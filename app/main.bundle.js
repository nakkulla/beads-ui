var Ul=Object.create;var os=Object.defineProperty;var jl=Object.getOwnPropertyDescriptor;var zl=Object.getOwnPropertyNames;var Hl=Object.getPrototypeOf,Wl=Object.prototype.hasOwnProperty;var Gl=(e,t,r)=>t in e?os(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var as=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Yl=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of zl(t))!Wl.call(e,s)&&s!==r&&os(e,s,{get:()=>t[s],enumerable:!(n=jl(t,s))||n.enumerable});return e};var Vl=(e,t,r)=>(r=e!=null?Ul(Hl(e)):{},Yl(t||!e||!e.__esModule?os(r,"default",{value:e,enumerable:!0}):r,e));var Ke=(e,t,r)=>Gl(e,typeof t!="symbol"?t+"":t,r);var Yo=as((cf,Go)=>{var Sr=1e3,Ar=Sr*60,Tr=Ar*60,mr=Tr*24,Jl=mr*7,ec=mr*365.25;Go.exports=function(e,t){t=t||{};var r=typeof e;if(r==="string"&&e.length>0)return tc(e);if(r==="number"&&isFinite(e))return t.long?nc(e):rc(e);throw new Error("val is not a non-empty string or a valid number. val="+JSON.stringify(e))};function tc(e){if(e=String(e),!(e.length>100)){var t=/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(e);if(t){var r=parseFloat(t[1]),n=(t[2]||"ms").toLowerCase();switch(n){case"years":case"year":case"yrs":case"yr":case"y":return r*ec;case"weeks":case"week":case"w":return r*Jl;case"days":case"day":case"d":return r*mr;case"hours":case"hour":case"hrs":case"hr":case"h":return r*Tr;case"minutes":case"minute":case"mins":case"min":case"m":return r*Ar;case"seconds":case"second":case"secs":case"sec":case"s":return r*Sr;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return r;default:return}}}}function rc(e){var t=Math.abs(e);return t>=mr?Math.round(e/mr)+"d":t>=Tr?Math.round(e/Tr)+"h":t>=Ar?Math.round(e/Ar)+"m":t>=Sr?Math.round(e/Sr)+"s":e+"ms"}function nc(e){var t=Math.abs(e);return t>=mr?vn(e,t,mr,"day"):t>=Tr?vn(e,t,Tr,"hour"):t>=Ar?vn(e,t,Ar,"minute"):t>=Sr?vn(e,t,Sr,"second"):e+" ms"}function vn(e,t,r,n){var s=t>=r*1.5;return Math.round(e/r)+" "+n+(s?"s":"")}});var Ko=as((df,Vo)=>{function sc(e){r.debug=r,r.default=r,r.coerce=l,r.disable=a,r.enable=s,r.enabled=i,r.humanize=Yo(),r.destroy=d,Object.keys(e).forEach(p=>{r[p]=e[p]}),r.names=[],r.skips=[],r.formatters={};function t(p){let f=0;for(let g=0;g<p.length;g++)f=(f<<5)-f+p.charCodeAt(g),f|=0;return r.colors[Math.abs(f)%r.colors.length]}r.selectColor=t;function r(p){let f,g=null,A,x;function T(...P){if(!T.enabled)return;let w=T,Y=Number(new Date),V=Y-(f||Y);w.diff=V,w.prev=f,w.curr=Y,f=Y,P[0]=r.coerce(P[0]),typeof P[0]!="string"&&P.unshift("%O");let q=0;P[0]=P[0].replace(/%([a-zA-Z%])/g,(S,L)=>{if(S==="%%")return"%";q++;let C=r.formatters[L];if(typeof C=="function"){let ce=P[q];S=C.call(w,ce),P.splice(q,1),q--}return S}),r.formatArgs.call(w,P),(w.log||r.log).apply(w,P)}return T.namespace=p,T.useColors=r.useColors(),T.color=r.selectColor(p),T.extend=n,T.destroy=r.destroy,Object.defineProperty(T,"enabled",{enumerable:!0,configurable:!1,get:()=>g!==null?g:(A!==r.namespaces&&(A=r.namespaces,x=r.enabled(p)),x),set:P=>{g=P}}),typeof r.init=="function"&&r.init(T),T}function n(p,f){let g=r(this.namespace+(typeof f>"u"?":":f)+p);return g.log=this.log,g}function s(p){r.save(p),r.namespaces=p,r.names=[],r.skips=[];let f=(typeof p=="string"?p:"").trim().replace(/\s+/g,",").split(",").filter(Boolean);for(let g of f)g[0]==="-"?r.skips.push(g.slice(1)):r.names.push(g)}function o(p,f){let g=0,A=0,x=-1,T=0;for(;g<p.length;)if(A<f.length&&(f[A]===p[g]||f[A]==="*"))f[A]==="*"?(x=A,T=g,A++):(g++,A++);else if(x!==-1)A=x+1,T++,g=T;else return!1;for(;A<f.length&&f[A]==="*";)A++;return A===f.length}function a(){let p=[...r.names,...r.skips.map(f=>"-"+f)].join(",");return r.enable(""),p}function i(p){for(let f of r.skips)if(o(p,f))return!1;for(let f of r.names)if(o(p,f))return!0;return!1}function l(p){return p instanceof Error?p.stack||p.message:p}function d(){console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.")}return r.enable(r.load()),r}Vo.exports=sc});var Zo=as((Tt,yn)=>{Tt.formatArgs=ac;Tt.save=ic;Tt.load=lc;Tt.useColors=oc;Tt.storage=cc();Tt.destroy=(()=>{let e=!1;return()=>{e||(e=!0,console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."))}})();Tt.colors=["#0000CC","#0000FF","#0033CC","#0033FF","#0066CC","#0066FF","#0099CC","#0099FF","#00CC00","#00CC33","#00CC66","#00CC99","#00CCCC","#00CCFF","#3300CC","#3300FF","#3333CC","#3333FF","#3366CC","#3366FF","#3399CC","#3399FF","#33CC00","#33CC33","#33CC66","#33CC99","#33CCCC","#33CCFF","#6600CC","#6600FF","#6633CC","#6633FF","#66CC00","#66CC33","#9900CC","#9900FF","#9933CC","#9933FF","#99CC00","#99CC33","#CC0000","#CC0033","#CC0066","#CC0099","#CC00CC","#CC00FF","#CC3300","#CC3333","#CC3366","#CC3399","#CC33CC","#CC33FF","#CC6600","#CC6633","#CC9900","#CC9933","#CCCC00","#CCCC33","#FF0000","#FF0033","#FF0066","#FF0099","#FF00CC","#FF00FF","#FF3300","#FF3333","#FF3366","#FF3399","#FF33CC","#FF33FF","#FF6600","#FF6633","#FF9900","#FF9933","#FFCC00","#FFCC33"];function oc(){if(typeof window<"u"&&window.process&&(window.process.type==="renderer"||window.process.__nwjs))return!0;if(typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/))return!1;let e;return typeof document<"u"&&document.documentElement&&document.documentElement.style&&document.documentElement.style.WebkitAppearance||typeof window<"u"&&window.console&&(window.console.firebug||window.console.exception&&window.console.table)||typeof navigator<"u"&&navigator.userAgent&&(e=navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/))&&parseInt(e[1],10)>=31||typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)}function ac(e){if(e[0]=(this.useColors?"%c":"")+this.namespace+(this.useColors?" %c":" ")+e[0]+(this.useColors?"%c ":" ")+"+"+yn.exports.humanize(this.diff),!this.useColors)return;let t="color: "+this.color;e.splice(1,0,t,"color: inherit");let r=0,n=0;e[0].replace(/%[a-zA-Z%]/g,s=>{s!=="%%"&&(r++,s==="%c"&&(n=r))}),e.splice(n,0,t)}Tt.log=console.debug||console.log||(()=>{});function ic(e){try{e?Tt.storage.setItem("debug",e):Tt.storage.removeItem("debug")}catch{}}function lc(){let e;try{e=Tt.storage.getItem("debug")||Tt.storage.getItem("DEBUG")}catch{}return!e&&typeof process<"u"&&"env"in process&&(e=process.env.DEBUG),e}function cc(){try{return localStorage}catch{}}yn.exports=Ko()(Tt);var{formatters:dc}=yn.exports;dc.j=function(e){try{return JSON.stringify(e)}catch(t){return"[UnexpectedJSONParseError]: "+t.message}}});var qr=globalThis,bn=qr.trustedTypes,Lo=bn?bn.createPolicy("lit-html",{createHTML:e=>e}):void 0,Fo="$lit$",rr=`lit$${Math.random().toFixed(9).slice(2)}$`,qo="?"+rr,Kl=`<${qo}>`,fr=document,Br=()=>fr.createComment(""),Ur=e=>e===null||typeof e!="object"&&typeof e!="function",fs=Array.isArray,Zl=e=>fs(e)||typeof e?.[Symbol.iterator]=="function",is=`[ 	
\f\r]`,Fr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Oo=/-->/g,Do=/>/g,ur=RegExp(`>|${is}(?:([^\\s"'>=/]+)(${is}*=${is}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Po=/'/g,Mo=/"/g,Bo=/^(?:script|style|textarea|title)$/i,_s=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),c=_s(1),Vt=_s(2),tf=_s(3),_r=Symbol.for("lit-noChange"),ct=Symbol.for("lit-nothing"),No=new WeakMap,pr=fr.createTreeWalker(fr,129);function Uo(e,t){if(!fs(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Lo!==void 0?Lo.createHTML(t):t}var Xl=(e,t)=>{let r=e.length-1,n=[],s,o=t===2?"<svg>":t===3?"<math>":"",a=Fr;for(let i=0;i<r;i++){let l=e[i],d,p,f=-1,g=0;for(;g<l.length&&(a.lastIndex=g,p=a.exec(l),p!==null);)g=a.lastIndex,a===Fr?p[1]==="!--"?a=Oo:p[1]!==void 0?a=Do:p[2]!==void 0?(Bo.test(p[2])&&(s=RegExp("</"+p[2],"g")),a=ur):p[3]!==void 0&&(a=ur):a===ur?p[0]===">"?(a=s??Fr,f=-1):p[1]===void 0?f=-2:(f=a.lastIndex-p[2].length,d=p[1],a=p[3]===void 0?ur:p[3]==='"'?Mo:Po):a===Mo||a===Po?a=ur:a===Oo||a===Do?a=Fr:(a=ur,s=void 0);let A=a===ur&&e[i+1].startsWith("/>")?" ":"";o+=a===Fr?l+Kl:f>=0?(n.push(d),l.slice(0,f)+Fo+l.slice(f)+rr+A):l+rr+(f===-2?i:A)}return[Uo(e,o+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]},jr=class e{constructor({strings:t,_$litType$:r},n){let s;this.parts=[];let o=0,a=0,i=t.length-1,l=this.parts,[d,p]=Xl(t,r);if(this.el=e.createElement(d,n),pr.currentNode=this.el.content,r===2||r===3){let f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(s=pr.nextNode())!==null&&l.length<i;){if(s.nodeType===1){if(s.hasAttributes())for(let f of s.getAttributeNames())if(f.endsWith(Fo)){let g=p[a++],A=s.getAttribute(f).split(rr),x=/([.?@])?(.*)/.exec(g);l.push({type:1,index:o,name:x[2],strings:A,ctor:x[1]==="."?cs:x[1]==="?"?ds:x[1]==="@"?us:$r}),s.removeAttribute(f)}else f.startsWith(rr)&&(l.push({type:6,index:o}),s.removeAttribute(f));if(Bo.test(s.tagName)){let f=s.textContent.split(rr),g=f.length-1;if(g>0){s.textContent=bn?bn.emptyScript:"";for(let A=0;A<g;A++)s.append(f[A],Br()),pr.nextNode(),l.push({type:2,index:++o});s.append(f[g],Br())}}}else if(s.nodeType===8)if(s.data===qo)l.push({type:2,index:o});else{let f=-1;for(;(f=s.data.indexOf(rr,f+1))!==-1;)l.push({type:7,index:o}),f+=rr.length-1}o++}}static createElement(t,r){let n=fr.createElement("template");return n.innerHTML=t,n}};function wr(e,t,r=e,n){if(t===_r)return t;let s=n!==void 0?r._$Co?.[n]:r._$Cl,o=Ur(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(t=wr(e,s._$AS(e,t.values),s,n)),t}var ls=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:r},parts:n}=this._$AD,s=(t?.creationScope??fr).importNode(r,!0);pr.currentNode=s;let o=pr.nextNode(),a=0,i=0,l=n[0];for(;l!==void 0;){if(a===l.index){let d;l.type===2?d=new zr(o,o.nextSibling,this,t):l.type===1?d=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(d=new ps(o,this,t)),this._$AV.push(d),l=n[++i]}a!==l?.index&&(o=pr.nextNode(),a++)}return pr.currentNode=fr,s}p(t){let r=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,r),r+=n.strings.length-2):n._$AI(t[r])),r++}},zr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,r,n,s){this.type=2,this._$AH=ct,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=wr(this,t,r),Ur(t)?t===ct||t==null||t===""?(this._$AH!==ct&&this._$AR(),this._$AH=ct):t!==this._$AH&&t!==_r&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Zl(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==ct&&Ur(this._$AH)?this._$AA.nextSibling.data=t:this.T(fr.createTextNode(t)),this._$AH=t}$(t){let{values:r,_$litType$:n}=t,s=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=jr.createElement(Uo(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(r);else{let o=new ls(s,this),a=o.u(this.options);o.p(r),this.T(a),this._$AH=o}}_$AC(t){let r=No.get(t.strings);return r===void 0&&No.set(t.strings,r=new jr(t)),r}k(t){fs(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,n,s=0;for(let o of t)s===r.length?r.push(n=new e(this.O(Br()),this.O(Br()),this,this.options)):n=r[s],n._$AI(o),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(t=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);t!==this._$AB;){let n=t.nextSibling;t.remove(),t=n}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},$r=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,n,s,o){this.type=1,this._$AH=ct,this._$AN=void 0,this.element=t,this.name=r,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=ct}_$AI(t,r=this,n,s){let o=this.strings,a=!1;if(o===void 0)t=wr(this,t,r,0),a=!Ur(t)||t!==this._$AH&&t!==_r,a&&(this._$AH=t);else{let i=t,l,d;for(t=o[0],l=0;l<o.length-1;l++)d=wr(this,i[n+l],r,l),d===_r&&(d=this._$AH[l]),a||(a=!Ur(d)||d!==this._$AH[l]),d===ct?t=ct:t!==ct&&(t+=(d??"")+o[l+1]),this._$AH[l]=d}a&&!s&&this.j(t)}j(t){t===ct?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},cs=class extends $r{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===ct?void 0:t}},ds=class extends $r{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==ct)}},us=class extends $r{constructor(t,r,n,s,o){super(t,r,n,s,o),this.type=5}_$AI(t,r=this){if((t=wr(this,t,r,0)??ct)===_r)return;let n=this._$AH,s=t===ct&&n!==ct||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,o=t!==ct&&(n===ct||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ps=class{constructor(t,r,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){wr(this,t)}};var Ql=qr.litHtmlPolyfillSupport;Ql?.(jr,zr),(qr.litHtmlVersions??(qr.litHtmlVersions=[])).push("3.3.1");var qe=(e,t,r)=>{let n=r?.renderBefore??t,s=n._$litPart$;if(s===void 0){let o=r?.renderBefore??null;n._$litPart$=s=new zr(t.insertBefore(Br(),o),o,void 0,r??{})}return s._$AI(e),s};var Lt="today",zt=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function Kt(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function xr(e,t=Date.now()){switch(e){case"today":{let r=new Date(t);return r.setHours(0,0,0,0),r.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function jo(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function zo(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function Ho(){let e=null,t=[],r=new Set;function n(){for(let s of Array.from(r))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},set(s,o){e=Array.isArray(s)?s:null,t=Array.isArray(o)?o:[],n()},clear(){e=null,t=[],n()},subscribe(s){return r.add(s),()=>r.delete(s)}}}function Wo(){let e=new Map,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{set(n,s,o=null){e.set(n,{lines:Array.isArray(s)?[...s]:[],last_event_at:typeof o=="number"?o:null}),r()},append(n,s){let o=e.get(n)||{lines:[],last_event_at:null};o.lines=[...o.lines,s],o.last_event_at=Date.now(),e.set(n,o),r()},get(n){return e.get(n)||null},clear(n){typeof n=="string"?e.delete(n):e.clear(),r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}var Xo=Vl(Zo(),1);function rt(e){return(0,Xo.default)(`beads-ui:${e}`)}function Ft(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function gr(e,t){let r=Ft(e.created_at),n=Ft(t.created_at);if(r!==n)return r<n?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function ea(e,t){let r=Ft(e.created_at),n=Ft(t.created_at);if(r!==n)return r<n?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function ta(e,t){let r=Ft(e.updated_at),n=Ft(t.updated_at);if(r!==n)return r<n?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function ra(e,t){let r=e.priority??2,n=t.priority??2;if(r!==n)return r-n;let s=Ft(e.created_at),o=Ft(t.created_at);if(s!==o)return s<o?1:-1;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function na(e,t){let r=e.closed_at??0,n=t.closed_at??0;if(r!==n)return r<n?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var uc=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function Qo(e){let t=e&&e.metadata,r=t?t.task_order:void 0;if(r==null||r==="")return Number.POSITIVE_INFINITY;let n=Number(r);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function Jo(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let r=uc.exec(t);if(!r)return Number.POSITIVE_INFINITY;let n=Number(r[1]);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function sa(e,t){let r=Qo(e),n=Qo(t);if(r!==n)return r<n?-1:1;let s=Jo(e),o=Jo(t);if(s!==o)return s<o?-1:1;let a=Ft(e&&e.created_at),i=Ft(t&&t.created_at);if(a!==i)return a<i?-1:1;let l=e&&e.id,d=t&&t.id;return l===d?0:String(l)<String(d)?-1:1}var ms=2**20;function Er(e,t){let r=e&&e.id;return t&&typeof r=="string"&&Object.prototype.hasOwnProperty.call(t,r)&&typeof t[r]=="number"&&Number.isFinite(t[r])?t[r]:-Ft(e&&e.created_at)}function kn(e){return(t,r)=>{let n=Er(t,e),s=Er(r,e);if(n!==s)return n<s?-1:1;let o=t?.id,a=r?.id;return o<a?-1:o>a?1:0}}function gs(e,t,r){let n=Array.isArray(e)?e:[],s=n.length,o=Math.max(0,Math.min(t,s-1)),a=o-1>=0?n[o-1]:null,i=o+1<s?n[o+1]:null;if(!a&&!i)return{rank:0};if(!a)return{rank:Er(i,r)-ms};if(!i)return{rank:Er(a,r)+ms};let l=Er(a,r),d=Er(i,r),p=(l+d)/2;return l<p&&p<d?{rank:p}:{renormalize:n.map((f,g)=>({bead_id:f.id,rank:g*ms}))}}function hs(e,t={}){let r=rt(`issue-store:${e}`),n=new Map,s=[],o=0,a=new Set,i=!1,l=t.sort||gr;function d(){for(let g of Array.from(a))try{g()}catch{}}function p(){s=Array.from(n.values()).sort(l)}function f(g){if(i||!g||g.id!==e)return;let A=Number(g.revision)||0;if(r("apply %s rev=%d",g.type,A),!(A<=o&&g.type!=="snapshot")){if(g.type==="snapshot"){if(A<=o)return;n.clear();let x=Array.isArray(g.issues)?g.issues:[];for(let T of x)T&&typeof T.id=="string"&&T.id.length>0&&n.set(T.id,T);p(),o=A,d();return}if(g.type==="upsert"){let x=g.issue;if(x&&typeof x.id=="string"&&x.id.length>0){let T=n.get(x.id);if(!T)n.set(x.id,x);else{let P=Number.isFinite(T.updated_at)?T.updated_at:0,w=Number.isFinite(x.updated_at)?x.updated_at:0;if(P<=w){for(let Y of Object.keys(T))Y in x||delete T[Y];for(let[Y,V]of Object.entries(x))T[Y]=V}}p()}o=A,d()}else if(g.type==="delete"){let x=String(g.issue_id||"");x&&(n.delete(x),p()),o=A,d()}}}return{id:e,subscribe(g){return a.add(g),()=>{a.delete(g)}},applyPush:f,snapshot(){return s},size(){return n.size},getById(g){return n.get(g)},dispose(){i=!0,n.clear(),s=[],a.clear(),o=0}}}function wn(e){let t=String(e.type||"").trim(),r={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let a=e.params[o];r[o]=String(a)}}let n=new URLSearchParams(r).toString();return n.length>0?`${t}?${n}`:t}function oa(e){let t=rt("subs"),r=new Map,n=new Map;function s(i,l){t("applyDelta %s +%d ~%d -%d",i,(l.added||[]).length,(l.updated||[]).length,(l.removed||[]).length);let d=n.get(i);if(!d||d.size===0)return;let p=Array.isArray(l.added)?l.added:[],f=Array.isArray(l.updated)?l.updated:[],g=Array.isArray(l.removed)?l.removed:[];for(let A of Array.from(d)){let x=r.get(A);if(!x)continue;let T=x.itemsById;for(let P of p)typeof P=="string"&&P.length>0&&T.set(P,!0);for(let P of f)typeof P=="string"&&P.length>0&&T.set(P,!0);for(let P of g)typeof P=="string"&&P.length>0&&T.delete(P)}}async function o(i,l){let d=wn(l);if(t("subscribe %s key=%s",i,d),!r.has(i))r.set(i,{key:d,itemsById:new Map});else{let f=r.get(i);if(f&&f.key!==d){let g=n.get(f.key);g&&(g.delete(i),g.size===0&&n.delete(f.key)),r.set(i,{key:d,itemsById:new Map})}}n.has(d)||n.set(d,new Set);let p=n.get(d);p&&p.add(i);try{await e("subscribe-list",{id:i,type:l.type,params:l.params})}catch(f){let g=r.get(i)||null;if(g){let A=n.get(g.key);A&&(A.delete(i),A.size===0&&n.delete(g.key))}throw r.delete(i),f}return async()=>{t("unsubscribe %s key=%s",i,d);try{await e("unsubscribe-list",{id:i})}catch{}let f=r.get(i)||null;if(f){let g=n.get(f.key);g&&(g.delete(i),g.size===0&&n.delete(f.key))}r.delete(i)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:wn,selectors:{getIds(i){let l=r.get(i);return l?Array.from(l.itemsById.keys()):[]},has(i,l){let d=r.get(i);return d?d.itemsById.has(l):!1},count(i){let l=r.get(i);return l?l.itemsById.size:0},getItemsById(i){let l=r.get(i),d={};if(!l)return d;for(let p of l.itemsById.keys())d[p]=!0;return d}}}}function aa(){let e=rt("issue-stores"),t=new Map,r=new Map,n=new Set,s=new Map;function o(){for(let l of Array.from(n))try{l()}catch{}}function a(l,d,p){let f=d?wn(d):"",g=r.get(l)||"",A=t.has(l);if(e("register %s key=%s (prev=%s)",l,f,g),A&&g&&f&&g!==f){let x=t.get(l);if(x)try{x.dispose()}catch{}let T=s.get(l);if(T){try{T()}catch{}s.delete(l)}let P=hs(l,p);t.set(l,P);let w=P.subscribe(()=>o());s.set(l,w)}else if(!A){let x=hs(l,p);t.set(l,x);let T=x.subscribe(()=>o());s.set(l,T)}return r.set(l,f),()=>i(l)}function i(l){e("unregister %s",l),r.delete(l);let d=t.get(l);d&&(d.dispose(),t.delete(l));let p=s.get(l);if(p){try{p()}catch{}s.delete(l)}}return{register:a,unregister:i,getStore(l){return t.get(l)||null},snapshotFor(l){let d=t.get(l);return d?d.snapshot().slice():[]},subscribe(l){return n.add(l),()=>n.delete(l)}}}function ia(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function la(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function bs(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function pc(e){let t=String(e||""),r=t.startsWith("#")?t.slice(1):t,n=r.indexOf("?"),s=n>=0?r.slice(n+1):"";if(s){let i=new URLSearchParams(s).get("issue");if(i)return decodeURIComponent(i)}let o=/^\/issue\/([^\s?#]+)/.exec(r);return o&&o[1]?decodeURIComponent(o[1]):null}function fc(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function ca(e){let t=rt("router"),r=()=>{let n=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(n),o=s&&s[1]?decodeURIComponent(s[1]):pc(n),a=fc(n);if(t("hash change \u2192 view=%s id=%s",a,o),e.setState({selected_id:a==="worker"?null:o,view:a,worker:{selected_parent_id:a==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(n)){let l=o?`#/${a}?issue=${encodeURIComponent(o)}`:`#/${a}`;window.location.hash!==l&&(window.location.hash=l)}};return{start(){window.addEventListener("hashchange",r),r()},stop(){window.removeEventListener("hashchange",r)},gotoIssue(n){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",a=bs(o,n);t("goto issue %s (view=%s)",n,o),window.location.hash!==a?window.location.hash=a:e.setState({selected_id:o==="worker"?null:n,view:o,worker:{selected_parent_id:o==="worker"?n:null}})},gotoView(n){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=n==="worker"?s.worker?.selected_parent_id:s.selected_id,a=o?bs(n,o):`#/${n}`;t("goto view %s (id=%s)",n,o||""),window.location.hash!==a?window.location.hash=a:e.setState({view:n,selected_id:n==="worker"?null:s.selected_id})}}}var _c=Object.freeze({workspace_config:{default_workspace:null}});function da(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:_c.workspace_config.default_workspace}}}function ua(e={}){let t=rt("state"),r={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:da(e.config)},n=new Set;function s(){for(let o of Array.from(n))try{o(r)}catch{}}return{getState(){return r},setState(o){let a={...r,...o,filters:{...r.filters,...o.filters||{}},board:{...r.board,...o.board||{}},worker:{...r.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:r.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:r.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:r.workspace.hidden},config:o.config!==void 0?da(o.config):r.config},i=a.workspace.current?.path!==r.workspace.current?.path||a.workspace.available.length!==r.workspace.available.length||a.workspace.hidden.length!==r.workspace.hidden.length||a.workspace.hidden.some((d,p)=>d!==r.workspace.hidden[p]),l=a.config.workspace_config.default_workspace!==r.config.workspace_config.default_workspace;a.selected_id===r.selected_id&&a.view===r.view&&a.filters.status===r.filters.status&&a.filters.search===r.filters.search&&a.filters.type===r.filters.type&&a.board.closed_filter===r.board.closed_filter&&a.worker.selected_parent_id===r.worker.selected_parent_id&&a.worker.show_closed_children.length===r.worker.show_closed_children.length&&a.worker.show_closed_children.every((d,p)=>d===r.worker.show_closed_children[p])&&!i&&!l||(r=a,t("state change %o",{selected_id:r.selected_id,view:r.view,filters:r.filters,board:r.board,worker:r.worker,workspace:r.workspace.current?.path,config:{default_workspace:r.config.workspace_config.default_workspace}}),s())},subscribe(o){return n.add(o),()=>n.delete(o)}}}function pa(e){let t=rt("activity"),r=0,n=new Map,s=1;function o(){if(!e)return;let d=r>0;e.toggleAttribute("hidden",!d),e.setAttribute("aria-busy",d?"true":"false")}function a(){r+=1,t("start count=%d",r),o()}function i(){let d=r;r=Math.max(0,r-1),d<=0?t("done called but count was already %d",d):t("done count=%d\u2192%d",d,r),o()}function l(d){return async(f,g)=>{let A=s++,x=Date.now();n.set(A,{type:f,start_ts:x}),t("request start id=%d type=%s count=%d",A,f,r+1),a();let T=!1,P=()=>{T||(T=!0,n.delete(A),i())},w=setTimeout(()=>{T||(t("request TIMEOUT id=%d type=%s elapsed=%dms",A,f,Date.now()-x),P())},3e4);try{let Y=await d(f,g),V=Date.now()-x;return t("request done id=%d type=%s elapsed=%dms",A,f,V),Y}catch(Y){let V=Date.now()-x;throw t("request error id=%d type=%s elapsed=%dms err=%o",A,f,V,Y),Y}finally{clearTimeout(w),P()}}}return o(),{wrapSend:l,start:a,done:i,getCount:()=>r,getActiveRequests:()=>{let d=Date.now();return Array.from(n.entries()).map(([p,f])=>({id:p,type:f.type,elapsed_ms:d-f.start_ts}))}}}function te(e,t="info",r=2800){let n=document.createElement("div");n.className="toast",n.textContent=e,n.style.position="fixed",n.style.right="12px",n.style.bottom="12px",n.style.zIndex="1000",n.style.color="#fff",n.style.padding="8px 10px",n.style.borderRadius="4px",n.style.fontSize="12px",t==="success"?n.style.background="#156d36":t==="warning"?n.style.background="#a36a00":t==="error"?n.style.background="#9f2011":n.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(n),setTimeout(()=>{try{n.remove()}catch{}},r)}function $n(e=void 0,t=void 0){function r(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function n(o,a,i){let l=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(a==="closed")return l.sort(na),l;switch(i){case"created_desc":return l.sort(gr),l;case"created_asc":return l.sort(ea),l;case"updated_desc":return l.sort(ta),l;case"priority":return l.sort(ra),l;case"manual":default:{let d=r();return d?l.sort(kn(d)):l.sort(gr),l}}}function s(o){let a=[];return e&&typeof e.subscribe=="function"&&a.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&a.push(t.subscribe(o)),()=>{for(let i of a)try{i()}catch{}}}return{selectBoardColumn:n,subscribe:s}}function Hr(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function bt(e){let t=Hr(e);if(t===null)return"";let r=new Date(t),n=s=>String(s).padStart(2,"0");return`${r.getFullYear()}-${n(r.getMonth()+1)}-${n(r.getDate())} ${n(r.getHours())}:${n(r.getMinutes())}`}function Rt(e,t){let r=Hr(e);if(r===null)return"";let s=(typeof t=="number"?t:Date.now())-r;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let a=Math.floor(s/36e5);if(a<24)return`${a}\uC2DC\uAC04 \uC804`;let i=Math.floor(s/864e5);if(i<7)return`${i}\uC77C \uC804`;let l=Math.floor(i/7);if(i<30)return`${l}\uC8FC \uC804`;let d=Math.floor(i/30);return d<12?`${d}\uAC1C\uC6D4 \uC804`:`${Math.floor(i/365)}\uB144 \uC804`}function xn(e){if(!Array.isArray(e))return null;let t=null,r=-1;for(let n of e){if(!n||n.status!=="in_progress")continue;let s=Hr(n.updated_at)??0;if(t===null||s>r){t=n,r=s;continue}s===r&&String(n.id)<String(t.id)&&(t=n)}return t}function Sn(e){let t=e.transport,r=e.uiOrderStore;function n(a,i){return"renormalize"in a?a.renormalize:[{bead_id:i,rank:a.rank}]}function s(a,i){let l={...a.order};for(let d of i)l[d.bead_id]=d.rank;r&&r.set({revision:a.revision,order:l})}async function o(a,i,l){if(!t||!r)return;let d=r.get()||{revision:0,order:{}},p=n(gs(i,l,d.order),a);s(d,p);let f=await t("ui-order-set",{expected_revision:d.revision,entries:p});if(f&&f.conflict){let g={revision:typeof f.revision=="number"?f.revision:0,order:f.order||{}};r.set(g);let A=n(gs(i,l,g.order),a);s(g,A);let x=await t("ui-order-set",{expected_revision:g.revision,entries:A});x&&x.applied&&r.set({revision:typeof x.revision=="number"?x.revision:0,order:x.order||{}})}else f&&f.applied&&r.set({revision:typeof f.revision=="number"?f.revision:0,order:f.order||{}})}return{applyReorder:o}}function An(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function vs(e,t){return!t||typeof e!="string"||e.length===0||An(t.visible_labels).includes(e)?!0:An(t.hidden_labels).includes(e)?!1:!An(t.hidden_prefixes).some(r=>r.length>0&&e.startsWith(r))}function Tn(e,t){return An(e).filter(r=>vs(r,t))}function nr(e,t){let r=e&&e.chips?e.chips[t]:void 0;return typeof r=="boolean"?r:!0}var mc={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg",close:"mrg"},_a={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge",close:"close"},fa={quick_fix:["impl","close"],spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},gc={review:"\u2713",skip:"\u2298"},sr={none:"\uBBF8\uB3C4\uB2EC",dim:"\uC9C4\uD589 \uC911",stale:"\uC7AC\uAC80\uD1A0 \uD544\uC694",review:"\uAC80\uD1A0 \uC644\uB8CC",skip:"\uAC80\uD1A0 \uC0DD\uB7B5",done:"\uC644\uB8CC"};function hc(e,t,r){if(!(r==="in_progress"||r==="resolved"))return null;for(let s of e){let o=t[s];if(o&&o.fill==="dim"&&o.stale!==!0)return s}return null}function ma(e){let t=e&&e.fill||"none";return t==="none"?sr.none:e&&e.stale===!0?sr.stale:t==="dim"?sr.dim:e&&e.glyph==="review"?sr.review:e&&e.glyph==="skip"?sr.skip:sr.done}function bc(e){if(!e||e.fill==="none"||!e.approval_state)return ma(e);let t=[];return e.glyph==="review"?t.push(sr.review):e.glyph==="skip"&&t.push(sr.skip),e.approval_state==="missing"?t.push("\uC2B9\uC778 \uD544\uC694"):e.approval_state==="stale"?t.push("\uC7AC\uC2B9\uC778 \uD544\uC694"):e.approval_state==="unknown"?t.push("\uC2B9\uC778 \uD655\uC778 \uBD88\uAC00"):t.push("\uC2B9\uC778 \uC644\uB8CC"),t.join(" \xB7 ")}function vc(e,t,r){let n=mc[e]||e,s=t&&t.fill||"none",o=!!t&&t.stale===!0,a=gc[t&&t.glyph||""]||"",i="bar";s==="dim"?i+=` b-${n} dim`:s==="full"&&(i+=` b-${n} full`),o&&(i+=" stale"),r&&(i+=" cur");let l=s==="none"?"lbl":`lbl l-${n} on`,d=r?`color: var(--stage-${n}-on)`:"";return c`
    <div class="seg">
  ...
  `}function En(e,t){if(!e||!e.stages)return"";let r=fa[e.route]||fa.spec_backed,n=e.stages,s=hc(r,n,String(t||"open")),o=`\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uC9C4\uD589: ${r.map(a=>`${_a[a]||a} ${a==="plan"?bc(n[a]||{}):ma(n[a]||{})}`).join(" \xB7 ")}`;return c`
    <div class="stp" role="img" aria-label=${o}>
      ${r.map(a=>vc(a,n[a]||{},a===s))}
    </div>
  `}function yc(e){return typeof e!="number"||!Number.isFinite(e)?"":`P${Math.max(0,Math.min(4,e))}`}var ga=2;function kc(e){if(!e)return[];let t=[];if(e.external){let n=e.reason?`\u23F8 blocked: ${e.reason}`:"\u23F8 blocked";t.push(c`<span class="ctl-chip ctl-chip--blocked">${n}</span>`)}let r=Array.isArray(e.blockers)?e.blockers:[];if(r.length>0){let n=r.slice(0,ga).join(", "),s=r.length-ga,o=`\u26D3 blocked: ${n}${s>0?` +${s}`:""}`;t.push(c`<span class="ctl-chip ctl-chip--blocked-dep">${o}</span>`)}return t}function wc(e,t){let r=t.policy||null,n=e.workflow&&e.workflow.chips||{},s=[];if(n.route&&nr(r,"route")){let a=n.route_source==="derived";s.push(c`<span
        class="ctl-chip ctl-chip--route${a?" is-derived":""}"
        title=${a?"route \uBBF8\uD540 (metadata unset)":"route"}
        >${a?"unset":n.route}</span
      >`)}if(n.fast_track&&nr(r,"fast_track")&&s.push(c`<span class="ctl-chip ctl-chip--ft">⚡ fast_track</span>`),n.pr&&nr(r,"pr")){let a=n.pr.number;s.push(c`<span class="ctl-chip ctl-chip--pr"
        >${`PR${a!=null?` #${a}`:""}`}</span
      >`)}for(let a of Tn(e.labels,r))s.push(c`<span class="ctl-chip ctl-chip--label">${a}</span>`);return e.from_id&&nr(r,"from")&&s.push(c`<button
        type="button"
  ...
  `}function Cn(e,t){let r=yc(e.priority);return c`
    <article
      class="board-card"
      data-issue-id=${e.id}
      role="listitem"
    ...
    >
      ...
      ${wc(e,t)}
      ${e.workflow&&nr(t.policy||null,"stepper")?En(e.workflow,e.status):""}
      ${Sc(e,t)}
    </article>
  `}function Cr(e,t){let r=Array.isArray(e.items)?e.items.length:0,n=e.is_closed===!0;return c`
    ...
    >
      <div class="deferred-popup__container">
        ...
        <div
          ...
          aria-labelledby="deferred-popup-title"
        >
          ${e.items.length===0?c`<div class="deferred-popup__empty">Deferred 이슈 없음</div>`:e.items.map(n=>Cn(n,t))}
        </div>
      </div>
    </dialog>
  ...
  `}var Rc=200,Ic={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},Lc=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),va="beads-ui.board.sort",ya=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function Oc(){try{let e=window.localStorage.getItem(va);if(e&&ya.has(e))return e}catch{}return"created_desc"}function ka(e,t){let r=rt("views:board"),n=t.gotoIssue,s=t.issueStores,o=t.transport,a=t.uiOrderStore,i=t.displayPolicyStore,l=t.workerQueueStore,d=t.onClosedRangeChange,p=t.onNewIssue,f=t.closedRange||Lt,g=s?$n(s,a):null,A=Sn({transport:o,uiOrderStore:a}),x=[],T=[],P=[],w=[],Y=[],V=[],q=!1,E=0,S=Oc(),L=new Map,C=new Map,ce=new Map,$e=new Set,le={search:"",priority:"",type:"",labels:[]},me=!1,Le=null;function Ge(M){return String(M.status||"open")==="open"}function Ye(M){let W=String(M.status||"open");return W==="open"||W==="blocked"}function Me(M){let W=le.search.trim().toLowerCase(),ie=le.priority,ue=le.type,he=le.labels;return M.filter(Te=>{if(W){let He=String(Te.id||"").toLowerCase(),Xe=String(Te.title||"").toLowerCase();if(!He.includes(W)&&!Xe.includes(W))return!1}if(ie!==""&&String(Te.priority)!==ie||ue!==""&&String(Te.issue_type||"")!==ue)return!1;if(he.length>0){let He=Array.isArray(Te.labels)?Te.labels:[];if(!he.some(Xe=>He.includes(Xe)))return!1}return!0})}function Be(){let M=new Set;for(let W of[x,T,P,w,Y,V])for(let ie of W){let ue=Array.isArray(ie.labels)?ie.labels:[];for(let he of ue)typeof he=="string"&&he.length>0&&M.add(he)}return Array.from(M).sort()}function ge(){return le.search.trim()!==""||le.priority!==""||le.type!==""||le.labels.length>0}function ye(){try{if(g){let M=g.selectBoardColumn("tab:board:in-progress","in_progress",S),W=g.selectBoardColumn("tab:board:blocked","blocked",S).filter(Ye),ie=new Set(M.map(u=>u.id)),ue=g.selectBoardColumn("tab:board:ready","ready",S).filter(u=>Ge(u)&&!ie.has(u.id)),he=g.selectBoardColumn("tab:board:resolved","resolved",S),Te=g.selectBoardColumn("tab:board:deferred","deferred",S),He=g.selectBoardColumn("tab:board:closed","closed").slice(0,Rc),Xe=[...W,...ue,...M,...he,...He];Re(Xe);let Ee=new Set;for(let u of Xe)u&&u.id&&!ys(u)&&Ee.add(u.id);let Ve=!ge();x=Ve?Wr(W,Ee):W,T=Ve?Wr(ue,Ee):ue,P=Ve?Wr(M,Ee):M,w=Ve?Wr(he,Ee):he,Y=Te,E=Te.length,V=Ve?Wr(He,Ee):He,L=new Map;for(let u of x)L.set(u.id,"open");for(let u of T)L.set(u.id,"open");for(let u of P)L.set(u.id,"in_progress");for(let u of w)L.set(u.id,"resolved");for(let u of Y)L.set(u.id,"deferred");for(let u of V)L.set(u.id,"closed");C=new Map;for(let u of x)C.set(u.id,"blocked-col");for(let u of T)C.set(u.id,"ready-col");for(let u of P)C.set(u.id,"in-progress-col");for(let u of w)C.set(u.id,"resolved-col");for(let u of V)C.set(u.id,"closed-col")}ze()}catch{x=[],T=[],P=[],w=[],Y=[],V=[],ce=new Map,ze()}}function Re(M){let W=new Map;for(let ue of M)ue&&ue.id&&!W.has(ue.id)&&W.set(ue.id,ue);let ie=new Map;for(let ue of W.values()){let he=ys(ue);if(!he)continue;let Te=ie.get(he);Te||(Te=[],ie.set(he,Te)),Te.push({id:ue.id,title:ue.title,status:ue.status,metadata:ue.metadata,created_at:ue.created_at,updated_at:ue.updated_at})}ce=ie}function J(M){let W=ce.get(M)||[],ie=0;for(let he of W)(he.status==="resolved"||he.status==="closed")&&(ie+=1);let ue=xn(W);return{total:W.length,count:ie,current:ue,children:W}}function H(M){return!$e.has(M)}function X(M,W){M.preventDefault(),M.stopPropagation(),$e.has(W)?$e.delete(W):$e.add(W),ze()}function Oe(M,W){M.preventDefault(),M.stopPropagation(),n(W)}function _e(M,W){M.preventDefault(),M.stopPropagation(),n(W)}function ke(M,W){Le||n(W)}function B(M,W){M.preventDefault(),M.stopPropagation(),Dc(W).then(ie=>{ie&&te("\uBCF5\uC0AC\uB428","success",1200)})}function O(M,W){Le=W,M.dataTransfer&&(M.dataTransfer.setData("text/plain",W),M.dataTransfer.effectAllowed="move"),M.target.classList.add("board-card--dragging")}function oe(M){M.target.classList.remove("board-card--dragging"),Ne(),setTimeout(()=>{Le=null},0)}function ve(M){let W=String(M.target.value||"");!W||W===f||(f=W,d&&d(W),ze())}function Ae(){return i?i.get():null}function Ze(M){let W=l?l.get():null,ie=W?W.cleanup_failed:null;if(!ie||typeof ie!="object"||Array.isArray(ie))return null;let ue=ie[M];return!ue||typeof ue!="object"||Array.isArray(ue)?null:ue}let Ie={onCardClick:ke,onCopyId:B,onDragStart:O,onDragEnd:oe,onClosedRangeChange:ve,rollupFor:J,isExpanded:H,onRollupToggle:X,onChildClick:Oe,onFromChipClick:_e,cleanupFailureFor:Ze,get policy(){return Ae()}};function D(M,W){Le||(De(),n(W))}function U(M,W){M.preventDefault(),M.stopPropagation(),De(),n(W)}let R={...Ie,onCardClick:D,onChildClick:U,onFromChipClick:U,get policy(){return Ae()}};function y(M){let W=M.target,ie=e.querySelector(".board-filter__labels");W&&ie&&ie.contains(W)||K()}function z(M){M.key==="Escape"&&K()}function N(){me||(me=!0,document.addEventListener("mousedown",y),document.addEventListener("keydown",z),ze())}function K(){me&&(me=!1,document.removeEventListener("mousedown",y),document.removeEventListener("keydown",z),ze())}function ae(M){M.key==="Escape"&&De()}function xe(){q||(q=!0,document.addEventListener("keydown",ae),ze())}function De(){q&&(q=!1,document.removeEventListener("keydown",ae),ze())}let at={onClose:De,onOverlayClick(M){M.target===M.currentTarget&&De()}},it={onSearchInput(M){le.search=String(M.target.value||""),ye()},onPriorityChange(M){le.priority=String(M.target.value||""),ye()},onTypeChange(M){le.type=String(M.target.value||""),ye()},onSortChange(M){let W=String(M.target.value||"");if(!(!ya.has(W)||W===S)){S=W;try{window.localStorage.setItem(va,W)}catch{}ye()}},onDeferredToggle(){q?De():xe()},onLabelMenuToggle(){me?K():N()},onLabelToggle(M){let W=le.labels.indexOf(M);W===-1?le.labels.push(M):le.labels.splice(W,1),ye()},onLabelClear(){le.labels.length!==0&&(le.labels=[],ye())},onNewIssue(){p&&p()}};function lt(){return c`
      <div class="board-view">
        ${ba(le,it,{sort_mode:S,deferred_popup_open:q,deferred_count:E,label_options:Be(),label_menu_open:me})}
        <div class="board-root">
          ${Cr({title:"Blocked",id:"blocked-col",items:Me(x)},Ie)}
          ${Cr({title:"Ready",id:"ready-col",items:Me(T)},Ie)}
          ${Cr({title:"In progress",id:"in-progress-col",items:Me(P)},Ie)}
          ${Cr({title:"Resolved",id:"resolved-col",items:Me(w)},Ie)}
          ${Cr({title:"Closed",id:"closed-col",items:Me(V),is_closed:!0,closed_range:f},Ie)}
        </div>
        ${q?ha({items:Me(Y),count:E},R,at):""}
      </div>
    `}function ze(){qe(lt(),e),Pt()}function Pt(){try{let M=e.querySelector("#deferred-popup");M&&!M.open&&(typeof M.showModal=="function"?M.showModal():M.setAttribute("open",""));let W=Array.from(e.querySelectorAll(".board-column, .deferred-popup__body"));for(let ie of W)Array.from(ie.querySelectorAll(".board-card")).forEach((he,Te)=>{he.tabIndex=Te===0?0:-1})}catch{}}async function vt(M,W){if(!o){te("\uC5F0\uACB0\uB418\uC9C0 \uC54A\uC544 \uC0C1\uD0DC\uB97C \uBCC0\uACBD\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}try{await o("update-status",{id:M,status:W}),te("\uC0C1\uD0DC \uBCC0\uACBD\uB428","success",1500)}catch(ie){r("update-status failed: %o",ie),te("\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328","error")}}function _t(M){switch(M){case"blocked-col":return x;case"ready-col":return T;case"in-progress-col":return P;case"resolved-col":return w;default:return[]}}function dt(M,W,ie){if(!o||!a)return;let ue=_t(M),he=ue.find(Ve=>Ve.id===W);if(!he)return;let Te=ue.filter(Ve=>Ve.id!==W),He=ie.closest?ie.closest(".board-card"):null,Xe=Te.length;if(He){let Ve=He.getAttribute("data-issue-id");if(Ve===W)return;let u=Te.findIndex(k=>k.id===Ve);u>=0&&(Xe=u)}let Ee=Te.slice();Ee.splice(Xe,0,he),A.applyReorder(W,Ee,Xe)}function Ne(){for(let M of Array.from(e.querySelectorAll(".board-column--drag-over")))M.classList.remove("board-column--drag-over")}let tt=null;e.addEventListener("dragover",M=>{M.preventDefault(),M.dataTransfer&&(M.dataTransfer.dropEffect="move");let ie=M.target.closest(".board-column");ie&&ie!==tt&&(tt&&tt.classList.remove("board-column--drag-over"),ie.classList.add("board-column--drag-over"),tt=ie)}),e.addEventListener("dragleave",M=>{let W=M.relatedTarget;(!W||!e.contains(W))&&tt&&(tt.classList.remove("board-column--drag-over"),tt=null)}),e.addEventListener("drop",M=>{M.preventDefault(),tt&&(tt.classList.remove("board-column--drag-over"),tt=null);let W=M.target,ie=W.closest(".board-column");if(!ie)return;let ue=M.dataTransfer?.getData("text/plain")||"";if(!ue)return;let he=ie.id,Te=C.get(ue);if(Te&&Te===he){if(Lc.has(he)){if(S!=="manual"){te("\uC218\uB3D9(\uB4DC\uB798\uADF8) \uC815\uB82C \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC21C\uC11C\uB97C \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4","warning",2e3);return}dt(he,ue,W)}return}let He=Ic[he];if(!He){te("\uC5EC\uAE30\uB85C\uB294 \uC62E\uAE38 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","warning",1500);return}L.get(ue)!==He&&vt(ue,He)}),e.addEventListener("keydown",M=>{let W=M.target;if(!(W instanceof HTMLElement))return;let ie=String(W.tagName||"").toLowerCase();if(ie==="input"||ie==="textarea"||ie==="select"||ie==="button"||ie==="a"||W.isContentEditable===!0)return;let ue=W.closest(".board-card");if(!ue)return;let he=String(M.key||"");if(he==="Enter"||he===" "){M.preventDefault();let Ee=ue.getAttribute("data-issue-id");Ee&&n(Ee);return}if(he!=="ArrowUp"&&he!=="ArrowDown"&&he!=="ArrowLeft"&&he!=="ArrowRight")return;M.preventDefault();let Te=ue.closest(".board-column");if(!Te)return;let He=Array.from(Te.querySelectorAll(".board-card")),Xe=He.indexOf(ue);if(he==="ArrowDown"&&Xe<He.length-1){ut(ue,He[Xe+1]);return}if(he==="ArrowUp"&&Xe>0){ut(ue,He[Xe-1]);return}if(he==="ArrowLeft"||he==="ArrowRight"){let Ee=Array.from(e.querySelectorAll(".board-column")),Ve=Ee.indexOf(Te),u=he==="ArrowRight"?1:-1,k=Ve+u;for(;k>=0&&k<Ee.length;){let j=Ee[k].querySelector(".board-card");if(j){ut(ue,j);return}k+=u}}});function ut(M,W){try{M.tabIndex=-1,W.tabIndex=0,W.focus()}catch{}}let nt=null;g&&g.subscribe&&(nt=g.subscribe(()=>{try{ye()}catch{}}));let st=null;i&&i.subscribe&&(st=i.subscribe(()=>{try{ye()}catch{}}));let pt=null;return l&&l.subscribe&&(pt=l.subscribe(()=>{ze()})),{async load(){r("load"),ye()},clear(){K(),De(),nt&&(nt(),nt=null),st&&(st(),st=null),pt&&(pt(),pt=null),e.replaceChildren(),x=[],T=[],P=[],w=[],Y=[],V=[],L=new Map,C=new Map}}}function ys(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function Wr(e,t){return e.filter(r=>{let n=ys(r);return!(n&&t.has(n))})}async function Dc(e){try{if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")return await navigator.clipboard.writeText(String(e)),!0;let t=document.createElement("textarea");t.value=String(e),t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select();let r=!1;try{r=document.execCommand("copy")}finally{t.remove()}return r}catch{return!1}}async function hr(e){let t=String(e);if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{return await navigator.clipboard.writeText(t),!0}catch{}try{let r=document.createElement("textarea");r.value=t,r.style.position="fixed",r.style.left="-9999px",document.body.appendChild(r),r.select();let n=!1;try{n=document.execCommand("copy")}finally{r.remove()}return n}catch{return!1}}var Aa="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function ft(e){return typeof e=="number"&&Number.isFinite(e)?e:0}var Zt=["input_tokens","output_tokens","cache_read_input_tokens","cache_creation_input_tokens"],Gr=[...Zt,"reasoning_output_tokens"],Pc=["implementation","review-consult"];function ks(e){let t=0;for(let r of Zt)t+=ft(e?.[r]);return t}function Mc(e){return!e||typeof e!="object"?!1:Zt.some(t=>Number.isFinite(e[t]))}function wa(e){return!e||typeof e!="object"?!1:Gr.some(t=>Number.isFinite(e[t]))}function Nc(e){let t={};for(let r of Gr)e&&Number.isFinite(e[r])&&(t[r]=e[r]);return t}function $a(e){let t={};for(let r of Gr)Number.isFinite(e[r])&&(t[r]=e[r]);return e.replayed===!0&&(t.replayed=!0),typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)&&(t.total_cost_usd=e.total_cost_usd),t}function xa(e,t){return e==="codex"?ft(t.input_tokens)+ft(t.output_tokens):ks(t)}function Fc(e){return e==="claude"?"Claude":"Codex"}function qc(e){return`\u03C4 ${Ta(e)}`}function Bc(e,t){let r=t.breakdown||{},n=[`\uC785\uB825 ${ft(r.input_tokens).toLocaleString("en-US")}`,`\uCD9C\uB825 ${ft(r.output_tokens).toLocaleString("en-US")}`];e==="claude"?n.push(`\uCE90\uC2DC\uC77D\uAE30 ${ft(r.cache_read_input_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC0DD\uC131 ${ft(r.cache_creation_input_tokens).toLocaleString("en-US")}`):(n.push(`\uCE90\uC2DC\uC77D\uAE30 ${ft(r.cache_read_input_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC4F0\uAE30 ${ft(r.cache_creation_input_tokens).toLocaleString("en-US")}`),Number.isFinite(r.reasoning_output_tokens)&&n.push(`\uCD94\uB860\uCD9C\uB825 ${ft(r.reasoning_output_tokens).toLocaleString("en-US")}`));let o=[e==="claude"?"Claude subtotal = \uC785\uB825 + \uCD9C\uB825 + \uCE90\uC2DC\uC77D\uAE30 + \uCE90\uC2DC\uC0DD\uC131":"Codex subtotal = \uC785\uB825 + \uCD9C\uB825; \uCE90\uC2DC\uC77D\uAE30\xB7\uCE90\uC2DC\uC4F0\uAE30\xB7\uCD94\uB860\uCD9C\uB825\uC740 subtotal\uC5D0 \uD3EC\uD568\uB418\uC9C0 \uC54A\uB294 subset",`\uCD1D ${t.subtotal.toLocaleString("en-US")}`,n.join(" \xB7 ")];return typeof t.total_cost_usd=="number"&&Number.isFinite(t.total_cost_usd)&&o.push(`$${t.total_cost_usd.toFixed(2)}`),t.replayed&&o.push(Aa),o.join(`
`)}function gt(e){let t=[];if(!e||typeof e!="object"||!("providers"in e)||!e.providers)return t;for(let r of["claude","codex"]){let n=e.providers[r];n&&t.push({provider:r,label:`${Fc(r)} ${qc(n.subtotal)}${typeof n.total_cost_usd=="number"&&Number.isFinite(n.total_cost_usd)?` \xB7 $${n.total_cost_usd.toFixed(2)}`:""}`,tooltip:Bc(r,n)})}return t}function In(e){let t={},r={claude:!0,codex:!1},n={claude:0,codex:0};for(let s of e)if(!(!s||!s.providers))for(let o of["claude","codex"]){let a=s.providers[o];if(!a)continue;let i=t[o];i||(i={subtotal:0,breakdown:{}},t[o]=i),i.subtotal+=a.subtotal;for(let l of Gr)Number.isFinite(a.breakdown[l])&&(i.breakdown[l]=ft(i.breakdown[l])+ft(a.breakdown[l]));a.replayed&&(i.replayed=!0),o==="claude"&&(typeof a.total_cost_usd=="number"&&Number.isFinite(a.total_cost_usd)?n.claude+=a.total_cost_usd:r.claude=!1)}return t.claude&&r.claude&&(t.claude.total_cost_usd=n.claude),Object.keys(t).length===0?null:{providers:t,roles:{}}}function ws(e){return!e||typeof e!="object"?null:Ot({attempt:{...e,bead_id:"__attempt__"}},"__attempt__")}function Uc(e){return e==="codex"?"codex":"claude"}function or(){return{subtotal:0,breakdown:Nc(null),legs:[],replayed:!1,outer_count:0,outer_cost:0,outer_cost_count:0}}function Rn(e,t,r){e.subtotal+=t.subtotal;for(let n of Gr)Number.isFinite(t.usage[n])&&(e.breakdown[n]=ft(e.breakdown[n])+ft(t.usage[n]));e.legs.push(t),t.replayed===!0&&(e.replayed=!0),r&&(e.outer_count+=1,typeof t.usage.total_cost_usd=="number"&&Number.isFinite(t.usage.total_cost_usd)&&(e.outer_cost+=t.usage.total_cost_usd,e.outer_cost_count+=1))}function Sa(e,t){let r={subtotal:e.subtotal,breakdown:e.breakdown};return t&&(r.legs=e.legs),e.replayed&&(r.replayed=!0),r}function Ta(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}function Rr(e){return Mc(e)?`\u03C4 ${Ta(ks(e))}`:null}function qt(e){let t=Rr(e);if(!t)return null;let r=e?.total_cost_usd;return typeof r=="number"&&Number.isFinite(r)?`${t} \xB7 $${r.toFixed(2)}`:t}function Ir(e){if(!e||typeof e!="object")return"";let t=[`\uC785\uB825 ${ft(e.input_tokens).toLocaleString("en-US")}`,`\uCD9C\uB825 ${ft(e.output_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC77D\uAE30 ${ft(e.cache_read_input_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC0DD\uC131 ${ft(e.cache_creation_input_tokens).toLocaleString("en-US")}`];typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)&&t.push(`$${e.total_cost_usd.toFixed(2)}`);let r=[`\uCD1D ${ks(e).toLocaleString("en-US")}`,t.join(" \xB7 ")];return e.replayed&&r.push(Aa),r.join(`
`)}function Ot(e,t){let r={claude:or(),codex:or()},n={orchestrator:{claude:or(),codex:or()},implementation:{claude:or(),codex:or()},"review-consult":{claude:or(),codex:or()}},s=new Set;for(let i of Object.values(e||{})){if(!i||i.bead_id!==t)continue;let l=i.usage;if(wa(l)){let p=Uc(i.runner),f=$a(l),g={provider:p,role:"orchestrator",attempt_id:String(i.attempt_id||""),usage:f,subtotal:xa(p,f)};f.replayed===!0&&(g.replayed=!0),typeof i.model=="string"&&(g.model=i.model),typeof i.session_id=="string"&&(g.session_id=i.session_id),Rn(r[p],g,!0),Rn(n.orchestrator[p],g,!0)}let d=Array.isArray(i.usage_legs)?i.usage_legs:[];for(let p of d){if(!p||p.provider!=="codex"||!Pc.includes(p.role)||!wa(p.usage))continue;let f=typeof p.receipt_id=="string"&&p.receipt_id.length>0?p.receipt_id:null;if(!f||s.has(f))continue;s.add(f);let g=$a(p.usage),A={provider:"codex",role:p.role,attempt_id:String(i.attempt_id||""),usage:g,subtotal:xa("codex",g)};A.receipt_id=f,typeof p.model=="string"&&(A.model=p.model),typeof p.session_id=="string"?A.session_id=p.session_id:typeof p.thread_id=="string"&&(A.session_id=p.thread_id),typeof p.turn_id=="string"&&(A.turn_id=p.turn_id),typeof p.completed_at=="string"&&(A.completed_at=p.completed_at),g.replayed===!0&&(A.replayed=!0),Rn(r.codex,A,!1),Rn(n[A.role].codex,A,!1)}}let o={};for(let i of["claude","codex"]){let l=r[i];if(l.legs.length===0)continue;let d=Sa(l,!1);i==="claude"&&l.outer_count>0&&l.outer_cost_count===l.outer_count&&(d.total_cost_usd=l.outer_cost),o[i]=d}if(Object.keys(o).length===0)return null;let a={};for(let i of["orchestrator","implementation","review-consult"]){let l={};for(let d of["claude","codex"]){let p=n[i][d];p.legs.length>0&&(l[d]={...Sa(p,!0),legs:p.legs})}Object.keys(l).length>0&&(a[i]=l)}return{providers:o,roles:a}}var{entries:Ma,setPrototypeOf:Ea,isFrozen:jc,getPrototypeOf:zc,getOwnPropertyDescriptor:Hc}=Object,{freeze:kt,seal:Dt,create:Cs}=Object,{apply:Rs,construct:Is}=typeof Reflect<"u"&&Reflect;kt||(kt=function(t){return t});Dt||(Dt=function(t){return t});Rs||(Rs=function(t,r){for(var n=arguments.length,s=new Array(n>2?n-2:0),o=2;o<n;o++)s[o-2]=arguments[o];return t.apply(r,s)});Is||(Is=function(t){for(var r=arguments.length,n=new Array(r>1?r-1:0),s=1;s<r;s++)n[s-1]=arguments[s];return new t(...n)});var Ln=wt(Array.prototype.forEach),Wc=wt(Array.prototype.lastIndexOf),Ca=wt(Array.prototype.pop),Yr=wt(Array.prototype.push),Gc=wt(Array.prototype.splice),Dn=wt(String.prototype.toLowerCase),$s=wt(String.prototype.toString),xs=wt(String.prototype.match),Vr=wt(String.prototype.replace),Yc=wt(String.prototype.indexOf),Vc=wt(String.prototype.trim),Bt=wt(Object.prototype.hasOwnProperty),yt=wt(RegExp.prototype.test),Kr=Kc(TypeError);function wt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var r=arguments.length,n=new Array(r>1?r-1:0),s=1;s<r;s++)n[s-1]=arguments[s];return Rs(e,t,n)}}function Kc(e){return function(){for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];return Is(e,r)}}function Pe(e,t){let r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Dn;Ea&&Ea(e,null);let n=t.length;for(;n--;){let s=t[n];if(typeof s=="string"){let o=r(s);o!==s&&(jc(t)||(t[n]=o),s=o)}e[s]=!0}return e}function Zc(e){for(let t=0;t<e.length;t++)Bt(e,t)||(e[t]=null);return e}function Xt(e){let t=Cs(null);for(let[r,n]of Ma(e))Bt(e,r)&&(Array.isArray(n)?t[r]=Zc(n):n&&typeof n=="object"&&n.constructor===Object?t[r]=Xt(n):t[r]=n);return t}function Zr(e,t){for(;e!==null;){let n=Hc(e,t);if(n){if(n.get)return wt(n.get);if(typeof n.value=="function")return wt(n.value)}e=zc(e)}function r(){return null}return r}var Ra=kt(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Ss=kt(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),As=kt(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Xc=kt(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ts=kt(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Qc=kt(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Ia=kt(["#text"]),La=kt(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),Es=kt(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Oa=kt(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),On=kt(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Jc=Dt(/\{\{[\w\W]*|[\w\W]*\}\}/gm),ed=Dt(/<%[\w\W]*|[\w\W]*%>/gm),td=Dt(/\$\{[\w\W]*/gm),rd=Dt(/^data-[\-\w.\u00B7-\uFFFF]+$/),nd=Dt(/^aria-[\-\w]+$/),Na=Dt(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),sd=Dt(/^(?:\w+script|data):/i),od=Dt(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Fa=Dt(/^html$/i),ad=Dt(/^[a-z][.\w]*(-[.\w]+)+$/i),Da=Object.freeze({__proto__:null,ARIA_ATTR:nd,ATTR_WHITESPACE:od,CUSTOM_ELEMENT:ad,DATA_ATTR:rd,DOCTYPE_NAME:Fa,ERB_EXPR:ed,IS_ALLOWED_URI:Na,IS_SCRIPT_OR_DATA:sd,MUSTACHE_EXPR:Jc,TMPLIT_EXPR:td}),Xr={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},id=function(){return typeof window>"u"?null:window},ld=function(t,r){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null,s="data-tt-policy-suffix";r&&r.hasAttribute(s)&&(n=r.getAttribute(s));let o="dompurify"+(n?"#"+n:"");try{return t.createPolicy(o,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}},Pa=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function qa(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:id(),t=Q=>qa(Q);if(t.version="3.3.0",t.removed=[],!e||!e.document||e.document.nodeType!==Xr.document||!e.Element)return t.isSupported=!1,t;let{document:r}=e,n=r,s=n.currentScript,{DocumentFragment:o,HTMLTemplateElement:a,Node:i,Element:l,NodeFilter:d,NamedNodeMap:p=e.NamedNodeMap||e.MozNamedAttrMap,HTMLFormElement:f,DOMParser:g,trustedTypes:A}=e,x=l.prototype,T=Zr(x,"cloneNode"),P=Zr(x,"remove"),w=Zr(x,"nextSibling"),Y=Zr(x,"childNodes"),V=Zr(x,"parentNode");if(typeof a=="function"){let Q=r.createElement("template");Q.content&&Q.content.ownerDocument&&(r=Q.content.ownerDocument)}let q,E="",{implementation:S,createNodeIterator:L,createDocumentFragment:C,getElementsByTagName:ce}=r,{importNode:$e}=n,le=Pa();t.isSupported=typeof Ma=="function"&&typeof V=="function"&&S&&S.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:me,ERB_EXPR:Le,TMPLIT_EXPR:Ge,DATA_ATTR:Ye,ARIA_ATTR:Me,IS_SCRIPT_OR_DATA:Be,ATTR_WHITESPACE:ge,CUSTOM_ELEMENT:ye}=Da,{IS_ALLOWED_URI:Re}=Da,J=null,H=Pe({},[...Ra,...Ss,...As,...Ts,...Ia]),X=null,Oe=Pe({},[...La,...Es,...Oa,...On]),_e=Object.seal(Cs(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ke=null,B=null,O=Object.seal(Cs(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),oe=!0,ve=!0,Ae=!1,Ze=!0,Ie=!1,D=!0,U=!1,R=!1,y=!1,z=!1,N=!1,K=!1,ae=!0,xe=!1,De="user-content-",at=!0,it=!1,lt={},ze=null,Pt=Pe({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),vt=null,_t=Pe({},["audio","video","img","source","image","track"]),dt=null,Ne=Pe({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),tt="http://www.w3.org/1998/Math/MathML",ut="http://www.w3.org/2000/svg",nt="http://www.w3.org/1999/xhtml",st=nt,pt=!1,M=null,W=Pe({},[tt,ut,nt],$s),ie=Pe({},["mi","mo","mn","ms","mtext"]),ue=Pe({},["annotation-xml"]),he=Pe({},["title","style","font","a","script"]),Te=null,He=["application/xhtml+xml","text/html"],Xe="text/html",Ee=null,Ve=null,u=r.createElement("form"),k=function(b){return b instanceof RegExp||b instanceof Function},j=function(){let b=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Ve&&Ve===b)){if((!b||typeof b!="object")&&(b={}),b=Xt(b),Te=He.indexOf(b.PARSER_MEDIA_TYPE)===-1?Xe:b.PARSER_MEDIA_TYPE,Ee=Te==="application/xhtml+xml"?$s:Dn,J=Bt(b,"ALLOWED_TAGS")?Pe({},b.ALLOWED_TAGS,Ee):H,X=Bt(b,"ALLOWED_ATTR")?Pe({},b.ALLOWED_ATTR,Ee):Oe,M=Bt(b,"ALLOWED_NAMESPACES")?Pe({},b.ALLOWED_NAMESPACES,$s):W,dt=Bt(b,"ADD_URI_SAFE_ATTR")?Pe(Xt(Ne),b.ADD_URI_SAFE_ATTR,Ee):Ne,vt=Bt(b,"ADD_DATA_URI_TAGS")?Pe(Xt(_t),b.ADD_DATA_URI_TAGS,Ee):_t,ze=Bt(b,"FORBID_CONTENTS")?Pe({},b.FORBID_CONTENTS,Ee):Pt,ke=Bt(b,"FORBID_TAGS")?Pe({},b.FORBID_TAGS,Ee):Xt({}),B=Bt(b,"FORBID_ATTR")?Pe({},b.FORBID_ATTR,Ee):Xt({}),lt=Bt(b,"USE_PROFILES")?b.USE_PROFILES:!1,oe=b.ALLOW_ARIA_ATTR!==!1,ve=b.ALLOW_DATA_ATTR!==!1,Ae=b.ALLOW_UNKNOWN_PROTOCOLS||!1,Ze=b.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Ie=b.SAFE_FOR_TEMPLATES||!1,D=b.SAFE_FOR_XML!==!1,U=b.WHOLE_DOCUMENT||!1,z=b.RETURN_DOM||!1,N=b.RETURN_DOM_FRAGMENT||!1,K=b.RETURN_TRUSTED_TYPE||!1,y=b.FORCE_BODY||!1,ae=b.SANITIZE_DOM!==!1,xe=b.SANITIZE_NAMED_PROPS||!1,at=b.KEEP_CONTENT!==!1,it=b.IN_PLACE||!1,Re=b.ALLOWED_URI_REGEXP||Na,st=b.NAMESPACE||nt,ie=b.MATHML_TEXT_INTEGRATION_POINTS||ie,ue=b.HTML_INTEGRATION_POINTS||ue,_e=b.CUSTOM_ELEMENT_HANDLING||{},b.CUSTOM_ELEMENT_HANDLING&&k(b.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(_e.tagNameCheck=b.CUSTOM_ELEMENT_HANDLING.tagNameCheck),b.CUSTOM_ELEMENT_HANDLING&&k(b.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(_e.attributeNameCheck=b.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),b.CUSTOM_ELEMENT_HANDLING&&typeof b.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(_e.allowCustomizedBuiltInElements=b.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Ie&&(ve=!1),N&&(z=!0),lt&&(J=Pe({},Ia),X=[],lt.html===!0&&(Pe(J,Ra),Pe(X,La)),lt.svg===!0&&(Pe(J,Ss),Pe(X,Es),Pe(X,On)),lt.svgFilters===!0&&(Pe(J,As),Pe(X,Es),Pe(X,On)),lt.mathMl===!0&&(Pe(J,Ts),Pe(X,Oa),Pe(X,On))),b.ADD_TAGS&&(typeof b.ADD_TAGS=="function"?O.tagCheck=b.ADD_TAGS:(J===H&&(J=Xt(J)),Pe(J,b.ADD_TAGS,Ee))),b.ADD_ATTR&&(typeof b.ADD_ATTR=="function"?O.attributeCheck=b.ADD_ATTR:(X===Oe&&(X=Xt(X)),Pe(X,b.ADD_ATTR,Ee))),b.ADD_URI_SAFE_ATTR&&Pe(dt,b.ADD_URI_SAFE_ATTR,Ee),b.FORBID_CONTENTS&&(ze===Pt&&(ze=Xt(ze)),Pe(ze,b.FORBID_CONTENTS,Ee)),at&&(J["#text"]=!0),U&&Pe(J,["html","head","body"]),J.table&&(Pe(J,["tbody"]),delete ke.tbody),b.TRUSTED_TYPES_POLICY){if(typeof b.TRUSTED_TYPES_POLICY.createHTML!="function")throw Kr('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof b.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Kr('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');q=b.TRUSTED_TYPES_POLICY,E=q.createHTML("")}else q===void 0&&(q=ld(A,s)),q!==null&&typeof E=="string"&&(E=q.createHTML(""));kt&&kt(b),Ve=b}},pe=Pe({},[...Ss,...As,...Xc]),be=Pe({},[...Ts,...Qc]),we=function(b){let G=V(b);(!G||!G.tagName)&&(G={namespaceURI:st,tagName:"template"});let _=Dn(b.tagName),v=Dn(G.tagName);return M[b.namespaceURI]?b.namespaceURI===ut?G.namespaceURI===nt?_==="svg":G.namespaceURI===tt?_==="svg"&&(v==="annotation-xml"||ie[v]):!!pe[_]:b.namespaceURI===tt?G.namespaceURI===nt?_==="math":G.namespaceURI===ut?_==="math"&&ue[v]:!!be[_]:b.namespaceURI===nt?G.namespaceURI===ut&&!ue[v]||G.namespaceURI===tt&&!ie[v]?!1:!be[_]&&(he[_]||!pe[_]):!!(Te==="application/xhtml+xml"&&M[b.namespaceURI]):!1},se=function(b){Yr(t.removed,{element:b});try{V(b).removeChild(b)}catch{P(b)}},Se=function(b,G){try{Yr(t.removed,{attribute:G.getAttributeNode(b),from:G})}catch{Yr(t.removed,{attribute:null,from:G})}if(G.removeAttribute(b),b==="is")if(z||N)try{se(G)}catch{}else try{G.setAttribute(b,"")}catch{}},fe=function(b){let G=null,_=null;if(y)b="<remove></remove>"+b;else{let ne=xs(b,/^[\r\n\t ]+/);_=ne&&ne[0]}Te==="application/xhtml+xml"&&st===nt&&(b='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+b+"</body></html>");let v=q?q.createHTML(b):b;if(st===nt)try{G=new g().parseFromString(v,Te)}catch{}if(!G||!G.documentElement){G=S.createDocument(st,"template",null);try{G.documentElement.innerHTML=pt?E:v}catch{}}let re=G.body||G.documentElement;return b&&_&&re.insertBefore(r.createTextNode(_),re.childNodes[0]||null),st===nt?ce.call(G,U?"html":"body")[0]:U?G.documentElement:re},Qe=function(b){return L.call(b.ownerDocument||b,b,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT|d.SHOW_PROCESSING_INSTRUCTION|d.SHOW_CDATA_SECTION,null)},St=function(b){return b instanceof f&&(typeof b.nodeName!="string"||typeof b.textContent!="string"||typeof b.removeChild!="function"||!(b.attributes instanceof p)||typeof b.removeAttribute!="function"||typeof b.setAttribute!="function"||typeof b.namespaceURI!="string"||typeof b.insertBefore!="function"||typeof b.hasChildNodes!="function")},mt=function(b){return typeof i=="function"&&b instanceof i};function Je(Q,b,G){Ln(Q,_=>{_.call(t,b,G,Ve)})}let At=function(b){let G=null;if(Je(le.beforeSanitizeElements,b,null),St(b))return se(b),!0;let _=Ee(b.nodeName);if(Je(le.uponSanitizeElement,b,{tagName:_,allowedTags:J}),D&&b.hasChildNodes()&&!mt(b.firstElementChild)&&yt(/<[/\w!]/g,b.innerHTML)&&yt(/<[/\w!]/g,b.textContent)||b.nodeType===Xr.progressingInstruction||D&&b.nodeType===Xr.comment&&yt(/<[/\w]/g,b.data))return se(b),!0;if(!(O.tagCheck instanceof Function&&O.tagCheck(_))&&(!J[_]||ke[_])){if(!ke[_]&&Et(_)&&(_e.tagNameCheck instanceof RegExp&&yt(_e.tagNameCheck,_)||_e.tagNameCheck instanceof Function&&_e.tagNameCheck(_)))return!1;if(at&&!ze[_]){let v=V(b)||b.parentNode,re=Y(b)||b.childNodes;if(re&&v){let ne=re.length;for(let ee=ne-1;ee>=0;--ee){let m=T(re[ee],!0);m.__removalCount=(b.__removalCount||0)+1,v.insertBefore(m,w(b))}}}return se(b),!0}return b instanceof l&&!we(b)||(_==="noscript"||_==="noembed"||_==="noframes")&&yt(/<\/no(script|embed|frames)/i,b.innerHTML)?(se(b),!0):(Ie&&b.nodeType===Xr.text&&(G=b.textContent,Ln([me,Le,Ge],v=>{G=Vr(G,v," ")}),b.textContent!==G&&(Yr(t.removed,{element:b.cloneNode()}),b.textContent=G)),Je(le.afterSanitizeElements,b,null),!1)},Mt=function(b,G,_){if(ae&&(G==="id"||G==="name")&&(_ in r||_ in u))return!1;if(!(ve&&!B[G]&&yt(Ye,G))){if(!(oe&&yt(Me,G))){if(!(O.attributeCheck instanceof Function&&O.attributeCheck(G,b))){if(!X[G]||B[G]){if(!(Et(b)&&(_e.tagNameCheck instanceof RegExp&&yt(_e.tagNameCheck,b)||_e.tagNameCheck instanceof Function&&_e.tagNameCheck(b))&&(_e.attributeNameCheck instanceof RegExp&&yt(_e.attributeNameCheck,G)||_e.attributeNameCheck instanceof Function&&_e.attributeNameCheck(G,b))||G==="is"&&_e.allowCustomizedBuiltInElements&&(_e.tagNameCheck instanceof RegExp&&yt(_e.tagNameCheck,_)||_e.tagNameCheck instanceof Function&&_e.tagNameCheck(_))))return!1}else if(!dt[G]){if(!yt(Re,Vr(_,ge,""))){if(!((G==="src"||G==="xlink:href"||G==="href")&&b!=="script"&&Yc(_,"data:")===0&&vt[b])){if(!(Ae&&!yt(Be,Vr(_,ge,"")))){if(_)return!1}}}}}}}return!0},Et=function(b){return b!=="annotation-xml"&&xs(b,ye)},Ct=function(b){Je(le.beforeSanitizeAttributes,b,null);let{attributes:G}=b;if(!G||St(b))return;let _={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:X,forceKeepAttr:void 0},v=G.length;for(;v--;){let re=G[v],{name:ne,namespaceURI:ee,value:m}=re,I=Ee(ne),$=m,Z=ne==="value"?$:Vc($);if(_.attrName=I,_.attrValue=Z,_.keepAttr=!0,_.forceKeepAttr=void 0,Je(le.uponSanitizeAttribute,b,_),Z=_.attrValue,xe&&(I==="id"||I==="name")&&(Se(ne,b),Z=De+Z),D&&yt(/((--!?|])>)|<\/(style|title|textarea)/i,Z)){Se(ne,b);continue}if(I==="attributename"&&xs(Z,"href")){Se(ne,b);continue}if(_.forceKeepAttr)continue;if(!_.keepAttr){Se(ne,b);continue}if(!Ze&&yt(/\/>/i,Z)){Se(ne,b);continue}Ie&&Ln([me,Le,Ge],ot=>{Z=Vr(Z,ot," ")});let Ue=Ee(b.nodeName);if(!Mt(Ue,I,Z)){Se(ne,b);continue}if(q&&typeof A=="object"&&typeof A.getAttributeType=="function"&&!ee)switch(A.getAttributeType(Ue,I)){case"TrustedHTML":{Z=q.createHTML(Z);break}case"TrustedScriptURL":{Z=q.createScriptURL(Z);break}}if(Z!==$)try{ee?b.setAttributeNS(ee,ne,Z):b.setAttribute(ne,Z),St(b)?se(b):Ca(t.removed)}catch{Se(ne,b)}}Je(le.afterSanitizeAttributes,b,null)},Ce=function Q(b){let G=null,_=Qe(b);for(Je(le.beforeSanitizeShadowDOM,b,null);G=_.nextNode();)Je(le.uponSanitizeShadowNode,G,null),At(G),Ct(G),G.content instanceof o&&Q(G.content);Je(le.afterSanitizeShadowDOM,b,null)};return t.sanitize=function(Q){let b=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},G=null,_=null,v=null,re=null;if(pt=!Q,pt&&(Q="<!-->"),typeof Q!="string"&&!mt(Q))if(typeof Q.toString=="function"){if(Q=Q.toString(),typeof Q!="string")throw Kr("dirty is not a string, aborting")}else throw Kr("toString is not a function");if(!t.isSupported)return Q;if(R||j(b),t.removed=[],typeof Q=="string"&&(it=!1),it){if(Q.nodeName){let m=Ee(Q.nodeName);if(!J[m]||ke[m])throw Kr("root node is forbidden and cannot be sanitized in-place")}}else if(Q instanceof i)G=fe("<!---->"),_=G.ownerDocument.importNode(Q,!0),_.nodeType===Xr.element&&_.nodeName==="BODY"||_.nodeName==="HTML"?G=_:G.appendChild(_);else{if(!z&&!Ie&&!U&&Q.indexOf("<")===-1)return q&&K?q.createHTML(Q):Q;if(G=fe(Q),!G)return z?null:K?E:""}G&&y&&se(G.firstChild);let ne=Qe(it?Q:G);for(;v=ne.nextNode();)At(v),Ct(v),v.content instanceof o&&Ce(v.content);if(it)return Q;if(z){if(N)for(re=C.call(G.ownerDocument);G.firstChild;)re.appendChild(G.firstChild);else re=G;return(X.shadowroot||X.shadowrootmode)&&(re=$e.call(n,re,!0)),re}let ee=U?G.outerHTML:G.innerHTML;return U&&J["!doctype"]&&G.ownerDocument&&G.ownerDocument.doctype&&G.ownerDocument.doctype.name&&yt(Fa,G.ownerDocument.doctype.name)&&(ee="<!DOCTYPE "+G.ownerDocument.doctype.name+`>
`+ee),Ie&&Ln([me,Le,Ge],m=>{ee=Vr(ee,m," ")}),q&&K?q.createHTML(ee):ee},t.setConfig=function(){let Q=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};j(Q),R=!0},t.clearConfig=function(){Ve=null,R=!1},t.isValidAttribute=function(Q,b,G){Ve||j({});let _=Ee(Q),v=Ee(b);return Mt(_,v,G)},t.addHook=function(Q,b){typeof b=="function"&&Yr(le[Q],b)},t.removeHook=function(Q,b){if(b!==void 0){let G=Wc(le[Q],b);return G===-1?void 0:Gc(le[Q],G,1)[0]}return Ca(le[Q])},t.removeHooks=function(Q){le[Q]=[]},t.removeAllHooks=function(){le=Pa()},t}var Ba=qa();var Ua={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ja=e=>(...t)=>({_$litDirective$:e,values:t}),Pn=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,n){this._$Ct=t,this._$AM=r,this._$Ci=n}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Qr=class extends Pn{constructor(t){if(super(t),this.it=ct,t.type!==Ua.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===ct||t==null)return this._t=void 0,this.it=t;if(t===_r)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Qr.directiveName="unsafeHTML",Qr.resultType=1;var za=ja(Qr);function Ps(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var vr=Ps();function Za(e){vr=e}var rn={exec:()=>null};function je(e,t=""){let r=typeof e=="string"?e:e.source,n={replace:(s,o)=>{let a=typeof o=="string"?o:o.source;return a=a.replace($t.caret,"$1"),r=r.replace(s,a),n},getRegex:()=>new RegExp(r,t)};return n}var cd=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),$t={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},dd=/^(?:[ \t]*(?:\n|$))+/,ud=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,pd=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,nn=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,fd=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Ms=/(?:[*+-]|\d{1,9}[.)])/,Xa=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Qa=je(Xa).replace(/bull/g,Ms).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),_d=je(Xa).replace(/bull/g,Ms).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ns=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,md=/^[^\n]+/,Fs=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,gd=je(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Fs).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),hd=je(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Ms).getRegex(),Un="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",qs=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,bd=je("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",qs).replace("tag",Un).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ja=je(Ns).replace("hr",nn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Un).getRegex(),vd=je(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ja).getRegex(),Bs={blockquote:vd,code:ud,def:gd,fences:pd,heading:fd,hr:nn,html:bd,lheading:Qa,list:hd,newline:dd,paragraph:Ja,table:rn,text:md},Ha=je("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",nn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Un).getRegex(),yd={...Bs,lheading:_d,table:Ha,paragraph:je(Ns).replace("hr",nn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ha).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Un).getRegex()},kd={...Bs,html:je(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",qs).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:rn,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:je(Ns).replace("hr",nn).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Qa).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},wd=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,$d=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ei=/^( {2,}|\\)\n(?!\s*$)/,xd=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,jn=/[\p{P}\p{S}]/u,Us=/[\s\p{P}\p{S}]/u,ti=/[^\s\p{P}\p{S}]/u,Sd=je(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Us).getRegex(),ri=/(?!~)[\p{P}\p{S}]/u,Ad=/(?!~)[\s\p{P}\p{S}]/u,Td=/(?:[^\s\p{P}\p{S}]|~)/u,Ed=je(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",cd?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ni=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Cd=je(ni,"u").replace(/punct/g,jn).getRegex(),Rd=je(ni,"u").replace(/punct/g,ri).getRegex(),si="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Id=je(si,"gu").replace(/notPunctSpace/g,ti).replace(/punctSpace/g,Us).replace(/punct/g,jn).getRegex(),Ld=je(si,"gu").replace(/notPunctSpace/g,Td).replace(/punctSpace/g,Ad).replace(/punct/g,ri).getRegex(),Od=je("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ti).replace(/punctSpace/g,Us).replace(/punct/g,jn).getRegex(),Dd=je(/\\(punct)/,"gu").replace(/punct/g,jn).getRegex(),Pd=je(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Md=je(qs).replace("(?:-->|$)","-->").getRegex(),Nd=je("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Md).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Fn=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Fd=je(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Fn).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),oi=je(/^!?\[(label)\]\[(ref)\]/).replace("label",Fn).replace("ref",Fs).getRegex(),ai=je(/^!?\[(ref)\](?:\[\])?/).replace("ref",Fs).getRegex(),qd=je("reflink|nolink(?!\\()","g").replace("reflink",oi).replace("nolink",ai).getRegex(),Wa=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,js={_backpedal:rn,anyPunctuation:Dd,autolink:Pd,blockSkip:Ed,br:ei,code:$d,del:rn,emStrongLDelim:Cd,emStrongRDelimAst:Id,emStrongRDelimUnd:Od,escape:wd,link:Fd,nolink:ai,punctuation:Sd,reflink:oi,reflinkSearch:qd,tag:Nd,text:xd,url:rn},Bd={...js,link:je(/^!?\[(label)\]\((.*?)\)/).replace("label",Fn).getRegex(),reflink:je(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Fn).getRegex()},Ls={...js,emStrongRDelimAst:Ld,emStrongLDelim:Rd,url:je(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Wa).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:je(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Wa).getRegex()},Ud={...Ls,br:je(ei).replace("{2,}","*").getRegex(),text:je(Ls.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Mn={normal:Bs,gfm:yd,pedantic:kd},Jr={normal:js,gfm:Ls,breaks:Ud,pedantic:Bd},jd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ga=e=>jd[e];function Qt(e,t){if(t){if($t.escapeTest.test(e))return e.replace($t.escapeReplace,Ga)}else if($t.escapeTestNoEncode.test(e))return e.replace($t.escapeReplaceNoEncode,Ga);return e}function Ya(e){try{e=encodeURI(e).replace($t.percentDecode,"%")}catch{return null}return e}function Va(e,t){let r=e.replace($t.findPipe,(o,a,i)=>{let l=!1,d=a;for(;--d>=0&&i[d]==="\\";)l=!l;return l?"|":" |"}),n=r.split($t.splitPipe),s=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;s<n.length;s++)n[s]=n[s].trim().replace($t.slashPipe,"|");return n}function en(e,t,r){let n=e.length;if(n===0)return"";let s=0;for(;s<n;){let o=e.charAt(n-s-1);if(o===t&&!r)s++;else if(o!==t&&r)s++;else break}return e.slice(0,n-s)}function zd(e,t){if(e.indexOf(t[1])===-1)return-1;let r=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])r++;else if(e[n]===t[1]&&(r--,r<0))return n;return r>0?-2:-1}function Ka(e,t,r,n,s){let o=t.href,a=t.title||null,i=e[1].replace(s.other.outputLinkReplace,"$1");n.state.inLink=!0;let l={type:e[0].charAt(0)==="!"?"image":"link",raw:r,href:o,title:a,text:i,tokens:n.inlineTokens(i)};return n.state.inLink=!1,l}function Hd(e,t,r){let n=e.match(r.other.indentCodeCompensation);if(n===null)return t;let s=n[1];return t.split(`
`).map(o=>{let a=o.match(r.other.beginningSpace);if(a===null)return o;let[i]=a;return i.length>=s.length?o.slice(s.length):o}).join(`
`)}var qn=class{constructor(e){Ke(this,"options");Ke(this,"rules");Ke(this,"lexer");this.options=e||vr}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let r=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?r:en(r,`
...
`)?"":`
`)+s.raw,a.text+=`
`+s.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):r.push(s);continue}if(t){let a="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw new Error(a)}}return this.state.top=!0,r}inline(t,r=[]){return this.inlineQueue.push({src:t,tokens:r}),r}inlineTokens(t,r=[]){let n=t,s=null;if(this.tokens.links){let l=Object.keys(this.tokens.links);if(l.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)l.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,s.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)o=s[2]?s[2].length:0,n=n.slice(0,s.index+o)+"["+"a".repeat(s[0].length-o-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);n=this.options.hooks?.emStrongMask?.call({lexer:this},n)??n;let a=!1,i="";for(;t;){a||(i=""),a=!1;let l;if(this.options.extensions?.inline?.some(p=>(l=p.call({lexer:this},t,r))?(t=t.substring(l.raw.length),r.push(l),!0):!1))continue;if(l=this.tokenizer.escape(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.tag(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.link(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(l.raw.length);let p=r.at(-1);l.type==="text"&&p?.type==="text"?(p.raw+=l.raw,p.text+=l.text):r.push(l);continue}if(l=this.tokenizer.emStrong(t,n,i)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.codespan(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.br(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.del(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.autolink(t)){t=t.substring(l.raw.length),r.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(t))){t=t.substring(l.raw.length),r.push(l);continue}let d=t;if(this.options.extensions?.startInline){let p=1/0,f=t.slice(1),g;this.options.extensions.startInline.forEach(A=>{g=A.call({lexer:this},f),typeof g=="number"&&g>=0&&(p=Math.min(p,g))}),p<1/0&&p>=0&&(d=t.substring(0,p+1))}if(l=this.tokenizer.inlineText(d)){t=t.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(i=l.raw.slice(-1)),a=!0;let p=r.at(-1);p?.type==="text"?(p.raw+=l.raw,p.text+=l.text):r.push(l);continue}if(t){let p="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(p);break}else throw new Error(p)}}return r}},Bn=class{constructor(e){Ke(this,"options");Ke(this,"parser");this.options=e||vr}space(e){return""}code({text:e,lang:t,escaped:r}){let n=(t||"").match($t.notSpaceStart)?.[0],s=e.replace($t.endingNewline,"")+`
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+Qt(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},br=new Wd;function We(e,t){return br.parse(e,t)}We.options=We.setOptions=function(e){return br.setOptions(e),We.defaults=br.defaults,Za(We.defaults),We};We.getDefaults=Ps;We.defaults=vr;We.use=function(...e){return br.use(...e),We.defaults=br.defaults,Za(We.defaults),We};We.walkTokens=function(e,t){return br.walkTokens(e,t)};We.parseInline=br.parseInline;We.Parser=jt;We.parser=jt.parse;We.Renderer=Bn;We.TextRenderer=zs;We.Lexer=Ut;We.lexer=Ut.lex;We.Tokenizer=qn;We.Hooks=tn;We.parse=We;var w_=We.options,$_=We.setOptions,x_=We.use,S_=We.walkTokens,A_=We.parseInline;var T_=jt.parse,E_=Ut.lex;function ar(e){let t=We.parse(e),r=Ba.sanitize(t);return za(r)}function Jt(e,t){return c`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      >
        ...
        @click=${()=>Re(B)}
      >
        <span class="sv__think-line">💭 ${Hn(O.text)}</span>
        ${oe?c`<pre class="sv__think-expand">${O.text}</pre>`:""}
      </div>`}if(O.kind==="error")return c`<div class="sv__error">⛔ ${O.text}</div>`;if(O.kind==="blocker")return c`<div class="sv__error">⛔ ${O.text}</div>`;if(O.kind==="tool"){let oe=l.has(B),ve=O.tool==="Bash"?ou(O.command):0,Ae=O.tool==="Bash"?ve>1?Hn(O.command):O.command:O.path||O.command||"";return c`<div
      ...
      </div>`}return c`<div class="sv__as">${ar(O.text||"")}</div>`}function Ge(B){let O=[];if(B.tool==="Bash"&&typeof B.command=="string"&&B.command.length>0)O.push(B.command);else if(B.input!==void 0)try{O.push(`input: ${JSON.stringify(B.input,null,2)}`)}catch{}return typeof B.output=="string"&&B.output.length>0&&O.push(`output:
${B.output}`),O.join(`

`)}function Ye(){if(!o)return c``;let B=E(),O=[a.runner,a.model,a.effort].filter(Boolean).join(" \xB7 "),oe=a.session_id||"",ve=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${i?"ON":"OFF"}`,Ae=L(),Ze=Ae?uu(S(),Date.now()):"",Ie=Ae?le(B):null,D=Ae?me(B):null,U=du(B);return c`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
      ...
      ${Ie||D?c`<div class="sv__now">
            ...
            ${Ie?c`<span class="sv__now-icon">${Ie.icon}</span>
                  ...
                  <span class="sv__now-detail"
                    >${Ie.tool==="Bash"?Hn(Ie.command):Ie.path||Ie.command||""}</span
                  >`:""}
    ...
    </div>`}function Be(B){d.add(B),ge()}function ge(){qe(Ye(),e),C(),i&&ye()}function ye(){let B=e.querySelector(".sv__body");B&&(B.scrollTop=B.scrollHeight)}function Re(B){l.has(B)?l.delete(B):l.add(B),ge()}function J(){i=!i,ge()}function H(B){hr(B).then(O=>{O?te("\uBCF5\uC0AC\uB428","success",1200):te("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function X(B){!o||!B||(a={...a,...B},ge())}function Oe(B){let O=B.target;if(!O||!O.classList||!O.classList.contains("sv__body"))return;!(O.scrollHeight-O.scrollTop-O.clientHeight<=4)&&i&&(i=!1,ge())}e.addEventListener("scroll",Oe,!0);function _e(B){let O=B&&B.attempt_id;O&&(o=O,a=B.meta||{},i=!0,l.clear(),d.clear(),w(),!p&&n&&(p=n.subscribe(ge)),r&&Promise.resolve(r("subscribe-session-log",{id:`session-log:${o}`,attempt_id:o})).catch(()=>{}),ge())}function ke(){let B=o;o=null,l.clear(),d.clear(),w(),ce(),r&&B&&Promise.resolve(r("unsubscribe-session-log",{id:`session-log:${B}`})).catch(()=>{}),qe(c``,e),s&&s()}return{open:_e,updateMeta:X,close:ke,isOpen(){return o!==null},destroy(){ce(),p&&(p(),p=null),e.removeEventListener("scroll",Oe,!0),o=null,qe(c``,e)}}}function sn(e){let t=e&&typeof e=="object"?e:{},r=t.metadata&&typeof t.metadata=="object"?t.metadata:{},n=ui(t.spec_id),s=ui(r.spec_id);return n?{path:n,source:"native",conflict:s.length>0&&s!==n}:s?{path:s,source:"metadata",conflict:!1}:{path:"",source:"none",conflict:!1}}function ui(e){return typeof e=="string"?e.trim():""}function pu(e){return["plan_review","plan_approval","plan_check"].some(t=>{let r=e[t];return typeof r=="string"&&r.trim().length>0})}function fu(e){let t=e&&e.metadata||{},r=sn(e),n=[];return r.path&&n.push({kind:"spec",path:r.path,missing_state:null}),typeof t.plan_path=="string"&&t.plan_path.trim().length>0&&n.push({kind:"plan",path:t.plan_path.trim(),missing_state:pu(t)?null:"plan_pending"}),n}function pi(e,t){let r=fu(e);return c`
...
`).trim()}}var _i=20;function mi(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function hu(e){return e.length>_i?`${e.slice(0,_i)}\u2026`:e}function bu(e,t,r,n){let s=`${t.lane} ${hu(t.identifier)}`;return c`<div class="detail-report">
  ...
  </span>`}function Au(e,t,r=""){let n=t&&t[e];return typeof n=="string"&&n.length>0?`(\uAE30\uBCF8: ${e==="orchestration_speed"?n==="default"?"Standard":n==="fast"?"Fast":n:n} \u2014 ${r||"\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uD504\uB9AC\uC14B"})`:Ys[e]||"(\uAE30\uBCF8)"}function Or(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function yr(e){if(!Or(e)||!Or(e.runners))return null;let t=Object.entries(e.runners).filter(([,r])=>Or(r)&&Or(r.models));return t.length>0?t:null}function Ws(e){return{value:e,label:e}}function Ks(e){return{label:null,options:[{value:e,label:`${e} (\uBE44\uD638\uD658)`}]}}function bi(e,t,r=null){let n=yr(e);if(!n)return t?[{label:null,options:[Ws(t)]}]:[];let s=n.filter(([a])=>r===null||a===r).map(([a,i])=>({label:a,options:Object.keys(i.models).map(Ws)})),o=s.some(a=>a.options.some(i=>i.value===t));return t&&!o?[Ks(t),...s]:s}function lr(e,t){let r={label:null,options:e.map(Ws)};return t&&!e.includes(t)?[Ks(t),r]:[r]}function er(e,t){let r=yr(e);if(!r||!t)return null;for(let[n,s]of r)if(Object.hasOwn(s.models,t))return n;return null}function Zs(e,t){return Or(t)&&Array.isArray(t.efforts)?t.efforts.slice():Array.isArray(e.efforts)?e.efforts.slice():[]}function Tu(e,t){return Or(t)&&Array.isArray(t.orchestration_efforts)?t.orchestration_efforts.slice():Zs(e,t)}function Eu(e,t){let r=yr(e);if(!r||!t)return[];for(let[,n]of r)if(Object.hasOwn(n.models,t))return Tu(n,n.models[t]);return[]}function Cu(e,t){let r=yr(e);if(!r||!t)return[];for(let[,n]of r){if(!Object.hasOwn(n.models,t))continue;let s=n.models[t];return Array.isArray(s.speed_tiers)?s.speed_tiers.slice():["default"]}return[]}function Xs(e,t){let r=yr(e);if(!r||!t)return[];for(let[,n]of r)if(Object.hasOwn(n.models,t))return Zs(n,n.models[t]);return[]}function ki(e){let t=yr(e);if(!t)return[];let r=[];for(let[,n]of t)for(let s of Object.values(n.models))for(let o of Zs(n,s))r.includes(o)||r.push(o);return r}function wi(e,t){if(!t)return ki(e);let n=yr(e)?.find(([o])=>o===t)?.[1];if(!n)return[];let s=[];for(let o of Object.keys(n.models))for(let a of Xs(e,o))s.includes(a)||s.push(a);return s}function Yn(e,t,r){let n={impl_runtime:e.impl_runtime||"",impl_model:e.impl_model||"",impl_effort:e.impl_effort||""},s=n.impl_runtime==="inherit"?r:n.impl_runtime==="claude"||n.impl_runtime==="codex"?n.impl_runtime:null;if(n.impl_runtime==="inherit"&&!s)return n.impl_model="",n.impl_effort="",n;let o=er(t,n.impl_model);if(n.impl_model&&(!s||o!==s))return n.impl_model="",n.impl_effort="",n;let a=n.impl_model?Xs(t,n.impl_model):wi(t,s);return n.impl_effort&&a.length>0&&!a.includes(n.impl_effort)&&(n.impl_effort=""),n}function Pr(e){let{selectedOf:t,effectiveOf:r,runner_catalog:n,controller_runtime:s}=e,o=r("orchestration_model")||Su,a=r("impl_model"),i=r("impl_runtime"),l=i==="claude"||i==="codex"?i:i==="inherit"?s===void 0?er(n,o):s:null;return Dr.map(d=>{let p=t(d),f,g=!1;return d==="orchestration_model"?f=bi(n,p):d==="impl_runtime"?f=lr(["inherit","claude","codex"],p):d==="impl_model"?(f=l?bi(n,p,l):p?[Ks(p)]:[],g=i==="inherit"&&l===null):d==="orchestration_effort"?f=lr(Eu(n,o),p):d==="orchestration_speed"?f=Ru(Cu(n,o),p):d==="impl_effort"?(f=lr(a?Xs(n,a):l?wi(n,l):ki(n),p),g=i==="inherit"&&l===null):d==="plan_review_model"?f=lr(ku,p):Object.hasOwn(hi,d)?(f=lr(wu,p),g=xu.includes(r(hi[d]))):f=lr(yu,p),{key:d,groups:f,selected:p,disabled:g,runner:d==="orchestration_model"?er(n,o):null}})}function Gn(e,t,r){return c`
  ...
  `}function Ru(e,t){return lr(e,t).map(r=>({...r,options:r.options.map(n=>{let s=n.label.endsWith("(\uBE44\uD638\uD658)"),o=n.value==="default"?"Standard":n.value==="fast"?"Fast":null;return{...n,label:s?o?`${o} (\uBE44\uD638\uD658)`:n.label:o||n.label}})}))}function vi(e,t){return c`<option value=${e.value} ?selected=${e.value===t}>
    ${e.label}
  ...
  `}function $i(e,t,r,n,s=""){let o=e&&e.metadata||{},a=r&&typeof r=="object"?r:{},i=f=>typeof o[f]=="string"?o[f]:"",d=Pr({selectedOf:i,effectiveOf:f=>{let g=i(f);return g||(typeof a[f]=="string"?a[f]:"")},runner_catalog:n}),p=o.workflow_mode==="fast_track"?"fast_track":"standard";return c`
    <div class="detail-section-label">실행 설정 (수정 가능)</div>
    ${d.map(f=>yi(f.key,Gn(f.groups,f.selected,Au(f.key,a,s)),f.selected,!1,f.disabled,f.runner,t))}
    ${yi("workflow_mode",Gn(lr($u,p),p),p,o.workflow_mode==="fast_track",!1,null,t)}
  `}function Iu(e){return String(e||"").replace(/^docs\/(superpowers\/)?/,"")}function xi(e,t){let r=t.getWorkspacePath,n=t.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",a="",i="";function l(x){x.key==="Escape"&&s&&(x.preventDefault(),g())}document.addEventListener("keydown",l);function d(){return s?c`
    ...
    `:c``}function p(){qe(d(),e)}async function f(x,T={}){s=x,o="loading",a="",i="",p();let P=r?r():"";if(!P){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",i="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let w="/api/doc?workspace="+encodeURIComponent(P)+"&path="+encodeURIComponent(x);try{let Y=await n(w),V=await Y.json().catch(()=>({}));if(!Y.ok||!V||V.ok!==!0){if(V?.error==="not_found"&&T.missing_state==="plan_pending"){o="pending",i="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",p();return}o="error",i="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(V&&V.error||Y.status)+")",p();return}a=String(V.content||""),o="ready",p()}catch{o="error",i="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function g(){s=null,qe(c``,e)}function A(){document.removeEventListener("keydown",l),g()}return{open:f,close:g,destroy:A}}var Lu=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],Ti="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function Ou(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function Du(e){let t=gt(e);if(t.length>0)return t.map(s=>c`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
        >`);let r=Rr(e);if(!r||!e)return"";let n=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?` \xB7 $${e.total_cost_usd.toFixed(2)}`:"";return c`<span
  ...
  >
    ...
    >
      ...
      ${d.cause}
    </div>`},l=d=>{let p=Si(ws(d));if(gt(p).length===0&&!Rr(d.usage))return"";let f=s.has(d.attempt_id);return c`<button
      type="button"
      ...
      ${n.map(d=>{let p=ws(d),f=Si(p),g=gt(f);return c`<div class="detail-session-row">
          ...
          >
            ...
            ${g.length>0?g.map(A=>c`<span
                      ...
                      title=${A.tooltip}
                      >${A.label}</span
                    >`):Rr(d.usage)?c`<span class="detail-session__usage"
                    >${Rr(d.usage)}</span
                  >`:""}
  ...
  `}function qu(e){let t=Lr(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return c`<div class="detail-prompt__missing">
        기록 없음 — 아직 이 이슈로 디스패치된 세션이 없습니다. 아래는 다음
        디스패치가 보낼 기본 과업입니다.
      </div>
      ${typeof r.default_task_prompt=="string"?Jt("\uC608\uC0C1 \uAE30\uBCF8 \uACFC\uC5C5",r.default_task_prompt):""}`;let n=zn(r.recorded_at);return c`<div class="detail-prompt__meta">
      ${r.attempt_id}${n?` \xB7 ${n}`:""}
    </div>
    ${typeof r.task_prompt=="string"?Jt("\uACFC\uC5C5 (user)",r.task_prompt):""}
    ${typeof r.system_prompt=="string"?Jt("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var Bu=["open","in_progress","deferred","resolved","closed"],Uu=[0,1,2,3,4];function Ii(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,l=t.sessionLogStore,d=null,p=null,f={},g="",A=!1,x=!1,T=!1,P="",w="",Y="";function V(){x=!1,T=!1,P="",w="",Y=""}let q=[],E=null,S=null,L=!1,C="",ce=!1,$e=0,le=new Set;function me(){q=[],E=null,S=null,L=!1,C="",ce=!1,$e+=1,le.clear()}async function Le(m){if(!s)return;let I=++$e;try{let $=await Promise.resolve(s("get-comments",{id:m}));if(I!==$e||m!==d)return;q=Array.isArray($)?$:[],L=!1}catch{if(I!==$e||m!==d)return;L=!0}ee()}function Ge(){if(!s||!d)return;let m=p&&typeof p.comment_count=="number"?p.comment_count:null;if(E!==d){E=d,S=m,Le(d);return}m!==null&&m!==S&&(S=m,Le(d))}function Ye(m){le.has(m)?le.delete(m):le.add(m),ee()}function Me(m){let I=C.trim().length===0;C=m,I!==(m.trim().length===0)&&ee()}async function Be(){let m=C.trim();if(!s||!d||m.length===0||ce)return;let I=d;ce=!0,ee();let $=!1;try{let Z=await Promise.resolve(s("add-comment",{id:I,text:m}));Array.isArray(Z)&&Z.length>0&&($=!0,I===d&&(q=Z,L=!1,C="",S=Z.length))}catch{$=!1}$||te("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),I===d&&(ce=!1),ee()}let ge={onToggle:Ye,onDraftInput:Me,onSubmit:Be},ye=document.createElement("div");ye.className="md-viewer-root",document.body.appendChild(ye);let Re=xi(ye,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),J=document.createElement("div");J.className="session-log-root",document.body.appendChild(J);let H=Wn(J,{transport:s?(m,I)=>Promise.resolve(s(m,I)):void 0,sessionLogStore:l}),X=!1,Oe=!1,_e=!1,ke=null,B=null,O=0;function oe(m){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${m}`}function ve(){X=!1,Oe=!1,_e=!1,ke=null,B=null,O+=1}async function Ae(m){if(!s)return;let I=++O;Oe=!0,_e=!1,ee();try{let $=await Promise.resolve(s("get-bead-prompt",{bead_id:m}));if(I!==O)return;!$||typeof $!="object"||Array.isArray($)?_e=!0:(ke=$,B=oe(m))}catch{I===O&&(_e=!0)}finally{I===O&&(Oe=!1,ee())}}function Ze(){if(X=!X,X&&d&&B!==oe(d)){ke=null,Ae(d);return}ee()}function Ie(){if(!a||!d)return[];let m=a.get();return(m&&m.attempts?Object.values(m.attempts):[]).filter($=>$&&$.bead_id===d).sort(($,Z)=>(Z.started_at||0)-($.started_at||0)).map($=>({attempt_id:$.attempt_id,bead_id:$.bead_id,status:$.status,started_at:typeof $.started_at=="number"?$.started_at:null,runner:$.runner||null,model:$.model||null,session_id:$.session_id||null,resumed_from:$.resumed_from||null,dismissed_at:typeof $.dismissed_at=="number"?$.dismissed_at:null,cause:typeof $.cause=="string"?$.cause:null,cause_detail:$.cause_detail||null,exec_default_preset_id:typeof $.exec_default_preset_id=="string"?$.exec_default_preset_id:null,exec_default_preset_revision:typeof $.exec_default_preset_revision=="number"?$.exec_default_preset_revision:null,exec_values:$.exec_values&&typeof $.exec_values=="object"?$.exec_values:null,usage:$.usage||null,usage_legs:Array.isArray($.usage_legs)?$.usage_legs:[]}))}function D(){if(!a||!d)return null;let m=a.get();return Ot(m&&m.attempts||{},d)}let U=new Set;function R(m){U.has(m)?U.delete(m):U.add(m),ee()}function y(m){let I=a?a.get():null,$=I&&I.attempts?I.attempts[m]:null;H.open({attempt_id:m,meta:$?{runner:$.runner||void 0,model:$.model||void 0,effort:$.effort||void 0,status:$.status||void 0,session_id:$.session_id||void 0}:{}})}async function z(m){if(!s||!m)return;let I=()=>{let Z=a?a.get():null;return Z&&typeof Z.revision=="number"?Z.revision:0},$=await s("worker-attempt-resume",{attempt_id:m,expected_revision:I()});if($&&$.conflict){let Z=$.queue&&typeof $.queue.revision=="number"?$.queue.revision:I();$=await s("worker-attempt-resume",{attempt_id:m,expected_revision:Z})}$&&$.resumed===!1&&!$.conflict&&$.reason&&te(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${$.reason}`,"error",2400)}let N={onOpen:y,onResume:z,onToggleUsage:R};function K(){let m=a?a.get():null,I=m&&m.default_exec_preset_id,$=typeof I=="string"?at()?.presets.find(Z=>Z.id===I):null;return $&&$.compatible!==!1&&$.settings?$.settings:{}}function ae(){let m=a?a.get():null,I=m&&m.default_exec_preset_id,$=typeof I=="string"?at()?.presets.find(Z=>Z.id===I):null;return $&&$.compatible!==!1&&typeof $.name=="string"?$.name:""}function xe(){let m=a?a.get():null;return m&&m.runner_catalog||null}function De(){let m=p?.metadata&&typeof p.metadata=="object"?p.metadata:{},$=(Object.hasOwn(f,"orchestration_model")?f.orchestration_model:void 0)||(typeof m.orchestration_model=="string"?m.orchestration_model:"")||(typeof K().orchestration_model=="string"?K().orchestration_model:"")||"opus";return er(xe(),$)}function at(){let m=i?i.get():null;return!m||typeof m.revision!="number"?null:{revision:m.revision,presets:Array.isArray(m.presets)?m.presets:[]}}function it(m){let I=m&&m.settings&&typeof m.settings=="object"?m.settings:{},$=Z=>typeof I[Z]=="string"?I[Z]:Z==="impl_runtime"&&typeof I.impl_model=="string"&&er(xe(),I.impl_model)||"";return Pr({selectedOf:$,effectiveOf:$,runner_catalog:xe()}).some(Z=>Z.groups.some(Ue=>Ue.options.some(ot=>ot.value===Z.selected&&ot.label.endsWith("(\uBE44\uD638\uD658)"))))}function lt(m){i&&m&&typeof m.revision=="number"&&Array.isArray(m.presets)&&i.set({revision:m.revision,presets:m.presets})}async function ze(){let m=at(),I=m?.presets.find($=>$.id===g);if(!(!s||!d||!m||!I||it(I)||A)){A=!0,ee();try{let $=await Promise.resolve(s("apply-exec-preset",{id:d,preset_id:I.id,expected_revision:m.revision}));if($&&$.conflict){lt($),te("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let Z=$&&Array.isArray($.issue)?$.issue[0]:$?.issue;if($&&$.applied&&Z&&typeof Z=="object"){p=Z;for(let Ue of Dr)delete f[Ue];te("\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",2400);return}$&&$.error==="bd_readback_failed"?te("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):te("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch($){$&&typeof $=="object"&&$.code==="bd_readback_failed"?te("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):te("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{A=!1,ee()}}}function Pt(){let m=at();if(m&&m.presets.length===0)return c`<section class="detail-exec-presets">
    ...
    </section>`}let vt=null;r&&r.subscribe&&(vt=r.subscribe(()=>tt()));let _t=null;a&&typeof a.subscribe=="function"&&(_t=a.subscribe(()=>{d&&ee()}));let dt=null;i&&typeof i.subscribe=="function"&&(dt=i.subscribe(()=>{d&&ee()}));function Ne(m){m.key==="Escape"&&d&&(m.preventDefault(),n())}document.addEventListener("keydown",Ne);function tt(){if(d){if(r&&typeof r.snapshotFor=="function"){let m=r.snapshotFor("detail:"+d)||[];p=m.find($=>$&&$.id===d)||m[0]||p}Ge(),ee()}}function ut(m){hr(m).then(I=>{I?te("\uBCF5\uC0AC\uB428","success",1200):te("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function nt(m){m.preventDefault(),m.stopPropagation(),d&&ut(d)}function st(m,I){m.preventDefault(),m.stopPropagation(),ut(I)}function pt(m,I,$){m.preventDefault(),m.stopPropagation(),Re.open(I,{missing_state:$})}function M(m,I){f[m]=I,ee(),!(!s||!d)&&Promise.resolve(s("update-exec-settings",{id:d,key:m,value:I})).catch(()=>{te("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function W(m,I){let $=p||{},Z=$.metadata&&typeof $.metadata=="object"?$.metadata:{},Ue={};for(let Fe of["impl_runtime","impl_model","impl_effort"])Ue[Fe]=Object.hasOwn(f,Fe)?f[Fe]:typeof Z[Fe]=="string"?Z[Fe]:"";Ue[m]=I;let ot=Yn(Ue,xe(),De()),ht={};for(let Fe of["impl_runtime","impl_model","impl_effort"])ht[Fe]=f[Fe],f[Fe]=ot[Fe]||"";ee(),!(!s||!d)&&Promise.resolve(s("update-impl-target",{id:d,...ot,orchestration_runtime:De()})).then(Fe=>{let It=Array.isArray(Fe)?Fe[0]:Fe;if(!It||typeof It!="object"||!It.id)throw new Error("implementation target readback failed");p=It;for(let Nr of["impl_runtime","impl_model","impl_effort"])delete f[Nr];ee()}).catch(()=>{for(let Fe of["impl_runtime","impl_model","impl_effort"])ht[Fe]===void 0?delete f[Fe]:f[Fe]=ht[Fe];ee(),te("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function ie(m,I,$){if(!s||!d)return!1;try{let Z=await Promise.resolve(s(m,I)),Ue=Array.isArray(Z)?Z[0]:Z;return Ue&&typeof Ue=="object"&&Ue.id?(p=Ue,!0):(te($,"error"),!1)}catch{return te($,"error"),!1}}function ue(m){setTimeout(()=>{try{let I=e.querySelector(m);I&&typeof I.focus=="function"&&I.focus()}catch{}},0)}function he(){x=!0,P=p&&p.title||"",ee(),ue('.detail-edit__input[data-edit="title"]')}function Te(m){P=m.target.value}function He(){x=!1,P="",ee()}function Xe(){ie("edit-text",{id:d,field:"title",value:P},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(I=>{I&&(x=!1,P=""),ee()})}function Ee(){T=!0,w=p&&p.description||"",ee(),ue('.detail-edit__textarea[data-edit="description"]')}function Ve(m){w=m.target.value}function u(){T=!1,w="",ee()}function k(){ie("edit-text",{id:d,field:"description",value:w},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(I=>{I&&(T=!1,w=""),ee()})}function j(m,I,$,Z){if(m.key==="Escape"){m.stopPropagation(),$();return}m.key==="Enter"&&(!Z||m.ctrlKey||m.metaKey)&&(m.preventDefault(),I())}function pe(m){let I=m.target.value;ie("update-status",{id:d,status:I},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>ee())}function be(m){let I=Number(m.target.value);ie("update-priority",{id:d,priority:I},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>ee())}function we(m){Y=m.target.value}function se(){let m=Y.trim();m.length!==0&&ie("label-add",{id:d,label:m},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(I=>{I&&(Y=""),ee()})}function Se(m){if(m.key==="Escape"){m.stopPropagation(),Y="",ee();return}m.key==="Enter"&&(m.preventDefault(),se())}function fe(m){ie("label-remove",{id:d,label:m},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>ee())}let Qe={onCopyPath:st,onOpenDoc:pt},St={onChange:M,onImplTargetChange:W};function mt(m){return typeof m=="string"?m:m&&typeof m=="object"?String(m.id||m.to||m.issue_id||m.depends_on||""):""}function Je(m){switch(m&&typeof m=="object"?String(m.dependency_type||m.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function At(m){let $=(Array.isArray(m.dependencies)?m.dependencies:[]).map(Z=>({id:mt(Z),icon:Je(Z)})).filter(Z=>Z.id.length>0);return c`
    ...
    `}function ne(){if(!d)return c``;let m=p||{},I=String(m.id||d),$=m.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",Z=D(),Ue=m.status||"open",ot=typeof m.priority=="number"?Math.max(0,Math.min(4,m.priority)):"",ht=m.description||"",Fe={...m,metadata:{...m.metadata||{},...f}};return c`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${G(Ue,ot)} ${b(m)}
          ${_(ht)}
          ${gi(q,ge,{expanded:le,draft:C,sending:ce,error:L})}
          ${v(m)} ${re(m)} ${At(m)}
          ${Mt(m)} ${Ce(m)}
          ${pi(m,Qe)}
          ${Pt()}
          ${$i(Fe,St,K(),xe(),ae())}
          ${Ri({expanded:X,loading:Oe,error:_e,data:ke},{onToggle:Ze})}
          ${Ci(Ie(),N,{total:Z,expanded:U})}
        </div>
      </div>
    `}function ee(){qe(ne(),e)}return{load(m){m!==d&&(f={},g="",V(),me(),ve()),d=m,p=null,tt()},clear(){d=null,p=null,f={},g="",A=!1,V(),me(),ve(),Re.close(),H.close(),qe(c``,e)},destroy(){vt&&(vt(),vt=null),_t&&(_t(),_t=null),dt&&(dt(),dt=null),document.removeEventListener("keydown",Ne),Re.destroy(),ye.parentNode&&ye.parentNode.removeChild(ye),H.destroy(),J.parentNode&&J.parentNode.removeChild(J),d=null,p=null,g="",A=!1,me(),ve(),qe(c``,e)}}}var ju=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Li(e,t){return vs(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function zu(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}function Oi(e,t){let{policyStore:r,transport:n,labelOptions:s}=t,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),e.appendChild(o);let a="";async function i(S){let L=r.get();if(L)try{let C=await n("display-policy-set",{expected_revision:L.revision,policy:S(L)});l(C),C&&C.conflict&&C.policy&&(C=await n("display-policy-set",{expected_revision:C.policy.revision,policy:S(C.policy)}),l(C)),C&&C.conflict&&te("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{te("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function l(S){S&&S.policy&&typeof S.policy=="object"&&r.set(S.policy)}function d(S){let L=r.get();if(!L)return;let C=Li(S,L)!=="shown";i(ce=>zu(S,ce,C))}function p(){let S=a.trim();S.length!==0&&(a="",i(L=>L.hidden_prefixes.includes(S)?{hidden_prefixes:L.hidden_prefixes}:{hidden_prefixes:[...L.hidden_prefixes,S]}),P())}function f(S){i(L=>({hidden_prefixes:L.hidden_prefixes.filter(C=>C!==S)}))}function g(S){let L=r.get();if(!L)return;let C=L.chips[S]===!1;i(()=>({chips:{[S]:C}}))}function A(S){let L=s();return c`
      <section class="display-settings__section">
        ...
        ${L.length===0?c`<div class="display-settings__empty">라벨 없음</div>`:c`<div class="display-settings__pills">
              ${L.map(C=>{let ce=Li(C,S);return c`<button
                  type="button"
    ...
    <div class="fatal-error">
    ...
    </div>`,e.appendChild(t);let r=t.querySelector("#fatal-error-title"),n=t.querySelector("#fatal-error-message"),s=t.querySelector("#fatal-error-detail"),o=t.querySelector("#fatal-error-reload"),a=t.querySelector("#fatal-error-close"),i=()=>{if(typeof t.close=="function")try{t.close()}catch{}t.removeAttribute("open")},l=(d,p,f="")=>{r&&(r.textContent=d||"Unexpected Error"),n&&(n.textContent=p||"An unrecoverable error occurred.");let g=typeof f=="string"?f.trim():"";if(s&&(g.length>0?(s.textContent=g,s.removeAttribute("hidden")):(s.textContent="No additional diagnostics available.",s.setAttribute("hidden",""))),typeof t.showModal=="function")try{t.showModal(),t.setAttribute("open","")}catch{t.setAttribute("open","")}else t.setAttribute("open","")};return o&&o.addEventListener("click",()=>{window.location.reload()}),a&&a.addEventListener("click",()=>i()),t.addEventListener("cancel",d=>{d.preventDefault(),i()}),{open:l,close:i,getElement(){return t}}}function Pi(e){if(typeof e!="number"||!Number.isFinite(e)||e<=0)return"";if(e<6e4)return`${Math.round(e/1e3)}\uCD08`;let t=e/6e4;return`${Number.isInteger(t)?t:Math.round(t*10)/10}\uBD84`}function Mi(e){return Array.isArray(e)?e.filter(t=>typeof t=="string").join(" "):""}var Hu={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428 \xB7 \uACB0\uACFC \uBBF8\uAD00\uCE21"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},Ni=160;function Wu(e){return e.length>Ni?`${e.slice(0,Ni)}\u2026`:e}function Vn(e,t){let{queueStore:r,presetStore:n,transport:s,getWorkspacePath:o}=t,a=document.createElement("dialog");a.id="worker-exec-defaults-dialog",a.className="exec-defaults",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),e.appendChild(a);let i=null,l=!1;function d(){return r&&r.get()||{revision:0,exec_defaults:{}}}function p(){let y=d();return typeof y.revision=="number"?y.revision:0}function f(){let y=n?n.get():null;return!y||typeof y.revision!="number"?null:{revision:y.revision,presets:Array.isArray(y.presets)?y.presets:[]}}function g(y){n&&y&&typeof y.revision=="number"&&Array.isArray(y.presets)&&n.set({revision:y.revision,presets:y.presets})}function A(y){y&&y.queue&&r&&r.set(y.queue)}function x(){return d().runner_catalog??null}let T=null;function P(){if(T!==null)return T;let y=d().default_exec_preset_id;return typeof y=="string"&&y.length>0?y:null}async function w(y){if(!s)return;let z=f();if(!z)return;T=y||"";let N=E(y);if(oe(),!N.viable){te(N.missing?"\uC120\uD0DD\uD55C \uD504\uB9AC\uC14B\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC5B4 \uC800\uC7A5\uD558\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.":"\uBE44\uD638\uD658 \uD504\uB9AC\uC14B\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uAE30\uBCF8\uAC12\uC73C\uB85C \uC800\uC7A5\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.","error",4e3);return}try{let K=await s("worker-queue-set-default-exec-preset",{preset_id:y||null,expected_queue_revision:p(),expected_preset_revision:z.revision});if(A(K),K&&K.presets&&n&&n.set(K.presets),K&&K.conflict){te("\uAE30\uBCF8 \uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uC120\uD0DD\uC744 \uAC80\uD1A0\uD55C \uB4A4 \uB2E4\uC2DC \uC800\uC7A5\uD558\uC138\uC694.","error",4e3);return}if(K&&K.applied){T=null,oe();return}te("\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uAE30\uBCF8 \uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}catch{te("\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uAE30\uBCF8 \uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function Y(y){i={id:y.id,name:y.name,settings:{...y.settings||{}}},L(),l=!1,oe()}function V(){i={id:null,name:"",settings:{}},l=!1,oe()}function q(y){let z=y&&y.settings&&typeof y.settings=="object"?y.settings:{},N=K=>typeof z[K]=="string"?z[K]:K==="impl_runtime"&&typeof z.impl_model=="string"&&er(x(),z.impl_model)||"";return Pr({selectedOf:N,effectiveOf:N,runner_catalog:x()}).some(K=>K.groups.some(ae=>ae.options.some(xe=>xe.value===K.selected&&xe.label.endsWith("(\uBE44\uD638\uD658)"))))}function E(y){if(!y)return{viable:!0,missing:!1,incompatible:!1,preset:null};let N=f()?.presets.find(ae=>ae.id===y);if(!N||N.migration_pending===!0)return{viable:!1,missing:!0,incompatible:!1,preset:null};let K=N.compatible===!1||q(N);return{viable:!K,missing:!1,incompatible:K,preset:N}}function S(){let y=i?.settings.orchestration_model;return typeof y!="string"?null:er(x(),y)}function L(){if(!i)return;let y=Yn({impl_runtime:i.settings.impl_runtime||"",impl_model:i.settings.impl_model||"",impl_effort:i.settings.impl_effort||""},x(),S());for(let z of["impl_runtime","impl_model","impl_effort"])y[z]?i.settings[z]=y[z]:delete i.settings[z]}function C(y){let z=y&&y.settings&&typeof y.settings=="object"?y.settings:{},N=Dr.filter(ae=>typeof z[ae]=="string").length,K=Dr.filter(ae=>typeof z[ae]=="string").map(ae=>`${Gs[ae]?.title||ae}: ${z[ae]}`);return{count:`${N}/12 \uC9C0\uC815`,choices:K.length>0?K.join(" \xB7 "):"\uBAA8\uB4E0 \uD56D\uBAA9 \uAE30\uBCF8\uAC12"}}async function ce(y){if(!s||!window.confirm(`\u201C${y.name}\u201D \uD504\uB9AC\uC14B\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694? \uC774\uBBF8 \uC801\uC6A9\uB41C \uC774\uC288\uB294 \uBCC0\uACBD\uB418\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.`))return;let z=f();if(z)try{let N=await s("exec-preset-delete",{expected_revision:z.revision,id:y.id});g(N),N&&N.conflict&&te("\uD504\uB9AC\uC14B\uC774 \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694.","error",4e3)}catch{te("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328","error",4e3)}}async function $e(y=!1){if(!s||!i)return;let z=f();if(!z)return;let N=y||i.id===null,K={expected_revision:z.revision,...N?{}:{id:i.id},name:i.name,settings:{...i.settings}};try{let ae=await s(N?"exec-preset-create":"exec-preset-update",K);if(g(ae),ae&&ae.conflict){l=!0,oe();return}if(ae&&ae.applied){i=null,l=!1,oe();return}te("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}catch{te("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function le(y){return c`<div class="exec-defaults__row exec-preset-editor__row">
      <span class="exec-defaults__k">${Vs(y.key)}</span>
      <select
        class="exec-defaults__sel"
        data-preset-key=${y.key}
        ?disabled=${y.disabled}
        @change=${z=>{if(!i)return;let N=z.target.value;N?i.settings[y.key]=N:delete i.settings[y.key],(y.key==="impl_runtime"||y.key==="impl_model"||y.key==="impl_effort"||y.key==="orchestration_model")&&L(),l=!1,oe()}}
      >
        ${Gn(y.groups,y.selected,Ys[y.key]||"(\uAE30\uBCF8)")}
      </select>
    </div>`}function me(){if(!i)return"";let y=ae=>typeof i?.settings[ae]=="string"?i.settings[ae]:"",z=Pr({selectedOf:y,effectiveOf:y,runner_catalog:x(),controller_runtime:S()}),N=f(),K=i.id!==null&&N!==null&&!N.presets.some(ae=>ae.id===i?.id);return c`<div class="exec-preset-editor" data-preset-editor>
    ...
    </div>`}function Le(){let y=f(),z=y?y.presets.filter(N=>N?.migration_pending!==!0):[];return c`<section class="exec-presets" data-exec-presets>
      ...
      ${y===null?c`<p class="exec-presets__empty">프리셋을 불러오는 중…</p>`:z.length===0?c`<p class="exec-presets__empty">
              아직 공용 프리셋이 없습니다.
            </p>`:z.map(N=>{let K=C(N),ae=typeof N.reference_count=="number",xe=ae?N.reference_count:null,De=Array.isArray(N.reference_summary)?N.reference_summary.map(at=>at?.display_name||at?.workspace_key).filter(Boolean).join(", "):"";return c`<article
              ...
              >
                <div class="exec-preset-card__main">
                  ...
                  <span>${K.count}</span>
                  <span data-preset-references=${N.id}
                    >${ae?`\uCC38\uC870 ${xe}\uAC1C`:"\uCC38\uC870 \uD655\uC778 \uBD88\uAC00"}</span
                  >
                  ${q(N)?c`<span data-preset-incompatible>비호환</span>`:""}
                  <small>${K.choices}</small>
                  ${De?c`<small data-preset-impact=${N.id}
                        >업데이트 영향: ${De}</small
                      >`:""}
                </div>
                <div class="exec-preset-card__actions">
                  ...
                  <button
                    type="button"
                    data-preset-delete=${N.id}
                    ?disabled=${xe===null||xe>0||N.reference_scan_complete===!1}
                    title=${xe===null?"\uCC38\uC870 \uC218\uB97C \uD655\uC778\uD560 \uC218 \uC5C6\uC5B4 \uC0AD\uC81C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":xe>0?"\uCC38\uC870 \uC911\uC778 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC788\uC5B4 \uC0AD\uC81C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":N.reference_scan_complete===!1?"\uCC38\uC870 \uC2A4\uCE94\uC774 \uC644\uB8CC\uB418\uC9C0 \uC54A\uC544 \uC0AD\uC81C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":""}
                    @click=${()=>{ce(N)}}
                  >
                    삭제
                  </button>
      ...
      ${me()}
    </section>`}function Ge(){let y=f(),z=y?y.presets.filter(De=>De?.migration_pending!==!0):[],N=P()||"",K=E(N),ae=K.preset,xe=ae?C(ae):null;return c`<section class="exec-defaults__workspace" data-workspace-preset>
      ...
      >
        ...
        ${N&&K.missing?c`<option value=${N} ?selected=${!0}>
              ${N} (선택한 프리셋 없음)
            </option>`:""}
        ${z.map(De=>c`<option
              value=${De.id}
      ...
      >${z}</span
    >`}function Be(y){let z=y?Mi(y.cmd):"",N=y?Pi(y.timeout_ms):"",K=o&&o()||"<workspace \uACBD\uB85C>";return c`<div class="exec-defaults__vd-group" data-vd="verify">
      <div class="exec-defaults__vd-label">머지 전 검증 (verify)</div>
      ${z?c`<div class="exec-defaults__vd-line">
            <span class="exec-defaults__vd-cmd">${z}</span>
            ${Me("config","config")}
            ${N?c`<span class="exec-defaults__vd-meta"
                  >timeout ${N}</span
                >`:""}
    ...
    </div>`}function ge(y){let z=y?Mi(y.cmd):"",N=y?Pi(y.timeout_ms):"",K=N?`timeout ${N} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",ae=o&&o()||"<workspace \uACBD\uB85C>";return c`<div class="exec-defaults__vd-group" data-vd="deploy">
      ...
      ${Re?B():""}
    </section>`}function B(){let y=Lr({loading:J,error:H});if(y)return y;if(!X)return"";let z=Array.isArray(X.variants)?X.variants:[];return c`<div class="exec-defaults__sp-body">
      ${X.target_base_placeholder?c`<div class="prompt-block__meta">
            \`${X.target_base_placeholder}\`는 디스패치 시점에 해석된
            base로 치환됩니다.
          </div>`:""}
      ${z.map(N=>c`<div class="exec-defaults__sp-variant" data-variant=${N.key}>
            <div class="exec-defaults__sp-cond">${N.condition}</div>
            ${Jt(N.label,N.system_prompt)}
          </div>`)}
      ...
      `,a),T!==null){let y=a.querySelector("[data-workspace-preset-select]");y&&(y.value=T)}}let ve=!1,Ae=()=>{ve=!1},Ze=y=>{y.target===y.currentTarget&&R()};a.addEventListener("close",Ae),a.addEventListener("cancel",Ae),a.addEventListener("click",Ze);let Ie=null;r&&r.subscribe&&(Ie=r.subscribe(()=>{ve&&oe()}));let D=null;n&&n.subscribe&&(D=n.subscribe(()=>{ve&&oe()}));function U(){ve||(ve=!0,oe(),typeof a.showModal=="function"?a.showModal():a.setAttribute("open",""))}function R(){ve&&(ve=!1,typeof a.close=="function"?a.close():a.removeAttribute("open"))}return{open:U,close:R,destroy(){ve=!1,a.removeEventListener("close",Ae),a.removeEventListener("cancel",Ae),a.removeEventListener("click",Ze),Ie&&(Ie(),Ie=null),D&&(D(),D=null),a.remove()}}}function Mr(e){let t=Rt(e.created_at),r=Rt(e.updated_at);return!t&&!r?"":c`<div class="worker-mini__meta">
    ${t?c`<span title=${`\uC0DD\uC131 ${bt(e.created_at)}`}
          >생성 ${t}</span
        >`:""}${t&&r?c`<span>·</span>`:""}${r?c`<span title=${`\uC218\uC815 ${bt(e.updated_at)}`}
          >수정 ${r}</span
        >`:""}
  </div>`}function Gu(e){return!e||e==="requested"?"\uBC31\uC5C5 \uC911":e==="backup_verified"||e==="signaled"?"runner \uC885\uB8CC \uC911":e==="merged_revert"||e.startsWith("revert_")?"revert PR \uB300\uAE30":e.startsWith("rollback_")?"\uC6D0\uBCF5 \uBC30\uD3EC \uC911":e==="runner_terminated"||e.startsWith("pr_")||e.includes("ref_")||e.includes("worktree")||e.startsWith("bead_")?"PR \uC815\uB9AC \uC911":`\uD3D0\uAE30 \uCC98\uB9AC \uC911 (${e})`}function on(e,t){return t==="merged"?`${e}: \uC774\uBBF8 merge\uB41C \uAD6C\uD604\uC785\uB2C8\uB2E4. \uBCF5\uAD6C archive\uB97C \uB9CC\uB4E0 \uB4A4 revert PR\uC744 \uC0DD\uC131\uD558\uBA70, \uC2E4\uC81C \uC6D0\uBCF5\uC740 \uC0AC\uB78C\uC774 \uADF8 PR\uC744 merge\uD55C \uB4A4 \uC644\uB8CC\uB429\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`:`${e}: \uBCF5\uAD6C archive\uB97C \uB9CC\uB4E0 \uB4A4 runner/PR/branch/worktree\uB97C \uC815\uB9AC\uD558\uACE0 \uC774\uC288\uB97C \uD6C4\uBCF4\uB85C \uB418\uB3CC\uB9BD\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`}function Kn(e){let t=["\uD3D0\uAE30 \uC644\uB8CC"];return e.operation_id&&t.push(`\uC791\uC5C5 ${e.operation_id}`),e.receipt?.archive_path&&t.push(`\uBC31\uC5C5 ${e.receipt.archive_path}`),e.receipt?.original_pr?.url&&t.push(`\uC6D0\uBCF8 PR ${e.receipt.original_pr.url}`),e.receipt?.revert_pr?.url&&t.push(`revert PR ${e.receipt.revert_pr.url}`),t.join(" \xB7 ")}function Ht(e,t,r={}){let s=Object.values(e&&typeof e=="object"?e:{}).filter(p=>p&&p.bead_id===t&&p.phase!=="done").sort((p,f)=>(p.requested_at||0)-(f.requested_at||0)).at(-1),o=typeof r.attempt_id=="string"&&r.attempt_id.length>0?r.attempt_id:typeof s?.attempt_id=="string"?s.attempt_id:null,a=r.external?"\uC678\uBD80 PR\uC740 Worker\uAC00 \uC18C\uC720\uD558\uC9C0 \uC54A\uC544 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":r.done?"\uC644\uB8CC\uB41C \uC791\uC5C5\uC740 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":r.merge_active?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":r.merge_queued?"\uBA38\uC9C0 \uD050\uC5D0 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 [\uCDE8\uC18C]\uD558\uC138\uC694":r.conflict_active?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 \uC138\uC158\uC744 \uC815\uB9AC\uD558\uC138\uC694":r.cleanup_active?"\uC815\uB9AC \uC9C4\uD589 \uC911 \u2014 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":null,i=typeof s?.last_error=="string"?s.last_error:null,l=s?Gu(s.phase):null,d=r.merged||s?.mode==="merged_revert"?"merged":"unmerged";return{action:!r.external&&!r.done,enabled:!a&&(!s||!!i),label:i?"\uC7AC\uC2DC\uB3C4":"\uD3D0\uAE30",title:a||(i?`\uD3D0\uAE30 \uC2E4\uD328: ${i} \u2014 \uAC19\uC740 \uC791\uC5C5\uC744 \uC7AC\uC2DC\uB3C4\uD569\uB2C8\uB2E4`:s?`${l||"\uD3D0\uAE30 \uCC98\uB9AC \uC911"} \u2014 \uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694`:d==="merged"?"\uBCD1\uD569\uB41C \uBCC0\uACBD\uC744 \uC6D0\uBCF5 PR\uB85C \uB418\uB3CC\uB9BD\uB2C8\uB2E4":"\uBC31\uC5C5 \uD6C4 runner\xB7PR\xB7\uC6CC\uD06C\uD2B8\uB9AC\xB7\uBE0C\uB79C\uCE58\uB97C \uD3D0\uAE30\uD569\uB2C8\uB2E4"),attempt_id:o,operation:s||null,progress:l,error:i,confirmation:d}}function tr(e){let t=e.discard;if(!t||!t.operation)return"";let r=t.operation,n=r.backup?.path,s=r.original_pr,o=r.revert_pr;return c`<div
  ...
  >`,T=c`<span class="worker-mini__title">${e.title}</span>`,P=e.pr_url&&e.pr_number?c`<a
        ...
        >`),V=e.reason?c`<span class="worker-mini__reason">${e.reason}</span>`:"",q=s.length>0?s.map(me=>c`<span class="worker-usage" title=${me.tooltip}
              >${me.label}</span
            >`):o?c`<span class="worker-usage" title=${Ir(e.usage)}
            >${o}</span
      ...
      >
        취소
      </button>`:"",C=e.discard,ce=C?.action||e.discard_action?c`<button
          type="button"
        ...
        >
          승인하고 진행
        </button>`:"",le=!!(o||a||e.merge_action||e.cancel_action||e.discard_action||C?.operation||e.revise_action);return c`<div
  ...
  >
    ${l?c`<div class="worker-mini__row1">${A}${x}${T}</div>
          <div class="worker-mini__row2">
            ...
            ${le?c`<div class="worker-mini__foot">
                  ${q}${E}
                  <span class="worker-mini__actions"
                    >${S}${L}${ce}${$e}</span
                  >
            ...
            ${Mr(e)}`:c`<div class="worker-mini__line">
              ${p}${f}${A}${x}${T}${P}${w}${Y}${g}${V}${q}${E}${S}${L}${ce}
            </div>
            ${tr(e)} ${Mr(e)}`}
  ...
  </div>`}function cr(e){return c`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
...
${_e.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};p.push(O);let oe=g.get(Y);oe?oe.push(O):g.set(Y,[O])}for(let H of Array.isArray(w.runnable)?w.runnable:[]){let X=H&&H.bead_id;typeof X!="string"||J.has(X)||(J.add(X),i.push({...Re(X),title:H.title||L[X]||X,lane:"runnable",draggable:!0,reason:Vi(ce,X),created_at:H.created_at??void 0,updated_at:H.updated_at??void 0,labels:Array.isArray(H.labels)?H.labels:[],spec_reviewer:typeof H.spec_reviewer=="string"?H.spec_reviewer:void 0,plan_state:H.plan_state==="approved"||H.plan_state==="authored"?H.plan_state:"none",workflow:H.route?{route:H.route,chips:{route:H.route}}:null,place_index:Be.length}))}for(let H of ge){let X=H&&H.bead_id;if(typeof X!="string"||J.has(X)||(J.add(X),o!==void 0&&typeof H.added_at=="number"&&H.added_at<o))continue;let Oe=tp(S,X);f.push({...Re(X),lane:"done",done:!0,usage:Ot(S,X),done_at:typeof H.added_at=="number"?H.added_at:void 0,done_kind:Oe&&typeof Oe.done_kind=="string"?Oe.done_kind:null})}}let A=new Map;s.forEach((w,Y)=>{w&&typeof w.root_dir=="string"&&A.set(w.root_dir,Y)});let x=r&&r.running_sort==="repo"?"repo":"started";l.sort((w,Y)=>{if(x==="repo"){let E=A.get(w.root_dir)??Number.MAX_SAFE_INTEGER,S=A.get(Y.root_dir)??Number.MAX_SAFE_INTEGER;if(E!==S)return E-S}let V=typeof w.started_at=="number"&&Number.isFinite(w.started_at)?w.started_at:null,q=typeof Y.started_at=="number"&&Number.isFinite(Y.started_at)?Y.started_at:null;return V!==null&&q!==null&&V!==q?V-q:V===null&&q!==null?1:V!==null&&q===null?-1:w.id.localeCompare(Y.id)}),f.sort((w,Y)=>(Y.done_at??0)-(w.done_at??0));let T=s.length>0?s:n.map(w=>({root_dir:w&&w.root_dir,name:w&&w.name,auto_advance:w&&w.auto_advance,auto_merge:w&&w.auto_merge,slots:w&&w.slots,revision:w&&w.revision,exec_defaults:w&&w.exec_defaults,default_exec_preset_id:w&&w.default_exec_preset_id,runner_catalog:w&&w.runner_catalog})),P=[];for(let w of T)!w||typeof w.root_dir!="string"||P.push({root_dir:w.root_dir,name:w.name||w.root_dir,auto_advance:w.auto_advance===!0,auto_merge:w.auto_merge===!0,slots:typeof w.slots=="number"&&w.slots>=an?w.slots:an,revision:typeof w.revision=="number"?w.revision:0,exec_defaults:xt(w.exec_defaults),default_exec_preset_id:typeof w.default_exec_preset_id=="string"?w.default_exec_preset_id:null,runner_catalog:xt(w.runner_catalog),items:g.get(w.root_dir)||[]});return{runnable:i,queue:p,queue_groups:P,running:l,pr_wait:d,done:f,automation:{total:P.length,both_on:P.filter(w=>w.auto_advance&&w.auto_merge).length}}}function np(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<Qu;return c`<span
  ...
  >`}function Zn(e){return e.workspace_name?c`<span class="mon-c__repo" title=${e.root_dir||""}
      ...
      >`:""}function so(e){let t=gt(e.usage),r=qt(e.usage);return t.length>0?t.map(n=>c`<span class="mon-c__usage" title=${n.tooltip}
          >${n.label}</span
        >`):r?c`<span class="mon-c__usage" title=${Ir(e.usage)}
        >${r}</span
  ...
  </span>`}function op(e,t){let r=typeof e.started_at=="number"?Js(t-e.started_at):"";return c`${ln(e)}
    <div class="mon-c__meta">
      ${oo(e)}${np(e.last_event_at,t)}${cn(e)}${Zn(e)}
      ${e.model?c`<span class="mon-c__model">${e.model}</span>`:""}
      ${r?c`<span class="mon-live__elapsed">${r}</span>`:""}
      ${so(e)}${sp(e)}${tr(e)}
    </div>`}function ap(e){let t=e.workflow,n=(t&&t.chips||{}).route||t&&t.route,s=typeof e.spec_reviewer=="string"?e.spec_reviewer:"",o=e.plan_state==="approved"?"plan \u2713":e.plan_state==="authored"?"plan \u270E":"plan \u2013",a=typeof e.reason=="string"&&e.reason.startsWith("\u26D4"),i=Rt(e.updated_at);return c`${ln(e)}
    <div class="mon-c__meta">
      ...
      ${n==="full_plan"?c`<span
            ...
            >${o}</span
          >`:""}
      ${Tn(e.labels,null).map(l=>c`<span class="ctl-chip ctl-chip--label">${l}</span>`)}
      ${Zn(e)}
    ...
    </div>`}function ip(e){let t=!!e.discard?.operation;return c`${ln(e)}
    <div class="mon-c__meta">
    ...
    ${e.revise_action?c`<div class="mon-c__tail">
        ...
        </div>`:""}`}function lp(e){let t=!!(qt(e.usage)||e.merge_action||e.cancel_action||e.discard_action);return c`${ln(e)}
    <div class="mon-c__meta">
      ${cn(e)}${Zn(e)}
    ...
    ${t?c`<div class="mon-c__tail">
          ...
          ${tr(e)}
        </div>`:""}`}function cp(e,t){let r=e.done_kind||"",n=r?Ju[r]||r:"",s=Rt(e.done_at,t);return c`${ln(e)}
    <div class="mon-c__meta">
      ${cn(e)}${Zn(e)}
      ${n?c`<span
  ...
  >
    ${Ki(e,t)}
      ...
      </div>`}function ke(){let D=s&&s.get?s.get():null,U=s&&s.getWorkspacesState?s.getWorkspacesState():[],R=d();T=no(D,U,{done_since:xr(f,R),running_sort:g}),qe(_e(R),x)}function B(D,U){let R=i?i():void 0;if(!U||!R||U===R||!l){n(D);return}l(U).then(()=>{n(D)}).catch(y=>{r("workspace switch for %s failed: %o",U,y)})}function O(D){return{root_dir:D.getAttribute("data-root-dir")||"",revision:Number(D.getAttribute("data-revision")||0)||0}}function oe(D,U){let{root_dir:R,revision:y}=O(D),z=D.getAttribute("data-issue-id")||"",N=U.dataset.attemptId||D.getAttribute("data-attempt-id")||"",K=U.classList;if(K.contains("worker-card__place")){C("worker-queue-place",{bead_id:z,index:Number(D.getAttribute("data-place-index")||0)||0},R,y);return}if(K.contains("mon-op--up")||K.contains("mon-op--down")){let ae=Number(D.getAttribute("data-queue-index")||0)||0,xe=K.contains("mon-op--up")?ae-1:ae+1;if(xe<0)return;C("worker-queue-reorder",{bead_id:z,to_index:xe},R,y);return}if(K.contains("mon-op--remove")){C("worker-queue-remove",{bead_id:z},R,y);return}if(K.contains("mon-op--pause")){$e("worker-attempt-pause",{attempt_id:N},R);return}if(K.contains("mon-op--discard")){if(!p(on(z,"unmerged")))return;ce({bead_id:z,...N?{attempt_id:N}:{},...U.dataset.operationId?{operation_id:U.dataset.operationId}:{}},R,y);return}if(K.contains("mon-op--resume")){C("worker-attempt-resume",{attempt_id:N},R,y);return}if(K.contains("mon-op--dismiss")){C("worker-attempt-dismiss",{attempt_id:N},R,y);return}if(K.contains("worker-mini__merge")){C("worker-merge-queue-add",{bead_id:z},R,y);return}if(K.contains("worker-mini__merge-cancel")){C("worker-merge-queue-remove",{bead_id:z},R,y);return}if(K.contains("worker-mini__discard")){let ae=U.dataset.discardMode==="merged"?"merged":"unmerged";if(!p(on(z,ae)))return;ce({bead_id:z,...N?{attempt_id:N}:{},...U.dataset.operationId?{operation_id:U.dataset.operationId}:{}},R,y);return}if(K.contains("worker-mini__revise-fix")){C("worker-revise-fix",{bead_id:z},R,y);return}K.contains("worker-mini__revise-approve")&&C("worker-revise-approve",{bead_id:z},R,y)}function ve(D){let U=Ge;Ge=!1;let R=D.target;if(!R||typeof R.closest!="function"||R.closest("dialog")||R.closest("a"))return;let y=R.closest(".mon-running-sort");if(y){D.preventDefault(),g=y.getAttribute("data-sort")==="repo"?"repo":"started",fp(g),ke();return}let z=R.closest(".mon-auto-all");if(z){D.preventDefault(),le(z.getAttribute("data-on")==="true");return}if(R.closest(".mon-merge-all")){D.preventDefault(),me();return}let K=R.closest(".mon-ctl--advance");if(K){D.preventDefault();let{root_dir:lt,revision:ze}=O(K);C("worker-queue-toggle",{on:K.getAttribute("data-on")==="true"},lt,ze);return}let ae=R.closest(".mon-ctl--merge-auto");if(ae){D.preventDefault();let{root_dir:lt,revision:ze}=O(ae);C("worker-merge-auto-toggle",{on:ae.getAttribute("data-on")==="true"},lt,ze);return}let xe=R.closest(".mon-ctl--exec");if(xe){D.preventDefault(),P=xe.getAttribute("data-root-dir")||null,w.delete(P||""),E.open();return}let De=R.closest(".mon-card");if(!De)return;let at=R.closest("button");if(at){D.preventDefault(),oe(De,at);return}let it=De.getAttribute("data-issue-id");it&&!U&&(D.preventDefault(),B(it,De.getAttribute("data-root-dir")||""))}function Ae(D){let U=D.target;if(!U||typeof U.closest!="function")return;let R=U.closest(".mon-done-range");if(R){f=Kt(R.value)?R.value:Lt,up(f),ke();return}let y=U.closest(".mon-slots__input");if(!y)return;let{root_dir:z,revision:N}=O(y),K=Number(y.value);if(!Number.isFinite(K))return;let ae=Math.max(an,Math.floor(K));C("worker-queue-set-slots",{slots:ae},z,N)}e.addEventListener("click",ve),e.addEventListener("change",Ae),e.addEventListener("dragstart",Re),e.addEventListener("dragover",J),e.addEventListener("dragleave",H),e.addEventListener("drop",Oe),e.addEventListener("dragend",X),s&&typeof s.subscribe=="function"&&(S=s.subscribe(()=>{try{w.clear(),ke();for(let D of Array.from(Y))D()}catch{}}));function Ze(){L!==null&&(clearInterval(L),L=null)}function Ie(){Ye!==null&&(clearTimeout(Ye),Ye=null)}return{load(){r("load"),ke(),L===null&&(L=setInterval(()=>{try{ke()}catch{}},_p))},pause(){Ze()},clear(){Ze(),Ie(),S&&(S(),S=null),e.removeEventListener("click",ve),e.removeEventListener("change",Ae),e.removeEventListener("dragstart",Re),e.removeEventListener("dragover",J),e.removeEventListener("dragleave",H),e.removeEventListener("drop",Oe),e.removeEventListener("dragend",X),E.destroy(),Y.clear(),e.replaceChildren()}}}function ol(e,t,r){let n=rt("views:nav"),s=null;function o(l){return d=>{d.preventDefault(),n("click tab %s",l),r.gotoView(l)}}function a(){let l=t.getState(),d=l.view==="worker"||l.view==="monitor"?l.view:"board";return c`
  ...
  `,e.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),a=r.querySelector("#new-priority"),i=r.querySelector("#new-labels"),l=r.querySelector("#new-description"),d=r.querySelector("#new-issue-error"),p=r.querySelector("#btn-cancel"),f=r.querySelector("#btn-create"),g=r.querySelector(".new-issue__close");function A(){o.replaceChildren();let E=document.createElement("option");E.value="",E.textContent="\u2014 Select \u2014",o.appendChild(E);for(let S of al){let L=document.createElement("option");L.value=S,L.textContent=il(S),o.appendChild(L)}a.replaceChildren();for(let S=0;S<=4;S+=1){let L=document.createElement("option");L.value=String(S);let C=ll[S]||"Medium";L.textContent=`${S} \u2013 ${C}`,a.appendChild(L)}}A();function x(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function T(E){s.disabled=E,o.disabled=E,a.disabled=E,i.disabled=E,l.disabled=E,p.disabled=E,f.disabled=E,f.textContent=E?"Creating\u2026":"Create"}function P(){d.textContent=""}function w(E){d.textContent=E}function Y(){try{let E=window.localStorage.getItem("beads-ui.new.type");E?o.value=E:o.value="";let S=window.localStorage.getItem("beads-ui.new.priority");S&&/^\d$/.test(S)?a.value=S:a.value="2"}catch{o.value="",a.value="2"}}function V(){let E=o.value||"",S=a.value||"";E.length>0&&window.localStorage.setItem("beads-ui.new.type",E),S.length>0&&window.localStorage.setItem("beads-ui.new.priority",S)}async function q(){P();let E=String(s.value||"").trim();if(E.length===0){w("Title is required"),s.focus();return}let S=Number(a.value||"2");if(!(S>=0&&S<=4)){w("Priority must be 0..4"),a.focus();return}let L=String(o.value||""),C=String(l.value||""),ce={title:E};L.length>0&&(ce.type=L),String(S).length>0&&(ce.priority=S),C.length>0&&(ce.description=C),T(!0);try{await t("create-issue",ce)}catch{T(!1),w("Failed to create issue");return}V(),T(!1),x()}return r.addEventListener("cancel",E=>{E.preventDefault(),x()}),g.addEventListener("click",()=>x()),p.addEventListener("click",()=>x()),r.addEventListener("keydown",E=>{E.key==="Enter"&&(E.ctrlKey||E.metaKey)&&(E.preventDefault(),q())}),n.addEventListener("submit",E=>{E.preventDefault(),q()}),{open(){n.reset(),P(),Y();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){x()}}}var gp=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];function dl(e){return String(e).padStart(2,"0")}function hp(e,t){let r=Math.max(0,Math.ceil((e-t)/6e4)),n=Math.floor(r/1440),s=Math.floor(r%1440/60),o=r%60;return n>0?`${n}d${s>0?` ${s}h`:""}`:s>0?`${s}h${o>0?` ${o}m`:""}`:`${o}m`}function bp(e,t=Date.now()){let r=Date.parse(e);if(!Number.isFinite(r))return"";let n=new Date(r),s=new Date(t),o=`${dl(n.getHours())}:${dl(n.getMinutes())}`,i=n.getFullYear()===s.getFullYear()&&n.getMonth()===s.getMonth()&&n.getDate()===s.getDate()?o:`${gp[n.getMonth()]} ${n.getDate()} ${o}`;return`${hp(r,t)} \xB7 ${i}`}function vp(e){return e>=85?"usage-meter__window--danger":e>=60?"usage-meter__window--warn":"usage-meter__window--success"}var ul=[{key:"claude",label:"Claude",endpoint:"/api/claude-usage"},{key:"codex",label:"Codex",endpoint:"/api/codex-usage"}];function pl(e){let t=!1,r=null,n=new Map;function s(){qe(c``,e),e.hidden=!0}function o(){let l=ul.filter(p=>n.has(p.key));if(l.length===0){s();return}let d=Date.now();qe(c`<div class="usage-meter" aria-label="Usage">
      ...
      </div>`,e),e.hidden=!1}async function a(l){try{let d=await fetch(l.endpoint);if(!d.ok)return null;let p=await d.json();return!p||p.available!==!0||!Array.isArray(p.windows)?null:p}catch{return null}}async function i(){let l=await Promise.all(ul.map(async d=>({provider:d,payload:await a(d)})));if(!t){for(let d of l)d.payload?n.set(d.provider.key,d.payload):n.delete(d.provider.key);o()}}return s(),i(),r=setInterval(()=>{i()},6e4),{destroy(){t=!0,r!==null&&(clearInterval(r),r=null),s()}}}var yp="worker-ineligible";function ao(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function fl(e){return ao(e).includes(yp)}var io="worker-serial";function Xn(e){return ao(e).includes(io)}var kp="tab:worker:ready",wp="tab:worker:blocked",$p="tab:worker:in-progress",dn=1,xp=new Set(["done","failed","orphaned","stopped","discarded"]);function _l(e){return sn(e).path.length>0}var hl="beads-ui.worker.candidate-filter",lo={show_blocked:!1,spec:"all"};function Sp(){try{let e=window.localStorage.getItem(hl);if(!e)return{...lo};let t=JSON.parse(e);if(!t||typeof t!="object")return{...lo};let r=t.spec;return{show_blocked:t.show_blocked===!0,spec:r==="with"||r==="without"?r:"all"}}catch{return{...lo}}}function Ap(e){try{window.localStorage.setItem(hl,JSON.stringify(e))}catch{}}function Tp(e,t){let r=i=>t.show_blocked||!i.blocked,n=i=>t.spec==="all"||(t.spec==="with"?i.has_spec:!i.has_spec),s=[],o=0,a=0;for(let i of e){let l=r(i),d=n(i);l&&d?s.push(i):!l&&d?o+=1:l&&!d&&(a+=1)}return{visible:s,hidden_blocked:o,hidden_spec:a}}var Ep=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],bl="bdui.worker.candidate_sort",Cp=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],Qn="spec";function Rp(){try{let e=window.localStorage.getItem(bl);return e==="board"||e==="created"||e==="spec"?e:Qn}catch{return Qn}}function Ip(e){try{window.localStorage.setItem(bl,e)}catch{}}var vl="bdui.worker.done-range";function Lp(){try{let e=window.localStorage.getItem(vl);return Kt(e)?e:Lt}catch{return Lt}}function Op(e){try{window.localStorage.setItem(vl,e)}catch{}}var Dp="(max-width: 640px)",yl="beads-ui.worker.lane-collapsed",un={queue:!0,done:!0};function Pp(){try{let e=window.localStorage.getItem(yl);if(!e)return{...un};let t=JSON.parse(e);return!t||typeof t!="object"?{...un}:{queue:typeof t.queue=="boolean"?t.queue:un.queue,done:typeof t.done=="boolean"?t.done:un.done}}catch{return{...un}}}function Mp(e){try{window.localStorage.setItem(yl,JSON.stringify(e))}catch{}}function ml(e){let t=Array.isArray(e)&&e.length>0?e[0]:null;if(!t)return"";let r=typeof t.title=="string"?t.title:t.id||"";return r.length>22?`${r.slice(0,22)}\u2026`:r}function Np(e,t,r){let n=Array.isArray(e)?e.slice():[];return t==="created"?n.sort(gr):(n.sort(kn(r)),t==="board"?n:[...n.filter(_l),...n.filter(s=>!_l(s))])}function Fp(e){let t=e&&e.parent;return(typeof t=="string"?t.length>0:!!(t&&t.id))||/\.\d+$/.test(e&&e.id||"")}function qp(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function Bp(e){let r=(Array.isArray(e?.dependencies)?e.dependencies:[]).map(n=>typeof n=="string"?n:n&&n.id).filter(Boolean);return r.length>0?`\u{1F512} ${r.join(", ")}`:"\u{1F512} blocked"}var Up=["closed_unmerged","undecidable"],jp=[{from:"\uAD00\uCE21 \uB300\uAE30",activity:"checking",to:"\uD655\uC778\uC911"},{from:"\uB85C\uCEEC\uAC80\uC99D \uB300\uAE30",activity:"verifying",to:"\uB85C\uCEEC\uAC80\uC99D \uC2E4\uD589 \uC911"}];function zp(e,t){for(let r of jp)if(e===r.from&&t===r.activity)return{label:r.to,live:!0};return{label:e,live:!1}}var Hp=[{step:"merging",label:"\uBA38\uC9C0 \uC911",index:1},{step:"base_sync",label:"base \uB3D9\uAE30\uD654",index:2},{step:"reconcile_queued",label:"\uC815\uB9AC \uC900\uBE44",index:2},{step:"candidate_pinned",label:"\uBC30\uD3EC \uD6C4\uBCF4 \uACE0\uC815",index:3},{step:"post_merge_verify",label:"\uBA38\uC9C0 \uD6C4 \uAC80\uC99D",index:4},{step:"reconcile_verify",label:"\uC815\uB9AC \uC911 \xB7 \uAC80\uC99D",index:4},{step:"deploy",label:"\uBC30\uD3EC",index:5},{step:"reconcile_deploy",label:"\uC815\uB9AC \uC911 \xB7 \uBC30\uD3EC",index:5},{step:"reconcile_restart",label:"\uC815\uB9AC \uC911 \xB7 \uC7AC\uC2DC\uC791",index:6},{step:"reconcile_readback",label:"\uC815\uB9AC \uC911 \xB7 readback",index:6},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC",index:7},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC",index:8},{step:"parent_close",label:"\uBD80\uBAA8 close",index:9}];function Wp(e){if(typeof e!="string"||e.length===0)return null;let t=9,r=Hp.find(n=>n.step===e);return r?{label:r.label,index:r.index,total:t,percent:Math.round(r.index/t*100)}:{label:e,index:0,total:t,percent:0}}function Gp(e){if(!e||e.adapter!=="managed"&&e.stage!=="queued")return null;let t=e.stage==="queued"?"reconcile_queued":e.stage==="pinned"?"candidate_pinned":e.stage==="verifying"?"reconcile_verify":e.stage==="deploying"?"reconcile_deploy":e.stage==="restarting"?"reconcile_restart":e.stage==="readback"?"reconcile_readback":null;return t?{activity:null,merge_progress:{step:t,started_at:typeof e.updated_at=="number"?e.updated_at:0}}:null}function gl(e){switch(e){case"resolution_round_cap":return"\uCDA9\uB3CC \uD574\uC18C 2\uD68C \uCD08\uACFC";case"resolution_timeout":return"\uCDA9\uB3CC \uD574\uC18C \uB300\uAE30 \uC2DC\uAC04 \uCD08\uACFC";case"resolution_refused":return"\uD574\uC18C \uC138\uC158 \uB514\uC2A4\uD328\uCE58 \uAC70\uBD80";case"worktree_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uD574\uC18C \uD544\uC694";case"merge_unconfirmed_timeout":return"\uBA38\uC9C0 \uD655\uC778 \uC2DC\uAC04 \uCD08\uACFC";case"pr_closed_unmerged":return"PR \uB2EB\uD798";case"merge_error":return"\uBA38\uC9C0 \uC624\uB958";default:return e}}function Yp(e){if(!e||typeof e!="object")return null;switch(e.state){case"waiting":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC911",live:!0};case"yielded":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uACC4\uC18D \uC911 \xB7 \uC644\uB8CC \uD6C4 \uC6B0\uC120 \uBA38\uC9C0",live:!0};case"ready":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC644\uB8CC \xB7 \uC7AC\uAC80\uC99D \uB300\uAE30",live:!1};default:return null}}function co(e,t){return typeof e!="string"||e.length===0||typeof t!="string"||t.length===0||t===e?null:`\u2192 ${t}`}function Vp(e){if(!e||typeof e!="object")return null;let t=Number.isInteger(e.repair_sessions_used)?Math.max(0,e.repair_sessions_used):0,r=Number.isInteger(e.repair_session_cap)?Math.max(0,e.repair_session_cap):0,n=e.current_repair&&typeof e.current_repair=="object"?e.current_repair:null,s=n&&typeof n.pr_number=="number"?n.pr_number:null,o="";switch(e.phase){case"gating":o="root \uC7AC\uAC80\uC99D \uC911";break;case"repairing":o=e.subject_role==="root"?`\uC790\uB3D9\uBCF5\uAD6C ${t}/${r} \xB7 \uC6D0 PR \uC218\uC815 \uC911`:`\uC790\uB3D9\uBCF5\uAD6C ${t}/${r} \xB7 repair PR \uC900\uBE44 \uC911`;break;case"waiting_repair_pr":o=s?`repair PR #${s} \uB300\uAE30`:"repair PR \uB300\uAE30";break;case"merging":o=e.subject_role==="repair"?s?`repair PR #${s} \uBA38\uC9C0 \uC911`:"repair PR \uBA38\uC9C0 \uC911":"root \uBA38\uC9C0 \uC911";break;case"cleaning":o="\uC815\uB9AC \uBCF5\uAD6C \uC911";break;case"paused":o="\uC790\uB3D9\uBCF5\uAD6C \uC77C\uC2DC\uC815\uC9C0";break;case"needs_human":o=`\uC0AC\uB78C \uD655\uC778 \uD544\uC694 \xB7 ${e.terminal_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`;break;case"completed":return null;default:return null}let a=[`\uBCF5\uAD6C \uC138\uC158 ${t}/${r}`];return e.head_sha&&a.push(`head ${e.head_sha}`),e.base_sha&&a.push(`base ${e.base_sha}`),(e.failure_stage||e.failure_reason)&&a.push(`${e.failure_stage||"failure"} \xB7 ${e.failure_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`),e.active_attempt_id&&a.push(`attempt ${e.active_attempt_id}`),n&&typeof n.bead_id=="string"&&a.push(`repair ${n.bead_id}`),e.evidence&&a.push(e.evidence),e.log_path&&a.push(e.log_path),{badge:o,title:a.join(`
`),alert:e.phase==="needs_human",lock_actions:e.phase!=="paused"&&e.phase!=="needs_human",repair_pr_url:n&&typeof n.pr_url=="string"?n.pr_url:"",repair_pr_number:s}}function Kp(e,t,r,n,s=null,o=null,a=null,i=!1,l=null,d=!0,p=null,f=null,g=null,A={},x=!1){let T=!!l&&l.position>0,P=!!l&&l.active===!0,w=l&&l.failure||null,Y=r[e]||null,V=Y&&Y.gate?Y.gate:null,q=Y&&Y.pr?Y.pr:null,E=Vp(g),S=Yp(l?l.resolution:null),L=[];i&&L.push("\uC138\uC158");let C=a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":S?S.badge:a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":null,ce=zp(i&&V&&V.tier==="closed_unmerged"?"\uB2EB\uD798":V&&V.gate_badge||"",C?null:o&&o.activity||null);C&&L.push(C),ce.label&&L.push(ce.label),V&&V.base_badge&&V.base_badge!==V.gate_badge&&L.push(V.base_badge),f&&L.push(f),n&&L.push("\uC815\uB9AC \uC2E4\uD328"),E&&L.push(E.badge),T&&!P&&L.push(`\uBA38\uC9C0 \uB300\uAE30 #${l.position}`),w&&L.push(`\uC77C\uAD04 \uBA38\uC9C0 \uC2E4\uD328: ${gl(w)}`),p&&L.push(`\uC790\uB3D9 \uC81C\uC678: ${gl(p)}`);let $e=!!V&&V.base_badge==="\uCDA9\uB3CC",le=!!V&&V.enabled===!0,me=Wp(o&&o.merge_progress?o.merge_progress.step:null),Le=!!n&&!!V&&V.tier==="merged",Ge=i&&!!V&&V.tier==="merged",Ye=i&&$e&&d===!1,Me=Ht(A,e,{external:i,merge_active:P||!!me,merge_queued:T,conflict_active:!!a,cleanup_active:!1,merged:!!n||V?.tier==="merged"}),Be=!!Me.operation;return{id:e,title:t,reason:n?"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644":"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:x,external:i,pr_number:q&&typeof q.number=="number"?q.number:null,pr_url:q&&typeof q.url=="string"?q.url:"",completion_badge:E?E.badge:null,completion_title:E?E.title:"",completion_repair_pr_url:E?E.repair_pr_url:"",completion_repair_pr_number:E?E.repair_pr_number:null,badges:L,live_badge:a==="paused"?null:S?.live||a==="running"?C:ce.live?ce.label:null,usage:s,alert:!!V&&Up.includes(V.tier)||!!n||!!w||!!(E&&E.alert),merge_action:!T,cancel_action:T,cancel_enabled:!P&&!(E&&E.lock_actions),cancel_title:E&&E.lock_actions?"\uC790\uB3D9\uBCF5\uAD6C \uC911 \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694":P?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:Me,discard_action:Me.action,merge_step:me,discard_enabled:Me.enabled,discard_title:Me.title,merge_enabled:!me&&!a&&!Be&&!(E&&E.lock_actions)&&!Ye&&(le||$e||Le||Ge),merge_label:Le||Ge?"\uC815\uB9AC":$e&&!me&&!Le?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:Be?Me.error?`\uD3D0\uAE30 \uC2E4\uD328: ${Me.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${Me.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:me?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${me.label}`:Ge?"\uBA38\uC9C0\uB428 \u2014 \uD074\uB9AD\uD558\uBA74 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC\uB97C \uC218\uD589\uD569\uB2C8\uB2E4":Ye?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":Le?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uC218\uD589\uD569\uB2C8\uB2E4":$e?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":le?`\uBA38\uC9C0 (${V.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:V&&V.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${V&&V.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function uo(e,t={}){let{transport:r,issueStores:n,queueStore:s,execPresetStore:o,sessionLogStore:a,uiOrderStore:i,gotoIssue:l,getWorkspacePath:d}=t,p=n?$n(n,i):null,f=Sn({transport:r,uiOrderStore:i}),g=null,A=[],x=Sp(),T=Rp(),P=Lp();function w(){let u=zt.find(k=>k.value===P);return u?u.label:"\uC624\uB298"}let Y=Pp(),V=!1,q=new Set,E=new Set,S=new Set,L="ordinary",C=!1,ce=new Map,$e=[],le=document.createElement("div");le.className="worker-console";let me=document.createElement("div");me.className="worker-top";let Le=document.createElement("div");Le.className="worker-drawer-overlay",Le.hidden=!0;let Ge=document.createElement("div");Ge.className="worker-drawer-overlay__backdrop";let Ye=document.createElement("div");Ye.className="worker-drawer-host",Le.append(Ge,Ye);let Me=document.createElement("div");Me.className="worker-lanes-host",le.append(me,Le,Me),e.appendChild(le);let Be=null,ge=Wn(Ye,{transport:r,sessionLogStore:a,onClose:()=>{Be=null,Le.hidden=!0,Ne()}}),ye=Vn(le,{queueStore:s,presetStore:o,transport:r,getWorkspacePath:d});function Re(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,pr_wait_holds_slot:!1,slots:dn,queue:[],pr_wait:[],done:[]}}function J(){let u=Re();return typeof u.revision=="number"?u.revision:0}function H(u){u&&u.queue&&s&&s.set(u.queue)}function X(){let u=Re().queue;return Array.isArray(u)?u.length:0}async function Oe(u,k){if(!r)return;let j=await r("worker-queue-place",{bead_id:u,index:k,expected_revision:J()});H(j),j&&j.conflict&&await r("worker-queue-place",{bead_id:u,index:k,expected_revision:J()}).then(H)}async function _e(u,k){if(!r)return;let j=await r("worker-queue-reorder",{bead_id:u,to_index:k,expected_revision:J()});H(j),j&&j.conflict&&await r("worker-queue-reorder",{bead_id:u,to_index:k,expected_revision:J()}).then(H)}async function ke(u){if(!r)return;let k=await r("worker-queue-remove",{bead_id:u,expected_revision:J()});H(k),k&&k.conflict&&await r("worker-queue-remove",{bead_id:u,expected_revision:J()}).then(H)}async function B(){if(!r||C)return;let k=(Array.isArray(Re().queue)?Re().queue:[]).map(se=>se.bead_id).filter(se=>S.has(se));if(k.length===0)return;if(k.some(se=>{let Se=ce.get(se);return Se!==!0&&Se!==!1})){te("\uC2E4\uD589 \uBC29\uC2DD \uD655\uC778 \uC911","warning");return}let j=L==="serial",pe=k.filter(se=>ce.get(se)!==j);if(pe.length===0){S.clear(),Ne(),te("\uC774\uBBF8 \uAC19\uC740 \uC2E4\uD589 \uBC29\uC2DD\uC785\uB2C8\uB2E4","info");return}C=!0,Ne();let be=[],we=0;try{for(let se of pe){let Se=await Promise.resolve(r(j?"label-add":"label-remove",{id:se,label:io})).catch(()=>[]),fe=Array.isArray(Se)?Se[0]:Se,Qe=fe&&typeof fe=="object"?fe.labels:null;fe&&typeof fe=="object"&&fe.id===se&&Array.isArray(Qe)&&Xn(Qe)===j?we+=1:be.push(se)}if(be.length===0){S.clear(),te(`${we}\uAC1C \uC2E4\uD589 \uBC29\uC2DD \uBCC0\uACBD`,"success");return}S.clear();for(let se of be)S.add(se);te(`${pe.length}\uAC1C \uC911 ${we}\uAC1C \uBCC0\uACBD \xB7 ${be.length}\uAC1C \uC2E4\uD328 (${be.join(", ")})`,"error")}finally{C=!1,Ne()}}async function O(u){if(!r||!u)return;let k=await r("worker-attempt-pause",{attempt_id:u});k&&k.paused===!1&&k.reason&&te(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${k.reason}`,"error",2400)}async function oe(u){if(!r||!u)return;let k=await r("worker-attempt-resume",{attempt_id:u,expected_revision:J()});H(k),k&&k.conflict&&(k=await r("worker-attempt-resume",{attempt_id:u,expected_revision:J()}),H(k)),k&&k.resumed===!1&&!k.conflict&&k.reason&&te(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${k.reason}`,"error",2400)}async function ve(u){if(!r||!u)return;let k=await r("worker-attempt-dismiss",{attempt_id:u,expected_revision:J()});H(k),k&&k.conflict&&(k=await r("worker-attempt-dismiss",{attempt_id:u,expected_revision:J()}),H(k)),k&&k.dismissed===!1&&!k.conflict&&k.reason&&te(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${k.reason}`,"error",2400)}async function Ae(u,k){if(!r)return null;let j=r,pe=await j(u,{...k,expected_revision:J()});return H(pe),pe&&pe.conflict&&(pe=await j(u,{...k,expected_revision:J()}),H(pe)),pe}async function Ze(u){if(!r||!u)return;q.add(u),Ne();let k;try{k=await Ae("worker-merge-queue-add",{bead_id:u})}finally{q.delete(u),Ne()}!k||k.conflict||k.applied||te("\uBA38\uC9C0 \uD050\uC5D0 \uB123\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (\uC774\uBBF8 \uB300\uAE30 \uC911\uC774\uAC70\uB098 \uB300\uC0C1 \uC544\uB2D8)","error",2400)}async function Ie(u){if(!r)return;let k=await Ae("worker-merge-auto-toggle",{on:u});!k||k.conflict||te(u?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",u?"success":"info",2400)}async function D(u){if(!r||!u)return;let k=await Ae("worker-merge-queue-remove",{bead_id:u});k&&!k.conflict&&!k.applied&&k.reason==="merge_active"&&te("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function U(){await Ae("worker-merge-queue-remove",{all:!0})}async function R(u,k=null,j="unmerged",pe=null){if(!r||!u)return;let be=on(u,j);if(!(typeof globalThis.confirm!="function"||globalThis.confirm(be)))return;let se=await r("worker-discard",{bead_id:u,...k?{attempt_id:k}:{},...pe?{operation_id:pe}:{},expected_revision:J()});if(H(se),se&&se.conflict&&(se=await r("worker-discard",{bead_id:u,...k?{attempt_id:k}:{},...pe?{operation_id:pe}:{},expected_revision:J()}),H(se)),se&&se.discarded===!0){te(Kn(se),"success",5e3);return}if(se&&se.reason){te(`\uD3D0\uAE30 \uC2E4\uD328: ${se.reason}`,"error",2800);return}if(se&&se.accepted&&se.pending==="merged_revert"){te("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(se&&se.accepted&&!se.discarded){te(`\uD3D0\uAE30 \uC9C4\uD589: ${se.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}se&&!se.conflict&&te("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function y(u,k){if(!r||!k||E.has(k))return;E.add(k),Ne();let j;try{j=await r(u,{bead_id:k,expected_revision:J()}),H(j),j&&j.conflict&&(j=await r(u,{bead_id:k,expected_revision:J()}),H(j))}finally{E.delete(k),Ne()}if(!(!j||j.conflict)){if(j.ok){te(u==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}te(`\uCC98\uBD84 \uAC70\uBD80: ${j.reason||""}`,"error",3e3)}}async function z(u){if(!r)return;let k=await r("worker-queue-toggle",{on:u,expected_revision:J()});H(k),k&&k.conflict&&await r("worker-queue-toggle",{on:u,expected_revision:J()}).then(H)}async function N(u){if(!r||!Number.isFinite(u))return;let k=Math.max(dn,Math.floor(u)),j=await r("worker-queue-set-slots",{slots:k,expected_revision:J()});H(j),j&&j.conflict&&await r("worker-queue-set-slots",{slots:k,expected_revision:J()}).then(H)}async function K(u){if(!r)return;let k=await r("worker-queue-set-pr-wait-hold",{on:u,expected_revision:J()});H(k),k&&k.conflict&&await r("worker-queue-set-pr-wait-hold",{on:u,expected_revision:J()}).then(H)}function ae(){let u=Re(),k=p?p.selectBoardColumn(kp,"ready"):[],j=p?p.selectBoardColumn(wp,"blocked"):[],pe=p?p.selectBoardColumn($p,"in_progress"):[],be=new Map;for(let h of pe){let F=qp(h);if(!F)continue;let de=be.get(F);de?de.push(h):be.set(F,[h])}let we=h=>{let F=xn(be.get(h)||[]);return F?F.title||F.id:null},se=u.bead_titles||{},Se=new Map;for(let[h,F]of Object.entries(se))typeof F=="string"&&F.length>0&&Se.set(h,F);for(let h of[...k,...j])Se.set(h.id,h.title||h.id);ce.clear();let fe=u.bead_labels&&typeof u.bead_labels=="object"&&!Array.isArray(u.bead_labels)?u.bead_labels:{};for(let[h,F]of Object.entries(fe))Array.isArray(F)&&ce.set(h,Xn(F));for(let h of[...k,...j]){let F=h.labels;Array.isArray(F)&&ce.set(h.id,Xn(F))}let Qe=u.bead_times||{},St=new Map;for(let[h,F]of Object.entries(Qe))F&&typeof F=="object"&&St.set(h,F);for(let h of[...k,...j])St.set(h.id,{created_at:h.created_at,updated_at:h.updated_at});let mt=h=>St.get(h)||{},Je=u.pr_wait||[],At=u.pr_observations||{},Mt=u.pr_activity||{},Et=u.deployment_reconcile||u.reconcile||{},Ct=u.cleanup_failed||{},Ce=Object.entries(Ct).map(([h,F])=>({bead_id:h,step:F&&F.step?F.step:"",reason:F&&F.reason?F.reason:"",detail:Et[h]?.adapter==="managed"&&(F?.detail==="checkout_dirty"||F?.detail==="checkout_not_on_base"||F?.detail==="head_not_base_sha")?null:F&&typeof F.detail=="string"?F.detail:null,output_tail:F&&typeof F.output_tail=="string"&&F.output_tail?F.output_tail:void 0,log_path:F&&typeof F.log_path=="string"&&F.log_path?F.log_path:void 0,retry_count:F&&typeof F.retry_count=="number"&&Number.isInteger(F.retry_count)&&F.retry_count>0?F.retry_count:0})),Q=u.queue||[],b=new Set(Q.map(h=>h.bead_id));for(let h of S)b.has(h)||S.delete(h);let G=new Set([...Q.map(h=>h.bead_id),...Je.map(h=>h.bead_id),...u.done.map(h=>h.bead_id)]),_=new Set(j.map(h=>h.id)),v=i?i.get()?.order||{}:{},re=new Set,ne=[];for(let h of[...k,...j])G.has(h.id)||re.has(h.id)||Fp(h)||fl(h.labels)||(re.add(h.id),ne.push(h));A=Np(ne,T,v);let ee=u.admission||{},m=h=>{let F=ee[h];if(!F)return"";if(F.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let de=typeof F.reason=="string"?F.reason:"",et=de.indexOf(":");return et>0&&et<de.length-1?`\u26D4 ${de.slice(0,et)} (${de.slice(et+1)})`:`\u26D4 ${de}`},I=A.map(h=>{let F=sn(h),de=F.path.length>0,et=h.workflow?.route==="quick_fix"||h.metadata&&h.metadata.route==="quick_fix",gn=!et&&de&&!F.conflict,kr=_.has(h.id),Gt=[];kr&&Gt.push(Bp(h)),et?Gt.push("quick_fix \xB7 \uC6CC\uCEE4 \uBE44\uB300\uC0C1"):F.conflict?Gt.push("spec_id_conflict"):de||Gt.push("spec \uC5C6\uC74C");let hn=m(h.id);return hn&&Gt.push(hn),{id:h.id,title:h.title||h.id,reason:Gt.join(" \xB7 "),draggable:gn,lane:"candidate",created_at:h.created_at,updated_at:h.updated_at,workflow:h.workflow,is_quick_fix:et,status:h.status,blocked:kr,has_spec:de}}),$=Tp(I,x),Z=$.visible,Ue=u.revise_parked||{},ot=u.discard_operations&&typeof u.discard_operations=="object"&&!Array.isArray(u.discard_operations)?u.discard_operations:{},ht=(h,F)=>h.map(de=>{let et=F==="queue"?Ue[de.bead_id]:null,gn=F==="queue"?Ht(ot,de.bead_id):null,kr=gn?.operation?gn:null,Gt=F==="queue"?ce.has(de.bead_id)?ce.get(de.bead_id)||!1:null:!1,hn=Gt===!0&&(Object.values(u.attempts||{}).some(Yt=>Yt&&Yt.bead_id!==de.bead_id&&!xp.has(Yt.status))||Je.some(Yt=>Yt.bead_id!==de.bead_id)||Object.values(ot).some(Yt=>Yt&&Yt.bead_id!==de.bead_id&&Yt.phase!=="done")),Io=F==="done"?[]:[m(de.bead_id)];return hn&&Io.unshift("\uB2E4\uB978 \uC791\uC5C5 \uC885\uB8CC \uB300\uAE30 \xB7 \uBA38\uC9C0\uAE4C\uC9C0 \uB2E8\uB3C5"),{id:de.bead_id,title:Se.get(de.bead_id)||de.bead_id,reason:Io.filter(Boolean).join(" \xB7 "),draggable:F!=="done"&&!kr,done:F==="done",lane:F,selectable:F==="queue",selected:F==="queue"&&S.has(de.bead_id),worker_serial:Gt,discard:kr,badges:et?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!et,revise_action:!!et,revise_enabled:!!et&&!kr&&!E.has(de.bead_id),revise_title:et?et.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${et.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:F==="done"?Ot(u.attempts||{},de.bead_id):null,done_at:F==="done"&&typeof de.added_at=="number"?de.added_at:void 0,...mt(de.bead_id)}}),Fe=new Map;for(let h of u.done)h&&typeof h.bead_id=="string"&&typeof h.added_at=="number"&&Fe.set(h.bead_id,h.added_at);let It=u.attempts?Object.values(u.attempts):[],Nr=new Set;for(let h of It)h&&typeof h.resumed_from=="string"&&h.resumed_from.length>0&&Nr.add(h.resumed_from);let Jn=new Map;for(let h of It)Jn.set(h.bead_id,h.attempt_id);let es=new Map;for(let h of It)es.set(h.attempt_id,h);function ts(h){let F=new Set,de=h;for(;de&&!F.has(de.attempt_id);){if(de.conflict_resolution===!0)return!0;F.add(de.attempt_id),de=typeof de.resumed_from=="string"&&de.resumed_from.length>0&&es.get(de.resumed_from)||null}return!1}let pn=typeof u.declared_base=="string"?u.declared_base:null;function Ll(h){let F=null;for(let de of It)!de||de.bead_id!==h||ts(de)||(F===null||(typeof de.started_at=="number"?de.started_at:0)>=(typeof F.started_at=="number"?F.started_at:0))&&(F=de);return F&&typeof F.target_base=="string"?F.target_base:null}let mo=[],go=[],Ol=h=>{let F=Jn.get(h.bead_id)!==h.attempt_id,de=Fe.get(h.bead_id),et=typeof de=="number"&&de>0&&typeof h.finished_at=="number"&&de>=h.finished_at;return!F&&!et&&typeof h.dismissed_at!="number"},ho=h=>{let F=typeof h.session_id=="string"&&h.session_id.length>0,de=Nr.has(h.attempt_id);return{eligible:F&&!de,reason:F?de?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Nt=null;for(let h of It){let F=h.status==="paused"&&!Nr.has(h.attempt_id);if(h.status==="running"||F)go.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:Se.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,paused:F,conflict_resolution:ts(h),base_exception:co(pn,h.target_base),can_pause:typeof h.session_id=="string"&&h.session_id.length>0,discard:Ht(ot,h.bead_id,{attempt_id:h.attempt_id}),usage:Ot(u.attempts||{},h.bead_id),current_child:we(h.bead_id),...mt(h.bead_id)});else if((h.status==="failed"||h.status==="orphaned")&&Ol(h)){let de=ho(h);mo.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:Se.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,failed:!0,status:h.status,status_label:h.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Ht(ot,h.bead_id,{attempt_id:h.attempt_id}),resume_eligible:de.eligible,resume_reason:de.reason,conflict_resolution:ts(h),base_exception:co(pn,h.target_base),usage:Ot(u.attempts||{},h.bead_id),current_child:we(h.bead_id),...mt(h.bead_id)}),Nt=h}}let fn=[...mo,...go],bo=null;if(Nt){let h=ho(Nt),F=Nt.cause_detail;bo={bead_id:Nt.bead_id,repo:Nt.repo||"",reason:Nt.cause||Nt.status,cause_detail:F&&typeof F.reason=="string"?{reason:F.reason,command:typeof F.command=="string"?F.command:null}:null,resume_attempt_id:Nt.attempt_id,resume_eligible:h.eligible,resume_reason:h.reason,discard:Ht(ot,Nt.bead_id,{attempt_id:Nt.attempt_id})}}let Dl=new Set(fn.map(h=>h.bead_id)),rs=Array.isArray(u.merge_queue)?u.merge_queue:[],vo=new Map,yo=new Map;rs.forEach((h,F)=>{h&&typeof h.bead_id=="string"&&(vo.set(h.bead_id,F+1),yo.set(h.bead_id,h.resolution))});let ko=u.merge_queue_state||{active:null,failures:{}},Pl=ko.failures||{},Ml=u.auto_merge_skips||{},wo=h=>{let F=Ml[h];if(!F)return null;let de=At[h],et=de&&de.pr?de.pr.head_sha:null;return et&&et===F.head_sha?F.reason||"":null},_n=new Map;for(let h of fn)h.failed!==!0&&h.conflict_resolution&&(h.paused?_n.has(h.bead_id)||_n.set(h.bead_id,"paused"):_n.set(h.bead_id,"running"));let $o=fn.filter(h=>!h.paused&&h.failed!==!0).length,xo=(u.workspace_info||{}).slots,Nl=typeof xo=="number"?xo:typeof u.slots=="number"?u.slots:dn,So=u.pr_wait_holds_slot===!0?dn:Nl,Fl=$o>So,Ao=xr(P),ql=(Array.isArray(u.done)?u.done.slice():[]).filter(h=>Ao===void 0||typeof h.added_at!="number"||h.added_at>=Ao).sort((h,F)=>(F.added_at||0)-(h.added_at||0)),ns=ht(ql,"done"),mn={};for(let h of Zt)mn[h]=0;let To=!1,Eo=0,ss=0,Co=0;for(let h of ns){let F=h.usage;if(F&&typeof F=="object"){let de=!1;for(let et of Zt)Number.isFinite(F[et])&&(mn[et]+=F[et],To=!0,de=!0);de&&(ss+=1,Number.isFinite(F.total_cost_usd)&&(Eo+=F.total_cost_usd,Co+=1))}}ss>0&&Co===ss&&(mn.total_cost_usd=Eo);let Ro=ns.map(h=>h.usage).filter(h=>h&&typeof h=="object"&&h.providers),Bl=Ro.length>0?gt(In(Ro)):To?qt(mn):null;return{queue:u,idToTitle:Se,candidates:Z,candidate_hidden:{blocked:$.hidden_blocked,spec:$.hidden_spec},running:fn,live_count:$o,slots:So,over_cap:Fl,failure:bo,waiting:ht(Q.filter(h=>!Dl.has(h.bead_id)),"queue"),pr_wait:Je.map(h=>Kp(h.bead_id,Se.get(h.bead_id)||h.bead_id,At,Ct[h.bead_id]||null,Ot(u.attempts||{},h.bead_id),Gp(Et[h.bead_id])||Mt[h.bead_id]||(q.has(h.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),_n.get(h.bead_id)||null,h.external===!0,{position:vo.get(h.bead_id)||0,active:ko.active===h.bead_id,failure:Pl[h.bead_id]||null,resolution:yo.get(h.bead_id)},h.wt_present!==!1,u.auto_merge===!0?wo(h.bead_id):null,co(pn,Ll(h.bead_id)),u.completion_status&&typeof u.completion_status=="object"&&!Array.isArray(u.completion_status)&&u.completion_status[h.bead_id]||null,u.discard_operations&&typeof u.discard_operations=="object"&&!Array.isArray(u.discard_operations)?u.discard_operations:{},es.get(Jn.get(h.bead_id)||"")?.worker_serial===!0)).map(h=>({...h,...mt(h.id)})),merge_queue_length:rs.length,merge_queue_running:rs.length>0,auto_excluded:Je.map(h=>h.bead_id).filter(h=>wo(h)!==null),verify_cmd_present:!!(u.workspace_info||{}).verify_cmd,declared_base:pn,done:ns,token_total:Bl,cleanup_failures:Ce}}function xe(u){let k=u.waiting.length>0?u.waiting[0].id:"\u2014",j=c`<button
      type="button"
    ...
    >`,Se=c`<label class="worker-tgl worker-slots"
      ...
      >
        ...
        <div class="worker-kpi">
          ${be}${we}${se}
          ${(Array.isArray(u.token_total)?u.token_total:u.token_total?[{label:u.token_total,tooltip:`${w()} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}]:[]).map(Qe=>c`<span
                class="worker-kpi__chip worker-kpi__chip--tokens"
                title=${Qe.tooltip}
                >${w()} 완료 · 누적 ${Qe.label}</span
              >`)}
    ...
    </div>`}function ze(){if(S.size===0)return"";let u=Array.from(S),k=u.some(j=>{let pe=ce.get(j);return pe!==!0&&pe!==!1});return c`<div
      class="worker-bulk"
      role="group"
    ...
    `}function q(){let S=t.getState(),L=S.workspace?.current,C=S.workspace?.available||[],ce=new Set(S.workspace?.hidden||[]),$e=L?.path||C[0]?.path||"";if(C.length===0)return c``;let le=C.filter(me=>!ce.has(me.path)||me.path===$e);if(le.length<=1){let me=le[0]||C[0],Le=po(me.path);return c`
