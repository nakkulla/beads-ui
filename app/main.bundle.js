var W_=Object.create;var sa=Object.defineProperty;var z_=Object.getOwnPropertyDescriptor;var H_=Object.getOwnPropertyNames;var G_=Object.getPrototypeOf,K_=Object.prototype.hasOwnProperty;var V_=(e,t,n)=>t in e?sa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var ia=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Y_=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of H_(t))!K_.call(e,o)&&o!==n&&sa(e,o,{get:()=>t[o],enumerable:!(r=z_(t,o))||r.enumerable});return e};var X_=(e,t,n)=>(n=e!=null?W_(G_(e)):{},Y_(t||!e||!e.__esModule?sa(n,"default",{value:e,enumerable:!0}):n,e));var Rt=(e,t,n)=>V_(e,typeof t!="symbol"?t+"":t,n);var Mc=ia((Rw,Pc)=>{var jr=1e3,Br=jr*60,Ur=Br*60,xr=Ur*24,J_=xr*7,em=xr*365.25;Pc.exports=function(e,t){t=t||{};var n=typeof e;if(n==="string"&&e.length>0)return tm(e);if(n==="number"&&isFinite(e))return t.long?rm(e):nm(e);throw new Error("val is not a non-empty string or a valid number. val="+JSON.stringify(e))};function tm(e){if(e=String(e),!(e.length>100)){var t=/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(e);if(t){var n=parseFloat(t[1]),r=(t[2]||"ms").toLowerCase();switch(r){case"years":case"year":case"yrs":case"yr":case"y":return n*em;case"weeks":case"week":case"w":return n*J_;case"days":case"day":case"d":return n*xr;case"hours":case"hour":case"hrs":case"hr":case"h":return n*Ur;case"minutes":case"minute":case"mins":case"min":case"m":return n*Br;case"seconds":case"second":case"secs":case"sec":case"s":return n*jr;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return n;default:return}}}}function nm(e){var t=Math.abs(e);return t>=xr?Math.round(e/xr)+"d":t>=Ur?Math.round(e/Ur)+"h":t>=Br?Math.round(e/Br)+"m":t>=jr?Math.round(e/jr)+"s":e+"ms"}function rm(e){var t=Math.abs(e);return t>=xr?Cs(e,t,xr,"day"):t>=Ur?Cs(e,t,Ur,"hour"):t>=Br?Cs(e,t,Br,"minute"):t>=jr?Cs(e,t,jr,"second"):e+" ms"}function Cs(e,t,n,r){var o=t>=n*1.5;return Math.round(e/n)+" "+r+(o?"s":"")}});var qc=ia((Ow,Nc)=>{function om(e){n.debug=n,n.default=n,n.coerce=a,n.disable=i,n.enable=o,n.enabled=l,n.humanize=Mc(),n.destroy=c,Object.keys(e).forEach(u=>{n[u]=e[u]}),n.names=[],n.skips=[],n.formatters={};function t(u){let m=0;for(let y=0;y<u.length;y++)m=(m<<5)-m+u.charCodeAt(y),m|=0;return n.colors[Math.abs(m)%n.colors.length]}n.selectColor=t;function n(u){let m,y=null,b,k;function D(...q){if(!D.enabled)return;let Y=D,ae=Number(new Date),ee=ae-(m||ae);Y.diff=ee,Y.prev=m,Y.curr=ae,m=ae,q[0]=n.coerce(q[0]),typeof q[0]!="string"&&q.unshift("%O");let j=0;q[0]=q[0].replace(/%([a-zA-Z%])/g,(U,X)=>{if(U==="%%")return"%";j++;let V=n.formatters[X];if(typeof V=="function"){let _e=q[j];U=V.call(Y,_e),q.splice(j,1),j--}return U}),n.formatArgs.call(Y,q),(Y.log||n.log).apply(Y,q)}return D.namespace=u,D.useColors=n.useColors(),D.color=n.selectColor(u),D.extend=r,D.destroy=n.destroy,Object.defineProperty(D,"enabled",{enumerable:!0,configurable:!1,get:()=>y!==null?y:(b!==n.namespaces&&(b=n.namespaces,k=n.enabled(u)),k),set:q=>{y=q}}),typeof n.init=="function"&&n.init(D),D}function r(u,m){let y=n(this.namespace+(typeof m>"u"?":":m)+u);return y.log=this.log,y}function o(u){n.save(u),n.namespaces=u,n.names=[],n.skips=[];let m=(typeof u=="string"?u:"").trim().replace(/\s+/g,",").split(",").filter(Boolean);for(let y of m)y[0]==="-"?n.skips.push(y.slice(1)):n.names.push(y)}function s(u,m){let y=0,b=0,k=-1,D=0;for(;y<u.length;)if(b<m.length&&(m[b]===u[y]||m[b]==="*"))m[b]==="*"?(k=b,D=y,b++):(y++,b++);else if(k!==-1)b=k+1,D++,y=D;else return!1;for(;b<m.length&&m[b]==="*";)b++;return b===m.length}function i(){let u=[...n.names,...n.skips.map(m=>"-"+m)].join(",");return n.enable(""),u}function l(u){for(let m of n.skips)if(s(u,m))return!1;for(let m of n.names)if(s(u,m))return!0;return!1}function a(u){return u instanceof Error?u.stack||u.message:u}function c(){console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.")}return n.enable(n.load()),n}Nc.exports=om});var Fc=ia((vn,Rs)=>{vn.formatArgs=im;vn.save=am;vn.load=lm;vn.useColors=sm;vn.storage=cm();vn.destroy=(()=>{let e=!1;return()=>{e||(e=!0,console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."))}})();vn.colors=["#0000CC","#0000FF","#0033CC","#0033FF","#0066CC","#0066FF","#0099CC","#0099FF","#00CC00","#00CC33","#00CC66","#00CC99","#00CCCC","#00CCFF","#3300CC","#3300FF","#3333CC","#3333FF","#3366CC","#3366FF","#3399CC","#3399FF","#33CC00","#33CC33","#33CC66","#33CC99","#33CCCC","#33CCFF","#6600CC","#6600FF","#6633CC","#6633FF","#66CC00","#66CC33","#9900CC","#9900FF","#9933CC","#9933FF","#99CC00","#99CC33","#CC0000","#CC0033","#CC0066","#CC0099","#CC00CC","#CC00FF","#CC3300","#CC3333","#CC3366","#CC3399","#CC33CC","#CC33FF","#CC6600","#CC6633","#CC9900","#CC9933","#CCCC00","#CCCC33","#FF0000","#FF0033","#FF0066","#FF0099","#FF00CC","#FF00FF","#FF3300","#FF3333","#FF3366","#FF3399","#FF33CC","#FF33FF","#FF6600","#FF6633","#FF9900","#FF9933","#FFCC00","#FFCC33"];function sm(){if(typeof window<"u"&&window.process&&(window.process.type==="renderer"||window.process.__nwjs))return!0;if(typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/))return!1;let e;return typeof document<"u"&&document.documentElement&&document.documentElement.style&&document.documentElement.style.WebkitAppearance||typeof window<"u"&&window.console&&(window.console.firebug||window.console.exception&&window.console.table)||typeof navigator<"u"&&navigator.userAgent&&(e=navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/))&&parseInt(e[1],10)>=31||typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)}function im(e){if(e[0]=(this.useColors?"%c":"")+this.namespace+(this.useColors?" %c":" ")+e[0]+(this.useColors?"%c ":" ")+"+"+Rs.exports.humanize(this.diff),!this.useColors)return;let t="color: "+this.color;e.splice(1,0,t,"color: inherit");let n=0,r=0;e[0].replace(/%[a-zA-Z%]/g,o=>{o!=="%%"&&(n++,o==="%c"&&(r=n))}),e.splice(r,0,t)}vn.log=console.debug||console.log||(()=>{});function am(e){try{e?vn.storage.setItem("debug",e):vn.storage.removeItem("debug")}catch{}}function lm(){let e;try{e=vn.storage.getItem("debug")||vn.storage.getItem("DEBUG")}catch{}return!e&&typeof process<"u"&&"env"in process&&(e=process.env.DEBUG),e}function cm(){try{return localStorage}catch{}}Rs.exports=qc()(vn);var{formatters:dm}=Rs.exports;dm.j=function(e){try{return JSON.stringify(e)}catch(t){return"[UnexpectedJSONParseError]: "+t.message}}});var mo=globalThis,ks=mo.trustedTypes,yc=ks?ks.createPolicy("lit-html",{createHTML:e=>e}):void 0,la="$lit$",Qn=`lit$${Math.random().toFixed(9).slice(2)}$`,ca="?"+Qn,Z_=`<${ca}>`,vr=document,go=()=>vr.createComment(""),bo=e=>e===null||typeof e!="object"&&typeof e!="function",da=Array.isArray,Ac=e=>da(e)||typeof e?.[Symbol.iterator]=="function",aa=`[ 	
\f\r]`,_o=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,vc=/-->/g,wc=/>/g,hr=RegExp(`>|${aa}(?:([^\\s"'>=/]+)(${aa}*=${aa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),kc=/'/g,$c=/"/g,Sc=/^(?:script|style|textarea|title)$/i,ua=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),d=ua(1),yo=ua(2),$w=ua(3),Rn=Symbol.for("lit-noChange"),Wt=Symbol.for("lit-nothing"),xc=new WeakMap,yr=vr.createTreeWalker(vr,129);function Ec(e,t){if(!da(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return yc!==void 0?yc.createHTML(t):t}var Tc=(e,t)=>{let n=e.length-1,r=[],o,s=t===2?"<svg>":t===3?"<math>":"",i=_o;for(let l=0;l<n;l++){let a=e[l],c,u,m=-1,y=0;for(;y<a.length&&(i.lastIndex=y,u=i.exec(a),u!==null);)y=i.lastIndex,i===_o?u[1]==="!--"?i=vc:u[1]!==void 0?i=wc:u[2]!==void 0?(Sc.test(u[2])&&(o=RegExp("</"+u[2],"g")),i=hr):u[3]!==void 0&&(i=hr):i===hr?u[0]===">"?(i=o??_o,m=-1):u[1]===void 0?m=-2:(m=i.lastIndex-u[2].length,c=u[1],i=u[3]===void 0?hr:u[3]==='"'?$c:kc):i===$c||i===kc?i=hr:i===vc||i===wc?i=_o:(i=hr,o=void 0);let b=i===hr&&e[l+1].startsWith("/>")?" ":"";s+=i===_o?a+Z_:m>=0?(r.push(c),a.slice(0,m)+la+a.slice(m)+Qn+b):a+Qn+(m===-2?l:b)}return[Ec(e,s+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},ho=class e{constructor({strings:t,_$litType$:n},r){let o;this.parts=[];let s=0,i=0,l=t.length-1,a=this.parts,[c,u]=Tc(t,n);if(this.el=e.createElement(c,r),yr.currentNode=this.el.content,n===2||n===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(o=yr.nextNode())!==null&&a.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(let m of o.getAttributeNames())if(m.endsWith(la)){let y=u[i++],b=o.getAttribute(m).split(Qn),k=/([.?@])?(.*)/.exec(y);a.push({type:1,index:s,name:k[2],strings:b,ctor:k[1]==="."?xs:k[1]==="?"?As:k[1]==="@"?Ss:kr}),o.removeAttribute(m)}else m.startsWith(Qn)&&(a.push({type:6,index:s}),o.removeAttribute(m));if(Sc.test(o.tagName)){let m=o.textContent.split(Qn),y=m.length-1;if(y>0){o.textContent=ks?ks.emptyScript:"";for(let b=0;b<y;b++)o.append(m[b],go()),yr.nextNode(),a.push({type:2,index:++s});o.append(m[y],go())}}}else if(o.nodeType===8)if(o.data===ca)a.push({type:2,index:s});else{let m=-1;for(;(m=o.data.indexOf(Qn,m+1))!==-1;)a.push({type:7,index:s}),m+=Qn.length-1}s++}}static createElement(t,n){let r=vr.createElement("template");return r.innerHTML=t,r}};function wr(e,t,n=e,r){if(t===Rn)return t;let o=r!==void 0?n._$Co?.[r]:n._$Cl,s=bo(t)?void 0:t._$litDirective$;return o?.constructor!==s&&(o?._$AO?.(!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=o:n._$Cl=o),o!==void 0&&(t=wr(e,o._$AS(e,t.values),o,r)),t}var $s=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,o=(t?.creationScope??vr).importNode(n,!0);yr.currentNode=o;let s=yr.nextNode(),i=0,l=0,a=r[0];for(;a!==void 0;){if(i===a.index){let c;a.type===2?c=new qr(s,s.nextSibling,this,t):a.type===1?c=new a.ctor(s,a.name,a.strings,this,t):a.type===6&&(c=new Es(s,this,t)),this._$AV.push(c),a=r[++l]}i!==a?.index&&(s=yr.nextNode(),i++)}return yr.currentNode=vr,o}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},qr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,o){this.type=2,this._$AH=Wt,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=wr(this,t,n),bo(t)?t===Wt||t==null||t===""?(this._$AH!==Wt&&this._$AR(),this._$AH=Wt):t!==this._$AH&&t!==Rn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ac(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Wt&&bo(this._$AH)?this._$AA.nextSibling.data=t:this.T(vr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=ho.createElement(Ec(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(n);else{let s=new $s(o,this),i=s.u(this.options);s.p(n),this.T(i),this._$AH=s}}_$AC(t){let n=xc.get(t.strings);return n===void 0&&xc.set(t.strings,n=new ho(t)),n}k(t){da(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,o=0;for(let s of t)o===n.length?n.push(r=new e(this.O(go()),this.O(go()),this,this.options)):r=n[o],r._$AI(s),o++;o<n.length&&(this._$AR(r&&r._$AB.nextSibling,o),n.length=o)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},kr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,o,s){this.type=1,this._$AH=Wt,this._$AN=void 0,this.element=t,this.name=n,this._$AM=o,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Wt}_$AI(t,n=this,r,o){let s=this.strings,i=!1;if(s===void 0)t=wr(this,t,n,0),i=!bo(t)||t!==this._$AH&&t!==Rn,i&&(this._$AH=t);else{let l=t,a,c;for(t=s[0],a=0;a<s.length-1;a++)c=wr(this,l[r+a],n,a),c===Rn&&(c=this._$AH[a]),i||(i=!bo(c)||c!==this._$AH[a]),c===Wt?t=Wt:t!==Wt&&(t+=(c??"")+s[a+1]),this._$AH[a]=c}i&&!o&&this.j(t)}j(t){t===Wt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},xs=class extends kr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Wt?void 0:t}},As=class extends kr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Wt)}},Ss=class extends kr{constructor(t,n,r,o,s){super(t,n,r,o,s),this.type=5}_$AI(t,n=this){if((t=wr(this,t,n,0)??Wt)===Rn)return;let r=this._$AH,o=t===Wt&&r!==Wt||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,s=t!==Wt&&(r===Wt||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Es=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){wr(this,t)}},Cc={M:la,P:Qn,A:ca,C:1,L:Tc,R:$s,D:Ac,V:wr,I:qr,H:kr,N:As,U:Ss,B:xs,F:Es},Q_=mo.litHtmlPolyfillSupport;Q_?.(ho,qr),(mo.litHtmlVersions??(mo.litHtmlVersions=[])).push("3.3.1");var rt=(e,t,n)=>{let r=n?.renderBefore??t,o=r._$litPart$;if(o===void 0){let s=n?.renderBefore??null;r._$litPart$=o=new qr(t.insertBefore(go(),s),s,void 0,n??{})}return o._$AI(e),o};var Ts="today",Rc=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}],Fr=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"}];function Gn(e){return e==="today"?"today":"7d"}function pa(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function $r(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function Oc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Lc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Ic(){let e=null,t=[],n,r=new Set;function o(){for(let s of Array.from(r))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},crossLanes(){return n},set(s,i,l){e=Array.isArray(s)?s:null,t=Array.isArray(i)?i:[],n=l===void 0?void 0:l!==null&&typeof l=="object"&&typeof l.revision=="number"&&Array.isArray(l.lanes)?{revision:l.revision,lanes:l.lanes}:null,o()},clear(){e=null,t=[],n=void 0,o()},subscribe(s){return r.add(s),()=>r.delete(s)}}}function Dc(){let e=new Map,t=new Set;function n(o){return o.startsWith("session-log:")?o:`session-log:${o}`}function r(){for(let o of Array.from(t))try{o()}catch{}}return{set(o,s,i=null){e.set(n(o),{lines:Array.isArray(s)?[...s]:[],last_event_at:typeof i=="number"?i:null}),r()},append(o,s){let i=n(o),l=e.get(i)||{lines:[],last_event_at:null};l.lines=[...l.lines,s],l.last_event_at=Date.now(),e.set(i,l),r()},get(o){return e.get(n(o))||null},clear(o){typeof o=="string"?e.delete(n(o)):e.clear(),r()},subscribe(o){return t.add(o),()=>t.delete(o)}}}var jc=X_(Fc(),1);function qt(e){return(0,jc.default)(`beads-ui:${e}`)}function um(e){let t=e&&typeof e=="object"?e:{},n=t.metadata&&typeof t.metadata=="object"?t.metadata:{},r=Os(t.spec_id),o=Os(n.spec_id);return r?{path:r,source:"native",conflict:o.length>0&&o!==r}:o?{path:o,source:"metadata",conflict:!1}:{path:"",source:"none",conflict:!1}}function Os(e){return typeof e=="string"?e.trim():""}function pm(e){let t=um(e);if(t.path)return t;let n=Os(Bc(e).spec_path);return n?{path:n,source:"draft",conflict:!1}:t}function Bc(e){let t=e&&typeof e=="object"?e:{};return t.metadata&&typeof t.metadata=="object"?t.metadata:{}}var fm=/^[A-Za-z0-9_.:-]+@[0-9a-fA-F]{40}$/;function Wr(e){let t=pm(e),n=Os(Bc(e).spec_review),r=fm.test(n),o=r&&n.slice(0,n.indexOf("@"))==="skipped";if(t.source==="none")return{...t,evidence:"none",skipped:o};let s=t.source!=="draft"&&r;return{...t,evidence:s?"published":"draft",skipped:o}}function Dn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function vo(e,t){let n=Dn(e.created_at),r=Dn(t.created_at);if(n!==r)return n<r?1:-1;let o=e.priority??2,s=t.priority??2;if(o!==s)return o-s;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function Kc(e,t){let n=Dn(e.created_at),r=Dn(t.created_at);if(n!==r)return n<r?-1:1;let o=e.priority??2,s=t.priority??2;if(o!==s)return o-s;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function Vc(e,t){let n=Dn(e.updated_at),r=Dn(t.updated_at);if(n!==r)return n<r?1:-1;let o=e.id,s=t.id;return o<s?-1:o>s?1:0}function Yc(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let o=Dn(e.created_at),s=Dn(t.created_at);if(o!==s)return o<s?1:-1;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function Xc(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let o=e?.id,s=t?.id;return o<s?-1:o>s?1:0}var Ls=Object.freeze({priority:"asc",dependents:"desc",released:"desc",spec:"desc",created:"asc",updated:"desc"});function _m(e){return typeof e=="string"&&Object.prototype.hasOwnProperty.call(Ls,e)}function _a(e){if(!e||typeof e!="object")return!1;let t=e;return _m(t.key)&&(t.dir==="asc"||t.dir==="desc")}function Uc(e){if(typeof e=="number")return Number.isFinite(e)?e:null;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:null}return null}function Wc(e,t){switch(t){case"priority":{let n=e.priority;return typeof n=="number"&&Number.isFinite(n)?n:null}case"dependents":{let n=e.dependents_info?e.dependents_info.count:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"released":{let n=e.release_info?e.release_info.last_released_at:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"spec":return Wr(e).evidence==="published"?1:0;case"created":return Uc(e.created_at);case"updated":return Uc(e.updated_at);default:return null}}function zc(e,t,n){let r=Wc(e,n.key),o=Wc(t,n.key);if(r===null||o===null)return r===o?0:r===null?1:-1;if(r===o)return 0;let s=r<o?-1:1;return n.dir==="desc"?-s:s}function Zc(e){let t=Array.isArray(e)?e.filter(_a):[];return(n,r)=>{for(let l of t){let a=zc(n,r,l);if(a!==0)return a}let o=zc(n,r,{key:"created",dir:"asc"});if(o!==0)return o;let s=n.id,i=r.id;return s<i?-1:s>i?1:0}}var mm=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function Hc(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Gc(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=mm.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Qc(e,t){let n=Hc(e),r=Hc(t);if(n!==r)return n<r?-1:1;let o=Gc(e),s=Gc(t);if(o!==s)return o<s?-1:1;let i=Dn(e&&e.created_at),l=Dn(t&&t.created_at);if(i!==l)return i<l?-1:1;let a=e&&e.id,c=t&&t.id;return a===c?0:String(a)<String(c)?-1:1}var fa=2**20;function zr(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-Dn(e&&e.created_at)}function Jc(e){return(t,n)=>{let r=zr(t,e),o=zr(n,e);if(r!==o)return r<o?-1:1;let s=t?.id,i=n?.id;return s<i?-1:s>i?1:0}}function ma(e,t,n){let r=Array.isArray(e)?e:[],o=r.length,s=Math.max(0,Math.min(t,o-1)),i=s-1>=0?r[s-1]:null,l=s+1<o?r[s+1]:null;if(!i&&!l)return{rank:0};if(!i)return{rank:zr(l,n)-fa};if(!l)return{rank:zr(i,n)+fa};let a=zr(i,n),c=zr(l,n),u=(a+c)/2;return a<u&&u<c?{rank:u}:{renormalize:r.map((m,y)=>({bead_id:m.id,rank:y*fa}))}}function ga(e,t={}){let n=qt(`issue-store:${e}`),r=new Map,o=[],s=0,i=new Set,l=!1,a=t.sort||vo;function c(){for(let y of Array.from(i))try{y()}catch{}}function u(){o=Array.from(r.values()).sort(a)}function m(y){if(l||!y||y.id!==e)return;let b=Number(y.revision)||0;if(n("apply %s rev=%d",y.type,b),!(b<=s&&y.type!=="snapshot")){if(y.type==="snapshot"){if(b<=s)return;r.clear();let k=Array.isArray(y.issues)?y.issues:[];for(let D of k)D&&typeof D.id=="string"&&D.id.length>0&&r.set(D.id,D);u(),s=b,c();return}if(y.type==="upsert"){let k=y.issue;if(k&&typeof k.id=="string"&&k.id.length>0){let D=r.get(k.id);if(!D)r.set(k.id,k);else{let q=Number.isFinite(D.updated_at)?D.updated_at:0,Y=Number.isFinite(k.updated_at)?k.updated_at:0;if(q<=Y){for(let ae of Object.keys(D))ae in k||delete D[ae];for(let[ae,ee]of Object.entries(k))D[ae]=ee}}u()}s=b,c()}else if(y.type==="delete"){let k=String(y.issue_id||"");k&&(r.delete(k),u()),s=b,c()}}}return{id:e,subscribe(y){return i.add(y),()=>{i.delete(y)}},applyPush:m,snapshot(){return o},size(){return r.size},getById(y){return r.get(y)},dispose(){l=!0,r.clear(),o=[],i.clear(),s=0}}}function Is(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let o=Object.keys(e.params).sort();for(let s of o){let i=e.params[s];n[s]=String(i)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function ed(e){let t=qt("subs"),n=new Map,r=new Map;function o(l,a){t("applyDelta %s +%d ~%d -%d",l,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let c=r.get(l);if(!c||c.size===0)return;let u=Array.isArray(a.added)?a.added:[],m=Array.isArray(a.updated)?a.updated:[],y=Array.isArray(a.removed)?a.removed:[];for(let b of Array.from(c)){let k=n.get(b);if(!k)continue;let D=k.itemsById;for(let q of u)typeof q=="string"&&q.length>0&&D.set(q,!0);for(let q of m)typeof q=="string"&&q.length>0&&D.set(q,!0);for(let q of y)typeof q=="string"&&q.length>0&&D.delete(q)}}async function s(l,a){let c=Is(a);if(t("subscribe %s key=%s",l,c),!n.has(l))n.set(l,{key:c,itemsById:new Map});else{let m=n.get(l);if(m&&m.key!==c){let y=r.get(m.key);y&&(y.delete(l),y.size===0&&r.delete(m.key)),n.set(l,{key:c,itemsById:new Map})}}r.has(c)||r.set(c,new Set);let u=r.get(c);u&&u.add(l);try{await e("subscribe-list",{id:l,type:a.type,params:a.params})}catch(m){let y=n.get(l)||null;if(y){let b=r.get(y.key);b&&(b.delete(l),b.size===0&&r.delete(y.key))}throw n.delete(l),m}return async()=>{t("unsubscribe %s key=%s",l,c);try{await e("unsubscribe-list",{id:l})}catch{}let m=n.get(l)||null;if(m){let y=r.get(m.key);y&&(y.delete(l),y.size===0&&r.delete(m.key))}n.delete(l)}}return{subscribeList:s,_applyDelta:o,_subKeyOf:Is,selectors:{getIds(l){let a=n.get(l);return a?Array.from(a.itemsById.keys()):[]},has(l,a){let c=n.get(l);return c?c.itemsById.has(a):!1},count(l){let a=n.get(l);return a?a.itemsById.size:0},getItemsById(l){let a=n.get(l),c={};if(!a)return c;for(let u of a.itemsById.keys())c[u]=!0;return c}}}}function td(){let e=qt("issue-stores"),t=new Map,n=new Map,r=new Set,o=new Map;function s(){for(let a of Array.from(r))try{a()}catch{}}function i(a,c,u){let m=c?Is(c):"",y=n.get(a)||"",b=t.has(a);if(e("register %s key=%s (prev=%s)",a,m,y),b&&y&&m&&y!==m){let k=t.get(a);if(k)try{k.dispose()}catch{}let D=o.get(a);if(D){try{D()}catch{}o.delete(a)}let q=ga(a,u);t.set(a,q);let Y=q.subscribe(()=>s());o.set(a,Y)}else if(!b){let k=ga(a,u);t.set(a,k);let D=k.subscribe(()=>s());o.set(a,D)}return n.set(a,m),()=>l(a)}function l(a){e("unregister %s",a),n.delete(a);let c=t.get(a);c&&(c.dispose(),t.delete(a));let u=o.get(a);if(u){try{u()}catch{}o.delete(a)}}return{register:i,unregister:l,getStore(a){return t.get(a)||null},snapshotFor(a){let c=t.get(a);return c?c.snapshot().slice():[]},subscribe(a){return r.add(a),()=>r.delete(a)}}}function nd(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function rd(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function ba(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function gm(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),o=r>=0?n.slice(r+1):"";if(o){let l=new URLSearchParams(o).get("issue");if(l)return decodeURIComponent(l)}let s=/^\/issue\/([^\s?#]+)/.exec(n);return s&&s[1]?decodeURIComponent(s[1]):null}function bm(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function od(e){let t=qt("router"),n=()=>{let r=window.location.hash||"",o=/^#\/issue\/([^\s?#]+)/.exec(r),s=o&&o[1]?decodeURIComponent(o[1]):gm(r),i=bm(r);if(t("hash change \u2192 view=%s id=%s",i,s),e.setState({selected_id:i==="worker"?null:s,view:i,worker:{selected_parent_id:i==="worker"?s:null}}),!!o||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let a=s?`#/${i}?issue=${encodeURIComponent(s)}`:`#/${i}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let o=e.getState?e.getState():{view:"board"},s=o.view==="worker"||o.view==="monitor"?o.view:"board",i=ba(s,r);t("goto issue %s (view=%s)",r,s),window.location.hash!==i?window.location.hash=i:e.setState({selected_id:s==="worker"?null:r,view:s,worker:{selected_parent_id:s==="worker"?r:null}})},gotoView(r){let o=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},s=r==="worker"?o.worker?.selected_parent_id:o.selected_id,i=s?ba(r,s):`#/${r}`;t("goto view %s (id=%s)",r,s||""),window.location.hash!==i?window.location.hash=i:e.setState({view:r,selected_id:r==="worker"?null:o.selected_id})}}}var hm=Object.freeze({workspace_config:{default_workspace:null}});function sd(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:hm.workspace_config.default_workspace}}}function id(e={}){let t=qt("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:sd(e.config)},r=new Set;function o(){for(let s of Array.from(r))try{s(n)}catch{}}return{getState(){return n},setState(s){let i={...n,...s,filters:{...n.filters,...s.filters||{}},board:{...n.board,...s.board||{}},worker:{...n.worker,...s.worker||{}},workspace:{current:s.workspace?.current!==void 0?s.workspace.current:n.workspace.current,available:s.workspace?.available!==void 0?s.workspace.available:n.workspace.available,hidden:s.workspace?.hidden!==void 0?s.workspace.hidden:n.workspace.hidden},config:s.config!==void 0?sd(s.config):n.config},l=i.workspace.current?.path!==n.workspace.current?.path||i.workspace.available.length!==n.workspace.available.length||i.workspace.hidden.length!==n.workspace.hidden.length||i.workspace.hidden.some((c,u)=>c!==n.workspace.hidden[u]),a=i.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;i.selected_id===n.selected_id&&i.view===n.view&&i.filters.status===n.filters.status&&i.filters.search===n.filters.search&&i.filters.type===n.filters.type&&i.board.closed_filter===n.board.closed_filter&&i.worker.selected_parent_id===n.worker.selected_parent_id&&i.worker.show_closed_children.length===n.worker.show_closed_children.length&&i.worker.show_closed_children.every((c,u)=>c===n.worker.show_closed_children[u])&&!l&&!a||(n=i,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),o())},subscribe(s){return r.add(s),()=>r.delete(s)}}}function ad(e){let t=qt("activity"),n=0,r=new Map,o=1;function s(){if(!e)return;let c=n>0;e.toggleAttribute("hidden",!c),e.setAttribute("aria-busy",c?"true":"false")}function i(){n+=1,t("start count=%d",n),s()}function l(){let c=n;n=Math.max(0,n-1),c<=0?t("done called but count was already %d",c):t("done count=%d\u2192%d",c,n),s()}function a(c){return async(m,y)=>{let b=o++,k=Date.now();r.set(b,{type:m,start_ts:k}),t("request start id=%d type=%s count=%d",b,m,n+1),i();let D=!1,q=()=>{D||(D=!0,r.delete(b),l())},Y=setTimeout(()=>{D||(t("request TIMEOUT id=%d type=%s elapsed=%dms",b,m,Date.now()-k),q())},3e4);try{let ae=await c(m,y),ee=Date.now()-k;return t("request done id=%d type=%s elapsed=%dms",b,m,ee),ae}catch(ae){let ee=Date.now()-k;throw t("request error id=%d type=%s elapsed=%dms err=%o",b,m,ee,ae),ae}finally{clearTimeout(Y),q()}}}return s(),{wrapSend:a,start:i,done:l,getCount:()=>n,getActiveRequests:()=>{let c=Date.now();return Array.from(r.entries()).map(([u,m])=>({id:u,type:m.type,elapsed_ms:c-m.start_ts}))}}}function de(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function Ds(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let s=t.get();return s&&s.order?s.order:{}}function r(s,i,l){let a=e&&e.snapshotFor?e.snapshotFor(s).slice():[];if(i==="closed")return a.sort(Xc),a;switch(l){case"created_desc":return a.sort(vo),a;case"created_asc":return a.sort(Kc),a;case"updated_desc":return a.sort(Vc),a;case"priority":return a.sort(Yc),a;case"manual":default:{let c=n();return c?a.sort(Jc(c)):a.sort(vo),a}}}function o(s){let i=[];return e&&typeof e.subscribe=="function"&&i.push(e.subscribe(s)),t&&typeof t.subscribe=="function"&&i.push(t.subscribe(s)),()=>{for(let l of i)try{l()}catch{}}}return{selectBoardColumn:r,subscribe:o}}function Pn(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function on(e){let t=Pn(e);if(t===null)return"";let n=new Date(t),r=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function wn(e,t){let n=Pn(e);if(n===null)return"";let o=(typeof t=="number"?t:Date.now())-n;if(o<6e4)return"\uBC29\uAE08";let s=Math.floor(o/6e4);if(s<60)return`${s}\uBD84 \uC804`;let i=Math.floor(o/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let l=Math.floor(o/864e5);if(l<7)return`${l}\uC77C \uC804`;let a=Math.floor(l/7);if(l<30)return`${a}\uC8FC \uC804`;let c=Math.floor(l/30);return c<12?`${c}\uAC1C\uC6D4 \uC804`:`${Math.floor(l/365)}\uB144 \uC804`}function ld(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let o=Pn(r.updated_at)??0;if(t===null||o>n){t=r,n=o;continue}o===n&&String(r.id)<String(t.id)&&(t=r)}return t}function Ps(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function Ms(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let o=Ps(r);if(!o)continue;let s=n.get(o);s||(s=[],n.set(o,s)),s.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function Ns(e,t){let n=e.get(t)||[],r=0;for(let s of n)(s.status==="resolved"||s.status==="closed")&&(r+=1);let o=ld(n);return{total:n.length,count:r,current:o,children:n}}function cd(e){let t=e.transport,n=e.uiOrderStore;function r(i,l){return"renormalize"in i?i.renormalize:[{bead_id:l,rank:i.rank}]}function o(i,l){let a={...i.order};for(let c of l)a[c.bead_id]=c.rank;n&&n.set({revision:i.revision,order:a})}async function s(i,l,a){if(!t||!n)return;let c=n.get()||{revision:0,order:{}},u=r(ma(l,a,c.order),i);o(c,u);let m=await t("ui-order-set",{expected_revision:c.revision,entries:u});if(m&&m.conflict){let y={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};n.set(y);let b=r(ma(l,a,y.order),i);o(y,b);let k=await t("ui-order-set",{expected_revision:y.revision,entries:b});k&&k.applied&&n.set({revision:typeof k.revision=="number"?k.revision:0,order:k.order||{}})}else m&&m.applied&&n.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:s}}function dd(e){if(typeof e!="string")return"";let t=e.indexOf("-");return t>0?e.slice(0,t):""}function wo(e,t){let n=dd(e),r=dd(t);return n.length===0||r.length===0?!1:n!==r}function qs(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function ha(e,t){return!t||typeof e!="string"||e.length===0||qs(t.visible_labels).includes(e)?!0:qs(t.hidden_labels).includes(e)?!1:!qs(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function ud(e,t){return qs(e).filter(n=>ha(n,t))}function cr(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function ym(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function vm(e,t,n,r,o){return d`<button
    type="button"
  ...
  >
    ...
    ${n}
  </button>`}function Fs(e,t){let n=e.total||0,r=!!t.expanded,o=t.trailing??"",s=typeof t.empty_label=="string"&&t.empty_label.length>0?t.empty_label:null;if(n===0&&s===null)return"";let i=Array.isArray(e.children)?e.children:[],l=n>0?i.slice().sort(Qc):i;return d`
    <div class="board-card__roll">
      <div class="board-card__roll-meta">
        ${n>0?vm(t.parent_id,e.count,n,r,t.onToggle):d`<span class="board-card__roll-none">${s}</span>`}
        ${o}
      </div>
  ...
  `}function md(e){let t=e?e.doc:null;return!t||typeof t.path!="string"||t.path.length===0?null:t}function js(e,t,n={}){if(!e||!e.stages)return"";let r=n.onOpenDoc,o=pd[e.route]||pd.spec_backed,s=e.stages,i=xm(o,s,String(t||"open")),l=`\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uC9C4\uD589: ${o.map(c=>`${fd[c]||c} ${c==="plan"?Am(s[c]||{}):_d(s[c]||{})}`).join(" \xB7 ")}`,a=!!r&&o.some(c=>md(s[c]||{})!==null);return d`
    <div
      class="stp"
      role=${a?"group":"img"}
      aria-label=${l}
    >
      ${o.map(c=>Sm(c,s[c]||{},c===i,r))}
    </div>
  `}function Em(e){return typeof e!="number"||!Number.isFinite(e)?"":`P${Math.max(0,Math.min(4,e))}`}var gd=2;function bd(e){let t=e.slice(0,gd).join(", "),n=e.length-gd;return`\u26D3 blocked: ${t}${n>0?` +${n}`:""}`}function Tm(e,t){if(!t)return[];let n=[];if(t.external){let i=t.reason?`\u23F8 blocked: ${t.reason}`:"\u23F8 blocked";n.push(d`<span class="ctl-chip ctl-chip--blocked">${i}</span>`)}let r=Array.isArray(t.blockers)?t.blockers:[],o=[],s=[];for(let i of r)(wo(e,i)?s:o).push(i);return o.length>0&&n.push(d`<span class="ctl-chip ctl-chip--blocked-dep"
        >${bd(o)}</span
      >`),s.length>0&&n.push(d`<span class="ctl-chip ctl-chip--blocked-foreign"
        >${bd(s)}</span
      >`),n}function ya(e){return e==="delegated"?"\uC704\uC784":e==="main"?"\uBA54\uC778":null}function Bs(e){return e.effort?`${e.actor}:${e.effort}`:e.actor}function Jn(e){return`${e.kind}:${Bs(e)}@${e.sha}`}function Us(e,t){if(!e)return null;let n=ya(e.kind),r=e.reason,o=e.kind==="delegated"?r===null:typeof r=="string"&&r.trim().length>0&&!/[\r\n]/.test(r);if(!n||!o)return null;let s=ya(t?.kind),i=s!==null&&t?.kind!==e.kind,l=`\uACC4\uD68D \xB7 ${n}${i?` \u2192 ${s}`:""}`,a=`planned_execution ${e.kind}${typeof r=="string"?`:${r}`:""}`,c=t?` \xB7 exec_receipt ${Jn(t)}`:"";return{kind:e.kind,label:l,title:`${a}${c}`}}function hd(e,t){let n=Us(e,t);return n?d`<span
    ...
    >${`\uC2E4\uD589 \xB7 ${t}`}</span
  >`:null}function Rm(e,t){let n=t.policy||null,r=e.workflow&&e.workflow.chips||{},o=[];if(r.route&&cr(n,"route")){let l=r.route_source==="derived";o.push(d`<span
        class="ctl-chip ctl-chip--route${l?" is-derived":""}"
        title=${l?"route \uBBF8\uD540 (metadata unset)":"route"}
        >${l?"unset":r.route}</span
      >`)}if(r.fast_track&&cr(n,"fast_track")&&o.push(d`<span class="ctl-chip ctl-chip--ft">⚡ fast_track</span>`),r.pr&&cr(n,"pr")){let l=r.pr.number;o.push(d`<span class="ctl-chip ctl-chip--pr"
        >${`PR${l!=null?` #${l}`:""}`}</span
      >`)}let s=hd(r.planned_execution,r.exec_receipt);if(s&&o.push(s),r.exec_receipt){let l=r.exec_receipt;o.push(d`<span
        class="ctl-chip ctl-chip--exec-receipt"
        title=${`exec_receipt ${Jn(l)}`}
        >${`exec ${l.kind==="delegated"?Bs(l):`main:${l.actor}`} \xB7 ${l.sha.slice(0,7)}`}</span
      >`)}if(r.impl_entry){let l=r.impl_entry;o.push(d`<span
        class="ctl-chip ctl-chip--impl-entry"
        title=${`impl_entry ${l.actor}@${l.sha}`}
        >${`impl ${l.actor} \xB7 ${l.sha.slice(0,7)}`}</span
      >`)}for(let l of ud(e.labels,n))o.push(d`<span class="ctl-chip ctl-chip--label">${l}</span>`);return e.from_id&&cr(n,"from")&&o.push(d`<button
        type="button"
      ...
      >
        ↩ from ${e.from_id}
      </button>`),cr(n,"blocked")&&o.push(...Tm(e.id,e.blocked_info)),t.cleanupFailureFor&&t.cleanupFailureFor(e.id)&&cr(n,"blocked")&&o.push(d`<span class="ctl-chip ctl-chip--cleanup">⚠ 정리 멈춤</span>`),o.length===0?"":d`<div class="board-card__chips">${o}</div>`}function Om(e){let t=wn(e.created_at),n=wn(e.updated_at);return!t&&!n?"":d`<span class="board-card__times">
    ${t?d`<span
    ...
    ${n?d`<span
          ...
          >수정 ${n}</span
        >`:""}
  </span>`}function Lm(e,t){let n=t.rollupFor?t.rollupFor(e.id):{total:0,count:0,current:null,children:[]};return Fs(n,{parent_id:e.id,expanded:t.isExpanded?t.isExpanded(e.id):!0,trailing:Om(e),empty_label:"children \uC5C6\uC74C",childChips:va,onToggle:r=>t.onRollupToggle&&t.onRollupToggle(r,e.id),onChildClick:(r,o)=>t.onChildClick&&t.onChildClick(r,o)})}function va(e){let t=e?.workflow?.chips?.planned_execution,n=e?.workflow?.chips?.exec_receipt;return Us(t,n)?d`<span class="board-card__roll-child-chips">
    ${hd(t,n)}
    ${Cm(n)}
  </span>`:null}function Ws(e,t){let n=Em(e.priority);return d`
    <article
      class="board-card"
      data-issue-id=${e.id}
      role="listitem"
  ...
  `}var Im=[{value:"",label:"\uC6B0\uC120\uC21C\uC704"},{value:"0",label:"P0"},{value:"1",label:"P1"},{value:"2",label:"P2"},{value:"3",label:"P3"},{value:"4",label:"P4"}],Dm=[{value:"",label:"\uD0C0\uC785"},{value:"bug",label:"bug"},{value:"feature",label:"feature"},{value:"task",label:"task"},{value:"epic",label:"epic"},{value:"chore",label:"chore"}],Pm=[{value:"created_desc",label:"\uC0DD\uC131 \uCD5C\uC2E0\uC21C"},{value:"created_asc",label:"\uC0DD\uC131 \uC624\uB798\uB41C\uC21C"},{value:"updated_desc",label:"\uC218\uC815 \uCD5C\uC2E0\uC21C"},{value:"priority",label:"\uC6B0\uC120\uC21C\uC704\uC21C"},{value:"manual",label:"\uC218\uB3D9(\uB4DC\uB798\uADF8)"}];function Mm(e,t,n){let r=e.labels.length,o=r>0?`\uB77C\uBCA8 ${r}`:"\uB77C\uBCA8";return d`
    <div class="board-filter__labels">
      ...
      ${n.label_menu_open?d`<div class="board-filter__label-menu" role="group">
            ${n.label_options.length===0?d`<div class="board-filter__label-empty">라벨 없음</div>`:n.label_options.map(s=>d`<label class="board-filter__label-row">
                      <input
                        type="checkbox"
...
`);return d`<span
  ...
  >`}function mi(e){if(typeof e!="number"||!Number.isFinite(e))return"";let t=Math.max(0,Math.min(4,Math.trunc(e)));return d`<span class="worker-pri" title=${`\uC6B0\uC120\uC21C\uC704 P${t}`}
    >P${t}</span
  >`}function Ig(e){let t=Array.isArray(e.badges)?e.badges:[],n=an(e.usage),r=tr(e.usage),o=wn(e.done_at);return d`<div
  ...
  >
    <div class="worker-mini__row1">
      ...
      ${hu(e.pr_url,e.pr_number)}${o?d`<span
    ...
    <div class="worker-mini__row3">
      ${n.length>0?n.map(s=>d`<span class="worker-usage" title=${s.tooltip}
                >${s.label}</span
              >`):r?d`<span class="worker-usage" title=${So(e.usage)}
              >${r}</span
            >`:""}
  ...
  </div>`}function Fn(e,t={}){if(e.lane==="done"&&e.done_layout==="three_line")return Ig(e);let n=e.draggable&&!e.done,r=Array.isArray(e.badges)?e.badges:[],o=an(e.usage),s=tr(e.usage),i=e.merge_step||null,l=e.lane==="pr_wait"||!!e.revise_action||!!e.stale_work,a=e.lane==="done"&&!l,c=a?wn(e.done_at):"",u=n?d`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",m=typeof e.seq=="number"?d`<span class="worker-mini__seq" aria-hidden="true"
          >${e.seq}</span
  ...
  >`,D=e.lane==="done"?"":fi(e.workflow),q=e.lane==="done"?"":bu(e.from_id),Y=mi(e.priority),ae=d`<span class="worker-mini__title">${e.title}</span>`,ee=hu(e.pr_url,e.pr_number),j=e.completion_repair_pr_url&&e.completion_repair_pr_number?d`<a
        ...
        >`:d`<span
          ...
          >${$e}</span
        >`),U=e.reason?d`<span class="worker-mini__reason">${e.reason}</span>`:"",X=o.length>0?o.map($e=>d`<span class="worker-usage" title=${$e.tooltip}
              >${$e.label}</span
            >`):s?d`<span class="worker-usage" title=${So(e.usage)}
            >${s}</span
          >`:"",V=i?d`<span
      ...
      >
        ...
        </div>`:"",S=pi(e.dependency_chips),se=Fo(e),ye=t.actions?t.actions:"",ve=!!(i||e.merge_action||e.cancel_action||e.discard_action||Z?.operation||e.revise_action||te);return d`<div
  ...
  >
    ${a?d`<div class="worker-mini__row1">
          ...
          <div class="worker-mini__row2">
            ...
            ${no(e)}`:d`<div class="worker-mini__line">
              ${u}${m}${k}${Y}${ae}${ee}${j}${P}${y}${U}${V}${_e}${W}${ie}${ye}
            </div>
            ${S}${Ie}${se} ${no(e)}`}
  </div>`}function Dg(e,t){let n,r=[];for(let o of e){let s=o.group||"";s.length>0&&s!==n&&r.push(d`<div class="worker-card__place-group">${s}</div>`),n=s,r.push(d`<button
        type="button"
  ...
  >
    <div class="worker-card__head">
      ${o?d`<span class="worker-card__grip" aria-hidden="true">⠿</span>`:""}
    ...
    ${c?js(c,e.status,{onOpenDoc:n.onOpenDoc}):""}${y}
...
`);else return null;let n=t.replace(fh,"").trim();return n.length>0?{kind:"user",text:n}:null}function vl(e){let t=e.split(/\r?\n/).find(r=>r.trim().length>0)||"",n=dh.exec(t);return n?{kind:"gate",gate:n[2]==="implementation"?"impl":n[2],reviewer:n[3],verdict:n[4],time:n[5]?n[5].trim():void 0,text:t.trim()}:uh.test(t)&&t.trim().length<=80?{kind:"phase",text:t.trim()}:{kind:"assistant",text:e}}function _h(e,t){if(e.subtype==="init"){let n=typeof e.model=="string"?e.model:"";return t.progress=null,[{kind:"thinking",text:n?`\uC138\uC158 \uC2DC\uC791 \xB7 ${n}`:"\uC138\uC158 \uC2DC\uC791"}]}if(e.subtype==="thinking_tokens"){let r=`\uC0DD\uAC01 \uC911\u2026 ${typeof e.estimated_tokens=="number"&&Number.isFinite(e.estimated_tokens)?Math.max(0,Math.round(e.estimated_tokens)):0} \uD1A0\uD070`;return t.progress?(t.progress.text=r,[]):(t.progress={kind:"thinking",text:r},[t.progress])}return[]}function mh(e,t){let n=typeof e.parent_tool_use_id=="string"&&e.parent_tool_use_id.length>0?e.parent_tool_use_id:null;if(e.type==="assistant"){let r=e.message,o=r&&Array.isArray(r.content)?r.content:[],s=[];for(let i of o)if(Wn(i)){if(i.type==="text"&&typeof i.text=="string")s.push(vl(i.text));else if(i.type==="thinking"){let l=yl(i.thinking);l&&s.push(l)}else if(i.type==="tool_use"){let l=ph(i);typeof i.id=="string"&&t.set(i.id,l),s.push(l)}}return n?fp(s,n):s}if(e.type==="user"){let r=e.message,o=r&&Array.isArray(r.content)?r.content:[];for(let i of o)if(Wn(i)&&i.type==="tool_result"){let l=t.get(String(i.tool_use_id));if(l){let a=mp(i.content);l.result=a,l.output=typeof i.content=="string"?i.content:a,i.is_error===!0&&(l.is_error=!0)}}let s=gp(r&&r.content);return s?[s]:[]}if(e.type==="result"){let r=e.is_error===!1&&e.subtype==="success",o={kind:"result",success:r,text:typeof e.result=="string"?e.result:r?"DONE":""};return n?fp([o],n):[o]}return[]}function fp(e,t){for(let n of e)n.parent_tool_use_id=t;return e}function gh(e){let t=typeof e.command=="string"?e.command:"",n=mp(e.aggregated_output===void 0?e.output:e.aggregated_output),o=[typeof e.exit_code=="number"&&Number.isFinite(e.exit_code)?`exit ${e.exit_code}`:typeof e.status=="string"&&e.status.length>0?e.status:"",n].filter(i=>i.length>0).join(" \xB7 "),s={kind:"tool",tool:"shell",icon:_p.Bash,command:t,input:{command:t},expandable:!0};return o.length>0&&(s.result=o),typeof e.aggregated_output=="string"&&(s.output=e.aggregated_output),s}function bh(e){if(e.type==="item.completed"&&Wn(e.item)){let t=e.item;if(t.type==="agent_message"&&typeof t.text=="string")return[vl(t.text)];if(t.type==="user_message"){let n=gp(t.text);return n?[n]:[]}if(t.type==="reasoning"){let n=yl(t.text);return n?[n]:[]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:t.type==="command_execution"?[gh(t)]:[]}if(e.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(e.type==="turn.failed"){let t=e.error;return[{kind:"error",text:t&&typeof t.message=="string"?t.message:"turn failed"}]}return e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}function hh(e){if(e.schema!=="codex-delegation-monitor-v1"||!Wn(e.event))return[];let t=e.event;if(t.type==="session.started"||t.type==="turn.started")return[];if((t.type==="item.started"||t.type==="item.completed")&&Wn(t.item)){let n=t.item;if(typeof n.id!="string"||n.id.length===0)return[];if(t.type==="item.completed"&&n.kind==="agent_message"&&typeof n.text=="string"&&n.text.trim().length>0)return[vl(n.text)];if(t.type==="item.completed"&&n.kind==="reasoning"){let l=yl(n.text);return l?[l]:[]}if(n.kind!=="activity"||typeof n.activity!="string")return[];let r=ch[n.activity];if(!r)return[];let o="\uC2DC\uC791",s="\u2026",i={kind:"tool",tool:"",icon:s,expandable:!1};if(t.type==="item.completed"){if(n.status==="completed")o="\uC644\uB8CC",s="\u2713";else if(n.status==="failed")o="\uC2E4\uD328",s="\u2717";else return[];i.result=""}return i.tool=`${r} \xB7 ${o}`,i.icon=s,[i]}return t.type==="turn.completed"&&t.status==="completed"?[{kind:"result",success:!0,text:"DONE"}]:t.type==="turn.failed"&&(t.status==="failed"||t.status==="interrupted")&&typeof t.error_code=="string"&&t.error_code.length>0?[{kind:"error",text:t.error_code}]:[]}function yh(e){let t=e.type;return typeof t=="string"&&(t==="error"||t.startsWith("thread.")||t.startsWith("turn.")||t.startsWith("item."))}function vh(e){let t=e;if(typeof e=="string"){let n=e.trim();if(n.length===0)return null;try{t=JSON.parse(n)}catch{return null}}return Wn(t)?t:null}function bp(e={}){let t=e.skip_delegated===!0,n=new Map,r={progress:null};return{push(o){let s=vh(o);if(!s)return[];if(t&&typeof s.parent_tool_use_id=="string"&&s.parent_tool_use_id.length>0)return[];if(s.type==="system"&&s.schema!=="codex-delegation-monitor-v1")return _h(s,r);let i=s.schema==="codex-delegation-monitor-v1"?hh(s):yh(s)?bh(s):mh(s,n);return i.length>0&&(r.progress=null),i}}}function wl(e){let t=[],n=bp(),r=Array.isArray(e)?e:[];for(let o of r)for(let s of n.push(o))t.push(s);return t}var wh=5,kh=10,$h=/Task\s+#(\d+)/,xh=/\bgh\s+pr\s+create\b|\bgit\s+push\b/,Ah=/\bnpm\s+(?:run\s+)?(?:test|tsc|lint|build)\b|\bvitest\b/;function os(e){return typeof e!="string"?"":(e.split(/\r?\n/).find(t=>t.trim().length>0)||"").trim()}function Sh(e){return typeof e!="string"||e.length===0?0:e.split(/\r?\n/).length}function Eh(e){for(let t=e.length-1;t>=0;t-=1){let n=e[t];if(n.kind==="phase"||n.kind==="gate")return n.text||null}return null}function Th(e){let t=new Map,n=0;for(let o of e){if(o.kind!=="tool")continue;n+=1;let s=o.input||{};if(o.tool==="TaskCreate"){let a=$h.exec(o.output||o.result||""),c=String(s.activeForm||s.subject||"").trim();if(!a||c.length===0)continue;t.set(a[1],{label:c,active:s.status==="in_progress"?n:0});continue}if(o.tool!=="TaskUpdate")continue;let i=t.get(String(s.taskId??""));if(!i)continue;let l=s.activeForm||s.subject;typeof l=="string"&&l.trim().length>0&&(i.label=l.trim()),typeof s.status=="string"&&(i.active=s.status==="in_progress"?n:0)}let r=null;for(let o of t.values())o.active>0&&(!r||o.active>r.active)&&(r=o);return r?r.label:null}function Ch(e){if(e.tool==="Bash"){let t=e.command||"";return xh.test(t)?"~ PR/\uAC8C\uC2DC \uC911":Ah.test(t)?"~ \uAC80\uC99D \uC911":null}return e.tool==="Edit"||e.tool==="Write"||e.tool==="MultiEdit"?"~ \uAD6C\uD604 \uC911":e.tool==="Read"||e.tool==="Grep"||e.tool==="Glob"?"~ \uD0D0\uC0C9 \uC911":null}function Rh(e){let t=e.filter(o=>o.kind==="tool").slice(-kh),n=new Map;t.forEach((o,s)=>{let i=Ch(o);if(!i)return;let l=n.get(i)||{count:0,last:-1};l.count+=1,l.last=s,n.set(i,l)});let r=null;for(let[o,s]of n)(!r||s.count>r.count||s.count===r.count&&s.last>r.last)&&(r={label:o,count:s.count,last:s.last});return r?r.label:null}function Oh(e){let t=Eh(e);if(t)return{text:t,guess:!1};let n=Th(e);if(n)return{text:n,guess:!1};let r=Rh(e);return r?{text:r,guess:!0}:null}function Lh(e,t){if(typeof e!="number")return"";let n=Math.max(0,Math.floor((t-e)/1e3));return n<60?`${n}\uCD08 \uC804`:wn(e,t)}function io(e,t={}){let{transport:n,sessionLogStore:r,onClose:o}=t,s=null,i=null,l=null,a=null,c=null,u=!1,m={},y=!0,b=new Set,k=new Set,D=null,q=null,Y=!1,ae=!1,ee=!1,j=null,P=null;function U(){Y=!1,ae=!1,ee=!1,j=null,P=null}async function X(z){if(n){ae=!0,ee=!1,Oe();try{let ne=await Promise.resolve(n("get-attempt-prompt",{attempt_id:z,...c?{root_dir:c}:{}}));if(s!==z)return;!ne||typeof ne!="object"||Array.isArray(ne)?ee=!0:(j=ne,P=z)}catch{s===z&&(ee=!0)}finally{s===z&&(ae=!1,Oe())}}}function V(){if(Y=!Y,Y&&s&&P!==s){X(s);return}Oe()}function _e(){if(!Y)return"";let z=so({loading:ae,error:ee});if(z)return d`<div class="sv__prompt" data-seam="attempt-prompt">
      ...
      </div>`}if(ne.kind==="error")return d`<div class="sv__error">⛔ ${ne.text}</div>`;if(ne.kind==="blocker")return d`<div class="sv__error">⛔ ${ne.text}</div>`;if(ne.kind==="tool"){let De=b.has(z),lt=ne.tool==="Bash"?Sh(ne.command):0,it=ne.tool==="Bash"?lt>1?os(ne.command):ne.command:ne.path||ne.command||"";return d`<div
      ...
      >
        ...
        ${De?d`<pre class="sv__tool-expand">${se(ne)}</pre>`:""}
      </div>`}return d`<div class="sv__as">${mr(ne.text||"")}</div>`}function se(z){let ne=[];if(z.tool==="Bash"&&typeof z.command=="string"&&z.command.length>0)ne.push(z.command);else if(z.input!==void 0)try{ne.push(`input: ${JSON.stringify(z.input,null,2)}`)}catch{}return typeof z.output=="string"&&z.output.length>0&&ne.push(`output:
${z.output}`),ne.join(`

`)}function ye(){if(!s)return d``;let z=W(),ne=(i?[m.agent_type,m.model,m.effort]:[m.runner,m.model,m.effort]).filter(Boolean).join(" \xB7 "),De=m.session_id||"",lt=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${y?"ON":"OFF"}`,it=ie(),Pe=it?Lh(Z(),Date.now()):"",Ue=it?Te(z):null,dt=it?Ie(z):null,tt=Oh(z);return d`<div class="sv" data-attempt-id=${s}>
      <div class="sv__bar">
        <span class="sv__id"
...
`).trim()}}var yp=20;function vp(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),s=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${o}:${s}`}function qh(e){return e.length>yp?`${e.slice(0,yp)}\u2026`:e}function Fh(e,t,n,r){let o=`${t.lane} ${qh(t.identifier)}`;return d`<div class="detail-report">
  ...
  </div>`}function wp(e,t={},n={}){let r=Array.isArray(e)?e.filter(Boolean):[],o=n.expanded||new Set,s=typeof n.draft=="string"?n.draft:"",i=n.sending===!0,l=r.slice().sort((a,c)=>String(c.created_at||"").localeCompare(String(a.created_at||"")));return d`
    ...
    ${n.error?d`<div class="detail-empty" data-seam="comments-error">
          댓글을 불러오지 못했습니다
            ...
            ${l.map(a=>{let c=Di(typeof a.text=="string"?a.text:"");return c?Fh(a,c,t,o.has(a.id)):jh(a)})}
          </div>`}
  ...
  `}var{I:jx}=Cc;var kp=e=>e.strings===void 0;var Bh={},$p=(e,t=Bh)=>e._$AH=t;var Lr=Ai(class extends oo{constructor(e){if(super(e),e.type!==or.PROPERTY&&e.type!==or.ATTRIBUTE&&e.type!==or.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!kp(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Rn||t===Wt)return t;let n=e.element,r=e.name;if(e.type===or.PROPERTY){if(t===n[r])return Rn}else if(e.type===or.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return Rn}else if(e.type===or.ATTRIBUTE&&n.getAttribute(r)===t+"")return Rn;return $p(e),t}});var Uh=[{id:"spec",label:"spec \uB9AC\uBDF0",receipt:"spec_review",receipt_stage:null,fill_stage:"spec",stale_stage:"spec",hue:"spec"},{id:"plan",label:"\uACC4\uD68D \uB9AC\uBDF0",receipt:null,receipt_stage:"plan",fill_stage:"plan",stale_stage:"plan",hue:"plan"},{id:"impl",label:"\uAD6C\uD604",receipt:null,receipt_stage:null,fill_stage:"impl",stale_stage:null,hue:"impl"},{id:"impl_review",label:"impl \uB9AC\uBDF0",receipt:"impl_review",receipt_stage:null,fill_stage:null,stale_stage:"impl",hue:"impl"},{id:"pr",label:"PR",receipt:null,receipt_stage:null,fill_stage:"pr",stale_stage:null,hue:"pr"}],kl={quick_fix:["impl","impl_review"],spec_backed:["spec","impl","impl_review","pr"],full_plan:["spec","plan","impl","impl_review","pr"]},xp={missing:"\uC2B9\uC778 \uD544\uC694",stale:"\uC7AC\uC2B9\uC778 \uD544\uC694",unknown:"\uC2B9\uC778 \uD655\uC778 \uBD88\uAC00"},Wh={pin:"pin",global:"global",base:"base"};function zh(e){return d`<span
    class=${`detail-layer-rail detail-layer-rail--${Wh[e]}`}
    data-source=${e}
    aria-hidden="true"
    ><i></i><i></i><i></i
  ></span>`}function Hh(e,t,n){switch(e){case"workflow_mode":return Do;case"spec_review_model":case"impl_review_model":return Po;case"plan_review_model":return Js;case"spec_review_effort":case"plan_review_effort":case"impl_review_effort":return ei;case"impl_dispatch":return Yd;case"impl_runtime":return Qs;case"impl_model":return Jr(n,t.impl_runtime);case"impl_effort":return eo(n,t.impl_runtime,t.impl_model);case"impl_speed":case"orchestration_speed":return Io;case"orchestration_model":return Mo(n,null);case"orchestration_effort":return eo(n,void 0,t.orchestration_model||En).filter(r=>r!==En);default:return[]}}function Gh(e,t){return d`<div class="detail-effective__row" data-key=${e.key}>
    ${zh(e.source)}
  ...
  </div>`}function Ap(e,t){let n=Ma.flatMap(a=>a.keys),r=Na(n,e.metadata,e.workspace_values,e.execution_defaults,e.catalog,e.controller_runtime||null),o=nu(n,e.metadata,e.workspace_values,e.execution_defaults,e.catalog,e.controller_runtime||null),s=Object.fromEntries(r.map(a=>[a.key,a])),i=Object.fromEntries(r.filter(a=>a.value!==null).map(a=>[a.key,a.value])),l=r.filter(a=>a.full_value&&a.display!==a.full_value).map(a=>a.full_value).join(" \xB7 ");return d`<details
  ...
  >
    ...
    ${e.expanded?d`<div class="detail-effective__body">
          ${Ma.map(a=>d`
              ...
              ${r.filter(c=>a.keys.includes(c.key)).map(c=>{let u=zs({key:c.key,choices:Hh(c.key,i,e.catalog),layer:"pin",pin:e.metadata,global:e.workspace_values,execution_defaults:e.execution_defaults,runner_catalog:e.catalog,route:typeof e.metadata?.route=="string"?e.metadata.route:null,controller_runtime:e.controller_runtime||null});return Gh(c,{expanded:e.expanded,options:u.options,default_label:u.unset_label,default_full_value:u.full_value,onEdit:t.onEdit})})}
            `)}
    ...
    title=${b}
    >${D}</span
  >`}function Zh(e,t,n){if(e.receipt&&typeof t[e.receipt]=="string")return String(t[e.receipt]);if(e.receipt_stage){let r=n[e.receipt_stage]?.receipt;return typeof r=="string"?r:""}return""}function Qh(e,t){if(e.id!=="plan")return"";let n=t.plan?.approval_state;return typeof n=="string"&&Object.hasOwn(xp,n)?xp[n]:""}function Mi(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function Ep(e){return Mi(e)&&typeof e.key=="string"&&e.key.length>0&&typeof e.email=="string"&&e.email.length>0}function Tp(e,t){let n=e&&e[t];if(!Mi(n)||!Array.isArray(n.accounts))return null;let r=n.accounts.filter(Ep),o=Ep(n.active)?n.active:null;return{accounts:r,active:o||r.find(s=>s.active===!0)||null}}function Op(e){return typeof e.alias=="string"&&e.alias.length>0?` (${e.alias})`:""}function Ni(e){let t=typeof e.status=="string"&&e.status!=="ok"?` \xB7 ${e.status}`:"";return`${e.email}${Op(e)}${t}`}function ao(e){let t=typeof e.plan=="string"&&e.plan.length>0?e.plan:"plan \uD655\uC778 \uBD88\uAC00";return`${e.email} \xB7 ${t}${Op(e)}`}function Jh(e,t,n){if(n!==null){let o=e==="claude"?Ni:ao,s=t?t.accounts.find(i=>i.key===n):void 0;return`\uB808\uD3EC \uAE30\uBCF8\uAC12 \uC0AC\uC6A9(${s?o(s):n})`}return t?t.active?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${e==="claude"?t.active.email:ao({...t.active,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)":"(\uAE30\uBCF8)"}function Cp(e,t){if(!Mi(e)||e.state!=="usable"||!Mi(e.values))return null;let n=e.values[t];return typeof n=="string"&&n.length>0?n:null}function Rp(e){let t=e.provider_key==="claude"?Ni:ao,n=!!e.provider?.accounts.some(r=>r.key===e.selected);return d`<div class="detail-kv" data-exec-account-row=${e.key}>
  ...
  </div>`}function Lp({md:e,catalog:t,workspace_defaults:n=null,handlers:r}){let o=typeof e.claude_account=="string"?e.claude_account:"",s=typeof e.codex_account=="string"?e.codex_account:"";return d`<section class="exec-accounts" data-exec-accounts>
    ...
    <div class="exec-settings-core">
  ...
  </section>`}function ey(e){return String(e||"").replace(/^docs\/(superpowers\/)?/,"")}function ty(e){let t=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?/.exec(e);if(!t)return{front:null,body:e};let n=t[1].trim();return{front:n.length>0?n:null,body:e.slice(t[0].length)}}function qi(e,t){let n=t.getWorkspacePath,r=t.fetchImpl||globalThis.fetch?.bind(globalThis),o=null,s="loading",i="",l=null,a="";function c(D){D.key==="Escape"&&o&&(D.preventDefault(),b())}document.addEventListener("keydown",c);function u(){return o?d`
      <div class="mv-overlay" role="dialog" aria-modal="true">
        ...
        <div class="mv">
          ...
          <div class="mv__body">
            ${s==="loading"?d`<div class="mv__status">불러오는 중…</div>`:s==="pending"?d`<div class="mv__status">${a}</div>`:s==="error"?d`<div class="mv__status mv__status--error">
                      ${a||"\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4"}
...
${l}</pre
    ...
    `:d``}function m(){rt(u(),e)}async function y(D,q={}){o=D,s="loading",i="",l=null,a="",m();let Y=q.workspace||(n?n():"");if(!Y){s="error",a="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",m();return}if(!r){s="error",a="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",m();return}let ae="/api/doc?workspace="+encodeURIComponent(Y)+"&path="+encodeURIComponent(D);try{let ee=await r(ae),j=await ee.json().catch(()=>({}));if(!ee.ok||!j||j.ok!==!0){if(j?.error==="not_found"&&q.missing_state==="plan_pending"){s="pending",a="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",m();return}s="error",a="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(j&&j.error||ee.status)+")",m();return}let P=ty(String(j.content||""));l=P.front,i=P.body,s="ready",m()}catch{s="error",a="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",m()}}function b(){o=null,rt(d``,e)}function k(){document.removeEventListener("keydown",c),b()}return{open:y,close:b,destroy:k}}var ny=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],Pp="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Fi=[{role:"implementation",provider:"codex"},{role:"review-consult",provider:"codex"},{role:"subagent",provider:"claude"}],ry=new Set(["codex-runner","Explore","Plan","advisor","advisor-xhigh","claude-code-guide","statusline-setup"]);function Ip(e){return typeof e=="string"&&ry.has(e)}var oy=["running","done","failed","interrupted"],sy={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function iy(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function ay(e){let t=an(e);if(t.length>0)return t.map(o=>d`<span class="detail-usage-total" title=${o.tooltip}
          >${o.label}</span
    ...
    ${Al(n.completed_at)?d`<span class="detail-session__leg-time detail-session__time"
        ...
        >`:""}
    ${o?d`<span class="detail-session__usage" title=${o.tooltip}
          >${o.label}</span
        >`:""}
  </div>`}function py(e,t,n,r){let o=e.status==="running"?null:t,i=(o?an({providers:{[e.provider]:{subtotal:o.subtotal,breakdown:o.usage,...o.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],l=e.status==="running"?ss(e.last_event_at):o?Al(o.completed_at):"",a=(e.provider==="claude"?["Claude",e.agent_type,ly(e.model),e.effort]:["codex",e.model,e.effort]).filter(Boolean).join(" \xB7 "),c=cy(e,o);return d`<button
    type="button"
  ...
  >
    ...
    ${r.map(o=>d`<span class="detail-session__usage-field"
  ...
  >
  ...
  </div>`}function Mp(e,t={},n={},r=[]){let o=Array.isArray(e)?e:[],s=Array.isArray(r)?r:[],i=[...s.filter(b=>b&&b.current===!0),...s.filter(b=>b&&b.current!==!0).sort((b,k)=>k.index-b.index)],l=i.map(b=>yy(b,t)),a=n.expanded||new Set;if(o.length===0&&i.length===0)return d`
      <div class="detail-section-label">세션 이력</div>
      <div class="detail-empty" data-seam="session-history">세션 이력 없음</div>
    `;let c=new Set;for(let b of o)b&&typeof b.resumed_from=="string"&&b.resumed_from.length>0&&c.add(b.resumed_from);let u=b=>{if(!(b.status==="failed"||b.status==="orphaned"))return"";let D=typeof b.session_id=="string"&&b.session_id.length>0,q=c.has(b.attempt_id),Y=D&&!q,ae=D?q?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":"\uC774 \uC138\uC158\uC744 \uAC19\uC740 \uC6CC\uD06C\uD2B8\uB9AC\uC5D0\uC11C \uC774\uC5B4\uC11C \uC9C4\uD589":"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00";return d`<button
      type="button"
    ...
    <div class="detail-sessions" data-seam="session-history">
      ${l}${o.map(b=>{let k=Ea(b),D=Dp(k),q=an(D);return d`<div class="detail-session-row">
          <button
            type="button"
  ...
  `}function vy(e){let t=so(e);if(t)return t;let n=e.data;if(!n)return"";if(n.missing)return d`<div class="detail-prompt__missing">
    ...
    </div>`}function hn(v,K){let L=K.get(v.id),B=s?d`<button
          type="button"
    ...
    `}function N(v){let K=on(v.created_at),L=on(v.updated_at);return!K&&!L?d``:d`
    ...
    `}function Fe(){rt(nt(),e)}return{load(v){v!==c&&(m={},y="",k=[],D=!1,ie(),be(),Pe(),Ft(),te()),c=v,u=null,!mt&&t.subscribeCandidates&&(mt=t.subscribeCandidates(()=>{c&&Fe()})),Et(),at(),ee!==v&&pe(v)},clear(){c=null,u=null,m={},y="",b=!1,k=[],D=!1,ie(),be(),Pe(),Ft(),te(),$t(),je.close(),et.close(),rt(d``,e)},destroy(){ke&&(ke(),ke=null),Ze&&(Ze(),Ze=null),st&&(st(),st=null),$t(),document.removeEventListener("keydown",Kt),ce||(je.destroy(),Le&&Le.parentNode&&Le.parentNode.removeChild(Le)),et.destroy(),Me.parentNode&&Me.parentNode.removeChild(Me),c=null,u=null,te(),y="",b=!1,k=[],be(),Pe(),Ft(),rt(d``,e)}}}function Fp(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
  ...
  </details>`:""}function Iy(e){if(!Number.isFinite(e)||e<0)return"0s";let t=Math.floor(e/1e3),n=Math.floor(t/60),r=t%60;return n>0?`${n}m ${String(r).padStart(2,"0")}s`:`${r}s`}function Xp(e){let t=e.failure?lo(e.failure.reason):"";return d`<div class="worker-banners">
    ${e.failure?d`<div class="worker-banner worker-banner--failure" role="alert">
        ...
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?d`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`}var Py=new Set(["codex-runner"]);function My(e,t,n,r=null){if(!e)return"";let o=e.last_activity||null,s=o&&typeof o.text=="string"?o.text:"",i=o&&typeof o.at=="number"?o.at:null,l=(r||!Array.isArray(e.legs)?[]:e.legs).filter(b=>b&&!(typeof b.agent_type=="string"&&Py.has(b.agent_type))),a=l.filter(b=>b&&b.state==="live"),c=l.filter(b=>b&&b.state!=="live"),u=r&&typeof r.last_event_at=="number"?wn(r.last_event_at,t):"",m=r?wn(r.updated_at,t):"",y=u?`\uCD5C\uADFC \uD65C\uB3D9 ${u}`:m?`\uAC31\uC2E0 ${m}`:"";return d`${s?d`<div class="rtile__activity${n?" is-paused":""}">
  ...
  >
    ▤ 세션
  </button>`}function Rl(e,t,n=null,r={}){let o=e.kind==="session",s=o&&Array.isArray(e.session_refs)&&e.session_refs.find(Ee=>Ee&&Ee.current===!0)||null,i=e.failed===!0,l=!!e.paused,a=i?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):l?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Iy(t-e.started_at):"\u2014",c=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,u=$o(e),m=an(e.usage),y=tr(e.usage),b=e.conflict_resolution?l?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,k=e.base_exception||null,D=e.landing,q=e.attempt_id&&e.attempt_id===n,Y=r.monitor||null,ae=Dy(Y),ee=Y?pi(Y.dependency_chips):"",j=My(Y,t,l,o?{updated_at:e.updated_at??null,last_event_at:s&&s.locality==="local"?s.last_event_at:null}:null),P=o&&e.workflow?.chips?.exec_receipt||null,U=fi(e.workflow),X=_i(e.rec),V=P?d`<span
        class="ctl-chip ctl-chip--exec-receipt"
      ...
      >`:"",W=ae||U||_e||V||X?d`<div class="rtile__meta">
        ...
        >${k}</span
      >`:""}`,ie=o?"":no(e),te=e.discard?.action?d`<button
        type="button"
  ...
  >
    <div class="rtile__hd">
      ...
      <div class="rtile__hd-actions">
        ${o?d`${typeof e.started_at=="number"?d`<span class="rtile__elapsed">${a}</span>`:""}${qy(s)}<span
    ...
    ${j}${e.rollup?Fs(e.rollup,{parent_id:e.bead_id,expanded:e.rollup_expanded===!0,childChips:va}):""}
    ...
    ${ee}
    ${o?W:ae||U||c||X||m.length>0||y?d`<div class="rtile__meta">
  ...
  </div>`}function Zp(e,t=Date.now(),n=null,r=null){let o=Array.isArray(e)?e:[];return d`<div class="worker-rungrid" id="worker-rungrid">
    ${o.length===0?d`<div class="worker-rungrid__empty">실행 세션 없음</div>`:o.map(s=>Rl(s,t,n,{monitor:r&&r.get(s.bead_id)||null}))}
  </div>`}var ln="",Fy=["impl_runtime","impl_model","impl_effort"],jy=["claude_account","codex_account"],By=5,Ui=1;function xn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Wi(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,o=t.notify||(O=>de(O,"error",4e3)),s={},i={},l=[],a=!1,c={state:"absent",values:{},warnings:[]},u={},m={},y=Promise.resolve(),b={claude:null,codex:null},k=!1,D=null,q={},Y="",ae="",ee=!1,j=!1,P=!1,U=null,X=!1;function V(){let O=t.queue?t.queue():null;return xn(O)?O:null}function _e(){let O=V();return O?O.runner_catalog:null}function W(){let O=V();return O&&xn(O.execution_defaults)?O.execution_defaults:null}function Z(){let O=t.implPresetStore?.get();return xn(O)&&Array.isArray(O.presets)?O:null}function ie(){return r===null?{}:{root_dir:r}}async function te(O,J){return X||!n?null:await n(O,J)}function Ee(O){O&&xn(O.queue)&&t.onQueueAdopt?.(O.queue)}async function He(O,J){let me=V();if(!me||X)return null;let E=await te(O,{...J,...ie(),expected_revision:me.revision});if(Ee(E),r!==null&&E&&E.conflict){let G=E.queue&&typeof E.queue.revision=="number"?E.queue.revision:V()?.revision??me.revision;E=await te(O,{...J,...ie(),expected_revision:G}),Ee(E)}return E}async function pe(){a=!0,We();try{let O=await te("get-session-defaults",{...ie()});s=xn(O?.values)?{...O.values}:{},i={...s},l=Array.isArray(O?.warnings)?O.warnings:[]}catch(O){l=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${O instanceof Error?O.message:String(O)}`)}finally{a=!1,We()}}async function Q(){let O=eu(s,i);if(Object.keys(O).length!==0){try{let J=await te("set-session-defaults",{values:O,...ie()});s=xn(J?.values)?{...J.values}:{},i={...s},l=Array.isArray(J?.warnings)?J.warnings:[]}catch(J){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}We()}}function Te(O,J){if(!xn(O))return;let me=O.state;c={state:me==="usable"||me==="unusable"||me==="absent"?me:"absent",values:xn(O.values)?{...O.values}:{},warnings:Array.isArray(O.warnings)?O.warnings:[]},m={...c.values},J&&(u={...m})}async function Ie(){try{Te(await te("get-workspace-accounts",{...ie()}),!0)}catch(O){c={state:"unusable",values:{},warnings:["kv_read_failed"]},m={},u={},o(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${O instanceof Error?O.message:String(O)}`)}We()}async function S(O){try{let J=await fetch(O);if(!J.ok)return null;let me=await J.json();if(!xn(me)||!Array.isArray(me.accounts))return null;let E=me.accounts.filter(G=>xn(G)&&typeof G.key=="string"&&G.key.length>0&&typeof G.email=="string"&&G.email.length>0);return{accounts:E,active:E.find(G=>G.active===!0)||null}}catch{return null}}async function se(){k=!0;let[O,J]=await Promise.all([S("/api/claude-usage"),S("/api/codex-usage")]);X||(b={claude:O,codex:J},We())}function ye(){let O={};for(let J of jy){let me=Object.hasOwn(u,J)?u[J]:null,E=Object.hasOwn(m,J)?m[J]:null;me!==E&&(O[J]=me)}return O}async function ve(){let O=ye();if(Object.keys(O).length!==0){try{Te(await te("set-workspace-accounts",{values:O,...ie()}),!1)}catch(J){o(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}We()}}function $e(O,J){J===ln?delete u[O]:u[O]=J,We(),y=y.then(()=>ve())}function be(O,J){if(Fy.includes(O)){yt(O,J);return}J===ln?delete i[O]:i[O]=J,We(),Q()}function Oe(){let O=Nt().orchestration_model,J=$n({global:{orchestration_model:O??void 0},execution_defaults:W(),runner_catalog:_e()}).orchestration_model.value;return J?Nn(_e(),J):null}function Ke(O,J){typeof J=="string"&&J.length>0?i[O]=J:delete i[O]}function yt(O,J){let me=J===ln?void 0:J,E=Qd({impl_runtime:O==="impl_runtime"?me:i.impl_runtime,impl_model:O==="impl_model"?me:i.impl_model,impl_effort:O==="impl_effort"?me:i.impl_effort},_e(),Oe());Ke("impl_runtime",E.impl_runtime),Ke("impl_model",E.impl_model),Ke("impl_effort",E.impl_effort),We(),Q()}async function St(){let O=V();if(!O)return;let J={orchestration_model:O.orchestration_model??null,orchestration_effort:O.orchestration_effort??null,orchestration_speed:O.orchestration_speed??null},me=tu(J,{...J,...q});if(Object.keys(me).length!==0){try{let E=await He("worker-queue-set-orchestration-defaults",{values:me});if(E&&E.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}q={}}catch(E){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${E instanceof Error?E.message:String(E)}`)}We()}}function ct(O,J){q[O]=J===ln?null:J,We(),St()}function T(O){if(D=O,!O){We();return}let J=_e(),me=Nt(),E=me.orchestration_model;E&&!Mo(J,O).includes(E)&&(q.orchestration_model=null,E=null);let G=me.orchestration_effort;G&&!Da(J,O,E||En).includes(G)&&(q.orchestration_effort=null),We(),St()}async function ce(O){if(!(!V()||O<Ui)){try{await He("worker-queue-set-slots",{slots:O})}catch(J){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}We()}}async function Le(O){if(!(!V()||O<Ui||O>By)){try{await He("worker-queue-set-serial-lane-count",{count:O})}catch(J){o(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}We()}}async function je(O,J){let me=O==="auto_advance"?"worker-automation-toggle":"worker-merge-auto-toggle";try{await He(me,{on:J})}catch(E){o(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${E instanceof Error?E.message:String(E)}`)}We()}function Me(){let O={},J=Nt();for(let me of Zs){let E=nr.includes(me)?J[me]:i[me];typeof E=="string"&&E.length>0&&(O[me]=E)}return O}async function et(){let O=Z();if(!O)return;let J=Me();if(Object.keys(J).length===0){o("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let me=(O.presets||[]).find(G=>G.id===Y),E=ae.trim()||(me?me.name:"");if(!E){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let G=me?await te("impl-preset-update",{expected_revision:O.revision,id:me.id,name:E,settings:J}):await te("impl-preset-create",{expected_revision:O.revision,name:E,settings:J});if(G&&G.applied){if(ae="",!me&&Array.isArray(G.presets)){let Re=G.presets.find(ze=>ze.name===E);Y=Re?Re.id:Y}We()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),We()}catch(G){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${G instanceof Error?G.message:String(G)}`)}}async function bt(){let O=Z();if(!(!O||Y.length===0))try{let J=await te("impl-preset-delete",{expected_revision:O.revision,id:Y});J&&J.applied?(Y="",We()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),We())}catch(J){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}}function Ve(O){s=xn(O.values)?{...O.values}:{},i={...s},l=Array.isArray(O.warnings)?O.warnings:[],xn(O.queue)&&(t.onQueueAdopt?.(O.queue),q={})}async function z(){let O=Z(),J=V();if(!O||!J||Y.length===0)return;let me=E=>({preset_id:Y,expected_revision:O.revision,expected_queue_revision:E,...ie()});try{let E=await te("apply-impl-preset-global",me(J.revision));if(E&&E.applied&&Ve(E),r!==null&&E&&E.queue_applied===!1){let G=E.queue&&typeof E.queue.revision=="number"?E.queue.revision:V()?.revision??J.revision;E=await te("apply-impl-preset-global",me(G)),E&&E.applied&&Ve(E)}E&&E.applied?E.queue_applied===!1&&o("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):E&&E.conflict&&o("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(E){o(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${E instanceof Error?E.message:String(E)}`)}We()}async function ne(){j=!0,P=!1,We();try{let O=await te("get-worker-system-prompt",{});!O||typeof O!="object"||Array.isArray(O)?P=!0:U=O}catch{P=!0}finally{j=!1,We()}}function De(){if(ee=!ee,ee&&!U){ne();return}We()}function lt(){let O=so({loading:j,error:P});if(O)return O;if(!U)return"";let J=Array.isArray(U.variants)?U.variants:[];return d`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${ee?lt():""}
    </section>`}function Pe(O,J,me,E,G,Re,ze){let xe=G[O]??ln,at=Pa(O,me,G,W(),_e(),ze),ot=at.options.find(Je=>Je.value===xe),he=xe===ln?at.full_value:ot?.full_value;return d`<select
    ...
    >
    ...
    </div>`}function dt(O,J){let me=J?J.active:null;return xn(me)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${O==="claude"?me.email:ao({...me,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function tt(O,J,me){let E=b[me],G=Object.hasOwn(u,O)?u[O]:ln,Re=me==="claude"?Ni:ao,ze=!!E?.accounts.some(xe=>xe.key===G);return d`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${J}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${J}
      ...
      ${a?d`<div class="settings-dialog__empty">불러오는 중…</div>`:d`
            ...
            <div class="settings-dialog__group">
              ...
              ${Ue("orchestration_speed","\uC18D\uB3C4",Io,ct,Re)}
            </div>
            ...
            <div class="settings-dialog__group">
              ...
              ${Ue("impl_effort","effort",eo(O,J,me),be,i)}
            ...
            ${it()}
          `}
    `}function We(){X||rt(wt(),e)}return{load(){q={};let O=[pe(),Ie()];return k||O.push(se()),Promise.all(O).then(()=>{})},render:We,sessionDraft:()=>({...i}),destroy(){X=!0,rt(d``,e)}}}function zi(e){return d`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ${e}
  </svg>`}function Qp(){return zi(yo`<path d="M5.5 3.6 12 8l-6.5 4.4z" />`)}function Jp(){return zi(yo`<path d="M6 3.8v8.4M10 3.8v8.4" />`)}function ef(){return zi(yo`<path
      d="M4.6 5.6v4.8M4.6 8.2h2.2A3.2 3.2 0 0 0 10 5"
    />
    <circle cx="4.6" cy="4" r="1.5" />
    <circle cx="4.6" cy="12" r="1.5" />
    <circle cx="11.4" cy="4" r="1.5" />`)}function tf(){return zi(yo`<circle cx="8" cy="8" r="2.1" />
    <path
      d="M8 1.9v1.8M8 12.3v1.8M1.9 8h1.8M12.3 8h1.8M3.7 3.7l1.3 1.3M11 11l1.3 1.3M12.3 3.7 11 5M5 11l-1.3 1.3"
    />`)}function nf(e){return`${e} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}function rf(e){let t=(Array.isArray(e)?e:[]).map(l=>l&&l.usage).filter(l=>l&&typeof l=="object"&&"providers"in l);if(t.length>0)return an(Gs(t));let n={};for(let l of Vn)n[l]=0;let r=!1,o=0,s=0,i=0;for(let l of Array.isArray(e)?e:[]){let a=l&&l.usage;if(a&&typeof a=="object"){let c=!1;for(let u of Vn){let m=a[u];typeof m=="number"&&Number.isFinite(m)&&(n[u]+=m,r=!0,c=!0)}if(c){s+=1;let u=a.total_cost_usd;typeof u=="number"&&Number.isFinite(u)&&(o+=u,i+=1)}}}return s>0&&i===s&&(n.total_cost_usd=o),r?tr(n):null}function zn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Ol(e,t){let n=zn(e?.counts)?e.counts:null,r=n?n[t]:null;return typeof r=="number"&&Number.isFinite(r)?r:0}function Uy(e,t){if(!zn(t))return e;let n={...e};for(let[r,o]of Object.entries(t))o!==void 0&&(n[r]=o);return n}function Wy(e){if(!zn(e)||!zn(e.execution_defaults)||!zn(e.runner_catalog)||!zn(e.session_defaults))return null;let t={...e.session_defaults};for(let i of["orchestration_model","orchestration_effort","orchestration_speed"])typeof e[i]=="string"&&e[i].length>0&&(t[i]=e[i]);let n=$n({global:t,execution_defaults:e.execution_defaults,runner_catalog:e.runner_catalog}),r=Nn(e.runner_catalog,n.orchestration_model.value??""),o=Er(n,e.runner_catalog),s=_r(n,r);return o===null&&s===null?null:{orchestration:o,worker:s}}function of(e,t){let n=t.notify||(S=>de(S,"error",4e3)),r=document.createElement("div");r.className="mon2-deck__main",e.appendChild(r);let o=document.createElement("div");o.className="mon2-deck__panel",o.hidden=!0;let s=document.createElement("div");s.className="mon2-deck__panel-hd";let i=document.createElement("span");i.className="mon2-deck__panel-title";let l=document.createElement("button");l.type="button",l.className="mon2-deck__panel-close",l.setAttribute("aria-label","\uC2E4\uD589 \uC124\uC815 \uB2EB\uAE30"),l.textContent="\u2715",s.append(i,l);let a=document.createElement("div");a.className="mon2-deck__panel-body",o.append(s,a),e.appendChild(o);let c=null,u=null,m=null,y=new Map;function b(){let S=t.workspacesState?t.workspacesState():[];return Array.isArray(S)?S.filter(se=>zn(se)):[]}function k(S){return b().find(se=>se.root_dir===S)||null}function D(S){return Uy(k(S),y.get(S))}function q(){for(let S of b()){let se=y.get(S.root_dir);se&&typeof se.revision=="number"&&typeof S.revision=="number"&&S.revision>=se.revision&&y.delete(S.root_dir)}}async function Y(S,se,ye){let ve=t.transport,$e=D(se);if(!(!ve||!zn($e))){try{let be=await ve(S,{...ye,root_dir:se,expected_revision:$e.revision});if(zn(be?.queue)&&y.set(se,be.queue),be&&be.conflict){let Oe=zn(be.queue)&&typeof be.queue.revision=="number"?be.queue.revision:D(se)?.revision;be=await ve(S,{...ye,root_dir:se,expected_revision:Oe}),zn(be?.queue)&&y.set(se,be.queue)}}catch(be){n(`\uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${be instanceof Error?be.message:String(be)}`)}Q()}}function ae(S){c!==S&&(c=S,t.onFocusChange?.(c),Q())}function ee(S){ae(c===S?null:S)}function j(S){if(u===S){U();return}P(),u=S;let se=k(S);i.textContent=`${se?.name||S} \uC2E4\uD589 \uC124\uC815 \xB7 Worker \uD0ED \u2699 \uC2E4\uD589 \uD0ED\uACFC \uAC19\uC740 \uC800\uC7A5\uC18C`,o.hidden=!1,m=Wi(a,{root_dir:S,queue:()=>D(S),transport:t.transport,implPresetStore:t.implPresetStore,notify:n,onQueueAdopt:ye=>{y.set(S,ye),Q()}}),m.load(),Q()}function P(){m?.destroy(),m=null}function U(S){P(),u=null,o.hidden=!0,i.textContent="",S!==!0&&Q()}let X=()=>U();l.addEventListener("click",X);function V(S){S.key==="Escape"&&c!==null&&ae(null)}document.addEventListener("keydown",V);function _e(S,se){let ye=Math.max(se,S,1);return d`<span
    ...
    >
    ...
    </span>`}function W(S){let se=S.auto_advance===!0,ye=S.auto_merge===!0;return d`<button
        type="button"
      ...
      >
        ${tf()}
      </button>`}function Z(S){let se=Wy(S);return se?d`<div class="mon2-deck__chips">
      ${se.orchestration?d`<span class="mon2-deck__chip" title=${se.orchestration.title}
            >오케 ${se.orchestration.text}</span
          >`:""}
      ${se.worker?d`<span class="mon2-deck__chip" title=${se.worker.title}
            >워커 ${se.worker.text}</span
          >`:""}
    </div>`:""}function ie(S){let se=[];for(let[ye,ve]of[["queue","\uB300\uAE30"],["pr_wait","PR"],["session_active","\uC138\uC158"]]){let $e=Ol(S,ye);$e>0&&se.push(`${ve} ${$e}`)}return se.join(" \xB7 ")}function te(S){let se=Ol(S,"running"),ye=typeof S.slots=="number"?S.slots:1;return d`<div
    ...
    >
    ...
    </div>`}function Ee(S){let se=t.doneItems?t.doneItems():[],ye=t.rangeLabel?t.rangeLabel():"",ve=rf(Array.isArray(se)?se:[]),$e=be=>S.reduce((Oe,Ke)=>Oe+Ol(Ke,be),0);return d`<div class="mon2-deck__bar">
      <span
      ...
      <div class="mon2-deck__strip">
        ${S.map(se=>te(se))}
      </div>`}function pe(){c!==null&&!k(c)&&(c=null,t.onFocusChange?.(null))}function Q(){q(),pe(),u!==null&&!k(u)&&U(!0),rt(He(),r),m?.render()}function Te(S){let se=S.target;if(!se||typeof se.closest!="function")return;let ye=se.closest("[data-root-dir]");if(!ye)return;let ve=ye.getAttribute("data-root-dir")||"",$e=se.closest("[data-act]")?.getAttribute("data-act");if($e==="worker"){t.gotoWorkerTab?.(ve);return}if($e==="auto"){Y("worker-automation-toggle",ve,{on:D(ve)?.auto_advance!==!0});return}if($e==="merge"){Y("worker-merge-auto-toggle",ve,{on:D(ve)?.auto_merge!==!0});return}if($e==="gear"){j(ve);return}ee(ve)}function Ie(S){if(S.key!=="Enter"&&S.key!==" ")return;let se=S.target;if(!se||typeof se.closest!="function")return;let ye=se.closest('[data-root-dir][role="button"]');!ye||ye!==se||(S.preventDefault(),ee(ye.getAttribute("data-root-dir")||""))}return r.addEventListener("click",Te),r.addEventListener("keydown",Ie),{render:Q,focusRoot:()=>c,panelRoot:()=>u,destroy(){document.removeEventListener("keydown",V),r.removeEventListener("click",Te),r.removeEventListener("keydown",Ie),l.removeEventListener("click",X),P(),rt(d``,r),e.replaceChildren()}}}var sf="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C",zy=1e4;function af(e){return typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)?e.lane:e.lane==="running"&&e.serial_lane_id?e.serial_lane_id:null}function lf(e){return e.lane==="runnable"||e.lane==="queue"||typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)}var pf="bdui.monitor.done-range",ff="bdui.monitor.running_sort",_f="bdui.monitor.candidate_sort",mf="beads-ui.monitor.candidate-filter",gf="beads-ui.monitor.sections";function Hy(){try{let e=window.localStorage.getItem(mf);if(!e)return{...ro};let t=JSON.parse(e);return!t||typeof t!="object"?{...ro}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:ro.show_blocked,spec:Va.some(n=>n.value===t.spec)?t.spec:"all"}}catch{return{...ro}}}function cf(e){try{window.localStorage.setItem(mf,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Gy(){try{let e=window.localStorage.getItem(_f);return Ho.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function Ky(e){try{window.localStorage.setItem(_f,e)}catch{}}function Vy(){try{let e=window.localStorage.getItem(gf);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Yy(e){try{window.localStorage.setItem(gf,JSON.stringify(e))}catch{}}function Xy(){try{let e=window.localStorage.getItem(pf);return e===null?"today":Gn(e)}catch{return"today"}}function Zy(e){try{window.localStorage.setItem(pf,e)}catch{}}function Qy(){try{return window.localStorage.getItem(ff)==="repo"?"repo":"started"}catch{return"started"}}function Jy(e){try{window.localStorage.setItem(ff,e)}catch{}}var bf="tab:monitor:pipeline",ev=1e3,df=[{lane:"runnable",pane:"candidate",title:"\uD6C4\uBCF4",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589 \uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],tv=["queue","runnable","done"],uf="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function nv(e){return e>=1&&e<=uf.length?uf[e-1]:`(${e})`}function hf(e,t){let n=qt("views:monitor"),r=t.gotoIssue,o=t.pipelineStore,s=t.transport,i=t.getWorkspacePath,l=t.openDoc,a=t.switchWorkspace,c=t.router,u=t.now||(()=>Date.now()),m=t.confirm||(f=>typeof globalThis.confirm!="function"||globalThis.confirm(f)),y=Xy(),b=Qy(),k=Hy(),D=Gy(),q=Vy(),Y=Bi("beads-ui.monitor.lane-collapsed"),ae=!1,ee=null,j=null,P=null,U=null,X=[],V=null,_e=null,W=null,Z=null;function ie(f){return Z===null&&(Z=Jt()),Pd(f,Z)}function te(f,g){Ee(),!(g<=0)&&(_e={lane_id:f,corrected:g},W=setTimeout(()=>{W=null,_e=null,he()},zy))}function Ee(){W!==null&&(clearTimeout(W),W=null),_e=null}function He(){let f=Fr.find(g=>g.value===y);return f?f.label:""}let pe=document.createElement("div");pe.className="mon",e.appendChild(pe);let Q=document.createElement("div");Q.className="worker-drawer-overlay",Q.hidden=!0;let Te=document.createElement("div");Te.className="worker-drawer-overlay__backdrop";let Ie=document.createElement("div");Ie.className="worker-drawer-host mon2-drawer",Q.append(Te,Ie),e.appendChild(Q);let S=Go(null,null),se=new Map,ye=new Map,ve=null,$e=null,be=null,Oe=io(Ie,{transport:s,sessionLogStore:t.sessionLogStore,onClose:()=>{j=null,Q.hidden=!0,he()}});async function Ke(f,g,w,$,N=!0){if(!s||!w)return null;let H=await s(f,{...g,root_dir:w,expected_revision:$});if(H&&H.conflict&&N){H.queue&&ye.set(w,H.queue);let oe=H.queue&&typeof H.queue.revision=="number"?H.queue.revision:$;H=await s(f,{...g,root_dir:w,expected_revision:oe})}return H&&H.queue&&w&&ye.set(w,H.queue),H}function yt(f,g){let w=ye.get(f),$=o&&o.get?o.get():null,N=(Array.isArray($)?$:[]).find(oe=>oe?.root_dir===f);return(w||N)?.merge_queue?.find(oe=>oe.bead_id===g)?.continuation_action}async function St(f,g,w,$){let N=await Ke(f,g,w,$),H=ye.get(w)?.revision??N?.queue?.revision??$;return er(N,(oe,Se)=>Ke(f,{...g,continuation:oe,decision_token:Se},w,H,!1),{refresh:oe=>Ke(f,g,w,oe?.queue?.revision??ye.get(w)?.revision??H,!1)})}async function ct(f,g,w,$){let N=await er({continuation_mismatch:$},(oe,Se)=>Ke("worker-merge-queue-add",{bead_id:g,continuation:oe,decision_token:Se},f,w,!1)),H=N?.queue?.merge_queue?.find(oe=>oe.bead_id===g)?.continuation_action;N?.applied!==!0&&H?.continuation===null&&H.mismatch&&await ct(f,g,N.queue.revision,H.mismatch)}async function T(f,g,w){let $=await Ke("worker-discard",f,g,w);if($&&$.discarded===!0){de(di($),"success",5e3);return}if($&&$.reason){de(`\uD3D0\uAE30 \uC2E4\uD328: ${$.reason}`,"error");return}if($&&$.accepted&&$.pending==="merged_revert"){de("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if($&&$.accepted){de(`\uD3D0\uAE30 \uC9C4\uD589: ${$.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}$&&!$.conflict&&de("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function ce(f,g,w){return!s||!w?null:await s(f,{...g,root_dir:w})}async function Le(){let f=new Map;for(let g of S.pr_wait)f.has(g.root_dir)||f.set(g.root_dir,g.expected_revision);for(let[g,w]of f)await Ke("worker-merge-queue-add-all",{},g,w)}function je(f){let g=q[f];return!!(g&&g.runnable===!0)}function Me(f){let g={...q[f]||{}};g.runnable=!g.runnable,q={...q,[f]:g},Yy(q),he()}function et(f){Y.toggle(f),he()}function bt(f){Y.toggleArea(f),he()}function Ve(f){let g=S.queue_groups.find(w=>w.root_dir===f);if(!g)return null;for(let w=0;w<g.serial_lane_count;w+=1){let $=`s${w+1}`,N=g.sublanes.serial.find(H=>H.id===$);if(!N||N.raw_length===0&&N.occupied_by.length===0)return $}return null}function z(f,g){let w=S.queue_groups.find(N=>N.root_dir===f),$=w?w.sublanes.serial.find(N=>N.id===g):void 0;return $?$.raw_length:0}function ne(f,g){let w=se.get(f),$=se.get(g);if(!w||!$)return{kind:"note",text:"\uC0C1\uB300\uC758 \uD604\uC7AC \uC704\uCE58\uB97C \uC54C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"};let N=af(w),H=af($);if(N!==null&&N===H&&w.root_dir===$.root_dir)return{kind:"note",text:"\uC774\uBBF8 \uAC19\uC740 \uC9C1\uB82C \uB808\uC778 \u2014 \uC21C\uC11C\uAC00 \uC788\uC2B5\uB2C8\uB2E4"};let oe=lf(w),Se=lf($);if(oe&&H!==null){let Ye=H;return{kind:"ops",title:`${Ye} \uB05D\uC5D0 ${f}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:$.root_dir,ops:[{bead_id:f,lane:Ye,index:z($.root_dir,Ye)}]}}if(N!==null&&Se&&H===null){let Ye=N;return{kind:"ops",title:`${Ye} \uB05D\uC5D0 ${g}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:w.root_dir,ops:[{bead_id:g,lane:Ye,index:z(w.root_dir,Ye)}]}}if(oe&&N===null&&Se&&H===null){let Ye=Ve(w.root_dir);return Ye===null?{kind:"disabled",title:"\uBE48 \uC9C1\uB82C \uB808\uC778 \uC5C6\uC74C \u2014 Worker \uD0ED\uC5D0\uC11C \uB808\uC778 \uC218 \uC870\uC808"}:{kind:"ops",title:`${Ye} \uB808\uC778\uC5D0 ${g} \u2192 ${f} \uC21C\uC11C\uB85C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:w.root_dir,ops:[{bead_id:g,lane:Ye,index:0},{bead_id:f,lane:Ye,index:1}]}}return!oe&&!Se?{kind:"note",text:"\uB458 \uB2E4 \uC774\uBBF8 \uCD9C\uBC1C \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"}:oe?{kind:"note",text:`${as($.lane)} \u2014 \uC885\uB8CC \uD6C4 \uCD9C\uBC1C\uD558\uB824\uBA74 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694`}:{kind:"note",text:`${as(w.lane)} \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4\uB824\uBA74 \uC0C1\uB300\uB97C \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694`}}function De(f,g){let w=ne(f,g.id);return{id:g.id,title:g.title,location_label:g.location_label,prefixes:g.prefixes,action:w.kind==="note"?{kind:"note",text:w.text}:w.kind==="disabled"?{kind:"disabled",label:sf,title:w.title}:{kind:"place",label:sf,title:w.title}}}function lt(f,g){if(!U||U.bead_id!==f)return null;let w=U.counterpart_id,$=g.filter(N=>N.id===w);return $.length===0?null:{rows:$.map(N=>De(f,N))}}function it(f){let g=f.dependency_chips||null,w=f.overlap_chips||[],$=f.scope_state==="missing",N=f.cross_lane_chip,H=f.armed_lane_chip;if(!g&&w.length===0&&!$&&!N&&!H)return null;let oe=lt(f.id,w);return{...g||{},...w.length>0?{overlaps:w}:{},...$?{scope_missing:!0}:{},...N?{cross_lane:{lane_id:N.lane_id,label:N.label}}:{},...H?{armed_lane:H}:{},...oe?{popover:oe}:{}}}function Pe(f){let g=it(f);return g?{...f,dependency_chips:g}:f}async function Ue(f,g){let w=ne(f,g);if(U=null,w.kind!=="ops"){he();return}let $=mn(w.root_dir,w.ops[0].bead_id);for(let N of w.ops){let H=await dt(N,w.root_dir,$);if(H===null)break;$=H}he()}async function dt(f,g,w){try{let $=await Ke("worker-queue-place",f,g,w,!1);if($&&$.conflict)return de("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!$||$.applied!==!0)return de($&&typeof $.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${$.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let N=$.queue?$.queue.revision:void 0;return typeof N!="number"?(de("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):N}catch($){return de(st($),"error"),null}}function tt(f){let g=je(f.root_dir);return d`<header class="mon2-sec__hd">
      <button
        type="button"
    ...
    </div>`}function We(f){let g=S.cross_lanes_revision!==null,w=ie(f.lane_id),$=w?.held===!0,N=w?.cycle===!0,H=w?w.mismatched:[],oe=_e&&_e.lane_id===f.lane_id?_e.corrected:0;return d`<div class="mon2-clane" data-lane-id=${f.lane_id}>
...
`)}
    ...
    </div>`}function ze(f){let g={runnable:S.runnable,queue:S.queue,running:S.running,pr_wait:S.pr_wait,done:S.done},w=$=>{let N=g[$.lane],H=$.lane==="runnable"?S.runnable_flat?N.length>0?Ht():void 0:S.runnable_sections.length>0?Ht():void 0:$.lane==="queue"?S.queue_groups.length>0||S.chain_lanes.length>0||S.parallel_rows.length>0||S.cross_lanes_unreadable?G():void 0:$.lane==="running"?Re(f):N.length>0?d`${N.map(oe=>Fn(oe))}`:void 0;return Yn({id:`monitor-${$.lane}`,lane:$.pane,title:$.title,items:N,count:N.length,src:$.lane==="runnable",empty:$.empty,body:H,live:$.lane==="running"&&N.length>0,collapsible:!0,collapsed:Y.isCollapsed($.pane),controls:$.lane==="runnable"?xe():void 0,header_control:at($.lane,N.length)})};if(ae){let $=tv.map(N=>df.find(H=>H.lane===N)).filter(N=>N!==void 0);return d`<div class="mon2-deck"></div>
  ...
  `,e.appendChild(n);let r=n.querySelector("#new-issue-form"),o=n.querySelector("#new-title"),s=n.querySelector("#new-type"),i=n.querySelector("#new-priority"),l=n.querySelector("#new-labels"),a=n.querySelector("#new-description"),c=n.querySelector("#new-issue-error"),u=n.querySelector("#btn-cancel"),m=n.querySelector("#btn-create"),y=n.querySelector(".new-issue__close");function b(){s.replaceChildren();let P=document.createElement("option");P.value="",P.textContent="\u2014 Select \u2014",s.appendChild(P);for(let U of vf){let X=document.createElement("option");X.value=U,X.textContent=wf(U),s.appendChild(X)}i.replaceChildren();for(let U=0;U<=4;U+=1){let X=document.createElement("option");X.value=String(U);let V=kf[U]||"Medium";X.textContent=`${U} \u2013 ${V}`,i.appendChild(X)}}b();function k(){try{typeof n.close=="function"?n.close():n.removeAttribute("open")}catch{n.removeAttribute("open")}}function D(P){o.disabled=P,s.disabled=P,i.disabled=P,l.disabled=P,a.disabled=P,u.disabled=P,m.disabled=P,m.textContent=P?"Creating\u2026":"Create"}function q(){c.textContent=""}function Y(P){c.textContent=P}function ae(){try{let P=window.localStorage.getItem("beads-ui.new.type");P?s.value=P:s.value="";let U=window.localStorage.getItem("beads-ui.new.priority");U&&/^\d$/.test(U)?i.value=U:i.value="2"}catch{s.value="",i.value="2"}}function ee(){let P=s.value||"",U=i.value||"";P.length>0&&window.localStorage.setItem("beads-ui.new.type",P),U.length>0&&window.localStorage.setItem("beads-ui.new.priority",U)}async function j(){q();let P=String(o.value||"").trim();if(P.length===0){Y("Title is required"),o.focus();return}let U=Number(i.value||"2");if(!(U>=0&&U<=4)){Y("Priority must be 0..4"),i.focus();return}let X=String(s.value||""),V=String(a.value||""),_e={title:P};X.length>0&&(_e.type=X),String(U).length>0&&(_e.priority=U),V.length>0&&(_e.description=V),D(!0);try{await t("create-issue",_e)}catch{D(!1),Y("Failed to create issue");return}ee(),D(!1),k()}return n.addEventListener("cancel",P=>{P.preventDefault(),k()}),y.addEventListener("click",()=>k()),u.addEventListener("click",()=>k()),n.addEventListener("keydown",P=>{P.key==="Enter"&&(P.ctrlKey||P.metaKey)&&(P.preventDefault(),j())}),r.addEventListener("submit",P=>{P.preventDefault(),j()}),{open(){r.reset(),q(),ae();try{"showModal"in n&&typeof n.showModal=="function"?n.showModal():n.setAttribute("open","")}catch{n.setAttribute("open","")}setTimeout(()=>{try{o.focus()}catch{}},0)},close(){k()}}}var rv=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function ov(e,t){return ha(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function xf(e,t,n){return d`
    <section class="settings-dialog__group">
      ...
      ${t.length===0?d`<div class="settings-dialog__empty">라벨 없음</div>`:d`<div class="settings-dialog__pills">
            ${t.map(r=>{let o=ov(r,e);return d`<button
                type="button"
  ...
  `}var sv=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function Ef(e,t){let{transport:n,policyStore:r,labelOptions:o}=t,s=t.notify||(te=>de(te,"error",4e3)),i=document.createElement("dialog");i.id="settings-dialog",i.className="settings-dialog",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","\uC124\uC815"),e.appendChild(i);let l="execution",a=!1,c="",u=null;function m(){if(u)return u;let te=i.querySelector('[data-pane="execution"]');return te?(u=Wi(te,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:s,onQueueAdopt:Ee=>t.queueStore?.set?.(Ee)}),u):null}function y(){return d`
    ...
    </span>`}function P(pe,Q,Te){let Ie=Mf(Q,Te),S=Q.available&&(Q.held||Ie>Ll),se=S?`${Math.floor(Ie/60)}\uBD84 \uC804 \uCE21\uC815`:"",ye=Q.accounts.filter(Oe=>!Oe.active).length,ve=`usage-meter__group${S?" usage-meter__group--stale":""}`,$e=d`<span class="usage-meter__provider"
        >${pe.label}</span
      >
      ${Q.available?Q.windows.map(Oe=>j(Oe,S,se,Te)):d`<span class="usage-meter__empty">사용량 없음</span>`}
    ...
    </div>`}function ie(){let pe=Date.now(),Q=[];for(let Ie of If){let S=s.get(Ie.key);S&&Q.push({provider:Ie,snapshot:gv(S,pe)})}if(Q.length===0){b(),c();return}let Te=Q.find(Ie=>Ie.provider.key===n&&Ie.snapshot.accounts.length>0);Te||b(),rt(U(Q,pe),e),e.hidden=!1,Te?te(Te,pe):m()}function te(pe,Q){let Te=u(),Ie=e.getBoundingClientRect(),S=e.ownerDocument.documentElement.clientWidth;Te.style.setProperty("--usage-meter-anchor-top",`${Ie.bottom}px`),Te.style.setProperty("--usage-meter-anchor-right",`${Math.max(0,S-Ie.right)}px`),rt(d`<div
          class="usage-meter__scrim"
          aria-hidden="true"
          @mousedown=${ae}
        ></div>
        ${Z(pe,Q)}`,Te)}async function Ee(pe){try{let Q=await fetch(pe.endpoint);return Q.ok?mv(await Q.json(),Date.now()):{kind:"error"}}catch{return{kind:"error"}}}async function He(){l+=1;let pe=l,Q=await Promise.all(If.map(async Te=>({provider:Te,read:await Ee(Te)})));if(!(t||pe!==l)){for(let Te of Q){let Ie=Te.provider.key;if(Te.read.kind==="ok"){s.set(Ie,Te.read.snapshot);continue}if(Te.read.kind==="empty"){s.delete(Ie);continue}let S=s.get(Ie);S!==void 0&&!S.held&&s.set(Ie,{...S,held:!0})}ie()}}return c(),He(),o=setInterval(()=>{He()},6e4),{destroy(){t=!0,o!==null&&(clearInterval(o),o=null),b(),c()}}}function qf(e){let t=e.attempts?Object.values(e.attempts):[],n=new Map;for(let o of t)o&&(o.kind??"implementation")==="implementation"&&n.set(o.bead_id,o.attempt_id);let r=new Map;for(let o of e.done||[])o&&typeof o.bead_id=="string"&&typeof o.added_at=="number"&&r.set(o.bead_id,o.added_at);return o=>{let s=n.get(o.bead_id)!==o.attempt_id,i=r.get(o.bead_id),l=typeof i=="number"&&i>0&&typeof o.finished_at=="number"&&i>=o.finished_at;return!s&&!l&&typeof o.dismissed_at!="number"}}var bv="worker-ineligible";function ls(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ff(e){return ls(e).includes(bv)}var hv="session-preferred",yv=["exclusive_machine","iterative_user_judgment","visual_verification"];function jf(e,t){if(!ls(e).includes(hv)||typeof t!="object"||t===null)return"";let n=t.session_preferred_reason;return typeof n=="string"&&yv.includes(n)?n:""}var vv="worker-serial";function Il(e){return ls(e).includes(vv)}var Wf="bdui.worker.candidate_sort",cs=Object.freeze([{id:"spec",label:"spec \uC6B0\uC120",chain:[{key:"spec",dir:"desc"},{key:"created",dir:"asc"}]},{id:"bottleneck",label:"\uBCD1\uBAA9 \uC6B0\uC120",chain:[{key:"priority",dir:"asc"},{key:"dependents",dir:"desc"},{key:"released",dir:"desc"}]},{id:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131",chain:[{key:"created",dir:"desc"},{key:"priority",dir:"asc"}]},{id:"updated",label:"\uCD5C\uC2E0 \uC218\uC815",chain:[{key:"updated",dir:"desc"}]}]),Hi=Object.freeze({preset:"spec"}),zf=3,Hf=Object.freeze([{key:"priority",label:"\uC6B0\uC120\uC21C\uC704"},{key:"dependents",label:"\uD6C4\uC18D \uC218"},{key:"released",label:"\uD574\uC81C \uC2DC\uAC01"},{key:"spec",label:"spec \uC720\uBB34"},{key:"created",label:"\uC0DD\uC131"},{key:"updated",label:"\uC218\uC815"}]);function Bf(e){return cs.some(t=>t.id===e)}function Uf(e){let t=cs.find(n=>n.id===e);return t?t.chain.map(n=>({...n})):[]}function wv(e,t){return e.length===t.length&&e.every((n,r)=>n.key===t[r].key&&n.dir===t[r].dir)}function ds(e){return e&&"preset"in e?Uf(e.preset):e&&Array.isArray(e.chain)?e.chain.map(t=>({...t})):Uf("spec")}function Dl(e){return e&&"preset"in e?e.preset:null}function us(e){if(typeof e=="string"){let s;try{s=JSON.parse(e)}catch{return Bf(e)?{preset:e}:Hi}return us(s)}if(!e||typeof e!="object")return Hi;let t=e;if(Bf(t.preset))return{preset:t.preset};let n=t.chain;if(!Array.isArray(n)||n.length===0||n.length>zf||!n.every(_a))return Hi;let r=[];for(let s of n)r.some(i=>i.key===s.key)||r.push({key:s.key,dir:s.dir});let o=cs.find(s=>wv(s.chain,r));return o?{preset:o.id}:{chain:r}}function Gf(){try{return us(window.localStorage.getItem(Wf))}catch{return Hi}}function Pl(e){try{window.localStorage.setItem(Wf,JSON.stringify(e))}catch{}}function Kf(e,t,n){let r=e.map(a=>({...a}));if(!n)return r.slice(0,t);if(!Object.prototype.hasOwnProperty.call(Ls,n))return r;let o=n;if(r.slice(0,t).some(a=>a.key===o))return r.slice(0,t);let s={key:o,dir:r[t]&&r[t].key===o?r[t].dir:Ls[o]},i=r.slice(0,t),l=r.slice(t+1).filter(a=>a.key!==o);return[...i,s,...l].slice(0,zf)}function Vf(e,t){return e.map((n,r)=>r===t?{key:n.key,dir:n.dir==="asc"?"desc":"asc"}:{...n})}function Yf(e,t,n){let r=Array.isArray(e)?e.slice():[];return r.sort(Zc(ds(t))),!n||n.size===0?r:[...r.filter(o=>!n.has(o.id)),...r.filter(o=>n.has(o.id))]}var Xf=new Set(["sh","bash","zsh","dash","ksh"]),Zf=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function Qf(e){let t=e.split("/");return t[t.length-1]||""}function kv(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let n=t.slice(2).trim().split(/\s+/).filter(Boolean);if(n.length===0)return!1;let r=Qf(n[0]);if(r!=="env")return Xf.has(r);let o=n.slice(1).find(s=>!s.startsWith("-")&&!s.includes("="));return o!==void 0&&Xf.has(Qf(o))}function $v(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function xv(e){let t=[],n=0;Zf.lastIndex=0;for(let r of e.matchAll(Zf)){let o=r.index;o>n&&t.push({text:e.slice(n,o),kind:"plain"}),t.push({text:r[0],kind:$v(r[0])}),n=o+r[0].length}return n<e.length&&t.push({text:e.slice(n),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function Av(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function Jf(e){let t=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),r=document.createElement("div");r.className="repo-ops-script-viewer-root",document.body.appendChild(r);let o=null,s="loading",i="",l="",a=0,c=null,u=!1;function m(P,U){return U?xv(P).map(X=>X.kind==="plain"?X.text:d`<span
            class="repo-ops-script-viewer__token repo-ops-script-viewer__token--${X.kind}"
            >${X.text}</span
          >`):P}function y(){if(!o)return d``;let P=s==="ready"&&kv(i),U=s==="ready"?i.split(`
`):[];return d`<div
    ...
    >
      ...
      <section class="repo-ops-script-viewer__panel">
        ...
        <div class="repo-ops-script-viewer__body" aria-live="polite">
          ${s==="loading"?d`<div class="repo-ops-script-viewer__status">
                스크립트 불러오는 중…
              </div>`:s==="error"?d`<div
    ...
    </div>`}function b(){rt(y(),r)}async function k(){if(s!=="ready")return;let P=await Mn(i);de(P?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",P?"success":"error")}function D(P){P.key==="Escape"&&o&&(P.preventDefault(),ee())}function q(){u||(document.addEventListener("keydown",D),u=!0)}function Y(){u&&(document.removeEventListener("keydown",D),u=!1)}async function ae(P,U=null){let X=++a;q(),o={...P},c=U||(document.activeElement instanceof HTMLElement?document.activeElement:null),s="loading",i="",l="",b(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let _e=t?t():"";if(!_e){s="error",l="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",b();return}if(!n){s="error",l="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",b();return}let W="/api/repo-ops-script?workspace="+encodeURIComponent(_e)+"&lane="+encodeURIComponent(P.lane)+"&base_sha="+encodeURIComponent(P.base_sha);try{let Z=await n(W),ie=await Z.json().catch(()=>({}));if(X!==a)return;if((t?t():"")!==_e){ee();return}if(!Z.ok||!ie||ie.ok!==!0){s="error",l=Av(ie&&typeof ie.error=="string"?ie.error:""),b();return}o={lane:ie.lane,base_sha:ie.base_sha,path:ie.path,base_ref:ie.base_ref},i=String(ie.content),s="ready",b()}catch{if(X!==a)return;s="error",l="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",b()}}function ee(){a+=1,Y(),o=null,i="",b();let P=c;c=null,P?.isConnected&&P.focus()}function j(){ee(),r.remove()}return{open:ae,close:ee,destroy:j}}var e_={deploy_not_declared:"\uC120\uC5B8 \uC5C6\uC74C",deploy_opted_out:"\uC774 workspace\uC5D0\uC11C \uBC30\uD3EC \uC2E4\uD589\uC774 \uAEBC\uC838 \uC788\uC74C",deploy_in_flight:"\uBC30\uD3EC \uC9C4\uD589 \uC911",target_unresolved:"\uB300\uC0C1 tip\uC744 \uD655\uC815\uD558\uC9C0 \uBABB\uD568",remote_history_not_monotonic:"\uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC\uC640 \uC6D0\uACA9 \uC774\uB825\uC774 \uAC08\uB77C\uC9D0"},Sv=new Set(["queued","running","retry_pending"]);function t_(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),o=e.onOpenScript;function s(){return t&&t.get()||{}}function i(){let W=s();return typeof W.revision=="number"?W.revision:0}function l(W){t&&W&&W.queue&&typeof W.queue=="object"&&t.set(W.queue)}function a(){let W=s().workspace_info;return W&&typeof W=="object"?W:{}}function c(W,Z){return d`<span
    ...
    >`}function u(W){if(typeof W!="number"||!Number.isFinite(W))return"";let Z=W/6e4;return Number.isInteger(Z)?`timeout ${Z}\uBD84`:`timeout ${Math.round(W/1e3)}\uCD08`}function m(W){let Z=u(W);return Z?c("config",Z):""}function y(W,Z,ie){return d`<button
      ...
      @click=${te=>{o&&o({lane:W,base_sha:Z.base_sha,path:ie.script,base_ref:Z.base_ref},te.currentTarget)}}
    ></button>`}function b(){let W=s().repo_operations;return Array.isArray(W)?W:[]}function k(){let W=a().repo_ops,Z=W&&typeof W=="object"?W.repo_id:null;return typeof Z=="string"&&Z?Z:null}function D(){return b().some(W=>W&&W.kind==="deploy"&&Sv.has(W.state))}function q(){let W=D(),Z=k()===null;return d`<button
      type="button"
    ...
    >
      배포 실행
    </button>`}function Y(){let W=s().repo_ops_opt_out;return{verify:W?.verify===!0,deploy:W?.deploy===!0}}function ae(W,Z){return d`<label class="worker-repo-ops__lane-run">
      <input
        type="checkbox"
        .checked=${!Z}
    ...
    </div>`}function _e(){let W=s(),Z=W.repo_operation_policy&&typeof W.repo_operation_policy=="object"?W.repo_operation_policy:null;return Z?d`<section
  ...
  </p>`}function Iv(e,t){if(!e||typeof e!="object")return;let n=t&&t.kind==="verify"?"verify":"deploy",r=e[n],o=r&&typeof r=="object"?r.timeout_ms:void 0;return typeof o=="number"&&Number.isFinite(o)?o:void 0}function Dv(e,t){let n=Kp(e,t),r=Vp(e);return!n&&!r?"":d`<p class="worker-ev__why">
  ...
  </div>`}function Mv(e,t){let n=e.operation,r=n.state==="failed",o=n.failure?n.failure.code:"";return d`<li
    class="worker-ev"
  ...
  >
    ...
    <div class="worker-ev__body">
      ...
      ${Dv(n,Iv(t,n))}
      ${Pv(n)}
      ${s_([{term:"\uC2E4\uD328 \uCF54\uB4DC",value:r?o:""},{term:"script",value:[n.script_path||"",n.script_blob_sha?`blob ${ii(n.script_blob_sha)}`:"",Number.isInteger(n.exit_code)?`exit ${n.exit_code}`:""].filter(Boolean).join(" \xB7 ")},{term:"\uB85C\uADF8",value:n.log_path||""},{term:"\uCD9C\uB825",value:n.output_tail||""}])}
    </div>
  ...
  </section>`}function a_(e,t={}){let n=null;function r(){if(n===null){rt(d``,e);return}let i=Ov(n.operations,n.cleanup_failures,{expanded:n.expanded});rt(qv({events:i.visible,hidden:i.hidden,expanded:n.expanded,repo:n.repo,repo_ops:n.repo_ops}),e)}e.addEventListener("click",i=>{let l=i.target;if(l?.closest?.('[data-seam="repo-ops-close"]')){s();return}l?.closest?.('[data-seam="repo-ops-more"]')&&n&&(n.expanded=!n.expanded,r())});function o(i){n={operations:i.operations,cleanup_failures:i.cleanup_failures,repo:i.repo||"",repo_ops:i.repo_ops||null,expanded:!1},r()}function s(){n!==null&&(n=null,r(),t.onClose&&t.onClose())}return{open:o,close:s,isOpen:()=>n!==null,refresh(i){n&&(n={operations:i.operations,cleanup_failures:i.cleanup_failures,repo:i.repo||"",repo_ops:i.repo_ops||null,expanded:n.expanded},r())}}}var Fv=qt("views:worker"),jv="tab:worker:ready",Bv="tab:worker:blocked",Uv="tab:worker:in-progress",Wv="tab:worker:resolved",zv="tab:worker:closed",Gi=1,l_=5,Hv=new Set(["quick_fix","spec_backed","full_plan"]);function c_(e){return typeof e=="string"&&Hv.has(e)}var p_="beads-ui.worker.candidate-filter",Ml={show_blocked:!1,spec:"all"};function Gv(){try{let e=window.localStorage.getItem(p_);if(!e)return{...Ml};let t=JSON.parse(e);if(!t||typeof t!="object")return{...Ml};let n=t.spec;return{show_blocked:t.show_blocked===!0,spec:n==="with"||n==="without"?n:"all"}}catch{return{...Ml}}}function Kv(e){try{window.localStorage.setItem(p_,JSON.stringify(e))}catch{}}function Vv(e,t){let n=l=>t.show_blocked||!l.blocked,r=l=>t.spec==="all"||(t.spec==="with"?l.has_spec:!l.has_spec),o=[],s=0,i=0;for(let l of e){let a=n(l),c=r(l);a&&c?o.push(l):!a&&c?s+=1:a&&!c&&(i+=1)}return{visible:o,hidden_blocked:s,hidden_spec:i}}var Yv=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],f_="bdui.worker.done-range";function Xv(){try{let e=window.localStorage.getItem(f_);return e===null?"today":Gn(e)}catch{return"today"}}function Zv(e){try{window.localStorage.setItem(f_,e)}catch{}}function d_(e){let t=Array.isArray(e)&&e.length>0?e[0]:null;if(!t)return"";let n=typeof t.title=="string"?t.title:t.id||"";return n.length>22?`${n.slice(0,22)}\u2026`:n}function Qv(e){let t=e&&e.parent;return(typeof t=="string"?t.length>0:!!(t&&t.id))||/\.\d+$/.test(e&&e.id||"")}function Jv(e){let t=e?.blocked_info;return t&&typeof t=="object"?Array.isArray(t.blockers)?t.blockers.filter(r=>typeof r=="string"&&r.length>0):[]:(Array.isArray(e?.dependencies)?e.dependencies:[]).map(r=>{if(typeof r=="string")return r;if(!r||typeof r!="object")return"";let o=r.type??r.dependency_type;return o!==void 0&&o!=="blocks"?"":r.depends_on_id||r.id||""}).filter(Boolean)}var ew=2;function tw(e,t){let n=e?.release_info,o=(n&&typeof n=="object"&&Array.isArray(n.released_by)?n.released_by:[]).filter(a=>a&&typeof a=="object"&&typeof a.id=="string").slice().sort((a,c)=>(typeof c.closed_at=="number"?c.closed_at:0)-(typeof a.closed_at=="number"?a.closed_at:0)),s=[];for(let a of o){let c=ku(e.id,a,t);c&&s.push(c)}if(s.length===0)return null;let i=s.slice(0,ew),l=s.length-i.length;if(l>0){let a=i[i.length-1];i[i.length-1]={...a,label:`${a.label} \uC678 ${l}`}}return i}var nw="\u{1F512} blocked";function u_(e){if(e.startsWith("receipt_unbacked:"))return`\uC2E4\uD589 \uC601\uC218\uC99D \uC790\uB3D9 \uAC80\uC99D \uBD88\uAC00(${e.slice(17)}) \u2014 [\uBA38\uC9C0] \uD074\uB9AD\uC73C\uB85C \uC218\uB3D9 \uC9C4\uD589 \uAC00\uB2A5`;switch(e){case"not_in_pr_wait":return"PR \uB300\uAE30 \uC0C1\uD0DC \uB3D9\uAE30\uD654 \uC2E4\uD328";case"resolution_round_cap":return"\uCDA9\uB3CC \uD574\uC18C 2\uD68C \uCD08\uACFC";case"resolution_rebase_cap":return"\uD050 \uC7AC\uCDA9\uB3CC 3\uD68C \uCD08\uACFC";case"resolution_timeout":return"\uCDA9\uB3CC \uD574\uC18C \uB300\uAE30 \uC2DC\uAC04 \uCD08\uACFC";case"resolution_refused":return"\uD574\uC18C \uC138\uC158 \uB514\uC2A4\uD328\uCE58 \uAC70\uBD80";case"worktree_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uD574\uC18C \uD544\uC694";case"worktree_restore_branch_mismatch":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 \uBE0C\uB79C\uCE58 \uC774\uB984 \uBD88\uC77C\uCE58";case"worktree_restore_path_exists":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 \uACBD\uB85C \uC774\uBBF8 \uC788\uC74C";case"worktree_restore_branch_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 origin\uC5D0 \uBE0C\uB79C\uCE58 \uC5C6\uC74C";case"worktree_restore_branch_diverged":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 \uB85C\uCEEC \uBE0C\uB79C\uCE58\uAC00 origin\uACFC \uB2E4\uB984";case"worktree_restore_failed":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328";case"merge_unconfirmed_timeout":return"\uBA38\uC9C0 \uD655\uC778 \uC2DC\uAC04 \uCD08\uACFC";case"pr_closed_unmerged":return"PR \uB2EB\uD798";case"merge_error":return"\uBA38\uC9C0 \uC624\uB958";case"spec_id_missing":return"\uC2A4\uD399 ID \uAE30\uB85D \uC5C6\uC74C";default:return e}}function rw(e){let t=typeof e=="string"?e:"";return t==="review_failed"||t==="review_verdict_malformed"?{label:"\uB9AC\uBDF0\uC5B4 \uAC70\uBD80",action:"\uB9AC\uBDF0\uC5B4\uAC00 \uC2B9\uC778\uD558\uC9C0 \uC54A\uC558\uAC70\uB098 \uD310\uC815\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uCF54\uB4DC\uB97C \uACE0\uCE5C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:t==="reviewer_selection_invalid"?{label:"\uB9AC\uBDF0\uC5B4 \uC124\uC815 \uC624\uB958",action:"\uB9AC\uBDF0\uC5B4 \uC120\uD0DD(Bead\xB7\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\xB7harness)\uC774 \uC720\uD6A8\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4 \u2014 \uC124\uC815\uC744 \uACE0\uCE5C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:t.startsWith("repair_")?{label:"\uC218\uB9AC \uC2E4\uD328",action:"REVISE \uB4A4 1\uD68C \uC790\uB3D9 \uC218\uB9AC\uAC00 \uC2E4\uD328\uD588\uAC70\uB098 \uC608\uC0B0\uC744 \uB2E4 \uC37C\uC2B5\uB2C8\uB2E4 \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uACE0\uCE5C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:t.endsWith("_drift")||t.endsWith("_mismatch")||t==="head_drift_during_receipt"||t==="resolver_self_review_not_approved"?{label:"head \uBD88\uC77C\uCE58",action:"\uB9AC\uBDF0\uD55C head\uC640 \uD604\uC7AC head\uAC00 \uB2E4\uB985\uB2C8\uB2E4 \u2014 \uB204\uAC00 \uBE0C\uB79C\uCE58\uB97C \uBC14\uAFE8\uB294\uC9C0 \uD655\uC778\uD55C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:{label:"\uC9C4\uD589 \uBD88\uAC00",action:"\uB9AC\uBDF0 \uC9C4\uD589\uC744 \uC774\uC5B4\uAC08 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uC0AC\uC720\uB97C \uD655\uC778\uD55C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}}function ow(e){if(e==="lane_occupied")return"\uC2E4\uD589 \uB808\uC778\uC5D0 \uB0A8\uC544 \uC788\uC5B4 \uBA38\uC9C0 \uB300\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4";let t="\uBA38\uC9C0 \uD050\uC5D0 \uB123\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (\uC774\uBBF8 \uB300\uAE30 \uC911\uC774\uAC70\uB098 \uB300\uC0C1 \uC544\uB2D8)";return typeof e=="string"&&e.length>0?`${t}: ${e}`:t}function sw(e,t=null){if(e==="worker_sessions_busy")return"\uD574\uC18C \uB300\uAE30 \u2014 \uC2E4\uD589 \uC2AC\uB86F \uB300\uAE30 \uC911";if(typeof e!="string"||!e.startsWith("completion_waiting:"))return null;let n=e.slice(19);if(n.length===0)return null;switch(n){case"gating":{let r=t?.repair_sessions_used;return typeof r=="number"&&r>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911"}case"repairing":return"\uC790\uB3D9 \uC218\uC815 \uC911";case"waiting_repair_pr":return"\uC218\uC815 PR \uB300\uAE30 \uC911";case"merging":return"\uBA38\uC9C0 \uC911";case"cleaning":return"\uB9C8\uBB34\uB9AC \uC911";case"paused":return"\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";case"needs_human":return"\uD655\uC778 \uD544\uC694";default:return null}}function iw(e){if(!e||typeof e!="object")return null;switch(e.state){case"waiting":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC911",live:!0};case"yielded":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uACC4\uC18D \uC911 \xB7 \uC644\uB8CC \uD6C4 \uC6B0\uC120 \uBA38\uC9C0",live:!0};case"ready":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC644\uB8CC \xB7 \uC7AC\uAC80\uC99D \uB300\uAE30",live:!1};default:return null}}function aw(e){if(!e||typeof e!="object")return null;switch(e.state){case"pending":return{badge:"\uBA38\uC9C0 \uC804 \uD655\uC778 \uC911",title:"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uB97C \uB36E\uB294\uC9C0 \uD655\uC778\uD558\uB294 \uC911 \u2014 \uB9AC\uBDF0\uC5B4\uB294 \uC544\uC9C1 \uBD80\uB974\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",live:!1,alert:!1};case"reviewing":return{badge:"\uB9AC\uBDF0 \uC9C4\uD589 \uC911",title:"implementation review \uC2E4\uD589 \uC911",live:!0,alert:!1};case"revising":return{badge:"\uB9AC\uBDF0 \uC218\uC815 \uC911 \xB7 1\uD68C",title:"review findings \uC218\uC815 \uC911 \u2014 1\uD68C\uB85C \uC81C\uD55C\uB429\uB2C8\uB2E4",live:!0,alert:!1};case"failed":{let n=(typeof e.failure_reason=="string"?e.failure_reason:"").replace(/[\u0000-\u001f\u007f]/g," ").slice(0,120);return{badge:n.trim().length>0?`review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328: ${n.trim()}`:"review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328",title:n.trim(),live:!1,alert:!0}}default:return null}}function Nl(e,t){return typeof e!="string"||e.length===0||typeof t!="string"||t.length===0||t===e?null:`\u2192 ${t}`}var lw=new Set(["paused","needs_human","waiting_metadata","reviewing","retrying"]),cw=new Set(["waiting_metadata","reviewing","retrying"]);function dw(e,t){let n=e&&typeof e=="object"?e.auto_resolution:null,r=n&&typeof n=="object"&&!Array.isArray(n)?n:null;if(!r||!e)return null;let o=typeof r.origin_reason=="string"&&r.origin_reason.length>0?`\uC6D0 \uC0AC\uC720: ${r.origin_reason}`:"";switch(e.phase){case"waiting_metadata":return{label:"\uC815\uC815 \uB300\uAE30",details:[o,"\uBA54\uD0C0\uB370\uC774\uD130 \uC815\uC815\uC774 \uAD00\uCE21\uB418\uBA74 \uC790\uB3D9 \uC7AC\uAC1C"].filter(Boolean),live:!1};case"reviewing":{let s=typeof t?.reviewer=="string"?t.reviewer:"",i=typeof t?.effort=="string"?t.effort:"",l=t?.reviewer_source==="bead"||t?.reviewer_source==="harness"?t.reviewer_source:"";return{label:"\uC790\uB3D9 \uB9AC\uBDF0 \uC911",details:[s?`\uB9AC\uBDF0\uC5B4 ${s}${i?` \xB7 effort ${i}`:""}`:"",l?`\uB9AC\uBDF0\uC5B4 \uCD9C\uCC98 ${l}`:"",o].filter(Boolean),live:!0}}case"retrying":{let s=Number.isInteger(r.attempts)?Math.max(0,Number(r.attempts)):0,i=Number.isInteger(r.attempt_cap)&&Number(r.attempt_cap)>0?Number(r.attempt_cap):0,l=typeof r.next_at=="number"?on(r.next_at):"",a=typeof r.last_error=="string"&&r.last_error.length>0?r.last_error:"";return{label:i>0?`\uC7AC\uC2DC\uB3C4 ${Math.min(s,i)}/${i}`:`\uC7AC\uC2DC\uB3C4 ${s}`,details:[o,l?`\uB2E4\uC74C \uC2DC\uAC01 ${l}`:"",a?`\uB9C8\uC9C0\uB9C9 \uC624\uB958: ${a}`:""].filter(Boolean),live:!0}}default:return null}}function uw(e){if(typeof e!="string")return"";for(let t of["retry_exhausted:","auto_review_exhausted:"])if(e.startsWith(t))return e.slice(t.length);return""}function pw(e,t=null){if(!e||typeof e!="object")return null;let n=Number.isInteger(e.repair_sessions_used)?Math.max(0,e.repair_sessions_used):0,r=Number.isInteger(e.repair_session_cap)?Math.max(0,e.repair_session_cap):0,o=e.current_repair&&typeof e.current_repair=="object"?e.current_repair:null,s=o&&typeof o.pr_number=="number"?o.pr_number:null,i="";switch(e.phase){case"gating":i=n>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911";break;case"repairing":i="\uC790\uB3D9 \uC218\uC815 \uC911";break;case"waiting_repair_pr":i=s?`\uC218\uC815 PR #${s} \uB300\uAE30 \uC911`:"\uC218\uC815 PR \uB300\uAE30 \uC911";break;case"merging":i=e.subject_role==="repair"?s?`\uC218\uC815 PR #${s} \uBA38\uC9C0 \uC911`:"\uC218\uC815 PR \uBA38\uC9C0 \uC911":"\uBA38\uC9C0 \uC911";break;case"cleaning":i="\uB9C8\uBB34\uB9AC \uC911";break;case"waiting_metadata":case"reviewing":case"retrying":if(!t)return null;i=t.label;break;case"paused":i="\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";break;case"needs_human":i="\uD655\uC778 \uD544\uC694";break;case"completed":return null;default:return null}let l=[i,`\uC790\uB3D9 \uC218\uC815 \uD69F\uC218 ${n}/${r}`];e.head_sha&&l.push(`head ${e.head_sha}`),e.base_sha&&l.push(`base ${e.base_sha}`),(e.failure_stage||e.failure_reason)&&l.push(`${e.failure_stage||"failure"} \xB7 ${e.failure_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`);let a=uw(e.terminal_reason);a&&l.push(`\uC6D0 \uC0AC\uC720: ${a}`);for(let c of t?t.details:[])l.push(c);return e.active_attempt_id&&l.push(`attempt ${e.active_attempt_id}`),o&&typeof o.bead_id=="string"&&l.push(`repair ${o.bead_id}`),e.evidence&&l.push(e.evidence),e.log_path&&l.push(e.log_path),{badge:i,title:l.join(`
`),alert:e.phase==="needs_human",lock_actions:!lw.has(e.phase),repair_pr_url:o&&typeof o.pr_url=="string"?o.pr_url:"",repair_pr_number:s}}function fw(e){if(!e||typeof e!="object")return[];let t=e.blocking_codes;return Array.isArray(t)?t.filter(n=>typeof n=="string"&&n.length>0):[]}function _w(e){let t=e.queue_failure?`\uBA38\uC9C0 \uC2E4\uD328 \uC6D0\uBB38: ${e.queue_failure}`:e.auto_skip?`\uC790\uB3D9 \uC81C\uC678 \uC6D0\uBB38: ${e.auto_skip}`:"",n=(o,s={})=>{let i=[s.title||"",t].filter(Boolean);return{label:o,title:i.join(`
...
`),live:e.auto_resolution.live===!0});if(e.head_review&&e.head_review.state!=="failed")return n(e.head_review.badge,{title:e.head_review.title,live:e.head_review.live===!0});if(e.recovery?.lock_actions)return n(e.recovery.badge,{title:e.recovery.title,live:!0});if(e.cleanup_failed)return n(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0});if(e.base_exception)return n("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0});if(e.conflicting)return n("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="base_behind")return n("base \uAC31\uC2E0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale")return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0});if(e.gate?.reason==="spec_id_missing")return n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0});if(e.gate?.reason==="review_receipt_invalid")return n("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0});let r=fw(e.receipt_check);if(r.length>0)return n(`\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694 \xB7 ${r[0]}`,{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${r.join(", ")}`,alert:!0});if(e.head_review?.state==="failed"){let o=rw(e.head_review.failure_reason);return n(`\uB9AC\uBDF0 \uC2E4\uD328: ${o.label}`,{title:e.head_review.failure_reason?`${o.action} (${e.head_review.failure_reason})`:o.action,alert:!0})}return e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${u_(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${u_(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function mw(e,t,n,r,o=null,s=null,i=null,l=!1,a=null,c=!0,u=null,m=null,y=null,b={},k=!1,D=!1,q={},Y=null){let ae=!!a&&a.position>0,ee=!!a?.continuation_action&&a.continuation_action.continuation===null,j=!!a&&a.active===!0,P=a&&a.failure||null,U=sw(a?a.waiting:null,y),X=n[e]||null,V=X&&X.gate?X.gate:null,_e=X&&X.pr?X.pr:null,W=iw(a?a.resolution:null),Z=aw(a?a.head_review:null),ie=a&&a.head_review||null,te=dw(y,ie),Ee=pw(y,te),He=a&&a.authority||null,pe=!!ie&&["pending","reviewing","revising"].includes(ie.state),Q=!!y&&typeof y=="object"&&cw.has(y.phase),Te=ae&&!j&&(ie?.state==="failed"||!He||Q||He.source==="automatic"&&!D),Ie=i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":W?W.badge:i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":U,S=!!V&&V.base_badge==="\uCDA9\uB3CC",se=!!V&&V.enabled===!0,ye=Wo({bead_id:e,merge_sha:q.merge_sha,cleanup_cursor:q.cleanup_cursor,merge_progress:s&&s.merge_progress?s.merge_progress:null,cleanup_failed:r,repo_operations:q.repo_operations}),ve=vi(ye),$e=s&&!ye&&(s.queueing??null)?s.queueing:null,be=!!r&&["repo_operations","child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!V&&V.tier==="merged",Oe=r&&r.step==="repo_operations"&&ye?.failed===!0&&(ye.step==="deploy"||ye.step==="verify")?ye.step:null,Ke=l&&!!r&&!!V&&V.tier==="merged",yt=Te&&(se||S||V?.reason==="base_behind"||V?.reason==="review_receipt_missing"||V?.reason==="review_receipt_stale"||V?.reason==="review_receipt_undetermined"||be||Ke),St=l&&S&&c===!1,ct=qn(b,e,{external:l,merge_active:j||ye?.step==="merge",merge_queued:ae,conflict_active:!!i,cleanup_active:ve,merged:!!r||V?.tier==="merged"}),T=!!ct.operation,ce=_w({continuation_required:ee,queueing:$e,merge_step:ye,conflict_badge:Ie,conflict_live:W?.live===!0||i==="running",head_review:ie&&Z?{...Z,state:ie.state,failure_reason:ie.failure_reason}:null,auto_resolution:te,recovery:Ee,cleanup_failed:r,cleanup_label:r?Cr(r.step):null,base_exception:m,conflicting:S,gate:V,receipt_check:X&&X.receipt_check?X.receipt_check:null,queue_failure:P,auto_skip:u,queued:ae,queue_active:j,queue_position:a?a.position:0,activity:Ie?null:s&&s.activity||null}),Le=ce?.live===!0&&ce.title?d`<span title=${ce.title}>${ce.label}</span>`:ce?.label||null;return{id:e,title:l?d`${t}<span class="muted"> · 세션</span>`:t,reason:r&&ye?.active!==!0?yi(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:k,...Y?{dependency_chips:Y}:{},external:l,pr_number:_e&&typeof _e.number=="number"?_e.number:null,pr_url:_e&&typeof _e.url=="string"?_e.url:"",completion_badge:ce?.live!==!0&&ce?.title?ce.label:null,completion_title:ce?.title||"",completion_repair_pr_url:Ee?Ee.repair_pr_url:"",completion_repair_pr_number:Ee?Ee.repair_pr_number:null,badges:Le?[Le]:[],live_badge:ce?.live===!0?Le:null,usage:o,alert:ce?.alert===!0,merge_action:V?.tier==="merged"&&!be&&!Ke?!1:!ae||ee||Te,cancel_action:ae&&!ee,cancel_enabled:(!j||pe)&&!(Ee&&Ee.lock_actions),cancel_title:Ee&&Ee.lock_actions?`${Ee.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:j&&!pe?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":pe?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:ct,discard_action:ct.action,merge_step:ye,discard_enabled:ct.enabled,discard_title:ct.title,merge_enabled:!ye&&!$e&&!i&&!T&&!m&&!(Ee&&Ee.lock_actions)&&!St&&(se||S||V?.reason==="base_behind"||V?.reason==="review_receipt_missing"||V?.reason==="review_receipt_stale"||V?.reason==="review_receipt_undetermined"||be||Ke||yt||Q&&!j),merge_label:ee?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":be||Ke?Oe==="deploy"?"\uBC30\uD3EC \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":Oe==="verify"?"\uAC80\uC99D \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":"\uC815\uB9AC \uC7AC\uAC1C":S&&!ye&&!be?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":V?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":V?.reason==="review_receipt_missing"||V?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":Te?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:T?ct.error?`\uD3D0\uAE30 \uC2E4\uD328: ${ct.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${ct.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:ee?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":$e?"\uC694\uCCAD\uC744 \uBCF4\uB0B4\uB294 \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":ye?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${ye.label}`:Oe?`\uBA38\uC9C0 \uC644\uB8CC \u2014 ${Oe==="deploy"?"\uBC30\uD3EC":"\uAC80\uC99D"} \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC2E4\uD328\uD574 \uC815\uB9AC\uAC00 \uBA48\uCDC4\uC2B5\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uC800\uC7A5\uC18C \uC791\uC5C5\uBD80\uD130 \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4`:Ke?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":St?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":be?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":S?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uC790\uB3D9 \uC7AC\uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="review_receipt_undetermined"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uD310\uC815 \uBBF8\uACB0 \u2014 \uB2E4\uC74C \uAD00\uCE21\uC5D0\uC11C \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4. \uC9C0\uAE08 \uBA38\uC9C0\uD558\uBA74 \uAD00\uCE21\uB41C head\uB97C \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":V?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":se?`\uBA38\uC9C0 (${V.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:V&&V.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${V&&V.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function ql(e,t={}){let{transport:n,issueStores:r,queueStore:o,sessionLogStore:s,gotoIssue:i,getWorkspacePath:l,switchWorkspace:a,openDoc:c,doneRange:u,onDoneRangeChange:m}=t,y=r?Ds(r):null,b=null,k=Gv(),D=null,q=null,Y={members_by_id:new Map,serial_raw_lengths:{},serial_lane_count:0,occupied_lanes:new Set},ae=Gf(),ee=Dl(ae)===null,j=u?Gn(u):Xv(),P=new Map;function U(){let p=Fr.find(h=>h.value===j);return p?p.label:"\uC624\uB298"}let X=Bi("beads-ui.worker.lane-collapsed"),V=!1,_e=new Set,W=new Set,Z=new Set,ie=new Set,te=new Set,Ee={},He=null,pe=0,Q=null,Te=[];function Ie(p){return He===p?Ee:{}}async function S(){if(!n)return;let p=l?.()||"";if(He===p||Q&&Q.key===p&&Q.generation===pe)return;let h=++pe;Q={key:p,generation:h};let R=null;try{R=await Promise.resolve(n("get-session-defaults",{}))}catch(re){if(h!==pe)return;Q=null,Fv("get-session-defaults failed: %o",re),Ne();return}h===pe&&(Ee=R&&typeof R.values=="object"&&R.values!==null?{...R.values}:{},He=p,Q=null,Ne())}function se(){He=null,pe+=1,S()}let ye=document.createElement("div");ye.className="worker-console";let ve=document.createElement("div");ve.className="worker-top";let $e=document.createElement("div");$e.className="worker-drawer-overlay",$e.hidden=!0;let be=document.createElement("div");be.className="worker-drawer-overlay__backdrop";let Oe=document.createElement("div");Oe.className="worker-drawer-host";let Ke=document.createElement("div");Ke.className="worker-drawer-host",Ke.hidden=!0,$e.append(be,Oe,Ke);let yt=document.createElement("div");yt.className="worker-lanes-host",ye.append(ve,$e,yt),e.appendChild(ye);let St=null,ct=io(Oe,{transport:n,sessionLogStore:s,onClose:()=>{St=null,$e.hidden=!0,Ne()}}),T=a_(Ke,{onClose:()=>{Ke.hidden=!0,$e.hidden=!0,Ne()}}),ce=Jf({getWorkspacePath:l||(()=>"")}),Le=l&&l()||"",je=t_({queueStore:o,transport:n,onChanged:()=>Ne(),onOpenScript:(p,h)=>{ce.open(p,h)}});function Me(){return o&&o.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Gi,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function et(){let p=Me(),h=typeof p.serial_lane_count=="number"&&Number.isInteger(p.serial_lane_count)&&p.serial_lane_count>0?Math.min(p.serial_lane_count,5):0,R=Array.isArray(p.serial_lanes)?p.serial_lanes:[],re=[];for(let pt of R){if(re.length>=h)break;!pt||typeof pt.id!="string"||!/^s[1-5]$/.test(pt.id)||!Array.isArray(pt.entries)||re.push({id:pt.id,label:`\uC9C1\uB82C ${pt.id.slice(1)}`,count:pt.entries.length})}return re.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(p.queue)?p.queue:[]).length},...re]}function bt(p){if(!D||!p.some(R=>R.id===D))return null;let h=et();return h?{bead_id:D,lanes:h}:null}function Ve(){let p=Me();return typeof p.revision=="number"?p.revision:0}function z(p){p&&p.queue&&o&&o.set(p.queue)}function ne(){let p=Me().queue;return Array.isArray(p)?p.length:0}async function De(p,h,R){if(!n)return;let re=()=>({bead_id:p,...h==="parallel"?{}:{lane:h},...R===void 0?{}:{index:R},expected_revision:Ve()}),ge=await n("worker-queue-place",re());z(ge),ge&&ge.conflict&&await n("worker-queue-place",re()).then(z)}async function lt(p,h,R){if(!n)return;let re=()=>({bead_id:p,...h==="parallel"?{}:{lane:h},to_index:R,expected_revision:Ve()}),ge=await n("worker-queue-reorder",re());z(ge),ge&&ge.conflict&&await n("worker-queue-reorder",re()).then(z)}async function it(p){if(!n)return;let h=await n("worker-queue-remove",{bead_id:p,expected_revision:Ve()});z(h),h&&h.conflict&&await n("worker-queue-remove",{bead_id:p,expected_revision:Ve()}).then(z)}async function Pe(p){if(!n||!p)return;let h=await n("worker-attempt-pause",{attempt_id:p});h&&h.paused===!1&&h.reason&&de(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${h.reason}`,"error",2400)}async function Ue(p){if(!n||!p)return;let h=await Vr();if(h===null)return;let R=async(ge={})=>await n("worker-attempt-resume",{attempt_id:p,expected_revision:Ve(),...h!==""?{instructions:h}:{},...ge}),re=await R();z(re),re&&re.conflict&&(re=await R(),z(re)),re=await er(re,(ge,pt)=>R({continuation:ge,decision_token:pt}),{onResult:z,refresh:()=>R()}),re&&re.resumed===!1&&!re.conflict&&re.reason&&de(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${re.reason}`,"error",2400)}async function dt(p){if(!n||!p)return;let h=await n("worker-attempt-dismiss",{attempt_id:p,expected_revision:Ve()});z(h),h&&h.conflict&&(h=await n("worker-attempt-dismiss",{attempt_id:p,expected_revision:Ve()}),z(h)),h&&h.dismissed===!1&&!h.conflict&&h.reason&&de(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${h.reason}`,"error",2400)}async function tt(p,h,R=!0){if(!n)return null;let re=n,ge=await re(p,{...h,expected_revision:Ve()});return z(ge),ge&&ge.conflict&&R&&(ge=await re(p,{...h,expected_revision:Ve()}),z(ge)),ge}async function _t(p){if(!n||!p)return;let h=Me().merge_queue?.find(re=>re.bead_id===p)?.continuation_action;if(h?.mismatch&&h.continuation===null){await Ft(p,h.mismatch);return}_e.add(p),Ne();let R;try{R=await tt("worker-merge-queue-add",{bead_id:p})}catch{de("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{_e.delete(p),Ne()}if(!(!R||R.applied)){if(R.conflict){de("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}de(ow(R.reason),"error",2400)}}async function Pt(p){if(!(!n||!p||W.has(p))){W.add(p),Ne();try{let h=await n("worker-cleanup-retry",{bead_id:p,expected_revision:Ve()});z(h),h&&!h.retried&&!h.conflict&&h.reason&&de(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${h.reason}`,"error",2400)}finally{W.delete(p),Ne()}}}async function Ft(p,h){let R=await er({continuation_mismatch:h},(ge,pt)=>tt("worker-merge-queue-add",{bead_id:p,continuation:ge,decision_token:pt},!1)),re=R?.queue?.merge_queue?.find(ge=>ge.bead_id===p)?.continuation_action;if(R?.applied!==!0&&re?.continuation===null&&re.mismatch){await Ft(p,re.mismatch);return}R&&R.applied===!1&&!R.conflict&&de("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function Ht(p){if(!n)return;let h=await tt("worker-merge-auto-toggle",{on:p});!h||h.conflict||de(p?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",p?"success":"info",2400)}async function Mt(p){if(!n||!p)return;let h=await tt("worker-merge-queue-remove",{bead_id:p});h&&!h.conflict&&!h.applied&&h.reason==="merge_active"&&de("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function Nt(){await tt("worker-merge-queue-remove",{all:!0})}async function wt(p,h=null,R="unmerged",re=null){if(!n||!p)return;let ge=jo(p,R);if(!(!!re||typeof globalThis.confirm!="function"||globalThis.confirm(ge)))return;let ut=await n("worker-discard",{bead_id:p,...h?{attempt_id:h}:{},...re?{operation_id:re}:{},expected_revision:Ve()});if(z(ut),ut&&ut.conflict&&(ut=await n("worker-discard",{bead_id:p,...h?{attempt_id:h}:{},...re?{operation_id:re}:{},expected_revision:Ve()}),z(ut)),ut&&ut.discarded===!0){de(di(ut),"success",5e3);return}if(ut&&ut.reason){de(`\uD3D0\uAE30 \uC2E4\uD328: ${ut.reason}`,"error",2800);return}if(ut&&ut.accepted&&ut.pending==="merged_revert"){de("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(ut&&ut.accepted&&!ut.discarded){de(`\uD3D0\uAE30 \uC9C4\uD589: ${ut.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}ut&&!ut.conflict&&de("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function We(p,h,R){if(!(!n||!h||!R||ie.has(h))){ie.add(h),Ne();try{let re=await n(p,{bead_id:h,action_id:R,expected_revision:Ve()});z(re),re?.conflict?de("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!re?.ok&&re?.reason&&de(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(re.reason)}`,"error",2800)}finally{ie.delete(h),Ne()}}}async function O(p,h){if(!n||!h||Z.has(h))return;Z.add(h),Ne();let R;try{let re=async(ge={})=>await n(p,{bead_id:h,expected_revision:Ve(),...ge});R=await re(),z(R),R&&R.conflict&&(R=await n(p,{bead_id:h,expected_revision:Ve()}),z(R)),p==="worker-revise-fix"&&(R=await er(R,(ge,pt)=>re({continuation:ge,decision_token:pt}),{onResult:z,refresh:()=>re()}))}finally{Z.delete(h),Ne()}if(!(!R||R.conflict)){if(R.ok){de(p==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}de(`\uCC98\uBD84 \uAC70\uBD80: ${R.reason||""}`,"error",3e3)}}async function J(p){if(!n)return;let h=await n("worker-automation-toggle",{on:p,expected_revision:Ve()});z(h),h&&h.conflict&&await n("worker-automation-toggle",{on:p,expected_revision:Ve()}).then(z)}async function me(p){if(!n||!p)return;let h=await n("worker-repo-operation-dismiss",{operation_id:p});z(h),h&&h.ok===!1&&de(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${h.reason||""}`,"error",3e3)}async function E(p){if(!n||!Number.isFinite(p))return;let h=Math.max(Gi,Math.floor(p)),R=await n("worker-queue-set-slots",{slots:h,expected_revision:Ve()});z(R),R&&R.conflict&&await n("worker-queue-set-slots",{slots:h,expected_revision:Ve()}).then(z)}async function G(p){if(!n||!Number.isInteger(p)||p<1||p>l_)return;let h=Me(),R=(Array.isArray(h.serial_lanes)?h.serial_lanes:[]).slice(p).reduce((pt,ut)=>pt+(Array.isArray(ut?.entries)?ut.entries.length:0),0),re=()=>({count:p,expected_revision:Ve()}),ge=await n("worker-queue-set-serial-lane-count",re());z(ge),ge&&ge.conflict&&(ge=await n("worker-queue-set-serial-lane-count",re()),z(ge)),ge&&ge.applied&&R>0&&de(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${R}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}let Re="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function ze(p,h){let R=Sl(p,h.id,Y);return{id:h.id,title:h.title,location_label:h.location_label,prefixes:h.prefixes,action:R.kind==="note"?{kind:"note",text:R.text}:R.kind==="disabled"?{kind:"disabled",label:Re,title:R.title}:{kind:"place",label:Re,title:R.title}}}function xe(p,h){if(!q||q.bead_id!==p)return null;let R=q.counterpart_id,re=h.filter(ge=>ge.id===R);return re.length===0?null:{rows:re.map(ge=>ze(p,ge))}}async function at(p,h){let R=Sl(p,h,Y);if(q=null,R.kind!=="ops"){Ne();return}let re=Ve();for(let ge of R.ops){let pt=await ot(ge,re);if(pt===null)break;re=pt}Ne()}async function ot(p,h){if(!n)return null;try{let R=await n("worker-queue-place",{bead_id:p.bead_id,lane:p.lane,index:p.index,expected_revision:h});if(z(R),R&&R.conflict)return de("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!R||R.applied!==!0)return de(R&&typeof R.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${R.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let re=R.queue?R.queue.revision:void 0;return typeof re!="number"?(de("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):re}catch(R){return de(R instanceof Error&&R.message?R.message:"\uD050 \uC694\uCCAD \uC2E4\uD328","error"),null}}function he(){let p=Me(),h=y?y.selectBoardColumn(jv,"ready"):[],R=y?y.selectBoardColumn(Bv,"blocked"):[],re=y?y.selectBoardColumn(zv,"closed"):[],ge=y?y.selectBoardColumn(Uv,"in_progress"):[],pt=y?y.selectBoardColumn(Wv,"resolved"):[],ut=Ms([...h,...R,...ge,...pt,...re]),Vt=new Map;for(let _ of[...h,...R,...ge])_&&_.id&&!Vt.has(_.id)&&Vt.set(_.id,_);let Ut={...Ie(l?.()||"")};for(let _ of["orchestration_model","orchestration_effort","orchestration_speed"]){let I=p[_];typeof I=="string"&&(Ut[_]=I)}function Gt(_,I){let le=Vt.get(_);if(!le)return null;let Be=le.metadata&&typeof le.metadata=="object"?le.metadata:{},Qe=le.workflow?.route,Xt=Be.route,Lt=c_(Qe)?Qe:c_(Xt)?Xt:null;return $n({pin:Be,global:Ut,execution_defaults:p.execution_defaults??null,runner_catalog:p.runner_catalog??null,route:Lt,controller_runtime:I})}function Cn(_){let I=_.runner||null,le=Gt(_.bead_id,I),Be=qo(_),Qe=le?_r(le,I):null;return Be||Qe?{orchestration:Be,worker:Qe}:null}let bn=new Map;function Yt(_){if(bn.has(_))return bn.get(_)??null;let I=Gt(_,null),le=null;if(I){let Be=Nn(p.runner_catalog??null,I.orchestration_model.value??""),Qe=Be===null?I:Gt(_,Be),Xt=Er(Qe,p.runner_catalog??null),Lt=_r(Qe,Be);le=Xt||Lt?{orchestration:Xt,worker:Lt}:null}return bn.set(_,le),le}let An=new Map;function hn(_){if(An.has(_))return An.get(_)??null;let I=Vt.get(_),le=I&&I.metadata&&typeof I.metadata=="object"?I.metadata:null,Be=le?to(le):null;return An.set(_,Be),Be}function ar(_){let I=Ns(ut,_);return I.total===0?null:I}let Xn=p.bead_titles||{},f=new Map;for(let[_,I]of Object.entries(Xn))typeof I=="string"&&I.length>0&&f.set(_,I);for(let _ of[...h,...R])f.set(_.id,_.title||_.id);let g=new Map;for(let _ of[...h,...R,...ge,...pt,...re])_&&_.id&&typeof _.from_id=="string"&&g.set(_.id,_.from_id);let w=new Map;for(let _ of[...h,...R,...ge,...pt,...re])_&&_.id&&typeof _.priority=="number"&&w.set(_.id,_.priority);let $=p.bead_times&&typeof p.bead_times=="object"&&!Array.isArray(p.bead_times)?p.bead_times:{},N=p.bead_labels&&typeof p.bead_labels=="object"&&!Array.isArray(p.bead_labels)?p.bead_labels:{},H=p.bead_workflow&&typeof p.bead_workflow=="object"&&!Array.isArray(p.bead_workflow)?p.bead_workflow:{},oe=new Map;for(let[_,I]of Object.entries(N))Array.isArray(I)&&oe.set(_,Il(I));for(let _ of[...h,...R]){let I=_.labels;Array.isArray(I)&&!oe.has(_.id)&&oe.set(_.id,Il(I))}let Se=p.bead_blocked_by&&typeof p.bead_blocked_by=="object"&&!Array.isArray(p.bead_blocked_by)?p.bead_blocked_by:{},Ye=p.blocker_workspaces&&typeof p.blocker_workspaces=="object"&&!Array.isArray(p.blocker_workspaces)?p.blocker_workspaces:{},nt=new Map;for(let[_,I]of Object.entries($))I&&typeof I=="object"&&nt.set(_,I);for(let _ of[...h,...R])nt.set(_.id,{created_at:_.created_at,updated_at:_.updated_at});let Fe=_=>nt.get(_)||{},v=p.pr_wait||[],K=p.pr_observations||{},L=p.pr_activity||{},B=p.cleanup_failed||{},Ae=Object.entries(B).map(([_,I])=>({bead_id:_,step:I&&I.step?I.step:"",reason:I&&I.reason?I.reason:"",at:I&&typeof I.at=="number"?I.at:null,detail:I&&typeof I.detail=="string"?I.detail:null,output_tail:I&&typeof I.output_tail=="string"&&I.output_tail?I.output_tail:void 0,log_path:I&&typeof I.log_path=="string"&&I.log_path?I.log_path:void 0,retry_count:I&&typeof I.retry_count=="number"&&Number.isInteger(I.retry_count)&&I.retry_count>0?I.retry_count:0,failure_code:I&&typeof I.failure_code=="string"?I.failure_code:void 0})),qe=p.queue||[],ht=new Set([...qe.map(_=>_.bead_id),...(Array.isArray(p.serial_lanes)?p.serial_lanes:[]).flatMap(_=>(Array.isArray(_?.entries)?_.entries:[]).map(I=>I.bead_id)),...v.map(_=>_.bead_id),...p.done.map(_=>_.bead_id)]),Ge=new Set(R.map(_=>_.id)),ft=new Set,yn=[];for(let _ of[...h,...R])ht.has(_.id)||ft.has(_.id)||Qv(_)||(ft.add(_.id),yn.push(_));let A_=Yf(yn,ae,Ge),S_=p.admission||{},Ul=_=>{let I=S_[_];if(!I)return"";if(I.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let le=typeof I.reason=="string"?I.reason:"",Be=le.indexOf(":");return Be>0&&Be<le.length-1?`\u26D4 ${le.slice(0,Be)} (${le.slice(Be+1)})`:`\u26D4 ${le}`},Wl=new Map,E_=Date.now(),T_=A_.map(_=>{let I=Wr(_),le=I.evidence==="published",Be=_.workflow?.route==="quick_fix"||_.metadata&&_.metadata.route==="quick_fix",Qe=!Object.hasOwn(_,"description")||typeof _.description=="string"&&_.description.trim().length>0,Xt=Object.hasOwn(_,"labels")&&Ff(_.labels),Lt=Xt||!Object.hasOwn(_,"labels")?"":jf(_.labels,_.metadata),Mr=Lt.length>0,Ct=!Xt&&(Be?Qe:le&&!I.conflict),vs=Ge.has(_.id),Zn=[];if(vs){let ws=Jv(_);ws.length>0?Wl.set(_.id,ws):Zn.push(nw)}Be&&!Qe?Zn.push("missing_description"):!Be&&I.conflict?Zn.push("spec_id_conflict"):!Be&&I.evidence==="none"?Zn.push("spec \uC5C6\uC74C"):!Be&&I.evidence==="draft"&&Zn.push("spec \uBBF8\uBC1C\uD589(draft)");let Nr=Ul(_.id);Nr&&Zn.push(Nr);let po=tw(_,E_),fo=_.dependents_info&&typeof _.dependents_info=="object"?$u(_.dependents_info):null;return{id:_.id,title:_.title||_.id,reason:Zn.join(" \xB7 "),draggable:!1,queue_placeable:Ct,lane:"candidate",created_at:_.created_at,updated_at:_.updated_at,workflow:_.workflow,is_quick_fix:Be,status:_.status,worker_ineligible:Xt,session_preferred:Mr,session_preferred_reason:Lt,blocked:vs,has_spec:le,exec_chips:Yt(_.id),rec:hn(_.id),from_id:_.from_id||void 0,priority:w.get(_.id),...po||fo?{dependency_chips:{...po?{released:po}:{},...fo?{dependents:fo}:{}}}:{}}}),Ki=Vv(T_,k),Vi=Ki.visible,C_=p.revise_parked||{},ps=p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},R_=_=>{let I=H[_]?.chips?.pr;return I&&typeof I.number=="number"&&typeof I.url=="string"?{pr_number:I.number,pr_url:I.url}:{}},Yi=(_,I)=>_.map((le,Be)=>{let Qe=I!=="done",Xt=I!=="done"&&I!=="queue",Lt=Qe?C_[le.bead_id]:null,Mr=Qe?qn(ps,le.bead_id):null,Ct=Mr?.operation?Mr:null,vs=Qe&&oe.get(le.bead_id)===!0,Zn=p.admission&&typeof p.admission=="object"?p.admission[le.bead_id]:null,Nr=Qe?gu(Zn,!!Ct||ie.has(le.bead_id)):null,po=Qe&&!Nr?Ul(le.bead_id):null,fo=Qe?[po]:[],ws=[];return{id:le.bead_id,title:f.get(le.bead_id)||le.bead_id,reason:fo.filter(Boolean).join(" \xB7 "),draggable:Qe&&!Ct&&!Nr,done:I==="done",lane:I,seq:Xt?Be+1:void 0,worker_serial:vs,discard:Ct,stale_work:Nr,badges:[...ws,...Lt?["\u23F8 REVISE \uD30C\uD0B9"]:[],...I==="done"?ai(p.attempts||{},le.bead_id):[]],alert:!!Lt,revise_action:!!Lt,revise_enabled:!!Lt&&!Ct&&!Z.has(le.bead_id),revise_title:Lt?Lt.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${Lt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:I==="done"?On(p.attempts||{},le.bead_id):null,work_ms:I==="done"?li(p.attempts||{},le.bead_id):null,done_at:I==="done"&&typeof le.added_at=="number"?le.added_at:void 0,exec_chips:Qe?Yt(le.bead_id):null,rec:hn(le.bead_id),workflow:Qe&&H[le.bead_id]||null,...I==="done"?R_(le.bead_id):{},from_id:g.get(le.bead_id)||void 0,priority:w.get(le.bead_id),...Fe(le.bead_id)}}),Ir=p.attempts?Object.values(p.attempts).filter(Sr):[],Xi=new Set;for(let _ of Ir)_&&typeof _.resumed_from=="string"&&_.resumed_from.length>0&&Xi.add(_.resumed_from);let zl=new Map;for(let _ of Ir)zl.set(_.bead_id,_.attempt_id);let co=new Map;for(let _ of Ir)co.set(_.attempt_id,_);function Zi(_){let I=new Set,le=_;for(;le&&!I.has(le.attempt_id);){if(le.conflict_resolution===!0)return!0;I.add(le.attempt_id),le=typeof le.resumed_from=="string"&&le.resumed_from.length>0&&co.get(le.resumed_from)||null}return!1}let fs=typeof p.declared_base=="string"?p.declared_base:null;function O_(_){let I=null;for(let le of Ir)!le||le.bead_id!==_||Zi(le)||(I===null||(typeof le.started_at=="number"?le.started_at:0)>=(typeof I.started_at=="number"?I.started_at:0))&&(I=le);return I&&typeof I.target_base=="string"?I.target_base:null}let Qi=[],_s=[],L_=qf(p),Hl=_=>{let I=typeof _.session_id=="string"&&_.session_id.length>0,le=Xi.has(_.attempt_id);return{eligible:I&&!le,reason:I?le?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},In=null;for(let _ of Ir){let I=_.status==="paused"&&!Xi.has(_.attempt_id);if(_.status==="running"||I)_s.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:f.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,paused:I,conflict_resolution:Zi(_),base_exception:Nl(fs,_.target_base),can_pause:typeof _.session_id=="string"&&_.session_id.length>0,discard:qn(ps,_.bead_id,{attempt_id:_.attempt_id}),workflow:H[_.bead_id]||null,priority:w.get(_.bead_id),usage:On(p.attempts||{},_.bead_id),rollup:ar(_.bead_id),rollup_expanded:te.has(_.bead_id),exec_chips:Cn(_),rec:hn(_.bead_id),...Fe(_.bead_id)});else if((_.status==="failed"||_.status==="orphaned")&&L_(_)){let le=Hl(_);Qi.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:f.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,failed:!0,status:_.status,status_label:_.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:qn(ps,_.bead_id,{attempt_id:_.attempt_id}),resume_eligible:le.eligible,resume_reason:le.reason,conflict_resolution:Zi(_),base_exception:Nl(fs,_.target_base),workflow:H[_.bead_id]||null,priority:w.get(_.bead_id),usage:On(p.attempts||{},_.bead_id),rollup:ar(_.bead_id),rollup_expanded:te.has(_.bead_id),exec_chips:Cn(_),rec:hn(_.bead_id),...Fe(_.bead_id)}),In=_}}let Gl=new Set([...Qi,..._s].map(_=>_.bead_id)),Kl=new Map;for(let _ of Array.isArray(p.session_active)?p.session_active:[]){let I=_&&_.bead_id;if(!(typeof I!="string"||I.length===0||Gl.has(I))){if(Gl.add(I),Array.isArray(_.blocked_by)){let le=_.blocked_by.filter(Be=>typeof Be=="string"&&Be.length>0);le.length>0&&Kl.set(I,le)}_s.push({bead_id:I,attempt_id:null,kind:"session",title:_.title||f.get(I)||I,status:"in_progress",started_at:Pn(_.started_at)??Pn(_.updated_at),updated_at:Pn(_.updated_at),workflow:_.workflow||null,session_refs:Array.isArray(_.session_refs)?_.session_refs:[],priority:w.get(I),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,rec:hn(I),usage:null,rollup:null,rollup_expanded:!1})}}let Dr=[...Qi,..._s].map(_=>{let I=co.get(_.attempt_id),le=I?.quickfix_landing;if(I?.quickfix_lane!==!0||!le||typeof le!="object")return _;let Be=typeof le.reason=="string"&&le.reason.length>0?le.reason:null,Qe=Wo({bead_id:I.bead_id,merge_sha:le.head_sha,cleanup_cursor:le.cursor,cleanup_failed:Be?{step:le.cursor,reason:Be}:null,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]});return Qe?{..._,landing:Qe}:_}),Vl=null;if(In){let _=Hl(In),I=In.cause_detail;Vl={bead_id:In.bead_id,repo:In.repo||"",reason:In.cause||In.status,cause_detail:I&&typeof I.reason=="string"?{reason:I.reason,command:typeof I.command=="string"?I.command:null}:null,resume_attempt_id:In.attempt_id,resume_eligible:_.eligible,resume_reason:_.reason,discard:qn(ps,In.bead_id,{attempt_id:In.attempt_id})}}let Yl=new Set(Dr.map(_=>_.bead_id)),Ji=Array.isArray(p.merge_queue)?p.merge_queue:[],Xl=new Map,Zl=new Map,Ql=new Map,Jl=new Map,ec=new Map;Ji.forEach((_,I)=>{_&&typeof _.bead_id=="string"&&(Xl.set(_.bead_id,I+1),Zl.set(_.bead_id,_.resolution),Ql.set(_.bead_id,_.continuation_action||null),Jl.set(_.bead_id,_.head_review||null),ec.set(_.bead_id,_.authority||null))});let Pr=p.merge_queue_state||{active:null,failures:{}},I_=Pr.failures||{},tc=Pr.waiting&&typeof Pr.waiting.bead_id=="string"&&typeof Pr.waiting.reason=="string"?Pr.waiting:null,D_=p.auto_merge_skips||{},nc=_=>{let I=D_[_];if(!I)return null;let le=K[_],Be=le&&le.pr?le.pr.head_sha:null;return Be&&Be===I.head_sha?I.reason||"":null},ms=new Map;for(let _ of Dr)_.failed!==!0&&_.conflict_resolution&&(_.paused?ms.has(_.bead_id)||ms.set(_.bead_id,"paused"):ms.set(_.bead_id,"running"));let rc=Dr.filter(_=>_.kind!=="session"&&!_.paused&&_.failed!==!0).length,oc=(p.workspace_info||{}).slots,sc=typeof oc=="number"?oc:typeof p.slots=="number"?p.slots:Gi,P_=rc>sc,gs=$r(j),M_=(Array.isArray(p.done)?p.done.slice():[]).filter(_=>gs===void 0||typeof _.added_at!="number"||_.added_at>=gs).sort((_,I)=>(I.added_at||0)-(_.added_at||0)),uo=Yi(M_,"done"),N_=new Set((Array.isArray(p.done)?p.done:[]).map(_=>_?.bead_id).filter(_=>typeof _=="string")),ic=[],q_=l?.()||"";for(let _ of re){let I=Pn(_.closed_at);if(typeof _.id!="string"||N_.has(_.id)||I===null||gs!==void 0&&I<gs||typeof _.comment_count!="number"||_.comment_count<=0)continue;let le=`${q_}\0${_.id}\0${String(_.updated_at)}\0${_.comment_count}`,Be=P.get(le);if(Be===void 0&&n&&(P.set(le,"pending"),Promise.resolve(n("get-comments",{id:_.id})).then(Qe=>{let Xt=Array.isArray(Qe)&&Qe.some(Lt=>Di(typeof Lt?.text=="string"?Lt.text:"")?.lane==="session");P.set(le,Xt?"session":"not-session"),Ne()}).catch(()=>{P.set(le,"failed"),Ne()})),Be==="session"){let Qe=Pn(_.started_at);ic.push({id:_.id,title:_.title||_.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:Qe!==null&&I>=Qe?I-Qe:null,work_kind:"session",done_at:I,created_at:_.created_at,updated_at:_.updated_at})}}uo.push(...ic),uo.sort((_,I)=>(I.done_at||0)-(_.done_at||0));let bs={};for(let _ of Vn)bs[_]=0;let ac=!1,lc=0,ea=0,cc=0;for(let _ of uo){let I=_.usage;if(I&&typeof I=="object"){let le=!1;for(let Be of Vn)Number.isFinite(I[Be])&&(bs[Be]+=I[Be],ac=!0,le=!0);le&&(ea+=1,Number.isFinite(I.total_cost_usd)&&(lc+=I.total_cost_usd,cc+=1))}}ea>0&&cc===ea&&(bs.total_cost_usd=lc);let dc=uo.map(_=>_.usage).filter(_=>_&&typeof _=="object"&&_.providers),F_=dc.length>0?an(Gs(dc)):ac?tr(bs):null,uc=p.lane_states&&typeof p.lane_states=="object"&&!Array.isArray(p.lane_states)?p.lane_states:{},pc=Array.isArray(p.serial_lanes)?p.serial_lanes:[],fc=_=>{if(v.some(Be=>Be.bead_id===_))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let I=Ir.filter(Be=>Be&&Be.bead_id===_),le=I.length>0?I[I.length-1].status:null;return le==="failed"||le==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":le==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},hs=pc.filter(_=>_&&typeof _.id=="string"&&Array.isArray(_.entries)).map((_,I)=>{let le=uc[_.id]||{},Be=new Map((Array.isArray(le.corrections)?le.corrections:[]).filter(Ct=>Ct&&typeof Ct.bead_id=="string"&&typeof Ct.after=="string").map(Ct=>[Ct.bead_id,Ct.after])),Qe=Array.isArray(le.occupied_by)?le.occupied_by.filter(Ct=>typeof Ct=="string"):[],Xt=new Set(Qe),Lt=Yi(_.entries.filter(Ct=>!Yl.has(Ct.bead_id)&&!Xt.has(Ct.bead_id)),_.id).map(Ct=>Be.has(Ct.id)?{...Ct,badges:[`\u{1F517} ${Be.get(Ct.id)} \uB4A4 (blocks \uC790\uB3D9)`,...Ct.badges]}:Ct),Mr=Qe.map(Ct=>({id:Ct,title:f.get(Ct)||Ct,draggable:!1,lane:_.id,ghost:!0,badges:[fc(Ct)]}));return{id:_.id,index:I+1,rows:[...Mr,...Lt],occupied:Qe.length>0,badge:Qe.length>0?fc(Qe[0]):"\uB300\uAE30",cycle:le.cycle===!0}}),_c=typeof p.serial_lane_count=="number"?p.serial_lane_count:hs.length,ta=Yi(qe.filter(_=>!Yl.has(_.bead_id)),"queue"),mc=new Map,gc=new Set;for(let[_,I]of Object.entries(uc)){if(!/^s[1-5]$/.test(_))continue;let le=I&&Array.isArray(I.occupied_by)?I.occupied_by:[];for(let Be of le)typeof Be=="string"&&mc.set(Be,_);le.length>0&&gc.add(_)}let lr=[];for(let _ of Dr)typeof _.bead_id=="string"&&lr.push({id:_.bead_id,title:f.get(_.bead_id)||_.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:mc.get(_.bead_id)??null});for(let _ of v){let I=_&&_.bead_id;typeof I!="string"||I.length===0||lr.push({id:I,title:f.get(I)||I,location_label:"PR \uB300\uAE30",kind:"pr_wait",lane_id:null})}for(let _ of hs)for(let I of _.rows)I.ghost!==!0&&lr.push({id:I.id,title:I.title,location_label:`${_.id} #${I.seq??""}`.trim(),kind:"serial",lane_id:_.id});ta.forEach((_,I)=>{lr.push({id:_.id,title:_.title,location_label:`#${I+1}`,kind:"parallel",lane_id:null})});for(let _ of Vi)lr.push({id:_.id,title:_.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let bc={};for(let _ of pc)_&&typeof _.id=="string"&&Array.isArray(_.entries)&&(bc[_.id]=_.entries.length);let na=new Map;for(let _ of lr)na.has(_.id)||na.set(_.id,_);Y={members_by_id:na,serial_raw_lengths:bc,serial_lane_count:_c,occupied_lanes:gc};let j_=Up(p.bead_scope,lr),ys=new Map;for(let[_,I]of Kl)ys.set(_,I);for(let[_,I]of Wl)ys.set(_,I);for(let[_,I]of Object.entries(Se))Array.isArray(I)&&ys.set(_,I.filter(le=>typeof le=="string"&&le.length>0));let B_=xu(ys,lr,Ye),ra=(_,I=null)=>{let le=j_.get(_),Be=B_.get(_)||null,Qe=le&&le.overlaps.length>0?le.overlaps:null,Xt=!!le&&le.scope_missing;if(!Be&&!Qe&&!Xt)return I;let Lt=Qe?xe(_,Qe):null;return{...I||{},...Be?{predecessors:Be}:{},...Qe?{overlaps:Qe}:{},...Xt?{scope_missing:!0}:{},...Lt?{popover:Lt}:{}}},oa=_=>{let I=ra(_.id,_.dependency_chips||null);return I&&(_.dependency_chips=I),_};for(let _ of ta)oa(_);for(let _ of hs)for(let I of _.rows)I.ghost!==!0&&oa(I);for(let _ of Vi)oa(_);let hc=new Map;for(let _ of Dr){let I=typeof _.bead_id=="string"?_.bead_id:"";if(I.length===0)continue;let le=_.kind==="session",Be=ra(I),Qe=typeof _.attempt_id=="string"&&_.attempt_id.length>0?co.get(_.attempt_id):void 0,Xt=Qe&&Qe.last_activity&&typeof Qe.last_activity=="object"?Qe.last_activity:null,Lt=Qe&&Array.isArray(Qe.legs)?Qe.legs:[];!Be&&!Xt&&Lt.length===0&&!le||hc.set(I,{...Xt?{last_activity:Xt}:{},...Lt.length>0?{legs:Lt}:{},...Be?{dependency_chips:Be}:{}})}let U_=v.map(_=>mw(_.bead_id,f.get(_.bead_id)||_.bead_id,K,B[_.bead_id]||null,On(p.attempts||{},_.bead_id),L[_.bead_id]||(_e.has(_.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:W.has(_.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),ms.get(_.bead_id)||null,_.external===!0,{position:Xl.get(_.bead_id)||0,active:Pr.active===_.bead_id,failure:I_[_.bead_id]||null,waiting:tc?.bead_id===_.bead_id?tc.reason:null,resolution:Zl.get(_.bead_id),continuation_action:Ql.get(_.bead_id),head_review:Jl.get(_.bead_id)||null,authority:ec.get(_.bead_id)||null},_.wt_present!==!1,p.auto_merge===!0?nc(_.bead_id):null,Nl(fs,O_(_.bead_id)),p.completion_status&&typeof p.completion_status=="object"&&!Array.isArray(p.completion_status)&&p.completion_status[_.bead_id]||null,p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},co.get(zl.get(_.bead_id)||"")?.worker_serial===!0,p.auto_merge===!0,{merge_sha:_.merge_sha,cleanup_cursor:_.cleanup_cursor,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]},ra(_.bead_id))).map(_=>({..._,workflow:H[_.id]||null,priority:w.get(_.id),...Fe(_.id)}));return{queue:p,idToTitle:f,candidates:Vi,candidate_hidden:{blocked:Ki.hidden_blocked,spec:Ki.hidden_spec},running:Dr,live_count:rc,slots:sc,over_cap:P_,failure:Vl,waiting:ta,serial_lanes:hs,serial_lane_count:_c,running_overlays:hc,pr_wait:U_,merge_queue_length:Ji.length,merge_queue_running:Ji.length>0,auto_excluded:v.map(_=>_.bead_id).filter(_=>nc(_)!==null),declared_base:fs,done:uo,token_total:F_,cleanup_failures:Ae,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]}}function Je(p){let h=p.waiting.length>0?p.waiting[0].id:"\u2014",R=d`<button
      type="button"
    ...
    >`,Gt=d`<label class="worker-tgl worker-slots"
      ...
      .value=${p}
    >
      ${cs.map(h=>d`<option value=${h.id} ?selected=${p===h.id}>
            ${h.label}
          </option>`)}
      <option value="custom" ?selected=${p==="custom"}>
        사용자 지정…
      </option>
    </select>`}function we(){let p=ds(ae);return d`<div
