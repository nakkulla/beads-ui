...
`)}function Wt(e,t){let r={claude:Er(),codex:Er()},n={orchestrator:{claude:Er(),codex:Er()},implementation:{claude:Er(),codex:Er()},"review-consult":{claude:Er(),codex:Er()}},s=new Set;for(let i of Object.values(e||{})){if(!i||i.bead_id!==t)continue;let u=i.usage;if(ll(u)){let p=Sp(i.runner),f=cl(u),h={provider:p,role:"orchestrator",attempt_id:String(i.attempt_id||""),usage:f,subtotal:ul(p,f)};f.replayed===!0&&(h.replayed=!0),typeof i.model=="string"&&(h.model=i.model),typeof i.session_id=="string"&&(h.session_id=i.session_id),$s(r[p],h,!0),$s(n.orchestrator[p],h,!0)}let d=Array.isArray(i.usage_legs)?i.usage_legs:[];for(let p of d){if(!p||p.provider!=="codex"||!vp.includes(p.role)||!ll(p.usage))continue;let f=typeof p.receipt_id=="string"&&p.receipt_id.length>0?p.receipt_id:null;if(!f||s.has(f))continue;s.add(f);let h=cl(p.usage),R={provider:"codex",role:p.role,attempt_id:String(i.attempt_id||""),usage:h,subtotal:ul("codex",h)};R.receipt_id=f,typeof p.model=="string"&&(R.model=p.model),typeof p.effort=="string"&&p.effort.trim().length>0&&(R.effort=p.effort),typeof p.session_id=="string"?R.session_id=p.session_id:typeof p.thread_id=="string"&&(R.session_id=p.thread_id),typeof p.turn_id=="string"&&(R.turn_id=p.turn_id),typeof p.completed_at=="string"&&(R.completed_at=p.completed_at),h.replayed===!0&&(R.replayed=!0),$s(r.codex,R,!1),$s(n[R.role].codex,R,!1)}}let o={};for(let i of["claude","codex"]){let u=r[i];if(u.legs.length===0)continue;let d=dl(u,!1);i==="claude"&&u.outer_count>0&&u.outer_cost_count===u.outer_count&&(d.total_cost_usd=u.outer_cost),o[i]=d}if(Object.keys(o).length===0)return null;let a={};for(let i of["orchestrator","implementation","review-consult"]){let u={};for(let d of["claude","codex"]){let p=n[i][d];p.legs.length>0&&(u[d]={...dl(p,!0),legs:p.legs})}Object.keys(u).length>0&&(a[i]=u)}return{providers:o,roles:a}}var{entries:kl,setPrototypeOf:_l,isFrozen:Ep,getPrototypeOf:Tp,getOwnPropertyDescriptor:Cp}=Object,{freeze:It,seal:zt,create:Fo}=Object,{apply:jo,construct:Bo}=typeof Reflect<"u"&&Reflect;It||(It=function(t){return t});zt||(zt=function(t){return t});jo||(jo=function(t,r){for(var n=arguments.length,s=new Array(n>2?n-2:0),o=2;o<n;o++)s[o-2]=arguments[o];return t.apply(r,s)});Bo||(Bo=function(t){for(var r=arguments.length,n=new Array(r>1?r-1:0),s=1;s<r;s++)n[s-1]=arguments[s];return new t(...n)});var As=Lt(Array.prototype.forEach),Rp=Lt(Array.prototype.lastIndexOf),ml=Lt(Array.prototype.pop),xn=Lt(Array.prototype.push),Ip=Lt(Array.prototype.splice),Es=Lt(String.prototype.toLowerCase),Oo=Lt(String.prototype.toString),Mo=Lt(String.prototype.match),An=Lt(String.prototype.replace),Lp=Lt(String.prototype.indexOf),Op=Lt(String.prototype.trim),Jt=Lt(Object.prototype.hasOwnProperty),Rt=Lt(RegExp.prototype.test),Sn=Mp(TypeError);function Lt(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var r=arguments.length,n=new Array(r>1?r-1:0),s=1;s<r;s++)n[s-1]=arguments[s];return jo(e,t,n)}}function Mp(e){return function(){for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n];return Bo(e,r)}}function et(e,t){let r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Es;_l&&_l(e,null);let n=t.length;for(;n--;){let s=t[n];if(typeof s=="string"){let o=r(s);o!==s&&(Ep(t)||(t[n]=o),s=o)}e[s]=!0}return e}function Pp(e){for(let t=0;t<e.length;t++)Jt(e,t)||(e[t]=null);return e}function mr(e){let t=Fo(null);for(let[r,n]of kl(e))Jt(e,r)&&(Array.isArray(n)?t[r]=Pp(n):n&&typeof n=="object"&&n.constructor===Object?t[r]=mr(n):t[r]=n);return t}function En(e,t){for(;e!==null;){let n=Cp(e,t);if(n){if(n.get)return Lt(n.get);if(typeof n.value=="function")return Lt(n.value)}e=Tp(e)}function r(){return null}return r}var gl=It(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Po=It(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Do=It(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Dp=It(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),No=It(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Np=It(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),bl=It(["#text"]),hl=It(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),qo=It(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),yl=It(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ss=It(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),qp=zt(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Fp=zt(/<%[\w\W]*|[\w\W]*%>/gm),jp=zt(/\$\{[\w\W]*/gm),Bp=zt(/^data-[\-\w.\u00B7-\uFFFF]+$/),Up=zt(/^aria-[\-\w]+$/),$l=zt(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Wp=zt(/^(?:\w+script|data):/i),zp=zt(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),xl=zt(/^html$/i),Hp=zt(/^[a-z][.\w]*(-[.\w]+)+$/i),vl=Object.freeze({__proto__:null,ARIA_ATTR:Up,ATTR_WHITESPACE:zp,CUSTOM_ELEMENT:Hp,DATA_ATTR:Bp,DOCTYPE_NAME:xl,ERB_EXPR:Fp,IS_ALLOWED_URI:$l,IS_SCRIPT_OR_DATA:Wp,MUSTACHE_EXPR:qp,TMPLIT_EXPR:jp}),Tn={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Gp=function(){return typeof window>"u"?null:window},Vp=function(t,r){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let n=null,s="data-tt-policy-suffix";r&&r.hasAttribute(s)&&(n=r.getAttribute(s));let o="dompurify"+(n?"#"+n:"");try{return t.createPolicy(o,{createHTML(a){return a},createScriptURL(a){return a}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}},wl=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Al(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Gp(),t=he=>Al(he);if(t.version="3.3.0",t.removed=[],!e||!e.document||e.document.nodeType!==Tn.document||!e.Element)return t.isSupported=!1,t;let{document:r}=e,n=r,s=n.currentScript,{DocumentFragment:o,HTMLTemplateElement:a,Node:i,Element:u,NodeFilter:d,NamedNodeMap:p=e.NamedNodeMap||e.MozNamedAttrMap,HTMLFormElement:f,DOMParser:h,trustedTypes:R}=e,A=u.prototype,L=En(A,"cloneNode"),q=En(A,"remove"),Y=En(A,"nextSibling"),Q=En(A,"childNodes"),W=En(A,"parentNode");if(typeof a=="function"){let he=r.createElement("template");he.content&&he.content.ownerDocument&&(r=he.content.ownerDocument)}let I,S="",{implementation:D,createNodeIterator:k,createDocumentFragment:U,getElementsByTagName:se}=r,{importNode:z}=n,M=wl();t.isSupported=typeof kl=="function"&&typeof W=="function"&&D&&D.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:Z,ERB_EXPR:de,TMPLIT_EXPR:Ie,DATA_ATTR:we,ARIA_ATTR:Ge,IS_SCRIPT_OR_DATA:at,ATTR_WHITESPACE:Fe,CUSTOM_ELEMENT:me}=vl,{IS_ALLOWED_URI:Pe}=vl,ge=null,$e=et({},[...gl,...Po,...Do,...No,...bl]),Ce=null,je=et({},[...hl,...qo,...yl,...Ss]),xe=Object.seal(Fo(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Be=null,Ye=null,Se=Object.seal(Fo(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),st=!0,K=!0,j=!1,oe=!0,Le=!1,Ue=!0,Ve=!1,Re=!1,lt=!1,Ze=!1,G=!1,te=!1,Oe=!0,We=!1,pe="user-content-",g=!0,x=!1,$={},P=null,V=et({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),X=null,ae=et({},["audio","video","img","source","image","track"]),ue=null,Ne=et({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),ve="http://www.w3.org/1998/Math/MathML",Ee="http://www.w3.org/2000/svg",be="http://www.w3.org/1999/xhtml",ze=be,tt=!1,B=null,re=et({},[ve,Ee,be],Oo),_e=et({},["mi","mo","mn","ms","mtext"]),w=et({},["annotation-xml"]),C=et({},["title","style","font","a","script"]),N=null,ee=["application/xhtml+xml","text/html"],ke="text/html",J=null,Ae=null,Te=r.createElement("form"),ft=function(c){return c instanceof RegExp||c instanceof Function},Et=function(){let c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Ae&&Ae===c)){if((!c||typeof c!="object")&&(c={}),c=mr(c),N=ee.indexOf(c.PARSER_MEDIA_TYPE)===-1?ke:c.PARSER_MEDIA_TYPE,J=N==="application/xhtml+xml"?Oo:Es,ge=Jt(c,"ALLOWED_TAGS")?et({},c.ALLOWED_TAGS,J):$e,Ce=Jt(c,"ALLOWED_ATTR")?et({},c.ALLOWED_ATTR,J):je,B=Jt(c,"ALLOWED_NAMESPACES")?et({},c.ALLOWED_NAMESPACES,Oo):re,ue=Jt(c,"ADD_URI_SAFE_ATTR")?et(mr(Ne),c.ADD_URI_SAFE_ATTR,J):Ne,X=Jt(c,"ADD_DATA_URI_TAGS")?et(mr(ae),c.ADD_DATA_URI_TAGS,J):ae,P=Jt(c,"FORBID_CONTENTS")?et({},c.FORBID_CONTENTS,J):V,Be=Jt(c,"FORBID_TAGS")?et({},c.FORBID_TAGS,J):mr({}),Ye=Jt(c,"FORBID_ATTR")?et({},c.FORBID_ATTR,J):mr({}),$=Jt(c,"USE_PROFILES")?c.USE_PROFILES:!1,st=c.ALLOW_ARIA_ATTR!==!1,K=c.ALLOW_DATA_ATTR!==!1,j=c.ALLOW_UNKNOWN_PROTOCOLS||!1,oe=c.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Le=c.SAFE_FOR_TEMPLATES||!1,Ue=c.SAFE_FOR_XML!==!1,Ve=c.WHOLE_DOCUMENT||!1,Ze=c.RETURN_DOM||!1,G=c.RETURN_DOM_FRAGMENT||!1,te=c.RETURN_TRUSTED_TYPE||!1,lt=c.FORCE_BODY||!1,Oe=c.SANITIZE_DOM!==!1,We=c.SANITIZE_NAMED_PROPS||!1,g=c.KEEP_CONTENT!==!1,x=c.IN_PLACE||!1,Pe=c.ALLOWED_URI_REGEXP||$l,ze=c.NAMESPACE||be,_e=c.MATHML_TEXT_INTEGRATION_POINTS||_e,w=c.HTML_INTEGRATION_POINTS||w,xe=c.CUSTOM_ELEMENT_HANDLING||{},c.CUSTOM_ELEMENT_HANDLING&&ft(c.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(xe.tagNameCheck=c.CUSTOM_ELEMENT_HANDLING.tagNameCheck),c.CUSTOM_ELEMENT_HANDLING&&ft(c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(xe.attributeNameCheck=c.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),c.CUSTOM_ELEMENT_HANDLING&&typeof c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(xe.allowCustomizedBuiltInElements=c.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Le&&(K=!1),G&&(Ze=!0),$&&(ge=et({},bl),Ce=[],$.html===!0&&(et(ge,gl),et(Ce,hl)),$.svg===!0&&(et(ge,Po),et(Ce,qo),et(Ce,Ss)),$.svgFilters===!0&&(et(ge,Do),et(Ce,qo),et(Ce,Ss)),$.mathMl===!0&&(et(ge,No),et(Ce,yl),et(Ce,Ss))),c.ADD_TAGS&&(typeof c.ADD_TAGS=="function"?Se.tagCheck=c.ADD_TAGS:(ge===$e&&(ge=mr(ge)),et(ge,c.ADD_TAGS,J))),c.ADD_ATTR&&(typeof c.ADD_ATTR=="function"?Se.attributeCheck=c.ADD_ATTR:(Ce===je&&(Ce=mr(Ce)),et(Ce,c.ADD_ATTR,J))),c.ADD_URI_SAFE_ATTR&&et(ue,c.ADD_URI_SAFE_ATTR,J),c.FORBID_CONTENTS&&(P===V&&(P=mr(P)),et(P,c.FORBID_CONTENTS,J)),g&&(ge["#text"]=!0),Ve&&et(ge,["html","head","body"]),ge.table&&(et(ge,["tbody"]),delete Be.tbody),c.TRUSTED_TYPES_POLICY){if(typeof c.TRUSTED_TYPES_POLICY.createHTML!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof c.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Sn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');I=c.TRUSTED_TYPES_POLICY,S=I.createHTML("")}else I===void 0&&(I=Vp(R,s)),I!==null&&typeof S=="string"&&(S=I.createHTML(""));It&&It(c),Ae=c}},rt=et({},[...Po,...Do,...Dp]),yt=et({},[...No,...Np]),ur=function(c){let _=W(c);(!_||!_.tagName)&&(_={namespaceURI:ze,tagName:"template"});let E=Es(c.tagName),H=Es(_.tagName);return B[c.namespaceURI]?c.namespaceURI===Ee?_.namespaceURI===be?E==="svg":_.namespaceURI===ve?E==="svg"&&(H==="annotation-xml"||_e[H]):!!rt[E]:c.namespaceURI===ve?_.namespaceURI===be?E==="math":_.namespaceURI===Ee?E==="math"&&w[H]:!!yt[E]:c.namespaceURI===be?_.namespaceURI===Ee&&!w[H]||_.namespaceURI===ve&&!_e[H]?!1:!yt[E]&&(C[E]||!rt[E]):!!(N==="application/xhtml+xml"&&B[c.namespaceURI]):!1},vt=function(c){xn(t.removed,{element:c});try{W(c).removeChild(c)}catch{q(c)}},Tt=function(c,_){try{xn(t.removed,{attribute:_.getAttributeNode(c),from:_})}catch{xn(t.removed,{attribute:null,from:_})}if(_.removeAttribute(c),c==="is")if(Ze||G)try{vt(_)}catch{}else try{_.setAttribute(c,"")}catch{}},dr=function(c){let _=null,E=null;if(lt)c="<remove></remove>"+c;else{let ye=Mo(c,/^[\r\n\t ]+/);E=ye&&ye[0]}N==="application/xhtml+xml"&&ze===be&&(c='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+c+"</body></html>");let H=I?I.createHTML(c):c;if(ze===be)try{_=new h().parseFromString(H,N)}catch{}if(!_||!_.documentElement){_=D.createDocument(ze,"template",null);try{_.documentElement.innerHTML=tt?S:H}catch{}}let ie=_.body||_.documentElement;return c&&E&&ie.insertBefore(r.createTextNode(E),ie.childNodes[0]||null),ze===be?se.call(_,Ve?"html":"body")[0]:Ve?_.documentElement:ie},wr=function(c){return k.call(c.ownerDocument||c,c,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT|d.SHOW_PROCESSING_INSTRUCTION|d.SHOW_CDATA_SECTION,null)},jt=function(c){return c instanceof f&&(typeof c.nodeName!="string"||typeof c.textContent!="string"||typeof c.removeChild!="function"||!(c.attributes instanceof p)||typeof c.removeAttribute!="function"||typeof c.setAttribute!="function"||typeof c.namespaceURI!="string"||typeof c.insertBefore!="function"||typeof c.hasChildNodes!="function")},Ht=function(c){return typeof i=="function"&&c instanceof i};function wt(he,c,_){As(he,E=>{E.call(t,c,_,Ae)})}let nr=function(c){let _=null;if(wt(M.beforeSanitizeElements,c,null),jt(c))return vt(c),!0;let E=J(c.nodeName);if(wt(M.uponSanitizeElement,c,{tagName:E,allowedTags:ge}),Ue&&c.hasChildNodes()&&!Ht(c.firstElementChild)&&Rt(/<[/\w!]/g,c.innerHTML)&&Rt(/<[/\w!]/g,c.textContent)||c.nodeType===Tn.progressingInstruction||Ue&&c.nodeType===Tn.comment&&Rt(/<[/\w]/g,c.data))return vt(c),!0;if(!(Se.tagCheck instanceof Function&&Se.tagCheck(E))&&(!ge[E]||Be[E])){if(!Be[E]&&Mt(E)&&(xe.tagNameCheck instanceof RegExp&&Rt(xe.tagNameCheck,E)||xe.tagNameCheck instanceof Function&&xe.tagNameCheck(E)))return!1;if(g&&!P[E]){let H=W(c)||c.parentNode,ie=Q(c)||c.childNodes;if(ie&&H){let ye=ie.length;for(let fe=ye-1;fe>=0;--fe){let Xe=L(ie[fe],!0);Xe.__removalCount=(c.__removalCount||0)+1,H.insertBefore(Xe,Y(c))}}}return vt(c),!0}return c instanceof u&&!ur(c)||(E==="noscript"||E==="noembed"||E==="noframes")&&Rt(/<\/no(script|embed|frames)/i,c.innerHTML)?(vt(c),!0):(Le&&c.nodeType===Tn.text&&(_=c.textContent,As([Z,de,Ie],H=>{_=An(_,H," ")}),c.textContent!==_&&(xn(t.removed,{element:c.cloneNode()}),c.textContent=_)),wt(M.afterSanitizeElements,c,null),!1)},nt=function(c,_,E){if(Oe&&(_==="id"||_==="name")&&(E in r||E in Te))return!1;if(!(K&&!Ye[_]&&Rt(we,_))){if(!(st&&Rt(Ge,_))){if(!(Se.attributeCheck instanceof Function&&Se.attributeCheck(_,c))){if(!Ce[_]||Ye[_]){if(!(Mt(c)&&(xe.tagNameCheck instanceof RegExp&&Rt(xe.tagNameCheck,c)||xe.tagNameCheck instanceof Function&&xe.tagNameCheck(c))&&(xe.attributeNameCheck instanceof RegExp&&Rt(xe.attributeNameCheck,_)||xe.attributeNameCheck instanceof Function&&xe.attributeNameCheck(_,c))||_==="is"&&xe.allowCustomizedBuiltInElements&&(xe.tagNameCheck instanceof RegExp&&Rt(xe.tagNameCheck,E)||xe.tagNameCheck instanceof Function&&xe.tagNameCheck(E))))return!1}else if(!ue[_]){if(!Rt(Pe,An(E,Fe,""))){if(!((_==="src"||_==="xlink:href"||_==="href")&&c!=="script"&&Lp(E,"data:")===0&&X[c])){if(!(j&&!Rt(at,An(E,Fe,"")))){if(E)return!1}}}}}}}return!0},Mt=function(c){return c!=="annotation-xml"&&Mo(c,me)},kr=function(c){wt(M.beforeSanitizeAttributes,c,null);let{attributes:_}=c;if(!_||jt(c))return;let E={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:Ce,forceKeepAttr:void 0},H=_.length;for(;H--;){let ie=_[H],{name:ye,namespaceURI:fe,value:Xe}=ie,y=J(ye),v=Xe,m=ye==="value"?v:Op(v);if(E.attrName=y,E.attrValue=m,E.keepAttr=!0,E.forceKeepAttr=void 0,wt(M.uponSanitizeAttribute,c,E),m=E.attrValue,We&&(y==="id"||y==="name")&&(Tt(ye,c),m=pe+m),Ue&&Rt(/((--!?|])>)|<\/(style|title|textarea)/i,m)){Tt(ye,c);continue}if(y==="attributename"&&Mo(m,"href")){Tt(ye,c);continue}if(E.forceKeepAttr)continue;if(!E.keepAttr){Tt(ye,c);continue}if(!oe&&Rt(/\/>/i,m)){Tt(ye,c);continue}Le&&As([Z,de,Ie],T=>{m=An(m,T," ")});let O=J(c.nodeName);if(!nt(O,y,m)){Tt(ye,c);continue}if(I&&typeof R=="object"&&typeof R.getAttributeType=="function"&&!fe)switch(R.getAttributeType(O,y)){case"TrustedHTML":{m=I.createHTML(m);break}case"TrustedScriptURL":{m=I.createScriptURL(m);break}}if(m!==v)try{fe?c.setAttributeNS(fe,ye,m):c.setAttribute(ye,m),jt(c)?vt(c):ml(t.removed)}catch{Tt(ye,c)}}wt(M.afterSanitizeAttributes,c,null)},Gt=function he(c){let _=null,E=wr(c);for(wt(M.beforeSanitizeShadowDOM,c,null);_=E.nextNode();)wt(M.uponSanitizeShadowNode,_,null),nr(_),kr(_),_.content instanceof o&&he(_.content);wt(M.afterSanitizeShadowDOM,c,null)};return t.sanitize=function(he){let c=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},_=null,E=null,H=null,ie=null;if(tt=!he,tt&&(he="<!-->"),typeof he!="string"&&!Ht(he))if(typeof he.toString=="function"){if(he=he.toString(),typeof he!="string")throw Sn("dirty is not a string, aborting")}else throw Sn("toString is not a function");if(!t.isSupported)return he;if(Re||Et(c),t.removed=[],typeof he=="string"&&(x=!1),x){if(he.nodeName){let Xe=J(he.nodeName);if(!ge[Xe]||Be[Xe])throw Sn("root node is forbidden and cannot be sanitized in-place")}}else if(he instanceof i)_=dr("<!---->"),E=_.ownerDocument.importNode(he,!0),E.nodeType===Tn.element&&E.nodeName==="BODY"||E.nodeName==="HTML"?_=E:_.appendChild(E);else{if(!Ze&&!Le&&!Ve&&he.indexOf("<")===-1)return I&&te?I.createHTML(he):he;if(_=dr(he),!_)return Ze?null:te?S:""}_&&lt&&vt(_.firstChild);let ye=wr(x?he:_);for(;H=ye.nextNode();)nr(H),kr(H),H.content instanceof o&&Gt(H.content);if(x)return he;if(Ze){if(G)for(ie=U.call(_.ownerDocument);_.firstChild;)ie.appendChild(_.firstChild);else ie=_;return(Ce.shadowroot||Ce.shadowrootmode)&&(ie=z.call(n,ie,!0)),ie}let fe=Ve?_.outerHTML:_.innerHTML;return Ve&&ge["!doctype"]&&_.ownerDocument&&_.ownerDocument.doctype&&_.ownerDocument.doctype.name&&Rt(xl,_.ownerDocument.doctype.name)&&(fe="<!DOCTYPE "+_.ownerDocument.doctype.name+`>
`+fe),Le&&As([Z,de,Ie],Xe=>{fe=An(fe,Xe," ")}),I&&te?I.createHTML(fe):fe},t.setConfig=function(){let he=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Et(he),Re=!0},t.clearConfig=function(){Ae=null,Re=!1},t.isValidAttribute=function(he,c,_){Ae||Et({});let E=J(he),H=J(c);return nt(E,H,_)},t.addHook=function(he,c){typeof c=="function"&&xn(M[he],c)},t.removeHook=function(he,c){if(c!==void 0){let _=Rp(M[he],c);return _===-1?void 0:Ip(M[he],_,1)[0]}return ml(M[he])},t.removeHooks=function(he){M[he]=[]},t.removeAllHooks=function(){M=wl()},t}var Sl=Al();var gr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ts=e=>(...t)=>({_$litDirective$:e,values:t}),ln=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,n){this._$Ct=t,this._$AM=r,this._$Ci=n}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Cn=class extends ln{constructor(t){if(super(t),this.it=gt,t.type!==gr.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===gt||t==null)return this._t=void 0,this.it=t;if(t===Bt)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Cn.directiveName="unsafeHTML",Cn.resultType=1;var El=Ts(Cn);function Ho(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Wr=Ho();function Ml(e){Wr=e}var On={exec:()=>null};function ot(e,t=""){let r=typeof e=="string"?e:e.source,n={replace:(s,o)=>{let a=typeof o=="string"?o:o.source;return a=a.replace(Ot.caret,"$1"),r=r.replace(s,a),n},getRegex:()=>new RegExp(r,t)};return n}var Kp=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Ot={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},Yp=/^(?:[ \t]*(?:\n|$))+/,Zp=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Xp=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Mn=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Qp=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Go=/(?:[*+-]|\d{1,9}[.)])/,Pl=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Dl=ot(Pl).replace(/bull/g,Go).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Jp=ot(Pl).replace(/bull/g,Go).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Vo=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ef=/^[^\n]+/,Ko=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,tf=ot(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ko).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),rf=ot(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Go).getRegex(),Ms="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Yo=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,nf=ot("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Yo).replace("tag",Ms).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Nl=ot(Vo).replace("hr",Mn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ms).getRegex(),sf=ot(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Nl).getRegex(),Zo={blockquote:sf,code:Zp,def:tf,fences:Xp,heading:Qp,hr:Mn,html:nf,lheading:Dl,list:rf,newline:Yp,paragraph:Nl,table:On,text:ef},Tl=ot("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Mn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ms).getRegex(),of={...Zo,lheading:Jp,table:Tl,paragraph:ot(Vo).replace("hr",Mn).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Tl).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ms).getRegex()},af={...Zo,html:ot(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Yo).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:On,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ot(Vo).replace("hr",Mn).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Dl).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},lf=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,cf=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ql=/^( {2,}|\\)\n(?!\s*$)/,uf=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ps=/[\p{P}\p{S}]/u,Xo=/[\s\p{P}\p{S}]/u,Fl=/[^\s\p{P}\p{S}]/u,df=ot(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Xo).getRegex(),jl=/(?!~)[\p{P}\p{S}]/u,pf=/(?!~)[\s\p{P}\p{S}]/u,ff=/(?:[^\s\p{P}\p{S}]|~)/u,_f=ot(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Kp?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Bl=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,mf=ot(Bl,"u").replace(/punct/g,Ps).getRegex(),gf=ot(Bl,"u").replace(/punct/g,jl).getRegex(),Ul="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",bf=ot(Ul,"gu").replace(/notPunctSpace/g,Fl).replace(/punctSpace/g,Xo).replace(/punct/g,Ps).getRegex(),hf=ot(Ul,"gu").replace(/notPunctSpace/g,ff).replace(/punctSpace/g,pf).replace(/punct/g,jl).getRegex(),yf=ot("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Fl).replace(/punctSpace/g,Xo).replace(/punct/g,Ps).getRegex(),vf=ot(/\\(punct)/,"gu").replace(/punct/g,Ps).getRegex(),wf=ot(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),kf=ot(Yo).replace("(?:-->|$)","-->").getRegex(),$f=ot("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",kf).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Is=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,xf=ot(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Is).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Wl=ot(/^!?\[(label)\]\[(ref)\]/).replace("label",Is).replace("ref",Ko).getRegex(),zl=ot(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ko).getRegex(),Af=ot("reflink|nolink(?!\\()","g").replace("reflink",Wl).replace("nolink",zl).getRegex(),Cl=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Qo={_backpedal:On,anyPunctuation:vf,autolink:wf,blockSkip:_f,br:ql,code:cf,del:On,emStrongLDelim:mf,emStrongRDelimAst:bf,emStrongRDelimUnd:yf,escape:lf,link:xf,nolink:zl,punctuation:df,reflink:Wl,reflinkSearch:Af,tag:$f,text:uf,url:On},Sf={...Qo,link:ot(/^!?\[(label)\]\((.*?)\)/).replace("label",Is).getRegex(),reflink:ot(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Is).getRegex()},Uo={...Qo,emStrongRDelimAst:hf,emStrongLDelim:gf,url:ot(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Cl).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:ot(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Cl).getRegex()},Ef={...Uo,br:ot(ql).replace("{2,}","*").getRegex(),text:ot(Uo.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Cs={normal:Zo,gfm:of,pedantic:af},Rn={normal:Qo,gfm:Uo,breaks:Ef,pedantic:Sf},Tf={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Rl=e=>Tf[e];function br(e,t){if(t){if(Ot.escapeTest.test(e))return e.replace(Ot.escapeReplace,Rl)}else if(Ot.escapeTestNoEncode.test(e))return e.replace(Ot.escapeReplaceNoEncode,Rl);return e}function Il(e){try{e=encodeURI(e).replace(Ot.percentDecode,"%")}catch{return null}return e}function Ll(e,t){let r=e.replace(Ot.findPipe,(o,a,i)=>{let u=!1,d=a;for(;--d>=0&&i[d]==="\\";)u=!u;return u?"|":" |"}),n=r.split(Ot.splitPipe),s=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;s<n.length;s++)n[s]=n[s].trim().replace(Ot.slashPipe,"|");return n}function In(e,t,r){let n=e.length;if(n===0)return"";let s=0;for(;s<n;){let o=e.charAt(n-s-1);if(o===t&&!r)s++;else if(o!==t&&r)s++;else break}return e.slice(0,n-s)}function Cf(e,t){if(e.indexOf(t[1])===-1)return-1;let r=0;for(let n=0;n<e.length;n++)if(e[n]==="\\")n++;else if(e[n]===t[0])r++;else if(e[n]===t[1]&&(r--,r<0))return n;return r>0?-2:-1}function Ol(e,t,r,n,s){let o=t.href,a=t.title||null,i=e[1].replace(s.other.outputLinkReplace,"$1");n.state.inLink=!0;let u={type:e[0].charAt(0)==="!"?"image":"link",raw:r,href:o,title:a,text:i,tokens:n.inlineTokens(i)};return n.state.inLink=!1,u}function Rf(e,t,r){let n=e.match(r.other.indentCodeCompensation);if(n===null)return t;let s=n[1];return t.split(`
...
`,e=e.substring(h.length+1),u=!0),!u){let L=this.rules.other.nextBulletRegex(A),q=this.rules.other.hrRegex(A),Y=this.rules.other.fencesBeginRegex(A),Q=this.rules.other.headingBeginRegex(A),W=this.rules.other.htmlBeginRegex(A);for(;e;){let I=e.split(`
`,1)[0],S;if(h=I,this.options.pedantic?(h=h.replace(this.rules.other.listReplaceNesting,"  "),S=h):S=h.replace(this.rules.other.tabCharGlobal,"    "),Y.test(h)||Q.test(h)||W.test(h)||L.test(h)||q.test(h))break;if(S.search(this.rules.other.nonSpaceChar)>=A||!h.trim())p+=`
`+S.slice(A);else{if(R||f.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||Y.test(f)||Q.test(f)||q.test(f))break;p+=`
`+h}!R&&!h.trim()&&(R=!0),d+=I+`
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+br(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},Ur=new If;function it(e,t){return Ur.parse(e,t)}it.options=it.setOptions=function(e){return Ur.setOptions(e),it.defaults=Ur.defaults,Ml(it.defaults),it};it.getDefaults=Ho;it.defaults=Wr;it.use=function(...e){return Ur.use(...e),it.defaults=Ur.defaults,Ml(it.defaults),it};it.walkTokens=function(e,t){return Ur.walkTokens(e,t)};it.parseInline=Ur.parseInline;it.Parser=tr;it.parser=tr.parse;it.Renderer=Os;it.TextRenderer=Jo;it.Lexer=er;it.lexer=er.lex;it.Tokenizer=Ls;it.Hooks=Ln;it.parse=it;var nh=it.options,sh=it.setOptions,oh=it.use,ah=it.walkTokens,ih=it.parseInline;var lh=tr.parse,ch=er.lex;function Tr(e){let t=it.parse(e),r=Sl.sanitize(t);return El(r)}function hr(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
    ...
    </div>`}function U(){if(!i||!n)return[];let K=n.get(i);return Gl(K?K.lines:[])}function se(){if(!i||!n)return null;let K=n.get(i),j=K?K.last_event_at:null;return typeof j=="number"?j:null}function z(){return d.status==="running"}function M(){if(z()&&o){A||(A=setInterval(()=>ge(),1e3));return}Z()}function Z(){A&&(clearInterval(A),A=null)}function de(K){let j=[],oe=0;for(;oe<K.length;){let Le=K[oe];if(Le.kind==="tool"){let Ue=oe;for(;Ue<K.length&&K[Ue].kind==="tool"&&K[Ue].tool===Le.tool;)Ue+=1;if(Ue-oe>=Uf&&!h.has(oe)){j.push({kind:"group",idx:oe,tool:Le.tool||"",lines:K.slice(oe,Ue).map((Ve,Re)=>({idx:oe+Re,line:Ve}))}),oe=Ue;continue}}j.push({kind:"line",idx:oe,line:Le}),oe+=1}return j}function Ie(K){for(let j=K.length-1;j>=0;j-=1){let oe=K[j];if(oe.kind==="result"||oe.kind==="error")return null;if(oe.kind==="tool"&&!Object.hasOwn(oe,"result"))return oe}return null}function we(K){for(let j=K.length-1;j>=0;j-=1)if(K[j].kind==="thinking")return K[j];return null}function Ge(K,j){if(j.kind==="gate")return l`<div class="sv__gate">${j.text}</div>`;if(j.kind==="phase")return l`<div class="sv__phase">${j.text}</div>`;if(j.kind==="result")return l`<div
      ...
      >
        ...
        >
      </div>`;if(j.kind==="thinking"){let oe=f.has(K);return l`<div
      ...
      </div>`}if(j.kind==="error")return l`<div class="sv__error">⛔ ${j.text}</div>`;if(j.kind==="blocker")return l`<div class="sv__error">⛔ ${j.text}</div>`;if(j.kind==="tool"){let oe=f.has(K),Le=j.tool==="Bash"?Vf(j.command):0,Ue=j.tool==="Bash"?Le>1?Ns(j.command):j.command:j.path||j.command||"";return l`<div
      ...
      >
        ...
        ${oe?l`<pre class="sv__tool-expand">${at(j)}</pre>`:""}
      </div>`}return l`<div class="sv__as">${Tr(j.text||"")}</div>`}function at(K){let j=[];if(K.tool==="Bash"&&typeof K.command=="string"&&K.command.length>0)j.push(K.command);else if(K.input!==void 0)try{j.push(`input: ${JSON.stringify(K.input,null,2)}`)}catch{}return typeof K.output=="string"&&K.output.length>0&&j.push(`output:
${K.output}`),j.join(`

`)}function Fe(){if(!o)return l``;let K=U(),j=(a?[d.model,d.effort]:[d.runner,d.model,d.effort]).filter(Boolean).join(" \xB7 "),oe=d.session_id||"",Le=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${p?"ON":"OFF"}`,Ue=z(),Ve=Ue?Jf(se(),Date.now()):"",Re=Ue?Ie(K):null,lt=Ue?we(K):null,Ze=Qf(K);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
      ...
      ${a||u?"":k()}
      <div class="sv__body">
        ${K.length===0?l`<div class="sv__empty">세션 로그 없음</div>`:de(K).map(G=>G.kind==="group"?me(G):Ge(G.idx,G.line))}
      </div>
      ${Re||lt?l`<div class="sv__now">
            <span class="sv__now-label">지금</span>
            ${Re?l`<span class="sv__now-icon">${Re.icon}</span>
                  <span class="sv__now-name">${Re.tool}</span>
                  <span class="sv__now-detail"
                    >${Re.tool==="Bash"?Ns(Re.command):Re.path||Re.command||""}</span
                  >`:""}
    ...
    </div>`}function Pe(K){h.add(K),ge()}function ge(){Je(Fe(),e),M(),p&&$e()}function $e(){let K=e.querySelector(".sv__body");K&&(K.scrollTop=K.scrollHeight)}function Ce(K){f.has(K)?f.delete(K):f.add(K),ge()}function je(){p=!p,ge()}function xe(K){Xt(K).then(j=>{j?le("\uBCF5\uC0AC\uB428","success",1200):le("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function Be(K){!o||!K||(d={...d,...K},ge())}function Ye(K){let j=K.target;if(!j||!j.classList||!j.classList.contains("sv__body"))return;!(j.scrollHeight-j.scrollTop-j.clientHeight<=4)&&p&&(p=!1,ge())}e.addEventListener("scroll",Ye,!0);function Se(K){let j=K&&K.attempt_id;if(!j)return;let oe=i;o=j,a=typeof K.launch_id=="string"&&K.launch_id.length>0?K.launch_id:null,i=a?`session-log:${o}:${a}`:`session-log:${o}`,r&&oe&&oe!==i&&Promise.resolve(r("unsubscribe-session-log",{id:oe})).catch(()=>{}),d=K.meta||{},u=K.hide_prompt===!0,p=!0,f.clear(),h.clear(),I(),!R&&n&&(R=n.subscribe(ge)),r&&Promise.resolve(r("subscribe-session-log",{id:i,attempt_id:o,...a?{launch_id:a}:{}})).catch(()=>{}),ge()}function st(){let K=i;o=null,a=null,i=null,u=!1,f.clear(),h.clear(),I(),Z(),r&&K&&Promise.resolve(r("unsubscribe-session-log",{id:K})).catch(()=>{}),Je(l``,e),s&&s()}return{open:Se,updateMeta:Be,close:st,isOpen(){return o!==null},destroy(){Z(),R&&(R(),R=null),e.removeEventListener("scroll",Ye,!0),o=null,a=null,i=null,u=!1,Je(l``,e)}}}function Fs(e){let t=e&&typeof e=="object"?e:{},r=t.metadata&&typeof t.metadata=="object"?t.metadata:{},n=na(t.spec_id),s=na(r.spec_id);return n?{path:n,source:"native",conflict:s.length>0&&s!==n}:s?{path:s,source:"metadata",conflict:!1}:{path:"",source:"none",conflict:!1}}function na(e){return typeof e=="string"?e.trim():""}function Vl(e){let t=Fs(e);if(t.path)return t;let r=na(e_(e).spec_path);return r?{path:r,source:"draft",conflict:!1}:t}function e_(e){let t=e&&typeof e=="object"?e:{};return t.metadata&&typeof t.metadata=="object"?t.metadata:{}}function t_(e){return["plan_review","plan_approval","plan_check"].some(t=>{let r=e[t];return typeof r=="string"&&r.trim().length>0})}function r_(e){let t=e&&e.metadata||{},r=Vl(e),n=[];return r.path&&n.push({kind:"spec",path:r.path,missing_state:r.source==="draft"?"spec_draft":null}),typeof t.plan_path=="string"&&t.plan_path.trim().length>0&&n.push({kind:"plan",path:t.plan_path.trim(),missing_state:t_(t)?null:"plan_pending"}),n}function Kl(e,t){let r=r_(e);return l`
...
`).trim()}}var Yl=20;function Zl(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function a_(e){return e.length>Yl?`${e.slice(0,Yl)}\u2026`:e}function i_(e,t,r,n){let s=`${t.lane} ${a_(t.identifier)}`;return l`<div class="detail-report">
  ...
  >
    ...
    `:l``}function p(){Je(d(),e)}async function f(A,L={}){s=A,o="loading",a="",i="",p();let q=r?r():"";if(!q){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",i="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let Y="/api/doc?workspace="+encodeURIComponent(q)+"&path="+encodeURIComponent(A);try{let Q=await n(Y),W=await Q.json().catch(()=>({}));if(!Q.ok||!W||W.ok!==!0){if(W?.error==="not_found"&&L.missing_state==="plan_pending"){o="pending",i="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",p();return}o="error",i="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(W&&W.error||Q.status)+")",p();return}a=String(W.content||""),o="ready",p()}catch{o="error",i="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function h(){s=null,Je(l``,e)}function R(){document.removeEventListener("keydown",u),h()}return{open:f,close:h,destroy:R}}var w_=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],bc="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Ks=["implementation","review-consult"],k_=["running","done","failed","interrupted"],$_={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function x_(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function A_(e){let t=xt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
  ...
  `}function M_(e){let t=cn(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?hr("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var P_=["open","in_progress","deferred","resolved","closed"],D_=[0,1,2,3,4];function vc(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,u=t.sessionLogStore,d=null,p=null,f={},h="",R=!1,A=[],L=!1,q={},Y=!1,Q=!1,W="",I="",S="";function D(){Y=!1,Q=!1,W="",I="",S=""}let k=[],U=null,se=null,z=!1,M="",Z=!1,de=0,Ie=new Set;function we(){k=[],U=null,se=null,z=!1,M="",Z=!1,de+=1,Ie.clear()}async function Ge(m){if(!s)return;let O=++de;try{let T=await Promise.resolve(s("get-comments",{id:m}));if(O!==de||m!==d)return;k=Array.isArray(T)?T:[],z=!1}catch{if(O!==de||m!==d)return;z=!0}v()}function at(){if(!s||!d)return;let m=p&&typeof p.comment_count=="number"?p.comment_count:null;if(U!==d){U=d,se=m,Ge(d);return}m!==null&&m!==se&&(se=m,Ge(d))}function Fe(m){Ie.has(m)?Ie.delete(m):Ie.add(m),v()}function me(m){let O=M.trim().length===0;M=m,O!==(m.trim().length===0)&&v()}async function Pe(){let m=M.trim();if(!s||!d||m.length===0||Z)return;let O=d;Z=!0,v();let T=!1;try{let ne=await Promise.resolve(s("add-comment",{id:O,text:m}));Array.isArray(ne)&&ne.length>0&&(T=!0,O===d&&(k=ne,z=!1,M="",se=ne.length))}catch{T=!1}T||le("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),O===d&&(Z=!1),v()}let ge={onToggle:Fe,onDraftInput:me,onSubmit:Pe},$e=document.createElement("div");$e.className="md-viewer-root",document.body.appendChild($e);let Ce=mc($e,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),je=document.createElement("div");je.className="session-log-root",document.body.appendChild(je);let xe=qs(je,{transport:s?(m,O)=>Promise.resolve(s(m,O)):void 0,sessionLogStore:u}),Be=!1,Ye=!1,Se=!1,st=null,K=null,j=0;function oe(m){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${m}`}function Le(){Be=!1,Ye=!1,Se=!1,st=null,K=null,j+=1}async function Ue(m){if(!s)return;let O=++j;Ye=!0,Se=!1,v();try{let T=await Promise.resolve(s("get-bead-prompt",{bead_id:m}));if(O!==j)return;!T||typeof T!="object"||Array.isArray(T)?Se=!0:(st=T,K=oe(m))}catch{O===j&&(Se=!0)}finally{O===j&&(Ye=!1,v())}}function Ve(){if(Be=!Be,Be&&d&&K!==oe(d)){st=null,Ue(d);return}v()}function Re(){if(!a||!d)return[];let m=a.get();return(m&&m.attempts?Object.values(m.attempts):[]).filter(T=>T&&T.bead_id===d).sort((T,ne)=>(ne.started_at||0)-(T.started_at||0)).map(T=>({attempt_id:T.attempt_id,bead_id:T.bead_id,status:T.status,started_at:typeof T.started_at=="number"?T.started_at:null,runner:T.runner||null,model:T.model||null,effort:T.effort||T.observed_effort||null,speed:T.speed||null,session_id:T.session_id||null,resumed_from:T.resumed_from||null,continuation_mode:T.continuation_mode||null,dismissed_at:typeof T.dismissed_at=="number"?T.dismissed_at:null,cause:typeof T.cause=="string"?T.cause:null,cause_detail:T.cause_detail||null,exec_default_preset_id:typeof T.exec_default_preset_id=="string"?T.exec_default_preset_id:null,exec_default_preset_revision:typeof T.exec_default_preset_revision=="number"?T.exec_default_preset_revision:null,exec_values:T.exec_values&&typeof T.exec_values=="object"?T.exec_values:null,usage:T.usage||null,usage_legs:Array.isArray(T.usage_legs)?T.usage_legs:[],delegation_sessions:Array.isArray(T.delegation_sessions)?T.delegation_sessions:[]}))}function lt(){if(!a||!d)return null;let m=a.get();return Wt(m&&m.attempts||{},d)}let Ze=new Set;function G(m){Ze.has(m)?Ze.delete(m):Ze.add(m),v()}function te(m){let O=a?a.get():null,T=O&&O.attempts?O.attempts[m]:null;xe.open({attempt_id:m,meta:T?{runner:T.runner||void 0,model:T.model||void 0,effort:T.effort||void 0,status:T.status||void 0,session_id:T.session_id||void 0}:{}})}function Oe(m,O){let T=a?a.get():null,ne=T&&T.attempts?T.attempts[m]:null,Ke=(ne&&Array.isArray(ne.delegation_sessions)?ne.delegation_sessions:[]).find(Qe=>Qe&&typeof Qe=="object"&&Qe.launch_id===O);Ke&&xe.open({attempt_id:m,launch_id:O,meta:{runner:"codex",role:Ke.role,model:Ke.model,effort:Ke.effort,session_id:Ke.session_id,status:Ke.status}})}async function We(m){if(!s||!m)return;let O=await sn();if(O===null)return;let T=()=>{let Qe=a?a.get():null;return Qe&&typeof Qe.revision=="number"?Qe.revision:0},ne=async(Qe={},De=T())=>await s("worker-attempt-resume",{attempt_id:m,expected_revision:De,...O!==""?{instructions:O}:{},...Qe}),qe=Qe=>{Qe?.queue&&a?.set&&a.set(Qe.queue)},Ke=await ne();if(qe(Ke),Ke&&Ke.conflict){let Qe=Ke.queue&&typeof Ke.queue.revision=="number"?Ke.queue.revision:T();Ke=await ne({},Qe),qe(Ke)}Ke=await fr(Ke,(Qe,De)=>ne({continuation:Qe,decision_token:De}),{onResult:qe,refresh:()=>ne()}),Ke&&Ke.resumed===!1&&!Ke.conflict&&Ke.reason&&le(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${Ke.reason}`,"error",2400)}let pe={onOpen:te,onOpenDelegation:Oe,onResume:We,onToggleUsage:G};function g(){let m=a?a.get():null,O={...q};for(let T of["orchestration_model","orchestration_effort","orchestration_speed"]){let ne=m&&m[T];typeof ne=="string"&&(O[T]=ne)}return O}async function x(){if(s){try{let m=await Promise.resolve(s("get-session-defaults",{}));q=m&&m.values&&typeof m.values=="object"?m.values:{}}catch{q={}}v()}}function $(){let m=a?a.get():null;return m&&m.runner_catalog||null}function P(){let m=a?a.get():null;return m&&typeof m.execution_defaults=="object"?m.execution_defaults:null}function V(){let m=p?.metadata&&typeof p.metadata=="object"?p.metadata:{},T=nn({pin:{...m,...f},global:g(),execution_defaults:P(),runner_catalog:$(),route:typeof m.route=="string"?m.route:null}).orchestration_model.value||"";return la($(),T)}function X(){let m=i?i.get():null;return!m||typeof m.revision!="number"?null:{revision:m.revision,presets:Array.isArray(m.presets)?m.presets:[]}}function ae(m){return m?.compatible===!1}function ue(m){i&&m&&typeof m.revision=="number"&&Array.isArray(m.presets)&&i.set({revision:m.revision,presets:m.presets})}async function Ne(){let m=X(),O=m?.presets.find(T=>T.id===h);if(!(!s||!d||!m||!O||ae(O)||R)){R=!0,A=[],v();try{let T=await Promise.resolve(s("apply-impl-preset",lc(d,O.id,m.revision)));if(T&&T.conflict){ue(T),le("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let ne=T&&Array.isArray(T.issue)?T.issue[0]:T?.issue;if(T&&T.applied&&ne&&typeof ne=="object"){p=ne,A=Array.isArray(T.skipped_orchestration_keys)?T.skipped_orchestration_keys.filter(qe=>typeof qe=="string"):[];for(let qe of dc)delete f[qe];le(A.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}T&&T.error==="bd_readback_failed"?le("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):le("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(T){T&&typeof T=="object"&&T.code==="bd_readback_failed"?le("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):le("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{R=!1,v()}}}let ve=null;r&&r.subscribe&&(ve=r.subscribe(()=>tt()));let Ee=null;a&&typeof a.subscribe=="function"&&(Ee=a.subscribe(()=>{d&&v()}));let be=null;i&&typeof i.subscribe=="function"&&(be=i.subscribe(()=>{d&&v()}));function ze(m){m.key==="Escape"&&d&&(m.preventDefault(),n())}document.addEventListener("keydown",ze);function tt(){if(d){if(r&&typeof r.snapshotFor=="function"){let m=r.snapshotFor("detail:"+d)||[];p=m.find(T=>T&&T.id===d)||m[0]||p}at(),v()}}function B(m){Xt(m).then(O=>{O?le("\uBCF5\uC0AC\uB428","success",1200):le("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function re(m){m.preventDefault(),m.stopPropagation(),d&&B(d)}function _e(m,O){m.preventDefault(),m.stopPropagation(),B(O)}function w(m,O,T){m.preventDefault(),m.stopPropagation(),Ce.open(O,{missing_state:T})}function C(m,O){f[m]=O,v(),!(!s||!d)&&Promise.resolve(s("update-exec-settings",ic(d,m,O.length===0?null:O))).catch(()=>{le("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function N(m,O){let T=p||{},ne=T.metadata&&typeof T.metadata=="object"?T.metadata:{},qe={};for(let De of["impl_runtime","impl_model","impl_effort"])qe[De]=Object.hasOwn(f,De)?f[De]:typeof ne[De]=="string"?ne[De]:"";qe[m]=O;let Ke=_c(qe,$(),V()),Qe={};for(let De of["impl_runtime","impl_model","impl_effort"])Qe[De]=f[De],f[De]=Ke[De]||"";v(),!(!s||!d)&&Promise.resolve(s("update-impl-target",{id:d,...Ke,orchestration_runtime:V()})).then(De=>{let mt=Array.isArray(De)?De[0]:De;if(!mt||typeof mt!="object"||!mt.id)throw new Error("implementation target readback failed");p=mt;for(let sr of["impl_runtime","impl_model","impl_effort"])delete f[sr];v()}).catch(()=>{for(let De of["impl_runtime","impl_model","impl_effort"])Qe[De]===void 0?delete f[De]:f[De]=Qe[De];v(),le("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function ee(m,O,T){if(!s||!d)return!1;try{let ne=await Promise.resolve(s(m,O)),qe=Array.isArray(ne)?ne[0]:ne;return qe&&typeof qe=="object"&&qe.id?(p=qe,!0):(le(T,"error"),!1)}catch{return le(T,"error"),!1}}function ke(m){setTimeout(()=>{try{let O=e.querySelector(m);O&&typeof O.focus=="function"&&O.focus()}catch{}},0)}function J(){Y=!0,W=p&&p.title||"",v(),ke('.detail-edit__input[data-edit="title"]')}function Ae(m){W=m.target.value}function Te(){Y=!1,W="",v()}function ft(){ee("edit-text",{id:d,field:"title",value:W},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(O=>{O&&(Y=!1,W=""),v()})}function Et(){Q=!0,I=p&&p.description||"",v(),ke('.detail-edit__textarea[data-edit="description"]')}function rt(m){I=m.target.value}function yt(){Q=!1,I="",v()}function ur(){ee("edit-text",{id:d,field:"description",value:I},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(O=>{O&&(Q=!1,I=""),v()})}function vt(m,O,T,ne){if(m.key==="Escape"){m.stopPropagation(),T();return}m.key==="Enter"&&(!ne||m.ctrlKey||m.metaKey)&&(m.preventDefault(),O())}function Tt(m){let O=m.target.value;ee("update-status",{id:d,status:O},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>v())}function dr(m){let O=Number(m.target.value);ee("update-priority",{id:d,priority:O},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>v())}function wr(m){S=m.target.value}function jt(){let m=S.trim();m.length!==0&&ee("label-add",{id:d,label:m},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(O=>{O&&(S=""),v()})}function Ht(m){if(m.key==="Escape"){m.stopPropagation(),S="",v();return}m.key==="Enter"&&(m.preventDefault(),jt())}function wt(m){ee("label-remove",{id:d,label:m},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>v())}let nr={onCopyPath:_e,onOpenDoc:w};function nt(m){return typeof m=="string"?m:m&&typeof m=="object"?String(m.id||m.to||m.issue_id||m.depends_on||""):""}function Mt(m){switch(m&&typeof m=="object"?String(m.dependency_type||m.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function kr(m){let T=(Array.isArray(m.dependencies)?m.dependencies:[]).map(ne=>({id:nt(ne),icon:Mt(ne)})).filter(ne=>ne.id.length>0);return l`
    ...
    `}function Gt(m){let O=m.metadata||{},T=m.workflow||{},ne=T.stages||{},qe=ne.spec&&ne.spec.stale,Ke=ne.impl&&ne.impl.stale,Qe=ne.plan||null,De=T.route_source==="derived",mt=T.route||O.route||"\u2014";return l`
    ...
    `}let he={route:["quick_fix","spec_backed","full_plan"]};async function c(m,O){let T=O.target.value;if(m==="route"&&p&&p.metadata&&p.metadata.route==="full_plan"&&T!=="full_plan"&&!window.confirm(`full_plan \u2192 ${T||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){v();return}await ee("update-workflow-meta",{id:d,key:m,value:T},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),v()}function _(m){let O=m.metadata||{};return l` ${((ne,qe)=>{let Ke=he[ne],Qe=typeof O[ne]=="string"?O[ne]:"";return l`<div class="detail-kv">
        ...
        >
          ...
          ${Ke.map(De=>l`<option value=${De} ?selected=${Qe===De}>${De}</option>`)}
        </select>
    ...
    `}function fe(m){let O=typeof m.notes=="string"?m.notes:"";return O.trim().length===0?l``:l`
      <div class="detail-overlay__section-label">노트</div>
      <div class="detail-overlay__notes">${O}</div>
    `}function Xe(m){let O=Array.isArray(m.labels)?m.labels:[];return l`
    ...
    `}function y(){if(!d)return l``;let m=p||{},O=String(m.id||d),T=m.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",ne=lt(),qe=m.status||"open",Ke=typeof m.priority=="number"?Math.max(0,Math.min(4,m.priority)):"",Qe=m.description||"",De={...m,metadata:{...m.metadata||{},...f}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${E(T,ne)}
          ${uc(De)}
          ${cc({metadata:De.metadata,workspace_values:g(),catalog:$(),execution_defaults:P(),expanded:L,presets:X()?.presets||[],preset_id:h,preset_busy:R,skipped_orchestration_keys:A},{onToggle:mt=>{L=mt,v()},onEdit:(mt,sr)=>{if(mt==="impl_runtime"||mt==="impl_model"||mt==="impl_effort"){N(mt,sr??"");return}C(mt,sr??"")},onPresetSelect:mt=>{h=mt,A=[],v()},onPresetApply:()=>{Ne()}})}
          ${ie(qe,Ke)} ${H(m)}
          ${ye(Qe)}
          ${Xl(k,ge,{expanded:Ie,draft:M,sending:Z,error:z})}
          ${fe(m)} ${Xe(m)} ${kr(m)}
          ${Gt(m)} ${_(m)}
          ${Kl(m,nr)}
          ${yc({expanded:Be,loading:Ye,error:Se,data:st},{onToggle:Ve})}
          ${hc(Re(),pe,{total:ne,expanded:Ze})}
        </div>
      </div>
    `}function v(){Je(y(),e)}return{load(m){m!==d&&(f={},h="",A=[],L=!1,D(),we(),Le()),d=m,p=null,tt(),x()},clear(){d=null,p=null,f={},h="",R=!1,A=[],L=!1,D(),we(),Le(),Ce.close(),xe.close(),Je(l``,e)},destroy(){ve&&(ve(),ve=null),Ee&&(Ee(),Ee=null),be&&(be(),be=null),document.removeEventListener("keydown",ze),Ce.destroy(),$e.parentNode&&$e.parentNode.removeChild($e),xe.destroy(),je.parentNode&&je.parentNode.removeChild(je),d=null,p=null,h="",R=!1,A=[],we(),Le(),Je(l``,e)}}}function wc(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
  ...
  >`,A=l`<span class="worker-mini__title">${e.title}</span>`,L=e.pr_url&&e.pr_number?l`<a
        ...
        >`:"",Y=r.map(we=>we===e.live_badge?l`<span
        ...
        >`:l`<span
          ...
          >${we}</span
        >`),Q=e.reason?l`<span class="worker-mini__reason">${e.reason}</span>`:"",W=n.length>0?n.map(we=>l`<span class="worker-usage" title=${we.tooltip}
              >${we.label}</span
      ...
      >
        저장소 작업 보기
      </button>`:"",U=e.discard,se=U?.action||e.discard_action?l`<button
          type="button"
        ...
        >
          ${U?.label||"\uD3D0\uAE30"}
        </button>`:"",z=e.stale_work||null,M=z?l`${z.can_resume||z.can_continue?l`<button
            type="button"
          ...
          >
            다시 확인
          </button>`:""}`:"",Z=z?l`<div class="worker-mini__stale">
        ...
        >
          승인하고 진행
        </button>`:"",Ie=!!(s||o||e.merge_action||e.cancel_action||e.timeline_action||e.discard_action||U?.operation||e.revise_action||z);return l`<div
  ...
  >
    ${i?l`<div class="worker-mini__row1">${h}${R}${A}</div>
          <div class="worker-mini__row2">
            ...
            <div class="worker-mini__body">${A}${Z}</div>
            ${Ie?l`<div class="worker-mini__foot">
                  ${W}${I}
                  <span class="worker-mini__actions"
                    >${S}${D}${k}${se}${de}${M}</span
                  >
            ...
            ${dn(e)}`:l`<div class="worker-mini__line">
              ${d}${p}${h}${R}${A}${L}${q}${Y}${f}${Q}${W}${I}${S}${D}${k}${se}
            </div>
            ${vr(e)} ${dn(e)}`}
  ...
  >
    ...
    <path d="M8.8 3.6 14 8l-5.2 4.4z" />`)}var Wn=1,em=6e4,tm={auto_merge:"\uC790\uB3D9 \uBA38\uC9C0",merged:"\uBA38\uC9C0",merge:"\uBA38\uC9C0",pr_stop:"PR \uC911\uB2E8",stopped:"\uC911\uB2E8",failed:"\uC2E4\uD328"},rm=new Set(["auto_merge","merged","merge","done"]),zc={running:3,paused:2,failed:1};function nm(e,t){let r=null,n=-1/0;for(let s of Object.values(e)){if(!s||s.bead_id!==t||s.status==="running")continue;let o=typeof s.finished_at=="number"?s.finished_at:typeof s.started_at=="number"?s.started_at:0;o>=n&&(n=o,r=s)}return r}function sm(e,t){let r=Object.values(e||{}),n=new Set,s=new Map;for(let a of r)!a||typeof a.bead_id!="string"||(typeof a.resumed_from=="string"&&a.resumed_from.length>0&&n.add(a.resumed_from),s.set(a.bead_id,a.attempt_id));let o=new Map;for(let a of r){if(!a||typeof a.bead_id!="string"||a.bead_id.length===0)continue;let i=null;if(a.status==="running")i="running";else if(a.status==="paused"&&!n.has(a.attempt_id))i="paused";else if(a.status==="failed"||a.status==="orphaned"){let f=t.get(a.bead_id),h=typeof f=="number"&&f>0&&typeof a.finished_at=="number"&&f>=a.finished_at;s.get(a.bead_id)===a.attempt_id&&!h&&typeof a.dismissed_at!="number"&&(i="failed")}if(!i)continue;let u=typeof a.started_at=="number"?a.started_at:null,d=o.get(a.bead_id);if(d){let f=zc[d.run_state],h=zc[i];if(f>h||f===h&&(d.started_at??0)>(u??0))continue}let p=typeof a.session_id=="string"&&a.session_id.length>0;o.set(a.bead_id,{attempt_id:typeof a.attempt_id=="string"?a.attempt_id:"",run_state:i,started_at:u,last_event_at:typeof a.last_event_at=="number"?a.last_event_at:null,runner:typeof a.runner=="string"?a.runner:null,model:typeof a.model=="string"?a.model:null,effort:typeof a.effort=="string"?a.effort:null,speed:typeof a.speed=="string"?a.speed:null,resumed_from:typeof a.resumed_from=="string"?a.resumed_from:null,continuation_mode:a.continuation_mode==="session"||a.continuation_mode==="fresh"?a.continuation_mode:null,usage:Wt(e,a.bead_id),can_pause:i==="running"&&p,can_resume:i!=="running"&&p&&!n.has(a.attempt_id)})}return o}function Hc(e,t){let r=e[t];if(!r)return"";if(r.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let n=typeof r.reason=="string"?r.reason:"",s=n.indexOf(":");return s>0&&s<n.length-1?`\u26D4 ${n.slice(0,s)} (${n.slice(s+1)})`:`\u26D4 ${n}`}function At(e){return e&&typeof e=="object"?e:{}}function ka(e,t,r){let n=Array.isArray(e)?e:[],s=Array.isArray(t)?t:[],o=r&&typeof r.done_since=="number"?r.done_since:void 0,a=new Map;for(let k of s)k&&typeof k.root_dir=="string"&&a.set(k.root_dir,k);let i=[],u=[],d=[],p=[],f=[],h=[],R=new Map,A=new Map,L=new Map;for(let k of n){if(!k||typeof k.root_dir!="string")continue;let U=k.root_dir,se=k.name||U,z=a.get(U),M=z&&typeof z.revision=="number"?z.revision:typeof k.revision=="number"?k.revision:0,Z=At(k.attempts),de=At(k.bead_titles),Ie=At(k.pr_observations),we=At(k.admission),Ge=At(k.revise_parked),at=At(k.merge_queue_state),Fe=At(k.cleanup_failed),me=At(k.discard_operations),Pe=At(k.bead_blocked_by),ge=At(k.pr_activity),$e=Array.isArray(k.repo_operations)?k.repo_operations:[],Ce=Array.isArray(k.merge_queue)?k.merge_queue:[],je=new Set(Ce.filter(G=>G&&typeof G.bead_id=="string").map(G=>G.bead_id)),xe=new Map(Ce.filter(G=>G&&typeof G.bead_id=="string").map(G=>[G.bead_id,G])),Be=Array.isArray(k.queue)?k.queue:[],Ye=(Array.isArray(k.serial_lanes)?k.serial_lanes:[]).filter(G=>G&&/^s[1-5]$/.test(G.id)&&Array.isArray(G.entries)),Se=At(k.lane_states),st=typeof k.serial_lane_count=="number"?Math.max(0,Math.min(5,Math.floor(k.serial_lane_count))):Math.min(5,Ye.length);L.set(U,st);let K=new Map(Ye.map(G=>[G.id,G])),j=new Map;for(let G of Ye)for(let te of G.entries)te&&typeof te.bead_id=="string"&&j.set(te.bead_id,G.id);let oe=Array.isArray(k.done)?k.done:[];for(let G of oe)G&&typeof G.bead_id=="string"&&h.push({id:G.bead_id,root_dir:U,workspace_name:se});let Le=new Map;for(let G of oe)G&&typeof G.bead_id=="string"&&typeof G.added_at=="number"&&Le.set(G.bead_id,G.added_at);let Ue=G=>({id:G,title:de[G]||G,root_dir:U,workspace_name:se,expected_revision:M,draggable:!1}),Ve=new Set;for(let[G,te]of sm(Z,Le))Ve.add(G),u.push({...Ue(G),lane:"running",...j.has(G)?{serial_lane_id:j.get(G)}:{},attempt_id:te.attempt_id,run_state:te.run_state,can_pause:te.can_pause,can_resume:te.can_resume,started_at:te.started_at,last_event_at:te.last_event_at,runner:te.runner,model:te.model,effort:te.effort,speed:te.speed,resumed_from:te.resumed_from,continuation_mode:te.continuation_mode,usage:te.usage,discard:cr(me,G,{attempt_id:te.attempt_id}),badges:te.run_state==="paused"?["\u23F8 \uC77C\uC2DC\uC815\uC9C0"]:te.run_state==="failed"?["\u26A0 \uC2E4\uD328"]:[],alert:te.run_state==="failed"});for(let G of Array.isArray(k.pr_wait)?k.pr_wait:[]){let te=G&&G.bead_id;if(typeof te!="string"||Ve.has(te))continue;Ve.add(te);let Oe=At(Ie[te]),We=At(Oe.pr),pe=Oe.gate?At(Oe.gate):null,g=je.has(te),x=xe.get(te)?.continuation_action||null,$=!!x&&x.continuation===null,P=at.active===te,V=G.external===!0,X=Fe[te]||null,ae=At(ge[te]),ue=Un({bead_id:te,merge_sha:G.merge_sha,cleanup_cursor:G.cleanup_cursor,merge_progress:ae.merge_progress||null,cleanup_failed:X,repo_operations:$e}),Ne=to(ue),ve=!!pe&&pe.base_badge==="\uCDA9\uB3CC",Ee=!!X&&["child_sweep","branch_cleanup","parent_close"].includes(X.step)&&!!pe&&pe.tier==="merged",be=V&&!!X&&!!pe&&pe.tier==="merged",ze=!!pe&&["closed_unmerged","review","undecidable"].includes(pe.tier),tt=cr(me,te,{external:V,merge_active:P||ue?.step==="merge",merge_queued:g,cleanup_active:Ne,merged:!!X||pe?.tier==="merged"}),B=!!tt.operation;d.push({...Ue(te),lane:"pr_wait",pr_number:typeof We.number=="number"?We.number:null,pr_url:typeof We.url=="string"?We.url:void 0,external:V,usage:Wt(Z,te),merge_step:ue,badges:$?["\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694"]:ue?[pe?.tier==="merged"?"\uBA38\uC9C0\uB428":"\uBA38\uC9C0 \uC911"]:X?[Hr(X.step)?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${Hr(X.step)}`:"\uC815\uB9AC \uBA48\uCDA4"]:typeof pe?.gate_badge=="string"&&pe.gate_badge.length>0?[pe.gate_badge]:[],alert:ue?ue.failed===!0:!!X||ze,reason:X&&ue?.active!==!0?eo(X.step):"PR \uB300\uAE30",merge_action:pe?.tier==="merged"&&!Ee&&!be?!1:!g||$,merge_enabled:!B&&($||pe?.enabled===!0||ve||Ee||be),merge_label:$?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":be||Ee?"\uC815\uB9AC \uC7AC\uAC1C":ve&&!Ee?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:$?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":B?tt.error?`\uD3D0\uAE30 \uC2E4\uD328: ${tt.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${tt.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:be?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Ee?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":ve?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":pe?.enabled===!0?`\uBA38\uC9C0 (${pe.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4`:`\uBA38\uC9C0 \uBD88\uAC00: ${pe?.reason||"\uAD00\uCE21 \uB300\uAE30"}`,cancel_action:g&&!$,cancel_enabled:!P,continuation_mismatch:x?.mismatch||null,discard:tt,discard_action:tt.action,discard_enabled:tt.enabled,discard_title:tt.title})}let Re=(G,te,Oe,We)=>{let pe=G&&G.bead_id;if(typeof pe!="string"||Ve.has(pe))return null;Ve.add(pe);let g=Ge[pe],x=cr(me,pe),$=x.operation?x:null,P={...Ue(pe),lane:te,draggable:!$,discard:$||void 0,reason:Hc(we,pe),queue_position:Oe+1,queue_index:Oe,queue_length:We,badges:g?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!g,revise_action:!!g,revise_enabled:!!g&&!$,revise_title:g?g.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${g.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(Pe,pe)&&(P.blocked_by=Array.isArray(Pe[pe])?Pe[pe].filter(V=>typeof V=="string"&&V.length>0):[]),P};for(let G=0;G<Be.length;G++){let te=Re(Be[G],"queue",G,Be.length);if(!te)continue;p.push(te);let Oe=R.get(U);Oe?Oe.push(te):R.set(U,[te])}let lt=[];for(let G=0;G<Ye.length;G++){let te=Ye[G],Oe=[];for(let pe=0;pe<te.entries.length;pe++){let g=Re(te.entries[pe],te.id,pe,te.entries.length);g&&(Oe.push(g),p.push(g))}if(Oe.length===0)continue;let We=At(Se[te.id]);lt.push({id:te.id,index:G,items:Oe,occupied_by:Array.isArray(We.occupied_by)?We.occupied_by.filter(pe=>typeof pe=="string"):[],corrections:Array.isArray(We.corrections)?We.corrections.length:0,cycle:We.cycle===!0})}A.set(U,lt);let Ze=Array.from({length:st},(G,te)=>{let Oe=`s${te+1}`,We=K.get(Oe),pe=We&&Array.isArray(We.entries)?We.entries:[],g=At(Se[Oe]);return{id:Oe,index:pe.length,length:pe.length,occupied_by:Array.isArray(g.occupied_by)?g.occupied_by.filter(x=>typeof x=="string"):[]}});for(let G of Array.isArray(k.runnable)?k.runnable:[]){let te=G&&G.bead_id;typeof te!="string"||Ve.has(te)||(Ve.add(te),i.push({...Ue(te),title:G.title||de[te]||te,lane:"runnable",draggable:!0,reason:Hc(we,te),created_at:G.created_at??void 0,updated_at:G.updated_at??void 0,labels:Array.isArray(G.labels)?G.labels:[],spec_reviewer:typeof G.spec_reviewer=="string"?G.spec_reviewer:void 0,plan_state:G.plan_state==="approved"||G.plan_state==="authored"?G.plan_state:"none",workflow:G.route?{route:G.route,chips:{route:G.route}}:null,blocked:G.blocked===!0,...Array.isArray(G.blocked_by)?{blocked_by:G.blocked_by.filter(Oe=>typeof Oe=="string"&&Oe.length>0)}:{},place_index:Be.length,place_lanes:Ze}))}for(let G of oe){let te=G&&G.bead_id;if(typeof te!="string"||Ve.has(te)||(Ve.add(te),o!==void 0&&typeof G.added_at=="number"&&G.added_at<o))continue;let Oe=nm(Z,te);f.push({...Ue(te),lane:"done",done:!0,usage:Wt(Z,te),done_at:typeof G.added_at=="number"?G.added_at:void 0,done_kind:Oe&&typeof Oe.done_kind=="string"?Oe.done_kind:null})}}let q=new Map;s.forEach((k,U)=>{k&&typeof k.root_dir=="string"&&q.set(k.root_dir,U)});let Y=r&&r.running_sort==="repo"?"repo":"started";u.sort((k,U)=>{if(Y==="repo"){let M=q.get(k.root_dir)??Number.MAX_SAFE_INTEGER,Z=q.get(U.root_dir)??Number.MAX_SAFE_INTEGER;if(M!==Z)return M-Z}let se=typeof k.started_at=="number"&&Number.isFinite(k.started_at)?k.started_at:null,z=typeof U.started_at=="number"&&Number.isFinite(U.started_at)?U.started_at:null;return se!==null&&z!==null&&se!==z?se-z:se===null&&z!==null?1:se!==null&&z===null?-1:k.id.localeCompare(U.id)}),f.sort((k,U)=>(U.done_at??0)-(k.done_at??0));let Q=s.length>0?s:n.map(k=>({root_dir:k&&k.root_dir,name:k&&k.name,auto_advance:k&&k.auto_advance,auto_merge:k&&k.auto_merge,slots:k&&k.slots,revision:k&&k.revision,runner_catalog:k&&k.runner_catalog})),W=[];for(let k of Q){if(!k||typeof k.root_dir!="string")continue;let U=R.get(k.root_dir)||[],se=A.get(k.root_dir)||[];W.push({root_dir:k.root_dir,name:k.name||k.root_dir,auto_advance:k.auto_advance===!0,auto_merge:k.auto_merge===!0,slots:typeof k.slots=="number"&&k.slots>=Wn?k.slots:Wn,revision:typeof k.revision=="number"?k.revision:0,runner_catalog:At(k.runner_catalog),items:U,sublanes:{parallel:U,serial:se},serial_lane_count:L.get(k.root_dir)||0})}let I={runnable:i,queue:p,queue_groups:W,running:u,pr_wait:d,done:f,automation:{total:W.length,both_on:W.filter(k=>k.auto_advance&&k.auto_merge).length}},S=fa(I);for(let k of h)S.has(k.id)||S.set(k.id,{root_dir:k.root_dir,workspace_name:k.workspace_name,lane:"done",state:"done"});for(let k of[...I.queue,...I.runnable]){if(!Object.hasOwn(k,"blocked_by"))continue;let U=S.get(k.id);k.blockers=(k.blocked_by||[]).map(se=>Sc(se,U,S,s)),k.blocker_warnings=k.blockers.filter(se=>se.missing_internal).map(se=>`\u26A0 \uC120\uD589 ${se.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),k.blocker_warnings.length>0&&(k.alert=!0)}let D=Ec(I.queue_groups);for(let k of I.queue_groups)for(let U of k.sublanes.serial){let se=D.get(Cc(k.root_dir,U.id));se&&(U.cross_wait_peers=se)}return I}function om(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<em;return l`<span
  ...
  >
    ...
    ${r?e.sublanes.serial.map(s=>l`<section
  ...
  </div>`}function su(e,t){let r=_t("views:monitor"),n=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.switchWorkspace,u=t.now||(()=>Date.now()),d=t.confirm||(g=>typeof globalThis.confirm!="function"||globalThis.confirm(g)),p=mm(),f=bm(),h=pm();function R(){let g=or.find(x=>x.value===p);return g?g.label:""}let A=document.createElement("div");A.className="mon",e.appendChild(A);let L=ka(null,null),q=new Map,Y=null,Q=null;async function W(g,x,$,P,V=!0){if(!o||!$)return null;let X=await o(g,{...x,root_dir:$,expected_revision:P});if(X&&X.conflict&&V){X.queue&&q.set($,X.queue);let ae=X.queue&&typeof X.queue.revision=="number"?X.queue.revision:P;X=await o(g,{...x,root_dir:$,expected_revision:ae})}return X&&X.queue&&$&&q.set($,X.queue),X}function I(g,x){let $=q.get(g),P=s&&s.get?s.get():null,V=(Array.isArray(P)?P:[]).find(ae=>ae?.root_dir===g);return($||V)?.merge_queue?.find(ae=>ae.bead_id===x)?.continuation_action}async function S(g,x,$,P){let V=await W(g,x,$,P),X=q.get($)?.revision??V?.queue?.revision??P;return fr(V,(ae,ue)=>W(g,{...x,continuation:ae,decision_token:ue},$,X,!1),{refresh:ae=>W(g,x,$,ae?.queue?.revision??q.get($)?.revision??X,!1)})}async function D(g,x,$,P){let V=await fr({continuation_mismatch:P},(ae,ue)=>W("worker-merge-queue-add",{bead_id:x,continuation:ae,decision_token:ue},g,$,!1)),X=V?.queue?.merge_queue?.find(ae=>ae.bead_id===x)?.continuation_action;V?.applied!==!0&&X?.continuation===null&&X.mismatch&&await D(g,x,V.queue.revision,X.mismatch)}async function k(g,x,$){let P=await W("worker-discard",g,x,$);if(P&&P.discarded===!0){le(Qs(P),"success",5e3);return}if(P&&P.reason){le(`\uD3D0\uAE30 \uC2E4\uD328: ${P.reason}`,"error");return}if(P&&P.accepted&&P.pending==="merged_revert"){le("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(P&&P.accepted){le(`\uD3D0\uAE30 \uC9C4\uD589: ${P.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}P&&!P.conflict&&le("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function U(g,x,$){return!o||!$?null:await o(g,{...x,root_dir:$})}async function se(g){if(!o||!g&&!d("\uC804 \uB808\uD3EC\uC758 \uC790\uB3D9 \uC9C4\uD589\xB7\uC790\uB3D9 \uBA38\uC9C0\uB97C \uB055\uB2C8\uB2E4. \uAC01 \uB808\uD3EC\uC758 \uBA38\uC9C0 \uB300\uAE30\uC5F4\uB3C4 \uD568\uAED8 \uBE44\uC6CC\uC9D1\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?"))return;let x=await o("monitor-auto-toggle",{on:g}),$=x&&Array.isArray(x.failed)?x.failed:[];$.length>0&&le(`\uC790\uB3D9\uD654 ${g?"\uCF1C\uAE30":"\uB044\uAE30"} \uC77C\uBD80 \uC2E4\uD328: ${$.map(P=>P.root_dir).join(", ")}`,"error",3200)}async function z(){let g=new Map;for(let x of L.pr_wait)g.has(x.root_dir)||g.set(x.root_dir,x.expected_revision);for(let[x,$]of g)await W("worker-merge-queue-add-all",{},x,$)}let M=null,Z=!1,de=null;function Ie(){de!==null&&clearTimeout(de),de=setTimeout(()=>{de=null,Z=!1},0)}function we(g){let x=g.target;return typeof x?.closest=="function"?x.closest(".mon-group"):null}function Ge(g){let x=we(g);return!x||!M?null:(x.getAttribute("data-root-dir")||"")===M.root_dir?x:null}function at(){for(let g of Array.from(A.querySelectorAll(".mon-group--drag-over")))g.classList.remove("mon-group--drag-over")}function Fe(g){let x=g.target,$=typeof x?.closest=="function"?x.closest('.mon-card[draggable="true"]'):null;if($){M={bead_id:$.getAttribute("data-issue-id")||"",lane:$.getAttribute("data-lane")||"",root_dir:$.getAttribute("data-root-dir")||"",revision:Number($.getAttribute("data-revision")||0)||0,queue_index:Number($.getAttribute("data-queue-index")),queue_length:Number($.getAttribute("data-queue-length")),place_index:Number($.getAttribute("data-place-index"))},Z=!0;try{g.dataTransfer?.setData("text/plain",M.bead_id),g.dataTransfer&&(g.dataTransfer.effectAllowed="move")}catch{}}}function me(g){let x=Ge(g);x&&(g.preventDefault(),g.dataTransfer&&(g.dataTransfer.dropEffect="move"),x.classList.add("mon-group--drag-over"))}function Pe(g){we(g)?.classList.remove("mon-group--drag-over")}function ge(){M=null,at(),Ie()}function $e(g){let x=Ge(g),$=M;if(M=null,at(),!x||!$||!$.bead_id)return;g.preventDefault();let P=g.target,V=typeof P?.closest=="function"?P.closest('.mon-card[data-lane="queue"]'):null,X=V&&x.contains(V)?Number(V.getAttribute("data-queue-index")):NaN;if($.lane==="runnable"){let Ne=Number.isFinite(X)?X:$.place_index;if(!Number.isFinite(Ne))return;W("worker-queue-place",{bead_id:$.bead_id,index:Ne},$.root_dir,$.revision);return}if($.lane!=="queue"||V&&V.getAttribute("data-issue-id")===$.bead_id)return;let ae=$.queue_index,ue=Number.isFinite(X)?ae>X?X:X-1:$.queue_length-1;!Number.isFinite(ue)||ue<0||ue===ae||W("worker-queue-reorder",{bead_id:$.bead_id,to_index:ue},$.root_dir,$.revision)}function Ce(g){let x=_m(L.runnable,h),$={runnable:x.visible,queue:L.queue,running:L.running,pr_wait:L.pr_wait,done:L.done};return l`${Xc({automation:L.automation,counts:{running:L.running.length,queue:L.queue.length,pr_wait:L.pr_wait.length},running_sort:f,done_range:p,token_total:Jc(L.done),token_tooltip:Qc(R())})}
      <div class="worker-lanes mon-lanes">
        ${vm.map(P=>{let V=$[P.lane],X=P.lane==="queue"?L.queue_groups.length>0?l`${L.queue_groups.map(ae=>wm(ae,g))}`:void 0:V.length>0?l`${V.map(ae=>so(ae,g))}`:void 0;return rr({id:`monitor-${P.lane}`,lane:P.pane,title:P.lane==="done"?`\uC644\uB8CC\xB7${R()}`:P.title,items:V,empty:P.empty,body:X,live:P.lane==="running"&&V.length>0,header_control:P.lane==="runnable"?l`<span class="mon-candidate-filter">
                    <label
      ...
      </div>`}function je(){let g=s&&s.get?s.get():null,x=s&&s.getWorkspacesState?s.getWorkspacesState():[],$=u();L=ka(g,x,{done_since:Nr(p,$),running_sort:f}),Je(Ce($),A)}function xe(g,x){let $=a?a():void 0;if(!x||!$||x===$||!i){n(g);return}i(x).then(()=>{n(g)}).catch(P=>{r("workspace switch for %s failed: %o",x,P)})}function Be(g){return{root_dir:g.getAttribute("data-root-dir")||"",revision:Number(g.getAttribute("data-revision")||0)||0}}function Ye(g){if(typeof g=="string"&&g.length>0)return g;if(g&&typeof g=="object"){let x=g;if(typeof x.message=="string"&&x.message.length>0)return x.message;if(typeof x.error=="string"&&x.error.length>0)return x.error;if(x.error&&typeof x.error=="object"&&typeof x.error.message=="string")return x.error.message}return"\uC5F0\uACB0\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4"}function Se(g,x){let $=g.querySelector(".mon-link__trigger"),P=g.querySelector(".mon-link__popover"),V=g.querySelector(".mon-link__error");!$||!P||!V||(Le(),P.hidden=!1,$.setAttribute("aria-expanded","true"),V.textContent=x,V.hidden=!1)}async function st(g,x,$){let P=x.getAttribute("data-root-dir")||"",V=x.getAttribute("data-issue-id")||"";if(!(!V||!$||$===V))try{await U(g,{a:V,b:$},P),Le()}catch(X){Se(x,Ye(X))}}function K(g,x){let{root_dir:$,revision:P}=Be(g),V=g.getAttribute("data-issue-id")||"",X=x.dataset.attemptId||g.getAttribute("data-attempt-id")||"",ae=x.classList;if(ae.contains("mon-link__trigger")){Ve(x);return}if(ae.contains("mon-link__candidate")||ae.contains("mon-link__direct")){let ue=x.dataset.targetId||"";st("dep-add",g,ue);return}if(ae.contains("mon-blocker__remove")){let ue=x.dataset.blockerId||"";st("dep-remove",g,ue);return}if(ae.contains("mon-place__choice")){let ue=x.dataset.lane||"parallel",Ne=Number(x.dataset.placeIndex||0)||0;Le(),W("worker-queue-place",{bead_id:V,...ue==="parallel"?{}:{lane:ue},index:Ne},$,P);return}if(ae.contains("worker-card__place")){Ue(x);return}if(ae.contains("mon-op--up")||ae.contains("mon-op--down")){let ue=Number(g.getAttribute("data-queue-index")||0)||0,Ne=ae.contains("mon-op--up")?ue-1:ue+1;if(Ne<0)return;W("worker-queue-reorder",{bead_id:V,.../^s[1-5]$/.test(g.dataset.lane||"")?{lane:g.dataset.lane}:{},to_index:Ne},$,P);return}if(ae.contains("mon-op--remove")){W("worker-queue-remove",{bead_id:V},$,P);return}if(ae.contains("mon-op--pause")){U("worker-attempt-pause",{attempt_id:X},$);return}if(ae.contains("mon-op--discard")){if(!d(Fn(V,"unmerged")))return;k({bead_id:V,...X?{attempt_id:X}:{},...x.dataset.operationId?{operation_id:x.dataset.operationId}:{}},$,P);return}if(ae.contains("mon-op--resume")){sn().then(ue=>{if(ue!==null)return S("worker-attempt-resume",{attempt_id:X,...ue!==""?{instructions:ue}:{}},$,P)});return}if(ae.contains("mon-op--dismiss")){W("worker-attempt-dismiss",{attempt_id:X},$,P);return}if(ae.contains("worker-mini__merge")){let ue=I($,V);ue?.mismatch&&ue.continuation===null?D($,V,P,ue.mismatch):W("worker-merge-queue-add",{bead_id:V},$,P);return}if(ae.contains("worker-mini__merge-cancel")){W("worker-merge-queue-remove",{bead_id:V},$,P);return}if(ae.contains("worker-mini__discard")){let ue=x.dataset.discardMode==="merged"?"merged":"unmerged";if(!d(Fn(V,ue)))return;k({bead_id:V,...X?{attempt_id:X}:{},...x.dataset.operationId?{operation_id:x.dataset.operationId}:{}},$,P);return}if(ae.contains("worker-mini__revise-fix")){S("worker-revise-fix",{bead_id:V},$,P);return}ae.contains("worker-mini__revise-approve")&&W("worker-revise-approve",{bead_id:V},$,P)}function j(g){g.querySelector(".mon-link__list")?.replaceChildren();let $=g.querySelector(".mon-link__search");$&&($.value="");let P=g.querySelector(".mon-link__direct");P&&(P.hidden=!0,P.dataset.targetId="",P.textContent="");let V=g.querySelector(".mon-link__empty");V&&(V.hidden=!0);let X=g.querySelector(".mon-link__error");X&&(X.hidden=!0,X.textContent="")}function oe(g,x){let $=g.querySelector(".mon-link__list");if(!$)return;let P=document.createDocumentFragment(),V=Tc(L).filter(X=>X.id!==x);for(let X of V){let ae=document.createElement("button");ae.type="button",ae.className="mon-link__candidate",ae.dataset.targetId=X.id,ae.dataset.search=`${X.id} ${X.title} ${X.location}`.toLocaleLowerCase();let ue=document.createElement("strong");ue.textContent=X.id;let Ne=document.createElement("span");Ne.textContent=X.title;let ve=document.createElement("small");ve.textContent=X.location,ae.append(ue,Ne,ve),P.append(ae)}$.replaceChildren(P)}function Le(){for(let g of Array.from(A.querySelectorAll(".mon-card-popover"))){let x=g;x.hidden=!0,x.classList.contains("mon-link__popover")&&j(x)}for(let g of Array.from(A.querySelectorAll('[aria-expanded="true"]')))g.setAttribute("aria-expanded","false")}function Ue(g){let $=g.closest(".mon-place")?.querySelector(".mon-place__popover")||null;if(!$)return;let P=$.hidden;Le(),P&&($.hidden=!1,g.setAttribute("aria-expanded","true"))}function Ve(g){let $=g.closest(".mon-link")?.querySelector(".mon-link__popover")||null;if(!$)return;let P=$.hidden;if(Le(),P){let V=g.closest(".mon-card");oe($,V?.getAttribute("data-issue-id")||""),$.hidden=!1,g.setAttribute("aria-expanded","true");let X=$.querySelector(".mon-link__search");X&&(Re(X),X.focus())}}function Re(g){let x=g.closest(".mon-link__popover"),$=g.closest(".mon-card");if(!x||!$)return;let P=g.value.trim(),V=P.toLocaleLowerCase(),X=0,ae=!1;for(let be of Array.from(x.querySelectorAll(".mon-link__candidate"))){let ze=be,tt=ze.dataset.targetId||"",B=V.length===0||(ze.dataset.search||"").includes(V);ze.hidden=!B,B&&(X+=1),tt.toLocaleLowerCase()===V&&(ae=!0)}let ue=x.querySelector(".mon-link__direct"),Ne=$.getAttribute("data-issue-id")||"";if(ue){let be=P.length>0&&!ae&&V!==Ne.toLocaleLowerCase();ue.hidden=!be,ue.dataset.targetId=be?P:"",ue.textContent=be?`\uC9C1\uC811 \uC785\uB825 \xB7 ${P}`:"",be&&(X+=1)}let ve=x.querySelector(".mon-link__empty");ve&&(ve.hidden=X>0);let Ee=x.querySelector(".mon-link__error");Ee&&(Ee.hidden=!0,Ee.textContent="")}function lt(g){let x=g.target;x&&A.contains(x)&&typeof x.closest=="function"&&x.closest(".mon-popover-owner")||Le()}function Ze(g){if(g.key!=="Escape")return;let x=A.querySelector('[aria-expanded="true"]');Le(),x?.focus()}function G(g){let x=Z;Z=!1;let $=g.target;if(!$||typeof $.closest!="function"||$.closest("dialog")||$.closest("a"))return;let P=$.closest(".mon-running-sort");if(P){g.preventDefault(),f=P.getAttribute("data-sort")==="repo"?"repo":"started",hm(f),je();return}let V=$.closest(".mon-auto-all");if(V){g.preventDefault(),se(V.getAttribute("data-on")==="true");return}if($.closest(".mon-merge-all")){g.preventDefault(),z();return}let ae=$.closest(".mon-ctl--advance");if(ae){g.preventDefault();let{root_dir:be,revision:ze}=Be(ae);W("worker-automation-toggle",{on:ae.getAttribute("data-on")==="true"},be,ze);return}let ue=$.closest(".mon-ctl--merge-auto");if(ue){g.preventDefault();let{root_dir:be,revision:ze}=Be(ue);W("worker-merge-auto-toggle",{on:ue.getAttribute("data-on")==="true"},be,ze);return}let Ne=$.closest(".mon-card");if(!Ne)return;let ve=$.closest("button");if(ve){g.preventDefault(),K(Ne,ve);return}let Ee=Ne.getAttribute("data-issue-id");Ee&&!x&&(g.preventDefault(),xe(Ee,Ne.getAttribute("data-root-dir")||""))}function te(g){let x=g.target;if(!x||typeof x.closest!="function")return;let $=x.closest(".mon-filter__blocked");if($){h={show_blocked:$.checked},fm(h),je();return}let P=x.closest(".mon-done-range");if(P){p=Ut(P.value)?P.value:Dt,gm(p),je();return}let V=x.closest(".mon-slots__input");if(!V)return;let{root_dir:X,revision:ae}=Be(V),ue=Number(V.value);if(!Number.isFinite(ue))return;let Ne=Math.max(Wn,Math.floor(ue));W("worker-queue-set-slots",{slots:Ne},X,ae)}function Oe(g){let x=g.target;x?.classList.contains("mon-link__search")&&Re(x)}e.addEventListener("click",G),e.addEventListener("change",te),e.addEventListener("input",Oe),e.addEventListener("dragstart",Fe),e.addEventListener("dragover",me),e.addEventListener("dragleave",Pe),e.addEventListener("drop",$e),e.addEventListener("dragend",ge),document.addEventListener("click",lt),document.addEventListener("keydown",Ze),s&&typeof s.subscribe=="function"&&(Y=s.subscribe(()=>{try{q.clear(),je()}catch{}}));function We(){Q!==null&&(clearInterval(Q),Q=null)}function pe(){de!==null&&(clearTimeout(de),de=null)}return{load(){r("load"),je(),Q===null&&(Q=setInterval(()=>{try{if(A.querySelector(".mon-card-popover:not([hidden])"))return;je()}catch{}},ym))},pause(){We()},clear(){We(),pe(),Y&&(Y(),Y=null),e.removeEventListener("click",G),e.removeEventListener("change",te),e.removeEventListener("input",Oe),e.removeEventListener("dragstart",Fe),e.removeEventListener("dragover",me),e.removeEventListener("dragleave",Pe),e.removeEventListener("drop",$e),e.removeEventListener("dragend",ge),document.removeEventListener("click",lt),document.removeEventListener("keydown",Ze),e.replaceChildren()}}}function ou(e,t,r){let n=_t("views:nav"),s=null;function o(u){return d=>{d.preventDefault(),n("click tab %s",u),r.gotoView(u)}}function a(){let u=t.getState(),d=u.view==="worker"||u.view==="monitor"?u.view:"board";return l`
  ...
  `}var xm=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}],qt="";function Ft(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function fu(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(g=>le(g,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",u=!1,d="",p={},f={},h=[],R=!1,A=null,L={},q="",Y="",Q=!1,W=!1,I=!1,S=null;function D(){let g=t.queueStore?.get();return Ft(g)?g.runner_catalog:null}function k(){let g=t.queueStore?.get();return Ft(g)&&Ft(g.execution_defaults)?g.execution_defaults:null}function U(){let g=t.implPresetStore?.get();return Ft(g)&&Array.isArray(g.presets)?g:null}async function se(){R=!0,Re();try{let g=await r("get-session-defaults",{});p=Ft(g?.values)?{...g.values}:{},f={...p},h=Array.isArray(g?.warnings)?g.warnings:[]}catch(g){h=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${g instanceof Error?g.message:String(g)}`)}finally{R=!1,Re()}}async function z(){let g=nc(p,f);if(Object.keys(g).length!==0){try{let x=await r("set-session-defaults",{values:g});p=Ft(x?.values)?{...x.values}:{},f={...p},h=Array.isArray(x?.warnings)?x.warnings:[]}catch(x){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${x instanceof Error?x.message:String(x)}`)}Re()}}function M(g,x){x===qt?delete f[g]:f[g]=x,Re(),z()}async function Z(){let g=t.queueStore?.get();if(!Ft(g))return;let x={orchestration_model:g.orchestration_model??null,orchestration_effort:g.orchestration_effort??null,orchestration_speed:g.orchestration_speed??null},$=sc(x,{...x,...L});if(Object.keys($).length!==0){try{let P=await r("worker-queue-set-orchestration-defaults",{expected_revision:g.revision,values:$});if(P&&P.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}L={}}catch(P){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${P instanceof Error?P.message:String(P)}`)}Re()}}function de(g,x){L[g]=x===qt?null:x,Re(),Z()}async function Ie(g){let x=t.queueStore?.get();if(!(!Ft(x)||g<1)){try{await r("worker-queue-set-slots",{expected_revision:x.revision,slots:g})}catch($){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${$ instanceof Error?$.message:String($)}`)}Re()}}function we(){let g={},x=Be();for(let $ of ec){let P=Cr.includes($)?x[$]:f[$];typeof P=="string"&&P.length>0&&(g[$]=P)}return g}async function Ge(){let g=U();if(!g)return;let x=we();if(Object.keys(x).length===0){o("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let $=(g.presets||[]).find(V=>V.id===q),P=Y.trim()||($?$.name:"");if(!P){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let V=$?await r("impl-preset-update",{expected_revision:g.revision,id:$.id,name:P,settings:x}):await r("impl-preset-create",{expected_revision:g.revision,name:P,settings:x});if(V&&V.applied){if(Y="",!$&&Array.isArray(V.presets)){let X=V.presets.find(ae=>ae.name===P);q=X?X.id:q}Re()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Re()}catch(V){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}}async function at(){let g=U();if(!(!g||q.length===0))try{let x=await r("impl-preset-delete",{expected_revision:g.revision,id:q});x&&x.applied?(q="",Re()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Re())}catch(x){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${x instanceof Error?x.message:String(x)}`)}}async function Fe(){let g=U(),x=t.queueStore?.get();if(!(!g||!Ft(x)||q.length===0)){try{let $=await r("apply-impl-preset-global",{preset_id:q,expected_revision:g.revision,expected_queue_revision:x.revision});$&&$.applied?(p=Ft($.values)?{...$.values}:{},f={...p},h=Array.isArray($.warnings)?$.warnings:[],Ft($.queue)&&(t.queueStore?.set?.($.queue),L={}),$.queue_applied===!1&&o("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694")):$&&$.conflict&&o("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch($){o(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${$ instanceof Error?$.message:String($)}`)}Re()}}async function me(){W=!0,I=!1,Re();try{let g=await r("get-worker-system-prompt",{});!g||typeof g!="object"||Array.isArray(g)?I=!0:S=g}catch{I=!0}finally{W=!1,Re()}}function Pe(){if(Q=!Q,Q&&!S){me();return}Re()}function ge(){let g=cn({loading:W,error:I});if(g)return g;if(!S)return"";let x=Array.isArray(S.variants)?S.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    </div>`}function $e(){return l`<section
    ...
    >
      ...
      ${Q?ge():""}
    </section>`}function Ce(g,x,$,P,V,X){let ae=V[g]??qt,ue=sa(g,$,V,k(),D()),Ne=ue.options.find(Ee=>Ee.value===ae),ve=ae===qt?ue.full_value:Ne?.full_value;return l`<select
        class=${ae===qt?"settings-dialog__unset":""}
        data-key=${g}
        aria-label=${x}
        title=${ve||""}
        ?disabled=${X===!0||ue.disabled}
        .value=${zr(String(ae))}
        @change=${Ee=>P(g,String(Ee.target.value))}
      >
        <option value=${qt} ?selected=${ae===qt}>
          ${ue.unset_label}
        </option>
        ${ue.options.map(Ee=>l`<option
              value=${Ee.value}
              title=${Ee.full_value||""}
              ?selected=${Ee.value===ae}
            >
              ${Ee.label}
            </option>`)}
      </select>
      ${ae===qt?l`<span class="settings-dialog__source-badge">기본</span>`:""}`}function je(g,x,$,P,V,X=!1){return l`<div
    ...
    >
    ...
    </div>`}function xe(g,x,$,P,V){return l`<div class="settings-dialog__row">
      ...
      <span class="settings-dialog__controls">
        ${Ce($,`${g} \uBAA8\uB378`,P,M,f,!1)}
        ${Ce(V,`${g} effort`,zs,M,f,!1)}
      </span>
    </div>`}function Be(){let g=t.queueStore?.get(),x={};for(let $ of Cr)x[$]=Object.prototype.hasOwnProperty.call(L,$)?L[$]:Ft(g)&&typeof g[$]=="string"?g[$]:null;return x}function Ye(){let g=D(),x=f.impl_runtime,$=f.impl_model,P=U(),V=t.queueStore?.get(),X=Be(),ae=Gs(g,A),ue=un(g,A||void 0,X.orchestration_model||lr).filter(be=>be!==lr),Ne=Ft(V)&&typeof V.slots=="number"?V.slots:2,ve=k()?.supported===!0,Ee=sa("workflow_mode",Dn,f,k(),g);return l`
      <section
        ...
        ${R?l`<div class="settings-dialog__empty">불러오는 중…</div>`:l`
              <div class="settings-dialog__preset-bar">
                <select
                  aria-label="실행 프리셋"
                  .value=${zr(q)}
                  @change=${be=>{q=String(be.target.value),Re()}}
                >
              ...
              <div class="settings-dialog__group">
                ...
                <div class="settings-dialog__row">
                  ...
                  <span class="settings-dialog__controls">
                    <select
                      ...
                      .value=${zr(A||qt)}
                      @change=${be=>{let ze=String(be.target.value);A=ze===qt?null:ze,Re()}}
                    >
                      <option
                        value=${qt}
                        ?selected=${!A}
                ...
                ${je("orchestration_model","\uBAA8\uB378",ae,de,X)}
                ${je("orchestration_effort","effort",ue,de,X)}
                ${je("orchestration_speed","\uC18D\uB3C4",Pn,de,X)}
              </div>
              ...
              <div class="settings-dialog__group">
                ...
                ${xe("\uC0AC\uC591 \uB9AC\uBDF0","spec","spec_review_model",Nn,"spec_review_effort")}
                ${xe("\uACC4\uD68D \uB9AC\uBDF0","plan","plan_review_model",Ws,"plan_review_effort")}
                ${xe("\uAD6C\uD604 \uB9AC\uBDF0","impl","impl_review_model",Nn,"impl_review_effort")}
              </div>
              ...
              <div class="settings-dialog__group">
                ...
                ${je("impl_runtime","\uC704\uC784 \uB300\uC0C1",Us,M,f)}
                ${je("impl_model","\uBAA8\uB378",Hs(g,x),M,f)}
                ${je("impl_effort","effort",un(g,x,$),M,f)}
                ${je("impl_speed","\uC18D\uB3C4",Pn,M,f)}
              </div>
    ...
    `}function Se(){let g=n.get();return l`
      <section
    ...
    `}async function st(g){let x=n.get();if(x)try{let $=await r("display-policy-set",{expected_revision:x.revision,policy:g(x)});K($),$&&$.conflict&&$.policy&&($=await r("display-policy-set",{expected_revision:$.policy.revision,policy:g($.policy)}),K($)),$&&$.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function K(g){g&&g.policy&&typeof g.policy=="object"&&n.set(g.policy)}function j(g){st(g)}function oe(g){let x=n.get();if(!x)return;let $=!Am(g,x);j(P=>Sm(g,P,$))}function Le(){let g=d.trim();g.length!==0&&(d="",j(x=>x.hidden_prefixes.includes(g)?{hidden_prefixes:x.hidden_prefixes}:{hidden_prefixes:[...x.hidden_prefixes,g]}),Re())}function Ue(g){j(x=>({hidden_prefixes:x.hidden_prefixes.filter($=>$!==g)}))}function Ve(g){let x=n.get();if(!x)return;let $=x.chips[g]===!1;j(()=>({chips:{[g]:$}}))}function Re(){Je(l`
    ...
    </span>`}function q(z,M,Z){let de=M.available&&typeof M.ageSeconds=="number"&&M.ageSeconds>mu,Ie=de&&typeof M.ageSeconds=="number"?`${Math.floor(M.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",we=M.accounts.filter(Ge=>!Ge.active).length;return l`<span
      class="usage-meter__group${de?" usage-meter__group--stale":""}"
      aria-label=${`${z.label} usage`}
    >
      <span class="usage-meter__provider">${z.label}</span>
      ${M.available?M.windows.map(Ge=>L(Ge,de,Ie,Z)):l`<span class="usage-meter__empty">사용량 없음</span>`}
      ${we>0?l`<span class="usage-meter__badge">+${we}</span>`:""}
    </span>`}function Y(z,M){return l`<span class="usage-meter" aria-label="Usage">
      ${z.map(Z=>q(Z.provider,Z.snapshot,M))}
    </span>`}function Q(z){let M=hu(z.pct);return l`<span
    ...
    >
    ...
    </span>`}function W(z,M){return Tm.includes(M)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${z.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function I(z,M){let Z=M.status==="ok",de=typeof M.ageSeconds=="number"&&M.ageSeconds>mu,Ie=a.get(vu(z.key,M.number)),we=n.get(z.key),Ge=we!==void 0,at=we===M.number,Fe=["usage-meter__account"];return M.active&&Fe.push("usage-meter__account--active"),Z||Fe.push("usage-meter__account--unavailable"),de&&Fe.push("usage-meter__account--stale"),l`<div class=${Fe.join(" ")}>
      ...
      ${Z?l`<div class="usage-meter__account-windows">
            ${M.windows.map(me=>Q(me))}
    ...
    </div>`}function S(z,M){let Z=M.accounts.filter(de=>de.active).length;return l`<section class="usage-meter__section">
      <h2 class="usage-meter__section-title">
        ${z.label} · 활성 ${Z} / 전체
        ${M.accounts.length}
      </h2>
      ${M.accounts.map(de=>I(z,de))}
    </section>`}function D(z){return l`<div
      class="usage-meter__card"
      id=${_u}
      role="dialog"
      aria-label="계정 사용량"
    >
      ${z.filter(M=>M.snapshot.accounts.length>0).map(M=>S(M.provider,M.snapshot))}
      <p class="usage-meter__note">전환은 새로 시작하는 세션부터 적용됩니다.</p>
    </div>`}function k(){let z=[];for(let Ie of yu){let we=o.get(Ie.key);we&&z.push({provider:Ie,snapshot:we})}if(z.length===0){d(),i();return}let M=z.some(Ie=>Ie.snapshot.accounts.length>0);M||d();let Z=Date.now(),de=Y(z,Z);Je(l`${M?l`<button
            type="button"
      ...
      ${r?l`<div
              ...
              @mousedown=${R}
            ></div>
            ${D(z)}`:""}`,e),e.hidden=!1}async function U(z){try{let M=await fetch(z.endpoint);return M.ok?Om(await M.json()):null}catch{return null}}async function se(){let z=await Promise.all(yu.map(async M=>({provider:M,snapshot:await U(M)})));if(!t){for(let M of z)M.snapshot?o.set(M.provider.key,M.snapshot):o.delete(M.provider.key);k()}}return i(),se(),s=setInterval(()=>{se()},6e4),{destroy(){t=!0,s!==null&&(clearInterval(s),s=null),d(),i()}}}function $u(e){let t=e.attempts?Object.values(e.attempts):[],r=new Map;for(let s of t)s&&r.set(s.bead_id,s.attempt_id);let n=new Map;for(let s of e.done||[])s&&typeof s.bead_id=="string"&&typeof s.added_at=="number"&&n.set(s.bead_id,s.added_at);return s=>{let o=r.get(s.bead_id)!==s.attempt_id,a=n.get(s.bead_id),i=typeof a=="number"&&a>0&&typeof s.finished_at=="number"&&a>=s.finished_at;return!o&&!i&&typeof s.dismissed_at!="number"}}var Mm="worker-ineligible";function Sa(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ea(e){return Sa(e).includes(Mm)}var Pm="worker-serial";function Ta(e){return Sa(e).includes(Pm)}function Ca(e,t,r){if(typeof t!="string"||typeof r!="string")return[];let n=e?.runners;if(!n||!Object.hasOwn(n,t))return[];let s=n[t],o=s?.models;if(!o||!Object.hasOwn(o,r))return[];let a=o[r]?.efforts;return Array.isArray(a)?a.slice():Array.isArray(s.efforts)?s.efforts.slice():[]}var Dm=new Set(["done","failed","orphaned","stopped","discarded"]),Nm={spec_missing:"\uC2A4\uD399 \uC5C6\uC74C",route:"route \uBBF8\uB2EC",spec_review:"\uC2A4\uD399 \uB9AC\uBDF0 \uC5C6\uC74C",spec_conflict:"\uC2A4\uD399 \uCDA9\uB3CC",phase_child:"phase child",worker_ineligible:"worker \uC81C\uC678"},qm={running:"\uC2E4\uD589 \uC911",success:"\uC131\uACF5",failure:"\uC2E4\uD328",cancelled:"\uCDE8\uC18C",interrupted:"\uC911\uB2E8"},Fm={running:"running",success:"done",failure:"failed",cancelled:"stopped",interrupted:"orphaned"};function Ra(e){return{runner:e.runner||void 0,model:e.model||void 0,effort:e.effort||void 0,status:Fm[e.outcome]||(typeof e.job_id=="string"?"running":void 0),session_id:e.session_id||void 0}}function xu(e,t){let{queueStore:r,analysisStore:n,transport:s,getWorkspacePath:o,onOpenTranscript:a}=t,i=document.createElement("dialog");i.id="worker-parallel-analysis-dialog",i.className="pa",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),e.appendChild(i);let u=new Map,d=new Map,p=!1,f=null,h=null,R=null,A=new Set,L=!1,q=0,Y=null,Q=new Set;function W(){return r&&r.get()||{revision:0,queue:[],serial_lanes:[],serial_lane_count:0,attempts:{},pr_wait:[]}}function I(){return n&&n.get()||{settings:{revision:0,runner:null,model:null,effort:null},job:null,runs:[],last_good:null}}function S(){return o&&o()||""}async function D(){if(!s)return;let w=++q;L=!0,R=null,A.clear(),ve();try{let C=await s("worker-parallel-analysis-targets",{root_dir:S()});if(w!==q||!Ee)return;let N=Array.isArray(C?.qualified)?C.qualified:[],ee=Array.isArray(C?.excluded)?C.excluded:[];R={qualified:N,excluded:ee};for(let ke of N)ke&&typeof ke.id=="string"&&A.add(ke.id)}catch{w===q&&Ee&&(R={qualified:[],excluded:[]},le("\uBD84\uC11D \uB300\uC0C1\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800))}finally{w===q&&(L=!1,Ee&&ve())}}function k(w){return Array.isArray(w.runs)?w.runs:[]}function U(){let w=W(),C=new Set;for(let N of Object.values(w.attempts||{})){let ee=N;ee&&typeof ee.bead_id=="string"&&!Dm.has(ee.status)&&C.add(ee.bead_id)}for(let N of Array.isArray(w.pr_wait)?w.pr_wait:[])N&&typeof N.bead_id=="string"&&C.add(N.bead_id);for(let N of Object.values(w.discard_operations||{})){let ee=N;ee&&ee.phase!=="done"&&typeof ee.bead_id=="string"&&C.add(ee.bead_id)}return C}function se(w){return w.filter(C=>z(C)===null)}function z(w){let C=W();for(let N of Array.isArray(C.serial_lanes)?C.serial_lanes:[])if(Array.isArray(N?.entries)&&N.entries.some(ee=>ee.bead_id===w))return N.id;return(Array.isArray(C.queue)?C.queue:[]).some(N=>N.bead_id===w)?"parallel":null}function M(w,C){let N=u.get(w);return N||[...C.order]}function Z(w){if(w.length<2)return!1;let C=z(w[0]);if(!C||C==="parallel")return!1;let N=W(),ee=(Array.isArray(N.serial_lanes)?N.serial_lanes:[]).find(J=>J.id===C)?.entries.map(J=>J.bead_id);if(!Array.isArray(ee))return!1;let ke=w.map(J=>ee.indexOf(J));return ke.every(J=>J>=0)&&ke.every((J,Ae)=>Ae===0||J>ke[Ae-1])}function de(){let w=W(),C=Array.isArray(w.serial_lanes)?w.serial_lanes:[],N=C.find(ee=>Array.isArray(ee.entries)&&ee.entries.length===0);return N?N.id:C[0]?.id||"s1"}function Ie(w){let C=W().bead_titles||{};return typeof C[w]=="string"?C[w]:w}async function we(w,C){if(!s||p)return null;p=!0,ve();try{return await s(w,C)}finally{p=!1,ve()}}async function Ge(w){n?.setPending?.(!0);try{let C=await we("worker-parallel-analysis-start",{force:w,target_ids:Array.from(A)});C&&C.applied===!1&&C.reason&&(C.reason==="target_not_qualified"&&Array.isArray(C.detail)?le(`\uBD84\uC11D \uB300\uC0C1 \uC790\uACA9 \uBCC0\uACBD: ${C.detail.join(", ")}`,"error",3200):le(`\uBD84\uC11D \uC2E4\uD328: ${C.reason}`,"error",2800))}finally{n?.setPending?.(!1)}}async function at(){let w=I().job;!s||!w||await s("worker-parallel-analysis-cancel",{job_id:w.job_id})}async function Fe(w){if(!(!s||Q.has(w))){Q.add(w),ve();try{let C=await s("worker-parallel-analysis-prompt",{root_dir:S(),run_id:w});if(!Ee)return;if(C?.ok===!0&&typeof C.prompt=="string"){Y={run_id:w,prompt:C.prompt};return}le(C?.reason==="not_found"?"\uC800\uC7A5\uB41C \uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800)}finally{Q.delete(w),ve()}}}function me(){Y=null,ve()}async function Pe(){if(!Y)return;let w=await Xt(Y.prompt);le(w?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",w?"success":"error",1400)}function ge(w,C){a&&a(w,Ra(C))}function $e(){return W().runner_catalog}function Ce(w){return Object.keys($e()?.runners?.[w]?.models||{})}function je(w){let C=Ce(w),N=$e()?.runners?.[w]?.default_model;return typeof N=="string"&&C.includes(N)?N:C[0]||""}function xe(){let w=I().settings,C=f||w.runner||"claude",N=Ce(C),ee=f?je(C):w.model||N[0]||"",ke=Ca($e(),C,ee),J=w.effort||"",Ae=ke.includes(J)?J:ke[0]||"";return{runner:C,model:ee,effort:Ae,models:N,efforts:ke}}async function Be(w){let C=I().settings,N=await we("worker-parallel-analysis-settings-update",{expected_revision:C.revision,runner:w.runner,model:w.model,effort:w.effort});(!N||N.applied!==!0)&&(f=null,ve(),N&&N.reason&&le(`\uBD84\uC11D \uC124\uC815 \uAC70\uBD80: ${N.reason}`,"error",2800))}function Ye(w){f=w,ve();let C=xe();Be({runner:w,model:C.model,effort:C.effort})}function Se(w){let C=xe(),N=Ca($e(),C.runner,w);Be({runner:C.runner,model:w,effort:N.includes(C.effort)?C.effort:N[0]||""})}function st(w){let C=xe();Be({runner:C.runner,model:C.model,effort:w})}async function K(w,C){if(!s||p)return;let N=M(w,C),ee=I();if(N.length<2||!ee.last_good){le("\uC81C\uCD9C\uD558\uB824\uBA74 2\uAC1C \uC774\uC0C1\uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4","warning");return}let ke=d.get(w)||de(),J=()=>({snapshot_digest:ee.last_good.identity_digest,group_index:w,lane:ke,ordered_bead_ids:N,expected_revision:W().revision});p=!0,ve();try{let Ae=await s("worker-parallel-analysis-submit",J());Ae&&Ae.queue&&r&&r.set(Ae.queue),Ae&&Ae.applied!==!0&&Ae.conflict===!0&&(Ae=await s("worker-parallel-analysis-submit",J()),Ae&&Ae.queue&&r&&r.set(Ae.queue)),Ae&&Ae.applied===!0?(u.delete(w),le(`\uC9C1\uB82C \uB808\uC778 ${ke}\uC5D0 ${N.length}\uAC1C \uBC30\uCE58`,"success")):le(`\uC81C\uCD9C \uAC70\uBD80: ${Ae?.reason||"conflict"} (\uD050 \uBB34\uBCC0\uACBD)`,"error",2800)}finally{p=!1,ve()}}function j(w,C,N){u.set(w,M(w,C).filter(ee=>ee!==N)),ve()}function oe(w){u.delete(w),ve()}function Le(w,C,N,ee){let ke=[...M(w,C)],J=ke.indexOf(N),Ae=J+ee;J<0||Ae<0||Ae>=ke.length||(ke.splice(Ae,0,...ke.splice(J,1)),u.set(w,ke),ve())}function Ue(){let w=I().settings,C=Object.keys($e()?.runners||{}),N=xe();return l`<div class="pa-settings">
      <label class="pa-settings__field"
        >러너
        <select
          class="pa-settings__runner"
          aria-label="분석 러너"
          @change=${ee=>Ye(ee.target.value)}
        >
          ${C.map(ee=>l`<option
                value=${ee}
      ...
      ${Ve(w)}
    </div>`}function Ve(w){return!lt(w)||Re(w)?l`<span class="pa-settings__unset">분석 모델 설정 필요</span>`:w.compatible===!1?l`<span class="pa-settings__incompatible"
        >설정 비호환 — 저장된 ${w.runner}/${w.model} · effort
        ${w.effort} 을(를) 카탈로그가 더는 제공하지 않습니다</span
      >`:w.is_default===!0?l`<span class="pa-settings__default">기본값</span>`:""}function Re(w){return w.is_default===!0&&w.compatible===!1}function lt(w){return!!(w.runner&&w.model&&w.effort)}function Ze(w){return lt(w)&&w.compatible!==!1}function G(w){let C=Math.max(0,Math.floor(w/1e3)),N=Math.floor(C/60),ee=C%60;return`${N}:${String(ee).padStart(2,"0")}`}function te(w){let C=w.job;if(C){let N=typeof C.started_at=="number"?C.started_at:0,ee=`${C.runner||"?"}/${C.model||"?"}`,ke=N?` \xB7 \uACBD\uACFC ${G(Date.now()-N)}`:"",J=typeof C.session_id=="string"?C.session_id:"",Ae=k(w).find(Te=>Te.run_id===C.job_id);return l`<span class="pa-meta__progress">
        <span
          >분석 중 — ${ee} · effort ${C.effort||"?"}${ke}</span
        >
        ...
        <button
          ...
          ?disabled=${Ae?.prompt_saved!==!0||Q.has(C.job_id)}
          @click=${()=>{Fe(C.job_id)}}
        >
          프롬프트
        </button>
        ...
        >`:""}function Oe(){return n?.isPending?.()===!0}function We(w){let C=!!w.job,N=Ze(w.settings),ee=R!==null&&A.size===0,ke=C||p||Oe()||L;return l`<div class="pa-meta">
    ...
    </div>`}function pe(w){return typeof w=="string"&&w.length>0?w:"\uBBF8\uBC30\uCE58"}function g(w,C){C?A.add(w):A.delete(w),ve()}function x(w){let C=Array.isArray(w.scope)?w.scope:[],N=Array.isArray(w.overlaps)?w.overlaps:[];return C.length===0&&N.length===0?l``:l`<span class="pa-target__signals">
      ${C.length>0?l`<details class="pa-target__scope" title=${C.join(`
`)}>
            <summary>scope ${C.length}</summary>
            <ul>
              ${C.map(ee=>l`<li><code>${ee}</code></li>`)}
            </ul>
          </details>`:""}
      ${N.length>0?l`<span
            ...
            ${w.map(N=>l`<li class="pa-target">
                  <label class="pa-target__label">
                    <input
                      ...
                      data-target-id=${N.id}
                      .checked=${A.has(N.id)}
                      @change=${ee=>g(N.id,ee.target.checked)}
                    />
...
${Y.prompt}</pre
    ...
    </div>`:""}function ae(w,C){let N=M(w,C),ee=U(),ke=N.filter(rt=>ee.has(rt)),J=se(N),Ae=Z(N),Te=Array.isArray(W().serial_lanes)?W().serial_lanes:[],ft=d.get(w)||de(),Et=C.eligible!==!0||N.length<2||ke.length>0||J.length>0||Ae||p;return l`<section class="pa-group" data-group-index=${String(w)}>
      <header class="pa-group__head">
        <span class="pa-group__confidence">${C.confidence}</span>
        ${C.categories.map(rt=>l`<span class="pa-group__category">${rt}</span>`)}
      ...
      <ol class="pa-group__members">
        ${N.map((rt,yt)=>l`<li class="pa-member" data-bead-id=${rt}>
              <span class="pa-member__seq">${yt+1}</span>
              <span class="pa-member__title">${Ie(rt)}</span>
              ${ee.has(rt)?l`<span class="pa-member__active">실행 중</span>`:""}
              <button
                type="button"
                class="pa-member__up"
                data-bead-id=${rt}
      ...
      <ul class="pa-group__evidence">
        ${C.evidence.map(rt=>l`<li class="pa-evidence">
              <code>${rt.path}</code>
              <span class="pa-evidence__locator">${rt.locator}</span>
            </li>`)}
      </ul>
      <footer class="pa-group__foot">
        ...
        <label class="pa-group__lane-field"
          ...
          <select
            ...
            aria-label="제출 대상 레인"
            @change=${rt=>{d.set(w,rt.target.value),ve()}}
          >
            ${Te.map((rt,yt)=>l`<option
                  value=${rt.id}
                  ?selected=${ft===rt.id}
                >
                  직렬 ${yt+1}
    ...
    </section>`}function ue(w){let C=Array.isArray(w.issues)?w.issues:[],N=C.filter(ke=>ke.verdict==="parallel_ok").length,ee=C.filter(ke=>ke.verdict==="uncertain").length;return l`<div class="pa-summary">
      <span>parallel_ok ${N}</span>
      <span>uncertain ${ee}</span>
    </div>`}function Ne(){let w=Ee&&!!I().job;if(w&&h===null){h=setInterval(()=>ve(),1e3);return}!w&&h!==null&&(clearInterval(h),h=null)}function ve(){let w=I();f&&w.settings.runner===f&&(f=null);let C=w.last_good?.result;Ne(),Je(l`
        ...
        ${X()}
      `,i)}let Ee=!1,be=()=>{Ee=!1,Y=null,q+=1,Ne()},ze=w=>{w.target===w.currentTarget&&_e()};i.addEventListener("close",be),i.addEventListener("cancel",be),i.addEventListener("click",ze);let tt=null;r&&r.subscribe&&(tt=r.subscribe(()=>{Ee&&ve()}));let B=null;n&&n.subscribe&&(B=n.subscribe(()=>{Ee&&ve()}));function re(){Ee||(Ee=!0,ve(),D(),typeof i.showModal=="function"?i.showModal():i.setAttribute("open",""))}function _e(){Ee&&(Ee=!1,Y=null,q+=1,Ne(),typeof i.close=="function"?i.close():i.removeAttribute("open"))}return{open:re,close:_e,destroy(){Ee=!1,h!==null&&(clearInterval(h),h=null),i.removeEventListener("close",be),i.removeEventListener("cancel",be),i.removeEventListener("click",ze),tt&&(tt(),tt=null),B&&(B(),B=null),i.remove()}}}var Au=new Set(["sh","bash","zsh","dash","ksh"]),Su=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function Eu(e){let t=e.split("/");return t[t.length-1]||""}function jm(e){let t=e.split(`
...
`):[];return l`<div
    ...
    </div>`}function R(){Je(h(),n)}async function A(){if(o!=="ready")return;let S=await Xt(a);le(S?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",S?"success":"error")}function L(S){S.key==="Escape"&&s&&(S.preventDefault(),W())}function q(){p||(document.addEventListener("keydown",L),p=!0)}function Y(){p&&(document.removeEventListener("keydown",L),p=!1)}async function Q(S,D=null){let k=++u;q(),s={...S},d=D||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",R(),n.querySelector(".repo-ops-script-viewer__close")?.focus();let se=t?t():"";if(!se){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",R();return}if(!r){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",R();return}let z="/api/repo-ops-script?workspace="+encodeURIComponent(se)+"&lane="+encodeURIComponent(S.lane)+"&base_sha="+encodeURIComponent(S.base_sha);try{let M=await r(z),Z=await M.json().catch(()=>({}));if(k!==u)return;if((t?t():"")!==se){W();return}if(!M.ok||!Z||Z.ok!==!0){o="error",i=Wm(Z&&typeof Z.error=="string"?Z.error:""),R();return}s={lane:Z.lane,base_sha:Z.base_sha,path:Z.path,base_ref:Z.base_ref},a=String(Z.content),o="ready",R()}catch{if(k!==u)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",R()}}function W(){u+=1,Y(),s=null,a="",R();let S=d;d=null,S?.isConnected&&S.focus()}function I(){W(),n.remove()}return{open:Q,close:W,destroy:I}}function Cu(e){let t=e.queueStore,r=e.transport,n=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let I=o();return typeof I.revision=="number"?I.revision:0}function i(I){t&&I&&I.queue&&typeof I.queue=="object"&&t.set(I.queue)}function u(){let I=o().workspace_info;return I&&typeof I=="object"?I:{}}function d(I,S){return l`<span
    ...
    </div>`}function W(){let I=o(),S=I.auto_repair!==!1,D=I.repo_operation_policy&&typeof I.repo_operation_policy=="object"?I.repo_operation_policy:null,k=Array.isArray(I.repo_operations)?I.repo_operations:[],U=k.find(Z=>Z.state==="repairing"),se=k.filter(Z=>Z.state==="failed"||Z.state==="repairing"),z=se.length?Math.min(...se.map(Z=>typeof Z.repair?.remaining=="number"?Z.repair.remaining:0)):D?.auto_repair?.resolution_ladder?.find(Z=>Z.id==="auto_repair_session")?.attempts??1,M=Array.isArray(D?.auto_repair?.resolution_ladder)?D.auto_repair.resolution_ladder:[];return l`<section
...
`),live:s.live===!0,alert:s.alert===!0}};return e.continuation_required?r("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694",{alert:!0}):e.merge_step?e.gate?.tier==="merged"?r("\uBA38\uC9C0\uB428",{title:e.merge_step.label,alert:e.merge_step.failed===!0}):r("\uBA38\uC9C0 \uC911",{title:e.merge_step.label,live:!0}):e.conflict_badge?r(e.conflict_badge,{live:e.conflict_live===!0}):e.head_review&&e.head_review.state!=="failed"?r("\uB9AC\uBDF0 \uC9C4\uD589 \uC911",{title:e.head_review.badge,live:e.head_review.live===!0}):e.recovery?.lock_actions?r(e.recovery.badge,{title:e.recovery.title,live:!0}):e.cleanup_failed?r(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0}):e.base_exception?r("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0}):e.conflicting?r("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0}):e.gate?.reason==="base_behind"?r("base \uAC31\uC2E0 \uD544\uC694",{alert:!0}):e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale"?r("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2C8\uAC70\uB098 \uC870\uC0C1 \uD655\uC778\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0}):e.gate?.reason==="spec_id_missing"?r("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0}):e.gate?.reason==="review_receipt_invalid"?r("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0}):ju(e.receipt_check).length>0?r("\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694",{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${ju(e.receipt_check).join(", ")}`,alert:!0}):e.head_review?.state==="failed"?r("\uB9AC\uBDF0 \uC2E4\uD328",{title:e.head_review.failure_reason||"",alert:!0}):e.recovery?r(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?r("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?r(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Fu(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?r(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Fu(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?r(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?r("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?r("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?r("\uB2EB\uD798",{alert:!0}):e.activity?r("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?r("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?r("\uD655\uC778 \uC911"):e.gate?.gate_badge?r(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function $g(e,t,r,n,s=null,o=null,a=null,i=!1,u=null,d=!0,p=null,f=null,h=null,R={},A=!1,L=!1,q={}){let Y=!!u&&u.position>0,Q=!!u?.continuation_action&&u.continuation_action.continuation===null,W=!!u&&u.active===!0,I=u&&u.failure||null,S=hg(u?u.waiting:null,h),D=r[e]||null,k=D&&D.gate?D.gate:null,U=D&&D.pr?D.pr:null,se=wg(h),z=yg(u?u.resolution:null),M=vg(u?u.head_review:null),Z=u&&u.head_review||null,de=u&&u.authority||null,Ie=!!Z&&["pending","reviewing","revising"].includes(Z.state),we=Y&&!W&&(Z?.state==="failed"||!de||de.source==="automatic"&&!L),Ge=a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":z?z.badge:a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":S,at=!!k&&k.base_badge==="\uCDA9\uB3CC",Fe=!!k&&k.enabled===!0,me=Un({bead_id:e,merge_sha:q.merge_sha,cleanup_cursor:q.cleanup_cursor,merge_progress:o&&o.merge_progress?o.merge_progress:null,cleanup_failed:n,repo_operations:q.repo_operations}),Pe=to(me),ge=!!n&&["child_sweep","branch_cleanup","parent_close"].includes(n.step)&&!!k&&k.tier==="merged",$e=i&&!!n&&!!k&&k.tier==="merged",Ce=we&&(Fe||at||k?.reason==="base_behind"||k?.reason==="review_receipt_missing"||k?.reason==="review_receipt_stale"||ge||$e),je=i&&at&&d===!1,xe=cr(R,e,{external:i,merge_active:W||me?.step==="merge",merge_queued:Y,conflict_active:!!a,cleanup_active:Pe,merged:!!n||k?.tier==="merged"}),Be=!!xe.operation,Ye=!ge&&!!n&&n.step==="repo_operations",Se=kg({continuation_required:Q,merge_step:me,conflict_badge:Ge,conflict_live:z?.live===!0||a==="running",head_review:Z&&M?{...M,state:Z.state,failure_reason:Z.failure_reason}:null,recovery:se,cleanup_failed:n,cleanup_label:n?Hr(n.step):null,base_exception:f,conflicting:at,gate:k,receipt_check:D&&D.receipt_check?D.receipt_check:null,queue_failure:I,auto_skip:p,queued:Y,queue_active:W,queue_position:u?u.position:0,activity:Ge?null:o&&o.activity||null}),st=Se?.live===!0&&Se.title?l`<span title=${Se.title}>${Se.label}</span>`:Se?.label||null;return{id:e,title:i?l`${t}<span class="muted"> · 세션</span>`:t,reason:n&&me?.active!==!0?eo(n.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:A,external:i,pr_number:U&&typeof U.number=="number"?U.number:null,pr_url:U&&typeof U.url=="string"?U.url:"",completion_badge:Se?.live!==!0&&Se?.title?Se.label:null,completion_title:Se?.title||"",completion_repair_pr_url:se?se.repair_pr_url:"",completion_repair_pr_number:se?se.repair_pr_number:null,badges:st?[st]:[],live_badge:Se?.live===!0?st:null,usage:s,alert:Se?.alert===!0,merge_action:k?.tier==="merged"&&!ge&&!$e||Ye?!1:!Y||Q||we,timeline_action:Ye,cancel_action:Y&&!Q,cancel_enabled:(!W||Ie)&&!(se&&se.lock_actions),cancel_title:se&&se.lock_actions?`${se.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:W&&!Ie?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":Ie?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:xe,discard_action:xe.action,merge_step:me,discard_enabled:xe.enabled,discard_title:xe.title,merge_enabled:!me&&!a&&!Be&&!f&&!(se&&se.lock_actions)&&!je&&!Ye&&(Fe||at||k?.reason==="base_behind"||k?.reason==="review_receipt_missing"||k?.reason==="review_receipt_stale"||ge||$e||Ce),merge_label:Q?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":ge||$e?"\uC815\uB9AC \uC7AC\uAC1C":at&&!me&&!ge?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":k?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":k?.reason==="review_receipt_missing"||k?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":we?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:Be?xe.error?`\uD3D0\uAE30 \uC2E4\uD328: ${xe.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${xe.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:Q?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":me?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${me.label}`:$e?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":je?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":ge?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":at?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":k?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":k?.reason==="review_receipt_missing"||k?.reason==="review_receipt_stale"?"\uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":k?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":Fe?`\uBA38\uC9C0 (${k.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:k&&k.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${k&&k.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Oa(e,t={}){let{transport:r,issueStores:n,queueStore:s,analysisStore:o,sessionLogStore:a,uiOrderStore:i,gotoIssue:u,getWorkspacePath:d,doneRange:p,onDoneRangeChange:f}=t,h=n?fs(n,i):null,R=ms({transport:r,uiOrderStore:i}),A=null,L=[],q=tg(),Y=null,Q=ag(),W=Ut(p)?p:lg(),I=new Map;function S(){let c=or.find(_=>_.value===W);return c?c.label:"\uC624\uB298"}let D=dg(),k=!1,U=new Set,se=new Set,z=new Set,M=new Set,Z=[],de=document.createElement("div");de.className="worker-console";let Ie=document.createElement("div");Ie.className="worker-top";let we=document.createElement("div");we.className="worker-drawer-overlay",we.hidden=!0;let Ge=document.createElement("div");Ge.className="worker-drawer-overlay__backdrop";let at=document.createElement("div");at.className="worker-drawer-host";let Fe=document.createElement("div");Fe.className="worker-drawer-host",Fe.hidden=!0,we.append(Ge,at,Fe);let me=document.createElement("div");me.className="worker-lanes-host",de.append(Ie,we,me),e.appendChild(de);let Pe=null,ge=null,$e=qs(at,{transport:r,sessionLogStore:a,onClose:()=>{Pe=null,ge=null,we.hidden=!0,J()}}),Ce=Pu(Fe,{onClose:()=>{Fe.hidden=!0,we.hidden=!0,J()}}),je=Tu({getWorkspacePath:d||(()=>"")}),xe=d&&d()||"",Be=Cu({queueStore:s,transport:r,onChanged:()=>J(),onOpenScript:(c,_)=>{je.open(c,_)}}),Ye=o?xu(de,{queueStore:s,analysisStore:o,transport:r,getWorkspacePath:d,onOpenTranscript:(c,_)=>kr(c,_)}):null;function Se(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:oo,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function st(){let c=Se(),_=typeof c.serial_lane_count=="number"&&Number.isInteger(c.serial_lane_count)&&c.serial_lane_count>0?Math.min(c.serial_lane_count,5):0,E=Array.isArray(c.serial_lanes)?c.serial_lanes:[],H=[];for(let ye of E){if(H.length>=_)break;!ye||typeof ye.id!="string"||!/^s[1-5]$/.test(ye.id)||!Array.isArray(ye.entries)||H.push({id:ye.id,label:`\uC9C1\uB82C ${ye.id.slice(1)}`,count:ye.entries.length})}return H.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(c.queue)?c.queue:[]).length},...H]}function K(c){if(!Y||!c.some(E=>E.id===Y))return null;let _=st();return _?{bead_id:Y,lanes:_}:null}function j(){let c=Se();return typeof c.revision=="number"?c.revision:0}function oe(c){c&&c.queue&&s&&s.set(c.queue)}function Le(){let c=Se().queue;return Array.isArray(c)?c.length:0}async function Ue(c,_,E){if(!r)return;let H=()=>({bead_id:c,..._==="parallel"?{}:{lane:_},...E===void 0?{}:{index:E},expected_revision:j()}),ie=await r("worker-queue-place",H());oe(ie),ie&&ie.conflict&&await r("worker-queue-place",H()).then(oe)}async function Ve(c,_,E){if(!r)return;let H=()=>({bead_id:c,..._==="parallel"?{}:{lane:_},to_index:E,expected_revision:j()}),ie=await r("worker-queue-reorder",H());oe(ie),ie&&ie.conflict&&await r("worker-queue-reorder",H()).then(oe)}async function Re(c){if(!r)return;let _=await r("worker-queue-remove",{bead_id:c,expected_revision:j()});oe(_),_&&_.conflict&&await r("worker-queue-remove",{bead_id:c,expected_revision:j()}).then(oe)}async function lt(c){if(!r||!c)return;let _=await r("worker-attempt-pause",{attempt_id:c});_&&_.paused===!1&&_.reason&&le(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${_.reason}`,"error",2400)}async function Ze(c){if(!r||!c)return;let _=await sn();if(_===null)return;let E=async(ie={})=>await r("worker-attempt-resume",{attempt_id:c,expected_revision:j(),..._!==""?{instructions:_}:{},...ie}),H=await E();oe(H),H&&H.conflict&&(H=await E(),oe(H)),H=await fr(H,(ie,ye)=>E({continuation:ie,decision_token:ye}),{onResult:oe,refresh:()=>E()}),H&&H.resumed===!1&&!H.conflict&&H.reason&&le(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${H.reason}`,"error",2400)}async function G(c){if(!r||!c)return;let _=await r("worker-attempt-dismiss",{attempt_id:c,expected_revision:j()});oe(_),_&&_.conflict&&(_=await r("worker-attempt-dismiss",{attempt_id:c,expected_revision:j()}),oe(_)),_&&_.dismissed===!1&&!_.conflict&&_.reason&&le(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${_.reason}`,"error",2400)}async function te(c,_,E=!0){if(!r)return null;let H=r,ie=await H(c,{..._,expected_revision:j()});return oe(ie),ie&&ie.conflict&&E&&(ie=await H(c,{..._,expected_revision:j()}),oe(ie)),ie}async function Oe(c){if(!r||!c)return;let _=Se().merge_queue?.find(H=>H.bead_id===c)?.continuation_action;if(_?.mismatch&&_.continuation===null){await pe(c,_.mismatch);return}U.add(c),J();let E;try{E=await te("worker-merge-queue-add",{bead_id:c})}finally{U.delete(c),J()}!E||E.conflict||E.applied||le(bg(E.reason),"error",2400)}async function We(c){if(!(!r||!c||se.has(c))){se.add(c),J();try{let _=await r("worker-cleanup-retry",{bead_id:c,expected_revision:j()});oe(_),_&&!_.retried&&!_.conflict&&_.reason&&le(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${_.reason}`,"error",2400)}finally{se.delete(c),J()}}}async function pe(c,_){let E=await fr({continuation_mismatch:_},(ie,ye)=>te("worker-merge-queue-add",{bead_id:c,continuation:ie,decision_token:ye},!1)),H=E?.queue?.merge_queue?.find(ie=>ie.bead_id===c)?.continuation_action;if(E?.applied!==!0&&H?.continuation===null&&H.mismatch){await pe(c,H.mismatch);return}E&&E.applied===!1&&!E.conflict&&le("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function g(c){if(!r)return;let _=await te("worker-merge-auto-toggle",{on:c});!_||_.conflict||le(c?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",c?"success":"info",2400)}async function x(c){if(!r||!c)return;let _=await te("worker-merge-queue-remove",{bead_id:c});_&&!_.conflict&&!_.applied&&_.reason==="merge_active"&&le("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function $(){await te("worker-merge-queue-remove",{all:!0})}async function P(c,_=null,E="unmerged",H=null){if(!r||!c)return;let ie=Fn(c,E);if(!(!!H||typeof globalThis.confirm!="function"||globalThis.confirm(ie)))return;let fe=await r("worker-discard",{bead_id:c,..._?{attempt_id:_}:{},...H?{operation_id:H}:{},expected_revision:j()});if(oe(fe),fe&&fe.conflict&&(fe=await r("worker-discard",{bead_id:c,..._?{attempt_id:_}:{},...H?{operation_id:H}:{},expected_revision:j()}),oe(fe)),fe&&fe.discarded===!0){le(Qs(fe),"success",5e3);return}if(fe&&fe.reason){le(`\uD3D0\uAE30 \uC2E4\uD328: ${fe.reason}`,"error",2800);return}if(fe&&fe.accepted&&fe.pending==="merged_revert"){le("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(fe&&fe.accepted&&!fe.discarded){le(`\uD3D0\uAE30 \uC9C4\uD589: ${fe.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}fe&&!fe.conflict&&le("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function V(c,_,E){if(!(!r||!_||!E||M.has(_))){M.add(_),J();try{let H=await r(c,{bead_id:_,action_id:E,expected_revision:j()});oe(H),H?.conflict?le("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!H?.ok&&H?.reason&&le(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(H.reason)}`,"error",2800)}finally{M.delete(_),J()}}}async function X(c,_){if(!r||!_||z.has(_))return;z.add(_),J();let E;try{let H=async(ie={})=>await r(c,{bead_id:_,expected_revision:j(),...ie});E=await H(),oe(E),E&&E.conflict&&(E=await r(c,{bead_id:_,expected_revision:j()}),oe(E)),c==="worker-revise-fix"&&(E=await fr(E,(ie,ye)=>H({continuation:ie,decision_token:ye}),{onResult:oe,refresh:()=>H()}))}finally{z.delete(_),J()}if(!(!E||E.conflict)){if(E.ok){le(c==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}le(`\uCC98\uBD84 \uAC70\uBD80: ${E.reason||""}`,"error",3e3)}}async function ae(c){if(!r)return;let _=await r("worker-automation-toggle",{on:c,expected_revision:j()});oe(_),_&&_.conflict&&await r("worker-automation-toggle",{on:c,expected_revision:j()}).then(oe)}async function ue(c){if(!r||!c)return;let _=await r("worker-repo-operation-repair",{operation_id:c});if(oe(_),_&&_.ok===!1){le(`\uD574\uACB0 \uC138\uC158 \uAC70\uBD80: ${_.reason||""}`,"error",3e3);return}_&&_.ok===!0&&le("\uD574\uACB0 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4","success",2400)}async function Ne(c){if(!r||!c)return;let _=await r("worker-repo-operation-dismiss",{operation_id:c});oe(_),_&&_.ok===!1&&le(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${_.reason||""}`,"error",3e3)}async function ve(c){if(!r||!Number.isFinite(c))return;let _=Math.max(oo,Math.floor(c)),E=await r("worker-queue-set-slots",{slots:_,expected_revision:j()});oe(E),E&&E.conflict&&await r("worker-queue-set-slots",{slots:_,expected_revision:j()}).then(oe)}async function Ee(c){if(!r||!Number.isInteger(c)||c<1||c>Du)return;let _=Se(),E=(Array.isArray(_.serial_lanes)?_.serial_lanes:[]).slice(c).reduce((ye,fe)=>ye+(Array.isArray(fe?.entries)?fe.entries.length:0),0),H=()=>({count:c,expected_revision:j()}),ie=await r("worker-queue-set-serial-lane-count",H());oe(ie),ie&&ie.conflict&&(ie=await r("worker-queue-set-serial-lane-count",H()),oe(ie)),ie&&ie.applied&&E>0&&le(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${E}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}function be(){let c=Se(),_=h?h.selectBoardColumn(Xm,"ready"):[],E=h?h.selectBoardColumn(Qm,"blocked"):[],H=h?h.selectBoardColumn(eg,"closed"):[],ie=h?h.selectBoardColumn(Jm,"in_progress"):[],ye=new Map;for(let b of ie){let F=mg(b);if(!F)continue;let ce=ye.get(F);ce?ce.push(b):ye.set(F,[b])}let fe=b=>{let F=_s(ye.get(b)||[]);return F?F.title||F.id:null},Xe=c.bead_titles||{},y=new Map;for(let[b,F]of Object.entries(Xe))typeof F=="string"&&F.length>0&&y.set(b,F);for(let b of[..._,...E])y.set(b.id,b.title||b.id);let v=c.bead_times&&typeof c.bead_times=="object"&&!Array.isArray(c.bead_times)?c.bead_times:{},m=c.bead_labels&&typeof c.bead_labels=="object"&&!Array.isArray(c.bead_labels)?c.bead_labels:{},O=new Map;for(let[b,F]of Object.entries(m))Array.isArray(F)&&O.set(b,Ta(F));for(let b of[..._,...E]){let F=b.labels;Array.isArray(F)&&!O.has(b.id)&&O.set(b.id,Ta(F))}let T=new Map,ne=o?.get()?.last_good?.result?.groups;for(let b of Array.isArray(ne)?ne:[]){if(b?.eligible!==!0||!Array.isArray(b.members))continue;let F=b.members.map(He=>{let pt=(Array.isArray(c.serial_lanes)?c.serial_lanes:[]).find(Kt=>Kt.entries.some(Ct=>Ct.bead_id===He));return pt?pt.id:null});if(!(F.every(He=>He!==null)&&new Set(F).size===1))for(let He of b.members)T.set(He,b.members.filter(pt=>pt!==He))}let qe=c.bead_blocked_by&&typeof c.bead_blocked_by=="object"&&!Array.isArray(c.bead_blocked_by)?c.bead_blocked_by:{},Ke=new Map;for(let[b,F]of Object.entries(v))F&&typeof F=="object"&&Ke.set(b,F);for(let b of[..._,...E])Ke.set(b.id,{created_at:b.created_at,updated_at:b.updated_at});let Qe=b=>Ke.get(b)||{},De=c.pr_wait||[],mt=c.pr_observations||{},sr=c.pr_activity||{},Vr=c.cleanup_failed||{},Vn=Object.entries(Vr).map(([b,F])=>({bead_id:b,step:F&&F.step?F.step:"",reason:F&&F.reason?F.reason:"",at:F&&typeof F.at=="number"?F.at:null,detail:F&&typeof F.detail=="string"?F.detail:null,output_tail:F&&typeof F.output_tail=="string"&&F.output_tail?F.output_tail:void 0,log_path:F&&typeof F.log_path=="string"&&F.log_path?F.log_path:void 0,retry_count:F&&typeof F.retry_count=="number"&&Number.isInteger(F.retry_count)&&F.retry_count>0?F.retry_count:0,failure_code:F&&typeof F.failure_code=="string"?F.failure_code:void 0,subject_id:F&&typeof F.subject_id=="string"?F.subject_id:void 0,repair_eligible:!!(F&&F.repair_eligible),repair:F&&F.repair?F.repair:void 0})),pn=c.queue||[],fn=new Set([...pn.map(b=>b.bead_id),...(Array.isArray(c.serial_lanes)?c.serial_lanes:[]).flatMap(b=>(Array.isArray(b?.entries)?b.entries:[]).map(F=>F.bead_id)),...De.map(b=>b.bead_id),...c.done.map(b=>b.bead_id)]),Kn=new Set(E.map(b=>b.id)),Me=i?i.get()?.order||{}:{},dt=new Set,Kr=[];for(let b of[..._,...E])fn.has(b.id)||dt.has(b.id)||_g(b)||Object.hasOwn(b,"labels")&&Ea(b.labels)||(dt.add(b.id),Kr.push(b));L=fg(Kr,Q,Me);let nd=c.admission||{},Na=b=>{let F=nd[b];if(!F)return"";if(F.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let ce=typeof F.reason=="string"?F.reason:"",He=ce.indexOf(":");return He>0&&He<ce.length-1?`\u26D4 ${ce.slice(0,He)} (${ce.slice(He+1)})`:`\u26D4 ${ce}`},sd=L.map(b=>{let F=Fs(b),ce=F.path.length>0,He=b.workflow?.route==="quick_fix"||b.metadata&&b.metadata.route==="quick_fix",pt=!Object.hasOwn(b,"description")||typeof b.description=="string"&&b.description.trim().length>0,Ct=!(Object.hasOwn(b,"labels")&&Ea(b.labels))&&(He?pt:ce&&!F.conflict),ut=Kn.has(b.id),Yt=[];ut&&Yt.push(gg(b)),He&&!pt?Yt.push("missing_description"):!He&&F.conflict?Yt.push("spec_id_conflict"):!He&&!ce&&Yt.push("spec \uC5C6\uC74C");let rs=Na(b.id);return rs&&Yt.push(rs),{id:b.id,title:b.title||b.id,reason:Yt.join(" \xB7 "),draggable:Ct,lane:"candidate",created_at:b.created_at,updated_at:b.updated_at,workflow:b.workflow,is_quick_fix:He,status:b.status,blocked:ut,has_spec:ce}}),io=ng(sd,q),od=io.visible,ad=c.revise_parked||{},Yn=c.discard_operations&&typeof c.discard_operations=="object"&&!Array.isArray(c.discard_operations)?c.discard_operations:{},lo=(b,F)=>b.map((ce,He)=>{let pt=F!=="done",Kt=F!=="done"&&F!=="queue",Ct=pt?ad[ce.bead_id]:null,ut=pt?cr(Yn,ce.bead_id):null,Yt=ut?.operation?ut:null,rs=pt&&O.get(ce.bead_id)===!0,ii=qe[ce.bead_id]||[],_o=c.admission&&typeof c.admission=="object"?c.admission[ce.bead_id]:null,mo=pt?xc(_o,!!Yt||M.has(ce.bead_id)):null,yd=pt&&!mo?Na(ce.bead_id):null,vd=pt?[yd]:[],li=pt&&ii.length>0&&typeof _o?.reason=="string"&&_o.reason.startsWith("not_ready")?[`\u23F8 ${ii.join(", ")} \uC644\uB8CC \uB300\uAE30 (blocks)`]:[],go=pt?T.get(ce.bead_id):void 0;return go&&go.length>0&&li.push(`\u2733 serial \uAD8C\uC7A5 \xB7 ${go.join(", ")}\uC640`),{id:ce.bead_id,title:y.get(ce.bead_id)||ce.bead_id,reason:vd.filter(Boolean).join(" \xB7 "),draggable:pt&&!Yt&&!mo,done:F==="done",lane:F,seq:Kt?He+1:void 0,worker_serial:rs,discard:Yt,stale_work:mo,badges:[...li,...Ct?["\u23F8 REVISE \uD30C\uD0B9"]:[]],alert:!!Ct,revise_action:!!Ct,revise_enabled:!!Ct&&!Yt&&!z.has(ce.bead_id),revise_title:Ct?Ct.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${Ct.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:F==="done"?Wt(c.attempts||{},ce.bead_id):null,work_ms:F==="done"?kc(c.attempts||{},ce.bead_id):null,done_at:F==="done"&&typeof ce.added_at=="number"?ce.added_at:void 0,...Qe(ce.bead_id)}}),Yr=c.attempts?Object.values(c.attempts):[],co=new Set;for(let b of Yr)b&&typeof b.resumed_from=="string"&&b.resumed_from.length>0&&co.add(b.resumed_from);let qa=new Map;for(let b of Yr)qa.set(b.bead_id,b.attempt_id);let Zn=new Map;for(let b of Yr)Zn.set(b.attempt_id,b);function uo(b){let F=new Set,ce=b;for(;ce&&!F.has(ce.attempt_id);){if(ce.conflict_resolution===!0)return!0;F.add(ce.attempt_id),ce=typeof ce.resumed_from=="string"&&ce.resumed_from.length>0&&Zn.get(ce.resumed_from)||null}return!1}let Xn=typeof c.declared_base=="string"?c.declared_base:null;function id(b){let F=null;for(let ce of Yr)!ce||ce.bead_id!==b||uo(ce)||(F===null||(typeof ce.started_at=="number"?ce.started_at:0)>=(typeof F.started_at=="number"?F.started_at:0))&&(F=ce);return F&&typeof F.target_base=="string"?F.target_base:null}let Fa=[],ja=[],ld=$u(c),Ba=b=>{let F=typeof b.session_id=="string"&&b.session_id.length>0,ce=co.has(b.attempt_id);return{eligible:F&&!ce,reason:F?ce?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Vt=null;for(let b of Yr){let F=b.status==="paused"&&!co.has(b.attempt_id);if(b.status==="running"||F)ja.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:y.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,paused:F,conflict_resolution:uo(b),base_exception:La(Xn,b.target_base),can_pause:typeof b.session_id=="string"&&b.session_id.length>0,discard:cr(Yn,b.bead_id,{attempt_id:b.attempt_id}),usage:Wt(c.attempts||{},b.bead_id),current_child:fe(b.bead_id),...Qe(b.bead_id)});else if((b.status==="failed"||b.status==="orphaned")&&ld(b)){let ce=Ba(b);Fa.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:y.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,failed:!0,status:b.status,status_label:b.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:cr(Yn,b.bead_id,{attempt_id:b.attempt_id}),resume_eligible:ce.eligible,resume_reason:ce.reason,conflict_resolution:uo(b),base_exception:La(Xn,b.target_base),usage:Wt(c.attempts||{},b.bead_id),current_child:fe(b.bead_id),...Qe(b.bead_id)}),Vt=b}}let Qn=[...Fa,...ja].map(b=>{let F=Zn.get(b.attempt_id),ce=F?.quickfix_landing;if(F?.quickfix_lane!==!0||!ce||typeof ce!="object")return b;let He=typeof ce.reason=="string"&&ce.reason.length>0?ce.reason:null,pt=Un({bead_id:F.bead_id,merge_sha:ce.head_sha,cleanup_cursor:ce.cursor,cleanup_failed:He?{step:ce.cursor,reason:He}:null,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]});return pt?{...b,landing:pt}:b}),Ua=null;if(Vt){let b=Ba(Vt),F=Vt.cause_detail;Ua={bead_id:Vt.bead_id,repo:Vt.repo||"",reason:Vt.cause||Vt.status,cause_detail:F&&typeof F.reason=="string"?{reason:F.reason,command:typeof F.command=="string"?F.command:null}:null,resume_attempt_id:Vt.attempt_id,resume_eligible:b.eligible,resume_reason:b.reason,discard:cr(Yn,Vt.bead_id,{attempt_id:Vt.attempt_id})}}let Wa=new Set(Qn.map(b=>b.bead_id)),po=Array.isArray(c.merge_queue)?c.merge_queue:[],za=new Map,Ha=new Map,Ga=new Map,Va=new Map,Ka=new Map;po.forEach((b,F)=>{b&&typeof b.bead_id=="string"&&(za.set(b.bead_id,F+1),Ha.set(b.bead_id,b.resolution),Ga.set(b.bead_id,b.continuation_action||null),Va.set(b.bead_id,b.head_review||null),Ka.set(b.bead_id,b.authority||null))});let Zr=c.merge_queue_state||{active:null,failures:{}},cd=Zr.failures||{},Ya=Zr.waiting&&typeof Zr.waiting.bead_id=="string"&&typeof Zr.waiting.reason=="string"?Zr.waiting:null,ud=c.auto_merge_skips||{},Za=b=>{let F=ud[b];if(!F)return null;let ce=mt[b],He=ce&&ce.pr?ce.pr.head_sha:null;return He&&He===F.head_sha?F.reason||"":null},Jn=new Map;for(let b of Qn)b.failed!==!0&&b.conflict_resolution&&(b.paused?Jn.has(b.bead_id)||Jn.set(b.bead_id,"paused"):Jn.set(b.bead_id,"running"));let Xa=Qn.filter(b=>!b.paused&&b.failed!==!0).length,Qa=(c.workspace_info||{}).slots,Ja=typeof Qa=="number"?Qa:typeof c.slots=="number"?c.slots:oo,dd=Xa>Ja,es=Nr(W),pd=(Array.isArray(c.done)?c.done.slice():[]).filter(b=>es===void 0||typeof b.added_at!="number"||b.added_at>=es).sort((b,F)=>(F.added_at||0)-(b.added_at||0)),_n=lo(pd,"done"),fd=new Set((Array.isArray(c.done)?c.done:[]).map(b=>b?.bead_id).filter(b=>typeof b=="string")),ei=[],_d=d?.()||"";for(let b of H){let F=jr(b.closed_at);if(typeof b.id!="string"||fd.has(b.id)||F===null||es!==void 0&&F<es||typeof b.comment_count!="number"||b.comment_count<=0)continue;let ce=`${_d}\0${b.id}\0${String(b.updated_at)}\0${b.comment_count}`,He=I.get(ce);He===void 0&&r&&(I.set(ce,"pending"),Promise.resolve(r("get-comments",{id:b.id})).then(pt=>{let Kt=Array.isArray(pt)&&pt.some(Ct=>js(typeof Ct?.text=="string"?Ct.text:"")?.lane==="session");I.set(ce,Kt?"session":"not-session"),J()}).catch(()=>{I.set(ce,"failed"),J()})),He==="session"&&ei.push({id:b.id,title:b.title||b.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:F,created_at:b.created_at,updated_at:b.updated_at})}_n.push(...ei),_n.sort((b,F)=>(F.done_at||0)-(b.done_at||0));let ts={};for(let b of _r)ts[b]=0;let ti=!1,ri=0,fo=0,ni=0;for(let b of _n){let F=b.usage;if(F&&typeof F=="object"){let ce=!1;for(let He of _r)Number.isFinite(F[He])&&(ts[He]+=F[He],ti=!0,ce=!0);ce&&(fo+=1,Number.isFinite(F.total_cost_usd)&&(ri+=F.total_cost_usd,ni+=1))}}fo>0&&ni===fo&&(ts.total_cost_usd=ri);let si=_n.map(b=>b.usage).filter(b=>b&&typeof b=="object"&&b.providers),md=si.length>0?xt(xs(si)):ti?Qt(ts):null,gd=c.lane_states&&typeof c.lane_states=="object"&&!Array.isArray(c.lane_states)?c.lane_states:{},bd=Array.isArray(c.serial_lanes)?c.serial_lanes:[],oi=b=>{if(De.some(He=>He.bead_id===b))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let F=Yr.filter(He=>He&&He.bead_id===b),ce=F.length>0?F[F.length-1].status:null;return ce==="failed"||ce==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":ce==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},ai=bd.filter(b=>b&&typeof b.id=="string"&&Array.isArray(b.entries)).map((b,F)=>{let ce=gd[b.id]||{},He=new Map((Array.isArray(ce.corrections)?ce.corrections:[]).filter(ut=>ut&&typeof ut.bead_id=="string"&&typeof ut.after=="string").map(ut=>[ut.bead_id,ut.after])),pt=lo(b.entries.filter(ut=>!Wa.has(ut.bead_id)),b.id).map(ut=>He.has(ut.id)?{...ut,badges:[`\u{1F517} ${He.get(ut.id)} \uB4A4 (blocks \uC790\uB3D9)`,...ut.badges]}:ut),Kt=Array.isArray(ce.occupied_by)?ce.occupied_by.filter(ut=>typeof ut=="string"):[],Ct=Kt.map(ut=>({id:ut,title:y.get(ut)||ut,draggable:!1,lane:b.id,ghost:!0,badges:[oi(ut)]}));return{id:b.id,index:F+1,rows:[...Ct,...pt],occupied:Kt.length>0,badge:Kt.length>0?oi(Kt[0]):"\uB300\uAE30",cycle:ce.cycle===!0}}),hd=typeof c.serial_lane_count=="number"?c.serial_lane_count:ai.length;return{queue:c,idToTitle:y,candidates:od,candidate_hidden:{blocked:io.hidden_blocked,spec:io.hidden_spec},running:Qn,live_count:Xa,slots:Ja,over_cap:dd,failure:Ua,waiting:lo(pn.filter(b=>!Wa.has(b.bead_id)),"queue"),serial_lanes:ai,serial_lane_count:hd,pr_wait:De.map(b=>$g(b.bead_id,y.get(b.bead_id)||b.bead_id,mt,Vr[b.bead_id]||null,Wt(c.attempts||{},b.bead_id),sr[b.bead_id]||(U.has(b.bead_id)||se.has(b.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Jn.get(b.bead_id)||null,b.external===!0,{position:za.get(b.bead_id)||0,active:Zr.active===b.bead_id,failure:cd[b.bead_id]||null,waiting:Ya?.bead_id===b.bead_id?Ya.reason:null,resolution:Ha.get(b.bead_id),continuation_action:Ga.get(b.bead_id),head_review:Va.get(b.bead_id)||null,authority:Ka.get(b.bead_id)||null},b.wt_present!==!1,c.auto_merge===!0?Za(b.bead_id):null,La(Xn,id(b.bead_id)),c.completion_status&&typeof c.completion_status=="object"&&!Array.isArray(c.completion_status)&&c.completion_status[b.bead_id]||null,c.discard_operations&&typeof c.discard_operations=="object"&&!Array.isArray(c.discard_operations)?c.discard_operations:{},Zn.get(qa.get(b.bead_id)||"")?.worker_serial===!0,c.auto_merge===!0,{merge_sha:b.merge_sha,cleanup_cursor:b.cleanup_cursor,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]})).map(b=>({...b,...Qe(b.id)})),merge_queue_length:po.length,merge_queue_running:po.length>0,auto_excluded:De.map(b=>b.bead_id).filter(b=>Za(b)!==null),declared_base:Xn,done:_n,token_total:md,cleanup_failures:Vn,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]}}function ze(){let _=!!o?.get()?.job,E=!_&&o?.isPending?.()===!0,H=_?"\uBD84\uC11D \uC911":E?"\uC900\uBE44 \uC911":"";return l`<button
      type="button"
    ...
    </button>`}function tt(c){let _=c.waiting.length>0?c.waiting[0].id:"\u2014",E=l`<button
      type="button"
      class="worker-play${c.queue.auto_advance?" is-active":""}"
    >
      ${c.queue.auto_advance?"\u23F8 \uC790\uB3D9\uD654 \uBA48\uCDA4":"\u25B6 \uC790\uB3D9\uD654"}
    </button>`,H=N(c),ie=c.over_cap?l`<span
    ...
    >`,Xe=l`<label class="worker-tgl worker-slots"
        >동시 실행
        <input
          type="number"
      ...
      ${o?ze():""} `,y=qc({failure:c.failure}),v=$c(c.repo_operations,c.cleanup_failures);return k?l`<div class="worker-ribbon">
          ${E} ${H}
          <div class="worker-kpi worker-kpi--ribbon">${ie}${ye}</div>
        </div>
        ...
        <div class="worker-ctrl__ops">${E}${H}${Xe}</div>
      ...
      ${v}${Be.template()}${y}`}function B(c){if(c.running.length===0&&c.pr_wait.length===0)return"";let _=c.running.some(E=>!E.paused&&E.failed!==!0);return l`<section
    ...
    >
      ...
      .value=${Q}
    >
      ${og.map(c=>l`<option value=${c.value} ?selected=${Q===c.value}>
            ${c.label}
          </option>`)}
      ...
      <select
        ...
        .value=${W}
      >
        ${or.map(c=>l`<option value=${c.value} ?selected=${W===c.value}>
              ${c.label}
            </option>`)}
      </select>
    ...
    >`,E=c.cycle?l`<div class="worker-lane__cycle">
      ...
      >
        ⏸ 자동 머지
      </button>`;let E=new Set(c.auto_excluded),H=c.pr_wait.filter(ie=>ie.merge_action&&ie.merge_enabled&&!E.has(ie.id)).length;return l`<button
      type="button"
      class="worker-merge-all"
      title="켜 두면 자격이 생기는 PR을 계속 큐에 넣어 순서대로 충돌 해소·머지합니다"
    >
      ▶ 자동 머지${H>0?` ${H}`:""}
    </button>`}function ee(c){let _=rr({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:c.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:_e(),controls:re(c),place_menu:K(c.candidates)});return k?l`<div class="worker-lanes worker-lanes--mobile">
        ${B(c)}
    ...
    </div>`}function ke(c){D={...D,[c]:!D[c]},pg(D),J()}function J(){let c=be();Je(tt(c),Ie),Je(ee(c),me)}function Ae(){let c=document.querySelector(".app-header");if(!c)return;let _=()=>{let E=Math.round(c.getBoundingClientRect().height);de.style.setProperty("--worker-ribbon-top",`${E}px`)};if(_(),typeof ResizeObserver=="function"){let E=new ResizeObserver(_);E.observe(c),Z.push(()=>E.disconnect())}else window.addEventListener("resize",_),Z.push(()=>window.removeEventListener("resize",_))}function Te(){if(typeof window.matchMedia!="function")return;let c=window.matchMedia(ug);k=!!c.matches;let _=E=>{let H=!!(E&&typeof E.matches=="boolean"?E.matches:c.matches);H!==k&&(k=H,J())};typeof c.addEventListener=="function"?(c.addEventListener("change",_),Z.push(()=>c.removeEventListener("change",_))):typeof c.addListener=="function"&&(c.addListener(_),Z.push(()=>c.removeListener(_)))}let ft=null;function Et(c){ft=c.target instanceof Element?c.target:null}function rt(c){let E=c.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!E)return;if(ft&&E.contains(ft)&&ft.closest("input, button, a")){c.preventDefault();return}let H=E.dataset.beadId||"",ie=E.dataset.lane||"";A={bead_id:H,from_lane:ie};try{c.dataTransfer?.setData("text/plain",H),c.dataTransfer&&(c.dataTransfer.effectAllowed="move")}catch{}}function yt(c){let _=c.target?.closest?.(".worker-pane");if(!_)return;let E=_.dataset.lane||"";E!=="candidate"&&E!=="queue"&&!/^s[1-5]$/.test(E)||(c.preventDefault(),c.dataTransfer&&(c.dataTransfer.dropEffect="move"),_.classList.add("worker-pane--drag-over"))}function ur(c){c.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function vt(c,_){let E=L.find(fe=>fe.id===c);if(!E)return;let H=L.filter(fe=>fe.id!==c),ie=H.length;if(_){let fe=_.dataset.beadId;if(fe===c)return;let Xe=H.findIndex(y=>y.id===fe);Xe>=0&&(ie=Xe)}let ye=H.slice();ye.splice(ie,0,E),R.applyReorder(c,ye,ie)}function Tt(c){let _=c.target?.closest?.(".worker-pane");if(!_)return;c.preventDefault(),_.classList.remove("worker-pane--drag-over");let E=_.dataset.lane||"",H=A?.bead_id||c.dataTransfer?.getData("text/plain")||"",ie=A?.from_lane||"";if(A=null,!H)return;let ye=c.target?.closest?.(".worker-mini, .worker-card"),fe=Array.from(_.querySelectorAll(".worker-mini, .worker-card")),Xe=fe.length;if(ye){let y=fe.indexOf(ye);y>=0&&(Xe=y)}if(Xe=Math.max(0,Xe-_.querySelectorAll(".worker-mini--ghost").length),_.classList.contains("worker-pane--collapsed")&&(Xe=Le()),E==="candidate"){if(ie==="candidate"){vt(H,ye);return}(ie==="queue"||/^s[1-5]$/.test(ie))&&Re(H);return}if(E==="queue"||/^s[1-5]$/.test(E)){let y=E==="queue"?"parallel":E;ie===E?Ve(H,y,Xe):Ue(H,y,Xe)}}function dr(c){q=c,rg(c),J()}function wr(c){Q=c==="board"||c==="created"||c==="spec"?c:ao,ig(Q),J()}function jt(c){W=Ut(c)?c:Dt,cg(W),f?.(W),J()}function Ht(c){let _=c.target?.closest?.(".worker-serial-lane-count");if(_){let Xe=Number.parseInt(_.value,10);Number.isFinite(Xe)&&Ee(Xe).then(J);return}let E=c.target?.closest?.(".worker-filter__blocked");if(E){dr({...q,show_blocked:E.checked});return}let H=c.target?.closest?.(".worker-done-range");if(H){jt(H.value);return}let ie=c.target?.closest?.(".worker-sort");if(ie){wr(ie.value||ao);return}let ye=c.target?.closest?.(".worker-slots__input");if(!ye)return;let fe=Number.parseInt(ye.value,10);if(!Number.isFinite(fe)){J();return}ve(fe).then(J)}function wt(c){return c?{runner:c.runner||void 0,model:c.model||void 0,effort:c.effort||void 0,worktree:c.worktree||void 0,status:c.status||void 0,session_id:c.session_id||void 0}:{}}function nr(){let c=be();return{operations:c.repo_operations,cleanup_failures:c.cleanup_failures,repo:d&&d()||""}}function nt(){Pe&&$e.close(),Fe.hidden=!1,we.hidden=!1,Ce.open(nr()),J()}function Mt(c){let _=Se(),E=_.attempts?_.attempts[c]:null;Pe=c,ge=null,Ce.close(),Fe.hidden=!0,we.hidden=!1,$e.open({attempt_id:c,meta:wt(E)}),J()}function kr(c,_){Pe=null,ge=c,Ce.close(),Fe.hidden=!0,we.hidden=!1,$e.open({attempt_id:c,meta:_,hide_prompt:!0}),J()}function Gt(){if(Ce.isOpen()&&Ce.refresh(nr()),ge){let E=(o?.get()?.runs||[]).find(H=>H.run_id===ge);E?$e.updateMeta(Ra(E)):$e.close();return}if(!Pe)return;let c=Se(),_=c.attempts?c.attempts[Pe]:null;if(_){$e.updateMeta(wt(_));return}$e.close()}function he(c){let _=c.target;if(_?.closest?.(".worker-mini__serial, .worker-mini__grip")||_?.closest?.("#worker-parallel-analysis-dialog"))return;if(_?.closest?.(".worker-analysis-btn")){Ye?.open();return}if(_?.closest?.(".worker-repo-strip")||_?.closest?.(".worker-mini__timeline")){nt();return}let E=_?.closest?.(".worker-repo-op__session");if(E){let Me=E.dataset.attemptId;Me&&Mt(Me);return}let H=_?.closest?.(".worker-repo-op__resolve");if(H){ue(H.dataset.operationId||"");return}let ie=_?.closest?.(".worker-repo-op__dismiss");if(ie){Ne(ie.dataset.operationId||"");return}let ye=_?.closest?.(".worker-cleanup__resume");if(ye){let Me=ye.dataset.beadId;Me&&We(Me);return}let fe=_?.closest?.(".worker-banner__resume");if(fe){let Me=fe.dataset.attemptId;Me&&Ze(Me);return}let Xe=_?.closest?.(".worker-banner__discard");if(Xe){let Me=Xe.dataset.confirmation==="merged"?"merged":"unmerged";P(Xe.dataset.beadId||"",Xe.dataset.attemptId||null,Me,Xe.dataset.operationId||null);return}let y=_?.closest?.(".worker-banner__dismiss");if(y){let Me=y.dataset.attemptId;Me&&G(Me);return}if(_?.closest?.(".worker-play")){ae(!Se().auto_advance);return}let v=_?.closest?.(".worker-merge-all");if(v){v.classList.contains("worker-merge-all--stop")?Se().auto_merge===!0?g(!1):$():g(!0);return}let m=_?.closest?.(".worker-pane__hd--toggle");if(m){let Me=m.dataset.lane;(Me==="queue"||Me==="done")&&ke(Me);return}let O=_?.closest?.(".worker-card__place-lane");if(O){let Me=O.dataset.beadId,dt=O.dataset.lane;Me&&(dt==="parallel"||/^s[1-5]$/.test(dt||""))&&(Y=null,J(),Ue(Me,dt));return}if(_?.closest?.(".worker-card__place-cancel")){Y=null,J();return}let ne=_?.closest?.(".worker-card__place");if(ne){let Me=ne.dataset.beadId;Me&&!ne.disabled&&(st()?(Y=Me,J()):Ue(Me,"parallel"));return}let qe=_?.closest?.(".worker-filter__chip");if(qe){let Me=qe.dataset.spec;(Me==="all"||Me==="with"||Me==="without")&&dr({...q,spec:Me});return}let Ke=_?.closest?.(".worker-mini__merge");if(Ke){let Me=Ke.dataset.beadId||"";Se().cleanup_failed?.[Me]?We(Me):Oe(Me);return}let Qe=_?.closest?.(".worker-mini__merge-cancel");if(Qe){x(Qe.dataset.beadId||"");return}let De=_?.closest?.(".worker-mini__discard");if(De){P(De.dataset.beadId||"",De.dataset.attemptId||null,De.dataset.discardMode==="merged"?"merged":"unmerged",De.dataset.operationId||null);return}let mt=_?.closest?.(".worker-mini__stale-continue");if(mt){V("worker-stale-work-continue",mt.dataset.beadId||"",mt.dataset.actionId||"");return}let sr=_?.closest?.(".worker-mini__stale-backup");if(sr){V("worker-stale-work-backup-fresh",sr.dataset.beadId||"",sr.dataset.actionId||"");return}let Vr=_?.closest?.(".worker-mini__stale-recheck");if(Vr){V("worker-stale-work-recheck",Vr.dataset.beadId||"",Vr.dataset.actionId||"");return}let Vn=_?.closest?.(".worker-mini__revise-fix");if(Vn){X("worker-revise-fix",Vn.dataset.beadId||"");return}let pn=_?.closest?.(".worker-mini__revise-approve");if(pn){X("worker-revise-approve",pn.dataset.beadId||"");return}if(_?.closest?.(".worker-mini__pr"))return;if(_?.closest?.(".rtile__discard")){let Me=_?.closest?.(".rtile"),dt=Me?.dataset?.beadId,Kr=Me?.dataset?.attemptId;dt&&P(dt,Kr||null,"unmerged",_?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if(_?.closest?.(".rtile__dismiss")){let dt=_?.closest?.(".rtile")?.dataset?.attemptId;dt&&G(dt);return}if(_?.closest?.(".rtile__pause")){let dt=_?.closest?.(".rtile")?.dataset?.attemptId;dt&&lt(dt);return}if(_?.closest?.(".rtile__resume")){let dt=_?.closest?.(".rtile")?.dataset?.attemptId;dt&&Ze(dt);return}if(_?.closest?.(".rtile__session")){let dt=_?.closest?.(".rtile")?.dataset?.attemptId;dt&&Mt(dt);return}if(_?.closest?.(".worker-drawer-overlay__backdrop")){Ce.close(),$e.close();return}if(_?.closest?.(".worker-drawer-host"))return;let fn=_?.closest?.(".rtile");if(fn){if(_?.closest?.(".rtile__id")){let dt=fn.dataset.beadId;dt&&Xt(dt).then(Kr=>{Kr?le("\uBCF5\uC0AC\uB428","success",1200):le("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let Me=fn.dataset.beadId;Me&&u&&u(Me);return}let Kn=_?.closest?.(".worker-mini, .worker-card");if(Kn){let Me=Kn.dataset.beadId;if(_?.closest?.(".worker-mini__id, .worker-card__id")){Me&&Xt(Me).then(dt=>{dt?le("\uBCF5\uC0AC\uB428","success",1200):le("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}Me&&u&&u(Me)}}return e.addEventListener("pointerdown",Et),e.addEventListener("dragstart",rt),e.addEventListener("dragover",yt),e.addEventListener("dragleave",ur),e.addEventListener("drop",Tt),e.addEventListener("click",he),e.addEventListener("change",Ht),Te(),Ae(),h&&Z.push(h.subscribe(()=>{for(let[c,_]of I)_==="failed"&&I.delete(c);J()})),s&&Z.push(s.subscribe(()=>{let c=d&&d()||"";c!==xe&&(xe=c,je.close()),J(),Gt()})),o&&typeof o.subscribe=="function"&&Z.push(o.subscribe(()=>{Gt(),J()})),J(),{load(){J()},destroy(){for(let c of Z.splice(0))try{c()}catch{}e.removeEventListener("pointerdown",Et),e.removeEventListener("dragstart",rt),e.removeEventListener("dragover",yt),e.removeEventListener("dragleave",ur),e.removeEventListener("drop",Tt),e.removeEventListener("click",he),e.removeEventListener("change",Ht);try{$e.destroy()}catch{}we.hidden=!0;try{Ye?.destroy()}catch{}try{je.destroy()}catch{}Je(l``,e)}}}function Ma(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Hu(e,t,r,n=async()=>{},s=async()=>{}){let o=_t("views:workspace-picker"),a=null,i=!1,u=!1,d=!1;async function p(D){let U=D.target.value,z=t.getState().workspace?.current?.path||"";if(U&&U!==z){o("switching workspace to %s",U),i=!0,S();try{await r(U)}catch(M){o("workspace switch failed: %o",M)}finally{i=!1,S()}}}async function f(){let D=t.getState(),k=D.workspace?.current?.path||D.workspace?.available?.[0]?.path||"";if(!(!k||u)){o("git-pulling workspace %s",k),u=!0,S();try{await n(k)}catch(U){o("workspace git pull failed: %o",U)}finally{u=!1,S()}}}function h(D){let k=D.target;k&&e.contains(k)||L()}function R(D){D.key==="Escape"&&L()}function A(){d||(d=!0,document.addEventListener("mousedown",h),document.addEventListener("keydown",R),S())}function L(){d&&(d=!1,document.removeEventListener("mousedown",h),document.removeEventListener("keydown",R),S())}function q(){d?L():A()}async function Y(D){let k=D.target,U=k.value,se=k.checked;o("toggling visibility %s \u2192 %s",U,String(se));try{await s(U,se)}catch(z){o("workspace visibility toggle failed: %o",z)}}function Q(D){return D?l`
      <button
        type="button"
    ...
    `}function I(){let D=t.getState(),k=D.workspace?.current,U=D.workspace?.available||[],se=new Set(D.workspace?.hidden||[]),z=k?.path||U[0]?.path||"";if(U.length===0)return l``;let M=U.filter(Z=>!se.has(Z.path)||Z.path===z);if(M.length<=1){let Z=M[0]||U[0],de=Ma(Z.path);return l`
    ...
    `}function S(){Je(I(),e)}return S(),a=t.subscribe(()=>S()),{destroy(){a&&(a(),a=null),document.removeEventListener("mousedown",h),document.removeEventListener("keydown",R),Je(l``,e)}}}var Gu=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-impl-target","get-session-defaults","set-session-defaults","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-automation-toggle","worker-auto-repair-toggle","worker-repo-operation-repair","worker-repo-operation-dismiss","worker-queue-set-slots","worker-queue-set-serial-lane-count","subscribe-worker-parallel-analysis","unsubscribe-worker-parallel-analysis","worker-parallel-analysis-snapshot","worker-parallel-analysis-targets","worker-parallel-analysis-prompt","worker-parallel-analysis-start","worker-parallel-analysis-cancel","worker-parallel-analysis-settings-update","worker-parallel-analysis-submit","worker-queue-set-orchestration-defaults","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-cleanup-retry","worker-merge-queue-add","worker-merge-queue-add-all","worker-merge-auto-toggle","worker-merge-queue-remove","worker-discard","worker-stale-work-continue","worker-stale-work-backup-fresh","worker-stale-work-recheck","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append","get-attempt-prompt","get-bead-prompt","get-worker-system-prompt","subscribe-monitor-pipeline","unsubscribe-monitor-pipeline","monitor-pipeline-snapshot","subscribe-impl-presets","unsubscribe-impl-presets","impl-presets-snapshot","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","monitor-auto-toggle"];function Pa(){let e=Date.now().toString(36),t=Math.random().toString(36).slice(2,8);return`${e}-${t}`}function Vu(e,t,r=Pa()){return{id:r,type:e,payload:t}}function Ku(e={}){let t=_t("ws"),r={initialMs:e.backoff?.initialMs??1e3,maxMs:e.backoff?.maxMs??3e4,factor:e.backoff?.factor??2,jitterRatio:e.backoff?.jitterRatio??.2},n=()=>e.url&&e.url.length>0?e.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",a=0,i=null,u=!0,d=new Map,p=[],f=new Map,h=new Set;function R(I){for(let S of Array.from(h))try{S(I)}catch{}}function A(){if(!u||i)return;o="reconnecting",t("ws reconnecting\u2026"),R(o);let I=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,a)),S=(r.jitterRatio||0)*I,D=Math.max(0,Math.round(I+(Math.random()*2-1)*S));t("ws retry in %d ms (attempt %d)",D,a+1),i=setTimeout(()=>{i=null,W()},D)}function L(I){try{s?.send(JSON.stringify(I))}catch(S){t("ws send failed",S)}}function q(){for(o="open",t("ws open"),R(o),a=0;p.length;){let I=p.shift();I&&L(I)}}function Y(I){let S;try{S=JSON.parse(String(I.data))}catch{t("ws received non-JSON message");return}if(!S||typeof S.id!="string"||typeof S.type!="string"){t("ws received invalid envelope");return}if(d.has(S.id)){let k=d.get(S.id);d.delete(S.id),S.ok?k?.resolve(S.payload):k?.reject(S.error||new Error("ws error"));return}let D=f.get(S.type);if(D&&D.size>0)for(let k of Array.from(D))try{k(S.payload)}catch(U){t("ws event handler error",U)}else t("ws received unhandled message type: %s",S.type)}function Q(){o="closed",t("ws closed"),R(o);for(let[I,S]of d.entries())S.reject(new Error("ws disconnected")),d.delete(I);a+=1,A()}function W(){if(!u)return;let I=n();try{s=new WebSocket(I),t("ws connecting %s",I),o="connecting",R(o),s.addEventListener("open",q),s.addEventListener("message",Y),s.addEventListener("error",()=>{}),s.addEventListener("close",Q)}catch(S){t("ws connect failed %o",S),A()}}return W(),{send(I,S){if(!Gu.includes(I))return Promise.reject(new Error(`unknown message type: ${I}`));let D=Pa(),k=Vu(I,S,D);return t("send %s id=%s",I,D),new Promise((U,se)=>{d.set(D,{resolve:U,reject:se,type:I}),s&&s.readyState===s.OPEN?L(k):(t("queue %s id=%s (state=%s)",I,D,o),p.push(k))})},on(I,S){f.has(I)||f.set(I,new Set);let D=f.get(I);return D?.add(S),()=>{D?.delete(S)}},onConnection(I){return h.add(I),()=>{h.delete(I)}},reconnect(){u=!0,i&&(clearTimeout(i),i=null),a=0,W()},close(){u=!1,i&&(clearTimeout(i),i=null);try{s?.close()}catch{}},getState(){return o}}}function xg(){let e=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:null}}}async function Ag(e,t){try{let n=await(await fetch("/api/config")).json();e.setState({config:n})}catch(r){t("config refresh failed",r)}}var Da=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],Yu=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"],["tab:worker:in-progress","in-progress-issues"],["tab:worker:closed","closed-issues"]],Rr="tab:worker:closed",Sg="bdui.worker.done-range",Zu=nu,Xu="worker:queue",Qu="worker:parallel-analysis",Ju="ui:order",ed="ui:display-policy",td="exec:presets",Ir="tab:board:closed",rd="beads-ui.board.closed-range";function Eg(e){let t=_t("main");t("bootstrap start");let r=l`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="monitor-root" class="route monitor" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;Je(r,e);let n=document.getElementById("top-nav"),s=document.getElementById("usage-meter"),o=document.getElementById("board-root"),a=document.getElementById("worker-root"),i=document.getElementById("monitor-root"),u=document.getElementById("detail-panel");if(s&&ku(s),o&&a&&i&&u){let Fe=function(y,v){let m="Request failed",O="";if(y&&typeof y=="object"){let ne=y;if(typeof ne.message=="string"&&ne.message.length>0&&(m=ne.message),typeof ne.details=="string")O=ne.details;else if(ne.details&&typeof ne.details=="object")try{O=JSON.stringify(ne.details,null,2)}catch{O=""}}else typeof y=="string"&&y.length>0&&(m=y);let T=v&&v.length>0?`Failed to load ${v}`:"Request failed";at.open(T,m,O)},Ze=function(y){return`${nt.getState().workspace.current?.path||""}\0${y}`},G=function(){K&&(K().catch(()=>{}),K=null),j=null,oe=null},Oe=function(y){Le=y;let v=()=>{Le!==y||nt.getState().selected_id!==y||(Le=null,te(y))};if(!Re){Ve.then(v);return}v()},x=function(y,v,m,O,T){return m!==g[v]?(T().catch(()=>{}),!1):(y.set(O,T),!0)},P=function(){let y=nt.getState();Ne(y.view==="board"),B(y.view==="worker"),N(y.view==="monitor"),_e(y.view==="board"||y.view==="worker"||$||!!y.selected_id)},ae=function(){let y=Nr(V);return y===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:y}}},ue=function(){let y=Nr(X);return y===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:y}}},Ne=function(y){if(y)for(let[v,m]of Da){if(We.has(v)||pe.has(v))continue;let O=v===Ir?ae():{type:m};try{$e.register(v,O)}catch(qe){t("register %s store failed: %o",v,qe)}pe.add(v);let T=g.board,ne=!1;ge.subscribeList(v,O).then(qe=>{ne=!x(We,"board",T,v,qe)}).catch(qe=>{t("subscribe %s failed: %o",v,qe),Fe(qe,"board")}).finally(()=>{pe.delete(v),ne&&P()})}else be()},be=function(){g.board+=1;for(let[y]of Da){let v=We.get(y);v&&(v().catch(()=>{}),We.delete(y));try{$e.unregister(y)}catch(m){t("unregister %s failed: %o",y,m)}}},B=function(y){if(!y){re();return}for(let[v,m]of Yu){if(ze.has(v)||pe.has(v))continue;let O=v===Rr?ue():{type:m};try{$e.register(v,O)}catch(qe){t("register %s store failed: %o",v,qe)}pe.add(v);let T=g.worker,ne=!1;ge.subscribeList(v,O).then(qe=>{ne=!x(ze,"worker",T,v,qe)}).catch(qe=>{t("subscribe %s failed: %o",v,qe),Fe(qe,"worker")}).finally(()=>{pe.delete(v),ne&&P()})}},re=function(){g.worker+=1;for(let[y]of Yu){let v=ze.get(y);v&&(v().catch(()=>{}),ze.delete(y));try{$e.unregister(y)}catch(m){t("unregister %s failed: %o",y,m)}}},_e=function(y){if(!y){w();return}tt||(Pe("subscribe-worker-queue",{id:Xu}).catch(v=>{t("subscribe-worker-queue failed: %o",v)}),Pe("subscribe-worker-parallel-analysis",{id:Qu}).catch(v=>{t("subscribe-worker-parallel-analysis failed: %o",v)}),tt=()=>(Pe("unsubscribe-worker-parallel-analysis",{id:Qu}),Pe("unsubscribe-worker-queue",{id:Xu})))},w=function(){tt&&(tt().catch(()=>{}),tt=null),je.clear()},N=function(y){if(!y){ee();return}C||(Pe("subscribe-monitor-pipeline",{id:Zu}).catch(v=>{t("subscribe-monitor-pipeline failed: %o",v)}),C=()=>Pe("unsubscribe-monitor-pipeline",{id:Zu}))},ee=function(){C&&(C().catch(()=>{}),C=null)},J=function(){ke||(Pe("subscribe-ui-order",{id:Ju}).catch(y=>{t("subscribe-ui-order failed: %o",y)}),ke=()=>Pe("unsubscribe-ui-order",{id:Ju}))},Ae=function(){ke&&(ke().catch(()=>{}),ke=null),Be.clear()},ft=function(){Te||(Pe("subscribe-display-policy",{id:ed}).catch(y=>{t("subscribe-display-policy failed: %o",y)}),Te=()=>Pe("unsubscribe-display-policy",{id:ed}))},Et=function(){Te&&(Te().catch(()=>{}),Te=null),Ye.clear()},yt=function(){rt||(Pe("subscribe-impl-presets",{id:td}).catch(y=>{t("subscribe-impl-presets failed: %o",y)}),rt=()=>Pe("unsubscribe-impl-presets",{id:td}))},jt=function(y){if(!y)return"Unknown";let v=y.split("/").filter(Boolean);return v.length>0?v[v.length-1]:"Unknown"};var d=Fe,p=Ze,f=G,h=Oe,R=x,A=P,L=ae,q=ue,Y=Ne,Q=be,W=B,I=re,S=_e,D=w,k=N,U=ee,se=J,z=Ae,M=ft,Z=Et,de=yt,Ie=jt;let we=document.getElementById("header-loading"),Ge=Hi(we),at=wc(e),me=Ku(),Pe=Ge.wrapSend((y,v)=>me.send(y,v)),ge=Ni(Pe),$e=qi(),Ce=Bi(),je=ji(),xe=ki(),Be=Fi(),Ye=vi(),Se=wi(),st=$i();me.on("impl-presets-snapshot",y=>{let v=y;v&&typeof v.revision=="number"&&Array.isArray(v.presets)&&Se.set({revision:v.revision,presets:v.presets})}),me.on("monitor-pipeline-snapshot",y=>{let v=y;if(!(!v||!Array.isArray(v.workspaces)))try{xe.set(v.workspaces,v.workspaces_state)}catch{}}),me.on("ui-order-snapshot",y=>{let v=y;if(v&&typeof v.revision=="number")try{Be.set({revision:v.revision,order:v.order&&typeof v.order=="object"?v.order:{}})}catch{}}),me.on("display-policy-snapshot",y=>{let v=y;if(v&&v.policy&&typeof v.policy=="object")try{Ye.set(v.policy)}catch{}}),me.on("session-log-snapshot",y=>{let v=y;if(v&&typeof v.id=="string")try{st.set(v.id,Array.isArray(v.lines)?v.lines:[],typeof v.last_event_at=="number"?v.last_event_at:null)}catch{}}),me.on("session-log-append",y=>{let v=y;if(v&&typeof v.id=="string")try{st.append(v.id,v.event)}catch{}}),me.on("snapshot",y=>{let v=y,m=v&&typeof v.id=="string"?v.id:"",O=m?$e.getStore(m):null;if(O&&v&&v.type==="snapshot")try{O.applyPush(v)}catch{}}),me.on("upsert",y=>{let v=y,m=v&&typeof v.id=="string"?v.id:"",O=m?$e.getStore(m):null;if(O&&v&&v.type==="upsert")try{O.applyPush(v)}catch{}}),me.on("delete",y=>{let v=y,m=v&&typeof v.id=="string"?v.id:"",O=m?$e.getStore(m):null;if(O&&v&&v.type==="delete")try{O.applyPush(v)}catch{}});let K=null,j=null,oe=null,Le=null,Ue=()=>{},Ve=new Promise(y=>{Ue=()=>y(void 0)}),Re=!1,lt=!1;async function te(y){let v=Ze(y);if(v===j||v===oe)return;oe=v;let m=`detail:${y}`,O={type:"issue-detail",params:{id:y}};try{$e.register(m,O)}catch(T){t("register detail store failed: %o",T)}try{let T=await ge.subscribeList(m,O);if(nt.getState().selected_id!==y||Ze(y)!==v){await T().catch(()=>{});return}K&&await K().catch(()=>{}),K=T,j=v}catch(T){t("detail subscribe failed: %o",T),Fe(T,"issue details")}finally{oe===v&&(oe=null)}}let We=new Map,pe=new Set,g={board:0,worker:0},$=!1,V=Dt;try{let y=window.localStorage.getItem(rd);Ut(y)&&(V=y)}catch{}let X=Dt;try{let y=window.localStorage.getItem(Sg);Ut(y)&&(X=y)}catch{}async function ve(y){if(!Ut(y)||y===V)return;V=y;try{window.localStorage.setItem(rd,y)}catch{}let v=We.get(Ir);if(!v)return;We.delete(Ir),await v().catch(()=>{});let m=ae();try{$e.register(Ir,m)}catch(O){t("register %s store failed: %o",Ir,O)}try{let O=await ge.subscribeList(Ir,m);We.set(Ir,O)}catch(O){t("re-subscribe %s failed: %o",Ir,O),Fe(O,"board")}}async function Ee(y){if(!Ut(y)||y===X)return;X=y;let v=ze.get(Rr);if(!v)return;ze.delete(Rr),await v().catch(()=>{});let m=ue();try{$e.register(Rr,m)}catch(O){t("register %s store failed: %o",Rr,O)}try{let O=await ge.subscribeList(Rr,m);ze.set(Rr,O)}catch(O){t("re-subscribe %s failed: %o",Rr,O),Fe(O,"worker")}}let ze=new Map,tt=null,C=null,ke=null,Te=null,rt=null;async function ur(){Te=null,Ye.clear(),rt=null,Se.clear(),tt=null,C=null,We.clear(),ze.clear(),g.board+=1,g.worker+=1,yt();let y=nt.getState().workspace.current?.path;if(y)try{await me.send("set-workspace",{path:y})}catch(m){t("workspace restore after reconnect failed: %o",m);return}ft();let v=nt.getState();Ne(v.view==="board"),B(v.view==="worker"),N(v.view==="monitor"),_e(v.view==="board"||v.view==="worker"||!!v.selected_id)}async function vt(){t("clearing all subscriptions for workspace switch"),be(),re(),w(),Ce.clear(),Ae(),J(),Et(),ft(),G();let y=nt.getState();if(y.selected_id)try{$e.unregister(`detail:${y.selected_id}`)}catch{}let v=nt.getState();Ne(v.view==="board"),B(v.view==="worker"),N(v.view==="monitor"),_e(v.view==="board"||v.view==="worker"||!!v.selected_id),v.selected_id&&Oe(v.selected_id)}async function Tt(y){t("requesting workspace switch to %s",y),lt=!0;try{let v=await me.send("set-workspace",{path:y});t("workspace switch result: %o",v),v&&v.workspace&&(nt.setState({workspace:{current:{path:v.workspace.root_dir,database:v.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",y),v.changed&&(await vt(),le("Switched to "+jt(y),"success",2e3)))}catch(v){throw t("workspace switch failed: %o",v),le("Failed to switch workspace","error",3e3),v}finally{lt=!1}}async function dr(y){t("requesting workspace git pull for %s",y);try{let v=await me.send("git-pull-workspace",{});t("workspace git pull result: %o",v);let m=v?.status;if(m==="up_to_date"){le("Already up to date","success",2e3);return}if(m==="stash_pop_conflict"){le("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}le("Git pulled "+jt(y),"success",2e3)}catch(v){t("workspace git pull failed: %o",v);let m=v?.code,O=v?.message;if(m==="rebase_conflict"){le("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(m==="rebase_conflict_abort_failed"){le("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(m==="busy"){le("Git pull skipped: another operation is running","warning",3e3);return}let T=O?`: ${O}`:"";throw le(`Git pull failed${T}`,"error",3e3),v}}async function wr(y,v){t("setting workspace visibility %s \u2192 %s",y,String(v));try{await me.send("set-workspace-visibility",{path:y,visible:v}),await Ht()}catch(m){t("workspace visibility update failed: %o",m),le("Failed to update project visibility","error",3e3)}}async function Ht(){try{let y=await me.send("list-workspaces",{});if(t("workspaces loaded: %o",y),y&&Array.isArray(y.workspaces)){let v=y.workspaces.map(ne=>({path:ne.path,database:ne.database,pid:ne.pid,version:ne.version})),m=y.current?{path:y.current.root_dir,database:y.current.db_path}:null,O=Array.isArray(y.hidden)?y.hidden.filter(ne=>typeof ne=="string"):[];nt.setState({workspace:{current:m,available:v,hidden:O}});let T=window.localStorage.getItem("beads-ui.workspace");T&&(!v.some(qe=>qe.path===T)||O.includes(T)?window.localStorage.removeItem("beads-ui.workspace"):m&&T!==m.path&&(t("restoring saved workspace preference: %s",T),await Tt(T)))}}catch(y){t("failed to load workspaces: %o",y)}}me.on("workspace-changed",y=>{t("workspace-changed event: %o",y),y&&y.root_dir&&(nt.setState({workspace:{current:{path:y.root_dir,database:y.db_path}}}),Ht(),vt())});let wt=!1;if(typeof me.onConnection=="function"){let y=v=>{t("ws state %s",v),v==="reconnecting"||v==="closed"?(wt=!0,le("Connection lost. Reconnecting\u2026","error",4e3)):v==="open"&&wt&&(wt=!1,le("Reconnected","success",2200),Ag(nt,(m,O)=>{t(`${m}: %o`,O)}),ur())};me.onConnection(y)}let nr="board";try{let y=window.localStorage.getItem("beads-ui.view");(y==="board"||y==="worker"||y==="monitor")&&(nr=y)}catch(y){t("view parse error: %o",y)}let nt=zi({config:xg(),view:nr});me.on("worker-queue-snapshot",y=>{let v=y;if(!v||!v.queue)return;let m=nt.getState().workspace.current?.path;if(typeof m=="string"&&m.length>0&&v.root_dir!==m){t("dropping worker-queue snapshot for %s",String(v.root_dir));return}try{Ce.set(v.queue)}catch{}}),me.on("worker-parallel-analysis-snapshot",y=>{let v=y;if(!v)return;let m=nt.getState().workspace.current?.path;if(!(typeof m=="string"&&m.length>0&&typeof v.root_dir=="string"&&v.root_dir!==m))try{je.set({settings:v.settings,job:v.job??null,runs:Array.isArray(v.runs)?v.runs:[],last_good:v.last_good??null})}catch{}});let Mt=Ui(nt);Mt.start();let kr=new Set(["get-comments","dep-add","dep-remove","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","get-session-defaults","set-session-defaults"]),Gt=async(y,v)=>{try{return await Pe(y,v)}catch(m){if(kr.has(y))throw m;return[]}};n&&ou(n,nt,Mt);let he=document.getElementById("workspace-picker");he&&Hu(he,nt,Tt,dr,wr);let c=cu(e,(y,v)=>Pe(y,v));try{let y=document.getElementById("new-issue-btn");y&&y.addEventListener("click",()=>c.open())}catch{}let _=fu(e,{policyStore:Ye,queueStore:Ce,implPresetStore:Se,transport:(y,v)=>Pe(y,v),onOpenChange:y=>{$=y,P()},labelOptions:()=>{let y=new Set;for(let[v]of Da)for(let m of $e.snapshotFor(v)||[]){let O=m.labels;if(Array.isArray(O))for(let T of O)typeof T=="string"&&T.length>0&&y.add(T)}return Array.from(y).sort()}});try{let y=document.getElementById("display-settings-btn");y&&(y.setAttribute("aria-label","\uC124\uC815"),y.setAttribute("title","\uC124\uC815"),y.addEventListener("click",()=>_.open()))}catch{}let E=rl(o,{gotoIssue:y=>Mt.gotoIssue(y),issueStores:$e,transport:Gt,workerQueueStore:Ce,uiOrderStore:Be,displayPolicyStore:Ye,closedRange:V,onClosedRangeChange:y=>{ve(y)},onNewIssue:()=>c.open()}),H=Oa(a,{transport:Gt,issueStores:$e,queueStore:Ce,analysisStore:je,sessionLogStore:st,uiOrderStore:Be,gotoIssue:y=>nt.setState({selected_id:y}),getWorkspacePath:()=>nt.getState().workspace.current?.path,doneRange:X,onDoneRangeChange:y=>{Ee(y)}}),ie=su(i,{transport:Gt,pipelineStore:xe,execPresetStore:Se,gotoIssue:y=>Mt.gotoIssue(y),getWorkspacePath:()=>nt.getState().workspace.current?.path,switchWorkspace:y=>Tt(y)}),ye=vc(u,{issueStores:$e,transport:Gt,queueStore:Ce,execPresetStore:Se,sessionLogStore:st,getWorkspacePath:()=>nt.getState().workspace.current?.path,onNavigate:y=>{nt.getState().view==="worker"?nt.setState({selected_id:y}):Mt.gotoIssue(y)},onClose:()=>{let y=nt.getState();nt.setState({selected_id:null});try{Mt.gotoView(y.view==="worker"||y.view==="monitor"?y.view:"board")}catch{}},onOpenExecPresets:()=>{_.open("execution")}}),fe=nt.getState().selected_id;fe&&(u.hidden=!1,ye.load(fe),Oe(fe)),nt.subscribe(y=>{let v=y.selected_id;v?(u.hidden=!1,ye.load(v),lt||Oe(v)):(ye.clear(),u.hidden=!0,G())});let Xe=y=>{o.hidden=y.view!=="board",a.hidden=y.view!=="worker",i.hidden=y.view!=="monitor",Ne(y.view==="board"),B(y.view==="worker"),N(y.view==="monitor"),_e(y.view==="board"||y.view==="worker"||$||!!y.selected_id),!y.selected_id&&y.view==="board"&&E.load(),y.view==="worker"&&H.load(),y.view==="monitor"?ie.load():ie.pause(),window.localStorage.setItem("beads-ui.view",y.view)};nt.subscribe(Xe),Xe(nt.getState()),J(),ft(),yt(),Ht().finally(()=>{Re=!0,Ue()}),window.addEventListener("keydown",y=>{let v=y.ctrlKey||y.metaKey,m=String(y.key||"").toLowerCase(),O=y.target,T=O&&O.tagName?String(O.tagName).toLowerCase():"",ne=T==="input"||T==="textarea"||T==="select"||O&&typeof O.isContentEditable=="boolean"&&O.isContentEditable;v&&m==="n"&&(ne||(y.preventDefault(),c.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let e=document.getElementById("theme-switch");e&&e.addEventListener("change",()=>{let r=e.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let t=document.getElementById("app");t&&Eg(t)});export{Eg as bootstrap,xg as readBootstrapConfig,Ag as refreshConfigSnapshot};
