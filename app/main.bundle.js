...
`,e=e.substring(b.length+1),l=!0),!l){let q=this.rules.other.nextBulletRegex(w),U=this.rules.other.hrRegex(w),S=this.rules.other.fencesBeginRegex(w),$=this.rules.other.headingBeginRegex(w),M=this.rules.other.htmlBeginRegex(w);for(;e;){let O=e.split(`
...
`).trim()}}var ml=20;function gl(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function tf(e){return e.length>ml?`${e.slice(0,ml)}\u2026`:e}function rf(e,t,r,n){let s=`${t.lane} ${tf(t.identifier)}`;return i`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${af.map(l=>{let d=l.receipt&&typeof t[l.receipt]=="string"?String(t[l.receipt]):"",_=n[l.id],m=d.length>0||_?.fill==="full",b=!m&&_?.fill==="dim",A=_?.stale===!0;return i`<span
    ...
    `:i``}function _(){ze(d(),e)}async function m(w,q={}){s=w,o="loading",a="",c="",_();let U=r?r():"";if(!U){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",_();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",_();return}let S="/api/doc?workspace="+encodeURIComponent(U)+"&path="+encodeURIComponent(w);try{let $=await n(S),M=await $.json().catch(()=>({}));if(!$.ok||!M||M.ok!==!0){if(M?.error==="not_found"&&q.missing_state==="plan_pending"){o="pending",c="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",_();return}o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(M&&M.error||$.status)+")",_();return}a=String(M.content||""),o="ready",_()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",_()}}function b(){s=null,ze(i``,e)}function A(){document.removeEventListener("keydown",l),b()}return{open:m,close:b,destroy:A}}var gf=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],ql="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function bf(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function hf(e){let t=wt(e);if(t.length>0)return t.map(s=>i`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
  ...
  >`,w=i`<span class="worker-mini__title">${e.title}</span>`,q=e.pr_url&&e.pr_number?i`<a
    ...
    data-lane=${e.lane}
  >
    ${c?i`<div class="worker-mini__row1">${b}${A}${w}</div>
  ...
  </div>`}function Bf(e,t,r=null){let n=e.failed===!0,s=!!e.paused,o=n?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):s?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Wo(t-e.started_at):"\u2014",a=Jt(e),c=gr(e),l=wt(e.usage),d=zt(e.usage),_=e.conflict_resolution?s?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,m=e.base_exception||null,b=e.attempt_id&&e.attempt_id===r,A=e.discard?.action?i`<button
        type="button"
  ...
  >
    ...
    ${a||l.length>0||d||_||m?i`<div class="rtile__meta">
          ...
          ${l.length>0?l.map(w=>i`<span class="worker-usage" title=${w.tooltip}
                    >${w.label}</span
                  >`):d?i`<span
                  class="worker-usage"
                  title=${Hr(e.usage)}
  ...
  `}var i_=[{id:"session",label:"\uC138\uC158",glyph:"\u25C6"},{id:"worker",label:"Worker",glyph:"\u25A4"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}],Kt="";function Zt(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Ec(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(k=>ie(k,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let c="session",l=!1,d="",_={},m={},b=[],A=!1,w=null,q={},U="",S="",$=!1,M=!1,O=!1,I=null;function R(){let k=t.queueStore?.get();return Zt(k)?k.runner_catalog:null}function te(){let k=t.implPresetStore?.get();return Zt(k)&&Array.isArray(k.presets)?k:null}async function ee(){A=!0,re();try{let k=await r("get-session-defaults",{});_=Zt(k?.values)?{...k.values}:{},m={..._},b=Array.isArray(k?.warnings)?k.warnings:[]}catch(k){b=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${k instanceof Error?k.message:String(k)}`)}finally{A=!1,re()}}async function ye(){let k=$l(_,m);if(Object.keys(k).length!==0){try{let F=await r("set-session-defaults",{values:k});_=Zt(F?.values)?{...F.values}:{},m={..._},b=Array.isArray(F?.warnings)?F.warnings:[]}catch(F){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${F instanceof Error?F.message:String(F)}`)}re()}}function ne(k,F){F===Kt?delete m[k]:m[k]=F,re(),ye()}async function ae(){let k=t.queueStore?.get();if(!Zt(k))return;let F={orchestration_model:k.orchestration_model??null,orchestration_effort:k.orchestration_effort??null,orchestration_speed:k.orchestration_speed??null},X=xl(F,{...F,...q});if(Object.keys(X).length!==0){try{let Me=await r("worker-queue-set-orchestration-defaults",{expected_revision:k.revision,values:X});if(Me&&Me.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}q={}}catch(Me){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${Me instanceof Error?Me.message:String(Me)}`)}re()}}function ke(k,F){q[k]=F===Kt?null:F,re(),ae()}async function Be(k){let F=t.queueStore?.get();if(!(!Zt(F)||k<1)){try{await r("worker-queue-set-slots",{expected_revision:F.revision,slots:k})}catch(X){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}re()}}function Ue(){let k={};for(let F of vl){let X=m[F];typeof X=="string"&&X.length>0&&(k[F]=X)}return k}async function Ve(){let k=te();if(!k)return;let F=Ue();if(Object.keys(F).length===0){o("\uC800\uC7A5\uD560 \uAD6C\uD604 \uAC12\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uAD6C\uD604 \uADF8\uB8F9\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let X=(k.presets||[]).find(Le=>Le.id===U),Me=S.trim()||(X?X.name:"");if(!Me){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let Le=X?await r("impl-preset-update",{expected_revision:k.revision,id:X.id,name:Me,settings:F}):await r("impl-preset-create",{expected_revision:k.revision,name:Me,settings:F});if(Le&&Le.applied){if(S="",!X&&Array.isArray(Le.presets)){let Fe=Le.presets.find(Te=>Te.name===Me);U=Fe?Fe.id:U}re()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),re()}catch(Le){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${Le instanceof Error?Le.message:String(Le)}`)}}async function He(){let k=te();if(!(!k||U.length===0))try{let F=await r("impl-preset-delete",{expected_revision:k.revision,id:U});F&&F.applied?(U="",re()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),re())}catch(F){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${F instanceof Error?F.message:String(F)}`)}}async function Qe(){let k=te();if(!(!k||U.length===0)){try{let F=await r("apply-impl-preset-global",{preset_id:U,expected_revision:k.revision});F&&F.applied?(_=Zt(F.values)?{...F.values}:{},m={..._},b=Array.isArray(F.warnings)?F.warnings:[]):F&&F.conflict&&o("\uAD6C\uD604 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(F){o(`\uAD6C\uD604 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${F instanceof Error?F.message:String(F)}`)}re()}}async function Ie(){M=!0,O=!1,re();try{let k=await r("get-worker-system-prompt",{});!k||typeof k!="object"||Array.isArray(k)?O=!0:I=k}catch{O=!0}finally{M=!1,re()}}function ve(){if($=!$,$&&!I){Ie();return}re()}function Ae(){let k=Vr({loading:M,error:O});if(k)return k;if(!I)return"";let F=Array.isArray(I.variants)?I.variants:[];return i`<div class="settings-dialog__sp-body">
    ...
    `}async function P(k){let F=n.get();if(F)try{let X=await r("display-policy-set",{expected_revision:F.revision,policy:k(F)});be(X),X&&X.conflict&&X.policy&&(X=await r("display-policy-set",{expected_revision:X.policy.revision,policy:k(X.policy)}),be(X)),X&&X.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function be(k){k&&k.policy&&typeof k.policy=="object"&&n.set(k.policy)}function Ee(k){P(k)}function L(k){let F=n.get();if(!F)return;let X=!l_(k,F);Ee(Me=>c_(k,Me,X))}function H(){let k=d.trim();k.length!==0&&(d="",Ee(F=>F.hidden_prefixes.includes(k)?{hidden_prefixes:F.hidden_prefixes}:{hidden_prefixes:[...F.hidden_prefixes,k]}),re())}function C(k){Ee(F=>({hidden_prefixes:F.hidden_prefixes.filter(X=>X!==k)}))}function Z(k){let F=n.get();if(!F)return;let X=F.chips[k]===!1;Ee(()=>({chips:{[k]:X}}))}function re(){ze(i`
      ...
      >`}return de()?i`<span class="pa-meta__progress"
        ...
        >`:""}function de(){return n?.isPending?.()===!0}function N(E){let B=m(),Q=(Array.isArray(B.queue)?B.queue.length:0)+(Array.isArray(B.serial_lanes)?B.serial_lanes:[]).reduce((X,Me)=>X+(Array.isArray(Me.entries)?Me.entries.length:0),0),K=!!E.job,k=pe(E.settings),F=K||l||de();return i`<div class="pa-meta">
    ...
    </div>`}function P(E,B){let Q=U(E,B),K=A(),k=Q.filter(Te=>K.has(Te)),F=w(Q),X=S(Q),Me=Array.isArray(m().serial_lanes)?m().serial_lanes:[],Le=c.get(E)||$(),Fe=B.eligible!==!0||Q.length<2||k.length>0||F.length>0||X||l;return i`<section class="pa-group" data-group-index=${String(E)}>
