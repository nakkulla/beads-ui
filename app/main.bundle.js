  ...
  `}var Ji=200,ea={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","deferred-col":"deferred","closed-col":"closed"},ta=new Set(["blocked-col","ready-col","in-progress-col","resolved-col","deferred-col"]),Ws="beads-ui.board.sort",Gs=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function ra(){try{let t=window.localStorage.getItem(Ws);if(t&&Gs.has(t))return t}catch{}return"created_desc"}function js(t,e){let r=xe("views:board"),n=e.gotoIssue,s=e.issueStores,o=e.transport,i=e.uiOrderStore,c=e.displayPolicyStore,a=e.onClosedRangeChange,u=e.onNewIssue,f=e.closedRange||xr,m=s?Cr(s,i):null,w=Rr({transport:o,uiOrderStore:i}),$=[],y=[],E=[],M=[],F=[],B=[],q=!1,D=0,T=ra(),A=new Map,S=new Map,_=new Map,N=new Set,P={search:"",priority:"",type:"",labels:[]},U=!1,X=null;function we(R){return String(R.status||"open")==="open"}function oe(R){let O=String(R.status||"open");return O==="open"||O==="blocked"}function ne(R){let O=P.search.trim().toLowerCase(),J=P.priority,K=P.type,Y=P.labels;return R.filter(Z=>{if(O){let k=String(Z.id||"").toLowerCase(),L=String(Z.title||"").toLowerCase();if(!k.includes(O)&&!L.includes(O))return!1}if(J!==""&&String(Z.priority)!==J||K!==""&&String(Z.issue_type||"")!==K)return!1;if(Y.length>0){let k=Array.isArray(Z.labels)?Z.labels:[];if(!Y.some(L=>k.includes(L)))return!1}return!0})}function rt(){let R=new Set;for(let O of[$,y,E,M,F,B])for(let J of O){let K=Array.isArray(J.labels)?J.labels:[];for(let Y of K)typeof Y=="string"&&Y.length>0&&R.add(Y)}return Array.from(R).sort()}function We(){return P.search.trim()!==""||P.priority!==""||P.type!==""||P.labels.length>0}function Se(){try{if(m){let R=m.selectBoardColumn("tab:board:in-progress","in_progress",T),O=m.selectBoardColumn("tab:board:blocked","blocked",T).filter(oe),J=new Set(R.map(v=>v.id)),K=m.selectBoardColumn("tab:board:ready","ready",T).filter(v=>we(v)&&!J.has(v.id)),Y=m.selectBoardColumn("tab:board:resolved","resolved",T),Z=m.selectBoardColumn("tab:board:deferred","deferred",T),k=q?Z:[],L=m.selectBoardColumn("tab:board:closed","closed").slice(0,Ji),x=[...O,...K,...R,...Y,...k,...L];Ce(x);let l=new Set;for(let v of x)v&&v.id&&!_n(v)&&l.add(v.id);let g=!We();$=g?Yt(O,l):O,y=g?Yt(K,l):K,E=g?Yt(R,l):R,M=g?Yt(Y,l):Y,F=g?Yt(k,l):k,D=Z.length,B=g?Yt(L,l):L,A=new Map;for(let v of $)A.set(v.id,"open");for(let v of y)A.set(v.id,"open");for(let v of E)A.set(v.id,"in_progress");for(let v of M)A.set(v.id,"resolved");for(let v of F)A.set(v.id,"deferred");for(let v of B)A.set(v.id,"closed");S=new Map;for(let v of $)S.set(v.id,"blocked-col");for(let v of y)S.set(v.id,"ready-col");for(let v of E)S.set(v.id,"in-progress-col");for(let v of M)S.set(v.id,"resolved-col");for(let v of F)S.set(v.id,"deferred-col");for(let v of B)S.set(v.id,"closed-col")}Ae()}catch{$=[],y=[],E=[],M=[],F=[],B=[],_=new Map,Ae()}}function Ce(R){let O=new Map;for(let K of R)K&&K.id&&!O.has(K.id)&&O.set(K.id,K);let J=new Map;for(let K of O.values()){let Y=_n(K);if(!Y)continue;let Z=J.get(Y);Z||(Z=[],J.set(Y,Z)),Z.push({id:K.id,title:K.title,status:K.status,metadata:K.metadata,created_at:K.created_at})}_=J}function nt(R){let O=_.get(R)||[],J=0,K=null;for(let Y of O)(Y.status==="resolved"||Y.status==="closed")&&(J+=1),!K&&Y.status==="in_progress"&&(K=Y);return{total:O.length,count:J,current:K,children:O}}function fe(R){return!N.has(R)}function ct(R,O){R.preventDefault(),R.stopPropagation(),N.has(O)?N.delete(O):N.add(O),Ae()}function he(R,O){R.preventDefault(),R.stopPropagation(),n(O)}function Be(R,O){R.preventDefault(),R.stopPropagation(),n(O)}function le(R,O){X||n(O)}function Ge(R,O){R.preventDefault(),R.stopPropagation(),na(O).then(J=>{J&&Q("\uBCF5\uC0AC\uB428","success",1200)})}function ot(R,O){X=O,R.dataTransfer&&(R.dataTransfer.setData("text/plain",O),R.dataTransfer.effectAllowed="move"),R.target.classList.add("board-card--dragging")}function Le(R){R.target.classList.remove("board-card--dragging"),dt(),setTimeout(()=>{X=null},0)}function Me(R){let O=String(R.target.value||"");!O||O===f||(f=O,a&&a(O),Ae())}let ke={onCardClick:le,onCopyId:Ge,onDragStart:ot,onDragEnd:Le,onClosedRangeChange:Me,rollupFor:nt,isExpanded:fe,onRollupToggle:ct,onChildClick:he,onFromChipClick:Be,get policy(){return c?c.get():null}};function je(R){let O=R.target,J=t.querySelector(".board-filter__labels");O&&J&&J.contains(O)||Ye()}function st(R){R.key==="Escape"&&Ye()}function Ne(){U||(U=!0,document.addEventListener("mousedown",je),document.addEventListener("keydown",st),Ae())}function Ye(){U&&(U=!1,document.removeEventListener("mousedown",je),document.removeEventListener("keydown",st),Ae())}let Pe={onSearchInput(R){P.search=String(R.target.value||""),Se()},onPriorityChange(R){P.priority=String(R.target.value||""),Se()},onTypeChange(R){P.type=String(R.target.value||""),Se()},onSortChange(R){let O=String(R.target.value||"");if(!(!Gs.has(O)||O===T)){T=O;try{window.localStorage.setItem(Ws,O)}catch{}Se()}},onDeferredToggle(){q=!q,Se()},onLabelMenuToggle(){U?Ye():Ne()},onLabelToggle(R){let O=P.labels.indexOf(R);O===-1?P.labels.push(R):P.labels.splice(O,1),Se()},onLabelClear(){P.labels.length!==0&&(P.labels=[],Se())},onNewIssue(){u&&u()}};function Qe(){let R=q?"board-root board-root--deferred":"board-root";return d`
    ...
    `}function Ae(){de(Qe(),t),Ie()}function Ie(){try{let R=Array.from(t.querySelectorAll(".board-column"));for(let O of R)Array.from(O.querySelectorAll(".board-card")).forEach((K,Y)=>{K.tabIndex=Y===0?0:-1})}catch{}}async function Je(R,O){if(!o){Q("\uC5F0\uACB0\uB418\uC9C0 \uC54A\uC544 \uC0C1\uD0DC\uB97C \uBCC0\uACBD\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}try{await o("update-status",{id:R,status:O}),Q("\uC0C1\uD0DC \uBCC0\uACBD\uB428","success",1500)}catch(J){r("update-status failed: %o",J),Q("\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328","error")}}function Ue(R){switch(R){case"blocked-col":return $;case"ready-col":return y;case"in-progress-col":return E;case"resolved-col":return M;case"deferred-col":return F;default:return[]}}function ge(R,O,J){if(!o||!i)return;let K=Ue(R),Y=K.find(l=>l.id===O);if(!Y)return;let Z=K.filter(l=>l.id!==O),k=J.closest?J.closest(".board-card"):null,L=Z.length;if(k){let l=k.getAttribute("data-issue-id");if(l===O)return;let g=Z.findIndex(v=>v.id===l);g>=0&&(L=g)}let x=Z.slice();x.splice(L,0,Y),w.applyReorder(O,x,L)}function dt(){for(let R of Array.from(t.querySelectorAll(".board-column--drag-over")))R.classList.remove("board-column--drag-over")}let me=null;t.addEventListener("dragover",R=>{R.preventDefault(),R.dataTransfer&&(R.dataTransfer.dropEffect="move");let J=R.target.closest(".board-column");J&&J!==me&&(me&&me.classList.remove("board-column--drag-over"),J.classList.add("board-column--drag-over"),me=J)}),t.addEventListener("dragleave",R=>{let O=R.relatedTarget;(!O||!t.contains(O))&&me&&(me.classList.remove("board-column--drag-over"),me=null)}),t.addEventListener("drop",R=>{R.preventDefault(),me&&(me.classList.remove("board-column--drag-over"),me=null);let O=R.target,J=O.closest(".board-column");if(!J)return;let K=R.dataTransfer?.getData("text/plain")||"";if(!K)return;let Y=J.id,Z=S.get(K);if(Z&&Z===Y){if(ta.has(Y)){if(T!=="manual"){Q("\uC218\uB3D9(\uB4DC\uB798\uADF8) \uC815\uB82C \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC21C\uC11C\uB97C \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4","warning",2e3);return}ge(Y,K,O)}return}let k=ea[Y];if(!k){Q("\uC5EC\uAE30\uB85C\uB294 \uC62E\uAE38 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","warning",1500);return}A.get(K)!==k&&Je(K,k)}),t.addEventListener("keydown",R=>{let O=R.target;if(!(O instanceof HTMLElement))return;let J=String(O.tagName||"").toLowerCase();if(J==="input"||J==="textarea"||J==="select"||J==="button"||J==="a"||O.isContentEditable===!0)return;let K=O.closest(".board-card");if(!K)return;let Y=String(R.key||"");if(Y==="Enter"||Y===" "){R.preventDefault();let x=K.getAttribute("data-issue-id");x&&n(x);return}if(Y!=="ArrowUp"&&Y!=="ArrowDown"&&Y!=="ArrowLeft"&&Y!=="ArrowRight")return;R.preventDefault();let Z=K.closest(".board-column");if(!Z)return;let k=Array.from(Z.querySelectorAll(".board-card")),L=k.indexOf(K);if(Y==="ArrowDown"&&L<k.length-1){Fe(K,k[L+1]);return}if(Y==="ArrowUp"&&L>0){Fe(K,k[L-1]);return}if(Y==="ArrowLeft"||Y==="ArrowRight"){let x=Array.from(t.querySelectorAll(".board-column")),l=x.indexOf(Z),g=Y==="ArrowRight"?1:-1,v=l+g;for(;v>=0&&v<x.length;){let ee=x[v].querySelector(".board-card");if(ee){Fe(K,ee);return}v+=g}}});function Fe(R,O){try{R.tabIndex=-1,O.tabIndex=0,O.focus()}catch{}}let De=null;m&&m.subscribe&&(De=m.subscribe(()=>{try{Se()}catch{}}));let Oe=null;return c&&c.subscribe&&(Oe=c.subscribe(()=>{try{Se()}catch{}})),{async load(){r("load"),Se()},clear(){Ye(),De&&(De(),De=null),Oe&&(Oe(),Oe=null),t.replaceChildren(),$=[],y=[],E=[],M=[],F=[],B=[],A=new Map,S=new Map}}}function _n(t){let e=t&&t.parent;return typeof e=="string"?e:e&&e.id?String(e.id):""}function Yt(t,e){return t.filter(r=>{let n=_n(r);return!(n&&e.has(n))})}async function na(t){try{if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")return await navigator.clipboard.writeText(String(t)),!0;let e=document.createElement("textarea");e.value=String(t),e.style.position="fixed",e.style.left="-9999px",document.body.appendChild(e),e.select();let r=!1;try{r=document.execCommand("copy")}finally{e.remove()}return r}catch{return!1}}async function Ot(t){let e=String(t);if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{return await navigator.clipboard.writeText(e),!0}catch{}try{let r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.left="-9999px",document.body.appendChild(r),r.select();let n=!1;try{n=document.execCommand("copy")}finally{r.remove()}return n}catch{return!1}}var sa={Read:"\u{1F4D6}",Edit:"\u270E",MultiEdit:"\u270E",Write:"\u{1F4DD}",Bash:"\u26A1",Grep:"\u{1F50E}",Glob:"\u{1F50E}",Task:"\u{1F916}",WebFetch:"\u{1F310}",WebSearch:"\u{1F310}"},oa=/^\s*([✓✗⊘])\s*(spec|impl|implementation|plan)\s*게이트\s*[—–-]\s*(\S+)\s+(APPROVE|REVISE|REJECT|BLOCK|SKIP)(?:\s*·\s*(.+))?/,ia=/^\s*#{0,3}\s*Phase\s+\d+(?:\s*\/\s*\d+)?\s*(?:[·:—–-]\s*.+)?$/;function yt(t){return!!t&&typeof t=="object"}function mn(t){return typeof t!="string"||t.length===0?[]:t.split(/\r?\n/)}function Ys(t,e){let r=mn(t),n=mn(e),s=new Map;for(let c of r)s.set(c,(s.get(c)||0)+1);let o=0;for(let c of n){let a=s.get(c)||0;a>0?s.set(c,a-1):o+=1}let i=0;for(let c of s.values())i+=c;return{added:o,removed:i}}function aa(t){let e="";typeof t=="string"?e=t:Array.isArray(t)?e=t.map(s=>yt(s)&&typeof s.text=="string"?s.text:"").join(""):yt(t)&&typeof t.text=="string"&&(e=t.text);let n=(String(e).split(/\r?\n/).find(s=>s.trim().length>0)||"").trim();return n.length>120?`${n.slice(0,117)}\u2026`:n}function la(t){let e=String(t.name||""),r=t.input||{},n={kind:"tool",tool:e,icon:sa[e]||"\u{1F527}",input:r,expandable:!0};if((e==="Read"||e==="Write")&&(n.path=String(r.file_path||r.path||"")),e==="Write"&&(n.added=mn(r.content).length),e==="Edit"){n.path=String(r.file_path||r.path||"");let{added:s,removed:o}=Ys(r.old_string,r.new_string);n.added=s,n.removed=o}if(e==="MultiEdit"){n.path=String(r.file_path||r.path||"");let s=0,o=0,i=Array.isArray(r.edits)?r.edits:[];for(let c of i){let a=Ys(yt(c)?c.old_string:"",yt(c)?c.new_string:"");s+=a.added,o+=a.removed}n.added=s,n.removed=o}return e==="Bash"&&(n.command=String(r.command||"")),(e==="Grep"||e==="Glob")&&(n.command=String(r.pattern||r.query||"")),n}function Vs(t){let e=t.split(/\r?\n/).find(n=>n.trim().length>0)||"",r=oa.exec(e);return r?{kind:"gate",gate:r[2]==="implementation"?"impl":r[2],reviewer:r[3],verdict:r[4],time:r[5]?r[5].trim():void 0,text:e.trim()}:ia.test(e)&&e.trim().length<=80?{kind:"phase",text:e.trim()}:{kind:"assistant",text:t}}function ca(t,e){if(t.type==="assistant"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[],s=[];for(let o of n)if(yt(o)){if(o.type==="text"&&typeof o.text=="string")s.push(Vs(o.text));else if(o.type==="tool_use"){let i=la(o);typeof o.id=="string"&&e.set(o.id,i),s.push(i)}}return s}if(t.type==="user"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[];for(let s of n)if(yt(s)&&s.type==="tool_result"){let o=e.get(String(s.tool_use_id));if(o){let i=aa(s.content);o.result=i,o.output=typeof s.content=="string"?s.content:i}}return[]}if(t.type==="result"){let r=t.is_error===!1&&t.subtype==="success";return[{kind:"result",success:r,text:typeof t.result=="string"?t.result:r?"DONE":""}]}return[]}function da(t){if(t.type==="item.completed"&&yt(t.item)){let e=t.item;return e.type==="agent_message"&&typeof e.text=="string"?[Vs(e.text)]:e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}if(t.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(t.type==="turn.failed"){let e=t.error;return[{kind:"error",text:e&&typeof e.message=="string"?e.message:"turn failed"}]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:[]}function ua(t){let e=t.type;return typeof e=="string"&&(e==="error"||e.startsWith("thread.")||e.startsWith("turn.")||e.startsWith("item."))}function Ks(t){let e=[],r=new Map,n=Array.isArray(t)?t:[];for(let s of n){let o=s;if(typeof s=="string"){let c=s.trim();if(c.length===0)continue;try{o=JSON.parse(c)}catch{continue}}if(!yt(o))continue;let i=ua(o)?da(o):ca(o,r);for(let c of i)e.push(c)}return e}function Dr(t,e={}){let{transport:r,sessionLogStore:n,onClose:s}=e,o=null,i={},c=!0,a=new Set,u=null;function f(){if(!o||!n)return[];let S=n.get(o);return Ks(S?S.lines:[])}function m(S,_){if(_.kind==="gate")return d`<div class="sv__gate">${_.text}</div>`;if(_.kind==="phase")return d`<div class="sv__phase">${_.text}</div>`;if(_.kind==="result")return d`<div
      ...
      >
        ...
        ${N?d`<pre class="sv__tool-expand">${w(_)}</pre>`:""}
...
`)}function $(){if(!o)return d``;let S=f(),_=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),N=i.session_id||"",P=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`;return d`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
${u}`:u,s=s?`${s}
${f}`:f;let m=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(f,o,!0),this.lexer.state.top=m,r.length===0)break;let w=o.at(-1);if(w?.type==="code")break;if(w?.type==="blockquote"){let $=w,y=$.raw+`
`+r.join(`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+bt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},Mt=new ml;function ce(t,e){return Mt.parse(t,e)}ce.options=ce.setOptions=function(t){return Mt.setOptions(t),ce.defaults=Mt.defaults,yo(ce.defaults),ce};ce.getDefaults=Mn;ce.defaults=Nt;ce.use=function(...t){return Mt.use(...t),ce.defaults=Mt.defaults,yo(ce.defaults),ce};ce.walkTokens=function(t,e){return Mt.walkTokens(t,e)};ce.parseInline=Mt.parseInline;ce.Parser=ht;ce.parser=ht.parse;ce.Renderer=Hr;ce.TextRenderer=Hn;ce.Lexer=ft;ce.lexer=ft.lex;ce.Tokenizer=zr;ce.Hooks=_r;ce.parse=ce;var Cd=ce.options,Rd=ce.setOptions,Ld=ce.use,Id=ce.walkTokens,Dd=ce.parseInline;var Od=ht.parse,Md=ft.lex;function Io(t){let e=ce.parse(t),r=uo.sanitize(e);return ho(r)}function bl(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function Do(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",c="";function a(y){y.key==="Escape"&&s&&(y.preventDefault(),w())}document.addEventListener("keydown",a);function u(){return s?d`
    ...
    `:d``}function f(){de(u(),t)}async function m(y){s=y,o="loading",i="",c="",f();let E=r?r():"";if(!E){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",f();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",f();return}let M="/api/doc?workspace="+encodeURIComponent(E)+"&path="+encodeURIComponent(y);try{let F=await n(M),B=await F.json().catch(()=>({}));if(!F.ok||!B||B.ok!==!0){o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(B&&B.error||F.status)+")",f();return}i=String(B.content||""),o="ready",f()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",f()}}function w(){s=null,de(d``,t)}function $(){document.removeEventListener("keydown",a),w()}return{open:m,close:w,destroy:$}}var wl={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function kl(t){if(typeof t!="number"||!Number.isFinite(t))return"";let e=new Date(t),r=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${r}:${n}`}function Oo(t,e={}){let r=Array.isArray(t)?t:[];if(r.length===0)return d`
  ...
  `}var yl=["open","in_progress","deferred","resolved","closed"],vl=[0,1,2,3,4];function Mo(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,c=e.sessionLogStore,a=null,u=null,f={},m=!1,w=!1,$="",y="",E="";function M(){m=!1,w=!1,$="",y="",E=""}let F=document.createElement("div");F.className="md-viewer-root",document.body.appendChild(F);let B=Do(F,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),q=document.createElement("div");q.className="session-log-root",document.body.appendChild(q);let D=Dr(q,{transport:s?(k,L)=>Promise.resolve(s(k,L)):void 0,sessionLogStore:c});function T(){if(!i||!a)return[];let k=i.get();return(k&&k.attempts?Object.values(k.attempts):[]).filter(x=>x&&x.bead_id===a).sort((x,l)=>(l.started_at||0)-(x.started_at||0)).map(x=>({attempt_id:x.attempt_id,bead_id:x.bead_id,status:x.status,started_at:typeof x.started_at=="number"?x.started_at:null,runner:x.runner||null,model:x.model||null,session_id:x.session_id||null,resumed_from:x.resumed_from||null,dismissed_at:typeof x.dismissed_at=="number"?x.dismissed_at:null,cause:typeof x.cause=="string"?x.cause:null,cause_detail:x.cause_detail||null}))}function A(k){let L=i?i.get():null,x=L&&L.attempts?L.attempts[k]:null;D.open({attempt_id:k,meta:x?{runner:x.runner||void 0,model:x.model||void 0,effort:x.effort||void 0,status:x.status||void 0,session_id:x.session_id||void 0}:{}})}async function S(k){if(!s||!k)return;let L=()=>{let l=i?i.get():null;return l&&typeof l.revision=="number"?l.revision:0},x=await s("worker-attempt-resume",{attempt_id:k,expected_revision:L()});if(x&&x.conflict){let l=x.queue&&typeof x.queue.revision=="number"?x.queue.revision:L();x=await s("worker-attempt-resume",{attempt_id:k,expected_revision:l})}x&&x.resumed===!1&&!x.conflict&&x.reason&&Q(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${x.reason}`,"error",2400)}let _={onOpen:A,onResume:S};function N(){let k=i?i.get():null,L=k&&k.exec_defaults;return L&&typeof L=="object"?L:{}}let P=null;r&&r.subscribe&&(P=r.subscribe(()=>we()));let U=null;i&&typeof i.subscribe=="function"&&(U=i.subscribe(()=>{a&&Z()}));function X(k){k.key==="Escape"&&a&&(k.preventDefault(),n())}document.addEventListener("keydown",X);function we(){if(a){if(r&&typeof r.snapshotFor=="function"){let k=r.snapshotFor("detail:"+a)||[];u=k.find(x=>x&&x.id===a)||k[0]||u}Z()}}function oe(k){Ot(k).then(L=>{L?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ne(k){k.preventDefault(),k.stopPropagation(),a&&oe(a)}function rt(k,L){k.preventDefault(),k.stopPropagation(),oe(L)}function We(k,L){k.preventDefault(),k.stopPropagation(),B.open(L)}function Se(k,L){f[k]=L,Z(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:k,value:L})).catch(()=>{Q("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function Ce(k,L,x){if(!s||!a)return!1;try{let l=await Promise.resolve(s(k,L)),g=Array.isArray(l)?l[0]:l;return g&&typeof g=="object"&&g.id?(u=g,!0):(Q(x,"error"),!1)}catch{return Q(x,"error"),!1}}function nt(k){setTimeout(()=>{try{let L=t.querySelector(k);L&&typeof L.focus=="function"&&L.focus()}catch{}},0)}function fe(){m=!0,$=u&&u.title||"",Z(),nt('.detail-edit__input[data-edit="title"]')}function ct(k){$=k.target.value}function he(){m=!1,$="",Z()}function Be(){Ce("edit-text",{id:a,field:"title",value:$},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(L=>{L&&(m=!1,$=""),Z()})}function le(){w=!0,y=u&&u.description||"",Z(),nt('.detail-edit__textarea[data-edit="description"]')}function Ge(k){y=k.target.value}function ot(){w=!1,y="",Z()}function Le(){Ce("edit-text",{id:a,field:"description",value:y},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(L=>{L&&(w=!1,y=""),Z()})}function Me(k,L,x,l){if(k.key==="Escape"){k.stopPropagation(),x();return}k.key==="Enter"&&(!l||k.ctrlKey||k.metaKey)&&(k.preventDefault(),L())}function ke(k){let L=k.target.value;Ce("update-status",{id:a,status:L},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>Z())}function je(k){let L=Number(k.target.value);Ce("update-priority",{id:a,priority:L},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>Z())}function st(k){E=k.target.value}function Ne(){let k=E.trim();k.length!==0&&Ce("label-add",{id:a,label:k},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(L=>{L&&(E=""),Z()})}function Ye(k){if(k.key==="Escape"){k.stopPropagation(),E="",Z();return}k.key==="Enter"&&(k.preventDefault(),Ne())}function Pe(k){Ce("label-remove",{id:a,label:k},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>Z())}let Qe={onCopyPath:rt,onOpenDoc:We},Ae={onChange:Se};function Ie(k){return typeof k=="string"?k:k&&typeof k=="object"?String(k.id||k.to||k.issue_id||k.depends_on||""):""}function Je(k){switch(k&&typeof k=="object"?String(k.dependency_type||k.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Ue(k){let x=(Array.isArray(k.dependencies)?k.dependencies:[]).map(l=>({id:Ie(l),icon:Je(l)})).filter(l=>l.id.length>0);return d`
    ...
    `}let dt={route:["spec_backed","full_plan"]};async function me(k,L){let x=L.target.value;if(k==="route"&&u&&u.metadata&&u.metadata.route==="full_plan"&&x!=="full_plan"&&!window.confirm(`full_plan \u2192 ${x||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){Z();return}await Ce("update-workflow-meta",{id:a,key:k,value:x},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),Z()}function Fe(k){let L=k.metadata||{};return d` ${((l,g)=>{let v=dt[l],ee=typeof L[l]=="string"?L[l]:"";return d`<div class="detail-kv">
      ...
      </div>`})("route","(\uBBF8\uC124\uC815 \xB7 \uCD94\uB860)")} `}function De(k){return m?d`
    ...
    `}function Y(){if(!a)return d``;let k=u||{},L=String(k.id||a),x=k.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",l=k.status||"open",g=typeof k.priority=="number"?Math.max(0,Math.min(4,k.priority)):"",v=k.description||"",ee={...k,metadata:{...k.metadata||{},...f}};return d`
    ...
    `}function Z(){de(Y(),t)}return{load(k){k!==a&&(f={},M()),a=k,u=null,we()},clear(){a=null,u=null,f={},M(),B.close(),D.close(),de(d``,t)},destroy(){P&&(P(),P=null),U&&(U(),U=null),document.removeEventListener("keydown",X),B.destroy(),F.parentNode&&F.parentNode.removeChild(F),D.destroy(),q.parentNode&&q.parentNode.removeChild(q),a=null,u=null,de(d``,t)}}}var $l=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function No(t,e){return fn(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function xl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function Po(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function c(A){let S=r.get();if(S)try{let _=await n("display-policy-set",{expected_revision:S.revision,policy:A(S)});a(_),_&&_.conflict&&_.policy&&(_=await n("display-policy-set",{expected_revision:_.policy.revision,policy:A(_.policy)}),a(_)),_&&_.conflict&&Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(A){A&&A.policy&&typeof A.policy=="object"&&r.set(A.policy)}function u(A){let S=r.get();if(!S)return;let _=No(A,S)!=="shown";c(N=>xl(A,N,_))}function f(){let A=i.trim();A.length!==0&&(i="",c(S=>S.hidden_prefixes.includes(A)?{hidden_prefixes:S.hidden_prefixes}:{hidden_prefixes:[...S.hidden_prefixes,A]}),M())}function m(A){c(S=>({hidden_prefixes:S.hidden_prefixes.filter(_=>_!==A)}))}function w(A){let S=r.get();if(!S)return;let _=S.chips[A]===!1;c(()=>({chips:{[A]:_}}))}function $(A){let S=s();return d`
      <section class="display-settings__section">
        ...
        ${S.length===0?d`<div class="display-settings__empty">라벨 없음</div>`:d`<div class="display-settings__pills">
              ${S.map(_=>{let N=No(_,A);return d`<button
                  type="button"
    ...
    `}function E(A){return d`
      <section class="display-settings__section">
        ...
        <div class="display-settings__toggles">
          ${$l.map(([S,_])=>d`<label class="display-settings__toggle">
                <input
                  type="checkbox"
                  data-chip=${S}
                  .checked=${A.chips[S]!==!1}
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),c=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),f=r.querySelector("#btn-cancel"),m=r.querySelector("#btn-create"),w=r.querySelector(".new-issue__close");function $(){o.replaceChildren();let T=document.createElement("option");T.value="",T.textContent="\u2014 Select \u2014",o.appendChild(T);for(let A of Bo){let S=document.createElement("option");S.value=A,S.textContent=Uo(A),o.appendChild(S)}i.replaceChildren();for(let A=0;A<=4;A+=1){let S=document.createElement("option");S.value=String(A);let _=zo[A]||"Medium";S.textContent=`${A} \u2013 ${_}`,i.appendChild(S)}}$();function y(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function E(T){s.disabled=T,o.disabled=T,i.disabled=T,c.disabled=T,a.disabled=T,f.disabled=T,m.disabled=T,m.textContent=T?"Creating\u2026":"Create"}function M(){u.textContent=""}function F(T){u.textContent=T}function B(){try{let T=window.localStorage.getItem("beads-ui.new.type");T?o.value=T:o.value="";let A=window.localStorage.getItem("beads-ui.new.priority");A&&/^\d$/.test(A)?i.value=A:i.value="2"}catch{o.value="",i.value="2"}}function q(){let T=o.value||"",A=i.value||"";T.length>0&&window.localStorage.setItem("beads-ui.new.type",T),A.length>0&&window.localStorage.setItem("beads-ui.new.priority",A)}async function D(){M();let T=String(s.value||"").trim();if(T.length===0){F("Title is required"),s.focus();return}let A=Number(i.value||"2");if(!(A>=0&&A<=4)){F("Priority must be 0..4"),i.focus();return}let S=String(o.value||""),_=String(a.value||""),N={title:T};S.length>0&&(N.type=S),String(A).length>0&&(N.priority=A),_.length>0&&(N.description=_),E(!0);try{await e("create-issue",N)}catch{E(!1),F("Failed to create issue");return}q(),E(!1),y()}return r.addEventListener("cancel",T=>{T.preventDefault(),y()}),w.addEventListener("click",()=>y()),f.addEventListener("click",()=>y()),r.addEventListener("keydown",T=>{T.key==="Enter"&&(T.ctrlKey||T.metaKey)&&(T.preventDefault(),D())}),n.addEventListener("submit",T=>{T.preventDefault(),D()}),{open(){n.reset(),M(),B();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){y()}}}function Wo(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function Go(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var Sl={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},Al=[{key:"orchestration_model",values:()=>bn},{key:"orchestration_effort",values:()=>wn},{key:"review_model",values:()=>kn},{key:"impl_model",values:()=>yn}];function jo(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function c(){let _=i();return typeof _.revision=="number"?_.revision:0}function a(){let _=i().exec_defaults;return _&&typeof _=="object"?_:{}}function u(_){_&&_.queue&&r&&r.set(_.queue)}async function f(_,N){if(!n)return;let P={key:_,value:N||null};try{let U=await n("worker-queue-set-exec-default",{...P,expected_revision:c()});u(U),U&&U.conflict&&(U=await n("worker-queue-set-exec-default",{...P,expected_revision:c()}),u(U)),U&&U.conflict&&Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function m(_,N,P){let U=!!P&&!N.includes(P);return d`<div class="exec-defaults__row">
      ...
      >
        ...
        ${N.map(X=>d`<option value=${X} ?selected=${P===X}>${X}</option>`)}
      </select>
    </div>`}function w(){let _=i().workspace_info;return _&&typeof _=="object"?_:{}}function $(_,N){return d`<span
      class="exec-defaults__vd-badge exec-defaults__vd-badge--${_}"
      >${N}</span
    >`}function y(_){let N=_?Go(_.cmd):"",P=_?Wo(_.timeout_ms):"",U=s&&s()||"<workspace \uACBD\uB85C>";return d`<div class="exec-defaults__vd-group" data-vd="verify">
    ...
    </div>`}function E(_){let N=_?Go(_.cmd):"",P=_?Wo(_.timeout_ms):"",U=P?`timeout ${P} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",X=s&&s()||"<workspace \uACBD\uB85C>";return d`<div class="exec-defaults__vd-group" data-vd="deploy">
    ...
    </div>`}function M(_){if(!_||typeof _!="object")return"";let N=Sl[String(_.outcome)];if(!N)return"";let P=_.outcome==="failed"&&_.reason?`${N.label} \xB7 ${_.reason}`:N.label,U=[kt(_.at),typeof _.bead_id=="string"?_.bead_id:"",typeof _.base_sha=="string"?_.base_sha.slice(0,7):""].filter(X=>X.length>0).join(" \xB7 ");return d`<div class="exec-defaults__vd-group" data-vd="last-deploy">
      ...
      ${M(_.last_deploy)}
        ...
        <div class="exec-defaults__container">
          ...
          <div class="exec-defaults__body">
            ...
            ${Al.map(N=>m(N.key,N.values(),_[N.key]||""))}
            ${F(w())}
          </div>
        </div>
...
${Tl}`:r}function Wn(t,e){let r=null;for(let n of Object.values(t||{}))n&&n.bead_id===e&&(r=n.usage||null);return r}function Gn(t){let e=t.draggable&&!t.done,r=Array.isArray(t.badges)?t.badges:[],n=Kt(t.usage),s=t.merge_step||null,o=t.lane==="pr_wait"||!!t.revise_action,i=e?d`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",c=d`<span class="worker-mini__id" title="클릭하면 ID 복사"
  ...
  >`,a=d`<span class="worker-mini__title">${t.title}</span>`,u=t.pr_url&&t.pr_number?d`<a
        ...
        >`:d`<span
          ...
          >${q}</span
        >`),m=t.reason?d`<span class="worker-mini__reason">${t.reason}</span>`:"",w=n?d`<span class="worker-usage" title=${jr(t.usage)}
        >${n}</span
      ...
      >
        취소
      </button>`:"",M=t.discard_action?d`<button
        type="button"
...
${qe.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:j==="done"?Wn(l.attempts||{},ie.bead_id):null}}),xt=l.attempts?Object.values(l.attempts):[],qt=new Set;for(let C of xt)C&&typeof C.resumed_from=="string"&&C.resumed_from.length>0&&qt.add(C.resumed_from);let Xt=new Map;for(let C of xt)Xt.set(C.bead_id,C.attempt_id);let Qt=new Map;for(let C of xt)Qt.set(C.attempt_id,C);function Kr(C){let j=new Set,ie=C;for(;ie&&!j.has(ie.attempt_id);){if(ie.conflict_resolution===!0)return!0;j.add(ie.attempt_id),ie=typeof ie.resumed_from=="string"&&ie.resumed_from.length>0&&Qt.get(ie.resumed_from)||null}return!1}let H=[],p=null;for(let C of xt){let j=C.status==="paused"&&!qt.has(C.attempt_id);C.status==="running"||j?H.push({bead_id:C.bead_id,attempt_id:C.attempt_id,title:re.get(C.bead_id)||C.bead_id,runner:C.runner||null,model:C.model||null,effort:C.effort||null,started_at:typeof C.started_at=="number"?C.started_at:null,resumed_from:C.resumed_from||null,paused:j,conflict_resolution:Kr(C),can_pause:typeof C.session_id=="string"&&C.session_id.length>0,usage:C.usage||null}):(C.status==="failed"||C.status==="orphaned")&&!(Xt.get(C.bead_id)!==C.attempt_id)&&typeof C.dismissed_at!="number"&&(p=C)}let I=null;if(p){let C=typeof p.session_id=="string"&&p.session_id.length>0,j=qt.has(p.attempt_id),ie=p.cause_detail;I={repo:p.repo||"",reason:p.cause||p.status,cause_detail:ie&&typeof ie.reason=="string"?{reason:ie.reason,command:typeof ie.command=="string"?ie.command:null}:null,resume_attempt_id:p.attempt_id,resume_eligible:C&&!j,resume_reason:C?j?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let z=new Set(H.map(C=>C.bead_id)),ue=Array.isArray(l.merge_queue)?l.merge_queue:[],Re=new Map;ue.forEach((C,j)=>{C&&typeof C.bead_id=="string"&&Re.set(C.bead_id,j+1)});let be=l.merge_queue_state||{active:null,failures:{}},He=be.failures||{},et=new Map;for(let C of H)C.conflict_resolution&&(C.paused?et.has(C.bead_id)||et.set(C.bead_id,"paused"):et.set(C.bead_id,"running"));let Bt=H.filter(C=>!C.paused).length,Ee=(l.workspace_info||{}).slots,Jt=typeof Ee=="number"?Ee:typeof l.slots=="number"?l.slots:Yr,vr=Bt>Jt,ts=at(l.done,"done"),rs=0,ns=0,Zr=!1;for(let C of ts){let j=C.usage;j&&typeof j=="object"&&(Number.isFinite(j.input_tokens)&&(rs+=j.input_tokens,Zr=!0),Number.isFinite(j.output_tokens)&&(ns+=j.output_tokens,Zr=!0))}let li=Zr?Kt({input_tokens:rs,output_tokens:ns}):null;return{queue:l,idToTitle:re,candidates:Zt,candidate_hidden:{blocked:Ft.hidden_blocked,spec:Ft.hidden_spec},running:H,live_count:Bt,slots:Jt,over_cap:vr,failure:I,waiting:at(G.filter(C=>!z.has(C.bead_id)),"queue"),pr_wait:ye.map(C=>nc(C.bead_id,re.get(C.bead_id)||C.bead_id,ve,ze[C.bead_id]||null,Wn(l.attempts||{},C.bead_id),$e[C.bead_id]||(F.has(C.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),et.get(C.bead_id)||null,C.external===!0,{position:Re.get(C.bead_id)||0,active:be.active===C.bead_id,failure:He[C.bead_id]||null},C.wt_present!==!1)),merge_queue_length:ue.length,merge_queue_running:ue.length>0,done:ts,token_total:li,cleanup_failures:_t,ship_failure:b}}function Ye(l){let g=l.waiting.length>0?l.waiting[0].id:"\u2014",v=d`<button
    ...
    >
      ...
      >
        ⚙
      </button>`,ve=Vo({failure:l.failure,cleanupFailures:l.cleanup_failures,shipFailure:l.ship_failure});return M?d`<div class="worker-ribbon">
          ${v}
    ...
    >
      ...
      <div class="worker-filter__spec" role="group" aria-label="spec 필터">
        ${zl.map(v=>d`<button
              type="button"
              class="worker-filter__chip${$.spec===v.value?" is-active":""}"
              data-spec=${v.value}
      ...
      .value=${y}
    >
      ${Hl.map(l=>d`<option value=${l.value} ?selected=${y===l.value}>
            ${l.label}
          </option>`)}
    ...
    >
      일괄 머지 ${g}
    </button>`}function Je(l){let g=vt({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:l.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Ae(),controls:Qe(l)});return M?d`<div class="worker-lanes worker-lanes--mobile">
        ${Pe(l)}
    ...
    `}function D(){let A=e.getState(),S=A.workspace?.current,_=A.workspace?.available||[],N=new Set(A.workspace?.hidden||[]),P=S?.path||_[0]?.path||"";if(_.length===0)return d``;let U=_.filter(X=>!N.has(X.path)||X.path===P);if(U.length<=1){let X=U[0]||_[0],we=Qn(X.path);return d`
    ...
    `}function T(){de(D(),t)}return T(),i=e.subscribe(()=>T()),{destroy(){i&&(i(),i=null),document.removeEventListener("mousedown",w),document.removeEventListener("keydown",$),de(d``,t)}}}var ei=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-queue-set-slots","worker-queue-set-exec-default","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-merge-queue-add","worker-merge-queue-add-all","worker-merge-queue-remove","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append"];function Jn(){let t=Date.now().toString(36),e=Math.random().toString(36).slice(2,8);return`${t}-${e}`}function ti(t,e,r=Jn()){return{id:r,type:t,payload:e}}function ri(t={}){let e=xe("ws"),r={initialMs:t.backoff?.initialMs??1e3,maxMs:t.backoff?.maxMs??3e4,factor:t.backoff?.factor??2,jitterRatio:t.backoff?.jitterRatio??.2},n=()=>t.url&&t.url.length>0?t.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",i=0,c=null,a=!0,u=new Map,f=[],m=new Map,w=new Set;function $(D){for(let T of Array.from(w))try{T(D)}catch{}}function y(){if(!a||c)return;o="reconnecting",e("ws reconnecting\u2026"),$(o);let D=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,i)),T=(r.jitterRatio||0)*D,A=Math.max(0,Math.round(D+(Math.random()*2-1)*T));e("ws retry in %d ms (attempt %d)",A,i+1),c=setTimeout(()=>{c=null,q()},A)}function E(D){try{s?.send(JSON.stringify(D))}catch(T){e("ws send failed",T)}}function M(){for(o="open",e("ws open"),$(o),i=0;f.length;){let D=f.shift();D&&E(D)}}function F(D){let T;try{T=JSON.parse(String(D.data))}catch{e("ws received non-JSON message");return}if(!T||typeof T.id!="string"||typeof T.type!="string"){e("ws received invalid envelope");return}if(u.has(T.id)){let S=u.get(T.id);u.delete(T.id),T.ok?S?.resolve(T.payload):S?.reject(T.error||new Error("ws error"));return}let A=m.get(T.type);if(A&&A.size>0)for(let S of Array.from(A))try{S(T.payload)}catch(_){e("ws event handler error",_)}else e("ws received unhandled message type: %s",T.type)}function B(){o="closed",e("ws closed"),$(o);for(let[D,T]of u.entries())T.reject(new Error("ws disconnected")),u.delete(D);i+=1,y()}function q(){if(!a)return;let D=n();try{s=new WebSocket(D),e("ws connecting %s",D),o="connecting",$(o),s.addEventListener("open",M),s.addEventListener("message",F),s.addEventListener("error",()=>{}),s.addEventListener("close",B)}catch(T){e("ws connect failed %o",T),y()}}return q(),{send(D,T){if(!ei.includes(D))return Promise.reject(new Error(`unknown message type: ${D}`));let A=Jn(),S=ti(D,T,A);return e("send %s id=%s",D,A),new Promise((_,N)=>{u.set(A,{resolve:_,reject:N,type:D}),s&&s.readyState===s.OPEN?E(S):(e("queue %s id=%s (state=%s)",D,A,o),f.push(S))})},on(D,T){m.has(D)||m.set(D,new Set);let A=m.get(D);return A?.add(T),()=>{A?.delete(T)}},onConnection(D){return w.add(D),()=>{w.delete(D)}},reconnect(){a=!0,c&&(clearTimeout(c),c=null),i=0,q()},close(){a=!1,c&&(clearTimeout(c),c=null);try{s?.close()}catch{}},getState(){return o}}}function sc(){let t=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof t?.workspace_config?.default_workspace=="string"&&t.workspace_config.default_workspace.length>0?t.workspace_config.default_workspace:null}}}async function oc(t,e){try{let n=await(await fetch("/api/config")).json();t.setState({config:n})}catch(r){e("config refresh failed",r)}}var es=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],ni=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"]],si="worker:queue",oi="ui:order",ii="ui:display-policy",$t="tab:board:closed",ai="beads-ui.board.closed-range";function ic(t){let e=xe("main");e("bootstrap start");let r=d`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;de(r,t);let n=document.getElementById("top-nav"),s=document.getElementById("board-root"),o=document.getElementById("worker-root"),i=document.getElementById("detail-panel");if(s&&o&&i){let _=function(h,b){let G="Request failed",W="";if(h&&typeof h=="object"){let V=h;if(typeof V.message=="string"&&V.message.length>0&&(G=V.message),typeof V.details=="string")W=V.details;else if(V.details&&typeof V.details=="object")try{W=JSON.stringify(V.details,null,2)}catch{W=""}}else typeof h=="string"&&h.length>0&&(G=h);let te=b&&b.length>0?`Failed to load ${b}`:"Request failed";S.open(te,G,W)},le=function(h){return`${x.getState().workspace.current?.path||""}\0${h}`},Ge=function(){We&&(We().catch(()=>{}),We=null),Se=null,Ce=null},Le=function(h){nt=h;let b=()=>{nt!==h||x.getState().selected_id!==h||(nt=null,ot(h))};if(!he){ct.then(b);return}b()},st=function(){let h=_s(je);return h===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:h}}},Ne=function(h){if(h)for(let[b,G]of es){if(Me.has(b)||ke.has(b))continue;let W=b===$t?st():{type:G};try{X.register(b,W)}catch(te){e("register %s store failed: %o",b,te)}ke.add(b),U.subscribeList(b,W).then(te=>{Me.set(b,te)}).catch(te=>{e("subscribe %s failed: %o",b,te),_(te,"board")}).finally(()=>{ke.delete(b)})}else Pe()},Pe=function(){for(let[h]of es){let b=Me.get(h);b&&(b().catch(()=>{}),Me.delete(h));try{X.unregister(h)}catch(G){e("unregister %s failed: %o",h,G)}}},Ie=function(h){if(!h){Je();return}for(let[b,G]of ni)if(!(Qe.has(b)||ke.has(b))){try{X.register(b,{type:G})}catch(W){e("register %s store failed: %o",b,W)}ke.add(b),U.subscribeList(b,{type:G}).then(W=>{Qe.set(b,W)}).catch(W=>{e("subscribe %s failed: %o",b,W),_(W,"worker")}).finally(()=>{ke.delete(b)})}Ae||(P("subscribe-worker-queue",{id:si}).catch(b=>{e("subscribe-worker-queue failed: %o",b)}),Ae=()=>P("unsubscribe-worker-queue",{id:si}))},Je=function(){for(let[h]of ni){let b=Qe.get(h);b&&(b().catch(()=>{}),Qe.delete(h));try{X.unregister(h)}catch(G){e("unregister %s failed: %o",h,G)}}Ae&&(Ae().catch(()=>{}),Ae=null)},ge=function(){Ue||(P("subscribe-ui-order",{id:oi}).catch(h=>{e("subscribe-ui-order failed: %o",h)}),Ue=()=>P("unsubscribe-ui-order",{id:oi}))},dt=function(){Ue&&(Ue().catch(()=>{}),Ue=null),oe.clear()},Fe=function(){me||(P("subscribe-display-policy",{id:ii}).catch(h=>{e("subscribe-display-policy failed: %o",h)}),me=()=>P("unsubscribe-display-policy",{id:ii}))},De=function(){me&&(me().catch(()=>{}),me=null),ne.clear()},Y=function(h){if(!h)return"Unknown";let b=h.split("/").filter(Boolean);return b.length>0?b[b.length-1]:"Unknown"};var c=_,a=le,u=Ge,f=Le,m=st,w=Ne,$=Pe,y=Ie,E=Je,M=ge,F=dt,B=Fe,q=De,D=Y;let T=document.getElementById("header-loading"),A=qs(T),S=Fo(t),N=ri(),P=A.wrapSend((h,b)=>N.send(h,b)),U=Is(P),X=Ds(),we=Ms(),oe=Os(),ne=ms(),rt=bs();N.on("ui-order-snapshot",h=>{let b=h;if(b&&typeof b.revision=="number")try{oe.set({revision:b.revision,order:b.order&&typeof b.order=="object"?b.order:{}})}catch{}}),N.on("display-policy-snapshot",h=>{let b=h;if(b&&b.policy&&typeof b.policy=="object")try{ne.set(b.policy)}catch{}}),N.on("session-log-snapshot",h=>{let b=h;if(b&&typeof b.attempt_id=="string")try{rt.set(b.attempt_id,Array.isArray(b.lines)?b.lines:[])}catch{}}),N.on("session-log-append",h=>{let b=h;if(b&&typeof b.attempt_id=="string")try{rt.append(b.attempt_id,b.event)}catch{}}),N.on("snapshot",h=>{let b=h,G=b&&typeof b.id=="string"?b.id:"",W=G?X.getStore(G):null;if(W&&b&&b.type==="snapshot")try{W.applyPush(b)}catch{}}),N.on("upsert",h=>{let b=h,G=b&&typeof b.id=="string"?b.id:"",W=G?X.getStore(G):null;if(W&&b&&b.type==="upsert")try{W.applyPush(b)}catch{}}),N.on("delete",h=>{let b=h,G=b&&typeof b.id=="string"?b.id:"",W=G?X.getStore(G):null;if(W&&b&&b.type==="delete")try{W.applyPush(b)}catch{}});let We=null,Se=null,Ce=null,nt=null,fe=()=>{},ct=new Promise(h=>{fe=()=>h(void 0)}),he=!1,Be=!1;async function ot(h){let b=le(h);if(b===Se||b===Ce)return;Ce=b;let G=`detail:${h}`,W={type:"issue-detail",params:{id:h}};try{X.register(G,W)}catch(te){e("register detail store failed: %o",te)}try{let te=await U.subscribeList(G,W);if(x.getState().selected_id!==h||le(h)!==b){await te().catch(()=>{});return}We&&await We().catch(()=>{}),We=te,Se=b}catch(te){e("detail subscribe failed: %o",te),_(te,"issue details")}finally{Ce===b&&(Ce=null)}}let Me=new Map,ke=new Set,je=xr;try{let h=window.localStorage.getItem(ai);ln(h)&&(je=h)}catch{}async function Ye(h){if(!ln(h)||h===je)return;je=h;try{window.localStorage.setItem(ai,h)}catch{}let b=Me.get($t);if(!b)return;Me.delete($t),await b().catch(()=>{});let G=st();try{X.register($t,G)}catch(W){e("register %s store failed: %o",$t,W)}try{let W=await U.subscribeList($t,G);Me.set($t,W)}catch(W){e("re-subscribe %s failed: %o",$t,W),_(W,"board")}}let Qe=new Map,Ae=null,Ue=null,me=null;async function Oe(){me=null,ne.clear(),Ae=null;let h=x.getState().workspace.current?.path;if(h)try{await N.send("set-workspace",{path:h})}catch(b){e("workspace restore after reconnect failed: %o",b);return}Fe(),Ie(x.getState().view==="worker")}async function R(){e("clearing all subscriptions for workspace switch"),Pe(),Je(),we.clear(),dt(),ge(),De(),Fe(),Ge();let h=x.getState();if(h.selected_id)try{X.unregister(`detail:${h.selected_id}`)}catch{}let b=x.getState();Ne(b.view==="board"),Ie(b.view==="worker"),b.selected_id&&Le(b.selected_id)}async function O(h){e("requesting workspace switch to %s",h),Be=!0;try{let b=await N.send("set-workspace",{path:h});e("workspace switch result: %o",b),b&&b.workspace&&(x.setState({workspace:{current:{path:b.workspace.root_dir,database:b.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",h),b.changed&&(await R(),Q("Switched to "+Y(h),"success",2e3)))}catch(b){throw e("workspace switch failed: %o",b),Q("Failed to switch workspace","error",3e3),b}finally{Be=!1}}async function J(h){e("requesting workspace git pull for %s",h);try{let b=await N.send("git-pull-workspace",{});e("workspace git pull result: %o",b);let G=b?.status;if(G==="up_to_date"){Q("Already up to date","success",2e3);return}if(G==="stash_pop_conflict"){Q("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}Q("Git pulled "+Y(h),"success",2e3)}catch(b){e("workspace git pull failed: %o",b);let G=b?.code,W=b?.message;if(G==="rebase_conflict"){Q("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(G==="rebase_conflict_abort_failed"){Q("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(G==="busy"){Q("Git pull skipped: another operation is running","warning",3e3);return}let te=W?`: ${W}`:"";throw Q(`Git pull failed${te}`,"error",3e3),b}}async function K(h,b){e("setting workspace visibility %s \u2192 %s",h,String(b));try{await N.send("set-workspace-visibility",{path:h,visible:b}),await Z()}catch(G){e("workspace visibility update failed: %o",G),Q("Failed to update project visibility","error",3e3)}}async function Z(){try{let h=await N.send("list-workspaces",{});if(e("workspaces loaded: %o",h),h&&Array.isArray(h.workspaces)){let b=h.workspaces.map(V=>({path:V.path,database:V.database,pid:V.pid,version:V.version})),G=h.current?{path:h.current.root_dir,database:h.current.db_path}:null,W=Array.isArray(h.hidden)?h.hidden.filter(V=>typeof V=="string"):[];x.setState({workspace:{current:G,available:b,hidden:W}});let te=window.localStorage.getItem("beads-ui.workspace");te&&(!b.some(_e=>_e.path===te)||W.includes(te)?window.localStorage.removeItem("beads-ui.workspace"):G&&te!==G.path&&(e("restoring saved workspace preference: %s",te),await O(te)))}}catch(h){e("failed to load workspaces: %o",h)}}N.on("workspace-changed",h=>{e("workspace-changed event: %o",h),h&&h.root_dir&&(x.setState({workspace:{current:{path:h.root_dir,database:h.db_path}}}),Z(),R())});let k=!1;if(typeof N.onConnection=="function"){let h=b=>{e("ws state %s",b),b==="reconnecting"||b==="closed"?(k=!0,Q("Connection lost. Reconnecting\u2026","error",4e3)):b==="open"&&k&&(k=!1,Q("Reconnected","success",2200),oc(x,(G,W)=>{e(`${G}: %o`,W)}),Oe())};N.onConnection(h)}let L="board";try{let h=window.localStorage.getItem("beads-ui.view");(h==="board"||h==="worker")&&(L=h)}catch(h){e("view parse error: %o",h)}let x=Fs({config:sc(),view:L});N.on("worker-queue-snapshot",h=>{let b=h;if(!b||!b.queue)return;let G=x.getState().workspace.current?.path;if(typeof G=="string"&&G.length>0&&b.root_dir!==G){e("dropping worker-queue snapshot for %s",String(b.root_dir));return}try{we.set(b.queue)}catch{}});let l=Ns(x);l.start();let g=async(h,b)=>{try{return await P(h,b)}catch{return[]}};n&&qo(n,x,l);let v=document.getElementById("workspace-picker");v&&Jo(v,x,O,J,K);let ee=Ho(t,(h,b)=>P(h,b));try{let h=document.getElementById("new-issue-btn");h&&h.addEventListener("click",()=>ee.open())}catch{}let re=Po(t,{policyStore:ne,transport:(h,b)=>P(h,b),labelOptions:()=>{let h=new Set;for(let[b]of es)for(let G of X.snapshotFor(b)||[]){let W=G.labels;if(Array.isArray(W))for(let te of W)typeof te=="string"&&te.length>0&&h.add(te)}return Array.from(h).sort()}});try{let h=document.getElementById("display-settings-btn");h&&h.addEventListener("click",()=>re.open())}catch{}let ye=js(s,{gotoIssue:h=>l.gotoIssue(h),issueStores:X,transport:g,uiOrderStore:oe,displayPolicyStore:ne,closedRange:je,onClosedRangeChange:h=>{Ye(h)},onNewIssue:()=>ee.open()}),ve=Xn(o,{transport:g,issueStores:X,queueStore:we,sessionLogStore:rt,uiOrderStore:oe,gotoIssue:h=>x.setState({selected_id:h}),getWorkspacePath:()=>x.getState().workspace.current?.path}),$e=Mo(i,{issueStores:X,transport:g,queueStore:we,sessionLogStore:rt,getWorkspacePath:()=>x.getState().workspace.current?.path,onNavigate:h=>{x.getState().view==="worker"?x.setState({selected_id:h}):l.gotoIssue(h)},onClose:()=>{let h=x.getState();x.setState({selected_id:null});try{l.gotoView(h.view==="worker"?"worker":"board")}catch{}}}),ze=x.getState().selected_id;ze&&(i.hidden=!1,$e.load(ze),Le(ze)),x.subscribe(h=>{let b=h.selected_id;b?(i.hidden=!1,$e.load(b),Be||Le(b)):($e.clear(),i.hidden=!0,Ge())});let _t=h=>{s.hidden=h.view!=="board",o.hidden=h.view!=="worker",Ne(h.view==="board"),Ie(h.view==="worker"),!h.selected_id&&h.view==="board"&&ye.load(),h.view==="worker"&&ve.load(),window.localStorage.setItem("beads-ui.view",h.view)};x.subscribe(_t),_t(x.getState()),ge(),Fe(),Z().finally(()=>{he=!0,fe()}),window.addEventListener("keydown",h=>{let b=h.ctrlKey||h.metaKey,G=String(h.key||"").toLowerCase(),W=h.target,te=W&&W.tagName?String(W.tagName).toLowerCase():"",V=te==="input"||te==="textarea"||te==="select"||W&&typeof W.isContentEditable=="boolean"&&W.isContentEditable;b&&G==="n"&&(V||(h.preventDefault(),ee.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let t=document.getElementById("theme-switch");t&&t.addEventListener("change",()=>{let r=t.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let e=document.getElementById("app");e&&ic(e)});export{ic as bootstrap,sc as readBootstrapConfig,oc as refreshConfigSnapshot};
