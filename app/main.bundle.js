...
`)}function v(){if(!o)return p``;let x=h(),_=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),O=i.session_id||"",N=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`;return p`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
${u}`:u,s=s?`${s}
${h}`:h;let g=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,o,!0),this.lexer.state.top=g,r.length===0)break;let w=o.at(-1);if(w?.type==="code")break;if(w?.type==="blockquote"){let v=w,y=v.raw+`
`+r.join(`
`),C=this.blockquote(y);o[o.length-1]=C,n=n.substring(0,n.length-v.raw.length)+C.raw,s=s.substring(0,s.length-v.text.length)+C.text;break}else if(w?.type==="list"){let v=w,y=v.raw+`
`+r.join(`
`),C=this.list(y);o[o.length-1]=C,n=n.substring(0,n.length-w.raw.length)+C.raw,s=s.substring(0,s.length-v.raw.length)+C.raw,r=y.substring(o.at(-1).raw.length).split(`
...
`,1)[0],v=!g.trim(),y=0;if(this.options.pedantic?(y=2,h=g.trimStart()):v?y=e[1].length+1:(y=e[2].search(this.rules.other.nonSpaceChar),y=y>4?1:y,h=g.slice(y),y+=e[1].length),v&&this.rules.other.blankLine.test(w)&&(u+=w+`
...
`+A.slice(y);else{if(v||g.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||P.test(g)||B.test(g)||M.test(g))break;h+=`
`+w}!v&&!w.trim()&&(v=!0),u+=D+`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+gt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},It=new al;function le(t,e){return It.parse(t,e)}le.options=le.setOptions=function(t){return It.setOptions(t),le.defaults=It.defaults,uo(le.defaults),le};le.getDefaults=Cn;le.defaults=Dt;le.use=function(...t){return It.use(...t),le.defaults=It.defaults,uo(le.defaults),le};le.walkTokens=function(t,e){return It.walkTokens(t,e)};le.parseInline=It.parseInline;le.Parser=pt;le.parser=pt.parse;le.Renderer=Fr;le.TextRenderer=Pn;le.Lexer=ut;le.lexer=ut.lex;le.Tokenizer=Pr;le.Hooks=ur;le.parse=le;var md=le.options,_d=le.setOptions,bd=le.use,wd=le.walkTokens,kd=le.parseInline;var yd=pt.parse,vd=ut.lex;function vo(t){let e=le.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",c="";function a(y){y.key==="Escape"&&s&&(y.preventDefault(),w())}document.addEventListener("keydown",a);function u(){return s?p`
    ...
    `:p``}function h(){de(u(),t)}async function g(y){s=y,o="loading",i="",c="",h();let C=r?r():"";if(!C){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",h();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",h();return}let M="/api/doc?workspace="+encodeURIComponent(C)+"&path="+encodeURIComponent(y);try{let P=await n(M),B=await P.json().catch(()=>({}));if(!P.ok||!B||B.ok!==!0){o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(B&&B.error||P.status)+")",h();return}i=String(B.content||""),o="ready",h()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",h()}}function w(){s=null,de(p``,t)}function v(){document.removeEventListener("keydown",a),w()}return{open:g,close:w,destroy:v}}var cl={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function dl(t){if(typeof t!="number"||!Number.isFinite(t))return"";let e=new Date(t),r=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${r}:${n}`}function xo(t,e={}){let r=Array.isArray(t)?t:[];if(r.length===0)return p`
  ...
  `}var ul=["open","in_progress","deferred","resolved","closed"],pl=[0,1,2,3,4];function So(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,c=e.sessionLogStore,a=null,u=null,h={},g=!1,w=!1,v="",y="",C="";function M(){g=!1,w=!1,v="",y="",C=""}let P=document.createElement("div");P.className="md-viewer-root",document.body.appendChild(P);let B=$o(P,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),q=document.createElement("div");q.className="session-log-root",document.body.appendChild(q);let D=Er(q,{transport:s?(l,b)=>Promise.resolve(s(l,b)):void 0,sessionLogStore:c});function A(){if(!i||!a)return[];let l=i.get();return(l&&l.attempts?Object.values(l.attempts):[]).filter($=>$&&$.bead_id===a).sort(($,T)=>(T.started_at||0)-($.started_at||0)).map($=>({attempt_id:$.attempt_id,bead_id:$.bead_id,status:$.status,started_at:typeof $.started_at=="number"?$.started_at:null,runner:$.runner||null,model:$.model||null,session_id:$.session_id||null,resumed_from:$.resumed_from||null,dismissed_at:typeof $.dismissed_at=="number"?$.dismissed_at:null,cause:typeof $.cause=="string"?$.cause:null,cause_detail:$.cause_detail||null}))}function S(l){let b=i?i.get():null,$=b&&b.attempts?b.attempts[l]:null;D.open({attempt_id:l,meta:$?{runner:$.runner||void 0,model:$.model||void 0,effort:$.effort||void 0,status:$.status||void 0,session_id:$.session_id||void 0}:{}})}async function x(l){if(!s||!l)return;let b=()=>{let T=i?i.get():null;return T&&typeof T.revision=="number"?T.revision:0},$=await s("worker-attempt-resume",{attempt_id:l,expected_revision:b()});if($&&$.conflict){let T=$.queue&&typeof $.queue.revision=="number"?$.queue.revision:b();$=await s("worker-attempt-resume",{attempt_id:l,expected_revision:T})}$&&$.resumed===!1&&!$.conflict&&$.reason&&Z(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${$.reason}`,"error",2400)}let _={onOpen:S,onResume:x};function O(){let l=i?i.get():null,b=l&&l.exec_defaults;return b&&typeof b=="object"?b:{}}let N=null;r&&r.subscribe&&(N=r.subscribe(()=>ke()));let z=null;i&&typeof i.subscribe=="function"&&(z=i.subscribe(()=>{a&&d()}));function K(l){l.key==="Escape"&&a&&(l.preventDefault(),n())}document.addEventListener("keydown",K);function ke(){if(a){if(r&&typeof r.snapshotFor=="function"){let l=r.snapshotFor("detail:"+a)||[];u=l.find($=>$&&$.id===a)||l[0]||u}d()}}function oe(l){Lt(l).then(b=>{b?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ee(l){l.preventDefault(),l.stopPropagation(),a&&oe(a)}function Xe(l,b){l.preventDefault(),l.stopPropagation(),oe(b)}function qe(l,b){l.preventDefault(),l.stopPropagation(),B.open(b)}function ve(l,b){h[l]=b,d(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:l,value:b})).catch(()=>{Z("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function Ae(l,b,$){if(!s||!a)return!1;try{let T=await Promise.resolve(s(l,b)),W=Array.isArray(T)?T[0]:T;return W&&typeof W=="object"&&W.id?(u=W,!0):(Z($,"error"),!1)}catch{return Z($,"error"),!1}}function Qe(l){setTimeout(()=>{try{let b=t.querySelector(l);b&&typeof b.focus=="function"&&b.focus()}catch{}},0)}function fe(){g=!0,v=u&&u.title||"",d(),Qe('.detail-edit__input[data-edit="title"]')}function ot(l){v=l.target.value}function he(){g=!1,v="",d()}function Je(){Ae("edit-text",{id:a,field:"title",value:v},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(b=>{b&&(g=!1,v=""),d()})}function ae(){w=!0,y=u&&u.description||"",d(),Qe('.detail-edit__textarea[data-edit="description"]')}function Fe(l){y=l.target.value}function rt(){w=!1,y="",d()}function Ce(){Ae("edit-text",{id:a,field:"description",value:y},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(b=>{b&&(w=!1,y=""),d()})}function Le(l,b,$,T){if(l.key==="Escape"){l.stopPropagation(),$();return}l.key==="Enter"&&(!T||l.ctrlKey||l.metaKey)&&(l.preventDefault(),b())}function $e(l){let b=l.target.value;Ae("update-status",{id:a,status:b},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function Ue(l){let b=Number(l.target.value);Ae("update-priority",{id:a,priority:b},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function et(l){C=l.target.value}function Ie(){let l=C.trim();l.length!==0&&Ae("label-add",{id:a,label:l},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(b=>{b&&(C=""),d()})}function ze(l){if(l.key==="Escape"){l.stopPropagation(),C="",d();return}l.key==="Enter"&&(l.preventDefault(),Ie())}function De(l){Ae("label-remove",{id:a,label:l},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>d())}let ce={onCopyPath:Xe,onOpenDoc:qe},xe={onChange:ve};function Oe(l){return typeof l=="string"?l:l&&typeof l=="object"?String(l.id||l.to||l.issue_id||l.depends_on||""):""}function He(l){switch(l&&typeof l=="object"?String(l.dependency_type||l.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Me(l){let $=(Array.isArray(l.dependencies)?l.dependencies:[]).map(T=>({id:Oe(T),icon:He(T)})).filter(T=>T.id.length>0);return p`
      <div class="detail-section-label">의존성</div>
      ${$.length===0?p`<div class="detail-empty">의존성 없음</div>`:p`<div class="detail-deps">
            ${$.map(T=>o?p`<button
                    type="button"
    ...
    `}function tt(l){let b=l.metadata||{},$=l.workflow||{},T=$.stages||{},W=T.spec&&T.spec.stale,Q=T.impl&&T.impl.stale,F=$.route_source==="derived",ue=$.route||b.route||"\u2014";return p`
    ...
    `}let it={route:["spec_backed","full_plan"]};async function me(l,b){let $=b.target.value;if(l==="route"&&u&&u.metadata&&u.metadata.route==="full_plan"&&$!=="full_plan"&&!window.confirm(`full_plan \u2192 ${$||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){d();return}await Ae("update-workflow-meta",{id:a,key:l,value:$},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),d()}function Ne(l){let b=l.metadata||{};return p` ${((T,W)=>{let Q=it[T],F=typeof b[T]=="string"?b[T]:"";return p`<div class="detail-kv">
    ...
    `}function Re(l){let b=bt(l.created_at),$=bt(l.updated_at);return!b&&!$?p``:p`
    ...
    `}function R(l,b){return p`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${$e}
        >
          ${ul.map($=>p`<option value=${$} ?selected=${$===l}>${$}</option>`)}
        </select>
      </div>
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Ue}
        >
          ${pl.map($=>p`<option value=${String($)} ?selected=${$===b}>
                P${$}
              </option>`)}
        </select>
      </div>
    ...
    `}function X(l){let b=Array.isArray(l.labels)?l.labels:[];return p`
      ...
      <div class="detail-labels">
        ${b.map($=>p`<span class="detail-label-chip"
              >${$}<button
                type="button"
    ...
    `}function V(){if(!a)return p``;let l=u||{},b=String(l.id||a),$=l.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",T=l.status||"open",W=typeof l.priority=="number"?Math.max(0,Math.min(4,l.priority)):"",Q=l.description||"",F={...l,metadata:{...l.metadata||{},...h}};return p`
    ...
    `}function d(){de(V(),t)}return{load(l){l!==a&&(h={},M()),a=l,u=null,ke()},clear(){a=null,u=null,h={},M(),B.close(),D.close(),de(p``,t)},destroy(){N&&(N(),N=null),z&&(z(),z=null),document.removeEventListener("keydown",K),B.destroy(),P.parentNode&&P.parentNode.removeChild(P),D.destroy(),q.parentNode&&q.parentNode.removeChild(q),a=null,u=null,de(p``,t)}}}var fl=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function To(t,e){return an(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function hl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function Ao(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function c(S){let x=r.get();if(x)try{let _=await n("display-policy-set",{expected_revision:x.revision,policy:S(x)});a(_),_&&_.conflict&&_.policy&&(_=await n("display-policy-set",{expected_revision:_.policy.revision,policy:S(_.policy)}),a(_)),_&&_.conflict&&Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(S){S&&S.policy&&typeof S.policy=="object"&&r.set(S.policy)}function u(S){let x=r.get();if(!x)return;let _=To(S,x)!=="shown";c(O=>hl(S,O,_))}function h(){let S=i.trim();S.length!==0&&(i="",c(x=>x.hidden_prefixes.includes(S)?{hidden_prefixes:x.hidden_prefixes}:{hidden_prefixes:[...x.hidden_prefixes,S]}),M())}function g(S){c(x=>({hidden_prefixes:x.hidden_prefixes.filter(_=>_!==S)}))}function w(S){let x=r.get();if(!x)return;let _=x.chips[S]===!1;c(()=>({chips:{[S]:_}}))}function v(S){let x=s();return p`
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),c=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),h=r.querySelector("#btn-cancel"),g=r.querySelector("#btn-create"),w=r.querySelector(".new-issue__close");function v(){o.replaceChildren();let A=document.createElement("option");A.value="",A.textContent="\u2014 Select \u2014",o.appendChild(A);for(let S of Ro){let x=document.createElement("option");x.value=S,x.textContent=Lo(S),o.appendChild(x)}i.replaceChildren();for(let S=0;S<=4;S+=1){let x=document.createElement("option");x.value=String(S);let _=Io[S]||"Medium";x.textContent=`${S} \u2013 ${_}`,i.appendChild(x)}}v();function y(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function C(A){s.disabled=A,o.disabled=A,i.disabled=A,c.disabled=A,a.disabled=A,h.disabled=A,g.disabled=A,g.textContent=A?"Creating\u2026":"Create"}function M(){u.textContent=""}function P(A){u.textContent=A}function B(){try{let A=window.localStorage.getItem("beads-ui.new.type");A?o.value=A:o.value="";let S=window.localStorage.getItem("beads-ui.new.priority");S&&/^\d$/.test(S)?i.value=S:i.value="2"}catch{o.value="",i.value="2"}}function q(){let A=o.value||"",S=i.value||"";A.length>0&&window.localStorage.setItem("beads-ui.new.type",A),S.length>0&&window.localStorage.setItem("beads-ui.new.priority",S)}async function D(){M();let A=String(s.value||"").trim();if(A.length===0){P("Title is required"),s.focus();return}let S=Number(i.value||"2");if(!(S>=0&&S<=4)){P("Priority must be 0..4"),i.focus();return}let x=String(o.value||""),_=String(a.value||""),O={title:A};x.length>0&&(O.type=x),String(S).length>0&&(O.priority=S),_.length>0&&(O.description=_),C(!0);try{await e("create-issue",O)}catch{C(!1),P("Failed to create issue");return}q(),C(!1),y()}return r.addEventListener("cancel",A=>{A.preventDefault(),y()}),w.addEventListener("click",()=>y()),h.addEventListener("click",()=>y()),r.addEventListener("keydown",A=>{A.key==="Enter"&&(A.ctrlKey||A.metaKey)&&(A.preventDefault(),D())}),n.addEventListener("submit",A=>{A.preventDefault(),D()}),{open(){n.reset(),M(),B();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){y()}}}function Oo(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function Mo(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var gl={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},ml=[{key:"orchestration_model",values:()=>pn},{key:"orchestration_effort",values:()=>fn},{key:"review_model",values:()=>hn},{key:"impl_model",values:()=>gn}];function No(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function c(){let _=i();return typeof _.revision=="number"?_.revision:0}function a(){let _=i().exec_defaults;return _&&typeof _=="object"?_:{}}function u(_){_&&_.queue&&r&&r.set(_.queue)}async function h(_,O){if(!n)return;let N={key:_,value:O||null};try{let z=await n("worker-queue-set-exec-default",{...N,expected_revision:c()});u(z),z&&z.conflict&&(z=await n("worker-queue-set-exec-default",{...N,expected_revision:c()}),u(z)),z&&z.conflict&&Z("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function g(_,O,N){let z=!!N&&!O.includes(N);return p`<div class="exec-defaults__row">
    ...
    </div>`}function w(){let _=i().workspace_info;return _&&typeof _=="object"?_:{}}function v(_,O){return p`<span
      class="exec-defaults__vd-badge exec-defaults__vd-badge--${_}"
      >${O}</span
    >`}function y(_){let O=_?Mo(_.cmd):"",N=_?Oo(_.timeout_ms):"",z=!!_&&_.source==="detected";return p`<div class="exec-defaults__vd-group" data-vd="verify">
      <div class="exec-defaults__vd-label">머지 전 검증 (verify)</div>
      ${O?p`<div class="exec-defaults__vd-line">
            <span class="exec-defaults__vd-cmd">${O}</span>
            ${z?v("detected","\uC790\uB3D9\uAC10\uC9C0"):v("config","config")}
    ...
    </div>`}function C(_){let O=_?Mo(_.cmd):"",N=_?Oo(_.timeout_ms):"",z=N?`timeout ${N} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",K=s&&s()||"<workspace \uACBD\uB85C>";return p`<div class="exec-defaults__vd-group" data-vd="deploy">
      <div class="exec-defaults__vd-label">머지 후 배포 (deploy)</div>
      ${O?p`<div class="exec-defaults__vd-line">
            <span class="exec-defaults__vd-cmd">${O}</span>
            ${v("config","config")}
            ${_.detached===!0?v("detached","detached"):""}
...
${se.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:j==="done"?Fn(d.attempts||{},ne.bead_id):null}}),We=d.attempts?Object.values(d.attempts):[],lt=new Set;for(let E of We)E&&typeof E.resumed_from=="string"&&E.resumed_from.length>0&&lt.add(E.resumed_from);let Wt=new Map;for(let E of We)Wt.set(E.bead_id,E.attempt_id);let Gt=new Map;for(let E of We)Gt.set(E.attempt_id,E);function jt(E){let j=new Set,ne=E;for(;ne&&!j.has(ne.attempt_id);){if(ne.conflict_resolution===!0)return!0;j.add(ne.attempt_id),ne=typeof ne.resumed_from=="string"&&ne.resumed_from.length>0&&Gt.get(ne.resumed_from)||null}return!1}let mt=[],Te=null;for(let E of We){let j=E.status==="paused"&&!lt.has(E.attempt_id);E.status==="running"||j?mt.push({bead_id:E.bead_id,attempt_id:E.attempt_id,title:T.get(E.bead_id)||E.bead_id,runner:E.runner||null,model:E.model||null,effort:E.effort||null,started_at:typeof E.started_at=="number"?E.started_at:null,resumed_from:E.resumed_from||null,paused:j,conflict_resolution:jt(E),can_pause:typeof E.session_id=="string"&&E.session_id.length>0,usage:E.usage||null}):(E.status==="failed"||E.status==="orphaned")&&!(Wt.get(E.bead_id)!==E.attempt_id)&&typeof E.dismissed_at!="number"&&(Te=E)}let Yt=null;if(Te){let E=typeof Te.session_id=="string"&&Te.session_id.length>0,j=lt.has(Te.attempt_id),ne=Te.cause_detail;Yt={repo:Te.repo||"",reason:Te.cause||Te.status,cause_detail:ne&&typeof ne.reason=="string"?{reason:ne.reason,command:typeof ne.command=="string"?ne.command:null}:null,resume_attempt_id:Te.attempt_id,resume_eligible:E&&!j,resume_reason:E?j?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let mr=new Set(mt.map(E=>E.bead_id)),vt=new Map;for(let E of mt)E.conflict_resolution&&(E.paused?vt.has(E.bead_id)||vt.set(E.bead_id,"paused"):vt.set(E.bead_id,"running"));let _r=mt.filter(E=>!E.paused).length,H=(d.workspace_info||{}).slots,f=typeof H=="number"?H:typeof d.slots=="number"?d.slots:zr,L=_r>f,U=gr(d.done,"done"),ge=0,Ee=0,we=!1;for(let E of U){let j=E.usage;j&&typeof j=="object"&&(Number.isFinite(j.input_tokens)&&(ge+=j.input_tokens,we=!0),Number.isFinite(j.output_tokens)&&(Ee+=j.output_tokens,we=!0))}let Be=we?Ht({input_tokens:ge,output_tokens:Ee}):null;return{queue:d,idToTitle:T,candidates:be,candidate_hidden:{blocked:J.hidden_blocked,spec:J.hidden_spec},running:mt,live_count:_r,slots:f,over_cap:L,failure:Yt,waiting:gr(nt.filter(E=>!mr.has(E.bead_id)),"queue"),pr_wait:W.map(E=>Wl(E.bead_id,T.get(E.bead_id)||E.bead_id,Q,ue[E.bead_id]||null,Fn(d.attempts||{},E.bead_id),F[E.bead_id]||(P.has(E.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),vt.get(E.bead_id)||null,E.external===!0)),done:U,token_total:Be,cleanup_failures:at}}function $e(d){let l=d.waiting.length>0?d.waiting[0].id:"\u2014",b=p`<button
    ...
    >
      ...
      >
        ⚙
          ...
          ${b}
          <div class="worker-kpi worker-kpi--ribbon">${$}${T}</div>
        </div>
    ...
    >
      ...
      <div class="worker-filter__spec" role="group" aria-label="spec 필터">
        ${Rl.map(b=>p`<button
              type="button"
              class="worker-filter__chip${v.spec===b.value?" is-active":""}"
              data-spec=${b.value}
    ...
    </div>`}function De(d){C={...C,[d]:!C[d]},Nl(C),ce()}function ce(){let d=Le();de($e(d),A),de(ze(d),O)}function xe(){let d=document.querySelector(".app-header");if(!d)return;let l=()=>{let b=Math.round(d.getBoundingClientRect().height);D.style.setProperty("--worker-ribbon-top",`${b}px`)};if(l(),typeof ResizeObserver=="function"){let b=new ResizeObserver(l);b.observe(d),q.push(()=>b.disconnect())}else window.addEventListener("resize",l),q.push(()=>window.removeEventListener("resize",l))}function Oe(){if(typeof window.matchMedia!="function")return;let d=window.matchMedia(Ol);M=!!d.matches;let l=b=>{let $=!!(b&&typeof b.matches=="boolean"?b.matches:d.matches);$!==M&&(M=$,ce())};typeof d.addEventListener=="function"?(d.addEventListener("change",l),q.push(()=>d.removeEventListener("change",l))):typeof d.addListener=="function"&&(d.addListener(l),q.push(()=>d.removeListener(l)))}function He(d){let l=d.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!l)return;let b=l.dataset.beadId||"",$=l.dataset.lane||"";g={bead_id:b,from_lane:$};try{d.dataTransfer?.setData("text/plain",b),d.dataTransfer&&(d.dataTransfer.effectAllowed="move")}catch{}}function Me(d){let l=d.target?.closest?.(".worker-pane");if(!l)return;let b=l.dataset.lane||"";b!=="candidate"&&b!=="queue"||(d.preventDefault(),d.dataTransfer&&(d.dataTransfer.dropEffect="move"),l.classList.add("worker-pane--drag-over"))}function tt(d){d.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function it(d,l){let b=w.find(Q=>Q.id===d);if(!b)return;let $=w.filter(Q=>Q.id!==d),T=$.length;if(l){let Q=l.dataset.beadId;if(Q===d)return;let F=$.findIndex(ue=>ue.id===Q);F>=0&&(T=F)}let W=$.slice();W.splice(T,0,b),h.applyReorder(d,W,T)}function me(d){let l=d.target?.closest?.(".worker-pane");if(!l)return;d.preventDefault(),l.classList.remove("worker-pane--drag-over");let b=l.dataset.lane||"",$=g?.bead_id||d.dataTransfer?.getData("text/plain")||"",T=g?.from_lane||"";if(g=null,!$)return;let W=d.target?.closest?.(".worker-mini, .worker-card"),Q=Array.from(l.querySelectorAll(".worker-mini, .worker-card")),F=Q.length;if(W){let ue=Q.indexOf(W);ue>=0&&(F=ue)}if(l.classList.contains("worker-pane--collapsed")&&(F=Xe()),b==="candidate"){if(T==="candidate"){it($,W);return}T==="queue"&&Ae($);return}b==="queue"&&(T==="queue"?ve($,F):qe($,F))}function Ne(d){v=d,El(d),ce()}function Pe(d){y=d==="board"||d==="created"||d==="spec"?d:Hr,Dl(y),ce()}function Re(d){let l=d.target?.closest?.(".worker-filter__blocked");if(l){Ne({...v,show_blocked:l.checked});return}let b=d.target?.closest?.(".worker-sort");if(b){Pe(b.value||Hr);return}let $=d.target?.closest?.(".worker-slots__input");if(!$)return;let T=Number.parseInt($.value,10);if(!Number.isFinite(T)){ce();return}Ce(T).then(ce)}function R(d){return d?{runner:d.runner||void 0,model:d.model||void 0,effort:d.effort||void 0,worktree:d.worktree||void 0,status:d.status||void 0,session_id:d.session_id||void 0}:{}}function I(d){let l=ke(),b=l.attempts?l.attempts[d]:null;N=d,S.hidden=!1,z.open({attempt_id:d,meta:R(b)}),ce()}function X(){if(!N)return;let d=ke(),l=d.attempts?d.attempts[N]:null;if(l){z.updateMeta(R(l));return}z.close()}function V(d){let l=d.target;if(l?.closest?.("#worker-exec-defaults-dialog"))return;if(l?.closest?.(".worker-exec-defaults-btn")){K.open();return}let b=l?.closest?.(".worker-banner__resume");if(b){let te=b.dataset.attemptId;te&&ot(te);return}let $=l?.closest?.(".worker-banner__dismiss");if($){let te=$.dataset.attemptId;te&&he(te);return}if(l?.closest?.(".worker-play")){rt(!ke().auto_advance);return}let T=l?.closest?.(".worker-pane__hd--toggle");if(T){let te=T.dataset.lane;(te==="queue"||te==="done")&&De(te);return}let W=l?.closest?.(".worker-card__place");if(W){let te=W.dataset.beadId;te&&!W.disabled&&qe(te,Xe());return}let Q=l?.closest?.(".worker-filter__chip");if(Q){let te=Q.dataset.spec;(te==="all"||te==="with"||te==="without")&&Ne({...v,spec:te});return}let F=l?.closest?.(".worker-mini__merge");if(F){Je(F.dataset.beadId||"");return}let ue=l?.closest?.(".worker-mini__discard");if(ue){ae(ue.dataset.beadId||"");return}let at=l?.closest?.(".worker-mini__revise-fix");if(at){Fe("worker-revise-fix",at.dataset.beadId||"");return}let nt=l?.closest?.(".worker-mini__revise-approve");if(nt){Fe("worker-revise-approve",nt.dataset.beadId||"");return}if(l?.closest?.(".worker-mini__pr"))return;if(l?.closest?.(".rtile__stop")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&Qe(_e);return}if(l?.closest?.(".rtile__pause")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&fe(_e);return}if(l?.closest?.(".rtile__resume")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&ot(_e);return}if(l?.closest?.(".rtile__session")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&I(_e);return}if(l?.closest?.(".worker-drawer-overlay__backdrop")){z.close();return}if(l?.closest?.(".worker-drawer-host"))return;let ft=l?.closest?.(".rtile");if(ft){if(l?.closest?.(".rtile__id")){let _e=ft.dataset.beadId;_e&&Lt(_e).then(m=>{m?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let te=ft.dataset.beadId;te&&c&&c(te);return}let Ke=l?.closest?.(".worker-mini, .worker-card");if(Ke){let te=Ke.dataset.beadId;if(l?.closest?.(".worker-mini__id, .worker-card__id")){te&&Lt(te).then(_e=>{_e?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}te&&c&&c(te)}}return t.addEventListener("dragstart",He),t.addEventListener("dragover",Me),t.addEventListener("dragleave",tt),t.addEventListener("drop",me),t.addEventListener("click",V),t.addEventListener("change",Re),Oe(),xe(),u&&q.push(u.subscribe(ce)),s&&q.push(s.subscribe(()=>{ce(),X()})),ce(),{load(){ce()},destroy(){for(let d of q.splice(0))try{d()}catch{}t.removeEventListener("dragstart",He),t.removeEventListener("dragover",Me),t.removeEventListener("dragleave",tt),t.removeEventListener("drop",me),t.removeEventListener("click",V),t.removeEventListener("change",Re);try{z.destroy()}catch{}S.hidden=!0;try{K.destroy()}catch{}de(p``,t)}}}function Gn(t){if(!t)return"Unknown";let e=t.split("/").filter(Boolean);return e.length>0?e[e.length-1]:"Unknown"}function Wo(t,e,r,n=async()=>{},s=async()=>{}){let o=ye("views:workspace-picker"),i=null,c=!1,a=!1,u=!1;async function h(S){let _=S.target.value,N=e.getState().workspace?.current?.path||"";if(_&&_!==N){o("switching workspace to %s",_),c=!0,A();try{await r(_)}catch(z){o("workspace switch failed: %o",z)}finally{c=!1,A()}}}async function g(){let S=e.getState(),x=S.workspace?.current?.path||S.workspace?.available?.[0]?.path||"";if(!(!x||a)){o("git-pulling workspace %s",x),a=!0,A();try{await n(x)}catch(_){o("workspace git pull failed: %o",_)}finally{a=!1,A()}}}function w(S){let x=S.target;x&&t.contains(x)||C()}function v(S){S.key==="Escape"&&C()}function y(){u||(u=!0,document.addEventListener("mousedown",w),document.addEventListener("keydown",v),A())}function C(){u&&(u=!1,document.removeEventListener("mousedown",w),document.removeEventListener("keydown",v),A())}function M(){u?C():y()}async function P(S){let x=S.target,_=x.value,O=x.checked;o("toggling visibility %s \u2192 %s",_,String(O));try{await s(_,O)}catch(N){o("workspace visibility toggle failed: %o",N)}}function B(S){return S?p`
      <button
        type="button"
    ...
    `}function D(){let S=e.getState(),x=S.workspace?.current,_=S.workspace?.available||[],O=new Set(S.workspace?.hidden||[]),N=x?.path||_[0]?.path||"";if(_.length===0)return p``;let z=_.filter(K=>!O.has(K.path)||K.path===N);if(z.length<=1){let K=z[0]||_[0],ke=Gn(K.path);return p`
