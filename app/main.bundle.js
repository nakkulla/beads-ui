...
`,e=e.substring(w.length+1),i=!0),!i){let y=this.rules.other.nextBulletRegex(x),C=this.rules.other.hrRegex(x),j=this.rules.other.fencesBeginRegex(x),G=this.rules.other.headingBeginRegex(x),Q=this.rules.other.htmlBeginRegex(x);for(;e;){let z=e.split(`
`,1)[0],R;if(w=z,this.options.pedantic?(w=w.replace(this.rules.other.listReplaceNesting,"  "),R=w):R=w.replace(this.rules.other.tabCharGlobal,"    "),j.test(w)||G.test(w)||Q.test(w)||y.test(w)||C.test(w))break;if(R.search(this.rules.other.nonSpaceChar)>=x||!w.trim())_+=`
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+Ut(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},ir=new Gc;function Pe(e,t){return ir.parse(e,t)}Pe.options=Pe.setOptions=function(e){return ir.setOptions(e),Pe.defaults=ir.defaults,pa(Pe.defaults),Pe};Pe.getDefaults=ds;Pe.defaults=lr;Pe.use=function(...e){return ir.use(...e),Pe.defaults=ir.defaults,pa(Pe.defaults),Pe};Pe.walkTokens=function(e,t){return ir.walkTokens(e,t)};Pe.parseInline=ir.parseInline;Pe.Parser=Rt;Pe.parser=Rt.parse;Pe.Renderer=yn;Pe.TextRenderer=bs;Pe.Lexer=Ct;Pe.lexer=Ct.lex;Pe.Tokenizer=vn;Pe.Hooks=Br;Pe.parse=Pe;var pf=Pe.options,ff=Pe.setOptions,_f=Pe.use,mf=Pe.walkTokens,gf=Pe.parseInline;var hf=Rt.parse,bf=Ct.lex;function Vt(e){let t=Pe.parse(e),r=ra.sanitize(t);return oa(r)}function zt(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      </div>`}if(M.kind==="error")return l`<div class="sv__error">⛔ ${M.text}</div>`;if(M.kind==="blocker")return l`<div class="sv__error">⛔ ${M.text}</div>`;if(M.kind==="tool"){let ne=i.has(P),ke=M.tool==="Bash"?ad(M.command):0,$e=M.tool==="Bash"?ke>1?xn(M.command):M.command:M.path||M.command||"";return l`<div
      ...
      </div>`}return l`<div class="sv__as">${Vt(M.text||"")}</div>`}function Ve(P){let M=[];if(P.tool==="Bash"&&typeof P.command=="string"&&P.command.length>0)M.push(P.command);else if(P.input!==void 0)try{M.push(`input: ${JSON.stringify(P.input,null,2)}`)}catch{}return typeof P.output=="string"&&P.output.length>0&&M.push(`output:
${P.output}`),M.join(`

`)}function We(){if(!o)return l``;let P=R(),M=[a.runner,a.model,a.effort].filter(Boolean).join(" \xB7 "),ne=a.session_id||"",ke=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`,$e=D(),N=$e?pd(E(),Date.now()):"",h=$e?ie(P):null,S=$e?me(P):null,F=ud(P);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
`).trim()}}var Ca=20;function Ra(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function hd(e){return e.length>Ca?`${e.slice(0,Ca)}\u2026`:e}function bd(e,t,r,n){let s=`${t.lane} ${hd(t.identifier)}`;return l`<div class="detail-report">
  ...
  `}function Rd(e){return String(e||"").replace(/^docs\/(superpowers\/)?/,"")}function qa(e,t){let r=t.getWorkspacePath,n=t.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",a="",c="";function i(x){x.key==="Escape"&&s&&(x.preventDefault(),w())}document.addEventListener("keydown",i);function d(){return s?l`
    ...
    `:l``}function _(){Te(d(),e)}async function g(x){s=x,o="loading",a="",c="",_();let y=r?r():"";if(!y){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",_();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",_();return}let C="/api/doc?workspace="+encodeURIComponent(y)+"&path="+encodeURIComponent(x);try{let j=await n(C),G=await j.json().catch(()=>({}));if(!j.ok||!G||G.ok!==!0){o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(G&&G.error||j.status)+")",_();return}a=String(G.content||""),o="ready",_()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",_()}}function w(){s=null,Te(l``,e)}function T(){document.removeEventListener("keydown",i),w()}return{open:g,close:w,destroy:T}}var Id=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"},{key:"cache_creation_input_tokens",label:"\uCE90\uC2DC \uC0DD\uC131"}],Ba="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function Ld(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function Dd(e){let t=br(e);if(!t||!e)return"";let r=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?` \xB7 $${e.total_cost_usd.toFixed(2)}`:"";return l`<span
  ...
  `}function Nd(e){let t=yr(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    `}function fe(p){let $=p.metadata||{},k=p.workflow||{},q=k.stages||{},he=q.spec&&q.spec.stale,Je=q.impl&&q.impl.stale,De=q.plan||null,_t=k.route_source==="derived",jt=k.route||$.route||"\u2014";return l`
    ...
    `}function m(){Te(f(),e)}return{load(p){p!==d&&(g={},w="",Q(),me(),ke()),d=p,_=null,He()},clear(){d=null,_=null,g={},w="",T=!1,Q(),me(),ke(),ye.close(),we.close(),Te(l``,e)},destroy(){Xe&&(Xe(),Xe=null),Fe&&(Fe(),Fe=null),pt&&(pt(),pt=null),document.removeEventListener("keydown",ft),ye.destroy(),V.parentNode&&V.parentNode.removeChild(V),we.destroy(),K.parentNode&&K.parentNode.removeChild(K),d=null,_=null,w="",T=!1,me(),ke(),Te(l``,e)}}}var Bd=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Wa(e,t){return Zn(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function Ud(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}function ja(e,t){let{policyStore:r,transport:n,labelOptions:s}=t,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),e.appendChild(o);let a="";async function c(E){let D=r.get();if(D)try{let H=await n("display-policy-set",{expected_revision:D.revision,policy:E(D)});i(H),H&&H.conflict&&H.policy&&(H=await n("display-policy-set",{expected_revision:H.policy.revision,policy:E(H.policy)}),i(H)),H&&H.conflict&&X("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{X("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function i(E){E&&E.policy&&typeof E.policy=="object"&&r.set(E.policy)}function d(E){let D=r.get();if(!D)return;let H=Wa(E,D)!=="shown";c(oe=>Ud(E,oe,H))}function _(){let E=a.trim();E.length!==0&&(a="",c(D=>D.hidden_prefixes.includes(E)?{hidden_prefixes:D.hidden_prefixes}:{hidden_prefixes:[...D.hidden_prefixes,E]}),C())}function g(E){c(D=>({hidden_prefixes:D.hidden_prefixes.filter(H=>H!==E)}))}function w(E){let D=r.get();if(!D)return;let H=D.chips[E]===!1;c(()=>({chips:{[E]:H}}))}function T(E){let D=s();return l`
    ...
    `}function y(E){return l`
      <section class="display-settings__section">
        ...
        <div class="display-settings__toggles">
          ${Bd.map(([D,H])=>l`<label class="display-settings__toggle">
                <input
                  type="checkbox"
                  data-chip=${D}
                  .checked=${E.chips[D]!==!1}
    ...
    <div class="fatal-error">
    ...
    </div>`,e.appendChild(t);let r=t.querySelector("#fatal-error-title"),n=t.querySelector("#fatal-error-message"),s=t.querySelector("#fatal-error-detail"),o=t.querySelector("#fatal-error-reload"),a=t.querySelector("#fatal-error-close"),c=()=>{if(typeof t.close=="function")try{t.close()}catch{}t.removeAttribute("open")},i=(d,_,g="")=>{r&&(r.textContent=d||"Unexpected Error"),n&&(n.textContent=_||"An unrecoverable error occurred.");let w=typeof g=="string"?g.trim():"";if(s&&(w.length>0?(s.textContent=w,s.removeAttribute("hidden")):(s.textContent="No additional diagnostics available.",s.setAttribute("hidden",""))),typeof t.showModal=="function")try{t.showModal(),t.setAttribute("open","")}catch{t.setAttribute("open","")}else t.setAttribute("open","")};return o&&o.addEventListener("click",()=>{window.location.reload()}),a&&a.addEventListener("click",()=>c()),t.addEventListener("cancel",d=>{d.preventDefault(),c()}),{open:i,close:c,getElement(){return t}}}function Ya(e){if(typeof e!="number"||!Number.isFinite(e)||e<=0)return"";if(e<6e4)return`${Math.round(e/1e3)}\uCD08`;let t=e/6e4;return`${Number.isInteger(t)?t:Math.round(t*10)/10}\uBD84`}function Va(e){return Array.isArray(e)?e.filter(t=>typeof t=="string").join(" "):""}var zd={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428 \xB7 \uACB0\uACFC \uBBF8\uAD00\uCE21"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},Ka=160;function Hd(e){return e.length>Ka?`${e.slice(0,Ka)}\u2026`:e}function Cn(e,t){let{queueStore:r,presetStore:n,transport:s,getWorkspacePath:o}=t,a=document.createElement("dialog");a.id="worker-exec-defaults-dialog",a.className="exec-defaults",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),e.appendChild(a);let c=null,i=!1;function d(){return r&&r.get()||{revision:0,exec_defaults:{}}}function _(){let h=d();return typeof h.revision=="number"?h.revision:0}function g(){let h=d().exec_defaults;return h&&typeof h=="object"?h:{}}function w(){let h=n?n.get():null;return!h||typeof h.revision!="number"?null:{revision:h.revision,presets:Array.isArray(h.presets)?h.presets:[]}}function T(h){n&&h&&typeof h.revision=="number"&&Array.isArray(h.presets)&&n.set({revision:h.revision,presets:h.presets})}function x(h){h&&h.queue&&r&&r.set(h.queue)}async function y(h,S){if(!s)return;let F={key:h,value:S||null};try{let W=await s("worker-queue-set-exec-default",{...F,expected_revision:_()});x(W),W&&W.conflict&&(W=await s("worker-queue-set-exec-default",{...F,expected_revision:_()}),x(W)),W&&W.conflict&&X("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{X("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function C(){return d().runner_catalog??null}function j(h){let{key:S}=h;return l`<div class="exec-defaults__row">
      ...
      ${h.runner?l`<span class="exec-defaults__runner" data-runner-for=${S}
            >${h.runner}</span
          >`:""}
    </div>`}function G(h){c={id:h.id,name:h.name,settings:{...h.settings||{}}},i=!1,re()}function Q(){c={id:null,name:"",settings:{}},i=!1,re()}function z(h){let S=h&&h.settings&&typeof h.settings=="object"?h.settings:{},F=W=>typeof S[W]=="string"?S[W]:"";return cr({selectedOf:F,effectiveOf:F,runner_catalog:C()}).some(W=>W.groups.some(J=>J.options.some(se=>se.value===W.selected&&se.label.endsWith("(\uBE44\uD638\uD658)"))))}function R(h){let S=h&&h.settings&&typeof h.settings=="object"?h.settings:{},F=jr.filter(se=>typeof S[se]=="string").length,J=["orchestration_model","spec_review_model","plan_review_model","impl_review_model","impl_model"].filter(se=>typeof S[se]=="string").map(se=>`${ws[se]?.title||se}: ${S[se]}`);return{count:`${F}/10 \uC9C0\uC815`,choices:J.length>0?J.join(" \xB7 "):"\uBAA8\uB4E0 \uD56D\uBAA9 \uAE30\uBCF8\uAC12"}}async function E(h){if(!s||!window.confirm(`\u201C${h.name}\u201D \uD504\uB9AC\uC14B\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694? \uC774\uBBF8 \uC801\uC6A9\uB41C \uC774\uC288\uB294 \uBCC0\uACBD\uB418\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.`))return;let S=w();if(S)try{let F=await s("exec-preset-delete",{expected_revision:S.revision,id:h.id});T(F),F&&F.conflict&&X("\uD504\uB9AC\uC14B\uC774 \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694.","error",4e3)}catch{X("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328","error",4e3)}}async function D(h=!1){if(!s||!c)return;let S=w();if(!S)return;let F=h||c.id===null,W={expected_revision:S.revision,...F?{}:{id:c.id},name:c.name,settings:{...c.settings}};try{let J=await s(F?"exec-preset-create":"exec-preset-update",W);if(T(J),J&&J.conflict){i=!0,re();return}if(J&&J.applied){c=null,i=!1,re();return}X("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}catch{X("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function H(h){return l`<div class="exec-defaults__row exec-preset-editor__row">
    ...
    </div>`}function We(h){if(!h||typeof h!="object")return"";let S=zd[String(h.outcome)];if(!S)return"";let F=h.outcome==="failed"&&h.reason?`${S.label} \xB7 ${h.reason}`:S.label,W=[ut(h.at),typeof h.bead_id=="string"?h.bead_id:"",typeof h.base_sha=="string"?h.base_sha.slice(0,7):""].filter(Ie=>Ie.length>0).join(" \xB7 "),J=typeof h.detail=="string"&&h.detail.length>0?Hd(h.detail):"",se=typeof h.log_path=="string"&&h.log_path.length>0?h.log_path:"";return l`<div class="exec-defaults__vd-group" data-vd="last-deploy">
  ...
  >
    ...
    <path d="M8.8 3.6 14 8l-5.2 4.4z" />`)}var Gr=1,Zd=6e4,Xd={auto_merge:"\uC790\uB3D9 \uBA38\uC9C0",merged:"\uBA38\uC9C0",merge:"\uBA38\uC9C0",pr_stop:"PR \uC911\uB2E8",stopped:"\uC911\uB2E8",failed:"\uC2E4\uD328"},Qd=new Set(["auto_merge","merged","merge","done"]),ni={running:3,paused:2,failed:1};function Jd(e,t){let r=null,n=-1/0;for(let s of Object.values(e)){if(!s||s.bead_id!==t||s.status==="running")continue;let o=typeof s.finished_at=="number"?s.finished_at:typeof s.started_at=="number"?s.started_at:0;o>=n&&(n=o,r=s)}return r}function eu(e,t){let r=Object.values(e||{}),n=new Set,s=new Map;for(let a of r)!a||typeof a.bead_id!="string"||(typeof a.resumed_from=="string"&&a.resumed_from.length>0&&n.add(a.resumed_from),s.set(a.bead_id,a.attempt_id));let o=new Map;for(let a of r){if(!a||typeof a.bead_id!="string"||a.bead_id.length===0)continue;let c=null;if(a.status==="running")c="running";else if(a.status==="paused"&&!n.has(a.attempt_id))c="paused";else if(a.status==="failed"||a.status==="orphaned"){let g=t.get(a.bead_id),w=typeof g=="number"&&g>0&&typeof a.finished_at=="number"&&g>=a.finished_at;s.get(a.bead_id)===a.attempt_id&&!w&&typeof a.dismissed_at!="number"&&(c="failed")}if(!c)continue;let i=typeof a.started_at=="number"?a.started_at:null,d=o.get(a.bead_id);if(d){let g=ni[d.run_state],w=ni[c];if(g>w||g===w&&(d.started_at??0)>(i??0))continue}let _=typeof a.session_id=="string"&&a.session_id.length>0;o.set(a.bead_id,{attempt_id:typeof a.attempt_id=="string"?a.attempt_id:"",run_state:c,started_at:i,last_event_at:typeof a.last_event_at=="number"?a.last_event_at:null,model:typeof a.model=="string"?a.model:null,usage:Dt(e,a.bead_id),can_pause:c==="running"&&_,can_resume:c!=="running"&&_&&!n.has(a.attempt_id)})}return o}function si(e,t){let r=e[t];if(!r)return"";if(r.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let n=typeof r.reason=="string"?r.reason:"",s=n.indexOf(":");return s>0&&s<n.length-1?`\u26D4 ${n.slice(0,s)} (${n.slice(s+1)})`:`\u26D4 ${n}`}function St(e){return e&&typeof e=="object"?e:{}}function Cs(e,t,r){let n=Array.isArray(e)?e:[],s=Array.isArray(t)?t:[],o=r&&typeof r.done_since=="number"?r.done_since:void 0,a=new Map;for(let y of s)y&&typeof y.root_dir=="string"&&a.set(y.root_dir,y);let c=[],i=[],d=[],_=[],g=[],w=new Map;for(let y of n){if(!y||typeof y.root_dir!="string")continue;let C=y.root_dir,j=y.name||C,G=a.get(C),Q=G&&typeof G.revision=="number"?G.revision:typeof y.revision=="number"?y.revision:0,z=St(y.attempts),R=St(y.bead_titles),E=St(y.pr_observations),D=St(y.admission),H=St(y.revise_parked),oe=St(y.merge_queue_state),ue=St(y.cleanup_failed),ie=Array.isArray(y.merge_queue)?y.merge_queue:[],me=new Set(ie.filter(I=>I&&typeof I.bead_id=="string").map(I=>I.bead_id)),Se=Array.isArray(y.queue)?y.queue:[],Ve=Array.isArray(y.done)?y.done:[],We=new Map;for(let I of Ve)I&&typeof I.bead_id=="string"&&typeof I.added_at=="number"&&We.set(I.bead_id,I.added_at);let Ae=I=>({id:I,title:R[I]||I,root_dir:C,workspace_name:j,expected_revision:Q,draggable:!1}),le=new Set;for(let[I,V]of eu(z,We))le.add(I),i.push({...Ae(I),lane:"running",attempt_id:V.attempt_id,run_state:V.run_state,can_pause:V.can_pause,can_resume:V.can_resume,started_at:V.started_at,last_event_at:V.last_event_at,model:V.model,usage:V.usage,badges:V.run_state==="paused"?["\u23F8 \uC77C\uC2DC\uC815\uC9C0"]:V.run_state==="failed"?["\u26A0 \uC2E4\uD328"]:[],alert:V.run_state==="failed"});for(let I of Array.isArray(y.pr_wait)?y.pr_wait:[]){let V=I&&I.bead_id;if(typeof V!="string"||le.has(V))continue;le.add(V);let ye=St(E[V]),K=St(ye.pr),we=ye.gate?St(ye.gate):null,pe=me.has(V),Ne=oe.active===V,re=I.external===!0,_e=ue[V]||null,P=!!we&&we.base_badge==="\uCDA9\uB3CC",M=!!_e&&!!we&&we.tier==="merged",ne=re&&!!we&&we.tier==="merged";d.push({...Ae(V),lane:"pr_wait",pr_number:typeof K.number=="number"?K.number:null,pr_url:typeof K.url=="string"?K.url:void 0,external:re,usage:Dt(z,V),badges:_e?["\uC815\uB9AC \uC2E4\uD328"]:[],alert:!!_e,reason:_e?"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644":"PR \uB300\uAE30",merge_action:!pe,merge_enabled:we?.enabled===!0||P||M||ne,merge_label:ne?"\uC815\uB9AC":P&&!M?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:ne?"\uBA38\uC9C0\uB428 \u2014 \uD074\uB9AD\uD558\uBA74 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC\uB97C \uC218\uD589\uD569\uB2C8\uB2E4":M?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uC218\uD589\uD569\uB2C8\uB2E4":P?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":we?.enabled===!0?`\uBA38\uC9C0 (${we.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4`:`\uBA38\uC9C0 \uBD88\uAC00: ${we?.reason||"\uAD00\uCE21 \uB300\uAE30"}`,cancel_action:pe,cancel_enabled:!Ne,discard_action:!re&&!_e&&!(we&&we.tier==="merged"),discard_enabled:!Ne&&!pe,discard_title:pe?"\uBA38\uC9C0 \uD050\uC5D0 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 [\uCDE8\uC18C]\uD558\uC138\uC694":void 0})}for(let I=0;I<Se.length;I++){let V=Se[I],ye=V&&V.bead_id;if(typeof ye!="string"||le.has(ye))continue;le.add(ye);let K=H[ye],we={...Ae(ye),lane:"queue",reason:si(D,ye),queue_position:I+1,queue_index:I,queue_length:Se.length,badges:K?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!K,revise_action:!!K,revise_enabled:!!K,revise_title:K?K.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${K.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};_.push(we);let pe=w.get(C);pe?pe.push(we):w.set(C,[we])}for(let I of Array.isArray(y.runnable)?y.runnable:[]){let V=I&&I.bead_id;typeof V!="string"||le.has(V)||(le.add(V),c.push({...Ae(V),title:I.title||R[V]||V,lane:"runnable",draggable:!0,reason:si(D,V),created_at:I.created_at??void 0,updated_at:I.updated_at??void 0,labels:Array.isArray(I.labels)?I.labels:[],workflow:I.route?{route:I.route,chips:{route:I.route}}:null,place_index:Se.length}))}for(let I of Ve){let V=I&&I.bead_id;if(typeof V!="string"||le.has(V)||(le.add(V),o!==void 0&&typeof I.added_at=="number"&&I.added_at<o))continue;let ye=Jd(z,V);g.push({...Ae(V),lane:"done",done:!0,usage:Dt(z,V),done_at:typeof I.added_at=="number"?I.added_at:void 0,done_kind:ye&&typeof ye.done_kind=="string"?ye.done_kind:null})}}i.sort((y,C)=>(C.last_event_at??0)-(y.last_event_at??0)),g.sort((y,C)=>(C.done_at??0)-(y.done_at??0));let T=s.length>0?s:n.map(y=>({root_dir:y&&y.root_dir,name:y&&y.name,auto_advance:y&&y.auto_advance,auto_merge:y&&y.auto_merge,slots:y&&y.slots,revision:y&&y.revision,exec_defaults:y&&y.exec_defaults,runner_catalog:y&&y.runner_catalog})),x=[];for(let y of T)!y||typeof y.root_dir!="string"||x.push({root_dir:y.root_dir,name:y.name||y.root_dir,auto_advance:y.auto_advance===!0,auto_merge:y.auto_merge===!0,slots:typeof y.slots=="number"&&y.slots>=Gr?y.slots:Gr,revision:typeof y.revision=="number"?y.revision:0,exec_defaults:St(y.exec_defaults),runner_catalog:St(y.runner_catalog),items:w.get(y.root_dir)||[]});return{runnable:c,queue:_,queue_groups:x,running:i,pr_wait:d,done:g,automation:{total:x.length,both_on:x.filter(y=>y.auto_advance&&y.auto_merge).length}}}function tu(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<Zd;return l`<span
