...
`,e=e.substring(_.length+1),c=!0),!c){let L=this.rules.other.nextBulletRegex(T),B=this.rules.other.hrRegex(T),V=this.rules.other.fencesBeginRegex(T),H=this.rules.other.headingBeginRegex(T),P=this.rules.other.htmlBeginRegex(T);for(;e;){let q=e.split(`
`,1)[0],O;if(_=q,this.options.pedantic?(_=_.replace(this.rules.other.listReplaceNesting,"  "),O=_):O=_.replace(this.rules.other.tabCharGlobal,"    "),V.test(_)||H.test(_)||P.test(_)||L.test(_)||B.test(_))break;if(O.search(this.rules.other.nonSpaceChar)>=T||!_.trim())d+=`
...
${i}</pre
    ...
    `:l``}function p(){Ge(d(),e)}async function _(L,B={}){s=L,o="loading",a="",i=null,c="",p();let V=r?r():"";if(!V){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let H="/api/doc?workspace="+encodeURIComponent(V)+"&path="+encodeURIComponent(L);try{let P=await n(H),q=await P.json().catch(()=>({}));if(!P.ok||!q||q.ok!==!0){if(q?.error==="not_found"&&B.missing_state==="plan_pending"){o="pending",c="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",p();return}o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(q&&q.error||P.status)+")",p();return}let O=Cm(String(q.content||""));i=O.front,a=O.body,o="ready",p()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function h(){s=null,Ge(l``,e)}function T(){document.removeEventListener("keydown",u),h()}return{open:_,close:h,destroy:T}}var Rm=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],ou="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",ho=["implementation","review-consult"],Im=["running","done","failed","interrupted"],Lm={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function Om(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function Mm(e){let t=Wt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
    ...
    >${e.replayed?l`<span class="detail-usage-partial" title=${ou}
          >부분 집계</span
        >`:""}`}function su(e){return!e||!e.roles.orchestrator?null:{providers:e.roles.orchestrator,roles:{}}}function ja(e){if(typeof e!="string")return"";let t=Date.parse(e);return Number.isFinite(t)?Ba(t):""}function Pm(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let t=e;return typeof t.launch_id!="string"||t.launch_id.length===0||t.provider!=="codex"||!ho.includes(t.role)||typeof t.model!="string"||t.model.length===0||!(!("effort"in t)||t.effort===null||typeof t.effort=="string"&&t.effort.trim().length>0)||typeof t.session_id!="string"||t.session_id.length===0||!Im.includes(t.status)||typeof t.started_at!="number"||!Number.isFinite(t.started_at)||typeof t.last_event_at!="number"||!Number.isFinite(t.last_event_at)||!(t.completed_at===null||typeof t.completed_at=="string"&&Number.isFinite(Date.parse(t.completed_at)))||!(t.turn_id===null||typeof t.turn_id=="string")?null:t}function Dm(e,t){let n=Wt({providers:{codex:{subtotal:t.subtotal,breakdown:t.usage,...t.replayed?{replayed:!0}:{}}},roles:{}})[0];return l`<div class="detail-session__leg detail-session__usage-detail">
    ...
    ${n?l`<span class="detail-session__usage" title=${n.tooltip}
          >${n.label}</span
        >`:""}
  </div>`}function Nm(e,t,r,n){let s=e.status==="running"?null:t,a=(s?Wt({providers:{codex:{subtotal:s.subtotal,breakdown:s.usage,...s.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],i=e.status==="running"?Ba(e.last_event_at):s?ja(s.completed_at):"";return l`<button
    type="button"
  ...
  >
    ...
    ${a?l`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function qm(e,t){return e.role===t.role&&e.model===t.model&&e.session_id===t.session_id}function Fm(e,t,r){let n=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let d of o){let p=Pm(d);!p||s.has(p.launch_id)||(s.add(p.launch_id),n.push(p))}n.sort((d,p)=>d.started_at-p.started_at);let a={implementation:[],"review-consult":[]};if(t)for(let d of ho){let p=t.roles[d]?.codex;a[d]=p?[...p.legs]:[]}let i=ho.flatMap(d=>a[d]),c=new Set,u=[];for(let d of ho){for(let p of n.filter(_=>_.role===d)){let _=i.find(h=>h.receipt_id===p.launch_id)||null;_&&!qm(p,_)||(_&&c.add(_.receipt_id),u.push(Nm(p,_,e.attempt_id,r)))}for(let p of a[d])c.has(p.receipt_id)||u.push(Dm(d,p))}return u}function jm(e,t){let r=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,n=[...Rm,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return l`<div class="detail-session__usage-detail">
    ${n.map(s=>l`<span class="detail-session__usage-field"
          ><span class="detail-session__usage-label">${s.label}</span
          ><span class="detail-session__usage-value"
            >${Om(e[s.key]).toLocaleString("en-US")}</span
          ></span
        >`)}
  ...
  </div>`}var Bm={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function Ba(e){if(typeof e!="number"||!Number.isFinite(e))return"";let t=new Date(e),r=String(t.getHours()).padStart(2,"0"),n=String(t.getMinutes()).padStart(2,"0");return`${r}:${n}`}function Um(e){if(typeof e.exec_default_preset_id!="string"||e.exec_default_preset_id.length===0)return"";let t=e.exec_values&&typeof e.exec_values=="object"?Object.entries(e.exec_values).filter(([,n])=>typeof n=="string"&&n.length>0).map(([n,s])=>`${n}=${s}`).join(" \xB7 "):"",r=typeof e.exec_default_preset_revision=="number"?` r${e.exec_default_preset_revision}`:"";return l`<div
  ...
  >
    ...
    <div class="detail-sessions" data-seam="session-history">
      ${n.map(u=>{let d=aa(u),p=su(d),_=Wt(p);return l`<div class="detail-session-row">
          ...
          ${c(u)} ${a(u)} ${i(u)} ${Um(u)}
          ${s.has(u.attempt_id)&&u.usage?jm(u.usage,u.runner==="codex"?"codex":"claude"):""}
          ${Fm(u,d,t)}
        </div>`})}
    </div>
  ...
  `}function Wm(e){let t=En(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    `}let vt={route:["quick_fix","spec_backed","full_plan"]};async function Pt(x,Z){let D=Z.target.value;if(x==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&D!=="full_plan"&&!window.confirm(`full_plan \u2192 ${D||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){xe();return}await at("update-workflow-meta",{id:u,key:x,value:D},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),xe()}function f(x){let Z=x.metadata||{};return l` ${((Ie,ut)=>{let it=vt[Ie],rt=typeof Z[Ie]=="string"?Z[Ie]:"";return l`<div class="detail-kv">
      ...
      </div>`})("route","(unset)")} `}function $(x,Z){return q?l`
    ...
    `}function m(x,Z){return l`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${W}
        >
          ${zm.map(D=>l`<option value=${D} ?selected=${D===x}>${D}</option>`)}
        </select>
      </div>
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${be}
        >
          ${Hm.map(D=>l`<option value=${String(D)} ?selected=${D===Z}>
                P${D}
              </option>`)}
        </select>
      </div>
    ...
    `}function xe(){Ge(je(),e)}return{load(x){x!==u&&(p={},_="",T=[],L=!1,J(),re(),Pe(),ee()),u=x,d=null,F(),pt(),H!==x&&de(x)},clear(){u=null,d=null,p={},_="",h=!1,T=[],L=!1,J(),re(),Pe(),ee(),ze.close(),Y.close(),Ge(l``,e)},destroy(){M&&(M(),M=null),ue&&(ue(),ue=null),k&&(k(),k=null),document.removeEventListener("keydown",S),ze.destroy(),Oe.parentNode&&Oe.parentNode.removeChild(Oe),Y.destroy(),Ye.parentNode&&Ye.parentNode.removeChild(Ye),u=null,d=null,ee(),_="",h=!1,T=[],re(),Pe(),Ge(l``,e)}}}function cu(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
...
\uC774\uC288 \uD540 \u2014 \uB808\uD3EC \uAE30\uBCF8\uAC12\uACFC \uB2E4\uB984`:"";return l`${e.orchestration?l`<span
  ...
  </div>`}function Ym(e){let t=Array.isArray(e.badges)?e.badges:[],r=Wt(e.usage),n=$r(e.usage),s=ar(e.done_at);return l`<div
  ...
  >`,T=l`<span class="worker-mini__title">${e.title}</span>`,L=e.pr_url&&e.pr_number?l`<a
      ...
      >
        저장소 작업 보기
      </button>`:"",j=e.discard,J=j?.action||e.discard_action?l`<button
          type="button"
        ...
        </div>`:"",Le=$o(e.dependency_chips),te=is(e),se=!!(s||o||e.merge_action||e.cancel_action||e.timeline_action||e.discard_action||j?.operation||e.revise_action||ee);return l`<div
    ...
    ${i?l`<div class="worker-mini__row1">${_}${h}${T}</div>
          <div class="worker-mini__row2">
            ...
            ${In(e)}`:l`<div class="worker-mini__line">
              ${u}${d}${_}${h}${T}${L}${B}${V}${p}${H}${P}${q}${O}${U}${b}${J}
            </div>
            ${Le}${Se}${te} ${In(e)}`}
  ...
  >
  ...
  </details>`:""}function Jm(e){if(!Number.isFinite(e)||e<0)return"0s";let t=Math.floor(e/1e3),r=Math.floor(t/60),n=t%60;return r>0?`${r}m ${String(n).padStart(2,"0")}s`:`${n}s`}function hu(e){let t=e.failure?xo(e.failure.reason):"";return l`<div class="worker-banners">
    ${e.failure?l`<div class="worker-banner worker-banner--failure" role="alert">
          ...
          ${Qm(e.failure.cause_detail)}
          ${Xm(e.failure.reason)}
          ${is({discard:e.failure.discard})}
        </div>`:""}
  </div>`}function eg(e){return e?l`${e.repo?l`<span
        class="worker-card__repo rtile__repo"
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?l`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`:""}function tg(e,t,r){if(!e)return"";let n=e.workflow||null,s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=Array.isArray(e.legs)?e.legs:[],c=i.filter(p=>p&&p.state==="live"),u=i.filter(p=>p&&p.state!=="live"),d=$o(e.dependency_chips);return l`${n?vn(n,"in_progress"):""}
  ${o?l`<div class="rtile__activity${r?" is-paused":""}">
        ...
        ${c.map(p=>l`<span class="rtile__leg rtile__leg--live"
            ...
            >`)}${u.length>0?l`<span
              ...
              >✓ ${u.length}</span
            >`:""}
      </div>`:""}${d}`}function Ha(e,t,r=null,n={}){let s=e.failed===!0,o=!!e.paused,a=s?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):o?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Jm(t-e.started_at):"\u2014",i=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,c=Bn(e),u=Wt(e.usage),d=$r(e.usage),p=e.conflict_resolution?o?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,_=e.base_exception||null,h=e.landing,T=e.attempt_id&&e.attempt_id===r,L=n.monitor||null,B=eg(L),V=tg(L,t,o),H=e.discard?.action?l`<button
        type="button"
...
`)}function Ao(e){if(typeof e!="object"||e===null)return null;let t=Jr(e);if(t==="")return null;let r=(n,s)=>typeof s=="string"&&s.length>0?`${n}: ${s}`:null;return{text:t,title:Ka(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",r("runner",e.runner),r(Pr.orchestration_model,e.model),r(Pr.orchestration_effort,e.effort),r(Pr.orchestration_speed,e.speed)])}}function sn(e,t){let r=Dr(e,"orchestration_model");if(r===null||r.resolution==="unavailable")return null;let n=Dr(e,"orchestration_effort"),s=Dr(e,"orchestration_speed"),o=bu([gr(t,r.value??""),r.display,n!==null&&n.value!==null?n.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Ka(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Nr("orchestration_model",r),Nr("orchestration_effort",n),Nr("orchestration_speed",s)])}}function rg(e,t){return e===null||e.value===null||Va.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function ng(e){return e===null||Va.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function sg(e){return e===null?null:e.value==="auto"?"auto":Va.has(e.resolution)?null:e.display}function qr(e,t){if(typeof e!="object"||e===null)return null;let r=Dr(e,"impl_dispatch"),n=Dr(e,"impl_runtime"),s=Dr(e,"impl_model"),o=Dr(e,"impl_effort"),a=Dr(e,"impl_speed"),i=r!==null&&r.value==="main"?"\uBA54\uC778":bu([rg(n,t??null),ng(s),sg(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Ka(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Nr("impl_dispatch",r),Nr("impl_runtime",n),Nr("impl_model",s),Nr("impl_effort",o),Nr("impl_speed",a)])}}var Xt="",og=["impl_runtime","impl_model","impl_effort"],ag=5,So=1;function Cr(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Eo(e,t){let r=t.transport,n=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(I=>fe(I,"error",4e3)),o={},a={},i=[],c=!1,u=null,d={},p="",_="",h=!1,T=!1,L=!1,B=null,V=!1;function H(){let I=t.queue?t.queue():null;return Cr(I)?I:null}function P(){let I=H();return I?I.runner_catalog:null}function q(){let I=H();return I&&Cr(I.execution_defaults)?I.execution_defaults:null}function O(){let I=t.implPresetStore?.get();return Cr(I)&&Array.isArray(I.presets)?I:null}function U(){return n===null?{}:{root_dir:n}}async function b(I,ne){return V||!r?null:await r(I,ne)}function j(I){I&&Cr(I.queue)&&t.onQueueAdopt?.(I.queue)}async function J(I,ne){let me=H();if(!me||V)return null;let ae=await b(I,{...ne,...U(),expected_revision:me.revision});if(j(ae),n!==null&&ae&&ae.conflict){let qe=ae.queue&&typeof ae.queue.revision=="number"?ae.queue.revision:H()?.revision??me.revision;ae=await b(I,{...ne,...U(),expected_revision:qe}),j(ae)}return ae}async function ee(){c=!0,Pe();try{let I=await b("get-session-defaults",{...U()});o=Cr(I?.values)?{...I.values}:{},a={...o},i=Array.isArray(I?.warnings)?I.warnings:[]}catch(I){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}finally{c=!1,Pe()}}async function pe(){let I=Fc(o,a);if(Object.keys(I).length!==0){try{let ne=await b("set-session-defaults",{values:I,...U()});o=Cr(ne?.values)?{...ne.values}:{},a={...o},i=Array.isArray(ne?.warnings)?ne.warnings:[]}catch(ne){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}Pe()}}function de(I,ne){if(og.includes(I)){Le(I,ne);return}ne===Xt?delete a[I]:a[I]=ne,Pe(),pe()}function he(){let I=Je().orchestration_model,ne=Qt({global:{orchestration_model:I??void 0},execution_defaults:q(),runner_catalog:P()}).orchestration_model.value;return ne?gr(P(),ne):null}function Se(I,ne){typeof ne=="string"&&ne.length>0?a[I]=ne:delete a[I]}function Le(I,ne){let me=ne===Xt?void 0:ne,ae=Nc({impl_runtime:I==="impl_runtime"?me:a.impl_runtime,impl_model:I==="impl_model"?me:a.impl_model,impl_effort:I==="impl_effort"?me:a.impl_effort},P(),he());Se("impl_runtime",ae.impl_runtime),Se("impl_model",ae.impl_model),Se("impl_effort",ae.impl_effort),Pe(),pe()}async function te(){let I=H();if(!I)return;let ne={orchestration_model:I.orchestration_model??null,orchestration_effort:I.orchestration_effort??null,orchestration_speed:I.orchestration_speed??null},me=jc(ne,{...ne,...d});if(Object.keys(me).length!==0){try{let ae=await J("worker-queue-set-orchestration-defaults",{values:me});if(ae&&ae.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}d={}}catch(ae){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${ae instanceof Error?ae.message:String(ae)}`)}Pe()}}function se(I,ne){d[I]=ne===Xt?null:ne,Pe(),te()}function Ae(I){if(u=I,!I){Pe();return}let ne=P(),me=Je(),ae=me.orchestration_model;ae&&!os(ne,I).includes(ae)&&(d.orchestration_model=null,ae=null);let qe=me.orchestration_effort;qe&&!Da(ne,I,ae||nr).includes(qe)&&(d.orchestration_effort=null),Pe(),te()}async function N(I){if(!(!H()||I<So)){try{await J("worker-queue-set-slots",{slots:I})}catch(ne){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}Pe()}}async function oe(I){if(!(!H()||I<So||I>ag)){try{await J("worker-queue-set-serial-lane-count",{count:I})}catch(ne){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}Pe()}}async function re(I,ne){let me=I==="auto_advance"?"worker-automation-toggle":I==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await J(me,{on:ne})}catch(ae){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${ae instanceof Error?ae.message:String(ae)}`)}Pe()}function ye(){let I={},ne=Je();for(let me of uo){let ae=Tr.includes(me)?ne[me]:a[me];typeof ae=="string"&&ae.length>0&&(I[me]=ae)}return I}async function Ee(){let I=O();if(!I)return;let ne=ye();if(Object.keys(ne).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let me=(I.presets||[]).find(qe=>qe.id===p),ae=_.trim()||(me?me.name:"");if(!ae){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let qe=me?await b("impl-preset-update",{expected_revision:I.revision,id:me.id,name:ae,settings:ne}):await b("impl-preset-create",{expected_revision:I.revision,name:ae,settings:ne});if(qe&&qe.applied){if(_="",!me&&Array.isArray(qe.presets)){let Qe=qe.presets.find(ot=>ot.name===ae);p=Qe?Qe.id:p}Pe()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Pe()}catch(qe){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${qe instanceof Error?qe.message:String(qe)}`)}}async function C(){let I=O();if(!(!I||p.length===0))try{let ne=await b("impl-preset-delete",{expected_revision:I.revision,id:p});ne&&ne.applied?(p="",Pe()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Pe())}catch(ne){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}}function K(I){o=Cr(I.values)?{...I.values}:{},a={...o},i=Array.isArray(I.warnings)?I.warnings:[],Cr(I.queue)&&(t.onQueueAdopt?.(I.queue),d={})}async function $e(){let I=O(),ne=H();if(!I||!ne||p.length===0)return;let me=ae=>({preset_id:p,expected_revision:I.revision,expected_queue_revision:ae,...U()});try{let ae=await b("apply-impl-preset-global",me(ne.revision));if(ae&&ae.applied&&K(ae),n!==null&&ae&&ae.queue_applied===!1){let qe=ae.queue&&typeof ae.queue.revision=="number"?ae.queue.revision:H()?.revision??ne.revision;ae=await b("apply-impl-preset-global",me(qe)),ae&&ae.applied&&K(ae)}ae&&ae.applied?ae.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):ae&&ae.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(ae){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${ae instanceof Error?ae.message:String(ae)}`)}Pe()}async function Ne(){T=!0,L=!1,Pe();try{let I=await b("get-worker-system-prompt",{});!I||typeof I!="object"||Array.isArray(I)?L=!0:B=I}catch{L=!0}finally{T=!1,Pe()}}function Oe(){if(h=!h,h&&!B){Ne();return}Pe()}function ze(){let I=En({loading:T,error:L});if(I)return I;if(!B)return"";let ne=Array.isArray(B.variants)?B.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${h?ze():""}
    </section>`}function Y(I,ne,me,ae,qe,Qe,ot){let Xe=qe[I]??Xt,dt=Na(I,me,qe,q(),P(),ot),yt=dt.options.find(pt=>pt.value===Xe),gt=Xe===Xt?dt.full_value:yt?.full_value;return l`<select
  ...
  >
    ...
    >
      ...
      >
        ${$u()}
      </button>`}function pe(N){let oe=lg(N);return oe?l`<div class="mon2-deck__chips">
    ...
    </div>`}function Le(){u!==null&&!T(u)&&(u=null,t.onFocusChange?.(null))}function te(){B(),Le(),d!==null&&!T(d)&&U(!0),Ge(Se(),n),p?.render()}function se(N){let oe=N.target;if(!oe||typeof oe.closest!="function")return;let re=oe.closest("[data-root-dir]");if(!re)return;let ye=re.getAttribute("data-root-dir")||"",Ee=oe.closest("[data-act]")?.getAttribute("data-act");if(Ee==="worker"){t.gotoWorkerTab?.(ye);return}if(Ee==="auto"){V("worker-automation-toggle",ye,{on:L(ye)?.auto_advance!==!0});return}if(Ee==="merge"){V("worker-merge-auto-toggle",ye,{on:L(ye)?.auto_merge!==!0});return}if(Ee==="gear"){q(ye);return}P(ye)}function Ae(N){if(N.key!=="Enter"&&N.key!==" ")return;let oe=N.target;if(!oe||typeof oe.closest!="function")return;let re=oe.closest('[data-root-dir][role="button"]');!re||re!==oe||(N.preventDefault(),P(re.getAttribute("data-root-dir")||""))}return n.addEventListener("click",se),n.addEventListener("keydown",Ae),{render:te,focusRoot:()=>u,panelRoot:()=>d,destroy(){document.removeEventListener("keydown",j),n.removeEventListener("click",se),n.removeEventListener("keydown",Ae),i.removeEventListener("click",b),O(),Ge(l``,n),e.replaceChildren()}}}var cg="\uB2E4\uB978 \uB808\uD3EC \uC774\uC288\uB294 \uC774 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",ug="Worker \uD0ED \uC9C1\uB82C \uB808\uC778\uC5D0\uC11C \uBA3C\uC800 \uBE7C \uC8FC\uC138\uC694";function Ya(e,t){return`${e}\0${t}`}function dg(e){return`${e}\uC758 \uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4`}function pg(e){let t=new Map;for(let[r,n]of e)t.set(r,n.slice());return t}function fg(e,t,r){let n=new Set([t]),s=[t];for(;s.length>0;){let o=s.pop();for(let a of e.get(o)||[]){if(a===r)return!0;n.has(a)||(n.add(a),s.push(a))}}return!1}function _g(e,t){let r=new Set(t),n=new Map,s=new Map;for(let i of r){let c=Array.from(new Set((e.get(i)||[]).filter(u=>u!==i&&r.has(u))));n.set(i,c.length);for(let u of c){let d=s.get(u);d?d.push(i):s.set(u,[i])}}let o=[],a=Array.from(r).filter(i=>n.get(i)===0).sort();for(;a.length>0;){let i=a.shift();o.push(i);for(let c of(s.get(i)||[]).slice().sort()){let u=(n.get(c)||0)-1;n.set(c,u),u===0&&a.push(c)}}for(let i of t)o.includes(i)||o.push(i);return o}function mg(e,t){let r=new Set;for(let[a,i]of t)for(let c of i)r.add(Ya(a,c));let n=new Map,s=new Map;for(let a of e){let i=Ya(a.a,a.b);n.set(i,a),s.set(i,a.type==="dep-add")}let o=[];for(let a of e){let i=Ya(a.a,a.b);n.get(i)===a&&s.get(i)!==r.has(i)&&o.push(a)}return o}function gg(e,t,r){let n=e.parallel_rows,s=Math.max(0,Math.min(n.length,r)),o=n[s];if(o&&o.root_dir===t)return o.queue_index;for(let a=s-1;a>=0;a--)if(n[a].root_dir===t)return n[a].queue_index+1;for(let a=s;a<n.length;a++)if(n[a].root_dir===t)return n[a].queue_index;return e.parallel_raw_length.get(t)??0}function hg(e,t){return e.parallel_rows.some(r=>r.root_dir===t)}function Za(e,t,r,n){return{type:"worker-queue-place",payload:{bead_id:e,...n?{lane:n}:{},index:r},root_dir:t}}function Eu(e,t,r){let n=pg(r.blocked_by_map),s=[],o=null,a=h=>{let T=r.owner_of.get(h);return typeof T!="string"||T.length===0?(o=dg(h),null):T},i=(h,T)=>{if(o!==null||h===T)return;let L=n.get(h)||[];if(!L.includes(T))return;let B=a(h);B!==null&&(n.set(h,L.filter(V=>V!==T)),s.push({type:"dep-remove",a:h,b:T,root_dir:B}))},c=(h,T)=>{if(o!==null||h===T)return;let L=n.get(h)||[];if(L.includes(T))return;let B=a(h);if(B!==null){if(fg(n,T,h)){o=`\uC758\uC874 \uC0AC\uC774\uD074\uC774 \uC0DD\uAE41\uB2C8\uB2E4 \u2014 ${h}\uAC00 \uC774\uBBF8 ${T}\uB97C \uB9C9\uACE0 \uC788\uC2B5\uB2C8\uB2E4`;return}n.set(h,[...L,T]),s.push({type:"dep-add",a:h,b:T,root_dir:B})}},u=()=>{let h=r.lane_order.get(e.lane_id||"")||[],T=new Set(h),L=(n.get(e.bead_id)||[]).filter(V=>T.has(V)),B=h.filter(V=>(n.get(V)||[]).includes(e.bead_id));for(let V of L)i(e.bead_id,V);for(let V of B)i(V,e.bead_id);for(let V of L)for(let H of B)c(H,V);return h.filter(V=>V!==e.bead_id)},d=(h,T)=>{let L=r.lane_order.get(h)||[],B=L.indexOf(e.bead_id),V=_g(n,L.filter(O=>O!==e.bead_id)),H=h.startsWith("pending:")?V.length:Math.max(0,Math.min(V.length,B>=0&&T>B?T-1:T)),P=H>0?V[H-1]:null,q=H<V.length?V[H]:null;if(P===null){q!==null&&c(q,e.bead_id);return}c(e.bead_id,P),q!==null&&(n.get(q)||[]).includes(P)&&(i(q,P),c(q,e.bead_id))},p=typeof e.queue_index=="number"?e.queue_index:r.queue_index_of.get(e.bead_id);if(t.kind==="repo-serial"&&e.root_dir!==t.root_dir)return{refused:cg};if(t.kind==="chain"&&e.kind==="repo-serial")return{refused:ug};if(e.kind==="chain"&&u(),t.kind==="chain"&&d(t.lane_id,t.marker_index),o!==null)return{refused:o};let _=[];if(t.kind==="candidate")e.kind!=="candidate"&&_.push({type:"worker-queue-remove",payload:{bead_id:e.bead_id},root_dir:e.root_dir});else if(t.kind==="parallel"){let h=gg(r,e.root_dir,t.marker_index);if(e.kind==="candidate"||e.kind==="repo-serial")_.push(Za(e.bead_id,e.root_dir,h));else if(e.kind==="parallel"){let T=r.parallel_rows,L=T[Math.max(0,Math.min(T.length,t.marker_index))];if(!(!!L&&L.bead_id===e.bead_id)&&hg(r,e.root_dir)&&p!==void 0){let V=p>h?h:h-1;V>=0&&V!==p&&_.push({type:"worker-queue-reorder",payload:{bead_id:e.bead_id,to_index:V},root_dir:e.root_dir})}}}else if(t.kind==="chain")e.kind==="candidate"&&_.push(Za(e.bead_id,e.root_dir,r.parallel_raw_length.get(e.root_dir)??0));else if(e.kind==="repo-serial"&&e.lane_id===t.lane_id){if(p!==void 0&&t.index!==p){let h=p>t.index?t.index:t.index-1;h>=0&&h!==p&&_.push({type:"worker-queue-reorder",payload:{bead_id:e.bead_id,lane:t.lane_id,to_index:h},root_dir:e.root_dir})}}else _.push(Za(e.bead_id,e.root_dir,t.index,t.lane_id));return{ops:[...mg(s,r.blocked_by_map),..._]}}var Tu={running:3,paused:2,failed:1};function Cu(e,t){let r=Object.values(e||{}),n=new Set,s=new Map;for(let a of r)!a||typeof a.bead_id!="string"||(typeof a.resumed_from=="string"&&a.resumed_from.length>0&&n.add(a.resumed_from),s.set(a.bead_id,a.attempt_id));let o=new Map;for(let a of r){if(!a||typeof a.bead_id!="string"||a.bead_id.length===0)continue;let i=null;if(a.status==="running")i="running";else if(a.status==="paused"&&!n.has(a.attempt_id))i="paused";else if(a.status==="failed"||a.status==="orphaned"){let d=t.get(a.bead_id),p=typeof d=="number"&&d>0&&typeof a.finished_at=="number"&&d>=a.finished_at;s.get(a.bead_id)===a.attempt_id&&!p&&typeof a.dismissed_at!="number"&&(i="failed")}if(!i)continue;let c=typeof a.started_at=="number"?a.started_at:null,u=o.get(a.bead_id);if(u){let d=Tu[u.run_state],p=Tu[i];if(d>p||d===p&&(u.started_at??0)>(c??0))continue}o.set(a.bead_id,{attempt:a,run_state:i,started_at:c})}return{winners:o,resumed_from_ids:n}}var Ru=[{step:"merge",label:"\uBA38\uC9C0",index:1},{step:"base",label:"base",index:2},{step:"verify",label:"\uAC80\uC99D",index:3},{step:"deploy",label:"\uBC30\uD3EC",index:4},{step:"child",label:"\uC790\uC2DD",index:5},{step:"branch",label:"\uBE0C\uB79C\uCE58",index:6},{step:"close",label:"close",index:7}],ds=[{step:"base_containment",label:"base \uD3EC\uD568 \uD655\uC778"},{step:"repo_operations",label:"\uC800\uC7A5\uC18C \uC791\uC5C5"},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC"},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC"},{step:"parent_close",label:"\uBD80\uBAA8 close"}];function Co(e,t){let r=Ru.find(s=>s.step===e);if(!r)return null;let n=Ru.length;return{step:r.step,label:t,index:r.index,total:n,percent:Math.round(r.index/n*100)}}function Iu(e){let t=ds.findIndex(r=>r.step===e);return ds.map((r,n)=>({step:r.step,label:r.label,state:t<0?"todo":n<t?"done":n===t?"stall":"todo"}))}function on(e){let t=ds.find(r=>r.step===e);return t?t.label:typeof e=="string"?e:""}function bg(e){let t=ds.findIndex(r=>r.step===e);return t<0?null:{index:t+1,total:ds.length}}function Ro(e){let t=bg(e);return t?`\uBA38\uC9C0 \uC644\uB8CC \xB7 \uC815\uB9AC ${t.total}\uB2E8\uACC4 \uC911 ${t.index}\uB2E8\uACC4\uC5D0\uC11C \uBA48\uCDA4`:"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644"}var Xa=new Set(["queued","running","retry_pending","repairing"]),Lu=new Set(["failed","succeeded"]),yg={queued:"\uB300\uAE30",running:"\uC911",retry_pending:"\uC7AC\uC2DC\uB3C4 \uB300\uAE30",repairing:"\uC790\uB3D9 \uD574\uACB0 \uC911",failed:"\uC2E4\uD328",succeeded:"\uC644\uB8CC \xB7 \uC815\uB9AC \uC7AC\uAC1C \uB300\uAE30"},ps={base_containment:{step:"base",label:"base \uD655\uC778 \uC911"},child_sweep:{step:"child",label:"\uC790\uC2DD \uC815\uB9AC \uC911"},branch_cleanup:{step:"branch",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC \uC911"},parent_close:{step:"close",label:"\uBD80\uBAA8 close \uC911"}},vg={merging:{step:"merge",label:"\uBA38\uC9C0 \uC911"},base_containment:ps.base_containment,child_sweep:ps.child_sweep,branch_cleanup:ps.branch_cleanup,parent_close:ps.parent_close};function wg(e){return typeof e=="string"&&/^[0-9a-f]{40}$/.test(e)}function kg(e,t,r){return!["verify","deploy"].includes(e.kind)||![...Xa,...Lu].includes(e.state)||![null,void 0,""].includes(e.superseded_by)||!Array.isArray(e.subjects)?!1:e.subjects.some(n=>n&&typeof n=="object"&&n.bead_id===t&&n.merged_sha===r)}function $g(e,t){let r=(t.kind==="deploy"?2:1)-(e.kind==="deploy"?2:1);if(r!==0)return r;let n=u=>u.state==="succeeded"?1:2,s=n(t)-n(e);if(s!==0)return s;let o=typeof e.requested_at=="number"?e.requested_at:0,a=typeof t.requested_at=="number"?t.requested_at:0;if(o!==a)return a-o;let i=typeof e.operation_id=="string"?e.operation_id:"",c=typeof t.operation_id=="string"?t.operation_id:"";return i.localeCompare(c)}function Qa(e,t=!1){let r=e.kind,n=r==="verify"?"\uAC80\uC99D":"\uBC30\uD3EC",s=t?"failed":e.state,o=yg[s];if(!o)return null;let a=Co(r,`${n} ${o}`);return a?{...a,active:Xa.has(s),failed:s==="failed"}:null}function xg(e){return!e||typeof e!="object"?null:vg[e.step]||null}function fs(e){if(!e||typeof e.bead_id!="string")return null;let t=e.bead_id,r=e.merge_progress&&typeof e.merge_progress=="object"?e.merge_progress:{},n=xg(r),s=e.cleanup_failed&&typeof e.cleanup_failed=="object"?e.cleanup_failed:null,o=["child_sweep","branch_cleanup","parent_close"].includes(typeof e.cleanup_cursor=="string"?e.cleanup_cursor:""),a=!o&&(e.cleanup_cursor==="repo_operations"||r.step==="repo_operations"),i=wg(e.merge_sha)?e.merge_sha:null,c=!o&&i&&Array.isArray(e.repo_operations)?e.repo_operations.filter(T=>T&&typeof T=="object"&&kg(T,t,i)).sort($g):[],u=a?c:[],d=u.find(T=>Xa.has(T.state));if(d)return Qa(d);if(s)return s.step==="repo_operations"&&c[0]?Qa(c[0],!0):null;let p=u.find(T=>Lu.has(T.state)?T.state!=="succeeded"||e.cleanup_cursor==="repo_operations":!1);if(p)return Qa(p);if(n){let T=Co(n.step,n.label);return T?{...T,active:!0,failed:!1}:null}let _=typeof e.cleanup_cursor=="string"?ps[e.cleanup_cursor]:null;if(!_)return null;let h=Co(_.step,_.label);return h?{...h,active:!0,failed:!1}:null}function Io(e){return!!e&&e.step!=="merge"&&e.failed!==!0}function Ja(e,t){return`${e}\0${t}`}function Ou(e){let t=new Map;for(let r of Array.isArray(e?.running)?e.running:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"running",state:"running"});for(let r of Array.isArray(e?.pr_wait)?e.pr_wait:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"pr_wait",state:"pr_wait"});for(let r of Array.isArray(e?.queue_groups)?e.queue_groups:[]){let n=Array.isArray(r.sublanes?.parallel)?r.sublanes.parallel:Array.isArray(r.items)?r.items:[];for(let s of n)t.set(s.id,{root_dir:s.root_dir,workspace_name:s.workspace_name,lane:"parallel",position:s.queue_position});for(let s of Array.isArray(r.sublanes?.serial)?r.sublanes.serial:[])for(let o of s.items)t.set(o.id,{root_dir:o.root_dir,workspace_name:o.workspace_name,lane:s.id,position:o.queue_position})}for(let r of Array.isArray(e?.runnable)?e.runnable:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"runnable",state:"runnable"});for(let r of Array.isArray(e?.done)?e.done:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"done",state:"done"});return t}function ei(e,t){let r=Array.isArray(t)?t:[],n=e.indexOf("-"),s=n>0?e.slice(0,n):e;return r.some(o=>typeof o?.issue_prefix=="string"&&o.issue_prefix===s)?"internal":r.length>0&&r.every(o=>typeof o?.issue_prefix=="string")?"external":"unknown"}function Ag(e,t){return e==="internal"&&t===void 0}function Ln(e){if(e.state==="running")return"\uC2E4\uD589\uC911";if(e.state==="pr_wait")return"PR \uB300\uAE30";if(e.state==="runnable")return"\uC2E4\uD589\uAC00\uB2A5";if(e.state==="done")return"\uC644\uB8CC";let t=e.lane==="parallel"?"\uBCD1\uB82C":e.lane;return`${e.workspace_name} \xB7 ${t} #${e.position}`}function Mu(e,t,r,n){let s=r.get(e);if(!!(s&&t&&s.root_dir===t.root_dir&&s.lane===t.lane&&typeof s.position=="number"&&typeof t.position=="number"&&s.position<t.position))return{id:e,label:`\u{1F512} ${e} (\uAC19\uC740 \uB808\uC778 \uC55E)`,location_label:"\uAC19\uC740 \uB808\uC778 \uC55E",scope:null,same_lane_ahead:!0,missing_internal:!1};if(s)return{id:e,label:`\u{1F512} ${e} (${Ln(s)})`,location_label:Ln(s),scope:null,same_lane_ahead:!1,missing_internal:!1};let a=ei(e,n),i=a==="internal"?"\uBBF8\uC801\uC7AC":a==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778";return{id:e,label:`\u{1F512} ${e} (${i})`,location_label:i,scope:a,same_lane_ahead:!1,missing_internal:Ag(a,s)}}function Pu(e){let t=Array.isArray(e)?e:[],r=new Map,n=new Map,s=new Map;for(let i of t)for(let c of Array.isArray(i.sublanes?.serial)?i.sublanes.serial:[]){let u=Ja(i.root_dir,c.id);r.set(u,{root_dir:i.root_dir,workspace_name:i.name,lane:c.id}),s.set(u,[]);for(let d of Array.isArray(c.items)?c.items:[])n.set(d.id,u)}for(let i of t)for(let c of Array.isArray(i.sublanes?.serial)?i.sublanes.serial:[]){let u=Ja(i.root_dir,c.id),d=Array.isArray(c.items)?c.items[0]:null,_=!!d&&d.queue_index===0&&(!Array.isArray(c.occupied_by)||c.occupied_by.length===0)&&Array.isArray(d.blocked_by)?d.blocked_by:[],h=s.get(u);if(h)for(let T of _){let L=n.get(T);L&&L!==u&&!h.includes(L)&&h.push(L)}}let o=(i,c)=>{let u=new Set,d=[i];for(;d.length>0;){let p=d.pop();if(p===c)return!0;!p||u.has(p)||(u.add(p),d.push(...s.get(p)||[]))}return!1},a=new Map;for(let[i,c]of s){let u=[];for(let d of c){let p=r.get(d);o(d,i)&&p&&u.push(p)}u.length>0&&a.set(i,u)}return a}function Du(e,t){return Ja(e,t)}var Nu=1,_s=[{value:"repo_spec",label:"\uB808\uD3EC \xB7 spec \uC6B0\uC120"},{value:"repo_updated",label:"\uB808\uD3EC \xB7 \uCD5C\uC2E0 \uC218\uC815"},{value:"updated_flat",label:"\uCD5C\uC2E0 \uC218\uC815(\uB808\uD3EC \uBB34\uC2DC)"}],ti=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],On={show_blocked:!0,spec:"all"},qu={auto_merge:"\uC790\uB3D9 \uBA38\uC9C0",merged:"\uBA38\uC9C0",merge:"\uBA38\uC9C0",pr_stop:"PR \uC911\uB2E8",stopped:"\uC911\uB2E8",failed:"\uC2E4\uD328"};function Sg(e,t){let r=null,n=-1/0;for(let s of Object.values(e)){if(!s||s.bead_id!==t||s.status==="running")continue;let o=typeof s.finished_at=="number"?s.finished_at:typeof s.started_at=="number"?s.started_at:0;o>=n&&(n=o,r=s)}return r}function Eg(e,t){let{winners:r,resumed_from_ids:n}=Cu(e,t),s=new Map;for(let[o,a]of r){let i=a.attempt,c=a.run_state,u=a.started_at,d=typeof i.session_id=="string"&&i.session_id.length>0;s.set(o,{attempt_id:typeof i.attempt_id=="string"?i.attempt_id:"",run_state:c,started_at:u,last_event_at:typeof i.last_event_at=="number"?i.last_event_at:null,last_activity:i.last_activity&&typeof i.last_activity=="object"?i.last_activity:null,legs:Array.isArray(i.legs)?i.legs:[],runner:typeof i.runner=="string"?i.runner:null,model:typeof i.model=="string"?i.model:null,effort:typeof i.effort=="string"?i.effort:null,speed:typeof i.speed=="string"?i.speed:null,resumed_from:typeof i.resumed_from=="string"?i.resumed_from:null,continuation_mode:i.continuation_mode==="session"||i.continuation_mode==="fresh"?i.continuation_mode:null,status:typeof i.status=="string"?i.status:null,usage:ir(e,i.bead_id),can_pause:c==="running"&&d,can_resume:c!=="running"&&d&&!n.has(i.attempt_id)})}return s}function Fu(e,t){let r=e[t];if(!r)return"";if(r.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let n=typeof r.reason=="string"?r.reason:"",s=n.indexOf(":");return s>0&&s<n.length-1?`\u26D4 ${n.slice(0,s)} (${n.slice(s+1)})`:`\u26D4 ${n}`}function Et(e){return e&&typeof e=="object"?e:{}}function Tg(e,t,r){let n=Et(t);if(Object.keys(n).length===0)return null;let s=e.execution_defaults,o=e.runner_catalog,a=e.session_defaults;if(!s||!o||!a)return null;let i=_=>Qt({pin:_,global:a,execution_defaults:s,runner_catalog:o,route:r}),c,u;try{c=i(n),u=i(null)}catch{return null}let d=ju(sn(c,o),sn(u,o)),p=ju(qr(c,null),qr(u,null));return d||p?{orchestration:d,worker:p}:null}function ju(e,t){return!e||t&&t.text===e.text?null:e}function Cg(e){return{id:e.id,label:`\u{1F512} \uC120\uD589 ${e.id} (${e.location_label})`,title:`\uC774 \uC774\uC288\uB294 ${e.id}\uAC00 close\uB420 \uB54C\uAE4C\uC9C0 \uCD9C\uBC1C\uD558\uC9C0 \uC54A\uB294\uB2E4`}}function Rg(e,t){let r=t.get(e);return r?{id:e,label:`\u2192 \uD6C4\uC18D ${e} (${Ln(r)})`,title:`\uC774 \uC774\uC288\uAC00 close\uB418\uBA74 ${e}\uAC00 \uC790\uAE30 \uB808\uD3EC \uD050\uC5D0\uC11C \uCD9C\uBC1C\uD55C\uB2E4`}:null}function Ig(e,t,r){let n=new Map;for(let c of e)n.set(c,Array.from(r.get(c)||[]).filter(u=>e.includes(u)).length);let s=[],o=new Map,a=e.filter(c=>(n.get(c)||0)===0).sort();for(let c of a)o.set(c,0);let i=[...a];for(;i.length>0;){let c=i.shift();s.push(c);let u=Array.from(t.get(c)||[]).filter(p=>e.includes(p)).sort(),d=(o.get(c)||0)+(u.length>1?1:0);for(let p of u){let _=(n.get(p)||0)-1;n.set(p,_);let h=o.get(p);o.set(p,h===void 0?d:Math.min(h,d)),_===0&&i.push(p)}}return{order:s,indent:o,cycle:s.length!==e.length}}function Lg(e,t,r){let n=new Map,s=new Map,o=new Set,a=(u,d,p)=>{let _=u.get(d);_?_.add(p):u.set(d,new Set([p]))};for(let[u,d]of e)for(let p of d)p!==u&&(o.add(p),o.add(u),a(n,p,u),a(s,u,p));let i=new Set,c=[];for(let u of Array.from(o).sort()){if(i.has(u))continue;let d=[],p=[u];for(i.add(u);p.length>0;){let H=p.pop();d.push(H);for(let P of[...n.get(H)||[],...s.get(H)||[]])i.has(P)||(i.add(P),p.push(P))}if(d.length<2)continue;let _=d.map(H=>t.get(H));if(_.every(H=>!!H&&/^s[1-5]$/.test(H.lane||""))&&_.every(H=>H&&_[0]&&H.root_dir===_[0].root_dir&&H.lane===_[0].lane))continue;let{order:T,indent:L,cycle:B}=Ig(d.slice().sort(),n,s),V=B?d.slice().sort():T;c.push({key:d.slice().sort().join("\0"),cycle:B,nodes:V.map(H=>{let P=t.get(H);return{id:H,workspace_name:P?P.workspace_name:"",root_dir:P?P.root_dir:"",location_label:P?Ln(P):Uu(H,r),indent:B?0:L.get(H)||0}})})}return c}function Uu(e,t){let r=ei(e,t);return r==="internal"?"\uBBF8\uC801\uC7AC":r==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778"}function Og(e,t,r){let n=t.get(e);if(!n)return Uu(e,r);if(typeof n.position=="number"){if(n.lane==="parallel")return`#${n.position}`;if(/^s[1-5]$/.test(n.lane))return`${n.lane} #${n.position}`}return Ln(n)}function Mg(e,t,r){let n=[];for(let s of r.get(e)||[])s!==e&&t.has(s)&&!n.includes(s)&&n.push(s);return n}function Pg(e,t,r,n,s,o){let a=(d,p,_,h,T=!1)=>{let L=n.get(d),B=L&&L.lane==="parallel"&&typeof L.position=="number"?L.position-1:null;return{id:d,title:o.get(d)||d,root_dir:L?L.root_dir:"",workspace_name:L?L.workspace_name:"",seq:p,indent:_,predecessors:h,location_label:Og(d,n,s),draggable:!T&&B!==null,...B!==null?{queue_index:B}:{}}},i=[];for(let d of e.slice().sort((p,_)=>p.key<_.key?-1:1)){let p=new Set(d.nodes.map(_=>_.id));i.push({lane_id:`chain:${d.key}`,label:"",pending:!1,cycle:d.cycle,rows:d.nodes.map((_,h)=>a(_.id,h+1,d.cycle?0:_.indent,d.cycle?[]:Mg(_.id,p,r),d.cycle))})}let c=new Set;for(let d of i)for(let p of d.rows)c.add(p.id);let u=[];return t.forEach((d,p)=>{let _=d&&typeof d.seed=="string"&&d.seed.length>0?d.seed:null;_!==null&&c.has(_)||(u.push(p),i.push({lane_id:`pending:${p}`,label:"",pending:!0,cycle:!1,rows:_===null?[]:[a(_,1,0,[])]}))}),i.forEach((d,p)=>{d.label=`\uC5F0\uACB0 ${p+1} \xB7 \uB808\uD3EC \uAC04`}),{chain_lanes:i,pending_lanes_kept:u}}function Bu(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function ri(e,t,r){let n=Array.isArray(e)?e:[],s=Array.isArray(t)?t:[],o=r&&typeof r.done_since=="number"?r.done_since:void 0,a={...On,...r&&r.candidate_filter?r.candidate_filter:{}},i=r&&_s.some(C=>C.value===r.candidate_sort)?r.candidate_sort:"repo_spec",c=new Map;for(let C of s)C&&typeof C.root_dir=="string"&&c.set(C.root_dir,C);let u=[],d=[],p=[],_=[],h=[],T=[],L=new Map,B=new Map,V=new Map,H=new Map,P=new Map,q=new Map;for(let C of n){if(!C||typeof C.root_dir!="string")continue;let K=C.root_dir,$e=C.name||K,Ne=c.get(K),Oe=Ne&&typeof Ne.revision=="number"?Ne.revision:typeof C.revision=="number"?C.revision:0,ze=Et(C.attempts),Ye=Et(C.bead_titles);for(let[A,M]of Object.entries(Ye))typeof M=="string"&&M.length>0&&q.set(A,M);let Y=Et(C.bead_times),Q=Et(C.pr_observations),Te=Et(C.admission),Ze=Et(C.revise_parked),Ve=Et(C.merge_queue_state),st=Et(C.cleanup_failed),Je=Et(C.discard_operations),mt=Et(C.bead_blocked_by),Pe=Et(C.bead_workflow),I=Et(C.pr_activity),ne=Array.isArray(C.repo_operations)?C.repo_operations:[],me=Array.isArray(C.merge_queue)?C.merge_queue:[],ae=new Set(me.filter(A=>A&&typeof A.bead_id=="string").map(A=>A.bead_id)),qe=new Map(me.filter(A=>A&&typeof A.bead_id=="string").map(A=>[A.bead_id,A])),Qe=Array.isArray(C.queue)?C.queue:[],ot=(Array.isArray(C.serial_lanes)?C.serial_lanes:[]).filter(A=>A&&/^s[1-5]$/.test(A.id)&&Array.isArray(A.entries)),Xe=Et(C.lane_states),dt=typeof C.serial_lane_count=="number"?Math.max(0,Math.min(5,Math.floor(C.serial_lane_count))):Math.min(5,ot.length);V.set(K,dt),H.set(K,Qe.length);let yt=new Map(ot.map(A=>[A.id,A])),gt=new Map;for(let A of ot)for(let M of A.entries)M&&typeof M.bead_id=="string"&&gt.set(M.bead_id,A.id);for(let[A,M]of Object.entries(mt))Array.isArray(M)&&P.set(A,M.filter(ue=>typeof ue=="string"&&ue.length>0));let pt=Array.isArray(C.done)?C.done:[];for(let A of pt)A&&typeof A.bead_id=="string"&&T.push({id:A.bead_id,root_dir:K,workspace_name:$e});let kt=new Map;for(let A of pt)A&&typeof A.bead_id=="string"&&typeof A.added_at=="number"&&kt.set(A.bead_id,A.added_at);let We=A=>({id:A,title:Ye[A]||A,root_dir:K,workspace_name:$e,expected_revision:Oe,draggable:!1,...Et(Y[A]).created_at?{created_at:Et(Y[A]).created_at}:{},...Et(Y[A]).updated_at?{updated_at:Et(Y[A]).updated_at}:{}}),Ke=new Set;for(let[A,M]of Eg(ze,kt))Ke.add(A),d.push({...We(A),lane:"running",...gt.has(A)?{serial_lane_id:gt.get(A)}:{},attempt_id:M.attempt_id,run_state:M.run_state,status:M.status||void 0,workflow:Pe[A]||null,can_pause:M.can_pause,can_resume:M.can_resume,started_at:M.started_at,last_event_at:M.last_event_at,last_activity:M.last_activity,legs:M.legs,runner:M.runner,model:M.model,effort:M.effort,speed:M.speed,resumed_from:M.resumed_from,continuation_mode:M.continuation_mode,usage:M.usage,exec_chips:{orchestration:Ao(M),worker:null},discard:yr(Je,A,{attempt_id:M.attempt_id}),badges:M.run_state==="paused"?["\u23F8 \uC77C\uC2DC\uC815\uC9C0"]:M.run_state==="failed"?["\u26A0 \uC2E4\uD328"]:[],alert:M.run_state==="failed"});for(let A of Array.isArray(C.pr_wait)?C.pr_wait:[]){let M=A&&A.bead_id;if(typeof M!="string"||Ke.has(M))continue;Ke.add(M);let ue=Et(Q[M]),k=Et(ue.pr),S=ue.gate?Et(ue.gate):null,F=ae.has(M),X=qe.get(M)?.continuation_action||null,ke=!!X&&X.continuation===null,ve=Ve.active===M,Me=A.external===!0,De=st[M]||null,Rt=Et(I[M]),at=fs({bead_id:M,merge_sha:A.merge_sha,cleanup_cursor:A.cleanup_cursor,merge_progress:Rt.merge_progress||null,cleanup_failed:De,repo_operations:ne}),et=Io(at),Dt=!!S&&S.base_badge==="\uCDA9\uB3CC",Ut=!!De&&["child_sweep","branch_cleanup","parent_close"].includes(De.step)&&!!S&&S.tier==="merged",Fe=Me&&!!De&&!!S&&S.tier==="merged",Ft=!!S&&["closed_unmerged","review","undecidable"].includes(S.tier),It=yr(Je,M,{external:Me,merge_active:ve||at?.step==="merge",merge_queued:F,cleanup_active:et,merged:!!De||S?.tier==="merged"}),zt=!!It.operation;p.push({...We(M),lane:"pr_wait",pr_number:typeof k.number=="number"?k.number:null,pr_url:typeof k.url=="string"?k.url:void 0,external:Me,usage:ir(ze,M),merge_step:at,badges:ke?["\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694"]:at?[S?.tier==="merged"?"\uBA38\uC9C0\uB428":"\uBA38\uC9C0 \uC911"]:De?[on(De.step)?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${on(De.step)}`:"\uC815\uB9AC \uBA48\uCDA4"]:typeof S?.gate_badge=="string"&&S.gate_badge.length>0?[S.gate_badge]:[],alert:at?at.failed===!0:!!De||Ft,reason:De&&at?.active!==!0?Ro(De.step):"PR \uB300\uAE30",merge_action:S?.tier==="merged"&&!Ut&&!Fe?!1:!F||ke,merge_enabled:!zt&&(ke||S?.enabled===!0||Dt||Ut||Fe),merge_label:ke?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":Fe||Ut?"\uC815\uB9AC \uC7AC\uAC1C":Dt&&!Ut?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:ke?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":zt?It.error?`\uD3D0\uAE30 \uC2E4\uD328: ${It.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${It.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:Fe?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Ut?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Dt?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":S?.enabled===!0?`\uBA38\uC9C0 (${S.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4`:`\uBA38\uC9C0 \uBD88\uAC00: ${S?.reason||"\uAD00\uCE21 \uB300\uAE30"}`,cancel_action:F&&!ke,cancel_enabled:!ve,continuation_mismatch:X?.mismatch||null,discard:It,discard_action:It.action,discard_enabled:It.enabled,discard_title:It.title})}let Ue=(A,M,ue,k)=>{let S=A&&A.bead_id;if(typeof S!="string"||Ke.has(S))return null;Ke.add(S);let F=Ze[S],X=yr(Je,S),ke=X.operation?X:null,ve={...We(S),lane:M,draggable:!ke,discard:ke||void 0,reason:Fu(Te,S),seq:ue+1,queue_position:ue+1,queue_index:ue,queue_length:k,badges:F?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!F,revise_action:!!F,revise_enabled:!!F&&!ke,revise_title:F?F.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${F.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(mt,S)&&(ve.blocked_by=Array.isArray(mt[S])?mt[S].filter(Me=>typeof Me=="string"&&Me.length>0):[]),ve};for(let A=0;A<Qe.length;A++){let M=Ue(Qe[A],"queue",A,Qe.length);if(!M)continue;_.push(M);let ue=L.get(K);ue?ue.push(M):L.set(K,[M])}let ct=[];for(let A=0;A<Math.max(dt,ot.length);A++){let M=`s${A+1}`,ue=yt.get(M),k=ue&&Array.isArray(ue.entries)?ue.entries:[],S=[];for(let ke=0;ke<k.length;ke++){let ve=Ue(k[ke],M,ke,k.length);ve&&(S.push(ve),_.push(ve))}let F=Et(Xe[M]),X=Array.isArray(F.occupied_by)?F.occupied_by.filter(ke=>typeof ke=="string"):[];S.length===0&&X.length===0&&(dt<=1||A>=dt)||ct.push({id:M,index:A,items:S,raw_length:k.length,occupied_by:X,corrections:Array.isArray(F.corrections)?F.corrections.length:0,cycle:F.cycle===!0,...S.length===0&&X.length===0?{empty:!0}:{}})}B.set(K,ct);let At=Array.from({length:dt},(A,M)=>{let ue=`s${M+1}`,k=yt.get(ue),S=k&&Array.isArray(k.entries)?k.entries:[],F=Et(Xe[ue]);return{id:ue,index:S.length,length:S.length,occupied_by:Array.isArray(F.occupied_by)?F.occupied_by.filter(X=>typeof X=="string"):[]}});for(let A of Array.isArray(C.runnable)?C.runnable:[]){let M=A&&A.bead_id;if(typeof M!="string"||Ke.has(M))continue;Ke.add(M);let ue=A.workflow&&typeof A.workflow=="object"?A.workflow:null,k=ue&&typeof ue.route=="string"&&ue.route||(typeof A.route=="string"?A.route:null),S=Tg(Et(Ne),A.exec_pins,k);Array.isArray(A.blocked_by)&&A.blocked_by.length>0&&P.set(M,A.blocked_by.filter(F=>typeof F=="string"&&F.length>0)),typeof A.title=="string"&&A.title.length>0&&q.set(M,A.title),u.push({...We(M),title:A.title||Ye[M]||M,lane:"runnable",draggable:!0,reason:Fu(Te,M),created_at:A.created_at??void 0,updated_at:A.updated_at??void 0,status:typeof A.status=="string"?A.status:void 0,labels:Array.isArray(A.labels)?A.labels:[],spec_id:typeof A.spec_id=="string"?A.spec_id:"",workflow:ue||(k?{route:k,chips:{route:k}}:null),...S?{exec_chips:S}:{},blocked:A.blocked===!0,...Array.isArray(A.blocked_by)?{blocked_by:A.blocked_by.filter(F=>typeof F=="string"&&F.length>0)}:{},place_index:Qe.length,place_lanes:At})}for(let A of pt){let M=A&&A.bead_id;if(typeof M!="string"||Ke.has(M)||(Ke.add(M),o!==void 0&&typeof A.added_at=="number"&&A.added_at<o))continue;let ue=Sg(ze,M),k=ue&&typeof ue.done_kind=="string"?ue.done_kind:null;h.push({...We(M),lane:"done",done:!0,done_layout:"three_line",usage:ir(ze,M),work_ms:yo(ze,M),done_at:typeof A.added_at=="number"?A.added_at:void 0,done_kind:k,badges:k&&qu[k]?[qu[k]]:[]})}}let O=new Map;s.forEach((C,K)=>{C&&typeof C.root_dir=="string"&&O.set(C.root_dir,K)});let U=r&&r.running_sort==="repo"?"repo":"started";d.sort((C,K)=>{if(U==="repo"){let Oe=O.get(C.root_dir)??Number.MAX_SAFE_INTEGER,ze=O.get(K.root_dir)??Number.MAX_SAFE_INTEGER;if(Oe!==ze)return Oe-ze}let $e=typeof C.started_at=="number"&&Number.isFinite(C.started_at)?C.started_at:null,Ne=typeof K.started_at=="number"&&Number.isFinite(K.started_at)?K.started_at:null;return $e!==null&&Ne!==null&&$e!==Ne?$e-Ne:$e===null&&Ne!==null?1:$e!==null&&Ne===null?-1:C.id.localeCompare(K.id)}),h.sort((C,K)=>(K.done_at??0)-(C.done_at??0));let b=s.length>0?s:n.map(C=>({root_dir:C&&C.root_dir,name:C&&C.name,auto_advance:C&&C.auto_advance,auto_merge:C&&C.auto_merge,slots:C&&C.slots,revision:C&&C.revision,runner_catalog:C&&C.runner_catalog})),j=new Set(u.map(C=>C.root_dir)),J=[];for(let C of b){if(!C||typeof C.root_dir!="string")continue;let K=L.get(C.root_dir)||[],$e=B.get(C.root_dir)||[];!(K.length>0||$e.some(Oe=>Oe.items.length>0||Oe.occupied_by.length>0))&&!j.has(C.root_dir)||J.push({root_dir:C.root_dir,name:C.name||C.root_dir,auto_advance:C.auto_advance===!0,auto_merge:C.auto_merge===!0,slots:typeof C.slots=="number"&&C.slots>=Nu?C.slots:Nu,revision:typeof C.revision=="number"?C.revision:0,runner_catalog:Et(C.runner_catalog),items:K,sublanes:{parallel:K,serial:$e},serial_lane_count:V.get(C.root_dir)||0,raw_queue_length:H.get(C.root_dir)||0})}let ee={runnable:u,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:i==="updated_flat",queue:_,queue_groups:J,running:d,pr_wait:p,done:h,chains:[],parallel_rows:[],chain_lanes:[],parallel_raw_length:Object.fromEntries(H),owner_of:{},pending_lanes_kept:[]},pe=Ou(ee);for(let C of T)pe.has(C.id)||pe.set(C.id,{root_dir:C.root_dir,workspace_name:C.workspace_name,lane:"done",state:"done"});let de=new Map;for(let[C,K]of P)for(let $e of K){let Ne=de.get($e);Ne?Ne.includes(C)||Ne.push(C):de.set($e,[C])}for(let C of[...ee.queue,...ee.runnable]){if(!Object.hasOwn(C,"blocked_by"))continue;let K=pe.get(C.id);C.blockers=(C.blocked_by||[]).map($e=>Mu($e,K,pe,s)),C.blocker_warnings=C.blockers.filter($e=>$e.missing_internal).map($e=>`\u26A0 \uC120\uD589 ${$e.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),C.blocker_warnings.length>0&&(C.alert=!0)}for(let C of[...ee.queue,...ee.runnable,...ee.running,...ee.pr_wait]){let K=C.lane==="running"||C.lane==="pr_wait"?[]:(C.blockers||[]).map(Cg),$e=[];for(let ze of de.get(C.id)||[]){let Ye=Rg(ze,pe);Ye&&$e.push(Ye)}let Ne=C.lane==="running"||C.lane==="pr_wait"?[]:C.blocker_warnings||[];if(K.length===0&&$e.length===0&&Ne.length===0)continue;let Oe={predecessors:K,successors:$e,warnings:Ne};C.dependency_chips=Oe}ee.chains=Lg(P,pe,s);let he=Pu(ee.queue_groups);for(let C of ee.queue_groups)for(let K of C.sublanes.serial){let $e=he.get(Du(C.root_dir,K.id));$e&&(K.cross_wait_peers=$e)}let Se=Pg(ee.chains,Array.isArray(r?.pending_lanes)?r.pending_lanes:[],P,pe,s,q);ee.chain_lanes=Se.chain_lanes,ee.pending_lanes_kept=Se.pending_lanes_kept;let Le=new Set;for(let C of ee.chain_lanes)for(let K of C.rows)Le.add(K.id);let te=[];for(let C of L.values())for(let K of C)Le.has(K.id)||te.push(K);te.sort((C,K)=>{let $e=C.workspace_name.localeCompare(K.workspace_name);return $e!==0?$e:(C.queue_index??0)-(K.queue_index??0)}),ee.parallel_rows=te;let se={};for(let[C,K]of pe)typeof K.root_dir=="string"&&K.root_dir.length>0&&(se[C]=K.root_dir);ee.owner_of=se;let Ae=ee.runnable.length,N=ee.runnable;a.show_blocked||(N=N.filter(C=>C.blocked!==!0));let oe=N.length;a.spec==="with"?N=N.filter(C=>!!C.spec_id):a.spec==="without"&&(N=N.filter(C=>!C.spec_id)),ee.runnable_hidden={blocked:Ae-oe,spec:oe-N.length};let re=(C,K)=>{let $e=Bu(K.updated_at)-Bu(C.updated_at);return $e!==0?$e:C.id.localeCompare(K.id)},Ee=i==="repo_spec"?(C,K)=>{let $e=C.spec_id?0:1,Ne=K.spec_id?0:1;return $e!==Ne?$e-Ne:re(C,K)}:re;if(i==="updated_flat")ee.runnable=N.slice().sort(re),ee.runnable_sections=[];else{let C=new Map;for(let Ne of N){let Oe=C.get(Ne.root_dir);Oe?Oe.push(Ne):C.set(Ne.root_dir,[Ne])}let K=[],$e=[];for(let Ne of b){if(!Ne||typeof Ne.root_dir!="string")continue;let Oe=(C.get(Ne.root_dir)||[]).slice().sort(Ee);C.delete(Ne.root_dir),Oe.length!==0&&(K.push({root_dir:Ne.root_dir,name:Ne.name||Ne.root_dir,items:Oe.map(ze=>({...ze,workspace_name:""}))}),$e.push(...Oe))}for(let[Ne,Oe]of C){let ze=Oe.slice().sort(Ee);K.push({root_dir:Ne,name:ze[0]?.workspace_name||Ne,items:ze.map(Ye=>({...Ye,workspace_name:""}))}),$e.push(...ze)}ee.runnable=$e,ee.runnable_sections=K}return ee}var Gu="bdui.monitor.done-range",Vu="bdui.monitor.running_sort",Ku="bdui.monitor.candidate_sort",Yu="beads-ui.monitor.candidate-filter",Zu="beads-ui.monitor.sections";function Dg(){try{let e=window.localStorage.getItem(Yu);if(!e)return{...On};let t=JSON.parse(e);return!t||typeof t!="object"?{...On}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:On.show_blocked,spec:ti.some(r=>r.value===t.spec)?t.spec:"all"}}catch{return{...On}}}function Wu(e){try{window.localStorage.setItem(Yu,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Ng(){try{let e=window.localStorage.getItem(Ku);return _s.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function qg(e){try{window.localStorage.setItem(Ku,e)}catch{}}function Fg(){try{let e=window.localStorage.getItem(Zu);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function zu(e){try{window.localStorage.setItem(Zu,JSON.stringify(e))}catch{}}function jg(){try{let e=window.localStorage.getItem(Gu);return or(e)?e:er}catch{return er}}function Bg(e){try{window.localStorage.setItem(Gu,e)}catch{}}function Ug(){try{return window.localStorage.getItem(Vu)==="repo"?"repo":"started"}catch{return"started"}}function Wg(e){try{window.localStorage.setItem(Vu,e)}catch{}}var Qu="tab:monitor:pipeline",zg=1e3,Hg=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],Hu="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function Gg(e){return e>=1&&e<=Hu.length?Hu[e-1]:`(${e})`}function Xu(e,t){let r=St("views:monitor"),n=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.switchWorkspace,c=t.router,u=t.now||(()=>Date.now()),d=t.confirm||(v=>typeof globalThis.confirm!="function"||globalThis.confirm(v)),p=jg(),_=Ug(),h=Dg(),T=Ng(),L=Fg(),B=null,V=null,H=[],P=null;function q(){let v=Rr.find(w=>w.value===p);return v?v.label:""}let O=document.createElement("div");O.className="mon",e.appendChild(O);let U=document.createElement("div");U.className="mon2-drawer",e.appendChild(U);let b=ri(null,null),j=new Map,J=new Map,ee=null,pe=null,de=null,he=Tn(U,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{B=null,me()}});async function Se(v,w,R,W,be=!0){if(!o||!R)return null;let we=await o(v,{...w,root_dir:R,expected_revision:W});if(we&&we.conflict&&be){we.queue&&J.set(R,we.queue);let ge=we.queue&&typeof we.queue.revision=="number"?we.queue.revision:W;we=await o(v,{...w,root_dir:R,expected_revision:ge})}return we&&we.queue&&R&&J.set(R,we.queue),we}function Le(v,w){let R=J.get(v),W=s&&s.get?s.get():null,be=(Array.isArray(W)?W:[]).find(ge=>ge?.root_dir===v);return(R||be)?.merge_queue?.find(ge=>ge.bead_id===w)?.continuation_action}async function te(v,w,R,W){let be=await Se(v,w,R,W),we=J.get(R)?.revision??be?.queue?.revision??W;return wr(be,(ge,tt)=>Se(v,{...w,continuation:ge,decision_token:tt},R,we,!1),{refresh:ge=>Se(v,w,R,ge?.queue?.revision??J.get(R)?.revision??we,!1)})}async function se(v,w,R,W){let be=await wr({continuation_mismatch:W},(ge,tt)=>Se("worker-merge-queue-add",{bead_id:w,continuation:ge,decision_token:tt},v,R,!1)),we=be?.queue?.merge_queue?.find(ge=>ge.bead_id===w)?.continuation_action;be?.applied!==!0&&we?.continuation===null&&we.mismatch&&await se(v,w,be.queue.revision,we.mismatch)}async function Ae(v,w,R){let W=await Se("worker-discard",v,w,R);if(W&&W.discarded===!0){fe(wo(W),"success",5e3);return}if(W&&W.reason){fe(`\uD3D0\uAE30 \uC2E4\uD328: ${W.reason}`,"error");return}if(W&&W.accepted&&W.pending==="merged_revert"){fe("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(W&&W.accepted){fe(`\uD3D0\uAE30 \uC9C4\uD589: ${W.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}W&&!W.conflict&&fe("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function N(v,w,R){return!o||!R?null:await o(v,{...w,root_dir:R})}async function oe(){let v=new Map;for(let w of b.pr_wait)v.has(w.root_dir)||v.set(w.root_dir,w.expected_revision);for(let[w,R]of v)await Se("worker-merge-queue-add-all",{},w,R)}function re(v){let w=L[v];return!!(w&&w.runnable===!0)}function ye(v){let w={...L[v]||{}};w.runnable=!w.runnable,L={...L,[v]:w},zu(L),me()}function Ee(v){return L[v]===!0}function C(v){L={...L,[v]:L[v]!==!0},zu(L),me()}function K(v){let w=re(v.root_dir);return l`<header class="mon2-sec__hd">
      <button
        type="button"
  ...
  `,e.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),a=r.querySelector("#new-priority"),i=r.querySelector("#new-labels"),c=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),d=r.querySelector("#btn-cancel"),p=r.querySelector("#btn-create"),_=r.querySelector(".new-issue__close");function h(){o.replaceChildren();let O=document.createElement("option");O.value="",O.textContent="\u2014 Select \u2014",o.appendChild(O);for(let U of ed){let b=document.createElement("option");b.value=U,b.textContent=td(U),o.appendChild(b)}a.replaceChildren();for(let U=0;U<=4;U+=1){let b=document.createElement("option");b.value=String(U);let j=rd[U]||"Medium";b.textContent=`${U} \u2013 ${j}`,a.appendChild(b)}}h();function T(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function L(O){s.disabled=O,o.disabled=O,a.disabled=O,i.disabled=O,c.disabled=O,d.disabled=O,p.disabled=O,p.textContent=O?"Creating\u2026":"Create"}function B(){u.textContent=""}function V(O){u.textContent=O}function H(){try{let O=window.localStorage.getItem("beads-ui.new.type");O?o.value=O:o.value="";let U=window.localStorage.getItem("beads-ui.new.priority");U&&/^\d$/.test(U)?a.value=U:a.value="2"}catch{o.value="",a.value="2"}}function P(){let O=o.value||"",U=a.value||"";O.length>0&&window.localStorage.setItem("beads-ui.new.type",O),U.length>0&&window.localStorage.setItem("beads-ui.new.priority",U)}async function q(){B();let O=String(s.value||"").trim();if(O.length===0){V("Title is required"),s.focus();return}let U=Number(a.value||"2");if(!(U>=0&&U<=4)){V("Priority must be 0..4"),a.focus();return}let b=String(o.value||""),j=String(c.value||""),J={title:O};b.length>0&&(J.type=b),String(U).length>0&&(J.priority=U),j.length>0&&(J.description=j),L(!0);try{await t("create-issue",J)}catch{L(!1),V("Failed to create issue");return}P(),L(!1),T()}return r.addEventListener("cancel",O=>{O.preventDefault(),T()}),_.addEventListener("click",()=>T()),d.addEventListener("click",()=>T()),r.addEventListener("keydown",O=>{O.key==="Enter"&&(O.ctrlKey||O.metaKey)&&(O.preventDefault(),q())}),n.addEventListener("submit",O=>{O.preventDefault(),q()}),{open(){n.reset(),B(),H();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){T()}}}var Vg=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Kg(e,t){return ea(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function sd(e,t,r){return l`
    <section class="settings-dialog__group">
      ...
      ${t.length===0?l`<div class="settings-dialog__empty">라벨 없음</div>`:l`<div class="settings-dialog__pills">
            ${t.map(n=>{let s=Kg(n,e);return l`<button
                type="button"
  ...
  `}function ad(e,t){return l`
    <section class="settings-dialog__group">
      ...
      <div class="settings-dialog__toggles">
        ${Vg.map(([r,n])=>l`<label class="settings-dialog__toggle">
              <input
                type="checkbox"
                data-chip=${r}
                .checked=${e.chips[r]!==!1}
  ...
  `}var Yg=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function id(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(he=>fe(he,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,u="",d=null;function p(){if(d)return d;let he=a.querySelector('[data-pane="execution"]');return he?(d=Eo(he,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:r,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:Se=>t.queueStore?.set?.(Se)}),d):null}function _(){return l`
      <section
    ...
    `}async function T(he){let Se=n.get();if(Se)try{let Le=await r("display-policy-set",{expected_revision:Se.revision,policy:he(Se)});L(Le),Le&&Le.conflict&&Le.policy&&(Le=await r("display-policy-set",{expected_revision:Le.policy.revision,policy:he(Le.policy)}),L(Le)),Le&&Le.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function L(he){he&&he.policy&&typeof he.policy=="object"&&n.set(he.policy)}function B(he){T(he)}function V(he){let Se=n.get();if(!Se)return;let Le=!Zg(he,Se);B(te=>Qg(he,te,Le))}function H(){let he=u.trim();he.length!==0&&(u="",B(Se=>Se.hidden_prefixes.includes(he)?{hidden_prefixes:Se.hidden_prefixes}:{hidden_prefixes:[...Se.hidden_prefixes,he]}),O())}function P(he){B(Se=>({hidden_prefixes:Se.hidden_prefixes.filter(Le=>Le!==he)}))}function q(he){let Se=n.get();if(!Se)return;let Le=Se.chips[he]===!1;B(()=>({chips:{[he]:Le}}))}function O(){Ge(l`
    ...
    >
      ...
      <span class="usage-meter__pct">${oe}%</span>
        ...
        >${te.label}</span
      >
      ${se.available?se.windows.map(K=>q(K,N,oe,Ae)):l`<span class="usage-meter__empty">사용량 없음</span>`}
    ...
    >
      ...
      <p class="usage-meter__note">전환은 새로 시작하는 세션부터 적용됩니다.</p>
          ...
          @mousedown=${H}
        ></div>
        ${pe(te,se)}`,Ae)}async function Se(te){try{let se=await fetch(te.endpoint);return se.ok?sh(await se.json()):null}catch{return null}}async function Le(){i+=1;let te=i,se=await Promise.all(_d.map(async Ae=>({provider:Ae,snapshot:await Se(Ae)})));if(!(t||te!==i)){for(let Ae of se)Ae.snapshot?o.set(Ae.provider.key,Ae.snapshot):o.delete(Ae.provider.key);de()}}return u(),Le(),s=setInterval(()=>{Le()},6e4),{destroy(){t=!0,s!==null&&(clearInterval(s),s=null),h(),u()}}}function bd(e){let t=e.attempts?Object.values(e.attempts):[],r=new Map;for(let s of t)s&&r.set(s.bead_id,s.attempt_id);let n=new Map;for(let s of e.done||[])s&&typeof s.bead_id=="string"&&typeof s.added_at=="number"&&n.set(s.bead_id,s.added_at);return s=>{let o=r.get(s.bead_id)!==s.attempt_id,a=n.get(s.bead_id),i=typeof a=="number"&&a>0&&typeof s.finished_at=="number"&&a>=s.finished_at;return!o&&!i&&typeof s.dismissed_at!="number"}}var oh="worker-ineligible";function ni(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function yd(e){return ni(e).includes(oh)}var ah="worker-serial";function si(e){return ni(e).includes(ah)}function oi(e,t,r){if(typeof t!="string"||typeof r!="string")return[];let n=e?.runners;if(!n||!Object.hasOwn(n,t))return[];let s=n[t],o=s?.models;if(!o||!Object.hasOwn(o,r))return[];let a=o[r]?.efforts;return Array.isArray(a)?a.slice():Array.isArray(s.efforts)?s.efforts.slice():[]}var ih=new Set(["done","failed","orphaned","stopped","discarded"]),lh={spec_missing:"\uC2A4\uD399 \uC5C6\uC74C",route:"route \uBBF8\uB2EC",spec_review:"\uC2A4\uD399 \uB9AC\uBDF0 \uC5C6\uC74C",spec_conflict:"\uC2A4\uD399 \uCDA9\uB3CC",phase_child:"phase child",worker_ineligible:"worker \uC81C\uC678"},ch={running:"\uC2E4\uD589 \uC911",success:"\uC131\uACF5",failure:"\uC2E4\uD328",cancelled:"\uCDE8\uC18C",interrupted:"\uC911\uB2E8"},uh={running:"running",success:"done",failure:"failed",cancelled:"stopped",interrupted:"orphaned"};function ai(e){return{runner:e.runner||void 0,model:e.model||void 0,effort:e.effort||void 0,status:uh[e.outcome]||(typeof e.job_id=="string"?"running":void 0),session_id:e.session_id||void 0}}function vd(e,t){let{queueStore:r,analysisStore:n,transport:s,getWorkspacePath:o,onOpenTranscript:a}=t,i=document.createElement("dialog");i.id="worker-parallel-analysis-dialog",i.className="pa",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),e.appendChild(i);let c=new Map,u=new Map,d=!1,p=null,_=null,h=null,T=new Set,L=!1,B=0,V=null,H=new Set;function P(){return r&&r.get()||{revision:0,queue:[],serial_lanes:[],serial_lane_count:0,attempts:{},pr_wait:[]}}function q(){return n&&n.get()||{settings:{revision:0,runner:null,model:null,effort:null},job:null,runs:[],last_good:null}}function O(){return o&&o()||""}async function U(){if(!s)return;let k=++B;L=!0,h=null,T.clear(),We();try{let S=await s("worker-parallel-analysis-targets",{root_dir:O()});if(k!==B||!Ke)return;let F=Array.isArray(S?.qualified)?S.qualified:[],X=Array.isArray(S?.excluded)?S.excluded:[];h={qualified:F,excluded:X};for(let ke of F)ke&&typeof ke.id=="string"&&T.add(ke.id)}catch{k===B&&Ke&&(h={qualified:[],excluded:[]},fe("\uBD84\uC11D \uB300\uC0C1\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800))}finally{k===B&&(L=!1,Ke&&We())}}function b(k){return Array.isArray(k.runs)?k.runs:[]}function j(){let k=P(),S=new Set;for(let F of Object.values(k.attempts||{})){let X=F;X&&typeof X.bead_id=="string"&&!ih.has(X.status)&&S.add(X.bead_id)}for(let F of Array.isArray(k.pr_wait)?k.pr_wait:[])F&&typeof F.bead_id=="string"&&S.add(F.bead_id);for(let F of Object.values(k.discard_operations||{})){let X=F;X&&X.phase!=="done"&&typeof X.bead_id=="string"&&S.add(X.bead_id)}return S}function J(k){return k.filter(S=>ee(S)===null)}function ee(k){let S=P();for(let F of Array.isArray(S.serial_lanes)?S.serial_lanes:[])if(Array.isArray(F?.entries)&&F.entries.some(X=>X.bead_id===k))return F.id;return(Array.isArray(S.queue)?S.queue:[]).some(F=>F.bead_id===k)?"parallel":null}function pe(k,S){let F=c.get(k);return F||[...S.order]}function de(k){if(k.length<2)return!1;let S=ee(k[0]);if(!S||S==="parallel")return!1;let F=P(),X=(Array.isArray(F.serial_lanes)?F.serial_lanes:[]).find(ve=>ve.id===S)?.entries.map(ve=>ve.bead_id);if(!Array.isArray(X))return!1;let ke=k.map(ve=>X.indexOf(ve));return ke.every(ve=>ve>=0)&&ke.every((ve,Me)=>Me===0||ve>ke[Me-1])}function he(){let k=P(),S=Array.isArray(k.serial_lanes)?k.serial_lanes:[],F=S.find(X=>Array.isArray(X.entries)&&X.entries.length===0);return F?F.id:S[0]?.id||"s1"}function Se(k){let S=P().bead_titles||{};return typeof S[k]=="string"?S[k]:k}async function Le(k,S){if(!s||d)return null;d=!0,We();try{return await s(k,S)}finally{d=!1,We()}}async function te(k){n?.setPending?.(!0);try{let S=await Le("worker-parallel-analysis-start",{force:k,target_ids:Array.from(T)});S&&S.applied===!1&&S.reason&&(S.reason==="target_not_qualified"&&Array.isArray(S.detail)?fe(`\uBD84\uC11D \uB300\uC0C1 \uC790\uACA9 \uBCC0\uACBD: ${S.detail.join(", ")}`,"error",3200):fe(`\uBD84\uC11D \uC2E4\uD328: ${S.reason}`,"error",2800))}finally{n?.setPending?.(!1)}}async function se(){let k=q().job;!s||!k||await s("worker-parallel-analysis-cancel",{job_id:k.job_id})}async function Ae(k){if(!(!s||H.has(k))){H.add(k),We();try{let S=await s("worker-parallel-analysis-prompt",{root_dir:O(),run_id:k});if(!Ke)return;if(S?.ok===!0&&typeof S.prompt=="string"){V={run_id:k,prompt:S.prompt};return}fe(S?.reason==="not_found"?"\uC800\uC7A5\uB41C \uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800)}finally{H.delete(k),We()}}}function N(){V=null,We()}async function oe(){if(!V)return;let k=await tr(V.prompt);fe(k?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",k?"success":"error",1400)}function re(k,S){a&&a(k,ai(S))}function ye(){return P().runner_catalog}function Ee(k){return Object.keys(ye()?.runners?.[k]?.models||{})}function C(k){let S=Ee(k),F=ye()?.runners?.[k]?.default_model;return typeof F=="string"&&S.includes(F)?F:S[0]||""}function K(){let k=q().settings,S=p||k.runner||"claude",F=Ee(S),X=p?C(S):k.model||F[0]||"",ke=oi(ye(),S,X),ve=k.effort||"",Me=ke.includes(ve)?ve:ke[0]||"";return{runner:S,model:X,effort:Me,models:F,efforts:ke}}async function $e(k){let S=q().settings,F=await Le("worker-parallel-analysis-settings-update",{expected_revision:S.revision,runner:k.runner,model:k.model,effort:k.effort});(!F||F.applied!==!0)&&(p=null,We(),F&&F.reason&&fe(`\uBD84\uC11D \uC124\uC815 \uAC70\uBD80: ${F.reason}`,"error",2800))}function Ne(k){p=k,We();let S=K();$e({runner:k,model:S.model,effort:S.effort})}function Oe(k){let S=K(),F=oi(ye(),S.runner,k);$e({runner:S.runner,model:k,effort:F.includes(S.effort)?S.effort:F[0]||""})}function ze(k){let S=K();$e({runner:S.runner,model:S.model,effort:k})}async function Ye(k,S){if(!s||d)return;let F=pe(k,S),X=q();if(F.length<2||!X.last_good){fe("\uC81C\uCD9C\uD558\uB824\uBA74 2\uAC1C \uC774\uC0C1\uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4","warning");return}let ke=u.get(k)||he(),ve=()=>({snapshot_digest:X.last_good.identity_digest,group_index:k,lane:ke,ordered_bead_ids:F,expected_revision:P().revision});d=!0,We();try{let Me=await s("worker-parallel-analysis-submit",ve());Me&&Me.queue&&r&&r.set(Me.queue),Me&&Me.applied!==!0&&Me.conflict===!0&&(Me=await s("worker-parallel-analysis-submit",ve()),Me&&Me.queue&&r&&r.set(Me.queue)),Me&&Me.applied===!0?(c.delete(k),fe(`\uC9C1\uB82C \uB808\uC778 ${ke}\uC5D0 ${F.length}\uAC1C \uBC30\uCE58`,"success")):fe(`\uC81C\uCD9C \uAC70\uBD80: ${Me?.reason||"conflict"} (\uD050 \uBB34\uBCC0\uACBD)`,"error",2800)}finally{d=!1,We()}}function Y(k,S,F){c.set(k,pe(k,S).filter(X=>X!==F)),We()}function Q(k){c.delete(k),We()}function Te(k,S,F,X){let ke=[...pe(k,S)],ve=ke.indexOf(F),Me=ve+X;ve<0||Me<0||Me>=ke.length||(ke.splice(Me,0,...ke.splice(ve,1)),c.set(k,ke),We())}function Ze(){let k=q().settings,S=Object.keys(ye()?.runners||{}),F=K();return l`<div class="pa-settings">
      ...
      >`:k.is_default===!0?l`<span class="pa-settings__default">기본값</span>`:""}function st(k){return k.is_default===!0&&k.compatible===!1}function Je(k){return!!(k.runner&&k.model&&k.effort)}function mt(k){return Je(k)&&k.compatible!==!1}function Pe(k){let S=Math.max(0,Math.floor(k/1e3)),F=Math.floor(S/60),X=S%60;return`${F}:${String(X).padStart(2,"0")}`}function I(k){let S=k.job;if(S){let F=typeof S.started_at=="number"?S.started_at:0,X=`${S.runner||"?"}/${S.model||"?"}`,ke=F?` \xB7 \uACBD\uACFC ${Pe(Date.now()-F)}`:"",ve=typeof S.session_id=="string"?S.session_id:"",Me=b(k).find(De=>De.run_id===S.job_id);return l`<span class="pa-meta__progress">
        <span
        ...
        >`:""}function ne(){return n?.isPending?.()===!0}function me(k){let S=!!k.job,F=mt(k.settings),X=h!==null&&T.size===0,ke=S||d||ne()||L;return l`<div class="pa-meta">
    ...
    </div>`}function ae(k){return typeof k=="string"&&k.length>0?k:"\uBBF8\uBC30\uCE58"}function qe(k,S){S?T.add(k):T.delete(k),We()}function Qe(k){let S=Array.isArray(k.scope)?k.scope:[],F=Array.isArray(k.overlaps)?k.overlaps:[];return S.length===0&&F.length===0?l``:l`<span class="pa-target__signals">
...
`)}>
            ...
            ${k.map(F=>l`<li class="pa-target">
                  <label class="pa-target__label">
                    <input
                      ...
                      data-target-id=${F.id}
                      .checked=${T.has(F.id)}
                      @change=${X=>qe(F.id,X.target.checked)}
                    />
      ...
      ${h&&S.length>0?l`<details class="pa-targets__excluded">
            ...
            <ul class="pa-targets__list">
              ${S.map(F=>l`<li class="pa-target pa-target--excluded">
                    <label class="pa-target__label">
    ...
    </section>`}function Xe(k){let S=typeof k.session_id=="string"&&k.session_id.length>0,F=S?k.session_id:"";return l`<li class="pa-run-row">
      <span class="pa-run-row__status pa-run-row__status--${k.outcome}"
        >${ch[k.outcome]||k.outcome}</span
      >
      ...
      >
      ${S?l`<code class="pa-session-id" title=${F}
            >${F.slice(0,8)}</code
...
${V.prompt}</pre
    ...
    </div>`:""}function gt(k,S){let F=pe(k,S),X=j(),ke=F.filter(et=>X.has(et)),ve=J(F),Me=de(F),De=Array.isArray(P().serial_lanes)?P().serial_lanes:[],Rt=u.get(k)||he(),at=S.eligible!==!0||F.length<2||ke.length>0||ve.length>0||Me||d;return l`<section class="pa-group" data-group-index=${String(k)}>
      ...
      <ol class="pa-group__members">
        ${F.map((et,Dt)=>l`<li class="pa-member" data-bead-id=${et}>
    ...
    </section>`}function pt(k){let S=Array.isArray(k.issues)?k.issues:[],F=S.filter(ke=>ke.verdict==="parallel_ok").length,X=S.filter(ke=>ke.verdict==="uncertain").length;return l`<div class="pa-summary">
      <span>parallel_ok ${F}</span>
      <span>uncertain ${X}</span>
    </div>`}function kt(){let k=Ke&&!!q().job;if(k&&_===null){_=setInterval(()=>We(),1e3);return}!k&&_!==null&&(clearInterval(_),_=null)}function We(){let k=q();p&&k.settings.runner===p&&(p=null);let S=k.last_good?.result;kt(),Ge(l`
        ...
        ${yt()}
      `,i)}let Ke=!1,Ue=()=>{Ke=!1,V=null,B+=1,kt()},ct=k=>{k.target===k.currentTarget&&ue()};i.addEventListener("close",Ue),i.addEventListener("cancel",Ue),i.addEventListener("click",ct);let At=null;r&&r.subscribe&&(At=r.subscribe(()=>{Ke&&We()}));let A=null;n&&n.subscribe&&(A=n.subscribe(()=>{Ke&&We()}));function M(){Ke||(Ke=!0,We(),U(),typeof i.showModal=="function"?i.showModal():i.setAttribute("open",""))}function ue(){Ke&&(Ke=!1,V=null,B+=1,kt(),typeof i.close=="function"?i.close():i.removeAttribute("open"))}return{open:M,close:ue,destroy(){Ke=!1,_!==null&&(clearInterval(_),_=null),i.removeEventListener("close",Ue),i.removeEventListener("cancel",Ue),i.removeEventListener("click",ct),At&&(At(),At=null),A&&(A(),A=null),i.remove()}}}var wd=new Set(["sh","bash","zsh","dash","ksh"]),kd=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function $d(e){let t=e.split("/");return t[t.length-1]||""}function dh(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let r=t.slice(2).trim().split(/\s+/).filter(Boolean);if(r.length===0)return!1;let n=$d(r[0]);if(n!=="env")return wd.has(n);let s=r.slice(1).find(o=>!o.startsWith("-")&&!o.includes("="));return s!==void 0&&wd.has($d(s))}function ph(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function fh(e){let t=[],r=0;kd.lastIndex=0;for(let n of e.matchAll(kd)){let s=n.index;s>r&&t.push({text:e.slice(r,s),kind:"plain"}),t.push({text:n[0],kind:ph(n[0])}),r=s+n[0].length}return r<e.length&&t.push({text:e.slice(r),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function _h(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function xd(e){let t=e.getWorkspacePath,r=e.fetchImpl||globalThis.fetch?.bind(globalThis),n=document.createElement("div");n.className="repo-ops-script-viewer-root",document.body.appendChild(n);let s=null,o="loading",a="",i="",c=0,u=null,d=!1;function p(O,U){return U?fh(O).map(b=>b.kind==="plain"?b.text:l`<span
            class="repo-ops-script-viewer__token repo-ops-script-viewer__token--${b.kind}"
            >${b.text}</span
          >`):O}function _(){if(!s)return l``;let O=o==="ready"&&dh(a),U=o==="ready"?a.split(`
`):[];return l`<div
    ...
    </div>`}function h(){Ge(_(),n)}async function T(){if(o!=="ready")return;let O=await tr(a);fe(O?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",O?"success":"error")}function L(O){O.key==="Escape"&&s&&(O.preventDefault(),P())}function B(){d||(document.addEventListener("keydown",L),d=!0)}function V(){d&&(document.removeEventListener("keydown",L),d=!1)}async function H(O,U=null){let b=++c;B(),s={...O},u=U||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",h(),n.querySelector(".repo-ops-script-viewer__close")?.focus();let J=t?t():"";if(!J){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",h();return}if(!r){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",h();return}let ee="/api/repo-ops-script?workspace="+encodeURIComponent(J)+"&lane="+encodeURIComponent(O.lane)+"&base_sha="+encodeURIComponent(O.base_sha);try{let pe=await r(ee),de=await pe.json().catch(()=>({}));if(b!==c)return;if((t?t():"")!==J){P();return}if(!pe.ok||!de||de.ok!==!0){o="error",i=_h(de&&typeof de.error=="string"?de.error:""),h();return}s={lane:de.lane,base_sha:de.base_sha,path:de.path,base_ref:de.base_ref},a=String(de.content),o="ready",h()}catch{if(b!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",h()}}function P(){c+=1,V(),s=null,a="",h();let O=u;u=null,O?.isConnected&&O.focus()}function q(){P(),n.remove()}return{open:H,close:P,destroy:q}}function Ad(e){let t=e.queueStore,r=e.transport,n=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let b=o();return typeof b.revision=="number"?b.revision:0}function i(b){t&&b&&b.queue&&typeof b.queue=="object"&&t.set(b.queue)}function c(){let b=o().workspace_info;return b&&typeof b=="object"?b:{}}function u(b,j){return l`<span
      class="worker-repo-ops__vd-badge worker-repo-ops__vd-badge--${b}"
      >${j}</span
    >`}function d(b){if(typeof b!="number"||!Number.isFinite(b))return"";let j=b/6e4;return Number.isInteger(j)?`timeout ${j}\uBD84`:`timeout ${Math.round(b/1e3)}\uCD08`}function p(b){let j=d(b);return j?u("config",j):""}function _(b,j,J){return l`<button
      type="button"
      class="worker-repo-ops__vd-cmd worker-repo-ops__vd-cmd--link"
      .textContent=${J.script}
      @click=${ee=>{s&&s({lane:b,base_sha:j.base_sha,path:J.script,base_ref:j.base_ref},ee.currentTarget)}}
    ></button>`}function h(){let b=o().repo_ops_opt_out;return{verify:b?.verify===!0,deploy:b?.deploy===!0}}function T(b,j){return l`<label class="worker-repo-ops__lane-run">
      <input
        type="checkbox"
        .checked=${!j}
      ...
      />
      이 workspace에서 실행
    </label>`}function L(b){let j=typeof b.base_sha=="string"?b.base_sha:"",J=`${b.source_path||"repo-ops/config.toml"} @ ${b.base_ref||"?"}${j?`@${j.slice(0,7)}`:""}`,ee=h(),pe=!!b.verify&&ee.verify,de=!!b.deploy&&ee.deploy;return l`<section class="worker-repo-ops__vd" data-seam="repo-ops">
    ...
    </section>`}function B(b){let j=b.repo_ops&&typeof b.repo_ops=="object"?b.repo_ops:null;return j&&(j.status==="resolved"||j.status==="absent")?L(j):j&&(j.status==="pending"||j.status==="error")?l`<section class="worker-repo-ops__vd" data-seam="repo-ops">
        <p class="worker-repo-ops__vd-title">
          저장소 작업 선언
    ...
    </section>`}async function V(b){if(!r)return;let j=await r("worker-auto-repair-toggle",{on:b,expected_revision:a()});if(i(j),j&&j.conflict){let J=await r("worker-auto-repair-toggle",{on:b,expected_revision:a()});i(J)}n()}async function H(b,j){if(!r)return;let J=await r("worker-repo-ops-opt-out-toggle",{kind:b,opted_out:j,expected_revision:a()});if(i(J),J&&J.conflict){let ee=await r("worker-repo-ops-opt-out-toggle",{kind:b,opted_out:j,expected_revision:a()});i(ee)}n()}let P={owned_deploy_worktree_fetch_detached_alignment_recreate:"\uC804\uC6A9 \uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC \uC815\uB82C\xB7\uBCF5\uAD6C",recovered_pre_execution_fetch_timeout_retry_once:"fetch \uD0C0\uC784\uC544\uC6C3 1\uD68C \uBCF5\uAD6C",repo_serial_lock_wait:"\uC800\uC7A5\uC18C \uC21C\uCC28 \uC2E4\uD589 \uB300\uAE30",restart_operation_adoption:"\uC7AC\uC2DC\uC791 \uD6C4 \uC791\uC5C5 \uC778\uACC4",exact_input_exit_zero_evidence_adoption:"\uB3D9\uC77C \uC785\uB825 \uC131\uACF5 \uC99D\uAC70 \uC778\uACC4",descendant_success_covers_ancestor_rows:"\uCD5C\uC2E0 SHA \uC131\uACF5\uC774 \uC774\uC804 \uD589 \uCEE4\uBC84",owned_verify_candidate_cleanup:"\uAC80\uC99D \uC784\uC2DC \uCCB4\uD06C\uC544\uC6C3 \uC815\uB9AC",script_retry:"\uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4",auto_repair_session:"\uC790\uB3D9 \uD574\uACB0 \uC138\uC158",user_triggered_session:"\uC0AC\uC6A9\uC790 \uD574\uACB0 \uC138\uC158",automatic:"\uC790\uB3D9",user_action_only:"\uC0AC\uC6A9\uC790 \uD074\uB9AD",script_identity_present:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC788\uC744 \uB54C\uB9CC",per_completion_chain:"\uC644\uB8CC \uCCB4\uC778\uB2F9",unbounded:"\uD69F\uC218 \uC81C\uD55C \uC5C6\uC74C",bounded_single_script_retry_exceeded:"\uB2E8\uC77C \uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4 \uD55C\uB3C4 \uCD08\uACFC",baseline_failure_ignore:"\uAE30\uC874 \uC2E4\uD328 \uBB34\uC2DC",config_or_script_deletion_to_bypass_gate:"\uC124\uC815\xB7\uC2A4\uD06C\uB9BD\uD2B8 \uC0AD\uC81C\uB85C \uAC8C\uC774\uD2B8 \uC6B0\uD68C",credential_entry:"\uC790\uACA9\uC99D\uBA85 \uC785\uB825\xB7\uCD9C\uB825",destructive_action:"\uD30C\uAD34\uC801 \uC791\uC5C5",history_rewrite:"\uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131",agent_self_report_as_success:"\uC138\uC158 \uC790\uAE30\uBCF4\uACE0\uB97C \uC131\uACF5 \uCC98\uB9AC",unbounded_repair_session_retry:"\uBB34\uD55C \uD574\uACB0 \uC138\uC158 \uBC18\uBCF5"};function q(b,j,J){return l`<div class="worker-repo-ops__policy-group" data-policy=${J}>
      <div class="worker-repo-ops__policy-label">${b}</div>
      <ul class="worker-repo-ops__policy-list">
        ${j.map(ee=>l`<li data-token=${ee}>
              ${P[ee]||ee}
            </li>`)}
      </ul>
    ...
    >
      ...
      <ol class="worker-repo-ops__policy-list">
        ${b.map(j=>{let J=[P[j.trigger]||j.trigger];return Number.isInteger(j.attempts_per_operation_attempt)?J.push(`operation\uB2F9 ${j.attempts_per_operation_attempt}\uD68C`):Number.isInteger(j.attempts)?J.push(`${P[j.budget]||j.budget} ${j.attempts}\uD68C`):Number.isInteger(j.sessions_per_user_action)&&J.push(`${j.sessions_per_user_action}\uD68C`,P[j.user_actions]||j.user_actions),j.applies_when&&J.push(P[j.applies_when]||j.applies_when),l`<li data-token=${j.id}>
    ...
    >
      ...
      ${J?l`<details
          ...
          >
            ...
            ${q("Worker\uAC00 \uC790\uB3D9 \uCC98\uB9AC",J.worker_automatic||[],"worker-automatic")}
            ...
            ${q("\uC790\uB3D9\uC73C\uB85C \uD558\uC9C0 \uC54A\uC74C",J.never_automatic||[],"never-automatic")}
          </details>`:""}
  ...
  </p>`}function wh(e){if(e.state!=="failed"||e.superseded_by)return"";let t=e.repair||{},r=typeof t.remaining=="number"?t.remaining:0,n=e.failure_kind==="verify_script_failure"&&e.verify_stage==="pre_merge"?"verify_script_failure_pre_merge":e.failure_kind||"",s=r<=0;return l`<div class="worker-ev__acts">
    <button
      type="button"
  ...
  </div>`}function kh(e){let t=e.operation,r=t.state==="failed",n=t.failure?t.failure.code:"";return l`<li
    class="worker-ev"
  ...
  </li>`}function $h(e){let t=e.cleanup,r=on(t.step);return l`<li
    class="worker-ev"
  ...
  >
  ...
  </li>`}function xh(e){let t=typeof e.hidden=="number"?e.hidden:0,r=e.expanded===!0;return l`<section class="worker-repo-drawer" data-seam="repo-ops-timeline">
    ...
    ${e.events.length===0?l`<div class="worker-repo-drawer__empty">기록 없음</div>`:l`<ul class="worker-rail">
          ${e.events.map(n=>n.type==="cleanup"?$h(n):kh(n))}
        </ul>`}
  ...
  </section>`}function Ld(e,t={}){let r=null;function n(){if(r===null){Ge(l``,e);return}let a=yh(r.operations,r.cleanup_failures,{expanded:r.expanded});Ge(xh({events:a.visible,hidden:a.hidden,expanded:r.expanded,repo:r.repo}),e)}e.addEventListener("click",a=>{let i=a.target;if(i?.closest?.('[data-seam="repo-ops-close"]')){o();return}i?.closest?.('[data-seam="repo-ops-more"]')&&r&&(r.expanded=!r.expanded,n())});function s(a){r={operations:a.operations,cleanup_failures:a.cleanup_failures,repo:a.repo||"",expanded:!1},n()}function o(){r!==null&&(r=null,n(),t.onClose&&t.onClose())}return{open:s,close:o,isOpen:()=>r!==null,refresh(a){r&&(r={operations:a.operations,cleanup_failures:a.cleanup_failures,repo:a.repo||"",expanded:r.expanded},n())}}}var Ah=St("views:worker"),Sh="tab:worker:ready",Eh="tab:worker:blocked",Th="tab:worker:in-progress",Ch="tab:worker:resolved",Rh="tab:worker:closed",Lo=1,Od=5;function Md(e){return io(e).path.length>0}var Ih=new Set(["quick_fix","spec_backed","full_plan"]);function Pd(e){return typeof e=="string"&&Ih.has(e)}var Fd="beads-ui.worker.candidate-filter",ii={show_blocked:!1,spec:"all"};function Lh(){try{let e=window.localStorage.getItem(Fd);if(!e)return{...ii};let t=JSON.parse(e);if(!t||typeof t!="object")return{...ii};let r=t.spec;return{show_blocked:t.show_blocked===!0,spec:r==="with"||r==="without"?r:"all"}}catch{return{...ii}}}function Oh(e){try{window.localStorage.setItem(Fd,JSON.stringify(e))}catch{}}function Mh(e,t){let r=i=>t.show_blocked||!i.blocked,n=i=>t.spec==="all"||(t.spec==="with"?i.has_spec:!i.has_spec),s=[],o=0,a=0;for(let i of e){let c=r(i),u=n(i);c&&u?s.push(i):!c&&u?o+=1:c&&!u&&(a+=1)}return{visible:s,hidden_blocked:o,hidden_spec:a}}var Ph=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],jd="bdui.worker.candidate_sort",Dh=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],Oo="spec";function Nh(){try{let e=window.localStorage.getItem(jd);return e==="board"||e==="created"||e==="spec"?e:Oo}catch{return Oo}}function qh(e){try{window.localStorage.setItem(jd,e)}catch{}}var Bd="bdui.worker.done-range";function Fh(){try{let e=window.localStorage.getItem(Bd);return or(e)?e:er}catch{return er}}function jh(e){try{window.localStorage.setItem(Bd,e)}catch{}}var Bh="(max-width: 640px)",Ud="beads-ui.worker.lane-collapsed",ms={queue:!0,done:!0};function Uh(){try{let e=window.localStorage.getItem(Ud);if(!e)return{...ms};let t=JSON.parse(e);return!t||typeof t!="object"?{...ms}:{queue:typeof t.queue=="boolean"?t.queue:ms.queue,done:typeof t.done=="boolean"?t.done:ms.done}}catch{return{...ms}}}function Wh(e){try{window.localStorage.setItem(Ud,JSON.stringify(e))}catch{}}function Dd(e){let t=Array.isArray(e)&&e.length>0?e[0]:null;if(!t)return"";let r=typeof t.title=="string"?t.title:t.id||"";return r.length>22?`${r.slice(0,22)}\u2026`:r}function zh(e,t,r){let n=Array.isArray(e)?e.slice():[];return t==="created"?n.sort(Zr):(n.sort(Ms(r)),t==="board"?n:[...n.filter(Md),...n.filter(s=>!Md(s))])}function Hh(e){let t=e&&e.parent;return(typeof t=="string"?t.length>0:!!(t&&t.id))||/\.\d+$/.test(e&&e.id||"")}function Gh(e){let t=e?.blocked_info;if(t&&typeof t=="object"){let s=Array.isArray(t.blockers)?t.blockers.filter(o=>typeof o=="string"&&o.length>0):[];return s.length>0?`\u{1F512} ${s.join(", ")}`:"\u{1F512} blocked"}let n=(Array.isArray(e?.dependencies)?e.dependencies:[]).map(s=>{if(typeof s=="string")return s;if(!s||typeof s!="object")return"";let o=s.type??s.dependency_type;return o!==void 0&&o!=="blocks"?"":s.depends_on_id||s.id||""}).filter(Boolean);return n.length>0?`\u{1F512} ${n.join(", ")}`:"\u{1F512} blocked"}function Nd(e){switch(e){case"not_in_pr_wait":return"PR \uB300\uAE30 \uC0C1\uD0DC \uB3D9\uAE30\uD654 \uC2E4\uD328";case"resolution_round_cap":return"\uCDA9\uB3CC \uD574\uC18C 2\uD68C \uCD08\uACFC";case"resolution_timeout":return"\uCDA9\uB3CC \uD574\uC18C \uB300\uAE30 \uC2DC\uAC04 \uCD08\uACFC";case"resolution_refused":return"\uD574\uC18C \uC138\uC158 \uB514\uC2A4\uD328\uCE58 \uAC70\uBD80";case"worktree_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uD574\uC18C \uD544\uC694";case"merge_unconfirmed_timeout":return"\uBA38\uC9C0 \uD655\uC778 \uC2DC\uAC04 \uCD08\uACFC";case"pr_closed_unmerged":return"PR \uB2EB\uD798";case"merge_error":return"\uBA38\uC9C0 \uC624\uB958";case"spec_id_missing":return"\uC2A4\uD399 ID \uAE30\uB85D \uC5C6\uC74C";default:return e}}function Vh(e){if(e==="lane_occupied")return"\uC2E4\uD589 \uB808\uC778\uC5D0 \uB0A8\uC544 \uC788\uC5B4 \uBA38\uC9C0 \uB300\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4";let t="\uBA38\uC9C0 \uD050\uC5D0 \uB123\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (\uC774\uBBF8 \uB300\uAE30 \uC911\uC774\uAC70\uB098 \uB300\uC0C1 \uC544\uB2D8)";return typeof e=="string"&&e.length>0?`${t}: ${e}`:t}function Kh(e,t=null){if(e==="worker_sessions_busy")return"\uD574\uC18C \uB300\uAE30 \u2014 \uC2E4\uD589 \uC2AC\uB86F \uB300\uAE30 \uC911";if(typeof e!="string"||!e.startsWith("completion_waiting:"))return null;let r=e.slice(19);if(r.length===0)return null;switch(r){case"gating":{let n=t?.repair_sessions_used;return typeof n=="number"&&n>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911"}case"repairing":return"\uC790\uB3D9 \uC218\uC815 \uC911";case"waiting_repair_pr":return"\uC218\uC815 PR \uB300\uAE30 \uC911";case"merging":return"\uBA38\uC9C0 \uC911";case"cleaning":return"\uB9C8\uBB34\uB9AC \uC911";case"paused":return"\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";case"needs_human":return"\uD655\uC778 \uD544\uC694";default:return null}}function Yh(e){if(!e||typeof e!="object")return null;switch(e.state){case"waiting":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC911",live:!0};case"yielded":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uACC4\uC18D \uC911 \xB7 \uC644\uB8CC \uD6C4 \uC6B0\uC120 \uBA38\uC9C0",live:!0};case"ready":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC644\uB8CC \xB7 \uC7AC\uAC80\uC99D \uB300\uAE30",live:!1};default:return null}}function Zh(e){if(!e||typeof e!="object")return null;switch(e.state){case"pending":return{badge:"implementation review \uB300\uAE30",live:!1,alert:!1};case"reviewing":return{badge:"implementation review \uC911",live:!0,alert:!1};case"revising":return{badge:"review \uC218\uC815 \uC911 \xB7 1\uD68C",live:!0,alert:!1};case"failed":{let r=(typeof e.failure_reason=="string"?e.failure_reason:"").replace(/[\u0000-\u001f\u007f]/g," ").slice(0,120);return{badge:r.trim().length>0?`review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328: ${r.trim()}`:"review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328",live:!1,alert:!0}}default:return null}}function li(e,t){return typeof e!="string"||e.length===0||typeof t!="string"||t.length===0||t===e?null:`\u2192 ${t}`}function Qh(e){if(!e||typeof e!="object")return null;let t=Number.isInteger(e.repair_sessions_used)?Math.max(0,e.repair_sessions_used):0,r=Number.isInteger(e.repair_session_cap)?Math.max(0,e.repair_session_cap):0,n=e.current_repair&&typeof e.current_repair=="object"?e.current_repair:null,s=n&&typeof n.pr_number=="number"?n.pr_number:null,o="";switch(e.phase){case"gating":o=t>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911";break;case"repairing":o="\uC790\uB3D9 \uC218\uC815 \uC911";break;case"waiting_repair_pr":o=s?`\uC218\uC815 PR #${s} \uB300\uAE30 \uC911`:"\uC218\uC815 PR \uB300\uAE30 \uC911";break;case"merging":o=e.subject_role==="repair"?s?`\uC218\uC815 PR #${s} \uBA38\uC9C0 \uC911`:"\uC218\uC815 PR \uBA38\uC9C0 \uC911":"\uBA38\uC9C0 \uC911";break;case"cleaning":o="\uB9C8\uBB34\uB9AC \uC911";break;case"paused":o="\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";break;case"needs_human":o="\uD655\uC778 \uD544\uC694";break;case"completed":return null;default:return null}let a=[o,`\uC790\uB3D9 \uC218\uC815 \uD69F\uC218 ${t}/${r}`];return e.head_sha&&a.push(`head ${e.head_sha}`),e.base_sha&&a.push(`base ${e.base_sha}`),(e.failure_stage||e.failure_reason)&&a.push(`${e.failure_stage||"failure"} \xB7 ${e.failure_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`),e.active_attempt_id&&a.push(`attempt ${e.active_attempt_id}`),n&&typeof n.bead_id=="string"&&a.push(`repair ${n.bead_id}`),e.evidence&&a.push(e.evidence),e.log_path&&a.push(e.log_path),{badge:o,title:a.join(`
`),alert:e.phase==="needs_human",lock_actions:e.phase!=="paused"&&e.phase!=="needs_human",repair_pr_url:n&&typeof n.pr_url=="string"?n.pr_url:"",repair_pr_number:s}}function qd(e){if(!e||typeof e!="object")return[];let t=e.blocking_codes;return Array.isArray(t)?t.filter(r=>typeof r=="string"&&r.length>0):[]}function Xh(e){let t=e.queue_failure?`\uBA38\uC9C0 \uC2E4\uD328 \uC6D0\uBB38: ${e.queue_failure}`:e.auto_skip?`\uC790\uB3D9 \uC81C\uC678 \uC6D0\uBB38: ${e.auto_skip}`:"",r=(n,s={})=>{let o=[s.title||"",t].filter(Boolean);return{label:n,title:o.join(`
`),live:s.live===!0,alert:s.alert===!0}};return e.continuation_required?r("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694",{alert:!0}):e.merge_step?e.gate?.tier==="merged"?r("\uBA38\uC9C0\uB428",{title:e.merge_step.label,alert:e.merge_step.failed===!0}):r("\uBA38\uC9C0 \uC911",{title:e.merge_step.label,live:!0}):e.conflict_badge?r(e.conflict_badge,{live:e.conflict_live===!0}):e.head_review&&e.head_review.state!=="failed"?r("\uB9AC\uBDF0 \uC9C4\uD589 \uC911",{title:e.head_review.badge,live:e.head_review.live===!0}):e.recovery?.lock_actions?r(e.recovery.badge,{title:e.recovery.title,live:!0}):e.cleanup_failed?r(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0}):e.base_exception?r("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0}):e.conflicting?r("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0}):e.gate?.reason==="base_behind"?r("base \uAC31\uC2E0 \uD544\uC694",{alert:!0}):e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale"?r("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2C8\uAC70\uB098 \uC870\uC0C1 \uD655\uC778\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0}):e.gate?.reason==="spec_id_missing"?r("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0}):e.gate?.reason==="review_receipt_invalid"?r("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0}):qd(e.receipt_check).length>0?r("\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694",{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${qd(e.receipt_check).join(", ")}`,alert:!0}):e.head_review?.state==="failed"?r("\uB9AC\uBDF0 \uC2E4\uD328",{title:e.head_review.failure_reason||"",alert:!0}):e.recovery?r(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?r("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?r(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Nd(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?r(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Nd(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?r(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?r("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?r("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?r("\uB2EB\uD798",{alert:!0}):e.activity?r("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?r("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?r("\uD655\uC778 \uC911"):e.gate?.gate_badge?r(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function Jh(e,t,r,n,s=null,o=null,a=null,i=!1,c=null,u=!0,d=null,p=null,_=null,h={},T=!1,L=!1,B={}){let V=!!c&&c.position>0,H=!!c?.continuation_action&&c.continuation_action.continuation===null,P=!!c&&c.active===!0,q=c&&c.failure||null,O=Kh(c?c.waiting:null,_),U=r[e]||null,b=U&&U.gate?U.gate:null,j=U&&U.pr?U.pr:null,J=Qh(_),ee=Yh(c?c.resolution:null),pe=Zh(c?c.head_review:null),de=c&&c.head_review||null,he=c&&c.authority||null,Se=!!de&&["pending","reviewing","revising"].includes(de.state),Le=V&&!P&&(de?.state==="failed"||!he||he.source==="automatic"&&!L),te=a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":ee?ee.badge:a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":O,se=!!b&&b.base_badge==="\uCDA9\uB3CC",Ae=!!b&&b.enabled===!0,N=fs({bead_id:e,merge_sha:B.merge_sha,cleanup_cursor:B.cleanup_cursor,merge_progress:o&&o.merge_progress?o.merge_progress:null,cleanup_failed:n,repo_operations:B.repo_operations}),oe=Io(N),re=!!n&&["child_sweep","branch_cleanup","parent_close"].includes(n.step)&&!!b&&b.tier==="merged",ye=i&&!!n&&!!b&&b.tier==="merged",Ee=Le&&(Ae||se||b?.reason==="base_behind"||b?.reason==="review_receipt_missing"||b?.reason==="review_receipt_stale"||re||ye),C=i&&se&&u===!1,K=yr(h,e,{external:i,merge_active:P||N?.step==="merge",merge_queued:V,conflict_active:!!a,cleanup_active:oe,merged:!!n||b?.tier==="merged"}),$e=!!K.operation,Ne=!re&&!!n&&n.step==="repo_operations",Oe=Xh({continuation_required:H,merge_step:N,conflict_badge:te,conflict_live:ee?.live===!0||a==="running",head_review:de&&pe?{...pe,state:de.state,failure_reason:de.failure_reason}:null,recovery:J,cleanup_failed:n,cleanup_label:n?on(n.step):null,base_exception:p,conflicting:se,gate:b,receipt_check:U&&U.receipt_check?U.receipt_check:null,queue_failure:q,auto_skip:d,queued:V,queue_active:P,queue_position:c?c.position:0,activity:te?null:o&&o.activity||null}),ze=Oe?.live===!0&&Oe.title?l`<span title=${Oe.title}>${Oe.label}</span>`:Oe?.label||null;return{id:e,title:i?l`${t}<span class="muted"> · 세션</span>`:t,reason:n&&N?.active!==!0?Ro(n.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:T,external:i,pr_number:j&&typeof j.number=="number"?j.number:null,pr_url:j&&typeof j.url=="string"?j.url:"",completion_badge:Oe?.live!==!0&&Oe?.title?Oe.label:null,completion_title:Oe?.title||"",completion_repair_pr_url:J?J.repair_pr_url:"",completion_repair_pr_number:J?J.repair_pr_number:null,badges:ze?[ze]:[],live_badge:Oe?.live===!0?ze:null,usage:s,alert:Oe?.alert===!0,merge_action:b?.tier==="merged"&&!re&&!ye||Ne?!1:!V||H||Le,timeline_action:Ne,cancel_action:V&&!H,cancel_enabled:(!P||Se)&&!(J&&J.lock_actions),cancel_title:J&&J.lock_actions?`${J.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:P&&!Se?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":Se?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:K,discard_action:K.action,merge_step:N,discard_enabled:K.enabled,discard_title:K.title,merge_enabled:!N&&!a&&!$e&&!p&&!(J&&J.lock_actions)&&!C&&!Ne&&(Ae||se||b?.reason==="base_behind"||b?.reason==="review_receipt_missing"||b?.reason==="review_receipt_stale"||re||ye||Ee),merge_label:H?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":re||ye?"\uC815\uB9AC \uC7AC\uAC1C":se&&!N&&!re?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":b?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":b?.reason==="review_receipt_missing"||b?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":Le?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:$e?K.error?`\uD3D0\uAE30 \uC2E4\uD328: ${K.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${K.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:H?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":N?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${N.label}`:ye?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":C?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":re?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":se?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":b?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":b?.reason==="review_receipt_missing"||b?.reason==="review_receipt_stale"?"\uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":b?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":Ae?`\uBA38\uC9C0 (${b.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:b&&b.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${b&&b.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function ci(e,t={}){let{transport:r,issueStores:n,queueStore:s,analysisStore:o,sessionLogStore:a,uiOrderStore:i,gotoIssue:c,getWorkspacePath:u,doneRange:d,onDoneRangeChange:p}=t,_=n?Ds(n,i):null,h=js({transport:r,uiOrderStore:i}),T=null,L=[],B=Lh(),V=null,H=Nh(),P=or(d)?d:Fh(),q=new Map;function O(){let f=Rr.find($=>$.value===P);return f?f.label:"\uC624\uB298"}let U=Uh(),b=!1,j=new Set,J=new Set,ee=new Set,pe=new Set,de=new Set,he={},Se=null,Le=0,te=null,se=[];function Ae(f){return Se===f?he:{}}async function N(){if(!r)return;let f=u?.()||"";if(Se===f||te&&te.key===f&&te.generation===Le)return;let $=++Le;te={key:f,generation:$};let G=null;try{G=await Promise.resolve(r("get-session-defaults",{}))}catch(m){if($!==Le)return;te=null,Ah("get-session-defaults failed: %o",m),Fe();return}$===Le&&(he=G&&typeof G.values=="object"&&G.values!==null?{...G.values}:{},Se=f,te=null,Fe())}function oe(){Se=null,Le+=1,N()}let re=document.createElement("div");re.className="worker-console";let ye=document.createElement("div");ye.className="worker-top";let Ee=document.createElement("div");Ee.className="worker-drawer-overlay",Ee.hidden=!0;let C=document.createElement("div");C.className="worker-drawer-overlay__backdrop";let K=document.createElement("div");K.className="worker-drawer-host";let $e=document.createElement("div");$e.className="worker-drawer-host",$e.hidden=!0,Ee.append(C,K,$e);let Ne=document.createElement("div");Ne.className="worker-lanes-host",re.append(ye,Ee,Ne),e.appendChild(re);let Oe=null,ze=null,Ye=Tn(K,{transport:r,sessionLogStore:a,onClose:()=>{Oe=null,ze=null,Ee.hidden=!0,Fe()}}),Y=Ld($e,{onClose:()=>{$e.hidden=!0,Ee.hidden=!0,Fe()}}),Q=xd({getWorkspacePath:u||(()=>"")}),Te=u&&u()||"",Ze=Ad({queueStore:s,transport:r,onChanged:()=>Fe(),onOpenScript:(f,$)=>{Q.open(f,$)}}),Ve=o?vd(re,{queueStore:s,analysisStore:o,transport:r,getWorkspacePath:u,onOpenTranscript:(f,$)=>Mt(f,$)}):null;function st(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Lo,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function Je(){let f=st(),$=typeof f.serial_lane_count=="number"&&Number.isInteger(f.serial_lane_count)&&f.serial_lane_count>0?Math.min(f.serial_lane_count,5):0,G=Array.isArray(f.serial_lanes)?f.serial_lanes:[],m=[];for(let ce of G){if(m.length>=$)break;!ce||typeof ce.id!="string"||!/^s[1-5]$/.test(ce.id)||!Array.isArray(ce.entries)||m.push({id:ce.id,label:`\uC9C1\uB82C ${ce.id.slice(1)}`,count:ce.entries.length})}return m.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(f.queue)?f.queue:[]).length},...m]}function mt(f){if(!V||!f.some(G=>G.id===V))return null;let $=Je();return $?{bead_id:V,lanes:$}:null}function Pe(){let f=st();return typeof f.revision=="number"?f.revision:0}function I(f){f&&f.queue&&s&&s.set(f.queue)}function ne(){let f=st().queue;return Array.isArray(f)?f.length:0}async function me(f,$,G){if(!r)return;let m=()=>({bead_id:f,...$==="parallel"?{}:{lane:$},...G===void 0?{}:{index:G},expected_revision:Pe()}),y=await r("worker-queue-place",m());I(y),y&&y.conflict&&await r("worker-queue-place",m()).then(I)}async function ae(f,$,G){if(!r)return;let m=()=>({bead_id:f,...$==="parallel"?{}:{lane:$},to_index:G,expected_revision:Pe()}),y=await r("worker-queue-reorder",m());I(y),y&&y.conflict&&await r("worker-queue-reorder",m()).then(I)}async function qe(f){if(!r)return;let $=await r("worker-queue-remove",{bead_id:f,expected_revision:Pe()});I($),$&&$.conflict&&await r("worker-queue-remove",{bead_id:f,expected_revision:Pe()}).then(I)}async function Qe(f){if(!r||!f)return;let $=await r("worker-attempt-pause",{attempt_id:f});$&&$.paused===!1&&$.reason&&fe(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${$.reason}`,"error",2400)}async function ot(f){if(!r||!f)return;let $=await xn();if($===null)return;let G=async(y={})=>await r("worker-attempt-resume",{attempt_id:f,expected_revision:Pe(),...$!==""?{instructions:$}:{},...y}),m=await G();I(m),m&&m.conflict&&(m=await G(),I(m)),m=await wr(m,(y,ce)=>G({continuation:y,decision_token:ce}),{onResult:I,refresh:()=>G()}),m&&m.resumed===!1&&!m.conflict&&m.reason&&fe(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${m.reason}`,"error",2400)}async function Xe(f){if(!r||!f)return;let $=await r("worker-attempt-dismiss",{attempt_id:f,expected_revision:Pe()});I($),$&&$.conflict&&($=await r("worker-attempt-dismiss",{attempt_id:f,expected_revision:Pe()}),I($)),$&&$.dismissed===!1&&!$.conflict&&$.reason&&fe(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${$.reason}`,"error",2400)}async function dt(f,$,G=!0){if(!r)return null;let m=r,y=await m(f,{...$,expected_revision:Pe()});return I(y),y&&y.conflict&&G&&(y=await m(f,{...$,expected_revision:Pe()}),I(y)),y}async function yt(f){if(!r||!f)return;let $=st().merge_queue?.find(m=>m.bead_id===f)?.continuation_action;if($?.mismatch&&$.continuation===null){await pt(f,$.mismatch);return}j.add(f),Fe();let G;try{G=await dt("worker-merge-queue-add",{bead_id:f})}finally{j.delete(f),Fe()}if(!(!G||G.applied)){if(G.conflict){fe("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}fe(Vh(G.reason),"error",2400)}}async function gt(f){if(!(!r||!f||J.has(f))){J.add(f),Fe();try{let $=await r("worker-cleanup-retry",{bead_id:f,expected_revision:Pe()});I($),$&&!$.retried&&!$.conflict&&$.reason&&fe(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${$.reason}`,"error",2400)}finally{J.delete(f),Fe()}}}async function pt(f,$){let G=await wr({continuation_mismatch:$},(y,ce)=>dt("worker-merge-queue-add",{bead_id:f,continuation:y,decision_token:ce},!1)),m=G?.queue?.merge_queue?.find(y=>y.bead_id===f)?.continuation_action;if(G?.applied!==!0&&m?.continuation===null&&m.mismatch){await pt(f,m.mismatch);return}G&&G.applied===!1&&!G.conflict&&fe("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function kt(f){if(!r)return;let $=await dt("worker-merge-auto-toggle",{on:f});!$||$.conflict||fe(f?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",f?"success":"info",2400)}async function We(f){if(!r||!f)return;let $=await dt("worker-merge-queue-remove",{bead_id:f});$&&!$.conflict&&!$.applied&&$.reason==="merge_active"&&fe("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function Ke(){await dt("worker-merge-queue-remove",{all:!0})}async function Ue(f,$=null,G="unmerged",m=null){if(!r||!f)return;let y=cs(f,G);if(!(!!m||typeof globalThis.confirm!="function"||globalThis.confirm(y)))return;let le=await r("worker-discard",{bead_id:f,...$?{attempt_id:$}:{},...m?{operation_id:m}:{},expected_revision:Pe()});if(I(le),le&&le.conflict&&(le=await r("worker-discard",{bead_id:f,...$?{attempt_id:$}:{},...m?{operation_id:m}:{},expected_revision:Pe()}),I(le)),le&&le.discarded===!0){fe(wo(le),"success",5e3);return}if(le&&le.reason){fe(`\uD3D0\uAE30 \uC2E4\uD328: ${le.reason}`,"error",2800);return}if(le&&le.accepted&&le.pending==="merged_revert"){fe("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(le&&le.accepted&&!le.discarded){fe(`\uD3D0\uAE30 \uC9C4\uD589: ${le.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}le&&!le.conflict&&fe("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function ct(f,$,G){if(!(!r||!$||!G||pe.has($))){pe.add($),Fe();try{let m=await r(f,{bead_id:$,action_id:G,expected_revision:Pe()});I(m),m?.conflict?fe("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!m?.ok&&m?.reason&&fe(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(m.reason)}`,"error",2800)}finally{pe.delete($),Fe()}}}async function At(f,$){if(!r||!$||ee.has($))return;ee.add($),Fe();let G;try{let m=async(y={})=>await r(f,{bead_id:$,expected_revision:Pe(),...y});G=await m(),I(G),G&&G.conflict&&(G=await r(f,{bead_id:$,expected_revision:Pe()}),I(G)),f==="worker-revise-fix"&&(G=await wr(G,(y,ce)=>m({continuation:y,decision_token:ce}),{onResult:I,refresh:()=>m()}))}finally{ee.delete($),Fe()}if(!(!G||G.conflict)){if(G.ok){fe(f==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}fe(`\uCC98\uBD84 \uAC70\uBD80: ${G.reason||""}`,"error",3e3)}}async function A(f){if(!r)return;let $=await r("worker-automation-toggle",{on:f,expected_revision:Pe()});I($),$&&$.conflict&&await r("worker-automation-toggle",{on:f,expected_revision:Pe()}).then(I)}async function M(f){if(!r||!f)return;let $=await r("worker-repo-operation-repair",{operation_id:f});if(I($),$&&$.ok===!1){fe(`\uD574\uACB0 \uC138\uC158 \uAC70\uBD80: ${$.reason||""}`,"error",3e3);return}$&&$.ok===!0&&fe("\uD574\uACB0 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4","success",2400)}async function ue(f){if(!r||!f)return;let $=await r("worker-repo-operation-dismiss",{operation_id:f});I($),$&&$.ok===!1&&fe(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${$.reason||""}`,"error",3e3)}async function k(f){if(!r||!Number.isFinite(f))return;let $=Math.max(Lo,Math.floor(f)),G=await r("worker-queue-set-slots",{slots:$,expected_revision:Pe()});I(G),G&&G.conflict&&await r("worker-queue-set-slots",{slots:$,expected_revision:Pe()}).then(I)}async function S(f){if(!r||!Number.isInteger(f)||f<1||f>Od)return;let $=st(),G=(Array.isArray($.serial_lanes)?$.serial_lanes:[]).slice(f).reduce((ce,le)=>ce+(Array.isArray(le?.entries)?le.entries.length:0),0),m=()=>({count:f,expected_revision:Pe()}),y=await r("worker-queue-set-serial-lane-count",m());I(y),y&&y.conflict&&(y=await r("worker-queue-set-serial-lane-count",m()),I(y)),y&&y.applied&&G>0&&fe(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${G}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}function F(){let f=st(),$=_?_.selectBoardColumn(Sh,"ready"):[],G=_?_.selectBoardColumn(Eh,"blocked"):[],m=_?_.selectBoardColumn(Rh,"closed"):[],y=_?_.selectBoardColumn(Th,"in_progress"):[],ce=_?_.selectBoardColumn(Ch,"resolved"):[],le=qs([...$,...G,...y,...ce,...m]),je=new Map;for(let g of[...$,...G,...y])g&&g.id&&!je.has(g.id)&&je.set(g.id,g);let xe={...Ae(u?.()||"")};for(let g of["orchestration_model","orchestration_effort","orchestration_speed"]){let z=f[g];typeof z=="string"&&(xe[g]=z)}function x(g,z){let _e=je.get(g);if(!_e)return null;let He=_e.metadata&&typeof _e.metadata=="object"?_e.metadata:{},_t=_e.workflow?.route,jt=He.route,Nt=Pd(_t)?_t:Pd(jt)?jt:null;return Qt({pin:He,global:xe,execution_defaults:f.execution_defaults??null,runner_catalog:f.runner_catalog??null,route:Nt,controller_runtime:z})}function Z(g){let z=g.runner||null,_e=x(g.bead_id,z),He=Ao(g),_t=_e?qr(_e,z):null;return He||_t?{orchestration:He,worker:_t}:null}let D=new Map;function Ie(g){if(D.has(g))return D.get(g)??null;let z=x(g,null),_e=null;if(z){let He=gr(f.runner_catalog??null,z.orchestration_model.value??""),_t=He===null?z:x(g,He),jt=sn(_t,f.runner_catalog??null),Nt=qr(_t,He);_e=jt||Nt?{orchestration:jt,worker:Nt}:null}return D.set(g,_e),_e}function ut(g){let z=Fs(le,g);return z.total===0?null:z}let it=f.bead_titles||{},rt=new Map;for(let[g,z]of Object.entries(it))typeof z=="string"&&z.length>0&&rt.set(g,z);for(let g of[...$,...G])rt.set(g.id,g.title||g.id);let nt=f.bead_times&&typeof f.bead_times=="object"&&!Array.isArray(f.bead_times)?f.bead_times:{},Lt=f.bead_labels&&typeof f.bead_labels=="object"&&!Array.isArray(f.bead_labels)?f.bead_labels:{},Jt=new Map;for(let[g,z]of Object.entries(Lt))Array.isArray(z)&&Jt.set(g,si(z));for(let g of[...$,...G]){let z=g.labels;Array.isArray(z)&&!Jt.has(g.id)&&Jt.set(g.id,si(z))}let an=new Map,ln=o?.get()?.last_good?.result?.groups;for(let g of Array.isArray(ln)?ln:[]){if(g?.eligible!==!0||!Array.isArray(g.members))continue;let z=g.members.map(He=>{let _t=(Array.isArray(f.serial_lanes)?f.serial_lanes:[]).find(jt=>jt.entries.some(Nt=>Nt.bead_id===He));return _t?_t.id:null});if(!(z.every(He=>He!==null)&&new Set(z).size===1))for(let He of g.members)an.set(He,g.members.filter(_t=>_t!==He))}let gs=f.bead_blocked_by&&typeof f.bead_blocked_by=="object"&&!Array.isArray(f.bead_blocked_by)?f.bead_blocked_by:{},cn=new Map;for(let[g,z]of Object.entries(nt))z&&typeof z=="object"&&cn.set(g,z);for(let g of[...$,...G])cn.set(g.id,{created_at:g.created_at,updated_at:g.updated_at});let Br=g=>cn.get(g)||{},Ur=f.pr_wait||[],un=f.pr_observations||{},hs=f.pr_activity||{},Be=f.cleanup_failed||{},Tt=Object.entries(Be).map(([g,z])=>({bead_id:g,step:z&&z.step?z.step:"",reason:z&&z.reason?z.reason:"",at:z&&typeof z.at=="number"?z.at:null,detail:z&&typeof z.detail=="string"?z.detail:null,output_tail:z&&typeof z.output_tail=="string"&&z.output_tail?z.output_tail:void 0,log_path:z&&typeof z.log_path=="string"&&z.log_path?z.log_path:void 0,retry_count:z&&typeof z.retry_count=="number"&&Number.isInteger(z.retry_count)&&z.retry_count>0?z.retry_count:0,failure_code:z&&typeof z.failure_code=="string"?z.failure_code:void 0,subject_id:z&&typeof z.subject_id=="string"?z.subject_id:void 0,repair_eligible:!!(z&&z.repair_eligible),repair:z&&z.repair?z.repair:void 0})),dn=f.queue||[],tp=new Set([...dn.map(g=>g.bead_id),...(Array.isArray(f.serial_lanes)?f.serial_lanes:[]).flatMap(g=>(Array.isArray(g?.entries)?g.entries:[]).map(z=>z.bead_id)),...Ur.map(g=>g.bead_id),...f.done.map(g=>g.bead_id)]),rp=new Set(G.map(g=>g.id)),np=i?i.get()?.order||{}:{},fi=new Set,_i=[];for(let g of[...$,...G])tp.has(g.id)||fi.has(g.id)||Hh(g)||(fi.add(g.id),_i.push(g));L=zh(_i,H,np);let sp=f.admission||{},mi=g=>{let z=sp[g];if(!z)return"";if(z.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let _e=typeof z.reason=="string"?z.reason:"",He=_e.indexOf(":");return He>0&&He<_e.length-1?`\u26D4 ${_e.slice(0,He)} (${_e.slice(He+1)})`:`\u26D4 ${_e}`},op=L.map(g=>{let z=io(g),_e=z.path.length>0,He=g.workflow?.route==="quick_fix"||g.metadata&&g.metadata.route==="quick_fix",_t=!Object.hasOwn(g,"description")||typeof g.description=="string"&&g.description.trim().length>0,jt=Object.hasOwn(g,"labels")&&yd(g.labels),Nt=!jt&&(He?_t:_e&&!z.conflict),$t=rp.has(g.id),dr=[];$t&&dr.push(Gh(g)),He&&!_t?dr.push("missing_description"):!He&&z.conflict?dr.push("spec_id_conflict"):!He&&!_e&&dr.push("spec \uC5C6\uC74C");let As=mi(g.id);return As&&dr.push(As),{id:g.id,title:g.title||g.id,reason:dr.join(" \xB7 "),draggable:Nt,lane:"candidate",created_at:g.created_at,updated_at:g.updated_at,workflow:g.workflow,is_quick_fix:He,status:g.status,worker_ineligible:jt,blocked:$t,has_spec:_e,exec_chips:Ie(g.id)}}),Mo=Mh(op,B),ap=Mo.visible,ip=f.revise_parked||{},bs=f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},Po=(g,z)=>g.map((_e,He)=>{let _t=z!=="done",jt=z!=="done"&&z!=="queue",Nt=_t?ip[_e.bead_id]:null,$t=_t?yr(bs,_e.bead_id):null,dr=$t?.operation?$t:null,As=_t&&Jt.get(_e.bead_id)===!0,Fi=gs[_e.bead_id]||[],jo=f.admission&&typeof f.admission=="object"?f.admission[_e.bead_id]:null,Bo=_t?du(jo,!!dr||pe.has(_e.bead_id)):null,vp=_t&&!Bo?mi(_e.bead_id):null,wp=_t?[vp]:[],ji=_t&&Fi.length>0&&typeof jo?.reason=="string"&&jo.reason.startsWith("not_ready")?[`\u23F8 ${Fi.join(", ")} \uC644\uB8CC \uB300\uAE30 (blocks)`]:[],Uo=_t?an.get(_e.bead_id):void 0;return Uo&&Uo.length>0&&ji.push(`\u2733 serial \uAD8C\uC7A5 \xB7 ${Uo.join(", ")}\uC640`),{id:_e.bead_id,title:rt.get(_e.bead_id)||_e.bead_id,reason:wp.filter(Boolean).join(" \xB7 "),draggable:_t&&!dr&&!Bo,done:z==="done",lane:z,seq:jt?He+1:void 0,worker_serial:As,discard:dr,stale_work:Bo,badges:[...ji,...Nt?["\u23F8 REVISE \uD30C\uD0B9"]:[]],alert:!!Nt,revise_action:!!Nt,revise_enabled:!!Nt&&!dr&&!ee.has(_e.bead_id),revise_title:Nt?Nt.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${Nt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:z==="done"?ir(f.attempts||{},_e.bead_id):null,work_ms:z==="done"?yo(f.attempts||{},_e.bead_id):null,done_at:z==="done"&&typeof _e.added_at=="number"?_e.added_at:void 0,exec_chips:_t?Ie(_e.bead_id):null,...Br(_e.bead_id)}}),pn=f.attempts?Object.values(f.attempts):[],Do=new Set;for(let g of pn)g&&typeof g.resumed_from=="string"&&g.resumed_from.length>0&&Do.add(g.resumed_from);let gi=new Map;for(let g of pn)gi.set(g.bead_id,g.attempt_id);let ys=new Map;for(let g of pn)ys.set(g.attempt_id,g);function No(g){let z=new Set,_e=g;for(;_e&&!z.has(_e.attempt_id);){if(_e.conflict_resolution===!0)return!0;z.add(_e.attempt_id),_e=typeof _e.resumed_from=="string"&&_e.resumed_from.length>0&&ys.get(_e.resumed_from)||null}return!1}let vs=typeof f.declared_base=="string"?f.declared_base:null;function lp(g){let z=null;for(let _e of pn)!_e||_e.bead_id!==g||No(_e)||(z===null||(typeof _e.started_at=="number"?_e.started_at:0)>=(typeof z.started_at=="number"?z.started_at:0))&&(z=_e);return z&&typeof z.target_base=="string"?z.target_base:null}let hi=[],bi=[],cp=bd(f),yi=g=>{let z=typeof g.session_id=="string"&&g.session_id.length>0,_e=Do.has(g.attempt_id);return{eligible:z&&!_e,reason:z?_e?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},ur=null;for(let g of pn){let z=g.status==="paused"&&!Do.has(g.attempt_id);if(g.status==="running"||z)bi.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:rt.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,paused:z,conflict_resolution:No(g),base_exception:li(vs,g.target_base),can_pause:typeof g.session_id=="string"&&g.session_id.length>0,discard:yr(bs,g.bead_id,{attempt_id:g.attempt_id}),usage:ir(f.attempts||{},g.bead_id),rollup:ut(g.bead_id),rollup_expanded:de.has(g.bead_id),exec_chips:Z(g),...Br(g.bead_id)});else if((g.status==="failed"||g.status==="orphaned")&&cp(g)){let _e=yi(g);hi.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:rt.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,failed:!0,status:g.status,status_label:g.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:yr(bs,g.bead_id,{attempt_id:g.attempt_id}),resume_eligible:_e.eligible,resume_reason:_e.reason,conflict_resolution:No(g),base_exception:li(vs,g.target_base),usage:ir(f.attempts||{},g.bead_id),rollup:ut(g.bead_id),rollup_expanded:de.has(g.bead_id),exec_chips:Z(g),...Br(g.bead_id)}),ur=g}}let ws=[...hi,...bi].map(g=>{let z=ys.get(g.attempt_id),_e=z?.quickfix_landing;if(z?.quickfix_lane!==!0||!_e||typeof _e!="object")return g;let He=typeof _e.reason=="string"&&_e.reason.length>0?_e.reason:null,_t=fs({bead_id:z.bead_id,merge_sha:_e.head_sha,cleanup_cursor:_e.cursor,cleanup_failed:He?{step:_e.cursor,reason:He}:null,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]});return _t?{...g,landing:_t}:g}),vi=null;if(ur){let g=yi(ur),z=ur.cause_detail;vi={bead_id:ur.bead_id,repo:ur.repo||"",reason:ur.cause||ur.status,cause_detail:z&&typeof z.reason=="string"?{reason:z.reason,command:typeof z.command=="string"?z.command:null}:null,resume_attempt_id:ur.attempt_id,resume_eligible:g.eligible,resume_reason:g.reason,discard:yr(bs,ur.bead_id,{attempt_id:ur.attempt_id})}}let wi=new Set(ws.map(g=>g.bead_id)),qo=Array.isArray(f.merge_queue)?f.merge_queue:[],ki=new Map,$i=new Map,xi=new Map,Ai=new Map,Si=new Map;qo.forEach((g,z)=>{g&&typeof g.bead_id=="string"&&(ki.set(g.bead_id,z+1),$i.set(g.bead_id,g.resolution),xi.set(g.bead_id,g.continuation_action||null),Ai.set(g.bead_id,g.head_review||null),Si.set(g.bead_id,g.authority||null))});let fn=f.merge_queue_state||{active:null,failures:{}},up=fn.failures||{},Ei=fn.waiting&&typeof fn.waiting.bead_id=="string"&&typeof fn.waiting.reason=="string"?fn.waiting:null,dp=f.auto_merge_skips||{},Ti=g=>{let z=dp[g];if(!z)return null;let _e=un[g],He=_e&&_e.pr?_e.pr.head_sha:null;return He&&He===z.head_sha?z.reason||"":null},ks=new Map;for(let g of ws)g.failed!==!0&&g.conflict_resolution&&(g.paused?ks.has(g.bead_id)||ks.set(g.bead_id,"paused"):ks.set(g.bead_id,"running"));let Ci=ws.filter(g=>!g.paused&&g.failed!==!0).length,Ri=(f.workspace_info||{}).slots,Ii=typeof Ri=="number"?Ri:typeof f.slots=="number"?f.slots:Lo,pp=Ci>Ii,$s=Kr(P),fp=(Array.isArray(f.done)?f.done.slice():[]).filter(g=>$s===void 0||typeof g.added_at!="number"||g.added_at>=$s).sort((g,z)=>(z.added_at||0)-(g.added_at||0)),Mn=Po(fp,"done"),_p=new Set((Array.isArray(f.done)?f.done:[]).map(g=>g?.bead_id).filter(g=>typeof g=="string")),Li=[],mp=u?.()||"";for(let g of m){let z=Qr(g.closed_at);if(typeof g.id!="string"||_p.has(g.id)||z===null||$s!==void 0&&z<$s||typeof g.comment_count!="number"||g.comment_count<=0)continue;let _e=`${mp}\0${g.id}\0${String(g.updated_at)}\0${g.comment_count}`,He=q.get(_e);He===void 0&&r&&(q.set(_e,"pending"),Promise.resolve(r("get-comments",{id:g.id})).then(_t=>{let jt=Array.isArray(_t)&&_t.some(Nt=>lo(typeof Nt?.text=="string"?Nt.text:"")?.lane==="session");q.set(_e,jt?"session":"not-session"),Fe()}).catch(()=>{q.set(_e,"failed"),Fe()})),He==="session"&&Li.push({id:g.id,title:g.title||g.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:z,created_at:g.created_at,updated_at:g.updated_at})}Mn.push(...Li),Mn.sort((g,z)=>(z.done_at||0)-(g.done_at||0));let xs={};for(let g of kr)xs[g]=0;let Oi=!1,Mi=0,Fo=0,Pi=0;for(let g of Mn){let z=g.usage;if(z&&typeof z=="object"){let _e=!1;for(let He of kr)Number.isFinite(z[He])&&(xs[He]+=z[He],Oi=!0,_e=!0);_e&&(Fo+=1,Number.isFinite(z.total_cost_usd)&&(Mi+=z.total_cost_usd,Pi+=1))}}Fo>0&&Pi===Fo&&(xs.total_cost_usd=Mi);let Di=Mn.map(g=>g.usage).filter(g=>g&&typeof g=="object"&&g.providers),gp=Di.length>0?Wt(Vs(Di)):Oi?$r(xs):null,hp=f.lane_states&&typeof f.lane_states=="object"&&!Array.isArray(f.lane_states)?f.lane_states:{},bp=Array.isArray(f.serial_lanes)?f.serial_lanes:[],Ni=g=>{if(Ur.some(He=>He.bead_id===g))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let z=pn.filter(He=>He&&He.bead_id===g),_e=z.length>0?z[z.length-1].status:null;return _e==="failed"||_e==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":_e==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},qi=bp.filter(g=>g&&typeof g.id=="string"&&Array.isArray(g.entries)).map((g,z)=>{let _e=hp[g.id]||{},He=new Map((Array.isArray(_e.corrections)?_e.corrections:[]).filter($t=>$t&&typeof $t.bead_id=="string"&&typeof $t.after=="string").map($t=>[$t.bead_id,$t.after])),_t=Po(g.entries.filter($t=>!wi.has($t.bead_id)),g.id).map($t=>He.has($t.id)?{...$t,badges:[`\u{1F517} ${He.get($t.id)} \uB4A4 (blocks \uC790\uB3D9)`,...$t.badges]}:$t),jt=Array.isArray(_e.occupied_by)?_e.occupied_by.filter($t=>typeof $t=="string"):[],Nt=jt.map($t=>({id:$t,title:rt.get($t)||$t,draggable:!1,lane:g.id,ghost:!0,badges:[Ni($t)]}));return{id:g.id,index:z+1,rows:[...Nt,..._t],occupied:jt.length>0,badge:jt.length>0?Ni(jt[0]):"\uB300\uAE30",cycle:_e.cycle===!0}}),yp=typeof f.serial_lane_count=="number"?f.serial_lane_count:qi.length;return{queue:f,idToTitle:rt,candidates:ap,candidate_hidden:{blocked:Mo.hidden_blocked,spec:Mo.hidden_spec},running:ws,live_count:Ci,slots:Ii,over_cap:pp,failure:vi,waiting:Po(dn.filter(g=>!wi.has(g.bead_id)),"queue"),serial_lanes:qi,serial_lane_count:yp,pr_wait:Ur.map(g=>Jh(g.bead_id,rt.get(g.bead_id)||g.bead_id,un,Be[g.bead_id]||null,ir(f.attempts||{},g.bead_id),hs[g.bead_id]||(j.has(g.bead_id)||J.has(g.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),ks.get(g.bead_id)||null,g.external===!0,{position:ki.get(g.bead_id)||0,active:fn.active===g.bead_id,failure:up[g.bead_id]||null,waiting:Ei?.bead_id===g.bead_id?Ei.reason:null,resolution:$i.get(g.bead_id),continuation_action:xi.get(g.bead_id),head_review:Ai.get(g.bead_id)||null,authority:Si.get(g.bead_id)||null},g.wt_present!==!1,f.auto_merge===!0?Ti(g.bead_id):null,li(vs,lp(g.bead_id)),f.completion_status&&typeof f.completion_status=="object"&&!Array.isArray(f.completion_status)&&f.completion_status[g.bead_id]||null,f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},ys.get(gi.get(g.bead_id)||"")?.worker_serial===!0,f.auto_merge===!0,{merge_sha:g.merge_sha,cleanup_cursor:g.cleanup_cursor,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]})).map(g=>({...g,...Br(g.id)})),merge_queue_length:qo.length,merge_queue_running:qo.length>0,auto_excluded:Ur.map(g=>g.bead_id).filter(g=>Ti(g)!==null),declared_base:vs,done:Mn,token_total:gp,cleanup_failures:Tt,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]}}function X(){let $=!!o?.get()?.job,G=!$&&o?.isPending?.()===!0,m=$?"\uBD84\uC11D \uC911":G?"\uC900\uBE44 \uC911":"";return l`<button
      type="button"
    ...
    >
      ...
      .value=${H}
    >
      ${Dh.map(f=>l`<option value=${f.value} ?selected=${H===f.value}>
            ${f.label}
          </option>`)}
    ...
    `}function q(){let U=t.getState(),b=U.workspace?.current,j=U.workspace?.available||[],J=new Set(U.workspace?.hidden||[]),ee=b?.path||j[0]?.path||"";if(j.length===0)return l``;let pe=j.filter(de=>!J.has(de.path)||de.path===ee);if(pe.length<=1){let de=pe[0]||j[0],he=ui(de.path);return l`
