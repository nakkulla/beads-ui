    ...
    `}function xe(){de(ce(),t),Oe()}function Oe(){try{let R=Array.from(t.querySelectorAll(".board-column"));for(let I of R)Array.from(I.querySelectorAll(".board-card")).forEach((V,d)=>{V.tabIndex=d===0?0:-1})}catch{}}async function He(R,I){if(!o){Z("\uC5F0\uACB0\uB418\uC9C0 \uC54A\uC544 \uC0C1\uD0DC\uB97C \uBCC0\uACBD\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}try{await o("update-status",{id:R,status:I}),Z("\uC0C1\uD0DC \uBCC0\uACBD\uB428","success",1500)}catch(X){r("update-status failed: %o",X),Z("\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328","error")}}function Me(R){switch(R){case"blocked-col":return $;case"ready-col":return y;case"in-progress-col":return E;case"resolved-col":return M;case"deferred-col":return F;default:return[]}}function tt(R,I,X){if(!o||!i)return;let V=Me(R),d=V.find(W=>W.id===I);if(!d)return;let l=V.filter(W=>W.id!==I),b=X.closest?X.closest(".board-card"):null,v=l.length;if(b){let W=b.getAttribute("data-issue-id");if(W===I)return;let Q=l.findIndex(P=>P.id===W);Q>=0&&(v=Q)}let T=l.slice();T.splice(v,0,d),w.applyReorder(I,T,v)}function it(){for(let R of Array.from(t.querySelectorAll(".board-column--drag-over")))R.classList.remove("board-column--drag-over")}let me=null;t.addEventListener("dragover",R=>{R.preventDefault(),R.dataTransfer&&(R.dataTransfer.dropEffect="move");let X=R.target.closest(".board-column");X&&X!==me&&(me&&me.classList.remove("board-column--drag-over"),X.classList.add("board-column--drag-over"),me=X)}),t.addEventListener("dragleave",R=>{let I=R.relatedTarget;(!I||!t.contains(I))&&me&&(me.classList.remove("board-column--drag-over"),me=null)}),t.addEventListener("drop",R=>{R.preventDefault(),me&&(me.classList.remove("board-column--drag-over"),me=null);let I=R.target,X=I.closest(".board-column");if(!X)return;let V=R.dataTransfer?.getData("text/plain")||"";if(!V)return;let d=X.id,l=x.get(V);if(l&&l===d){if(Gi.has(d)){if(A!=="manual"){Z("\uC218\uB3D9(\uB4DC\uB798\uADF8) \uC815\uB82C \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC21C\uC11C\uB97C \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4","warning",2e3);return}tt(d,V,I)}return}let b=Wi[d];if(!b){Z("\uC5EC\uAE30\uB85C\uB294 \uC62E\uAE38 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","warning",1500);return}S.get(V)!==b&&He(V,b)}),t.addEventListener("keydown",R=>{let I=R.target;if(!(I instanceof HTMLElement))return;let X=String(I.tagName||"").toLowerCase();if(X==="input"||X==="textarea"||X==="select"||X==="button"||X==="a"||I.isContentEditable===!0)return;let V=I.closest(".board-card");if(!V)return;let d=String(R.key||"");if(d==="Enter"||d===" "){R.preventDefault();let T=V.getAttribute("data-issue-id");T&&n(T);return}if(d!=="ArrowUp"&&d!=="ArrowDown"&&d!=="ArrowLeft"&&d!=="ArrowRight")return;R.preventDefault();let l=V.closest(".board-column");if(!l)return;let b=Array.from(l.querySelectorAll(".board-card")),v=b.indexOf(V);if(d==="ArrowDown"&&v<b.length-1){Ne(V,b[v+1]);return}if(d==="ArrowUp"&&v>0){Ne(V,b[v-1]);return}if(d==="ArrowLeft"||d==="ArrowRight"){let T=Array.from(t.querySelectorAll(".board-column")),W=T.indexOf(l),Q=d==="ArrowRight"?1:-1,P=W+Q;for(;P>=0&&P<T.length;){let ue=T[P].querySelector(".board-card");if(ue){Ne(V,ue);return}P+=Q}}});function Ne(R,I){try{R.tabIndex=-1,I.tabIndex=0,I.focus()}catch{}}let Pe=null;g&&g.subscribe&&(Pe=g.subscribe(()=>{try{ve()}catch{}}));let Re=null;return c&&c.subscribe&&(Re=c.subscribe(()=>{try{ve()}catch{}})),{async load(){r("load"),ve()},clear(){ze(),Pe&&(Pe(),Pe=null),Re&&(Re(),Re=null),t.replaceChildren(),$=[],y=[],E=[],M=[],F=[],B=[],S=new Map,x=new Map}}}function dn(t){let e=t&&t.parent;return typeof e=="string"?e:e&&e.id?String(e.id):""}function Ut(t,e){return t.filter(r=>{let n=dn(r);return!(n&&e.has(n))})}async function Yi(t){try{if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")return await navigator.clipboard.writeText(String(t)),!0;let e=document.createElement("textarea");e.value=String(t),e.style.position="fixed",e.style.left="-9999px",document.body.appendChild(e),e.select();let r=!1;try{r=document.execCommand("copy")}finally{e.remove()}return r}catch{return!1}}async function Lt(t){let e=String(t);if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{return await navigator.clipboard.writeText(e),!0}catch{}try{let r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.left="-9999px",document.body.appendChild(r),r.select();let n=!1;try{n=document.execCommand("copy")}finally{r.remove()}return n}catch{return!1}}var Vi={Read:"\u{1F4D6}",Edit:"\u270E",MultiEdit:"\u270E",Write:"\u{1F4DD}",Bash:"\u26A1",Grep:"\u{1F50E}",Glob:"\u{1F50E}",Task:"\u{1F916}",WebFetch:"\u{1F310}",WebSearch:"\u{1F310}"},Ki=/^\s*([✓✗⊘])\s*(spec|impl|implementation|plan)\s*게이트\s*[—–-]\s*(\S+)\s+(APPROVE|REVISE|REJECT|BLOCK|SKIP)(?:\s*·\s*(.+))?/,Zi=/^\s*#{0,3}\s*Phase\s+\d+(?:\s*\/\s*\d+)?\s*(?:[·:—–-]\s*.+)?$/;function wt(t){return!!t&&typeof t=="object"}function un(t){return typeof t!="string"||t.length===0?[]:t.split(/\r?\n/)}function Ps(t,e){let r=un(t),n=un(e),s=new Map;for(let c of r)s.set(c,(s.get(c)||0)+1);let o=0;for(let c of n){let a=s.get(c)||0;a>0?s.set(c,a-1):o+=1}let i=0;for(let c of s.values())i+=c;return{added:o,removed:i}}function Xi(t){let e="";typeof t=="string"?e=t:Array.isArray(t)?e=t.map(s=>wt(s)&&typeof s.text=="string"?s.text:"").join(""):wt(t)&&typeof t.text=="string"&&(e=t.text);let n=(String(e).split(/\r?\n/).find(s=>s.trim().length>0)||"").trim();return n.length>120?`${n.slice(0,117)}\u2026`:n}function Qi(t){let e=String(t.name||""),r=t.input||{},n={kind:"tool",tool:e,icon:Vi[e]||"\u{1F527}",input:r,expandable:!0};if((e==="Read"||e==="Write")&&(n.path=String(r.file_path||r.path||"")),e==="Write"&&(n.added=un(r.content).length),e==="Edit"){n.path=String(r.file_path||r.path||"");let{added:s,removed:o}=Ps(r.old_string,r.new_string);n.added=s,n.removed=o}if(e==="MultiEdit"){n.path=String(r.file_path||r.path||"");let s=0,o=0,i=Array.isArray(r.edits)?r.edits:[];for(let c of i){let a=Ps(wt(c)?c.old_string:"",wt(c)?c.new_string:"");s+=a.added,o+=a.removed}n.added=s,n.removed=o}return e==="Bash"&&(n.command=String(r.command||"")),(e==="Grep"||e==="Glob")&&(n.command=String(r.pattern||r.query||"")),n}function Fs(t){let e=t.split(/\r?\n/).find(n=>n.trim().length>0)||"",r=Ki.exec(e);return r?{kind:"gate",gate:r[2]==="implementation"?"impl":r[2],reviewer:r[3],verdict:r[4],time:r[5]?r[5].trim():void 0,text:e.trim()}:Zi.test(e)&&e.trim().length<=80?{kind:"phase",text:e.trim()}:{kind:"assistant",text:t}}function Ji(t,e){if(t.type==="assistant"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[],s=[];for(let o of n)if(wt(o)){if(o.type==="text"&&typeof o.text=="string")s.push(Fs(o.text));else if(o.type==="tool_use"){let i=Qi(o);typeof o.id=="string"&&e.set(o.id,i),s.push(i)}}return s}if(t.type==="user"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[];for(let s of n)if(wt(s)&&s.type==="tool_result"){let o=e.get(String(s.tool_use_id));if(o){let i=Xi(s.content);o.result=i,o.output=typeof s.content=="string"?s.content:i}}return[]}if(t.type==="result"){let r=t.is_error===!1&&t.subtype==="success";return[{kind:"result",success:r,text:typeof t.result=="string"?t.result:r?"DONE":""}]}return[]}function ea(t){if(t.type==="item.completed"&&wt(t.item)){let e=t.item;return e.type==="agent_message"&&typeof e.text=="string"?[Fs(e.text)]:e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}if(t.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(t.type==="turn.failed"){let e=t.error;return[{kind:"error",text:e&&typeof e.message=="string"?e.message:"turn failed"}]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:[]}function ta(t){let e=t.type;return typeof e=="string"&&(e==="error"||e.startsWith("thread.")||e.startsWith("turn.")||e.startsWith("item."))}function Bs(t){let e=[],r=new Map,n=Array.isArray(t)?t:[];for(let s of n){let o=s;if(typeof s=="string"){let c=s.trim();if(c.length===0)continue;try{o=JSON.parse(c)}catch{continue}}if(!wt(o))continue;let i=ta(o)?ea(o):Ji(o,r);for(let c of i)e.push(c)}return e}function Er(t,e={}){let{transport:r,sessionLogStore:n,onClose:s}=e,o=null,i={},c=!0,a=new Set,u=null;function h(){if(!o||!n)return[];let x=n.get(o);return Bs(x?x.lines:[])}function g(x,_){if(_.kind==="gate")return p`<div class="sv__gate">${_.text}</div>`;if(_.kind==="phase")return p`<div class="sv__phase">${_.text}</div>`;if(_.kind==="result")return p`<div
      ...
      >
        <span class="sv__tool-line">
          ...
          ${typeof _.added=="number"?p`<span class="sv__diff-add">+${_.added}</span>`:""}
          ${typeof _.removed=="number"?p`<span class="sv__diff-del">−${_.removed}</span>`:""}
          ${_.result?p`<span class="sv__tool-ok">→ ${_.result}</span>`:""}
        </span>
        ${O?p`<pre class="sv__tool-expand">${w(_)}</pre>`:""}
      </div>`}return p`<div class="sv__as">${_.text}</div>`}function w(x){let _=[];if(x.input!==void 0)try{_.push(`input: ${JSON.stringify(x.input,null,2)}`)}catch{}return typeof x.output=="string"&&x.output.length>0&&_.push(`output:
${x.output}`),_.join(`

`)}function $(){if(!o)return p``;let x=h(),_=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),O=i.session_id||"",N=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`;return p`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
        ...
        ${_?p`<span class="sv__meta">${_}</span>`:""}
      ...
      <div class="sv__body">
        ${x.length===0?p`<div class="sv__empty">세션 로그 없음</div>`:x.map((U,K)=>g(K,U))}
      </div>
    </div>`}function y(){de($(),t),c&&E()}function E(){let x=t.querySelector(".sv__body");x&&(x.scrollTop=x.scrollHeight)}function M(x){a.has(x)?a.delete(x):a.add(x),y()}function F(){c=!c,y()}function B(x){Lt(x).then(_=>{_?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function z(x){!o||!x||(i={...i,...x},y())}function D(x){let _=x.target;if(!_||!_.classList||!_.classList.contains("sv__body"))return;!(_.scrollHeight-_.scrollTop-_.clientHeight<=4)&&c&&(c=!1,y())}t.addEventListener("scroll",D,!0);function A(x){let _=x&&x.attempt_id;_&&(o=_,i=x.meta||{},c=!0,a.clear(),!u&&n&&(u=n.subscribe(y)),r&&Promise.resolve(r("subscribe-session-log",{id:`session-log:${o}`,attempt_id:o})).catch(()=>{}),y())}function S(){let x=o;o=null,a.clear(),r&&x&&Promise.resolve(r("unsubscribe-session-log",{id:`session-log:${x}`})).catch(()=>{}),de(p``,t),s&&s()}return{open:A,updateMeta:z,close:S,isOpen(){return o!==null},destroy(){u&&(u(),u=null),t.removeEventListener("scroll",D,!0),o=null,de(p``,t)}}}function ra(t){let e=t&&t.metadata||{},r=[];return typeof e.spec_id=="string"&&e.spec_id.trim().length>0&&r.push({kind:"spec",path:e.spec_id.trim()}),typeof e.plan_path=="string"&&e.plan_path.trim().length>0&&r.push({kind:"plan",path:e.plan_path.trim()}),r}function qs(t,e){let r=ra(t);return p`
...
`+r.join(`
`),E=this.blockquote(y);o[o.length-1]=E,n=n.substring(0,n.length-$.raw.length)+E.raw,s=s.substring(0,s.length-$.text.length)+E.text;break}else if(w?.type==="list"){let $=w,y=$.raw+`
`+r.join(`
`),E=this.list(y);o[o.length-1]=E,n=n.substring(0,n.length-w.raw.length)+E.raw,s=s.substring(0,s.length-$.raw.length)+E.raw,r=y.substring(o.at(-1).raw.length).split(`
...
`,t=t.substring(w.length+1),a=!0),!a){let E=this.rules.other.nextBulletRegex(y),M=this.rules.other.hrRegex(y),F=this.rules.other.fencesBeginRegex(y),B=this.rules.other.headingBeginRegex(y),z=this.rules.other.htmlBeginRegex(y);for(;t;){let D=t.split(`
`,1)[0],A;if(w=D,this.options.pedantic?(w=w.replace(this.rules.other.listReplaceNesting,"  "),A=w):A=w.replace(this.rules.other.tabCharGlobal,"    "),F.test(w)||B.test(w)||z.test(w)||E.test(w)||M.test(w))break;if(A.search(this.rules.other.nonSpaceChar)>=y||!w.trim())h+=`
`+A.slice(y);else{if($||g.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||F.test(g)||B.test(g)||M.test(g))break;h+=`
`+w}!$&&!w.trim()&&($=!0),u+=D+`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+gt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},It=new al;function le(t,e){return It.parse(t,e)}le.options=le.setOptions=function(t){return It.setOptions(t),le.defaults=It.defaults,uo(le.defaults),le};le.getDefaults=Cn;le.defaults=Dt;le.use=function(...t){return It.use(...t),le.defaults=It.defaults,uo(le.defaults),le};le.walkTokens=function(t,e){return It.walkTokens(t,e)};le.parseInline=It.parseInline;le.Parser=pt;le.parser=pt.parse;le.Renderer=Fr;le.TextRenderer=Pn;le.Lexer=ut;le.lexer=ut.lex;le.Tokenizer=Pr;le.Hooks=ur;le.parse=le;var md=le.options,_d=le.setOptions,bd=le.use,wd=le.walkTokens,kd=le.parseInline;var yd=pt.parse,vd=ut.lex;function vo(t){let e=le.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",c="";function a(y){y.key==="Escape"&&s&&(y.preventDefault(),w())}document.addEventListener("keydown",a);function u(){return s?p`
    ...
    `:p``}function h(){de(u(),t)}async function g(y){s=y,o="loading",i="",c="",h();let E=r?r():"";if(!E){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",h();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",h();return}let M="/api/doc?workspace="+encodeURIComponent(E)+"&path="+encodeURIComponent(y);try{let F=await n(M),B=await F.json().catch(()=>({}));if(!F.ok||!B||B.ok!==!0){o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(B&&B.error||F.status)+")",h();return}i=String(B.content||""),o="ready",h()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",h()}}function w(){s=null,de(p``,t)}function $(){document.removeEventListener("keydown",a),w()}return{open:g,close:w,destroy:$}}var cl={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function dl(t){if(typeof t!="number"||!Number.isFinite(t))return"";let e=new Date(t),r=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${r}:${n}`}function xo(t,e={}){let r=Array.isArray(t)?t:[];if(r.length===0)return p`
  ...
  `}var ul=["open","in_progress","deferred","resolved","closed"],pl=[0,1,2,3,4];function So(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,c=e.sessionLogStore,a=null,u=null,h={},g=!1,w=!1,$="",y="",E="";function M(){g=!1,w=!1,$="",y="",E=""}let F=document.createElement("div");F.className="md-viewer-root",document.body.appendChild(F);let B=$o(F,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),z=document.createElement("div");z.className="session-log-root",document.body.appendChild(z);let D=Er(z,{transport:s?(l,b)=>Promise.resolve(s(l,b)):void 0,sessionLogStore:c});function A(){if(!i||!a)return[];let l=i.get();return(l&&l.attempts?Object.values(l.attempts):[]).filter(v=>v&&v.bead_id===a).sort((v,T)=>(T.started_at||0)-(v.started_at||0)).map(v=>({attempt_id:v.attempt_id,bead_id:v.bead_id,status:v.status,started_at:typeof v.started_at=="number"?v.started_at:null,runner:v.runner||null,model:v.model||null,session_id:v.session_id||null,resumed_from:v.resumed_from||null,dismissed_at:typeof v.dismissed_at=="number"?v.dismissed_at:null,cause:typeof v.cause=="string"?v.cause:null,cause_detail:v.cause_detail||null}))}function S(l){let b=i?i.get():null,v=b&&b.attempts?b.attempts[l]:null;D.open({attempt_id:l,meta:v?{runner:v.runner||void 0,model:v.model||void 0,effort:v.effort||void 0,status:v.status||void 0,session_id:v.session_id||void 0}:{}})}async function x(l){if(!s||!l)return;let b=()=>{let T=i?i.get():null;return T&&typeof T.revision=="number"?T.revision:0},v=await s("worker-attempt-resume",{attempt_id:l,expected_revision:b()});if(v&&v.conflict){let T=v.queue&&typeof v.queue.revision=="number"?v.queue.revision:b();v=await s("worker-attempt-resume",{attempt_id:l,expected_revision:T})}v&&v.resumed===!1&&!v.conflict&&v.reason&&Z(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${v.reason}`,"error",2400)}let _={onOpen:S,onResume:x};function O(){let l=i?i.get():null,b=l&&l.exec_defaults;return b&&typeof b=="object"?b:{}}let N=null;r&&r.subscribe&&(N=r.subscribe(()=>ke()));let U=null;i&&typeof i.subscribe=="function"&&(U=i.subscribe(()=>{a&&d()}));function K(l){l.key==="Escape"&&a&&(l.preventDefault(),n())}document.addEventListener("keydown",K);function ke(){if(a){if(r&&typeof r.snapshotFor=="function"){let l=r.snapshotFor("detail:"+a)||[];u=l.find(v=>v&&v.id===a)||l[0]||u}d()}}function oe(l){Lt(l).then(b=>{b?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ee(l){l.preventDefault(),l.stopPropagation(),a&&oe(a)}function Xe(l,b){l.preventDefault(),l.stopPropagation(),oe(b)}function qe(l,b){l.preventDefault(),l.stopPropagation(),B.open(b)}function ve(l,b){h[l]=b,d(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:l,value:b})).catch(()=>{Z("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function Ae(l,b,v){if(!s||!a)return!1;try{let T=await Promise.resolve(s(l,b)),W=Array.isArray(T)?T[0]:T;return W&&typeof W=="object"&&W.id?(u=W,!0):(Z(v,"error"),!1)}catch{return Z(v,"error"),!1}}function Qe(l){setTimeout(()=>{try{let b=t.querySelector(l);b&&typeof b.focus=="function"&&b.focus()}catch{}},0)}function fe(){g=!0,$=u&&u.title||"",d(),Qe('.detail-edit__input[data-edit="title"]')}function ot(l){$=l.target.value}function he(){g=!1,$="",d()}function Je(){Ae("edit-text",{id:a,field:"title",value:$},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(b=>{b&&(g=!1,$=""),d()})}function ae(){w=!0,y=u&&u.description||"",d(),Qe('.detail-edit__textarea[data-edit="description"]')}function Fe(l){y=l.target.value}function rt(){w=!1,y="",d()}function Ce(){Ae("edit-text",{id:a,field:"description",value:y},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(b=>{b&&(w=!1,y=""),d()})}function Le(l,b,v,T){if(l.key==="Escape"){l.stopPropagation(),v();return}l.key==="Enter"&&(!T||l.ctrlKey||l.metaKey)&&(l.preventDefault(),b())}function $e(l){let b=l.target.value;Ae("update-status",{id:a,status:b},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function Ue(l){let b=Number(l.target.value);Ae("update-priority",{id:a,priority:b},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function et(l){E=l.target.value}function Ie(){let l=E.trim();l.length!==0&&Ae("label-add",{id:a,label:l},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(b=>{b&&(E=""),d()})}function ze(l){if(l.key==="Escape"){l.stopPropagation(),E="",d();return}l.key==="Enter"&&(l.preventDefault(),Ie())}function De(l){Ae("label-remove",{id:a,label:l},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>d())}let ce={onCopyPath:Xe,onOpenDoc:qe},xe={onChange:ve};function Oe(l){return typeof l=="string"?l:l&&typeof l=="object"?String(l.id||l.to||l.issue_id||l.depends_on||""):""}function He(l){switch(l&&typeof l=="object"?String(l.dependency_type||l.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Me(l){let v=(Array.isArray(l.dependencies)?l.dependencies:[]).map(T=>({id:Oe(T),icon:He(T)})).filter(T=>T.id.length>0);return p`
    ...
    `}function tt(l){let b=l.metadata||{},v=l.workflow||{},T=v.stages||{},W=T.spec&&T.spec.stale,Q=T.impl&&T.impl.stale,P=v.route_source==="derived",ue=v.route||b.route||"\u2014";return p`
      ...
      <div class="detail-kv">
        ...
        <span
          ...
          >${P&&v.route?`${ue} ? (\uCD94\uB860)`:ue}</span
        >
      </div>
      <div class="detail-kv">
        <span class="detail-kv__k">spec_review</span>
        <span class="detail-kv__v"
          >${b.spec_review||"\uC5C6\uC74C"}${W?" \xB7 stale":""}</span
        >
      </div>
      <div class="detail-kv">
        <span class="detail-kv__k">impl_review</span>
        <span class="detail-kv__v"
          >${b.impl_review||"\uC5C6\uC74C"}${Q?" \xB7 stale":""}</span
        >
      </div>
      ${b.pr_url?p`<div class="detail-kv">
            <span class="detail-kv__k">pr_url</span>
            <span class="detail-kv__v detail-kv__v--wrap">${b.pr_url}</span>
          </div>`:""}
    `}let it={route:["spec_backed","full_plan"]};async function me(l,b){let v=b.target.value;if(l==="route"&&u&&u.metadata&&u.metadata.route==="full_plan"&&v!=="full_plan"&&!window.confirm(`full_plan \u2192 ${v||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){d();return}await Ae("update-workflow-meta",{id:a,key:l,value:v},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),d()}function Ne(l){let b=l.metadata||{};return p` ${((T,W)=>{let Q=it[T],P=typeof b[T]=="string"?b[T]:"";return p`<div class="detail-kv">
        ...
        <select
          ...
          @change=${ue=>me(T,ue)}
        >
          <option value="" ?selected=${!Q.includes(P)}>
            ${W}
          </option>
          ${Q.map(ue=>p`<option value=${ue} ?selected=${P===ue}>${ue}</option>`)}
        </select>
    ...
    `}function Re(l){let b=bt(l.created_at),v=bt(l.updated_at);return!b&&!v?p``:p`
      ${b?p`<div class="detail-kv">
    ...
    `}function R(l,b){return p`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Ue}
        >
          ${pl.map(v=>p`<option value=${String(v)} ?selected=${v===b}>
                P${v}
              </option>`)}
        </select>
      </div>
    ...
    `}function X(l){let b=Array.isArray(l.labels)?l.labels:[];return p`
      <div class="detail-section-label">라벨</div>
      <div class="detail-labels">
        ${b.map(v=>p`<span class="detail-label-chip"
              >${v}<button
                type="button"
    ...
    `}function V(){if(!a)return p``;let l=u||{},b=String(l.id||a),v=l.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",T=l.status||"open",W=typeof l.priority=="number"?Math.max(0,Math.min(4,l.priority)):"",Q=l.description||"",P={...l,metadata:{...l.metadata||{},...h}};return p`
    ...
    `}function d(){de(V(),t)}return{load(l){l!==a&&(h={},M()),a=l,u=null,ke()},clear(){a=null,u=null,h={},M(),B.close(),D.close(),de(p``,t)},destroy(){N&&(N(),N=null),U&&(U(),U=null),document.removeEventListener("keydown",K),B.destroy(),F.parentNode&&F.parentNode.removeChild(F),D.destroy(),z.parentNode&&z.parentNode.removeChild(z),a=null,u=null,de(p``,t)}}}var fl=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function To(t,e){return an(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function hl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function Ao(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function c(S){let x=r.get();if(x)try{let _=await n("display-policy-set",{expected_revision:x.revision,policy:S(x)});a(_),_&&_.conflict&&_.policy&&(_=await n("display-policy-set",{expected_revision:_.policy.revision,policy:S(_.policy)}),a(_)),_&&_.conflict&&Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(S){S&&S.policy&&typeof S.policy=="object"&&r.set(S.policy)}function u(S){let x=r.get();if(!x)return;let _=To(S,x)!=="shown";c(O=>hl(S,O,_))}function h(){let S=i.trim();S.length!==0&&(i="",c(x=>x.hidden_prefixes.includes(S)?{hidden_prefixes:x.hidden_prefixes}:{hidden_prefixes:[...x.hidden_prefixes,S]}),M())}function g(S){c(x=>({hidden_prefixes:x.hidden_prefixes.filter(_=>_!==S)}))}function w(S){let x=r.get();if(!x)return;let _=x.chips[S]===!1;c(()=>({chips:{[S]:_}}))}function $(S){let x=s();return p`
      <section class="display-settings__section">
        ...
        ${x.length===0?p`<div class="display-settings__empty">라벨 없음</div>`:p`<div class="display-settings__pills">
              ${x.map(_=>{let O=To(_,S);return p`<button
                  type="button"
    ...
    `}function E(S){return p`
      <section class="display-settings__section">
        <h3 class="display-settings__heading">카드 표시 요소</h3>
        <div class="display-settings__toggles">
          ${fl.map(([x,_])=>p`<label class="display-settings__toggle">
                <input
                  type="checkbox"
                  data-chip=${x}
                  .checked=${S.chips[x]!==!1}
    ...
    `}function M(){let S=r.get();de(p`
        <div class="display-settings__container">
          ...
          <div class="display-settings__body">
            ${S?p`${$(S)} ${y(S)}
                ${E(S)}`:p`<div class="display-settings__empty">
                  표시 정책을 불러오는 중…
                </div>`}
          </div>
        </div>
      `,o)}let F=!1,B=()=>{F=!1};o.addEventListener("close",B),o.addEventListener("cancel",B);let z=null;r.subscribe&&(z=r.subscribe(()=>{F&&M()}));function D(){F||(i="",F=!0,M(),typeof o.showModal=="function"?o.showModal():o.setAttribute("open",""))}function A(){F&&(F=!1,typeof o.close=="function"?o.close():o.removeAttribute("open"))}return{open:D,close:A,destroy(){F=!1,o.removeEventListener("close",B),o.removeEventListener("cancel",B),z&&(z(),z=null),o.remove()}}}function Eo(t){let e=document.createElement("dialog");e.id="fatal-error-dialog",e.setAttribute("role","alertdialog"),e.setAttribute("aria-modal","true"),e.innerHTML=`
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),c=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),h=r.querySelector("#btn-cancel"),g=r.querySelector("#btn-create"),w=r.querySelector(".new-issue__close");function $(){o.replaceChildren();let A=document.createElement("option");A.value="",A.textContent="\u2014 Select \u2014",o.appendChild(A);for(let S of Ro){let x=document.createElement("option");x.value=S,x.textContent=Lo(S),o.appendChild(x)}i.replaceChildren();for(let S=0;S<=4;S+=1){let x=document.createElement("option");x.value=String(S);let _=Io[S]||"Medium";x.textContent=`${S} \u2013 ${_}`,i.appendChild(x)}}$();function y(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function E(A){s.disabled=A,o.disabled=A,i.disabled=A,c.disabled=A,a.disabled=A,h.disabled=A,g.disabled=A,g.textContent=A?"Creating\u2026":"Create"}function M(){u.textContent=""}function F(A){u.textContent=A}function B(){try{let A=window.localStorage.getItem("beads-ui.new.type");A?o.value=A:o.value="";let S=window.localStorage.getItem("beads-ui.new.priority");S&&/^\d$/.test(S)?i.value=S:i.value="2"}catch{o.value="",i.value="2"}}function z(){let A=o.value||"",S=i.value||"";A.length>0&&window.localStorage.setItem("beads-ui.new.type",A),S.length>0&&window.localStorage.setItem("beads-ui.new.priority",S)}async function D(){M();let A=String(s.value||"").trim();if(A.length===0){F("Title is required"),s.focus();return}let S=Number(i.value||"2");if(!(S>=0&&S<=4)){F("Priority must be 0..4"),i.focus();return}let x=String(o.value||""),_=String(a.value||""),O={title:A};x.length>0&&(O.type=x),String(S).length>0&&(O.priority=S),_.length>0&&(O.description=_),E(!0);try{await e("create-issue",O)}catch{E(!1),F("Failed to create issue");return}z(),E(!1),y()}return r.addEventListener("cancel",A=>{A.preventDefault(),y()}),w.addEventListener("click",()=>y()),h.addEventListener("click",()=>y()),r.addEventListener("keydown",A=>{A.key==="Enter"&&(A.ctrlKey||A.metaKey)&&(A.preventDefault(),D())}),n.addEventListener("submit",A=>{A.preventDefault(),D()}),{open(){n.reset(),M(),B();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){y()}}}function Oo(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function Mo(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var gl={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},ml=[{key:"orchestration_model",values:()=>pn},{key:"orchestration_effort",values:()=>fn},{key:"review_model",values:()=>hn},{key:"impl_model",values:()=>gn}];function No(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function c(){let _=i();return typeof _.revision=="number"?_.revision:0}function a(){let _=i().exec_defaults;return _&&typeof _=="object"?_:{}}function u(_){_&&_.queue&&r&&r.set(_.queue)}async function h(_,O){if(!n)return;let N={key:_,value:O||null};try{let U=await n("worker-queue-set-exec-default",{...N,expected_revision:c()});u(U),U&&U.conflict&&(U=await n("worker-queue-set-exec-default",{...N,expected_revision:c()}),u(U)),U&&U.conflict&&Z("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function g(_,O,N){let U=!!N&&!O.includes(N);return p`<div class="exec-defaults__row">
      ...
      >
        ...
        ${U?p`<option value=${N} ?selected=${!0}>
              ${N} (비호환)
            </option>`:""}
        ${O.map(K=>p`<option value=${K} ?selected=${N===K}>${K}</option>`)}
      </select>
    </div>`}function w(){let _=i().workspace_info;return _&&typeof _=="object"?_:{}}function $(_,O){return p`<span
      class="exec-defaults__vd-badge exec-defaults__vd-badge--${_}"
      >${O}</span
    >`}function y(_){let O=_?Mo(_.cmd):"",N=_?Oo(_.timeout_ms):"",U=!!_&&_.source==="detected";return p`<div class="exec-defaults__vd-group" data-vd="verify">
      <div class="exec-defaults__vd-label">머지 전 검증 (verify)</div>
      ${O?p`<div class="exec-defaults__vd-line">
            <span class="exec-defaults__vd-cmd">${O}</span>
            ${U?$("detected","\uC790\uB3D9\uAC10\uC9C0"):$("config","config")}
    ...
    </div>`}function E(_){let O=_?Mo(_.cmd):"",N=_?Oo(_.timeout_ms):"",U=N?`timeout ${N} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",K=s&&s()||"<workspace \uACBD\uB85C>";return p`<div class="exec-defaults__vd-group" data-vd="deploy">
    ...
    </div>`}function M(_){if(!_||typeof _!="object")return"";let O=gl[String(_.outcome)];if(!O)return"";let N=_.outcome==="failed"&&_.reason?`${O.label} \xB7 ${_.reason}`:O.label,U=[bt(_.at),typeof _.bead_id=="string"?_.bead_id:"",typeof _.base_sha=="string"?_.base_sha.slice(0,7):""].filter(K=>K.length>0).join(" \xB7 ");return p`<div class="exec-defaults__vd-group" data-vd="last-deploy">
      <div class="exec-defaults__vd-label">마지막 배포</div>
      <div class="exec-defaults__vd-line">
        ${$(O.modifier,N)}
        ${U?p`<span class="exec-defaults__vd-meta">${U}</span>`:""}
      </div>
    </div>`}function F(_){return p`<section class="exec-defaults__vd">
      ...
      ${y(_.verify_cmd)} ${E(_.deploy_cmd)}
      ${M(_.last_deploy)}
    </section>`}function B(){let _=a();de(p`
      ...
      `,o)}let z=!1,D=()=>{z=!1};o.addEventListener("close",D),o.addEventListener("cancel",D);let A=null;r&&r.subscribe&&(A=r.subscribe(()=>{z&&B()}));function S(){z||(z=!0,B(),typeof o.showModal=="function"?o.showModal():o.setAttribute("open",""))}function x(){z&&(z=!1,typeof o.close=="function"?o.close():o.removeAttribute("open"))}return{open:S,close:x,destroy(){z=!1,o.removeEventListener("close",D),o.removeEventListener("cancel",D),A&&(A(),A=null),o.remove()}}}var _l="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function zt(t){return typeof t=="number"&&Number.isFinite(t)?t:0}function bl(t){return!t||typeof t!="object"?!1:typeof t.input_tokens=="number"||typeof t.output_tokens=="number"}function wl(t){return t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}k`:String(t)}function Ht(t){if(!bl(t))return null;let e=zt(t?.input_tokens)+zt(t?.output_tokens);return`\u03C4 ${wl(e)}`}function Ur(t){if(!t||typeof t!="object")return"";let e=[`\uC785\uB825 ${zt(t.input_tokens).toLocaleString("en-US")}`,`\uCD9C\uB825 ${zt(t.output_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC77D\uAE30 ${zt(t.cache_read_input_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC0DD\uC131 ${zt(t.cache_creation_input_tokens).toLocaleString("en-US")}`];typeof t.total_cost_usd=="number"&&Number.isFinite(t.total_cost_usd)&&e.push(`$${t.total_cost_usd.toFixed(2)}`);let r=e.join(" \xB7 ");return t.replayed?`${r}
${_l}`:r}function Fn(t,e){let r=null;for(let n of Object.values(t||{}))n&&n.bead_id===e&&(r=n.usage||null);return r}function Bn(t){let e=t.draggable&&!t.done,r=Array.isArray(t.badges)?t.badges:[],n=Ht(t.usage),s=t.merge_step||null,o=t.lane==="pr_wait",i=e?p`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",c=p`<span class="worker-mini__id" title="클릭하면 ID 복사"
  ...
  >`,a=p`<span class="worker-mini__title">${t.title}</span>`,u=t.pr_url&&t.pr_number?p`<a
      ...
      >
        ${t.merge_label||"\uBA38\uC9C0"}
      </button>`:"",E=t.discard_action?p`<button
        type="button"
      ...
      >
        ...
        >
          승인하고 진행
        </button>`:"",F=!!(n||s||t.merge_action||t.discard_action);return p`<div
  ...
  >
    ...
    <pre>${t}</pre>
  </details>`:""}function $l(t){if(!Number.isFinite(t)||t<0)return"0s";let e=Math.floor(t/1e3),r=Math.floor(e/60),n=e%60;return r>0?`${r}m ${String(n).padStart(2,"0")}s`:`${n}s`}function Bo(t){let e=Array.isArray(t.cleanupFailures)?t.cleanupFailures:[];return p`<div class="worker-banners">
  ...
  </div>`}function xl(t,e,r=null){let n=!!t.paused,s=n?"\uC77C\uC2DC\uC815\uC9C0":typeof t.started_at=="number"?$l(e-t.started_at):"\u2014",o=[t.runner,t.model].filter(Boolean).join(" \xB7 "),i=Ht(t.usage),c=t.conflict_resolution?n?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,a=t.attempt_id&&t.attempt_id===r;return p`<div
  ...
  >
    ...
    ${n.length===0?p`<div class="worker-rungrid__empty">실행 세션 없음</div>`:n.map(s=>xl(s,e,r))}
  </div>`}var Sl="tab:worker:ready",Tl="tab:worker:blocked",zr=1;function Hn(t){let e=t&&t.metadata;return!!(e&&typeof e=="object"&&e.spec_id)}var Uo="beads-ui.worker.candidate-filter",Un={show_blocked:!1,spec:"all"};function Al(){try{let t=window.localStorage.getItem(Uo);if(!t)return{...Un};let e=JSON.parse(t);if(!e||typeof e!="object")return{...Un};let r=e.spec;return{show_blocked:e.show_blocked===!0,spec:r==="with"||r==="without"?r:"all"}}catch{return{...Un}}}function El(t){try{window.localStorage.setItem(Uo,JSON.stringify(t))}catch{}}function Cl(t,e){let r=c=>e.show_blocked||!c.blocked,n=c=>e.spec==="all"||(e.spec==="with"?c.has_spec:!c.has_spec),s=[],o=0,i=0;for(let c of t){let a=r(c),u=n(c);a&&u?s.push(c):!a&&u?o+=1:a&&!u&&(i+=1)}return{visible:s,hidden_blocked:o,hidden_spec:i}}var Rl=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],zo="bdui.worker.candidate_sort",Ll=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],Hr="spec";function Il(){try{let t=window.localStorage.getItem(zo);return t==="board"||t==="created"||t==="spec"?t:Hr}catch{return Hr}}function Dl(t){try{window.localStorage.setItem(zo,t)}catch{}}var Ol="(max-width: 640px)",Ho="beads-ui.worker.lane-collapsed",hr={queue:!0,done:!0};function Ml(){try{let t=window.localStorage.getItem(Ho);if(!t)return{...hr};let e=JSON.parse(t);return!e||typeof e!="object"?{...hr}:{queue:typeof e.queue=="boolean"?e.queue:hr.queue,done:typeof e.done=="boolean"?e.done:hr.done}}catch{return{...hr}}}function Nl(t){try{window.localStorage.setItem(Ho,JSON.stringify(t))}catch{}}function qo(t){let e=Array.isArray(t)&&t.length>0?t[0]:null;if(!e)return"";let r=typeof e.title=="string"?e.title:e.id||"";return r.length>22?`${r.slice(0,22)}\u2026`:r}function Pl(t,e,r){let n=Array.isArray(t)?t.slice():[];return e==="created"?n.sort(Et):(n.sort(vr(r)),e==="board"?n:[...n.filter(Hn),...n.filter(s=>!Hn(s))])}function Fl(t){let e=t&&t.parent;return(typeof e=="string"?e.length>0:!!(e&&e.id))||/\.\d+$/.test(t&&t.id||"")}function Bl(t){let r=(Array.isArray(t?.dependencies)?t.dependencies:[]).map(n=>typeof n=="string"?n:n&&n.id).filter(Boolean);return r.length>0?`\u{1F512} ${r.join(", ")}`:"\u{1F512} blocked"}var ql=["closed_unmerged","undecidable"],Ul=[{from:"\uAD00\uCE21 \uB300\uAE30",activity:"checking",to:"\uD655\uC778\uC911"},{from:"\uB85C\uCEEC\uAC80\uC99D \uB300\uAE30",activity:"verifying",to:"\uB85C\uCEEC\uAC80\uC99D \uC2E4\uD589 \uC911"}];function zl(t,e){for(let r of Ul)if(t===r.from&&e===r.activity)return{label:r.to,live:!0};return{label:t,live:!1}}var zn=[{step:"merging",label:"\uBA38\uC9C0 \uC911"},{step:"base_sync",label:"base \uB3D9\uAE30\uD654"},{step:"post_merge_verify",label:"\uBA38\uC9C0 \uD6C4 \uAC80\uC99D"},{step:"deploy",label:"\uBC30\uD3EC"},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC"},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC"},{step:"parent_close",label:"\uBD80\uBAA8 close"}];function Hl(t){if(typeof t!="string"||t.length===0)return null;let e=zn.length,r=zn.findIndex(n=>n.step===t);return r<0?{label:t,index:0,total:e,percent:0}:{label:zn[r].label,index:r+1,total:e,percent:Math.round((r+1)/e*100)}}function Wl(t,e,r,n,s=null,o=null,i=null){let c=r[t]||null,a=c&&c.gate?c.gate:null,u=c&&c.pr?c.pr:null,h=[],g=i?i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":null,w=zl(a&&a.gate_badge||"",g?null:o&&o.activity||null);g&&h.push(g),w.label&&h.push(w.label),a&&a.base_badge&&a.base_badge!==a.gate_badge&&h.push(a.base_badge),n&&h.push("\uC815\uB9AC \uC2E4\uD328");let $=!!a&&a.base_badge==="\uCDA9\uB3CC",y=!!a&&a.enabled===!0,E=Hl(o&&o.merge_progress?o.merge_progress.step:null),M=!!n&&!!a&&a.tier==="merged";return{id:t,title:e,reason:n?"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644":"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",pr_number:u&&typeof u.number=="number"?u.number:null,pr_url:u&&typeof u.url=="string"?u.url:"",badges:h,live_badge:i==="running"?g:g?null:w.live?w.label:null,usage:s,alert:!!a&&ql.includes(a.tier)||!!n,merge_action:!0,discard_action:!n&&!(a&&a.tier==="merged"),merge_step:E,discard_enabled:!E&&!i,discard_title:i?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 \uC138\uC158\uC744 \uC815\uB9AC\uD558\uC138\uC694":void 0,merge_enabled:!E&&!i&&(y||$||M),merge_label:$&&!E&&!M?"\uCDA9\uB3CC \uD574\uC18C":void 0,merge_title:E?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${E.label}`:i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":M?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uC218\uD589\uD569\uB2C8\uB2E4":$?"\uCDA9\uB3CC \u2014 \uD074\uB9AD\uD558\uBA74 \uCDA9\uB3CC \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 (\uBA38\uC9C0\uD558\uC9C0 \uC54A\uC74C)":y?`\uBA38\uC9C0 (${a.gate_badge}) \u2014 \uD074\uB9AD \uC2DC\uC810\uC5D0 \uB2E4\uC2DC \uD655\uC778\uD569\uB2C8\uB2E4`:a&&a.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${a&&a.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Wn(t,e={}){let{transport:r,issueStores:n,queueStore:s,sessionLogStore:o,uiOrderStore:i,gotoIssue:c,getWorkspacePath:a}=e,u=n?xr(n,i):null,h=Sr({transport:r,uiOrderStore:i}),g=null,w=[],$=Al(),y=Il(),E=Ml(),M=!1,F=new Set,B=new Set,z=[],D=document.createElement("div");D.className="worker-console";let A=document.createElement("div");A.className="worker-top";let S=document.createElement("div");S.className="worker-drawer-overlay",S.hidden=!0;let x=document.createElement("div");x.className="worker-drawer-overlay__backdrop";let _=document.createElement("div");_.className="worker-drawer-host",S.append(x,_);let O=document.createElement("div");O.className="worker-lanes-host",D.append(A,S,O),t.appendChild(D);let N=null,U=Er(_,{transport:r,sessionLogStore:o,onClose:()=>{N=null,S.hidden=!0,ce()}}),K=No(D,{queueStore:s,transport:r,getWorkspacePath:a});function ke(){return s&&s.get()||{revision:0,auto_advance:!1,slots:zr,queue:[],pr_wait:[],done:[]}}function oe(){let d=ke();return typeof d.revision=="number"?d.revision:0}function ee(d){d&&d.queue&&s&&s.set(d.queue)}function Xe(){let d=ke().queue;return Array.isArray(d)?d.length:0}async function qe(d,l){if(!r)return;let b=await r("worker-queue-place",{bead_id:d,index:l,expected_revision:oe()});ee(b),b&&b.conflict&&await r("worker-queue-place",{bead_id:d,index:l,expected_revision:oe()}).then(ee)}async function ve(d,l){if(!r)return;let b=await r("worker-queue-reorder",{bead_id:d,to_index:l,expected_revision:oe()});ee(b),b&&b.conflict&&await r("worker-queue-reorder",{bead_id:d,to_index:l,expected_revision:oe()}).then(ee)}async function Ae(d){if(!r)return;let l=await r("worker-queue-remove",{bead_id:d,expected_revision:oe()});ee(l),l&&l.conflict&&await r("worker-queue-remove",{bead_id:d,expected_revision:oe()}).then(ee)}async function Qe(d){!r||!d||await r("worker-attempt-stop",{attempt_id:d})}async function fe(d){if(!r||!d)return;let l=await r("worker-attempt-pause",{attempt_id:d});l&&l.paused===!1&&l.reason&&Z(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${l.reason}`,"error",2400)}async function ot(d){if(!r||!d)return;let l=await r("worker-attempt-resume",{attempt_id:d,expected_revision:oe()});ee(l),l&&l.conflict&&(l=await r("worker-attempt-resume",{attempt_id:d,expected_revision:oe()}),ee(l)),l&&l.resumed===!1&&!l.conflict&&l.reason&&Z(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${l.reason}`,"error",2400)}async function he(d){if(!r||!d)return;let l=await r("worker-attempt-dismiss",{attempt_id:d,expected_revision:oe()});ee(l),l&&l.conflict&&(l=await r("worker-attempt-dismiss",{attempt_id:d,expected_revision:oe()}),ee(l)),l&&l.dismissed===!1&&!l.conflict&&l.reason&&Z(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${l.reason}`,"error",2400)}async function Je(d){if(!r||!d)return;F.add(d),ce();let l;try{l=await r("worker-pr-merge",{bead_id:d,expected_revision:oe()}),ee(l),l&&l.conflict&&(l=await r("worker-pr-merge",{bead_id:d,expected_revision:oe()}),ee(l))}finally{F.delete(d),ce()}if(!(!l||l.conflict)){if(l.action==="conflict_resolution"){Z(l.ok?"\uCDA9\uB3CC \u2014 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 (\uBA38\uC9C0\uD558\uC9C0 \uC54A\uC74C)":`\uCDA9\uB3CC \uD574\uC18C \uB514\uC2A4\uD328\uCE58 \uC2E4\uD328: ${l.reason||""}`,l.ok?"success":"error",2800);return}if(l.ok){Z("\uBA38\uC9C0 + \uC815\uB9AC \uC644\uB8CC","success",2e3);return}Z(l.cleanup_step?`\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uC2E4\uD328(${l.cleanup_step}): ${l.reason||""}`:`\uBA38\uC9C0 \uAC70\uBD80: ${l.reason||""}`,"error",3200)}}async function ae(d){if(!r||!d||!(typeof globalThis.confirm!="function"||globalThis.confirm(`${d}: PR\uC744 \uB2EB\uACE0 \uC6CC\uD06C\uD2B8\uB9AC/\uBE0C\uB79C\uCE58\uB97C \uD3D0\uAE30\uD569\uB2C8\uB2E4. \uB418\uB3CC\uB9B4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uB2E4\uC2DC \uC2E4\uD589\uD558\uB824\uBA74 \uD6C4\uBCF4 \uB808\uC778\uC5D0\uC11C \uB300\uAE30 \uB808\uC778\uC73C\uB85C \uC62E\uAE30\uC138\uC694. \uACC4\uC18D\uD560\uAE4C\uC694?`)))return;let b=await r("worker-pr-discard",{bead_id:d,expected_revision:oe()});if(ee(b),b&&b.conflict&&(b=await r("worker-pr-discard",{bead_id:d,expected_revision:oe()}),ee(b)),b&&b.discarded===!0){Z("\uD3D0\uAE30 \uC644\uB8CC \u2014 \uD6C4\uBCF4 \uB808\uC778\uC5D0\uC11C \uB2E4\uC2DC \uC2E4\uD589\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4","success",2400);return}b&&b.discarded===!1&&!b.conflict&&Z(`\uD3D0\uAE30 \uAC70\uBD80: ${b.reason||""}`,"error",2800)}async function Fe(d,l){if(!r||!l||B.has(l))return;B.add(l),ce();let b;try{b=await r(d,{bead_id:l,expected_revision:oe()}),ee(b),b&&b.conflict&&(b=await r(d,{bead_id:l,expected_revision:oe()}),ee(b))}finally{B.delete(l),ce()}if(!(!b||b.conflict)){if(b.ok){Z(d==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}Z(`\uCC98\uBD84 \uAC70\uBD80: ${b.reason||""}`,"error",3e3)}}async function rt(d){if(!r)return;let l=await r("worker-queue-toggle",{on:d,expected_revision:oe()});ee(l),l&&l.conflict&&await r("worker-queue-toggle",{on:d,expected_revision:oe()}).then(ee)}async function Ce(d){if(!r||!Number.isFinite(d))return;let l=Math.max(zr,Math.floor(d)),b=await r("worker-queue-set-slots",{slots:l,expected_revision:oe()});ee(b),b&&b.conflict&&await r("worker-queue-set-slots",{slots:l,expected_revision:oe()}).then(ee)}function Le(){let d=ke(),l=u?u.selectBoardColumn(Sl,"ready"):[],b=u?u.selectBoardColumn(Tl,"blocked"):[],v=d.bead_titles||{},T=new Map;for(let[C,j]of Object.entries(v))typeof j=="string"&&j.length>0&&T.set(C,j);for(let C of[...l,...b])T.set(C.id,C.title||C.id);let W=d.pr_wait||[],Q=d.pr_observations||{},P=d.pr_activity||{},ue=d.cleanup_failed||{},at=Object.entries(ue).map(([C,j])=>({bead_id:C,step:j&&j.step?j.step:"",reason:j&&j.reason?j.reason:"",detail:j&&typeof j.detail=="string"?j.detail:null,output_tail:j&&typeof j.output_tail=="string"&&j.output_tail?j.output_tail:void 0})),nt=d.queue||[],ft=new Set([...nt.map(C=>C.bead_id),...W.map(C=>C.bead_id),...d.done.map(C=>C.bead_id)]),Ke=new Set(b.map(C=>C.id)),te=i?i.get()?.order||{}:{},_e=new Set,m=[];for(let C of[...l,...b])ft.has(C.id)||_e.has(C.id)||Fl(C)||(_e.add(C.id),m.push(C));w=Pl(m,y,te);let k=d.admission||{},Y=C=>{let j=k[C];if(!j)return"";if(j.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let ne=typeof j.reason=="string"?j.reason:"",se=ne.indexOf(":");return se>0&&se<ne.length-1?`\u26D4 ${ne.slice(0,se)} (${ne.slice(se+1)})`:`\u26D4 ${ne}`},G=w.map(C=>{let j=Hn(C),ne=Ke.has(C.id),se=[];ne&&se.push(Bl(C)),j||se.push("spec \uC5C6\uC74C");let Vt=Y(C.id);return Vt&&se.push(Vt),{id:C.id,title:C.title||C.id,reason:se.join(" \xB7 "),draggable:j,lane:"candidate",workflow:C.workflow,status:C.status,blocked:ne,has_spec:j}}),J=Cl(G,$),be=J.visible,Ot=d.revise_parked||{},gr=(C,j)=>C.map(ne=>{let se=j==="queue"?Ot[ne.bead_id]:null;return{id:ne.bead_id,title:T.get(ne.bead_id)||ne.bead_id,reason:j==="done"?"":Y(ne.bead_id),draggable:j!=="done",done:j==="done",lane:j,badges:se?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!se,revise_action:!!se,revise_enabled:!!se&&!B.has(ne.bead_id),revise_title:se?se.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${se.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:j==="done"?Fn(d.attempts||{},ne.bead_id):null}}),We=d.attempts?Object.values(d.attempts):[],lt=new Set;for(let C of We)C&&typeof C.resumed_from=="string"&&C.resumed_from.length>0&&lt.add(C.resumed_from);let Wt=new Map;for(let C of We)Wt.set(C.bead_id,C.attempt_id);let Gt=new Map;for(let C of We)Gt.set(C.attempt_id,C);function jt(C){let j=new Set,ne=C;for(;ne&&!j.has(ne.attempt_id);){if(ne.conflict_resolution===!0)return!0;j.add(ne.attempt_id),ne=typeof ne.resumed_from=="string"&&ne.resumed_from.length>0&&Gt.get(ne.resumed_from)||null}return!1}let mt=[],Te=null;for(let C of We){let j=C.status==="paused"&&!lt.has(C.attempt_id);C.status==="running"||j?mt.push({bead_id:C.bead_id,attempt_id:C.attempt_id,title:T.get(C.bead_id)||C.bead_id,runner:C.runner||null,model:C.model||null,effort:C.effort||null,started_at:typeof C.started_at=="number"?C.started_at:null,resumed_from:C.resumed_from||null,paused:j,conflict_resolution:jt(C),can_pause:typeof C.session_id=="string"&&C.session_id.length>0,usage:C.usage||null}):(C.status==="failed"||C.status==="orphaned")&&!(Wt.get(C.bead_id)!==C.attempt_id)&&typeof C.dismissed_at!="number"&&(Te=C)}let Yt=null;if(Te){let C=typeof Te.session_id=="string"&&Te.session_id.length>0,j=lt.has(Te.attempt_id),ne=Te.cause_detail;Yt={repo:Te.repo||"",reason:Te.cause||Te.status,cause_detail:ne&&typeof ne.reason=="string"?{reason:ne.reason,command:typeof ne.command=="string"?ne.command:null}:null,resume_attempt_id:Te.attempt_id,resume_eligible:C&&!j,resume_reason:C?j?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let mr=new Set(mt.map(C=>C.bead_id)),vt=new Map;for(let C of mt)C.conflict_resolution&&(C.paused?vt.has(C.bead_id)||vt.set(C.bead_id,"paused"):vt.set(C.bead_id,"running"));let _r=mt.filter(C=>!C.paused).length,H=(d.workspace_info||{}).slots,f=typeof H=="number"?H:typeof d.slots=="number"?d.slots:zr,L=_r>f,q=gr(d.done,"done"),ge=0,Ee=0,we=!1;for(let C of q){let j=C.usage;j&&typeof j=="object"&&(Number.isFinite(j.input_tokens)&&(ge+=j.input_tokens,we=!0),Number.isFinite(j.output_tokens)&&(Ee+=j.output_tokens,we=!0))}let Be=we?Ht({input_tokens:ge,output_tokens:Ee}):null;return{queue:d,idToTitle:T,candidates:be,candidate_hidden:{blocked:J.hidden_blocked,spec:J.hidden_spec},running:mt,live_count:_r,slots:f,over_cap:L,failure:Yt,waiting:gr(nt.filter(C=>!mr.has(C.bead_id)),"queue"),pr_wait:W.map(C=>Wl(C.bead_id,T.get(C.bead_id)||C.bead_id,Q,ue[C.bead_id]||null,Fn(d.attempts||{},C.bead_id),P[C.bead_id]||(F.has(C.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),vt.get(C.bead_id)||null)),done:q,token_total:Be,cleanup_failures:at}}function $e(d){let l=d.waiting.length>0?d.waiting[0].id:"\u2014",b=p`<button
      type="button"
    ...
    >
      ...
      >`,W=p`<label class="worker-tgl worker-slots"
        >동시 실행
        <input
          type="number"
      ...
      >
        ...
        <div class="worker-ctrl__ops">${b}${W}</div>
      ...
      ${Q}`}function Ue(d){if(d.running.length===0&&d.pr_wait.length===0)return"";let l=d.running.some(b=>!b.paused);return p`<section
    ...
    >
      ...
      <div class="worker-filter__spec" role="group" aria-label="spec 필터">
        ${Rl.map(b=>p`<button
              type="button"
              class="worker-filter__chip${$.spec===b.value?" is-active":""}"
              data-spec=${b.value}
              aria-pressed=${$.spec===b.value?"true":"false"}
            >
              ${b.label}
            </button>`)}
      ...
      .value=${y}
    >
      ${Ll.map(d=>p`<option value=${d.value} ?selected=${y===d.value}>
            ${d.label}
          </option>`)}
        ...
        ${Ue(d)}
        ${kt({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:d.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:E.queue,preview:qo(d.waiting)})}
        ${l}
        ${kt({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:d.done,empty:"\uC644\uB8CC \uC5C6\uC74C",collapsible:!0,collapsed:E.done,preview:d.token_total||qo(d.done)})}
      </div>`:p`<div class="worker-lanes">
      ${l}
      ${kt({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:d.waiting,empty:"\uB4DC\uB798\uADF8\uB85C \uBC30\uCE58"})}
      ${kt({id:"worker-pane-running",lane:"running",title:`\uC2E4\uD589 \uC911 \xB7 \uC2AC\uB86F ${d.slots}`,items:d.running,live:d.running.some(b=>!b.paused),body:qn(d.running,Date.now(),N)})}
    ...
    </div>`}function De(d){E={...E,[d]:!E[d]},Nl(E),ce()}function ce(){let d=Le();de($e(d),A),de(ze(d),O)}function xe(){let d=document.querySelector(".app-header");if(!d)return;let l=()=>{let b=Math.round(d.getBoundingClientRect().height);D.style.setProperty("--worker-ribbon-top",`${b}px`)};if(l(),typeof ResizeObserver=="function"){let b=new ResizeObserver(l);b.observe(d),z.push(()=>b.disconnect())}else window.addEventListener("resize",l),z.push(()=>window.removeEventListener("resize",l))}function Oe(){if(typeof window.matchMedia!="function")return;let d=window.matchMedia(Ol);M=!!d.matches;let l=b=>{let v=!!(b&&typeof b.matches=="boolean"?b.matches:d.matches);v!==M&&(M=v,ce())};typeof d.addEventListener=="function"?(d.addEventListener("change",l),z.push(()=>d.removeEventListener("change",l))):typeof d.addListener=="function"&&(d.addListener(l),z.push(()=>d.removeListener(l)))}function He(d){let l=d.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!l)return;let b=l.dataset.beadId||"",v=l.dataset.lane||"";g={bead_id:b,from_lane:v};try{d.dataTransfer?.setData("text/plain",b),d.dataTransfer&&(d.dataTransfer.effectAllowed="move")}catch{}}function Me(d){let l=d.target?.closest?.(".worker-pane");if(!l)return;let b=l.dataset.lane||"";b!=="candidate"&&b!=="queue"||(d.preventDefault(),d.dataTransfer&&(d.dataTransfer.dropEffect="move"),l.classList.add("worker-pane--drag-over"))}function tt(d){d.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function it(d,l){let b=w.find(Q=>Q.id===d);if(!b)return;let v=w.filter(Q=>Q.id!==d),T=v.length;if(l){let Q=l.dataset.beadId;if(Q===d)return;let P=v.findIndex(ue=>ue.id===Q);P>=0&&(T=P)}let W=v.slice();W.splice(T,0,b),h.applyReorder(d,W,T)}function me(d){let l=d.target?.closest?.(".worker-pane");if(!l)return;d.preventDefault(),l.classList.remove("worker-pane--drag-over");let b=l.dataset.lane||"",v=g?.bead_id||d.dataTransfer?.getData("text/plain")||"",T=g?.from_lane||"";if(g=null,!v)return;let W=d.target?.closest?.(".worker-mini, .worker-card"),Q=Array.from(l.querySelectorAll(".worker-mini, .worker-card")),P=Q.length;if(W){let ue=Q.indexOf(W);ue>=0&&(P=ue)}if(l.classList.contains("worker-pane--collapsed")&&(P=Xe()),b==="candidate"){if(T==="candidate"){it(v,W);return}T==="queue"&&Ae(v);return}b==="queue"&&(T==="queue"?ve(v,P):qe(v,P))}function Ne(d){$=d,El(d),ce()}function Pe(d){y=d==="board"||d==="created"||d==="spec"?d:Hr,Dl(y),ce()}function Re(d){let l=d.target?.closest?.(".worker-filter__blocked");if(l){Ne({...$,show_blocked:l.checked});return}let b=d.target?.closest?.(".worker-sort");if(b){Pe(b.value||Hr);return}let v=d.target?.closest?.(".worker-slots__input");if(!v)return;let T=Number.parseInt(v.value,10);if(!Number.isFinite(T)){ce();return}Ce(T).then(ce)}function R(d){return d?{runner:d.runner||void 0,model:d.model||void 0,effort:d.effort||void 0,worktree:d.worktree||void 0,status:d.status||void 0,session_id:d.session_id||void 0}:{}}function I(d){let l=ke(),b=l.attempts?l.attempts[d]:null;N=d,S.hidden=!1,U.open({attempt_id:d,meta:R(b)}),ce()}function X(){if(!N)return;let d=ke(),l=d.attempts?d.attempts[N]:null;if(l){U.updateMeta(R(l));return}U.close()}function V(d){let l=d.target;if(l?.closest?.("#worker-exec-defaults-dialog"))return;if(l?.closest?.(".worker-exec-defaults-btn")){K.open();return}let b=l?.closest?.(".worker-banner__resume");if(b){let te=b.dataset.attemptId;te&&ot(te);return}let v=l?.closest?.(".worker-banner__dismiss");if(v){let te=v.dataset.attemptId;te&&he(te);return}if(l?.closest?.(".worker-play")){rt(!ke().auto_advance);return}let T=l?.closest?.(".worker-pane__hd--toggle");if(T){let te=T.dataset.lane;(te==="queue"||te==="done")&&De(te);return}let W=l?.closest?.(".worker-card__place");if(W){let te=W.dataset.beadId;te&&!W.disabled&&qe(te,Xe());return}let Q=l?.closest?.(".worker-filter__chip");if(Q){let te=Q.dataset.spec;(te==="all"||te==="with"||te==="without")&&Ne({...$,spec:te});return}let P=l?.closest?.(".worker-mini__merge");if(P){Je(P.dataset.beadId||"");return}let ue=l?.closest?.(".worker-mini__discard");if(ue){ae(ue.dataset.beadId||"");return}let at=l?.closest?.(".worker-mini__revise-fix");if(at){Fe("worker-revise-fix",at.dataset.beadId||"");return}let nt=l?.closest?.(".worker-mini__revise-approve");if(nt){Fe("worker-revise-approve",nt.dataset.beadId||"");return}if(l?.closest?.(".worker-mini__pr"))return;if(l?.closest?.(".rtile__stop")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&Qe(_e);return}if(l?.closest?.(".rtile__pause")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&fe(_e);return}if(l?.closest?.(".rtile__resume")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&ot(_e);return}if(l?.closest?.(".rtile__session")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&I(_e);return}if(l?.closest?.(".worker-drawer-overlay__backdrop")){U.close();return}if(l?.closest?.(".worker-drawer-host"))return;let ft=l?.closest?.(".rtile");if(ft){if(l?.closest?.(".rtile__id")){let _e=ft.dataset.beadId;_e&&Lt(_e).then(m=>{m?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let te=ft.dataset.beadId;te&&c&&c(te);return}let Ke=l?.closest?.(".worker-mini, .worker-card");if(Ke){let te=Ke.dataset.beadId;if(l?.closest?.(".worker-mini__id, .worker-card__id")){te&&Lt(te).then(_e=>{_e?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}te&&c&&c(te)}}return t.addEventListener("dragstart",He),t.addEventListener("dragover",Me),t.addEventListener("dragleave",tt),t.addEventListener("drop",me),t.addEventListener("click",V),t.addEventListener("change",Re),Oe(),xe(),u&&z.push(u.subscribe(ce)),s&&z.push(s.subscribe(()=>{ce(),X()})),ce(),{load(){ce()},destroy(){for(let d of z.splice(0))try{d()}catch{}t.removeEventListener("dragstart",He),t.removeEventListener("dragover",Me),t.removeEventListener("dragleave",tt),t.removeEventListener("drop",me),t.removeEventListener("click",V),t.removeEventListener("change",Re);try{U.destroy()}catch{}S.hidden=!0;try{K.destroy()}catch{}de(p``,t)}}}function Gn(t){if(!t)return"Unknown";let e=t.split("/").filter(Boolean);return e.length>0?e[e.length-1]:"Unknown"}function Wo(t,e,r,n=async()=>{},s=async()=>{}){let o=ye("views:workspace-picker"),i=null,c=!1,a=!1,u=!1;async function h(S){let _=S.target.value,N=e.getState().workspace?.current?.path||"";if(_&&_!==N){o("switching workspace to %s",_),c=!0,A();try{await r(_)}catch(U){o("workspace switch failed: %o",U)}finally{c=!1,A()}}}async function g(){let S=e.getState(),x=S.workspace?.current?.path||S.workspace?.available?.[0]?.path||"";if(!(!x||a)){o("git-pulling workspace %s",x),a=!0,A();try{await n(x)}catch(_){o("workspace git pull failed: %o",_)}finally{a=!1,A()}}}function w(S){let x=S.target;x&&t.contains(x)||E()}function $(S){S.key==="Escape"&&E()}function y(){u||(u=!0,document.addEventListener("mousedown",w),document.addEventListener("keydown",$),A())}function E(){u&&(u=!1,document.removeEventListener("mousedown",w),document.removeEventListener("keydown",$),A())}function M(){u?E():y()}async function F(S){let x=S.target,_=x.value,O=x.checked;o("toggling visibility %s \u2192 %s",_,String(O));try{await s(_,O)}catch(N){o("workspace visibility toggle failed: %o",N)}}function B(S){return S?p`
      <button
        type="button"
    ...
    `}function D(){let S=e.getState(),x=S.workspace?.current,_=S.workspace?.available||[],O=new Set(S.workspace?.hidden||[]),N=x?.path||_[0]?.path||"";if(_.length===0)return p``;let U=_.filter(K=>!O.has(K.path)||K.path===N);if(U.length<=1){let K=U[0]||_[0],ke=Gn(K.path);return p`
    ...
    `}function A(){de(D(),t)}return A(),i=e.subscribe(()=>A()),{destroy(){i&&(i(),i=null),document.removeEventListener("mousedown",w),document.removeEventListener("keydown",$),de(p``,t)}}}var Go=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-queue-set-slots","worker-queue-set-exec-default","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-pr-merge","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append"];function jn(){let t=Date.now().toString(36),e=Math.random().toString(36).slice(2,8);return`${t}-${e}`}function jo(t,e,r=jn()){return{id:r,type:t,payload:e}}function Yo(t={}){let e=ye("ws"),r={initialMs:t.backoff?.initialMs??1e3,maxMs:t.backoff?.maxMs??3e4,factor:t.backoff?.factor??2,jitterRatio:t.backoff?.jitterRatio??.2},n=()=>t.url&&t.url.length>0?t.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",i=0,c=null,a=!0,u=new Map,h=[],g=new Map,w=new Set;function $(D){for(let A of Array.from(w))try{A(D)}catch{}}function y(){if(!a||c)return;o="reconnecting",e("ws reconnecting\u2026"),$(o);let D=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,i)),A=(r.jitterRatio||0)*D,S=Math.max(0,Math.round(D+(Math.random()*2-1)*A));e("ws retry in %d ms (attempt %d)",S,i+1),c=setTimeout(()=>{c=null,z()},S)}function E(D){try{s?.send(JSON.stringify(D))}catch(A){e("ws send failed",A)}}function M(){for(o="open",e("ws open"),$(o),i=0;h.length;){let D=h.shift();D&&E(D)}}function F(D){let A;try{A=JSON.parse(String(D.data))}catch{e("ws received non-JSON message");return}if(!A||typeof A.id!="string"||typeof A.type!="string"){e("ws received invalid envelope");return}if(u.has(A.id)){let x=u.get(A.id);u.delete(A.id),A.ok?x?.resolve(A.payload):x?.reject(A.error||new Error("ws error"));return}let S=g.get(A.type);if(S&&S.size>0)for(let x of Array.from(S))try{x(A.payload)}catch(_){e("ws event handler error",_)}else e("ws received unhandled message type: %s",A.type)}function B(){o="closed",e("ws closed"),$(o);for(let[D,A]of u.entries())A.reject(new Error("ws disconnected")),u.delete(D);i+=1,y()}function z(){if(!a)return;let D=n();try{s=new WebSocket(D),e("ws connecting %s",D),o="connecting",$(o),s.addEventListener("open",M),s.addEventListener("message",F),s.addEventListener("error",()=>{}),s.addEventListener("close",B)}catch(A){e("ws connect failed %o",A),y()}}return z(),{send(D,A){if(!Go.includes(D))return Promise.reject(new Error(`unknown message type: ${D}`));let S=jn(),x=jo(D,A,S);return e("send %s id=%s",D,S),new Promise((_,O)=>{u.set(S,{resolve:_,reject:O,type:D}),s&&s.readyState===s.OPEN?E(x):(e("queue %s id=%s (state=%s)",D,S,o),h.push(x))})},on(D,A){g.has(D)||g.set(D,new Set);let S=g.get(D);return S?.add(A),()=>{S?.delete(A)}},onConnection(D){return w.add(D),()=>{w.delete(D)}},reconnect(){a=!0,c&&(clearTimeout(c),c=null),i=0,z()},close(){a=!1,c&&(clearTimeout(c),c=null);try{s?.close()}catch{}},getState(){return o}}}function Gl(){let t=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof t?.workspace_config?.default_workspace=="string"&&t.workspace_config.default_workspace.length>0?t.workspace_config.default_workspace:null}}}async function jl(t,e){try{let n=await(await fetch("/api/config")).json();t.setState({config:n})}catch(r){e("config refresh failed",r)}}var Yn=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],Vo=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"]],Ko="worker:queue",Zo="ui:order",Xo="ui:display-policy",yt="tab:board:closed",Qo="beads-ui.board.closed-range";function Yl(t){let e=ye("main");e("bootstrap start");let r=p`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;de(r,t);let n=document.getElementById("top-nav"),s=document.getElementById("board-root"),o=document.getElementById("worker-root"),i=document.getElementById("detail-panel");if(s&&o&&i){let _=function(m,k){let Y="Request failed",G="";if(m&&typeof m=="object"){let be=m;if(typeof be.message=="string"&&be.message.length>0&&(Y=be.message),typeof be.details=="string")G=be.details;else if(be.details&&typeof be.details=="object")try{G=JSON.stringify(be.details,null,2)}catch{G=""}}else typeof m=="string"&&m.length>0&&(Y=m);let J=k&&k.length>0?`Failed to load ${k}`:"Request failed";x.open(J,Y,G)},ae=function(m){return`${T.getState().workspace.current?.path||""}\0${m}`},Fe=function(){qe&&(qe().catch(()=>{}),qe=null),ve=null,Ae=null},Ce=function(m){Qe=m;let k=()=>{Qe!==m||T.getState().selected_id!==m||(Qe=null,rt(m))};if(!he){ot.then(k);return}k()},et=function(){let m=is(Ue);return m===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:m}}},Ie=function(m){if(m)for(let[k,Y]of Yn){if(Le.has(k)||$e.has(k))continue;let G=k===yt?et():{type:Y};try{K.register(k,G)}catch(J){e("register %s store failed: %o",k,J)}$e.add(k),U.subscribeList(k,G).then(J=>{Le.set(k,J)}).catch(J=>{e("subscribe %s failed: %o",k,J),_(J,"board")}).finally(()=>{$e.delete(k)})}else De()},De=function(){for(let[m]of Yn){let k=Le.get(m);k&&(k().catch(()=>{}),Le.delete(m));try{K.unregister(m)}catch(Y){e("unregister %s failed: %o",m,Y)}}},Oe=function(m){if(!m){He();return}for(let[k,Y]of Vo)if(!(ce.has(k)||$e.has(k))){try{K.register(k,{type:Y})}catch(G){e("register %s store failed: %o",k,G)}$e.add(k),U.subscribeList(k,{type:Y}).then(G=>{ce.set(k,G)}).catch(G=>{e("subscribe %s failed: %o",k,G),_(G,"worker")}).finally(()=>{$e.delete(k)})}xe||(N("subscribe-worker-queue",{id:Ko}).catch(k=>{e("subscribe-worker-queue failed: %o",k)}),xe=()=>N("unsubscribe-worker-queue",{id:Ko}))},He=function(){for(let[m]of Vo){let k=ce.get(m);k&&(k().catch(()=>{}),ce.delete(m));try{K.unregister(m)}catch(Y){e("unregister %s failed: %o",m,Y)}}xe&&(xe().catch(()=>{}),xe=null)},tt=function(){Me||(N("subscribe-ui-order",{id:Zo}).catch(m=>{e("subscribe-ui-order failed: %o",m)}),Me=()=>N("unsubscribe-ui-order",{id:Zo}))},it=function(){Me&&(Me().catch(()=>{}),Me=null),oe.clear()},Ne=function(){me||(N("subscribe-display-policy",{id:Xo}).catch(m=>{e("subscribe-display-policy failed: %o",m)}),me=()=>N("unsubscribe-display-policy",{id:Xo}))},Pe=function(){me&&(me().catch(()=>{}),me=null),ee.clear()},d=function(m){if(!m)return"Unknown";let k=m.split("/").filter(Boolean);return k.length>0?k[k.length-1]:"Unknown"};var c=_,a=ae,u=Fe,h=Ce,g=et,w=Ie,$=De,y=Oe,E=He,M=tt,F=it,B=Ne,z=Pe,D=d;let A=document.getElementById("header-loading"),S=Cs(A),x=Eo(t),O=Yo(),N=S.wrapSend((m,k)=>O.send(m,k)),U=vs(N),K=$s(),ke=Ss(),oe=xs(),ee=as(),Xe=ls();O.on("ui-order-snapshot",m=>{let k=m;if(k&&typeof k.revision=="number")try{oe.set({revision:k.revision,order:k.order&&typeof k.order=="object"?k.order:{}})}catch{}}),O.on("display-policy-snapshot",m=>{let k=m;if(k&&k.policy&&typeof k.policy=="object")try{ee.set(k.policy)}catch{}}),O.on("session-log-snapshot",m=>{let k=m;if(k&&typeof k.attempt_id=="string")try{Xe.set(k.attempt_id,Array.isArray(k.lines)?k.lines:[])}catch{}}),O.on("session-log-append",m=>{let k=m;if(k&&typeof k.attempt_id=="string")try{Xe.append(k.attempt_id,k.event)}catch{}}),O.on("snapshot",m=>{let k=m,Y=k&&typeof k.id=="string"?k.id:"",G=Y?K.getStore(Y):null;if(G&&k&&k.type==="snapshot")try{G.applyPush(k)}catch{}}),O.on("upsert",m=>{let k=m,Y=k&&typeof k.id=="string"?k.id:"",G=Y?K.getStore(Y):null;if(G&&k&&k.type==="upsert")try{G.applyPush(k)}catch{}}),O.on("delete",m=>{let k=m,Y=k&&typeof k.id=="string"?k.id:"",G=Y?K.getStore(Y):null;if(G&&k&&k.type==="delete")try{G.applyPush(k)}catch{}});let qe=null,ve=null,Ae=null,Qe=null,fe=()=>{},ot=new Promise(m=>{fe=()=>m(void 0)}),he=!1,Je=!1;async function rt(m){let k=ae(m);if(k===ve||k===Ae)return;Ae=k;let Y=`detail:${m}`,G={type:"issue-detail",params:{id:m}};try{K.register(Y,G)}catch(J){e("register detail store failed: %o",J)}try{let J=await U.subscribeList(Y,G);if(T.getState().selected_id!==m||ae(m)!==k){await J().catch(()=>{});return}qe&&await qe().catch(()=>{}),qe=J,ve=k}catch(J){e("detail subscribe failed: %o",J),_(J,"issue details")}finally{Ae===k&&(Ae=null)}}let Le=new Map,$e=new Set,Ue=wr;try{let m=window.localStorage.getItem(Qo);tn(m)&&(Ue=m)}catch{}async function ze(m){if(!tn(m)||m===Ue)return;Ue=m;try{window.localStorage.setItem(Qo,m)}catch{}let k=Le.get(yt);if(!k)return;Le.delete(yt),await k().catch(()=>{});let Y=et();try{K.register(yt,Y)}catch(G){e("register %s store failed: %o",yt,G)}try{let G=await U.subscribeList(yt,Y);Le.set(yt,G)}catch(G){e("re-subscribe %s failed: %o",yt,G),_(G,"board")}}let ce=new Map,xe=null,Me=null,me=null;async function Re(){me=null,ee.clear(),xe=null;let m=T.getState().workspace.current?.path;if(m)try{await O.send("set-workspace",{path:m})}catch(k){e("workspace restore after reconnect failed: %o",k);return}Ne(),Oe(T.getState().view==="worker")}async function R(){e("clearing all subscriptions for workspace switch"),De(),He(),ke.clear(),it(),tt(),Pe(),Ne(),Fe();let m=T.getState();if(m.selected_id)try{K.unregister(`detail:${m.selected_id}`)}catch{}let k=T.getState();Ie(k.view==="board"),Oe(k.view==="worker"),k.selected_id&&Ce(k.selected_id)}async function I(m){e("requesting workspace switch to %s",m),Je=!0;try{let k=await O.send("set-workspace",{path:m});e("workspace switch result: %o",k),k&&k.workspace&&(T.setState({workspace:{current:{path:k.workspace.root_dir,database:k.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",m),k.changed&&(await R(),Z("Switched to "+d(m),"success",2e3)))}catch(k){throw e("workspace switch failed: %o",k),Z("Failed to switch workspace","error",3e3),k}finally{Je=!1}}async function X(m){e("requesting workspace git pull for %s",m);try{let k=await O.send("git-pull-workspace",{});e("workspace git pull result: %o",k);let Y=k?.status;if(Y==="up_to_date"){Z("Already up to date","success",2e3);return}if(Y==="stash_pop_conflict"){Z("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}Z("Git pulled "+d(m),"success",2e3)}catch(k){e("workspace git pull failed: %o",k);let Y=k?.code,G=k?.message;if(Y==="rebase_conflict"){Z("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(Y==="rebase_conflict_abort_failed"){Z("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(Y==="busy"){Z("Git pull skipped: another operation is running","warning",3e3);return}let J=G?`: ${G}`:"";throw Z(`Git pull failed${J}`,"error",3e3),k}}async function V(m,k){e("setting workspace visibility %s \u2192 %s",m,String(k));try{await O.send("set-workspace-visibility",{path:m,visible:k}),await l()}catch(Y){e("workspace visibility update failed: %o",Y),Z("Failed to update project visibility","error",3e3)}}async function l(){try{let m=await O.send("list-workspaces",{});if(e("workspaces loaded: %o",m),m&&Array.isArray(m.workspaces)){let k=m.workspaces.map(be=>({path:be.path,database:be.database,pid:be.pid,version:be.version})),Y=m.current?{path:m.current.root_dir,database:m.current.db_path}:null,G=Array.isArray(m.hidden)?m.hidden.filter(be=>typeof be=="string"):[];T.setState({workspace:{current:Y,available:k,hidden:G}});let J=window.localStorage.getItem("beads-ui.workspace");J&&(!k.some(Ot=>Ot.path===J)||G.includes(J)?window.localStorage.removeItem("beads-ui.workspace"):Y&&J!==Y.path&&(e("restoring saved workspace preference: %s",J),await I(J)))}}catch(m){e("failed to load workspaces: %o",m)}}O.on("workspace-changed",m=>{e("workspace-changed event: %o",m),m&&m.root_dir&&(T.setState({workspace:{current:{path:m.root_dir,database:m.db_path}}}),l(),R())});let b=!1;if(typeof O.onConnection=="function"){let m=k=>{e("ws state %s",k),k==="reconnecting"||k==="closed"?(b=!0,Z("Connection lost. Reconnecting\u2026","error",4e3)):k==="open"&&b&&(b=!1,Z("Reconnected","success",2200),jl(T,(Y,G)=>{e(`${Y}: %o`,G)}),Re())};O.onConnection(m)}let v="board";try{let m=window.localStorage.getItem("beads-ui.view");(m==="board"||m==="worker")&&(v=m)}catch(m){e("view parse error: %o",m)}let T=Es({config:Gl(),view:v});O.on("worker-queue-snapshot",m=>{let k=m;if(!k||!k.queue)return;let Y=T.getState().workspace.current?.path;if(typeof Y=="string"&&Y.length>0&&k.root_dir!==Y){e("dropping worker-queue snapshot for %s",String(k.root_dir));return}try{ke.set(k.queue)}catch{}});let W=Ts(T);W.start();let Q=async(m,k)=>{try{return await N(m,k)}catch{return[]}};n&&Co(n,T,W);let P=document.getElementById("workspace-picker");P&&Wo(P,T,I,X,V);let ue=Do(t,(m,k)=>N(m,k));try{let m=document.getElementById("new-issue-btn");m&&m.addEventListener("click",()=>ue.open())}catch{}let at=Ao(t,{policyStore:ee,transport:(m,k)=>N(m,k),labelOptions:()=>{let m=new Set;for(let[k]of Yn)for(let Y of K.snapshotFor(k)||[]){let G=Y.labels;if(Array.isArray(G))for(let J of G)typeof J=="string"&&J.length>0&&m.add(J)}return Array.from(m).sort()}});try{let m=document.getElementById("display-settings-btn");m&&m.addEventListener("click",()=>at.open())}catch{}let nt=Ns(s,{gotoIssue:m=>W.gotoIssue(m),issueStores:K,transport:Q,uiOrderStore:oe,displayPolicyStore:ee,closedRange:Ue,onClosedRangeChange:m=>{ze(m)},onNewIssue:()=>ue.open()}),ft=Wn(o,{transport:Q,issueStores:K,queueStore:ke,sessionLogStore:Xe,uiOrderStore:oe,gotoIssue:m=>T.setState({selected_id:m}),getWorkspacePath:()=>T.getState().workspace.current?.path}),Ke=So(i,{issueStores:K,transport:Q,queueStore:ke,sessionLogStore:Xe,getWorkspacePath:()=>T.getState().workspace.current?.path,onNavigate:m=>{T.getState().view==="worker"?T.setState({selected_id:m}):W.gotoIssue(m)},onClose:()=>{let m=T.getState();T.setState({selected_id:null});try{W.gotoView(m.view==="worker"?"worker":"board")}catch{}}}),te=T.getState().selected_id;te&&(i.hidden=!1,Ke.load(te),Ce(te)),T.subscribe(m=>{let k=m.selected_id;k?(i.hidden=!1,Ke.load(k),Je||Ce(k)):(Ke.clear(),i.hidden=!0,Fe())});let _e=m=>{s.hidden=m.view!=="board",o.hidden=m.view!=="worker",Ie(m.view==="board"),Oe(m.view==="worker"),!m.selected_id&&m.view==="board"&&nt.load(),m.view==="worker"&&ft.load(),window.localStorage.setItem("beads-ui.view",m.view)};T.subscribe(_e),_e(T.getState()),tt(),Ne(),l().finally(()=>{he=!0,fe()}),window.addEventListener("keydown",m=>{let k=m.ctrlKey||m.metaKey,Y=String(m.key||"").toLowerCase(),G=m.target,J=G&&G.tagName?String(G.tagName).toLowerCase():"",be=J==="input"||J==="textarea"||J==="select"||G&&typeof G.isContentEditable=="boolean"&&G.isContentEditable;k&&Y==="n"&&(be||(m.preventDefault(),ue.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let t=document.getElementById("theme-switch");t&&t.addEventListener("change",()=>{let r=t.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let e=document.getElementById("app");e&&Yl(e)});export{Yl as bootstrap,Gl as readBootstrapConfig,jl as refreshConfigSnapshot};
