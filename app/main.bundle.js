...
`)}function $(){if(!o)return d``;let S=f(),m=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),N=i.session_id||"",P=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`;return d`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
${u}`:u,s=s?`${s}
${f}`:f;let _=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(f,o,!0),this.lexer.state.top=_,r.length===0)break;let w=o.at(-1);if(w?.type==="code")break;if(w?.type==="blockquote"){let $=w,y=$.raw+`
`+r.join(`
...
`,1)[0],$=!_.trim(),y=0;if(this.options.pedantic?(y=2,f=_.trimStart()):$?y=e[1].length+1:(y=e[2].search(this.rules.other.nonSpaceChar),y=y>4?1:y,f=_.slice(y),y+=e[1].length),$&&this.rules.other.blankLine.test(w)&&(u+=w+`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+kt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},Pt=new gl;function ce(t,e){return Pt.parse(t,e)}ce.options=ce.setOptions=function(t){return Pt.setOptions(t),ce.defaults=Pt.defaults,bo(ce.defaults),ce};ce.getDefaults=Mn;ce.defaults=Ft;ce.use=function(...t){return Pt.use(...t),ce.defaults=Pt.defaults,bo(ce.defaults),ce};ce.walkTokens=function(t,e){return Pt.walkTokens(t,e)};ce.parseInline=Pt.parseInline;ce.Parser=mt;ce.parser=mt.parse;ce.Renderer=Wr;ce.TextRenderer=Hn;ce.Lexer=gt;ce.lexer=gt.lex;ce.Tokenizer=Hr;ce.Hooks=_r;ce.parse=ce;var Ad=ce.options,Td=ce.setOptions,Ed=ce.use,Cd=ce.walkTokens,Rd=ce.parseInline;var Ld=mt.parse,Id=gt.lex;function Co(t){let e=ce.parse(t),r=ao.sanitize(e);return uo(r)}function ml(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function Ro(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",c="";function a(y){y.key==="Escape"&&s&&(y.preventDefault(),w())}document.addEventListener("keydown",a);function u(){return s?d`
    ...
    `:d``}function f(){de(u(),t)}async function _(y){s=y,o="loading",i="",c="",f();let E=r?r():"";if(!E){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",f();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",f();return}let M="/api/doc?workspace="+encodeURIComponent(E)+"&path="+encodeURIComponent(y);try{let F=await n(M),B=await F.json().catch(()=>({}));if(!F.ok||!B||B.ok!==!0){o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(B&&B.error||F.status)+")",f();return}i=String(B.content||""),o="ready",f()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",f()}}function w(){s=null,de(d``,t)}function $(){document.removeEventListener("keydown",a),w()}return{open:_,close:w,destroy:$}}var _l={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function bl(t){if(typeof t!="number"||!Number.isFinite(t))return"";let e=new Date(t),r=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${r}:${n}`}function Lo(t,e={}){let r=Array.isArray(t)?t:[];if(r.length===0)return d`
      <div class="detail-section-label">세션 이력</div>
      <div class="detail-empty" data-seam="session-history">세션 이력 없음</div>
    `;let n=new Set;for(let i of r)i&&typeof i.resumed_from=="string"&&i.resumed_from.length>0&&n.add(i.resumed_from);let s=i=>{if(!(i.status==="failed"||i.status==="orphaned"))return"";let a=typeof i.session_id=="string"&&i.session_id.length>0,u=n.has(i.attempt_id),f=a&&!u,_=a?u?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":"\uC774 \uC138\uC158\uC744 \uAC19\uC740 \uC6CC\uD06C\uD2B8\uB9AC\uC5D0\uC11C \uC774\uC5B4\uC11C \uC9C4\uD589":"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00";return d`<button
      type="button"
  ...
  `}var wl=["open","in_progress","deferred","resolved","closed"],kl=[0,1,2,3,4];function Io(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,c=e.sessionLogStore,a=null,u=null,f={},_=!1,w=!1,$="",y="",E="";function M(){_=!1,w=!1,$="",y="",E=""}let F=document.createElement("div");F.className="md-viewer-root",document.body.appendChild(F);let B=Ro(F,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),q=document.createElement("div");q.className="session-log-root",document.body.appendChild(q);let D=Or(q,{transport:s?(k,L)=>Promise.resolve(s(k,L)):void 0,sessionLogStore:c});function T(){if(!i||!a)return[];let k=i.get();return(k&&k.attempts?Object.values(k.attempts):[]).filter(x=>x&&x.bead_id===a).sort((x,l)=>(l.started_at||0)-(x.started_at||0)).map(x=>({attempt_id:x.attempt_id,bead_id:x.bead_id,status:x.status,started_at:typeof x.started_at=="number"?x.started_at:null,runner:x.runner||null,model:x.model||null,session_id:x.session_id||null,resumed_from:x.resumed_from||null,dismissed_at:typeof x.dismissed_at=="number"?x.dismissed_at:null,cause:typeof x.cause=="string"?x.cause:null,cause_detail:x.cause_detail||null}))}function A(k){let L=i?i.get():null,x=L&&L.attempts?L.attempts[k]:null;D.open({attempt_id:k,meta:x?{runner:x.runner||void 0,model:x.model||void 0,effort:x.effort||void 0,status:x.status||void 0,session_id:x.session_id||void 0}:{}})}async function S(k){if(!s||!k)return;let L=()=>{let l=i?i.get():null;return l&&typeof l.revision=="number"?l.revision:0},x=await s("worker-attempt-resume",{attempt_id:k,expected_revision:L()});if(x&&x.conflict){let l=x.queue&&typeof x.queue.revision=="number"?x.queue.revision:L();x=await s("worker-attempt-resume",{attempt_id:k,expected_revision:l})}x&&x.resumed===!1&&!x.conflict&&x.reason&&Q(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${x.reason}`,"error",2400)}let m={onOpen:A,onResume:S};function N(){let k=i?i.get():null,L=k&&k.exec_defaults;return L&&typeof L=="object"?L:{}}let P=null;r&&r.subscribe&&(P=r.subscribe(()=>we()));let z=null;i&&typeof i.subscribe=="function"&&(z=i.subscribe(()=>{a&&Z()}));function X(k){k.key==="Escape"&&a&&(k.preventDefault(),n())}document.addEventListener("keydown",X);function we(){if(a){if(r&&typeof r.snapshotFor=="function"){let k=r.snapshotFor("detail:"+a)||[];u=k.find(x=>x&&x.id===a)||k[0]||u}Z()}}function oe(k){Nt(k).then(L=>{L?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ne(k){k.preventDefault(),k.stopPropagation(),a&&oe(a)}function tt(k,L){k.preventDefault(),k.stopPropagation(),oe(L)}function He(k,L){k.preventDefault(),k.stopPropagation(),B.open(L)}function Se(k,L){f[k]=L,Z(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:k,value:L})).catch(()=>{Q("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function Ee(k,L,x){if(!s||!a)return!1;try{let l=await Promise.resolve(s(k,L)),g=Array.isArray(l)?l[0]:l;return g&&typeof g=="object"&&g.id?(u=g,!0):(Q(x,"error"),!1)}catch{return Q(x,"error"),!1}}function rt(k){setTimeout(()=>{try{let L=t.querySelector(k);L&&typeof L.focus=="function"&&L.focus()}catch{}},0)}function pe(){_=!0,$=u&&u.title||"",Z(),rt('.detail-edit__input[data-edit="title"]')}function dt(k){$=k.target.value}function fe(){_=!1,$="",Z()}function Be(){Ee("edit-text",{id:a,field:"title",value:$},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(L=>{L&&(_=!1,$=""),Z()})}function le(){w=!0,y=u&&u.description||"",Z(),rt('.detail-edit__textarea[data-edit="description"]')}function We(k){y=k.target.value}function ot(){w=!1,y="",Z()}function Re(){Ee("edit-text",{id:a,field:"description",value:y},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(L=>{L&&(w=!1,y=""),Z()})}function Me(k,L,x,l){if(k.key==="Escape"){k.stopPropagation(),x();return}k.key==="Enter"&&(!l||k.ctrlKey||k.metaKey)&&(k.preventDefault(),L())}function ke(k){let L=k.target.value;Ee("update-status",{id:a,status:L},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>Z())}function Ge(k){let L=Number(k.target.value);Ee("update-priority",{id:a,priority:L},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>Z())}function nt(k){E=k.target.value}function Ne(){let k=E.trim();k.length!==0&&Ee("label-add",{id:a,label:k},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(L=>{L&&(E=""),Z()})}function je(k){if(k.key==="Escape"){k.stopPropagation(),E="",Z();return}k.key==="Enter"&&(k.preventDefault(),Ne())}function Pe(k){Ee("label-remove",{id:a,label:k},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>Z())}let Qe={onCopyPath:tt,onOpenDoc:He},Ae={onChange:Se};function Le(k){return typeof k=="string"?k:k&&typeof k=="object"?String(k.id||k.to||k.issue_id||k.depends_on||""):""}function Je(k){switch(k&&typeof k=="object"?String(k.dependency_type||k.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Ue(k){let x=(Array.isArray(k.dependencies)?k.dependencies:[]).map(l=>({id:Le(l),icon:Je(l)})).filter(l=>l.id.length>0);return d`
    ...
    `}let ut={route:["spec_backed","full_plan"]};async function _e(k,L){let x=L.target.value;if(k==="route"&&u&&u.metadata&&u.metadata.route==="full_plan"&&x!=="full_plan"&&!window.confirm(`full_plan \u2192 ${x||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){Z();return}await Ee("update-workflow-meta",{id:a,key:k,value:x},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),Z()}function Fe(k){let L=k.metadata||{};return d` ${((l,g)=>{let v=ut[l],ee=typeof L[l]=="string"?L[l]:"";return d`<div class="detail-kv">
      ...
      </div>`})("route","(\uBBF8\uC124\uC815 \xB7 \uCD94\uB860)")} `}function Ie(k){return _?d`
    ...
    `}function Z(){de(V(),t)}return{load(k){k!==a&&(f={},M()),a=k,u=null,we()},clear(){a=null,u=null,f={},M(),B.close(),D.close(),de(d``,t)},destroy(){P&&(P(),P=null),z&&(z(),z=null),document.removeEventListener("keydown",X),B.destroy(),F.parentNode&&F.parentNode.removeChild(F),D.destroy(),q.parentNode&&q.parentNode.removeChild(q),a=null,u=null,de(d``,t)}}}var yl=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Do(t,e){return fn(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function vl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function Oo(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function c(A){let S=r.get();if(S)try{let m=await n("display-policy-set",{expected_revision:S.revision,policy:A(S)});a(m),m&&m.conflict&&m.policy&&(m=await n("display-policy-set",{expected_revision:m.policy.revision,policy:A(m.policy)}),a(m)),m&&m.conflict&&Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(A){A&&A.policy&&typeof A.policy=="object"&&r.set(A.policy)}function u(A){let S=r.get();if(!S)return;let m=Do(A,S)!=="shown";c(N=>vl(A,N,m))}function f(){let A=i.trim();A.length!==0&&(i="",c(S=>S.hidden_prefixes.includes(A)?{hidden_prefixes:S.hidden_prefixes}:{hidden_prefixes:[...S.hidden_prefixes,A]}),M())}function _(A){c(S=>({hidden_prefixes:S.hidden_prefixes.filter(m=>m!==A)}))}function w(A){let S=r.get();if(!S)return;let m=S.chips[A]===!1;c(()=>({chips:{[A]:m}}))}function $(A){let S=s();return d`
      <section class="display-settings__section">
        ...
        ${S.length===0?d`<div class="display-settings__empty">라벨 없음</div>`:d`<div class="display-settings__pills">
              ${S.map(m=>{let N=Do(m,A);return d`<button
                  type="button"
    ...
    `}function E(A){return d`
      <section class="display-settings__section">
        ...
        <div class="display-settings__toggles">
          ${yl.map(([S,m])=>d`<label class="display-settings__toggle">
                <input
                  type="checkbox"
                  data-chip=${S}
                  .checked=${A.chips[S]!==!1}
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),c=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),f=r.querySelector("#btn-cancel"),_=r.querySelector("#btn-create"),w=r.querySelector(".new-issue__close");function $(){o.replaceChildren();let T=document.createElement("option");T.value="",T.textContent="\u2014 Select \u2014",o.appendChild(T);for(let A of Po){let S=document.createElement("option");S.value=A,S.textContent=Fo(A),o.appendChild(S)}i.replaceChildren();for(let A=0;A<=4;A+=1){let S=document.createElement("option");S.value=String(A);let m=qo[A]||"Medium";S.textContent=`${A} \u2013 ${m}`,i.appendChild(S)}}$();function y(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function E(T){s.disabled=T,o.disabled=T,i.disabled=T,c.disabled=T,a.disabled=T,f.disabled=T,_.disabled=T,_.textContent=T?"Creating\u2026":"Create"}function M(){u.textContent=""}function F(T){u.textContent=T}function B(){try{let T=window.localStorage.getItem("beads-ui.new.type");T?o.value=T:o.value="";let A=window.localStorage.getItem("beads-ui.new.priority");A&&/^\d$/.test(A)?i.value=A:i.value="2"}catch{o.value="",i.value="2"}}function q(){let T=o.value||"",A=i.value||"";T.length>0&&window.localStorage.setItem("beads-ui.new.type",T),A.length>0&&window.localStorage.setItem("beads-ui.new.priority",A)}async function D(){M();let T=String(s.value||"").trim();if(T.length===0){F("Title is required"),s.focus();return}let A=Number(i.value||"2");if(!(A>=0&&A<=4)){F("Priority must be 0..4"),i.focus();return}let S=String(o.value||""),m=String(a.value||""),N={title:T};S.length>0&&(N.type=S),String(A).length>0&&(N.priority=A),m.length>0&&(N.description=m),E(!0);try{await e("create-issue",N)}catch{E(!1),F("Failed to create issue");return}q(),E(!1),y()}return r.addEventListener("cancel",T=>{T.preventDefault(),y()}),w.addEventListener("click",()=>y()),f.addEventListener("click",()=>y()),r.addEventListener("keydown",T=>{T.key==="Enter"&&(T.ctrlKey||T.metaKey)&&(T.preventDefault(),D())}),n.addEventListener("submit",T=>{T.preventDefault(),D()}),{open(){n.reset(),M(),B();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){y()}}}function Uo(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function zo(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var $l={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},xl=[{key:"orchestration_model",values:()=>bn},{key:"orchestration_effort",values:()=>wn},{key:"review_model",values:()=>kn},{key:"impl_model",values:()=>yn}];function Ho(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function c(){let m=i();return typeof m.revision=="number"?m.revision:0}function a(){let m=i().exec_defaults;return m&&typeof m=="object"?m:{}}function u(m){m&&m.queue&&r&&r.set(m.queue)}async function f(m,N){if(!n)return;let P={key:m,value:N||null};try{let z=await n("worker-queue-set-exec-default",{...P,expected_revision:c()});u(z),z&&z.conflict&&(z=await n("worker-queue-set-exec-default",{...P,expected_revision:c()}),u(z)),z&&z.conflict&&Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function _(m,N,P){let z=!!P&&!N.includes(P);return d`<div class="exec-defaults__row">
    ...
    </div>`}function w(){let m=i().workspace_info;return m&&typeof m=="object"?m:{}}function $(m,N){return d`<span
      class="exec-defaults__vd-badge exec-defaults__vd-badge--${m}"
      >${N}</span
    >`}function y(m){let N=m?zo(m.cmd):"",P=m?Uo(m.timeout_ms):"",z=s&&s()||"<workspace \uACBD\uB85C>";return d`<div class="exec-defaults__vd-group" data-vd="verify">
    ...
    </div>`}function E(m){let N=m?zo(m.cmd):"",P=m?Uo(m.timeout_ms):"",z=P?`timeout ${P} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",X=s&&s()||"<workspace \uACBD\uB85C>";return d`<div class="exec-defaults__vd-group" data-vd="deploy">
    ...
    </div>`}function M(m){if(!m||typeof m!="object")return"";let N=$l[String(m.outcome)];if(!N)return"";let P=m.outcome==="failed"&&m.reason?`${N.label} \xB7 ${m.reason}`:N.label,z=[$t(m.at),typeof m.bead_id=="string"?m.bead_id:"",typeof m.base_sha=="string"?m.base_sha.slice(0,7):""].filter(X=>X.length>0).join(" \xB7 ");return d`<div class="exec-defaults__vd-group" data-vd="last-deploy">
      ...
      ${M(m.last_deploy)}
        ...
        <div class="exec-defaults__container">
          ...
          <div class="exec-defaults__body">
            ...
            ${xl.map(N=>_(N.key,N.values(),m[N.key]||""))}
            ${F(w())}
          </div>
        </div>
...
${Sl}`:r}function Wn(t,e){let r=null;for(let n of Object.values(t||{}))n&&n.bead_id===e&&(r=n.usage||null);return r}function Gn(t){let e=t.draggable&&!t.done,r=Array.isArray(t.badges)?t.badges:[],n=Zt(t.usage),s=t.merge_step||null,o=t.lane==="pr_wait"||!!t.revise_action,i=e?d`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",c=d`<span class="worker-mini__id" title="클릭하면 ID 복사"
  ...
  >`,a=d`<span class="worker-mini__title">${t.title}</span>`,u=t.pr_url&&t.pr_number?d`<a
        ...
        >`:d`<span
          ...
          >${q}</span
        >`),_=t.reason?d`<span class="worker-mini__reason">${t.reason}</span>`:"",w=n?d`<span class="worker-usage" title=${Yr(t.usage)}
        >${n}</span
...
${qe.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:Y==="done"?Wn(l.attempts||{},ie.bead_id):null}}),Tt=l.attempts?Object.values(l.attempts):[],st=new Set;for(let C of Tt)C&&typeof C.resumed_from=="string"&&C.resumed_from.length>0&&st.add(C.resumed_from);let Xt=new Map;for(let C of Tt)Xt.set(C.bead_id,C.attempt_id);let Qt=new Map;for(let C of Tt)Qt.set(C.attempt_id,C);function $r(C){let Y=new Set,ie=C;for(;ie&&!Y.has(ie.attempt_id);){if(ie.conflict_resolution===!0)return!0;Y.add(ie.attempt_id),ie=typeof ie.resumed_from=="string"&&ie.resumed_from.length>0&&Qt.get(ie.resumed_from)||null}return!1}let yt=[],at=null;for(let C of Tt){let Y=C.status==="paused"&&!st.has(C.attempt_id);C.status==="running"||Y?yt.push({bead_id:C.bead_id,attempt_id:C.attempt_id,title:re.get(C.bead_id)||C.bead_id,runner:C.runner||null,model:C.model||null,effort:C.effort||null,started_at:typeof C.started_at=="number"?C.started_at:null,resumed_from:C.resumed_from||null,paused:Y,conflict_resolution:$r(C),can_pause:typeof C.session_id=="string"&&C.session_id.length>0,usage:C.usage||null}):(C.status==="failed"||C.status==="orphaned")&&!(Xt.get(C.bead_id)!==C.attempt_id)&&typeof C.dismissed_at!="number"&&(at=C)}let W=null;if(at){let C=typeof at.session_id=="string"&&at.session_id.length>0,Y=st.has(at.attempt_id),ie=at.cause_detail;W={repo:at.repo||"",reason:at.cause||at.status,cause_detail:ie&&typeof ie.reason=="string"?{reason:ie.reason,command:typeof ie.command=="string"?ie.command:null}:null,resume_attempt_id:at.attempt_id,resume_eligible:C&&!Y,resume_reason:C?Y?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let p=new Set(yt.map(C=>C.bead_id)),I=Array.isArray(l.merge_queue)?l.merge_queue:[],U=new Map;I.forEach((C,Y)=>{C&&typeof C.bead_id=="string"&&U.set(C.bead_id,Y+1)});let ge=l.merge_queue_state||{active:null,failures:{}},Oe=ge.failures||{},me=new Map;for(let C of yt)C.conflict_resolution&&(C.paused?me.has(C.bead_id)||me.set(C.bead_id,"paused"):me.set(C.bead_id,"running"));let lt=yt.filter(C=>!C.paused).length,bt=(l.workspace_info||{}).slots,Ut=typeof bt=="number"?bt:typeof l.slots=="number"?l.slots:Vr,Ce=lt>Ut,Jt=Bt(l.done,"done"),er=0,es=0,Zr=!1;for(let C of Jt){let Y=C.usage;Y&&typeof Y=="object"&&(Number.isFinite(Y.input_tokens)&&(er+=Y.input_tokens,Zr=!0),Number.isFinite(Y.output_tokens)&&(es+=Y.output_tokens,Zr=!0))}let ii=Zr?Zt({input_tokens:er,output_tokens:es}):null;return{queue:l,idToTitle:re,candidates:yr,candidate_hidden:{blocked:pt.hidden_blocked,spec:pt.hidden_spec},running:yt,live_count:lt,slots:Ut,over_cap:Ce,failure:W,waiting:Bt(h.filter(C=>!p.has(C.bead_id)),"queue"),pr_wait:ye.map(C=>ec(C.bead_id,re.get(C.bead_id)||C.bead_id,ve,ze[C.bead_id]||null,Wn(l.attempts||{},C.bead_id),$e[C.bead_id]||(F.has(C.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),me.get(C.bead_id)||null,C.external===!0,{position:U.get(C.bead_id)||0,active:ge.active===C.bead_id,failure:Oe[C.bead_id]||null},C.wt_present!==!1)),merge_queue_length:I.length,merge_queue_running:I.length>0,done:Jt,token_total:ii,cleanup_failures:_t}}function je(l){let g=l.waiting.length>0?l.waiting[0].id:"\u2014",v=d`<button
    ...
    >
      ...
      >
        ⚙
      </button>`,ve=jo({failure:l.failure,cleanupFailures:l.cleanup_failures});return M?d`<div class="worker-ribbon">
          ${v}
    ...
    >
      ...
      .value=${y}
    >
      ${Bl.map(l=>d`<option value=${l.value} ?selected=${y===l.value}>
            ${l.label}
          </option>`)}
    ...
    >
      일괄 머지 ${g}
    </button>`}function Je(l){let g=St({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:l.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Ae(),controls:Qe(l)});return M?d`<div class="worker-lanes worker-lanes--mobile">
        ${Pe(l)}
    ...
    `}function D(){let A=e.getState(),S=A.workspace?.current,m=A.workspace?.available||[],N=new Set(A.workspace?.hidden||[]),P=S?.path||m[0]?.path||"";if(m.length===0)return d``;let z=m.filter(X=>!N.has(X.path)||X.path===P);if(z.length<=1){let X=z[0]||m[0],we=Xn(X.path);return d`
