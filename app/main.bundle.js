...
`)}function ue(){if(!o)return l``;let Q=Ee(),ee=(a?[g.agent_type,g.model,g.effort]:[g.runner,g.model,g.effort]).filter(Boolean).join(" \xB7 "),Oe=g.session_id||"",Ne=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${y?"ON":"OFF"}`,Te=z(),Pe=Te?qg(ke(),Date.now()):"",Fe=Te?Ae(Q):null,ot=Te?ye(Q):null,nt=Ng(Q);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
        <span class="sv__id"
