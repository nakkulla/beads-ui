...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+gt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},It=new al;function le(t,e){return It.parse(t,e)}le.options=le.setOptions=function(t){return It.setOptions(t),le.defaults=It.defaults,uo(le.defaults),le};le.getDefaults=Cn;le.defaults=Dt;le.use=function(...t){return It.use(...t),le.defaults=It.defaults,uo(le.defaults),le};le.walkTokens=function(t,e){return It.walkTokens(t,e)};le.parseInline=It.parseInline;le.Parser=pt;le.parser=pt.parse;le.Renderer=Fr;le.TextRenderer=Pn;le.Lexer=ut;le.lexer=ut.lex;le.Tokenizer=Pr;le.Hooks=ur;le.parse=le;var _d=le.options,bd=le.setOptions,wd=le.use,kd=le.walkTokens,yd=le.parseInline;var vd=pt.parse,$d=ut.lex;function vo(t){let e=le.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",c="";function a(y){y.key==="Escape"&&s&&(y.preventDefault(),w())}document.addEventListener("keydown",a);function u(){return s?p`
  ...
  `}var ul=["open","in_progress","deferred","resolved","closed"],pl=[0,1,2,3,4];function So(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,c=e.sessionLogStore,a=null,u=null,h={},g=!1,w=!1,v="",y="",C="";function M(){g=!1,w=!1,v="",y="",C=""}let P=document.createElement("div");P.className="md-viewer-root",document.body.appendChild(P);let B=$o(P,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),q=document.createElement("div");q.className="session-log-root",document.body.appendChild(q);let D=Er(q,{transport:s?(l,b)=>Promise.resolve(s(l,b)):void 0,sessionLogStore:c});function A(){if(!i||!a)return[];let l=i.get();return(l&&l.attempts?Object.values(l.attempts):[]).filter($=>$&&$.bead_id===a).sort(($,T)=>(T.started_at||0)-($.started_at||0)).map($=>({attempt_id:$.attempt_id,bead_id:$.bead_id,status:$.status,started_at:typeof $.started_at=="number"?$.started_at:null,runner:$.runner||null,model:$.model||null,session_id:$.session_id||null,resumed_from:$.resumed_from||null,dismissed_at:typeof $.dismissed_at=="number"?$.dismissed_at:null,cause:typeof $.cause=="string"?$.cause:null,cause_detail:$.cause_detail||null}))}function S(l){let b=i?i.get():null,$=b&&b.attempts?b.attempts[l]:null;D.open({attempt_id:l,meta:$?{runner:$.runner||void 0,model:$.model||void 0,effort:$.effort||void 0,status:$.status||void 0,session_id:$.session_id||void 0}:{}})}async function x(l){if(!s||!l)return;let b=()=>{let T=i?i.get():null;return T&&typeof T.revision=="number"?T.revision:0},$=await s("worker-attempt-resume",{attempt_id:l,expected_revision:b()});if($&&$.conflict){let T=$.queue&&typeof $.queue.revision=="number"?$.queue.revision:b();$=await s("worker-attempt-resume",{attempt_id:l,expected_revision:T})}$&&$.resumed===!1&&!$.conflict&&$.reason&&Z(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${$.reason}`,"error",2400)}let _={onOpen:S,onResume:x};function O(){let l=i?i.get():null,b=l&&l.exec_defaults;return b&&typeof b=="object"?b:{}}let N=null;r&&r.subscribe&&(N=r.subscribe(()=>ke()));let z=null;i&&typeof i.subscribe=="function"&&(z=i.subscribe(()=>{a&&d()}));function K(l){l.key==="Escape"&&a&&(l.preventDefault(),n())}document.addEventListener("keydown",K);function ke(){if(a){if(r&&typeof r.snapshotFor=="function"){let l=r.snapshotFor("detail:"+a)||[];u=l.find($=>$&&$.id===a)||l[0]||u}d()}}function oe(l){Lt(l).then(b=>{b?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ee(l){l.preventDefault(),l.stopPropagation(),a&&oe(a)}function Xe(l,b){l.preventDefault(),l.stopPropagation(),oe(b)}function qe(l,b){l.preventDefault(),l.stopPropagation(),B.open(b)}function ve(l,b){h[l]=b,d(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:l,value:b})).catch(()=>{Z("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function Ae(l,b,$){if(!s||!a)return!1;try{let T=await Promise.resolve(s(l,b)),G=Array.isArray(T)?T[0]:T;return G&&typeof G=="object"&&G.id?(u=G,!0):(Z($,"error"),!1)}catch{return Z($,"error"),!1}}function Qe(l){setTimeout(()=>{try{let b=t.querySelector(l);b&&typeof b.focus=="function"&&b.focus()}catch{}},0)}function fe(){g=!0,v=u&&u.title||"",d(),Qe('.detail-edit__input[data-edit="title"]')}function ot(l){v=l.target.value}function he(){g=!1,v="",d()}function Je(){Ae("edit-text",{id:a,field:"title",value:v},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(b=>{b&&(g=!1,v=""),d()})}function ae(){w=!0,y=u&&u.description||"",d(),Qe('.detail-edit__textarea[data-edit="description"]')}function Fe(l){y=l.target.value}function rt(){w=!1,y="",d()}function Ce(){Ae("edit-text",{id:a,field:"description",value:y},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(b=>{b&&(w=!1,y=""),d()})}function Le(l,b,$,T){if(l.key==="Escape"){l.stopPropagation(),$();return}l.key==="Enter"&&(!T||l.ctrlKey||l.metaKey)&&(l.preventDefault(),b())}function $e(l){let b=l.target.value;Ae("update-status",{id:a,status:b},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function Ue(l){let b=Number(l.target.value);Ae("update-priority",{id:a,priority:b},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function et(l){C=l.target.value}function Ie(){let l=C.trim();l.length!==0&&Ae("label-add",{id:a,label:l},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(b=>{b&&(C=""),d()})}function ze(l){if(l.key==="Escape"){l.stopPropagation(),C="",d();return}l.key==="Enter"&&(l.preventDefault(),Ie())}function De(l){Ae("label-remove",{id:a,label:l},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>d())}let ce={onCopyPath:Xe,onOpenDoc:qe},xe={onChange:ve};function Oe(l){return typeof l=="string"?l:l&&typeof l=="object"?String(l.id||l.to||l.issue_id||l.depends_on||""):""}function He(l){switch(l&&typeof l=="object"?String(l.dependency_type||l.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Me(l){let $=(Array.isArray(l.dependencies)?l.dependencies:[]).map(T=>({id:Oe(T),icon:He(T)})).filter(T=>T.id.length>0);return p`
    ...
    `}function tt(l){let b=l.metadata||{},$=l.workflow||{},T=$.stages||{},G=T.spec&&T.spec.stale,Q=T.impl&&T.impl.stale,F=$.route_source==="derived",ue=$.route||b.route||"\u2014";return p`
      ...
      <div class="detail-kv">
        ...
        <span class="detail-kv__v"
          >${b.spec_review||"\uC5C6\uC74C"}${G?" \xB7 stale":""}</span
        >
      </div>
      <div class="detail-kv">
    ...
    `}let it={route:["spec_backed","full_plan"]};async function me(l,b){let $=b.target.value;if(l==="route"&&u&&u.metadata&&u.metadata.route==="full_plan"&&$!=="full_plan"&&!window.confirm(`full_plan \u2192 ${$||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){d();return}await Ae("update-workflow-meta",{id:a,key:l,value:$},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),d()}function Ne(l){let b=l.metadata||{};return p` ${((T,G)=>{let Q=it[T],F=typeof b[T]=="string"?b[T]:"";return p`<div class="detail-kv">
    ...
    `}function V(){if(!a)return p``;let l=u||{},b=String(l.id||a),$=l.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",T=l.status||"open",G=typeof l.priority=="number"?Math.max(0,Math.min(4,l.priority)):"",Q=l.description||"",F={...l,metadata:{...l.metadata||{},...h}};return p`
...
${se.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:H==="done"?Fn(d.attempts||{},ne.bead_id):null}}),We=d.attempts?Object.values(d.attempts):[],lt=new Set;for(let E of We)E&&typeof E.resumed_from=="string"&&E.resumed_from.length>0&&lt.add(E.resumed_from);let Wt=new Map;for(let E of We)Wt.set(E.bead_id,E.attempt_id);let Gt=new Map;for(let E of We)Gt.set(E.attempt_id,E);function jt(E){let H=new Set,ne=E;for(;ne&&!H.has(ne.attempt_id);){if(ne.conflict_resolution===!0)return!0;H.add(ne.attempt_id),ne=typeof ne.resumed_from=="string"&&ne.resumed_from.length>0&&Gt.get(ne.resumed_from)||null}return!1}let mt=[],Te=null;for(let E of We){let H=E.status==="paused"&&!lt.has(E.attempt_id);E.status==="running"||H?mt.push({bead_id:E.bead_id,attempt_id:E.attempt_id,title:T.get(E.bead_id)||E.bead_id,runner:E.runner||null,model:E.model||null,effort:E.effort||null,started_at:typeof E.started_at=="number"?E.started_at:null,resumed_from:E.resumed_from||null,paused:H,conflict_resolution:jt(E),can_pause:typeof E.session_id=="string"&&E.session_id.length>0,usage:E.usage||null}):(E.status==="failed"||E.status==="orphaned")&&!(Wt.get(E.bead_id)!==E.attempt_id)&&typeof E.dismissed_at!="number"&&(Te=E)}let Yt=null;if(Te){let E=typeof Te.session_id=="string"&&Te.session_id.length>0,H=lt.has(Te.attempt_id),ne=Te.cause_detail;Yt={repo:Te.repo||"",reason:Te.cause||Te.status,cause_detail:ne&&typeof ne.reason=="string"?{reason:ne.reason,command:typeof ne.command=="string"?ne.command:null}:null,resume_attempt_id:Te.attempt_id,resume_eligible:E&&!H,resume_reason:E?H?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let mr=new Set(mt.map(E=>E.bead_id)),vt=new Map;for(let E of mt)E.conflict_resolution&&(E.paused?vt.has(E.bead_id)||vt.set(E.bead_id,"paused"):vt.set(E.bead_id,"running"));let _r=mt.filter(E=>!E.paused).length,W=(d.workspace_info||{}).slots,f=typeof W=="number"?W:typeof d.slots=="number"?d.slots:zr,L=_r>f,U=gr(d.done,"done"),ge=0,Ee=0,we=!1;for(let E of U){let H=E.usage;H&&typeof H=="object"&&(Number.isFinite(H.input_tokens)&&(ge+=H.input_tokens,we=!0),Number.isFinite(H.output_tokens)&&(Ee+=H.output_tokens,we=!0))}let Be=we?Ht({input_tokens:ge,output_tokens:Ee}):null;return{queue:d,idToTitle:T,candidates:be,candidate_hidden:{blocked:J.hidden_blocked,spec:J.hidden_spec},running:mt,live_count:_r,slots:f,over_cap:L,failure:Yt,waiting:gr(nt.filter(E=>!mr.has(E.bead_id)),"queue"),pr_wait:G.map(E=>Gl(E.bead_id,T.get(E.bead_id)||E.bead_id,Q,ue[E.bead_id]||null,Fn(d.attempts||{},E.bead_id),F[E.bead_id]||(P.has(E.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),vt.get(E.bead_id)||null,E.external===!0)),done:U,token_total:Be,cleanup_failures:at}}function $e(d){let l=d.waiting.length>0?d.waiting[0].id:"\u2014",b=p`<button
    ...
    >
      ...
      >
        ...
        <div class="worker-ctrl__ops">${b}${G}</div>
