...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ec=/'/g,Tc=/"/g,Oc=/^(?:script|style|textarea|title)$/i,Da=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),c=Da(1),Uo=Da(2),Ww=Da(3),In=Symbol.for("lit-noChange"),Ht=Symbol.for("lit-nothing"),Cc=new WeakMap,Dr=Pr.createTreeWalker(Pr,129);function Ic(e,t){if(!La(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return xc!==void 0?xc.createHTML(t):t}var Lc=(e,t)=>{let n=e.length-1,r=[],o,i=t===2?"<svg>":t===3?"<math>":"",s=qo;for(let l=0;l<n;l++){let a=e[l],u,d,m=-1,b=0;for(;b<a.length&&(s.lastIndex=b,d=s.exec(a),d!==null);)b=s.lastIndex,s===qo?d[1]==="!--"?s=Ac:d[1]!==void 0?s=Sc:d[2]!==void 0?(Oc.test(d[2])&&(o=RegExp("</"+d[2],"g")),s=Lr):d[3]!==void 0&&(s=Lr):s===Lr?d[0]===">"?(s=o??qo,m=-1):d[1]===void 0?m=-2:(m=s.lastIndex-d[2].length,u=d[1],s=d[3]===void 0?Lr:d[3]==='"'?Tc:Ec):s===Tc||s===Ec?s=Lr:s===Ac||s===Sc?s=qo:(s=Lr,o=void 0);let h=s===Lr&&e[l+1].startsWith("/>")?" ":"";i+=s===qo?a+vm:m>=0?(r.push(u),a.slice(0,m)+Oa+a.slice(m)+nr+h):a+nr+(m===-2?l:h)}return[Ic(e,i+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},Bo=class e{constructor({strings:t,_$litType$:n},r){let o;this.parts=[];let i=0,s=0,l=t.length-1,a=this.parts,[u,d]=Lc(t,n);if(this.el=e.createElement(u,r),Dr.currentNode=this.el.content,n===2||n===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(o=Dr.nextNode())!==null&&a.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(let m of o.getAttributeNames())if(m.endsWith(Oa)){let b=d[s++],h=o.getAttribute(m).split(nr),k=/([.?@])?(.*)/.exec(b);a.push({type:1,index:i,name:k[2],strings:h,ctor:k[1]==="."?zs:k[1]==="?"?Hs:k[1]==="@"?Ks:qr}),o.removeAttribute(m)}else m.startsWith(nr)&&(a.push({type:6,index:i}),o.removeAttribute(m));if(Oc.test(o.tagName)){let m=o.textContent.split(nr),b=m.length-1;if(b>0){o.textContent=Us?Us.emptyScript:"";for(let h=0;h<b;h++)o.append(m[h],jo()),Dr.nextNode(),a.push({type:2,index:++i});o.append(m[b],jo())}}}else if(o.nodeType===8)if(o.data===Ia)a.push({type:2,index:i});else{let m=-1;for(;(m=o.data.indexOf(nr,m+1))!==-1;)a.push({type:7,index:i}),m+=nr.length-1}i++}}static createElement(t,n){let r=Pr.createElement("template");return r.innerHTML=t,r}};function Mr(e,t,n=e,r){if(t===In)return t;let o=r!==void 0?n._$Co?.[r]:n._$Cl,i=Fo(t)?void 0:t._$litDirective$;return o?.constructor!==i&&(o?._$AO?.(!1),i===void 0?o=void 0:(o=new i(e),o._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=o:n._$Cl=o),o!==void 0&&(t=Mr(e,o._$AS(e,t.values),o,r)),t}var Ws=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,o=(t?.creationScope??Pr).importNode(n,!0);Dr.currentNode=o;let i=Dr.nextNode(),s=0,l=0,a=r[0];for(;a!==void 0;){if(s===a.index){let u;a.type===2?u=new no(i,i.nextSibling,this,t):a.type===1?u=new a.ctor(i,a.name,a.strings,this,t):a.type===6&&(u=new Gs(i,this,t)),this._$AV.push(u),a=r[++l]}s!==a?.index&&(i=Dr.nextNode(),s++)}return Dr.currentNode=Pr,o}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},no=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,o){this.type=2,this._$AH=Ht,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=Mr(this,t,n),Fo(t)?t===Ht||t==null||t===""?(this._$AH!==Ht&&this._$AR(),this._$AH=Ht):t!==this._$AH&&t!==In&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Rc(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Ht&&Fo(this._$AH)?this._$AA.nextSibling.data=t:this.T(Pr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=Bo.createElement(Ic(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(n);else{let i=new Ws(o,this),s=i.u(this.options);i.p(n),this.T(s),this._$AH=i}}_$AC(t){let n=Cc.get(t.strings);return n===void 0&&Cc.set(t.strings,n=new Bo(t)),n}k(t){La(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,o=0;for(let i of t)o===n.length?n.push(r=new e(this.O(jo()),this.O(jo()),this,this.options)):r=n[o],r._$AI(i),o++;o<n.length&&(this._$AR(r&&r._$AB.nextSibling,o),n.length=o)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},qr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,o,i){this.type=1,this._$AH=Ht,this._$AN=void 0,this.element=t,this.name=n,this._$AM=o,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Ht}_$AI(t,n=this,r,o){let i=this.strings,s=!1;if(i===void 0)t=Mr(this,t,n,0),s=!Fo(t)||t!==this._$AH&&t!==In,s&&(this._$AH=t);else{let l=t,a,u;for(t=i[0],a=0;a<i.length-1;a++)u=Mr(this,l[r+a],n,a),u===In&&(u=this._$AH[a]),s||(s=!Fo(u)||u!==this._$AH[a]),u===Ht?t=Ht:t!==Ht&&(t+=(u??"")+i[a+1]),this._$AH[a]=u}s&&!o&&this.j(t)}j(t){t===Ht?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},zs=class extends qr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Ht?void 0:t}},Hs=class extends qr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Ht)}},Ks=class extends qr{constructor(t,n,r,o,i){super(t,n,r,o,i),this.type=5}_$AI(t,n=this){if((t=Mr(this,t,n,0)??Ht)===In)return;let r=this._$AH,o=t===Ht&&r!==Ht||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,i=t!==Ht&&(r===Ht||o);o&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Gs=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){Mr(this,t)}},Dc={M:Oa,P:nr,A:Ia,C:1,L:Lc,R:Ws,D:Rc,V:Mr,I:no,H:qr,N:Hs,U:Ks,B:zs,F:Gs},km=No.litHtmlPolyfillSupport;km?.(Bo,no),(No.litHtmlVersions??(No.litHtmlVersions=[])).push("3.3.1");var ft=(e,t,n)=>{let r=n?.renderBefore??t,o=r._$litPart$;if(o===void 0){let i=n?.renderBefore??null;r._$litPart$=o=new no(t.insertBefore(jo(),i),i,void 0,n??{})}return o._$AI(e),o};var Ys="today",Pc=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}],ro=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"}];function Kn(e){return e==="today"?"today":"7d"}function Pa(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function Nr(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function Mc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function qc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Nc(){let e=null,t=[],n,r=new Set;function o(){for(let i of Array.from(r))try{i()}catch{}}return{get(){return e},getWorkspacesState(){return t},crossLanes(){return n},set(i,s,l){e=Array.isArray(i)?i:null,t=Array.isArray(s)?s:[],n=l===void 0?void 0:l!==null&&typeof l=="object"&&typeof l.revision=="number"&&Array.isArray(l.lanes)?{revision:l.revision,lanes:l.lanes}:null,o()},clear(){e=null,t=[],n=void 0,o()},subscribe(i){return r.add(i),()=>r.delete(i)}}}function jc(){let e=new Map,t=new Set;function n(o){return o.startsWith("session-log:")?o:`session-log:${o}`}function r(){for(let o of Array.from(t))try{o()}catch{}}return{set(o,i,s=null){e.set(n(o),{lines:Array.isArray(i)?[...i]:[],last_event_at:typeof s=="number"?s:null}),r()},append(o,i){let s=n(o),l=e.get(s)||{lines:[],last_event_at:null};l.lines=[...l.lines,i],l.last_event_at=Date.now(),e.set(s,l),r()},get(o){return e.get(n(o))||null},clear(o){typeof o=="string"?e.delete(n(o)):e.clear(),r()},subscribe(o){return t.add(o),()=>t.delete(o)}}}var Hc=ym(zc(),1);function Bt(e){return(0,Hc.default)(`beads-ui:${e}`)}function Dm(e){let n=Kc((e&&typeof e=="object"?e:{}).spec_id);return n?{path:n,source:"native",conflict:!1}:{path:"",source:"none",conflict:!1}}function Kc(e){return typeof e=="string"?e.trim():""}function Pm(e){let t=e&&typeof e=="object"?e:{};return t.metadata&&typeof t.metadata=="object"?t.metadata:{}}var Mm=/^[A-Za-z0-9_.:-]+@[0-9a-fA-F]{40}$/;function ao(e){let t=Dm(e),n=Kc(Pm(e).spec_review),r=Mm.test(n),o=r&&n.slice(0,n.indexOf("@"))==="skipped";return t.source==="none"?{...t,evidence:"none",skipped:o}:{...t,evidence:r?"published":"draft",skipped:o}}function Pn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function Wo(e,t){let n=Pn(e.created_at),r=Pn(t.created_at);if(n!==r)return n<r?1:-1;let o=e.priority??2,i=t.priority??2;if(o!==i)return o-i;let s=e.id,l=t.id;return s<l?-1:s>l?1:0}function Zc(e,t){let n=Pn(e.created_at),r=Pn(t.created_at);if(n!==r)return n<r?-1:1;let o=e.priority??2,i=t.priority??2;if(o!==i)return o-i;let s=e.id,l=t.id;return s<l?-1:s>l?1:0}function Jc(e,t){let n=Pn(e.updated_at),r=Pn(t.updated_at);if(n!==r)return n<r?1:-1;let o=e.id,i=t.id;return o<i?-1:o>i?1:0}function eu(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let o=Pn(e.created_at),i=Pn(t.created_at);if(o!==i)return o<i?1:-1;let s=e.id,l=t.id;return s<l?-1:s>l?1:0}function tu(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let o=e?.id,i=t?.id;return o<i?-1:o>i?1:0}var Xs=Object.freeze({priority:"asc",dependents:"desc",released:"desc",spec:"desc",created:"asc",updated:"desc"});function qm(e){return typeof e=="string"&&Object.prototype.hasOwnProperty.call(Xs,e)}function qa(e){if(!e||typeof e!="object")return!1;let t=e;return qm(t.key)&&(t.dir==="asc"||t.dir==="desc")}function Gc(e){if(typeof e=="number")return Number.isFinite(e)?e:null;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:null}return null}function Yc(e,t){switch(t){case"priority":{let n=e.priority;return typeof n=="number"&&Number.isFinite(n)?n:null}case"dependents":{let n=e.dependents_info?e.dependents_info.count:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"released":{let n=e.release_info?e.release_info.last_released_at:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"spec":return ao(e).evidence==="published"?1:0;case"created":return Gc(e.created_at);case"updated":return Gc(e.updated_at);default:return null}}function Vc(e,t,n){let r=Yc(e,n.key),o=Yc(t,n.key);if(r===null||o===null)return r===o?0:r===null?1:-1;if(r===o)return 0;let i=r<o?-1:1;return n.dir==="desc"?-i:i}function nu(e){let t=Array.isArray(e)?e.filter(qa):[];return(n,r)=>{for(let l of t){let a=Vc(n,r,l);if(a!==0)return a}let o=Vc(n,r,{key:"created",dir:"asc"});if(o!==0)return o;let i=n.id,s=r.id;return i<s?-1:i>s?1:0}}var Nm=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function Qc(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Xc(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=Nm.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function ru(e,t){let n=Qc(e),r=Qc(t);if(n!==r)return n<r?-1:1;let o=Xc(e),i=Xc(t);if(o!==i)return o<i?-1:1;let s=Pn(e&&e.created_at),l=Pn(t&&t.created_at);if(s!==l)return s<l?-1:1;let a=e&&e.id,u=t&&t.id;return a===u?0:String(a)<String(u)?-1:1}var Ma=2**20;function lo(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-Pn(e&&e.created_at)}function ou(e){return(t,n)=>{let r=lo(t,e),o=lo(n,e);if(r!==o)return r<o?-1:1;let i=t?.id,s=n?.id;return i<s?-1:i>s?1:0}}function Na(e,t,n){let r=Array.isArray(e)?e:[],o=r.length,i=Math.max(0,Math.min(t,o-1)),s=i-1>=0?r[i-1]:null,l=i+1<o?r[i+1]:null;if(!s&&!l)return{rank:0};if(!s)return{rank:lo(l,n)-Ma};if(!l)return{rank:lo(s,n)+Ma};let a=lo(s,n),u=lo(l,n),d=(a+u)/2;return a<d&&d<u?{rank:d}:{renormalize:r.map((m,b)=>({bead_id:m.id,rank:b*Ma}))}}function ja(e,t={}){let n=Bt(`issue-store:${e}`),r=new Map,o=[],i=0,s=new Set,l=!1,a=t.sort||Wo;function u(){for(let b of Array.from(s))try{b()}catch{}}function d(){o=Array.from(r.values()).sort(a)}function m(b){if(l||!b||b.id!==e)return;let h=Number(b.revision)||0;if(n("apply %s rev=%d",b.type,h),!(h<=i&&b.type!=="snapshot")){if(b.type==="snapshot"){if(h<=i)return;r.clear();let k=Array.isArray(b.issues)?b.issues:[];for(let S of k)S&&typeof S.id=="string"&&S.id.length>0&&r.set(S.id,S);d(),i=h,u();return}if(b.type==="upsert"){let k=b.issue;if(k&&typeof k.id=="string"&&k.id.length>0){let S=r.get(k.id);if(!S)r.set(k.id,k);else{let T=Number.isFinite(S.updated_at)?S.updated_at:0,ee=Number.isFinite(k.updated_at)?k.updated_at:0;if(T<=ee){for(let re of Object.keys(S))re in k||delete S[re];for(let[re,U]of Object.entries(k))S[re]=U}}d()}i=h,u()}else if(b.type==="delete"){let k=String(b.issue_id||"");k&&(r.delete(k),d()),i=h,u()}}}return{id:e,subscribe(b){return s.add(b),()=>{s.delete(b)}},applyPush:m,snapshot(){return o},size(){return r.size},getById(b){return r.get(b)},dispose(){l=!0,r.clear(),o=[],s.clear(),i=0}}}function Zs(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let o=Object.keys(e.params).sort();for(let i of o){let s=e.params[i];n[i]=String(s)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function su(e){let t=Bt("subs"),n=new Map,r=new Map;function o(l,a){t("applyDelta %s +%d ~%d -%d",l,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let u=r.get(l);if(!u||u.size===0)return;let d=Array.isArray(a.added)?a.added:[],m=Array.isArray(a.updated)?a.updated:[],b=Array.isArray(a.removed)?a.removed:[];for(let h of Array.from(u)){let k=n.get(h);if(!k)continue;let S=k.itemsById;for(let T of d)typeof T=="string"&&T.length>0&&S.set(T,!0);for(let T of m)typeof T=="string"&&T.length>0&&S.set(T,!0);for(let T of b)typeof T=="string"&&T.length>0&&S.delete(T)}}async function i(l,a){let u=Zs(a);if(t("subscribe %s key=%s",l,u),!n.has(l))n.set(l,{key:u,itemsById:new Map});else{let m=n.get(l);if(m&&m.key!==u){let b=r.get(m.key);b&&(b.delete(l),b.size===0&&r.delete(m.key)),n.set(l,{key:u,itemsById:new Map})}}r.has(u)||r.set(u,new Set);let d=r.get(u);d&&d.add(l);try{await e("subscribe-list",{id:l,type:a.type,params:a.params})}catch(m){let b=n.get(l)||null;if(b){let h=r.get(b.key);h&&(h.delete(l),h.size===0&&r.delete(b.key))}throw n.delete(l),m}return async()=>{t("unsubscribe %s key=%s",l,u);try{await e("unsubscribe-list",{id:l})}catch{}let m=n.get(l)||null;if(m){let b=r.get(m.key);b&&(b.delete(l),b.size===0&&r.delete(m.key))}n.delete(l)}}return{subscribeList:i,_applyDelta:o,_subKeyOf:Zs,selectors:{getIds(l){let a=n.get(l);return a?Array.from(a.itemsById.keys()):[]},has(l,a){let u=n.get(l);return u?u.itemsById.has(a):!1},count(l){let a=n.get(l);return a?a.itemsById.size:0},getItemsById(l){let a=n.get(l),u={};if(!a)return u;for(let d of a.itemsById.keys())u[d]=!0;return u}}}}function iu(){let e=Bt("issue-stores"),t=new Map,n=new Map,r=new Set,o=new Map;function i(){for(let a of Array.from(r))try{a()}catch{}}function s(a,u,d){let m=u?Zs(u):"",b=n.get(a)||"",h=t.has(a);if(e("register %s key=%s (prev=%s)",a,m,b),h&&b&&m&&b!==m){let k=t.get(a);if(k)try{k.dispose()}catch{}let S=o.get(a);if(S){try{S()}catch{}o.delete(a)}let T=ja(a,d);t.set(a,T);let ee=T.subscribe(()=>i());o.set(a,ee)}else if(!h){let k=ja(a,d);t.set(a,k);let S=k.subscribe(()=>i());o.set(a,S)}return n.set(a,m),()=>l(a)}function l(a){e("unregister %s",a),n.delete(a);let u=t.get(a);u&&(u.dispose(),t.delete(a));let d=o.get(a);if(d){try{d()}catch{}o.delete(a)}}return{register:s,unregister:l,getStore(a){return t.get(a)||null},snapshotFor(a){let u=t.get(a);return u?u.snapshot().slice():[]},subscribe(a){return r.add(a),()=>r.delete(a)}}}function au(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function lu(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Fa(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function jm(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),o=r>=0?n.slice(r+1):"";if(o){let l=new URLSearchParams(o).get("issue");if(l)return decodeURIComponent(l)}let i=/^\/issue\/([^\s?#]+)/.exec(n);return i&&i[1]?decodeURIComponent(i[1]):null}function Fm(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function cu(e){let t=Bt("router"),n=()=>{let r=window.location.hash||"",o=/^#\/issue\/([^\s?#]+)/.exec(r),i=o&&o[1]?decodeURIComponent(o[1]):jm(r),s=Fm(r);if(t("hash change \u2192 view=%s id=%s",s,i),e.setState({selected_id:s==="worker"?null:i,view:s,worker:{selected_parent_id:s==="worker"?i:null}}),!!o||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let a=i?`#/${s}?issue=${encodeURIComponent(i)}`:`#/${s}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let o=e.getState?e.getState():{view:"board"},i=o.view==="worker"||o.view==="monitor"?o.view:"board",s=Fa(i,r);t("goto issue %s (view=%s)",r,i),window.location.hash!==s?window.location.hash=s:e.setState({selected_id:i==="worker"?null:r,view:i,worker:{selected_parent_id:i==="worker"?r:null}})},gotoView(r){let o=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},i=r==="worker"?o.worker?.selected_parent_id:o.selected_id,s=i?Fa(r,i):`#/${r}`;t("goto view %s (id=%s)",r,i||""),window.location.hash!==s?window.location.hash=s:e.setState({view:r,selected_id:r==="worker"?null:o.selected_id})}}}var Bm=Object.freeze({workspace_config:{default_workspace:null}});function uu(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:Bm.workspace_config.default_workspace}}}function du(e={}){let t=Bt("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:uu(e.config)},r=new Set;function o(){for(let i of Array.from(r))try{i(n)}catch{}}return{getState(){return n},setState(i){let s={...n,...i,filters:{...n.filters,...i.filters||{}},board:{...n.board,...i.board||{}},worker:{...n.worker,...i.worker||{}},workspace:{current:i.workspace?.current!==void 0?i.workspace.current:n.workspace.current,available:i.workspace?.available!==void 0?i.workspace.available:n.workspace.available,hidden:i.workspace?.hidden!==void 0?i.workspace.hidden:n.workspace.hidden},config:i.config!==void 0?uu(i.config):n.config},l=s.workspace.current?.path!==n.workspace.current?.path||s.workspace.available.length!==n.workspace.available.length||s.workspace.hidden.length!==n.workspace.hidden.length||s.workspace.hidden.some((u,d)=>u!==n.workspace.hidden[d]),a=s.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;s.selected_id===n.selected_id&&s.view===n.view&&s.filters.status===n.filters.status&&s.filters.search===n.filters.search&&s.filters.type===n.filters.type&&s.board.closed_filter===n.board.closed_filter&&s.worker.selected_parent_id===n.worker.selected_parent_id&&s.worker.show_closed_children.length===n.worker.show_closed_children.length&&s.worker.show_closed_children.every((u,d)=>u===n.worker.show_closed_children[d])&&!l&&!a||(n=s,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),o())},subscribe(i){return r.add(i),()=>r.delete(i)}}}function pu(e){let t=Bt("activity"),n=0,r=new Map,o=1;function i(){if(!e)return;let u=n>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function s(){n+=1,t("start count=%d",n),i()}function l(){let u=n;n=Math.max(0,n-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,n),i()}function a(u){return async(m,b)=>{let h=o++,k=Date.now();r.set(h,{type:m,start_ts:k}),t("request start id=%d type=%s count=%d",h,m,n+1),s();let S=!1,T=()=>{S||(S=!0,r.delete(h),l())},ee=setTimeout(()=>{S||(t("request TIMEOUT id=%d type=%s elapsed=%dms",h,m,Date.now()-k),T())},3e4);try{let re=await u(m,b),U=Date.now()-k;return t("request done id=%d type=%s elapsed=%dms",h,m,U),re}catch(re){let U=Date.now()-k;throw t("request error id=%d type=%s elapsed=%dms err=%o",h,m,U,re),re}finally{clearTimeout(ee),T()}}}return i(),{wrapSend:a,start:s,done:l,getCount:()=>n,getActiveRequests:()=>{let u=Date.now();return Array.from(r.entries()).map(([d,m])=>({id:d,type:m.type,elapsed_ms:u-m.start_ts}))}}}function _e(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function co(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let i=t.get();return i&&i.order?i.order:{}}function r(i,s,l){let a=e&&e.snapshotFor?e.snapshotFor(i).slice():[];if(s==="closed")return a.sort(tu),a;switch(l){case"created_desc":return a.sort(Wo),a;case"created_asc":return a.sort(Zc),a;case"updated_desc":return a.sort(Jc),a;case"priority":return a.sort(eu),a;case"manual":default:{let u=n();return u?a.sort(ou(u)):a.sort(Wo),a}}}function o(i){let s=[];return e&&typeof e.subscribe=="function"&&s.push(e.subscribe(i)),t&&typeof t.subscribe=="function"&&s.push(t.subscribe(i)),()=>{for(let l of s)try{l()}catch{}}}return{selectBoardColumn:r,subscribe:o}}function _r(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function ln(e){let t=_r(e);if(t===null)return"";let n=new Date(t),r=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function bn(e,t){let n=_r(e);if(n===null)return"";let o=(typeof t=="number"?t:Date.now())-n;if(o<6e4)return"\uBC29\uAE08";let i=Math.floor(o/6e4);if(i<60)return`${i}\uBD84 \uC804`;let s=Math.floor(o/36e5);if(s<24)return`${s}\uC2DC\uAC04 \uC804`;let l=Math.floor(o/864e5);if(l<7)return`${l}\uC77C \uC804`;let a=Math.floor(l/7);if(l<30)return`${a}\uC8FC \uC804`;let u=Math.floor(l/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(l/365)}\uB144 \uC804`}function fu(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let o=_r(r.updated_at)??0;if(t===null||o>n){t=r,n=o;continue}o===n&&String(r.id)<String(t.id)&&(t=r)}return t}function Js(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function ei(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let o=Js(r);if(!o)continue;let i=n.get(o);i||(i=[],n.set(o,i)),i.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function ti(e,t){let n=e.get(t)||[],r=0;for(let i of n)(i.status==="resolved"||i.status==="closed")&&(r+=1);let o=fu(n);return{total:n.length,count:r,current:o,children:n}}function _u(e){let t=e.transport,n=e.uiOrderStore;function r(s,l){return"renormalize"in s?s.renormalize:[{bead_id:l,rank:s.rank}]}function o(s,l){let a={...s.order};for(let u of l)a[u.bead_id]=u.rank;n&&n.set({revision:s.revision,order:a})}async function i(s,l,a){if(!t||!n)return;let u=n.get()||{revision:0,order:{}},d=r(Na(l,a,u.order),s);o(u,d);let m=await t("ui-order-set",{expected_revision:u.revision,entries:d});if(m&&m.conflict){let b={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};n.set(b);let h=r(Na(l,a,b.order),s);o(b,h);let k=await t("ui-order-set",{expected_revision:b.revision,entries:h});k&&k.applied&&n.set({revision:typeof k.revision=="number"?k.revision:0,order:k.order||{}})}else m&&m.applied&&n.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:i}}function mu(e){if(typeof e!="string")return"";let t=e.indexOf("-");return t>0?e.slice(0,t):""}function Gn(e,t){let n=mu(e),r=mu(t);return n.length===0||r.length===0?!1:n!==r}function ni(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ba(e,t){return!t||typeof e!="string"||e.length===0||ni(t.visible_labels).includes(e)?!0:ni(t.hidden_labels).includes(e)?!1:!ni(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function gu(e,t){return ni(e).filter(n=>Ba(n,t))}function mr(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function Um(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function Wm(e,t,n,r,o){return c`<button
  ...
  >
    ...
    ${n}
  </button>`}function ri(e,t){let n=e.total||0,r=!!t.expanded,o=t.trailing??"",i=typeof t.empty_label=="string"&&t.empty_label.length>0?t.empty_label:null;if(n===0&&i===null)return"";let s=Array.isArray(e.children)?e.children:[],l=n>0?s.slice().sort(ru):s;return c`
  ...
  `}function vu(e){let t=e?e.doc:null;return!t||typeof t.path!="string"||t.path.length===0?null:t}function oi(e,t,n={}){if(!e||!e.stages)return"";let r=n.onOpenDoc,o=hu[e.route]||hu.spec_backed,i=e.stages,s=Gm(o,i,String(t||"open")),l=`\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uC9C4\uD589: ${o.map(u=>`${bu[u]||u} ${u==="plan"?Ym(i[u]||{}):yu(i[u]||{})}`).join(" \xB7 ")}`,a=!!r&&o.some(u=>vu(i[u]||{})!==null);return c`
    <div
      class="stp"
      role=${a?"group":"img"}
      aria-label=${l}
  ...
  `}function Qm(e){return typeof e!="number"||!Number.isFinite(e)?"":`P${Math.max(0,Math.min(4,e))}`}var ku=2;function wu(e){let t=e.slice(0,ku).join(", "),n=e.length-ku;return`\u26D3 blocked: ${t}${n>0?` +${n}`:""}`}function Xm(e,t){if(!t)return[];let n=[],r=Array.isArray(t.blockers)?t.blockers:[],o=[],i=[];for(let s of r)(Gn(e,s)?i:o).push(s);return o.length>0&&n.push(c`<span class="ctl-chip ctl-chip--blocked-dep"
        >${wu(o)}</span
  ...
  >`:null}function eg(e,t){let n=t.policy||null,r=e.workflow&&e.workflow.chips||{},o=[];if(r.route&&mr(n,"route")){let l=r.route_source==="derived";o.push(c`<span
      ...
      >`)}if(r.fast_track&&mr(n,"fast_track")&&o.push(c`<span class="ctl-chip ctl-chip--ft">⚡ fast_track</span>`),r.pr&&mr(n,"pr")){let l=r.pr.number;o.push(c`<span class="ctl-chip ctl-chip--pr"
        >${`PR${l!=null?` #${l}`:""}`}</span
      >`)}let i=$u(r.planned_execution,r.exec_receipt);if(i&&o.push(i),r.exec_receipt){let l=r.exec_receipt;o.push(c`<span
        class="ctl-chip ctl-chip--exec-receipt"
      ...
      >`)}for(let l of gu(e.labels,n))o.push(c`<span class="ctl-chip ctl-chip--label">${l}</span>`);if(e.from_id&&mr(n,"from")&&o.push(c`<button
        type="button"
  ...
  `}var ag=200,lg={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},cg=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),Su="beads-ui.board.sort",Eu=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function ug(){try{let e=window.localStorage.getItem(Su);if(e&&Eu.has(e))return e}catch{}return"created_desc"}function Tu(e,t){let n=Bt("views:board"),r=t.gotoIssue,o=t.issueStores,i=t.transport,s=t.uiOrderStore,l=t.displayPolicyStore,a=t.workerQueueStore,u=t.onClosedRangeChange,d=t.onNewIssue,m=t.openDoc,b=t.closedRange||Ys,h=o?co(o,s):null,k=_u({transport:i,uiOrderStore:s}),S=[],T=[],ee=[],re=[],U=[],L=[],R=!1,P=0,q=ug(),W=new Map,F=new Map,D=new Map,V=new Set,j={search:"",priority:"",type:"",labels:[]},ne=!1,me=null;function Oe(se){return String(se.status||"open")==="open"}function H(se){return String(se.status||"open")==="open"}function te(se){let ge=j.search.trim().toLowerCase(),Ge=j.priority,at=j.type,ze=j.labels;return se.filter(mt=>{if(ge){let gt=String(mt.id||"").toLowerCase(),nt=String(mt.title||"").toLowerCase();if(!gt.includes(ge)&&!nt.includes(ge))return!1}if(Ge!==""&&String(mt.priority)!==Ge||at!==""&&String(mt.issue_type||"")!==at)return!1;if(ze.length>0){let gt=Array.isArray(mt.labels)?mt.labels:[];if(!ze.some(nt=>gt.includes(nt)))return!1}return!0})}function ce(){let se=new Set;for(let ge of[S,T,ee,re,U,L])for(let Ge of ge){let at=Array.isArray(Ge.labels)?Ge.labels:[];for(let ze of at)typeof ze=="string"&&ze.length>0&&se.add(ze)}return Array.from(se).sort()}function Te(){return j.search.trim()!==""||j.priority!==""||j.type!==""||j.labels.length>0}function K(){try{if(h){let se=h.selectBoardColumn("tab:board:in-progress","in_progress",q),ge=h.selectBoardColumn("tab:board:blocked","blocked",q).filter(H),Ge=new Set(se.map(N=>N.id)),at=h.selectBoardColumn("tab:board:ready","ready",q).filter(N=>Oe(N)&&!Ge.has(N.id)),ze=h.selectBoardColumn("tab:board:resolved","resolved",q),mt=h.selectBoardColumn("tab:board:deferred","deferred",q),gt=h.selectBoardColumn("tab:board:closed","closed").slice(0,ag),nt=[...ge,...at,...se,...ze,...gt];ae(nt);let Me=new Set;for(let N of nt)N&&N.id&&!Js(N)&&Me.add(N.id);let A=!Te();S=A?zo(ge,Me):ge,T=A?zo(at,Me):at,ee=A?zo(se,Me):se,re=A?zo(ze,Me):ze,U=mt,P=mt.length,L=A?zo(gt,Me):gt,W=new Map;for(let N of S)W.set(N.id,"open");for(let N of T)W.set(N.id,"open");for(let N of ee)W.set(N.id,"in_progress");for(let N of re)W.set(N.id,"resolved");for(let N of U)W.set(N.id,"deferred");for(let N of L)W.set(N.id,"closed");F=new Map;for(let N of S)F.set(N.id,"blocked-col");for(let N of T)F.set(N.id,"ready-col");for(let N of ee)F.set(N.id,"in-progress-col");for(let N of re)F.set(N.id,"resolved-col");for(let N of L)F.set(N.id,"closed-col")}Ze()}catch{S=[],T=[],ee=[],re=[],U=[],L=[],D=new Map,Ze()}}function ae(se){D=ei(se)}function Q(se){return ti(D,se)}function de(se){return!V.has(se)}function Re(se,ge){se.preventDefault(),se.stopPropagation(),V.has(ge)?V.delete(ge):V.add(ge),Ze()}function be(se,ge){se.preventDefault(),se.stopPropagation(),r(ge)}function Ie(se,ge){se.preventDefault(),se.stopPropagation(),r(ge)}function Ye(se,ge){me||r(ge)}function _t(se,ge){se.preventDefault(),se.stopPropagation(),dg(ge).then(Ge=>{Ge&&_e("\uBCF5\uC0AC\uB428","success",1200)})}function G(se,ge){me=ge,se.dataTransfer&&(se.dataTransfer.setData("text/plain",ge),se.dataTransfer.effectAllowed="move"),se.target.classList.add("board-card--dragging")}function pe(se){se.target.classList.remove("board-card--dragging"),De(),setTimeout(()=>{me=null},0)}function oe(se){let ge=String(se.target.value||"");!ge||ge===b||(b=ge,u&&u(ge),Ze())}function Y(){return l?l.get():null}function ke(se){let ge=a?a.get():null,Ge=ge?ge.cleanup_failed:null;if(!Ge||typeof Ge!="object"||Array.isArray(Ge))return null;let at=Ge[se];return!at||typeof at!="object"||Array.isArray(at)?null:at}let fe={onCardClick:Ye,onCopyId:_t,onDragStart:G,onDragEnd:pe,onClosedRangeChange:oe,rollupFor:Q,isExpanded:de,onRollupToggle:Re,onChildClick:be,onFromChipClick:Ie,onOpenDoc:m?(se,ge)=>m(ge):void 0,cleanupFailureFor:ke,get policy(){return Y()}};function Ce(se,ge){me||(Ue(),r(ge))}function Ne(se,ge){se.preventDefault(),se.stopPropagation(),Ue(),r(ge)}let Qe={...fe,onCardClick:Ce,onChildClick:Ne,onFromChipClick:Ne,onOpenDoc:m?(se,ge)=>{Ue(),m(ge)}:void 0,get policy(){return Y()}};function Fe(se){let ge=se.target,Ge=e.querySelector(".board-filter__labels");ge&&Ge&&Ge.contains(ge)||Ee()}function J(se){se.key==="Escape"&&Ee()}function X(){ne||(ne=!0,document.addEventListener("mousedown",Fe),document.addEventListener("keydown",J),Ze())}function Ee(){ne&&(ne=!1,document.removeEventListener("mousedown",Fe),document.removeEventListener("keydown",J),Ze())}function Je(se){se.key==="Escape"&&Ue()}function st(){R||(R=!0,document.addEventListener("keydown",Je),Ze())}function Ue(){R&&(R=!1,document.removeEventListener("keydown",Je),Ze())}let et={onClose:Ue,onOverlayClick(se){se.target===se.currentTarget&&Ue()}},vt={onSearchInput(se){j.search=String(se.target.value||""),K()},onPriorityChange(se){j.priority=String(se.target.value||""),K()},onTypeChange(se){j.type=String(se.target.value||""),K()},onSortChange(se){let ge=String(se.target.value||"");if(!(!Eu.has(ge)||ge===q)){q=ge;try{window.localStorage.setItem(Su,ge)}catch{}K()}},onDeferredToggle(){R?Ue():st()},onLabelMenuToggle(){ne?Ee():X()},onLabelToggle(se){let ge=j.labels.indexOf(se);ge===-1?j.labels.push(se):j.labels.splice(ge,1),K()},onLabelClear(){j.labels.length!==0&&(j.labels=[],K())},onNewIssue(){d&&d()}};function ut(){return c`
      <div class="board-view">
        ${Au(j,vt,{sort_mode:q,deferred_popup_open:R,deferred_count:P,label_options:ce(),label_menu_open:ne})}
...
`)}function sr(e,t){let n={claude:Yn(),codex:Yn()},r={orchestrator:{claude:Yn(),codex:Yn()},implementation:{claude:Yn(),codex:Yn()},"review-consult":{claude:Yn(),codex:Yn()},subagent:{claude:Yn(),codex:Yn()}},o=new Set;for(let l of Object.values(e||{})){if(!l||l.bead_id!==t)continue;let a=l.usage;if(Nu(a)){let d=Cg(l.runner),m=ju(a),b={provider:d,role:"orchestrator",attempt_id:String(l.attempt_id||""),usage:m,subtotal:Fu(d,m)};m.replayed===!0&&(b.replayed=!0),typeof l.model=="string"&&(b.model=l.model),typeof l.session_id=="string"&&(b.session_id=l.session_id),ui(n[d],b,!0),ui(r.orchestrator[d],b,!0)}let u=Array.isArray(l.usage_legs)?l.usage_legs:[];for(let d of u){let m=d&&d.provider==="claude"?"claude":"codex";if(!d||d.provider!=="codex"&&d.provider!=="claude"||!wg[m].includes(d.role)||!Nu(d.usage))continue;let b=typeof d.receipt_id=="string"&&d.receipt_id.length>0?d.receipt_id:null;if(!b||o.has(b))continue;o.add(b);let h=ju(d.usage),k={provider:m,role:d.role,attempt_id:String(l.attempt_id||""),usage:h,subtotal:Fu(m,h)};k.receipt_id=b,typeof d.agent_type=="string"&&(k.agent_type=d.agent_type),typeof d.agent_id=="string"&&(k.agent_id=d.agent_id),typeof d.model=="string"&&(k.model=d.model),typeof d.effort=="string"&&d.effort.trim().length>0&&(k.effort=d.effort),typeof d.session_id=="string"?k.session_id=d.session_id:typeof d.thread_id=="string"&&(k.session_id=d.thread_id),typeof d.turn_id=="string"&&(k.turn_id=d.turn_id),(typeof d.completed_at=="string"||typeof d.completed_at=="number"&&Number.isFinite(d.completed_at))&&(k.completed_at=d.completed_at),h.replayed===!0&&(k.replayed=!0),ui(n[m],k,!1),ui(r[k.role][m],k,!1)}}let i={};for(let l of["claude","codex"]){let a=n[l];if(a.legs.length===0)continue;let u=Bu(a,!1);l==="claude"&&a.outer_count>0&&a.outer_cost_count===a.outer_count&&(u.total_cost_usd=a.outer_cost),i[l]=u}if(Object.keys(i).length===0)return null;let s={};for(let l of["orchestrator","implementation","review-consult","subagent"]){let a={};for(let u of["claude","codex"]){let d=r[l][u];d.legs.length>0&&(a[u]={...Bu(d,!0),legs:d.legs})}Object.keys(a).length>0&&(s[l]=a)}return{providers:i,roles:s}}var Rg=".chip-popover, .judgement-chip";function ho(e){let t=null,n=!1;function r(d){return t!==null&&t.bead_id===d.bead_id&&t.chip_key===d.chip_key}function o(d){t=r(d)?null:{...d},e()}function i(){t!==null&&(t=null,e())}function s(d){let m=d.target;t!==null&&(m&&typeof m.closest=="function"&&m.closest(Rg)||i())}function l(d){d.key==="Escape"&&i()}function a(){n||(n=!0,document.addEventListener("click",s),document.addEventListener("keydown",l))}function u(){n&&(n=!1,document.removeEventListener("click",s),document.removeEventListener("keydown",l))}return{toggle:o,close:i,isOpen:r,attach:a,detach:u}}function bo(e){return c`<div
  ...
  </div>`}var Wu={running:3,paused:2,failed:1};function ir(e){if(!e||typeof e!="object")return!1;let t=e.kind;return t==null||t==="implementation"}function zu(e){let t=Object.values(e||{}),n=new Map;for(let r of t){if(!r||typeof r.bead_id!="string"||r.bead_id.length===0||r.kind!=="review_session"||r.status!=="running")continue;let o=typeof r.started_at=="number"?r.started_at:null,i=n.get(r.bead_id);i&&(i.started_at??0)>(o??0)||n.set(r.bead_id,{attempt:r,origin:r.origin==="click"||r.origin==="auto"?r.origin:null,started_at:o})}return n}function Hu(e,t){let n=Object.values(e||{}),r=new Set,o=new Map;for(let s of n)!s||typeof s.bead_id!="string"||(typeof s.resumed_from=="string"&&s.resumed_from.length>0&&r.add(s.resumed_from),ir(s)&&o.set(s.bead_id,s.attempt_id));let i=new Map;for(let s of n){if(!s||typeof s.bead_id!="string"||s.bead_id.length===0||!ir(s))continue;let l=null;if(s.status==="running")l="running";else if(s.status==="paused"&&!r.has(s.attempt_id))l="paused";else if(s.status==="failed"||s.status==="orphaned"){let d=t.get(s.bead_id),m=typeof d=="number"&&d>0&&typeof s.finished_at=="number"&&d>=s.finished_at;o.get(s.bead_id)===s.attempt_id&&!m&&typeof s.dismissed_at!="number"&&(l="failed")}if(!l)continue;let a=typeof s.started_at=="number"?s.started_at:null,u=i.get(s.bead_id);if(u){let d=Wu[u.run_state],m=Wu[l];if(d>m||d===m&&(u.started_at??0)>(a??0))continue}i.set(s.bead_id,{attempt:s,run_state:l,started_at:a})}return{winners:i,resumed_from_ids:r}}var pi=["workflow_mode","spec_review_model","spec_review_effort","spec_review_speed","plan_review_model","plan_review_effort","plan_review_speed","impl_review_model","impl_review_effort","impl_review_speed","impl_dispatch","impl_runtime","impl_model","impl_effort","impl_speed"],Og=["quick_fix_impl_dispatch","quick_fix_impl_runtime","quick_fix_impl_model","quick_fix_impl_effort","quick_fix_impl_speed"],Yo=[...pi.filter(e=>e!=="impl_dispatch"),...Og,"base_sync_accept_local_commits","bdui_url"],Ku=["base_sync_accept_local_commits"],Vo="true";function fi(e){let t={};if(!gn(e))return t;for(let[n,r]of Object.entries(e)){if(Ku.includes(n)){r===!0&&(t[n]=Vo);continue}typeof r=="string"&&(t[n]=r)}return t}function Gu(e){let t;try{t=new URL(e)}catch{return!1}return(t.protocol==="http:"||t.protocol==="https:")&&e===t.origin}var qn=["orchestration_model","orchestration_effort","orchestration_speed"],yo=["quick_fix_orchestration_model","quick_fix_orchestration_effort","quick_fix_orchestration_speed"],Xa=Object.freeze({orchestration_model:"quick_fix_orchestration_model",orchestration_effort:"quick_fix_orchestration_effort",orchestration_speed:"quick_fix_orchestration_speed",impl_dispatch:"quick_fix_impl_dispatch",impl_runtime:"quick_fix_impl_runtime",impl_model:"quick_fix_impl_model",impl_effort:"quick_fix_impl_effort",impl_speed:"quick_fix_impl_speed"}),vo=[...pi,...qn],Ig=Yo.filter(e=>vo.includes(e));function Lg(e,t){let n={},r=[];for(let[i,s]of Object.entries(Xa)){let l=e[i];if(!Object.hasOwn(e,i)){n[s]=null;continue}let a=t[s];if(typeof l!="string"||!Array.isArray(a)||!a.includes(l)){n[s]=null,r.push(`lane_incompatible:${s}`);continue}n[s]=l}let o=Object.keys(e).filter(i=>!Object.hasOwn(Xa,i));return{values:n,warnings:r,skipped_keys:o}}var Qo=["delegated","main"],_i=["inherit","claude","codex"],Qn=["default","fast"],Xo=["standard","fast_track"],Zo=["codex","opus","fable","self","skip"],mi=["codex","fable","skip"],gi=["low","medium","high","xhigh"],Yu=["default","fast"],En="auto";function gn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Vu(e){if(!gn(e)||!gn(e.runners))return[];let t=[];for(let[n,r]of Object.entries(e.runners))gn(r)&&gn(r.models)&&t.push([n,Object.keys(r.models)]);return t}function ko(e,t){let n=Vu(e),r=t&&t!=="inherit"?n.filter(([o])=>o===t):n;return[En,...r.flatMap(([,o])=>o)]}function Qu(e,t,n,r){if(!gn(e)||!gn(e.runners))return[En];let o=[];for(let[i,s]of Object.entries(e.runners))if(!(!gn(s)||!gn(s.models))&&!(t&&t!=="inherit"&&i!==t))for(let[l,a]of Object.entries(s.models)){if(n&&n!==En&&l!==n)continue;let u=r(s,a);if(Array.isArray(u))for(let d of u)typeof d=="string"&&!o.includes(d)&&o.push(d)}return[En,...o]}function Fr(e,t,n){return Qu(e,t,n,(r,o)=>gn(o)&&Array.isArray(o.efforts)?o.efforts:r.efforts)}function hi(e,t,n){return Qu(e,t,n,(r,o)=>gn(o)&&Array.isArray(o.orchestration_efforts)?o.orchestration_efforts:gn(o)&&Array.isArray(o.efforts)?o.efforts:r.efforts)}function wo(e,t){let n=Vu(e);return(t?n.filter(([o])=>o===t):n).flatMap(([,o])=>o)}function Xu(e,t,n){let r={impl_runtime:e?.impl_runtime,impl_model:e?.impl_model,impl_effort:e?.impl_effort},o=r.impl_runtime==="claude"||r.impl_runtime==="codex"?r.impl_runtime:r.impl_runtime==="inherit"?n:null;return o&&(r.impl_model&&!ko(t,o).includes(r.impl_model)&&(r.impl_model=void 0),r.impl_effort&&!Fr(t,o,r.impl_model||En).includes(r.impl_effort)&&(r.impl_effort=void 0)),r}var Dg={workflow_mode:"\uC6CC\uD06C\uD50C\uB85C \uBAA8\uB4DC",spec_review_model:"\uC2A4\uD399 \uB9AC\uBDF0\uC5B4",spec_review_effort:"\uC2A4\uD399 \uB9AC\uBDF0 effort",spec_review_speed:"\uC2A4\uD399 \uB9AC\uBDF0 \uC18D\uB3C4",plan_review_model:"\uACC4\uD68D \uB9AC\uBDF0\uC5B4",plan_review_effort:"\uACC4\uD68D \uB9AC\uBDF0 effort",plan_review_speed:"\uACC4\uD68D \uB9AC\uBDF0 \uC18D\uB3C4",impl_review_model:"\uAD6C\uD604 \uB9AC\uBDF0\uC5B4",impl_review_effort:"\uAD6C\uD604 \uB9AC\uBDF0 effort",impl_review_speed:"\uAD6C\uD604 \uB9AC\uBDF0 \uC18D\uB3C4",impl_runtime:"\uC704\uC784 \uB300\uC0C1",impl_model:"\uAD6C\uD604 \uBAA8\uB378",impl_effort:"\uAD6C\uD604 effort",impl_speed:"\uAD6C\uD604 \uC18D\uB3C4",orchestration_model:"\uC6CC\uCEE4 \uBAA8\uB378",orchestration_effort:"\uC6CC\uCEE4 effort",orchestration_speed:"\uC6CC\uCEE4 \uC18D\uB3C4"},Pg={quick_fix_orchestration_model:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uBAA8\uB378",quick_fix_orchestration_effort:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 effort",quick_fix_orchestration_speed:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uC18D\uB3C4",quick_fix_impl_dispatch:"\uC2E4\uD589 \uBC29\uC2DD",quick_fix_impl_runtime:"\uC704\uC784 \uB300\uC0C1",quick_fix_impl_model:"\uBAA8\uB378",quick_fix_impl_effort:"effort",quick_fix_impl_speed:"\uC18D\uB3C4"},Za=[...Ig,...qn],Mg=[...vo,...Yo].filter((e,t,n)=>n.indexOf(e)===t&&!Za.includes(e));function Zu(e,t){let n=gn(e)?e:{},r=gn(t)?t:{},o=[];for(let s of Za){let l=n[s]??null,a=r[s]??null;l!==a&&o.push({key:s,label:Dg[s]||s,before:l,after:a,kind:l===null?"added":a===null?"removed":"changed"})}let i=[];for(let s of[...Mg,...Object.keys(r)])!Za.includes(s)&&!i.includes(s)&&Object.hasOwn(r,s)&&i.push(s);return{rows:o,ignored_keys:i}}function Ju(e,t,n){let r=gn(e)?e:{},o=Lg(gn(t)?t:{},n),i=[];for(let s of Object.values(Xa)){let l=r[s]??null,a=o.values[s]??null;l!==a&&i.push({key:s,label:Pg[s]||s,before:l,after:a,kind:l===null?"added":a===null?"removed":"changed"})}return{rows:i,ignored_keys:o.skipped_keys}}function Ja(e,t,n,r,o,i,s=null){return ci({key:e,choices:t,layer:"global",global:n,resolution_global:i,execution_defaults:r,runner_catalog:o,route:s})}function ed(e,t){let n={};for(let r of Yo){let o=e?.[r],i=t?.[r];if(o!==i){if(Ku.includes(r)){n[r]=i===Vo?!0:null;continue}n[r]=typeof i=="string"&&i.length>0?i:null}}return n}function td(e,t){let n={};for(let r of[...qn,...yo]){let o=e?.[r]??null,i=t?.[r]??null;o!==i&&(n[r]=typeof i=="string"&&i.length>0?i:null)}return n}var el=[{id:"workflow",label:"\uC6CC\uD06C\uD50C\uB85C\uC6B0",keys:["workflow_mode"]},{id:"review",label:"\uB9AC\uBDF0",keys:["spec_review_model","spec_review_effort","spec_review_speed","plan_review_model","plan_review_effort","plan_review_speed","impl_review_model","impl_review_effort","impl_review_speed"]},{id:"implementation",label:"\uAD6C\uD604",keys:["impl_dispatch","impl_runtime","impl_model","impl_effort","impl_speed"]},{id:"worker",label:"Worker",keys:[...qn]}],yr={workflow_mode:"\uBAA8\uB4DC",spec_review_model:"\uC0AC\uC591 \uB9AC\uBDF0",spec_review_effort:"\uC0AC\uC591 \uB9AC\uBDF0 effort",spec_review_speed:"\uC0AC\uC591 \uB9AC\uBDF0 \uC18D\uB3C4",plan_review_model:"\uACC4\uD68D \uB9AC\uBDF0",plan_review_effort:"\uACC4\uD68D \uB9AC\uBDF0 effort",plan_review_speed:"\uACC4\uD68D \uB9AC\uBDF0 \uC18D\uB3C4",impl_review_model:"\uAD6C\uD604 \uB9AC\uBDF0",impl_review_effort:"\uAD6C\uD604 \uB9AC\uBDF0 effort",impl_review_speed:"\uAD6C\uD604 \uB9AC\uBDF0 \uC18D\uB3C4",impl_dispatch:"\uC2E4\uD589 \uBC29\uC2DD",impl_runtime:"\uC704\uC784 \uB300\uC0C1",impl_model:"\uBAA8\uB378",impl_effort:"effort",impl_speed:"\uC18D\uB3C4",orchestration_model:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uBAA8\uB378",orchestration_effort:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 effort",orchestration_speed:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uC18D\uB3C4"},bi={pin:"\uD540",global:"\uC804\uC5ED",base:"\uAE30\uBCF8"};function tl(e,t,n,r,o,i=null){let s=On({pin:t,global:n,execution_defaults:r,runner_catalog:o,route:t&&typeof t.route=="string"?t.route:null,controller_runtime:i});return e.map(l=>({key:l,...s[l]}))}function nd(e,t,n,r,o,i=null){let s={pin:0,global:0,base:0};for(let l of tl(e,t,n,r,o,i))s[l.source]+=1;return s}function rd(e,t,n){return{id:e,key:t,value:typeof n=="string"?n:""}}function od(e,t,n){return typeof t!="string"||t.length===0?null:{id:e,preset_id:t,expected_revision:n}}var Ix=[...pi,...qn];var sd=["orchestration_model","orchestration_effort","orchestration_speed","spec_review_model","spec_review_effort","spec_review_speed","plan_review_model","plan_review_effort","plan_review_speed","impl_review_model","impl_review_effort","impl_review_speed","impl_runtime","impl_model","impl_effort"];function Jo(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function yi(e){if(!Jo(e)||!Jo(e.runners))return null;let t=Object.entries(e.runners).filter(([,n])=>Jo(n)&&Jo(n.models));return t.length>0?t:null}function Nn(e,t){let n=yi(e);if(!n||!t)return null;for(let[r,o]of n)if(Object.hasOwn(o.models,t))return r;return null}function id(e,t){return Jo(t)&&Array.isArray(t.efforts)?t.efforts.slice():Array.isArray(e.efforts)?e.efforts.slice():[]}function ad(e,t){let n=yi(e);if(!n||!t)return[];for(let[,r]of n)if(Object.hasOwn(r.models,t))return id(r,r.models[t]);return[]}function qg(e){let t=yi(e);if(!t)return[];let n=[];for(let[,r]of t)for(let o of Object.values(r.models))for(let i of id(r,o))n.includes(i)||n.push(i);return n}function Ng(e,t){if(!t)return qg(e);let r=yi(e)?.find(([i])=>i===t)?.[1];if(!r)return[];let o=[];for(let i of Object.keys(r.models))for(let s of ad(e,i))o.includes(s)||o.push(s);return o}function ld(e,t,n){let r={impl_runtime:e.impl_runtime||"",impl_model:e.impl_model||"",impl_effort:e.impl_effort||""},o=r.impl_runtime==="inherit"?n:r.impl_runtime==="claude"||r.impl_runtime==="codex"?r.impl_runtime:null;if(r.impl_runtime==="inherit"&&!o)return r.impl_model="",r.impl_effort="",r;let i=Nn(t,r.impl_model);if(r.impl_model&&(!o||i!==o))return r.impl_model="",r.impl_effort="",r;let s=r.impl_model?ad(t,r.impl_model):Ng(t,o);return r.impl_effort&&s.length>0&&!s.includes(r.impl_effort)&&(r.impl_effort=""),r}var nl=new Set(["unavailable","not_applicable"]);function vr(e,t){if(typeof e!="object"||e===null)return null;let n=e[t];return typeof n=="object"&&n!==null?n:null}function cd(e){return e.filter(t=>t!==null).join(" \xB7 ")}function kr(e,t){return t===null?null:`${yr[e]}: ${t.display} (${bi[t.source]})`}function rl(e){return e.filter(t=>t!==null).join(`
`)}function vi(e){if(typeof e!="object"||e===null)return null;let t=Rn(e);if(t==="")return null;let n=(r,o)=>typeof o=="string"&&o.length>0?`${r}: ${o}`:null;return{text:t,title:rl(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(yr.orchestration_model,e.model),n(yr.orchestration_effort,e.effort),n(yr.orchestration_speed,e.speed)])}}function $o(e,t){let n=vr(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=vr(e,"orchestration_effort"),o=vr(e,"orchestration_speed"),i=cd([Nn(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,o!==null&&o.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:rl(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",kr("orchestration_model",n),kr("orchestration_effort",r),kr("orchestration_speed",o)])}}function jg(e,t){return e===null||e.value===null||nl.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function Fg(e){return e===null||nl.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function Bg(e){return e===null?null:e.value==="auto"?"auto":nl.has(e.resolution)?null:e.display}function Br(e,t){if(typeof e!="object"||e===null)return null;let n=vr(e,"impl_dispatch"),r=vr(e,"impl_runtime"),o=vr(e,"impl_model"),i=vr(e,"impl_effort"),s=vr(e,"impl_speed"),l=n!==null&&n.value==="main"?"\uBA54\uC778":cd([jg(r,t??null),Fg(o),Bg(i),s!==null&&s.value==="fast"?"Fast":null]);return l===""?null:{text:l,title:rl(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",kr("impl_dispatch",n),kr("impl_runtime",r),kr("impl_model",o),kr("impl_effort",i),kr("impl_speed",s)])}}var Ug=Object.freeze(new Set(["push_not_contained","invalid_impl_review","premature_close","head_mismatch","foreign_deploy_unsupported","not_resolved"])),Wg=Object.freeze(["delivery_unproven:"]);function ki(e){let t=e&&typeof e.reason=="string"?e.reason:"";if(t.length===0||Ug.has(t))return"session";for(let n of Wg)if(t.startsWith(n))return"session";return"settlement"}var zg=["hard_diagnosis","invariant_reasoning","verification_by_judgment","claude_bound"];var Hg={hard_diagnosis:"\uC6D0\uC778\uC774 \uBD88\uBA85\uD655\uD558\uAC70\uB098 \uC7AC\uD604\uC774 \uBD88\uC548\uC815\uD574 \uAC00\uC124-\uAC80\uC99D \uB8E8\uD504\uAC00 \uD544\uC694\uD558\uB2E4",invariant_reasoning:"\uC815\uD569\uC131\uC774 \uC0C1\uD0DC\uAE30\uACC4\xB7\uB3D9\uC2DC\uC131\xB7\uBD88\uBCC0\uC2DD \uCD94\uB860\uC5D0 \uB2EC\uB824 \uC788\uB2E4",verification_by_judgment:"\uD14C\uC2A4\uD2B8\uAC00 \uBABB \uC7A1\uACE0 \uB9AC\uBDF0\uC5B4\uC758 \uCD94\uB860\uC73C\uB85C\uB9CC \uAC80\uC99D\uD560 \uC218 \uC788\uB2E4",claude_bound:"Claude \uC138\uC158 \uC790\uC0B0\xB7\uC758\uBBF8\uB860\uC5D0 \uAC15\uD558\uAC8C \uBB36\uC5EC \uC788\uB2E4"};function ol(e){return(e&&Array.isArray(e.reasons)?e.reasons:[]).map(n=>Hg[n]||"").filter(n=>n.length>0)}var ud={orchestration_model:["fable"],impl_runtime:["claude"]},sl={unapplied:"\uBBF8\uC801\uC6A9",applied:"\uC801\uC6A9\uB428",diverged:"\uCD94\uCC9C\uACFC \uB2E4\uB984"};function dd(e){return typeof e=="object"&&e!==null?e:null}function pd(e,t){return typeof e=="string"&&t.includes(e)?e:""}function Kg(e){return typeof e!="string"?[]:e.split("+").map(t=>t.trim()).filter(t=>zg.includes(t))}function es(e,t=e){let n=dd(e);if(!n)return null;let r=pd(n.rec_orchestration_model,ud.orchestration_model);if(r.length===0)return null;let o=pd(n.rec_impl_runtime,ud.impl_runtime),i={orchestration_model:r};o.length>0&&(i.impl_runtime=o);let s=dd(t)||{},l=Object.keys(i),a=0,u=0;for(let m of l){let b=s[m];typeof b=="string"&&b.length>0&&(a+=1,b===i[m]&&(u+=1))}let d=a===0?"unapplied":u===l.length?"applied":"diverged";return{reasons:Kg(n.rec_reason),rec:i,state:d}}function wi(e){if(!e||typeof e!="object")return"";let t=ol(e),n=sl[e.state]||"",r=["\uBCF5\uC7A1\uD55C \uC791\uC5C5\uC73C\uB85C \uD310\uC815\uB428"];return t.length>0&&r.push(`\uC0AC\uC720: ${t.join(" \xB7 ")}`),n.length>0&&r.push(`\uC0C1\uD0DC: ${n}`),r.join(`
`)}function $i(e){return e.replace(/\/+$/,"")}function Gg(e,t){let n=$i(e),r=$i(t);return n===r||r.startsWith(`${n}/`)||n.startsWith(`${r}/`)}function xi(e,t){let n=new Set;for(let r of e)for(let o of t){if(!Gg(r,o))continue;let i=$i(r),s=$i(o);n.add(i.length>=s.length?i:s)}return[...n].sort()}function il(e,t){return`${e}\0${t}`}function fd(e){let t=new Map;for(let n of Array.isArray(e?.running)?e.running:[])t.set(n.id,{root_dir:n.root_dir,workspace_name:n.workspace_name,lane:"running",state:"running"});for(let n of Array.isArray(e?.pr_wait)?e.pr_wait:[])t.set(n.id,{root_dir:n.root_dir,workspace_name:n.workspace_name,lane:"pr_wait",state:"pr_wait"});for(let n of Array.isArray(e?.queue_groups)?e.queue_groups:[]){let r=Array.isArray(n.sublanes?.parallel)?n.sublanes.parallel:Array.isArray(n.items)?n.items:[];for(let o of r)t.set(o.id,{root_dir:o.root_dir,workspace_name:o.workspace_name,lane:"parallel",position:o.queue_position});for(let o of Array.isArray(n.sublanes?.serial)?n.sublanes.serial:[])for(let i of o.items)t.set(i.id,{root_dir:i.root_dir,workspace_name:i.workspace_name,lane:o.id,position:i.queue_position})}for(let n of Array.isArray(e?.runnable)?e.runnable:[])t.set(n.id,{root_dir:n.root_dir,workspace_name:n.workspace_name,lane:"runnable",state:"runnable"});for(let n of Array.isArray(e?.done)?e.done:[])t.set(n.id,{root_dir:n.root_dir,workspace_name:n.workspace_name,lane:"done",state:"done"});return t}function ns(e,t){let n=Array.isArray(t)?t:[],r=e.indexOf("-"),o=r>0?e.slice(0,r):e;return n.some(i=>typeof i?.issue_prefix=="string"&&i.issue_prefix===o)?"internal":n.length>0&&n.every(i=>typeof i?.issue_prefix=="string")?"external":"unknown"}function ts(e){if(e.state==="running")return"\uC2E4\uD589\uC911";if(e.state==="pr_wait")return"PR \uB300\uAE30";if(e.state==="runnable")return"\uC2E4\uD589\uAC00\uB2A5";if(e.state==="done")return"\uC644\uB8CC";let t=e.lane==="parallel"?"\uBCD1\uB82C":e.lane;return`${e.workspace_name} \xB7 ${t} #${e.position}`}function _d(e,t,n,r){let o=n.get(e);if(!!(o&&t&&o.root_dir===t.root_dir&&o.lane===t.lane&&typeof o.position=="number"&&typeof t.position=="number"&&o.position<t.position))return{id:e,label:`\u{1F512} ${e} (\uAC19\uC740 \uB808\uC778 \uC55E)`,location_label:"\uAC19\uC740 \uB808\uC778 \uC55E",scope:null,same_lane_ahead:!0};if(o)return{id:e,label:`\u{1F512} ${e} (${ts(o)})`,location_label:ts(o),scope:null,same_lane_ahead:!1};let s=ns(e,r),l=s==="internal"?"\uBBF8\uC801\uC7AC":s==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778";return{id:e,label:`\u{1F512} ${e} (${l})`,location_label:l,scope:s,same_lane_ahead:!1}}function md(e){let t=Array.isArray(e)?e:[],n=new Map,r=new Map,o=new Map;for(let l of t)for(let a of Array.isArray(l.sublanes?.serial)?l.sublanes.serial:[]){let u=il(l.root_dir,a.id);n.set(u,{root_dir:l.root_dir,workspace_name:l.name,lane:a.id}),o.set(u,[]);for(let d of Array.isArray(a.items)?a.items:[])r.set(d.id,u)}for(let l of t)for(let a of Array.isArray(l.sublanes?.serial)?l.sublanes.serial:[]){let u=il(l.root_dir,a.id),d=Array.isArray(a.items)?a.items[0]:null,b=!!d&&d.queue_index===0&&(!Array.isArray(a.occupied_by)||a.occupied_by.length===0)&&Array.isArray(d.blocked_by)?d.blocked_by:[],h=o.get(u);if(h)for(let k of b){let S=r.get(k);S&&S!==u&&!h.includes(S)&&h.push(S)}}let i=(l,a)=>{let u=new Set,d=[l];for(;d.length>0;){let m=d.pop();if(m===a)return!0;!m||u.has(m)||(u.add(m),d.push(...o.get(m)||[]))}return!1},s=new Map;for(let[l,a]of o){let u=[];for(let d of a){let m=n.get(d);i(d,l)&&m&&u.push(m)}u.length>0&&s.set(l,u)}return s}function gd(e,t){return il(e,t)}var Yg=Object.freeze(["done","abandoned"]);function hd(e){return!e||typeof e!="object"||Array.isArray(e)?!1:typeof e.phase=="string"&&!Yg.includes(e.phase)}async function Vg(e){let t=await yn(e);_e(t?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",t?"success":"error",1200)}function Ur(e){return typeof e!="string"||e.length===0?"":c`<span class="worker-ev__copyline"
  ...
  >`}var bd=Object.freeze(["spec_backed","full_plan","quick_fix"]);var Qg="worker-ineligible";function rs(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function yd(e){return rs(e).includes(Qg)}var Xg=new Set(bd),vd=new WeakMap;function xo(e){return e&&typeof e=="object"?e:{}}function Zg(e){let t=vd.get(e);if(t)return t;let n=wd(e);return vd.set(e,n),n}function Ai(e,t){return(Array.isArray(e)?e:[]).findIndex(r=>r&&r.bead_id===t)}function Jg(e,t){if(e.length===0)return null;if(Zg(t).has(e))return{lane:"running"};if(Ai(t.pr_wait,e)>=0)return{lane:"pr_wait"};let n=Ai(t.queue,e);if(n>=0)return{lane:"parallel",index:n};for(let r of Array.isArray(t.serial_lanes)?t.serial_lanes:[]){if(!r||typeof r.id!="string"||!/^s[1-5]$/.test(r.id))continue;let o=Ai(r.entries,e);if(o>=0)return{lane:r.id,index:o}}return Ai(t.done,e)>=0?{lane:"done"}:null}function al(e,t){let n=Xg.has(e.route),r=e.route==="quick_fix";return{placeable:n&&!e.worker_ineligible&&!e.awaiting_user&&(r?e.has_description:e.spec==="published")&&t===null,route_ok:n,worker_ineligible:e.worker_ineligible,awaiting_user:e.awaiting_user,missing_description:r&&!e.has_description,spec:e.spec,location:t}}function os(e,t){let n=xo(e),r=xo(t),o=ao(n),i=n.workflow?.route_source==="explicit"&&typeof n.workflow.route=="string"&&n.workflow.route||(typeof xo(n.metadata).route=="string"?xo(n.metadata).route:""),s=i==="quick_fix",l=!Object.hasOwn(n,"description")||typeof n.description=="string"&&n.description.trim().length>0,a=Object.hasOwn(n,"labels")&&yd(n.labels),u=Object.hasOwn(xo(n.metadata),"awaiting_user"),d=Jg(typeof n.id=="string"?n.id:"",r);return al({route:i,spec:s?"n/a":o.conflict?"conflict":o.evidence,has_description:l,awaiting_user:u,worker_ineligible:a},d)}function Wr(e){let t=e.location;if(t)switch(t.lane){case"running":return"\uC2E4\uD589 \uC911\uC774\uB77C \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4";case"pr_wait":return"PR \uB300\uAE30 \uC911\uC774\uB77C \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4";case"done":return"\uC644\uB8CC \uB808\uC778\uC5D0 \uC788\uC5B4 \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4";case"parallel":return`\uC774\uBBF8 \uB300\uAE30 \uC911 \xB7 \uBCD1\uB82C #${t.index+1}`;default:return`\uC774\uBBF8 \uB300\uAE30 \uC911 \xB7 \uC9C1\uB82C ${t.lane.slice(1)} #${t.index+1}`}return e.placeable?"\uB300\uAE30 \uD050 \uB9E8 \uB4A4\uC5D0 \uCD94\uAC00":e.route_ok===!1?"route\uAC00 \uC815\uD574\uC9C0\uC9C0 \uC54A\uC544 \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":e.worker_ineligible?"worker-ineligible label\uB85C \uC6CC\uCEE4\uC5D0\uC11C \uC2E4\uD589\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":e.awaiting_user?"\uC0AC\uC6A9\uC790 \uB9AC\uBDF0\uB97C \uAE30\uB2E4\uB9AC\uB294 \uC911\uC774\uB77C \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":e.missing_description?"description\uC774 \uC5C6\uC5B4 \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":e.spec==="conflict"?"spec \uACBD\uB85C\uAC00 \uCDA9\uB3CC\uD574 \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"spec\uC774 \uBC1C\uD589\uB418\uC9C0 \uC54A\uC544 \uB300\uAE30 \uD050\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"}function ss(e){let t=xo(e),n=typeof t.serial_lane_count=="number"&&Number.isInteger(t.serial_lane_count)&&t.serial_lane_count>0?Math.min(t.serial_lane_count,5):0,r=Array.isArray(t.serial_lanes)?t.serial_lanes:[],o=[];for(let s of r){if(o.length>=n)break;!s||typeof s.id!="string"||!/^s[1-5]$/.test(s.id)||!Array.isArray(s.entries)||o.push({id:s.id,label:`\uC9C1\uB82C ${s.id.slice(1)}`,count:s.entries.length})}return o.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(t.queue)?t.queue:[]).length},...o]}function kd(e){return/^s[1-5]$/.test(e)?`\uC9C1\uB82C ${e.slice(1)}`:"\uBCD1\uB82C"}function Ti(e){return typeof e=="string"&&e.length>=7?e.slice(0,7):"\u2014"}function Ad(e){return e==="session"?"bead\uAC00 in_progress\uB85C \uC7A1\uD78C \uB4A4 \uB2EB\uD788\uAE30\uAE4C\uC9C0\uC758 \uACBD\uACFC":"attempt \uC2E4\uD589 \uC2DC\uAC04 \uD569\uC0B0 (\uC7AC\uAC1C \uC138\uC158 \uD3EC\uD568)"}function zr(e){if(typeof e!="number"||!Number.isFinite(e)||e<0)return"\u2014";if(e<1e3)return`${Math.round(e)}ms`;let t=e/1e3;if(t<60)return`${t.toFixed(1)}\uCD08`;let n=Math.floor(t/60);if(n<60)return`${n}\uBD84 ${Math.round(t-n*60)}\uCD08`;let r=Math.floor(n/60),o=n%60;return`${r}\uC2DC\uAC04 ${o}\uBD84`}function Sd(e,t){if(typeof e!="object"||e===null)return[];let n=!1,r=!1;for(let o of Object.values(e)){if(typeof o!="object"||o===null)continue;let i=o;i.bead_id!==t||i.kind!=="review_session"||(n=!0,r=r||i.origin==="auto")}return n?[r?"\uB9AC\uBDF0 \xB7 \uC790\uB3D9":"\uB9AC\uBDF0"]:[]}function $d(e){return e==="auto"||e==="click"?e:null}function Ed(e,t){if(typeof e!="object"||e===null)return{active:!1,failure:null,origin:null};let n=!1,r=null,o=-1,i=null,s=null,l=-1;for(let a of Object.values(e)){if(typeof a!="object"||a===null)continue;let u=a;if(u.bead_id!==t||u.kind!=="review_session")continue;if(u.status==="pending"||u.status==="running"){n=!0;let m=typeof u.started_at=="number"?u.started_at:0;m>=o&&(o=m,r=$d(u.origin));continue}if(u.status!=="failed")continue;let d=typeof u.finished_at=="number"?u.finished_at:0;d>=l&&(l=d,i=typeof u.cause=="string"&&u.cause.length>0?u.cause:null,s=$d(u.origin))}return n?{active:!0,failure:null,origin:r}:{active:!1,failure:i,origin:s}}function Td(e,t){if(typeof e!="object"||e===null)return null;let n=0,r=!1;for(let o of Object.values(e)){if(typeof o!="object"||o===null)continue;let i=o;if(i.bead_id!==t)continue;let s=i.started_at,l=i.finished_at;typeof s!="number"||typeof l!="number"||!Number.isFinite(s)||!Number.isFinite(l)||l<s||(n+=l-s,r=!0)}return r?n:null}function Ci(e){if(typeof e!="number"||!Number.isFinite(e)||e<=0)return"";let t=new Date(e);return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}function eh(e,t){let n=Array.isArray(e)?e:[],r=Array.isArray(t)?t:[];if(n.length===0&&r.length===0)return null;let o=null;for(let s of n)s.kind!=="deploy"||s.state!=="succeeded"||typeof s.target_sha!="string"||(!o||(typeof s.finished_at=="number"?s.finished_at:0)>(typeof o.finished_at=="number"?o.finished_at:0))&&(o=s);let i=n.filter(s=>s.state==="failed"&&!s.dismissed&&!s.superseded_by).length+r.length;return{deploy:o?{sha:Ti(o.target_sha),at:typeof o.finished_at=="number"?o.finished_at:null,elapsed_ms:typeof o.elapsed_ms=="number"?o.elapsed_ms:null}:null,unresolved:i,badge:i>0?{tone:"act",label:`\uD574\uACB0 \uD544\uC694 ${i}`}:{tone:"quiet",label:"\uBAA8\uB450 \uC815\uC0C1"}}}function Cd(e,t){let n=eh(e,t);return n?c`<button
    type="button"
  ...
  >
    ...
    ${t?c`<span title=${`\uC0DD\uC131 ${ln(e.created_at)}`}
        ...
        >`:""}${t&&n?c`<span>·</span>`:""}${n?c`<span title=${`\uC218\uC815 ${ln(e.updated_at)}`}
          >수정 ${n}</span
        >`:""}
  </div>`}function th(e){return!e||e==="requested"?"\uBC31\uC5C5 \uC911":e==="abandoned"?"\uD3D0\uAE30 \uD3EC\uAE30\uB428":e==="backup_verified"||e==="signaled"?"runner \uC885\uB8CC \uC911":e==="merged_revert"||e.startsWith("revert_")?"revert PR \uB300\uAE30":e.startsWith("rollback_")?"\uC6D0\uBCF5 \uBC30\uD3EC \uC911":e==="runner_terminated"||e.startsWith("pr_")||e.includes("ref_")||e.includes("worktree")||e.startsWith("bead_")?"PR \uC815\uB9AC \uC911":`\uD3D0\uAE30 \uCC98\uB9AC \uC911 (${e})`}function as(e,t){return t==="merged"?`${e}: \uC774\uBBF8 merge\uB41C \uAD6C\uD604\uC785\uB2C8\uB2E4. \uBCF5\uAD6C archive\uB97C \uB9CC\uB4E0 \uB4A4 revert PR\uC744 \uC0DD\uC131\uD558\uBA70, \uC2E4\uC81C \uC6D0\uBCF5\uC740 \uC0AC\uB78C\uC774 \uADF8 PR\uC744 merge\uD55C \uB4A4 \uC644\uB8CC\uB429\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`:`${e}: \uBCF5\uAD6C archive\uB97C \uB9CC\uB4E0 \uB4A4 runner/PR/branch/worktree\uB97C \uC815\uB9AC\uD558\uACE0 \uC774\uC288\uB97C \uD6C4\uBCF4\uB85C \uB418\uB3CC\uB9BD\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`}function ls(e,t){return t.kind==="stale_work_backup_fresh"?`${e}: \uC2E4\uD328\uD55C \uBC31\uC5C5 \uC791\uC5C5\uC744 \uD3EC\uAE30\uD569\uB2C8\uB2E4. \uBC31\uC5C5\uC740 \uB9CC\uB4E4\uC5B4\uC9C0\uC9C0 \uC54A\uC558\uACE0 \uAE30\uC874 \uC791\uC5C5\uC740 \uADF8\uB300\uB85C \uB0A8\uC2B5\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`:`${e}: \uC2E4\uD328\uD55C \uD3D0\uAE30 \uC791\uC5C5\uC744 \uD3EC\uAE30\uD569\uB2C8\uB2E4. \uBC31\uC5C5\uACFC \uD3D0\uAE30\uB294 \uC218\uD589\uB418\uC9C0 \uC54A\uC558\uACE0 bead\uB294 \uD3D0\uAE30 \uC774\uC804 \uC0C1\uD0DC\uB85C \uB3CC\uC544\uAC11\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`}function Ri(e){return e.kind==="stale_work_backup_fresh"?`\uBC31\uC5C5 \uD3EC\uAE30\uB428 \xB7 \uAE30\uC874 \uC791\uC5C5\uC740 \uADF8\uB300\uB85C \uB0A8\uC2B5\uB2C8\uB2E4 (\uC6D0\uC778: ${e.last_error})`:`\uD3D0\uAE30 \uD3EC\uAE30\uB428 \xB7 \uD3D0\uAE30\uB294 \uC218\uD589\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 (\uC6D0\uC778: ${e.last_error})`}function Oi(e){let t=["\uD3D0\uAE30 \uC644\uB8CC"];return e.operation_id&&t.push(`\uC791\uC5C5 ${e.operation_id}`),e.receipt?.archive_path&&t.push(`\uBC31\uC5C5 ${e.receipt.archive_path}`),e.receipt?.original_pr?.url&&t.push(`\uC6D0\uBCF8 PR ${e.receipt.original_pr.url}`),e.receipt?.revert_pr?.url&&t.push(`revert PR ${e.receipt.revert_pr.url}`),t.join(" \xB7 ")}function Rd(e){return e?.startsWith("orphan_gitlink_content:")?`\uB9E4\uD551 \uC5C6\uB294 gitlink \uACBD\uB85C ${e.slice(23)}\uC5D0 \uB0B4\uC6A9\uC774 \uC788\uC2B5\uB2C8\uB2E4 \u2014 \uC800\uC7A5\uC18C\uC5D0\uC11C \uADF8 \uACBD\uB85C\uB97C \uC815\uB9AC\uD55C \uB4A4 \uC7AC\uC2DC\uB3C4\uD558\uAC70\uB098 \uD3EC\uAE30\uD558\uC138\uC694`:e==="dirty_submodule"?"\uC11C\uBE0C\uBAA8\uB4C8\uC5D0 \uBBF8\uCEE4\uBC0B \uBCC0\uACBD\uC774\uB098 \uBBF8\uCD08\uAE30\uD654 \uD56D\uBAA9\uC774 \uC788\uC2B5\uB2C8\uB2E4 \u2014 \uC815\uB9AC \uD6C4 \uC7AC\uC2DC\uB3C4\uD558\uC138\uC694":e==="submodule_observation_failed"?"\uC11C\uBE0C\uBAA8\uB4C8 \uC0C1\uD0DC\uB97C \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (git \uC624\uB958) \u2014 \uC6CC\uD06C\uD2B8\uB9AC\uC5D0\uC11C git \uBA85\uB839\uC744 \uC9C1\uC811 \uD655\uC778\uD558\uC138\uC694":null}function ar(e,t,n={}){let o=Object.values(e&&typeof e=="object"?e:{}).filter(b=>b&&b.bead_id===t&&hd(b)).sort((b,h)=>(b.requested_at||0)-(h.requested_at||0)).at(-1),i=typeof n.attempt_id=="string"&&n.attempt_id.length>0?n.attempt_id:typeof o?.attempt_id=="string"?o.attempt_id:null,s=n.external?"\uC678\uBD80 PR\uC740 Worker\uAC00 \uC18C\uC720\uD558\uC9C0 \uC54A\uC544 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":n.done?"\uC644\uB8CC\uB41C \uC791\uC5C5\uC740 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":n.merge_active?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":n.merge_queued?"\uBA38\uC9C0 \uD050\uC5D0 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 [\uCDE8\uC18C]\uD558\uC138\uC694":n.conflict_active?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 \uC138\uC158\uC744 \uC815\uB9AC\uD558\uC138\uC694":n.cleanup_active?"\uC815\uB9AC \uC9C4\uD589 \uC911 \u2014 \uD3D0\uAE30\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":null,l=typeof o?.last_error=="string"?o.last_error:null,a=o?th(o.phase):null,u=o?.kind==="stale_work_backup_fresh",d=Rd(l),m=n.merged||o?.mode==="merged_revert"?"merged":"unmerged";return{action:!n.external&&!n.done,enabled:!s&&(!o||!!l),label:u?l?"\uBC31\uC5C5 \uC815\uB9AC \uC7AC\uC2DC\uB3C4":"\uBC31\uC5C5 \uD6C4 \uC0C8\uB85C \uC2DC\uC791":l?"\uC7AC\uC2DC\uB3C4":"\uD3D0\uAE30",title:s||(l?d?`\uD3D0\uAE30 \uC2E4\uD328: ${l} \u2014 ${d}`:u?`\uBC31\uC5C5 \uB4A4 \uC815\uB9AC \uC2E4\uD328: ${l} \u2014 \uC6D0\uBCF8\uACFC \uAC80\uC99D \uC601\uC218\uC99D\uC744 \uBCF4\uC874\uD55C \uCC44 \uC7AC\uC2DC\uB3C4\uD569\uB2C8\uB2E4`:`\uD3D0\uAE30 \uC2E4\uD328: ${l} \u2014 \uAC19\uC740 \uC791\uC5C5\uC744 \uC7AC\uC2DC\uB3C4\uD569\uB2C8\uB2E4`:o?`${a||"\uD3D0\uAE30 \uCC98\uB9AC \uC911"} \u2014 \uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694`:m==="merged"?"\uBCD1\uD569\uB41C \uBCC0\uACBD\uC744 \uC6D0\uBCF5 PR\uB85C \uB418\uB3CC\uB9BD\uB2C8\uB2E4":"\uBC31\uC5C5 \uD6C4 runner\xB7PR\xB7\uC6CC\uD06C\uD2B8\uB9AC\xB7\uBE0C\uB79C\uCE58\uB97C \uD3D0\uAE30\uD569\uB2C8\uB2E4"),attempt_id:i,operation:o||null,progress:a,error:l,confirmation:m,abandon:{action:!!o&&o.phase==="requested"&&!!l,label:u?"\uBC31\uC5C5 \uD3EC\uAE30":"\uD3D0\uAE30 \uD3EC\uAE30",title:u?"\uC2E4\uD328\uD55C \uBC31\uC5C5 \uC791\uC5C5\uC744 \uD3EC\uAE30\uD569\uB2C8\uB2E4 \u2014 \uC6D0\uBCF8\uC740 \uADF8\uB300\uB85C \uB0A8\uACE0 \uC0C8\uB85C \uC2DC\uC791\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4":"\uC2E4\uD328\uD55C \uD3D0\uAE30 \uC791\uC5C5\uC744 \uD3EC\uAE30\uD569\uB2C8\uB2E4 \u2014 \uBC31\uC5C5\xB7\uD3D0\uAE30\uB294 \uC218\uD589\uB418\uC9C0 \uC54A\uC558\uACE0 bead\uB294 \uD3D0\uAE30 \uC774\uC804 \uC0C1\uD0DC\uB85C \uB3CC\uC544\uAC11\uB2C8\uB2E4"}}}function Od(e){if(!e||e.quickfix_lane!==!0)return!1;let t=e.quickfix_landing;return!t||typeof t!="object"?!1:["repo_operations","branch_cleanup","parent_close"].includes(t.cursor)}function Ei(e){let t=e.discard;if(!t||!t.operation)return"";let n=t.operation,r=Rd(t.error),o=n.kind==="stale_work_backup_fresh"&&!t.error?null:n.backup?.path,i=n.original_pr,s=n.revert_pr;return c`<div
  ...
  >
    ${e.label}
        ...
        ${r.map(d=>is(d,"released"))}${i.map(d=>is(rh(d),"overlap"))}${s?c`<span
              ...
              >scope 없음</span
            >`:""}
      </div>`:""}`}function Dd(e,t=""){let n=(Array.isArray(e)?e:[]).filter(r=>typeof r=="string"&&r!=="").slice().sort();return n.length===0?"":c`<div class="worker-deps worker-deps--secondary">
...
`);return c`<button
  ...
  </button>`}function Pd(e){return e?c`<button
    type="button"
    class="ctl-chip ctl-chip--from"
    data-from-id=${e}
    title=${`\uCD9C\uCC98 ${e} \uC5F4\uAE30`}
  ...
  >
    ${r}
  </button>`}function Md(e){let t=e.receipt_badge?e.receipt_badge.codes:null;return Array.isArray(t)?t.filter(n=>typeof n=="string"&&n.length>0):[]}function qd(e,t){return!e||typeof t!="number"?"":c`<a
  ...
  >
    <div class="worker-mini__row1">
      ...
      ${qd(e.pr_url,e.pr_number)}${o?c`<span
  ...
  </div>`}function Mi(e,t){return typeof e=="number"?e+jd-t:0}function ul(e,t=Date.now()){let n=Mi(e,t);return n<=0?"":c`<span
  ...
  >
    ...
    >${e.id}</span
  >`,k=Kr(e.workflow),S=e.lane==="done"?"":Pd(e.from_id),T=Pi(e.priority),ee=c`<span class="worker-mini__title">${e.title}</span>`,re=qd(e.pr_url,e.pr_number),U=r.map(G=>G===e.live_badge?c`<span
  ...
  >
    ${a?c`<div class="worker-mini__row1">
      ...
      </button>`)}return c`${r}`}var Nd={external_roundtrip:"\uD558\uB124\uC2A4 \uBC16 \uC0C1\uB300\uC640 \uC608\uCE21 \uBD88\uAC00 \uC655\uBCF5 \uBC18\uBCF5 \u2014 \uB2E4\uB978 rig \uC138\uC158\xB7\uC0AC\uB78C\xB7\uC678\uBD80 \uC2DC\uC2A4\uD15C",user_feedback_loop:"\uC9C4\uD589 \uC911 \uC0AC\uC6A9\uC790 \uD53C\uB4DC\uBC31 \uC5C6\uC774\uB294 \uD488\uC9C8\uC774 \uB0AE\uC74C \u2014 \uBB38\uC548\xB7\uC124\uACC4 \uC138\uBD80\xB7\uBC29\uD5A5 \uC120\uD0DD"};function fl(e,t){if(t==="rec"){let n=e.rec;if(!n)return null;let r=sl[n.state]||"";return{title:"\uBCF5\uC7A1\uD55C \uC791\uC5C5\uC73C\uB85C \uD310\uC815\uB428",lines:[...ol(n),...r.length>0?[`\uC0C1\uD0DC: ${r}`]:[],"\uC801\uC6A9\uC740 \uC774\uC288 \uC0C1\uC138\uC758 \uC2E4\uD589 \uC124\uC815 \uD3B8\uC9D1\uAE30\uC5D0\uC11C"]}}if(t==="session_preferred"){if(e.session_preferred!==!0)return null;let n=Nd[e.session_preferred_reason||""]||"";return{title:"\uC6CC\uCEE4\uB85C \uB3CC\uB9B4 \uC218 \uC788\uC9C0\uB9CC \uC138\uC158\uC774 \uB0AB\uB2E4",lines:n.length>0?[n]:[]}}if(t==="ineligible")return e.worker_ineligible!==!0?null:{title:"\uC6CC\uCEE4 \uC2E4\uD589 \uB300\uC0C1\uC774 \uC544\uB2C8\uB2E4",lines:["worker-ineligible \uB77C\uBCA8\uC774 \uBD99\uC5B4 \uC788\uB2E4 \u2014 \uB77C\uBCA8\uC740 \uC774\uC288 \uC0C1\uC138\uC758 \uB77C\uBCA8 \uC808\uC5D0\uC11C \uB5C0\uB2E4"]};if(t==="spec_after_blocker")return e.spec_after_blocker!==!0?null:{title:"\uC120\uD589 \uACB0\uACFC\uAC00 \uC124\uACC4 \uC804\uC81C \u2014 \uC2A4\uD399\uB3C4 \uC120\uD589 \uB4A4\uC5D0",lines:[`\uC120\uD589: ${(Array.isArray(e.blocked_by)?e.blocked_by:[]).join(" \xB7 ")}`,"\uC120\uD589\uC774 \uB2EB\uD788\uBA74 \uC774 \uD45C\uC2DC\uB294 \uC800\uC808\uB85C \uC0AC\uB77C\uC9C4\uB2E4 \u2014 \uB77C\uBCA8\uC740 \uC774\uC288 \uC0C1\uC138\uC758 \uB77C\uBCA8 \uC808\uC5D0\uC11C \uB5C0\uB2E4"]};if(t==="readiness"){let n=Ld(e);return n?{title:n.title,lines:[]}:null}if(t==="receipt"){let n=Md(e);return n.length===0?null:{title:"\uC2E4\uD589 \uC601\uC218\uC99D \uD68C\uACC4 \uC794\uC5EC \u2014 \uBA38\uC9C0\uB294 \uC9C4\uD589",lines:[...n.map(r=>ah[r]||r),"\uC790\uB3D9 \uBA38\uC9C0 \uD310\uC815\uC5D0\uB294 \uC601\uD5A5\uC774 \uC5C6\uB2E4 \u2014 \uC815\uC815\uC740 bd update --set-metadata exec_receipt=\u2026 \uB85C"]}}if(t==="qfr"){let n=e.workflow?e.workflow.quick_fix_review:null;if(!n||n.state!=="reviewed"&&n.state!=="stale")return null;let r=Array.isArray(n.missing)?n.missing:[];return{title:n.state==="reviewed"?"quick_fix self-review \uC601\uC218\uC99D\uC774 \uC9C0\uAE08 \uBCF8\uBB38\uACFC \uC77C\uCE58\uD569\uB2C8\uB2E4":"quick_fix self-review \uC601\uC218\uC99D\uC774 \uC9C0\uAE08 \uBCF8\uBB38\uACFC \uB2E4\uB985\uB2C8\uB2E4",lines:r.length>0?r:["\uBE60\uC9C4 \uD56D\uBAA9 \uC5C6\uC74C"]}}return null}var uh=["rec","receipt","session_preferred","ineligible","qfr","spec_after_blocker","readiness"];function qi(e,t){for(let n of uh){if(!t(n))continue;let r=fl(e,n);return r?{chip_key:n,content:r}:null}return null}function Si(e){return e.chip_popover?bo(e.chip_popover.content):""}function wr(e,t){return!!e.chip_popover&&e.chip_popover.chip_key===t}var _l="\uC0AC\uC6A9\uC790 \uB9AC\uBDF0 \uD544\uC694";function ml(e,t=null,n={}){let r=e.worker_ineligible===!0,o=e.draggable&&!e.done&&!r,i=e.queue_placeable===!0&&!e.done&&!r,s=i&&t&&t.bead_id===e.id,l=e.session_preferred===!0,a=Nd[e.session_preferred_reason||""]||"",u=e.workflow,d=e.missing_description===!0,m=e.awaiting_user===!0,b=typeof e.reason=="string"&&e.reason.startsWith("\u26D4"),h=wr(e,"spec_after_blocker"),k=oh(e.spec_after_blocker===!0,h),S=Ld(e),T=wr(e,"readiness"),ee=sh(S,T),re=c`${k}${h?Si(e):""}${ee}${T?Si(e):""}`,U=Ii(e.dependency_chips,k===""&&ee===""?"":re),L=e.workspace_name?c`<span class="worker-card__repo" title=${e.root_dir||""}
        >${e.workspace_name}</span
      >`:"",R=Li(e.cross_lane_chip),P=Kr(u),q=Pd(e.from_id),W=!!(e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)),F=!r&&(e.blocked===!0||e.queue_placeable===!1);return c`<div
  ...
  </section>`}function xd(e,t,n){return c`<button
      type="button"
...
`).trim()}}var of=20;function sf(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),i=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${o}:${i}`}function Wy(e){return e.length>of?`${e.slice(0,of)}\u2026`:e}function zy(e,t,n,r){let o=`${t.lane} ${Wy(t.identifier)}`;return c`<div class="detail-report">
  ...
  </div>`}function df(e,t){let n=el.flatMap(a=>a.keys),r=tl(n,e.metadata,e.workspace_values,e.execution_defaults,e.catalog,e.controller_runtime||null),o=nd(n,e.metadata,e.workspace_values,e.execution_defaults,e.catalog,e.controller_runtime||null),i=Object.fromEntries(r.map(a=>[a.key,a])),s=Object.fromEntries(r.filter(a=>a.value!==null).map(a=>[a.key,a.value])),l=r.filter(a=>a.full_value&&a.display!==a.full_value).map(a=>a.full_value).join(" \xB7 ");return c`<details
...
${l}</pre
    ...
    >${e.replayed?c`<span class="detail-usage-partial" title=${kf}
          >부분 집계</span
        >`:""}`}function vf(e){return!e||!e.roles.orchestrator?null:{providers:e.roles.orchestrator,roles:{}}}function ac(e){if(typeof e=="number")return Ls(e);if(typeof e!="string")return"";let t=Date.parse(e);return Number.isFinite(t)?Ls(t):""}function fv(e){return typeof e=="string"?e.replace(/-\d{8}$/,""):""}function wf(e,t,n){if(e.provider!=="claude"){let o=e.session_id?` \xB7 thread ${e.session_id}`:"",i=n?" \xB7 \uC774\uC804 \uB77C\uC6B4\uB4DC \uC2A4\uB808\uB4DC \uC774\uC5B4\uAC10":"";return{text:`${n?"\u21A9 ":""}${e.launch_id}`,title:`${e.launch_id}${o}${i}`,thread:e.session_id?{text:e.session_id.slice(0,8),title:e.session_id}:null}}let r=t&&typeof t.agent_id=="string"?t.agent_id:"";return r.length>0?{text:r.slice(0,8),title:r,thread:null}:{text:e.launch_id.slice(-8),title:e.launch_id,thread:null}}function $f(e){return e?c`<span
        class="detail-session__leg-thread detail-session__sid"
        title=${e.title}
        >${e.text}</span
      >`:""}function sc(e){return e===null||typeof e=="string"&&e.trim().length>0}function ic(e){return e===null||typeof e=="number"&&Number.isFinite(e)}function _v(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let t=e,n=t.provider==="claude";return typeof t.launch_id!="string"||t.launch_id.length===0||!pa.some(r=>r.role===t.role&&r.provider===t.provider)||!(n?sc(t.model):typeof t.model=="string"&&t.model.length>0)||!(!("effort"in t)||sc(t.effort))||!(!("agent_type"in t)||sc(t.agent_type))||typeof t.session_id!="string"||t.session_id.length===0||!cv.includes(t.status)||!(t.turn_id===null||typeof t.turn_id=="string")?null:n?!ic(t.started_at)||!ic(t.last_event_at)||!ic(t.completed_at)?null:t:typeof t.started_at!="number"||!Number.isFinite(t.started_at)||typeof t.last_event_at!="number"||!Number.isFinite(t.last_event_at)||!(t.completed_at===null||typeof t.completed_at=="string"&&Number.isFinite(Date.parse(t.completed_at)))?null:t}function mv(e,t,n,r){let i=pn({providers:{[t]:{subtotal:n.subtotal,breakdown:n.usage,...n.replayed?{replayed:!0}:{}}},roles:{}})[0],s=wf({provider:t,launch_id:n.receipt_id,session_id:typeof n.session_id=="string"?n.session_id:void 0},n,r);return c`<div class="detail-session__leg detail-session__usage-detail">
    ...
    >
    ${$f(s.thread)}
    ${ac(n.completed_at)?c`<span class="detail-session__leg-time detail-session__time"
          >${ac(n.completed_at)}</span
        >`:""}
    ${i?c`<span class="detail-session__usage" title=${i.tooltip}
          >${i.label}</span
        >`:""}
  </div>`}function gv(e,t,n,r,o){let i=e.status==="running"?null:t,l=(i?pn({providers:{[e.provider]:{subtotal:i.subtotal,breakdown:i.usage,...i.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],a=e.status==="running"?Ls(e.last_event_at):i?ac(i.completed_at):"",u=(e.provider==="claude"?["Claude",e.agent_type,fv(e.model),e.effort]:["codex",e.model,e.effort]).filter(Boolean).join(" \xB7 "),d=wf(e,i,o);return c`<button
    type="button"
  ...
  `}var Av=["open","in_progress","deferred","resolved","closed"],Sv=[0,1,2,3,4];function Tf(e,t){let n=t.issueStores,r=t.onClose,o=t.transport,i=t.onNavigate,s=t.queueStore,l=t.execPresetStore,a=t.sessionLogStore,u=null,d=null,m={},b="",h=!1,k=[],S=!1,T=!1,ee={},re={claude:null,codex:null},U=null,L=null,R=0,P=!1,q=!1,W="",F="",D="",V="",j=!1;function ne(){P=!1,q=!1,W="",F="",D="",V="",j=!1}function me(){re={claude:null,codex:null},U=null,L=null,R+=1}async function Oe(){if(!o)return null;try{let v=await Promise.resolve(o("get-workspace-accounts",{}));return v&&typeof v.state=="string"?v:null}catch{return null}}async function H(v){try{let I=await fetch(v);if(!I.ok)return null;let M=await I.json();if(!M||typeof M!="object"||!Array.isArray(M.accounts))return null;let ve=M.accounts.filter(Be=>Be!==null&&typeof Be=="object"&&!Array.isArray(Be));return{accounts:ve,active:ve.find(Be=>Be.active===!0)||null}}catch{return null}}async function te(v){L=v;let I=++R,[M,ve,Be]=await Promise.all([H("/api/claude-usage"),H("/api/codex-usage"),Oe()]);I!==R||v!==u||(re={claude:M,codex:ve},U=Be,tt())}let ce=[],Te=null,K=null,ae=!1,Q="",de=!1,Re=0,be=new Set;function Ie(){ce=[],Te=null,K=null,ae=!1,Q="",de=!1,Re+=1,be.clear()}async function Ye(v){if(!o)return;let I=++Re;try{let M=await Promise.resolve(o("get-comments",{id:v}));if(I!==Re||v!==u)return;ce=Array.isArray(M)?M:[],ae=!1}catch{if(I!==Re||v!==u)return;ae=!0}tt()}function _t(){if(!o||!u)return;let v=d&&typeof d.comment_count=="number"?d.comment_count:null;if(Te!==u){Te=u,K=v,Ye(u);return}v!==null&&v!==K&&(K=v,Ye(u))}function G(v){be.has(v)?be.delete(v):be.add(v),tt()}function pe(v){let I=Q.trim().length===0;Q=v,I!==(v.trim().length===0)&&tt()}async function oe(){let v=Q.trim();if(!o||!u||v.length===0||de)return;let I=u;de=!0,tt();let M=!1;try{let ve=await Promise.resolve(o("add-comment",{id:I,text:v}));Array.isArray(ve)&&ve.length>0&&(M=!0,I===u&&(ce=ve,ae=!1,Q="",K=ve.length))}catch{M=!1}M||_e("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),I===u&&(de=!1),tt()}let Y={onToggle:G,onDraftInput:pe,onSubmit:oe},ke=t.mdViewer||null,fe=null;ke||(fe=document.createElement("div"),fe.className="md-viewer-root",document.body.appendChild(fe));let Ce=ke||da(fe,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),Ne=document.createElement("div");Ne.className="session-log-root",document.body.appendChild(Ne);let Qe=Oo(Ne,{transport:o?(v,I)=>Promise.resolve(o(v,I)):void 0,sessionLogStore:a}),Fe=!1,J=!1,X=!1,Ee=null,Je=null,st=0;function Ue(v){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${v}`}function et(){Fe=!1,J=!1,X=!1,Ee=null,Je=null,st+=1}async function vt(v){if(!o)return;let I=++st;J=!0,X=!1,tt();try{let M=await Promise.resolve(o("get-bead-prompt",{bead_id:v}));if(I!==st)return;!M||typeof M!="object"||Array.isArray(M)?X=!0:(Ee=M,Je=Ue(v))}catch{I===st&&(X=!0)}finally{I===st&&(J=!1,tt())}}let ut=[],Ze=null,dt=0;function Zt(v,I){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${v}::${I}`}function $(){ut=[],Ze=null,dt+=1}async function Z(v,I){if(!o)return;let M=++dt,ve;try{ve=await Promise.resolve(o("get-session-refs",{bead_id:v}))}catch{ve=null}M!==dt||I!==Ze||(ut=ve&&Array.isArray(ve.sessions)?ve.sessions:[],tt())}function De(){if(!o||!u)return;let v=d&&d.metadata,I=v&&typeof v=="object"&&typeof v.session_ref=="string"?v.session_ref:null;if(I===null){$();return}let M=Zt(u,I);Ze!==M&&(ut=[],Ze=M,Z(u,M))}let Se=[],Pe=[],je=Xr,it=null,kt=0;function se(v){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${v}`}function ge(){Se=[],Pe=[],je=Xr,it=null,kt+=1}async function Ge(v,I){if(!o)return;let M=++kt,ve;try{ve=await Promise.resolve(o("get-bead-timeline",{bead_id:v}))}catch{ve=null}M!==kt||I!==it||(Se=ve&&Array.isArray(ve.events)?ve.events:[],Pe=ve&&Array.isArray(ve.attempts)?ve.attempts:[],je=Xr,tt())}function at(){if(!o||!u)return;let v=se(u);it!==v&&(Se=[],Pe=[],je=Xr,it=v,Ge(u,v))}function ze(){je+=Xr,tt()}function mt(){if(Fe=!Fe,Fe&&u&&Je!==Ue(u)){Ee=null,vt(u);return}tt()}function gt(){let v={};for(let M of Pe)M&&typeof M=="object"&&M.bead_id===u&&(v[String(M.attempt_id)]=M);let I=s?s.get():null;for(let M of I&&I.attempts?Object.values(I.attempts):[]){let ve=M;ve&&ve.bead_id===u&&(v[String(ve.attempt_id)]=ve)}return v}function nt(){return u?Object.values(gt()).sort((I,M)=>(M.started_at||0)-(I.started_at||0)).map(I=>({attempt_id:I.attempt_id,bead_id:I.bead_id,status:I.status,started_at:typeof I.started_at=="number"?I.started_at:null,runner:I.runner||null,model:I.model||null,effort:I.effort||I.observed_effort||null,speed:I.speed||null,session_id:I.session_id||null,resumed_from:I.resumed_from||null,continuation_mode:I.continuation_mode||null,dismissed_at:typeof I.dismissed_at=="number"?I.dismissed_at:null,cause:typeof I.cause=="string"?I.cause:null,cause_detail:I.cause_detail||null,exec_default_preset_id:typeof I.exec_default_preset_id=="string"?I.exec_default_preset_id:null,exec_default_preset_revision:typeof I.exec_default_preset_revision=="number"?I.exec_default_preset_revision:null,exec_values:I.exec_values&&typeof I.exec_values=="object"?I.exec_values:null,usage:I.usage||null,usage_legs:Array.isArray(I.usage_legs)?I.usage_legs:[],delegation_sessions:Array.isArray(I.delegation_sessions)?I.delegation_sessions:[]})):[]}function Me(){return u?sr(gt(),u):null}let A=new Set;function N(v){A.has(v)?A.delete(v):A.add(v),tt()}function B(v){let I=s?s.get():null,M=I&&I.attempts?I.attempts[v]:null;Qe.open({attempt_id:v,meta:M?{runner:M.runner||void 0,model:M.model||void 0,effort:M.effort||void 0,status:M.status||void 0,session_id:M.session_id||void 0}:{}})}function we(v,I){let M=s?s.get():null,ve=M&&M.attempts?M.attempts[v]:null,lt=(ve&&Array.isArray(ve.delegation_sessions)?ve.delegation_sessions:[]).find(Mt=>Mt&&typeof Mt=="object"&&Mt.launch_id===I);lt&&Qe.open({attempt_id:v,launch_id:I,meta:{runner:lt.provider==="claude"?"claude":"codex",role:lt.role,...typeof lt.agent_type=="string"?{agent_type:lt.agent_type}:{},model:lt.model,effort:lt.effort,session_id:lt.session_id,status:lt.status}})}async function ye(v){if(!o||!v)return;let I=o,M=()=>{let Be=s?s.get():null;return Be&&typeof Be.revision=="number"?Be.revision:0},ve=s?.get()?.attempts?.[v]||null;await fo({context:{bead_id:ve?.bead_id||u||"",kind:"session",tuple:ve?Rn(ve):""},transport:Be=>I("worker-attempt-resume",{attempt_id:v,expected_revision:M(),...Be}),adopt:Be=>{Be?.queue&&s?.set&&s.set(Be.queue)}})}async function pt(v,I){if(!o||!v)return;let M=o,ve=()=>{let ht=s?s.get():null;return{bead_id:v,...I==="parallel"?{}:{lane:I},expected_revision:ht&&typeof ht.revision=="number"?ht.revision:0}},Be=ht=>{ht?.queue&&s?.set&&s.set(ht.queue)},lt=await Promise.resolve(M("worker-queue-place",ve()));if(Be(lt),lt&&lt.conflict&&(lt=await Promise.resolve(M("worker-queue-place",ve())),Be(lt)),tt(),!lt)return;if(lt.applied===!1&&typeof lt.admission_reason=="string"){_e(`\uB300\uAE30 \uC801\uC7AC \uAC70\uBD80: ${lt.admission_reason}`,"error",2400);return}if(lt.reason==="rejected"){_e("\uB300\uAE30 \uC801\uC7AC \uAC70\uBD80: rejected","error",2400);return}if(lt.applied===!1)return;let Mt=lt.queue?os({id:v},lt.queue).location:null;Mt&&"index"in Mt&&_e(`${kd(Mt.lane)} \uB300\uAE30 #${Mt.index+1}\uC5D0 \uCD94\uAC00`,"success",2400)}function wt(v,I){if(I){T=!0,tt();return}pt(v,"parallel")}function yt(v,I){let Be=(v.target?.closest?.(".worker-card__place-lane")||null)?.dataset.lane;Be&&(Be!=="parallel"&&!/^s[1-5]$/.test(Be)||(T=!1,tt(),pt(I,Be)))}function Tt(v){!v||!u||Qe.open(_o(v,u,d&&d.status))}let jt={onOpen:B,onOpenDelegation:we,onResume:ye,onToggleUsage:N,onOpenSessionRef:Tt,onCopyResumeCommand:Kt};function Ut(){let v=s?s.get():null,I={...ee};for(let M of[...qn,...yo]){let ve=v&&v[M];typeof ve=="string"&&(I[M]=ve)}return I}async function Yt(){if(o){try{let v=await Promise.resolve(o("get-session-defaults",{}));ee=v&&v.values&&typeof v.values=="object"?v.values:{}}catch{ee={}}tt()}}function St(){let v=s?s.get():null;return v&&v.runner_catalog||null}function sn(){let v=s?s.get():null;return v&&typeof v.execution_defaults=="object"?v.execution_defaults:null}function Wt(){let v=d?.metadata&&typeof d.metadata=="object"?d.metadata:{},M=On({pin:{...v,...m},global:Ut(),execution_defaults:sn(),runner_catalog:St(),route:typeof v.route=="string"?v.route:null}).orchestration_model.value||"";return Nn(St(),M)}function Pt(){let v=l?l.get():null;return!v||typeof v.revision!="number"?null:{revision:v.revision,presets:Array.isArray(v.presets)?v.presets:[]}}function Ft(v){return v?.compatible===!1}function zt(v){l&&v&&typeof v.revision=="number"&&Array.isArray(v.presets)&&l.set({revision:v.revision,presets:v.presets})}async function xe(){let v=Pt(),I=v?.presets.find(M=>M.id===b);if(!(!o||!u||!v||!I||Ft(I)||h)){h=!0,k=[],tt();try{let M=await Promise.resolve(o("apply-impl-preset",od(u,I.id,v.revision)));if(M&&M.conflict){zt(M),_e("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let ve=M&&Array.isArray(M.issue)?M.issue[0]:M?.issue;if(M&&M.applied&&ve&&typeof ve=="object"){d=ve,k=Array.isArray(M.skipped_orchestration_keys)?M.skipped_orchestration_keys.filter(Be=>typeof Be=="string"):[];for(let Be of sd)delete m[Be];_e(k.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}M&&M.error==="bd_readback_failed"?_e("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):_e("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(M){M&&typeof M=="object"&&M.code==="bd_readback_failed"?_e("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):_e("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{h=!1,tt()}}}let E=null;n&&n.subscribe&&(E=n.subscribe(()=>Et()));let he=null;s&&typeof s.subscribe=="function"&&(he=s.subscribe(()=>{u&&tt()}));let Le=null,ot=null;function Ve(){ot&&(ot(),ot=null)}l&&typeof l.subscribe=="function"&&(Le=l.subscribe(()=>{u&&tt()}));function $t(v){v.key==="Escape"&&u&&(v.preventDefault(),r())}document.addEventListener("keydown",$t);let It=ho(()=>tt());It.attach();function Et(){if(u){if(n&&typeof n.snapshotFor=="function"){let v=n.snapshotFor("detail:"+u)||[];d=v.find(M=>M&&M.id===u)||v[0]||d}_t(),De(),at(),tt()}}function Kt(v){yn(v).then(I=>{I?_e("\uBCF5\uC0AC\uB428","success",1200):_e("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function _n(v){v.preventDefault(),v.stopPropagation(),u&&Kt(u)}function Lt(v,I){v.preventDefault(),v.stopPropagation(),Kt(I)}function hn(v,I,M){v.preventDefault(),v.stopPropagation(),Ce.open(I,{missing_state:M})}async function p(v,I){let M=Object.hasOwn(m,v),ve=m[v];if(m[v]=I,tt(),!(!o||!u))try{let Be=await Promise.resolve(o("update-exec-settings",rd(u,v,I.length===0?null:I))),lt=Array.isArray(Be)?Be[0]:Be;if(!lt||typeof lt!="object"||!lt.id)throw new Error("exec settings readback failed");d=lt,delete m[v],tt()}catch(Be){throw M?m[v]=ve:delete m[v],tt(),_e("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error"),Be}}function f(v){v.catch(()=>{})}async function x(v,I){let M=d||{},ve=M.metadata&&typeof M.metadata=="object"?M.metadata:{},Be={};for(let ht of["impl_runtime","impl_model","impl_effort"])Be[ht]=Object.hasOwn(m,ht)?m[ht]:typeof ve[ht]=="string"?ve[ht]:"";Be[v]=I;let lt=ld(Be,St(),Wt()),Mt={};for(let ht of["impl_runtime","impl_model","impl_effort"])Mt[ht]=m[ht],m[ht]=lt[ht]||"";if(tt(),!(!o||!u))return Promise.resolve(o("update-impl-target",{id:u,...lt,orchestration_runtime:Wt()})).then(ht=>{let le=Array.isArray(ht)?ht[0]:ht;if(!le||typeof le!="object"||!le.id)throw new Error("implementation target readback failed");d=le;for(let rt of["impl_runtime","impl_model","impl_effort"])delete m[rt];tt()}).catch(ht=>{for(let le of["impl_runtime","impl_model","impl_effort"])Mt[le]===void 0?delete m[le]:m[le]=Mt[le];throw tt(),_e("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error"),ht})}async function _(v,I,M){if(!o||!u)return!1;try{let ve=await Promise.resolve(o(v,I)),Be=Array.isArray(ve)?ve[0]:ve;return Be&&typeof Be=="object"&&Be.id?(d=Be,!0):(_e(M,"error"),!1)}catch(ve){return ve&&typeof ve=="object"&&ve.code==="bd_readback_failed"?(_e("\uC800\uC7A5\uB410\uC73C\uB098 \uD655\uC778 \uC2E4\uD328 \u2014 \uACE7 \uAC31\uC2E0\uB429\uB2C8\uB2E4","error"),{ok:!1,saved:!0}):(_e(g(M,ve),"error"),!1)}}function g(v,I){let M=I&&typeof I=="object"&&typeof I.message=="string"?I.message.trim():"";return M.length>0?`${v} \u2014 ${M}`:v}function O(v){setTimeout(()=>{try{let I=e.querySelector(v);I&&typeof I.focus=="function"&&I.focus()}catch{}},0)}function z(){P=!0,W=d&&d.title||"",tt(),O('.detail-edit__input[data-edit="title"]')}function ue(v){W=v.target.value}function Ae(){P=!1,W="",tt()}function He(){_("edit-text",{id:u,field:"title",value:W},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(I=>{I===!0&&(P=!1,W=""),tt()})}function xt(){q=!0,F=d&&d.description||"",tt(),O('.detail-edit__textarea[data-edit="description"]')}function Qt(v){F=v.target.value}function an(){q=!1,F="",tt()}function xn(){_("edit-text",{id:u,field:"description",value:F},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(I=>{I===!0&&(q=!1,F=""),tt()})}function Vt(v,I,M,ve){if(v.key==="Escape"){v.stopPropagation(),M();return}v.key==="Enter"&&(!ve||v.ctrlKey||v.metaKey)&&(v.preventDefault(),I())}function Jt(v){let I=v.target.value;_("update-status",{id:u,status:I},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>tt())}function en(v){let I=Number(v.target.value);_("update-priority",{id:u,priority:I},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>tt())}function eo(v){D=v.target.value}function Tn(){let v=D.trim();v.length!==0&&_("label-add",{id:u,label:v},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(I=>{I===!0&&(D=""),tt()})}function to(v){if(v.key==="Escape"){v.stopPropagation(),D="",tt();return}v.key==="Enter"&&(v.preventDefault(),Tn())}function Rr(v){_("label-remove",{id:u,label:v},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>tt())}let Ns={onCopyPath:Lt,onOpenDoc:hn};function w(v){return typeof v=="string"?v:v&&typeof v=="object"?String(v.id||v.to||v.issue_id||v.depends_on||""):""}function y(v){return v&&typeof v=="object"?String(v.dependency_type||v.type||""):""}function C(v){switch(v){case"discovered-from":return{glyph:"\u21A9 ",relation:"\uBC1C\uACAC"};case"parent-child":return{glyph:"\u2338 ",relation:"\uC0C1\uC704"};case"related":return{glyph:"\u2194 ",relation:"\uAD00\uB828"};default:return v.length>0?{glyph:`${v} `,relation:v}:{glyph:"",relation:""}}}function ie(v,I){let M=$e(I),ve=[];return v.length>0&&ve.push(v),M&&ve.push(M),ve.length>0?ve.join(`
`):void 0}function $e(v){if(!v||typeof v!="object")return;let I=typeof v.status=="string"?v.status:"",M=typeof v.title=="string"?v.title:"";return I.length>0&&M.length>0?`${I} \xB7 ${M}`:void 0}function qe(){return(t.getWorkspacePath&&t.getWorkspacePath()||"").trim()}function Xe(){return t.depCandidates?t.depCandidates():null}async function Rt(v,I,M){let ve=qe(),Be=u;if(!Be)return;if(ve.length===0){_e("\uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}let lt=await _(v,{a:Be,b:I,view_id:Be,root_dir:ve},M),Mt=lt===!0||lt!==!1&&lt.saved===!0;Mt&&t.onDepChanged&&t.onDepChanged({type:v,a:Be,b:I}),v==="dep-add"&&Mt&&(V="",j=!1),tt()}function tn(v){if(!u)return;let I=globalThis.confirm;typeof I=="function"&&!I(`${v}\uAC00 ${u}\uB97C \uB9C9\uB294 \uC5F0\uACB0\uC744 \uB04A\uC744\uAE4C\uC694?`)||Rt("dep-remove",v,"\uC758\uC874 \uD574\uC81C \uC2E4\uD328")}function ct(v){v.disabled||dn(v.bead_id)}function dn(v){Rt("dep-add",v,"\uC758\uC874 \uCD94\uAC00 \uC2E4\uD328")}function An(v,I){let M=V.trim();return!vp(M)||M===u||I.includes(M)||v.some(ve=>ve.bead_id===M)?null:M}function Or(v){V=v.target.value,j=!0,tt()}function Hn(){j||(j=!0,tt())}function Zn(v,I,M){if(v.key==="Escape"){v.stopPropagation(),V="",j=!1,tt();return}v.key==="Enter"&&(v.preventDefault(),I.length===1&&!I[0].disabled?ct(I[0]):M!==null&&dn(M))}function Jn(v,I){return c`<div class="detail-dep-add">
      <input
    ...
    `}function tr(v){let I=v.metadata||{},M=v.workflow||{},ve=M.stages||{},Be=ve.spec&&ve.spec.stale,lt=ve.impl&&ve.impl.stale,Mt=M.quick_fix_review?.state==="stale",ht=ve.plan||null,le=M.route_source==="derived",rt=M.route||I.route||"\u2014";return c`
      ...
      ${M.route!=="quick_fix"||Object.hasOwn(I,"impl_review")?c`<div class="detail-kv">
            ...
            <span class="detail-kv__v"
              >${I.impl_review||"\uC5C6\uC74C"}${lt?" \xB7 stale":""}</span
            >
          </div>`:""}
    ...
    `}let pr={route:["quick_fix","spec_backed","full_plan"]};async function fr(v,I){let M=I.target.value;if(v==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&M!=="full_plan"&&!window.confirm(`full_plan \u2192 ${M||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){tt();return}await _("update-workflow-meta",{id:u,key:v,value:M},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),tt()}function Ir(v){let I=v.metadata||{};return c` ${((ve,Be)=>{let lt=pr[ve],Mt=typeof I[ve]=="string"?I[ve]:"";return c`<div class="detail-kv">
        ...
        <select
          ...
          @change=${ht=>fr(ve,ht)}
        >
          <option value="" ?selected=${!lt.includes(Mt)}>
            ${Be}
          </option>
          ${lt.map(ht=>c`<option value=${ht} ?selected=${Mt===ht}>${ht}</option>`)}
        </select>
    ...
    `}function Fs(){if(!u)return c``;let v=d||{},I=String(v.id||u),M=v.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",ve=Me(),Be=v.status||"open",lt=typeof v.priority=="number"?Math.max(0,Math.min(4,v.priority)):"",Mt=v.description||"",ht=s?s.get():null,le=ht&&Be!=="closed"?os({...v,id:I},ht):null,rt=ht?ss(ht):null,Gt={...v,metadata:{...v.metadata||{},...m}};return c`
  ...
  >
    ...
    ${r.length===0?c`<div class="worker-rungrid__empty">실행 세션 없음</div>`:r.map(o=>dc(o,t,n,{monitor:Xv(o)}))}
  </div>`}function Do(e,t,n=!1){let r=!!t.discard?.error;return!e||!r&&t.parked!==!0?{}:{resolve_action:!0,resolve_enabled:!n,resolve_title:n?"\uC138\uC158 \uAE30\uB3D9 \uC694\uCCAD \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":r?"\uC2E4\uD328\uD55C \uD3D0\uAE30\uB97C \uC0AC\uB78C\uC774 \uC774\uC5B4\uBC1B\uB294 \uB300\uD654\uD615 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 \u2014 \uAE30\uB85D\uB41C \uC138\uC158\uC774 \uC788\uC73C\uBA74 fork\uD558\uACE0, \uC5C6\uC73C\uBA74 \uC0C8 \uC138\uC158\uC5D0 \uC0AC\uC720\uB97C \uC2E3\uC2B5\uB2C8\uB2E4":"\uD30C\uD0B9\uC744 \uC0AC\uB78C\uC774 \uC774\uC5B4\uBC1B\uB294 \uB300\uD654\uD615 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 \u2014 \uC0B4\uC544 \uC788\uB294 \uBB38\uC758 \uC138\uC158\uC774 \uC788\uC73C\uBA74 \uADF8 \uCC3D\uC744 \uAC00\uB9AC\uD0B5\uB2C8\uB2E4"}}var cn="",Zv=["impl_runtime","impl_model","impl_effort"],Wf=["claude","codex"],Jv=["claude_account","codex_account"],ek=5,$a=1;function Dn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function xa(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,o=t.notify||(A=>_e(A,"error",4e3)),i={},s={},l={},a={},u=[],d=!1,m={state:"absent",values:{},warnings:[]},b={},h={},k=Promise.resolve(),S=Promise.resolve(),T={claude:null,codex:null},ee=!1,re=null,U={},L="",R="general",P="",q=!1,W=!1,F=!1,D=null,V=!1;function j(){let A=t.queue?t.queue():null;return Dn(A)?A:null}function ne(){let A=j();return A?A.runner_catalog:null}function me(){let A=j();return A&&Dn(A.execution_defaults)?A.execution_defaults:null}function Oe(){let A=j();return!!(A&&Object.hasOwn(A,"quick_fix_orchestration_model"))}function H(){let A=t.implPresetStore?.get();return Dn(A)&&Array.isArray(A.presets)?A:null}function te(){return r===null?{}:{root_dir:r}}async function ce(A,N){return V||!n?null:await n(A,N)}function Te(A){A&&Dn(A.queue)&&t.onQueueAdopt?.(A.queue)}async function K(A,N){let B=j();if(!B||V)return null;let we=await ce(A,{...N,...te(),expected_revision:B.revision});if(Te(we),r!==null&&we&&we.conflict){let ye=we.queue&&typeof we.queue.revision=="number"?we.queue.revision:j()?.revision??B.revision;we=await ce(A,{...N,...te(),expected_revision:ye}),Te(we)}return we}async function ae(){d=!0,Me();try{let A=await ce("get-session-defaults",{...te()});i=fi(A?.values),s={...i},l={},a={},u=Array.isArray(A?.warnings)?A.warnings:[]}catch(A){u=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${A instanceof Error?A.message:String(A)}`)}finally{d=!1,Me()}}function Q(A,N){let B={...N};for(let we of Yo){let ye=s[we];ye!==A[we]&&(typeof ye=="string"?B[we]=ye:delete B[we])}return B}function de(){S=S.then(()=>Re())}async function Re(){let A=ed(i,s);if(Object.keys(A).length===0)return;let N={...s};try{let B=await ce("set-session-defaults",{values:A,...te()});i=fi(B?.values),s=Q(N,i),u=Array.isArray(B?.warnings)?B.warnings:[]}catch(B){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${B instanceof Error?B.message:String(B)}`)}Me()}function be(A,N){if(!Dn(A))return;let B=A.state;m={state:B==="usable"||B==="unusable"||B==="absent"?B:"absent",values:Dn(A.values)?{...A.values}:{},warnings:Array.isArray(A.warnings)?A.warnings:[]},h={...m.values},N&&(b={...h})}async function Ie(){try{be(await ce("get-workspace-accounts",{...te()}),!0)}catch(A){m={state:"unusable",values:{},warnings:["kv_read_failed"]},h={},b={},o(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${A instanceof Error?A.message:String(A)}`)}Me()}async function Ye(A){try{let N=await fetch(A);if(!N.ok)return null;let B=await N.json();if(!Dn(B)||!Array.isArray(B.accounts))return null;let we=B.accounts.filter(ye=>Dn(ye)&&typeof ye.key=="string"&&ye.key.length>0&&typeof ye.email=="string"&&ye.email.length>0);return{accounts:we,active:we.find(ye=>ye.active===!0)||null}}catch{return null}}async function _t(){ee=!0;let[A,N]=await Promise.all([Ye("/api/claude-usage"),Ye("/api/codex-usage")]);V||(T={claude:A,codex:N},Me())}function G(){let A={};for(let N of Jv){let B=Object.hasOwn(b,N)?b[N]:null,we=Object.hasOwn(h,N)?h[N]:null;B!==we&&(A[N]=B)}return A}async function pe(){let A=G();if(Object.keys(A).length!==0){try{be(await ce("set-workspace-accounts",{values:A,...te()}),!1)}catch(N){o(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${N instanceof Error?N.message:String(N)}`)}Me()}}function oe(A,N){N===cn?delete b[A]:b[A]=N,Me(),k=k.then(()=>pe())}function Y(A,N){if(Zv.includes(A)){Qe(A,N);return}N===cn?delete s[A]:s[A]=N,Me(),de()}function ke(A,N){l[A]=N,delete a[A]}function fe(A,N,B){if(l[A]=N,N.length>0&&!B(N)){a[A]=!0,Me();return}delete l[A],delete a[A],N.length===0?delete s[A]:s[A]=N,Me(),de()}function Ce(){let A=mt().orchestration_model,N=On({global:{orchestration_model:A??void 0},execution_defaults:me(),runner_catalog:ne()}).orchestration_model.value;return N?Nn(ne(),N):null}function Ne(A,N){typeof N=="string"&&N.length>0?s[A]=N:delete s[A]}function Qe(A,N){let B=N===cn?void 0:N,we=Xu({impl_runtime:A==="impl_runtime"?B:s.impl_runtime,impl_model:A==="impl_model"?B:s.impl_model,impl_effort:A==="impl_effort"?B:s.impl_effort},ne(),Ce());Ne("impl_runtime",we.impl_runtime),Ne("impl_model",we.impl_model),Ne("impl_effort",we.impl_effort),Me(),de()}async function Fe(){let A=j();if(!A)return;let N={orchestration_model:A.orchestration_model??null,orchestration_effort:A.orchestration_effort??null,orchestration_speed:A.orchestration_speed??null,quick_fix_orchestration_model:A.quick_fix_orchestration_model??null,quick_fix_orchestration_effort:A.quick_fix_orchestration_effort??null,quick_fix_orchestration_speed:A.quick_fix_orchestration_speed??null},B=td(N,{...N,...U});if(Object.keys(B).length!==0){try{let we=await K("worker-queue-set-orchestration-defaults",{values:B});if(we&&we.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}U={}}catch(we){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${we instanceof Error?we.message:String(we)}`)}Me()}}function J(A,N){U[A]=N===cn?null:N,Me(),Fe()}function X(A){if(re=A,!A){Me();return}let N=ne(),B=mt(),we=B.orchestration_model;we&&!wo(N,A).includes(we)&&(U.orchestration_model=null,we=null);let ye=B.orchestration_effort;ye&&!hi(N,A,we||En).includes(ye)&&(U.orchestration_effort=null),Me(),Fe()}async function Ee(A){if(!(!j()||A<$a)){try{await K("worker-queue-set-slots",{slots:A})}catch(N){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${N instanceof Error?N.message:String(N)}`)}Me()}}async function Je(A){if(!(!j()||A<$a||A>ek)){try{await K("worker-queue-set-serial-lane-count",{count:A})}catch(N){o(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${N instanceof Error?N.message:String(N)}`)}Me()}}async function st(A,N){let B=A==="auto_advance"?"worker-automation-toggle":A==="auto_merge"?"worker-merge-auto-toggle":"worker-provider-auto-switch-toggle";try{await K(B,{on:N})}catch(we){o(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${we instanceof Error?we.message:String(we)}`)}Me()}function Ue(){let A={},N=mt();for(let B of vo){let we=qn.includes(B)?N[B]:s[B];typeof we=="string"&&we.length>0&&(A[B]=we)}return A}async function et(){let A=H();if(!A)return;let N=Ue();if(Object.keys(N).length===0){o("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let B=(A.presets||[]).find(ye=>ye.id===L),we=P.trim()||(B?B.name:"");if(!we){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let ye=B?await ce("impl-preset-update",{expected_revision:A.revision,id:B.id,name:we,settings:N}):await ce("impl-preset-create",{expected_revision:A.revision,name:we,settings:N});if(ye&&ye.applied){if(P="",!B&&Array.isArray(ye.presets)){let pt=ye.presets.find(wt=>wt.name===we);L=pt?pt.id:L}Me()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Me()}catch(ye){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${ye instanceof Error?ye.message:String(ye)}`)}}async function vt(){let A=H();if(!(!A||L.length===0))try{let N=await ce("impl-preset-delete",{expected_revision:A.revision,id:L});N&&N.applied?(L="",Me()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Me())}catch(N){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${N instanceof Error?N.message:String(N)}`)}}function ut(A){i=fi(A.values),s={...i},u=Array.isArray(A.warnings)?A.warnings:[],Dn(A.queue)&&(t.onQueueAdopt?.(A.queue),U={})}async function Ze(A){let N=H(),B=j();if(!N||!B||L.length===0||A==="quick_fix"&&!Oe())return;let we=ye=>({preset_id:L,expected_revision:N.revision,expected_queue_revision:ye,...A==="quick_fix"?{lane:"quick_fix"}:{},...te()});try{let ye=await ce("apply-impl-preset-global",we(B.revision));if(A==="quick_fix"&&ye&&ye.lane!=="quick_fix"){o("\uC11C\uBC84 \uC751\uB2F5\uC5D0 lane\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uD050 \uC2A4\uB0C5\uC0F7\uC744 \uB2E4\uC2DC \uBC1B\uC740 \uB4A4 \uD655\uC778\uD558\uC138\uC694"),Me();return}if(ye&&ye.applied&&ut(ye),r!==null&&ye&&ye.queue_applied===!1){let pt=ye.queue&&typeof ye.queue.revision=="number"?ye.queue.revision:j()?.revision??B.revision;if(ye=await ce("apply-impl-preset-global",we(pt)),A==="quick_fix"&&ye&&ye.lane!=="quick_fix"){o("\uC11C\uBC84 \uC751\uB2F5\uC5D0 lane\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uD050 \uC2A4\uB0C5\uC0F7\uC744 \uB2E4\uC2DC \uBC1B\uC740 \uB4A4 \uD655\uC778\uD558\uC138\uC694"),Me();return}ye&&ye.applied&&ut(ye)}ye&&ye.applied?ye.queue_applied===!1&&o("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):ye&&ye.conflict&&o("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(ye){o(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${ye instanceof Error?ye.message:String(ye)}`)}Me()}async function dt(){W=!0,F=!1,Me();try{let A=await ce("get-worker-system-prompt",{});!A||typeof A!="object"||Array.isArray(A)?F=!0:D=A}catch{F=!0}finally{W=!1,Me()}}function Zt(){if(q=!q,q&&!D){dt();return}Me()}function $(){let A=Ro({loading:W,error:F});if(A)return A;if(!D)return"";let N=Array.isArray(D.variants)?D.variants:[];return c`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${q?$():""}
    </section>`}function De(A,N,B,we,ye,pt,wt,yt){let Tt=ye[A]??cn,jt=Ja(A,B,ye,me(),ne(),wt,yt),Ut=jt.options.find(St=>St.value===Tt),Yt=Tt===cn?jt.full_value:Ut?.full_value;return c`<select
        ...
        .value=${Ar(String(Tt))}
        @change=${St=>we(A,String(St.target.value))}
      >
      ...
      ${Tt===cn?c`<span class="settings-dialog__source-badge">기본</span>`:""}`}function Se(A,N,B,we,ye,pt=!1,wt,yt=null,Tt=null){return c`<div
      class=${`settings-dialog__row${pt?" settings-dialog__row--off":""}`}
      title=${pt&&Tt?Tt:""}
    >
      <span class="settings-dialog__row-label">${N}</span>
      <span class="settings-dialog__controls">
        ${De(A,N,B,we,ye,pt,wt,yt)}
      </span>
    </div>`}function Pe(A,N,B,we,ye,pt){let wt=Object.hasOwn(a,A),yt=l[A]??s[A]??cn;return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${N}</span>
      <span class="settings-dialog__controls">
        <input
          type="text"
          ...
          placeholder=${B}
          .value=${Ar(yt)}
          @input=${Tt=>ke(A,String(Tt.target.value))}
    ...
    </div>`}function je(A,N,B,we){return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${N}</span>
      <span class="settings-dialog__controls">
        ...
        <span class="settings-dialog__hint" data-key-hint=${A}>${we}</span>
      </span>
    </div>`}function it(A,N){let B=N?N.active:null;return Dn(B)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${A==="claude"?B.email:Io({...B,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function kt(A,N,B){let we=T[B],ye=Object.hasOwn(b,A)?b[A]:cn,pt=B==="claude"?ua:Io,wt=!!we?.accounts.some(yt=>yt.key===ye);return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${N}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${N}
        ...
        >
          ...
          ${we?.accounts.map(yt=>c`<option value=${yt.key} ?selected=${yt.key===ye}>
                ${pt(yt)}
              </option>`)||""}
        </select>
    ...
    </div>`}function se(){let A=m.warnings.join(", ");return m.state==="unusable"?`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uD574\uC11D\uD560 \uC218 \uC5C6\uC5B4 \uC774 \uB808\uD3EC\uC758 \uB514\uC2A4\uD328\uCE58\uAC00 \uAC70\uBD80\uB429\uB2C8\uB2E4 \u2014 ${A} \xB7 \uACC4\uC815\uC744 \uB2E4\uC2DC \uACE0\uB974\uBA74 \uD574\uC18C\uB429\uB2C8\uB2E4`:m.warnings.length>0?`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC5D0 \uC54C \uC218 \uC5C6\uB294 \uD0A4\uAC00 \uC788\uC2B5\uB2C8\uB2E4 \u2014 ${A}`:null}function ge(A,N,B,we,ye,pt){return c`<div class="settings-dialog__row">
      ...
      <span class="settings-dialog__controls">
        ${De(B,`${A} \uBAA8\uB378`,we,Y,s,!1)}
        ${De(ye,`${A} effort`,gi,Y,s,!1)}
        ${De(pt,`${A} \uC18D\uB3C4`,Yu,Y,s,!1)}
      </span>
    </div>`}function Ge(A,N,B,we){return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${N}</span>
      <span class="settings-dialog__controls">
        <button
          type="button"
    ...
    </div>`}function at(A,N,B,we){return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${N}</span>
      <span class="settings-dialog__controls">
    ...
    </div>`}function mt(){let A=j(),N={};for(let B of[...qn,...yo])N[B]=Object.prototype.hasOwnProperty.call(U,B)?U[B]:A&&typeof A[B]=="string"?A[B]:null;return N}function gt(){let A=mt(),N={};for(let B of yo)N[B]=A[B]??null;for(let B of["quick_fix_impl_dispatch","quick_fix_impl_runtime","quick_fix_impl_model","quick_fix_impl_effort","quick_fix_impl_speed"])N[B]=s[B]??null;return N}function nt(){let A=ne(),N=s.impl_runtime,B=s.impl_model,we=H(),ye=j(),pt=mt(),wt=wo(A,re),yt=ko(A,void 0).filter(Ve=>Ve!==En),Tt=Fr(A,void 0,void 0),jt=hi(A,re,pt.orchestration_model||En).filter(Ve=>Ve!==En),Ut=L?(we?.presets||[]).find(Ve=>Ve.id===L):null,Yt=Ut?Zu(Ue(),Dn(Ut.settings)?Ut.settings:{}):null,St={quick_fix_orchestration_model:wo(A,null),quick_fix_orchestration_effort:hi(A,null,null).filter(Ve=>Ve!==En),quick_fix_orchestration_speed:Qn,quick_fix_impl_dispatch:Qo,quick_fix_impl_runtime:Wf,quick_fix_impl_model:yt,quick_fix_impl_effort:Tt,quick_fix_impl_speed:Qn},sn=Ut?Ju(gt(),Dn(Ut.settings)?Ut.settings:{},St):null,Wt=R==="quick_fix"?sn:Yt,Pt=Oe(),Ft=Pt?null:"\uC11C\uBC84\uAC00 quick_fix \uB808\uC778\uC744 \uC9C0\uC6D0\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4",zt={...s,...pt},xe=ye&&typeof ye.slots=="number"?ye.slots:$a+1,E=ye&&typeof ye.serial_lane_count=="number"?ye.serial_lane_count:$a,he=me()?.supported===!0,Le=se(),ot=Ja("workflow_mode",Xo,s,me(),A);return c`
      ...
      ${d?c`<div class="settings-dialog__empty">불러오는 중…</div>`:c`
            <div class="settings-dialog__preset-bar">
              <select
                aria-label="실행 프리셋"
                .value=${Ar(L)}
                @change=${Ve=>{L=String(Ve.target.value),Me()}}
              >
                <option value="" ?selected=${L===""}>
                  실행 프리셋…
                </option>
                ${(we?.presets||[]).map(Ve=>c`<option
                      value=${Ve.id}
                      ?selected=${Ve.id===L}
                    >
                      ${Ve.name}
            ...
            <div class="settings-dialog__group">
              ...
              ${Pe("bdui_url","beads-ui \uC8FC\uC18C","http://\uD638\uC2A4\uD2B8:3000","\uC138\uC158\uC774 Worker \uB808\uC778 \uBC30\uCE58\uB97C \uBB3C\uC5B4\uBCFC \uB54C \uC4F0\uB294 \uC8FC\uC18C\uC785\uB2C8\uB2E4","http:// \uB610\uB294 https:// \uB85C \uC2DC\uC791\uD558\uB294 \uC8FC\uC18C\uB9CC \uC800\uC7A5\uB429\uB2C8\uB2E4 (\uACBD\uB85C \uC5C6\uC774)",Gu)}
            ...
            <div class="settings-dialog__group">
              ...
              ${at("slots","\uB3D9\uC2DC \uC2E4\uD589",xe,Ve=>Ee(Ve))}
              ${at("serial-lane-count","\uC9C1\uB82C \uB808\uC778",E,Ve=>Je(Ve))}
            </div>
            ${Z()}
          `}
    `}function Me(){V||ft(nt(),e)}return{load(){U={},R="general",l={},a={};let A=[ae(),Ie()];return ee||A.push(_t()),Promise.all(A).then(()=>{})},render:Me,sessionDraft:()=>({...s}),destroy(){V=!0,ft(c``,e)}}}function Aa(e){return c`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ...
    >
      ...
      ${ae.worker?c`<span class="mon2-deck__chip" title=${ae.worker.title}
          ...
          >`:""}
    </div>`:""}function j(K){let ae=[];for(let[Q,de]of[["queue","\uB300\uAE30"],["pr_wait","PR"],["session_active","\uC138\uC158"]]){let Re=pc(K,Q);Re>0&&ae.push(`${de} ${Re}`)}return ae.join(" \xB7 ")}function ne(K){let ae=pc(K,"running"),Q=typeof K.slots=="number"?K.slots:1;return c`<div
    ...
    </div>`}function me(K){let ae=t.doneItems?t.doneItems():[],Q=t.rangeLabel?t.rangeLabel():"",de=Vf(Array.isArray(ae)?ae:[]),Re=be=>K.reduce((Ie,Ye)=>Ie+pc(Ye,be),0);return c`<div class="mon2-deck__bar">
      <span
    ...
    >
      ...
      </section>`})}`}function it(p,f){return c`<div
      class="mon2-item"
      data-bead-id=${p.id}
    ...
    >
      ${jn($(f),{actions:So(f)})}
    </div>`}function Ge(p){if(p.length===0)return"";let f=p.length-1;return`${p[0].id} \uC810\uC720${f>0?` +${f}`:""}`}function at(p){return c`<div
      class="mon2-item mon2-item--ghost"
      data-bead-id=${p.id}
    >
      ${jn({id:p.id,title:p.title,lane:"running",draggable:!1,ghost:!0,badges:[p.badge]})}
    </div>`}function ze(p,f){let x=f.occupants,_=f.cross_wait_peers||[];return{id:f.id,pane_id:"",title:`${p.name} \xB7 \uC9C1\uB82C ${f.index+1}`,rows:[...x.map(g=>at(g)),...f.items.map((g,O)=>ge(f,g,O))],count:f.items.length,empty:f.empty===!0,...x.length>0?{badge:c`<span
...
`)}
      ...
      ${Lo(W?.draft||null,W?Ne(W.root_dir):{})}`}function Me(){return c`<div class="worker-filter">
  ...
  `}var bk=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function __(e,t){let{transport:n,policyStore:r,labelOptions:o}=t,i=t.notify||(ne=>_e(ne,"error",4e3)),s=document.createElement("dialog");s.id="settings-dialog",s.className="settings-dialog",s.setAttribute("role","dialog"),s.setAttribute("aria-modal","true"),s.setAttribute("aria-label","\uC124\uC815"),e.appendChild(s);let l="execution",a=!1,u="",d=null;function m(){if(d)return d;let ne=s.querySelector('[data-pane="execution"]');return ne?(d=xa(ne,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:i,onQueueAdopt:me=>t.queueStore?.set?.(me)}),d):null}function b(){return c`
    ...
    </span>`}function R(H,te,ce){let Te=$_(te,ce),K=te.available&&(te.held||Te>_c),ae=K?`${Math.floor(Te/60)}\uBD84 \uC804 \uCE21\uC815`:"",Q=te.accounts.filter(Ie=>!Ie.active).length,de=`usage-meter__group${K?" usage-meter__group--stale":""}`,Re=c`<span class="usage-meter__provider"
        >${H.label}</span
      >
    ...
    >
      ...
      <span class="usage-meter__account-reset"
        >${Te.length>0?`\u21BB ${Te}`:""}</span
      >
    </span>`}function W(H,te){return $k.includes(te)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${H.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function F(H,te,ce){let Te=te.status==="ok",K=typeof te.ageSeconds=="number"&&te.ageSeconds>_c,ae=s.get(k_(H.key,te.number)),Q=r.get(H.key),de=Q!==void 0,Re=Q===te.number,be=["usage-meter__account"];return te.active&&be.push("usage-meter__account--active"),Te||be.push("usage-meter__account--unavailable"),K&&be.push("usage-meter__account--stale"),c`<div class=${be.join(" ")}>
...
\uC9C1\uC804 \uB9AC\uBDF0 \uC138\uC158 \uC885\uB8CC \uC0AC\uC720: ${e.review_session.failure}`,alert:!0})}return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:i,alert:!0})}return e.gate?.reason==="spec_id_missing"?n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0}):r.length>0?n(`\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694 \xB7 ${r[0]}`,{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${r.join(", ")}`,alert:!0}):e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Z_(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Z_(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function Pw(e,t,n,r,o=null,i=null,s=null,l=!1,a=null,u=!0,d=null,m=null,b=null,h={},k=!1,S={},T=null,ee={active:!1,failure:null,origin:null},re=!1){let U=!!a&&a.position>0,L=!!a?.continuation_action&&a.continuation_action.continuation===null,R=!!a&&a.active===!0,P=a&&a.failure||null,q=Aw(a?a.waiting:null),W=n[e]||null,F=W&&W.gate?W.gate:null,D=W&&W.pr?W.pr:null,V=Sw(a?a.resolution:null),j=Cw(b),ne=Ow(b,j),me=a&&a.authority||null,Oe=a&&a.review_dispatch||null,H=a?.hold?.auto_review_wait==="slot"?"slot":null,te=!!b&&typeof b=="object"&&Tw.has(b.phase),ce=U&&!R&&(!me||te||me.source==="automatic"&&!k),Te=s==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":V?V.badge:s==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":q,K=!!F&&F.base_badge==="\uCDA9\uB3CC",ae=!!F&&F.enabled===!0,Q=ds({bead_id:e,merge_sha:S.merge_sha,cleanup_cursor:S.cleanup_cursor,merge_progress:i&&i.merge_progress?i.merge_progress:null,cleanup_failed:r,repo_operations:S.repo_operations}),de=Ui(Q),Re=i&&!Q&&(i.queueing??null)?i.queueing:null,be=!!r&&["repo_operations","post_merge_jobs","child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!F&&F.tier==="merged",Ie=r&&r.step==="repo_operations"&&Q?.failed===!0&&(Q.step==="deploy"||Q.step==="verify")?Q.step:null,Ye=l&&!!r&&!!F&&F.tier==="merged",_t=ce&&(ae||K||F?.reason==="base_behind"||yc.has(F?.reason)||be||Ye),G=yc.has(F?.reason),pe=l&&K&&u===!1,oe=ar(h,e,{external:l,merge_active:R||Q?.step==="merge",merge_queued:U,conflict_active:!!s,cleanup_active:de,merged:!!r||F?.tier==="merged"}),Y=!!oe.operation,ke=!!r||b?.phase==="needs_human"||!!oe.error,fe=U&&!P&&!L&&!be&&!(ne&&ne.lock_actions),Ce=Dw({auto_pending:fe,continuation_required:L,queueing:Re,merge_step:Q,conflict_badge:Te,conflict_live:V?.live===!0||s==="running",auto_resolution:j,recovery:ne,cleanup_failed:r,cleanup_label:r?Gr(r.step):null,base_exception:m,conflicting:K,gate:F,receipt_check:W&&W.receipt_check?W.receipt_check:null,queue_failure:P,auto_skip:d,queued:U,queue_active:R,queue_position:a?a.position:0,review_session:ee,review_dispatch:Oe,auto_review_wait:H,activity:Te?null:i&&i.activity||null}),Ne=Ce?.live===!0&&Ce.title?c`<span title=${Ce.title}>${Ce.label}</span>`:Ce?.label||null,Qe=Lw(W&&W.receipt_check?W.receipt_check:null);return{id:e,title:l?c`${t}<span class="muted"> · 세션</span>`:t,reason:r&&Q?.active!==!0?Bi(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",...T?{dependency_chips:T}:{},external:l,pr_number:D&&typeof D.number=="number"?D.number:null,pr_url:D&&typeof D.url=="string"?D.url:"",completion_badge:Ce?.live!==!0&&Ce?.title?Ce.label:null,completion_title:Ce?.title||"",...b?.phase==="needs_human"&&typeof b.log_path=="string"&&b.log_path.length>0?{log_path:b.log_path}:{},...Qe.length>0?{receipt_badge:{codes:Qe}}:{},badges:Ne?[Ne]:[],live_badge:Ce?.live===!0?Ne:null,usage:o,alert:Ce?.alert===!0,merge_action:F?.tier==="merged"&&!be&&!Ye?!1:!U||L||ce||G,cancel_action:U&&!L,cancel_enabled:!R&&!(ne&&ne.lock_actions),cancel_title:ne&&ne.lock_actions?`${ne.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:R?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:oe,discard_action:oe.action,resolve_action:ke,resolve_enabled:!re,resolve_title:re?"\uC138\uC158 \uAE30\uB3D9 \uC694\uCCAD \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":"\uC774 \uC2E4\uD328\uB97C \uC0AC\uB78C\uC774 \uC774\uC5B4\uBC1B\uB294 \uB300\uD654\uD615 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 \u2014 \uAE30\uB85D\uB41C \uC138\uC158\uC774 \uC788\uC73C\uBA74 fork\uD558\uACE0, \uC5C6\uC73C\uBA74 \uC0C8 \uC138\uC158\uC5D0 \uC0AC\uC720\uB97C \uC2E3\uC2B5\uB2C8\uB2E4",merge_step:Q,discard_enabled:oe.enabled,discard_title:oe.title,merge_enabled:!Q&&!Re&&!s&&!Y&&!m&&!(ne&&ne.lock_actions)&&!pe&&ee.active!==!0&&(ae||K||F?.reason==="base_behind"||G||be||Ye||_t||te&&!R),merge_label:L?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":be||Ye?Ie==="deploy"?"\uBC30\uD3EC \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":Ie==="verify"?"\uAC80\uC99D \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":"\uC815\uB9AC \uC7AC\uC2DC\uB3C4":K&&!Q&&!be?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":F?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":G?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":ce?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:Y?oe.error?`\uD3D0\uAE30 \uC2E4\uD328: ${oe.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${oe.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:L?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":Re?"\uC694\uCCAD\uC744 \uBCF4\uB0B4\uB294 \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":Q?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${Q.label}`:Ie?`\uBA38\uC9C0 \uC644\uB8CC \u2014 ${Ie==="deploy"?"\uBC30\uD3EC":"\uAC80\uC99D"} \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC2E4\uD328\uD574 \uC815\uB9AC\uAC00 \uBA48\uCDC4\uC2B5\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uC800\uC7A5\uC18C \uC791\uC5C5\uBD80\uD130 \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4`:Ye?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC2DC\uB3C4\uD569\uB2C8\uB2E4":pe?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":s==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":s==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":be?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uB2E4\uC2DC \uC2DC\uB3C4\uD569\uB2C8\uB2E4":K?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":F?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":ee.active===!0?ee.origin==="auto"?"\uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uB05D\uB098\uBA74 \uC601\uC218\uC99D\uC744 \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uB05D\uB098\uBA74 \uC601\uC218\uC99D\uC744 \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":F?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uB9AC\uBDF0\uB9CC \uC218\uD589\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":F?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":F?.reason==="review_receipt_invalid"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uAE30\uB85D\uC774 \uC131\uB9BD\uD558\uC9C0 \uC54A\uC74C \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":F?.reason==="review_receipt_undetermined"?"\uB9AC\uBDF0 \uC601\uC218\uC99D ancestry probe \uBBF8\uC644\uB8CC \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC0C8 \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":F?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":ae?`\uBA38\uC9C0 (${F.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:F&&F.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${F&&F.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function vc(e,t={}){let{transport:n,issueStores:r,queueStore:o,sessionLogStore:i,gotoIssue:s,getWorkspacePath:l,switchWorkspace:a,openDoc:u,doneRange:d,onDoneRangeChange:m}=t,b=r?co(r):null,h=hw(),k=null,S=null,T=null,ee=null,re=null,U=ho(()=>_()),L=new Map,R=new Map,P=R_(),q=mc(P)===null,W=d?Kn(d):yw();function F(){let w=ro.find(y=>y.value===W);return w?w.label:"\uC624\uB298"}let D=_a("beads-ui.worker.lane-collapsed"),V=!1,j="";function ne(){return j.trim().length>0}function me(w){return ne()?w.filter(y=>y.search_match===!0).length:void 0}let Oe=new Set,H=new Set,te=new Set,ce=new Set,Te=new Set,K=new Set,ae=null,Q=[],de=V_({queueStore:o,issueStores:r,transport:n,getWorkspacePath:l,onInvalidate:()=>_()});function Re(){de.refreshSessionDefaults()}let be=document.createElement("div");be.className="worker-console";let Ie=document.createElement("div");Ie.className="worker-top";let Ye=document.createElement("div");Ye.className="worker-drawer-overlay",Ye.hidden=!0;let _t=document.createElement("div");_t.className="worker-drawer-overlay__backdrop";let G=document.createElement("div");G.className="worker-drawer-host";let pe=document.createElement("div");pe.className="worker-drawer-host",pe.hidden=!0,Ye.append(_t,G,pe);let oe=document.createElement("div");oe.className="worker-lanes-host",be.append(Ie,Ye,oe),e.appendChild(be);let Y=$r(null,null),ke=[],fe=ga({transport:n,console_el:be,getLanes:()=>Y,getWorkspaces:()=>ke,getCrossLanes:()=>null,reproject:()=>({lanes:B(),raw_lanes:null}),onCorrection:()=>{},showToast:_e,requestRender:()=>_(),adoptQueue:(w,y)=>{o&&o.set(y)},onDragBegin:()=>{S=null}}),Ce=null,Ne=Oo(G,{transport:n,sessionLogStore:i,onClose:()=>{Ce=null,Ye.hidden=!0,_()}}),Qe=K_(pe,{onClose:()=>{pe.hidden=!0,Ye.hidden=!0,_()}}),Fe=N_({getWorkspacePath:l||(()=>"")}),J=l&&l()||"",X=F_({queueStore:o,transport:n,onChanged:()=>_(),onOpenScript:(w,y)=>{Fe.open(w,y)}});function Ee(){return o&&o.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Ea,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function Je(w){let y=ha(w,Ee());y&&(re=y,_())}function st(){re=null,_()}function Ue(){let w=ya(re);w&&(re=null,_(),$(w.attempt_id,"session",w.payload))}function et(w){if(!S||!w.some(C=>C.id===S))return null;let y=ss(Ee());return y?{bead_id:S,lanes:y}:null}function vt(){return l&&l()||""}async function ut(w,y){await fe.sendOp({type:"worker-queue-place",payload:{bead_id:w,...y==="parallel"?{}:{lane:y}},root_dir:vt()},w)}function Ze(){let w=Ee();return typeof w.revision=="number"?w.revision:0}function dt(w){w&&w.queue&&o&&o.set(w.queue)}async function Zt(w){if(!n||!w)return;let y=await n("worker-attempt-pause",{attempt_id:w});y&&y.paused===!1&&y.reason&&_e(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${y.reason}`,"error",2400)}async function $(w,y="session",C={}){if(!n||!w)return;let ie=n,$e=Ee().attempts?.[w]||null;await fo({context:{bead_id:$e?.bead_id||"",kind:y,tuple:$e?Rn($e):""},transport:qe=>ie("worker-attempt-resume",{attempt_id:w,expected_revision:Ze(),...C,...qe}),adopt:dt})}async function Z(w,y,C=!0){if(!n)return null;let ie=n,$e=await ie(w,{...y,expected_revision:Ze()});return dt($e),$e&&$e.conflict&&C&&($e=await ie(w,{...y,expected_revision:Ze()}),dt($e)),$e}async function De(w){if(!n||!w)return;let y=Ee().merge_queue?.find(ie=>ie.bead_id===w)?.continuation_action;if(y?.mismatch&&y.continuation===null){await kt(w,y.mismatch);return}Oe.add(w),_();let C;try{C=await Z("worker-merge-queue-add",{bead_id:w})}catch{_e("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{Oe.delete(w),_()}if(!(!C||C.applied)){if(C.conflict){_e("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}_e(ww(C.reason),"error",2400)}}async function Se(w){if(!(!n||!w||H.has(w))){H.add(w),_();try{let y=await n("worker-cleanup-retry",{bead_id:w,expected_revision:Ze()});dt(y),y&&!y.retried&&!y.conflict&&y.reason&&_e(`\uC815\uB9AC \uC7AC\uC2DC\uB3C4 \uAC70\uBD80: ${y.reason}`,"error",2400)}finally{H.delete(w),_()}}}async function Pe(w){if(!(!n||!w||te.has(w))){te.add(w),_();try{let y=await n("worker-resolve-in-session",{bead_id:w,expected_revision:Ze()});dt(y);let C=$w(y);C!==null&&_e(C,xw(y),4e3)}finally{te.delete(w),_()}}}async function je(w,y){let C=Ee().hold;if(!n||!C||typeof C.since!="number")return;let ie=await n(w,{since:C.since});dt(ie),ie&&ie.ok===!1&&_e(`${y}: ${ie.reason==="hold_changed"?"\uD050 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694":ie.reason||""}`,"error",2800)}async function it(w){if(!n||!w)return;let y=await n("worker-queue-start-now",{bead_id:w});dt(y),y&&y.ok===!1&&_e(`\uC9C0\uAE08 \uC2DC\uC791 \uAC70\uBD80: ${y.reason==="not_waiting"?"\uC774 \uC774\uC288\uB294 \uB354 \uC774\uC0C1 \uB300\uAE30 \uB808\uC778\uC5D0 \uC5C6\uC2B5\uB2C8\uB2E4":y.reason||""}`,"error",2800)}async function kt(w,y){let C=await br({continuation_mismatch:y},($e,qe)=>Z("worker-merge-queue-add",{bead_id:w,continuation:$e,decision_token:qe},!1)),ie=C?.queue?.merge_queue?.find($e=>$e.bead_id===w)?.continuation_action;if(C?.applied!==!0&&ie?.continuation===null&&ie.mismatch){await kt(w,ie.mismatch);return}C&&C.applied===!1&&!C.conflict&&_e("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function se(w){if(!n)return;let y=await Z("worker-merge-auto-toggle",{on:w});!y||y.conflict||_e(w?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",w?"success":"info",2400)}async function ge(w){if(!n||!w)return;let y=await Z("worker-merge-queue-remove",{bead_id:w});y&&!y.conflict&&!y.applied&&y.reason==="merge_active"&&_e("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function Ge(){await Z("worker-merge-queue-remove",{all:!0})}async function at(w,y=null,C="unmerged",ie=null){if(!n||!w)return;let $e=as(w,C);if(!(!!ie||typeof globalThis.confirm!="function"||globalThis.confirm($e)))return;let Xe=await n("worker-discard",{bead_id:w,...y?{attempt_id:y}:{},...ie?{operation_id:ie}:{},expected_revision:Ze()});if(dt(Xe),Xe&&Xe.conflict&&(Xe=await n("worker-discard",{bead_id:w,...y?{attempt_id:y}:{},...ie?{operation_id:ie}:{},expected_revision:Ze()}),dt(Xe)),Xe&&Xe.discarded===!0){_e(Oi(Xe),"success",5e3);return}if(Xe&&Xe.reason){_e(`\uD3D0\uAE30 \uC2E4\uD328: ${Xe.reason}`,"error",2800);return}if(Xe&&Xe.accepted&&Xe.pending==="merged_revert"){_e("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(Xe&&Xe.accepted&&!Xe.discarded){_e(`\uD3D0\uAE30 \uC9C4\uD589: ${Xe.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}Xe&&!Xe.conflict&&_e("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function ze(w,y,C){if(!n||!w||!y||typeof globalThis.confirm=="function"&&!globalThis.confirm(ls(w,C)))return;let ie=await n("worker-discard-abandon",{bead_id:w,operation_id:y,expected_revision:Ze()});if(dt(ie),ie&&ie.conflict&&(ie=await n("worker-discard-abandon",{bead_id:w,operation_id:y,expected_revision:Ze()}),dt(ie)),ie&&ie.abandoned===!0){_e(Ri(C),"success",5e3);return}if(ie&&ie.reason){_e(`\uD3D0\uAE30 \uD3EC\uAE30 \uAC70\uBD80: ${ie.reason}`,"error",2800);return}ie&&!ie.conflict&&_e("\uD3D0\uAE30 \uD3EC\uAE30 \uAC70\uBD80: unknown","error",2800)}async function mt(w,y,C){if(!(!n||!y||!C||Te.has(y))){Te.add(y),_();try{let ie=await n(w,{bead_id:y,action_id:C,expected_revision:Ze()});dt(ie),ie?.conflict?_e("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!ie?.ok&&ie?.reason&&_e(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(ie.reason)}`,"error",2800)}finally{Te.delete(y),_()}}}async function gt(w,y){if(!n||!y||ce.has(y))return;ce.add(y),_();let C;try{let ie=async($e={})=>await n(w,{bead_id:y,expected_revision:Ze(),...$e});C=await ie(),dt(C),C&&C.conflict&&(C=await n(w,{bead_id:y,expected_revision:Ze()}),dt(C)),w==="worker-revise-fix"&&(C=await br(C,($e,qe)=>ie({continuation:$e,decision_token:qe}),{onResult:dt,refresh:()=>ie()}))}finally{ce.delete(y),_()}if(!(!C||C.conflict)){if(C.ok){_e(w==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}_e(`\uCC98\uBD84 \uAC70\uBD80: ${C.reason||""}`,"error",3e3)}}async function nt(w){if(!n)return;let y=await n("worker-automation-toggle",{on:w,expected_revision:Ze()});dt(y),y&&y.conflict&&await n("worker-automation-toggle",{on:w,expected_revision:Ze()}).then(dt)}async function Me(w){if(!n||!w)return;let y=await n("worker-repo-operation-dismiss",{operation_id:w});dt(y),y&&y.ok===!1&&_e(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${y.reason||""}`,"error",3e3)}async function A(w){if(!n||!Number.isFinite(w))return;let y=Math.max(Ea,Math.floor(w)),C=await n("worker-queue-set-slots",{slots:y,expected_revision:Ze()});dt(C),C&&C.conflict&&await n("worker-queue-set-slots",{slots:y,expected_revision:Ze()}).then(dt)}async function N(w){if(!n||!Number.isInteger(w)||w<1||w>Q_)return;let y=Ee(),C=(Array.isArray(y.serial_lanes)?y.serial_lanes:[]).slice(w).reduce((qe,Xe)=>qe+(Array.isArray(Xe?.entries)?Xe.entries.length:0),0),ie=()=>({count:w,expected_revision:Ze()}),$e=await n("worker-queue-set-serial-lane-count",ie());dt($e),$e&&$e.conflict&&($e=await n("worker-queue-set-serial-lane-count",ie()),dt($e)),$e&&$e.applied&&C>0&&_e(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${C}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}function B(){let w=Nr(W),y=de.read({candidate_sort:P,done_since:w});return ke=y.workspaces,Y=$r(y.workspaces,y.workspaces_state,{done_since:w,candidate_filter:h,candidate_hidden_counts:"per_control",candidate_sort:"as_given",groups:"all",search:j}),Y}function we(w){return w.queue_groups[0]||mw}function ye(w){let y=w.dependency_chips||null,C={...y&&y.released?{released:y.released}:{},...y&&y.dependents?{dependents:y.dependents}:{}},ie=L.get(w.id),$e=R.get(w.id)||null,qe=ie&&ie.overlaps.length>0?ie.overlaps:null,Xe=!!ie&&ie.scope_missing;return!$e&&!qe&&!Xe&&Object.keys(C).length===0?null:{...C,...$e?{predecessors:$e}:{},...qe?{overlaps:qe}:{},...Xe?{scope_missing:!0}:{}}}function pt(w){return{...w,workspace_name:"",done_layout:void 0,dependency_chips:ye(w)||void 0,chip_popover:wt(w)}}function wt(w){return qi(w,y=>U.isOpen({bead_id:w.id,chip_key:y}))}function yt(){let w=Ee(),y=new Map;for(let C of Object.values(fn(w.lane_states))){let ie=Array.isArray(C?.corrections)?C.corrections:[];for(let $e of ie)$e&&typeof $e.bead_id=="string"&&typeof $e.after=="string"&&y.set($e.bead_id,$e.after)}return{admission:fn(w.admission),correction_after:y}}function Tt(w,y){let C=pt(w),ie=Id(y.admission[w.id]||null,!!w.discard||Te.has(w.id)),$e=y.correction_after.get(w.id);return{...C,draggable:C.draggable===!0&&!ie,stale_work:ie,reason:ie?"":C.reason,badges:$e?[`\u{1F517} ${$e} \uB4A4 (blocks \uC790\uB3D9)`,...C.badges||[]]:C.badges,revise_enabled:C.revise_enabled===!0&&!ce.has(w.id)}}function jt(w){let y=yt();return we(w).sublanes.parallel.map(C=>Tt(C,y))}function Ut(w){let y=yt();return we(w).sublanes.serial.map(C=>{let ie=C.occupants.map($e=>({id:$e.id,title:$e.title,draggable:!1,lane:C.id,ghost:!0,badges:[$e.badge],...typeof $e.search_match=="boolean"?{search_match:$e.search_match}:{}}));return{id:C.id,index:C.index+1,raw_length:C.raw_length,ghosts:ie,items:C.items.map($e=>Tt($e,y)),occupied:C.occupied_by.length>0,badge:C.occupants.length>0?C.occupants[0].badge:"\uB300\uAE30",cycle:C.cycle===!0}})}function Yt(w){return w.runnable.map(y=>pt(y))}function St(w){return w.done.map(y=>pt(y))}function sn(w){let y=w.running.filter(C=>C.non_occupying!==!0).map(C=>({...C,bead_id:C.id,attempt_id:C.attempt_id||"",paused:C.run_state==="paused",failed:C.run_state==="failed",parked:C.run_state==="parked",retry_wait:C.run_state==="retry_wait",waiting:C.run_state==="waiting",wait:C.wait||null,provider_hold:C.run_state==="provider_hold",hold:C.hold?{...C.hold,open:ee===C.attempt_id}:null,status_label:C.run_state==="failed"?C.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328":C.run_state==="parked"?"\uC138\uC158 \uB300\uAE30":C.run_state==="retry_wait"?"\uC7AC\uC2DC\uB3C4 \uB300\uAE30":C.run_state==="waiting"?"\uC120\uD589 \uB300\uAE30":C.run_state==="provider_hold"?"\uACF5\uAE09\uC790 \uBCF4\uB958":void 0,can_pause:C.can_pause!==!1,workspace_name:"",dependency_chips:ye(C)||void 0,chip_popover:wt(C),rollup_expanded:K.has(C.id),failure:C.failure?{...C.failure,open:T===C.attempt_id}:null,...Do(C.id,{discard:C.discard,parked:C.run_state==="parked"},te.has(C.id))}));return[...y.filter(C=>C.failed===!0),...y.filter(C=>C.failed!==!0&&C.parked===!0),...y.filter(C=>C.failed!==!0&&C.parked!==!0)]}function Wt(w){return Pt(w).map(y=>({...y,chip_popover:wt(y)}))}function Pt(w){if(ae&&ae.model===w)return ae.rows;let y=Ee(),C=we(w),ie=fn(y.attempts),$e=Object.values(ie).filter(ir),qe=new Map;for(let We of $e)qe.set(We.attempt_id,We);let Xe=new Map;for(let We of $e)Xe.set(We.bead_id,We);let Rt=new Map;for(let We of[...w.pr_wait,...w.running,...w.queue,...w.runnable,...w.done])Rt.has(We.id)||Rt.set(We.id,We);let tn=We=>{let Nt=null;for(let Cn of $e)!Cn||Cn.bead_id!==We||El(Cn,qe)||(Nt===null||(typeof Cn.started_at=="number"?Cn.started_at:0)>=(typeof Nt.started_at=="number"?Nt.started_at:0))&&(Nt=Cn);return Nt&&typeof Nt.target_base=="string"?Nt.target_base:null},ct=new Map;for(let We of w.running)We.run_state==="failed"||We.conflict_resolution!==!0||(We.run_state!=="paused"?ct.set(We.id,"running"):ct.has(We.id)||ct.set(We.id,"paused"));let dn=fn(y.auto_merge_skips),An=new Set(C.merge.auto_excluded),Or=fn(y.pr_observations),Hn=fn(y.pr_activity),Zn=fn(y.cleanup_failed),Jn=fn(y.discard_operations),er=fn(y.bead_workflow),un=fn(y.bead_titles),tr=y.merge_queue_state||{active:null,failures:{}},pr=C.merge.state.waiting,fr=new Map;for(let We of Array.isArray(y.merge_queue)?y.merge_queue:[])We&&typeof We=="object"&&We.bead_id&&fr.set(We.bead_id,We);let Ir=(Array.isArray(y.pr_wait)?y.pr_wait:[]).map(We=>{let Nt=Rt.get(We.bead_id);return{...Pw(We.bead_id,Nt?.title||un[We.bead_id]||We.bead_id,Or,Zn[We.bead_id]||null,sr(ie,We.bead_id),Hn[We.bead_id]||(Oe.has(We.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:H.has(We.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),ct.get(We.bead_id)||null,We.external===!0,{position:C.merge.positions.get(We.bead_id)||0,active:tr.active===We.bead_id,failure:fn(tr.failures)[We.bead_id]||null,waiting:pr&&pr.bead_id===We.bead_id?pr.reason:null,resolution:C.merge.resolutions.get(We.bead_id),continuation_action:C.merge.continuations.get(We.bead_id),authority:C.merge.authorities.get(We.bead_id)||null,hold:fr.get(We.bead_id)?.hold||null,review_dispatch:fr.get(We.bead_id)?.review_dispatch||null},We.wt_present!==!1,y.auto_merge===!0&&An.has(We.bead_id)?dn[We.bead_id]?.reason||"":null,Sl(C.declared_base,tn(We.bead_id)),fn(y.completion_status)[We.bead_id]||null,Jn,y.auto_merge===!0,{merge_sha:We.merge_sha,cleanup_cursor:We.cleanup_cursor,repo_operations:C.repo_operations},Nt?ye(Nt):null,Ed(ie,We.bead_id),te.has(We.bead_id)),...Nt?.search_match===void 0?{}:{search_match:Nt.search_match},workflow:er[We.bead_id]||null,priority:Nt?.priority,from_id:Nt?.from_id,...Nt?.created_at===void 0?{}:{created_at:Nt.created_at},...Nt?.updated_at===void 0?{}:{updated_at:Nt.updated_at}}});return ae={model:w,rows:Ir},Ir}function Ft(w){let y=we(w),C=[];for(let qe of w.running)qe.non_occupying!==!0&&C.push({id:qe.id,title:qe.title,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:qe.serial_lane_id??null});for(let qe of w.pr_wait)C.push({id:qe.id,title:qe.title,location_label:"PR \uB300\uAE30",kind:"pr_wait",lane_id:null});for(let qe of y.sublanes.serial)qe.items.forEach((Xe,Rt)=>{C.push({id:Xe.id,title:Xe.title,location_label:`${qe.id} #${Rt+1}`,kind:"serial",lane_id:qe.id})});y.sublanes.parallel.forEach((qe,Xe)=>{C.push({id:qe.id,title:qe.title,location_label:`#${Xe+1}`,kind:"parallel",lane_id:null})});for(let qe of w.runnable)C.push({id:qe.id,title:qe.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null,queue_placeable:qe.queue_placeable===!0});let ie=Ee();L=D_(ie.bead_scope,C);let $e=new Map;for(let qe of[...w.running,...w.runnable])Array.isArray(qe.blocked_by)&&qe.blocked_by.length>0&&$e.set(qe.id,qe.blocked_by);for(let[qe,Xe]of Object.entries(fn(ie.bead_blocked_by)))Array.isArray(Xe)&&$e.set(qe,Xe.filter(Rt=>typeof Rt=="string"&&Rt.length>0));R=Kd($e,C,fn(ie.blocker_workspaces))}function zt(w){let y=w.hold&&typeof w.hold=="object"?w.hold:null;if(!y||y.kind!=="env"&&y.kind!=="systemic")return"";let C=Sr(y.cause)||String(y.cause||""),ie=Array.isArray(w.lineages)?w.lineages:[];if(y.kind==="env"){let qe=ie.map(Rt=>Rt&&Rt.next_at).filter(Rt=>typeof Rt=="number").sort((Rt,tn)=>Rt-tn)[0],Xe=typeof qe=="number"?` \xB7 \uB2E4\uC74C ${new Date(qe).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"})}`:"";return c`<div class="worker-hold worker-hold--env" role="status">
      ...
      </div>`}let $e=(Array.isArray(y.bead_ids)?y.bead_ids:[]).filter(qe=>typeof qe=="string"&&qe.length>0);return c`<div class="worker-hold worker-hold--systemic" role="alert">
      <span class="worker-hold__text"
      ...
      >
        ...
        보류${ct?`, \uB2E4\uC74C \uD504\uB85C\uBE0C ${ct}`:""}
      </div>`}let ie=Array.isArray(fn(w.account_catalog).claude)?fn(w.account_catalog).claude:[],$e=ct=>ie.find(An=>An?.email===ct)?.alias||ct,qe=y.find(ct=>typeof ct.target?.account!="string"),Xe=ct=>typeof ct?.resets_at=="number"?new Date(ct.resets_at).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"}):"";if(qe){let ct=Xe(qe.target);return c`<div class="worker-provider-gate" role="status">
      ...
      보류${tn?`, \uB9AC\uC14B ${tn}`:""}
    </div>`}function E(w){let y=Ee(),C=we(w),ie=C.sublanes.parallel,$e=ie.length>0?ie[0].id:"\u2014",qe=c`<button
      type="button"
    ...
    >`,Or=c`<label class="worker-tgl worker-slots"
      ...
      .value=${j}
    />`,Zn=Cd(C.repo_operations,C.cleanup_failures),Jn=zt(y),er=xe(y);return V?c`<div class="worker-ribbon">
          ${qe} ${Xe}
    ...
    </div>`}function Le(){let w=q?"custom":mc(P)||"custom";return c`<select
      class="worker-sort"
      aria-label="후보 정렬"
      title="후보 정렬"
      .value=${w}
    ...
    >
    ...
    </div>`}function $t(w){let y=we(w).merge,C=Ee().auto_merge===!0;if(y.running)return c`<button
        type="button"
      ...
      >
        ⏸ 자동 머지
      </button>`;let ie=new Set(y.auto_excluded),$e=Wt(w).filter(qe=>qe.merge_action&&qe.merge_enabled&&!ie.has(qe.id)).length;return c`<button
      type="button"
    ...
    </div>`}function Et(w){let y=jt(w),C=vt();return Ni({parallel:{rows:y.map((ie,$e)=>It(ie,{kind:"parallel",root_dir:C,row_index:$e})),count:y.length,collapsed:D.isAreaCollapsed("parallel"),drop:{drop:"parallel",root_dir:C}},serial:{lanes:Ut(w).map(ie=>({id:ie.id,title:`\uC9C1\uB82C ${ie.index}`,rows:[...ie.ghosts.map($e=>jn({...$e,...Do($e.id,{discard:$e.discard,parked:!1},te.has($e.id))},{actions:So($e)})),...ie.items.map(($e,qe)=>It($e,{kind:"repo-serial",root_dir:C,row_index:qe,lane_id:ie.id}))],count:ie.ghosts.length+ie.items.length,match_count:me([...ie.ghosts,...ie.items]),empty:ie.ghosts.length+ie.items.length===0,badge:ie.badge,held:ie.occupied,cycle:ie.cycle,drop:{drop:"repo-serial",root_dir:C,lane_id:ie.id,lane_length:String(ie.raw_length)}})),collapsed:D.isAreaCollapsed("serial")}})}function Kt(w){return Uf(sn(w),Date.now(),Ce)}function _n(w){return w.running.some(y=>y.kind!=="session"&&y.run_state==="running")}function Lt(w){let y=we(w),C=Yt(w),ie=jt(w),$e=St(w),qe=Wt(w),Xe=sn(w),Rt=Xn({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4",items:C,match_count:me(C),src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Le(),header_row:q?ot():void 0,controls:he(w),collapsible:!0,collapsed:D.isCollapsed("candidate"),place_menu:et(C),onOpenDoc:u?(ct,dn)=>u(dn):void 0}),tn=Xn({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:$e,match_count:me($e),empty:`${F()} \uC644\uB8CC \uC5C6\uC74C`,header_control:Ve(),collapsible:!0,collapsed:D.isCollapsed("done"),preview:V?Array.isArray(y.token_total)?y.token_total.map(ct=>ct.label).join(" \xB7 "):y.token_total||X_($e):void 0});return V?c`<div class="worker-lanes worker-lanes--mobile">
          ${ji({live:_n(w),running_body:Xe.length>0?Kt(w):"",pr_wait_rows:qe.map(ct=>jn(ct)),count:Xe.length+qe.length})}
    ...
    `}function L(){let P=t.getState(),q=P.workspace?.current,W=P.workspace?.available||[],F=new Set(P.workspace?.hidden||[]),D=q?.path||W[0]?.path||"";if(W.length===0)return c``;let V=W.filter(j=>!F.has(j.path)||j.path===D);if(V.length<=1){let j=V[0]||W[0],ne=kc(j.path);return c`
