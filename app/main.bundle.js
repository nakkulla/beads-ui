...
`);return l`<span
  ...
  >
    ...
    ${e.failure?l`<div class="worker-banner worker-banner--failure" role="alert">
          ...
          ${Hb(e.failure.cause_detail,e.failure.reason)}
          ${Gb(e.failure.reason)}
