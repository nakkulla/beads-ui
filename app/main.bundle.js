...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Qn=/'/g,Jn=/"/g,ns=/^(?:script|style|textarea|title)$/i,en=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),p=en(1),Zl=en(2),Xl=en(3),Tt=Symbol.for("lit-noChange"),Se=Symbol.for("lit-nothing"),es=new WeakMap,xt=St.createTreeWalker(St,129);function ss(t,e){if(!Jr(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Kn!==void 0?Kn.createHTML(e):e}var ci=(t,e)=>{let r=t.length-1,n=[],s,o=e===2?"<svg>":e===3?"<math>":"",i=Kt;for(let c=0;c<r;c++){let a=t[c],u,f,g=-1,w=0;for(;w<a.length&&(i.lastIndex=w,f=i.exec(a),f!==null);)w=i.lastIndex,i===Kt?f[1]==="!--"?i=Zn:f[1]!==void 0?i=Xn:f[2]!==void 0?(ns.test(f[2])&&(s=RegExp("</"+f[2],"g")),i=$t):f[3]!==void 0&&(i=$t):i===$t?f[0]===">"?(i=s??Kt,g=-1):f[1]===void 0?g=-2:(g=i.lastIndex-f[2].length,u=f[1],i=f[3]===void 0?$t:f[3]==='"'?Jn:Qn):i===Jn||i===Qn?i=$t:i===Zn||i===Xn?i=Kt:(i=$t,s=void 0);let v=i===$t&&t[c+1].startsWith("/>")?" ":"";o+=i===Kt?a+ai:g>=0?(n.push(u),a.slice(0,g)+ts+a.slice(g)+_t+v):a+_t+(g===-2?c:v)}return[ss(t,o+(t[r]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Jt=class t{constructor({strings:e,_$litType$:r},n){let s;this.parts=[];let o=0,i=0,c=e.length-1,a=this.parts,[u,f]=ci(e,r);if(this.el=t.createElement(u,n),xt.currentNode=this.el.content,r===2||r===3){let g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(s=xt.nextNode())!==null&&a.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(let g of s.getAttributeNames())if(g.endsWith(ts)){let w=f[i++],v=s.getAttribute(g).split(_t),y=/([.?@])?(.*)/.exec(w);a.push({type:1,index:o,name:y[2],strings:v,ctor:y[1]==="."?Kr:y[1]==="?"?Zr:y[1]==="@"?Xr:Nt}),s.removeAttribute(g)}else g.startsWith(_t)&&(a.push({type:6,index:o}),s.removeAttribute(g));if(ns.test(s.tagName)){let g=s.textContent.split(_t),w=g.length-1;if(w>0){s.textContent=br?br.emptyScript:"";for(let v=0;v<w;v++)s.append(g[v],Xt()),xt.nextNode(),a.push({type:2,index:++o});s.append(g[w],Xt())}}}else if(s.nodeType===8)if(s.data===rs)a.push({type:2,index:o});else{let g=-1;for(;(g=s.data.indexOf(_t,g+1))!==-1;)a.push({type:7,index:o}),g+=_t.length-1}o++}}static createElement(e,r){let n=St.createElement("template");return n.innerHTML=e,n}};function Mt(t,e,r=t,n){if(e===Tt)return e;let s=n!==void 0?r._$Co?.[n]:r._$Cl,o=Qt(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(t),s._$AT(t,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(e=Mt(t,s._$AS(t,e.values),s,n)),e}var Vr=class{constructor(e,r){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:r},parts:n}=this._$AD,s=(e?.creationScope??St).importNode(r,!0);xt.currentNode=s;let o=xt.nextNode(),i=0,c=0,a=n[0];for(;a!==void 0;){if(i===a.index){let u;a.type===2?u=new er(o,o.nextSibling,this,e):a.type===1?u=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(u=new Qr(o,this,e)),this._$AV.push(u),a=n[++c]}i!==a?.index&&(o=xt.nextNode(),i++)}return xt.currentNode=St,s}p(e){let r=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,r),r+=n.strings.length-2):n._$AI(e[r])),r++}},er=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,r,n,s){this.type=2,this._$AH=Se,this._$AN=void 0,this._$AA=e,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,r=this._$AM;return r!==void 0&&e?.nodeType===11&&(e=r.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,r=this){e=Mt(this,e,r),Qt(e)?e===Se||e==null||e===""?(this._$AH!==Se&&this._$AR(),this._$AH=Se):e!==this._$AH&&e!==Tt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):li(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==Se&&Qt(this._$AH)?this._$AA.nextSibling.data=e:this.T(St.createTextNode(e)),this._$AH=e}$(e){let{values:r,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Jt.createElement(ss(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(r);else{let o=new Vr(s,this),i=o.u(this.options);o.p(r),this.T(i),this._$AH=o}}_$AC(e){let r=es.get(e.strings);return r===void 0&&es.set(e.strings,r=new Jt(e)),r}k(e){Jr(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,n,s=0;for(let o of e)s===r.length?r.push(n=new t(this.O(Xt()),this.O(Xt()),this,this.options)):n=r[s],n._$AI(o),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(e=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Nt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,r,n,s,o){this.type=1,this._$AH=Se,this._$AN=void 0,this.element=e,this.name=r,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=Se}_$AI(e,r=this,n,s){let o=this.strings,i=!1;if(o===void 0)e=Mt(this,e,r,0),i=!Qt(e)||e!==this._$AH&&e!==Tt,i&&(this._$AH=e);else{let c=e,a,u;for(e=o[0],a=0;a<o.length-1;a++)u=Mt(this,c[n+a],r,a),u===Tt&&(u=this._$AH[a]),i||(i=!Qt(u)||u!==this._$AH[a]),u===Se?e=Se:e!==Se&&(e+=(u??"")+o[a+1]),this._$AH[a]=u}i&&!s&&this.j(e)}j(e){e===Se?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Kr=class extends Nt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Se?void 0:e}},Zr=class extends Nt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==Se)}},Xr=class extends Nt{constructor(e,r,n,s,o){super(e,r,n,s,o),this.type=5}_$AI(e,r=this){if((e=Mt(this,e,r,0)??Se)===Tt)return;let n=this._$AH,s=e===Se&&n!==Se||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,o=e!==Se&&(n===Se||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Qr=class{constructor(e,r,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Mt(this,e)}};var di=Zt.litHtmlPolyfillSupport;di?.(Jt,er),(Zt.litHtmlVersions??(Zt.litHtmlVersions=[])).push("3.3.1");var de=(t,e,r)=>{let n=r?.renderBefore??e,s=n._$litPart$;if(s===void 0){let o=r?.renderBefore??null;n._$litPart$=s=new er(e.insertBefore(Xt(),o),o,void 0,r??{})}return s._$AI(t),s};var wr="today",os=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function tn(t){return t==="today"||t==="7d"||t==="30d"||t==="all"}function is(t,e=Date.now()){switch(t){case"today":{let r=new Date(e);return r.setHours(0,0,0,0),r.getTime()}case"7d":return e-7*864e5;case"30d":return e-30*864e5;case"all":default:return}}function as(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function ls(){let t=new Map,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{set(n,s){t.set(n,{lines:Array.isArray(s)?[...s]:[]}),r()},append(n,s){let o=t.get(n)||{lines:[]};o.lines=[...o.lines,s],t.set(n,o),r()},get(n){return t.get(n)||null},clear(n){typeof n=="string"?t.delete(n):t.clear(),r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}var hs=ii(fs(),1);function ye(t){return(0,hs.default)(`beads-ui:${t}`)}function ct(t){if(typeof t=="number")return Number.isFinite(t)?t:0;if(typeof t=="string"){let e=Date.parse(t);return Number.isFinite(e)?e:0}return 0}function Et(t,e){let r=ct(t.created_at),n=ct(e.created_at);if(r!==n)return r<n?1:-1;let s=t.priority??2,o=e.priority??2;if(s!==o)return s-o;let i=t.id,c=e.id;return i<c?-1:i>c?1:0}function _s(t,e){let r=ct(t.created_at),n=ct(e.created_at);if(r!==n)return r<n?-1:1;let s=t.priority??2,o=e.priority??2;if(s!==o)return s-o;let i=t.id,c=e.id;return i<c?-1:i>c?1:0}function bs(t,e){let r=ct(t.updated_at),n=ct(e.updated_at);if(r!==n)return r<n?1:-1;let s=t.id,o=e.id;return s<o?-1:s>o?1:0}function ws(t,e){let r=t.priority??2,n=e.priority??2;if(r!==n)return r-n;let s=ct(t.created_at),o=ct(e.created_at);if(s!==o)return s<o?1:-1;let i=t.id,c=e.id;return i<c?-1:i>c?1:0}function ks(t,e){let r=t.closed_at??0,n=e.closed_at??0;if(r!==n)return r<n?1:-1;let s=t?.id,o=e?.id;return s<o?-1:s>o?1:0}var $i=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function gs(t){let e=t&&t.metadata,r=e?e.task_order:void 0;if(r==null||r==="")return Number.POSITIVE_INFINITY;let n=Number(r);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ms(t){let e=t&&t.title;if(typeof e!="string")return Number.POSITIVE_INFINITY;let r=$i.exec(e);if(!r)return Number.POSITIVE_INFINITY;let n=Number(r[1]);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ys(t,e){let r=gs(t),n=gs(e);if(r!==n)return r<n?-1:1;let s=ms(t),o=ms(e);if(s!==o)return s<o?-1:1;let i=ct(t&&t.created_at),c=ct(e&&e.created_at);if(i!==c)return i<c?-1:1;let a=t&&t.id,u=e&&e.id;return a===u?0:String(a)<String(u)?-1:1}var rn=2**20;function qt(t,e){let r=t&&t.id;return e&&typeof r=="string"&&Object.prototype.hasOwnProperty.call(e,r)&&typeof e[r]=="number"&&Number.isFinite(e[r])?e[r]:-ct(t&&t.created_at)}function vr(t){return(e,r)=>{let n=qt(e,t),s=qt(r,t);if(n!==s)return n<s?-1:1;let o=e?.id,i=r?.id;return o<i?-1:o>i?1:0}}function nn(t,e,r){let n=Array.isArray(t)?t:[],s=n.length,o=Math.max(0,Math.min(e,s-1)),i=o-1>=0?n[o-1]:null,c=o+1<s?n[o+1]:null;if(!i&&!c)return{rank:0};if(!i)return{rank:qt(c,r)-rn};if(!c)return{rank:qt(i,r)+rn};let a=qt(i,r),u=qt(c,r),f=(a+u)/2;return a<f&&f<u?{rank:f}:{renormalize:n.map((g,w)=>({bead_id:g.id,rank:w*rn}))}}function sn(t,e={}){let r=ye(`issue-store:${t}`),n=new Map,s=[],o=0,i=new Set,c=!1,a=e.sort||Et;function u(){for(let w of Array.from(i))try{w()}catch{}}function f(){s=Array.from(n.values()).sort(a)}function g(w){if(c||!w||w.id!==t)return;let v=Number(w.revision)||0;if(r("apply %s rev=%d",w.type,v),!(v<=o&&w.type!=="snapshot")){if(w.type==="snapshot"){if(v<=o)return;n.clear();let y=Array.isArray(w.issues)?w.issues:[];for(let C of y)C&&typeof C.id=="string"&&C.id.length>0&&n.set(C.id,C);f(),o=v,u();return}if(w.type==="upsert"){let y=w.issue;if(y&&typeof y.id=="string"&&y.id.length>0){let C=n.get(y.id);if(!C)n.set(y.id,y);else{let M=Number.isFinite(C.updated_at)?C.updated_at:0,P=Number.isFinite(y.updated_at)?y.updated_at:0;if(M<=P){for(let B of Object.keys(C))B in y||delete C[B];for(let[B,q]of Object.entries(y))C[B]=q}}f()}o=v,u()}else if(w.type==="delete"){let y=String(w.issue_id||"");y&&(n.delete(y),f()),o=v,u()}}}return{id:t,subscribe(w){return i.add(w),()=>{i.delete(w)}},applyPush:g,snapshot(){return s},size(){return n.size},getById(w){return n.get(w)},dispose(){c=!0,n.clear(),s=[],i.clear(),o=0}}}function $r(t){let e=String(t.type||"").trim(),r={};if(t.params&&typeof t.params=="object"){let s=Object.keys(t.params).sort();for(let o of s){let i=t.params[o];r[o]=String(i)}}let n=new URLSearchParams(r).toString();return n.length>0?`${e}?${n}`:e}function vs(t){let e=ye("subs"),r=new Map,n=new Map;function s(c,a){e("applyDelta %s +%d ~%d -%d",c,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let u=n.get(c);if(!u||u.size===0)return;let f=Array.isArray(a.added)?a.added:[],g=Array.isArray(a.updated)?a.updated:[],w=Array.isArray(a.removed)?a.removed:[];for(let v of Array.from(u)){let y=r.get(v);if(!y)continue;let C=y.itemsById;for(let M of f)typeof M=="string"&&M.length>0&&C.set(M,!0);for(let M of g)typeof M=="string"&&M.length>0&&C.set(M,!0);for(let M of w)typeof M=="string"&&M.length>0&&C.delete(M)}}async function o(c,a){let u=$r(a);if(e("subscribe %s key=%s",c,u),!r.has(c))r.set(c,{key:u,itemsById:new Map});else{let g=r.get(c);if(g&&g.key!==u){let w=n.get(g.key);w&&(w.delete(c),w.size===0&&n.delete(g.key)),r.set(c,{key:u,itemsById:new Map})}}n.has(u)||n.set(u,new Set);let f=n.get(u);f&&f.add(c);try{await t("subscribe-list",{id:c,type:a.type,params:a.params})}catch(g){let w=r.get(c)||null;if(w){let v=n.get(w.key);v&&(v.delete(c),v.size===0&&n.delete(w.key))}throw r.delete(c),g}return async()=>{e("unsubscribe %s key=%s",c,u);try{await t("unsubscribe-list",{id:c})}catch{}let g=r.get(c)||null;if(g){let w=n.get(g.key);w&&(w.delete(c),w.size===0&&n.delete(g.key))}r.delete(c)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:$r,selectors:{getIds(c){let a=r.get(c);return a?Array.from(a.itemsById.keys()):[]},has(c,a){let u=r.get(c);return u?u.itemsById.has(a):!1},count(c){let a=r.get(c);return a?a.itemsById.size:0},getItemsById(c){let a=r.get(c),u={};if(!a)return u;for(let f of a.itemsById.keys())u[f]=!0;return u}}}}function $s(){let t=ye("issue-stores"),e=new Map,r=new Map,n=new Set,s=new Map;function o(){for(let a of Array.from(n))try{a()}catch{}}function i(a,u,f){let g=u?$r(u):"",w=r.get(a)||"",v=e.has(a);if(t("register %s key=%s (prev=%s)",a,g,w),v&&w&&g&&w!==g){let y=e.get(a);if(y)try{y.dispose()}catch{}let C=s.get(a);if(C){try{C()}catch{}s.delete(a)}let M=sn(a,f);e.set(a,M);let P=M.subscribe(()=>o());s.set(a,P)}else if(!v){let y=sn(a,f);e.set(a,y);let C=y.subscribe(()=>o());s.set(a,C)}return r.set(a,g),()=>c(a)}function c(a){t("unregister %s",a),r.delete(a);let u=e.get(a);u&&(u.dispose(),e.delete(a));let f=s.get(a);if(f){try{f()}catch{}s.delete(a)}}return{register:i,unregister:c,getStore(a){return e.get(a)||null},snapshotFor(a){let u=e.get(a);return u?u.snapshot().slice():[]},subscribe(a){return n.add(a),()=>n.delete(a)}}}function xs(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function Ss(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function on(t,e){return`#/${t==="worker"?"worker":"board"}?issue=${encodeURIComponent(e)}`}function xi(t){let e=String(t||""),r=e.startsWith("#")?e.slice(1):e,n=r.indexOf("?"),s=n>=0?r.slice(n+1):"";if(s){let c=new URLSearchParams(s).get("issue");if(c)return decodeURIComponent(c)}let o=/^\/issue\/([^\s?#]+)/.exec(r);return o&&o[1]?decodeURIComponent(o[1]):null}function Si(t){let e=String(t||"");return/^#\/worker(\b|\/|$)/.test(e)?"worker":"board"}function Ts(t){let e=ye("router"),r=()=>{let n=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(n),o=s&&s[1]?decodeURIComponent(s[1]):xi(n),i=Si(n);if(e("hash change \u2192 view=%s id=%s",i,o),t.setState({selected_id:i==="worker"?null:o,view:i,worker:{selected_parent_id:i==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(n)){let a=o?`#/${i}?issue=${encodeURIComponent(o)}`:`#/${i}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",r),r()},stop(){window.removeEventListener("hashchange",r)},gotoIssue(n){let o=(t.getState?t.getState():{view:"board"}).view==="worker"?"worker":"board",i=on(o,n);e("goto issue %s (view=%s)",n,o),window.location.hash!==i?window.location.hash=i:t.setState({selected_id:o==="worker"?null:n,view:o,worker:{selected_parent_id:o==="worker"?n:null}})},gotoView(n){let s=t.getState?t.getState():{selected_id:null,worker:{selected_parent_id:null}},o=n==="worker"?s.worker?.selected_parent_id:s.selected_id,i=o?on(n,o):`#/${n}`;e("goto view %s (id=%s)",n,o||""),window.location.hash!==i?window.location.hash=i:t.setState({view:n,selected_id:n==="worker"?null:s.selected_id})}}}var Ti=Object.freeze({workspace_config:{default_workspace:null}});function As(t){return{workspace_config:{default_workspace:typeof t?.workspace_config?.default_workspace=="string"&&t.workspace_config.default_workspace.length>0?t.workspace_config.default_workspace:Ti.workspace_config.default_workspace}}}function Es(t={}){let e=ye("state"),r={selected_id:t.selected_id??null,view:t.view??"board",filters:{status:t.filters?.status??"all",search:t.filters?.search??"",type:typeof t.filters?.type=="string"?t.filters?.type:""},board:{closed_filter:t.board?.closed_filter==="3"||t.board?.closed_filter==="7"||t.board?.closed_filter==="today"?t.board?.closed_filter:"today",show_deferred_column:t.board?.show_deferred_column===!0},worker:{selected_parent_id:t.worker?.selected_parent_id??null,show_closed_children:Array.isArray(t.worker?.show_closed_children)?t.worker.show_closed_children:[]},workspace:{current:t.workspace?.current??null,available:t.workspace?.available??[],hidden:t.workspace?.hidden??[]},config:As(t.config)},n=new Set;function s(){for(let o of Array.from(n))try{o(r)}catch{}}return{getState(){return r},setState(o){let i={...r,...o,filters:{...r.filters,...o.filters||{}},board:{...r.board,...o.board||{}},worker:{...r.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:r.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:r.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:r.workspace.hidden},config:o.config!==void 0?As(o.config):r.config},c=i.workspace.current?.path!==r.workspace.current?.path||i.workspace.available.length!==r.workspace.available.length||i.workspace.hidden.length!==r.workspace.hidden.length||i.workspace.hidden.some((u,f)=>u!==r.workspace.hidden[f]),a=i.config.workspace_config.default_workspace!==r.config.workspace_config.default_workspace;i.selected_id===r.selected_id&&i.view===r.view&&i.filters.status===r.filters.status&&i.filters.search===r.filters.search&&i.filters.type===r.filters.type&&i.board.closed_filter===r.board.closed_filter&&i.board.show_deferred_column===r.board.show_deferred_column&&i.worker.selected_parent_id===r.worker.selected_parent_id&&i.worker.show_closed_children.length===r.worker.show_closed_children.length&&i.worker.show_closed_children.every((u,f)=>u===r.worker.show_closed_children[f])&&!c&&!a||(r=i,e("state change %o",{selected_id:r.selected_id,view:r.view,filters:r.filters,board:r.board,worker:r.worker,workspace:r.workspace.current?.path,config:{default_workspace:r.config.workspace_config.default_workspace}}),s())},subscribe(o){return n.add(o),()=>n.delete(o)}}}function Cs(t){let e=ye("activity"),r=0,n=new Map,s=1;function o(){if(!t)return;let u=r>0;t.toggleAttribute("hidden",!u),t.setAttribute("aria-busy",u?"true":"false")}function i(){r+=1,e("start count=%d",r),o()}function c(){let u=r;r=Math.max(0,r-1),u<=0?e("done called but count was already %d",u):e("done count=%d\u2192%d",u,r),o()}function a(u){return async(g,w)=>{let v=s++,y=Date.now();n.set(v,{type:g,start_ts:y}),e("request start id=%d type=%s count=%d",v,g,r+1),i();let C=!1,M=()=>{C||(C=!0,n.delete(v),c())},P=setTimeout(()=>{C||(e("request TIMEOUT id=%d type=%s elapsed=%dms",v,g,Date.now()-y),M())},3e4);try{let B=await u(g,w),q=Date.now()-y;return e("request done id=%d type=%s elapsed=%dms",v,g,q),B}catch(B){let q=Date.now()-y;throw e("request error id=%d type=%s elapsed=%dms err=%o",v,g,q,B),B}finally{clearTimeout(P),M()}}}return o(),{wrapSend:a,start:i,done:c,getCount:()=>r,getActiveRequests:()=>{let u=Date.now();return Array.from(n.entries()).map(([f,g])=>({id:f,type:g.type,elapsed_ms:u-g.start_ts}))}}}function Z(t,e="info",r=2800){let n=document.createElement("div");n.className="toast",n.textContent=t,n.style.position="fixed",n.style.right="12px",n.style.bottom="12px",n.style.zIndex="1000",n.style.color="#fff",n.style.padding="8px 10px",n.style.borderRadius="4px",n.style.fontSize="12px",e==="success"?n.style.background="#156d36":e==="warning"?n.style.background="#a36a00":e==="error"?n.style.background="#9f2011":n.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(n),setTimeout(()=>{try{n.remove()}catch{}},r)}function xr(t=void 0,e=void 0){function r(){if(!e||typeof e.get!="function")return null;let o=e.get();return o&&o.order?o.order:{}}function n(o,i,c){let a=t&&t.snapshotFor?t.snapshotFor(o).slice():[];if(i==="closed")return a.sort(ks),a;switch(c){case"created_desc":return a.sort(Et),a;case"created_asc":return a.sort(_s),a;case"updated_desc":return a.sort(bs),a;case"priority":return a.sort(ws),a;case"manual":default:{let u=r();return u?a.sort(vr(u)):a.sort(Et),a}}}function s(o){let i=[];return t&&typeof t.subscribe=="function"&&i.push(t.subscribe(o)),e&&typeof e.subscribe=="function"&&i.push(e.subscribe(o)),()=>{for(let c of i)try{c()}catch{}}}return{selectBoardColumn:n,subscribe:s}}function Sr(t){let e=t.transport,r=t.uiOrderStore;function n(i,c){return"renormalize"in i?i.renormalize:[{bead_id:c,rank:i.rank}]}function s(i,c){let a={...i.order};for(let u of c)a[u.bead_id]=u.rank;r&&r.set({revision:i.revision,order:a})}async function o(i,c,a){if(!e||!r)return;let u=r.get()||{revision:0,order:{}},f=n(nn(c,a,u.order),i);s(u,f);let g=await e("ui-order-set",{expected_revision:u.revision,entries:f});if(g&&g.conflict){let w={revision:typeof g.revision=="number"?g.revision:0,order:g.order||{}};r.set(w);let v=n(nn(c,a,w.order),i);s(w,v);let y=await e("ui-order-set",{expected_revision:w.revision,entries:v});y&&y.applied&&r.set({revision:typeof y.revision=="number"?y.revision:0,order:y.order||{}})}else g&&g.applied&&r.set({revision:typeof g.revision=="number"?g.revision:0,order:g.order||{}})}return{applyReorder:o}}function Tr(t){return Array.isArray(t)?t.filter(e=>typeof e=="string"):[]}function an(t,e){return!e||typeof t!="string"||t.length===0||Tr(e.visible_labels).includes(t)?!0:Tr(e.hidden_labels).includes(t)?!1:!Tr(e.hidden_prefixes).some(r=>r.length>0&&t.startsWith(r))}function Rs(t,e){return Tr(t).filter(r=>an(r,e))}function Ct(t,e){let r=t&&t.chips?t.chips[e]:void 0;return typeof r=="boolean"?r:!0}function ln(t){if(!t)return null;if(typeof t=="number")return Number.isFinite(t)?t:null;let e=Date.parse(t);return Number.isFinite(e)?e:null}function bt(t){let e=ln(t);if(e===null)return"";let r=new Date(e),n=s=>String(s).padStart(2,"0");return`${r.getFullYear()}-${n(r.getMonth()+1)}-${n(r.getDate())} ${n(r.getHours())}:${n(r.getMinutes())}`}function cn(t,e){let r=ln(t);if(r===null)return"";let s=(typeof e=="number"?e:Date.now())-r;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let i=Math.floor(s/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let c=Math.floor(s/864e5);if(c<7)return`${c}\uC77C \uC804`;let a=Math.floor(c/7);if(c<30)return`${a}\uC8FC \uC804`;let u=Math.floor(c/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(c/365)}\uB144 \uC804`}var Ai={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg"},Ei={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge"},Ci={spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},Ri={reviewed:"\u2713",skip:"\u2298",stale:"\u2713"};function Li(t,e,r){if(!(r==="in_progress"||r==="resolved"))return null;for(let s of t)if(e[s]&&e[s].state==="dim")return s;return null}function Ii(t,e,r){let n=Ai[t]||t,s=e&&e.state||"empty",o=Ri[s]||"",i="bar";s==="dim"?i+=` b-${n} dim`:s==="on"||s==="reviewed"||s==="skip"?i+=` b-${n} on`:s==="stale"&&(i+=` b-${n} stale`),r&&(i+=" glow");let c=s==="empty"?"lbl":`lbl l-${n} on`,a=r?`color: var(--stage-${n}-on)`:"";return p`
  ...
  `}var Hi=200,Wi={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","deferred-col":"deferred","closed-col":"closed"},Gi=new Set(["blocked-col","ready-col","in-progress-col","resolved-col","deferred-col"]),Os="beads-ui.board.sort",Ms=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function ji(){try{let t=window.localStorage.getItem(Os);if(t&&Ms.has(t))return t}catch{}return"created_desc"}function Ns(t,e){let r=ye("views:board"),n=e.gotoIssue,s=e.issueStores,o=e.transport,i=e.uiOrderStore,c=e.displayPolicyStore,a=e.onClosedRangeChange,u=e.onNewIssue,f=e.closedRange||wr,g=s?xr(s,i):null,w=Sr({transport:o,uiOrderStore:i}),v=[],y=[],C=[],M=[],P=[],B=[],q=!1,I=0,A=ji(),S=new Map,x=new Map,b=new Map,O=new Set,N={search:"",priority:"",type:"",labels:[]},z=!1,K=null;function ke(R){return String(R.status||"open")==="open"}function oe(R){let D=String(R.status||"open");return D==="open"||D==="blocked"}function ee(R){let D=N.search.trim().toLowerCase(),X=N.priority,V=N.type,d=N.labels;return R.filter(l=>{if(D){let _=String(l.id||"").toLowerCase(),$=String(l.title||"").toLowerCase();if(!_.includes(D)&&!$.includes(D))return!1}if(X!==""&&String(l.priority)!==X||V!==""&&String(l.issue_type||"")!==V)return!1;if(d.length>0){let _=Array.isArray(l.labels)?l.labels:[];if(!d.some($=>_.includes($)))return!1}return!0})}function Xe(){let R=new Set;for(let D of[v,y,C,M,P,B])for(let X of D){let V=Array.isArray(X.labels)?X.labels:[];for(let d of V)typeof d=="string"&&d.length>0&&R.add(d)}return Array.from(R).sort()}function qe(){return N.search.trim()!==""||N.priority!==""||N.type!==""||N.labels.length>0}function ve(){try{if(g){let R=g.selectBoardColumn("tab:board:in-progress","in_progress",A),D=g.selectBoardColumn("tab:board:blocked","blocked",A).filter(oe),X=new Set(R.map(F=>F.id)),V=g.selectBoardColumn("tab:board:ready","ready",A).filter(F=>ke(F)&&!X.has(F.id)),d=g.selectBoardColumn("tab:board:resolved","resolved",A),l=g.selectBoardColumn("tab:board:deferred","deferred",A),_=q?l:[],$=g.selectBoardColumn("tab:board:closed","closed").slice(0,Hi),T=[...D,...V,...R,...d,..._,...$];Ae(T);let G=new Set;for(let F of T)F&&F.id&&!dn(F)&&G.add(F.id);let Q=!qe();v=Q?Ut(D,G):D,y=Q?Ut(V,G):V,C=Q?Ut(R,G):R,M=Q?Ut(d,G):d,P=Q?Ut(_,G):_,I=l.length,B=Q?Ut($,G):$,S=new Map;for(let F of v)S.set(F.id,"open");for(let F of y)S.set(F.id,"open");for(let F of C)S.set(F.id,"in_progress");for(let F of M)S.set(F.id,"resolved");for(let F of P)S.set(F.id,"deferred");for(let F of B)S.set(F.id,"closed");x=new Map;for(let F of v)x.set(F.id,"blocked-col");for(let F of y)x.set(F.id,"ready-col");for(let F of C)x.set(F.id,"in-progress-col");for(let F of M)x.set(F.id,"resolved-col");for(let F of P)x.set(F.id,"deferred-col");for(let F of B)x.set(F.id,"closed-col")}xe()}catch{v=[],y=[],C=[],M=[],P=[],B=[],b=new Map,xe()}}function Ae(R){let D=new Map;for(let V of R)V&&V.id&&!D.has(V.id)&&D.set(V.id,V);let X=new Map;for(let V of D.values()){let d=dn(V);if(!d)continue;let l=X.get(d);l||(l=[],X.set(d,l)),l.push({id:V.id,title:V.title,status:V.status,metadata:V.metadata,created_at:V.created_at})}b=X}function Qe(R){let D=b.get(R)||[],X=0,V=null;for(let d of D)(d.status==="resolved"||d.status==="closed")&&(X+=1),!V&&d.status==="in_progress"&&(V=d);return{total:D.length,count:X,current:V,children:D}}function fe(R){return!O.has(R)}function ot(R,D){R.preventDefault(),R.stopPropagation(),O.has(D)?O.delete(D):O.add(D),xe()}function he(R,D){R.preventDefault(),R.stopPropagation(),n(D)}function Je(R,D){R.preventDefault(),R.stopPropagation(),n(D)}function ae(R,D){K||n(D)}function Fe(R,D){R.preventDefault(),R.stopPropagation(),Yi(D).then(X=>{X&&Z("\uBCF5\uC0AC\uB428","success",1200)})}function rt(R,D){K=D,R.dataTransfer&&(R.dataTransfer.setData("text/plain",D),R.dataTransfer.effectAllowed="move"),R.target.classList.add("board-card--dragging")}function Ce(R){R.target.classList.remove("board-card--dragging"),it(),setTimeout(()=>{K=null},0)}function Le(R){let D=String(R.target.value||"");!D||D===f||(f=D,a&&a(D),xe())}let $e={onCardClick:ae,onCopyId:Fe,onDragStart:rt,onDragEnd:Ce,onClosedRangeChange:Le,rollupFor:Qe,isExpanded:fe,onRollupToggle:ot,onChildClick:he,onFromChipClick:Je,get policy(){return c?c.get():null}};function Ue(R){let D=R.target,X=t.querySelector(".board-filter__labels");D&&X&&X.contains(D)||ze()}function et(R){R.key==="Escape"&&ze()}function Ie(){z||(z=!0,document.addEventListener("mousedown",Ue),document.addEventListener("keydown",et),xe())}function ze(){z&&(z=!1,document.removeEventListener("mousedown",Ue),document.removeEventListener("keydown",et),xe())}let De={onSearchInput(R){N.search=String(R.target.value||""),ve()},onPriorityChange(R){N.priority=String(R.target.value||""),ve()},onTypeChange(R){N.type=String(R.target.value||""),ve()},onSortChange(R){let D=String(R.target.value||"");if(!(!Ms.has(D)||D===A)){A=D;try{window.localStorage.setItem(Os,D)}catch{}ve()}},onDeferredToggle(){q=!q,ve()},onLabelMenuToggle(){z?ze():Ie()},onLabelToggle(R){let D=N.labels.indexOf(R);D===-1?N.labels.push(R):N.labels.splice(D,1),ve()},onLabelClear(){N.labels.length!==0&&(N.labels=[],ve())},onNewIssue(){u&&u()}};function ce(){let R=q?"board-root board-root--deferred":"board-root";return p`
      <div class="board-view">
        ${Ds(N,De,{sort_mode:A,show_deferred:q,deferred_count:I,label_options:Xe(),label_menu_open:z})}
        <div class=${R}>
...
`)}function v(){if(!o)return p``;let x=f(),b=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),O=i.session_id||"",N=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`;return p`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
    ...
    </div>`}function y(){de(v(),t),c&&C()}function C(){let x=t.querySelector(".sv__body");x&&(x.scrollTop=x.scrollHeight)}function M(x){a.has(x)?a.delete(x):a.add(x),y()}function P(){c=!c,y()}function B(x){Lt(x).then(b=>{b?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function q(x){!o||!x||(i={...i,...x},y())}function I(x){let b=x.target;if(!b||!b.classList||!b.classList.contains("sv__body"))return;!(b.scrollHeight-b.scrollTop-b.clientHeight<=4)&&c&&(c=!1,y())}t.addEventListener("scroll",I,!0);function A(x){let b=x&&x.attempt_id;b&&(o=b,i=x.meta||{},c=!0,a.clear(),!u&&n&&(u=n.subscribe(y)),r&&Promise.resolve(r("subscribe-session-log",{id:`session-log:${o}`,attempt_id:o})).catch(()=>{}),y())}function S(){let x=o;o=null,a.clear(),r&&x&&Promise.resolve(r("unsubscribe-session-log",{id:`session-log:${x}`})).catch(()=>{}),de(p``,t),s&&s()}return{open:A,updateMeta:q,close:S,isOpen(){return o!==null},destroy(){u&&(u(),u=null),t.removeEventListener("scroll",I,!0),o=null,de(p``,t)}}}function ra(t){let e=t&&t.metadata||{},r=[];return typeof e.spec_id=="string"&&e.spec_id.trim().length>0&&r.push({kind:"spec",path:e.spec_id.trim()}),typeof e.plan_path=="string"&&e.plan_path.trim().length>0&&r.push({kind:"plan",path:e.plan_path.trim()}),r}function qs(t,e){let r=ra(t);return p`
...
${u}`:u,s=s?`${s}
${f}`:f;let g=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(f,o,!0),this.lexer.state.top=g,r.length===0)break;let w=o.at(-1);if(w?.type==="code")break;if(w?.type==="blockquote"){let v=w,y=v.raw+`
`+r.join(`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+gt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},It=new al;function le(t,e){return It.parse(t,e)}le.options=le.setOptions=function(t){return It.setOptions(t),le.defaults=It.defaults,uo(le.defaults),le};le.getDefaults=Cn;le.defaults=Dt;le.use=function(...t){return It.use(...t),le.defaults=It.defaults,uo(le.defaults),le};le.walkTokens=function(t,e){return It.walkTokens(t,e)};le.parseInline=It.parseInline;le.Parser=pt;le.parser=pt.parse;le.Renderer=Fr;le.TextRenderer=Pn;le.Lexer=ut;le.lexer=ut.lex;le.Tokenizer=Pr;le.Hooks=ur;le.parse=le;var _d=le.options,bd=le.setOptions,wd=le.use,kd=le.walkTokens,yd=le.parseInline;var vd=pt.parse,$d=ut.lex;function vo(t){let e=le.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",c="";function a(y){y.key==="Escape"&&s&&(y.preventDefault(),w())}document.addEventListener("keydown",a);function u(){return s?p`
    ...
    `:p``}function f(){de(u(),t)}async function g(y){s=y,o="loading",i="",c="",f();let C=r?r():"";if(!C){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",f();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",f();return}let M="/api/doc?workspace="+encodeURIComponent(C)+"&path="+encodeURIComponent(y);try{let P=await n(M),B=await P.json().catch(()=>({}));if(!P.ok||!B||B.ok!==!0){o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(B&&B.error||P.status)+")",f();return}i=String(B.content||""),o="ready",f()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",f()}}function w(){s=null,de(p``,t)}function v(){document.removeEventListener("keydown",a),w()}return{open:g,close:w,destroy:v}}var cl={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function dl(t){if(typeof t!="number"||!Number.isFinite(t))return"";let e=new Date(t),r=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${r}:${n}`}function xo(t,e={}){let r=Array.isArray(t)?t:[];if(r.length===0)return p`
  ...
  `}var ul=["open","in_progress","deferred","resolved","closed"],pl=[0,1,2,3,4];function So(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,c=e.sessionLogStore,a=null,u=null,f={},g=!1,w=!1,v="",y="",C="";function M(){g=!1,w=!1,v="",y="",C=""}let P=document.createElement("div");P.className="md-viewer-root",document.body.appendChild(P);let B=$o(P,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),q=document.createElement("div");q.className="session-log-root",document.body.appendChild(q);let I=Er(q,{transport:s?(l,_)=>Promise.resolve(s(l,_)):void 0,sessionLogStore:c});function A(){if(!i||!a)return[];let l=i.get();return(l&&l.attempts?Object.values(l.attempts):[]).filter($=>$&&$.bead_id===a).sort(($,T)=>(T.started_at||0)-($.started_at||0)).map($=>({attempt_id:$.attempt_id,bead_id:$.bead_id,status:$.status,started_at:typeof $.started_at=="number"?$.started_at:null,runner:$.runner||null,model:$.model||null,session_id:$.session_id||null,resumed_from:$.resumed_from||null,dismissed_at:typeof $.dismissed_at=="number"?$.dismissed_at:null,cause:typeof $.cause=="string"?$.cause:null,cause_detail:$.cause_detail||null}))}function S(l){let _=i?i.get():null,$=_&&_.attempts?_.attempts[l]:null;I.open({attempt_id:l,meta:$?{runner:$.runner||void 0,model:$.model||void 0,effort:$.effort||void 0,status:$.status||void 0,session_id:$.session_id||void 0}:{}})}async function x(l){if(!s||!l)return;let _=()=>{let T=i?i.get():null;return T&&typeof T.revision=="number"?T.revision:0},$=await s("worker-attempt-resume",{attempt_id:l,expected_revision:_()});if($&&$.conflict){let T=$.queue&&typeof $.queue.revision=="number"?$.queue.revision:_();$=await s("worker-attempt-resume",{attempt_id:l,expected_revision:T})}$&&$.resumed===!1&&!$.conflict&&$.reason&&Z(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${$.reason}`,"error",2400)}let b={onOpen:S,onResume:x};function O(){let l=i?i.get():null,_=l&&l.exec_defaults;return _&&typeof _=="object"?_:{}}let N=null;r&&r.subscribe&&(N=r.subscribe(()=>ke()));let z=null;i&&typeof i.subscribe=="function"&&(z=i.subscribe(()=>{a&&d()}));function K(l){l.key==="Escape"&&a&&(l.preventDefault(),n())}document.addEventListener("keydown",K);function ke(){if(a){if(r&&typeof r.snapshotFor=="function"){let l=r.snapshotFor("detail:"+a)||[];u=l.find($=>$&&$.id===a)||l[0]||u}d()}}function oe(l){Lt(l).then(_=>{_?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ee(l){l.preventDefault(),l.stopPropagation(),a&&oe(a)}function Xe(l,_){l.preventDefault(),l.stopPropagation(),oe(_)}function qe(l,_){l.preventDefault(),l.stopPropagation(),B.open(_)}function ve(l,_){f[l]=_,d(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:l,value:_})).catch(()=>{Z("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function Ae(l,_,$){if(!s||!a)return!1;try{let T=await Promise.resolve(s(l,_)),G=Array.isArray(T)?T[0]:T;return G&&typeof G=="object"&&G.id?(u=G,!0):(Z($,"error"),!1)}catch{return Z($,"error"),!1}}function Qe(l){setTimeout(()=>{try{let _=t.querySelector(l);_&&typeof _.focus=="function"&&_.focus()}catch{}},0)}function fe(){g=!0,v=u&&u.title||"",d(),Qe('.detail-edit__input[data-edit="title"]')}function ot(l){v=l.target.value}function he(){g=!1,v="",d()}function Je(){Ae("edit-text",{id:a,field:"title",value:v},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(_=>{_&&(g=!1,v=""),d()})}function ae(){w=!0,y=u&&u.description||"",d(),Qe('.detail-edit__textarea[data-edit="description"]')}function Fe(l){y=l.target.value}function rt(){w=!1,y="",d()}function Ce(){Ae("edit-text",{id:a,field:"description",value:y},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(_=>{_&&(w=!1,y=""),d()})}function Le(l,_,$,T){if(l.key==="Escape"){l.stopPropagation(),$();return}l.key==="Enter"&&(!T||l.ctrlKey||l.metaKey)&&(l.preventDefault(),_())}function $e(l){let _=l.target.value;Ae("update-status",{id:a,status:_},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function Ue(l){let _=Number(l.target.value);Ae("update-priority",{id:a,priority:_},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>d())}function et(l){C=l.target.value}function Ie(){let l=C.trim();l.length!==0&&Ae("label-add",{id:a,label:l},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(_=>{_&&(C=""),d()})}function ze(l){if(l.key==="Escape"){l.stopPropagation(),C="",d();return}l.key==="Enter"&&(l.preventDefault(),Ie())}function De(l){Ae("label-remove",{id:a,label:l},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>d())}let ce={onCopyPath:Xe,onOpenDoc:qe},xe={onChange:ve};function Oe(l){return typeof l=="string"?l:l&&typeof l=="object"?String(l.id||l.to||l.issue_id||l.depends_on||""):""}function He(l){switch(l&&typeof l=="object"?String(l.dependency_type||l.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Me(l){let $=(Array.isArray(l.dependencies)?l.dependencies:[]).map(T=>({id:Oe(T),icon:He(T)})).filter(T=>T.id.length>0);return p`
    ...
    `}function tt(l){let _=l.metadata||{},$=l.workflow||{},T=$.stages||{},G=T.spec&&T.spec.stale,Q=T.impl&&T.impl.stale,F=$.route_source==="derived",ue=$.route||_.route||"\u2014";return p`
    ...
    `}let it={route:["spec_backed","full_plan"]};async function me(l,_){let $=_.target.value;if(l==="route"&&u&&u.metadata&&u.metadata.route==="full_plan"&&$!=="full_plan"&&!window.confirm(`full_plan \u2192 ${$||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){d();return}await Ae("update-workflow-meta",{id:a,key:l,value:$},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),d()}function Ne(l){let _=l.metadata||{};return p` ${((T,G)=>{let Q=it[T],F=typeof _[T]=="string"?_[T]:"";return p`<div class="detail-kv">
    ...
    `}function Re(l){let _=bt(l.created_at),$=bt(l.updated_at);return!_&&!$?p``:p`
    ...
    `}function R(l,_){return p`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Ue}
        >
          ${pl.map($=>p`<option value=${String($)} ?selected=${$===_}>
                P${$}
              </option>`)}
        </select>
      </div>
    `}function D(l){return p`
      <div class="detail-title-row">
    ...
    `}function X(l){let _=Array.isArray(l.labels)?l.labels:[];return p`
      ...
      <div class="detail-labels">
        ${_.map($=>p`<span class="detail-label-chip"
              >${$}<button
                type="button"
    ...
    `}function V(){if(!a)return p``;let l=u||{},_=String(l.id||a),$=l.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",T=l.status||"open",G=typeof l.priority=="number"?Math.max(0,Math.min(4,l.priority)):"",Q=l.description||"",F={...l,metadata:{...l.metadata||{},...f}};return p`
    ...
    `}function d(){de(V(),t)}return{load(l){l!==a&&(f={},M()),a=l,u=null,ke()},clear(){a=null,u=null,f={},M(),B.close(),I.close(),de(p``,t)},destroy(){N&&(N(),N=null),z&&(z(),z=null),document.removeEventListener("keydown",K),B.destroy(),P.parentNode&&P.parentNode.removeChild(P),I.destroy(),q.parentNode&&q.parentNode.removeChild(q),a=null,u=null,de(p``,t)}}}var fl=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function To(t,e){return an(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function hl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function Ao(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function c(S){let x=r.get();if(x)try{let b=await n("display-policy-set",{expected_revision:x.revision,policy:S(x)});a(b),b&&b.conflict&&b.policy&&(b=await n("display-policy-set",{expected_revision:b.policy.revision,policy:S(b.policy)}),a(b)),b&&b.conflict&&Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(S){S&&S.policy&&typeof S.policy=="object"&&r.set(S.policy)}function u(S){let x=r.get();if(!x)return;let b=To(S,x)!=="shown";c(O=>hl(S,O,b))}function f(){let S=i.trim();S.length!==0&&(i="",c(x=>x.hidden_prefixes.includes(S)?{hidden_prefixes:x.hidden_prefixes}:{hidden_prefixes:[...x.hidden_prefixes,S]}),M())}function g(S){c(x=>({hidden_prefixes:x.hidden_prefixes.filter(b=>b!==S)}))}function w(S){let x=r.get();if(!x)return;let b=x.chips[S]===!1;c(()=>({chips:{[S]:b}}))}function v(S){let x=s();return p`
    ...
    `}function M(){let S=r.get();de(p`
      ...
      `,o)}let P=!1,B=()=>{P=!1};o.addEventListener("close",B),o.addEventListener("cancel",B);let q=null;r.subscribe&&(q=r.subscribe(()=>{P&&M()}));function I(){P||(i="",P=!0,M(),typeof o.showModal=="function"?o.showModal():o.setAttribute("open",""))}function A(){P&&(P=!1,typeof o.close=="function"?o.close():o.removeAttribute("open"))}return{open:I,close:A,destroy(){P=!1,o.removeEventListener("close",B),o.removeEventListener("cancel",B),q&&(q(),q=null),o.remove()}}}function Eo(t){let e=document.createElement("dialog");e.id="fatal-error-dialog",e.setAttribute("role","alertdialog"),e.setAttribute("aria-modal","true"),e.innerHTML=`
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),c=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),f=r.querySelector("#btn-cancel"),g=r.querySelector("#btn-create"),w=r.querySelector(".new-issue__close");function v(){o.replaceChildren();let A=document.createElement("option");A.value="",A.textContent="\u2014 Select \u2014",o.appendChild(A);for(let S of Ro){let x=document.createElement("option");x.value=S,x.textContent=Lo(S),o.appendChild(x)}i.replaceChildren();for(let S=0;S<=4;S+=1){let x=document.createElement("option");x.value=String(S);let b=Io[S]||"Medium";x.textContent=`${S} \u2013 ${b}`,i.appendChild(x)}}v();function y(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function C(A){s.disabled=A,o.disabled=A,i.disabled=A,c.disabled=A,a.disabled=A,f.disabled=A,g.disabled=A,g.textContent=A?"Creating\u2026":"Create"}function M(){u.textContent=""}function P(A){u.textContent=A}function B(){try{let A=window.localStorage.getItem("beads-ui.new.type");A?o.value=A:o.value="";let S=window.localStorage.getItem("beads-ui.new.priority");S&&/^\d$/.test(S)?i.value=S:i.value="2"}catch{o.value="",i.value="2"}}function q(){let A=o.value||"",S=i.value||"";A.length>0&&window.localStorage.setItem("beads-ui.new.type",A),S.length>0&&window.localStorage.setItem("beads-ui.new.priority",S)}async function I(){M();let A=String(s.value||"").trim();if(A.length===0){P("Title is required"),s.focus();return}let S=Number(i.value||"2");if(!(S>=0&&S<=4)){P("Priority must be 0..4"),i.focus();return}let x=String(o.value||""),b=String(a.value||""),O={title:A};x.length>0&&(O.type=x),String(S).length>0&&(O.priority=S),b.length>0&&(O.description=b),C(!0);try{await e("create-issue",O)}catch{C(!1),P("Failed to create issue");return}q(),C(!1),y()}return r.addEventListener("cancel",A=>{A.preventDefault(),y()}),w.addEventListener("click",()=>y()),f.addEventListener("click",()=>y()),r.addEventListener("keydown",A=>{A.key==="Enter"&&(A.ctrlKey||A.metaKey)&&(A.preventDefault(),I())}),n.addEventListener("submit",A=>{A.preventDefault(),I()}),{open(){n.reset(),M(),B();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){y()}}}function Oo(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function Mo(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var gl={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},ml=[{key:"orchestration_model",values:()=>pn},{key:"orchestration_effort",values:()=>fn},{key:"review_model",values:()=>hn},{key:"impl_model",values:()=>gn}];function No(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function c(){let b=i();return typeof b.revision=="number"?b.revision:0}function a(){let b=i().exec_defaults;return b&&typeof b=="object"?b:{}}function u(b){b&&b.queue&&r&&r.set(b.queue)}async function f(b,O){if(!n)return;let N={key:b,value:O||null};try{let z=await n("worker-queue-set-exec-default",{...N,expected_revision:c()});u(z),z&&z.conflict&&(z=await n("worker-queue-set-exec-default",{...N,expected_revision:c()}),u(z)),z&&z.conflict&&Z("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function g(b,O,N){let z=!!N&&!O.includes(N);return p`<div class="exec-defaults__row">
    ...
    </div>`}function w(){let b=i().workspace_info;return b&&typeof b=="object"?b:{}}function v(b,O){return p`<span
    ...
    >`}function y(b){let O=b?Mo(b.cmd):"",N=b?Oo(b.timeout_ms):"",z=s&&s()||"<workspace \uACBD\uB85C>";return p`<div class="exec-defaults__vd-group" data-vd="verify">
      ...
      ${O?p`<div class="exec-defaults__vd-line">
            <span class="exec-defaults__vd-cmd">${O}</span>
            ${v("config","config")}
            ${b.detached===!0?v("detached","detached"):""}
      ...
      `,o)}let q=!1,I=()=>{q=!1};o.addEventListener("close",I),o.addEventListener("cancel",I);let A=null;r&&r.subscribe&&(A=r.subscribe(()=>{q&&B()}));function S(){q||(q=!0,B(),typeof o.showModal=="function"?o.showModal():o.setAttribute("open",""))}function x(){q&&(q=!1,typeof o.close=="function"?o.close():o.removeAttribute("open"))}return{open:S,close:x,destroy(){q=!1,o.removeEventListener("close",I),o.removeEventListener("cancel",I),A&&(A(),A=null),o.remove()}}}var _l="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function zt(t){return typeof t=="number"&&Number.isFinite(t)?t:0}function bl(t){return!t||typeof t!="object"?!1:typeof t.input_tokens=="number"||typeof t.output_tokens=="number"}function wl(t){return t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}k`:String(t)}function Ht(t){if(!bl(t))return null;let e=zt(t?.input_tokens)+zt(t?.output_tokens);return`\u03C4 ${wl(e)}`}function Ur(t){if(!t||typeof t!="object")return"";let e=[`\uC785\uB825 ${zt(t.input_tokens).toLocaleString("en-US")}`,`\uCD9C\uB825 ${zt(t.output_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC77D\uAE30 ${zt(t.cache_read_input_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC0DD\uC131 ${zt(t.cache_creation_input_tokens).toLocaleString("en-US")}`];typeof t.total_cost_usd=="number"&&Number.isFinite(t.total_cost_usd)&&e.push(`$${t.total_cost_usd.toFixed(2)}`);let r=e.join(" \xB7 ");return t.replayed?`${r}
${_l}`:r}function Fn(t,e){let r=null;for(let n of Object.values(t||{}))n&&n.bead_id===e&&(r=n.usage||null);return r}function Bn(t){let e=t.draggable&&!t.done,r=Array.isArray(t.badges)?t.badges:[],n=Ht(t.usage),s=t.merge_step||null,o=t.lane==="pr_wait",i=e?p`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",c=p`<span class="worker-mini__id" title="클릭하면 ID 복사"
  ...
  >`,a=p`<span class="worker-mini__title">${t.title}</span>`,u=t.pr_url&&t.pr_number?p`<a
          ...
          title="PR 열기"
          >#${t.pr_number} ↗</a
        >`:"",f=r.map(B=>B===t.live_badge?p`<span
...
${se.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:H==="done"?Fn(d.attempts||{},ne.bead_id):null}}),We=d.attempts?Object.values(d.attempts):[],lt=new Set;for(let E of We)E&&typeof E.resumed_from=="string"&&E.resumed_from.length>0&&lt.add(E.resumed_from);let Wt=new Map;for(let E of We)Wt.set(E.bead_id,E.attempt_id);let Gt=new Map;for(let E of We)Gt.set(E.attempt_id,E);function jt(E){let H=new Set,ne=E;for(;ne&&!H.has(ne.attempt_id);){if(ne.conflict_resolution===!0)return!0;H.add(ne.attempt_id),ne=typeof ne.resumed_from=="string"&&ne.resumed_from.length>0&&Gt.get(ne.resumed_from)||null}return!1}let mt=[],Te=null;for(let E of We){let H=E.status==="paused"&&!lt.has(E.attempt_id);E.status==="running"||H?mt.push({bead_id:E.bead_id,attempt_id:E.attempt_id,title:T.get(E.bead_id)||E.bead_id,runner:E.runner||null,model:E.model||null,effort:E.effort||null,started_at:typeof E.started_at=="number"?E.started_at:null,resumed_from:E.resumed_from||null,paused:H,conflict_resolution:jt(E),can_pause:typeof E.session_id=="string"&&E.session_id.length>0,usage:E.usage||null}):(E.status==="failed"||E.status==="orphaned")&&!(Wt.get(E.bead_id)!==E.attempt_id)&&typeof E.dismissed_at!="number"&&(Te=E)}let Yt=null;if(Te){let E=typeof Te.session_id=="string"&&Te.session_id.length>0,H=lt.has(Te.attempt_id),ne=Te.cause_detail;Yt={repo:Te.repo||"",reason:Te.cause||Te.status,cause_detail:ne&&typeof ne.reason=="string"?{reason:ne.reason,command:typeof ne.command=="string"?ne.command:null}:null,resume_attempt_id:Te.attempt_id,resume_eligible:E&&!H,resume_reason:E?H?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let mr=new Set(mt.map(E=>E.bead_id)),vt=new Map;for(let E of mt)E.conflict_resolution&&(E.paused?vt.has(E.bead_id)||vt.set(E.bead_id,"paused"):vt.set(E.bead_id,"running"));let _r=mt.filter(E=>!E.paused).length,W=(d.workspace_info||{}).slots,h=typeof W=="number"?W:typeof d.slots=="number"?d.slots:zr,L=_r>h,U=gr(d.done,"done"),ge=0,Ee=0,we=!1;for(let E of U){let H=E.usage;H&&typeof H=="object"&&(Number.isFinite(H.input_tokens)&&(ge+=H.input_tokens,we=!0),Number.isFinite(H.output_tokens)&&(Ee+=H.output_tokens,we=!0))}let Be=we?Ht({input_tokens:ge,output_tokens:Ee}):null;return{queue:d,idToTitle:T,candidates:be,candidate_hidden:{blocked:J.hidden_blocked,spec:J.hidden_spec},running:mt,live_count:_r,slots:h,over_cap:L,failure:Yt,waiting:gr(nt.filter(E=>!mr.has(E.bead_id)),"queue"),pr_wait:G.map(E=>Gl(E.bead_id,T.get(E.bead_id)||E.bead_id,Q,ue[E.bead_id]||null,Fn(d.attempts||{},E.bead_id),F[E.bead_id]||(P.has(E.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),vt.get(E.bead_id)||null,E.external===!0,E.wt_present!==!1)),done:U,token_total:Be,cleanup_failures:at}}function $e(d){let l=d.waiting.length>0?d.waiting[0].id:"\u2014",_=p`<button
    ...
    >
      ...
      <div class="worker-filter__spec" role="group" aria-label="spec 필터">
        ${Ll.map(_=>p`<button
              type="button"
              class="worker-filter__chip${v.spec===_.value?" is-active":""}"
              data-spec=${_.value}
              aria-pressed=${v.spec===_.value?"true":"false"}
            >
              ${_.label}
            </button>`)}
    ...
    </div>`}function De(d){C={...C,[d]:!C[d]},Pl(C),ce()}function ce(){let d=Le();de($e(d),A),de(ze(d),O)}function xe(){let d=document.querySelector(".app-header");if(!d)return;let l=()=>{let _=Math.round(d.getBoundingClientRect().height);I.style.setProperty("--worker-ribbon-top",`${_}px`)};if(l(),typeof ResizeObserver=="function"){let _=new ResizeObserver(l);_.observe(d),q.push(()=>_.disconnect())}else window.addEventListener("resize",l),q.push(()=>window.removeEventListener("resize",l))}function Oe(){if(typeof window.matchMedia!="function")return;let d=window.matchMedia(Ml);M=!!d.matches;let l=_=>{let $=!!(_&&typeof _.matches=="boolean"?_.matches:d.matches);$!==M&&(M=$,ce())};typeof d.addEventListener=="function"?(d.addEventListener("change",l),q.push(()=>d.removeEventListener("change",l))):typeof d.addListener=="function"&&(d.addListener(l),q.push(()=>d.removeListener(l)))}function He(d){let l=d.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!l)return;let _=l.dataset.beadId||"",$=l.dataset.lane||"";g={bead_id:_,from_lane:$};try{d.dataTransfer?.setData("text/plain",_),d.dataTransfer&&(d.dataTransfer.effectAllowed="move")}catch{}}function Me(d){let l=d.target?.closest?.(".worker-pane");if(!l)return;let _=l.dataset.lane||"";_!=="candidate"&&_!=="queue"||(d.preventDefault(),d.dataTransfer&&(d.dataTransfer.dropEffect="move"),l.classList.add("worker-pane--drag-over"))}function tt(d){d.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function it(d,l){let _=w.find(Q=>Q.id===d);if(!_)return;let $=w.filter(Q=>Q.id!==d),T=$.length;if(l){let Q=l.dataset.beadId;if(Q===d)return;let F=$.findIndex(ue=>ue.id===Q);F>=0&&(T=F)}let G=$.slice();G.splice(T,0,_),f.applyReorder(d,G,T)}function me(d){let l=d.target?.closest?.(".worker-pane");if(!l)return;d.preventDefault(),l.classList.remove("worker-pane--drag-over");let _=l.dataset.lane||"",$=g?.bead_id||d.dataTransfer?.getData("text/plain")||"",T=g?.from_lane||"";if(g=null,!$)return;let G=d.target?.closest?.(".worker-mini, .worker-card"),Q=Array.from(l.querySelectorAll(".worker-mini, .worker-card")),F=Q.length;if(G){let ue=Q.indexOf(G);ue>=0&&(F=ue)}if(l.classList.contains("worker-pane--collapsed")&&(F=Xe()),_==="candidate"){if(T==="candidate"){it($,G);return}T==="queue"&&Ae($);return}_==="queue"&&(T==="queue"?ve($,F):qe($,F))}function Ne(d){v=d,Cl(d),ce()}function Pe(d){y=d==="board"||d==="created"||d==="spec"?d:Hr,Ol(y),ce()}function Re(d){let l=d.target?.closest?.(".worker-filter__blocked");if(l){Ne({...v,show_blocked:l.checked});return}let _=d.target?.closest?.(".worker-sort");if(_){Pe(_.value||Hr);return}let $=d.target?.closest?.(".worker-slots__input");if(!$)return;let T=Number.parseInt($.value,10);if(!Number.isFinite(T)){ce();return}Ce(T).then(ce)}function R(d){return d?{runner:d.runner||void 0,model:d.model||void 0,effort:d.effort||void 0,worktree:d.worktree||void 0,status:d.status||void 0,session_id:d.session_id||void 0}:{}}function D(d){let l=ke(),_=l.attempts?l.attempts[d]:null;N=d,S.hidden=!1,z.open({attempt_id:d,meta:R(_)}),ce()}function X(){if(!N)return;let d=ke(),l=d.attempts?d.attempts[N]:null;if(l){z.updateMeta(R(l));return}z.close()}function V(d){let l=d.target;if(l?.closest?.("#worker-exec-defaults-dialog"))return;if(l?.closest?.(".worker-exec-defaults-btn")){K.open();return}let _=l?.closest?.(".worker-banner__resume");if(_){let te=_.dataset.attemptId;te&&ot(te);return}let $=l?.closest?.(".worker-banner__dismiss");if($){let te=$.dataset.attemptId;te&&he(te);return}if(l?.closest?.(".worker-play")){rt(!ke().auto_advance);return}let T=l?.closest?.(".worker-pane__hd--toggle");if(T){let te=T.dataset.lane;(te==="queue"||te==="done")&&De(te);return}let G=l?.closest?.(".worker-card__place");if(G){let te=G.dataset.beadId;te&&!G.disabled&&qe(te,Xe());return}let Q=l?.closest?.(".worker-filter__chip");if(Q){let te=Q.dataset.spec;(te==="all"||te==="with"||te==="without")&&Ne({...v,spec:te});return}let F=l?.closest?.(".worker-mini__merge");if(F){Je(F.dataset.beadId||"");return}let ue=l?.closest?.(".worker-mini__discard");if(ue){ae(ue.dataset.beadId||"");return}let at=l?.closest?.(".worker-mini__revise-fix");if(at){Fe("worker-revise-fix",at.dataset.beadId||"");return}let nt=l?.closest?.(".worker-mini__revise-approve");if(nt){Fe("worker-revise-approve",nt.dataset.beadId||"");return}if(l?.closest?.(".worker-mini__pr"))return;if(l?.closest?.(".rtile__stop")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&Qe(_e);return}if(l?.closest?.(".rtile__pause")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&fe(_e);return}if(l?.closest?.(".rtile__resume")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&ot(_e);return}if(l?.closest?.(".rtile__session")){let _e=l?.closest?.(".rtile")?.dataset?.attemptId;_e&&D(_e);return}if(l?.closest?.(".worker-drawer-overlay__backdrop")){z.close();return}if(l?.closest?.(".worker-drawer-host"))return;let ft=l?.closest?.(".rtile");if(ft){if(l?.closest?.(".rtile__id")){let _e=ft.dataset.beadId;_e&&Lt(_e).then(m=>{m?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let te=ft.dataset.beadId;te&&c&&c(te);return}let Ke=l?.closest?.(".worker-mini, .worker-card");if(Ke){let te=Ke.dataset.beadId;if(l?.closest?.(".worker-mini__id, .worker-card__id")){te&&Lt(te).then(_e=>{_e?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}te&&c&&c(te)}}return t.addEventListener("dragstart",He),t.addEventListener("dragover",Me),t.addEventListener("dragleave",tt),t.addEventListener("drop",me),t.addEventListener("click",V),t.addEventListener("change",Re),Oe(),xe(),u&&q.push(u.subscribe(ce)),s&&q.push(s.subscribe(()=>{ce(),X()})),ce(),{load(){ce()},destroy(){for(let d of q.splice(0))try{d()}catch{}t.removeEventListener("dragstart",He),t.removeEventListener("dragover",Me),t.removeEventListener("dragleave",tt),t.removeEventListener("drop",me),t.removeEventListener("click",V),t.removeEventListener("change",Re);try{z.destroy()}catch{}S.hidden=!0;try{K.destroy()}catch{}de(p``,t)}}}function Gn(t){if(!t)return"Unknown";let e=t.split("/").filter(Boolean);return e.length>0?e[e.length-1]:"Unknown"}function Wo(t,e,r,n=async()=>{},s=async()=>{}){let o=ye("views:workspace-picker"),i=null,c=!1,a=!1,u=!1;async function f(S){let b=S.target.value,N=e.getState().workspace?.current?.path||"";if(b&&b!==N){o("switching workspace to %s",b),c=!0,A();try{await r(b)}catch(z){o("workspace switch failed: %o",z)}finally{c=!1,A()}}}async function g(){let S=e.getState(),x=S.workspace?.current?.path||S.workspace?.available?.[0]?.path||"";if(!(!x||a)){o("git-pulling workspace %s",x),a=!0,A();try{await n(x)}catch(b){o("workspace git pull failed: %o",b)}finally{a=!1,A()}}}function w(S){let x=S.target;x&&t.contains(x)||C()}function v(S){S.key==="Escape"&&C()}function y(){u||(u=!0,document.addEventListener("mousedown",w),document.addEventListener("keydown",v),A())}function C(){u&&(u=!1,document.removeEventListener("mousedown",w),document.removeEventListener("keydown",v),A())}function M(){u?C():y()}async function P(S){let x=S.target,b=x.value,O=x.checked;o("toggling visibility %s \u2192 %s",b,String(O));try{await s(b,O)}catch(N){o("workspace visibility toggle failed: %o",N)}}function B(S){return S?p`
      <button
        type="button"
    ...
    `}function I(){let S=e.getState(),x=S.workspace?.current,b=S.workspace?.available||[],O=new Set(S.workspace?.hidden||[]),N=x?.path||b[0]?.path||"";if(b.length===0)return p``;let z=b.filter(K=>!O.has(K.path)||K.path===N);if(z.length<=1){let K=z[0]||b[0],ke=Gn(K.path);return p`
