...
\f\r"'\`<>=]|("|')|))|$)`,"g"),ec=/'/g,tc=/"/g,sc=/^(?:script|style|textarea|title)$/i,ja=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),l=ja(1),rs=ja(2),fv=ja(3),bn=Symbol.for("lit-noChange"),Ft=Symbol.for("lit-nothing"),nc=new WeakMap,ir=lr.createTreeWalker(lr,129);function oc(e,t){if(!Fa(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xl!==void 0?Xl.createHTML(t):t}var ac=(e,t)=>{let n=e.length-1,r=[],s,o=t===2?"<svg>":t===3?"<math>":"",a=Qr;for(let i=0;i<n;i++){let c=e[i],u,d,g=-1,y=0;for(;y<c.length&&(a.lastIndex=y,d=a.exec(c),d!==null);)y=a.lastIndex,a===Qr?d[1]==="!--"?a=Ql:d[1]!==void 0?a=Jl:d[2]!==void 0?(sc.test(d[2])&&(s=RegExp("</"+d[2],"g")),a=ar):d[3]!==void 0&&(a=ar):a===ar?d[0]===">"?(a=s??Qr,g=-1):d[1]===void 0?g=-2:(g=a.lastIndex-d[2].length,u=d[1],a=d[3]===void 0?ar:d[3]==='"'?tc:ec):a===tc||a===ec?a=ar:a===Ql||a===Jl?a=Qr:(a=ar,s=void 0);let h=a===ar&&e[i+1].startsWith("/>")?" ":"";o+=a===Qr?c+a_:g>=0?(r.push(u),c.slice(0,g)+Na+c.slice(g)+Mn+h):c+Mn+(g===-2?i:h)}return[oc(e,o+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},ns=class e{constructor({strings:t,_$litType$:n},r){let s;this.parts=[];let o=0,a=0,i=t.length-1,c=this.parts,[u,d]=ac(t,n);if(this.el=e.createElement(u,r),ir.currentNode=this.el.content,n===2||n===3){let g=this.el.content.firstChild;g.replaceWith(...g.childNodes)}for(;(s=ir.nextNode())!==null&&c.length<i;){if(s.nodeType===1){if(s.hasAttributes())for(let g of s.getAttributeNames())if(g.endsWith(Na)){let y=d[a++],h=s.getAttribute(g).split(Mn),A=/([.?@])?(.*)/.exec(y);c.push({type:1,index:o,name:A[2],strings:h,ctor:A[1]==="."?Xs:A[1]==="?"?Qs:A[1]==="@"?Js:ur}),s.removeAttribute(g)}else g.startsWith(Mn)&&(c.push({type:6,index:o}),s.removeAttribute(g));if(sc.test(s.tagName)){let g=s.textContent.split(Mn),y=g.length-1;if(y>0){s.textContent=Ys?Ys.emptyScript:"";for(let h=0;h<y;h++)s.append(g[h],es()),ir.nextNode(),c.push({type:2,index:++o});s.append(g[y],es())}}}else if(s.nodeType===8)if(s.data===qa)c.push({type:2,index:o});else{let g=-1;for(;(g=s.data.indexOf(Mn,g+1))!==-1;)c.push({type:7,index:o}),g+=Mn.length-1}o++}}static createElement(t,n){let r=lr.createElement("template");return r.innerHTML=t,r}};function cr(e,t,n=e,r){if(t===bn)return t;let s=r!==void 0?n._$Co?.[r]:n._$Cl,o=ts(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=s:n._$Cl=s),s!==void 0&&(t=cr(e,s._$AS(e,t.values),s,r)),t}var Zs=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,s=(t?.creationScope??lr).importNode(n,!0);ir.currentNode=s;let o=ir.nextNode(),a=0,i=0,c=r[0];for(;c!==void 0;){if(a===c.index){let u;c.type===2?u=new Tr(o,o.nextSibling,this,t):c.type===1?u=new c.ctor(o,c.name,c.strings,this,t):c.type===6&&(u=new eo(o,this,t)),this._$AV.push(u),c=r[++i]}a!==c?.index&&(o=ir.nextNode(),a++)}return ir.currentNode=lr,s}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},Tr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,s){this.type=2,this._$AH=Ft,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=cr(this,t,n),ts(t)?t===Ft||t==null||t===""?(this._$AH!==Ft&&this._$AR(),this._$AH=Ft):t!==this._$AH&&t!==bn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):rc(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Ft&&ts(this._$AH)?this._$AA.nextSibling.data=t:this.T(lr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=ns.createElement(oc(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(n);else{let o=new Zs(s,this),a=o.u(this.options);o.p(n),this.T(a),this._$AH=o}}_$AC(t){let n=nc.get(t.strings);return n===void 0&&nc.set(t.strings,n=new ns(t)),n}k(t){Fa(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,s=0;for(let o of t)s===n.length?n.push(r=new e(this.O(es()),this.O(es()),this,this.options)):r=n[s],r._$AI(o),s++;s<n.length&&(this._$AR(r&&r._$AB.nextSibling,s),n.length=s)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},ur=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,s,o){this.type=1,this._$AH=Ft,this._$AN=void 0,this.element=t,this.name=n,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Ft}_$AI(t,n=this,r,s){let o=this.strings,a=!1;if(o===void 0)t=cr(this,t,n,0),a=!ts(t)||t!==this._$AH&&t!==bn,a&&(this._$AH=t);else{let i=t,c,u;for(t=o[0],c=0;c<o.length-1;c++)u=cr(this,i[r+c],n,c),u===bn&&(u=this._$AH[c]),a||(a=!ts(u)||u!==this._$AH[c]),u===Ft?t=Ft:t!==Ft&&(t+=(u??"")+o[c+1]),this._$AH[c]=u}a&&!s&&this.j(t)}j(t){t===Ft?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Xs=class extends ur{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Ft?void 0:t}},Qs=class extends ur{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Ft)}},Js=class extends ur{constructor(t,n,r,s,o){super(t,n,r,s,o),this.type=5}_$AI(t,n=this){if((t=cr(this,t,n,0)??Ft)===bn)return;let r=this._$AH,s=t===Ft&&r!==Ft||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==Ft&&(r===Ft||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},eo=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){cr(this,t)}},ic={M:Na,P:Mn,A:qa,C:1,L:ac,R:Zs,D:rc,V:cr,I:Tr,H:ur,N:Qs,U:Js,B:Xs,F:eo},i_=Jr.litHtmlPolyfillSupport;i_?.(ns,Tr),(Jr.litHtmlVersions??(Jr.litHtmlVersions=[])).push("3.3.1");var Qe=(e,t,n)=>{let r=n?.renderBefore??t,s=r._$litPart$;if(s===void 0){let o=n?.renderBefore??null;r._$litPart$=s=new Tr(t.insertBefore(es(),o),o,void 0,n??{})}return s._$AI(e),s};var to="today",lc=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}],Cr=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"}];function Rn(e){return e==="today"?"today":"7d"}function Ba(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function dr(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function cc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function uc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function dc(){let e=null,t=[],n,r=new Set;function s(){for(let o of Array.from(r))try{o()}catch{}}return{get(){return e},getWorkspacesState(){return t},crossLanes(){return n},set(o,a,i){e=Array.isArray(o)?o:null,t=Array.isArray(a)?a:[],n=i===void 0?void 0:i!==null&&typeof i=="object"&&typeof i.revision=="number"&&Array.isArray(i.lanes)?{revision:i.revision,lanes:i.lanes}:null,s()},clear(){e=null,t=[],n=void 0,s()},subscribe(o){return r.add(o),()=>r.delete(o)}}}function pc(){let e=new Map,t=new Set;function n(s){return s.startsWith("session-log:")?s:`session-log:${s}`}function r(){for(let s of Array.from(t))try{s()}catch{}}return{set(s,o,a=null){e.set(n(s),{lines:Array.isArray(o)?[...o]:[],last_event_at:typeof a=="number"?a:null}),r()},append(s,o){let a=n(s),i=e.get(a)||{lines:[],last_event_at:null};i.lines=[...i.lines,o],i.last_event_at=Date.now(),e.set(a,i),r()},get(s){return e.get(n(s))||null},clear(s){typeof s=="string"?e.delete(n(s)):e.clear(),r()},subscribe(s){return t.add(s),()=>t.delete(s)}}}var hc=o_(bc(),1);function Ot(e){return(0,hc.default)(`beads-ui:${e}`)}function kn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function fr(e,t){let n=kn(e.created_at),r=kn(t.created_at);if(n!==r)return n<r?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function wc(e,t){let n=kn(e.created_at),r=kn(t.created_at);if(n!==r)return n<r?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function so(e,t){let n=kn(e.updated_at),r=kn(t.updated_at);if(n!==r)return n<r?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function kc(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let s=kn(e.created_at),o=kn(t.created_at);if(s!==o)return s<o?1:-1;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function $c(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var v_=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function yc(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function vc(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=v_.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function xc(e,t){let n=yc(e),r=yc(t);if(n!==r)return n<r?-1:1;let s=vc(e),o=vc(t);if(s!==o)return s<o?-1:1;let a=kn(e&&e.created_at),i=kn(t&&t.created_at);if(a!==i)return a<i?-1:1;let c=e&&e.id,u=t&&t.id;return c===u?0:String(c)<String(u)?-1:1}var Ua=2**20;function Ir(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-kn(e&&e.created_at)}function oo(e){return(t,n)=>{let r=Ir(t,e),s=Ir(n,e);if(r!==s)return r<s?-1:1;let o=t?.id,a=n?.id;return o<a?-1:o>a?1:0}}function Wa(e,t,n){let r=Array.isArray(e)?e:[],s=r.length,o=Math.max(0,Math.min(t,s-1)),a=o-1>=0?r[o-1]:null,i=o+1<s?r[o+1]:null;if(!a&&!i)return{rank:0};if(!a)return{rank:Ir(i,n)-Ua};if(!i)return{rank:Ir(a,n)+Ua};let c=Ir(a,n),u=Ir(i,n),d=(c+u)/2;return c<d&&d<u?{rank:d}:{renormalize:r.map((g,y)=>({bead_id:g.id,rank:y*Ua}))}}function za(e,t={}){let n=Ot(`issue-store:${e}`),r=new Map,s=[],o=0,a=new Set,i=!1,c=t.sort||fr;function u(){for(let y of Array.from(a))try{y()}catch{}}function d(){s=Array.from(r.values()).sort(c)}function g(y){if(i||!y||y.id!==e)return;let h=Number(y.revision)||0;if(n("apply %s rev=%d",y.type,h),!(h<=o&&y.type!=="snapshot")){if(y.type==="snapshot"){if(h<=o)return;r.clear();let A=Array.isArray(y.issues)?y.issues:[];for(let M of A)M&&typeof M.id=="string"&&M.id.length>0&&r.set(M.id,M);d(),o=h,u();return}if(y.type==="upsert"){let A=y.issue;if(A&&typeof A.id=="string"&&A.id.length>0){let M=r.get(A.id);if(!M)r.set(A.id,A);else{let W=Number.isFinite(M.updated_at)?M.updated_at:0,Z=Number.isFinite(A.updated_at)?A.updated_at:0;if(W<=Z){for(let le of Object.keys(M))le in A||delete M[le];for(let[le,V]of Object.entries(A))M[le]=V}}d()}o=h,u()}else if(y.type==="delete"){let A=String(y.issue_id||"");A&&(r.delete(A),d()),o=h,u()}}}return{id:e,subscribe(y){return a.add(y),()=>{a.delete(y)}},applyPush:g,snapshot(){return s},size(){return r.size},getById(y){return r.get(y)},dispose(){i=!0,r.clear(),s=[],a.clear(),o=0}}}function ao(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let a=e.params[o];n[o]=String(a)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function Ac(e){let t=Ot("subs"),n=new Map,r=new Map;function s(i,c){t("applyDelta %s +%d ~%d -%d",i,(c.added||[]).length,(c.updated||[]).length,(c.removed||[]).length);let u=r.get(i);if(!u||u.size===0)return;let d=Array.isArray(c.added)?c.added:[],g=Array.isArray(c.updated)?c.updated:[],y=Array.isArray(c.removed)?c.removed:[];for(let h of Array.from(u)){let A=n.get(h);if(!A)continue;let M=A.itemsById;for(let W of d)typeof W=="string"&&W.length>0&&M.set(W,!0);for(let W of g)typeof W=="string"&&W.length>0&&M.set(W,!0);for(let W of y)typeof W=="string"&&W.length>0&&M.delete(W)}}async function o(i,c){let u=ao(c);if(t("subscribe %s key=%s",i,u),!n.has(i))n.set(i,{key:u,itemsById:new Map});else{let g=n.get(i);if(g&&g.key!==u){let y=r.get(g.key);y&&(y.delete(i),y.size===0&&r.delete(g.key)),n.set(i,{key:u,itemsById:new Map})}}r.has(u)||r.set(u,new Set);let d=r.get(u);d&&d.add(i);try{await e("subscribe-list",{id:i,type:c.type,params:c.params})}catch(g){let y=n.get(i)||null;if(y){let h=r.get(y.key);h&&(h.delete(i),h.size===0&&r.delete(y.key))}throw n.delete(i),g}return async()=>{t("unsubscribe %s key=%s",i,u);try{await e("unsubscribe-list",{id:i})}catch{}let g=n.get(i)||null;if(g){let y=r.get(g.key);y&&(y.delete(i),y.size===0&&r.delete(g.key))}n.delete(i)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:ao,selectors:{getIds(i){let c=n.get(i);return c?Array.from(c.itemsById.keys()):[]},has(i,c){let u=n.get(i);return u?u.itemsById.has(c):!1},count(i){let c=n.get(i);return c?c.itemsById.size:0},getItemsById(i){let c=n.get(i),u={};if(!c)return u;for(let d of c.itemsById.keys())u[d]=!0;return u}}}}function Sc(){let e=Ot("issue-stores"),t=new Map,n=new Map,r=new Set,s=new Map;function o(){for(let c of Array.from(r))try{c()}catch{}}function a(c,u,d){let g=u?ao(u):"",y=n.get(c)||"",h=t.has(c);if(e("register %s key=%s (prev=%s)",c,g,y),h&&y&&g&&y!==g){let A=t.get(c);if(A)try{A.dispose()}catch{}let M=s.get(c);if(M){try{M()}catch{}s.delete(c)}let W=za(c,d);t.set(c,W);let Z=W.subscribe(()=>o());s.set(c,Z)}else if(!h){let A=za(c,d);t.set(c,A);let M=A.subscribe(()=>o());s.set(c,M)}return n.set(c,g),()=>i(c)}function i(c){e("unregister %s",c),n.delete(c);let u=t.get(c);u&&(u.dispose(),t.delete(c));let d=s.get(c);if(d){try{d()}catch{}s.delete(c)}}return{register:a,unregister:i,getStore(c){return t.get(c)||null},snapshotFor(c){let u=t.get(c);return u?u.snapshot().slice():[]},subscribe(c){return r.add(c),()=>r.delete(c)}}}function Ec(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Tc(){let e=null,t=!1,n=new Set;function r(){for(let s of Array.from(n))try{s()}catch{}}return{get(){return e},set(s){e=s,r()},isPending(){return t},setPending(s){let o=s===!0;o!==t&&(t=o,r())},clear(){e=null,t=!1,r()},subscribe(s){return n.add(s),()=>n.delete(s)}}}function Cc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Ha(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function w_(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),s=r>=0?n.slice(r+1):"";if(s){let i=new URLSearchParams(s).get("issue");if(i)return decodeURIComponent(i)}let o=/^\/issue\/([^\s?#]+)/.exec(n);return o&&o[1]?decodeURIComponent(o[1]):null}function k_(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function Rc(e){let t=Ot("router"),n=()=>{let r=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(r),o=s&&s[1]?decodeURIComponent(s[1]):w_(r),a=k_(r);if(t("hash change \u2192 view=%s id=%s",a,o),e.setState({selected_id:a==="worker"?null:o,view:a,worker:{selected_parent_id:a==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let c=o?`#/${a}?issue=${encodeURIComponent(o)}`:`#/${a}`;window.location.hash!==c&&(window.location.hash=c)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",a=Ha(o,r);t("goto issue %s (view=%s)",r,o),window.location.hash!==a?window.location.hash=a:e.setState({selected_id:o==="worker"?null:r,view:o,worker:{selected_parent_id:o==="worker"?r:null}})},gotoView(r){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=r==="worker"?s.worker?.selected_parent_id:s.selected_id,a=o?Ha(r,o):`#/${r}`;t("goto view %s (id=%s)",r,o||""),window.location.hash!==a?window.location.hash=a:e.setState({view:r,selected_id:r==="worker"?null:s.selected_id})}}}var $_=Object.freeze({workspace_config:{default_workspace:null}});function Oc(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:$_.workspace_config.default_workspace}}}function Lc(e={}){let t=Ot("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:Oc(e.config)},r=new Set;function s(){for(let o of Array.from(r))try{o(n)}catch{}}return{getState(){return n},setState(o){let a={...n,...o,filters:{...n.filters,...o.filters||{}},board:{...n.board,...o.board||{}},worker:{...n.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:n.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:n.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:n.workspace.hidden},config:o.config!==void 0?Oc(o.config):n.config},i=a.workspace.current?.path!==n.workspace.current?.path||a.workspace.available.length!==n.workspace.available.length||a.workspace.hidden.length!==n.workspace.hidden.length||a.workspace.hidden.some((u,d)=>u!==n.workspace.hidden[d]),c=a.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;a.selected_id===n.selected_id&&a.view===n.view&&a.filters.status===n.filters.status&&a.filters.search===n.filters.search&&a.filters.type===n.filters.type&&a.board.closed_filter===n.board.closed_filter&&a.worker.selected_parent_id===n.worker.selected_parent_id&&a.worker.show_closed_children.length===n.worker.show_closed_children.length&&a.worker.show_closed_children.every((u,d)=>u===n.worker.show_closed_children[d])&&!i&&!c||(n=a,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),s())},subscribe(o){return r.add(o),()=>r.delete(o)}}}function Ic(e){let t=Ot("activity"),n=0,r=new Map,s=1;function o(){if(!e)return;let u=n>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function a(){n+=1,t("start count=%d",n),o()}function i(){let u=n;n=Math.max(0,n-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,n),o()}function c(u){return async(g,y)=>{let h=s++,A=Date.now();r.set(h,{type:g,start_ts:A}),t("request start id=%d type=%s count=%d",h,g,n+1),a();let M=!1,W=()=>{M||(M=!0,r.delete(h),i())},Z=setTimeout(()=>{M||(t("request TIMEOUT id=%d type=%s elapsed=%dms",h,g,Date.now()-A),W())},3e4);try{let le=await u(g,y),V=Date.now()-A;return t("request done id=%d type=%s elapsed=%dms",h,g,V),le}catch(le){let V=Date.now()-A;throw t("request error id=%d type=%s elapsed=%dms err=%o",h,g,V,le),le}finally{clearTimeout(Z),W()}}}return o(),{wrapSend:c,start:a,done:i,getCount:()=>n,getActiveRequests:()=>{let u=Date.now();return Array.from(r.entries()).map(([d,g])=>({id:d,type:g.type,elapsed_ms:u-g.start_ts}))}}}function pe(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function io(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function r(o,a,i){let c=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(a==="closed")return c.sort($c),c;switch(i){case"created_desc":return c.sort(fr),c;case"created_asc":return c.sort(wc),c;case"updated_desc":return c.sort(so),c;case"priority":return c.sort(kc),c;case"manual":default:{let u=n();return u?c.sort(oo(u)):c.sort(fr),c}}}function s(o){let a=[];return e&&typeof e.subscribe=="function"&&a.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&a.push(t.subscribe(o)),()=>{for(let i of a)try{i()}catch{}}}return{selectBoardColumn:r,subscribe:s}}function On(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function Kt(e){let t=On(e);if(t===null)return"";let n=new Date(t),r=s=>String(s).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function an(e,t){let n=On(e);if(n===null)return"";let s=(typeof t=="number"?t:Date.now())-n;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let a=Math.floor(s/36e5);if(a<24)return`${a}\uC2DC\uAC04 \uC804`;let i=Math.floor(s/864e5);if(i<7)return`${i}\uC77C \uC804`;let c=Math.floor(i/7);if(i<30)return`${c}\uC8FC \uC804`;let u=Math.floor(i/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(i/365)}\uB144 \uC804`}function Pc(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let s=On(r.updated_at)??0;if(t===null||s>n){t=r,n=s;continue}s===n&&String(r.id)<String(t.id)&&(t=r)}return t}function lo(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function co(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let s=lo(r);if(!s)continue;let o=n.get(s);o||(o=[],n.set(s,o)),o.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function uo(e,t){let n=e.get(t)||[],r=0;for(let o of n)(o.status==="resolved"||o.status==="closed")&&(r+=1);let s=Pc(n);return{total:n.length,count:r,current:s,children:n}}function po(e){let t=e.transport,n=e.uiOrderStore;function r(a,i){return"renormalize"in a?a.renormalize:[{bead_id:i,rank:a.rank}]}function s(a,i){let c={...a.order};for(let u of i)c[u.bead_id]=u.rank;n&&n.set({revision:a.revision,order:c})}async function o(a,i,c){if(!t||!n)return;let u=n.get()||{revision:0,order:{}},d=r(Wa(i,c,u.order),a);s(u,d);let g=await t("ui-order-set",{expected_revision:u.revision,entries:d});if(g&&g.conflict){let y={revision:typeof g.revision=="number"?g.revision:0,order:g.order||{}};n.set(y);let h=r(Wa(i,c,y.order),a);s(y,h);let A=await t("ui-order-set",{expected_revision:y.revision,entries:h});A&&A.applied&&n.set({revision:typeof A.revision=="number"?A.revision:0,order:A.order||{}})}else g&&g.applied&&n.set({revision:typeof g.revision=="number"?g.revision:0,order:g.order||{}})}return{applyReorder:o}}function Dc(e){if(typeof e!="string")return"";let t=e.indexOf("-");return t>0?e.slice(0,t):""}function fo(e,t){let n=Dc(e),r=Dc(t);return n.length===0||r.length===0?!1:n!==r}function _o(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ga(e,t){return!t||typeof e!="string"||e.length===0||_o(t.visible_labels).includes(e)?!0:_o(t.hidden_labels).includes(e)?!1:!_o(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function Mc(e,t){return _o(e).filter(n=>Ga(n,t))}function Yn(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function x_(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function A_(e,t,n,r,s){return l`<button
  ...
  `}function jc(e){let t=e?e.doc:null;return!t||typeof t.path!="string"||t.path.length===0?null:t}function go(e,t,n={}){if(!e||!e.stages)return"";let r=n.onOpenDoc,s=Nc[e.route]||Nc.spec_backed,o=e.stages,a=C_(s,o,String(t||"open")),i=`\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uC9C4\uD589: ${s.map(u=>`${qc[u]||u} ${u==="plan"?R_(o[u]||{}):Fc(o[u]||{})}`).join(" \xB7 ")}`,c=!!r&&s.some(u=>jc(o[u]||{})!==null);return l`
    <div
      class="stp"
      role=${c?"group":"img"}
      aria-label=${i}
  ...
  `}function L_(e){return typeof e!="number"||!Number.isFinite(e)?"":`P${Math.max(0,Math.min(4,e))}`}var Bc=2;function Uc(e){let t=e.slice(0,Bc).join(", "),n=e.length-Bc;return`\u26D3 blocked: ${t}${n>0?` +${n}`:""}`}function I_(e,t){if(!t)return[];let n=[];if(t.external){let a=t.reason?`\u23F8 blocked: ${t.reason}`:"\u23F8 blocked";n.push(l`<span class="ctl-chip ctl-chip--blocked">${a}</span>`)}let r=Array.isArray(t.blockers)?t.blockers:[],s=[],o=[];for(let a of r)(fo(e,a)?o:s).push(a);return s.length>0&&n.push(l`<span class="ctl-chip ctl-chip--blocked-dep"
        >${Uc(s)}</span
      ...
      >`),n}function Ka(e){return e==="delegated"?"\uC704\uC784":e==="main"?"\uBA54\uC778":null}function bo(e){return e.effort?`${e.actor}:${e.effort}`:e.actor}function Nn(e){return`${e.kind}:${bo(e)}@${e.sha}`}function ho(e,t){if(!e)return null;let n=Ka(e.kind),r=e.reason,s=e.kind==="delegated"?r===null:typeof r=="string"&&r.trim().length>0&&!/[\r\n]/.test(r);if(!n||!s)return null;let o=Ka(t?.kind),a=o!==null&&t?.kind!==e.kind,i=`\uACC4\uD68D \xB7 ${n}${a?` \u2192 ${o}`:""}`,c=`planned_execution ${e.kind}${typeof r=="string"?`:${r}`:""}`,u=t?` \xB7 exec_receipt ${Nn(t)}`:"";return{kind:e.kind,label:i,title:`${c}${u}`}}function Wc(e,t){let n=ho(e,t);return n?l`<span
        ...
        title=${n.title}
        >${n.label}</span
      >`:null}function P_(e){if(!e)return null;let t=Ka(e.kind);return t?l`<span
  ...
  `}var U_=200,W_={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},z_=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),Gc="beads-ui.board.sort",Kc=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function H_(){try{let e=window.localStorage.getItem(Gc);if(e&&Kc.has(e))return e}catch{}return"created_desc"}function Vc(e,t){let n=Ot("views:board"),r=t.gotoIssue,s=t.issueStores,o=t.transport,a=t.uiOrderStore,i=t.displayPolicyStore,c=t.workerQueueStore,u=t.onClosedRangeChange,d=t.onNewIssue,g=t.openDoc,y=t.closedRange||to,h=s?io(s,a):null,A=po({transport:o,uiOrderStore:a}),M=[],W=[],Z=[],le=[],V=[],B=[],j=!1,G=0,P=H_(),L=new Map,ne=new Map,Te=new Map,ke=new Set,z={search:"",priority:"",type:"",labels:[]},te=!1,me=null;function xe(E){return String(E.status||"open")==="open"}function ye(E){let Y=String(E.status||"open");return Y==="open"||Y==="blocked"}function ce(E){let Y=z.search.trim().toLowerCase(),fe=z.priority,x=z.type,b=z.labels;return E.filter($=>{if(Y){let U=String($.id||"").toLowerCase(),se=String($.title||"").toLowerCase();if(!U.includes(Y)&&!se.includes(Y))return!1}if(fe!==""&&String($.priority)!==fe||x!==""&&String($.issue_type||"")!==x)return!1;if(b.length>0){let U=Array.isArray($.labels)?$.labels:[];if(!b.some(se=>U.includes(se)))return!1}return!0})}function Ae(){let E=new Set;for(let Y of[M,W,Z,le,V,B])for(let fe of Y){let x=Array.isArray(fe.labels)?fe.labels:[];for(let b of x)typeof b=="string"&&b.length>0&&E.add(b)}return Array.from(E).sort()}function ve(){return z.search.trim()!==""||z.priority!==""||z.type!==""||z.labels.length>0}function K(){try{if(h){let E=h.selectBoardColumn("tab:board:in-progress","in_progress",P),Y=h.selectBoardColumn("tab:board:blocked","blocked",P).filter(ye),fe=new Set(E.map(De=>De.id)),x=h.selectBoardColumn("tab:board:ready","ready",P).filter(De=>xe(De)&&!fe.has(De.id)),b=h.selectBoardColumn("tab:board:resolved","resolved",P),$=h.selectBoardColumn("tab:board:deferred","deferred",P),U=h.selectBoardColumn("tab:board:closed","closed").slice(0,U_),se=[...Y,...x,...E,...b,...U];oe(se);let ae=new Set;for(let De of se)De&&De.id&&!lo(De)&&ae.add(De.id);let he=!ve();M=he?ss(Y,ae):Y,W=he?ss(x,ae):x,Z=he?ss(E,ae):E,le=he?ss(b,ae):b,V=$,G=$.length,B=he?ss(U,ae):U,L=new Map;for(let De of M)L.set(De.id,"open");for(let De of W)L.set(De.id,"open");for(let De of Z)L.set(De.id,"in_progress");for(let De of le)L.set(De.id,"resolved");for(let De of V)L.set(De.id,"deferred");for(let De of B)L.set(De.id,"closed");ne=new Map;for(let De of M)ne.set(De.id,"blocked-col");for(let De of W)ne.set(De.id,"ready-col");for(let De of Z)ne.set(De.id,"in-progress-col");for(let De of le)ne.set(De.id,"resolved-col");for(let De of B)ne.set(De.id,"closed-col")}et()}catch{M=[],W=[],Z=[],le=[],V=[],B=[],Te=new Map,et()}}function oe(E){Te=co(E)}function ue(E){return uo(Te,E)}function $e(E){return!ke.has(E)}function He(E,Y){E.preventDefault(),E.stopPropagation(),ke.has(Y)?ke.delete(Y):ke.add(Y),et()}function ge(E,Y){E.preventDefault(),E.stopPropagation(),r(Y)}function qe(E,Y){E.preventDefault(),E.stopPropagation(),r(Y)}function N(E,Y){me||r(Y)}function be(E,Y){E.preventDefault(),E.stopPropagation(),G_(Y).then(fe=>{fe&&pe("\uBCF5\uC0AC\uB428","success",1200)})}function Oe(E,Y){me=Y,E.dataTransfer&&(E.dataTransfer.setData("text/plain",Y),E.dataTransfer.effectAllowed="move"),E.target.classList.add("board-card--dragging")}function We(E){E.target.classList.remove("board-card--dragging"),vt(),setTimeout(()=>{me=null},0)}function ze(E){let Y=String(E.target.value||"");!Y||Y===y||(y=Y,u&&u(Y),et())}function je(){return i?i.get():null}function Ge(E){let Y=c?c.get():null,fe=Y?Y.cleanup_failed:null;if(!fe||typeof fe!="object"||Array.isArray(fe))return null;let x=fe[E];return!x||typeof x!="object"||Array.isArray(x)?null:x}let Je={onCardClick:N,onCopyId:be,onDragStart:Oe,onDragEnd:We,onClosedRangeChange:ze,rollupFor:ue,isExpanded:$e,onRollupToggle:He,onChildClick:ge,onFromChipClick:qe,onOpenDoc:g?(E,Y)=>g(Y):void 0,cleanupFailureFor:Ge,get policy(){return je()}};function lt(E,Y){me||(Ie(),r(Y))}function ft(E,Y){E.preventDefault(),E.stopPropagation(),Ie(),r(Y)}let xt={...Je,onCardClick:lt,onChildClick:ft,onFromChipClick:ft,onOpenDoc:g?(E,Y)=>{Ie(),g(Y)}:void 0,get policy(){return je()}};function _t(E){let Y=E.target,fe=e.querySelector(".board-filter__labels");Y&&fe&&fe.contains(Y)||Re()}function Q(E){E.key==="Escape"&&Re()}function ee(){te||(te=!0,document.addEventListener("mousedown",_t),document.addEventListener("keydown",Q),et())}function Re(){te&&(te=!1,document.removeEventListener("mousedown",_t),document.removeEventListener("keydown",Q),et())}function Ne(E){E.key==="Escape"&&Ie()}function Ce(){j||(j=!0,document.addEventListener("keydown",Ne),et())}function Ie(){j&&(j=!1,document.removeEventListener("keydown",Ne),et())}let Fe={onClose:Ie,onOverlayClick(E){E.target===E.currentTarget&&Ie()}},at={onSearchInput(E){z.search=String(E.target.value||""),K()},onPriorityChange(E){z.priority=String(E.target.value||""),K()},onTypeChange(E){z.type=String(E.target.value||""),K()},onSortChange(E){let Y=String(E.target.value||"");if(!(!Kc.has(Y)||Y===P)){P=Y;try{window.localStorage.setItem(Gc,Y)}catch{}K()}},onDeferredToggle(){j?Ie():Ce()},onLabelMenuToggle(){te?Re():ee()},onLabelToggle(E){let Y=z.labels.indexOf(E);Y===-1?z.labels.push(E):z.labels.splice(Y,1),K()},onLabelClear(){z.labels.length!==0&&(z.labels=[],K())},onNewIssue(){d&&d()}};function nt(){return l`
      <div class="board-view">
        ${Hc(z,at,{sort_mode:P,deferred_popup_open:j,deferred_count:G,label_options:Ae(),label_menu_open:te})}
...
`)}function ue(){if(!o)return l``;let Q=Te(),ee=(a?[g.agent_type,g.model,g.effort]:[g.runner,g.model,g.effort]).filter(Boolean).join(" \xB7 "),Re=g.session_id||"",Ne=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${y?"ON":"OFF"}`,Ce=z(),Ie=Ce?Ng(ke(),Date.now()):"",Fe=Ce?Ae(Q):null,at=Ce?ve(Q):null,nt=Mg(Q);return l`<div class="sv" data-attempt-id=${o}>
    ...
    </div>`}function He(Q){let ee=A.has(Q.idx),Re=Q.header?Q.header.line:null,Ne=Re?Re.is_error===!0?"\u2717":typeof Re.result=="string"?"\u2713":"\u27F3":"",Ce=Re&&Re.command?Re.command:"";return l`<div class="sv__sub${ee?" sv__sub--open":""}">
      <div
        class="sv__sub-head"
        role="button"
        tabindex="0"
...
`).trim()}}var Wu=20;function zu(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${s}:${o}`}function zg(e){return e.length>Wu?`${e.slice(0,Wu)}\u2026`:e}function Hg(e,t,n,r){let s=`${t.lane} ${zg(t.identifier)}`;return l`<div class="detail-report">
    ...
    ${n.error?l`<div class="detail-empty" data-seam="comments-error">
          댓글을 불러오지 못했습니다
            ...
            ${i.map(c=>{let u=No(typeof c.text=="string"?c.text:"");return u?Hg(c,u,t,s.has(c.id)):Gg(c)})}
          </div>`}
  ...
  >
    ...
    title=${h}
    >${M}</span
  >`}function ab(e,t,n){if(e.receipt&&typeof t[e.receipt]=="string")return String(t[e.receipt]);if(e.receipt_stage){let r=n[e.receipt_stage]?.receipt;return typeof r=="string"?r:""}return""}function ib(e,t){if(e.id!=="plan")return"";let n=t.plan?.approval_state;return typeof n=="string"&&Object.hasOwn(sd,n)?sd[n]:""}function Ho(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function id(e){return Ho(e)&&typeof e.key=="string"&&e.key.length>0&&typeof e.email=="string"&&e.email.length>0}function ld(e,t){let n=e&&e[t];if(!Ho(n)||!Array.isArray(n.accounts))return null;let r=n.accounts.filter(id),s=id(n.active)?n.active:null;return{accounts:r,active:s||r.find(o=>o.active===!0)||null}}function dd(e){return typeof e.alias=="string"&&e.alias.length>0?` (${e.alias})`:""}function Go(e){let t=typeof e.status=="string"&&e.status!=="ok"?` \xB7 ${e.status}`:"";return`${e.email}${dd(e)}${t}`}function Hr(e){let t=typeof e.plan=="string"&&e.plan.length>0?e.plan:"plan \uD655\uC778 \uBD88\uAC00";return`${e.email} \xB7 ${t}${dd(e)}`}function lb(e,t,n){if(n!==null){let s=e==="claude"?Go:Hr,o=t?t.accounts.find(a=>a.key===n):void 0;return`\uB808\uD3EC \uAE30\uBCF8\uAC12 \uC0AC\uC6A9(${o?s(o):n})`}return t?t.active?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${e==="claude"?t.active.email:Hr({...t.active,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)":"(\uAE30\uBCF8)"}function cd(e,t){if(!Ho(e)||e.state!=="usable"||!Ho(e.values))return null;let n=e.values[t];return typeof n=="string"&&n.length>0?n:null}function ud(e){let t=e.provider_key==="claude"?Go:Hr,n=!!e.provider?.accounts.some(r=>r.key===e.selected);return l`<div class="detail-kv" data-exec-account-row=${e.key}>
...
${i}</pre
    ...
    `:l``}function g(){Qe(d(),e)}async function y(M,W={}){s=M,o="loading",a="",i=null,c="",g();let Z=W.workspace||(n?n():"");if(!Z){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",g();return}if(!r){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",g();return}let le="/api/doc?workspace="+encodeURIComponent(Z)+"&path="+encodeURIComponent(M);try{let V=await r(le),B=await V.json().catch(()=>({}));if(!V.ok||!B||B.ok!==!0){if(B?.error==="not_found"&&W.missing_state==="plan_pending"){o="pending",c="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",g();return}o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(B&&B.error||V.status)+")",g();return}let j=pb(String(B.content||""));i=j.front,a=j.body,o="ready",g()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",g()}}function h(){s=null,Qe(l``,e)}function A(){document.removeEventListener("keydown",u),h()}return{open:y,close:h,destroy:A}}var fb=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],yd="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Yo=[{role:"implementation",provider:"codex"},{role:"review-consult",provider:"codex"},{role:"subagent",provider:"claude"}],_b=new Set(["codex-runner","Explore","Plan","advisor","advisor-xhigh","claude-code-guide","statusline-setup"]);function bd(e){return typeof e=="string"&&_b.has(e)}var mb=["running","done","failed","interrupted"],gb={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function bb(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function hb(e){let t=Vt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
    ...
    >${e.replayed?l`<span class="detail-usage-partial" title=${yd}
          >부분 집계</span
        >`:""}`}function hd(e){return!e||!e.roles.orchestrator?null:{providers:e.roles.orchestrator,roles:{}}}function qi(e){if(typeof e=="number")return Ss(e);if(typeof e!="string")return"";let t=Date.parse(e);return Number.isFinite(t)?Ss(t):""}function yb(e){return typeof e=="string"?e.replace(/-\d{8}$/,""):""}function vb(e,t){if(e.provider!=="claude")return{text:e.session_id.slice(0,8),title:e.session_id};let n=t&&typeof t.agent_id=="string"?t.agent_id:"";return n.length>0?{text:n.slice(0,8),title:n}:{text:e.launch_id.slice(-8),title:e.launch_id}}function Mi(e){return e===null||typeof e=="string"&&e.trim().length>0}function Ni(e){return e===null||typeof e=="number"&&Number.isFinite(e)}function wb(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let t=e,n=t.provider==="claude";return typeof t.launch_id!="string"||t.launch_id.length===0||!Yo.some(r=>r.role===t.role&&r.provider===t.provider)||!(n?Mi(t.model):typeof t.model=="string"&&t.model.length>0)||!(!("effort"in t)||Mi(t.effort))||!(!("agent_type"in t)||Mi(t.agent_type))||typeof t.session_id!="string"||t.session_id.length===0||!mb.includes(t.status)||!(t.turn_id===null||typeof t.turn_id=="string")?null:n?!Ni(t.started_at)||!Ni(t.last_event_at)||!Ni(t.completed_at)?null:t:typeof t.started_at!="number"||!Number.isFinite(t.started_at)||typeof t.last_event_at!="number"||!Number.isFinite(t.last_event_at)||!(t.completed_at===null||typeof t.completed_at=="string"&&Number.isFinite(Date.parse(t.completed_at)))?null:t}function kb(e,t,n){let s=Vt({providers:{[t]:{subtotal:n.subtotal,breakdown:n.usage,...n.replayed?{replayed:!0}:{}}},roles:{}})[0];return l`<div class="detail-session__leg detail-session__usage-detail">
  ...
  >
    ...
    ${a?l`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function xb(e,t){return e.role===t.role&&(e.model===null||t.model===void 0||e.model===t.model)&&e.session_id===t.session_id}function Ab(e,t,n){let r=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let d of o){let g=wb(d);!g||s.has(g.launch_id)||bd(g.agent_type)||(s.add(g.launch_id),r.push(g))}r.sort((d,g)=>(d.started_at||0)-(g.started_at||0));let a={};for(let{role:d,provider:g}of Yo){let y=t?t.roles[d]?.[g]:null;a[d]=y?[...y.legs]:[]}let i=Yo.flatMap(({role:d})=>a[d]),c=new Set,u=[];for(let{role:d,provider:g}of Yo){for(let y of r.filter(h=>h.role===d&&h.provider===g)){let h=i.find(A=>A.receipt_id===y.launch_id)||null;h&&!xb(y,h)||(h&&c.add(h.receipt_id),u.push($b(y,h,e.attempt_id,n)))}for(let y of a[d])!c.has(y.receipt_id)&&!bd(y.agent_type)&&u.push(kb(d,g,y))}return u}function Sb(e,t){let n=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,r=[...fb,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return l`<div class="detail-session__usage-detail">
  ...
  >
  ...
  </div>`}function vd(e,t={},n={},r=[]){let s=Array.isArray(e)?e:[],o=Array.isArray(r)?r:[],a=[...o.filter(h=>h&&h.current===!0),...o.filter(h=>h&&h.current!==!0).sort((h,A)=>A.index-h.index)],i=a.map(h=>Rb(h,t)),c=n.expanded||new Set;if(s.length===0&&a.length===0)return l`
    ...
    >
      ...
      ${h.cause}
    </div>`},y=h=>{let A=hd(ti(h));if(Vt(A).length===0&&!Fr(h.usage))return"";let M=c.has(h.attempt_id);return l`<button
      type="button"
    ...
    `}function J(){if(!u)return l``;let v=d||{},O=String(v.id||u),C=v.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",we=vt(),st=v.status||"open",Ye=typeof v.priority=="number"?Math.max(0,Math.min(4,v.priority)):"",it=v.description||"",Xe={...v,metadata:{...v.metadata||{},...g}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${q(C,we)}
          ${ad(Xe)}
          ${od({metadata:Xe.metadata,workspace_values:fe(),catalog:b(),execution_defaults:$(),expanded:M,presets:se()?.presets||[],preset_id:y,preset_busy:h,skipped_orchestration_keys:A},{onToggle:qt=>{M=qt,H()},onEdit:(qt,sn)=>{if(qt==="impl_runtime"||qt==="impl_model"||qt==="impl_effort"){zt(qt,sn??"");return}Zt(qt,sn??"")},onPresetSelect:qt=>{y=qt,A=[],H()},onPresetApply:()=>{De()}})}
          ${pd({md:Xe.metadata,catalog:Z,workspace_defaults:le,handlers:{onExecChange:Zt}})}
          ${p(st,Ye)} ${re(v)}
          ${m(it)}
          ${Hu(xe,Oe,{expanded:ue,draft:ve,sending:K,error:Ae})}
          ${w(v)} ${S(v)} ${T(v)}
          ${I(v)} ${k(v)}
          ${Uu(v,rn)}
          ${wd({expanded:lt,loading:ft,error:xt,data:_t},{onToggle:mt})}
          ${vd(Mt(),Y,{total:we,expanded:Ve},Ie)}
        </div>
      </div>
    `}function H(){Qe(J(),e)}return{load(v){v!==u&&(g={},y="",A=[],M=!1,Te(),$e(),Ne(),et(),ke()),u=v,d=null,Nt(),x(),V!==v&&me(v)},clear(){u=null,d=null,g={},y="",h=!1,A=[],M=!1,Te(),$e(),Ne(),et(),ke(),je.close(),Je.close(),Qe(l``,e)},destroy(){tt&&(tt(),tt=null),rt&&(rt(),rt=null),Se&&(Se(),Se=null),document.removeEventListener("keydown",ct),We||(je.destroy(),ze&&ze.parentNode&&ze.parentNode.removeChild(ze)),Je.destroy(),Ge.parentNode&&Ge.parentNode.removeChild(Ge),u=null,d=null,ke(),y="",h=!1,A=[],$e(),Ne(),et(),Qe(l``,e)}}}function $d(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
...
`);return l`<span
  ...
  >`,A=e.lane==="done"?"":ra(e.workflow),M=e.lane==="done"?"":Sd(e.from_id),W=sa(e.priority),Z=l`<span class="worker-mini__title">${e.title}</span>`,le=e.pr_url&&e.pr_number?l`<a
      ...
      >
        ...
        </div>`:"",ve=na(e.dependency_chips),K=Es(e),oe=!!(o||e.merge_action||e.cancel_action||e.timeline_action||e.discard_action||ke?.operation||e.revise_action||te);return l`<div
  ...
  >
  ...
  </details>`:""}function Hb(e){if(!Number.isFinite(e)||e<0)return"0s";let t=Math.floor(e/1e3),n=Math.floor(t/60),r=t%60;return n>0?`${n}m ${String(r).padStart(2,"0")}s`:`${r}s`}function Ld(e){let t=e.failure?oa(e.failure.reason):"";return l`<div class="worker-banners">
    ${e.failure?l`<div class="worker-banner worker-banner--failure" role="alert">
          ...
          ${Wb(e.failure.cause_detail)}
          ${zb(e.failure.reason)}
          ${Es({discard:e.failure.discard})}
        </div>`:""}
  </div>`}function Gb(e){return!e||!e.repo&&!e.serial_lane_id?"":l`${e.repo?l`<span
        class="worker-card__repo rtile__repo"
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?l`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`}var Kb=new Set(["codex-runner"]);function Vb(e,t,n,r=null){if(!e)return"";let s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=(r||!Array.isArray(e.legs)?[]:e.legs).filter(h=>h&&!(typeof h.agent_type=="string"&&Kb.has(h.agent_type))),c=i.filter(h=>h&&h.state==="live"),u=i.filter(h=>h&&h.state!=="live"),d=r&&typeof r.last_event_at=="number"?an(r.last_event_at,t):"",g=r?an(r.updated_at,t):"",y=d?`\uCD5C\uADFC \uD65C\uB3D9 ${d}`:g?`\uAC31\uC2E0 ${g}`:"";return l`${o?l`<div class="rtile__activity${n?" is-paused":""}">
        ...
        ${c.map(h=>l`<span
            ...
            >`)}${u.length>0?l`<span
              ...
              >위임 완료 ${u.length}</span
            >`:""}
      </div>`:""}`}var Yb={remote:"\uB2E4\uB978 \uBA38\uC2E0 \uC138\uC158 \u2014 \uC774 \uC11C\uBC84\uC5D0 transcript \uC5C6\uC74C",missing:"transcript \uD30C\uC77C \uC5C6\uC74C"};function Zb(e){if(!e)return"";let t=Yb[e.locality]||"";return l`<button
    type="button"
  ...
  >
    ▤ 세션
  </button>`}function Ui(e,t,n=null,r={}){let s=e.kind==="session",o=s&&Array.isArray(e.session_refs)&&e.session_refs.find(te=>te&&te.current===!0)||null,a=e.failed===!0,i=!!e.paused,c=a?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):i?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Hb(t-e.started_at):"\u2014",u=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,d=os(e),g=Vt(e.usage),y=Fn(e.usage),h=e.conflict_resolution?i?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,A=e.base_exception||null,M=e.landing,W=e.attempt_id&&e.attempt_id===n,Z=r.monitor||null,le=Gb(Z),V=Z?na(Z.dependency_chips):"",B=Vb(Z,t,i,s?{updated_at:e.updated_at??null,last_event_at:o&&o.locality==="local"?o.last_event_at:null}:null),j=s&&e.workflow?.chips?.exec_receipt||null,G=ra(e.workflow),P=j?l`<span
        class="ctl-chip ctl-chip--exec-receipt"
      ...
      >`:"",ne=le||G||L||P?l`<div class="rtile__meta">
          ${le}${G}${L}${P}
        </div>`:"",Te=l`${h?l`<span class="worker-mini__badge">${h}</span>`:""}${A?l`<span
  ...
  >
    <div class="rtile__hd">
      ...
      ${sa(e.priority)}${d?l`<span class="rtile__resumed" title=${d}>↻</span>`:""}${Te}
      <div class="rtile__hd-actions">
        ${s?l`${typeof e.started_at=="number"?l`<span class="rtile__elapsed">${c}</span>`:""}${Zb(o)}<span
...
`)}function Rs(e){if(typeof e!="object"||e===null)return null;let t=_r(e);if(t==="")return null;let n=(r,s)=>typeof s=="string"&&s.length>0?`${r}: ${s}`:null;return{text:t,title:Hi(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(Qn.orchestration_model,e.model),n(Qn.orchestration_effort,e.effort),n(Qn.orchestration_speed,e.speed)])}}function hr(e,t){let n=er(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=er(e,"orchestration_effort"),s=er(e,"orchestration_speed"),o=Id([En(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Hi(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",tr("orchestration_model",n),tr("orchestration_effort",r),tr("orchestration_speed",s)])}}function Xb(e,t){return e===null||e.value===null||zi.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function Qb(e){return e===null||zi.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function Jb(e){return e===null?null:e.value==="auto"?"auto":zi.has(e.resolution)?null:e.display}function nr(e,t){if(typeof e!="object"||e===null)return null;let n=er(e,"impl_dispatch"),r=er(e,"impl_runtime"),s=er(e,"impl_model"),o=er(e,"impl_effort"),a=er(e,"impl_speed"),i=n!==null&&n.value==="main"?"\uBA54\uC778":Id([Xb(r,t??null),Qb(s),Jb(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Hi(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",tr("impl_dispatch",n),tr("impl_runtime",r),tr("impl_model",s),tr("impl_effort",o),tr("impl_speed",a)])}}var Yt="",eh=["impl_runtime","impl_model","impl_effort"],th=["claude_account","codex_account"],nh=5,aa=1;function cn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function ia(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(D=>pe(D,"error",4e3)),o={},a={},i=[],c=!1,u={state:"absent",values:{},warnings:[]},d={},g={},y=Promise.resolve(),h={claude:null,codex:null},A=!1,M=null,W={},Z="",le="",V=!1,B=!1,j=!1,G=null,P=!1;function L(){let D=t.queue?t.queue():null;return cn(D)?D:null}function ne(){let D=L();return D?D.runner_catalog:null}function Te(){let D=L();return D&&cn(D.execution_defaults)?D.execution_defaults:null}function ke(){let D=t.implPresetStore?.get();return cn(D)&&Array.isArray(D.presets)?D:null}function z(){return r===null?{}:{root_dir:r}}async function te(D,X){return P||!n?null:await n(D,X)}function me(D){D&&cn(D.queue)&&t.onQueueAdopt?.(D.queue)}async function xe(D,X){let de=L();if(!de||P)return null;let E=await te(D,{...X,...z(),expected_revision:de.revision});if(me(E),r!==null&&E&&E.conflict){let Y=E.queue&&typeof E.queue.revision=="number"?E.queue.revision:L()?.revision??de.revision;E=await te(D,{...X,...z(),expected_revision:Y}),me(E)}return E}async function ye(){c=!0,Pe();try{let D=await te("get-session-defaults",{...z()});o=cn(D?.values)?{...D.values}:{},a={...o},i=Array.isArray(D?.warnings)?D.warnings:[]}catch(D){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${D instanceof Error?D.message:String(D)}`)}finally{c=!1,Pe()}}async function ce(){let D=Ju(o,a);if(Object.keys(D).length!==0){try{let X=await te("set-session-defaults",{values:D,...z()});o=cn(X?.values)?{...X.values}:{},a={...o},i=Array.isArray(X?.warnings)?X.warnings:[]}catch(X){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}Pe()}}function Ae(D,X){if(!cn(D))return;let de=D.state;u={state:de==="usable"||de==="unusable"||de==="absent"?de:"absent",values:cn(D.values)?{...D.values}:{},warnings:Array.isArray(D.warnings)?D.warnings:[]},g={...u.values},X&&(d={...g})}async function ve(){try{Ae(await te("get-workspace-accounts",{...z()}),!0)}catch(D){u={state:"unusable",values:{},warnings:["kv_read_failed"]},g={},d={},s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${D instanceof Error?D.message:String(D)}`)}Pe()}async function K(D){try{let X=await fetch(D);if(!X.ok)return null;let de=await X.json();if(!cn(de)||!Array.isArray(de.accounts))return null;let E=de.accounts.filter(Y=>cn(Y)&&typeof Y.key=="string"&&Y.key.length>0&&typeof Y.email=="string"&&Y.email.length>0);return{accounts:E,active:E.find(Y=>Y.active===!0)||null}}catch{return null}}async function oe(){A=!0;let[D,X]=await Promise.all([K("/api/claude-usage"),K("/api/codex-usage")]);P||(h={claude:D,codex:X},Pe())}function ue(){let D={};for(let X of th){let de=Object.hasOwn(d,X)?d[X]:null,E=Object.hasOwn(g,X)?g[X]:null;de!==E&&(D[X]=de)}return D}async function $e(){let D=ue();if(Object.keys(D).length!==0){try{Ae(await te("set-workspace-accounts",{values:D,...z()}),!1)}catch(X){s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}Pe()}}function He(D,X){X===Yt?delete d[D]:d[D]=X,Pe(),y=y.then(()=>$e())}function ge(D,X){if(eh.includes(D)){be(D,X);return}X===Yt?delete a[D]:a[D]=X,Pe(),ce()}function qe(){let D=vt().orchestration_model,X=ln({global:{orchestration_model:D??void 0},execution_defaults:Te(),runner_catalog:ne()}).orchestration_model.value;return X?En(ne(),X):null}function N(D,X){typeof X=="string"&&X.length>0?a[D]=X:delete a[D]}function be(D,X){let de=X===Yt?void 0:X,E=Xu({impl_runtime:D==="impl_runtime"?de:a.impl_runtime,impl_model:D==="impl_model"?de:a.impl_model,impl_effort:D==="impl_effort"?de:a.impl_effort},ne(),qe());N("impl_runtime",E.impl_runtime),N("impl_model",E.impl_model),N("impl_effort",E.impl_effort),Pe(),ce()}async function Oe(){let D=L();if(!D)return;let X={orchestration_model:D.orchestration_model??null,orchestration_effort:D.orchestration_effort??null,orchestration_speed:D.orchestration_speed??null},de=ed(X,{...X,...W});if(Object.keys(de).length!==0){try{let E=await xe("worker-queue-set-orchestration-defaults",{values:de});if(E&&E.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}W={}}catch(E){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${E instanceof Error?E.message:String(E)}`)}Pe()}}function We(D,X){W[D]=X===Yt?null:X,Pe(),Oe()}function ze(D){if(M=D,!D){Pe();return}let X=ne(),de=vt(),E=de.orchestration_model;E&&!xs(X,D).includes(E)&&(W.orchestration_model=null,E=null);let Y=de.orchestration_effort;Y&&!Oi(X,D,E||mn).includes(Y)&&(W.orchestration_effort=null),Pe(),Oe()}async function je(D){if(!(!L()||D<aa)){try{await xe("worker-queue-set-slots",{slots:D})}catch(X){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}Pe()}}async function Ge(D){if(!(!L()||D<aa||D>nh)){try{await xe("worker-queue-set-serial-lane-count",{count:D})}catch(X){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}Pe()}}async function Je(D,X){let de=D==="auto_advance"?"worker-automation-toggle":D==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await xe(de,{on:X})}catch(E){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${E instanceof Error?E.message:String(E)}`)}Pe()}function lt(){let D={},X=vt();for(let de of Fo){let E=zn.includes(de)?X[de]:a[de];typeof E=="string"&&E.length>0&&(D[de]=E)}return D}async function ft(){let D=ke();if(!D)return;let X=lt();if(Object.keys(X).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let de=(D.presets||[]).find(Y=>Y.id===Z),E=le.trim()||(de?de.name:"");if(!E){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let Y=de?await te("impl-preset-update",{expected_revision:D.revision,id:de.id,name:E,settings:X}):await te("impl-preset-create",{expected_revision:D.revision,name:E,settings:X});if(Y&&Y.applied){if(le="",!de&&Array.isArray(Y.presets)){let fe=Y.presets.find(x=>x.name===E);Z=fe?fe.id:Z}Pe()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Pe()}catch(Y){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${Y instanceof Error?Y.message:String(Y)}`)}}async function xt(){let D=ke();if(!(!D||Z.length===0))try{let X=await te("impl-preset-delete",{expected_revision:D.revision,id:Z});X&&X.applied?(Z="",Pe()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Pe())}catch(X){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}}function _t(D){o=cn(D.values)?{...D.values}:{},a={...o},i=Array.isArray(D.warnings)?D.warnings:[],cn(D.queue)&&(t.onQueueAdopt?.(D.queue),W={})}async function Q(){let D=ke(),X=L();if(!D||!X||Z.length===0)return;let de=E=>({preset_id:Z,expected_revision:D.revision,expected_queue_revision:E,...z()});try{let E=await te("apply-impl-preset-global",de(X.revision));if(E&&E.applied&&_t(E),r!==null&&E&&E.queue_applied===!1){let Y=E.queue&&typeof E.queue.revision=="number"?E.queue.revision:L()?.revision??X.revision;E=await te("apply-impl-preset-global",de(Y)),E&&E.applied&&_t(E)}E&&E.applied?E.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):E&&E.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(E){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${E instanceof Error?E.message:String(E)}`)}Pe()}async function ee(){B=!0,j=!1,Pe();try{let D=await te("get-worker-system-prompt",{});!D||typeof D!="object"||Array.isArray(D)?j=!0:G=D}catch{j=!0}finally{B=!1,Pe()}}function Re(){if(V=!V,V&&!G){ee();return}Pe()}function Ne(){let D=Br({loading:B,error:j});if(D)return D;if(!G)return"";let X=Array.isArray(G.variants)?G.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${V?Ne():""}
    </section>`}function Ie(D,X,de,E,Y,fe,x){let b=Y[D]??Yt,$=Li(D,de,Y,Te(),ne(),x),U=$.options.find(ae=>ae.value===b),se=b===Yt?$.full_value:U?.full_value;return l`<select
    ...
    >
    ...
    </div>`}function at(D,X){let de=X?X.active:null;return cn(de)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${D==="claude"?de.email:Hr({...de,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function nt(D,X,de){let E=h[de],Y=Object.hasOwn(d,D)?d[D]:Yt,fe=de==="claude"?Go:Hr,x=!!E?.accounts.some(b=>b.key===Y);return l`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${X}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${X}
    ...
    </div>`}function vt(){let D=L(),X={};for(let de of zn)X[de]=Object.prototype.hasOwnProperty.call(W,de)?W[de]:D&&typeof D[de]=="string"?D[de]:null;return X}function Ve(){let D=ne(),X=a.impl_runtime,de=a.impl_model,E=ke(),Y=L(),fe=vt(),x=xs(D,M),b=Wr(D,void 0).filter(Se=>Se!==mn),$=Oi(D,M,fe.orchestration_model||mn).filter(Se=>Se!==mn),U=Z?(E?.presets||[]).find(Se=>Se.id===Z):null,se=U?Qu(lt(),cn(U.settings)?U.settings:{}):null,ae=Y&&typeof Y.slots=="number"?Y.slots:aa+1,he=Y&&typeof Y.serial_lane_count=="number"?Y.serial_lane_count:aa,De=Te()?.supported===!0,tt=et(),rt=Li("workflow_mode",ks,a,Te(),D);return l`
      ...
      ${c?l`<div class="settings-dialog__empty">불러오는 중…</div>`:l`
            ...
            ${Ce()}
          `}
    `}function Pe(){P||Qe(Ve(),e)}return{load(){W={};let D=[ye(),ve()];return A||D.push(oe()),Promise.all(D).then(()=>{})},render:Pe,sessionDraft:()=>({...a}),destroy(){P=!0,Qe(l``,e)}}}function la(e){return l`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ...
    >
      ...
      >
        ${Nd()}
      </button>`}function ke(K){let oe=sh(K);return oe?l`<div class="mon2-deck__chips">
      ...
      ${oe.worker?l`<span class="mon2-deck__chip" title=${oe.worker.title}
          ...
          >`:""}
    </div>`:""}function z(K){let oe=[];for(let[ue,$e]of[["queue","\uB300\uAE30"],["pr_wait","PR"],["session_active","\uC138\uC158"]]){let He=Gi(K,ue);He>0&&oe.push(`${$e} ${He}`)}return oe.join(" \xB7 ")}function te(K){let oe=Gi(K,"running"),ue=typeof K.slots=="number"?K.slots:1;return l`<div
    ...
    </div>`}function me(K){let oe=t.doneItems?t.doneItems():[],ue=t.rangeLabel?t.rangeLabel():"",$e=Fd(Array.isArray(oe)?oe:[]),He=ge=>K.reduce((qe,N)=>qe+Gi(N,ge),0);return l`<div class="mon2-deck__bar">
      <span
...
${he.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""},Se=X(ae);return Object.hasOwn(Se,"blocked_by")&&(rt.blocked_by=Se.blocked_by),rt};for(let b=0;b<et.length;b++){let $=E(et[b],"queue",b,et.length);if(!$)continue;A.push($);let U=Z.get(be);U?U.push($):Z.set(be,[$])}let Y=b=>{let $=h.find(he=>he.id===b&&he.root_dir===be);if($)return{id:b,title:$.title,badge:"PR \uB300\uAE30 \xB7 \uC810\uC720"};let U=y.find(he=>he.id===b&&he.root_dir===be),se=U?U.run_state:xh(je,b),ae=se==="failed"||se==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":se==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720";return{id:b,title:U?U.title:D(b).title,badge:ae}},fe=[];for(let b=0;b<Math.max(mt,yt.length);b++){let $=`s${b+1}`,U=Mt.get($),se=U&&Array.isArray(U.entries)?U.entries:[],ae=Rt(Lt[$]),he=Array.isArray(ae.occupied_by)?ae.occupied_by.filter(rt=>typeof rt=="string"):[],De=new Set(he),tt=[];for(let rt=0;rt<se.length;rt++){let Se=se[rt]&&se[rt].bead_id;if(typeof Se=="string"&&De.has(Se)){de.add(Se);continue}let ct=E(se[rt],$,rt,se.length);ct&&(tt.push(ct),A.push(ct))}tt.length===0&&he.length===0&&(mt<=1||b>=mt)||fe.push({id:$,index:b,items:tt,raw_length:se.length,occupied_by:he,occupants:he.map(rt=>Y(rt)),corrections:Array.isArray(ae.corrections)?ae.corrections.length:0,cycle:ae.cycle===!0,...tt.length===0&&he.length===0?{empty:!0}:{}})}le.set(be,fe);let x=Array.from({length:mt},(b,$)=>{let U=`s${$+1}`,se=Mt.get(U),ae=se&&Array.isArray(se.entries)?se.entries:[],he=Rt(Lt[U]);return{id:U,index:ae.length,length:ae.length,occupied_by:Array.isArray(he.occupied_by)?he.occupied_by.filter(De=>typeof De=="string"):[]}});for(let b of Array.isArray(N.runnable)?N.runnable:[]){let $=b&&b.bead_id;if(typeof $!="string"||de.has($))continue;de.add($);let U=b.workflow&&typeof b.workflow=="object"?b.workflow:null,se=U&&typeof U.route=="string"&&U.route||(typeof b.route=="string"?b.route:null),ae=Eh(Rt(We),b.exec_pins,se);Array.isArray(b.blocked_by)&&b.blocked_by.length>0&&j.set($,b.blocked_by.filter(he=>typeof he=="string"&&he.length>0)),typeof b.title=="string"&&b.title.length>0&&L.set($,b.title),Array.isArray(b.scope)&&P.set($,b.scope.filter(he=>typeof he=="string"&&he.length>0)),g.push({...D($),title:b.title||Ge[$]||$,lane:"runnable",draggable:!0,reason:lp(ft,$),created_at:b.created_at??void 0,updated_at:b.updated_at??void 0,status:typeof b.status=="string"?b.status:void 0,labels:Array.isArray(b.labels)?b.labels:[],spec_id:typeof b.spec_id=="string"?b.spec_id:"",workflow:U||(se?{route:se,chips:{route:se}}:null),...ae?{exec_chips:ae}:{},blocked:b.blocked===!0,...Array.isArray(b.blocked_by)?{blocked_by:b.blocked_by.filter(he=>typeof he=="string"&&he.length>0)}:{},place_index:et.length,place_lanes:x})}for(let b of Ve){let $=b&&b.bead_id;if(typeof $!="string"||de.has($)||(de.add($),o!==void 0&&typeof b.added_at=="number"&&b.added_at<o))continue;let U=Ah(je,$),se=U&&typeof U.done_kind=="string"?U.done_kind:null;M.push({...D($),lane:"done",done:!0,done_layout:"three_line",usage:hn(je,$),work_ms:Qo(je,$),done_at:typeof b.added_at=="number"?b.added_at:void 0,done_kind:se,badges:[...se&&ip[se]?[ip[se]]:[],...Xo(je,$)]})}}let ne=new Map;s.forEach((N,be)=>{N&&typeof N.root_dir=="string"&&ne.set(N.root_dir,be)});let Te=n&&n.running_sort==="repo"?"repo":"started";y.sort((N,be)=>{let Oe=N.kind==="session",We=be.kind==="session";if(Oe!==We)return Oe?1:-1;if(Oe&&We){let Ge=ha(be.updated_at)-ha(N.updated_at);return Ge!==0?Ge:N.id.localeCompare(be.id)}if(Te==="repo"){let Ge=ne.get(N.root_dir)??Number.MAX_SAFE_INTEGER,Je=ne.get(be.root_dir)??Number.MAX_SAFE_INTEGER;if(Ge!==Je)return Ge-Je}let ze=typeof N.started_at=="number"&&Number.isFinite(N.started_at)?N.started_at:null,je=typeof be.started_at=="number"&&Number.isFinite(be.started_at)?be.started_at:null;return ze!==null&&je!==null&&ze!==je?ze-je:ze===null&&je!==null?1:ze!==null&&je===null?-1:N.id.localeCompare(be.id)}),M.sort((N,be)=>(be.done_at??0)-(N.done_at??0));let ke=s.length>0?s:r.map(N=>({root_dir:N&&N.root_dir,name:N&&N.name,auto_advance:N&&N.auto_advance,auto_merge:N&&N.auto_merge,slots:N&&N.slots,revision:N&&N.revision,runner_catalog:N&&N.runner_catalog})),z=new Set(g.map(N=>N.root_dir)),te=[];for(let N of ke){if(!N||typeof N.root_dir!="string")continue;let be=Z.get(N.root_dir)||[],Oe=le.get(N.root_dir)||[];!(be.length>0||Oe.some(ze=>ze.items.length>0||ze.occupied_by.length>0))&&!z.has(N.root_dir)||te.push({root_dir:N.root_dir,name:N.name||N.root_dir,auto_advance:N.auto_advance===!0,auto_merge:N.auto_merge===!0,slots:typeof N.slots=="number"&&N.slots>=ap?N.slots:ap,revision:typeof N.revision=="number"?N.revision:0,runner_catalog:Rt(N.runner_catalog),items:be,sublanes:{parallel:be,serial:Oe},serial_lane_count:V.get(N.root_dir)||0,raw_queue_length:B.get(N.root_dir)||0})}let me={runnable:g,runnable_all:g,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:c==="updated_flat",queue:A,queue_groups:te,running:y,pr_wait:h,done:M,parallel_rows:[],chain_lanes:[],cross_lanes_revision:i&&typeof i.revision=="number"?i.revision:null,cross_lanes_unreadable:i===null,parallel_raw_length:Object.fromEntries(B),owner_of:{}},xe=np(me);for(let N of W)xe.has(N.id)||xe.set(N.id,{root_dir:N.root_dir,workspace_name:N.workspace_name,lane:"done",state:"done"});for(let N of[...me.queue,...me.runnable,...me.running,...me.pr_wait]){if(!Object.hasOwn(N,"blocked_by"))continue;let be=xe.get(N.id);N.blockers=(N.blocked_by||[]).map(Oe=>rp(Oe,be,xe,s))}for(let N of[...me.queue,...me.runnable,...me.running,...me.pr_wait]){let be=(N.blockers||[]).map(We=>Ji(N.id,We));if(be.length===0)continue;let Oe={predecessors:be};N.dependency_chips=Oe}Oh(me,G,P,xe,s);let ye=sp(me.queue_groups);for(let N of me.queue_groups)for(let be of N.sublanes.serial){let Oe=ye.get(op(N.root_dir,be.id));Oe&&(be.cross_wait_peers=Oe)}me.chain_lanes=Ch(i&&Array.isArray(i.lanes)?i.lanes:[],j,xe,s,L,d);let ce=new Map;for(let N of[...me.queue,...me.runnable])ce.has(N.id)||ce.set(N.id,N);let Ae=new Set;for(let N of me.chain_lanes)for(let be of N.rows){if(N.status==="confirmed"&&!be.unplaced&&!be.fixed&&Ae.add(be.id),!N.draft&&!be.unplaced)continue;let Oe=ce.get(be.id);Oe&&(Oe.cross_lane_chip={lane_id:N.lane_id,number:N.number,status:N.status,label:N.draft?`\uC5F0\uACB0 ${N.number} (draft)`:`\uC5F0\uACB0 ${N.number}`})}let ve=[];for(let N of Z.values())for(let be of N)Ae.has(be.id)||ve.push(be);ve.sort((N,be)=>{let Oe=N.workspace_name.localeCompare(be.workspace_name);return Oe!==0?Oe:(N.queue_index??0)-(be.queue_index??0)}),me.parallel_rows=ve;let K={};for(let[N,be]of xe)typeof be.root_dir=="string"&&be.root_dir.length>0&&(K[N]=be.root_dir);for(let N of me.chain_lanes)for(let be of N.rows)!Object.hasOwn(K,be.id)&&be.root_dir.length>0&&d.has(be.root_dir)&&(K[be.id]=be.root_dir);me.owner_of=K;let oe=me.runnable.length;me.runnable_all=me.runnable.slice();let ue=me.runnable;a.show_blocked||(ue=ue.filter(N=>N.blocked!==!0));let $e=ue.length;a.spec==="with"?ue=ue.filter(N=>!!N.spec_id):a.spec==="without"&&(ue=ue.filter(N=>!N.spec_id)),me.runnable_hidden={blocked:oe-$e,spec:$e-ue.length};let He=(N,be)=>{let Oe=ha(be.updated_at)-ha(N.updated_at);return Oe!==0?Oe:N.id.localeCompare(be.id)},qe=c==="repo_spec"?(N,be)=>{let Oe=N.spec_id?0:1,We=be.spec_id?0:1;return Oe!==We?Oe-We:He(N,be)}:He;if(c==="updated_flat")me.runnable=ue.slice().sort(He),me.runnable_sections=[];else{let N=new Map;for(let We of ue){let ze=N.get(We.root_dir);ze?ze.push(We):N.set(We.root_dir,[We])}let be=[],Oe=[];for(let We of ke){if(!We||typeof We.root_dir!="string")continue;let ze=(N.get(We.root_dir)||[]).slice().sort(qe);N.delete(We.root_dir),ze.length!==0&&(be.push({root_dir:We.root_dir,name:We.name||We.root_dir,items:ze.map(je=>({...je,workspace_name:""}))}),Oe.push(...ze))}for(let[We,ze]of N){let je=ze.slice().sort(qe);be.push({root_dir:We,name:je[0]?.workspace_name||We,items:je.map(Ge=>({...Ge,workspace_name:""}))}),Oe.push(...je)}me.runnable=Oe,me.runnable_sections=be}return me}var dp="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function pp(e){return typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)?e.lane:e.lane==="running"&&e.serial_lane_id?e.serial_lane_id:null}function fp(e){return e.lane==="runnable"||e.lane==="queue"||typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)}var bp="bdui.monitor.done-range",hp="bdui.monitor.running_sort",yp="bdui.monitor.candidate_sort",vp="beads-ui.monitor.candidate-filter",wp="beads-ui.monitor.sections";function Lh(){try{let e=window.localStorage.getItem(vp);if(!e)return{...Kr};let t=JSON.parse(e);return!t||typeof t!="object"?{...Kr}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:Kr.show_blocked,spec:rl.some(n=>n.value===t.spec)?t.spec:"all"}}catch{return{...Kr}}}function _p(e){try{window.localStorage.setItem(vp,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Ih(){try{let e=window.localStorage.getItem(yp);return Ds.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function Ph(e){try{window.localStorage.setItem(yp,e)}catch{}}function Dh(){try{let e=window.localStorage.getItem(wp);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function mp(e){try{window.localStorage.setItem(wp,JSON.stringify(e))}catch{}}function Mh(){try{let e=window.localStorage.getItem(bp);return e===null?"today":Rn(e)}catch{return"today"}}function Nh(e){try{window.localStorage.setItem(bp,e)}catch{}}function qh(){try{return window.localStorage.getItem(hp)==="repo"?"repo":"started"}catch{return"started"}}function Fh(e){try{window.localStorage.setItem(hp,e)}catch{}}var kp="tab:monitor:pipeline",jh=1e3,Bh=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],gp="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function Uh(e){return e>=1&&e<=gp.length?gp[e-1]:`(${e})`}function $p(e,t){let n=Ot("views:monitor"),r=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.openDoc,c=t.switchWorkspace,u=t.router,d=t.now||(()=>Date.now()),g=t.confirm||(p=>typeof globalThis.confirm!="function"||globalThis.confirm(p)),y=Mh(),h=qh(),A=Lh(),M=Ih(),W=Dh(),Z=null,le=null,V=null,B=null,j=[],G=null;function P(){let p=Cr.find(m=>m.value===y);return p?p.label:""}let L=document.createElement("div");L.className="mon",e.appendChild(L);let ne=document.createElement("div");ne.className="worker-drawer-overlay",ne.hidden=!0;let Te=document.createElement("div");Te.className="worker-drawer-overlay__backdrop";let ke=document.createElement("div");ke.className="worker-drawer-host mon2-drawer",ne.append(Te,ke),e.appendChild(ne);let z=sl(null,null),te=new Map,me=new Map,xe=null,ye=null,ce=null,Ae=Ur(ke,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{Z=null,ne.hidden=!0,fe()}});async function ve(p,m,w,S,J=!0){if(!o||!w)return null;let H=await o(p,{...m,root_dir:w,expected_revision:S});if(H&&H.conflict&&J){H.queue&&me.set(w,H.queue);let v=H.queue&&typeof H.queue.revision=="number"?H.queue.revision:S;H=await o(p,{...m,root_dir:w,expected_revision:v})}return H&&H.queue&&w&&me.set(w,H.queue),H}function K(p,m){let w=me.get(p),S=s&&s.get?s.get():null,J=(Array.isArray(S)?S:[]).find(v=>v?.root_dir===p);return(w||J)?.merge_queue?.find(v=>v.bead_id===m)?.continuation_action}async function oe(p,m,w,S){let J=await ve(p,m,w,S),H=me.get(w)?.revision??J?.queue?.revision??S;return qn(J,(v,O)=>ve(p,{...m,continuation:v,decision_token:O},w,H,!1),{refresh:v=>ve(p,m,w,v?.queue?.revision??me.get(w)?.revision??H,!1)})}async function ue(p,m,w,S){let J=await qn({continuation_mismatch:S},(v,O)=>ve("worker-merge-queue-add",{bead_id:m,continuation:v,decision_token:O},p,w,!1)),H=J?.queue?.merge_queue?.find(v=>v.bead_id===m)?.continuation_action;J?.applied!==!0&&H?.continuation===null&&H.mismatch&&await ue(p,m,J.queue.revision,H.mismatch)}async function $e(p,m,w){let S=await ve("worker-discard",p,m,w);if(S&&S.discarded===!0){pe(ea(S),"success",5e3);return}if(S&&S.reason){pe(`\uD3D0\uAE30 \uC2E4\uD328: ${S.reason}`,"error");return}if(S&&S.accepted&&S.pending==="merged_revert"){pe("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(S&&S.accepted){pe(`\uD3D0\uAE30 \uC9C4\uD589: ${S.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}S&&!S.conflict&&pe("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function He(p,m,w){return!o||!w?null:await o(p,{...m,root_dir:w})}async function ge(){let p=new Map;for(let m of z.pr_wait)p.has(m.root_dir)||p.set(m.root_dir,m.expected_revision);for(let[m,w]of p)await ve("worker-merge-queue-add-all",{},m,w)}function qe(p){let m=W[p];return!!(m&&m.runnable===!0)}function N(p){let m={...W[p]||{}};m.runnable=!m.runnable,W={...W,[p]:m},mp(W),fe()}function be(p){return W[p]===!0}function Oe(p){W={...W,[p]:W[p]!==!0},mp(W),fe()}function We(p){let m=z.queue_groups.find(w=>w.root_dir===p);if(!m)return null;for(let w=0;w<m.serial_lane_count;w+=1){let S=`s${w+1}`,J=m.sublanes.serial.find(H=>H.id===S);if(!J||J.raw_length===0&&J.occupied_by.length===0)return S}return null}function ze(p,m){let w=z.queue_groups.find(J=>J.root_dir===p),S=w?w.sublanes.serial.find(J=>J.id===m):void 0;return S?S.raw_length:0}function je(p,m){let w=te.get(p),S=te.get(m);if(!w||!S)return{kind:"note",text:"\uC0C1\uB300\uC758 \uD604\uC7AC \uC704\uCE58\uB97C \uC54C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"};let J=pp(w),H=pp(S);if(J!==null&&J===H&&w.root_dir===S.root_dir)return{kind:"note",text:"\uC774\uBBF8 \uAC19\uC740 \uC9C1\uB82C \uB808\uC778 \u2014 \uC21C\uC11C\uAC00 \uC788\uC2B5\uB2C8\uB2E4"};let v=fp(w),O=fp(S);if(v&&H!==null){let C=H;return{kind:"ops",title:`${C} \uB05D\uC5D0 ${p}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:S.root_dir,ops:[{bead_id:p,lane:C,index:ze(S.root_dir,C)}]}}if(J!==null&&O&&H===null){let C=J;return{kind:"ops",title:`${C} \uB05D\uC5D0 ${m}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:w.root_dir,ops:[{bead_id:m,lane:C,index:ze(w.root_dir,C)}]}}if(v&&J===null&&O&&H===null){let C=We(w.root_dir);return C===null?{kind:"disabled",title:"\uBE48 \uC9C1\uB82C \uB808\uC778 \uC5C6\uC74C \u2014 Worker \uD0ED\uC5D0\uC11C \uB808\uC778 \uC218 \uC870\uC808"}:{kind:"ops",title:`${C} \uB808\uC778\uC5D0 ${m} \u2192 ${p} \uC21C\uC11C\uB85C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:w.root_dir,ops:[{bead_id:m,lane:C,index:0},{bead_id:p,lane:C,index:1}]}}return!v&&!O?{kind:"note",text:"\uB458 \uB2E4 \uC2E4\uD589 \uC911 \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"}:v?{kind:"note",text:"\uC2E4\uD589 \uC911 \u2014 \uC885\uB8CC \uD6C4 \uCD9C\uBC1C\uD558\uB824\uBA74 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694"}:{kind:"note",text:"\uC2E4\uD589 \uC911 \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4\uB824\uBA74 \uC0C1\uB300\uB97C \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694"}}function Ge(p,m){let w=je(p,m.id);return{id:m.id,title:m.title,location_label:m.location_label,prefixes:m.prefixes,action:w.kind==="note"?{kind:"note",text:w.text}:w.kind==="disabled"?{kind:"disabled",label:dp,title:w.title}:{kind:"place",label:dp,title:w.title}}}function Je(p,m){if(!V||V.bead_id!==p)return null;let w=V.counterpart_id,S=m.filter(J=>J.id===w);return S.length===0?null:{rows:S.map(J=>Ge(p,J))}}function lt(p){let m=p.dependency_chips||null,w=p.overlap_chips||[],S=p.scope_state==="missing",J=p.cross_lane_chip;if(!m&&w.length===0&&!S&&!J)return null;let H=Je(p.id,w);return{...m||{},...w.length>0?{overlaps:w}:{},...S?{scope_missing:!0}:{},...J?{cross_lane:{lane_id:J.lane_id,label:J.label}}:{},...H?{popover:H}:{}}}function ft(p){let m=lt(p);return m?{...p,dependency_chips:m}:p}async function xt(p,m){let w=je(p,m);if(V=null,w.kind!=="ops"){fe();return}let S=un(w.root_dir,w.ops[0].bead_id);for(let J of w.ops){let H=await _t(J,w.root_dir,S);if(H===null)break;S=H}fe()}async function _t(p,m,w){try{let S=await ve("worker-queue-place",p,m,w,!1);if(S&&S.conflict)return pe("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!S||S.applied!==!0)return pe(S&&typeof S.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${S.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let J=S.queue?S.queue.revision:void 0;return typeof J!="number"?(pe("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):J}catch(S){return pe(De(S),"error"),null}}function Q(p){let m=qe(p.root_dir);return l`<header class="mon2-sec__hd">
    ...
    >
      ${m}
    </div>`}function Re(p){if(le!==p.id)return null;let m=z.queue_groups.find(H=>H.root_dir===p.root_dir),w=p.place_lanes||[],S=z.cross_lanes_revision!==null,J=[{id:"parallel",label:"\uBCD1\uB82C",count:p.place_index??0}];for(let H of z.chain_lanes)J.push({id:`lane:${H.lane_id}`,label:`\uC5F0\uACB0 ${H.number} (${H.draft?"draft":"\uD655\uC815"}) \uB05D\uC5D0`,count:H.rows.length,group:"\uC5F0\uACB0 \uB808\uC778",disabled:!S});J.push({id:"new-lane",label:"+ \uC0C8 \uC5F0\uACB0 \uB808\uC778",group:"\uC5F0\uACB0 \uB808\uC778",disabled:!S,title:S?"\uC774 \uC774\uC288\uB9CC \uB4E0 draft \uB808\uC778\uC744 \uB9CC\uB4ED\uB2C8\uB2E4":"\uC5F0\uACB0 \uB808\uC778 \uC800\uC7A5\uC18C\uB97C \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"});for(let H of w)J.push({id:`serial:${H.id}`,label:`\uC9C1\uB82C ${Number(H.id.slice(1))}`,count:H.length,group:`${m?m.name:""} \uC9C1\uB82C`});return{bead_id:p.id,lanes:J}}function Ne(){let p=[],m=new Set,w=(S,J)=>{for(let H of S)m.has(H.id)||(m.add(H.id),p.push({bead_id:H.id,root_dir:H.root_dir,workspace_name:H.workspace_name,title:H.title,lane:J}))};return w(z.running,"running"),w(z.pr_wait,"pr_wait"),w(z.queue,"queue"),w(z.runnable_all,"runnable"),p}function Ce(p){if(!B||B.bead_id!==p)return"";let m=ct(),w=Ne(),S=new Map;for(let O of w)S.set(O.bead_id,O);let J=(m.get(p)||[]).filter(O=>S.has(O)),H=Vd(Kd(p,{issues:w,blocked_by_map:m}),B.query),v=z.owner_of[p];return l`<div
      class="mon-deppanel"
      data-bead-id=${p}
      role="dialog"
      aria-label="의존성"
    ...
    </div>`}function Ie(p){return ee(p,l`${Fi(ft(p),Re(p),{exec_chips_mode:"pinned_only",dep_action:!0,onOpenDoc:i?(m,w)=>i(w,p.root_dir):void 0})}${Ce(p.id)}`)}function Fe(){return z.runnable_flat?l`<div class="mon2-flat" data-drop="candidate">
    ...
    >
      ${vn({id:"",lane:m.id,title:`${p.name} \xB7 \uC9C1\uB82C ${m.index+1}`,items:m.items,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uB4DC\uB798\uADF8\uB85C \uBC30\uCE58",body:l`<div
        ...
        >
          ...
          ${m.items.length>0?m.items.map((w,S)=>Lt(m,w,S)):m.occupants.length>0?"":l`<div class="worker-pane__empty">
                  비어 있음 — 드래그로 배치
                </div>`}
...
`):""}
    ...
    >
      ...
      <div class="worker-lanes mon2-lanes">
        ${Bh.map(w=>{let S=m[w.lane],J=w.lane==="runnable"?z.runnable_flat?S.length>0?Fe():void 0:z.runnable_sections.length>0?Fe():void 0:w.lane==="queue"?z.queue_groups.length>0||z.chain_lanes.length>0||z.parallel_rows.length>0?Pe():void 0:w.lane==="running"?D(p):S.length>0?l`${S.map(H=>Jn(H))}`:void 0;return vn({id:`monitor-${w.lane}`,lane:w.pane,title:w.lane==="done"?`\uC644\uB8CC\xB7${P()}`:w.title,items:S,empty:w.empty,body:J,live:w.lane==="running"&&S.length>0,controls:w.lane==="runnable"?de():void 0,header_control:E(w.lane,S.length)})})}
      ...
      </select>`:""}function Y(p){let m=s&&s.get?s.get():null,w=s&&s.getWorkspacesState?s.getWorkspacesState():[],S=p===void 0?s&&s.crossLanes?s.crossLanes():void 0:p,J={done_since:dr(y,d()),running_sort:h,candidate_filter:A,candidate_sort:M};return S!==void 0&&(J.cross_lanes=S),sl(m,w,J)}function fe(){let p=d();z=Y(),te=new Map;for(let m of[...z.runnable,...z.queue,...z.running,...z.pr_wait,...z.done])!m.non_occupying&&!te.has(m.id)&&te.set(m.id,m);Qe(X(p),L),b()?.render(),x(),$()}function x(){let p=new Map;for(let m of z.queue_groups)p.set(m.root_dir,m.auto_advance);for(let m of Array.from(L.querySelectorAll(".mon2-parallel .worker-mini__repo"))){let w=m.closest(".mon2-item")?.getAttribute("data-root-dir")||"",S=p.get(w);typeof S=="boolean"&&m.setAttribute("title",`${m.textContent||""} \xB7 ${S?"\uC790\uB3D9\uD654 \uCF1C\uC9D0":"\uC790\uB3D9\uD654 \uAEBC\uC9D0"}`)}}function b(){if(ce)return ce;let p=L.querySelector(".mon2-deck");return p?(ce=jd(p,{workspacesState:()=>s&&s.getWorkspacesState?s.getWorkspacesState():[],doneItems:()=>z.done,rangeLabel:P,transport:o,implPresetStore:t.execPresetStore,gotoWorkerTab:se,onFocusChange:m=>{G=m,$()}}),ce):null}function $(){L.classList.toggle("has-focus",G!==null);for(let p of Array.from(L.querySelectorAll(".mon2-sec[data-root-dir]")))p.classList.toggle("is-focus",G!==null&&p.getAttribute("data-root-dir")===G);for(let p of Array.from(L.querySelectorAll(".mon2-item[data-bead-id], .rtile[data-bead-id], .worker-mini[data-bead-id], .worker-card[data-bead-id]"))){let m=te.get(p.getAttribute("data-bead-id")||"");p.classList.toggle("is-focus",G!==null&&!!m&&m.root_dir===G)}for(let p of Array.from(L.querySelectorAll(".mon2-crow[data-root-dir]")))p.classList.toggle("is-focus",G!==null&&p.getAttribute("data-root-dir")===G)}function U(p,m){let w=a?a():void 0;if(!m||!w||m===w||!c){r(p);return}c(m).then(()=>{r(p)}).catch(S=>{n("workspace switch for %s failed: %o",m,S)})}function se(p){if(!p)return;let m=a?a():void 0,w=()=>{try{u?.gotoView("worker")}catch(S){n("gotoView(worker) failed: %o",S)}};if(!c||m&&m===p){w();return}c(p).then(w).catch(S=>{n("workspace switch for %s failed: %o",p,S),pe("\uB808\uD3EC \uC804\uD658\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error")})}function ae(p){fn(p).then(m=>{pe(m?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",m?"success":"error",1400)})}function he(p){let m=te.get(p)||null;return{item:m,root_dir:m?m.root_dir:"",revision:m?m.expected_revision:0}}function De(p){if(typeof p=="string"&&p.length>0)return p;if(p&&typeof p=="object"){let m=p;if(typeof m.message=="string"&&m.message.length>0)return m.message;if(typeof m.error=="string"&&m.error.length>0)return m.error;if(m.error&&typeof m.error=="object"&&typeof m.error.message=="string")return m.error.message}return"\uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4"}async function tt(p,m,w){let S=z.owner_of[m];if(typeof S!="string"||S.length===0){pe(`${m}\uC758 \uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4`,"error");return}try{await He(p,{a:m,b:w},S)}catch(J){pe(De(J),"error")}fe()}function rt(p){return z.runnable.some(m=>m.id===p)||z.parallel_rows.some(m=>m.id===p)?!0:z.queue_groups.some(m=>m.sublanes.serial.some(w=>w.items.some(S=>S.id===p)))}function Se(p){!p||!rt(p)||(B=B&&B.bead_id===p?null:{bead_id:p,query:""},fe())}function ct(){let p=new Map,m=s&&s.get?s.get():null,w=S=>Array.isArray(S)?S.filter(J=>typeof J=="string"&&J.length>0):[];for(let S of Array.isArray(m)?m:[]){if(!S||typeof S!="object")continue;let J=S.bead_blocked_by&&typeof S.bead_blocked_by=="object"?S.bead_blocked_by:{};for(let[H,v]of Object.entries(J))Array.isArray(v)&&p.set(H,w(v));for(let H of[...Array.isArray(S.runnable)?S.runnable:[],...Array.isArray(S.session_active)?S.session_active:[]])H&&typeof H.bead_id=="string"&&Array.isArray(H.blocked_by)&&H.blocked_by.length>0&&p.set(H.bead_id,w(H.blocked_by))}return p}function Nt(){let p=ct();for(let m of j){let w=(p.get(m.a)||[]).slice();m.type==="dep-remove"?p.set(m.a,w.filter(S=>S!==m.b)):w.includes(m.b)||p.set(m.a,[...w,m.b])}return p}function Et(p=z){let m=new Map,w=new Map,S=new Set,J=new Set;for(let v of p.chain_lanes){m.set(v.lane_id,{status:v.status,entries:v.rows.map(O=>({bead_id:O.id,root_dir:O.root_dir}))});for(let O of v.rows)w.set(O.id,v.lane_id),O.fixed&&S.add(O.id),O.unplaced||J.add(O.id)}let H=new Map;for(let v of p.parallel_rows)typeof v.queue_index=="number"&&H.set(v.id,v.queue_index);for(let v of p.queue_groups)for(let O of v.sublanes.serial)for(let C of O.items)typeof C.queue_index=="number"&&H.set(C.id,C.queue_index);return{blocked_by_map:Nt(),owner_of:new Map(Object.entries(p.owner_of)),cross_lanes:m,owner_lane_of:w,fixed_members:S,placed_members:J,parallel_rows:p.parallel_rows.map(v=>({bead_id:v.id,root_dir:v.root_dir,queue_index:v.queue_index??0})),parallel_raw_length:new Map(Object.entries(p.parallel_raw_length)),queue_index_of:H}}function un(p,m){let w=te.get(m);if(w&&w.root_dir===p)return w.expected_revision;let S=z.queue_groups.find(J=>J.root_dir===p);return S?S.revision:0}async function Ht(p,m,w){try{if(p.type==="worker-queue-place"||p.type==="worker-queue-reorder"||p.type==="worker-queue-remove"){let S=await ve(p.type,p.payload,p.root_dir,w.get(p.root_dir)??un(p.root_dir,m));return!S||typeof S.applied!="boolean"?(pe("\uD050 \uC694\uCCAD\uC774 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error"),!1):(S.queue&&typeof S.queue.revision=="number"&&w.set(p.root_dir,S.queue.revision),S.conflict?(pe("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),!1):S.applied===!1?(pe(S.admission_reason?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${S.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),!1):!0)}return(p.type==="dep-add"||p.type==="dep-remove")&&await He(p.type,{a:p.a,b:p.b},p.root_dir),!0}catch(S){return pe(De(S),"error"),!1}}function Ut(p){(p.type==="dep-add"||p.type==="dep-remove")&&(j=[...j,{type:p.type,a:p.a,b:p.b}])}async function Zt(p,m){if(!o)return{ok:!1};try{let w=await o(p.type,{...p.payload,expected_revision:m});return!w||typeof w.revision!="number"?(pe("\uC5F0\uACB0 \uB808\uC778 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),{ok:!1}):{ok:!0,revision:w.revision}}catch(w){let S=w,J=S&&S.code==="conflict"?S.details?.cross_lanes:null;return J&&typeof J.revision=="number"&&Array.isArray(J.lanes)?{ok:!1,conflict:J}:(pe(De(w),"error"),{ok:!1})}}async function zt(p,m,w){let S=new Map,J=p.ops.slice(0,p.lane_op_index),H=p.ops.slice(p.lane_op_index);for(let O of J){if(!await Ht(O,w,S))return{done:!0};Ut(O)}let v=m;for(let O of p.lane_ops){if(v===null)return pe("\uC5F0\uACB0 \uB808\uC778 \uC800\uC7A5\uC18C\uB97C \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error"),{done:!0};let C=await Zt(O,v);if(!C.ok)return C.conflict?{done:!1,conflict:C.conflict}:{done:!0};v=C.revision}for(let O of H){if(!await Ht(O,w,S))return{done:!0};Ut(O)}return{done:!0}}async function gt(p,m){j=[];let w=z;for(let S=0;;S+=1){let J=p(Et(w));if("refused"in J){pe(J.refused,"error");break}let H=await zt(J,w.cross_lanes_revision,m);if(H.done)break;if(S>=1){pe("\uB808\uC778\uC774 \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4","error");break}w=Y(H.conflict)}j=[],fe()}async function Ke(p,m){await gt(w=>Yi(p,m,w),p.bead_id)}async function dn(p,m){if(p==="create"){await gt(w=>Zi(null,w),"");return}if(p==="remove"){let w=z.chain_lanes.find(S=>S.lane_id===m);if(w&&!w.draft){let S=w.rows.filter((J,H)=>H===0?!1:!J.mismatch).length;if(!g(`\uC758\uC874 ${S}\uAC1C\uB97C \uD568\uAED8 \uC81C\uAC70\uD569\uB2C8\uB2E4`))return}await gt(S=>Gd(m,S),"");return}await gt(w=>p==="confirm"?zd(m,w):Hd(m,w),"")}async function tn(p,m){let w=te.get(p);if(!w){fe();return}let S={kind:"candidate",bead_id:p,root_dir:w.root_dir};if(m==="new-lane"){await gt(J=>Zi({bead_id:p,root_dir:w.root_dir},J),p);return}if(m.startsWith("lane:")){let J=m.slice(5);if(!z.chain_lanes.find(v=>v.lane_id===J)){fe();return}await gt(v=>Yi(S,{kind:"chain",lane_id:J,marker_index:(v.cross_lanes.get(J)?.entries??[]).length},v),p);return}if(m.startsWith("serial:")){let J=m.slice(7),H=(w.place_lanes||[]).find(v=>v.id===J);await Ke(S,{kind:"repo-serial",root_dir:w.root_dir,lane_id:J,index:H?H.index:0});return}await Ke(S,{kind:"parallel",marker_index:z.parallel_rows.length})}async function ot(p,m){let w=z.parallel_rows,S=w.findIndex(we=>we.id===p);if(S<0)return;let J=w[S].root_dir,H=[];w.forEach((we,st)=>{we.root_dir===J&&H.push(st)});let v=H.indexOf(S),O=H[v+m];if(typeof O!="number")return;let C=m===-1?O:H[v+2]??Math.min(w.length,O+1);await Ke({kind:"parallel",bead_id:p,root_dir:J,queue_index:w[S].queue_index??0},{kind:"parallel",marker_index:C})}async function Le(p){for(let m of z.chain_lanes){let w=m.rows.find(S=>S.id===p);if(w){await Ke({kind:"chain",bead_id:p,root_dir:w.root_dir,lane_id:m.lane_id,...typeof w.queue_index=="number"?{queue_index:w.queue_index}:{}},{kind:"parallel",marker_index:z.parallel_rows.length});return}}}let R=null,_e=!1,Ee=null;function dt(){Ee!==null&&clearTimeout(Ee),Ee=setTimeout(()=>{Ee=null,_e=!1},0)}function At(p,m){let w=m&&typeof m.closest=="function"?m.closest("[data-row-index]"):null;if(w&&p.contains(w)){let S=Number(w.getAttribute("data-row-index"));return Number.isFinite(S)?S:0}return p.querySelectorAll("[data-row-index]").length}function ht(p){let m=p.target,w=typeof m?.closest=="function"?m.closest("[data-drop]"):null;if(!w||!R)return null;let S=w.getAttribute("data-drop");if(S==="candidate")return{zone:w,target:{kind:"candidate"}};if(S==="parallel")return{zone:w,target:{kind:"parallel",marker_index:At(w,m)}};if(S==="chain")return{zone:w,target:{kind:"chain",lane_id:w.getAttribute("data-lane-id")||"",marker_index:At(w,m)}};if(S==="repo-serial"){let J=w.getAttribute("data-root-dir")||"";if(J!==R.root_dir)return null;let H=typeof m?.closest=="function"?m.closest("[data-queue-index]"):null,v=H&&w.contains(H)?H.getAttribute("data-queue-index"):w.getAttribute("data-lane-length"),O=Number(v);return{zone:w,target:{kind:"repo-serial",root_dir:J,lane_id:w.getAttribute("data-lane-id")||"",index:Number.isFinite(O)?O:0}}}return null}function Pt(){for(let p of Array.from(L.querySelectorAll(".is-drop-over")))p.classList.remove("is-drop-over")}function jt(p){let m=p.target,w=typeof m?.closest=="function"?m.closest('[draggable="true"][data-bead-id]'):null,S=w?w.closest("[data-drag-kind]"):null;if(!S)return;let J=S.getAttribute("data-bead-id")||"",H=S.getAttribute("data-drag-kind")||"",v=S.getAttribute("data-root-dir")||"";if(!J||!H||!v)return;let O=S.getAttribute("data-queue-index")||"",C=Number(O),we=S.getAttribute("data-lane-id")||"";R={kind:H,bead_id:J,root_dir:v,...O!==""&&Number.isFinite(C)?{queue_index:C}:{},...we?{lane_id:we}:{}},_e=!0,le=null,L.classList.add("is-dragging");try{p.dataTransfer?.setData("text/plain",J),p.dataTransfer&&(p.dataTransfer.effectAllowed="move")}catch{}}function Gt(p){let m=ht(p);m&&(p.preventDefault(),p.dataTransfer&&(p.dataTransfer.dropEffect="move"),m.zone.classList.add("is-drop-over"))}function nn(p){let m=p.target;typeof m?.closest=="function"&&m.closest("[data-drop]")?.classList.remove("is-drop-over")}function Tt(){R=null,Pt(),L.classList.remove("is-dragging"),dt()}function rn(p){let m=ht(p),w=R;R=null,Pt(),L.classList.remove("is-dragging"),!(!m||!w)&&(p.preventDefault(),Ke(w,m.target))}function gn(p){return{runner:p.runner||void 0,model:p.model||void 0,effort:p.effort||void 0,status:p.run_state==="running"?"running":p.run_state,worktree:p.root_dir}}function Pn(p,m){let{item:w,root_dir:S,revision:J}=he(m),H=w?.attempt_id||"",v=p.classList;if(v.contains("mon2-rowops__up")||v.contains("mon2-rowops__down")){ot(m,v.contains("mon2-rowops__up")?-1:1);return}if(v.contains("mon2-rowops__remove")){ve("worker-queue-remove",{bead_id:m},S,J);return}if(v.contains("mon2-crow__detach")){Le(m);return}if(v.contains("mon-dep__btn")){Se(m);return}if(v.contains("worker-dep__open")){Se(m);return}if(v.contains("mon-lane__chip")){let O=p.getAttribute("data-lane-id")||"";L.querySelector(`.mon2-clane[data-lane-id="${O}"]`)?.scrollIntoView({block:"nearest"});return}if(v.contains("mon-deppanel__unlink")){let O=p.getAttribute("data-dep-a")||"",C=p.getAttribute("data-dep-b")||"";g(`${C}\uAC00 ${O}\uB97C \uB9C9\uB294 \uC5F0\uACB0\uC744 \uB04A\uC744\uAE4C\uC694?`)&&tt("dep-remove",O,C);return}if(v.contains("mon-deppanel__cand")){let O=p.getAttribute("data-dep-cand")||"";B&&O&&tt("dep-add",B.bead_id,O);return}if(v.contains("mon-overlap__chip")){let O=p.getAttribute("data-overlap-id")||"";V=!!V&&V.bead_id===m&&V.counterpart_id===O?null:{bead_id:m,counterpart_id:O},fe();return}if(v.contains("mon-overlap__place")){xt(m,p.getAttribute("data-counterpart-id")||"");return}if(v.contains("worker-card__place")){le=le===m?null:m,fe();return}if(v.contains("worker-card__place-cancel")){le=null,fe();return}if(v.contains("worker-card__place-lane")){let O=p.getAttribute("data-lane")||"parallel";le=null,tn(m,O);return}if(v.contains("rtile__session")){if(w&&w.kind==="session"){let O=(w.session_refs||[]).find(C=>C&&C.current===!0);O&&(ne.hidden=!1,Ae.open(wo(O,m,"in_progress",S)),fe());return}Z=H,H&&w&&(ne.hidden=!1,Ae.open({attempt_id:H,root_dir:S,meta:gn(w)})),fe();return}if(v.contains("rtile__pause")){He("worker-attempt-pause",{attempt_id:H},S);return}if(v.contains("rtile__resume")){Nr().then(O=>{if(O!==null)return oe("worker-attempt-resume",{attempt_id:H,...O!==""?{instructions:O}:{}},S,J)});return}if(v.contains("rtile__dismiss")){ve("worker-attempt-dismiss",{attempt_id:H},S,J);return}if(v.contains("rtile__discard")){if(!g(Cs(m,"unmerged")))return;$e({bead_id:m,...H?{attempt_id:H}:{},...p.dataset.operationId?{operation_id:p.dataset.operationId}:{}},S,J);return}if(v.contains("worker-mini__merge")){let O=K(S,m);O?.mismatch&&O.continuation===null?ue(S,m,J,O.mismatch):ve("worker-merge-queue-add",{bead_id:m},S,J);return}if(v.contains("worker-mini__merge-cancel")){ve("worker-merge-queue-remove",{bead_id:m},S,J);return}if(v.contains("worker-mini__discard")){let O=p.dataset.discardMode==="merged"?"merged":"unmerged";if(!g(Cs(m,O)))return;$e({bead_id:m,...p.dataset.attemptId?{attempt_id:p.dataset.attemptId}:{},...p.dataset.operationId?{operation_id:p.dataset.operationId}:{}},S,J);return}if(v.contains("worker-mini__revise-fix")){oe("worker-revise-fix",{bead_id:m},S,J);return}v.contains("worker-mini__revise-approve")&&ve("worker-revise-approve",{bead_id:m},S,J)}function T(p){let m=_e;_e=!1;let w=p.target;if(!w||typeof w.closest!="function"||w.closest("dialog")||w.closest(".worker-drawer-overlay")||w.closest("a"))return;let S=w.closest(".worker-card__id, .worker-mini__id, .rtile__id");if(S){p.preventDefault();let Xe=w.closest(".mon2-item, .rtile, .mon2-crow, .worker-mini")?.getAttribute("data-bead-id")||S.textContent?.trim()||"";Xe&&ae(Xe);return}let J=w.closest(".worker-mini__repo, .worker-card__repo, .mon2-sec__worker");if(J){p.preventDefault();let it=J.getAttribute("data-root-dir")||te.get(w.closest(".mon2-item, .rtile, .worker-mini")?.getAttribute("data-bead-id")||"")?.root_dir||J.getAttribute("title")||"";se(it);return}let H=w.closest(".mon2-sec__toggle");if(H){p.preventDefault(),N(H.getAttribute("data-root-dir")||"");return}let v=w.closest(".mon2-area__toggle");if(v){p.preventDefault(),Oe(v.getAttribute("data-area")||"parallel");return}if(w.closest(".mon2-newlane")){p.preventDefault(),dn("create","");return}let O=w.closest(".mon2-clane__confirm, .mon2-clane__reapply, .mon2-clane__remove");if(O){p.preventDefault();let it=O.getAttribute("data-lane-id")||"";dn(O.classList.contains("mon2-clane__confirm")?"confirm":O.classList.contains("mon2-clane__reapply")?"reapply":"remove",it);return}if(w.closest(".mon-merge-all")){p.preventDefault(),ge();return}let C=w.closest(".mon-filter__spec");if(C){p.preventDefault(),A={...A,spec:C.getAttribute("data-spec")||"all"},_p(A),fe();return}let we=w.closest(".mon2-item, .rtile, .mon2-crow, .worker-mini, .worker-card");if(!we)return;let st=we.getAttribute("data-bead-id")||"",Ye=w.closest("button");if(Ye){p.preventDefault(),Pn(Ye,st);return}st&&!m&&(p.preventDefault(),U(st,we.getAttribute("data-root-dir")||he(st).root_dir))}function I(p){let m=p.target;if(!m||typeof m.closest!="function")return;let w=m.closest(".mon-filter__blocked");if(w){A={...A,show_blocked:w.checked},_p(A),fe();return}let S=m.closest(".mon-candidate-sort");if(S){M=Ds.some(v=>v.value===S.value)?S.value:"repo_spec",Ph(M),fe();return}let J=m.closest(".mon-running-sort");if(J){h=J.value==="repo"?"repo":"started",Fh(h),fe();return}let H=m.closest(".mon-done-range");H&&(y=Rn(H.value),Nh(y),fe())}function Me(p){let m=p.target,w=m&&typeof m.closest=="function"?J=>m.closest(J):()=>null,S=!1;V&&!w(".mon-overlap__popover, .mon-overlap__chip")&&(V=null,S=!0),B&&!w(".mon-deppanel, .mon-dep__btn, .worker-dep__open")&&(B=null,S=!0),S&&fe()}function f(p){p.key!=="Escape"||!V&&!B||(V=null,B=null,fe())}function k(p){let m=p.target;!m||typeof m.closest!="function"||!m.closest(".mon-deppanel__search")||!B||(B={...B,query:m.value},fe())}e.addEventListener("click",T),e.addEventListener("change",I),e.addEventListener("input",k),document.addEventListener("click",Me),document.addEventListener("keydown",f),e.addEventListener("dragstart",jt),e.addEventListener("dragover",Gt),e.addEventListener("dragleave",nn),e.addEventListener("drop",rn),e.addEventListener("dragend",Tt),s&&typeof s.subscribe=="function"&&(xe=s.subscribe(()=>{try{me.clear(),fe()}catch{}}));function q(){ye!==null&&(clearInterval(ye),ye=null)}function re(){Ee!==null&&(clearTimeout(Ee),Ee=null)}return{load(){n("load"),fe(),ye===null&&(ye=setInterval(()=>{try{fe()}catch{}},jh))},pause(){q()},clear(){q(),re(),xe&&(xe(),xe=null),Ae.destroy(),ne.hidden=!0,ce?.destroy(),ce=null,e.removeEventListener("click",T),e.removeEventListener("change",I),e.removeEventListener("input",k),document.removeEventListener("click",Me),document.removeEventListener("keydown",f),e.removeEventListener("dragstart",jt),e.removeEventListener("dragover",Gt),e.removeEventListener("dragleave",nn),e.removeEventListener("drop",rn),e.removeEventListener("dragend",Tt),e.replaceChildren()}}}function xp(e,t,n){let r=Ot("views:nav"),{global_element:s,repo_element:o}=e,a=null;function i(y){return h=>{h.preventDefault();let A=y==="monitor"&&c()==="monitor"?"worker":y;r("click tab %s",A),n.gotoView(A)}}function c(){let y=t.getState();return y.view==="worker"||y.view==="monitor"?y.view:"board"}function u(){let y=c();return l`
      <a
        href="#/monitor"
  ...
  `}var Hh=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function Lp(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(te=>pe(te,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,u="",d=null;function g(){if(d)return d;let te=a.querySelector('[data-pane="execution"]');return te?(d=ia(te,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:me=>t.queueStore?.set?.(me)}),d):null}function y(){return l`
    ...
    </span>`}function j(ye,ce,Ae){let ve=Bp(ce,Ae),K=ce.available&&(ce.held||ve>ol),oe=K?`${Math.floor(ve/60)}\uBD84 \uC804 \uCE21\uC815`:"",ue=ce.accounts.filter(qe=>!qe.active).length,$e=`usage-meter__group${K?" usage-meter__group--stale":""}`,He=l`<span class="usage-meter__provider"
        >${ye.label}</span
      >
    ...
    </span>`}function P(ye,ce){let Ae=Np(ye.pct),ve=Dp(ye.resetsAt,ce);return l`<span
    ...
    >
      ...
      <span class="usage-meter__account-reset"
        >${ve.length>0?`\u21BB ${ve}`:""}</span
      >
    </span>`}function L(ye,ce){return Zh.includes(ce)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${ye.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function ne(ye,ce,Ae){let ve=ce.status==="ok",K=typeof ce.ageSeconds=="number"&&ce.ageSeconds>ol,oe=a.get(Fp(ye.key,ce.number)),ue=r.get(ye.key),$e=ue!==void 0,He=ue===ce.number,ge=["usage-meter__account"];return ce.active&&ge.push("usage-meter__account--active"),ve||ge.push("usage-meter__account--unavailable"),K&&ge.push("usage-meter__account--stale"),l`<div class=${ge.join(" ")}>
    ...
    >
      ...
      >`:x.is_default===!0?l`<span class="pa-settings__default">기본값</span>`:""}function ft(x){return x.is_default===!0&&x.compatible===!1}function xt(x){return!!(x.runner&&x.model&&x.effort)}function _t(x){return xt(x)&&x.compatible!==!1}function Q(x){let b=Math.max(0,Math.floor(x/1e3)),$=Math.floor(b/60),U=b%60;return`${$}:${String(U).padStart(2,"0")}`}function ee(x){let b=x.job;if(b){let $=typeof b.started_at=="number"?b.started_at:0,U=`${b.runner||"?"}/${b.model||"?"}`,se=$?` \xB7 \uACBD\uACFC ${Q(Date.now()-$)}`:"",ae=typeof b.session_id=="string"?b.session_id:"",he=P(x).find(De=>De.run_id===b.job_id);return l`<span class="pa-meta__progress">
        ...
        >`:""}function Re(x){let b=ee(x);return b===""?"":l`<div class="pa__strip">${b}</div>`}function Ne(){return r?.isPending?.()===!0}function Ce(x){let b=!!x.job,$=_t(x.settings),U=h!==null&&A.size===0,se=b||d||Ne()||M;return l`<div class="pa-meta">
    ...
    </div>`}function Ie(x){return typeof x=="string"&&x.length>0?x:"\uBBF8\uBC30\uCE58"}function Fe(x,b){b?A.add(x):A.delete(x),Ve()}function at(x){let b=Array.isArray(x.scope)?x.scope:[],$=Array.isArray(x.overlaps)?x.overlaps:[];return b.length===0&&$.length===0?l``:l`<span class="pa-target__signals">
...
${kt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:F==="done"?hn(f.attempts||{},ie.bead_id):null,work_ms:F==="done"?Qo(f.attempts||{},ie.bead_id):null,done_at:F==="done"&&typeof ie.added_at=="number"?ie.added_at:void 0,exec_chips:Ze?C(ie.bead_id):null,workflow:Ze&&Hn[ie.bead_id]||null,from_id:it.get(ie.bead_id)||void 0,priority:Xe.get(ie.bead_id),...or(ie.bead_id)}}),$r=f.attempts?Object.values(f.attempts).filter(yr):[],xa=new Set;for(let _ of $r)_&&typeof _.resumed_from=="string"&&_.resumed_from.length>0&&xa.add(_.resumed_from);let wl=new Map;for(let _ of $r)wl.set(_.bead_id,_.attempt_id);let Zr=new Map;for(let _ of $r)Zr.set(_.attempt_id,_);function Aa(_){let F=new Set,ie=_;for(;ie&&!F.has(ie.attempt_id);){if(ie.conflict_resolution===!0)return!0;F.add(ie.attempt_id),ie=typeof ie.resumed_from=="string"&&ie.resumed_from.length>0&&Zr.get(ie.resumed_from)||null}return!1}let js=typeof f.declared_base=="string"?f.declared_base:null;function Ff(_){let F=null;for(let ie of $r)!ie||ie.bead_id!==_||Aa(ie)||(F===null||(typeof ie.started_at=="number"?ie.started_at:0)>=(typeof F.started_at=="number"?F.started_at:0))&&(F=ie);return F&&typeof F.target_base=="string"?F.target_base:null}let Sa=[],Bs=[],jf=Wp(f),kl=_=>{let F=typeof _.session_id=="string"&&_.session_id.length>0,ie=xa.has(_.attempt_id);return{eligible:F&&!ie,reason:F?ie?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},wn=null;for(let _ of $r){let F=_.status==="paused"&&!xa.has(_.attempt_id);if(_.status==="running"||F)Bs.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:Ye.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,paused:F,conflict_resolution:Aa(_),base_exception:dl(js,_.target_base),can_pause:typeof _.session_id=="string"&&_.session_id.length>0,discard:Tn(Fs,_.bead_id,{attempt_id:_.attempt_id}),workflow:Hn[_.bead_id]||null,priority:Xe.get(_.bead_id),usage:hn(f.attempts||{},_.bead_id),rollup:we(_.bead_id),rollup_expanded:xe.has(_.bead_id),exec_chips:v(_),...or(_.bead_id)});else if((_.status==="failed"||_.status==="orphaned")&&jf(_)){let ie=kl(_);Sa.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:Ye.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,failed:!0,status:_.status,status_label:_.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Tn(Fs,_.bead_id,{attempt_id:_.attempt_id}),resume_eligible:ie.eligible,resume_reason:ie.reason,conflict_resolution:Aa(_),base_exception:dl(js,_.target_base),workflow:Hn[_.bead_id]||null,priority:Xe.get(_.bead_id),usage:hn(f.attempts||{},_.bead_id),rollup:we(_.bead_id),rollup_expanded:xe.has(_.bead_id),exec_chips:v(_),...or(_.bead_id)}),wn=_}}let $l=new Set([...Sa,...Bs].map(_=>_.bead_id)),xl=new Map;for(let _ of Array.isArray(f.session_active)?f.session_active:[]){let F=_&&_.bead_id;if(!(typeof F!="string"||F.length===0||$l.has(F))){if($l.add(F),Array.isArray(_.blocked_by)){let ie=_.blocked_by.filter(Ue=>typeof Ue=="string"&&Ue.length>0);ie.length>0&&xl.set(F,ie)}Bs.push({bead_id:F,attempt_id:null,kind:"session",title:_.title||Ye.get(F)||F,status:"in_progress",started_at:On(_.started_at)??On(_.updated_at),updated_at:On(_.updated_at),workflow:_.workflow||null,priority:Xe.get(F),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,usage:null,rollup:null,rollup_expanded:!1})}}let xr=[...Sa,...Bs].map(_=>{let F=Zr.get(_.attempt_id),ie=F?.quickfix_landing;if(F?.quickfix_lane!==!0||!ie||typeof ie!="object")return _;let Ue=typeof ie.reason=="string"&&ie.reason.length>0?ie.reason:null,Ze=Ps({bead_id:F.bead_id,merge_sha:ie.head_sha,cleanup_cursor:ie.cursor,cleanup_failed:Ue?{step:ie.cursor,reason:Ue}:null,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]});return Ze?{..._,landing:Ze}:_}),Al=null;if(wn){let _=kl(wn),F=wn.cause_detail;Al={bead_id:wn.bead_id,repo:wn.repo||"",reason:wn.cause||wn.status,cause_detail:F&&typeof F.reason=="string"?{reason:F.reason,command:typeof F.command=="string"?F.command:null}:null,resume_attempt_id:wn.attempt_id,resume_eligible:_.eligible,resume_reason:_.reason,discard:Tn(Fs,wn.bead_id,{attempt_id:wn.attempt_id})}}let Sl=new Set(xr.map(_=>_.bead_id)),Ea=Array.isArray(f.merge_queue)?f.merge_queue:[],El=new Map,Tl=new Map,Cl=new Map,Rl=new Map,Ol=new Map;Ea.forEach((_,F)=>{_&&typeof _.bead_id=="string"&&(El.set(_.bead_id,F+1),Tl.set(_.bead_id,_.resolution),Cl.set(_.bead_id,_.continuation_action||null),Rl.set(_.bead_id,_.head_review||null),Ol.set(_.bead_id,_.authority||null))});let Ar=f.merge_queue_state||{active:null,failures:{}},Bf=Ar.failures||{},Ll=Ar.waiting&&typeof Ar.waiting.bead_id=="string"&&typeof Ar.waiting.reason=="string"?Ar.waiting:null,Uf=f.auto_merge_skips||{},Il=_=>{let F=Uf[_];if(!F)return null;let ie=Yr[_],Ue=ie&&ie.pr?ie.pr.head_sha:null;return Ue&&Ue===F.head_sha?F.reason||"":null},Us=new Map;for(let _ of xr)_.failed!==!0&&_.conflict_resolution&&(_.paused?Us.has(_.bead_id)||Us.set(_.bead_id,"paused"):Us.set(_.bead_id,"running"));let Pl=xr.filter(_=>_.kind!=="session"&&!_.paused&&_.failed!==!0).length,Dl=(f.workspace_info||{}).slots,Ml=typeof Dl=="number"?Dl:typeof f.slots=="number"?f.slots:ya,Wf=Pl>Ml,Ws=dr(G),zf=(Array.isArray(f.done)?f.done.slice():[]).filter(_=>Ws===void 0||typeof _.added_at!="number"||_.added_at>=Ws).sort((_,F)=>(F.added_at||0)-(_.added_at||0)),Xr=$a(zf,"done"),Hf=new Set((Array.isArray(f.done)?f.done:[]).map(_=>_?.bead_id).filter(_=>typeof _=="string")),Nl=[],Gf=u?.()||"";for(let _ of re){let F=On(_.closed_at);if(typeof _.id!="string"||Hf.has(_.id)||F===null||Ws!==void 0&&F<Ws||typeof _.comment_count!="number"||_.comment_count<=0)continue;let ie=`${Gf}\0${_.id}\0${String(_.updated_at)}\0${_.comment_count}`,Ue=P.get(ie);Ue===void 0&&n&&(P.set(ie,"pending"),Promise.resolve(n("get-comments",{id:_.id})).then(Ze=>{let Dt=Array.isArray(Ze)&&Ze.some(kt=>No(typeof kt?.text=="string"?kt.text:"")?.lane==="session");P.set(ie,Dt?"session":"not-session"),Ke()}).catch(()=>{P.set(ie,"failed"),Ke()})),Ue==="session"&&Nl.push({id:_.id,title:_.title||_.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:F,created_at:_.created_at,updated_at:_.updated_at})}Xr.push(...Nl),Xr.sort((_,F)=>(F.done_at||0)-(_.done_at||0));let zs={};for(let _ of In)zs[_]=0;let ql=!1,Fl=0,Ta=0,jl=0;for(let _ of Xr){let F=_.usage;if(F&&typeof F=="object"){let ie=!1;for(let Ue of In)Number.isFinite(F[Ue])&&(zs[Ue]+=F[Ue],ql=!0,ie=!0);ie&&(Ta+=1,Number.isFinite(F.total_cost_usd)&&(Fl+=F.total_cost_usd,jl+=1))}}Ta>0&&jl===Ta&&(zs.total_cost_usd=Fl);let Bl=Xr.map(_=>_.usage).filter(_=>_&&typeof _=="object"&&_.providers),Kf=Bl.length>0?Vt($o(Bl)):ql?Fn(zs):null,Ul=f.lane_states&&typeof f.lane_states=="object"&&!Array.isArray(f.lane_states)?f.lane_states:{},Wl=Array.isArray(f.serial_lanes)?f.serial_lanes:[],zl=_=>{if(Dn.some(Ue=>Ue.bead_id===_))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let F=$r.filter(Ue=>Ue&&Ue.bead_id===_),ie=F.length>0?F[F.length-1].status:null;return ie==="failed"||ie==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":ie==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},Hs=Wl.filter(_=>_&&typeof _.id=="string"&&Array.isArray(_.entries)).map((_,F)=>{let ie=Ul[_.id]||{},Ue=new Map((Array.isArray(ie.corrections)?ie.corrections:[]).filter($t=>$t&&typeof $t.bead_id=="string"&&typeof $t.after=="string").map($t=>[$t.bead_id,$t.after])),Ze=Array.isArray(ie.occupied_by)?ie.occupied_by.filter($t=>typeof $t=="string"):[],Dt=new Set(Ze),kt=$a(_.entries.filter($t=>!Sl.has($t.bead_id)&&!Dt.has($t.bead_id)),_.id).map($t=>Ue.has($t.id)?{...$t,badges:[`\u{1F517} ${Ue.get($t.id)} \uB4A4 (blocks \uC790\uB3D9)`,...$t.badges]}:$t),Sr=Ze.map($t=>({id:$t,title:Ye.get($t)||$t,draggable:!1,lane:_.id,ghost:!0,badges:[zl($t)]}));return{id:_.id,index:F+1,rows:[...Sr,...kt],occupied:Ze.length>0,badge:Ze.length>0?zl(Ze[0]):"\uB300\uAE30",cycle:ie.cycle===!0}}),Hl=typeof f.serial_lane_count=="number"?f.serial_lane_count:Hs.length,Ca=$a(va.filter(_=>!Sl.has(_.bead_id)),"queue"),Gl=new Map,Kl=new Set;for(let[_,F]of Object.entries(Ul)){if(!/^s[1-5]$/.test(_))continue;let ie=F&&Array.isArray(F.occupied_by)?F.occupied_by:[];for(let Ue of ie)typeof Ue=="string"&&Gl.set(Ue,_);ie.length>0&&Kl.add(_)}let Kn=[];for(let _ of xr)typeof _.bead_id=="string"&&Kn.push({id:_.bead_id,title:Ye.get(_.bead_id)||_.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:Gl.get(_.bead_id)??null});for(let _ of Dn){let F=_&&_.bead_id;typeof F!="string"||F.length===0||Kn.push({id:F,title:Ye.get(F)||F,location_label:"PR \uB300\uAE30",kind:"pr_wait",lane_id:null})}for(let _ of Hs)for(let F of _.rows)F.ghost!==!0&&Kn.push({id:F.id,title:F.title,location_label:`${_.id} #${F.seq??""}`.trim(),kind:"serial",lane_id:_.id});Ca.forEach((_,F)=>{Kn.push({id:_.id,title:_.title,location_label:`#${F+1}`,kind:"parallel",lane_id:null})});for(let _ of ka)Kn.push({id:_.id,title:_.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let Vl={};for(let _ of Wl)_&&typeof _.id=="string"&&Array.isArray(_.entries)&&(Vl[_.id]=_.entries.length);let Ra=new Map;for(let _ of Kn)Ra.has(_.id)||Ra.set(_.id,_);B={members_by_id:Ra,serial_raw_lengths:Vl,serial_lane_count:Hl,occupied_lanes:Kl};let Vf=Yp(f.bead_scope,Kn),Gs=new Map;for(let[_,F]of xl)Gs.set(_,F);for(let[_,F]of vl)Gs.set(_,F);for(let[_,F]of Object.entries(qs))Array.isArray(F)&&Gs.set(_,F.filter(ie=>typeof ie=="string"&&ie.length>0));let Yf=tp(Gs,Kn),Oa=(_,F=null)=>{let ie=Vf.get(_),Ue=Yf.get(_)||null,Ze=ie&&ie.overlaps.length>0?ie.overlaps:null,Dt=!!ie&&ie.scope_missing;if(!Ue&&!Ze&&!Dt)return F;let kt=Ze?he(_,Ze):null;return{...F||{},interactive:!1,...Ue?{predecessors:Ue}:{},...Ze?{overlaps:Ze}:{},...Dt?{scope_missing:!0}:{},...kt?{popover:kt}:{}}},La=_=>{let F=Oa(_.id,_.dependency_chips||null);return F&&(_.dependency_chips=F),_};for(let _ of Ca)La(_);for(let _ of Hs)for(let F of _.rows)F.ghost!==!0&&La(F);for(let _ of ka)La(_);let Yl=new Map;for(let _ of xr){let F=typeof _.bead_id=="string"?_.bead_id:"";if(F.length===0)continue;let ie=_.kind==="session",Ue=Oa(F),Ze=typeof _.attempt_id=="string"&&_.attempt_id.length>0?Zr.get(_.attempt_id):void 0,Dt=Ze&&Ze.last_activity&&typeof Ze.last_activity=="object"?Ze.last_activity:null,kt=Ze&&Array.isArray(Ze.legs)?Ze.legs:[];!Ue&&!Dt&&kt.length===0&&!ie||Yl.set(F,{...Dt?{last_activity:Dt}:{},...kt.length>0?{legs:kt}:{},...Ue?{dependency_chips:Ue}:{}})}let Zf=Dn.map(_=>ov(_.bead_id,Ye.get(_.bead_id)||_.bead_id,Yr,pt[_.bead_id]||null,hn(f.attempts||{},_.bead_id),Be[_.bead_id]||(ke.has(_.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:z.has(_.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),Us.get(_.bead_id)||null,_.external===!0,{position:El.get(_.bead_id)||0,active:Ar.active===_.bead_id,failure:Bf[_.bead_id]||null,waiting:Ll?.bead_id===_.bead_id?Ll.reason:null,resolution:Tl.get(_.bead_id),continuation_action:Cl.get(_.bead_id),head_review:Rl.get(_.bead_id)||null,authority:Ol.get(_.bead_id)||null},_.wt_present!==!1,f.auto_merge===!0?Il(_.bead_id):null,dl(js,Ff(_.bead_id)),f.completion_status&&typeof f.completion_status=="object"&&!Array.isArray(f.completion_status)&&f.completion_status[_.bead_id]||null,f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},Zr.get(wl.get(_.bead_id)||"")?.worker_serial===!0,f.auto_merge===!0,{merge_sha:_.merge_sha,cleanup_cursor:_.cleanup_cursor,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]},Oa(_.bead_id))).map(_=>({..._,workflow:Hn[_.id]||null,priority:Xe.get(_.id),...or(_.id)}));return{queue:f,idToTitle:Ye,candidates:ka,candidate_hidden:{blocked:wa.hidden_blocked,spec:wa.hidden_spec},running:xr,live_count:Pl,slots:Ml,over_cap:Wf,failure:Al,waiting:Ca,serial_lanes:Hs,serial_lane_count:Hl,running_overlays:Yl,pr_wait:Zf,merge_queue_length:Ea.length,merge_queue_running:Ea.length>0,auto_excluded:Dn.map(_=>_.bead_id).filter(_=>Il(_)!==null),declared_base:js,done:Xr,token_total:Kf,cleanup_failures:pn,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]}}function Se(){let k=!!o?.get()?.job,q=!k&&o?.isPending?.()===!0,re=k?"\uBD84\uC11D \uC911":q?"\uC900\uBE44 \uC911":"";return l`<button
    ...
    >`,S=l`<label class="worker-tgl worker-slots"
      ...
      ${o?Se():""} `,J=Ld({failure:f.failure}),H=xd(f.repo_operations,f.cleanup_failures);return Te?l`<div class="worker-ribbon">
          ${q} ${re}
    ...
    `}function B(){let G=t.getState(),P=G.workspace?.current,L=G.workspace?.available||[],ne=new Set(G.workspace?.hidden||[]),Te=P?.path||L[0]?.path||"";if(L.length===0)return l``;let ke=L.filter(z=>!ne.has(z.path)||z.path===Te);if(ke.length<=1){let z=ke[0]||L[0],te=_l(z.path);return l`
