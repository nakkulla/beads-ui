...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+ut(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},Lt=new al;function ae(t,e){return Lt.parse(t,e)}ae.options=ae.setOptions=function(t){return Lt.setOptions(t),ae.defaults=Lt.defaults,uo(ae.defaults),ae};ae.getDefaults=En;ae.defaults=It;ae.use=function(...t){return Lt.use(...t),ae.defaults=Lt.defaults,uo(ae.defaults),ae};ae.walkTokens=function(t,e){return Lt.walkTokens(t,e)};ae.parseInline=Lt.parseInline;ae.Parser=at;ae.parser=at.parse;ae.Renderer=Pr;ae.TextRenderer=Nn;ae.Lexer=it;ae.lexer=it.lex;ae.Tokenizer=Nr;ae.Hooks=dr;ae.parse=ae;var gd=ae.options,md=ae.setOptions,_d=ae.use,bd=ae.walkTokens,wd=ae.parseInline;var kd=at.parse,yd=it.lex;function vo(t){let e=ae.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",l="";function a(v){v.key==="Escape"&&s&&(v.preventDefault(),k())}document.addEventListener("keydown",a);function d(){return s?u`
