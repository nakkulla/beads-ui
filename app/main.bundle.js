...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Nl=/'/g,ql=/"/g,Bl=/^(?:script|style|textarea|title)$/i,Xi=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),c=Xi(1),yo=Xi(2),dw=Xi(3),vn=Symbol.for("lit-noChange"),Pt=Symbol.for("lit-nothing"),jl=new WeakMap,hr=br.createTreeWalker(br,129);function Ul(e,t){if(!Vi(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Pl!==void 0?Pl.createHTML(t):t}var Wl=(e,t)=>{let n=e.length-1,r=[],o,s=t===2?"<svg>":t===3?"<math>":"",i=_o;for(let l=0;l<n;l++){let a=e[l],u,d,f=-1,g=0;for(;g<a.length&&(i.lastIndex=g,d=i.exec(a),d!==null);)g=i.lastIndex,i===_o?d[1]==="!--"?i=Dl:d[1]!==void 0?i=Ml:d[2]!==void 0?(Bl.test(d[2])&&(o=RegExp("</"+d[2],"g")),i=gr):d[3]!==void 0&&(i=gr):i===gr?d[0]===">"?(i=o??_o,f=-1):d[1]===void 0?f=-2:(f=i.lastIndex-d[2].length,u=d[1],i=d[3]===void 0?gr:d[3]==='"'?ql:Nl):i===ql||i===Nl?i=gr:i===Dl||i===Ml?i=_o:(i=gr,o=void 0);let m=i===gr&&e[l+1].startsWith("/>")?" ":"";s+=i===_o?a+l_:f>=0?(r.push(u),a.slice(0,f)+Ki+a.slice(f)+Fn+m):a+Fn+(f===-2?l:m)}return[Ul(e,s+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},bo=class e{constructor({strings:t,_$litType$:n},r){let o;this.parts=[];let s=0,i=0,l=t.length-1,a=this.parts,[u,d]=Wl(t,n);if(this.el=e.createElement(u,r),hr.currentNode=this.el.content,n===2||n===3){let f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(o=hr.nextNode())!==null&&a.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(let f of o.getAttributeNames())if(f.endsWith(Ki)){let g=d[i++],m=o.getAttribute(f).split(Fn),k=/([.?@])?(.*)/.exec(g);a.push({type:1,index:s,name:k[2],strings:m,ctor:k[1]==="."?ms:k[1]==="?"?gs:k[1]==="@"?hs:vr}),o.removeAttribute(f)}else f.startsWith(Fn)&&(a.push({type:6,index:s}),o.removeAttribute(f));if(Bl.test(o.tagName)){let f=o.textContent.split(Fn),g=f.length-1;if(g>0){o.textContent=fs?fs.emptyScript:"";for(let m=0;m<g;m++)o.append(f[m],go()),hr.nextNode(),a.push({type:2,index:++s});o.append(f[g],go())}}}else if(o.nodeType===8)if(o.data===Yi)a.push({type:2,index:s});else{let f=-1;for(;(f=o.data.indexOf(Fn,f+1))!==-1;)a.push({type:7,index:s}),f+=Fn.length-1}s++}}static createElement(t,n){let r=br.createElement("template");return r.innerHTML=t,r}};function yr(e,t,n=e,r){if(t===vn)return t;let o=r!==void 0?n._$Co?.[r]:n._$Cl,s=ho(t)?void 0:t._$litDirective$;return o?.constructor!==s&&(o?._$AO?.(!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=o:n._$Cl=o),o!==void 0&&(t=yr(e,o._$AS(e,t.values),o,r)),t}var _s=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,o=(t?.creationScope??br).importNode(n,!0);hr.currentNode=o;let s=hr.nextNode(),i=0,l=0,a=r[0];for(;a!==void 0;){if(i===a.index){let u;a.type===2?u=new Dr(s,s.nextSibling,this,t):a.type===1?u=new a.ctor(s,a.name,a.strings,this,t):a.type===6&&(u=new bs(s,this,t)),this._$AV.push(u),a=r[++l]}i!==a?.index&&(s=hr.nextNode(),i++)}return hr.currentNode=br,o}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},Dr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,o){this.type=2,this._$AH=Pt,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=yr(this,t,n),ho(t)?t===Pt||t==null||t===""?(this._$AH!==Pt&&this._$AR(),this._$AH=Pt):t!==this._$AH&&t!==vn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Fl(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Pt&&ho(this._$AH)?this._$AA.nextSibling.data=t:this.T(br.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=bo.createElement(Ul(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(n);else{let s=new _s(o,this),i=s.u(this.options);s.p(n),this.T(i),this._$AH=s}}_$AC(t){let n=jl.get(t.strings);return n===void 0&&jl.set(t.strings,n=new bo(t)),n}k(t){Vi(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,o=0;for(let s of t)o===n.length?n.push(r=new e(this.O(go()),this.O(go()),this,this.options)):r=n[o],r._$AI(s),o++;o<n.length&&(this._$AR(r&&r._$AB.nextSibling,o),n.length=o)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},vr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,o,s){this.type=1,this._$AH=Pt,this._$AN=void 0,this.element=t,this.name=n,this._$AM=o,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Pt}_$AI(t,n=this,r,o){let s=this.strings,i=!1;if(s===void 0)t=yr(this,t,n,0),i=!ho(t)||t!==this._$AH&&t!==vn,i&&(this._$AH=t);else{let l=t,a,u;for(t=s[0],a=0;a<s.length-1;a++)u=yr(this,l[r+a],n,a),u===vn&&(u=this._$AH[a]),i||(i=!ho(u)||u!==this._$AH[a]),u===Pt?t=Pt:t!==Pt&&(t+=(u??"")+s[a+1]),this._$AH[a]=u}i&&!o&&this.j(t)}j(t){t===Pt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ms=class extends vr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Pt?void 0:t}},gs=class extends vr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Pt)}},hs=class extends vr{constructor(t,n,r,o,s){super(t,n,r,o,s),this.type=5}_$AI(t,n=this){if((t=yr(this,t,n,0)??Pt)===vn)return;let r=this._$AH,o=t===Pt&&r!==Pt||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,s=t!==Pt&&(r===Pt||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},bs=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){yr(this,t)}},zl={M:Ki,P:Fn,A:Yi,C:1,L:Wl,R:_s,D:Fl,V:yr,I:Dr,H:vr,N:gs,U:hs,B:ms,F:bs},c_=mo.litHtmlPolyfillSupport;c_?.(bo,Dr),(mo.litHtmlVersions??(mo.litHtmlVersions=[])).push("3.3.1");var st=(e,t,n)=>{let r=n?.renderBefore??t,o=r._$litPart$;if(o===void 0){let s=n?.renderBefore??null;r._$litPart$=o=new Dr(t.insertBefore(go(),s),s,void 0,n??{})}return o._$AI(e),o};var ys="today",Hl=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}],Mr=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"}];function Dn(e){return e==="today"?"today":"7d"}function Qi(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function wr(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function Gl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Kl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Yl(){let e=null,t=[],n,r=new Set;function o(){for(let s of Array.from(r))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},crossLanes(){return n},set(s,i,l){e=Array.isArray(s)?s:null,t=Array.isArray(i)?i:[],n=l===void 0?void 0:l!==null&&typeof l=="object"&&typeof l.revision=="number"&&Array.isArray(l.lanes)?{revision:l.revision,lanes:l.lanes}:null,o()},clear(){e=null,t=[],n=void 0,o()},subscribe(s){return r.add(s),()=>r.delete(s)}}}function Vl(){let e=new Map,t=new Set;function n(o){return o.startsWith("session-log:")?o:`session-log:${o}`}function r(){for(let o of Array.from(t))try{o()}catch{}}return{set(o,s,i=null){e.set(n(o),{lines:Array.isArray(s)?[...s]:[],last_event_at:typeof i=="number"?i:null}),r()},append(o,s){let i=n(o),l=e.get(i)||{lines:[],last_event_at:null};l.lines=[...l.lines,s],l.last_event_at=Date.now(),e.set(i,l),r()},get(o){return e.get(n(o))||null},clear(o){typeof o=="string"?e.delete(n(o)):e.clear(),r()},subscribe(o){return t.add(o),()=>t.delete(o)}}}var tc=a_(ec(),1);function Ot(e){return(0,tc.default)(`beads-ui:${e}`)}function k_(e){let n=nc((e&&typeof e=="object"?e:{}).spec_id);return n?{path:n,source:"native",conflict:!1}:{path:"",source:"none",conflict:!1}}function nc(e){return typeof e=="string"?e.trim():""}function $_(e){let t=e&&typeof e=="object"?e:{};return t.metadata&&typeof t.metadata=="object"?t.metadata:{}}var x_=/^[A-Za-z0-9_.:-]+@[0-9a-fA-F]{40}$/;function Fr(e){let t=k_(e),n=nc($_(e).spec_review),r=x_.test(n),o=r&&n.slice(0,n.indexOf("@"))==="skipped";return t.source==="none"?{...t,evidence:"none",skipped:o}:{...t,evidence:r?"published":"draft",skipped:o}}function xn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function vo(e,t){let n=xn(e.created_at),r=xn(t.created_at);if(n!==r)return n<r?1:-1;let o=e.priority??2,s=t.priority??2;if(o!==s)return o-s;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function lc(e,t){let n=xn(e.created_at),r=xn(t.created_at);if(n!==r)return n<r?-1:1;let o=e.priority??2,s=t.priority??2;if(o!==s)return o-s;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function cc(e,t){let n=xn(e.updated_at),r=xn(t.updated_at);if(n!==r)return n<r?1:-1;let o=e.id,s=t.id;return o<s?-1:o>s?1:0}function uc(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let o=xn(e.created_at),s=xn(t.created_at);if(o!==s)return o<s?1:-1;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function dc(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let o=e?.id,s=t?.id;return o<s?-1:o>s?1:0}var ks=Object.freeze({priority:"asc",dependents:"desc",released:"desc",spec:"desc",created:"asc",updated:"desc"});function A_(e){return typeof e=="string"&&Object.prototype.hasOwnProperty.call(ks,e)}function Ji(e){if(!e||typeof e!="object")return!1;let t=e;return A_(t.key)&&(t.dir==="asc"||t.dir==="desc")}function rc(e){if(typeof e=="number")return Number.isFinite(e)?e:null;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:null}return null}function oc(e,t){switch(t){case"priority":{let n=e.priority;return typeof n=="number"&&Number.isFinite(n)?n:null}case"dependents":{let n=e.dependents_info?e.dependents_info.count:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"released":{let n=e.release_info?e.release_info.last_released_at:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"spec":return Fr(e).evidence==="published"?1:0;case"created":return rc(e.created_at);case"updated":return rc(e.updated_at);default:return null}}function sc(e,t,n){let r=oc(e,n.key),o=oc(t,n.key);if(r===null||o===null)return r===o?0:r===null?1:-1;if(r===o)return 0;let s=r<o?-1:1;return n.dir==="desc"?-s:s}function pc(e){let t=Array.isArray(e)?e.filter(Ji):[];return(n,r)=>{for(let l of t){let a=sc(n,r,l);if(a!==0)return a}let o=sc(n,r,{key:"created",dir:"asc"});if(o!==0)return o;let s=n.id,i=r.id;return s<i?-1:s>i?1:0}}var S_=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function ic(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function ac(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=S_.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function fc(e,t){let n=ic(e),r=ic(t);if(n!==r)return n<r?-1:1;let o=ac(e),s=ac(t);if(o!==s)return o<s?-1:1;let i=xn(e&&e.created_at),l=xn(t&&t.created_at);if(i!==l)return i<l?-1:1;let a=e&&e.id,u=t&&t.id;return a===u?0:String(a)<String(u)?-1:1}var Zi=2**20;function Br(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-xn(e&&e.created_at)}function _c(e){return(t,n)=>{let r=Br(t,e),o=Br(n,e);if(r!==o)return r<o?-1:1;let s=t?.id,i=n?.id;return s<i?-1:s>i?1:0}}function ea(e,t,n){let r=Array.isArray(e)?e:[],o=r.length,s=Math.max(0,Math.min(t,o-1)),i=s-1>=0?r[s-1]:null,l=s+1<o?r[s+1]:null;if(!i&&!l)return{rank:0};if(!i)return{rank:Br(l,n)-Zi};if(!l)return{rank:Br(i,n)+Zi};let a=Br(i,n),u=Br(l,n),d=(a+u)/2;return a<d&&d<u?{rank:d}:{renormalize:r.map((f,g)=>({bead_id:f.id,rank:g*Zi}))}}function ta(e,t={}){let n=Ot(`issue-store:${e}`),r=new Map,o=[],s=0,i=new Set,l=!1,a=t.sort||vo;function u(){for(let g of Array.from(i))try{g()}catch{}}function d(){o=Array.from(r.values()).sort(a)}function f(g){if(l||!g||g.id!==e)return;let m=Number(g.revision)||0;if(n("apply %s rev=%d",g.type,m),!(m<=s&&g.type!=="snapshot")){if(g.type==="snapshot"){if(m<=s)return;r.clear();let k=Array.isArray(g.issues)?g.issues:[];for(let R of k)R&&typeof R.id=="string"&&R.id.length>0&&r.set(R.id,R);d(),s=m,u();return}if(g.type==="upsert"){let k=g.issue;if(k&&typeof k.id=="string"&&k.id.length>0){let R=r.get(k.id);if(!R)r.set(k.id,k);else{let B=Number.isFinite(R.updated_at)?R.updated_at:0,V=Number.isFinite(k.updated_at)?k.updated_at:0;if(B<=V){for(let se of Object.keys(R))se in k||delete R[se];for(let[se,j]of Object.entries(k))R[se]=j}}d()}s=m,u()}else if(g.type==="delete"){let k=String(g.issue_id||"");k&&(r.delete(k),d()),s=m,u()}}}return{id:e,subscribe(g){return i.add(g),()=>{i.delete(g)}},applyPush:f,snapshot(){return o},size(){return r.size},getById(g){return r.get(g)},dispose(){l=!0,r.clear(),o=[],i.clear(),s=0}}}function $s(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let o=Object.keys(e.params).sort();for(let s of o){let i=e.params[s];n[s]=String(i)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function mc(e){let t=Ot("subs"),n=new Map,r=new Map;function o(l,a){t("applyDelta %s +%d ~%d -%d",l,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let u=r.get(l);if(!u||u.size===0)return;let d=Array.isArray(a.added)?a.added:[],f=Array.isArray(a.updated)?a.updated:[],g=Array.isArray(a.removed)?a.removed:[];for(let m of Array.from(u)){let k=n.get(m);if(!k)continue;let R=k.itemsById;for(let B of d)typeof B=="string"&&B.length>0&&R.set(B,!0);for(let B of f)typeof B=="string"&&B.length>0&&R.set(B,!0);for(let B of g)typeof B=="string"&&B.length>0&&R.delete(B)}}async function s(l,a){let u=$s(a);if(t("subscribe %s key=%s",l,u),!n.has(l))n.set(l,{key:u,itemsById:new Map});else{let f=n.get(l);if(f&&f.key!==u){let g=r.get(f.key);g&&(g.delete(l),g.size===0&&r.delete(f.key)),n.set(l,{key:u,itemsById:new Map})}}r.has(u)||r.set(u,new Set);let d=r.get(u);d&&d.add(l);try{await e("subscribe-list",{id:l,type:a.type,params:a.params})}catch(f){let g=n.get(l)||null;if(g){let m=r.get(g.key);m&&(m.delete(l),m.size===0&&r.delete(g.key))}throw n.delete(l),f}return async()=>{t("unsubscribe %s key=%s",l,u);try{await e("unsubscribe-list",{id:l})}catch{}let f=n.get(l)||null;if(f){let g=r.get(f.key);g&&(g.delete(l),g.size===0&&r.delete(f.key))}n.delete(l)}}return{subscribeList:s,_applyDelta:o,_subKeyOf:$s,selectors:{getIds(l){let a=n.get(l);return a?Array.from(a.itemsById.keys()):[]},has(l,a){let u=n.get(l);return u?u.itemsById.has(a):!1},count(l){let a=n.get(l);return a?a.itemsById.size:0},getItemsById(l){let a=n.get(l),u={};if(!a)return u;for(let d of a.itemsById.keys())u[d]=!0;return u}}}}function gc(){let e=Ot("issue-stores"),t=new Map,n=new Map,r=new Set,o=new Map;function s(){for(let a of Array.from(r))try{a()}catch{}}function i(a,u,d){let f=u?$s(u):"",g=n.get(a)||"",m=t.has(a);if(e("register %s key=%s (prev=%s)",a,f,g),m&&g&&f&&g!==f){let k=t.get(a);if(k)try{k.dispose()}catch{}let R=o.get(a);if(R){try{R()}catch{}o.delete(a)}let B=ta(a,d);t.set(a,B);let V=B.subscribe(()=>s());o.set(a,V)}else if(!m){let k=ta(a,d);t.set(a,k);let R=k.subscribe(()=>s());o.set(a,R)}return n.set(a,f),()=>l(a)}function l(a){e("unregister %s",a),n.delete(a);let u=t.get(a);u&&(u.dispose(),t.delete(a));let d=o.get(a);if(d){try{d()}catch{}o.delete(a)}}return{register:i,unregister:l,getStore(a){return t.get(a)||null},snapshotFor(a){let u=t.get(a);return u?u.snapshot().slice():[]},subscribe(a){return r.add(a),()=>r.delete(a)}}}function hc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function bc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function na(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function E_(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),o=r>=0?n.slice(r+1):"";if(o){let l=new URLSearchParams(o).get("issue");if(l)return decodeURIComponent(l)}let s=/^\/issue\/([^\s?#]+)/.exec(n);return s&&s[1]?decodeURIComponent(s[1]):null}function T_(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function yc(e){let t=Ot("router"),n=()=>{let r=window.location.hash||"",o=/^#\/issue\/([^\s?#]+)/.exec(r),s=o&&o[1]?decodeURIComponent(o[1]):E_(r),i=T_(r);if(t("hash change \u2192 view=%s id=%s",i,s),e.setState({selected_id:i==="worker"?null:s,view:i,worker:{selected_parent_id:i==="worker"?s:null}}),!!o||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let a=s?`#/${i}?issue=${encodeURIComponent(s)}`:`#/${i}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let o=e.getState?e.getState():{view:"board"},s=o.view==="worker"||o.view==="monitor"?o.view:"board",i=na(s,r);t("goto issue %s (view=%s)",r,s),window.location.hash!==i?window.location.hash=i:e.setState({selected_id:s==="worker"?null:r,view:s,worker:{selected_parent_id:s==="worker"?r:null}})},gotoView(r){let o=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},s=r==="worker"?o.worker?.selected_parent_id:o.selected_id,i=s?na(r,s):`#/${r}`;t("goto view %s (id=%s)",r,s||""),window.location.hash!==i?window.location.hash=i:e.setState({view:r,selected_id:r==="worker"?null:o.selected_id})}}}var C_=Object.freeze({workspace_config:{default_workspace:null}});function vc(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:C_.workspace_config.default_workspace}}}function wc(e={}){let t=Ot("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:vc(e.config)},r=new Set;function o(){for(let s of Array.from(r))try{s(n)}catch{}}return{getState(){return n},setState(s){let i={...n,...s,filters:{...n.filters,...s.filters||{}},board:{...n.board,...s.board||{}},worker:{...n.worker,...s.worker||{}},workspace:{current:s.workspace?.current!==void 0?s.workspace.current:n.workspace.current,available:s.workspace?.available!==void 0?s.workspace.available:n.workspace.available,hidden:s.workspace?.hidden!==void 0?s.workspace.hidden:n.workspace.hidden},config:s.config!==void 0?vc(s.config):n.config},l=i.workspace.current?.path!==n.workspace.current?.path||i.workspace.available.length!==n.workspace.available.length||i.workspace.hidden.length!==n.workspace.hidden.length||i.workspace.hidden.some((u,d)=>u!==n.workspace.hidden[d]),a=i.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;i.selected_id===n.selected_id&&i.view===n.view&&i.filters.status===n.filters.status&&i.filters.search===n.filters.search&&i.filters.type===n.filters.type&&i.board.closed_filter===n.board.closed_filter&&i.worker.selected_parent_id===n.worker.selected_parent_id&&i.worker.show_closed_children.length===n.worker.show_closed_children.length&&i.worker.show_closed_children.every((u,d)=>u===n.worker.show_closed_children[d])&&!l&&!a||(n=i,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),o())},subscribe(s){return r.add(s),()=>r.delete(s)}}}function kc(e){let t=Ot("activity"),n=0,r=new Map,o=1;function s(){if(!e)return;let u=n>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function i(){n+=1,t("start count=%d",n),s()}function l(){let u=n;n=Math.max(0,n-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,n),s()}function a(u){return async(f,g)=>{let m=o++,k=Date.now();r.set(m,{type:f,start_ts:k}),t("request start id=%d type=%s count=%d",m,f,n+1),i();let R=!1,B=()=>{R||(R=!0,r.delete(m),l())},V=setTimeout(()=>{R||(t("request TIMEOUT id=%d type=%s elapsed=%dms",m,f,Date.now()-k),B())},3e4);try{let se=await u(f,g),j=Date.now()-k;return t("request done id=%d type=%s elapsed=%dms",m,f,j),se}catch(se){let j=Date.now()-k;throw t("request error id=%d type=%s elapsed=%dms err=%o",m,f,j,se),se}finally{clearTimeout(V),B()}}}return s(),{wrapSend:a,start:i,done:l,getCount:()=>n,getActiveRequests:()=>{let u=Date.now();return Array.from(r.entries()).map(([d,f])=>({id:d,type:f.type,elapsed_ms:u-f.start_ts}))}}}function we(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function Ur(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let s=t.get();return s&&s.order?s.order:{}}function r(s,i,l){let a=e&&e.snapshotFor?e.snapshotFor(s).slice():[];if(i==="closed")return a.sort(dc),a;switch(l){case"created_desc":return a.sort(vo),a;case"created_asc":return a.sort(lc),a;case"updated_desc":return a.sort(cc),a;case"priority":return a.sort(uc),a;case"manual":default:{let u=n();return u?a.sort(_c(u)):a.sort(vo),a}}}function o(s){let i=[];return e&&typeof e.subscribe=="function"&&i.push(e.subscribe(s)),t&&typeof t.subscribe=="function"&&i.push(t.subscribe(s)),()=>{for(let l of i)try{l()}catch{}}}return{selectBoardColumn:r,subscribe:o}}function tr(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function Vt(e){let t=tr(e);if(t===null)return"";let n=new Date(t),r=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function on(e,t){let n=tr(e);if(n===null)return"";let o=(typeof t=="number"?t:Date.now())-n;if(o<6e4)return"\uBC29\uAE08";let s=Math.floor(o/6e4);if(s<60)return`${s}\uBD84 \uC804`;let i=Math.floor(o/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let l=Math.floor(o/864e5);if(l<7)return`${l}\uC77C \uC804`;let a=Math.floor(l/7);if(l<30)return`${a}\uC8FC \uC804`;let u=Math.floor(l/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(l/365)}\uB144 \uC804`}function $c(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let o=tr(r.updated_at)??0;if(t===null||o>n){t=r,n=o;continue}o===n&&String(r.id)<String(t.id)&&(t=r)}return t}function xs(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function As(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let o=xs(r);if(!o)continue;let s=n.get(o);s||(s=[],n.set(o,s)),s.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function Ss(e,t){let n=e.get(t)||[],r=0;for(let s of n)(s.status==="resolved"||s.status==="closed")&&(r+=1);let o=$c(n);return{total:n.length,count:r,current:o,children:n}}function xc(e){let t=e.transport,n=e.uiOrderStore;function r(i,l){return"renormalize"in i?i.renormalize:[{bead_id:l,rank:i.rank}]}function o(i,l){let a={...i.order};for(let u of l)a[u.bead_id]=u.rank;n&&n.set({revision:i.revision,order:a})}async function s(i,l,a){if(!t||!n)return;let u=n.get()||{revision:0,order:{}},d=r(ea(l,a,u.order),i);o(u,d);let f=await t("ui-order-set",{expected_revision:u.revision,entries:d});if(f&&f.conflict){let g={revision:typeof f.revision=="number"?f.revision:0,order:f.order||{}};n.set(g);let m=r(ea(l,a,g.order),i);o(g,m);let k=await t("ui-order-set",{expected_revision:g.revision,entries:m});k&&k.applied&&n.set({revision:typeof k.revision=="number"?k.revision:0,order:k.order||{}})}else f&&f.applied&&n.set({revision:typeof f.revision=="number"?f.revision:0,order:f.order||{}})}return{applyReorder:s}}function Ac(e){if(typeof e!="string")return"";let t=e.indexOf("-");return t>0?e.slice(0,t):""}function Bn(e,t){let n=Ac(e),r=Ac(t);return n.length===0||r.length===0?!1:n!==r}function Es(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function ra(e,t){return!t||typeof e!="string"||e.length===0||Es(t.visible_labels).includes(e)?!0:Es(t.hidden_labels).includes(e)?!1:!Es(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function Sc(e,t){return Es(e).filter(n=>ra(n,t))}function nr(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function R_(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function O_(e,t,n,r,o){return c`<button
  ...
  `}var L_={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg",close:"mrg"},Tc={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge",close:"close"},Ec={quick_fix:["impl","close"],spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},P_={review:"\u2713",skip:"\u2298"},rr={none:"\uBBF8\uB3C4\uB2EC",dim:"\uC9C4\uD589 \uC911",stale:"\uC7AC\uAC80\uD1A0 \uD544\uC694",review:"\uAC80\uD1A0 \uC644\uB8CC",skip:"\uAC80\uD1A0 \uC0DD\uB7B5",done:"\uC644\uB8CC"};function D_(e,t,n){if(!(n==="in_progress"||n==="resolved"))return null;for(let o of e){let s=t[o];if(s&&s.fill==="dim"&&s.stale!==!0)return o}return null}function Cc(e){let t=e&&e.fill||"none";return t==="none"?rr.none:e&&e.stale===!0?rr.stale:t==="dim"?rr.dim:e&&e.glyph==="review"?rr.review:e&&e.glyph==="skip"?rr.skip:rr.done}function M_(e){if(!e||e.fill==="none"||!e.approval_state)return Cc(e);let t=[];return e.glyph==="review"?t.push(rr.review):e.glyph==="skip"&&t.push(rr.skip),e.approval_state==="missing"?t.push("\uC2B9\uC778 \uD544\uC694"):e.approval_state==="stale"?t.push("\uC7AC\uC2B9\uC778 \uD544\uC694"):e.approval_state==="unknown"?t.push("\uC2B9\uC778 \uD655\uC778 \uBD88\uAC00"):t.push("\uC2B9\uC778 \uC644\uB8CC"),t.join(" \xB7 ")}function N_(e,t,n,r){let o=L_[e]||e,s=t&&t.fill||"none",i=!!t&&t.stale===!0,l=P_[t&&t.glyph||""]||"",a="bar";s==="dim"?a+=` b-${o} dim`:s==="full"&&(a+=` b-${o} full`),i&&(a+=" stale"),n&&(a+=" cur");let u=s==="none"?"lbl":`lbl l-${o} on`,d=n?`color: var(--stage-${o}-on)`:"",f=Tc[e]||e,g=r?Rc(t):null;if(!g)return c`
      <div class="seg">
  ...
  >`}function oa(e){return e==="delegated"?"\uC704\uC784":e==="main"?"\uBA54\uC778":null}function Rs(e){return e.effort?`${e.actor}:${e.effort}`:e.actor}function Un(e){return`${e.kind}:${Rs(e)}@${e.sha}`}function Os(e,t){if(!e)return null;let n=oa(e.kind),r=e.reason,o=e.kind==="delegated"?r===null:typeof r=="string"&&r.trim().length>0&&!/[\r\n]/.test(r);if(!n||!o)return null;let s=oa(t?.kind),i=s!==null&&t?.kind!==e.kind,l=`\uACC4\uD68D \xB7 ${n}${i?` \u2192 ${s}`:""}`,a=`planned_execution ${e.kind}${typeof r=="string"?`:${r}`:""}`,u=t?` \xB7 exec_receipt ${Un(t)}`:"";return{kind:e.kind,label:l,title:`${a}${u}`}}function Lc(e,t){let n=Os(e,t);return n?c`<span
    ...
    >${`\uC2E4\uD589 \xB7 ${t}`}</span
  >`:null}function U_(e,t){let n=t.policy||null,r=e.workflow&&e.workflow.chips||{},o=[];if(r.route&&nr(n,"route")){let l=r.route_source==="derived";o.push(c`<span
  ...
  `}var V_=200,X_={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},Q_=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),Mc="beads-ui.board.sort",Nc=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function Z_(){try{let e=window.localStorage.getItem(Mc);if(e&&Nc.has(e))return e}catch{}return"created_desc"}function qc(e,t){let n=Ot("views:board"),r=t.gotoIssue,o=t.issueStores,s=t.transport,i=t.uiOrderStore,l=t.displayPolicyStore,a=t.workerQueueStore,u=t.onClosedRangeChange,d=t.onNewIssue,f=t.openDoc,g=t.closedRange||ys,m=o?Ur(o,i):null,k=xc({transport:s,uiOrderStore:i}),R=[],B=[],V=[],se=[],j=[],N=[],C=!1,L=0,F=Z_(),Y=new Map,Q=new Map,P=new Map,H=new Set,G={search:"",priority:"",type:"",labels:[]},te=!1,ke=null;function Ee(ae){return String(ae.status||"open")==="open"}function oe(ae){return String(ae.status||"open")==="open"}function D(ae){let ie=G.search.trim().toLowerCase(),$=G.priority,q=G.type,J=G.labels;return ae.filter(re=>{if(ie){let le=String(re.id||"").toLowerCase(),Be=String(re.title||"").toLowerCase();if(!le.includes(ie)&&!Be.includes(ie))return!1}if($!==""&&String(re.priority)!==$||q!==""&&String(re.issue_type||"")!==q)return!1;if(J.length>0){let le=Array.isArray(re.labels)?re.labels:[];if(!J.some(Be=>le.includes(Be)))return!1}return!0})}function be(){let ae=new Set;for(let ie of[R,B,V,se,j,N])for(let $ of ie){let q=Array.isArray($.labels)?$.labels:[];for(let J of q)typeof J=="string"&&J.length>0&&ae.add(J)}return Array.from(ae).sort()}function Se(){return G.search.trim()!==""||G.priority!==""||G.type!==""||G.labels.length>0}function T(){try{if(m){let ae=m.selectBoardColumn("tab:board:in-progress","in_progress",F),ie=m.selectBoardColumn("tab:board:blocked","blocked",F).filter(oe),$=new Set(ae.map(ze=>ze.id)),q=m.selectBoardColumn("tab:board:ready","ready",F).filter(ze=>Ee(ze)&&!$.has(ze.id)),J=m.selectBoardColumn("tab:board:resolved","resolved",F),re=m.selectBoardColumn("tab:board:deferred","deferred",F),le=m.selectBoardColumn("tab:board:closed","closed").slice(0,V_),Be=[...ie,...q,...ae,...J,...le];ee(Be);let Ve=new Set;for(let ze of Be)ze&&ze.id&&!xs(ze)&&Ve.add(ze.id);let tt=!Se();R=tt?wo(ie,Ve):ie,B=tt?wo(q,Ve):q,V=tt?wo(ae,Ve):ae,se=tt?wo(J,Ve):J,j=re,L=re.length,N=tt?wo(le,Ve):le,Y=new Map;for(let ze of R)Y.set(ze.id,"open");for(let ze of B)Y.set(ze.id,"open");for(let ze of V)Y.set(ze.id,"in_progress");for(let ze of se)Y.set(ze.id,"resolved");for(let ze of j)Y.set(ze.id,"deferred");for(let ze of N)Y.set(ze.id,"closed");Q=new Map;for(let ze of R)Q.set(ze.id,"blocked-col");for(let ze of B)Q.set(ze.id,"ready-col");for(let ze of V)Q.set(ze.id,"in-progress-col");for(let ze of se)Q.set(ze.id,"resolved-col");for(let ze of N)Q.set(ze.id,"closed-col")}Ue()}catch{R=[],B=[],V=[],se=[],j=[],N=[],P=new Map,Ue()}}function ee(ae){P=As(ae)}function me(ae){return Ss(P,ae)}function ve(ae){return!H.has(ae)}function Ce(ae,ie){ae.preventDefault(),ae.stopPropagation(),H.has(ie)?H.delete(ie):H.add(ie),Ue()}function _e(ae,ie){ae.preventDefault(),ae.stopPropagation(),r(ie)}function Re(ae,ie){ae.preventDefault(),ae.stopPropagation(),r(ie)}function Ye(ae,ie){ke||r(ie)}function it(ae,ie){ae.preventDefault(),ae.stopPropagation(),J_(ie).then($=>{$&&we("\uBCF5\uC0AC\uB428","success",1200)})}function I(ae,ie){ke=ie,ae.dataTransfer&&(ae.dataTransfer.setData("text/plain",ie),ae.dataTransfer.effectAllowed="move"),ae.target.classList.add("board-card--dragging")}function ue(ae){ae.target.classList.remove("board-card--dragging"),Mt(),setTimeout(()=>{ke=null},0)}function ne(ae){let ie=String(ae.target.value||"");!ie||ie===g||(g=ie,u&&u(ie),Ue())}function de(){return l?l.get():null}function Ae(ae){let ie=a?a.get():null,$=ie?ie.cleanup_failed:null;if(!$||typeof $!="object"||Array.isArray($))return null;let q=$[ae];return!q||typeof q!="object"||Array.isArray(q)?null:q}let ge={onCardClick:Ye,onCopyId:it,onDragStart:I,onDragEnd:ue,onClosedRangeChange:ne,rollupFor:me,isExpanded:ve,onRollupToggle:Ce,onChildClick:_e,onFromChipClick:Re,onOpenDoc:f?(ae,ie)=>f(ie):void 0,cleanupFailureFor:Ae,get policy(){return de()}};function Ne(ae,ie){ke||(y(),r(ie))}function qe(ae,ie){ae.preventDefault(),ae.stopPropagation(),y(),r(ie)}let Ze={...ge,onCardClick:Ne,onChildClick:qe,onFromChipClick:qe,onOpenDoc:f?(ae,ie)=>{y(),f(ie)}:void 0,get policy(){return de()}};function Fe(ae){let ie=ae.target,$=e.querySelector(".board-filter__labels");ie&&$&&$.contains(ie)||Te()}function Z(ae){ae.key==="Escape"&&Te()}function X(){te||(te=!0,document.addEventListener("mousedown",Fe),document.addEventListener("keydown",Z),Ue())}function Te(){te&&(te=!1,document.removeEventListener("mousedown",Fe),document.removeEventListener("keydown",Z),Ue())}function He(ae){ae.key==="Escape"&&y()}function at(){C||(C=!0,document.addEventListener("keydown",He),Ue())}function y(){C&&(C=!1,document.removeEventListener("keydown",He),Ue())}let U={onClose:y,onOverlayClick(ae){ae.target===ae.currentTarget&&y()}},Oe={onSearchInput(ae){G.search=String(ae.target.value||""),T()},onPriorityChange(ae){G.priority=String(ae.target.value||""),T()},onTypeChange(ae){G.type=String(ae.target.value||""),T()},onSortChange(ae){let ie=String(ae.target.value||"");if(!(!Nc.has(ie)||ie===F)){F=ie;try{window.localStorage.setItem(Mc,ie)}catch{}T()}},onDeferredToggle(){C?y():at()},onLabelMenuToggle(){te?Te():X()},onLabelToggle(ae){let ie=G.labels.indexOf(ae);ie===-1?G.labels.push(ae):G.labels.splice(ie,1),T()},onLabelClear(){G.labels.length!==0&&(G.labels=[],T())},onNewIssue(){d&&d()}};function Ie(){return c`
      <div class="board-view">
        ${Dc(G,Oe,{sort_mode:F,deferred_popup_open:C,deferred_count:L,label_options:be(),label_menu_open:te})}
        <div class="board-root">
          ${Wr({title:"Blocked",id:"blocked-col",items:D(R)},ge)}
          ${Wr({title:"Ready",id:"ready-col",items:D(B)},ge)}
...
`),openable:!0,...e.root_dir?{root_dir:e.root_dir}:{}}}function Sa(e){return Array.isArray(e)?e.slice().sort((t,n)=>t.id<n.id?-1:t.id>n.id?1:0):[]}function Nm(e,t=!1){return e?c`<button
  ...
  >
    스펙 대기
        ...
        ${r.map(d=>Oo(d,"released"))}${s.map(d=>Oo(Mm(d),"overlap"))}${i?c`<span
...
`);return c`<button
  ...
  >`}function ti(e){if(typeof e!="number"||!Number.isFinite(e))return"";let t=Math.max(0,Math.min(4,Math.trunc(e)));return c`<span class="worker-pri" title=${`\uC6B0\uC120\uC21C\uC704 P${t}`}
    >P${t}</span
  >`}function Bm(e){let t=Array.isArray(e.badges)?e.badges:[],n=nn(e.usage),r=zn(e.usage),o=on(e.done_at);return c`<div
  ...
  >`,k=e.lane==="done"?"":Js(e.workflow),R=e.lane==="done"?"":Lu(e.from_id),B=ti(e.priority),V=c`<span class="worker-mini__title">${e.title}</span>`,se=Du(e.pr_url,e.pr_number),j=r.map(Re=>Re===e.live_badge?c`<span
        ...
        >`:c`<span
          ...
          >${Re}</span
        >`),N=e.reason?c`<span class="worker-mini__reason">${e.reason}</span>`:"",C=o.length>0?o.map(Re=>c`<span class="worker-usage" title=${Re.tooltip}
              >${Re.label}</span
      ...
      >
        ...
        >
          승인하고 진행
        </button>`:"",oe=!!(e.lane!=="pr_wait"&&!e.done&&e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)),D=ei(e.rec,Sr(e,"rec")),be=Fm(e,Sr(e,"receipt")),Se=Zs(e.cross_lane_chip),T=ro(e.log_path),ee=g||Se||k||R||oe||D||be||C||T?c`<div class="worker-chips">
          ${g}${Se}${k}${R}${oe?Xs(e.exec_chips,{pin:e.exec_chips_pinned===!0}):""}${D}${be}${C}${T}${Ea(e)}
    ...
    <div class="worker-card__head">
      ...
      ${r?c`<button
          ...
          >
            ...
            >
              세션 권장
            </button>`:""}${ei(e.rec,Sr(e,"rec"))}${qm(u,Sr(e,"qfr"))}
      ${k?"":Ea(e)}
    </div>
    <div class="worker-card__title">${e.title}</div>
    ${u?Cs(u,e.status,{onOpenDoc:n.onOpenDoc}):""}${B}
    ${V||se||j||N||C?c`<div class="worker-chips">
...
`);else return null;let n=t.replace(zh,"").trim();return n.length>0?{kind:"user",text:n}:null}function fl(e){let t=e.split(/\r?\n/).find(r=>r.trim().length>0)||"",n=Bh.exec(t);return n?{kind:"gate",gate:n[2]==="implementation"?"impl":n[2],reviewer:n[3],verdict:n[4],time:n[5]?n[5].trim():void 0,text:t.trim()}:Uh.test(t)&&t.trim().length<=80?{kind:"phase",text:t.trim()}:{kind:"assistant",text:e}}function Hh(e,t){if(e.subtype==="init"){let n=typeof e.model=="string"?e.model:"";return t.progress=null,[{kind:"thinking",text:n?`\uC138\uC158 \uC2DC\uC791 \xB7 ${n}`:"\uC138\uC158 \uC2DC\uC791"}]}if(e.subtype==="thinking_tokens"){let r=`\uC0DD\uAC01 \uC911\u2026 ${typeof e.estimated_tokens=="number"&&Number.isFinite(e.estimated_tokens)?Math.max(0,Math.round(e.estimated_tokens)):0} \uD1A0\uD070`;return t.progress?(t.progress.text=r,[]):(t.progress={kind:"thinking",text:r},[t.progress])}return[]}function Gh(e,t){let n=typeof e.parent_tool_use_id=="string"&&e.parent_tool_use_id.length>0?e.parent_tool_use_id:null;if(e.type==="assistant"){let r=e.message,o=r&&Array.isArray(r.content)?r.content:[],s=[];for(let i of o)if(Rn(i)){if(i.type==="text"&&typeof i.text=="string")s.push(fl(i.text));else if(i.type==="thinking"){let l=pl(i.thinking);l&&s.push(l)}else if(i.type==="tool_use"){let l=Wh(i);typeof i.id=="string"&&t.set(i.id,l),s.push(l)}}return n?Wd(s,n):s}if(e.type==="user"){let r=e.message,o=r&&Array.isArray(r.content)?r.content:[];for(let i of o)if(Rn(i)&&i.type==="tool_result"){let l=t.get(String(i.tool_use_id));if(l){let a=Hd(i.content);l.result=a,l.output=typeof i.content=="string"?i.content:a,i.is_error===!0&&(l.is_error=!0)}}let s=Gd(r&&r.content);return s?[s]:[]}if(e.type==="result"){let r=e.is_error===!1&&e.subtype==="success",o={kind:"result",success:r,text:typeof e.result=="string"?e.result:r?"DONE":""};return n?Wd([o],n):[o]}return[]}function Wd(e,t){for(let n of e)n.parent_tool_use_id=t;return e}function Kh(e){let t=typeof e.command=="string"?e.command:"",n=Hd(e.aggregated_output===void 0?e.output:e.aggregated_output),o=[typeof e.exit_code=="number"&&Number.isFinite(e.exit_code)?`exit ${e.exit_code}`:typeof e.status=="string"&&e.status.length>0?e.status:"",n].filter(i=>i.length>0).join(" \xB7 "),s={kind:"tool",tool:"shell",icon:zd.Bash,command:t,input:{command:t},expandable:!0};return o.length>0&&(s.result=o),typeof e.aggregated_output=="string"&&(s.output=e.aggregated_output),s}function Yh(e){if(e.type==="item.completed"&&Rn(e.item)){let t=e.item;if(t.type==="agent_message"&&typeof t.text=="string")return[fl(t.text)];if(t.type==="user_message"){let n=Gd(t.text);return n?[n]:[]}if(t.type==="reasoning"){let n=pl(t.text);return n?[n]:[]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:t.type==="command_execution"?[Kh(t)]:[]}if(e.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(e.type==="turn.failed"){let t=e.error;return[{kind:"error",text:t&&typeof t.message=="string"?t.message:"turn failed"}]}return e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}function Vh(e){if(e.schema!=="codex-delegation-monitor-v1"||!Rn(e.event))return[];let t=e.event;if(t.type==="session.started"||t.type==="turn.started")return[];if((t.type==="item.started"||t.type==="item.completed")&&Rn(t.item)){let n=t.item;if(typeof n.id!="string"||n.id.length===0)return[];if(t.type==="item.completed"&&n.kind==="agent_message"&&typeof n.text=="string"&&n.text.trim().length>0)return[fl(n.text)];if(t.type==="item.completed"&&n.kind==="reasoning"){let l=pl(n.text);return l?[l]:[]}if(n.kind!=="activity"||typeof n.activity!="string")return[];let r=Fh[n.activity];if(!r)return[];let o="\uC2DC\uC791",s="\u2026",i={kind:"tool",tool:"",icon:s,expandable:!1};if(t.type==="item.completed"){if(n.status==="completed")o="\uC644\uB8CC",s="\u2713";else if(n.status==="failed")o="\uC2E4\uD328",s="\u2717";else return[];i.result=""}return i.tool=`${r} \xB7 ${o}`,i.icon=s,[i]}return t.type==="turn.completed"&&t.status==="completed"?[{kind:"result",success:!0,text:"DONE"}]:t.type==="turn.failed"&&(t.status==="failed"||t.status==="interrupted")&&typeof t.error_code=="string"&&t.error_code.length>0?[{kind:"error",text:t.error_code}]:[]}function Xh(e){let t=e.type;return typeof t=="string"&&(t==="error"||t.startsWith("thread.")||t.startsWith("turn.")||t.startsWith("item."))}function Qh(e){let t=e;if(typeof e=="string"){let n=e.trim();if(n.length===0)return null;try{t=JSON.parse(n)}catch{return null}}return Rn(t)?t:null}function Kd(e={}){let t=e.skip_delegated===!0,n=new Map,r={progress:null};return{push(o){let s=Qh(o);if(!s)return[];if(t&&typeof s.parent_tool_use_id=="string"&&s.parent_tool_use_id.length>0)return[];if(s.type==="system"&&s.schema!=="codex-delegation-monitor-v1")return Hh(s,r);let i=s.schema==="codex-delegation-monitor-v1"?Vh(s):Xh(s)?Yh(s):Gh(s,n);return i.length>0&&(r.progress=null),i}}}function _l(e){let t=[],n=Kd(),r=Array.isArray(e)?e:[];for(let o of r)for(let s of n.push(o))t.push(s);return t}var Zh=5,Jh=10,eb=/Task\s+#(\d+)/,tb=/\bgh\s+pr\s+create\b|\bgit\s+push\b/,nb=/\bnpm\s+(?:run\s+)?(?:test|tsc|lint|build)\b|\bvitest\b/;function es(e){return typeof e!="string"?"":(e.split(/\r?\n/).find(t=>t.trim().length>0)||"").trim()}function rb(e){return typeof e!="string"||e.length===0?0:e.split(/\r?\n/).length}function ob(e){for(let t=e.length-1;t>=0;t-=1){let n=e[t];if(n.kind==="phase"||n.kind==="gate")return n.text||null}return null}function sb(e){let t=new Map,n=0;for(let o of e){if(o.kind!=="tool")continue;n+=1;let s=o.input||{};if(o.tool==="TaskCreate"){let a=eb.exec(o.output||o.result||""),u=String(s.activeForm||s.subject||"").trim();if(!a||u.length===0)continue;t.set(a[1],{label:u,active:s.status==="in_progress"?n:0});continue}if(o.tool!=="TaskUpdate")continue;let i=t.get(String(s.taskId??""));if(!i)continue;let l=s.activeForm||s.subject;typeof l=="string"&&l.trim().length>0&&(i.label=l.trim()),typeof s.status=="string"&&(i.active=s.status==="in_progress"?n:0)}let r=null;for(let o of t.values())o.active>0&&(!r||o.active>r.active)&&(r=o);return r?r.label:null}function ib(e){if(e.tool==="Bash"){let t=e.command||"";return tb.test(t)?"~ PR/\uAC8C\uC2DC \uC911":nb.test(t)?"~ \uAC80\uC99D \uC911":null}return e.tool==="Edit"||e.tool==="Write"||e.tool==="MultiEdit"?"~ \uAD6C\uD604 \uC911":e.tool==="Read"||e.tool==="Grep"||e.tool==="Glob"?"~ \uD0D0\uC0C9 \uC911":null}function ab(e){let t=e.filter(o=>o.kind==="tool").slice(-Jh),n=new Map;t.forEach((o,s)=>{let i=ib(o);if(!i)return;let l=n.get(i)||{count:0,last:-1};l.count+=1,l.last=s,n.set(i,l)});let r=null;for(let[o,s]of n)(!r||s.count>r.count||s.count===r.count&&s.last>r.last)&&(r={label:o,count:s.count,last:s.last});return r?r.label:null}function lb(e){let t=ob(e);if(t)return{text:t,guess:!1};let n=sb(e);if(n)return{text:n,guess:!1};let r=ab(e);return r?{text:r,guess:!0}:null}function cb(e,t){if(typeof e!="number")return"";let n=Math.max(0,Math.floor((t-e)/1e3));return n<60?`${n}\uCD08 \uC804`:on(e,t)}function co(e,t={}){let{transport:n,sessionLogStore:r,onClose:o}=t,s=null,i=null,l=null,a=null,u=null,d=!1,f={},g=!0,m=new Set,k=new Set,R=null,B=null,V=!1,se=!1,j=!1,N=null,C=null;function L(){V=!1,se=!1,j=!1,N=null,C=null}async function F(Z){if(n){se=!0,j=!1,Re();try{let X=await Promise.resolve(n("get-attempt-prompt",{attempt_id:Z,...u?{root_dir:u}:{}}));if(s!==Z)return;!X||typeof X!="object"||Array.isArray(X)?j=!0:(N=X,C=Z)}catch{s===Z&&(j=!0)}finally{s===Z&&(se=!1,Re())}}}function Y(){if(V=!V,V&&s&&C!==s){F(s);return}Re()}function Q(){if(!V)return"";let Z=lo({loading:se,error:j});if(Z)return c`<div class="sv__prompt" data-seam="attempt-prompt">
      ...
      </div>`}if(X.kind==="error")return c`<div class="sv__error">⛔ ${X.text}</div>`;if(X.kind==="blocker")return c`<div class="sv__error">⛔ ${X.text}</div>`;if(X.kind==="tool"){let Te=m.has(Z),He=X.tool==="Bash"?rb(X.command):0,at=X.tool==="Bash"?He>1?es(X.command):X.command:X.path||X.command||"";return c`<div
...
`)}function me(){if(!s)return c``;let Z=P(),X=(i?[f.agent_type,f.model,f.effort]:[f.runner,f.model,f.effort]).filter(Boolean).join(" \xB7 "),Te=f.session_id||"",He=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${g?"ON":"OFF"}`,at=G(),y=at?cb(H(),Date.now()):"",U=at?be(Z):null,Oe=at?Se(Z):null,Ie=lb(Z);return c`<div class="sv" data-attempt-id=${s}>
      <div class="sv__bar">
        <span class="sv__id"
    ...
    </div>`}function Ce(Z){let X=k.has(Z.idx),Te=Z.header?Z.header.line:null,He=Te?Te.is_error===!0?"\u2717":typeof Te.result=="string"?"\u2713":"\u27F3":"",at=Te&&Te.command?Te.command:"";return c`<div class="sv__sub${X?" sv__sub--open":""}">
      <div
        class="sv__sub-head"
        role="button"
        tabindex="0"
...
`).trim()}}var Vd=20;function Xd(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),s=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${o}:${s}`}function mb(e){return e.length>Vd?`${e.slice(0,Vd)}\u2026`:e}function gb(e,t,n,r){let o=`${t.lane} ${mb(t.identifier)}`;return c`<div class="detail-report">
  ...
  `}var{I:Fx}=zl;var Zd=e=>e.strings===void 0;var bb={},Jd=(e,t=bb)=>e._$AH=t;var cr=bi(class extends ao{constructor(e){if(super(e),e.type!==Xn.PROPERTY&&e.type!==Xn.ATTRIBUTE&&e.type!==Xn.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Zd(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===vn||t===Pt)return t;let n=e.element,r=e.name;if(e.type===Xn.PROPERTY){if(t===n[r])return vn}else if(e.type===Xn.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return vn}else if(e.type===Xn.ATTRIBUTE&&n.getAttribute(r)===t+"")return vn;return Jd(e),t}});var yb=[{id:"spec",label:"spec \uB9AC\uBDF0",receipt:"spec_review",receipt_stage:null,fill_stage:"spec",stale_stage:"spec",hue:"spec"},{id:"plan",label:"\uACC4\uD68D \uB9AC\uBDF0",receipt:null,receipt_stage:"plan",fill_stage:"plan",stale_stage:"plan",hue:"plan"},{id:"impl",label:"\uAD6C\uD604",receipt:null,receipt_stage:null,fill_stage:"impl",stale_stage:null,hue:"impl"},{id:"impl_review",label:"impl \uB9AC\uBDF0",receipt:"impl_review",receipt_stage:null,fill_stage:null,stale_stage:"impl",hue:"impl"},{id:"pr",label:"PR",receipt:null,receipt_stage:null,fill_stage:"pr",stale_stage:null,hue:"pr"}],ml={quick_fix:["impl","impl_review"],spec_backed:["spec","impl","impl_review","pr"],full_plan:["spec","plan","impl","impl_review","pr"]},ep={missing:"\uC2B9\uC778 \uD544\uC694",stale:"\uC7AC\uC2B9\uC778 \uD544\uC694",unknown:"\uC2B9\uC778 \uD655\uC778 \uBD88\uAC00"},vb={pin:"pin",global:"global",base:"base"};function wb(e){return c`<span
    class=${`detail-layer-rail detail-layer-rail--${vb[e]}`}
    data-source=${e}
    aria-hidden="true"
    ><i></i><i></i><i></i
  ></span>`}function kb(e,t,n){switch(e){case"workflow_mode":return Ao;case"spec_review_model":case"impl_review_model":return So;case"plan_review_model":return qs;case"spec_review_effort":case"plan_review_effort":case"impl_review_effort":return js;case"spec_review_speed":case"plan_review_speed":case"impl_review_speed":return Jr;case"impl_dispatch":return eu;case"impl_runtime":return Ns;case"impl_model":return eo(n,t.impl_runtime);case"impl_effort":return to(n,t.impl_runtime,t.impl_model);case"impl_speed":case"orchestration_speed":return Jr;case"orchestration_model":return Eo(n,null);case"orchestration_effort":return to(n,void 0,t.orchestration_model||bn).filter(r=>r!==bn);default:return[]}}function $b(e,t){return c`<div class="detail-effective__row" data-key=${e.key}>
    ${wb(e.source)}
  ...
  >
  ...
  </details>`}function xb(e){let t=[];if(e.workflow_mode&&t.push(e.workflow_mode.display),e.impl_dispatch?.value==="main")t.push("\uBA54\uC778");else if(e.impl_dispatch?.value==="delegated"){let n=e.impl_runtime?` ${e.impl_runtime.display}`:"";t.push(`\uC704\uC784${n}`)}for(let n of["impl_model","impl_effort","impl_speed"])e[n]?.resolution!=="not_applicable"&&t.push(e[n]?.display||"\uAE30\uBCF8\uAC12 \uD655\uC778 \uBD88\uAC00");return t.join(" \xB7 ")}function Ab(e){if(!e||typeof e!="object")return null;let{kind:t,actor:n,effort:r,sha:o}=e;return typeof t!="string"||typeof n!="string"||typeof o!="string"?null:{kind:t,actor:n,effort:typeof r=="string"?r:null,sha:o}}function np(e,t={}){let n=e&&typeof e.metadata=="object"&&e.metadata?e.metadata:{},r=e&&typeof e.workflow=="object"&&e.workflow?e.workflow:{},o=r.stages||{},s=r.route||n.route||null,i=typeof n.pr_url=="string"?n.pr_url:"",l=typeof n.exec_receipt=="string"?n.exec_receipt:"",a=Ab(r.exec_receipt),u=a?Un(a):l,d=a?`${a.kind}:${a.actor}`:l.split("@")[0],f=Os(r.planned_execution,r.exec_receipt),g=r.chips?.pr?.number,m=typeof g=="number"?`PR #${g}`:"PR",k=Co(n),R=k!==null&&t.isChipOpen?.("rec")===!0,B=R?Ca({rec:k},"rec"):null;return c`<section class="detail-summary" data-seam="detail-summary">
    ...
    <div
      ...
      aria-label="워크플로 게이트"
    >
      ${Sb(s).map(V=>Eb(V,n,o,{label:V.id==="pr"?m:V.label,href:V.id==="pr"?i:""}))}
    </div>
...
${l}</pre
    ...
    `:c``}function f(){st(d(),e)}async function g(R,B={}){o=R,s="loading",i="",l=null,a="",f();let V=B.workspace||(n?n():"");if(!V){s="error",a="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",f();return}if(!r){s="error",a="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",f();return}let se="/api/doc?workspace="+encodeURIComponent(V)+"&path="+encodeURIComponent(R);try{let j=await r(se),N=await j.json().catch(()=>({}));if(!j.ok||!N||N.ok!==!0){if(N?.error==="not_found"&&B.missing_state==="plan_pending"){s="pending",a="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",f();return}s="error",a="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(N&&N.error||j.status)+")",f();return}let C=Ib(String(N.content||""));l=C.front,i=C.body,s="ready",f()}catch{s="error",a="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",f()}}function m(){o=null,st(c``,e)}function k(){document.removeEventListener("keydown",u),m()}return{open:g,close:m,destroy:k}}var Lb=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],dp="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Ii=[{role:"implementation",provider:"codex"},{role:"review-consult",provider:"codex"},{role:"subagent",provider:"claude"}],Pb=new Set(["codex-runner","Explore","Plan","advisor","advisor-xhigh","claude-code-guide","statusline-setup"]);function cp(e){return typeof e=="string"&&Pb.has(e)}var Db=["running","done","failed","interrupted"],Mb={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function Nb(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function qb(e){let t=nn(e);if(t.length>0)return t.map(o=>c`<span class="detail-usage-total" title=${o.tooltip}
          >${o.label}</span
    ...
    ${o?c`<span class="detail-session__usage" title=${o.tooltip}
          >${o.label}</span
        >`:""}
  </div>`}function Wb(e,t,n,r){let o=e.status==="running"?null:t,i=(o?nn({providers:{[e.provider]:{subtotal:o.subtotal,breakdown:o.usage,...o.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],l=e.status==="running"?ts(e.last_event_at):o?bl(o.completed_at):"",a=(e.provider==="claude"?["Claude",e.agent_type,jb(e.model),e.effort]:["codex",e.model,e.effort]).filter(Boolean).join(" \xB7 "),u=Fb(e,o);return c`<button
    type="button"
  ...
  >
    ...
    ${i?c`<span class="detail-session__usage" title=${i.tooltip}
          >${i.label}</span
        >`:""}
  </button>`}function zb(e,t){return e.role===t.role&&(e.model===null||t.model===void 0||e.model===t.model)&&e.session_id===t.session_id}function Hb(e,t,n){let r=[],o=new Set,s=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let d of s){let f=Bb(d);!f||o.has(f.launch_id)||cp(f.agent_type)||(o.add(f.launch_id),r.push(f))}r.sort((d,f)=>(d.started_at||0)-(f.started_at||0));let i={};for(let{role:d,provider:f}of Ii){let g=t?t.roles[d]?.[f]:null;i[d]=g?[...g.legs]:[]}let l=Ii.flatMap(({role:d})=>i[d]),a=new Set,u=[];for(let{role:d,provider:f}of Ii){for(let g of r.filter(m=>m.role===d&&m.provider===f)){let m=l.find(k=>k.receipt_id===g.launch_id)||null;m&&!zb(g,m)||(m&&a.add(m.receipt_id),u.push(Wb(g,m,e.attempt_id,n)))}for(let g of i[d])!a.has(g.receipt_id)&&!cp(g.agent_type)&&u.push(Ub(d,f,g))}return u}function Gb(e,t){let n=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,r=[...Lb,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return c`<div class="detail-session__usage-detail">
  ...
  >
    ...
    `;let u=new Set;for(let m of o)m&&typeof m.resumed_from=="string"&&m.resumed_from.length>0&&u.add(m.resumed_from);let d=m=>{if(!(m.status==="failed"||m.status==="orphaned"))return"";let R=typeof m.session_id=="string"&&m.session_id.length>0,B=u.has(m.attempt_id),V=R&&!B,se=R?B?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":"\uC774 \uC138\uC158\uC744 \uAC19\uC740 \uC6CC\uD06C\uD2B8\uB9AC\uC5D0\uC11C \uC774\uC5B4\uC11C \uC9C4\uD589":"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00";return c`<button
      type="button"
    ...
    >
      ...
      ${m.cause}
    </div>`},g=m=>{let k=up(pa(m));if(nn(k).length===0&&!Vr(m.usage))return"";let R=a.has(m.attempt_id);return c`<button
      type="button"
    ...
    <div class="detail-sessions" data-seam="session-history">
      ${l}${o.map(m=>{let k=pa(m),R=up(k),B=nn(R);return c`<div class="detail-session-row">
          <button
            type="button"
...
`):void 0}function In(b){if(!b||typeof b!="object")return;let M=typeof b.status=="string"?b.status:"",W=typeof b.title=="string"?b.title:"";return M.length>0&&W.length>0?`${M} \xB7 ${W}`:void 0}function _r(){return(t.getWorkspacePath&&t.getWorkspacePath()||"").trim()}function Ln(){return t.depCandidates?t.depCandidates():null}async function Pn(b,M,W){let $e=_r(),nt=u;if(!nt)return;if($e.length===0){we("\uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}let rt=await Xe(b,{a:nt,b:M,view_id:nt,root_dir:$e},W),bt=rt===!0||rt!==!1&&rt.saved===!0;bt&&t.onDepChanged&&t.onDepChanged({type:b,a:nt,b:M}),b==="dep-add"&&bt&&(P="",H=!1),je()}function Xt(b){if(!u)return;let M=globalThis.confirm;typeof M=="function"&&!M(`${b}\uAC00 ${u}\uB97C \uB9C9\uB294 \uC5F0\uACB0\uC744 \uB04A\uC744\uAE4C\uC694?`)||Pn("dep-remove",b,"\uC758\uC874 \uD574\uC81C \uC2E4\uD328")}function jn(b){b.disabled||Pn("dep-add",b.bead_id,"\uC758\uC874 \uCD94\uAC00 \uC2E4\uD328")}function Pr(b){P=b.target.value,H=!0,je()}function mr(){H||(H=!0,je())}function Jn(b,M){if(b.key==="Escape"){b.stopPropagation(),P="",H=!1,je();return}b.key==="Enter"&&(b.preventDefault(),M.length===1&&!M[0].disabled&&jn(M[0]))}function kn(b){return c`<div class="detail-dep-add">
    ...
    `}let yn={route:["quick_fix","spec_backed","full_plan"]};async function as(b,M){let W=M.target.value;if(b==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&W!=="full_plan"&&!window.confirm(`full_plan \u2192 ${W||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){je();return}await Xe("update-workflow-meta",{id:u,key:b,value:W},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),je()}function ls(b){let M=b.metadata||{};return c` ${(($e,nt)=>{let rt=yn[$e],bt=typeof M[$e]=="string"?M[$e]:"";return c`<div class="detail-kv">
      ...
      </div>`})("route","(unset)")} `}function cs(b,M){return C?c`
    ...
    `}function Pe(){if(!u)return c``;let b=d||{},M=String(b.id||u),W=b.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",$e=Be(),nt=b.status||"open",rt=typeof b.priority=="number"?Math.max(0,Math.min(4,b.priority)):"",bt=b.description||"",Je={...b,metadata:{...b.metadata||{},...f}};return c`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${tp({metadata:Je.metadata,workspace_values:vt(),catalog:Wt(),execution_defaults:ut(),expanded:R,presets:Yt()?.presets||[],preset_id:g,preset_busy:m,skipped_orchestration_keys:k},{onToggle:dt=>{R=dt,je()},onEdit:(dt,$n)=>{if(dt==="impl_runtime"||dt==="impl_model"||dt==="impl_effort"){ce(xe(dt,$n??""));return}ce(K(dt,$n??""))},onPresetSelect:dt=>{g=dt,k=[],je()},onPresetApply:()=>{Ft()}})}
          ...
          ${jt(b)} ${ls(b)}
          ${Yd(b,Qe)}
          ${fp({expanded:Ze,loading:Fe,error:Z,data:X},{onToggle:J})}
          ${pp(le(),Zt,{total:$e,expanded:Ve},Oe)}
          ${mp({events:Mt,shown:ct},{onMore:q})}
        </div>
      </div>
    `}function je(){st(Pe(),e)}return{load(b){b!==u&&(f={},g="",k=[],R=!1,G(),_e(),y(),pt(),ae(),te()),u=b,d=null,!fe&&t.subscribeCandidates&&(fe=t.subscribeCandidates(()=>{u&&je()})),h(),Rt(),j!==b&&oe(b)},clear(){u=null,d=null,f={},g="",m=!1,k=[],R=!1,G(),_e(),y(),pt(),ae(),te(),E(),ge.close(),qe.close(),st(c``,e)},destroy(){Jt&&(Jt(),Jt=null),Ht&&(Ht(),Ht=null),en&&(en(),en=null),E(),document.removeEventListener("keydown",he),De.detach(),de||(ge.destroy(),Ae&&Ae.parentNode&&Ae.parentNode.removeChild(Ae)),qe.destroy(),Ne.parentNode&&Ne.parentNode.removeChild(Ne),u=null,d=null,te(),g="",m=!1,k=[],_e(),y(),pt(),ae(),st(c``,e)}}}function hp(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
      ...
      >
        ...
        >
          만료됨
            ...
            ${ro(n)}
          </p>`:""}`}function Sp(e){return typeof e!="number"||!Number.isFinite(e)?"":new Date(e).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"})}function cy(e,t){if(!e||e.open!==!0)return"";let n=Ir(e.cause)||ur(e.cause),r=e.retry&&e.retry.attempts>0?`\uC790\uB3D9 \uC7AC\uC2DC\uB3C4 ${e.retry.attempts}\uD68C \u2014 \uAC19\uC740 \uC624\uB958`:"",o=e.cause_detail,s=e.quickfix_lane&&e.quickfix_landing?e.quickfix_landing:null,i=s?[s.cursor||null,typeof s.head_sha=="string"?s.head_sha.slice(0,7):null,s.reason||null].filter(Boolean).join(" \xB7 "):"",l=typeof e.finished_at=="number"?`${new Date(e.finished_at).toLocaleString("ko-KR")} \xB7 ${on(e.finished_at,t)}`:"",a=[e.runner,e.model,e.observed_effort??e.effort,e.speed].filter(g=>typeof g=="string"&&g.length>0).join(" \xB7 "),u=e.usage?.total_cost_usd,d=typeof u=="number"&&Number.isFinite(u)?`$${u.toFixed(2)}`:"",f=Ep(e);return c`<div
  ...
  >
    ...
    <div class="rtile__foot">
      ...
      ${n}
    </div>`}function wl(e,t,n=null,r={}){let o=e.kind==="session",s=o&&Array.isArray(e.session_refs)&&e.session_refs.find(I=>I&&I.current===!0)||null,i=e.failed===!0,l=i&&e.failure||null,a=e.parked===!0&&!i,u=e.retry_wait===!0&&!i&&!a,d=e.waiting===!0&&!i&&!a&&!u,f=a&&e.failure||null,g=d&&e.wait||null,m=a||u||d,k=!!e.paused,R=i||m?e.status_label||(a?"\uC138\uC158 \uB300\uAE30":u?"\uC7AC\uC2DC\uB3C4 \uB300\uAE30":d?"\uC120\uD589 \uB300\uAE30":e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):k?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?iy(t-e.started_at):"\u2014",B=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,V=ko(e),se=nn(e.usage),j=zn(e.usage),N=e.conflict_resolution?k?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,C=e.base_exception||null,L=e.landing,F=e.attempt_id&&e.attempt_id===n,Y=r.monitor||null,Q=uy(Y),P=Zs(Y?.cross_lane_chip),H=Y?Qs(Y.dependency_chips):"",G=py(Y,t,k,o?{updated_at:e.updated_at??null,last_event_at:s&&s.locality==="local"?s.last_event_at:null}:null),te=o&&e.workflow?.chips?.exec_receipt||null,ke=Js(e.workflow),Ee=ei(e.rec,e.chip_popover?.chip_key==="rec"),oe=e.chip_popover?Qr(e.chip_popover.content):"",D=te?c`<span
        class="ctl-chip ctl-chip--exec-receipt"
  ...
  >
    ...
    ${m?my(a?"parked":u?"retry_wait":"waiting",a?f:g,it,d?H:""):i?"":c`${G}${e.rollup?Ts(e.rollup,{parent_id:e.bead_id,expanded:e.rollup_expanded===!0,childChips:sa}):""}
            ...
            ${H}
            ${o?Se:Q||P||ke||B||Ee||se.length>0||j?c`<div class="rtile__meta">
    ...
    >
    ...
    </div>`}function Et($,q){let J=q?q.active:null;return pn(J)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${$==="claude"?J.email:uo({...J,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function It($,q,J){let re=R[J],le=Object.hasOwn(g,$)?g[$]:Qt,Be=J==="claude"?Ri:uo,Ve=!!re?.accounts.some(tt=>tt.key===le);return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${q}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${q}
      ...
      ${d?c`<div class="settings-dialog__empty">불러오는 중…</div>`:c`
            ...
            ${Ie()}
          `}
    `}function ie(){Q||st(ae(),e)}return{load(){se={},l={},a={};let $=[be(),ee()];return B||$.push(ve()),Promise.all($).then(()=>{})},render:ie,sessionDraft:()=>({...i}),destroy(){Q=!0,st(c``,e)}}}function Bi(e){return c`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ...
    </div>`}function ke(T){let ee=t.doneItems?t.doneItems():[],me=t.rangeLabel?t.rangeLabel():"",ve=Pp(Array.isArray(ee)?ee:[]),Ce=_e=>T.reduce((Re,Ye)=>Re+kl(Ye,_e),0);return c`<div class="mon2-deck__bar">
      <span
...
`)}
    ...
    </div>`}function $(h){let p={runnable:T.runnable,queue:T.queue,running:T.running,pr_wait:T.pr_wait,done:T.done},_=S=>{let z=p[S.lane],K=S.lane==="runnable"?T.runnable_flat?z.length>0?pt():void 0:T.runnable_sections.length>0?pt():void 0:S.lane==="queue"?T.queue_groups.length>0||T.chain_lanes.length>0||T.parallel_rows.length>0||T.cross_lanes_unreadable?ae():void 0:S.lane==="running"?ie(h):z.length>0?c`${z.map(ce=>Sn(U(ce)))}`:void 0;return qn({id:`monitor-${S.lane}`,lane:S.pane,title:S.title,items:z,count:z.length,src:S.lane==="runnable",empty:S.empty,body:K,live:S.lane==="running"&&z.length>0,collapsible:!0,collapsed:V.isCollapsed(S.pane),controls:S.lane==="runnable"?q():void 0,header_control:J(S.lane,z.length)})};if(se){let S=Ly.map(z=>Np.find(K=>K.lane===z)).filter(z=>z!==void 0);return c`<div class="mon2-deck"></div>
  ...
  `,e.appendChild(n);let r=n.querySelector("#new-issue-form"),o=n.querySelector("#new-title"),s=n.querySelector("#new-type"),i=n.querySelector("#new-priority"),l=n.querySelector("#new-labels"),a=n.querySelector("#new-description"),u=n.querySelector("#new-issue-error"),d=n.querySelector("#btn-cancel"),f=n.querySelector("#btn-create"),g=n.querySelector(".new-issue__close");function m(){s.replaceChildren();let C=document.createElement("option");C.value="",C.textContent="\u2014 Select \u2014",s.appendChild(C);for(let L of Kp){let F=document.createElement("option");F.value=L,F.textContent=Yp(L),s.appendChild(F)}i.replaceChildren();for(let L=0;L<=4;L+=1){let F=document.createElement("option");F.value=String(L);let Y=Vp[L]||"Medium";F.textContent=`${L} \u2013 ${Y}`,i.appendChild(F)}}m();function k(){try{typeof n.close=="function"?n.close():n.removeAttribute("open")}catch{n.removeAttribute("open")}}function R(C){o.disabled=C,s.disabled=C,i.disabled=C,l.disabled=C,a.disabled=C,d.disabled=C,f.disabled=C,f.textContent=C?"Creating\u2026":"Create"}function B(){u.textContent=""}function V(C){u.textContent=C}function se(){try{let C=window.localStorage.getItem("beads-ui.new.type");C?s.value=C:s.value="";let L=window.localStorage.getItem("beads-ui.new.priority");L&&/^\d$/.test(L)?i.value=L:i.value="2"}catch{s.value="",i.value="2"}}function j(){let C=s.value||"",L=i.value||"";C.length>0&&window.localStorage.setItem("beads-ui.new.type",C),L.length>0&&window.localStorage.setItem("beads-ui.new.priority",L)}async function N(){B();let C=String(o.value||"").trim();if(C.length===0){V("Title is required"),o.focus();return}let L=Number(i.value||"2");if(!(L>=0&&L<=4)){V("Priority must be 0..4"),i.focus();return}let F=String(s.value||""),Y=String(a.value||""),Q={title:C};F.length>0&&(Q.type=F),String(L).length>0&&(Q.priority=L),Y.length>0&&(Q.description=Y),R(!0);try{await t("create-issue",Q)}catch{R(!1),V("Failed to create issue");return}j(),R(!1),k()}return n.addEventListener("cancel",C=>{C.preventDefault(),k()}),g.addEventListener("click",()=>k()),d.addEventListener("click",()=>k()),n.addEventListener("keydown",C=>{C.key==="Enter"&&(C.ctrlKey||C.metaKey)&&(C.preventDefault(),N())}),r.addEventListener("submit",C=>{C.preventDefault(),N()}),{open(){r.reset(),B(),se();try{"showModal"in n&&typeof n.showModal=="function"?n.showModal():n.setAttribute("open","")}catch{n.setAttribute("open","")}setTimeout(()=>{try{o.focus()}catch{}},0)},close(){k()}}}var Dy=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked\xB7\uC0AC\uC6A9\uC790 \uB9AC\uBDF0 \uD544\uC694 \uCE69"],["stepper","stepper"]];function My(e,t){return ra(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function Qp(e,t,n){return c`
  ...
  `}var Ny=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function ef(e,t){let{transport:n,policyStore:r,labelOptions:o}=t,s=t.notify||(te=>we(te,"error",4e3)),i=document.createElement("dialog");i.id="settings-dialog",i.className="settings-dialog",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","\uC124\uC815"),e.appendChild(i);let l="execution",a=!1,u="",d=null;function f(){if(d)return d;let te=i.querySelector('[data-pane="execution"]');return te?(d=Fi(te,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:s,onQueueAdopt:ke=>t.queueStore?.set?.(ke)}),d):null}function g(){return c`
    ...
    `}function m(){let te=r.get();return c`
      ...
      >
        ...
        ${te?c`
              ${Qp(te,o(),V)}
              ${Zp(te,u,{onDraft:ke=>{u=ke},onAdd:se,onRemove:j})}
              ${Jp(te,N)}
            `:c`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function k(te){let ke=r.get();if(ke)try{let Ee=await n("display-policy-set",{expected_revision:ke.revision,policy:te(ke)});R(Ee),Ee&&Ee.conflict&&Ee.policy&&(Ee=await n("display-policy-set",{expected_revision:Ee.policy.revision,policy:te(Ee.policy)}),R(Ee)),Ee&&Ee.conflict&&s("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{s("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function R(te){te&&te.policy&&typeof te.policy=="object"&&r.set(te.policy)}function B(te){k(te)}function V(te){let ke=r.get();if(!ke)return;let Ee=!qy(te,ke);B(oe=>jy(te,oe,Ee))}function se(){let te=u.trim();te.length!==0&&(u="",B(ke=>ke.hidden_prefixes.includes(te)?{hidden_prefixes:ke.hidden_prefixes}:{hidden_prefixes:[...ke.hidden_prefixes,te]}),C())}function j(te){B(ke=>({hidden_prefixes:ke.hidden_prefixes.filter(Ee=>Ee!==te)}))}function N(te){let ke=r.get();if(!ke)return;let Ee=ke.chips[te]===!1;B(()=>({chips:{[te]:Ee}}))}function C(){st(c`
    ...
    </span>`}function C(oe,D,be){let Se=uf(D,be),T=D.available&&(D.held||Se>$l),ee=T?`${Math.floor(Se/60)}\uBD84 \uC804 \uCE21\uC815`:"",me=D.accounts.filter(Re=>!Re.active).length,ve=`usage-meter__group${T?" usage-meter__group--stale":""}`,Ce=c`<span class="usage-meter__provider"
        >${oe.label}</span
      >
    ...
    >
      ...
      ${oe.map(be=>C(be.provider,be.snapshot,D))}
    </span>`}function F(oe,D){let be=sf(oe.pct),Se=rf(oe.resetsAt,D);return c`<span
      class="usage-meter__account-window ${of(be)}"
      style=${`--progress: ${be}%`}
    >
    ...
    </div>`}function G(){let oe=Date.now(),D=[];for(let Se of af){let T=s.get(Se.key);T&&D.push({provider:Se,snapshot:Yy(T,oe)})}if(D.length===0){m(),u();return}let be=D.find(Se=>Se.provider.key===n&&Se.snapshot.accounts.length>0);be||m(),st(L(D,oe),e),e.hidden=!1,be?te(be,oe):f()}function te(oe,D){let be=d(),Se=e.getBoundingClientRect(),T=e.ownerDocument.documentElement.clientWidth;be.style.setProperty("--usage-meter-anchor-top",`${Se.bottom}px`),be.style.setProperty("--usage-meter-anchor-right",`${Math.max(0,T-Se.right)}px`),st(c`<div
          class="usage-meter__scrim"
          aria-hidden="true"
          @mousedown=${se}
        ></div>
        ${H(oe,D)}`,be)}async function ke(oe){try{let D=await fetch(oe.endpoint);return D.ok?Ky(await D.json(),Date.now()):{kind:"error"}}catch{return{kind:"error"}}}async function Ee(){l+=1;let oe=l,D=await Promise.all(af.map(async be=>({provider:be,read:await ke(be)})));if(!(t||oe!==l)){for(let be of D){let Se=be.provider.key;if(be.read.kind==="ok"){s.set(Se,be.read.snapshot);continue}if(be.read.kind==="empty"){s.delete(Se);continue}let T=s.get(Se);T!==void 0&&!T.held&&s.set(Se,{...T,held:!0})}G()}}return u(),Ee(),o=setInterval(()=>{Ee()},6e4),{destroy(){t=!0,o!==null&&(clearInterval(o),o=null),m(),u()}}}function rs(e){let t=e?.blocked_info;return t&&typeof t=="object"?Array.isArray(t.blockers)?t.blockers.filter(r=>typeof r=="string"&&r.length>0):[]:(Array.isArray(e?.dependencies)?e.dependencies:[]).map(r=>{if(typeof r=="string")return r;if(!r||typeof r!="object")return"";let o=r.type??r.dependency_type;return o!==void 0&&o!=="blocks"?"":r.depends_on_id||r.id||""}).filter(Boolean)}var _f="bdui.worker.candidate_sort",os=Object.freeze([{id:"spec",label:"spec \uC6B0\uC120",chain:[{key:"spec",dir:"desc"},{key:"created",dir:"asc"}]},{id:"bottleneck",label:"\uBCD1\uBAA9 \uC6B0\uC120",chain:[{key:"priority",dir:"asc"},{key:"dependents",dir:"desc"},{key:"released",dir:"desc"}]},{id:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131",chain:[{key:"created",dir:"desc"},{key:"priority",dir:"asc"}]},{id:"updated",label:"\uCD5C\uC2E0 \uC218\uC815",chain:[{key:"updated",dir:"desc"}]}]),Ui=Object.freeze({preset:"spec"}),mf=3,gf=Object.freeze([{key:"priority",label:"\uC6B0\uC120\uC21C\uC704"},{key:"dependents",label:"\uD6C4\uC18D \uC218"},{key:"released",label:"\uD574\uC81C \uC2DC\uAC01"},{key:"spec",label:"spec \uC720\uBB34"},{key:"created",label:"\uC0DD\uC131"},{key:"updated",label:"\uC218\uC815"}]);function pf(e){return os.some(t=>t.id===e)}function ff(e){let t=os.find(n=>n.id===e);return t?t.chain.map(n=>({...n})):[]}function Vy(e,t){return e.length===t.length&&e.every((n,r)=>n.key===t[r].key&&n.dir===t[r].dir)}function ss(e){return e&&"preset"in e?ff(e.preset):e&&Array.isArray(e.chain)?e.chain.map(t=>({...t})):ff("spec")}function xl(e){return e&&"preset"in e?e.preset:null}function Lr(e){if(typeof e=="string"){let s;try{s=JSON.parse(e)}catch{return pf(e)?{preset:e}:Ui}return Lr(s)}if(!e||typeof e!="object")return Ui;let t=e;if(pf(t.preset))return{preset:t.preset};let n=t.chain;if(!Array.isArray(n)||n.length===0||n.length>mf||!n.every(Ji))return Ui;let r=[];for(let s of n)r.some(i=>i.key===s.key)||r.push({key:s.key,dir:s.dir});let o=os.find(s=>Vy(s.chain,r));return o?{preset:o.id}:{chain:r}}function hf(){try{return Lr(window.localStorage.getItem(_f))}catch{return Ui}}function Al(e){try{window.localStorage.setItem(_f,JSON.stringify(e))}catch{}}function bf(e,t,n){let r=e.map(a=>({...a}));if(!n)return r.slice(0,t);if(!Object.prototype.hasOwnProperty.call(ks,n))return r;let o=n;if(r.slice(0,t).some(a=>a.key===o))return r.slice(0,t);let s={key:o,dir:r[t]&&r[t].key===o?r[t].dir:ks[o]},i=r.slice(0,t),l=r.slice(t+1).filter(a=>a.key!==o);return[...i,s,...l].slice(0,mf)}function yf(e,t){return e.map((n,r)=>r===t?{key:n.key,dir:n.dir==="asc"?"desc":"asc"}:{...n})}function Xy(e){let t=new Set(e.map(l=>l.id)),n=new Map,r=new Map;for(let l of e){let a=rs(l).filter(u=>t.has(u));n.set(l.id,a);for(let u of a){let d=r.get(u);d?d.push(l):r.set(u,[l])}}let o=new Set,s=[],i=l=>{o.add(l.id),s.push(l);for(let a of r.get(l.id)??[])!o.has(a.id)&&(n.get(a.id)??[]).every(u=>o.has(u))&&i(a)};for(;s.length<e.length;){let l=e.find(a=>!o.has(a.id)&&(n.get(a.id)??[]).every(u=>o.has(u)));i(l??e.find(a=>!o.has(a.id)))}return s}function vf(e,t){let n=Array.isArray(e)?e.slice():[];return n.sort(pc(ss(t))),Xy(n)}function wf(e,t){let n=new Map;if(!e||typeof e!="object")return n;let r=e,o=[],s=new Set;for(let i of t){if(s.has(i.id))continue;s.add(i.id);let l=r[i.id];if(!l||!Array.isArray(l.scope))continue;let a=l.scope.filter(u=>typeof u=="string"&&u.length>0);if(a.length===0){n.set(i.id,{overlaps:[],scope_missing:!0});continue}n.set(i.id,{overlaps:[],scope_missing:!1}),o.push({member:i,scope:a})}for(let i=0;i<o.length;i+=1)for(let l=i+1;l<o.length;l+=1){let a=Hs(o[i].scope,o[l].scope);if(a.length===0)continue;let u=o[i].member,d=o[l].member;n.get(u.id)?.overlaps.push({id:d.id,title:d.title,location_label:d.location_label,prefixes:a}),n.get(d.id)?.overlaps.push({id:u.id,title:u.title,location_label:u.location_label,prefixes:a})}return n}var kf=new Set(["sh","bash","zsh","dash","ksh"]),$f=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function xf(e){let t=e.split("/");return t[t.length-1]||""}function Qy(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let n=t.slice(2).trim().split(/\s+/).filter(Boolean);if(n.length===0)return!1;let r=xf(n[0]);if(r!=="env")return kf.has(r);let o=n.slice(1).find(s=>!s.startsWith("-")&&!s.includes("="));return o!==void 0&&kf.has(xf(o))}function Zy(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function Jy(e){let t=[],n=0;$f.lastIndex=0;for(let r of e.matchAll($f)){let o=r.index;o>n&&t.push({text:e.slice(n,o),kind:"plain"}),t.push({text:r[0],kind:Zy(r[0])}),n=o+r[0].length}return n<e.length&&t.push({text:e.slice(n),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function ev(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function Af(e){let t=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),r=document.createElement("div");r.className="repo-ops-script-viewer-root",document.body.appendChild(r);let o=null,s="loading",i="",l="",a=0,u=null,d=!1;function f(C,L){return L?Jy(C).map(F=>F.kind==="plain"?F.text:c`<span
            class="repo-ops-script-viewer__token repo-ops-script-viewer__token--${F.kind}"
            >${F.text}</span
          >`):C}function g(){if(!o)return c``;let C=s==="ready"&&Qy(i),L=s==="ready"?i.split(`
`):[];return c`<div
        ...
        <div class="repo-ops-script-viewer__body" aria-live="polite">
          ${s==="loading"?c`<div class="repo-ops-script-viewer__status">
                ...
                >
                  ...
                  ${L.map((F,Y)=>c`<div class="repo-ops-script-viewer__row">
                        <span
    ...
    </div>`}function m(){st(g(),r)}async function k(){if(s!=="ready")return;let C=await sn(i);we(C?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",C?"success":"error")}function R(C){C.key==="Escape"&&o&&(C.preventDefault(),j())}function B(){d||(document.addEventListener("keydown",R),d=!0)}function V(){d&&(document.removeEventListener("keydown",R),d=!1)}async function se(C,L=null){let F=++a;B(),o={...C},u=L||(document.activeElement instanceof HTMLElement?document.activeElement:null),s="loading",i="",l="",m(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let Q=t?t():"";if(!Q){s="error",l="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",m();return}if(!n){s="error",l="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",m();return}let P="/api/repo-ops-script?workspace="+encodeURIComponent(Q)+"&lane="+encodeURIComponent(C.lane)+"&base_sha="+encodeURIComponent(C.base_sha);try{let H=await n(P),G=await H.json().catch(()=>({}));if(F!==a)return;if((t?t():"")!==Q){j();return}if(!H.ok||!G||G.ok!==!0){s="error",l=ev(G&&typeof G.error=="string"?G.error:""),m();return}o={lane:G.lane,base_sha:G.base_sha,path:G.path,base_ref:G.base_ref},i=String(G.content),s="ready",m()}catch{if(F!==a)return;s="error",l="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",m()}}function j(){a+=1,V(),o=null,i="",m();let C=u;u=null,C?.isConnected&&C.focus()}function N(){j(),r.remove()}return{open:se,close:j,destroy:N}}var Sf={deploy_not_declared:"\uC120\uC5B8 \uC5C6\uC74C",deploy_opted_out:"\uC774 workspace\uC5D0\uC11C \uBC30\uD3EC \uC2E4\uD589\uC774 \uAEBC\uC838 \uC788\uC74C",deploy_in_flight:"\uBC30\uD3EC \uC9C4\uD589 \uC911",target_unresolved:"\uB300\uC0C1 tip\uC744 \uD655\uC815\uD558\uC9C0 \uBABB\uD568",remote_history_not_monotonic:"\uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC\uC640 \uC6D0\uACA9 \uC774\uB825\uC774 \uAC08\uB77C\uC9D0"},tv=new Set(["queued","running","retry_pending"]);function Ef(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),o=e.onOpenScript;function s(){return t&&t.get()||{}}function i(){let P=s();return typeof P.revision=="number"?P.revision:0}function l(P){t&&P&&P.queue&&typeof P.queue=="object"&&t.set(P.queue)}function a(){let P=s().workspace_info;return P&&typeof P=="object"?P:{}}function u(P,H){return c`<span
    ...
    ></button>`}function m(){let P=s().repo_operations;return Array.isArray(P)?P:[]}function k(){let P=a().repo_ops,H=P&&typeof P=="object"?P.repo_id:null;return typeof H=="string"&&H?H:null}function R(){return m().some(P=>P&&P.kind==="deploy"&&tv.has(P.state))}function B(){let P=R(),H=k()===null;return c`<button
      type="button"
      ...
      >
        ...
        <span class="worker-repo-ops__lane-v"
          >${P.deploy?c`${g("deploy",P,P.deploy)}
              ...
              ${Ee?u("skipped","\uC774 workspace\uC5D0\uC11C \uAC74\uB108\uB700"):B()}`:c`선언 없음${u("absent","\uBC30\uD3EC \uC5C6\uC74C")}`}</span
        >
        <span class="worker-repo-ops__lane-d"
  ...
  >
    ...
    <div class="worker-ev__body">
      ...
      ${If(ur(t.reason),typeof t.retry_count=="number"&&t.retry_count>0?`${t.retry_count}\uD68C \uC790\uB3D9 \uC7AC\uC2DC\uB3C4 \uD6C4\uC5D0\uB3C4 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uBA74 \uBA48\uCD98 \uB2E8\uACC4\uBD80\uD130 \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4.`:"\uC815\uB9AC\uB97C \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uBA74 \uBA48\uCD98 \uB2E8\uACC4\uBD80\uD130 \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4.",!0)}
...
\uC9C1\uC804 \uB9AC\uBDF0 \uC138\uC158 \uC885\uB8CC \uC0AC\uC720: ${e.review_session.failure}`,alert:!0})}return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:s,alert:!0})}return e.gate?.reason==="spec_id_missing"?n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0}):r.length>0?n(`\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694 \xB7 ${r[0]}`,{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${r.join(", ")}`,alert:!0}):e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Ff(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Ff(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function rw(e,t,n,r,o=null,s=null,i=null,l=!1,a=null,u=!0,d=null,f=null,g=null,m={},k=!1,R={},B=null,V={active:!1,failure:null,origin:null},se=!1){let j=!!a&&a.position>0,N=!!a?.continuation_action&&a.continuation_action.continuation===null,C=!!a&&a.active===!0,L=a&&a.failure||null,F=Kv(a?a.waiting:null),Y=n[e]||null,Q=Y&&Y.gate?Y.gate:null,P=Y&&Y.pr?Y.pr:null,H=Yv(a?a.resolution:null),G=Qv(g),te=Jv(g,G),ke=a&&a.authority||null,Ee=a&&a.review_dispatch||null,oe=a?.hold?.auto_review_wait==="slot"?"slot":null,D=!!g&&typeof g=="object"&&Xv.has(g.phase),be=j&&!C&&(!ke||D||ke.source==="automatic"&&!k),Se=i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":H?H.badge:i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":F,T=!!Q&&Q.base_badge==="\uCDA9\uB3CC",ee=!!Q&&Q.enabled===!0,me=Do({bead_id:e,merge_sha:R.merge_sha,cleanup_cursor:R.cleanup_cursor,merge_progress:s&&s.merge_progress?s.merge_progress:null,cleanup_failed:r,repo_operations:R.repo_operations}),ve=li(me),Ce=s&&!me&&(s.queueing??null)?s.queueing:null,_e=!!r&&["repo_operations","post_merge_jobs","child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!Q&&Q.tier==="merged",Re=r&&r.step==="repo_operations"&&me?.failed===!0&&(me.step==="deploy"||me.step==="verify")?me.step:null,Ye=l&&!!r&&!!Q&&Q.tier==="merged",it=be&&(ee||T||Q?.reason==="base_behind"||Tl.has(Q?.reason)||_e||Ye),I=Tl.has(Q?.reason),ue=l&&T&&u===!1,ne=Yn(m,e,{external:l,merge_active:C||me?.step==="merge",merge_queued:j,conflict_active:!!i,cleanup_active:ve,merged:!!r||Q?.tier==="merged"}),de=!!ne.operation,Ae=!!r||g?.phase==="needs_human"||!!ne.error,ge=j&&!L&&!N&&!_e&&!(te&&te.lock_actions),Ne=nw({auto_pending:ge,continuation_required:N,queueing:Ce,merge_step:me,conflict_badge:Se,conflict_live:H?.live===!0||i==="running",auto_resolution:G,recovery:te,cleanup_failed:r,cleanup_label:r?Tr(r.step):null,base_exception:f,conflicting:T,gate:Q,receipt_check:Y&&Y.receipt_check?Y.receipt_check:null,queue_failure:L,auto_skip:d,queued:j,queue_active:C,queue_position:a?a.position:0,review_session:V,review_dispatch:Ee,auto_review_wait:oe,activity:Se?null:s&&s.activity||null}),qe=Ne?.live===!0&&Ne.title?c`<span title=${Ne.title}>${Ne.label}</span>`:Ne?.label||null,Ze=tw(Y&&Y.receipt_check?Y.receipt_check:null);return{id:e,title:l?c`${t}<span class="muted"> · 세션</span>`:t,reason:r&&me?.active!==!0?ai(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",...B?{dependency_chips:B}:{},external:l,pr_number:P&&typeof P.number=="number"?P.number:null,pr_url:P&&typeof P.url=="string"?P.url:"",completion_badge:Ne?.live!==!0&&Ne?.title?Ne.label:null,completion_title:Ne?.title||"",...g?.phase==="needs_human"&&typeof g.log_path=="string"&&g.log_path.length>0?{log_path:g.log_path}:{},...Ze.length>0?{receipt_badge:{codes:Ze}}:{},badges:qe?[qe]:[],live_badge:Ne?.live===!0?qe:null,usage:o,alert:Ne?.alert===!0,merge_action:Q?.tier==="merged"&&!_e&&!Ye?!1:!j||N||be||I,cancel_action:j&&!N,cancel_enabled:!C&&!(te&&te.lock_actions),cancel_title:te&&te.lock_actions?`${te.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:C?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:ne,discard_action:ne.action,resolve_action:Ae,resolve_enabled:!se,resolve_title:se?"\uC138\uC158 \uAE30\uB3D9 \uC694\uCCAD \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":"\uC774 \uC2E4\uD328\uB97C \uC0AC\uB78C\uC774 \uC774\uC5B4\uBC1B\uB294 \uB300\uD654\uD615 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 \u2014 \uAE30\uB85D\uB41C \uC138\uC158\uC774 \uC788\uC73C\uBA74 fork\uD558\uACE0, \uC5C6\uC73C\uBA74 \uC0C8 \uC138\uC158\uC5D0 \uC0AC\uC720\uB97C \uC2E3\uC2B5\uB2C8\uB2E4",merge_step:me,discard_enabled:ne.enabled,discard_title:ne.title,merge_enabled:!me&&!Ce&&!i&&!de&&!f&&!(te&&te.lock_actions)&&!ue&&V.active!==!0&&(ee||T||Q?.reason==="base_behind"||I||_e||Ye||it||D&&!C),merge_label:N?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":_e||Ye?Re==="deploy"?"\uBC30\uD3EC \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":Re==="verify"?"\uAC80\uC99D \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":"\uC815\uB9AC \uC7AC\uC2DC\uB3C4":T&&!me&&!_e?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":Q?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":I?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":be?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:de?ne.error?`\uD3D0\uAE30 \uC2E4\uD328: ${ne.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${ne.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:N?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":Ce?"\uC694\uCCAD\uC744 \uBCF4\uB0B4\uB294 \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":me?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${me.label}`:Re?`\uBA38\uC9C0 \uC644\uB8CC \u2014 ${Re==="deploy"?"\uBC30\uD3EC":"\uAC80\uC99D"} \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC2E4\uD328\uD574 \uC815\uB9AC\uAC00 \uBA48\uCDC4\uC2B5\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uC800\uC7A5\uC18C \uC791\uC5C5\uBD80\uD130 \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4`:Ye?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC2DC\uB3C4\uD569\uB2C8\uB2E4":ue?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":_e?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uB2E4\uC2DC \uC2DC\uB3C4\uD569\uB2C8\uB2E4":T?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":Q?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V.active===!0?V.origin==="auto"?"\uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uB05D\uB098\uBA74 \uC601\uC218\uC99D\uC744 \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uB05D\uB098\uBA74 \uC601\uC218\uC99D\uC744 \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":Q?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uB9AC\uBDF0\uB9CC \uC218\uD589\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":Q?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":Q?.reason==="review_receipt_invalid"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uAE30\uB85D\uC774 \uC131\uB9BD\uD558\uC9C0 \uC54A\uC74C \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":Q?.reason==="review_receipt_undetermined"?"\uB9AC\uBDF0 \uC601\uC218\uC99D ancestry probe \uBBF8\uC644\uB8CC \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC0C8 \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":Q?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":ee?`\uBA38\uC9C0 (${Q.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:Q&&Q.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${Q&&Q.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Cl(e,t={}){let{transport:n,issueStores:r,queueStore:o,sessionLogStore:s,gotoIssue:i,getWorkspacePath:l,switchWorkspace:a,openDoc:u,doneRange:d,onDoneRangeChange:f}=t,g=r?Ur(r):null,m=Mv(),k=null,R=null,B=Xr(()=>_()),V=new Map,se=new Map,j=hf(),N=xl(j)===null,C=d?Dn(d):jv();function L(){let v=Mr.find(w=>w.value===C);return v?v.label:"\uC624\uB298"}let F=Pi("beads-ui.worker.lane-collapsed"),Y=!1,Q=new Set,P=new Set,H=new Set;function G(v,w){return!w?.error||!v?{}:{resolve_action:!0,resolve_enabled:!H.has(v),resolve_title:H.has(v)?"\uC138\uC158 \uAE30\uB3D9 \uC694\uCCAD \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":"\uC2E4\uD328\uD55C \uD3D0\uAE30\uB97C \uC0AC\uB78C\uC774 \uC774\uC5B4\uBC1B\uB294 \uB300\uD654\uD615 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 \u2014 \uAE30\uB85D\uB41C \uC138\uC158\uC774 \uC788\uC73C\uBA74 fork\uD558\uACE0, \uC5C6\uC73C\uBA74 \uC0C8 \uC138\uC158\uC5D0 \uC0AC\uC720\uB97C \uC2E3\uC2B5\uB2C8\uB2E4"}}let te=new Set,ke=new Set,Ee=new Set,oe=null,D=[],be=Nf({queueStore:o,issueStores:r,transport:n,getWorkspacePath:l,onInvalidate:()=>_()});function Se(){be.refreshSessionDefaults()}let T=document.createElement("div");T.className="worker-console";let ee=document.createElement("div");ee.className="worker-top";let me=document.createElement("div");me.className="worker-drawer-overlay",me.hidden=!0;let ve=document.createElement("div");ve.className="worker-drawer-overlay__backdrop";let Ce=document.createElement("div");Ce.className="worker-drawer-host";let _e=document.createElement("div");_e.className="worker-drawer-host",_e.hidden=!0,me.append(ve,Ce,_e);let Re=document.createElement("div");Re.className="worker-lanes-host",T.append(ee,me,Re),e.appendChild(T);let Ye=ar(null,null),it=[],I=Mi({transport:n,console_el:T,getLanes:()=>Ye,getWorkspaces:()=>it,getCrossLanes:()=>null,reproject:()=>({lanes:q(),raw_lanes:null}),onCorrection:()=>{},showToast:we,requestRender:()=>_(),adoptQueue:(v,w)=>{o&&o.set(w)},onDragBegin:()=>{k=null}}),ue=null,ne=co(Ce,{transport:n,sessionLogStore:s,onClose:()=>{ue=null,me.hidden=!0,_()}}),de=Lf(_e,{onClose:()=>{_e.hidden=!0,me.hidden=!0,_()}}),Ae=Af({getWorkspacePath:l||(()=>"")}),ge=l&&l()||"",Ne=Ef({queueStore:o,transport:n,onChanged:()=>_(),onOpenScript:(v,w)=>{Ae.open(v,w)}});function qe(){return o&&o.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Wi,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function Ze(){let v=qe(),w=typeof v.serial_lane_count=="number"&&Number.isInteger(v.serial_lane_count)&&v.serial_lane_count>0?Math.min(v.serial_lane_count,5):0,O=Array.isArray(v.serial_lanes)?v.serial_lanes:[],pe=[];for(let Me of O){if(pe.length>=w)break;!Me||typeof Me.id!="string"||!/^s[1-5]$/.test(Me.id)||!Array.isArray(Me.entries)||pe.push({id:Me.id,label:`\uC9C1\uB82C ${Me.id.slice(1)}`,count:Me.entries.length})}return pe.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(v.queue)?v.queue:[]).length},...pe]}function Fe(v){if(!k||!v.some(O=>O.id===k))return null;let w=Ze();return w?{bead_id:k,lanes:w}:null}function Z(){return l&&l()||""}async function X(v,w){await I.sendOp({type:"worker-queue-place",payload:{bead_id:v,...w==="parallel"?{}:{lane:w}},root_dir:Z()},v)}function Te(){let v=qe();return typeof v.revision=="number"?v.revision:0}function He(v){v&&v.queue&&o&&o.set(v.queue)}async function at(v){if(!n||!v)return;let w=await n("worker-attempt-pause",{attempt_id:v});w&&w.paused===!1&&w.reason&&we(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${w.reason}`,"error",2400)}async function y(v,w="session"){if(!n||!v)return;let O=await Gr();if(O===null)return;let pe=async(Me={})=>await n("worker-attempt-resume",{attempt_id:v,expected_revision:Te(),...O!==""?{instructions:O}:{},...Me}),ye=await pe();He(ye),ye&&ye.conflict&&(ye=await pe(),He(ye)),ye=await Wn(ye,(Me,Qe)=>pe({continuation:Me,decision_token:Qe}),{onResult:He,refresh:()=>pe()}),ye&&ye.resumed===!1&&!ye.conflict&&ye.reason&&we(`${w==="settlement"?"\uC815\uC0B0 \uC7AC\uAC1C":"\uC774\uC5B4\uD558\uAE30"} \uAC70\uBD80: ${ye.reason}`,"error",2400)}async function U(v,w,O=!0){if(!n)return null;let pe=n,ye=await pe(v,{...w,expected_revision:Te()});return He(ye),ye&&ye.conflict&&O&&(ye=await pe(v,{...w,expected_revision:Te()}),He(ye)),ye}async function Oe(v){if(!n||!v)return;let w=qe().merge_queue?.find(pe=>pe.bead_id===v)?.continuation_action;if(w?.mismatch&&w.continuation===null){await Et(v,w.mismatch);return}Q.add(v),_();let O;try{O=await U("worker-merge-queue-add",{bead_id:v})}catch{we("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{Q.delete(v),_()}if(!(!O||O.applied)){if(O.conflict){we("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}we(Uv(O.reason),"error",2400)}}async function Ie(v){if(!(!n||!v||P.has(v))){P.add(v),_();try{let w=await n("worker-cleanup-retry",{bead_id:v,expected_revision:Te()});He(w),w&&!w.retried&&!w.conflict&&w.reason&&we(`\uC815\uB9AC \uC7AC\uC2DC\uB3C4 \uAC70\uBD80: ${w.reason}`,"error",2400)}finally{P.delete(v),_()}}}async function Ue(v){if(!(!n||!v||H.has(v))){H.add(v),_();try{let w=await n("worker-resolve-in-session",{bead_id:v,expected_revision:Te()});He(w),we(Hv(w),Gv(w),4e3)}finally{H.delete(v),_()}}}async function Ke(v,w){let O=qe().hold;if(!n||!O||typeof O.since!="number")return;let pe=await n(v,{since:O.since});He(pe),pe&&pe.ok===!1&&we(`${w}: ${pe.reason==="hold_changed"?"\uD050 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694":pe.reason||""}`,"error",2800)}async function pt(v,w){if(!n||!v||!w)return;let O=await n("worker-parked-retry",{bead_id:v,attempt_id:w});He(O),O&&O.ok===!1&&we(`\uC7AC\uC2DC\uB3C4 \uAC70\uBD80: ${O.reason==="not_latest"?"\uC774 bead\uC5D0 \uB354 \uC0C8\uB85C\uC6B4 \uC2DC\uB3C4\uAC00 \uC788\uC2B5\uB2C8\uB2E4":O.reason||""}`,"error",2800)}async function Et(v,w){let O=await Wn({continuation_mismatch:w},(ye,Me)=>U("worker-merge-queue-add",{bead_id:v,continuation:ye,decision_token:Me},!1)),pe=O?.queue?.merge_queue?.find(ye=>ye.bead_id===v)?.continuation_action;if(O?.applied!==!0&&pe?.continuation===null&&pe.mismatch){await Et(v,pe.mismatch);return}O&&O.applied===!1&&!O.conflict&&we("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function It(v){if(!n)return;let w=await U("worker-merge-auto-toggle",{on:v});!w||w.conflict||we(v?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",v?"success":"info",2400)}async function Mt(v){if(!n||!v)return;let w=await U("worker-merge-queue-remove",{bead_id:v});w&&!w.conflict&&!w.applied&&w.reason==="merge_active"&&we("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function mt(){await U("worker-merge-queue-remove",{all:!0})}async function ct(v,w=null,O="unmerged",pe=null){if(!n||!v)return;let ye=Io(v,O);if(!(!!pe||typeof globalThis.confirm!="function"||globalThis.confirm(ye)))return;let Qe=await n("worker-discard",{bead_id:v,...w?{attempt_id:w}:{},...pe?{operation_id:pe}:{},expected_revision:Te()});if(He(Qe),Qe&&Qe.conflict&&(Qe=await n("worker-discard",{bead_id:v,...w?{attempt_id:w}:{},...pe?{operation_id:pe}:{},expected_revision:Te()}),He(Qe)),Qe&&Qe.discarded===!0){we(Vs(Qe),"success",5e3);return}if(Qe&&Qe.reason){we(`\uD3D0\uAE30 \uC2E4\uD328: ${Qe.reason}`,"error",2800);return}if(Qe&&Qe.accepted&&Qe.pending==="merged_revert"){we("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(Qe&&Qe.accepted&&!Qe.discarded){we(`\uD3D0\uAE30 \uC9C4\uD589: ${Qe.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}Qe&&!Qe.conflict&&we("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function $t(v,w,O){if(!(!n||!w||!O||ke.has(w))){ke.add(w),_();try{let pe=await n(v,{bead_id:w,action_id:O,expected_revision:Te()});He(pe),pe?.conflict?we("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!pe?.ok&&pe?.reason&&we(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(pe.reason)}`,"error",2800)}finally{ke.delete(w),_()}}}async function Ct(v,w){if(!n||!w||te.has(w))return;te.add(w),_();let O;try{let pe=async(ye={})=>await n(v,{bead_id:w,expected_revision:Te(),...ye});O=await pe(),He(O),O&&O.conflict&&(O=await n(v,{bead_id:w,expected_revision:Te()}),He(O)),v==="worker-revise-fix"&&(O=await Wn(O,(ye,Me)=>pe({continuation:ye,decision_token:Me}),{onResult:He,refresh:()=>pe()}))}finally{te.delete(w),_()}if(!(!O||O.conflict)){if(O.ok){we(v==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}we(`\uCC98\uBD84 \uAC70\uBD80: ${O.reason||""}`,"error",3e3)}}async function Lt(v){if(!n)return;let w=await n("worker-automation-toggle",{on:v,expected_revision:Te()});He(w),w&&w.conflict&&await n("worker-automation-toggle",{on:v,expected_revision:Te()}).then(He)}async function ae(v){if(!n||!v)return;let w=await n("worker-repo-operation-dismiss",{operation_id:v});He(w),w&&w.ok===!1&&we(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${w.reason||""}`,"error",3e3)}async function ie(v){if(!n||!Number.isFinite(v))return;let w=Math.max(Wi,Math.floor(v)),O=await n("worker-queue-set-slots",{slots:w,expected_revision:Te()});He(O),O&&O.conflict&&await n("worker-queue-set-slots",{slots:w,expected_revision:Te()}).then(He)}async function $(v){if(!n||!Number.isInteger(v)||v<1||v>qf)return;let w=qe(),O=(Array.isArray(w.serial_lanes)?w.serial_lanes:[]).slice(v).reduce((Me,Qe)=>Me+(Array.isArray(Qe?.entries)?Qe.entries.length:0),0),pe=()=>({count:v,expected_revision:Te()}),ye=await n("worker-queue-set-serial-lane-count",pe());He(ye),ye&&ye.conflict&&(ye=await n("worker-queue-set-serial-lane-count",pe()),He(ye)),ye&&ye.applied&&O>0&&we(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${O}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}function q(){let v=wr(C),w=be.read({candidate_sort:j,done_since:v});return it=w.workspaces,Ye=ar(w.workspaces,w.workspaces_state,{done_since:v,candidate_filter:m,candidate_hidden_counts:"per_control",candidate_sort:"as_given",groups:"all"}),Ye}function J(v){return v.queue_groups[0]||Dv}function re(v){let w=v.dependency_chips||null,O={...w&&w.released?{released:w.released}:{},...w&&w.dependents?{dependents:w.dependents}:{}},pe=V.get(v.id),ye=se.get(v.id)||null,Me=pe&&pe.overlaps.length>0?pe.overlaps:null,Qe=!!pe&&pe.scope_missing;return!ye&&!Me&&!Qe&&Object.keys(O).length===0?null:{...O,...ye?{predecessors:ye}:{},...Me?{overlaps:Me}:{},...Qe?{scope_missing:!0}:{}}}function le(v){return{...v,workspace_name:"",done_layout:void 0,dependency_chips:re(v)||void 0,chip_popover:Be(v)}}function Be(v){return ni(v,w=>B.isOpen({bead_id:v.id,chip_key:w}))}function Ve(){let v=qe(),w=new Map;for(let O of Object.values(fn(v.lane_states))){let pe=Array.isArray(O?.corrections)?O.corrections:[];for(let ye of pe)ye&&typeof ye.bead_id=="string"&&typeof ye.after=="string"&&w.set(ye.bead_id,ye.after)}return{admission:fn(v.admission),correction_after:w}}function tt(v,w){let O=le(v),pe=Ou(w.admission[v.id]||null,!!v.discard||ke.has(v.id)),ye=w.correction_after.get(v.id);return{...O,draggable:O.draggable===!0&&!pe,stale_work:pe,reason:pe?"":O.reason,badges:ye?[`\u{1F517} ${ye} \uB4A4 (blocks \uC790\uB3D9)`,...O.badges||[]]:O.badges,revise_enabled:O.revise_enabled===!0&&!te.has(v.id)}}function ze(v){let w=Ve();return J(v).sublanes.parallel.map(O=>tt(O,w))}function xt(v){let w=Ve();return J(v).sublanes.serial.map(O=>{let pe=O.occupants.map(ye=>({id:ye.id,title:ye.title,draggable:!1,lane:O.id,ghost:!0,badges:[ye.badge]}));return{id:O.id,index:O.index+1,raw_length:O.raw_length,ghosts:pe,items:O.items.map(ye=>tt(ye,w)),occupied:O.occupied_by.length>0,badge:O.occupants.length>0?O.occupants[0].badge:"\uB300\uAE30",cycle:O.cycle===!0}})}function Nt(v){return v.runnable.map(w=>le(w))}function At(v){return v.done.map(w=>le(w))}function Zt(v){let w=v.running.filter(O=>O.non_occupying!==!0).map(O=>({...O,bead_id:O.id,attempt_id:O.attempt_id||"",paused:O.run_state==="paused",failed:O.run_state==="failed",parked:O.run_state==="parked",retry_wait:O.run_state==="retry_wait",waiting:O.run_state==="waiting",wait:O.wait||null,status_label:O.run_state==="failed"?O.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328":O.run_state==="parked"?"\uC138\uC158 \uB300\uAE30":O.run_state==="retry_wait"?"\uC7AC\uC2DC\uB3C4 \uB300\uAE30":O.run_state==="waiting"?"\uC120\uD589 \uB300\uAE30":void 0,can_pause:O.can_pause!==!1,workspace_name:"",dependency_chips:re(O)||void 0,chip_popover:Be(O),rollup_expanded:Ee.has(O.id),failure:O.failure?{...O.failure,open:R===O.attempt_id}:null,...G(O.id,O.discard)}));return[...w.filter(O=>O.failed===!0),...w.filter(O=>O.failed!==!0&&O.parked===!0),...w.filter(O=>O.failed!==!0&&O.parked!==!0)]}function vt(v){return Rt(v).map(w=>({...w,chip_popover:Be(w)}))}function Rt(v){if(oe&&oe.model===v)return oe.rows;let w=qe(),O=J(v),pe=fn(w.attempts),ye=Object.values(pe).filter(Gn),Me=new Map;for(let Ge of ye)Me.set(Ge.attempt_id,Ge);let Qe=new Map;for(let Ge of ye)Qe.set(Ge.bead_id,Ge);let wt=new Map;for(let Ge of[...v.pr_wait,...v.running,...v.queue,...v.runnable,...v.done])wt.has(Ge.id)||wt.set(Ge.id,Ge);let Bt=Ge=>{let jt=null;for(let yn of ye)!yn||yn.bead_id!==Ge||qa(yn,Me)||(jt===null||(typeof yn.started_at=="number"?yn.started_at:0)>=(typeof jt.started_at=="number"?jt.started_at:0))&&(jt=yn);return jt&&typeof jt.target_base=="string"?jt.target_base:null},tn=new Map;for(let Ge of v.running)Ge.run_state==="failed"||Ge.conflict_resolution!==!0||(Ge.run_state!=="paused"?tn.set(Ge.id,"running"):tn.has(Ge.id)||tn.set(Ge.id,"paused"));let mn=fn(w.auto_merge_skips),In=new Set(O.merge.auto_excluded),_r=fn(w.pr_observations),Ln=fn(w.pr_activity),Pn=fn(w.cleanup_failed),Xt=fn(w.discard_operations),jn=fn(w.bead_workflow),Pr=fn(w.bead_titles),mr=w.merge_queue_state||{active:null,failures:{}},Jn=O.merge.state.waiting,kn=new Map;for(let Ge of Array.isArray(w.merge_queue)?w.merge_queue:[])Ge&&typeof Ge=="object"&&Ge.bead_id&&kn.set(Ge.bead_id,Ge);let er=(Array.isArray(w.pr_wait)?w.pr_wait:[]).map(Ge=>{let jt=wt.get(Ge.bead_id);return{...rw(Ge.bead_id,jt?.title||Pr[Ge.bead_id]||Ge.bead_id,_r,Pn[Ge.bead_id]||null,Hn(pe,Ge.bead_id),Ln[Ge.bead_id]||(Q.has(Ge.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:P.has(Ge.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),tn.get(Ge.bead_id)||null,Ge.external===!0,{position:O.merge.positions.get(Ge.bead_id)||0,active:mr.active===Ge.bead_id,failure:fn(mr.failures)[Ge.bead_id]||null,waiting:Jn&&Jn.bead_id===Ge.bead_id?Jn.reason:null,resolution:O.merge.resolutions.get(Ge.bead_id),continuation_action:O.merge.continuations.get(Ge.bead_id),authority:O.merge.authorities.get(Ge.bead_id)||null,hold:kn.get(Ge.bead_id)?.hold||null,review_dispatch:kn.get(Ge.bead_id)?.review_dispatch||null},Ge.wt_present!==!1,w.auto_merge===!0&&In.has(Ge.bead_id)?mn[Ge.bead_id]?.reason||"":null,Na(O.declared_base,Bt(Ge.bead_id)),fn(w.completion_status)[Ge.bead_id]||null,Xt,w.auto_merge===!0,{merge_sha:Ge.merge_sha,cleanup_cursor:Ge.cleanup_cursor,repo_operations:O.repo_operations},jt?re(jt):null,Eu(pe,Ge.bead_id),H.has(Ge.bead_id)),workflow:jn[Ge.bead_id]||null,priority:jt?.priority,from_id:jt?.from_id,...jt?.created_at===void 0?{}:{created_at:jt.created_at},...jt?.updated_at===void 0?{}:{updated_at:jt.updated_at}}});return oe={model:v,rows:er},er}function Wt(v){let w=J(v),O=[];for(let Me of v.running)Me.non_occupying!==!0&&O.push({id:Me.id,title:Me.title,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:Me.serial_lane_id??null});for(let Me of v.pr_wait)O.push({id:Me.id,title:Me.title,location_label:"PR \uB300\uAE30",kind:"pr_wait",lane_id:null});for(let Me of w.sublanes.serial)Me.items.forEach((Qe,wt)=>{O.push({id:Qe.id,title:Qe.title,location_label:`${Me.id} #${wt+1}`,kind:"serial",lane_id:Me.id})});w.sublanes.parallel.forEach((Me,Qe)=>{O.push({id:Me.id,title:Me.title,location_label:`#${Qe+1}`,kind:"parallel",lane_id:null})});for(let Me of v.runnable)O.push({id:Me.id,title:Me.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null,queue_placeable:Me.queue_placeable===!0});let pe=qe();V=wf(pe.bead_scope,O);let ye=new Map;for(let Me of[...v.running,...v.runnable])Array.isArray(Me.blocked_by)&&Me.blocked_by.length>0&&ye.set(Me.id,Me.blocked_by);for(let[Me,Qe]of Object.entries(fn(pe.bead_blocked_by)))Array.isArray(Qe)&&ye.set(Me,Qe.filter(wt=>typeof wt=="string"&&wt.length>0));se=Uu(ye,O,fn(pe.blocker_workspaces))}function ut(v){let w=v.hold&&typeof v.hold=="object"?v.hold:null;if(!w||w.kind!=="env"&&w.kind!=="systemic")return"";let O=ur(w.cause)||String(w.cause||""),pe=Array.isArray(v.lineages)?v.lineages:[];if(w.kind==="env"){let Me=pe.map(wt=>wt&&wt.next_at).filter(wt=>typeof wt=="number").sort((wt,Bt)=>wt-Bt)[0],Qe=typeof Me=="number"?` \xB7 \uB2E4\uC74C ${new Date(Me).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"})}`:"";return c`<div class="worker-hold worker-hold--env" role="status">
      ...
      </div>`}let ye=(Array.isArray(w.bead_ids)?w.bead_ids:[]).filter(Me=>typeof Me=="string"&&Me.length>0);return c`<div class="worker-hold worker-hold--systemic" role="alert">
      <span class="worker-hold__text"
    ...
    </div>`}function Kt(v){let w=qe(),O=J(v),pe=O.sublanes.parallel,ye=pe.length>0?pe[0].id:"\u2014",Me=c`<button
      type="button"
    ...
    >
      ${w.auto_advance?"\u23F8 \uC790\uB3D9\uD654 \uBA48\uCDA4":"\u25B6 \uC790\uB3D9\uD654"}
          ...
          >cap 초과</span
        >`:"",Bt=w.auto_advance?0:(Array.isArray(w.queue)?w.queue:[]).filter(Xt=>Xt&&typeof Xt.armed_by_lane=="string"&&Xt.armed_by_lane.length>0).length,tn=Bt>0?c`<span
    ...
    >`,_r=c`<label class="worker-tgl worker-slots"
      ...
      <label
        ...
        <select class="worker-serial-lane-count" aria-label="직렬 레인 수">
          ${Array.from({length:qf},(Xt,jn)=>jn+1).map(Xt=>c`<option
                value=${String(Xt)}
      ...
      </label> `,Ln=Cu(O.repo_operations,O.cleanup_failures),Pn=ut(w);return Y?c`<div class="worker-ribbon">
          ${Me} ${Qe}
      ...
      ${Pn}${Ln}${Ne.template()}`}function Yt(v){let w=v.runnable_hidden;return c`<div class="worker-filter">
    ...
    >
      ...
      <select
        ...
        .value=${C}
      >
        ${Mr.map(v=>c`<option value=${v.value} ?selected=${C===v.value}>
              ${v.label}
            </option>`)}
      </select>
    </div>`}function Jt(v){let w=J(v).merge,O=qe().auto_merge===!0;if(w.running)return c`<button
        type="button"
      ...
      >
        ⏸ 자동 머지
      </button>`;let pe=new Set(w.auto_excluded),ye=vt(v).filter(Me=>Me.merge_action&&Me.merge_enabled&&!pe.has(Me.id)).length;return c`<button
      type="button"
    ...
    </span>`}function en(v,w){return c`<div
      data-bead-id=${v.id}
      data-drag-kind=${w.kind}
      data-root-dir=${w.root_dir}
      data-lane-id=${rn(w.lane_id)}
      data-row-index=${w.row_index}
      data-queue-index=${String(v.queue_index??0)}
    >
      ${Sn({...v,...G(v.id,v.discard)},{actions:Ht(v)})}
    </div>`}function fe(v){let w=ze(v),O=Z();return oi({parallel:{rows:w.map((pe,ye)=>en(pe,{kind:"parallel",root_dir:O,row_index:ye})),count:w.length,collapsed:F.isAreaCollapsed("parallel"),drop:{drop:"parallel",root_dir:O}},serial:{lanes:xt(v).map(pe=>({id:pe.id,title:`\uC9C1\uB82C ${pe.index}`,rows:[...pe.ghosts.map(ye=>Sn({...ye,...G(ye.id,ye.discard)},{actions:Ht(ye)})),...pe.items.map((ye,Me)=>en(ye,{kind:"repo-serial",root_dir:O,row_index:Me,lane_id:pe.id}))],count:pe.ghosts.length+pe.items.length,empty:pe.ghosts.length+pe.items.length===0,badge:pe.badge,held:pe.occupied,cycle:pe.cycle,drop:{drop:"repo-serial",root_dir:O,lane_id:pe.id,lane_length:String(pe.raw_length)}})),collapsed:F.isAreaCollapsed("serial")}})}function E(v){return Tp(Zt(v),Date.now(),ue)}function he(v){return v.running.some(w=>w.kind!=="session"&&w.run_state==="running")}function De(v){let w=J(v),O=Nt(v),pe=ze(v),ye=At(v),Me=vt(v),Qe=Zt(v),wt=qn({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4",items:O,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:zt(),header_row:N?_n():void 0,controls:Yt(v),collapsible:!0,collapsed:F.isCollapsed("candidate"),place_menu:Fe(O),onOpenDoc:u?(tn,mn)=>u(mn):void 0}),Bt=qn({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:ye,empty:`${L()} \uC644\uB8CC \uC5C6\uC74C`,header_control:Ft(),collapsible:!0,collapsed:F.isCollapsed("done"),preview:Y?Array.isArray(w.token_total)?w.token_total.map(tn=>tn.label).join(" \xB7 "):w.token_total||jf(ye):void 0});return Y?c`<div class="worker-lanes worker-lanes--mobile">
        ${si({live:he(v),running_body:Qe.length>0?E(v):"",pr_wait_rows:Me.map(tn=>Sn(tn)),count:Qe.length+Me.length})}
        ${qn({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:pe,count:pe.length,collapsible:!0,collapsed:F.isCollapsed("queue"),preview:jf(pe),body:fe(v)})}
        ${wt} ${Bt}
      </div>`:c`<div class="worker-lanes">
      ${wt}
      ${qn({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:pe,count:pe.length,collapsible:!0,collapsed:F.isCollapsed("queue"),body:fe(v)})}
      ${qn({id:"worker-pane-running",lane:"running",title:"\uC2E4\uD589 \uC911",items:Qe,header_control:c`<span class="worker-pane__meta"
          >슬롯 ${w.slots}</span
        >`,live:he(v),collapsible:!0,collapsed:F.isCollapsed("running"),body:E(v)})}
      ${qn({id:"worker-pane-pr-wait",lane:"pr_wait",title:"PR \uB300\uAE30",items:Me,empty:"PR \uB300\uAE30 \uC5C6\uC74C",collapsible:!0,collapsed:F.isCollapsed("pr_wait")})}
      ${Bt}
    </div>`}function h(v){F.toggle(v),_()}function p(v){F.toggleArea(v),_()}function _(){let v=q();Wt(v),st(Kt(v),ee),st(De(v),Re)}function S(){let v=!0,w=Li(O=>{if(Y=O,v){v=!1;return}_()});D.push(w)}function z(v){m=v,Nv(v),_()}function K(v){if(v==="custom"){N=!0,_();return}j=Lr(v),Al(j),N=!1,_()}function ce(v){j=Lr({chain:v}),Al(j),_()}function xe(v){C=Dn(v),Fv(C),f?.(C),_()}function Xe(v){let w=v.target?.closest?.(".worker-serial-lane-count");if(w){let Bt=Number.parseInt(w.value,10);Number.isFinite(Bt)&&$(Bt).then(_);return}let O=v.target?.closest?.(".worker-filter__blocked");if(O){z({...m,show_blocked:O.checked});return}let pe=v.target?.closest?.(".worker-sort-chain__key");if(pe){let Bt=Number.parseInt(pe.getAttribute("data-step")||"",10);Number.isFinite(Bt)&&ce(bf(ss(j),Bt,pe.value));return}let ye=v.target?.closest?.(".worker-done-range");if(ye){xe(ye.value);return}let Me=v.target?.closest?.(".worker-sort");if(Me){K(Me.value);return}let Qe=v.target?.closest?.(".worker-slots__input");if(!Qe)return;let wt=Number.parseInt(Qe.value,10);if(!Number.isFinite(wt)){_();return}ie(wt).then(_)}function ot(v){return v?{runner:v.runner||void 0,model:v.model||void 0,effort:v.effort||void 0,worktree:v.worktree||void 0,status:v.status||void 0,session_id:v.session_id||void 0}:{}}function ht(){let v=J(q()),w=qe().workspace_info,O=w&&typeof w=="object"&&w.repo_ops&&typeof w.repo_ops=="object"?w.repo_ops:null;return{operations:v.repo_operations,cleanup_failures:v.cleanup_failures,repo:l&&l()||"",repo_ops:O}}function gt(){ue&&ne.close(),_e.hidden=!1,me.hidden=!1,de.open(ht()),_()}function x(v){let w=qe(),O=w.attempts?w.attempts[v]:null;ue=v,de.close(),_e.hidden=!0,me.hidden=!1,ne.open({attempt_id:v,meta:ot(O)}),_()}function A(v){let w=qe(),O=(Array.isArray(w.session_active)?w.session_active:[]).find(ye=>ye&&ye.bead_id===v),pe=(O&&Array.isArray(O.session_refs)?O.session_refs:[]).find(ye=>ye&&ye.current===!0);pe&&(de.close(),_e.hidden=!0,me.hidden=!1,ne.open(Kr(pe,v,"in_progress")),_())}function Le(){if(de.isOpen()&&de.refresh(ht()),!ue)return;let v=qe(),w=v.attempts?v.attempts[ue]:null;if(w){ne.updateMeta(ot(w));return}ne.close()}function We(v,w){if(v.length===0||!i)return;let O=l?l():void 0;if(w.length===0||!O||w===O||!a){i(v);return}Promise.resolve(a(w)).then(()=>{i(v)}).catch(()=>{we("\uB808\uD3EC \uC804\uD658\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error",2400)})}function et(v){let w=v.target;if(w?.closest?.(".worker-mini__grip"))return;let O=w?.closest?.(".worker-sort-chain__dir");if(O){let Pe=Number.parseInt(O.getAttribute("data-step")||"",10);Number.isFinite(Pe)&&ce(yf(ss(j),Pe));return}let pe=w?.closest?.(".worker-dep__open");if(pe){We(pe.getAttribute("data-dep-id")||"",pe.getAttribute("data-root-dir")||"");return}let ye=w?.closest?.(".judgement-chip");if(ye){let Pe=ye.closest("[data-bead-id]"),je=Pe&&Pe.getAttribute("data-bead-id")||"",b=ye.getAttribute("data-chip-key")||"";je&&b&&B.toggle({bead_id:je,chip_key:b});return}if(w?.closest?.(".chip-popover"))return;if(w?.closest?.(".worker-repo-strip")){gt();return}let Me=w?.closest?.(".worker-repo-op__dismiss");if(Me){ae(Me.dataset.operationId||"");return}let Qe=w?.closest?.(".worker-cleanup__resume");if(Qe){let Pe=Qe.dataset.beadId;Pe&&Ie(Pe);return}let wt=w?.closest?.(".worker-cleanup__resolve");if(wt){let Pe=wt.dataset.beadId;Pe&&Ue(Pe);return}if(w?.closest?.(".worker-hold__retry")){Ke("worker-queue-hold-retry-now","\uC9C0\uAE08 \uC7AC\uC2DC\uB3C4 \uAC70\uBD80");return}if(w?.closest?.(".worker-hold__resume")){Ke("worker-queue-hold-resume","\uC7AC\uAC1C \uAC70\uBD80");return}if(w?.closest?.(".worker-play")){Lt(!qe().auto_advance);return}let Bt=w?.closest?.(".worker-merge-all");if(Bt){Bt.classList.contains("worker-merge-all--stop")?qe().auto_merge===!0?It(!1):mt():It(!0);return}let tn=w?.closest?.(".worker-pane__toggle[data-lane]");if(tn){let Pe=tn.dataset.lane;(Pe==="candidate"||Pe==="queue"||Pe==="running"||Pe==="pr_wait"||Pe==="done")&&h(Pe);return}let mn=w?.closest?.(".worker-wait__area-toggle[data-area]");if(mn){let Pe=mn.dataset.area;(Pe==="parallel"||Pe==="serial")&&p(Pe);return}let In=w?.closest?.(".worker-card__place-lane");if(In){let Pe=In.dataset.beadId,je=In.dataset.lane;Pe&&(je==="parallel"||/^s[1-5]$/.test(je||""))&&(k=null,_(),X(Pe,je));return}if(w?.closest?.(".worker-card__place-cancel")){k=null,_();return}let Ln=w?.closest?.(".worker-card__place");if(Ln){let Pe=Ln.dataset.beadId;Pe&&!Ln.disabled&&(Ze()?(k=Pe,_()):X(Pe,"parallel"));return}let Pn=w?.closest?.(".worker-filter__chip");if(Pn){let Pe=Pn.dataset.spec;(Pe==="all"||Pe==="with"||Pe==="without")&&z({...m,spec:Pe});return}let Xt=w?.closest?.('[data-action="queue-remove"]');if(Xt){let Pe=Xt.dataset.beadId||"";Pe&&I.sendOp({type:"worker-queue-remove",payload:{bead_id:Pe},root_dir:Z()},Pe);return}let jn=w?.closest?.(".worker-mini__merge");if(jn){let Pe=jn.dataset.beadId||"";qe().cleanup_failed?.[Pe]?Ie(Pe):Oe(Pe);return}let Pr=w?.closest?.(".worker-mini__merge-cancel");if(Pr){Mt(Pr.dataset.beadId||"");return}let mr=w?.closest?.(".worker-mini__resolve");if(mr){Ue(mr.dataset.beadId||"");return}let Jn=w?.closest?.(".rtile__resolve");if(Jn){let Pe=Jn.closest(".rtile");Ue(Pe?.dataset.beadId||"");return}let kn=w?.closest?.(".worker-mini__discard");if(kn){ct(kn.dataset.beadId||"",kn.dataset.attemptId||null,kn.dataset.discardMode==="merged"?"merged":"unmerged",kn.dataset.operationId||null);return}let er=w?.closest?.(".worker-mini__stale-continue");if(er){$t("worker-stale-work-continue",er.dataset.beadId||"",er.dataset.actionId||"");return}let Ge=w?.closest?.(".worker-mini__stale-backup");if(Ge){$t("worker-stale-work-backup-fresh",Ge.dataset.beadId||"",Ge.dataset.actionId||"");return}let jt=w?.closest?.(".worker-mini__stale-recheck");if(jt){$t("worker-stale-work-recheck",jt.dataset.beadId||"",jt.dataset.actionId||"");return}let yn=w?.closest?.(".worker-mini__revise-fix");if(yn){Ct("worker-revise-fix",yn.dataset.beadId||"");return}let as=w?.closest?.(".worker-mini__revise-approve");if(as){Ct("worker-revise-approve",as.dataset.beadId||"");return}if(w?.closest?.(".worker-mini__pr"))return;let ls=w?.closest?.(".rtile__failure-badge");if(ls){let Pe=ls.dataset.attemptId||"";R=R===Pe?null:Pe,_();return}let cs=w?.closest?.(".rtile__attempt-copy");if(cs){let Pe=cs.dataset.attemptId||"";Pe&&sn(Pe).then(je=>{we(je?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",je?"success":"error",1400)});return}if(w?.closest?.(".rtile__parked-retry")){let Pe=w?.closest?.(".rtile");pt(Pe?.dataset?.beadId||"",Pe?.dataset?.attemptId||"");return}let po=w?.closest?.(".rtile__discard");if(po){let Pe=w?.closest?.(".rtile"),je=Pe?.dataset?.beadId,b=Pe?.dataset?.attemptId;je&&ct(je,b||null,po.dataset.confirmation==="merged"?"merged":"unmerged",po.dataset.operationId||null);return}if(w?.closest?.(".rtile__pause")){let je=w?.closest?.(".rtile")?.dataset?.attemptId;je&&at(je);return}if(w?.closest?.(".rtile__resume")){let Pe=w?.closest?.(".rtile__resume"),b=w?.closest?.(".rtile")?.dataset?.attemptId;b&&y(b,Pe?.dataset?.resumeKind==="settlement"?"settlement":"session");return}if(w?.closest?.(".rtile__session")){let Pe=w?.closest?.(".rtile"),je=Pe?.dataset?.attemptId;if(je){x(je);return}let b=Pe?.dataset?.beadId;b&&A(b);return}if(w?.closest?.(".rtile__failure-pop"))return;if(w?.closest?.(".worker-drawer-overlay__backdrop")){de.close(),ne.close();return}if(w?.closest?.(".worker-drawer-host"))return;let us=w?.closest?.(".rtile .board-card__roll-toggle");if(us){let Pe=us.dataset.rollParent;Pe&&(Ee.has(Pe)?Ee.delete(Pe):Ee.add(Pe),_());return}let ds=w?.closest?.(".rtile .board-card__roll-child");if(ds){let Pe=ds.dataset.childId;Pe&&i&&i(Pe);return}let fo=w?.closest?.(".rtile");if(fo){if(w?.closest?.(".rtile__id")){let je=fo.dataset.beadId;je&&sn(je).then(b=>{b?we("\uBCF5\uC0AC\uB428","success",1200):we("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let Pe=fo.dataset.beadId;Pe&&i&&i(Pe);return}let ps=w?.closest?.(".worker-mini, .worker-card");if(ps){let Pe=ps.dataset.beadId;if(w?.closest?.('[data-seam="log-path-copy"]'))return;if(w?.closest?.(".worker-mini__id, .worker-card__id")){Pe&&sn(Pe).then(b=>{b?we("\uBCF5\uC0AC\uB428","success",1200):we("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let je=w?.closest?.(".ctl-chip--from");if(je){let b=je.dataset.fromId;b&&i&&i(b);return}Pe&&i&&i(Pe)}}I.attach(e),e.addEventListener("click",et),e.addEventListener("change",Xe);function _t(v){let w=v.target,O=w&&typeof w.closest=="function"?pe=>w.closest(pe):()=>null;R&&!O(".rtile__failure-pop, .rtile__failure-badge")&&(R=null,_())}function qt(v){v.key!=="Escape"||R===null||(R=null,_())}return document.addEventListener("click",_t),document.addEventListener("keydown",qt),B.attach(),D.push(()=>{document.removeEventListener("click",_t),document.removeEventListener("keydown",qt),B.detach()}),S(),g&&D.push(g.subscribe(()=>{be.notifyIssuesChanged(),_()})),o&&D.push(o.subscribe(()=>{let v=l&&l()||"";v!==ge&&(ge=v,Ae.close()),_(),Le()})),_(),{load(){be.ensureSessionDefaults(),_()},refreshSessionDefaults:Se,destroy(){for(let v of D.splice(0))try{v()}catch{}I.detach(),e.removeEventListener("click",et),e.removeEventListener("change",Xe),be.destroy();try{ne.destroy()}catch{}me.hidden=!0;try{Ae.destroy()}catch{}st(c``,e)}}}function Rl(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Wf(e,t,n,r=async()=>{},o=async()=>{}){let s=Ot("views:workspace-picker"),i=null,l=!1,a=!1,u=!1;async function d(L){let Y=L.target.value,P=t.getState().workspace?.current?.path||"";if(Y&&Y!==P){s("switching workspace to %s",Y),l=!0,C();try{await n(Y)}catch(H){s("workspace switch failed: %o",H)}finally{l=!1,C()}}}async function f(){let L=t.getState(),F=L.workspace?.current?.path||L.workspace?.available?.[0]?.path||"";if(!(!F||a)){s("git-pulling workspace %s",F),a=!0,C();try{await r(F)}catch(Y){s("workspace git pull failed: %o",Y)}finally{a=!1,C()}}}function g(L){let F=L.target;F&&e.contains(F)||R()}function m(L){L.key==="Escape"&&R()}function k(){u||(u=!0,document.addEventListener("mousedown",g),document.addEventListener("keydown",m),C())}function R(){u&&(u=!1,document.removeEventListener("mousedown",g),document.removeEventListener("keydown",m),C())}function B(){u?R():k()}async function V(L){let F=L.target,Y=F.value,Q=F.checked;s("toggling visibility %s \u2192 %s",Y,String(Q));try{await o(Y,Q)}catch(P){s("workspace visibility toggle failed: %o",P)}}function se(L){return L?c`
      <button
        type="button"
    ...
    `}function N(){let L=t.getState(),F=L.workspace?.current,Y=L.workspace?.available||[],Q=new Set(L.workspace?.hidden||[]),P=F?.path||Y[0]?.path||"";if(Y.length===0)return c``;let H=Y.filter(G=>!Q.has(G.path)||G.path===P);if(H.length<=1){let G=H[0]||Y[0],te=Rl(G.path);return c`
