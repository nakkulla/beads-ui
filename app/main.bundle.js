...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Zo=/'/g,Xo=/"/g,ta=/^(?:script|style|textarea|title)$/i,xs=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),l=xs(1),Zt=xs(2),xf=xs(3),wr=Symbol.for("lit-noChange"),dt=Symbol.for("lit-nothing"),Qo=new WeakMap,yr=vr.createTreeWalker(vr,129);function ra(e,t){if(!$s(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Yo!==void 0?Yo.createHTML(t):t}var gc=(e,t)=>{let r=e.length-1,n=[],s,o=t===2?"<svg>":t===3?"<math>":"",a=Gr;for(let i=0;i<r;i++){let c=e[i],u,f,m=-1,h=0;for(;h<c.length&&(a.lastIndex=h,f=a.exec(c),f!==null);)h=a.lastIndex,a===Gr?f[1]==="!--"?a=Vo:f[1]!==void 0?a=Ko:f[2]!==void 0?(ta.test(f[2])&&(s=RegExp("</"+f[2],"g")),a=br):f[3]!==void 0&&(a=br):a===br?f[0]===">"?(a=s??Gr,m=-1):f[1]===void 0?m=-2:(m=a.lastIndex-f[2].length,u=f[1],a=f[3]===void 0?br:f[3]==='"'?Xo:Zo):a===Xo||a===Zo?a=br:a===Vo||a===Ko?a=Gr:(a=br,s=void 0);let E=a===br&&e[i+1].startsWith("/>")?" ":"";o+=a===Gr?c+_c:m>=0?(n.push(u),c.slice(0,m)+Jo+c.slice(m)+ir+E):c+ir+(m===-2?i:E)}return[ra(e,o+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]},Zr=class e{constructor({strings:t,_$litType$:r},n){let s;this.parts=[];let o=0,a=0,i=t.length-1,c=this.parts,[u,f]=gc(t,r);if(this.el=e.createElement(u,n),yr.currentNode=this.el.content,r===2||r===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=yr.nextNode())!==null&&c.length<i;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith(Jo)){let h=f[a++],E=s.getAttribute(m).split(ir),k=/([.?@])?(.*)/.exec(h);c.push({type:1,index:o,name:k[2],strings:E,ctor:k[1]==="."?ys:k[1]==="?"?vs:k[1]==="@"?ws:Ir}),s.removeAttribute(m)}else m.startsWith(ir)&&(c.push({type:6,index:o}),s.removeAttribute(m));if(ta.test(s.tagName)){let m=s.textContent.split(ir),h=m.length-1;if(h>0){s.textContent=Tn?Tn.emptyScript:"";for(let E=0;E<h;E++)s.append(m[E],Vr()),yr.nextNode(),c.push({type:2,index:++o});s.append(m[h],Vr())}}}else if(s.nodeType===8)if(s.data===ea)c.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(ir,m+1))!==-1;)c.push({type:7,index:o}),m+=ir.length-1}o++}}static createElement(t,r){let n=vr.createElement("template");return n.innerHTML=t,n}};function Rr(e,t,r=e,n){if(t===wr)return t;let s=n!==void 0?r._$Co?.[n]:r._$Cl,o=Kr(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(t=Rr(e,s._$AS(e,t.values),s,n)),t}var bs=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:r},parts:n}=this._$AD,s=(t?.creationScope??vr).importNode(r,!0);yr.currentNode=s;let o=yr.nextNode(),a=0,i=0,c=n[0];for(;c!==void 0;){if(a===c.index){let u;c.type===2?u=new Xr(o,o.nextSibling,this,t):c.type===1?u=new c.ctor(o,c.name,c.strings,this,t):c.type===6&&(u=new ks(o,this,t)),this._$AV.push(u),c=n[++i]}a!==c?.index&&(o=yr.nextNode(),a++)}return yr.currentNode=vr,s}p(t){let r=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,r),r+=n.strings.length-2):n._$AI(t[r])),r++}},Xr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,r,n,s){this.type=2,this._$AH=dt,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Rr(this,t,r),Kr(t)?t===dt||t==null||t===""?(this._$AH!==dt&&this._$AR(),this._$AH=dt):t!==this._$AH&&t!==wr&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):mc(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==dt&&Kr(this._$AH)?this._$AA.nextSibling.data=t:this.T(vr.createTextNode(t)),this._$AH=t}$(t){let{values:r,_$litType$:n}=t,s=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=Zr.createElement(ra(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(r);else{let o=new bs(s,this),a=o.u(this.options);o.p(r),this.T(a),this._$AH=o}}_$AC(t){let r=Qo.get(t.strings);return r===void 0&&Qo.set(t.strings,r=new Zr(t)),r}k(t){$s(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,n,s=0;for(let o of t)s===r.length?r.push(n=new e(this.O(Vr()),this.O(Vr()),this,this.options)):n=r[s],n._$AI(o),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(t=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);t!==this._$AB;){let n=t.nextSibling;t.remove(),t=n}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},Ir=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,n,s,o){this.type=1,this._$AH=dt,this._$AN=void 0,this.element=t,this.name=r,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=dt}_$AI(t,r=this,n,s){let o=this.strings,a=!1;if(o===void 0)t=Rr(this,t,r,0),a=!Kr(t)||t!==this._$AH&&t!==wr,a&&(this._$AH=t);else{let i=t,c,u;for(t=o[0],c=0;c<o.length-1;c++)u=Rr(this,i[n+c],r,c),u===wr&&(u=this._$AH[c]),a||(a=!Kr(u)||u!==this._$AH[c]),u===dt?t=dt:t!==dt&&(t+=(u??"")+o[c+1]),this._$AH[c]=u}a&&!s&&this.j(t)}j(t){t===dt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ys=class extends Ir{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===dt?void 0:t}},vs=class extends Ir{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==dt)}},ws=class extends Ir{constructor(t,r,n,s,o){super(t,r,n,s,o),this.type=5}_$AI(t,r=this){if((t=Rr(this,t,r,0)??dt)===wr)return;let n=this._$AH,s=t===dt&&n!==dt||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,o=t!==dt&&(n===dt||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ks=class{constructor(t,r,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){Rr(this,t)}};var hc=Yr.litHtmlPolyfillSupport;hc?.(Zr,Xr),(Yr.litHtmlVersions??(Yr.litHtmlVersions=[])).push("3.3.1");var Ue=(e,t,r)=>{let n=r?.renderBefore??t,s=n._$litPart$;if(s===void 0){let o=r?.renderBefore??null;n._$litPart$=s=new Xr(t.insertBefore(Vr(),o),o,void 0,r??{})}return s._$AI(e),s};var Et="today",Ht=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function Dt(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function kr(e,t=Date.now()){switch(e){case"today":{let r=new Date(t);return r.setHours(0,0,0,0),r.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function na(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function sa(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function oa(){let e=null,t=[],r=new Set;function n(){for(let s of Array.from(r))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},set(s,o){e=Array.isArray(s)?s:null,t=Array.isArray(o)?o:[],n()},clear(){e=null,t=[],n()},subscribe(s){return r.add(s),()=>r.delete(s)}}}function aa(){let e=new Map,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{set(n,s,o=null){e.set(n,{lines:Array.isArray(s)?[...s]:[],last_event_at:typeof o=="number"?o:null}),r()},append(n,s){let o=e.get(n)||{lines:[],last_event_at:null};o.lines=[...o.lines,s],o.last_event_at=Date.now(),e.set(n,o),r()},get(n){return e.get(n)||null},clear(n){typeof n=="string"?e.delete(n):e.clear(),r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}var pa=fc(ua(),1);function ot(e){return(0,pa.default)(`beads-ui:${e}`)}function Nt(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function xr(e,t){let r=Nt(e.created_at),n=Nt(t.created_at);if(r!==n)return r<n?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function ma(e,t){let r=Nt(e.created_at),n=Nt(t.created_at);if(r!==n)return r<n?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function ga(e,t){let r=Nt(e.updated_at),n=Nt(t.updated_at);if(r!==n)return r<n?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function ha(e,t){let r=e.priority??2,n=t.priority??2;if(r!==n)return r-n;let s=Nt(e.created_at),o=Nt(t.created_at);if(s!==o)return s<o?1:-1;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function ba(e,t){let r=e.closed_at??0,n=t.closed_at??0;if(r!==n)return r<n?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var Rc=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function fa(e){let t=e&&e.metadata,r=t?t.task_order:void 0;if(r==null||r==="")return Number.POSITIVE_INFINITY;let n=Number(r);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function _a(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let r=Rc.exec(t);if(!r)return Number.POSITIVE_INFINITY;let n=Number(r[1]);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ya(e,t){let r=fa(e),n=fa(t);if(r!==n)return r<n?-1:1;let s=_a(e),o=_a(t);if(s!==o)return s<o?-1:1;let a=Nt(e&&e.created_at),i=Nt(t&&t.created_at);if(a!==i)return a<i?-1:1;let c=e&&e.id,u=t&&t.id;return c===u?0:String(c)<String(u)?-1:1}var Ss=2**20;function Mr(e,t){let r=e&&e.id;return t&&typeof r=="string"&&Object.prototype.hasOwnProperty.call(t,r)&&typeof t[r]=="number"&&Number.isFinite(t[r])?t[r]:-Nt(e&&e.created_at)}function Rn(e){return(t,r)=>{let n=Mr(t,e),s=Mr(r,e);if(n!==s)return n<s?-1:1;let o=t?.id,a=r?.id;return o<a?-1:o>a?1:0}}function As(e,t,r){let n=Array.isArray(e)?e:[],s=n.length,o=Math.max(0,Math.min(t,s-1)),a=o-1>=0?n[o-1]:null,i=o+1<s?n[o+1]:null;if(!a&&!i)return{rank:0};if(!a)return{rank:Mr(i,r)-Ss};if(!i)return{rank:Mr(a,r)+Ss};let c=Mr(a,r),u=Mr(i,r),f=(c+u)/2;return c<f&&f<u?{rank:f}:{renormalize:n.map((m,h)=>({bead_id:m.id,rank:h*Ss}))}}function Ts(e,t={}){let r=ot(`issue-store:${e}`),n=new Map,s=[],o=0,a=new Set,i=!1,c=t.sort||xr;function u(){for(let h of Array.from(a))try{h()}catch{}}function f(){s=Array.from(n.values()).sort(c)}function m(h){if(i||!h||h.id!==e)return;let E=Number(h.revision)||0;if(r("apply %s rev=%d",h.type,E),!(E<=o&&h.type!=="snapshot")){if(h.type==="snapshot"){if(E<=o)return;n.clear();let k=Array.isArray(h.issues)?h.issues:[];for(let T of k)T&&typeof T.id=="string"&&T.id.length>0&&n.set(T.id,T);f(),o=E,u();return}if(h.type==="upsert"){let k=h.issue;if(k&&typeof k.id=="string"&&k.id.length>0){let T=n.get(k.id);if(!T)n.set(k.id,k);else{let B=Number.isFinite(T.updated_at)?T.updated_at:0,$=Number.isFinite(k.updated_at)?k.updated_at:0;if(B<=$){for(let H of Object.keys(T))H in k||delete T[H];for(let[H,X]of Object.entries(k))T[H]=X}}f()}o=E,u()}else if(h.type==="delete"){let k=String(h.issue_id||"");k&&(n.delete(k),f()),o=E,u()}}}return{id:e,subscribe(h){return a.add(h),()=>{a.delete(h)}},applyPush:m,snapshot(){return s},size(){return n.size},getById(h){return n.get(h)},dispose(){i=!0,n.clear(),s=[],a.clear(),o=0}}}function In(e){let t=String(e.type||"").trim(),r={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let a=e.params[o];r[o]=String(a)}}let n=new URLSearchParams(r).toString();return n.length>0?`${t}?${n}`:t}function va(e){let t=ot("subs"),r=new Map,n=new Map;function s(i,c){t("applyDelta %s +%d ~%d -%d",i,(c.added||[]).length,(c.updated||[]).length,(c.removed||[]).length);let u=n.get(i);if(!u||u.size===0)return;let f=Array.isArray(c.added)?c.added:[],m=Array.isArray(c.updated)?c.updated:[],h=Array.isArray(c.removed)?c.removed:[];for(let E of Array.from(u)){let k=r.get(E);if(!k)continue;let T=k.itemsById;for(let B of f)typeof B=="string"&&B.length>0&&T.set(B,!0);for(let B of m)typeof B=="string"&&B.length>0&&T.set(B,!0);for(let B of h)typeof B=="string"&&B.length>0&&T.delete(B)}}async function o(i,c){let u=In(c);if(t("subscribe %s key=%s",i,u),!r.has(i))r.set(i,{key:u,itemsById:new Map});else{let m=r.get(i);if(m&&m.key!==u){let h=n.get(m.key);h&&(h.delete(i),h.size===0&&n.delete(m.key)),r.set(i,{key:u,itemsById:new Map})}}n.has(u)||n.set(u,new Set);let f=n.get(u);f&&f.add(i);try{await e("subscribe-list",{id:i,type:c.type,params:c.params})}catch(m){let h=r.get(i)||null;if(h){let E=n.get(h.key);E&&(E.delete(i),E.size===0&&n.delete(h.key))}throw r.delete(i),m}return async()=>{t("unsubscribe %s key=%s",i,u);try{await e("unsubscribe-list",{id:i})}catch{}let m=r.get(i)||null;if(m){let h=n.get(m.key);h&&(h.delete(i),h.size===0&&n.delete(m.key))}r.delete(i)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:In,selectors:{getIds(i){let c=r.get(i);return c?Array.from(c.itemsById.keys()):[]},has(i,c){let u=r.get(i);return u?u.itemsById.has(c):!1},count(i){let c=r.get(i);return c?c.itemsById.size:0},getItemsById(i){let c=r.get(i),u={};if(!c)return u;for(let f of c.itemsById.keys())u[f]=!0;return u}}}}function wa(){let e=ot("issue-stores"),t=new Map,r=new Map,n=new Set,s=new Map;function o(){for(let c of Array.from(n))try{c()}catch{}}function a(c,u,f){let m=u?In(u):"",h=r.get(c)||"",E=t.has(c);if(e("register %s key=%s (prev=%s)",c,m,h),E&&h&&m&&h!==m){let k=t.get(c);if(k)try{k.dispose()}catch{}let T=s.get(c);if(T){try{T()}catch{}s.delete(c)}let B=Ts(c,f);t.set(c,B);let $=B.subscribe(()=>o());s.set(c,$)}else if(!E){let k=Ts(c,f);t.set(c,k);let T=k.subscribe(()=>o());s.set(c,T)}return r.set(c,m),()=>i(c)}function i(c){e("unregister %s",c),r.delete(c);let u=t.get(c);u&&(u.dispose(),t.delete(c));let f=s.get(c);if(f){try{f()}catch{}s.delete(c)}}return{register:a,unregister:i,getStore(c){return t.get(c)||null},snapshotFor(c){let u=t.get(c);return u?u.snapshot().slice():[]},subscribe(c){return n.add(c),()=>n.delete(c)}}}function ka(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function $a(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function Es(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function Ic(e){let t=String(e||""),r=t.startsWith("#")?t.slice(1):t,n=r.indexOf("?"),s=n>=0?r.slice(n+1):"";if(s){let i=new URLSearchParams(s).get("issue");if(i)return decodeURIComponent(i)}let o=/^\/issue\/([^\s?#]+)/.exec(r);return o&&o[1]?decodeURIComponent(o[1]):null}function Lc(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function xa(e){let t=ot("router"),r=()=>{let n=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(n),o=s&&s[1]?decodeURIComponent(s[1]):Ic(n),a=Lc(n);if(t("hash change \u2192 view=%s id=%s",a,o),e.setState({selected_id:a==="worker"?null:o,view:a,worker:{selected_parent_id:a==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(n)){let c=o?`#/${a}?issue=${encodeURIComponent(o)}`:`#/${a}`;window.location.hash!==c&&(window.location.hash=c)}};return{start(){window.addEventListener("hashchange",r),r()},stop(){window.removeEventListener("hashchange",r)},gotoIssue(n){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",a=Es(o,n);t("goto issue %s (view=%s)",n,o),window.location.hash!==a?window.location.hash=a:e.setState({selected_id:o==="worker"?null:n,view:o,worker:{selected_parent_id:o==="worker"?n:null}})},gotoView(n){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=n==="worker"?s.worker?.selected_parent_id:s.selected_id,a=o?Es(n,o):`#/${n}`;t("goto view %s (id=%s)",n,o||""),window.location.hash!==a?window.location.hash=a:e.setState({view:n,selected_id:n==="worker"?null:s.selected_id})}}}var Dc=Object.freeze({workspace_config:{default_workspace:null}});function Sa(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:Dc.workspace_config.default_workspace}}}function Aa(e={}){let t=ot("state"),r={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:Sa(e.config)},n=new Set;function s(){for(let o of Array.from(n))try{o(r)}catch{}}return{getState(){return r},setState(o){let a={...r,...o,filters:{...r.filters,...o.filters||{}},board:{...r.board,...o.board||{}},worker:{...r.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:r.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:r.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:r.workspace.hidden},config:o.config!==void 0?Sa(o.config):r.config},i=a.workspace.current?.path!==r.workspace.current?.path||a.workspace.available.length!==r.workspace.available.length||a.workspace.hidden.length!==r.workspace.hidden.length||a.workspace.hidden.some((u,f)=>u!==r.workspace.hidden[f]),c=a.config.workspace_config.default_workspace!==r.config.workspace_config.default_workspace;a.selected_id===r.selected_id&&a.view===r.view&&a.filters.status===r.filters.status&&a.filters.search===r.filters.search&&a.filters.type===r.filters.type&&a.board.closed_filter===r.board.closed_filter&&a.worker.selected_parent_id===r.worker.selected_parent_id&&a.worker.show_closed_children.length===r.worker.show_closed_children.length&&a.worker.show_closed_children.every((u,f)=>u===r.worker.show_closed_children[f])&&!i&&!c||(r=a,t("state change %o",{selected_id:r.selected_id,view:r.view,filters:r.filters,board:r.board,worker:r.worker,workspace:r.workspace.current?.path,config:{default_workspace:r.config.workspace_config.default_workspace}}),s())},subscribe(o){return n.add(o),()=>n.delete(o)}}}function Ta(e){let t=ot("activity"),r=0,n=new Map,s=1;function o(){if(!e)return;let u=r>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function a(){r+=1,t("start count=%d",r),o()}function i(){let u=r;r=Math.max(0,r-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,r),o()}function c(u){return async(m,h)=>{let E=s++,k=Date.now();n.set(E,{type:m,start_ts:k}),t("request start id=%d type=%s count=%d",E,m,r+1),a();let T=!1,B=()=>{T||(T=!0,n.delete(E),i())},$=setTimeout(()=>{T||(t("request TIMEOUT id=%d type=%s elapsed=%dms",E,m,Date.now()-k),B())},3e4);try{let H=await u(m,h),X=Date.now()-k;return t("request done id=%d type=%s elapsed=%dms",E,m,X),H}catch(H){let X=Date.now()-k;throw t("request error id=%d type=%s elapsed=%dms err=%o",E,m,X,H),H}finally{clearTimeout($),B()}}}return o(),{wrapSend:c,start:a,done:i,getCount:()=>r,getActiveRequests:()=>{let u=Date.now();return Array.from(n.entries()).map(([f,m])=>({id:f,type:m.type,elapsed_ms:u-m.start_ts}))}}}function Z(e,t="info",r=2800){let n=document.createElement("div");n.className="toast",n.textContent=e,n.style.position="fixed",n.style.right="12px",n.style.bottom="12px",n.style.zIndex="1000",n.style.color="#fff",n.style.padding="8px 10px",n.style.borderRadius="4px",n.style.fontSize="12px",t==="success"?n.style.background="#156d36":t==="warning"?n.style.background="#a36a00":t==="error"?n.style.background="#9f2011":n.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(n),setTimeout(()=>{try{n.remove()}catch{}},r)}var Cs=new Set;function Ea(e,t,r="info",n=2800){if(typeof e!="string"||e.length===0)return!1;let s=`beads-ui.toast.${e}`;if(Cs.has(s))return!1;try{if(window.sessionStorage.getItem(s)==="1")return Cs.add(s),!1;window.sessionStorage.setItem(s,"1")}catch{}return Cs.add(s),Z(t,r,n),!0}function Ln(e=void 0,t=void 0){function r(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function n(o,a,i){let c=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(a==="closed")return c.sort(ba),c;switch(i){case"created_desc":return c.sort(xr),c;case"created_asc":return c.sort(ma),c;case"updated_desc":return c.sort(ga),c;case"priority":return c.sort(ha),c;case"manual":default:{let u=r();return u?c.sort(Rn(u)):c.sort(xr),c}}}function s(o){let a=[];return e&&typeof e.subscribe=="function"&&a.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&a.push(t.subscribe(o)),()=>{for(let i of a)try{i()}catch{}}}return{selectBoardColumn:n,subscribe:s}}function Xt(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function Tt(e){let t=Xt(e);if(t===null)return"";let r=new Date(t),n=s=>String(s).padStart(2,"0");return`${r.getFullYear()}-${n(r.getMonth()+1)}-${n(r.getDate())} ${n(r.getHours())}:${n(r.getMinutes())}`}function Ct(e,t){let r=Xt(e);if(r===null)return"";let s=(typeof t=="number"?t:Date.now())-r;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let a=Math.floor(s/36e5);if(a<24)return`${a}\uC2DC\uAC04 \uC804`;let i=Math.floor(s/864e5);if(i<7)return`${i}\uC77C \uC804`;let c=Math.floor(i/7);if(i<30)return`${c}\uC8FC \uC804`;let u=Math.floor(i/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(i/365)}\uB144 \uC804`}function Dn(e){if(!Array.isArray(e))return null;let t=null,r=-1;for(let n of e){if(!n||n.status!=="in_progress")continue;let s=Xt(n.updated_at)??0;if(t===null||s>r){t=n,r=s;continue}s===r&&String(n.id)<String(t.id)&&(t=n)}return t}function On(e){let t=e.transport,r=e.uiOrderStore;function n(a,i){return"renormalize"in a?a.renormalize:[{bead_id:i,rank:a.rank}]}function s(a,i){let c={...a.order};for(let u of i)c[u.bead_id]=u.rank;r&&r.set({revision:a.revision,order:c})}async function o(a,i,c){if(!t||!r)return;let u=r.get()||{revision:0,order:{}},f=n(As(i,c,u.order),a);s(u,f);let m=await t("ui-order-set",{expected_revision:u.revision,entries:f});if(m&&m.conflict){let h={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};r.set(h);let E=n(As(i,c,h.order),a);s(h,E);let k=await t("ui-order-set",{expected_revision:h.revision,entries:E});k&&k.applied&&r.set({revision:typeof k.revision=="number"?k.revision:0,order:k.order||{}})}else m&&m.applied&&r.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:o}}function Mn(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Rs(e,t){return!t||typeof e!="string"||e.length===0||Mn(t.visible_labels).includes(e)?!0:Mn(t.hidden_labels).includes(e)?!1:!Mn(t.hidden_prefixes).some(r=>r.length>0&&e.startsWith(r))}function Pn(e,t){return Mn(e).filter(r=>Rs(r,t))}function lr(e,t){let r=e&&e.chips?e.chips[t]:void 0;return typeof r=="boolean"?r:!0}var Oc={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg",close:"mrg"},Ra={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge",close:"close"},Ca={quick_fix:["impl","close"],spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},Mc={review:"\u2713",skip:"\u2298"},cr={none:"\uBBF8\uB3C4\uB2EC",dim:"\uC9C4\uD589 \uC911",stale:"\uC7AC\uAC80\uD1A0 \uD544\uC694",review:"\uAC80\uD1A0 \uC644\uB8CC",skip:"\uAC80\uD1A0 \uC0DD\uB7B5",done:"\uC644\uB8CC"};function Pc(e,t,r){if(!(r==="in_progress"||r==="resolved"))return null;for(let s of e){let o=t[s];if(o&&o.fill==="dim"&&o.stale!==!0)return s}return null}function Ia(e){let t=e&&e.fill||"none";return t==="none"?cr.none:e&&e.stale===!0?cr.stale:t==="dim"?cr.dim:e&&e.glyph==="review"?cr.review:e&&e.glyph==="skip"?cr.skip:cr.done}function Nc(e){if(!e||e.fill==="none"||!e.approval_state)return Ia(e);let t=[];return e.glyph==="review"?t.push(cr.review):e.glyph==="skip"&&t.push(cr.skip),e.approval_state==="missing"?t.push("\uC2B9\uC778 \uD544\uC694"):e.approval_state==="stale"?t.push("\uC7AC\uC2B9\uC778 \uD544\uC694"):e.approval_state==="unknown"?t.push("\uC2B9\uC778 \uD655\uC778 \uBD88\uAC00"):t.push("\uC2B9\uC778 \uC644\uB8CC"),t.join(" \xB7 ")}function Fc(e,t,r){let n=Oc[e]||e,s=t&&t.fill||"none",o=!!t&&t.stale===!0,a=Mc[t&&t.glyph||""]||"",i="bar";s==="dim"?i+=` b-${n} dim`:s==="full"&&(i+=` b-${n} full`),o&&(i+=" stale"),r&&(i+=" cur");let c=s==="none"?"lbl":`lbl l-${n} on`,u=r?`color: var(--stage-${n}-on)`:"";return l`
  ...
  `}var Kc=200,Zc={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},Xc=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),Ma="beads-ui.board.sort",Pa=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function Qc(){try{let e=window.localStorage.getItem(Ma);if(e&&Pa.has(e))return e}catch{}return"created_desc"}function Na(e,t){let r=ot("views:board"),n=t.gotoIssue,s=t.issueStores,o=t.transport,a=t.uiOrderStore,i=t.displayPolicyStore,c=t.workerQueueStore,u=t.onClosedRangeChange,f=t.onNewIssue,m=t.closedRange||Et,h=s?Ln(s,a):null,E=On({transport:o,uiOrderStore:a}),k=[],T=[],B=[],$=[],H=[],X=[],U=!1,O=0,x=Qc(),N=new Map,L=new Map,ue=new Map,ve=new Set,ne={search:"",priority:"",type:"",labels:[]},be=!1,Me=null;function tt(F){return String(F.status||"open")==="open"}function Je(F){let G=String(F.status||"open");return G==="open"||G==="blocked"}function Ie(F){let G=ne.search.trim().toLowerCase(),se=ne.priority,fe=ne.type,xe=ne.labels;return F.filter(Re=>{if(G){let We=String(Re.id||"").toLowerCase(),et=String(Re.title||"").toLowerCase();if(!We.includes(G)&&!et.includes(G))return!1}if(se!==""&&String(Re.priority)!==se||fe!==""&&String(Re.issue_type||"")!==fe)return!1;if(xe.length>0){let We=Array.isArray(Re.labels)?Re.labels:[];if(!xe.some(et=>We.includes(et)))return!1}return!0})}function Xe(){let F=new Set;for(let G of[k,T,B,$,H,X])for(let se of G){let fe=Array.isArray(se.labels)?se.labels:[];for(let xe of fe)typeof xe=="string"&&xe.length>0&&F.add(xe)}return Array.from(F).sort()}function we(){return ne.search.trim()!==""||ne.priority!==""||ne.type!==""||ne.labels.length>0}function ge(){try{if(h){let F=h.selectBoardColumn("tab:board:in-progress","in_progress",x),G=h.selectBoardColumn("tab:board:blocked","blocked",x).filter(Je),se=new Set(F.map(Ae=>Ae.id)),fe=h.selectBoardColumn("tab:board:ready","ready",x).filter(Ae=>tt(Ae)&&!se.has(Ae.id)),xe=h.selectBoardColumn("tab:board:resolved","resolved",x),Re=h.selectBoardColumn("tab:board:deferred","deferred",x),We=h.selectBoardColumn("tab:board:closed","closed").slice(0,Kc),et=[...G,...fe,...F,...xe,...We];ke(et);let Te=new Set;for(let Ae of et)Ae&&Ae.id&&!Is(Ae)&&Te.add(Ae.id);let Ye=!we();k=Ye?Qr(G,Te):G,T=Ye?Qr(fe,Te):fe,B=Ye?Qr(F,Te):F,$=Ye?Qr(xe,Te):xe,H=Re,O=Re.length,X=Ye?Qr(We,Te):We,N=new Map;for(let Ae of k)N.set(Ae.id,"open");for(let Ae of T)N.set(Ae.id,"open");for(let Ae of B)N.set(Ae.id,"in_progress");for(let Ae of $)N.set(Ae.id,"resolved");for(let Ae of H)N.set(Ae.id,"deferred");for(let Ae of X)N.set(Ae.id,"closed");L=new Map;for(let Ae of k)L.set(Ae.id,"blocked-col");for(let Ae of T)L.set(Ae.id,"ready-col");for(let Ae of B)L.set(Ae.id,"in-progress-col");for(let Ae of $)L.set(Ae.id,"resolved-col");for(let Ae of X)L.set(Ae.id,"closed-col")}ze()}catch{k=[],T=[],B=[],$=[],H=[],X=[],ue=new Map,ze()}}function ke(F){let G=new Map;for(let fe of F)fe&&fe.id&&!G.has(fe.id)&&G.set(fe.id,fe);let se=new Map;for(let fe of G.values()){let xe=Is(fe);if(!xe)continue;let Re=se.get(xe);Re||(Re=[],se.set(xe,Re)),Re.push({id:fe.id,title:fe.title,status:fe.status,metadata:fe.metadata,created_at:fe.created_at,updated_at:fe.updated_at})}ue=se}function pe(F){let G=ue.get(F)||[],se=0;for(let xe of G)(xe.status==="resolved"||xe.status==="closed")&&(se+=1);let fe=Dn(G);return{total:G.length,count:se,current:fe,children:G}}function W(F){return!ve.has(F)}function j(F,G){F.preventDefault(),F.stopPropagation(),ve.has(G)?ve.delete(G):ve.add(G),ze()}function he(F,G){F.preventDefault(),F.stopPropagation(),n(G)}function V(F,G){F.preventDefault(),F.stopPropagation(),n(G)}function $e(F,G){Me||n(G)}function M(F,G){F.preventDefault(),F.stopPropagation(),Jc(G).then(se=>{se&&Z("\uBCF5\uC0AC\uB428","success",1200)})}function P(F,G){Me=G,F.dataTransfer&&(F.dataTransfer.setData("text/plain",G),F.dataTransfer.effectAllowed="move"),F.target.classList.add("board-card--dragging")}function oe(F){F.target.classList.remove("board-card--dragging"),It(),setTimeout(()=>{Me=null},0)}function Fe(F){let G=String(F.target.value||"");!G||G===m||(m=G,u&&u(G),ze())}function Ee(){return i?i.get():null}function Be(F){let G=c?c.get():null,se=G?G.cleanup_failed:null;if(!se||typeof se!="object"||Array.isArray(se))return null;let fe=se[F];return!fe||typeof fe!="object"||Array.isArray(fe)?null:fe}let De={onCardClick:$e,onCopyId:M,onDragStart:P,onDragEnd:oe,onClosedRangeChange:Fe,rollupFor:pe,isExpanded:W,onRollupToggle:j,onChildClick:he,onFromChipClick:V,cleanupFailureFor:Be,get policy(){return Ee()}};function Ke(F,G){Me||(ie(),n(G))}function C(F,G){F.preventDefault(),F.stopPropagation(),ie(),n(G)}let me={...De,onCardClick:Ke,onChildClick:C,onFromChipClick:C,get policy(){return Ee()}};function S(F){let G=F.target,se=e.querySelector(".board-filter__labels");G&&se&&se.contains(G)||Y()}function I(F){F.key==="Escape"&&Y()}function A(){be||(be=!0,document.addEventListener("mousedown",S),document.addEventListener("keydown",I),ze())}function Y(){be&&(be=!1,document.removeEventListener("mousedown",S),document.removeEventListener("keydown",I),ze())}function K(F){F.key==="Escape"&&ie()}function re(){U||(U=!0,document.addEventListener("keydown",K),ze())}function ie(){U&&(U=!1,document.removeEventListener("keydown",K),ze())}let Ce={onClose:ie,onOverlayClick(F){F.target===F.currentTarget&&ie()}},je={onSearchInput(F){ne.search=String(F.target.value||""),ge()},onPriorityChange(F){ne.priority=String(F.target.value||""),ge()},onTypeChange(F){ne.type=String(F.target.value||""),ge()},onSortChange(F){let G=String(F.target.value||"");if(!(!Pa.has(G)||G===x)){x=G;try{window.localStorage.setItem(Ma,G)}catch{}ge()}},onDeferredToggle(){U?ie():re()},onLabelMenuToggle(){be?Y():A()},onLabelToggle(F){let G=ne.labels.indexOf(F);G===-1?ne.labels.push(F):ne.labels.splice(G,1),ge()},onLabelClear(){ne.labels.length!==0&&(ne.labels=[],ge())},onNewIssue(){f&&f()}};function rt(){return l`
      <div class="board-view">
        ${Oa(ne,je,{sort_mode:x,deferred_popup_open:U,deferred_count:O,label_options:Xe(),label_menu_open:be})}
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+er(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},Ar=new uu;function Ve(e,t){return Ar.parse(e,t)}Ve.options=Ve.setOptions=function(e){return Ar.setOptions(e),Ve.defaults=Ar.defaults,pi(Ve.defaults),Ve};Ve.getDefaults=Gs;Ve.defaults=Tr;Ve.use=function(...e){return Ar.use(...e),Ve.defaults=Ar.defaults,pi(Ve.defaults),Ve};Ve.walkTokens=function(e,t){return Ar.walkTokens(e,t)};Ve.parseInline=Ar.parseInline;Ve.Parser=Ut;Ve.parser=Ut.parse;Ve.Renderer=Kn;Ve.TextRenderer=eo;Ve.Lexer=Bt;Ve.lexer=Bt.lex;Ve.Tokenizer=Vn;Ve.Hooks=cn;Ve.parse=Ve;var Y_=Ve.options,V_=Ve.setOptions,K_=Ve.use,Z_=Ve.walkTokens,X_=Ve.parseInline;var Q_=Ut.parse,J_=Bt.lex;function pr(e){let t=Ve.parse(e),r=ri.sanitize(t);return oi(r)}function tr(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
    ...
    </div>`}function O(){if(!o||!n)return[];let M=n.get(o);return Ai(M?M.lines:[])}function x(){if(!o||!n)return null;let M=n.get(o),P=M?M.last_event_at:null;return typeof P=="number"?P:null}function N(){return a.status==="running"}function L(){if(N()&&o){m||(m=setInterval(()=>we(),1e3));return}ue()}function ue(){m&&(clearInterval(m),m=null)}function ve(M){let P=[],oe=0;for(;oe<M.length;){let Fe=M[oe];if(Fe.kind==="tool"){let Ee=oe;for(;Ee<M.length&&M[Ee].kind==="tool"&&M[Ee].tool===Fe.tool;)Ee+=1;if(Ee-oe>=vu&&!u.has(oe)){P.push({kind:"group",idx:oe,tool:Fe.tool||"",lines:M.slice(oe,Ee).map((Be,De)=>({idx:oe+De,line:Be}))}),oe=Ee;continue}}P.push({kind:"line",idx:oe,line:Fe}),oe+=1}return P}function ne(M){for(let P=M.length-1;P>=0;P-=1){let oe=M[P];if(oe.kind==="result"||oe.kind==="error")return null;if(oe.kind==="tool"&&!Object.hasOwn(oe,"result"))return oe}return null}function be(M){for(let P=M.length-1;P>=0;P-=1)if(M[P].kind==="thinking")return M[P];return null}function Me(M,P){if(P.kind==="gate")return l`<div class="sv__gate">${P.text}</div>`;if(P.kind==="phase")return l`<div class="sv__phase">${P.text}</div>`;if(P.kind==="result")return l`<div
      ...
      >
        ...
        >
      </div>`;if(P.kind==="thinking"){let oe=c.has(M);return l`<div
      ...
      >
        ...
        ${oe?l`<pre class="sv__think-expand">${P.text}</pre>`:""}
      </div>`}if(P.kind==="error")return l`<div class="sv__error">⛔ ${P.text}</div>`;if(P.kind==="blocker")return l`<div class="sv__error">⛔ ${P.text}</div>`;if(P.kind==="tool"){let oe=c.has(M),Fe=P.tool==="Bash"?Su(P.command):0,Ee=P.tool==="Bash"?Fe>1?Jn(P.command):P.command:P.path||P.command||"";return l`<div
      ...
      >
        ...
        ${oe?l`<pre class="sv__tool-expand">${tt(P)}</pre>`:""}
...
`)}function Je(){if(!o)return l``;let M=O(),P=[a.runner,a.model,a.effort].filter(Boolean).join(" \xB7 "),oe=a.session_id||"",Fe=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${i?"ON":"OFF"}`,Ee=N(),Be=Ee?Iu(x(),Date.now()):"",De=Ee?ne(M):null,Ke=Ee?be(M):null,C=Ru(M);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
      ...
      ${U()}
      <div class="sv__body">
        ${M.length===0?l`<div class="sv__empty">세션 로그 없음</div>`:ve(M).map(me=>me.kind==="group"?Ie(me):Me(me.idx,me.line))}
      </div>
...
`).trim()}}var Ci=20;function Ri(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function Nu(e){return e.length>Ci?`${e.slice(0,Ci)}\u2026`:e}function Fu(e,t,r,n){let s=`${t.lane} ${Nu(t.identifier)}`;return l`<div class="detail-report">
  ...
  `}function ip(e){let t=qr(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?tr("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var lp=["open","in_progress","deferred","resolved","closed"],cp=[0,1,2,3,4];function Gi(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,c=t.sessionLogStore,u=null,f=null,m={},h="",E=!1,k=!1,T=!1,B="",$="",H="";function X(){k=!1,T=!1,B="",$="",H=""}let U=[],O=null,x=null,N=!1,L="",ue=!1,ve=0,ne=new Set;function be(){U=[],O=null,x=null,N=!1,L="",ue=!1,ve+=1,ne.clear()}async function Me(d){if(!s)return;let w=++ve;try{let y=await Promise.resolve(s("get-comments",{id:d}));if(w!==ve||d!==u)return;U=Array.isArray(y)?y:[],N=!1}catch{if(w!==ve||d!==u)return;N=!0}_()}function tt(){if(!s||!u)return;let d=f&&typeof f.comment_count=="number"?f.comment_count:null;if(O!==u){O=u,x=d,Me(u);return}d!==null&&d!==x&&(x=d,Me(u))}function Je(d){ne.has(d)?ne.delete(d):ne.add(d),_()}function Ie(d){let w=L.trim().length===0;L=d,w!==(d.trim().length===0)&&_()}async function Xe(){let d=L.trim();if(!s||!u||d.length===0||ue)return;let w=u;ue=!0,_();let y=!1;try{let D=await Promise.resolve(s("add-comment",{id:w,text:d}));Array.isArray(D)&&D.length>0&&(y=!0,w===u&&(U=D,N=!1,L="",x=D.length))}catch{y=!1}y||Z("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),w===u&&(ue=!1),_()}let we={onToggle:Je,onDraftInput:Ie,onSubmit:Xe},ge=document.createElement("div");ge.className="md-viewer-root",document.body.appendChild(ge);let ke=qi(ge,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),pe=document.createElement("div");pe.className="session-log-root",document.body.appendChild(pe);let W=es(pe,{transport:s?(d,w)=>Promise.resolve(s(d,w)):void 0,sessionLogStore:c}),j=!1,he=!1,V=!1,$e=null,M=null,P=0;function oe(d){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${d}`}function Fe(){j=!1,he=!1,V=!1,$e=null,M=null,P+=1}async function Ee(d){if(!s)return;let w=++P;he=!0,V=!1,_();try{let y=await Promise.resolve(s("get-bead-prompt",{bead_id:d}));if(w!==P)return;!y||typeof y!="object"||Array.isArray(y)?V=!0:($e=y,M=oe(d))}catch{w===P&&(V=!0)}finally{w===P&&(he=!1,_())}}function Be(){if(j=!j,j&&u&&M!==oe(u)){$e=null,Ee(u);return}_()}function De(){if(!a||!u)return[];let d=a.get();return(d&&d.attempts?Object.values(d.attempts):[]).filter(y=>y&&y.bead_id===u).sort((y,D)=>(D.started_at||0)-(y.started_at||0)).map(y=>({attempt_id:y.attempt_id,bead_id:y.bead_id,status:y.status,started_at:typeof y.started_at=="number"?y.started_at:null,runner:y.runner||null,model:y.model||null,effort:y.effort||null,speed:y.speed||null,session_id:y.session_id||null,resumed_from:y.resumed_from||null,continuation_mode:y.continuation_mode||null,dismissed_at:typeof y.dismissed_at=="number"?y.dismissed_at:null,cause:typeof y.cause=="string"?y.cause:null,cause_detail:y.cause_detail||null,exec_default_preset_id:typeof y.exec_default_preset_id=="string"?y.exec_default_preset_id:null,exec_default_preset_revision:typeof y.exec_default_preset_revision=="number"?y.exec_default_preset_revision:null,exec_values:y.exec_values&&typeof y.exec_values=="object"?y.exec_values:null,usage:y.usage||null,usage_legs:Array.isArray(y.usage_legs)?y.usage_legs:[]}))}function Ke(){if(!a||!u)return null;let d=a.get();return Ot(d&&d.attempts||{},u)}let C=new Set;function me(d){C.has(d)?C.delete(d):C.add(d),_()}function S(d){let w=a?a.get():null,y=w&&w.attempts?w.attempts[d]:null;W.open({attempt_id:d,meta:y?{runner:y.runner||void 0,model:y.model||void 0,effort:y.effort||void 0,status:y.status||void 0,session_id:y.session_id||void 0}:{}})}async function I(d){if(!s||!d)return;let w=()=>{let Se=a?a.get():null;return Se&&typeof Se.revision=="number"?Se.revision:0},y=async(Se={})=>await s("worker-attempt-resume",{attempt_id:d,expected_revision:w(),...Se}),D=Se=>{Se?.queue&&a?.set&&a.set(Se.queue)},J=await y();if(D(J),J&&J.conflict){let Se=J.queue&&typeof J.queue.revision=="number"?J.queue.revision:w();J=await s("worker-attempt-resume",{attempt_id:d,expected_revision:Se}),D(J)}J=await Gt(J,(Se,mt)=>y({continuation:Se,decision_token:mt}),{onResult:D,refresh:()=>y()}),J&&J.resumed===!1&&!J.conflict&&J.reason&&Z(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${J.reason}`,"error",2400)}let A={onOpen:S,onResume:I,onToggleUsage:me};function Y(){let d=a?a.get():null,w=d&&d.default_exec_preset_id,y=typeof w=="string"?Ce()?.presets.find(D=>D.id===w):null;return y&&y.compatible!==!1&&y.settings?y.settings:{}}function K(){let d=a?a.get():null,w=d&&d.default_exec_preset_id,y=typeof w=="string"?Ce()?.presets.find(D=>D.id===w):null;return y&&y.compatible!==!1&&typeof y.name=="string"?y.name:""}function re(){let d=a?a.get():null;return d&&d.runner_catalog||null}function ie(){let d=f?.metadata&&typeof f.metadata=="object"?f.metadata:{},y=(Object.hasOwn(m,"orchestration_model")?m.orchestration_model:void 0)||(typeof d.orchestration_model=="string"?d.orchestration_model:"")||(typeof Y().orchestration_model=="string"?Y().orchestration_model:"")||"opus";return rr(re(),y)}function Ce(){let d=i?i.get():null;return!d||typeof d.revision!="number"?null:{revision:d.revision,presets:Array.isArray(d.presets)?d.presets:[]}}function je(d){let w=d&&d.settings&&typeof d.settings=="object"?d.settings:{},y=D=>typeof w[D]=="string"?w[D]:D==="impl_runtime"&&typeof w.impl_model=="string"&&rr(re(),w.impl_model)||"";return Ur({selectedOf:y,effectiveOf:y,runner_catalog:re()}).some(D=>D.groups.some(J=>J.options.some(Se=>Se.value===D.selected&&Se.label.endsWith("(\uBE44\uD638\uD658)"))))}function rt(d){i&&d&&typeof d.revision=="number"&&Array.isArray(d.presets)&&i.set({revision:d.revision,presets:d.presets})}async function ze(){let d=Ce(),w=d?.presets.find(y=>y.id===h);if(!(!s||!u||!d||!w||je(w)||E)){E=!0,_();try{let y=await Promise.resolve(s("apply-exec-preset",{id:u,preset_id:w.id,expected_revision:d.revision}));if(y&&y.conflict){rt(y),Z("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let D=y&&Array.isArray(y.issue)?y.issue[0]:y?.issue;if(y&&y.applied&&D&&typeof D=="object"){f=D;for(let J of Er)delete m[J];Z("\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",2400);return}y&&y.error==="bd_readback_failed"?Z("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):Z("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(y){y&&typeof y=="object"&&y.code==="bd_readback_failed"?Z("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):Z("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{E=!1,_()}}}function bt(){let d=Ce();if(d&&d.presets.length===0)return l`<section class="detail-exec-presets">
      ...
      <div class="detail-exec-presets__controls">
        ...
        >
          ...
          ${w.map(J=>{let Se=je(J);return l`<option
              value=${J.id}
              ?selected=${J.id===h}
            >
              ${J.name}${Se?" (\uBE44\uD638\uD658)":""}
    ...
    </section>`}let ut=null;r&&r.subscribe&&(ut=r.subscribe(()=>nt()));let lt=null;a&&typeof a.subscribe=="function"&&(lt=a.subscribe(()=>{u&&_()}));let yt=null;i&&typeof i.subscribe=="function"&&(yt=i.subscribe(()=>{u&&_()}));function It(d){d.key==="Escape"&&u&&(d.preventDefault(),n())}document.addEventListener("keydown",It);function nt(){if(u){if(r&&typeof r.snapshotFor=="function"){let d=r.snapshotFor("detail:"+u)||[];f=d.find(y=>y&&y.id===u)||d[0]||f}tt(),_()}}function at(d){Sr(d).then(w=>{w?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function st(d){d.preventDefault(),d.stopPropagation(),u&&at(u)}function ct(d,w){d.preventDefault(),d.stopPropagation(),at(w)}function Oe(d,w,y){d.preventDefault(),d.stopPropagation(),ke.open(w,{missing_state:y})}function F(d,w){m[d]=w,_(),!(!s||!u)&&Promise.resolve(s("update-exec-settings",{id:u,key:d,value:w})).catch(()=>{Z("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function G(d,w){let y=f||{},D=y.metadata&&typeof y.metadata=="object"?y.metadata:{},J={};for(let qe of["impl_runtime","impl_model","impl_effort"])J[qe]=Object.hasOwn(m,qe)?m[qe]:typeof D[qe]=="string"?D[qe]:"";J[d]=w;let Se=ns(J,re(),ie()),mt={};for(let qe of["impl_runtime","impl_model","impl_effort"])mt[qe]=m[qe],m[qe]=Se[qe]||"";_(),!(!s||!u)&&Promise.resolve(s("update-impl-target",{id:u,...Se,orchestration_runtime:ie()})).then(qe=>{let or=Array.isArray(qe)?qe[0]:qe;if(!or||typeof or!="object"||!or.id)throw new Error("implementation target readback failed");f=or;for(let ls of["impl_runtime","impl_model","impl_effort"])delete m[ls];_()}).catch(()=>{for(let qe of["impl_runtime","impl_model","impl_effort"])mt[qe]===void 0?delete m[qe]:m[qe]=mt[qe];_(),Z("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function se(d,w,y){if(!s||!u)return!1;try{let D=await Promise.resolve(s(d,w)),J=Array.isArray(D)?D[0]:D;return J&&typeof J=="object"&&J.id?(f=J,!0):(Z(y,"error"),!1)}catch{return Z(y,"error"),!1}}function fe(d){setTimeout(()=>{try{let w=e.querySelector(d);w&&typeof w.focus=="function"&&w.focus()}catch{}},0)}function xe(){k=!0,B=f&&f.title||"",_(),fe('.detail-edit__input[data-edit="title"]')}function Re(d){B=d.target.value}function We(){k=!1,B="",_()}function et(){se("edit-text",{id:u,field:"title",value:B},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(w=>{w&&(k=!1,B=""),_()})}function Te(){T=!0,$=f&&f.description||"",_(),fe('.detail-edit__textarea[data-edit="description"]')}function Ye(d){$=d.target.value}function Ae(){T=!1,$="",_()}function pt(){se("edit-text",{id:u,field:"description",value:$},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(w=>{w&&(T=!1,$=""),_()})}function ht(d,w,y,D){if(d.key==="Escape"){d.stopPropagation(),y();return}d.key==="Enter"&&(!D||d.ctrlKey||d.metaKey)&&(d.preventDefault(),w())}function sr(d){let w=d.target.value;se("update-status",{id:u,status:w},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>_())}function jt(d){let w=Number(d.target.value);se("update-priority",{id:u,priority:w},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>_())}function p(d){H=d.target.value}function v(){let d=H.trim();d.length!==0&&se("label-add",{id:u,label:d},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(w=>{w&&(H=""),_()})}function R(d){if(d.key==="Escape"){d.stopPropagation(),H="",_();return}d.key==="Enter"&&(d.preventDefault(),v())}function Q(d){se("label-remove",{id:u,label:d},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>_())}let _e={onCopyPath:ct,onOpenDoc:Oe},ye={onChange:F,onImplTargetChange:G};function le(d){return typeof d=="string"?d:d&&typeof d=="object"?String(d.id||d.to||d.issue_id||d.depends_on||""):""}function ce(d){switch(d&&typeof d=="object"?String(d.dependency_type||d.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Le(d){let y=(Array.isArray(d.dependencies)?d.dependencies:[]).map(D=>({id:le(D),icon:ce(D)})).filter(D=>D.id.length>0);return l`
    ...
    `}function it(d){let w=d.metadata||{},y=d.workflow||{},D=y.stages||{},J=D.spec&&D.spec.stale,Se=D.impl&&D.impl.stale,mt=D.plan||null,qe=y.route_source==="derived",or=y.route||w.route||"\u2014";return l`
      ...
      ${y.route!=="quick_fix"||Object.hasOwn(w,"impl_review")?l`<div class="detail-kv">
            ...
            <span class="detail-kv__v"
              >${w.impl_review||"\uC5C6\uC74C"}${Se?" \xB7 stale":""}</span
            >
          </div>`:""}
    ...
    `}let ft={route:["quick_fix","spec_backed","full_plan"]};async function St(d,w){let y=w.target.value;if(d==="route"&&f&&f.metadata&&f.metadata.route==="full_plan"&&y!=="full_plan"&&!window.confirm(`full_plan \u2192 ${y||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){_();return}await se("update-workflow-meta",{id:u,key:d,value:y},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),_()}function vt(d){let w=d.metadata||{};return l` ${((D,J)=>{let Se=ft[D],mt=typeof w[D]=="string"?w[D]:"";return l`<div class="detail-kv">
        ...
        <select
          ...
          @change=${qe=>St(D,qe)}
        >
          <option value="" ?selected=${!Se.includes(mt)}>
            ${J}
          </option>
          ${Se.map(qe=>l`<option value=${qe} ?selected=${mt===qe}>${qe}</option>`)}
        </select>
      </div>`})("route","(unset)")} `}function de(d,w){return k?l`
    ...
    `}function ae(){if(!u)return l``;let d=f||{},w=String(d.id||u),y=d.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",D=Ke(),J=d.status||"open",Se=typeof d.priority=="number"?Math.max(0,Math.min(4,d.priority)):"",mt=d.description||"",qe={...d,metadata:{...d.metadata||{},...m}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${z(J,Se)} ${b(d)}
          ${ee(mt)}
          ${Ii(U,we,{expanded:ne,draft:L,sending:ue,error:N})}
          ${Ne(d)} ${Ze(d)} ${Le(d)}
          ${it(d)} ${vt(d)}
          ${Ei(d,_e)}
          ${bt()}
          ${Fi(qe,ye,Y(),re(),K())}
          ${Wi({expanded:j,loading:he,error:V,data:$e},{onToggle:Be})}
          ${Hi(De(),A,{total:D,expanded:C})}
        </div>
      </div>
    `}function _(){Ue(ae(),e)}return{load(d){d!==u&&(m={},h="",X(),be(),Fe()),u=d,f=null,nt()},clear(){u=null,f=null,m={},h="",E=!1,X(),be(),Fe(),ke.close(),W.close(),Ue(l``,e)},destroy(){ut&&(ut(),ut=null),lt&&(lt(),lt=null),yt&&(yt(),yt=null),document.removeEventListener("keydown",It),ke.destroy(),ge.parentNode&&ge.parentNode.removeChild(ge),W.destroy(),pe.parentNode&&pe.parentNode.removeChild(pe),u=null,f=null,h="",E=!1,be(),Fe(),Ue(l``,e)}}}var dp=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Yi(e,t){return Rs(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function up(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}function Vi(e,t){let{policyStore:r,transport:n,labelOptions:s}=t,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),e.appendChild(o);let a="";async function i(x){let N=r.get();if(N)try{let L=await n("display-policy-set",{expected_revision:N.revision,policy:x(N)});c(L),L&&L.conflict&&L.policy&&(L=await n("display-policy-set",{expected_revision:L.policy.revision,policy:x(L.policy)}),c(L)),L&&L.conflict&&Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Z("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function c(x){x&&x.policy&&typeof x.policy=="object"&&r.set(x.policy)}function u(x){let N=r.get();if(!N)return;let L=Yi(x,N)!=="shown";i(ue=>up(x,ue,L))}function f(){let x=a.trim();x.length!==0&&(a="",i(N=>N.hidden_prefixes.includes(x)?{hidden_prefixes:N.hidden_prefixes}:{hidden_prefixes:[...N.hidden_prefixes,x]}),B())}function m(x){i(N=>({hidden_prefixes:N.hidden_prefixes.filter(L=>L!==x)}))}function h(x){let N=r.get();if(!N)return;let L=N.chips[x]===!1;i(()=>({chips:{[x]:L}}))}function E(x){let N=s();return l`
      <section class="display-settings__section">
        ...
        ${N.length===0?l`<div class="display-settings__empty">라벨 없음</div>`:l`<div class="display-settings__pills">
              ${N.map(L=>{let ue=Yi(L,x);return l`<button
                  type="button"
    ...
    `}function T(x){return l`
      <section class="display-settings__section">
        ...
        <div class="display-settings__toggles">
          ${dp.map(([N,L])=>l`<label class="display-settings__toggle">
                <input
                  type="checkbox"
                  data-chip=${N}
                  .checked=${x.chips[N]!==!1}
    ...
    <div class="fatal-error">
    ...
    </div>`,e.appendChild(t);let r=t.querySelector("#fatal-error-title"),n=t.querySelector("#fatal-error-message"),s=t.querySelector("#fatal-error-detail"),o=t.querySelector("#fatal-error-reload"),a=t.querySelector("#fatal-error-close"),i=()=>{if(typeof t.close=="function")try{t.close()}catch{}t.removeAttribute("open")},c=(u,f,m="")=>{r&&(r.textContent=u||"Unexpected Error"),n&&(n.textContent=f||"An unrecoverable error occurred.");let h=typeof m=="string"?m.trim():"";if(s&&(h.length>0?(s.textContent=h,s.removeAttribute("hidden")):(s.textContent="No additional diagnostics available.",s.setAttribute("hidden",""))),typeof t.showModal=="function")try{t.showModal(),t.setAttribute("open","")}catch{t.setAttribute("open","")}else t.setAttribute("open","")};return o&&o.addEventListener("click",()=>{window.location.reload()}),a&&a.addEventListener("click",()=>i()),t.addEventListener("cancel",u=>{u.preventDefault(),i()}),{open:c,close:i,getElement(){return t}}}function Zi(e){if(typeof e!="number"||!Number.isFinite(e)||e<=0)return"";if(e<6e4)return`${Math.round(e/1e3)}\uCD08`;let t=e/6e4;return`${Number.isInteger(t)?t:Math.round(t*10)/10}\uBD84`}function Xi(e){return Array.isArray(e)?e.filter(t=>typeof t=="string").join(" "):""}function ss(e,t){let{queueStore:r,presetStore:n,transport:s,getWorkspacePath:o}=t,a=document.createElement("dialog");a.id="worker-exec-defaults-dialog",a.className="exec-defaults",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),e.appendChild(a);let i=null,c=!1;function u(){return r&&r.get()||{revision:0,exec_defaults:{}}}function f(){let C=u();return typeof C.revision=="number"?C.revision:0}function m(){let C=n?n.get():null;return!C||typeof C.revision!="number"?null:{revision:C.revision,presets:Array.isArray(C.presets)?C.presets:[]}}function h(C){n&&C&&typeof C.revision=="number"&&Array.isArray(C.presets)&&n.set({revision:C.revision,presets:C.presets})}function E(C){C&&C.queue&&r&&r.set(C.queue)}function k(){return u().runner_catalog??null}let T=null;function B(){if(T!==null)return T;let C=u().default_exec_preset_id;return typeof C=="string"&&C.length>0?C:null}async function $(C){if(!s)return;let me=m();if(!me)return;T=C||"";let S=O(C);if(M(),!S.viable){Z(S.missing?"\uC120\uD0DD\uD55C \uD504\uB9AC\uC14B\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC5B4 \uC800\uC7A5\uD558\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.":"\uBE44\uD638\uD658 \uD504\uB9AC\uC14B\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uAE30\uBCF8\uAC12\uC73C\uB85C \uC800\uC7A5\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.","error",4e3),T=null,M();return}try{let I=await s("worker-queue-set-default-exec-preset",{preset_id:C||null,expected_queue_revision:f(),expected_preset_revision:me.revision});E(I),I&&I.presets&&n&&n.set(I.presets),I&&I.conflict?Z("\uAE30\uBCF8 \uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uC120\uD0DD\uC744 \uAC80\uD1A0\uD55C \uB4A4 \uB2E4\uC2DC \uC800\uC7A5\uD558\uC138\uC694.","error",4e3):I&&I.applied||Z("\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uAE30\uBCF8 \uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}catch{Z("\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4 \uAE30\uBCF8 \uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}T=null,M()}function H(C){i={id:C.id,name:C.name,settings:{...C.settings||{}}},N(),c=!1,M()}function X(){i={id:null,name:"",settings:{}},c=!1,M()}function U(C){let me=C&&C.settings&&typeof C.settings=="object"?C.settings:{},S=I=>typeof me[I]=="string"?me[I]:I==="impl_runtime"&&typeof me.impl_model=="string"&&rr(k(),me.impl_model)||"";return Ur({selectedOf:S,effectiveOf:S,runner_catalog:k()}).some(I=>I.groups.some(A=>A.options.some(Y=>Y.value===I.selected&&Y.label.endsWith("(\uBE44\uD638\uD658)"))))}function O(C){if(!C)return{viable:!0,missing:!1,incompatible:!1,preset:null};let S=m()?.presets.find(A=>A.id===C);if(!S||S.migration_pending===!0)return{viable:!1,missing:!0,incompatible:!1,preset:null};let I=S.compatible===!1||U(S);return{viable:!I,missing:!1,incompatible:I,preset:S}}function x(){let C=i?.settings.orchestration_model;return typeof C!="string"?null:rr(k(),C)}function N(){if(!i)return;let C=ns({impl_runtime:i.settings.impl_runtime||"",impl_model:i.settings.impl_model||"",impl_effort:i.settings.impl_effort||""},k(),x());for(let me of["impl_runtime","impl_model","impl_effort"])C[me]?i.settings[me]=C[me]:delete i.settings[me]}function L(C){let me=C&&C.settings&&typeof C.settings=="object"?C.settings:{},S=Er.filter(A=>typeof me[A]=="string").length,I=Er.filter(A=>typeof me[A]=="string").map(A=>`${so[A]?.title||A}: ${me[A]}`);return{count:`${S}/12 \uC9C0\uC815`,choices:I.length>0?I.join(" \xB7 "):"\uBAA8\uB4E0 \uD56D\uBAA9 \uAE30\uBCF8\uAC12"}}async function ue(C){if(!s||!window.confirm(`\u201C${C.name}\u201D \uD504\uB9AC\uC14B\uC744 \uC0AD\uC81C\uD560\uAE4C\uC694? \uC774\uBBF8 \uC801\uC6A9\uB41C \uC774\uC288\uB294 \uBCC0\uACBD\uB418\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.`))return;let me=m();if(me)try{let S=await s("exec-preset-delete",{expected_revision:me.revision,id:C.id});h(S),S&&S.conflict&&Z("\uD504\uB9AC\uC14B\uC774 \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694.","error",4e3)}catch{Z("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328","error",4e3)}}async function ve(C=!1){if(!s||!i)return;let me=m();if(!me)return;let S=C||i.id===null,I={expected_revision:me.revision,...S?{}:{id:i.id},name:i.name,settings:{...i.settings}};try{let A=await s(S?"exec-preset-create":"exec-preset-update",I);if(h(A),A&&A.conflict){c=!0,M();return}if(A&&A.applied){i=null,c=!1,M();return}Z("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}catch{Z("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function ne(C){return l`<div class="exec-defaults__row exec-preset-editor__row">
      <span class="exec-defaults__k">${ao(C.key)}</span>
      <select
        class="exec-defaults__sel"
        data-preset-key=${C.key}
        ?disabled=${C.disabled}
        @change=${me=>{if(!i)return;let S=me.target.value;S?i.settings[C.key]=S:delete i.settings[C.key],(C.key==="impl_runtime"||C.key==="impl_model"||C.key==="impl_effort"||C.key==="orchestration_model")&&N(),c=!1,M()}}
      >
        ${rs(C.groups,C.selected,oo[C.key]||"(\uAE30\uBCF8)")}
      </select>
    </div>`}function be(){if(!i)return"";let C=K=>typeof i?.settings[K]=="string"?i.settings[K]:"",me=Ur({selectedOf:C,effectiveOf:C,runner_catalog:k(),controller_runtime:x()}),S=fn.flatMap(K=>K.keys).filter(K=>typeof i?.settings[K]=="string").length,I=K=>{let re=me.find(ie=>ie.key===K);return re?ne(re):""},A=m(),Y=i.id!==null&&A!==null&&!A.presets.some(K=>K.id===i?.id);return l`<div class="exec-preset-editor" data-preset-editor>
    ...
    </div>`}function Me(){let C=m(),me=C?C.presets.filter(A=>A?.migration_pending!==!0):[],S=B()||"",I=O(S);return l`<section class="exec-presets" data-exec-presets>
      ...
      ${C===null?l`<p class="exec-presets__empty">프리셋을 불러오는 중…</p>`:me.length===0?l`<p class="exec-presets__empty">
              아직 공용 프리셋이 없습니다.
            </p>`:me.map(A=>{let Y=L(A),K=O(A.id),re=A.id===S,ie=K.missing?"\uD504\uB9AC\uC14B\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC5B4 \uAE30\uBCF8\uC73C\uB85C \uC9C0\uC815\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":K.incompatible?"\uBE44\uD638\uD658 \uD504\uB9AC\uC14B\uC740 \uAE30\uBCF8\uC73C\uB85C \uC9C0\uC815\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"",Ce=typeof A.reference_count=="number",je=Ce?A.reference_count:null,rt=Array.isArray(A.reference_summary)?A.reference_summary.map(ze=>ze?.display_name||ze?.workspace_key).filter(Boolean).join(", "):"";return l`<article
              ...
              >
                ...
                <div class="exec-preset-card__actions">
                  ${re?l`<button
                        type="button"
                        data-workspace-preset-release=${A.id}
                        @click=${()=>{$("")}}
                      >
                        기본 해제
                      </button>`:l`<button
                        type="button"
                        data-workspace-preset-assign=${A.id}
                        ?disabled=${!K.viable}
                        title=${ie}
                        @click=${()=>{$(A.id)}}
                      >
                  ...
                  <button
                    ...
                    ?disabled=${je===null||je>0||A.reference_scan_complete===!1}
                    title=${je===null?"\uCC38\uC870 \uC218\uB97C \uD655\uC778\uD560 \uC218 \uC5C6\uC5B4 \uC0AD\uC81C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":je>0?"\uCC38\uC870 \uC911\uC778 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC788\uC5B4 \uC0AD\uC81C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":A.reference_scan_complete===!1?"\uCC38\uC870 \uC2A4\uCE94\uC774 \uC644\uB8CC\uB418\uC9C0 \uC54A\uC544 \uC0AD\uC81C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":""}
                    @click=${()=>{ue(A)}}
                  >
                    삭제
                  </button>
      ...
      ${C!==null&&S&&I.missing?l`<article class="exec-preset-card" data-workspace-preset-missing>
            <div class="exec-preset-card__main">
            ...
            <div class="exec-preset-card__actions">
              <button
                type="button"
                data-workspace-preset-release=${S}
                @click=${()=>{$("")}}
              >
                기본 해제
              </button>
      ...
      ${be()}
    </section>`}function tt(){let C=u().workspace_info;return C&&typeof C=="object"?C:{}}function Je(C,me){return l`<span
      class="exec-defaults__vd-badge exec-defaults__vd-badge--${C}"
      >${me}</span
    >`}function Ie(C){let me=C?Xi(C.cmd):"",S=C?Zi(C.timeout_ms):"",I=o&&o()||"<workspace \uACBD\uB85C>";return l`<div class="exec-defaults__vd-group" data-vd="verify">
      <div class="exec-defaults__vd-label">머지 전 검증 (verify)</div>
      ${me?l`<div class="exec-defaults__vd-line">
            <span class="exec-defaults__vd-cmd">${me}</span>
            ${Je("config","config")}
            ${S?l`<span class="exec-defaults__vd-meta"
                  >timeout ${S}</span
                >`:""}
    ...
    </div>`}function Xe(C){let me=C?Xi(C.cmd):"",S=C?Zi(C.timeout_ms):"",I=S?`timeout ${S} \xB7 external deployer \uC2E4\uD589`:"external deployer \uC2E4\uD589";return l`<div class="exec-defaults__vd-group" data-vd="deploy">
    ...
    </div>`}let we=!1,ge=!1,ke=!1,pe=null;async function W(){if(s){ge=!0,ke=!1,M();try{let C=await Promise.resolve(s("get-worker-system-prompt",{}));!C||typeof C!="object"||Array.isArray(C)?ke=!0:pe=C}catch{ke=!0}finally{ge=!1,M()}}}function j(){if(we=!we,we&&!pe){W();return}M()}function he(){return l`<section class="exec-defaults__sp" data-seam="system-prompt">
      ...
      ${we?V():""}
    </section>`}function V(){let C=qr({loading:ge,error:ke});if(C)return C;if(!pe)return"";let me=Array.isArray(pe.variants)?pe.variants:[];return l`<div class="exec-defaults__sp-body">
      ${pe.target_base_placeholder?l`<div class="prompt-block__meta">
            \`${pe.target_base_placeholder}\`는 디스패치 시점에 해석된
            base로 치환됩니다.
          </div>`:""}
      ${me.map(S=>l`<div class="exec-defaults__sp-variant" data-variant=${S.key}>
            <div class="exec-defaults__sp-cond">${S.condition}</div>
            ${tr(S.label,S.system_prompt)}
          </div>`)}
    </div>`}function $e(C){return l`<section class="exec-defaults__vd">
      <p class="exec-defaults__vd-title">
        검증·배포 설정
  ...
  >`,T=l`<span class="worker-mini__title">${e.title}</span>`,B=e.pr_url&&e.pr_number?l`<a
      ...
      >
        취소
      </button>`:"",L=e.discard,ue=L?.action||e.discard_action?l`<button
          type="button"
        ...
        >
          승인하고 진행
        </button>`:"",ne=!!(o||a||e.merge_action||e.cancel_action||e.discard_action||L?.operation||e.revise_action);return l`<div
  ...
  >
    ${c?l`<div class="worker-mini__row1">${E}${k}${T}</div>
          <div class="worker-mini__row2">
            ...
            ${ne?l`<div class="worker-mini__foot">
                  ${U}${O}
                  <span class="worker-mini__actions"
                    >${x}${N}${ue}${ve}</span
                  >
...
${V.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};f.push(P);let oe=h.get(H);oe?oe.push(P):h.set(H,[P])}for(let W of Array.isArray($.runnable)?$.runnable:[]){let j=W&&W.bead_id;typeof j!="string"||pe.has(j)||(pe.add(j),i.push({...ke(j),title:W.title||N[j]||j,lane:"runnable",draggable:!0,reason:cl(ue,j),created_at:W.created_at??void 0,updated_at:W.updated_at??void 0,labels:Array.isArray(W.labels)?W.labels:[],spec_reviewer:typeof W.spec_reviewer=="string"?W.spec_reviewer:void 0,plan_state:W.plan_state==="approved"||W.plan_state==="authored"?W.plan_state:"none",workflow:W.route?{route:W.route,chips:{route:W.route}}:null,place_index:Xe.length}))}for(let W of we){let j=W&&W.bead_id;if(typeof j!="string"||pe.has(j)||(pe.add(j),o!==void 0&&typeof W.added_at=="number"&&W.added_at<o))continue;let he=kp(x,j);m.push({...ke(j),lane:"done",done:!0,usage:Ot(x,j),done_at:typeof W.added_at=="number"?W.added_at:void 0,done_kind:he&&typeof he.done_kind=="string"?he.done_kind:null})}}let E=new Map;s.forEach(($,H)=>{$&&typeof $.root_dir=="string"&&E.set($.root_dir,H)});let k=r&&r.running_sort==="repo"?"repo":"started";c.sort(($,H)=>{if(k==="repo"){let O=E.get($.root_dir)??Number.MAX_SAFE_INTEGER,x=E.get(H.root_dir)??Number.MAX_SAFE_INTEGER;if(O!==x)return O-x}let X=typeof $.started_at=="number"&&Number.isFinite($.started_at)?$.started_at:null,U=typeof H.started_at=="number"&&Number.isFinite(H.started_at)?H.started_at:null;return X!==null&&U!==null&&X!==U?X-U:X===null&&U!==null?1:X!==null&&U===null?-1:$.id.localeCompare(H.id)}),m.sort(($,H)=>(H.done_at??0)-($.done_at??0));let T=s.length>0?s:n.map($=>({root_dir:$&&$.root_dir,name:$&&$.name,auto_advance:$&&$.auto_advance,auto_merge:$&&$.auto_merge,slots:$&&$.slots,revision:$&&$.revision,exec_defaults:$&&$.exec_defaults,default_exec_preset_id:$&&$.default_exec_preset_id,runner_catalog:$&&$.runner_catalog})),B=[];for(let $ of T)!$||typeof $.root_dir!="string"||B.push({root_dir:$.root_dir,name:$.name||$.root_dir,auto_advance:$.auto_advance===!0,auto_merge:$.auto_merge===!0,slots:typeof $.slots=="number"&&$.slots>=mn?$.slots:mn,revision:typeof $.revision=="number"?$.revision:0,exec_defaults:Rt($.exec_defaults),default_exec_preset_id:typeof $.default_exec_preset_id=="string"?$.default_exec_preset_id:null,runner_catalog:Rt($.runner_catalog),items:h.get($.root_dir)||[]});return{runnable:i,queue:f,queue_groups:B,running:c,pr_wait:u,done:m,automation:{total:B.length,both_on:B.filter($=>$.auto_advance&&$.auto_merge).length}}}function xp(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<yp;return l`<span
  ...
  >
    ${dl(e,t)}
  </div>`}function yl(e,t){let r=ot("views:monitor"),n=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.execPresetStore,i=t.getWorkspacePath,c=t.switchWorkspace,u=t.now||(()=>Date.now()),f=t.confirm||(S=>typeof globalThis.confirm!="function"||globalThis.confirm(S)),m=Ip(),h=Dp();function E(){let S=Ht.find(I=>I.value===m);return S?S.label:""}let k=document.createElement("div");k.className="mon",e.appendChild(k);let T=go(null,null),B=null,$=new Map,H=new Set;function X(S){return T.queue_groups.find(I=>I.root_dir===S)||null}let O=ss(e,{queueStore:{get(){if(!B)return{revision:0,exec_defaults:{},default_exec_preset_id:null};let S=$.get(B);if(S)return S;let I=X(B),A=s&&s.get?s.get():null,Y=(Array.isArray(A)?A:[]).find(K=>K&&K.root_dir===B);return{revision:I?I.revision:0,exec_defaults:I?I.exec_defaults:{},default_exec_preset_id:I?I.default_exec_preset_id:null,runner_catalog:I?I.runner_catalog:null,workspace_info:Y?Y.workspace_info:void 0}},set(S){B&&$.set(B,S);for(let I of Array.from(H))I()},subscribe(S){return H.add(S),()=>H.delete(S)}},presetStore:a,transport:o?(S,I)=>o(S,S==="worker-queue-set-default-exec-preset"||S==="get-worker-system-prompt"?{...I||{},root_dir:B}:I):void 0,getWorkspacePath:()=>B||void 0}),x=null,N=null;async function L(S,I,A,Y,K=!0){if(!o||!A)return null;let re=await o(S,{...I,root_dir:A,expected_revision:Y});if(re&&re.conflict&&K){re.queue&&$.set(A,re.queue);let ie=re.queue&&typeof re.queue.revision=="number"?re.queue.revision:Y;re=await o(S,{...I,root_dir:A,expected_revision:ie})}return re&&re.queue&&A&&$.set(A,re.queue),re}function ue(S,I){let A=$.get(S),Y=s&&s.get?s.get():null,K=(Array.isArray(Y)?Y:[]).find(ie=>ie?.root_dir===S);return(A||K)?.merge_queue?.find(ie=>ie.bead_id===I)?.continuation_action}async function ve(S,I,A,Y){let K=await L(S,I,A,Y),re=$.get(A)?.revision??K?.queue?.revision??Y;return Gt(K,(ie,Ce)=>L(S,{...I,continuation:ie,decision_token:Ce},A,re,!1),{refresh:ie=>L(S,I,A,ie?.queue?.revision??$.get(A)?.revision??re,!1)})}async function ne(S,I,A,Y){let K=await Gt({continuation_mismatch:Y},(ie,Ce)=>L("worker-merge-queue-add",{bead_id:I,continuation:ie,decision_token:Ce},S,A,!1)),re=K?.queue?.merge_queue?.find(ie=>ie.bead_id===I)?.continuation_action;K?.applied!==!0&&re?.continuation===null&&re.mismatch&&await ne(S,I,K.queue.revision,re.mismatch)}async function be(S,I,A){let Y=await L("worker-discard",S,I,A);if(Y&&Y.discarded===!0){Z(os(Y),"success",5e3);return}if(Y&&Y.reason){Z(`\uD3D0\uAE30 \uC2E4\uD328: ${Y.reason}`,"error");return}if(Y&&Y.accepted&&Y.pending==="merged_revert"){Z("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(Y&&Y.accepted){Z(`\uD3D0\uAE30 \uC9C4\uD589: ${Y.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}Y&&!Y.conflict&&Z("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function Me(S,I,A){return!o||!A?null:await o(S,{...I,root_dir:A})}async function tt(S){if(!o||!S&&!f("\uC804 \uB808\uD3EC\uC758 \uC790\uB3D9 \uC9C4\uD589\xB7\uC790\uB3D9 \uBA38\uC9C0\uB97C \uB055\uB2C8\uB2E4. \uAC01 \uB808\uD3EC\uC758 \uBA38\uC9C0 \uB300\uAE30\uC5F4\uB3C4 \uD568\uAED8 \uBE44\uC6CC\uC9D1\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?"))return;let I=await o("monitor-auto-toggle",{on:S}),A=I&&Array.isArray(I.failed)?I.failed:[];A.length>0&&Z(`\uC790\uB3D9\uD654 ${S?"\uCF1C\uAE30":"\uB044\uAE30"} \uC77C\uBD80 \uC2E4\uD328: ${A.map(Y=>Y.root_dir).join(", ")}`,"error",3200)}async function Je(){let S=new Map;for(let I of T.pr_wait)S.has(I.root_dir)||S.set(I.root_dir,I.expected_revision);for(let[I,A]of S)await L("worker-merge-queue-add-all",{},I,A)}let Ie=null,Xe=!1,we=null;function ge(){we!==null&&clearTimeout(we),we=setTimeout(()=>{we=null,Xe=!1},0)}function ke(S){let I=S.target;return typeof I?.closest=="function"?I.closest(".mon-group"):null}function pe(S){let I=ke(S);return!I||!Ie?null:(I.getAttribute("data-root-dir")||"")===Ie.root_dir?I:null}function W(){for(let S of Array.from(k.querySelectorAll(".mon-group--drag-over")))S.classList.remove("mon-group--drag-over")}function j(S){let I=S.target,A=typeof I?.closest=="function"?I.closest('.mon-card[draggable="true"]'):null;if(A){Ie={bead_id:A.getAttribute("data-issue-id")||"",lane:A.getAttribute("data-lane")||"",root_dir:A.getAttribute("data-root-dir")||"",revision:Number(A.getAttribute("data-revision")||0)||0,queue_index:Number(A.getAttribute("data-queue-index")),queue_length:Number(A.getAttribute("data-queue-length")),place_index:Number(A.getAttribute("data-place-index"))},Xe=!0;try{S.dataTransfer?.setData("text/plain",Ie.bead_id),S.dataTransfer&&(S.dataTransfer.effectAllowed="move")}catch{}}}function he(S){let I=pe(S);I&&(S.preventDefault(),S.dataTransfer&&(S.dataTransfer.dropEffect="move"),I.classList.add("mon-group--drag-over"))}function V(S){ke(S)?.classList.remove("mon-group--drag-over")}function $e(){Ie=null,W(),ge()}function M(S){let I=pe(S),A=Ie;if(Ie=null,W(),!I||!A||!A.bead_id)return;S.preventDefault();let Y=S.target,K=typeof Y?.closest=="function"?Y.closest('.mon-card[data-lane="queue"]'):null,re=K&&I.contains(K)?Number(K.getAttribute("data-queue-index")):NaN;if(A.lane==="runnable"){let je=Number.isFinite(re)?re:A.place_index;if(!Number.isFinite(je))return;L("worker-queue-place",{bead_id:A.bead_id,index:je},A.root_dir,A.revision);return}if(A.lane!=="queue"||K&&K.getAttribute("data-issue-id")===A.bead_id)return;let ie=A.queue_index,Ce=Number.isFinite(re)?ie>re?re:re-1:A.queue_length-1;!Number.isFinite(Ce)||Ce<0||Ce===ie||L("worker-queue-reorder",{bead_id:A.bead_id,to_index:Ce},A.root_dir,A.revision)}function P(S){let I={runnable:T.runnable,queue:T.queue,running:T.running,pr_wait:T.pr_wait,done:T.done};return l`${pl({automation:T.automation,counts:{running:T.running.length,queue:T.queue.length,pr_wait:T.pr_wait.length},running_sort:h,done_range:m,token_total:_l(T.done),token_tooltip:fl(E())})}
      <div class="worker-lanes mon-lanes">
        ${Pp.map(A=>{let Y=I[A.lane],K=A.lane==="queue"?T.queue_groups.length>0?l`${T.queue_groups.map(re=>l`<div
                        class="mon-group"
                        data-root-dir=${re.root_dir}
                      >
                        ${ul(re)}
                        <div class="mon-group__list">
                          ${re.items.map(ie=>ml(ie,S))}
                        </div>
                      </div>`)}`:void 0:Y.length>0?l`${Y.map(re=>ml(re,S))}`:void 0;return Vt({id:`monitor-${A.lane}`,lane:A.pane,title:A.lane==="done"?`\uC644\uB8CC\xB7${E()}`:A.title,items:Y,empty:A.empty,body:K,live:A.lane==="running"&&Y.length>0,header_control:A.lane==="pr_wait"&&Y.length>0?l`<button
                    type="button"
      ...
      </div>`}function oe(){let S=s&&s.get?s.get():null,I=s&&s.getWorkspacesState?s.getWorkspacesState():[],A=u();T=go(S,I,{done_since:kr(m,A),running_sort:h}),Ue(P(A),k)}function Fe(S,I){let A=i?i():void 0;if(!I||!A||I===A||!c){n(S);return}c(I).then(()=>{n(S)}).catch(Y=>{r("workspace switch for %s failed: %o",I,Y)})}function Ee(S){return{root_dir:S.getAttribute("data-root-dir")||"",revision:Number(S.getAttribute("data-revision")||0)||0}}function Be(S,I){let{root_dir:A,revision:Y}=Ee(S),K=S.getAttribute("data-issue-id")||"",re=I.dataset.attemptId||S.getAttribute("data-attempt-id")||"",ie=I.classList;if(ie.contains("worker-card__place")){L("worker-queue-place",{bead_id:K,index:Number(S.getAttribute("data-place-index")||0)||0},A,Y);return}if(ie.contains("mon-op--up")||ie.contains("mon-op--down")){let Ce=Number(S.getAttribute("data-queue-index")||0)||0,je=ie.contains("mon-op--up")?Ce-1:Ce+1;if(je<0)return;L("worker-queue-reorder",{bead_id:K,to_index:je},A,Y);return}if(ie.contains("mon-op--remove")){L("worker-queue-remove",{bead_id:K},A,Y);return}if(ie.contains("mon-op--pause")){Me("worker-attempt-pause",{attempt_id:re},A);return}if(ie.contains("mon-op--discard")){if(!f(_n(K,"unmerged")))return;be({bead_id:K,...re?{attempt_id:re}:{},...I.dataset.operationId?{operation_id:I.dataset.operationId}:{}},A,Y);return}if(ie.contains("mon-op--resume")){ve("worker-attempt-resume",{attempt_id:re},A,Y);return}if(ie.contains("mon-op--dismiss")){L("worker-attempt-dismiss",{attempt_id:re},A,Y);return}if(ie.contains("worker-mini__merge")){let Ce=ue(A,K);Ce?.mismatch&&Ce.continuation===null?ne(A,K,Y,Ce.mismatch):L("worker-merge-queue-add",{bead_id:K},A,Y);return}if(ie.contains("worker-mini__merge-cancel")){L("worker-merge-queue-remove",{bead_id:K},A,Y);return}if(ie.contains("worker-mini__discard")){let Ce=I.dataset.discardMode==="merged"?"merged":"unmerged";if(!f(_n(K,Ce)))return;be({bead_id:K,...re?{attempt_id:re}:{},...I.dataset.operationId?{operation_id:I.dataset.operationId}:{}},A,Y);return}if(ie.contains("worker-mini__revise-fix")){ve("worker-revise-fix",{bead_id:K},A,Y);return}ie.contains("worker-mini__revise-approve")&&L("worker-revise-approve",{bead_id:K},A,Y)}function De(S){let I=Xe;Xe=!1;let A=S.target;if(!A||typeof A.closest!="function"||A.closest("dialog")||A.closest("a"))return;let Y=A.closest(".mon-running-sort");if(Y){S.preventDefault(),h=Y.getAttribute("data-sort")==="repo"?"repo":"started",Op(h),oe();return}let K=A.closest(".mon-auto-all");if(K){S.preventDefault(),tt(K.getAttribute("data-on")==="true");return}if(A.closest(".mon-merge-all")){S.preventDefault(),Je();return}let ie=A.closest(".mon-ctl--advance");if(ie){S.preventDefault();let{root_dir:ut,revision:lt}=Ee(ie);L("worker-automation-toggle",{on:ie.getAttribute("data-on")==="true"},ut,lt);return}let Ce=A.closest(".mon-ctl--merge-auto");if(Ce){S.preventDefault();let{root_dir:ut,revision:lt}=Ee(Ce);L("worker-merge-auto-toggle",{on:Ce.getAttribute("data-on")==="true"},ut,lt);return}let je=A.closest(".mon-ctl--exec");if(je){S.preventDefault(),B=je.getAttribute("data-root-dir")||null,$.delete(B||""),O.open();return}let rt=A.closest(".mon-card");if(!rt)return;let ze=A.closest("button");if(ze){S.preventDefault(),Be(rt,ze);return}let bt=rt.getAttribute("data-issue-id");bt&&!I&&(S.preventDefault(),Fe(bt,rt.getAttribute("data-root-dir")||""))}function Ke(S){let I=S.target;if(!I||typeof I.closest!="function")return;let A=I.closest(".mon-done-range");if(A){m=Dt(A.value)?A.value:Et,Lp(m),oe();return}let Y=I.closest(".mon-slots__input");if(!Y)return;let{root_dir:K,revision:re}=Ee(Y),ie=Number(Y.value);if(!Number.isFinite(ie))return;let Ce=Math.max(mn,Math.floor(ie));L("worker-queue-set-slots",{slots:Ce},K,re)}e.addEventListener("click",De),e.addEventListener("change",Ke),e.addEventListener("dragstart",j),e.addEventListener("dragover",he),e.addEventListener("dragleave",V),e.addEventListener("drop",M),e.addEventListener("dragend",$e),s&&typeof s.subscribe=="function"&&(x=s.subscribe(()=>{try{$.clear(),oe();for(let S of Array.from(H))S()}catch{}}));function C(){N!==null&&(clearInterval(N),N=null)}function me(){we!==null&&(clearTimeout(we),we=null)}return{load(){r("load"),oe(),N===null&&(N=setInterval(()=>{try{oe()}catch{}},Mp))},pause(){C()},clear(){C(),me(),x&&(x(),x=null),e.removeEventListener("click",De),e.removeEventListener("change",Ke),e.removeEventListener("dragstart",j),e.removeEventListener("dragover",he),e.removeEventListener("dragleave",V),e.removeEventListener("drop",M),e.removeEventListener("dragend",$e),O.destroy(),H.clear(),e.replaceChildren()}}}function vl(e,t,r){let n=ot("views:nav"),s=null;function o(c){return u=>{u.preventDefault(),n("click tab %s",c),r.gotoView(c)}}function a(){let c=t.getState(),u=c.view==="worker"||c.view==="monitor"?c.view:"board";return l`
...
${Ge.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:q==="done"?Ot(p.attempts||{},te.bead_id):null,done_at:q==="done"&&typeof te.added_at=="number"?te.added_at:void 0,...vt(te.bead_id)}}),Eo=new Map;for(let g of p.done)g&&typeof g.bead_id=="string"&&typeof g.added_at=="number"&&Eo.set(g.bead_id,g.added_at);let Hr=p.attempts?Object.values(p.attempts):[],cs=new Set;for(let g of Hr)g&&typeof g.resumed_from=="string"&&g.resumed_from.length>0&&cs.add(g.resumed_from);let ds=new Map;for(let g of Hr)ds.set(g.bead_id,g.attempt_id);let us=new Map;for(let g of Hr)us.set(g.attempt_id,g);function ps(g){let q=new Set,te=g;for(;te&&!q.has(te.attempt_id);){if(te.conflict_resolution===!0)return!0;q.add(te.attempt_id),te=typeof te.resumed_from=="string"&&te.resumed_from.length>0&&us.get(te.resumed_from)||null}return!1}let wn=typeof p.declared_base=="string"?p.declared_base:null;function Yl(g){let q=null;for(let te of Hr)!te||te.bead_id!==g||ps(te)||(q===null||(typeof te.started_at=="number"?te.started_at:0)>=(typeof q.started_at=="number"?q.started_at:0))&&(q=te);return q&&typeof q.target_base=="string"?q.target_base:null}let Co=[],Ro=[],Vl=g=>{let q=ds.get(g.bead_id)!==g.attempt_id,te=Eo.get(g.bead_id),Ge=typeof te=="number"&&te>0&&typeof g.finished_at=="number"&&te>=g.finished_at;return!q&&!Ge&&typeof g.dismissed_at!="number"},Io=g=>{let q=typeof g.session_id=="string"&&g.session_id.length>0,te=cs.has(g.attempt_id);return{eligible:q&&!te,reason:q?te?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Pt=null;for(let g of Hr){let q=g.status==="paused"&&!cs.has(g.attempt_id);if(g.status==="running"||q)Ro.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:Le.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,paused:q,conflict_resolution:ps(g),base_exception:ko(wn,g.target_base),can_pause:typeof g.session_id=="string"&&g.session_id.length>0,discard:Yt(zr,g.bead_id,{attempt_id:g.attempt_id}),usage:Ot(p.attempts||{},g.bead_id),current_child:le(g.bead_id),...vt(g.bead_id)});else if((g.status==="failed"||g.status==="orphaned")&&Vl(g)){let te=Io(g);Co.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:Le.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,failed:!0,status:g.status,status_label:g.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Yt(zr,g.bead_id,{attempt_id:g.attempt_id}),resume_eligible:te.eligible,resume_reason:te.reason,conflict_resolution:ps(g),base_exception:ko(wn,g.target_base),usage:Ot(p.attempts||{},g.bead_id),current_child:le(g.bead_id),...vt(g.bead_id)}),Pt=g}}let kn=[...Co,...Ro],Lo=null;if(Pt){let g=Io(Pt),q=Pt.cause_detail;Lo={bead_id:Pt.bead_id,repo:Pt.repo||"",reason:Pt.cause||Pt.status,cause_detail:q&&typeof q.reason=="string"?{reason:q.reason,command:typeof q.command=="string"?q.command:null}:null,resume_attempt_id:Pt.attempt_id,resume_eligible:g.eligible,resume_reason:g.reason,discard:Yt(zr,Pt.bead_id,{attempt_id:Pt.attempt_id})}}let Kl=new Set(kn.map(g=>g.bead_id)),fs=Array.isArray(p.merge_queue)?p.merge_queue:[],Do=new Map,Oo=new Map,Mo=new Map;fs.forEach((g,q)=>{g&&typeof g.bead_id=="string"&&(Do.set(g.bead_id,q+1),Oo.set(g.bead_id,g.resolution),Mo.set(g.bead_id,g.continuation_action||null))});let Po=p.merge_queue_state||{active:null,failures:{}},Zl=Po.failures||{},Xl=p.deployment_coverage&&typeof p.deployment_coverage=="object"&&!Array.isArray(p.deployment_coverage)?p.deployment_coverage:{},Ql=p.deployment&&typeof p.deployment.desired_sha=="string"?p.deployment.desired_sha:null,Jl=p.auto_merge_skips||{},No=g=>{let q=Jl[g];if(!q)return null;let te=b[g],Ge=te&&te.pr?te.pr.head_sha:null;return Ge&&Ge===q.head_sha?q.reason||"":null},$n=new Map;for(let g of kn)g.failed!==!0&&g.conflict_resolution&&(g.paused?$n.has(g.bead_id)||$n.set(g.bead_id,"paused"):$n.set(g.bead_id,"running"));let Fo=kn.filter(g=>!g.paused&&g.failed!==!0).length,qo=(p.workspace_info||{}).slots,ec=typeof qo=="number"?qo:typeof p.slots=="number"?p.slots:yn,Bo=p.pr_wait_holds_slot===!0?yn:ec,tc=Fo>Bo,xn=kr(H),rc=(Array.isArray(p.done)?p.done.slice():[]).filter(g=>xn===void 0||typeof g.added_at!="number"||g.added_at>=xn).sort((g,q)=>(q.added_at||0)-(g.added_at||0)),Wr=To(rc,"done"),nc=new Set((Array.isArray(p.done)?p.done:[]).map(g=>g?.bead_id).filter(g=>typeof g=="string")),Uo=[],sc=u?.()||"";for(let g of Q){let q=Xt(g.closed_at);if(typeof g.id!="string"||nc.has(g.id)||q===null||xn!==void 0&&q<xn||typeof g.comment_count!="number"||g.comment_count<=0)continue;let te=`${sc}\0${g.id}\0${String(g.updated_at)}\0${g.comment_count}`,Ge=X.get(te);Ge===void 0&&r&&(X.set(te,"pending"),Promise.resolve(r("get-comments",{id:g.id})).then(zt=>{let ar=Array.isArray(zt)&&zt.some(Lt=>ts(typeof Lt?.text=="string"?Lt.text:"")?.lane==="session");X.set(te,ar?"session":"not-session"),Oe()}).catch(()=>{X.set(te,"failed"),Oe()})),Ge==="session"&&Uo.push({id:g.id,title:g.title||g.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,done_at:q,created_at:g.created_at,updated_at:g.updated_at})}Wr.push(...Uo),Wr.sort((g,q)=>(q.done_at||0)-(g.done_at||0));let Sn={};for(let g of Qt)Sn[g]=0;let jo=!1,zo=0,_s=0,Ho=0;for(let g of Wr){let q=g.usage;if(q&&typeof q=="object"){let te=!1;for(let Ge of Qt)Number.isFinite(q[Ge])&&(Sn[Ge]+=q[Ge],jo=!0,te=!0);te&&(_s+=1,Number.isFinite(q.total_cost_usd)&&(zo+=q.total_cost_usd,Ho+=1))}}_s>0&&Ho===_s&&(Sn.total_cost_usd=zo);let Wo=Wr.map(g=>g.usage).filter(g=>g&&typeof g=="object"&&g.providers),oc=Wo.length>0?gt(Bn(Wo)):jo?Ft(Sn):null;return{queue:p,idToTitle:Le,candidates:or,candidate_hidden:{blocked:qe.hidden_blocked,spec:qe.hidden_spec},running:kn,live_count:Fo,slots:Bo,over_cap:tc,failure:Lo,waiting:To(Ze.filter(g=>!Kl.has(g.bead_id)),"queue"),pr_wait:de.map(g=>hf(g.bead_id,Le.get(g.bead_id)||g.bead_id,b,ee[g.bead_id]||null,Ot(p.attempts||{},g.bead_id),z[g.bead_id]||(N.has(g.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),$n.get(g.bead_id)||null,g.external===!0,{position:Do.get(g.bead_id)||0,active:Po.active===g.bead_id,failure:Zl[g.bead_id]||null,resolution:Oo.get(g.bead_id),continuation_action:Mo.get(g.bead_id)},g.wt_present!==!1,p.auto_merge===!0?No(g.bead_id):null,ko(wn,Yl(g.bead_id)),p.completion_status&&typeof p.completion_status=="object"&&!Array.isArray(p.completion_status)&&p.completion_status[g.bead_id]||null,p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},us.get(ds.get(g.bead_id)||"")?.worker_serial===!0,Xl[g.bead_id]||null,Ql)).map(g=>({...g,...vt(g.id)})),merge_queue_length:fs.length,merge_queue_running:fs.length>0,auto_excluded:de.map(g=>g.bead_id).filter(g=>No(g)!==null),verify_cmd_present:!!(p.workspace_info||{}).verify_cmd,declared_base:wn,done:Wr,token_total:oc,cleanup_failures:Ne,deployment:p.deployment||null}}function ze(p){let v=p.waiting.length>0?p.waiting[0].id:"\u2014",R=l`<button
    ...
    >`,ce=l`<label class="worker-tgl worker-slots"
        >동시 실행
        <input
          type="number"
      ...
      >
        ⚙
          ...
          ${R} ${Q}
          <div class="worker-kpi worker-kpi--ribbon">${_e}${ye}</div>
        </div>
        ...
        <div class="worker-ctrl__ops">${R}${Q}${ce}</div>
    ...
    </div>`}function It(){if(ue.size===0)return"";let p=Array.from(ue),v=p.some(R=>{let Q=be.get(R);return Q!==!0&&Q!==!1});return l`<div
      class="worker-bulk"
      role="group"
    ...
    </div>`}function nt(p){let v=(p.queue.pr_wait||[]).filter(ye=>ye&&ye.external!==!0&&typeof ye.bead_id=="string"),R=new Set(p.running.filter(ye=>!ye.paused&&ye.failed!==!0).map(ye=>ye.bead_id));for(let ye of v)R.add(ye.bead_id);let Q=!(p.queue.pr_wait_holds_slot!==!0||p.queue.auto_advance!==!0||p.queue.auto_merge===!0||v.length===0||p.waiting.length===0||R.size<p.slots),_e=p.pr_wait.some(ye=>ye.worker_serial===!0);if(!(!Q&&!(_e&&p.queue.auto_merge!==!0)))return l`${Q?l`<div class="worker-stat worker-pr-wait-hint">
    ...
    </div>`}function ct(p){O={...O,[p]:!O[p]},sf(O),Oe()}function Oe(){let p=rt();Ue(ze(p),Je),Ue(st(p),ge)}function F(){let p=document.querySelector(".app-header");if(!p)return;let v=()=>{let R=Math.round(p.getBoundingClientRect().height);tt.style.setProperty("--worker-ribbon-top",`${R}px`)};if(v(),typeof ResizeObserver=="function"){let R=new ResizeObserver(v);R.observe(p),Me.push(()=>R.disconnect())}else window.addEventListener("resize",v),Me.push(()=>window.removeEventListener("resize",v))}function G(){if(typeof window.matchMedia!="function")return;let p=window.matchMedia(rf);x=!!p.matches;let v=R=>{let Q=!!(R&&typeof R.matches=="boolean"?R.matches:p.matches);Q!==x&&(x=Q,Oe())};typeof p.addEventListener=="function"?(p.addEventListener("change",v),Me.push(()=>p.removeEventListener("change",v))):typeof p.addListener=="function"&&(p.addListener(v),Me.push(()=>p.removeListener(v)))}function se(p){let v=p.target,R=v?.closest?.(".worker-mini__grip"),Q=R?R.closest('.worker-mini[data-lane="queue"]'):v?.closest?.('.worker-card[draggable="true"]');if(!Q)return;let _e=Q.dataset.beadId||"",ye=Q.dataset.lane||"";k={bead_id:_e,from_lane:ye};try{p.dataTransfer?.setData("text/plain",_e),p.dataTransfer&&(p.dataTransfer.effectAllowed="move")}catch{}}function fe(p){let v=p.target?.closest?.(".worker-pane");if(!v)return;let R=v.dataset.lane||"";R!=="candidate"&&R!=="queue"||(p.preventDefault(),p.dataTransfer&&(p.dataTransfer.dropEffect="move"),v.classList.add("worker-pane--drag-over"))}function xe(p){p.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function Re(p,v){let R=T.find(le=>le.id===p);if(!R)return;let Q=T.filter(le=>le.id!==p),_e=Q.length;if(v){let le=v.dataset.beadId;if(le===p)return;let ce=Q.findIndex(Le=>Le.id===le);ce>=0&&(_e=ce)}let ye=Q.slice();ye.splice(_e,0,R),E.applyReorder(p,ye,_e)}function We(p){let v=p.target?.closest?.(".worker-pane");if(!v)return;p.preventDefault(),v.classList.remove("worker-pane--drag-over");let R=v.dataset.lane||"",Q=k?.bead_id||p.dataTransfer?.getData("text/plain")||"",_e=k?.from_lane||"";if(k=null,!Q)return;let ye=p.target?.closest?.(".worker-mini, .worker-card"),le=Array.from(v.querySelectorAll(".worker-mini, .worker-card")),ce=le.length;if(ye){let Le=le.indexOf(ye);Le>=0&&(ce=Le)}if(v.classList.contains("worker-pane--collapsed")&&(ce=$e()),R==="candidate"){if(_e==="candidate"){Re(Q,ye);return}_e==="queue"&&oe(Q);return}R==="queue"&&(_e==="queue"?P(Q,ce):M(Q,ce))}function et(p){B=p,Vp(p),Oe()}function Te(p){$=p==="board"||p==="created"||p==="spec"?p:is,Jp($),Oe()}function Ye(p){H=Dt(p)?p:Et,tf(H),m?.(H),Oe()}function Ae(p){let v=p.target?.closest?.(".worker-mini__select");if(v){let it=v.dataset.beadId||"";it&&(v.checked?ue.add(it):ue.delete(it),Oe());return}let R=p.target?.closest?.(".worker-bulk__mode");if(R){ve=R.value==="serial"?"serial":"ordinary";return}let Q=p.target?.closest?.(".worker-filter__blocked");if(Q){et({...B,show_blocked:Q.checked});return}let _e=p.target?.closest?.(".worker-done-range");if(_e){Ye(_e.value);return}let ye=p.target?.closest?.(".worker-sort");if(ye){Te(ye.value||is);return}let le=p.target?.closest?.(".worker-pr-wait-hold");if(le){je(le.checked);return}let ce=p.target?.closest?.(".worker-slots__input");if(!ce)return;let Le=Number.parseInt(ce.value,10);if(!Number.isFinite(Le)){Oe();return}Ce(Le).then(Oe)}function pt(p){return p?{runner:p.runner||void 0,model:p.model||void 0,effort:p.effort||void 0,worktree:p.worktree||void 0,status:p.status||void 0,session_id:p.session_id||void 0}:{}}function ht(p){let v=j(),R=v.attempts?v.attempts[p]:null;ke=p,Ie.hidden=!1,pe.open({attempt_id:p,meta:pt(R)}),Oe()}function sr(){if(!ke)return;let p=j(),v=p.attempts?p.attempts[ke]:null;if(v){pe.updateMeta(pt(v));return}pe.close()}function jt(p){let v=p.target,R=v?.closest?.(".worker-bulk__apply");if(R){R.disabled||Fe();return}if(v?.closest?.(".worker-mini__select, .worker-mini__serial, .worker-mini__grip")||v?.closest?.("#worker-exec-defaults-dialog"))return;if(v?.closest?.(".worker-exec-defaults-btn")){W.open();return}if(v?.closest?.(".worker-deployment-retry")){r&&Promise.resolve(r("worker-deployment-retry",{})).then(V);return}let Q=v?.closest?.(".worker-deployment-session");if(Q){let ae=Q.dataset.attemptId;ae&&ht(ae);return}let _e=v?.closest?.(".worker-deployment-continue");if(_e){let ae=_e.dataset.attemptId;ae&&De(ae);return}let ye=v?.closest?.(".worker-banner__resume");if(ye){let ae=ye.dataset.attemptId;ae&&Be(ae);return}let le=v?.closest?.(".worker-banner__discard");if(le){let ae=le.dataset.confirmation==="merged"?"merged":"unmerged";K(le.dataset.beadId||"",le.dataset.attemptId||null,ae,le.dataset.operationId||null);return}let ce=v?.closest?.(".worker-banner__dismiss");if(ce){let ae=ce.dataset.attemptId;ae&&Ke(ae);return}if(v?.closest?.(".worker-play")){ie(!j().auto_advance);return}let Le=v?.closest?.(".worker-merge-all");if(Le){Le.classList.contains("worker-merge-all--stop")?j().auto_merge===!0?I(!1):Y():I(!0);return}let it=v?.closest?.(".worker-pane__hd--toggle");if(it){let ae=it.dataset.lane;(ae==="queue"||ae==="done")&&ct(ae);return}let ft=v?.closest?.(".worker-card__place");if(ft){let ae=ft.dataset.beadId;ae&&!ft.disabled&&M(ae,$e());return}let St=v?.closest?.(".worker-filter__chip");if(St){let ae=St.dataset.spec;(ae==="all"||ae==="with"||ae==="without")&&et({...B,spec:ae});return}let vt=v?.closest?.(".worker-mini__merge");if(vt){me(vt.dataset.beadId||"");return}let de=v?.closest?.(".worker-mini__merge-cancel");if(de){A(de.dataset.beadId||"");return}let b=v?.closest?.(".worker-mini__discard");if(b){K(b.dataset.beadId||"",b.dataset.attemptId||null,b.dataset.discardMode==="merged"?"merged":"unmerged",b.dataset.operationId||null);return}let z=v?.closest?.(".worker-mini__revise-fix");if(z){re("worker-revise-fix",z.dataset.beadId||"");return}let ee=v?.closest?.(".worker-mini__revise-approve");if(ee){re("worker-revise-approve",ee.dataset.beadId||"");return}if(v?.closest?.(".worker-mini__pr"))return;if(v?.closest?.(".rtile__discard")){let ae=v?.closest?.(".rtile"),_=ae?.dataset?.beadId,d=ae?.dataset?.attemptId;_&&K(_,d||null,"unmerged",v?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if(v?.closest?.(".rtile__dismiss")){let _=v?.closest?.(".rtile")?.dataset?.attemptId;_&&Ke(_);return}if(v?.closest?.(".rtile__pause")){let _=v?.closest?.(".rtile")?.dataset?.attemptId;_&&Ee(_);return}if(v?.closest?.(".rtile__resume")){let _=v?.closest?.(".rtile")?.dataset?.attemptId;_&&Be(_);return}if(v?.closest?.(".rtile__session")){let _=v?.closest?.(".rtile")?.dataset?.attemptId;_&&ht(_);return}if(v?.closest?.(".worker-drawer-overlay__backdrop")){pe.close();return}if(v?.closest?.(".worker-drawer-host"))return;let Ne=v?.closest?.(".rtile");if(Ne){if(v?.closest?.(".rtile__id")){let _=Ne.dataset.beadId;_&&Sr(_).then(d=>{d?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let ae=Ne.dataset.beadId;ae&&c&&c(ae);return}let Ze=v?.closest?.(".worker-mini, .worker-card");if(Ze){let ae=Ze.dataset.beadId;if(v?.closest?.(".worker-mini__id, .worker-card__id")){ae&&Sr(ae).then(_=>{_?Z("\uBCF5\uC0AC\uB428","success",1200):Z("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}ae&&c&&c(ae)}}return e.addEventListener("dragstart",se),e.addEventListener("dragover",fe),e.addEventListener("dragleave",xe),e.addEventListener("drop",We),e.addEventListener("click",jt),e.addEventListener("change",Ae),G(),F(),h&&Me.push(h.subscribe(()=>{for(let[p,v]of X)v==="failed"&&X.delete(p);Oe()})),s&&Me.push(s.subscribe(()=>{Oe(),sr()})),Oe(),{load(){Oe()},openExecDefaults(){W.open()},destroy(){for(let p of Me.splice(0))try{p()}catch{}e.removeEventListener("dragstart",se),e.removeEventListener("dragover",fe),e.removeEventListener("dragleave",xe),e.removeEventListener("drop",We),e.removeEventListener("click",jt),e.removeEventListener("change",Ae);try{pe.destroy()}catch{}Ie.hidden=!0;try{W.destroy()}catch{}Ue(l``,e)}}}function xo(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Pl(e,t,r,n=async()=>{},s=async()=>{}){let o=ot("views:workspace-picker"),a=null,i=!1,c=!1,u=!1;async function f(x){let L=x.target.value,ve=t.getState().workspace?.current?.path||"";if(L&&L!==ve){o("switching workspace to %s",L),i=!0,O();try{await r(L)}catch(ne){o("workspace switch failed: %o",ne)}finally{i=!1,O()}}}async function m(){let x=t.getState(),N=x.workspace?.current?.path||x.workspace?.available?.[0]?.path||"";if(!(!N||c)){o("git-pulling workspace %s",N),c=!0,O();try{await n(N)}catch(L){o("workspace git pull failed: %o",L)}finally{c=!1,O()}}}function h(x){let N=x.target;N&&e.contains(N)||T()}function E(x){x.key==="Escape"&&T()}function k(){u||(u=!0,document.addEventListener("mousedown",h),document.addEventListener("keydown",E),O())}function T(){u&&(u=!1,document.removeEventListener("mousedown",h),document.removeEventListener("keydown",E),O())}function B(){u?T():k()}async function $(x){let N=x.target,L=N.value,ue=N.checked;o("toggling visibility %s \u2192 %s",L,String(ue));try{await s(L,ue)}catch(ve){o("workspace visibility toggle failed: %o",ve)}}function H(x){return x?l`
      <button
        type="button"
    ...
    `}function U(){let x=t.getState(),N=x.workspace?.current,L=x.workspace?.available||[],ue=new Set(x.workspace?.hidden||[]),ve=N?.path||L[0]?.path||"";if(L.length===0)return l``;let ne=L.filter(be=>!ue.has(be.path)||be.path===ve);if(ne.length<=1){let be=ne[0]||L[0],Me=xo(be.path);return l`
    ...
    `}function O(){Ue(U(),e)}return O(),a=t.subscribe(()=>O()),{destroy(){a&&(a(),a=null),document.removeEventListener("mousedown",h),document.removeEventListener("keydown",E),Ue(l``,e)}}}var Nl=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-impl-target","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-automation-toggle","worker-queue-set-slots","worker-deployment-retry","worker-deployment-recovery-continue","worker-queue-set-pr-wait-hold","worker-queue-set-default-exec-preset","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-merge-queue-add","worker-merge-queue-add-all","worker-merge-auto-toggle","worker-merge-queue-remove","worker-discard","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append","get-attempt-prompt","get-bead-prompt","get-worker-system-prompt","subscribe-monitor-pipeline","unsubscribe-monitor-pipeline","monitor-pipeline-snapshot","subscribe-exec-presets","unsubscribe-exec-presets","exec-presets-snapshot","exec-preset-create","exec-preset-update","exec-preset-delete","apply-exec-preset","monitor-auto-toggle"];function So(){let e=Date.now().toString(36),t=Math.random().toString(36).slice(2,8);return`${e}-${t}`}function Fl(e,t,r=So()){return{id:r,type:e,payload:t}}function ql(e={}){let t=ot("ws"),r={initialMs:e.backoff?.initialMs??1e3,maxMs:e.backoff?.maxMs??3e4,factor:e.backoff?.factor??2,jitterRatio:e.backoff?.jitterRatio??.2},n=()=>e.url&&e.url.length>0?e.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",a=0,i=null,c=!0,u=new Map,f=[],m=new Map,h=new Set;function E(U){for(let O of Array.from(h))try{O(U)}catch{}}function k(){if(!c||i)return;o="reconnecting",t("ws reconnecting\u2026"),E(o);let U=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,a)),O=(r.jitterRatio||0)*U,x=Math.max(0,Math.round(U+(Math.random()*2-1)*O));t("ws retry in %d ms (attempt %d)",x,a+1),i=setTimeout(()=>{i=null,X()},x)}function T(U){try{s?.send(JSON.stringify(U))}catch(O){t("ws send failed",O)}}function B(){for(o="open",t("ws open"),E(o),a=0;f.length;){let U=f.shift();U&&T(U)}}function $(U){let O;try{O=JSON.parse(String(U.data))}catch{t("ws received non-JSON message");return}if(!O||typeof O.id!="string"||typeof O.type!="string"){t("ws received invalid envelope");return}if(u.has(O.id)){let N=u.get(O.id);u.delete(O.id),O.ok?N?.resolve(O.payload):N?.reject(O.error||new Error("ws error"));return}let x=m.get(O.type);if(x&&x.size>0)for(let N of Array.from(x))try{N(O.payload)}catch(L){t("ws event handler error",L)}else t("ws received unhandled message type: %s",O.type)}function H(){o="closed",t("ws closed"),E(o);for(let[U,O]of u.entries())O.reject(new Error("ws disconnected")),u.delete(U);a+=1,k()}function X(){if(!c)return;let U=n();try{s=new WebSocket(U),t("ws connecting %s",U),o="connecting",E(o),s.addEventListener("open",B),s.addEventListener("message",$),s.addEventListener("error",()=>{}),s.addEventListener("close",H)}catch(O){t("ws connect failed %o",O),k()}}return X(),{send(U,O){if(!Nl.includes(U))return Promise.reject(new Error(`unknown message type: ${U}`));let x=So(),N=Fl(U,O,x);return t("send %s id=%s",U,x),new Promise((L,ue)=>{u.set(x,{resolve:L,reject:ue,type:U}),s&&s.readyState===s.OPEN?T(N):(t("queue %s id=%s (state=%s)",U,x,o),f.push(N))})},on(U,O){m.has(U)||m.set(U,new Set);let x=m.get(U);return x?.add(O),()=>{x?.delete(O)}},onConnection(U){return h.add(U),()=>{h.delete(U)}},reconnect(){c=!0,i&&(clearTimeout(i),i=null),a=0,X()},close(){c=!1,i&&(clearTimeout(i),i=null);try{s?.close()}catch{}},getState(){return o}}}function bf(){let e=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:null}}}async function yf(e,t){try{let n=await(await fetch("/api/config")).json();e.setState({config:n})}catch(r){t("config refresh failed",r)}}var Ao=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],Bl=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"],["tab:worker:in-progress","in-progress-issues"],["tab:worker:closed","closed-issues"]],gr="tab:worker:closed",vf="bdui.worker.done-range",Ul=bl,jl="worker:queue",zl="ui:order",Hl="ui:display-policy",Wl="exec:presets",hr="tab:board:closed",Gl="beads-ui.board.closed-range";function wf(e){let t=ot("main");t("bootstrap start");let r=l`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="monitor-root" class="route monitor" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;Ue(r,e);let n=document.getElementById("top-nav"),s=document.getElementById("usage-meter"),o=document.getElementById("board-root"),a=document.getElementById("worker-root"),i=document.getElementById("monitor-root"),c=document.getElementById("detail-panel");if(s&&Tl(s),o&&a&&i&&c){let we=function(_,d){let w="Request failed",y="";if(_&&typeof _=="object"){let J=_;if(typeof J.message=="string"&&J.message.length>0&&(w=J.message),typeof J.details=="string")y=J.details;else if(J.details&&typeof J.details=="object")try{y=JSON.stringify(J.details,null,2)}catch{y=""}}else typeof _=="string"&&_.length>0&&(w=_);let D=d&&d.length>0?`Failed to load ${d}`:"Request failed";Xe.open(D,w,y)},S=function(_){return`${ce.getState().workspace.current?.path||""}\0${_}`},I=function(){oe&&(oe().catch(()=>{}),oe=null),Fe=null,Ee=null},Y=function(_){Be=_;let d=()=>{Be!==_||ce.getState().selected_id!==_||(Be=null,A(_))};if(!C){Ke.then(d);return}d()},Ce=function(_,d,w,y,D){return w!==ie[d]?(D().catch(()=>{}),!1):(_.set(y,D),!0)},je=function(){let _=ce.getState();lt(_.view==="board"),ct(_.view==="worker"),fe(_.view==="monitor"),F(_.view==="board"||_.view==="worker"||!!_.selected_id)},bt=function(){let _=kr(rt);return _===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:_}}},ut=function(){let _=kr(ze);return _===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:_}}},lt=function(_){if(_)for(let[d,w]of Ao){if(K.has(d)||re.has(d))continue;let y=d===hr?bt():{type:w};try{W.register(d,y)}catch(Se){t("register %s store failed: %o",d,Se)}re.add(d);let D=ie.board,J=!1;pe.subscribeList(d,y).then(Se=>{J=!Ce(K,"board",D,d,Se)}).catch(Se=>{t("subscribe %s failed: %o",d,Se),we(Se,"board")}).finally(()=>{re.delete(d),J&&je()})}else nt()},nt=function(){ie.board+=1;for(let[_]of Ao){let d=K.get(_);d&&(d().catch(()=>{}),K.delete(_));try{W.unregister(_)}catch(w){t("unregister %s failed: %o",_,w)}}},ct=function(_){if(!_){Oe();return}for(let[d,w]of Bl){if(at.has(d)||re.has(d))continue;let y=d===gr?ut():{type:w};try{W.register(d,y)}catch(Se){t("register %s store failed: %o",d,Se)}re.add(d);let D=ie.worker,J=!1;pe.subscribeList(d,y).then(Se=>{J=!Ce(at,"worker",D,d,Se)}).catch(Se=>{t("subscribe %s failed: %o",d,Se),we(Se,"worker")}).finally(()=>{re.delete(d),J&&je()})}},Oe=function(){ie.worker+=1;for(let[_]of Bl){let d=at.get(_);d&&(d().catch(()=>{}),at.delete(_));try{W.unregister(_)}catch(w){t("unregister %s failed: %o",_,w)}}},F=function(_){if(!_){G();return}st||(ke("subscribe-worker-queue",{id:jl}).catch(d=>{t("subscribe-worker-queue failed: %o",d)}),st=()=>ke("unsubscribe-worker-queue",{id:jl}))},G=function(){st&&(st().catch(()=>{}),st=null)},fe=function(_){if(!_){xe();return}se||(ke("subscribe-monitor-pipeline",{id:Ul}).catch(d=>{t("subscribe-monitor-pipeline failed: %o",d)}),se=()=>ke("unsubscribe-monitor-pipeline",{id:Ul}))},xe=function(){se&&(se().catch(()=>{}),se=null)},We=function(){Re||(ke("subscribe-ui-order",{id:zl}).catch(_=>{t("subscribe-ui-order failed: %o",_)}),Re=()=>ke("unsubscribe-ui-order",{id:zl}))},et=function(){Re&&(Re().catch(()=>{}),Re=null),V.clear()},Ye=function(){Te||(ke("subscribe-display-policy",{id:Hl}).catch(_=>{t("subscribe-display-policy failed: %o",_)}),Te=()=>ke("unsubscribe-display-policy",{id:Hl}))},Ae=function(){Te&&(Te().catch(()=>{}),Te=null),$e.clear()},ht=function(){pt||(ke("subscribe-exec-presets",{id:Wl}).catch(_=>{t("subscribe-exec-presets failed: %o",_)}),pt=()=>ke("unsubscribe-exec-presets",{id:Wl}))},Q=function(_){if(!_)return"Unknown";let d=_.split("/").filter(Boolean);return d.length>0?d[d.length-1]:"Unknown"};var u=we,f=S,m=I,h=Y,E=Ce,k=je,T=bt,B=ut,$=lt,H=nt,X=ct,U=Oe,O=F,x=G,N=fe,L=xe,ue=We,ve=et,ne=Ye,be=Ae,Me=ht,tt=Q;let Je=document.getElementById("header-loading"),Ie=Ta(Je),Xe=Ki(e),ge=ql(),ke=Ie.wrapSend((_,d)=>ge.send(_,d)),pe=va(ke),W=wa(),j=$a(),he=oa(),V=ka(),$e=na(),M=sa(),P=aa();ge.on("exec-presets-snapshot",_=>{let d=_;d&&typeof d.revision=="number"&&Array.isArray(d.presets)&&M.set({revision:d.revision,presets:d.presets})}),ge.on("monitor-pipeline-snapshot",_=>{let d=_;if(!(!d||!Array.isArray(d.workspaces)))try{he.set(d.workspaces,d.workspaces_state)}catch{}}),ge.on("ui-order-snapshot",_=>{let d=_;if(d&&typeof d.revision=="number")try{V.set({revision:d.revision,order:d.order&&typeof d.order=="object"?d.order:{}})}catch{}}),ge.on("display-policy-snapshot",_=>{let d=_;if(d&&d.policy&&typeof d.policy=="object")try{$e.set(d.policy)}catch{}}),ge.on("session-log-snapshot",_=>{let d=_;if(d&&typeof d.attempt_id=="string")try{P.set(d.attempt_id,Array.isArray(d.lines)?d.lines:[],typeof d.last_event_at=="number"?d.last_event_at:null)}catch{}}),ge.on("session-log-append",_=>{let d=_;if(d&&typeof d.attempt_id=="string")try{P.append(d.attempt_id,d.event)}catch{}}),ge.on("snapshot",_=>{let d=_,w=d&&typeof d.id=="string"?d.id:"",y=w?W.getStore(w):null;if(y&&d&&d.type==="snapshot")try{y.applyPush(d)}catch{}}),ge.on("upsert",_=>{let d=_,w=d&&typeof d.id=="string"?d.id:"",y=w?W.getStore(w):null;if(y&&d&&d.type==="upsert")try{y.applyPush(d)}catch{}}),ge.on("delete",_=>{let d=_,w=d&&typeof d.id=="string"?d.id:"",y=w?W.getStore(w):null;if(y&&d&&d.type==="delete")try{y.applyPush(d)}catch{}});let oe=null,Fe=null,Ee=null,Be=null,De=()=>{},Ke=new Promise(_=>{De=()=>_(void 0)}),C=!1,me=!1;async function A(_){let d=S(_);if(d===Fe||d===Ee)return;Ee=d;let w=`detail:${_}`,y={type:"issue-detail",params:{id:_}};try{W.register(w,y)}catch(D){t("register detail store failed: %o",D)}try{let D=await pe.subscribeList(w,y);if(ce.getState().selected_id!==_||S(_)!==d){await D().catch(()=>{});return}oe&&await oe().catch(()=>{}),oe=D,Fe=d}catch(D){t("detail subscribe failed: %o",D),we(D,"issue details")}finally{Ee===d&&(Ee=null)}}let K=new Map,re=new Set,ie={board:0,worker:0},rt=Et;try{let _=window.localStorage.getItem(Gl);Dt(_)&&(rt=_)}catch{}let ze=Et;try{let _=window.localStorage.getItem(vf);Dt(_)&&(ze=_)}catch{}async function yt(_){if(!Dt(_)||_===rt)return;rt=_;try{window.localStorage.setItem(Gl,_)}catch{}let d=K.get(hr);if(!d)return;K.delete(hr),await d().catch(()=>{});let w=bt();try{W.register(hr,w)}catch(y){t("register %s store failed: %o",hr,y)}try{let y=await pe.subscribeList(hr,w);K.set(hr,y)}catch(y){t("re-subscribe %s failed: %o",hr,y),we(y,"board")}}async function It(_){if(!Dt(_)||_===ze)return;ze=_;let d=at.get(gr);if(!d)return;at.delete(gr),await d().catch(()=>{});let w=ut();try{W.register(gr,w)}catch(y){t("register %s store failed: %o",gr,y)}try{let y=await pe.subscribeList(gr,w);at.set(gr,y)}catch(y){t("re-subscribe %s failed: %o",gr,y),we(y,"worker")}}let at=new Map,st=null,se=null,Re=null,Te=null,pt=null;async function sr(){Te=null,$e.clear(),pt=null,M.clear(),st=null,se=null,K.clear(),at.clear(),ie.board+=1,ie.worker+=1,ht();let _=ce.getState().workspace.current?.path;if(_)try{await ge.send("set-workspace",{path:_})}catch(w){t("workspace restore after reconnect failed: %o",w);return}Ye();let d=ce.getState();lt(d.view==="board"),ct(d.view==="worker"),fe(d.view==="monitor"),F(d.view==="board"||d.view==="worker"||!!d.selected_id)}async function jt(){t("clearing all subscriptions for workspace switch"),nt(),Oe(),G(),j.clear(),et(),We(),Ae(),Ye(),I();let _=ce.getState();if(_.selected_id)try{W.unregister(`detail:${_.selected_id}`)}catch{}let d=ce.getState();lt(d.view==="board"),ct(d.view==="worker"),fe(d.view==="monitor"),F(d.view==="board"||d.view==="worker"||!!d.selected_id),d.selected_id&&Y(d.selected_id)}async function p(_){t("requesting workspace switch to %s",_),me=!0;try{let d=await ge.send("set-workspace",{path:_});t("workspace switch result: %o",d),d&&d.workspace&&(ce.setState({workspace:{current:{path:d.workspace.root_dir,database:d.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",_),d.changed&&(await jt(),Z("Switched to "+Q(_),"success",2e3)))}catch(d){throw t("workspace switch failed: %o",d),Z("Failed to switch workspace","error",3e3),d}finally{me=!1}}async function v(_){t("requesting workspace git pull for %s",_);try{let d=await ge.send("git-pull-workspace",{});t("workspace git pull result: %o",d);let w=d?.status;if(w==="up_to_date"){Z("Already up to date","success",2e3);return}if(w==="stash_pop_conflict"){Z("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}Z("Git pulled "+Q(_),"success",2e3)}catch(d){t("workspace git pull failed: %o",d);let w=d?.code,y=d?.message;if(w==="rebase_conflict"){Z("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(w==="rebase_conflict_abort_failed"){Z("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(w==="busy"){Z("Git pull skipped: another operation is running","warning",3e3);return}let D=y?`: ${y}`:"";throw Z(`Git pull failed${D}`,"error",3e3),d}}async function R(_,d){t("setting workspace visibility %s \u2192 %s",_,String(d));try{await ge.send("set-workspace-visibility",{path:_,visible:d}),await _e()}catch(w){t("workspace visibility update failed: %o",w),Z("Failed to update project visibility","error",3e3)}}async function _e(){try{let _=await ge.send("list-workspaces",{});if(t("workspaces loaded: %o",_),_&&Array.isArray(_.workspaces)){let d=_.workspaces.map(J=>({path:J.path,database:J.database,pid:J.pid,version:J.version})),w=_.current?{path:_.current.root_dir,database:_.current.db_path}:null,y=Array.isArray(_.hidden)?_.hidden.filter(J=>typeof J=="string"):[];ce.setState({workspace:{current:w,available:d,hidden:y}});let D=window.localStorage.getItem("beads-ui.workspace");D&&(!d.some(Se=>Se.path===D)||y.includes(D)?window.localStorage.removeItem("beads-ui.workspace"):w&&D!==w.path&&(t("restoring saved workspace preference: %s",D),await p(D)))}}catch(_){t("failed to load workspaces: %o",_)}}ge.on("workspace-changed",_=>{t("workspace-changed event: %o",_),_&&_.root_dir&&(ce.setState({workspace:{current:{path:_.root_dir,database:_.db_path}}}),_e(),jt())});let ye=!1;if(typeof ge.onConnection=="function"){let _=d=>{t("ws state %s",d),d==="reconnecting"||d==="closed"?(ye=!0,Z("Connection lost. Reconnecting\u2026","error",4e3)):d==="open"&&ye&&(ye=!1,Z("Reconnected","success",2200),yf(ce,(w,y)=>{t(`${w}: %o`,y)}),sr())};ge.onConnection(_)}let le="board";try{let _=window.localStorage.getItem("beads-ui.view");(_==="board"||_==="worker"||_==="monitor")&&(le=_)}catch(_){t("view parse error: %o",_)}let ce=Aa({config:bf(),view:le});ge.on("worker-queue-snapshot",_=>{let d=_;if(!d||!d.queue)return;let w=ce.getState().workspace.current?.path;if(typeof w=="string"&&w.length>0&&d.root_dir!==w){t("dropping worker-queue snapshot for %s",String(d.root_dir));return}try{let y=d.queue?.deployment?.notifications;if(Array.isArray(y))for(let D of y)D&&typeof D.key=="string"&&typeof D.text=="string"&&(D.variant==="success"||D.variant==="warning"||D.variant==="info")&&Ea(D.key,D.text,D.variant);j.set(d.queue)}catch{}});let Le=xa(ce);Le.start();let it=new Set(["get-comments","exec-preset-create","exec-preset-update","exec-preset-delete","apply-exec-preset"]),ft=async(_,d)=>{try{return await ke(_,d)}catch(w){if(it.has(_))throw w;return[]}};n&&vl(n,ce,Le);let St=document.getElementById("workspace-picker");St&&Pl(St,ce,p,v,R);let vt=xl(e,(_,d)=>ke(_,d));try{let _=document.getElementById("new-issue-btn");_&&_.addEventListener("click",()=>vt.open())}catch{}let de=Vi(e,{policyStore:$e,transport:(_,d)=>ke(_,d),labelOptions:()=>{let _=new Set;for(let[d]of Ao)for(let w of W.snapshotFor(d)||[]){let y=w.labels;if(Array.isArray(y))for(let D of y)typeof D=="string"&&D.length>0&&_.add(D)}return Array.from(_).sort()}});try{let _=document.getElementById("display-settings-btn");_&&_.addEventListener("click",()=>de.open())}catch{}let b=Na(o,{gotoIssue:_=>Le.gotoIssue(_),issueStores:W,transport:ft,workerQueueStore:j,uiOrderStore:V,displayPolicyStore:$e,closedRange:rt,onClosedRangeChange:_=>{yt(_)},onNewIssue:()=>vt.open()}),z=$o(a,{transport:ft,issueStores:W,queueStore:j,execPresetStore:M,sessionLogStore:P,uiOrderStore:V,gotoIssue:_=>ce.setState({selected_id:_}),getWorkspacePath:()=>ce.getState().workspace.current?.path,doneRange:ze,onDoneRangeChange:_=>{It(_)}}),ee=yl(i,{transport:ft,pipelineStore:he,execPresetStore:M,gotoIssue:_=>Le.gotoIssue(_),getWorkspacePath:()=>ce.getState().workspace.current?.path,switchWorkspace:_=>p(_)}),Ne=Gi(c,{issueStores:W,transport:ft,queueStore:j,execPresetStore:M,sessionLogStore:P,getWorkspacePath:()=>ce.getState().workspace.current?.path,onNavigate:_=>{ce.getState().view==="worker"?ce.setState({selected_id:_}):Le.gotoIssue(_)},onClose:()=>{let _=ce.getState();ce.setState({selected_id:null});try{Le.gotoView(_.view==="worker"||_.view==="monitor"?_.view:"board")}catch{}},onOpenExecPresets:()=>{ce.setState({selected_id:null}),Le.gotoView("worker"),z.openExecDefaults()}}),Ze=ce.getState().selected_id;Ze&&(c.hidden=!1,Ne.load(Ze),Y(Ze)),ce.subscribe(_=>{let d=_.selected_id;d?(c.hidden=!1,Ne.load(d),me||Y(d)):(Ne.clear(),c.hidden=!0,I())});let ae=_=>{o.hidden=_.view!=="board",a.hidden=_.view!=="worker",i.hidden=_.view!=="monitor",lt(_.view==="board"),ct(_.view==="worker"),fe(_.view==="monitor"),F(_.view==="board"||_.view==="worker"||!!_.selected_id),!_.selected_id&&_.view==="board"&&b.load(),_.view==="worker"&&z.load(),_.view==="monitor"?ee.load():ee.pause(),window.localStorage.setItem("beads-ui.view",_.view)};ce.subscribe(ae),ae(ce.getState()),We(),Ye(),ht(),_e().finally(()=>{C=!0,De()}),window.addEventListener("keydown",_=>{let d=_.ctrlKey||_.metaKey,w=String(_.key||"").toLowerCase(),y=_.target,D=y&&y.tagName?String(y.tagName).toLowerCase():"",J=D==="input"||D==="textarea"||D==="select"||y&&typeof y.isContentEditable=="boolean"&&y.isContentEditable;d&&w==="n"&&(J||(_.preventDefault(),vt.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let e=document.getElementById("theme-switch");e&&e.addEventListener("change",()=>{let r=e.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let t=document.getElementById("app");t&&wf(t)});export{wf as bootstrap,bf as readBootstrapConfig,yf as refreshConfigSnapshot};
