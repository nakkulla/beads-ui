...
${u}`:u,s=s?`${s}
${d}`:d;let p=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(d,o,!0),this.lexer.state.top=p,r.length===0)break;let m=o.at(-1);if(m?.type==="code")break;if(m?.type==="blockquote"){let $=m,T=$.raw+`
`+r.join(`
`),D=this.blockquote(T);o[o.length-1]=D,n=n.substring(0,n.length-$.raw.length)+D.raw,s=s.substring(0,s.length-$.text.length)+D.text;break}else if(m?.type==="list"){let $=m,T=$.raw+`
`+r.join(`
`),D=this.list(T);o[o.length-1]=D,n=n.substring(0,n.length-m.raw.length)+D.raw,s=s.substring(0,s.length-$.raw.length)+D.raw,r=T.substring(o.at(-1).raw.length).split(`
...
`)?"":`
`)+s.raw,a.text+=`
`+s.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):r.push(s);continue}if(t){let a="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw new Error(a)}}return this.state.top=!0,r}inline(t,r=[]){return this.inlineQueue.push({src:t,tokens:r}),r}inlineTokens(t,r=[]){let n=t,s=null;if(this.tokens.links){let c=Object.keys(this.tokens.links);if(c.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)c.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,s.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)o=s[2]?s[2].length:0,n=n.slice(0,s.index+o)+"["+"a".repeat(s[0].length-o-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);n=this.options.hooks?.emStrongMask?.call({lexer:this},n)??n;let a=!1,i="";for(;t;){a||(i=""),a=!1;let c;if(this.options.extensions?.inline?.some(d=>(c=d.call({lexer:this},t,r))?(t=t.substring(c.raw.length),r.push(c),!0):!1))continue;if(c=this.tokenizer.escape(t)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.tag(t)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.link(t)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(c.raw.length);let d=r.at(-1);c.type==="text"&&d?.type==="text"?(d.raw+=c.raw,d.text+=c.text):r.push(c);continue}if(c=this.tokenizer.emStrong(t,n,i)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.codespan(t)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.br(t)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.del(t)){t=t.substring(c.raw.length),r.push(c);continue}if(c=this.tokenizer.autolink(t)){t=t.substring(c.raw.length),r.push(c);continue}if(!this.state.inLink&&(c=this.tokenizer.url(t))){t=t.substring(c.raw.length),r.push(c);continue}let u=t;if(this.options.extensions?.startInline){let d=1/0,p=t.slice(1),m;this.options.extensions.startInline.forEach($=>{m=$.call({lexer:this},p),typeof m=="number"&&m>=0&&(d=Math.min(d,m))}),d<1/0&&d>=0&&(u=t.substring(0,d+1))}if(c=this.tokenizer.inlineText(u)){t=t.substring(c.raw.length),c.raw.slice(-1)!=="_"&&(i=c.raw.slice(-1)),a=!0;let d=r.at(-1);d?.type==="text"?(d.raw+=c.raw,d.text+=c.text):r.push(c);continue}if(t){let d="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(d);break}else throw new Error(d)}}return r}},ro=class{constructor(e){At(this,"options");At(this,"parser");this.options=e||tn}space(e){return""}code({text:e,lang:t,escaped:r}){let n=(t||"").match(Yt.notSpaceStart)?.[0],s=e.replace(Yt.endingNewline,"")+`
...
`).trim()}}var Tc=20;function Cc(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function am(e){return e.length>Tc?`${e.slice(0,Tc)}\u2026`:e}function im(e,t,r,n){let s=`${t.lane} ${am(t.identifier)}`;return l`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${fm.map(p=>{let m=p.receipt&&typeof t[p.receipt]=="string"?String(t[p.receipt]):"",$=n[p.id],T=m.length>0||$?.fill==="full",D=!T&&$?.fill==="dim",H=$?.stale===!0;return l`<span
          class=${`detail-summary__gate${T?" detail-summary__gate--on":""}${D?" detail-summary__gate--current":""}${H?" detail-summary__gate--stale":""}`}
          data-gate=${p.id}
        >
    ...
    `:l``}function d(){Ye(u(),e)}async function p(T,D={}){s=T,o="loading",a="",i="",d();let H=r?r():"";if(!H){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",d();return}if(!n){o="error",i="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",d();return}let se="/api/doc?workspace="+encodeURIComponent(H)+"&path="+encodeURIComponent(T);try{let V=await n(se),N=await V.json().catch(()=>({}));if(!V.ok||!N||N.ok!==!0){if(N?.error==="not_found"&&D.missing_state==="plan_pending"){o="pending",i="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",d();return}o="error",i="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(N&&N.error||V.status)+")",d();return}a=String(N.content||""),o="ready",d()}catch{o="error",i="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",d()}}function m(){s=null,Ye(l``,e)}function $(){document.removeEventListener("keydown",c),m()}return{open:p,close:m,destroy:$}}var Am=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],su="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",ho=["implementation","review-consult"],Sm=["running","done","failed","interrupted"],Em={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function Tm(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function Cm(e){let t=zt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
    ...
    >${e.replayed?l`<span class="detail-usage-partial" title=${su}
          >부분 집계</span
        >`:""}`}function nu(e){return!e||!e.roles.orchestrator?null:{providers:e.roles.orchestrator,roles:{}}}function ja(e){if(typeof e!="string")return"";let t=Date.parse(e);return Number.isFinite(t)?Ba(t):""}function Rm(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let t=e;return typeof t.launch_id!="string"||t.launch_id.length===0||t.provider!=="codex"||!ho.includes(t.role)||typeof t.model!="string"||t.model.length===0||!(!("effort"in t)||t.effort===null||typeof t.effort=="string"&&t.effort.trim().length>0)||typeof t.session_id!="string"||t.session_id.length===0||!Sm.includes(t.status)||typeof t.started_at!="number"||!Number.isFinite(t.started_at)||typeof t.last_event_at!="number"||!Number.isFinite(t.last_event_at)||!(t.completed_at===null||typeof t.completed_at=="string"&&Number.isFinite(Date.parse(t.completed_at)))||!(t.turn_id===null||typeof t.turn_id=="string")?null:t}function Lm(e,t){let n=zt({providers:{codex:{subtotal:t.subtotal,breakdown:t.usage,...t.replayed?{replayed:!0}:{}}},roles:{}})[0];return l`<div class="detail-session__leg detail-session__usage-detail">
    ...
    ${n?l`<span class="detail-session__usage" title=${n.tooltip}
          >${n.label}</span
        >`:""}
  </div>`}function Im(e,t,r,n){let s=e.status==="running"?null:t,a=(s?zt({providers:{codex:{subtotal:s.subtotal,breakdown:s.usage,...s.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],i=e.status==="running"?Ba(e.last_event_at):s?ja(s.completed_at):"";return l`<button
    type="button"
  ...
  >
    ...
    ${a?l`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function Om(e,t){return e.role===t.role&&e.model===t.model&&e.session_id===t.session_id}function Pm(e,t,r){let n=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let d of o){let p=Rm(d);!p||s.has(p.launch_id)||(s.add(p.launch_id),n.push(p))}n.sort((d,p)=>d.started_at-p.started_at);let a={implementation:[],"review-consult":[]};if(t)for(let d of ho){let p=t.roles[d]?.codex;a[d]=p?[...p.legs]:[]}let i=ho.flatMap(d=>a[d]),c=new Set,u=[];for(let d of ho){for(let p of n.filter(m=>m.role===d)){let m=i.find($=>$.receipt_id===p.launch_id)||null;m&&!Om(p,m)||(m&&c.add(m.receipt_id),u.push(Im(p,m,e.attempt_id,r)))}for(let p of a[d])c.has(p.receipt_id)||u.push(Lm(d,p))}return u}function Mm(e,t){let r=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,n=[...Am,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return l`<div class="detail-session__usage-detail">
    ${n.map(s=>l`<span class="detail-session__usage-field"
          ><span class="detail-session__usage-label">${s.label}</span
          ><span class="detail-session__usage-value"
            >${Tm(e[s.key]).toLocaleString("en-US")}</span
          ></span
        >`)}
  ...
  </div>`}var Dm={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function Ba(e){if(typeof e!="number"||!Number.isFinite(e))return"";let t=new Date(e),r=String(t.getHours()).padStart(2,"0"),n=String(t.getMinutes()).padStart(2,"0");return`${r}:${n}`}function Nm(e){if(typeof e.exec_default_preset_id!="string"||e.exec_default_preset_id.length===0)return"";let t=e.exec_values&&typeof e.exec_values=="object"?Object.entries(e.exec_values).filter(([,n])=>typeof n=="string"&&n.length>0).map(([n,s])=>`${n}=${s}`).join(" \xB7 "):"",r=typeof e.exec_default_preset_revision=="number"?` r${e.exec_default_preset_revision}`:"";return l`<div
  ...
  >
    ...
    `;let o=new Set;for(let u of n)u&&typeof u.resumed_from=="string"&&u.resumed_from.length>0&&o.add(u.resumed_from);let a=u=>{if(!(u.status==="failed"||u.status==="orphaned"))return"";let p=typeof u.session_id=="string"&&u.session_id.length>0,m=o.has(u.attempt_id),$=p&&!m,T=p?m?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":"\uC774 \uC138\uC158\uC744 \uAC19\uC740 \uC6CC\uD06C\uD2B8\uB9AC\uC5D0\uC11C \uC774\uC5B4\uC11C \uC9C4\uD589":"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00";return l`<button
      type="button"
      class="detail-session__resume"
      data-attempt-id=${u.attempt_id}
      ?disabled=${!$}
      title=${T}
      @click=${D=>{D.stopPropagation(),$&&t.onResume&&t.onResume(u.attempt_id)}}
    >
      ↻ 이어하기
  ...
  `}function qm(e){let t=Sn(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?Er("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var Fm=["open","in_progress","deferred","resolved","closed"],jm=[0,1,2,3,4];function iu(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,c=t.sessionLogStore,u=null,d=null,p={},m="",$=!1,T=[],D=!1,H={},se={claude:null,codex:null},V=null,N=0,P=!1,I=!1,R="",A="",M="";function G(){P=!1,I=!1,R="",A="",M=""}function pe(){se={claude:null,codex:null},V=null,N+=1}async function fe(x){try{let J=await fetch(x);if(!J.ok)return null;let O=await J.json();if(!O||typeof O!="object"||!Array.isArray(O.accounts))return null;let Re=O.accounts.filter(ut=>ut!==null&&typeof ut=="object"&&!Array.isArray(ut));return{accounts:Re,active:Re.find(ut=>ut.active===!0)||null}}catch{return null}}async function _e(x){V=x;let J=++N,[O,Re]=await Promise.all([fe("/api/claude-usage"),fe("/api/codex-usage")]);J!==N||x!==u||(se={claude:O,codex:Re},$e())}let ae=[],Le=null,Te=null,ee=!1,oe="",xe=!1,g=0,j=new Set;function U(){ae=[],Le=null,Te=null,ee=!1,oe="",xe=!1,g+=1,j.clear()}async function K(x){if(!s)return;let J=++g;try{let O=await Promise.resolve(s("get-comments",{id:x}));if(J!==g||x!==u)return;ae=Array.isArray(O)?O:[],ee=!1}catch{if(J!==g||x!==u)return;ee=!0}$e()}function ge(){if(!s||!u)return;let x=d&&typeof d.comment_count=="number"?d.comment_count:null;if(Le!==u){Le=u,Te=x,K(u);return}x!==null&&x!==Te&&(Te=x,K(u))}function we(x){j.has(x)?j.delete(x):j.add(x),$e()}function ke(x){let J=oe.trim().length===0;oe=x,J!==(x.trim().length===0)&&$e()}async function Ze(){let x=oe.trim();if(!s||!u||x.length===0||xe)return;let J=u;xe=!0,$e();let O=!1;try{let Re=await Promise.resolve(s("add-comment",{id:J,text:x}));Array.isArray(Re)&&Re.length>0&&(O=!0,J===u&&(ae=Re,ee=!1,oe="",Te=Re.length))}catch{O=!1}O||me("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),J===u&&(xe=!1),$e()}let wt={onToggle:we,onDraftInput:ke,onSubmit:Ze},He=document.createElement("div");He.className="md-viewer-root",document.body.appendChild(He);let pt=ru(He,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),st=document.createElement("div");st.className="session-log-root",document.body.appendChild(st);let Y=En(st,{transport:s?(x,J)=>Promise.resolve(s(x,J)):void 0,sessionLogStore:c}),Z=!1,Se=!1,Qe=!1,je=null,ot=null,Je=0;function yt(x){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${x}`}function Ie(){Z=!1,Se=!1,Qe=!1,je=null,ot=null,Je+=1}async function E(x){if(!s)return;let J=++Je;Se=!0,Qe=!1,$e();try{let O=await Promise.resolve(s("get-bead-prompt",{bead_id:x}));if(J!==Je)return;!O||typeof O!="object"||Array.isArray(O)?Qe=!0:(je=O,ot=yt(x))}catch{J===Je&&(Qe=!0)}finally{J===Je&&(Se=!1,$e())}}function Q(){if(Z=!Z,Z&&u&&ot!==yt(u)){je=null,E(u);return}$e()}function Ee(){if(!a||!u)return[];let x=a.get();return(x&&x.attempts?Object.values(x.attempts):[]).filter(O=>O&&O.bead_id===u).sort((O,Re)=>(Re.started_at||0)-(O.started_at||0)).map(O=>({attempt_id:O.attempt_id,bead_id:O.bead_id,status:O.status,started_at:typeof O.started_at=="number"?O.started_at:null,runner:O.runner||null,model:O.model||null,effort:O.effort||O.observed_effort||null,speed:O.speed||null,session_id:O.session_id||null,resumed_from:O.resumed_from||null,continuation_mode:O.continuation_mode||null,dismissed_at:typeof O.dismissed_at=="number"?O.dismissed_at:null,cause:typeof O.cause=="string"?O.cause:null,cause_detail:O.cause_detail||null,exec_default_preset_id:typeof O.exec_default_preset_id=="string"?O.exec_default_preset_id:null,exec_default_preset_revision:typeof O.exec_default_preset_revision=="number"?O.exec_default_preset_revision:null,exec_values:O.exec_values&&typeof O.exec_values=="object"?O.exec_values:null,usage:O.usage||null,usage_legs:Array.isArray(O.usage_legs)?O.usage_legs:[],delegation_sessions:Array.isArray(O.delegation_sessions)?O.delegation_sessions:[]}))}function re(){if(!a||!u)return null;let x=a.get();return lr(x&&x.attempts||{},u)}let qe=new Set;function rt(x){qe.has(x)?qe.delete(x):qe.add(x),$e()}function it(x){let J=a?a.get():null,O=J&&J.attempts?J.attempts[x]:null;Y.open({attempt_id:x,meta:O?{runner:O.runner||void 0,model:O.model||void 0,effort:O.effort||void 0,status:O.status||void 0,session_id:O.session_id||void 0}:{}})}function Xe(x,J){let O=a?a.get():null,Re=O&&O.attempts?O.attempts[x]:null,lt=(Re&&Array.isArray(Re.delegation_sessions)?Re.delegation_sessions:[]).find(et=>et&&typeof et=="object"&&et.launch_id===J);lt&&Y.open({attempt_id:x,launch_id:J,meta:{runner:"codex",role:lt.role,model:lt.model,effort:lt.effort,session_id:lt.session_id,status:lt.status}})}async function nt(x){if(!s||!x)return;let J=await $n();if(J===null)return;let O=()=>{let et=a?a.get():null;return et&&typeof et.revision=="number"?et.revision:0},Re=async(et={},tt=O())=>await s("worker-attempt-resume",{attempt_id:x,expected_revision:tt,...J!==""?{instructions:J}:{},...et}),ut=et=>{et?.queue&&a?.set&&a.set(et.queue)},lt=await Re();if(ut(lt),lt&&lt.conflict){let et=lt.queue&&typeof lt.queue.revision=="number"?lt.queue.revision:O();lt=await Re({},et),ut(lt)}lt=await wr(lt,(et,tt)=>Re({continuation:et,decision_token:tt}),{onResult:ut,refresh:()=>Re()}),lt&&lt.resumed===!1&&!lt.conflict&&lt.reason&&me(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${lt.reason}`,"error",2400)}let _t={onOpen:it,onOpenDelegation:Xe,onResume:nt,onToggleUsage:rt};function ht(){let x=a?a.get():null,J={...H};for(let O of["orchestration_model","orchestration_effort","orchestration_speed"]){let Re=x&&x[O];typeof Re=="string"&&(J[O]=Re)}return J}async function at(){if(s){try{let x=await Promise.resolve(s("get-session-defaults",{}));H=x&&x.values&&typeof x.values=="object"?x.values:{}}catch{H={}}$e()}}function kt(){let x=a?a.get():null;return x&&x.runner_catalog||null}function q(){let x=a?a.get():null;return x&&typeof x.execution_defaults=="object"?x.execution_defaults:null}function te(){let x=d?.metadata&&typeof d.metadata=="object"?d.metadata:{},O=Qt({pin:{...x,...p},global:ht(),execution_defaults:q(),runner_catalog:kt(),route:typeof x.route=="string"?x.route:null}).orchestration_model.value||"";return gr(kt(),O)}function he(){let x=i?i.get():null;return!x||typeof x.revision!="number"?null:{revision:x.revision,presets:Array.isArray(x.presets)?x.presets:[]}}function ze(x){return x?.compatible===!1}function De(x){i&&x&&typeof x.revision=="number"&&Array.isArray(x.presets)&&i.set({revision:x.revision,presets:x.presets})}async function F(){let x=he(),J=x?.presets.find(O=>O.id===m);if(!(!s||!u||!x||!J||ze(J)||$)){$=!0,T=[],$e();try{let O=await Promise.resolve(s("apply-impl-preset",Uc(u,J.id,x.revision)));if(O&&O.conflict){De(O),me("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let Re=O&&Array.isArray(O.issue)?O.issue[0]:O?.issue;if(O&&O.applied&&Re&&typeof Re=="object"){d=Re,T=Array.isArray(O.skipped_orchestration_keys)?O.skipped_orchestration_keys.filter(ut=>typeof ut=="string"):[];for(let ut of Xc)delete p[ut];me(T.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}O&&O.error==="bd_readback_failed"?me("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):me("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(O){O&&typeof O=="object"&&O.code==="bd_readback_failed"?me("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):me("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{$=!1,$e()}}}let ne=null;r&&r.subscribe&&(ne=r.subscribe(()=>B()));let ve=null;a&&typeof a.subscribe=="function"&&(ve=a.subscribe(()=>{u&&$e()}));let w=null;i&&typeof i.subscribe=="function"&&(w=i.subscribe(()=>{u&&$e()}));function C(x){x.key==="Escape"&&u&&(x.preventDefault(),n())}document.addEventListener("keydown",C);function B(){if(u){if(r&&typeof r.snapshotFor=="function"){let x=r.snapshotFor("detail:"+u)||[];d=x.find(O=>O&&O.id===u)||x[0]||d}ge(),$e()}}function ie(x){tr(x).then(J=>{J?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function Ce(x){x.preventDefault(),x.stopPropagation(),u&&ie(u)}function Ae(x,J){x.preventDefault(),x.stopPropagation(),ie(J)}function Pe(x,J,O){x.preventDefault(),x.stopPropagation(),pt.open(J,{missing_state:O})}function Be(x,J){p[x]=J,$e(),!(!s||!u)&&Promise.resolve(s("update-exec-settings",Bc(u,x,J.length===0?null:J))).catch(()=>{me("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function St(x,J){let O=d||{},Re=O.metadata&&typeof O.metadata=="object"?O.metadata:{},ut={};for(let tt of["impl_runtime","impl_model","impl_effort"])ut[tt]=Object.hasOwn(p,tt)?p[tt]:typeof Re[tt]=="string"?Re[tt]:"";ut[x]=J;let lt=tu(ut,kt(),te()),et={};for(let tt of["impl_runtime","impl_model","impl_effort"])et[tt]=p[tt],p[tt]=lt[tt]||"";$e(),!(!s||!u)&&Promise.resolve(s("update-impl-target",{id:u,...lt,orchestration_runtime:te()})).then(tt=>{let Pt=Array.isArray(tt)?tt[0]:tt;if(!Pt||typeof Pt!="object"||!Pt.id)throw new Error("implementation target readback failed");d=Pt;for(let Jt of["impl_runtime","impl_model","impl_effort"])delete p[Jt];$e()}).catch(()=>{for(let tt of["impl_runtime","impl_model","impl_effort"])et[tt]===void 0?delete p[tt]:p[tt]=et[tt];$e(),me("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function bt(x,J,O){if(!s||!u)return!1;try{let Re=await Promise.resolve(s(x,J)),ut=Array.isArray(Re)?Re[0]:Re;return ut&&typeof ut=="object"&&ut.id?(d=ut,!0):(me(O,"error"),!1)}catch{return me(O,"error"),!1}}function Ke(x){setTimeout(()=>{try{let J=e.querySelector(x);J&&typeof J.focus=="function"&&J.focus()}catch{}},0)}function Ft(){P=!0,R=d&&d.title||"",$e(),Ke('.detail-edit__input[data-edit="title"]')}function v(x){R=x.target.value}function y(){P=!1,R="",$e()}function L(){bt("edit-text",{id:u,field:"title",value:R},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(J=>{J&&(P=!1,R=""),$e()})}function X(){I=!0,A=d&&d.description||"",$e(),Ke('.detail-edit__textarea[data-edit="description"]')}function be(x){A=x.target.value}function ye(){I=!1,A="",$e()}function Ne(){bt("edit-text",{id:u,field:"description",value:A},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(J=>{J&&(I=!1,A=""),$e()})}function Me(x,J,O,Re){if(x.key==="Escape"){x.stopPropagation(),O();return}x.key==="Enter"&&(!Re||x.ctrlKey||x.metaKey)&&(x.preventDefault(),J())}function ft(x){let J=x.target.value;bt("update-status",{id:u,status:J},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>$e())}function $t(x){let J=Number(x.target.value);bt("update-priority",{id:u,priority:J},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>$e())}function jt(x){M=x.target.value}function Ge(){let x=M.trim();x.length!==0&&bt("label-add",{id:u,label:x},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(J=>{J&&(M=""),$e()})}function Ot(x){if(x.key==="Escape"){x.stopPropagation(),M="",$e();return}x.key==="Enter"&&(x.preventDefault(),Ge())}function Fe(x){bt("label-remove",{id:u,label:x},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>$e())}let S={onCopyPath:Ae,onOpenDoc:Pe};function ue(x){return typeof x=="string"?x:x&&typeof x=="object"?String(x.id||x.to||x.issue_id||x.depends_on||""):""}function Oe(x){switch(x&&typeof x=="object"?String(x.dependency_type||x.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function mt(x){let O=(Array.isArray(x.dependencies)?x.dependencies:[]).map(Re=>({id:ue(Re),icon:Oe(Re)})).filter(Re=>Re.id.length>0);return l`
      <div class="detail-section-label">의존성</div>
      ${O.length===0?l`<div class="detail-empty">의존성 없음</div>`:l`<div class="detail-deps">
            ${O.map(Re=>o?l`<button
                    type="button"
    ...
    `}function Dt(x){let J=x.metadata||{},O=x.workflow||{},Re=O.stages||{},ut=Re.spec&&Re.spec.stale,lt=Re.impl&&Re.impl.stale,et=Re.plan||null,tt=O.route_source==="derived",Pt=O.route||J.route||"\u2014";return l`
      ...
      ${O.route!=="quick_fix"||Object.hasOwn(J,"spec_review")?l`<div class="detail-kv">
            <span class="detail-kv__k">spec_review</span>
            <span class="detail-kv__v"
              >${J.spec_review||"\uC5C6\uC74C"}${ut?" \xB7 stale":""}</span
            >
          </div>`:""}
      ${O.route==="full_plan"?l`<div class="detail-kv">
      ...
      ${O.route!=="quick_fix"||Object.hasOwn(J,"impl_review")?l`<div class="detail-kv">
            <span class="detail-kv__k">impl_review</span>
            <span class="detail-kv__v"
              >${J.impl_review||"\uC5C6\uC74C"}${lt?" \xB7 stale":""}</span
            >
          </div>`:""}
      ${O.planned_execution?l`<div class="detail-kv">
              <span class="detail-kv__k">planned_execution</span>
              <span class="detail-kv__v">${O.planned_execution.kind}</span>
            </div>
            ${O.planned_execution.kind==="main"?l`<div class="detail-kv">
                  <span class="detail-kv__k">planned_execution_reason</span>
                  <span class="detail-kv__v detail-kv__v--wrap"
                    >${O.planned_execution.reason}</span
                  >
                </div>`:""}`:""}
      ${O.exec_receipt?l`<div class="detail-kv">
            <span class="detail-kv__k">exec_receipt</span>
            <span class="detail-kv__v detail-kv__v--wrap"
              >${Xr(O.exec_receipt)}</span
            >
          </div>`:""}
      ${O.impl_entry?l`<div class="detail-kv">
            <span class="detail-kv__k">impl_entry</span>
            <span class="detail-kv__v"
              >${`${O.impl_entry.actor}@${O.impl_entry.sha}`}</span
            >
          </div>`:""}
    ...
    `}let xt={route:["quick_fix","spec_backed","full_plan"]};async function Nt(x,J){let O=J.target.value;if(x==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&O!=="full_plan"&&!window.confirm(`full_plan \u2192 ${O||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){$e();return}await bt("update-workflow-meta",{id:u,key:x,value:O},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),$e()}function f(x){let J=x.metadata||{};return l` ${((Re,ut)=>{let lt=xt[Re],et=typeof J[Re]=="string"?J[Re]:"";return l`<div class="detail-kv">
      ...
      </div>`})("route","(unset)")} `}function k(x,J){return P?l`
      ...
      <div class="detail-title-row">
        ...
        ${zt(J).map(O=>l`<span class="detail-usage-total" title=${O.tooltip}
              >${O.label}</span
            >`)}
        <button
          type="button"
    ...
    `}function z(x){let J=Ht(x.created_at),O=Ht(x.updated_at);return!J&&!O?l``:l`
    ...
    `}function _(x,J){return l`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${ft}
        >
          ${Fm.map(O=>l`<option value=${O} ?selected=${O===x}>${O}</option>`)}
        </select>
      </div>
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${$t}
        >
          ${jm.map(O=>l`<option value=${String(O)} ?selected=${O===J}>
                P${O}
              </option>`)}
        </select>
      </div>
    ...
    `}function le(x){let J=Array.isArray(x.labels)?x.labels:[];return l`
      ...
      <div class="detail-labels">
        ${J.map(O=>l`<span class="detail-label-chip"
              >${O}<button
                type="button"
    ...
    `}function Ue(){if(!u)return l``;let x=d||{},J=String(x.id||u),O=x.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",Re=re(),ut=x.status||"open",lt=typeof x.priority=="number"?Math.max(0,Math.min(4,x.priority)):"",et=x.description||"",tt={...x,metadata:{...x.metadata||{},...p}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${k(O,Re)}
          ${zc(tt)}
          ${Wc({metadata:tt.metadata,workspace_values:ht(),catalog:kt(),execution_defaults:q(),expanded:D,presets:he()?.presets||[],preset_id:m,preset_busy:$,skipped_orchestration_keys:T},{onToggle:Pt=>{D=Pt,$e()},onEdit:(Pt,Jt)=>{if(Pt==="impl_runtime"||Pt==="impl_model"||Pt==="impl_effort"){St(Pt,Jt??"");return}Be(Pt,Jt??"")},onPresetSelect:Pt=>{m=Pt,T=[],$e()},onPresetApply:()=>{F()}})}
    ...
    `}function $e(){Ye(Ue(),e)}return{load(x){x!==u&&(p={},m="",T=[],D=!1,G(),U(),Ie(),pe()),u=x,d=null,B(),at(),V!==x&&_e(x)},clear(){u=null,d=null,p={},m="",$=!1,T=[],D=!1,G(),U(),Ie(),pe(),pt.close(),Y.close(),Ye(l``,e)},destroy(){ne&&(ne(),ne=null),ve&&(ve(),ve=null),w&&(w(),w=null),document.removeEventListener("keydown",C),pt.destroy(),He.parentNode&&He.parentNode.removeChild(He),Y.destroy(),st.parentNode&&st.parentNode.removeChild(st),u=null,d=null,pe(),m="",$=!1,T=[],U(),Ie(),Ye(l``,e)}}}function lu(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
...
\uC774\uC288 \uD540 \u2014 \uB808\uD3EC \uAE30\uBCF8\uAC12\uACFC \uB2E4\uB984`:"";return l`${e.orchestration?l`<span
  ...
  </div>`}function zm(e){let t=Array.isArray(e.badges)?e.badges:[],r=zt(e.usage),n=$r(e.usage),s=ir(e.done_at);return l`<div
  ...
  >
    ...
    >${e.id}</span
  >`,T=l`<span class="worker-mini__title">${e.title}</span>`,D=e.pr_url&&e.pr_number?l`<a
        ...
        >`:l`<span
          ...
          >${xe}</span
        >`),V=e.reason?l`<span class="worker-mini__reason">${e.reason}</span>`:"",N=n.length>0?n.map(xe=>l`<span class="worker-usage" title=${xe.tooltip}
              >${xe.label}</span
      ...
      >
        저장소 작업 보기
      </button>`:"",M=e.discard,G=M?.action||e.discard_action?l`<button
          type="button"
        ...
        </div>`:"",Te=$o(e.dependency_chips),ee=is(e),oe=!!(s||o||e.merge_action||e.cancel_action||e.timeline_action||e.discard_action||M?.operation||e.revise_action||pe);return l`<div
    ...
    data-lane=${e.lane}
  >
    ${i?l`<div class="worker-mini__row1">${m}${$}${T}</div>
          <div class="worker-mini__row2">
            ${N}${c?l`<span
                  class="worker-mini__done-at"
                  title=${`\uC644\uB8CC ${Ht(e.done_at)}`}
            ...
            ${Rn(e)}`:l`<div class="worker-mini__line">
              ${u}${d}${m}${$}${T}${D}${H}${se}${p}${V}${N}${P}${I}${R}${A}${G}
            </div>
            ${Te}${Le}${ee} ${Rn(e)}`}
  ...
  >
  ...
  </details>`:""}function Km(e){if(!Number.isFinite(e)||e<0)return"0s";let t=Math.floor(e/1e3),r=Math.floor(t/60),n=t%60;return r>0?`${r}m ${String(n).padStart(2,"0")}s`:`${n}s`}function gu(e){let t=e.failure?xo(e.failure.reason):"";return l`<div class="worker-banners">
    ${e.failure?l`<div class="worker-banner worker-banner--failure" role="alert">
          ...
          ${Gm(e.failure.cause_detail)}
          ${Vm(e.failure.reason)}
          ${is({discard:e.failure.discard})}
        </div>`:""}
  </div>`}function Ym(e){return e?l`${e.repo?l`<span
        class="worker-card__repo rtile__repo"
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?l`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`:""}function Zm(e,t,r){if(!e)return"";let n=e.workflow||null,s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=Array.isArray(e.legs)?e.legs:[],c=i.filter(p=>p&&p.state==="live"),u=i.filter(p=>p&&p.state!=="live"),d=$o(e.dependency_chips);return l`${n?yn(n,"in_progress"):""}
  ${o?l`<div class="rtile__activity${r?" is-paused":""}">
        ...
        ${c.map(p=>l`<span class="rtile__leg rtile__leg--live"
            ...
            >`)}${u.length>0?l`<span
              ...
              >✓ ${u.length}</span
            >`:""}
      </div>`:""}${d}`}function Ha(e,t,r=null,n={}){let s=e.failed===!0,o=!!e.paused,a=s?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):o?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Km(t-e.started_at):"\u2014",i=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,c=Bn(e),u=zt(e.usage),d=$r(e.usage),p=e.conflict_resolution?o?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,m=e.base_exception||null,$=e.landing,T=e.attempt_id&&e.attempt_id===r,D=n.monitor||null,H=Ym(D),se=Zm(D,t,o),V=e.discard?.action?l`<button
        type="button"
  ...
  >
    ...
    ${i||u.length>0||d||p||m?l`<div class="rtile__meta">
          ...
          ${m?l`<span
              ...
              >`:""}
          ${ko(e.exec_chips)}
          ${u.length>0?u.map(N=>l`<span class="worker-usage" title=${N.tooltip}
                    >${N.label}</span
                  >`):d?l`<span
                  class="worker-usage"
                  title=${zn(e.usage)}
  ...
  </div>`}function Va(e,t){return`${e}\0${t}`}function Ka(e){let t=new Map;for(let r of Array.isArray(e?.running)?e.running:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"running",state:"running"});for(let r of Array.isArray(e?.pr_wait)?e.pr_wait:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"pr_wait",state:"pr_wait"});for(let r of Array.isArray(e?.queue_groups)?e.queue_groups:[]){let n=Array.isArray(r.sublanes?.parallel)?r.sublanes.parallel:Array.isArray(r.items)?r.items:[];for(let s of n)t.set(s.id,{root_dir:s.root_dir,workspace_name:s.workspace_name,lane:"parallel",position:s.queue_position});for(let s of Array.isArray(r.sublanes?.serial)?r.sublanes.serial:[])for(let o of s.items)t.set(o.id,{root_dir:o.root_dir,workspace_name:o.workspace_name,lane:s.id,position:o.queue_position})}for(let r of Array.isArray(e?.runnable)?e.runnable:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"runnable",state:"runnable"});for(let r of Array.isArray(e?.done)?e.done:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"done",state:"done"});return t}function Ya(e,t){let r=Array.isArray(t)?t:[],n=e.indexOf("-"),s=n>0?e.slice(0,n):e;return r.some(o=>typeof o?.issue_prefix=="string"&&o.issue_prefix===s)?"internal":r.length>0&&r.every(o=>typeof o?.issue_prefix=="string")?"external":"unknown"}function Qm(e,t){return e==="internal"&&t===void 0}function In(e){if(e.state==="running")return"\uC2E4\uD589\uC911";if(e.state==="pr_wait")return"PR \uB300\uAE30";if(e.state==="runnable")return"\uC2E4\uD589\uAC00\uB2A5";if(e.state==="done")return"\uC644\uB8CC";let t=e.lane==="parallel"?"\uBCD1\uB82C":e.lane;return`${e.workspace_name} \xB7 ${t} #${e.position}`}function hu(e,t,r,n){let s=r.get(e);if(!!(s&&t&&s.root_dir===t.root_dir&&s.lane===t.lane&&typeof s.position=="number"&&typeof t.position=="number"&&s.position<t.position))return{id:e,label:`\u{1F512} ${e} (\uAC19\uC740 \uB808\uC778 \uC55E)`,location_label:"\uAC19\uC740 \uB808\uC778 \uC55E",scope:null,same_lane_ahead:!0,missing_internal:!1};if(s)return{id:e,label:`\u{1F512} ${e} (${In(s)})`,location_label:In(s),scope:null,same_lane_ahead:!1,missing_internal:!1};let a=Ya(e,n),i=a==="internal"?"\uBBF8\uC801\uC7AC":a==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778";return{id:e,label:`\u{1F512} ${e} (${i})`,location_label:i,scope:a,same_lane_ahead:!1,missing_internal:Qm(a,s)}}function bu(e){let t=Array.isArray(e)?e:[],r=new Map,n=new Map,s=new Map;for(let i of t)for(let c of Array.isArray(i.sublanes?.serial)?i.sublanes.serial:[]){let u=Va(i.root_dir,c.id);r.set(u,{root_dir:i.root_dir,workspace_name:i.name,lane:c.id}),s.set(u,[]);for(let d of Array.isArray(c.items)?c.items:[])n.set(d.id,u)}for(let i of t)for(let c of Array.isArray(i.sublanes?.serial)?i.sublanes.serial:[]){let u=Va(i.root_dir,c.id),d=Array.isArray(c.items)?c.items[0]:null,m=!!d&&d.queue_index===0&&(!Array.isArray(c.occupied_by)||c.occupied_by.length===0)&&Array.isArray(d.blocked_by)?d.blocked_by:[],$=s.get(u);if($)for(let T of m){let D=n.get(T);D&&D!==u&&!$.includes(D)&&$.push(D)}}let o=(i,c)=>{let u=new Set,d=[i];for(;d.length>0;){let p=d.pop();if(p===c)return!0;!p||u.has(p)||(u.add(p),d.push(...s.get(p)||[]))}return!1},a=new Map;for(let[i,c]of s){let u=[];for(let d of c){let p=r.get(d);o(d,i)&&p&&u.push(p)}u.length>0&&a.set(i,u)}return a}function yu(e){let t=Ka(e),r=new Map;for(let n of[...Array.isArray(e?.runnable)?e.runnable:[],...Array.isArray(e?.queue)?e.queue:[],...Array.isArray(e?.running)?e.running:[],...Array.isArray(e?.pr_wait)?e.pr_wait:[]])r.has(n.id)||r.set(n.id,n);return Array.from(r.values()).map(n=>({id:n.id,title:n.title,root_dir:n.root_dir,workspace_name:n.workspace_name,location:t.has(n.id)?(()=>{let s=t.get(n.id),o=In(s);return s.state?`${s.workspace_name} \xB7 ${o}`:o})():""}))}function vu(e,t){return Va(e,t)}var Za=new Set(["unavailable","not_applicable"]);function Dr(e,t){if(typeof e!="object"||e===null)return null;let r=e[t];return typeof r=="object"&&r!==null?r:null}function wu(e){return e.filter(t=>t!==null).join(" \xB7 ")}function Nr(e,t){return t===null?null:`${Mr[e]}: ${t.display} (${mo[t.source]})`}function Qa(e){return e.filter(t=>t!==null).join(`
`)}function Ao(e){if(typeof e!="object"||e===null)return null;let t=Jr(e);if(t==="")return null;let r=(n,s)=>typeof s=="string"&&s.length>0?`${n}: ${s}`:null;return{text:t,title:Qa(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",r("runner",e.runner),r(Mr.orchestration_model,e.model),r(Mr.orchestration_effort,e.effort),r(Mr.orchestration_speed,e.speed)])}}function nn(e,t){let r=Dr(e,"orchestration_model");if(r===null||r.resolution==="unavailable")return null;let n=Dr(e,"orchestration_effort"),s=Dr(e,"orchestration_speed"),o=wu([gr(t,r.value??""),r.display,n!==null&&n.value!==null?n.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Qa(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Nr("orchestration_model",r),Nr("orchestration_effort",n),Nr("orchestration_speed",s)])}}function Xm(e,t){return e===null||e.value===null||Za.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function Jm(e){return e===null||Za.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function eg(e){return e===null?null:e.value==="auto"?"auto":Za.has(e.resolution)?null:e.display}function qr(e,t){if(typeof e!="object"||e===null)return null;let r=Dr(e,"impl_dispatch"),n=Dr(e,"impl_runtime"),s=Dr(e,"impl_model"),o=Dr(e,"impl_effort"),a=Dr(e,"impl_speed"),i=r!==null&&r.value==="main"?"\uBA54\uC778":wu([Xm(n,t??null),Jm(s),eg(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Qa(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Nr("impl_dispatch",r),Nr("impl_runtime",n),Nr("impl_model",s),Nr("impl_effort",o),Nr("impl_speed",a)])}}var Xt="",tg=["impl_runtime","impl_model","impl_effort"],rg=5,So=1;function Cr(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Eo(e,t){let r=t.transport,n=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(E=>me(E,"error",4e3)),o={},a={},i=[],c=!1,u=null,d={},p="",m="",$=!1,T=!1,D=!1,H=null,se=!1;function V(){let E=t.queue?t.queue():null;return Cr(E)?E:null}function N(){let E=V();return E?E.runner_catalog:null}function P(){let E=V();return E&&Cr(E.execution_defaults)?E.execution_defaults:null}function I(){let E=t.implPresetStore?.get();return Cr(E)&&Array.isArray(E.presets)?E:null}function R(){return n===null?{}:{root_dir:n}}async function A(E,Q){return se||!r?null:await r(E,Q)}function M(E){E&&Cr(E.queue)&&t.onQueueAdopt?.(E.queue)}async function G(E,Q){let Ee=V();if(!Ee||se)return null;let re=await A(E,{...Q,...R(),expected_revision:Ee.revision});if(M(re),n!==null&&re&&re.conflict){let qe=re.queue&&typeof re.queue.revision=="number"?re.queue.revision:V()?.revision??Ee.revision;re=await A(E,{...Q,...R(),expected_revision:qe}),M(re)}return re}async function pe(){c=!0,Ie();try{let E=await A("get-session-defaults",{...R()});o=Cr(E?.values)?{...E.values}:{},a={...o},i=Array.isArray(E?.warnings)?E.warnings:[]}catch(E){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${E instanceof Error?E.message:String(E)}`)}finally{c=!1,Ie()}}async function fe(){let E=qc(o,a);if(Object.keys(E).length!==0){try{let Q=await A("set-session-defaults",{values:E,...R()});o=Cr(Q?.values)?{...Q.values}:{},a={...o},i=Array.isArray(Q?.warnings)?Q.warnings:[]}catch(Q){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}Ie()}}function _e(E,Q){if(tg.includes(E)){Te(E,Q);return}Q===Xt?delete a[E]:a[E]=Q,Ie(),fe()}function ae(){let E=Je().orchestration_model,Q=Qt({global:{orchestration_model:E??void 0},execution_defaults:P(),runner_catalog:N()}).orchestration_model.value;return Q?gr(N(),Q):null}function Le(E,Q){typeof Q=="string"&&Q.length>0?a[E]=Q:delete a[E]}function Te(E,Q){let Ee=Q===Xt?void 0:Q,re=Dc({impl_runtime:E==="impl_runtime"?Ee:a.impl_runtime,impl_model:E==="impl_model"?Ee:a.impl_model,impl_effort:E==="impl_effort"?Ee:a.impl_effort},N(),ae());Le("impl_runtime",re.impl_runtime),Le("impl_model",re.impl_model),Le("impl_effort",re.impl_effort),Ie(),fe()}async function ee(){let E=V();if(!E)return;let Q={orchestration_model:E.orchestration_model??null,orchestration_effort:E.orchestration_effort??null,orchestration_speed:E.orchestration_speed??null},Ee=Fc(Q,{...Q,...d});if(Object.keys(Ee).length!==0){try{let re=await G("worker-queue-set-orchestration-defaults",{values:Ee});if(re&&re.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}d={}}catch(re){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${re instanceof Error?re.message:String(re)}`)}Ie()}}function oe(E,Q){d[E]=Q===Xt?null:Q,Ie(),ee()}function xe(E){if(u=E,!E){Ie();return}let Q=N(),Ee=Je(),re=Ee.orchestration_model;re&&!os(Q,E).includes(re)&&(d.orchestration_model=null,re=null);let qe=Ee.orchestration_effort;qe&&!Da(Q,E,re||nr).includes(qe)&&(d.orchestration_effort=null),Ie(),ee()}async function g(E){if(!(!V()||E<So)){try{await G("worker-queue-set-slots",{slots:E})}catch(Q){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}Ie()}}async function j(E){if(!(!V()||E<So||E>rg)){try{await G("worker-queue-set-serial-lane-count",{count:E})}catch(Q){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}Ie()}}async function U(E,Q){let Ee=E==="auto_advance"?"worker-automation-toggle":E==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await G(Ee,{on:Q})}catch(re){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${re instanceof Error?re.message:String(re)}`)}Ie()}function K(){let E={},Q=Je();for(let Ee of uo){let re=Tr.includes(Ee)?Q[Ee]:a[Ee];typeof re=="string"&&re.length>0&&(E[Ee]=re)}return E}async function ge(){let E=I();if(!E)return;let Q=K();if(Object.keys(Q).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let Ee=(E.presets||[]).find(qe=>qe.id===p),re=m.trim()||(Ee?Ee.name:"");if(!re){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let qe=Ee?await A("impl-preset-update",{expected_revision:E.revision,id:Ee.id,name:re,settings:Q}):await A("impl-preset-create",{expected_revision:E.revision,name:re,settings:Q});if(qe&&qe.applied){if(m="",!Ee&&Array.isArray(qe.presets)){let rt=qe.presets.find(it=>it.name===re);p=rt?rt.id:p}Ie()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Ie()}catch(qe){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${qe instanceof Error?qe.message:String(qe)}`)}}async function we(){let E=I();if(!(!E||p.length===0))try{let Q=await A("impl-preset-delete",{expected_revision:E.revision,id:p});Q&&Q.applied?(p="",Ie()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Ie())}catch(Q){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}}function ke(E){o=Cr(E.values)?{...E.values}:{},a={...o},i=Array.isArray(E.warnings)?E.warnings:[],Cr(E.queue)&&(t.onQueueAdopt?.(E.queue),d={})}async function Ze(){let E=I(),Q=V();if(!E||!Q||p.length===0)return;let Ee=re=>({preset_id:p,expected_revision:E.revision,expected_queue_revision:re,...R()});try{let re=await A("apply-impl-preset-global",Ee(Q.revision));if(re&&re.applied&&ke(re),n!==null&&re&&re.queue_applied===!1){let qe=re.queue&&typeof re.queue.revision=="number"?re.queue.revision:V()?.revision??Q.revision;re=await A("apply-impl-preset-global",Ee(qe)),re&&re.applied&&ke(re)}re&&re.applied?re.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):re&&re.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(re){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${re instanceof Error?re.message:String(re)}`)}Ie()}async function wt(){T=!0,D=!1,Ie();try{let E=await A("get-worker-system-prompt",{});!E||typeof E!="object"||Array.isArray(E)?D=!0:H=E}catch{D=!0}finally{T=!1,Ie()}}function He(){if($=!$,$&&!H){wt();return}Ie()}function pt(){let E=Sn({loading:T,error:D});if(E)return E;if(!H)return"";let Q=Array.isArray(H.variants)?H.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${$?pt():""}
    </section>`}function Y(E,Q,Ee,re,qe,rt,it){let Xe=qe[E]??Xt,nt=Na(E,Ee,qe,P(),N(),it),_t=nt.options.find(at=>at.value===Xe),ht=Xe===Xt?nt.full_value:_t?.full_value;return l`<select
    ...
    </div>`}function Je(){let E=V(),Q={};for(let Ee of Tr)Q[Ee]=Object.prototype.hasOwnProperty.call(d,Ee)?d[Ee]:E&&typeof E[Ee]=="string"?E[Ee]:null;return Q}function yt(){let E=N(),Q=a.impl_runtime,Ee=a.impl_model,re=I(),qe=V(),rt=Je(),it=os(E,u),Xe=Tn(E,void 0).filter(he=>he!==nr),nt=Da(E,u,rt.orchestration_model||nr).filter(he=>he!==nr),_t=p?(re?.presets||[]).find(he=>he.id===p):null,ht=_t?Nc(K(),Cr(_t.settings)?_t.settings:{}):null,at=qe&&typeof qe.slots=="number"?qe.slots:So+1,kt=qe&&typeof qe.serial_lane_count=="number"?qe.serial_lane_count:So,q=P()?.supported===!0,te=Na("workflow_mode",ns,a,P(),E);return l`
  ...
  >
    ...
    />`)}function Eu(e){return`${e} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}function Tu(e){let t=(Array.isArray(e)?e:[]).map(i=>i&&i.usage).filter(i=>i&&typeof i=="object"&&"providers"in i);if(t.length>0)return zt(Vs(t));let r={};for(let i of kr)r[i]=0;let n=!1,s=0,o=0,a=0;for(let i of Array.isArray(e)?e:[]){let c=i&&i.usage;if(c&&typeof c=="object"){let u=!1;for(let d of kr){let p=c[d];typeof p=="number"&&Number.isFinite(p)&&(r[d]+=p,n=!0,u=!0)}if(u){o+=1;let d=c.total_cost_usd;typeof d=="number"&&Number.isFinite(d)&&(s+=d,a+=1)}}}return o>0&&a===o&&(r.total_cost_usd=s),n?$r(r):null}function hr(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function To(e,t){let r=hr(e?.counts)?e.counts:null,n=r?r[t]:null;return typeof n=="number"&&Number.isFinite(n)?n:0}function ng(e,t){if(!hr(t))return e;let r={...e};for(let[n,s]of Object.entries(t))s!==void 0&&(r[n]=s);return r}function sg(e){if(!hr(e)||!hr(e.execution_defaults)||!hr(e.runner_catalog)||!hr(e.session_defaults))return null;let t={...e.session_defaults};for(let a of["orchestration_model","orchestration_effort","orchestration_speed"])typeof e[a]=="string"&&e[a].length>0&&(t[a]=e[a]);let r=Qt({global:t,execution_defaults:e.execution_defaults,runner_catalog:e.runner_catalog}),n=gr(e.runner_catalog,r.orchestration_model.value??""),s=nn(r,e.runner_catalog),o=qr(r,n);return s===null&&o===null?null:{orchestration:s,worker:o}}function Cu(e,t){let r=t.notify||(g=>me(g,"error",4e3)),n=document.createElement("div");n.className="mon2-deck__main",e.appendChild(n);let s=document.createElement("div");s.className="mon2-deck__panel",s.hidden=!0;let o=document.createElement("div");o.className="mon2-deck__panel-hd";let a=document.createElement("span");a.className="mon2-deck__panel-title";let i=document.createElement("button");i.type="button",i.className="mon2-deck__panel-close",i.setAttribute("aria-label","\uC2E4\uD589 \uC124\uC815 \uB2EB\uAE30"),i.textContent="\u2715",o.append(a,i);let c=document.createElement("div");c.className="mon2-deck__panel-body",s.append(o,c),e.appendChild(s);let u=null,d=null,p=null,m=new Map;function $(){let g=t.workspacesState?t.workspacesState():[];return Array.isArray(g)?g.filter(j=>hr(j)):[]}function T(g){return $().find(j=>j.root_dir===g)||null}function D(g){return ng(T(g),m.get(g))}function H(){for(let g of $()){let j=m.get(g.root_dir);j&&typeof j.revision=="number"&&typeof g.revision=="number"&&g.revision>=j.revision&&m.delete(g.root_dir)}}async function se(g,j,U){let K=t.transport,ge=D(j);if(!(!K||!hr(ge))){try{let we=await K(g,{...U,root_dir:j,expected_revision:ge.revision});if(hr(we?.queue)&&m.set(j,we.queue),we&&we.conflict){let ke=hr(we.queue)&&typeof we.queue.revision=="number"?we.queue.revision:D(j)?.revision;we=await K(g,{...U,root_dir:j,expected_revision:ke}),hr(we?.queue)&&m.set(j,we.queue)}}catch(we){r(`\uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${we instanceof Error?we.message:String(we)}`)}ee()}}function V(g){u!==g&&(u=g,t.onFocusChange?.(u),ee())}function N(g){V(u===g?null:g)}function P(g){if(d===g){R();return}I(),d=g;let j=T(g);a.textContent=`${j?.name||g} \uC2E4\uD589 \uC124\uC815 \xB7 Worker \uD0ED \u2699 \uC2E4\uD589 \uD0ED\uACFC \uAC19\uC740 \uC800\uC7A5\uC18C`,s.hidden=!1,p=Eo(c,{root_dir:g,queue:()=>D(g),transport:t.transport,implPresetStore:t.implPresetStore,notify:r,onQueueAdopt:U=>{m.set(g,U),ee()}}),p.load(),ee()}function I(){p?.destroy(),p=null}function R(g){I(),d=null,s.hidden=!0,a.textContent="",g!==!0&&ee()}let A=()=>R();i.addEventListener("click",A);function M(g){g.key==="Escape"&&u!==null&&V(null)}document.addEventListener("keydown",M);function G(g,j){let U=Math.max(j,g,1);return l`<span
    ...
    >
      ...
      >
        ${Su()}
      </button>`}function fe(g){let j=sg(g);return j?l`<div class="mon2-deck__chips">
    ...
    </div>`}function Le(){let g=$();return g.length===0?"":l`<div class="mon2-deck__row">
      ${ae(g)}
      <div class="mon2-deck__strip">
        ${g.map(j=>_e(j))}
      </div>
    </div>`}function Te(){u!==null&&!T(u)&&(u=null,t.onFocusChange?.(null))}function ee(){H(),Te(),d!==null&&!T(d)&&R(!0),Ye(Le(),n),p?.render()}function oe(g){let j=g.target;if(!j||typeof j.closest!="function")return;let U=j.closest("[data-root-dir]");if(!U)return;let K=U.getAttribute("data-root-dir")||"",ge=j.closest("[data-act]")?.getAttribute("data-act");if(ge==="worker"){t.gotoWorkerTab?.(K);return}if(ge==="auto"){se("worker-automation-toggle",K,{on:D(K)?.auto_advance!==!0});return}if(ge==="merge"){se("worker-merge-auto-toggle",K,{on:D(K)?.auto_merge!==!0});return}if(ge==="gear"){P(K);return}N(K)}function xe(g){if(g.key!=="Enter"&&g.key!==" ")return;let j=g.target;if(!j||typeof j.closest!="function")return;let U=j.closest('[data-root-dir][role="button"]');!U||U!==j||(g.preventDefault(),N(U.getAttribute("data-root-dir")||""))}return n.addEventListener("click",oe),n.addEventListener("keydown",xe),{render:ee,focusRoot:()=>u,panelRoot:()=>d,destroy(){document.removeEventListener("keydown",M),n.removeEventListener("click",oe),n.removeEventListener("keydown",xe),i.removeEventListener("click",A),I(),Ye(l``,n),e.replaceChildren()}}}var Ru={running:3,paused:2,failed:1};function Lu(e,t){let r=Object.values(e||{}),n=new Set,s=new Map;for(let a of r)!a||typeof a.bead_id!="string"||(typeof a.resumed_from=="string"&&a.resumed_from.length>0&&n.add(a.resumed_from),s.set(a.bead_id,a.attempt_id));let o=new Map;for(let a of r){if(!a||typeof a.bead_id!="string"||a.bead_id.length===0)continue;let i=null;if(a.status==="running")i="running";else if(a.status==="paused"&&!n.has(a.attempt_id))i="paused";else if(a.status==="failed"||a.status==="orphaned"){let d=t.get(a.bead_id),p=typeof d=="number"&&d>0&&typeof a.finished_at=="number"&&d>=a.finished_at;s.get(a.bead_id)===a.attempt_id&&!p&&typeof a.dismissed_at!="number"&&(i="failed")}if(!i)continue;let c=typeof a.started_at=="number"?a.started_at:null,u=o.get(a.bead_id);if(u){let d=Ru[u.run_state],p=Ru[i];if(d>p||d===p&&(u.started_at??0)>(c??0))continue}o.set(a.bead_id,{attempt:a,run_state:i,started_at:c})}return{winners:o,resumed_from_ids:n}}var Iu=[{step:"merge",label:"\uBA38\uC9C0",index:1},{step:"base",label:"base",index:2},{step:"verify",label:"\uAC80\uC99D",index:3},{step:"deploy",label:"\uBC30\uD3EC",index:4},{step:"child",label:"\uC790\uC2DD",index:5},{step:"branch",label:"\uBE0C\uB79C\uCE58",index:6},{step:"close",label:"close",index:7}],ds=[{step:"base_containment",label:"base \uD3EC\uD568 \uD655\uC778"},{step:"repo_operations",label:"\uC800\uC7A5\uC18C \uC791\uC5C5"},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC"},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC"},{step:"parent_close",label:"\uBD80\uBAA8 close"}];function Co(e,t){let r=Iu.find(s=>s.step===e);if(!r)return null;let n=Iu.length;return{step:r.step,label:t,index:r.index,total:n,percent:Math.round(r.index/n*100)}}function Ou(e){let t=ds.findIndex(r=>r.step===e);return ds.map((r,n)=>({step:r.step,label:r.label,state:t<0?"todo":n<t?"done":n===t?"stall":"todo"}))}function sn(e){let t=ds.find(r=>r.step===e);return t?t.label:typeof e=="string"?e:""}function og(e){let t=ds.findIndex(r=>r.step===e);return t<0?null:{index:t+1,total:ds.length}}function Ro(e){let t=og(e);return t?`\uBA38\uC9C0 \uC644\uB8CC \xB7 \uC815\uB9AC ${t.total}\uB2E8\uACC4 \uC911 ${t.index}\uB2E8\uACC4\uC5D0\uC11C \uBA48\uCDA4`:"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644"}var Ja=new Set(["queued","running","retry_pending","repairing"]),Pu=new Set(["failed","succeeded"]),ag={queued:"\uB300\uAE30",running:"\uC911",retry_pending:"\uC7AC\uC2DC\uB3C4 \uB300\uAE30",repairing:"\uC790\uB3D9 \uD574\uACB0 \uC911",failed:"\uC2E4\uD328",succeeded:"\uC644\uB8CC \xB7 \uC815\uB9AC \uC7AC\uAC1C \uB300\uAE30"},ps={base_containment:{step:"base",label:"base \uD655\uC778 \uC911"},child_sweep:{step:"child",label:"\uC790\uC2DD \uC815\uB9AC \uC911"},branch_cleanup:{step:"branch",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC \uC911"},parent_close:{step:"close",label:"\uBD80\uBAA8 close \uC911"}},ig={merging:{step:"merge",label:"\uBA38\uC9C0 \uC911"},base_containment:ps.base_containment,child_sweep:ps.child_sweep,branch_cleanup:ps.branch_cleanup,parent_close:ps.parent_close};function lg(e){return typeof e=="string"&&/^[0-9a-f]{40}$/.test(e)}function cg(e,t,r){return!["verify","deploy"].includes(e.kind)||![...Ja,...Pu].includes(e.state)||![null,void 0,""].includes(e.superseded_by)||!Array.isArray(e.subjects)?!1:e.subjects.some(n=>n&&typeof n=="object"&&n.bead_id===t&&n.merged_sha===r)}function ug(e,t){let r=(t.kind==="deploy"?2:1)-(e.kind==="deploy"?2:1);if(r!==0)return r;let n=u=>u.state==="succeeded"?1:2,s=n(t)-n(e);if(s!==0)return s;let o=typeof e.requested_at=="number"?e.requested_at:0,a=typeof t.requested_at=="number"?t.requested_at:0;if(o!==a)return a-o;let i=typeof e.operation_id=="string"?e.operation_id:"",c=typeof t.operation_id=="string"?t.operation_id:"";return i.localeCompare(c)}function Xa(e,t=!1){let r=e.kind,n=r==="verify"?"\uAC80\uC99D":"\uBC30\uD3EC",s=t?"failed":e.state,o=ag[s];if(!o)return null;let a=Co(r,`${n} ${o}`);return a?{...a,active:Ja.has(s),failed:s==="failed"}:null}function dg(e){return!e||typeof e!="object"?null:ig[e.step]||null}function fs(e){if(!e||typeof e.bead_id!="string")return null;let t=e.bead_id,r=e.merge_progress&&typeof e.merge_progress=="object"?e.merge_progress:{},n=dg(r),s=e.cleanup_failed&&typeof e.cleanup_failed=="object"?e.cleanup_failed:null,o=["child_sweep","branch_cleanup","parent_close"].includes(typeof e.cleanup_cursor=="string"?e.cleanup_cursor:""),a=!o&&(e.cleanup_cursor==="repo_operations"||r.step==="repo_operations"),i=lg(e.merge_sha)?e.merge_sha:null,c=!o&&i&&Array.isArray(e.repo_operations)?e.repo_operations.filter(T=>T&&typeof T=="object"&&cg(T,t,i)).sort(ug):[],u=a?c:[],d=u.find(T=>Ja.has(T.state));if(d)return Xa(d);if(s)return s.step==="repo_operations"&&c[0]?Xa(c[0],!0):null;let p=u.find(T=>Pu.has(T.state)?T.state!=="succeeded"||e.cleanup_cursor==="repo_operations":!1);if(p)return Xa(p);if(n){let T=Co(n.step,n.label);return T?{...T,active:!0,failed:!1}:null}let m=typeof e.cleanup_cursor=="string"?ps[e.cleanup_cursor]:null;if(!m)return null;let $=Co(m.step,m.label);return $?{...$,active:!0,failed:!1}:null}function Lo(e){return!!e&&e.step!=="merge"&&e.failed!==!0}var Mu=1,_s=[{value:"repo_spec",label:"\uB808\uD3EC \xB7 spec \uC6B0\uC120"},{value:"repo_updated",label:"\uB808\uD3EC \xB7 \uCD5C\uC2E0 \uC218\uC815"},{value:"updated_flat",label:"\uCD5C\uC2E0 \uC218\uC815(\uB808\uD3EC \uBB34\uC2DC)"}],ei=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],On={show_blocked:!0,spec:"all"},Du={auto_merge:"\uC790\uB3D9 \uBA38\uC9C0",merged:"\uBA38\uC9C0",merge:"\uBA38\uC9C0",pr_stop:"PR \uC911\uB2E8",stopped:"\uC911\uB2E8",failed:"\uC2E4\uD328"};function pg(e,t){let r=null,n=-1/0;for(let s of Object.values(e)){if(!s||s.bead_id!==t||s.status==="running")continue;let o=typeof s.finished_at=="number"?s.finished_at:typeof s.started_at=="number"?s.started_at:0;o>=n&&(n=o,r=s)}return r}function fg(e,t){let{winners:r,resumed_from_ids:n}=Lu(e,t),s=new Map;for(let[o,a]of r){let i=a.attempt,c=a.run_state,u=a.started_at,d=typeof i.session_id=="string"&&i.session_id.length>0;s.set(o,{attempt_id:typeof i.attempt_id=="string"?i.attempt_id:"",run_state:c,started_at:u,last_event_at:typeof i.last_event_at=="number"?i.last_event_at:null,last_activity:i.last_activity&&typeof i.last_activity=="object"?i.last_activity:null,legs:Array.isArray(i.legs)?i.legs:[],runner:typeof i.runner=="string"?i.runner:null,model:typeof i.model=="string"?i.model:null,effort:typeof i.effort=="string"?i.effort:null,speed:typeof i.speed=="string"?i.speed:null,resumed_from:typeof i.resumed_from=="string"?i.resumed_from:null,continuation_mode:i.continuation_mode==="session"||i.continuation_mode==="fresh"?i.continuation_mode:null,status:typeof i.status=="string"?i.status:null,usage:lr(e,i.bead_id),can_pause:c==="running"&&d,can_resume:c!=="running"&&d&&!n.has(i.attempt_id)})}return s}function Nu(e,t){let r=e[t];if(!r)return"";if(r.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let n=typeof r.reason=="string"?r.reason:"",s=n.indexOf(":");return s>0&&s<n.length-1?`\u26D4 ${n.slice(0,s)} (${n.slice(s+1)})`:`\u26D4 ${n}`}function Rt(e){return e&&typeof e=="object"?e:{}}function _g(e,t,r){let n=Rt(t);if(Object.keys(n).length===0)return null;let s=e.execution_defaults,o=e.runner_catalog,a=e.session_defaults;if(!s||!o||!a)return null;let i=m=>Qt({pin:m,global:a,execution_defaults:s,runner_catalog:o,route:r}),c,u;try{c=i(n),u=i(null)}catch{return null}let d=qu(nn(c,o),nn(u,o)),p=qu(qr(c,null),qr(u,null));return d||p?{orchestration:d,worker:p}:null}function qu(e,t){return!e||t&&t.text===e.text?null:e}function mg(e){return{id:e.id,label:`\u{1F512} \uC120\uD589 ${e.id} (${e.location_label})`,title:`\uC774 \uC774\uC288\uB294 ${e.id}\uAC00 close\uB420 \uB54C\uAE4C\uC9C0 \uCD9C\uBC1C\uD558\uC9C0 \uC54A\uB294\uB2E4`}}function gg(e,t){let r=t.get(e);return r?{id:e,label:`\u2192 \uD6C4\uC18D ${e} (${In(r)})`,title:`\uC774 \uC774\uC288\uAC00 close\uB418\uBA74 ${e}\uAC00 \uC790\uAE30 \uB808\uD3EC \uD050\uC5D0\uC11C \uCD9C\uBC1C\uD55C\uB2E4`}:null}function hg(e,t,r){let n=new Map;for(let c of e)n.set(c,Array.from(r.get(c)||[]).filter(u=>e.includes(u)).length);let s=[],o=new Map,a=e.filter(c=>(n.get(c)||0)===0).sort();for(let c of a)o.set(c,0);let i=[...a];for(;i.length>0;){let c=i.shift();s.push(c);let u=Array.from(t.get(c)||[]).filter(p=>e.includes(p)).sort(),d=(o.get(c)||0)+(u.length>1?1:0);for(let p of u){let m=(n.get(p)||0)-1;n.set(p,m);let $=o.get(p);o.set(p,$===void 0?d:Math.min($,d)),m===0&&i.push(p)}}return{order:s,indent:o,cycle:s.length!==e.length}}function bg(e,t,r){let n=new Map,s=new Map,o=new Set,a=(u,d,p)=>{let m=u.get(d);m?m.add(p):u.set(d,new Set([p]))};for(let[u,d]of e)for(let p of d)p!==u&&(o.add(p),o.add(u),a(n,p,u),a(s,u,p));let i=new Set,c=[];for(let u of Array.from(o).sort()){if(i.has(u))continue;let d=[],p=[u];for(i.add(u);p.length>0;){let V=p.pop();d.push(V);for(let N of[...n.get(V)||[],...s.get(V)||[]])i.has(N)||(i.add(N),p.push(N))}if(d.length<2)continue;let m=d.map(V=>t.get(V));if(m.every(V=>!!V&&/^s[1-5]$/.test(V.lane||""))&&m.every(V=>V&&m[0]&&V.root_dir===m[0].root_dir&&V.lane===m[0].lane))continue;let{order:T,indent:D,cycle:H}=hg(d.slice().sort(),n,s),se=H?d.slice().sort():T;c.push({key:se.join("\0"),cycle:H,nodes:se.map(V=>{let N=t.get(V);return{id:V,workspace_name:N?N.workspace_name:"",root_dir:N?N.root_dir:"",location_label:N?In(N):yg(V,r),indent:H?0:D.get(V)||0}})})}return c}function yg(e,t){let r=Ya(e,t);return r==="internal"?"\uBBF8\uC801\uC7AC":r==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778"}function Fu(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function ti(e,t,r){let n=Array.isArray(e)?e:[],s=Array.isArray(t)?t:[],o=r&&typeof r.done_since=="number"?r.done_since:void 0,a={...On,...r&&r.candidate_filter?r.candidate_filter:{}},i=r&&_s.some(g=>g.value===r.candidate_sort)?r.candidate_sort:"repo_spec",c=new Map;for(let g of s)g&&typeof g.root_dir=="string"&&c.set(g.root_dir,g);let u=[],d=[],p=[],m=[],$=[],T=[],D=new Map,H=new Map,se=new Map,V=new Map,N=new Map;for(let g of n){if(!g||typeof g.root_dir!="string")continue;let j=g.root_dir,U=g.name||j,K=c.get(j),ge=K&&typeof K.revision=="number"?K.revision:typeof g.revision=="number"?g.revision:0,we=Rt(g.attempts),ke=Rt(g.bead_titles),Ze=Rt(g.bead_times),wt=Rt(g.pr_observations),He=Rt(g.admission),pt=Rt(g.revise_parked),st=Rt(g.merge_queue_state),Y=Rt(g.cleanup_failed),Z=Rt(g.discard_operations),Se=Rt(g.bead_blocked_by),Qe=Rt(g.bead_workflow),je=Rt(g.pr_activity),ot=Array.isArray(g.repo_operations)?g.repo_operations:[],Je=Array.isArray(g.merge_queue)?g.merge_queue:[],yt=new Set(Je.filter(q=>q&&typeof q.bead_id=="string").map(q=>q.bead_id)),Ie=new Map(Je.filter(q=>q&&typeof q.bead_id=="string").map(q=>[q.bead_id,q])),E=Array.isArray(g.queue)?g.queue:[],Q=(Array.isArray(g.serial_lanes)?g.serial_lanes:[]).filter(q=>q&&/^s[1-5]$/.test(q.id)&&Array.isArray(q.entries)),Ee=Rt(g.lane_states),re=typeof g.serial_lane_count=="number"?Math.max(0,Math.min(5,Math.floor(g.serial_lane_count))):Math.min(5,Q.length);se.set(j,re),V.set(j,E.length);let qe=new Map(Q.map(q=>[q.id,q])),rt=new Map;for(let q of Q)for(let te of q.entries)te&&typeof te.bead_id=="string"&&rt.set(te.bead_id,q.id);for(let[q,te]of Object.entries(Se))Array.isArray(te)&&N.set(q,te.filter(he=>typeof he=="string"&&he.length>0));let it=Array.isArray(g.done)?g.done:[];for(let q of it)q&&typeof q.bead_id=="string"&&T.push({id:q.bead_id,root_dir:j,workspace_name:U});let Xe=new Map;for(let q of it)q&&typeof q.bead_id=="string"&&typeof q.added_at=="number"&&Xe.set(q.bead_id,q.added_at);let nt=q=>({id:q,title:ke[q]||q,root_dir:j,workspace_name:U,expected_revision:ge,draggable:!1,...Rt(Ze[q]).created_at?{created_at:Rt(Ze[q]).created_at}:{},...Rt(Ze[q]).updated_at?{updated_at:Rt(Ze[q]).updated_at}:{}}),_t=new Set;for(let[q,te]of fg(we,Xe))_t.add(q),d.push({...nt(q),lane:"running",...rt.has(q)?{serial_lane_id:rt.get(q)}:{},attempt_id:te.attempt_id,run_state:te.run_state,status:te.status||void 0,workflow:Qe[q]||null,can_pause:te.can_pause,can_resume:te.can_resume,started_at:te.started_at,last_event_at:te.last_event_at,last_activity:te.last_activity,legs:te.legs,runner:te.runner,model:te.model,effort:te.effort,speed:te.speed,resumed_from:te.resumed_from,continuation_mode:te.continuation_mode,usage:te.usage,exec_chips:{orchestration:Ao(te),worker:null},discard:yr(Z,q,{attempt_id:te.attempt_id}),badges:te.run_state==="paused"?["\u23F8 \uC77C\uC2DC\uC815\uC9C0"]:te.run_state==="failed"?["\u26A0 \uC2E4\uD328"]:[],alert:te.run_state==="failed"});for(let q of Array.isArray(g.pr_wait)?g.pr_wait:[]){let te=q&&q.bead_id;if(typeof te!="string"||_t.has(te))continue;_t.add(te);let he=Rt(wt[te]),ze=Rt(he.pr),De=he.gate?Rt(he.gate):null,F=yt.has(te),ne=Ie.get(te)?.continuation_action||null,ve=!!ne&&ne.continuation===null,w=st.active===te,C=q.external===!0,B=Y[te]||null,ie=Rt(je[te]),Ce=fs({bead_id:te,merge_sha:q.merge_sha,cleanup_cursor:q.cleanup_cursor,merge_progress:ie.merge_progress||null,cleanup_failed:B,repo_operations:ot}),Ae=Lo(Ce),Pe=!!De&&De.base_badge==="\uCDA9\uB3CC",Be=!!B&&["child_sweep","branch_cleanup","parent_close"].includes(B.step)&&!!De&&De.tier==="merged",St=C&&!!B&&!!De&&De.tier==="merged",bt=!!De&&["closed_unmerged","review","undecidable"].includes(De.tier),Ke=yr(Z,te,{external:C,merge_active:w||Ce?.step==="merge",merge_queued:F,cleanup_active:Ae,merged:!!B||De?.tier==="merged"}),Ft=!!Ke.operation;p.push({...nt(te),lane:"pr_wait",pr_number:typeof ze.number=="number"?ze.number:null,pr_url:typeof ze.url=="string"?ze.url:void 0,external:C,usage:lr(we,te),merge_step:Ce,badges:ve?["\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694"]:Ce?[De?.tier==="merged"?"\uBA38\uC9C0\uB428":"\uBA38\uC9C0 \uC911"]:B?[sn(B.step)?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${sn(B.step)}`:"\uC815\uB9AC \uBA48\uCDA4"]:typeof De?.gate_badge=="string"&&De.gate_badge.length>0?[De.gate_badge]:[],alert:Ce?Ce.failed===!0:!!B||bt,reason:B&&Ce?.active!==!0?Ro(B.step):"PR \uB300\uAE30",merge_action:De?.tier==="merged"&&!Be&&!St?!1:!F||ve,merge_enabled:!Ft&&(ve||De?.enabled===!0||Pe||Be||St),merge_label:ve?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":St||Be?"\uC815\uB9AC \uC7AC\uAC1C":Pe&&!Be?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:ve?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":Ft?Ke.error?`\uD3D0\uAE30 \uC2E4\uD328: ${Ke.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${Ke.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:St?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Be?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Pe?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":De?.enabled===!0?`\uBA38\uC9C0 (${De.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4`:`\uBA38\uC9C0 \uBD88\uAC00: ${De?.reason||"\uAD00\uCE21 \uB300\uAE30"}`,cancel_action:F&&!ve,cancel_enabled:!w,continuation_mismatch:ne?.mismatch||null,discard:Ke,discard_action:Ke.action,discard_enabled:Ke.enabled,discard_title:Ke.title})}let ht=(q,te,he,ze)=>{let De=q&&q.bead_id;if(typeof De!="string"||_t.has(De))return null;_t.add(De);let F=pt[De],ne=yr(Z,De),ve=ne.operation?ne:null,w={...nt(De),lane:te,draggable:!ve,discard:ve||void 0,reason:Nu(He,De),seq:he+1,queue_position:he+1,queue_index:he,queue_length:ze,badges:F?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!F,revise_action:!!F,revise_enabled:!!F&&!ve,revise_title:F?F.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${F.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(Se,De)&&(w.blocked_by=Array.isArray(Se[De])?Se[De].filter(C=>typeof C=="string"&&C.length>0):[]),w};for(let q=0;q<E.length;q++){let te=ht(E[q],"queue",q,E.length);if(!te)continue;m.push(te);let he=D.get(j);he?he.push(te):D.set(j,[te])}let at=[];for(let q=0;q<Math.max(re,Q.length);q++){let te=`s${q+1}`,he=qe.get(te),ze=he&&Array.isArray(he.entries)?he.entries:[],De=[];for(let ve=0;ve<ze.length;ve++){let w=ht(ze[ve],te,ve,ze.length);w&&(De.push(w),m.push(w))}let F=Rt(Ee[te]),ne=Array.isArray(F.occupied_by)?F.occupied_by.filter(ve=>typeof ve=="string"):[];De.length===0&&ne.length===0&&(re<=1||q>=re)||at.push({id:te,index:q,items:De,raw_length:ze.length,occupied_by:ne,corrections:Array.isArray(F.corrections)?F.corrections.length:0,cycle:F.cycle===!0,...De.length===0&&ne.length===0?{empty:!0}:{}})}H.set(j,at);let kt=Array.from({length:re},(q,te)=>{let he=`s${te+1}`,ze=qe.get(he),De=ze&&Array.isArray(ze.entries)?ze.entries:[],F=Rt(Ee[he]);return{id:he,index:De.length,length:De.length,occupied_by:Array.isArray(F.occupied_by)?F.occupied_by.filter(ne=>typeof ne=="string"):[]}});for(let q of Array.isArray(g.runnable)?g.runnable:[]){let te=q&&q.bead_id;if(typeof te!="string"||_t.has(te))continue;_t.add(te);let he=q.workflow&&typeof q.workflow=="object"?q.workflow:null,ze=he&&typeof he.route=="string"&&he.route||(typeof q.route=="string"?q.route:null),De=_g(Rt(K),q.exec_pins,ze);Array.isArray(q.blocked_by)&&q.blocked_by.length>0&&N.set(te,q.blocked_by.filter(F=>typeof F=="string"&&F.length>0)),u.push({...nt(te),title:q.title||ke[te]||te,lane:"runnable",draggable:!0,reason:Nu(He,te),created_at:q.created_at??void 0,updated_at:q.updated_at??void 0,status:typeof q.status=="string"?q.status:void 0,labels:Array.isArray(q.labels)?q.labels:[],spec_id:typeof q.spec_id=="string"?q.spec_id:"",workflow:he||(ze?{route:ze,chips:{route:ze}}:null),...De?{exec_chips:De}:{},blocked:q.blocked===!0,...Array.isArray(q.blocked_by)?{blocked_by:q.blocked_by.filter(F=>typeof F=="string"&&F.length>0)}:{},place_index:E.length,place_lanes:kt})}for(let q of it){let te=q&&q.bead_id;if(typeof te!="string"||_t.has(te)||(_t.add(te),o!==void 0&&typeof q.added_at=="number"&&q.added_at<o))continue;let he=pg(we,te),ze=he&&typeof he.done_kind=="string"?he.done_kind:null;$.push({...nt(te),lane:"done",done:!0,done_layout:"three_line",usage:lr(we,te),work_ms:yo(we,te),done_at:typeof q.added_at=="number"?q.added_at:void 0,done_kind:ze,badges:ze&&Du[ze]?[Du[ze]]:[]})}}let P=new Map;s.forEach((g,j)=>{g&&typeof g.root_dir=="string"&&P.set(g.root_dir,j)});let I=r&&r.running_sort==="repo"?"repo":"started";d.sort((g,j)=>{if(I==="repo"){let ge=P.get(g.root_dir)??Number.MAX_SAFE_INTEGER,we=P.get(j.root_dir)??Number.MAX_SAFE_INTEGER;if(ge!==we)return ge-we}let U=typeof g.started_at=="number"&&Number.isFinite(g.started_at)?g.started_at:null,K=typeof j.started_at=="number"&&Number.isFinite(j.started_at)?j.started_at:null;return U!==null&&K!==null&&U!==K?U-K:U===null&&K!==null?1:U!==null&&K===null?-1:g.id.localeCompare(j.id)}),$.sort((g,j)=>(j.done_at??0)-(g.done_at??0));let R=s.length>0?s:n.map(g=>({root_dir:g&&g.root_dir,name:g&&g.name,auto_advance:g&&g.auto_advance,auto_merge:g&&g.auto_merge,slots:g&&g.slots,revision:g&&g.revision,runner_catalog:g&&g.runner_catalog})),A=new Set(u.map(g=>g.root_dir)),M=[];for(let g of R){if(!g||typeof g.root_dir!="string")continue;let j=D.get(g.root_dir)||[],U=H.get(g.root_dir)||[];!(j.length>0||U.some(ge=>ge.items.length>0||ge.occupied_by.length>0))&&!A.has(g.root_dir)||M.push({root_dir:g.root_dir,name:g.name||g.root_dir,auto_advance:g.auto_advance===!0,auto_merge:g.auto_merge===!0,slots:typeof g.slots=="number"&&g.slots>=Mu?g.slots:Mu,revision:typeof g.revision=="number"?g.revision:0,runner_catalog:Rt(g.runner_catalog),items:j,sublanes:{parallel:j,serial:U},serial_lane_count:se.get(g.root_dir)||0,raw_queue_length:V.get(g.root_dir)||0})}let G={runnable:u,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:i==="updated_flat",queue:m,queue_groups:M,running:d,pr_wait:p,done:$,chains:[]},pe=Ka(G);for(let g of T)pe.has(g.id)||pe.set(g.id,{root_dir:g.root_dir,workspace_name:g.workspace_name,lane:"done",state:"done"});let fe=new Map;for(let[g,j]of N)for(let U of j){let K=fe.get(U);K?K.includes(g)||K.push(g):fe.set(U,[g])}for(let g of[...G.queue,...G.runnable]){if(!Object.hasOwn(g,"blocked_by"))continue;let j=pe.get(g.id);g.blockers=(g.blocked_by||[]).map(U=>hu(U,j,pe,s)),g.blocker_warnings=g.blockers.filter(U=>U.missing_internal).map(U=>`\u26A0 \uC120\uD589 ${U.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),g.blocker_warnings.length>0&&(g.alert=!0)}for(let g of[...G.queue,...G.runnable,...G.running,...G.pr_wait]){let j=g.lane==="running"||g.lane==="pr_wait"?[]:(g.blockers||[]).map(mg),U=[];for(let we of fe.get(g.id)||[]){let ke=gg(we,pe);ke&&U.push(ke)}let K=g.lane==="running"||g.lane==="pr_wait"?[]:g.blocker_warnings||[];if(j.length===0&&U.length===0&&K.length===0)continue;let ge={predecessors:j,successors:U,warnings:K};g.dependency_chips=ge}G.chains=bg(N,pe,s);let _e=bu(G.queue_groups);for(let g of G.queue_groups)for(let j of g.sublanes.serial){let U=_e.get(vu(g.root_dir,j.id));U&&(j.cross_wait_peers=U)}let ae=G.runnable.length,Le=G.runnable;a.show_blocked||(Le=Le.filter(g=>g.blocked!==!0));let Te=Le.length;a.spec==="with"?Le=Le.filter(g=>!!g.spec_id):a.spec==="without"&&(Le=Le.filter(g=>!g.spec_id)),G.runnable_hidden={blocked:ae-Te,spec:Te-Le.length};let ee=(g,j)=>{let U=Fu(j.updated_at)-Fu(g.updated_at);return U!==0?U:g.id.localeCompare(j.id)},xe=i==="repo_spec"?(g,j)=>{let U=g.spec_id?0:1,K=j.spec_id?0:1;return U!==K?U-K:ee(g,j)}:ee;if(i==="updated_flat")G.runnable=Le.slice().sort(ee),G.runnable_sections=[];else{let g=new Map;for(let K of Le){let ge=g.get(K.root_dir);ge?ge.push(K):g.set(K.root_dir,[K])}let j=[],U=[];for(let K of R){if(!K||typeof K.root_dir!="string")continue;let ge=(g.get(K.root_dir)||[]).slice().sort(xe);g.delete(K.root_dir),ge.length!==0&&(j.push({root_dir:K.root_dir,name:K.name||K.root_dir,items:ge.map(we=>({...we,workspace_name:""}))}),U.push(...ge))}for(let[K,ge]of g){let we=ge.slice().sort(xe);j.push({root_dir:K,name:we[0]?.workspace_name||K,items:we.map(ke=>({...ke,workspace_name:""}))}),U.push(...we)}G.runnable=U,G.runnable_sections=j}return G}var Uu="bdui.monitor.done-range",Wu="bdui.monitor.running_sort",zu="bdui.monitor.candidate_sort",Hu="beads-ui.monitor.candidate-filter",Gu="beads-ui.monitor.sections";function vg(){try{let e=window.localStorage.getItem(Hu);if(!e)return{...On};let t=JSON.parse(e);return!t||typeof t!="object"?{...On}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:On.show_blocked,spec:ei.some(r=>r.value===t.spec)?t.spec:"all"}}catch{return{...On}}}function ju(e){try{window.localStorage.setItem(Hu,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function wg(){try{let e=window.localStorage.getItem(zu);return _s.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function kg(e){try{window.localStorage.setItem(zu,e)}catch{}}function $g(){try{let e=window.localStorage.getItem(Gu);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Bu(e){try{window.localStorage.setItem(Gu,JSON.stringify(e))}catch{}}function xg(){try{let e=window.localStorage.getItem(Uu);return ar(e)?e:er}catch{return er}}function Ag(e){try{window.localStorage.setItem(Uu,e)}catch{}}function Sg(){try{return window.localStorage.getItem(Wu)==="repo"?"repo":"started"}catch{return"started"}}function Eg(e){try{window.localStorage.setItem(Wu,e)}catch{}}var Vu="tab:monitor:pipeline",Tg=1e3,Cg=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}];function Rg(){return l`<span class="mon-link mon-popover-owner">
    <button
      type="button"
    ...
    <span class="mon-link__popover mon-card-popover" role="dialog" hidden>
  ...
  </span>`}function Ku(e,t){let r=Ct("views:monitor"),n=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.switchWorkspace,c=t.router,u=t.now||(()=>Date.now()),d=t.confirm||(v=>typeof globalThis.confirm!="function"||globalThis.confirm(v)),p=xg(),m=Sg(),$=vg(),T=wg(),D=$g(),H=null,se=null,V=null;function N(){let v=Rr.find(y=>y.value===p);return v?v.label:""}let P=document.createElement("div");P.className="mon",e.appendChild(P);let I=document.createElement("div");I.className="mon2-drawer",e.appendChild(I);let R=ti(null,null),A=new Map,M=new Map,G=null,pe=null,fe=null,_e=En(I,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{H=null,je()}});async function ae(v,y,L,X,be=!0){if(!o||!L)return null;let ye=await o(v,{...y,root_dir:L,expected_revision:X});if(ye&&ye.conflict&&be){ye.queue&&M.set(L,ye.queue);let Ne=ye.queue&&typeof ye.queue.revision=="number"?ye.queue.revision:X;ye=await o(v,{...y,root_dir:L,expected_revision:Ne})}return ye&&ye.queue&&L&&M.set(L,ye.queue),ye}function Le(v,y){let L=M.get(v),X=s&&s.get?s.get():null,be=(Array.isArray(X)?X:[]).find(Ne=>Ne?.root_dir===v);return(L||be)?.merge_queue?.find(Ne=>Ne.bead_id===y)?.continuation_action}async function Te(v,y,L,X){let be=await ae(v,y,L,X),ye=M.get(L)?.revision??be?.queue?.revision??X;return wr(be,(Ne,Me)=>ae(v,{...y,continuation:Ne,decision_token:Me},L,ye,!1),{refresh:Ne=>ae(v,y,L,Ne?.queue?.revision??M.get(L)?.revision??ye,!1)})}async function ee(v,y,L,X){let be=await wr({continuation_mismatch:X},(Ne,Me)=>ae("worker-merge-queue-add",{bead_id:y,continuation:Ne,decision_token:Me},v,L,!1)),ye=be?.queue?.merge_queue?.find(Ne=>Ne.bead_id===y)?.continuation_action;be?.applied!==!0&&ye?.continuation===null&&ye.mismatch&&await ee(v,y,be.queue.revision,ye.mismatch)}async function oe(v,y,L){let X=await ae("worker-discard",v,y,L);if(X&&X.discarded===!0){me(wo(X),"success",5e3);return}if(X&&X.reason){me(`\uD3D0\uAE30 \uC2E4\uD328: ${X.reason}`,"error");return}if(X&&X.accepted&&X.pending==="merged_revert"){me("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(X&&X.accepted){me(`\uD3D0\uAE30 \uC9C4\uD589: ${X.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}X&&!X.conflict&&me("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function xe(v,y,L){return!o||!L?null:await o(v,{...y,root_dir:L})}async function g(){let v=new Map;for(let y of R.pr_wait)v.has(y.root_dir)||v.set(y.root_dir,y.expected_revision);for(let[y,L]of v)await ae("worker-merge-queue-add-all",{},y,L)}function j(v,y){let L=D[v];return!!(L&&L[y]===!0)}function U(v,y){let L={...D[v]||{}};L[y]=!L[y],D={...D,[v]:L},Bu(D),je()}function K(v){let y=j(v.root_dir,v.section);return l`<header class="mon2-sec__hd">
      <button
        type="button"
      ...
      ${y}
      <span class="mon2-item__ops">${Rg()}</span>
    ...
    >
    ...
    </section>`}function st(){if(R.chains.length===0)return"";let v=D.chains===!0;return l`<section class="mon2-chains${v?" is-collapsed":""}">
      ...
      <div class="worker-lanes mon2-lanes">
        ${Cg.map(L=>{let X=y[L.lane],be=L.lane==="runnable"?R.runnable_flat?X.length>0?wt():void 0:R.runnable_sections.length>0?wt():void 0:L.lane==="queue"?R.queue_groups.length>0||R.chains.length>0?l`${st()}${R.queue_groups.map(ye=>pt(ye))}`:void 0:L.lane==="running"?Y(v):X.length>0?l`${X.map(ye=>Ln(ye))}`:void 0;return sr({id:`monitor-${L.lane}`,lane:L.pane,title:L.lane==="done"?`\uC644\uB8CC\xB7${N()}`:L.title,items:X,empty:L.empty,body:be,live:L.lane==="running"&&X.length>0,controls:L.lane==="runnable"?Se():void 0,header_control:Qe(L.lane,X.length)})})}
  ...
  `,e.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),a=r.querySelector("#new-priority"),i=r.querySelector("#new-labels"),c=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),d=r.querySelector("#btn-cancel"),p=r.querySelector("#btn-create"),m=r.querySelector(".new-issue__close");function $(){o.replaceChildren();let I=document.createElement("option");I.value="",I.textContent="\u2014 Select \u2014",o.appendChild(I);for(let R of Zu){let A=document.createElement("option");A.value=R,A.textContent=Qu(R),o.appendChild(A)}a.replaceChildren();for(let R=0;R<=4;R+=1){let A=document.createElement("option");A.value=String(R);let M=Xu[R]||"Medium";A.textContent=`${R} \u2013 ${M}`,a.appendChild(A)}}$();function T(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function D(I){s.disabled=I,o.disabled=I,a.disabled=I,i.disabled=I,c.disabled=I,d.disabled=I,p.disabled=I,p.textContent=I?"Creating\u2026":"Create"}function H(){u.textContent=""}function se(I){u.textContent=I}function V(){try{let I=window.localStorage.getItem("beads-ui.new.type");I?o.value=I:o.value="";let R=window.localStorage.getItem("beads-ui.new.priority");R&&/^\d$/.test(R)?a.value=R:a.value="2"}catch{o.value="",a.value="2"}}function N(){let I=o.value||"",R=a.value||"";I.length>0&&window.localStorage.setItem("beads-ui.new.type",I),R.length>0&&window.localStorage.setItem("beads-ui.new.priority",R)}async function P(){H();let I=String(s.value||"").trim();if(I.length===0){se("Title is required"),s.focus();return}let R=Number(a.value||"2");if(!(R>=0&&R<=4)){se("Priority must be 0..4"),a.focus();return}let A=String(o.value||""),M=String(c.value||""),G={title:I};A.length>0&&(G.type=A),String(R).length>0&&(G.priority=R),M.length>0&&(G.description=M),D(!0);try{await t("create-issue",G)}catch{D(!1),se("Failed to create issue");return}N(),D(!1),T()}return r.addEventListener("cancel",I=>{I.preventDefault(),T()}),m.addEventListener("click",()=>T()),d.addEventListener("click",()=>T()),r.addEventListener("keydown",I=>{I.key==="Enter"&&(I.ctrlKey||I.metaKey)&&(I.preventDefault(),P())}),n.addEventListener("submit",I=>{I.preventDefault(),P()}),{open(){n.reset(),H(),V();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){T()}}}var Lg=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Ig(e,t){return ea(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function ed(e,t,r){return l`
    <section class="settings-dialog__group">
      ...
      ${t.length===0?l`<div class="settings-dialog__empty">라벨 없음</div>`:l`<div class="settings-dialog__pills">
            ${t.map(n=>{let s=Ig(n,e);return l`<button
                type="button"
  ...
  `}function rd(e,t){return l`
    <section class="settings-dialog__group">
      ...
      <div class="settings-dialog__toggles">
        ${Lg.map(([r,n])=>l`<label class="settings-dialog__toggle">
              <input
                type="checkbox"
                data-chip=${r}
                .checked=${e.chips[r]!==!1}
  ...
  `}var Og=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function nd(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(ae=>me(ae,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,u="",d=null;function p(){if(d)return d;let ae=a.querySelector('[data-pane="execution"]');return ae?(d=Eo(ae,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:r,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:Le=>t.queueStore?.set?.(Le)}),d):null}function m(){return l`
      <section
    ...
    `}function $(){let ae=n.get();return l`
      <section
      ...
      >
        ...
        ${ae?l`
              ${ed(ae,s(),se)}
              ${td(ae,u,{onDraft:Le=>{u=Le},onAdd:V,onRemove:N})}
              ${rd(ae,P)}
            `:l`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function T(ae){let Le=n.get();if(Le)try{let Te=await r("display-policy-set",{expected_revision:Le.revision,policy:ae(Le)});D(Te),Te&&Te.conflict&&Te.policy&&(Te=await r("display-policy-set",{expected_revision:Te.policy.revision,policy:ae(Te.policy)}),D(Te)),Te&&Te.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function D(ae){ae&&ae.policy&&typeof ae.policy=="object"&&n.set(ae.policy)}function H(ae){T(ae)}function se(ae){let Le=n.get();if(!Le)return;let Te=!Pg(ae,Le);H(ee=>Mg(ae,ee,Te))}function V(){let ae=u.trim();ae.length!==0&&(u="",H(Le=>Le.hidden_prefixes.includes(ae)?{hidden_prefixes:Le.hidden_prefixes}:{hidden_prefixes:[...Le.hidden_prefixes,ae]}),I())}function N(ae){H(Le=>({hidden_prefixes:Le.hidden_prefixes.filter(Te=>Te!==ae)}))}function P(ae){let Le=n.get();if(!Le)return;let Te=Le.chips[ae]===!1;H(()=>({chips:{[ae]:Te}}))}function I(){Ye(l`
      ...
      `,a),p()}function R(ae){i=ae,I()}let A=()=>{c=!1,t.onOpenChange?.(!1)};a.addEventListener("close",A),a.addEventListener("cancel",A);let M=ae=>{ae.target===a&&_e()};a.addEventListener("click",M);let G=null;n.subscribe&&(G=n.subscribe(()=>{c&&I()}));let pe=null;t.implPresetStore?.subscribe&&(pe=t.implPresetStore.subscribe(()=>{c&&d?.render()}));function fe(ae="execution"){c||(c=!0,t.onOpenChange?.(!0),i=ae,u="",I(),typeof a.showModal=="function"?a.showModal():a.setAttribute("open",""),p()?.load())}function _e(){c&&(c=!1,t.onOpenChange?.(!1),typeof a.close=="function"?a.close():a.removeAttribute("open"))}return{open:fe,close:_e,sessionDraft:()=>d?.sessionDraft()??{},destroy(){c=!1,a.removeEventListener("close",A),a.removeEventListener("cancel",A),a.removeEventListener("click",M),G&&(G(),G=null),pe&&(pe(),pe=null),d?.destroy(),d=null,a.remove()}}}function Pg(e,t){return t.visible_labels.includes(e)?!0:t.hidden_labels.includes(e)?!1:!t.hidden_prefixes.some(r=>r.length>0&&e.startsWith(r))}function Mg(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}var Dg=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],sd="usage-meter-card",Ng="usage-meter-layer",od=600,qg=["token_expired","relogin_required"];function ad(e){return String(e).padStart(2,"0")}function Fg(e,t){let r=Math.max(0,Math.ceil((e-t)/6e4)),n=Math.floor(r/1440),s=Math.floor(r%1440/60),o=r%60;return n>0?`${n}d${s>0?` ${s}h`:""}`:s>0?`${s}h${o>0?` ${o}m`:""}`:`${o}m`}function id(e,t=Date.now()){let r=Date.parse(e);if(!Number.isFinite(r))return"";let n=new Date(r),s=new Date(t),o=`${ad(n.getHours())}:${ad(n.getMinutes())}`,i=n.getFullYear()===s.getFullYear()&&n.getMonth()===s.getMonth()&&n.getDate()===s.getDate()?o:`${Dg[n.getMonth()]} ${n.getDate()} ${o}`;return`${Fg(r,t)} \xB7 ${i}`}function jg(e){let t=Math.max(0,Math.floor(e));return t<60?`${t}\uCD08 \uC804`:t<3600?`${Math.floor(t/60)}\uBD84 \uC804`:`${Math.floor(t/3600)}\uC2DC\uAC04 \uC804`}function ld(e){return e>=85?"usage-meter__window--danger":e>=60?"usage-meter__window--warn":"usage-meter__window--success"}function cd(e){let t=typeof e=="number"&&Number.isFinite(e)?e:0;return Math.min(100,Math.max(0,t))}var ud=[{key:"claude",label:"Claude",endpoint:"/api/claude-usage",switch_endpoint:"/api/claude-account/switch",tool:"cswap"},{key:"codex",label:"Codex",endpoint:"/api/codex-usage",switch_endpoint:"/api/codex-account/switch",tool:"codex-auth"}];function pd(e){let t=[];for(let r of e){if(!r||typeof r!="object")continue;let n=r;typeof n.key!="string"||n.key.length===0||typeof n.pct!="number"||!Number.isFinite(n.pct)||t.push({key:n.key,pct:n.pct,resetsAt:typeof n.resetsAt=="string"?n.resetsAt:""})}return t}function Bg(e){if(!e||typeof e!="object")return null;let t=e;return!Number.isInteger(t.number)||t.number<=0||typeof t.email!="string"||t.email.length===0||typeof t.status!="string"||t.status.length===0||typeof t.active!="boolean"||!Array.isArray(t.windows)?null:{number:t.number,email:t.email,alias:typeof t.alias=="string"&&t.alias.length>0?t.alias:null,plan:typeof t.plan=="string"&&t.plan.length>0?t.plan:null,active:t.active,status:t.status,windows:pd(t.windows),fetchedAt:typeof t.fetchedAt=="string"?t.fetchedAt:null,ageSeconds:typeof t.ageSeconds=="number"&&Number.isFinite(t.ageSeconds)?t.ageSeconds:null}}function Ug(e){if(!e||typeof e!="object")return null;let t=e,r=[];if(Array.isArray(t.accounts))for(let s of t.accounts){let o=Bg(s);o&&r.push(o)}let n=t.available===!0&&Array.isArray(t.windows);return!n&&r.length===0?null:{available:n,windows:n?pd(t.windows):[],ageSeconds:typeof t.ageSeconds=="number"&&Number.isFinite(t.ageSeconds)?t.ageSeconds:null,accounts:r}}function dd(e,t){return`${e}:${t}`}function fd(e){let t=!1,r=null,n=new Map,s=null,o=new Map,a=new Map,i=0,c=null;function u(){Ye(l``,e),e.hidden=!0,p()}function d(){if(c===null){let ee=e.ownerDocument;c=ee.createElement("div"),c.id=Ng,c.className="usage-meter__layer",ee.body.appendChild(c)}return c}function p(){c!==null&&(Ye(l``,c),c.remove(),c=null)}function m(ee){r!==ee&&(r===null&&(document.addEventListener("mousedown",T),document.addEventListener("keydown",H),window.addEventListener("resize",D)),r=ee)}function $(){r!==null&&(r=null,document.removeEventListener("mousedown",T),document.removeEventListener("keydown",H),window.removeEventListener("resize",D))}function T(ee){let oe=ee.target;oe&&(e.contains(oe)||c!==null&&c.contains(oe))||($(),_e())}function D(){_e()}function H(ee){ee.key==="Escape"&&($(),_e())}function se(ee){r===ee?$():m(ee),_e()}function V(){$(),_e()}async function N(ee,oe){if(n.has(ee.key))return;let xe=dd(ee.key,oe);n.set(ee.key,oe),a.delete(xe),_e();let g=null;try{g=await(await fetch(ee.switch_endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({number:oe})})).json()}catch{g=null}if(t)return;if(n.delete(ee.key),!g||g.ok!==!0){let U=g&&typeof g.error=="string"&&g.error.length>0?g.error:"network_error";a.set(xe,{kind:"error",text:`\uC804\uD658 \uC2E4\uD328 \u2014 ${U}`}),_e();return}let j=Array.isArray(g.warnings)?g.warnings.filter(U=>typeof U=="string"&&U.length>0):[];j.length>0&&a.set(xe,{kind:"warn",text:j.join(" \xB7 ")}),_e(),await Te()}function P(ee,oe,xe,g){let j=cd(ee.pct),K=`resets ${id(ee.resetsAt,g)}${oe?` \xB7 ${xe}`:""}`;return l`<span
    ...
    </span>`}function I(ee,oe,xe){let g=oe.available&&typeof oe.ageSeconds=="number"&&oe.ageSeconds>od,j=g&&typeof oe.ageSeconds=="number"?`${Math.floor(oe.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",U=oe.accounts.filter(ke=>!ke.active).length,K=`usage-meter__group${g?" usage-meter__group--stale":""}`,ge=l`<span class="usage-meter__provider"
        >${ee.label}</span
      >
      ${oe.available?oe.windows.map(ke=>P(ke,g,j,xe)):l`<span class="usage-meter__empty">사용량 없음</span>`}
    ...
    >
      ...
      ${ee.map(xe=>I(xe.provider,xe.snapshot,oe))}
    ...
    >
      ...
      <div class="usage-meter__account-head">
        ...
        ${oe.ageSeconds===null?"":l`<span class="usage-meter__account-age"
              >${jg(oe.ageSeconds)}</span
            >`}
        ${oe.active?"":l`<button
              type="button"
              class="usage-meter__switch"
              ?disabled=${ge}
              @click=${()=>{N(ee,oe.number)}}
            >
              ${we?"\uC804\uD658 \uC911\u2026":"\uC804\uD658"}
            </button>`}
      </div>
    ...
    >
    ...
    </div>`}function _e(){let ee=[];for(let g of ud){let j=o.get(g.key);j&&ee.push({provider:g,snapshot:j})}if(ee.length===0){$(),u();return}let oe=ee.find(g=>g.provider.key===r&&g.snapshot.accounts.length>0);oe||$();let xe=Date.now();Ye(R(ee,xe),e),e.hidden=!1,oe?ae(oe,xe):p()}function ae(ee,oe){let xe=d(),g=e.getBoundingClientRect(),j=e.ownerDocument.documentElement.clientWidth;xe.style.setProperty("--usage-meter-anchor-top",`${g.bottom}px`),xe.style.setProperty("--usage-meter-anchor-right",`${Math.max(0,j-g.right)}px`),Ye(l`<div
          class="usage-meter__scrim"
          aria-hidden="true"
          @mousedown=${V}
        ></div>
        ${fe(ee,oe)}`,xe)}async function Le(ee){try{let oe=await fetch(ee.endpoint);return oe.ok?Ug(await oe.json()):null}catch{return null}}async function Te(){i+=1;let ee=i,oe=await Promise.all(ud.map(async xe=>({provider:xe,snapshot:await Le(xe)})));if(!(t||ee!==i)){for(let xe of oe)xe.snapshot?o.set(xe.provider.key,xe.snapshot):o.delete(xe.provider.key);_e()}}return u(),Te(),s=setInterval(()=>{Te()},6e4),{destroy(){t=!0,s!==null&&(clearInterval(s),s=null),$(),u()}}}function _d(e){let t=e.attempts?Object.values(e.attempts):[],r=new Map;for(let s of t)s&&r.set(s.bead_id,s.attempt_id);let n=new Map;for(let s of e.done||[])s&&typeof s.bead_id=="string"&&typeof s.added_at=="number"&&n.set(s.bead_id,s.added_at);return s=>{let o=r.get(s.bead_id)!==s.attempt_id,a=n.get(s.bead_id),i=typeof a=="number"&&a>0&&typeof s.finished_at=="number"&&a>=s.finished_at;return!o&&!i&&typeof s.dismissed_at!="number"}}var Wg="worker-ineligible";function ri(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function md(e){return ri(e).includes(Wg)}var zg="worker-serial";function ni(e){return ri(e).includes(zg)}function si(e,t,r){if(typeof t!="string"||typeof r!="string")return[];let n=e?.runners;if(!n||!Object.hasOwn(n,t))return[];let s=n[t],o=s?.models;if(!o||!Object.hasOwn(o,r))return[];let a=o[r]?.efforts;return Array.isArray(a)?a.slice():Array.isArray(s.efforts)?s.efforts.slice():[]}var Hg=new Set(["done","failed","orphaned","stopped","discarded"]),Gg={spec_missing:"\uC2A4\uD399 \uC5C6\uC74C",route:"route \uBBF8\uB2EC",spec_review:"\uC2A4\uD399 \uB9AC\uBDF0 \uC5C6\uC74C",spec_conflict:"\uC2A4\uD399 \uCDA9\uB3CC",phase_child:"phase child",worker_ineligible:"worker \uC81C\uC678"},Vg={running:"\uC2E4\uD589 \uC911",success:"\uC131\uACF5",failure:"\uC2E4\uD328",cancelled:"\uCDE8\uC18C",interrupted:"\uC911\uB2E8"},Kg={running:"running",success:"done",failure:"failed",cancelled:"stopped",interrupted:"orphaned"};function oi(e){return{runner:e.runner||void 0,model:e.model||void 0,effort:e.effort||void 0,status:Kg[e.outcome]||(typeof e.job_id=="string"?"running":void 0),session_id:e.session_id||void 0}}function gd(e,t){let{queueStore:r,analysisStore:n,transport:s,getWorkspacePath:o,onOpenTranscript:a}=t,i=document.createElement("dialog");i.id="worker-parallel-analysis-dialog",i.className="pa",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),e.appendChild(i);let c=new Map,u=new Map,d=!1,p=null,m=null,$=null,T=new Set,D=!1,H=0,se=null,V=new Set;function N(){return r&&r.get()||{revision:0,queue:[],serial_lanes:[],serial_lane_count:0,attempts:{},pr_wait:[]}}function P(){return n&&n.get()||{settings:{revision:0,runner:null,model:null,effort:null},job:null,runs:[],last_good:null}}function I(){return o&&o()||""}async function R(){if(!s)return;let w=++H;D=!0,$=null,T.clear(),q();try{let C=await s("worker-parallel-analysis-targets",{root_dir:I()});if(w!==H||!te)return;let B=Array.isArray(C?.qualified)?C.qualified:[],ie=Array.isArray(C?.excluded)?C.excluded:[];$={qualified:B,excluded:ie};for(let Ce of B)Ce&&typeof Ce.id=="string"&&T.add(Ce.id)}catch{w===H&&te&&($={qualified:[],excluded:[]},me("\uBD84\uC11D \uB300\uC0C1\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800))}finally{w===H&&(D=!1,te&&q())}}function A(w){return Array.isArray(w.runs)?w.runs:[]}function M(){let w=N(),C=new Set;for(let B of Object.values(w.attempts||{})){let ie=B;ie&&typeof ie.bead_id=="string"&&!Hg.has(ie.status)&&C.add(ie.bead_id)}for(let B of Array.isArray(w.pr_wait)?w.pr_wait:[])B&&typeof B.bead_id=="string"&&C.add(B.bead_id);for(let B of Object.values(w.discard_operations||{})){let ie=B;ie&&ie.phase!=="done"&&typeof ie.bead_id=="string"&&C.add(ie.bead_id)}return C}function G(w){return w.filter(C=>pe(C)===null)}function pe(w){let C=N();for(let B of Array.isArray(C.serial_lanes)?C.serial_lanes:[])if(Array.isArray(B?.entries)&&B.entries.some(ie=>ie.bead_id===w))return B.id;return(Array.isArray(C.queue)?C.queue:[]).some(B=>B.bead_id===w)?"parallel":null}function fe(w,C){let B=c.get(w);return B||[...C.order]}function _e(w){if(w.length<2)return!1;let C=pe(w[0]);if(!C||C==="parallel")return!1;let B=N(),ie=(Array.isArray(B.serial_lanes)?B.serial_lanes:[]).find(Ae=>Ae.id===C)?.entries.map(Ae=>Ae.bead_id);if(!Array.isArray(ie))return!1;let Ce=w.map(Ae=>ie.indexOf(Ae));return Ce.every(Ae=>Ae>=0)&&Ce.every((Ae,Pe)=>Pe===0||Ae>Ce[Pe-1])}function ae(){let w=N(),C=Array.isArray(w.serial_lanes)?w.serial_lanes:[],B=C.find(ie=>Array.isArray(ie.entries)&&ie.entries.length===0);return B?B.id:C[0]?.id||"s1"}function Le(w){let C=N().bead_titles||{};return typeof C[w]=="string"?C[w]:w}async function Te(w,C){if(!s||d)return null;d=!0,q();try{return await s(w,C)}finally{d=!1,q()}}async function ee(w){n?.setPending?.(!0);try{let C=await Te("worker-parallel-analysis-start",{force:w,target_ids:Array.from(T)});C&&C.applied===!1&&C.reason&&(C.reason==="target_not_qualified"&&Array.isArray(C.detail)?me(`\uBD84\uC11D \uB300\uC0C1 \uC790\uACA9 \uBCC0\uACBD: ${C.detail.join(", ")}`,"error",3200):me(`\uBD84\uC11D \uC2E4\uD328: ${C.reason}`,"error",2800))}finally{n?.setPending?.(!1)}}async function oe(){let w=P().job;!s||!w||await s("worker-parallel-analysis-cancel",{job_id:w.job_id})}async function xe(w){if(!(!s||V.has(w))){V.add(w),q();try{let C=await s("worker-parallel-analysis-prompt",{root_dir:I(),run_id:w});if(!te)return;if(C?.ok===!0&&typeof C.prompt=="string"){se={run_id:w,prompt:C.prompt};return}me(C?.reason==="not_found"?"\uC800\uC7A5\uB41C \uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800)}finally{V.delete(w),q()}}}function g(){se=null,q()}async function j(){if(!se)return;let w=await tr(se.prompt);me(w?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",w?"success":"error",1400)}function U(w,C){a&&a(w,oi(C))}function K(){return N().runner_catalog}function ge(w){return Object.keys(K()?.runners?.[w]?.models||{})}function we(w){let C=ge(w),B=K()?.runners?.[w]?.default_model;return typeof B=="string"&&C.includes(B)?B:C[0]||""}function ke(){let w=P().settings,C=p||w.runner||"claude",B=ge(C),ie=p?we(C):w.model||B[0]||"",Ce=si(K(),C,ie),Ae=w.effort||"",Pe=Ce.includes(Ae)?Ae:Ce[0]||"";return{runner:C,model:ie,effort:Pe,models:B,efforts:Ce}}async function Ze(w){let C=P().settings,B=await Te("worker-parallel-analysis-settings-update",{expected_revision:C.revision,runner:w.runner,model:w.model,effort:w.effort});(!B||B.applied!==!0)&&(p=null,q(),B&&B.reason&&me(`\uBD84\uC11D \uC124\uC815 \uAC70\uBD80: ${B.reason}`,"error",2800))}function wt(w){p=w,q();let C=ke();Ze({runner:w,model:C.model,effort:C.effort})}function He(w){let C=ke(),B=si(K(),C.runner,w);Ze({runner:C.runner,model:w,effort:B.includes(C.effort)?C.effort:B[0]||""})}function pt(w){let C=ke();Ze({runner:C.runner,model:C.model,effort:w})}async function st(w,C){if(!s||d)return;let B=fe(w,C),ie=P();if(B.length<2||!ie.last_good){me("\uC81C\uCD9C\uD558\uB824\uBA74 2\uAC1C \uC774\uC0C1\uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4","warning");return}let Ce=u.get(w)||ae(),Ae=()=>({snapshot_digest:ie.last_good.identity_digest,group_index:w,lane:Ce,ordered_bead_ids:B,expected_revision:N().revision});d=!0,q();try{let Pe=await s("worker-parallel-analysis-submit",Ae());Pe&&Pe.queue&&r&&r.set(Pe.queue),Pe&&Pe.applied!==!0&&Pe.conflict===!0&&(Pe=await s("worker-parallel-analysis-submit",Ae()),Pe&&Pe.queue&&r&&r.set(Pe.queue)),Pe&&Pe.applied===!0?(c.delete(w),me(`\uC9C1\uB82C \uB808\uC778 ${Ce}\uC5D0 ${B.length}\uAC1C \uBC30\uCE58`,"success")):me(`\uC81C\uCD9C \uAC70\uBD80: ${Pe?.reason||"conflict"} (\uD050 \uBB34\uBCC0\uACBD)`,"error",2800)}finally{d=!1,q()}}function Y(w,C,B){c.set(w,fe(w,C).filter(ie=>ie!==B)),q()}function Z(w){c.delete(w),q()}function Se(w,C,B,ie){let Ce=[...fe(w,C)],Ae=Ce.indexOf(B),Pe=Ae+ie;Ae<0||Pe<0||Pe>=Ce.length||(Ce.splice(Pe,0,...Ce.splice(Ae,1)),c.set(w,Ce),q())}function Qe(){let w=P().settings,C=Object.keys(K()?.runners||{}),B=ke();return l`<div class="pa-settings">
      ...
      >`:w.is_default===!0?l`<span class="pa-settings__default">기본값</span>`:""}function ot(w){return w.is_default===!0&&w.compatible===!1}function Je(w){return!!(w.runner&&w.model&&w.effort)}function yt(w){return Je(w)&&w.compatible!==!1}function Ie(w){let C=Math.max(0,Math.floor(w/1e3)),B=Math.floor(C/60),ie=C%60;return`${B}:${String(ie).padStart(2,"0")}`}function E(w){let C=w.job;if(C){let B=typeof C.started_at=="number"?C.started_at:0,ie=`${C.runner||"?"}/${C.model||"?"}`,Ce=B?` \xB7 \uACBD\uACFC ${Ie(Date.now()-B)}`:"",Ae=typeof C.session_id=="string"?C.session_id:"",Pe=A(w).find(Be=>Be.run_id===C.job_id);return l`<span class="pa-meta__progress">
        ...
        >`:""}function Q(){return n?.isPending?.()===!0}function Ee(w){let C=!!w.job,B=yt(w.settings),ie=$!==null&&T.size===0,Ce=C||d||Q()||D;return l`<div class="pa-meta">
    ...
    </div>`}function re(w){return typeof w=="string"&&w.length>0?w:"\uBBF8\uBC30\uCE58"}function qe(w,C){C?T.add(w):T.delete(w),q()}function rt(w){let C=Array.isArray(w.scope)?w.scope:[],B=Array.isArray(w.overlaps)?w.overlaps:[];return C.length===0&&B.length===0?l``:l`<span class="pa-target__signals">
...
`)}>
      ...
      ${B.length>0?l`<span
            ...
            >겹침 ${B.join(", ")}</span
          >`:""}
    </span>`}function it(){let w=$?.qualified||[],C=$?.excluded||[];return l`<section class="pa-targets">
      <header class="pa-targets__header">
        <strong>분석 대상</strong>
        <span class="pa-targets__summary"
          >${D?"\uC870\uD68C \uC911\u2026":`\uC790\uACA9 ${w.length} \xB7 \uC81C\uC678 ${C.length}`}</span
        >
      </header>
      ${$&&w.length>0?l`<ul class="pa-targets__list">
          ...
          </ul>`:$&&w.length===0?l`<p class="pa-empty">자격 있는 분석 대상이 없습니다</p>`:""}
      ${$&&C.length>0?l`<details class="pa-targets__excluded">
...
${se.prompt}</pre
    ...
    </div>`:""}function ht(w,C){let B=fe(w,C),ie=M(),Ce=B.filter(Ke=>ie.has(Ke)),Ae=G(B),Pe=_e(B),Be=Array.isArray(N().serial_lanes)?N().serial_lanes:[],St=u.get(w)||ae(),bt=C.eligible!==!0||B.length<2||Ce.length>0||Ae.length>0||Pe||d;return l`<section class="pa-group" data-group-index=${String(w)}>
      ...
      <footer class="pa-group__foot">
        ...
        <label class="pa-group__lane-field"
          ...
          <select
            ...
            aria-label="제출 대상 레인"
            @change=${Ke=>{u.set(w,Ke.target.value),q()}}
          >
      ...
      <span>uncertain ${ie}</span>
    </div>`}function kt(){let w=te&&!!P().job;if(w&&m===null){m=setInterval(()=>q(),1e3);return}!w&&m!==null&&(clearInterval(m),m=null)}function q(){let w=P();p&&w.settings.runner===p&&(p=null);let C=w.last_good?.result;kt(),Ye(l`
        ...
        ${_t()}
      `,i)}let te=!1,he=()=>{te=!1,se=null,H+=1,kt()},ze=w=>{w.target===w.currentTarget&&ve()};i.addEventListener("close",he),i.addEventListener("cancel",he),i.addEventListener("click",ze);let De=null;r&&r.subscribe&&(De=r.subscribe(()=>{te&&q()}));let F=null;n&&n.subscribe&&(F=n.subscribe(()=>{te&&q()}));function ne(){te||(te=!0,q(),R(),typeof i.showModal=="function"?i.showModal():i.setAttribute("open",""))}function ve(){te&&(te=!1,se=null,H+=1,kt(),typeof i.close=="function"?i.close():i.removeAttribute("open"))}return{open:ne,close:ve,destroy(){te=!1,m!==null&&(clearInterval(m),m=null),i.removeEventListener("close",he),i.removeEventListener("cancel",he),i.removeEventListener("click",ze),De&&(De(),De=null),F&&(F(),F=null),i.remove()}}}var hd=new Set(["sh","bash","zsh","dash","ksh"]),bd=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function yd(e){let t=e.split("/");return t[t.length-1]||""}function Yg(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let r=t.slice(2).trim().split(/\s+/).filter(Boolean);if(r.length===0)return!1;let n=yd(r[0]);if(n!=="env")return hd.has(n);let s=r.slice(1).find(o=>!o.startsWith("-")&&!o.includes("="));return s!==void 0&&hd.has(yd(s))}function Zg(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function Qg(e){let t=[],r=0;bd.lastIndex=0;for(let n of e.matchAll(bd)){let s=n.index;s>r&&t.push({text:e.slice(r,s),kind:"plain"}),t.push({text:n[0],kind:Zg(n[0])}),r=s+n[0].length}return r<e.length&&t.push({text:e.slice(r),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function Xg(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function vd(e){let t=e.getWorkspacePath,r=e.fetchImpl||globalThis.fetch?.bind(globalThis),n=document.createElement("div");n.className="repo-ops-script-viewer-root",document.body.appendChild(n);let s=null,o="loading",a="",i="",c=0,u=null,d=!1;function p(I,R){return R?Qg(I).map(A=>A.kind==="plain"?A.text:l`<span
            class="repo-ops-script-viewer__token repo-ops-script-viewer__token--${A.kind}"
            >${A.text}</span
          >`):I}function m(){if(!s)return l``;let I=o==="ready"&&Yg(a),R=o==="ready"?a.split(`
`):[];return l`<div
        ...
        <div class="repo-ops-script-viewer__body" aria-live="polite">
          ${o==="loading"?l`<div class="repo-ops-script-viewer__status">
                ...
                >
                  ...
                  ${R.map((A,M)=>l`<div class="repo-ops-script-viewer__row">
                        <span
    ...
    </div>`}function $(){Ye(m(),n)}async function T(){if(o!=="ready")return;let I=await tr(a);me(I?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",I?"success":"error")}function D(I){I.key==="Escape"&&s&&(I.preventDefault(),N())}function H(){d||(document.addEventListener("keydown",D),d=!0)}function se(){d&&(document.removeEventListener("keydown",D),d=!1)}async function V(I,R=null){let A=++c;H(),s={...I},u=R||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",$(),n.querySelector(".repo-ops-script-viewer__close")?.focus();let G=t?t():"";if(!G){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",$();return}if(!r){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",$();return}let pe="/api/repo-ops-script?workspace="+encodeURIComponent(G)+"&lane="+encodeURIComponent(I.lane)+"&base_sha="+encodeURIComponent(I.base_sha);try{let fe=await r(pe),_e=await fe.json().catch(()=>({}));if(A!==c)return;if((t?t():"")!==G){N();return}if(!fe.ok||!_e||_e.ok!==!0){o="error",i=Xg(_e&&typeof _e.error=="string"?_e.error:""),$();return}s={lane:_e.lane,base_sha:_e.base_sha,path:_e.path,base_ref:_e.base_ref},a=String(_e.content),o="ready",$()}catch{if(A!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",$()}}function N(){c+=1,se(),s=null,a="",$();let I=u;u=null,I?.isConnected&&I.focus()}function P(){N(),n.remove()}return{open:V,close:N,destroy:P}}function wd(e){let t=e.queueStore,r=e.transport,n=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let A=o();return typeof A.revision=="number"?A.revision:0}function i(A){t&&A&&A.queue&&typeof A.queue=="object"&&t.set(A.queue)}function c(){let A=o().workspace_info;return A&&typeof A=="object"?A:{}}function u(A,M){return l`<span
      class="worker-repo-ops__vd-badge worker-repo-ops__vd-badge--${A}"
      >${M}</span
    >`}function d(A){if(typeof A!="number"||!Number.isFinite(A))return"";let M=A/6e4;return Number.isInteger(M)?`timeout ${M}\uBD84`:`timeout ${Math.round(A/1e3)}\uCD08`}function p(A){let M=d(A);return M?u("config",M):""}function m(A,M,G){return l`<button
      type="button"
      class="worker-repo-ops__vd-cmd worker-repo-ops__vd-cmd--link"
      .textContent=${G.script}
      @click=${pe=>{s&&s({lane:A,base_sha:M.base_sha,path:G.script,base_ref:M.base_ref},pe.currentTarget)}}
    ></button>`}function $(){let A=o().repo_ops_opt_out;return{verify:A?.verify===!0,deploy:A?.deploy===!0}}function T(A,M){return l`<label class="worker-repo-ops__lane-run">
      <input
        type="checkbox"
        .checked=${!M}
      ...
      />
      이 workspace에서 실행
    </label>`}function D(A){let M=typeof A.base_sha=="string"?A.base_sha:"",G=`${A.source_path||"repo-ops/config.toml"} @ ${A.base_ref||"?"}${M?`@${M.slice(0,7)}`:""}`,pe=$(),fe=!!A.verify&&pe.verify,_e=!!A.deploy&&pe.deploy;return l`<section class="worker-repo-ops__vd" data-seam="repo-ops">
    ...
    </section>`}function H(A){let M=A.repo_ops&&typeof A.repo_ops=="object"?A.repo_ops:null;return M&&(M.status==="resolved"||M.status==="absent")?D(M):M&&(M.status==="pending"||M.status==="error")?l`<section class="worker-repo-ops__vd" data-seam="repo-ops">
        <p class="worker-repo-ops__vd-title">
          저장소 작업 선언
    ...
    </section>`}async function se(A){if(!r)return;let M=await r("worker-auto-repair-toggle",{on:A,expected_revision:a()});if(i(M),M&&M.conflict){let G=await r("worker-auto-repair-toggle",{on:A,expected_revision:a()});i(G)}n()}async function V(A,M){if(!r)return;let G=await r("worker-repo-ops-opt-out-toggle",{kind:A,opted_out:M,expected_revision:a()});if(i(G),G&&G.conflict){let pe=await r("worker-repo-ops-opt-out-toggle",{kind:A,opted_out:M,expected_revision:a()});i(pe)}n()}let N={owned_deploy_worktree_fetch_detached_alignment_recreate:"\uC804\uC6A9 \uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC \uC815\uB82C\xB7\uBCF5\uAD6C",recovered_pre_execution_fetch_timeout_retry_once:"fetch \uD0C0\uC784\uC544\uC6C3 1\uD68C \uBCF5\uAD6C",repo_serial_lock_wait:"\uC800\uC7A5\uC18C \uC21C\uCC28 \uC2E4\uD589 \uB300\uAE30",restart_operation_adoption:"\uC7AC\uC2DC\uC791 \uD6C4 \uC791\uC5C5 \uC778\uACC4",exact_input_exit_zero_evidence_adoption:"\uB3D9\uC77C \uC785\uB825 \uC131\uACF5 \uC99D\uAC70 \uC778\uACC4",descendant_success_covers_ancestor_rows:"\uCD5C\uC2E0 SHA \uC131\uACF5\uC774 \uC774\uC804 \uD589 \uCEE4\uBC84",owned_verify_candidate_cleanup:"\uAC80\uC99D \uC784\uC2DC \uCCB4\uD06C\uC544\uC6C3 \uC815\uB9AC",script_retry:"\uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4",auto_repair_session:"\uC790\uB3D9 \uD574\uACB0 \uC138\uC158",user_triggered_session:"\uC0AC\uC6A9\uC790 \uD574\uACB0 \uC138\uC158",automatic:"\uC790\uB3D9",user_action_only:"\uC0AC\uC6A9\uC790 \uD074\uB9AD",script_identity_present:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC788\uC744 \uB54C\uB9CC",per_completion_chain:"\uC644\uB8CC \uCCB4\uC778\uB2F9",unbounded:"\uD69F\uC218 \uC81C\uD55C \uC5C6\uC74C",bounded_single_script_retry_exceeded:"\uB2E8\uC77C \uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4 \uD55C\uB3C4 \uCD08\uACFC",baseline_failure_ignore:"\uAE30\uC874 \uC2E4\uD328 \uBB34\uC2DC",config_or_script_deletion_to_bypass_gate:"\uC124\uC815\xB7\uC2A4\uD06C\uB9BD\uD2B8 \uC0AD\uC81C\uB85C \uAC8C\uC774\uD2B8 \uC6B0\uD68C",credential_entry:"\uC790\uACA9\uC99D\uBA85 \uC785\uB825\xB7\uCD9C\uB825",destructive_action:"\uD30C\uAD34\uC801 \uC791\uC5C5",history_rewrite:"\uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131",agent_self_report_as_success:"\uC138\uC158 \uC790\uAE30\uBCF4\uACE0\uB97C \uC131\uACF5 \uCC98\uB9AC",unbounded_repair_session_retry:"\uBB34\uD55C \uD574\uACB0 \uC138\uC158 \uBC18\uBCF5"};function P(A,M,G){return l`<div class="worker-repo-ops__policy-group" data-policy=${G}>
    ...
    </div>`}function I(A){return l`<div
      class="worker-repo-ops__policy-group"
      data-policy="resolution-ladder"
    >
      <div class="worker-repo-ops__policy-label">해결 사다리</div>
      <ol class="worker-repo-ops__policy-list">
        ${A.map(M=>{let G=[N[M.trigger]||M.trigger];return Number.isInteger(M.attempts_per_operation_attempt)?G.push(`operation\uB2F9 ${M.attempts_per_operation_attempt}\uD68C`):Number.isInteger(M.attempts)?G.push(`${N[M.budget]||M.budget} ${M.attempts}\uD68C`):Number.isInteger(M.sessions_per_user_action)&&G.push(`${M.sessions_per_user_action}\uD68C`,N[M.user_actions]||M.user_actions),M.applies_when&&G.push(N[M.applies_when]||M.applies_when),l`<li data-token=${M.id}>
            <strong>${N[M.id]||M.id}</strong>
            <span>${G.filter(Boolean).join(" \xB7 ")}</span>
          </li>`})}
      </ol>
    </div>`}function R(){let A=o(),M=A.auto_repair!==!1,G=A.repo_operation_policy&&typeof A.repo_operation_policy=="object"?A.repo_operation_policy:null,pe=Array.isArray(A.repo_operations)?A.repo_operations:[],fe=pe.find(Te=>Te.state==="repairing"),_e=pe.filter(Te=>Te.state==="failed"||Te.state==="repairing"),ae=_e.length?Math.min(..._e.map(Te=>typeof Te.repair?.remaining=="number"?Te.repair.remaining:0)):G?.auto_repair?.resolution_ladder?.find(Te=>Te.id==="auto_repair_session")?.attempts??1,Le=Array.isArray(G?.auto_repair?.resolution_ladder)?G.auto_repair.resolution_ladder:[];return l`<section
    ...
    >
      ...
      ${G?l`<details
          ...
          >
            ...
            ${P("Worker\uAC00 \uC790\uB3D9 \uCC98\uB9AC",G.worker_automatic||[],"worker-automatic")}
            ...
            ${P("\uC790\uB3D9\uC73C\uB85C \uD558\uC9C0 \uC54A\uC74C",G.never_automatic||[],"never-automatic")}
          </details>`:""}
        ...
        ${H(c())} ${R()}
      </details>`}}}var Ad=20,Jg=5,eh=new Set(["failed","repairing","running","queued","retry_pending"]),kd={verify:"\uBA38\uC9C0 \uC804 \uAC80\uC99D",deploy:"\uBA38\uC9C0 \uD6C4 \uBC30\uD3EC"},$d={verify_script_failure:"\uAC80\uC99D \uC2E4\uD328 \uD574\uACB0",verify_script_failure_pre_merge:"\uAC80\uC99D \uC2E4\uD328 \uD574\uACB0 \uD6C4 \uBA38\uC9C0",deploy_script_failure:"\uBC30\uD3EC \uC2E4\uD328 \uD574\uACB0",interrupted_without_terminal_exit:"\uC911\uB2E8\uB41C \uC791\uC5C5 \uC9C4\uB2E8"};function th(e,t,r=Ad){let n=[];for(let s of Array.isArray(e)?e:[])!s||typeof s!="object"||n.push({type:"operation",id:s.operation_id,at:typeof s.finished_at=="number"?s.finished_at:typeof s.requested_at=="number"?s.requested_at:null,operation:s});for(let s of Array.isArray(t)?t:[])!s||typeof s!="object"||n.push({type:"cleanup",id:s.bead_id,at:typeof s.at=="number"?s.at:null,cleanup:s});return n.sort((s,o)=>s.at===null&&o.at===null?String(s.id||"").localeCompare(String(o.id||"")):s.at===null?1:o.at===null?-1:o.at-s.at),n.slice(0,Math.max(0,r))}function rh(e){if(e.type==="cleanup")return!0;let t=e.operation;return eh.has(t.state)&&!t.dismissed&&!t.superseded_by}function nh(e,t,r={}){let n=th(e,t,1/0),s=r.expanded===!0?Ad:Jg,o=new Set(n.slice(0,s)),a=n.filter(i=>o.has(i)||rh(i));return{visible:a,hidden:n.length-a.length}}function xd(e){if(e.type==="cleanup")return"warn";let t=e.operation.state;return t==="succeeded"?"ok":t==="failed"?"fail":"live"}function sh(e){if(e.type==="cleanup")return"\uBA48\uCDA4";switch(e.operation.state){case"succeeded":return"\uC131\uACF5";case"failed":return"\uC2E4\uD328";case"repairing":return"\uC790\uB3D9 \uD574\uACB0 \uC911";case"retry_pending":return"\uC7AC\uC2DC\uB3C4 \uC911";case"running":return"\uC2E4\uD589 \uC911";default:return"\uB300\uAE30"}}function Sd(e){let t=e.filter(r=>r.value);return t.length===0?"":l`<details class="worker-ev__details">
    <summary>세부</summary>
  ...
  </p>`}function oh(e){if(e.state!=="failed"||e.superseded_by)return"";let t=e.repair||{},r=typeof t.remaining=="number"?t.remaining:0,n=e.failure_kind==="verify_script_failure"&&e.verify_stage==="pre_merge"?"verify_script_failure_pre_merge":e.failure_kind||"",s=r<=0;return l`<div class="worker-ev__acts">
    <button
      type="button"
  ...
  </div>`}function ah(e){let t=e.operation,r=t.state==="failed",n=t.failure?t.failure.code:"";return l`<li
    class="worker-ev"
  ...
  </li>`}function ih(e){let t=e.cleanup,r=sn(t.step);return l`<li
    class="worker-ev"
  ...
  >
  ...
  </li>`}function lh(e){let t=typeof e.hidden=="number"?e.hidden:0,r=e.expanded===!0;return l`<section class="worker-repo-drawer" data-seam="repo-ops-timeline">
    ...
    ${e.events.length===0?l`<div class="worker-repo-drawer__empty">기록 없음</div>`:l`<ul class="worker-rail">
          ${e.events.map(n=>n.type==="cleanup"?ih(n):ah(n))}
        </ul>`}
  ...
  </section>`}function Td(e,t={}){let r=null;function n(){if(r===null){Ye(l``,e);return}let a=nh(r.operations,r.cleanup_failures,{expanded:r.expanded});Ye(lh({events:a.visible,hidden:a.hidden,expanded:r.expanded,repo:r.repo}),e)}e.addEventListener("click",a=>{let i=a.target;if(i?.closest?.('[data-seam="repo-ops-close"]')){o();return}i?.closest?.('[data-seam="repo-ops-more"]')&&r&&(r.expanded=!r.expanded,n())});function s(a){r={operations:a.operations,cleanup_failures:a.cleanup_failures,repo:a.repo||"",expanded:!1},n()}function o(){r!==null&&(r=null,n(),t.onClose&&t.onClose())}return{open:s,close:o,isOpen:()=>r!==null,refresh(a){r&&(r={operations:a.operations,cleanup_failures:a.cleanup_failures,repo:a.repo||"",expanded:r.expanded},n())}}}var ch=Ct("views:worker"),uh="tab:worker:ready",dh="tab:worker:blocked",ph="tab:worker:in-progress",fh="tab:worker:resolved",_h="tab:worker:closed",Io=1,Cd=5;function Rd(e){return io(e).path.length>0}var mh=new Set(["quick_fix","spec_backed","full_plan"]);function Ld(e){return typeof e=="string"&&mh.has(e)}var Md="beads-ui.worker.candidate-filter",ai={show_blocked:!1,spec:"all"};function gh(){try{let e=window.localStorage.getItem(Md);if(!e)return{...ai};let t=JSON.parse(e);if(!t||typeof t!="object")return{...ai};let r=t.spec;return{show_blocked:t.show_blocked===!0,spec:r==="with"||r==="without"?r:"all"}}catch{return{...ai}}}function hh(e){try{window.localStorage.setItem(Md,JSON.stringify(e))}catch{}}function bh(e,t){let r=i=>t.show_blocked||!i.blocked,n=i=>t.spec==="all"||(t.spec==="with"?i.has_spec:!i.has_spec),s=[],o=0,a=0;for(let i of e){let c=r(i),u=n(i);c&&u?s.push(i):!c&&u?o+=1:c&&!u&&(a+=1)}return{visible:s,hidden_blocked:o,hidden_spec:a}}var yh=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],Dd="bdui.worker.candidate_sort",vh=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],Oo="spec";function wh(){try{let e=window.localStorage.getItem(Dd);return e==="board"||e==="created"||e==="spec"?e:Oo}catch{return Oo}}function kh(e){try{window.localStorage.setItem(Dd,e)}catch{}}var Nd="bdui.worker.done-range";function $h(){try{let e=window.localStorage.getItem(Nd);return ar(e)?e:er}catch{return er}}function xh(e){try{window.localStorage.setItem(Nd,e)}catch{}}var Ah="(max-width: 640px)",qd="beads-ui.worker.lane-collapsed",ms={queue:!0,done:!0};function Sh(){try{let e=window.localStorage.getItem(qd);if(!e)return{...ms};let t=JSON.parse(e);return!t||typeof t!="object"?{...ms}:{queue:typeof t.queue=="boolean"?t.queue:ms.queue,done:typeof t.done=="boolean"?t.done:ms.done}}catch{return{...ms}}}function Eh(e){try{window.localStorage.setItem(qd,JSON.stringify(e))}catch{}}function Id(e){let t=Array.isArray(e)&&e.length>0?e[0]:null;if(!t)return"";let r=typeof t.title=="string"?t.title:t.id||"";return r.length>22?`${r.slice(0,22)}\u2026`:r}function Th(e,t,r){let n=Array.isArray(e)?e.slice():[];return t==="created"?n.sort(Zr):(n.sort(Ps(r)),t==="board"?n:[...n.filter(Rd),...n.filter(s=>!Rd(s))])}function Ch(e){let t=e&&e.parent;return(typeof t=="string"?t.length>0:!!(t&&t.id))||/\.\d+$/.test(e&&e.id||"")}function Rh(e){let t=e?.blocked_info;if(t&&typeof t=="object"){let s=Array.isArray(t.blockers)?t.blockers.filter(o=>typeof o=="string"&&o.length>0):[];return s.length>0?`\u{1F512} ${s.join(", ")}`:"\u{1F512} blocked"}let n=(Array.isArray(e?.dependencies)?e.dependencies:[]).map(s=>{if(typeof s=="string")return s;if(!s||typeof s!="object")return"";let o=s.type??s.dependency_type;return o!==void 0&&o!=="blocks"?"":s.depends_on_id||s.id||""}).filter(Boolean);return n.length>0?`\u{1F512} ${n.join(", ")}`:"\u{1F512} blocked"}function Od(e){switch(e){case"not_in_pr_wait":return"PR \uB300\uAE30 \uC0C1\uD0DC \uB3D9\uAE30\uD654 \uC2E4\uD328";case"resolution_round_cap":return"\uCDA9\uB3CC \uD574\uC18C 2\uD68C \uCD08\uACFC";case"resolution_timeout":return"\uCDA9\uB3CC \uD574\uC18C \uB300\uAE30 \uC2DC\uAC04 \uCD08\uACFC";case"resolution_refused":return"\uD574\uC18C \uC138\uC158 \uB514\uC2A4\uD328\uCE58 \uAC70\uBD80";case"worktree_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uD574\uC18C \uD544\uC694";case"merge_unconfirmed_timeout":return"\uBA38\uC9C0 \uD655\uC778 \uC2DC\uAC04 \uCD08\uACFC";case"pr_closed_unmerged":return"PR \uB2EB\uD798";case"merge_error":return"\uBA38\uC9C0 \uC624\uB958";case"spec_id_missing":return"\uC2A4\uD399 ID \uAE30\uB85D \uC5C6\uC74C";default:return e}}function Lh(e){if(e==="lane_occupied")return"\uC2E4\uD589 \uB808\uC778\uC5D0 \uB0A8\uC544 \uC788\uC5B4 \uBA38\uC9C0 \uB300\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4";let t="\uBA38\uC9C0 \uD050\uC5D0 \uB123\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (\uC774\uBBF8 \uB300\uAE30 \uC911\uC774\uAC70\uB098 \uB300\uC0C1 \uC544\uB2D8)";return typeof e=="string"&&e.length>0?`${t}: ${e}`:t}function Ih(e,t=null){if(e==="worker_sessions_busy")return"\uD574\uC18C \uB300\uAE30 \u2014 \uC2E4\uD589 \uC2AC\uB86F \uB300\uAE30 \uC911";if(typeof e!="string"||!e.startsWith("completion_waiting:"))return null;let r=e.slice(19);if(r.length===0)return null;switch(r){case"gating":{let n=t?.repair_sessions_used;return typeof n=="number"&&n>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911"}case"repairing":return"\uC790\uB3D9 \uC218\uC815 \uC911";case"waiting_repair_pr":return"\uC218\uC815 PR \uB300\uAE30 \uC911";case"merging":return"\uBA38\uC9C0 \uC911";case"cleaning":return"\uB9C8\uBB34\uB9AC \uC911";case"paused":return"\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";case"needs_human":return"\uD655\uC778 \uD544\uC694";default:return null}}function Oh(e){if(!e||typeof e!="object")return null;switch(e.state){case"waiting":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC911",live:!0};case"yielded":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uACC4\uC18D \uC911 \xB7 \uC644\uB8CC \uD6C4 \uC6B0\uC120 \uBA38\uC9C0",live:!0};case"ready":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC644\uB8CC \xB7 \uC7AC\uAC80\uC99D \uB300\uAE30",live:!1};default:return null}}function Ph(e){if(!e||typeof e!="object")return null;switch(e.state){case"pending":return{badge:"implementation review \uB300\uAE30",live:!1,alert:!1};case"reviewing":return{badge:"implementation review \uC911",live:!0,alert:!1};case"revising":return{badge:"review \uC218\uC815 \uC911 \xB7 1\uD68C",live:!0,alert:!1};case"failed":{let r=(typeof e.failure_reason=="string"?e.failure_reason:"").replace(/[\u0000-\u001f\u007f]/g," ").slice(0,120);return{badge:r.trim().length>0?`review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328: ${r.trim()}`:"review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328",live:!1,alert:!0}}default:return null}}function ii(e,t){return typeof e!="string"||e.length===0||typeof t!="string"||t.length===0||t===e?null:`\u2192 ${t}`}function Mh(e){if(!e||typeof e!="object")return null;let t=Number.isInteger(e.repair_sessions_used)?Math.max(0,e.repair_sessions_used):0,r=Number.isInteger(e.repair_session_cap)?Math.max(0,e.repair_session_cap):0,n=e.current_repair&&typeof e.current_repair=="object"?e.current_repair:null,s=n&&typeof n.pr_number=="number"?n.pr_number:null,o="";switch(e.phase){case"gating":o=t>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911";break;case"repairing":o="\uC790\uB3D9 \uC218\uC815 \uC911";break;case"waiting_repair_pr":o=s?`\uC218\uC815 PR #${s} \uB300\uAE30 \uC911`:"\uC218\uC815 PR \uB300\uAE30 \uC911";break;case"merging":o=e.subject_role==="repair"?s?`\uC218\uC815 PR #${s} \uBA38\uC9C0 \uC911`:"\uC218\uC815 PR \uBA38\uC9C0 \uC911":"\uBA38\uC9C0 \uC911";break;case"cleaning":o="\uB9C8\uBB34\uB9AC \uC911";break;case"paused":o="\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";break;case"needs_human":o="\uD655\uC778 \uD544\uC694";break;case"completed":return null;default:return null}let a=[o,`\uC790\uB3D9 \uC218\uC815 \uD69F\uC218 ${t}/${r}`];return e.head_sha&&a.push(`head ${e.head_sha}`),e.base_sha&&a.push(`base ${e.base_sha}`),(e.failure_stage||e.failure_reason)&&a.push(`${e.failure_stage||"failure"} \xB7 ${e.failure_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`),e.active_attempt_id&&a.push(`attempt ${e.active_attempt_id}`),n&&typeof n.bead_id=="string"&&a.push(`repair ${n.bead_id}`),e.evidence&&a.push(e.evidence),e.log_path&&a.push(e.log_path),{badge:o,title:a.join(`
`),alert:e.phase==="needs_human",lock_actions:e.phase!=="paused"&&e.phase!=="needs_human",repair_pr_url:n&&typeof n.pr_url=="string"?n.pr_url:"",repair_pr_number:s}}function Pd(e){if(!e||typeof e!="object")return[];let t=e.blocking_codes;return Array.isArray(t)?t.filter(r=>typeof r=="string"&&r.length>0):[]}function Dh(e){let t=e.queue_failure?`\uBA38\uC9C0 \uC2E4\uD328 \uC6D0\uBB38: ${e.queue_failure}`:e.auto_skip?`\uC790\uB3D9 \uC81C\uC678 \uC6D0\uBB38: ${e.auto_skip}`:"",r=(n,s={})=>{let o=[s.title||"",t].filter(Boolean);return{label:n,title:o.join(`
`),live:s.live===!0,alert:s.alert===!0}};return e.continuation_required?r("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694",{alert:!0}):e.merge_step?e.gate?.tier==="merged"?r("\uBA38\uC9C0\uB428",{title:e.merge_step.label,alert:e.merge_step.failed===!0}):r("\uBA38\uC9C0 \uC911",{title:e.merge_step.label,live:!0}):e.conflict_badge?r(e.conflict_badge,{live:e.conflict_live===!0}):e.head_review&&e.head_review.state!=="failed"?r("\uB9AC\uBDF0 \uC9C4\uD589 \uC911",{title:e.head_review.badge,live:e.head_review.live===!0}):e.recovery?.lock_actions?r(e.recovery.badge,{title:e.recovery.title,live:!0}):e.cleanup_failed?r(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0}):e.base_exception?r("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0}):e.conflicting?r("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0}):e.gate?.reason==="base_behind"?r("base \uAC31\uC2E0 \uD544\uC694",{alert:!0}):e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale"?r("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2C8\uAC70\uB098 \uC870\uC0C1 \uD655\uC778\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0}):e.gate?.reason==="spec_id_missing"?r("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0}):e.gate?.reason==="review_receipt_invalid"?r("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0}):Pd(e.receipt_check).length>0?r("\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694",{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${Pd(e.receipt_check).join(", ")}`,alert:!0}):e.head_review?.state==="failed"?r("\uB9AC\uBDF0 \uC2E4\uD328",{title:e.head_review.failure_reason||"",alert:!0}):e.recovery?r(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?r("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?r(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Od(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?r(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Od(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?r(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?r("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?r("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?r("\uB2EB\uD798",{alert:!0}):e.activity?r("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?r("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?r("\uD655\uC778 \uC911"):e.gate?.gate_badge?r(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function Nh(e,t,r,n,s=null,o=null,a=null,i=!1,c=null,u=!0,d=null,p=null,m=null,$={},T=!1,D=!1,H={}){let se=!!c&&c.position>0,V=!!c?.continuation_action&&c.continuation_action.continuation===null,N=!!c&&c.active===!0,P=c&&c.failure||null,I=Ih(c?c.waiting:null,m),R=r[e]||null,A=R&&R.gate?R.gate:null,M=R&&R.pr?R.pr:null,G=Mh(m),pe=Oh(c?c.resolution:null),fe=Ph(c?c.head_review:null),_e=c&&c.head_review||null,ae=c&&c.authority||null,Le=!!_e&&["pending","reviewing","revising"].includes(_e.state),Te=se&&!N&&(_e?.state==="failed"||!ae||ae.source==="automatic"&&!D),ee=a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":pe?pe.badge:a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":I,oe=!!A&&A.base_badge==="\uCDA9\uB3CC",xe=!!A&&A.enabled===!0,g=fs({bead_id:e,merge_sha:H.merge_sha,cleanup_cursor:H.cleanup_cursor,merge_progress:o&&o.merge_progress?o.merge_progress:null,cleanup_failed:n,repo_operations:H.repo_operations}),j=Lo(g),U=!!n&&["child_sweep","branch_cleanup","parent_close"].includes(n.step)&&!!A&&A.tier==="merged",K=i&&!!n&&!!A&&A.tier==="merged",ge=Te&&(xe||oe||A?.reason==="base_behind"||A?.reason==="review_receipt_missing"||A?.reason==="review_receipt_stale"||U||K),we=i&&oe&&u===!1,ke=yr($,e,{external:i,merge_active:N||g?.step==="merge",merge_queued:se,conflict_active:!!a,cleanup_active:j,merged:!!n||A?.tier==="merged"}),Ze=!!ke.operation,wt=!U&&!!n&&n.step==="repo_operations",He=Dh({continuation_required:V,merge_step:g,conflict_badge:ee,conflict_live:pe?.live===!0||a==="running",head_review:_e&&fe?{...fe,state:_e.state,failure_reason:_e.failure_reason}:null,recovery:G,cleanup_failed:n,cleanup_label:n?sn(n.step):null,base_exception:p,conflicting:oe,gate:A,receipt_check:R&&R.receipt_check?R.receipt_check:null,queue_failure:P,auto_skip:d,queued:se,queue_active:N,queue_position:c?c.position:0,activity:ee?null:o&&o.activity||null}),pt=He?.live===!0&&He.title?l`<span title=${He.title}>${He.label}</span>`:He?.label||null;return{id:e,title:i?l`${t}<span class="muted"> · 세션</span>`:t,reason:n&&g?.active!==!0?Ro(n.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:T,external:i,pr_number:M&&typeof M.number=="number"?M.number:null,pr_url:M&&typeof M.url=="string"?M.url:"",completion_badge:He?.live!==!0&&He?.title?He.label:null,completion_title:He?.title||"",completion_repair_pr_url:G?G.repair_pr_url:"",completion_repair_pr_number:G?G.repair_pr_number:null,badges:pt?[pt]:[],live_badge:He?.live===!0?pt:null,usage:s,alert:He?.alert===!0,merge_action:A?.tier==="merged"&&!U&&!K||wt?!1:!se||V||Te,timeline_action:wt,cancel_action:se&&!V,cancel_enabled:(!N||Le)&&!(G&&G.lock_actions),cancel_title:G&&G.lock_actions?`${G.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:N&&!Le?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":Le?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:ke,discard_action:ke.action,merge_step:g,discard_enabled:ke.enabled,discard_title:ke.title,merge_enabled:!g&&!a&&!Ze&&!p&&!(G&&G.lock_actions)&&!we&&!wt&&(xe||oe||A?.reason==="base_behind"||A?.reason==="review_receipt_missing"||A?.reason==="review_receipt_stale"||U||K||ge),merge_label:V?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":U||K?"\uC815\uB9AC \uC7AC\uAC1C":oe&&!g&&!U?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":A?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":A?.reason==="review_receipt_missing"||A?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":Te?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:Ze?ke.error?`\uD3D0\uAE30 \uC2E4\uD328: ${ke.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${ke.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:V?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":g?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${g.label}`:K?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":we?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":U?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":oe?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":A?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":A?.reason==="review_receipt_missing"||A?.reason==="review_receipt_stale"?"\uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":A?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":xe?`\uBA38\uC9C0 (${A.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:A&&A.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${A&&A.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function li(e,t={}){let{transport:r,issueStores:n,queueStore:s,analysisStore:o,sessionLogStore:a,uiOrderStore:i,gotoIssue:c,getWorkspacePath:u,doneRange:d,onDoneRangeChange:p}=t,m=n?Ds(n,i):null,$=js({transport:r,uiOrderStore:i}),T=null,D=[],H=gh(),se=null,V=wh(),N=ar(d)?d:$h(),P=new Map;function I(){let f=Rr.find(k=>k.value===N);return f?f.label:"\uC624\uB298"}let R=Sh(),A=!1,M=new Set,G=new Set,pe=new Set,fe=new Set,_e=new Set,ae={},Le=null,Te=0,ee=null,oe=[];function xe(f){return Le===f?ae:{}}async function g(){if(!r)return;let f=u?.()||"";if(Le===f||ee&&ee.key===f&&ee.generation===Te)return;let k=++Te;ee={key:f,generation:k};let z=null;try{z=await Promise.resolve(r("get-session-defaults",{}))}catch(_){if(k!==Te)return;ee=null,ch("get-session-defaults failed: %o",_),y();return}k===Te&&(ae=z&&typeof z.values=="object"&&z.values!==null?{...z.values}:{},Le=f,ee=null,y())}function j(){Le=null,Te+=1,g()}let U=document.createElement("div");U.className="worker-console";let K=document.createElement("div");K.className="worker-top";let ge=document.createElement("div");ge.className="worker-drawer-overlay",ge.hidden=!0;let we=document.createElement("div");we.className="worker-drawer-overlay__backdrop";let ke=document.createElement("div");ke.className="worker-drawer-host";let Ze=document.createElement("div");Ze.className="worker-drawer-host",Ze.hidden=!0,ge.append(we,ke,Ze);let wt=document.createElement("div");wt.className="worker-lanes-host",U.append(K,ge,wt),e.appendChild(U);let He=null,pt=null,st=En(ke,{transport:r,sessionLogStore:a,onClose:()=>{He=null,pt=null,ge.hidden=!0,y()}}),Y=Td(Ze,{onClose:()=>{Ze.hidden=!0,ge.hidden=!0,y()}}),Z=vd({getWorkspacePath:u||(()=>"")}),Se=u&&u()||"",Qe=wd({queueStore:s,transport:r,onChanged:()=>y(),onOpenScript:(f,k)=>{Z.open(f,k)}}),je=o?gd(U,{queueStore:s,analysisStore:o,transport:r,getWorkspacePath:u,onOpenTranscript:(f,k)=>Dt(f,k)}):null;function ot(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Io,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function Je(){let f=ot(),k=typeof f.serial_lane_count=="number"&&Number.isInteger(f.serial_lane_count)&&f.serial_lane_count>0?Math.min(f.serial_lane_count,5):0,z=Array.isArray(f.serial_lanes)?f.serial_lanes:[],_=[];for(let ce of z){if(_.length>=k)break;!ce||typeof ce.id!="string"||!/^s[1-5]$/.test(ce.id)||!Array.isArray(ce.entries)||_.push({id:ce.id,label:`\uC9C1\uB82C ${ce.id.slice(1)}`,count:ce.entries.length})}return _.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(f.queue)?f.queue:[]).length},..._]}function yt(f){if(!se||!f.some(z=>z.id===se))return null;let k=Je();return k?{bead_id:se,lanes:k}:null}function Ie(){let f=ot();return typeof f.revision=="number"?f.revision:0}function E(f){f&&f.queue&&s&&s.set(f.queue)}function Q(){let f=ot().queue;return Array.isArray(f)?f.length:0}async function Ee(f,k,z){if(!r)return;let _=()=>({bead_id:f,...k==="parallel"?{}:{lane:k},...z===void 0?{}:{index:z},expected_revision:Ie()}),b=await r("worker-queue-place",_());E(b),b&&b.conflict&&await r("worker-queue-place",_()).then(E)}async function re(f,k,z){if(!r)return;let _=()=>({bead_id:f,...k==="parallel"?{}:{lane:k},to_index:z,expected_revision:Ie()}),b=await r("worker-queue-reorder",_());E(b),b&&b.conflict&&await r("worker-queue-reorder",_()).then(E)}async function qe(f){if(!r)return;let k=await r("worker-queue-remove",{bead_id:f,expected_revision:Ie()});E(k),k&&k.conflict&&await r("worker-queue-remove",{bead_id:f,expected_revision:Ie()}).then(E)}async function rt(f){if(!r||!f)return;let k=await r("worker-attempt-pause",{attempt_id:f});k&&k.paused===!1&&k.reason&&me(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${k.reason}`,"error",2400)}async function it(f){if(!r||!f)return;let k=await $n();if(k===null)return;let z=async(b={})=>await r("worker-attempt-resume",{attempt_id:f,expected_revision:Ie(),...k!==""?{instructions:k}:{},...b}),_=await z();E(_),_&&_.conflict&&(_=await z(),E(_)),_=await wr(_,(b,ce)=>z({continuation:b,decision_token:ce}),{onResult:E,refresh:()=>z()}),_&&_.resumed===!1&&!_.conflict&&_.reason&&me(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${_.reason}`,"error",2400)}async function Xe(f){if(!r||!f)return;let k=await r("worker-attempt-dismiss",{attempt_id:f,expected_revision:Ie()});E(k),k&&k.conflict&&(k=await r("worker-attempt-dismiss",{attempt_id:f,expected_revision:Ie()}),E(k)),k&&k.dismissed===!1&&!k.conflict&&k.reason&&me(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${k.reason}`,"error",2400)}async function nt(f,k,z=!0){if(!r)return null;let _=r,b=await _(f,{...k,expected_revision:Ie()});return E(b),b&&b.conflict&&z&&(b=await _(f,{...k,expected_revision:Ie()}),E(b)),b}async function _t(f){if(!r||!f)return;let k=ot().merge_queue?.find(_=>_.bead_id===f)?.continuation_action;if(k?.mismatch&&k.continuation===null){await at(f,k.mismatch);return}M.add(f),y();let z;try{z=await nt("worker-merge-queue-add",{bead_id:f})}finally{M.delete(f),y()}!z||z.conflict||z.applied||me(Lh(z.reason),"error",2400)}async function ht(f){if(!(!r||!f||G.has(f))){G.add(f),y();try{let k=await r("worker-cleanup-retry",{bead_id:f,expected_revision:Ie()});E(k),k&&!k.retried&&!k.conflict&&k.reason&&me(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${k.reason}`,"error",2400)}finally{G.delete(f),y()}}}async function at(f,k){let z=await wr({continuation_mismatch:k},(b,ce)=>nt("worker-merge-queue-add",{bead_id:f,continuation:b,decision_token:ce},!1)),_=z?.queue?.merge_queue?.find(b=>b.bead_id===f)?.continuation_action;if(z?.applied!==!0&&_?.continuation===null&&_.mismatch){await at(f,_.mismatch);return}z&&z.applied===!1&&!z.conflict&&me("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function kt(f){if(!r)return;let k=await nt("worker-merge-auto-toggle",{on:f});!k||k.conflict||me(f?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",f?"success":"info",2400)}async function q(f){if(!r||!f)return;let k=await nt("worker-merge-queue-remove",{bead_id:f});k&&!k.conflict&&!k.applied&&k.reason==="merge_active"&&me("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function te(){await nt("worker-merge-queue-remove",{all:!0})}async function he(f,k=null,z="unmerged",_=null){if(!r||!f)return;let b=cs(f,z);if(!(!!_||typeof globalThis.confirm!="function"||globalThis.confirm(b)))return;let le=await r("worker-discard",{bead_id:f,...k?{attempt_id:k}:{},..._?{operation_id:_}:{},expected_revision:Ie()});if(E(le),le&&le.conflict&&(le=await r("worker-discard",{bead_id:f,...k?{attempt_id:k}:{},..._?{operation_id:_}:{},expected_revision:Ie()}),E(le)),le&&le.discarded===!0){me(wo(le),"success",5e3);return}if(le&&le.reason){me(`\uD3D0\uAE30 \uC2E4\uD328: ${le.reason}`,"error",2800);return}if(le&&le.accepted&&le.pending==="merged_revert"){me("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(le&&le.accepted&&!le.discarded){me(`\uD3D0\uAE30 \uC9C4\uD589: ${le.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}le&&!le.conflict&&me("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function ze(f,k,z){if(!(!r||!k||!z||fe.has(k))){fe.add(k),y();try{let _=await r(f,{bead_id:k,action_id:z,expected_revision:Ie()});E(_),_?.conflict?me("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!_?.ok&&_?.reason&&me(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(_.reason)}`,"error",2800)}finally{fe.delete(k),y()}}}async function De(f,k){if(!r||!k||pe.has(k))return;pe.add(k),y();let z;try{let _=async(b={})=>await r(f,{bead_id:k,expected_revision:Ie(),...b});z=await _(),E(z),z&&z.conflict&&(z=await r(f,{bead_id:k,expected_revision:Ie()}),E(z)),f==="worker-revise-fix"&&(z=await wr(z,(b,ce)=>_({continuation:b,decision_token:ce}),{onResult:E,refresh:()=>_()}))}finally{pe.delete(k),y()}if(!(!z||z.conflict)){if(z.ok){me(f==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}me(`\uCC98\uBD84 \uAC70\uBD80: ${z.reason||""}`,"error",3e3)}}async function F(f){if(!r)return;let k=await r("worker-automation-toggle",{on:f,expected_revision:Ie()});E(k),k&&k.conflict&&await r("worker-automation-toggle",{on:f,expected_revision:Ie()}).then(E)}async function ne(f){if(!r||!f)return;let k=await r("worker-repo-operation-repair",{operation_id:f});if(E(k),k&&k.ok===!1){me(`\uD574\uACB0 \uC138\uC158 \uAC70\uBD80: ${k.reason||""}`,"error",3e3);return}k&&k.ok===!0&&me("\uD574\uACB0 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4","success",2400)}async function ve(f){if(!r||!f)return;let k=await r("worker-repo-operation-dismiss",{operation_id:f});E(k),k&&k.ok===!1&&me(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${k.reason||""}`,"error",3e3)}async function w(f){if(!r||!Number.isFinite(f))return;let k=Math.max(Io,Math.floor(f)),z=await r("worker-queue-set-slots",{slots:k,expected_revision:Ie()});E(z),z&&z.conflict&&await r("worker-queue-set-slots",{slots:k,expected_revision:Ie()}).then(E)}async function C(f){if(!r||!Number.isInteger(f)||f<1||f>Cd)return;let k=ot(),z=(Array.isArray(k.serial_lanes)?k.serial_lanes:[]).slice(f).reduce((ce,le)=>ce+(Array.isArray(le?.entries)?le.entries.length:0),0),_=()=>({count:f,expected_revision:Ie()}),b=await r("worker-queue-set-serial-lane-count",_());E(b),b&&b.conflict&&(b=await r("worker-queue-set-serial-lane-count",_()),E(b)),b&&b.applied&&z>0&&me(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${z}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}function B(){let f=ot(),k=m?m.selectBoardColumn(uh,"ready"):[],z=m?m.selectBoardColumn(dh,"blocked"):[],_=m?m.selectBoardColumn(_h,"closed"):[],b=m?m.selectBoardColumn(ph,"in_progress"):[],ce=m?m.selectBoardColumn(fh,"resolved"):[],le=qs([...k,...z,...b,...ce,..._]),Ue=new Map;for(let h of[...k,...z,...b])h&&h.id&&!Ue.has(h.id)&&Ue.set(h.id,h);let $e={...xe(u?.()||"")};for(let h of["orchestration_model","orchestration_effort","orchestration_speed"]){let W=f[h];typeof W=="string"&&($e[h]=W)}function x(h,W){let de=Ue.get(h);if(!de)return null;let Ve=de.metadata&&typeof de.metadata=="object"?de.metadata:{},dt=de.workflow?.route,Ut=Ve.route,qt=Ld(dt)?dt:Ld(Ut)?Ut:null;return Qt({pin:Ve,global:$e,execution_defaults:f.execution_defaults??null,runner_catalog:f.runner_catalog??null,route:qt,controller_runtime:W})}function J(h){let W=h.runner||null,de=x(h.bead_id,W),Ve=Ao(h),dt=de?qr(de,W):null;return Ve||dt?{orchestration:Ve,worker:dt}:null}let O=new Map;function Re(h){if(O.has(h))return O.get(h)??null;let W=x(h,null),de=null;if(W){let Ve=gr(f.runner_catalog??null,W.orchestration_model.value??""),dt=Ve===null?W:x(h,Ve),Ut=nn(dt,f.runner_catalog??null),qt=qr(dt,Ve);de=Ut||qt?{orchestration:Ut,worker:qt}:null}return O.set(h,de),de}function ut(h){let W=Fs(le,h);return W.total===0?null:W}let lt=f.bead_titles||{},et=new Map;for(let[h,W]of Object.entries(lt))typeof W=="string"&&W.length>0&&et.set(h,W);for(let h of[...k,...z])et.set(h.id,h.title||h.id);let tt=f.bead_times&&typeof f.bead_times=="object"&&!Array.isArray(f.bead_times)?f.bead_times:{},Pt=f.bead_labels&&typeof f.bead_labels=="object"&&!Array.isArray(f.bead_labels)?f.bead_labels:{},Jt=new Map;for(let[h,W]of Object.entries(Pt))Array.isArray(W)&&Jt.set(h,ni(W));for(let h of[...k,...z]){let W=h.labels;Array.isArray(W)&&!Jt.has(h.id)&&Jt.set(h.id,ni(W))}let on=new Map,an=o?.get()?.last_good?.result?.groups;for(let h of Array.isArray(an)?an:[]){if(h?.eligible!==!0||!Array.isArray(h.members))continue;let W=h.members.map(Ve=>{let dt=(Array.isArray(f.serial_lanes)?f.serial_lanes:[]).find(Ut=>Ut.entries.some(qt=>qt.bead_id===Ve));return dt?dt.id:null});if(!(W.every(Ve=>Ve!==null)&&new Set(W).size===1))for(let Ve of h.members)on.set(Ve,h.members.filter(dt=>dt!==Ve))}let gs=f.bead_blocked_by&&typeof f.bead_blocked_by=="object"&&!Array.isArray(f.bead_blocked_by)?f.bead_blocked_by:{},ln=new Map;for(let[h,W]of Object.entries(tt))W&&typeof W=="object"&&ln.set(h,W);for(let h of[...k,...z])ln.set(h.id,{created_at:h.created_at,updated_at:h.updated_at});let Br=h=>ln.get(h)||{},Ur=f.pr_wait||[],cn=f.pr_observations||{},hs=f.pr_activity||{},We=f.cleanup_failed||{},Lt=Object.entries(We).map(([h,W])=>({bead_id:h,step:W&&W.step?W.step:"",reason:W&&W.reason?W.reason:"",at:W&&typeof W.at=="number"?W.at:null,detail:W&&typeof W.detail=="string"?W.detail:null,output_tail:W&&typeof W.output_tail=="string"&&W.output_tail?W.output_tail:void 0,log_path:W&&typeof W.log_path=="string"&&W.log_path?W.log_path:void 0,retry_count:W&&typeof W.retry_count=="number"&&Number.isInteger(W.retry_count)&&W.retry_count>0?W.retry_count:0,failure_code:W&&typeof W.failure_code=="string"?W.failure_code:void 0,subject_id:W&&typeof W.subject_id=="string"?W.subject_id:void 0,repair_eligible:!!(W&&W.repair_eligible),repair:W&&W.repair?W.repair:void 0})),un=f.queue||[],Qd=new Set([...un.map(h=>h.bead_id),...(Array.isArray(f.serial_lanes)?f.serial_lanes:[]).flatMap(h=>(Array.isArray(h?.entries)?h.entries:[]).map(W=>W.bead_id)),...Ur.map(h=>h.bead_id),...f.done.map(h=>h.bead_id)]),Xd=new Set(z.map(h=>h.id)),Jd=i?i.get()?.order||{}:{},pi=new Set,fi=[];for(let h of[...k,...z])Qd.has(h.id)||pi.has(h.id)||Ch(h)||(pi.add(h.id),fi.push(h));D=Th(fi,V,Jd);let ep=f.admission||{},_i=h=>{let W=ep[h];if(!W)return"";if(W.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let de=typeof W.reason=="string"?W.reason:"",Ve=de.indexOf(":");return Ve>0&&Ve<de.length-1?`\u26D4 ${de.slice(0,Ve)} (${de.slice(Ve+1)})`:`\u26D4 ${de}`},tp=D.map(h=>{let W=io(h),de=W.path.length>0,Ve=h.workflow?.route==="quick_fix"||h.metadata&&h.metadata.route==="quick_fix",dt=!Object.hasOwn(h,"description")||typeof h.description=="string"&&h.description.trim().length>0,Ut=Object.hasOwn(h,"labels")&&md(h.labels),qt=!Ut&&(Ve?dt:de&&!W.conflict),Et=Xd.has(h.id),dr=[];Et&&dr.push(Rh(h)),Ve&&!dt?dr.push("missing_description"):!Ve&&W.conflict?dr.push("spec_id_conflict"):!Ve&&!de&&dr.push("spec \uC5C6\uC74C");let As=_i(h.id);return As&&dr.push(As),{id:h.id,title:h.title||h.id,reason:dr.join(" \xB7 "),draggable:qt,lane:"candidate",created_at:h.created_at,updated_at:h.updated_at,workflow:h.workflow,is_quick_fix:Ve,status:h.status,worker_ineligible:Ut,blocked:Et,has_spec:de,exec_chips:Re(h.id)}}),Po=bh(tp,H),rp=Po.visible,np=f.revise_parked||{},bs=f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},Mo=(h,W)=>h.map((de,Ve)=>{let dt=W!=="done",Ut=W!=="done"&&W!=="queue",qt=dt?np[de.bead_id]:null,Et=dt?yr(bs,de.bead_id):null,dr=Et?.operation?Et:null,As=dt&&Jt.get(de.bead_id)===!0,qi=gs[de.bead_id]||[],jo=f.admission&&typeof f.admission=="object"?f.admission[de.bead_id]:null,Bo=dt?uu(jo,!!dr||fe.has(de.bead_id)):null,gp=dt&&!Bo?_i(de.bead_id):null,hp=dt?[gp]:[],Fi=dt&&qi.length>0&&typeof jo?.reason=="string"&&jo.reason.startsWith("not_ready")?[`\u23F8 ${qi.join(", ")} \uC644\uB8CC \uB300\uAE30 (blocks)`]:[],Uo=dt?on.get(de.bead_id):void 0;return Uo&&Uo.length>0&&Fi.push(`\u2733 serial \uAD8C\uC7A5 \xB7 ${Uo.join(", ")}\uC640`),{id:de.bead_id,title:et.get(de.bead_id)||de.bead_id,reason:hp.filter(Boolean).join(" \xB7 "),draggable:dt&&!dr&&!Bo,done:W==="done",lane:W,seq:Ut?Ve+1:void 0,worker_serial:As,discard:dr,stale_work:Bo,badges:[...Fi,...qt?["\u23F8 REVISE \uD30C\uD0B9"]:[]],alert:!!qt,revise_action:!!qt,revise_enabled:!!qt&&!dr&&!pe.has(de.bead_id),revise_title:qt?qt.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${qt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:W==="done"?lr(f.attempts||{},de.bead_id):null,work_ms:W==="done"?yo(f.attempts||{},de.bead_id):null,done_at:W==="done"&&typeof de.added_at=="number"?de.added_at:void 0,exec_chips:dt?Re(de.bead_id):null,...Br(de.bead_id)}}),dn=f.attempts?Object.values(f.attempts):[],Do=new Set;for(let h of dn)h&&typeof h.resumed_from=="string"&&h.resumed_from.length>0&&Do.add(h.resumed_from);let mi=new Map;for(let h of dn)mi.set(h.bead_id,h.attempt_id);let ys=new Map;for(let h of dn)ys.set(h.attempt_id,h);function No(h){let W=new Set,de=h;for(;de&&!W.has(de.attempt_id);){if(de.conflict_resolution===!0)return!0;W.add(de.attempt_id),de=typeof de.resumed_from=="string"&&de.resumed_from.length>0&&ys.get(de.resumed_from)||null}return!1}let vs=typeof f.declared_base=="string"?f.declared_base:null;function sp(h){let W=null;for(let de of dn)!de||de.bead_id!==h||No(de)||(W===null||(typeof de.started_at=="number"?de.started_at:0)>=(typeof W.started_at=="number"?W.started_at:0))&&(W=de);return W&&typeof W.target_base=="string"?W.target_base:null}let gi=[],hi=[],op=_d(f),bi=h=>{let W=typeof h.session_id=="string"&&h.session_id.length>0,de=Do.has(h.attempt_id);return{eligible:W&&!de,reason:W?de?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},ur=null;for(let h of dn){let W=h.status==="paused"&&!Do.has(h.attempt_id);if(h.status==="running"||W)hi.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:et.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,speed:h.speed||null,continuation_mode:h.continuation_mode||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,paused:W,conflict_resolution:No(h),base_exception:ii(vs,h.target_base),can_pause:typeof h.session_id=="string"&&h.session_id.length>0,discard:yr(bs,h.bead_id,{attempt_id:h.attempt_id}),usage:lr(f.attempts||{},h.bead_id),rollup:ut(h.bead_id),rollup_expanded:_e.has(h.bead_id),exec_chips:J(h),...Br(h.bead_id)});else if((h.status==="failed"||h.status==="orphaned")&&op(h)){let de=bi(h);gi.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:et.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,speed:h.speed||null,continuation_mode:h.continuation_mode||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,failed:!0,status:h.status,status_label:h.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:yr(bs,h.bead_id,{attempt_id:h.attempt_id}),resume_eligible:de.eligible,resume_reason:de.reason,conflict_resolution:No(h),base_exception:ii(vs,h.target_base),usage:lr(f.attempts||{},h.bead_id),rollup:ut(h.bead_id),rollup_expanded:_e.has(h.bead_id),exec_chips:J(h),...Br(h.bead_id)}),ur=h}}let ws=[...gi,...hi].map(h=>{let W=ys.get(h.attempt_id),de=W?.quickfix_landing;if(W?.quickfix_lane!==!0||!de||typeof de!="object")return h;let Ve=typeof de.reason=="string"&&de.reason.length>0?de.reason:null,dt=fs({bead_id:W.bead_id,merge_sha:de.head_sha,cleanup_cursor:de.cursor,cleanup_failed:Ve?{step:de.cursor,reason:Ve}:null,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]});return dt?{...h,landing:dt}:h}),yi=null;if(ur){let h=bi(ur),W=ur.cause_detail;yi={bead_id:ur.bead_id,repo:ur.repo||"",reason:ur.cause||ur.status,cause_detail:W&&typeof W.reason=="string"?{reason:W.reason,command:typeof W.command=="string"?W.command:null}:null,resume_attempt_id:ur.attempt_id,resume_eligible:h.eligible,resume_reason:h.reason,discard:yr(bs,ur.bead_id,{attempt_id:ur.attempt_id})}}let vi=new Set(ws.map(h=>h.bead_id)),qo=Array.isArray(f.merge_queue)?f.merge_queue:[],wi=new Map,ki=new Map,$i=new Map,xi=new Map,Ai=new Map;qo.forEach((h,W)=>{h&&typeof h.bead_id=="string"&&(wi.set(h.bead_id,W+1),ki.set(h.bead_id,h.resolution),$i.set(h.bead_id,h.continuation_action||null),xi.set(h.bead_id,h.head_review||null),Ai.set(h.bead_id,h.authority||null))});let pn=f.merge_queue_state||{active:null,failures:{}},ap=pn.failures||{},Si=pn.waiting&&typeof pn.waiting.bead_id=="string"&&typeof pn.waiting.reason=="string"?pn.waiting:null,ip=f.auto_merge_skips||{},Ei=h=>{let W=ip[h];if(!W)return null;let de=cn[h],Ve=de&&de.pr?de.pr.head_sha:null;return Ve&&Ve===W.head_sha?W.reason||"":null},ks=new Map;for(let h of ws)h.failed!==!0&&h.conflict_resolution&&(h.paused?ks.has(h.bead_id)||ks.set(h.bead_id,"paused"):ks.set(h.bead_id,"running"));let Ti=ws.filter(h=>!h.paused&&h.failed!==!0).length,Ci=(f.workspace_info||{}).slots,Ri=typeof Ci=="number"?Ci:typeof f.slots=="number"?f.slots:Io,lp=Ti>Ri,$s=Kr(N),cp=(Array.isArray(f.done)?f.done.slice():[]).filter(h=>$s===void 0||typeof h.added_at!="number"||h.added_at>=$s).sort((h,W)=>(W.added_at||0)-(h.added_at||0)),Pn=Mo(cp,"done"),up=new Set((Array.isArray(f.done)?f.done:[]).map(h=>h?.bead_id).filter(h=>typeof h=="string")),Li=[],dp=u?.()||"";for(let h of _){let W=Qr(h.closed_at);if(typeof h.id!="string"||up.has(h.id)||W===null||$s!==void 0&&W<$s||typeof h.comment_count!="number"||h.comment_count<=0)continue;let de=`${dp}\0${h.id}\0${String(h.updated_at)}\0${h.comment_count}`,Ve=P.get(de);Ve===void 0&&r&&(P.set(de,"pending"),Promise.resolve(r("get-comments",{id:h.id})).then(dt=>{let Ut=Array.isArray(dt)&&dt.some(qt=>lo(typeof qt?.text=="string"?qt.text:"")?.lane==="session");P.set(de,Ut?"session":"not-session"),y()}).catch(()=>{P.set(de,"failed"),y()})),Ve==="session"&&Li.push({id:h.id,title:h.title||h.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:W,created_at:h.created_at,updated_at:h.updated_at})}Pn.push(...Li),Pn.sort((h,W)=>(W.done_at||0)-(h.done_at||0));let xs={};for(let h of kr)xs[h]=0;let Ii=!1,Oi=0,Fo=0,Pi=0;for(let h of Pn){let W=h.usage;if(W&&typeof W=="object"){let de=!1;for(let Ve of kr)Number.isFinite(W[Ve])&&(xs[Ve]+=W[Ve],Ii=!0,de=!0);de&&(Fo+=1,Number.isFinite(W.total_cost_usd)&&(Oi+=W.total_cost_usd,Pi+=1))}}Fo>0&&Pi===Fo&&(xs.total_cost_usd=Oi);let Mi=Pn.map(h=>h.usage).filter(h=>h&&typeof h=="object"&&h.providers),pp=Mi.length>0?zt(Vs(Mi)):Ii?$r(xs):null,fp=f.lane_states&&typeof f.lane_states=="object"&&!Array.isArray(f.lane_states)?f.lane_states:{},_p=Array.isArray(f.serial_lanes)?f.serial_lanes:[],Di=h=>{if(Ur.some(Ve=>Ve.bead_id===h))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let W=dn.filter(Ve=>Ve&&Ve.bead_id===h),de=W.length>0?W[W.length-1].status:null;return de==="failed"||de==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":de==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},Ni=_p.filter(h=>h&&typeof h.id=="string"&&Array.isArray(h.entries)).map((h,W)=>{let de=fp[h.id]||{},Ve=new Map((Array.isArray(de.corrections)?de.corrections:[]).filter(Et=>Et&&typeof Et.bead_id=="string"&&typeof Et.after=="string").map(Et=>[Et.bead_id,Et.after])),dt=Mo(h.entries.filter(Et=>!vi.has(Et.bead_id)),h.id).map(Et=>Ve.has(Et.id)?{...Et,badges:[`\u{1F517} ${Ve.get(Et.id)} \uB4A4 (blocks \uC790\uB3D9)`,...Et.badges]}:Et),Ut=Array.isArray(de.occupied_by)?de.occupied_by.filter(Et=>typeof Et=="string"):[],qt=Ut.map(Et=>({id:Et,title:et.get(Et)||Et,draggable:!1,lane:h.id,ghost:!0,badges:[Di(Et)]}));return{id:h.id,index:W+1,rows:[...qt,...dt],occupied:Ut.length>0,badge:Ut.length>0?Di(Ut[0]):"\uB300\uAE30",cycle:de.cycle===!0}}),mp=typeof f.serial_lane_count=="number"?f.serial_lane_count:Ni.length;return{queue:f,idToTitle:et,candidates:rp,candidate_hidden:{blocked:Po.hidden_blocked,spec:Po.hidden_spec},running:ws,live_count:Ti,slots:Ri,over_cap:lp,failure:yi,waiting:Mo(un.filter(h=>!vi.has(h.bead_id)),"queue"),serial_lanes:Ni,serial_lane_count:mp,pr_wait:Ur.map(h=>Nh(h.bead_id,et.get(h.bead_id)||h.bead_id,cn,We[h.bead_id]||null,lr(f.attempts||{},h.bead_id),hs[h.bead_id]||(M.has(h.bead_id)||G.has(h.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),ks.get(h.bead_id)||null,h.external===!0,{position:wi.get(h.bead_id)||0,active:pn.active===h.bead_id,failure:ap[h.bead_id]||null,waiting:Si?.bead_id===h.bead_id?Si.reason:null,resolution:ki.get(h.bead_id),continuation_action:$i.get(h.bead_id),head_review:xi.get(h.bead_id)||null,authority:Ai.get(h.bead_id)||null},h.wt_present!==!1,f.auto_merge===!0?Ei(h.bead_id):null,ii(vs,sp(h.bead_id)),f.completion_status&&typeof f.completion_status=="object"&&!Array.isArray(f.completion_status)&&f.completion_status[h.bead_id]||null,f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},ys.get(mi.get(h.bead_id)||"")?.worker_serial===!0,f.auto_merge===!0,{merge_sha:h.merge_sha,cleanup_cursor:h.cleanup_cursor,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]})).map(h=>({...h,...Br(h.id)})),merge_queue_length:qo.length,merge_queue_running:qo.length>0,auto_excluded:Ur.map(h=>h.bead_id).filter(h=>Ei(h)!==null),declared_base:vs,done:Pn,token_total:pp,cleanup_failures:Lt,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]}}function ie(){let k=!!o?.get()?.job,z=!k&&o?.isPending?.()===!0,_=k?"\uBD84\uC11D \uC911":z?"\uC900\uBE44 \uC911":"";return l`<button
      type="button"
    ...
    </button>`}function Ce(f){let k=f.waiting.length>0?f.waiting[0].id:"\u2014",z=l`<button
      type="button"
    ...
    >`,Ue=l`<label class="worker-tgl worker-slots"
      ...
      <label
        ...
        <select class="worker-serial-lane-count" aria-label="직렬 레인 수">
          ${Array.from({length:Cd},(J,O)=>O+1).map(J=>l`<option
                value=${String(J)}
      ...
      ${o?ie():""} `,$e=gu({failure:f.failure}),x=cu(f.repo_operations,f.cleanup_failures);return A?l`<div class="worker-ribbon">
        ...
        <div class="worker-kpi">
          ${b}${ce}${le}
          ${(Array.isArray(f.token_total)?f.token_total:f.token_total?[{label:f.token_total,tooltip:`${I()} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}]:[]).map(J=>l`<span
                class="worker-kpi__chip worker-kpi__chip--tokens"
                title=${J.tooltip}
                >${I()} 완료 · 누적 ${J.label}</span
              >`)}
      ...
      ${x}${Qe.template()}${$e}`}function Ae(f){if(f.running.length===0&&f.pr_wait.length===0)return"";let k=f.running.some(z=>!z.paused&&z.failed!==!0);return l`<section
    ...
    >
    ...
    </section>`}function Pe(f){let k=f.candidate_hidden;return l`<div class="worker-filter">
      ...
      .value=${V}
    >
      ${vh.map(f=>l`<option value=${f.value} ?selected=${V===f.value}>
            ${f.label}
          </option>`)}
      ...
      <select
        ...
        .value=${N}
      >
        ${Rr.map(f=>l`<option value=${f.value} ?selected=${N===f.value}>
              ${f.label}
            </option>`)}
      </select>
    </div>`}function bt(f){let k=l`<span
      class="worker-lane__badge${f.occupied?" worker-lane__badge--held":""}"
      >${f.badge}</span
    >`,z=f.cycle?l`<div class="worker-lane__cycle">
          ⚠ blocks 순환 감지 — 자동 정렬을 생략했습니다
        </div>`:"";return sr({id:`worker-pane-lane-${f.id}`,lane:f.id,title:`\uC9C1\uB82C ${f.index}`,items:f.rows,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uD589\uC744 \uC5EC\uAE30\uB85C \uB4DC\uB798\uADF8",header_control:k,controls:z})}function Ke(f){let k=f.queue.auto_merge===!0;if(f.merge_queue_running)return l`<button
        type="button"
    ...
    >
      ▶ 자동 머지${_>0?` ${_}`:""}
    </button>`}function Ft(f){let k=sr({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:f.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Be(),controls:Pe(f),place_menu:yt(f.candidates)});return A?l`<div class="worker-lanes worker-lanes--mobile">
        ${Ae(f)}
        ...
        ${k}
        ${sr({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:f.done,empty:`${I()} \uC644\uB8CC \uC5C6\uC74C`,controls:St(),collapsible:!0,collapsed:R.done,preview:Array.isArray(f.token_total)?f.token_total.map(z=>z.label).join(" \xB7 "):f.token_total||Id(f.done)})}
      ...
      ${sr({id:"worker-pane-done",lane:"done",title:`\uC644\uB8CC \xB7 ${I()} ${f.done.length}`,items:f.done,empty:`${I()} \uC644\uB8CC \uC5C6\uC74C`,controls:St()})}
    </div>`}function v(f){R={...R,[f]:!R[f]},Eh(R),y()}function y(){let f=B();Ye(Ce(f),K),Ye(Ft(f),wt)}function L(){if(typeof window.matchMedia!="function")return;let f=window.matchMedia(Ah);A=!!f.matches;let k=z=>{let _=!!(z&&typeof z.matches=="boolean"?z.matches:f.matches);_!==A&&(A=_,y())};typeof f.addEventListener=="function"?(f.addEventListener("change",k),oe.push(()=>f.removeEventListener("change",k))):typeof f.addListener=="function"&&(f.addListener(k),oe.push(()=>f.removeListener(k)))}let X=null;function be(f){X=f.target instanceof Element?f.target:null}function ye(f){let z=f.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!z)return;if(X&&z.contains(X)&&X.closest("input, button, a")){f.preventDefault();return}let _=z.dataset.beadId||"",b=z.dataset.lane||"";T={bead_id:_,from_lane:b};try{f.dataTransfer?.setData("text/plain",_),f.dataTransfer&&(f.dataTransfer.effectAllowed="move")}catch{}}function Ne(f){let k=f.target?.closest?.(".worker-pane");if(!k)return;let z=k.dataset.lane||"";z!=="candidate"&&z!=="queue"&&!/^s[1-5]$/.test(z)||(f.preventDefault(),f.dataTransfer&&(f.dataTransfer.dropEffect="move"),k.classList.add("worker-pane--drag-over"))}function Me(f){f.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function ft(f,k){let z=D.find(le=>le.id===f);if(!z)return;let _=D.filter(le=>le.id!==f),b=_.length;if(k){let le=k.dataset.beadId;if(le===f)return;let Ue=_.findIndex($e=>$e.id===le);Ue>=0&&(b=Ue)}let ce=_.slice();ce.splice(b,0,z),$.applyReorder(f,ce,b)}function $t(f){let k=f.target?.closest?.(".worker-pane");if(!k)return;f.preventDefault(),k.classList.remove("worker-pane--drag-over");let z=k.dataset.lane||"",_=T?.bead_id||f.dataTransfer?.getData("text/plain")||"",b=T?.from_lane||"";if(T=null,!_)return;let ce=f.target?.closest?.(".worker-mini, .worker-card"),le=Array.from(k.querySelectorAll(".worker-mini, .worker-card")),Ue=le.length;if(ce){let $e=le.indexOf(ce);$e>=0&&(Ue=$e)}if(Ue=Math.max(0,Ue-k.querySelectorAll(".worker-mini--ghost").length),k.classList.contains("worker-pane--collapsed")&&(Ue=Q()),z==="candidate"){if(b==="candidate"){ft(_,ce);return}(b==="queue"||/^s[1-5]$/.test(b))&&qe(_);return}if(z==="queue"||/^s[1-5]$/.test(z)){let $e=z==="queue"?"parallel":z;b===z?re(_,$e,Ue):Ee(_,$e)}}function jt(f){H=f,hh(f),y()}function Ge(f){V=f==="board"||f==="created"||f==="spec"?f:Oo,kh(V),y()}function Ot(f){N=ar(f)?f:er,xh(N),p?.(N),y()}function Fe(f){let k=f.target?.closest?.(".worker-serial-lane-count");if(k){let Ue=Number.parseInt(k.value,10);Number.isFinite(Ue)&&C(Ue).then(y);return}let z=f.target?.closest?.(".worker-filter__blocked");if(z){jt({...H,show_blocked:z.checked});return}let _=f.target?.closest?.(".worker-done-range");if(_){Ot(_.value);return}let b=f.target?.closest?.(".worker-sort");if(b){Ge(b.value||Oo);return}let ce=f.target?.closest?.(".worker-slots__input");if(!ce)return;let le=Number.parseInt(ce.value,10);if(!Number.isFinite(le)){y();return}w(le).then(y)}function S(f){return f?{runner:f.runner||void 0,model:f.model||void 0,effort:f.effort||void 0,worktree:f.worktree||void 0,status:f.status||void 0,session_id:f.session_id||void 0}:{}}function ue(){let f=B();return{operations:f.repo_operations,cleanup_failures:f.cleanup_failures,repo:u&&u()||""}}function Oe(){He&&st.close(),Ze.hidden=!1,ge.hidden=!1,Y.open(ue()),y()}function mt(f){let k=ot(),z=k.attempts?k.attempts[f]:null;He=f,pt=null,Y.close(),Ze.hidden=!0,ge.hidden=!1,st.open({attempt_id:f,meta:S(z)}),y()}function Dt(f,k){He=null,pt=f,Y.close(),Ze.hidden=!0,ge.hidden=!1,st.open({attempt_id:f,meta:k,hide_prompt:!0}),y()}function xt(){if(Y.isOpen()&&Y.refresh(ue()),pt){let z=(o?.get()?.runs||[]).find(_=>_.run_id===pt);z?st.updateMeta(oi(z)):st.close();return}if(!He)return;let f=ot(),k=f.attempts?f.attempts[He]:null;if(k){st.updateMeta(S(k));return}st.close()}function Nt(f){let k=f.target;if(k?.closest?.(".worker-mini__serial, .worker-mini__grip")||k?.closest?.("#worker-parallel-analysis-dialog"))return;if(k?.closest?.(".worker-analysis-btn")){je?.open();return}if(k?.closest?.(".worker-repo-strip")||k?.closest?.(".worker-mini__timeline")){Oe();return}let z=k?.closest?.(".worker-repo-op__session");if(z){let We=z.dataset.attemptId;We&&mt(We);return}let _=k?.closest?.(".worker-repo-op__resolve");if(_){ne(_.dataset.operationId||"");return}let b=k?.closest?.(".worker-repo-op__dismiss");if(b){ve(b.dataset.operationId||"");return}let ce=k?.closest?.(".worker-cleanup__resume");if(ce){let We=ce.dataset.beadId;We&&ht(We);return}let le=k?.closest?.(".worker-banner__resume");if(le){let We=le.dataset.attemptId;We&&it(We);return}let Ue=k?.closest?.(".worker-banner__discard");if(Ue){let We=Ue.dataset.confirmation==="merged"?"merged":"unmerged";he(Ue.dataset.beadId||"",Ue.dataset.attemptId||null,We,Ue.dataset.operationId||null);return}let $e=k?.closest?.(".worker-banner__dismiss");if($e){let We=$e.dataset.attemptId;We&&Xe(We);return}if(k?.closest?.(".worker-play")){F(!ot().auto_advance);return}let x=k?.closest?.(".worker-merge-all");if(x){x.classList.contains("worker-merge-all--stop")?ot().auto_merge===!0?kt(!1):te():kt(!0);return}let J=k?.closest?.(".worker-pane__hd--toggle");if(J){let We=J.dataset.lane;(We==="queue"||We==="done")&&v(We);return}let O=k?.closest?.(".worker-card__place-lane");if(O){let We=O.dataset.beadId,Lt=O.dataset.lane;We&&(Lt==="parallel"||/^s[1-5]$/.test(Lt||""))&&(se=null,y(),Ee(We,Lt));return}if(k?.closest?.(".worker-card__place-cancel")){se=null,y();return}let ut=k?.closest?.(".worker-card__place");if(ut){let We=ut.dataset.beadId;We&&!ut.disabled&&(Je()?(se=We,y()):Ee(We,"parallel"));return}let lt=k?.closest?.(".worker-filter__chip");if(lt){let We=lt.dataset.spec;(We==="all"||We==="with"||We==="without")&&jt({...H,spec:We});return}let et=k?.closest?.(".worker-mini__merge");if(et){let We=et.dataset.beadId||"";ot().cleanup_failed?.[We]?ht(We):_t(We);return}let tt=k?.closest?.(".worker-mini__merge-cancel");if(tt){q(tt.dataset.beadId||"");return}let Pt=k?.closest?.(".worker-mini__discard");if(Pt){he(Pt.dataset.beadId||"",Pt.dataset.attemptId||null,Pt.dataset.discardMode==="merged"?"merged":"unmerged",Pt.dataset.operationId||null);return}let Jt=k?.closest?.(".worker-mini__stale-continue");if(Jt){ze("worker-stale-work-continue",Jt.dataset.beadId||"",Jt.dataset.actionId||"");return}let on=k?.closest?.(".worker-mini__stale-backup");if(on){ze("worker-stale-work-backup-fresh",on.dataset.beadId||"",on.dataset.actionId||"");return}let an=k?.closest?.(".worker-mini__stale-recheck");if(an){ze("worker-stale-work-recheck",an.dataset.beadId||"",an.dataset.actionId||"");return}let gs=k?.closest?.(".worker-mini__revise-fix");if(gs){De("worker-revise-fix",gs.dataset.beadId||"");return}let ln=k?.closest?.(".worker-mini__revise-approve");if(ln){De("worker-revise-approve",ln.dataset.beadId||"");return}if(k?.closest?.(".worker-mini__pr"))return;if(k?.closest?.(".rtile__discard")){let We=k?.closest?.(".rtile"),Lt=We?.dataset?.beadId,un=We?.dataset?.attemptId;Lt&&he(Lt,un||null,"unmerged",k?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if(k?.closest?.(".rtile__dismiss")){let Lt=k?.closest?.(".rtile")?.dataset?.attemptId;Lt&&Xe(Lt);return}if(k?.closest?.(".rtile__pause")){let Lt=k?.closest?.(".rtile")?.dataset?.attemptId;Lt&&rt(Lt);return}if(k?.closest?.(".rtile__resume")){let Lt=k?.closest?.(".rtile")?.dataset?.attemptId;Lt&&it(Lt);return}if(k?.closest?.(".rtile__session")){let Lt=k?.closest?.(".rtile")?.dataset?.attemptId;Lt&&mt(Lt);return}if(k?.closest?.(".worker-drawer-overlay__backdrop")){Y.close(),st.close();return}if(k?.closest?.(".worker-drawer-host"))return;let Br=k?.closest?.(".rtile .board-card__roll-toggle");if(Br){let We=Br.dataset.rollParent;We&&(_e.has(We)?_e.delete(We):_e.add(We),y());return}let Ur=k?.closest?.(".rtile .board-card__roll-child");if(Ur){let We=Ur.dataset.childId;We&&c&&c(We);return}let cn=k?.closest?.(".rtile");if(cn){if(k?.closest?.(".rtile__id")){let Lt=cn.dataset.beadId;Lt&&tr(Lt).then(un=>{un?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let We=cn.dataset.beadId;We&&c&&c(We);return}let hs=k?.closest?.(".worker-mini, .worker-card");if(hs){let We=hs.dataset.beadId;if(k?.closest?.(".worker-mini__id, .worker-card__id")){We&&tr(We).then(Lt=>{Lt?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}We&&c&&c(We)}}return e.addEventListener("pointerdown",be),e.addEventListener("dragstart",ye),e.addEventListener("dragover",Ne),e.addEventListener("dragleave",Me),e.addEventListener("drop",$t),e.addEventListener("click",Nt),e.addEventListener("change",Fe),L(),m&&oe.push(m.subscribe(()=>{for(let[f,k]of P)k==="failed"&&P.delete(f);y()})),s&&oe.push(s.subscribe(()=>{let f=u&&u()||"";f!==Se&&(Se=f,Z.close()),y(),xt()})),o&&typeof o.subscribe=="function"&&oe.push(o.subscribe(()=>{xt(),y()})),y(),{load(){g(),y()},refreshSessionDefaults:j,destroy(){for(let f of oe.splice(0))try{f()}catch{}e.removeEventListener("pointerdown",be),e.removeEventListener("dragstart",ye),e.removeEventListener("dragover",Ne),e.removeEventListener("dragleave",Me),e.removeEventListener("drop",$t),e.removeEventListener("click",Nt),e.removeEventListener("change",Fe);try{st.destroy()}catch{}ge.hidden=!0;try{je?.destroy()}catch{}try{Z.destroy()}catch{}Ye(l``,e)}}}function ci(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Fd(e,t,r,n=async()=>{},s=async()=>{}){let o=Ct("views:workspace-picker"),a=null,i=!1,c=!1,u=!1;async function d(R){let M=R.target.value,pe=t.getState().workspace?.current?.path||"";if(M&&M!==pe){o("switching workspace to %s",M),i=!0,I();try{await r(M)}catch(fe){o("workspace switch failed: %o",fe)}finally{i=!1,I()}}}async function p(){let R=t.getState(),A=R.workspace?.current?.path||R.workspace?.available?.[0]?.path||"";if(!(!A||c)){o("git-pulling workspace %s",A),c=!0,I();try{await n(A)}catch(M){o("workspace git pull failed: %o",M)}finally{c=!1,I()}}}function m(R){let A=R.target;A&&e.contains(A)||D()}function $(R){R.key==="Escape"&&D()}function T(){u||(u=!0,document.addEventListener("mousedown",m),document.addEventListener("keydown",$),I())}function D(){u&&(u=!1,document.removeEventListener("mousedown",m),document.removeEventListener("keydown",$),I())}function H(){u?D():T()}async function se(R){let A=R.target,M=A.value,G=A.checked;o("toggling visibility %s \u2192 %s",M,String(G));try{await s(M,G)}catch(pe){o("workspace visibility toggle failed: %o",pe)}}function V(R){return R?l`
      <button
        type="button"
    ...
    `}function P(){let R=t.getState(),A=R.workspace?.current,M=R.workspace?.available||[],G=new Set(R.workspace?.hidden||[]),pe=A?.path||M[0]?.path||"";if(M.length===0)return l``;let fe=M.filter(_e=>!G.has(_e.path)||_e.path===pe);if(fe.length<=1){let _e=fe[0]||M[0],ae=ci(_e.path);return l`
