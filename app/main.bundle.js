...
`,e=e.substring(b.length+1),u=!0),!u){let L=this.rules.other.nextBulletRegex(A),q=this.rules.other.hrRegex(A),Y=this.rules.other.fencesBeginRegex(A),X=this.rules.other.headingBeginRegex(A),z=this.rules.other.htmlBeginRegex(A);for(;e;){let I=e.split(`
`,1)[0],S;if(b=I,this.options.pedantic?(b=b.replace(this.rules.other.listReplaceNesting,"  "),S=b):S=b.replace(this.rules.other.tabCharGlobal,"    "),Y.test(b)||X.test(b)||z.test(b)||L.test(b)||q.test(b))break;if(S.search(this.rules.other.nonSpaceChar)>=A||!b.trim())p+=`
...
`).trim()}}var Kl=20;function Yl(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function a_(e){return e.length>Kl?`${e.slice(0,Kl)}\u2026`:e}function i_(e,t,r,n){let s=`${t.lane} ${a_(t.identifier)}`;return l`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${d_.map(f=>{let b=f.receipt&&typeof t[f.receipt]=="string"?String(t[f.receipt]):"",R=n[f.id],A=b.length>0||R?.fill==="full",L=!A&&R?.fill==="dim",q=R?.stale===!0;return l`<span
    ...
    `:l``}function p(){Qe(d(),e)}async function f(A,L={}){s=A,o="loading",a="",i="",p();let q=r?r():"";if(!q){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",i="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let Y="/api/doc?workspace="+encodeURIComponent(q)+"&path="+encodeURIComponent(A);try{let X=await n(Y),z=await X.json().catch(()=>({}));if(!X.ok||!z||z.ok!==!0){if(z?.error==="not_found"&&L.missing_state==="plan_pending"){o="pending",i="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",p();return}o="error",i="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(z&&z.error||X.status)+")",p();return}a=String(z.content||""),o="ready",p()}catch{o="error",i="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function b(){s=null,Qe(l``,e)}function R(){document.removeEventListener("keydown",u),b()}return{open:f,close:b,destroy:R}}var w_=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],gc="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Ks=["implementation","review-consult"],k_=["running","done","failed","interrupted"],$_={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function x_(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function A_(e){let t=xt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
  ...
  `}function M_(e){let t=cn(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    `}function Vt(m){let O=m.metadata||{},T=m.workflow||{},re=T.stages||{},Fe=re.spec&&re.spec.stale,Ke=re.impl&&re.impl.stale,Xe=re.plan||null,Ne=T.route_source==="derived",mt=T.route||O.route||"\u2014";return l`
    ...
    `}function y(){if(!d)return l``;let m=p||{},O=String(m.id||d),T=m.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",re=lt(),Fe=m.status||"open",Ke=typeof m.priority=="number"?Math.max(0,Math.min(4,m.priority)):"",Xe=m.description||"",Ne={...m,metadata:{...m.metadata||{},...f}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${E(T,re)}
          ${cc(Ne)}
          ${lc({metadata:Ne.metadata,workspace_values:g(),catalog:$(),execution_defaults:P(),expanded:L,presets:Z()?.presets||[],preset_id:b,preset_busy:R,skipped_orchestration_keys:A},{onToggle:mt=>{L=mt,v()},onEdit:(mt,sr)=>{if(mt==="impl_runtime"||mt==="impl_model"||mt==="impl_effort"){N(mt,sr??"");return}C(mt,sr??"")},onPresetSelect:mt=>{b=mt,A=[],v()},onPresetApply:()=>{qe()}})}
          ${ae(Fe,Ke)} ${H(m)}
          ${ve(Xe)}
          ${Zl(k,ge,{expanded:$e,draft:F,sending:M,error:ce})}
          ${_e(m)} ${et(m)} ${kr(m)}
          ${Vt(m)} ${_(m)}
          ${Vl(m,nr)}
          ${hc({expanded:Be,loading:Ye,error:Ee,data:ot},{onToggle:Ve})}
          ${bc(Ie(),pe,{total:re,expanded:Ze})}
        </div>
      </div>
    `}function v(){Qe(y(),e)}return{load(m){m!==d&&(f={},b="",A=[],L=!1,D(),he(),Le()),d=m,p=null,rt(),x()},clear(){d=null,p=null,f={},b="",R=!1,A=[],L=!1,D(),he(),Le(),Re.close(),Ae.close(),Qe(l``,e)},destroy(){we&&(we(),we=null),Te&&(Te(),Te=null),be&&(be(),be=null),document.removeEventListener("keydown",ze),Re.destroy(),xe.parentNode&&xe.parentNode.removeChild(xe),Ae.destroy(),je.parentNode&&je.parentNode.removeChild(je),d=null,p=null,b="",R=!1,A=[],he(),Le(),Qe(l``,e)}}}function vc(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
    ...
    ${i?l`<div class="worker-mini__row1">${b}${R}${A}</div>
          <div class="worker-mini__row2">
            ...
            ${dn(e)}`:l`<div class="worker-mini__line">
              ${d}${p}${b}${R}${A}${L}${q}${Y}${f}${X}${z}${I}${S}${D}${k}${ne}
            </div>
            ${vr(e)} ${dn(e)}`}
...
${g.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(Pe,pe)&&(P.blocked_by=Array.isArray(Pe[pe])?Pe[pe].filter(V=>typeof V=="string"&&V.length>0):[]),P};for(let G=0;G<Be.length;G++){let ee=Ie(Be[G],"queue",G,Be.length);if(!ee)continue;p.push(ee);let Oe=R.get(U);Oe?Oe.push(ee):R.set(U,[ee])}let lt=[];for(let G=0;G<Ye.length;G++){let ee=Ye[G],Oe=[];for(let pe=0;pe<ee.entries.length;pe++){let g=Ie(ee.entries[pe],ee.id,pe,ee.entries.length);g&&(Oe.push(g),p.push(g))}if(Oe.length===0)continue;let We=At(Ee[ee.id]);lt.push({id:ee.id,index:G,items:Oe,occupied_by:Array.isArray(We.occupied_by)?We.occupied_by.filter(pe=>typeof pe=="string"):[],corrections:Array.isArray(We.corrections)?We.corrections.length:0,cycle:We.cycle===!0})}A.set(U,lt);let Ze=Array.from({length:ot},(G,ee)=>{let Oe=`s${ee+1}`,We=K.get(Oe),pe=We&&Array.isArray(We.entries)?We.entries:[],g=At(Ee[Oe]);return{id:Oe,index:pe.length,length:pe.length,occupied_by:Array.isArray(g.occupied_by)?g.occupied_by.filter(x=>typeof x=="string"):[]}});for(let G of Array.isArray(k.runnable)?k.runnable:[]){let ee=G&&G.bead_id;typeof ee!="string"||Ve.has(ee)||(Ve.add(ee),i.push({...Ue(ee),title:G.title||de[ee]||ee,lane:"runnable",draggable:!0,reason:zc(he,ee),created_at:G.created_at??void 0,updated_at:G.updated_at??void 0,labels:Array.isArray(G.labels)?G.labels:[],spec_reviewer:typeof G.spec_reviewer=="string"?G.spec_reviewer:void 0,plan_state:G.plan_state==="approved"||G.plan_state==="authored"?G.plan_state:"none",workflow:G.route?{route:G.route,chips:{route:G.route}}:null,blocked:G.blocked===!0,...Array.isArray(G.blocked_by)?{blocked_by:G.blocked_by.filter(Oe=>typeof Oe=="string"&&Oe.length>0)}:{},place_index:Be.length,place_lanes:Ze}))}for(let G of se){let ee=G&&G.bead_id;if(typeof ee!="string"||Ve.has(ee)||(Ve.add(ee),o!==void 0&&typeof G.added_at=="number"&&G.added_at<o))continue;let Oe=nm(M,ee);f.push({...Ue(ee),lane:"done",done:!0,usage:zt(M,ee),done_at:typeof G.added_at=="number"?G.added_at:void 0,done_kind:Oe&&typeof Oe.done_kind=="string"?Oe.done_kind:null})}}let q=new Map;s.forEach((k,U)=>{k&&typeof k.root_dir=="string"&&q.set(k.root_dir,U)});let Y=r&&r.running_sort==="repo"?"repo":"started";u.sort((k,U)=>{if(Y==="repo"){let F=q.get(k.root_dir)??Number.MAX_SAFE_INTEGER,M=q.get(U.root_dir)??Number.MAX_SAFE_INTEGER;if(F!==M)return F-M}let ne=typeof k.started_at=="number"&&Number.isFinite(k.started_at)?k.started_at:null,ce=typeof U.started_at=="number"&&Number.isFinite(U.started_at)?U.started_at:null;return ne!==null&&ce!==null&&ne!==ce?ne-ce:ne===null&&ce!==null?1:ne!==null&&ce===null?-1:k.id.localeCompare(U.id)}),f.sort((k,U)=>(U.done_at??0)-(k.done_at??0));let X=s.length>0?s:n.map(k=>({root_dir:k&&k.root_dir,name:k&&k.name,auto_advance:k&&k.auto_advance,auto_merge:k&&k.auto_merge,slots:k&&k.slots,revision:k&&k.revision,runner_catalog:k&&k.runner_catalog})),z=[];for(let k of X){if(!k||typeof k.root_dir!="string")continue;let U=R.get(k.root_dir)||[],ne=A.get(k.root_dir)||[];z.push({root_dir:k.root_dir,name:k.name||k.root_dir,auto_advance:k.auto_advance===!0,auto_merge:k.auto_merge===!0,slots:typeof k.slots=="number"&&k.slots>=Wn?k.slots:Wn,revision:typeof k.revision=="number"?k.revision:0,runner_catalog:At(k.runner_catalog),items:U,sublanes:{parallel:U,serial:ne},serial_lane_count:L.get(k.root_dir)||0})}let I={runnable:i,queue:p,queue_groups:z,running:u,pr_wait:d,done:f,automation:{total:z.length,both_on:z.filter(k=>k.auto_advance&&k.auto_merge).length}},S=fa(I);for(let k of b)S.has(k.id)||S.set(k.id,{root_dir:k.root_dir,workspace_name:k.workspace_name,lane:"done",state:"done"});for(let k of[...I.queue,...I.runnable]){if(!Object.hasOwn(k,"blocked_by"))continue;let U=S.get(k.id);k.blockers=(k.blocked_by||[]).map(ne=>Ac(ne,U,S,s)),k.blocker_warnings=k.blockers.filter(ne=>ne.missing_internal).map(ne=>`\u26A0 \uC120\uD589 ${ne.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),k.blocker_warnings.length>0&&(k.alert=!0)}let D=Sc(I.queue_groups);for(let k of I.queue_groups)for(let U of k.sublanes.serial){let ne=D.get(Tc(k.root_dir,U.id));ne&&(U.cross_wait_peers=ne)}return I}function om(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<em;return l`<span
  ...
  `}var xm=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}],Ft="";function jt(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function pu(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(g=>ie(g,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",u=!1,d="",p={},f={},b=[],R=!1,A=null,L={},q="",Y="",X=!1,z=!1,I=!1,S=null;function D(){let g=t.queueStore?.get();return jt(g)?g.runner_catalog:null}function k(){let g=t.queueStore?.get();return jt(g)&&jt(g.execution_defaults)?g.execution_defaults:null}function U(){let g=t.implPresetStore?.get();return jt(g)&&Array.isArray(g.presets)?g:null}async function ne(){R=!0,Ie();try{let g=await r("get-session-defaults",{});p=jt(g?.values)?{...g.values}:{},f={...p},b=Array.isArray(g?.warnings)?g.warnings:[]}catch(g){b=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${g instanceof Error?g.message:String(g)}`)}finally{R=!1,Ie()}}async function ce(){let g=rc(p,f);if(Object.keys(g).length!==0){try{let x=await r("set-session-defaults",{values:g});p=jt(x?.values)?{...x.values}:{},f={...p},b=Array.isArray(x?.warnings)?x.warnings:[]}catch(x){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${x instanceof Error?x.message:String(x)}`)}Ie()}}function F(g,x){x===Ft?delete f[g]:f[g]=x,Ie(),ce()}async function M(){let g=t.queueStore?.get();if(!jt(g))return;let x={orchestration_model:g.orchestration_model??null,orchestration_effort:g.orchestration_effort??null,orchestration_speed:g.orchestration_speed??null},$=nc(x,{...x,...L});if(Object.keys($).length!==0){try{let P=await r("worker-queue-set-orchestration-defaults",{expected_revision:g.revision,values:$});if(P&&P.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}L={}}catch(P){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${P instanceof Error?P.message:String(P)}`)}Ie()}}function de(g,x){L[g]=x===Ft?null:x,Ie(),M()}async function $e(g){let x=t.queueStore?.get();if(!(!jt(x)||g<1)){try{await r("worker-queue-set-slots",{expected_revision:x.revision,slots:g})}catch($){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${$ instanceof Error?$.message:String($)}`)}Ie()}}function he(){let g={},x=Be();for(let $ of Jl){let P=Cr.includes($)?x[$]:f[$];typeof P=="string"&&P.length>0&&(g[$]=P)}return g}async function De(){let g=U();if(!g)return;let x=he();if(Object.keys(x).length===0){o("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let $=(g.presets||[]).find(V=>V.id===q),P=Y.trim()||($?$.name:"");if(!P){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let V=$?await r("impl-preset-update",{expected_revision:g.revision,id:$.id,name:P,settings:x}):await r("impl-preset-create",{expected_revision:g.revision,name:P,settings:x});if(V&&V.applied){if(Y="",!$&&Array.isArray(V.presets)){let Z=V.presets.find(oe=>oe.name===P);q=Z?Z.id:q}Ie()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Ie()}catch(V){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}}async function Je(){let g=U();if(!(!g||q.length===0))try{let x=await r("impl-preset-delete",{expected_revision:g.revision,id:q});x&&x.applied?(q="",Ie()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Ie())}catch(x){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${x instanceof Error?x.message:String(x)}`)}}async function He(){let g=U(),x=t.queueStore?.get();if(!(!g||!jt(x)||q.length===0)){try{let $=await r("apply-impl-preset-global",{preset_id:q,expected_revision:g.revision,expected_queue_revision:x.revision});$&&$.applied?(p=jt($.values)?{...$.values}:{},f={...p},b=Array.isArray($.warnings)?$.warnings:[],jt($.queue)&&(t.queueStore?.set?.($.queue),L={}),$.queue_applied===!1&&o("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694")):$&&$.conflict&&o("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch($){o(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${$ instanceof Error?$.message:String($)}`)}Ie()}}async function fe(){z=!0,I=!1,Ie();try{let g=await r("get-worker-system-prompt",{});!g||typeof g!="object"||Array.isArray(g)?I=!0:S=g}catch{I=!0}finally{z=!1,Ie()}}function Pe(){if(X=!X,X&&!S){fe();return}Ie()}function ge(){let g=cn({loading:z,error:I});if(g)return g;if(!S)return"";let x=Array.isArray(S.variants)?S.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${X?ge():""}
    </section>`}function Re(g,x,$,P,V,Z){let oe=V[g]??Ft,ue=sa(g,$,V,k(),D()),qe=ue.options.find(Te=>Te.value===oe),we=oe===Ft?ue.full_value:qe?.full_value;return l`<select
      ...
      ${oe===Ft?l`<span class="settings-dialog__source-badge">기본</span>`:""}`}function je(g,x,$,P,V,Z=!1){return l`<div
    ...
    </div>`}function Be(){let g=t.queueStore?.get(),x={};for(let $ of Cr)x[$]=Object.prototype.hasOwnProperty.call(L,$)?L[$]:jt(g)&&typeof g[$]=="string"?g[$]:null;return x}function Ye(){let g=D(),x=f.impl_runtime,$=f.impl_model,P=U(),V=t.queueStore?.get(),Z=Be(),oe=Gs(g,A),ue=un(g,A||void 0,Z.orchestration_model||lr).filter(be=>be!==lr),qe=jt(V)&&typeof V.slots=="number"?V.slots:2,we=k()?.supported===!0,Te=sa("workflow_mode",Dn,f,k(),g);return l`
      <section
                ...
                <div class="settings-dialog__row">
                  ...
                  <span class="settings-dialog__controls">
                    <select
                      ...
                      .value=${zr(A||Ft)}
                      @change=${be=>{let ze=String(be.target.value);A=ze===Ft?null:ze,Ie()}}
                    >
                      <option
                        value=${Ft}
                        ?selected=${!A}
    ...
    `}function Ee(){let g=n.get();return l`
      ...
      >
        ...
        ${g?l`
              ${cu(g,s(),se)}
              ${uu(g,d,{onDraft:x=>{d=x},onAdd:Le,onRemove:Ue})}
              ${du(g,Ve)}
    ...
    </span>`}function Y(F,M,de){let $e=M.available&&typeof M.ageSeconds=="number"&&M.ageSeconds>_u,he=$e&&typeof M.ageSeconds=="number"?`${Math.floor(M.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",De=M.accounts.filter(Je=>!Je.active).length;return l`<span
    ...
    </span>`}function z(F){let M=bu(F.pct);return l`<span
    ...
    </span>`}function I(F,M){return Tm.includes(M)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${F.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function S(F,M){let de=M.status==="ok",$e=typeof M.ageSeconds=="number"&&M.ageSeconds>_u,he=a.get(yu(F.key,M.number)),De=n.get(F.key),Je=De!==void 0,He=De===M.number,fe=["usage-meter__account"];return M.active&&fe.push("usage-meter__account--active"),de||fe.push("usage-meter__account--unavailable"),$e&&fe.push("usage-meter__account--stale"),l`<div class=${fe.join(" ")}>
    ...
    </div>`}function U(){let F=[];for(let he of hu){let De=o.get(he.key);De&&F.push({provider:he,snapshot:De})}if(F.length===0){p(),u();return}let M=F.some(he=>he.snapshot.accounts.length>0);M||p();let de=Date.now(),$e=X(F,de);Qe(l`${M?l`<button
            type="button"
...
${Y.prompt}</pre
    ...
    </div>`}function qe(){let w=Te&&!!I().job;if(w&&b===null){b=setInterval(()=>we(),1e3);return}!w&&b!==null&&(clearInterval(b),b=null)}function we(){let w=I();f&&w.settings.runner===f&&(f=null);let C=w.last_good?.result;qe(),Qe(l`
...
`,1)[0];if(!t.startsWith("#!"))return!1;let r=t.slice(2).trim().split(/\s+/).filter(Boolean);if(r.length===0)return!1;let n=Eu(r[0]);if(n!=="env")return Au.has(n);let s=r.slice(1).find(o=>!o.startsWith("-")&&!o.includes("="));return s!==void 0&&Au.has(Eu(s))}function Bm(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function Um(e){let t=[],r=0;Su.lastIndex=0;for(let n of e.matchAll(Su)){let s=n.index;s>r&&t.push({text:e.slice(r,s),kind:"plain"}),t.push({text:n[0],kind:Bm(n[0])}),r=s+n[0].length}return r<e.length&&t.push({text:e.slice(r),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function Wm(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function Tu(e){let t=e.getWorkspacePath,r=e.fetchImpl||globalThis.fetch?.bind(globalThis),n=document.createElement("div");n.className="repo-ops-script-viewer-root",document.body.appendChild(n);let s=null,o="loading",a="",i="",u=0,d=null,p=!1;function f(S,D){return D?Um(S).map(k=>k.kind==="plain"?k.text:l`<span
            ...
            >${k.text}</span
          >`):S}function b(){if(!s)return l``;let S=o==="ready"&&jm(a),D=o==="ready"?a.split(`
`):[];return l`<div
    ...
    >
      ...
      >${S}</span
    >`}function p(I){if(typeof I!="number"||!Number.isFinite(I))return"";let S=I/6e4;return Number.isInteger(S)?`timeout ${S}\uBD84`:`timeout ${Math.round(I/1e3)}\uCD08`}function f(I){let S=p(I);return S?d("config",S):""}function b(I,S,D){return l`<button
      type="button"
...
${Ct.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:j==="done"?zt(c.attempts||{},le.bead_id):null,work_ms:j==="done"?wc(c.attempts||{},le.bead_id):null,done_at:j==="done"&&typeof le.added_at=="number"?le.added_at:void 0,...Xe(le.bead_id)}}),Yr=c.attempts?Object.values(c.attempts):[],co=new Set;for(let h of Yr)h&&typeof h.resumed_from=="string"&&h.resumed_from.length>0&&co.add(h.resumed_from);let Na=new Map;for(let h of Yr)Na.set(h.bead_id,h.attempt_id);let Zn=new Map;for(let h of Yr)Zn.set(h.attempt_id,h);function uo(h){let j=new Set,le=h;for(;le&&!j.has(le.attempt_id);){if(le.conflict_resolution===!0)return!0;j.add(le.attempt_id),le=typeof le.resumed_from=="string"&&le.resumed_from.length>0&&Zn.get(le.resumed_from)||null}return!1}let Xn=typeof c.declared_base=="string"?c.declared_base:null;function id(h){let j=null;for(let le of Yr)!le||le.bead_id!==h||uo(le)||(j===null||(typeof le.started_at=="number"?le.started_at:0)>=(typeof j.started_at=="number"?j.started_at:0))&&(j=le);return j&&typeof j.target_base=="string"?j.target_base:null}let qa=[],Fa=[],ld=ku(c),ja=h=>{let j=typeof h.session_id=="string"&&h.session_id.length>0,le=co.has(h.attempt_id);return{eligible:j&&!le,reason:j?le?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Kt=null;for(let h of Yr){let j=h.status==="paused"&&!co.has(h.attempt_id);if(h.status==="running"||j)Fa.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:y.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,speed:h.speed||null,continuation_mode:h.continuation_mode||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,paused:j,conflict_resolution:uo(h),base_exception:Ia(Xn,h.target_base),can_pause:typeof h.session_id=="string"&&h.session_id.length>0,discard:cr(Yn,h.bead_id,{attempt_id:h.attempt_id}),usage:zt(c.attempts||{},h.bead_id),current_child:_e(h.bead_id),...Xe(h.bead_id)});else if((h.status==="failed"||h.status==="orphaned")&&ld(h)){let le=ja(h);qa.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:y.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,speed:h.speed||null,continuation_mode:h.continuation_mode||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,failed:!0,status:h.status,status_label:h.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:cr(Yn,h.bead_id,{attempt_id:h.attempt_id}),resume_eligible:le.eligible,resume_reason:le.reason,conflict_resolution:uo(h),base_exception:Ia(Xn,h.target_base),usage:zt(c.attempts||{},h.bead_id),current_child:_e(h.bead_id),...Xe(h.bead_id)}),Kt=h}}let Qn=[...qa,...Fa].map(h=>{let j=Zn.get(h.attempt_id),le=j?.quickfix_landing;if(j?.quickfix_lane!==!0||!le||typeof le!="object")return h;let Ge=typeof le.reason=="string"&&le.reason.length>0?le.reason:null,pt=Un({bead_id:j.bead_id,merge_sha:le.head_sha,cleanup_cursor:le.cursor,cleanup_failed:Ge?{step:le.cursor,reason:Ge}:null,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]});return pt?{...h,landing:pt}:h}),Ba=null;if(Kt){let h=ja(Kt),j=Kt.cause_detail;Ba={bead_id:Kt.bead_id,repo:Kt.repo||"",reason:Kt.cause||Kt.status,cause_detail:j&&typeof j.reason=="string"?{reason:j.reason,command:typeof j.command=="string"?j.command:null}:null,resume_attempt_id:Kt.attempt_id,resume_eligible:h.eligible,resume_reason:h.reason,discard:cr(Yn,Kt.bead_id,{attempt_id:Kt.attempt_id})}}let Ua=new Set(Qn.map(h=>h.bead_id)),po=Array.isArray(c.merge_queue)?c.merge_queue:[],Wa=new Map,za=new Map,Ha=new Map,Ga=new Map,Va=new Map;po.forEach((h,j)=>{h&&typeof h.bead_id=="string"&&(Wa.set(h.bead_id,j+1),za.set(h.bead_id,h.resolution),Ha.set(h.bead_id,h.continuation_action||null),Ga.set(h.bead_id,h.head_review||null),Va.set(h.bead_id,h.authority||null))});let Zr=c.merge_queue_state||{active:null,failures:{}},cd=Zr.failures||{},Ka=Zr.waiting&&typeof Zr.waiting.bead_id=="string"&&typeof Zr.waiting.reason=="string"?Zr.waiting:null,ud=c.auto_merge_skips||{},Ya=h=>{let j=ud[h];if(!j)return null;let le=mt[h],Ge=le&&le.pr?le.pr.head_sha:null;return Ge&&Ge===j.head_sha?j.reason||"":null},Jn=new Map;for(let h of Qn)h.failed!==!0&&h.conflict_resolution&&(h.paused?Jn.has(h.bead_id)||Jn.set(h.bead_id,"paused"):Jn.set(h.bead_id,"running"));let Za=Qn.filter(h=>!h.paused&&h.failed!==!0).length,Xa=(c.workspace_info||{}).slots,Qa=typeof Xa=="number"?Xa:typeof c.slots=="number"?c.slots:oo,dd=Za>Qa,es=Nr(z),pd=(Array.isArray(c.done)?c.done.slice():[]).filter(h=>es===void 0||typeof h.added_at!="number"||h.added_at>=es).sort((h,j)=>(j.added_at||0)-(h.added_at||0)),_n=lo(pd,"done"),fd=new Set((Array.isArray(c.done)?c.done:[]).map(h=>h?.bead_id).filter(h=>typeof h=="string")),Ja=[],_d=d?.()||"";for(let h of H){let j=jr(h.closed_at);if(typeof h.id!="string"||fd.has(h.id)||j===null||es!==void 0&&j<es||typeof h.comment_count!="number"||h.comment_count<=0)continue;let le=`${_d}\0${h.id}\0${String(h.updated_at)}\0${h.comment_count}`,Ge=I.get(le);Ge===void 0&&r&&(I.set(le,"pending"),Promise.resolve(r("get-comments",{id:h.id})).then(pt=>{let Dt=Array.isArray(pt)&&pt.some(Ct=>js(typeof Ct?.text=="string"?Ct.text:"")?.lane==="session");I.set(le,Dt?"session":"not-session"),Q()}).catch(()=>{I.set(le,"failed"),Q()})),Ge==="session"&&Ja.push({id:h.id,title:h.title||h.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:j,created_at:h.created_at,updated_at:h.updated_at})}_n.push(...Ja),_n.sort((h,j)=>(j.done_at||0)-(h.done_at||0));let ts={};for(let h of _r)ts[h]=0;let ei=!1,ti=0,fo=0,ri=0;for(let h of _n){let j=h.usage;if(j&&typeof j=="object"){let le=!1;for(let Ge of _r)Number.isFinite(j[Ge])&&(ts[Ge]+=j[Ge],ei=!0,le=!0);le&&(fo+=1,Number.isFinite(j.total_cost_usd)&&(ti+=j.total_cost_usd,ri+=1))}}fo>0&&ri===fo&&(ts.total_cost_usd=ti);let ni=_n.map(h=>h.usage).filter(h=>h&&typeof h=="object"&&h.providers),md=ni.length>0?xt(xs(ni)):ei?Qt(ts):null,gd=c.lane_states&&typeof c.lane_states=="object"&&!Array.isArray(c.lane_states)?c.lane_states:{},bd=Array.isArray(c.serial_lanes)?c.serial_lanes:[],si=h=>{if(Ne.some(Ge=>Ge.bead_id===h))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let j=Yr.filter(Ge=>Ge&&Ge.bead_id===h),le=j.length>0?j[j.length-1].status:null;return le==="failed"||le==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":le==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},oi=bd.filter(h=>h&&typeof h.id=="string"&&Array.isArray(h.entries)).map((h,j)=>{let le=gd[h.id]||{},Ge=new Map((Array.isArray(le.corrections)?le.corrections:[]).filter(ut=>ut&&typeof ut.bead_id=="string"&&typeof ut.after=="string").map(ut=>[ut.bead_id,ut.after])),pt=lo(h.entries.filter(ut=>!Ua.has(ut.bead_id)),h.id).map(ut=>Ge.has(ut.id)?{...ut,badges:[`\u{1F517} ${Ge.get(ut.id)} \uB4A4 (blocks \uC790\uB3D9)`,...ut.badges]}:ut),Dt=Array.isArray(le.occupied_by)?le.occupied_by.filter(ut=>typeof ut=="string"):[],Ct=Dt.map(ut=>({id:ut,title:y.get(ut)||ut,draggable:!1,lane:h.id,ghost:!0,badges:[si(ut)]}));return{id:h.id,index:j+1,rows:[...Ct,...pt],occupied:Dt.length>0,badge:Dt.length>0?si(Dt[0]):"\uB300\uAE30",cycle:le.cycle===!0}}),hd=typeof c.serial_lane_count=="number"?c.serial_lane_count:oi.length;return{queue:c,idToTitle:y,candidates:od,candidate_hidden:{blocked:io.hidden_blocked,spec:io.hidden_spec},running:Qn,live_count:Za,slots:Qa,over_cap:dd,failure:Ba,waiting:lo(pn.filter(h=>!Ua.has(h.bead_id)),"queue"),serial_lanes:oi,serial_lane_count:hd,pr_wait:Ne.map(h=>$g(h.bead_id,y.get(h.bead_id)||h.bead_id,mt,Vr[h.bead_id]||null,zt(c.attempts||{},h.bead_id),sr[h.bead_id]||(U.has(h.bead_id)||ne.has(h.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Jn.get(h.bead_id)||null,h.external===!0,{position:Wa.get(h.bead_id)||0,active:Zr.active===h.bead_id,failure:cd[h.bead_id]||null,waiting:Ka?.bead_id===h.bead_id?Ka.reason:null,resolution:za.get(h.bead_id),continuation_action:Ha.get(h.bead_id),head_review:Ga.get(h.bead_id)||null,authority:Va.get(h.bead_id)||null},h.wt_present!==!1,c.auto_merge===!0?Ya(h.bead_id):null,Ia(Xn,id(h.bead_id)),c.completion_status&&typeof c.completion_status=="object"&&!Array.isArray(c.completion_status)&&c.completion_status[h.bead_id]||null,c.discard_operations&&typeof c.discard_operations=="object"&&!Array.isArray(c.discard_operations)?c.discard_operations:{},Zn.get(Na.get(h.bead_id)||"")?.worker_serial===!0,c.auto_merge===!0,{merge_sha:h.merge_sha,cleanup_cursor:h.cleanup_cursor,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]})).map(h=>({...h,...Xe(h.id)})),merge_queue_length:po.length,merge_queue_running:po.length>0,auto_excluded:Ne.map(h=>h.bead_id).filter(h=>Ya(h)!==null),declared_base:Xn,done:_n,token_total:md,cleanup_failures:Vn,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]}}function ze(){let _=!!o?.get()?.job,E=!_&&o?.isPending?.()===!0,H=_?"\uBD84\uC11D \uC911":E?"\uC900\uBE44 \uC911":"";return l`<button
    ...
    >`,et=l`<label class="worker-tgl worker-slots"
      ...
      ${o?ze():""} `,y=Nc({failure:c.failure}),v=kc(c.repo_operations,c.cleanup_failures);return k?l`<div class="worker-ribbon">
          ${E} ${H}
    ...
    `}function I(){let D=t.getState(),k=D.workspace?.current,U=D.workspace?.available||[],ne=new Set(D.workspace?.hidden||[]),ce=k?.path||U[0]?.path||"";if(U.length===0)return l``;let F=U.filter(M=>!ne.has(M.path)||M.path===ce);if(F.length<=1){let M=F[0]||U[0],de=Oa(M.path);return l`
