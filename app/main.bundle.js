...
`)}function A(){if(!o)return d``;let D=w(),P=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),se=i.session_id||"",Ae=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${l?"ON":"OFF"}`,ae=v(),Ee=ae?Na($(),Date.now()):"",le=B(D);return d`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
