var rf=Object.create;var _a=Object.defineProperty;var sf=Object.getOwnPropertyDescriptor;var of=Object.getOwnPropertyNames;var af=Object.getPrototypeOf,lf=Object.prototype.hasOwnProperty;var cf=(e,t,n)=>t in e?_a(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var ma=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var uf=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of of(t))!lf.call(e,s)&&s!==n&&_a(e,s,{get:()=>t[s],enumerable:!(r=sf(t,s))||r.enumerable});return e};var df=(e,t,n)=>(n=e!=null?rf(af(e)):{},uf(t||!e||!e.__esModule?_a(n,"default",{value:e,enumerable:!0}):n,e));var kt=(e,t,n)=>cf(e,typeof t!="symbol"?t+"":t,n);var Fl=ma((sy,ql)=>{var $r=1e3,xr=$r*60,Ar=xr*60,or=Ar*24,_f=or*7,mf=or*365.25;ql.exports=function(e,t){t=t||{};var n=typeof e;if(n==="string"&&e.length>0)return gf(e);if(n==="number"&&isFinite(e))return t.long?bf(e):hf(e);throw new Error("val is not a non-empty string or a valid number. val="+JSON.stringify(e))};function gf(e){if(e=String(e),!(e.length>100)){var t=/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(e);if(t){var n=parseFloat(t[1]),r=(t[2]||"ms").toLowerCase();switch(r){case"years":case"year":case"yrs":case"yr":case"y":return n*mf;case"weeks":case"week":case"w":return n*_f;case"days":case"day":case"d":return n*or;case"hours":case"hour":case"hrs":case"hr":case"h":return n*Ar;case"minutes":case"minute":case"mins":case"min":case"m":return n*xr;case"seconds":case"second":case"secs":case"sec":case"s":return n*$r;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return n;default:return}}}}function hf(e){var t=Math.abs(e);return t>=or?Math.round(e/or)+"d":t>=Ar?Math.round(e/Ar)+"h":t>=xr?Math.round(e/xr)+"m":t>=$r?Math.round(e/$r)+"s":e+"ms"}function bf(e){var t=Math.abs(e);return t>=or?Vs(e,t,or,"day"):t>=Ar?Vs(e,t,Ar,"hour"):t>=xr?Vs(e,t,xr,"minute"):t>=$r?Vs(e,t,$r,"second"):e+" ms"}function Vs(e,t,n,r){var s=t>=n*1.5;return Math.round(e/n)+" "+r+(s?"s":"")}});var Bl=ma((oy,jl)=>{function yf(e){n.debug=n,n.default=n,n.coerce=u,n.disable=a,n.enable=s,n.enabled=i,n.humanize=Fl(),n.destroy=d,Object.keys(e).forEach(p=>{n[p]=e[p]}),n.names=[],n.skips=[],n.formatters={};function t(p){let f=0;for(let g=0;g<p.length;g++)f=(f<<5)-f+p.charCodeAt(g),f|=0;return n.colors[Math.abs(f)%n.colors.length]}n.selectColor=t;function n(p){let f,g=null,w,A;function D(...W){if(!D.enabled)return;let V=D,Y=Number(new Date),N=Y-(f||Y);V.diff=N,V.prev=f,V.curr=Y,f=Y,W[0]=n.coerce(W[0]),typeof W[0]!="string"&&W.unshift("%O");let M=0;W[0]=W[0].replace(/%([a-zA-Z%])/g,(U,E)=>{if(U==="%%")return"%";M++;let R=n.formatters[E];if(typeof R=="function"){let Z=W[M];U=R.call(V,Z),W.splice(M,1),M--}return U}),n.formatArgs.call(V,W),(V.log||n.log).apply(V,W)}return D.namespace=p,D.useColors=n.useColors(),D.color=n.selectColor(p),D.extend=r,D.destroy=n.destroy,Object.defineProperty(D,"enabled",{enumerable:!0,configurable:!1,get:()=>g!==null?g:(w!==n.namespaces&&(w=n.namespaces,A=n.enabled(p)),A),set:W=>{g=W}}),typeof n.init=="function"&&n.init(D),D}function r(p,f){let g=n(this.namespace+(typeof f>"u"?":":f)+p);return g.log=this.log,g}function s(p){n.save(p),n.namespaces=p,n.names=[],n.skips=[];let f=(typeof p=="string"?p:"").trim().replace(/\s+/g,",").split(",").filter(Boolean);for(let g of f)g[0]==="-"?n.skips.push(g.slice(1)):n.names.push(g)}function o(p,f){let g=0,w=0,A=-1,D=0;for(;g<p.length;)if(w<f.length&&(f[w]===p[g]||f[w]==="*"))f[w]==="*"?(A=w,D=g,w++):(g++,w++);else if(A!==-1)w=A+1,D++,g=D;else return!1;for(;w<f.length&&f[w]==="*";)w++;return w===f.length}function a(){let p=[...n.names,...n.skips.map(f=>"-"+f)].join(",");return n.enable(""),p}function i(p){for(let f of n.skips)if(o(p,f))return!1;for(let f of n.names)if(o(p,f))return!0;return!1}function u(p){return p instanceof Error?p.stack||p.message:p}function d(){console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.")}return n.enable(n.load()),n}jl.exports=yf});var Ul=ma((Xt,Ks)=>{Xt.formatArgs=wf;Xt.save=kf;Xt.load=$f;Xt.useColors=vf;Xt.storage=xf();Xt.destroy=(()=>{let e=!1;return()=>{e||(e=!0,console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."))}})();Xt.colors=["#0000CC","#0000FF","#0033CC","#0033FF","#0066CC","#0066FF","#0099CC","#0099FF","#00CC00","#00CC33","#00CC66","#00CC99","#00CCCC","#00CCFF","#3300CC","#3300FF","#3333CC","#3333FF","#3366CC","#3366FF","#3399CC","#3399FF","#33CC00","#33CC33","#33CC66","#33CC99","#33CCCC","#33CCFF","#6600CC","#6600FF","#6633CC","#6633FF","#66CC00","#66CC33","#9900CC","#9900FF","#9933CC","#9933FF","#99CC00","#99CC33","#CC0000","#CC0033","#CC0066","#CC0099","#CC00CC","#CC00FF","#CC3300","#CC3333","#CC3366","#CC3399","#CC33CC","#CC33FF","#CC6600","#CC6633","#CC9900","#CC9933","#CCCC00","#CCCC33","#FF0000","#FF0033","#FF0066","#FF0099","#FF00CC","#FF00FF","#FF3300","#FF3333","#FF3366","#FF3399","#FF33CC","#FF33FF","#FF6600","#FF6633","#FF9900","#FF9933","#FFCC00","#FFCC33"];function vf(){if(typeof window<"u"&&window.process&&(window.process.type==="renderer"||window.process.__nwjs))return!0;if(typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/))return!1;let e;return typeof document<"u"&&document.documentElement&&document.documentElement.style&&document.documentElement.style.WebkitAppearance||typeof window<"u"&&window.console&&(window.console.firebug||window.console.exception&&window.console.table)||typeof navigator<"u"&&navigator.userAgent&&(e=navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/))&&parseInt(e[1],10)>=31||typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)}function wf(e){if(e[0]=(this.useColors?"%c":"")+this.namespace+(this.useColors?" %c":" ")+e[0]+(this.useColors?"%c ":" ")+"+"+Ks.exports.humanize(this.diff),!this.useColors)return;let t="color: "+this.color;e.splice(1,0,t,"color: inherit");let n=0,r=0;e[0].replace(/%[a-zA-Z%]/g,s=>{s!=="%%"&&(n++,s==="%c"&&(r=n))}),e.splice(r,0,t)}Xt.log=console.debug||console.log||(()=>{});function kf(e){try{e?Xt.storage.setItem("debug",e):Xt.storage.removeItem("debug")}catch{}}function $f(){let e;try{e=Xt.storage.getItem("debug")||Xt.storage.getItem("DEBUG")}catch{}return!e&&typeof process<"u"&&"env"in process&&(e=process.env.DEBUG),e}function xf(){try{return localStorage}catch{}}Ks.exports=Bl()(Xt);var{formatters:Af}=Ks.exports;Af.j=function(e){try{return JSON.stringify(e)}catch(t){return"[UnexpectedJSONParseError]: "+t.message}}});var Zr=globalThis,Bs=Zr.trustedTypes,$l=Bs?Bs.createPolicy("lit-html",{createHTML:e=>e}):void 0,ha="$lit$",Sn=`lit$${Math.random().toFixed(9).slice(2)}$`,ba="?"+Sn,pf=`<${ba}>`,tr=document,Qr=()=>tr.createComment(""),Xr=e=>e===null||typeof e!="object"&&typeof e!="function",ya=Array.isArray,Cl=e=>ya(e)||typeof e?.[Symbol.iterator]=="function",ga=`[ 	
\f\r]`,Yr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,xl=/-->/g,Al=/>/g,Jn=RegExp(`>|${ga}(?:([^\\s"'>=/]+)(${ga}*=${ga}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Sl=/'/g,El=/"/g,Rl=/^(?:script|style|textarea|title)$/i,va=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),l=va(1),kr=va(2),Qb=va(3),ln=Symbol.for("lit-noChange"),Ot=Symbol.for("lit-nothing"),Tl=new WeakMap,er=tr.createTreeWalker(tr,129);function Ll(e,t){if(!ya(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return $l!==void 0?$l.createHTML(t):t}var Ol=(e,t)=>{let n=e.length-1,r=[],s,o=t===2?"<svg>":t===3?"<math>":"",a=Yr;for(let i=0;i<n;i++){let u=e[i],d,p,f=-1,g=0;for(;g<u.length&&(a.lastIndex=g,p=a.exec(u),p!==null);)g=a.lastIndex,a===Yr?p[1]==="!--"?a=xl:p[1]!==void 0?a=Al:p[2]!==void 0?(Rl.test(p[2])&&(s=RegExp("</"+p[2],"g")),a=Jn):p[3]!==void 0&&(a=Jn):a===Jn?p[0]===">"?(a=s??Yr,f=-1):p[1]===void 0?f=-2:(f=a.lastIndex-p[2].length,d=p[1],a=p[3]===void 0?Jn:p[3]==='"'?El:Sl):a===El||a===Sl?a=Jn:a===xl||a===Al?a=Yr:(a=Jn,s=void 0);let w=a===Jn&&e[i+1].startsWith("/>")?" ":"";o+=a===Yr?u+pf:f>=0?(r.push(d),u.slice(0,f)+ha+u.slice(f)+Sn+w):u+Sn+(f===-2?i:w)}return[Ll(e,o+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},Jr=class e{constructor({strings:t,_$litType$:n},r){let s;this.parts=[];let o=0,a=0,i=t.length-1,u=this.parts,[d,p]=Ol(t,n);if(this.el=e.createElement(d,r),er.currentNode=this.el.content,n===2||n===3){let f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(s=er.nextNode())!==null&&u.length<i;){if(s.nodeType===1){if(s.hasAttributes())for(let f of s.getAttributeNames())if(f.endsWith(ha)){let g=p[a++],w=s.getAttribute(f).split(Sn),A=/([.?@])?(.*)/.exec(g);u.push({type:1,index:o,name:A[2],strings:w,ctor:A[1]==="."?Ws:A[1]==="?"?zs:A[1]==="@"?Hs:rr}),s.removeAttribute(f)}else f.startsWith(Sn)&&(u.push({type:6,index:o}),s.removeAttribute(f));if(Rl.test(s.tagName)){let f=s.textContent.split(Sn),g=f.length-1;if(g>0){s.textContent=Bs?Bs.emptyScript:"";for(let w=0;w<g;w++)s.append(f[w],Qr()),er.nextNode(),u.push({type:2,index:++o});s.append(f[g],Qr())}}}else if(s.nodeType===8)if(s.data===ba)u.push({type:2,index:o});else{let f=-1;for(;(f=s.data.indexOf(Sn,f+1))!==-1;)u.push({type:7,index:o}),f+=Sn.length-1}o++}}static createElement(t,n){let r=tr.createElement("template");return r.innerHTML=t,r}};function nr(e,t,n=e,r){if(t===ln)return t;let s=r!==void 0?n._$Co?.[r]:n._$Cl,o=Xr(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=s:n._$Cl=s),s!==void 0&&(t=nr(e,s._$AS(e,t.values),s,r)),t}var Us=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,s=(t?.creationScope??tr).importNode(n,!0);er.currentNode=s;let o=er.nextNode(),a=0,i=0,u=r[0];for(;u!==void 0;){if(a===u.index){let d;u.type===2?d=new wr(o,o.nextSibling,this,t):u.type===1?d=new u.ctor(o,u.name,u.strings,this,t):u.type===6&&(d=new Gs(o,this,t)),this._$AV.push(d),u=r[++i]}a!==u?.index&&(o=er.nextNode(),a++)}return er.currentNode=tr,s}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},wr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,s){this.type=2,this._$AH=Ot,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=nr(this,t,n),Xr(t)?t===Ot||t==null||t===""?(this._$AH!==Ot&&this._$AR(),this._$AH=Ot):t!==this._$AH&&t!==ln&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Cl(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Ot&&Xr(this._$AH)?this._$AA.nextSibling.data=t:this.T(tr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=Jr.createElement(Ll(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(n);else{let o=new Us(s,this),a=o.u(this.options);o.p(n),this.T(a),this._$AH=o}}_$AC(t){let n=Tl.get(t.strings);return n===void 0&&Tl.set(t.strings,n=new Jr(t)),n}k(t){ya(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,s=0;for(let o of t)s===n.length?n.push(r=new e(this.O(Qr()),this.O(Qr()),this,this.options)):r=n[s],r._$AI(o),s++;s<n.length&&(this._$AR(r&&r._$AB.nextSibling,s),n.length=s)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},rr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,s,o){this.type=1,this._$AH=Ot,this._$AN=void 0,this.element=t,this.name=n,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Ot}_$AI(t,n=this,r,s){let o=this.strings,a=!1;if(o===void 0)t=nr(this,t,n,0),a=!Xr(t)||t!==this._$AH&&t!==ln,a&&(this._$AH=t);else{let i=t,u,d;for(t=o[0],u=0;u<o.length-1;u++)d=nr(this,i[r+u],n,u),d===ln&&(d=this._$AH[u]),a||(a=!Xr(d)||d!==this._$AH[u]),d===Ot?t=Ot:t!==Ot&&(t+=(d??"")+o[u+1]),this._$AH[u]=d}a&&!s&&this.j(t)}j(t){t===Ot?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Ws=class extends rr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Ot?void 0:t}},zs=class extends rr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Ot)}},Hs=class extends rr{constructor(t,n,r,s,o){super(t,n,r,s,o),this.type=5}_$AI(t,n=this){if((t=nr(this,t,n,0)??Ot)===ln)return;let r=this._$AH,s=t===Ot&&r!==Ot||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==Ot&&(r===Ot||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Gs=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){nr(this,t)}},Il={M:ha,P:Sn,A:ba,C:1,L:Ol,R:Us,D:Cl,V:nr,I:wr,H:rr,N:zs,U:Hs,B:Ws,F:Gs},ff=Zr.litHtmlPolyfillSupport;ff?.(Jr,wr),(Zr.litHtmlVersions??(Zr.litHtmlVersions=[])).push("3.3.1");var Ze=(e,t,n)=>{let r=n?.renderBefore??t,s=r._$litPart$;if(s===void 0){let o=n?.renderBefore??null;r._$litPart$=s=new wr(t.insertBefore(Qr(),o),o,void 0,n??{})}return s._$AI(e),s};var nn="today",Fn=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function cn(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function sr(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function Pl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Ml(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Dl(){let e=null,t=[],n=new Set;function r(){for(let s of Array.from(n))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},set(s,o){e=Array.isArray(s)?s:null,t=Array.isArray(o)?o:[],r()},clear(){e=null,t=[],r()},subscribe(s){return n.add(s),()=>n.delete(s)}}}function Nl(){let e=new Map,t=new Set;function n(s){return s.startsWith("session-log:")?s:`session-log:${s}`}function r(){for(let s of Array.from(t))try{s()}catch{}}return{set(s,o,a=null){e.set(n(s),{lines:Array.isArray(o)?[...o]:[],last_event_at:typeof a=="number"?a:null}),r()},append(s,o){let a=n(s),i=e.get(a)||{lines:[],last_event_at:null};i.lines=[...i.lines,o],i.last_event_at=Date.now(),e.set(a,i),r()},get(s){return e.get(n(s))||null},clear(s){typeof s=="string"?e.delete(n(s)):e.clear(),r()},subscribe(s){return t.add(s),()=>t.delete(s)}}}var Wl=df(Ul(),1);function Et(e){return(0,Wl.default)(`beads-ui:${e}`)}function mn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function ar(e,t){let n=mn(e.created_at),r=mn(t.created_at);if(n!==r)return n<r?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function Gl(e,t){let n=mn(e.created_at),r=mn(t.created_at);if(n!==r)return n<r?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function Vl(e,t){let n=mn(e.updated_at),r=mn(t.updated_at);if(n!==r)return n<r?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function Kl(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let s=mn(e.created_at),o=mn(t.created_at);if(s!==o)return s<o?1:-1;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function Yl(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var Sf=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function zl(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Hl(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=Sf.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Zl(e,t){let n=zl(e),r=zl(t);if(n!==r)return n<r?-1:1;let s=Hl(e),o=Hl(t);if(s!==o)return s<o?-1:1;let a=mn(e&&e.created_at),i=mn(t&&t.created_at);if(a!==i)return a<i?-1:1;let u=e&&e.id,d=t&&t.id;return u===d?0:String(u)<String(d)?-1:1}var wa=2**20;function Sr(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-mn(e&&e.created_at)}function Ys(e){return(t,n)=>{let r=Sr(t,e),s=Sr(n,e);if(r!==s)return r<s?-1:1;let o=t?.id,a=n?.id;return o<a?-1:o>a?1:0}}function ka(e,t,n){let r=Array.isArray(e)?e:[],s=r.length,o=Math.max(0,Math.min(t,s-1)),a=o-1>=0?r[o-1]:null,i=o+1<s?r[o+1]:null;if(!a&&!i)return{rank:0};if(!a)return{rank:Sr(i,n)-wa};if(!i)return{rank:Sr(a,n)+wa};let u=Sr(a,n),d=Sr(i,n),p=(u+d)/2;return u<p&&p<d?{rank:p}:{renormalize:r.map((f,g)=>({bead_id:f.id,rank:g*wa}))}}function $a(e,t={}){let n=Et(`issue-store:${e}`),r=new Map,s=[],o=0,a=new Set,i=!1,u=t.sort||ar;function d(){for(let g of Array.from(a))try{g()}catch{}}function p(){s=Array.from(r.values()).sort(u)}function f(g){if(i||!g||g.id!==e)return;let w=Number(g.revision)||0;if(n("apply %s rev=%d",g.type,w),!(w<=o&&g.type!=="snapshot")){if(g.type==="snapshot"){if(w<=o)return;r.clear();let A=Array.isArray(g.issues)?g.issues:[];for(let D of A)D&&typeof D.id=="string"&&D.id.length>0&&r.set(D.id,D);p(),o=w,d();return}if(g.type==="upsert"){let A=g.issue;if(A&&typeof A.id=="string"&&A.id.length>0){let D=r.get(A.id);if(!D)r.set(A.id,A);else{let W=Number.isFinite(D.updated_at)?D.updated_at:0,V=Number.isFinite(A.updated_at)?A.updated_at:0;if(W<=V){for(let Y of Object.keys(D))Y in A||delete D[Y];for(let[Y,N]of Object.entries(A))D[Y]=N}}p()}o=w,d()}else if(g.type==="delete"){let A=String(g.issue_id||"");A&&(r.delete(A),p()),o=w,d()}}}return{id:e,subscribe(g){return a.add(g),()=>{a.delete(g)}},applyPush:f,snapshot(){return s},size(){return r.size},getById(g){return r.get(g)},dispose(){i=!0,r.clear(),s=[],a.clear(),o=0}}}function Zs(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let a=e.params[o];n[o]=String(a)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function Ql(e){let t=Et("subs"),n=new Map,r=new Map;function s(i,u){t("applyDelta %s +%d ~%d -%d",i,(u.added||[]).length,(u.updated||[]).length,(u.removed||[]).length);let d=r.get(i);if(!d||d.size===0)return;let p=Array.isArray(u.added)?u.added:[],f=Array.isArray(u.updated)?u.updated:[],g=Array.isArray(u.removed)?u.removed:[];for(let w of Array.from(d)){let A=n.get(w);if(!A)continue;let D=A.itemsById;for(let W of p)typeof W=="string"&&W.length>0&&D.set(W,!0);for(let W of f)typeof W=="string"&&W.length>0&&D.set(W,!0);for(let W of g)typeof W=="string"&&W.length>0&&D.delete(W)}}async function o(i,u){let d=Zs(u);if(t("subscribe %s key=%s",i,d),!n.has(i))n.set(i,{key:d,itemsById:new Map});else{let f=n.get(i);if(f&&f.key!==d){let g=r.get(f.key);g&&(g.delete(i),g.size===0&&r.delete(f.key)),n.set(i,{key:d,itemsById:new Map})}}r.has(d)||r.set(d,new Set);let p=r.get(d);p&&p.add(i);try{await e("subscribe-list",{id:i,type:u.type,params:u.params})}catch(f){let g=n.get(i)||null;if(g){let w=r.get(g.key);w&&(w.delete(i),w.size===0&&r.delete(g.key))}throw n.delete(i),f}return async()=>{t("unsubscribe %s key=%s",i,d);try{await e("unsubscribe-list",{id:i})}catch{}let f=n.get(i)||null;if(f){let g=r.get(f.key);g&&(g.delete(i),g.size===0&&r.delete(f.key))}n.delete(i)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:Zs,selectors:{getIds(i){let u=n.get(i);return u?Array.from(u.itemsById.keys()):[]},has(i,u){let d=n.get(i);return d?d.itemsById.has(u):!1},count(i){let u=n.get(i);return u?u.itemsById.size:0},getItemsById(i){let u=n.get(i),d={};if(!u)return d;for(let p of u.itemsById.keys())d[p]=!0;return d}}}}function Xl(){let e=Et("issue-stores"),t=new Map,n=new Map,r=new Set,s=new Map;function o(){for(let u of Array.from(r))try{u()}catch{}}function a(u,d,p){let f=d?Zs(d):"",g=n.get(u)||"",w=t.has(u);if(e("register %s key=%s (prev=%s)",u,f,g),w&&g&&f&&g!==f){let A=t.get(u);if(A)try{A.dispose()}catch{}let D=s.get(u);if(D){try{D()}catch{}s.delete(u)}let W=$a(u,p);t.set(u,W);let V=W.subscribe(()=>o());s.set(u,V)}else if(!w){let A=$a(u,p);t.set(u,A);let D=A.subscribe(()=>o());s.set(u,D)}return n.set(u,f),()=>i(u)}function i(u){e("unregister %s",u),n.delete(u);let d=t.get(u);d&&(d.dispose(),t.delete(u));let p=s.get(u);if(p){try{p()}catch{}s.delete(u)}}return{register:a,unregister:i,getStore(u){return t.get(u)||null},snapshotFor(u){let d=t.get(u);return d?d.snapshot().slice():[]},subscribe(u){return r.add(u),()=>r.delete(u)}}}function Jl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function ec(){let e=null,t=!1,n=new Set;function r(){for(let s of Array.from(n))try{s()}catch{}}return{get(){return e},set(s){e=s,r()},isPending(){return t},setPending(s){let o=s===!0;o!==t&&(t=o,r())},clear(){e=null,t=!1,r()},subscribe(s){return n.add(s),()=>n.delete(s)}}}function tc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function xa(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function Ef(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),s=r>=0?n.slice(r+1):"";if(s){let i=new URLSearchParams(s).get("issue");if(i)return decodeURIComponent(i)}let o=/^\/issue\/([^\s?#]+)/.exec(n);return o&&o[1]?decodeURIComponent(o[1]):null}function Tf(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function nc(e){let t=Et("router"),n=()=>{let r=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(r),o=s&&s[1]?decodeURIComponent(s[1]):Ef(r),a=Tf(r);if(t("hash change \u2192 view=%s id=%s",a,o),e.setState({selected_id:a==="worker"?null:o,view:a,worker:{selected_parent_id:a==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let u=o?`#/${a}?issue=${encodeURIComponent(o)}`:`#/${a}`;window.location.hash!==u&&(window.location.hash=u)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",a=xa(o,r);t("goto issue %s (view=%s)",r,o),window.location.hash!==a?window.location.hash=a:e.setState({selected_id:o==="worker"?null:r,view:o,worker:{selected_parent_id:o==="worker"?r:null}})},gotoView(r){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=r==="worker"?s.worker?.selected_parent_id:s.selected_id,a=o?xa(r,o):`#/${r}`;t("goto view %s (id=%s)",r,o||""),window.location.hash!==a?window.location.hash=a:e.setState({view:r,selected_id:r==="worker"?null:s.selected_id})}}}var Cf=Object.freeze({workspace_config:{default_workspace:null}});function rc(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:Cf.workspace_config.default_workspace}}}function sc(e={}){let t=Et("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:rc(e.config)},r=new Set;function s(){for(let o of Array.from(r))try{o(n)}catch{}}return{getState(){return n},setState(o){let a={...n,...o,filters:{...n.filters,...o.filters||{}},board:{...n.board,...o.board||{}},worker:{...n.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:n.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:n.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:n.workspace.hidden},config:o.config!==void 0?rc(o.config):n.config},i=a.workspace.current?.path!==n.workspace.current?.path||a.workspace.available.length!==n.workspace.available.length||a.workspace.hidden.length!==n.workspace.hidden.length||a.workspace.hidden.some((d,p)=>d!==n.workspace.hidden[p]),u=a.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;a.selected_id===n.selected_id&&a.view===n.view&&a.filters.status===n.filters.status&&a.filters.search===n.filters.search&&a.filters.type===n.filters.type&&a.board.closed_filter===n.board.closed_filter&&a.worker.selected_parent_id===n.worker.selected_parent_id&&a.worker.show_closed_children.length===n.worker.show_closed_children.length&&a.worker.show_closed_children.every((d,p)=>d===n.worker.show_closed_children[p])&&!i&&!u||(n=a,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),s())},subscribe(o){return r.add(o),()=>r.delete(o)}}}function oc(e){let t=Et("activity"),n=0,r=new Map,s=1;function o(){if(!e)return;let d=n>0;e.toggleAttribute("hidden",!d),e.setAttribute("aria-busy",d?"true":"false")}function a(){n+=1,t("start count=%d",n),o()}function i(){let d=n;n=Math.max(0,n-1),d<=0?t("done called but count was already %d",d):t("done count=%d\u2192%d",d,n),o()}function u(d){return async(f,g)=>{let w=s++,A=Date.now();r.set(w,{type:f,start_ts:A}),t("request start id=%d type=%s count=%d",w,f,n+1),a();let D=!1,W=()=>{D||(D=!0,r.delete(w),i())},V=setTimeout(()=>{D||(t("request TIMEOUT id=%d type=%s elapsed=%dms",w,f,Date.now()-A),W())},3e4);try{let Y=await d(f,g),N=Date.now()-A;return t("request done id=%d type=%s elapsed=%dms",w,f,N),Y}catch(Y){let N=Date.now()-A;throw t("request error id=%d type=%s elapsed=%dms err=%o",w,f,N,Y),Y}finally{clearTimeout(V),W()}}}return o(),{wrapSend:u,start:a,done:i,getCount:()=>n,getActiveRequests:()=>{let d=Date.now();return Array.from(r.entries()).map(([p,f])=>({id:p,type:f.type,elapsed_ms:d-f.start_ts}))}}}function ce(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function Qs(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function r(o,a,i){let u=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(a==="closed")return u.sort(Yl),u;switch(i){case"created_desc":return u.sort(ar),u;case"created_asc":return u.sort(Gl),u;case"updated_desc":return u.sort(Vl),u;case"priority":return u.sort(Kl),u;case"manual":default:{let d=n();return d?u.sort(Ys(d)):u.sort(ar),u}}}function s(o){let a=[];return e&&typeof e.subscribe=="function"&&a.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&a.push(t.subscribe(o)),()=>{for(let i of a)try{i()}catch{}}}return{selectBoardColumn:r,subscribe:s}}function kn(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function Gt(e){let t=kn(e);if(t===null)return"";let n=new Date(t),r=s=>String(s).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function rn(e,t){let n=kn(e);if(n===null)return"";let s=(typeof t=="number"?t:Date.now())-n;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let a=Math.floor(s/36e5);if(a<24)return`${a}\uC2DC\uAC04 \uC804`;let i=Math.floor(s/864e5);if(i<7)return`${i}\uC77C \uC804`;let u=Math.floor(i/7);if(i<30)return`${u}\uC8FC \uC804`;let d=Math.floor(i/30);return d<12?`${d}\uAC1C\uC6D4 \uC804`:`${Math.floor(i/365)}\uB144 \uC804`}function ac(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let s=kn(r.updated_at)??0;if(t===null||s>n){t=r,n=s;continue}s===n&&String(r.id)<String(t.id)&&(t=r)}return t}function Xs(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function Js(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let s=Xs(r);if(!s)continue;let o=n.get(s);o||(o=[],n.set(s,o)),o.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function eo(e,t){let n=e.get(t)||[],r=0;for(let o of n)(o.status==="resolved"||o.status==="closed")&&(r+=1);let s=ac(n);return{total:n.length,count:r,current:s,children:n}}function to(e){let t=e.transport,n=e.uiOrderStore;function r(a,i){return"renormalize"in a?a.renormalize:[{bead_id:i,rank:a.rank}]}function s(a,i){let u={...a.order};for(let d of i)u[d.bead_id]=d.rank;n&&n.set({revision:a.revision,order:u})}async function o(a,i,u){if(!t||!n)return;let d=n.get()||{revision:0,order:{}},p=r(ka(i,u,d.order),a);s(d,p);let f=await t("ui-order-set",{expected_revision:d.revision,entries:p});if(f&&f.conflict){let g={revision:typeof f.revision=="number"?f.revision:0,order:f.order||{}};n.set(g);let w=r(ka(i,u,g.order),a);s(g,w);let A=await t("ui-order-set",{expected_revision:g.revision,entries:w});A&&A.applied&&n.set({revision:typeof A.revision=="number"?A.revision:0,order:A.order||{}})}else f&&f.applied&&n.set({revision:typeof f.revision=="number"?f.revision:0,order:f.order||{}})}return{applyReorder:o}}function no(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Aa(e,t){return!t||typeof e!="string"||e.length===0||no(t.visible_labels).includes(e)?!0:no(t.hidden_labels).includes(e)?!1:!no(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function ic(e,t){return no(e).filter(n=>Aa(n,t))}function jn(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function Rf(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function Lf(e,t,n,r,s){return l`<button
    type="button"
  ...
  `}function so(e,t){if(!e||!e.stages)return"";let n=lc[e.route]||lc.spec_backed,r=e.stages,s=Mf(n,r,String(t||"open")),o=`\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uC9C4\uD589: ${n.map(a=>`${cc[a]||a} ${a==="plan"?Df(r[a]||{}):uc(r[a]||{})}`).join(" \xB7 ")}`;return l`
    <div class="stp" role="img" aria-label=${o}>
      ${n.map(a=>Nf(a,r[a]||{},a===s))}
    </div>
  `}function qf(e){return typeof e!="number"||!Number.isFinite(e)?"":`P${Math.max(0,Math.min(4,e))}`}var dc=2;function Ff(e){if(!e)return[];let t=[];if(e.external){let r=e.reason?`\u23F8 blocked: ${e.reason}`:"\u23F8 blocked";t.push(l`<span class="ctl-chip ctl-chip--blocked">${r}</span>`)}let n=Array.isArray(e.blockers)?e.blockers:[];if(n.length>0){let r=n.slice(0,dc).join(", "),s=n.length-dc,o=`\u26D3 blocked: ${r}${s>0?` +${s}`:""}`;t.push(l`<span class="ctl-chip ctl-chip--blocked-dep">${o}</span>`)}return t}function Sa(e){return e==="delegated"?"\uC704\uC784":e==="main"?"\uBA54\uC778":null}function oo(e){return e.effort?`${e.actor}:${e.effort}`:e.actor}function En(e){return`${e.kind}:${oo(e)}@${e.sha}`}function ao(e,t){if(!e)return null;let n=Sa(e.kind),r=e.reason,s=e.kind==="delegated"?r===null:typeof r=="string"&&r.trim().length>0&&!/[\r\n]/.test(r);if(!n||!s)return null;let o=Sa(t?.kind),a=o!==null&&t?.kind!==e.kind,i=`\uACC4\uD68D \xB7 ${n}${a?` \u2192 ${o}`:""}`,u=`planned_execution ${e.kind}${typeof r=="string"?`:${r}`:""}`,d=t?` \xB7 exec_receipt ${En(t)}`:"";return{kind:e.kind,label:i,title:`${u}${d}`}}function pc(e,t){let n=ao(e,t);return n?l`<span
        class="ctl-chip ctl-chip--planned"
        data-kind=${n.kind}
        title=${n.title}
        >${n.label}</span
      >`:null}function jf(e){if(!e)return null;let t=Sa(e.kind);return t?l`<span
  ...
  >`:null}function Bf(e,t){let n=t.policy||null,r=e.workflow&&e.workflow.chips||{},s=[];if(r.route&&jn(n,"route")){let i=r.route_source==="derived";s.push(l`<span
      ...
      >`)}for(let i of ic(e.labels,n))s.push(l`<span class="ctl-chip ctl-chip--label">${i}</span>`);return e.from_id&&jn(n,"from")&&s.push(l`<button
        type="button"
  ...
  `}function Er(e,t){let n=Array.isArray(e.items)?e.items.length:0,r=e.is_closed===!0;return l`
...
`).trim()}}var du=20;function pu(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${s}:${o}`}function Hm(e){return e.length>du?`${e.slice(0,du)}\u2026`:e}function Gm(e,t,n,r){let s=`${t.lane} ${Hm(t.identifier)}`;return l`<div class="detail-report">
    <button
      type="button"
  ...
  </div>`}function fu(e,t={},n={}){let r=Array.isArray(e)?e.filter(Boolean):[],s=n.expanded||new Set,o=typeof n.draft=="string"?n.draft:"",a=n.sending===!0,i=r.slice().sort((u,d)=>String(d.created_at||"").localeCompare(String(u.created_at||"")));return l`
  ...
  `}var{I:mw}=Il;var _u=e=>e.strings===void 0;var Km={},mu=(e,t=Km)=>e._$AH=t;var ur=mo(class extends Or{constructor(e){if(super(e),e.type!==On.PROPERTY&&e.type!==On.ATTRIBUTE&&e.type!==On.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!_u(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===ln||t===Ot)return t;let n=e.element,r=e.name;if(e.type===On.PROPERTY){if(t===n[r])return ln}else if(e.type===On.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return ln}else if(e.type===On.ATTRIBUTE&&n.getAttribute(r)===t+"")return ln;return mu(e),t}});var Eo=["workflow_mode","spec_review_model","spec_review_effort","plan_review_model","plan_review_effort","impl_review_model","impl_review_effort","impl_dispatch","impl_runtime","impl_model","impl_effort","impl_speed"],ai=[...Eo.filter(e=>e!=="impl_dispatch"),"quick_fix_impl_model"],Mn=["orchestration_model","orchestration_effort","orchestration_speed"],To=[...Eo,...Mn],Ym=ai.filter(e=>To.includes(e)),gu=["delegated","main"],Co=["inherit","claude","codex"],gs=["default","fast"],hs=["standard","fast_track"],bs=["codex","opus","fable","self","skip"],Ro=["codex","fable","skip"],Lo=["low","medium","high","xhigh"],an="auto";function on(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function hu(e){if(!on(e)||!on(e.runners))return[];let t=[];for(let[n,r]of Object.entries(e.runners))on(r)&&on(r.models)&&t.push([n,Object.keys(r.models)]);return t}function Mr(e,t){let n=hu(e),r=t&&t!=="inherit"?n.filter(([s])=>s===t):n;return[an,...r.flatMap(([,s])=>s)]}function bu(e,t,n,r){if(!on(e)||!on(e.runners))return[an];let s=[];for(let[o,a]of Object.entries(e.runners))if(!(!on(a)||!on(a.models))&&!(t&&t!=="inherit"&&o!==t))for(let[i,u]of Object.entries(a.models)){if(n&&n!==an&&i!==n)continue;let d=r(a,u);if(Array.isArray(d))for(let p of d)typeof p=="string"&&!s.includes(p)&&s.push(p)}return[an,...s]}function Dr(e,t,n){return bu(e,t,n,(r,s)=>on(s)&&Array.isArray(s.efforts)?s.efforts:r.efforts)}function ii(e,t,n){return bu(e,t,n,(r,s)=>on(s)&&Array.isArray(s.orchestration_efforts)?s.orchestration_efforts:on(s)&&Array.isArray(s.efforts)?s.efforts:r.efforts)}function ys(e,t){let n=hu(e);return(t?n.filter(([s])=>s===t):n).flatMap(([,s])=>s)}function yu(e,t,n){let r={impl_runtime:e?.impl_runtime,impl_model:e?.impl_model,impl_effort:e?.impl_effort},s=r.impl_runtime==="claude"||r.impl_runtime==="codex"?r.impl_runtime:r.impl_runtime==="inherit"?n:null;return s&&(r.impl_model&&!Mr(t,s).includes(r.impl_model)&&(r.impl_model=void 0),r.impl_effort&&!Dr(t,s,r.impl_model||an).includes(r.impl_effort)&&(r.impl_effort=void 0)),r}var Zm={workflow_mode:"\uC6CC\uD06C\uD50C\uB85C \uBAA8\uB4DC",spec_review_model:"\uC2A4\uD399 \uB9AC\uBDF0\uC5B4",spec_review_effort:"\uC2A4\uD399 \uB9AC\uBDF0 effort",plan_review_model:"\uACC4\uD68D \uB9AC\uBDF0\uC5B4",plan_review_effort:"\uACC4\uD68D \uB9AC\uBDF0 effort",impl_review_model:"\uAD6C\uD604 \uB9AC\uBDF0\uC5B4",impl_review_effort:"\uAD6C\uD604 \uB9AC\uBDF0 effort",impl_runtime:"\uC704\uC784 \uB300\uC0C1",impl_model:"\uAD6C\uD604 \uBAA8\uB378",impl_effort:"\uAD6C\uD604 effort",impl_speed:"\uAD6C\uD604 \uC18D\uB3C4",orchestration_model:"\uC6CC\uCEE4 \uBAA8\uB378",orchestration_effort:"\uC6CC\uCEE4 effort",orchestration_speed:"\uC6CC\uCEE4 \uC18D\uB3C4"},oi=[...Ym,...Mn],Qm=[...To,...ai].filter((e,t,n)=>n.indexOf(e)===t&&!oi.includes(e));function vu(e,t){let n=on(e)?e:{},r=on(t)?t:{},s=[];for(let a of oi){let i=n[a]??null,u=r[a]??null;i!==u&&s.push({key:a,label:Zm[a]||a,before:i,after:u,kind:i===null?"added":u===null?"removed":"changed"})}let o=[];for(let a of[...Qm,...Object.keys(r)])!oi.includes(a)&&!o.includes(a)&&Object.hasOwn(r,a)&&o.push(a);return{rows:s,ignored_keys:o}}function li(e,t,n,r,s,o){return lo({key:e,choices:t,layer:"global",global:n,resolution_global:o,execution_defaults:r,runner_catalog:s})}function wu(e,t){let n={};for(let r of ai){let s=e?.[r],o=t?.[r];s!==o&&(n[r]=typeof o=="string"&&o.length>0?o:null)}return n}function ku(e,t){let n={};for(let r of Mn){let s=e?.[r]??null,o=t?.[r]??null;s!==o&&(n[r]=typeof o=="string"&&o.length>0?o:null)}return n}var ci=[{id:"workflow",label:"\uC6CC\uD06C\uD50C\uB85C\uC6B0",keys:["workflow_mode"]},{id:"review",label:"\uB9AC\uBDF0",keys:["spec_review_model","spec_review_effort","plan_review_model","plan_review_effort","impl_review_model","impl_review_effort"]},{id:"implementation",label:"\uAD6C\uD604",keys:["impl_dispatch","impl_runtime","impl_model","impl_effort","impl_speed"]},{id:"worker",label:"Worker",keys:[...Mn]}],Wn={workflow_mode:"\uBAA8\uB4DC",spec_review_model:"\uC0AC\uC591 \uB9AC\uBDF0",spec_review_effort:"\uC0AC\uC591 \uB9AC\uBDF0 effort",plan_review_model:"\uACC4\uD68D \uB9AC\uBDF0",plan_review_effort:"\uACC4\uD68D \uB9AC\uBDF0 effort",impl_review_model:"\uAD6C\uD604 \uB9AC\uBDF0",impl_review_effort:"\uAD6C\uD604 \uB9AC\uBDF0 effort",impl_dispatch:"\uC2E4\uD589 \uBC29\uC2DD",impl_runtime:"\uC704\uC784 \uB300\uC0C1",impl_model:"\uBAA8\uB378",impl_effort:"effort",impl_speed:"\uC18D\uB3C4",orchestration_model:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uBAA8\uB378",orchestration_effort:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 effort",orchestration_speed:"\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uC18D\uB3C4"},Oo={pin:"\uD540",global:"\uC804\uC5ED",base:"\uAE30\uBCF8"};function ui(e,t,n,r,s,o=null){let a=Jt({pin:t,global:n,execution_defaults:r,runner_catalog:s,route:t&&typeof t.route=="string"?t.route:null,controller_runtime:o});return e.map(i=>({key:i,...a[i]}))}function $u(e,t,n,r,s,o=null){let a={pin:0,global:0,base:0};for(let i of ui(e,t,n,r,s,o))a[i.source]+=1;return a}function xu(e,t,n){return{id:e,key:t,value:typeof n=="string"?n:""}}function Au(e,t,n){return typeof t!="string"||t.length===0?null:{id:e,preset_id:t,expected_revision:n}}var Sw=[...Eo,...Mn];var Xm=[{id:"spec",label:"spec \uB9AC\uBDF0",receipt:"spec_review"},{id:"impl",label:"\uAD6C\uD604",receipt:null},{id:"impl_review",label:"impl \uB9AC\uBDF0",receipt:"impl_review"},{id:"pr",label:"PR",receipt:null}],Jm={pin:"pin",global:"global",base:"base"};function eg(e){return l`<span
    class=${`detail-layer-rail detail-layer-rail--${Jm[e]}`}
    data-source=${e}
    aria-hidden="true"
    ><i></i><i></i><i></i
  ></span>`}function tg(e,t,n){switch(e){case"workflow_mode":return hs;case"spec_review_model":case"impl_review_model":return bs;case"plan_review_model":return Ro;case"spec_review_effort":case"plan_review_effort":case"impl_review_effort":return Lo;case"impl_dispatch":return gu;case"impl_runtime":return Co;case"impl_model":return Mr(n,t.impl_runtime);case"impl_effort":return Dr(n,t.impl_runtime,t.impl_model);case"impl_speed":case"orchestration_speed":return gs;case"orchestration_model":return ys(n,null);case"orchestration_effort":return Dr(n,void 0,t.orchestration_model||an).filter(r=>r!==an);default:return[]}}function ng(e,t){return l`<div class="detail-effective__row" data-key=${e.key}>
    ${eg(e.source)}
  ...
  </div>`}function Su(e,t){let n=ci.flatMap(u=>u.keys),r=ui(n,e.metadata,e.workspace_values,e.execution_defaults,e.catalog,e.controller_runtime||null),s=$u(n,e.metadata,e.workspace_values,e.execution_defaults,e.catalog,e.controller_runtime||null),o=Object.fromEntries(r.map(u=>[u.key,u])),a=Object.fromEntries(r.filter(u=>u.value!==null).map(u=>[u.key,u.value])),i=r.filter(u=>u.full_value&&u.display!==u.full_value).map(u=>u.full_value).join(" \xB7 ");return l`<details
  ...
  </section>`}function Lu(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function Tu(e){return Lu(e)&&typeof e.key=="string"&&e.key.length>0&&typeof e.email=="string"&&e.email.length>0}function Cu(e,t){let n=e&&e[t];if(!Lu(n)||!Array.isArray(n.accounts))return null;let r=n.accounts.filter(Tu),s=Tu(n.active)?n.active:null;return{accounts:r,active:s||r.find(o=>o.active===!0)||null}}function Ou(e){return typeof e.alias=="string"&&e.alias.length>0?` (${e.alias})`:""}function og(e){let t=typeof e.status=="string"&&e.status!=="ok"?` \xB7 ${e.status}`:"";return`${e.email}${Ou(e)}${t}`}function Iu(e){let t=typeof e.plan=="string"&&e.plan.length>0?e.plan:"plan \uD655\uC778 \uBD88\uAC00";return`${e.email} \xB7 ${t}${Ou(e)}`}function ag(e,t){return t?t.active?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${e==="claude"?t.active.email:Iu({...t.active,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)":"(\uAE30\uBCF8)"}function Ru(e){let t=e.provider_key==="claude"?og:Iu,n=!!e.provider?.accounts.some(r=>r.key===e.selected);return l`<div class="detail-kv" data-exec-account-row=${e.key}>
...
${i}</pre
    ...
    `:l``}function f(){Ze(p(),e)}async function g(D,W={}){s=D,o="loading",a="",i=null,u="",f();let V=n?n():"";if(!V){o="error",u="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",f();return}if(!r){o="error",u="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",f();return}let Y="/api/doc?workspace="+encodeURIComponent(V)+"&path="+encodeURIComponent(D);try{let N=await r(Y),M=await N.json().catch(()=>({}));if(!N.ok||!M||M.ok!==!0){if(M?.error==="not_found"&&W.missing_state==="plan_pending"){o="pending",u="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",f();return}o="error",u="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(M&&M.error||N.status)+")",f();return}let q=ug(String(M.content||""));i=q.front,a=q.body,o="ready",f()}catch{o="error",u="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",f()}}function w(){s=null,Ze(l``,e)}function A(){document.removeEventListener("keydown",d),w()}return{open:g,close:w,destroy:A}}var dg=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],Uu="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Po=[{role:"implementation",provider:"codex"},{role:"review-consult",provider:"codex"},{role:"subagent",provider:"claude"}],pg=new Set(["codex-runner","Explore","Plan","advisor","advisor-xhigh","claude-code-guide","statusline-setup"]);function ju(e){return typeof e=="string"&&pg.has(e)}var fg=["running","done","failed","interrupted"],_g={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function mg(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function gg(e){let t=Bt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
        >`);let n=Lr(e);if(!n||!e)return"";let r=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?` \xB7 $${e.total_cost_usd.toFixed(2)}`:"";return l`<span
      class="detail-usage-total"
      title="이 이슈의 모든 attempt 토큰 합계 (입력+출력+캐시)"
      >${n.replace(/^τ /,"\u03C4 \uCD1D ")}${r}</span
    >${e.replayed?l`<span class="detail-usage-partial" title=${Uu}
          >부분 집계</span
        >`:""}`}function Bu(e){return!e||!e.roles.orchestrator?null:{providers:e.roles.orchestrator,roles:{}}}function fi(e){if(typeof e=="number")return Mo(e);if(typeof e!="string")return"";let t=Date.parse(e);return Number.isFinite(t)?Mo(t):""}function hg(e){return typeof e=="string"?e.replace(/-\d{8}$/,""):""}function bg(e,t){if(e.provider!=="claude")return{text:e.session_id.slice(0,8),title:e.session_id};let n=t&&typeof t.agent_id=="string"?t.agent_id:"";return n.length>0?{text:n.slice(0,8),title:n}:{text:e.launch_id.slice(-8),title:e.launch_id}}function di(e){return e===null||typeof e=="string"&&e.trim().length>0}function pi(e){return e===null||typeof e=="number"&&Number.isFinite(e)}function yg(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let t=e,n=t.provider==="claude";return typeof t.launch_id!="string"||t.launch_id.length===0||!Po.some(r=>r.role===t.role&&r.provider===t.provider)||!(n?di(t.model):typeof t.model=="string"&&t.model.length>0)||!(!("effort"in t)||di(t.effort))||!(!("agent_type"in t)||di(t.agent_type))||typeof t.session_id!="string"||t.session_id.length===0||!fg.includes(t.status)||!(t.turn_id===null||typeof t.turn_id=="string")?null:n?!pi(t.started_at)||!pi(t.last_event_at)||!pi(t.completed_at)?null:t:typeof t.started_at!="number"||!Number.isFinite(t.started_at)||typeof t.last_event_at!="number"||!Number.isFinite(t.last_event_at)||!(t.completed_at===null||typeof t.completed_at=="string"&&Number.isFinite(Date.parse(t.completed_at)))?null:t}function vg(e,t,n){let s=Bt({providers:{[t]:{subtotal:n.subtotal,breakdown:n.usage,...n.replayed?{replayed:!0}:{}}},roles:{}})[0];return l`<div class="detail-session__leg detail-session__usage-detail">
    ...
    ${s?l`<span class="detail-session__usage" title=${s.tooltip}
          >${s.label}</span
        >`:""}
  </div>`}function wg(e,t,n,r){let s=e.status==="running"?null:t,a=(s?Bt({providers:{[e.provider]:{subtotal:s.subtotal,breakdown:s.usage,...s.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],i=e.status==="running"?Mo(e.last_event_at):s?fi(s.completed_at):"",u=(e.provider==="claude"?["Claude",e.agent_type,hg(e.model),e.effort]:["codex",e.model,e.effort]).filter(Boolean).join(" \xB7 "),d=bg(e,s);return l`<button
    type="button"
  ...
  >
    ...
    ${a?l`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function kg(e,t){return e.role===t.role&&(e.model===null||t.model===void 0||e.model===t.model)&&e.session_id===t.session_id}function $g(e,t,n){let r=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let p of o){let f=yg(p);!f||s.has(f.launch_id)||ju(f.agent_type)||(s.add(f.launch_id),r.push(f))}r.sort((p,f)=>(p.started_at||0)-(f.started_at||0));let a={};for(let{role:p,provider:f}of Po){let g=t?t.roles[p]?.[f]:null;a[p]=g?[...g.legs]:[]}let i=Po.flatMap(({role:p})=>a[p]),u=new Set,d=[];for(let{role:p,provider:f}of Po){for(let g of r.filter(w=>w.role===p&&w.provider===f)){let w=i.find(A=>A.receipt_id===g.launch_id)||null;w&&!kg(g,w)||(w&&u.add(w.receipt_id),d.push(wg(g,w,e.attempt_id,n)))}for(let g of a[p])!u.has(g.receipt_id)&&!ju(g.agent_type)&&d.push(vg(p,f,g))}return d}function xg(e,t){let n=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,r=[...dg,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return l`<div class="detail-session__usage-detail">
  ...
  >
    ...
    >
      ...
      ${d.cause}
    </div>`},u=d=>{let p=Bu(La(d));if(Bt(p).length===0&&!Lr(d.usage))return"";let f=s.has(d.attempt_id);return l`<button
      type="button"
      ...
      ${r.map(d=>{let p=La(d),f=Bu(p),g=Bt(f);return l`<div class="detail-session-row">
          ...
          >
            ...
            ${g.length>0?g.map(w=>l`<span
                      ...
                      title=${w.tooltip}
                      >${w.label}</span
                    >`):Lr(d.usage)?l`<span class="detail-session__usage"
                    >${Lr(d.usage)}</span
                  >`:""}
  ...
  `}function Eg(e){let t=Ir(e);if(t)return t;let n=e.data;if(!n)return"";if(n.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof n.task_prompt=="string"?Pn("\uACFC\uC5C5 (user)",n.task_prompt):""}
    ${typeof n.system_prompt=="string"?Pn("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",n.system_prompt):""}`}var Tg=["open","in_progress","deferred","resolved","closed"],Cg=[0,1,2,3,4];function Hu(e,t){let n=t.issueStores,r=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,u=t.sessionLogStore,d=null,p=null,f={},g="",w=!1,A=[],D=!1,W={},V={claude:null,codex:null},Y=null,N=0,M=!1,q=!1,U="",E="",R="";function Z(){M=!1,q=!1,U="",E="",R=""}function $e(){V={claude:null,codex:null},Y=null,N+=1}async function ue(c){try{let m=await fetch(c);if(!m.ok)return null;let v=await m.json();if(!v||typeof v!="object"||!Array.isArray(v.accounts))return null;let B=v.accounts.filter(_e=>_e!==null&&typeof _e=="object"&&!Array.isArray(_e));return{accounts:B,active:B.find(_e=>_e.active===!0)||null}}catch{return null}}async function me(c){Y=c;let m=++N,[v,B]=await Promise.all([ue("/api/claude-usage"),ue("/api/codex-usage")]);m!==N||c!==d||(V={claude:v,codex:B},Oe())}let Q=[],Re=null,we=null,oe=!1,ae="",xe=!1,F=0,se=new Set;function ie(){Q=[],Re=null,we=null,oe=!1,ae="",xe=!1,F+=1,se.clear()}async function Ae(c){if(!s)return;let m=++F;try{let v=await Promise.resolve(s("get-comments",{id:c}));if(m!==F||c!==d)return;Q=Array.isArray(v)?v:[],oe=!1}catch{if(m!==F||c!==d)return;oe=!0}Oe()}function Se(){if(!s||!d)return;let c=p&&typeof p.comment_count=="number"?p.comment_count:null;if(Re!==d){Re=d,we=c,Ae(d);return}c!==null&&c!==we&&(we=c,Ae(d))}function Ie(c){se.has(c)?se.delete(c):se.add(c),Oe()}function he(c){let m=ae.trim().length===0;ae=c,m!==(c.trim().length===0)&&Oe()}async function it(){let c=ae.trim();if(!s||!d||c.length===0||xe)return;let m=d;xe=!0,Oe();let v=!1;try{let B=await Promise.resolve(s("add-comment",{id:m,text:c}));Array.isArray(B)&&B.length>0&&(v=!0,m===d&&(Q=B,oe=!1,ae="",we=B.length))}catch{v=!1}v||ce("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),m===d&&(xe=!1),Oe()}let _t={onToggle:Ie,onDraftInput:he,onSubmit:it},C=document.createElement("div");C.className="md-viewer-root",document.body.appendChild(C);let ge=Fu(C,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),ke=document.createElement("div");ke.className="session-log-root",document.body.appendChild(ke);let Le=Pr(ke,{transport:s?(c,m)=>Promise.resolve(s(c,m)):void 0,sessionLogStore:u}),Me=!1,Be=!1,z=!1,K=null,De=null,Qe=0;function We(c){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${c}`}function ve(){Me=!1,Be=!1,z=!1,K=null,De=null,Qe+=1}async function P(c){if(!s)return;let m=++Qe;Be=!0,z=!1,Oe();try{let v=await Promise.resolve(s("get-bead-prompt",{bead_id:c}));if(m!==Qe)return;!v||typeof v!="object"||Array.isArray(v)?z=!0:(K=v,De=We(c))}catch{m===Qe&&(z=!0)}finally{m===Qe&&(Be=!1,Oe())}}function H(){if(Me=!Me,Me&&d&&De!==We(d)){K=null,P(d);return}Oe()}function J(){if(!a||!d)return[];let c=a.get();return(c&&c.attempts?Object.values(c.attempts):[]).filter(v=>v&&v.bead_id===d).sort((v,B)=>(B.started_at||0)-(v.started_at||0)).map(v=>({attempt_id:v.attempt_id,bead_id:v.bead_id,status:v.status,started_at:typeof v.started_at=="number"?v.started_at:null,runner:v.runner||null,model:v.model||null,effort:v.effort||v.observed_effort||null,speed:v.speed||null,session_id:v.session_id||null,resumed_from:v.resumed_from||null,continuation_mode:v.continuation_mode||null,dismissed_at:typeof v.dismissed_at=="number"?v.dismissed_at:null,cause:typeof v.cause=="string"?v.cause:null,cause_detail:v.cause_detail||null,exec_default_preset_id:typeof v.exec_default_preset_id=="string"?v.exec_default_preset_id:null,exec_default_preset_revision:typeof v.exec_default_preset_revision=="number"?v.exec_default_preset_revision:null,exec_values:v.exec_values&&typeof v.exec_values=="object"?v.exec_values:null,usage:v.usage||null,usage_legs:Array.isArray(v.usage_legs)?v.usage_legs:[],delegation_sessions:Array.isArray(v.delegation_sessions)?v.delegation_sessions:[]}))}function X(){if(!a||!d)return null;let c=a.get();return un(c&&c.attempts||{},d)}let Pe=new Set;function tt(c){Pe.has(c)?Pe.delete(c):Pe.add(c),Oe()}function st(c){let m=a?a.get():null,v=m&&m.attempts?m.attempts[c]:null;Le.open({attempt_id:c,meta:v?{runner:v.runner||void 0,model:v.model||void 0,effort:v.effort||void 0,status:v.status||void 0,session_id:v.session_id||void 0}:{}})}function Je(c,m){let v=a?a.get():null,B=v&&v.attempts?v.attempts[c]:null,Ce=(B&&Array.isArray(B.delegation_sessions)?B.delegation_sessions:[]).find(Ee=>Ee&&typeof Ee=="object"&&Ee.launch_id===m);Ce&&Le.open({attempt_id:c,launch_id:m,meta:{runner:Ce.provider==="claude"?"claude":"codex",role:Ce.role,...typeof Ce.agent_type=="string"?{agent_type:Ce.agent_type}:{},model:Ce.model,effort:Ce.effort,session_id:Ce.session_id,status:Ce.status}})}async function vt(c){if(!s||!c)return;let m=await Rr();if(m===null)return;let v=()=>{let Ee=a?a.get():null;return Ee&&typeof Ee.revision=="number"?Ee.revision:0},B=async(Ee={},ze=v())=>await s("worker-attempt-resume",{attempt_id:c,expected_revision:ze,...m!==""?{instructions:m}:{},...Ee}),_e=Ee=>{Ee?.queue&&a?.set&&a.set(Ee.queue)},Ce=await B();if(_e(Ce),Ce&&Ce.conflict){let Ee=Ce.queue&&typeof Ce.queue.revision=="number"?Ce.queue.revision:v();Ce=await B({},Ee),_e(Ce)}Ce=await Tn(Ce,(Ee,ze)=>B({continuation:Ee,decision_token:ze}),{onResult:_e,refresh:()=>B()}),Ce&&Ce.resumed===!1&&!Ce.conflict&&Ce.reason&&ce(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${Ce.reason}`,"error",2400)}let mt={onOpen:st,onOpenDelegation:Je,onResume:vt,onToggleUsage:tt};function ot(){let c=a?a.get():null,m={...W};for(let v of["orchestration_model","orchestration_effort","orchestration_speed"]){let B=c&&c[v];typeof B=="string"&&(m[v]=B)}return m}async function ut(){if(s){try{let c=await Promise.resolve(s("get-session-defaults",{}));W=c&&c.values&&typeof c.values=="object"?c.values:{}}catch{W={}}Oe()}}function gt(){let c=a?a.get():null;return c&&c.runner_catalog||null}function Ve(){let c=a?a.get():null;return c&&typeof c.execution_defaults=="object"?c.execution_defaults:null}function Ne(){let c=p?.metadata&&typeof p.metadata=="object"?p.metadata:{},v=Jt({pin:{...c,...f},global:ot(),execution_defaults:Ve(),runner_catalog:gt(),route:typeof c.route=="string"?c.route:null}).orchestration_model.value||"";return yn(gt(),v)}function He(){let c=i?i.get():null;return!c||typeof c.revision!="number"?null:{revision:c.revision,presets:Array.isArray(c.presets)?c.presets:[]}}function wt(c){return c?.compatible===!1}function lt(c){i&&c&&typeof c.revision=="number"&&Array.isArray(c.presets)&&i.set({revision:c.revision,presets:c.presets})}async function G(){let c=He(),m=c?.presets.find(v=>v.id===g);if(!(!s||!d||!c||!m||wt(m)||w)){w=!0,A=[],Oe();try{let v=await Promise.resolve(s("apply-impl-preset",Au(d,m.id,c.revision)));if(v&&v.conflict){lt(v),ce("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let B=v&&Array.isArray(v.issue)?v.issue[0]:v?.issue;if(v&&v.applied&&B&&typeof B=="object"){p=B,A=Array.isArray(v.skipped_orchestration_keys)?v.skipped_orchestration_keys.filter(_e=>typeof _e=="string"):[];for(let _e of Mu)delete f[_e];ce(A.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}v&&v.error==="bd_readback_failed"?ce("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):ce("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(v){v&&typeof v=="object"&&v.code==="bd_readback_failed"?ce("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):ce("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{w=!1,Oe()}}}let pe=null;n&&n.subscribe&&(pe=n.subscribe(()=>k()));let qe=null;a&&typeof a.subscribe=="function"&&(qe=a.subscribe(()=>{d&&Oe()}));let S=null;i&&typeof i.subscribe=="function"&&(S=i.subscribe(()=>{d&&Oe()}));function I(c){c.key==="Escape"&&d&&(c.preventDefault(),r())}document.addEventListener("keydown",I);function k(){if(d){if(n&&typeof n.snapshotFor=="function"){let c=n.snapshotFor("detail:"+d)||[];p=c.find(v=>v&&v.id===d)||c[0]||p}Se(),Oe()}}function L(c){sn(c).then(m=>{m?ce("\uBCF5\uC0AC\uB428","success",1200):ce("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function re(c){c.preventDefault(),c.stopPropagation(),d&&L(d)}function de(c,m){c.preventDefault(),c.stopPropagation(),L(m)}function te(c,m,v){c.preventDefault(),c.stopPropagation(),ge.open(m,{missing_state:v})}function be(c,m){f[c]=m,Oe(),!(!s||!d)&&Promise.resolve(s("update-exec-settings",xu(d,c,m.length===0?null:m))).catch(()=>{ce("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function ct(c,m){let v=p||{},B=v.metadata&&typeof v.metadata=="object"?v.metadata:{},_e={};for(let ze of["impl_runtime","impl_model","impl_effort"])_e[ze]=Object.hasOwn(f,ze)?f[ze]:typeof B[ze]=="string"?B[ze]:"";_e[c]=m;let Ce=qu(_e,gt(),Ne()),Ee={};for(let ze of["impl_runtime","impl_model","impl_effort"])Ee[ze]=f[ze],f[ze]=Ce[ze]||"";Oe(),!(!s||!d)&&Promise.resolve(s("update-impl-target",{id:d,...Ce,orchestration_runtime:Ne()})).then(ze=>{let dt=Array.isArray(ze)?ze[0]:ze;if(!dt||typeof dt!="object"||!dt.id)throw new Error("implementation target readback failed");p=dt;for(let jt of["impl_runtime","impl_model","impl_effort"])delete f[jt];Oe()}).catch(()=>{for(let ze of["impl_runtime","impl_model","impl_effort"])Ee[ze]===void 0?delete f[ze]:f[ze]=Ee[ze];Oe(),ce("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function Xe(c,m,v){if(!s||!d)return!1;try{let B=await Promise.resolve(s(c,m)),_e=Array.isArray(B)?B[0]:B;return _e&&typeof _e=="object"&&_e.id?(p=_e,!0):(ce(v,"error"),!1)}catch{return ce(v,"error"),!1}}function Ye(c){setTimeout(()=>{try{let m=e.querySelector(c);m&&typeof m.focus=="function"&&m.focus()}catch{}},0)}function bt(){M=!0,U=p&&p.title||"",Oe(),Ye('.detail-edit__input[data-edit="title"]')}function St(c){U=c.target.value}function yt(){M=!1,U="",Oe()}function Ct(){Xe("edit-text",{id:d,field:"title",value:U},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(m=>{m&&(M=!1,U=""),Oe()})}function zt(){q=!0,E=p&&p.description||"",Oe(),Ye('.detail-edit__textarea[data-edit="description"]')}function Nt(c){E=c.target.value}function Mt(){q=!1,E="",Oe()}function Ft(){Xe("edit-text",{id:d,field:"description",value:E},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(m=>{m&&(q=!1,E=""),Oe()})}function Lt(c,m,v,B){if(c.key==="Escape"){c.stopPropagation(),v();return}c.key==="Enter"&&(!B||c.ctrlKey||c.metaKey)&&(c.preventDefault(),m())}function Ue(c){let m=c.target.value;Xe("update-status",{id:d,status:m},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>Oe())}function Ut(c){let m=Number(c.target.value);Xe("update-priority",{id:d,priority:m},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>Oe())}function Ht(c){R=c.target.value}function et(){let c=R.trim();c.length!==0&&Xe("label-add",{id:d,label:c},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(m=>{m&&(R=""),Oe()})}function Wt(c){if(c.key==="Escape"){c.stopPropagation(),R="",Oe();return}c.key==="Enter"&&(c.preventDefault(),et())}function Fe(c){Xe("label-remove",{id:d,label:c},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>Oe())}let T={onCopyPath:de,onOpenDoc:te};function fe(c){return typeof c=="string"?c:c&&typeof c=="object"?String(c.id||c.to||c.issue_id||c.depends_on||""):""}function Te(c){switch(c&&typeof c=="object"?String(c.dependency_type||c.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function at(c){let v=(Array.isArray(c.dependencies)?c.dependencies:[]).map(B=>({id:fe(B),icon:Te(B)})).filter(B=>B.id.length>0);return l`
    ...
    `}function Rt(c){let m=c.metadata||{},v=c.workflow||{},B=v.stages||{},_e=B.spec&&B.spec.stale,Ce=B.impl&&B.impl.stale,Ee=B.plan||null,ze=v.route_source==="derived",dt=v.route||m.route||"\u2014";return l`
      ...
      ${v.route!=="quick_fix"||Object.hasOwn(m,"spec_review")?l`<div class="detail-kv">
            ...
            <span class="detail-kv__v"
              >${m.spec_review||"\uC5C6\uC74C"}${_e?" \xB7 stale":""}</span
            >
          </div>`:""}
      ...
      ${v.route!=="quick_fix"||Object.hasOwn(m,"impl_review")?l`<div class="detail-kv">
            ...
            <span class="detail-kv__v"
              >${m.impl_review||"\uC5C6\uC74C"}${Ce?" \xB7 stale":""}</span
            >
          </div>`:""}
    ...
    `}let b={route:["quick_fix","spec_backed","full_plan"]};async function h(c,m){let v=m.target.value;if(c==="route"&&p&&p.metadata&&p.metadata.route==="full_plan"&&v!=="full_plan"&&!window.confirm(`full_plan \u2192 ${v||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){Oe();return}await Xe("update-workflow-meta",{id:d,key:c,value:v},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),Oe()}function x(c){let m=c.metadata||{};return l` ${((B,_e)=>{let Ce=b[B],Ee=typeof m[B]=="string"?m[B]:"";return l`<div class="detail-kv">
      ...
      </div>`})("route","(unset)")} `}function O(c,m){return M?l`
    ...
    `}function ee(c){let m=Gt(c.created_at),v=Gt(c.updated_at);return!m&&!v?l``:l`
    ...
    `}function y(c,m){return l`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Ut}
        >
          ${Cg.map(v=>l`<option value=${String(v)} ?selected=${v===m}>
                P${v}
              </option>`)}
        </select>
      </div>
    ...
    `}function le(c){let m=typeof c.notes=="string"?c.notes:"";return m.trim().length===0?l``:l`
      <div class="detail-overlay__section-label">노트</div>
      <div class="detail-overlay__notes">${m}</div>
    `}function ye(c){let m=Array.isArray(c.labels)?c.labels:[];return l`
    ...
    `}function Ke(){if(!d)return l``;let c=p||{},m=String(c.id||d),v=c.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",B=X(),_e=c.status||"open",Ce=typeof c.priority=="number"?Math.max(0,Math.min(4,c.priority)):"",Ee=c.description||"",ze={...c,metadata:{...c.metadata||{},...f}};return l`
  ...
  >
    ...
    <span
      ...
      >${n.badge.label}</span
    >
  </button>`:""}function Nr(e){let t=rn(e.created_at),n=rn(e.updated_at);return!t&&!n?"":l`<div class="worker-mini__meta">
...
\uC774\uC288 \uD540 \u2014 \uB808\uD3EC \uAE30\uBCF8\uAC12\uACFC \uB2E4\uB984`:"";return l`${e.orchestration?l`<span
  ...
  </div>`}function qr(e,t={}){if(!e)return"";let n=Array.isArray(e.predecessors)?e.predecessors:[],r=Array.isArray(e.successors)?e.successors:[],s=Array.isArray(e.warnings)?e.warnings:[],o=Array.isArray(e.overlaps)?e.overlaps:[],a=e.scope_missing===!0&&t.lane!=="running",i=e.popover||null;if(n.length===0&&r.length===0&&s.length===0&&o.length===0&&!a)return"";let u=o.length>Do,d=u?o.slice(0,Do):o;return l`<div class="worker-deps">
...
`)}
  ...
  </div>`}function Fr(e){if(!e)return"";let t=e.chips||{},n=t.route||e.route,r=t.route_source==="derived"||e.route_source==="derived";return n?l`<span
  ...
  >
    ...
    >${e.id}</span
  >`,A=e.lane==="done"?"":Fr(e.workflow),D=l`<span class="worker-mini__title">${e.title}</span>`,W=e.pr_url&&e.pr_number?l`<a
      ...
      >
        ...
        </div>`:"",oe=qr(e.dependency_chips,{lane:e.lane}),ae=ws(e),xe=!!(s||o||e.merge_action||e.cancel_action||e.timeline_action||e.discard_action||Z?.operation||e.revise_action||ue);return l`<div
  ...
  >
    ${i?l`<div class="worker-mini__row1">${g}${w}${D}</div>
          <div class="worker-mini__row2">
            ...
            ${Nr(e)}`:l`<div class="worker-mini__line">
              ${d}${p}${g}${w}${A}${D}${W}${V}${Y}${f}${N}${M}${q}${U}${E}${R}${$e}
            </div>
            ${oe}${we}${ae} ${Nr(e)}`}
  </div>`}function _i(e,t=null,n={}){let r=e.worker_ineligible===!0,s=e.draggable&&!e.done&&!r,o=s&&t&&t.bead_id===e.id,a=e.workflow,i=typeof e.reason=="string"&&e.reason.split(" \xB7 ").includes("missing_description"),u=typeof e.reason=="string"&&e.reason.startsWith("\u26D4"),d=qr(e.dependency_chips,{lane:e.lane});return l`<div
  ...
  >
    ...
    ${t?"":l`${e.controls?e.controls:""}
          <div class="worker-pane__body">
            ${e.body?e.body:e.items.length===0?l`<div class="worker-pane__empty">
                    ${e.empty||""}
                  </div>`:e.items.map(r=>e.lane==="candidate"?_i(r,e.place_menu):zn(r))}
          </div>`}
  </section>`}var Yu={verify_failed:"\uAC80\uC99D \uC2E4\uD328",verify_cmd_failed:"\uAC80\uC99D \uC2E4\uD328",verify_script_failure:"\uAC80\uC99D \uC2E4\uD328",deploy_failed:"\uBC30\uD3EC \uC2E4\uD328",deploy_script_failure:"\uBC30\uD3EC \uC2E4\uD328",interrupted_without_terminal_exit:"\uC911\uB2E8\uB428"},Zu={repo_ops_worktree_unowned:"\uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC\uAC00 \uC544\uC9C1 Worker \uC18C\uC720\uAC00 \uC544\uB2C8\uC5B4\uC11C \uC2A4\uD06C\uB9BD\uD2B8 \uC2E4\uD589 \uC804\uC5D0 \uC911\uB2E8\uB410\uC2B5\uB2C8\uB2E4.",verify_cmd_failed:"\uBA38\uC9C0 \uD6C4 \uAC80\uC99D \uBA85\uB839\uC774 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",gh_observation_failed:"GitHub\uC5D0\uC11C PR \uC0C1\uD0DC\uB97C \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",verify_script_failure:"\uAC80\uC99D \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",deploy_script_failure:"\uBC30\uD3EC \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",interrupted_without_terminal_exit:"\uC791\uC5C5\uC774 \uC885\uB8CC \uAE30\uB85D \uC5C6\uC774 \uC911\uB2E8\uB410\uC2B5\uB2C8\uB2E4.",base_unresolved:"PR\uC774 \uC5B4\uB290 base \uBE0C\uB79C\uCE58\uB85C \uBA38\uC9C0\uB418\uB294\uC9C0 \uD655\uC815\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",base_ref_unobserved:"PR\uC758 base \uBE0C\uB79C\uCE58\uB97C \uC544\uC9C1 \uAD00\uCE21\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",merge_sha_unobserved:"\uBA38\uC9C0 \uCEE4\uBC0B SHA\uB97C \uC544\uC9C1 \uAD00\uCE21\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",base_fetch_failed:"\uC6D0\uACA9 base \uBE0C\uB79C\uCE58\uB97C fetch\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",base_rev_unavailable:"fetch\uD55C \uC6D0\uACA9 base \uBE0C\uB79C\uCE58\uC758 \uCEE4\uBC0B\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",base_ff_diverged:"\uB85C\uCEEC base \uBE0C\uB79C\uCE58\uAC00 \uC6D0\uACA9\uACFC \uAC08\uB77C\uC838 fast-forward\uB85C \uC815\uB82C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",deployment_target_not_covering_merge:"\uBC30\uD3EC \uB300\uC0C1 base\uAC00 \uC774 \uBA38\uC9C0 \uCEE4\uBC0B\uC744 \uD3EC\uD568\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",deployment_candidate_ancestry_check_failed:"\uBC30\uD3EC \uB300\uC0C1 base\uAC00 \uC774 \uBA38\uC9C0 \uCEE4\uBC0B\uC744 \uD3EC\uD568\uD558\uB294\uC9C0 \uD655\uC778\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."};function Qu(e){return typeof e!="string"||e.length===0?[]:e.split(":").filter(t=>t.length>0)}function mi(e){for(let t of Qu(e))if(Object.hasOwn(Yu,t))return Yu[t];return null}function gi(e){let t=null;for(let n of Qu(e))Object.hasOwn(Zu,n)&&(t=Zu[n]);return t}function Uo(e){let t=mi(e),n=gi(e);return t&&n?`${t} \u2014 ${n}`:t||n?t||n:typeof e=="string"?e:""}function Xu(e,t){let n=mi(e)??mi(t),r=gi(t)??gi(e);return n&&r?`${n} \u2014 ${r}`:n||r?n||r:typeof t=="string"?t:""}var Ju=160;function Mg(e){return e.length>Ju?`${e.slice(0,Ju)}\u2026`:e}function Dg(e){return!e||!e.reason?"":l`<div class="worker-banner__detail">
    가드:
  ...
  </details>`:""}function qg(e){if(!Number.isFinite(e)||e<0)return"0s";let t=Math.floor(e/1e3),n=Math.floor(t/60),r=t%60;return n>0?`${n}m ${String(r).padStart(2,"0")}s`:`${r}s`}function ed(e){let t=e.failure?Uo(e.failure.reason):"";return l`<div class="worker-banners">
    ${e.failure?l`<div class="worker-banner worker-banner--failure" role="alert">
        ...
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?l`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`:""}var jg=new Set(["codex-runner"]);function Bg(e,t,n,r=null){if(!e)return"";let s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=(r||!Array.isArray(e.legs)?[]:e.legs).filter(g=>g&&!(typeof g.agent_type=="string"&&jg.has(g.agent_type))),u=i.filter(g=>g&&g.state==="live"),d=i.filter(g=>g&&g.state!=="live"),p=qr(e.dependency_chips,{lane:"running"}),f=r?rn(r.updated_at,t):"";return l`${o?l`<div class="rtile__activity${n?" is-paused":""}">
  ...
  >
    <div class="rtile__hd">
      ...
      ${Fr(e.workflow)}${V}${d?l`<span class="rtile__resumed" title=${d}>↻</span>`:""}
...
`)}function Wo(e){if(typeof e!="object"||e===null)return null;let t=ir(e);if(t==="")return null;let n=(r,s)=>typeof s=="string"&&s.length>0?`${r}: ${s}`:null;return{text:t,title:vi(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(Wn.orchestration_model,e.model),n(Wn.orchestration_effort,e.effort),n(Wn.orchestration_speed,e.speed)])}}function dr(e,t){let n=Hn(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=Hn(e,"orchestration_effort"),s=Hn(e,"orchestration_speed"),o=td([yn(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:vi(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Gn("orchestration_model",n),Gn("orchestration_effort",r),Gn("orchestration_speed",s)])}}function Ug(e,t){return e===null||e.value===null||yi.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function Wg(e){return e===null||yi.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function zg(e){return e===null?null:e.value==="auto"?"auto":yi.has(e.resolution)?null:e.display}function Vn(e,t){if(typeof e!="object"||e===null)return null;let n=Hn(e,"impl_dispatch"),r=Hn(e,"impl_runtime"),s=Hn(e,"impl_model"),o=Hn(e,"impl_effort"),a=Hn(e,"impl_speed"),i=n!==null&&n.value==="main"?"\uBA54\uC778":td([Ug(r,t??null),Wg(s),zg(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:vi(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Gn("impl_dispatch",n),Gn("impl_runtime",r),Gn("impl_model",s),Gn("impl_effort",o),Gn("impl_speed",a)])}}var en="",Hg=["impl_runtime","impl_model","impl_effort"],Gg=5,zo=1;function Dn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Ho(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(P=>ce(P,"error",4e3)),o={},a={},i=[],u=!1,d=null,p={},f="",g="",w=!1,A=!1,D=!1,W=null,V=!1;function Y(){let P=t.queue?t.queue():null;return Dn(P)?P:null}function N(){let P=Y();return P?P.runner_catalog:null}function M(){let P=Y();return P&&Dn(P.execution_defaults)?P.execution_defaults:null}function q(){let P=t.implPresetStore?.get();return Dn(P)&&Array.isArray(P.presets)?P:null}function U(){return r===null?{}:{root_dir:r}}async function E(P,H){return V||!n?null:await n(P,H)}function R(P){P&&Dn(P.queue)&&t.onQueueAdopt?.(P.queue)}async function Z(P,H){let J=Y();if(!J||V)return null;let X=await E(P,{...H,...U(),expected_revision:J.revision});if(R(X),r!==null&&X&&X.conflict){let Pe=X.queue&&typeof X.queue.revision=="number"?X.queue.revision:Y()?.revision??J.revision;X=await E(P,{...H,...U(),expected_revision:Pe}),R(X)}return X}async function $e(){u=!0,ve();try{let P=await E("get-session-defaults",{...U()});o=Dn(P?.values)?{...P.values}:{},a={...o},i=Array.isArray(P?.warnings)?P.warnings:[]}catch(P){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${P instanceof Error?P.message:String(P)}`)}finally{u=!1,ve()}}async function ue(){let P=wu(o,a);if(Object.keys(P).length!==0){try{let H=await E("set-session-defaults",{values:P,...U()});o=Dn(H?.values)?{...H.values}:{},a={...o},i=Array.isArray(H?.warnings)?H.warnings:[]}catch(H){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${H instanceof Error?H.message:String(H)}`)}ve()}}function me(P,H){if(Hg.includes(P)){we(P,H);return}H===en?delete a[P]:a[P]=H,ve(),ue()}function Q(){let P=Qe().orchestration_model,H=Jt({global:{orchestration_model:P??void 0},execution_defaults:M(),runner_catalog:N()}).orchestration_model.value;return H?yn(N(),H):null}function Re(P,H){typeof H=="string"&&H.length>0?a[P]=H:delete a[P]}function we(P,H){let J=H===en?void 0:H,X=yu({impl_runtime:P==="impl_runtime"?J:a.impl_runtime,impl_model:P==="impl_model"?J:a.impl_model,impl_effort:P==="impl_effort"?J:a.impl_effort},N(),Q());Re("impl_runtime",X.impl_runtime),Re("impl_model",X.impl_model),Re("impl_effort",X.impl_effort),ve(),ue()}async function oe(){let P=Y();if(!P)return;let H={orchestration_model:P.orchestration_model??null,orchestration_effort:P.orchestration_effort??null,orchestration_speed:P.orchestration_speed??null},J=ku(H,{...H,...p});if(Object.keys(J).length!==0){try{let X=await Z("worker-queue-set-orchestration-defaults",{values:J});if(X&&X.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}p={}}catch(X){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}ve()}}function ae(P,H){p[P]=H===en?null:H,ve(),oe()}function xe(P){if(d=P,!P){ve();return}let H=N(),J=Qe(),X=J.orchestration_model;X&&!ys(H,P).includes(X)&&(p.orchestration_model=null,X=null);let Pe=J.orchestration_effort;Pe&&!ii(H,P,X||an).includes(Pe)&&(p.orchestration_effort=null),ve(),oe()}async function F(P){if(!(!Y()||P<zo)){try{await Z("worker-queue-set-slots",{slots:P})}catch(H){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${H instanceof Error?H.message:String(H)}`)}ve()}}async function se(P){if(!(!Y()||P<zo||P>Gg)){try{await Z("worker-queue-set-serial-lane-count",{count:P})}catch(H){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${H instanceof Error?H.message:String(H)}`)}ve()}}async function ie(P,H){let J=P==="auto_advance"?"worker-automation-toggle":P==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await Z(J,{on:H})}catch(X){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}ve()}function Ae(){let P={},H=Qe();for(let J of To){let X=Mn.includes(J)?H[J]:a[J];typeof X=="string"&&X.length>0&&(P[J]=X)}return P}async function Se(){let P=q();if(!P)return;let H=Ae();if(Object.keys(H).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let J=(P.presets||[]).find(Pe=>Pe.id===f),X=g.trim()||(J?J.name:"");if(!X){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let Pe=J?await E("impl-preset-update",{expected_revision:P.revision,id:J.id,name:X,settings:H}):await E("impl-preset-create",{expected_revision:P.revision,name:X,settings:H});if(Pe&&Pe.applied){if(g="",!J&&Array.isArray(Pe.presets)){let tt=Pe.presets.find(st=>st.name===X);f=tt?tt.id:f}ve()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),ve()}catch(Pe){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${Pe instanceof Error?Pe.message:String(Pe)}`)}}async function Ie(){let P=q();if(!(!P||f.length===0))try{let H=await E("impl-preset-delete",{expected_revision:P.revision,id:f});H&&H.applied?(f="",ve()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),ve())}catch(H){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${H instanceof Error?H.message:String(H)}`)}}function he(P){o=Dn(P.values)?{...P.values}:{},a={...o},i=Array.isArray(P.warnings)?P.warnings:[],Dn(P.queue)&&(t.onQueueAdopt?.(P.queue),p={})}async function it(){let P=q(),H=Y();if(!P||!H||f.length===0)return;let J=X=>({preset_id:f,expected_revision:P.revision,expected_queue_revision:X,...U()});try{let X=await E("apply-impl-preset-global",J(H.revision));if(X&&X.applied&&he(X),r!==null&&X&&X.queue_applied===!1){let Pe=X.queue&&typeof X.queue.revision=="number"?X.queue.revision:Y()?.revision??H.revision;X=await E("apply-impl-preset-global",J(Pe)),X&&X.applied&&he(X)}X&&X.applied?X.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):X&&X.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(X){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}ve()}async function _t(){A=!0,D=!1,ve();try{let P=await E("get-worker-system-prompt",{});!P||typeof P!="object"||Array.isArray(P)?D=!0:W=P}catch{D=!0}finally{A=!1,ve()}}function C(){if(w=!w,w&&!W){_t();return}ve()}function ge(){let P=Ir({loading:A,error:D});if(P)return P;if(!W)return"";let H=Array.isArray(W.variants)?W.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${w?ge():""}
    </section>`}function Le(P,H,J,X,Pe,tt,st){let Je=Pe[P]??en,vt=li(P,J,Pe,M(),N(),st),mt=vt.options.find(ut=>ut.value===Je),ot=Je===en?vt.full_value:mt?.full_value;return l`<select
    ...
    >
    ...
    </div>`}function Qe(){let P=Y(),H={};for(let J of Mn)H[J]=Object.prototype.hasOwnProperty.call(p,J)?p[J]:P&&typeof P[J]=="string"?P[J]:null;return H}function We(){let P=N(),H=a.impl_runtime,J=a.impl_model,X=q(),Pe=Y(),tt=Qe(),st=ys(P,d),Je=Mr(P,void 0).filter(He=>He!==an),vt=ii(P,d,tt.orchestration_model||an).filter(He=>He!==an),mt=f?(X?.presets||[]).find(He=>He.id===f):null,ot=mt?vu(Ae(),Dn(mt.settings)?mt.settings:{}):null,ut=Pe&&typeof Pe.slots=="number"?Pe.slots:zo+1,gt=Pe&&typeof Pe.serial_lane_count=="number"?Pe.serial_lane_count:zo,Ve=M()?.supported===!0,Ne=li("workflow_mode",hs,a,M(),P);return l`
      ...
      ${u?l`<div class="settings-dialog__empty">불러오는 중…</div>`:l`
            ...
            <div class="settings-dialog__group">
              ...
              ${Me("impl_model","\uBAA8\uB378",Mr(P,H),me,a)}
              ${Me("impl_effort","effort",Dr(P,H,J),me,a)}
  ...
  >
    ...
    >
      ...
      ${se.worker?l`<span class="mon2-deck__chip" title=${se.worker.title}
          ...
          >`:""}
    </div>`:""}function me(F){let se=jr(F,"running"),ie=typeof F.slots=="number"?F.slots:1;return l`<div
    ...
    >
      ...
      <div class="mon2-deck__slots">
        ...
        <span class="mon2-deck__counts"
          >${se}/${ie} 실행 · 대기 ${jr(F,"queue")} · PR
          ${jr(F,"pr_wait")}${jr(F,"session_active")>0?` \xB7 \uC138\uC158 ${jr(F,"session_active")}`:""}</span
        >
      </div>
      <div class="mon2-deck__ops">${$e(F)}</div>
      ${ue(F)}
    </div>`}function Q(F){let se=t.doneItems?t.doneItems():[],ie=t.rangeLabel?t.rangeLabel():"",Ae=ld(Array.isArray(se)?se:[]),Se=Ie=>F.reduce((he,it)=>he+jr(it,Ie),0);return l`<div
...
`):""}
    ...
    `}function f(){s&&Ze(d(),s),o&&Ze(p(),o)}return f(),a=t.subscribe(()=>f()),{destroy(){a&&(a(),a=null),s&&Ze(l``,s),o&&Ze(l``,o)}}}var jd=["bug","feature","task","epic","chore"];function Bd(e){switch((e||"").toString().toLowerCase()){case"bug":return"Bug";case"feature":return"Feature";case"task":return"Task";case"epic":return"Epic";case"chore":return"Chore";default:return""}}var Ud=["Critical","High","Medium","Low","Backlog"];function Wd(e,t){let n=document.createElement("dialog");n.id="new-issue-dialog",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
  ...
  `}var Nh=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function Vd(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(Q=>ce(Q,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",u=!1,d="",p=null;function f(){if(p)return p;let Q=a.querySelector('[data-pane="execution"]');return Q?(p=Ho(Q,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:Re=>t.queueStore?.set?.(Re)}),p):null}function g(){return l`
      <section
    ...
    `}function w(){let Q=r.get();return l`
      ...
      >
        ...
        ${Q?l`
              ${zd(Q,s(),V)}
              ${Hd(Q,d,{onDraft:Re=>{d=Re},onAdd:Y,onRemove:N})}
              ${Gd(Q,M)}
    ...
    </span>`}function q(oe,ae,xe){let F=ae.available&&typeof ae.ageSeconds=="number"&&ae.ageSeconds>Yd,se=F&&typeof ae.ageSeconds=="number"?`${Math.floor(ae.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",ie=ae.accounts.filter(he=>!he.active).length,Ae=`usage-meter__group${F?" usage-meter__group--stale":""}`,Se=l`<span class="usage-meter__provider"
        >${oe.label}</span
      >
    ...
    </span>`}function E(oe,ae){let xe=Jd(oe.pct),F=Qd(oe.resetsAt,ae);return l`<span
      class="usage-meter__account-window ${Xd(xe)}"
      style=${`--progress: ${xe}%`}
    >
      ...
      <span class="usage-meter__account-reset"
        >${F.length>0?`\u21BB ${F}`:""}</span
      >
    </span>`}function R(oe,ae){return Uh.includes(ae)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${oe.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function Z(oe,ae,xe){let F=ae.status==="ok",se=typeof ae.ageSeconds=="number"&&ae.ageSeconds>Yd,ie=a.get(tp(oe.key,ae.number)),Ae=r.get(oe.key),Se=Ae!==void 0,Ie=Ae===ae.number,he=["usage-meter__account"];return ae.active&&he.push("usage-meter__account--active"),F||he.push("usage-meter__account--unavailable"),se&&he.push("usage-meter__account--stale"),l`<div class=${he.join(" ")}>
...
`):[];return l`<div
  ...
  >
    ...
    <button
      ...
      title="해결 세션을 엽니다"
    >
      ${Object.hasOwn(_p,r)?_p[r]:"\uC2E4\uD328 \uD574\uACB0 \uC138\uC158 \uC2DC\uC791"}
    </button>
  ...
  >
    ...
    <span class="worker-ev__node" aria-hidden="true"
      ><span class="worker-ev__dot worker-ev__dot--${mp(e)}"></span
    ></span>
    <div class="worker-ev__body">
      <div class="worker-ev__line1">
        <span class="worker-ev__what"
          >${Object.hasOwn(fp,t.kind)?fp[t.kind]:t.kind}</span
        >
        <span class="worker-ev__meta"
          >${t.target_base}@${No(t.target_sha)}${typeof t.elapsed_ms=="number"?` \xB7 ${ks(t.elapsed_ms)}`:""}</span
        >
        <span class="worker-ev__st worker-ev__st--${mp(e)}"
          >${cb(e)}</span
        >
      ...
      ${n?bp(Xu(t.failure_kind,r)):""}
      ${ub(t)}
      ${hp([{term:"\uC2E4\uD328 \uCF54\uB4DC",value:n?r:""},{term:"script",value:[t.script_path||"",t.script_blob_sha?`blob ${No(t.script_blob_sha)}`:"",Number.isInteger(t.exit_code)?`exit ${t.exit_code}`:""].filter(Boolean).join(" \xB7 ")},{term:"\uB85C\uADF8",value:t.log_path||""},{term:"\uCD9C\uB825",value:t.output_tail||""}])}
    </div>
  ...
  >
    ...
    <div class="worker-ev__body">
      ...
      ${bp(Uo(t.reason),typeof t.retry_count=="number"&&t.retry_count>0?`${t.retry_count}\uD68C \uC790\uB3D9 \uC7AC\uC2DC\uB3C4 \uD6C4\uC5D0\uB3C4 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD558\uBA74 \uBA48\uCD98 \uB2E8\uACC4\uBD80\uD130 \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4.`:"\uC815\uB9AC\uB97C \uC7AC\uAC1C\uD558\uBA74 \uBA48\uCD98 \uB2E8\uACC4\uBD80\uD130 \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4.",!0)}
  ...
  </section>`}function yp(e,t={}){let n=null;function r(){if(n===null){Ze(l``,e);return}let a=lb(n.operations,n.cleanup_failures,{expanded:n.expanded});Ze(fb({events:a.visible,hidden:a.hidden,expanded:n.expanded,repo:n.repo}),e)}e.addEventListener("click",a=>{let i=a.target;if(i?.closest?.('[data-seam="repo-ops-close"]')){o();return}i?.closest?.('[data-seam="repo-ops-more"]')&&n&&(n.expanded=!n.expanded,r())});function s(a){n={operations:a.operations,cleanup_failures:a.cleanup_failures,repo:a.repo||"",expanded:!1},r()}function o(){n!==null&&(n=null,r(),t.onClose&&t.onClose())}return{open:s,close:o,isOpen:()=>n!==null,refresh(a){n&&(n={operations:a.operations,cleanup_failures:a.cleanup_failures,repo:a.repo||"",expanded:n.expanded},r())}}}var _b=Et("views:worker"),mb="tab:worker:ready",gb="tab:worker:blocked",hb="tab:worker:in-progress",bb="tab:worker:resolved",yb="tab:worker:closed",Xo=1,vp=5;function wp(e){return Ao(e).path.length>0}var vb=new Set(["quick_fix","spec_backed","full_plan"]);function kp(e){return typeof e=="string"&&vb.has(e)}var Sp="beads-ui.worker.candidate-filter",Mi={show_blocked:!1,spec:"all"};function wb(){try{let e=window.localStorage.getItem(Sp);if(!e)return{...Mi};let t=JSON.parse(e);if(!t||typeof t!="object")return{...Mi};let n=t.spec;return{show_blocked:t.show_blocked===!0,spec:n==="with"||n==="without"?n:"all"}}catch{return{...Mi}}}function kb(e){try{window.localStorage.setItem(Sp,JSON.stringify(e))}catch{}}function $b(e,t){let n=i=>t.show_blocked||!i.blocked,r=i=>t.spec==="all"||(t.spec==="with"?i.has_spec:!i.has_spec),s=[],o=0,a=0;for(let i of e){let u=n(i),d=r(i);u&&d?s.push(i):!u&&d?o+=1:u&&!d&&(a+=1)}return{visible:s,hidden_blocked:o,hidden_spec:a}}var xb=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],Ep="bdui.worker.candidate_sort",Ab=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],Jo="spec";function Sb(){try{let e=window.localStorage.getItem(Ep);return e==="board"||e==="created"||e==="spec"?e:Jo}catch{return Jo}}function Eb(e){try{window.localStorage.setItem(Ep,e)}catch{}}var Tp="bdui.worker.done-range";function Tb(){try{let e=window.localStorage.getItem(Tp);return cn(e)?e:nn}catch{return nn}}function Cb(e){try{window.localStorage.setItem(Tp,e)}catch{}}var Rb="(max-width: 640px)",Cp="beads-ui.worker.lane-collapsed",Cs={queue:!0,done:!0};function Lb(){try{let e=window.localStorage.getItem(Cp);if(!e)return{...Cs};let t=JSON.parse(e);return!t||typeof t!="object"?{...Cs}:{queue:typeof t.queue=="boolean"?t.queue:Cs.queue,done:typeof t.done=="boolean"?t.done:Cs.done}}catch{return{...Cs}}}function Ob(e){try{window.localStorage.setItem(Cp,JSON.stringify(e))}catch{}}function $p(e){let t=Array.isArray(e)&&e.length>0?e[0]:null;if(!t)return"";let n=typeof t.title=="string"?t.title:t.id||"";return n.length>22?`${n.slice(0,22)}\u2026`:n}function Ib(e,t,n){let r=Array.isArray(e)?e.slice():[];return t==="created"?r.sort(ar):(r.sort(Ys(n)),t==="board"?r:[...r.filter(wp),...r.filter(s=>!wp(s))])}function Pb(e){let t=e&&e.parent;return(typeof t=="string"?t.length>0:!!(t&&t.id))||/\.\d+$/.test(e&&e.id||"")}function Mb(e){let t=e?.blocked_info;if(t&&typeof t=="object"){let s=Array.isArray(t.blockers)?t.blockers.filter(o=>typeof o=="string"&&o.length>0):[];return s.length>0?`\u{1F512} ${s.join(", ")}`:"\u{1F512} blocked"}let r=(Array.isArray(e?.dependencies)?e.dependencies:[]).map(s=>{if(typeof s=="string")return s;if(!s||typeof s!="object")return"";let o=s.type??s.dependency_type;return o!==void 0&&o!=="blocks"?"":s.depends_on_id||s.id||""}).filter(Boolean);return r.length>0?`\u{1F512} ${r.join(", ")}`:"\u{1F512} blocked"}function xp(e){if(e.startsWith("receipt_unbacked:"))return`\uC2E4\uD589 \uC601\uC218\uC99D \uC790\uB3D9 \uAC80\uC99D \uBD88\uAC00(${e.slice(17)}) \u2014 [\uBA38\uC9C0] \uD074\uB9AD\uC73C\uB85C \uC218\uB3D9 \uC9C4\uD589 \uAC00\uB2A5`;switch(e){case"not_in_pr_wait":return"PR \uB300\uAE30 \uC0C1\uD0DC \uB3D9\uAE30\uD654 \uC2E4\uD328";case"resolution_round_cap":return"\uCDA9\uB3CC \uD574\uC18C 2\uD68C \uCD08\uACFC";case"resolution_timeout":return"\uCDA9\uB3CC \uD574\uC18C \uB300\uAE30 \uC2DC\uAC04 \uCD08\uACFC";case"resolution_refused":return"\uD574\uC18C \uC138\uC158 \uB514\uC2A4\uD328\uCE58 \uAC70\uBD80";case"worktree_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uD574\uC18C \uD544\uC694";case"merge_unconfirmed_timeout":return"\uBA38\uC9C0 \uD655\uC778 \uC2DC\uAC04 \uCD08\uACFC";case"pr_closed_unmerged":return"PR \uB2EB\uD798";case"merge_error":return"\uBA38\uC9C0 \uC624\uB958";case"spec_id_missing":return"\uC2A4\uD399 ID \uAE30\uB85D \uC5C6\uC74C";default:return e}}function Db(e){let t=typeof e=="string"?e:"";return t==="review_failed"||t==="review_verdict_malformed"?{label:"\uB9AC\uBDF0\uC5B4 \uAC70\uBD80",action:"\uB9AC\uBDF0\uC5B4\uAC00 \uC2B9\uC778\uD558\uC9C0 \uC54A\uC558\uAC70\uB098 \uD310\uC815\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uCF54\uB4DC\uB97C \uACE0\uCE5C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:t==="reviewer_selection_invalid"?{label:"\uB9AC\uBDF0\uC5B4 \uC124\uC815 \uC624\uB958",action:"\uB9AC\uBDF0\uC5B4 \uC120\uD0DD(Bead\xB7\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\xB7harness)\uC774 \uC720\uD6A8\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4 \u2014 \uC124\uC815\uC744 \uACE0\uCE5C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:t.startsWith("repair_")?{label:"\uC218\uB9AC \uC2E4\uD328",action:"REVISE \uB4A4 1\uD68C \uC790\uB3D9 \uC218\uB9AC\uAC00 \uC2E4\uD328\uD588\uAC70\uB098 \uC608\uC0B0\uC744 \uB2E4 \uC37C\uC2B5\uB2C8\uB2E4 \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uACE0\uCE5C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:t.endsWith("_drift")||t.endsWith("_mismatch")||t==="head_drift_during_receipt"||t==="resolver_self_review_not_approved"?{label:"head \uBD88\uC77C\uCE58",action:"\uB9AC\uBDF0\uD55C head\uC640 \uD604\uC7AC head\uAC00 \uB2E4\uB985\uB2C8\uB2E4 \u2014 \uB204\uAC00 \uBE0C\uB79C\uCE58\uB97C \uBC14\uAFE8\uB294\uC9C0 \uD655\uC778\uD55C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}:{label:"\uC9C4\uD589 \uBD88\uAC00",action:"\uB9AC\uBDF0 \uC9C4\uD589\uC744 \uC774\uC5B4\uAC08 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uC0AC\uC720\uB97C \uD655\uC778\uD55C \uB4A4 \uB2E4\uC2DC [\uBA38\uC9C0]"}}function Nb(e){if(e==="lane_occupied")return"\uC2E4\uD589 \uB808\uC778\uC5D0 \uB0A8\uC544 \uC788\uC5B4 \uBA38\uC9C0 \uB300\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4";let t="\uBA38\uC9C0 \uD050\uC5D0 \uB123\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (\uC774\uBBF8 \uB300\uAE30 \uC911\uC774\uAC70\uB098 \uB300\uC0C1 \uC544\uB2D8)";return typeof e=="string"&&e.length>0?`${t}: ${e}`:t}function qb(e,t=null){if(e==="worker_sessions_busy")return"\uD574\uC18C \uB300\uAE30 \u2014 \uC2E4\uD589 \uC2AC\uB86F \uB300\uAE30 \uC911";if(typeof e!="string"||!e.startsWith("completion_waiting:"))return null;let n=e.slice(19);if(n.length===0)return null;switch(n){case"gating":{let r=t?.repair_sessions_used;return typeof r=="number"&&r>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911"}case"repairing":return"\uC790\uB3D9 \uC218\uC815 \uC911";case"waiting_repair_pr":return"\uC218\uC815 PR \uB300\uAE30 \uC911";case"merging":return"\uBA38\uC9C0 \uC911";case"cleaning":return"\uB9C8\uBB34\uB9AC \uC911";case"paused":return"\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";case"needs_human":return"\uD655\uC778 \uD544\uC694";default:return null}}function Fb(e){if(!e||typeof e!="object")return null;switch(e.state){case"waiting":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC911",live:!0};case"yielded":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uACC4\uC18D \uC911 \xB7 \uC644\uB8CC \uD6C4 \uC6B0\uC120 \uBA38\uC9C0",live:!0};case"ready":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC644\uB8CC \xB7 \uC7AC\uAC80\uC99D \uB300\uAE30",live:!1};default:return null}}function jb(e){if(!e||typeof e!="object")return null;switch(e.state){case"pending":return{badge:"implementation review \uB300\uAE30",live:!1,alert:!1};case"reviewing":return{badge:"implementation review \uC911",live:!0,alert:!1};case"revising":return{badge:"review \uC218\uC815 \uC911 \xB7 1\uD68C",live:!0,alert:!1};case"failed":{let n=(typeof e.failure_reason=="string"?e.failure_reason:"").replace(/[\u0000-\u001f\u007f]/g," ").slice(0,120);return{badge:n.trim().length>0?`review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328: ${n.trim()}`:"review \uC790\uB3D9 \uC9C4\uD589 \uC2E4\uD328",live:!1,alert:!0}}default:return null}}function Di(e,t){return typeof e!="string"||e.length===0||typeof t!="string"||t.length===0||t===e?null:`\u2192 ${t}`}function Bb(e){if(!e||typeof e!="object")return null;let t=Number.isInteger(e.repair_sessions_used)?Math.max(0,e.repair_sessions_used):0,n=Number.isInteger(e.repair_session_cap)?Math.max(0,e.repair_session_cap):0,r=e.current_repair&&typeof e.current_repair=="object"?e.current_repair:null,s=r&&typeof r.pr_number=="number"?r.pr_number:null,o="";switch(e.phase){case"gating":o=t>0?"\uC218\uC815 \uACB0\uACFC \uC7AC\uD655\uC778 \uC911":"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911";break;case"repairing":o="\uC790\uB3D9 \uC218\uC815 \uC911";break;case"waiting_repair_pr":o=s?`\uC218\uC815 PR #${s} \uB300\uAE30 \uC911`:"\uC218\uC815 PR \uB300\uAE30 \uC911";break;case"merging":o=e.subject_role==="repair"?s?`\uC218\uC815 PR #${s} \uBA38\uC9C0 \uC911`:"\uC218\uC815 PR \uBA38\uC9C0 \uC911":"\uBA38\uC9C0 \uC911";break;case"cleaning":o="\uB9C8\uBB34\uB9AC \uC911";break;case"paused":o="\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";break;case"needs_human":o="\uD655\uC778 \uD544\uC694";break;case"completed":return null;default:return null}let a=[o,`\uC790\uB3D9 \uC218\uC815 \uD69F\uC218 ${t}/${n}`];return e.head_sha&&a.push(`head ${e.head_sha}`),e.base_sha&&a.push(`base ${e.base_sha}`),(e.failure_stage||e.failure_reason)&&a.push(`${e.failure_stage||"failure"} \xB7 ${e.failure_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`),e.active_attempt_id&&a.push(`attempt ${e.active_attempt_id}`),r&&typeof r.bead_id=="string"&&a.push(`repair ${r.bead_id}`),e.evidence&&a.push(e.evidence),e.log_path&&a.push(e.log_path),{badge:o,title:a.join(`
`),alert:e.phase==="needs_human",lock_actions:e.phase!=="paused"&&e.phase!=="needs_human",repair_pr_url:r&&typeof r.pr_url=="string"?r.pr_url:"",repair_pr_number:s}}function Ap(e){if(!e||typeof e!="object")return[];let t=e.blocking_codes;return Array.isArray(t)?t.filter(n=>typeof n=="string"&&n.length>0):[]}function Ub(e){let t=e.queue_failure?`\uBA38\uC9C0 \uC2E4\uD328 \uC6D0\uBB38: ${e.queue_failure}`:e.auto_skip?`\uC790\uB3D9 \uC81C\uC678 \uC6D0\uBB38: ${e.auto_skip}`:"",n=(r,s={})=>{let o=[s.title||"",t].filter(Boolean);return{label:r,title:o.join(`
`),live:s.live===!0,alert:s.alert===!0}};if(e.continuation_required)return n("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694",{alert:!0});if(e.merge_step)return e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428",{title:e.merge_step.label,alert:e.merge_step.failed===!0}):n("\uBA38\uC9C0 \uC911",{title:e.merge_step.label,live:!0});if(e.conflict_badge)return n(e.conflict_badge,{live:e.conflict_live===!0});if(e.head_review&&e.head_review.state!=="failed")return n("\uB9AC\uBDF0 \uC9C4\uD589 \uC911",{title:e.head_review.badge,live:e.head_review.live===!0});if(e.recovery?.lock_actions)return n(e.recovery.badge,{title:e.recovery.title,live:!0});if(e.cleanup_failed)return n(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0});if(e.base_exception)return n("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0});if(e.conflicting)return n("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="base_behind")return n("base \uAC31\uC2E0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale")return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2C8\uAC70\uB098 \uC870\uC0C1 \uD655\uC778\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0});if(e.gate?.reason==="spec_id_missing")return n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0});if(e.gate?.reason==="review_receipt_invalid")return n("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0});if(Ap(e.receipt_check).length>0)return n("\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694",{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${Ap(e.receipt_check).join(", ")}`,alert:!0});if(e.head_review?.state==="failed"){let r=Db(e.head_review.failure_reason);return n(`\uB9AC\uBDF0 \uC2E4\uD328: ${r.label}`,{title:e.head_review.failure_reason?`${r.action} (${e.head_review.failure_reason})`:r.action,alert:!0})}return e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${xp(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${xp(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function Wb(e,t,n,r,s=null,o=null,a=null,i=!1,u=null,d=!0,p=null,f=null,g=null,w={},A=!1,D=!1,W={}){let V=!!u&&u.position>0,Y=!!u?.continuation_action&&u.continuation_action.continuation===null,N=!!u&&u.active===!0,M=u&&u.failure||null,q=qb(u?u.waiting:null,g),U=n[e]||null,E=U&&U.gate?U.gate:null,R=U&&U.pr?U.pr:null,Z=Bb(g),$e=Fb(u?u.resolution:null),ue=jb(u?u.head_review:null),me=u&&u.head_review||null,Q=u&&u.authority||null,Re=!!me&&["pending","reviewing","revising"].includes(me.state),we=V&&!N&&(me?.state==="failed"||!Q||Q.source==="automatic"&&!D),oe=a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":$e?$e.badge:a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":q,ae=!!E&&E.base_badge==="\uCDA9\uB3CC",xe=!!E&&E.enabled===!0,F=Es({bead_id:e,merge_sha:W.merge_sha,cleanup_cursor:W.cleanup_cursor,merge_progress:o&&o.merge_progress?o.merge_progress:null,cleanup_failed:r,repo_operations:W.repo_operations}),se=Zo(F),ie=!!r&&["child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!E&&E.tier==="merged",Ae=i&&!!r&&!!E&&E.tier==="merged",Se=we&&(xe||ae||E?.reason==="base_behind"||E?.reason==="review_receipt_missing"||E?.reason==="review_receipt_stale"||ie||Ae),Ie=i&&ae&&d===!1,he=An(w,e,{external:i,merge_active:N||F?.step==="merge",merge_queued:V,conflict_active:!!a,cleanup_active:se,merged:!!r||E?.tier==="merged"}),it=!!he.operation,_t=!ie&&!!r&&r.step==="repo_operations",C=Ub({continuation_required:Y,merge_step:F,conflict_badge:oe,conflict_live:$e?.live===!0||a==="running",head_review:me&&ue?{...ue,state:me.state,failure_reason:me.failure_reason}:null,recovery:Z,cleanup_failed:r,cleanup_label:r?pr(r.step):null,base_exception:f,conflicting:ae,gate:E,receipt_check:U&&U.receipt_check?U.receipt_check:null,queue_failure:M,auto_skip:p,queued:V,queue_active:N,queue_position:u?u.position:0,activity:oe?null:o&&o.activity||null}),ge=C?.live===!0&&C.title?l`<span title=${C.title}>${C.label}</span>`:C?.label||null;return{id:e,title:i?l`${t}<span class="muted"> · 세션</span>`:t,reason:r&&F?.active!==!0?Yo(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:A,external:i,pr_number:R&&typeof R.number=="number"?R.number:null,pr_url:R&&typeof R.url=="string"?R.url:"",completion_badge:C?.live!==!0&&C?.title?C.label:null,completion_title:C?.title||"",completion_repair_pr_url:Z?Z.repair_pr_url:"",completion_repair_pr_number:Z?Z.repair_pr_number:null,badges:ge?[ge]:[],live_badge:C?.live===!0?ge:null,usage:s,alert:C?.alert===!0,merge_action:E?.tier==="merged"&&!ie&&!Ae||_t?!1:!V||Y||we,timeline_action:_t,cancel_action:V&&!Y,cancel_enabled:(!N||Re)&&!(Z&&Z.lock_actions),cancel_title:Z&&Z.lock_actions?`${Z.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:N&&!Re?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":Re?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:he,discard_action:he.action,merge_step:F,discard_enabled:he.enabled,discard_title:he.title,merge_enabled:!F&&!a&&!it&&!f&&!(Z&&Z.lock_actions)&&!Ie&&!_t&&(xe||ae||E?.reason==="base_behind"||E?.reason==="review_receipt_missing"||E?.reason==="review_receipt_stale"||ie||Ae||Se),merge_label:Y?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":ie||Ae?"\uC815\uB9AC \uC7AC\uAC1C":ae&&!F&&!ie?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":E?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":E?.reason==="review_receipt_missing"||E?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":we?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:it?he.error?`\uD3D0\uAE30 \uC2E4\uD328: ${he.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${he.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:Y?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":F?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${F.label}`:Ae?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Ie?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":ie?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":ae?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":E?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":E?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":E?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uC790\uB3D9 \uC7AC\uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":E?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":xe?`\uBA38\uC9C0 (${E.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:E&&E.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${E&&E.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Ni(e,t={}){let{transport:n,issueStores:r,queueStore:s,analysisStore:o,sessionLogStore:a,uiOrderStore:i,gotoIssue:u,getWorkspacePath:d,doneRange:p,onDoneRangeChange:f}=t,g=r?Qs(r,i):null,w=to({transport:n,uiOrderStore:i}),A=null,D=[],W=wb(),V=null,Y=null,N={members_by_id:new Map,serial_raw_lengths:{},serial_lane_count:0,occupied_lanes:new Set},M=Sb(),q=cn(p)?p:Tb(),U=new Map;function E(){let c=Fn.find(m=>m.value===q);return c?c.label:"\uC624\uB298"}let R=Lb(),Z=!1,$e=new Set,ue=new Set,me=new Set,Q=new Set,Re=new Set,we={},oe=null,ae=0,xe=null,F=[];function se(c){return oe===c?we:{}}async function ie(){if(!n)return;let c=d?.()||"";if(oe===c||xe&&xe.key===c&&xe.generation===ae)return;let m=++ae;xe={key:c,generation:m};let v=null;try{v=await Promise.resolve(n("get-session-defaults",{}))}catch(B){if(m!==ae)return;xe=null,_b("get-session-defaults failed: %o",B),Ue();return}m===ae&&(we=v&&typeof v.values=="object"&&v.values!==null?{...v.values}:{},oe=c,xe=null,Ue())}function Ae(){oe=null,ae+=1,ie()}let Se=document.createElement("div");Se.className="worker-console";let Ie=document.createElement("div");Ie.className="worker-top";let he=document.createElement("div");he.className="worker-drawer-overlay",he.hidden=!0;let it=document.createElement("div");it.className="worker-drawer-overlay__backdrop";let _t=document.createElement("div");_t.className="worker-drawer-host";let C=document.createElement("div");C.className="worker-drawer-host",C.hidden=!0,he.append(it,_t,C);let ge=document.createElement("div");ge.className="worker-lanes-host",Se.append(Ie,he,ge),e.appendChild(Se);let ke=null,Le=null,Me=Pr(_t,{transport:n,sessionLogStore:a,onClose:()=>{ke=null,Le=null,he.hidden=!0,Ue()}}),Be=yp(C,{onClose:()=>{C.hidden=!0,he.hidden=!0,Ue()}}),z=dp({getWorkspacePath:d||(()=>"")}),K=d&&d()||"",De=pp({queueStore:s,transport:n,onChanged:()=>Ue(),onOpenScript:(c,m)=>{z.open(c,m)}}),Qe=o?ap(Se,{queueStore:s,analysisStore:o,transport:n,getWorkspacePath:d,onOpenTranscript:(c,m)=>$(c,m)}):null;function We(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Xo,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function ve(){let c=We(),m=typeof c.serial_lane_count=="number"&&Number.isInteger(c.serial_lane_count)&&c.serial_lane_count>0?Math.min(c.serial_lane_count,5):0,v=Array.isArray(c.serial_lanes)?c.serial_lanes:[],B=[];for(let Ce of v){if(B.length>=m)break;!Ce||typeof Ce.id!="string"||!/^s[1-5]$/.test(Ce.id)||!Array.isArray(Ce.entries)||B.push({id:Ce.id,label:`\uC9C1\uB82C ${Ce.id.slice(1)}`,count:Ce.entries.length})}return B.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(c.queue)?c.queue:[]).length},...B]}function P(c){if(!V||!c.some(v=>v.id===V))return null;let m=ve();return m?{bead_id:V,lanes:m}:null}function H(){let c=We();return typeof c.revision=="number"?c.revision:0}function J(c){c&&c.queue&&s&&s.set(c.queue)}function X(){let c=We().queue;return Array.isArray(c)?c.length:0}async function Pe(c,m,v){if(!n)return;let B=()=>({bead_id:c,...m==="parallel"?{}:{lane:m},...v===void 0?{}:{index:v},expected_revision:H()}),_e=await n("worker-queue-place",B());J(_e),_e&&_e.conflict&&await n("worker-queue-place",B()).then(J)}async function tt(c,m,v){if(!n)return;let B=()=>({bead_id:c,...m==="parallel"?{}:{lane:m},to_index:v,expected_revision:H()}),_e=await n("worker-queue-reorder",B());J(_e),_e&&_e.conflict&&await n("worker-queue-reorder",B()).then(J)}async function st(c){if(!n)return;let m=await n("worker-queue-remove",{bead_id:c,expected_revision:H()});J(m),m&&m.conflict&&await n("worker-queue-remove",{bead_id:c,expected_revision:H()}).then(J)}async function Je(c){if(!n||!c)return;let m=await n("worker-attempt-pause",{attempt_id:c});m&&m.paused===!1&&m.reason&&ce(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${m.reason}`,"error",2400)}async function vt(c){if(!n||!c)return;let m=await Rr();if(m===null)return;let v=async(_e={})=>await n("worker-attempt-resume",{attempt_id:c,expected_revision:H(),...m!==""?{instructions:m}:{},..._e}),B=await v();J(B),B&&B.conflict&&(B=await v(),J(B)),B=await Tn(B,(_e,Ce)=>v({continuation:_e,decision_token:Ce}),{onResult:J,refresh:()=>v()}),B&&B.resumed===!1&&!B.conflict&&B.reason&&ce(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${B.reason}`,"error",2400)}async function mt(c){if(!n||!c)return;let m=await n("worker-attempt-dismiss",{attempt_id:c,expected_revision:H()});J(m),m&&m.conflict&&(m=await n("worker-attempt-dismiss",{attempt_id:c,expected_revision:H()}),J(m)),m&&m.dismissed===!1&&!m.conflict&&m.reason&&ce(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${m.reason}`,"error",2400)}async function ot(c,m,v=!0){if(!n)return null;let B=n,_e=await B(c,{...m,expected_revision:H()});return J(_e),_e&&_e.conflict&&v&&(_e=await B(c,{...m,expected_revision:H()}),J(_e)),_e}async function ut(c){if(!n||!c)return;let m=We().merge_queue?.find(B=>B.bead_id===c)?.continuation_action;if(m?.mismatch&&m.continuation===null){await Ve(c,m.mismatch);return}$e.add(c),Ue();let v;try{v=await ot("worker-merge-queue-add",{bead_id:c})}catch{ce("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{$e.delete(c),Ue()}if(!(!v||v.applied)){if(v.conflict){ce("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}ce(Nb(v.reason),"error",2400)}}async function gt(c){if(!(!n||!c||ue.has(c))){ue.add(c),Ue();try{let m=await n("worker-cleanup-retry",{bead_id:c,expected_revision:H()});J(m),m&&!m.retried&&!m.conflict&&m.reason&&ce(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${m.reason}`,"error",2400)}finally{ue.delete(c),Ue()}}}async function Ve(c,m){let v=await Tn({continuation_mismatch:m},(_e,Ce)=>ot("worker-merge-queue-add",{bead_id:c,continuation:_e,decision_token:Ce},!1)),B=v?.queue?.merge_queue?.find(_e=>_e.bead_id===c)?.continuation_action;if(v?.applied!==!0&&B?.continuation===null&&B.mismatch){await Ve(c,B.mismatch);return}v&&v.applied===!1&&!v.conflict&&ce("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function Ne(c){if(!n)return;let m=await ot("worker-merge-auto-toggle",{on:c});!m||m.conflict||ce(c?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",c?"success":"info",2400)}async function He(c){if(!n||!c)return;let m=await ot("worker-merge-queue-remove",{bead_id:c});m&&!m.conflict&&!m.applied&&m.reason==="merge_active"&&ce("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function wt(){await ot("worker-merge-queue-remove",{all:!0})}async function lt(c,m=null,v="unmerged",B=null){if(!n||!c)return;let _e=$s(c,v);if(!(!!B||typeof globalThis.confirm!="function"||globalThis.confirm(_e)))return;let Ee=await n("worker-discard",{bead_id:c,...m?{attempt_id:m}:{},...B?{operation_id:B}:{},expected_revision:H()});if(J(Ee),Ee&&Ee.conflict&&(Ee=await n("worker-discard",{bead_id:c,...m?{attempt_id:m}:{},...B?{operation_id:B}:{},expected_revision:H()}),J(Ee)),Ee&&Ee.discarded===!0){ce(jo(Ee),"success",5e3);return}if(Ee&&Ee.reason){ce(`\uD3D0\uAE30 \uC2E4\uD328: ${Ee.reason}`,"error",2800);return}if(Ee&&Ee.accepted&&Ee.pending==="merged_revert"){ce("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(Ee&&Ee.accepted&&!Ee.discarded){ce(`\uD3D0\uAE30 \uC9C4\uD589: ${Ee.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}Ee&&!Ee.conflict&&ce("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function G(c,m,v){if(!(!n||!m||!v||Q.has(m))){Q.add(m),Ue();try{let B=await n(c,{bead_id:m,action_id:v,expected_revision:H()});J(B),B?.conflict?ce("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!B?.ok&&B?.reason&&ce(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(B.reason)}`,"error",2800)}finally{Q.delete(m),Ue()}}}async function pe(c,m){if(!n||!m||me.has(m))return;me.add(m),Ue();let v;try{let B=async(_e={})=>await n(c,{bead_id:m,expected_revision:H(),..._e});v=await B(),J(v),v&&v.conflict&&(v=await n(c,{bead_id:m,expected_revision:H()}),J(v)),c==="worker-revise-fix"&&(v=await Tn(v,(_e,Ce)=>B({continuation:_e,decision_token:Ce}),{onResult:J,refresh:()=>B()}))}finally{me.delete(m),Ue()}if(!(!v||v.conflict)){if(v.ok){ce(c==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}ce(`\uCC98\uBD84 \uAC70\uBD80: ${v.reason||""}`,"error",3e3)}}async function qe(c){if(!n)return;let m=await n("worker-automation-toggle",{on:c,expected_revision:H()});J(m),m&&m.conflict&&await n("worker-automation-toggle",{on:c,expected_revision:H()}).then(J)}async function S(c){if(!n||!c)return;let m=await n("worker-repo-operation-repair",{operation_id:c});if(J(m),m&&m.ok===!1){ce(`\uD574\uACB0 \uC138\uC158 \uAC70\uBD80: ${m.reason||""}`,"error",3e3);return}m&&m.ok===!0&&ce("\uD574\uACB0 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4","success",2400)}async function I(c){if(!n||!c)return;let m=await n("worker-repo-operation-dismiss",{operation_id:c});J(m),m&&m.ok===!1&&ce(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${m.reason||""}`,"error",3e3)}async function k(c){if(!n||!Number.isFinite(c))return;let m=Math.max(Xo,Math.floor(c)),v=await n("worker-queue-set-slots",{slots:m,expected_revision:H()});J(v),v&&v.conflict&&await n("worker-queue-set-slots",{slots:m,expected_revision:H()}).then(J)}async function L(c){if(!n||!Number.isInteger(c)||c<1||c>vp)return;let m=We(),v=(Array.isArray(m.serial_lanes)?m.serial_lanes:[]).slice(c).reduce((Ce,Ee)=>Ce+(Array.isArray(Ee?.entries)?Ee.entries.length:0),0),B=()=>({count:c,expected_revision:H()}),_e=await n("worker-queue-set-serial-lane-count",B());J(_e),_e&&_e.conflict&&(_e=await n("worker-queue-set-serial-lane-count",B()),J(_e)),_e&&_e.applied&&v>0&&ce(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${v}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}let re="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function de(c,m){let v=Pi(c,m.id,N);return{id:m.id,title:m.title,location_label:m.location_label,prefixes:m.prefixes,action:v.kind==="note"?{kind:"note",text:v.text}:v.kind==="disabled"?{kind:"disabled",label:re,title:v.title}:{kind:"place",label:re,title:v.title}}}function te(c,m){if(!Y||Y.bead_id!==c)return null;let v=Y.counterpart_id,B=v===null?m:m.filter(_e=>_e.id===v);return B.length===0?null:{rows:B.map(_e=>de(c,_e))}}async function be(c,m){let v=Pi(c,m,N);if(Y=null,v.kind!=="ops"){Ue();return}let B=H();for(let _e of v.ops){let Ce=await ct(_e,B);if(Ce===null)break;B=Ce}Ue()}async function ct(c,m){if(!n)return null;try{let v=await n("worker-queue-place",{bead_id:c.bead_id,lane:c.lane,index:c.index,expected_revision:m});if(J(v),v&&v.conflict)return ce("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!v||v.applied!==!0)return ce(v&&typeof v.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${v.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let B=v.queue?v.queue.revision:void 0;return typeof B!="number"?(ce("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):B}catch(v){return ce(v instanceof Error&&v.message?v.message:"\uD050 \uC694\uCCAD \uC2E4\uD328","error"),null}}function Xe(){let c=We(),m=g?g.selectBoardColumn(mb,"ready"):[],v=g?g.selectBoardColumn(gb,"blocked"):[],B=g?g.selectBoardColumn(yb,"closed"):[],_e=g?g.selectBoardColumn(hb,"in_progress"):[],Ce=g?g.selectBoardColumn(bb,"resolved"):[],Ee=Js([...m,...v,..._e,...Ce,...B]),ze=new Map;for(let _ of[...m,...v,..._e])_&&_.id&&!ze.has(_.id)&&ze.set(_.id,_);let dt={...se(d?.()||"")};for(let _ of["orchestration_model","orchestration_effort","orchestration_speed"]){let j=c[_];typeof j=="string"&&(dt[_]=j)}function jt(_,j){let ne=ze.get(_);if(!ne)return null;let Ge=ne.metadata&&typeof ne.metadata=="object"?ne.metadata:{},rt=ne.workflow?.route,Dt=Ge.route,It=kp(rt)?rt:kp(Dt)?Dt:null;return Jt({pin:Ge,global:dt,execution_defaults:c.execution_defaults??null,runner_catalog:c.runner_catalog??null,route:It,controller_runtime:j})}function tn(_){let j=_.runner||null,ne=jt(_.bead_id,j),Ge=Wo(_),rt=ne?Vn(ne,j):null;return Ge||rt?{orchestration:Ge,worker:rt}:null}let Nn=new Map;function Wr(_){if(Nn.has(_))return Nn.get(_)??null;let j=jt(_,null),ne=null;if(j){let Ge=yn(c.runner_catalog??null,j.orchestration_model.value??""),rt=Ge===null?j:jt(_,Ge),Dt=dr(rt,c.runner_catalog??null),It=Vn(rt,Ge);ne=Dt||It?{orchestration:Dt,worker:It}:null}return Nn.set(_,ne),ne}function fr(_){let j=eo(Ee,_);return j.total===0?null:j}let Bi=c.bead_titles||{},Qt=new Map;for(let[_,j]of Object.entries(Bi))typeof j=="string"&&j.length>0&&Qt.set(_,j);for(let _ of[...m,...v])Qt.set(_.id,_.title||_.id);let Rs=c.bead_times&&typeof c.bead_times=="object"&&!Array.isArray(c.bead_times)?c.bead_times:{},Ls=c.bead_labels&&typeof c.bead_labels=="object"&&!Array.isArray(c.bead_labels)?c.bead_labels:{},Zn=c.bead_workflow&&typeof c.bead_workflow=="object"&&!Array.isArray(c.bead_workflow)?c.bead_workflow:{},wn=new Map;for(let[_,j]of Object.entries(Ls))Array.isArray(j)&&wn.set(_,Li(j));for(let _ of[...m,...v]){let j=_.labels;Array.isArray(j)&&!wn.has(_.id)&&wn.set(_.id,Li(j))}let _r=new Map,mr=o?.get()?.last_good?.result?.groups;for(let _ of Array.isArray(mr)?mr:[]){if(_?.eligible!==!0||!Array.isArray(_.members))continue;let j=_.members.map(Ge=>{let rt=(Array.isArray(c.serial_lanes)?c.serial_lanes:[]).find(Dt=>Dt.entries.some(It=>It.bead_id===Ge));return rt?rt.id:null});if(!(j.every(Ge=>Ge!==null)&&new Set(j).size===1))for(let Ge of _.members)_r.set(Ge,_.members.filter(rt=>rt!==Ge))}let zr=c.bead_blocked_by&&typeof c.bead_blocked_by=="object"&&!Array.isArray(c.bead_blocked_by)?c.bead_blocked_by:{},gr=new Map;for(let[_,j]of Object.entries(Rs))j&&typeof j=="object"&&gr.set(_,j);for(let _ of[...m,...v])gr.set(_.id,{created_at:_.created_at,updated_at:_.updated_at});let Qn=_=>gr.get(_)||{},Xn=c.pr_wait||[],Hr=c.pr_observations||{},Gr=c.pr_activity||{},Vr=c.cleanup_failed||{},je=Object.entries(Vr).map(([_,j])=>({bead_id:_,step:j&&j.step?j.step:"",reason:j&&j.reason?j.reason:"",at:j&&typeof j.at=="number"?j.at:null,detail:j&&typeof j.detail=="string"?j.detail:null,output_tail:j&&typeof j.output_tail=="string"&&j.output_tail?j.output_tail:void 0,log_path:j&&typeof j.log_path=="string"&&j.log_path?j.log_path:void 0,retry_count:j&&typeof j.retry_count=="number"&&Number.isInteger(j.retry_count)&&j.retry_count>0?j.retry_count:0,failure_code:j&&typeof j.failure_code=="string"?j.failure_code:void 0,subject_id:j&&typeof j.subject_id=="string"?j.subject_id:void 0,repair_eligible:!!(j&&j.repair_eligible),repair:j&&j.repair?j.repair:void 0})),pt=c.queue||[],qn=new Set([...pt.map(_=>_.bead_id),...(Array.isArray(c.serial_lanes)?c.serial_lanes:[]).flatMap(_=>(Array.isArray(_?.entries)?_.entries:[]).map(j=>j.bead_id)),...Xn.map(_=>_.bead_id),...c.done.map(_=>_.bead_id)]),Ui=new Set(v.map(_=>_.id)),Up=i?i.get()?.order||{}:{},Wi=new Set,zi=[];for(let _ of[...m,...v])qn.has(_.id)||Wi.has(_.id)||Pb(_)||(Wi.add(_.id),zi.push(_));D=Ib(zi,M,Up);let Wp=c.admission||{},Hi=_=>{let j=Wp[_];if(!j)return"";if(j.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let ne=typeof j.reason=="string"?j.reason:"",Ge=ne.indexOf(":");return Ge>0&&Ge<ne.length-1?`\u26D4 ${ne.slice(0,Ge)} (${ne.slice(Ge+1)})`:`\u26D4 ${ne}`},zp=D.map(_=>{let j=Ao(_),ne=j.path.length>0,Ge=_.workflow?.route==="quick_fix"||_.metadata&&_.metadata.route==="quick_fix",rt=!Object.hasOwn(_,"description")||typeof _.description=="string"&&_.description.trim().length>0,Dt=Object.hasOwn(_,"labels")&&op(_.labels),It=!Dt&&(Ge?rt:ne&&!j.conflict),$t=Ui.has(_.id),_n=[];$t&&_n.push(Mb(_)),Ge&&!rt?_n.push("missing_description"):!Ge&&j.conflict?_n.push("spec_id_conflict"):!Ge&&!ne&&_n.push("spec \uC5C6\uC74C");let js=Hi(_.id);return js&&_n.push(js),{id:_.id,title:_.title||_.id,reason:_n.join(" \xB7 "),draggable:It,lane:"candidate",created_at:_.created_at,updated_at:_.updated_at,workflow:_.workflow,is_quick_fix:Ge,status:_.status,worker_ineligible:Dt,blocked:$t,has_spec:ne,exec_chips:Wr(_.id)}}),ea=$b(zp,W),ta=ea.visible,Hp=c.revise_parked||{},Os=c.discard_operations&&typeof c.discard_operations=="object"&&!Array.isArray(c.discard_operations)?c.discard_operations:{},na=(_,j)=>_.map((ne,Ge)=>{let rt=j!=="done",Dt=j!=="done"&&j!=="queue",It=rt?Hp[ne.bead_id]:null,$t=rt?An(Os,ne.bead_id):null,_n=$t?.operation?$t:null,js=rt&&wn.get(ne.bead_id)===!0,wl=zr[ne.bead_id]||[],da=c.admission&&typeof c.admission=="object"?c.admission[ne.bead_id]:null,pa=rt?Ku(da,!!_n||Q.has(ne.bead_id)):null,tf=rt&&!pa?Hi(ne.bead_id):null,nf=rt?[tf]:[],kl=rt&&wl.length>0&&typeof da?.reason=="string"&&da.reason.startsWith("not_ready")?[`\u23F8 ${wl.join(", ")} \uC644\uB8CC \uB300\uAE30 (blocks)`]:[],fa=rt?_r.get(ne.bead_id):void 0;return fa&&fa.length>0&&kl.push(`\u2733 serial \uAD8C\uC7A5 \xB7 ${fa.join(", ")}\uC640`),{id:ne.bead_id,title:Qt.get(ne.bead_id)||ne.bead_id,reason:nf.filter(Boolean).join(" \xB7 "),draggable:rt&&!_n&&!pa,done:j==="done",lane:j,seq:Dt?Ge+1:void 0,worker_serial:js,discard:_n,stale_work:pa,badges:[...kl,...It?["\u23F8 REVISE \uD30C\uD0B9"]:[]],alert:!!It,revise_action:!!It,revise_enabled:!!It&&!_n&&!me.has(ne.bead_id),revise_title:It?It.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${It.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:j==="done"?un(c.attempts||{},ne.bead_id):null,work_ms:j==="done"?qo(c.attempts||{},ne.bead_id):null,done_at:j==="done"&&typeof ne.added_at=="number"?ne.added_at:void 0,exec_chips:rt?Wr(ne.bead_id):null,workflow:rt&&Zn[ne.bead_id]||null,...Qn(ne.bead_id)}}),hr=c.attempts?Object.values(c.attempts):[],ra=new Set;for(let _ of hr)_&&typeof _.resumed_from=="string"&&_.resumed_from.length>0&&ra.add(_.resumed_from);let Gi=new Map;for(let _ of hr)Gi.set(_.bead_id,_.attempt_id);let Is=new Map;for(let _ of hr)Is.set(_.attempt_id,_);function sa(_){let j=new Set,ne=_;for(;ne&&!j.has(ne.attempt_id);){if(ne.conflict_resolution===!0)return!0;j.add(ne.attempt_id),ne=typeof ne.resumed_from=="string"&&ne.resumed_from.length>0&&Is.get(ne.resumed_from)||null}return!1}let Ps=typeof c.declared_base=="string"?c.declared_base:null;function Gp(_){let j=null;for(let ne of hr)!ne||ne.bead_id!==_||sa(ne)||(j===null||(typeof ne.started_at=="number"?ne.started_at:0)>=(typeof j.started_at=="number"?j.started_at:0))&&(j=ne);return j&&typeof j.target_base=="string"?j.target_base:null}let oa=[],Ms=[],Vp=sp(c),Vi=_=>{let j=typeof _.session_id=="string"&&_.session_id.length>0,ne=ra.has(_.attempt_id);return{eligible:j&&!ne,reason:j?ne?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},fn=null;for(let _ of hr){let j=_.status==="paused"&&!ra.has(_.attempt_id);if(_.status==="running"||j)Ms.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:Qt.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,paused:j,conflict_resolution:sa(_),base_exception:Di(Ps,_.target_base),can_pause:typeof _.session_id=="string"&&_.session_id.length>0,discard:An(Os,_.bead_id,{attempt_id:_.attempt_id}),workflow:Zn[_.bead_id]||null,usage:un(c.attempts||{},_.bead_id),rollup:fr(_.bead_id),rollup_expanded:Re.has(_.bead_id),exec_chips:tn(_),...Qn(_.bead_id)});else if((_.status==="failed"||_.status==="orphaned")&&Vp(_)){let ne=Vi(_);oa.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:Qt.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,failed:!0,status:_.status,status_label:_.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:An(Os,_.bead_id,{attempt_id:_.attempt_id}),resume_eligible:ne.eligible,resume_reason:ne.reason,conflict_resolution:sa(_),base_exception:Di(Ps,_.target_base),workflow:Zn[_.bead_id]||null,usage:un(c.attempts||{},_.bead_id),rollup:fr(_.bead_id),rollup_expanded:Re.has(_.bead_id),exec_chips:tn(_),...Qn(_.bead_id)}),fn=_}}let Ki=new Set([...oa,...Ms].map(_=>_.bead_id));for(let _ of Array.isArray(c.session_active)?c.session_active:[]){let j=_&&_.bead_id;typeof j!="string"||j.length===0||Ki.has(j)||(Ki.add(j),Ms.push({bead_id:j,attempt_id:null,kind:"session",title:_.title||Qt.get(j)||j,status:"in_progress",started_at:kn(_.started_at)??kn(_.updated_at),updated_at:kn(_.updated_at),workflow:_.workflow||null,runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,usage:null,rollup:null,rollup_expanded:!1}))}let br=[...oa,...Ms].map(_=>{let j=Is.get(_.attempt_id),ne=j?.quickfix_landing;if(j?.quickfix_lane!==!0||!ne||typeof ne!="object")return _;let Ge=typeof ne.reason=="string"&&ne.reason.length>0?ne.reason:null,rt=Es({bead_id:j.bead_id,merge_sha:ne.head_sha,cleanup_cursor:ne.cursor,cleanup_failed:Ge?{step:ne.cursor,reason:Ge}:null,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]});return rt?{..._,landing:rt}:_}),Yi=null;if(fn){let _=Vi(fn),j=fn.cause_detail;Yi={bead_id:fn.bead_id,repo:fn.repo||"",reason:fn.cause||fn.status,cause_detail:j&&typeof j.reason=="string"?{reason:j.reason,command:typeof j.command=="string"?j.command:null}:null,resume_attempt_id:fn.attempt_id,resume_eligible:_.eligible,resume_reason:_.reason,discard:An(Os,fn.bead_id,{attempt_id:fn.attempt_id})}}let Zi=new Set(br.map(_=>_.bead_id)),aa=Array.isArray(c.merge_queue)?c.merge_queue:[],Qi=new Map,Xi=new Map,Ji=new Map,el=new Map,tl=new Map;aa.forEach((_,j)=>{_&&typeof _.bead_id=="string"&&(Qi.set(_.bead_id,j+1),Xi.set(_.bead_id,_.resolution),Ji.set(_.bead_id,_.continuation_action||null),el.set(_.bead_id,_.head_review||null),tl.set(_.bead_id,_.authority||null))});let yr=c.merge_queue_state||{active:null,failures:{}},Kp=yr.failures||{},nl=yr.waiting&&typeof yr.waiting.bead_id=="string"&&typeof yr.waiting.reason=="string"?yr.waiting:null,Yp=c.auto_merge_skips||{},rl=_=>{let j=Yp[_];if(!j)return null;let ne=Hr[_],Ge=ne&&ne.pr?ne.pr.head_sha:null;return Ge&&Ge===j.head_sha?j.reason||"":null},Ds=new Map;for(let _ of br)_.failed!==!0&&_.conflict_resolution&&(_.paused?Ds.has(_.bead_id)||Ds.set(_.bead_id,"paused"):Ds.set(_.bead_id,"running"));let sl=br.filter(_=>_.kind!=="session"&&!_.paused&&_.failed!==!0).length,ol=(c.workspace_info||{}).slots,al=typeof ol=="number"?ol:typeof c.slots=="number"?c.slots:Xo,Zp=sl>al,Ns=sr(q),Qp=(Array.isArray(c.done)?c.done.slice():[]).filter(_=>Ns===void 0||typeof _.added_at!="number"||_.added_at>=Ns).sort((_,j)=>(j.added_at||0)-(_.added_at||0)),Kr=na(Qp,"done"),Xp=new Set((Array.isArray(c.done)?c.done:[]).map(_=>_?.bead_id).filter(_=>typeof _=="string")),il=[],Jp=d?.()||"";for(let _ of B){let j=kn(_.closed_at);if(typeof _.id!="string"||Xp.has(_.id)||j===null||Ns!==void 0&&j<Ns||typeof _.comment_count!="number"||_.comment_count<=0)continue;let ne=`${Jp}\0${_.id}\0${String(_.updated_at)}\0${_.comment_count}`,Ge=U.get(ne);Ge===void 0&&n&&(U.set(ne,"pending"),Promise.resolve(n("get-comments",{id:_.id})).then(rt=>{let Dt=Array.isArray(rt)&&rt.some(It=>So(typeof It?.text=="string"?It.text:"")?.lane==="session");U.set(ne,Dt?"session":"not-session"),Ue()}).catch(()=>{U.set(ne,"failed"),Ue()})),Ge==="session"&&il.push({id:_.id,title:_.title||_.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:j,created_at:_.created_at,updated_at:_.updated_at})}Kr.push(...il),Kr.sort((_,j)=>(j.done_at||0)-(_.done_at||0));let qs={};for(let _ of Cn)qs[_]=0;let ll=!1,cl=0,ia=0,ul=0;for(let _ of Kr){let j=_.usage;if(j&&typeof j=="object"){let ne=!1;for(let Ge of Cn)Number.isFinite(j[Ge])&&(qs[Ge]+=j[Ge],ll=!0,ne=!0);ne&&(ia+=1,Number.isFinite(j.total_cost_usd)&&(cl+=j.total_cost_usd,ul+=1))}}ia>0&&ul===ia&&(qs.total_cost_usd=cl);let dl=Kr.map(_=>_.usage).filter(_=>_&&typeof _=="object"&&_.providers),ef=dl.length>0?Bt(uo(dl)):ll?Rn(qs):null,pl=c.lane_states&&typeof c.lane_states=="object"&&!Array.isArray(c.lane_states)?c.lane_states:{},fl=Array.isArray(c.serial_lanes)?c.serial_lanes:[],_l=_=>{if(Xn.some(Ge=>Ge.bead_id===_))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let j=hr.filter(Ge=>Ge&&Ge.bead_id===_),ne=j.length>0?j[j.length-1].status:null;return ne==="failed"||ne==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":ne==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},Fs=fl.filter(_=>_&&typeof _.id=="string"&&Array.isArray(_.entries)).map((_,j)=>{let ne=pl[_.id]||{},Ge=new Map((Array.isArray(ne.corrections)?ne.corrections:[]).filter($t=>$t&&typeof $t.bead_id=="string"&&typeof $t.after=="string").map($t=>[$t.bead_id,$t.after])),rt=na(_.entries.filter($t=>!Zi.has($t.bead_id)),_.id).map($t=>Ge.has($t.id)?{...$t,badges:[`\u{1F517} ${Ge.get($t.id)} \uB4A4 (blocks \uC790\uB3D9)`,...$t.badges]}:$t),Dt=Array.isArray(ne.occupied_by)?ne.occupied_by.filter($t=>typeof $t=="string"):[],It=Dt.map($t=>({id:$t,title:Qt.get($t)||$t,draggable:!1,lane:_.id,ghost:!0,badges:[_l($t)]}));return{id:_.id,index:j+1,rows:[...It,...rt],occupied:Dt.length>0,badge:Dt.length>0?_l(Dt[0]):"\uB300\uAE30",cycle:ne.cycle===!0}}),ml=typeof c.serial_lane_count=="number"?c.serial_lane_count:Fs.length,la=na(pt.filter(_=>!Zi.has(_.bead_id)),"queue"),gl=new Map,hl=new Set;for(let[_,j]of Object.entries(pl)){if(!/^s[1-5]$/.test(_))continue;let ne=j&&Array.isArray(j.occupied_by)?j.occupied_by:[];for(let Ge of ne)typeof Ge=="string"&&gl.set(Ge,_);ne.length>0&&hl.add(_)}let vr=[];for(let _ of br)typeof _.bead_id=="string"&&vr.push({id:_.bead_id,title:Qt.get(_.bead_id)||_.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:gl.get(_.bead_id)??null});for(let _ of Fs)for(let j of _.rows)j.ghost!==!0&&vr.push({id:j.id,title:j.title,location_label:`${_.id} #${j.seq??""}`.trim(),kind:"serial",lane_id:_.id});la.forEach((_,j)=>{vr.push({id:_.id,title:_.title,location_label:`#${j+1}`,kind:"parallel",lane_id:null})});for(let _ of ta)vr.push({id:_.id,title:_.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let bl={};for(let _ of fl)_&&typeof _.id=="string"&&Array.isArray(_.entries)&&(bl[_.id]=_.entries.length);let ca=new Map;for(let _ of vr)ca.has(_.id)||ca.set(_.id,_);N={members_by_id:ca,serial_raw_lengths:bl,serial_lane_count:ml,occupied_lanes:hl};let yl=ip(c.bead_scope,vr),ua=(_,j)=>{let ne=yl.get(_.id);if(!ne||ne.overlaps.length===0&&!ne.scope_missing)return _;let Ge=te(_.id,ne.overlaps);return _.dependency_chips={..._.dependency_chips||{},...ne.overlaps.length>0?{overlaps:ne.overlaps}:{},...ne.scope_missing&&j!=="running"?{scope_missing:!0}:{},...Ge?{popover:Ge}:{}},_};for(let _ of la)ua(_,"queue");for(let _ of Fs)for(let j of _.rows)j.ghost!==!0&&ua(j,_.id);for(let _ of ta)ua(_,"candidate");let vl=new Map;for(let _ of br){let j=typeof _.bead_id=="string"?yl.get(_.bead_id):void 0;if(!j||j.overlaps.length===0)continue;let ne=te(_.bead_id,j.overlaps);vl.set(_.bead_id,{dependency_chips:{overlaps:j.overlaps,...ne?{popover:ne}:{}}})}return{queue:c,idToTitle:Qt,candidates:ta,candidate_hidden:{blocked:ea.hidden_blocked,spec:ea.hidden_spec},running:br,live_count:sl,slots:al,over_cap:Zp,failure:Yi,waiting:la,serial_lanes:Fs,serial_lane_count:ml,running_overlays:vl,pr_wait:Xn.map(_=>Wb(_.bead_id,Qt.get(_.bead_id)||_.bead_id,Hr,Vr[_.bead_id]||null,un(c.attempts||{},_.bead_id),Gr[_.bead_id]||($e.has(_.bead_id)||ue.has(_.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Ds.get(_.bead_id)||null,_.external===!0,{position:Qi.get(_.bead_id)||0,active:yr.active===_.bead_id,failure:Kp[_.bead_id]||null,waiting:nl?.bead_id===_.bead_id?nl.reason:null,resolution:Xi.get(_.bead_id),continuation_action:Ji.get(_.bead_id),head_review:el.get(_.bead_id)||null,authority:tl.get(_.bead_id)||null},_.wt_present!==!1,c.auto_merge===!0?rl(_.bead_id):null,Di(Ps,Gp(_.bead_id)),c.completion_status&&typeof c.completion_status=="object"&&!Array.isArray(c.completion_status)&&c.completion_status[_.bead_id]||null,c.discard_operations&&typeof c.discard_operations=="object"&&!Array.isArray(c.discard_operations)?c.discard_operations:{},Is.get(Gi.get(_.bead_id)||"")?.worker_serial===!0,c.auto_merge===!0,{merge_sha:_.merge_sha,cleanup_cursor:_.cleanup_cursor,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]})).map(_=>({..._,workflow:Zn[_.id]||null,...Qn(_.id)})),merge_queue_length:aa.length,merge_queue_running:aa.length>0,auto_excluded:Xn.map(_=>_.bead_id).filter(_=>rl(_)!==null),declared_base:Ps,done:Kr,token_total:ef,cleanup_failures:je,repo_operations:Array.isArray(c.repo_operations)?c.repo_operations:[]}}function Ye(){let m=!!o?.get()?.job,v=!m&&o?.isPending?.()===!0,B=m?"\uBD84\uC11D \uC911":v?"\uC900\uBE44 \uC911":"";return l`<button
      type="button"
    ...
    </button>`}function bt(c){let m=c.waiting.length>0?c.waiting[0].id:"\u2014",v=l`<button
      type="button"
    ...
    >`,ze=l`<label class="worker-tgl worker-slots"
      ...
      <label
        ...
        <select class="worker-serial-lane-count" aria-label="직렬 레인 수">
          ${Array.from({length:vp},(tn,Nn)=>Nn+1).map(tn=>l`<option
                value=${String(tn)}
      ...
      ${o?Ye():""} `,dt=ed({failure:c.failure}),jt=Vu(c.repo_operations,c.cleanup_failures);return Z?l`<div class="worker-ribbon">
          ${v} ${B}
      ...
      ${jt}${De.template()}${dt}`}function St(c){if(c.running.length===0&&c.pr_wait.length===0)return"";let m=c.running.some(v=>v.kind!=="session"&&!v.paused&&v.failed!==!0);return l`<section
    ...
    >
      ...
      ${c.running.length>0?bi(c.running,Date.now(),ke,c.running_overlays):""}
      ${c.pr_wait.map(v=>zn(v))}
    </section>`}function yt(c){let m=c.candidate_hidden;return l`<div class="worker-filter">
    ...
    </div>`}function Nt(c){let m=l`<span
      class="worker-lane__badge${c.occupied?" worker-lane__badge--held":""}"
      >${c.badge}</span
    >`,v=c.cycle?l`<div class="worker-lane__cycle">
          ⚠ blocks 순환 감지 — 자동 정렬을 생략했습니다
        </div>`:"";return pn({id:`worker-pane-lane-${c.id}`,lane:c.id,title:`\uC9C1\uB82C ${c.index}`,items:c.rows,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uD589\uC744 \uC5EC\uAE30\uB85C \uB4DC\uB798\uADF8",header_control:m,controls:v})}function Mt(c){let m=c.queue.auto_merge===!0;if(c.merge_queue_running)return l`<button
        type="button"
    ...
    >
      ▶ 자동 머지${B>0?` ${B}`:""}
    </button>`}function Ft(c){let m=pn({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:c.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Ct(),controls:yt(c),place_menu:P(c.candidates)});return Z?l`<div class="worker-lanes worker-lanes--mobile">
        ${St(c)}
        ${pn({id:"worker-pane-queue",lane:"queue",title:"\uBCD1\uB82C \uB300\uAE30",items:c.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:R.queue,preview:$p(c.waiting)})}
        ${c.serial_lanes.map(v=>Nt(v))}
        ${m}
        ${pn({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:c.done,empty:`${E()} \uC644\uB8CC \uC5C6\uC74C`,controls:zt(),collapsible:!0,collapsed:R.done,preview:Array.isArray(c.token_total)?c.token_total.map(v=>v.label).join(" \xB7 "):c.token_total||$p(c.done)})}
      ...
      ${pn({id:"worker-pane-running",lane:"running",title:`\uC2E4\uD589 \uC911 \xB7 \uC2AC\uB86F ${c.slots}`,items:c.running,live:c.running.some(v=>v.kind!=="session"&&!v.paused&&v.failed!==!0),body:bi(c.running,Date.now(),ke,c.running_overlays)})}
    ...
    </div>`}function Lt(c){R={...R,[c]:!R[c]},Ob(R),Ue()}function Ue(){let c=Xe();Ze(bt(c),Ie),Ze(Ft(c),ge)}function Ut(){if(typeof window.matchMedia!="function")return;let c=window.matchMedia(Rb);Z=!!c.matches;let m=v=>{let B=!!(v&&typeof v.matches=="boolean"?v.matches:c.matches);B!==Z&&(Z=B,Ue())};typeof c.addEventListener=="function"?(c.addEventListener("change",m),F.push(()=>c.removeEventListener("change",m))):typeof c.addListener=="function"&&(c.addListener(m),F.push(()=>c.removeListener(m)))}let Ht=null;function et(c){Ht=c.target instanceof Element?c.target:null}function Wt(c){let v=c.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!v)return;if(Ht&&v.contains(Ht)&&Ht.closest("input, button, a")){c.preventDefault();return}let B=v.dataset.beadId||"",_e=v.dataset.lane||"";A={bead_id:B,from_lane:_e};try{c.dataTransfer?.setData("text/plain",B),c.dataTransfer&&(c.dataTransfer.effectAllowed="move")}catch{}}function Fe(c){let m=c.target?.closest?.(".worker-pane");if(!m)return;let v=m.dataset.lane||"";v!=="candidate"&&v!=="queue"&&!/^s[1-5]$/.test(v)||(c.preventDefault(),c.dataTransfer&&(c.dataTransfer.dropEffect="move"),m.classList.add("worker-pane--drag-over"))}function T(c){c.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function fe(c,m){let v=D.find(Ee=>Ee.id===c);if(!v)return;let B=D.filter(Ee=>Ee.id!==c),_e=B.length;if(m){let Ee=m.dataset.beadId;if(Ee===c)return;let ze=B.findIndex(dt=>dt.id===Ee);ze>=0&&(_e=ze)}let Ce=B.slice();Ce.splice(_e,0,v),w.applyReorder(c,Ce,_e)}function Te(c){let m=c.target?.closest?.(".worker-pane");if(!m)return;c.preventDefault(),m.classList.remove("worker-pane--drag-over");let v=m.dataset.lane||"",B=A?.bead_id||c.dataTransfer?.getData("text/plain")||"",_e=A?.from_lane||"";if(A=null,!B)return;let Ce=c.target?.closest?.(".worker-mini, .worker-card"),Ee=Array.from(m.querySelectorAll(".worker-mini, .worker-card")),ze=Ee.length;if(Ce){let dt=Ee.indexOf(Ce);dt>=0&&(ze=dt)}if(ze=Math.max(0,ze-m.querySelectorAll(".worker-mini--ghost").length),m.classList.contains("worker-pane--collapsed")&&(ze=X()),v==="candidate"){if(_e==="candidate"){fe(B,Ce);return}(_e==="queue"||/^s[1-5]$/.test(_e))&&st(B);return}if(v==="queue"||/^s[1-5]$/.test(v)){let dt=v==="queue"?"parallel":v;_e===v?tt(B,dt,ze):Pe(B,dt)}}function at(c){W=c,kb(c),Ue()}function Rt(c){M=c==="board"||c==="created"||c==="spec"?c:Jo,Eb(M),Ue()}function b(c){q=cn(c)?c:nn,Cb(q),f?.(q),Ue()}function h(c){let m=c.target?.closest?.(".worker-serial-lane-count");if(m){let ze=Number.parseInt(m.value,10);Number.isFinite(ze)&&L(ze).then(Ue);return}let v=c.target?.closest?.(".worker-filter__blocked");if(v){at({...W,show_blocked:v.checked});return}let B=c.target?.closest?.(".worker-done-range");if(B){b(B.value);return}let _e=c.target?.closest?.(".worker-sort");if(_e){Rt(_e.value||Jo);return}let Ce=c.target?.closest?.(".worker-slots__input");if(!Ce)return;let Ee=Number.parseInt(Ce.value,10);if(!Number.isFinite(Ee)){Ue();return}k(Ee).then(Ue)}function x(c){return c?{runner:c.runner||void 0,model:c.model||void 0,effort:c.effort||void 0,worktree:c.worktree||void 0,status:c.status||void 0,session_id:c.session_id||void 0}:{}}function O(){let c=Xe();return{operations:c.repo_operations,cleanup_failures:c.cleanup_failures,repo:d&&d()||""}}function ee(){ke&&Me.close(),C.hidden=!1,he.hidden=!1,Be.open(O()),Ue()}function y(c){let m=We(),v=m.attempts?m.attempts[c]:null;ke=c,Le=null,Be.close(),C.hidden=!0,he.hidden=!1,Me.open({attempt_id:c,meta:x(v)}),Ue()}function $(c,m){ke=null,Le=c,Be.close(),C.hidden=!0,he.hidden=!1,Me.open({attempt_id:c,meta:m,hide_prompt:!0}),Ue()}function le(){if(Be.isOpen()&&Be.refresh(O()),Le){let v=(o?.get()?.runs||[]).find(B=>B.run_id===Le);v?Me.updateMeta(Ii(v)):Me.close();return}if(!ke)return;let c=We(),m=c.attempts?c.attempts[ke]:null;if(m){Me.updateMeta(x(m));return}Me.close()}function ye(c){let m=c.target;if(m?.closest?.(".worker-mini__serial, .worker-mini__grip")||m?.closest?.("#worker-parallel-analysis-dialog"))return;let v=m?.closest?.(".mon-overlap__chip");if(v){let je=v.closest("[data-bead-id]"),pt=je&&je.getAttribute("data-bead-id")||"";if(pt){let qn=v.getAttribute("data-overlap-all")==="true"?null:v.getAttribute("data-overlap-id")||"";Y=!!Y&&Y.bead_id===pt&&Y.counterpart_id===qn?null:{bead_id:pt,counterpart_id:qn},Ue()}return}let B=m?.closest?.(".mon-overlap__place");if(B){let je=B.closest("[data-bead-id]"),pt=je&&je.getAttribute("data-bead-id")||"";pt&&be(pt,B.getAttribute("data-counterpart-id")||"");return}if(m?.closest?.(".mon-overlap__popover"))return;if(m?.closest?.(".worker-analysis-btn")){Qe?.open();return}if(m?.closest?.(".worker-repo-strip")||m?.closest?.(".worker-mini__timeline")){ee();return}let _e=m?.closest?.(".worker-repo-op__session");if(_e){let je=_e.dataset.attemptId;je&&y(je);return}let Ce=m?.closest?.(".worker-repo-op__resolve");if(Ce){S(Ce.dataset.operationId||"");return}let Ee=m?.closest?.(".worker-repo-op__dismiss");if(Ee){I(Ee.dataset.operationId||"");return}let ze=m?.closest?.(".worker-cleanup__resume");if(ze){let je=ze.dataset.beadId;je&&gt(je);return}let dt=m?.closest?.(".worker-banner__resume");if(dt){let je=dt.dataset.attemptId;je&&vt(je);return}let jt=m?.closest?.(".worker-banner__discard");if(jt){let je=jt.dataset.confirmation==="merged"?"merged":"unmerged";lt(jt.dataset.beadId||"",jt.dataset.attemptId||null,je,jt.dataset.operationId||null);return}let tn=m?.closest?.(".worker-banner__dismiss");if(tn){let je=tn.dataset.attemptId;je&&mt(je);return}if(m?.closest?.(".worker-play")){qe(!We().auto_advance);return}let Nn=m?.closest?.(".worker-merge-all");if(Nn){Nn.classList.contains("worker-merge-all--stop")?We().auto_merge===!0?Ne(!1):wt():Ne(!0);return}let Wr=m?.closest?.(".worker-pane__hd--toggle");if(Wr){let je=Wr.dataset.lane;(je==="queue"||je==="done")&&Lt(je);return}let fr=m?.closest?.(".worker-card__place-lane");if(fr){let je=fr.dataset.beadId,pt=fr.dataset.lane;je&&(pt==="parallel"||/^s[1-5]$/.test(pt||""))&&(V=null,Ue(),Pe(je,pt));return}if(m?.closest?.(".worker-card__place-cancel")){V=null,Ue();return}let Qt=m?.closest?.(".worker-card__place");if(Qt){let je=Qt.dataset.beadId;je&&!Qt.disabled&&(ve()?(V=je,Ue()):Pe(je,"parallel"));return}let Rs=m?.closest?.(".worker-filter__chip");if(Rs){let je=Rs.dataset.spec;(je==="all"||je==="with"||je==="without")&&at({...W,spec:je});return}let Ls=m?.closest?.(".worker-mini__merge");if(Ls){let je=Ls.dataset.beadId||"";We().cleanup_failed?.[je]?gt(je):ut(je);return}let Zn=m?.closest?.(".worker-mini__merge-cancel");if(Zn){He(Zn.dataset.beadId||"");return}let wn=m?.closest?.(".worker-mini__discard");if(wn){lt(wn.dataset.beadId||"",wn.dataset.attemptId||null,wn.dataset.discardMode==="merged"?"merged":"unmerged",wn.dataset.operationId||null);return}let _r=m?.closest?.(".worker-mini__stale-continue");if(_r){G("worker-stale-work-continue",_r.dataset.beadId||"",_r.dataset.actionId||"");return}let mr=m?.closest?.(".worker-mini__stale-backup");if(mr){G("worker-stale-work-backup-fresh",mr.dataset.beadId||"",mr.dataset.actionId||"");return}let zr=m?.closest?.(".worker-mini__stale-recheck");if(zr){G("worker-stale-work-recheck",zr.dataset.beadId||"",zr.dataset.actionId||"");return}let gr=m?.closest?.(".worker-mini__revise-fix");if(gr){pe("worker-revise-fix",gr.dataset.beadId||"");return}let Qn=m?.closest?.(".worker-mini__revise-approve");if(Qn){pe("worker-revise-approve",Qn.dataset.beadId||"");return}if(m?.closest?.(".worker-mini__pr"))return;if(m?.closest?.(".rtile__discard")){let je=m?.closest?.(".rtile"),pt=je?.dataset?.beadId,qn=je?.dataset?.attemptId;pt&&lt(pt,qn||null,"unmerged",m?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if(m?.closest?.(".rtile__dismiss")){let pt=m?.closest?.(".rtile")?.dataset?.attemptId;pt&&mt(pt);return}if(m?.closest?.(".rtile__pause")){let pt=m?.closest?.(".rtile")?.dataset?.attemptId;pt&&Je(pt);return}if(m?.closest?.(".rtile__resume")){let pt=m?.closest?.(".rtile")?.dataset?.attemptId;pt&&vt(pt);return}if(m?.closest?.(".rtile__session")){let pt=m?.closest?.(".rtile")?.dataset?.attemptId;pt&&y(pt);return}if(m?.closest?.(".worker-drawer-overlay__backdrop")){Be.close(),Me.close();return}if(m?.closest?.(".worker-drawer-host"))return;let Xn=m?.closest?.(".rtile .board-card__roll-toggle");if(Xn){let je=Xn.dataset.rollParent;je&&(Re.has(je)?Re.delete(je):Re.add(je),Ue());return}let Hr=m?.closest?.(".rtile .board-card__roll-child");if(Hr){let je=Hr.dataset.childId;je&&u&&u(je);return}let Gr=m?.closest?.(".rtile");if(Gr){if(m?.closest?.(".rtile__id")){let pt=Gr.dataset.beadId;pt&&sn(pt).then(qn=>{qn?ce("\uBCF5\uC0AC\uB428","success",1200):ce("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let je=Gr.dataset.beadId;je&&u&&u(je);return}let Vr=m?.closest?.(".worker-mini, .worker-card");if(Vr){let je=Vr.dataset.beadId;if(m?.closest?.(".worker-mini__id, .worker-card__id")){je&&sn(je).then(pt=>{pt?ce("\uBCF5\uC0AC\uB428","success",1200):ce("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}je&&u&&u(je)}}e.addEventListener("pointerdown",et),e.addEventListener("dragstart",Wt),e.addEventListener("dragover",Fe),e.addEventListener("dragleave",T),e.addEventListener("drop",Te),e.addEventListener("click",ye),e.addEventListener("change",h);function Ke(c){if(!Y)return;let m=c.target;m&&typeof m.closest=="function"&&m.closest(".mon-overlap__popover, .mon-overlap__chip")||(Y=null,Ue())}function Oe(c){c.key!=="Escape"||!Y||(Y=null,Ue())}return document.addEventListener("click",Ke),document.addEventListener("keydown",Oe),F.push(()=>{document.removeEventListener("click",Ke),document.removeEventListener("keydown",Oe)}),Ut(),g&&F.push(g.subscribe(()=>{for(let[c,m]of U)m==="failed"&&U.delete(c);Ue()})),s&&F.push(s.subscribe(()=>{let c=d&&d()||"";c!==K&&(K=c,z.close()),Ue(),le()})),o&&typeof o.subscribe=="function"&&F.push(o.subscribe(()=>{le(),Ue()})),Ue(),{load(){ie(),Ue()},refreshSessionDefaults:Ae,destroy(){for(let c of F.splice(0))try{c()}catch{}e.removeEventListener("pointerdown",et),e.removeEventListener("dragstart",Wt),e.removeEventListener("dragover",Fe),e.removeEventListener("dragleave",T),e.removeEventListener("drop",Te),e.removeEventListener("click",ye),e.removeEventListener("change",h);try{Me.destroy()}catch{}he.hidden=!0;try{Qe?.destroy()}catch{}try{z.destroy()}catch{}Ze(l``,e)}}}function qi(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Rp(e,t,n,r=async()=>{},s=async()=>{}){let o=Et("views:workspace-picker"),a=null,i=!1,u=!1,d=!1;async function p(U){let R=U.target.value,$e=t.getState().workspace?.current?.path||"";if(R&&R!==$e){o("switching workspace to %s",R),i=!0,q();try{await n(R)}catch(ue){o("workspace switch failed: %o",ue)}finally{i=!1,q()}}}async function f(){let U=t.getState(),E=U.workspace?.current?.path||U.workspace?.available?.[0]?.path||"";if(!(!E||u)){o("git-pulling workspace %s",E),u=!0,q();try{await r(E)}catch(R){o("workspace git pull failed: %o",R)}finally{u=!1,q()}}}function g(U){let E=U.target;E&&e.contains(E)||D()}function w(U){U.key==="Escape"&&D()}function A(){d||(d=!0,document.addEventListener("mousedown",g),document.addEventListener("keydown",w),q())}function D(){d&&(d=!1,document.removeEventListener("mousedown",g),document.removeEventListener("keydown",w),q())}function W(){d?D():A()}async function V(U){let E=U.target,R=E.value,Z=E.checked;o("toggling visibility %s \u2192 %s",R,String(Z));try{await s(R,Z)}catch($e){o("workspace visibility toggle failed: %o",$e)}}function Y(U){return U?l`
      <button
        type="button"
    ...
    `}function M(){let U=t.getState(),E=U.workspace?.current,R=U.workspace?.available||[],Z=new Set(U.workspace?.hidden||[]),$e=E?.path||R[0]?.path||"";if(R.length===0)return l``;let ue=R.filter(me=>!Z.has(me.path)||me.path===$e);if(ue.length<=1){let me=ue[0]||R[0],Q=qi(me.path);return l`
