...
${d}`:d,s=s?`${s}
${p}`:p;let f=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(p,o,!0),this.lexer.state.top=f,r.length===0)break;let g=o.at(-1);if(g?.type==="code")break;if(g?.type==="blockquote"){let E=g,$=E.raw+`
`+r.join(`
`),q=this.blockquote($);o[o.length-1]=q,n=n.substring(0,n.length-E.raw.length)+q.raw,s=s.substring(0,s.length-E.text.length)+q.text;break}else if(g?.type==="list"){let E=g,$=E.raw+`
`+r.join(`
`),q=this.list($);o[o.length-1]=q,n=n.substring(0,n.length-g.raw.length)+q.raw,s=s.substring(0,s.length-E.raw.length)+q.raw,r=$.substring(o.at(-1).raw.length).split(`
...
`,1)[0],E=!f.trim(),$=0;if(this.options.pedantic?($=2,p=f.trimStart()):E?$=t[1].length+1:($=t[2].search(this.rules.other.nonSpaceChar),$=$>4?1:$,p=f.slice($),$+=t[1].length),E&&this.rules.other.blankLine.test(g)&&(d+=g+`
...
`+k.slice($);else{if(E||f.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||R.test(f)||j.test(f)||F.test(f))break;p+=`
`+g}!E&&!g.trim()&&(E=!0),d+=C+`
...
`)?"":`
`)+s.raw,a.text+=`
`+s.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):r.push(s);continue}if(t){let a="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw new Error(a)}}return this.state.top=!0,r}inline(t,r=[]){return this.inlineQueue.push({src:t,tokens:r}),r}inlineTokens(t,r=[]){let n=t,s=null;if(this.tokens.links){let l=Object.keys(this.tokens.links);if(l.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)l.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,s.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)o=s[2]?s[2].length:0,n=n.slice(0,s.index+o)+"["+"a".repeat(s[0].length-o-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);n=this.options.hooks?.emStrongMask?.call({lexer:this},n)??n;let a=!1,i="";for(;t;){a||(i=""),a=!1;let l;if(this.options.extensions?.inline?.some(p=>(l=p.call({lexer:this},t,r))?(t=t.substring(l.raw.length),r.push(l),!0):!1))continue;if(l=this.tokenizer.escape(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.tag(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.link(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(l.raw.length);let p=r.at(-1);l.type==="text"&&p?.type==="text"?(p.raw+=l.raw,p.text+=l.text):r.push(l);continue}if(l=this.tokenizer.emStrong(t,n,i)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.codespan(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.br(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.del(t)){t=t.substring(l.raw.length),r.push(l);continue}if(l=this.tokenizer.autolink(t)){t=t.substring(l.raw.length),r.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(t))){t=t.substring(l.raw.length),r.push(l);continue}let d=t;if(this.options.extensions?.startInline){let p=1/0,f=t.slice(1),g;this.options.extensions.startInline.forEach(E=>{g=E.call({lexer:this},f),typeof g=="number"&&g>=0&&(p=Math.min(p,g))}),p<1/0&&p>=0&&(d=t.substring(0,p+1))}if(l=this.tokenizer.inlineText(d)){t=t.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(i=l.raw.slice(-1)),a=!0;let p=r.at(-1);p?.type==="text"?(p.raw+=l.raw,p.text+=l.text):r.push(l);continue}if(t){let p="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(p);break}else throw new Error(p)}}return r}},Es=class{constructor(e){it(this,"options");it(this,"parser");this.options=e||jr}space(e){return""}code({text:e,lang:t,escaped:r}){let n=(t||"").match(Lt.notSpaceStart)?.[0],s=e.replace(Lt.endingNewline,"")+`
...
`)}function Ze(){if(!o)return c``;let W=Q(),x=(a?[d.model]:[d.runner,d.model,d.effort]).filter(Boolean).join(" \xB7 "),B=d.session_id||"",M=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${p?"ON":"OFF"}`,Y=ue(),_e=Y?Cf(pe(),Date.now()):"",K=Y?Ne(W):null,ce=Y?He(W):null,be=Tf(W);return c`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
`).trim()}}var jl=20;function Bl(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function Df(e){return e.length>jl?`${e.slice(0,jl)}\u2026`:e}function Mf(e,t,r,n){let s=`${t.lane} ${Df(t.identifier)}`;return c`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${Ff.map(l=>{let d=l.receipt&&typeof t[l.receipt]=="string"?String(t[l.receipt]):"",p=n[l.id],f=d.length>0||p?.fill==="full",g=!f&&p?.fill==="dim",E=p?.stale===!0;return c`<span
          class=${`detail-summary__gate${f?" detail-summary__gate--on":""}${g?" detail-summary__gate--current":""}${E?" detail-summary__gate--stale":""}`}
          data-gate=${l.id}
        >
    ...
    >${e.replayed?c`<span class="detail-usage-partial" title=${lc}
          >부분 집계</span
        >`:""}`}function ic(e){return!e||!e.roles.orchestrator?null:{providers:e.roles.orchestrator,roles:{}}}function ra(e){if(typeof e!="string")return"";let t=Date.parse(e);return Number.isFinite(t)?na(t):""}function Jf(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let t=e;return typeof t.launch_id!="string"||t.launch_id.length===0||t.provider!=="codex"||!Us.includes(t.role)||typeof t.model!="string"||t.model.length===0||typeof t.session_id!="string"||t.session_id.length===0||!Kf.includes(t.status)||typeof t.started_at!="number"||!Number.isFinite(t.started_at)||typeof t.last_event_at!="number"||!Number.isFinite(t.last_event_at)||!(t.completed_at===null||typeof t.completed_at=="string"&&Number.isFinite(Date.parse(t.completed_at)))||!(t.turn_id===null||typeof t.turn_id=="string")?null:t}function e_(e,t){let n=kt({providers:{codex:{subtotal:t.subtotal,breakdown:t.usage,...t.replayed?{replayed:!0}:{}}},roles:{}})[0];return c`<div class="detail-session__leg detail-session__usage-detail">
  ...
  >
    ...
    ${a?c`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function r_(e,t){return e.role===t.role&&e.model===t.model&&e.session_id===t.session_id}function n_(e,t,r){let n=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let p of o){let f=Jf(p);!f||s.has(f.launch_id)||(s.add(f.launch_id),n.push(f))}n.sort((p,f)=>p.started_at-f.started_at);let a={implementation:[],"review-consult":[]};if(t)for(let p of Us){let f=t.roles[p]?.codex;a[p]=f?[...f.legs]:[]}let i=Us.flatMap(p=>a[p]),l=new Set,d=[];for(let p of Us){for(let f of n.filter(g=>g.role===p)){let g=i.find(E=>E.receipt_id===f.launch_id)||null;g&&!r_(f,g)||(g&&l.add(g.receipt_id),d.push(t_(f,g,e.attempt_id,r)))}for(let f of a[p])l.has(f.receipt_id)||d.push(e_(p,f))}return d}function s_(e,t){let r=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,n=[...Yf,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return c`<div class="detail-session__usage-detail">
  ...
  >
    ...
    `;let o=new Set;for(let d of n)d&&typeof d.resumed_from=="string"&&d.resumed_from.length>0&&o.add(d.resumed_from);let a=d=>{if(!(d.status==="failed"||d.status==="orphaned"))return"";let f=typeof d.session_id=="string"&&d.session_id.length>0,g=o.has(d.attempt_id),E=f&&!g,$=f?g?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":"\uC774 \uC138\uC158\uC744 \uAC19\uC740 \uC6CC\uD06C\uD2B8\uB9AC\uC5D0\uC11C \uC774\uC5B4\uC11C \uC9C4\uD589":"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00";return c`<button
      type="button"
      class="detail-session__resume"
      data-attempt-id=${d.attempt_id}
      ?disabled=${!E}
      title=${$}
      @click=${q=>{q.stopPropagation(),E&&t.onResume&&t.onResume(d.attempt_id)}}
    >
      ↻ 이어하기
  ...
  `}function i_(e){let t=nn(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return c`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?yr("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var l_=["open","in_progress","deferred","resolved","closed"],c_=[0,1,2,3,4];function uc(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,l=t.sessionLogStore,d=null,p=null,f={},g="",E=!1,$=!1,q={},F=!1,R=!1,j="",Z="",C="";function k(){F=!1,R=!1,j="",Z="",C=""}let L=[],U=null,Q=null,pe=!1,ue="",te=!1,se=0,Ie=new Set;function Ne(){L=[],U=null,Q=null,pe=!1,ue="",te=!1,se+=1,Ie.clear()}async function He(u){if(!s)return;let A=++se;try{let w=await Promise.resolve(s("get-comments",{id:u}));if(A!==se||u!==d)return;L=Array.isArray(w)?w:[],pe=!1}catch{if(A!==se||u!==d)return;pe=!0}h()}function Xe(){if(!s||!d)return;let u=p&&typeof p.comment_count=="number"?p.comment_count:null;if(U!==d){U=d,Q=u,He(d);return}u!==null&&u!==Q&&(Q=u,He(d))}function Ve(u){Ie.has(u)?Ie.delete(u):Ie.add(u),h()}function Ze(u){let A=ue.trim().length===0;ue=u,A!==(u.trim().length===0)&&h()}async function fe(){let u=ue.trim();if(!s||!d||u.length===0||te)return;let A=d;te=!0,h();let w=!1;try{let G=await Promise.resolve(s("add-comment",{id:A,text:u}));Array.isArray(G)&&G.length>0&&(w=!0,A===d&&(L=G,pe=!1,ue="",Q=G.length))}catch{w=!1}w||re("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),A===d&&(te=!1),h()}let Re={onToggle:Ve,onDraftInput:Ze,onSubmit:fe},ie=document.createElement("div");ie.className="md-viewer-root",document.body.appendChild(ie);let ke=ac(ie,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),me=document.createElement("div");me.className="session-log-root",document.body.appendChild(me);let J=Ls(me,{transport:s?(u,A)=>Promise.resolve(s(u,A)):void 0,sessionLogStore:l}),H=!1,Ae=!1,$e=!1,oe=null,ge=null,W=0;function x(u){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${u}`}function B(){H=!1,Ae=!1,$e=!1,oe=null,ge=null,W+=1}async function M(u){if(!s)return;let A=++W;Ae=!0,$e=!1,h();try{let w=await Promise.resolve(s("get-bead-prompt",{bead_id:u}));if(A!==W)return;!w||typeof w!="object"||Array.isArray(w)?$e=!0:(oe=w,ge=x(u))}catch{A===W&&($e=!0)}finally{A===W&&(Ae=!1,h())}}function Y(){if(H=!H,H&&d&&ge!==x(d)){oe=null,M(d);return}h()}function _e(){if(!a||!d)return[];let u=a.get();return(u&&u.attempts?Object.values(u.attempts):[]).filter(w=>w&&w.bead_id===d).sort((w,G)=>(G.started_at||0)-(w.started_at||0)).map(w=>({attempt_id:w.attempt_id,bead_id:w.bead_id,status:w.status,started_at:typeof w.started_at=="number"?w.started_at:null,runner:w.runner||null,model:w.model||null,effort:w.effort||null,speed:w.speed||null,session_id:w.session_id||null,resumed_from:w.resumed_from||null,continuation_mode:w.continuation_mode||null,dismissed_at:typeof w.dismissed_at=="number"?w.dismissed_at:null,cause:typeof w.cause=="string"?w.cause:null,cause_detail:w.cause_detail||null,exec_default_preset_id:typeof w.exec_default_preset_id=="string"?w.exec_default_preset_id:null,exec_default_preset_revision:typeof w.exec_default_preset_revision=="number"?w.exec_default_preset_revision:null,exec_values:w.exec_values&&typeof w.exec_values=="object"?w.exec_values:null,usage:w.usage||null,usage_legs:Array.isArray(w.usage_legs)?w.usage_legs:[],delegation_sessions:Array.isArray(w.delegation_sessions)?w.delegation_sessions:[]}))}function K(){if(!a||!d)return null;let u=a.get();return zt(u&&u.attempts||{},d)}let ce=new Set;function be(u){ce.has(u)?ce.delete(u):ce.add(u),h()}function Le(u){let A=a?a.get():null,w=A&&A.attempts?A.attempts[u]:null;J.open({attempt_id:u,meta:w?{runner:w.runner||void 0,model:w.model||void 0,effort:w.effort||void 0,status:w.status||void 0,session_id:w.session_id||void 0}:{}})}function Je(u,A){let w=a?a.get():null,G=w&&w.attempts?w.attempts[u]:null,we=(G&&Array.isArray(G.delegation_sessions)?G.delegation_sessions:[]).find(We=>We&&typeof We=="object"&&We.launch_id===A);we&&J.open({attempt_id:u,launch_id:A,meta:{runner:"codex",role:we.role,model:we.model,session_id:we.session_id,status:we.status}})}async function ot(u){if(!s||!u)return;let A=await Jr();if(A===null)return;let w=()=>{let We=a?a.get():null;return We&&typeof We.revision=="number"?We.revision:0},G=async(We={},Pe=w())=>await s("worker-attempt-resume",{attempt_id:u,expected_revision:Pe,...A!==""?{instructions:A}:{},...We}),ve=We=>{We?.queue&&a?.set&&a.set(We.queue)},we=await G();if(ve(we),we&&we.conflict){let We=we.queue&&typeof we.queue.revision=="number"?we.queue.revision:w();we=await G({},We),ve(we)}we=await _r(we,(We,Pe)=>G({continuation:We,decision_token:Pe}),{onResult:ve,refresh:()=>G()}),we&&we.resumed===!1&&!we.conflict&&we.reason&&re(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${we.reason}`,"error",2400)}let Ye={onOpen:Le,onOpenDelegation:Je,onResume:ot,onToggleUsage:be};function Ge(){let u=a?a.get():null,A={...q};for(let w of["orchestration_model","orchestration_effort","orchestration_speed"]){let G=u&&u[w];typeof G=="string"&&(A[w]=G)}return A}async function O(){if(s){try{let u=await Promise.resolve(s("get-session-defaults",{}));q=u&&u.values&&typeof u.values=="object"?u.values:{}}catch{q={}}h()}}function V(){let u=a?a.get():null;return u&&u.runner_catalog||null}function de(){let u=a?a.get():null;return u&&typeof u.execution_defaults=="object"?u.execution_defaults:null}function Se(){let u=p?.metadata&&typeof p.metadata=="object"?p.metadata:{},w=Qr({pin:{...u,...f},global:Ge(),execution_defaults:de(),runner_catalog:V()}).orchestration_model.value||"";return ta(V(),w)}function qe(){let u=i?i.get():null;return!u||typeof u.revision!="number"?null:{revision:u.revision,presets:Array.isArray(u.presets)?u.presets:[]}}function tt(u){return u?.compatible===!1}function rt(u){i&&u&&typeof u.revision=="number"&&Array.isArray(u.presets)&&i.set({revision:u.revision,presets:u.presets})}async function Fe(){let u=qe(),A=u?.presets.find(w=>w.id===g);if(!(!s||!d||!u||!A||tt(A)||E)){E=!0,h();try{let w=await Promise.resolve(s("apply-impl-preset",Jl(d,A.id,u.revision)));if(w&&w.conflict){rt(w),re("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let G=w&&Array.isArray(w.issue)?w.issue[0]:w?.issue;if(w&&w.applied&&G&&typeof G=="object"){p=G;for(let ve of rc)delete f[ve];re("\uAD6C\uD604 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",2400);return}w&&w.error==="bd_readback_failed"?re("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):re("\uAD6C\uD604 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(w){w&&typeof w=="object"&&w.code==="bd_readback_failed"?re("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):re("\uAD6C\uD604 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{E=!1,h()}}}let Oe=null;r&&r.subscribe&&(Oe=r.subscribe(()=>nt()));let De=null;a&&typeof a.subscribe=="function"&&(De=a.subscribe(()=>{d&&h()}));let et=null;i&&typeof i.subscribe=="function"&&(et=i.subscribe(()=>{d&&h()}));function dt(u){u.key==="Escape"&&d&&(u.preventDefault(),n())}document.addEventListener("keydown",dt);function nt(){if(d){if(r&&typeof r.snapshotFor=="function"){let u=r.snapshotFor("detail:"+d)||[];p=u.find(w=>w&&w.id===d)||u[0]||p}Xe(),h()}}function ut(u){Zt(u).then(A=>{A?re("\uBCF5\uC0AC\uB428","success",1200):re("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function z(u){u.preventDefault(),u.stopPropagation(),d&&ut(d)}function X(u,A){u.preventDefault(),u.stopPropagation(),ut(A)}function y(u,A,w){u.preventDefault(),u.stopPropagation(),ke.open(A,{missing_state:w})}function S(u,A){f[u]=A,h(),!(!s||!d)&&Promise.resolve(s("update-exec-settings",Ql(d,u,A.length===0?null:A))).catch(()=>{re("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function P(u,A){let w=p||{},G=w.metadata&&typeof w.metadata=="object"?w.metadata:{},ve={};for(let Pe of["impl_runtime","impl_model","impl_effort"])ve[Pe]=Object.hasOwn(f,Pe)?f[Pe]:typeof G[Pe]=="string"?G[Pe]:"";ve[u]=A;let we=oc(ve,V(),Se()),We={};for(let Pe of["impl_runtime","impl_model","impl_effort"])We[Pe]=f[Pe],f[Pe]=we[Pe]||"";h(),!(!s||!d)&&Promise.resolve(s("update-impl-target",{id:d,...we,orchestration_runtime:Se()})).then(Pe=>{let mt=Array.isArray(Pe)?Pe[0]:Pe;if(!mt||typeof mt!="object"||!mt.id)throw new Error("implementation target readback failed");p=mt;for(let sr of["impl_runtime","impl_model","impl_effort"])delete f[sr];h()}).catch(()=>{for(let Pe of["impl_runtime","impl_model","impl_effort"])We[Pe]===void 0?delete f[Pe]:f[Pe]=We[Pe];h(),re("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function D(u,A,w){if(!s||!d)return!1;try{let G=await Promise.resolve(s(u,A)),ve=Array.isArray(G)?G[0]:G;return ve&&typeof ve=="object"&&ve.id?(p=ve,!0):(re(w,"error"),!1)}catch{return re(w,"error"),!1}}function he(u){setTimeout(()=>{try{let A=e.querySelector(u);A&&typeof A.focus=="function"&&A.focus()}catch{}},0)}function ye(){F=!0,j=p&&p.title||"",h(),he('.detail-edit__input[data-edit="title"]')}function ae(u){j=u.target.value}function Ke(){F=!1,j="",h()}function xe(){D("edit-text",{id:d,field:"title",value:j},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(A=>{A&&(F=!1,j=""),h()})}function gt(){R=!0,Z=p&&p.description||"",h(),he('.detail-edit__textarea[data-edit="description"]')}function je(u){Z=u.target.value}function $t(){R=!1,Z="",h()}function jt(){D("edit-text",{id:d,field:"description",value:Z},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(A=>{A&&(R=!1,Z=""),h()})}function dr(u,A,w,G){if(u.key==="Escape"){u.stopPropagation(),w();return}u.key==="Enter"&&(!G||u.ctrlKey||u.metaKey)&&(u.preventDefault(),A())}function xt(u){let A=u.target.value;D("update-status",{id:d,status:A},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>h())}function Et(u){let A=Number(u.target.value);D("update-priority",{id:d,priority:A},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>h())}function ur(u){C=u.target.value}function rr(){let u=C.trim();u.length!==0&&D("label-add",{id:d,label:u},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(A=>{A&&(C=""),h()})}function Bt(u){if(u.key==="Escape"){u.stopPropagation(),C="",h();return}u.key==="Enter"&&(u.preventDefault(),rr())}function nr(u){D("label-remove",{id:d,label:u},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>h())}let yt={onCopyPath:X,onOpenDoc:y};function pr(u){return typeof u=="string"?u:u&&typeof u=="object"?String(u.id||u.to||u.issue_id||u.depends_on||""):""}function Ue(u){switch(u&&typeof u=="object"?String(u.dependency_type||u.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Ot(u){let w=(Array.isArray(u.dependencies)?u.dependencies:[]).map(G=>({id:pr(G),icon:Ue(G)})).filter(G=>G.id.length>0);return c`
    ...
    `}function _(u){let A=u.metadata||{},w=u.workflow||{},G=w.stages||{},ve=G.spec&&G.spec.stale,we=G.impl&&G.impl.stale,We=G.plan||null,Pe=w.route_source==="derived",mt=w.route||A.route||"\u2014";return c`
      ...
      ${w.route!=="quick_fix"||Object.hasOwn(A,"spec_review")?c`<div class="detail-kv">
            <span class="detail-kv__k">spec_review</span>
            <span class="detail-kv__v"
              >${A.spec_review||"\uC5C6\uC74C"}${ve?" \xB7 stale":""}</span
            >
          </div>`:""}
      ...
      ${w.route!=="quick_fix"||Object.hasOwn(A,"impl_review")?c`<div class="detail-kv">
            <span class="detail-kv__k">impl_review</span>
            <span class="detail-kv__v"
              >${A.impl_review||"\uC5C6\uC74C"}${we?" \xB7 stale":""}</span
            >
          </div>`:""}
    ...
    `}let v={route:["quick_fix","spec_backed","full_plan"]};async function T(u,A){let w=A.target.value;if(u==="route"&&p&&p.metadata&&p.metadata.route==="full_plan"&&w!=="full_plan"&&!window.confirm(`full_plan \u2192 ${w||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){h();return}await D("update-workflow-meta",{id:d,key:u,value:w},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),h()}function m(u){let A=u.metadata||{};return c` ${((G,ve)=>{let we=v[G],We=typeof A[G]=="string"?A[G]:"";return c`<div class="detail-kv">
        ...
        <select
          ...
          @change=${Pe=>T(G,Pe)}
        >
          <option value="" ?selected=${!we.includes(We)}>
            ${ve}
          </option>
          ${we.map(Pe=>c`<option value=${Pe} ?selected=${We===Pe}>${Pe}</option>`)}
        </select>
      </div>`})("route","(unset)")} `}function I(u,A){return F?c`
      ...
      <div class="detail-title-row">
        ...
        ${kt(A).map(w=>c`<span class="detail-usage-total" title=${w.tooltip}
              >${w.label}</span
            >`)}
        <button
          type="button"
    ...
    `}function ee(u){let A=vt(u.created_at),w=vt(u.updated_at);return!A&&!w?c``:c`
    ...
    `}function le(u,A){return c`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Et}
        >
          ${c_.map(w=>c`<option value=${String(w)} ?selected=${w===A}>
                P${w}
              </option>`)}
        </select>
      </div>
    ...
    `}function Ee(u){let A=typeof u.notes=="string"?u.notes:"";return A.trim().length===0?c``:c`
      <div class="detail-overlay__section-label">노트</div>
      <div class="detail-overlay__notes">${A}</div>
    `}function at(u){let A=Array.isArray(u.labels)?u.labels:[];return c`
      <div class="detail-section-label">라벨</div>
      <div class="detail-labels">
        ${A.map(w=>c`<span class="detail-label-chip"
              >${w}<button
                type="button"
    ...
    `}function lt(){if(!d)return c``;let u=p||{},A=String(u.id||d),w=u.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",G=K(),ve=u.status||"open",we=typeof u.priority=="number"?Math.max(0,Math.min(4,u.priority)):"",We=u.description||"",Pe={...u,metadata:{...u.metadata||{},...f}};return c`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${I(w,G)}
          ${tc(Pe)}
          ${ec({metadata:Pe.metadata,workspace_values:Ge(),catalog:V(),execution_defaults:de(),expanded:$,presets:qe()?.presets||[],preset_id:g,preset_busy:E},{onToggle:mt=>{$=mt,h()},onEdit:(mt,sr)=>{if(mt==="impl_runtime"||mt==="impl_model"||mt==="impl_effort"){P(mt,sr??"");return}S(mt,sr??"")},onPresetSelect:mt=>{g=mt,h()},onPresetApply:()=>{Fe()}})}
          ${le(ve,we)} ${ee(u)}
          ${Ce(We)}
  ...
  >
    ...
    ${o?.url?c`<a href=${o.url} target="_blank" rel="noreferrer noopener"
      ...
      >`:"",E=c`<span class="worker-mini__id" title="클릭하면 ID 복사"
    >${e.id}</span
  >`,$=c`<span class="worker-mini__title">${e.title}</span>`,q=e.pr_url&&e.pr_number?c`<a
    ...
    data-lane=${e.lane}
  >
    ${i?c`<div class="worker-mini__row1">${g}${E}${$}</div>
          <div class="worker-mini__row2">
            ...
            ${on(e)}`:c`<div class="worker-mini__line">
              ${d}${p}${g}${E}${$}${q}${F}${R}${f}${j}${Z}${C}${k}${L}${U}${pe}
            </div>
            ${wr(e)} ${on(e)}`}
  ...
  </div>`}function x_(e,t,r=null){let n=e.failed===!0,s=!!e.paused,o=n?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):s?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?ca(t-e.started_at):"\u2014",a=ar(e),i=Sr(e),l=kt(e.usage),d=Xt(e.usage),p=e.conflict_resolution?s?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,f=e.base_exception||null,g=e.landing,E=e.attempt_id&&e.attempt_id===r,$=e.discard?.action?c`<button
        type="button"
  ...
  `}var H_=[{id:"session",label:"\uC138\uC158",glyph:"\u25C6"},{id:"worker",label:"Worker",glyph:"\u25A4"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}],qt="";function Ft(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Zc(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(O=>re(O,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="session",l=!1,d="",p={},f={},g=[],E=!1,$=null,q={},F="",R="",j=!1,Z=!1,C=!1,k=null;function L(){let O=t.queueStore?.get();return Ft(O)?O.runner_catalog:null}function U(){let O=t.queueStore?.get();return Ft(O)&&Ft(O.execution_defaults)?O.execution_defaults:null}function Q(){let O=t.implPresetStore?.get();return Ft(O)&&Array.isArray(O.presets)?O:null}async function pe(){E=!0,K();try{let O=await r("get-session-defaults",{});p=Ft(O?.values)?{...O.values}:{},f={...p},g=Array.isArray(O?.warnings)?O.warnings:[]}catch(O){g=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${O instanceof Error?O.message:String(O)}`)}finally{E=!1,K()}}async function ue(){let O=Yl(p,f);if(Object.keys(O).length!==0){try{let V=await r("set-session-defaults",{values:O});p=Ft(V?.values)?{...V.values}:{},f={...p},g=Array.isArray(V?.warnings)?V.warnings:[]}catch(V){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}K()}}function te(O,V){V===qt?delete f[O]:f[O]=V,K(),ue()}async function se(){let O=t.queueStore?.get();if(!Ft(O))return;let V={orchestration_model:O.orchestration_model??null,orchestration_effort:O.orchestration_effort??null,orchestration_speed:O.orchestration_speed??null},de=Kl(V,{...V,...q});if(Object.keys(de).length!==0){try{let Se=await r("worker-queue-set-orchestration-defaults",{expected_revision:O.revision,values:de});if(Se&&Se.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}q={}}catch(Se){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${Se instanceof Error?Se.message:String(Se)}`)}K()}}function Ie(O,V){q[O]=V===qt?null:V,K(),se()}async function Ne(O){let V=t.queueStore?.get();if(!(!Ft(V)||O<1)){try{await r("worker-queue-set-slots",{expected_revision:V.revision,slots:O})}catch(de){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${de instanceof Error?de.message:String(de)}`)}K()}}function He(){let O={};for(let V of Hl){let de=f[V];typeof de=="string"&&de.length>0&&(O[V]=de)}return O}async function Xe(){let O=Q();if(!O)return;let V=He();if(Object.keys(V).length===0){o("\uC800\uC7A5\uD560 \uAD6C\uD604 \uAC12\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uAD6C\uD604 \uADF8\uB8F9\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let de=(O.presets||[]).find(qe=>qe.id===F),Se=R.trim()||(de?de.name:"");if(!Se){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let qe=de?await r("impl-preset-update",{expected_revision:O.revision,id:de.id,name:Se,settings:V}):await r("impl-preset-create",{expected_revision:O.revision,name:Se,settings:V});if(qe&&qe.applied){if(R="",!de&&Array.isArray(qe.presets)){let tt=qe.presets.find(rt=>rt.name===Se);F=tt?tt.id:F}K()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),K()}catch(qe){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${qe instanceof Error?qe.message:String(qe)}`)}}async function Ve(){let O=Q();if(!(!O||F.length===0))try{let V=await r("impl-preset-delete",{expected_revision:O.revision,id:F});V&&V.applied?(F="",K()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),K())}catch(V){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}}async function Ze(){let O=Q();if(!(!O||F.length===0)){try{let V=await r("apply-impl-preset-global",{preset_id:F,expected_revision:O.revision});V&&V.applied?(p=Ft(V.values)?{...V.values}:{},f={...p},g=Array.isArray(V.warnings)?V.warnings:[]):V&&V.conflict&&o("\uAD6C\uD604 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(V){o(`\uAD6C\uD604 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}K()}}async function fe(){Z=!0,C=!1,K();try{let O=await r("get-worker-system-prompt",{});!O||typeof O!="object"||Array.isArray(O)?C=!0:k=O}catch{C=!0}finally{Z=!1,K()}}function Re(){if(j=!j,j&&!k){fe();return}K()}function ie(){let O=nn({loading:Z,error:C});if(O)return O;if(!k)return"";let V=Array.isArray(k.variants)?k.variants:[];return c`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      >
        ...
        ${E?c`<div class="settings-dialog__empty">불러오는 중…</div>`:c`
    ...
    `}async function ge(O){let V=n.get();if(V)try{let de=await r("display-policy-set",{expected_revision:V.revision,policy:O(V)});W(de),de&&de.conflict&&de.policy&&(de=await r("display-policy-set",{expected_revision:de.policy.revision,policy:O(de.policy)}),W(de)),de&&de.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function W(O){O&&O.policy&&typeof O.policy=="object"&&n.set(O.policy)}function x(O){ge(O)}function B(O){let V=n.get();if(!V)return;let de=!G_(O,V);x(Se=>V_(O,Se,de))}function M(){let O=d.trim();O.length!==0&&(d="",x(V=>V.hidden_prefixes.includes(O)?{hidden_prefixes:V.hidden_prefixes}:{hidden_prefixes:[...V.hidden_prefixes,O]}),K())}function Y(O){x(V=>({hidden_prefixes:V.hidden_prefixes.filter(de=>de!==O)}))}function _e(O){let V=n.get();if(!V)return;let de=V.chips[O]===!1;x(()=>({chips:{[O]:de}}))}function K(){Be(c`
      ...
      `,a)}function ce(O){i=O,K()}let be=()=>{l=!1,t.onOpenChange?.(!1)};a.addEventListener("close",be),a.addEventListener("cancel",be);let Le=O=>{O.target===a&&Ge()};a.addEventListener("click",Le);let Je=null;n.subscribe&&(Je=n.subscribe(()=>{l&&K()}));let ot=null;t.implPresetStore?.subscribe&&(ot=t.implPresetStore.subscribe(()=>{l&&K()}));function Ye(O="session"){l||(l=!0,t.onOpenChange?.(!0),i=O,d="",q={},K(),typeof a.showModal=="function"?a.showModal():a.setAttribute("open",""),pe())}function Ge(){l&&(l=!1,t.onOpenChange?.(!1),typeof a.close=="function"?a.close():a.removeAttribute("open"))}return{open:Ye,close:Ge,sessionDraft:()=>({...f}),destroy(){l=!1,a.removeEventListener("close",be),a.removeEventListener("cancel",be),a.removeEventListener("click",Le),Je&&(Je(),Je=null),ot&&(ot(),ot=null),a.remove()}}}function G_(e,t){return t.visible_labels.includes(e)?!0:t.hidden_labels.includes(e)?!1:!t.hidden_prefixes.some(r=>r.length>0&&e.startsWith(r))}function V_(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}var Y_=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];function Xc(e){return String(e).padStart(2,"0")}function K_(e,t){let r=Math.max(0,Math.ceil((e-t)/6e4)),n=Math.floor(r/1440),s=Math.floor(r%1440/60),o=r%60;return n>0?`${n}d${s>0?` ${s}h`:""}`:s>0?`${s}h${o>0?` ${o}m`:""}`:`${o}m`}function Z_(e,t=Date.now()){let r=Date.parse(e);if(!Number.isFinite(r))return"";let n=new Date(r),s=new Date(t),o=`${Xc(n.getHours())}:${Xc(n.getMinutes())}`,i=n.getFullYear()===s.getFullYear()&&n.getMonth()===s.getMonth()&&n.getDate()===s.getDate()?o:`${Y_[n.getMonth()]} ${n.getDate()} ${o}`;return`${K_(r,t)} \xB7 ${i}`}function X_(e){return e>=85?"usage-meter__window--danger":e>=60?"usage-meter__window--warn":"usage-meter__window--success"}var Qc=[{key:"claude",label:"Claude",endpoint:"/api/claude-usage"},{key:"codex",label:"Codex",endpoint:"/api/codex-usage"}];function Jc(e){let t=!1,r=null,n=new Map;function s(){Be(c``,e),e.hidden=!0}function o(){let l=Qc.filter(p=>n.has(p.key));if(l.length===0){s();return}let d=Date.now();Be(c`<div class="usage-meter" aria-label="Usage">
        ${l.map(p=>{let f=n.get(p.key),g=typeof f.ageSeconds=="number"&&f.ageSeconds>600,E=g?`${Math.floor(f.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"";return c`<span
            class="usage-meter__group${g?" usage-meter__group--stale":""}"
            aria-label=${`${p.label} usage`}
          >
            <span class="usage-meter__provider">${p.label}</span>
            ${f.windows.map($=>{let q=typeof $.pct=="number"&&Number.isFinite($.pct)?$.pct:0,F=Math.min(100,Math.max(0,q)),j=`resets ${Z_($.resetsAt,d)}${g?` \xB7 ${E}`:""}`;return c`<span
      ...
      >`:y.is_default===!0?c`<span class="pa-settings__default">기본값</span>`:""}function K(y){return y.is_default===!0&&y.compatible===!1}function ce(y){return!!(y.runner&&y.model&&y.effort)}function be(y){return ce(y)&&y.compatible!==!1}function Le(y){let S=Math.max(0,Math.floor(y/1e3)),P=Math.floor(S/60),D=S%60;return`${P}:${String(D).padStart(2,"0")}`}function Je(y){let S=y.job;if(S){let P=typeof S.started_at=="number"?S.started_at:0,D=`${S.runner||"?"}/${S.model||"?"}`,he=P?` \xB7 \uACBD\uACFC ${Le(Date.now()-P)}`:"",ye=typeof S.session_id=="string"?S.session_id:"",ae=U(y).find(Ke=>Ke.run_id===S.job_id);return c`<span class="pa-meta__progress">
        <span
          >분석 중 — ${D} · effort ${S.effort||"?"}${he}</span
        >
        ${ye?c`<code class="pa-session-id" title=${ye}
              >${ye.slice(0,8)}</code
            >`:""}
        <button
          type="button"
        ...
        >`:""}function ot(){return n?.isPending?.()===!0}function Ye(y){let S=!!y.job,P=be(y.settings),D=E!==null&&$.size===0,he=S||p||ot()||q;return c`<div class="pa-meta">
    ...
    </div>`}function Ge(y){return typeof y=="string"&&y.length>0?y:"\uBBF8\uBC30\uCE58"}function O(y,S){S?$.add(y):$.delete(y),Oe()}function V(){let y=E?.qualified||[],S=E?.excluded||[];return c`<section class="pa-targets">
      ...
      ${E&&y.length>0?c`<ul class="pa-targets__list">
          ...
          </ul>`:E&&y.length===0?c`<p class="pa-empty">자격 있는 분석 대상이 없습니다</p>`:""}
      ${E&&S.length>0?c`<details class="pa-targets__excluded">
...
${R.prompt}</pre
    ...
    </div>`:""}function tt(y,S){let P=te(y,S),D=Q(),he=P.filter(je=>D.has(je)),ye=pe(P),ae=se(P),Ke=Array.isArray(Z().serial_lanes)?Z().serial_lanes:[],xe=d.get(y)||Ie(),gt=S.eligible!==!0||P.length<2||he.length>0||ye.length>0||ae||p;return c`<section class="pa-group" data-group-index=${String(y)}>
      <header class="pa-group__head">
        ...
        ${ye.length>0?c`<span class="pa-group__stale"
...
`):[];return c`<div
    ...
    </div>`}function E(){Be(g(),n)}async function $(){if(o!=="ready")return;let k=await Zt(a);re(k?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",k?"success":"error")}function q(k){k.key==="Escape"&&s&&(k.preventDefault(),Z())}function F(){p||(document.addEventListener("keydown",q),p=!0)}function R(){p&&(document.removeEventListener("keydown",q),p=!1)}async function j(k,L=null){let U=++l;F(),s={...k},d=L||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",E(),n.querySelector(".repo-ops-script-viewer__close")?.focus();let pe=t?t():"";if(!pe){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",E();return}if(!r){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",E();return}let ue="/api/repo-ops-script?workspace="+encodeURIComponent(pe)+"&lane="+encodeURIComponent(k.lane)+"&base_sha="+encodeURIComponent(k.base_sha);try{let te=await r(ue),se=await te.json().catch(()=>({}));if(U!==l)return;if((t?t():"")!==pe){Z();return}if(!te.ok||!se||se.ok!==!0){o="error",i=im(se&&typeof se.error=="string"?se.error:""),E();return}s={lane:se.lane,base_sha:se.base_sha,path:se.path,base_ref:se.base_ref},a=String(se.content),o="ready",E()}catch{if(U!==l)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",E()}}function Z(){l+=1,R(),s=null,a="",E();let k=d;d=null,k?.isConnected&&k.focus()}function C(){Z(),n.remove()}return{open:j,close:Z,destroy:C}}function ad(e){let t=e.queueStore,r=e.transport,n=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let C=o();return typeof C.revision=="number"?C.revision:0}function i(C){t&&C&&C.queue&&typeof C.queue=="object"&&t.set(C.queue)}function l(){let C=o().workspace_info;return C&&typeof C=="object"?C:{}}function d(C,k){return c`<span
    ...
    ></button>`}function E(C){let k=typeof C.base_sha=="string"?C.base_sha:"",L=`${C.source_path||"repo-ops/config.toml"} @ ${C.base_ref||"?"}${k?`@${k.slice(0,7)}`:""}`;return c`<section class="worker-repo-ops__vd" data-seam="repo-ops">
    ...
    </section>`}function $(C){let k=C.repo_ops&&typeof C.repo_ops=="object"?C.repo_ops:null;return k&&(k.status==="resolved"||k.status==="absent")?E(k):k&&(k.status==="pending"||k.status==="error")?c`<section class="worker-repo-ops__vd" data-seam="repo-ops">
        <p class="worker-repo-ops__vd-title">
          저장소 작업 선언
...
${At.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:N==="done"?zt(_.attempts||{},ne.bead_id):null,work_ms:N==="done"?fc(_.attempts||{},ne.bead_id):null,done_at:N==="done"&&typeof ne.added_at=="number"?ne.added_at:void 0,...ve(ne.bead_id)}}),zr=_.attempts?Object.values(_.attempts):[],ro=new Set;for(let b of zr)b&&typeof b.resumed_from=="string"&&b.resumed_from.length>0&&ro.add(b.resumed_from);let Ra=new Map;for(let b of zr)Ra.set(b.bead_id,b.attempt_id);let zn=new Map;for(let b of zr)zn.set(b.attempt_id,b);function no(b){let N=new Set,ne=b;for(;ne&&!N.has(ne.attempt_id);){if(ne.conflict_resolution===!0)return!0;N.add(ne.attempt_id),ne=typeof ne.resumed_from=="string"&&ne.resumed_from.length>0&&zn.get(ne.resumed_from)||null}return!1}let Hn=typeof _.declared_base=="string"?_.declared_base:null;function Nd(b){let N=null;for(let ne of zr)!ne||ne.bead_id!==b||no(ne)||(N===null||(typeof ne.started_at=="number"?ne.started_at:0)>=(typeof N.started_at=="number"?N.started_at:0))&&(N=ne);return N&&typeof N.target_base=="string"?N.target_base:null}let Ia=[],La=[],qd=ed(_),Oa=b=>{let N=typeof b.session_id=="string"&&b.session_id.length>0,ne=ro.has(b.attempt_id);return{eligible:N&&!ne,reason:N?ne?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Gt=null;for(let b of zr){let N=b.status==="paused"&&!ro.has(b.attempt_id);if(b.status==="running"||N)La.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:Ee.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,paused:N,conflict_resolution:no(b),base_exception:ka(Hn,b.target_base),can_pause:typeof b.session_id=="string"&&b.session_id.length>0,discard:cr(Wn,b.bead_id,{attempt_id:b.attempt_id}),usage:zt(_.attempts||{},b.bead_id),current_child:le(b.bead_id),...ve(b.bead_id)});else if((b.status==="failed"||b.status==="orphaned")&&qd(b)){let ne=Oa(b);Ia.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:Ee.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,failed:!0,status:b.status,status_label:b.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:cr(Wn,b.bead_id,{attempt_id:b.attempt_id}),resume_eligible:ne.eligible,resume_reason:ne.reason,conflict_resolution:no(b),base_exception:ka(Hn,b.target_base),usage:zt(_.attempts||{},b.bead_id),current_child:le(b.bead_id),...ve(b.bead_id)}),Gt=b}}let Gn=[...Ia,...La].map(b=>{let N=zn.get(b.attempt_id),ne=N?.quickfix_landing;if(N?.quickfix_lane!==!0||!ne||typeof ne!="object")return b;let Me=typeof ne.reason=="string"&&ne.reason.length>0?ne.reason:null,pt=qn({bead_id:N.bead_id,merge_sha:ne.head_sha,cleanup_cursor:ne.cursor,cleanup_failed:Me?{step:ne.cursor,reason:Me}:null,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]});return pt?{...b,landing:pt}:b}),Pa=null;if(Gt){let b=Oa(Gt),N=Gt.cause_detail;Pa={bead_id:Gt.bead_id,repo:Gt.repo||"",reason:Gt.cause||Gt.status,cause_detail:N&&typeof N.reason=="string"?{reason:N.reason,command:typeof N.command=="string"?N.command:null}:null,resume_attempt_id:Gt.attempt_id,resume_eligible:b.eligible,resume_reason:b.reason,discard:cr(Wn,Gt.bead_id,{attempt_id:Gt.attempt_id})}}let Da=new Set(Gn.map(b=>b.bead_id)),so=Array.isArray(_.merge_queue)?_.merge_queue:[],Ma=new Map,Na=new Map,qa=new Map,Fa=new Map,ja=new Map;so.forEach((b,N)=>{b&&typeof b.bead_id=="string"&&(Ma.set(b.bead_id,N+1),Na.set(b.bead_id,b.resolution),qa.set(b.bead_id,b.continuation_action||null),Fa.set(b.bead_id,b.head_review||null),ja.set(b.bead_id,b.authority||null))});let Hr=_.merge_queue_state||{active:null,failures:{}},Fd=Hr.failures||{},Ba=Hr.waiting&&typeof Hr.waiting.bead_id=="string"&&typeof Hr.waiting.reason=="string"?Hr.waiting:null,jd=_.auto_merge_skips||{},Ua=b=>{let N=jd[b];if(!N)return null;let ne=We[b],Me=ne&&ne.pr?ne.pr.head_sha:null;return Me&&Me===N.head_sha?N.reason||"":null},Vn=new Map;for(let b of Gn)b.failed!==!0&&b.conflict_resolution&&(b.paused?Vn.has(b.bead_id)||Vn.set(b.bead_id,"paused"):Vn.set(b.bead_id,"running"));let Wa=Gn.filter(b=>!b.paused&&b.failed!==!0).length,za=(_.workspace_info||{}).slots,Ha=typeof za=="number"?za:typeof _.slots=="number"?_.slots:Qs,Bd=Wa>Ha,Yn=Dr(j),Ud=(Array.isArray(_.done)?_.done.slice():[]).filter(b=>Yn===void 0||typeof b.added_at!="number"||b.added_at>=Yn).sort((b,N)=>(N.added_at||0)-(b.added_at||0)),cn=to(Ud,"done"),Wd=new Set((Array.isArray(_.done)?_.done:[]).map(b=>b?.bead_id).filter(b=>typeof b=="string")),Ga=[],zd=d?.()||"";for(let b of m){let N=qr(b.closed_at);if(typeof b.id!="string"||Wd.has(b.id)||N===null||Yn!==void 0&&N<Yn||typeof b.comment_count!="number"||b.comment_count<=0)continue;let ne=`${zd}\0${b.id}\0${String(b.updated_at)}\0${b.comment_count}`,Me=Z.get(ne);Me===void 0&&r&&(Z.set(ne,"pending"),Promise.resolve(r("get-comments",{id:b.id})).then(pt=>{let Vt=Array.isArray(pt)&&pt.some(At=>Os(typeof At?.text=="string"?At.text:"")?.lane==="session");Z.set(ne,Vt?"session":"not-session"),D()}).catch(()=>{Z.set(ne,"failed"),D()})),Me==="session"&&Ga.push({id:b.id,title:b.title||b.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:N,created_at:b.created_at,updated_at:b.updated_at})}cn.push(...Ga),cn.sort((b,N)=>(N.done_at||0)-(b.done_at||0));let Kn={};for(let b of mr)Kn[b]=0;let Va=!1,Ya=0,oo=0,Ka=0;for(let b of cn){let N=b.usage;if(N&&typeof N=="object"){let ne=!1;for(let Me of mr)Number.isFinite(N[Me])&&(Kn[Me]+=N[Me],Va=!0,ne=!0);ne&&(oo+=1,Number.isFinite(N.total_cost_usd)&&(Ya+=N.total_cost_usd,Ka+=1))}}oo>0&&Ka===oo&&(Kn.total_cost_usd=Ya);let Za=cn.map(b=>b.usage).filter(b=>b&&typeof b=="object"&&b.providers),Hd=Za.length>0?kt(hs(Za)):Va?Xt(Kn):null,Gd=_.lane_states&&typeof _.lane_states=="object"&&!Array.isArray(_.lane_states)?_.lane_states:{},Vd=Array.isArray(_.serial_lanes)?_.serial_lanes:[],Xa=b=>{if(we.some(Me=>Me.bead_id===b))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let N=zr.filter(Me=>Me&&Me.bead_id===b),ne=N.length>0?N[N.length-1].status:null;return ne==="failed"||ne==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":ne==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},Qa=Vd.filter(b=>b&&typeof b.id=="string"&&Array.isArray(b.entries)).map((b,N)=>{let ne=Gd[b.id]||{},Me=new Map((Array.isArray(ne.corrections)?ne.corrections:[]).filter(ct=>ct&&typeof ct.bead_id=="string"&&typeof ct.after=="string").map(ct=>[ct.bead_id,ct.after])),pt=to(b.entries.filter(ct=>!Da.has(ct.bead_id)),b.id).map(ct=>Me.has(ct.id)?{...ct,badges:[`\u{1F517} ${Me.get(ct.id)} \uB4A4 (blocks \uC790\uB3D9)`,...ct.badges]}:ct),Vt=Array.isArray(ne.occupied_by)?ne.occupied_by.filter(ct=>typeof ct=="string"):[],At=Vt.map(ct=>({id:ct,title:Ee.get(ct)||ct,draggable:!1,lane:b.id,ghost:!0,badges:[Xa(ct)]}));return{id:b.id,index:N+1,rows:[...At,...pt],occupied:Vt.length>0,badge:Vt.length>0?Xa(Vt[0]):"\uB300\uAE30",cycle:ne.cycle===!0}}),Yd=typeof _.serial_lane_count=="number"?_.serial_lane_count:Qa.length;return{queue:_,idToTitle:Ee,candidates:Dd,candidate_hidden:{blocked:eo.hidden_blocked,spec:eo.hidden_spec},running:Gn,live_count:Wa,slots:Ha,over_cap:Bd,failure:Pa,waiting:to(an.filter(b=>!Da.has(b.bead_id)),"queue"),serial_lanes:Qa,serial_lane_count:Yd,pr_wait:we.map(b=>Bm(b.bead_id,Ee.get(b.bead_id)||b.bead_id,We,mt[b.bead_id]||null,zt(_.attempts||{},b.bead_id),Pe[b.bead_id]||(U.has(b.bead_id)||Q.has(b.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Vn.get(b.bead_id)||null,b.external===!0,{position:Ma.get(b.bead_id)||0,active:Hr.active===b.bead_id,failure:Fd[b.bead_id]||null,waiting:Ba?.bead_id===b.bead_id?Ba.reason:null,resolution:Na.get(b.bead_id),continuation_action:qa.get(b.bead_id),head_review:Fa.get(b.bead_id)||null,authority:ja.get(b.bead_id)||null},b.wt_present!==!1,_.auto_merge===!0?Ua(b.bead_id):null,ka(Hn,Nd(b.bead_id)),_.completion_status&&typeof _.completion_status=="object"&&!Array.isArray(_.completion_status)&&_.completion_status[b.bead_id]||null,_.discard_operations&&typeof _.discard_operations=="object"&&!Array.isArray(_.discard_operations)?_.discard_operations:{},zn.get(Ra.get(b.bead_id)||"")?.worker_serial===!0,_.auto_merge===!0,{merge_sha:b.merge_sha,cleanup_cursor:b.cleanup_cursor,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]})).map(b=>({...b,...ve(b.id)})),merge_queue_length:so.length,merge_queue_running:so.length>0,auto_excluded:we.map(b=>b.bead_id).filter(b=>Ua(b)!==null),declared_base:Hn,done:cn,token_total:Hd,cleanup_failures:sr,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]}}function De(){let v=!!o?.get()?.job,T=!v&&o?.isPending?.()===!0,m=v?"\uBD84\uC11D \uC911":T?"\uC900\uBE44 \uC911":"";return c`<button
    ...
    `}function k(){Be(C(),e)}return k(),a=t.subscribe(()=>k()),{destroy(){a&&(a(),a=null),document.removeEventListener("mousedown",g),document.removeEventListener("keydown",E),Be(c``,e)}}}var kd=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-impl-target","get-session-defaults","set-session-defaults","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-automation-toggle","worker-auto-repair-toggle","worker-repo-operation-repair","worker-repo-operation-dismiss","worker-queue-set-slots","worker-queue-set-serial-lane-count","subscribe-worker-parallel-analysis","unsubscribe-worker-parallel-analysis","worker-parallel-analysis-snapshot","worker-parallel-analysis-targets","worker-parallel-analysis-prompt","worker-parallel-analysis-start","worker-parallel-analysis-cancel","worker-parallel-analysis-settings-update","worker-parallel-analysis-submit","worker-queue-set-orchestration-defaults","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-cleanup-retry","worker-merge-queue-add","worker-merge-queue-add-all","worker-merge-auto-toggle","worker-merge-queue-remove","worker-discard","worker-stale-work-continue","worker-stale-work-backup-fresh","worker-stale-work-recheck","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append","get-attempt-prompt","get-bead-prompt","get-worker-system-prompt","subscribe-monitor-pipeline","unsubscribe-monitor-pipeline","monitor-pipeline-snapshot","subscribe-impl-presets","unsubscribe-impl-presets","impl-presets-snapshot","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","monitor-auto-toggle"];function Sa(){let e=Date.now().toString(36),t=Math.random().toString(36).slice(2,8);return`${e}-${t}`}function $d(e,t,r=Sa()){return{id:r,type:e,payload:t}}function xd(e={}){let t=ft("ws"),r={initialMs:e.backoff?.initialMs??1e3,maxMs:e.backoff?.maxMs??3e4,factor:e.backoff?.factor??2,jitterRatio:e.backoff?.jitterRatio??.2},n=()=>e.url&&e.url.length>0?e.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",a=0,i=null,l=!0,d=new Map,p=[],f=new Map,g=new Set;function E(C){for(let k of Array.from(g))try{k(C)}catch{}}function $(){if(!l||i)return;o="reconnecting",t("ws reconnecting\u2026"),E(o);let C=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,a)),k=(r.jitterRatio||0)*C,L=Math.max(0,Math.round(C+(Math.random()*2-1)*k));t("ws retry in %d ms (attempt %d)",L,a+1),i=setTimeout(()=>{i=null,Z()},L)}function q(C){try{s?.send(JSON.stringify(C))}catch(k){t("ws send failed",k)}}function F(){for(o="open",t("ws open"),E(o),a=0;p.length;){let C=p.shift();C&&q(C)}}function R(C){let k;try{k=JSON.parse(String(C.data))}catch{t("ws received non-JSON message");return}if(!k||typeof k.id!="string"||typeof k.type!="string"){t("ws received invalid envelope");return}if(d.has(k.id)){let U=d.get(k.id);d.delete(k.id),k.ok?U?.resolve(k.payload):U?.reject(k.error||new Error("ws error"));return}let L=f.get(k.type);if(L&&L.size>0)for(let U of Array.from(L))try{U(k.payload)}catch(Q){t("ws event handler error",Q)}else t("ws received unhandled message type: %s",k.type)}function j(){o="closed",t("ws closed"),E(o);for(let[C,k]of d.entries())k.reject(new Error("ws disconnected")),d.delete(C);a+=1,$()}function Z(){if(!l)return;let C=n();try{s=new WebSocket(C),t("ws connecting %s",C),o="connecting",E(o),s.addEventListener("open",F),s.addEventListener("message",R),s.addEventListener("error",()=>{}),s.addEventListener("close",j)}catch(k){t("ws connect failed %o",k),$()}}return Z(),{send(C,k){if(!kd.includes(C))return Promise.reject(new Error(`unknown message type: ${C}`));let L=Sa(),U=$d(C,k,L);return t("send %s id=%s",C,L),new Promise((Q,pe)=>{d.set(L,{resolve:Q,reject:pe,type:C}),s&&s.readyState===s.OPEN?q(U):(t("queue %s id=%s (state=%s)",C,L,o),p.push(U))})},on(C,k){f.has(C)||f.set(C,new Set);let L=f.get(C);return L?.add(k),()=>{L?.delete(k)}},onConnection(C){return g.add(C),()=>{g.delete(C)}},reconnect(){l=!0,i&&(clearTimeout(i),i=null),a=0,Z()},close(){l=!1,i&&(clearTimeout(i),i=null);try{s?.close()}catch{}},getState(){return o}}}function Um(){let e=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:null}}}async function Wm(e,t){try{let n=await(await fetch("/api/config")).json();e.setState({config:n})}catch(r){t("config refresh failed",r)}}var Aa=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],Sd=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"],["tab:worker:in-progress","in-progress-issues"],["tab:worker:closed","closed-issues"]],Tr="tab:worker:closed",zm="bdui.worker.done-range",Ad=jc,Ed="worker:queue",Td="worker:parallel-analysis",Cd="ui:order",Rd="ui:display-policy",Id="exec:presets",Cr="tab:board:closed",Ld="beads-ui.board.closed-range";function Hm(e){let t=ft("main");t("bootstrap start");let r=c`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="monitor-root" class="route monitor" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;Be(r,e);let n=document.getElementById("top-nav"),s=document.getElementById("usage-meter"),o=document.getElementById("board-root"),a=document.getElementById("worker-root"),i=document.getElementById("monitor-root"),l=document.getElementById("detail-panel");if(s&&Jc(s),o&&a&&i&&l){let Ze=function(h,u){let A="Request failed",w="";if(h&&typeof h=="object"){let ve=h;if(typeof ve.message=="string"&&ve.message.length>0&&(A=ve.message),typeof ve.details=="string")w=ve.details;else if(ve.details&&typeof ve.details=="object")try{w=JSON.stringify(ve.details,null,2)}catch{w=""}}else typeof h=="string"&&h.length>0&&(A=h);let G=u&&u.length>0?`Failed to load ${u}`:"Request failed";Ve.open(G,A,w)},be=function(h){return`${Ue.getState().workspace.current?.path||""}\0${h}`},Le=function(){W&&(W().catch(()=>{}),W=null),x=null,B=null},ot=function(h){M=h;let u=()=>{M!==h||Ue.getState().selected_id!==h||(M=null,Je(h))};if(!K){_e.then(u);return}u()},V=function(h,u,A,w,G){return A!==O[u]?(G().catch(()=>{}),!1):(h.set(w,G),!0)},Se=function(){let h=Ue.getState();Oe(h.view==="board"),z(h.view==="worker"),D(h.view==="monitor"),y(h.view==="board"||h.view==="worker"||de||!!h.selected_id)},rt=function(){let h=Dr(qe);return h===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:h}}},Fe=function(){let h=Dr(tt);return h===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:h}}},Oe=function(h){if(h)for(let[u,A]of Aa){if(Ye.has(u)||Ge.has(u))continue;let w=u===Cr?rt():{type:A};try{ke.register(u,w)}catch(we){t("register %s store failed: %o",u,we)}Ge.add(u);let G=O.board,ve=!1;ie.subscribeList(u,w).then(we=>{ve=!V(Ye,"board",G,u,we)}).catch(we=>{t("subscribe %s failed: %o",u,we),Ze(we,"board")}).finally(()=>{Ge.delete(u),ve&&Se()})}else dt()},dt=function(){O.board+=1;for(let[h]of Aa){let u=Ye.get(h);u&&(u().catch(()=>{}),Ye.delete(h));try{ke.unregister(h)}catch(A){t("unregister %s failed: %o",h,A)}}},z=function(h){if(!h){X();return}for(let[u,A]of Sd){if(nt.has(u)||Ge.has(u))continue;let w=u===Tr?Fe():{type:A};try{ke.register(u,w)}catch(we){t("register %s store failed: %o",u,we)}Ge.add(u);let G=O.worker,ve=!1;ie.subscribeList(u,w).then(we=>{ve=!V(nt,"worker",G,u,we)}).catch(we=>{t("subscribe %s failed: %o",u,we),Ze(we,"worker")}).finally(()=>{Ge.delete(u),ve&&Se()})}},X=function(){O.worker+=1;for(let[h]of Sd){let u=nt.get(h);u&&(u().catch(()=>{}),nt.delete(h));try{ke.unregister(h)}catch(A){t("unregister %s failed: %o",h,A)}}},y=function(h){if(!h){S();return}ut||(Re("subscribe-worker-queue",{id:Ed}).catch(u=>{t("subscribe-worker-queue failed: %o",u)}),Re("subscribe-worker-parallel-analysis",{id:Td}).catch(u=>{t("subscribe-worker-parallel-analysis failed: %o",u)}),ut=()=>(Re("unsubscribe-worker-parallel-analysis",{id:Td}),Re("unsubscribe-worker-queue",{id:Ed})))},S=function(){ut&&(ut().catch(()=>{}),ut=null),J.clear()},D=function(h){if(!h){he();return}P||(Re("subscribe-monitor-pipeline",{id:Ad}).catch(u=>{t("subscribe-monitor-pipeline failed: %o",u)}),P=()=>Re("unsubscribe-monitor-pipeline",{id:Ad}))},he=function(){P&&(P().catch(()=>{}),P=null)},ae=function(){ye||(Re("subscribe-ui-order",{id:Cd}).catch(h=>{t("subscribe-ui-order failed: %o",h)}),ye=()=>Re("unsubscribe-ui-order",{id:Cd}))},Ke=function(){ye&&(ye().catch(()=>{}),ye=null),Ae.clear()},gt=function(){xe||(Re("subscribe-display-policy",{id:Rd}).catch(h=>{t("subscribe-display-policy failed: %o",h)}),xe=()=>Re("unsubscribe-display-policy",{id:Rd}))},je=function(){xe&&(xe().catch(()=>{}),xe=null),$e.clear()},jt=function(){$t||(Re("subscribe-impl-presets",{id:Id}).catch(h=>{t("subscribe-impl-presets failed: %o",h)}),$t=()=>Re("unsubscribe-impl-presets",{id:Id}))},Bt=function(h){if(!h)return"Unknown";let u=h.split("/").filter(Boolean);return u.length>0?u[u.length-1]:"Unknown"};var d=Ze,p=be,f=Le,g=ot,E=V,$=Se,q=rt,F=Fe,R=Oe,j=dt,Z=z,C=X,k=y,L=S,U=D,Q=he,pe=ae,ue=Ke,te=gt,se=je,Ie=jt,Ne=Bt;let He=document.getElementById("header-loading"),Xe=Ni(He),Ve=pc(e),fe=xd(),Re=Xe.wrapSend((h,u)=>fe.send(h,u)),ie=Ci(Re),ke=Ri(),me=Oi(),J=Li(),H=_i(),Ae=Ii(),$e=pi(),oe=fi(),ge=mi();fe.on("impl-presets-snapshot",h=>{let u=h;u&&typeof u.revision=="number"&&Array.isArray(u.presets)&&oe.set({revision:u.revision,presets:u.presets})}),fe.on("monitor-pipeline-snapshot",h=>{let u=h;if(!(!u||!Array.isArray(u.workspaces)))try{H.set(u.workspaces,u.workspaces_state)}catch{}}),fe.on("ui-order-snapshot",h=>{let u=h;if(u&&typeof u.revision=="number")try{Ae.set({revision:u.revision,order:u.order&&typeof u.order=="object"?u.order:{}})}catch{}}),fe.on("display-policy-snapshot",h=>{let u=h;if(u&&u.policy&&typeof u.policy=="object")try{$e.set(u.policy)}catch{}}),fe.on("session-log-snapshot",h=>{let u=h;if(u&&typeof u.id=="string")try{ge.set(u.id,Array.isArray(u.lines)?u.lines:[],typeof u.last_event_at=="number"?u.last_event_at:null)}catch{}}),fe.on("session-log-append",h=>{let u=h;if(u&&typeof u.id=="string")try{ge.append(u.id,u.event)}catch{}}),fe.on("snapshot",h=>{let u=h,A=u&&typeof u.id=="string"?u.id:"",w=A?ke.getStore(A):null;if(w&&u&&u.type==="snapshot")try{w.applyPush(u)}catch{}}),fe.on("upsert",h=>{let u=h,A=u&&typeof u.id=="string"?u.id:"",w=A?ke.getStore(A):null;if(w&&u&&u.type==="upsert")try{w.applyPush(u)}catch{}}),fe.on("delete",h=>{let u=h,A=u&&typeof u.id=="string"?u.id:"",w=A?ke.getStore(A):null;if(w&&u&&u.type==="delete")try{w.applyPush(u)}catch{}});let W=null,x=null,B=null,M=null,Y=()=>{},_e=new Promise(h=>{Y=()=>h(void 0)}),K=!1,ce=!1;async function Je(h){let u=be(h);if(u===x||u===B)return;B=u;let A=`detail:${h}`,w={type:"issue-detail",params:{id:h}};try{ke.register(A,w)}catch(G){t("register detail store failed: %o",G)}try{let G=await ie.subscribeList(A,w);if(Ue.getState().selected_id!==h||be(h)!==u){await G().catch(()=>{});return}W&&await W().catch(()=>{}),W=G,x=u}catch(G){t("detail subscribe failed: %o",G),Ze(G,"issue details")}finally{B===u&&(B=null)}}let Ye=new Map,Ge=new Set,O={board:0,worker:0},de=!1,qe=Mt;try{let h=window.localStorage.getItem(Ld);Wt(h)&&(qe=h)}catch{}let tt=Mt;try{let h=window.localStorage.getItem(zm);Wt(h)&&(tt=h)}catch{}async function De(h){if(!Wt(h)||h===qe)return;qe=h;try{window.localStorage.setItem(Ld,h)}catch{}let u=Ye.get(Cr);if(!u)return;Ye.delete(Cr),await u().catch(()=>{});let A=rt();try{ke.register(Cr,A)}catch(w){t("register %s store failed: %o",Cr,w)}try{let w=await ie.subscribeList(Cr,A);Ye.set(Cr,w)}catch(w){t("re-subscribe %s failed: %o",Cr,w),Ze(w,"board")}}async function et(h){if(!Wt(h)||h===tt)return;tt=h;let u=nt.get(Tr);if(!u)return;nt.delete(Tr),await u().catch(()=>{});let A=Fe();try{ke.register(Tr,A)}catch(w){t("register %s store failed: %o",Tr,w)}try{let w=await ie.subscribeList(Tr,A);nt.set(Tr,w)}catch(w){t("re-subscribe %s failed: %o",Tr,w),Ze(w,"worker")}}let nt=new Map,ut=null,P=null,ye=null,xe=null,$t=null;async function dr(){xe=null,$e.clear(),$t=null,oe.clear(),ut=null,P=null,Ye.clear(),nt.clear(),O.board+=1,O.worker+=1,jt();let h=Ue.getState().workspace.current?.path;if(h)try{await fe.send("set-workspace",{path:h})}catch(A){t("workspace restore after reconnect failed: %o",A);return}gt();let u=Ue.getState();Oe(u.view==="board"),z(u.view==="worker"),D(u.view==="monitor"),y(u.view==="board"||u.view==="worker"||!!u.selected_id)}async function xt(){t("clearing all subscriptions for workspace switch"),dt(),X(),S(),me.clear(),Ke(),ae(),je(),gt(),Le();let h=Ue.getState();if(h.selected_id)try{ke.unregister(`detail:${h.selected_id}`)}catch{}let u=Ue.getState();Oe(u.view==="board"),z(u.view==="worker"),D(u.view==="monitor"),y(u.view==="board"||u.view==="worker"||!!u.selected_id),u.selected_id&&ot(u.selected_id)}async function Et(h){t("requesting workspace switch to %s",h),ce=!0;try{let u=await fe.send("set-workspace",{path:h});t("workspace switch result: %o",u),u&&u.workspace&&(Ue.setState({workspace:{current:{path:u.workspace.root_dir,database:u.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",h),u.changed&&(await xt(),re("Switched to "+Bt(h),"success",2e3)))}catch(u){throw t("workspace switch failed: %o",u),re("Failed to switch workspace","error",3e3),u}finally{ce=!1}}async function ur(h){t("requesting workspace git pull for %s",h);try{let u=await fe.send("git-pull-workspace",{});t("workspace git pull result: %o",u);let A=u?.status;if(A==="up_to_date"){re("Already up to date","success",2e3);return}if(A==="stash_pop_conflict"){re("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}re("Git pulled "+Bt(h),"success",2e3)}catch(u){t("workspace git pull failed: %o",u);let A=u?.code,w=u?.message;if(A==="rebase_conflict"){re("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(A==="rebase_conflict_abort_failed"){re("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(A==="busy"){re("Git pull skipped: another operation is running","warning",3e3);return}let G=w?`: ${w}`:"";throw re(`Git pull failed${G}`,"error",3e3),u}}async function rr(h,u){t("setting workspace visibility %s \u2192 %s",h,String(u));try{await fe.send("set-workspace-visibility",{path:h,visible:u}),await nr()}catch(A){t("workspace visibility update failed: %o",A),re("Failed to update project visibility","error",3e3)}}async function nr(){try{let h=await fe.send("list-workspaces",{});if(t("workspaces loaded: %o",h),h&&Array.isArray(h.workspaces)){let u=h.workspaces.map(ve=>({path:ve.path,database:ve.database,pid:ve.pid,version:ve.version})),A=h.current?{path:h.current.root_dir,database:h.current.db_path}:null,w=Array.isArray(h.hidden)?h.hidden.filter(ve=>typeof ve=="string"):[];Ue.setState({workspace:{current:A,available:u,hidden:w}});let G=window.localStorage.getItem("beads-ui.workspace");G&&(!u.some(we=>we.path===G)||w.includes(G)?window.localStorage.removeItem("beads-ui.workspace"):A&&G!==A.path&&(t("restoring saved workspace preference: %s",G),await Et(G)))}}catch(h){t("failed to load workspaces: %o",h)}}fe.on("workspace-changed",h=>{t("workspace-changed event: %o",h),h&&h.root_dir&&(Ue.setState({workspace:{current:{path:h.root_dir,database:h.db_path}}}),nr(),xt())});let yt=!1;if(typeof fe.onConnection=="function"){let h=u=>{t("ws state %s",u),u==="reconnecting"||u==="closed"?(yt=!0,re("Connection lost. Reconnecting\u2026","error",4e3)):u==="open"&&yt&&(yt=!1,re("Reconnected","success",2200),Wm(Ue,(A,w)=>{t(`${A}: %o`,w)}),dr())};fe.onConnection(h)}let pr="board";try{let h=window.localStorage.getItem("beads-ui.view");(h==="board"||h==="worker"||h==="monitor")&&(pr=h)}catch(h){t("view parse error: %o",h)}let Ue=Mi({config:Um(),view:pr});fe.on("worker-queue-snapshot",h=>{let u=h;if(!u||!u.queue)return;let A=Ue.getState().workspace.current?.path;if(typeof A=="string"&&A.length>0&&u.root_dir!==A){t("dropping worker-queue snapshot for %s",String(u.root_dir));return}try{me.set(u.queue)}catch{}}),fe.on("worker-parallel-analysis-snapshot",h=>{let u=h;if(!u)return;let A=Ue.getState().workspace.current?.path;if(!(typeof A=="string"&&A.length>0&&typeof u.root_dir=="string"&&u.root_dir!==A))try{J.set({settings:u.settings,job:u.job??null,runs:Array.isArray(u.runs)?u.runs:[],last_good:u.last_good??null})}catch{}});let Ot=Pi(Ue);Ot.start();let _=new Set(["get-comments","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","get-session-defaults","set-session-defaults"]),v=async(h,u)=>{try{return await Re(h,u)}catch(A){if(_.has(h))throw A;return[]}};n&&Uc(n,Ue,Ot);let T=document.getElementById("workspace-picker");T&&wd(T,Ue,Et,ur,rr);let m=Gc(e,(h,u)=>Re(h,u));try{let h=document.getElementById("new-issue-btn");h&&h.addEventListener("click",()=>m.open())}catch{}let I=Zc(e,{policyStore:$e,queueStore:me,implPresetStore:oe,transport:(h,u)=>Re(h,u),onOpenChange:h=>{de=h,Se()},labelOptions:()=>{let h=new Set;for(let[u]of Aa)for(let A of ke.snapshotFor(u)||[]){let w=A.labels;if(Array.isArray(w))for(let G of w)typeof G=="string"&&G.length>0&&h.add(G)}return Array.from(h).sort()}});try{let h=document.getElementById("display-settings-btn");h&&(h.setAttribute("aria-label","\uC124\uC815"),h.setAttribute("title","\uC124\uC815"),h.addEventListener("click",()=>I.open()))}catch{}let ee=Vi(o,{gotoIssue:h=>Ot.gotoIssue(h),issueStores:ke,transport:v,workerQueueStore:me,uiOrderStore:Ae,displayPolicyStore:$e,closedRange:qe,onClosedRangeChange:h=>{De(h)},onNewIssue:()=>m.open()}),le=$a(a,{transport:v,issueStores:ke,queueStore:me,analysisStore:J,sessionLogStore:ge,uiOrderStore:Ae,gotoIssue:h=>Ue.setState({selected_id:h}),getWorkspacePath:()=>Ue.getState().workspace.current?.path,doneRange:tt,onDoneRangeChange:h=>{et(h)}}),Ce=Bc(i,{transport:v,pipelineStore:H,execPresetStore:oe,gotoIssue:h=>Ot.gotoIssue(h),getWorkspacePath:()=>Ue.getState().workspace.current?.path,switchWorkspace:h=>Et(h)}),Ee=uc(l,{issueStores:ke,transport:v,queueStore:me,execPresetStore:oe,sessionLogStore:ge,getWorkspacePath:()=>Ue.getState().workspace.current?.path,onNavigate:h=>{Ue.getState().view==="worker"?Ue.setState({selected_id:h}):Ot.gotoIssue(h)},onClose:()=>{let h=Ue.getState();Ue.setState({selected_id:null});try{Ot.gotoView(h.view==="worker"||h.view==="monitor"?h.view:"board")}catch{}},onOpenExecPresets:()=>{I.open("session")}}),at=Ue.getState().selected_id;at&&(l.hidden=!1,Ee.load(at),ot(at)),Ue.subscribe(h=>{let u=h.selected_id;u?(l.hidden=!1,Ee.load(u),ce||ot(u)):(Ee.clear(),l.hidden=!0,Le())});let lt=h=>{o.hidden=h.view!=="board",a.hidden=h.view!=="worker",i.hidden=h.view!=="monitor",Oe(h.view==="board"),z(h.view==="worker"),D(h.view==="monitor"),y(h.view==="board"||h.view==="worker"||de||!!h.selected_id),!h.selected_id&&h.view==="board"&&ee.load(),h.view==="worker"&&le.load(),h.view==="monitor"?Ce.load():Ce.pause(),window.localStorage.setItem("beads-ui.view",h.view)};Ue.subscribe(lt),lt(Ue.getState()),ae(),gt(),jt(),nr().finally(()=>{K=!0,Y()}),window.addEventListener("keydown",h=>{let u=h.ctrlKey||h.metaKey,A=String(h.key||"").toLowerCase(),w=h.target,G=w&&w.tagName?String(w.tagName).toLowerCase():"",ve=G==="input"||G==="textarea"||G==="select"||w&&typeof w.isContentEditable=="boolean"&&w.isContentEditable;u&&A==="n"&&(ve||(h.preventDefault(),m.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let e=document.getElementById("theme-switch");e&&e.addEventListener("change",()=>{let r=e.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let t=document.getElementById("app");t&&Hm(t)});export{Hm as bootstrap,Um as readBootstrapConfig,Wm as refreshConfigSnapshot};
