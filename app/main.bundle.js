...
`+r.join(`
`),O=this.blockquote($);o[o.length-1]=O,n=n.substring(0,n.length-h.raw.length)+O.raw,s=s.substring(0,s.length-h.text.length)+O.text;break}else if(_?.type==="list"){let h=_,$=h.raw+`
`+r.join(`
`),O=this.list($);o[o.length-1]=O,n=n.substring(0,n.length-_.raw.length)+O.raw,s=s.substring(0,s.length-h.raw.length)+O.raw,r=$.substring(o.at(-1).raw.length).split(`
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+Er(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},en=new q_;function bt(e,t){return en.parse(e,t)}bt.options=bt.setOptions=function(e){return en.setOptions(e),bt.defaults=en.defaults,mc(bt.defaults),bt};bt.getDefaults=va;bt.defaults=tn;bt.use=function(...e){return en.use(...e),bt.defaults=en.defaults,mc(bt.defaults),bt};bt.walkTokens=function(e,t){return en.walkTokens(e,t)};bt.parseInline=en.parseInline;bt.Parser=mr;bt.parser=mr.parse;bt.Renderer=ro;bt.TextRenderer=Ta;bt.Lexer=_r;bt.lexer=_r.lex;bt.Tokenizer=to;bt.Hooks=Jn;bt.parse=bt;var Wy=bt.options,zy=bt.setOptions,Hy=bt.use,Gy=bt.walkTokens,Vy=bt.parseInline;var Ky=mr.parse,Yy=_r.lex;function Mr(e){let t=bt.parse(e),r=ic.sanitize(t);return lc(r)}function Tr(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      >
        ...
        ${Ee?l`<pre class="sv__think-expand">${Z.text}</pre>`:""}
      </div>`}if(Z.kind==="error")return l`<div class="sv__error">⛔ ${Z.text}</div>`;if(Z.kind==="blocker")return l`<div class="sv__error">⛔ ${Z.text}</div>`;if(Z.kind==="tool"){let Ee=_.has(Y),Ve=Z.tool==="Bash"?em(Z.command):0,ze=Z.tool==="Bash"?Ve>1?ao(Z.command):Z.command:Z.path||Z.command||"";return l`<div
      ...
      >
        ...
        ${Ee?l`<pre class="sv__tool-expand">${ie(Z)}</pre>`:""}
      </div>`}return l`<div class="sv__as">${Mr(Z.text||"")}</div>`}function ie(Y){let Z=[];if(Y.tool==="Bash"&&typeof Y.command=="string"&&Y.command.length>0)Z.push(Y.command);else if(Y.input!==void 0)try{Z.push(`input: ${JSON.stringify(Y.input,null,2)}`)}catch{}return typeof Y.output=="string"&&Y.output.length>0&&Z.push(`output:
${Y.output}`),Z.join(`

`)}function se(){if(!o)return l``;let Y=te(),Z=(a?[d.agent_type,d.model,d.effort]:[d.runner,d.model,d.effort]).filter(Boolean).join(" \xB7 "),Ee=d.session_id||"",Ve=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${p?"ON":"OFF"}`,ze=_e(),fe=ze?am(re(),Date.now()):"",R=ze?oe(Y):null,Q=ze?Ae(Y):null,ae=om(Y);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
      ...
      ${a||u?"":j()}
      <div class="sv__body">
        ${Y.length===0?l`<div class="sv__empty">세션 로그 없음</div>`:Le(Y).map(J=>J.kind==="subagent"?Ce(J):J.kind==="group"?Se(J):D(J.idx,J.line))}
      </div>
    ...
    </div>`}function Se(Y){return l`<div
      class="sv__group"
      role="button"
      tabindex="0"
      title="펼치기"
    ...
    >
    ...
    </div>`}function Ce(Y){let Z=h.has(Y.idx),Ee=Y.header?Y.header.line:null,Ve=Ee?Ee.is_error===!0?"\u2717":typeof Ee.result=="string"?"\u2713":"\u27F3":"",ze=Ee&&Ee.command?Ee.command:"";return l`<div class="sv__sub${Z?" sv__sub--open":""}">
      <div
        class="sv__sub-head"
        role="button"
        tabindex="0"
      ...
      ${Z?l`<div class="sv__sub-body">
            ${Te(Y.lines).map(fe=>fe.kind==="group"?Se(fe):D(fe.idx,fe.line))}
          </div>`:""}
    </div>`}function C(Y){h.add(Y),V()}function V(){Ke(se(),e),pe(),p&&$e()}function $e(){let Y=e.querySelector(".sv__body");Y&&(Y.scrollTop=Y.scrollHeight)}function Ne(Y){_.has(Y)?_.delete(Y):_.add(Y),V()}function Pe(){p=!p,V()}function He(Y){tr(Y).then(Z=>{Z?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function Ze(Y){!o||!Y||(d={...d,...Y},V())}function ot(Y){let Z=Y.target;if(!Z||!Z.classList||!Z.classList.contains("sv__body"))return;!(Z.scrollHeight-Z.scrollTop-Z.clientHeight<=4)&&p&&(p=!1,V())}e.addEventListener("scroll",ot,!0);function at(Y){let Z=Y&&Y.attempt_id;if(!Z)return;let Ee=i;o=Z,a=typeof Y.launch_id=="string"&&Y.launch_id.length>0?Y.launch_id:null,i=a?`session-log:${o}:${a}`:`session-log:${o}`,r&&Ee&&Ee!==i&&Promise.resolve(r("unsubscribe-session-log",{id:Ee})).catch(()=>{}),c=typeof Y.root_dir=="string"&&Y.root_dir.length>0?Y.root_dir:null,d=Y.meta||{},u=Y.hide_prompt===!0,p=!0,_.clear(),h.clear(),L(),!$&&n&&($=n.subscribe(V)),r&&Promise.resolve(r("subscribe-session-log",{id:i,attempt_id:o,...a?{launch_id:a}:{},...c?{root_dir:c}:{}})).catch(()=>{}),V()}function nt(){let Y=i;o=null,a=null,i=null,c=null,u=!1,_.clear(),h.clear(),L(),be(),r&&Y&&Promise.resolve(r("unsubscribe-session-log",{id:Y})).catch(()=>{}),Ke(l``,e),s&&s()}return{open:at,updateMeta:Ze,close:nt,isOpen(){return o!==null},destroy(){be(),$&&($(),$=null),e.removeEventListener("scroll",ot,!0),o=null,a=null,i=null,c=null,u=!1,Ke(l``,e)}}}function io(e){let t=e&&typeof e=="object"?e:{},r=t.metadata&&typeof t.metadata=="object"?t.metadata:{},n=Ma(t.spec_id),s=Ma(r.spec_id);return n?{path:n,source:"native",conflict:s.length>0&&s!==n}:s?{path:s,source:"metadata",conflict:!1}:{path:"",source:"none",conflict:!1}}function Ma(e){return typeof e=="string"?e.trim():""}function Rc(e){let t=io(e);if(t.path)return t;let r=Ma(im(e).spec_path);return r?{path:r,source:"draft",conflict:!1}:t}function im(e){let t=e&&typeof e=="object"?e:{};return t.metadata&&typeof t.metadata=="object"?t.metadata:{}}function lm(e){return["plan_review","plan_approval","plan_check"].some(t=>{let r=e[t];return typeof r=="string"&&r.trim().length>0})}function cm(e){let t=e&&e.metadata||{},r=Rc(e),n=[];return r.path&&n.push({kind:"spec",path:r.path,missing_state:r.source==="draft"?"spec_draft":null}),typeof t.plan_path=="string"&&t.plan_path.trim().length>0&&n.push({kind:"plan",path:t.plan_path.trim(),missing_state:lm(t)?null:"plan_pending"}),n}function Ic(e,t){let r=cm(e);return l`
...
`).trim()}}var Oc=20;function Lc(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function fm(e){return e.length>Oc?`${e.slice(0,Oc)}\u2026`:e}function _m(e,t,r,n){let s=`${t.lane} ${fm(t.identifier)}`;return l`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${vm.map(p=>{let _=p.receipt&&typeof t[p.receipt]=="string"?String(t[p.receipt]):"",h=n[p.id],$=_.length>0||h?.fill==="full",O=!$&&h?.fill==="dim",B=h?.stale===!0;return l`<span
          class=${`detail-summary__gate${$?" detail-summary__gate--on":""}${O?" detail-summary__gate--current":""}${B?" detail-summary__gate--stale":""}`}
          data-gate=${p.id}
        >
...
${i}</pre
    ...
    `:l``}function p(){Ke(d(),e)}async function _(O,B={}){s=O,o="loading",a="",i=null,c="",p();let K=r?r():"";if(!K){o="error",c="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",c="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let H="/api/doc?workspace="+encodeURIComponent(K)+"&path="+encodeURIComponent(O);try{let P=await n(H),q=await P.json().catch(()=>({}));if(!P.ok||!q||q.ok!==!0){if(q?.error==="not_found"&&B.missing_state==="plan_pending"){o="pending",c="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",p();return}o="error",c="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(q&&q.error||P.status)+")",p();return}let L=Om(String(q.content||""));i=L.front,a=L.body,o="ready",p()}catch{o="error",c="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function h(){s=null,Ke(l``,e)}function $(){document.removeEventListener("keydown",u),h()}return{open:_,close:h,destroy:$}}var Lm=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],lu="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",ho=[{role:"implementation",provider:"codex"},{role:"review-consult",provider:"codex"},{role:"subagent",provider:"claude"}],Mm=["running","done","failed","interrupted"],Pm={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function Dm(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function Nm(e){let t=Wt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
  ...
  >
    ...
    ${a?l`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function Wm(e,t){return e.role===t.role&&(e.model===null||t.model===void 0||e.model===t.model)&&e.session_id===t.session_id}function zm(e,t,r){let n=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let d of o){let p=jm(d);!p||s.has(p.launch_id)||(s.add(p.launch_id),n.push(p))}n.sort((d,p)=>(d.started_at||0)-(p.started_at||0));let a={};for(let{role:d,provider:p}of ho){let _=t?t.roles[d]?.[p]:null;a[d]=_?[..._.legs]:[]}let i=ho.flatMap(({role:d})=>a[d]),c=new Set,u=[];for(let{role:d,provider:p}of ho){for(let _ of n.filter(h=>h.role===d&&h.provider===p)){let h=i.find($=>$.receipt_id===_.launch_id)||null;h&&!Wm(_,h)||(h&&c.add(h.receipt_id),u.push(Um(_,h,e.attempt_id,r)))}for(let _ of a[d])c.has(_.receipt_id)||u.push(Bm(d,p,_))}return u}function Hm(e,t){let r=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,n=[...Lm,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return l`<div class="detail-session__usage-detail">
  ...
  `}function Km(e){let t=En(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?Tr("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var Ym=["open","in_progress","deferred","resolved","closed"],Zm=[0,1,2,3,4];function du(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,c=t.sessionLogStore,u=null,d=null,p={},_="",h=!1,$=[],O=!1,B={},K={claude:null,codex:null},H=null,P=0,q=!1,L=!1,U="",b="",j="";function te(){q=!1,L=!1,U="",b="",j=""}function re(){K={claude:null,codex:null},H=null,P+=1}async function _e(A){try{let X=await fetch(A);if(!X.ok)return null;let N=await X.json();if(!N||typeof N!="object"||!Array.isArray(N.accounts))return null;let Oe=N.accounts.filter(dt=>dt!==null&&typeof dt=="object"&&!Array.isArray(dt));return{accounts:Oe,active:Oe.find(dt=>dt.active===!0)||null}}catch{return null}}async function pe(A){H=A;let X=++P,[N,Oe]=await Promise.all([_e("/api/claude-usage"),_e("/api/codex-usage")]);X!==P||A!==u||(K={claude:N,codex:Oe},xe())}let be=[],Te=null,Le=null,ne=!1,oe="",Ae=!1,D=0,ie=new Set;function se(){be=[],Te=null,Le=null,ne=!1,oe="",Ae=!1,D+=1,ie.clear()}async function Se(A){if(!s)return;let X=++D;try{let N=await Promise.resolve(s("get-comments",{id:A}));if(X!==D||A!==u)return;be=Array.isArray(N)?N:[],ne=!1}catch{if(X!==D||A!==u)return;ne=!0}xe()}function Ce(){if(!s||!u)return;let A=d&&typeof d.comment_count=="number"?d.comment_count:null;if(Te!==u){Te=u,Le=A,Se(u);return}A!==null&&A!==Le&&(Le=A,Se(u))}function C(A){ie.has(A)?ie.delete(A):ie.add(A),xe()}function V(A){let X=oe.trim().length===0;oe=A,X!==(A.trim().length===0)&&xe()}async function $e(){let A=oe.trim();if(!s||!u||A.length===0||Ae)return;let X=u;Ae=!0,xe();let N=!1;try{let Oe=await Promise.resolve(s("add-comment",{id:X,text:A}));Array.isArray(Oe)&&Oe.length>0&&(N=!0,X===u&&(be=Oe,ne=!1,oe="",Le=Oe.length))}catch{N=!1}N||me("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),X===u&&(Ae=!1),xe()}let Ne={onToggle:C,onDraftInput:V,onSubmit:$e},Pe=document.createElement("div");Pe.className="md-viewer-root",document.body.appendChild(Pe);let He=au(Pe,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),Ze=document.createElement("div");Ze.className="session-log-root",document.body.appendChild(Ze);let ot=Tn(Ze,{transport:s?(A,X)=>Promise.resolve(s(A,X)):void 0,sessionLogStore:c}),at=!1,nt=!1,Y=!1,Z=null,Ee=null,Ve=0;function ze(A){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${A}`}function fe(){at=!1,nt=!1,Y=!1,Z=null,Ee=null,Ve+=1}async function R(A){if(!s)return;let X=++Ve;nt=!0,Y=!1,xe();try{let N=await Promise.resolve(s("get-bead-prompt",{bead_id:A}));if(X!==Ve)return;!N||typeof N!="object"||Array.isArray(N)?Y=!0:(Z=N,Ee=ze(A))}catch{X===Ve&&(Y=!0)}finally{X===Ve&&(nt=!1,xe())}}function Q(){if(at=!at,at&&u&&Ee!==ze(u)){Z=null,R(u);return}xe()}function ae(){if(!a||!u)return[];let A=a.get();return(A&&A.attempts?Object.values(A.attempts):[]).filter(N=>N&&N.bead_id===u).sort((N,Oe)=>(Oe.started_at||0)-(N.started_at||0)).map(N=>({attempt_id:N.attempt_id,bead_id:N.bead_id,status:N.status,started_at:typeof N.started_at=="number"?N.started_at:null,runner:N.runner||null,model:N.model||null,effort:N.effort||N.observed_effort||null,speed:N.speed||null,session_id:N.session_id||null,resumed_from:N.resumed_from||null,continuation_mode:N.continuation_mode||null,dismissed_at:typeof N.dismissed_at=="number"?N.dismissed_at:null,cause:typeof N.cause=="string"?N.cause:null,cause_detail:N.cause_detail||null,exec_default_preset_id:typeof N.exec_default_preset_id=="string"?N.exec_default_preset_id:null,exec_default_preset_revision:typeof N.exec_default_preset_revision=="number"?N.exec_default_preset_revision:null,exec_values:N.exec_values&&typeof N.exec_values=="object"?N.exec_values:null,usage:N.usage||null,usage_legs:Array.isArray(N.usage_legs)?N.usage_legs:[],delegation_sessions:Array.isArray(N.delegation_sessions)?N.delegation_sessions:[]}))}function J(){if(!a||!u)return null;let A=a.get();return ir(A&&A.attempts||{},u)}let qe=new Set;function Qe(A){qe.has(A)?qe.delete(A):qe.add(A),xe()}function it(A){let X=a?a.get():null,N=X&&X.attempts?X.attempts[A]:null;ot.open({attempt_id:A,meta:N?{runner:N.runner||void 0,model:N.model||void 0,effort:N.effort||void 0,status:N.status||void 0,session_id:N.session_id||void 0}:{}})}function Xe(A,X){let N=a?a.get():null,Oe=N&&N.attempts?N.attempts[A]:null,st=(Oe&&Array.isArray(Oe.delegation_sessions)?Oe.delegation_sessions:[]).find(tt=>tt&&typeof tt=="object"&&tt.launch_id===X);st&&ot.open({attempt_id:A,launch_id:X,meta:{runner:st.provider==="claude"?"claude":"codex",role:st.role,...typeof st.agent_type=="string"?{agent_type:st.agent_type}:{},model:st.model,effort:st.effort,session_id:st.session_id,status:st.status}})}async function pt(A){if(!s||!A)return;let X=await xn();if(X===null)return;let N=()=>{let tt=a?a.get():null;return tt&&typeof tt.revision=="number"?tt.revision:0},Oe=async(tt={},rt=N())=>await s("worker-attempt-resume",{attempt_id:A,expected_revision:rt,...X!==""?{instructions:X}:{},...tt}),dt=tt=>{tt?.queue&&a?.set&&a.set(tt.queue)},st=await Oe();if(dt(st),st&&st.conflict){let tt=st.queue&&typeof st.queue.revision=="number"?st.queue.revision:N();st=await Oe({},tt),dt(st)}st=await kr(st,(tt,rt)=>Oe({continuation:tt,decision_token:rt}),{onResult:dt,refresh:()=>Oe()}),st&&st.resumed===!1&&!st.conflict&&st.reason&&me(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${st.reason}`,"error",2400)}let yt={onOpen:it,onOpenDelegation:Xe,onResume:pt,onToggleUsage:Qe};function gt(){let A=a?a.get():null,X={...B};for(let N of["orchestration_model","orchestration_effort","orchestration_speed"]){let Oe=A&&A[N];typeof Oe=="string"&&(X[N]=Oe)}return X}async function ft(){if(s){try{let A=await Promise.resolve(s("get-session-defaults",{}));B=A&&A.values&&typeof A.values=="object"?A.values:{}}catch{B={}}xe()}}function kt(){let A=a?a.get():null;return A&&A.runner_catalog||null}function We(){let A=a?a.get():null;return A&&typeof A.execution_defaults=="object"?A.execution_defaults:null}function Ye(){let A=d?.metadata&&typeof d.metadata=="object"?d.metadata:{},N=Qt({pin:{...A,...p},global:gt(),execution_defaults:We(),runner_catalog:kt(),route:typeof A.route=="string"?A.route:null}).orchestration_model.value||"";return gr(kt(),N)}function Ue(){let A=i?i.get():null;return!A||typeof A.revision!="number"?null:{revision:A.revision,presets:Array.isArray(A.presets)?A.presets:[]}}function ut(A){return A?.compatible===!1}function At(A){i&&A&&typeof A.revision=="number"&&Array.isArray(A.presets)&&i.set({revision:A.revision,presets:A.presets})}async function S(){let A=Ue(),X=A?.presets.find(N=>N.id===_);if(!(!s||!u||!A||!X||ut(X)||h)){h=!0,$=[],xe();try{let N=await Promise.resolve(s("apply-impl-preset",Gc(u,X.id,A.revision)));if(N&&N.conflict){At(N),me("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let Oe=N&&Array.isArray(N.issue)?N.issue[0]:N?.issue;if(N&&N.applied&&Oe&&typeof Oe=="object"){d=Oe,$=Array.isArray(N.skipped_orchestration_keys)?N.skipped_orchestration_keys.filter(dt=>typeof dt=="string"):[];for(let dt of ru)delete p[dt];me($.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}N&&N.error==="bd_readback_failed"?me("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):me("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(N){N&&typeof N=="object"&&N.code==="bd_readback_failed"?me("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):me("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{h=!1,xe()}}}let M=null;r&&r.subscribe&&(M=r.subscribe(()=>F()));let de=null;a&&typeof a.subscribe=="function"&&(de=a.subscribe(()=>{u&&xe()}));let k=null;i&&typeof i.subscribe=="function"&&(k=i.subscribe(()=>{u&&xe()}));function E(A){A.key==="Escape"&&u&&(A.preventDefault(),n())}document.addEventListener("keydown",E);function F(){if(u){if(r&&typeof r.snapshotFor=="function"){let A=r.snapshotFor("detail:"+u)||[];d=A.find(N=>N&&N.id===u)||A[0]||d}Ce(),xe()}}function ee(A){tr(A).then(X=>{X?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function ke(A){A.preventDefault(),A.stopPropagation(),u&&ee(u)}function ve(A,X){A.preventDefault(),A.stopPropagation(),ee(X)}function Me(A,X,N){A.preventDefault(),A.stopPropagation(),He.open(X,{missing_state:N})}function De(A,X){p[A]=X,xe(),!(!s||!u)&&Promise.resolve(s("update-exec-settings",Hc(u,A,X.length===0?null:X))).catch(()=>{me("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function Rt(A,X){let N=d||{},Oe=N.metadata&&typeof N.metadata=="object"?N.metadata:{},dt={};for(let rt of["impl_runtime","impl_model","impl_effort"])dt[rt]=Object.hasOwn(p,rt)?p[rt]:typeof Oe[rt]=="string"?Oe[rt]:"";dt[A]=X;let st=ou(dt,kt(),Ye()),tt={};for(let rt of["impl_runtime","impl_model","impl_effort"])tt[rt]=p[rt],p[rt]=st[rt]||"";xe(),!(!s||!u)&&Promise.resolve(s("update-impl-target",{id:u,...st,orchestration_runtime:Ye()})).then(rt=>{let Ot=Array.isArray(rt)?rt[0]:rt;if(!Ot||typeof Ot!="object"||!Ot.id)throw new Error("implementation target readback failed");d=Ot;for(let Jt of["impl_runtime","impl_model","impl_effort"])delete p[Jt];xe()}).catch(()=>{for(let rt of["impl_runtime","impl_model","impl_effort"])tt[rt]===void 0?delete p[rt]:p[rt]=tt[rt];xe(),me("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function lt(A,X,N){if(!s||!u)return!1;try{let Oe=await Promise.resolve(s(A,X)),dt=Array.isArray(Oe)?Oe[0]:Oe;return dt&&typeof dt=="object"&&dt.id?(d=dt,!0):(me(N,"error"),!1)}catch{return me(N,"error"),!1}}function Je(A){setTimeout(()=>{try{let X=e.querySelector(A);X&&typeof X.focus=="function"&&X.focus()}catch{}},0)}function Dt(){q=!0,U=d&&d.title||"",xe(),Je('.detail-edit__input[data-edit="title"]')}function Ut(A){U=A.target.value}function Fe(){q=!1,U="",xe()}function Ft(){lt("edit-text",{id:u,field:"title",value:U},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(X=>{X&&(q=!1,U=""),xe()})}function It(){L=!0,b=d&&d.description||"",xe(),Je('.detail-edit__textarea[data-edit="description"]')}function zt(A){b=A.target.value}function v(){L=!1,b="",xe()}function w(){lt("edit-text",{id:u,field:"description",value:b},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(X=>{X&&(L=!1,b=""),xe()})}function I(A,X,N,Oe){if(A.key==="Escape"){A.stopPropagation(),N();return}A.key==="Enter"&&(!Oe||A.ctrlKey||A.metaKey)&&(A.preventDefault(),X())}function W(A){let X=A.target.value;lt("update-status",{id:u,status:X},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>xe())}function ye(A){let X=Number(A.target.value);lt("update-priority",{id:u,priority:X},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>xe())}function we(A){j=A.target.value}function he(){let A=j.trim();A.length!==0&&lt("label-add",{id:u,label:A},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(X=>{X&&(j=""),xe()})}function et(A){if(A.key==="Escape"){A.stopPropagation(),j="",xe();return}A.key==="Enter"&&(A.preventDefault(),he())}function Ie(A){lt("label-remove",{id:u,label:A},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>xe())}let T={onCopyPath:ve,onOpenDoc:Me};function le(A){return typeof A=="string"?A:A&&typeof A=="object"?String(A.id||A.to||A.issue_id||A.depends_on||""):""}function Re(A){switch(A&&typeof A=="object"?String(A.dependency_type||A.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function _t(A){let N=(Array.isArray(A.dependencies)?A.dependencies:[]).map(Oe=>({id:le(Oe),icon:Re(Oe)})).filter(Oe=>Oe.id.length>0);return l`
      <div class="detail-section-label">의존성</div>
      ${N.length===0?l`<div class="detail-empty">의존성 없음</div>`:l`<div class="detail-deps">
            ${N.map(Oe=>o?l`<button
                    type="button"
    ...
    `}function Mt(A){let X=A.metadata||{},N=A.workflow||{},Oe=N.stages||{},dt=Oe.spec&&Oe.spec.stale,st=Oe.impl&&Oe.impl.stale,tt=Oe.plan||null,rt=N.route_source==="derived",Ot=N.route||X.route||"\u2014";return l`
      ...
      ${N.route!=="quick_fix"||Object.hasOwn(X,"spec_review")?l`<div class="detail-kv">
            <span class="detail-kv__k">spec_review</span>
            <span class="detail-kv__v"
              >${X.spec_review||"\uC5C6\uC74C"}${dt?" \xB7 stale":""}</span
            >
          </div>`:""}
      ${N.route==="full_plan"?l`<div class="detail-kv">
      ...
      ${N.route!=="quick_fix"||Object.hasOwn(X,"impl_review")?l`<div class="detail-kv">
            <span class="detail-kv__k">impl_review</span>
            <span class="detail-kv__v"
              >${X.impl_review||"\uC5C6\uC74C"}${st?" \xB7 stale":""}</span
            >
          </div>`:""}
      ${N.planned_execution?l`<div class="detail-kv">
              <span class="detail-kv__k">planned_execution</span>
              <span class="detail-kv__v">${N.planned_execution.kind}</span>
            </div>
            ${N.planned_execution.kind==="main"?l`<div class="detail-kv">
                  <span class="detail-kv__k">planned_execution_reason</span>
                  <span class="detail-kv__v detail-kv__v--wrap"
                    >${N.planned_execution.reason}</span
                  >
                </div>`:""}`:""}
      ${N.exec_receipt?l`<div class="detail-kv">
            <span class="detail-kv__k">exec_receipt</span>
            <span class="detail-kv__v detail-kv__v--wrap"
              >${Xr(N.exec_receipt)}</span
            >
          </div>`:""}
      ${N.impl_entry?l`<div class="detail-kv">
    ...
    `}let vt={route:["quick_fix","spec_backed","full_plan"]};async function Pt(A,X){let N=X.target.value;if(A==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&N!=="full_plan"&&!window.confirm(`full_plan \u2192 ${N||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){xe();return}await lt("update-workflow-meta",{id:u,key:A,value:N},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),xe()}function f(A){let X=A.metadata||{};return l` ${((Oe,dt)=>{let st=vt[Oe],tt=typeof X[Oe]=="string"?X[Oe]:"";return l`<div class="detail-kv">
      ...
      </div>`})("route","(unset)")} `}function x(A,X){return q?l`
      ...
      <div class="detail-title-row">
        ...
        ${Wt(X).map(N=>l`<span class="detail-usage-total" title=${N.tooltip}
              >${N.label}</span
            >`)}
        <button
          type="button"
    ...
    `}function G(A){let X=Ht(A.created_at),N=Ht(A.updated_at);return!X&&!N?l``:l`
      ${X?l`<div class="detail-kv">
            <span class="detail-kv__k">생성</span>
            <span class="detail-kv__v detail-kv__v--time">${X}</span>
          </div>`:""}
      ${N?l`<div class="detail-kv">
    ...
    `}function m(A,X){return l`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${W}
        >
          ${Ym.map(N=>l`<option value=${N} ?selected=${N===A}>${N}</option>`)}
        </select>
      </div>
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${ye}
        >
          ${Zm.map(N=>l`<option value=${String(N)} ?selected=${N===X}>
                P${N}
              </option>`)}
        </select>
      </div>
    ...
    `}function ce(A){let X=Array.isArray(A.labels)?A.labels:[];return l`
      ...
      <div class="detail-labels">
        ${X.map(N=>l`<span class="detail-label-chip"
              >${N}<button
                type="button"
    ...
    `}function je(){if(!u)return l``;let A=d||{},X=String(A.id||u),N=A.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",Oe=J(),dt=A.status||"open",st=typeof A.priority=="number"?Math.max(0,Math.min(4,A.priority)):"",tt=A.description||"",rt={...A,metadata:{...A.metadata||{},...p}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${x(N,Oe)}
          ${Kc(rt)}
          ${Vc({metadata:rt.metadata,workspace_values:gt(),catalog:kt(),execution_defaults:We(),expanded:O,presets:Ue()?.presets||[],preset_id:_,preset_busy:h,skipped_orchestration_keys:$},{onToggle:Ot=>{O=Ot,xe()},onEdit:(Ot,Jt)=>{if(Ot==="impl_runtime"||Ot==="impl_model"||Ot==="impl_effort"){Rt(Ot,Jt??"");return}De(Ot,Jt??"")},onPresetSelect:Ot=>{_=Ot,$=[],xe()},onPresetApply:()=>{S()}})}
          ${tu({md:rt.metadata,catalog:K,handlers:{onExecChange:De}})}
          ${m(dt,st)} ${G(A)}
          ${y(tt)}
          ...
          ${Mt(A)} ${f(A)}
          ${Ic(A,T)}
          ${uu({expanded:at,loading:nt,error:Y,data:Z},{onToggle:Q})}
          ${cu(ae(),yt,{total:Oe,expanded:qe})}
        </div>
      </div>
    `}function xe(){Ke(je(),e)}return{load(A){A!==u&&(p={},_="",$=[],O=!1,te(),se(),fe(),re()),u=A,d=null,F(),ft(),H!==A&&pe(A)},clear(){u=null,d=null,p={},_="",h=!1,$=[],O=!1,te(),se(),fe(),re(),He.close(),ot.close(),Ke(l``,e)},destroy(){M&&(M(),M=null),de&&(de(),de=null),k&&(k(),k=null),document.removeEventListener("keydown",E),He.destroy(),Pe.parentNode&&Pe.parentNode.removeChild(Pe),ot.destroy(),Ze.parentNode&&Ze.parentNode.removeChild(Ze),u=null,d=null,re(),_="",h=!1,$=[],se(),fe(),Ke(l``,e)}}}function pu(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
...
\uC774\uC288 \uD540 \u2014 \uB808\uD3EC \uAE30\uBCF8\uAC12\uACFC \uB2E4\uB984`:"";return l`${e.orchestration?l`<span
  ...
  >
    ...
    >${e.id}</span
  >`,$=l`<span class="worker-mini__title">${e.title}</span>`,O=e.pr_url&&e.pr_number?l`<a
        ...
        >`:"",K=r.map(Ae=>Ae===e.live_badge?l`<span
    ...
    data-lane=${e.lane}
  >
    ${i?l`<div class="worker-mini__row1">${_}${h}${$}</div>
          <div class="worker-mini__row2">
            ${P}${c?l`<span
                  class="worker-mini__done-at"
                  title=${`\uC644\uB8CC ${Ht(e.done_at)}`}
            ...
            <div class="worker-mini__body">${$}${pe}</div>
            ...
            ${In(e)}`:l`<div class="worker-mini__line">
              ${u}${d}${_}${h}${$}${O}${B}${K}${p}${H}${P}${q}${L}${U}${b}${te}
            </div>
            ${Le}${Te}${ne} ${In(e)}`}
  ...
  ${o?l`<div class="rtile__activity${r?" is-paused":""}">
        ...
        ${c.map(p=>l`<span class="rtile__leg rtile__leg--live"
            ...
            >`)}${u.length>0?l`<span
              ...
              >✓ ${u.length}</span
            >`:""}
      </div>`:""}${d}`}function Va(e,t,r=null,n={}){let s=e.failed===!0,o=!!e.paused,a=s?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):o?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?sg(t-e.started_at):"\u2014",i=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,c=Bn(e),u=Wt(e.usage),d=xr(e.usage),p=e.conflict_resolution?o?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,_=e.base_exception||null,h=e.landing,$=e.attempt_id&&e.attempt_id===r,O=n.monitor||null,B=og(O),K=ag(O,t,o),H=e.discard?.action?l`<button
        type="button"
    ...
    class="rtile${$?" rtile--sel":""}${o?" rtile--paused":""}${s?" rtile--failed":""}"
...
`)}function So(e){if(typeof e!="object"||e===null)return null;let t=Jr(e);if(t==="")return null;let r=(n,s)=>typeof s=="string"&&s.length>0?`${n}: ${s}`:null;return{text:t,title:Za(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",r("runner",e.runner),r(Pr.orchestration_model,e.model),r(Pr.orchestration_effort,e.effort),r(Pr.orchestration_speed,e.speed)])}}function sn(e,t){let r=Dr(e,"orchestration_model");if(r===null||r.resolution==="unavailable")return null;let n=Dr(e,"orchestration_effort"),s=Dr(e,"orchestration_speed"),o=wu([gr(t,r.value??""),r.display,n!==null&&n.value!==null?n.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Za(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Nr("orchestration_model",r),Nr("orchestration_effort",n),Nr("orchestration_speed",s)])}}function ig(e,t){return e===null||e.value===null||Ya.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function lg(e){return e===null||Ya.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function cg(e){return e===null?null:e.value==="auto"?"auto":Ya.has(e.resolution)?null:e.display}function qr(e,t){if(typeof e!="object"||e===null)return null;let r=Dr(e,"impl_dispatch"),n=Dr(e,"impl_runtime"),s=Dr(e,"impl_model"),o=Dr(e,"impl_effort"),a=Dr(e,"impl_speed"),i=r!==null&&r.value==="main"?"\uBA54\uC778":wu([ig(n,t??null),lg(s),cg(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Za(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Nr("impl_dispatch",r),Nr("impl_runtime",n),Nr("impl_model",s),Nr("impl_effort",o),Nr("impl_speed",a)])}}var Xt="",ug=["impl_runtime","impl_model","impl_effort"],dg=5,Eo=1;function Rr(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function To(e,t){let r=t.transport,n=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(R=>me(R,"error",4e3)),o={},a={},i=[],c=!1,u=null,d={},p="",_="",h=!1,$=!1,O=!1,B=null,K=!1;function H(){let R=t.queue?t.queue():null;return Rr(R)?R:null}function P(){let R=H();return R?R.runner_catalog:null}function q(){let R=H();return R&&Rr(R.execution_defaults)?R.execution_defaults:null}function L(){let R=t.implPresetStore?.get();return Rr(R)&&Array.isArray(R.presets)?R:null}function U(){return n===null?{}:{root_dir:n}}async function b(R,Q){return K||!r?null:await r(R,Q)}function j(R){R&&Rr(R.queue)&&t.onQueueAdopt?.(R.queue)}async function te(R,Q){let ae=H();if(!ae||K)return null;let J=await b(R,{...Q,...U(),expected_revision:ae.revision});if(j(J),n!==null&&J&&J.conflict){let qe=J.queue&&typeof J.queue.revision=="number"?J.queue.revision:H()?.revision??ae.revision;J=await b(R,{...Q,...U(),expected_revision:qe}),j(J)}return J}async function re(){c=!0,fe();try{let R=await b("get-session-defaults",{...U()});o=Rr(R?.values)?{...R.values}:{},a={...o},i=Array.isArray(R?.warnings)?R.warnings:[]}catch(R){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${R instanceof Error?R.message:String(R)}`)}finally{c=!1,fe()}}async function _e(){let R=Uc(o,a);if(Object.keys(R).length!==0){try{let Q=await b("set-session-defaults",{values:R,...U()});o=Rr(Q?.values)?{...Q.values}:{},a={...o},i=Array.isArray(Q?.warnings)?Q.warnings:[]}catch(Q){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}fe()}}function pe(R,Q){if(ug.includes(R)){Le(R,Q);return}Q===Xt?delete a[R]:a[R]=Q,fe(),_e()}function be(){let R=Ve().orchestration_model,Q=Qt({global:{orchestration_model:R??void 0},execution_defaults:q(),runner_catalog:P()}).orchestration_model.value;return Q?gr(P(),Q):null}function Te(R,Q){typeof Q=="string"&&Q.length>0?a[R]=Q:delete a[R]}function Le(R,Q){let ae=Q===Xt?void 0:Q,J=jc({impl_runtime:R==="impl_runtime"?ae:a.impl_runtime,impl_model:R==="impl_model"?ae:a.impl_model,impl_effort:R==="impl_effort"?ae:a.impl_effort},P(),be());Te("impl_runtime",J.impl_runtime),Te("impl_model",J.impl_model),Te("impl_effort",J.impl_effort),fe(),_e()}async function ne(){let R=H();if(!R)return;let Q={orchestration_model:R.orchestration_model??null,orchestration_effort:R.orchestration_effort??null,orchestration_speed:R.orchestration_speed??null},ae=Wc(Q,{...Q,...d});if(Object.keys(ae).length!==0){try{let J=await te("worker-queue-set-orchestration-defaults",{values:ae});if(J&&J.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}d={}}catch(J){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}fe()}}function oe(R,Q){d[R]=Q===Xt?null:Q,fe(),ne()}function Ae(R){if(u=R,!R){fe();return}let Q=P(),ae=Ve(),J=ae.orchestration_model;J&&!os(Q,R).includes(J)&&(d.orchestration_model=null,J=null);let qe=ae.orchestration_effort;qe&&!Na(Q,R,J||nr).includes(qe)&&(d.orchestration_effort=null),fe(),ne()}async function D(R){if(!(!H()||R<Eo)){try{await te("worker-queue-set-slots",{slots:R})}catch(Q){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}fe()}}async function ie(R){if(!(!H()||R<Eo||R>dg)){try{await te("worker-queue-set-serial-lane-count",{count:R})}catch(Q){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}fe()}}async function se(R,Q){let ae=R==="auto_advance"?"worker-automation-toggle":R==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await te(ae,{on:Q})}catch(J){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}fe()}function Se(){let R={},Q=Ve();for(let ae of uo){let J=Cr.includes(ae)?Q[ae]:a[ae];typeof J=="string"&&J.length>0&&(R[ae]=J)}return R}async function Ce(){let R=L();if(!R)return;let Q=Se();if(Object.keys(Q).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let ae=(R.presets||[]).find(qe=>qe.id===p),J=_.trim()||(ae?ae.name:"");if(!J){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let qe=ae?await b("impl-preset-update",{expected_revision:R.revision,id:ae.id,name:J,settings:Q}):await b("impl-preset-create",{expected_revision:R.revision,name:J,settings:Q});if(qe&&qe.applied){if(_="",!ae&&Array.isArray(qe.presets)){let Qe=qe.presets.find(it=>it.name===J);p=Qe?Qe.id:p}fe()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),fe()}catch(qe){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${qe instanceof Error?qe.message:String(qe)}`)}}async function C(){let R=L();if(!(!R||p.length===0))try{let Q=await b("impl-preset-delete",{expected_revision:R.revision,id:p});Q&&Q.applied?(p="",fe()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),fe())}catch(Q){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}}function V(R){o=Rr(R.values)?{...R.values}:{},a={...o},i=Array.isArray(R.warnings)?R.warnings:[],Rr(R.queue)&&(t.onQueueAdopt?.(R.queue),d={})}async function $e(){let R=L(),Q=H();if(!R||!Q||p.length===0)return;let ae=J=>({preset_id:p,expected_revision:R.revision,expected_queue_revision:J,...U()});try{let J=await b("apply-impl-preset-global",ae(Q.revision));if(J&&J.applied&&V(J),n!==null&&J&&J.queue_applied===!1){let qe=J.queue&&typeof J.queue.revision=="number"?J.queue.revision:H()?.revision??Q.revision;J=await b("apply-impl-preset-global",ae(qe)),J&&J.applied&&V(J)}J&&J.applied?J.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):J&&J.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(J){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${J instanceof Error?J.message:String(J)}`)}fe()}async function Ne(){$=!0,O=!1,fe();try{let R=await b("get-worker-system-prompt",{});!R||typeof R!="object"||Array.isArray(R)?O=!0:B=R}catch{O=!0}finally{$=!1,fe()}}function Pe(){if(h=!h,h&&!B){Ne();return}fe()}function He(){let R=En({loading:$,error:O});if(R)return R;if(!B)return"";let Q=Array.isArray(B.variants)?B.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${h?He():""}
    </section>`}function ot(R,Q,ae,J,qe,Qe,it){let Xe=qe[R]??Xt,pt=qa(R,ae,qe,q(),P(),it),yt=pt.options.find(ft=>ft.value===Xe),gt=Xe===Xt?pt.full_value:yt?.full_value;return l`<select
    ...
    >
    ...
    </div>`}function Z(R,Q,ae,J){return l`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${Q}</span>
      <span class="settings-dialog__controls">
    ...
    </div>`}function Ve(){let R=H(),Q={};for(let ae of Cr)Q[ae]=Object.prototype.hasOwnProperty.call(d,ae)?d[ae]:R&&typeof R[ae]=="string"?R[ae]:null;return Q}function ze(){let R=P(),Q=a.impl_runtime,ae=a.impl_model,J=L(),qe=H(),Qe=Ve(),it=os(R,u),Xe=Cn(R,void 0).filter(Ue=>Ue!==nr),pt=Na(R,u,Qe.orchestration_model||nr).filter(Ue=>Ue!==nr),yt=p?(J?.presets||[]).find(Ue=>Ue.id===p):null,gt=yt?Bc(Se(),Rr(yt.settings)?yt.settings:{}):null,ft=qe&&typeof qe.slots=="number"?qe.slots:Eo+1,kt=qe&&typeof qe.serial_lane_count=="number"?qe.serial_lane_count:Eo,We=q()?.supported===!0,Ye=qa("workflow_mode",ns,a,q(),R);return l`
      ...
      ${c?l`<div class="settings-dialog__empty">불러오는 중…</div>`:l`
            ...
            <div class="settings-dialog__group">
              ...
              ${Y("auto_advance","\uC790\uB3D9\uD654","\uC2AC\uB86F\uC774 \uBE44\uBA74 \uB300\uAE30 \uC55E \uD589\uC774 \uCD9C\uBC1C\uD569\uB2C8\uB2E4",qe?.auto_advance===!0)}
              ${Y("auto_merge","\uBA38\uC9C0","\uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4",qe?.auto_merge===!0)}
              ${Y("auto_repair","\uC790\uB3D9 \uD574\uACB0","\uC2E4\uD328\uD55C \uC800\uC7A5\uC18C \uC791\uC5C5\uC744 \uC138\uC158\uC774 \uC790\uB3D9\uC73C\uB85C \uBCF5\uAD6C\uD569\uB2C8\uB2E4",qe?.auto_repair===!0)}
              ${Z("slots","\uB3D9\uC2DC \uC2E4\uD589",ft,Ue=>D(Ue))}
              ${Z("serial-lane-count","\uC9C1\uB82C \uB808\uC778",kt,Ue=>ie(Ue))}
            </div>
            ${Ze()}
          `}
    `}function fe(){K||Ke(ze(),e)}return{load(){return d={},re()},render:fe,sessionDraft:()=>({...a}),destroy(){K=!0,Ke(l``,e)}}}function us(e){return l`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ...
    />`)}function Eu(e){return`${e} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}function Tu(e){let t=(Array.isArray(e)?e:[]).map(i=>i&&i.usage).filter(i=>i&&typeof i=="object"&&"providers"in i);if(t.length>0)return Wt(Vs(t));let r={};for(let i of $r)r[i]=0;let n=!1,s=0,o=0,a=0;for(let i of Array.isArray(e)?e:[]){let c=i&&i.usage;if(c&&typeof c=="object"){let u=!1;for(let d of $r){let p=c[d];typeof p=="number"&&Number.isFinite(p)&&(r[d]+=p,n=!0,u=!0)}if(u){o+=1;let d=c.total_cost_usd;typeof d=="number"&&Number.isFinite(d)&&(s+=d,a+=1)}}}return o>0&&a===o&&(r.total_cost_usd=s),n?xr(r):null}function hr(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Co(e,t){let r=hr(e?.counts)?e.counts:null,n=r?r[t]:null;return typeof n=="number"&&Number.isFinite(n)?n:0}function pg(e,t){if(!hr(t))return e;let r={...e};for(let[n,s]of Object.entries(t))s!==void 0&&(r[n]=s);return r}function fg(e){if(!hr(e)||!hr(e.execution_defaults)||!hr(e.runner_catalog)||!hr(e.session_defaults))return null;let t={...e.session_defaults};for(let a of["orchestration_model","orchestration_effort","orchestration_speed"])typeof e[a]=="string"&&e[a].length>0&&(t[a]=e[a]);let r=Qt({global:t,execution_defaults:e.execution_defaults,runner_catalog:e.runner_catalog}),n=gr(e.runner_catalog,r.orchestration_model.value??""),s=sn(r,e.runner_catalog),o=qr(r,n);return s===null&&o===null?null:{orchestration:s,worker:o}}function Cu(e,t){let r=t.notify||(D=>me(D,"error",4e3)),n=document.createElement("div");n.className="mon2-deck__main",e.appendChild(n);let s=document.createElement("div");s.className="mon2-deck__panel",s.hidden=!0;let o=document.createElement("div");o.className="mon2-deck__panel-hd";let a=document.createElement("span");a.className="mon2-deck__panel-title";let i=document.createElement("button");i.type="button",i.className="mon2-deck__panel-close",i.setAttribute("aria-label","\uC2E4\uD589 \uC124\uC815 \uB2EB\uAE30"),i.textContent="\u2715",o.append(a,i);let c=document.createElement("div");c.className="mon2-deck__panel-body",s.append(o,c),e.appendChild(s);let u=null,d=null,p=null,_=new Map;function h(){let D=t.workspacesState?t.workspacesState():[];return Array.isArray(D)?D.filter(ie=>hr(ie)):[]}function $(D){return h().find(ie=>ie.root_dir===D)||null}function O(D){return pg($(D),_.get(D))}function B(){for(let D of h()){let ie=_.get(D.root_dir);ie&&typeof ie.revision=="number"&&typeof D.revision=="number"&&D.revision>=ie.revision&&_.delete(D.root_dir)}}async function K(D,ie,se){let Se=t.transport,Ce=O(ie);if(!(!Se||!hr(Ce))){try{let C=await Se(D,{...se,root_dir:ie,expected_revision:Ce.revision});if(hr(C?.queue)&&_.set(ie,C.queue),C&&C.conflict){let V=hr(C.queue)&&typeof C.queue.revision=="number"?C.queue.revision:O(ie)?.revision;C=await Se(D,{...se,root_dir:ie,expected_revision:V}),hr(C?.queue)&&_.set(ie,C.queue)}}catch(C){r(`\uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}ne()}}function H(D){u!==D&&(u=D,t.onFocusChange?.(u),ne())}function P(D){H(u===D?null:D)}function q(D){if(d===D){U();return}L(),d=D;let ie=$(D);a.textContent=`${ie?.name||D} \uC2E4\uD589 \uC124\uC815 \xB7 Worker \uD0ED \u2699 \uC2E4\uD589 \uD0ED\uACFC \uAC19\uC740 \uC800\uC7A5\uC18C`,s.hidden=!1,p=To(c,{root_dir:D,queue:()=>O(D),transport:t.transport,implPresetStore:t.implPresetStore,notify:r,onQueueAdopt:se=>{_.set(D,se),ne()}}),p.load(),ne()}function L(){p?.destroy(),p=null}function U(D){L(),d=null,s.hidden=!0,a.textContent="",D!==!0&&ne()}let b=()=>U();i.addEventListener("click",b);function j(D){D.key==="Escape"&&u!==null&&H(null)}document.addEventListener("keydown",j);function te(D,ie){let se=Math.max(ie,D,1);return l`<span
      class="mon2-deck__rail"
      role="img"
      aria-label=${`\uC2AC\uB86F ${ie}\uAC1C \uC911 ${D}\uAC1C \uC2E4\uD589 \uC911`}
    >
      ${Array.from({length:se},(Se,Ce)=>Ce<D?l`<i class="mon2-deck__slot is-run"></i>`:l`<i class="mon2-deck__slot"></i>`)}
    </span>`}function re(D){let ie=D.auto_advance===!0,se=D.auto_merge===!0;return l`<button
        type="button"
        class=${`mon2-deck__op mon2-deck__auto${ie?" is-on":""}`}
        data-act="auto"
        aria-pressed=${ie?"true":"false"}
        aria-label=${`${D.name} \uC790\uB3D9\uD654`}
      ...
      <button
        type="button"
        class=${`mon2-deck__op mon2-deck__gear${d===D.root_dir?" is-on":""}`}
        data-act="gear"
        aria-expanded=${d===D.root_dir?"true":"false"}
        aria-label=${`${D.name} \uC2E4\uD589 \uC124\uC815`}
        title="이 레포의 실행 설정"
      >
        ${Su()}
      </button>`}function _e(D){let ie=fg(D);return ie?l`<div class="mon2-deck__chips">
      ...
      ${ie.worker?l`<span class="mon2-deck__chip" title=${ie.worker.title}
          ...
          >`:""}
    </div>`:""}function pe(D){let ie=Co(D,"running"),se=typeof D.slots=="number"?D.slots:1;return l`<div
      class=${`mon2-deck__tile${u===D.root_dir?" is-focus":""}`}
      role="button"
      tabindex="0"
      data-root-dir=${D.root_dir}
      aria-pressed=${u===D.root_dir?"true":"false"}
      title="클릭하면 이 레포만 선명하게 봅니다 (Esc로 해제)"
    >
      <div class="mon2-deck__tile-hd">
        <span class="mon2-deck__name" title=${D.root_dir}>${D.name}</span>
        <button
          type="button"
      ...
      <div class="mon2-deck__slots">
        ...
        <span class="mon2-deck__counts"
          >${ie}/${se} 실행 · 대기 ${Co(D,"queue")} · PR
          ${Co(D,"pr_wait")}</span
        >
      </div>
      <div class="mon2-deck__ops">${re(D)}</div>
      ${_e(D)}
    </div>`}function be(D){let ie=t.doneItems?t.doneItems():[],se=t.rangeLabel?t.rangeLabel():"",Se=Tu(Array.isArray(ie)?ie:[]),Ce=C=>D.reduce((V,$e)=>V+Co($e,C),0);return l`<div
      class="mon2-deck__total"
      title=${`visible \uB808\uD3EC ${D.length}\uACF3\uC758 \uD569\uACC4\uC785\uB2C8\uB2E4 \u2014 \uC2E4\uD589\xB7\uB300\uAE30\xB7PR\uC740 \uC9C0\uAE08, \uC644\uB8CC\uB294 ${se}`}
    >
...
${F.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(ze,E)&&(ve.blocked_by=Array.isArray(ze[E])?ze[E].filter(Me=>typeof Me=="string"&&Me.length>0):[]),ve};for(let S=0;S<Qe.length;S++){let M=Ue(Qe[S],"queue",S,Qe.length);if(!M)continue;_.push(M);let de=O.get(V);de?de.push(M):O.set(V,[M])}let ut=[];for(let S=0;S<Math.max(pt,it.length);S++){let M=`s${S+1}`,de=yt.get(M),k=de&&Array.isArray(de.entries)?de.entries:[],E=[];for(let ke=0;ke<k.length;ke++){let ve=Ue(k[ke],M,ke,k.length);ve&&(E.push(ve),_.push(ve))}let F=Et(Xe[M]),ee=Array.isArray(F.occupied_by)?F.occupied_by.filter(ke=>typeof ke=="string"):[];E.length===0&&ee.length===0&&(pt<=1||S>=pt)||ut.push({id:M,index:S,items:E,raw_length:k.length,occupied_by:ee,corrections:Array.isArray(F.corrections)?F.corrections.length:0,cycle:F.cycle===!0,...E.length===0&&ee.length===0?{empty:!0}:{}})}B.set(V,ut);let At=Array.from({length:pt},(S,M)=>{let de=`s${M+1}`,k=yt.get(de),E=k&&Array.isArray(k.entries)?k.entries:[],F=Et(Xe[de]);return{id:de,index:E.length,length:E.length,occupied_by:Array.isArray(F.occupied_by)?F.occupied_by.filter(ee=>typeof ee=="string"):[]}});for(let S of Array.isArray(C.runnable)?C.runnable:[]){let M=S&&S.bead_id;if(typeof M!="string"||Ye.has(M))continue;Ye.add(M);let de=S.workflow&&typeof S.workflow=="object"?S.workflow:null,k=de&&typeof de.route=="string"&&de.route||(typeof S.route=="string"?S.route:null),E=Lg(Et(Ne),S.exec_pins,k);Array.isArray(S.blocked_by)&&S.blocked_by.length>0&&P.set(M,S.blocked_by.filter(F=>typeof F=="string"&&F.length>0)),typeof S.title=="string"&&S.title.length>0&&q.set(M,S.title),u.push({...We(M),title:S.title||Ze[M]||M,lane:"runnable",draggable:!0,reason:Uu(nt,M),created_at:S.created_at??void 0,updated_at:S.updated_at??void 0,status:typeof S.status=="string"?S.status:void 0,labels:Array.isArray(S.labels)?S.labels:[],spec_id:typeof S.spec_id=="string"?S.spec_id:"",workflow:de||(k?{route:k,chips:{route:k}}:null),...E?{exec_chips:E}:{},blocked:S.blocked===!0,...Array.isArray(S.blocked_by)?{blocked_by:S.blocked_by.filter(F=>typeof F=="string"&&F.length>0)}:{},place_index:Qe.length,place_lanes:At})}for(let S of ft){let M=S&&S.bead_id;if(typeof M!="string"||Ye.has(M)||(Ye.add(M),o!==void 0&&typeof S.added_at=="number"&&S.added_at<o))continue;let de=Ig(He,M),k=de&&typeof de.done_kind=="string"?de.done_kind:null;h.push({...We(M),lane:"done",done:!0,done_layout:"three_line",usage:ir(He,M),work_ms:vo(He,M),done_at:typeof S.added_at=="number"?S.added_at:void 0,done_kind:k,badges:k&&Bu[k]?[Bu[k]]:[]})}}let L=new Map;s.forEach((C,V)=>{C&&typeof C.root_dir=="string"&&L.set(C.root_dir,V)});let U=r&&r.running_sort==="repo"?"repo":"started";d.sort((C,V)=>{if(U==="repo"){let Pe=L.get(C.root_dir)??Number.MAX_SAFE_INTEGER,He=L.get(V.root_dir)??Number.MAX_SAFE_INTEGER;if(Pe!==He)return Pe-He}let $e=typeof C.started_at=="number"&&Number.isFinite(C.started_at)?C.started_at:null,Ne=typeof V.started_at=="number"&&Number.isFinite(V.started_at)?V.started_at:null;return $e!==null&&Ne!==null&&$e!==Ne?$e-Ne:$e===null&&Ne!==null?1:$e!==null&&Ne===null?-1:C.id.localeCompare(V.id)}),h.sort((C,V)=>(V.done_at??0)-(C.done_at??0));let b=s.length>0?s:n.map(C=>({root_dir:C&&C.root_dir,name:C&&C.name,auto_advance:C&&C.auto_advance,auto_merge:C&&C.auto_merge,slots:C&&C.slots,revision:C&&C.revision,runner_catalog:C&&C.runner_catalog})),j=new Set(u.map(C=>C.root_dir)),te=[];for(let C of b){if(!C||typeof C.root_dir!="string")continue;let V=O.get(C.root_dir)||[],$e=B.get(C.root_dir)||[];!(V.length>0||$e.some(Pe=>Pe.items.length>0||Pe.occupied_by.length>0))&&!j.has(C.root_dir)||te.push({root_dir:C.root_dir,name:C.name||C.root_dir,auto_advance:C.auto_advance===!0,auto_merge:C.auto_merge===!0,slots:typeof C.slots=="number"&&C.slots>=ju?C.slots:ju,revision:typeof C.revision=="number"?C.revision:0,runner_catalog:Et(C.runner_catalog),items:V,sublanes:{parallel:V,serial:$e},serial_lane_count:K.get(C.root_dir)||0,raw_queue_length:H.get(C.root_dir)||0})}let re={runnable:u,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:i==="updated_flat",queue:_,queue_groups:te,running:d,pr_wait:p,done:h,chains:[],parallel_rows:[],chain_lanes:[],parallel_raw_length:Object.fromEntries(H),owner_of:{},pending_lanes_kept:[]},_e=Du(re);for(let C of $)_e.has(C.id)||_e.set(C.id,{root_dir:C.root_dir,workspace_name:C.workspace_name,lane:"done",state:"done"});let pe=new Map;for(let[C,V]of P)for(let $e of V){let Ne=pe.get($e);Ne?Ne.includes(C)||Ne.push(C):pe.set($e,[C])}for(let C of[...re.queue,...re.runnable]){if(!Object.hasOwn(C,"blocked_by"))continue;let V=_e.get(C.id);C.blockers=(C.blocked_by||[]).map($e=>Nu($e,V,_e,s)),C.blocker_warnings=C.blockers.filter($e=>$e.missing_internal).map($e=>`\u26A0 \uC120\uD589 ${$e.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),C.blocker_warnings.length>0&&(C.alert=!0)}for(let C of[...re.queue,...re.runnable,...re.running,...re.pr_wait]){let V=C.lane==="running"||C.lane==="pr_wait"?[]:(C.blockers||[]).map(Mg),$e=[];for(let He of pe.get(C.id)||[]){let Ze=Pg(He,_e);Ze&&$e.push(Ze)}let Ne=C.lane==="running"||C.lane==="pr_wait"?[]:C.blocker_warnings||[];if(V.length===0&&$e.length===0&&Ne.length===0)continue;let Pe={predecessors:V,successors:$e,warnings:Ne};C.dependency_chips=Pe}re.chains=Ng(P,_e,s);let be=qu(re.queue_groups);for(let C of re.queue_groups)for(let V of C.sublanes.serial){let $e=be.get(Fu(C.root_dir,V.id));$e&&(V.cross_wait_peers=$e)}let Te=jg(re.chains,Array.isArray(r?.pending_lanes)?r.pending_lanes:[],P,_e,s,q);re.chain_lanes=Te.chain_lanes,re.pending_lanes_kept=Te.pending_lanes_kept;let Le=new Set;for(let C of re.chain_lanes)for(let V of C.rows)Le.add(V.id);let ne=[];for(let C of O.values())for(let V of C)Le.has(V.id)||ne.push(V);ne.sort((C,V)=>{let $e=C.workspace_name.localeCompare(V.workspace_name);return $e!==0?$e:(C.queue_index??0)-(V.queue_index??0)}),re.parallel_rows=ne;let oe={};for(let[C,V]of _e)typeof V.root_dir=="string"&&V.root_dir.length>0&&(oe[C]=V.root_dir);re.owner_of=oe;let Ae=re.runnable.length,D=re.runnable;a.show_blocked||(D=D.filter(C=>C.blocked!==!0));let ie=D.length;a.spec==="with"?D=D.filter(C=>!!C.spec_id):a.spec==="without"&&(D=D.filter(C=>!C.spec_id)),re.runnable_hidden={blocked:Ae-ie,spec:ie-D.length};let se=(C,V)=>{let $e=zu(V.updated_at)-zu(C.updated_at);return $e!==0?$e:C.id.localeCompare(V.id)},Ce=i==="repo_spec"?(C,V)=>{let $e=C.spec_id?0:1,Ne=V.spec_id?0:1;return $e!==Ne?$e-Ne:se(C,V)}:se;if(i==="updated_flat")re.runnable=D.slice().sort(se),re.runnable_sections=[];else{let C=new Map;for(let Ne of D){let Pe=C.get(Ne.root_dir);Pe?Pe.push(Ne):C.set(Ne.root_dir,[Ne])}let V=[],$e=[];for(let Ne of b){if(!Ne||typeof Ne.root_dir!="string")continue;let Pe=(C.get(Ne.root_dir)||[]).slice().sort(Ce);C.delete(Ne.root_dir),Pe.length!==0&&(V.push({root_dir:Ne.root_dir,name:Ne.name||Ne.root_dir,items:Pe.map(He=>({...He,workspace_name:""}))}),$e.push(...Pe))}for(let[Ne,Pe]of C){let He=Pe.slice().sort(Ce);V.push({root_dir:Ne,name:He[0]?.workspace_name||Ne,items:He.map(Ze=>({...Ze,workspace_name:""}))}),$e.push(...He)}re.runnable=$e,re.runnable_sections=V}return re}var Yu="bdui.monitor.done-range",Zu="bdui.monitor.running_sort",Qu="bdui.monitor.candidate_sort",Xu="beads-ui.monitor.candidate-filter",Ju="beads-ui.monitor.sections";function Bg(){try{let e=window.localStorage.getItem(Xu);if(!e)return{...Ln};let t=JSON.parse(e);return!t||typeof t!="object"?{...Ln}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:Ln.show_blocked,spec:ni.some(r=>r.value===t.spec)?t.spec:"all"}}catch{return{...Ln}}}function Gu(e){try{window.localStorage.setItem(Xu,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Ug(){try{let e=window.localStorage.getItem(Qu);return _s.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function Wg(e){try{window.localStorage.setItem(Qu,e)}catch{}}function zg(){try{let e=window.localStorage.getItem(Ju);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Vu(e){try{window.localStorage.setItem(Ju,JSON.stringify(e))}catch{}}function Hg(){try{let e=window.localStorage.getItem(Yu);return or(e)?e:er}catch{return er}}function Gg(e){try{window.localStorage.setItem(Yu,e)}catch{}}function Vg(){try{return window.localStorage.getItem(Zu)==="repo"?"repo":"started"}catch{return"started"}}function Kg(e){try{window.localStorage.setItem(Zu,e)}catch{}}var ed="tab:monitor:pipeline",Yg=1e3,Zg=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],Ku="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function Qg(e){return e>=1&&e<=Ku.length?Ku[e-1]:`(${e})`}function td(e,t){let r=St("views:monitor"),n=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.switchWorkspace,c=t.router,u=t.now||(()=>Date.now()),d=t.confirm||(v=>typeof globalThis.confirm!="function"||globalThis.confirm(v)),p=Hg(),_=Vg(),h=Bg(),$=Ug(),O=zg(),B=null,K=null,H=[],P=null;function q(){let v=Ir.find(w=>w.value===p);return v?v.label:""}let L=document.createElement("div");L.className="mon",e.appendChild(L);let U=document.createElement("div");U.className="mon2-drawer",e.appendChild(U);let b=si(null,null),j=new Map,te=new Map,re=null,_e=null,pe=null,be=Tn(U,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{B=null,ae()}});async function Te(v,w,I,W,ye=!0){if(!o||!I)return null;let we=await o(v,{...w,root_dir:I,expected_revision:W});if(we&&we.conflict&&ye){we.queue&&te.set(I,we.queue);let he=we.queue&&typeof we.queue.revision=="number"?we.queue.revision:W;we=await o(v,{...w,root_dir:I,expected_revision:he})}return we&&we.queue&&I&&te.set(I,we.queue),we}function Le(v,w){let I=te.get(v),W=s&&s.get?s.get():null,ye=(Array.isArray(W)?W:[]).find(he=>he?.root_dir===v);return(I||ye)?.merge_queue?.find(he=>he.bead_id===w)?.continuation_action}async function ne(v,w,I,W){let ye=await Te(v,w,I,W),we=te.get(I)?.revision??ye?.queue?.revision??W;return kr(ye,(he,et)=>Te(v,{...w,continuation:he,decision_token:et},I,we,!1),{refresh:he=>Te(v,w,I,he?.queue?.revision??te.get(I)?.revision??we,!1)})}async function oe(v,w,I,W){let ye=await kr({continuation_mismatch:W},(he,et)=>Te("worker-merge-queue-add",{bead_id:w,continuation:he,decision_token:et},v,I,!1)),we=ye?.queue?.merge_queue?.find(he=>he.bead_id===w)?.continuation_action;ye?.applied!==!0&&we?.continuation===null&&we.mismatch&&await oe(v,w,ye.queue.revision,we.mismatch)}async function Ae(v,w,I){let W=await Te("worker-discard",v,w,I);if(W&&W.discarded===!0){me(ko(W),"success",5e3);return}if(W&&W.reason){me(`\uD3D0\uAE30 \uC2E4\uD328: ${W.reason}`,"error");return}if(W&&W.accepted&&W.pending==="merged_revert"){me("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(W&&W.accepted){me(`\uD3D0\uAE30 \uC9C4\uD589: ${W.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}W&&!W.conflict&&me("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function D(v,w,I){return!o||!I?null:await o(v,{...w,root_dir:I})}async function ie(){let v=new Map;for(let w of b.pr_wait)v.has(w.root_dir)||v.set(w.root_dir,w.expected_revision);for(let[w,I]of v)await Te("worker-merge-queue-add-all",{},w,I)}function se(v){let w=O[v];return!!(w&&w.runnable===!0)}function Se(v){let w={...O[v]||{}};w.runnable=!w.runnable,O={...O,[v]:w},Vu(O),ae()}function Ce(v){return O[v]===!0}function C(v){O={...O,[v]:O[v]!==!0},Vu(O),ae()}function V(v){let w=se(v.root_dir);return l`<header class="mon2-sec__hd">
    ...
    >
      ${w}
        ...
        data-section="runnable"
      >
        ${V({root_dir:v.root_dir,name:v.name,count:v.items.length})}
        ${w?"":l`<div
    ...
    </div>`}function Y(v,w,I){return l`<div
      class="mon2-item"
      data-bead-id=${w.id}
    ...
    >
      ${nn(w)}
    </div>`}function Z(v,w){return l`<div
    ...
    >
      ${cr({id:"",lane:w.id,title:`${v.name} \xB7 \uC9C1\uB82C ${w.index+1}`,items:w.items,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uB4DC\uB798\uADF8\uB85C \uBC30\uCE58",body:l`<div
          ...
          data-lane-length=${String(w.raw_length)}
        >
          ${w.items.length>0?w.items.map((I,W)=>Y(w,I,W)):l`<div class="worker-pane__empty">
                비어 있음 — 드래그로 배치
              </div>`}
    ...
    >
      ...
      ${v?"":l`<div class="mon2-area__body">
            ...
            ${b.queue_groups.map(I=>I.sublanes.serial.map(W=>Z(I,W)))}
          </div>`}
  ...
  `,e.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),a=r.querySelector("#new-priority"),i=r.querySelector("#new-labels"),c=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),d=r.querySelector("#btn-cancel"),p=r.querySelector("#btn-create"),_=r.querySelector(".new-issue__close");function h(){o.replaceChildren();let L=document.createElement("option");L.value="",L.textContent="\u2014 Select \u2014",o.appendChild(L);for(let U of nd){let b=document.createElement("option");b.value=U,b.textContent=sd(U),o.appendChild(b)}a.replaceChildren();for(let U=0;U<=4;U+=1){let b=document.createElement("option");b.value=String(U);let j=od[U]||"Medium";b.textContent=`${U} \u2013 ${j}`,a.appendChild(b)}}h();function $(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function O(L){s.disabled=L,o.disabled=L,a.disabled=L,i.disabled=L,c.disabled=L,d.disabled=L,p.disabled=L,p.textContent=L?"Creating\u2026":"Create"}function B(){u.textContent=""}function K(L){u.textContent=L}function H(){try{let L=window.localStorage.getItem("beads-ui.new.type");L?o.value=L:o.value="";let U=window.localStorage.getItem("beads-ui.new.priority");U&&/^\d$/.test(U)?a.value=U:a.value="2"}catch{o.value="",a.value="2"}}function P(){let L=o.value||"",U=a.value||"";L.length>0&&window.localStorage.setItem("beads-ui.new.type",L),U.length>0&&window.localStorage.setItem("beads-ui.new.priority",U)}async function q(){B();let L=String(s.value||"").trim();if(L.length===0){K("Title is required"),s.focus();return}let U=Number(a.value||"2");if(!(U>=0&&U<=4)){K("Priority must be 0..4"),a.focus();return}let b=String(o.value||""),j=String(c.value||""),te={title:L};b.length>0&&(te.type=b),String(U).length>0&&(te.priority=U),j.length>0&&(te.description=j),O(!0);try{await t("create-issue",te)}catch{O(!1),K("Failed to create issue");return}P(),O(!1),$()}return r.addEventListener("cancel",L=>{L.preventDefault(),$()}),_.addEventListener("click",()=>$()),d.addEventListener("click",()=>$()),r.addEventListener("keydown",L=>{L.key==="Enter"&&(L.ctrlKey||L.metaKey)&&(L.preventDefault(),q())}),n.addEventListener("submit",L=>{L.preventDefault(),q()}),{open(){n.reset(),B(),H();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){$()}}}var Xg=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Jg(e,t){return ta(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function id(e,t,r){return l`
  ...
  `}var eh=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function ud(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(be=>me(be,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,u="",d=null;function p(){if(d)return d;let be=a.querySelector('[data-pane="execution"]');return be?(d=To(be,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:r,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:Te=>t.queueStore?.set?.(Te)}),d):null}function _(){return l`
    ...
    `}function h(){let be=n.get();return l`
      ...
      >
        ...
        ${be?l`
              ${id(be,s(),K)}
              ${ld(be,u,{onDraft:Te=>{u=Te},onAdd:H,onRemove:P})}
              ${cd(be,q)}
            `:l`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function $(be){let Te=n.get();if(Te)try{let Le=await r("display-policy-set",{expected_revision:Te.revision,policy:be(Te)});O(Le),Le&&Le.conflict&&Le.policy&&(Le=await r("display-policy-set",{expected_revision:Le.policy.revision,policy:be(Le.policy)}),O(Le)),Le&&Le.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function O(be){be&&be.policy&&typeof be.policy=="object"&&n.set(be.policy)}function B(be){$(be)}function K(be){let Te=n.get();if(!Te)return;let Le=!th(be,Te);B(ne=>rh(be,ne,Le))}function H(){let be=u.trim();be.length!==0&&(u="",B(Te=>Te.hidden_prefixes.includes(be)?{hidden_prefixes:Te.hidden_prefixes}:{hidden_prefixes:[...Te.hidden_prefixes,be]}),L())}function P(be){B(Te=>({hidden_prefixes:Te.hidden_prefixes.filter(Le=>Le!==be)}))}function q(be){let Te=n.get();if(!Te)return;let Le=Te.chips[be]===!1;B(()=>({chips:{[be]:Le}}))}function L(){Ke(l`
    ...
    </span>`}function L(ne,oe,Ae){let D=oe.available&&typeof oe.ageSeconds=="number"&&oe.ageSeconds>pd,ie=D&&typeof oe.ageSeconds=="number"?`${Math.floor(oe.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",se=oe.accounts.filter(V=>!V.active).length,Se=`usage-meter__group${D?" usage-meter__group--stale":""}`,Ce=l`<span class="usage-meter__provider"
        >${ne.label}</span
      >
      ${oe.available?oe.windows.map(V=>q(V,D,ie,Ae)):l`<span class="usage-meter__empty">사용량 없음</span>`}
    ...
    </span>`}function b(ne,oe){let Ae=gd(ne.pct),D=_d(ne.resetsAt,oe);return l`<span
    ...
    >
      ...
      <span class="usage-meter__account-reset"
        >${D.length>0?`\u21BB ${D}`:""}</span
      >
    </span>`}function j(ne,oe){return oh.includes(oe)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${ne.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function te(ne,oe,Ae){let D=oe.status==="ok",ie=typeof oe.ageSeconds=="number"&&oe.ageSeconds>pd,se=a.get(bd(ne.key,oe.number)),Se=n.get(ne.key),Ce=Se!==void 0,C=Se===oe.number,V=["usage-meter__account"];return oe.active&&V.push("usage-meter__account--active"),D||V.push("usage-meter__account--unavailable"),ie&&V.push("usage-meter__account--stale"),l`<div class=${V.join(" ")}>
      <div class="usage-meter__account-head">
        ...
        ${oe.active?"":l`<button
              ...
              ?disabled=${Ce}
              @click=${()=>{P(ne,oe.number)}}
            >
              ${C?"\uC804\uD658 \uC911\u2026":"\uC804\uD658"}
            </button>`}
      </div>
      ${D?l`<div class="usage-meter__account-windows">
    ...
    </div>`}function re(ne,oe,Ae){let D=oe.accounts.filter(ie=>ie.active).length;return l`<section class="usage-meter__section">
    ...
    >
    ...
    </div>`}function pe(){let ne=[];for(let D of hd){let ie=o.get(D.key);ie&&ne.push({provider:D,snapshot:ie})}if(ne.length===0){h(),u();return}let oe=ne.find(D=>D.provider.key===r&&D.snapshot.accounts.length>0);oe||h();let Ae=Date.now();Ke(U(ne,Ae),e),e.hidden=!1,oe?be(oe,Ae):p()}function be(ne,oe){let Ae=d(),D=e.getBoundingClientRect(),ie=e.ownerDocument.documentElement.clientWidth;Ae.style.setProperty("--usage-meter-anchor-top",`${D.bottom}px`),Ae.style.setProperty("--usage-meter-anchor-right",`${Math.max(0,ie-D.right)}px`),Ke(l`<div
          class="usage-meter__scrim"
          aria-hidden="true"
          @mousedown=${H}
        ></div>
        ${_e(ne,oe)}`,Ae)}async function Te(ne){try{let oe=await fetch(ne.endpoint);return oe.ok?ch(await oe.json()):null}catch{return null}}async function Le(){i+=1;let ne=i,oe=await Promise.all(hd.map(async Ae=>({provider:Ae,snapshot:await Te(Ae)})));if(!(t||ne!==i)){for(let Ae of oe)Ae.snapshot?o.set(Ae.provider.key,Ae.snapshot):o.delete(Ae.provider.key);pe()}}return u(),Le(),s=setInterval(()=>{Le()},6e4),{destroy(){t=!0,s!==null&&(clearInterval(s),s=null),h(),u()}}}function wd(e){let t=e.attempts?Object.values(e.attempts):[],r=new Map;for(let s of t)s&&r.set(s.bead_id,s.attempt_id);let n=new Map;for(let s of e.done||[])s&&typeof s.bead_id=="string"&&typeof s.added_at=="number"&&n.set(s.bead_id,s.added_at);return s=>{let o=r.get(s.bead_id)!==s.attempt_id,a=n.get(s.bead_id),i=typeof a=="number"&&a>0&&typeof s.finished_at=="number"&&a>=s.finished_at;return!o&&!i&&typeof s.dismissed_at!="number"}}var uh="worker-ineligible";function oi(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function kd(e){return oi(e).includes(uh)}var dh="worker-serial";function ai(e){return oi(e).includes(dh)}function ii(e,t,r){if(typeof t!="string"||typeof r!="string")return[];let n=e?.runners;if(!n||!Object.hasOwn(n,t))return[];let s=n[t],o=s?.models;if(!o||!Object.hasOwn(o,r))return[];let a=o[r]?.efforts;return Array.isArray(a)?a.slice():Array.isArray(s.efforts)?s.efforts.slice():[]}var ph=new Set(["done","failed","orphaned","stopped","discarded"]),fh={spec_missing:"\uC2A4\uD399 \uC5C6\uC74C",route:"route \uBBF8\uB2EC",spec_review:"\uC2A4\uD399 \uB9AC\uBDF0 \uC5C6\uC74C",spec_conflict:"\uC2A4\uD399 \uCDA9\uB3CC",phase_child:"phase child",worker_ineligible:"worker \uC81C\uC678"},_h={running:"\uC2E4\uD589 \uC911",success:"\uC131\uACF5",failure:"\uC2E4\uD328",cancelled:"\uCDE8\uC18C",interrupted:"\uC911\uB2E8"},mh={running:"running",success:"done",failure:"failed",cancelled:"stopped",interrupted:"orphaned"};function li(e){return{runner:e.runner||void 0,model:e.model||void 0,effort:e.effort||void 0,status:mh[e.outcome]||(typeof e.job_id=="string"?"running":void 0),session_id:e.session_id||void 0}}function $d(e,t){let{queueStore:r,analysisStore:n,transport:s,getWorkspacePath:o,onOpenTranscript:a}=t,i=document.createElement("dialog");i.id="worker-parallel-analysis-dialog",i.className="pa",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),e.appendChild(i);let c=new Map,u=new Map,d=!1,p=null,_=null,h=null,$=new Set,O=!1,B=0,K=null,H=new Set;function P(){return r&&r.get()||{revision:0,queue:[],serial_lanes:[],serial_lane_count:0,attempts:{},pr_wait:[]}}function q(){return n&&n.get()||{settings:{revision:0,runner:null,model:null,effort:null},job:null,runs:[],last_good:null}}function L(){return o&&o()||""}async function U(){if(!s)return;let k=++B;O=!0,h=null,$.clear(),We();try{let E=await s("worker-parallel-analysis-targets",{root_dir:L()});if(k!==B||!Ye)return;let F=Array.isArray(E?.qualified)?E.qualified:[],ee=Array.isArray(E?.excluded)?E.excluded:[];h={qualified:F,excluded:ee};for(let ke of F)ke&&typeof ke.id=="string"&&$.add(ke.id)}catch{k===B&&Ye&&(h={qualified:[],excluded:[]},me("\uBD84\uC11D \uB300\uC0C1\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800))}finally{k===B&&(O=!1,Ye&&We())}}function b(k){return Array.isArray(k.runs)?k.runs:[]}function j(){let k=P(),E=new Set;for(let F of Object.values(k.attempts||{})){let ee=F;ee&&typeof ee.bead_id=="string"&&!ph.has(ee.status)&&E.add(ee.bead_id)}for(let F of Array.isArray(k.pr_wait)?k.pr_wait:[])F&&typeof F.bead_id=="string"&&E.add(F.bead_id);for(let F of Object.values(k.discard_operations||{})){let ee=F;ee&&ee.phase!=="done"&&typeof ee.bead_id=="string"&&E.add(ee.bead_id)}return E}function te(k){return k.filter(E=>re(E)===null)}function re(k){let E=P();for(let F of Array.isArray(E.serial_lanes)?E.serial_lanes:[])if(Array.isArray(F?.entries)&&F.entries.some(ee=>ee.bead_id===k))return F.id;return(Array.isArray(E.queue)?E.queue:[]).some(F=>F.bead_id===k)?"parallel":null}function _e(k,E){let F=c.get(k);return F||[...E.order]}function pe(k){if(k.length<2)return!1;let E=re(k[0]);if(!E||E==="parallel")return!1;let F=P(),ee=(Array.isArray(F.serial_lanes)?F.serial_lanes:[]).find(ve=>ve.id===E)?.entries.map(ve=>ve.bead_id);if(!Array.isArray(ee))return!1;let ke=k.map(ve=>ee.indexOf(ve));return ke.every(ve=>ve>=0)&&ke.every((ve,Me)=>Me===0||ve>ke[Me-1])}function be(){let k=P(),E=Array.isArray(k.serial_lanes)?k.serial_lanes:[],F=E.find(ee=>Array.isArray(ee.entries)&&ee.entries.length===0);return F?F.id:E[0]?.id||"s1"}function Te(k){let E=P().bead_titles||{};return typeof E[k]=="string"?E[k]:k}async function Le(k,E){if(!s||d)return null;d=!0,We();try{return await s(k,E)}finally{d=!1,We()}}async function ne(k){n?.setPending?.(!0);try{let E=await Le("worker-parallel-analysis-start",{force:k,target_ids:Array.from($)});E&&E.applied===!1&&E.reason&&(E.reason==="target_not_qualified"&&Array.isArray(E.detail)?me(`\uBD84\uC11D \uB300\uC0C1 \uC790\uACA9 \uBCC0\uACBD: ${E.detail.join(", ")}`,"error",3200):me(`\uBD84\uC11D \uC2E4\uD328: ${E.reason}`,"error",2800))}finally{n?.setPending?.(!1)}}async function oe(){let k=q().job;!s||!k||await s("worker-parallel-analysis-cancel",{job_id:k.job_id})}async function Ae(k){if(!(!s||H.has(k))){H.add(k),We();try{let E=await s("worker-parallel-analysis-prompt",{root_dir:L(),run_id:k});if(!Ye)return;if(E?.ok===!0&&typeof E.prompt=="string"){K={run_id:k,prompt:E.prompt};return}me(E?.reason==="not_found"?"\uC800\uC7A5\uB41C \uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBD84\uC11D \uD504\uB86C\uD504\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4","error",2800)}finally{H.delete(k),We()}}}function D(){K=null,We()}async function ie(){if(!K)return;let k=await tr(K.prompt);me(k?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",k?"success":"error",1400)}function se(k,E){a&&a(k,li(E))}function Se(){return P().runner_catalog}function Ce(k){return Object.keys(Se()?.runners?.[k]?.models||{})}function C(k){let E=Ce(k),F=Se()?.runners?.[k]?.default_model;return typeof F=="string"&&E.includes(F)?F:E[0]||""}function V(){let k=q().settings,E=p||k.runner||"claude",F=Ce(E),ee=p?C(E):k.model||F[0]||"",ke=ii(Se(),E,ee),ve=k.effort||"",Me=ke.includes(ve)?ve:ke[0]||"";return{runner:E,model:ee,effort:Me,models:F,efforts:ke}}async function $e(k){let E=q().settings,F=await Le("worker-parallel-analysis-settings-update",{expected_revision:E.revision,runner:k.runner,model:k.model,effort:k.effort});(!F||F.applied!==!0)&&(p=null,We(),F&&F.reason&&me(`\uBD84\uC11D \uC124\uC815 \uAC70\uBD80: ${F.reason}`,"error",2800))}function Ne(k){p=k,We();let E=V();$e({runner:k,model:E.model,effort:E.effort})}function Pe(k){let E=V(),F=ii(Se(),E.runner,k);$e({runner:E.runner,model:k,effort:F.includes(E.effort)?E.effort:F[0]||""})}function He(k){let E=V();$e({runner:E.runner,model:E.model,effort:k})}async function Ze(k,E){if(!s||d)return;let F=_e(k,E),ee=q();if(F.length<2||!ee.last_good){me("\uC81C\uCD9C\uD558\uB824\uBA74 2\uAC1C \uC774\uC0C1\uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4","warning");return}let ke=u.get(k)||be(),ve=()=>({snapshot_digest:ee.last_good.identity_digest,group_index:k,lane:ke,ordered_bead_ids:F,expected_revision:P().revision});d=!0,We();try{let Me=await s("worker-parallel-analysis-submit",ve());Me&&Me.queue&&r&&r.set(Me.queue),Me&&Me.applied!==!0&&Me.conflict===!0&&(Me=await s("worker-parallel-analysis-submit",ve()),Me&&Me.queue&&r&&r.set(Me.queue)),Me&&Me.applied===!0?(c.delete(k),me(`\uC9C1\uB82C \uB808\uC778 ${ke}\uC5D0 ${F.length}\uAC1C \uBC30\uCE58`,"success")):me(`\uC81C\uCD9C \uAC70\uBD80: ${Me?.reason||"conflict"} (\uD050 \uBB34\uBCC0\uACBD)`,"error",2800)}finally{d=!1,We()}}function ot(k,E,F){c.set(k,_e(k,E).filter(ee=>ee!==F)),We()}function at(k){c.delete(k),We()}function nt(k,E,F,ee){let ke=[..._e(k,E)],ve=ke.indexOf(F),Me=ve+ee;ve<0||Me<0||Me>=ke.length||(ke.splice(Me,0,...ke.splice(ve,1)),c.set(k,ke),We())}function Y(){let k=q().settings,E=Object.keys(Se()?.runners||{}),F=V();return l`<div class="pa-settings">
      ...
      ${Z(k)}
    </div>`}function Z(k){return!Ve(k)||Ee(k)?l`<span class="pa-settings__unset">분석 모델 설정 필요</span>`:k.compatible===!1?l`<span class="pa-settings__incompatible"
      ...
      >`:k.is_default===!0?l`<span class="pa-settings__default">기본값</span>`:""}function Ee(k){return k.is_default===!0&&k.compatible===!1}function Ve(k){return!!(k.runner&&k.model&&k.effort)}function ze(k){return Ve(k)&&k.compatible!==!1}function fe(k){let E=Math.max(0,Math.floor(k/1e3)),F=Math.floor(E/60),ee=E%60;return`${F}:${String(ee).padStart(2,"0")}`}function R(k){let E=k.job;if(E){let F=typeof E.started_at=="number"?E.started_at:0,ee=`${E.runner||"?"}/${E.model||"?"}`,ke=F?` \xB7 \uACBD\uACFC ${fe(Date.now()-F)}`:"",ve=typeof E.session_id=="string"?E.session_id:"",Me=b(k).find(De=>De.run_id===E.job_id);return l`<span class="pa-meta__progress">
        ...
        <button
          ...
          ?disabled=${Me?.prompt_saved!==!0||H.has(E.job_id)}
          @click=${()=>{Ae(E.job_id)}}
        >
          프롬프트
        </button>
        ...
        >`:""}function Q(){return n?.isPending?.()===!0}function ae(k){let E=!!k.job,F=ze(k.settings),ee=h!==null&&$.size===0,ke=E||d||Q()||O;return l`<div class="pa-meta">
    ...
    </div>`}function J(k){return typeof k=="string"&&k.length>0?k:"\uBBF8\uBC30\uCE58"}function qe(k,E){E?$.add(k):$.delete(k),We()}function Qe(k){let E=Array.isArray(k.scope)?k.scope:[],F=Array.isArray(k.overlaps)?k.overlaps:[];return E.length===0&&F.length===0?l``:l`<span class="pa-target__signals">
...
`)}>
    ...
    </section>`}function yt(){return K?l`<div
      class="pa-prompt-popup"
      role="dialog"
      aria-modal="true"
      aria-label="분석 프롬프트"
    >
      <div class="pa-prompt-popup__backdrop" @click=${D}></div>
...
${K.prompt}</pre
    ...
    </div>`:""}function gt(k,E){let F=_e(k,E),ee=j(),ke=F.filter(Je=>ee.has(Je)),ve=te(F),Me=pe(F),De=Array.isArray(P().serial_lanes)?P().serial_lanes:[],Rt=u.get(k)||be(),lt=E.eligible!==!0||F.length<2||ke.length>0||ve.length>0||Me||d;return l`<section class="pa-group" data-group-index=${String(k)}>
    ...
    </div>`}function kt(){let k=Ye&&!!q().job;if(k&&_===null){_=setInterval(()=>We(),1e3);return}!k&&_!==null&&(clearInterval(_),_=null)}function We(){let k=q();p&&k.settings.runner===p&&(p=null);let E=k.last_good?.result;kt(),Ke(l`
...
`):[];return l`<div
    ...
    </div>`}function h(){Ke(_(),n)}async function $(){if(o!=="ready")return;let L=await tr(a);me(L?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",L?"success":"error")}function O(L){L.key==="Escape"&&s&&(L.preventDefault(),P())}function B(){d||(document.addEventListener("keydown",O),d=!0)}function K(){d&&(document.removeEventListener("keydown",O),d=!1)}async function H(L,U=null){let b=++c;B(),s={...L},u=U||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",h(),n.querySelector(".repo-ops-script-viewer__close")?.focus();let te=t?t():"";if(!te){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",h();return}if(!r){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",h();return}let re="/api/repo-ops-script?workspace="+encodeURIComponent(te)+"&lane="+encodeURIComponent(L.lane)+"&base_sha="+encodeURIComponent(L.base_sha);try{let _e=await r(re),pe=await _e.json().catch(()=>({}));if(b!==c)return;if((t?t():"")!==te){P();return}if(!_e.ok||!pe||pe.ok!==!0){o="error",i=yh(pe&&typeof pe.error=="string"?pe.error:""),h();return}s={lane:pe.lane,base_sha:pe.base_sha,path:pe.path,base_ref:pe.base_ref},a=String(pe.content),o="ready",h()}catch{if(b!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",h()}}function P(){c+=1,K(),s=null,a="",h();let L=u;u=null,L?.isConnected&&L.focus()}function q(){P(),n.remove()}return{open:H,close:P,destroy:q}}function Td(e){let t=e.queueStore,r=e.transport,n=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let b=o();return typeof b.revision=="number"?b.revision:0}function i(b){t&&b&&b.queue&&typeof b.queue=="object"&&t.set(b.queue)}function c(){let b=o().workspace_info;return b&&typeof b=="object"?b:{}}function u(b,j){return l`<span
    ...
    ></button>`}function h(){let b=o().repo_ops_opt_out;return{verify:b?.verify===!0,deploy:b?.deploy===!0}}function $(b,j){return l`<label class="worker-repo-ops__lane-run">
      <input
        type="checkbox"
        .checked=${!j}
        @change=${te=>{H(b,!te.target.checked)}}
      />
      이 workspace에서 실행
    ...
    </section>`}async function K(b){if(!r)return;let j=await r("worker-auto-repair-toggle",{on:b,expected_revision:a()});if(i(j),j&&j.conflict){let te=await r("worker-auto-repair-toggle",{on:b,expected_revision:a()});i(te)}n()}async function H(b,j){if(!r)return;let te=await r("worker-repo-ops-opt-out-toggle",{kind:b,opted_out:j,expected_revision:a()});if(i(te),te&&te.conflict){let re=await r("worker-repo-ops-opt-out-toggle",{kind:b,opted_out:j,expected_revision:a()});i(re)}n()}let P={owned_deploy_worktree_fetch_detached_alignment_recreate:"\uC804\uC6A9 \uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC \uC815\uB82C\xB7\uBCF5\uAD6C",recovered_pre_execution_fetch_timeout_retry_once:"fetch \uD0C0\uC784\uC544\uC6C3 1\uD68C \uBCF5\uAD6C",repo_serial_lock_wait:"\uC800\uC7A5\uC18C \uC21C\uCC28 \uC2E4\uD589 \uB300\uAE30",restart_operation_adoption:"\uC7AC\uC2DC\uC791 \uD6C4 \uC791\uC5C5 \uC778\uACC4",exact_input_exit_zero_evidence_adoption:"\uB3D9\uC77C \uC785\uB825 \uC131\uACF5 \uC99D\uAC70 \uC778\uACC4",descendant_success_covers_ancestor_rows:"\uCD5C\uC2E0 SHA \uC131\uACF5\uC774 \uC774\uC804 \uD589 \uCEE4\uBC84",owned_verify_candidate_cleanup:"\uAC80\uC99D \uC784\uC2DC \uCCB4\uD06C\uC544\uC6C3 \uC815\uB9AC",script_retry:"\uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4",auto_repair_session:"\uC790\uB3D9 \uD574\uACB0 \uC138\uC158",user_triggered_session:"\uC0AC\uC6A9\uC790 \uD574\uACB0 \uC138\uC158",automatic:"\uC790\uB3D9",user_action_only:"\uC0AC\uC6A9\uC790 \uD074\uB9AD",script_identity_present:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC788\uC744 \uB54C\uB9CC",per_completion_chain:"\uC644\uB8CC \uCCB4\uC778\uB2F9",unbounded:"\uD69F\uC218 \uC81C\uD55C \uC5C6\uC74C",bounded_single_script_retry_exceeded:"\uB2E8\uC77C \uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4 \uD55C\uB3C4 \uCD08\uACFC",baseline_failure_ignore:"\uAE30\uC874 \uC2E4\uD328 \uBB34\uC2DC",config_or_script_deletion_to_bypass_gate:"\uC124\uC815\xB7\uC2A4\uD06C\uB9BD\uD2B8 \uC0AD\uC81C\uB85C \uAC8C\uC774\uD2B8 \uC6B0\uD68C",credential_entry:"\uC790\uACA9\uC99D\uBA85 \uC785\uB825\xB7\uCD9C\uB825",destructive_action:"\uD30C\uAD34\uC801 \uC791\uC5C5",history_rewrite:"\uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131",agent_self_report_as_success:"\uC138\uC158 \uC790\uAE30\uBCF4\uACE0\uB97C \uC131\uACF5 \uCC98\uB9AC",unbounded_repair_session_retry:"\uBB34\uD55C \uD574\uACB0 \uC138\uC158 \uBC18\uBCF5"};function q(b,j,te){return l`<div class="worker-repo-ops__policy-group" data-policy=${te}>
    ...
    >
      ...
      <ol class="worker-repo-ops__policy-list">
        ${b.map(j=>{let te=[P[j.trigger]||j.trigger];return Number.isInteger(j.attempts_per_operation_attempt)?te.push(`operation\uB2F9 ${j.attempts_per_operation_attempt}\uD68C`):Number.isInteger(j.attempts)?te.push(`${P[j.budget]||j.budget} ${j.attempts}\uD68C`):Number.isInteger(j.sessions_per_user_action)&&te.push(`${j.sessions_per_user_action}\uD68C`,P[j.user_actions]||j.user_actions),j.applies_when&&te.push(P[j.applies_when]||j.applies_when),l`<li data-token=${j.id}>
            <strong>${P[j.id]||j.id}</strong>
...
${Nt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:z==="done"?ir(f.attempts||{},ge.bead_id):null,work_ms:z==="done"?vo(f.attempts||{},ge.bead_id):null,done_at:z==="done"&&typeof ge.added_at=="number"?ge.added_at:void 0,exec_chips:mt?Oe(ge.bead_id):null,...Br(ge.bead_id)}}),pn=f.attempts?Object.values(f.attempts):[],No=new Set;for(let g of pn)g&&typeof g.resumed_from=="string"&&g.resumed_from.length>0&&No.add(g.resumed_from);let bi=new Map;for(let g of pn)bi.set(g.bead_id,g.attempt_id);let ys=new Map;for(let g of pn)ys.set(g.attempt_id,g);function qo(g){let z=new Set,ge=g;for(;ge&&!z.has(ge.attempt_id);){if(ge.conflict_resolution===!0)return!0;z.add(ge.attempt_id),ge=typeof ge.resumed_from=="string"&&ge.resumed_from.length>0&&ys.get(ge.resumed_from)||null}return!1}let vs=typeof f.declared_base=="string"?f.declared_base:null;function dp(g){let z=null;for(let ge of pn)!ge||ge.bead_id!==g||qo(ge)||(z===null||(typeof ge.started_at=="number"?ge.started_at:0)>=(typeof z.started_at=="number"?z.started_at:0))&&(z=ge);return z&&typeof z.target_base=="string"?z.target_base:null}let yi=[],vi=[],pp=wd(f),wi=g=>{let z=typeof g.session_id=="string"&&g.session_id.length>0,ge=No.has(g.attempt_id);return{eligible:z&&!ge,reason:z?ge?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},ur=null;for(let g of pn){let z=g.status==="paused"&&!No.has(g.attempt_id);if(g.status==="running"||z)vi.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:tt.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,paused:z,conflict_resolution:qo(g),base_exception:ui(vs,g.target_base),can_pause:typeof g.session_id=="string"&&g.session_id.length>0,discard:vr(bs,g.bead_id,{attempt_id:g.attempt_id}),usage:ir(f.attempts||{},g.bead_id),rollup:dt(g.bead_id),rollup_expanded:pe.has(g.bead_id),exec_chips:X(g),...Br(g.bead_id)});else if((g.status==="failed"||g.status==="orphaned")&&pp(g)){let ge=wi(g);yi.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:tt.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,failed:!0,status:g.status,status_label:g.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:vr(bs,g.bead_id,{attempt_id:g.attempt_id}),resume_eligible:ge.eligible,resume_reason:ge.reason,conflict_resolution:qo(g),base_exception:ui(vs,g.target_base),usage:ir(f.attempts||{},g.bead_id),rollup:dt(g.bead_id),rollup_expanded:pe.has(g.bead_id),exec_chips:X(g),...Br(g.bead_id)}),ur=g}}let ws=[...yi,...vi].map(g=>{let z=ys.get(g.attempt_id),ge=z?.quickfix_landing;if(z?.quickfix_lane!==!0||!ge||typeof ge!="object")return g;let Ge=typeof ge.reason=="string"&&ge.reason.length>0?ge.reason:null,mt=fs({bead_id:z.bead_id,merge_sha:ge.head_sha,cleanup_cursor:ge.cursor,cleanup_failed:Ge?{step:ge.cursor,reason:Ge}:null,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]});return mt?{...g,landing:mt}:g}),ki=null;if(ur){let g=wi(ur),z=ur.cause_detail;ki={bead_id:ur.bead_id,repo:ur.repo||"",reason:ur.cause||ur.status,cause_detail:z&&typeof z.reason=="string"?{reason:z.reason,command:typeof z.command=="string"?z.command:null}:null,resume_attempt_id:ur.attempt_id,resume_eligible:g.eligible,resume_reason:g.reason,discard:vr(bs,ur.bead_id,{attempt_id:ur.attempt_id})}}let $i=new Set(ws.map(g=>g.bead_id)),Fo=Array.isArray(f.merge_queue)?f.merge_queue:[],xi=new Map,Ai=new Map,Si=new Map,Ei=new Map,Ti=new Map;Fo.forEach((g,z)=>{g&&typeof g.bead_id=="string"&&(xi.set(g.bead_id,z+1),Ai.set(g.bead_id,g.resolution),Si.set(g.bead_id,g.continuation_action||null),Ei.set(g.bead_id,g.head_review||null),Ti.set(g.bead_id,g.authority||null))});let fn=f.merge_queue_state||{active:null,failures:{}},fp=fn.failures||{},Ci=fn.waiting&&typeof fn.waiting.bead_id=="string"&&typeof fn.waiting.reason=="string"?fn.waiting:null,_p=f.auto_merge_skips||{},Ri=g=>{let z=_p[g];if(!z)return null;let ge=un[g],Ge=ge&&ge.pr?ge.pr.head_sha:null;return Ge&&Ge===z.head_sha?z.reason||"":null},ks=new Map;for(let g of ws)g.failed!==!0&&g.conflict_resolution&&(g.paused?ks.has(g.bead_id)||ks.set(g.bead_id,"paused"):ks.set(g.bead_id,"running"));let Ii=ws.filter(g=>!g.paused&&g.failed!==!0).length,Oi=(f.workspace_info||{}).slots,Li=typeof Oi=="number"?Oi:typeof f.slots=="number"?f.slots:Lo,mp=Ii>Li,$s=Kr(P),gp=(Array.isArray(f.done)?f.done.slice():[]).filter(g=>$s===void 0||typeof g.added_at!="number"||g.added_at>=$s).sort((g,z)=>(z.added_at||0)-(g.added_at||0)),Mn=Do(gp,"done"),hp=new Set((Array.isArray(f.done)?f.done:[]).map(g=>g?.bead_id).filter(g=>typeof g=="string")),Mi=[],bp=u?.()||"";for(let g of m){let z=Qr(g.closed_at);if(typeof g.id!="string"||hp.has(g.id)||z===null||$s!==void 0&&z<$s||typeof g.comment_count!="number"||g.comment_count<=0)continue;let ge=`${bp}\0${g.id}\0${String(g.updated_at)}\0${g.comment_count}`,Ge=q.get(ge);Ge===void 0&&r&&(q.set(ge,"pending"),Promise.resolve(r("get-comments",{id:g.id})).then(mt=>{let jt=Array.isArray(mt)&&mt.some(Nt=>lo(typeof Nt?.text=="string"?Nt.text:"")?.lane==="session");q.set(ge,jt?"session":"not-session"),Fe()}).catch(()=>{q.set(ge,"failed"),Fe()})),Ge==="session"&&Mi.push({id:g.id,title:g.title||g.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:z,created_at:g.created_at,updated_at:g.updated_at})}Mn.push(...Mi),Mn.sort((g,z)=>(z.done_at||0)-(g.done_at||0));let xs={};for(let g of $r)xs[g]=0;let Pi=!1,Di=0,jo=0,Ni=0;for(let g of Mn){let z=g.usage;if(z&&typeof z=="object"){let ge=!1;for(let Ge of $r)Number.isFinite(z[Ge])&&(xs[Ge]+=z[Ge],Pi=!0,ge=!0);ge&&(jo+=1,Number.isFinite(z.total_cost_usd)&&(Di+=z.total_cost_usd,Ni+=1))}}jo>0&&Ni===jo&&(xs.total_cost_usd=Di);let qi=Mn.map(g=>g.usage).filter(g=>g&&typeof g=="object"&&g.providers),yp=qi.length>0?Wt(Vs(qi)):Pi?xr(xs):null,vp=f.lane_states&&typeof f.lane_states=="object"&&!Array.isArray(f.lane_states)?f.lane_states:{},wp=Array.isArray(f.serial_lanes)?f.serial_lanes:[],Fi=g=>{if(Ur.some(Ge=>Ge.bead_id===g))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let z=pn.filter(Ge=>Ge&&Ge.bead_id===g),ge=z.length>0?z[z.length-1].status:null;return ge==="failed"||ge==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":ge==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},ji=wp.filter(g=>g&&typeof g.id=="string"&&Array.isArray(g.entries)).map((g,z)=>{let ge=vp[g.id]||{},Ge=new Map((Array.isArray(ge.corrections)?ge.corrections:[]).filter($t=>$t&&typeof $t.bead_id=="string"&&typeof $t.after=="string").map($t=>[$t.bead_id,$t.after])),mt=Do(g.entries.filter($t=>!$i.has($t.bead_id)),g.id).map($t=>Ge.has($t.id)?{...$t,badges:[`\u{1F517} ${Ge.get($t.id)} \uB4A4 (blocks \uC790\uB3D9)`,...$t.badges]}:$t),jt=Array.isArray(ge.occupied_by)?ge.occupied_by.filter($t=>typeof $t=="string"):[],Nt=jt.map($t=>({id:$t,title:tt.get($t)||$t,draggable:!1,lane:g.id,ghost:!0,badges:[Fi($t)]}));return{id:g.id,index:z+1,rows:[...Nt,...mt],occupied:jt.length>0,badge:jt.length>0?Fi(jt[0]):"\uB300\uAE30",cycle:ge.cycle===!0}}),kp=typeof f.serial_lane_count=="number"?f.serial_lane_count:ji.length;return{queue:f,idToTitle:tt,candidates:cp,candidate_hidden:{blocked:Po.hidden_blocked,spec:Po.hidden_spec},running:ws,live_count:Ii,slots:Li,over_cap:mp,failure:ki,waiting:Do(dn.filter(g=>!$i.has(g.bead_id)),"queue"),serial_lanes:ji,serial_lane_count:kp,pr_wait:Ur.map(g=>sb(g.bead_id,tt.get(g.bead_id)||g.bead_id,un,Be[g.bead_id]||null,ir(f.attempts||{},g.bead_id),hs[g.bead_id]||(j.has(g.bead_id)||te.has(g.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),ks.get(g.bead_id)||null,g.external===!0,{position:xi.get(g.bead_id)||0,active:fn.active===g.bead_id,failure:fp[g.bead_id]||null,waiting:Ci?.bead_id===g.bead_id?Ci.reason:null,resolution:Ai.get(g.bead_id),continuation_action:Si.get(g.bead_id),head_review:Ei.get(g.bead_id)||null,authority:Ti.get(g.bead_id)||null},g.wt_present!==!1,f.auto_merge===!0?Ri(g.bead_id):null,ui(vs,dp(g.bead_id)),f.completion_status&&typeof f.completion_status=="object"&&!Array.isArray(f.completion_status)&&f.completion_status[g.bead_id]||null,f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},ys.get(bi.get(g.bead_id)||"")?.worker_serial===!0,f.auto_merge===!0,{merge_sha:g.merge_sha,cleanup_cursor:g.cleanup_cursor,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]})).map(g=>({...g,...Br(g.id)})),merge_queue_length:Fo.length,merge_queue_running:Fo.length>0,auto_excluded:Ur.map(g=>g.bead_id).filter(g=>Ri(g)!==null),declared_base:vs,done:Mn,token_total:yp,cleanup_failures:Tt,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]}}function ee(){let x=!!o?.get()?.job,G=!x&&o?.isPending?.()===!0,m=x?"\uBD84\uC11D \uC911":G?"\uC900\uBE44 \uC911":"";return l`<button
    ...
    </button>`}function ke(f){let x=f.waiting.length>0?f.waiting[0].id:"\u2014",G=l`<button
      type="button"
    ...
    >`,je=l`<label class="worker-tgl worker-slots"
      ...
      <label
        ...
        <select class="worker-serial-lane-count" aria-label="직렬 레인 수">
          ${Array.from({length:Dd},(X,N)=>N+1).map(X=>l`<option
                value=${String(X)}
      ...
      ${o?ee():""} `,xe=vu({failure:f.failure}),A=fu(f.repo_operations,f.cleanup_failures);return b?l`<div class="worker-ribbon">
        ...
        ${A}${Y.template()}${xe}`:l`<div class="worker-ctrl">
      ...
      ${A}${Y.template()}${xe}`}function ve(f){if(f.running.length===0&&f.pr_wait.length===0)return"";let x=f.running.some(G=>!G.paused&&G.failed!==!0);return l`<section
    ...
    >
    ...
    </section>`}function Me(f){let x=f.candidate_hidden;return l`<div class="worker-filter">
      ...
      .value=${H}
    >
      ${Bh.map(f=>l`<option value=${f.value} ?selected=${H===f.value}>
            ${f.label}
          </option>`)}
      ...
      <select
        ...
        .value=${P}
      >
        ${Ir.map(f=>l`<option value=${f.value} ?selected=${P===f.value}>
              ${f.label}
            </option>`)}
      </select>
    </div>`}function lt(f){let x=l`<span
      class="worker-lane__badge${f.occupied?" worker-lane__badge--held":""}"
      >${f.badge}</span
    >`,G=f.cycle?l`<div class="worker-lane__cycle">
          ⚠ blocks 순환 감지 — 자동 정렬을 생략했습니다
        </div>`:"";return cr({id:`worker-pane-lane-${f.id}`,lane:f.id,title:`\uC9C1\uB82C ${f.index}`,items:f.rows,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uD589\uC744 \uC5EC\uAE30\uB85C \uB4DC\uB798\uADF8",header_control:x,controls:G})}function Je(f){let x=f.queue.auto_merge===!0;if(f.merge_queue_running)return l`<button
        type="button"
    ...
    >
      ▶ 자동 머지${m>0?` ${m}`:""}
    </button>`}function Dt(f){let x=cr({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:f.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:De(),controls:Me(f),place_menu:ze(f.candidates)});return b?l`<div class="worker-lanes worker-lanes--mobile">
        ${ve(f)}
        ...
        ${f.serial_lanes.map(G=>lt(G))}
        ${x}
        ${cr({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:f.done,empty:`${L()} \uC644\uB8CC \uC5C6\uC74C`,controls:Rt(),collapsible:!0,collapsed:U.done,preview:Array.isArray(f.token_total)?f.token_total.map(G=>G.label).join(" \xB7 "):f.token_total||Fd(f.done)})}
    ...
    </div>`}function Ut(f){U={...U,[f]:!U[f]},Kh(U),Fe()}function Fe(){let f=F();Ke(ke(f),Se),Ke(Dt(f),Ne)}function Ft(){if(typeof window.matchMedia!="function")return;let f=window.matchMedia(Gh);b=!!f.matches;let x=G=>{let m=!!(G&&typeof G.matches=="boolean"?G.matches:f.matches);m!==b&&(b=m,Fe())};typeof f.addEventListener=="function"?(f.addEventListener("change",x),oe.push(()=>f.removeEventListener("change",x))):typeof f.addListener=="function"&&(f.addListener(x),oe.push(()=>f.removeListener(x)))}let It=null;function zt(f){It=f.target instanceof Element?f.target:null}function v(f){let G=f.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!G)return;if(It&&G.contains(It)&&It.closest("input, button, a")){f.preventDefault();return}let m=G.dataset.beadId||"",y=G.dataset.lane||"";$={bead_id:m,from_lane:y};try{f.dataTransfer?.setData("text/plain",m),f.dataTransfer&&(f.dataTransfer.effectAllowed="move")}catch{}}function w(f){let x=f.target?.closest?.(".worker-pane");if(!x)return;let G=x.dataset.lane||"";G!=="candidate"&&G!=="queue"&&!/^s[1-5]$/.test(G)||(f.preventDefault(),f.dataTransfer&&(f.dataTransfer.dropEffect="move"),x.classList.add("worker-pane--drag-over"))}function I(f){f.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function W(f,x){let G=O.find(ce=>ce.id===f);if(!G)return;let m=O.filter(ce=>ce.id!==f),y=m.length;if(x){let ce=x.dataset.beadId;if(ce===f)return;let je=m.findIndex(xe=>xe.id===ce);je>=0&&(y=je)}let ue=m.slice();ue.splice(y,0,G),h.applyReorder(f,ue,y)}function ye(f){let x=f.target?.closest?.(".worker-pane");if(!x)return;f.preventDefault(),x.classList.remove("worker-pane--drag-over");let G=x.dataset.lane||"",m=$?.bead_id||f.dataTransfer?.getData("text/plain")||"",y=$?.from_lane||"";if($=null,!m)return;let ue=f.target?.closest?.(".worker-mini, .worker-card"),ce=Array.from(x.querySelectorAll(".worker-mini, .worker-card")),je=ce.length;if(ue){let xe=ce.indexOf(ue);xe>=0&&(je=xe)}if(je=Math.max(0,je-x.querySelectorAll(".worker-mini--ghost").length),x.classList.contains("worker-pane--collapsed")&&(je=Q()),G==="candidate"){if(y==="candidate"){W(m,ue);return}(y==="queue"||/^s[1-5]$/.test(y))&&qe(m);return}if(G==="queue"||/^s[1-5]$/.test(G)){let xe=G==="queue"?"parallel":G;y===G?J(m,xe,je):ae(m,xe)}}function we(f){B=f,qh(f),Fe()}function he(f){H=f==="board"||f==="created"||f==="spec"?f:Mo,Wh(H),Fe()}function et(f){P=or(f)?f:er,Hh(P),p?.(P),Fe()}function Ie(f){let x=f.target?.closest?.(".worker-serial-lane-count");if(x){let je=Number.parseInt(x.value,10);Number.isFinite(je)&&E(je).then(Fe);return}let G=f.target?.closest?.(".worker-filter__blocked");if(G){we({...B,show_blocked:G.checked});return}let m=f.target?.closest?.(".worker-done-range");if(m){et(m.value);return}let y=f.target?.closest?.(".worker-sort");if(y){he(y.value||Mo);return}let ue=f.target?.closest?.(".worker-slots__input");if(!ue)return;let ce=Number.parseInt(ue.value,10);if(!Number.isFinite(ce)){Fe();return}k(ce).then(Fe)}function T(f){return f?{runner:f.runner||void 0,model:f.model||void 0,effort:f.effort||void 0,worktree:f.worktree||void 0,status:f.status||void 0,session_id:f.session_id||void 0}:{}}function le(){let f=F();return{operations:f.repo_operations,cleanup_failures:f.cleanup_failures,repo:u&&u()||""}}function Re(){Pe&&Ze.close(),$e.hidden=!1,Ce.hidden=!1,ot.open(le()),Fe()}function _t(f){let x=Ee(),G=x.attempts?x.attempts[f]:null;Pe=f,He=null,ot.close(),$e.hidden=!0,Ce.hidden=!1,Ze.open({attempt_id:f,meta:T(G)}),Fe()}function Mt(f,x){Pe=null,He=f,ot.close(),$e.hidden=!0,Ce.hidden=!1,Ze.open({attempt_id:f,meta:x,hide_prompt:!0}),Fe()}function vt(){if(ot.isOpen()&&ot.refresh(le()),He){let G=(o?.get()?.runs||[]).find(m=>m.run_id===He);G?Ze.updateMeta(li(G)):Ze.close();return}if(!Pe)return;let f=Ee(),x=f.attempts?f.attempts[Pe]:null;if(x){Ze.updateMeta(T(x));return}Ze.close()}function Pt(f){let x=f.target;if(x?.closest?.(".worker-mini__serial, .worker-mini__grip")||x?.closest?.("#worker-parallel-analysis-dialog"))return;if(x?.closest?.(".worker-analysis-btn")){Z?.open();return}if(x?.closest?.(".worker-repo-strip")||x?.closest?.(".worker-mini__timeline")){Re();return}let G=x?.closest?.(".worker-repo-op__session");if(G){let Be=G.dataset.attemptId;Be&&_t(Be);return}let m=x?.closest?.(".worker-repo-op__resolve");if(m){M(m.dataset.operationId||"");return}let y=x?.closest?.(".worker-repo-op__dismiss");if(y){de(y.dataset.operationId||"");return}let ue=x?.closest?.(".worker-cleanup__resume");if(ue){let Be=ue.dataset.beadId;Be&&gt(Be);return}let ce=x?.closest?.(".worker-banner__resume");if(ce){let Be=ce.dataset.attemptId;Be&&it(Be);return}let je=x?.closest?.(".worker-banner__discard");if(je){let Be=je.dataset.confirmation==="merged"?"merged":"unmerged";Ue(je.dataset.beadId||"",je.dataset.attemptId||null,Be,je.dataset.operationId||null);return}let xe=x?.closest?.(".worker-banner__dismiss");if(xe){let Be=xe.dataset.attemptId;Be&&Xe(Be);return}if(x?.closest?.(".worker-play")){S(!Ee().auto_advance);return}let A=x?.closest?.(".worker-merge-all");if(A){A.classList.contains("worker-merge-all--stop")?Ee().auto_merge===!0?kt(!1):Ye():kt(!0);return}let X=x?.closest?.(".worker-pane__hd--toggle");if(X){let Be=X.dataset.lane;(Be==="queue"||Be==="done")&&Ut(Be);return}let N=x?.closest?.(".worker-card__place-lane");if(N){let Be=N.dataset.beadId,Tt=N.dataset.lane;Be&&(Tt==="parallel"||/^s[1-5]$/.test(Tt||""))&&(K=null,Fe(),ae(Be,Tt));return}if(x?.closest?.(".worker-card__place-cancel")){K=null,Fe();return}let dt=x?.closest?.(".worker-card__place");if(dt){let Be=dt.dataset.beadId;Be&&!dt.disabled&&(Ve()?(K=Be,Fe()):ae(Be,"parallel"));return}let st=x?.closest?.(".worker-filter__chip");if(st){let Be=st.dataset.spec;(Be==="all"||Be==="with"||Be==="without")&&we({...B,spec:Be});return}let tt=x?.closest?.(".worker-mini__merge");if(tt){let Be=tt.dataset.beadId||"";Ee().cleanup_failed?.[Be]?gt(Be):yt(Be);return}let rt=x?.closest?.(".worker-mini__merge-cancel");if(rt){We(rt.dataset.beadId||"");return}let Ot=x?.closest?.(".worker-mini__discard");if(Ot){Ue(Ot.dataset.beadId||"",Ot.dataset.attemptId||null,Ot.dataset.discardMode==="merged"?"merged":"unmerged",Ot.dataset.operationId||null);return}let Jt=x?.closest?.(".worker-mini__stale-continue");if(Jt){ut("worker-stale-work-continue",Jt.dataset.beadId||"",Jt.dataset.actionId||"");return}let an=x?.closest?.(".worker-mini__stale-backup");if(an){ut("worker-stale-work-backup-fresh",an.dataset.beadId||"",an.dataset.actionId||"");return}let ln=x?.closest?.(".worker-mini__stale-recheck");if(ln){ut("worker-stale-work-recheck",ln.dataset.beadId||"",ln.dataset.actionId||"");return}let gs=x?.closest?.(".worker-mini__revise-fix");if(gs){At("worker-revise-fix",gs.dataset.beadId||"");return}let cn=x?.closest?.(".worker-mini__revise-approve");if(cn){At("worker-revise-approve",cn.dataset.beadId||"");return}if(x?.closest?.(".worker-mini__pr"))return;if(x?.closest?.(".rtile__discard")){let Be=x?.closest?.(".rtile"),Tt=Be?.dataset?.beadId,dn=Be?.dataset?.attemptId;Tt&&Ue(Tt,dn||null,"unmerged",x?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if(x?.closest?.(".rtile__dismiss")){let Tt=x?.closest?.(".rtile")?.dataset?.attemptId;Tt&&Xe(Tt);return}if(x?.closest?.(".rtile__pause")){let Tt=x?.closest?.(".rtile")?.dataset?.attemptId;Tt&&Qe(Tt);return}if(x?.closest?.(".rtile__resume")){let Tt=x?.closest?.(".rtile")?.dataset?.attemptId;Tt&&it(Tt);return}if(x?.closest?.(".rtile__session")){let Tt=x?.closest?.(".rtile")?.dataset?.attemptId;Tt&&_t(Tt);return}if(x?.closest?.(".worker-drawer-overlay__backdrop")){ot.close(),Ze.close();return}if(x?.closest?.(".worker-drawer-host"))return;let Br=x?.closest?.(".rtile .board-card__roll-toggle");if(Br){let Be=Br.dataset.rollParent;Be&&(pe.has(Be)?pe.delete(Be):pe.add(Be),Fe());return}let Ur=x?.closest?.(".rtile .board-card__roll-child");if(Ur){let Be=Ur.dataset.childId;Be&&c&&c(Be);return}let un=x?.closest?.(".rtile");if(un){if(x?.closest?.(".rtile__id")){let Tt=un.dataset.beadId;Tt&&tr(Tt).then(dn=>{dn?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let Be=un.dataset.beadId;Be&&c&&c(Be);return}let hs=x?.closest?.(".worker-mini, .worker-card");if(hs){let Be=hs.dataset.beadId;if(x?.closest?.(".worker-mini__id, .worker-card__id")){Be&&tr(Be).then(Tt=>{Tt?me("\uBCF5\uC0AC\uB428","success",1200):me("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}Be&&c&&c(Be)}}return e.addEventListener("pointerdown",zt),e.addEventListener("dragstart",v),e.addEventListener("dragover",w),e.addEventListener("dragleave",I),e.addEventListener("drop",ye),e.addEventListener("click",Pt),e.addEventListener("change",Ie),Ft(),_&&oe.push(_.subscribe(()=>{for(let[f,x]of q)x==="failed"&&q.delete(f);Fe()})),s&&oe.push(s.subscribe(()=>{let f=u&&u()||"";f!==nt&&(nt=f,at.close()),Fe(),vt()})),o&&typeof o.subscribe=="function"&&oe.push(o.subscribe(()=>{vt(),Fe()})),Fe(),{load(){D(),Fe()},refreshSessionDefaults:ie,destroy(){for(let f of oe.splice(0))try{f()}catch{}e.removeEventListener("pointerdown",zt),e.removeEventListener("dragstart",v),e.removeEventListener("dragover",w),e.removeEventListener("dragleave",I),e.removeEventListener("drop",ye),e.removeEventListener("click",Pt),e.removeEventListener("change",Ie);try{Ze.destroy()}catch{}Ce.hidden=!0;try{Z?.destroy()}catch{}try{at.destroy()}catch{}Ke(l``,e)}}}function pi(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Gd(e,t,r,n=async()=>{},s=async()=>{}){let o=St("views:workspace-picker"),a=null,i=!1,c=!1,u=!1;async function d(U){let j=U.target.value,re=t.getState().workspace?.current?.path||"";if(j&&j!==re){o("switching workspace to %s",j),i=!0,L();try{await r(j)}catch(_e){o("workspace switch failed: %o",_e)}finally{i=!1,L()}}}async function p(){let U=t.getState(),b=U.workspace?.current?.path||U.workspace?.available?.[0]?.path||"";if(!(!b||c)){o("git-pulling workspace %s",b),c=!0,L();try{await n(b)}catch(j){o("workspace git pull failed: %o",j)}finally{c=!1,L()}}}function _(U){let b=U.target;b&&e.contains(b)||O()}function h(U){U.key==="Escape"&&O()}function $(){u||(u=!0,document.addEventListener("mousedown",_),document.addEventListener("keydown",h),L())}function O(){u&&(u=!1,document.removeEventListener("mousedown",_),document.removeEventListener("keydown",h),L())}function B(){u?O():$()}async function K(U){let b=U.target,j=b.value,te=b.checked;o("toggling visibility %s \u2192 %s",j,String(te));try{await s(j,te)}catch(re){o("workspace visibility toggle failed: %o",re)}}function H(U){return U?l`
      <button
        type="button"
    ...
    `}function q(){let U=t.getState(),b=U.workspace?.current,j=U.workspace?.available||[],te=new Set(U.workspace?.hidden||[]),re=b?.path||j[0]?.path||"";if(j.length===0)return l``;let _e=j.filter(pe=>!te.has(pe.path)||pe.path===re);if(_e.length<=1){let pe=_e[0]||j[0],be=pi(pe.path);return l`
