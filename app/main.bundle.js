...
`+r.join(`
`),O=this.blockquote(A);o[o.length-1]=O,n=n.substring(0,n.length-h.raw.length)+O.raw,s=s.substring(0,s.length-h.text.length)+O.text;break}else if(_?.type==="list"){let h=_,A=h.raw+`
`+r.join(`
`),O=this.list(A);o[o.length-1]=O,n=n.substring(0,n.length-_.raw.length)+O.raw,s=s.substring(0,s.length-h.raw.length)+O.raw,r=A.substring(o.at(-1).raw.length).split(`
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+Sr(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},en=new P_;function bt(e,t){return en.parse(e,t)}bt.options=bt.setOptions=function(e){return en.setOptions(e),bt.defaults=en.defaults,fc(bt.defaults),bt};bt.getDefaults=ya;bt.defaults=tn;bt.use=function(...e){return en.use(...e),bt.defaults=en.defaults,fc(bt.defaults),bt};bt.walkTokens=function(e,t){return en.walkTokens(e,t)};bt.parseInline=en.parseInline;bt.Parser=mr;bt.parser=mr.parse;bt.Renderer=ro;bt.TextRenderer=Ea;bt.Lexer=_r;bt.lexer=_r.lex;bt.Tokenizer=to;bt.Hooks=Jn;bt.parse=bt;var Dy=bt.options,Ny=bt.setOptions,qy=bt.use,Fy=bt.walkTokens,jy=bt.parseInline;var By=mr.parse,Uy=_r.lex;function Mr(e){let t=bt.parse(e),r=oc.sanitize(t);return ac(r)}function Er(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      </div>`}if(Q.kind==="error")return l`<div class="sv__error">⛔ ${Q.text}</div>`;if(Q.kind==="blocker")return l`<div class="sv__error">⛔ ${Q.text}</div>`;if(Q.kind==="tool"){let Te=_.has(Y),Qe=Q.tool==="Bash"?Q_(Q.command):0,Ve=Q.tool==="Bash"?Qe>1?ao(Q.command):Q.command:Q.path||Q.command||"";return l`<div
...
`)}function N(){if(!o)return l``;let Y=J(),Q=(a?[d.model,d.effort]:[d.runner,d.model,d.effort]).filter(Boolean).join(" \xB7 "),Te=d.session_id||"",Qe=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${p?"ON":"OFF"}`,Ve=pe(),st=Ve?nm(ee(),Date.now()):"",et=Ve?Le(Y):null,mt=Ve?te(Y):null,Pe=rm(Y);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
      ...
      ${et||mt?l`<div class="sv__now">
            <span class="sv__now-label">지금</span>
            ${et?l`<span class="sv__now-icon">${et.icon}</span>
                  <span class="sv__now-name">${et.tool}</span>
                  <span class="sv__now-detail"
                    >${et.tool==="Bash"?ao(et.command):et.path||et.command||""}</span
                  >`:""}
...
`).trim()}}var Cc=20;function Rc(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function um(e){return e.length>Cc?`${e.slice(0,Cc)}\u2026`:e}function dm(e,t,r,n){let s=`${t.lane} ${um(t.identifier)}`;return l`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${hm.map(p=>{let _=p.receipt&&typeof t[p.receipt]=="string"?String(t[p.receipt]):"",h=n[p.id],A=_.length>0||h?.fill==="full",O=!A&&h?.fill==="dim",U=h?.stale===!0;return l`<span
          class=${`detail-summary__gate${A?" detail-summary__gate--on":""}${O?" detail-summary__gate--current":""}${U?" detail-summary__gate--stale":""}`}
          data-gate=${p.id}
        >
    ...
    `:l``}function d(){Ge(u(),e)}async function p(A,O={}){s=A,o="loading",a="",i="",d();let U=r?r():"";if(!U){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",d();return}if(!n){o="error",i="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",d();return}let V="/api/doc?workspace="+encodeURIComponent(U)+"&path="+encodeURIComponent(A);try{let H=await n(V),P=await H.json().catch(()=>({}));if(!H.ok||!P||P.ok!==!0){if(P?.error==="not_found"&&O.missing_state==="plan_pending"){o="pending",i="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",d();return}o="error",i="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(P&&P.error||H.status)+")",d();return}a=String(P.content||""),o="ready",d()}catch{o="error",i="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",d()}}function _(){s=null,Ge(l``,e)}function h(){document.removeEventListener("keydown",c),_()}return{open:p,close:_,destroy:h}}var Cm=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],ou="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",ho=["implementation","review-consult"],Rm=["running","done","failed","interrupted"],Im={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function Lm(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function Om(e){let t=Wt(e);if(t.length>0)return t.map(s=>l`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
    ...
    `}function je(){if(!u)return l``;let x=d||{},Z=String(x.id||u),D=x.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",Ie=ae(),ut=x.status||"open",it=typeof x.priority=="number"?Math.max(0,Math.min(4,x.priority)):"",rt=x.description||"",nt={...x,metadata:{...x.metadata||{},...p}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${$(D,Ie)}
          ${Hc(nt)}
          ${zc({metadata:nt.metadata,workspace_values:gt(),catalog:kt(),execution_defaults:We(),expanded:O,presets:Ue()?.presets||[],preset_id:_,preset_busy:h,skipped_orchestration_keys:A},{onToggle:Lt=>{O=Lt,xe()},onEdit:(Lt,Jt)=>{if(Lt==="impl_runtime"||Lt==="impl_model"||Lt==="impl_effort"){Rt(Lt,Jt??"");return}De(Lt,Jt??"")},onPresetSelect:Lt=>{_=Lt,A=[],xe()},onPresetApply:()=>{E()}})}
          ...
          ${Mt(x)} ${f(x)}
          ${Tc(x,T)}
          ${iu({expanded:Q,loading:Te,error:Qe,data:Ve},{onToggle:ne})}
          ${au(me(),yt,{total:Ie,expanded:qe})}
        </div>
      </div>
    `}function xe(){Ge(je(),e)}return{load(x){x!==u&&(p={},_="",A=[],O=!1,J(),re(),Pe(),ee()),u=x,d=null,q(),pt(),H!==x&&de(x)},clear(){u=null,d=null,p={},_="",h=!1,A=[],O=!1,J(),re(),Pe(),ee(),ze.close(),Y.close(),Ge(l``,e)},destroy(){M&&(M(),M=null),ue&&(ue(),ue=null),k&&(k(),k=null),document.removeEventListener("keydown",S),ze.destroy(),Oe.parentNode&&Oe.parentNode.removeChild(Oe),Y.destroy(),Ye.parentNode&&Ye.parentNode.removeChild(Ye),u=null,d=null,ee(),_="",h=!1,A=[],re(),Pe(),Ge(l``,e)}}}function cu(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
...
\uC774\uC288 \uD540 \u2014 \uB808\uD3EC \uAE30\uBCF8\uAC12\uACFC \uB2E4\uB984`:"";return l`${e.orchestration?l`<span
  ...
  >
    ...
    >${e.id}</span
  >`,A=l`<span class="worker-mini__title">${e.title}</span>`,O=e.pr_url&&e.pr_number?l`<a
    ...
    ${i?l`<div class="worker-mini__row1">${_}${h}${A}</div>
          <div class="worker-mini__row2">
            ...
            ${In(e)}`:l`<div class="worker-mini__line">
              ${u}${d}${_}${h}${A}${O}${U}${V}${p}${H}${P}${j}${L}${B}${b}${J}
            </div>
            ${Le}${Se}${te} ${In(e)}`}
  ...
  ${o?l`<div class="rtile__activity${r?" is-paused":""}">
        ...
        ${c.map(p=>l`<span class="rtile__leg rtile__leg--live"
            ...
            >`)}${u.length>0?l`<span
              ...
              >✓ ${u.length}</span
            >`:""}
      </div>`:""}${d}`}function Ha(e,t,r=null,n={}){let s=e.failed===!0,o=!!e.paused,a=s?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):o?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Xm(t-e.started_at):"\u2014",i=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,c=Bn(e),u=Wt(e.usage),d=$r(e.usage),p=e.conflict_resolution?o?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,_=e.base_exception||null,h=e.landing,A=e.attempt_id&&e.attempt_id===r,O=n.monitor||null,U=Jm(O),V=eg(O,t,o),H=e.discard?.action?l`<button
        type="button"
  ...
  >
    <div class="rtile__hd">
      ...
      ${U}${c?l`<span class="rtile__resumed" title=${c}>↻</span>`:""}
...
`)}function Ao(e){if(typeof e!="object"||e===null)return null;let t=Jr(e);if(t==="")return null;let r=(n,s)=>typeof s=="string"&&s.length>0?`${n}: ${s}`:null;return{text:t,title:Ka(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",r("runner",e.runner),r(Pr.orchestration_model,e.model),r(Pr.orchestration_effort,e.effort),r(Pr.orchestration_speed,e.speed)])}}function sn(e,t){let r=Dr(e,"orchestration_model");if(r===null||r.resolution==="unavailable")return null;let n=Dr(e,"orchestration_effort"),s=Dr(e,"orchestration_speed"),o=bu([gr(t,r.value??""),r.display,n!==null&&n.value!==null?n.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Ka(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Nr("orchestration_model",r),Nr("orchestration_effort",n),Nr("orchestration_speed",s)])}}function tg(e,t){return e===null||e.value===null||Va.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function rg(e){return e===null||Va.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function ng(e){return e===null?null:e.value==="auto"?"auto":Va.has(e.resolution)?null:e.display}function qr(e,t){if(typeof e!="object"||e===null)return null;let r=Dr(e,"impl_dispatch"),n=Dr(e,"impl_runtime"),s=Dr(e,"impl_model"),o=Dr(e,"impl_effort"),a=Dr(e,"impl_speed"),i=r!==null&&r.value==="main"?"\uBA54\uC778":bu([tg(n,t??null),rg(s),ng(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Ka(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Nr("impl_dispatch",r),Nr("impl_runtime",n),Nr("impl_model",s),Nr("impl_effort",o),Nr("impl_speed",a)])}}var Xt="",sg=["impl_runtime","impl_model","impl_effort"],og=5,So=1;function Cr(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Eo(e,t){let r=t.transport,n=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(I=>_e(I,"error",4e3)),o={},a={},i=[],c=!1,u=null,d={},p="",_="",h=!1,A=!1,O=!1,U=null,V=!1;function H(){let I=t.queue?t.queue():null;return Cr(I)?I:null}function P(){let I=H();return I?I.runner_catalog:null}function j(){let I=H();return I&&Cr(I.execution_defaults)?I.execution_defaults:null}function L(){let I=t.implPresetStore?.get();return Cr(I)&&Array.isArray(I.presets)?I:null}function B(){return n===null?{}:{root_dir:n}}async function b(I,ne){return V||!r?null:await r(I,ne)}function F(I){I&&Cr(I.queue)&&t.onQueueAdopt?.(I.queue)}async function J(I,ne){let me=H();if(!me||V)return null;let ae=await b(I,{...ne,...B(),expected_revision:me.revision});if(F(ae),n!==null&&ae&&ae.conflict){let qe=ae.queue&&typeof ae.queue.revision=="number"?ae.queue.revision:H()?.revision??me.revision;ae=await b(I,{...ne,...B(),expected_revision:qe}),F(ae)}return ae}async function ee(){c=!0,Pe();try{let I=await b("get-session-defaults",{...B()});o=Cr(I?.values)?{...I.values}:{},a={...o},i=Array.isArray(I?.warnings)?I.warnings:[]}catch(I){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}finally{c=!1,Pe()}}async function pe(){let I=Fc(o,a);if(Object.keys(I).length!==0){try{let ne=await b("set-session-defaults",{values:I,...B()});o=Cr(ne?.values)?{...ne.values}:{},a={...o},i=Array.isArray(ne?.warnings)?ne.warnings:[]}catch(ne){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}Pe()}}function de(I,ne){if(sg.includes(I)){Le(I,ne);return}ne===Xt?delete a[I]:a[I]=ne,Pe(),pe()}function he(){let I=et().orchestration_model,ne=Qt({global:{orchestration_model:I??void 0},execution_defaults:j(),runner_catalog:P()}).orchestration_model.value;return ne?gr(P(),ne):null}function Se(I,ne){typeof ne=="string"&&ne.length>0?a[I]=ne:delete a[I]}function Le(I,ne){let me=ne===Xt?void 0:ne,ae=Nc({impl_runtime:I==="impl_runtime"?me:a.impl_runtime,impl_model:I==="impl_model"?me:a.impl_model,impl_effort:I==="impl_effort"?me:a.impl_effort},P(),he());Se("impl_runtime",ae.impl_runtime),Se("impl_model",ae.impl_model),Se("impl_effort",ae.impl_effort),Pe(),pe()}async function te(){let I=H();if(!I)return;let ne={orchestration_model:I.orchestration_model??null,orchestration_effort:I.orchestration_effort??null,orchestration_speed:I.orchestration_speed??null},me=jc(ne,{...ne,...d});if(Object.keys(me).length!==0){try{let ae=await J("worker-queue-set-orchestration-defaults",{values:me});if(ae&&ae.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}d={}}catch(ae){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${ae instanceof Error?ae.message:String(ae)}`)}Pe()}}function se(I,ne){d[I]=ne===Xt?null:ne,Pe(),te()}function Ae(I){if(u=I,!I){Pe();return}let ne=P(),me=et(),ae=me.orchestration_model;ae&&!os(ne,I).includes(ae)&&(d.orchestration_model=null,ae=null);let qe=me.orchestration_effort;qe&&!Da(ne,I,ae||nr).includes(qe)&&(d.orchestration_effort=null),Pe(),te()}async function N(I){if(!(!H()||I<So)){try{await J("worker-queue-set-slots",{slots:I})}catch(ne){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}Pe()}}async function oe(I){if(!(!H()||I<So||I>og)){try{await J("worker-queue-set-serial-lane-count",{count:I})}catch(ne){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}Pe()}}async function re(I,ne){let me=I==="auto_advance"?"worker-automation-toggle":I==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await J(me,{on:ne})}catch(ae){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${ae instanceof Error?ae.message:String(ae)}`)}Pe()}function ye(){let I={},ne=et();for(let me of uo){let ae=Tr.includes(me)?ne[me]:a[me];typeof ae=="string"&&ae.length>0&&(I[me]=ae)}return I}async function Ee(){let I=L();if(!I)return;let ne=ye();if(Object.keys(ne).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let me=(I.presets||[]).find(qe=>qe.id===p),ae=_.trim()||(me?me.name:"");if(!ae){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let qe=me?await b("impl-preset-update",{expected_revision:I.revision,id:me.id,name:ae,settings:ne}):await b("impl-preset-create",{expected_revision:I.revision,name:ae,settings:ne});if(qe&&qe.applied){if(_="",!me&&Array.isArray(qe.presets)){let Xe=qe.presets.find(ot=>ot.name===ae);p=Xe?Xe.id:p}Pe()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Pe()}catch(qe){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${qe instanceof Error?qe.message:String(qe)}`)}}async function C(){let I=L();if(!(!I||p.length===0))try{let ne=await b("impl-preset-delete",{expected_revision:I.revision,id:p});ne&&ne.applied?(p="",Pe()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Pe())}catch(ne){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${ne instanceof Error?ne.message:String(ne)}`)}}function K(I){o=Cr(I.values)?{...I.values}:{},a={...o},i=Array.isArray(I.warnings)?I.warnings:[],Cr(I.queue)&&(t.onQueueAdopt?.(I.queue),d={})}async function $e(){let I=L(),ne=H();if(!I||!ne||p.length===0)return;let me=ae=>({preset_id:p,expected_revision:I.revision,expected_queue_revision:ae,...B()});try{let ae=await b("apply-impl-preset-global",me(ne.revision));if(ae&&ae.applied&&K(ae),n!==null&&ae&&ae.queue_applied===!1){let qe=ae.queue&&typeof ae.queue.revision=="number"?ae.queue.revision:H()?.revision??ne.revision;ae=await b("apply-impl-preset-global",me(qe)),ae&&ae.applied&&K(ae)}ae&&ae.applied?ae.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):ae&&ae.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(ae){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${ae instanceof Error?ae.message:String(ae)}`)}Pe()}async function Ne(){A=!0,O=!1,Pe();try{let I=await b("get-worker-system-prompt",{});!I||typeof I!="object"||Array.isArray(I)?O=!0:U=I}catch{O=!0}finally{A=!1,Pe()}}function Oe(){if(h=!h,h&&!U){Ne();return}Pe()}function ze(){let I=En({loading:A,error:O});if(I)return I;if(!U)return"";let ne=Array.isArray(U.variants)?U.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${h?ze():""}
    </section>`}function Y(I,ne,me,ae,qe,Xe,ot){let Je=qe[I]??Xt,dt=Na(I,me,qe,j(),P(),ot),yt=dt.options.find(pt=>pt.value===Je),gt=Je===Xt?dt.full_value:yt?.full_value;return l`<select
        class=${Je===Xt?"settings-dialog__unset":""}
        data-key=${I}
        aria-label=${ne}
        title=${gt||""}
        ?disabled=${Xe===!0||dt.disabled}
        .value=${rn(String(Je))}
        @change=${pt=>ae(I,String(pt.target.value))}
      >
        <option value=${Xt} ?selected=${Je===Xt}>
          ${dt.unset_label}
        </option>
        ${dt.options.map(pt=>l`<option
              value=${pt.value}
              title=${pt.full_value||""}
              ?selected=${pt.value===Je}
            >
              ${pt.label}
            </option>`)}
      </select>
      ${Je===Xt?l`<span class="settings-dialog__source-badge">기본</span>`:""}`}function Q(I,ne,me,ae,qe,Xe=!1,ot){return l`<div
      class=${`settings-dialog__row${Xe?" settings-dialog__row--off":""}`}
    >
      <span class="settings-dialog__row-label">${ne}</span>
      <span class="settings-dialog__controls">
        ${Y(I,ne,me,ae,qe,Xe,ot)}
      </span>
    ...
    </div>`}function Qe(I,ne,me,ae){return l`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${ne}</span>
      <span class="settings-dialog__controls">
        <button
          type="button"
    ...
    </div>`}function et(){let I=H(),ne={};for(let me of Tr)ne[me]=Object.prototype.hasOwnProperty.call(d,me)?d[me]:I&&typeof I[me]=="string"?I[me]:null;return ne}function mt(){let I=P(),ne=a.impl_runtime,me=a.impl_model,ae=L(),qe=H(),Xe=et(),ot=os(I,u),Je=Cn(I,void 0).filter(Ue=>Ue!==nr),dt=Da(I,u,Xe.orchestration_model||nr).filter(Ue=>Ue!==nr),yt=p?(ae?.presets||[]).find(Ue=>Ue.id===p):null,gt=yt?qc(ye(),Cr(yt.settings)?yt.settings:{}):null,pt=qe&&typeof qe.slots=="number"?qe.slots:So+1,kt=qe&&typeof qe.serial_lane_count=="number"?qe.serial_lane_count:So,We=j()?.supported===!0,Ke=Na("workflow_mode",ns,a,j(),I);return l`
      ...
      ${c?l`<div class="settings-dialog__empty">불러오는 중…</div>`:l`
            ...
            <div class="settings-dialog__group">
              ...
              ${Q("orchestration_model","\uBAA8\uB378",ot,se,Xe)}
              ${Q("orchestration_effort","effort",dt,se,Xe)}
              ${Q("orchestration_speed","\uC18D\uB3C4",rs,se,Xe)}
            </div>
            ...
            <div class="settings-dialog__group">
              ...
              ${Q("quick_fix_impl_model","quick_fix \uAD6C\uD604 \uBAA8\uB378",Je,de,a,!1,{...a,...Xe})}
            </div>
  ...
  >
    ...
    </div>`}function Le(){u!==null&&!A(u)&&(u=null,t.onFocusChange?.(null))}function te(){U(),Le(),d!==null&&!A(d)&&B(!0),Ge(Se(),n),p?.render()}function se(N){let oe=N.target;if(!oe||typeof oe.closest!="function")return;let re=oe.closest("[data-root-dir]");if(!re)return;let ye=re.getAttribute("data-root-dir")||"",Ee=oe.closest("[data-act]")?.getAttribute("data-act");if(Ee==="worker"){t.gotoWorkerTab?.(ye);return}if(Ee==="auto"){V("worker-automation-toggle",ye,{on:O(ye)?.auto_advance!==!0});return}if(Ee==="merge"){V("worker-merge-auto-toggle",ye,{on:O(ye)?.auto_merge!==!0});return}if(Ee==="gear"){j(ye);return}P(ye)}function Ae(N){if(N.key!=="Enter"&&N.key!==" ")return;let oe=N.target;if(!oe||typeof oe.closest!="function")return;let re=oe.closest('[data-root-dir][role="button"]');!re||re!==oe||(N.preventDefault(),P(re.getAttribute("data-root-dir")||""))}return n.addEventListener("click",se),n.addEventListener("keydown",Ae),{render:te,focusRoot:()=>u,panelRoot:()=>d,destroy(){document.removeEventListener("keydown",F),n.removeEventListener("click",se),n.removeEventListener("keydown",Ae),i.removeEventListener("click",b),L(),Ge(l``,n),e.replaceChildren()}}}var lg="\uB2E4\uB978 \uB808\uD3EC \uC774\uC288\uB294 \uC774 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB123\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",cg="Worker \uD0ED \uC9C1\uB82C \uB808\uC778\uC5D0\uC11C \uBA3C\uC800 \uBE7C \uC8FC\uC138\uC694";function Ya(e,t){return`${e}\0${t}`}function ug(e){return`${e}\uC758 \uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4`}function dg(e){let t=new Map;for(let[r,n]of e)t.set(r,n.slice());return t}function pg(e,t,r){let n=new Set([t]),s=[t];for(;s.length>0;){let o=s.pop();for(let a of e.get(o)||[]){if(a===r)return!0;n.has(a)||(n.add(a),s.push(a))}}return!1}function fg(e,t){let r=new Set;for(let[a,i]of t)for(let c of i)r.add(Ya(a,c));let n=new Map,s=new Map;for(let a of e){let i=Ya(a.a,a.b);n.set(i,a),s.set(i,a.type==="dep-add")}let o=[];for(let a of e){let i=Ya(a.a,a.b);n.get(i)===a&&s.get(i)!==r.has(i)&&o.push(a)}return o}function _g(e,t,r){let n=e.parallel_rows,s=Math.max(0,Math.min(n.length,r)),o=n[s];if(o&&o.root_dir===t)return o.queue_index;for(let a=s-1;a>=0;a--)if(n[a].root_dir===t)return n[a].queue_index+1;for(let a=s;a<n.length;a++)if(n[a].root_dir===t)return n[a].queue_index;return e.parallel_raw_length.get(t)??0}function mg(e,t){return e.parallel_rows.some(r=>r.root_dir===t)}function Za(e,t,r,n){return{type:"worker-queue-place",payload:{bead_id:e,...n?{lane:n}:{},index:r},root_dir:t}}function Eu(e,t,r){let n=dg(r.blocked_by_map),s=[],o=null,a=h=>{let A=r.owner_of.get(h);return typeof A!="string"||A.length===0?(o=ug(h),null):A},i=(h,A)=>{if(o!==null||h===A)return;let O=n.get(h)||[];if(!O.includes(A))return;let U=a(h);U!==null&&(n.set(h,O.filter(V=>V!==A)),s.push({type:"dep-remove",a:h,b:A,root_dir:U}))},c=(h,A)=>{if(o!==null||h===A)return;let O=n.get(h)||[];if(O.includes(A))return;let U=a(h);if(U!==null){if(pg(n,A,h)){o=`\uC758\uC874 \uC0AC\uC774\uD074\uC774 \uC0DD\uAE41\uB2C8\uB2E4 \u2014 ${h}\uAC00 \uC774\uBBF8 ${A}\uB97C \uB9C9\uACE0 \uC788\uC2B5\uB2C8\uB2E4`;return}n.set(h,[...O,A]),s.push({type:"dep-add",a:h,b:A,root_dir:U})}},u=()=>{let h=r.lane_order.get(e.lane_id||"")||[],A=new Set(h),O=(n.get(e.bead_id)||[]).filter(V=>A.has(V)),U=h.filter(V=>(n.get(V)||[]).includes(e.bead_id));for(let V of O)i(e.bead_id,V);for(let V of U)i(V,e.bead_id);for(let V of O)for(let H of U)c(H,V);return h.filter(V=>V!==e.bead_id)},d=(h,A)=>{let O=r.lane_order.get(h)||[],U=O.indexOf(e.bead_id),V=O.filter(L=>L!==e.bead_id),H=h.startsWith("pending:")?V.length:Math.max(0,Math.min(V.length,U>=0&&A>U?A-1:A)),P=H>0?V[H-1]:null,j=H<V.length?V[H]:null;if(P===null){j!==null&&c(j,e.bead_id);return}c(e.bead_id,P),j!==null&&(n.get(j)||[]).includes(P)&&(i(j,P),c(j,e.bead_id))},p=typeof e.queue_index=="number"?e.queue_index:r.queue_index_of.get(e.bead_id);if(t.kind==="repo-serial"&&e.root_dir!==t.root_dir)return{refused:lg};if(t.kind==="chain"&&e.kind==="repo-serial")return{refused:cg};if(e.kind==="chain"&&u(),t.kind==="chain"&&d(t.lane_id,t.marker_index),o!==null)return{refused:o};let _=[];if(t.kind==="candidate")e.kind!=="candidate"&&_.push({type:"worker-queue-remove",payload:{bead_id:e.bead_id},root_dir:e.root_dir});else if(t.kind==="parallel"){let h=_g(r,e.root_dir,t.marker_index);if(e.kind==="candidate"||e.kind==="repo-serial")_.push(Za(e.bead_id,e.root_dir,h));else if(e.kind==="parallel"&&mg(r,e.root_dir)&&p!==void 0){let A=p>h?h:h-1;A>=0&&A!==p&&_.push({type:"worker-queue-reorder",payload:{bead_id:e.bead_id,to_index:A},root_dir:e.root_dir})}}else if(t.kind==="chain")e.kind==="candidate"&&_.push(Za(e.bead_id,e.root_dir,r.parallel_raw_length.get(e.root_dir)??0));else if(e.kind==="repo-serial"&&e.lane_id===t.lane_id){if(p!==void 0){let h=p>t.index?t.index:t.index-1;h>=0&&h!==p&&_.push({type:"worker-queue-reorder",payload:{bead_id:e.bead_id,lane:t.lane_id,to_index:h},root_dir:e.root_dir})}}else _.push(Za(e.bead_id,e.root_dir,t.index,t.lane_id));return{ops:[...fg(s,r.blocked_by_map),..._]}}var Tu={running:3,paused:2,failed:1};function Cu(e,t){let r=Object.values(e||{}),n=new Set,s=new Map;for(let a of r)!a||typeof a.bead_id!="string"||(typeof a.resumed_from=="string"&&a.resumed_from.length>0&&n.add(a.resumed_from),s.set(a.bead_id,a.attempt_id));let o=new Map;for(let a of r){if(!a||typeof a.bead_id!="string"||a.bead_id.length===0)continue;let i=null;if(a.status==="running")i="running";else if(a.status==="paused"&&!n.has(a.attempt_id))i="paused";else if(a.status==="failed"||a.status==="orphaned"){let d=t.get(a.bead_id),p=typeof d=="number"&&d>0&&typeof a.finished_at=="number"&&d>=a.finished_at;s.get(a.bead_id)===a.attempt_id&&!p&&typeof a.dismissed_at!="number"&&(i="failed")}if(!i)continue;let c=typeof a.started_at=="number"?a.started_at:null,u=o.get(a.bead_id);if(u){let d=Tu[u.run_state],p=Tu[i];if(d>p||d===p&&(u.started_at??0)>(c??0))continue}o.set(a.bead_id,{attempt:a,run_state:i,started_at:c})}return{winners:o,resumed_from_ids:n}}var Ru=[{step:"merge",label:"\uBA38\uC9C0",index:1},{step:"base",label:"base",index:2},{step:"verify",label:"\uAC80\uC99D",index:3},{step:"deploy",label:"\uBC30\uD3EC",index:4},{step:"child",label:"\uC790\uC2DD",index:5},{step:"branch",label:"\uBE0C\uB79C\uCE58",index:6},{step:"close",label:"close",index:7}],ds=[{step:"base_containment",label:"base \uD3EC\uD568 \uD655\uC778"},{step:"repo_operations",label:"\uC800\uC7A5\uC18C \uC791\uC5C5"},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC"},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC"},{step:"parent_close",label:"\uBD80\uBAA8 close"}];function Co(e,t){let r=Ru.find(s=>s.step===e);if(!r)return null;let n=Ru.length;return{step:r.step,label:t,index:r.index,total:n,percent:Math.round(r.index/n*100)}}function Iu(e){let t=ds.findIndex(r=>r.step===e);return ds.map((r,n)=>({step:r.step,label:r.label,state:t<0?"todo":n<t?"done":n===t?"stall":"todo"}))}function on(e){let t=ds.find(r=>r.step===e);return t?t.label:typeof e=="string"?e:""}function gg(e){let t=ds.findIndex(r=>r.step===e);return t<0?null:{index:t+1,total:ds.length}}function Ro(e){let t=gg(e);return t?`\uBA38\uC9C0 \uC644\uB8CC \xB7 \uC815\uB9AC ${t.total}\uB2E8\uACC4 \uC911 ${t.index}\uB2E8\uACC4\uC5D0\uC11C \uBA48\uCDA4`:"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644"}var Xa=new Set(["queued","running","retry_pending","repairing"]),Lu=new Set(["failed","succeeded"]),hg={queued:"\uB300\uAE30",running:"\uC911",retry_pending:"\uC7AC\uC2DC\uB3C4 \uB300\uAE30",repairing:"\uC790\uB3D9 \uD574\uACB0 \uC911",failed:"\uC2E4\uD328",succeeded:"\uC644\uB8CC \xB7 \uC815\uB9AC \uC7AC\uAC1C \uB300\uAE30"},ps={base_containment:{step:"base",label:"base \uD655\uC778 \uC911"},child_sweep:{step:"child",label:"\uC790\uC2DD \uC815\uB9AC \uC911"},branch_cleanup:{step:"branch",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC \uC911"},parent_close:{step:"close",label:"\uBD80\uBAA8 close \uC911"}},bg={merging:{step:"merge",label:"\uBA38\uC9C0 \uC911"},base_containment:ps.base_containment,child_sweep:ps.child_sweep,branch_cleanup:ps.branch_cleanup,parent_close:ps.parent_close};function yg(e){return typeof e=="string"&&/^[0-9a-f]{40}$/.test(e)}function vg(e,t,r){return!["verify","deploy"].includes(e.kind)||![...Xa,...Lu].includes(e.state)||![null,void 0,""].includes(e.superseded_by)||!Array.isArray(e.subjects)?!1:e.subjects.some(n=>n&&typeof n=="object"&&n.bead_id===t&&n.merged_sha===r)}function wg(e,t){let r=(t.kind==="deploy"?2:1)-(e.kind==="deploy"?2:1);if(r!==0)return r;let n=u=>u.state==="succeeded"?1:2,s=n(t)-n(e);if(s!==0)return s;let o=typeof e.requested_at=="number"?e.requested_at:0,a=typeof t.requested_at=="number"?t.requested_at:0;if(o!==a)return a-o;let i=typeof e.operation_id=="string"?e.operation_id:"",c=typeof t.operation_id=="string"?t.operation_id:"";return i.localeCompare(c)}function Qa(e,t=!1){let r=e.kind,n=r==="verify"?"\uAC80\uC99D":"\uBC30\uD3EC",s=t?"failed":e.state,o=hg[s];if(!o)return null;let a=Co(r,`${n} ${o}`);return a?{...a,active:Xa.has(s),failed:s==="failed"}:null}function kg(e){return!e||typeof e!="object"?null:bg[e.step]||null}function fs(e){if(!e||typeof e.bead_id!="string")return null;let t=e.bead_id,r=e.merge_progress&&typeof e.merge_progress=="object"?e.merge_progress:{},n=kg(r),s=e.cleanup_failed&&typeof e.cleanup_failed=="object"?e.cleanup_failed:null,o=["child_sweep","branch_cleanup","parent_close"].includes(typeof e.cleanup_cursor=="string"?e.cleanup_cursor:""),a=!o&&(e.cleanup_cursor==="repo_operations"||r.step==="repo_operations"),i=yg(e.merge_sha)?e.merge_sha:null,c=!o&&i&&Array.isArray(e.repo_operations)?e.repo_operations.filter(A=>A&&typeof A=="object"&&vg(A,t,i)).sort(wg):[],u=a?c:[],d=u.find(A=>Xa.has(A.state));if(d)return Qa(d);if(s)return s.step==="repo_operations"&&c[0]?Qa(c[0],!0):null;let p=u.find(A=>Lu.has(A.state)?A.state!=="succeeded"||e.cleanup_cursor==="repo_operations":!1);if(p)return Qa(p);if(n){let A=Co(n.step,n.label);return A?{...A,active:!0,failed:!1}:null}let _=typeof e.cleanup_cursor=="string"?ps[e.cleanup_cursor]:null;if(!_)return null;let h=Co(_.step,_.label);return h?{...h,active:!0,failed:!1}:null}function Io(e){return!!e&&e.step!=="merge"&&e.failed!==!0}function Ja(e,t){return`${e}\0${t}`}function Ou(e){let t=new Map;for(let r of Array.isArray(e?.running)?e.running:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"running",state:"running"});for(let r of Array.isArray(e?.pr_wait)?e.pr_wait:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"pr_wait",state:"pr_wait"});for(let r of Array.isArray(e?.queue_groups)?e.queue_groups:[]){let n=Array.isArray(r.sublanes?.parallel)?r.sublanes.parallel:Array.isArray(r.items)?r.items:[];for(let s of n)t.set(s.id,{root_dir:s.root_dir,workspace_name:s.workspace_name,lane:"parallel",position:s.queue_position});for(let s of Array.isArray(r.sublanes?.serial)?r.sublanes.serial:[])for(let o of s.items)t.set(o.id,{root_dir:o.root_dir,workspace_name:o.workspace_name,lane:s.id,position:o.queue_position})}for(let r of Array.isArray(e?.runnable)?e.runnable:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"runnable",state:"runnable"});for(let r of Array.isArray(e?.done)?e.done:[])t.set(r.id,{root_dir:r.root_dir,workspace_name:r.workspace_name,lane:"done",state:"done"});return t}function ei(e,t){let r=Array.isArray(t)?t:[],n=e.indexOf("-"),s=n>0?e.slice(0,n):e;return r.some(o=>typeof o?.issue_prefix=="string"&&o.issue_prefix===s)?"internal":r.length>0&&r.every(o=>typeof o?.issue_prefix=="string")?"external":"unknown"}function $g(e,t){return e==="internal"&&t===void 0}function Ln(e){if(e.state==="running")return"\uC2E4\uD589\uC911";if(e.state==="pr_wait")return"PR \uB300\uAE30";if(e.state==="runnable")return"\uC2E4\uD589\uAC00\uB2A5";if(e.state==="done")return"\uC644\uB8CC";let t=e.lane==="parallel"?"\uBCD1\uB82C":e.lane;return`${e.workspace_name} \xB7 ${t} #${e.position}`}function Mu(e,t,r,n){let s=r.get(e);if(!!(s&&t&&s.root_dir===t.root_dir&&s.lane===t.lane&&typeof s.position=="number"&&typeof t.position=="number"&&s.position<t.position))return{id:e,label:`\u{1F512} ${e} (\uAC19\uC740 \uB808\uC778 \uC55E)`,location_label:"\uAC19\uC740 \uB808\uC778 \uC55E",scope:null,same_lane_ahead:!0,missing_internal:!1};if(s)return{id:e,label:`\u{1F512} ${e} (${Ln(s)})`,location_label:Ln(s),scope:null,same_lane_ahead:!1,missing_internal:!1};let a=ei(e,n),i=a==="internal"?"\uBBF8\uC801\uC7AC":a==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778";return{id:e,label:`\u{1F512} ${e} (${i})`,location_label:i,scope:a,same_lane_ahead:!1,missing_internal:$g(a,s)}}function Pu(e){let t=Array.isArray(e)?e:[],r=new Map,n=new Map,s=new Map;for(let i of t)for(let c of Array.isArray(i.sublanes?.serial)?i.sublanes.serial:[]){let u=Ja(i.root_dir,c.id);r.set(u,{root_dir:i.root_dir,workspace_name:i.name,lane:c.id}),s.set(u,[]);for(let d of Array.isArray(c.items)?c.items:[])n.set(d.id,u)}for(let i of t)for(let c of Array.isArray(i.sublanes?.serial)?i.sublanes.serial:[]){let u=Ja(i.root_dir,c.id),d=Array.isArray(c.items)?c.items[0]:null,_=!!d&&d.queue_index===0&&(!Array.isArray(c.occupied_by)||c.occupied_by.length===0)&&Array.isArray(d.blocked_by)?d.blocked_by:[],h=s.get(u);if(h)for(let A of _){let O=n.get(A);O&&O!==u&&!h.includes(O)&&h.push(O)}}let o=(i,c)=>{let u=new Set,d=[i];for(;d.length>0;){let p=d.pop();if(p===c)return!0;!p||u.has(p)||(u.add(p),d.push(...s.get(p)||[]))}return!1},a=new Map;for(let[i,c]of s){let u=[];for(let d of c){let p=r.get(d);o(d,i)&&p&&u.push(p)}u.length>0&&a.set(i,u)}return a}function Du(e,t){return Ja(e,t)}var Nu=1,_s=[{value:"repo_spec",label:"\uB808\uD3EC \xB7 spec \uC6B0\uC120"},{value:"repo_updated",label:"\uB808\uD3EC \xB7 \uCD5C\uC2E0 \uC218\uC815"},{value:"updated_flat",label:"\uCD5C\uC2E0 \uC218\uC815(\uB808\uD3EC \uBB34\uC2DC)"}],ti=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],On={show_blocked:!0,spec:"all"},qu={auto_merge:"\uC790\uB3D9 \uBA38\uC9C0",merged:"\uBA38\uC9C0",merge:"\uBA38\uC9C0",pr_stop:"PR \uC911\uB2E8",stopped:"\uC911\uB2E8",failed:"\uC2E4\uD328"};function xg(e,t){let r=null,n=-1/0;for(let s of Object.values(e)){if(!s||s.bead_id!==t||s.status==="running")continue;let o=typeof s.finished_at=="number"?s.finished_at:typeof s.started_at=="number"?s.started_at:0;o>=n&&(n=o,r=s)}return r}function Ag(e,t){let{winners:r,resumed_from_ids:n}=Cu(e,t),s=new Map;for(let[o,a]of r){let i=a.attempt,c=a.run_state,u=a.started_at,d=typeof i.session_id=="string"&&i.session_id.length>0;s.set(o,{attempt_id:typeof i.attempt_id=="string"?i.attempt_id:"",run_state:c,started_at:u,last_event_at:typeof i.last_event_at=="number"?i.last_event_at:null,last_activity:i.last_activity&&typeof i.last_activity=="object"?i.last_activity:null,legs:Array.isArray(i.legs)?i.legs:[],runner:typeof i.runner=="string"?i.runner:null,model:typeof i.model=="string"?i.model:null,effort:typeof i.effort=="string"?i.effort:null,speed:typeof i.speed=="string"?i.speed:null,resumed_from:typeof i.resumed_from=="string"?i.resumed_from:null,continuation_mode:i.continuation_mode==="session"||i.continuation_mode==="fresh"?i.continuation_mode:null,status:typeof i.status=="string"?i.status:null,usage:ir(e,i.bead_id),can_pause:c==="running"&&d,can_resume:c!=="running"&&d&&!n.has(i.attempt_id)})}return s}function Fu(e,t){let r=e[t];if(!r)return"";if(r.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let n=typeof r.reason=="string"?r.reason:"",s=n.indexOf(":");return s>0&&s<n.length-1?`\u26D4 ${n.slice(0,s)} (${n.slice(s+1)})`:`\u26D4 ${n}`}function Et(e){return e&&typeof e=="object"?e:{}}function Sg(e,t,r){let n=Et(t);if(Object.keys(n).length===0)return null;let s=e.execution_defaults,o=e.runner_catalog,a=e.session_defaults;if(!s||!o||!a)return null;let i=_=>Qt({pin:_,global:a,execution_defaults:s,runner_catalog:o,route:r}),c,u;try{c=i(n),u=i(null)}catch{return null}let d=ju(sn(c,o),sn(u,o)),p=ju(qr(c,null),qr(u,null));return d||p?{orchestration:d,worker:p}:null}function ju(e,t){return!e||t&&t.text===e.text?null:e}function Eg(e){return{id:e.id,label:`\u{1F512} \uC120\uD589 ${e.id} (${e.location_label})`,title:`\uC774 \uC774\uC288\uB294 ${e.id}\uAC00 close\uB420 \uB54C\uAE4C\uC9C0 \uCD9C\uBC1C\uD558\uC9C0 \uC54A\uB294\uB2E4`}}function Tg(e,t){let r=t.get(e);return r?{id:e,label:`\u2192 \uD6C4\uC18D ${e} (${Ln(r)})`,title:`\uC774 \uC774\uC288\uAC00 close\uB418\uBA74 ${e}\uAC00 \uC790\uAE30 \uB808\uD3EC \uD050\uC5D0\uC11C \uCD9C\uBC1C\uD55C\uB2E4`}:null}function Cg(e,t,r){let n=new Map;for(let c of e)n.set(c,Array.from(r.get(c)||[]).filter(u=>e.includes(u)).length);let s=[],o=new Map,a=e.filter(c=>(n.get(c)||0)===0).sort();for(let c of a)o.set(c,0);let i=[...a];for(;i.length>0;){let c=i.shift();s.push(c);let u=Array.from(t.get(c)||[]).filter(p=>e.includes(p)).sort(),d=(o.get(c)||0)+(u.length>1?1:0);for(let p of u){let _=(n.get(p)||0)-1;n.set(p,_);let h=o.get(p);o.set(p,h===void 0?d:Math.min(h,d)),_===0&&i.push(p)}}return{order:s,indent:o,cycle:s.length!==e.length}}function Rg(e,t,r){let n=new Map,s=new Map,o=new Set,a=(u,d,p)=>{let _=u.get(d);_?_.add(p):u.set(d,new Set([p]))};for(let[u,d]of e)for(let p of d)p!==u&&(o.add(p),o.add(u),a(n,p,u),a(s,u,p));let i=new Set,c=[];for(let u of Array.from(o).sort()){if(i.has(u))continue;let d=[],p=[u];for(i.add(u);p.length>0;){let H=p.pop();d.push(H);for(let P of[...n.get(H)||[],...s.get(H)||[]])i.has(P)||(i.add(P),p.push(P))}if(d.length<2)continue;let _=d.map(H=>t.get(H));if(_.every(H=>!!H&&/^s[1-5]$/.test(H.lane||""))&&_.every(H=>H&&_[0]&&H.root_dir===_[0].root_dir&&H.lane===_[0].lane))continue;let{order:A,indent:O,cycle:U}=Cg(d.slice().sort(),n,s),V=U?d.slice().sort():A;c.push({key:V.join("\0"),cycle:U,nodes:V.map(H=>{let P=t.get(H);return{id:H,workspace_name:P?P.workspace_name:"",root_dir:P?P.root_dir:"",location_label:P?Ln(P):Uu(H,r),indent:U?0:O.get(H)||0}})})}return c}function Uu(e,t){let r=ei(e,t);return r==="internal"?"\uBBF8\uC801\uC7AC":r==="external"?"\uC678\uBD80":"\uC704\uCE58 \uBBF8\uD655\uC778"}function Ig(e,t,r){let n=t.get(e);if(!n)return Uu(e,r);if(typeof n.position=="number"){if(n.lane==="parallel")return`#${n.position}`;if(/^s[1-5]$/.test(n.lane))return`${n.lane} #${n.position}`}return Ln(n)}function Lg(e,t,r){let n=[];for(let s of r.get(e)||[])s!==e&&t.has(s)&&!n.includes(s)&&n.push(s);return n}function Og(e,t,r,n,s,o){let a=(d,p,_,h)=>{let A=n.get(d),O=A&&A.lane==="parallel"&&typeof A.position=="number"?A.position-1:null;return{id:d,title:o.get(d)||d,root_dir:A?A.root_dir:"",workspace_name:A?A.workspace_name:"",seq:p,indent:_,predecessors:h,location_label:Ig(d,n,s),draggable:O!==null,...O!==null?{queue_index:O}:{}}},i=[];for(let d of e.slice().sort((p,_)=>p.key<_.key?-1:1)){let p=new Set(d.nodes.map(_=>_.id));i.push({lane_id:`chain:${d.key}`,label:"",pending:!1,cycle:d.cycle,rows:d.nodes.map((_,h)=>a(_.id,h+1,d.cycle?0:_.indent,d.cycle?[]:Lg(_.id,p,r)))})}let c=new Set;for(let d of i)for(let p of d.rows)c.add(p.id);let u=[];return t.forEach((d,p)=>{let _=d&&typeof d.seed=="string"&&d.seed.length>0?d.seed:null;_!==null&&c.has(_)||(u.push(p),i.push({lane_id:`pending:${p}`,label:"",pending:!0,cycle:!1,rows:_===null?[]:[a(_,1,0,[])]}))}),i.forEach((d,p)=>{d.label=`\uC5F0\uACB0 ${p+1} \xB7 \uB808\uD3EC \uAC04`}),{chain_lanes:i,pending_lanes_kept:u}}function Bu(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function ri(e,t,r){let n=Array.isArray(e)?e:[],s=Array.isArray(t)?t:[],o=r&&typeof r.done_since=="number"?r.done_since:void 0,a={...On,...r&&r.candidate_filter?r.candidate_filter:{}},i=r&&_s.some(C=>C.value===r.candidate_sort)?r.candidate_sort:"repo_spec",c=new Map;for(let C of s)C&&typeof C.root_dir=="string"&&c.set(C.root_dir,C);let u=[],d=[],p=[],_=[],h=[],A=[],O=new Map,U=new Map,V=new Map,H=new Map,P=new Map,j=new Map;for(let C of n){if(!C||typeof C.root_dir!="string")continue;let K=C.root_dir,$e=C.name||K,Ne=c.get(K),Oe=Ne&&typeof Ne.revision=="number"?Ne.revision:typeof C.revision=="number"?C.revision:0,ze=Et(C.attempts),Ye=Et(C.bead_titles);for(let[E,M]of Object.entries(Ye))typeof M=="string"&&M.length>0&&j.set(E,M);let Y=Et(C.bead_times),Q=Et(C.pr_observations),Te=Et(C.admission),Qe=Et(C.revise_parked),Ve=Et(C.merge_queue_state),st=Et(C.cleanup_failed),et=Et(C.discard_operations),mt=Et(C.bead_blocked_by),Pe=Et(C.bead_workflow),I=Et(C.pr_activity),ne=Array.isArray(C.repo_operations)?C.repo_operations:[],me=Array.isArray(C.merge_queue)?C.merge_queue:[],ae=new Set(me.filter(E=>E&&typeof E.bead_id=="string").map(E=>E.bead_id)),qe=new Map(me.filter(E=>E&&typeof E.bead_id=="string").map(E=>[E.bead_id,E])),Xe=Array.isArray(C.queue)?C.queue:[],ot=(Array.isArray(C.serial_lanes)?C.serial_lanes:[]).filter(E=>E&&/^s[1-5]$/.test(E.id)&&Array.isArray(E.entries)),Je=Et(C.lane_states),dt=typeof C.serial_lane_count=="number"?Math.max(0,Math.min(5,Math.floor(C.serial_lane_count))):Math.min(5,ot.length);V.set(K,dt),H.set(K,Xe.length);let yt=new Map(ot.map(E=>[E.id,E])),gt=new Map;for(let E of ot)for(let M of E.entries)M&&typeof M.bead_id=="string"&&gt.set(M.bead_id,E.id);for(let[E,M]of Object.entries(mt))Array.isArray(M)&&P.set(E,M.filter(ue=>typeof ue=="string"&&ue.length>0));let pt=Array.isArray(C.done)?C.done:[];for(let E of pt)E&&typeof E.bead_id=="string"&&A.push({id:E.bead_id,root_dir:K,workspace_name:$e});let kt=new Map;for(let E of pt)E&&typeof E.bead_id=="string"&&typeof E.added_at=="number"&&kt.set(E.bead_id,E.added_at);let We=E=>({id:E,title:Ye[E]||E,root_dir:K,workspace_name:$e,expected_revision:Oe,draggable:!1,...Et(Y[E]).created_at?{created_at:Et(Y[E]).created_at}:{},...Et(Y[E]).updated_at?{updated_at:Et(Y[E]).updated_at}:{}}),Ke=new Set;for(let[E,M]of Ag(ze,kt))Ke.add(E),d.push({...We(E),lane:"running",...gt.has(E)?{serial_lane_id:gt.get(E)}:{},attempt_id:M.attempt_id,run_state:M.run_state,status:M.status||void 0,workflow:Pe[E]||null,can_pause:M.can_pause,can_resume:M.can_resume,started_at:M.started_at,last_event_at:M.last_event_at,last_activity:M.last_activity,legs:M.legs,runner:M.runner,model:M.model,effort:M.effort,speed:M.speed,resumed_from:M.resumed_from,continuation_mode:M.continuation_mode,usage:M.usage,exec_chips:{orchestration:Ao(M),worker:null},discard:yr(et,E,{attempt_id:M.attempt_id}),badges:M.run_state==="paused"?["\u23F8 \uC77C\uC2DC\uC815\uC9C0"]:M.run_state==="failed"?["\u26A0 \uC2E4\uD328"]:[],alert:M.run_state==="failed"});for(let E of Array.isArray(C.pr_wait)?C.pr_wait:[]){let M=E&&E.bead_id;if(typeof M!="string"||Ke.has(M))continue;Ke.add(M);let ue=Et(Q[M]),k=Et(ue.pr),S=ue.gate?Et(ue.gate):null,q=ae.has(M),X=qe.get(M)?.continuation_action||null,ke=!!X&&X.continuation===null,ve=Ve.active===M,Me=E.external===!0,De=st[M]||null,Rt=Et(I[M]),at=fs({bead_id:M,merge_sha:E.merge_sha,cleanup_cursor:E.cleanup_cursor,merge_progress:Rt.merge_progress||null,cleanup_failed:De,repo_operations:ne}),tt=Io(at),Dt=!!S&&S.base_badge==="\uCDA9\uB3CC",Ut=!!De&&["child_sweep","branch_cleanup","parent_close"].includes(De.step)&&!!S&&S.tier==="merged",Fe=Me&&!!De&&!!S&&S.tier==="merged",Ft=!!S&&["closed_unmerged","review","undecidable"].includes(S.tier),It=yr(et,M,{external:Me,merge_active:ve||at?.step==="merge",merge_queued:q,cleanup_active:tt,merged:!!De||S?.tier==="merged"}),zt=!!It.operation;p.push({...We(M),lane:"pr_wait",pr_number:typeof k.number=="number"?k.number:null,pr_url:typeof k.url=="string"?k.url:void 0,external:Me,usage:ir(ze,M),merge_step:at,badges:ke?["\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD \uD544\uC694"]:at?[S?.tier==="merged"?"\uBA38\uC9C0\uB428":"\uBA38\uC9C0 \uC911"]:De?[on(De.step)?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${on(De.step)}`:"\uC815\uB9AC \uBA48\uCDA4"]:typeof S?.gate_badge=="string"&&S.gate_badge.length>0?[S.gate_badge]:[],alert:at?at.failed===!0:!!De||Ft,reason:De&&at?.active!==!0?Ro(De.step):"PR \uB300\uAE30",merge_action:S?.tier==="merged"&&!Ut&&!Fe?!1:!q||ke,merge_enabled:!zt&&(ke||S?.enabled===!0||Dt||Ut||Fe),merge_label:ke?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":Fe||Ut?"\uC815\uB9AC \uC7AC\uAC1C":Dt&&!Ut?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:ke?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":zt?It.error?`\uD3D0\uAE30 \uC2E4\uD328: ${It.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${It.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:Fe?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Ut?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Dt?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":S?.enabled===!0?`\uBA38\uC9C0 (${S.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4`:`\uBA38\uC9C0 \uBD88\uAC00: ${S?.reason||"\uAD00\uCE21 \uB300\uAE30"}`,cancel_action:q&&!ke,cancel_enabled:!ve,continuation_mismatch:X?.mismatch||null,discard:It,discard_action:It.action,discard_enabled:It.enabled,discard_title:It.title})}let Ue=(E,M,ue,k)=>{let S=E&&E.bead_id;if(typeof S!="string"||Ke.has(S))return null;Ke.add(S);let q=Qe[S],X=yr(et,S),ke=X.operation?X:null,ve={...We(S),lane:M,draggable:!ke,discard:ke||void 0,reason:Fu(Te,S),seq:ue+1,queue_position:ue+1,queue_index:ue,queue_length:k,badges:q?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!q,revise_action:!!q,revise_enabled:!!q&&!ke,revise_title:q?q.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${q.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(mt,S)&&(ve.blocked_by=Array.isArray(mt[S])?mt[S].filter(Me=>typeof Me=="string"&&Me.length>0):[]),ve};for(let E=0;E<Xe.length;E++){let M=Ue(Xe[E],"queue",E,Xe.length);if(!M)continue;_.push(M);let ue=O.get(K);ue?ue.push(M):O.set(K,[M])}let ct=[];for(let E=0;E<Math.max(dt,ot.length);E++){let M=`s${E+1}`,ue=yt.get(M),k=ue&&Array.isArray(ue.entries)?ue.entries:[],S=[];for(let ke=0;ke<k.length;ke++){let ve=Ue(k[ke],M,ke,k.length);ve&&(S.push(ve),_.push(ve))}let q=Et(Je[M]),X=Array.isArray(q.occupied_by)?q.occupied_by.filter(ke=>typeof ke=="string"):[];S.length===0&&X.length===0&&(dt<=1||E>=dt)||ct.push({id:M,index:E,items:S,raw_length:k.length,occupied_by:X,corrections:Array.isArray(q.corrections)?q.corrections.length:0,cycle:q.cycle===!0,...S.length===0&&X.length===0?{empty:!0}:{}})}U.set(K,ct);let At=Array.from({length:dt},(E,M)=>{let ue=`s${M+1}`,k=yt.get(ue),S=k&&Array.isArray(k.entries)?k.entries:[],q=Et(Je[ue]);return{id:ue,index:S.length,length:S.length,occupied_by:Array.isArray(q.occupied_by)?q.occupied_by.filter(X=>typeof X=="string"):[]}});for(let E of Array.isArray(C.runnable)?C.runnable:[]){let M=E&&E.bead_id;if(typeof M!="string"||Ke.has(M))continue;Ke.add(M);let ue=E.workflow&&typeof E.workflow=="object"?E.workflow:null,k=ue&&typeof ue.route=="string"&&ue.route||(typeof E.route=="string"?E.route:null),S=Sg(Et(Ne),E.exec_pins,k);Array.isArray(E.blocked_by)&&E.blocked_by.length>0&&P.set(M,E.blocked_by.filter(q=>typeof q=="string"&&q.length>0)),u.push({...We(M),title:E.title||Ye[M]||M,lane:"runnable",draggable:!0,reason:Fu(Te,M),created_at:E.created_at??void 0,updated_at:E.updated_at??void 0,status:typeof E.status=="string"?E.status:void 0,labels:Array.isArray(E.labels)?E.labels:[],spec_id:typeof E.spec_id=="string"?E.spec_id:"",workflow:ue||(k?{route:k,chips:{route:k}}:null),...S?{exec_chips:S}:{},blocked:E.blocked===!0,...Array.isArray(E.blocked_by)?{blocked_by:E.blocked_by.filter(q=>typeof q=="string"&&q.length>0)}:{},place_index:Xe.length,place_lanes:At})}for(let E of pt){let M=E&&E.bead_id;if(typeof M!="string"||Ke.has(M)||(Ke.add(M),o!==void 0&&typeof E.added_at=="number"&&E.added_at<o))continue;let ue=xg(ze,M),k=ue&&typeof ue.done_kind=="string"?ue.done_kind:null;h.push({...We(M),lane:"done",done:!0,done_layout:"three_line",usage:ir(ze,M),work_ms:yo(ze,M),done_at:typeof E.added_at=="number"?E.added_at:void 0,done_kind:k,badges:k&&qu[k]?[qu[k]]:[]})}}let L=new Map;s.forEach((C,K)=>{C&&typeof C.root_dir=="string"&&L.set(C.root_dir,K)});let B=r&&r.running_sort==="repo"?"repo":"started";d.sort((C,K)=>{if(B==="repo"){let Oe=L.get(C.root_dir)??Number.MAX_SAFE_INTEGER,ze=L.get(K.root_dir)??Number.MAX_SAFE_INTEGER;if(Oe!==ze)return Oe-ze}let $e=typeof C.started_at=="number"&&Number.isFinite(C.started_at)?C.started_at:null,Ne=typeof K.started_at=="number"&&Number.isFinite(K.started_at)?K.started_at:null;return $e!==null&&Ne!==null&&$e!==Ne?$e-Ne:$e===null&&Ne!==null?1:$e!==null&&Ne===null?-1:C.id.localeCompare(K.id)}),h.sort((C,K)=>(K.done_at??0)-(C.done_at??0));let b=s.length>0?s:n.map(C=>({root_dir:C&&C.root_dir,name:C&&C.name,auto_advance:C&&C.auto_advance,auto_merge:C&&C.auto_merge,slots:C&&C.slots,revision:C&&C.revision,runner_catalog:C&&C.runner_catalog})),F=new Set(u.map(C=>C.root_dir)),J=[];for(let C of b){if(!C||typeof C.root_dir!="string")continue;let K=O.get(C.root_dir)||[],$e=U.get(C.root_dir)||[];!(K.length>0||$e.some(Oe=>Oe.items.length>0||Oe.occupied_by.length>0))&&!F.has(C.root_dir)||J.push({root_dir:C.root_dir,name:C.name||C.root_dir,auto_advance:C.auto_advance===!0,auto_merge:C.auto_merge===!0,slots:typeof C.slots=="number"&&C.slots>=Nu?C.slots:Nu,revision:typeof C.revision=="number"?C.revision:0,runner_catalog:Et(C.runner_catalog),items:K,sublanes:{parallel:K,serial:$e},serial_lane_count:V.get(C.root_dir)||0,raw_queue_length:H.get(C.root_dir)||0})}let ee={runnable:u,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:i==="updated_flat",queue:_,queue_groups:J,running:d,pr_wait:p,done:h,chains:[],parallel_rows:[],chain_lanes:[],parallel_raw_length:Object.fromEntries(H),owner_of:{},pending_lanes_kept:[]},pe=Ou(ee);for(let C of A)pe.has(C.id)||pe.set(C.id,{root_dir:C.root_dir,workspace_name:C.workspace_name,lane:"done",state:"done"});let de=new Map;for(let[C,K]of P)for(let $e of K){let Ne=de.get($e);Ne?Ne.includes(C)||Ne.push(C):de.set($e,[C])}for(let C of[...ee.queue,...ee.runnable]){if(!Object.hasOwn(C,"blocked_by"))continue;let K=pe.get(C.id);C.blockers=(C.blocked_by||[]).map($e=>Mu($e,K,pe,s)),C.blocker_warnings=C.blockers.filter($e=>$e.missing_internal).map($e=>`\u26A0 \uC120\uD589 ${$e.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),C.blocker_warnings.length>0&&(C.alert=!0)}for(let C of[...ee.queue,...ee.runnable,...ee.running,...ee.pr_wait]){let K=C.lane==="running"||C.lane==="pr_wait"?[]:(C.blockers||[]).map(Eg),$e=[];for(let ze of de.get(C.id)||[]){let Ye=Tg(ze,pe);Ye&&$e.push(Ye)}let Ne=C.lane==="running"||C.lane==="pr_wait"?[]:C.blocker_warnings||[];if(K.length===0&&$e.length===0&&Ne.length===0)continue;let Oe={predecessors:K,successors:$e,warnings:Ne};C.dependency_chips=Oe}ee.chains=Rg(P,pe,s);let he=Pu(ee.queue_groups);for(let C of ee.queue_groups)for(let K of C.sublanes.serial){let $e=he.get(Du(C.root_dir,K.id));$e&&(K.cross_wait_peers=$e)}let Se=Og(ee.chains,Array.isArray(r?.pending_lanes)?r.pending_lanes:[],P,pe,s,j);ee.chain_lanes=Se.chain_lanes,ee.pending_lanes_kept=Se.pending_lanes_kept;let Le=new Set;for(let C of ee.chain_lanes)for(let K of C.rows)Le.add(K.id);let te=[];for(let C of O.values())for(let K of C)Le.has(K.id)||te.push(K);te.sort((C,K)=>{let $e=C.workspace_name.localeCompare(K.workspace_name);return $e!==0?$e:(C.queue_index??0)-(K.queue_index??0)}),ee.parallel_rows=te;let se={};for(let[C,K]of pe)typeof K.root_dir=="string"&&K.root_dir.length>0&&(se[C]=K.root_dir);ee.owner_of=se;let Ae=ee.runnable.length,N=ee.runnable;a.show_blocked||(N=N.filter(C=>C.blocked!==!0));let oe=N.length;a.spec==="with"?N=N.filter(C=>!!C.spec_id):a.spec==="without"&&(N=N.filter(C=>!C.spec_id)),ee.runnable_hidden={blocked:Ae-oe,spec:oe-N.length};let re=(C,K)=>{let $e=Bu(K.updated_at)-Bu(C.updated_at);return $e!==0?$e:C.id.localeCompare(K.id)},Ee=i==="repo_spec"?(C,K)=>{let $e=C.spec_id?0:1,Ne=K.spec_id?0:1;return $e!==Ne?$e-Ne:re(C,K)}:re;if(i==="updated_flat")ee.runnable=N.slice().sort(re),ee.runnable_sections=[];else{let C=new Map;for(let Ne of N){let Oe=C.get(Ne.root_dir);Oe?Oe.push(Ne):C.set(Ne.root_dir,[Ne])}let K=[],$e=[];for(let Ne of b){if(!Ne||typeof Ne.root_dir!="string")continue;let Oe=(C.get(Ne.root_dir)||[]).slice().sort(Ee);C.delete(Ne.root_dir),Oe.length!==0&&(K.push({root_dir:Ne.root_dir,name:Ne.name||Ne.root_dir,items:Oe.map(ze=>({...ze,workspace_name:""}))}),$e.push(...Oe))}for(let[Ne,Oe]of C){let ze=Oe.slice().sort(Ee);K.push({root_dir:Ne,name:ze[0]?.workspace_name||Ne,items:ze.map(Ye=>({...Ye,workspace_name:""}))}),$e.push(...ze)}ee.runnable=$e,ee.runnable_sections=K}return ee}var Gu="bdui.monitor.done-range",Vu="bdui.monitor.running_sort",Ku="bdui.monitor.candidate_sort",Yu="beads-ui.monitor.candidate-filter",Zu="beads-ui.monitor.sections";function Mg(){try{let e=window.localStorage.getItem(Yu);if(!e)return{...On};let t=JSON.parse(e);return!t||typeof t!="object"?{...On}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:On.show_blocked,spec:ti.some(r=>r.value===t.spec)?t.spec:"all"}}catch{return{...On}}}function Wu(e){try{window.localStorage.setItem(Yu,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Pg(){try{let e=window.localStorage.getItem(Ku);return _s.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function Dg(e){try{window.localStorage.setItem(Ku,e)}catch{}}function Ng(){try{let e=window.localStorage.getItem(Zu);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function zu(e){try{window.localStorage.setItem(Zu,JSON.stringify(e))}catch{}}function qg(){try{let e=window.localStorage.getItem(Gu);return or(e)?e:er}catch{return er}}function Fg(e){try{window.localStorage.setItem(Gu,e)}catch{}}function jg(){try{return window.localStorage.getItem(Vu)==="repo"?"repo":"started"}catch{return"started"}}function Bg(e){try{window.localStorage.setItem(Vu,e)}catch{}}var Qu="tab:monitor:pipeline",Ug=1e3,Wg=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],Hu="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function zg(e){return e>=1&&e<=Hu.length?Hu[e-1]:`(${e})`}function Xu(e,t){let r=St("views:monitor"),n=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.switchWorkspace,c=t.router,u=t.now||(()=>Date.now()),d=t.confirm||(w=>typeof globalThis.confirm!="function"||globalThis.confirm(w)),p=qg(),_=jg(),h=Mg(),A=Pg(),O=Ng(),U=null,V=null,H=[],P=null;function j(){let w=Rr.find(v=>v.value===p);return w?w.label:""}let L=document.createElement("div");L.className="mon",e.appendChild(L);let B=document.createElement("div");B.className="mon2-drawer",e.appendChild(B);let b=ri(null,null),F=new Map,J=new Map,ee=null,pe=null,de=null,he=Tn(B,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{U=null,me()}});async function Se(w,v,R,W,be=!0){if(!o||!R)return null;let we=await o(w,{...v,root_dir:R,expected_revision:W});if(we&&we.conflict&&be){we.queue&&J.set(R,we.queue);let ge=we.queue&&typeof we.queue.revision=="number"?we.queue.revision:W;we=await o(w,{...v,root_dir:R,expected_revision:ge})}return we&&we.queue&&R&&J.set(R,we.queue),we}function Le(w,v){let R=J.get(w),W=s&&s.get?s.get():null,be=(Array.isArray(W)?W:[]).find(ge=>ge?.root_dir===w);return(R||be)?.merge_queue?.find(ge=>ge.bead_id===v)?.continuation_action}async function te(w,v,R,W){let be=await Se(w,v,R,W),we=J.get(R)?.revision??be?.queue?.revision??W;return wr(be,(ge,Ze)=>Se(w,{...v,continuation:ge,decision_token:Ze},R,we,!1),{refresh:ge=>Se(w,v,R,ge?.queue?.revision??J.get(R)?.revision??we,!1)})}async function se(w,v,R,W){let be=await wr({continuation_mismatch:W},(ge,Ze)=>Se("worker-merge-queue-add",{bead_id:v,continuation:ge,decision_token:Ze},w,R,!1)),we=be?.queue?.merge_queue?.find(ge=>ge.bead_id===v)?.continuation_action;be?.applied!==!0&&we?.continuation===null&&we.mismatch&&await se(w,v,be.queue.revision,we.mismatch)}async function Ae(w,v,R){let W=await Se("worker-discard",w,v,R);if(W&&W.discarded===!0){_e(wo(W),"success",5e3);return}if(W&&W.reason){_e(`\uD3D0\uAE30 \uC2E4\uD328: ${W.reason}`,"error");return}if(W&&W.accepted&&W.pending==="merged_revert"){_e("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(W&&W.accepted){_e(`\uD3D0\uAE30 \uC9C4\uD589: ${W.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}W&&!W.conflict&&_e("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function N(w,v,R){return!o||!R?null:await o(w,{...v,root_dir:R})}async function oe(){let w=new Map;for(let v of b.pr_wait)w.has(v.root_dir)||w.set(v.root_dir,v.expected_revision);for(let[v,R]of w)await Se("worker-merge-queue-add-all",{},v,R)}function re(w){let v=O[w];return!!(v&&v.runnable===!0)}function ye(w){let v={...O[w]||{}};v.runnable=!v.runnable,O={...O,[w]:v},zu(O),me()}function Ee(w){return O[w]===!0}function C(w){O={...O,[w]:O[w]!==!0},zu(O),me()}function K(w){let v=re(w.root_dir);return l`<header class="mon2-sec__hd">
      <button
        type="button"
        ...
        aria-label=${`${w.name} \uC139\uC158 ${v?"\uD3BC\uCE58\uAE30":"\uC811\uAE30"}`}
      >
        ${v?"\u25B8":"\u25BE"}
      </button>
      <span class="mon2-sec__name" title=${w.root_dir}>${w.name}</span>
      <span class="mon2-sec__count">${w.count}</span>
      <button
        type="button"
    ...
    </header>`}function $e(w,v){return l`<div
      class="mon2-item"
      data-bead-id=${w.id}
    ...
    >
      ${v}
    </div>`}function Ne(w){if(V!==w.id)return null;let v=b.queue_groups.find(W=>W.root_dir===w.root_dir),R=v?v.sublanes.serial:[];return{bead_id:w.id,lanes:[{id:"parallel",label:"\uBCD1\uB82C",count:w.place_index??0},...b.chain_lanes.map((W,be)=>({id:`lane:${be}`,label:`\uC5F0\uACB0 ${be+1} \uB05D\uC5D0`,count:W.rows.length})),{id:"new-lane",label:"\uC0C8 \uC5F0\uACB0 \uB808\uC778",count:0},...R.map(W=>({id:`serial:${W.id}`,label:`${v?v.name:""} \uC9C1\uB82C ${W.index+1}`,count:W.raw_length}))]}}function Oe(w){return $e(w,Ua(w,Ne(w),{exec_chips_mode:"pinned_only"}))}function ze(){return b.runnable_flat?l`<div class="mon2-flat" data-drop="candidate">
        ${b.runnable.map(w=>Oe(w))}
      </div>`:l`${b.runnable_sections.map(w=>{let v=re(w.root_dir);return l`<section
        class="mon2-sec${v?" is-collapsed":""}"
        data-root-dir=${w.root_dir}
        data-section="runnable"
      >
        ${K({root_dir:w.root_dir,name:w.name,count:w.items.length})}
        ${v?"":l`<div
      ...
      </section>`})}`}function Ye(w,v){return l`<div
      class="mon2-item"
      data-bead-id=${w.id}
    ...
    </div>`}function Y(){let w=Ee("parallel");return l`<section
      class="mon2-area mon2-parallel${w?" is-collapsed":""}"
      data-area="parallel"
    >
      ...
      ${w?"":l`<div class="mon2-area__body" data-drop="parallel">
            ${b.parallel_rows.length===0?l`<div class="worker-pane__empty">
                  비어 있음 — 드래그로 배치
                </div>`:b.parallel_rows.map((v,R)=>Ye(v,R))}
          </div>`}
    </section>`}function Q(w,v,R){return l`<div
      class="mon2-crow"
    ...
    >
    ...
    </div>`}function Te(w){return l`<div class="mon2-clane" data-lane-id=${w.lane_id}>
      <header class="mon2-clane__hd">
        <span class="mon2-clane__name">${w.label}</span>
        <span class="mon2-clane__count">${w.rows.length}</span>
      </header>
      <div
      ...
      >
        ...
        ${w.rows.length===0?l`<div class="mon2-clane__hint">
              여기로 끌어다 놓으면 연결이 시작됩니다
            </div>`:w.rows.map((v,R)=>Q(w,v,R))}
      </div>
    </div>`}function Qe(w,v,R){return l`<div
      class="mon2-item"
      data-bead-id=${v.id}
    ...
    >
      ${nn(v)}
    </div>`}function Ve(w,v){return l`<div
      class="mon2-lane${v.empty?" mon2-lane--empty":""}"
      data-root-dir=${w.root_dir}
      data-lane-length=${String(v.raw_length)}
    >
      ${cr({id:"",lane:v.id,title:`${w.name} \xB7 \uC9C1\uB82C ${v.index+1}`,items:v.items,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uB4DC\uB798\uADF8\uB85C \uBC30\uCE58",body:l`<div
          ...
          data-lane-length=${String(v.raw_length)}
        >
          ${v.items.length>0?v.items.map((R,W)=>Qe(v,R,W)):l`<div class="worker-pane__empty">
                비어 있음 — 드래그로 배치
              </div>`}
      ...
      ${v.empty?l`<div class="mon2-lane__hint">
            ${w.name} 직렬 ${v.index+1} 비어 있음
          </div>`:""}
      ${v.cycle?l`<div class="mon2-lane__cycle">
            ⛔ 의존 사이클 — 자동 교정 불가
          </div>`:""}
      ${(v.cross_wait_peers||[]).map(R=>l`<div class="mon2-lane__cross-wait">
            ⚠ 상호 정지 — ${R.workspace_name}·${R.lane}과 교차 대기
          </div>`)}
    </div>`}function st(){let w=Ee("serial"),v=b.chain_lanes.some(R=>R.pending&&R.rows.length===0);return l`<section
      class="mon2-area mon2-serial${w?" is-collapsed":""}"
      data-area="serial"
    >
      <header class="mon2-area__hd">
        <button
      ...
      ${w?"":l`<div class="mon2-area__body">
            ${b.chain_lanes.map(R=>Te(R))}
            ${b.queue_groups.map(R=>R.sublanes.serial.map(W=>Ve(R,W)))}
          </div>`}
    </section>`}function et(){return l`<div class="mon2-wait">${Y()}${st()}</div>`}function mt(w){return l`<div class="worker-rungrid">
      ${b.running.length===0?l`<div class="worker-rungrid__empty">실행 세션 없음</div>`:b.running.map(v=>Ha({bead_id:v.id,attempt_id:v.attempt_id||"",title:v.title,runner:v.runner??null,model:v.model??null,effort:v.effort??null,speed:v.speed??null,started_at:v.started_at??null,resumed_from:v.resumed_from??null,continuation_mode:v.continuation_mode??null,paused:v.run_state==="paused",failed:v.run_state==="failed",status:v.status,status_label:v.run_state==="failed"?"\uC2E4\uD328":void 0,resume_eligible:v.can_resume!==!1,can_pause:v.can_pause!==!1,exec_chips:v.exec_chips||null,usage:v.usage||null,discard:v.discard},w,U,{monitor:{repo:v.workspace_name,root_dir:v.root_dir,serial_lane_id:v.serial_lane_id,workflow:v.workflow||null,last_activity:v.last_activity||null,legs:v.legs||[],dependency_chips:v.dependency_chips||null}}))}
    </div>`}function Pe(w){let v={runnable:b.runnable,queue:b.queue,running:b.running,pr_wait:b.pr_wait,done:b.done};return l`<div class="mon2-deck"></div>
      <div class="worker-lanes mon2-lanes">
        ${Wg.map(R=>{let W=v[R.lane],be=R.lane==="runnable"?b.runnable_flat?W.length>0?ze():void 0:b.runnable_sections.length>0?ze():void 0:R.lane==="queue"?b.queue_groups.length>0||b.chain_lanes.length>0||b.parallel_rows.length>0?et():void 0:R.lane==="running"?mt(w):W.length>0?l`${W.map(we=>nn(we))}`:void 0;return cr({id:`monitor-${R.lane}`,lane:R.pane,title:R.lane==="done"?`\uC644\uB8CC\xB7${j()}`:R.title,items:W,empty:R.empty,body:be,live:R.lane==="running"&&W.length>0,controls:R.lane==="runnable"?I():void 0,header_control:ne(R.lane,W.length)})})}
      ...
      <div class="worker-filter__spec" role="group" aria-label="spec 필터">
        ${ti.map(w=>l`<button
              type="button"
              class="mon-filter__spec worker-filter__chip${h.spec===w.value?" is-active":""}"
              data-spec=${w.value}
              aria-pressed=${h.spec===w.value?"true":"false"}
            >
              ${w.label}
            </button>`)}
    ...
    </div>`}function ne(w,v){return w==="runnable"?l`<select
      ...
      </select>`:w==="pr_wait"&&v>0?l`<button
        type="button"
        class="mon-lane-op mon-merge-all"
        title="자격이 생기는 PR을 각 레포의 머지 큐에 한 번에 넣습니다"
      >
        일괄 머지
      </button>`:w==="done"?l`<select
      ...
      </select>`:""}function me(){let w=s&&s.get?s.get():null,v=s&&s.getWorkspacesState?s.getWorkspacesState():[],R=u(),W=()=>ri(w,v,{done_since:Kr(p,R),running_sort:_,candidate_filter:h,candidate_sort:A,pending_lanes:H});b=W(),b.pending_lanes_kept.length!==H.length&&(H=b.pending_lanes_kept.map(be=>H[be]),b=W()),F=new Map;for(let be of[...b.runnable,...b.queue,...b.running,...b.pr_wait,...b.done])F.has(be.id)||F.set(be.id,be);Ge(Pe(R),L),qe()?.render(),ae(),Xe()}function ae(){let w=new Map;for(let v of b.queue_groups)w.set(v.root_dir,v.auto_advance);for(let v of Array.from(L.querySelectorAll(".mon2-parallel .worker-mini__repo"))){let R=v.closest(".mon2-item")?.getAttribute("data-root-dir")||"",W=w.get(R);typeof W=="boolean"&&v.setAttribute("title",`${v.textContent||""} \xB7 ${W?"\uC790\uB3D9\uD654 \uCF1C\uC9D0":"\uC790\uB3D9\uD654 \uAEBC\uC9D0"}`)}}function qe(){if(de)return de;let w=L.querySelector(".mon2-deck");return w?(de=Su(w,{workspacesState:()=>s&&s.getWorkspacesState?s.getWorkspacesState():[],doneItems:()=>b.done,rangeLabel:j,transport:o,implPresetStore:t.execPresetStore,gotoWorkerTab:Je,onFocusChange:v=>{P=v,Xe()}}),de):null}function Xe(){L.classList.toggle("has-focus",P!==null);for(let w of Array.from(L.querySelectorAll(".mon2-sec[data-root-dir]")))w.classList.toggle("is-focus",P!==null&&w.getAttribute("data-root-dir")===P);for(let w of Array.from(L.querySelectorAll(".mon2-item[data-bead-id], .rtile[data-bead-id], .worker-mini[data-bead-id], .worker-card[data-bead-id]"))){let v=F.get(w.getAttribute("data-bead-id")||"");w.classList.toggle("is-focus",P!==null&&!!v&&v.root_dir===P)}for(let w of Array.from(L.querySelectorAll(".mon2-crow[data-root-dir]")))w.classList.toggle("is-focus",P!==null&&w.getAttribute("data-root-dir")===P)}function ot(w,v){let R=a?a():void 0;if(!v||!R||v===R||!i){n(w);return}i(v).then(()=>{n(w)}).catch(W=>{r("workspace switch for %s failed: %o",v,W)})}function Je(w){if(!w)return;let v=a?a():void 0,R=()=>{try{c?.gotoView("worker")}catch(W){r("gotoView(worker) failed: %o",W)}};if(!i||v&&v===w){R();return}i(w).then(R).catch(W=>{r("workspace switch for %s failed: %o",w,W),_e("\uB808\uD3EC \uC804\uD658\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error")})}function dt(w){tr(w).then(v=>{_e(v?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",v?"success":"error",1400)})}function yt(w){let v=F.get(w)||null;return{item:v,root_dir:v?v.root_dir:"",revision:v?v.expected_revision:0}}function gt(w){if(typeof w=="string"&&w.length>0)return w;if(w&&typeof w=="object"){let v=w;if(typeof v.message=="string"&&v.message.length>0)return v.message;if(typeof v.error=="string"&&v.error.length>0)return v.error;if(v.error&&typeof v.error=="object"&&typeof v.error.message=="string")return v.error.message}return"\uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4"}async function pt(w,v,R){let{root_dir:W}=yt(v);if(!(!v||!R||R===v))try{await N(w,{a:v,b:R},W)}catch(be){_e(gt(be),"error")}}function kt(){let w=new Map,v=s&&s.get?s.get():null,R=W=>Array.isArray(W)?W.filter(be=>typeof be=="string"&&be.length>0):[];for(let W of Array.isArray(v)?v:[]){if(!W||typeof W!="object")continue;let be=W.bead_blocked_by&&typeof W.bead_blocked_by=="object"?W.bead_blocked_by:{};for(let[we,ge]of Object.entries(be))Array.isArray(ge)&&w.set(we,R(ge));for(let we of Array.isArray(W.runnable)?W.runnable:[])we&&typeof we.bead_id=="string"&&Array.isArray(we.blocked_by)&&we.blocked_by.length>0&&w.set(we.bead_id,R(we.blocked_by))}return w}function We(){let w=new Map;for(let R of b.chain_lanes)w.set(R.lane_id,R.rows.map(W=>W.id));let v=new Map;for(let R of b.parallel_rows)typeof R.queue_index=="number"&&v.set(R.id,R.queue_index);for(let R of b.queue_groups)for(let W of R.sublanes.serial)for(let be of W.items)typeof be.queue_index=="number"&&v.set(be.id,be.queue_index);return{blocked_by_map:kt(),owner_of:new Map(Object.entries(b.owner_of)),lane_order:w,parallel_rows:b.parallel_rows.map(R=>({bead_id:R.id,root_dir:R.root_dir,queue_index:R.queue_index??0})),parallel_raw_length:new Map(Object.entries(b.parallel_raw_length)),queue_index_of:v}}function Ke(w,v){let R=F.get(v);if(R&&R.root_dir===w)return R.expected_revision;let W=b.queue_groups.find(be=>be.root_dir===w);return W?W.revision:0}async function Ue(w,v){try{if(w.type==="worker-queue-place"||w.type==="worker-queue-reorder"||w.type==="worker-queue-remove"){let R=await Se(w.type,w.payload,w.root_dir,Ke(w.root_dir,v));return R&&R.conflict?(_e("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),!1):!0}return(w.type==="dep-add"||w.type==="dep-remove")&&await N(w.type,{a:w.a,b:w.b},w.root_dir),!0}catch(R){return _e(gt(R),"error"),!1}}async function ct(w,v){let R=Eu(w,v,We());if("refused"in R){_e(R.refused,"error");return}if(v.kind==="chain"){let W=b.chain_lanes.find(we=>we.lane_id===v.lane_id),be=W&&W.pending&&W.rows.length===0?Number(W.lane_id.slice(8)):-1;be>=0&&H[be]&&(H=H.map((we,ge)=>ge===be?{seed:w.bead_id}:we))}for(let W of R.ops)if(!await Ue(W,w.bead_id))break;me()}async function At(w,v){let R=F.get(w);if(!R){me();return}let W={kind:"candidate",bead_id:w,root_dir:R.root_dir};if(v==="new-lane"){H.some(we=>we.seed===null)||(H=[...H,{seed:null}]),me();let be=b.chain_lanes.find(we=>we.pending&&we.rows.length===0);if(!be)return;await ct(W,{kind:"chain",lane_id:be.lane_id,marker_index:0});return}if(v.startsWith("lane:")){let be=b.chain_lanes[Number(v.slice(5))];if(!be){me();return}await ct(W,{kind:"chain",lane_id:be.lane_id,marker_index:be.rows.length});return}if(v.startsWith("serial:")){let be=v.slice(7),we=b.queue_groups.find(Ze=>Ze.root_dir===R.root_dir),ge=we?we.sublanes.serial.find(Ze=>Ze.id===be):void 0;await ct(W,{kind:"repo-serial",root_dir:R.root_dir,lane_id:be,index:ge?ge.raw_length:0});return}await ct(W,{kind:"parallel",marker_index:b.parallel_rows.length})}async function E(w,v){let R=b.parallel_rows,W=R.findIndex(T=>T.id===w);if(W<0)return;let be=R[W].root_dir,we=[];R.forEach((T,ie)=>{T.root_dir===be&&we.push(ie)});let ge=we.indexOf(W),Ze=we[ge+v];if(typeof Ze!="number")return;let Re=v===-1?Ze:we[ge+2]??Math.min(R.length,Ze+1);await ct({kind:"parallel",bead_id:w,root_dir:be,queue_index:R[W].queue_index??0},{kind:"parallel",marker_index:Re})}async function M(w){for(let v of b.chain_lanes){let R=v.rows.find(W=>W.id===w);if(!(!R||!R.draggable)){await ct({kind:"chain",bead_id:w,root_dir:R.root_dir,lane_id:v.lane_id,...typeof R.queue_index=="number"?{queue_index:R.queue_index}:{}},{kind:"parallel",marker_index:b.parallel_rows.length});return}}}let ue=null,k=!1,S=null;function q(){S!==null&&clearTimeout(S),S=setTimeout(()=>{S=null,k=!1},0)}function X(w,v){let R=v&&typeof v.closest=="function"?v.closest("[data-row-index]"):null;if(R&&w.contains(R)){let W=Number(R.getAttribute("data-row-index"));return Number.isFinite(W)?W:0}return w.querySelectorAll("[data-row-index]").length}function ke(w){let v=w.target,R=typeof v?.closest=="function"?v.closest("[data-drop]"):null;if(!R||!ue)return null;let W=R.getAttribute("data-drop");if(W==="candidate")return{zone:R,target:{kind:"candidate"}};if(W==="parallel")return{zone:R,target:{kind:"parallel",marker_index:X(R,v)}};if(W==="chain")return{zone:R,target:{kind:"chain",lane_id:R.getAttribute("data-lane-id")||"",marker_index:X(R,v)}};if(W==="repo-serial"){let be=R.getAttribute("data-root-dir")||"";if(be!==ue.root_dir)return null;let we=typeof v?.closest=="function"?v.closest("[data-queue-index]"):null,ge=we&&R.contains(we)?we.getAttribute("data-queue-index"):R.getAttribute("data-lane-length"),Ze=Number(ge);return{zone:R,target:{kind:"repo-serial",root_dir:be,lane_id:R.getAttribute("data-lane-id")||"",index:Number.isFinite(Ze)?Ze:0}}}return null}function ve(){for(let w of Array.from(L.querySelectorAll(".is-drop-over")))w.classList.remove("is-drop-over")}function Me(w){let v=w.target,R=typeof v?.closest=="function"?v.closest('[draggable="true"][data-bead-id]'):null,W=R?R.closest("[data-drag-kind]"):null;if(!W)return;let be=W.getAttribute("data-bead-id")||"",we=W.getAttribute("data-drag-kind")||"",ge=W.getAttribute("data-root-dir")||"";if(!be||!we||!ge)return;let Ze=W.getAttribute("data-queue-index")||"",Re=Number(Ze),T=W.getAttribute("data-lane-id")||"";ue={kind:we,bead_id:be,root_dir:ge,...Ze!==""&&Number.isFinite(Re)?{queue_index:Re}:{},...T?{lane_id:T}:{}},k=!0,V=null,L.classList.add("is-dragging");try{w.dataTransfer?.setData("text/plain",be),w.dataTransfer&&(w.dataTransfer.effectAllowed="move")}catch{}}function De(w){let v=ke(w);v&&(w.preventDefault(),w.dataTransfer&&(w.dataTransfer.dropEffect="move"),v.zone.classList.add("is-drop-over"))}function Rt(w){let v=w.target;typeof v?.closest=="function"&&v.closest("[data-drop]")?.classList.remove("is-drop-over")}function at(){ue=null,ve(),L.classList.remove("is-dragging"),q()}function tt(w){let v=ke(w),R=ue;ue=null,ve(),L.classList.remove("is-dragging"),!(!v||!R)&&(w.preventDefault(),ct(R,v.target))}function Dt(w){return{runner:w.runner||void 0,model:w.model||void 0,effort:w.effort||void 0,status:w.run_state==="running"?"running":w.run_state,worktree:w.root_dir}}function Ut(w,v){let{item:R,root_dir:W,revision:be}=yt(v),we=R?.attempt_id||"",ge=w.classList;if(ge.contains("worker-dep__remove")){pt("dep-remove",v,w.dataset.blockerId||"");return}if(ge.contains("mon2-rowops__up")||ge.contains("mon2-rowops__down")){E(v,ge.contains("mon2-rowops__up")?-1:1);return}if(ge.contains("mon2-rowops__remove")){Se("worker-queue-remove",{bead_id:v},W,be);return}if(ge.contains("mon2-crow__detach")){M(v);return}if(ge.contains("worker-card__place")){V=V===v?null:v,me();return}if(ge.contains("worker-card__place-cancel")){V=null,me();return}if(ge.contains("worker-card__place-lane")){let Ze=w.getAttribute("data-lane")||"parallel";V=null,At(v,Ze);return}if(ge.contains("rtile__session")){U=we,we&&R&&he.open({attempt_id:we,root_dir:W,meta:Dt(R)}),me();return}if(ge.contains("rtile__pause")){N("worker-attempt-pause",{attempt_id:we},W);return}if(ge.contains("rtile__resume")){xn().then(Ze=>{if(Ze!==null)return te("worker-attempt-resume",{attempt_id:we,...Ze!==""?{instructions:Ze}:{}},W,be)});return}if(ge.contains("rtile__dismiss")){Se("worker-attempt-dismiss",{attempt_id:we},W,be);return}if(ge.contains("rtile__discard")){if(!d(cs(v,"unmerged")))return;Ae({bead_id:v,...we?{attempt_id:we}:{},...w.dataset.operationId?{operation_id:w.dataset.operationId}:{}},W,be);return}if(ge.contains("worker-mini__merge")){let Ze=Le(W,v);Ze?.mismatch&&Ze.continuation===null?se(W,v,be,Ze.mismatch):Se("worker-merge-queue-add",{bead_id:v},W,be);return}if(ge.contains("worker-mini__merge-cancel")){Se("worker-merge-queue-remove",{bead_id:v},W,be);return}if(ge.contains("worker-mini__discard")){let Ze=w.dataset.discardMode==="merged"?"merged":"unmerged";if(!d(cs(v,Ze)))return;Ae({bead_id:v,...w.dataset.attemptId?{attempt_id:w.dataset.attemptId}:{},...w.dataset.operationId?{operation_id:w.dataset.operationId}:{}},W,be);return}if(ge.contains("worker-mini__revise-fix")){te("worker-revise-fix",{bead_id:v},W,be);return}ge.contains("worker-mini__revise-approve")&&Se("worker-revise-approve",{bead_id:v},W,be)}function Fe(w){let v=k;k=!1;let R=w.target;if(!R||typeof R.closest!="function"||R.closest("dialog")||R.closest(".mon2-drawer")||R.closest("a"))return;let W=R.closest(".worker-card__id, .worker-mini__id, .rtile__id");if(W){w.preventDefault();let ft=R.closest(".mon2-item, .rtile, .mon2-crow, .worker-mini")?.getAttribute("data-bead-id")||W.textContent?.trim()||"";ft&&dt(ft);return}let be=R.closest(".worker-mini__repo, .worker-card__repo, .mon2-sec__worker");if(be){w.preventDefault();let Ce=be.getAttribute("data-root-dir")||F.get(R.closest(".mon2-item, .rtile, .worker-mini")?.getAttribute("data-bead-id")||"")?.root_dir||be.getAttribute("title")||"";Je(Ce);return}let we=R.closest(".mon2-sec__toggle");if(we){w.preventDefault(),ye(we.getAttribute("data-root-dir")||"");return}let ge=R.closest(".mon2-area__toggle");if(ge){w.preventDefault(),C(ge.getAttribute("data-area")||"parallel");return}if(R.closest(".mon2-newlane")){w.preventDefault(),H=[...H,{seed:null}],me();return}if(R.closest(".mon-merge-all")){w.preventDefault(),oe();return}let Ze=R.closest(".mon-filter__spec");if(Ze){w.preventDefault(),h={...h,spec:Ze.getAttribute("data-spec")||"all"},Wu(h),me();return}let Re=R.closest(".mon2-item, .rtile, .mon2-crow, .worker-mini, .worker-card");if(!Re)return;let T=Re.getAttribute("data-bead-id")||"",ie=R.closest("button");if(ie){w.preventDefault(),Ut(ie,T);return}T&&!v&&(w.preventDefault(),ot(T,Re.getAttribute("data-root-dir")||yt(T).root_dir))}function Ft(w){let v=w.target;if(!v||typeof v.closest!="function")return;let R=v.closest(".mon-filter__blocked");if(R){h={...h,show_blocked:R.checked},Wu(h),me();return}let W=v.closest(".mon-candidate-sort");if(W){A=_s.some(ge=>ge.value===W.value)?W.value:"repo_spec",Dg(A),me();return}let be=v.closest(".mon-running-sort");if(be){_=be.value==="repo"?"repo":"started",Bg(_),me();return}let we=v.closest(".mon-done-range");we&&(p=or(we.value)?we.value:er,Fg(p),me())}e.addEventListener("click",Fe),e.addEventListener("change",Ft),e.addEventListener("dragstart",Me),e.addEventListener("dragover",De),e.addEventListener("dragleave",Rt),e.addEventListener("drop",tt),e.addEventListener("dragend",at),s&&typeof s.subscribe=="function"&&(ee=s.subscribe(()=>{try{J.clear(),me()}catch{}}));function It(){pe!==null&&(clearInterval(pe),pe=null)}function zt(){S!==null&&(clearTimeout(S),S=null)}return{load(){r("load"),me(),pe===null&&(pe=setInterval(()=>{try{me()}catch{}},Ug))},pause(){It()},clear(){It(),zt(),ee&&(ee(),ee=null),he.destroy(),de?.destroy(),de=null,e.removeEventListener("click",Fe),e.removeEventListener("change",Ft),e.removeEventListener("dragstart",Me),e.removeEventListener("dragover",De),e.removeEventListener("dragleave",Rt),e.removeEventListener("drop",tt),e.removeEventListener("dragend",at),e.replaceChildren()}}}function Ju(e,t,r){let n=St("views:nav"),{global_element:s,repo_element:o}=e,a=null;function i(_){return h=>{h.preventDefault(),n("click tab %s",_),r.gotoView(_)}}function c(){let _=t.getState();return _.view==="worker"||_.view==="monitor"?_.view:"board"}function u(){let _=c();return l`
      <a
        href="#/monitor"
  ...
  `,e.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),a=r.querySelector("#new-priority"),i=r.querySelector("#new-labels"),c=r.querySelector("#new-description"),u=r.querySelector("#new-issue-error"),d=r.querySelector("#btn-cancel"),p=r.querySelector("#btn-create"),_=r.querySelector(".new-issue__close");function h(){o.replaceChildren();let L=document.createElement("option");L.value="",L.textContent="\u2014 Select \u2014",o.appendChild(L);for(let B of ed){let b=document.createElement("option");b.value=B,b.textContent=td(B),o.appendChild(b)}a.replaceChildren();for(let B=0;B<=4;B+=1){let b=document.createElement("option");b.value=String(B);let F=rd[B]||"Medium";b.textContent=`${B} \u2013 ${F}`,a.appendChild(b)}}h();function A(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function O(L){s.disabled=L,o.disabled=L,a.disabled=L,i.disabled=L,c.disabled=L,d.disabled=L,p.disabled=L,p.textContent=L?"Creating\u2026":"Create"}function U(){u.textContent=""}function V(L){u.textContent=L}function H(){try{let L=window.localStorage.getItem("beads-ui.new.type");L?o.value=L:o.value="";let B=window.localStorage.getItem("beads-ui.new.priority");B&&/^\d$/.test(B)?a.value=B:a.value="2"}catch{o.value="",a.value="2"}}function P(){let L=o.value||"",B=a.value||"";L.length>0&&window.localStorage.setItem("beads-ui.new.type",L),B.length>0&&window.localStorage.setItem("beads-ui.new.priority",B)}async function j(){U();let L=String(s.value||"").trim();if(L.length===0){V("Title is required"),s.focus();return}let B=Number(a.value||"2");if(!(B>=0&&B<=4)){V("Priority must be 0..4"),a.focus();return}let b=String(o.value||""),F=String(c.value||""),J={title:L};b.length>0&&(J.type=b),String(B).length>0&&(J.priority=B),F.length>0&&(J.description=F),O(!0);try{await t("create-issue",J)}catch{O(!1),V("Failed to create issue");return}P(),O(!1),A()}return r.addEventListener("cancel",L=>{L.preventDefault(),A()}),_.addEventListener("click",()=>A()),d.addEventListener("click",()=>A()),r.addEventListener("keydown",L=>{L.key==="Enter"&&(L.ctrlKey||L.metaKey)&&(L.preventDefault(),j())}),n.addEventListener("submit",L=>{L.preventDefault(),j()}),{open(){n.reset(),U(),H();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){A()}}}var Hg=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function Gg(e,t){return ea(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function sd(e,t,r){return l`
    <section class="settings-dialog__group">
      ...
      ${t.length===0?l`<div class="settings-dialog__empty">라벨 없음</div>`:l`<div class="settings-dialog__pills">
            ${t.map(n=>{let s=Gg(n,e);return l`<button
                type="button"
  ...
  `}function ad(e,t){return l`
    <section class="settings-dialog__group">
      ...
      <div class="settings-dialog__toggles">
        ${Hg.map(([r,n])=>l`<label class="settings-dialog__toggle">
              <input
                type="checkbox"
                data-chip=${r}
                .checked=${e.chips[r]!==!1}
  ...
  `}var Vg=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function id(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(he=>_e(he,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,u="",d=null;function p(){if(d)return d;let he=a.querySelector('[data-pane="execution"]');return he?(d=Eo(he,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:r,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:Se=>t.queueStore?.set?.(Se)}),d):null}function _(){return l`
      <section
    ...
    `}async function A(he){let Se=n.get();if(Se)try{let Le=await r("display-policy-set",{expected_revision:Se.revision,policy:he(Se)});O(Le),Le&&Le.conflict&&Le.policy&&(Le=await r("display-policy-set",{expected_revision:Le.policy.revision,policy:he(Le.policy)}),O(Le)),Le&&Le.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function O(he){he&&he.policy&&typeof he.policy=="object"&&n.set(he.policy)}function U(he){A(he)}function V(he){let Se=n.get();if(!Se)return;let Le=!Kg(he,Se);U(te=>Yg(he,te,Le))}function H(){let he=u.trim();he.length!==0&&(u="",U(Se=>Se.hidden_prefixes.includes(he)?{hidden_prefixes:Se.hidden_prefixes}:{hidden_prefixes:[...Se.hidden_prefixes,he]}),L())}function P(he){U(Se=>({hidden_prefixes:Se.hidden_prefixes.filter(Le=>Le!==he)}))}function j(he){let Se=n.get();if(!Se)return;let Le=Se.chips[he]===!1;U(()=>({chips:{[he]:Le}}))}function L(){Ge(l`
      ...
      `,a),p()}function B(he){i=he,L()}let b=()=>{c=!1,t.onOpenChange?.(!1)};a.addEventListener("close",b),a.addEventListener("cancel",b);let F=he=>{he.target===a&&de()};a.addEventListener("click",F);let J=null;n.subscribe&&(J=n.subscribe(()=>{c&&L()}));let ee=null;t.implPresetStore?.subscribe&&(ee=t.implPresetStore.subscribe(()=>{c&&d?.render()}));function pe(he="execution"){c||(c=!0,t.onOpenChange?.(!0),i=he,u="",L(),typeof a.showModal=="function"?a.showModal():a.setAttribute("open",""),p()?.load())}function de(){c&&(c=!1,t.onOpenChange?.(!1),typeof a.close=="function"?a.close():a.removeAttribute("open"))}return{open:pe,close:de,sessionDraft:()=>d?.sessionDraft()??{},destroy(){c=!1,a.removeEventListener("close",b),a.removeEventListener("cancel",b),a.removeEventListener("click",F),J&&(J(),J=null),ee&&(ee(),ee=null),d?.destroy(),d=null,a.remove()}}}function Kg(e,t){return t.visible_labels.includes(e)?!0:t.hidden_labels.includes(e)?!1:!t.hidden_prefixes.some(r=>r.length>0&&e.startsWith(r))}function Yg(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}var Zg=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ld="usage-meter-card",Qg="usage-meter-layer",cd=600,Xg=["token_expired","relogin_required"];function ud(e){return String(e).padStart(2,"0")}function Jg(e,t){let r=Math.max(0,Math.ceil((e-t)/6e4)),n=Math.floor(r/1440),s=Math.floor(r%1440/60),o=r%60;return n>0?`${n}d${s>0?` ${s}h`:""}`:s>0?`${s}h${o>0?` ${o}m`:""}`:`${o}m`}function dd(e,t=Date.now()){let r=Date.parse(e);if(!Number.isFinite(r))return"";let n=new Date(r),s=new Date(t),o=`${ud(n.getHours())}:${ud(n.getMinutes())}`,i=n.getFullYear()===s.getFullYear()&&n.getMonth()===s.getMonth()&&n.getDate()===s.getDate()?o:`${Zg[n.getMonth()]} ${n.getDate()} ${o}`;return`${Jg(r,t)} \xB7 ${i}`}function eh(e){let t=Math.max(0,Math.floor(e));return t<60?`${t}\uCD08 \uC804`:t<3600?`${Math.floor(t/60)}\uBD84 \uC804`:`${Math.floor(t/3600)}\uC2DC\uAC04 \uC804`}function pd(e){return e>=85?"usage-meter__window--danger":e>=60?"usage-meter__window--warn":"usage-meter__window--success"}function fd(e){let t=typeof e=="number"&&Number.isFinite(e)?e:0;return Math.min(100,Math.max(0,t))}var _d=[{key:"claude",label:"Claude",endpoint:"/api/claude-usage",switch_endpoint:"/api/claude-account/switch",tool:"cswap"},{key:"codex",label:"Codex",endpoint:"/api/codex-usage",switch_endpoint:"/api/codex-account/switch",tool:"codex-auth"}];function gd(e){let t=[];for(let r of e){if(!r||typeof r!="object")continue;let n=r;typeof n.key!="string"||n.key.length===0||typeof n.pct!="number"||!Number.isFinite(n.pct)||t.push({key:n.key,pct:n.pct,resetsAt:typeof n.resetsAt=="string"?n.resetsAt:""})}return t}function th(e){if(!e||typeof e!="object")return null;let t=e;return!Number.isInteger(t.number)||t.number<=0||typeof t.email!="string"||t.email.length===0||typeof t.status!="string"||t.status.length===0||typeof t.active!="boolean"||!Array.isArray(t.windows)?null:{number:t.number,email:t.email,alias:typeof t.alias=="string"&&t.alias.length>0?t.alias:null,plan:typeof t.plan=="string"&&t.plan.length>0?t.plan:null,active:t.active,status:t.status,windows:gd(t.windows),fetchedAt:typeof t.fetchedAt=="string"?t.fetchedAt:null,ageSeconds:typeof t.ageSeconds=="number"&&Number.isFinite(t.ageSeconds)?t.ageSeconds:null}}function rh(e){if(!e||typeof e!="object")return null;let t=e,r=[];if(Array.isArray(t.accounts))for(let s of t.accounts){let o=th(s);o&&r.push(o)}let n=t.available===!0&&Array.isArray(t.windows);return!n&&r.length===0?null:{available:n,windows:n?gd(t.windows):[],ageSeconds:typeof t.ageSeconds=="number"&&Number.isFinite(t.ageSeconds)?t.ageSeconds:null,accounts:r}}function md(e,t){return`${e}:${t}`}function hd(e){let t=!1,r=null,n=new Map,s=null,o=new Map,a=new Map,i=0,c=null;function u(){Ge(l``,e),e.hidden=!0,p()}function d(){if(c===null){let te=e.ownerDocument;c=te.createElement("div"),c.id=Qg,c.className="usage-meter__layer",te.body.appendChild(c)}return c}function p(){c!==null&&(Ge(l``,c),c.remove(),c=null)}function _(te){r!==te&&(r===null&&(document.addEventListener("mousedown",A),document.addEventListener("keydown",U),window.addEventListener("resize",O)),r=te)}function h(){r!==null&&(r=null,document.removeEventListener("mousedown",A),document.removeEventListener("keydown",U),window.removeEventListener("resize",O))}function A(te){let se=te.target;se&&(e.contains(se)||c!==null&&c.contains(se))||(h(),de())}function O(){de()}function U(te){te.key==="Escape"&&(h(),de())}function V(te){r===te?h():_(te),de()}function H(){h(),de()}async function P(te,se){if(n.has(te.key))return;let Ae=md(te.key,se);n.set(te.key,se),a.delete(Ae),de();let N=null;try{N=await(await fetch(te.switch_endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({number:se})})).json()}catch{N=null}if(t)return;if(n.delete(te.key),!N||N.ok!==!0){let re=N&&typeof N.error=="string"&&N.error.length>0?N.error:"network_error";a.set(Ae,{kind:"error",text:`\uC804\uD658 \uC2E4\uD328 \u2014 ${re}`}),de();return}let oe=Array.isArray(N.warnings)?N.warnings.filter(re=>typeof re=="string"&&re.length>0):[];oe.length>0&&a.set(Ae,{kind:"warn",text:oe.join(" \xB7 ")}),de(),await Le()}function j(te,se,Ae,N){let oe=fd(te.pct),ye=`resets ${dd(te.resetsAt,N)}${se?` \xB7 ${Ae}`:""}`;return l`<span
    ...
    </span>`}function L(te,se,Ae){let N=se.available&&typeof se.ageSeconds=="number"&&se.ageSeconds>cd,oe=N&&typeof se.ageSeconds=="number"?`${Math.floor(se.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",re=se.accounts.filter(K=>!K.active).length,ye=`usage-meter__group${N?" usage-meter__group--stale":""}`,Ee=l`<span class="usage-meter__provider"
        >${te.label}</span
      >
    ...
    >
      ${Ee}
    </button>`}function B(te,se){return l`<span class="usage-meter" aria-label="Usage">
      ${te.map(Ae=>L(Ae.provider,Ae.snapshot,se))}
    ...
    >
      ...
      ${Ve(k)}
    </div>`}function Ve(k){return!et(k)||st(k)?l`<span class="pa-settings__unset">분석 모델 설정 필요</span>`:k.compatible===!1?l`<span class="pa-settings__incompatible"
        >설정 비호환 — 저장된 ${k.runner}/${k.model} · effort
        ${k.effort} 을(를) 카탈로그가 더는 제공하지 않습니다</span
      >`:k.is_default===!0?l`<span class="pa-settings__default">기본값</span>`:""}function st(k){return k.is_default===!0&&k.compatible===!1}function et(k){return!!(k.runner&&k.model&&k.effort)}function mt(k){return et(k)&&k.compatible!==!1}function Pe(k){let S=Math.max(0,Math.floor(k/1e3)),q=Math.floor(S/60),X=S%60;return`${q}:${String(X).padStart(2,"0")}`}function I(k){let S=k.job;if(S){let q=typeof S.started_at=="number"?S.started_at:0,X=`${S.runner||"?"}/${S.model||"?"}`,ke=q?` \xB7 \uACBD\uACFC ${Pe(Date.now()-q)}`:"",ve=typeof S.session_id=="string"?S.session_id:"",Me=b(k).find(De=>De.run_id===S.job_id);return l`<span class="pa-meta__progress">
        <span
        ...
        >`:""}function ne(){return n?.isPending?.()===!0}function me(k){let S=!!k.job,q=mt(k.settings),X=h!==null&&A.size===0,ke=S||d||ne()||O;return l`<div class="pa-meta">
    ...
    </div>`}function ae(k){return typeof k=="string"&&k.length>0?k:"\uBBF8\uBC30\uCE58"}function qe(k,S){S?A.add(k):A.delete(k),We()}function Xe(k){let S=Array.isArray(k.scope)?k.scope:[],q=Array.isArray(k.overlaps)?k.overlaps:[];return S.length===0&&q.length===0?l``:l`<span class="pa-target__signals">
...
`)}>
      ...
      <header class="pa-targets__header">
        ...
        <span class="pa-targets__summary"
          >${O?"\uC870\uD68C \uC911\u2026":`\uC790\uACA9 ${k.length} \xB7 \uC81C\uC678 ${S.length}`}</span
        >
      </header>
    ...
    </section>`}function Je(k){let S=typeof k.session_id=="string"&&k.session_id.length>0,q=S?k.session_id:"";return l`<li class="pa-run-row">
      <span class="pa-run-row__status pa-run-row__status--${k.outcome}"
        >${ih[k.outcome]||k.outcome}</span
      >
...
${V.prompt}</pre
    ...
    </div>`:""}function gt(k,S){let q=pe(k,S),X=F(),ke=q.filter(tt=>X.has(tt)),ve=J(q),Me=de(q),De=Array.isArray(P().serial_lanes)?P().serial_lanes:[],Rt=u.get(k)||he(),at=S.eligible!==!0||q.length<2||ke.length>0||ve.length>0||Me||d;return l`<section class="pa-group" data-group-index=${String(k)}>
      <header class="pa-group__head">
        <span class="pa-group__confidence">${S.confidence}</span>
        ${S.categories.map(tt=>l`<span class="pa-group__category">${tt}</span>`)}
      ...
      <ol class="pa-group__members">
        ${q.map((tt,Dt)=>l`<li class="pa-member" data-bead-id=${tt}>
              <span class="pa-member__seq">${Dt+1}</span>
              <span class="pa-member__title">${Se(tt)}</span>
              ${X.has(tt)?l`<span class="pa-member__active">실행 중</span>`:""}
              <button
                type="button"
                class="pa-member__up"
                data-bead-id=${tt}
      ...
      <ul class="pa-group__evidence">
        ${S.evidence.map(tt=>l`<li class="pa-evidence">
              <code>${tt.path}</code>
      ...
      <footer class="pa-group__foot">
        ...
        <label class="pa-group__lane-field"
          ...
          <select
            ...
            aria-label="제출 대상 레인"
            @change=${tt=>{u.set(k,tt.target.value),We()}}
          >
            ${De.map((tt,Dt)=>l`<option
                  value=${tt.id}
                  ?selected=${Rt===tt.id}
                >
                  직렬 ${Dt+1}
      ...
      <span>uncertain ${X}</span>
        ...
        ${yt()}
      `,i)}let Ke=!1,Ue=()=>{Ke=!1,V=null,U+=1,kt()},ct=k=>{k.target===k.currentTarget&&ue()};i.addEventListener("close",Ue),i.addEventListener("cancel",Ue),i.addEventListener("click",ct);let At=null;r&&r.subscribe&&(At=r.subscribe(()=>{Ke&&We()}));let E=null;n&&n.subscribe&&(E=n.subscribe(()=>{Ke&&We()}));function M(){Ke||(Ke=!0,We(),B(),typeof i.showModal=="function"?i.showModal():i.setAttribute("open",""))}function ue(){Ke&&(Ke=!1,V=null,U+=1,kt(),typeof i.close=="function"?i.close():i.removeAttribute("open"))}return{open:M,close:ue,destroy(){Ke=!1,_!==null&&(clearInterval(_),_=null),i.removeEventListener("close",Ue),i.removeEventListener("cancel",Ue),i.removeEventListener("click",ct),At&&(At(),At=null),E&&(E(),E=null),i.remove()}}}var wd=new Set(["sh","bash","zsh","dash","ksh"]),kd=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function $d(e){let t=e.split("/");return t[t.length-1]||""}function ch(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let r=t.slice(2).trim().split(/\s+/).filter(Boolean);if(r.length===0)return!1;let n=$d(r[0]);if(n!=="env")return wd.has(n);let s=r.slice(1).find(o=>!o.startsWith("-")&&!o.includes("="));return s!==void 0&&wd.has($d(s))}function uh(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function dh(e){let t=[],r=0;kd.lastIndex=0;for(let n of e.matchAll(kd)){let s=n.index;s>r&&t.push({text:e.slice(r,s),kind:"plain"}),t.push({text:n[0],kind:uh(n[0])}),r=s+n[0].length}return r<e.length&&t.push({text:e.slice(r),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function ph(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function xd(e){let t=e.getWorkspacePath,r=e.fetchImpl||globalThis.fetch?.bind(globalThis),n=document.createElement("div");n.className="repo-ops-script-viewer-root",document.body.appendChild(n);let s=null,o="loading",a="",i="",c=0,u=null,d=!1;function p(L,B){return B?dh(L).map(b=>b.kind==="plain"?b.text:l`<span
            class="repo-ops-script-viewer__token repo-ops-script-viewer__token--${b.kind}"
            >${b.text}</span
          >`):L}function _(){if(!s)return l``;let L=o==="ready"&&ch(a),B=o==="ready"?a.split(`
`):[];return l`<div
        ...
        <div class="repo-ops-script-viewer__body" aria-live="polite">
          ${o==="loading"?l`<div class="repo-ops-script-viewer__status">
                ...
                >
                  ...
                  ${B.map((b,F)=>l`<div class="repo-ops-script-viewer__row">
                        <span
    ...
    </div>`}function h(){Ge(_(),n)}async function A(){if(o!=="ready")return;let L=await tr(a);_e(L?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",L?"success":"error")}function O(L){L.key==="Escape"&&s&&(L.preventDefault(),P())}function U(){d||(document.addEventListener("keydown",O),d=!0)}function V(){d&&(document.removeEventListener("keydown",O),d=!1)}async function H(L,B=null){let b=++c;U(),s={...L},u=B||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",h(),n.querySelector(".repo-ops-script-viewer__close")?.focus();let J=t?t():"";if(!J){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",h();return}if(!r){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",h();return}let ee="/api/repo-ops-script?workspace="+encodeURIComponent(J)+"&lane="+encodeURIComponent(L.lane)+"&base_sha="+encodeURIComponent(L.base_sha);try{let pe=await r(ee),de=await pe.json().catch(()=>({}));if(b!==c)return;if((t?t():"")!==J){P();return}if(!pe.ok||!de||de.ok!==!0){o="error",i=ph(de&&typeof de.error=="string"?de.error:""),h();return}s={lane:de.lane,base_sha:de.base_sha,path:de.path,base_ref:de.base_ref},a=String(de.content),o="ready",h()}catch{if(b!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",h()}}function P(){c+=1,V(),s=null,a="",h();let L=u;u=null,L?.isConnected&&L.focus()}function j(){P(),n.remove()}return{open:H,close:P,destroy:j}}function Ad(e){let t=e.queueStore,r=e.transport,n=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let b=o();return typeof b.revision=="number"?b.revision:0}function i(b){t&&b&&b.queue&&typeof b.queue=="object"&&t.set(b.queue)}function c(){let b=o().workspace_info;return b&&typeof b=="object"?b:{}}function u(b,F){return l`<span
    ...
    ></button>`}function h(){let b=o().repo_ops_opt_out;return{verify:b?.verify===!0,deploy:b?.deploy===!0}}function A(b,F){return l`<label class="worker-repo-ops__lane-run">
      <input
        type="checkbox"
        .checked=${!F}
      ...
      />
      이 workspace에서 실행
    </label>`}function O(b){let F=typeof b.base_sha=="string"?b.base_sha:"",J=`${b.source_path||"repo-ops/config.toml"} @ ${b.base_ref||"?"}${F?`@${F.slice(0,7)}`:""}`,ee=h(),pe=!!b.verify&&ee.verify,de=!!b.deploy&&ee.deploy;return l`<section class="worker-repo-ops__vd" data-seam="repo-ops">
      ...
      >
        ...
        >
        ${b.deploy?A("deploy",ee.deploy):""}
      </div>
    </section>`}function U(b){let F=b.repo_ops&&typeof b.repo_ops=="object"?b.repo_ops:null;return F&&(F.status==="resolved"||F.status==="absent")?O(F):F&&(F.status==="pending"||F.status==="error")?l`<section class="worker-repo-ops__vd" data-seam="repo-ops">
        <p class="worker-repo-ops__vd-title">
          저장소 작업 선언
  ...
  </p>`}function yh(e){if(e.state!=="failed"||e.superseded_by)return"";let t=e.repair||{},r=typeof t.remaining=="number"?t.remaining:0,n=e.failure_kind==="verify_script_failure"&&e.verify_stage==="pre_merge"?"verify_script_failure_pre_merge":e.failure_kind||"",s=r<=0;return l`<div class="worker-ev__acts">
    <button
      type="button"
  ...
  </div>`}function vh(e){let t=e.operation,r=t.state==="failed",n=t.failure?t.failure.code:"";return l`<li
    class="worker-ev"
  ...
  </li>`}function wh(e){let t=e.cleanup,r=on(t.step);return l`<li
    class="worker-ev"
  ...
  >
  ...
  </li>`}function kh(e){let t=typeof e.hidden=="number"?e.hidden:0,r=e.expanded===!0;return l`<section class="worker-repo-drawer" data-seam="repo-ops-timeline">
    ...
    ${e.events.length===0?l`<div class="worker-repo-drawer__empty">기록 없음</div>`:l`<ul class="worker-rail">
          ${e.events.map(n=>n.type==="cleanup"?wh(n):vh(n))}
        </ul>`}
...
${Nt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:z==="done"?ir(f.attempts||{},fe.bead_id):null,work_ms:z==="done"?yo(f.attempts||{},fe.bead_id):null,done_at:z==="done"&&typeof fe.added_at=="number"?fe.added_at:void 0,exec_chips:_t?Ie(fe.bead_id):null,...Br(fe.bead_id)}}),pn=f.attempts?Object.values(f.attempts):[],Do=new Set;for(let g of pn)g&&typeof g.resumed_from=="string"&&g.resumed_from.length>0&&Do.add(g.resumed_from);let gi=new Map;for(let g of pn)gi.set(g.bead_id,g.attempt_id);let ys=new Map;for(let g of pn)ys.set(g.attempt_id,g);function No(g){let z=new Set,fe=g;for(;fe&&!z.has(fe.attempt_id);){if(fe.conflict_resolution===!0)return!0;z.add(fe.attempt_id),fe=typeof fe.resumed_from=="string"&&fe.resumed_from.length>0&&ys.get(fe.resumed_from)||null}return!1}let vs=typeof f.declared_base=="string"?f.declared_base:null;function lp(g){let z=null;for(let fe of pn)!fe||fe.bead_id!==g||No(fe)||(z===null||(typeof fe.started_at=="number"?fe.started_at:0)>=(typeof z.started_at=="number"?z.started_at:0))&&(z=fe);return z&&typeof z.target_base=="string"?z.target_base:null}let hi=[],bi=[],cp=bd(f),yi=g=>{let z=typeof g.session_id=="string"&&g.session_id.length>0,fe=Do.has(g.attempt_id);return{eligible:z&&!fe,reason:z?fe?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},ur=null;for(let g of pn){let z=g.status==="paused"&&!Do.has(g.attempt_id);if(g.status==="running"||z)bi.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:rt.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,paused:z,conflict_resolution:No(g),base_exception:li(vs,g.target_base),can_pause:typeof g.session_id=="string"&&g.session_id.length>0,discard:yr(bs,g.bead_id,{attempt_id:g.attempt_id}),usage:ir(f.attempts||{},g.bead_id),rollup:ut(g.bead_id),rollup_expanded:de.has(g.bead_id),exec_chips:Z(g),...Br(g.bead_id)});else if((g.status==="failed"||g.status==="orphaned")&&cp(g)){let fe=yi(g);hi.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:rt.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,failed:!0,status:g.status,status_label:g.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:yr(bs,g.bead_id,{attempt_id:g.attempt_id}),resume_eligible:fe.eligible,resume_reason:fe.reason,conflict_resolution:No(g),base_exception:li(vs,g.target_base),usage:ir(f.attempts||{},g.bead_id),rollup:ut(g.bead_id),rollup_expanded:de.has(g.bead_id),exec_chips:Z(g),...Br(g.bead_id)}),ur=g}}let ws=[...hi,...bi].map(g=>{let z=ys.get(g.attempt_id),fe=z?.quickfix_landing;if(z?.quickfix_lane!==!0||!fe||typeof fe!="object")return g;let He=typeof fe.reason=="string"&&fe.reason.length>0?fe.reason:null,_t=fs({bead_id:z.bead_id,merge_sha:fe.head_sha,cleanup_cursor:fe.cursor,cleanup_failed:He?{step:fe.cursor,reason:He}:null,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]});return _t?{...g,landing:_t}:g}),vi=null;if(ur){let g=yi(ur),z=ur.cause_detail;vi={bead_id:ur.bead_id,repo:ur.repo||"",reason:ur.cause||ur.status,cause_detail:z&&typeof z.reason=="string"?{reason:z.reason,command:typeof z.command=="string"?z.command:null}:null,resume_attempt_id:ur.attempt_id,resume_eligible:g.eligible,resume_reason:g.reason,discard:yr(bs,ur.bead_id,{attempt_id:ur.attempt_id})}}let wi=new Set(ws.map(g=>g.bead_id)),qo=Array.isArray(f.merge_queue)?f.merge_queue:[],ki=new Map,$i=new Map,xi=new Map,Ai=new Map,Si=new Map;qo.forEach((g,z)=>{g&&typeof g.bead_id=="string"&&(ki.set(g.bead_id,z+1),$i.set(g.bead_id,g.resolution),xi.set(g.bead_id,g.continuation_action||null),Ai.set(g.bead_id,g.head_review||null),Si.set(g.bead_id,g.authority||null))});let fn=f.merge_queue_state||{active:null,failures:{}},up=fn.failures||{},Ei=fn.waiting&&typeof fn.waiting.bead_id=="string"&&typeof fn.waiting.reason=="string"?fn.waiting:null,dp=f.auto_merge_skips||{},Ti=g=>{let z=dp[g];if(!z)return null;let fe=un[g],He=fe&&fe.pr?fe.pr.head_sha:null;return He&&He===z.head_sha?z.reason||"":null},ks=new Map;for(let g of ws)g.failed!==!0&&g.conflict_resolution&&(g.paused?ks.has(g.bead_id)||ks.set(g.bead_id,"paused"):ks.set(g.bead_id,"running"));let Ci=ws.filter(g=>!g.paused&&g.failed!==!0).length,Ri=(f.workspace_info||{}).slots,Ii=typeof Ri=="number"?Ri:typeof f.slots=="number"?f.slots:Lo,pp=Ci>Ii,$s=Kr(P),fp=(Array.isArray(f.done)?f.done.slice():[]).filter(g=>$s===void 0||typeof g.added_at!="number"||g.added_at>=$s).sort((g,z)=>(z.added_at||0)-(g.added_at||0)),Mn=Po(fp,"done"),_p=new Set((Array.isArray(f.done)?f.done:[]).map(g=>g?.bead_id).filter(g=>typeof g=="string")),Li=[],mp=u?.()||"";for(let g of m){let z=Qr(g.closed_at);if(typeof g.id!="string"||_p.has(g.id)||z===null||$s!==void 0&&z<$s||typeof g.comment_count!="number"||g.comment_count<=0)continue;let fe=`${mp}\0${g.id}\0${String(g.updated_at)}\0${g.comment_count}`,He=j.get(fe);He===void 0&&r&&(j.set(fe,"pending"),Promise.resolve(r("get-comments",{id:g.id})).then(_t=>{let jt=Array.isArray(_t)&&_t.some(Nt=>lo(typeof Nt?.text=="string"?Nt.text:"")?.lane==="session");j.set(fe,jt?"session":"not-session"),Fe()}).catch(()=>{j.set(fe,"failed"),Fe()})),He==="session"&&Li.push({id:g.id,title:g.title||g.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:z,created_at:g.created_at,updated_at:g.updated_at})}Mn.push(...Li),Mn.sort((g,z)=>(z.done_at||0)-(g.done_at||0));let xs={};for(let g of kr)xs[g]=0;let Oi=!1,Mi=0,Fo=0,Pi=0;for(let g of Mn){let z=g.usage;if(z&&typeof z=="object"){let fe=!1;for(let He of kr)Number.isFinite(z[He])&&(xs[He]+=z[He],Oi=!0,fe=!0);fe&&(Fo+=1,Number.isFinite(z.total_cost_usd)&&(Mi+=z.total_cost_usd,Pi+=1))}}Fo>0&&Pi===Fo&&(xs.total_cost_usd=Mi);let Di=Mn.map(g=>g.usage).filter(g=>g&&typeof g=="object"&&g.providers),gp=Di.length>0?Wt(Vs(Di)):Oi?$r(xs):null,hp=f.lane_states&&typeof f.lane_states=="object"&&!Array.isArray(f.lane_states)?f.lane_states:{},bp=Array.isArray(f.serial_lanes)?f.serial_lanes:[],Ni=g=>{if(Ur.some(He=>He.bead_id===g))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let z=pn.filter(He=>He&&He.bead_id===g),fe=z.length>0?z[z.length-1].status:null;return fe==="failed"||fe==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":fe==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},qi=bp.filter(g=>g&&typeof g.id=="string"&&Array.isArray(g.entries)).map((g,z)=>{let fe=hp[g.id]||{},He=new Map((Array.isArray(fe.corrections)?fe.corrections:[]).filter($t=>$t&&typeof $t.bead_id=="string"&&typeof $t.after=="string").map($t=>[$t.bead_id,$t.after])),_t=Po(g.entries.filter($t=>!wi.has($t.bead_id)),g.id).map($t=>He.has($t.id)?{...$t,badges:[`\u{1F517} ${He.get($t.id)} \uB4A4 (blocks \uC790\uB3D9)`,...$t.badges]}:$t),jt=Array.isArray(fe.occupied_by)?fe.occupied_by.filter($t=>typeof $t=="string"):[],Nt=jt.map($t=>({id:$t,title:rt.get($t)||$t,draggable:!1,lane:g.id,ghost:!0,badges:[Ni($t)]}));return{id:g.id,index:z+1,rows:[...Nt,..._t],occupied:jt.length>0,badge:jt.length>0?Ni(jt[0]):"\uB300\uAE30",cycle:fe.cycle===!0}}),yp=typeof f.serial_lane_count=="number"?f.serial_lane_count:qi.length;return{queue:f,idToTitle:rt,candidates:ap,candidate_hidden:{blocked:Mo.hidden_blocked,spec:Mo.hidden_spec},running:ws,live_count:Ci,slots:Ii,over_cap:pp,failure:vi,waiting:Po(dn.filter(g=>!wi.has(g.bead_id)),"queue"),serial_lanes:qi,serial_lane_count:yp,pr_wait:Ur.map(g=>Qh(g.bead_id,rt.get(g.bead_id)||g.bead_id,un,Be[g.bead_id]||null,ir(f.attempts||{},g.bead_id),hs[g.bead_id]||(F.has(g.bead_id)||J.has(g.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),ks.get(g.bead_id)||null,g.external===!0,{position:ki.get(g.bead_id)||0,active:fn.active===g.bead_id,failure:up[g.bead_id]||null,waiting:Ei?.bead_id===g.bead_id?Ei.reason:null,resolution:$i.get(g.bead_id),continuation_action:xi.get(g.bead_id),head_review:Ai.get(g.bead_id)||null,authority:Si.get(g.bead_id)||null},g.wt_present!==!1,f.auto_merge===!0?Ti(g.bead_id):null,li(vs,lp(g.bead_id)),f.completion_status&&typeof f.completion_status=="object"&&!Array.isArray(f.completion_status)&&f.completion_status[g.bead_id]||null,f.discard_operations&&typeof f.discard_operations=="object"&&!Array.isArray(f.discard_operations)?f.discard_operations:{},ys.get(gi.get(g.bead_id)||"")?.worker_serial===!0,f.auto_merge===!0,{merge_sha:g.merge_sha,cleanup_cursor:g.cleanup_cursor,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]})).map(g=>({...g,...Br(g.id)})),merge_queue_length:qo.length,merge_queue_running:qo.length>0,auto_excluded:Ur.map(g=>g.bead_id).filter(g=>Ti(g)!==null),declared_base:vs,done:Mn,token_total:gp,cleanup_failures:Tt,repo_operations:Array.isArray(f.repo_operations)?f.repo_operations:[]}}function X(){let $=!!o?.get()?.job,G=!$&&o?.isPending?.()===!0,m=$?"\uBD84\uC11D \uC911":G?"\uC900\uBE44 \uC911":"";return l`<button
    ...
    </button>`,m=tt(f),y=f.over_cap?l`<span
    ...
    >`,je=l`<label class="worker-tgl worker-slots"
      ...
      ${o?X():""} `,xe=hu({failure:f.failure}),x=uu(f.repo_operations,f.cleanup_failures);return b?l`<div class="worker-ribbon">
        ...
        ${x}${Qe.template()}${xe}`:l`<div class="worker-ctrl">
        <div class="worker-ctrl__ops">${G}${m}${je}</div>
        <div class="worker-kpi">
          ${y}${ce}${le}
          ${(Array.isArray(f.token_total)?f.token_total:f.token_total?[{label:f.token_total,tooltip:`${L()} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}]:[]).map(Z=>l`<span
                class="worker-kpi__chip worker-kpi__chip--tokens"
                title=${Z.tooltip}
                >${L()} 완료 · 누적 ${Z.label}</span
              >`)}
      ...
      ${x}${Qe.template()}${xe}`}function ve(f){if(f.running.length===0&&f.pr_wait.length===0)return"";let $=f.running.some(G=>!G.paused&&G.failed!==!0);return l`<section
    ...
    >
      ...
      <div class="worker-filter__spec" role="group" aria-label="spec 필터">
        ${Oh.map(G=>l`<button
              type="button"
              class="worker-filter__chip${U.spec===G.value?" is-active":""}"
              data-spec=${G.value}
              aria-pressed=${U.spec===G.value?"true":"false"}
            >
              ${G.label}
            </button>`)}
      ...
      .value=${H}
    >
      ${Mh.map(f=>l`<option value=${f.value} ?selected=${H===f.value}>
            ${f.label}
          </option>`)}
    ...
    >`,G=f.cycle?l`<div class="worker-lane__cycle">
        ...
        </div>`:"";return cr({id:`worker-pane-lane-${f.id}`,lane:f.id,title:`\uC9C1\uB82C ${f.index}`,items:f.rows,empty:"\uBE44\uC5B4 \uC788\uC74C \u2014 \uD589\uC744 \uC5EC\uAE30\uB85C \uB4DC\uB798\uADF8",header_control:$,controls:G})}function tt(f){let $=f.queue.auto_merge===!0;if(f.merge_queue_running)return l`<button
        type="button"
    ...
    >
      ▶ 자동 머지${m>0?` ${m}`:""}
        ...
        ${ve(f)}
        ${cr({id:"worker-pane-queue",lane:"queue",title:"\uBCD1\uB82C \uB300\uAE30",items:f.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:B.queue,preview:Dd(f.waiting)})}
        ${f.serial_lanes.map(G=>at(G))}
        ${$}
        ${cr({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:f.done,empty:`${L()} \uC644\uB8CC \uC5C6\uC74C`,controls:Rt(),collapsible:!0,collapsed:B.done,preview:Array.isArray(f.token_total)?f.token_total.map(G=>G.label).join(" \xB7 "):f.token_total||Dd(f.done)})}
    ...
    </div>`}function Ut(f){B={...B,[f]:!B[f]},Bh(B),Fe()}function Fe(){let f=q();Ge(ke(f),ye),Ge(Dt(f),Ne)}function Ft(){if(typeof window.matchMedia!="function")return;let f=window.matchMedia(Fh);b=!!f.matches;let $=G=>{let m=!!(G&&typeof G.matches=="boolean"?G.matches:f.matches);m!==b&&(b=m,Fe())};typeof f.addEventListener=="function"?(f.addEventListener("change",$),se.push(()=>f.removeEventListener("change",$))):typeof f.addListener=="function"&&(f.addListener($),se.push(()=>f.removeListener($)))}let It=null;function zt(f){It=f.target instanceof Element?f.target:null}function w(f){let G=f.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!G)return;if(It&&G.contains(It)&&It.closest("input, button, a")){f.preventDefault();return}let m=G.dataset.beadId||"",y=G.dataset.lane||"";A={bead_id:m,from_lane:y};try{f.dataTransfer?.setData("text/plain",m),f.dataTransfer&&(f.dataTransfer.effectAllowed="move")}catch{}}function v(f){let $=f.target?.closest?.(".worker-pane");if(!$)return;let G=$.dataset.lane||"";G!=="candidate"&&G!=="queue"&&!/^s[1-5]$/.test(G)||(f.preventDefault(),f.dataTransfer&&(f.dataTransfer.dropEffect="move"),$.classList.add("worker-pane--drag-over"))}function R(f){f.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function W(f,$){let G=O.find(le=>le.id===f);if(!G)return;let m=O.filter(le=>le.id!==f),y=m.length;if($){let le=$.dataset.beadId;if(le===f)return;let je=m.findIndex(xe=>xe.id===le);je>=0&&(y=je)}let ce=m.slice();ce.splice(y,0,G),h.applyReorder(f,ce,y)}function be(f){let $=f.target?.closest?.(".worker-pane");if(!$)return;f.preventDefault(),$.classList.remove("worker-pane--drag-over");let G=$.dataset.lane||"",m=A?.bead_id||f.dataTransfer?.getData("text/plain")||"",y=A?.from_lane||"";if(A=null,!m)return;let ce=f.target?.closest?.(".worker-mini, .worker-card"),le=Array.from($.querySelectorAll(".worker-mini, .worker-card")),je=le.length;if(ce){let xe=le.indexOf(ce);xe>=0&&(je=xe)}if(je=Math.max(0,je-$.querySelectorAll(".worker-mini--ghost").length),$.classList.contains("worker-pane--collapsed")&&(je=ne()),G==="candidate"){if(y==="candidate"){W(m,ce);return}(y==="queue"||/^s[1-5]$/.test(y))&&qe(m);return}if(G==="queue"||/^s[1-5]$/.test(G)){let xe=G==="queue"?"parallel":G;y===G?ae(m,xe,je):me(m,xe)}}function we(f){U=f,Ih(f),Fe()}function ge(f){H=f==="board"||f==="created"||f==="spec"?f:Oo,Dh(H),Fe()}function Ze(f){P=or(f)?f:er,qh(P),p?.(P),Fe()}function Re(f){let $=f.target?.closest?.(".worker-serial-lane-count");if($){let je=Number.parseInt($.value,10);Number.isFinite(je)&&S(je).then(Fe);return}let G=f.target?.closest?.(".worker-filter__blocked");if(G){we({...U,show_blocked:G.checked});return}let m=f.target?.closest?.(".worker-done-range");if(m){Ze(m.value);return}let y=f.target?.closest?.(".worker-sort");if(y){ge(y.value||Oo);return}let ce=f.target?.closest?.(".worker-slots__input");if(!ce)return;let le=Number.parseInt(ce.value,10);if(!Number.isFinite(le)){Fe();return}k(le).then(Fe)}function T(f){return f?{runner:f.runner||void 0,model:f.model||void 0,effort:f.effort||void 0,worktree:f.worktree||void 0,status:f.status||void 0,session_id:f.session_id||void 0}:{}}function ie(){let f=q();return{operations:f.repo_operations,cleanup_failures:f.cleanup_failures,repo:u&&u()||""}}function Ce(){Oe&&Ye.close(),$e.hidden=!1,Ee.hidden=!1,Y.open(ie()),Fe()}function ft(f){let $=st(),G=$.attempts?$.attempts[f]:null;Oe=f,ze=null,Y.close(),$e.hidden=!0,Ee.hidden=!1,Ye.open({attempt_id:f,meta:T(G)}),Fe()}function Mt(f,$){Oe=null,ze=f,Y.close(),$e.hidden=!0,Ee.hidden=!1,Ye.open({attempt_id:f,meta:$,hide_prompt:!0}),Fe()}function vt(){if(Y.isOpen()&&Y.refresh(ie()),ze){let G=(o?.get()?.runs||[]).find(m=>m.run_id===ze);G?Ye.updateMeta(ai(G)):Ye.close();return}if(!Oe)return;let f=st(),$=f.attempts?f.attempts[Oe]:null;if($){Ye.updateMeta(T($));return}Ye.close()}function Pt(f){let $=f.target;if($?.closest?.(".worker-mini__serial, .worker-mini__grip")||$?.closest?.("#worker-parallel-analysis-dialog"))return;if($?.closest?.(".worker-analysis-btn")){Ve?.open();return}if($?.closest?.(".worker-repo-strip")||$?.closest?.(".worker-mini__timeline")){Ce();return}let G=$?.closest?.(".worker-repo-op__session");if(G){let Be=G.dataset.attemptId;Be&&ft(Be);return}let m=$?.closest?.(".worker-repo-op__resolve");if(m){M(m.dataset.operationId||"");return}let y=$?.closest?.(".worker-repo-op__dismiss");if(y){ue(y.dataset.operationId||"");return}let ce=$?.closest?.(".worker-cleanup__resume");if(ce){let Be=ce.dataset.beadId;Be&&gt(Be);return}let le=$?.closest?.(".worker-banner__resume");if(le){let Be=le.dataset.attemptId;Be&&ot(Be);return}let je=$?.closest?.(".worker-banner__discard");if(je){let Be=je.dataset.confirmation==="merged"?"merged":"unmerged";Ue(je.dataset.beadId||"",je.dataset.attemptId||null,Be,je.dataset.operationId||null);return}let xe=$?.closest?.(".worker-banner__dismiss");if(xe){let Be=xe.dataset.attemptId;Be&&Je(Be);return}if($?.closest?.(".worker-play")){E(!st().auto_advance);return}let x=$?.closest?.(".worker-merge-all");if(x){x.classList.contains("worker-merge-all--stop")?st().auto_merge===!0?kt(!1):Ke():kt(!0);return}let Z=$?.closest?.(".worker-pane__hd--toggle");if(Z){let Be=Z.dataset.lane;(Be==="queue"||Be==="done")&&Ut(Be);return}let D=$?.closest?.(".worker-card__place-lane");if(D){let Be=D.dataset.beadId,Tt=D.dataset.lane;Be&&(Tt==="parallel"||/^s[1-5]$/.test(Tt||""))&&(V=null,Fe(),me(Be,Tt));return}if($?.closest?.(".worker-card__place-cancel")){V=null,Fe();return}let ut=$?.closest?.(".worker-card__place");if(ut){let Be=ut.dataset.beadId;Be&&!ut.disabled&&(et()?(V=Be,Fe()):me(Be,"parallel"));return}let it=$?.closest?.(".worker-filter__chip");if(it){let Be=it.dataset.spec;(Be==="all"||Be==="with"||Be==="without")&&we({...U,spec:Be});return}let rt=$?.closest?.(".worker-mini__merge");if(rt){let Be=rt.dataset.beadId||"";st().cleanup_failed?.[Be]?gt(Be):yt(Be);return}let nt=$?.closest?.(".worker-mini__merge-cancel");if(nt){We(nt.dataset.beadId||"");return}let Lt=$?.closest?.(".worker-mini__discard");if(Lt){Ue(Lt.dataset.beadId||"",Lt.dataset.attemptId||null,Lt.dataset.discardMode==="merged"?"merged":"unmerged",Lt.dataset.operationId||null);return}let Jt=$?.closest?.(".worker-mini__stale-continue");if(Jt){ct("worker-stale-work-continue",Jt.dataset.beadId||"",Jt.dataset.actionId||"");return}let an=$?.closest?.(".worker-mini__stale-backup");if(an){ct("worker-stale-work-backup-fresh",an.dataset.beadId||"",an.dataset.actionId||"");return}let ln=$?.closest?.(".worker-mini__stale-recheck");if(ln){ct("worker-stale-work-recheck",ln.dataset.beadId||"",ln.dataset.actionId||"");return}let gs=$?.closest?.(".worker-mini__revise-fix");if(gs){At("worker-revise-fix",gs.dataset.beadId||"");return}let cn=$?.closest?.(".worker-mini__revise-approve");if(cn){At("worker-revise-approve",cn.dataset.beadId||"");return}if($?.closest?.(".worker-mini__pr"))return;if($?.closest?.(".rtile__discard")){let Be=$?.closest?.(".rtile"),Tt=Be?.dataset?.beadId,dn=Be?.dataset?.attemptId;Tt&&Ue(Tt,dn||null,"unmerged",$?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if($?.closest?.(".rtile__dismiss")){let Tt=$?.closest?.(".rtile")?.dataset?.attemptId;Tt&&Je(Tt);return}if($?.closest?.(".rtile__pause")){let Tt=$?.closest?.(".rtile")?.dataset?.attemptId;Tt&&Xe(Tt);return}if($?.closest?.(".rtile__resume")){let Tt=$?.closest?.(".rtile")?.dataset?.attemptId;Tt&&ot(Tt);return}if($?.closest?.(".rtile__session")){let Tt=$?.closest?.(".rtile")?.dataset?.attemptId;Tt&&ft(Tt);return}if($?.closest?.(".worker-drawer-overlay__backdrop")){Y.close(),Ye.close();return}if($?.closest?.(".worker-drawer-host"))return;let Br=$?.closest?.(".rtile .board-card__roll-toggle");if(Br){let Be=Br.dataset.rollParent;Be&&(de.has(Be)?de.delete(Be):de.add(Be),Fe());return}let Ur=$?.closest?.(".rtile .board-card__roll-child");if(Ur){let Be=Ur.dataset.childId;Be&&c&&c(Be);return}let un=$?.closest?.(".rtile");if(un){if($?.closest?.(".rtile__id")){let Tt=un.dataset.beadId;Tt&&tr(Tt).then(dn=>{dn?_e("\uBCF5\uC0AC\uB428","success",1200):_e("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let Be=un.dataset.beadId;Be&&c&&c(Be);return}let hs=$?.closest?.(".worker-mini, .worker-card");if(hs){let Be=hs.dataset.beadId;if($?.closest?.(".worker-mini__id, .worker-card__id")){Be&&tr(Be).then(Tt=>{Tt?_e("\uBCF5\uC0AC\uB428","success",1200):_e("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}Be&&c&&c(Be)}}return e.addEventListener("pointerdown",zt),e.addEventListener("dragstart",w),e.addEventListener("dragover",v),e.addEventListener("dragleave",R),e.addEventListener("drop",be),e.addEventListener("click",Pt),e.addEventListener("change",Re),Ft(),_&&se.push(_.subscribe(()=>{for(let[f,$]of j)$==="failed"&&j.delete(f);Fe()})),s&&se.push(s.subscribe(()=>{let f=u&&u()||"";f!==Te&&(Te=f,Q.close()),Fe(),vt()})),o&&typeof o.subscribe=="function"&&se.push(o.subscribe(()=>{vt(),Fe()})),Fe(),{load(){N(),Fe()},refreshSessionDefaults:oe,destroy(){for(let f of se.splice(0))try{f()}catch{}e.removeEventListener("pointerdown",zt),e.removeEventListener("dragstart",w),e.removeEventListener("dragover",v),e.removeEventListener("dragleave",R),e.removeEventListener("drop",be),e.removeEventListener("click",Pt),e.removeEventListener("change",Re);try{Ye.destroy()}catch{}Ee.hidden=!0;try{Ve?.destroy()}catch{}try{Q.destroy()}catch{}Ge(l``,e)}}}function ui(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Wd(e,t,r,n=async()=>{},s=async()=>{}){let o=St("views:workspace-picker"),a=null,i=!1,c=!1,u=!1;async function d(B){let F=B.target.value,ee=t.getState().workspace?.current?.path||"";if(F&&F!==ee){o("switching workspace to %s",F),i=!0,L();try{await r(F)}catch(pe){o("workspace switch failed: %o",pe)}finally{i=!1,L()}}}async function p(){let B=t.getState(),b=B.workspace?.current?.path||B.workspace?.available?.[0]?.path||"";if(!(!b||c)){o("git-pulling workspace %s",b),c=!0,L();try{await n(b)}catch(F){o("workspace git pull failed: %o",F)}finally{c=!1,L()}}}function _(B){let b=B.target;b&&e.contains(b)||O()}function h(B){B.key==="Escape"&&O()}function A(){u||(u=!0,document.addEventListener("mousedown",_),document.addEventListener("keydown",h),L())}function O(){u&&(u=!1,document.removeEventListener("mousedown",_),document.removeEventListener("keydown",h),L())}function U(){u?O():A()}async function V(B){let b=B.target,F=b.value,J=b.checked;o("toggling visibility %s \u2192 %s",F,String(J));try{await s(F,J)}catch(ee){o("workspace visibility toggle failed: %o",ee)}}function H(B){return B?l`
      <button
        type="button"
    ...
    `}function j(){let B=t.getState(),b=B.workspace?.current,F=B.workspace?.available||[],J=new Set(B.workspace?.hidden||[]),ee=b?.path||F[0]?.path||"";if(F.length===0)return l``;let pe=F.filter(de=>!J.has(de.path)||de.path===ee);if(pe.length<=1){let de=pe[0]||F[0],he=ui(de.path);return l`
    ...
    `}function L(){Ge(j(),e)}return L(),a=t.subscribe(()=>L()),{destroy(){a&&(a(),a=null),document.removeEventListener("mousedown",_),document.removeEventListener("keydown",h),Ge(l``,e)}}}var zd=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-impl-target","get-session-defaults","set-session-defaults","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-automation-toggle","worker-auto-repair-toggle","worker-repo-ops-opt-out-toggle","worker-repo-operation-repair","worker-repo-operation-dismiss","worker-queue-set-slots","worker-queue-set-serial-lane-count","subscribe-worker-parallel-analysis","unsubscribe-worker-parallel-analysis","worker-parallel-analysis-snapshot","worker-parallel-analysis-targets","worker-parallel-analysis-prompt","worker-parallel-analysis-start","worker-parallel-analysis-cancel","worker-parallel-analysis-settings-update","worker-parallel-analysis-submit","worker-queue-set-orchestration-defaults","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-cleanup-retry","worker-merge-queue-add","worker-merge-queue-add-all","worker-merge-auto-toggle","worker-merge-queue-remove","worker-discard","worker-stale-work-continue","worker-stale-work-backup-fresh","worker-stale-work-recheck","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append","get-attempt-prompt","get-bead-prompt","get-worker-system-prompt","subscribe-monitor-pipeline","unsubscribe-monitor-pipeline","monitor-pipeline-snapshot","subscribe-impl-presets","unsubscribe-impl-presets","impl-presets-snapshot","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","monitor-auto-toggle"];function di(){let e=Date.now().toString(36),t=Math.random().toString(36).slice(2,8);return`${e}-${t}`}function Hd(e,t,r=di()){return{id:r,type:e,payload:t}}function Gd(e={}){let t=St("ws"),r={initialMs:e.backoff?.initialMs??1e3,maxMs:e.backoff?.maxMs??3e4,factor:e.backoff?.factor??2,jitterRatio:e.backoff?.jitterRatio??.2},n=()=>e.url&&e.url.length>0?e.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",a=0,i=null,c=!0,u=new Map,d=[],p=new Map,_=new Set;function h(j){for(let L of Array.from(_))try{L(j)}catch{}}function A(){if(!c||i)return;o="reconnecting",t("ws reconnecting\u2026"),h(o);let j=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,a)),L=(r.jitterRatio||0)*j,B=Math.max(0,Math.round(j+(Math.random()*2-1)*L));t("ws retry in %d ms (attempt %d)",B,a+1),i=setTimeout(()=>{i=null,P()},B)}function O(j){try{s?.send(JSON.stringify(j))}catch(L){t("ws send failed",L)}}function U(){for(o="open",t("ws open"),h(o),a=0;d.length;){let j=d.shift();j&&O(j)}}function V(j){let L;try{L=JSON.parse(String(j.data))}catch{t("ws received non-JSON message");return}if(!L||typeof L.id!="string"||typeof L.type!="string"){t("ws received invalid envelope");return}if(u.has(L.id)){let b=u.get(L.id);u.delete(L.id),L.ok?b?.resolve(L.payload):b?.reject(L.error||new Error("ws error"));return}let B=p.get(L.type);if(B&&B.size>0)for(let b of Array.from(B))try{b(L.payload)}catch(F){t("ws event handler error",F)}else t("ws received unhandled message type: %s",L.type)}function H(){o="closed",t("ws closed"),h(o);for(let[j,L]of u.entries())L.reject(new Error("ws disconnected")),u.delete(j);a+=1,A()}function P(){if(!c)return;let j=n();try{s=new WebSocket(j),t("ws connecting %s",j),o="connecting",h(o),s.addEventListener("open",U),s.addEventListener("message",V),s.addEventListener("error",()=>{}),s.addEventListener("close",H)}catch(L){t("ws connect failed %o",L),A()}}return P(),{send(j,L){if(!zd.includes(j))return Promise.reject(new Error(`unknown message type: ${j}`));let B=di(),b=Hd(j,L,B);return t("send %s id=%s",j,B),new Promise((F,J)=>{u.set(B,{resolve:F,reject:J,type:j}),s&&s.readyState===s.OPEN?O(b):(t("queue %s id=%s (state=%s)",j,B,o),d.push(b))})},on(j,L){p.has(j)||p.set(j,new Set);let B=p.get(j);return B?.add(L),()=>{B?.delete(L)}},onConnection(j){return _.add(j),()=>{_.delete(j)}},reconnect(){c=!0,i&&(clearTimeout(i),i=null),a=0,P()},close(){c=!1,i&&(clearTimeout(i),i=null);try{s?.close()}catch{}},getState(){return o}}}function Xh(){let e=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:null}}}async function Jh(e,t){try{let n=await(await fetch("/api/config")).json();e.setState({config:n})}catch(r){t("config refresh failed",r)}}var pi=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],Vd=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"],["tab:worker:in-progress","in-progress-issues"],["tab:worker:resolved","resolved-issues"],["tab:worker:closed","closed-issues"]],Fr="tab:worker:closed",eb="bdui.worker.done-range",Kd=Qu,Yd="worker:queue",Zd="worker:parallel-analysis",Qd="ui:order",Xd="ui:display-policy",Jd="exec:presets",jr="tab:board:closed",ep="beads-ui.board.closed-range";function tb(e){let t=St("main");t("bootstrap start");let r=l`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="monitor-root" class="route monitor" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;Ge(r,e);let n=document.getElementById("global-nav"),s=document.getElementById("top-nav"),o=document.getElementById("repo-scope"),a=document.getElementById("usage-meter"),i=document.getElementById("board-root"),c=document.getElementById("worker-root"),u=document.getElementById("monitor-root"),d=document.getElementById("detail-panel");if(a&&hd(a),i&&c&&u&&d){let oe=function(m,y){let ce="Request failed",le="";if(m&&typeof m=="object"){let xe=m;if(typeof xe.message=="string"&&xe.message.length>0&&(ce=xe.message),typeof xe.details=="string")le=xe.details;else if(xe.details&&typeof xe.details=="object")try{le=JSON.stringify(xe.details,null,2)}catch{le=""}}else typeof m=="string"&&m.length>0&&(ce=m);let je=y&&y.length>0?`Failed to load ${y}`:"Request failed";N.open(je,ce,le)},I=function(m){return`${ge.getState().workspace.current?.path||""}\0${m}`},ne=function(){Q&&(Q().catch(()=>{}),Q=null),Te=null,Qe=null},ae=function(m){Ve=m;let y=()=>{Ve!==m||ge.getState().selected_id!==m||(Ve=null,me(m))};if(!mt){et.then(y);return}y()},Je=function(m,y,ce,le,je){return ce!==ot[y]?(je().catch(()=>{}),!1):(m.set(le,je),!0)},yt=function(){let m=ge.getState();Ke(m.view==="board"),ue(m.view==="worker"),ke(m.view==="monitor"),S(m.view==="board"||m.view==="worker"||dt||!!m.selected_id)},kt=function(){let m=Kr(gt);return m===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:m}}},We=function(){let m=Kr(pt);return m===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:m}}},Ke=function(m){if(m)for(let[y,ce]of pi){if(qe.has(y)||Xe.has(y))continue;let le=y===jr?kt():{type:ce};try{C.register(y,le)}catch(x){t("register %s store failed: %o",y,x)}Xe.add(y);let je=ot.board,xe=!1;Ee.subscribeList(y,le).then(x=>{xe=!Je(qe,"board",je,y,x)}).catch(x=>{t("subscribe %s failed: %o",y,x),oe(x,"board")}).finally(()=>{Xe.delete(y),xe&&yt()})}else At()},At=function(){ot.board+=1;for(let[m]of pi){let y=qe.get(m);y&&(y().catch(()=>{}),qe.delete(m));try{C.unregister(m)}catch(ce){t("unregister %s failed: %o",m,ce)}}},ue=function(m){if(!m){k();return}for(let[y,ce]of Vd){if(E.has(y)||Xe.has(y))continue;let le=y===Fr?We():{type:ce};try{C.register(y,le)}catch(x){t("register %s store failed: %o",y,x)}Xe.add(y);let je=ot.worker,xe=!1;Ee.subscribeList(y,le).then(x=>{xe=!Je(E,"worker",je,y,x)}).catch(x=>{t("subscribe %s failed: %o",y,x),oe(x,"worker")}).finally(()=>{Xe.delete(y),xe&&yt()})}},k=function(){ot.worker+=1;for(let[m]of Vd){let y=E.get(m);y&&(y().catch(()=>{}),E.delete(m));try{C.unregister(m)}catch(ce){t("unregister %s failed: %o",m,ce)}}},S=function(m){if(!m){q();return}M||(ye("subscribe-worker-queue",{id:Yd}).catch(y=>{t("subscribe-worker-queue failed: %o",y)}),ye("subscribe-worker-parallel-analysis",{id:Zd}).catch(y=>{t("subscribe-worker-parallel-analysis failed: %o",y)}),M=()=>(ye("unsubscribe-worker-parallel-analysis",{id:Zd}),ye("unsubscribe-worker-queue",{id:Yd})))},q=function(){M&&(M().catch(()=>{}),M=null),$e.clear()},ke=function(m){if(!m){ve();return}X||(ye("subscribe-monitor-pipeline",{id:Kd}).catch(y=>{t("subscribe-monitor-pipeline failed: %o",y)}),X=()=>ye("unsubscribe-monitor-pipeline",{id:Kd}))},ve=function(){X&&(X().catch(()=>{}),X=null)},De=function(){Me||(ye("subscribe-ui-order",{id:Qd}).catch(m=>{t("subscribe-ui-order failed: %o",m)}),Me=()=>ye("unsubscribe-ui-order",{id:Qd}))},Rt=function(){Me&&(Me().catch(()=>{}),Me=null),Oe.clear()},tt=function(){at||(ye("subscribe-display-policy",{id:Xd}).catch(m=>{t("subscribe-display-policy failed: %o",m)}),at=()=>ye("unsubscribe-display-policy",{id:Xd}))},Dt=function(){at&&(at().catch(()=>{}),at=null),ze.clear()},Fe=function(){Ut||(ye("subscribe-impl-presets",{id:Jd}).catch(m=>{t("subscribe-impl-presets failed: %o",m)}),Ut=()=>ye("unsubscribe-impl-presets",{id:Jd}))},R=function(m){if(!m)return"Unknown";let y=m.split("/").filter(Boolean);return y.length>0?y[y.length-1]:"Unknown"};var p=oe,_=I,h=ne,A=ae,O=Je,U=yt,V=kt,H=We,P=Ke,j=At,L=ue,B=k,b=S,F=q,J=ke,ee=ve,pe=De,de=Rt,he=tt,Se=Dt,Le=Fe,te=R;let se=document.getElementById("header-loading"),Ae=$l(se),N=cu(e),re=Gd(),ye=Ae.wrapSend((m,y)=>re.send(m,y)),Ee=ml(ye),C=gl(),K=yl(),$e=bl(),Ne=el(),Oe=hl(),ze=Xi(),Ye=Ji(),Y=tl();re.on("impl-presets-snapshot",m=>{let y=m;y&&typeof y.revision=="number"&&Array.isArray(y.presets)&&Ye.set({revision:y.revision,presets:y.presets})}),re.on("monitor-pipeline-snapshot",m=>{let y=m;if(!(!y||!Array.isArray(y.workspaces)))try{Ne.set(y.workspaces,y.workspaces_state)}catch{}}),re.on("ui-order-snapshot",m=>{let y=m;if(y&&typeof y.revision=="number")try{Oe.set({revision:y.revision,order:y.order&&typeof y.order=="object"?y.order:{}})}catch{}}),re.on("display-policy-snapshot",m=>{let y=m;if(y&&y.policy&&typeof y.policy=="object")try{ze.set(y.policy)}catch{}}),re.on("session-log-snapshot",m=>{let y=m;if(y&&typeof y.id=="string")try{Y.set(y.id,Array.isArray(y.lines)?y.lines:[],typeof y.last_event_at=="number"?y.last_event_at:null)}catch{}}),re.on("session-log-append",m=>{let y=m;if(y&&typeof y.id=="string")try{Y.append(y.id,y.event)}catch{}}),re.on("snapshot",m=>{let y=m,ce=y&&typeof y.id=="string"?y.id:"",le=ce?C.getStore(ce):null;if(le&&y&&y.type==="snapshot")try{le.applyPush(y)}catch{}}),re.on("upsert",m=>{let y=m,ce=y&&typeof y.id=="string"?y.id:"",le=ce?C.getStore(ce):null;if(le&&y&&y.type==="upsert")try{le.applyPush(y)}catch{}}),re.on("delete",m=>{let y=m,ce=y&&typeof y.id=="string"?y.id:"",le=ce?C.getStore(ce):null;if(le&&y&&y.type==="delete")try{le.applyPush(y)}catch{}});let Q=null,Te=null,Qe=null,Ve=null,st=()=>{},et=new Promise(m=>{st=()=>m(void 0)}),mt=!1,Pe=!1;async function me(m){let y=I(m);if(y===Te||y===Qe)return;Qe=y;let ce=`detail:${m}`,le={type:"issue-detail",params:{id:m}};try{C.register(ce,le)}catch(je){t("register detail store failed: %o",je)}try{let je=await Ee.subscribeList(ce,le);if(ge.getState().selected_id!==m||I(m)!==y){await je().catch(()=>{});return}Q&&await Q().catch(()=>{}),Q=je,Te=y}catch(je){t("detail subscribe failed: %o",je),oe(je,"issue details")}finally{Qe===y&&(Qe=null)}}let qe=new Map,Xe=new Set,ot={board:0,worker:0},dt=!1,gt=er;try{let m=window.localStorage.getItem(ep);or(m)&&(gt=m)}catch{}let pt=er;try{let m=window.localStorage.getItem(eb);or(m)&&(pt=m)}catch{}async function Ue(m){if(!or(m)||m===gt)return;gt=m;try{window.localStorage.setItem(ep,m)}catch{}let y=qe.get(jr);if(!y)return;qe.delete(jr),await y().catch(()=>{});let ce=kt();try{C.register(jr,ce)}catch(le){t("register %s store failed: %o",jr,le)}try{let le=await Ee.subscribeList(jr,ce);qe.set(jr,le)}catch(le){t("re-subscribe %s failed: %o",jr,le),oe(le,"board")}}async function ct(m){if(!or(m)||m===pt)return;pt=m;let y=E.get(Fr);if(!y)return;E.delete(Fr),await y().catch(()=>{});let ce=We();try{C.register(Fr,ce)}catch(le){t("register %s store failed: %o",Fr,le)}try{let le=await Ee.subscribeList(Fr,ce);E.set(Fr,le)}catch(le){t("re-subscribe %s failed: %o",Fr,le),oe(le,"worker")}}let E=new Map,M=null,X=null,Me=null,at=null,Ut=null;async function Ft(){at=null,ze.clear(),Ut=null,Ye.clear(),M=null,X=null,qe.clear(),E.clear(),ot.board+=1,ot.worker+=1,Fe();let m=ge.getState().workspace.current?.path;if(m)try{await re.send("set-workspace",{path:m})}catch(ce){t("workspace restore after reconnect failed: %o",ce);return}tt();let y=ge.getState();Ke(y.view==="board"),ue(y.view==="worker"),ke(y.view==="monitor"),S(y.view==="board"||y.view==="worker"||!!y.selected_id)}async function It(){t("clearing all subscriptions for workspace switch"),At(),k(),q(),K.clear(),Rt(),De(),Dt(),tt(),ne();let m=ge.getState();if(m.selected_id)try{C.unregister(`detail:${m.selected_id}`)}catch{}let y=ge.getState();Ke(y.view==="board"),ue(y.view==="worker"),ke(y.view==="monitor"),S(y.view==="board"||y.view==="worker"||!!y.selected_id),y.selected_id&&ae(y.selected_id)}async function zt(m){t("requesting workspace switch to %s",m),Pe=!0;try{let y=await re.send("set-workspace",{path:m});t("workspace switch result: %o",y),y&&y.workspace&&(ge.setState({workspace:{current:{path:y.workspace.root_dir,database:y.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",m),y.changed&&(await It(),_e("Switched to "+R(m),"success",2e3)))}catch(y){throw t("workspace switch failed: %o",y),_e("Failed to switch workspace","error",3e3),y}finally{Pe=!1}}async function w(m){t("requesting workspace git pull for %s",m);try{let y=await re.send("git-pull-workspace",{});t("workspace git pull result: %o",y);let ce=y?.status;if(ce==="up_to_date"){_e("Already up to date","success",2e3);return}if(ce==="stash_pop_conflict"){_e("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}_e("Git pulled "+R(m),"success",2e3)}catch(y){t("workspace git pull failed: %o",y);let ce=y?.code,le=y?.message;if(ce==="rebase_conflict"){_e("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(ce==="rebase_conflict_abort_failed"){_e("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(ce==="busy"){_e("Git pull skipped: another operation is running","warning",3e3);return}let je=le?`: ${le}`:"";throw _e(`Git pull failed${je}`,"error",3e3),y}}async function v(m,y){t("setting workspace visibility %s \u2192 %s",m,String(y));try{await re.send("set-workspace-visibility",{path:m,visible:y}),await W()}catch(ce){t("workspace visibility update failed: %o",ce),_e("Failed to update project visibility","error",3e3)}}async function W(){try{let m=await re.send("list-workspaces",{});if(t("workspaces loaded: %o",m),m&&Array.isArray(m.workspaces)){let y=m.workspaces.map(xe=>({path:xe.path,database:xe.database,pid:xe.pid,version:xe.version})),ce=m.current?{path:m.current.root_dir,database:m.current.db_path}:null,le=Array.isArray(m.hidden)?m.hidden.filter(xe=>typeof xe=="string"):[];ge.setState({workspace:{current:ce,available:y,hidden:le}});let je=window.localStorage.getItem("beads-ui.workspace");je&&(!y.some(x=>x.path===je)||le.includes(je)?window.localStorage.removeItem("beads-ui.workspace"):ce&&je!==ce.path&&(t("restoring saved workspace preference: %s",je),await zt(je)))}}catch(m){t("failed to load workspaces: %o",m)}}re.on("workspace-changed",m=>{t("workspace-changed event: %o",m),m&&m.root_dir&&(ge.setState({workspace:{current:{path:m.root_dir,database:m.db_path}}}),W(),It())});let be=!1;if(typeof re.onConnection=="function"){let m=y=>{t("ws state %s",y),y==="reconnecting"||y==="closed"?(be=!0,_e("Connection lost. Reconnecting\u2026","error",4e3)):y==="open"&&be&&(be=!1,_e("Reconnected","success",2200),Jh(ge,(ce,le)=>{t(`${ce}: %o`,le)}),Ft())};re.onConnection(m)}let we="board";try{let m=window.localStorage.getItem("beads-ui.view");(m==="board"||m==="worker"||m==="monitor")&&(we=m)}catch(m){t("view parse error: %o",m)}let ge=kl({config:Xh(),view:we});re.on("worker-queue-snapshot",m=>{let y=m;if(!y||!y.queue)return;let ce=ge.getState().workspace.current?.path;if(typeof ce=="string"&&ce.length>0&&y.root_dir!==ce){t("dropping worker-queue snapshot for %s",String(y.root_dir));return}try{K.set(y.queue)}catch{}}),re.on("worker-parallel-analysis-snapshot",m=>{let y=m;if(!y)return;let ce=ge.getState().workspace.current?.path;if(!(typeof ce=="string"&&ce.length>0&&typeof y.root_dir=="string"&&y.root_dir!==ce))try{$e.set({settings:y.settings,job:y.job??null,runs:Array.isArray(y.runs)?y.runs:[],last_good:y.last_good??null})}catch{}});let Ze=vl(ge);Ze.start();let Re=new Set(["get-comments","dep-add","dep-remove","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","get-session-defaults","set-session-defaults"]),T=async(m,y)=>{try{return await ye(m,y)}catch(ce){if(Re.has(m))throw ce;return[]}};Ju({global_element:n,repo_element:s},ge,Ze);let ie=document.getElementById("workspace-picker");ie&&Wd(ie,ge,zt,w,v);let Ce=nd(e,(m,y)=>ye(m,y));try{let m=document.getElementById("new-issue-btn");m&&m.addEventListener("click",()=>Ce.open())}catch{}let ft=id(e,{policyStore:ze,queueStore:K,implPresetStore:Ye,transport:(m,y)=>ye(m,y),onOpenChange:m=>{let y=dt;dt=m,yt(),y&&m===!1&&vt.refreshSessionDefaults()},labelOptions:()=>{let m=new Set;for(let[y]of pi)for(let ce of C.snapshotFor(y)||[]){let le=ce.labels;if(Array.isArray(le))for(let je of le)typeof je=="string"&&je.length>0&&m.add(je)}return Array.from(m).sort()}});try{let m=document.getElementById("display-settings-btn");m&&(m.setAttribute("aria-label","\uC124\uC815"),m.setAttribute("title","\uC124\uC815"),m.addEventListener("click",()=>ft.open()))}catch{}let Mt=Dl(i,{gotoIssue:m=>Ze.gotoIssue(m),issueStores:C,transport:T,workerQueueStore:K,uiOrderStore:Oe,displayPolicyStore:ze,closedRange:gt,onClosedRangeChange:m=>{Ue(m)},onNewIssue:()=>Ce.open()}),vt=ci(c,{transport:T,issueStores:C,queueStore:K,analysisStore:$e,sessionLogStore:Y,uiOrderStore:Oe,gotoIssue:m=>ge.setState({selected_id:m}),getWorkspacePath:()=>ge.getState().workspace.current?.path,doneRange:pt,onDoneRangeChange:m=>{ct(m)}}),Pt=Xu(u,{transport:T,pipelineStore:Ne,execPresetStore:Ye,sessionLogStore:Y,router:Ze,gotoIssue:m=>Ze.gotoIssue(m),getWorkspacePath:()=>ge.getState().workspace.current?.path,switchWorkspace:m=>zt(m)}),f=lu(d,{issueStores:C,transport:T,queueStore:K,execPresetStore:Ye,sessionLogStore:Y,getWorkspacePath:()=>ge.getState().workspace.current?.path,onNavigate:m=>{ge.getState().view==="worker"?ge.setState({selected_id:m}):Ze.gotoIssue(m)},onClose:()=>{let m=ge.getState();ge.setState({selected_id:null});try{Ze.gotoView(m.view==="worker"||m.view==="monitor"?m.view:"board")}catch{}},onOpenExecPresets:()=>{ft.open("execution")}}),$=ge.getState().selected_id;$&&(d.hidden=!1,f.load($),ae($)),ge.subscribe(m=>{let y=m.selected_id;y?(d.hidden=!1,f.load(y),Pe||ae(y)):(f.clear(),d.hidden=!0,ne())});let G=m=>{i.hidden=m.view!=="board",c.hidden=m.view!=="worker",u.hidden=m.view!=="monitor",o&&o.classList.toggle("is-quiet",m.view==="monitor"),Ke(m.view==="board"),ue(m.view==="worker"),ke(m.view==="monitor"),S(m.view==="board"||m.view==="worker"||dt||!!m.selected_id),!m.selected_id&&m.view==="board"&&Mt.load(),m.view==="worker"&&vt.load(),m.view==="monitor"?Pt.load():Pt.pause(),window.localStorage.setItem("beads-ui.view",m.view)};ge.subscribe(G),G(ge.getState()),De(),tt(),Fe(),W().finally(()=>{mt=!0,st()}),window.addEventListener("keydown",m=>{let y=m.ctrlKey||m.metaKey,ce=String(m.key||"").toLowerCase(),le=m.target,je=le&&le.tagName?String(le.tagName).toLowerCase():"",xe=je==="input"||je==="textarea"||je==="select"||le&&typeof le.isContentEditable=="boolean"&&le.isContentEditable;y&&ce==="n"&&(xe||(m.preventDefault(),Ce.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let e=document.getElementById("theme-switch");e&&e.addEventListener("change",()=>{let r=e.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let t=document.getElementById("app");t&&tb(t)});export{tb as bootstrap,Xh as readBootstrapConfig,Jh as refreshConfigSnapshot};
