  ...
  >
    ${a?c`<div class="worker-mini__row1">
      ...
      >
        ...
        >${e.workspace_name}</span
      >`:"",O=_i(e.cross_lane_chip),q=mi(u),W=dd(e.from_id),Y=!!(e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)),N=!r&&(e.blocked===!0||e.queue_placeable===!1);return c`<div
