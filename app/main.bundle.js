var Jo=Object.create;var Wr=Object.defineProperty;var ei=Object.getOwnPropertyDescriptor;var ti=Object.getOwnPropertyNames;var ri=Object.getPrototypeOf,ni=Object.prototype.hasOwnProperty;var si=(t,e,r)=>e in t?Wr(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var Gr=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var oi=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of ti(e))!ni.call(t,s)&&s!==r&&Wr(t,s,{get:()=>e[s],enumerable:!(n=ei(e,s))||n.enumerable});return t};var ii=(t,e,r)=>(r=t!=null?Jo(ri(t)):{},oi(e||!t||!t.__esModule?Wr(r,"default",{value:t,enumerable:!0}):r,t));var ue=(t,e,r)=>si(t,typeof e!="symbol"?e+"":e,r);var ds=Gr((tc,cs)=>{var Nt=1e3,Pt=Nt*60,Ft=Pt*60,Tt=Ft*24,ui=Tt*7,pi=Tt*365.25;cs.exports=function(t,e){e=e||{};var r=typeof t;if(r==="string"&&t.length>0)return fi(t);if(r==="number"&&isFinite(t))return e.long?gi(t):hi(t);throw new Error("val is not a non-empty string or a valid number. val="+JSON.stringify(t))};function fi(t){if(t=String(t),!(t.length>100)){var e=/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(t);if(e){var r=parseFloat(e[1]),n=(e[2]||"ms").toLowerCase();switch(n){case"years":case"year":case"yrs":case"yr":case"y":return r*pi;case"weeks":case"week":case"w":return r*ui;case"days":case"day":case"d":return r*Tt;case"hours":case"hour":case"hrs":case"hr":case"h":return r*Ft;case"minutes":case"minute":case"mins":case"min":case"m":return r*Pt;case"seconds":case"second":case"secs":case"sec":case"s":return r*Nt;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return r;default:return}}}}function hi(t){var e=Math.abs(t);return e>=Tt?Math.round(t/Tt)+"d":e>=Ft?Math.round(t/Ft)+"h":e>=Pt?Math.round(t/Pt)+"m":e>=Nt?Math.round(t/Nt)+"s":t+"ms"}function gi(t){var e=Math.abs(t);return e>=Tt?wr(t,e,Tt,"day"):e>=Ft?wr(t,e,Ft,"hour"):e>=Pt?wr(t,e,Pt,"minute"):e>=Nt?wr(t,e,Nt,"second"):t+" ms"}function wr(t,e,r,n){var s=e>=r*1.5;return Math.round(t/r)+" "+n+(s?"s":"")}});var ps=Gr((rc,us)=>{function mi(t){r.debug=r,r.default=r,r.coerce=a,r.disable=i,r.enable=s,r.enabled=l,r.humanize=ds(),r.destroy=d,Object.keys(t).forEach(h=>{r[h]=t[h]}),r.names=[],r.skips=[],r.formatters={};function e(h){let m=0;for(let k=0;k<h.length;k++)m=(m<<5)-m+h.charCodeAt(k),m|=0;return r.colors[Math.abs(m)%r.colors.length]}r.selectColor=e;function r(h){let m,k=null,$,v;function L(...P){if(!L.enabled)return;let B=L,q=Number(new Date),G=q-(m||q);B.diff=G,B.prev=m,B.curr=q,m=q,P[0]=r.coerce(P[0]),typeof P[0]!="string"&&P.unshift("%O");let N=0;P[0]=P[0].replace(/%([a-zA-Z%])/g,(C,x)=>{if(C==="%%")return"%";N++;let _=r.formatters[x];if(typeof _=="function"){let O=P[N];C=_.call(B,O),P.splice(N,1),N--}return C}),r.formatArgs.call(B,P),(B.log||r.log).apply(B,P)}return L.namespace=h,L.useColors=r.useColors(),L.color=r.selectColor(h),L.extend=n,L.destroy=r.destroy,Object.defineProperty(L,"enabled",{enumerable:!0,configurable:!1,get:()=>k!==null?k:($!==r.namespaces&&($=r.namespaces,v=r.enabled(h)),v),set:P=>{k=P}}),typeof r.init=="function"&&r.init(L),L}function n(h,m){let k=r(this.namespace+(typeof m>"u"?":":m)+h);return k.log=this.log,k}function s(h){r.save(h),r.namespaces=h,r.names=[],r.skips=[];let m=(typeof h=="string"?h:"").trim().replace(/\s+/g,",").split(",").filter(Boolean);for(let k of m)k[0]==="-"?r.skips.push(k.slice(1)):r.names.push(k)}function o(h,m){let k=0,$=0,v=-1,L=0;for(;k<h.length;)if($<m.length&&(m[$]===h[k]||m[$]==="*"))m[$]==="*"?(v=$,L=k,$++):(k++,$++);else if(v!==-1)$=v+1,L++,k=L;else return!1;for(;$<m.length&&m[$]==="*";)$++;return $===m.length}function i(){let h=[...r.names,...r.skips.map(m=>"-"+m)].join(",");return r.enable(""),h}function l(h){for(let m of r.skips)if(o(h,m))return!1;for(let m of r.names)if(o(h,m))return!0;return!1}function a(h){return h instanceof Error?h.stack||h.message:h}function d(){console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.")}return r.enable(r.load()),r}us.exports=mi});var fs=Gr((We,kr)=>{We.formatArgs=bi;We.save=wi;We.load=ki;We.useColors=_i;We.storage=yi();We.destroy=(()=>{let t=!1;return()=>{t||(t=!0,console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."))}})();We.colors=["#0000CC","#0000FF","#0033CC","#0033FF","#0066CC","#0066FF","#0099CC","#0099FF","#00CC00","#00CC33","#00CC66","#00CC99","#00CCCC","#00CCFF","#3300CC","#3300FF","#3333CC","#3333FF","#3366CC","#3366FF","#3399CC","#3399FF","#33CC00","#33CC33","#33CC66","#33CC99","#33CCCC","#33CCFF","#6600CC","#6600FF","#6633CC","#6633FF","#66CC00","#66CC33","#9900CC","#9900FF","#9933CC","#9933FF","#99CC00","#99CC33","#CC0000","#CC0033","#CC0066","#CC0099","#CC00CC","#CC00FF","#CC3300","#CC3333","#CC3366","#CC3399","#CC33CC","#CC33FF","#CC6600","#CC6633","#CC9900","#CC9933","#CCCC00","#CCCC33","#FF0000","#FF0033","#FF0066","#FF0099","#FF00CC","#FF00FF","#FF3300","#FF3333","#FF3366","#FF3399","#FF33CC","#FF33FF","#FF6600","#FF6633","#FF9900","#FF9933","#FFCC00","#FFCC33"];function _i(){if(typeof window<"u"&&window.process&&(window.process.type==="renderer"||window.process.__nwjs))return!0;if(typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/))return!1;let t;return typeof document<"u"&&document.documentElement&&document.documentElement.style&&document.documentElement.style.WebkitAppearance||typeof window<"u"&&window.console&&(window.console.firebug||window.console.exception&&window.console.table)||typeof navigator<"u"&&navigator.userAgent&&(t=navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/))&&parseInt(t[1],10)>=31||typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)}function bi(t){if(t[0]=(this.useColors?"%c":"")+this.namespace+(this.useColors?" %c":" ")+t[0]+(this.useColors?"%c ":" ")+"+"+kr.exports.humanize(this.diff),!this.useColors)return;let e="color: "+this.color;t.splice(1,0,e,"color: inherit");let r=0,n=0;t[0].replace(/%[a-zA-Z%]/g,s=>{s!=="%%"&&(r++,s==="%c"&&(n=r))}),t.splice(n,0,e)}We.log=console.debug||console.log||(()=>{});function wi(t){try{t?We.storage.setItem("debug",t):We.storage.removeItem("debug")}catch{}}function ki(){let t;try{t=We.storage.getItem("debug")||We.storage.getItem("DEBUG")}catch{}return!t&&typeof process<"u"&&"env"in process&&(t=process.env.DEBUG),t}function yi(){try{return localStorage}catch{}}kr.exports=ps()(We);var{formatters:vi}=kr.exports;vi.j=function(t){try{return JSON.stringify(t)}catch(e){return"[UnexpectedJSONParseError]: "+e.message}}});var Kt=globalThis,_r=Kt.trustedTypes,Kn=_r?_r.createPolicy("lit-html",{createHTML:t=>t}):void 0,ts="$lit$",ft=`lit$${Math.random().toFixed(9).slice(2)}$`,rs="?"+ft,ai=`<${rs}>`,xt=document,Zt=()=>xt.createComment(""),Xt=t=>t===null||typeof t!="object"&&typeof t!="function",Qr=Array.isArray,li=t=>Qr(t)||typeof t?.[Symbol.iterator]=="function",jr=`[ 	
\f\r]`,Vt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Zn=/-->/g,Xn=/>/g,vt=RegExp(`>|${jr}(?:([^\\s"'>=/]+)(${jr}*=${jr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Qn=/'/g,Jn=/"/g,ns=/^(?:script|style|textarea|title)$/i,Jr=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),u=Jr(1),Kl=Jr(2),Zl=Jr(3),St=Symbol.for("lit-noChange"),ve=Symbol.for("lit-nothing"),es=new WeakMap,$t=xt.createTreeWalker(xt,129);function ss(t,e){if(!Qr(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Kn!==void 0?Kn.createHTML(e):e}var ci=(t,e)=>{let r=t.length-1,n=[],s,o=e===2?"<svg>":e===3?"<math>":"",i=Vt;for(let l=0;l<r;l++){let a=t[l],d,h,m=-1,k=0;for(;k<a.length&&(i.lastIndex=k,h=i.exec(a),h!==null);)k=i.lastIndex,i===Vt?h[1]==="!--"?i=Zn:h[1]!==void 0?i=Xn:h[2]!==void 0?(ns.test(h[2])&&(s=RegExp("</"+h[2],"g")),i=vt):h[3]!==void 0&&(i=vt):i===vt?h[0]===">"?(i=s??Vt,m=-1):h[1]===void 0?m=-2:(m=i.lastIndex-h[2].length,d=h[1],i=h[3]===void 0?vt:h[3]==='"'?Jn:Qn):i===Jn||i===Qn?i=vt:i===Zn||i===Xn?i=Vt:(i=vt,s=void 0);let $=i===vt&&t[l+1].startsWith("/>")?" ":"";o+=i===Vt?a+ai:m>=0?(n.push(d),a.slice(0,m)+ts+a.slice(m)+ft+$):a+ft+(m===-2?l:$)}return[ss(t,o+(t[r]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Qt=class t{constructor({strings:e,_$litType$:r},n){let s;this.parts=[];let o=0,i=0,l=e.length-1,a=this.parts,[d,h]=ci(e,r);if(this.el=t.createElement(d,n),$t.currentNode=this.el.content,r===2||r===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=$t.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith(ts)){let k=h[i++],$=s.getAttribute(m).split(ft),v=/([.?@])?(.*)/.exec(k);a.push({type:1,index:o,name:v[2],strings:$,ctor:v[1]==="."?Vr:v[1]==="?"?Kr:v[1]==="@"?Zr:Mt}),s.removeAttribute(m)}else m.startsWith(ft)&&(a.push({type:6,index:o}),s.removeAttribute(m));if(ns.test(s.tagName)){let m=s.textContent.split(ft),k=m.length-1;if(k>0){s.textContent=_r?_r.emptyScript:"";for(let $=0;$<k;$++)s.append(m[$],Zt()),$t.nextNode(),a.push({type:2,index:++o});s.append(m[k],Zt())}}}else if(s.nodeType===8)if(s.data===rs)a.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(ft,m+1))!==-1;)a.push({type:7,index:o}),m+=ft.length-1}o++}}static createElement(e,r){let n=xt.createElement("template");return n.innerHTML=e,n}};function Ot(t,e,r=t,n){if(e===St)return e;let s=n!==void 0?r._$Co?.[n]:r._$Cl,o=Xt(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(t),s._$AT(t,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(e=Ot(t,s._$AS(t,e.values),s,n)),e}var Yr=class{constructor(e,r){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:r},parts:n}=this._$AD,s=(e?.creationScope??xt).importNode(r,!0);$t.currentNode=s;let o=$t.nextNode(),i=0,l=0,a=n[0];for(;a!==void 0;){if(i===a.index){let d;a.type===2?d=new Jt(o,o.nextSibling,this,e):a.type===1?d=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(d=new Xr(o,this,e)),this._$AV.push(d),a=n[++l]}i!==a?.index&&(o=$t.nextNode(),i++)}return $t.currentNode=xt,s}p(e){let r=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,r),r+=n.strings.length-2):n._$AI(e[r])),r++}},Jt=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,r,n,s){this.type=2,this._$AH=ve,this._$AN=void 0,this._$AA=e,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,r=this._$AM;return r!==void 0&&e?.nodeType===11&&(e=r.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,r=this){e=Ot(this,e,r),Xt(e)?e===ve||e==null||e===""?(this._$AH!==ve&&this._$AR(),this._$AH=ve):e!==this._$AH&&e!==St&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):li(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==ve&&Xt(this._$AH)?this._$AA.nextSibling.data=e:this.T(xt.createTextNode(e)),this._$AH=e}$(e){let{values:r,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Qt.createElement(ss(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(r);else{let o=new Yr(s,this),i=o.u(this.options);o.p(r),this.T(i),this._$AH=o}}_$AC(e){let r=es.get(e.strings);return r===void 0&&es.set(e.strings,r=new Qt(e)),r}k(e){Qr(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,n,s=0;for(let o of e)s===r.length?r.push(n=new t(this.O(Zt()),this.O(Zt()),this,this.options)):n=r[s],n._$AI(o),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(e=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Mt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,r,n,s,o){this.type=1,this._$AH=ve,this._$AN=void 0,this.element=e,this.name=r,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=ve}_$AI(e,r=this,n,s){let o=this.strings,i=!1;if(o===void 0)e=Ot(this,e,r,0),i=!Xt(e)||e!==this._$AH&&e!==St,i&&(this._$AH=e);else{let l=e,a,d;for(e=o[0],a=0;a<o.length-1;a++)d=Ot(this,l[n+a],r,a),d===St&&(d=this._$AH[a]),i||(i=!Xt(d)||d!==this._$AH[a]),d===ve?e=ve:e!==ve&&(e+=(d??"")+o[a+1]),this._$AH[a]=d}i&&!s&&this.j(e)}j(e){e===ve?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Vr=class extends Mt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ve?void 0:e}},Kr=class extends Mt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==ve)}},Zr=class extends Mt{constructor(e,r,n,s,o){super(e,r,n,s,o),this.type=5}_$AI(e,r=this){if((e=Ot(this,e,r,0)??ve)===St)return;let n=this._$AH,s=e===ve&&n!==ve||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,o=e!==ve&&(n===ve||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Xr=class{constructor(e,r,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Ot(this,e)}};var di=Kt.litHtmlPolyfillSupport;di?.(Qt,Jt),(Kt.litHtmlVersions??(Kt.litHtmlVersions=[])).push("3.3.1");var le=(t,e,r)=>{let n=r?.renderBefore??e,s=n._$litPart$;if(s===void 0){let o=r?.renderBefore??null;n._$litPart$=s=new Jt(e.insertBefore(Zt(),o),o,void 0,r??{})}return s._$AI(t),s};var br="today",os=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function en(t){return t==="today"||t==="7d"||t==="30d"||t==="all"}function is(t,e=Date.now()){switch(t){case"today":{let r=new Date(e);return r.setHours(0,0,0,0),r.getTime()}case"7d":return e-7*864e5;case"30d":return e-30*864e5;case"all":default:return}}function as(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function ls(){let t=new Map,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{set(n,s){t.set(n,{lines:Array.isArray(s)?[...s]:[]}),r()},append(n,s){let o=t.get(n)||{lines:[]};o.lines=[...o.lines,s],t.set(n,o),r()},get(n){return t.get(n)||null},clear(n){typeof n=="string"?t.delete(n):t.clear(),r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}var hs=ii(fs(),1);function we(t){return(0,hs.default)(`beads-ui:${t}`)}function st(t){if(typeof t=="number")return Number.isFinite(t)?t:0;if(typeof t=="string"){let e=Date.parse(t);return Number.isFinite(e)?e:0}return 0}function At(t,e){let r=st(t.created_at),n=st(e.created_at);if(r!==n)return r<n?1:-1;let s=t.priority??2,o=e.priority??2;if(s!==o)return s-o;let i=t.id,l=e.id;return i<l?-1:i>l?1:0}function _s(t,e){let r=st(t.created_at),n=st(e.created_at);if(r!==n)return r<n?-1:1;let s=t.priority??2,o=e.priority??2;if(s!==o)return s-o;let i=t.id,l=e.id;return i<l?-1:i>l?1:0}function bs(t,e){let r=st(t.updated_at),n=st(e.updated_at);if(r!==n)return r<n?1:-1;let s=t.id,o=e.id;return s<o?-1:s>o?1:0}function ws(t,e){let r=t.priority??2,n=e.priority??2;if(r!==n)return r-n;let s=st(t.created_at),o=st(e.created_at);if(s!==o)return s<o?1:-1;let i=t.id,l=e.id;return i<l?-1:i>l?1:0}function ks(t,e){let r=t.closed_at??0,n=e.closed_at??0;if(r!==n)return r<n?1:-1;let s=t?.id,o=e?.id;return s<o?-1:s>o?1:0}var $i=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function gs(t){let e=t&&t.metadata,r=e?e.task_order:void 0;if(r==null||r==="")return Number.POSITIVE_INFINITY;let n=Number(r);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ms(t){let e=t&&t.title;if(typeof e!="string")return Number.POSITIVE_INFINITY;let r=$i.exec(e);if(!r)return Number.POSITIVE_INFINITY;let n=Number(r[1]);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ys(t,e){let r=gs(t),n=gs(e);if(r!==n)return r<n?-1:1;let s=ms(t),o=ms(e);if(s!==o)return s<o?-1:1;let i=st(t&&t.created_at),l=st(e&&e.created_at);if(i!==l)return i<l?-1:1;let a=t&&t.id,d=e&&e.id;return a===d?0:String(a)<String(d)?-1:1}var tn=2**20;function Bt(t,e){let r=t&&t.id;return e&&typeof r=="string"&&Object.prototype.hasOwnProperty.call(e,r)&&typeof e[r]=="number"&&Number.isFinite(e[r])?e[r]:-st(t&&t.created_at)}function yr(t){return(e,r)=>{let n=Bt(e,t),s=Bt(r,t);if(n!==s)return n<s?-1:1;let o=e?.id,i=r?.id;return o<i?-1:o>i?1:0}}function rn(t,e,r){let n=Array.isArray(t)?t:[],s=n.length,o=Math.max(0,Math.min(e,s-1)),i=o-1>=0?n[o-1]:null,l=o+1<s?n[o+1]:null;if(!i&&!l)return{rank:0};if(!i)return{rank:Bt(l,r)-tn};if(!l)return{rank:Bt(i,r)+tn};let a=Bt(i,r),d=Bt(l,r),h=(a+d)/2;return a<h&&h<d?{rank:h}:{renormalize:n.map((m,k)=>({bead_id:m.id,rank:k*tn}))}}function nn(t,e={}){let r=we(`issue-store:${t}`),n=new Map,s=[],o=0,i=new Set,l=!1,a=e.sort||At;function d(){for(let k of Array.from(i))try{k()}catch{}}function h(){s=Array.from(n.values()).sort(a)}function m(k){if(l||!k||k.id!==t)return;let $=Number(k.revision)||0;if(r("apply %s rev=%d",k.type,$),!($<=o&&k.type!=="snapshot")){if(k.type==="snapshot"){if($<=o)return;n.clear();let v=Array.isArray(k.issues)?k.issues:[];for(let L of v)L&&typeof L.id=="string"&&L.id.length>0&&n.set(L.id,L);h(),o=$,d();return}if(k.type==="upsert"){let v=k.issue;if(v&&typeof v.id=="string"&&v.id.length>0){let L=n.get(v.id);if(!L)n.set(v.id,v);else{let P=Number.isFinite(L.updated_at)?L.updated_at:0,B=Number.isFinite(v.updated_at)?v.updated_at:0;if(P<=B){for(let q of Object.keys(L))q in v||delete L[q];for(let[q,G]of Object.entries(v))L[q]=G}}h()}o=$,d()}else if(k.type==="delete"){let v=String(k.issue_id||"");v&&(n.delete(v),h()),o=$,d()}}}return{id:t,subscribe(k){return i.add(k),()=>{i.delete(k)}},applyPush:m,snapshot(){return s},size(){return n.size},getById(k){return n.get(k)},dispose(){l=!0,n.clear(),s=[],i.clear(),o=0}}}function vr(t){let e=String(t.type||"").trim(),r={};if(t.params&&typeof t.params=="object"){let s=Object.keys(t.params).sort();for(let o of s){let i=t.params[o];r[o]=String(i)}}let n=new URLSearchParams(r).toString();return n.length>0?`${e}?${n}`:e}function vs(t){let e=we("subs"),r=new Map,n=new Map;function s(l,a){e("applyDelta %s +%d ~%d -%d",l,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let d=n.get(l);if(!d||d.size===0)return;let h=Array.isArray(a.added)?a.added:[],m=Array.isArray(a.updated)?a.updated:[],k=Array.isArray(a.removed)?a.removed:[];for(let $ of Array.from(d)){let v=r.get($);if(!v)continue;let L=v.itemsById;for(let P of h)typeof P=="string"&&P.length>0&&L.set(P,!0);for(let P of m)typeof P=="string"&&P.length>0&&L.set(P,!0);for(let P of k)typeof P=="string"&&P.length>0&&L.delete(P)}}async function o(l,a){let d=vr(a);if(e("subscribe %s key=%s",l,d),!r.has(l))r.set(l,{key:d,itemsById:new Map});else{let m=r.get(l);if(m&&m.key!==d){let k=n.get(m.key);k&&(k.delete(l),k.size===0&&n.delete(m.key)),r.set(l,{key:d,itemsById:new Map})}}n.has(d)||n.set(d,new Set);let h=n.get(d);h&&h.add(l);try{await t("subscribe-list",{id:l,type:a.type,params:a.params})}catch(m){let k=r.get(l)||null;if(k){let $=n.get(k.key);$&&($.delete(l),$.size===0&&n.delete(k.key))}throw r.delete(l),m}return async()=>{e("unsubscribe %s key=%s",l,d);try{await t("unsubscribe-list",{id:l})}catch{}let m=r.get(l)||null;if(m){let k=n.get(m.key);k&&(k.delete(l),k.size===0&&n.delete(m.key))}r.delete(l)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:vr,selectors:{getIds(l){let a=r.get(l);return a?Array.from(a.itemsById.keys()):[]},has(l,a){let d=r.get(l);return d?d.itemsById.has(a):!1},count(l){let a=r.get(l);return a?a.itemsById.size:0},getItemsById(l){let a=r.get(l),d={};if(!a)return d;for(let h of a.itemsById.keys())d[h]=!0;return d}}}}function $s(){let t=we("issue-stores"),e=new Map,r=new Map,n=new Set,s=new Map;function o(){for(let a of Array.from(n))try{a()}catch{}}function i(a,d,h){let m=d?vr(d):"",k=r.get(a)||"",$=e.has(a);if(t("register %s key=%s (prev=%s)",a,m,k),$&&k&&m&&k!==m){let v=e.get(a);if(v)try{v.dispose()}catch{}let L=s.get(a);if(L){try{L()}catch{}s.delete(a)}let P=nn(a,h);e.set(a,P);let B=P.subscribe(()=>o());s.set(a,B)}else if(!$){let v=nn(a,h);e.set(a,v);let L=v.subscribe(()=>o());s.set(a,L)}return r.set(a,m),()=>l(a)}function l(a){t("unregister %s",a),r.delete(a);let d=e.get(a);d&&(d.dispose(),e.delete(a));let h=s.get(a);if(h){try{h()}catch{}s.delete(a)}}return{register:i,unregister:l,getStore(a){return e.get(a)||null},snapshotFor(a){let d=e.get(a);return d?d.snapshot().slice():[]},subscribe(a){return n.add(a),()=>n.delete(a)}}}function xs(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function Ss(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function sn(t,e){return`#/${t==="worker"?"worker":"board"}?issue=${encodeURIComponent(e)}`}function xi(t){let e=String(t||""),r=e.startsWith("#")?e.slice(1):e,n=r.indexOf("?"),s=n>=0?r.slice(n+1):"";if(s){let l=new URLSearchParams(s).get("issue");if(l)return decodeURIComponent(l)}let o=/^\/issue\/([^\s?#]+)/.exec(r);return o&&o[1]?decodeURIComponent(o[1]):null}function Si(t){let e=String(t||"");return/^#\/worker(\b|\/|$)/.test(e)?"worker":"board"}function Ts(t){let e=we("router"),r=()=>{let n=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(n),o=s&&s[1]?decodeURIComponent(s[1]):xi(n),i=Si(n);if(e("hash change \u2192 view=%s id=%s",i,o),t.setState({selected_id:i==="worker"?null:o,view:i,worker:{selected_parent_id:i==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(n)){let a=o?`#/${i}?issue=${encodeURIComponent(o)}`:`#/${i}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",r),r()},stop(){window.removeEventListener("hashchange",r)},gotoIssue(n){let o=(t.getState?t.getState():{view:"board"}).view==="worker"?"worker":"board",i=sn(o,n);e("goto issue %s (view=%s)",n,o),window.location.hash!==i?window.location.hash=i:t.setState({selected_id:o==="worker"?null:n,view:o,worker:{selected_parent_id:o==="worker"?n:null}})},gotoView(n){let s=t.getState?t.getState():{selected_id:null,worker:{selected_parent_id:null}},o=n==="worker"?s.worker?.selected_parent_id:s.selected_id,i=o?sn(n,o):`#/${n}`;e("goto view %s (id=%s)",n,o||""),window.location.hash!==i?window.location.hash=i:t.setState({view:n,selected_id:n==="worker"?null:s.selected_id})}}}var Ti=Object.freeze({workspace_config:{default_workspace:null}});function As(t){return{workspace_config:{default_workspace:typeof t?.workspace_config?.default_workspace=="string"&&t.workspace_config.default_workspace.length>0?t.workspace_config.default_workspace:Ti.workspace_config.default_workspace}}}function Es(t={}){let e=we("state"),r={selected_id:t.selected_id??null,view:t.view??"board",filters:{status:t.filters?.status??"all",search:t.filters?.search??"",type:typeof t.filters?.type=="string"?t.filters?.type:""},board:{closed_filter:t.board?.closed_filter==="3"||t.board?.closed_filter==="7"||t.board?.closed_filter==="today"?t.board?.closed_filter:"today",show_deferred_column:t.board?.show_deferred_column===!0},worker:{selected_parent_id:t.worker?.selected_parent_id??null,show_closed_children:Array.isArray(t.worker?.show_closed_children)?t.worker.show_closed_children:[]},workspace:{current:t.workspace?.current??null,available:t.workspace?.available??[],hidden:t.workspace?.hidden??[]},config:As(t.config)},n=new Set;function s(){for(let o of Array.from(n))try{o(r)}catch{}}return{getState(){return r},setState(o){let i={...r,...o,filters:{...r.filters,...o.filters||{}},board:{...r.board,...o.board||{}},worker:{...r.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:r.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:r.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:r.workspace.hidden},config:o.config!==void 0?As(o.config):r.config},l=i.workspace.current?.path!==r.workspace.current?.path||i.workspace.available.length!==r.workspace.available.length||i.workspace.hidden.length!==r.workspace.hidden.length||i.workspace.hidden.some((d,h)=>d!==r.workspace.hidden[h]),a=i.config.workspace_config.default_workspace!==r.config.workspace_config.default_workspace;i.selected_id===r.selected_id&&i.view===r.view&&i.filters.status===r.filters.status&&i.filters.search===r.filters.search&&i.filters.type===r.filters.type&&i.board.closed_filter===r.board.closed_filter&&i.board.show_deferred_column===r.board.show_deferred_column&&i.worker.selected_parent_id===r.worker.selected_parent_id&&i.worker.show_closed_children.length===r.worker.show_closed_children.length&&i.worker.show_closed_children.every((d,h)=>d===r.worker.show_closed_children[h])&&!l&&!a||(r=i,e("state change %o",{selected_id:r.selected_id,view:r.view,filters:r.filters,board:r.board,worker:r.worker,workspace:r.workspace.current?.path,config:{default_workspace:r.config.workspace_config.default_workspace}}),s())},subscribe(o){return n.add(o),()=>n.delete(o)}}}function Cs(t){let e=we("activity"),r=0,n=new Map,s=1;function o(){if(!t)return;let d=r>0;t.toggleAttribute("hidden",!d),t.setAttribute("aria-busy",d?"true":"false")}function i(){r+=1,e("start count=%d",r),o()}function l(){let d=r;r=Math.max(0,r-1),d<=0?e("done called but count was already %d",d):e("done count=%d\u2192%d",d,r),o()}function a(d){return async(m,k)=>{let $=s++,v=Date.now();n.set($,{type:m,start_ts:v}),e("request start id=%d type=%s count=%d",$,m,r+1),i();let L=!1,P=()=>{L||(L=!0,n.delete($),l())},B=setTimeout(()=>{L||(e("request TIMEOUT id=%d type=%s elapsed=%dms",$,m,Date.now()-v),P())},3e4);try{let q=await d(m,k),G=Date.now()-v;return e("request done id=%d type=%s elapsed=%dms",$,m,G),q}catch(q){let G=Date.now()-v;throw e("request error id=%d type=%s elapsed=%dms err=%o",$,m,G,q),q}finally{clearTimeout(B),P()}}}return o(),{wrapSend:a,start:i,done:l,getCount:()=>r,getActiveRequests:()=>{let d=Date.now();return Array.from(n.entries()).map(([h,m])=>({id:h,type:m.type,elapsed_ms:d-m.start_ts}))}}}function Q(t,e="info",r=2800){let n=document.createElement("div");n.className="toast",n.textContent=t,n.style.position="fixed",n.style.right="12px",n.style.bottom="12px",n.style.zIndex="1000",n.style.color="#fff",n.style.padding="8px 10px",n.style.borderRadius="4px",n.style.fontSize="12px",e==="success"?n.style.background="#156d36":e==="warning"?n.style.background="#a36a00":e==="error"?n.style.background="#9f2011":n.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(n),setTimeout(()=>{try{n.remove()}catch{}},r)}function $r(t=void 0,e=void 0){function r(){if(!e||typeof e.get!="function")return null;let o=e.get();return o&&o.order?o.order:{}}function n(o,i,l){let a=t&&t.snapshotFor?t.snapshotFor(o).slice():[];if(i==="closed")return a.sort(ks),a;switch(l){case"created_desc":return a.sort(At),a;case"created_asc":return a.sort(_s),a;case"updated_desc":return a.sort(bs),a;case"priority":return a.sort(ws),a;case"manual":default:{let d=r();return d?a.sort(yr(d)):a.sort(At),a}}}function s(o){let i=[];return t&&typeof t.subscribe=="function"&&i.push(t.subscribe(o)),e&&typeof e.subscribe=="function"&&i.push(e.subscribe(o)),()=>{for(let l of i)try{l()}catch{}}}return{selectBoardColumn:n,subscribe:s}}function xr(t){let e=t.transport,r=t.uiOrderStore;function n(i,l){return"renormalize"in i?i.renormalize:[{bead_id:l,rank:i.rank}]}function s(i,l){let a={...i.order};for(let d of l)a[d.bead_id]=d.rank;r&&r.set({revision:i.revision,order:a})}async function o(i,l,a){if(!e||!r)return;let d=r.get()||{revision:0,order:{}},h=n(rn(l,a,d.order),i);s(d,h);let m=await e("ui-order-set",{expected_revision:d.revision,entries:h});if(m&&m.conflict){let k={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};r.set(k);let $=n(rn(l,a,k.order),i);s(k,$);let v=await e("ui-order-set",{expected_revision:k.revision,entries:$});v&&v.applied&&r.set({revision:typeof v.revision=="number"?v.revision:0,order:v.order||{}})}else m&&m.applied&&r.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:o}}function Sr(t){return Array.isArray(t)?t.filter(e=>typeof e=="string"):[]}function on(t,e){return!e||typeof t!="string"||t.length===0||Sr(e.visible_labels).includes(t)?!0:Sr(e.hidden_labels).includes(t)?!1:!Sr(e.hidden_prefixes).some(r=>r.length>0&&t.startsWith(r))}function Rs(t,e){return Sr(t).filter(r=>on(r,e))}function Et(t,e){let r=t&&t.chips?t.chips[e]:void 0;return typeof r=="boolean"?r:!0}function an(t){if(!t)return null;if(typeof t=="number")return Number.isFinite(t)?t:null;let e=Date.parse(t);return Number.isFinite(e)?e:null}function ht(t){let e=an(t);if(e===null)return"";let r=new Date(e),n=s=>String(s).padStart(2,"0");return`${r.getFullYear()}-${n(r.getMonth()+1)}-${n(r.getDate())} ${n(r.getHours())}:${n(r.getMinutes())}`}function ln(t,e){let r=an(t);if(r===null)return"";let s=(typeof e=="number"?e:Date.now())-r;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let i=Math.floor(s/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let l=Math.floor(s/864e5);if(l<7)return`${l}\uC77C \uC804`;let a=Math.floor(l/7);if(l<30)return`${a}\uC8FC \uC804`;let d=Math.floor(l/30);return d<12?`${d}\uAC1C\uC6D4 \uC804`:`${Math.floor(l/365)}\uB144 \uC804`}var Ai={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg"},Ei={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge"},Ci={spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},Ri={reviewed:"\u2713",skip:"\u2298",stale:"\u2713"};function Li(t,e,r){if(!(r==="in_progress"||r==="resolved"))return null;for(let s of t)if(e[s]&&e[s].state==="dim")return s;return null}function Ii(t,e,r){let n=Ai[t]||t,s=e&&e.state||"empty",o=Ri[s]||"",i="bar";s==="dim"?i+=` b-${n} dim`:s==="on"||s==="reviewed"||s==="skip"?i+=` b-${n} on`:s==="stale"&&(i+=` b-${n} stale`),r&&(i+=" glow");let l=s==="empty"?"lbl":`lbl l-${n} on`,a=r?`color: var(--stage-${n}-on)`:"";return u`
    <div class="seg">
  ...
  `}function Is(t,e){let r=Di(t.priority);return u`
    ...
    >
      ...
      ${Mi(t,e)}
      ${t.workflow&&Et(e.policy||null,"stepper")?Tr(t.workflow,t.status):""}
      ${Fi(t,e)}
    </article>
  ...
  `}var Hi=200,Wi={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","deferred-col":"deferred","closed-col":"closed"},Gi=new Set(["blocked-col","ready-col","in-progress-col","resolved-col","deferred-col"]),Os="beads-ui.board.sort",Ms=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function ji(){try{let t=window.localStorage.getItem(Os);if(t&&Ms.has(t))return t}catch{}return"created_desc"}function Ns(t,e){let r=we("views:board"),n=e.gotoIssue,s=e.issueStores,o=e.transport,i=e.uiOrderStore,l=e.displayPolicyStore,a=e.onClosedRangeChange,d=e.onNewIssue,h=e.closedRange||br,m=s?$r(s,i):null,k=xr({transport:o,uiOrderStore:i}),$=[],v=[],L=[],P=[],B=[],q=[],G=!1,N=0,E=ji(),C=new Map,x=new Map,_=new Map,O=new Set,F={search:"",priority:"",type:"",labels:[]},W=!1,V=null;function ne(I){return String(I.status||"open")==="open"}function se(I){let M=String(I.status||"open");return M==="open"||M==="blocked"}function $e(I){let M=F.search.trim().toLowerCase(),c=F.priority,f=F.type,y=F.labels;return I.filter(g=>{if(M){let A=String(g.id||"").toLowerCase(),T=String(g.title||"").toLowerCase();if(!A.includes(M)&&!T.includes(M))return!1}if(c!==""&&String(g.priority)!==c||f!==""&&String(g.issue_type||"")!==f)return!1;if(y.length>0){let A=Array.isArray(g.labels)?g.labels:[];if(!y.some(T=>A.includes(T)))return!1}return!0})}function Ge(){let I=new Set;for(let M of[$,v,L,P,B,q])for(let c of M){let f=Array.isArray(c.labels)?c.labels:[];for(let y of f)typeof y=="string"&&y.length>0&&I.add(y)}return Array.from(I).sort()}function ze(){return F.search.trim()!==""||F.priority!==""||F.type!==""||F.labels.length>0}function ke(){try{if(m){let I=m.selectBoardColumn("tab:board:in-progress","in_progress",E),M=m.selectBoardColumn("tab:board:blocked","blocked",E).filter(se),c=new Set(I.map(U=>U.id)),f=m.selectBoardColumn("tab:board:ready","ready",E).filter(U=>ne(U)&&!c.has(U.id)),y=m.selectBoardColumn("tab:board:resolved","resolved",E),g=m.selectBoardColumn("tab:board:deferred","deferred",E),A=G?g:[],T=m.selectBoardColumn("tab:board:closed","closed").slice(0,Hi),R=[...M,...f,...I,...y,...A,...T];xe(R);let K=new Set;for(let U of R)U&&U.id&&!cn(U)&&K.add(U.id);let te=!ze();$=te?qt(M,K):M,v=te?qt(f,K):f,L=te?qt(I,K):I,P=te?qt(y,K):y,B=te?qt(A,K):A,N=g.length,q=te?qt(T,K):T,C=new Map;for(let U of $)C.set(U.id,"open");for(let U of v)C.set(U.id,"open");for(let U of L)C.set(U.id,"in_progress");for(let U of P)C.set(U.id,"resolved");for(let U of B)C.set(U.id,"deferred");for(let U of q)C.set(U.id,"closed");x=new Map;for(let U of $)x.set(U.id,"blocked-col");for(let U of v)x.set(U.id,"ready-col");for(let U of L)x.set(U.id,"in-progress-col");for(let U of P)x.set(U.id,"resolved-col");for(let U of B)x.set(U.id,"deferred-col");for(let U of q)x.set(U.id,"closed-col")}_e()}catch{$=[],v=[],L=[],P=[],B=[],q=[],_=new Map,_e()}}function xe(I){let M=new Map;for(let f of I)f&&f.id&&!M.has(f.id)&&M.set(f.id,f);let c=new Map;for(let f of M.values()){let y=cn(f);if(!y)continue;let g=c.get(y);g||(g=[],c.set(y,g)),g.push({id:f.id,title:f.title,status:f.status,metadata:f.metadata,created_at:f.created_at})}_=c}function je(I){let M=_.get(I)||[],c=0,f=null;for(let y of M)(y.status==="resolved"||y.status==="closed")&&(c+=1),!f&&y.status==="in_progress"&&(f=y);return{total:M.length,count:c,current:f,children:M}}function ce(I){return!O.has(I)}function lt(I,M){I.preventDefault(),I.stopPropagation(),O.has(M)?O.delete(M):O.add(M),_e()}function pe(I,M){I.preventDefault(),I.stopPropagation(),n(M)}function Ye(I,M){I.preventDefault(),I.stopPropagation(),n(M)}function ie(I,M){V||n(M)}function Me(I,M){I.preventDefault(),I.stopPropagation(),Yi(M).then(c=>{c&&Q("\uBCF5\uC0AC\uB428","success",1200)})}function Qe(I,M){V=M,I.dataTransfer&&(I.dataTransfer.setData("text/plain",M),I.dataTransfer.effectAllowed="move"),I.target.classList.add("board-card--dragging")}function Se(I){I.target.classList.remove("board-card--dragging"),Je(),setTimeout(()=>{V=null},0)}function Ee(I){let M=String(I.target.value||"");!M||M===h||(h=M,a&&a(M),_e())}let ye={onCardClick:ie,onCopyId:Me,onDragStart:Qe,onDragEnd:Se,onClosedRangeChange:Ee,rollupFor:je,isExpanded:ce,onRollupToggle:lt,onChildClick:pe,onFromChipClick:Ye,get policy(){return l?l.get():null}};function Ne(I){let M=I.target,c=t.querySelector(".board-filter__labels");M&&c&&c.contains(M)||de()}function Ve(I){I.key==="Escape"&&de()}function Ce(){W||(W=!0,document.addEventListener("mousedown",Ne),document.addEventListener("keydown",Ve),_e())}function de(){W&&(W=!1,document.removeEventListener("mousedown",Ne),document.removeEventListener("keydown",Ve),_e())}let Re={onSearchInput(I){F.search=String(I.target.value||""),ke()},onPriorityChange(I){F.priority=String(I.target.value||""),ke()},onTypeChange(I){F.type=String(I.target.value||""),ke()},onSortChange(I){let M=String(I.target.value||"");if(!(!Ms.has(M)||M===E)){E=M;try{window.localStorage.setItem(Os,M)}catch{}ke()}},onDeferredToggle(){G=!G,ke()},onLabelMenuToggle(){W?de():Ce()},onLabelToggle(I){let M=F.labels.indexOf(I);M===-1?F.labels.push(I):F.labels.splice(M,1),ke()},onLabelClear(){F.labels.length!==0&&(F.labels=[],ke())},onNewIssue(){d&&d()}};function He(){let I=G?"board-root board-root--deferred":"board-root";return u`
      <div class="board-view">
        ${Ds(F,Re,{sort_mode:E,show_deferred:G,deferred_count:N,label_options:Ge(),label_menu_open:W})}
        <div class=${I}>
    ...
    `}function _e(){le(He(),t),Te()}function Te(){try{let I=Array.from(t.querySelectorAll(".board-column"));for(let M of I)Array.from(M.querySelectorAll(".board-card")).forEach((f,y)=>{f.tabIndex=y===0?0:-1})}catch{}}async function Pe(I,M){if(!o){Q("\uC5F0\uACB0\uB418\uC9C0 \uC54A\uC544 \uC0C1\uD0DC\uB97C \uBCC0\uACBD\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}try{await o("update-status",{id:I,status:M}),Q("\uC0C1\uD0DC \uBCC0\uACBD\uB428","success",1500)}catch(c){r("update-status failed: %o",c),Q("\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328","error")}}function Oe(I){switch(I){case"blocked-col":return $;case"ready-col":return v;case"in-progress-col":return L;case"resolved-col":return P;case"deferred-col":return B;default:return[]}}function Ke(I,M,c){if(!o||!i)return;let f=Oe(I),y=f.find(K=>K.id===M);if(!y)return;let g=f.filter(K=>K.id!==M),A=c.closest?c.closest(".board-card"):null,T=g.length;if(A){let K=A.getAttribute("data-issue-id");if(K===M)return;let te=g.findIndex(U=>U.id===K);te>=0&&(T=te)}let R=g.slice();R.splice(T,0,y),k.applyReorder(M,R,T)}function Je(){for(let I of Array.from(t.querySelectorAll(".board-column--drag-over")))I.classList.remove("board-column--drag-over")}let me=null;t.addEventListener("dragover",I=>{I.preventDefault(),I.dataTransfer&&(I.dataTransfer.dropEffect="move");let c=I.target.closest(".board-column");c&&c!==me&&(me&&me.classList.remove("board-column--drag-over"),c.classList.add("board-column--drag-over"),me=c)}),t.addEventListener("dragleave",I=>{let M=I.relatedTarget;(!M||!t.contains(M))&&me&&(me.classList.remove("board-column--drag-over"),me=null)}),t.addEventListener("drop",I=>{I.preventDefault(),me&&(me.classList.remove("board-column--drag-over"),me=null);let M=I.target,c=M.closest(".board-column");if(!c)return;let f=I.dataTransfer?.getData("text/plain")||"";if(!f)return;let y=c.id,g=x.get(f);if(g&&g===y){if(Gi.has(y)){if(E!=="manual"){Q("\uC218\uB3D9(\uB4DC\uB798\uADF8) \uC815\uB82C \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC21C\uC11C\uB97C \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4","warning",2e3);return}Ke(y,f,M)}return}let A=Wi[y];if(!A){Q("\uC5EC\uAE30\uB85C\uB294 \uC62E\uAE38 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","warning",1500);return}C.get(f)!==A&&Pe(f,A)}),t.addEventListener("keydown",I=>{let M=I.target;if(!(M instanceof HTMLElement))return;let c=String(M.tagName||"").toLowerCase();if(c==="input"||c==="textarea"||c==="select"||c==="button"||c==="a"||M.isContentEditable===!0)return;let f=M.closest(".board-card");if(!f)return;let y=String(I.key||"");if(y==="Enter"||y===" "){I.preventDefault();let R=f.getAttribute("data-issue-id");R&&n(R);return}if(y!=="ArrowUp"&&y!=="ArrowDown"&&y!=="ArrowLeft"&&y!=="ArrowRight")return;I.preventDefault();let g=f.closest(".board-column");if(!g)return;let A=Array.from(g.querySelectorAll(".board-card")),T=A.indexOf(f);if(y==="ArrowDown"&&T<A.length-1){Le(f,A[T+1]);return}if(y==="ArrowUp"&&T>0){Le(f,A[T-1]);return}if(y==="ArrowLeft"||y==="ArrowRight"){let R=Array.from(t.querySelectorAll(".board-column")),K=R.indexOf(g),te=y==="ArrowRight"?1:-1,U=K+te;for(;U>=0&&U<R.length;){let be=R[U].querySelector(".board-card");if(be){Le(f,be);return}U+=te}}});function Le(I,M){try{I.tabIndex=-1,M.tabIndex=0,M.focus()}catch{}}let Ae=null;m&&m.subscribe&&(Ae=m.subscribe(()=>{try{ke()}catch{}}));let Ie=null;return l&&l.subscribe&&(Ie=l.subscribe(()=>{try{ke()}catch{}})),{async load(){r("load"),ke()},clear(){de(),Ae&&(Ae(),Ae=null),Ie&&(Ie(),Ie=null),t.replaceChildren(),$=[],v=[],L=[],P=[],B=[],q=[],C=new Map,x=new Map}}}function cn(t){let e=t&&t.parent;return typeof e=="string"?e:e&&e.id?String(e.id):""}function qt(t,e){return t.filter(r=>{let n=cn(r);return!(n&&e.has(n))})}async function Yi(t){try{if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")return await navigator.clipboard.writeText(String(t)),!0;let e=document.createElement("textarea");e.value=String(t),e.style.position="fixed",e.style.left="-9999px",document.body.appendChild(e),e.select();let r=!1;try{r=document.execCommand("copy")}finally{e.remove()}return r}catch{return!1}}async function Rt(t){let e=String(t);if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{return await navigator.clipboard.writeText(e),!0}catch{}try{let r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.left="-9999px",document.body.appendChild(r),r.select();let n=!1;try{n=document.execCommand("copy")}finally{r.remove()}return n}catch{return!1}}var Vi={Read:"\u{1F4D6}",Edit:"\u270E",MultiEdit:"\u270E",Write:"\u{1F4DD}",Bash:"\u26A1",Grep:"\u{1F50E}",Glob:"\u{1F50E}",Task:"\u{1F916}",WebFetch:"\u{1F310}",WebSearch:"\u{1F310}"},Ki=/^\s*([✓✗⊘])\s*(spec|impl|implementation|plan)\s*게이트\s*[—–-]\s*(\S+)\s+(APPROVE|REVISE|REJECT|BLOCK|SKIP)(?:\s*·\s*(.+))?/,Zi=/^\s*#{0,3}\s*Phase\s+\d+(?:\s*\/\s*\d+)?\s*(?:[·:—–-]\s*.+)?$/;function gt(t){return!!t&&typeof t=="object"}function dn(t){return typeof t!="string"||t.length===0?[]:t.split(/\r?\n/)}function Ps(t,e){let r=dn(t),n=dn(e),s=new Map;for(let l of r)s.set(l,(s.get(l)||0)+1);let o=0;for(let l of n){let a=s.get(l)||0;a>0?s.set(l,a-1):o+=1}let i=0;for(let l of s.values())i+=l;return{added:o,removed:i}}function Xi(t){let e="";typeof t=="string"?e=t:Array.isArray(t)?e=t.map(s=>gt(s)&&typeof s.text=="string"?s.text:"").join(""):gt(t)&&typeof t.text=="string"&&(e=t.text);let n=(String(e).split(/\r?\n/).find(s=>s.trim().length>0)||"").trim();return n.length>120?`${n.slice(0,117)}\u2026`:n}function Qi(t){let e=String(t.name||""),r=t.input||{},n={kind:"tool",tool:e,icon:Vi[e]||"\u{1F527}",input:r,expandable:!0};if((e==="Read"||e==="Write")&&(n.path=String(r.file_path||r.path||"")),e==="Write"&&(n.added=dn(r.content).length),e==="Edit"){n.path=String(r.file_path||r.path||"");let{added:s,removed:o}=Ps(r.old_string,r.new_string);n.added=s,n.removed=o}if(e==="MultiEdit"){n.path=String(r.file_path||r.path||"");let s=0,o=0,i=Array.isArray(r.edits)?r.edits:[];for(let l of i){let a=Ps(gt(l)?l.old_string:"",gt(l)?l.new_string:"");s+=a.added,o+=a.removed}n.added=s,n.removed=o}return e==="Bash"&&(n.command=String(r.command||"")),(e==="Grep"||e==="Glob")&&(n.command=String(r.pattern||r.query||"")),n}function Fs(t){let e=t.split(/\r?\n/).find(n=>n.trim().length>0)||"",r=Ki.exec(e);return r?{kind:"gate",gate:r[2]==="implementation"?"impl":r[2],reviewer:r[3],verdict:r[4],time:r[5]?r[5].trim():void 0,text:e.trim()}:Zi.test(e)&&e.trim().length<=80?{kind:"phase",text:e.trim()}:{kind:"assistant",text:t}}function Ji(t,e){if(t.type==="assistant"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[],s=[];for(let o of n)if(gt(o)){if(o.type==="text"&&typeof o.text=="string")s.push(Fs(o.text));else if(o.type==="tool_use"){let i=Qi(o);typeof o.id=="string"&&e.set(o.id,i),s.push(i)}}return s}if(t.type==="user"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[];for(let s of n)if(gt(s)&&s.type==="tool_result"){let o=e.get(String(s.tool_use_id));if(o){let i=Xi(s.content);o.result=i,o.output=typeof s.content=="string"?s.content:i}}return[]}if(t.type==="result"){let r=t.is_error===!1&&t.subtype==="success";return[{kind:"result",success:r,text:typeof t.result=="string"?t.result:r?"DONE":""}]}return[]}function ea(t){if(t.type==="item.completed"&&gt(t.item)){let e=t.item;return e.type==="agent_message"&&typeof e.text=="string"?[Fs(e.text)]:e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}if(t.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(t.type==="turn.failed"){let e=t.error;return[{kind:"error",text:e&&typeof e.message=="string"?e.message:"turn failed"}]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:[]}function ta(t){let e=t.type;return typeof e=="string"&&(e==="error"||e.startsWith("thread.")||e.startsWith("turn.")||e.startsWith("item."))}function Bs(t){let e=[],r=new Map,n=Array.isArray(t)?t:[];for(let s of n){let o=s;if(typeof s=="string"){let l=s.trim();if(l.length===0)continue;try{o=JSON.parse(l)}catch{continue}}if(!gt(o))continue;let i=ta(o)?ea(o):Ji(o,r);for(let l of i)e.push(l)}return e}function Ar(t,e={}){let{transport:r,sessionLogStore:n,onClose:s}=e,o=null,i={},l=!0,a=new Set,d=null;function h(){if(!o||!n)return[];let x=n.get(o);return Bs(x?x.lines:[])}function m(x,_){if(_.kind==="gate")return u`<div class="sv__gate">${_.text}</div>`;if(_.kind==="phase")return u`<div class="sv__phase">${_.text}</div>`;if(_.kind==="result")return u`<div
      ...
      >
        ...
        ${O?u`<pre class="sv__tool-expand">${k(_)}</pre>`:""}
      </div>`}return u`<div class="sv__as">${_.text}</div>`}function k(x){let _=[];if(x.input!==void 0)try{_.push(`input: ${JSON.stringify(x.input,null,2)}`)}catch{}return typeof x.output=="string"&&x.output.length>0&&_.push(`output:
${x.output}`),_.join(`
...
`)}var Nr=class{constructor(t){ue(this,"options");ue(this,"rules");ue(this,"lexer");this.options=t||It}space(t){let e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){let e=this.rules.block.code.exec(t);if(e){let r=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?r:cr(r,`
...
${d}`:d,s=s?`${s}
${h}`:h;let m=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,o,!0),this.lexer.state.top=m,r.length===0)break;let k=o.at(-1);if(k?.type==="code")break;if(k?.type==="blockquote"){let $=k,v=$.raw+`
`+r.join(`
...
`,1)[0],$=!m.trim(),v=0;if(this.options.pedantic?(v=2,h=m.trimStart()):$?v=e[1].length+1:(v=e[2].search(this.rules.other.nonSpaceChar),v=v>4?1:v,h=m.slice(v),v+=e[1].length),$&&this.rules.other.blankLine.test(k)&&(d+=k+`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+ut(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},Lt=new al;function ae(t,e){return Lt.parse(t,e)}ae.options=ae.setOptions=function(t){return Lt.setOptions(t),ae.defaults=Lt.defaults,uo(ae.defaults),ae};ae.getDefaults=En;ae.defaults=It;ae.use=function(...t){return Lt.use(...t),ae.defaults=Lt.defaults,uo(ae.defaults),ae};ae.walkTokens=function(t,e){return Lt.walkTokens(t,e)};ae.parseInline=Lt.parseInline;ae.Parser=at;ae.parser=at.parse;ae.Renderer=Pr;ae.TextRenderer=Nn;ae.Lexer=it;ae.lexer=it.lex;ae.Tokenizer=Nr;ae.Hooks=dr;ae.parse=ae;var md=ae.options,_d=ae.setOptions,bd=ae.use,wd=ae.walkTokens,kd=ae.parseInline;var yd=at.parse,vd=it.lex;function vo(t){let e=ae.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",l="";function a(v){v.key==="Escape"&&s&&(v.preventDefault(),k())}document.addEventListener("keydown",a);function d(){return s?u`
  ...
  `}var ul=["open","in_progress","deferred","resolved","closed"],pl=[0,1,2,3,4];function So(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,l=e.sessionLogStore,a=null,d=null,h={},m=!1,k=!1,$="",v="",L="";function P(){m=!1,k=!1,$="",v="",L=""}let B=document.createElement("div");B.className="md-viewer-root",document.body.appendChild(B);let q=$o(B,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),G=document.createElement("div");G.className="session-log-root",document.body.appendChild(G);let N=Ar(G,{transport:s?(g,A)=>Promise.resolve(s(g,A)):void 0,sessionLogStore:l});function E(){if(!i||!a)return[];let g=i.get();return(g&&g.attempts?Object.values(g.attempts):[]).filter(T=>T&&T.bead_id===a).sort((T,R)=>(R.started_at||0)-(T.started_at||0)).map(T=>({attempt_id:T.attempt_id,bead_id:T.bead_id,status:T.status,started_at:typeof T.started_at=="number"?T.started_at:null,runner:T.runner||null,model:T.model||null,session_id:T.session_id||null,resumed_from:T.resumed_from||null,dismissed_at:typeof T.dismissed_at=="number"?T.dismissed_at:null,cause:typeof T.cause=="string"?T.cause:null,cause_detail:T.cause_detail||null}))}function C(g){let A=i?i.get():null,T=A&&A.attempts?A.attempts[g]:null;N.open({attempt_id:g,meta:T?{runner:T.runner||void 0,model:T.model||void 0,effort:T.effort||void 0,status:T.status||void 0,session_id:T.session_id||void 0}:{}})}async function x(g){if(!s||!g)return;let A=()=>{let R=i?i.get():null;return R&&typeof R.revision=="number"?R.revision:0},T=await s("worker-attempt-resume",{attempt_id:g,expected_revision:A()});if(T&&T.conflict){let R=T.queue&&typeof T.queue.revision=="number"?T.queue.revision:A();T=await s("worker-attempt-resume",{attempt_id:g,expected_revision:R})}T&&T.resumed===!1&&!T.conflict&&T.reason&&Q(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${T.reason}`,"error",2400)}let _={onOpen:C,onResume:x};function O(){let g=i?i.get():null,A=g&&g.exec_defaults;return A&&typeof A=="object"?A:{}}let F=null;r&&r.subscribe&&(F=r.subscribe(()=>ne()));let W=null;i&&typeof i.subscribe=="function"&&(W=i.subscribe(()=>{a&&y()}));function V(g){g.key==="Escape"&&a&&(g.preventDefault(),n())}document.addEventListener("keydown",V);function ne(){if(a){if(r&&typeof r.snapshotFor=="function"){let g=r.snapshotFor("detail:"+a)||[];d=g.find(T=>T&&T.id===a)||g[0]||d}y()}}function se(g){Rt(g).then(A=>{A?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function $e(g){g.preventDefault(),g.stopPropagation(),a&&se(a)}function Ge(g,A){g.preventDefault(),g.stopPropagation(),se(A)}function ze(g,A){g.preventDefault(),g.stopPropagation(),q.open(A)}function ke(g,A){h[g]=A,y(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:g,value:A})).catch(()=>{Q("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function xe(g,A,T){if(!s||!a)return!1;try{let R=await Promise.resolve(s(g,A)),K=Array.isArray(R)?R[0]:R;return K&&typeof K=="object"&&K.id?(d=K,!0):(Q(T,"error"),!1)}catch{return Q(T,"error"),!1}}function je(g){setTimeout(()=>{try{let A=t.querySelector(g);A&&typeof A.focus=="function"&&A.focus()}catch{}},0)}function ce(){m=!0,$=d&&d.title||"",y(),je('.detail-edit__input[data-edit="title"]')}function lt(g){$=g.target.value}function pe(){m=!1,$="",y()}function Ye(){xe("edit-text",{id:a,field:"title",value:$},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(A=>{A&&(m=!1,$=""),y()})}function ie(){k=!0,v=d&&d.description||"",y(),je('.detail-edit__textarea[data-edit="description"]')}function Me(g){v=g.target.value}function Qe(){k=!1,v="",y()}function Se(){xe("edit-text",{id:a,field:"description",value:v},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(A=>{A&&(k=!1,v=""),y()})}function Ee(g,A,T,R){if(g.key==="Escape"){g.stopPropagation(),T();return}g.key==="Enter"&&(!R||g.ctrlKey||g.metaKey)&&(g.preventDefault(),A())}function ye(g){let A=g.target.value;xe("update-status",{id:a,status:A},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>y())}function Ne(g){let A=Number(g.target.value);xe("update-priority",{id:a,priority:A},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>y())}function Ve(g){L=g.target.value}function Ce(){let g=L.trim();g.length!==0&&xe("label-add",{id:a,label:g},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(A=>{A&&(L=""),y()})}function de(g){if(g.key==="Escape"){g.stopPropagation(),L="",y();return}g.key==="Enter"&&(g.preventDefault(),Ce())}function Re(g){xe("label-remove",{id:a,label:g},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>y())}let He={onCopyPath:Ge,onOpenDoc:ze},_e={onChange:ke};function Te(g){return typeof g=="string"?g:g&&typeof g=="object"?String(g.id||g.to||g.issue_id||g.depends_on||""):""}function Pe(g){switch(g&&typeof g=="object"?String(g.dependency_type||g.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Oe(g){let T=(Array.isArray(g.dependencies)?g.dependencies:[]).map(R=>({id:Te(R),icon:Pe(R)})).filter(R=>R.id.length>0);return u`
    ...
    `}function Ke(g){let A=g.metadata||{},T=g.workflow||{},R=T.stages||{},K=R.spec&&R.spec.stale,te=R.impl&&R.impl.stale,U=T.route_source==="derived",be=T.route||A.route||"\u2014";return u`
    ...
    `}let Je={route:["spec_backed","full_plan"]};async function me(g,A){let T=A.target.value;if(g==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&T!=="full_plan"&&!window.confirm(`full_plan \u2192 ${T||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){y();return}await xe("update-workflow-meta",{id:a,key:g,value:T},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),y()}function Le(g){let A=g.metadata||{};return u` ${((R,K)=>{let te=Je[R],U=typeof A[R]=="string"?A[R]:"";return u`<div class="detail-kv">
        ...
        <select
          ...
          @change=${be=>me(R,be)}
        >
          <option value="" ?selected=${!te.includes(U)}>
            ${K}
          </option>
          ${te.map(be=>u`<option value=${be} ?selected=${U===be}>${be}</option>`)}
        </select>
      </div>`})("route","(\uBBF8\uC124\uC815 \xB7 \uCD94\uB860)")} `}function Ae(g){return m?u`
    ...
    `}function Ie(g){let A=ht(g.created_at),T=ht(g.updated_at);return!A&&!T?u``:u`
    ...
    `}function f(){if(!a)return u``;let g=d||{},A=String(g.id||a),T=g.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",R=g.status||"open",K=typeof g.priority=="number"?Math.max(0,Math.min(4,g.priority)):"",te=g.description||"",U={...g,metadata:{...g.metadata||{},...h}};return u`
    ...
    `}function y(){le(f(),t)}return{load(g){g!==a&&(h={},P()),a=g,d=null,ne()},clear(){a=null,d=null,h={},P(),q.close(),N.close(),le(u``,t)},destroy(){F&&(F(),F=null),W&&(W(),W=null),document.removeEventListener("keydown",V),q.destroy(),B.parentNode&&B.parentNode.removeChild(B),N.destroy(),G.parentNode&&G.parentNode.removeChild(G),a=null,d=null,le(u``,t)}}}var fl=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function To(t,e){return on(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function hl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function Ao(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function l(C){let x=r.get();if(x)try{let _=await n("display-policy-set",{expected_revision:x.revision,policy:C(x)});a(_),_&&_.conflict&&_.policy&&(_=await n("display-policy-set",{expected_revision:_.policy.revision,policy:C(_.policy)}),a(_)),_&&_.conflict&&Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(C){C&&C.policy&&typeof C.policy=="object"&&r.set(C.policy)}function d(C){let x=r.get();if(!x)return;let _=To(C,x)!=="shown";l(O=>hl(C,O,_))}function h(){let C=i.trim();C.length!==0&&(i="",l(x=>x.hidden_prefixes.includes(C)?{hidden_prefixes:x.hidden_prefixes}:{hidden_prefixes:[...x.hidden_prefixes,C]}),P())}function m(C){l(x=>({hidden_prefixes:x.hidden_prefixes.filter(_=>_!==C)}))}function k(C){let x=r.get();if(!x)return;let _=x.chips[C]===!1;l(()=>({chips:{[C]:_}}))}function $(C){let x=s();return u`
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),l=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),d=r.querySelector("#new-issue-error"),h=r.querySelector("#btn-cancel"),m=r.querySelector("#btn-create"),k=r.querySelector(".new-issue__close");function $(){o.replaceChildren();let E=document.createElement("option");E.value="",E.textContent="\u2014 Select \u2014",o.appendChild(E);for(let C of Ro){let x=document.createElement("option");x.value=C,x.textContent=Lo(C),o.appendChild(x)}i.replaceChildren();for(let C=0;C<=4;C+=1){let x=document.createElement("option");x.value=String(C);let _=Io[C]||"Medium";x.textContent=`${C} \u2013 ${_}`,i.appendChild(x)}}$();function v(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function L(E){s.disabled=E,o.disabled=E,i.disabled=E,l.disabled=E,a.disabled=E,h.disabled=E,m.disabled=E,m.textContent=E?"Creating\u2026":"Create"}function P(){d.textContent=""}function B(E){d.textContent=E}function q(){try{let E=window.localStorage.getItem("beads-ui.new.type");E?o.value=E:o.value="";let C=window.localStorage.getItem("beads-ui.new.priority");C&&/^\d$/.test(C)?i.value=C:i.value="2"}catch{o.value="",i.value="2"}}function G(){let E=o.value||"",C=i.value||"";E.length>0&&window.localStorage.setItem("beads-ui.new.type",E),C.length>0&&window.localStorage.setItem("beads-ui.new.priority",C)}async function N(){P();let E=String(s.value||"").trim();if(E.length===0){B("Title is required"),s.focus();return}let C=Number(i.value||"2");if(!(C>=0&&C<=4)){B("Priority must be 0..4"),i.focus();return}let x=String(o.value||""),_=String(a.value||""),O={title:E};x.length>0&&(O.type=x),String(C).length>0&&(O.priority=C),_.length>0&&(O.description=_),L(!0);try{await e("create-issue",O)}catch{L(!1),B("Failed to create issue");return}G(),L(!1),v()}return r.addEventListener("cancel",E=>{E.preventDefault(),v()}),k.addEventListener("click",()=>v()),h.addEventListener("click",()=>v()),r.addEventListener("keydown",E=>{E.key==="Enter"&&(E.ctrlKey||E.metaKey)&&(E.preventDefault(),N())}),n.addEventListener("submit",E=>{E.preventDefault(),N()}),{open(){n.reset(),P(),q();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){v()}}}function Oo(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function Mo(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var gl={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},ml=[{key:"orchestration_model",values:()=>un},{key:"orchestration_effort",values:()=>pn},{key:"review_model",values:()=>fn},{key:"impl_model",values:()=>hn}];function No(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function l(){let _=i();return typeof _.revision=="number"?_.revision:0}function a(){let _=i().exec_defaults;return _&&typeof _=="object"?_:{}}function d(_){_&&_.queue&&r&&r.set(_.queue)}async function h(_,O){if(!n)return;let F={key:_,value:O||null};try{let W=await n("worker-queue-set-exec-default",{...F,expected_revision:l()});d(W),W&&W.conflict&&(W=await n("worker-queue-set-exec-default",{...F,expected_revision:l()}),d(W)),W&&W.conflict&&Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function m(_,O,F){let W=!!F&&!O.includes(F);return u`<div class="exec-defaults__row">
    ...
    </div>`}function k(){let _=i().workspace_info;return _&&typeof _=="object"?_:{}}function $(_,O){return u`<span
    ...
    >`}function v(_){let O=_?Mo(_.cmd):"",F=_?Oo(_.timeout_ms):"",W=!!_&&_.source==="detected";return u`<div class="exec-defaults__vd-group" data-vd="verify">
    ...
    </div>`}function L(_){let O=_?Mo(_.cmd):"",F=_?Oo(_.timeout_ms):"",W=F?`timeout ${F} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",V=s&&s()||"<workspace \uACBD\uB85C>";return u`<div class="exec-defaults__vd-group" data-vd="deploy">
      ...
      ${P(_.last_deploy)}
    </section>`}function q(){let _=a();le(u`
      ...
      `,o)}let G=!1,N=()=>{G=!1};o.addEventListener("close",N),o.addEventListener("cancel",N);let E=null;r&&r.subscribe&&(E=r.subscribe(()=>{G&&q()}));function C(){G||(G=!0,q(),typeof o.showModal=="function"?o.showModal():o.setAttribute("open",""))}function x(){G&&(G=!1,typeof o.close=="function"?o.close():o.removeAttribute("open"))}return{open:C,close:x,destroy(){G=!1,o.removeEventListener("close",N),o.removeEventListener("cancel",N),E&&(E(),E=null),o.remove()}}}var _l="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4";function Ut(t){return typeof t=="number"&&Number.isFinite(t)?t:0}function bl(t){return!t||typeof t!="object"?!1:typeof t.input_tokens=="number"||typeof t.output_tokens=="number"}function wl(t){return t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}k`:String(t)}function zt(t){if(!bl(t))return null;let e=Ut(t?.input_tokens)+Ut(t?.output_tokens);return`\u03C4 ${wl(e)}`}function qr(t){if(!t||typeof t!="object")return"";let e=[`\uC785\uB825 ${Ut(t.input_tokens).toLocaleString("en-US")}`,`\uCD9C\uB825 ${Ut(t.output_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC77D\uAE30 ${Ut(t.cache_read_input_tokens).toLocaleString("en-US")}`,`\uCE90\uC2DC\uC0DD\uC131 ${Ut(t.cache_creation_input_tokens).toLocaleString("en-US")}`];typeof t.total_cost_usd=="number"&&Number.isFinite(t.total_cost_usd)&&e.push(`$${t.total_cost_usd.toFixed(2)}`);let r=e.join(" \xB7 ");return t.replayed?`${r}
${_l}`:r}function Pn(t,e){let r=null;for(let n of Object.values(t||{}))n&&n.bead_id===e&&(r=n.usage||null);return r}function Fn(t){let e=t.draggable&&!t.done,r=Array.isArray(t.badges)?t.badges:[],n=zt(t.usage),s=t.merge_step||null,o=t.lane==="pr_wait",i=e?u`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",l=u`<span class="worker-mini__id" title="클릭하면 ID 복사"
    >${t.id}</span
  >`,a=u`<span class="worker-mini__title">${t.title}</span>`,d=t.pr_url&&t.pr_number?u`<a
          ...
          title="PR 열기"
          >#${t.pr_number} ↗</a
        >`:"",h=r.map(B=>B===t.live_badge?u`<span
        ...
        >`:u`<span
          ...
          >${B}</span
        >`),m=t.reason?u`<span class="worker-mini__reason">${t.reason}</span>`:"",k=n?u`<span class="worker-usage" title=${qr(t.usage)}
        >${n}</span
  ...
  </div>`}function mt(t){let e=!!t.collapsible&&!!t.collapsed,r=u`<span
  ...
  </div>`}function xl(t,e,r=null){let n=!!t.paused,s=n?"\uC77C\uC2DC\uC815\uC9C0":typeof t.started_at=="number"?$l(e-t.started_at):"\u2014",o=[t.runner,t.model].filter(Boolean).join(" \xB7 "),i=zt(t.usage),l=t.conflict_resolution?n?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,a=t.attempt_id&&t.attempt_id===r;return u`<div
  ...
  >
  ...
  </div>`}var Sl="tab:worker:ready",Tl="tab:worker:blocked",Ur=1;function zn(t){let e=t&&t.metadata;return!!(e&&typeof e=="object"&&e.spec_id)}var Uo="beads-ui.worker.candidate-filter",qn={show_blocked:!1,spec:"all"};function Al(){try{let t=window.localStorage.getItem(Uo);if(!t)return{...qn};let e=JSON.parse(t);if(!e||typeof e!="object")return{...qn};let r=e.spec;return{show_blocked:e.show_blocked===!0,spec:r==="with"||r==="without"?r:"all"}}catch{return{...qn}}}function El(t){try{window.localStorage.setItem(Uo,JSON.stringify(t))}catch{}}function Cl(t,e){let r=l=>e.show_blocked||!l.blocked,n=l=>e.spec==="all"||(e.spec==="with"?l.has_spec:!l.has_spec),s=[],o=0,i=0;for(let l of t){let a=r(l),d=n(l);a&&d?s.push(l):!a&&d?o+=1:a&&!d&&(i+=1)}return{visible:s,hidden_blocked:o,hidden_spec:i}}var Rl=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],zo="bdui.worker.candidate_sort",Ll=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],zr="spec";function Il(){try{let t=window.localStorage.getItem(zo);return t==="board"||t==="created"||t==="spec"?t:zr}catch{return zr}}function Dl(t){try{window.localStorage.setItem(zo,t)}catch{}}var Ol="(max-width: 640px)",Ho="beads-ui.worker.lane-collapsed",fr={queue:!0,done:!0};function Ml(){try{let t=window.localStorage.getItem(Ho);if(!t)return{...fr};let e=JSON.parse(t);return!e||typeof e!="object"?{...fr}:{queue:typeof e.queue=="boolean"?e.queue:fr.queue,done:typeof e.done=="boolean"?e.done:fr.done}}catch{return{...fr}}}function Nl(t){try{window.localStorage.setItem(Ho,JSON.stringify(t))}catch{}}function qo(t){let e=Array.isArray(t)&&t.length>0?t[0]:null;if(!e)return"";let r=typeof e.title=="string"?e.title:e.id||"";return r.length>22?`${r.slice(0,22)}\u2026`:r}function Pl(t,e,r){let n=Array.isArray(t)?t.slice():[];return e==="created"?n.sort(At):(n.sort(yr(r)),e==="board"?n:[...n.filter(zn),...n.filter(s=>!zn(s))])}function Fl(t){let e=t&&t.parent;return(typeof e=="string"?e.length>0:!!(e&&e.id))||/\.\d+$/.test(t&&t.id||"")}function Bl(t){let r=(Array.isArray(t?.dependencies)?t.dependencies:[]).map(n=>typeof n=="string"?n:n&&n.id).filter(Boolean);return r.length>0?`\u{1F512} ${r.join(", ")}`:"\u{1F512} blocked"}var ql=["closed_unmerged","undecidable"],Ul=[{from:"\uAD00\uCE21 \uB300\uAE30",activity:"checking",to:"\uD655\uC778\uC911"},{from:"\uB85C\uCEEC\uAC80\uC99D \uB300\uAE30",activity:"verifying",to:"\uB85C\uCEEC\uAC80\uC99D \uC2E4\uD589 \uC911"}];function zl(t,e){for(let r of Ul)if(t===r.from&&e===r.activity)return{label:r.to,live:!0};return{label:t,live:!1}}var Un=[{step:"merging",label:"\uBA38\uC9C0 \uC911"},{step:"base_sync",label:"base \uB3D9\uAE30\uD654"},{step:"post_merge_verify",label:"\uBA38\uC9C0 \uD6C4 \uAC80\uC99D"},{step:"deploy",label:"\uBC30\uD3EC"},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC"},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC"},{step:"parent_close",label:"\uBD80\uBAA8 close"}];function Hl(t){if(typeof t!="string"||t.length===0)return null;let e=Un.length,r=Un.findIndex(n=>n.step===t);return r<0?{label:t,index:0,total:e,percent:0}:{label:Un[r].label,index:r+1,total:e,percent:Math.round((r+1)/e*100)}}function Wl(t,e,r,n,s=null,o=null,i=null){let l=r[t]||null,a=l&&l.gate?l.gate:null,d=l&&l.pr?l.pr:null,h=[],m=i?i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":null,k=zl(a&&a.gate_badge||"",m?null:o&&o.activity||null);m&&h.push(m),k.label&&h.push(k.label),a&&a.base_badge&&a.base_badge!==a.gate_badge&&h.push(a.base_badge),n&&h.push("\uC815\uB9AC \uC2E4\uD328");let $=!!a&&a.base_badge==="\uCDA9\uB3CC",v=!!a&&a.enabled===!0,L=Hl(o&&o.merge_progress?o.merge_progress.step:null),P=!!n&&!!a&&a.tier==="merged";return{id:t,title:e,reason:n?"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644":"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",pr_number:d&&typeof d.number=="number"?d.number:null,pr_url:d&&typeof d.url=="string"?d.url:"",badges:h,live_badge:i==="running"?m:m?null:k.live?k.label:null,usage:s,alert:!!a&&ql.includes(a.tier)||!!n,merge_action:!0,discard_action:!n&&!(a&&a.tier==="merged"),merge_step:L,discard_enabled:!L&&!i,discard_title:i?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 \uC138\uC158\uC744 \uC815\uB9AC\uD558\uC138\uC694":void 0,merge_enabled:!L&&!i&&(v||$||P),merge_label:$&&!L&&!P?"\uCDA9\uB3CC \uD574\uC18C":void 0,merge_title:L?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${L.label}`:i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":P?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uC218\uD589\uD569\uB2C8\uB2E4":$?"\uCDA9\uB3CC \u2014 \uD074\uB9AD\uD558\uBA74 \uCDA9\uB3CC \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 (\uBA38\uC9C0\uD558\uC9C0 \uC54A\uC74C)":v?`\uBA38\uC9C0 (${a.gate_badge}) \u2014 \uD074\uB9AD \uC2DC\uC810\uC5D0 \uB2E4\uC2DC \uD655\uC778\uD569\uB2C8\uB2E4`:a&&a.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${a&&a.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Hn(t,e={}){let{transport:r,issueStores:n,queueStore:s,sessionLogStore:o,uiOrderStore:i,gotoIssue:l,getWorkspacePath:a}=e,d=n?$r(n,i):null,h=xr({transport:r,uiOrderStore:i}),m=null,k=[],$=Al(),v=Il(),L=Ml(),P=!1,B=new Set,q=[],G=document.createElement("div");G.className="worker-console";let N=document.createElement("div");N.className="worker-top";let E=document.createElement("div");E.className="worker-drawer-overlay",E.hidden=!0;let C=document.createElement("div");C.className="worker-drawer-overlay__backdrop";let x=document.createElement("div");x.className="worker-drawer-host",E.append(C,x);let _=document.createElement("div");_.className="worker-lanes-host",G.append(N,E,_),t.appendChild(G);let O=null,F=Ar(x,{transport:r,sessionLogStore:o,onClose:()=>{O=null,E.hidden=!0,de()}}),W=No(G,{queueStore:s,transport:r,getWorkspacePath:a});function V(){return s&&s.get()||{revision:0,auto_advance:!1,slots:Ur,queue:[],pr_wait:[],done:[]}}function ne(){let c=V();return typeof c.revision=="number"?c.revision:0}function se(c){c&&c.queue&&s&&s.set(c.queue)}function $e(){let c=V().queue;return Array.isArray(c)?c.length:0}async function Ge(c,f){if(!r)return;let y=await r("worker-queue-place",{bead_id:c,index:f,expected_revision:ne()});se(y),y&&y.conflict&&await r("worker-queue-place",{bead_id:c,index:f,expected_revision:ne()}).then(se)}async function ze(c,f){if(!r)return;let y=await r("worker-queue-reorder",{bead_id:c,to_index:f,expected_revision:ne()});se(y),y&&y.conflict&&await r("worker-queue-reorder",{bead_id:c,to_index:f,expected_revision:ne()}).then(se)}async function ke(c){if(!r)return;let f=await r("worker-queue-remove",{bead_id:c,expected_revision:ne()});se(f),f&&f.conflict&&await r("worker-queue-remove",{bead_id:c,expected_revision:ne()}).then(se)}async function xe(c){!r||!c||await r("worker-attempt-stop",{attempt_id:c})}async function je(c){if(!r||!c)return;let f=await r("worker-attempt-pause",{attempt_id:c});f&&f.paused===!1&&f.reason&&Q(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${f.reason}`,"error",2400)}async function ce(c){if(!r||!c)return;let f=await r("worker-attempt-resume",{attempt_id:c,expected_revision:ne()});se(f),f&&f.conflict&&(f=await r("worker-attempt-resume",{attempt_id:c,expected_revision:ne()}),se(f)),f&&f.resumed===!1&&!f.conflict&&f.reason&&Q(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${f.reason}`,"error",2400)}async function lt(c){if(!r||!c)return;let f=await r("worker-attempt-dismiss",{attempt_id:c,expected_revision:ne()});se(f),f&&f.conflict&&(f=await r("worker-attempt-dismiss",{attempt_id:c,expected_revision:ne()}),se(f)),f&&f.dismissed===!1&&!f.conflict&&f.reason&&Q(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${f.reason}`,"error",2400)}async function pe(c){if(!r||!c)return;B.add(c),de();let f;try{f=await r("worker-pr-merge",{bead_id:c,expected_revision:ne()}),se(f),f&&f.conflict&&(f=await r("worker-pr-merge",{bead_id:c,expected_revision:ne()}),se(f))}finally{B.delete(c),de()}if(!(!f||f.conflict)){if(f.action==="conflict_resolution"){Q(f.ok?"\uCDA9\uB3CC \u2014 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 (\uBA38\uC9C0\uD558\uC9C0 \uC54A\uC74C)":`\uCDA9\uB3CC \uD574\uC18C \uB514\uC2A4\uD328\uCE58 \uC2E4\uD328: ${f.reason||""}`,f.ok?"success":"error",2800);return}if(f.ok){Q("\uBA38\uC9C0 + \uC815\uB9AC \uC644\uB8CC","success",2e3);return}Q(f.cleanup_step?`\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uC2E4\uD328(${f.cleanup_step}): ${f.reason||""}`:`\uBA38\uC9C0 \uAC70\uBD80: ${f.reason||""}`,"error",3200)}}async function Ye(c){if(!r||!c||!(typeof globalThis.confirm!="function"||globalThis.confirm(`${c}: PR\uC744 \uB2EB\uACE0 \uC6CC\uD06C\uD2B8\uB9AC/\uBE0C\uB79C\uCE58\uB97C \uD3D0\uAE30\uD569\uB2C8\uB2E4. \uB418\uB3CC\uB9B4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uB2E4\uC2DC \uC2E4\uD589\uD558\uB824\uBA74 \uD6C4\uBCF4 \uB808\uC778\uC5D0\uC11C \uB300\uAE30 \uB808\uC778\uC73C\uB85C \uC62E\uAE30\uC138\uC694. \uACC4\uC18D\uD560\uAE4C\uC694?`)))return;let y=await r("worker-pr-discard",{bead_id:c,expected_revision:ne()});if(se(y),y&&y.conflict&&(y=await r("worker-pr-discard",{bead_id:c,expected_revision:ne()}),se(y)),y&&y.discarded===!0){Q("\uD3D0\uAE30 \uC644\uB8CC \u2014 \uD6C4\uBCF4 \uB808\uC778\uC5D0\uC11C \uB2E4\uC2DC \uC2E4\uD589\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4","success",2400);return}y&&y.discarded===!1&&!y.conflict&&Q(`\uD3D0\uAE30 \uAC70\uBD80: ${y.reason||""}`,"error",2800)}async function ie(c){if(!r)return;let f=await r("worker-queue-toggle",{on:c,expected_revision:ne()});se(f),f&&f.conflict&&await r("worker-queue-toggle",{on:c,expected_revision:ne()}).then(se)}async function Me(c){if(!r||!Number.isFinite(c))return;let f=Math.max(Ur,Math.floor(c)),y=await r("worker-queue-set-slots",{slots:f,expected_revision:ne()});se(y),y&&y.conflict&&await r("worker-queue-set-slots",{slots:f,expected_revision:ne()}).then(se)}function Qe(){let c=V(),f=d?d.selectBoardColumn(Sl,"ready"):[],y=d?d.selectBoardColumn(Tl,"blocked"):[],g=new Map;for(let S of[...f,...y])g.set(S.id,S.title||S.id);let A=c.pr_wait||[],T=c.pr_observations||{},R=c.pr_activity||{},K=c.cleanup_failed||{},te=Object.entries(K).map(([S,H])=>({bead_id:S,step:H&&H.step?H.step:"",reason:H&&H.reason?H.reason:"",detail:H&&typeof H.detail=="string"?H.detail:null,output_tail:H&&typeof H.output_tail=="string"&&H.output_tail?H.output_tail:void 0})),U=c.queue||[],be=new Set([...U.map(S=>S.bead_id),...A.map(S=>S.bead_id),...c.done.map(S=>S.bead_id)]),ee=new Set(y.map(S=>S.id)),he=i?i.get()?.order||{}:{},pt=new Set,et=[];for(let S of[...f,...y])be.has(S.id)||pt.has(S.id)||Fl(S)||(pt.add(S.id),et.push(S));k=Pl(et,v,he);let bt=c.admission||{},wt=S=>{let H=bt[S];if(!H)return"";if(H.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let X=typeof H.reason=="string"?H.reason:"",ge=X.indexOf(":");return ge>0&&ge<X.length-1?`\u26D4 ${X.slice(0,ge)} (${X.slice(ge+1)})`:`\u26D4 ${X}`},b=k.map(S=>{let H=zn(S),X=ee.has(S.id),ge=[];X&&ge.push(Bl(S)),H||ge.push("spec \uC5C6\uC74C");let rt=wt(S.id);return rt&&ge.push(rt),{id:S.id,title:S.title||S.id,reason:ge.join(" \xB7 "),draggable:H,lane:"candidate",workflow:S.workflow,status:S.status,blocked:X,has_spec:H}}),w=Cl(b,$),Z=w.visible,Y=(S,H)=>S.map(X=>({id:X.bead_id,title:g.get(X.bead_id)||X.bead_id,reason:H==="done"?"":wt(X.bead_id),draggable:H!=="done",done:H==="done",lane:H,usage:H==="done"?Pn(c.attempts||{},X.bead_id):null})),J=c.attempts?Object.values(c.attempts):[],fe=new Set;for(let S of J)S&&typeof S.resumed_from=="string"&&S.resumed_from.length>0&&fe.add(S.resumed_from);let kt=new Map;for(let S of J)kt.set(S.bead_id,S.attempt_id);let hr=new Map;for(let S of J)hr.set(S.attempt_id,S);function tt(S){let H=new Set,X=S;for(;X&&!H.has(X.attempt_id);){if(X.conflict_resolution===!0)return!0;H.add(X.attempt_id),X=typeof X.resumed_from=="string"&&X.resumed_from.length>0&&hr.get(X.resumed_from)||null}return!1}let Ze=[],Xe=null;for(let S of J){let H=S.status==="paused"&&!fe.has(S.attempt_id);S.status==="running"||H?Ze.push({bead_id:S.bead_id,attempt_id:S.attempt_id,title:g.get(S.bead_id)||S.bead_id,runner:S.runner||null,model:S.model||null,effort:S.effort||null,started_at:typeof S.started_at=="number"?S.started_at:null,resumed_from:S.resumed_from||null,paused:H,conflict_resolution:tt(S),can_pause:typeof S.session_id=="string"&&S.session_id.length>0,usage:S.usage||null}):(S.status==="failed"||S.status==="orphaned")&&!(kt.get(S.bead_id)!==S.attempt_id)&&typeof S.dismissed_at!="number"&&(Xe=S)}let Ht=null;if(Xe){let S=typeof Xe.session_id=="string"&&Xe.session_id.length>0,H=fe.has(Xe.attempt_id),X=Xe.cause_detail;Ht={repo:Xe.repo||"",reason:Xe.cause||Xe.status,cause_detail:X&&typeof X.reason=="string"?{reason:X.reason,command:typeof X.command=="string"?X.command:null}:null,resume_attempt_id:Xe.attempt_id,resume_eligible:S&&!H,resume_reason:S?H?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let Wt=new Set(Ze.map(S=>S.bead_id)),yt=new Map;for(let S of Ze)S.conflict_resolution&&(S.paused?yt.has(S.bead_id)||yt.set(S.bead_id,"paused"):yt.set(S.bead_id,"running"));let Gt=Ze.filter(S=>!S.paused).length,jt=(c.workspace_info||{}).slots,Yt=typeof jt=="number"?jt:typeof c.slots=="number"?c.slots:Ur,gr=Gt>Yt,mr=Y(c.done,"done"),j=0,p=0,D=!1;for(let S of mr){let H=S.usage;H&&typeof H=="object"&&(Number.isFinite(H.input_tokens)&&(j+=H.input_tokens,D=!0),Number.isFinite(H.output_tokens)&&(p+=H.output_tokens,D=!0))}let z=D?zt({input_tokens:j,output_tokens:p}):null;return{queue:c,idToTitle:g,candidates:Z,candidate_hidden:{blocked:w.hidden_blocked,spec:w.hidden_spec},running:Ze,live_count:Gt,slots:Yt,over_cap:gr,failure:Ht,waiting:Y(U.filter(S=>!Wt.has(S.bead_id)),"queue"),pr_wait:A.map(S=>Wl(S.bead_id,g.get(S.bead_id)||S.bead_id,T,K[S.bead_id]||null,Pn(c.attempts||{},S.bead_id),R[S.bead_id]||(B.has(S.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),yt.get(S.bead_id)||null)),done:mr,token_total:z,cleanup_failures:te}}function Se(c){let f=c.waiting.length>0?c.waiting[0].id:"\u2014",y=u`<button
      type="button"
    ...
    >
      ...
      .value=${v}
    >
      ${Ll.map(c=>u`<option value=${c.value} ?selected=${v===c.value}>
            ${c.label}
          </option>`)}
    </select>`}function Ve(c){let f=mt({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4 \xB7 Board \uC5F0\uB3D9",items:c.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Ne(),controls:ye(c)});return P?u`<div class="worker-lanes worker-lanes--mobile">
        ${Ee(c)}
        ${mt({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:c.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:L.queue,preview:qo(c.waiting)})}
        ${f}
        ${mt({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:c.done,empty:"\uC644\uB8CC \uC5C6\uC74C",collapsible:!0,collapsed:L.done,preview:c.token_total||qo(c.done)})}
      </div>`:u`<div class="worker-lanes">
      ${f}
      ${mt({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:c.waiting,empty:"\uB4DC\uB798\uADF8\uB85C \uBC30\uCE58"})}
      ${mt({id:"worker-pane-running",lane:"running",title:`\uC2E4\uD589 \uC911 \xB7 \uC2AC\uB86F ${c.slots}`,items:c.running,live:c.running.some(y=>!y.paused),body:Bn(c.running,Date.now(),O)})}
      ${mt({id:"worker-pane-pr-wait",lane:"pr_wait",title:"PR \uB300\uAE30",items:c.pr_wait,empty:"PR \uB300\uAE30 \uC5C6\uC74C"})}
      ${mt({id:"worker-pane-done",lane:"done",title:`\uC644\uB8CC \xB7 \uC624\uB298 ${c.done.length}`,items:c.done,empty:"\uC644\uB8CC \uC5C6\uC74C"})}
    </div>`}function Ce(c){L={...L,[c]:!L[c]},Nl(L),de()}function de(){let c=Qe();le(Se(c),N),le(Ve(c),_)}function Re(){let c=document.querySelector(".app-header");if(!c)return;let f=()=>{let y=Math.round(c.getBoundingClientRect().height);G.style.setProperty("--worker-ribbon-top",`${y}px`)};if(f(),typeof ResizeObserver=="function"){let y=new ResizeObserver(f);y.observe(c),q.push(()=>y.disconnect())}else window.addEventListener("resize",f),q.push(()=>window.removeEventListener("resize",f))}function He(){if(typeof window.matchMedia!="function")return;let c=window.matchMedia(Ol);P=!!c.matches;let f=y=>{let g=!!(y&&typeof y.matches=="boolean"?y.matches:c.matches);g!==P&&(P=g,de())};typeof c.addEventListener=="function"?(c.addEventListener("change",f),q.push(()=>c.removeEventListener("change",f))):typeof c.addListener=="function"&&(c.addListener(f),q.push(()=>c.removeListener(f)))}function _e(c){let f=c.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!f)return;let y=f.dataset.beadId||"",g=f.dataset.lane||"";m={bead_id:y,from_lane:g};try{c.dataTransfer?.setData("text/plain",y),c.dataTransfer&&(c.dataTransfer.effectAllowed="move")}catch{}}function Te(c){let f=c.target?.closest?.(".worker-pane");if(!f)return;let y=f.dataset.lane||"";y!=="candidate"&&y!=="queue"||(c.preventDefault(),c.dataTransfer&&(c.dataTransfer.dropEffect="move"),f.classList.add("worker-pane--drag-over"))}function Pe(c){c.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function Oe(c,f){let y=k.find(R=>R.id===c);if(!y)return;let g=k.filter(R=>R.id!==c),A=g.length;if(f){let R=f.dataset.beadId;if(R===c)return;let K=g.findIndex(te=>te.id===R);K>=0&&(A=K)}let T=g.slice();T.splice(A,0,y),h.applyReorder(c,T,A)}function Ke(c){let f=c.target?.closest?.(".worker-pane");if(!f)return;c.preventDefault(),f.classList.remove("worker-pane--drag-over");let y=f.dataset.lane||"",g=m?.bead_id||c.dataTransfer?.getData("text/plain")||"",A=m?.from_lane||"";if(m=null,!g)return;let T=c.target?.closest?.(".worker-mini, .worker-card"),R=Array.from(f.querySelectorAll(".worker-mini, .worker-card")),K=R.length;if(T){let te=R.indexOf(T);te>=0&&(K=te)}if(f.classList.contains("worker-pane--collapsed")&&(K=$e()),y==="candidate"){if(A==="candidate"){Oe(g,T);return}A==="queue"&&ke(g);return}y==="queue"&&(A==="queue"?ze(g,K):Ge(g,K))}function Je(c){$=c,El(c),de()}function me(c){v=c==="board"||c==="created"||c==="spec"?c:zr,Dl(v),de()}function Le(c){let f=c.target?.closest?.(".worker-filter__blocked");if(f){Je({...$,show_blocked:f.checked});return}let y=c.target?.closest?.(".worker-sort");if(y){me(y.value||zr);return}let g=c.target?.closest?.(".worker-slots__input");if(!g)return;let A=Number.parseInt(g.value,10);if(!Number.isFinite(A)){de();return}Me(A).then(de)}function Ae(c){return c?{runner:c.runner||void 0,model:c.model||void 0,effort:c.effort||void 0,worktree:c.worktree||void 0,status:c.status||void 0,session_id:c.session_id||void 0}:{}}function Ie(c){let f=V(),y=f.attempts?f.attempts[c]:null;O=c,E.hidden=!1,F.open({attempt_id:c,meta:Ae(y)}),de()}function I(){if(!O)return;let c=V(),f=c.attempts?c.attempts[O]:null;if(f){F.updateMeta(Ae(f));return}F.close()}function M(c){let f=c.target;if(f?.closest?.("#worker-exec-defaults-dialog"))return;if(f?.closest?.(".worker-exec-defaults-btn")){W.open();return}let y=f?.closest?.(".worker-banner__resume");if(y){let ee=y.dataset.attemptId;ee&&ce(ee);return}let g=f?.closest?.(".worker-banner__dismiss");if(g){let ee=g.dataset.attemptId;ee&&lt(ee);return}if(f?.closest?.(".worker-play")){ie(!V().auto_advance);return}let A=f?.closest?.(".worker-pane__hd--toggle");if(A){let ee=A.dataset.lane;(ee==="queue"||ee==="done")&&Ce(ee);return}let T=f?.closest?.(".worker-card__place");if(T){let ee=T.dataset.beadId;ee&&!T.disabled&&Ge(ee,$e());return}let R=f?.closest?.(".worker-filter__chip");if(R){let ee=R.dataset.spec;(ee==="all"||ee==="with"||ee==="without")&&Je({...$,spec:ee});return}let K=f?.closest?.(".worker-mini__merge");if(K){pe(K.dataset.beadId||"");return}let te=f?.closest?.(".worker-mini__discard");if(te){Ye(te.dataset.beadId||"");return}if(f?.closest?.(".worker-mini__pr"))return;if(f?.closest?.(".rtile__stop")){let he=f?.closest?.(".rtile")?.dataset?.attemptId;he&&xe(he);return}if(f?.closest?.(".rtile__pause")){let he=f?.closest?.(".rtile")?.dataset?.attemptId;he&&je(he);return}if(f?.closest?.(".rtile__resume")){let he=f?.closest?.(".rtile")?.dataset?.attemptId;he&&ce(he);return}if(f?.closest?.(".rtile__session")){let he=f?.closest?.(".rtile")?.dataset?.attemptId;he&&Ie(he);return}if(f?.closest?.(".worker-drawer-overlay__backdrop")){F.close();return}if(f?.closest?.(".worker-drawer-host"))return;let U=f?.closest?.(".rtile");if(U){if(f?.closest?.(".rtile__id")){let he=U.dataset.beadId;he&&Rt(he).then(pt=>{pt?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let ee=U.dataset.beadId;ee&&l&&l(ee);return}let be=f?.closest?.(".worker-mini, .worker-card");if(be){let ee=be.dataset.beadId;if(f?.closest?.(".worker-mini__id, .worker-card__id")){ee&&Rt(ee).then(he=>{he?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}ee&&l&&l(ee)}}return t.addEventListener("dragstart",_e),t.addEventListener("dragover",Te),t.addEventListener("dragleave",Pe),t.addEventListener("drop",Ke),t.addEventListener("click",M),t.addEventListener("change",Le),He(),Re(),d&&q.push(d.subscribe(de)),s&&q.push(s.subscribe(()=>{de(),I()})),de(),{load(){de()},destroy(){for(let c of q.splice(0))try{c()}catch{}t.removeEventListener("dragstart",_e),t.removeEventListener("dragover",Te),t.removeEventListener("dragleave",Pe),t.removeEventListener("drop",Ke),t.removeEventListener("click",M),t.removeEventListener("change",Le);try{F.destroy()}catch{}E.hidden=!0;try{W.destroy()}catch{}le(u``,t)}}}function Wn(t){if(!t)return"Unknown";let e=t.split("/").filter(Boolean);return e.length>0?e[e.length-1]:"Unknown"}function Wo(t,e,r,n=async()=>{},s=async()=>{}){let o=we("views:workspace-picker"),i=null,l=!1,a=!1,d=!1;async function h(C){let _=C.target.value,F=e.getState().workspace?.current?.path||"";if(_&&_!==F){o("switching workspace to %s",_),l=!0,E();try{await r(_)}catch(W){o("workspace switch failed: %o",W)}finally{l=!1,E()}}}async function m(){let C=e.getState(),x=C.workspace?.current?.path||C.workspace?.available?.[0]?.path||"";if(!(!x||a)){o("git-pulling workspace %s",x),a=!0,E();try{await n(x)}catch(_){o("workspace git pull failed: %o",_)}finally{a=!1,E()}}}function k(C){let x=C.target;x&&t.contains(x)||L()}function $(C){C.key==="Escape"&&L()}function v(){d||(d=!0,document.addEventListener("mousedown",k),document.addEventListener("keydown",$),E())}function L(){d&&(d=!1,document.removeEventListener("mousedown",k),document.removeEventListener("keydown",$),E())}function P(){d?L():v()}async function B(C){let x=C.target,_=x.value,O=x.checked;o("toggling visibility %s \u2192 %s",_,String(O));try{await s(_,O)}catch(F){o("workspace visibility toggle failed: %o",F)}}function q(C){return C?u`
      <button
        type="button"
    ...
    `}function N(){let C=e.getState(),x=C.workspace?.current,_=C.workspace?.available||[],O=new Set(C.workspace?.hidden||[]),F=x?.path||_[0]?.path||"";if(_.length===0)return u``;let W=_.filter(V=>!O.has(V.path)||V.path===F);if(W.length<=1){let V=W[0]||_[0],ne=Wn(V.path);return u`
