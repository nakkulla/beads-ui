...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+br(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},Br=new kf;function at(e,t){return Br.parse(e,t)}at.options=at.setOptions=function(e){return Br.setOptions(e),at.defaults=Br.defaults,Ll(at.defaults),at};at.getDefaults=Ho;at.defaults=Ur;at.use=function(...e){return Br.use(...e),at.defaults=Br.defaults,Ll(at.defaults),at};at.walkTokens=function(e,t){return Br.walkTokens(e,t)};at.parseInline=Br.parseInline;at.Parser=tr;at.parser=tr.parse;at.Renderer=Os;at.TextRenderer=Jo;at.Lexer=er;at.lexer=er.lex;at.Tokenizer=Ls;at.Hooks=In;at.parse=at;var Ub=at.options,Wb=at.setOptions,zb=at.use,Hb=at.walkTokens,Gb=at.parseInline;var Vb=tr.parse,Kb=er.lex;function Tr(e){let t=at.parse(e),r=xl.sanitize(t);return Al(r)}function hr(e,t){return d`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      </div>`}if(F.kind==="error")return d`<div class="sv__error">⛔ ${F.text}</div>`;if(F.kind==="blocker")return d`<div class="sv__error">⛔ ${F.text}</div>`;if(F.kind==="tool"){let se=f.has(H),Ce=F.tool==="Bash"?qf(F.command):0,Be=F.tool==="Bash"?Ce>1?Ns(F.command):F.command:F.path||F.command||"";return d`<div
...
`)}function Ve(){if(!o)return d``;let H=B(),F=(a?[u.model,u.effort]:[u.runner,u.model,u.effort]).filter(Boolean).join(" \xB7 "),se=u.session_id||"",Ce=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${p?"ON":"OFF"}`,Be=de(),ze=Be?zf(oe(),Date.now()):"",Te=Be?nt(H):null,lt=Be?De(H):null,Ye=Wf(H);return d`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
`).trim()}}var Vl=20;function Kl(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function Zf(e){return e.length>Vl?`${e.slice(0,Vl)}\u2026`:e}function Xf(e,t,r,n){let s=`${t.lane} ${Zf(t.identifier)}`;return d`<div class="detail-report">
  ...
  >
    ...
    `:d``}function p(){Qe(u(),e)}async function f(A,L={}){s=A,o="loading",a="",i="",p();let N=r?r():"";if(!N){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",i="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let V="/api/doc?workspace="+encodeURIComponent(N)+"&path="+encodeURIComponent(A);try{let K=await n(V),W=await K.json().catch(()=>({}));if(!K.ok||!W||W.ok!==!0){if(W?.error==="not_found"&&L.missing_state==="plan_pending"){o="pending",i="\uACC4\uD68D \uC791\uC131 \uC804 \xB7 \uACBD\uB85C\uB9CC \uC608\uC57D\uB418\uC5B4 \uC788\uC2B5\uB2C8\uB2E4",p();return}o="error",i="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(W&&W.error||K.status)+")",p();return}a=String(W.content||""),o="ready",p()}catch{o="error",i="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function h(){s=null,Qe(d``,e)}function R(){document.removeEventListener("keydown",c),h()}return{open:f,close:h,destroy:R}}var c_=[{key:"input_tokens",label:"\uC785\uB825"},{key:"output_tokens",label:"\uCD9C\uB825"},{key:"cache_read_input_tokens",label:"\uCE90\uC2DC \uC77D\uAE30"}],mc="\uC11C\uBC84 \uC7AC\uC2DC\uC791 \uBCF5\uAD6C \u2014 \uBD80\uBD84 \uC9D1\uACC4",Ks=["implementation","review-consult"],d_=["running","done","failed","interrupted"],u_={running:"\u25CF",done:"\u2713",failed:"\u2717",interrupted:"\u26A0"};function p_(e){return typeof e=="number"&&Number.isFinite(e)?e:0}function f_(e){let t=xt(e);if(t.length>0)return t.map(s=>d`<span class="detail-usage-total" title=${s.tooltip}
          >${s.label}</span
    ...
    ${n?d`<span class="detail-session__usage" title=${n.tooltip}
          >${n.label}</span
        >`:""}
  </div>`}function g_(e,t,r,n){let s=e.status==="running"?null:t,a=(s?xt({providers:{codex:{subtotal:s.subtotal,breakdown:s.usage,...s.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],i=e.status==="running"?ca(e.last_event_at):s?la(s.completed_at):"";return d`<button
    type="button"
  ...
  >
    ...
    >
      ...
      ${u.cause}
    </div>`},c=u=>{let p=_c(Lo(u));if(xt(p).length===0&&!sn(u.usage))return"";let f=s.has(u.attempt_id);return d`<button
      type="button"
    ...
    <div class="detail-sessions" data-seam="session-history">
      ${n.map(u=>{let p=Lo(u),f=_c(p),h=xt(f);return d`<div class="detail-session-row">
          <button
            type="button"
  ...
  </div>`}function B_(e,t,r=null){let n=e.failed===!0,s=!!e.paused,o=n?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):s?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?ba(t-e.started_at):"\u2014",a=ar(e),i=Sr(e),c=xt(e.usage),u=Qt(e.usage),p=e.conflict_resolution?s?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,f=e.base_exception||null,h=e.landing,R=e.attempt_id&&e.attempt_id===r,A=e.discard?.action?d`<button
        type="button"
...
${g.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(Me,ue)&&(M.blocked_by=Array.isArray(Me[ue])?Me[ue].filter(G=>typeof G=="string"&&G.length>0):[]),M};for(let z=0;z<je.length;z++){let Q=Te(je[z],"queue",z,je.length);if(!Q)continue;p.push(Q);let Re=R.get(B);Re?Re.push(Q):R.set(B,[Q])}let lt=[];for(let z=0;z<Ke.length;z++){let Q=Ke[z],Re=[];for(let ue=0;ue<Q.entries.length;ue++){let g=Te(Q.entries[ue],Q.id,ue,Q.entries.length);g&&(Re.push(g),p.push(g))}if(Re.length===0)continue;let Ue=At($e[Q.id]);lt.push({id:Q.id,index:z,items:Re,occupied_by:Array.isArray(Ue.occupied_by)?Ue.occupied_by.filter(ue=>typeof ue=="string"):[],corrections:Array.isArray(Ue.corrections)?Ue.corrections.length:0,cycle:Ue.cycle===!0})}A.set(B,lt);let Ye=Array.from({length:rt},(z,Q)=>{let Re=`s${Q+1}`,Ue=H.get(Re),ue=Ue&&Array.isArray(Ue.entries)?Ue.entries:[],g=At($e[Re]);return{id:Re,index:ue.length,length:ue.length,occupied_by:Array.isArray(g.occupied_by)?g.occupied_by.filter($=>typeof $=="string"):[]}});for(let z of Array.isArray(k.runnable)?k.runnable:[]){let Q=z&&z.bead_id;typeof Q!="string"||ze.has(Q)||(ze.add(Q),i.push({...Be(Q),title:z.title||Oe[Q]||Q,lane:"runnable",draggable:!0,reason:Wc(De,Q),created_at:z.created_at??void 0,updated_at:z.updated_at??void 0,labels:Array.isArray(z.labels)?z.labels:[],spec_reviewer:typeof z.spec_reviewer=="string"?z.spec_reviewer:void 0,plan_state:z.plan_state==="approved"||z.plan_state==="authored"?z.plan_state:"none",workflow:z.route?{route:z.route,chips:{route:z.route}}:null,blocked:z.blocked===!0,...Array.isArray(z.blocked_by)?{blocked_by:z.blocked_by.filter(Re=>typeof Re=="string"&&Re.length>0)}:{},place_index:je.length,place_lanes:Ye}))}for(let z of se){let Q=z&&z.bead_id;if(typeof Q!="string"||ze.has(Q)||(ze.add(Q),o!==void 0&&typeof z.added_at=="number"&&z.added_at<o))continue;let Re=H_(re,Q);f.push({...Be(Q),lane:"done",done:!0,usage:Wt(re,Q),done_at:typeof z.added_at=="number"?z.added_at:void 0,done_kind:Re&&typeof Re.done_kind=="string"?Re.done_kind:null})}}let N=new Map;s.forEach((k,B)=>{k&&typeof k.root_dir=="string"&&N.set(k.root_dir,B)});let V=r&&r.running_sort==="repo"?"repo":"started";c.sort((k,B)=>{if(V==="repo"){let te=N.get(k.root_dir)??Number.MAX_SAFE_INTEGER,re=N.get(B.root_dir)??Number.MAX_SAFE_INTEGER;if(te!==re)return te-re}let oe=typeof k.started_at=="number"&&Number.isFinite(k.started_at)?k.started_at:null,de=typeof B.started_at=="number"&&Number.isFinite(B.started_at)?B.started_at:null;return oe!==null&&de!==null&&oe!==de?oe-de:oe===null&&de!==null?1:oe!==null&&de===null?-1:k.id.localeCompare(B.id)}),f.sort((k,B)=>(B.done_at??0)-(k.done_at??0));let K=s.length>0?s:n.map(k=>({root_dir:k&&k.root_dir,name:k&&k.name,auto_advance:k&&k.auto_advance,auto_merge:k&&k.auto_merge,slots:k&&k.slots,revision:k&&k.revision,runner_catalog:k&&k.runner_catalog})),W=[];for(let k of K){if(!k||typeof k.root_dir!="string")continue;let B=R.get(k.root_dir)||[],oe=A.get(k.root_dir)||[];W.push({root_dir:k.root_dir,name:k.name||k.root_dir,auto_advance:k.auto_advance===!0,auto_merge:k.auto_merge===!0,slots:typeof k.slots=="number"&&k.slots>=Wn?k.slots:Wn,revision:typeof k.revision=="number"?k.revision:0,runner_catalog:At(k.runner_catalog),items:B,sublanes:{parallel:B,serial:oe},serial_lane_count:L.get(k.root_dir)||0})}let I={runnable:i,queue:p,queue_groups:W,running:c,pr_wait:u,done:f,automation:{total:W.length,both_on:W.filter(k=>k.auto_advance&&k.auto_merge).length}},S=pa(I);for(let k of h)S.has(k.id)||S.set(k.id,{root_dir:k.root_dir,workspace_name:k.workspace_name,lane:"done",state:"done"});for(let k of[...I.queue,...I.runnable]){if(!Object.hasOwn(k,"blocked_by"))continue;let B=S.get(k.id);k.blockers=(k.blocked_by||[]).map(oe=>xc(oe,B,S,s)),k.blocker_warnings=k.blockers.filter(oe=>oe.missing_internal).map(oe=>`\u26A0 \uC120\uD589 ${oe.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),k.blocker_warnings.length>0&&(k.alert=!0)}let P=Ac(I.queue_groups);for(let k of I.queue_groups)for(let B of k.sublanes.serial){let oe=P.get(Ec(k.root_dir,B.id));oe&&(B.cross_wait_peers=oe)}return I}function V_(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<U_;return d`<span
  ...
  >`}function no(e){return e.workspace_name?d`<span class="mon-c__repo" title=${e.root_dir||""}
        >${e.workspace_name}</span
      >`:""}function ka(e){let t=xt(e.usage),r=Qt(e.usage);return t.length>0?t.map(n=>d`<span class="mon-c__usage" title=${n.tooltip}
          >${n.label}</span
    ...
    <div class="mon-c__meta">
      ...
      ${ka(e)}${K_(e)}${vr(e)}
    </div>`}function Z_(e){let t=e.workflow,n=(t&&t.chips||{}).route||t&&t.route,s=typeof e.spec_reviewer=="string"?e.spec_reviewer:"",o=e.plan_state==="approved"?"plan \u2713":e.plan_state==="authored"?"plan \u270E":"plan \u2013",a=typeof e.reason=="string"&&e.reason.startsWith("\u26D4"),i=Nt(e.updated_at);return d`${zn(e)}
    <div class="mon-c__meta">
    ...
    ${r?d`<div class="mon-c__tail">
          ...
          ${vr(e)}
        </div>`:""}`}function J_(e,t){let r=e.done_kind||"",n=r?W_[r]||r:"",s=Nt(e.done_at,t);return d`${zn(e)}
    <div class="mon-c__meta">
      ${Hn(e)}${no(e)}
      ${n?d`<span
  ...
  `}var pm=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}],qt="";function Ft(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function ud(e,t){let{transport:r,policyStore:n,labelOptions:s}=t,o=t.notify||(g=>ie(g,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,u="",p={},f={},h=[],R=!1,A=null,L={},N="",V="",K=!1,W=!1,I=!1,S=null;function P(){let g=t.queueStore?.get();return Ft(g)?g.runner_catalog:null}function k(){let g=t.queueStore?.get();return Ft(g)&&Ft(g.execution_defaults)?g.execution_defaults:null}function B(){let g=t.implPresetStore?.get();return Ft(g)&&Array.isArray(g.presets)?g:null}async function oe(){R=!0,Te();try{let g=await r("get-session-defaults",{});p=Ft(g?.values)?{...g.values}:{},f={...p},h=Array.isArray(g?.warnings)?g.warnings:[]}catch(g){h=["kv_read_failed"],o(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${g instanceof Error?g.message:String(g)}`)}finally{R=!1,Te()}}async function de(){let g=tc(p,f);if(Object.keys(g).length!==0){try{let $=await r("set-session-defaults",{values:g});p=Ft($?.values)?{...$.values}:{},f={...p},h=Array.isArray($?.warnings)?$.warnings:[]}catch($){o(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${$ instanceof Error?$.message:String($)}`)}Te()}}function te(g,$){$===qt?delete f[g]:f[g]=$,Te(),de()}async function re(){let g=t.queueStore?.get();if(!Ft(g))return;let $={orchestration_model:g.orchestration_model??null,orchestration_effort:g.orchestration_effort??null,orchestration_speed:g.orchestration_speed??null},x=rc($,{...$,...L});if(Object.keys(x).length!==0){try{let M=await r("worker-queue-set-orchestration-defaults",{expected_revision:g.revision,values:x});if(M&&M.applied===!1){o("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}L={}}catch(M){o(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${M instanceof Error?M.message:String(M)}`)}Te()}}function Oe(g,$){L[g]=$===qt?null:$,Te(),re()}async function nt(g){let $=t.queueStore?.get();if(!(!Ft($)||g<1)){try{await r("worker-queue-set-slots",{expected_revision:$.revision,slots:g})}catch(x){o(`slots \uC800\uC7A5 \uC2E4\uD328: ${x instanceof Error?x.message:String(x)}`)}Te()}}function De(){let g={},$=je();for(let x of Ql){let M=Cr.includes(x)?$[x]:f[x];typeof M=="string"&&M.length>0&&(g[x]=M)}return g}async function ot(){let g=B();if(!g)return;let $=De();if(Object.keys($).length===0){o("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let x=(g.presets||[]).find(G=>G.id===N),M=V.trim()||(x?x.name:"");if(!M){o("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let G=x?await r("impl-preset-update",{expected_revision:g.revision,id:x.id,name:M,settings:$}):await r("impl-preset-create",{expected_revision:g.revision,name:M,settings:$});if(G&&G.applied){if(V="",!x&&Array.isArray(G.presets)){let Y=G.presets.find(ne=>ne.name===M);N=Y?Y.id:N}Te()}else o("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Te()}catch(G){o(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${G instanceof Error?G.message:String(G)}`)}}async function it(){let g=B();if(!(!g||N.length===0))try{let $=await r("impl-preset-delete",{expected_revision:g.revision,id:N});$&&$.applied?(N="",Te()):(o("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Te())}catch($){o(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${$ instanceof Error?$.message:String($)}`)}}async function Ve(){let g=B(),$=t.queueStore?.get();if(!(!g||!Ft($)||N.length===0)){try{let x=await r("apply-impl-preset-global",{preset_id:N,expected_revision:g.revision,expected_queue_revision:$.revision});x&&x.applied?(p=Ft(x.values)?{...x.values}:{},f={...p},h=Array.isArray(x.warnings)?x.warnings:[],Ft(x.queue)&&(t.queueStore?.set?.(x.queue),L={}),x.queue_applied===!1&&o("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694")):x&&x.conflict&&o("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(x){o(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${x instanceof Error?x.message:String(x)}`)}Te()}}async function he(){W=!0,I=!1,Te();try{let g=await r("get-worker-system-prompt",{});!g||typeof g!="object"||Array.isArray(g)?I=!0:S=g}catch{I=!0}finally{W=!1,Te()}}function Me(){if(K=!K,K&&!S){he();return}Te()}function _e(){let g=ln({loading:W,error:I});if(g)return g;if(!S)return"";let $=Array.isArray(S.variants)?S.variants:[];return d`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${K?_e():""}
    </section>`}function Ee(g,$,x,M,G,Y){let ne=G[g]??qt,ce=na(g,x,G,k(),P()),qe=ce.options.find(xe=>xe.value===ne),me=ne===qt?ce.full_value:qe?.full_value;return d`<select
    ...
    </div>`}function je(){let g=t.queueStore?.get(),$={};for(let x of Cr)$[x]=Object.prototype.hasOwnProperty.call(L,x)?L[x]:Ft(g)&&typeof g[x]=="string"?g[x]:null;return $}function Ke(){let g=P(),$=ec(f),x=f.impl_runtime,M=f.impl_model,G=B(),Y=t.queueStore?.get(),ne=je(),ce=Gs(g,A),qe=cn(g,A||void 0,ne.orchestration_model||lr).filter(Ae=>Ae!==lr),me=Ft(Y)&&typeof Y.slots=="number"?Y.slots:2,xe=k()?.supported===!0,Le=na("workflow_mode",Dn,f,k(),g);return d`
      <section
    ...
    `}function $e(){let g=n.get();return d`
      ...
      >
        ...
        ${g?d`
              ${ld(g,s(),se)}
              ${cd(g,u,{onDraft:$=>{u=$},onAdd:Ce,onRemove:Be})}
              ${dd(g,ze)}
            `:d`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function rt(g){let $=n.get();if($)try{let x=await r("display-policy-set",{expected_revision:$.revision,policy:g($)});H(x),x&&x.conflict&&x.policy&&(x=await r("display-policy-set",{expected_revision:x.policy.revision,policy:g(x.policy)}),H(x)),x&&x.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function H(g){g&&g.policy&&typeof g.policy=="object"&&n.set(g.policy)}function F(g){rt(g)}function se(g){let $=n.get();if(!$)return;let x=!fm(g,$);F(M=>_m(g,M,x))}function Ce(){let g=u.trim();g.length!==0&&(u="",F($=>$.hidden_prefixes.includes(g)?{hidden_prefixes:$.hidden_prefixes}:{hidden_prefixes:[...$.hidden_prefixes,g]}),Te())}function Be(g){F($=>({hidden_prefixes:$.hidden_prefixes.filter(x=>x!==g)}))}function ze(g){let $=n.get();if(!$)return;let x=$.chips[g]===!1;F(()=>({chips:{[g]:x}}))}function Te(){Qe(d`
...
${Ct.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:q==="done"?Wt(l.attempts||{},le.bead_id):null,work_ms:q==="done"?vc(l.attempts||{},le.bead_id):null,done_at:q==="done"&&typeof le.added_at=="number"?le.added_at:void 0,...Xe(le.bead_id)}}),Kr=l.attempts?Object.values(l.attempts):[],co=new Set;for(let b of Kr)b&&typeof b.resumed_from=="string"&&b.resumed_from.length>0&&co.add(b.resumed_from);let Na=new Map;for(let b of Kr)Na.set(b.bead_id,b.attempt_id);let Zn=new Map;for(let b of Kr)Zn.set(b.attempt_id,b);function uo(b){let q=new Set,le=b;for(;le&&!q.has(le.attempt_id);){if(le.conflict_resolution===!0)return!0;q.add(le.attempt_id),le=typeof le.resumed_from=="string"&&le.resumed_from.length>0&&Zn.get(le.resumed_from)||null}return!1}let Xn=typeof l.declared_base=="string"?l.declared_base:null;function Qd(b){let q=null;for(let le of Kr)!le||le.bead_id!==b||uo(le)||(q===null||(typeof le.started_at=="number"?le.started_at:0)>=(typeof q.started_at=="number"?q.started_at:0))&&(q=le);return q&&typeof q.target_base=="string"?q.target_base:null}let qa=[],Fa=[],Jd=md(l),ja=b=>{let q=typeof b.session_id=="string"&&b.session_id.length>0,le=co.has(b.attempt_id);return{eligible:q&&!le,reason:q?le?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Vt=null;for(let b of Kr){let q=b.status==="paused"&&!co.has(b.attempt_id);if(b.status==="running"||q)Fa.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:y.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,paused:q,conflict_resolution:uo(b),base_exception:Ia(Xn,b.target_base),can_pause:typeof b.session_id=="string"&&b.session_id.length>0,discard:cr(Yn,b.bead_id,{attempt_id:b.attempt_id}),usage:Wt(l.attempts||{},b.bead_id),current_child:pe(b.bead_id),...Xe(b.bead_id)});else if((b.status==="failed"||b.status==="orphaned")&&Jd(b)){let le=ja(b);qa.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:y.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,failed:!0,status:b.status,status_label:b.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:cr(Yn,b.bead_id,{attempt_id:b.attempt_id}),resume_eligible:le.eligible,resume_reason:le.reason,conflict_resolution:uo(b),base_exception:Ia(Xn,b.target_base),usage:Wt(l.attempts||{},b.bead_id),current_child:pe(b.bead_id),...Xe(b.bead_id)}),Vt=b}}let Qn=[...qa,...Fa].map(b=>{let q=Zn.get(b.attempt_id),le=q?.quickfix_landing;if(q?.quickfix_lane!==!0||!le||typeof le!="object")return b;let We=typeof le.reason=="string"&&le.reason.length>0?le.reason:null,pt=Un({bead_id:q.bead_id,merge_sha:le.head_sha,cleanup_cursor:le.cursor,cleanup_failed:We?{step:le.cursor,reason:We}:null,repo_operations:Array.isArray(l.repo_operations)?l.repo_operations:[]});return pt?{...b,landing:pt}:b}),Ba=null;if(Vt){let b=ja(Vt),q=Vt.cause_detail;Ba={bead_id:Vt.bead_id,repo:Vt.repo||"",reason:Vt.cause||Vt.status,cause_detail:q&&typeof q.reason=="string"?{reason:q.reason,command:typeof q.command=="string"?q.command:null}:null,resume_attempt_id:Vt.attempt_id,resume_eligible:b.eligible,resume_reason:b.reason,discard:cr(Yn,Vt.bead_id,{attempt_id:Vt.attempt_id})}}let Ua=new Set(Qn.map(b=>b.bead_id)),po=Array.isArray(l.merge_queue)?l.merge_queue:[],Wa=new Map,za=new Map,Ha=new Map,Ga=new Map,Va=new Map;po.forEach((b,q)=>{b&&typeof b.bead_id=="string"&&(Wa.set(b.bead_id,q+1),za.set(b.bead_id,b.resolution),Ha.set(b.bead_id,b.continuation_action||null),Ga.set(b.bead_id,b.head_review||null),Va.set(b.bead_id,b.authority||null))});let Yr=l.merge_queue_state||{active:null,failures:{}},eu=Yr.failures||{},Ka=Yr.waiting&&typeof Yr.waiting.bead_id=="string"&&typeof Yr.waiting.reason=="string"?Yr.waiting:null,tu=l.auto_merge_skips||{},Ya=b=>{let q=tu[b];if(!q)return null;let le=mt[b],We=le&&le.pr?le.pr.head_sha:null;return We&&We===q.head_sha?q.reason||"":null},Jn=new Map;for(let b of Qn)b.failed!==!0&&b.conflict_resolution&&(b.paused?Jn.has(b.bead_id)||Jn.set(b.bead_id,"paused"):Jn.set(b.bead_id,"running"));let Za=Qn.filter(b=>!b.paused&&b.failed!==!0).length,Xa=(l.workspace_info||{}).slots,Qa=typeof Xa=="number"?Xa:typeof l.slots=="number"?l.slots:oo,ru=Za>Qa,es=Nr(W),nu=(Array.isArray(l.done)?l.done.slice():[]).filter(b=>es===void 0||typeof b.added_at!="number"||b.added_at>=es).sort((b,q)=>(q.added_at||0)-(b.added_at||0)),fn=lo(nu,"done"),su=new Set((Array.isArray(l.done)?l.done:[]).map(b=>b?.bead_id).filter(b=>typeof b=="string")),Ja=[],ou=u?.()||"";for(let b of U){let q=jr(b.closed_at);if(typeof b.id!="string"||su.has(b.id)||q===null||es!==void 0&&q<es||typeof b.comment_count!="number"||b.comment_count<=0)continue;let le=`${ou}\0${b.id}\0${String(b.updated_at)}\0${b.comment_count}`,We=I.get(le);We===void 0&&r&&(I.set(le,"pending"),Promise.resolve(r("get-comments",{id:b.id})).then(pt=>{let Kt=Array.isArray(pt)&&pt.some(Ct=>Fs(typeof Ct?.text=="string"?Ct.text:"")?.lane==="session");I.set(le,Kt?"session":"not-session"),Z()}).catch(()=>{I.set(le,"failed"),Z()})),We==="session"&&Ja.push({id:b.id,title:b.title||b.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:q,created_at:b.created_at,updated_at:b.updated_at})}fn.push(...Ja),fn.sort((b,q)=>(q.done_at||0)-(b.done_at||0));let ts={};for(let b of _r)ts[b]=0;let ei=!1,ti=0,fo=0,ri=0;for(let b of fn){let q=b.usage;if(q&&typeof q=="object"){let le=!1;for(let We of _r)Number.isFinite(q[We])&&(ts[We]+=q[We],ei=!0,le=!0);le&&(fo+=1,Number.isFinite(q.total_cost_usd)&&(ti+=q.total_cost_usd,ri+=1))}}fo>0&&ri===fo&&(ts.total_cost_usd=ti);let ni=fn.map(b=>b.usage).filter(b=>b&&typeof b=="object"&&b.providers),au=ni.length>0?xt(xs(ni)):ei?Qt(ts):null,iu=l.lane_states&&typeof l.lane_states=="object"&&!Array.isArray(l.lane_states)?l.lane_states:{},lu=Array.isArray(l.serial_lanes)?l.serial_lanes:[],si=b=>{if(Pe.some(We=>We.bead_id===b))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let q=Kr.filter(We=>We&&We.bead_id===b),le=q.length>0?q[q.length-1].status:null;return le==="failed"||le==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":le==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},oi=lu.filter(b=>b&&typeof b.id=="string"&&Array.isArray(b.entries)).map((b,q)=>{let le=iu[b.id]||{},We=new Map((Array.isArray(le.corrections)?le.corrections:[]).filter(dt=>dt&&typeof dt.bead_id=="string"&&typeof dt.after=="string").map(dt=>[dt.bead_id,dt.after])),pt=lo(b.entries.filter(dt=>!Ua.has(dt.bead_id)),b.id).map(dt=>We.has(dt.id)?{...dt,badges:[`\u{1F517} ${We.get(dt.id)} \uB4A4 (blocks \uC790\uB3D9)`,...dt.badges]}:dt),Kt=Array.isArray(le.occupied_by)?le.occupied_by.filter(dt=>typeof dt=="string"):[],Ct=Kt.map(dt=>({id:dt,title:y.get(dt)||dt,draggable:!1,lane:b.id,ghost:!0,badges:[si(dt)]}));return{id:b.id,index:q+1,rows:[...Ct,...pt],occupied:Kt.length>0,badge:Kt.length>0?si(Kt[0]):"\uB300\uAE30",cycle:le.cycle===!0}}),cu=typeof l.serial_lane_count=="number"?l.serial_lane_count:oi.length;return{queue:l,idToTitle:y,candidates:Zd,candidate_hidden:{blocked:io.hidden_blocked,spec:io.hidden_spec},running:Qn,live_count:Za,slots:Qa,over_cap:ru,failure:Ba,waiting:lo(un.filter(b=>!Ua.has(b.bead_id)),"queue"),serial_lanes:oi,serial_lane_count:cu,pr_wait:Pe.map(b=>lg(b.bead_id,y.get(b.bead_id)||b.bead_id,mt,Gr[b.bead_id]||null,Wt(l.attempts||{},b.bead_id),sr[b.bead_id]||(B.has(b.bead_id)||oe.has(b.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Jn.get(b.bead_id)||null,b.external===!0,{position:Wa.get(b.bead_id)||0,active:Yr.active===b.bead_id,failure:eu[b.bead_id]||null,waiting:Ka?.bead_id===b.bead_id?Ka.reason:null,resolution:za.get(b.bead_id),continuation_action:Ha.get(b.bead_id),head_review:Ga.get(b.bead_id)||null,authority:Va.get(b.bead_id)||null},b.wt_present!==!1,l.auto_merge===!0?Ya(b.bead_id):null,Ia(Xn,Qd(b.bead_id)),l.completion_status&&typeof l.completion_status=="object"&&!Array.isArray(l.completion_status)&&l.completion_status[b.bead_id]||null,l.discard_operations&&typeof l.discard_operations=="object"&&!Array.isArray(l.discard_operations)?l.discard_operations:{},Zn.get(Na.get(b.bead_id)||"")?.worker_serial===!0,l.auto_merge===!0,{merge_sha:b.merge_sha,cleanup_cursor:b.cleanup_cursor,repo_operations:Array.isArray(l.repo_operations)?l.repo_operations:[]})).map(b=>({...b,...Xe(b.id)})),merge_queue_length:po.length,merge_queue_running:po.length>0,auto_excluded:Pe.map(b=>b.bead_id).filter(b=>Ya(b)!==null),declared_base:Xn,done:fn,token_total:au,cleanup_failures:Vn,repo_operations:Array.isArray(l.repo_operations)?l.repo_operations:[]}}function Ae(){let _=!!o?.get()?.job,E=!_&&o?.isPending?.()===!0,U=_?"\uBD84\uC11D \uC911":E?"\uC900\uBE44 \uC911":"";return d`<button
    ...
    >`,Ze=d`<label class="worker-tgl worker-slots"
      ...
      ${o?Ae():""} `,y=Dc({failure:l.failure}),v=wc(l.repo_operations,l.cleanup_failures);return k?d`<div class="worker-ribbon">
          ${E} ${U}
    ...
    >
      ...
      ${l.running.length>0?ha(l.running,Date.now(),Me):""}
    ...
    >
      ▶ 자동 머지${U>0?` ${U}`:""}
        ...
        ${_}
        ${rr({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:l.done,empty:`${S()} \uC644\uB8CC \uC5C6\uC74C`,controls:w(),collapsible:!0,collapsed:P.done,preview:Array.isArray(l.token_total)?l.token_total.map(E=>E.label).join(" \xB7 "):l.token_total||Rd(l.done)})}
      ...
      ${rr({id:"worker-pane-running",lane:"running",title:`\uC2E4\uD589 \uC911 \xB7 \uC2AC\uB86F ${l.slots}`,items:l.running,live:l.running.some(E=>!E.paused&&E.failed!==!0),body:ha(l.running,Date.now(),Me)})}
    ...
    `}function I(){let P=t.getState(),k=P.workspace?.current,B=P.workspace?.available||[],oe=new Set(P.workspace?.hidden||[]),de=k?.path||B[0]?.path||"";if(B.length===0)return d``;let te=B.filter(re=>!oe.has(re.path)||re.path===de);if(te.length<=1){let re=te[0]||B[0],Oe=Oa(re.path);return d`
