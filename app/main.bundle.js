...
`).trim()}}var qi=20;function Bi(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function np(e){return e.length>qi?`${e.slice(0,qi)}\u2026`:e}function sp(e,t,r,n){let s=`${t.lane} ${np(t.identifier)}`;return l`<div class="detail-report">
  ...
  `}function Tp(e){let t=Br(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?nr("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var Ep=["open","in_progress","deferred","resolved","closed"],Cp=[0,1,2,3,4];function rl(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,i=t.execPresetStore,c=t.sessionLogStore,u=null,f=null,_={},h="",T=!1,$=!1,E=!1,B="",x="",G="";function ee(){$=!1,E=!1,B="",x="",G=""}let I=[],L=null,A=null,j=!1,N="",ne=!1,Ae=0,le=new Set;function ve(){I=[],L=null,A=null,j=!1,N="",ne=!1,Ae+=1,le.clear()}async function $e(d){if(!s)return;let k=++Ae;try{let v=await Promise.resolve(s("get-comments",{id:d}));if(k!==Ae||d!==u)return;I=Array.isArray(v)?v:[],j=!1}catch{if(k!==Ae||d!==u)return;j=!0}m()}function et(){if(!s||!u)return;let d=f&&typeof f.comment_count=="number"?f.comment_count:null;if(L!==u){L=u,A=d,$e(u);return}d!==null&&d!==A&&(A=d,$e(u))}function nt(d){le.has(d)?le.delete(d):le.add(d),m()}function De(d){let k=N.trim().length===0;N=d,k!==(d.trim().length===0)&&m()}async function Fe(){let d=N.trim();if(!s||!u||d.length===0||ne)return;let k=u;ne=!0,m();let v=!1;try{let D=await Promise.resolve(s("add-comment",{id:k,text:d}));Array.isArray(D)&&D.length>0&&(v=!0,k===u&&(I=D,j=!1,N="",A=D.length))}catch{v=!1}v||J("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),k===u&&(ne=!1),m()}let xe={onToggle:nt,onDraftInput:De,onSubmit:Fe},me=document.createElement("div");me.className="md-viewer-root",document.body.appendChild(me);let ye=Ki(me,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),he=document.createElement("div");he.className="session-log-root",document.body.appendChild(he);let W=rs(he,{transport:s?(d,k)=>Promise.resolve(s(d,k)):void 0,sessionLogStore:c}),V=!1,Le=!1,de=!1,ie=null,R=null,F=0;function ce(d){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${d}`}function Me(){V=!1,Le=!1,de=!1,ie=null,R=null,F+=1}async function Ee(d){if(!s)return;let k=++F;Le=!0,de=!1,m();try{let v=await Promise.resolve(s("get-bead-prompt",{bead_id:d}));if(k!==F)return;!v||typeof v!="object"||Array.isArray(v)?de=!0:(ie=v,R=ce(d))}catch{k===F&&(de=!0)}finally{k===F&&(Le=!1,m())}}function He(){if(V=!V,V&&u&&R!==ce(u)){ie=null,Ee(u);return}m()}function Oe(){if(!a||!u)return[];let d=a.get();return(d&&d.attempts?Object.values(d.attempts):[]).filter(v=>v&&v.bead_id===u).sort((v,D)=>(D.started_at||0)-(v.started_at||0)).map(v=>({attempt_id:v.attempt_id,bead_id:v.bead_id,status:v.status,started_at:typeof v.started_at=="number"?v.started_at:null,runner:v.runner||null,model:v.model||null,effort:v.effort||null,speed:v.speed||null,session_id:v.session_id||null,resumed_from:v.resumed_from||null,continuation_mode:v.continuation_mode||null,dismissed_at:typeof v.dismissed_at=="number"?v.dismissed_at:null,cause:typeof v.cause=="string"?v.cause:null,cause_detail:v.cause_detail||null,exec_default_preset_id:typeof v.exec_default_preset_id=="string"?v.exec_default_preset_id:null,exec_default_preset_revision:typeof v.exec_default_preset_revision=="number"?v.exec_default_preset_revision:null,exec_values:v.exec_values&&typeof v.exec_values=="object"?v.exec_values:null,usage:v.usage||null,usage_legs:Array.isArray(v.usage_legs)?v.usage_legs:[]}))}function Ce(){if(!a||!u)return null;let d=a.get();return It(d&&d.attempts||{},u)}let Re=new Set;function Ye(d){Re.has(d)?Re.delete(d):Re.add(d),m()}function M(d){let k=a?a.get():null,v=k&&k.attempts?k.attempts[d]:null;W.open({attempt_id:d,meta:v?{runner:v.runner||void 0,model:v.model||void 0,effort:v.effort||void 0,status:v.status||void 0,session_id:v.session_id||void 0}:{}})}async function U(d){if(!s||!d)return;let k=()=>{let X=a?a.get():null;return X&&typeof X.revision=="number"?X.revision:0},v=async(X={})=>await s("worker-attempt-resume",{attempt_id:d,expected_revision:k(),...X}),D=X=>{X?.queue&&a?.set&&a.set(X.queue)},te=await v();if(D(te),te&&te.conflict){let X=te.queue&&typeof te.queue.revision=="number"?te.queue.revision:k();te=await s("worker-attempt-resume",{attempt_id:d,expected_revision:X}),D(te)}te=await Jt(te,(X,Ue)=>v({continuation:X,decision_token:Ue}),{onResult:D,refresh:()=>v()}),te&&te.resumed===!1&&!te.conflict&&te.reason&&J(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${te.reason}`,"error",2400)}let P={onOpen:M,onResume:U,onToggleUsage:Ye};function Q(){let d=a?a.get():null,k=d&&d.default_exec_preset_id,v=typeof k=="string"?z()?.presets.find(D=>D.id===k):null;return v&&v.compatible!==!1&&v.settings?v.settings:{}}function fe(){let d=a?a.get():null,k=d&&d.default_exec_preset_id,v=typeof k=="string"?z()?.presets.find(D=>D.id===k):null;return v&&v.compatible!==!1&&typeof v.name=="string"?v.name:""}function w(){let d=a?a.get():null;return d&&d.runner_catalog||null}function C(){let d=f?.metadata&&typeof f.metadata=="object"?f.metadata:{},v=(Object.hasOwn(_,"orchestration_model")?_.orchestration_model:void 0)||(typeof d.orchestration_model=="string"?d.orchestration_model:"")||(typeof Q().orchestration_model=="string"?Q().orchestration_model:"")||"opus";return sr(w(),v)}function z(){let d=i?i.get():null;return!d||typeof d.revision!="number"?null:{revision:d.revision,presets:Array.isArray(d.presets)?d.presets:[]}}function ue(d){let k=d&&d.settings&&typeof d.settings=="object"?d.settings:{},v=D=>typeof k[D]=="string"?k[D]:D==="impl_runtime"&&typeof k.impl_model=="string"&&sr(w(),k.impl_model)||"";return jr({selectedOf:v,effectiveOf:v,runner_catalog:w()}).some(D=>D.groups.some(te=>te.options.some(X=>X.value===D.selected&&X.label.endsWith("(\uBE44\uD638\uD658)"))))}function ae(d){i&&d&&typeof d.revision=="number"&&Array.isArray(d.presets)&&i.set({revision:d.revision,presets:d.presets})}async function Ie(){let d=z(),k=d?.presets.find(v=>v.id===h);if(!(!s||!u||!d||!k||ue(k)||T)){T=!0,m();try{let v=await Promise.resolve(s("apply-exec-preset",{id:u,preset_id:k.id,expected_revision:d.revision}));if(v&&v.conflict){ae(v),J("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let D=v&&Array.isArray(v.issue)?v.issue[0]:v?.issue;if(v&&v.applied&&D&&typeof D=="object"){f=D;for(let te of Er)delete _[te];J("\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",2400);return}v&&v.error==="bd_readback_failed"?J("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):J("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(v){v&&typeof v=="object"&&v.code==="bd_readback_failed"?J("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):J("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{T=!1,m()}}}function Ne(){let d=z();if(d&&d.presets.length===0)return l`<section class="detail-exec-presets">
      ...
      </section>`;let k=d?d.presets:[],v=k.find(te=>te.id===h),D=v?ue(v):!1;return l`<section class="detail-exec-presets">
      <div class="detail-section-label">실행 프리셋</div>
    ...
    </section>`}let tt=null;r&&r.subscribe&&(tt=r.subscribe(()=>st()));let Be=null;a&&typeof a.subscribe=="function"&&(Be=a.subscribe(()=>{u&&m()}));let _t=null;i&&typeof i.subscribe=="function"&&(_t=i.subscribe(()=>{u&&m()}));function mt(d){d.key==="Escape"&&u&&(d.preventDefault(),n())}document.addEventListener("keydown",mt);function st(){if(u){if(r&&typeof r.snapshotFor=="function"){let d=r.snapshotFor("detail:"+u)||[];f=d.find(v=>v&&v.id===u)||d[0]||f}et(),m()}}function at(d){Sr(d).then(k=>{k?J("\uBCF5\uC0AC\uB428","success",1200):J("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function it(d){d.preventDefault(),d.stopPropagation(),u&&at(u)}function ct(d,k){d.preventDefault(),d.stopPropagation(),at(k)}function bt(d,k,v){d.preventDefault(),d.stopPropagation(),ye.open(k,{missing_state:v})}function q(d,k){_[d]=k,m(),!(!s||!u)&&Promise.resolve(s("update-exec-settings",{id:u,key:d,value:k})).catch(()=>{J("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}function Y(d,k){let v=f||{},D=v.metadata&&typeof v.metadata=="object"?v.metadata:{},te={};for(let qe of["impl_runtime","impl_model","impl_effort"])te[qe]=Object.hasOwn(_,qe)?_[qe]:typeof D[qe]=="string"?D[qe]:"";te[d]=k;let X=os(te,w(),C()),Ue={};for(let qe of["impl_runtime","impl_model","impl_effort"])Ue[qe]=_[qe],_[qe]=X[qe]||"";m(),!(!s||!u)&&Promise.resolve(s("update-impl-target",{id:u,...X,orchestration_runtime:C()})).then(qe=>{let Kt=Array.isArray(qe)?qe[0]:qe;if(!Kt||typeof Kt!="object"||!Kt.id)throw new Error("implementation target readback failed");f=Kt;for(let _s of["impl_runtime","impl_model","impl_effort"])delete _[_s];m()}).catch(()=>{for(let qe of["impl_runtime","impl_model","impl_effort"])Ue[qe]===void 0?delete _[qe]:_[qe]=Ue[qe];m(),J("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error")})}async function K(d,k,v){if(!s||!u)return!1;try{let D=await Promise.resolve(s(d,k)),te=Array.isArray(D)?D[0]:D;return te&&typeof te=="object"&&te.id?(f=te,!0):(J(v,"error"),!1)}catch{return J(v,"error"),!1}}function _e(d){setTimeout(()=>{try{let k=e.querySelector(d);k&&typeof k.focus=="function"&&k.focus()}catch{}},0)}function we(){$=!0,B=f&&f.title||"",m(),_e('.detail-edit__input[data-edit="title"]')}function Te(d){B=d.target.value}function Ve(){$=!1,B="",m()}function ot(){K("edit-text",{id:u,field:"title",value:B},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(k=>{k&&($=!1,B=""),m()})}function Se(){E=!0,x=f&&f.description||"",m(),_e('.detail-edit__textarea[data-edit="description"]')}function Ke(d){x=d.target.value}function ke(){E=!1,x="",m()}function ut(){K("edit-text",{id:u,field:"description",value:x},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(k=>{k&&(E=!1,x=""),m()})}function vt(d,k,v,D){if(d.key==="Escape"){d.stopPropagation(),v();return}d.key==="Enter"&&(!D||d.ctrlKey||d.metaKey)&&(d.preventDefault(),k())}function Vt(d){let k=d.target.value;K("update-status",{id:u,status:k},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>m())}function Bt(d){let k=Number(d.target.value);K("update-priority",{id:u,priority:k},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>m())}function Ut(d){G=d.target.value}function gt(){let d=G.trim();d.length!==0&&K("label-add",{id:u,label:d},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(k=>{k&&(G=""),m()})}function xt(d){if(d.key==="Escape"){d.stopPropagation(),G="",m();return}d.key==="Enter"&&(d.preventDefault(),gt())}function jt(d){K("label-remove",{id:u,label:d},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>m())}let Ot={onCopyPath:ct,onOpenDoc:bt},p={onChange:q,onImplTargetChange:Y};function y(d){return typeof d=="string"?d:d&&typeof d=="object"?String(d.id||d.to||d.issue_id||d.depends_on||""):""}function S(d){switch(d&&typeof d=="object"?String(d.dependency_type||d.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function re(d){let v=(Array.isArray(d.dependencies)?d.dependencies:[]).map(D=>({id:y(D),icon:S(D)})).filter(D=>D.id.length>0);return l`
    ...
    `}function ge(d){let k=d.metadata||{},v=d.workflow||{},D=v.stages||{},te=D.spec&&D.spec.stale,X=D.impl&&D.impl.stale,Ue=D.plan||null,qe=v.route_source==="derived",Kt=v.route||k.route||"\u2014";return l`
    ...
    `}let be={route:["quick_fix","spec_backed","full_plan"]};async function pe(d,k){let v=k.target.value;if(d==="route"&&f&&f.metadata&&f.metadata.route==="full_plan"&&v!=="full_plan"&&!window.confirm(`full_plan \u2192 ${v||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){m();return}await K("update-workflow-meta",{id:u,key:d,value:v},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),m()}function We(d){let k=d.metadata||{};return l` ${((D,te)=>{let X=be[D],Ue=typeof k[D]=="string"?k[D]:"";return l`<div class="detail-kv">
    ...
    `}function b(d){let k=pt(d.created_at),v=pt(d.updated_at);return!k&&!v?l``:l`
    ...
    `}function Ze(){if(!u)return l``;let d=f||{},k=String(d.id||u),v=d.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",D=Ce(),te=d.status||"open",X=typeof d.priority=="number"?Math.max(0,Math.min(4,d.priority)):"",Ue=d.description||"",qe={...d,metadata:{...d.metadata||{},..._}};return l`
...
${Xe.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:O==="done"?It(p.attempts||{},oe.bead_id):null,done_at:O==="done"&&typeof oe.added_at=="number"?oe.added_at:void 0,...Pe(oe.bead_id)}}),qo=new Map;for(let g of p.done)g&&typeof g.bead_id=="string"&&typeof g.added_at=="number"&&qo.set(g.bead_id,g.added_at);let Wr=p.attempts?Object.values(p.attempts):[],gs=new Set;for(let g of Wr)g&&typeof g.resumed_from=="string"&&g.resumed_from.length>0&&gs.add(g.resumed_from);let hs=new Map;for(let g of Wr)hs.set(g.bead_id,g.attempt_id);let bs=new Map;for(let g of Wr)bs.set(g.attempt_id,g);function vs(g){let O=new Set,oe=g;for(;oe&&!O.has(oe.attempt_id);){if(oe.conflict_resolution===!0)return!0;O.add(oe.attempt_id),oe=typeof oe.resumed_from=="string"&&oe.resumed_from.length>0&&bs.get(oe.resumed_from)||null}return!1}let $n=typeof p.declared_base=="string"?p.declared_base:null;function mc(g){let O=null;for(let oe of Wr)!oe||oe.bead_id!==g||vs(oe)||(O===null||(typeof oe.started_at=="number"?oe.started_at:0)>=(typeof O.started_at=="number"?O.started_at:0))&&(O=oe);return O&&typeof O.target_base=="string"?O.target_base:null}let Bo=[],Uo=[],gc=g=>{let O=hs.get(g.bead_id)!==g.attempt_id,oe=qo.get(g.bead_id),Xe=typeof oe=="number"&&oe>0&&typeof g.finished_at=="number"&&oe>=g.finished_at;return!O&&!Xe&&typeof g.dismissed_at!="number"},jo=g=>{let O=typeof g.session_id=="string"&&g.session_id.length>0,oe=gs.has(g.attempt_id);return{eligible:O&&!oe,reason:O?oe?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Dt=null;for(let g of Wr){let O=g.status==="paused"&&!gs.has(g.attempt_id);if(g.status==="running"||O)Uo.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:Z.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,paused:O,conflict_resolution:vs(g),base_exception:Lo($n,g.target_base),can_pause:typeof g.session_id=="string"&&g.session_id.length>0,discard:Gt(Hr,g.bead_id,{attempt_id:g.attempt_id}),usage:It(p.attempts||{},g.bead_id),current_child:pe(g.bead_id),...Pe(g.bead_id)});else if((g.status==="failed"||g.status==="orphaned")&&gc(g)){let oe=jo(g);Bo.push({bead_id:g.bead_id,attempt_id:g.attempt_id,title:Z.get(g.bead_id)||g.bead_id,runner:g.runner||null,model:g.model||null,effort:g.effort||null,speed:g.speed||null,continuation_mode:g.continuation_mode||null,started_at:typeof g.started_at=="number"?g.started_at:null,resumed_from:g.resumed_from||null,failed:!0,status:g.status,status_label:g.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Gt(Hr,g.bead_id,{attempt_id:g.attempt_id}),resume_eligible:oe.eligible,resume_reason:oe.reason,conflict_resolution:vs(g),base_exception:Lo($n,g.target_base),usage:It(p.attempts||{},g.bead_id),current_child:pe(g.bead_id),...Pe(g.bead_id)}),Dt=g}}let xn=[...Bo,...Uo],zo=null;if(Dt){let g=jo(Dt),O=Dt.cause_detail;zo={bead_id:Dt.bead_id,repo:Dt.repo||"",reason:Dt.cause||Dt.status,cause_detail:O&&typeof O.reason=="string"?{reason:O.reason,command:typeof O.command=="string"?O.command:null}:null,resume_attempt_id:Dt.attempt_id,resume_eligible:g.eligible,resume_reason:g.reason,discard:Gt(Hr,Dt.bead_id,{attempt_id:Dt.attempt_id})}}let hc=new Set(xn.map(g=>g.bead_id)),ys=Array.isArray(p.merge_queue)?p.merge_queue:[],Ho=new Map,Wo=new Map,Go=new Map;ys.forEach((g,O)=>{g&&typeof g.bead_id=="string"&&(Ho.set(g.bead_id,O+1),Wo.set(g.bead_id,g.resolution),Go.set(g.bead_id,g.continuation_action||null))});let Yo=p.merge_queue_state||{active:null,failures:{}},bc=Yo.failures||{},vc=p.auto_merge_skips||{},Vo=g=>{let O=vc[g];if(!O)return null;let oe=Ze[g],Xe=oe&&oe.pr?oe.pr.head_sha:null;return Xe&&Xe===O.head_sha?O.reason||"":null},Sn=new Map;for(let g of xn)g.failed!==!0&&g.conflict_resolution&&(g.paused?Sn.has(g.bead_id)||Sn.set(g.bead_id,"paused"):Sn.set(g.bead_id,"running"));let Ko=xn.filter(g=>!g.paused&&g.failed!==!0).length,Zo=(p.workspace_info||{}).slots,yc=typeof Zo=="number"?Zo:typeof p.slots=="number"?p.slots:wn,Xo=p.pr_wait_holds_slot===!0?wn:yc,wc=Ko>Xo,An=kr(G),kc=(Array.isArray(p.done)?p.done.slice():[]).filter(g=>An===void 0||typeof g.added_at!="number"||g.added_at>=An).sort((g,O)=>(O.added_at||0)-(g.added_at||0)),Gr=Fo(kc,"done"),$c=new Set((Array.isArray(p.done)?p.done:[]).map(g=>g?.bead_id).filter(g=>typeof g=="string")),Qo=[],xc=u?.()||"";for(let g of re){let O=Qt(g.closed_at);if(typeof g.id!="string"||$c.has(g.id)||O===null||An!==void 0&&O<An||typeof g.comment_count!="number"||g.comment_count<=0)continue;let oe=`${xc}\0${g.id}\0${String(g.updated_at)}\0${g.comment_count}`,Xe=ee.get(oe);Xe===void 0&&r&&(ee.set(oe,"pending"),Promise.resolve(r("get-comments",{id:g.id})).then(zt=>{let ar=Array.isArray(zt)&&zt.some(Ct=>ns(typeof Ct?.text=="string"?Ct.text:"")?.lane==="session");ee.set(oe,ar?"session":"not-session"),K()}).catch(()=>{ee.set(oe,"failed"),K()})),Xe==="session"&&Qo.push({id:g.id,title:g.title||g.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,done_at:O,created_at:g.created_at,updated_at:g.updated_at})}Gr.push(...Qo),Gr.sort((g,O)=>(O.done_at||0)-(g.done_at||0));let Tn={};for(let g of er)Tn[g]=0;let Jo=!1,ea=0,ws=0,ta=0;for(let g of Gr){let O=g.usage;if(O&&typeof O=="object"){let oe=!1;for(let Xe of er)Number.isFinite(O[Xe])&&(Tn[Xe]+=O[Xe],Jo=!0,oe=!0);oe&&(ws+=1,Number.isFinite(O.total_cost_usd)&&(ea+=O.total_cost_usd,ta+=1))}}ws>0&&ta===ws&&(Tn.total_cost_usd=ea);let ra=Gr.map(g=>g.usage).filter(g=>g&&typeof g=="object"&&g.providers),Sc=ra.length>0?ht(jn(ra)):Jo?Nt(Tn):null;return{queue:p,idToTitle:Z,candidates:fc,candidate_hidden:{blocked:ms.hidden_blocked,spec:ms.hidden_spec},running:xn,live_count:Ko,slots:Xo,over_cap:wc,failure:zo,waiting:Fo(v.filter(g=>!hc.has(g.bead_id)),"queue"),pr_wait:Qe.map(g=>Wf(g.bead_id,Z.get(g.bead_id)||g.bead_id,Ze,d[g.bead_id]||null,It(p.attempts||{},g.bead_id),m[g.bead_id]||(j.has(g.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Sn.get(g.bead_id)||null,g.external===!0,{position:Ho.get(g.bead_id)||0,active:Yo.active===g.bead_id,failure:bc[g.bead_id]||null,resolution:Wo.get(g.bead_id),continuation_action:Go.get(g.bead_id)},g.wt_present!==!1,p.auto_merge===!0?Vo(g.bead_id):null,Lo($n,mc(g.bead_id)),p.completion_status&&typeof p.completion_status=="object"&&!Array.isArray(p.completion_status)&&p.completion_status[g.bead_id]||null,p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},bs.get(hs.get(g.bead_id)||"")?.worker_serial===!0)).map(g=>({...g,...Pe(g.id)})),merge_queue_length:ys.length,merge_queue_running:ys.length>0,auto_excluded:Qe.map(g=>g.bead_id).filter(g=>Vo(g)!==null),verify_cmd_present:!!(p.workspace_info||{}).verify_cmd,declared_base:$n,done:Gr,token_total:Sc,cleanup_failures:k,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]}}function Be(p){let y=p.waiting.length>0?p.waiting[0].id:"\u2014",S=l`<button
    ...
    >`,We=l`<label class="worker-tgl worker-slots"
      ...
      >
        ⚙
      </button>`,Z=_l({failure:p.failure}),b=al(p.repo_operations,p.cleanup_failures);return A?l`<div class="worker-ribbon">
          ${S} ${re}
      ...
      ${b}${Z}`}function _t(p){if(p.running.length===0&&p.pr_wait.length===0)return"";let y=p.running.some(S=>!S.paused&&S.failed!==!0);return l`<section
