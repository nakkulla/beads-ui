...
Please report this to https://github.com/markedjs/marked.`,e){let r="<p>An error occurred:</p><pre>"+Bn(n.message+"",!0)+"</pre>";return t?Promise.resolve(r):r}if(t)return Promise.reject(n);throw n}}},mr=new Gm;function mt(e,t){return mr.parse(e,t)}mt.options=mt.setOptions=function(e){return mr.setOptions(e),mt.defaults=mr.defaults,mu(mt.defaults),mt};mt.getDefaults=oi;mt.defaults=gr;mt.use=function(...e){return mr.use(...e),mt.defaults=mr.defaults,mu(mt.defaults),mt};mt.walkTokens=function(e,t){return mr.walkTokens(e,t)};mt.parseInline=mr.parseInline;mt.Parser=xn;mt.parser=xn.parse;mt.Renderer=ko;mt.TextRenderer=fi;mt.Lexer=$n;mt.lexer=$n.lex;mt.Tokenizer=wo;mt.Hooks=_s;mt.parse=mt;var gw=mt.options,bw=mt.setOptions,hw=mt.use,yw=mt.walkTokens,vw=mt.parseInline;var ww=xn.parse,kw=$n.lex;function Zn(e){let t=mt.parse(e),n=iu.sanitize(t);return lu(n)}function Un(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      </div>`}if(J.kind==="error")return l`<div class="sv__error">⛔ ${J.text}</div>`;if(J.kind==="blocker")return l`<div class="sv__error">⛔ ${J.text}</div>`;if(J.kind==="tool"){let Ce=v.has(te),Ke=J.tool==="Bash"?cg(J.command):0,Oe=J.tool==="Bash"?Ke>1?So(J.command):J.command:J.path||J.command||"";return l`<div
...
`)}function ee(){if(!o)return l``;let te=re(),J=(a?[p.agent_type,p.model,p.effort]:[p.runner,p.model,p.effort]).filter(Boolean).join(" \xB7 "),Ce=p.session_id||"",Ke=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${b?"ON":"OFF"}`,Oe=be(),we=Oe?mg(Ae(),Date.now()):"",Be=Oe?se(te):null,Ge=Oe?xe(te):null,Qe=_g(te);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
${i}</pre
  ...
  >
    ...
    ${a?l`<span class="detail-session__usage" title=${a.tooltip}
          >${a.label}</span
        >`:""}
  </button>`}function nb(e,t){return e.role===t.role&&(e.model===null||t.model===void 0||e.model===t.model)&&e.session_id===t.session_id}function rb(e,t,n){let r=[],s=new Set,o=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let p of o){let b=Jg(p);!b||s.has(b.launch_id)||ad(b.agent_type)||(s.add(b.launch_id),r.push(b))}r.sort((p,b)=>(p.started_at||0)-(b.started_at||0));let a={};for(let{role:p,provider:b}of jo){let v=t?t.roles[p]?.[b]:null;a[p]=v?[...v.legs]:[]}let i=jo.flatMap(({role:p})=>a[p]),c=new Set,d=[];for(let{role:p,provider:b}of jo){for(let v of r.filter($=>$.role===p&&$.provider===b)){let $=i.find(S=>S.receipt_id===v.launch_id)||null;$&&!nb(v,$)||($&&c.add($.receipt_id),d.push(tb(v,$,e.attempt_id,n)))}for(let v of a[p])!c.has(v.receipt_id)&&!ad(v.agent_type)&&d.push(eb(p,b,v))}return d}function sb(e,t){let n=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,r=[...Hg,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return l`<div class="detail-session__usage-detail">
  ...
  >
    ...
    >
      ...
      ${d.cause}
    </div>`},c=d=>{let p=id(Ga(d));if(Wt(p).length===0&&!Dr(d.usage))return"";let b=s.has(d.attempt_id);return l`<button
      type="button"
    ...
    <div class="detail-sessions" data-seam="session-history">
      ${r.map(d=>{let p=Ga(d),b=id(p),v=Wt(b);return l`<div class="detail-session-row">
          <button
            type="button"
    ...
    `}function _(){if(!d)return l``;let m=p||{},A=String(m.id||d),u=m.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",f=Qe(),y=m.status||"open",x=typeof m.priority=="number"?Math.max(0,Math.min(4,m.priority)):"",B=m.description||"",W={...m,metadata:{...m.metadata||{},...b}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${en(u,f)}
          ${Yu(W)}
          ${Ku({metadata:W.metadata,workspace_values:ut(),catalog:Re(),execution_defaults:I(),expanded:N,presets:pe()?.presets||[],preset_id:v,preset_busy:$,skipped_orchestration_keys:S},{onToggle:ne=>{N=ne,w()},onEdit:(ne,me)=>{if(ne==="impl_runtime"||ne==="impl_model"||ne==="impl_effort"){Se(ne,me??"");return}dt(ne,me??"")},onPresetSelect:ne=>{v=ne,S=[],w()},onPresetApply:()=>{fe()}})}
          ${td({md:W.metadata,catalog:Y,workspace_defaults:ie,handlers:{onExecChange:dt}})}
          ${In(y,x)} ${_n(m)}
          ${T(B)}
...
`);return l`<span
  ...
  >
    ...
    >${e.id}</span
  >`,S=e.lane==="done"?"":Yo(e.workflow),N=e.lane==="done"?"":md(e.from_id),j=Zo(e.priority),Y=l`<span class="worker-mini__title">${e.title}</span>`,ie=e.pr_url&&e.pr_number?l`<a
  ...
  >
    ${i?l`<div class="worker-mini__row1">
      ...
      >
        ...
        >${e.workspace_name}</span
      >`:"",b=Yo(a),v=md(e.from_id),$=!!(e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker));return l`<div
  ...
  >
    ...
    ${e.failure?l`<div class="worker-banner worker-banner--failure" role="alert">
        ...
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?l`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`}var kb=new Set(["codex-runner"]);function $b(e,t,n,r=null){if(!e)return"";let s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=(r||!Array.isArray(e.legs)?[]:e.legs).filter(b=>b&&!(typeof b.agent_type=="string"&&kb.has(b.agent_type))),c=i.filter(b=>b&&b.state==="live"),d=i.filter(b=>b&&b.state!=="live"),p=r?cn(r.updated_at,t):"";return l`${o?l`<div class="rtile__activity${n?" is-paused":""}">
        ...
        ${c.map(b=>l`<span
            ...
            >`)}${d.length>0?l`<span
              ...
              >위임 완료 ${d.length}</span
            >`:""}
      </div>`:""}`}function Ii(e,t,n=null,r={}){let s=e.kind==="session",o=e.failed===!0,a=!!e.paused,i=o?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):a?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?vb(t-e.started_at):"\u2014",c=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,d=ns(e),p=Wt(e.usage),b=qn(e.usage),v=e.conflict_resolution?a?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,$=e.base_exception||null,S=e.landing,N=e.attempt_id&&e.attempt_id===n,j=r.monitor||null,Y=wb(j),ie=j?Ko(j.dependency_chips,{lane:"running"}):"",z=$b(j,t,a,s?{updated_at:e.updated_at??null}:null),q=s&&e.workflow?.chips?.exec_receipt||null,D=Yo(e.workflow),U=q?l`<span
        class="ctl-chip ctl-chip--exec-receipt"
...
`)}function As(e){if(typeof e!="object"||e===null)return null;let t=_r(e);if(t==="")return null;let n=(r,s)=>typeof s=="string"&&s.length>0?`${r}: ${s}`:null;return{text:t,title:Mi(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(Xn.orchestration_model,e.model),n(Xn.orchestration_effort,e.effort),n(Xn.orchestration_speed,e.speed)])}}function hr(e,t){let n=Jn(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=Jn(e,"orchestration_effort"),s=Jn(e,"orchestration_speed"),o=kd([An(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Mi(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",er("orchestration_model",n),er("orchestration_effort",r),er("orchestration_speed",s)])}}function xb(e,t){return e===null||e.value===null||Di.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function Ab(e){return e===null||Di.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function Sb(e){return e===null?null:e.value==="auto"?"auto":Di.has(e.resolution)?null:e.display}function tr(e,t){if(typeof e!="object"||e===null)return null;let n=Jn(e,"impl_dispatch"),r=Jn(e,"impl_runtime"),s=Jn(e,"impl_model"),o=Jn(e,"impl_effort"),a=Jn(e,"impl_speed"),i=n!==null&&n.value==="main"?"\uBA54\uC778":kd([xb(r,t??null),Ab(s),Sb(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Mi(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",er("impl_dispatch",n),er("impl_runtime",r),er("impl_model",s),er("impl_effort",o),er("impl_speed",a)])}}var zt="",Eb=["impl_runtime","impl_model","impl_effort"],Tb=["claude_account","codex_account"],Cb=5,Qo=1;function sn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Jo(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(I=>ae(I,"error",4e3)),o={},a={},i=[],c=!1,d={state:"absent",values:{},warnings:[]},p={},b={},v=Promise.resolve(),$={claude:null,codex:null},S=!1,N=null,j={},Y="",ie="",z=!1,q=!1,D=!1,U=null,E=!1;function M(){let I=t.queue?t.queue():null;return sn(I)?I:null}function re(){let I=M();return I?I.runner_catalog:null}function Ae(){let I=M();return I&&sn(I.execution_defaults)?I.execution_defaults:null}function be(){let I=t.implPresetStore?.get();return sn(I)&&Array.isArray(I.presets)?I:null}function H(){return r===null?{}:{root_dir:r}}async function X(I,K){return E||!n?null:await n(I,K)}function ye(I){I&&sn(I.queue)&&t.onQueueAdopt?.(I.queue)}async function ke(I,K){let pe=M();if(!pe||E)return null;let C=await X(I,{...K,...H(),expected_revision:pe.revision});if(ye(C),r!==null&&C&&C.conflict){let G=C.queue&&typeof C.queue.revision=="number"?C.queue.revision:M()?.revision??pe.revision;C=await X(I,{...K,...H(),expected_revision:G}),ye(C)}return C}async function he(){c=!0,Re();try{let I=await X("get-session-defaults",{...H()});o=sn(I?.values)?{...I.values}:{},a={...o},i=Array.isArray(I?.warnings)?I.warnings:[]}catch(I){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}finally{c=!1,Re()}}async function se(){let I=Uu(o,a);if(Object.keys(I).length!==0){try{let K=await X("set-session-defaults",{values:I,...H()});o=sn(K?.values)?{...K.values}:{},a={...o},i=Array.isArray(K?.warnings)?K.warnings:[]}catch(K){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${K instanceof Error?K.message:String(K)}`)}Re()}}function xe(I,K){if(!sn(I))return;let pe=I.state;d={state:pe==="usable"||pe==="unusable"||pe==="absent"?pe:"absent",values:sn(I.values)?{...I.values}:{},warnings:Array.isArray(I.warnings)?I.warnings:[]},b={...d.values},K&&(p={...b})}async function ge(){try{xe(await X("get-workspace-accounts",{...H()}),!0)}catch(I){d={state:"unusable",values:{},warnings:["kv_read_failed"]},b={},p={},s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}Re()}async function V(I){try{let K=await fetch(I);if(!K.ok)return null;let pe=await K.json();if(!sn(pe)||!Array.isArray(pe.accounts))return null;let C=pe.accounts.filter(G=>sn(G)&&typeof G.key=="string"&&G.key.length>0&&typeof G.email=="string"&&G.email.length>0);return{accounts:C,active:C.find(G=>G.active===!0)||null}}catch{return null}}async function ee(){S=!0;let[I,K]=await Promise.all([V("/api/claude-usage"),V("/api/codex-usage")]);E||($={claude:I,codex:K},Re())}function ce(){let I={};for(let K of Tb){let pe=Object.hasOwn(p,K)?p[K]:null,C=Object.hasOwn(b,K)?b[K]:null;pe!==C&&(I[K]=pe)}return I}async function ve(){let I=ce();if(Object.keys(I).length!==0){try{xe(await X("set-workspace-accounts",{values:I,...H()}),!1)}catch(K){s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${K instanceof Error?K.message:String(K)}`)}Re()}}function De(I,K){K===zt?delete p[I]:p[I]=K,Re(),v=v.then(()=>ve())}function le(I,K){if(Eb.includes(I)){ue(I,K);return}K===zt?delete a[I]:a[I]=K,Re(),se()}function ze(){let I=ut().orchestration_model,K=rn({global:{orchestration_model:I??void 0},execution_defaults:Ae(),runner_catalog:re()}).orchestration_model.value;return K?An(re(),K):null}function P(I,K){typeof K=="string"&&K.length>0?a[I]=K:delete a[I]}function ue(I,K){let pe=K===zt?void 0:K,C=ju({impl_runtime:I==="impl_runtime"?pe:a.impl_runtime,impl_model:I==="impl_model"?pe:a.impl_model,impl_effort:I==="impl_effort"?pe:a.impl_effort},re(),ze());P("impl_runtime",C.impl_runtime),P("impl_model",C.impl_model),P("impl_effort",C.impl_effort),Re(),se()}async function Me(){let I=M();if(!I)return;let K={orchestration_model:I.orchestration_model??null,orchestration_effort:I.orchestration_effort??null,orchestration_speed:I.orchestration_speed??null},pe=Wu(K,{...K,...j});if(Object.keys(pe).length!==0){try{let C=await ke("worker-queue-set-orchestration-defaults",{values:pe});if(C&&C.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}j={}}catch(C){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}Re()}}function qe(I,K){j[I]=K===zt?null:K,Re(),Me()}function Le(I){if(N=I,!I){Re();return}let K=re(),pe=ut(),C=pe.orchestration_model;C&&!vs(K,I).includes(C)&&(j.orchestration_model=null,C=null);let G=pe.orchestration_effort;G&&!ki(K,I,C||pn).includes(G)&&(j.orchestration_effort=null),Re(),Me()}async function We(I){if(!(!M()||I<Qo)){try{await ke("worker-queue-set-slots",{slots:I})}catch(K){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${K instanceof Error?K.message:String(K)}`)}Re()}}async function je(I){if(!(!M()||I<Qo||I>Cb)){try{await ke("worker-queue-set-serial-lane-count",{count:I})}catch(K){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${K instanceof Error?K.message:String(K)}`)}Re()}}async function Ye(I,K){let pe=I==="auto_advance"?"worker-automation-toggle":I==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await ke(pe,{on:K})}catch(C){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}Re()}function tt(){let I={},K=ut();for(let pe of Ro){let C=Wn.includes(pe)?K[pe]:a[pe];typeof C=="string"&&C.length>0&&(I[pe]=C)}return I}async function ct(){let I=be();if(!I)return;let K=tt();if(Object.keys(K).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let pe=(I.presets||[]).find(G=>G.id===Y),C=ie.trim()||(pe?pe.name:"");if(!C){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let G=pe?await X("impl-preset-update",{expected_revision:I.revision,id:pe.id,name:C,settings:K}):await X("impl-preset-create",{expected_revision:I.revision,name:C,settings:K});if(G&&G.applied){if(ie="",!pe&&Array.isArray(G.presets)){let fe=G.presets.find(g=>g.name===C);Y=fe?fe.id:Y}Re()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Re()}catch(G){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${G instanceof Error?G.message:String(G)}`)}}async function _t(){let I=be();if(!(!I||Y.length===0))try{let K=await X("impl-preset-delete",{expected_revision:I.revision,id:Y});K&&K.applied?(Y="",Re()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Re())}catch(K){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${K instanceof Error?K.message:String(K)}`)}}function te(I){o=sn(I.values)?{...I.values}:{},a={...o},i=Array.isArray(I.warnings)?I.warnings:[],sn(I.queue)&&(t.onQueueAdopt?.(I.queue),j={})}async function J(){let I=be(),K=M();if(!I||!K||Y.length===0)return;let pe=C=>({preset_id:Y,expected_revision:I.revision,expected_queue_revision:C,...H()});try{let C=await X("apply-impl-preset-global",pe(K.revision));if(C&&C.applied&&te(C),r!==null&&C&&C.queue_applied===!1){let G=C.queue&&typeof C.queue.revision=="number"?C.queue.revision:M()?.revision??K.revision;C=await X("apply-impl-preset-global",pe(G)),C&&C.applied&&te(C)}C&&C.applied?C.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):C&&C.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(C){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}Re()}async function Ce(){q=!0,D=!1,Re();try{let I=await X("get-worker-system-prompt",{});!I||typeof I!="object"||Array.isArray(I)?D=!0:U=I}catch{D=!0}finally{q=!1,Re()}}function Ke(){if(z=!z,z&&!U){Ce();return}Re()}function Oe(){let I=Nr({loading:q,error:D});if(I)return I;if(!U)return"";let K=Array.isArray(U.variants)?U.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${z?Oe():""}
    </section>`}function Be(I,K,pe,C,G,fe,g){let k=G[I]??zt,O=$i(I,pe,G,Ae(),re(),g),Q=O.options.find(_e=>_e.value===k),Z=k===zt?O.full_value:Q?.full_value;return l`<select
    ...
    </div>`}function ut(){let I=M(),K={};for(let pe of Wn)K[pe]=Object.prototype.hasOwnProperty.call(j,pe)?j[pe]:I&&typeof I[pe]=="string"?I[pe]:null;return K}function He(){let I=re(),K=a.impl_runtime,pe=a.impl_model,C=be(),G=M(),fe=ut(),g=vs(I,N),k=Fr(I,void 0).filter(Se=>Se!==pn),O=ki(I,N,fe.orchestration_model||pn).filter(Se=>Se!==pn),Q=Y?(C?.presets||[]).find(Se=>Se.id===Y):null,Z=Q?Bu(tt(),sn(Q.settings)?Q.settings:{}):null,_e=G&&typeof G.slots=="number"?G.slots:Qo+1,Te=G&&typeof G.serial_lane_count=="number"?G.serial_lane_count:Qo,$e=Ae()?.supported===!0,st=rt(),dt=$i("workflow_mode",hs,a,Ae(),I);return l`
  ...
  >
    ...
    >
      ...
      >
        ${Sd()}
      </button>`}function be(V){let ee=Ob(V);return ee?l`<div class="mon2-deck__chips">
...
${_e.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(Ke,Z)&&(st.blocked_by=Array.isArray(Ke[Z])?Ke[Z].filter(dt=>typeof dt=="string"&&dt.length>0):[]),st};for(let g=0;g<rt.length;g++){let k=pe(rt[g],"queue",g,rt.length);if(!k)continue;S.push(k);let O=Y.get(ue);O?O.push(k):Y.set(ue,[k])}let C=g=>{let k=$.find(Z=>Z.id===g&&Z.root_dir===ue);if(k)return{id:g,title:k.title,badge:"PR \uB300\uAE30 \xB7 \uC810\uC720"};let O=v.find(Z=>Z.id===g&&Z.root_dir===ue),Q=O&&O.run_state==="failed"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":O&&O.run_state==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720";return{id:g,title:O?O.title:I(g).title,badge:Q}},G=[];for(let g=0;g<Math.max(it,yt.length);g++){let k=`s${g+1}`,O=Ot.get(k),Q=O&&Array.isArray(O.entries)?O.entries:[],Z=[];for(let $e=0;$e<Q.length;$e++){let st=pe(Q[$e],k,$e,Q.length);st&&(Z.push(st),S.push(st))}let _e=xt(Et[k]),Te=Array.isArray(_e.occupied_by)?_e.occupied_by.filter($e=>typeof $e=="string"):[];Z.length===0&&Te.length===0&&(it<=1||g>=it)||G.push({id:k,index:g,items:Z,raw_length:Q.length,occupied_by:Te,occupants:Te.map($e=>C($e)),corrections:Array.isArray(_e.corrections)?_e.corrections.length:0,cycle:_e.cycle===!0,...Z.length===0&&Te.length===0?{empty:!0}:{}})}ie.set(ue,G);let fe=Array.from({length:it},(g,k)=>{let O=`s${k+1}`,Q=Ot.get(O),Z=Q&&Array.isArray(Q.entries)?Q.entries:[],_e=xt(Et[O]);return{id:O,index:Z.length,length:Z.length,occupied_by:Array.isArray(_e.occupied_by)?_e.occupied_by.filter(Te=>typeof Te=="string"):[]}});for(let g of Array.isArray(P.runnable)?P.runnable:[]){let k=g&&g.bead_id;if(typeof k!="string"||K.has(k))continue;K.add(k);let O=g.workflow&&typeof g.workflow=="object"?g.workflow:null,Q=O&&typeof O.route=="string"&&O.route||(typeof g.route=="string"?g.route:null),Z=Qb(xt(qe),g.exec_pins,Q);Array.isArray(g.blocked_by)&&g.blocked_by.length>0&&D.set(k,g.blocked_by.filter(_e=>typeof _e=="string"&&_e.length>0)),typeof g.title=="string"&&g.title.length>0&&M.set(k,g.title),Array.isArray(g.scope)&&E.set(k,g.scope.filter(_e=>typeof _e=="string"&&_e.length>0)),b.push({...I(k),title:g.title||je[k]||k,lane:"runnable",draggable:!0,reason:Zd(ct,k),created_at:g.created_at??void 0,updated_at:g.updated_at??void 0,status:typeof g.status=="string"?g.status:void 0,labels:Array.isArray(g.labels)?g.labels:[],spec_id:typeof g.spec_id=="string"?g.spec_id:"",workflow:O||(Q?{route:Q,chips:{route:Q}}:null),...Z?{exec_chips:Z}:{},blocked:g.blocked===!0,...Array.isArray(g.blocked_by)?{blocked_by:g.blocked_by.filter(_e=>typeof _e=="string"&&_e.length>0)}:{},place_index:rt.length,place_lanes:fe})}for(let g of He){let k=g&&g.bead_id;if(typeof k!="string"||K.has(k)||(K.add(k),o!==void 0&&typeof g.added_at=="number"&&g.added_at<o))continue;let O=Zb(We,k),Q=O&&typeof O.done_kind=="string"?O.done_kind:null;N.push({...I(k),lane:"done",done:!0,done_layout:"three_line",usage:bn(We,k),work_ms:zo(We,k),done_at:typeof g.added_at=="number"?g.added_at:void 0,done_kind:Q,badges:[...Q&&Yd[Q]?[Yd[Q]]:[],...Wo(We,k)]})}}let re=new Map;s.forEach((P,ue)=>{P&&typeof P.root_dir=="string"&&re.set(P.root_dir,ue)});let Ae=n&&n.running_sort==="repo"?"repo":"started";v.sort((P,ue)=>{let Me=P.kind==="session",qe=ue.kind==="session";if(Me!==qe)return Me?1:-1;if(Me&&qe){let je=ua(ue.updated_at)-ua(P.updated_at);return je!==0?je:P.id.localeCompare(ue.id)}if(Ae==="repo"){let je=re.get(P.root_dir)??Number.MAX_SAFE_INTEGER,Ye=re.get(ue.root_dir)??Number.MAX_SAFE_INTEGER;if(je!==Ye)return je-Ye}let Le=typeof P.started_at=="number"&&Number.isFinite(P.started_at)?P.started_at:null,We=typeof ue.started_at=="number"&&Number.isFinite(ue.started_at)?ue.started_at:null;return Le!==null&&We!==null&&Le!==We?Le-We:Le===null&&We!==null?1:Le!==null&&We===null?-1:P.id.localeCompare(ue.id)}),N.sort((P,ue)=>(ue.done_at??0)-(P.done_at??0));let be=s.length>0?s:r.map(P=>({root_dir:P&&P.root_dir,name:P&&P.name,auto_advance:P&&P.auto_advance,auto_merge:P&&P.auto_merge,slots:P&&P.slots,revision:P&&P.revision,runner_catalog:P&&P.runner_catalog})),H=new Set(b.map(P=>P.root_dir)),X=[];for(let P of be){if(!P||typeof P.root_dir!="string")continue;let ue=Y.get(P.root_dir)||[],Me=ie.get(P.root_dir)||[];!(ue.length>0||Me.some(Le=>Le.items.length>0||Le.occupied_by.length>0))&&!H.has(P.root_dir)||X.push({root_dir:P.root_dir,name:P.name||P.root_dir,auto_advance:P.auto_advance===!0,auto_merge:P.auto_merge===!0,slots:typeof P.slots=="number"&&P.slots>=Kd?P.slots:Kd,revision:typeof P.revision=="number"?P.revision:0,runner_catalog:xt(P.runner_catalog),items:ue,sublanes:{parallel:ue,serial:Me},serial_lane_count:z.get(P.root_dir)||0,raw_queue_length:q.get(P.root_dir)||0})}let ye={runnable:b,runnable_all:b,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:c==="updated_flat",queue:S,queue_groups:X,running:v,pr_wait:$,done:N,parallel_rows:[],chain_lanes:[],cross_lanes_revision:i&&typeof i.revision=="number"?i.revision:null,cross_lanes_unreadable:i===null,parallel_raw_length:Object.fromEntries(q),owner_of:{}},ke=zd(ye);for(let P of j)ke.has(P.id)||ke.set(P.id,{root_dir:P.root_dir,workspace_name:P.workspace_name,lane:"done",state:"done"});for(let P of[...ye.queue,...ye.runnable]){if(!Object.hasOwn(P,"blocked_by"))continue;let ue=ke.get(P.id);P.blockers=(P.blocked_by||[]).map(Me=>Hd(Me,ue,ke,s))}for(let P of[...ye.queue,...ye.runnable,...ye.running,...ye.pr_wait]){let ue=P.lane==="running"||P.lane==="pr_wait"?[]:(P.blockers||[]).map(qe=>Jb(P.id,qe));if(ue.length===0)continue;let Me={predecessors:ue};P.dependency_chips=Me}rh(ye,U,E,ke,s);let he=Gd(ye.queue_groups);for(let P of ye.queue_groups)for(let ue of P.sublanes.serial){let Me=he.get(Vd(P.root_dir,ue.id));Me&&(ue.cross_wait_peers=Me)}ye.chain_lanes=th(i&&Array.isArray(i.lanes)?i.lanes:[],D,ke,s,M,p);let se=new Map;for(let P of[...ye.queue,...ye.runnable])se.has(P.id)||se.set(P.id,P);let xe=new Set;for(let P of ye.chain_lanes)for(let ue of P.rows){if(P.status==="confirmed"&&!ue.unplaced&&!ue.fixed&&xe.add(ue.id),!P.draft&&!ue.unplaced)continue;let Me=se.get(ue.id);Me&&(Me.cross_lane_chip={lane_id:P.lane_id,number:P.number,status:P.status,label:P.draft?`\uC5F0\uACB0 ${P.number} (draft)`:`\uC5F0\uACB0 ${P.number}`})}let ge=[];for(let P of Y.values())for(let ue of P)xe.has(ue.id)||ge.push(ue);ge.sort((P,ue)=>{let Me=P.workspace_name.localeCompare(ue.workspace_name);return Me!==0?Me:(P.queue_index??0)-(ue.queue_index??0)}),ye.parallel_rows=ge;let V={};for(let[P,ue]of ke)typeof ue.root_dir=="string"&&ue.root_dir.length>0&&(V[P]=ue.root_dir);for(let P of ye.chain_lanes)for(let ue of P.rows)!Object.hasOwn(V,ue.id)&&ue.root_dir.length>0&&p.has(ue.root_dir)&&(V[ue.id]=ue.root_dir);ye.owner_of=V;let ee=ye.runnable.length;ye.runnable_all=ye.runnable.slice();let ce=ye.runnable;a.show_blocked||(ce=ce.filter(P=>P.blocked!==!0));let ve=ce.length;a.spec==="with"?ce=ce.filter(P=>!!P.spec_id):a.spec==="without"&&(ce=ce.filter(P=>!P.spec_id)),ye.runnable_hidden={blocked:ee-ve,spec:ve-ce.length};let De=(P,ue)=>{let Me=ua(ue.updated_at)-ua(P.updated_at);return Me!==0?Me:P.id.localeCompare(ue.id)},ze=c==="repo_spec"?(P,ue)=>{let Me=P.spec_id?0:1,qe=ue.spec_id?0:1;return Me!==qe?Me-qe:De(P,ue)}:De;if(c==="updated_flat")ye.runnable=ce.slice().sort(De),ye.runnable_sections=[];else{let P=new Map;for(let qe of ce){let Le=P.get(qe.root_dir);Le?Le.push(qe):P.set(qe.root_dir,[qe])}let ue=[],Me=[];for(let qe of be){if(!qe||typeof qe.root_dir!="string")continue;let Le=(P.get(qe.root_dir)||[]).slice().sort(ze);P.delete(qe.root_dir),Le.length!==0&&(ue.push({root_dir:qe.root_dir,name:qe.name||qe.root_dir,items:Le.map(We=>({...We,workspace_name:""}))}),Me.push(...Le))}for(let[qe,Le]of P){let We=Le.slice().sort(ze);ue.push({root_dir:qe,name:We[0]?.workspace_name||qe,items:We.map(je=>({...je,workspace_name:""}))}),Me.push(...We)}ye.runnable=Me,ye.runnable_sections=ue}return ye}var Jd="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function ep(e){return typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)?e.lane:e.lane==="running"&&e.serial_lane_id?e.serial_lane_id:null}function tp(e){return e.lane==="runnable"||e.lane==="queue"||typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)}var op="bdui.monitor.done-range",ap="bdui.monitor.running_sort",ip="bdui.monitor.candidate_sort",lp="beads-ui.monitor.candidate-filter",cp="beads-ui.monitor.sections";function sh(){try{let e=window.localStorage.getItem(lp);if(!e)return{...zr};let t=JSON.parse(e);return!t||typeof t!="object"?{...zr}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:zr.show_blocked,spec:Vi.some(n=>n.value===t.spec)?t.spec:"all"}}catch{return{...zr}}}function np(e){try{window.localStorage.setItem(lp,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function oh(){try{let e=window.localStorage.getItem(ip);return Rs.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function ah(e){try{window.localStorage.setItem(ip,e)}catch{}}function ih(){try{let e=window.localStorage.getItem(cp);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function rp(e){try{window.localStorage.setItem(cp,JSON.stringify(e))}catch{}}function lh(){try{let e=window.localStorage.getItem(op);return gn(e)?e:ln}catch{return ln}}function ch(e){try{window.localStorage.setItem(op,e)}catch{}}function uh(){try{return window.localStorage.getItem(ap)==="repo"?"repo":"started"}catch{return"started"}}function dh(e){try{window.localStorage.setItem(ap,e)}catch{}}var up="tab:monitor:pipeline",ph=1e3,fh=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],sp="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function _h(e){return e>=1&&e<=sp.length?sp[e-1]:`(${e})`}function dp(e,t){let n=St("views:monitor"),r=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.openDoc,c=t.switchWorkspace,d=t.router,p=t.now||(()=>Date.now()),b=t.confirm||(u=>typeof globalThis.confirm!="function"||globalThis.confirm(u)),v=lh(),$=uh(),S=sh(),N=oh(),j=ih(),Y=null,ie=null,z=null,q=null,D=[],U=null;function E(){let u=Vn.find(f=>f.value===v);return u?u.label:""}let M=document.createElement("div");M.className="mon",e.appendChild(M);let re=document.createElement("div");re.className="worker-drawer-overlay",re.hidden=!0;let Ae=document.createElement("div");Ae.className="worker-drawer-overlay__backdrop";let be=document.createElement("div");be.className="worker-drawer-host mon2-drawer",re.append(Ae,be),e.appendChild(re);let H=Ki(null,null),X=new Map,ye=new Map,ke=null,he=null,se=null,xe=qr(be,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{Y=null,re.hidden=!0,fe()}});async function ge(u,f,y,x,B=!0){if(!o||!y)return null;let W=await o(u,{...f,root_dir:y,expected_revision:x});if(W&&W.conflict&&B){W.queue&&ye.set(y,W.queue);let ne=W.queue&&typeof W.queue.revision=="number"?W.queue.revision:x;W=await o(u,{...f,root_dir:y,expected_revision:ne})}return W&&W.queue&&y&&ye.set(y,W.queue),W}function V(u,f){let y=ye.get(u),x=s&&s.get?s.get():null,B=(Array.isArray(x)?x:[]).find(ne=>ne?.root_dir===u);return(y||B)?.merge_queue?.find(ne=>ne.bead_id===f)?.continuation_action}async function ee(u,f,y,x){let B=await ge(u,f,y,x),W=ye.get(y)?.revision??B?.queue?.revision??x;return Nn(B,(ne,me)=>ge(u,{...f,continuation:ne,decision_token:me},y,W,!1),{refresh:ne=>ge(u,f,y,ne?.queue?.revision??ye.get(y)?.revision??W,!1)})}async function ce(u,f,y,x){let B=await Nn({continuation_mismatch:x},(ne,me)=>ge("worker-merge-queue-add",{bead_id:f,continuation:ne,decision_token:me},u,y,!1)),W=B?.queue?.merge_queue?.find(ne=>ne.bead_id===f)?.continuation_action;B?.applied!==!0&&W?.continuation===null&&W.mismatch&&await ce(u,f,B.queue.revision,W.mismatch)}async function ve(u,f,y){let x=await ge("worker-discard",u,f,y);if(x&&x.discarded===!0){ae(Go(x),"success",5e3);return}if(x&&x.reason){ae(`\uD3D0\uAE30 \uC2E4\uD328: ${x.reason}`,"error");return}if(x&&x.accepted&&x.pending==="merged_revert"){ae("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(x&&x.accepted){ae(`\uD3D0\uAE30 \uC9C4\uD589: ${x.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}x&&!x.conflict&&ae("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function De(u,f,y){return!o||!y?null:await o(u,{...f,root_dir:y})}async function le(){let u=new Map;for(let f of H.pr_wait)u.has(f.root_dir)||u.set(f.root_dir,f.expected_revision);for(let[f,y]of u)await ge("worker-merge-queue-add-all",{},f,y)}function ze(u){let f=j[u];return!!(f&&f.runnable===!0)}function P(u){let f={...j[u]||{}};f.runnable=!f.runnable,j={...j,[u]:f},rp(j),fe()}function ue(u){return j[u]===!0}function Me(u){j={...j,[u]:j[u]!==!0},rp(j),fe()}function qe(u){let f=H.queue_groups.find(y=>y.root_dir===u);if(!f)return null;for(let y=0;y<f.serial_lane_count;y+=1){let x=`s${y+1}`,B=f.sublanes.serial.find(W=>W.id===x);if(!B||B.raw_length===0&&B.occupied_by.length===0)return x}return null}function Le(u,f){let y=H.queue_groups.find(B=>B.root_dir===u),x=y?y.sublanes.serial.find(B=>B.id===f):void 0;return x?x.raw_length:0}function We(u,f){let y=X.get(u),x=X.get(f);if(!y||!x)return{kind:"note",text:"\uC0C1\uB300\uC758 \uD604\uC7AC \uC704\uCE58\uB97C \uC54C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"};let B=ep(y),W=ep(x);if(B!==null&&B===W&&y.root_dir===x.root_dir)return{kind:"note",text:"\uC774\uBBF8 \uAC19\uC740 \uC9C1\uB82C \uB808\uC778 \u2014 \uC21C\uC11C\uAC00 \uC788\uC2B5\uB2C8\uB2E4"};let ne=tp(y),me=tp(x);if(ne&&W!==null){let Je=W;return{kind:"ops",title:`${Je} \uB05D\uC5D0 ${u}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:x.root_dir,ops:[{bead_id:u,lane:Je,index:Le(x.root_dir,Je)}]}}if(B!==null&&me&&W===null){let Je=B;return{kind:"ops",title:`${Je} \uB05D\uC5D0 ${f}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:y.root_dir,ops:[{bead_id:f,lane:Je,index:Le(y.root_dir,Je)}]}}if(ne&&B===null&&me&&W===null){let Je=qe(y.root_dir);return Je===null?{kind:"disabled",title:"\uBE48 \uC9C1\uB82C \uB808\uC778 \uC5C6\uC74C \u2014 Worker \uD0ED\uC5D0\uC11C \uB808\uC778 \uC218 \uC870\uC808"}:{kind:"ops",title:`${Je} \uB808\uC778\uC5D0 ${f} \u2192 ${u} \uC21C\uC11C\uB85C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:y.root_dir,ops:[{bead_id:f,lane:Je,index:0},{bead_id:u,lane:Je,index:1}]}}return!ne&&!me?{kind:"note",text:"\uB458 \uB2E4 \uC2E4\uD589 \uC911 \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"}:ne?{kind:"note",text:"\uC2E4\uD589 \uC911 \u2014 \uC885\uB8CC \uD6C4 \uCD9C\uBC1C\uD558\uB824\uBA74 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694"}:{kind:"note",text:"\uC2E4\uD589 \uC911 \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4\uB824\uBA74 \uC0C1\uB300\uB97C \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694"}}function je(u,f){let y=We(u,f.id);return{id:f.id,title:f.title,location_label:f.location_label,prefixes:f.prefixes,action:y.kind==="note"?{kind:"note",text:y.text}:y.kind==="disabled"?{kind:"disabled",label:Jd,title:y.title}:{kind:"place",label:Jd,title:y.title}}}function Ye(u,f){if(!z||z.bead_id!==u)return null;let y=z.counterpart_id,x=f.filter(B=>B.id===y);return x.length===0?null:{rows:x.map(B=>je(u,B))}}function tt(u){let f=u.dependency_chips||null,y=u.overlap_chips||[],x=u.scope_state==="missing",B=u.cross_lane_chip;if(!f&&y.length===0&&!x&&!B)return null;let W=Ye(u.id,y);return{...f||{},...y.length>0?{overlaps:y}:{},...x?{scope_missing:!0}:{},...B?{cross_lane:{lane_id:B.lane_id,label:B.label}}:{},...W?{popover:W}:{}}}function ct(u){let f=tt(u);return f?{...u,dependency_chips:f}:u}async function _t(u,f){let y=We(u,f);if(z=null,y.kind!=="ops"){fe();return}let x=Gt(y.root_dir,y.ops[0].bead_id);for(let B of y.ops){let W=await te(B,y.root_dir,x);if(W===null)break;x=W}fe()}async function te(u,f,y){try{let x=await ge("worker-queue-place",u,f,y,!1);if(x&&x.conflict)return ae("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!x||x.applied!==!0)return ae(x&&typeof x.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${x.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let B=x.queue?x.queue.revision:void 0;return typeof B!="number"?(ae("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):B}catch(x){return ae($e(x),"error"),null}}function J(u){let f=ze(u.root_dir);return l`<header class="mon2-sec__hd">
    ...
    </div>`}function Be(u){return Ce(u,l`${Ri(ct(u),Ke(u),{exec_chips_mode:"pinned_only",dep_action:!0,onOpenDoc:i?(f,y)=>i(y,u.root_dir):void 0})}${we(u.id)}`)}function Ge(){return H.runnable_flat?l`<div class="mon2-flat" data-drop="candidate">
  ...
  `}var bh=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function vp(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(X=>ae(X,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,d="",p=null;function b(){if(p)return p;let X=a.querySelector('[data-pane="execution"]');return X?(p=Jo(X,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:ye=>t.queueStore?.set?.(ye)}),p):null}function v(){return l`
    ...
    `}function $(){let X=r.get();return l`
      ...
      >
        ...
        ${X?l`
              ${bp(X,s(),Y)}
              ${hp(X,d,{onDraft:ye=>{d=ye},onAdd:ie,onRemove:z})}
              ${yp(X,q)}
            `:l`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function S(X){let ye=r.get();if(ye)try{let ke=await n("display-policy-set",{expected_revision:ye.revision,policy:X(ye)});N(ke),ke&&ke.conflict&&ke.policy&&(ke=await n("display-policy-set",{expected_revision:ke.policy.revision,policy:X(ke.policy)}),N(ke)),ke&&ke.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function N(X){X&&X.policy&&typeof X.policy=="object"&&r.set(X.policy)}function j(X){S(X)}function Y(X){let ye=r.get();if(!ye)return;let ke=!hh(X,ye);j(he=>yh(X,he,ke))}function ie(){let X=d.trim();X.length!==0&&(d="",j(ye=>ye.hidden_prefixes.includes(X)?{hidden_prefixes:ye.hidden_prefixes}:{hidden_prefixes:[...ye.hidden_prefixes,X]}),D())}function z(X){j(ye=>({hidden_prefixes:ye.hidden_prefixes.filter(ke=>ke!==X)}))}function q(X){let ye=r.get();if(!ye)return;let ke=ye.chips[X]===!1;j(()=>({chips:{[X]:ke}}))}function D(){Ve(l`
    ...
    </span>`}function D(he,se,xe){let ge=Cp(se,xe),V=se.available&&(se.held||ge>Yi),ee=V?`${Math.floor(ge/60)}\uBD84 \uC804 \uCE21\uC815`:"",ce=se.accounts.filter(ze=>!ze.active).length,ve=`usage-meter__group${V?" usage-meter__group--stale":""}`,De=l`<span class="usage-meter__provider"
        >${he.label}</span
      >
    ...
    </span>`}function E(he,se){let xe=Ap(he.pct),ge=$p(he.resetsAt,se);return l`<span
    ...
    >
      ...
      <span class="usage-meter__account-reset"
        >${ge.length>0?`\u21BB ${ge}`:""}</span
      >
    </span>`}function M(he,se){return kh.includes(se)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${he.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function re(he,se,xe){let ge=se.status==="ok",V=typeof se.ageSeconds=="number"&&se.ageSeconds>Yi,ee=a.get(Ep(he.key,se.number)),ce=r.get(he.key),ve=ce!==void 0,De=ce===se.number,le=["usage-meter__account"];return se.active&&le.push("usage-meter__account--active"),ge||le.push("usage-meter__account--unavailable"),V&&le.push("usage-meter__account--stale"),l`<div class=${le.join(" ")}>
...
`):[];return l`<div
    ...
    </div>`}function $(){Ve(v(),r)}async function S(){if(o!=="ready")return;let D=await un(a);ae(D?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",D?"success":"error")}function N(D){D.key==="Escape"&&s&&(D.preventDefault(),z())}function j(){p||(document.addEventListener("keydown",N),p=!0)}function Y(){p&&(document.removeEventListener("keydown",N),p=!1)}async function ie(D,U=null){let E=++c;j(),s={...D},d=U||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",$(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let re=t?t():"";if(!re){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",$();return}if(!n){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",$();return}let Ae="/api/repo-ops-script?workspace="+encodeURIComponent(re)+"&lane="+encodeURIComponent(D.lane)+"&base_sha="+encodeURIComponent(D.base_sha);try{let be=await n(Ae),H=await be.json().catch(()=>({}));if(E!==c)return;if((t?t():"")!==re){z();return}if(!be.ok||!H||H.ok!==!0){o="error",i=Fh(H&&typeof H.error=="string"?H.error:""),$();return}s={lane:H.lane,base_sha:H.base_sha,path:H.path,base_ref:H.base_ref},a=String(H.content),o="ready",$()}catch{if(E!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",$()}}function z(){c+=1,Y(),s=null,a="",$();let D=d;d=null,D?.isConnected&&D.focus()}function q(){z(),r.remove()}return{open:ie,close:z,destroy:q}}function Fp(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let E=o();return typeof E.revision=="number"?E.revision:0}function i(E){t&&E&&E.queue&&typeof E.queue=="object"&&t.set(E.queue)}function c(){let E=o().workspace_info;return E&&typeof E=="object"?E:{}}function d(E,M){return l`<span
...
${Tt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:F==="done"?bn(_.attempts||{},oe.bead_id):null,work_ms:F==="done"?zo(_.attempts||{},oe.bead_id):null,done_at:F==="done"&&typeof oe.added_at=="number"?oe.added_at:void 0,exec_chips:Xe?Je(oe.bead_id):null,workflow:Xe&&zn[oe.bead_id]||null,from_id:Tn.get(oe.bead_id)||void 0,priority:on.get(oe.bead_id),...or(oe.bead_id)}}),kr=_.attempts?Object.values(_.attempts).filter(Wr):[],ba=new Set;for(let h of kr)h&&typeof h.resumed_from=="string"&&h.resumed_from.length>0&&ba.add(h.resumed_from);let ul=new Map;for(let h of kr)ul.set(h.bead_id,h.attempt_id);let Vr=new Map;for(let h of kr)Vr.set(h.attempt_id,h);function ha(h){let F=new Set,oe=h;for(;oe&&!F.has(oe.attempt_id);){if(oe.conflict_resolution===!0)return!0;F.add(oe.attempt_id),oe=typeof oe.resumed_from=="string"&&oe.resumed_from.length>0&&Vr.get(oe.resumed_from)||null}return!1}let Ds=typeof _.declared_base=="string"?_.declared_base:null;function kf(h){let F=null;for(let oe of kr)!oe||oe.bead_id!==h||ha(oe)||(F===null||(typeof oe.started_at=="number"?oe.started_at:0)>=(typeof F.started_at=="number"?F.started_at:0))&&(F=oe);return F&&typeof F.target_base=="string"?F.target_base:null}let ya=[],Ms=[],$f=Op(_),dl=h=>{let F=typeof h.session_id=="string"&&h.session_id.length>0,oe=ba.has(h.attempt_id);return{eligible:F&&!oe,reason:F?oe?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},vn=null;for(let h of kr){let F=h.status==="paused"&&!ba.has(h.attempt_id);if(h.status==="running"||F)Ms.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:Bt.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,speed:h.speed||null,continuation_mode:h.continuation_mode||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,paused:F,conflict_resolution:ha(h),base_exception:nl(Ds,h.target_base),can_pause:typeof h.session_id=="string"&&h.session_id.length>0,discard:Sn(Ps,h.bead_id,{attempt_id:h.attempt_id}),workflow:zn[h.bead_id]||null,priority:on.get(h.bead_id),usage:bn(_.attempts||{},h.bead_id),rollup:jt(h.bead_id),rollup_expanded:ke.has(h.bead_id),exec_chips:ne(h),...or(h.bead_id)});else if((h.status==="failed"||h.status==="orphaned")&&$f(h)){let oe=dl(h);ya.push({bead_id:h.bead_id,attempt_id:h.attempt_id,title:Bt.get(h.bead_id)||h.bead_id,runner:h.runner||null,model:h.model||null,effort:h.effort||null,speed:h.speed||null,continuation_mode:h.continuation_mode||null,started_at:typeof h.started_at=="number"?h.started_at:null,resumed_from:h.resumed_from||null,failed:!0,status:h.status,status_label:h.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Sn(Ps,h.bead_id,{attempt_id:h.attempt_id}),resume_eligible:oe.eligible,resume_reason:oe.reason,conflict_resolution:ha(h),base_exception:nl(Ds,h.target_base),workflow:zn[h.bead_id]||null,priority:on.get(h.bead_id),usage:bn(_.attempts||{},h.bead_id),rollup:jt(h.bead_id),rollup_expanded:ke.has(h.bead_id),exec_chips:ne(h),...or(h.bead_id)}),vn=h}}let pl=new Set([...ya,...Ms].map(h=>h.bead_id));for(let h of Array.isArray(_.session_active)?_.session_active:[]){let F=h&&h.bead_id;typeof F!="string"||F.length===0||pl.has(F)||(pl.add(F),Ms.push({bead_id:F,attempt_id:null,kind:"session",title:h.title||Bt.get(F)||F,status:"in_progress",started_at:Cn(h.started_at)??Cn(h.updated_at),updated_at:Cn(h.updated_at),workflow:h.workflow||null,priority:on.get(F),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,usage:null,rollup:null,rollup_expanded:!1}))}let $r=[...ya,...Ms].map(h=>{let F=Vr.get(h.attempt_id),oe=F?.quickfix_landing;if(F?.quickfix_lane!==!0||!oe||typeof oe!="object")return h;let Fe=typeof oe.reason=="string"&&oe.reason.length>0?oe.reason:null,Xe=Cs({bead_id:F.bead_id,merge_sha:oe.head_sha,cleanup_cursor:oe.cursor,cleanup_failed:Fe?{step:oe.cursor,reason:Fe}:null,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]});return Xe?{...h,landing:Xe}:h}),fl=null;if(vn){let h=dl(vn),F=vn.cause_detail;fl={bead_id:vn.bead_id,repo:vn.repo||"",reason:vn.cause||vn.status,cause_detail:F&&typeof F.reason=="string"?{reason:F.reason,command:typeof F.command=="string"?F.command:null}:null,resume_attempt_id:vn.attempt_id,resume_eligible:h.eligible,resume_reason:h.reason,discard:Sn(Ps,vn.bead_id,{attempt_id:vn.attempt_id})}}let _l=new Set($r.map(h=>h.bead_id)),va=Array.isArray(_.merge_queue)?_.merge_queue:[],ml=new Map,gl=new Map,bl=new Map,hl=new Map,yl=new Map;va.forEach((h,F)=>{h&&typeof h.bead_id=="string"&&(ml.set(h.bead_id,F+1),gl.set(h.bead_id,h.resolution),bl.set(h.bead_id,h.continuation_action||null),hl.set(h.bead_id,h.head_review||null),yl.set(h.bead_id,h.authority||null))});let xr=_.merge_queue_state||{active:null,failures:{}},xf=xr.failures||{},vl=xr.waiting&&typeof xr.waiting.bead_id=="string"&&typeof xr.waiting.reason=="string"?xr.waiting:null,Af=_.auto_merge_skips||{},wl=h=>{let F=Af[h];if(!F)return null;let oe=Gr[h],Fe=oe&&oe.pr?oe.pr.head_sha:null;return Fe&&Fe===F.head_sha?F.reason||"":null},Ns=new Map;for(let h of $r)h.failed!==!0&&h.conflict_resolution&&(h.paused?Ns.has(h.bead_id)||Ns.set(h.bead_id,"paused"):Ns.set(h.bead_id,"running"));let kl=$r.filter(h=>h.kind!=="session"&&!h.paused&&h.failed!==!0).length,$l=(_.workspace_info||{}).slots,xl=typeof $l=="number"?$l:typeof _.slots=="number"?_.slots:da,Sf=kl>xl,qs=dr(U),Ef=(Array.isArray(_.done)?_.done.slice():[]).filter(h=>qs===void 0||typeof h.added_at!="number"||h.added_at>=qs).sort((h,F)=>(F.added_at||0)-(h.added_at||0)),Kr=ga(Ef,"done"),Tf=new Set((Array.isArray(_.done)?_.done:[]).map(h=>h?.bead_id).filter(h=>typeof h=="string")),Al=[],Cf=d?.()||"";for(let h of A){let F=Cn(h.closed_at);if(typeof h.id!="string"||Tf.has(h.id)||F===null||qs!==void 0&&F<qs||typeof h.comment_count!="number"||h.comment_count<=0)continue;let oe=`${Cf}\0${h.id}\0${String(h.updated_at)}\0${h.comment_count}`,Fe=E.get(oe);Fe===void 0&&n&&(E.set(oe,"pending"),Promise.resolve(n("get-comments",{id:h.id})).then(Xe=>{let kt=Array.isArray(Xe)&&Xe.some(Tt=>To(typeof Tt?.text=="string"?Tt.text:"")?.lane==="session");E.set(oe,kt?"session":"not-session"),Ue()}).catch(()=>{E.set(oe,"failed"),Ue()})),Fe==="session"&&Al.push({id:h.id,title:h.title||h.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:F,created_at:h.created_at,updated_at:h.updated_at})}Kr.push(...Al),Kr.sort((h,F)=>(F.done_at||0)-(h.done_at||0));let Fs={};for(let h of On)Fs[h]=0;let Sl=!1,El=0,wa=0,Tl=0;for(let h of Kr){let F=h.usage;if(F&&typeof F=="object"){let oe=!1;for(let Fe of On)Number.isFinite(F[Fe])&&(Fs[Fe]+=F[Fe],Sl=!0,oe=!0);oe&&(wa+=1,Number.isFinite(F.total_cost_usd)&&(El+=F.total_cost_usd,Tl+=1))}}wa>0&&Tl===wa&&(Fs.total_cost_usd=El);let Cl=Kr.map(h=>h.usage).filter(h=>h&&typeof h=="object"&&h.providers),Rf=Cl.length>0?Wt(fo(Cl)):Sl?qn(Fs):null,Rl=_.lane_states&&typeof _.lane_states=="object"&&!Array.isArray(_.lane_states)?_.lane_states:{},Ol=Array.isArray(_.serial_lanes)?_.serial_lanes:[],Ll=h=>{if(Gn.some(Fe=>Fe.bead_id===h))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let F=kr.filter(Fe=>Fe&&Fe.bead_id===h),oe=F.length>0?F[F.length-1].status:null;return oe==="failed"||oe==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":oe==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},js=Ol.filter(h=>h&&typeof h.id=="string"&&Array.isArray(h.entries)).map((h,F)=>{let oe=Rl[h.id]||{},Fe=new Map((Array.isArray(oe.corrections)?oe.corrections:[]).filter(ft=>ft&&typeof ft.bead_id=="string"&&typeof ft.after=="string").map(ft=>[ft.bead_id,ft.after])),Xe=ga(h.entries.filter(ft=>!_l.has(ft.bead_id)),h.id).map(ft=>Fe.has(ft.id)?{...ft,badges:[`\u{1F517} ${Fe.get(ft.id)} \uB4A4 (blocks \uC790\uB3D9)`,...ft.badges]}:ft),kt=Array.isArray(oe.occupied_by)?oe.occupied_by.filter(ft=>typeof ft=="string"):[],Tt=kt.map(ft=>({id:ft,title:Bt.get(ft)||ft,draggable:!1,lane:h.id,ghost:!0,badges:[Ll(ft)]}));return{id:h.id,index:F+1,rows:[...Tt,...Xe],occupied:kt.length>0,badge:kt.length>0?Ll(kt[0]):"\uB300\uAE30",cycle:oe.cycle===!0}}),Il=typeof _.serial_lane_count=="number"?_.serial_lane_count:js.length,ka=ga(fa.filter(h=>!_l.has(h.bead_id)),"queue"),Pl=new Map,Dl=new Set;for(let[h,F]of Object.entries(Rl)){if(!/^s[1-5]$/.test(h))continue;let oe=F&&Array.isArray(F.occupied_by)?F.occupied_by:[];for(let Fe of oe)typeof Fe=="string"&&Pl.set(Fe,h);oe.length>0&&Dl.add(h)}let Ar=[];for(let h of $r)typeof h.bead_id=="string"&&Ar.push({id:h.bead_id,title:Bt.get(h.bead_id)||h.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:Pl.get(h.bead_id)??null});for(let h of js)for(let F of h.rows)F.ghost!==!0&&Ar.push({id:F.id,title:F.title,location_label:`${h.id} #${F.seq??""}`.trim(),kind:"serial",lane_id:h.id});ka.forEach((h,F)=>{Ar.push({id:h.id,title:h.title,location_label:`#${F+1}`,kind:"parallel",lane_id:null})});for(let h of ma)Ar.push({id:h.id,title:h.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let Ml={};for(let h of Ol)h&&typeof h.id=="string"&&Array.isArray(h.entries)&&(Ml[h.id]=h.entries.length);let $a=new Map;for(let h of Ar)$a.has(h.id)||$a.set(h.id,h);q={members_by_id:$a,serial_raw_lengths:Ml,serial_lane_count:Il,occupied_lanes:Dl};let Nl=Pp(_.bead_scope,Ar),xa=(h,F)=>{let oe=Nl.get(h.id);if(!oe||oe.overlaps.length===0&&!oe.scope_missing)return h;let Fe=Te(h.id,oe.overlaps);return h.dependency_chips={...h.dependency_chips||{},...oe.overlaps.length>0?{overlaps:oe.overlaps}:{},...oe.scope_missing&&F!=="running"?{scope_missing:!0}:{},...Fe?{popover:Fe}:{}},h};for(let h of ka)xa(h,"queue");for(let h of js)for(let F of h.rows)F.ghost!==!0&&xa(F,h.id);for(let h of ma)xa(h,"candidate");let ql=new Map;for(let h of $r){let F=typeof h.bead_id=="string"?h.bead_id:"";if(F.length===0)continue;let oe=h.kind==="session",Fe=Nl.get(F),Xe=Fe&&Fe.overlaps.length>0?Fe.overlaps:null,kt=typeof h.attempt_id=="string"&&h.attempt_id.length>0?Vr.get(h.attempt_id):void 0,Tt=kt&&kt.last_activity&&typeof kt.last_activity=="object"?kt.last_activity:null,ft=kt&&Array.isArray(kt.legs)?kt.legs:[];if(!Xe&&!Tt&&ft.length===0&&!oe)continue;let tn=Xe?Te(F,Xe):null;ql.set(F,{...Tt?{last_activity:Tt}:{},...ft.length>0?{legs:ft}:{},...Xe?{dependency_chips:{overlaps:Xe,...tn?{popover:tn}:{}}}:{}})}return{queue:_,idToTitle:Bt,candidates:ma,candidate_hidden:{blocked:_a.hidden_blocked,spec:_a.hidden_spec},running:$r,live_count:kl,slots:xl,over_cap:Sf,failure:fl,waiting:ka,serial_lanes:js,serial_lane_count:Il,running_overlays:ql,pr_wait:Gn.map(h=>Cy(h.bead_id,Bt.get(h.bead_id)||h.bead_id,Gr,at[h.bead_id]||null,bn(_.attempts||{},h.bead_id),Ne[h.bead_id]||(be.has(h.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:H.has(h.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),Ns.get(h.bead_id)||null,h.external===!0,{position:ml.get(h.bead_id)||0,active:xr.active===h.bead_id,failure:xf[h.bead_id]||null,waiting:vl?.bead_id===h.bead_id?vl.reason:null,resolution:gl.get(h.bead_id),continuation_action:bl.get(h.bead_id),head_review:hl.get(h.bead_id)||null,authority:yl.get(h.bead_id)||null},h.wt_present!==!1,_.auto_merge===!0?wl(h.bead_id):null,nl(Ds,kf(h.bead_id)),_.completion_status&&typeof _.completion_status=="object"&&!Array.isArray(_.completion_status)&&_.completion_status[h.bead_id]||null,_.discard_operations&&typeof _.discard_operations=="object"&&!Array.isArray(_.discard_operations)?_.discard_operations:{},Vr.get(ul.get(h.bead_id)||"")?.worker_serial===!0,_.auto_merge===!0,{merge_sha:h.merge_sha,cleanup_cursor:h.cleanup_cursor,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]})).map(h=>({...h,workflow:zn[h.id]||null,priority:on.get(h.id),...or(h.id)})),merge_queue_length:va.length,merge_queue_running:va.length>0,auto_excluded:Gn.map(h=>h.bead_id).filter(h=>wl(h)!==null),declared_base:Ds,done:Kr,token_total:Rf,cleanup_failures:an,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]}}function Se(){let w=!!o?.get()?.job,m=!w&&o?.isPending?.()===!0,A=w?"\uBD84\uC11D \uC911":m?"\uC900\uBE44 \uC911":"";return l`<button
    ...
    >`,x=l`<label class="worker-tgl worker-slots"
      ...
      <label
        ...
        <select class="worker-serial-lane-count" aria-label="직렬 레인 수">
          ${Array.from({length:Vp},(ne,me)=>me+1).map(ne=>l`<option
                value=${String(ne)}
      ...
      ${o?Se():""} `,B=wd({failure:_.failure}),W=fd(_.repo_operations,_.cleanup_failures);return Ae?l`<div class="worker-ribbon">
          ${m} ${A}
    ...
    >
      ▶ 자동 머지${A>0?` ${A}`:""}
        ...
        ${gt(_)}
        ${yn({id:"worker-pane-queue",lane:"queue",title:"\uBCD1\uB82C \uB300\uAE30",items:_.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:re.queue,preview:Zp(_.waiting)})}
        ${_.serial_lanes.map(m=>Pt(m))}
        ${w}
        ${yn({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:_.done,empty:`${M()} \uC644\uB8CC \uC5C6\uC74C`,controls:Mt(),collapsible:!0,collapsed:re.done,preview:Array.isArray(_.token_total)?_.token_total.map(m=>m.label).join(" \xB7 "):_.token_total||Zp(_.done)})}
    ...
    `}function q(){let U=t.getState(),E=U.workspace?.current,M=U.workspace?.available||[],re=new Set(U.workspace?.hidden||[]),Ae=E?.path||M[0]?.path||"";if(M.length===0)return l``;let be=M.filter(H=>!re.has(H.path)||H.path===Ae);if(be.length<=1){let H=be[0]||M[0],X=sl(H.path);return l`
