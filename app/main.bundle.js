...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+pt(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},Lt=new al;function ae(t,e){return Lt.parse(t,e)}ae.options=ae.setOptions=function(t){return Lt.setOptions(t),ae.defaults=Lt.defaults,uo(ae.defaults),ae};ae.getDefaults=En;ae.defaults=It;ae.use=function(...t){return Lt.use(...t),ae.defaults=Lt.defaults,uo(ae.defaults),ae};ae.walkTokens=function(t,e){return Lt.walkTokens(t,e)};ae.parseInline=Lt.parseInline;ae.Parser=at;ae.parser=at.parse;ae.Renderer=Mr;ae.TextRenderer=Nn;ae.Lexer=it;ae.lexer=it.lex;ae.Tokenizer=Or;ae.Hooks=cr;ae.parse=ae;var _d=ae.options,bd=ae.setOptions,wd=ae.use,kd=ae.walkTokens,yd=ae.parseInline;var vd=at.parse,$d=it.lex;function vo(t){let e=ae.parse(t),r=eo.sanitize(e);return no(r)}function ll(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function $o(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",l="";function a(v){v.key==="Escape"&&s&&(v.preventDefault(),w())}document.addEventListener("keydown",a);function d(){return s?u`
...
${_l}`:r}function Pn(t,e){let r=null;for(let n of Object.values(t||{}))n&&n.bead_id===e&&(r=n.usage||null);return r}function Fn(t){let e=t.draggable&&!t.done,r=Array.isArray(t.badges)?t.badges:[],n=Ht(t.usage),s=t.merge_step||null,o=t.lane==="pr_wait",i=e?u`<span class="worker-mini__grip" aria-hidden="true">⠿</span>`:"",l=u`<span class="worker-mini__id" title="클릭하면 ID 복사"
  ...
  >
    ...
    <pre>${t}</pre>
  </details>`:""}function $l(t){return t?u`<div class="worker-banner__log-path">
    전체 로그: <code>${t}</code>
  </div>`:""}function xl(t){if(!Number.isFinite(t)||t<0)return"0s";let e=Math.floor(t/1e3),r=Math.floor(e/60),n=e%60;return r>0?`${r}m ${String(n).padStart(2,"0")}s`:`${n}s`}function Bo(t){let e=Array.isArray(t.cleanupFailures)?t.cleanupFailures:[];return u`<div class="worker-banners">
  ...
  </div>`}function Sl(t,e,r=null){let n=!!t.paused,s=n?"\uC77C\uC2DC\uC815\uC9C0":typeof t.started_at=="number"?xl(e-t.started_at):"\u2014",o=[t.runner,t.model].filter(Boolean).join(" \xB7 "),i=Ht(t.usage),l=t.conflict_resolution?n?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,a=t.attempt_id&&t.attempt_id===r;return u`<div
  ...
  >
    ...
    >
      ...
      .value=${v}
    >
      ${Il.map(c=>u`<option value=${c.value} ?selected=${v===c.value}>
            ${c.label}
          </option>`)}
