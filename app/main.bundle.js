...
`).trim()}}var zl=20;function Hl(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function Vf(e){return e.length>zl?`${e.slice(0,zl)}\u2026`:e}function Kf(e,t,r,n){let s=`${t.lane} ${Vf(t.identifier)}`;return c`<div class="detail-report">
  ...
  `}function y_(e){let t=nn(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return c`<div class="detail-prompt__missing">
    ...
    `}function _(u){let R=u.metadata||{},x=u.workflow||{},V=x.stages||{},we=V.spec&&V.spec.stale,ke=V.impl&&V.impl.stale,Ze=V.plan||null,Ue=x.route_source==="derived",mt=x.route||R.route||"\u2014";return c`
      ...
      ${x.route!=="quick_fix"||Object.hasOwn(R,"spec_review")?c`<div class="detail-kv">
            ...
            <span class="detail-kv__v"
              >${R.spec_review||"\uC5C6\uC74C"}${we?" \xB7 stale":""}</span
            >
          </div>`:""}
      ...
      ${x.route!=="quick_fix"||Object.hasOwn(R,"impl_review")?c`<div class="detail-kv">
            ...
            <span class="detail-kv__v"
              >${R.impl_review||"\uC5C6\uC74C"}${ke?" \xB7 stale":""}</span
            >
          </div>`:""}
    ...
    `}function dt(){if(!d)return c``;let u=p||{},R=String(u.id||d),x=u.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",V=$e(),we=u.status||"open",ke=typeof u.priority=="number"?Math.max(0,Math.min(4,u.priority)):"",Ze=u.description||"",Ue={...u,metadata:{...u.metadata||{},...f}};return c`
