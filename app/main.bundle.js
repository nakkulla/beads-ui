...
\f\r"'\`<>=]|("|')|))|$)`,"g"),bc=/'/g,hc=/"/g,wc=/^(?:script|style|textarea|title)$/i,aa=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),c=aa(1),gs=aa(2),nw=aa(3),Cn=Symbol.for("lit-noChange"),Ut=Symbol.for("lit-nothing"),yc=new WeakMap,yr=vr.createTreeWalker(vr,129);function kc(e,t){if(!ia(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return _c!==void 0?_c.createHTML(t):t}var $c=(e,t)=>{let n=e.length-1,r=[],s,o=t===2?"<svg>":t===3?"<math>":"",i=ds;for(let a=0;a<n;a++){let l=e[a],u,d,m=-1,v=0;for(;v<l.length&&(i.lastIndex=v,d=i.exec(l),d!==null);)v=i.lastIndex,i===ds?d[1]==="!--"?i=mc:d[1]!==void 0?i=gc:d[2]!==void 0?(wc.test(d[2])&&(s=RegExp("</"+d[2],"g")),i=hr):d[3]!==void 0&&(i=hr):i===hr?d[0]===">"?(i=s??ds,m=-1):d[1]===void 0?m=-2:(m=i.lastIndex-d[2].length,u=d[1],i=d[3]===void 0?hr:d[3]==='"'?hc:bc):i===hc||i===bc?i=hr:i===mc||i===gc?i=ds:(i=hr,s=void 0);let b=i===hr&&e[a+1].startsWith("/>")?" ":"";o+=i===ds?l+I_:m>=0?(r.push(u),l.slice(0,m)+sa+l.slice(m)+Qn+b):l+Qn+(m===-2?a:b)}return[kc(e,o+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},ms=class e{constructor({strings:t,_$litType$:n},r){let s;this.parts=[];let o=0,i=0,a=t.length-1,l=this.parts,[u,d]=$c(t,n);if(this.el=e.createElement(u,r),yr.currentNode=this.el.content,n===2||n===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=yr.nextNode())!==null&&l.length<a;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith(sa)){let v=d[i++],b=s.getAttribute(m).split(Qn),k=/([.?@])?(.*)/.exec(v);l.push({type:1,index:o,name:k[2],strings:b,ctor:k[1]==="."?ho:k[1]==="?"?yo:k[1]==="@"?vo:kr}),s.removeAttribute(m)}else m.startsWith(Qn)&&(l.push({type:6,index:o}),s.removeAttribute(m));if(wc.test(s.tagName)){let m=s.textContent.split(Qn),v=m.length-1;if(v>0){s.textContent=go?go.emptyScript:"";for(let b=0;b<v;b++)s.append(m[b],fs()),yr.nextNode(),l.push({type:2,index:++o});s.append(m[v],fs())}}}else if(s.nodeType===8)if(s.data===oa)l.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(Qn,m+1))!==-1;)l.push({type:7,index:o}),m+=Qn.length-1}o++}}static createElement(t,n){let r=vr.createElement("template");return r.innerHTML=t,r}};function wr(e,t,n=e,r){if(t===Cn)return t;let s=r!==void 0?n._$Co?.[r]:n._$Cl,o=_s(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=s:n._$Cl=s),s!==void 0&&(t=wr(e,s._$AS(e,t.values),s,r)),t}var bo=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,s=(t?.creationScope??vr).importNode(n,!0);yr.currentNode=s;let o=yr.nextNode(),i=0,a=0,l=r[0];for(;l!==void 0;){if(i===l.index){let u;l.type===2?u=new Fr(o,o.nextSibling,this,t):l.type===1?u=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(u=new wo(o,this,t)),this._$AV.push(u),l=r[++a]}i!==l?.index&&(o=yr.nextNode(),i++)}return yr.currentNode=vr,s}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},Fr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,s){this.type=2,this._$AH=Ut,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=wr(this,t,n),_s(t)?t===Ut||t==null||t===""?(this._$AH!==Ut&&this._$AR(),this._$AH=Ut):t!==this._$AH&&t!==Cn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):vc(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Ut&&_s(this._$AH)?this._$AA.nextSibling.data=t:this.T(vr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=ms.createElement(kc(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(n);else{let o=new bo(s,this),i=o.u(this.options);o.p(n),this.T(i),this._$AH=o}}_$AC(t){let n=yc.get(t.strings);return n===void 0&&yc.set(t.strings,n=new ms(t)),n}k(t){ia(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,s=0;for(let o of t)s===n.length?n.push(r=new e(this.O(fs()),this.O(fs()),this,this.options)):r=n[s],r._$AI(o),s++;s<n.length&&(this._$AR(r&&r._$AB.nextSibling,s),n.length=s)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},kr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,s,o){this.type=1,this._$AH=Ut,this._$AN=void 0,this.element=t,this.name=n,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Ut}_$AI(t,n=this,r,s){let o=this.strings,i=!1;if(o===void 0)t=wr(this,t,n,0),i=!_s(t)||t!==this._$AH&&t!==Cn,i&&(this._$AH=t);else{let a=t,l,u;for(t=o[0],l=0;l<o.length-1;l++)u=wr(this,a[r+l],n,l),u===Cn&&(u=this._$AH[l]),i||(i=!_s(u)||u!==this._$AH[l]),u===Ut?t=Ut:t!==Ut&&(t+=(u??"")+o[l+1]),this._$AH[l]=u}i&&!s&&this.j(t)}j(t){t===Ut?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ho=class extends kr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Ut?void 0:t}},yo=class extends kr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Ut)}},vo=class extends kr{constructor(t,n,r,s,o){super(t,n,r,s,o),this.type=5}_$AI(t,n=this){if((t=wr(this,t,n,0)??Ut)===Cn)return;let r=this._$AH,s=t===Ut&&r!==Ut||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==Ut&&(r===Ut||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},wo=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){wr(this,t)}},xc={M:sa,P:Qn,A:oa,C:1,L:$c,R:bo,D:vc,V:wr,I:Fr,H:kr,N:yo,U:vo,B:ho,F:wo},M_=ps.litHtmlPolyfillSupport;M_?.(ms,Fr),(ps.litHtmlVersions??(ps.litHtmlVersions=[])).push("3.3.1");var rt=(e,t,n)=>{let r=n?.renderBefore??t,s=r._$litPart$;if(s===void 0){let o=n?.renderBefore??null;r._$litPart$=s=new Fr(t.insertBefore(fs(),o),o,void 0,n??{})}return s._$AI(e),s};var ko="today",Ac=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}],jr=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"}];function Kn(e){return e==="today"?"today":"7d"}function la(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function $r(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function Sc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Ec(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Tc(){let e=null,t=[],n,r=new Set;function s(){for(let o of Array.from(r))try{o()}catch{}}return{get(){return e},getWorkspacesState(){return t},crossLanes(){return n},set(o,i,a){e=Array.isArray(o)?o:null,t=Array.isArray(i)?i:[],n=a===void 0?void 0:a!==null&&typeof a=="object"&&typeof a.revision=="number"&&Array.isArray(a.lanes)?{revision:a.revision,lanes:a.lanes}:null,s()},clear(){e=null,t=[],n=void 0,s()},subscribe(o){return r.add(o),()=>r.delete(o)}}}function Cc(){let e=new Map,t=new Set;function n(s){return s.startsWith("session-log:")?s:`session-log:${s}`}function r(){for(let s of Array.from(t))try{s()}catch{}}return{set(s,o,i=null){e.set(n(s),{lines:Array.isArray(o)?[...o]:[],last_event_at:typeof i=="number"?i:null}),r()},append(s,o){let i=n(s),a=e.get(i)||{lines:[],last_event_at:null};a.lines=[...a.lines,o],a.last_event_at=Date.now(),e.set(i,a),r()},get(s){return e.get(n(s))||null},clear(s){typeof s=="string"?e.delete(n(s)):e.clear(),r()},subscribe(s){return t.add(s),()=>t.delete(s)}}}var Pc=L_(Mc(),1);function qt(e){return(0,Pc.default)(`beads-ui:${e}`)}function Pn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function Ar(e,t){let n=Pn(e.created_at),r=Pn(t.created_at);if(n!==r)return n<r?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let i=e.id,a=t.id;return i<a?-1:i>a?1:0}function qc(e,t){let n=Pn(e.created_at),r=Pn(t.created_at);if(n!==r)return n<r?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let i=e.id,a=t.id;return i<a?-1:i>a?1:0}function Ao(e,t){let n=Pn(e.updated_at),r=Pn(t.updated_at);if(n!==r)return n<r?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function Fc(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let s=Pn(e.created_at),o=Pn(t.created_at);if(s!==o)return s<o?1:-1;let i=e.id,a=t.id;return i<a?-1:i>a?1:0}function jc(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var K_=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function Dc(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Nc(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=K_.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function Bc(e,t){let n=Dc(e),r=Dc(t);if(n!==r)return n<r?-1:1;let s=Nc(e),o=Nc(t);if(s!==o)return s<o?-1:1;let i=Pn(e&&e.created_at),a=Pn(t&&t.created_at);if(i!==a)return i<a?-1:1;let l=e&&e.id,u=t&&t.id;return l===u?0:String(l)<String(u)?-1:1}var ca=2**20;function zr(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-Pn(e&&e.created_at)}function So(e){return(t,n)=>{let r=zr(t,e),s=zr(n,e);if(r!==s)return r<s?-1:1;let o=t?.id,i=n?.id;return o<i?-1:o>i?1:0}}function ua(e,t,n){let r=Array.isArray(e)?e:[],s=r.length,o=Math.max(0,Math.min(t,s-1)),i=o-1>=0?r[o-1]:null,a=o+1<s?r[o+1]:null;if(!i&&!a)return{rank:0};if(!i)return{rank:zr(a,n)-ca};if(!a)return{rank:zr(i,n)+ca};let l=zr(i,n),u=zr(a,n),d=(l+u)/2;return l<d&&d<u?{rank:d}:{renormalize:r.map((m,v)=>({bead_id:m.id,rank:v*ca}))}}function da(e,t={}){let n=qt(`issue-store:${e}`),r=new Map,s=[],o=0,i=new Set,a=!1,l=t.sort||Ar;function u(){for(let v of Array.from(i))try{v()}catch{}}function d(){s=Array.from(r.values()).sort(l)}function m(v){if(a||!v||v.id!==e)return;let b=Number(v.revision)||0;if(n("apply %s rev=%d",v.type,b),!(b<=o&&v.type!=="snapshot")){if(v.type==="snapshot"){if(b<=o)return;r.clear();let k=Array.isArray(v.issues)?v.issues:[];for(let N of k)N&&typeof N.id=="string"&&N.id.length>0&&r.set(N.id,N);d(),o=b,u();return}if(v.type==="upsert"){let k=v.issue;if(k&&typeof k.id=="string"&&k.id.length>0){let N=r.get(k.id);if(!N)r.set(k.id,k);else{let W=Number.isFinite(N.updated_at)?N.updated_at:0,K=Number.isFinite(k.updated_at)?k.updated_at:0;if(W<=K){for(let le of Object.keys(N))le in k||delete N[le];for(let[le,Y]of Object.entries(k))N[le]=Y}}d()}o=b,u()}else if(v.type==="delete"){let k=String(v.issue_id||"");k&&(r.delete(k),d()),o=b,u()}}}return{id:e,subscribe(v){return i.add(v),()=>{i.delete(v)}},applyPush:m,snapshot(){return s},size(){return r.size},getById(v){return r.get(v)},dispose(){a=!0,r.clear(),s=[],i.clear(),o=0}}}function Eo(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let i=e.params[o];n[o]=String(i)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function Uc(e){let t=qt("subs"),n=new Map,r=new Map;function s(a,l){t("applyDelta %s +%d ~%d -%d",a,(l.added||[]).length,(l.updated||[]).length,(l.removed||[]).length);let u=r.get(a);if(!u||u.size===0)return;let d=Array.isArray(l.added)?l.added:[],m=Array.isArray(l.updated)?l.updated:[],v=Array.isArray(l.removed)?l.removed:[];for(let b of Array.from(u)){let k=n.get(b);if(!k)continue;let N=k.itemsById;for(let W of d)typeof W=="string"&&W.length>0&&N.set(W,!0);for(let W of m)typeof W=="string"&&W.length>0&&N.set(W,!0);for(let W of v)typeof W=="string"&&W.length>0&&N.delete(W)}}async function o(a,l){let u=Eo(l);if(t("subscribe %s key=%s",a,u),!n.has(a))n.set(a,{key:u,itemsById:new Map});else{let m=n.get(a);if(m&&m.key!==u){let v=r.get(m.key);v&&(v.delete(a),v.size===0&&r.delete(m.key)),n.set(a,{key:u,itemsById:new Map})}}r.has(u)||r.set(u,new Set);let d=r.get(u);d&&d.add(a);try{await e("subscribe-list",{id:a,type:l.type,params:l.params})}catch(m){let v=n.get(a)||null;if(v){let b=r.get(v.key);b&&(b.delete(a),b.size===0&&r.delete(v.key))}throw n.delete(a),m}return async()=>{t("unsubscribe %s key=%s",a,u);try{await e("unsubscribe-list",{id:a})}catch{}let m=n.get(a)||null;if(m){let v=r.get(m.key);v&&(v.delete(a),v.size===0&&r.delete(m.key))}n.delete(a)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:Eo,selectors:{getIds(a){let l=n.get(a);return l?Array.from(l.itemsById.keys()):[]},has(a,l){let u=n.get(a);return u?u.itemsById.has(l):!1},count(a){let l=n.get(a);return l?l.itemsById.size:0},getItemsById(a){let l=n.get(a),u={};if(!l)return u;for(let d of l.itemsById.keys())u[d]=!0;return u}}}}function Wc(){let e=qt("issue-stores"),t=new Map,n=new Map,r=new Set,s=new Map;function o(){for(let l of Array.from(r))try{l()}catch{}}function i(l,u,d){let m=u?Eo(u):"",v=n.get(l)||"",b=t.has(l);if(e("register %s key=%s (prev=%s)",l,m,v),b&&v&&m&&v!==m){let k=t.get(l);if(k)try{k.dispose()}catch{}let N=s.get(l);if(N){try{N()}catch{}s.delete(l)}let W=da(l,d);t.set(l,W);let K=W.subscribe(()=>o());s.set(l,K)}else if(!b){let k=da(l,d);t.set(l,k);let N=k.subscribe(()=>o());s.set(l,N)}return n.set(l,m),()=>a(l)}function a(l){e("unregister %s",l),n.delete(l);let u=t.get(l);u&&(u.dispose(),t.delete(l));let d=s.get(l);if(d){try{d()}catch{}s.delete(l)}}return{register:i,unregister:a,getStore(l){return t.get(l)||null},snapshotFor(l){let u=t.get(l);return u?u.snapshot().slice():[]},subscribe(l){return r.add(l),()=>r.delete(l)}}}function zc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Hc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function pa(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function V_(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),s=r>=0?n.slice(r+1):"";if(s){let a=new URLSearchParams(s).get("issue");if(a)return decodeURIComponent(a)}let o=/^\/issue\/([^\s?#]+)/.exec(n);return o&&o[1]?decodeURIComponent(o[1]):null}function Y_(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function Gc(e){let t=qt("router"),n=()=>{let r=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(r),o=s&&s[1]?decodeURIComponent(s[1]):V_(r),i=Y_(r);if(t("hash change \u2192 view=%s id=%s",i,o),e.setState({selected_id:i==="worker"?null:o,view:i,worker:{selected_parent_id:i==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let l=o?`#/${i}?issue=${encodeURIComponent(o)}`:`#/${i}`;window.location.hash!==l&&(window.location.hash=l)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",i=pa(o,r);t("goto issue %s (view=%s)",r,o),window.location.hash!==i?window.location.hash=i:e.setState({selected_id:o==="worker"?null:r,view:o,worker:{selected_parent_id:o==="worker"?r:null}})},gotoView(r){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=r==="worker"?s.worker?.selected_parent_id:s.selected_id,i=o?pa(r,o):`#/${r}`;t("goto view %s (id=%s)",r,o||""),window.location.hash!==i?window.location.hash=i:e.setState({view:r,selected_id:r==="worker"?null:s.selected_id})}}}var Z_=Object.freeze({workspace_config:{default_workspace:null}});function Kc(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:Z_.workspace_config.default_workspace}}}function Vc(e={}){let t=qt("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:Kc(e.config)},r=new Set;function s(){for(let o of Array.from(r))try{o(n)}catch{}}return{getState(){return n},setState(o){let i={...n,...o,filters:{...n.filters,...o.filters||{}},board:{...n.board,...o.board||{}},worker:{...n.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:n.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:n.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:n.workspace.hidden},config:o.config!==void 0?Kc(o.config):n.config},a=i.workspace.current?.path!==n.workspace.current?.path||i.workspace.available.length!==n.workspace.available.length||i.workspace.hidden.length!==n.workspace.hidden.length||i.workspace.hidden.some((u,d)=>u!==n.workspace.hidden[d]),l=i.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;i.selected_id===n.selected_id&&i.view===n.view&&i.filters.status===n.filters.status&&i.filters.search===n.filters.search&&i.filters.type===n.filters.type&&i.board.closed_filter===n.board.closed_filter&&i.worker.selected_parent_id===n.worker.selected_parent_id&&i.worker.show_closed_children.length===n.worker.show_closed_children.length&&i.worker.show_closed_children.every((u,d)=>u===n.worker.show_closed_children[d])&&!a&&!l||(n=i,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),s())},subscribe(o){return r.add(o),()=>r.delete(o)}}}function Yc(e){let t=qt("activity"),n=0,r=new Map,s=1;function o(){if(!e)return;let u=n>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function i(){n+=1,t("start count=%d",n),o()}function a(){let u=n;n=Math.max(0,n-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,n),o()}function l(u){return async(m,v)=>{let b=s++,k=Date.now();r.set(b,{type:m,start_ts:k}),t("request start id=%d type=%s count=%d",b,m,n+1),i();let N=!1,W=()=>{N||(N=!0,r.delete(b),a())},K=setTimeout(()=>{N||(t("request TIMEOUT id=%d type=%s elapsed=%dms",b,m,Date.now()-k),W())},3e4);try{let le=await u(m,v),Y=Date.now()-k;return t("request done id=%d type=%s elapsed=%dms",b,m,Y),le}catch(le){let Y=Date.now()-k;throw t("request error id=%d type=%s elapsed=%dms err=%o",b,m,Y,le),le}finally{clearTimeout(K),W()}}}return o(),{wrapSend:l,start:i,done:a,getCount:()=>n,getActiveRequests:()=>{let u=Date.now();return Array.from(r.entries()).map(([d,m])=>({id:d,type:m.type,elapsed_ms:u-m.start_ts}))}}}function ce(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function To(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function r(o,i,a){let l=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(i==="closed")return l.sort(jc),l;switch(a){case"created_desc":return l.sort(Ar),l;case"created_asc":return l.sort(qc),l;case"updated_desc":return l.sort(Ao),l;case"priority":return l.sort(Fc),l;case"manual":default:{let u=n();return u?l.sort(So(u)):l.sort(Ar),l}}}function s(o){let i=[];return e&&typeof e.subscribe=="function"&&i.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&i.push(t.subscribe(o)),()=>{for(let a of i)try{a()}catch{}}}return{selectBoardColumn:r,subscribe:s}}function Dn(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function on(e){let t=Dn(e);if(t===null)return"";let n=new Date(t),r=s=>String(s).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function wn(e,t){let n=Dn(e);if(n===null)return"";let s=(typeof t=="number"?t:Date.now())-n;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let i=Math.floor(s/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let a=Math.floor(s/864e5);if(a<7)return`${a}\uC77C \uC804`;let l=Math.floor(a/7);if(a<30)return`${l}\uC8FC \uC804`;let u=Math.floor(a/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(a/365)}\uB144 \uC804`}function Zc(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let s=Dn(r.updated_at)??0;if(t===null||s>n){t=r,n=s;continue}s===n&&String(r.id)<String(t.id)&&(t=r)}return t}function Co(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function Ro(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let s=Co(r);if(!s)continue;let o=n.get(s);o||(o=[],n.set(s,o)),o.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function Oo(e,t){let n=e.get(t)||[],r=0;for(let o of n)(o.status==="resolved"||o.status==="closed")&&(r+=1);let s=Zc(n);return{total:n.length,count:r,current:s,children:n}}function Lo(e){let t=e.transport,n=e.uiOrderStore;function r(i,a){return"renormalize"in i?i.renormalize:[{bead_id:a,rank:i.rank}]}function s(i,a){let l={...i.order};for(let u of a)l[u.bead_id]=u.rank;n&&n.set({revision:i.revision,order:l})}async function o(i,a,l){if(!t||!n)return;let u=n.get()||{revision:0,order:{}},d=r(ua(a,l,u.order),i);s(u,d);let m=await t("ui-order-set",{expected_revision:u.revision,entries:d});if(m&&m.conflict){let v={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};n.set(v);let b=r(ua(a,l,v.order),i);s(v,b);let k=await t("ui-order-set",{expected_revision:v.revision,entries:b});k&&k.applied&&n.set({revision:typeof k.revision=="number"?k.revision:0,order:k.order||{}})}else m&&m.applied&&n.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:o}}function Xc(e){if(typeof e!="string")return"";let t=e.indexOf("-");return t>0?e.slice(0,t):""}function Io(e,t){let n=Xc(e),r=Xc(t);return n.length===0||r.length===0?!1:n!==r}function Mo(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function fa(e,t){return!t||typeof e!="string"||e.length===0||Mo(t.visible_labels).includes(e)?!0:Mo(t.hidden_labels).includes(e)?!1:!Mo(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function Qc(e,t){return Mo(e).filter(n=>fa(n,t))}function cr(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function X_(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function Q_(e,t,n,r,s){return c`<button
  ...
  `}var mm=200,gm={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},bm=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),lu="beads-ui.board.sort",cu=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function hm(){try{let e=window.localStorage.getItem(lu);if(e&&cu.has(e))return e}catch{}return"created_desc"}function uu(e,t){let n=qt("views:board"),r=t.gotoIssue,s=t.issueStores,o=t.transport,i=t.uiOrderStore,a=t.displayPolicyStore,l=t.workerQueueStore,u=t.onClosedRangeChange,d=t.onNewIssue,m=t.openDoc,v=t.closedRange||ko,b=s?To(s,i):null,k=Lo({transport:o,uiOrderStore:i}),N=[],W=[],K=[],le=[],Y=[],B=[],D=!1,j=0,Z=hm(),V=new Map,ue=new Map,U=new Map,J=new Set,se={search:"",priority:"",type:"",labels:[]},ae=!1,he=null;function Ue(C){return String(C.status||"open")==="open"}function ge(C){let H=String(C.status||"open");return H==="open"||H==="blocked"}function X(C){let H=se.search.trim().toLowerCase(),Ie=se.priority,Be=se.type,xe=se.labels;return C.filter(lt=>{if(H){let st=String(lt.id||"").toLowerCase(),ve=String(lt.title||"").toLowerCase();if(!st.includes(H)&&!ve.includes(H))return!1}if(Ie!==""&&String(lt.priority)!==Ie||Be!==""&&String(lt.issue_type||"")!==Be)return!1;if(xe.length>0){let st=Array.isArray(lt.labels)?lt.labels:[];if(!xe.some(ve=>st.includes(ve)))return!1}return!0})}function Ee(){let C=new Set;for(let H of[N,W,K,le,Y,B])for(let Ie of H){let Be=Array.isArray(Ie.labels)?Ie.labels:[];for(let xe of Be)typeof xe=="string"&&xe.length>0&&C.add(xe)}return Array.from(C).sort()}function Le(){return se.search.trim()!==""||se.priority!==""||se.type!==""||se.labels.length>0}function T(){try{if(b){let C=b.selectBoardColumn("tab:board:in-progress","in_progress",Z),H=b.selectBoardColumn("tab:board:blocked","blocked",Z).filter(ge),Ie=new Set(C.map(F=>F.id)),Be=b.selectBoardColumn("tab:board:ready","ready",Z).filter(F=>Ue(F)&&!Ie.has(F.id)),xe=b.selectBoardColumn("tab:board:resolved","resolved",Z),lt=b.selectBoardColumn("tab:board:deferred","deferred",Z),st=b.selectBoardColumn("tab:board:closed","closed").slice(0,mm),ve=[...H,...Be,...C,...xe,...st];ne(ve);let Xe=new Set;for(let F of ve)F&&F.id&&!Co(F)&&Xe.add(F.id);let P=!Le();N=P?bs(H,Xe):H,W=P?bs(Be,Xe):Be,K=P?bs(C,Xe):C,le=P?bs(xe,Xe):xe,Y=lt,j=lt.length,B=P?bs(st,Xe):st,V=new Map;for(let F of N)V.set(F.id,"open");for(let F of W)V.set(F.id,"open");for(let F of K)V.set(F.id,"in_progress");for(let F of le)V.set(F.id,"resolved");for(let F of Y)V.set(F.id,"deferred");for(let F of B)V.set(F.id,"closed");ue=new Map;for(let F of N)ue.set(F.id,"blocked-col");for(let F of W)ue.set(F.id,"ready-col");for(let F of K)ue.set(F.id,"in-progress-col");for(let F of le)ue.set(F.id,"resolved-col");for(let F of B)ue.set(F.id,"closed-col")}pt()}catch{N=[],W=[],K=[],le=[],Y=[],B=[],U=new Map,pt()}}function ne(C){U=Ro(C)}function Ae(C){return Oo(U,C)}function we(C){return!J.has(C)}function Re(C,H){C.preventDefault(),C.stopPropagation(),J.has(H)?J.delete(H):J.add(H),pt()}function fe(C,H){C.preventDefault(),C.stopPropagation(),r(H)}function Se(C,H){C.preventDefault(),C.stopPropagation(),r(H)}function it(C,H){he||r(H)}function ht(C,H){C.preventDefault(),C.stopPropagation(),ym(H).then(Ie=>{Ie&&ce("\uBCF5\uC0AC\uB428","success",1200)})}function _t(C,H){he=H,C.dataTransfer&&(C.dataTransfer.setData("text/plain",H),C.dataTransfer.effectAllowed="move"),C.target.classList.add("board-card--dragging")}function wt(C){C.target.classList.remove("board-card--dragging"),It(),setTimeout(()=>{he=null},0)}function R(C){let H=String(C.target.value||"");!H||H===v||(v=H,u&&u(H),pt())}function oe(){return a?a.get():null}function Te(C){let H=l?l.get():null,Ie=H?H.cleanup_failed:null;if(!Ie||typeof Ie!="object"||Array.isArray(Ie))return null;let Be=Ie[C];return!Be||typeof Be!="object"||Array.isArray(Be)?null:Be}let Ne={onCardClick:it,onCopyId:ht,onDragStart:_t,onDragEnd:wt,onClosedRangeChange:R,rollupFor:Ae,isExpanded:we,onRollupToggle:Re,onChildClick:fe,onFromChipClick:Se,onOpenDoc:m?(C,H)=>m(H):void 0,cleanupFailureFor:Te,get policy(){return oe()}};function We(C,H){he||(Me(),r(H))}function Je(C,H){C.preventDefault(),C.stopPropagation(),Me(),r(H)}let tt={...Ne,onCardClick:We,onChildClick:Je,onFromChipClick:Je,onOpenDoc:m?(C,H)=>{Me(),m(H)}:void 0,get policy(){return oe()}};function bt(C){let H=C.target,Ie=e.querySelector(".board-filter__labels");H&&Ie&&Ie.contains(H)||ye()}function te(C){C.key==="Escape"&&ye()}function G(){ae||(ae=!0,document.addEventListener("mousedown",bt),document.addEventListener("keydown",te),pt())}function ye(){ae&&(ae=!1,document.removeEventListener("mousedown",bt),document.removeEventListener("keydown",te),pt())}function ct(C){C.key==="Escape"&&Me()}function nt(){D||(D=!0,document.addEventListener("keydown",ct),pt())}function Me(){D&&(D=!1,document.removeEventListener("keydown",ct),pt())}let Fe={onClose:Me,onOverlayClick(C){C.target===C.currentTarget&&Me()}},dt={onSearchInput(C){se.search=String(C.target.value||""),T()},onPriorityChange(C){se.priority=String(C.target.value||""),T()},onTypeChange(C){se.type=String(C.target.value||""),T()},onSortChange(C){let H=String(C.target.value||"");if(!(!cu.has(H)||H===Z)){Z=H;try{window.localStorage.setItem(lu,H)}catch{}T()}},onDeferredToggle(){D?Me():nt()},onLabelMenuToggle(){ae?ye():G()},onLabelToggle(C){let H=se.labels.indexOf(C);H===-1?se.labels.push(C):se.labels.splice(H,1),T()},onLabelClear(){se.labels.length!==0&&(se.labels=[],T())},onNewIssue(){d&&d()}};function at(){return c`
      <div class="board-view">
        ${au(se,dt,{sort_mode:Z,deferred_popup_open:D,deferred_count:j,label_options:Ee(),label_menu_open:ae})}
...
`);return c`<span
  ...
  >`,N=e.lane==="done"?"":ci(e.workflow),W=e.lane==="done"?"":sd(e.from_id),K=di(e.priority),le=c`<span class="worker-mini__title">${e.title}</span>`,Y=od(e.pr_url,e.pr_number),B=e.completion_repair_pr_url&&e.completion_repair_pr_number?c`<a
        ...
        >`:"",D=r.map(fe=>fe===e.live_badge?c`<span
        ...
        >`:c`<span
          ...
          >${fe}</span
        >`),j=e.reason?c`<span class="worker-mini__reason">${e.reason}</span>`:"",Z=s.length>0?s.map(fe=>c`<span class="worker-usage" title=${fe.tooltip}
              >${fe.label}</span
      ...
      >
        취소
      </button>`:"",J=e.timeline_action?c`<button
        type="button"
      ...
      >
        저장소 작업 보기
      </button>`:"",se=e.discard,ae=se?.action||e.discard_action?c`<button
          type="button"
        ...
        >
          ${se?.label||"\uD3D0\uAE30"}
        </button>`:"",he=e.stale_work||null,Ue=he?c`${he.can_resume||he.can_continue?c`<button
            type="button"
          ...
          >
            다시 확인
          </button>`:""}`:"",ge=he?c`<div class="worker-mini__stale">
        ...
        >
          승인하고 진행
        </button>`:"",Ee=!!(e.lane!=="pr_wait"&&!e.done&&e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)),Le=ui(e.rec),T=b||N||W||Ee||Le||Z?c`<div class="worker-chips">
          ${b}${N}${W}${Ee?ai(e.exec_chips,{pin:e.exec_chips_pinned===!0}):""}${Le}${Z}
        </div>`:"",ne=li(e.dependency_chips),Ae=Ms(e),we=t.actions?t.actions:"",Re=!!(i||e.merge_action||e.cancel_action||e.timeline_action||e.discard_action||se?.operation||e.revise_action||he);return c`<div
    ...
    ${l?c`<div class="worker-mini__row1">
          ...
          <div class="worker-mini__row2">
            ...
            ${ns(e)}
              ...
              ${d}${m}${k}${K}${Y}${B}${D}${v}${j}${we}
            </div>
            <div class="worker-mini__body">${le}${ge}</div>
            ${ne}${T}${Re?c`<div class="worker-mini__foot">
                  ${V}
                  <span class="worker-mini__actions"
                    >${ue}${U}${J}${ae}${X}${Ue}</span
                  >
            ...
            ${ns(e)}`:c`<div class="worker-mini__line">
              ${d}${m}${k}${K}${le}${Y}${B}${D}${v}${j}${V}${ue}${U}${J}${ae}${we}
            </div>
            ${ne}${T}${Ae} ${ns(e)}`}
...
`);else return null;let n=t.replace(zb,"").trim();return n.length>0?{kind:"user",text:n}:null}function ml(e){let t=e.split(/\r?\n/).find(r=>r.trim().length>0)||"",n=Bb.exec(t);return n?{kind:"gate",gate:n[2]==="implementation"?"impl":n[2],reviewer:n[3],verdict:n[4],time:n[5]?n[5].trim():void 0,text:t.trim()}:Ub.test(t)&&t.trim().length<=80?{kind:"phase",text:t.trim()}:{kind:"assistant",text:e}}function Hb(e,t){if(e.subtype==="init"){let n=typeof e.model=="string"?e.model:"";return t.progress=null,[{kind:"thinking",text:n?`\uC138\uC158 \uC2DC\uC791 \xB7 ${n}`:"\uC138\uC158 \uC2DC\uC791"}]}if(e.subtype==="thinking_tokens"){let r=`\uC0DD\uAC01 \uC911\u2026 ${typeof e.estimated_tokens=="number"&&Number.isFinite(e.estimated_tokens)?Math.max(0,Math.round(e.estimated_tokens)):0} \uD1A0\uD070`;return t.progress?(t.progress.text=r,[]):(t.progress={kind:"thinking",text:r},[t.progress])}return[]}function Gb(e,t){let n=typeof e.parent_tool_use_id=="string"&&e.parent_tool_use_id.length>0?e.parent_tool_use_id:null;if(e.type==="assistant"){let r=e.message,s=r&&Array.isArray(r.content)?r.content:[],o=[];for(let i of s)if(zn(i)){if(i.type==="text"&&typeof i.text=="string")o.push(ml(i.text));else if(i.type==="thinking"){let a=_l(i.thinking);a&&o.push(a)}else if(i.type==="tool_use"){let a=Wb(i);typeof i.id=="string"&&t.set(i.id,a),o.push(a)}}return n?Qd(o,n):o}if(e.type==="user"){let r=e.message,s=r&&Array.isArray(r.content)?r.content:[];for(let i of s)if(zn(i)&&i.type==="tool_result"){let a=t.get(String(i.tool_use_id));if(a){let l=ep(i.content);a.result=l,a.output=typeof i.content=="string"?i.content:l,i.is_error===!0&&(a.is_error=!0)}}let o=tp(r&&r.content);return o?[o]:[]}if(e.type==="result"){let r=e.is_error===!1&&e.subtype==="success",s={kind:"result",success:r,text:typeof e.result=="string"?e.result:r?"DONE":""};return n?Qd([s],n):[s]}return[]}function Qd(e,t){for(let n of e)n.parent_tool_use_id=t;return e}function Kb(e){let t=typeof e.command=="string"?e.command:"",n=ep(e.aggregated_output===void 0?e.output:e.aggregated_output),s=[typeof e.exit_code=="number"&&Number.isFinite(e.exit_code)?`exit ${e.exit_code}`:typeof e.status=="string"&&e.status.length>0?e.status:"",n].filter(i=>i.length>0).join(" \xB7 "),o={kind:"tool",tool:"shell",icon:Jd.Bash,command:t,input:{command:t},expandable:!0};return s.length>0&&(o.result=s),typeof e.aggregated_output=="string"&&(o.output=e.aggregated_output),o}function Vb(e){if(e.type==="item.completed"&&zn(e.item)){let t=e.item;if(t.type==="agent_message"&&typeof t.text=="string")return[ml(t.text)];if(t.type==="user_message"){let n=tp(t.text);return n?[n]:[]}if(t.type==="reasoning"){let n=_l(t.text);return n?[n]:[]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:t.type==="command_execution"?[Kb(t)]:[]}if(e.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(e.type==="turn.failed"){let t=e.error;return[{kind:"error",text:t&&typeof t.message=="string"?t.message:"turn failed"}]}return e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}function Yb(e){if(e.schema!=="codex-delegation-monitor-v1"||!zn(e.event))return[];let t=e.event;if(t.type==="session.started"||t.type==="turn.started")return[];if((t.type==="item.started"||t.type==="item.completed")&&zn(t.item)){let n=t.item;if(typeof n.id!="string"||n.id.length===0)return[];if(t.type==="item.completed"&&n.kind==="agent_message"&&typeof n.text=="string"&&n.text.trim().length>0)return[ml(n.text)];if(t.type==="item.completed"&&n.kind==="reasoning"){let a=_l(n.text);return a?[a]:[]}if(n.kind!=="activity"||typeof n.activity!="string")return[];let r=jb[n.activity];if(!r)return[];let s="\uC2DC\uC791",o="\u2026",i={kind:"tool",tool:"",icon:o,expandable:!1};if(t.type==="item.completed"){if(n.status==="completed")s="\uC644\uB8CC",o="\u2713";else if(n.status==="failed")s="\uC2E4\uD328",o="\u2717";else return[];i.result=""}return i.tool=`${r} \xB7 ${s}`,i.icon=o,[i]}return t.type==="turn.completed"&&t.status==="completed"?[{kind:"result",success:!0,text:"DONE"}]:t.type==="turn.failed"&&(t.status==="failed"||t.status==="interrupted")&&typeof t.error_code=="string"&&t.error_code.length>0?[{kind:"error",text:t.error_code}]:[]}function Zb(e){let t=e.type;return typeof t=="string"&&(t==="error"||t.startsWith("thread.")||t.startsWith("turn.")||t.startsWith("item."))}function Xb(e){let t=e;if(typeof e=="string"){let n=e.trim();if(n.length===0)return null;try{t=JSON.parse(n)}catch{return null}}return zn(t)?t:null}function np(e={}){let t=e.skip_delegated===!0,n=new Map,r={progress:null};return{push(s){let o=Xb(s);if(!o)return[];if(t&&typeof o.parent_tool_use_id=="string"&&o.parent_tool_use_id.length>0)return[];if(o.type==="system"&&o.schema!=="codex-delegation-monitor-v1")return Hb(o,r);let i=o.schema==="codex-delegation-monitor-v1"?Yb(o):Zb(o)?Vb(o):Gb(o,n);return i.length>0&&(r.progress=null),i}}}function gl(e){let t=[],n=np(),r=Array.isArray(e)?e:[];for(let s of r)for(let o of n.push(s))t.push(o);return t}var Qb=5,Jb=10,eh=/Task\s+#(\d+)/,th=/\bgh\s+pr\s+create\b|\bgit\s+push\b/,nh=/\bnpm\s+(?:run\s+)?(?:test|tsc|lint|build)\b|\bvitest\b/;function Js(e){return typeof e!="string"?"":(e.split(/\r?\n/).find(t=>t.trim().length>0)||"").trim()}function rh(e){return typeof e!="string"||e.length===0?0:e.split(/\r?\n/).length}function sh(e){for(let t=e.length-1;t>=0;t-=1){let n=e[t];if(n.kind==="phase"||n.kind==="gate")return n.text||null}return null}function oh(e){let t=new Map,n=0;for(let s of e){if(s.kind!=="tool")continue;n+=1;let o=s.input||{};if(s.tool==="TaskCreate"){let l=eh.exec(s.output||s.result||""),u=String(o.activeForm||o.subject||"").trim();if(!l||u.length===0)continue;t.set(l[1],{label:u,active:o.status==="in_progress"?n:0});continue}if(s.tool!=="TaskUpdate")continue;let i=t.get(String(o.taskId??""));if(!i)continue;let a=o.activeForm||o.subject;typeof a=="string"&&a.trim().length>0&&(i.label=a.trim()),typeof o.status=="string"&&(i.active=o.status==="in_progress"?n:0)}let r=null;for(let s of t.values())s.active>0&&(!r||s.active>r.active)&&(r=s);return r?r.label:null}function ih(e){if(e.tool==="Bash"){let t=e.command||"";return th.test(t)?"~ PR/\uAC8C\uC2DC \uC911":nh.test(t)?"~ \uAC80\uC99D \uC911":null}return e.tool==="Edit"||e.tool==="Write"||e.tool==="MultiEdit"?"~ \uAD6C\uD604 \uC911":e.tool==="Read"||e.tool==="Grep"||e.tool==="Glob"?"~ \uD0D0\uC0C9 \uC911":null}function ah(e){let t=e.filter(s=>s.kind==="tool").slice(-Jb),n=new Map;t.forEach((s,o)=>{let i=ih(s);if(!i)return;let a=n.get(i)||{count:0,last:-1};a.count+=1,a.last=o,n.set(i,a)});let r=null;for(let[s,o]of n)(!r||o.count>r.count||o.count===r.count&&o.last>r.last)&&(r={label:s,count:o.count,last:o.last});return r?r.label:null}function lh(e){let t=sh(e);if(t)return{text:t,guess:!1};let n=oh(e);if(n)return{text:n,guess:!1};let r=ah(e);return r?{text:r,guess:!0}:null}function ch(e,t){if(typeof e!="number")return"";let n=Math.max(0,Math.floor((t-e)/1e3));return n<60?`${n}\uCD08 \uC804`:wn(e,t)}function is(e,t={}){let{transport:n,sessionLogStore:r,onClose:s}=t,o=null,i=null,a=null,l=null,u=null,d=!1,m={},v=!0,b=new Set,k=new Set,N=null,W=null,K=!1,le=!1,Y=!1,B=null,D=null;function j(){K=!1,le=!1,Y=!1,B=null,D=null}async function Z(te){if(n){le=!0,Y=!1,Se();try{let G=await Promise.resolve(n("get-attempt-prompt",{attempt_id:te,...u?{root_dir:u}:{}}));if(o!==te)return;!G||typeof G!="object"||Array.isArray(G)?Y=!0:(B=G,D=te)}catch{o===te&&(Y=!0)}finally{o===te&&(le=!1,Se())}}}function V(){if(K=!K,K&&o&&D!==o){Z(o);return}Se()}function ue(){if(!K)return"";let te=os({loading:le,error:Y});if(te)return c`<div class="sv__prompt" data-seam="attempt-prompt">
    ...
    </div>`}function U(){if(!l||!r)return[];let te=r.get(l);return gl(te?te.lines:[])}function J(){if(!l||!r)return null;let te=r.get(l),G=te?te.last_event_at:null;return typeof G=="number"?G:null}function se(){return m.status==="running"}function ae(){if(se()&&o){W||(W=setInterval(()=>Se(),1e3));return}he()}function he(){W&&(clearInterval(W),W=null)}function Ue(te){let G=[],ye=0;for(;ye<te.length;){let{idx:ct,line:nt}=te[ye];if(nt.kind==="tool"){let Me=ye;for(;Me<te.length&&te[Me].line.kind==="tool"&&te[Me].line.tool===nt.tool;)Me+=1;if(Me-ye>=Qb&&!k.has(ct)){G.push({kind:"group",idx:ct,tool:nt.tool||"",lines:te.slice(ye,Me)}),ye=Me;continue}}G.push({kind:"line",idx:ct,line:nt}),ye+=1}return G}function ge(te){let G=[],ye=new Map;for(let Me=0;Me<te.length;Me+=1){let Fe=te[Me],dt=Fe.parent_tool_use_id;if(typeof dt=="string"&&dt.length>0){let at=ye.get(dt);at||(at={kind:"subagent",idx:Me,launch_id:dt,agent_type:null,header:null,lines:[]},ye.set(dt,at),G.push(at)),at.lines.push({idx:Me,line:Fe});continue}if(Fe.kind==="tool"&&Fe.tool==="Agent"&&typeof Fe.launch_id=="string"&&Fe.launch_id.length>0){let at=X(Fe),pt=ye.get(Fe.launch_id);if(pt){pt.header={idx:Me,line:Fe},pt.agent_type=at;continue}let Et={kind:"subagent",idx:Me,launch_id:Fe.launch_id,agent_type:at,header:{idx:Me,line:Fe},lines:[]};ye.set(Fe.launch_id,Et),G.push(Et);continue}G.push({kind:"entry",idx:Me,line:Fe})}let ct=[],nt=0;for(;nt<G.length;){if(G[nt].kind!=="entry"){ct.push(G[nt]),nt+=1;continue}let Me=nt;for(;Me<G.length&&G[Me].kind==="entry";)Me+=1;ct.push(...Ue(G.slice(nt,Me))),nt=Me}return ct}function X(te){let G=te.input;return G&&typeof G.subagent_type=="string"?G.subagent_type:null}function Ee(te){for(let G=te.length-1;G>=0;G-=1){let ye=te[G];if(ye.kind==="result"||ye.kind==="error")return null;if(ye.kind==="tool"&&!Object.hasOwn(ye,"result"))return ye}return null}function Le(te){for(let G=te.length-1;G>=0;G-=1)if(te[G].kind==="thinking")return te[G];return null}function T(te,G){if(G.kind==="gate")return c`<div class="sv__gate">${G.text}</div>`;if(G.kind==="phase")return c`<div class="sv__phase">${G.text}</div>`;if(G.kind==="result")return c`<div
      ...
      >
        ...
        >
      </div>`;if(G.kind==="thinking"){let ye=b.has(te);return c`<div
      ...
      >
        ...
        ${ye?c`<pre class="sv__think-expand">${G.text}</pre>`:""}
      </div>`}if(G.kind==="user"){let ye=b.has(te);return c`<div
        class="sv__line sv__line--user${ye?" sv__line--expanded":""}"
        role="button"
        tabindex="0"
        title="펼치기"
        @click=${()=>ht(te)}
      >
        ...
        ${ye?c`<pre class="sv__user-expand">${G.text}</pre>`:""}
      </div>`}if(G.kind==="error")return c`<div class="sv__error">⛔ ${G.text}</div>`;if(G.kind==="blocker")return c`<div class="sv__error">⛔ ${G.text}</div>`;if(G.kind==="tool"){let ye=b.has(te),ct=G.tool==="Bash"?rh(G.command):0,nt=G.tool==="Bash"?ct>1?Js(G.command):G.command:G.path||G.command||"";return c`<div
      ...
      >
        ...
        ${ye?c`<pre class="sv__tool-expand">${ne(G)}</pre>`:""}
      </div>`}return c`<div class="sv__as">${mr(G.text||"")}</div>`}function ne(te){let G=[];if(te.tool==="Bash"&&typeof te.command=="string"&&te.command.length>0)G.push(te.command);else if(te.input!==void 0)try{G.push(`input: ${JSON.stringify(te.input,null,2)}`)}catch{}return typeof te.output=="string"&&te.output.length>0&&G.push(`output:
${te.output}`),G.join(`

`)}function Ae(){if(!o)return c``;let te=U(),G=(i?[m.agent_type,m.model,m.effort]:[m.runner,m.model,m.effort]).filter(Boolean).join(" \xB7 "),ye=m.session_id||"",ct=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${v?"ON":"OFF"}`,nt=se(),Me=nt?ch(J(),Date.now()):"",Fe=nt?Ee(te):null,dt=nt?Le(te):null,at=lh(te);return c`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
        <span class="sv__id"
      ...
      ${i||d?"":ue()}
      <div class="sv__body">
        ${te.length===0?c`<div class="sv__empty">세션 로그 없음</div>`:ge(te).map(pt=>pt.kind==="subagent"?Re(pt):pt.kind==="group"?we(pt):T(pt.idx,pt.line))}
      </div>
    ...
    </div>`}function Re(te){let G=k.has(te.idx),ye=te.header?te.header.line:null,ct=ye?ye.is_error===!0?"\u2717":typeof ye.result=="string"?"\u2713":"\u27F3":"",nt=ye&&ye.command?ye.command:"";return c`<div class="sv__sub${G?" sv__sub--open":""}">
      <div
        class="sv__sub-head"
        role="button"
        tabindex="0"
...
${a}</pre
  ...
  `}function ey(e){let t=os(e);if(t)return t;let n=e.data;if(!n)return"";if(n.missing)return c`<div class="detail-prompt__missing">
    ...
    ${typeof n.system_prompt=="string"?ir("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",n.system_prompt):""}`}var ty=["open","in_progress","deferred","resolved","closed"],ny=[0,1,2,3,4];function xp(e,t){let n=t.issueStores,r=t.onClose,s=t.transport,o=t.onNavigate,i=t.queueStore,a=t.execPresetStore,l=t.sessionLogStore,u=null,d=null,m={},v="",b=!1,k=[],N=!1,W={},K={claude:null,codex:null},le=null,Y=null,B=0,D=!1,j=!1,Z="",V="",ue="",U="",J=!1;function se(){D=!1,j=!1,Z="",V="",ue="",U="",J=!1}function ae(){K={claude:null,codex:null},le=null,Y=null,B+=1}async function he(){if(!s)return null;try{let y=await Promise.resolve(s("get-workspace-accounts",{}));return y&&typeof y.state=="string"?y:null}catch{return null}}async function Ue(y){try{let E=await fetch(y);if(!E.ok)return null;let A=await E.json();if(!A||typeof A!="object"||!Array.isArray(A.accounts))return null;let me=A.accounts.filter(Ke=>Ke!==null&&typeof Ke=="object"&&!Array.isArray(Ke));return{accounts:me,active:me.find(Ke=>Ke.active===!0)||null}}catch{return null}}async function ge(y){Y=y;let E=++B,[A,me,Ke]=await Promise.all([Ue("/api/claude-usage"),Ue("/api/codex-usage"),he()]);E!==B||y!==u||(K={claude:A,codex:me},le=Ke,De())}let X=[],Ee=null,Le=null,T=!1,ne="",Ae=!1,we=0,Re=new Set;function fe(){X=[],Ee=null,Le=null,T=!1,ne="",Ae=!1,we+=1,Re.clear()}async function Se(y){if(!s)return;let E=++we;try{let A=await Promise.resolve(s("get-comments",{id:y}));if(E!==we||y!==u)return;X=Array.isArray(A)?A:[],T=!1}catch{if(E!==we||y!==u)return;T=!0}De()}function it(){if(!s||!u)return;let y=d&&typeof d.comment_count=="number"?d.comment_count:null;if(Ee!==u){Ee=u,Le=y,Se(u);return}y!==null&&y!==Le&&(Le=y,Se(u))}function ht(y){Re.has(y)?Re.delete(y):Re.add(y),De()}function _t(y){let E=ne.trim().length===0;ne=y,E!==(y.trim().length===0)&&De()}async function wt(){let y=ne.trim();if(!s||!u||y.length===0||Ae)return;let E=u;Ae=!0,De();let A=!1;try{let me=await Promise.resolve(s("add-comment",{id:E,text:y}));Array.isArray(me)&&me.length>0&&(A=!0,E===u&&(X=me,T=!1,ne="",Le=me.length))}catch{A=!1}A||ce("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),E===u&&(Ae=!1),De()}let R={onToggle:ht,onDraftInput:_t,onSubmit:wt},oe=t.mdViewer||null,Te=null;oe||(Te=document.createElement("div"),Te.className="md-viewer-root",document.body.appendChild(Te));let Ne=oe||Pi(Te,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),We=document.createElement("div");We.className="session-log-root",document.body.appendChild(We);let Je=is(We,{transport:s?(y,E)=>Promise.resolve(s(y,E)):void 0,sessionLogStore:l}),tt=!1,bt=!1,te=!1,G=null,ye=null,ct=0;function nt(y){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${y}`}function Me(){tt=!1,bt=!1,te=!1,G=null,ye=null,ct+=1}async function Fe(y){if(!s)return;let E=++ct;bt=!0,te=!1,De();try{let A=await Promise.resolve(s("get-bead-prompt",{bead_id:y}));if(E!==ct)return;!A||typeof A!="object"||Array.isArray(A)?te=!0:(G=A,ye=nt(y))}catch{E===ct&&(te=!0)}finally{E===ct&&(bt=!1,De())}}let dt=[],at=null,pt=0;function Et(y,E){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${y}::${E}`}function zt(){dt=[],at=null,pt+=1}async function Ht(y,E){if(!s)return;let A=++pt,me;try{me=await Promise.resolve(s("get-session-refs",{bead_id:y}))}catch{me=null}A!==pt||E!==at||(dt=me&&Array.isArray(me.sessions)?me.sessions:[],De())}function Lt(){if(!s||!u)return;let y=d&&d.metadata,E=y&&typeof y=="object"&&typeof y.session_ref=="string"?y.session_ref:null;if(E===null){zt();return}let A=Et(u,E);at!==A&&(dt=[],at=A,Ht(u,A))}function It(){if(tt=!tt,tt&&u&&ye!==nt(u)){G=null,Fe(u);return}De()}function xt(){if(!i||!u)return[];let y=i.get();return(y&&y.attempts?Object.values(y.attempts):[]).filter(A=>A&&A.bead_id===u).sort((A,me)=>(me.started_at||0)-(A.started_at||0)).map(A=>({attempt_id:A.attempt_id,bead_id:A.bead_id,status:A.status,started_at:typeof A.started_at=="number"?A.started_at:null,runner:A.runner||null,model:A.model||null,effort:A.effort||A.observed_effort||null,speed:A.speed||null,session_id:A.session_id||null,resumed_from:A.resumed_from||null,continuation_mode:A.continuation_mode||null,dismissed_at:typeof A.dismissed_at=="number"?A.dismissed_at:null,cause:typeof A.cause=="string"?A.cause:null,cause_detail:A.cause_detail||null,exec_default_preset_id:typeof A.exec_default_preset_id=="string"?A.exec_default_preset_id:null,exec_default_preset_revision:typeof A.exec_default_preset_revision=="number"?A.exec_default_preset_revision:null,exec_values:A.exec_values&&typeof A.exec_values=="object"?A.exec_values:null,usage:A.usage||null,usage_legs:Array.isArray(A.usage_legs)?A.usage_legs:[],delegation_sessions:Array.isArray(A.delegation_sessions)?A.delegation_sessions:[]}))}function je(){if(!i||!u)return null;let y=i.get();return Rn(y&&y.attempts||{},u)}let I=new Set;function Q(y){I.has(y)?I.delete(y):I.add(y),De()}function be(y){let E=i?i.get():null,A=E&&E.attempts?E.attempts[y]:null;Je.open({attempt_id:y,meta:A?{runner:A.runner||void 0,model:A.model||void 0,effort:A.effort||void 0,status:A.status||void 0,session_id:A.session_id||void 0}:{}})}function C(y,E){let A=i?i.get():null,me=A&&A.attempts?A.attempts[y]:null,Ve=(me&&Array.isArray(me.delegation_sessions)?me.delegation_sessions:[]).find(vt=>vt&&typeof vt=="object"&&vt.launch_id===E);Ve&&Je.open({attempt_id:y,launch_id:E,meta:{runner:Ve.provider==="claude"?"claude":"codex",role:Ve.role,...typeof Ve.agent_type=="string"?{agent_type:Ve.agent_type}:{},model:Ve.model,effort:Ve.effort,session_id:Ve.session_id,status:Ve.status}})}async function H(y){if(!s||!y)return;let E=await Vr();if(E===null)return;let A=()=>{let vt=i?i.get():null;return vt&&typeof vt.revision=="number"?vt.revision:0},me=async(vt={},ze=A())=>await s("worker-attempt-resume",{attempt_id:y,expected_revision:ze,...E!==""?{instructions:E}:{},...vt}),Ke=vt=>{vt?.queue&&i?.set&&i.set(vt.queue)},Ve=await me();if(Ke(Ve),Ve&&Ve.conflict){let vt=Ve.queue&&typeof Ve.queue.revision=="number"?Ve.queue.revision:A();Ve=await me({},vt),Ke(Ve)}Ve=await er(Ve,(vt,ze)=>me({continuation:vt,decision_token:ze}),{onResult:Ke,refresh:()=>me()}),Ve&&Ve.resumed===!1&&!Ve.conflict&&Ve.reason&&ce(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${Ve.reason}`,"error",2400)}function Ie(y){!y||!u||Je.open(Yr(y,u,d&&d.status))}let Be={onOpen:be,onOpenDelegation:C,onResume:H,onToggleUsage:Q,onOpenSessionRef:Ie,onCopyResumeCommand:Qt};function xe(){let y=i?i.get():null,E={...W};for(let A of["orchestration_model","orchestration_effort","orchestration_speed"]){let me=y&&y[A];typeof me=="string"&&(E[A]=me)}return E}async function lt(){if(s){try{let y=await Promise.resolve(s("get-session-defaults",{}));W=y&&y.values&&typeof y.values=="object"?y.values:{}}catch{W={}}De()}}function st(){let y=i?i.get():null;return y&&y.runner_catalog||null}function ve(){let y=i?i.get():null;return y&&typeof y.execution_defaults=="object"?y.execution_defaults:null}function Xe(){let y=d?.metadata&&typeof d.metadata=="object"?d.metadata:{},A=$n({pin:{...y,...m},global:xe(),execution_defaults:ve(),runner_catalog:st(),route:typeof y.route=="string"?y.route:null}).orchestration_model.value||"";return qn(st(),A)}function P(){let y=a?a.get():null;return!y||typeof y.revision!="number"?null:{revision:y.revision,presets:Array.isArray(y.presets)?y.presets:[]}}function F(y){return y?.compatible===!1}function ke(y){a&&y&&typeof y.revision=="number"&&Array.isArray(y.presets)&&a.set({revision:y.revision,presets:y.presets})}async function Ge(){let y=P(),E=y?.presets.find(A=>A.id===v);if(!(!s||!u||!y||!E||F(E)||b)){b=!0,k=[],De();try{let A=await Promise.resolve(s("apply-impl-preset",Hu(u,E.id,y.revision)));if(A&&A.conflict){ke(A),ce("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let me=A&&Array.isArray(A.issue)?A.issue[0]:A?.issue;if(A&&A.applied&&me&&typeof me=="object"){d=me,k=Array.isArray(A.skipped_orchestration_keys)?A.skipped_orchestration_keys.filter(Ke=>typeof Ke=="string"):[];for(let Ke of Gu)delete m[Ke];ce(k.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}A&&A.error==="bd_readback_failed"?ce("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):ce("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(A){A&&typeof A=="object"&&A.code==="bd_readback_failed"?ce("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):ce("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{b=!1,De()}}}let $e=null;n&&n.subscribe&&($e=n.subscribe(()=>Tt()));let Ze=null;i&&typeof i.subscribe=="function"&&(Ze=i.subscribe(()=>{u&&De()}));let ot=null,mt=null;function $t(){mt&&(mt(),mt=null)}a&&typeof a.subscribe=="function"&&(ot=a.subscribe(()=>{u&&De()}));function Kt(y){y.key==="Escape"&&u&&(y.preventDefault(),r())}document.addEventListener("keydown",Kt);function Tt(){if(u){if(n&&typeof n.snapshotFor=="function"){let y=n.snapshotFor("detail:"+u)||[];d=y.find(A=>A&&A.id===u)||y[0]||d}it(),Lt(),De()}}function Qt(y){Nn(y).then(E=>{E?ce("\uBCF5\uC0AC\uB428","success",1200):ce("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function Pe(y){y.preventDefault(),y.stopPropagation(),u&&Qt(u)}function mn(y,E){y.preventDefault(),y.stopPropagation(),Qt(E)}function Jt(y,E,A){y.preventDefault(),y.stopPropagation(),Ne.open(E,{missing_state:A})}async function Ft(y,E){let A=Object.hasOwn(m,y),me=m[y];if(m[y]=E,De(),!(!s||!u))try{let Ke=await Promise.resolve(s("update-exec-settings",zu(u,y,E.length===0?null:E))),Ve=Array.isArray(Ke)?Ke[0]:Ke;if(!Ve||typeof Ve!="object"||!Ve.id)throw new Error("exec settings readback failed");d=Ve,delete m[y],De()}catch(Ke){throw A?m[y]=me:delete m[y],De(),ce("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error"),Ke}}function Xt(y){y.catch(()=>{})}async function gn(y,E){let A=d||{},me=A.metadata&&typeof A.metadata=="object"?A.metadata:{},Ke={};for(let ze of["impl_runtime","impl_model","impl_effort"])Ke[ze]=Object.hasOwn(m,ze)?m[ze]:typeof me[ze]=="string"?me[ze]:"";Ke[y]=E;let Ve=Yu(Ke,st(),Xe()),vt={};for(let ze of["impl_runtime","impl_model","impl_effort"])vt[ze]=m[ze],m[ze]=Ve[ze]||"";if(De(),!(!s||!u))return Promise.resolve(s("update-impl-target",{id:u,...Ve,orchestration_runtime:Xe()})).then(ze=>{let ft=Array.isArray(ze)?ze[0]:ze;if(!ft||typeof ft!="object"||!ft.id)throw new Error("implementation target readback failed");d=ft;for(let yn of["impl_runtime","impl_model","impl_effort"])delete m[yn];De()}).catch(ze=>{for(let ft of["impl_runtime","impl_model","impl_effort"])vt[ft]===void 0?delete m[ft]:m[ft]=vt[ft];throw De(),ce("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error"),ze})}async function _e(y,E){if(!(!y||typeof y!="object")&&!(E==="diverged"&&!window.confirm("\uCD94\uCC9C \uC2E4\uD589 \uC124\uC815\uC744 \uC801\uC6A9\uD560\uAE4C\uC694? \uD604\uC7AC \uC218\uB3D9 \uC124\uC815\uC744 \uB36E\uC5B4\uC501\uB2C8\uB2E4."))){try{await Ft("orchestration_model",y.orchestration_model)}catch{return}if(typeof y.impl_runtime=="string"&&y.impl_runtime.length>0)try{await gn("impl_runtime",y.impl_runtime)}catch{}}}async function S(y,E,A){if(!s||!u)return!1;try{let me=await Promise.resolve(s(y,E)),Ke=Array.isArray(me)?me[0]:me;return Ke&&typeof Ke=="object"&&Ke.id?(d=Ke,!0):(ce(A,"error"),!1)}catch(me){return me&&typeof me=="object"&&me.code==="bd_readback_failed"?(ce("\uC800\uC7A5\uB410\uC73C\uB098 \uD655\uC778 \uC2E4\uD328 \u2014 \uACE7 \uAC31\uC2E0\uB429\uB2C8\uB2E4","error"),{ok:!1,saved:!0}):(ce(A,"error"),!1)}}function de(y){setTimeout(()=>{try{let E=e.querySelector(y);E&&typeof E.focus=="function"&&E.focus()}catch{}},0)}function Oe(){D=!0,Z=d&&d.title||"",De(),de('.detail-edit__input[data-edit="title"]')}function yt(y){Z=y.target.value}function Rt(){D=!1,Z="",De()}function At(){S("edit-text",{id:u,field:"title",value:Z},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(E=>{E===!0&&(D=!1,Z=""),De()})}function jt(){j=!0,V=d&&d.description||"",De(),de('.detail-edit__textarea[data-edit="description"]')}function nn(y){V=y.target.value}function rn(){j=!1,V="",De()}function En(){S("edit-text",{id:u,field:"description",value:V},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(E=>{E===!0&&(j=!1,V=""),De()})}function Mt(y,E,A,me){if(y.key==="Escape"){y.stopPropagation(),A();return}y.key==="Enter"&&(!me||y.ctrlKey||y.metaKey)&&(y.preventDefault(),E())}function sn(y){let E=y.target.value;S("update-status",{id:u,status:E},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>De())}function cn(y){let E=Number(y.target.value);S("update-priority",{id:u,priority:E},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>De())}function un(y){ue=y.target.value}function Gn(){let y=ue.trim();y.length!==0&&S("label-add",{id:u,label:y},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(E=>{E===!0&&(ue=""),De()})}function x(y){if(y.key==="Escape"){y.stopPropagation(),ue="",De();return}y.key==="Enter"&&(y.preventDefault(),Gn())}function O(y){S("label-remove",{id:u,label:y},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>De())}let p={onCopyPath:mn,onOpenDoc:Jt};function h(y){return typeof y=="string"?y:y&&typeof y=="object"?String(y.id||y.to||y.issue_id||y.depends_on||""):""}function L(y){return y&&typeof y=="object"?String(y.dependency_type||y.type||""):""}function ee(y){switch(y){case"discovered-from":return"\u21A9 \uBC1C\uACAC ";case"parent-child":return"\u2338 \uC0C1\uC704 ";case"related":return"\uAD00\uB828 ";default:return y.length>0?`${y} `:""}}function pe(y){if(!y||typeof y!="object")return;let E=typeof y.status=="string"?y.status:"",A=typeof y.title=="string"?y.title:"";return E.length>0&&A.length>0?`${E} \xB7 ${A}`:void 0}function ut(){return(t.getWorkspacePath&&t.getWorkspacePath()||"").trim()}function Qe(){return t.depCandidates?t.depCandidates():null}async function Bt(y,E,A){let me=ut(),Ke=u;if(!Ke)return;if(me.length===0){ce("\uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}let Ve=await S(y,{a:Ke,b:E,view_id:Ke,root_dir:me},A),vt=Ve===!0||Ve!==!1&&Ve.saved===!0;vt&&t.onDepChanged&&t.onDepChanged({type:y,a:Ke,b:E}),y==="dep-add"&&vt&&(U="",J=!1),De()}function Gt(y){if(!u)return;let E=globalThis.confirm;typeof E=="function"&&!E(`${y}\uAC00 ${u}\uB97C \uB9C9\uB294 \uC5F0\uACB0\uC744 \uB04A\uC744\uAE4C\uC694?`)||Bt("dep-remove",y,"\uC758\uC874 \uD574\uC81C \uC2E4\uD328")}function en(y){y.disabled||Bt("dep-add",y.bead_id,"\uC758\uC874 \uCD94\uAC00 \uC2E4\uD328")}function Tn(y){U=y.target.value,J=!0,De()}function bn(){J||(J=!0,De())}function Vt(y,E){if(y.key==="Escape"){y.stopPropagation(),U="",J=!1,De();return}y.key==="Enter"&&(y.preventDefault(),E.length===1&&!E[0].disabled&&en(E[0]))}function hn(y){return c`<div class="detail-dep-add">
      <input
        ...
        @keydown=${E=>Vt(E,y)}
      />
      ${J||U.length>0?c`<div class="detail-dep-add__list">
    ...
    </div>`}function Ln(y,E){let A=E.get(y.id),me=o?c`<button
          type="button"
    ...
    >`}function In(y){let E=Array.isArray(y.dependencies)?y.dependencies:[],A=Array.isArray(y.dependents)?y.dependents:[],me=[];for(let ze of E){let ft=h(ze);ft.length>0&&L(ze)==="blocks"&&me.push({id:ft,label:`\u26D3 \uB9C9\uB294 ${ft}`,kind:"pred",title:pe(ze)})}for(let ze of A){let ft=h(ze);ft.length>0&&L(ze)==="blocks"&&me.push({id:ft,label:`\u26D3 \uB9C9\uD788\uB294 ${ft}`,kind:"succ",title:pe(ze)})}for(let ze of E){let ft=h(ze),yn=L(ze);ft.length>0&&yn!=="blocks"&&me.push({id:ft,label:`${ee(yn)}${ft}`,kind:"other",title:pe(ze)})}let Ke=Qe(),Ve=new Map;if(Ke)for(let ze of Ke.issues)Ve.has(ze.bead_id)||Ve.set(ze.bead_id,ze.root_dir);let vt=Ke&&u?vd(yd(u,Ke),U):[];return c`
      <div class="detail-section-label">의존성</div>
      ${me.length===0?c`<div class="detail-empty">의존성 없음</div>`:c`<div class="detail-deps">
            ${me.map(ze=>Ln(ze,Ve))}
          </div>`}
      ${Ke===null?c`<div class="detail-empty">후보를 불러올 수 없음</div>`:hn(vt)}
    `}function ar(y){let E=y.metadata||{},A=y.workflow||{},me=A.stages||{},Ke=me.spec&&me.spec.stale,Ve=me.impl&&me.impl.stale,vt=A.quick_fix_review?.state==="stale",ze=me.plan||null,ft=A.route_source==="derived",yn=A.route||E.route||"\u2014";return c`
    ...
    `}let f={route:["quick_fix","spec_backed","full_plan"]};async function g(y,E){let A=E.target.value;if(y==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&A!=="full_plan"&&!window.confirm(`full_plan \u2192 ${A||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){De();return}await S("update-workflow-meta",{id:u,key:y,value:A},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),De()}function w(y){let E=y.metadata||{};return c` ${((me,Ke)=>{let Ve=f[me],vt=typeof E[me]=="string"?E[me]:"";return c`<div class="detail-kv">
    ...
    `}function Ce(y){let E=typeof y.notes=="string"?y.notes:"";return E.trim().length===0?c``:c`
    ...
    `}function et(){if(!u)return c``;let y=d||{},E=String(y.id||u),A=y.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",me=je(),Ke=y.status||"open",Ve=typeof y.priority=="number"?Math.max(0,Math.min(4,y.priority)):"",vt=y.description||"",ze={...y,metadata:{...y.metadata||{},...m}};return c`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${$(A,me)}
          ${pp(ze,{onApplyRec:_e})}
          ${dp({metadata:ze.metadata,workspace_values:xe(),catalog:st(),execution_defaults:ve(),expanded:N,presets:P()?.presets||[],preset_id:v,preset_busy:b,skipped_orchestration_keys:k},{onToggle:ft=>{N=ft,De()},onEdit:(ft,yn)=>{if(ft==="impl_runtime"||ft==="impl_model"||ft==="impl_effort"){Xt(gn(ft,yn??""));return}Xt(Ft(ft,yn??""))},onPresetSelect:ft=>{v=ft,k=[],De()},onPresetApply:()=>{Ge()}})}
          ${hp({md:ze.metadata,catalog:K,workspace_defaults:le,handlers:{onExecChange:(ft,yn)=>Xt(Ft(ft,yn))}})}
          ${z(Ke,Ve)} ${q(y)}
          ${re(vt)}
          ${ap(X,R,{expanded:Re,draft:ne,sending:Ae,error:T})}
          ${Ce(y)} ${He(y)} ${In(y)}
          ${ar(y)} ${w(y)}
          ${sp(y,p)}
          ${$p({expanded:tt,loading:bt,error:te,data:G},{onToggle:It})}
          ${kp(xt(),Be,{total:me,expanded:I},dt)}
        </div>
      </div>
    `}function De(){rt(et(),e)}return{load(y){y!==u&&(m={},v="",k=[],N=!1,se(),fe(),Me(),zt(),ae()),u=y,d=null,!mt&&t.subscribeCandidates&&(mt=t.subscribeCandidates(()=>{u&&De()})),Tt(),lt(),Y!==y&&ge(y)},clear(){u=null,d=null,m={},v="",b=!1,k=[],N=!1,se(),fe(),Me(),zt(),ae(),$t(),Ne.close(),Je.close(),rt(c``,e)},destroy(){$e&&($e(),$e=null),Ze&&(Ze(),Ze=null),ot&&(ot(),ot=null),$t(),document.removeEventListener("keydown",Kt),oe||(Ne.destroy(),Te&&Te.parentNode&&Te.parentNode.removeChild(Te)),Je.destroy(),We.parentNode&&We.parentNode.removeChild(We),u=null,d=null,ae(),v="",b=!1,k=[],fe(),Me(),zt(),rt(c``,e)}}}function Ap(e){let t=document.createElement("dialog");t.id="fatal-error-dialog",t.setAttribute("role","alertdialog"),t.setAttribute("aria-modal","true"),t.innerHTML=`
  ...
  >
    ▤ 세션
  </button>`}function Al(e,t,n=null,r={}){let s=e.kind==="session",o=s&&Array.isArray(e.session_refs)&&e.session_refs.find(he=>he&&he.current===!0)||null,i=e.failed===!0,a=!!e.paused,l=i?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):a?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?fy(t-e.started_at):"\u2014",u=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,d=hs(e),m=an(e.usage),v=tr(e.usage),b=e.conflict_resolution?a?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,k=e.base_exception||null,N=e.landing,W=e.attempt_id&&e.attempt_id===n,K=r.monitor||null,le=_y(K),Y=K?li(K.dependency_chips):"",B=gy(K,t,a,s?{updated_at:e.updated_at??null,last_event_at:o&&o.locality==="local"?o.last_event_at:null}:null),D=s&&e.workflow?.chips?.exec_receipt||null,j=ci(e.workflow),Z=ui(e.rec),V=D?c`<span
        class="ctl-chip ctl-chip--exec-receipt"
      ...
      >`:"",ue=o?c`<span
        ...
        >${vs(o)}</span
      >`:"",U=le||j||ue||V||Z?c`<div class="rtile__meta">
          ${le}${j}${ue}${V}${Z}
        </div>`:"",J=c`${b?c`<span class="worker-mini__badge">${b}</span>`:""}${k?c`<span
        class="worker-mini__badge"
        title="이 세션의 target base가 워크스페이스 선언 base와 다릅니다"
        >${k}</span
      >`:""}`,se=s?"":ns(e),ae=e.discard?.action?c`<button
        type="button"
  ...
  >
    <div class="rtile__hd">
      ...
      ${di(e.priority)}${d?c`<span class="rtile__resumed" title=${d}>↻</span>`:""}${J}
    ...
    ${Y}
    ${s?U:le||j||u||Z||m.length>0||v?c`<div class="rtile__meta">
            ${le}${j}${ai(e.exec_chips)}${Z}
            ${m.length>0?m.map(he=>c`<span class="worker-usage" title=${he.tooltip}
                      >${he.label}</span
                    >`):v?c`<span
                    class="worker-usage"
                    title=${ws(e.usage)}
  ...
  </div>`}var ln="",yy=["impl_runtime","impl_model","impl_effort"],vy=["claude_account","codex_account"],wy=5,Fi=1;function xn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function ji(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(I=>ce(I,"error",4e3)),o={},i={},a=[],l=!1,u={state:"absent",values:{},warnings:[]},d={},m={},v=Promise.resolve(),b={claude:null,codex:null},k=!1,N=null,W={},K="",le="",Y=!1,B=!1,D=!1,j=null,Z=!1;function V(){let I=t.queue?t.queue():null;return xn(I)?I:null}function ue(){let I=V();return I?I.runner_catalog:null}function U(){let I=V();return I&&xn(I.execution_defaults)?I.execution_defaults:null}function J(){let I=t.implPresetStore?.get();return xn(I)&&Array.isArray(I.presets)?I:null}function se(){return r===null?{}:{root_dir:r}}async function ae(I,Q){return Z||!n?null:await n(I,Q)}function he(I){I&&xn(I.queue)&&t.onQueueAdopt?.(I.queue)}async function Ue(I,Q){let be=V();if(!be||Z)return null;let C=await ae(I,{...Q,...se(),expected_revision:be.revision});if(he(C),r!==null&&C&&C.conflict){let H=C.queue&&typeof C.queue.revision=="number"?C.queue.revision:V()?.revision??be.revision;C=await ae(I,{...Q,...se(),expected_revision:H}),he(C)}return C}async function ge(){l=!0,je();try{let I=await ae("get-session-defaults",{...se()});o=xn(I?.values)?{...I.values}:{},i={...o},a=Array.isArray(I?.warnings)?I.warnings:[]}catch(I){a=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}finally{l=!1,je()}}async function X(){let I=Bu(o,i);if(Object.keys(I).length!==0){try{let Q=await ae("set-session-defaults",{values:I,...se()});o=xn(Q?.values)?{...Q.values}:{},i={...o},a=Array.isArray(Q?.warnings)?Q.warnings:[]}catch(Q){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}je()}}function Ee(I,Q){if(!xn(I))return;let be=I.state;u={state:be==="usable"||be==="unusable"||be==="absent"?be:"absent",values:xn(I.values)?{...I.values}:{},warnings:Array.isArray(I.warnings)?I.warnings:[]},m={...u.values},Q&&(d={...m})}async function Le(){try{Ee(await ae("get-workspace-accounts",{...se()}),!0)}catch(I){u={state:"unusable",values:{},warnings:["kv_read_failed"]},m={},d={},s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}je()}async function T(I){try{let Q=await fetch(I);if(!Q.ok)return null;let be=await Q.json();if(!xn(be)||!Array.isArray(be.accounts))return null;let C=be.accounts.filter(H=>xn(H)&&typeof H.key=="string"&&H.key.length>0&&typeof H.email=="string"&&H.email.length>0);return{accounts:C,active:C.find(H=>H.active===!0)||null}}catch{return null}}async function ne(){k=!0;let[I,Q]=await Promise.all([T("/api/claude-usage"),T("/api/codex-usage")]);Z||(b={claude:I,codex:Q},je())}function Ae(){let I={};for(let Q of vy){let be=Object.hasOwn(d,Q)?d[Q]:null,C=Object.hasOwn(m,Q)?m[Q]:null;be!==C&&(I[Q]=be)}return I}async function we(){let I=Ae();if(Object.keys(I).length!==0){try{Ee(await ae("set-workspace-accounts",{values:I,...se()}),!1)}catch(Q){s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}je()}}function Re(I,Q){Q===ln?delete d[I]:d[I]=Q,je(),v=v.then(()=>we())}function fe(I,Q){if(yy.includes(I)){ht(I,Q);return}Q===ln?delete i[I]:i[I]=Q,je(),X()}function Se(){let I=It().orchestration_model,Q=$n({global:{orchestration_model:I??void 0},execution_defaults:U(),runner_catalog:ue()}).orchestration_model.value;return Q?qn(ue(),Q):null}function it(I,Q){typeof Q=="string"&&Q.length>0?i[I]=Q:delete i[I]}function ht(I,Q){let be=Q===ln?void 0:Q,C=Fu({impl_runtime:I==="impl_runtime"?be:i.impl_runtime,impl_model:I==="impl_model"?be:i.impl_model,impl_effort:I==="impl_effort"?be:i.impl_effort},ue(),Se());it("impl_runtime",C.impl_runtime),it("impl_model",C.impl_model),it("impl_effort",C.impl_effort),je(),X()}async function _t(){let I=V();if(!I)return;let Q={orchestration_model:I.orchestration_model??null,orchestration_effort:I.orchestration_effort??null,orchestration_speed:I.orchestration_speed??null},be=Uu(Q,{...Q,...W});if(Object.keys(be).length!==0){try{let C=await Ue("worker-queue-set-orchestration-defaults",{values:be});if(C&&C.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}W={}}catch(C){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}je()}}function wt(I,Q){W[I]=Q===ln?null:Q,je(),_t()}function R(I){if(N=I,!I){je();return}let Q=ue(),be=It(),C=be.orchestration_model;C&&!Os(Q,I).includes(C)&&(W.orchestration_model=null,C=null);let H=be.orchestration_effort;H&&!Ca(Q,I,C||Sn).includes(H)&&(W.orchestration_effort=null),je(),_t()}async function oe(I){if(!(!V()||I<Fi)){try{await Ue("worker-queue-set-slots",{slots:I})}catch(Q){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}je()}}async function Te(I){if(!(!V()||I<Fi||I>wy)){try{await Ue("worker-queue-set-serial-lane-count",{count:I})}catch(Q){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}je()}}async function Ne(I,Q){let be=I==="auto_advance"?"worker-automation-toggle":"worker-merge-auto-toggle";try{await Ue(be,{on:Q})}catch(C){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}je()}function We(){let I={},Q=It();for(let be of Ko){let C=nr.includes(be)?Q[be]:i[be];typeof C=="string"&&C.length>0&&(I[be]=C)}return I}async function Je(){let I=J();if(!I)return;let Q=We();if(Object.keys(Q).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let be=(I.presets||[]).find(H=>H.id===K),C=le.trim()||(be?be.name:"");if(!C){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let H=be?await ae("impl-preset-update",{expected_revision:I.revision,id:be.id,name:C,settings:Q}):await ae("impl-preset-create",{expected_revision:I.revision,name:C,settings:Q});if(H&&H.applied){if(le="",!be&&Array.isArray(H.presets)){let Ie=H.presets.find(Be=>Be.name===C);K=Ie?Ie.id:K}je()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),je()}catch(H){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${H instanceof Error?H.message:String(H)}`)}}async function tt(){let I=J();if(!(!I||K.length===0))try{let Q=await ae("impl-preset-delete",{expected_revision:I.revision,id:K});Q&&Q.applied?(K="",je()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),je())}catch(Q){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${Q instanceof Error?Q.message:String(Q)}`)}}function bt(I){o=xn(I.values)?{...I.values}:{},i={...o},a=Array.isArray(I.warnings)?I.warnings:[],xn(I.queue)&&(t.onQueueAdopt?.(I.queue),W={})}async function te(){let I=J(),Q=V();if(!I||!Q||K.length===0)return;let be=C=>({preset_id:K,expected_revision:I.revision,expected_queue_revision:C,...se()});try{let C=await ae("apply-impl-preset-global",be(Q.revision));if(C&&C.applied&&bt(C),r!==null&&C&&C.queue_applied===!1){let H=C.queue&&typeof C.queue.revision=="number"?C.queue.revision:V()?.revision??Q.revision;C=await ae("apply-impl-preset-global",be(H)),C&&C.applied&&bt(C)}C&&C.applied?C.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):C&&C.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(C){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}je()}async function G(){B=!0,D=!1,je();try{let I=await ae("get-worker-system-prompt",{});!I||typeof I!="object"||Array.isArray(I)?D=!0:j=I}catch{D=!0}finally{B=!1,je()}}function ye(){if(Y=!Y,Y&&!j){G();return}je()}function ct(){let I=os({loading:B,error:D});if(I)return I;if(!j)return"";let Q=Array.isArray(j.variants)?j.variants:[];return c`<div class="settings-dialog__sp-body">
      ${j.target_base_placeholder?c`<div class="prompt-block__meta">
            \`${j.target_base_placeholder}\`는 디스패치 시점에 해석된
            base로 치환됩니다.
          </div>`:""}
      ${Q.map(be=>c`<div class="settings-dialog__sp-variant" data-variant=${be.key}>
    ...
    >
      ...
      ${Y?ct():""}
    </section>`}function Me(I,Q,be,C,H,Ie,Be){let xe=H[I]??ln,lt=Ra(I,be,H,U(),ue(),Be),st=lt.options.find(Xe=>Xe.value===xe),ve=xe===ln?lt.full_value:st?.full_value;return c`<select
      ...
      >
        ...
        ${lt.options.map(Xe=>c`<option
              value=${Xe.value}
              title=${Xe.full_value||""}
              ?selected=${Xe.value===xe}
            >
              ${Xe.label}
            </option>`)}
      </select>
      ${xe===ln?c`<span class="settings-dialog__source-badge">기본</span>`:""}`}function Fe(I,Q,be,C,H,Ie=!1,Be){return c`<div
    ...
    >
    ...
    </div>`}function dt(I,Q){let be=Q?Q.active:null;return xn(be)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${I==="claude"?be.email:as({...be,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function at(I,Q,be){let C=b[be],H=Object.hasOwn(d,I)?d[I]:ln,Ie=be==="claude"?Mi:as,Be=!!C?.accounts.some(xe=>xe.key===H);return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${Q}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${Q}
          data-account-key=${I}
          @change=${xe=>Re(I,String(xe.target.value))}
        >
          ...
          ${C?.accounts.map(xe=>c`<option value=${xe.key} ?selected=${xe.key===H}>
                ${Ie(xe)}
              </option>`)||""}
        </select>
    ...
    </div>`}function pt(){let I=u.warnings.join(", ");return u.state==="unusable"?`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uD574\uC11D\uD560 \uC218 \uC5C6\uC5B4 \uC774 \uB808\uD3EC\uC758 \uB514\uC2A4\uD328\uCE58\uAC00 \uAC70\uBD80\uB429\uB2C8\uB2E4 \u2014 ${I} \xB7 \uACC4\uC815\uC744 \uB2E4\uC2DC \uACE0\uB974\uBA74 \uD574\uC18C\uB429\uB2C8\uB2E4`:u.warnings.length>0?`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC5D0 \uC54C \uC218 \uC5C6\uB294 \uD0A4\uAC00 \uC788\uC2B5\uB2C8\uB2E4 \u2014 ${I}`:null}function Et(I,Q,be,C,H){return c`<div class="settings-dialog__row">
      ...
      <span class="settings-dialog__controls">
        ${Me(be,`${I} \uBAA8\uB378`,C,fe,i,!1)}
        ${Me(H,`${I} effort`,Zo,fe,i,!1)}
      </span>
    </div>`}function zt(I,Q,be,C){return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${Q}</span>
      <span class="settings-dialog__controls">
        <button
          type="button"
    ...
    </div>`}function Ht(I,Q,be,C){return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${Q}</span>
      <span class="settings-dialog__controls">
    ...
    </div>`}function It(){let I=V(),Q={};for(let be of nr)Q[be]=Object.prototype.hasOwnProperty.call(W,be)?W[be]:I&&typeof I[be]=="string"?I[be]:null;return Q}function xt(){let I=ue(),Q=i.impl_runtime,be=i.impl_model,C=J(),H=V(),Ie=It(),Be=Os(I,N),xe=Jr(I,void 0).filter($e=>$e!==Sn),lt=Ca(I,N,Ie.orchestration_model||Sn).filter($e=>$e!==Sn),st=K?(C?.presets||[]).find($e=>$e.id===K):null,ve=st?ju(We(),xn(st.settings)?st.settings:{}):null,Xe=H&&typeof H.slots=="number"?H.slots:Fi+1,P=H&&typeof H.serial_lane_count=="number"?H.serial_lane_count:Fi,F=U()?.supported===!0,ke=pt(),Ge=Ra("workflow_mode",Cs,i,U(),I);return c`
      ...
      ${l?c`<div class="settings-dialog__empty">불러오는 중…</div>`:c`
            <div class="settings-dialog__preset-bar">
              <select
                aria-label="실행 프리셋"
                .value=${Ir(K)}
                @change=${$e=>{K=String($e.target.value),je()}}
              >
              ...
              <input
                ...
                aria-label="프리셋 이름"
                .value=${Ir(le)}
                @input=${$e=>{le=String($e.target.value)}}
              />
              <button
                type="button"
                class="settings-dialog__btn"
              ...
              <div class="settings-dialog__row">
                ...
                <span class="settings-dialog__controls">
                  <select
                    ...
                    .value=${Ir(N||ln)}
                    @change=${$e=>{let Ze=String($e.target.value);R(Ze===ln?null:Ze)}}
                  >
            ...
            <div class="settings-dialog__group">
              ...
              ${Fe("impl_runtime","\uC704\uC784 \uB300\uC0C1",Vo,fe,i)}
              ${Fe("impl_model","\uBAA8\uB378",Jr(I,Q),fe,i)}
              ${Fe("impl_effort","effort",es(I,Q,be),fe,i)}
              ${Fe("impl_speed","\uC18D\uB3C4",Ts,fe,i)}
              ${Fe("quick_fix_impl_model","quick_fix \uAD6C\uD604 \uBAA8\uB378",xe,fe,i,!1,{...i,...Ie})}
            </div>
            ...
            <div class="settings-dialog__group">
              ...
              ${Ht("slots","\uB3D9\uC2DC \uC2E4\uD589",Xe,$e=>oe($e))}
              ${Ht("serial-lane-count","\uC9C1\uB82C \uB808\uC778",P,$e=>Te($e))}
            </div>
            ${nt()}
          `}
    `}function je(){Z||rt(xt(),e)}return{load(){W={};let I=[ge(),Le()];return k||I.push(ne()),Promise.all(I).then(()=>{})},render:je,sessionDraft:()=>({...i}),destroy(){Z=!0,rt(c``,e)}}}function Bi(e){return c`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ...
    >
      ...
      >
        ${Bp()}
      </button>`}function J(T){let ne=$y(T);return ne?c`<div class="mon2-deck__chips">
      ...
      ${ne.worker?c`<span class="mon2-deck__chip" title=${ne.worker.title}
          ...
          >`:""}
    </div>`:""}function se(T){let ne=[];for(let[Ae,we]of[["queue","\uB300\uAE30"],["pr_wait","PR"],["session_active","\uC138\uC158"]]){let Re=Sl(T,Ae);Re>0&&ne.push(`${we} ${Re}`)}return ne.join(" \xB7 ")}function ae(T){let ne=Sl(T,"running"),Ae=typeof T.slots=="number"?T.slots:1;return c`<div
    ...
    >
      <div class="mon2-deck__tile-hd">
        ...
        <span
          ...
          title=${`\uC2AC\uB86F ${Ae}\uAC1C \uC911 ${ne}\uAC1C \uC2E4\uD589 \uC911`}
        >
          <span class="mon2-deck__load-n">${ne}/${Ae}</span>
          ${ue(ne,Ae)}
        </span>
        <button
          type="button"
      ...
      <div class="mon2-deck__tile-ft">
        ...
        <span class="mon2-deck__counts">${se(T)}</span>
        ${J(T)}
      </div>
    </div>`}function he(T){let ne=t.doneItems?t.doneItems():[],Ae=t.rangeLabel?t.rangeLabel():"",we=Wp(Array.isArray(ne)?ne:[]),Re=fe=>T.reduce((Se,it)=>Se+Sl(it,fe),0);return c`<div class="mon2-deck__bar">
      <span
        class="mon2-deck__total-counts"
        title=${`visible \uB808\uD3EC ${T.length}\uACF3\uC758 \uD569\uACC4\uC785\uB2C8\uB2E4 \u2014 \uC2E4\uD589\xB7\uB300\uAE30\xB7PR\uC740 \uC9C0\uAE08, \uC644\uB8CC\uB294 ${Ae}`}
    ...
    </div>`}function Ue(){let T=b();return T.length===0?"":c`${he(T)}
      <div class="mon2-deck__strip">
        ${T.map(ne=>ae(ne))}
      </div>`}function ge(){u!==null&&!k(u)&&(u=null,t.onFocusChange?.(null))}function X(){W(),ge(),d!==null&&!k(d)&&j(!0),rt(Ue(),r),m?.render()}function Ee(T){let ne=T.target;if(!ne||typeof ne.closest!="function")return;let Ae=ne.closest("[data-root-dir]");if(!Ae)return;let we=Ae.getAttribute("data-root-dir")||"",Re=ne.closest("[data-act]")?.getAttribute("data-act");if(Re==="worker"){t.gotoWorkerTab?.(we);return}if(Re==="auto"){K("worker-automation-toggle",we,{on:N(we)?.auto_advance!==!0});return}if(Re==="merge"){K("worker-merge-auto-toggle",we,{on:N(we)?.auto_merge!==!0});return}if(Re==="gear"){B(we);return}Y(we)}function Le(T){if(T.key!=="Enter"&&T.key!==" ")return;let ne=T.target;if(!ne||typeof ne.closest!="function")return;let Ae=ne.closest('[data-root-dir][role="button"]');!Ae||Ae!==ne||(T.preventDefault(),Y(Ae.getAttribute("data-root-dir")||""))}return r.addEventListener("click",Ee),r.addEventListener("keydown",Le),{render:X,focusRoot:()=>u,panelRoot:()=>d,destroy(){document.removeEventListener("keydown",V),r.removeEventListener("click",Ee),r.removeEventListener("keydown",Le),a.removeEventListener("click",Z),D(),rt(c``,r),e.replaceChildren()}}}var Hp="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C",xy=1e4;function Gp(e){return typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)?e.lane:e.lane==="running"&&e.serial_lane_id?e.serial_lane_id:null}function Kp(e){return e.lane==="runnable"||e.lane==="queue"||typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)}var Xp="bdui.monitor.done-range",Qp="bdui.monitor.running_sort",Jp="bdui.monitor.candidate_sort",ef="beads-ui.monitor.candidate-filter",tf="beads-ui.monitor.sections";function Ay(){try{let e=window.localStorage.getItem(ef);if(!e)return{...rs};let t=JSON.parse(e);return!t||typeof t!="object"?{...rs}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:rs.show_blocked,spec:Wa.some(n=>n.value===t.spec)?t.spec:"all"}}catch{return{...rs}}}function Vp(e){try{window.localStorage.setItem(ef,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Sy(){try{let e=window.localStorage.getItem(Jp);return js.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function Ey(e){try{window.localStorage.setItem(Jp,e)}catch{}}function Ty(){try{let e=window.localStorage.getItem(tf);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Cy(e){try{window.localStorage.setItem(tf,JSON.stringify(e))}catch{}}function Ry(){try{let e=window.localStorage.getItem(Xp);return e===null?"today":Kn(e)}catch{return"today"}}function Oy(e){try{window.localStorage.setItem(Xp,e)}catch{}}function Ly(){try{return window.localStorage.getItem(Qp)==="repo"?"repo":"started"}catch{return"started"}}function Iy(e){try{window.localStorage.setItem(Qp,e)}catch{}}var nf="tab:monitor:pipeline",My=1e3,Yp=[{lane:"runnable",pane:"candidate",title:"\uD6C4\uBCF4",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589 \uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],Py=["queue","runnable","done"],Zp="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function Dy(e){return e>=1&&e<=Zp.length?Zp[e-1]:`(${e})`}function rf(e,t){let n=qt("views:monitor"),r=t.gotoIssue,s=t.pipelineStore,o=t.transport,i=t.getWorkspacePath,a=t.openDoc,l=t.switchWorkspace,u=t.router,d=t.now||(()=>Date.now()),m=t.confirm||(f=>typeof globalThis.confirm!="function"||globalThis.confirm(f)),v=Ry(),b=Ly(),k=Ay(),N=Sy(),W=Ty(),K=qi("beads-ui.monitor.lane-collapsed"),le=!1,Y=null,B=null,D=null,j=null,Z=[],V=null,ue=null,U=null,J=null;function se(f){return J===null&&(J=Qt()),ku(f,J)}function ae(f,g){he(),!(g<=0)&&(ue={lane_id:f,corrected:g},U=setTimeout(()=>{U=null,ue=null,ve()},xy))}function he(){U!==null&&(clearTimeout(U),U=null),ue=null}function Ue(){let f=jr.find(g=>g.value===v);return f?f.label:""}let ge=document.createElement("div");ge.className="mon",e.appendChild(ge);let X=document.createElement("div");X.className="worker-drawer-overlay",X.hidden=!0;let Ee=document.createElement("div");Ee.className="worker-drawer-overlay__backdrop";let Le=document.createElement("div");Le.className="worker-drawer-host mon2-drawer",X.append(Ee,Le),e.appendChild(X);let T=Bs(null,null),ne=new Map,Ae=new Map,we=null,Re=null,fe=null,Se=is(Le,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{B=null,X.hidden=!0,ve()}});async function it(f,g,w,$,q=!0){if(!o||!w)return null;let z=await o(f,{...g,root_dir:w,expected_revision:$});if(z&&z.conflict&&q){z.queue&&Ae.set(w,z.queue);let re=z.queue&&typeof z.queue.revision=="number"?z.queue.revision:$;z=await o(f,{...g,root_dir:w,expected_revision:re})}return z&&z.queue&&w&&Ae.set(w,z.queue),z}function ht(f,g){let w=Ae.get(f),$=s&&s.get?s.get():null,q=(Array.isArray($)?$:[]).find(re=>re?.root_dir===f);return(w||q)?.merge_queue?.find(re=>re.bead_id===g)?.continuation_action}async function _t(f,g,w,$){let q=await it(f,g,w,$),z=Ae.get(w)?.revision??q?.queue?.revision??$;return er(q,(re,Ce)=>it(f,{...g,continuation:re,decision_token:Ce},w,z,!1),{refresh:re=>it(f,g,w,re?.queue?.revision??Ae.get(w)?.revision??z,!1)})}async function wt(f,g,w,$){let q=await er({continuation_mismatch:$},(re,Ce)=>it("worker-merge-queue-add",{bead_id:g,continuation:re,decision_token:Ce},f,w,!1)),z=q?.queue?.merge_queue?.find(re=>re.bead_id===g)?.continuation_action;q?.applied!==!0&&z?.continuation===null&&z.mismatch&&await wt(f,g,q.queue.revision,z.mismatch)}async function R(f,g,w){let $=await it("worker-discard",f,g,w);if($&&$.discarded===!0){ce(ii($),"success",5e3);return}if($&&$.reason){ce(`\uD3D0\uAE30 \uC2E4\uD328: ${$.reason}`,"error");return}if($&&$.accepted&&$.pending==="merged_revert"){ce("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if($&&$.accepted){ce(`\uD3D0\uAE30 \uC9C4\uD589: ${$.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}$&&!$.conflict&&ce("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function oe(f,g,w){return!o||!w?null:await o(f,{...g,root_dir:w})}async function Te(){let f=new Map;for(let g of T.pr_wait)f.has(g.root_dir)||f.set(g.root_dir,g.expected_revision);for(let[g,w]of f)await it("worker-merge-queue-add-all",{},g,w)}function Ne(f){let g=W[f];return!!(g&&g.runnable===!0)}function We(f){let g={...W[f]||{}};g.runnable=!g.runnable,W={...W,[f]:g},Cy(W),ve()}function Je(f){K.toggle(f),ve()}function tt(f){K.toggleArea(f),ve()}function bt(f){let g=T.queue_groups.find(w=>w.root_dir===f);if(!g)return null;for(let w=0;w<g.serial_lane_count;w+=1){let $=`s${w+1}`,q=g.sublanes.serial.find(z=>z.id===$);if(!q||q.raw_length===0&&q.occupied_by.length===0)return $}return null}function te(f,g){let w=T.queue_groups.find(q=>q.root_dir===f),$=w?w.sublanes.serial.find(q=>q.id===g):void 0;return $?$.raw_length:0}function G(f,g){let w=ne.get(f),$=ne.get(g);if(!w||!$)return{kind:"note",text:"\uC0C1\uB300\uC758 \uD604\uC7AC \uC704\uCE58\uB97C \uC54C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"};let q=Gp(w),z=Gp($);if(q!==null&&q===z&&w.root_dir===$.root_dir)return{kind:"note",text:"\uC774\uBBF8 \uAC19\uC740 \uC9C1\uB82C \uB808\uC778 \u2014 \uC21C\uC11C\uAC00 \uC788\uC2B5\uB2C8\uB2E4"};let re=Kp(w),Ce=Kp($);if(re&&z!==null){let He=z;return{kind:"ops",title:`${He} \uB05D\uC5D0 ${f}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:$.root_dir,ops:[{bead_id:f,lane:He,index:te($.root_dir,He)}]}}if(q!==null&&Ce&&z===null){let He=q;return{kind:"ops",title:`${He} \uB05D\uC5D0 ${g}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:w.root_dir,ops:[{bead_id:g,lane:He,index:te(w.root_dir,He)}]}}if(re&&q===null&&Ce&&z===null){let He=bt(w.root_dir);return He===null?{kind:"disabled",title:"\uBE48 \uC9C1\uB82C \uB808\uC778 \uC5C6\uC74C \u2014 Worker \uD0ED\uC5D0\uC11C \uB808\uC778 \uC218 \uC870\uC808"}:{kind:"ops",title:`${He} \uB808\uC778\uC5D0 ${g} \u2192 ${f} \uC21C\uC11C\uB85C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:w.root_dir,ops:[{bead_id:g,lane:He,index:0},{bead_id:f,lane:He,index:1}]}}return!re&&!Ce?{kind:"note",text:"\uB458 \uB2E4 \uC774\uBBF8 \uCD9C\uBC1C \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"}:re?{kind:"note",text:`${ro($.lane)} \u2014 \uC885\uB8CC \uD6C4 \uCD9C\uBC1C\uD558\uB824\uBA74 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694`}:{kind:"note",text:`${ro(w.lane)} \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4\uB824\uBA74 \uC0C1\uB300\uB97C \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694`}}function ye(f,g){let w=G(f,g.id);return{id:g.id,title:g.title,location_label:g.location_label,prefixes:g.prefixes,action:w.kind==="note"?{kind:"note",text:w.text}:w.kind==="disabled"?{kind:"disabled",label:Hp,title:w.title}:{kind:"place",label:Hp,title:w.title}}}function ct(f,g){if(!j||j.bead_id!==f)return null;let w=j.counterpart_id,$=g.filter(q=>q.id===w);return $.length===0?null:{rows:$.map(q=>ye(f,q))}}function nt(f){let g=f.dependency_chips||null,w=f.overlap_chips||[],$=f.scope_state==="missing",q=f.cross_lane_chip,z=f.armed_lane_chip;if(!g&&w.length===0&&!$&&!q&&!z)return null;let re=ct(f.id,w);return{...g||{},...w.length>0?{overlaps:w}:{},...$?{scope_missing:!0}:{},...q?{cross_lane:{lane_id:q.lane_id,label:q.label}}:{},...z?{armed_lane:z}:{},...re?{popover:re}:{}}}function Me(f){let g=nt(f);return g?{...f,dependency_chips:g}:f}async function Fe(f,g){let w=G(f,g);if(j=null,w.kind!=="ops"){ve();return}let $=mn(w.root_dir,w.ops[0].bead_id);for(let q of w.ops){let z=await dt(q,w.root_dir,$);if(z===null)break;$=z}ve()}async function dt(f,g,w){try{let $=await it("worker-queue-place",f,g,w,!1);if($&&$.conflict)return ce("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!$||$.applied!==!0)return ce($&&typeof $.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${$.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let q=$.queue?$.queue.revision:void 0;return typeof q!="number"?(ce("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):q}catch($){return ce(ot($),"error"),null}}function at(f){let g=Ne(f.root_dir);return c`<header class="mon2-sec__hd">
      <button
        type="button"
    ...
    >
    ...
    </div>`}function je(f){let g=T.cross_lanes_revision!==null,w=se(f.lane_id),$=w?.held===!0,q=w?.cycle===!0,z=w?w.mismatched:[],re=ue&&ue.lane_id===f.lane_id?ue.corrected:0;return c`<div class="mon2-clane" data-lane-id=${f.lane_id}>
      ...
      >
        ${f.rows.length===0?c`<div class="mon2-clane__hint">
            ...
            </div>`:f.rows.map((Ce,He)=>xt(f,Ce,He,z))}
      </div>
    ...
    </div>`}function Q(f){if(f.length===0)return"";let g=f.length-1;return`${f[0].id} \uC810\uC720${g>0?` +${g}`:""}`}function be(f){return c`<div
      class="mon2-item mon2-item--ghost"
      data-bead-id=${f.id}
    >
      ${jn({id:f.id,title:f.title,lane:"running",draggable:!1,ghost:!0,badges:[f.badge]})}
    </div>`}function C(f,g){let w=g.occupants,$=g.cross_wait_peers||[];return{id:g.id,pane_id:"",title:`${f.name} \xB7 \uC9C1\uB82C ${g.index+1}`,rows:[...w.map(q=>be(q)),...g.items.map((q,z)=>I(g,q,z))],count:g.items.length,empty:g.empty===!0,...w.length>0?{badge:c`<span
...
`)}
      ...
      </select>`:""}function st(f){let g=s&&s.get?s.get():null,w=s&&s.getWorkspacesState?s.getWorkspacesState():[],$=f===void 0?s&&s.crossLanes?s.crossLanes():void 0:f,q={done_since:$r(v,d()),running_sort:b,candidate_filter:k,candidate_sort:N};return $!==void 0&&(q.cross_lanes=$),Bs(g,w,q)}function ve(){let f=d();T=st(),J=null,ne=new Map;for(let g of[...T.runnable,...T.queue,...T.running,...T.pr_wait,...T.done])!g.non_occupying&&!ne.has(g.id)&&ne.set(g.id,g);rt(Be(f),ge),P()?.render(),Xe(),F()}function Xe(){let f=new Map;for(let g of T.queue_groups)f.set(g.root_dir,g.auto_advance);for(let g of Array.from(ge.querySelectorAll(".worker-wait__area--parallel .worker-mini__repo"))){let w=g.closest(".mon2-item")?.getAttribute("data-root-dir")||"",$=f.get(w);typeof $=="boolean"&&g.setAttribute("title",`${g.textContent||""} \xB7 ${$?"\uC790\uB3D9\uD654 \uCF1C\uC9D0":"\uC790\uB3D9\uD654 \uAEBC\uC9D0"}`)}}function P(){if(fe)return fe;let f=ge.querySelector(".mon2-deck");return f?(fe=zp(f,{workspacesState:()=>s&&s.getWorkspacesState?s.getWorkspacesState():[],doneItems:()=>T.done,rangeLabel:Ue,transport:o,implPresetStore:t.execPresetStore,gotoWorkerTab:Ge,onFocusChange:g=>{V=g,F()}}),fe):null}function F(){ge.classList.toggle("has-focus",V!==null);for(let f of Array.from(ge.querySelectorAll(".mon2-sec[data-root-dir]")))f.classList.toggle("is-focus",V!==null&&f.getAttribute("data-root-dir")===V);for(let f of Array.from(ge.querySelectorAll(".mon2-item[data-bead-id], .rtile[data-bead-id], .worker-mini[data-bead-id], .worker-card[data-bead-id]"))){let g=ne.get(f.getAttribute("data-bead-id")||"");f.classList.toggle("is-focus",V!==null&&!!g&&g.root_dir===V)}for(let f of Array.from(ge.querySelectorAll(".mon2-crow[data-root-dir]")))f.classList.toggle("is-focus",V!==null&&f.getAttribute("data-root-dir")===V)}function ke(f,g){let w=i?i():void 0;if(!g||!w||g===w||!l){r(f);return}l(g).then(()=>{r(f)}).catch($=>{n("workspace switch for %s failed: %o",g,$)})}function Ge(f){if(!f)return;let g=i?i():void 0,w=()=>{try{u?.gotoView("worker")}catch($){n("gotoView(worker) failed: %o",$)}};if(!l||g&&g===f){w();return}l(f).then(w).catch($=>{n("workspace switch for %s failed: %o",f,$),ce("\uB808\uD3EC \uC804\uD658\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error")})}function $e(f){Nn(f).then(g=>{ce(g?"\uBCF5\uC0AC\uB428":"\uBCF5\uC0AC \uC2E4\uD328",g?"success":"error",1400)})}function Ze(f){let g=ne.get(f)||null;return{item:g,root_dir:g?g.root_dir:"",revision:g?g.expected_revision:0}}function ot(f){if(typeof f=="string"&&f.length>0)return f;if(f&&typeof f=="object"){let g=f;if(typeof g.message=="string"&&g.message.length>0)return g.message;if(typeof g.error=="string"&&g.error.length>0)return g.error;if(g.error&&typeof g.error=="object"&&typeof g.error.message=="string")return g.error.message}return"\uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4"}async function mt(f,g,w){if(f!=="dep-add")return;let $=T.chain_lanes.find(q=>q.rows.some(z=>z.id===g));!$||!$.rows.some(q=>q.id===w)||await de(q=>Tu($.lane_id,q),"",[{type:f,a:g,b:w}])}function $t(){let f=new Map,g=s&&s.get?s.get():null,w=$=>Array.isArray($)?$.filter(q=>typeof q=="string"&&q.length>0):[];for(let $ of Array.isArray(g)?g:[]){if(!$||typeof $!="object")continue;let q=$.bead_blocked_by&&typeof $.bead_blocked_by=="object"?$.bead_blocked_by:{};for(let[z,re]of Object.entries(q))Array.isArray(re)&&f.set(z,w(re));for(let z of[...Array.isArray($.runnable)?$.runnable:[],...Array.isArray($.session_active)?$.session_active:[]])z&&typeof z.bead_id=="string"&&Array.isArray(z.blocked_by)&&z.blocked_by.length>0&&f.set(z.bead_id,w(z.blocked_by))}return f}function Kt(){let f=new Map,g=new Map,w=s&&s.get?s.get():null,$=q=>Array.isArray(q)?q.filter(z=>typeof z=="string"&&z.length>0):[];for(let q of Array.isArray(w)?w:[]){if(!q||typeof q!="object")continue;let z=q.bead_blocked_by&&typeof q.bead_blocked_by=="object"?q.bead_blocked_by:{};for(let[re,Ce]of Object.entries(z))Array.isArray(Ce)&&f.set(re,$(Ce));for(let re of Array.isArray(q.runnable)?q.runnable:[])re&&typeof re.bead_id=="string"&&Array.isArray(re.blocked_by)&&g.set(re.bead_id,$(re.blocked_by))}for(let q of Z)for(let z of[f,g]){let re=z.get(q.a);re!==void 0&&z.set(q.a,q.type==="dep-remove"?re.filter(Ce=>Ce!==q.b):re.includes(q.b)?re:[...re,q.b])}return{snapshot:f,runnable:g}}function Tt(){let f=$t();for(let g of Z){let w=(f.get(g.a)||[]).slice();g.type==="dep-remove"?f.set(g.a,w.filter($=>$!==g.b)):w.includes(g.b)||f.set(g.a,[...w,g.b])}return f}function Qt(f=T,g=Pe()){let w=new Map;for(let et of Array.isArray(g?.lanes)?g.lanes:[]){let De=new Map;for(let y of Array.isArray(et?.entries)?et.entries:[])y&&typeof y.bead_id=="string"&&De.set(y.bead_id,y.dep_created_by_lane===!0);w.set(typeof et?.id=="string"?et.id:"",De)}let $=new Map,q=new Map,z=new Set,re=new Set;for(let et of f.chain_lanes){let De=w.get(et.lane_id);$.set(et.lane_id,{status:et.status,entries:et.rows.map((y,E)=>({bead_id:y.id,root_dir:y.root_dir,...E===0?{}:{dep_created_by_lane:De?.get(y.id)===!0}}))});for(let y of et.rows)q.set(y.id,et.lane_id),y.fixed&&z.add(y.id),y.unplaced||re.add(y.id)}let Ce=new Map;for(let et of f.parallel_rows)typeof et.queue_index=="number"&&Ce.set(et.id,et.queue_index);for(let et of f.queue_groups)for(let De of et.sublanes.serial)for(let y of De.items)typeof y.queue_index=="number"&&Ce.set(y.id,y.queue_index);let He=Kt();return{blocked_by_map:Tt(),snapshot_blocked_by:He.snapshot,runnable_blocked_by:He.runnable,owner_of:new Map(Object.entries(f.owner_of)),cross_lanes:$,owner_lane_of:q,fixed_members:z,placed_members:re,parallel_rows:f.parallel_rows.map(et=>({bead_id:et.id,root_dir:et.root_dir,queue_index:et.queue_index??0})),parallel_raw_length:new Map(Object.entries(f.parallel_raw_length)),queue_index_of:Ce}}function Pe(){return(s&&s.crossLanes?s.crossLanes():null)??null}function mn(f,g){let w=ne.get(g);if(w&&w.root_dir===f)return w.expected_revision;let $=T.queue_groups.find(q=>q.root_dir===f);return $?$.revision:0}async function Jt(f,g,w){if(f.type==="worker-queue-disarm"){try{let $=await it(f.type,f.payload,f.root_dir,w.get(f.root_dir)??mn(f.root_dir,g));$&&$.queue&&typeof $.queue.revision=="number"&&w.set(f.root_dir,$.queue.revision)}catch{}return!0}if(f.type==="worker-queue-place"||f.type==="worker-queue-reorder"||f.type==="worker-queue-remove")return await Ft(f.type,f.payload,f.root_dir,w,{bead_id:g})!==null;try{return(f.type==="dep-add"||f.type==="dep-remove")&&await oe(f.type,{a:f.a,b:f.b},f.root_dir),!0}catch($){return ce(ot($),"error"),!1}}async function Ft(f,g,w,$,q){try{let z=await it(f,g,w,$.get(w)??mn(w,q.bead_id));return!z||typeof z.applied!="boolean"?(ce("\uD050 \uC694\uCCAD\uC774 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error"),null):(z.queue&&typeof z.queue.revision=="number"&&$.set(w,z.queue.revision),z.conflict?(ce("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null):z.applied===!1?(ce(z.admission_reason?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${z.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null):z.queue&&typeof z.queue.revision=="number"?z.queue.revision:$.get(w)??0)}catch(z){return ce(ot(z),"error"),null}}function Xt(f){(f.type==="dep-add"||f.type==="dep-remove")&&(Z=[...Z,{type:f.type,a:f.a,b:f.b}])}async function gn(f,g){if(!o)return{ok:!1};try{let w=await o(f.type,{...f.payload,expected_revision:g});return!w||typeof w.revision!="number"?(ce("\uC5F0\uACB0 \uB808\uC778 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),{ok:!1}):{ok:!0,revision:w.revision}}catch(w){let $=w,q=$&&$.code==="conflict"?$.details?.cross_lanes:null;return q&&typeof q.revision=="number"&&Array.isArray(q.lanes)?{ok:!1,conflict:q}:(ce(ot(w),"error"),{ok:!1})}}async function _e(f,g,w){let $=new Map,q=[],z=f.ops.slice(0,f.lane_op_index),re=f.ops.slice(f.lane_op_index);for(let He of z){if(!await Jt(He,w,$))return{done:!0};Xt(He)}let Ce=g;for(let He of f.lane_ops){if(Ce===null)return ce("\uC5F0\uACB0 \uB808\uC778 \uC800\uC7A5\uC18C\uB97C \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error"),{done:!0};let et=await gn(He,Ce);if(!et.ok)return et.conflict?{done:!1,conflict:et.conflict}:{done:!0};Ce=et.revision}for(let He of re){if(!await Jt(He,w,$))return{done:!0};Xt(He),He.type==="dep-add"&&q.push(He)}for(let He of Ou(q))Ce=await S(He,Ce);return{done:!0}}async function S(f,g){if(g===null||!o)return g;let w=f.pairs,$=g;for(let q=0;q<2;q+=1){if(w.length===0)return $;try{let z=await o("monitor-lane-provenance",{lane_id:f.lane_id,pairs:w.map(re=>({bead_id:re.bead_id,after:re.after,value:!0})),expected_revision:$});return z&&typeof z.revision=="number"?z.revision:$}catch(z){let re=z,Ce=re&&re.code==="conflict"?re.details?.cross_lanes:null;if(!Ce||typeof Ce.revision!="number"||!Array.isArray(Ce.lanes))return $;let He=Ce.lanes.find(et=>et&&et.id===f.lane_id);w=Lu(Array.isArray(He?.entries)?He.entries:[],w),$=Ce.revision}}return $}async function de(f,g,w=[]){Z=w,he();let $=T,q=Pe();for(let z=0;;z+=1){let re=f(Qt($,q));if("refused"in re){ce(re.refused,"error");break}let Ce=await _e(re,$.cross_lanes_revision,g);if(Ce.done){re.correction&&ae(re.correction.lane_id,re.correction.corrected);break}if(z>=1){ce("\uB808\uC778\uC774 \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4","error");break}$=st(Ce.conflict),q=Ce.conflict}Z=[],ve()}async function Oe(f,g){await de(w=>Aa(f,g,w),f.bead_id)}async function yt(f,g){if(f==="run"){await At(g);return}if(f==="stop"){await jt(g);return}if(f==="create"){await de(w=>Sa(null,w),"");return}if(f==="remove"){let w=Ru(g,Qt());if(w!==null&&!m(w))return;await de($=>Cu(g,$),"");return}await de(w=>f==="confirm"?Su(g,w):Eu(g,w),"")}function Rt(f){let g=new Map;for(let w of f.rows){let $=T.owner_of[w.id]||w.root_dir;typeof $!="string"||$.length===0||g.set($,[...g.get($)||[],w.id])}return g}async function At(f){let g=T.chain_lanes.find(z=>z.lane_id===f);if(!g||T.cross_lanes_revision===null){ve();return}he();let w=new Map,$=new Map,q=Rt(g);for(let z of g.rows){if(!z.unplaced)continue;let re=T.owner_of[z.id]||z.root_dir;if(typeof re!="string"||re.length===0){ce(`${z.id}\uC758 \uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC801\uC7AC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4`,"error"),ve();return}let Ce=$.get(re)??0;if(await Ft("worker-queue-place",{bead_id:z.id,lane:"parallel",index:(T.parallel_raw_length[re]??0)+Ce},re,w,{bead_id:z.id})===null){ve();return}$.set(re,Ce+1)}for(let[z,re]of q)if(await Ft("worker-queue-arm",{bead_ids:re,lane_id:f},z,w,{bead_id:re[0]})===null){ce("\uC77C\uBD80 \uB808\uD3EC\uC5D0\uC11C \uC9C4\uD589\uC744 \uCF1C\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 \u2014 [\u25B6 \uC774\uC5B4\uC11C \uC9C4\uD589]\uC73C\uB85C \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694","error"),ve();return}ve()}async function jt(f){let g=T.chain_lanes.find($=>$.lane_id===f);if(!g||T.cross_lanes_revision===null){ve();return}he();let w=new Map;for(let[$,q]of Rt(g))if(await Ft("worker-queue-disarm",{lane_id:f},$,w,{bead_id:q[0]})===null)break;ve()}async function nn(f,g){let{root_dir:w,revision:$}=Ze(f);if(w.length===0){ve();return}await Ft("worker-queue-disarm",{bead_ids:[f],lane_id:g},w,new Map([[w,$]]),{bead_id:f}),ve()}async function rn(f,g){let w=ne.get(f);if(!w){ve();return}let $={kind:"candidate",bead_id:f,root_dir:w.root_dir};if(g==="new-lane"){await de(q=>Sa({bead_id:f,root_dir:w.root_dir},q),f);return}if(g.startsWith("lane:")){let q=g.slice(5);if(!T.chain_lanes.find(re=>re.lane_id===q)){ve();return}await de(re=>Aa($,{kind:"chain",lane_id:q,marker_index:(re.cross_lanes.get(q)?.entries??[]).length},re),f);return}if(g.startsWith("serial:")){let q=g.slice(7),z=(w.place_lanes||[]).find(re=>re.id===q);await Oe($,{kind:"repo-serial",root_dir:w.root_dir,lane_id:q,index:z?z.index:0});return}await Oe($,{kind:"parallel",marker_index:T.parallel_rows.length})}async function En(f,g){let w=T.parallel_rows,$=w.findIndex(et=>et.id===f);if($<0)return;let q=w[$].root_dir,z=[];w.forEach((et,De)=>{et.root_dir===q&&z.push(De)});let re=z.indexOf($),Ce=z[re+g];if(typeof Ce!="number")return;let He=g===-1?Ce:z[re+2]??Math.min(w.length,Ce+1);await Oe({kind:"parallel",bead_id:f,root_dir:q,queue_index:w[$].queue_index??0},{kind:"parallel",marker_index:He})}async function Mt(f){for(let g of T.chain_lanes){let w=g.rows.find($=>$.id===f);if(w){await Oe({kind:"chain",bead_id:f,root_dir:w.root_dir,lane_id:g.lane_id,...typeof w.queue_index=="number"?{queue_index:w.queue_index}:{}},{kind:"parallel",marker_index:T.parallel_rows.length});return}}}let sn=null,cn=!1,un=null;function Gn(){un!==null&&clearTimeout(un),un=setTimeout(()=>{un=null,cn=!1},0)}function x(f,g){let w=g&&typeof g.closest=="function"?g.closest("[data-row-index]"):null;if(w&&f.contains(w)){let $=Number(w.getAttribute("data-row-index"));return Number.isFinite($)?$:0}return f.querySelectorAll("[data-row-index]").length}function O(f){let g=typeof f?.closest=="function"?f.closest(".worker-pane--collapsed[data-lane]"):null;if(!g)return null;let w=g.getAttribute("data-lane");return w==="queue"?{zone:g,target:{kind:"parallel",marker_index:T.parallel_rows.length}}:w==="candidate"?{zone:g,target:{kind:"candidate"}}:null}function p(f){let g=f.target;if(!sn)return null;let w=typeof g?.closest=="function"?g.closest("[data-drop]"):null;if(!w)return O(g);let $=w.getAttribute("data-drop");if($==="candidate")return{zone:w,target:{kind:"candidate"}};if($==="parallel")return{zone:w,target:{kind:"parallel",marker_index:x(w,g)}};if($==="chain")return{zone:w,target:{kind:"chain",lane_id:w.getAttribute("data-lane-id")||"",marker_index:x(w,g)}};if($==="repo-serial"){let q=w.getAttribute("data-root-dir")||"";if(q!==sn.root_dir)return null;let z=typeof g?.closest=="function"?g.closest("[data-queue-index]"):null,re=z&&w.contains(z)?z.getAttribute("data-queue-index"):w.getAttribute("data-lane-length"),Ce=Number(re);return{zone:w,target:{kind:"repo-serial",root_dir:q,lane_id:w.getAttribute("data-lane-id")||"",index:Number.isFinite(Ce)?Ce:0}}}return null}function h(){for(let f of Array.from(ge.querySelectorAll(".is-drop-over")))f.classList.remove("is-drop-over")}let L=null;function ee(f){L=f.target instanceof Element?f.target:null}function pe(f){let g=f.target,w=typeof g?.closest=="function"?g.closest('[draggable="true"][data-bead-id]'):null,$=w?w.closest("[data-drag-kind]"):null;if(!$)return;if(w&&L&&w.contains(L)&&typeof L.closest=="function"&&L.closest("input, button, a")){f.preventDefault();return}let q=$.getAttribute("data-bead-id")||"",z=$.getAttribute("data-drag-kind")||"",re=$.getAttribute("data-root-dir")||"";if(!q||!z||!re)return;let Ce=$.getAttribute("data-queue-index")||"",He=Number(Ce),et=$.getAttribute("data-lane-id")||"";sn={kind:z,bead_id:q,root_dir:re,...Ce!==""&&Number.isFinite(He)?{queue_index:He}:{},...et?{lane_id:et}:{}},cn=!0,D=null,ge.classList.add("is-dragging");try{f.dataTransfer?.setData("text/plain",q),f.dataTransfer&&(f.dataTransfer.effectAllowed="move")}catch{}}function ut(f){let g=p(f);g&&(f.preventDefault(),f.dataTransfer&&(f.dataTransfer.dropEffect="move"),g.zone.classList.add("is-drop-over"))}function Qe(f){let g=f.target;typeof g?.closest=="function"&&(g.closest("[data-drop]")?.classList.remove("is-drop-over"),g.closest(".worker-pane--collapsed")?.classList.remove("is-drop-over"))}function Bt(){sn=null,h(),ge.classList.remove("is-dragging"),Gn()}function Gt(f){let g=p(f),w=sn;sn=null,h(),ge.classList.remove("is-dragging"),!(!g||!w)&&(f.preventDefault(),Oe(w,g.target))}function en(f){return{runner:f.runner||void 0,model:f.model||void 0,effort:f.effort||void 0,status:f.run_state==="running"?"running":f.run_state,worktree:f.root_dir}}function Tn(f,g){let{item:w,root_dir:$,revision:q}=Ze(g),z=w?.attempt_id||"",re=f.classList;if(re.contains("worker-mini__rowops-up")||re.contains("worker-mini__rowops-down")){En(g,re.contains("worker-mini__rowops-up")?-1:1);return}if(re.contains("worker-mini__rowops-remove")){it("worker-queue-remove",{bead_id:g},$,q);return}if(re.contains("mon2-crow__detach")){Mt(g);return}if(re.contains("worker-dep__open")){ke(f.getAttribute("data-dep-id")||"",f.getAttribute("data-root-dir")||"");return}if(re.contains("mon2-arm__release")){nn(g,f.getAttribute("data-lane-id")||"");return}if(re.contains("mon-lane__chip")){let Ce=f.getAttribute("data-lane-id")||"";ge.querySelector(`.mon2-clane[data-lane-id="${Ce}"]`)?.scrollIntoView({block:"nearest"});return}if(re.contains("mon-overlap__chip")){let Ce=f.getAttribute("data-overlap-id")||"";j=!!j&&j.bead_id===g&&j.counterpart_id===Ce?null:{bead_id:g,counterpart_id:Ce},ve();return}if(re.contains("mon-overlap__place")){Fe(g,f.getAttribute("data-counterpart-id")||"");return}if(re.contains("worker-card__place")){D=D===g?null:g,ve();return}if(re.contains("worker-card__place-cancel")){D=null,ve();return}if(re.contains("worker-card__place-lane")){let Ce=f.getAttribute("data-lane")||"parallel";D=null,rn(g,Ce);return}if(re.contains("rtile__session")){if(w&&w.kind==="session"){let Ce=(w.session_refs||[]).find(He=>He&&He.current===!0);Ce&&(X.hidden=!1,Se.open(Yr(Ce,g,"in_progress",$)),ve());return}B=z,z&&w&&(X.hidden=!1,Se.open({attempt_id:z,root_dir:$,meta:en(w)})),ve();return}if(re.contains("rtile__pause")){oe("worker-attempt-pause",{attempt_id:z},$);return}if(re.contains("rtile__resume")){Vr().then(Ce=>{if(Ce!==null)return _t("worker-attempt-resume",{attempt_id:z,...Ce!==""?{instructions:Ce}:{}},$,q)});return}if(re.contains("rtile__dismiss")){it("worker-attempt-dismiss",{attempt_id:z},$,q);return}if(re.contains("rtile__discard")){if(!m(Ps(g,"unmerged")))return;R({bead_id:g,...z?{attempt_id:z}:{},...f.dataset.operationId?{operation_id:f.dataset.operationId}:{}},$,q);return}if(re.contains("worker-mini__merge")){let Ce=ht($,g);Ce?.mismatch&&Ce.continuation===null?wt($,g,q,Ce.mismatch):it("worker-merge-queue-add",{bead_id:g},$,q);return}if(re.contains("worker-mini__merge-cancel")){it("worker-merge-queue-remove",{bead_id:g},$,q);return}if(re.contains("worker-mini__discard")){let Ce=f.dataset.discardMode==="merged"?"merged":"unmerged";if(!m(Ps(g,Ce)))return;R({bead_id:g,...f.dataset.attemptId?{attempt_id:f.dataset.attemptId}:{},...f.dataset.operationId?{operation_id:f.dataset.operationId}:{}},$,q);return}if(re.contains("worker-mini__revise-fix")){_t("worker-revise-fix",{bead_id:g},$,q);return}re.contains("worker-mini__revise-approve")&&it("worker-revise-approve",{bead_id:g},$,q)}function bn(f){let g=cn;cn=!1;let w=f.target;if(!w||typeof w.closest!="function"||w.closest("dialog")||w.closest(".worker-drawer-overlay")||w.closest("a"))return;let $=w.closest(".worker-card__id, .worker-mini__id, .rtile__id");if($){f.preventDefault();let me=w.closest(".mon2-item, .rtile, .mon2-crow, .worker-mini")?.getAttribute("data-bead-id")||$.textContent?.trim()||"";me&&$e(me);return}let q=w.closest(".worker-mini__repo, .worker-card__repo, .mon2-sec__worker");if(q){f.preventDefault();let A=q.getAttribute("data-root-dir")||ne.get(w.closest(".mon2-item, .rtile, .worker-mini")?.getAttribute("data-bead-id")||"")?.root_dir||q.getAttribute("title")||"";Ge(A);return}let z=w.closest(".mon2-sec__toggle");if(z){f.preventDefault(),We(z.getAttribute("data-root-dir")||"");return}let re=w.closest(".worker-pane__toggle[data-lane]");if(re){f.preventDefault();let A=re.getAttribute("data-lane")||"";(A==="candidate"||A==="queue"||A==="running"||A==="pr_wait"||A==="done")&&Je(A);return}let Ce=w.closest(".worker-wait__area-toggle[data-area]");if(Ce){f.preventDefault(),tt(Ce.getAttribute("data-area")||"parallel");return}if(w.closest(".mon2-newlane")){f.preventDefault(),yt("create","");return}let He=w.closest(".mon2-clane__confirm, .mon2-clane__reapply, .mon2-clane__remove, .mon2-clane__run, .mon2-clane__stop");if(He){f.preventDefault();let A=He.getAttribute("data-lane-id")||"",me=He.classList;yt(me.contains("mon2-clane__confirm")?"confirm":me.contains("mon2-clane__reapply")?"reapply":me.contains("mon2-clane__run")?"run":me.contains("mon2-clane__stop")?"stop":"remove",A);return}if(w.closest(".mon-merge-all")){f.preventDefault(),Te();return}let et=w.closest(".mon-filter__spec");if(et){f.preventDefault(),k={...k,spec:et.getAttribute("data-spec")||"all"},Vp(k),ve();return}let De=w.closest(".mon2-item, .rtile, .mon2-crow, .worker-mini, .worker-card");if(!De)return;let y=De.getAttribute("data-bead-id")||"",E=w.closest("button");if(E){f.preventDefault(),Tn(E,y);return}y&&!g&&(f.preventDefault(),ke(y,De.getAttribute("data-root-dir")||Ze(y).root_dir))}function Vt(f){let g=f.target;if(!g||typeof g.closest!="function")return;let w=g.closest(".mon-filter__blocked");if(w){k={...k,show_blocked:w.checked},Vp(k),ve();return}let $=g.closest(".mon-candidate-sort");if($){N=js.some(re=>re.value===$.value)?$.value:"repo_spec",Ey(N),ve();return}let q=g.closest(".mon-running-sort");if(q){b=q.value==="repo"?"repo":"started",Iy(b),ve();return}let z=g.closest(".mon-done-range");z&&(v=Kn(z.value),Oy(v),ve())}function hn(f){let g=f.target,w=g&&typeof g.closest=="function"?q=>g.closest(q):()=>null,$=!1;j&&!w(".mon-overlap__popover, .mon-overlap__chip")&&(j=null,$=!0),$&&ve()}function Ln(f){f.key!=="Escape"||!j||(j=null,ve())}e.addEventListener("click",bn),e.addEventListener("change",Vt),e.addEventListener("pointerdown",ee),document.addEventListener("click",hn),document.addEventListener("keydown",Ln),e.addEventListener("dragstart",pe),e.addEventListener("dragover",ut),e.addEventListener("dragleave",Qe),e.addEventListener("drop",Gt),e.addEventListener("dragend",Bt);{let f=!0;Y=Ni(g=>{if(le=g,f){f=!1;return}ve()})}s&&typeof s.subscribe=="function"&&(we=s.subscribe(()=>{try{Ae.clear(),ve()}catch{}}));function In(){Re!==null&&(clearInterval(Re),Re=null)}function ar(){un!==null&&(clearTimeout(un),un=null)}return{recorrectSharedLane:mt,load(){n("load"),ve(),Re===null&&(Re=setInterval(()=>{try{ve()}catch{}},My))},pause(){In()},clear(){In(),ar(),we&&(we(),we=null),Y&&(Y(),Y=null),Se.destroy(),X.hidden=!0,fe?.destroy(),fe=null,e.removeEventListener("click",bn),e.removeEventListener("change",Vt),e.removeEventListener("pointerdown",ee),document.removeEventListener("click",hn),document.removeEventListener("keydown",Ln),e.removeEventListener("dragstart",pe),e.removeEventListener("dragover",ut),e.removeEventListener("dragleave",Qe),e.removeEventListener("drop",Gt),e.removeEventListener("dragend",Bt),e.replaceChildren()}}}function sf(e,t,n){let r=qt("views:nav"),{global_element:s,repo_element:o}=e,i=null;function a(v){return b=>{b.preventDefault();let k=v==="monitor"&&l()==="monitor"?"worker":v;r("click tab %s",k),n.gotoView(k)}}function l(){let v=t.getState();return v.view==="worker"||v.view==="monitor"?v.view:"board"}function u(){let v=l();return c`
      <a
        href="#/monitor"
  ...
  `}var Fy=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function ff(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(ae=>ce(ae,"error",4e3)),i=document.createElement("dialog");i.id="settings-dialog",i.className="settings-dialog",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","\uC124\uC815"),e.appendChild(i);let a="execution",l=!1,u="",d=null;function m(){if(d)return d;let ae=i.querySelector('[data-pane="execution"]');return ae?(d=ji(ae,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:he=>t.queueStore?.set?.(he)}),d):null}function v(){return c`
      <section
    ...
    `}function b(){let ae=r.get();return c`
      ...
      >
        ...
        ${ae?c`
              ${uf(ae,s(),K)}
              ${df(ae,u,{onDraft:he=>{u=he},onAdd:le,onRemove:Y})}
              ${pf(ae,B)}
            `:c`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function k(ae){let he=r.get();if(he)try{let Ue=await n("display-policy-set",{expected_revision:he.revision,policy:ae(he)});N(Ue),Ue&&Ue.conflict&&Ue.policy&&(Ue=await n("display-policy-set",{expected_revision:Ue.policy.revision,policy:ae(Ue.policy)}),N(Ue)),Ue&&Ue.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function N(ae){ae&&ae.policy&&typeof ae.policy=="object"&&r.set(ae.policy)}function W(ae){k(ae)}function K(ae){let he=r.get();if(!he)return;let Ue=!jy(ae,he);W(ge=>By(ae,ge,Ue))}function le(){let ae=u.trim();ae.length!==0&&(u="",W(he=>he.hidden_prefixes.includes(ae)?{hidden_prefixes:he.hidden_prefixes}:{hidden_prefixes:[...he.hidden_prefixes,ae]}),D())}function Y(ae){W(he=>({hidden_prefixes:he.hidden_prefixes.filter(Ue=>Ue!==ae)}))}function B(ae){let he=r.get();if(!he)return;let Ue=he.chips[ae]===!1;W(()=>({chips:{[ae]:Ue}}))}function D(){rt(c`
    ...
    </span>`}function D(ge,X,Ee){let Le=kf(X,Ee),T=X.available&&(X.held||Le>El),ne=T?`${Math.floor(Le/60)}\uBD84 \uC804 \uCE21\uC815`:"",Ae=X.accounts.filter(Se=>!Se.active).length,we=`usage-meter__group${T?" usage-meter__group--stale":""}`,Re=c`<span class="usage-meter__provider"
        >${ge.label}</span
      >
      ${X.available?X.windows.map(Se=>B(Se,T,ne,Ee)):c`<span class="usage-meter__empty">사용량 없음</span>`}
      ${Ae>0?c`<span class="usage-meter__badge">+${Ae}</span>`:""}`;if(X.accounts.length===0)return c`<span
        class=${we}
        aria-label=${`${ge.label} usage`}
        >${Re}</span
      >`;let fe=n===ge.key;return c`<button
      type="button"
    ...
    >
      ${Re}
    </button>`}function j(ge,X){return c`<span class="usage-meter" aria-label="Usage">
      ${ge.map(Ee=>D(Ee.provider,Ee.snapshot,X))}
    </span>`}function Z(ge,X){let Ee=hf(ge.pct),Le=gf(ge.resetsAt,X);return c`<span
      class="usage-meter__account-window ${bf(Ee)}"
      style=${`--progress: ${Ee}%`}
    >
      ...
      <span class="usage-meter__account-reset"
        >${Le.length>0?`\u21BB ${Le}`:""}</span
      >
    </span>`}function V(ge,X){return zy.includes(X)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${ge.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function ue(ge,X,Ee){let Le=X.status==="ok",T=typeof X.ageSeconds=="number"&&X.ageSeconds>El,ne=i.get(vf(ge.key,X.number)),Ae=r.get(ge.key),we=Ae!==void 0,Re=Ae===X.number,fe=["usage-meter__account"];return X.active&&fe.push("usage-meter__account--active"),Le||fe.push("usage-meter__account--unavailable"),T&&fe.push("usage-meter__account--stale"),c`<div class=${fe.join(" ")}>
    ...
    </div>`}function U(ge,X,Ee){let Le=X.accounts.filter(T=>T.active).length;return c`<section class="usage-meter__section">
      <h2 class="usage-meter__section-title">
        ${ge.label} · 활성 ${Le} / 전체
        ${X.accounts.length}
      </h2>
      ${X.accounts.map(T=>ue(ge,T,Ee))}
    </section>`}function J(ge,X){return c`<div
      class="usage-meter__card"
      id=${_f}
      role="dialog"
      aria-label=${`${ge.provider.label} \uACC4\uC815 \uC0AC\uC6A9\uB7C9`}
    >
      ${U(ge.provider,ge.snapshot,X)}
      <p class="usage-meter__note">전환은 새로 시작하는 세션부터 적용됩니다.</p>
    </div>`}function se(){let ge=Date.now(),X=[];for(let Le of yf){let T=o.get(Le.key);T&&X.push({provider:Le,snapshot:Zy(T,ge)})}if(X.length===0){b(),u();return}let Ee=X.find(Le=>Le.provider.key===n&&Le.snapshot.accounts.length>0);Ee||b(),rt(j(X,ge),e),e.hidden=!1,Ee?ae(Ee,ge):m()}function ae(ge,X){let Ee=d(),Le=e.getBoundingClientRect(),T=e.ownerDocument.documentElement.clientWidth;Ee.style.setProperty("--usage-meter-anchor-top",`${Le.bottom}px`),Ee.style.setProperty("--usage-meter-anchor-right",`${Math.max(0,T-Le.right)}px`),rt(c`<div
          class="usage-meter__scrim"
          aria-hidden="true"
          @mousedown=${le}
        ></div>
        ${J(ge,X)}`,Ee)}async function he(ge){try{let X=await fetch(ge.endpoint);return X.ok?Yy(await X.json(),Date.now()):{kind:"error"}}catch{return{kind:"error"}}}async function Ue(){a+=1;let ge=a,X=await Promise.all(yf.map(async Ee=>({provider:Ee,read:await he(Ee)})));if(!(t||ge!==a)){for(let Ee of X){let Le=Ee.provider.key;if(Ee.read.kind==="ok"){o.set(Le,Ee.read.snapshot);continue}if(Ee.read.kind==="empty"){o.delete(Le);continue}let T=o.get(Le);T!==void 0&&!T.held&&o.set(Le,{...T,held:!0})}se()}}return u(),Ue(),s=setInterval(()=>{Ue()},6e4),{destroy(){t=!0,s!==null&&(clearInterval(s),s=null),b(),u()}}}function xf(e){let t=e.attempts?Object.values(e.attempts):[],n=new Map;for(let s of t)s&&(s.kind??"implementation")==="implementation"&&n.set(s.bead_id,s.attempt_id);let r=new Map;for(let s of e.done||[])s&&typeof s.bead_id=="string"&&typeof s.added_at=="number"&&r.set(s.bead_id,s.added_at);return s=>{let o=n.get(s.bead_id)!==s.attempt_id,i=r.get(s.bead_id),a=typeof i=="number"&&i>0&&typeof s.finished_at=="number"&&i>=s.finished_at;return!o&&!a&&typeof s.dismissed_at!="number"}}var Xy="worker-ineligible";function so(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Af(e){return so(e).includes(Xy)}var Qy="session-preferred",Jy=["exclusive_machine","iterative_user_judgment","visual_verification"];function Sf(e,t){if(!so(e).includes(Qy)||typeof t!="object"||t===null)return"";let n=t.session_preferred_reason;return typeof n=="string"&&Jy.includes(n)?n:""}var ev="worker-serial";function Tl(e){return so(e).includes(ev)}var Ef=new Set(["sh","bash","zsh","dash","ksh"]),Tf=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function Cf(e){let t=e.split("/");return t[t.length-1]||""}function tv(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let n=t.slice(2).trim().split(/\s+/).filter(Boolean);if(n.length===0)return!1;let r=Cf(n[0]);if(r!=="env")return Ef.has(r);let s=n.slice(1).find(o=>!o.startsWith("-")&&!o.includes("="));return s!==void 0&&Ef.has(Cf(s))}function nv(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function rv(e){let t=[],n=0;Tf.lastIndex=0;for(let r of e.matchAll(Tf)){let s=r.index;s>n&&t.push({text:e.slice(n,s),kind:"plain"}),t.push({text:r[0],kind:nv(r[0])}),n=s+r[0].length}return n<e.length&&t.push({text:e.slice(n),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function sv(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function Rf(e){let t=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),r=document.createElement("div");r.className="repo-ops-script-viewer-root",document.body.appendChild(r);let s=null,o="loading",i="",a="",l=0,u=null,d=!1;function m(D,j){return j?rv(D).map(Z=>Z.kind==="plain"?Z.text:c`<span
...
`):[];return c`<div
        ...
        <div class="repo-ops-script-viewer__body" aria-live="polite">
          ${o==="loading"?c`<div class="repo-ops-script-viewer__status">
                ...
                >
                  ...
                  ${j.map((Z,V)=>c`<div class="repo-ops-script-viewer__row">
                        <span
    ...
    </div>`}function b(){rt(v(),r)}async function k(){if(o!=="ready")return;let D=await Nn(i);ce(D?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",D?"success":"error")}function N(D){D.key==="Escape"&&s&&(D.preventDefault(),Y())}function W(){d||(document.addEventListener("keydown",N),d=!0)}function K(){d&&(document.removeEventListener("keydown",N),d=!1)}async function le(D,j=null){let Z=++l;W(),s={...D},u=j||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",i="",a="",b(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let ue=t?t():"";if(!ue){o="error",a="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",b();return}if(!n){o="error",a="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",b();return}let U="/api/repo-ops-script?workspace="+encodeURIComponent(ue)+"&lane="+encodeURIComponent(D.lane)+"&base_sha="+encodeURIComponent(D.base_sha);try{let J=await n(U),se=await J.json().catch(()=>({}));if(Z!==l)return;if((t?t():"")!==ue){Y();return}if(!J.ok||!se||se.ok!==!0){o="error",a=sv(se&&typeof se.error=="string"?se.error:""),b();return}s={lane:se.lane,base_sha:se.base_sha,path:se.path,base_ref:se.base_ref},i=String(se.content),o="ready",b()}catch{if(Z!==l)return;o="error",a="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",b()}}function Y(){l+=1,K(),s=null,i="",b();let D=u;u=null,D?.isConnected&&D.focus()}function B(){Y(),r.remove()}return{open:le,close:Y,destroy:B}}var Of={deploy_not_declared:"\uC120\uC5B8 \uC5C6\uC74C",deploy_opted_out:"\uC774 workspace\uC5D0\uC11C \uBC30\uD3EC \uC2E4\uD589\uC774 \uAEBC\uC838 \uC788\uC74C",deploy_in_flight:"\uBC30\uD3EC \uC9C4\uD589 \uC911",target_unresolved:"\uB300\uC0C1 tip\uC744 \uD655\uC815\uD558\uC9C0 \uBABB\uD568",remote_history_not_monotonic:"\uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC\uC640 \uC6D0\uACA9 \uC774\uB825\uC774 \uAC08\uB77C\uC9D0"},ov=new Set(["queued","running","retry_pending"]);function Lf(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function i(){let U=o();return typeof U.revision=="number"?U.revision:0}function a(U){t&&U&&U.queue&&typeof U.queue=="object"&&t.set(U.queue)}function l(){let U=o().workspace_info;return U&&typeof U=="object"?U:{}}function u(U,J){return c`<span
      class="worker-repo-ops__vd-badge worker-repo-ops__vd-badge--${U}"
      >${J}</span
    >`}function d(U){if(typeof U!="number"||!Number.isFinite(U))return"";let J=U/6e4;return Number.isInteger(J)?`timeout ${J}\uBD84`:`timeout ${Math.round(U/1e3)}\uCD08`}function m(U){let J=d(U);return J?u("config",J):""}function v(U,J,se){return c`<button
      type="button"
      class="worker-repo-ops__vd-cmd worker-repo-ops__vd-cmd--link"
      .textContent=${se.script}
      @click=${ae=>{s&&s({lane:U,base_sha:J.base_sha,path:se.script,base_ref:J.base_ref},ae.currentTarget)}}
    ></button>`}function b(){let U=o().repo_operations;return Array.isArray(U)?U:[]}function k(){let U=l().repo_ops,J=U&&typeof U=="object"?U.repo_id:null;return typeof J=="string"&&J?J:null}function N(){return b().some(U=>U&&U.kind==="deploy"&&ov.has(U.state))}function W(){let U=N(),J=k()===null;return c`<button
      type="button"
      class="worker-repo-ops__deploy-run"
      data-seam="repo-ops-deploy-run"
      ?disabled=${U||J}
      title=${U?"\uBC30\uD3EC \uC9C4\uD589 \uC911":J?"\uC800\uC7A5\uC18C\uB97C \uD655\uC778\uD560 \uC218 \uC5C6\uC74C":"\uC6D0\uACA9 base tip\uC5D0\uC11C \uBC30\uD3EC \uC2A4\uD06C\uB9BD\uD2B8\uB97C 1\uD68C \uC2E4\uD589\uD569\uB2C8\uB2E4"}
      @click=${()=>{j()}}
    >
      배포 실행
    </button>`}function K(){let U=o().repo_ops_opt_out;return{verify:U?.verify===!0,deploy:U?.deploy===!0}}function le(U,J){return c`<label class="worker-repo-ops__lane-run">
      <input
        type="checkbox"
        .checked=${!J}
        @change=${se=>{D(U,!se.target.checked)}}
      />
      이 workspace에서 실행
    </label>`}function Y(U){let J=typeof U.base_sha=="string"?U.base_sha:"",se=`${U.source_path||"repo-ops/config.toml"} @ ${U.base_ref||"?"}${J?`@${J.slice(0,7)}`:""}`,ae=K(),he=!!U.verify&&ae.verify,Ue=!!U.deploy&&ae.deploy;return c`<section class="worker-repo-ops__vd" data-seam="repo-ops">
      ...
      >
        ...
        <span class="worker-repo-ops__lane-d"
          >${he?"\uC774 workspace\uC5D0\uC11C\uB294 \uAC80\uC99D \uC5C6\uC774 \uD310\uC815\uD569\uB2C8\uB2E4.":U.verify?"\uBA38\uC9C0 \uC804\uC5D0 \uC774 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uD1B5\uACFC\uD574\uC57C \uC790\uACA9\uC744 \uC5BB\uC2B5\uB2C8\uB2E4.":"\uBA38\uC9C0 \uC790\uACA9\uC740 PR/base/head \uC2E0\uC120\uB3C4\xB7mergeability\xB7\uB9AC\uBDF0 \uC601\uC218\uC99D\uC73C\uB85C\uB9CC \uD310\uC815\uD569\uB2C8\uB2E4."}</span
        >
        ${U.verify?le("verify",ae.verify):""}
      </div>
      <div
      ...
      >
        ...
        >
        ${U.deploy?le("deploy",ae.deploy):""}
      </div>
    </section>`}function B(U){let J=U.repo_ops&&typeof U.repo_ops=="object"?U.repo_ops:null;return J&&(J.status==="resolved"||J.status==="absent")?Y(J):J&&(J.status==="pending"||J.status==="error")?c`<section class="worker-repo-ops__vd" data-seam="repo-ops">
        <p class="worker-repo-ops__vd-title">
          저장소 작업 선언
    ...
    </section>`}async function D(U,J){if(!n)return;let se=await n("worker-repo-ops-opt-out-toggle",{kind:U,opted_out:J,expected_revision:i()});if(a(se),se&&se.conflict){let ae=await n("worker-repo-ops-opt-out-toggle",{kind:U,opted_out:J,expected_revision:i()});a(ae)}r()}async function j(){let U=k();if(!n||U===null)return;let J=await n("worker-repo-operation-deploy-run",{repo_id:U});if(a(J),!J||J.ok!==!0){let se=J&&typeof J.reason=="string"?J.reason:"",ae=Object.hasOwn(Of,se)?Of[se]:se||"\uBC30\uD3EC \uC2E4\uD589\uC744 \uC2DC\uC791\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4";ce(`\uBC30\uD3EC \uC2E4\uD589 \uAC70\uBD80 \u2014 ${ae}`,"error")}else ce("\uBC30\uD3EC \uC2E4\uD589\uC744 \uC2DC\uC791\uD588\uC2B5\uB2C8\uB2E4","success");r()}let Z={owned_deploy_worktree_fetch_detached_alignment_recreate:"\uC804\uC6A9 \uBC30\uD3EC \uC6CC\uD06C\uD2B8\uB9AC \uC815\uB82C\xB7\uBCF5\uAD6C",recovered_pre_execution_fetch_timeout_retry_once:"fetch \uD0C0\uC784\uC544\uC6C3 1\uD68C \uBCF5\uAD6C",repo_serial_lock_wait:"\uC800\uC7A5\uC18C \uC21C\uCC28 \uC2E4\uD589 \uB300\uAE30",restart_operation_adoption:"\uC7AC\uC2DC\uC791 \uD6C4 \uC791\uC5C5 \uC778\uACC4",exact_input_exit_zero_evidence_adoption:"\uB3D9\uC77C \uC785\uB825 \uC131\uACF5 \uC99D\uAC70 \uC778\uACC4",descendant_success_covers_ancestor_rows:"\uCD5C\uC2E0 SHA \uC131\uACF5\uC774 \uC774\uC804 \uD589 \uCEE4\uBC84",owned_verify_candidate_cleanup:"\uAC80\uC99D \uC784\uC2DC \uCCB4\uD06C\uC544\uC6C3 \uC815\uB9AC",bounded_single_script_retry_exceeded:"\uB2E8\uC77C \uC2A4\uD06C\uB9BD\uD2B8 \uC7AC\uC2DC\uB3C4 \uD55C\uB3C4 \uCD08\uACFC",repair_session_dispatch:"\uC2E4\uD328 \uD574\uACB0 \uC138\uC158 \uC790\uB3D9 \uC2E4\uD589",baseline_failure_ignore:"\uAE30\uC874 \uC2E4\uD328 \uBB34\uC2DC",config_or_script_deletion_to_bypass_gate:"\uC124\uC815\xB7\uC2A4\uD06C\uB9BD\uD2B8 \uC0AD\uC81C\uB85C \uAC8C\uC774\uD2B8 \uC6B0\uD68C",credential_entry:"\uC790\uACA9\uC99D\uBA85 \uC785\uB825\xB7\uCD9C\uB825",destructive_action:"\uD30C\uAD34\uC801 \uC791\uC5C5",history_rewrite:"\uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131",agent_self_report_as_success:"\uC138\uC158 \uC790\uAE30\uBCF4\uACE0\uB97C \uC131\uACF5 \uCC98\uB9AC"};function V(U,J,se){return c`<div class="worker-repo-ops__policy-group" data-policy=${se}>
    ...
    </div>`}function ue(){let U=o(),J=U.repo_operation_policy&&typeof U.repo_operation_policy=="object"?U.repo_operation_policy:null;return J?c`<section
...
`),live:e.auto_resolution.live===!0});if(e.head_review&&e.head_review.state!=="failed")return n(e.head_review.badge,{title:e.head_review.title,live:e.head_review.live===!0});if(e.recovery?.lock_actions)return n(e.recovery.badge,{title:e.recovery.title,live:!0});if(e.cleanup_failed)return n(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0});if(e.base_exception)return n("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0});if(e.conflicting)return n("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="base_behind")return n("base \uAC31\uC2E0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale")return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0});if(e.gate?.reason==="spec_id_missing")return n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0});if(e.gate?.reason==="review_receipt_invalid")return n("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0});if(zf(e.receipt_check).length>0)return n("\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694",{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${zf(e.receipt_check).join(", ")}`,alert:!0});if(e.head_review?.state==="failed"){let r=Nv(e.head_review.failure_reason);return n(`\uB9AC\uBDF0 \uC2E4\uD328: ${r.label}`,{title:e.head_review.failure_reason?`${r.action} (${e.head_review.failure_reason})`:r.action,alert:!0})}return e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Wf(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Wf(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function Vv(e,t,n,r,s=null,o=null,i=null,a=!1,l=null,u=!0,d=null,m=null,v=null,b={},k=!1,N=!1,W={},K=null){let le=!!l&&l.position>0,Y=!!l?.continuation_action&&l.continuation_action.continuation===null,B=!!l&&l.active===!0,D=l&&l.failure||null,j=Fv(l?l.waiting:null,v),Z=n[e]||null,V=Z&&Z.gate?Z.gate:null,ue=Z&&Z.pr?Z.pr:null,U=jv(l?l.resolution:null),J=Bv(l?l.head_review:null),se=l&&l.head_review||null,ae=zv(v,se),he=Gv(v,ae),Ue=l&&l.authority||null,ge=!!se&&["pending","reviewing","revising"].includes(se.state),X=!!v&&typeof v=="object"&&Wv.has(v.phase),Ee=le&&!B&&(se?.state==="failed"||!Ue||X||Ue.source==="automatic"&&!N),Le=i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":U?U.badge:i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":j,T=!!V&&V.base_badge==="\uCDA9\uB3CC",ne=!!V&&V.enabled===!0,Ae=qs({bead_id:e,merge_sha:W.merge_sha,cleanup_cursor:W.cleanup_cursor,merge_progress:o&&o.merge_progress?o.merge_progress:null,cleanup_failed:r,repo_operations:W.repo_operations}),we=gi(Ae),Re=o&&!Ae&&(o.queueing??null)?o.queueing:null,fe=!!r&&["child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!V&&V.tier==="merged",Se=a&&!!r&&!!V&&V.tier==="merged",it=Ee&&(ne||T||V?.reason==="base_behind"||V?.reason==="review_receipt_missing"||V?.reason==="review_receipt_stale"||V?.reason==="review_receipt_undetermined"||fe||Se),ht=a&&T&&u===!1,_t=Fn(b,e,{external:a,merge_active:B||Ae?.step==="merge",merge_queued:le,conflict_active:!!i,cleanup_active:we,merged:!!r||V?.tier==="merged"}),wt=!!_t.operation,R=!fe&&!!r&&r.step==="repo_operations",oe=Kv({continuation_required:Y,queueing:Re,merge_step:Ae,conflict_badge:Le,conflict_live:U?.live===!0||i==="running",head_review:se&&J?{...J,state:se.state,failure_reason:se.failure_reason}:null,auto_resolution:ae,recovery:he,cleanup_failed:r,cleanup_label:r?Rr(r.step):null,base_exception:m,conflicting:T,gate:V,receipt_check:Z&&Z.receipt_check?Z.receipt_check:null,queue_failure:D,auto_skip:d,queued:le,queue_active:B,queue_position:l?l.position:0,activity:Le?null:o&&o.activity||null}),Te=oe?.live===!0&&oe.title?c`<span title=${oe.title}>${oe.label}</span>`:oe?.label||null;return{id:e,title:a?c`${t}<span class="muted"> · 세션</span>`:t,reason:r&&Ae?.active!==!0?mi(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:k,...K?{dependency_chips:K}:{},external:a,pr_number:ue&&typeof ue.number=="number"?ue.number:null,pr_url:ue&&typeof ue.url=="string"?ue.url:"",completion_badge:oe?.live!==!0&&oe?.title?oe.label:null,completion_title:oe?.title||"",completion_repair_pr_url:he?he.repair_pr_url:"",completion_repair_pr_number:he?he.repair_pr_number:null,badges:Te?[Te]:[],live_badge:oe?.live===!0?Te:null,usage:s,alert:oe?.alert===!0,merge_action:V?.tier==="merged"&&!fe&&!Se||R?!1:!le||Y||Ee,timeline_action:R,cancel_action:le&&!Y,cancel_enabled:(!B||ge)&&!(he&&he.lock_actions),cancel_title:he&&he.lock_actions?`${he.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:B&&!ge?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":ge?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:_t,discard_action:_t.action,merge_step:Ae,discard_enabled:_t.enabled,discard_title:_t.title,merge_enabled:!Ae&&!Re&&!i&&!wt&&!m&&!(he&&he.lock_actions)&&!ht&&!R&&(ne||T||V?.reason==="base_behind"||V?.reason==="review_receipt_missing"||V?.reason==="review_receipt_stale"||V?.reason==="review_receipt_undetermined"||fe||Se||it||X&&!B),merge_label:Y?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":fe||Se?"\uC815\uB9AC \uC7AC\uAC1C":T&&!Ae&&!fe?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":V?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":V?.reason==="review_receipt_missing"||V?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":Ee?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:wt?_t.error?`\uD3D0\uAE30 \uC2E4\uD328: ${_t.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${_t.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:Y?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":Re?"\uC694\uCCAD\uC744 \uBCF4\uB0B4\uB294 \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":Ae?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${Ae.label}`:Se?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":ht?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":fe?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":T?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uC790\uB3D9 \uC7AC\uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":V?.reason==="review_receipt_undetermined"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uD310\uC815 \uBBF8\uACB0 \u2014 \uB2E4\uC74C \uAD00\uCE21\uC5D0\uC11C \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4. \uC9C0\uAE08 \uBA38\uC9C0\uD558\uBA74 \uAD00\uCE21\uB41C head\uB97C \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":V?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":ne?`\uBA38\uC9C0 (${V.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:V&&V.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${V&&V.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Ll(e,t={}){let{transport:n,issueStores:r,queueStore:s,sessionLogStore:o,uiOrderStore:i,gotoIssue:a,getWorkspacePath:l,switchWorkspace:u,openDoc:d,doneRange:m,onDoneRangeChange:v}=t,b=r?To(r,i):null,k=Lo({transport:n,uiOrderStore:i}),N=null,W=[],K=Av(),le=null,Y=null,B={members_by_id:new Map,serial_raw_lengths:{},serial_lane_count:0,occupied_lanes:new Set},D=Cv(),j=m?Kn(m):Ov(),Z=new Map;function V(){let p=jr.find(h=>h.value===j);return p?p.label:"\uC624\uB298"}let ue=qi("beads-ui.worker.lane-collapsed"),U=!1,J=new Set,se=new Set,ae=new Set,he=new Set,Ue=new Set,ge={},X=null,Ee=0,Le=null,T=[];function ne(p){return X===p?ge:{}}async function Ae(){if(!n)return;let p=l?.()||"";if(X===p||Le&&Le.key===p&&Le.generation===Ee)return;let h=++Ee;Le={key:p,generation:h};let L=null;try{L=await Promise.resolve(n("get-session-defaults",{}))}catch(ee){if(h!==Ee)return;Le=null,hv("get-session-defaults failed: %o",ee),Pe();return}h===Ee&&(ge=L&&typeof L.values=="object"&&L.values!==null?{...L.values}:{},X=p,Le=null,Pe())}function we(){X=null,Ee+=1,Ae()}let Re=document.createElement("div");Re.className="worker-console";let fe=document.createElement("div");fe.className="worker-top";let Se=document.createElement("div");Se.className="worker-drawer-overlay",Se.hidden=!0;let it=document.createElement("div");it.className="worker-drawer-overlay__backdrop";let ht=document.createElement("div");ht.className="worker-drawer-host";let _t=document.createElement("div");_t.className="worker-drawer-host",_t.hidden=!0,Se.append(it,ht,_t);let wt=document.createElement("div");wt.className="worker-lanes-host",Re.append(fe,Se,wt),e.appendChild(Re);let R=null,oe=is(ht,{transport:n,sessionLogStore:o,onClose:()=>{R=null,Se.hidden=!0,Pe()}}),Te=qf(_t,{onClose:()=>{_t.hidden=!0,Se.hidden=!0,Pe()}}),Ne=Rf({getWorkspacePath:l||(()=>"")}),We=l&&l()||"",Je=Lf({queueStore:s,transport:n,onChanged:()=>Pe(),onOpenScript:(p,h)=>{Ne.open(p,h)}});function tt(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:Ui,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function bt(){let p=tt(),h=typeof p.serial_lane_count=="number"&&Number.isInteger(p.serial_lane_count)&&p.serial_lane_count>0?Math.min(p.serial_lane_count,5):0,L=Array.isArray(p.serial_lanes)?p.serial_lanes:[],ee=[];for(let ut of L){if(ee.length>=h)break;!ut||typeof ut.id!="string"||!/^s[1-5]$/.test(ut.id)||!Array.isArray(ut.entries)||ee.push({id:ut.id,label:`\uC9C1\uB82C ${ut.id.slice(1)}`,count:ut.entries.length})}return ee.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(p.queue)?p.queue:[]).length},...ee]}function te(p){if(!le||!p.some(L=>L.id===le))return null;let h=bt();return h?{bead_id:le,lanes:h}:null}function G(){let p=tt();return typeof p.revision=="number"?p.revision:0}function ye(p){p&&p.queue&&s&&s.set(p.queue)}function ct(){let p=tt().queue;return Array.isArray(p)?p.length:0}async function nt(p,h,L){if(!n)return;let ee=()=>({bead_id:p,...h==="parallel"?{}:{lane:h},...L===void 0?{}:{index:L},expected_revision:G()}),pe=await n("worker-queue-place",ee());ye(pe),pe&&pe.conflict&&await n("worker-queue-place",ee()).then(ye)}async function Me(p,h,L){if(!n)return;let ee=()=>({bead_id:p,...h==="parallel"?{}:{lane:h},to_index:L,expected_revision:G()}),pe=await n("worker-queue-reorder",ee());ye(pe),pe&&pe.conflict&&await n("worker-queue-reorder",ee()).then(ye)}async function Fe(p){if(!n)return;let h=await n("worker-queue-remove",{bead_id:p,expected_revision:G()});ye(h),h&&h.conflict&&await n("worker-queue-remove",{bead_id:p,expected_revision:G()}).then(ye)}async function dt(p){if(!n||!p)return;let h=await n("worker-attempt-pause",{attempt_id:p});h&&h.paused===!1&&h.reason&&ce(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${h.reason}`,"error",2400)}async function at(p){if(!n||!p)return;let h=await Vr();if(h===null)return;let L=async(pe={})=>await n("worker-attempt-resume",{attempt_id:p,expected_revision:G(),...h!==""?{instructions:h}:{},...pe}),ee=await L();ye(ee),ee&&ee.conflict&&(ee=await L(),ye(ee)),ee=await er(ee,(pe,ut)=>L({continuation:pe,decision_token:ut}),{onResult:ye,refresh:()=>L()}),ee&&ee.resumed===!1&&!ee.conflict&&ee.reason&&ce(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${ee.reason}`,"error",2400)}async function pt(p){if(!n||!p)return;let h=await n("worker-attempt-dismiss",{attempt_id:p,expected_revision:G()});ye(h),h&&h.conflict&&(h=await n("worker-attempt-dismiss",{attempt_id:p,expected_revision:G()}),ye(h)),h&&h.dismissed===!1&&!h.conflict&&h.reason&&ce(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${h.reason}`,"error",2400)}async function Et(p,h,L=!0){if(!n)return null;let ee=n,pe=await ee(p,{...h,expected_revision:G()});return ye(pe),pe&&pe.conflict&&L&&(pe=await ee(p,{...h,expected_revision:G()}),ye(pe)),pe}async function zt(p){if(!n||!p)return;let h=tt().merge_queue?.find(ee=>ee.bead_id===p)?.continuation_action;if(h?.mismatch&&h.continuation===null){await Lt(p,h.mismatch);return}J.add(p),Pe();let L;try{L=await Et("worker-merge-queue-add",{bead_id:p})}catch{ce("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{J.delete(p),Pe()}if(!(!L||L.applied)){if(L.conflict){ce("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}ce(qv(L.reason),"error",2400)}}async function Ht(p){if(!(!n||!p||se.has(p))){se.add(p),Pe();try{let h=await n("worker-cleanup-retry",{bead_id:p,expected_revision:G()});ye(h),h&&!h.retried&&!h.conflict&&h.reason&&ce(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${h.reason}`,"error",2400)}finally{se.delete(p),Pe()}}}async function Lt(p,h){let L=await er({continuation_mismatch:h},(pe,ut)=>Et("worker-merge-queue-add",{bead_id:p,continuation:pe,decision_token:ut},!1)),ee=L?.queue?.merge_queue?.find(pe=>pe.bead_id===p)?.continuation_action;if(L?.applied!==!0&&ee?.continuation===null&&ee.mismatch){await Lt(p,ee.mismatch);return}L&&L.applied===!1&&!L.conflict&&ce("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function It(p){if(!n)return;let h=await Et("worker-merge-auto-toggle",{on:p});!h||h.conflict||ce(p?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",p?"success":"info",2400)}async function xt(p){if(!n||!p)return;let h=await Et("worker-merge-queue-remove",{bead_id:p});h&&!h.conflict&&!h.applied&&h.reason==="merge_active"&&ce("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function je(){await Et("worker-merge-queue-remove",{all:!0})}async function I(p,h=null,L="unmerged",ee=null){if(!n||!p)return;let pe=Ps(p,L);if(!(!!ee||typeof globalThis.confirm!="function"||globalThis.confirm(pe)))return;let Qe=await n("worker-discard",{bead_id:p,...h?{attempt_id:h}:{},...ee?{operation_id:ee}:{},expected_revision:G()});if(ye(Qe),Qe&&Qe.conflict&&(Qe=await n("worker-discard",{bead_id:p,...h?{attempt_id:h}:{},...ee?{operation_id:ee}:{},expected_revision:G()}),ye(Qe)),Qe&&Qe.discarded===!0){ce(ii(Qe),"success",5e3);return}if(Qe&&Qe.reason){ce(`\uD3D0\uAE30 \uC2E4\uD328: ${Qe.reason}`,"error",2800);return}if(Qe&&Qe.accepted&&Qe.pending==="merged_revert"){ce("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(Qe&&Qe.accepted&&!Qe.discarded){ce(`\uD3D0\uAE30 \uC9C4\uD589: ${Qe.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}Qe&&!Qe.conflict&&ce("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function Q(p,h,L){if(!(!n||!h||!L||he.has(h))){he.add(h),Pe();try{let ee=await n(p,{bead_id:h,action_id:L,expected_revision:G()});ye(ee),ee?.conflict?ce("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!ee?.ok&&ee?.reason&&ce(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(ee.reason)}`,"error",2800)}finally{he.delete(h),Pe()}}}async function be(p,h){if(!n||!h||ae.has(h))return;ae.add(h),Pe();let L;try{let ee=async(pe={})=>await n(p,{bead_id:h,expected_revision:G(),...pe});L=await ee(),ye(L),L&&L.conflict&&(L=await n(p,{bead_id:h,expected_revision:G()}),ye(L)),p==="worker-revise-fix"&&(L=await er(L,(pe,ut)=>ee({continuation:pe,decision_token:ut}),{onResult:ye,refresh:()=>ee()}))}finally{ae.delete(h),Pe()}if(!(!L||L.conflict)){if(L.ok){ce(p==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}ce(`\uCC98\uBD84 \uAC70\uBD80: ${L.reason||""}`,"error",3e3)}}async function C(p){if(!n)return;let h=await n("worker-automation-toggle",{on:p,expected_revision:G()});ye(h),h&&h.conflict&&await n("worker-automation-toggle",{on:p,expected_revision:G()}).then(ye)}async function H(p){if(!n||!p)return;let h=await n("worker-repo-operation-dismiss",{operation_id:p});ye(h),h&&h.ok===!1&&ce(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${h.reason||""}`,"error",3e3)}async function Ie(p){if(!n||!Number.isFinite(p))return;let h=Math.max(Ui,Math.floor(p)),L=await n("worker-queue-set-slots",{slots:h,expected_revision:G()});ye(L),L&&L.conflict&&await n("worker-queue-set-slots",{slots:h,expected_revision:G()}).then(ye)}async function Be(p){if(!n||!Number.isInteger(p)||p<1||p>Ff)return;let h=tt(),L=(Array.isArray(h.serial_lanes)?h.serial_lanes:[]).slice(p).reduce((ut,Qe)=>ut+(Array.isArray(Qe?.entries)?Qe.entries.length:0),0),ee=()=>({count:p,expected_revision:G()}),pe=await n("worker-queue-set-serial-lane-count",ee());ye(pe),pe&&pe.conflict&&(pe=await n("worker-queue-set-serial-lane-count",ee()),ye(pe)),pe&&pe.applied&&L>0&&ce(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${L}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}let xe="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function lt(p,h){let L=wl(p,h.id,B);return{id:h.id,title:h.title,location_label:h.location_label,prefixes:h.prefixes,action:L.kind==="note"?{kind:"note",text:L.text}:L.kind==="disabled"?{kind:"disabled",label:xe,title:L.title}:{kind:"place",label:xe,title:L.title}}}function st(p,h){if(!Y||Y.bead_id!==p)return null;let L=Y.counterpart_id,ee=h.filter(pe=>pe.id===L);return ee.length===0?null:{rows:ee.map(pe=>lt(p,pe))}}async function ve(p,h){let L=wl(p,h,B);if(Y=null,L.kind!=="ops"){Pe();return}let ee=G();for(let pe of L.ops){let ut=await Xe(pe,ee);if(ut===null)break;ee=ut}Pe()}async function Xe(p,h){if(!n)return null;try{let L=await n("worker-queue-place",{bead_id:p.bead_id,lane:p.lane,index:p.index,expected_revision:h});if(ye(L),L&&L.conflict)return ce("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!L||L.applied!==!0)return ce(L&&typeof L.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${L.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let ee=L.queue?L.queue.revision:void 0;return typeof ee!="number"?(ce("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):ee}catch(L){return ce(L instanceof Error&&L.message?L.message:"\uD050 \uC694\uCCAD \uC2E4\uD328","error"),null}}function P(){let p=tt(),h=b?b.selectBoardColumn(yv,"ready"):[],L=b?b.selectBoardColumn(vv,"blocked"):[],ee=b?b.selectBoardColumn($v,"closed"):[],pe=b?b.selectBoardColumn(wv,"in_progress"):[],ut=b?b.selectBoardColumn(kv,"resolved"):[],Qe=Ro([...h,...L,...pe,...ut,...ee]),Bt=new Map;for(let _ of[...h,...L,...pe])_&&_.id&&!Bt.has(_.id)&&Bt.set(_.id,_);let Gt={...ne(l?.()||"")};for(let _ of["orchestration_model","orchestration_effort","orchestration_speed"]){let M=p[_];typeof M=="string"&&(Gt[_]=M)}function en(_,M){let ie=Bt.get(_);if(!ie)return null;let qe=ie.metadata&&typeof ie.metadata=="object"?ie.metadata:{},Ye=ie.workflow?.route,Yt=qe.route,Pt=Bf(Ye)?Ye:Bf(Yt)?Yt:null;return $n({pin:qe,global:Gt,execution_defaults:p.execution_defaults??null,runner_catalog:p.runner_catalog??null,route:Pt,controller_runtime:M})}function Tn(_){let M=_.runner||null,ie=en(_.bead_id,M),qe=Is(_),Ye=ie?_r(ie,M):null;return qe||Ye?{orchestration:qe,worker:Ye}:null}let bn=new Map;function Vt(_){if(bn.has(_))return bn.get(_)??null;let M=en(_,null),ie=null;if(M){let qe=qn(p.runner_catalog??null,M.orchestration_model.value??""),Ye=qe===null?M:en(_,qe),Yt=Tr(Ye,p.runner_catalog??null),Pt=_r(Ye,qe);ie=Yt||Pt?{orchestration:Yt,worker:Pt}:null}return bn.set(_,ie),ie}let hn=new Map;function Ln(_){if(hn.has(_))return hn.get(_)??null;let M=Bt.get(_),ie=M&&M.metadata&&typeof M.metadata=="object"?M.metadata:null,qe=ie?ts(ie):null;return hn.set(_,qe),qe}function In(_){let M=Oo(Qe,_);return M.total===0?null:M}let ar=p.bead_titles||{},f=new Map;for(let[_,M]of Object.entries(ar))typeof M=="string"&&M.length>0&&f.set(_,M);for(let _ of[...h,...L])f.set(_.id,_.title||_.id);let g=new Map;for(let _ of[...h,...L,...pe,...ut,...ee])_&&_.id&&typeof _.from_id=="string"&&g.set(_.id,_.from_id);let w=new Map;for(let _ of[...h,...L,...pe,...ut,...ee])_&&_.id&&typeof _.priority=="number"&&w.set(_.id,_.priority);let $=p.bead_times&&typeof p.bead_times=="object"&&!Array.isArray(p.bead_times)?p.bead_times:{},q=p.bead_labels&&typeof p.bead_labels=="object"&&!Array.isArray(p.bead_labels)?p.bead_labels:{},z=p.bead_workflow&&typeof p.bead_workflow=="object"&&!Array.isArray(p.bead_workflow)?p.bead_workflow:{},re=new Map;for(let[_,M]of Object.entries(q))Array.isArray(M)&&re.set(_,Tl(M));for(let _ of[...h,...L]){let M=_.labels;Array.isArray(M)&&!re.has(_.id)&&re.set(_.id,Tl(M))}let Ce=p.bead_blocked_by&&typeof p.bead_blocked_by=="object"&&!Array.isArray(p.bead_blocked_by)?p.bead_blocked_by:{},He=p.blocker_workspaces&&typeof p.blocker_workspaces=="object"&&!Array.isArray(p.blocker_workspaces)?p.blocker_workspaces:{},et=new Map;for(let[_,M]of Object.entries($))M&&typeof M=="object"&&et.set(_,M);for(let _ of[...h,...L])et.set(_.id,{created_at:_.created_at,updated_at:_.updated_at});let De=_=>et.get(_)||{},y=p.pr_wait||[],E=p.pr_observations||{},A=p.pr_activity||{},me=p.cleanup_failed||{},Ke=Object.entries(me).map(([_,M])=>({bead_id:_,step:M&&M.step?M.step:"",reason:M&&M.reason?M.reason:"",at:M&&typeof M.at=="number"?M.at:null,detail:M&&typeof M.detail=="string"?M.detail:null,output_tail:M&&typeof M.output_tail=="string"&&M.output_tail?M.output_tail:void 0,log_path:M&&typeof M.log_path=="string"&&M.log_path?M.log_path:void 0,retry_count:M&&typeof M.retry_count=="number"&&Number.isInteger(M.retry_count)&&M.retry_count>0?M.retry_count:0,failure_code:M&&typeof M.failure_code=="string"?M.failure_code:void 0})),Ve=p.queue||[],vt=new Set([...Ve.map(_=>_.bead_id),...(Array.isArray(p.serial_lanes)?p.serial_lanes:[]).flatMap(_=>(Array.isArray(_?.entries)?_.entries:[]).map(M=>M.bead_id)),...y.map(_=>_.bead_id),...p.done.map(_=>_.bead_id)]),ze=new Set(L.map(_=>_.id)),ft=i?i.get()?.order||{}:{},yn=new Set,Dl=[];for(let _ of[...h,...L])vt.has(_.id)||yn.has(_.id)||Mv(_)||(yn.add(_.id),Dl.push(_));W=Iv(Dl,D,ft);let a_=p.admission||{},Nl=_=>{let M=a_[_];if(!M)return"";if(M.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let ie=typeof M.reason=="string"?M.reason:"",qe=ie.indexOf(":");return qe>0&&qe<ie.length-1?`\u26D4 ${ie.slice(0,qe)} (${ie.slice(qe+1)})`:`\u26D4 ${ie}`},ql=new Map,l_=W.map(_=>{let M=eo(_),ie=M.evidence==="published",qe=_.workflow?.route==="quick_fix"||_.metadata&&_.metadata.route==="quick_fix",Ye=!Object.hasOwn(_,"description")||typeof _.description=="string"&&_.description.trim().length>0,Yt=Object.hasOwn(_,"labels")&&Af(_.labels),Pt=Yt||!Object.hasOwn(_,"labels")?"":Sf(_.labels,_.metadata),Nr=Pt.length>0,Ct=!Yt&&(qe?Ye:ie&&!M.conflict),_o=ze.has(_.id),Xn=[];if(_o){let mo=Pv(_);mo.length>0?ql.set(_.id,mo):Xn.push(Dv)}qe&&!Ye?Xn.push("missing_description"):!qe&&M.conflict?Xn.push("spec_id_conflict"):!qe&&M.evidence==="none"?Xn.push("spec \uC5C6\uC74C"):!qe&&M.evidence==="draft"&&Xn.push("spec \uBBF8\uBC1C\uD589(draft)");let qr=Nl(_.id);return qr&&Xn.push(qr),{id:_.id,title:_.title||_.id,reason:Xn.join(" \xB7 "),draggable:Ct,lane:"candidate",created_at:_.created_at,updated_at:_.updated_at,workflow:_.workflow,is_quick_fix:qe,status:_.status,worker_ineligible:Yt,session_preferred:Nr,session_preferred_reason:Pt,blocked:_o,has_spec:ie,exec_chips:Vt(_.id),rec:Ln(_.id),from_id:_.from_id||void 0,priority:w.get(_.id)}}),Wi=Ev(l_,K),zi=Wi.visible,c_=p.revise_parked||{},oo=p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},u_=_=>{let M=z[_]?.chips?.pr;return M&&typeof M.number=="number"&&typeof M.url=="string"?{pr_number:M.number,pr_url:M.url}:{}},Hi=(_,M)=>_.map((ie,qe)=>{let Ye=M!=="done",Yt=M!=="done"&&M!=="queue",Pt=Ye?c_[ie.bead_id]:null,Nr=Ye?Fn(oo,ie.bead_id):null,Ct=Nr?.operation?Nr:null,_o=Ye&&re.get(ie.bead_id)===!0,Xn=p.admission&&typeof p.admission=="object"?p.admission[ie.bead_id]:null,qr=Ye?rd(Xn,!!Ct||he.has(ie.bead_id)):null,mo=Ye&&!qr?Nl(ie.bead_id):null,$_=Ye?[mo]:[],x_=[];return{id:ie.bead_id,title:f.get(ie.bead_id)||ie.bead_id,reason:$_.filter(Boolean).join(" \xB7 "),draggable:Ye&&!Ct&&!qr,done:M==="done",lane:M,seq:Yt?qe+1:void 0,worker_serial:_o,discard:Ct,stale_work:qr,badges:[...x_,...Pt?["\u23F8 REVISE \uD30C\uD0B9"]:[],...M==="done"?ri(p.attempts||{},ie.bead_id):[]],alert:!!Pt,revise_action:!!Pt,revise_enabled:!!Pt&&!Ct&&!ae.has(ie.bead_id),revise_title:Pt?Pt.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${Pt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:M==="done"?Rn(p.attempts||{},ie.bead_id):null,work_ms:M==="done"?si(p.attempts||{},ie.bead_id):null,done_at:M==="done"&&typeof ie.added_at=="number"?ie.added_at:void 0,exec_chips:Ye?Vt(ie.bead_id):null,rec:Ln(ie.bead_id),workflow:Ye&&z[ie.bead_id]||null,...M==="done"?u_(ie.bead_id):{},from_id:g.get(ie.bead_id)||void 0,priority:w.get(ie.bead_id),...De(ie.bead_id)}}),Mr=p.attempts?Object.values(p.attempts).filter(Er):[],Gi=new Set;for(let _ of Mr)_&&typeof _.resumed_from=="string"&&_.resumed_from.length>0&&Gi.add(_.resumed_from);let Fl=new Map;for(let _ of Mr)Fl.set(_.bead_id,_.attempt_id);let cs=new Map;for(let _ of Mr)cs.set(_.attempt_id,_);function Ki(_){let M=new Set,ie=_;for(;ie&&!M.has(ie.attempt_id);){if(ie.conflict_resolution===!0)return!0;M.add(ie.attempt_id),ie=typeof ie.resumed_from=="string"&&ie.resumed_from.length>0&&cs.get(ie.resumed_from)||null}return!1}let io=typeof p.declared_base=="string"?p.declared_base:null;function d_(_){let M=null;for(let ie of Mr)!ie||ie.bead_id!==_||Ki(ie)||(M===null||(typeof ie.started_at=="number"?ie.started_at:0)>=(typeof M.started_at=="number"?M.started_at:0))&&(M=ie);return M&&typeof M.target_base=="string"?M.target_base:null}let Vi=[],ao=[],p_=xf(p),jl=_=>{let M=typeof _.session_id=="string"&&_.session_id.length>0,ie=Gi.has(_.attempt_id);return{eligible:M&&!ie,reason:M?ie?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},Mn=null;for(let _ of Mr){let M=_.status==="paused"&&!Gi.has(_.attempt_id);if(_.status==="running"||M)ao.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:f.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,paused:M,conflict_resolution:Ki(_),base_exception:Rl(io,_.target_base),can_pause:typeof _.session_id=="string"&&_.session_id.length>0,discard:Fn(oo,_.bead_id,{attempt_id:_.attempt_id}),workflow:z[_.bead_id]||null,priority:w.get(_.bead_id),usage:Rn(p.attempts||{},_.bead_id),rollup:In(_.bead_id),rollup_expanded:Ue.has(_.bead_id),exec_chips:Tn(_),rec:Ln(_.bead_id),...De(_.bead_id)});else if((_.status==="failed"||_.status==="orphaned")&&p_(_)){let ie=jl(_);Vi.push({bead_id:_.bead_id,attempt_id:_.attempt_id,title:f.get(_.bead_id)||_.bead_id,runner:_.runner||null,model:_.model||null,effort:_.effort||null,speed:_.speed||null,continuation_mode:_.continuation_mode||null,started_at:typeof _.started_at=="number"?_.started_at:null,resumed_from:_.resumed_from||null,failed:!0,status:_.status,status_label:_.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Fn(oo,_.bead_id,{attempt_id:_.attempt_id}),resume_eligible:ie.eligible,resume_reason:ie.reason,conflict_resolution:Ki(_),base_exception:Rl(io,_.target_base),workflow:z[_.bead_id]||null,priority:w.get(_.bead_id),usage:Rn(p.attempts||{},_.bead_id),rollup:In(_.bead_id),rollup_expanded:Ue.has(_.bead_id),exec_chips:Tn(_),rec:Ln(_.bead_id),...De(_.bead_id)}),Mn=_}}let Bl=new Set([...Vi,...ao].map(_=>_.bead_id)),Ul=new Map;for(let _ of Array.isArray(p.session_active)?p.session_active:[]){let M=_&&_.bead_id;if(!(typeof M!="string"||M.length===0||Bl.has(M))){if(Bl.add(M),Array.isArray(_.blocked_by)){let ie=_.blocked_by.filter(qe=>typeof qe=="string"&&qe.length>0);ie.length>0&&Ul.set(M,ie)}ao.push({bead_id:M,attempt_id:null,kind:"session",title:_.title||f.get(M)||M,status:"in_progress",started_at:Dn(_.started_at)??Dn(_.updated_at),updated_at:Dn(_.updated_at),workflow:_.workflow||null,session_refs:Array.isArray(_.session_refs)?_.session_refs:[],priority:w.get(M),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,rec:Ln(M),usage:null,rollup:null,rollup_expanded:!1})}}let Pr=[...Vi,...ao].map(_=>{let M=cs.get(_.attempt_id),ie=M?.quickfix_landing;if(M?.quickfix_lane!==!0||!ie||typeof ie!="object")return _;let qe=typeof ie.reason=="string"&&ie.reason.length>0?ie.reason:null,Ye=qs({bead_id:M.bead_id,merge_sha:ie.head_sha,cleanup_cursor:ie.cursor,cleanup_failed:qe?{step:ie.cursor,reason:qe}:null,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]});return Ye?{..._,landing:Ye}:_}),Wl=null;if(Mn){let _=jl(Mn),M=Mn.cause_detail;Wl={bead_id:Mn.bead_id,repo:Mn.repo||"",reason:Mn.cause||Mn.status,cause_detail:M&&typeof M.reason=="string"?{reason:M.reason,command:typeof M.command=="string"?M.command:null}:null,resume_attempt_id:Mn.attempt_id,resume_eligible:_.eligible,resume_reason:_.reason,discard:Fn(oo,Mn.bead_id,{attempt_id:Mn.attempt_id})}}let zl=new Set(Pr.map(_=>_.bead_id)),Yi=Array.isArray(p.merge_queue)?p.merge_queue:[],Hl=new Map,Gl=new Map,Kl=new Map,Vl=new Map,Yl=new Map;Yi.forEach((_,M)=>{_&&typeof _.bead_id=="string"&&(Hl.set(_.bead_id,M+1),Gl.set(_.bead_id,_.resolution),Kl.set(_.bead_id,_.continuation_action||null),Vl.set(_.bead_id,_.head_review||null),Yl.set(_.bead_id,_.authority||null))});let Dr=p.merge_queue_state||{active:null,failures:{}},f_=Dr.failures||{},Zl=Dr.waiting&&typeof Dr.waiting.bead_id=="string"&&typeof Dr.waiting.reason=="string"?Dr.waiting:null,__=p.auto_merge_skips||{},Xl=_=>{let M=__[_];if(!M)return null;let ie=E[_],qe=ie&&ie.pr?ie.pr.head_sha:null;return qe&&qe===M.head_sha?M.reason||"":null},lo=new Map;for(let _ of Pr)_.failed!==!0&&_.conflict_resolution&&(_.paused?lo.has(_.bead_id)||lo.set(_.bead_id,"paused"):lo.set(_.bead_id,"running"));let Ql=Pr.filter(_=>_.kind!=="session"&&!_.paused&&_.failed!==!0).length,Jl=(p.workspace_info||{}).slots,ec=typeof Jl=="number"?Jl:typeof p.slots=="number"?p.slots:Ui,m_=Ql>ec,co=$r(j),g_=(Array.isArray(p.done)?p.done.slice():[]).filter(_=>co===void 0||typeof _.added_at!="number"||_.added_at>=co).sort((_,M)=>(M.added_at||0)-(_.added_at||0)),us=Hi(g_,"done"),b_=new Set((Array.isArray(p.done)?p.done:[]).map(_=>_?.bead_id).filter(_=>typeof _=="string")),tc=[],h_=l?.()||"";for(let _ of ee){let M=Dn(_.closed_at);if(typeof _.id!="string"||b_.has(_.id)||M===null||co!==void 0&&M<co||typeof _.comment_count!="number"||_.comment_count<=0)continue;let ie=`${h_}\0${_.id}\0${String(_.updated_at)}\0${_.comment_count}`,qe=Z.get(ie);if(qe===void 0&&n&&(Z.set(ie,"pending"),Promise.resolve(n("get-comments",{id:_.id})).then(Ye=>{let Yt=Array.isArray(Ye)&&Ye.some(Pt=>Oi(typeof Pt?.text=="string"?Pt.text:"")?.lane==="session");Z.set(ie,Yt?"session":"not-session"),Pe()}).catch(()=>{Z.set(ie,"failed"),Pe()})),qe==="session"){let Ye=Dn(_.started_at);tc.push({id:_.id,title:_.title||_.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:Ye!==null&&M>=Ye?M-Ye:null,work_kind:"session",done_at:M,created_at:_.created_at,updated_at:_.updated_at})}}us.push(...tc),us.sort((_,M)=>(M.done_at||0)-(_.done_at||0));let uo={};for(let _ of Yn)uo[_]=0;let nc=!1,rc=0,Zi=0,sc=0;for(let _ of us){let M=_.usage;if(M&&typeof M=="object"){let ie=!1;for(let qe of Yn)Number.isFinite(M[qe])&&(uo[qe]+=M[qe],nc=!0,ie=!0);ie&&(Zi+=1,Number.isFinite(M.total_cost_usd)&&(rc+=M.total_cost_usd,sc+=1))}}Zi>0&&sc===Zi&&(uo.total_cost_usd=rc);let oc=us.map(_=>_.usage).filter(_=>_&&typeof _=="object"&&_.providers),y_=oc.length>0?an(Uo(oc)):nc?tr(uo):null,ic=p.lane_states&&typeof p.lane_states=="object"&&!Array.isArray(p.lane_states)?p.lane_states:{},ac=Array.isArray(p.serial_lanes)?p.serial_lanes:[],lc=_=>{if(y.some(qe=>qe.bead_id===_))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let M=Mr.filter(qe=>qe&&qe.bead_id===_),ie=M.length>0?M[M.length-1].status:null;return ie==="failed"||ie==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":ie==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},po=ac.filter(_=>_&&typeof _.id=="string"&&Array.isArray(_.entries)).map((_,M)=>{let ie=ic[_.id]||{},qe=new Map((Array.isArray(ie.corrections)?ie.corrections:[]).filter(Ct=>Ct&&typeof Ct.bead_id=="string"&&typeof Ct.after=="string").map(Ct=>[Ct.bead_id,Ct.after])),Ye=Array.isArray(ie.occupied_by)?ie.occupied_by.filter(Ct=>typeof Ct=="string"):[],Yt=new Set(Ye),Pt=Hi(_.entries.filter(Ct=>!zl.has(Ct.bead_id)&&!Yt.has(Ct.bead_id)),_.id).map(Ct=>qe.has(Ct.id)?{...Ct,badges:[`\u{1F517} ${qe.get(Ct.id)} \uB4A4 (blocks \uC790\uB3D9)`,...Ct.badges]}:Ct),Nr=Ye.map(Ct=>({id:Ct,title:f.get(Ct)||Ct,draggable:!1,lane:_.id,ghost:!0,badges:[lc(Ct)]}));return{id:_.id,index:M+1,rows:[...Nr,...Pt],occupied:Ye.length>0,badge:Ye.length>0?lc(Ye[0]):"\uB300\uAE30",cycle:ie.cycle===!0}}),cc=typeof p.serial_lane_count=="number"?p.serial_lane_count:po.length,Xi=Hi(Ve.filter(_=>!zl.has(_.bead_id)),"queue"),uc=new Map,dc=new Set;for(let[_,M]of Object.entries(ic)){if(!/^s[1-5]$/.test(_))continue;let ie=M&&Array.isArray(M.occupied_by)?M.occupied_by:[];for(let qe of ie)typeof qe=="string"&&uc.set(qe,_);ie.length>0&&dc.add(_)}let lr=[];for(let _ of Pr)typeof _.bead_id=="string"&&lr.push({id:_.bead_id,title:f.get(_.bead_id)||_.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:uc.get(_.bead_id)??null});for(let _ of y){let M=_&&_.bead_id;typeof M!="string"||M.length===0||lr.push({id:M,title:f.get(M)||M,location_label:"PR \uB300\uAE30",kind:"pr_wait",lane_id:null})}for(let _ of po)for(let M of _.rows)M.ghost!==!0&&lr.push({id:M.id,title:M.title,location_label:`${_.id} #${M.seq??""}`.trim(),kind:"serial",lane_id:_.id});Xi.forEach((_,M)=>{lr.push({id:_.id,title:_.title,location_label:`#${M+1}`,kind:"parallel",lane_id:null})});for(let _ of zi)lr.push({id:_.id,title:_.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let pc={};for(let _ of ac)_&&typeof _.id=="string"&&Array.isArray(_.entries)&&(pc[_.id]=_.entries.length);let Qi=new Map;for(let _ of lr)Qi.has(_.id)||Qi.set(_.id,_);B={members_by_id:Qi,serial_raw_lengths:pc,serial_lane_count:cc,occupied_lanes:dc};let v_=Tp(p.bead_scope,lr),fo=new Map;for(let[_,M]of Ul)fo.set(_,M);for(let[_,M]of ql)fo.set(_,M);for(let[_,M]of Object.entries(Ce))Array.isArray(M)&&fo.set(_,M.filter(ie=>typeof ie=="string"&&ie.length>0));let w_=cd(fo,lr,He),Ji=(_,M=null)=>{let ie=v_.get(_),qe=w_.get(_)||null,Ye=ie&&ie.overlaps.length>0?ie.overlaps:null,Yt=!!ie&&ie.scope_missing;if(!qe&&!Ye&&!Yt)return M;let Pt=Ye?st(_,Ye):null;return{...M||{},...qe?{predecessors:qe}:{},...Ye?{overlaps:Ye}:{},...Yt?{scope_missing:!0}:{},...Pt?{popover:Pt}:{}}},ea=_=>{let M=Ji(_.id,_.dependency_chips||null);return M&&(_.dependency_chips=M),_};for(let _ of Xi)ea(_);for(let _ of po)for(let M of _.rows)M.ghost!==!0&&ea(M);for(let _ of zi)ea(_);let fc=new Map;for(let _ of Pr){let M=typeof _.bead_id=="string"?_.bead_id:"";if(M.length===0)continue;let ie=_.kind==="session",qe=Ji(M),Ye=typeof _.attempt_id=="string"&&_.attempt_id.length>0?cs.get(_.attempt_id):void 0,Yt=Ye&&Ye.last_activity&&typeof Ye.last_activity=="object"?Ye.last_activity:null,Pt=Ye&&Array.isArray(Ye.legs)?Ye.legs:[];!qe&&!Yt&&Pt.length===0&&!ie||fc.set(M,{...Yt?{last_activity:Yt}:{},...Pt.length>0?{legs:Pt}:{},...qe?{dependency_chips:qe}:{}})}let k_=y.map(_=>Vv(_.bead_id,f.get(_.bead_id)||_.bead_id,E,me[_.bead_id]||null,Rn(p.attempts||{},_.bead_id),A[_.bead_id]||(J.has(_.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:se.has(_.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),lo.get(_.bead_id)||null,_.external===!0,{position:Hl.get(_.bead_id)||0,active:Dr.active===_.bead_id,failure:f_[_.bead_id]||null,waiting:Zl?.bead_id===_.bead_id?Zl.reason:null,resolution:Gl.get(_.bead_id),continuation_action:Kl.get(_.bead_id),head_review:Vl.get(_.bead_id)||null,authority:Yl.get(_.bead_id)||null},_.wt_present!==!1,p.auto_merge===!0?Xl(_.bead_id):null,Rl(io,d_(_.bead_id)),p.completion_status&&typeof p.completion_status=="object"&&!Array.isArray(p.completion_status)&&p.completion_status[_.bead_id]||null,p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},cs.get(Fl.get(_.bead_id)||"")?.worker_serial===!0,p.auto_merge===!0,{merge_sha:_.merge_sha,cleanup_cursor:_.cleanup_cursor,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]},Ji(_.bead_id))).map(_=>({..._,workflow:z[_.id]||null,priority:w.get(_.id),...De(_.id)}));return{queue:p,idToTitle:f,candidates:zi,candidate_hidden:{blocked:Wi.hidden_blocked,spec:Wi.hidden_spec},running:Pr,live_count:Ql,slots:ec,over_cap:m_,failure:Wl,waiting:Xi,serial_lanes:po,serial_lane_count:cc,running_overlays:fc,pr_wait:k_,merge_queue_length:Yi.length,merge_queue_running:Yi.length>0,auto_excluded:y.map(_=>_.bead_id).filter(_=>Xl(_)!==null),declared_base:io,done:us,token_total:y_,cleanup_failures:Ke,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]}}function F(p){let h=p.waiting.length>0?p.waiting[0].id:"\u2014",L=c`<button
      type="button"
    ...
    >`,en=c`<label class="worker-tgl worker-slots"
      ...
      ${bn}${Je.template()}${Tn}`}function ke(p){let h=p.candidate_hidden;return c`<div class="worker-filter">
    ...
    </select>`}function $e(){return c`<div class="worker-done-controls">
      <select
    ...
    >
      ▶ 자동 머지${ee>0?` ${ee}`:""}
    </button>`}function ot(p){return pi({parallel:{rows:p.waiting.map(h=>jn(h)),count:p.waiting.length,collapsed:ue.isAreaCollapsed("parallel")},serial:{lanes:p.serial_lanes.map(h=>({id:h.id,title:`\uC9C1\uB82C ${h.index}`,rows:h.rows.map(L=>jn(L)),count:h.rows.length,empty:h.rows.length===0,badge:h.badge,held:h.occupied,cycle:h.cycle})),collapsed:ue.isAreaCollapsed("serial")}})}function mt(p){return Np(p.running,Date.now(),R,p.running_overlays)}function $t(p){return p.running.some(h=>h.kind!=="session"&&!h.paused&&h.failed!==!0)}function Kt(p){let h=Zn({id:"worker-pane-candidate",lane:"candidate",title:"\uD6C4\uBCF4",items:p.candidates,src:!0,empty:"\uD6C4\uBCF4 \uC5C6\uC74C",header_control:Ge(),controls:ke(p),collapsible:!0,collapsed:ue.isCollapsed("candidate"),place_menu:te(p.candidates),onOpenDoc:d?(ee,pe)=>d(pe):void 0}),L=Zn({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:p.done,empty:`${V()} \uC644\uB8CC \uC5C6\uC74C`,header_control:$e(),collapsible:!0,collapsed:ue.isCollapsed("done"),preview:U?Array.isArray(p.token_total)?p.token_total.map(ee=>ee.label).join(" \xB7 "):p.token_total||Uf(p.done):void 0});return U?c`<div class="worker-lanes worker-lanes--mobile">
      ...
      ${L}
    </div>`}function Tt(p){ue.toggle(p),Pe()}function Qt(p){ue.toggleArea(p),Pe()}function Pe(){let p=P();rt(F(p),fe),rt(Kt(p),wt)}function mn(){let p=!0,h=Ni(L=>{if(U=L,p){p=!1;return}Pe()});T.push(h)}let Jt=null;function Ft(p){Jt=p.target instanceof Element?p.target:null}function Xt(p){let L=p.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!L)return;if(Jt&&L.contains(Jt)&&Jt.closest("input, button, a")){p.preventDefault();return}let ee=L.dataset.beadId||"",pe=L.dataset.lane||"";N={bead_id:ee,from_lane:pe},Re.classList.add("is-dragging");try{p.dataTransfer?.setData("text/plain",ee),p.dataTransfer&&(p.dataTransfer.effectAllowed="move")}catch{}}function gn(p){let h=p.target?.closest?.(".worker-pane");if(!h)return;let L=h.dataset.lane||"";L!=="candidate"&&L!=="queue"&&!/^s[1-5]$/.test(L)||(p.preventDefault(),p.dataTransfer&&(p.dataTransfer.dropEffect="move"),h.classList.add("worker-pane--drag-over"))}function _e(p){p.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function S(){Re.classList.remove("is-dragging")}function de(p,h){let L=W.find(Qe=>Qe.id===p);if(!L)return;let ee=W.filter(Qe=>Qe.id!==p),pe=ee.length;if(h){let Qe=h.dataset.beadId;if(Qe===p)return;let Bt=ee.findIndex(Gt=>Gt.id===Qe);Bt>=0&&(pe=Bt)}let ut=ee.slice();ut.splice(pe,0,L),k.applyReorder(p,ut,pe)}function Oe(p){let h=p.target?.closest?.(".worker-pane");if(!h)return;p.preventDefault(),h.classList.remove("worker-pane--drag-over"),Re.classList.remove("is-dragging");let L=h.dataset.lane||"",ee=N?.bead_id||p.dataTransfer?.getData("text/plain")||"",pe=N?.from_lane||"";if(N=null,!ee)return;let ut=p.target?.closest?.(".worker-mini, .worker-card"),Qe=L==="queue"&&h.querySelector(".worker-wait__area--parallel > .worker-wait__area-body")||h,Bt=Array.from(Qe.querySelectorAll(".worker-mini, .worker-card")),Gt=Bt.length;if(ut){let en=Bt.indexOf(ut);en>=0&&(Gt=en)}if(Gt=Math.max(0,Gt-Qe.querySelectorAll(".worker-mini--ghost").length),h.classList.contains("worker-pane--collapsed")&&(Gt=ct()),L==="candidate"){if(pe==="candidate"){de(ee,ut);return}(pe==="queue"||/^s[1-5]$/.test(pe))&&Fe(ee);return}if(L==="queue"||/^s[1-5]$/.test(L)){let en=L==="queue"?"parallel":L;pe===L?Me(ee,en,Gt):nt(ee,en)}}function yt(p){K=p,Sv(p),Pe()}function Rt(p){D=Vf(p),Rv(D),Pe()}function At(p){j=Kn(p),Lv(j),v?.(j),Pe()}function jt(p){let h=p.target?.closest?.(".worker-serial-lane-count");if(h){let Bt=Number.parseInt(h.value,10);Number.isFinite(Bt)&&Be(Bt).then(Pe);return}let L=p.target?.closest?.(".worker-filter__blocked");if(L){yt({...K,show_blocked:L.checked});return}let ee=p.target?.closest?.(".worker-done-range");if(ee){At(ee.value);return}let pe=p.target?.closest?.(".worker-sort");if(pe){Rt(pe.value||Ol);return}let ut=p.target?.closest?.(".worker-slots__input");if(!ut)return;let Qe=Number.parseInt(ut.value,10);if(!Number.isFinite(Qe)){Pe();return}Ie(Qe).then(Pe)}function nn(p){return p?{runner:p.runner||void 0,model:p.model||void 0,effort:p.effort||void 0,worktree:p.worktree||void 0,status:p.status||void 0,session_id:p.session_id||void 0}:{}}function rn(){let p=P(),h=tt().workspace_info,L=h&&typeof h=="object"&&h.repo_ops&&typeof h.repo_ops=="object"?h.repo_ops:null;return{operations:p.repo_operations,cleanup_failures:p.cleanup_failures,repo:l&&l()||"",repo_ops:L}}function En(){R&&oe.close(),_t.hidden=!1,Se.hidden=!1,Te.open(rn()),Pe()}function Mt(p){let h=tt(),L=h.attempts?h.attempts[p]:null;R=p,Te.close(),_t.hidden=!0,Se.hidden=!1,oe.open({attempt_id:p,meta:nn(L)}),Pe()}function sn(p){let h=tt(),L=(Array.isArray(h.session_active)?h.session_active:[]).find(pe=>pe&&pe.bead_id===p),ee=(L&&Array.isArray(L.session_refs)?L.session_refs:[]).find(pe=>pe&&pe.current===!0);ee&&(Te.close(),_t.hidden=!0,Se.hidden=!1,oe.open(Yr(ee,p,"in_progress")),Pe())}function cn(){if(Te.isOpen()&&Te.refresh(rn()),!R)return;let p=tt(),h=p.attempts?p.attempts[R]:null;if(h){oe.updateMeta(nn(h));return}oe.close()}function un(p,h){if(p.length===0||!a)return;let L=l?l():void 0;if(h.length===0||!L||h===L||!u){a(p);return}Promise.resolve(u(h)).then(()=>{a(p)}).catch(()=>{ce("\uB808\uD3EC \uC804\uD658\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error",2400)})}function Gn(p){let h=p.target;if(h?.closest?.(".worker-mini__serial, .worker-mini__grip"))return;let L=h?.closest?.(".worker-dep__open");if(L){un(L.getAttribute("data-dep-id")||"",L.getAttribute("data-root-dir")||"");return}let ee=h?.closest?.(".mon-overlap__chip");if(ee){let E=ee.closest("[data-bead-id]"),A=E&&E.getAttribute("data-bead-id")||"";if(A){let me=ee.getAttribute("data-overlap-id")||"";Y=!!Y&&Y.bead_id===A&&Y.counterpart_id===me?null:{bead_id:A,counterpart_id:me},Pe()}return}let pe=h?.closest?.(".mon-overlap__place");if(pe){let E=pe.closest("[data-bead-id]"),A=E&&E.getAttribute("data-bead-id")||"";A&&ve(A,pe.getAttribute("data-counterpart-id")||"");return}if(h?.closest?.(".mon-overlap__popover"))return;if(h?.closest?.(".worker-repo-strip")||h?.closest?.(".worker-mini__timeline")){En();return}let ut=h?.closest?.(".worker-repo-op__dismiss");if(ut){H(ut.dataset.operationId||"");return}let Qe=h?.closest?.(".worker-cleanup__resume");if(Qe){let E=Qe.dataset.beadId;E&&Ht(E);return}let Bt=h?.closest?.(".worker-banner__resume");if(Bt){let E=Bt.dataset.attemptId;E&&at(E);return}let Gt=h?.closest?.(".worker-banner__discard");if(Gt){let E=Gt.dataset.confirmation==="merged"?"merged":"unmerged";I(Gt.dataset.beadId||"",Gt.dataset.attemptId||null,E,Gt.dataset.operationId||null);return}let en=h?.closest?.(".worker-banner__dismiss");if(en){let E=en.dataset.attemptId;E&&pt(E);return}if(h?.closest?.(".worker-play")){C(!tt().auto_advance);return}let Tn=h?.closest?.(".worker-merge-all");if(Tn){Tn.classList.contains("worker-merge-all--stop")?tt().auto_merge===!0?It(!1):je():It(!0);return}let bn=h?.closest?.(".worker-pane__toggle[data-lane]");if(bn){let E=bn.dataset.lane;(E==="candidate"||E==="queue"||E==="running"||E==="pr_wait"||E==="done")&&Tt(E);return}let Vt=h?.closest?.(".worker-wait__area-toggle[data-area]");if(Vt){let E=Vt.dataset.area;(E==="parallel"||E==="serial")&&Qt(E);return}let hn=h?.closest?.(".worker-card__place-lane");if(hn){let E=hn.dataset.beadId,A=hn.dataset.lane;E&&(A==="parallel"||/^s[1-5]$/.test(A||""))&&(le=null,Pe(),nt(E,A));return}if(h?.closest?.(".worker-card__place-cancel")){le=null,Pe();return}let In=h?.closest?.(".worker-card__place");if(In){let E=In.dataset.beadId;E&&!In.disabled&&(bt()?(le=E,Pe()):nt(E,"parallel"));return}let ar=h?.closest?.(".worker-filter__chip");if(ar){let E=ar.dataset.spec;(E==="all"||E==="with"||E==="without")&&yt({...K,spec:E});return}let f=h?.closest?.(".worker-mini__merge");if(f){let E=f.dataset.beadId||"";tt().cleanup_failed?.[E]?Ht(E):zt(E);return}let g=h?.closest?.(".worker-mini__merge-cancel");if(g){xt(g.dataset.beadId||"");return}let w=h?.closest?.(".worker-mini__discard");if(w){I(w.dataset.beadId||"",w.dataset.attemptId||null,w.dataset.discardMode==="merged"?"merged":"unmerged",w.dataset.operationId||null);return}let $=h?.closest?.(".worker-mini__stale-continue");if($){Q("worker-stale-work-continue",$.dataset.beadId||"",$.dataset.actionId||"");return}let q=h?.closest?.(".worker-mini__stale-backup");if(q){Q("worker-stale-work-backup-fresh",q.dataset.beadId||"",q.dataset.actionId||"");return}let z=h?.closest?.(".worker-mini__stale-recheck");if(z){Q("worker-stale-work-recheck",z.dataset.beadId||"",z.dataset.actionId||"");return}let re=h?.closest?.(".worker-mini__revise-fix");if(re){be("worker-revise-fix",re.dataset.beadId||"");return}let Ce=h?.closest?.(".worker-mini__revise-approve");if(Ce){be("worker-revise-approve",Ce.dataset.beadId||"");return}if(h?.closest?.(".worker-mini__pr"))return;if(h?.closest?.(".rtile__discard")){let E=h?.closest?.(".rtile"),A=E?.dataset?.beadId,me=E?.dataset?.attemptId;A&&I(A,me||null,"unmerged",h?.closest?.(".rtile__discard")?.dataset.operationId||null);return}if(h?.closest?.(".rtile__dismiss")){let A=h?.closest?.(".rtile")?.dataset?.attemptId;A&&pt(A);return}if(h?.closest?.(".rtile__pause")){let A=h?.closest?.(".rtile")?.dataset?.attemptId;A&&dt(A);return}if(h?.closest?.(".rtile__resume")){let A=h?.closest?.(".rtile")?.dataset?.attemptId;A&&at(A);return}if(h?.closest?.(".rtile__session")){let E=h?.closest?.(".rtile"),A=E?.dataset?.attemptId;if(A){Mt(A);return}let me=E?.dataset?.beadId;me&&sn(me);return}if(h?.closest?.(".worker-drawer-overlay__backdrop")){Te.close(),oe.close();return}if(h?.closest?.(".worker-drawer-host"))return;let He=h?.closest?.(".rtile .board-card__roll-toggle");if(He){let E=He.dataset.rollParent;E&&(Ue.has(E)?Ue.delete(E):Ue.add(E),Pe());return}let et=h?.closest?.(".rtile .board-card__roll-child");if(et){let E=et.dataset.childId;E&&a&&a(E);return}let De=h?.closest?.(".rtile");if(De){if(h?.closest?.(".rtile__id")){let A=De.dataset.beadId;A&&Nn(A).then(me=>{me?ce("\uBCF5\uC0AC\uB428","success",1200):ce("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let E=De.dataset.beadId;E&&a&&a(E);return}let y=h?.closest?.(".worker-mini, .worker-card");if(y){let E=y.dataset.beadId;if(h?.closest?.(".worker-mini__id, .worker-card__id")){E&&Nn(E).then(me=>{me?ce("\uBCF5\uC0AC\uB428","success",1200):ce("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}let A=h?.closest?.(".ctl-chip--from");if(A){let me=A.dataset.fromId;me&&a&&a(me);return}E&&a&&a(E)}}e.addEventListener("pointerdown",Ft),e.addEventListener("dragstart",Xt),e.addEventListener("dragover",gn),e.addEventListener("dragleave",_e),e.addEventListener("dragend",S),e.addEventListener("drop",Oe),e.addEventListener("click",Gn),e.addEventListener("change",jt);function x(p){if(!Y)return;let h=p.target;h&&typeof h.closest=="function"&&h.closest(".mon-overlap__popover, .mon-overlap__chip")||(Y=null,Pe())}function O(p){p.key!=="Escape"||!Y||(Y=null,Pe())}return document.addEventListener("click",x),document.addEventListener("keydown",O),T.push(()=>{document.removeEventListener("click",x),document.removeEventListener("keydown",O)}),mn(),b&&T.push(b.subscribe(()=>{for(let[p,h]of Z)h==="failed"&&Z.delete(p);Pe()})),s&&T.push(s.subscribe(()=>{let p=l&&l()||"";p!==We&&(We=p,Ne.close()),Pe(),cn()})),Pe(),{load(){Ae(),Pe()},refreshSessionDefaults:we,destroy(){for(let p of T.splice(0))try{p()}catch{}e.removeEventListener("pointerdown",Ft),e.removeEventListener("dragstart",Xt),e.removeEventListener("dragover",gn),e.removeEventListener("dragleave",_e),e.removeEventListener("dragend",S),e.removeEventListener("drop",Oe),e.removeEventListener("click",Gn),e.removeEventListener("change",jt);try{oe.destroy()}catch{}Se.hidden=!0;try{Ne.destroy()}catch{}rt(c``,e)}}}function Il(e){if(!e)return"Unknown";let t=e.split("/").filter(Boolean);return t.length>0?t[t.length-1]:"Unknown"}function Zf(e,t,n,r=async()=>{},s=async()=>{}){let o=qt("views:workspace-picker"),i=null,a=!1,l=!1,u=!1;async function d(j){let V=j.target.value,U=t.getState().workspace?.current?.path||"";if(V&&V!==U){o("switching workspace to %s",V),a=!0,D();try{await n(V)}catch(J){o("workspace switch failed: %o",J)}finally{a=!1,D()}}}async function m(){let j=t.getState(),Z=j.workspace?.current?.path||j.workspace?.available?.[0]?.path||"";if(!(!Z||l)){o("git-pulling workspace %s",Z),l=!0,D();try{await r(Z)}catch(V){o("workspace git pull failed: %o",V)}finally{l=!1,D()}}}function v(j){let Z=j.target;Z&&e.contains(Z)||N()}function b(j){j.key==="Escape"&&N()}function k(){u||(u=!0,document.addEventListener("mousedown",v),document.addEventListener("keydown",b),D())}function N(){u&&(u=!1,document.removeEventListener("mousedown",v),document.removeEventListener("keydown",b),D())}function W(){u?N():k()}async function K(j){let Z=j.target,V=Z.value,ue=Z.checked;o("toggling visibility %s \u2192 %s",V,String(ue));try{await s(V,ue)}catch(U){o("workspace visibility toggle failed: %o",U)}}function le(j){return j?c`
      <button
        type="button"
    ...
    `}function B(){let j=t.getState(),Z=j.workspace?.current,V=j.workspace?.available||[],ue=new Set(j.workspace?.hidden||[]),U=Z?.path||V[0]?.path||"";if(V.length===0)return c``;let J=V.filter(se=>!ue.has(se.path)||se.path===U);if(J.length<=1){let se=J[0]||V[0],ae=Il(se.path);return c`
    ...
    `}function D(){rt(B(),e)}return D(),i=t.subscribe(()=>D()),{destroy(){i&&(i(),i=null),document.removeEventListener("mousedown",v),document.removeEventListener("keydown",b),rt(c``,e)}}}var Xf=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-impl-target","get-session-defaults","set-session-defaults","get-workspace-accounts","set-workspace-accounts","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-automation-toggle","worker-repo-ops-opt-out-toggle","worker-repo-operation-dismiss","worker-repo-operation-deploy-run","worker-queue-set-slots","worker-queue-set-serial-lane-count","worker-queue-set-orchestration-defaults","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-cleanup-retry","worker-merge-queue-add","worker-merge-queue-add-all","worker-merge-auto-toggle","worker-merge-queue-remove","worker-discard","worker-stale-work-continue","worker-stale-work-backup-fresh","worker-stale-work-recheck","worker-pr-discard","worker-revise-fix","worker-revise-approve","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append","get-attempt-prompt","get-bead-prompt","get-worker-system-prompt","get-session-refs","subscribe-monitor-pipeline","unsubscribe-monitor-pipeline","monitor-pipeline-snapshot","subscribe-impl-presets","unsubscribe-impl-presets","impl-presets-snapshot","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","monitor-auto-toggle","monitor-lane-create","monitor-lane-update","monitor-lane-confirm","monitor-lane-remove"];function Ml(){let e=Date.now().toString(36),t=Math.random().toString(36).slice(2,8);return`${e}-${t}`}function Qf(e,t,n=Ml()){return{id:n,type:e,payload:t}}function Jf(e={}){let t=qt("ws"),n={initialMs:e.backoff?.initialMs??1e3,maxMs:e.backoff?.maxMs??3e4,factor:e.backoff?.factor??2,jitterRatio:e.backoff?.jitterRatio??.2},r=()=>e.url&&e.url.length>0?e.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",i=0,a=null,l=!0,u=new Map,d=[],m=new Map,v=new Set;function b(B){for(let D of Array.from(v))try{D(B)}catch{}}function k(){if(!l||a)return;o="reconnecting",t("ws reconnecting\u2026"),b(o);let B=Math.min(n.maxMs||0,(n.initialMs||0)*Math.pow(n.factor||1,i)),D=(n.jitterRatio||0)*B,j=Math.max(0,Math.round(B+(Math.random()*2-1)*D));t("ws retry in %d ms (attempt %d)",j,i+1),a=setTimeout(()=>{a=null,Y()},j)}function N(B){try{s?.send(JSON.stringify(B))}catch(D){t("ws send failed",D)}}function W(){for(o="open",t("ws open"),b(o),i=0;d.length;){let B=d.shift();B&&N(B)}}function K(B){let D;try{D=JSON.parse(String(B.data))}catch{t("ws received non-JSON message");return}if(!D||typeof D.id!="string"||typeof D.type!="string"){t("ws received invalid envelope");return}if(u.has(D.id)){let Z=u.get(D.id);u.delete(D.id),D.ok?Z?.resolve(D.payload):Z?.reject(D.error||new Error("ws error"));return}let j=m.get(D.type);if(j&&j.size>0)for(let Z of Array.from(j))try{Z(D.payload)}catch(V){t("ws event handler error",V)}else t("ws received unhandled message type: %s",D.type)}function le(){o="closed",t("ws closed"),b(o);for(let[B,D]of u.entries())D.reject(new Error("ws disconnected")),u.delete(B);i+=1,k()}function Y(){if(!l)return;let B=r();try{s=new WebSocket(B),t("ws connecting %s",B),o="connecting",b(o),s.addEventListener("open",W),s.addEventListener("message",K),s.addEventListener("error",()=>{}),s.addEventListener("close",le)}catch(D){t("ws connect failed %o",D),k()}}return Y(),{send(B,D){if(!Xf.includes(B))return Promise.reject(new Error(`unknown message type: ${B}`));let j=Ml(),Z=Qf(B,D,j);return t("send %s id=%s",B,j),new Promise((V,ue)=>{u.set(j,{resolve:V,reject:ue,type:B}),s&&s.readyState===s.OPEN?N(Z):(t("queue %s id=%s (state=%s)",B,j,o),d.push(Z))})},on(B,D){m.has(B)||m.set(B,new Set);let j=m.get(B);return j?.add(D),()=>{j?.delete(D)}},onConnection(B){return v.add(B),()=>{v.delete(B)}},reconnect(){l=!0,a&&(clearTimeout(a),a=null),i=0,Y()},close(){l=!1,a&&(clearTimeout(a),a=null);try{s?.close()}catch{}},getState(){return o}}}function Yv(){let e=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:null}}}async function Zv(e,t){try{let r=await(await fetch("/api/config")).json();e.setState({config:r})}catch(n){t("config refresh failed",n)}}var Pl=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],e_=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"],["tab:worker:in-progress","in-progress-issues"],["tab:worker:resolved","resolved-issues"],["tab:worker:closed","closed-issues"]],gr="tab:worker:closed",Xv="bdui.worker.done-range",t_=nf,n_="worker:queue",r_="ui:order",s_="ui:display-policy",o_="exec:presets",br="tab:board:closed",i_="beads-ui.board.closed-range";function Qv(e){let t=qt("main");t("bootstrap start");let n=c`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="monitor-root" class="route monitor" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;rt(n,e);let r=document.getElementById("global-nav"),s=document.getElementById("top-nav"),o=document.getElementById("repo-scope"),i=document.getElementById("usage-meter"),a=document.getElementById("board-root"),l=document.getElementById("worker-root"),u=document.getElementById("monitor-root"),d=document.getElementById("detail-panel");if(i&&$f(i),a&&l&&u&&d){let Ae=function(x,O){let p="Request failed",h="";if(x&&typeof x=="object"){let ee=x;if(typeof ee.message=="string"&&ee.message.length>0&&(p=ee.message),typeof ee.details=="string")h=ee.details;else if(ee.details&&typeof ee.details=="object")try{h=JSON.stringify(ee.details,null,2)}catch{h=""}}else typeof x=="string"&&x.length>0&&(p=x);let L=O&&O.length>0?`Failed to load ${O}`:"Request failed";ne.open(L,p,h)},ye=function(x){return`${_e.getState().workspace.current?.path||""}\0${x}`},ct=function(){Te&&(Te().catch(()=>{}),Te=null),Ne=null,We=null},Me=function(x){Je=x;let O=()=>{Je!==x||_e.getState().selected_id!==x||(Je=null,nt(x))};if(!te){bt.then(O);return}O()},pt=function(x,O,p,h,L){return p!==at[O]?(L().catch(()=>{}),!1):(x.set(h,L),!0)},zt=function(){let x=_e.getState();je(x.view==="board"),Ie(x.view==="worker"),Xe(ve(x)),xe(x.view==="board"||x.view==="worker"||Et||!!x.selected_id)},It=function(){let x=$r(Ht);return x===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:x}}},xt=function(){let x=$r(Lt);return x===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:x}}},je=function(x){if(x)for(let[O,p]of Pl){if(Fe.has(O)||dt.has(O))continue;let h=O===br?It():{type:p};try{Se.register(O,h)}catch(pe){t("register %s store failed: %o",O,pe)}dt.add(O);let L=at.board,ee=!1;fe.subscribeList(O,h).then(pe=>{ee=!pt(Fe,"board",L,O,pe)}).catch(pe=>{t("subscribe %s failed: %o",O,pe),Ae(pe,"board")}).finally(()=>{dt.delete(O),ee&&zt()})}else be()},be=function(){at.board+=1;for(let[x]of Pl){let O=Fe.get(x);O&&(O().catch(()=>{}),Fe.delete(x));try{Se.unregister(x)}catch(p){t("unregister %s failed: %o",x,p)}}},Ie=function(x){if(!x){Be();return}for(let[O,p]of e_){if(C.has(O)||dt.has(O))continue;let h=O===gr?xt():{type:p};try{Se.register(O,h)}catch(pe){t("register %s store failed: %o",O,pe)}dt.add(O);let L=at.worker,ee=!1;fe.subscribeList(O,h).then(pe=>{ee=!pt(C,"worker",L,O,pe)}).catch(pe=>{t("subscribe %s failed: %o",O,pe),Ae(pe,"worker")}).finally(()=>{dt.delete(O),ee&&zt()})}},Be=function(){at.worker+=1;for(let[x]of e_){let O=C.get(x);O&&(O().catch(()=>{}),C.delete(x));try{Se.unregister(x)}catch(p){t("unregister %s failed: %o",x,p)}}},xe=function(x){if(!x){lt();return}H||(Re("subscribe-worker-queue",{id:n_}).catch(O=>{t("subscribe-worker-queue failed: %o",O)}),H=()=>Re("unsubscribe-worker-queue",{id:n_}))},lt=function(){H&&(H().catch(()=>{}),H=null)},ve=function(x){return x.view==="monitor"||x.selected_id!=null},Xe=function(x){if(!x){P();return}st||(Re("subscribe-monitor-pipeline",{id:t_}).catch(O=>{t("subscribe-monitor-pipeline failed: %o",O)}),st=()=>Re("unsubscribe-monitor-pipeline",{id:t_}))},P=function(){st&&(st().catch(()=>{}),st=null)},ke=function(){F||(Re("subscribe-ui-order",{id:r_}).catch(x=>{t("subscribe-ui-order failed: %o",x)}),F=()=>Re("unsubscribe-ui-order",{id:r_}))},Ge=function(){F&&(F().catch(()=>{}),F=null),_t.clear()},Ze=function(){$e||(Re("subscribe-display-policy",{id:s_}).catch(x=>{t("subscribe-display-policy failed: %o",x)}),$e=()=>Re("unsubscribe-display-policy",{id:s_}))},ot=function(){$e&&($e().catch(()=>{}),$e=null),wt.clear()},$t=function(){mt||(Re("subscribe-impl-presets",{id:o_}).catch(x=>{t("subscribe-impl-presets failed: %o",x)}),mt=()=>Re("unsubscribe-impl-presets",{id:o_}))},Jt=function(x){if(!x)return"Unknown";let O=x.split("/").filter(Boolean);return O.length>0?O[O.length-1]:"Unknown"},rn=function(x,O){nn.open(x.path,{missing_state:x.missing_state,...O?{workspace:O}:{}})};var m=Ae,v=ye,b=ct,k=Me,N=pt,W=zt,K=It,le=xt,Y=je,B=be,D=Ie,j=Be,Z=xe,V=lt,ue=ve,U=Xe,J=P,se=ke,ae=Ge,he=Ze,Ue=ot,ge=$t,X=Jt,Ee=rn;let Le=document.getElementById("header-loading"),T=Yc(Le),ne=Ap(e),we=Jf(),Re=T.wrapSend((x,O)=>we.send(x,O)),fe=Uc(Re),Se=Wc(),it=Hc(),ht=Tc(),_t=zc(),wt=Sc(),R=Ec(),oe=Cc();we.on("impl-presets-snapshot",x=>{let O=x;O&&typeof O.revision=="number"&&Array.isArray(O.presets)&&R.set({revision:O.revision,presets:O.presets})}),we.on("monitor-pipeline-snapshot",x=>{let O=x;if(!(!O||!Array.isArray(O.workspaces)))try{ht.set(O.workspaces,O.workspaces_state,O.cross_lanes)}catch{}}),we.on("ui-order-snapshot",x=>{let O=x;if(O&&typeof O.revision=="number")try{_t.set({revision:O.revision,order:O.order&&typeof O.order=="object"?O.order:{}})}catch{}}),we.on("display-policy-snapshot",x=>{let O=x;if(O&&O.policy&&typeof O.policy=="object")try{wt.set(O.policy)}catch{}}),we.on("session-log-snapshot",x=>{let O=x;if(O&&typeof O.id=="string")try{oe.set(O.id,Array.isArray(O.lines)?O.lines:[],typeof O.last_event_at=="number"?O.last_event_at:null)}catch{}}),we.on("session-log-append",x=>{let O=x;if(O&&typeof O.id=="string")try{oe.append(O.id,O.event)}catch{}}),we.on("snapshot",x=>{let O=x,p=O&&typeof O.id=="string"?O.id:"",h=p?Se.getStore(p):null;if(h&&O&&O.type==="snapshot")try{h.applyPush(O)}catch{}}),we.on("upsert",x=>{let O=x,p=O&&typeof O.id=="string"?O.id:"",h=p?Se.getStore(p):null;if(h&&O&&O.type==="upsert")try{h.applyPush(O)}catch{}}),we.on("delete",x=>{let O=x,p=O&&typeof O.id=="string"?O.id:"",h=p?Se.getStore(p):null;if(h&&O&&O.type==="delete")try{h.applyPush(O)}catch{}});let Te=null,Ne=null,We=null,Je=null,tt=()=>{},bt=new Promise(x=>{tt=()=>x(void 0)}),te=!1,G=!1;async function nt(x){let O=ye(x);if(O===Ne||O===We)return;We=O;let p=`detail:${x}`,h={type:"issue-detail",params:{id:x}};try{Se.register(p,h)}catch(L){t("register detail store failed: %o",L)}try{let L=await fe.subscribeList(p,h);if(_e.getState().selected_id!==x||ye(x)!==O){await L().catch(()=>{});return}Te&&await Te().catch(()=>{}),Te=L,Ne=O}catch(L){t("detail subscribe failed: %o",L),Ae(L,"issue details")}finally{We===O&&(We=null)}}let Fe=new Map,dt=new Set,at={board:0,worker:0},Et=!1,Ht=ko;try{let x=window.localStorage.getItem(i_);la(x)&&(Ht=x)}catch{}let Lt="today";try{let x=window.localStorage.getItem(Xv);x!==null&&(Lt=Kn(x))}catch{}async function I(x){if(!la(x)||x===Ht)return;Ht=x;try{window.localStorage.setItem(i_,x)}catch{}let O=Fe.get(br);if(!O)return;Fe.delete(br),await O().catch(()=>{});let p=It();try{Se.register(br,p)}catch(h){t("register %s store failed: %o",br,h)}try{let h=await fe.subscribeList(br,p);Fe.set(br,h)}catch(h){t("re-subscribe %s failed: %o",br,h),Ae(h,"board")}}async function Q(x){let O=Kn(x);if(O===Lt)return;Lt=O;let p=C.get(gr);if(!p)return;C.delete(gr),await p().catch(()=>{});let h=xt();try{Se.register(gr,h)}catch(L){t("register %s store failed: %o",gr,L)}try{let L=await fe.subscribeList(gr,h);C.set(gr,L)}catch(L){t("re-subscribe %s failed: %o",gr,L),Ae(L,"worker")}}let C=new Map,H=null,st=null,F=null,$e=null,mt=null;async function Kt(){$e=null,wt.clear(),mt=null,R.clear(),H=null,st=null,Fe.clear(),C.clear(),at.board+=1,at.worker+=1,$t();let x=_e.getState().workspace.current?.path;if(x)try{await we.send("set-workspace",{path:x})}catch(p){t("workspace restore after reconnect failed: %o",p);return}Ze();let O=_e.getState();je(O.view==="board"),Ie(O.view==="worker"),Xe(ve(O)),xe(O.view==="board"||O.view==="worker"||!!O.selected_id)}async function Tt(){t("clearing all subscriptions for workspace switch"),be(),Be(),lt(),it.clear(),Ge(),ke(),ot(),Ze(),ct();let x=_e.getState();if(x.selected_id)try{Se.unregister(`detail:${x.selected_id}`)}catch{}let O=_e.getState();je(O.view==="board"),Ie(O.view==="worker"),Xe(ve(O)),xe(O.view==="board"||O.view==="worker"||!!O.selected_id),O.selected_id&&Me(O.selected_id)}async function Qt(x){t("requesting workspace switch to %s",x),G=!0;try{let O=await we.send("set-workspace",{path:x});t("workspace switch result: %o",O),O&&O.workspace&&(_e.setState({workspace:{current:{path:O.workspace.root_dir,database:O.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",x),O.changed&&(await Tt(),ce("Switched to "+Jt(x),"success",2e3)))}catch(O){throw t("workspace switch failed: %o",O),ce("Failed to switch workspace","error",3e3),O}finally{G=!1}}async function Pe(x){t("requesting workspace git pull for %s",x);try{let O=await we.send("git-pull-workspace",{});t("workspace git pull result: %o",O);let p=O?.status;if(p==="up_to_date"){ce("Already up to date","success",2e3);return}if(p==="stash_pop_conflict"){ce("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}ce("Git pulled "+Jt(x),"success",2e3)}catch(O){t("workspace git pull failed: %o",O);let p=O?.code,h=O?.message;if(p==="rebase_conflict"){ce("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(p==="rebase_conflict_abort_failed"){ce("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(p==="busy"){ce("Git pull skipped: another operation is running","warning",3e3);return}let L=h?`: ${h}`:"";throw ce(`Git pull failed${L}`,"error",3e3),O}}async function mn(x,O){t("setting workspace visibility %s \u2192 %s",x,String(O));try{await we.send("set-workspace-visibility",{path:x,visible:O}),await Ft()}catch(p){t("workspace visibility update failed: %o",p),ce("Failed to update project visibility","error",3e3)}}async function Ft(){try{let x=await we.send("list-workspaces",{});if(t("workspaces loaded: %o",x),x&&Array.isArray(x.workspaces)){let O=x.workspaces.map(ee=>({path:ee.path,database:ee.database,pid:ee.pid,version:ee.version})),p=x.current?{path:x.current.root_dir,database:x.current.db_path}:null,h=Array.isArray(x.hidden)?x.hidden.filter(ee=>typeof ee=="string"):[];_e.setState({workspace:{current:p,available:O,hidden:h}});let L=window.localStorage.getItem("beads-ui.workspace");L&&(!O.some(pe=>pe.path===L)||h.includes(L)?window.localStorage.removeItem("beads-ui.workspace"):p&&L!==p.path&&(t("restoring saved workspace preference: %s",L),await Qt(L)))}}catch(x){t("failed to load workspaces: %o",x)}}we.on("workspace-changed",x=>{t("workspace-changed event: %o",x),x&&x.root_dir&&(_e.setState({workspace:{current:{path:x.root_dir,database:x.db_path}}}),Ft(),Tt())});let Xt=!1;if(typeof we.onConnection=="function"){let x=O=>{t("ws state %s",O),O==="reconnecting"||O==="closed"?(Xt=!0,ce("Connection lost. Reconnecting\u2026","error",4e3)):O==="open"&&Xt&&(Xt=!1,ce("Reconnected","success",2200),Zv(_e,(p,h)=>{t(`${p}: %o`,h)}),Kt())};we.onConnection(x)}let gn="board";try{let x=window.localStorage.getItem("beads-ui.view");(x==="board"||x==="worker"||x==="monitor")&&(gn=x)}catch(x){t("view parse error: %o",x)}let _e=Vc({config:Yv(),view:gn});we.on("worker-queue-snapshot",x=>{let O=x;if(!O||!O.queue)return;let p=_e.getState().workspace.current?.path;if(typeof p=="string"&&p.length>0&&O.root_dir!==p){t("dropping worker-queue snapshot for %s",String(O.root_dir));return}try{it.set(O.queue)}catch{}});let S=Gc(_e);S.start();let de=new Set(["get-comments","dep-add","dep-remove","impl-preset-create","impl-preset-update","impl-preset-delete","apply-impl-preset","apply-impl-preset-global","get-session-defaults","set-session-defaults","monitor-lane-create","monitor-lane-update","monitor-lane-confirm","monitor-lane-remove"]),Oe=async(x,O)=>{try{return await Re(x,O)}catch(p){if(de.has(x))throw p;return[]}};sf({global_element:r,repo_element:s},_e,S);let yt=document.getElementById("workspace-picker");yt&&Zf(yt,_e,Qt,Pe,mn);let Rt=cf(e,(x,O)=>Re(x,O));try{let x=document.getElementById("new-issue-btn");x&&x.addEventListener("click",()=>Rt.open())}catch{}let At=ff(e,{policyStore:wt,queueStore:it,implPresetStore:R,transport:(x,O)=>Re(x,O),onOpenChange:x=>{let O=Et;Et=x,zt(),O&&x===!1&&Mt.refreshSessionDefaults()},labelOptions:()=>{let x=new Set;for(let[O]of Pl)for(let p of Se.snapshotFor(O)||[]){let h=p.labels;if(Array.isArray(h))for(let L of h)typeof L=="string"&&L.length>0&&x.add(L)}return Array.from(x).sort()}});try{let x=document.getElementById("display-settings-btn");x&&(x.setAttribute("aria-label","\uC124\uC815"),x.setAttribute("title","\uC124\uC815"),x.addEventListener("click",()=>At.open()))}catch{}let jt=document.createElement("div");jt.className="md-viewer-root",document.body.appendChild(jt);let nn=Pi(jt,{getWorkspacePath:()=>_e.getState().workspace.current?.path}),En=uu(a,{gotoIssue:x=>S.gotoIssue(x),issueStores:Se,transport:Oe,workerQueueStore:it,uiOrderStore:_t,displayPolicyStore:wt,closedRange:Ht,onClosedRangeChange:x=>{I(x)},onNewIssue:()=>Rt.open(),openDoc:rn}),Mt=Ll(l,{transport:Oe,issueStores:Se,queueStore:it,sessionLogStore:oe,uiOrderStore:_t,gotoIssue:x=>_e.setState({selected_id:x}),getWorkspacePath:()=>_e.getState().workspace.current?.path,switchWorkspace:x=>Qt(x),openDoc:rn,doneRange:Lt,onDoneRangeChange:x=>{Q(x)}}),sn=rf(u,{transport:Oe,pipelineStore:ht,execPresetStore:R,sessionLogStore:oe,router:S,gotoIssue:x=>S.gotoIssue(x),getWorkspacePath:()=>_e.getState().workspace.current?.path,switchWorkspace:x=>Qt(x),openDoc:rn}),cn=xp(d,{issueStores:Se,transport:Oe,queueStore:it,execPresetStore:R,sessionLogStore:oe,getWorkspacePath:()=>_e.getState().workspace.current?.path,mdViewer:nn,depCandidates:()=>{let x=ht.get();if(x===null)return null;let O=ht.getWorkspacesState(),p=_e.getState();if(p.view==="monitor")return za(x,O);let h=p.workspace.current?.path;return h?za(x,O,{root_dir:h}):null},subscribeCandidates:x=>ht.subscribe(x),onDepChanged:({type:x,a:O,b:p})=>{let h=sn;x==="dep-add"&&h&&typeof h.recorrectSharedLane=="function"&&h.recorrectSharedLane(x,O,p)},onNavigate:(x,O)=>{let p=()=>{_e.getState().view==="worker"?_e.setState({selected_id:x}):S.gotoIssue(x)},h=_e.getState().workspace.current?.path;if(typeof O!="string"||O.length===0||!h||O===h){p();return}Promise.resolve(Qt(O)).then(p).catch(()=>{ce("\uB808\uD3EC \uC804\uD658\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4","error",2400)})},onClose:()=>{let x=_e.getState();_e.setState({selected_id:null});try{S.gotoView(x.view==="worker"||x.view==="monitor"?x.view:"board")}catch{}},onOpenExecPresets:()=>{At.open("execution")}}),un=_e.getState().selected_id;un&&(d.hidden=!1,cn.load(un),Me(un)),_e.subscribe(x=>{let O=x.selected_id;O?(d.hidden=!1,cn.load(O),G||Me(O)):(cn.clear(),d.hidden=!0,ct())});let Gn=x=>{a.hidden=x.view!=="board",l.hidden=x.view!=="worker",u.hidden=x.view!=="monitor",o&&o.classList.toggle("is-quiet",x.view==="monitor"),je(x.view==="board"),Ie(x.view==="worker"),Xe(ve(x)),xe(x.view==="board"||x.view==="worker"||Et||!!x.selected_id),!x.selected_id&&x.view==="board"&&En.load(),x.view==="worker"&&Mt.load(),x.view==="monitor"?sn.load():sn.pause(),window.localStorage.setItem("beads-ui.view",x.view)};_e.subscribe(Gn),Gn(_e.getState()),ke(),Ze(),$t(),Ft().finally(()=>{te=!0,tt()}),window.addEventListener("keydown",x=>{let O=x.ctrlKey||x.metaKey,p=String(x.key||"").toLowerCase(),h=x.target,L=h&&h.tagName?String(h.tagName).toLowerCase():"",ee=L==="input"||L==="textarea"||L==="select"||h&&typeof h.isContentEditable=="boolean"&&h.isContentEditable;O&&p==="n"&&(ee||(x.preventDefault(),Rt.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let n=window.localStorage.getItem("beads-ui.theme"),r=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=n==="dark"||n==="light"?n:r?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let e=document.getElementById("theme-switch");e&&e.addEventListener("change",()=>{let n=e.checked?"dark":"light";document.documentElement.setAttribute("data-theme",n),window.localStorage.setItem("beads-ui.theme",n)});let t=document.getElementById("app");t&&Qv(t)});export{Qv as bootstrap,Yv as readBootstrapConfig,Zv as refreshConfigSnapshot};
