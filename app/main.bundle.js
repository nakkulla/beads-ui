...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ml=/'/g,Dl=/"/g,Fl=/^(?:script|style|textarea|title)$/i,Ta=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),c=Ta(1),ns=Ta(2),by=Ta(3),fn=Symbol.for("lit-noChange"),Nt=Symbol.for("lit-nothing"),Nl=new WeakMap,rr=sr.createTreeWalker(sr,129);function jl(e,t){if(!Ea(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ll!==void 0?Ll.createHTML(t):t}var Bl=(e,t)=>{let n=e.length-1,r=[],s,o=t===2?"<svg>":t===3?"<math>":"",a=Qr;for(let i=0;i<n;i++){let l=e[i],u,d,_=-1,h=0;for(;h<l.length&&(a.lastIndex=h,d=a.exec(l),d!==null);)h=a.lastIndex,a===Qr?d[1]==="!--"?a=Il:d[1]!==void 0?a=Pl:d[2]!==void 0?(Fl.test(d[2])&&(s=RegExp("</"+d[2],"g")),a=nr):d[3]!==void 0&&(a=nr):a===nr?d[0]===">"?(a=s??Qr,_=-1):d[1]===void 0?_=-2:(_=a.lastIndex-d[2].length,u=d[1],a=d[3]===void 0?nr:d[3]==='"'?Dl:Ml):a===Dl||a===Ml?a=nr:a===Il||a===Pl?a=Qr:(a=nr,s=void 0);let w=a===nr&&e[i+1].startsWith("/>")?" ":"";o+=a===Qr?l+xf:_>=0?(r.push(u),l.slice(0,_)+Aa+l.slice(_)+Rn+w):l+Rn+(_===-2?i:w)}return[jl(e,o+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},ts=class e{constructor({strings:t,_$litType$:n},r){let s;this.parts=[];let o=0,a=0,i=t.length-1,l=this.parts,[u,d]=Bl(t,n);if(this.el=e.createElement(u,r),rr.currentNode=this.el.content,n===2||n===3){let _=this.el.content.firstChild;_.replaceWith(..._.childNodes)}for(;(s=rr.nextNode())!==null&&l.length<i;){if(s.nodeType===1){if(s.hasAttributes())for(let _ of s.getAttributeNames())if(_.endsWith(Aa)){let h=d[a++],w=s.getAttribute(_).split(Rn),S=/([.?@])?(.*)/.exec(h);l.push({type:1,index:o,name:S[2],strings:w,ctor:S[1]==="."?Hs:S[1]==="?"?Gs:S[1]==="@"?Vs:ar}),s.removeAttribute(_)}else _.startsWith(Rn)&&(l.push({type:6,index:o}),s.removeAttribute(_));if(Fl.test(s.tagName)){let _=s.textContent.split(Rn),h=_.length-1;if(h>0){s.textContent=Ws?Ws.emptyScript:"";for(let w=0;w<h;w++)s.append(_[w],Jr()),rr.nextNode(),l.push({type:2,index:++o});s.append(_[h],Jr())}}}else if(s.nodeType===8)if(s.data===Sa)l.push({type:2,index:o});else{let _=-1;for(;(_=s.data.indexOf(Rn,_+1))!==-1;)l.push({type:7,index:o}),_+=Rn.length-1}o++}}static createElement(t,n){let r=sr.createElement("template");return r.innerHTML=t,r}};function or(e,t,n=e,r){if(t===fn)return t;let s=r!==void 0?n._$Co?.[r]:n._$Cl,o=es(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=s:n._$Cl=s),s!==void 0&&(t=or(e,s._$AS(e,t.values),s,r)),t}var zs=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,s=(t?.creationScope??sr).importNode(n,!0);rr.currentNode=s;let o=rr.nextNode(),a=0,i=0,l=r[0];for(;l!==void 0;){if(a===l.index){let u;l.type===2?u=new $r(o,o.nextSibling,this,t):l.type===1?u=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(u=new Ks(o,this,t)),this._$AV.push(u),l=r[++i]}a!==l?.index&&(o=rr.nextNode(),a++)}return rr.currentNode=sr,s}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},$r=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,s){this.type=2,this._$AH=Nt,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=or(this,t,n),es(t)?t===Nt||t==null||t===""?(this._$AH!==Nt&&this._$AR(),this._$AH=Nt):t!==this._$AH&&t!==fn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ql(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Nt&&es(this._$AH)?this._$AA.nextSibling.data=t:this.T(sr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=ts.createElement(jl(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(n);else{let o=new zs(s,this),a=o.u(this.options);o.p(n),this.T(a),this._$AH=o}}_$AC(t){let n=Nl.get(t.strings);return n===void 0&&Nl.set(t.strings,n=new ts(t)),n}k(t){Ea(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,s=0;for(let o of t)s===n.length?n.push(r=new e(this.O(Jr()),this.O(Jr()),this,this.options)):r=n[s],r._$AI(o),s++;s<n.length&&(this._$AR(r&&r._$AB.nextSibling,s),n.length=s)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},ar=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,s,o){this.type=1,this._$AH=Nt,this._$AN=void 0,this.element=t,this.name=n,this._$AM=s,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Nt}_$AI(t,n=this,r,s){let o=this.strings,a=!1;if(o===void 0)t=or(this,t,n,0),a=!es(t)||t!==this._$AH&&t!==fn,a&&(this._$AH=t);else{let i=t,l,u;for(t=o[0],l=0;l<o.length-1;l++)u=or(this,i[r+l],n,l),u===fn&&(u=this._$AH[l]),a||(a=!es(u)||u!==this._$AH[l]),u===Nt?t=Nt:t!==Nt&&(t+=(u??"")+o[l+1]),this._$AH[l]=u}a&&!s&&this.j(t)}j(t){t===Nt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Hs=class extends ar{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Nt?void 0:t}},Gs=class extends ar{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Nt)}},Vs=class extends ar{constructor(t,n,r,s,o){super(t,n,r,s,o),this.type=5}_$AI(t,n=this){if((t=or(this,t,n,0)??Nt)===fn)return;let r=this._$AH,s=t===Nt&&r!==Nt||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,o=t!==Nt&&(r===Nt||s);s&&this.element.removeEventListener(this.name,this,r),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Ks=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){or(this,t)}},Ul={M:Aa,P:Rn,A:Sa,C:1,L:Bl,R:zs,D:ql,V:or,I:$r,H:ar,N:Gs,U:Vs,B:Hs,F:Ks},Af=Xr.litHtmlPolyfillSupport;Af?.(ts,$r),(Xr.litHtmlVersions??(Xr.litHtmlVersions=[])).push("3.3.1");var Ye=(e,t,n)=>{let r=n?.renderBefore??t,s=r._$litPart$;if(s===void 0){let o=n?.renderBefore??null;r._$litPart$=s=new $r(t.insertBefore(Jr(),o),o,void 0,n??{})}return s._$AI(e),s};var an="today",Wn=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function _n(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function ir(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function Wl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function zl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Hl(){let e=null,t=[],n=new Set;function r(){for(let s of Array.from(n))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},set(s,o){e=Array.isArray(s)?s:null,t=Array.isArray(o)?o:[],r()},clear(){e=null,t=[],r()},subscribe(s){return n.add(s),()=>n.delete(s)}}}function Gl(){let e=new Map,t=new Set;function n(s){return s.startsWith("session-log:")?s:`session-log:${s}`}function r(){for(let s of Array.from(t))try{s()}catch{}}return{set(s,o,a=null){e.set(n(s),{lines:Array.isArray(o)?[...o]:[],last_event_at:typeof a=="number"?a:null}),r()},append(s,o){let a=n(s),i=e.get(a)||{lines:[],last_event_at:null};i.lines=[...i.lines,o],i.last_event_at=Date.now(),e.set(a,i),r()},get(s){return e.get(n(s))||null},clear(s){typeof s=="string"?e.delete(n(s)):e.clear(),r()},subscribe(s){return t.add(s),()=>t.delete(s)}}}var Xl=$f(Ql(),1);function It(e){return(0,Xl.default)(`beads-ui:${e}`)}function yn(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function cr(e,t){let n=yn(e.created_at),r=yn(t.created_at);if(n!==r)return n<r?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function tc(e,t){let n=yn(e.created_at),r=yn(t.created_at);if(n!==r)return n<r?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function nc(e,t){let n=yn(e.updated_at),r=yn(t.updated_at);if(n!==r)return n<r?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function rc(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let s=yn(e.created_at),o=yn(t.created_at);if(s!==o)return s<o?1:-1;let a=e.id,i=t.id;return a<i?-1:a>i?1:0}function sc(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var qf=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function Jl(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function ec(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=qf.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function oc(e,t){let n=Jl(e),r=Jl(t);if(n!==r)return n<r?-1:1;let s=ec(e),o=ec(t);if(s!==o)return s<o?-1:1;let a=yn(e&&e.created_at),i=yn(t&&t.created_at);if(a!==i)return a<i?-1:1;let l=e&&e.id,u=t&&t.id;return l===u?0:String(l)<String(u)?-1:1}var Ca=2**20;function Er(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-yn(e&&e.created_at)}function Qs(e){return(t,n)=>{let r=Er(t,e),s=Er(n,e);if(r!==s)return r<s?-1:1;let o=t?.id,a=n?.id;return o<a?-1:o>a?1:0}}function Ra(e,t,n){let r=Array.isArray(e)?e:[],s=r.length,o=Math.max(0,Math.min(t,s-1)),a=o-1>=0?r[o-1]:null,i=o+1<s?r[o+1]:null;if(!a&&!i)return{rank:0};if(!a)return{rank:Er(i,n)-Ca};if(!i)return{rank:Er(a,n)+Ca};let l=Er(a,n),u=Er(i,n),d=(l+u)/2;return l<d&&d<u?{rank:d}:{renormalize:r.map((_,h)=>({bead_id:_.id,rank:h*Ca}))}}function Oa(e,t={}){let n=It(`issue-store:${e}`),r=new Map,s=[],o=0,a=new Set,i=!1,l=t.sort||cr;function u(){for(let h of Array.from(a))try{h()}catch{}}function d(){s=Array.from(r.values()).sort(l)}function _(h){if(i||!h||h.id!==e)return;let w=Number(h.revision)||0;if(n("apply %s rev=%d",h.type,w),!(w<=o&&h.type!=="snapshot")){if(h.type==="snapshot"){if(w<=o)return;r.clear();let S=Array.isArray(h.issues)?h.issues:[];for(let F of S)F&&typeof F.id=="string"&&F.id.length>0&&r.set(F.id,F);d(),o=w,u();return}if(h.type==="upsert"){let S=h.issue;if(S&&typeof S.id=="string"&&S.id.length>0){let F=r.get(S.id);if(!F)r.set(S.id,S);else{let z=Number.isFinite(F.updated_at)?F.updated_at:0,V=Number.isFinite(S.updated_at)?S.updated_at:0;if(z<=V){for(let oe of Object.keys(F))oe in S||delete F[oe];for(let[oe,M]of Object.entries(S))F[oe]=M}}d()}o=w,u()}else if(h.type==="delete"){let S=String(h.issue_id||"");S&&(r.delete(S),d()),o=w,u()}}}return{id:e,subscribe(h){return a.add(h),()=>{a.delete(h)}},applyPush:_,snapshot(){return s},size(){return r.size},getById(h){return r.get(h)},dispose(){i=!0,r.clear(),s=[],a.clear(),o=0}}}function Xs(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let a=e.params[o];n[o]=String(a)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function ac(e){let t=It("subs"),n=new Map,r=new Map;function s(i,l){t("applyDelta %s +%d ~%d -%d",i,(l.added||[]).length,(l.updated||[]).length,(l.removed||[]).length);let u=r.get(i);if(!u||u.size===0)return;let d=Array.isArray(l.added)?l.added:[],_=Array.isArray(l.updated)?l.updated:[],h=Array.isArray(l.removed)?l.removed:[];for(let w of Array.from(u)){let S=n.get(w);if(!S)continue;let F=S.itemsById;for(let z of d)typeof z=="string"&&z.length>0&&F.set(z,!0);for(let z of _)typeof z=="string"&&z.length>0&&F.set(z,!0);for(let z of h)typeof z=="string"&&z.length>0&&F.delete(z)}}async function o(i,l){let u=Xs(l);if(t("subscribe %s key=%s",i,u),!n.has(i))n.set(i,{key:u,itemsById:new Map});else{let _=n.get(i);if(_&&_.key!==u){let h=r.get(_.key);h&&(h.delete(i),h.size===0&&r.delete(_.key)),n.set(i,{key:u,itemsById:new Map})}}r.has(u)||r.set(u,new Set);let d=r.get(u);d&&d.add(i);try{await e("subscribe-list",{id:i,type:l.type,params:l.params})}catch(_){let h=n.get(i)||null;if(h){let w=r.get(h.key);w&&(w.delete(i),w.size===0&&r.delete(h.key))}throw n.delete(i),_}return async()=>{t("unsubscribe %s key=%s",i,u);try{await e("unsubscribe-list",{id:i})}catch{}let _=n.get(i)||null;if(_){let h=r.get(_.key);h&&(h.delete(i),h.size===0&&r.delete(_.key))}n.delete(i)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:Xs,selectors:{getIds(i){let l=n.get(i);return l?Array.from(l.itemsById.keys()):[]},has(i,l){let u=n.get(i);return u?u.itemsById.has(l):!1},count(i){let l=n.get(i);return l?l.itemsById.size:0},getItemsById(i){let l=n.get(i),u={};if(!l)return u;for(let d of l.itemsById.keys())u[d]=!0;return u}}}}function ic(){let e=It("issue-stores"),t=new Map,n=new Map,r=new Set,s=new Map;function o(){for(let l of Array.from(r))try{l()}catch{}}function a(l,u,d){let _=u?Xs(u):"",h=n.get(l)||"",w=t.has(l);if(e("register %s key=%s (prev=%s)",l,_,h),w&&h&&_&&h!==_){let S=t.get(l);if(S)try{S.dispose()}catch{}let F=s.get(l);if(F){try{F()}catch{}s.delete(l)}let z=Oa(l,d);t.set(l,z);let V=z.subscribe(()=>o());s.set(l,V)}else if(!w){let S=Oa(l,d);t.set(l,S);let F=S.subscribe(()=>o());s.set(l,F)}return n.set(l,_),()=>i(l)}function i(l){e("unregister %s",l),n.delete(l);let u=t.get(l);u&&(u.dispose(),t.delete(l));let d=s.get(l);if(d){try{d()}catch{}s.delete(l)}}return{register:a,unregister:i,getStore(l){return t.get(l)||null},snapshotFor(l){let u=t.get(l);return u?u.snapshot().slice():[]},subscribe(l){return r.add(l),()=>r.delete(l)}}}function lc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function cc(){let e=null,t=!1,n=new Set;function r(){for(let s of Array.from(n))try{s()}catch{}}return{get(){return e},set(s){e=s,r()},isPending(){return t},setPending(s){let o=s===!0;o!==t&&(t=o,r())},clear(){e=null,t=!1,r()},subscribe(s){return n.add(s),()=>n.delete(s)}}}function uc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function La(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function Ff(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),s=r>=0?n.slice(r+1):"";if(s){let i=new URLSearchParams(s).get("issue");if(i)return decodeURIComponent(i)}let o=/^\/issue\/([^\s?#]+)/.exec(n);return o&&o[1]?decodeURIComponent(o[1]):null}function jf(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function dc(e){let t=It("router"),n=()=>{let r=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(r),o=s&&s[1]?decodeURIComponent(s[1]):Ff(r),a=jf(r);if(t("hash change \u2192 view=%s id=%s",a,o),e.setState({selected_id:a==="worker"?null:o,view:a,worker:{selected_parent_id:a==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let l=o?`#/${a}?issue=${encodeURIComponent(o)}`:`#/${a}`;window.location.hash!==l&&(window.location.hash=l)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",a=La(o,r);t("goto issue %s (view=%s)",r,o),window.location.hash!==a?window.location.hash=a:e.setState({selected_id:o==="worker"?null:r,view:o,worker:{selected_parent_id:o==="worker"?r:null}})},gotoView(r){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=r==="worker"?s.worker?.selected_parent_id:s.selected_id,a=o?La(r,o):`#/${r}`;t("goto view %s (id=%s)",r,o||""),window.location.hash!==a?window.location.hash=a:e.setState({view:r,selected_id:r==="worker"?null:s.selected_id})}}}var Bf=Object.freeze({workspace_config:{default_workspace:null}});function pc(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:Bf.workspace_config.default_workspace}}}function fc(e={}){let t=It("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:pc(e.config)},r=new Set;function s(){for(let o of Array.from(r))try{o(n)}catch{}}return{getState(){return n},setState(o){let a={...n,...o,filters:{...n.filters,...o.filters||{}},board:{...n.board,...o.board||{}},worker:{...n.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:n.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:n.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:n.workspace.hidden},config:o.config!==void 0?pc(o.config):n.config},i=a.workspace.current?.path!==n.workspace.current?.path||a.workspace.available.length!==n.workspace.available.length||a.workspace.hidden.length!==n.workspace.hidden.length||a.workspace.hidden.some((u,d)=>u!==n.workspace.hidden[d]),l=a.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;a.selected_id===n.selected_id&&a.view===n.view&&a.filters.status===n.filters.status&&a.filters.search===n.filters.search&&a.filters.type===n.filters.type&&a.board.closed_filter===n.board.closed_filter&&a.worker.selected_parent_id===n.worker.selected_parent_id&&a.worker.show_closed_children.length===n.worker.show_closed_children.length&&a.worker.show_closed_children.every((u,d)=>u===n.worker.show_closed_children[d])&&!i&&!l||(n=a,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),s())},subscribe(o){return r.add(o),()=>r.delete(o)}}}function _c(e){let t=It("activity"),n=0,r=new Map,s=1;function o(){if(!e)return;let u=n>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function a(){n+=1,t("start count=%d",n),o()}function i(){let u=n;n=Math.max(0,n-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,n),o()}function l(u){return async(_,h)=>{let w=s++,S=Date.now();r.set(w,{type:_,start_ts:S}),t("request start id=%d type=%s count=%d",w,_,n+1),a();let F=!1,z=()=>{F||(F=!0,r.delete(w),i())},V=setTimeout(()=>{F||(t("request TIMEOUT id=%d type=%s elapsed=%dms",w,_,Date.now()-S),z())},3e4);try{let oe=await u(_,h),M=Date.now()-S;return t("request done id=%d type=%s elapsed=%dms",w,_,M),oe}catch(oe){let M=Date.now()-S;throw t("request error id=%d type=%s elapsed=%dms err=%o",w,_,M,oe),oe}finally{clearTimeout(V),z()}}}return o(),{wrapSend:l,start:a,done:i,getCount:()=>n,getActiveRequests:()=>{let u=Date.now();return Array.from(r.entries()).map(([d,_])=>({id:d,type:_.type,elapsed_ms:u-_.start_ts}))}}}function ce(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function Js(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function r(o,a,i){let l=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(a==="closed")return l.sort(sc),l;switch(i){case"created_desc":return l.sort(cr),l;case"created_asc":return l.sort(tc),l;case"updated_desc":return l.sort(nc),l;case"priority":return l.sort(rc),l;case"manual":default:{let u=n();return u?l.sort(Qs(u)):l.sort(cr),l}}}function s(o){let a=[];return e&&typeof e.subscribe=="function"&&a.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&a.push(t.subscribe(o)),()=>{for(let i of a)try{i()}catch{}}}return{selectBoardColumn:r,subscribe:s}}function En(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function Wt(e){let t=En(e);if(t===null)return"";let n=new Date(t),r=s=>String(s).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function ln(e,t){let n=En(e);if(n===null)return"";let s=(typeof t=="number"?t:Date.now())-n;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let a=Math.floor(s/36e5);if(a<24)return`${a}\uC2DC\uAC04 \uC804`;let i=Math.floor(s/864e5);if(i<7)return`${i}\uC77C \uC804`;let l=Math.floor(i/7);if(i<30)return`${l}\uC8FC \uC804`;let u=Math.floor(i/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(i/365)}\uB144 \uC804`}function mc(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let s=En(r.updated_at)??0;if(t===null||s>n){t=r,n=s;continue}s===n&&String(r.id)<String(t.id)&&(t=r)}return t}function eo(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function to(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let s=eo(r);if(!s)continue;let o=n.get(s);o||(o=[],n.set(s,o)),o.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function no(e,t){let n=e.get(t)||[],r=0;for(let o of n)(o.status==="resolved"||o.status==="closed")&&(r+=1);let s=mc(n);return{total:n.length,count:r,current:s,children:n}}function ro(e){let t=e.transport,n=e.uiOrderStore;function r(a,i){return"renormalize"in a?a.renormalize:[{bead_id:i,rank:a.rank}]}function s(a,i){let l={...a.order};for(let u of i)l[u.bead_id]=u.rank;n&&n.set({revision:a.revision,order:l})}async function o(a,i,l){if(!t||!n)return;let u=n.get()||{revision:0,order:{}},d=r(Ra(i,l,u.order),a);s(u,d);let _=await t("ui-order-set",{expected_revision:u.revision,entries:d});if(_&&_.conflict){let h={revision:typeof _.revision=="number"?_.revision:0,order:_.order||{}};n.set(h);let w=r(Ra(i,l,h.order),a);s(h,w);let S=await t("ui-order-set",{expected_revision:h.revision,entries:w});S&&S.applied&&n.set({revision:typeof S.revision=="number"?S.revision:0,order:S.order||{}})}else _&&_.applied&&n.set({revision:typeof _.revision=="number"?_.revision:0,order:_.order||{}})}return{applyReorder:o}}function so(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ia(e,t){return!t||typeof e!="string"||e.length===0||so(t.visible_labels).includes(e)?!0:so(t.hidden_labels).includes(e)?!1:!so(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function gc(e,t){return so(e).filter(n=>Ia(n,t))}function zn(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function Uf(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function Wf(e,t,n,r,s){return c`<button
  ...
  >`:null}function Jf(e,t){let n=t.policy||null,r=e.workflow&&e.workflow.chips||{},s=[];if(r.route&&zn(n,"route")){let i=r.route_source==="derived";s.push(c`<span
      ...
      >
        ↩ from ${e.from_id}
      </button>`),zn(n,"blocked")&&s.push(...Qf(e.blocked_info)),t.cleanupFailureFor&&t.cleanupFailureFor(e.id)&&zn(n,"blocked")&&s.push(c`<span class="ctl-chip ctl-chip--cleanup">⚠ 정리 멈춤</span>`),s.length===0?"":c`<div class="board-card__chips">${s}</div>`}function e_(e){let t=ln(e.created_at),n=ln(e.updated_at);return!t&&!n?"":c`<span class="board-card__times">
    ${t?c`<span
...
Please report this to https://github.com/markedjs/marked.`,e){let r="<p>An error occurred:</p><pre>"+Nn(n.message+"",!0)+"</pre>";return t?Promise.resolve(r):r}if(t)return Promise.reject(n);throw n}}},dr=new Tm;function wt(e,t){return dr.parse(e,t)}wt.options=wt.setOptions=function(e){return dr.setOptions(e),wt.defaults=dr.defaults,su(wt.defaults),wt};wt.getDefaults=Xa;wt.defaults=pr;wt.use=function(...e){return dr.use(...e),wt.defaults=dr.defaults,su(wt.defaults),wt};wt.walkTokens=function(e,t){return dr.walkTokens(e,t)};wt.parseInline=dr.parseInline;wt.Parser=kn;wt.parser=kn.parse;wt.Renderer=ko;wt.TextRenderer=ai;wt.Lexer=wn;wt.lexer=wn.lex;wt.Tokenizer=wo;wt.Hooks=gs;wt.parse=wt;var Yv=wt.options,Zv=wt.setOptions,Qv=wt.use,Xv=wt.walkTokens,Jv=wt.parseInline;var ew=kn.parse,tw=wn.lex;function Gn(e){let t=wt.parse(e),n=Zc.sanitize(t);return Qc(n)}function qn(e,t){return c`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      </div>`}if(Q.kind==="error")return c`<div class="sv__error">⛔ ${Q.text}</div>`;if(Q.kind==="blocker")return c`<div class="sv__error">⛔ ${Q.text}</div>`;if(Q.kind==="tool"){let Le=h.has(J),Je=Q.tool==="Bash"?Hm(Q.command):0,Ie=Q.tool==="Bash"?Je>1?So(Q.command):Q.command:Q.path||Q.command||"";return c`<div
...
`)}function X(){if(!o)return c``;let J=W(),Q=(a?[d.agent_type,d.model,d.effort]:[d.runner,d.model,d.effort]).filter(Boolean).join(" \xB7 "),Le=d.session_id||"",Je=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${_?"ON":"OFF"}`,Ie=he(),ke=Ie?Qm(we(),Date.now()):"",ze=Ie?ie(J):null,Qe=Ie?Ae(J):null,st=Zm(J);return c`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
    ...
    `}function rt(f,C){return c`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Vt}
        >
          ${zg.map(E=>c`<option value=${E} ?selected=${E===f}>${E}</option>`)}
        </select>
      </div>
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${lt}
        >
          ${Hg.map(E=>c`<option value=${String(E)} ?selected=${E===C}>
                P${E}
              </option>`)}
        </select>
      </div>
    ...
    `}function p(){if(!u)return c``;let f=d||{},C=String(f.id||u),E=f.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",le=st(),Te=f.status||"open",Ue=typeof f.priority=="number"?Math.max(0,Math.min(4,f.priority)):"",Xe=f.description||"",Ke={...f,metadata:{...f.metadata||{},..._}};return c`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${ge(E,le)}
          ${qu(Ke)}
          ${Nu({metadata:Ke.metadata,workspace_values:bt(),catalog:_e(),execution_defaults:I(),expanded:F,presets:re()?.presets||[],preset_id:h,preset_busy:w,skipped_orchestration_keys:S},{onToggle:vt=>{F=vt,y()},onEdit:(vt,sn)=>{if(vt==="impl_runtime"||vt==="impl_model"||vt==="impl_effort"){De(vt,sn??"");return}dt(vt,sn??"")},onPresetSelect:vt=>{h=vt,S=[],y()},onPresetApply:()=>{xe()}})}
          ${zu({md:Ke.metadata,catalog:V,workspace_defaults:oe,handlers:{onExecChange:dt}})}
          ${rt(Te,Ue)} ${Me(f)}
          ${x(Xe)}
          ${$u(Re,fe,{expanded:ye,draft:$e,sending:Y,error:Ae})}
          ${O(f)} ${Oe(f)} ${v(f)}
          ${b(f)} ${ee(f)}
          ${vu(f,ut)}
          ${Ju({expanded:tt,loading:$t,error:_t,data:J},{onToggle:ze})}
          ${Xu(Qe(),Ot,{total:le,expanded:nt})}
        </div>
      </div>
...
`)}
  ...
  >
    ...
    >${e.id}</span
  >`,S=e.lane==="done"?"":Br(e.workflow),F=sd(e.from_id),z=Ko(e.priority),V=c`<span class="worker-mini__title">${e.title}</span>`,oe=e.pr_url&&e.pr_number?c`<a
  ...
  >
    ...
    ${e.failure?c`<div class="worker-banner worker-banner--failure" role="alert">
        ...
        title=${e.root_dir||""}
        >${e.repo}</span
      >`:""}${e.serial_lane_id?c`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`:""}var nh=new Set(["codex-runner"]);function rh(e,t,n,r=null){if(!e)return"";let s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=(r||!Array.isArray(e.legs)?[]:e.legs).filter(h=>h&&!(typeof h.agent_type=="string"&&nh.has(h.agent_type))),l=i.filter(h=>h&&h.state==="live"),u=i.filter(h=>h&&h.state!=="live"),d=jr(e.dependency_chips,{lane:"running"}),_=r?ln(r.updated_at,t):"";return c`${o?c`<div class="rtile__activity${n?" is-paused":""}">
        ...
        ${l.map(h=>c`<span
            ...
            >`)}${u.length>0?c`<span
              ...
              >위임 완료 ${u.length}</span
            >`:""}
      </div>`:""}${d}`}function Si(e,t,n=null,r={}){let s=e.kind==="session",o=e.failed===!0,a=!!e.paused,i=o?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):a?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?eh(t-e.started_at):"\u2014",l=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,u=ss(e),d=zt(e.usage),_=Pn(e.usage),h=e.conflict_resolution?a?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,w=e.base_exception||null,S=e.landing,F=e.attempt_id&&e.attempt_id===n,z=r.monitor||null,V=th(z),oe=rh(z,t,a,s?{updated_at:e.updated_at??null}:null),M=s&&e.workflow?.chips?.exec_receipt||null,D=Br(e.workflow),q=M?c`<span
        class="ctl-chip ctl-chip--exec-receipt"
  ...
  >
    ...
    ${oe}${e.rollup?oo(e.rollup,{parent_id:e.bead_id,expanded:e.rollup_expanded===!0,childChips:Ma}):""}
...
`)}function Es(e){if(typeof e!="object"||e===null)return null;let t=ur(e);if(t==="")return null;let n=(r,s)=>typeof s=="string"&&s.length>0?`${r}: ${s}`:null;return{text:t,title:Ci(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(Vn.orchestration_model,e.model),n(Vn.orchestration_effort,e.effort),n(Vn.orchestration_speed,e.speed)])}}function _r(e,t){let n=Yn(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=Yn(e,"orchestration_effort"),s=Yn(e,"orchestration_speed"),o=dd([$n(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Ci(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Zn("orchestration_model",n),Zn("orchestration_effort",r),Zn("orchestration_speed",s)])}}function sh(e,t){return e===null||e.value===null||Ti.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function oh(e){return e===null||Ti.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function ah(e){return e===null?null:e.value==="auto"?"auto":Ti.has(e.resolution)?null:e.display}function Qn(e,t){if(typeof e!="object"||e===null)return null;let n=Yn(e,"impl_dispatch"),r=Yn(e,"impl_runtime"),s=Yn(e,"impl_model"),o=Yn(e,"impl_effort"),a=Yn(e,"impl_speed"),i=n!==null&&n.value==="main"?"\uBA54\uC778":dd([sh(r,t??null),oh(s),ah(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Ci(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Zn("impl_dispatch",n),Zn("impl_runtime",r),Zn("impl_model",s),Zn("impl_effort",o),Zn("impl_speed",a)])}}var Ht="",ih=["impl_runtime","impl_model","impl_effort"],lh=["claude_account","codex_account"],ch=5,Zo=1;function rn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Qo(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(I=>ce(I,"error",4e3)),o={},a={},i=[],l=!1,u={state:"absent",values:{},warnings:[]},d={},_={},h=Promise.resolve(),w={claude:null,codex:null},S=!1,F=null,z={},V="",oe="",M=!1,D=!1,q=!1,K=null,T=!1;function U(){let I=t.queue?t.queue():null;return rn(I)?I:null}function W(){let I=U();return I?I.runner_catalog:null}function we(){let I=U();return I&&rn(I.execution_defaults)?I.execution_defaults:null}function he(){let I=t.implPresetStore?.get();return rn(I)&&Array.isArray(I.presets)?I:null}function pe(){return r===null?{}:{root_dir:r}}async function H(I,Z){return T||!n?null:await n(I,Z)}function Ce(I){I&&rn(I.queue)&&t.onQueueAdopt?.(I.queue)}async function Re(I,Z){let re=U();if(!re||T)return null;let R=await H(I,{...Z,...pe(),expected_revision:re.revision});if(Ce(R),r!==null&&R&&R.conflict){let G=R.queue&&typeof R.queue.revision=="number"?R.queue.revision:U()?.revision??re.revision;R=await H(I,{...Z,...pe(),expected_revision:G}),Ce(R)}return R}async function ue(){l=!0,_e();try{let I=await H("get-session-defaults",{...pe()});o=rn(I?.values)?{...I.values}:{},a={...o},i=Array.isArray(I?.warnings)?I.warnings:[]}catch(I){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}finally{l=!1,_e()}}async function ie(){let I=Ou(o,a);if(Object.keys(I).length!==0){try{let Z=await H("set-session-defaults",{values:I,...pe()});o=rn(Z?.values)?{...Z.values}:{},a={...o},i=Array.isArray(Z?.warnings)?Z.warnings:[]}catch(Z){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${Z instanceof Error?Z.message:String(Z)}`)}_e()}}function Ae(I,Z){if(!rn(I))return;let re=I.state;u={state:re==="usable"||re==="unusable"||re==="absent"?re:"absent",values:rn(I.values)?{...I.values}:{},warnings:Array.isArray(I.warnings)?I.warnings:[]},_={...u.values},Z&&(d={..._})}async function $e(){try{Ae(await H("get-workspace-accounts",{...pe()}),!0)}catch(I){u={state:"unusable",values:{},warnings:["kv_read_failed"]},_={},d={},s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${I instanceof Error?I.message:String(I)}`)}_e()}async function Y(I){try{let Z=await fetch(I);if(!Z.ok)return null;let re=await Z.json();if(!rn(re)||!Array.isArray(re.accounts))return null;let R=re.accounts.filter(G=>rn(G)&&typeof G.key=="string"&&G.key.length>0&&typeof G.email=="string"&&G.email.length>0);return{accounts:R,active:R.find(G=>G.active===!0)||null}}catch{return null}}async function X(){S=!0;let[I,Z]=await Promise.all([Y("/api/claude-usage"),Y("/api/codex-usage")]);T||(w={claude:I,codex:Z},_e())}function ye(){let I={};for(let Z of lh){let re=Object.hasOwn(d,Z)?d[Z]:null,R=Object.hasOwn(_,Z)?_[Z]:null;re!==R&&(I[Z]=re)}return I}async function me(){let I=ye();if(Object.keys(I).length!==0){try{Ae(await H("set-workspace-accounts",{values:I,...pe()}),!1)}catch(Z){s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${Z instanceof Error?Z.message:String(Z)}`)}_e()}}function Be(I,Z){Z===Ht?delete d[I]:d[I]=Z,_e(),h=h.then(()=>me())}function ae(I,Z){if(ih.includes(I)){P(I,Z);return}Z===Ht?delete a[I]:a[I]=Z,_e(),ie()}function Ze(){let I=bt().orchestration_model,Z=nn({global:{orchestration_model:I??void 0},execution_defaults:we(),runner_catalog:W()}).orchestration_model.value;return Z?$n(W(),Z):null}function it(I,Z){typeof Z=="string"&&Z.length>0?a[I]=Z:delete a[I]}function P(I,Z){let re=Z===Ht?void 0:Z,R=Cu({impl_runtime:I==="impl_runtime"?re:a.impl_runtime,impl_model:I==="impl_model"?re:a.impl_model,impl_effort:I==="impl_effort"?re:a.impl_effort},W(),Ze());it("impl_runtime",R.impl_runtime),it("impl_model",R.impl_model),it("impl_effort",R.impl_effort),_e(),ie()}async function fe(){let I=U();if(!I)return;let Z={orchestration_model:I.orchestration_model??null,orchestration_effort:I.orchestration_effort??null,orchestration_speed:I.orchestration_speed??null},re=Lu(Z,{...Z,...z});if(Object.keys(re).length!==0){try{let R=await Re("worker-queue-set-orchestration-defaults",{values:re});if(R&&R.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}z={}}catch(R){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${R instanceof Error?R.message:String(R)}`)}_e()}}function ve(I,Z){z[I]=Z===Ht?null:Z,_e(),fe()}function Se(I){if(F=I,!I){_e();return}let Z=W(),re=bt(),R=re.orchestration_model;R&&!ks(Z,I).includes(R)&&(z.orchestration_model=null,R=null);let G=re.orchestration_effort;G&&!mi(Z,I,R||dn).includes(G)&&(z.orchestration_effort=null),_e(),fe()}async function He(I){if(!(!U()||I<Zo)){try{await Re("worker-queue-set-slots",{slots:I})}catch(Z){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${Z instanceof Error?Z.message:String(Z)}`)}_e()}}async function qe(I){if(!(!U()||I<Zo||I>ch)){try{await Re("worker-queue-set-serial-lane-count",{count:I})}catch(Z){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${Z instanceof Error?Z.message:String(Z)}`)}_e()}}async function Ve(I,Z){let re=I==="auto_advance"?"worker-automation-toggle":I==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await Re(re,{on:Z})}catch(R){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${R instanceof Error?R.message:String(R)}`)}_e()}function tt(){let I={},Z=bt();for(let re of Ro){let R=Fn.includes(re)?Z[re]:a[re];typeof R=="string"&&R.length>0&&(I[re]=R)}return I}async function $t(){let I=he();if(!I)return;let Z=tt();if(Object.keys(Z).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let re=(I.presets||[]).find(G=>G.id===V),R=oe.trim()||(re?re.name:"");if(!R){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let G=re?await H("impl-preset-update",{expected_revision:I.revision,id:re.id,name:R,settings:Z}):await H("impl-preset-create",{expected_revision:I.revision,name:R,settings:Z});if(G&&G.applied){if(oe="",!re&&Array.isArray(G.presets)){let xe=G.presets.find(A=>A.name===R);V=xe?xe.id:V}_e()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),_e()}catch(G){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${G instanceof Error?G.message:String(G)}`)}}async function _t(){let I=he();if(!(!I||V.length===0))try{let Z=await H("impl-preset-delete",{expected_revision:I.revision,id:V});Z&&Z.applied?(V="",_e()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),_e())}catch(Z){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${Z instanceof Error?Z.message:String(Z)}`)}}function J(I){o=rn(I.values)?{...I.values}:{},a={...o},i=Array.isArray(I.warnings)?I.warnings:[],rn(I.queue)&&(t.onQueueAdopt?.(I.queue),z={})}async function Q(){let I=he(),Z=U();if(!I||!Z||V.length===0)return;let re=R=>({preset_id:V,expected_revision:I.revision,expected_queue_revision:R,...pe()});try{let R=await H("apply-impl-preset-global",re(Z.revision));if(R&&R.applied&&J(R),r!==null&&R&&R.queue_applied===!1){let G=R.queue&&typeof R.queue.revision=="number"?R.queue.revision:U()?.revision??Z.revision;R=await H("apply-impl-preset-global",re(G)),R&&R.applied&&J(R)}R&&R.applied?R.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):R&&R.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(R){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${R instanceof Error?R.message:String(R)}`)}_e()}async function Le(){D=!0,q=!1,_e();try{let I=await H("get-worker-system-prompt",{});!I||typeof I!="object"||Array.isArray(I)?q=!0:K=I}catch{q=!0}finally{D=!1,_e()}}function Je(){if(M=!M,M&&!K){Le();return}_e()}function Ie(){let I=Pr({loading:D,error:q});if(I)return I;if(!K)return"";let Z=Array.isArray(K.variants)?K.variants:[];return c`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${M?Ie():""}
    </section>`}function ze(I,Z,re,R,G,xe,A){let g=G[I]??Ht,k=gi(I,re,G,we(),W(),A),j=k.options.find(te=>te.value===g),ne=g===Ht?k.full_value:j?.full_value;return c`<select
    ...
    >
    ...
    </div>`}function st(I,Z){let re=Z?Z.active:null;return rn(re)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${I==="claude"?re.email:qr({...re,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function nt(I,Z,re){let R=w[re],G=Object.hasOwn(d,I)?d[I]:Ht,xe=re==="claude"?No:qr,A=!!R?.accounts.some(g=>g.key===G);return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${Z}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${Z}
    ...
    </div>`}function bt(){let I=U(),Z={};for(let re of Fn)Z[re]=Object.prototype.hasOwnProperty.call(z,re)?z[re]:I&&typeof I[re]=="string"?I[re]:null;return Z}function Ge(){let I=W(),Z=a.impl_runtime,re=a.impl_model,R=he(),G=U(),xe=bt(),A=ks(I,F),g=Dr(I,void 0).filter(De=>De!==dn),k=mi(I,F,xe.orchestration_model||dn).filter(De=>De!==dn),j=V?(R?.presets||[]).find(De=>De.id===V):null,ne=j?Ru(tt(),rn(j.settings)?j.settings:{}):null,te=G&&typeof G.slots=="number"?G.slots:Zo+1,be=G&&typeof G.serial_lane_count=="number"?G.serial_lane_count:Zo,Ee=we()?.supported===!0,et=mt(),dt=gi("workflow_mode",vs,a,we(),I);return c`
      ...
      ${l?c`<div class="settings-dialog__empty">불러오는 중…</div>`:c`
            ...
            ${ke()}
          `}
    `}function _e(){T||Ye(Ge(),e)}return{load(){z={};let I=[ue(),$e()];return S||I.push(X()),Promise.all(I).then(()=>{})},render:_e,sessionDraft:()=>({...a}),destroy(){T=!0,Ye(c``,e)}}}function Xo(e){return c`<svg
    class="mon-i"
    viewBox="0 0 16 16"
    aria-hidden="true"
    fill="none"
  ...
  >
    ...
    >
      ...
      >
        ${md()}
      </button>`}function he(Y){let X=dh(Y);return X?c`<div class="mon2-deck__chips">
      ...
      ${X.worker?c`<span class="mon2-deck__chip" title=${X.worker.title}
          ...
          >`:""}
    </div>`:""}function pe(Y){let X=[];for(let[ye,me]of[["queue","\uB300\uAE30"],["pr_wait","PR"],["session_active","\uC138\uC158"]]){let Be=Ri(Y,ye);Be>0&&X.push(`${me} ${Be}`)}return X.join(" \xB7 ")}function H(Y){let X=Ri(Y,"running"),ye=typeof Y.slots=="number"?Y.slots:1;return c`<div
    ...
    </div>`}function Ce(Y){let X=t.doneItems?t.doneItems():[],ye=t.rangeLabel?t.rangeLabel():"",me=hd(Array.isArray(X)?X:[]),Be=ae=>Y.reduce((Ze,it)=>Ze+Ri(it,ae),0);return c`<div class="mon2-deck__bar">
      <span
...
`):""}
    ...
    >
      ...
      <div class="worker-lanes mon2-lanes">
        ${Zh.map($=>{let N=b[$.lane],ee=$.lane==="runnable"?W.runnable_flat?N.length>0?Le():void 0:W.runnable_sections.length>0?Le():void 0:$.lane==="queue"?W.queue_groups.length>0||W.chain_lanes.length>0||W.parallel_rows.length>0?St():void 0:$.lane==="running"?kt(v):N.length>0?c`${N.map(ge=>Kn(ge))}`:void 0;return hn({id:`monitor-${$.lane}`,lane:$.pane,title:$.lane==="done"?`\uC644\uB8CC\xB7${K()}`:$.title,items:N,empty:$.empty,body:ee,live:$.lane==="running"&&N.length>0,controls:$.lane==="runnable"?bt():void 0,header_control:Ge($.lane,N.length)})})}
  ...
  `}var eb=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function rp(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(H=>ce(H,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",l=!1,u="",d=null;function _(){if(d)return d;let H=a.querySelector('[data-pane="execution"]');return H?(d=Qo(H,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:Ce=>t.queueStore?.set?.(Ce)}),d):null}function h(){return c`
      <section
    ...
    `}function w(){let H=r.get();return c`
      ...
      >
        ...
        ${H?c`
              ${ep(H,s(),V)}
              ${tp(H,u,{onDraft:Ce=>{u=Ce},onAdd:oe,onRemove:M})}
              ${np(H,D)}
            `:c`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function S(H){let Ce=r.get();if(Ce)try{let Re=await n("display-policy-set",{expected_revision:Ce.revision,policy:H(Ce)});F(Re),Re&&Re.conflict&&Re.policy&&(Re=await n("display-policy-set",{expected_revision:Re.policy.revision,policy:H(Re.policy)}),F(Re)),Re&&Re.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function F(H){H&&H.policy&&typeof H.policy=="object"&&r.set(H.policy)}function z(H){S(H)}function V(H){let Ce=r.get();if(!Ce)return;let Re=!tb(H,Ce);z(ue=>nb(H,ue,Re))}function oe(){let H=u.trim();H.length!==0&&(u="",z(Ce=>Ce.hidden_prefixes.includes(H)?{hidden_prefixes:Ce.hidden_prefixes}:{hidden_prefixes:[...Ce.hidden_prefixes,H]}),q())}function M(H){z(Ce=>({hidden_prefixes:Ce.hidden_prefixes.filter(Re=>Re!==H)}))}function D(H){let Ce=r.get();if(!Ce)return;let Re=Ce.chips[H]===!1;z(()=>({chips:{[H]:Re}}))}function q(){Ye(c`
    ...
    </span>`}function q(ue,ie,Ae){let $e=ie.available&&typeof ie.ageSeconds=="number"&&ie.ageSeconds>op,Y=$e&&typeof ie.ageSeconds=="number"?`${Math.floor(ie.ageSeconds/60)}\uBD84 \uC804 \uCE21\uC815`:"",X=ie.accounts.filter(ae=>!ae.active).length,ye=`usage-meter__group${$e?" usage-meter__group--stale":""}`,me=c`<span class="usage-meter__provider"
        >${ue.label}</span
      >
    ...
    </span>`}function T(ue,ie){let Ae=cp(ue.pct),$e=ip(ue.resetsAt,ie);return c`<span
      class="usage-meter__account-window ${lp(Ae)}"
      style=${`--progress: ${Ae}%`}
    >
      ...
      <span class="usage-meter__account-reset"
        >${$e.length>0?`\u21BB ${$e}`:""}</span
      >
    </span>`}function U(ue,ie){return ob.includes(ie)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${ue.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function W(ue,ie,Ae){let $e=ie.status==="ok",Y=typeof ie.ageSeconds=="number"&&ie.ageSeconds>op,X=a.get(dp(ue.key,ie.number)),ye=r.get(ue.key),me=ye!==void 0,Be=ye===ie.number,ae=["usage-meter__account"];return ie.active&&ae.push("usage-meter__account--active"),$e||ae.push("usage-meter__account--unavailable"),Y&&ae.push("usage-meter__account--stale"),c`<div class=${ae.join(" ")}>
...
`):[];return c`<div
    ...
    </div>`}function w(){Ye(h(),r)}async function S(){if(o!=="ready")return;let q=await cn(a);ce(q?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",q?"success":"error")}function F(q){q.key==="Escape"&&s&&(q.preventDefault(),M())}function z(){d||(document.addEventListener("keydown",F),d=!0)}function V(){d&&(document.removeEventListener("keydown",F),d=!1)}async function oe(q,K=null){let T=++l;z(),s={...q},u=K||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",w(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let W=t?t():"";if(!W){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",w();return}if(!n){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",w();return}let we="/api/repo-ops-script?workspace="+encodeURIComponent(W)+"&lane="+encodeURIComponent(q.lane)+"&base_sha="+encodeURIComponent(q.base_sha);try{let he=await n(we),pe=await he.json().catch(()=>({}));if(T!==l)return;if((t?t():"")!==W){M();return}if(!he.ok||!pe||pe.ok!==!0){o="error",i=vb(pe&&typeof pe.error=="string"?pe.error:""),w();return}s={lane:pe.lane,base_sha:pe.base_sha,path:pe.path,base_ref:pe.base_ref},a=String(pe.content),o="ready",w()}catch{if(T!==l)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",w()}}function M(){l+=1,V(),s=null,a="",w();let q=u;u=null,q?.isConnected&&q.focus()}function D(){M(),r.remove()}return{open:oe,close:M,destroy:D}}function kp(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let T=o();return typeof T.revision=="number"?T.revision:0}function i(T){t&&T&&T.queue&&typeof T.queue=="object"&&t.set(T.queue)}function l(){let T=o().workspace_info;return T&&typeof T=="object"?T:{}}function u(T,U){return c`<span
...
`),live:e.auto_resolution.live===!0});if(e.head_review&&e.head_review.state!=="failed")return n("\uB9AC\uBDF0 \uC9C4\uD589 \uC911",{title:e.head_review.badge,live:e.head_review.live===!0});if(e.recovery?.lock_actions)return n(e.recovery.badge,{title:e.recovery.title,live:!0});if(e.cleanup_failed)return n(e.cleanup_label?`\uC815\uB9AC \uBA48\uCDA4 \xB7 ${e.cleanup_label}`:"\uC815\uB9AC \uBA48\uCDA4",{title:e.cleanup_failed.reason||"",alert:!0});if(e.base_exception)return n("\uB2E4\uB978 base \uB300\uC0C1",{title:e.base_exception,alert:!0});if(e.conflicting)return n("\uCDA9\uB3CC \uD574\uACB0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="base_behind")return n("base \uAC31\uC2E0 \uD544\uC694",{alert:!0});if(e.gate?.reason==="review_receipt_missing"||e.gate?.reason==="review_receipt_stale")return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:e.gate.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2C8\uAC70\uB098 \uC870\uC0C1 \uD655\uC778\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4 \u2014 \uD788\uC2A4\uD1A0\uB9AC \uC7AC\uC791\uC131\xB7\uBE0C\uB79C\uCE58 \uB9AC\uC14B \uBCF5\uAD6C \uACBD\uB85C\uB85C, \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC601\uC218\uC99D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uAD00\uCE21\uB41C \uCD5C\uC885 head \uC804\uCCB4\uB97C \uB9AC\uBDF0\uD574\uC57C \uBA38\uC9C0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4",alert:!0});if(e.gate?.reason==="spec_id_missing")return n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0});if(e.gate?.reason==="review_receipt_invalid")return n("\uB9AC\uBDF0 \uAE30\uB85D \uC624\uB958",{title:"review_receipt_invalid",alert:!0});if(Mp(e.receipt_check).length>0)return n("\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694",{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${Mp(e.receipt_check).join(", ")}`,alert:!0});if(e.head_review?.state==="failed"){let r=Jb(e.head_review.failure_reason);return n(`\uB9AC\uBDF0 \uC2E4\uD328: ${r.label}`,{title:e.head_review.failure_reason?`${r.action} (${e.head_review.failure_reason})`:r.action,alert:!0})}return e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Pp(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Pp(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function uy(e,t,n,r,s=null,o=null,a=null,i=!1,l=null,u=!0,d=null,_=null,h=null,w={},S=!1,F=!1,z={}){let V=!!l&&l.position>0,oe=!!l?.continuation_action&&l.continuation_action.continuation===null,M=!!l&&l.active===!0,D=l&&l.failure||null,q=ty(l?l.waiting:null,h),K=n[e]||null,T=K&&K.gate?K.gate:null,U=K&&K.pr?K.pr:null,W=ny(l?l.resolution:null),we=ry(l?l.head_review:null),he=l&&l.head_review||null,pe=ay(h,he),H=ly(h,pe),Ce=l&&l.authority||null,Re=!!he&&["pending","reviewing","revising"].includes(he.state),ue=!!h&&typeof h=="object"&&oy.has(h.phase),ie=V&&!M&&(he?.state==="failed"||!Ce||ue||Ce.source==="automatic"&&!F),Ae=a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":W?W.badge:a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":q,$e=!!T&&T.base_badge==="\uCDA9\uB3CC",Y=!!T&&T.enabled===!0,X=Rs({bead_id:e,merge_sha:z.merge_sha,cleanup_cursor:z.cleanup_cursor,merge_progress:o&&o.merge_progress?o.merge_progress:null,cleanup_failed:r,repo_operations:z.repo_operations}),ye=ra(X),me=!!r&&["child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!T&&T.tier==="merged",Be=i&&!!r&&!!T&&T.tier==="merged",ae=ie&&(Y||$e||T?.reason==="base_behind"||T?.reason==="review_receipt_missing"||T?.reason==="review_receipt_stale"||me||Be),Ze=i&&$e&&u===!1,it=xn(w,e,{external:i,merge_active:M||X?.step==="merge",merge_queued:V,conflict_active:!!a,cleanup_active:ye,merged:!!r||T?.tier==="merged"}),P=!!it.operation,fe=!me&&!!r&&r.step==="repo_operations",ve=cy({continuation_required:oe,merge_step:X,conflict_badge:Ae,conflict_live:W?.live===!0||a==="running",head_review:he&&we?{...we,state:he.state,failure_reason:he.failure_reason}:null,auto_resolution:pe,recovery:H,cleanup_failed:r,cleanup_label:r?mr(r.step):null,base_exception:_,conflicting:$e,gate:T,receipt_check:K&&K.receipt_check?K.receipt_check:null,queue_failure:D,auto_skip:d,queued:V,queue_active:M,queue_position:l?l.position:0,activity:Ae?null:o&&o.activity||null}),Se=ve?.live===!0&&ve.title?c`<span title=${ve.title}>${ve.label}</span>`:ve?.label||null;return{id:e,title:i?c`${t}<span class="muted"> · 세션</span>`:t,reason:r&&X?.active!==!0?na(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:S,external:i,pr_number:U&&typeof U.number=="number"?U.number:null,pr_url:U&&typeof U.url=="string"?U.url:"",completion_badge:ve?.live!==!0&&ve?.title?ve.label:null,completion_title:ve?.title||"",completion_repair_pr_url:H?H.repair_pr_url:"",completion_repair_pr_number:H?H.repair_pr_number:null,badges:Se?[Se]:[],live_badge:ve?.live===!0?Se:null,usage:s,alert:ve?.alert===!0,merge_action:T?.tier==="merged"&&!me&&!Be||fe?!1:!V||oe||ie,timeline_action:fe,cancel_action:V&&!oe,cancel_enabled:(!M||Re)&&!(H&&H.lock_actions),cancel_title:H&&H.lock_actions?`${H.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:M&&!Re?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":Re?"review \uC9C4\uD589\uC744 \uCDE8\uC18C\uD558\uACE0 \uBA38\uC9C0 \uAD8C\uD55C\uC744 \uD3D0\uAE30\uD569\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:it,discard_action:it.action,merge_step:X,discard_enabled:it.enabled,discard_title:it.title,merge_enabled:!X&&!a&&!P&&!_&&!(H&&H.lock_actions)&&!Ze&&!fe&&(Y||$e||T?.reason==="base_behind"||T?.reason==="review_receipt_missing"||T?.reason==="review_receipt_stale"||me||Be||ae||ue&&!M),merge_label:oe?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":me||Be?"\uC815\uB9AC \uC7AC\uAC1C":$e&&!X&&!me?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":T?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":T?.reason==="review_receipt_missing"||T?.reason==="review_receipt_stale"?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":ie?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:P?it.error?`\uD3D0\uAE30 \uC2E4\uD328: ${it.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${it.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:oe?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":X?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${X.label}`:Be?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":Ze?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":a==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":a==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":me?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":$e?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":T?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":T?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":T?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uC790\uB3D9 \uC7AC\uB9AC\uBDF0 \uC138\uC158 \uD6C4 \uC2B9\uC778\uB418\uBA74 \uBA38\uC9C0\uD569\uB2C8\uB2E4":T?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":Y?`\uBA38\uC9C0 (${T.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:T&&T.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${T&&T.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Vi(e,t={}){let{transport:n,issueStores:r,queueStore:s,analysisStore:o,sessionLogStore:a,uiOrderStore:i,gotoIssue:l,getWorkspacePath:u,openDoc:d,doneRange:_,onDoneRangeChange:h}=t,w=r?Js(r,i):null,S=ro({transport:n,uiOrderStore:i}),F=null,z=[],V=qb(),oe=null,M=null,D={members_by_id:new Map,serial_raw_lengths:{},serial_lane_count:0,occupied_lanes:new Set},q=Wb(),K=_n(_)?_:Hb(),T=new Map;function U(){let p=Wn.find(y=>y.value===K);return p?p.label:"\uC624\uB298"}let W=Kb(),we=!1,he=new Set,pe=new Set,H=new Set,Ce=new Set,Re=new Set,ue={},ie=null,Ae=0,$e=null,Y=[];function X(p){return ie===p?ue:{}}async function ye(){if(!n)return;let p=u?.()||"";if(ie===p||$e&&$e.key===p&&$e.generation===Ae)return;let y=++Ae;$e={key:p,generation:y};let f=null;try{f=await Promise.resolve(n("get-session-defaults",{}))}catch(C){if(y!==Ae)return;$e=null,Ob("get-session-defaults failed: %o",C),We();return}y===Ae&&(ue=f&&typeof f.values=="object"&&f.values!==null?{...f.values}:{},ie=p,$e=null,We())}function me(){ie=null,Ae+=1,ye()}let Be=document.createElement("div");Be.className="worker-console";let ae=document.createElement("div");ae.className="worker-top";let Ze=document.createElement("div");Ze.className="worker-drawer-overlay",Ze.hidden=!0;let it=document.createElement("div");it.className="worker-drawer-overlay__backdrop";let P=document.createElement("div");P.className="worker-drawer-host";let fe=document.createElement("div");fe.className="worker-drawer-host",fe.hidden=!0,Ze.append(it,P,fe);let ve=document.createElement("div");ve.className="worker-lanes-host",Be.append(ae,Ze,ve),e.appendChild(Be);let Se=null,He=null,qe=Mr(P,{transport:n,sessionLogStore:a,onClose:()=>{Se=null,He=null,Ze.hidden=!0,We()}}),Ve=Cp(fe,{onClose:()=>{fe.hidden=!0,Ze.hidden=!0,We()}}),tt=wp({getWorkspacePath:u||(()=>"")}),$t=u&&u()||"",_t=kp({queueStore:s,transport:n,onChanged:()=>We(),onOpenScript:(p,y)=>{tt.open(p,y)}}),J=o?gp(Be,{queueStore:s,analysisStore:o,transport:n,getWorkspacePath:u,onOpenTranscript:(p,y)=>Me(p,y)}):null;function Q(){return s&&s.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:oa,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function Le(){let p=Q(),y=typeof p.serial_lane_count=="number"&&Number.isInteger(p.serial_lane_count)&&p.serial_lane_count>0?Math.min(p.serial_lane_count,5):0,f=Array.isArray(p.serial_lanes)?p.serial_lanes:[],C=[];for(let le of f){if(C.length>=y)break;!le||typeof le.id!="string"||!/^s[1-5]$/.test(le.id)||!Array.isArray(le.entries)||C.push({id:le.id,label:`\uC9C1\uB82C ${le.id.slice(1)}`,count:le.entries.length})}return C.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(p.queue)?p.queue:[]).length},...C]}function Je(p){if(!oe||!p.some(f=>f.id===oe))return null;let y=Le();return y?{bead_id:oe,lanes:y}:null}function Ie(){let p=Q();return typeof p.revision=="number"?p.revision:0}function ke(p){p&&p.queue&&s&&s.set(p.queue)}function ze(){let p=Q().queue;return Array.isArray(p)?p.length:0}async function Qe(p,y,f){if(!n)return;let C=()=>({bead_id:p,...y==="parallel"?{}:{lane:y},...f===void 0?{}:{index:f},expected_revision:Ie()}),E=await n("worker-queue-place",C());ke(E),E&&E.conflict&&await n("worker-queue-place",C()).then(ke)}async function st(p,y,f){if(!n)return;let C=()=>({bead_id:p,...y==="parallel"?{}:{lane:y},to_index:f,expected_revision:Ie()}),E=await n("worker-queue-reorder",C());ke(E),E&&E.conflict&&await n("worker-queue-reorder",C()).then(ke)}async function nt(p){if(!n)return;let y=await n("worker-queue-remove",{bead_id:p,expected_revision:Ie()});ke(y),y&&y.conflict&&await n("worker-queue-remove",{bead_id:p,expected_revision:Ie()}).then(ke)}async function mt(p){if(!n||!p)return;let y=await n("worker-attempt-pause",{attempt_id:p});y&&y.paused===!1&&y.reason&&ce(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${y.reason}`,"error",2400)}async function xt(p){if(!n||!p)return;let y=await Or();if(y===null)return;let f=async(E={})=>await n("worker-attempt-resume",{attempt_id:p,expected_revision:Ie(),...y!==""?{instructions:y}:{},...E}),C=await f();ke(C),C&&C.conflict&&(C=await f(),ke(C)),C=await Ln(C,(E,le)=>f({continuation:E,decision_token:le}),{onResult:ke,refresh:()=>f()}),C&&C.resumed===!1&&!C.conflict&&C.reason&&ce(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${C.reason}`,"error",2400)}async function St(p){if(!n||!p)return;let y=await n("worker-attempt-dismiss",{attempt_id:p,expected_revision:Ie()});ke(y),y&&y.conflict&&(y=await n("worker-attempt-dismiss",{attempt_id:p,expected_revision:Ie()}),ke(y)),y&&y.dismissed===!1&&!y.conflict&&y.reason&&ce(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${y.reason}`,"error",2400)}async function kt(p,y,f=!0){if(!n)return null;let C=n,E=await C(p,{...y,expected_revision:Ie()});return ke(E),E&&E.conflict&&f&&(E=await C(p,{...y,expected_revision:Ie()}),ke(E)),E}async function Ot(p){if(!n||!p)return;let y=Q().merge_queue?.find(C=>C.bead_id===p)?.continuation_action;if(y?.mismatch&&y.continuation===null){await Ge(p,y.mismatch);return}he.add(p),We();let f;try{f=await kt("worker-merge-queue-add",{bead_id:p})}catch{ce("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{he.delete(p),We()}if(!(!f||f.applied)){if(f.conflict){ce("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}ce(ey(f.reason),"error",2400)}}async function bt(p){if(!(!n||!p||pe.has(p))){pe.add(p),We();try{let y=await n("worker-cleanup-retry",{bead_id:p,expected_revision:Ie()});ke(y),y&&!y.retried&&!y.conflict&&y.reason&&ce(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${y.reason}`,"error",2400)}finally{pe.delete(p),We()}}}async function Ge(p,y){let f=await Ln({continuation_mismatch:y},(E,le)=>kt("worker-merge-queue-add",{bead_id:p,continuation:E,decision_token:le},!1)),C=f?.queue?.merge_queue?.find(E=>E.bead_id===p)?.continuation_action;if(f?.applied!==!0&&C?.continuation===null&&C.mismatch){await Ge(p,C.mismatch);return}f&&f.applied===!1&&!f.conflict&&ce("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function _e(p){if(!n)return;let y=await kt("worker-merge-auto-toggle",{on:p});!y||y.conflict||ce(p?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",p?"success":"info",2400)}async function I(p){if(!n||!p)return;let y=await kt("worker-merge-queue-remove",{bead_id:p});y&&!y.conflict&&!y.applied&&y.reason==="merge_active"&&ce("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function Z(){await kt("worker-merge-queue-remove",{all:!0})}async function re(p,y=null,f="unmerged",C=null){if(!n||!p)return;let E=Ss(p,f);if(!(!!C||typeof globalThis.confirm!="function"||globalThis.confirm(E)))return;let Te=await n("worker-discard",{bead_id:p,...y?{attempt_id:y}:{},...C?{operation_id:C}:{},expected_revision:Ie()});if(ke(Te),Te&&Te.conflict&&(Te=await n("worker-discard",{bead_id:p,...y?{attempt_id:y}:{},...C?{operation_id:C}:{},expected_revision:Ie()}),ke(Te)),Te&&Te.discarded===!0){ce(Go(Te),"success",5e3);return}if(Te&&Te.reason){ce(`\uD3D0\uAE30 \uC2E4\uD328: ${Te.reason}`,"error",2800);return}if(Te&&Te.accepted&&Te.pending==="merged_revert"){ce("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(Te&&Te.accepted&&!Te.discarded){ce(`\uD3D0\uAE30 \uC9C4\uD589: ${Te.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}Te&&!Te.conflict&&ce("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function R(p,y,f){if(!(!n||!y||!f||Ce.has(y))){Ce.add(y),We();try{let C=await n(p,{bead_id:y,action_id:f,expected_revision:Ie()});ke(C),C?.conflict?ce("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!C?.ok&&C?.reason&&ce(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(C.reason)}`,"error",2800)}finally{Ce.delete(y),We()}}}async function G(p,y){if(!n||!y||H.has(y))return;H.add(y),We();let f;try{let C=async(E={})=>await n(p,{bead_id:y,expected_revision:Ie(),...E});f=await C(),ke(f),f&&f.conflict&&(f=await n(p,{bead_id:y,expected_revision:Ie()}),ke(f)),p==="worker-revise-fix"&&(f=await Ln(f,(E,le)=>C({continuation:E,decision_token:le}),{onResult:ke,refresh:()=>C()}))}finally{H.delete(y),We()}if(!(!f||f.conflict)){if(f.ok){ce(p==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}ce(`\uCC98\uBD84 \uAC70\uBD80: ${f.reason||""}`,"error",3e3)}}async function xe(p){if(!n)return;let y=await n("worker-automation-toggle",{on:p,expected_revision:Ie()});ke(y),y&&y.conflict&&await n("worker-automation-toggle",{on:p,expected_revision:Ie()}).then(ke)}async function A(p){if(!n||!p)return;let y=await n("worker-repo-operation-repair",{operation_id:p});if(ke(y),y&&y.ok===!1){ce(`\uD574\uACB0 \uC138\uC158 \uAC70\uBD80: ${y.reason||""}`,"error",3e3);return}y&&y.ok===!0&&ce("\uD574\uACB0 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4","success",2400)}async function g(p){if(!n||!p)return;let y=await n("worker-repo-operation-dismiss",{operation_id:p});ke(y),y&&y.ok===!1&&ce(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${y.reason||""}`,"error",3e3)}async function k(p){if(!n||!Number.isFinite(p))return;let y=Math.max(oa,Math.floor(p)),f=await n("worker-queue-set-slots",{slots:y,expected_revision:Ie()});ke(f),f&&f.conflict&&await n("worker-queue-set-slots",{slots:y,expected_revision:Ie()}).then(ke)}async function j(p){if(!n||!Number.isInteger(p)||p<1||p>Rp)return;let y=Q(),f=(Array.isArray(y.serial_lanes)?y.serial_lanes:[]).slice(p).reduce((le,Te)=>le+(Array.isArray(Te?.entries)?Te.entries.length:0),0),C=()=>({count:p,expected_revision:Ie()}),E=await n("worker-queue-set-serial-lane-count",C());ke(E),E&&E.conflict&&(E=await n("worker-queue-set-serial-lane-count",C()),ke(E)),E&&E.applied&&f>0&&ce(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${f}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}let ne="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function te(p,y){let f=zi(p,y.id,D);return{id:y.id,title:y.title,location_label:y.location_label,prefixes:y.prefixes,action:f.kind==="note"?{kind:"note",text:f.text}:f.kind==="disabled"?{kind:"disabled",label:ne,title:f.title}:{kind:"place",label:ne,title:f.title}}}function be(p,y){if(!M||M.bead_id!==p)return null;let f=M.counterpart_id,C=y.filter(E=>E.id===f);return C.length===0?null:{rows:C.map(E=>te(p,E))}}async function Ee(p,y){let f=zi(p,y,D);if(M=null,f.kind!=="ops"){We();return}let C=Ie();for(let E of f.ops){let le=await et(E,C);if(le===null)break;C=le}We()}async function et(p,y){if(!n)return null;try{let f=await n("worker-queue-place",{bead_id:p.bead_id,lane:p.lane,index:p.index,expected_revision:y});if(ke(f),f&&f.conflict)return ce("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!f||f.applied!==!0)return ce(f&&typeof f.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${f.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let C=f.queue?f.queue.revision:void 0;return typeof C!="number"?(ce("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):C}catch(f){return ce(f instanceof Error&&f.message?f.message:"\uD050 \uC694\uCCAD \uC2E4\uD328","error"),null}}function dt(){let p=Q(),y=w?w.selectBoardColumn(Lb,"ready"):[],f=w?w.selectBoardColumn(Ib,"blocked"):[],C=w?w.selectBoardColumn(Db,"closed"):[],E=w?w.selectBoardColumn(Pb,"in_progress"):[],le=w?w.selectBoardColumn(Mb,"resolved"):[],Te=to([...y,...f,...E,...le,...C]),Ue=new Map;for(let m of[...y,...f,...E])m&&m.id&&!Ue.has(m.id)&&Ue.set(m.id,m);let Xe={...X(u?.()||"")};for(let m of["orchestration_model","orchestration_effort","orchestration_speed"]){let B=p[m];typeof B=="string"&&(Xe[m]=B)}function Ke(m,B){let se=Ue.get(m);if(!se)return null;let je=se.metadata&&typeof se.metadata=="object"?se.metadata:{},at=se.workflow?.route,Tt=je.route,Pt=Lp(at)?at:Lp(Tt)?Tt:null;return nn({pin:je,global:Xe,execution_defaults:p.execution_defaults??null,runner_catalog:p.runner_catalog??null,route:Pt,controller_runtime:B})}function vt(m){let B=m.runner||null,se=Ke(m.bead_id,B),je=Es(m),at=se?Qn(se,B):null;return je||at?{orchestration:je,worker:at}:null}let sn=new Map;function Hr(m){if(sn.has(m))return sn.get(m)??null;let B=Ke(m,null),se=null;if(B){let je=$n(p.runner_catalog??null,B.orchestration_model.value??""),at=je===null?B:Ke(m,je),Tt=_r(at,p.runner_catalog??null),Pt=Qn(at,je);se=Tt||Pt?{orchestration:Tt,worker:Pt}:null}return sn.set(m,se),se}function gr(m){let B=no(Te,m);return B.total===0?null:B}let Qi=p.bead_titles||{},Jt=new Map;for(let[m,B]of Object.entries(Qi))typeof B=="string"&&B.length>0&&Jt.set(m,B);for(let m of[...y,...f])Jt.set(m.id,m.title||m.id);let Gr=new Map;for(let m of[...y,...f,...E,...le,...C])m&&m.id&&typeof m.from_id=="string"&&Gr.set(m.id,m.from_id);let Sn=new Map;for(let m of[...y,...f,...E,...le,...C])m&&m.id&&typeof m.priority=="number"&&Sn.set(m.id,m.priority);let Is=p.bead_times&&typeof p.bead_times=="object"&&!Array.isArray(p.bead_times)?p.bead_times:{},er=p.bead_labels&&typeof p.bead_labels=="object"&&!Array.isArray(p.bead_labels)?p.bead_labels:{},jn=p.bead_workflow&&typeof p.bead_workflow=="object"&&!Array.isArray(p.bead_workflow)?p.bead_workflow:{},Bn=new Map;for(let[m,B]of Object.entries(er))Array.isArray(B)&&Bn.set(m,Bi(B));for(let m of[...y,...f]){let B=m.labels;Array.isArray(B)&&!Bn.has(m.id)&&Bn.set(m.id,Bi(B))}let hr=new Map,Vr=o?.get()?.last_good?.result?.groups;for(let m of Array.isArray(Vr)?Vr:[]){if(m?.eligible!==!0||!Array.isArray(m.members))continue;let B=m.members.map(je=>{let at=(Array.isArray(p.serial_lanes)?p.serial_lanes:[]).find(Tt=>Tt.entries.some(Pt=>Pt.bead_id===je));return at?at.id:null});if(!(B.every(je=>je!==null)&&new Set(B).size===1))for(let je of m.members)hr.set(je,m.members.filter(at=>at!==je))}let Ps=p.bead_blocked_by&&typeof p.bead_blocked_by=="object"&&!Array.isArray(p.bead_blocked_by)?p.bead_blocked_by:{},br=new Map;for(let[m,B]of Object.entries(Is))B&&typeof B=="object"&&br.set(m,B);for(let m of[...y,...f])br.set(m.id,{created_at:m.created_at,updated_at:m.updated_at});let tr=m=>br.get(m)||{},Un=p.pr_wait||[],Kr=p.pr_observations||{},Fe=p.pr_activity||{},pt=p.cleanup_failed||{},on=Object.entries(pt).map(([m,B])=>({bead_id:m,step:B&&B.step?B.step:"",reason:B&&B.reason?B.reason:"",at:B&&typeof B.at=="number"?B.at:null,detail:B&&typeof B.detail=="string"?B.detail:null,output_tail:B&&typeof B.output_tail=="string"&&B.output_tail?B.output_tail:void 0,log_path:B&&typeof B.log_path=="string"&&B.log_path?B.log_path:void 0,retry_count:B&&typeof B.retry_count=="number"&&Number.isInteger(B.retry_count)&&B.retry_count>0?B.retry_count:0,failure_code:B&&typeof B.failure_code=="string"?B.failure_code:void 0,subject_id:B&&typeof B.subject_id=="string"?B.subject_id:void 0,repair_eligible:!!(B&&B.repair_eligible),repair:B&&B.repair?B.repair:void 0})),ia=p.queue||[],Xp=new Set([...ia.map(m=>m.bead_id),...(Array.isArray(p.serial_lanes)?p.serial_lanes:[]).flatMap(m=>(Array.isArray(m?.entries)?m.entries:[]).map(B=>B.bead_id)),...Un.map(m=>m.bead_id),...p.done.map(m=>m.bead_id)]),Jp=new Set(f.map(m=>m.id)),ef=i?i.get()?.order||{}:{},Xi=new Set,Ji=[];for(let m of[...y,...f])Xp.has(m.id)||Xi.has(m.id)||Qb(m)||(Xi.add(m.id),Ji.push(m));z=Zb(Ji,q,ef);let tf=p.admission||{},el=m=>{let B=tf[m];if(!B)return"";if(B.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let se=typeof B.reason=="string"?B.reason:"",je=se.indexOf(":");return je>0&&je<se.length-1?`\u26D4 ${se.slice(0,je)} (${se.slice(je+1)})`:`\u26D4 ${se}`},nf=z.map(m=>{let B=Eo(m),se=B.path.length>0,je=m.workflow?.route==="quick_fix"||m.metadata&&m.metadata.route==="quick_fix",at=!Object.hasOwn(m,"description")||typeof m.description=="string"&&m.description.trim().length>0,Tt=Object.hasOwn(m,"labels")&&mp(m.labels),Pt=!Tt&&(je?at:se&&!B.conflict),ht=Jp.has(m.id),en=[];ht&&en.push(Xb(m)),je&&!at?en.push("missing_description"):!je&&B.conflict?en.push("spec_id_conflict"):!je&&!se&&en.push("spec \uC5C6\uC74C");let Us=el(m.id);return Us&&en.push(Us),{id:m.id,title:m.title||m.id,reason:en.join(" \xB7 "),draggable:Pt,lane:"candidate",created_at:m.created_at,updated_at:m.updated_at,workflow:m.workflow,is_quick_fix:je,status:m.status,worker_ineligible:Tt,blocked:ht,has_spec:se,exec_chips:Hr(m.id),from_id:m.from_id||void 0,priority:Sn.get(m.id)}}),la=jb(nf,V),ca=la.visible,rf=p.revise_parked||{},Ms=p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},ua=(m,B)=>m.map((se,je)=>{let at=B!=="done",Tt=B!=="done"&&B!=="queue",Pt=at?rf[se.bead_id]:null,ht=at?xn(Ms,se.bead_id):null,en=ht?.operation?ht:null,Us=at&&Bn.get(se.bead_id)===!0,Rl=Ps[se.bead_id]||[],ya=p.admission&&typeof p.admission=="object"?p.admission[se.bead_id]:null,va=at?rd(ya,!!en||Ce.has(se.bead_id)):null,_f=at&&!va?el(se.bead_id):null,mf=at?[_f]:[],Ol=at&&Rl.length>0&&typeof ya?.reason=="string"&&ya.reason.startsWith("not_ready")?[`\u23F8 ${Rl.join(", ")} \uC644\uB8CC \uB300\uAE30 (blocks)`]:[],wa=at?hr.get(se.bead_id):void 0;return wa&&wa.length>0&&Ol.push(`\u2733 serial \uAD8C\uC7A5 \xB7 ${wa.join(", ")}\uC640`),{id:se.bead_id,title:Jt.get(se.bead_id)||se.bead_id,reason:mf.filter(Boolean).join(" \xB7 "),draggable:at&&!en&&!va,done:B==="done",lane:B,seq:Tt?je+1:void 0,worker_serial:Us,discard:en,stale_work:va,badges:[...Ol,...Pt?["\u23F8 REVISE \uD30C\uD0B9"]:[],...B==="done"?Wo(p.attempts||{},se.bead_id):[]],alert:!!Pt,revise_action:!!Pt,revise_enabled:!!Pt&&!en&&!H.has(se.bead_id),revise_title:Pt?Pt.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${Pt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:B==="done"?mn(p.attempts||{},se.bead_id):null,work_ms:B==="done"?zo(p.attempts||{},se.bead_id):null,done_at:B==="done"&&typeof se.added_at=="number"?se.added_at:void 0,exec_chips:at?Hr(se.bead_id):null,workflow:at&&jn[se.bead_id]||null,from_id:Gr.get(se.bead_id)||void 0,priority:Sn.get(se.bead_id),...tr(se.bead_id)}}),yr=p.attempts?Object.values(p.attempts).filter(Ur):[],da=new Set;for(let m of yr)m&&typeof m.resumed_from=="string"&&m.resumed_from.length>0&&da.add(m.resumed_from);let tl=new Map;for(let m of yr)tl.set(m.bead_id,m.attempt_id);let Yr=new Map;for(let m of yr)Yr.set(m.attempt_id,m);function pa(m){let B=new Set,se=m;for(;se&&!B.has(se.attempt_id);){if(se.conflict_resolution===!0)return!0;B.add(se.attempt_id),se=typeof se.resumed_from=="string"&&se.resumed_from.length>0&&Yr.get(se.resumed_from)||null}return!1}let Ds=typeof p.declared_base=="string"?p.declared_base:null;function sf(m){let B=null;for(let se of yr)!se||se.bead_id!==m||pa(se)||(B===null||(typeof se.started_at=="number"?se.started_at:0)>=(typeof B.started_at=="number"?B.started_at:0))&&(B=se);return B&&typeof B.target_base=="string"?B.target_base:null}let fa=[],Ns=[],of=_p(p),nl=m=>{let B=typeof m.session_id=="string"&&m.session_id.length>0,se=da.has(m.attempt_id);return{eligible:B&&!se,reason:B?se?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},bn=null;for(let m of yr){let B=m.status==="paused"&&!da.has(m.attempt_id);if(m.status==="running"||B)Ns.push({bead_id:m.bead_id,attempt_id:m.attempt_id,title:Jt.get(m.bead_id)||m.bead_id,runner:m.runner||null,model:m.model||null,effort:m.effort||null,speed:m.speed||null,continuation_mode:m.continuation_mode||null,started_at:typeof m.started_at=="number"?m.started_at:null,resumed_from:m.resumed_from||null,paused:B,conflict_resolution:pa(m),base_exception:Gi(Ds,m.target_base),can_pause:typeof m.session_id=="string"&&m.session_id.length>0,discard:xn(Ms,m.bead_id,{attempt_id:m.attempt_id}),workflow:jn[m.bead_id]||null,priority:Sn.get(m.bead_id),usage:mn(p.attempts||{},m.bead_id),rollup:gr(m.bead_id),rollup_expanded:Re.has(m.bead_id),exec_chips:vt(m),...tr(m.bead_id)});else if((m.status==="failed"||m.status==="orphaned")&&of(m)){let se=nl(m);fa.push({bead_id:m.bead_id,attempt_id:m.attempt_id,title:Jt.get(m.bead_id)||m.bead_id,runner:m.runner||null,model:m.model||null,effort:m.effort||null,speed:m.speed||null,continuation_mode:m.continuation_mode||null,started_at:typeof m.started_at=="number"?m.started_at:null,resumed_from:m.resumed_from||null,failed:!0,status:m.status,status_label:m.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:xn(Ms,m.bead_id,{attempt_id:m.attempt_id}),resume_eligible:se.eligible,resume_reason:se.reason,conflict_resolution:pa(m),base_exception:Gi(Ds,m.target_base),workflow:jn[m.bead_id]||null,priority:Sn.get(m.bead_id),usage:mn(p.attempts||{},m.bead_id),rollup:gr(m.bead_id),rollup_expanded:Re.has(m.bead_id),exec_chips:vt(m),...tr(m.bead_id)}),bn=m}}let rl=new Set([...fa,...Ns].map(m=>m.bead_id));for(let m of Array.isArray(p.session_active)?p.session_active:[]){let B=m&&m.bead_id;typeof B!="string"||B.length===0||rl.has(B)||(rl.add(B),Ns.push({bead_id:B,attempt_id:null,kind:"session",title:m.title||Jt.get(B)||B,status:"in_progress",started_at:En(m.started_at)??En(m.updated_at),updated_at:En(m.updated_at),workflow:m.workflow||null,priority:Sn.get(B),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,usage:null,rollup:null,rollup_expanded:!1}))}let vr=[...fa,...Ns].map(m=>{let B=Yr.get(m.attempt_id),se=B?.quickfix_landing;if(B?.quickfix_lane!==!0||!se||typeof se!="object")return m;let je=typeof se.reason=="string"&&se.reason.length>0?se.reason:null,at=Rs({bead_id:B.bead_id,merge_sha:se.head_sha,cleanup_cursor:se.cursor,cleanup_failed:je?{step:se.cursor,reason:je}:null,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]});return at?{...m,landing:at}:m}),sl=null;if(bn){let m=nl(bn),B=bn.cause_detail;sl={bead_id:bn.bead_id,repo:bn.repo||"",reason:bn.cause||bn.status,cause_detail:B&&typeof B.reason=="string"?{reason:B.reason,command:typeof B.command=="string"?B.command:null}:null,resume_attempt_id:bn.attempt_id,resume_eligible:m.eligible,resume_reason:m.reason,discard:xn(Ms,bn.bead_id,{attempt_id:bn.attempt_id})}}let ol=new Set(vr.map(m=>m.bead_id)),_a=Array.isArray(p.merge_queue)?p.merge_queue:[],al=new Map,il=new Map,ll=new Map,cl=new Map,ul=new Map;_a.forEach((m,B)=>{m&&typeof m.bead_id=="string"&&(al.set(m.bead_id,B+1),il.set(m.bead_id,m.resolution),ll.set(m.bead_id,m.continuation_action||null),cl.set(m.bead_id,m.head_review||null),ul.set(m.bead_id,m.authority||null))});let wr=p.merge_queue_state||{active:null,failures:{}},af=wr.failures||{},dl=wr.waiting&&typeof wr.waiting.bead_id=="string"&&typeof wr.waiting.reason=="string"?wr.waiting:null,lf=p.auto_merge_skips||{},pl=m=>{let B=lf[m];if(!B)return null;let se=Kr[m],je=se&&se.pr?se.pr.head_sha:null;return je&&je===B.head_sha?B.reason||"":null},qs=new Map;for(let m of vr)m.failed!==!0&&m.conflict_resolution&&(m.paused?qs.has(m.bead_id)||qs.set(m.bead_id,"paused"):qs.set(m.bead_id,"running"));let fl=vr.filter(m=>m.kind!=="session"&&!m.paused&&m.failed!==!0).length,_l=(p.workspace_info||{}).slots,ml=typeof _l=="number"?_l:typeof p.slots=="number"?p.slots:oa,cf=fl>ml,Fs=ir(K),uf=(Array.isArray(p.done)?p.done.slice():[]).filter(m=>Fs===void 0||typeof m.added_at!="number"||m.added_at>=Fs).sort((m,B)=>(B.added_at||0)-(m.added_at||0)),Zr=ua(uf,"done"),df=new Set((Array.isArray(p.done)?p.done:[]).map(m=>m?.bead_id).filter(m=>typeof m=="string")),gl=[],pf=u?.()||"";for(let m of C){let B=En(m.closed_at);if(typeof m.id!="string"||df.has(m.id)||B===null||Fs!==void 0&&B<Fs||typeof m.comment_count!="number"||m.comment_count<=0)continue;let se=`${pf}\0${m.id}\0${String(m.updated_at)}\0${m.comment_count}`,je=T.get(se);je===void 0&&n&&(T.set(se,"pending"),Promise.resolve(n("get-comments",{id:m.id})).then(at=>{let Tt=Array.isArray(at)&&at.some(Pt=>To(typeof Pt?.text=="string"?Pt.text:"")?.lane==="session");T.set(se,Tt?"session":"not-session"),We()}).catch(()=>{T.set(se,"failed"),We()})),je==="session"&&gl.push({id:m.id,title:m.title||m.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:B,created_at:m.created_at,updated_at:m.updated_at})}Zr.push(...gl),Zr.sort((m,B)=>(B.done_at||0)-(m.done_at||0));let js={};for(let m of In)js[m]=0;let hl=!1,bl=0,ma=0,yl=0;for(let m of Zr){let B=m.usage;if(B&&typeof B=="object"){let se=!1;for(let je of In)Number.isFinite(B[je])&&(js[je]+=B[je],hl=!0,se=!0);se&&(ma+=1,Number.isFinite(B.total_cost_usd)&&(bl+=B.total_cost_usd,yl+=1))}}ma>0&&yl===ma&&(js.total_cost_usd=bl);let vl=Zr.map(m=>m.usage).filter(m=>m&&typeof m=="object"&&m.providers),ff=vl.length>0?zt(fo(vl)):hl?Pn(js):null,wl=p.lane_states&&typeof p.lane_states=="object"&&!Array.isArray(p.lane_states)?p.lane_states:{},kl=Array.isArray(p.serial_lanes)?p.serial_lanes:[],$l=m=>{if(Un.some(je=>je.bead_id===m))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let B=yr.filter(je=>je&&je.bead_id===m),se=B.length>0?B[B.length-1].status:null;return se==="failed"||se==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":se==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},Bs=kl.filter(m=>m&&typeof m.id=="string"&&Array.isArray(m.entries)).map((m,B)=>{let se=wl[m.id]||{},je=new Map((Array.isArray(se.corrections)?se.corrections:[]).filter(ht=>ht&&typeof ht.bead_id=="string"&&typeof ht.after=="string").map(ht=>[ht.bead_id,ht.after])),at=ua(m.entries.filter(ht=>!ol.has(ht.bead_id)),m.id).map(ht=>je.has(ht.id)?{...ht,badges:[`\u{1F517} ${je.get(ht.id)} \uB4A4 (blocks \uC790\uB3D9)`,...ht.badges]}:ht),Tt=Array.isArray(se.occupied_by)?se.occupied_by.filter(ht=>typeof ht=="string"):[],Pt=Tt.map(ht=>({id:ht,title:Jt.get(ht)||ht,draggable:!1,lane:m.id,ghost:!0,badges:[$l(ht)]}));return{id:m.id,index:B+1,rows:[...Pt,...at],occupied:Tt.length>0,badge:Tt.length>0?$l(Tt[0]):"\uB300\uAE30",cycle:se.cycle===!0}}),xl=typeof p.serial_lane_count=="number"?p.serial_lane_count:Bs.length,ga=ua(ia.filter(m=>!ol.has(m.bead_id)),"queue"),Al=new Map,Sl=new Set;for(let[m,B]of Object.entries(wl)){if(!/^s[1-5]$/.test(m))continue;let se=B&&Array.isArray(B.occupied_by)?B.occupied_by:[];for(let je of se)typeof je=="string"&&Al.set(je,m);se.length>0&&Sl.add(m)}let kr=[];for(let m of vr)typeof m.bead_id=="string"&&kr.push({id:m.bead_id,title:Jt.get(m.bead_id)||m.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:Al.get(m.bead_id)??null});for(let m of Bs)for(let B of m.rows)B.ghost!==!0&&kr.push({id:B.id,title:B.title,location_label:`${m.id} #${B.seq??""}`.trim(),kind:"serial",lane_id:m.id});ga.forEach((m,B)=>{kr.push({id:m.id,title:m.title,location_label:`#${B+1}`,kind:"parallel",lane_id:null})});for(let m of ca)kr.push({id:m.id,title:m.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let El={};for(let m of kl)m&&typeof m.id=="string"&&Array.isArray(m.entries)&&(El[m.id]=m.entries.length);let ha=new Map;for(let m of kr)ha.has(m.id)||ha.set(m.id,m);D={members_by_id:ha,serial_raw_lengths:El,serial_lane_count:xl,occupied_lanes:Sl};let Tl=hp(p.bead_scope,kr),ba=(m,B)=>{let se=Tl.get(m.id);if(!se||se.overlaps.length===0&&!se.scope_missing)return m;let je=be(m.id,se.overlaps);return m.dependency_chips={...m.dependency_chips||{},...se.overlaps.length>0?{overlaps:se.overlaps}:{},...se.scope_missing&&B!=="running"?{scope_missing:!0}:{},...je?{popover:je}:{}},m};for(let m of ga)ba(m,"queue");for(let m of Bs)for(let B of m.rows)B.ghost!==!0&&ba(B,m.id);for(let m of ca)ba(m,"candidate");let Cl=new Map;for(let m of vr){let B=typeof m.bead_id=="string"?m.bead_id:"";if(B.length===0)continue;let se=m.kind==="session",je=Tl.get(B),at=je&&je.overlaps.length>0?je.overlaps:null,Tt=typeof m.attempt_id=="string"&&m.attempt_id.length>0?Yr.get(m.attempt_id):void 0,Pt=Tt&&Tt.last_activity&&typeof Tt.last_activity=="object"?Tt.last_activity:null,ht=Tt&&Array.isArray(Tt.legs)?Tt.legs:[];if(!at&&!Pt&&ht.length===0&&!se)continue;let en=at?be(B,at):null;Cl.set(B,{...Pt?{last_activity:Pt}:{},...ht.length>0?{legs:ht}:{},...at?{dependency_chips:{overlaps:at,...en?{popover:en}:{}}}:{}})}return{queue:p,idToTitle:Jt,candidates:ca,candidate_hidden:{blocked:la.hidden_blocked,spec:la.hidden_spec},running:vr,live_count:fl,slots:ml,over_cap:cf,failure:sl,waiting:ga,serial_lanes:Bs,serial_lane_count:xl,running_overlays:Cl,pr_wait:Un.map(m=>uy(m.bead_id,Jt.get(m.bead_id)||m.bead_id,Kr,pt[m.bead_id]||null,mn(p.attempts||{},m.bead_id),Fe[m.bead_id]||(he.has(m.bead_id)||pe.has(m.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),qs.get(m.bead_id)||null,m.external===!0,{position:al.get(m.bead_id)||0,active:wr.active===m.bead_id,failure:af[m.bead_id]||null,waiting:dl?.bead_id===m.bead_id?dl.reason:null,resolution:il.get(m.bead_id),continuation_action:ll.get(m.bead_id),head_review:cl.get(m.bead_id)||null,authority:ul.get(m.bead_id)||null},m.wt_present!==!1,p.auto_merge===!0?pl(m.bead_id):null,Gi(Ds,sf(m.bead_id)),p.completion_status&&typeof p.completion_status=="object"&&!Array.isArray(p.completion_status)&&p.completion_status[m.bead_id]||null,p.discard_operations&&typeof p.discard_operations=="object"&&!Array.isArray(p.discard_operations)?p.discard_operations:{},Yr.get(tl.get(m.bead_id)||"")?.worker_serial===!0,p.auto_merge===!0,{merge_sha:m.merge_sha,cleanup_cursor:m.cleanup_cursor,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]})).map(m=>({...m,workflow:jn[m.id]||null,priority:Sn.get(m.id),...tr(m.id)})),merge_queue_length:_a.length,merge_queue_running:_a.length>0,auto_excluded:Un.map(m=>m.bead_id).filter(m=>pl(m)!==null),declared_base:Ds,done:Zr,token_total:ff,cleanup_failures:on,repo_operations:Array.isArray(p.repo_operations)?p.repo_operations:[]}}function De(){let y=!!o?.get()?.job,f=!y&&o?.isPending?.()===!0,C=y?"\uBD84\uC11D \uC911":f?"\uC900\uBE44 \uC911":"";return c`<button
      type="button"
    ...
    >`,Ue=c`<label class="worker-tgl worker-slots"
      ...
      <label
        ...
        <select class="worker-serial-lane-count" aria-label="직렬 레인 수">
          ${Array.from({length:Rp},(vt,sn)=>sn+1).map(vt=>c`<option
                value=${String(vt)}
      ...
      ${o?De():""} `,Xe=ud({failure:p.failure}),Ke=nd(p.repo_operations,p.cleanup_failures);return we?c`<div class="worker-ribbon">
          ${f} ${C}
    ...
    >
      ▶ 자동 머지${C>0?` ${C}`:""}
        ...
        ${Lt(p)}
        ${hn({id:"worker-pane-queue",lane:"queue",title:"\uBCD1\uB82C \uB300\uAE30",items:p.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:W.queue,preview:Ip(p.waiting)})}
        ${p.serial_lanes.map(f=>qt(f))}
        ${y}
        ${hn({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:p.done,empty:`${U()} \uC644\uB8CC \uC5C6\uC74C`,controls:Bt(),collapsible:!0,collapsed:W.done,preview:Array.isArray(p.token_total)?p.token_total.map(f=>f.label).join(" \xB7 "):p.token_total||Ip(p.done)})}
      ...
      ${hn({id:"worker-pane-running",lane:"running",title:`\uC2E4\uD589 \uC911 \xB7 \uC2AC\uB86F ${p.slots}`,items:p.running,live:p.running.some(f=>f.kind!=="session"&&!f.paused&&f.failed!==!0),body:Ei(p.running,Date.now(),Se,p.running_overlays)})}
    ...
    `}function D(){let K=t.getState(),T=K.workspace?.current,U=K.workspace?.available||[],W=new Set(K.workspace?.hidden||[]),we=T?.path||U[0]?.path||"";if(U.length===0)return c``;let he=U.filter(pe=>!W.has(pe.path)||pe.path===we);if(he.length<=1){let pe=he[0]||U[0],H=Ki(pe.path);return c`
