    ...
    `}function _(){if(!d)return l``;let m=p||{},A=String(m.id||d),u=m.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",f=Qe(),v=m.status||"open",x=typeof m.priority=="number"?Math.max(0,Math.min(4,m.priority)):"",j=m.description||"",z={...m,metadata:{...m.metadata||{},...h}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${en(u,f)}
          ${Hu(z)}
          ${zu({metadata:z.metadata,workspace_values:ut(),catalog:Re(),execution_defaults:P(),expanded:N,presets:de()?.presets||[],preset_id:y,preset_busy:$,skipped_orchestration_keys:E},{onToggle:re=>{N=re,w()},onEdit:(re,_e)=>{if(re==="impl_runtime"||re==="impl_model"||re==="impl_effort"){xe(re,_e??"");return}dt(re,_e??"")},onPresetSelect:re=>{y=re,E=[],w()},onPresetApply:()=>{pe()}})}
          ${Xu({md:z.metadata,catalog:Y,workspace_defaults:le,handlers:{onExecChange:dt}})}
          ${In(v,x)} ${_n(m)}
          ${T(j)}
          ${Ru(ke,Le,{expanded:me,draft:ye,sending:K,error:Se})}
          ${L(m)} ${De(m)} ${Rt(m)}
          ${It(m)} ${wt(m)}
          ${Eu(m,ot)}
...
`)}
        >
          ...
          >scope 없음</span
        >`:""}${r.map(c=>l`<span class="worker-dep worker-dep--warn">${c}</span>`)}${a?cb(a):""}
...
`)}function As(e){if(typeof e!="object"||e===null)return null;let t=_r(e);if(t==="")return null;let n=(r,s)=>typeof s=="string"&&s.length>0?`${r}: ${s}`:null;return{text:t,title:Di(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(Xn.orchestration_model,e.model),n(Xn.orchestration_effort,e.effort),n(Xn.orchestration_speed,e.speed)])}}function hr(e,t){let n=Jn(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=Jn(e,"orchestration_effort"),s=Jn(e,"orchestration_speed"),o=hd([An(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Di(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",er("orchestration_model",n),er("orchestration_effort",r),er("orchestration_speed",s)])}}function yb(e,t){return e===null||e.value===null||Pi.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function vb(e){return e===null||Pi.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function wb(e){return e===null?null:e.value==="auto"?"auto":Pi.has(e.resolution)?null:e.display}function tr(e,t){if(typeof e!="object"||e===null)return null;let n=Jn(e,"impl_dispatch"),r=Jn(e,"impl_runtime"),s=Jn(e,"impl_model"),o=Jn(e,"impl_effort"),a=Jn(e,"impl_speed"),i=n!==null&&n.value==="main"?"\uBA54\uC778":hd([yb(r,t??null),vb(s),wb(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Di(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",er("impl_dispatch",n),er("impl_runtime",r),er("impl_model",s),er("impl_effort",o),er("impl_speed",a)])}}var zt="",kb=["impl_runtime","impl_model","impl_effort"],$b=["claude_account","codex_account"],xb=5,Xo=1;function sn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Qo(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(P=>ie(P,"error",4e3)),o={},a={},i=[],c=!1,d={state:"absent",values:{},warnings:[]},p={},h={},y=Promise.resolve(),$={claude:null,codex:null},E=!1,N=null,B={},Y="",le="",U=!1,q=!1,D=!1,W=null,S=!1;function M(){let P=t.queue?t.queue():null;return sn(P)?P:null}function ne(){let P=M();return P?P.runner_catalog:null}function Te(){let P=M();return P&&sn(P.execution_defaults)?P.execution_defaults:null}function be(){let P=t.implPresetStore?.get();return sn(P)&&Array.isArray(P.presets)?P:null}function H(){return r===null?{}:{root_dir:r}}async function X(P,V){return S||!n?null:await n(P,V)}function he(P){P&&sn(P.queue)&&t.onQueueAdopt?.(P.queue)}async function ke(P,V){let de=M();if(!de||S)return null;let C=await X(P,{...V,...H(),expected_revision:de.revision});if(he(C),r!==null&&C&&C.conflict){let G=C.queue&&typeof C.queue.revision=="number"?C.queue.revision:M()?.revision??de.revision;C=await X(P,{...V,...H(),expected_revision:G}),he(C)}return C}async function ge(){c=!0,Re();try{let P=await X("get-session-defaults",{...H()});o=sn(P?.values)?{...P.values}:{},a={...o},i=Array.isArray(P?.warnings)?P.warnings:[]}catch(P){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${P instanceof Error?P.message:String(P)}`)}finally{c=!1,Re()}}async function se(){let P=qu(o,a);if(Object.keys(P).length!==0){try{let V=await X("set-session-defaults",{values:P,...H()});o=sn(V?.values)?{...V.values}:{},a={...o},i=Array.isArray(V?.warnings)?V.warnings:[]}catch(V){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}Re()}}function Se(P,V){if(!sn(P))return;let de=P.state;d={state:de==="usable"||de==="unusable"||de==="absent"?de:"absent",values:sn(P.values)?{...P.values}:{},warnings:Array.isArray(P.warnings)?P.warnings:[]},h={...d.values},V&&(p={...h})}async function ye(){try{Se(await X("get-workspace-accounts",{...H()}),!0)}catch(P){d={state:"unusable",values:{},warnings:["kv_read_failed"]},h={},p={},s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${P instanceof Error?P.message:String(P)}`)}Re()}async function K(P){try{let V=await fetch(P);if(!V.ok)return null;let de=await V.json();if(!sn(de)||!Array.isArray(de.accounts))return null;let C=de.accounts.filter(G=>sn(G)&&typeof G.key=="string"&&G.key.length>0&&typeof G.email=="string"&&G.email.length>0);return{accounts:C,active:C.find(G=>G.active===!0)||null}}catch{return null}}async function ee(){E=!0;let[P,V]=await Promise.all([K("/api/claude-usage"),K("/api/codex-usage")]);S||($={claude:P,codex:V},Re())}function me(){let P={};for(let V of $b){let de=Object.hasOwn(p,V)?p[V]:null,C=Object.hasOwn(h,V)?h[V]:null;de!==C&&(P[V]=de)}return P}async function ve(){let P=me();if(Object.keys(P).length!==0){try{Se(await X("set-workspace-accounts",{values:P,...H()}),!1)}catch(V){s(`\uC2E4\uD589 \uACC4\uC815 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}Re()}}function Me(P,V){V===zt?delete p[P]:p[P]=V,Re(),y=y.then(()=>ve())}function ae(P,V){if(kb.includes(P)){ce(P,V);return}V===zt?delete a[P]:a[P]=V,Re(),se()}function He(){let P=ut().orchestration_model,V=rn({global:{orchestration_model:P??void 0},execution_defaults:Te(),runner_catalog:ne()}).orchestration_model.value;return V?An(ne(),V):null}function I(P,V){typeof V=="string"&&V.length>0?a[P]=V:delete a[P]}function ce(P,V){let de=V===zt?void 0:V,C=Mu({impl_runtime:P==="impl_runtime"?de:a.impl_runtime,impl_model:P==="impl_model"?de:a.impl_model,impl_effort:P==="impl_effort"?de:a.impl_effort},ne(),He());I("impl_runtime",C.impl_runtime),I("impl_model",C.impl_model),I("impl_effort",C.impl_effort),Re(),se()}async function Le(){let P=M();if(!P)return;let V={orchestration_model:P.orchestration_model??null,orchestration_effort:P.orchestration_effort??null,orchestration_speed:P.orchestration_speed??null},de=Fu(V,{...V,...B});if(Object.keys(de).length!==0){try{let C=await ke("worker-queue-set-orchestration-defaults",{values:de});if(C&&C.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}B={}}catch(C){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}Re()}}function qe(P,V){B[P]=V===zt?null:V,Re(),Le()}function Ie(P){if(N=P,!P){Re();return}let V=ne(),de=ut(),C=de.orchestration_model;C&&!vs(V,P).includes(C)&&(B.orchestration_model=null,C=null);let G=de.orchestration_effort;G&&!wi(V,P,C||pn).includes(G)&&(B.orchestration_effort=null),Re(),Le()}async function We(P){if(!(!M()||P<Xo)){try{await ke("worker-queue-set-slots",{slots:P})}catch(V){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}Re()}}async function je(P){if(!(!M()||P<Xo||P>xb)){try{await ke("worker-queue-set-serial-lane-count",{count:P})}catch(V){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}Re()}}async function Ye(P,V){let de=P==="auto_advance"?"worker-automation-toggle":P==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await ke(de,{on:V})}catch(C){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}Re()}function tt(){let P={},V=ut();for(let de of Co){let C=Wn.includes(de)?V[de]:a[de];typeof C=="string"&&C.length>0&&(P[de]=C)}return P}async function ct(){let P=be();if(!P)return;let V=tt();if(Object.keys(V).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let de=(P.presets||[]).find(G=>G.id===Y),C=le.trim()||(de?de.name:"");if(!C){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let G=de?await X("impl-preset-update",{expected_revision:P.revision,id:de.id,name:C,settings:V}):await X("impl-preset-create",{expected_revision:P.revision,name:C,settings:V});if(G&&G.applied){if(le="",!de&&Array.isArray(G.presets)){let pe=G.presets.find(g=>g.name===C);Y=pe?pe.id:Y}Re()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Re()}catch(G){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${G instanceof Error?G.message:String(G)}`)}}async function _t(){let P=be();if(!(!P||Y.length===0))try{let V=await X("impl-preset-delete",{expected_revision:P.revision,id:Y});V&&V.applied?(Y="",Re()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),Re())}catch(V){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}}function te(P){o=sn(P.values)?{...P.values}:{},a={...o},i=Array.isArray(P.warnings)?P.warnings:[],sn(P.queue)&&(t.onQueueAdopt?.(P.queue),B={})}async function J(){let P=be(),V=M();if(!P||!V||Y.length===0)return;let de=C=>({preset_id:Y,expected_revision:P.revision,expected_queue_revision:C,...H()});try{let C=await X("apply-impl-preset-global",de(V.revision));if(C&&C.applied&&te(C),r!==null&&C&&C.queue_applied===!1){let G=C.queue&&typeof C.queue.revision=="number"?C.queue.revision:M()?.revision??V.revision;C=await X("apply-impl-preset-global",de(G)),C&&C.applied&&te(C)}C&&C.applied?C.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):C&&C.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(C){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${C instanceof Error?C.message:String(C)}`)}Re()}async function Ce(){q=!0,D=!1,Re();try{let P=await X("get-worker-system-prompt",{});!P||typeof P!="object"||Array.isArray(P)?D=!0:W=P}catch{D=!0}finally{q=!1,Re()}}function Ke(){if(U=!U,U&&!W){Ce();return}Re()}function Oe(){let P=Nr({loading:q,error:D});if(P)return P;if(!W)return"";let V=Array.isArray(W.variants)?W.variants:[];return l`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${U?Oe():""}
    </section>`}function Be(P,V,de,C,G,pe,g){let k=G[P]??zt,O=ki(P,de,G,Te(),ne(),g),Q=O.options.find(fe=>fe.value===k),Z=k===zt?O.full_value:Q?.full_value;return l`<select
    ...
    </div>`}function ut(){let P=M(),V={};for(let de of Wn)V[de]=Object.prototype.hasOwnProperty.call(B,de)?B[de]:P&&typeof P[de]=="string"?P[de]:null;return V}function ze(){let P=ne(),V=a.impl_runtime,de=a.impl_model,C=be(),G=M(),pe=ut(),g=vs(P,N),k=Fr(P,void 0).filter(xe=>xe!==pn),O=wi(P,N,pe.orchestration_model||pn).filter(xe=>xe!==pn),Q=Y?(C?.presets||[]).find(xe=>xe.id===Y):null,Z=Q?Nu(tt(),sn(Q.settings)?Q.settings:{}):null,fe=G&&typeof G.slots=="number"?G.slots:Xo+1,Ee=G&&typeof G.serial_lane_count=="number"?G.serial_lane_count:Xo,$e=Te()?.supported===!0,st=rt(),dt=ki("workflow_mode",hs,a,Te(),P);return l`
  ...
  >
    ...
    </div>`}function he(K){let ee=t.doneItems?t.doneItems():[],me=t.rangeLabel?t.rangeLabel():"",ve=xd(Array.isArray(ee)?ee:[]),Me=ae=>K.reduce((He,I)=>He+Mi(I,ae),0);return l`<div class="mon2-deck__bar">
      <span
...
`):""}
    ...
    >
      ...
      <div class="worker-lanes mon2-lanes">
        ${ch.map(v=>{let x=f[v.lane],j=v.lane==="runnable"?H.runnable_flat?x.length>0?Ge():void 0:H.runnable_sections.length>0?Ge():void 0:v.lane==="queue"?H.queue_groups.length>0||H.chain_lanes.length>0||H.parallel_rows.length>0?Re():void 0:v.lane==="running"?P(u):x.length>0?l`${x.map(z=>Qn(z))}`:void 0;return yn({id:`monitor-${v.lane}`,lane:v.pane,title:v.lane==="done"?`\uC644\uB8CC\xB7${S()}`:v.title,items:x,empty:v.empty,body:j,live:v.lane==="running"&&x.length>0,controls:v.lane==="runnable"?de():void 0,header_control:C(v.lane,x.length)})})}
  ...
  `}var fh=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function gp(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(X=>ie(X,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,d="",p=null;function h(){if(p)return p;let X=a.querySelector('[data-pane="execution"]');return X?(p=Qo(X,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:he=>t.queueStore?.set?.(he)}),p):null}function y(){return l`
      <section
    ...
    `}async function E(X){let he=r.get();if(he)try{let ke=await n("display-policy-set",{expected_revision:he.revision,policy:X(he)});N(ke),ke&&ke.conflict&&ke.policy&&(ke=await n("display-policy-set",{expected_revision:ke.policy.revision,policy:X(ke.policy)}),N(ke)),ke&&ke.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function N(X){X&&X.policy&&typeof X.policy=="object"&&r.set(X.policy)}function B(X){E(X)}function Y(X){let he=r.get();if(!he)return;let ke=!_h(X,he);B(ge=>mh(X,ge,ke))}function le(){let X=d.trim();X.length!==0&&(d="",B(he=>he.hidden_prefixes.includes(X)?{hidden_prefixes:he.hidden_prefixes}:{hidden_prefixes:[...he.hidden_prefixes,X]}),D())}function U(X){B(he=>({hidden_prefixes:he.hidden_prefixes.filter(ke=>ke!==X)}))}function q(X){let he=r.get();if(!he)return;let ke=he.chips[X]===!1;B(()=>({chips:{[X]:ke}}))}function D(){Ve(l`
...
`):[];return l`<div
    ...
    </div>`}function $(){Ve(y(),r)}async function E(){if(o!=="ready")return;let D=await un(a);ie(D?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",D?"success":"error")}function N(D){D.key==="Escape"&&s&&(D.preventDefault(),U())}function B(){p||(document.addEventListener("keydown",N),p=!0)}function Y(){p&&(document.removeEventListener("keydown",N),p=!1)}async function le(D,W=null){let S=++c;B(),s={...D},d=W||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",$(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let ne=t?t():"";if(!ne){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",$();return}if(!n){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",$();return}let Te="/api/repo-ops-script?workspace="+encodeURIComponent(ne)+"&lane="+encodeURIComponent(D.lane)+"&base_sha="+encodeURIComponent(D.base_sha);try{let be=await n(Te),H=await be.json().catch(()=>({}));if(S!==c)return;if((t?t():"")!==ne){U();return}if(!be.ok||!H||H.ok!==!0){o="error",i=Ih(H&&typeof H.error=="string"?H.error:""),$();return}s={lane:H.lane,base_sha:H.base_sha,path:H.path,base_ref:H.base_ref},a=String(H.content),o="ready",$()}catch{if(S!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",$()}}function U(){c+=1,Y(),s=null,a="",$();let D=d;d=null,D?.isConnected&&D.focus()}function q(){U(),r.remove()}return{open:le,close:U,destroy:q}}function Dp(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let S=o();return typeof S.revision=="number"?S.revision:0}function i(S){t&&S&&S.queue&&typeof S.queue=="object"&&t.set(S.queue)}function c(){let S=o().workspace_info;return S&&typeof S=="object"?S:{}}function d(S,M){return l`<span
  ...
  </li>`}function Uh(e){let t=e.cleanup,n=yr(t.step);return l`<li
    class="worker-ev"
...
${Tt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:F==="done"?bn(_.attempts||{},oe.bead_id):null,work_ms:F==="done"?Wo(_.attempts||{},oe.bead_id):null,done_at:F==="done"&&typeof oe.added_at=="number"?oe.added_at:void 0,exec_chips:Xe?Je(oe.bead_id):null,workflow:Xe&&zn[oe.bead_id]||null,from_id:Tn.get(oe.bead_id)||void 0,priority:on.get(oe.bead_id),...or(oe.bead_id)}}),kr=_.attempts?Object.values(_.attempts).filter(Wr):[],ga=new Set;for(let b of kr)b&&typeof b.resumed_from=="string"&&b.resumed_from.length>0&&ga.add(b.resumed_from);let ll=new Map;for(let b of kr)ll.set(b.bead_id,b.attempt_id);let Vr=new Map;for(let b of kr)Vr.set(b.attempt_id,b);function ba(b){let F=new Set,oe=b;for(;oe&&!F.has(oe.attempt_id);){if(oe.conflict_resolution===!0)return!0;F.add(oe.attempt_id),oe=typeof oe.resumed_from=="string"&&oe.resumed_from.length>0&&Vr.get(oe.resumed_from)||null}return!1}let Ds=typeof _.declared_base=="string"?_.declared_base:null;function hf(b){let F=null;for(let oe of kr)!oe||oe.bead_id!==b||ba(oe)||(F===null||(typeof oe.started_at=="number"?oe.started_at:0)>=(typeof F.started_at=="number"?F.started_at:0))&&(F=oe);return F&&typeof F.target_base=="string"?F.target_base:null}let ha=[],Ms=[],yf=Ep(_),cl=b=>{let F=typeof b.session_id=="string"&&b.session_id.length>0,oe=ga.has(b.attempt_id);return{eligible:F&&!oe,reason:F?oe?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},vn=null;for(let b of kr){let F=b.status==="paused"&&!ga.has(b.attempt_id);if(b.status==="running"||F)Ms.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:Bt.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,paused:F,conflict_resolution:ba(b),base_exception:el(Ds,b.target_base),can_pause:typeof b.session_id=="string"&&b.session_id.length>0,discard:Sn(Ps,b.bead_id,{attempt_id:b.attempt_id}),workflow:zn[b.bead_id]||null,priority:on.get(b.bead_id),usage:bn(_.attempts||{},b.bead_id),rollup:jt(b.bead_id),rollup_expanded:ke.has(b.bead_id),exec_chips:re(b),...or(b.bead_id)});else if((b.status==="failed"||b.status==="orphaned")&&yf(b)){let oe=cl(b);ha.push({bead_id:b.bead_id,attempt_id:b.attempt_id,title:Bt.get(b.bead_id)||b.bead_id,runner:b.runner||null,model:b.model||null,effort:b.effort||null,speed:b.speed||null,continuation_mode:b.continuation_mode||null,started_at:typeof b.started_at=="number"?b.started_at:null,resumed_from:b.resumed_from||null,failed:!0,status:b.status,status_label:b.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:Sn(Ps,b.bead_id,{attempt_id:b.attempt_id}),resume_eligible:oe.eligible,resume_reason:oe.reason,conflict_resolution:ba(b),base_exception:el(Ds,b.target_base),workflow:zn[b.bead_id]||null,priority:on.get(b.bead_id),usage:bn(_.attempts||{},b.bead_id),rollup:jt(b.bead_id),rollup_expanded:ke.has(b.bead_id),exec_chips:re(b),...or(b.bead_id)}),vn=b}}let ul=new Set([...ha,...Ms].map(b=>b.bead_id));for(let b of Array.isArray(_.session_active)?_.session_active:[]){let F=b&&b.bead_id;typeof F!="string"||F.length===0||ul.has(F)||(ul.add(F),Ms.push({bead_id:F,attempt_id:null,kind:"session",title:b.title||Bt.get(F)||F,status:"in_progress",started_at:Cn(b.started_at)??Cn(b.updated_at),updated_at:Cn(b.updated_at),workflow:b.workflow||null,priority:on.get(F),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,usage:null,rollup:null,rollup_expanded:!1}))}let $r=[...ha,...Ms].map(b=>{let F=Vr.get(b.attempt_id),oe=F?.quickfix_landing;if(F?.quickfix_lane!==!0||!oe||typeof oe!="object")return b;let Fe=typeof oe.reason=="string"&&oe.reason.length>0?oe.reason:null,Xe=Cs({bead_id:F.bead_id,merge_sha:oe.head_sha,cleanup_cursor:oe.cursor,cleanup_failed:Fe?{step:oe.cursor,reason:Fe}:null,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]});return Xe?{...b,landing:Xe}:b}),dl=null;if(vn){let b=cl(vn),F=vn.cause_detail;dl={bead_id:vn.bead_id,repo:vn.repo||"",reason:vn.cause||vn.status,cause_detail:F&&typeof F.reason=="string"?{reason:F.reason,command:typeof F.command=="string"?F.command:null}:null,resume_attempt_id:vn.attempt_id,resume_eligible:b.eligible,resume_reason:b.reason,discard:Sn(Ps,vn.bead_id,{attempt_id:vn.attempt_id})}}let pl=new Set($r.map(b=>b.bead_id)),ya=Array.isArray(_.merge_queue)?_.merge_queue:[],fl=new Map,_l=new Map,ml=new Map,gl=new Map,bl=new Map;ya.forEach((b,F)=>{b&&typeof b.bead_id=="string"&&(fl.set(b.bead_id,F+1),_l.set(b.bead_id,b.resolution),ml.set(b.bead_id,b.continuation_action||null),gl.set(b.bead_id,b.head_review||null),bl.set(b.bead_id,b.authority||null))});let xr=_.merge_queue_state||{active:null,failures:{}},vf=xr.failures||{},hl=xr.waiting&&typeof xr.waiting.bead_id=="string"&&typeof xr.waiting.reason=="string"?xr.waiting:null,wf=_.auto_merge_skips||{},yl=b=>{let F=wf[b];if(!F)return null;let oe=Gr[b],Fe=oe&&oe.pr?oe.pr.head_sha:null;return Fe&&Fe===F.head_sha?F.reason||"":null},Ns=new Map;for(let b of $r)b.failed!==!0&&b.conflict_resolution&&(b.paused?Ns.has(b.bead_id)||Ns.set(b.bead_id,"paused"):Ns.set(b.bead_id,"running"));let vl=$r.filter(b=>b.kind!=="session"&&!b.paused&&b.failed!==!0).length,wl=(_.workspace_info||{}).slots,kl=typeof wl=="number"?wl:typeof _.slots=="number"?_.slots:ua,kf=vl>kl,qs=dr(W),$f=(Array.isArray(_.done)?_.done.slice():[]).filter(b=>qs===void 0||typeof b.added_at!="number"||b.added_at>=qs).sort((b,F)=>(F.added_at||0)-(b.added_at||0)),Kr=ma($f,"done"),xf=new Set((Array.isArray(_.done)?_.done:[]).map(b=>b?.bead_id).filter(b=>typeof b=="string")),$l=[],Af=d?.()||"";for(let b of A){let F=Cn(b.closed_at);if(typeof b.id!="string"||xf.has(b.id)||F===null||qs!==void 0&&F<qs||typeof b.comment_count!="number"||b.comment_count<=0)continue;let oe=`${Af}\0${b.id}\0${String(b.updated_at)}\0${b.comment_count}`,Fe=S.get(oe);Fe===void 0&&n&&(S.set(oe,"pending"),Promise.resolve(n("get-comments",{id:b.id})).then(Xe=>{let kt=Array.isArray(Xe)&&Xe.some(Tt=>Eo(typeof Tt?.text=="string"?Tt.text:"")?.lane==="session");S.set(oe,kt?"session":"not-session"),Ue()}).catch(()=>{S.set(oe,"failed"),Ue()})),Fe==="session"&&$l.push({id:b.id,title:b.title||b.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:F,created_at:b.created_at,updated_at:b.updated_at})}Kr.push(...$l),Kr.sort((b,F)=>(F.done_at||0)-(b.done_at||0));let Fs={};for(let b of On)Fs[b]=0;let xl=!1,Al=0,va=0,Sl=0;for(let b of Kr){let F=b.usage;if(F&&typeof F=="object"){let oe=!1;for(let Fe of On)Number.isFinite(F[Fe])&&(Fs[Fe]+=F[Fe],xl=!0,oe=!0);oe&&(va+=1,Number.isFinite(F.total_cost_usd)&&(Al+=F.total_cost_usd,Sl+=1))}}va>0&&Sl===va&&(Fs.total_cost_usd=Al);let El=Kr.map(b=>b.usage).filter(b=>b&&typeof b=="object"&&b.providers),Sf=El.length>0?Wt(po(El)):xl?qn(Fs):null,Tl=_.lane_states&&typeof _.lane_states=="object"&&!Array.isArray(_.lane_states)?_.lane_states:{},Cl=Array.isArray(_.serial_lanes)?_.serial_lanes:[],Rl=b=>{if(Gn.some(Fe=>Fe.bead_id===b))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let F=kr.filter(Fe=>Fe&&Fe.bead_id===b),oe=F.length>0?F[F.length-1].status:null;return oe==="failed"||oe==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":oe==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},js=Cl.filter(b=>b&&typeof b.id=="string"&&Array.isArray(b.entries)).map((b,F)=>{let oe=Tl[b.id]||{},Fe=new Map((Array.isArray(oe.corrections)?oe.corrections:[]).filter(ft=>ft&&typeof ft.bead_id=="string"&&typeof ft.after=="string").map(ft=>[ft.bead_id,ft.after])),Xe=ma(b.entries.filter(ft=>!pl.has(ft.bead_id)),b.id).map(ft=>Fe.has(ft.id)?{...ft,badges:[`\u{1F517} ${Fe.get(ft.id)} \uB4A4 (blocks \uC790\uB3D9)`,...ft.badges]}:ft),kt=Array.isArray(oe.occupied_by)?oe.occupied_by.filter(ft=>typeof ft=="string"):[],Tt=kt.map(ft=>({id:ft,title:Bt.get(ft)||ft,draggable:!1,lane:b.id,ghost:!0,badges:[Rl(ft)]}));return{id:b.id,index:F+1,rows:[...Tt,...Xe],occupied:kt.length>0,badge:kt.length>0?Rl(kt[0]):"\uB300\uAE30",cycle:oe.cycle===!0}}),Ol=typeof _.serial_lane_count=="number"?_.serial_lane_count:js.length,wa=ma(pa.filter(b=>!pl.has(b.bead_id)),"queue"),Ll=new Map,Il=new Set;for(let[b,F]of Object.entries(Tl)){if(!/^s[1-5]$/.test(b))continue;let oe=F&&Array.isArray(F.occupied_by)?F.occupied_by:[];for(let Fe of oe)typeof Fe=="string"&&Ll.set(Fe,b);oe.length>0&&Il.add(b)}let Ar=[];for(let b of $r)typeof b.bead_id=="string"&&Ar.push({id:b.bead_id,title:Bt.get(b.bead_id)||b.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:Ll.get(b.bead_id)??null});for(let b of js)for(let F of b.rows)F.ghost!==!0&&Ar.push({id:F.id,title:F.title,location_label:`${b.id} #${F.seq??""}`.trim(),kind:"serial",lane_id:b.id});wa.forEach((b,F)=>{Ar.push({id:b.id,title:b.title,location_label:`#${F+1}`,kind:"parallel",lane_id:null})});for(let b of _a)Ar.push({id:b.id,title:b.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let Pl={};for(let b of Cl)b&&typeof b.id=="string"&&Array.isArray(b.entries)&&(Pl[b.id]=b.entries.length);let ka=new Map;for(let b of Ar)ka.has(b.id)||ka.set(b.id,b);q={members_by_id:ka,serial_raw_lengths:Pl,serial_lane_count:Ol,occupied_lanes:Il};let Dl=Rp(_.bead_scope,Ar),$a=(b,F)=>{let oe=Dl.get(b.id);if(!oe||oe.overlaps.length===0&&!oe.scope_missing)return b;let Fe=Ee(b.id,oe.overlaps);return b.dependency_chips={...b.dependency_chips||{},...oe.overlaps.length>0?{overlaps:oe.overlaps}:{},...oe.scope_missing&&F!=="running"?{scope_missing:!0}:{},...Fe?{popover:Fe}:{}},b};for(let b of wa)$a(b,"queue");for(let b of js)for(let F of b.rows)F.ghost!==!0&&$a(F,b.id);for(let b of _a)$a(b,"candidate");let Ml=new Map;for(let b of $r){let F=typeof b.bead_id=="string"?b.bead_id:"";if(F.length===0)continue;let oe=b.kind==="session",Fe=Dl.get(F),Xe=Fe&&Fe.overlaps.length>0?Fe.overlaps:null,kt=typeof b.attempt_id=="string"&&b.attempt_id.length>0?Vr.get(b.attempt_id):void 0,Tt=kt&&kt.last_activity&&typeof kt.last_activity=="object"?kt.last_activity:null,ft=kt&&Array.isArray(kt.legs)?kt.legs:[];if(!Xe&&!Tt&&ft.length===0&&!oe)continue;let tn=Xe?Ee(F,Xe):null;Ml.set(F,{...Tt?{last_activity:Tt}:{},...ft.length>0?{legs:ft}:{},...Xe?{dependency_chips:{overlaps:Xe,...tn?{popover:tn}:{}}}:{}})}return{queue:_,idToTitle:Bt,candidates:_a,candidate_hidden:{blocked:fa.hidden_blocked,spec:fa.hidden_spec},running:$r,live_count:vl,slots:kl,over_cap:kf,failure:dl,waiting:wa,serial_lanes:js,serial_lane_count:Ol,running_overlays:Ml,pr_wait:Gn.map(b=>$y(b.bead_id,Bt.get(b.bead_id)||b.bead_id,Gr,at[b.bead_id]||null,bn(_.attempts||{},b.bead_id),Ne[b.bead_id]||(be.has(b.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:H.has(b.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),Ns.get(b.bead_id)||null,b.external===!0,{position:fl.get(b.bead_id)||0,active:xr.active===b.bead_id,failure:vf[b.bead_id]||null,waiting:hl?.bead_id===b.bead_id?hl.reason:null,resolution:_l.get(b.bead_id),continuation_action:ml.get(b.bead_id),head_review:gl.get(b.bead_id)||null,authority:bl.get(b.bead_id)||null},b.wt_present!==!1,_.auto_merge===!0?yl(b.bead_id):null,el(Ds,hf(b.bead_id)),_.completion_status&&typeof _.completion_status=="object"&&!Array.isArray(_.completion_status)&&_.completion_status[b.bead_id]||null,_.discard_operations&&typeof _.discard_operations=="object"&&!Array.isArray(_.discard_operations)?_.discard_operations:{},Vr.get(ll.get(b.bead_id)||"")?.worker_serial===!0,_.auto_merge===!0,{merge_sha:b.merge_sha,cleanup_cursor:b.cleanup_cursor,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]})).map(b=>({...b,workflow:zn[b.id]||null,priority:on.get(b.id),...or(b.id)})),merge_queue_length:ya.length,merge_queue_running:ya.length>0,auto_excluded:Gn.map(b=>b.bead_id).filter(b=>yl(b)!==null),declared_base:Ds,done:Kr,token_total:Sf,cleanup_failures:an,repo_operations:Array.isArray(_.repo_operations)?_.repo_operations:[]}}function xe(){let w=!!o?.get()?.job,m=!w&&o?.isPending?.()===!0,A=w?"\uBD84\uC11D \uC911":m?"\uC900\uBE44 \uC911":"";return l`<button
    ...
    >
      ...
      ${_.running.length>0?Ii(_.running,Date.now(),Ie,_.running_overlays):""}
    ...
    >
      ...
      ${yn({id:"worker-pane-running",lane:"running",title:`\uC2E4\uD589 \uC911 \xB7 \uC2AC\uB86F ${_.slots}`,items:_.running,live:_.running.some(m=>m.kind!=="session"&&!m.paused&&m.failed!==!0),body:Ii(_.running,Date.now(),Ie,_.running_overlays)})}
