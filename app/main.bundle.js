...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ol=/'/g,Ll=/"/g,Dl=/^(?:script|style|textarea|title)$/i,Hi=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),c=Hi(1),go=Hi(2),Vv=Hi(3),yn=Symbol.for("lit-noChange"),Rt=Symbol.for("lit-nothing"),Il=new WeakMap,_r=mr.createTreeWalker(mr,129);function Pl(e,t){if(!zi(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Tl!==void 0?Tl.createHTML(t):t}var Nl=(e,t)=>{let n=e.length-1,r=[],o,s=t===2?"<svg>":t===3?"<math>":"",i=uo;for(let l=0;l<n;l++){let a=e[l],u,d,_=-1,h=0;for(;h<a.length&&(i.lastIndex=h,d=i.exec(a),d!==null);)h=i.lastIndex,i===uo?d[1]==="!--"?i=Cl:d[1]!==void 0?i=Rl:d[2]!==void 0?(Dl.test(d[2])&&(o=RegExp("</"+d[2],"g")),i=fr):d[3]!==void 0&&(i=fr):i===fr?d[0]===">"?(i=o??uo,_=-1):d[1]===void 0?_=-2:(_=i.lastIndex-d[2].length,u=d[1],i=d[3]===void 0?fr:d[3]==='"'?Ll:Ol):i===Ll||i===Ol?i=fr:i===Cl||i===Rl?i=uo:(i=fr,o=void 0);let m=i===fr&&e[l+1].startsWith("/>")?" ":"";s+=i===uo?a+r_:_>=0?(r.push(u),a.slice(0,_)+Ui+a.slice(_)+Bn+m):a+Bn+(_===-2?l:m)}return[Pl(e,s+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},mo=class e{constructor({strings:t,_$litType$:n},r){let o;this.parts=[];let s=0,i=0,l=t.length-1,a=this.parts,[u,d]=Nl(t,n);if(this.el=e.createElement(u,r),_r.currentNode=this.el.content,n===2||n===3){let _=this.el.content.firstChild;_.replaceWith(..._.childNodes)}for(;(o=_r.nextNode())!==null&&a.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(let _ of o.getAttributeNames())if(_.endsWith(Ui)){let h=d[i++],m=o.getAttribute(_).split(Bn),w=/([.?@])?(.*)/.exec(h);a.push({type:1,index:s,name:w[2],strings:m,ctor:w[1]==="."?ls:w[1]==="?"?cs:w[1]==="@"?us:hr}),o.removeAttribute(_)}else _.startsWith(Bn)&&(a.push({type:6,index:s}),o.removeAttribute(_));if(Dl.test(o.tagName)){let _=o.textContent.split(Bn),h=_.length-1;if(h>0){o.textContent=is?is.emptyScript:"";for(let m=0;m<h;m++)o.append(_[m],fo()),_r.nextNode(),a.push({type:2,index:++s});o.append(_[h],fo())}}}else if(o.nodeType===8)if(o.data===Wi)a.push({type:2,index:s});else{let _=-1;for(;(_=o.data.indexOf(Bn,_+1))!==-1;)a.push({type:7,index:s}),_+=Bn.length-1}s++}}static createElement(t,n){let r=mr.createElement("template");return r.innerHTML=t,r}};function gr(e,t,n=e,r){if(t===yn)return t;let o=r!==void 0?n._$Co?.[r]:n._$Cl,s=_o(t)?void 0:t._$litDirective$;return o?.constructor!==s&&(o?._$AO?.(!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=o:n._$Cl=o),o!==void 0&&(t=gr(e,o._$AS(e,t.values),o,r)),t}var as=class{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:n},parts:r}=this._$AD,o=(t?.creationScope??mr).importNode(n,!0);_r.currentNode=o;let s=_r.nextNode(),i=0,l=0,a=r[0];for(;a!==void 0;){if(i===a.index){let u;a.type===2?u=new Lr(s,s.nextSibling,this,t):a.type===1?u=new a.ctor(s,a.name,a.strings,this,t):a.type===6&&(u=new ds(s,this,t)),this._$AV.push(u),a=r[++l]}i!==a?.index&&(s=_r.nextNode(),i++)}return _r.currentNode=mr,o}p(t){let n=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}},Lr=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,r,o){this.type=2,this._$AH=Rt,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=gr(this,t,n),_o(t)?t===Rt||t==null||t===""?(this._$AH!==Rt&&this._$AR(),this._$AH=Rt):t!==this._$AH&&t!==yn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ml(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Rt&&_o(this._$AH)?this._$AA.nextSibling.data=t:this.T(mr.createTextNode(t)),this._$AH=t}$(t){let{values:n,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=mo.createElement(Pl(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===o)this._$AH.p(n);else{let s=new as(o,this),i=s.u(this.options);s.p(n),this.T(i),this._$AH=s}}_$AC(t){let n=Il.get(t.strings);return n===void 0&&Il.set(t.strings,n=new mo(t)),n}k(t){zi(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,o=0;for(let s of t)o===n.length?n.push(r=new e(this.O(fo()),this.O(fo()),this,this.options)):r=n[o],r._$AI(s),o++;o<n.length&&(this._$AR(r&&r._$AB.nextSibling,o),n.length=o)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},hr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,o,s){this.type=1,this._$AH=Rt,this._$AN=void 0,this.element=t,this.name=n,this._$AM=o,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=Rt}_$AI(t,n=this,r,o){let s=this.strings,i=!1;if(s===void 0)t=gr(this,t,n,0),i=!_o(t)||t!==this._$AH&&t!==yn,i&&(this._$AH=t);else{let l=t,a,u;for(t=s[0],a=0;a<s.length-1;a++)u=gr(this,l[r+a],n,a),u===yn&&(u=this._$AH[a]),i||(i=!_o(u)||u!==this._$AH[a]),u===Rt?t=Rt:t!==Rt&&(t+=(u??"")+s[a+1]),this._$AH[a]=u}i&&!o&&this.j(t)}j(t){t===Rt?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ls=class extends hr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Rt?void 0:t}},cs=class extends hr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Rt)}},us=class extends hr{constructor(t,n,r,o,s){super(t,n,r,o,s),this.type=5}_$AI(t,n=this){if((t=gr(this,t,n,0)??Rt)===yn)return;let r=this._$AH,o=t===Rt&&r!==Rt||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,s=t!==Rt&&(r===Rt||o);o&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ds=class{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){gr(this,t)}},ql={M:Ui,P:Bn,A:Wi,C:1,L:Nl,R:as,D:Ml,V:gr,I:Lr,H:hr,N:cs,U:us,B:ls,F:ds},o_=po.litHtmlPolyfillSupport;o_?.(mo,Lr),(po.litHtmlVersions??(po.litHtmlVersions=[])).push("3.3.1");var ot=(e,t,n)=>{let r=n?.renderBefore??t,o=r._$litPart$;if(o===void 0){let s=n?.renderBefore??null;r._$litPart$=o=new Lr(t.insertBefore(fo(),s),s,void 0,n??{})}return o._$AI(e),o};var ps="today",Fl=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}],Ir=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"}];function Ln(e){return e==="today"?"today":"7d"}function Gi(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function br(e,t=Date.now()){switch(e){case"today":{let n=new Date(t);return n.setHours(0,0,0,0),n.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function jl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Bl(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Ul(){let e=null,t=[],n,r=new Set;function o(){for(let s of Array.from(r))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},crossLanes(){return n},set(s,i,l){e=Array.isArray(s)?s:null,t=Array.isArray(i)?i:[],n=l===void 0?void 0:l!==null&&typeof l=="object"&&typeof l.revision=="number"&&Array.isArray(l.lanes)?{revision:l.revision,lanes:l.lanes}:null,o()},clear(){e=null,t=[],n=void 0,o()},subscribe(s){return r.add(s),()=>r.delete(s)}}}function Wl(){let e=new Map,t=new Set;function n(o){return o.startsWith("session-log:")?o:`session-log:${o}`}function r(){for(let o of Array.from(t))try{o()}catch{}}return{set(o,s,i=null){e.set(n(o),{lines:Array.isArray(s)?[...s]:[],last_event_at:typeof i=="number"?i:null}),r()},append(o,s){let i=n(o),l=e.get(i)||{lines:[],last_event_at:null};l.lines=[...l.lines,s],l.last_event_at=Date.now(),e.set(i,l),r()},get(o){return e.get(n(o))||null},clear(o){typeof o=="string"?e.delete(n(o)):e.clear(),r()},subscribe(o){return t.add(o),()=>t.delete(o)}}}var Vl=n_(Yl(),1);function Ct(e){return(0,Vl.default)(`beads-ui:${e}`)}function h_(e){let n=Xl((e&&typeof e=="object"?e:{}).spec_id);return n?{path:n,source:"native",conflict:!1}:{path:"",source:"none",conflict:!1}}function Xl(e){return typeof e=="string"?e.trim():""}function b_(e){let t=e&&typeof e=="object"?e:{};return t.metadata&&typeof t.metadata=="object"?t.metadata:{}}var y_=/^[A-Za-z0-9_.:-]+@[0-9a-fA-F]{40}$/;function Nr(e){let t=h_(e),n=Xl(b_(e).spec_review),r=y_.test(n),o=r&&n.slice(0,n.indexOf("@"))==="skipped";return t.source==="none"?{...t,evidence:"none",skipped:o}:{...t,evidence:r?"published":"draft",skipped:o}}function $n(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function ho(e,t){let n=$n(e.created_at),r=$n(t.created_at);if(n!==r)return n<r?1:-1;let o=e.priority??2,s=t.priority??2;if(o!==s)return o-s;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function nc(e,t){let n=$n(e.created_at),r=$n(t.created_at);if(n!==r)return n<r?-1:1;let o=e.priority??2,s=t.priority??2;if(o!==s)return o-s;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function rc(e,t){let n=$n(e.updated_at),r=$n(t.updated_at);if(n!==r)return n<r?1:-1;let o=e.id,s=t.id;return o<s?-1:o>s?1:0}function oc(e,t){let n=e.priority??2,r=t.priority??2;if(n!==r)return n-r;let o=$n(e.created_at),s=$n(t.created_at);if(o!==s)return o<s?1:-1;let i=e.id,l=t.id;return i<l?-1:i>l?1:0}function sc(e,t){let n=e.closed_at??0,r=t.closed_at??0;if(n!==r)return n<r?1:-1;let o=e?.id,s=t?.id;return o<s?-1:o>s?1:0}var ms=Object.freeze({priority:"asc",dependents:"desc",released:"desc",spec:"desc",created:"asc",updated:"desc"});function v_(e){return typeof e=="string"&&Object.prototype.hasOwnProperty.call(ms,e)}function Yi(e){if(!e||typeof e!="object")return!1;let t=e;return v_(t.key)&&(t.dir==="asc"||t.dir==="desc")}function Ql(e){if(typeof e=="number")return Number.isFinite(e)?e:null;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:null}return null}function Zl(e,t){switch(t){case"priority":{let n=e.priority;return typeof n=="number"&&Number.isFinite(n)?n:null}case"dependents":{let n=e.dependents_info?e.dependents_info.count:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"released":{let n=e.release_info?e.release_info.last_released_at:null;return typeof n=="number"&&Number.isFinite(n)?n:null}case"spec":return Nr(e).evidence==="published"?1:0;case"created":return Ql(e.created_at);case"updated":return Ql(e.updated_at);default:return null}}function Jl(e,t,n){let r=Zl(e,n.key),o=Zl(t,n.key);if(r===null||o===null)return r===o?0:r===null?1:-1;if(r===o)return 0;let s=r<o?-1:1;return n.dir==="desc"?-s:s}function ic(e){let t=Array.isArray(e)?e.filter(Yi):[];return(n,r)=>{for(let l of t){let a=Jl(n,r,l);if(a!==0)return a}let o=Jl(n,r,{key:"created",dir:"asc"});if(o!==0)return o;let s=n.id,i=r.id;return s<i?-1:s>i?1:0}}var w_=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function ec(e){let t=e&&e.metadata,n=t?t.task_order:void 0;if(n==null||n==="")return Number.POSITIVE_INFINITY;let r=Number(n);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function tc(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let n=w_.exec(t);if(!n)return Number.POSITIVE_INFINITY;let r=Number(n[1]);return Number.isFinite(r)?r:Number.POSITIVE_INFINITY}function ac(e,t){let n=ec(e),r=ec(t);if(n!==r)return n<r?-1:1;let o=tc(e),s=tc(t);if(o!==s)return o<s?-1:1;let i=$n(e&&e.created_at),l=$n(t&&t.created_at);if(i!==l)return i<l?-1:1;let a=e&&e.id,u=t&&t.id;return a===u?0:String(a)<String(u)?-1:1}var Ki=2**20;function qr(e,t){let n=e&&e.id;return t&&typeof n=="string"&&Object.prototype.hasOwnProperty.call(t,n)&&typeof t[n]=="number"&&Number.isFinite(t[n])?t[n]:-$n(e&&e.created_at)}function lc(e){return(t,n)=>{let r=qr(t,e),o=qr(n,e);if(r!==o)return r<o?-1:1;let s=t?.id,i=n?.id;return s<i?-1:s>i?1:0}}function Vi(e,t,n){let r=Array.isArray(e)?e:[],o=r.length,s=Math.max(0,Math.min(t,o-1)),i=s-1>=0?r[s-1]:null,l=s+1<o?r[s+1]:null;if(!i&&!l)return{rank:0};if(!i)return{rank:qr(l,n)-Ki};if(!l)return{rank:qr(i,n)+Ki};let a=qr(i,n),u=qr(l,n),d=(a+u)/2;return a<d&&d<u?{rank:d}:{renormalize:r.map((_,h)=>({bead_id:_.id,rank:h*Ki}))}}function Xi(e,t={}){let n=Ct(`issue-store:${e}`),r=new Map,o=[],s=0,i=new Set,l=!1,a=t.sort||ho;function u(){for(let h of Array.from(i))try{h()}catch{}}function d(){o=Array.from(r.values()).sort(a)}function _(h){if(l||!h||h.id!==e)return;let m=Number(h.revision)||0;if(n("apply %s rev=%d",h.type,m),!(m<=s&&h.type!=="snapshot")){if(h.type==="snapshot"){if(m<=s)return;r.clear();let w=Array.isArray(h.issues)?h.issues:[];for(let C of w)C&&typeof C.id=="string"&&C.id.length>0&&r.set(C.id,C);d(),s=m,u();return}if(h.type==="upsert"){let w=h.issue;if(w&&typeof w.id=="string"&&w.id.length>0){let C=r.get(w.id);if(!C)r.set(w.id,w);else{let F=Number.isFinite(C.updated_at)?C.updated_at:0,z=Number.isFinite(w.updated_at)?w.updated_at:0;if(F<=z){for(let ae of Object.keys(C))ae in w||delete C[ae];for(let[ae,X]of Object.entries(w))C[ae]=X}}d()}s=m,u()}else if(h.type==="delete"){let w=String(h.issue_id||"");w&&(r.delete(w),d()),s=m,u()}}}return{id:e,subscribe(h){return i.add(h),()=>{i.delete(h)}},applyPush:_,snapshot(){return o},size(){return r.size},getById(h){return r.get(h)},dispose(){l=!0,r.clear(),o=[],i.clear(),s=0}}}function gs(e){let t=String(e.type||"").trim(),n={};if(e.params&&typeof e.params=="object"){let o=Object.keys(e.params).sort();for(let s of o){let i=e.params[s];n[s]=String(i)}}let r=new URLSearchParams(n).toString();return r.length>0?`${t}?${r}`:t}function cc(e){let t=Ct("subs"),n=new Map,r=new Map;function o(l,a){t("applyDelta %s +%d ~%d -%d",l,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let u=r.get(l);if(!u||u.size===0)return;let d=Array.isArray(a.added)?a.added:[],_=Array.isArray(a.updated)?a.updated:[],h=Array.isArray(a.removed)?a.removed:[];for(let m of Array.from(u)){let w=n.get(m);if(!w)continue;let C=w.itemsById;for(let F of d)typeof F=="string"&&F.length>0&&C.set(F,!0);for(let F of _)typeof F=="string"&&F.length>0&&C.set(F,!0);for(let F of h)typeof F=="string"&&F.length>0&&C.delete(F)}}async function s(l,a){let u=gs(a);if(t("subscribe %s key=%s",l,u),!n.has(l))n.set(l,{key:u,itemsById:new Map});else{let _=n.get(l);if(_&&_.key!==u){let h=r.get(_.key);h&&(h.delete(l),h.size===0&&r.delete(_.key)),n.set(l,{key:u,itemsById:new Map})}}r.has(u)||r.set(u,new Set);let d=r.get(u);d&&d.add(l);try{await e("subscribe-list",{id:l,type:a.type,params:a.params})}catch(_){let h=n.get(l)||null;if(h){let m=r.get(h.key);m&&(m.delete(l),m.size===0&&r.delete(h.key))}throw n.delete(l),_}return async()=>{t("unsubscribe %s key=%s",l,u);try{await e("unsubscribe-list",{id:l})}catch{}let _=n.get(l)||null;if(_){let h=r.get(_.key);h&&(h.delete(l),h.size===0&&r.delete(_.key))}n.delete(l)}}return{subscribeList:s,_applyDelta:o,_subKeyOf:gs,selectors:{getIds(l){let a=n.get(l);return a?Array.from(a.itemsById.keys()):[]},has(l,a){let u=n.get(l);return u?u.itemsById.has(a):!1},count(l){let a=n.get(l);return a?a.itemsById.size:0},getItemsById(l){let a=n.get(l),u={};if(!a)return u;for(let d of a.itemsById.keys())u[d]=!0;return u}}}}function uc(){let e=Ct("issue-stores"),t=new Map,n=new Map,r=new Set,o=new Map;function s(){for(let a of Array.from(r))try{a()}catch{}}function i(a,u,d){let _=u?gs(u):"",h=n.get(a)||"",m=t.has(a);if(e("register %s key=%s (prev=%s)",a,_,h),m&&h&&_&&h!==_){let w=t.get(a);if(w)try{w.dispose()}catch{}let C=o.get(a);if(C){try{C()}catch{}o.delete(a)}let F=Xi(a,d);t.set(a,F);let z=F.subscribe(()=>s());o.set(a,z)}else if(!m){let w=Xi(a,d);t.set(a,w);let C=w.subscribe(()=>s());o.set(a,C)}return n.set(a,_),()=>l(a)}function l(a){e("unregister %s",a),n.delete(a);let u=t.get(a);u&&(u.dispose(),t.delete(a));let d=o.get(a);if(d){try{d()}catch{}o.delete(a)}}return{register:i,unregister:l,getStore(a){return t.get(a)||null},snapshotFor(a){let u=t.get(a);return u?u.snapshot().slice():[]},subscribe(a){return r.add(a),()=>r.delete(a)}}}function dc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function pc(){let e=null,t=new Set;function n(){for(let r of Array.from(t))try{r()}catch{}}return{get(){return e},set(r){e=r,n()},clear(){e=null,n()},subscribe(r){return t.add(r),()=>t.delete(r)}}}function Qi(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function k_(e){let t=String(e||""),n=t.startsWith("#")?t.slice(1):t,r=n.indexOf("?"),o=r>=0?n.slice(r+1):"";if(o){let l=new URLSearchParams(o).get("issue");if(l)return decodeURIComponent(l)}let s=/^\/issue\/([^\s?#]+)/.exec(n);return s&&s[1]?decodeURIComponent(s[1]):null}function $_(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function fc(e){let t=Ct("router"),n=()=>{let r=window.location.hash||"",o=/^#\/issue\/([^\s?#]+)/.exec(r),s=o&&o[1]?decodeURIComponent(o[1]):k_(r),i=$_(r);if(t("hash change \u2192 view=%s id=%s",i,s),e.setState({selected_id:i==="worker"?null:s,view:i,worker:{selected_parent_id:i==="worker"?s:null}}),!!o||/^#\/(issues|epics)(\b|\/|\?|$)/.test(r)){let a=s?`#/${i}?issue=${encodeURIComponent(s)}`:`#/${i}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",n),n()},stop(){window.removeEventListener("hashchange",n)},gotoIssue(r){let o=e.getState?e.getState():{view:"board"},s=o.view==="worker"||o.view==="monitor"?o.view:"board",i=Qi(s,r);t("goto issue %s (view=%s)",r,s),window.location.hash!==i?window.location.hash=i:e.setState({selected_id:s==="worker"?null:r,view:s,worker:{selected_parent_id:s==="worker"?r:null}})},gotoView(r){let o=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},s=r==="worker"?o.worker?.selected_parent_id:o.selected_id,i=s?Qi(r,s):`#/${r}`;t("goto view %s (id=%s)",r,s||""),window.location.hash!==i?window.location.hash=i:e.setState({view:r,selected_id:r==="worker"?null:o.selected_id})}}}var x_=Object.freeze({workspace_config:{default_workspace:null}});function _c(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:x_.workspace_config.default_workspace}}}function mc(e={}){let t=Ct("state"),n={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:_c(e.config)},r=new Set;function o(){for(let s of Array.from(r))try{s(n)}catch{}}return{getState(){return n},setState(s){let i={...n,...s,filters:{...n.filters,...s.filters||{}},board:{...n.board,...s.board||{}},worker:{...n.worker,...s.worker||{}},workspace:{current:s.workspace?.current!==void 0?s.workspace.current:n.workspace.current,available:s.workspace?.available!==void 0?s.workspace.available:n.workspace.available,hidden:s.workspace?.hidden!==void 0?s.workspace.hidden:n.workspace.hidden},config:s.config!==void 0?_c(s.config):n.config},l=i.workspace.current?.path!==n.workspace.current?.path||i.workspace.available.length!==n.workspace.available.length||i.workspace.hidden.length!==n.workspace.hidden.length||i.workspace.hidden.some((u,d)=>u!==n.workspace.hidden[d]),a=i.config.workspace_config.default_workspace!==n.config.workspace_config.default_workspace;i.selected_id===n.selected_id&&i.view===n.view&&i.filters.status===n.filters.status&&i.filters.search===n.filters.search&&i.filters.type===n.filters.type&&i.board.closed_filter===n.board.closed_filter&&i.worker.selected_parent_id===n.worker.selected_parent_id&&i.worker.show_closed_children.length===n.worker.show_closed_children.length&&i.worker.show_closed_children.every((u,d)=>u===n.worker.show_closed_children[d])&&!l&&!a||(n=i,t("state change %o",{selected_id:n.selected_id,view:n.view,filters:n.filters,board:n.board,worker:n.worker,workspace:n.workspace.current?.path,config:{default_workspace:n.config.workspace_config.default_workspace}}),o())},subscribe(s){return r.add(s),()=>r.delete(s)}}}function gc(e){let t=Ct("activity"),n=0,r=new Map,o=1;function s(){if(!e)return;let u=n>0;e.toggleAttribute("hidden",!u),e.setAttribute("aria-busy",u?"true":"false")}function i(){n+=1,t("start count=%d",n),s()}function l(){let u=n;n=Math.max(0,n-1),u<=0?t("done called but count was already %d",u):t("done count=%d\u2192%d",u,n),s()}function a(u){return async(_,h)=>{let m=o++,w=Date.now();r.set(m,{type:_,start_ts:w}),t("request start id=%d type=%s count=%d",m,_,n+1),i();let C=!1,F=()=>{C||(C=!0,r.delete(m),l())},z=setTimeout(()=>{C||(t("request TIMEOUT id=%d type=%s elapsed=%dms",m,_,Date.now()-w),F())},3e4);try{let ae=await u(_,h),X=Date.now()-w;return t("request done id=%d type=%s elapsed=%dms",m,_,X),ae}catch(ae){let X=Date.now()-w;throw t("request error id=%d type=%s elapsed=%dms err=%o",m,_,X,ae),ae}finally{clearTimeout(z),F()}}}return s(),{wrapSend:a,start:i,done:l,getCount:()=>n,getActiveRequests:()=>{let u=Date.now();return Array.from(r.entries()).map(([d,_])=>({id:d,type:_.type,elapsed_ms:u-_.start_ts}))}}}function he(e,t="info",n=2800){let r=document.createElement("div");r.className="toast",r.textContent=e,r.style.position="fixed",r.style.right="12px",r.style.bottom="12px",r.style.zIndex="1000",r.style.color="#fff",r.style.padding="8px 10px",r.style.borderRadius="4px",r.style.fontSize="12px",t==="success"?r.style.background="#156d36":t==="warning"?r.style.background="#a36a00":t==="error"?r.style.background="#9f2011":r.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(r),setTimeout(()=>{try{r.remove()}catch{}},n)}function Fr(e=void 0,t=void 0){function n(){if(!t||typeof t.get!="function")return null;let s=t.get();return s&&s.order?s.order:{}}function r(s,i,l){let a=e&&e.snapshotFor?e.snapshotFor(s).slice():[];if(i==="closed")return a.sort(sc),a;switch(l){case"created_desc":return a.sort(ho),a;case"created_asc":return a.sort(nc),a;case"updated_desc":return a.sort(rc),a;case"priority":return a.sort(oc),a;case"manual":default:{let u=n();return u?a.sort(lc(u)):a.sort(ho),a}}}function o(s){let i=[];return e&&typeof e.subscribe=="function"&&i.push(e.subscribe(s)),t&&typeof t.subscribe=="function"&&i.push(t.subscribe(s)),()=>{for(let l of i)try{l()}catch{}}}return{selectBoardColumn:r,subscribe:o}}function tr(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function Ht(e){let t=tr(e);if(t===null)return"";let n=new Date(t),r=o=>String(o).padStart(2,"0");return`${n.getFullYear()}-${r(n.getMonth()+1)}-${r(n.getDate())} ${r(n.getHours())}:${r(n.getMinutes())}`}function nn(e,t){let n=tr(e);if(n===null)return"";let o=(typeof t=="number"?t:Date.now())-n;if(o<6e4)return"\uBC29\uAE08";let s=Math.floor(o/6e4);if(s<60)return`${s}\uBD84 \uC804`;let i=Math.floor(o/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let l=Math.floor(o/864e5);if(l<7)return`${l}\uC77C \uC804`;let a=Math.floor(l/7);if(l<30)return`${a}\uC8FC \uC804`;let u=Math.floor(l/30);return u<12?`${u}\uAC1C\uC6D4 \uC804`:`${Math.floor(l/365)}\uB144 \uC804`}function hc(e){if(!Array.isArray(e))return null;let t=null,n=-1;for(let r of e){if(!r||r.status!=="in_progress")continue;let o=tr(r.updated_at)??0;if(t===null||o>n){t=r,n=o;continue}o===n&&String(r.id)<String(t.id)&&(t=r)}return t}function hs(e){let t=e&&e.parent;return typeof t=="string"?t:t&&t.id?String(t.id):""}function bs(e){let t=new Map;for(let r of e)r&&r.id&&!t.has(r.id)&&t.set(r.id,r);let n=new Map;for(let r of t.values()){let o=hs(r);if(!o)continue;let s=n.get(o);s||(s=[],n.set(o,s)),s.push({id:r.id,title:r.title,status:r.status,metadata:r.metadata,workflow:r.workflow,created_at:r.created_at,updated_at:r.updated_at})}return n}function ys(e,t){let n=e.get(t)||[],r=0;for(let s of n)(s.status==="resolved"||s.status==="closed")&&(r+=1);let o=hc(n);return{total:n.length,count:r,current:o,children:n}}function bc(e){let t=e.transport,n=e.uiOrderStore;function r(i,l){return"renormalize"in i?i.renormalize:[{bead_id:l,rank:i.rank}]}function o(i,l){let a={...i.order};for(let u of l)a[u.bead_id]=u.rank;n&&n.set({revision:i.revision,order:a})}async function s(i,l,a){if(!t||!n)return;let u=n.get()||{revision:0,order:{}},d=r(Vi(l,a,u.order),i);o(u,d);let _=await t("ui-order-set",{expected_revision:u.revision,entries:d});if(_&&_.conflict){let h={revision:typeof _.revision=="number"?_.revision:0,order:_.order||{}};n.set(h);let m=r(Vi(l,a,h.order),i);o(h,m);let w=await t("ui-order-set",{expected_revision:h.revision,entries:m});w&&w.applied&&n.set({revision:typeof w.revision=="number"?w.revision:0,order:w.order||{}})}else _&&_.applied&&n.set({revision:typeof _.revision=="number"?_.revision:0,order:_.order||{}})}return{applyReorder:s}}function yc(e){if(typeof e!="string")return"";let t=e.indexOf("-");return t>0?e.slice(0,t):""}function Un(e,t){let n=yc(e),r=yc(t);return n.length===0||r.length===0?!1:n!==r}function vs(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Zi(e,t){return!t||typeof e!="string"||e.length===0||vs(t.visible_labels).includes(e)?!0:vs(t.hidden_labels).includes(e)?!1:!vs(t.hidden_prefixes).some(n=>n.length>0&&e.startsWith(n))}function vc(e,t){return vs(e).filter(n=>Zi(n,t))}function nr(e,t){let n=e&&e.chips?e.chips[t]:void 0;return typeof n=="boolean"?n:!0}function A_(e){switch(e){case"in_progress":return"board-card__dot board-card__dot--progress";case"resolved":return"board-card__dot board-card__dot--resolved";case"closed":return"board-card__dot board-card__dot--closed";case"blocked":return"board-card__dot board-card__dot--blocked";default:return"board-card__dot"}}function S_(e,t,n,r,o){return c`<button
  ...
  >`}function Ji(e){return e==="delegated"?"\uC704\uC784":e==="main"?"\uBA54\uC778":null}function $s(e){return e.effort?`${e.actor}:${e.effort}`:e.actor}function Wn(e){return`${e.kind}:${$s(e)}@${e.sha}`}function xs(e,t){if(!e)return null;let n=Ji(e.kind),r=e.reason,o=e.kind==="delegated"?r===null:typeof r=="string"&&r.trim().length>0&&!/[\r\n]/.test(r);if(!n||!o)return null;let s=Ji(t?.kind),i=s!==null&&t?.kind!==e.kind,l=`\uACC4\uD68D \xB7 ${n}${i?` \u2192 ${s}`:""}`,a=`planned_execution ${e.kind}${typeof r=="string"?`:${r}`:""}`,u=t?` \xB7 exec_receipt ${Wn(t)}`:"";return{kind:e.kind,label:l,title:`${a}${u}`}}function Ec(e,t){let n=xs(e,t);return n?c`<span
        ...
        title=${n.title}
        >${n.label}</span
      >`:null}function P_(e){if(!e)return null;let t=Ji(e.kind);return t?c`<span
...
`)}function Gn(e,t){let n={claude:In(),codex:In()},r={orchestrator:{claude:In(),codex:In()},implementation:{claude:In(),codex:In()},"review-consult":{claude:In(),codex:In()},subagent:{claude:In(),codex:In()}},o=new Set;for(let l of Object.values(e||{})){if(!l||l.bead_id!==t)continue;let a=l.usage;if(qc(a)){let d=dm(l.runner),_=Fc(a),h={provider:d,role:"orchestrator",attempt_id:String(l.attempt_id||""),usage:_,subtotal:jc(d,_)};_.replayed===!0&&(h.replayed=!0),typeof l.model=="string"&&(h.model=l.model),typeof l.session_id=="string"&&(h.session_id=l.session_id),Es(n[d],h,!0),Es(r.orchestrator[d],h,!0)}let u=Array.isArray(l.usage_legs)?l.usage_legs:[];for(let d of u){let _=d&&d.provider==="claude"?"claude":"codex";if(!d||d.provider!=="codex"&&d.provider!=="claude"||!om[_].includes(d.role)||!qc(d.usage))continue;let h=typeof d.receipt_id=="string"&&d.receipt_id.length>0?d.receipt_id:null;if(!h||o.has(h))continue;o.add(h);let m=Fc(d.usage),w={provider:_,role:d.role,attempt_id:String(l.attempt_id||""),usage:m,subtotal:jc(_,m)};w.receipt_id=h,typeof d.agent_type=="string"&&(w.agent_type=d.agent_type),typeof d.agent_id=="string"&&(w.agent_id=d.agent_id),typeof d.model=="string"&&(w.model=d.model),typeof d.effort=="string"&&d.effort.trim().length>0&&(w.effort=d.effort),typeof d.session_id=="string"?w.session_id=d.session_id:typeof d.thread_id=="string"&&(w.session_id=d.thread_id),typeof d.turn_id=="string"&&(w.turn_id=d.turn_id),(typeof d.completed_at=="string"||typeof d.completed_at=="number"&&Number.isFinite(d.completed_at))&&(w.completed_at=d.completed_at),m.replayed===!0&&(w.replayed=!0),Es(n[_],w,!1),Es(r[w.role][_],w,!1)}}let s={};for(let l of["claude","codex"]){let a=n[l];if(a.legs.length===0)continue;let u=Bc(a,!1);l==="claude"&&a.outer_count>0&&a.outer_cost_count===a.outer_count&&(u.total_cost_usd=a.outer_cost),s[l]=u}if(Object.keys(s).length===0)return null;let i={};for(let l of["orchestrator","implementation","review-consult","subagent"]){let a={};for(let u of["claude","codex"]){let d=r[l][u];d.legs.length>0&&(a[u]={...Bc(d,!0),legs:d.legs})}Object.keys(a).length>0&&(i[l]=a)}return{providers:s,roles:i}}var pm=".chip-popover, .judgement-chip";function Kr(e){let t=null,n=!1;function r(d){return t!==null&&t.bead_id===d.bead_id&&t.chip_key===d.chip_key}function o(d){t=r(d)?null:{...d},e()}function s(){t!==null&&(t=null,e())}function i(d){let _=d.target;t!==null&&(_&&typeof _.closest=="function"&&_.closest(pm)||s())}function l(d){d.key==="Escape"&&s()}function a(){n||(n=!0,document.addEventListener("click",i),document.addEventListener("keydown",l))}function u(){n&&(n=!1,document.removeEventListener("click",i),document.removeEventListener("keydown",l))}return{toggle:o,close:s,isOpen:r,attach:a,detach:u}}function Yr(e){return c`<div
    class="chip-popover"
    role="dialog"
    aria-label=${e.title}
  >
...
`);return c`<button
  ...
  >
    ...
    >${e.id}</span
  >`,C=e.lane==="done"?"":Ks(e.workflow),F=e.lane==="done"?"":$u(e.from_id),z=Vs(e.priority),ae=c`<span class="worker-mini__title">${e.title}</span>`,X=xu(e.pr_url,e.pr_number),N=r.map(ue=>ue===e.live_badge?c`<span
      ...
      >
        ...
        >
          승인하고 진행
        </button>`:"",ce=!!(e.lane!=="pr_wait"&&!e.done&&e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)),q=Ys(e.rec,eo(e,"rec")),we=Gs(e.cross_lane_chip),xe=Jr(e.log_path),A=m||we||C||F||ce||q||M||xe?c`<div class="worker-chips">
          ${m}${we}${C}${F}${ce?zs(e.exec_chips,{pin:e.exec_chips_pinned===!0}):""}${q}${M}${xe}${ka(e)}
  ...
  >
    ${a?c`<div class="worker-mini__row1">
          ...
          <div class="worker-mini__row2">
            ...
            ${ne}${A}${ge} ${to(e)}`}
  </div>`}function Dm(e,t){let n,r=[];for(let o of e){let s=o.group||"";s.length>0&&s!==n&&r.push(c`<div class="worker-card__place-group">${s}</div>`),n=s,r.push(c`<button
        type="button"
  ...
  >
    ...
    ${z||ae||X||N||O?c`<div class="worker-chips">
          ${z}${ae}${X}${N}${zs(e.exec_chips,{pin:n.exec_chips_mode==="pinned_only"})}
        </div>`:""}
    <div
...
`);else return null;let n=t.replace(Dh,"").trim();return n.length>0?{kind:"user",text:n}:null}function ll(e){let t=e.split(/\r?\n/).find(r=>r.trim().length>0)||"",n=Lh.exec(t);return n?{kind:"gate",gate:n[2]==="implementation"?"impl":n[2],reviewer:n[3],verdict:n[4],time:n[5]?n[5].trim():void 0,text:t.trim()}:Ih.test(t)&&t.trim().length<=80?{kind:"phase",text:t.trim()}:{kind:"assistant",text:e}}function Ph(e,t){if(e.subtype==="init"){let n=typeof e.model=="string"?e.model:"";return t.progress=null,[{kind:"thinking",text:n?`\uC138\uC158 \uC2DC\uC791 \xB7 ${n}`:"\uC138\uC158 \uC2DC\uC791"}]}if(e.subtype==="thinking_tokens"){let r=`\uC0DD\uAC01 \uC911\u2026 ${typeof e.estimated_tokens=="number"&&Number.isFinite(e.estimated_tokens)?Math.max(0,Math.round(e.estimated_tokens)):0} \uD1A0\uD070`;return t.progress?(t.progress.text=r,[]):(t.progress={kind:"thinking",text:r},[t.progress])}return[]}function Nh(e,t){let n=typeof e.parent_tool_use_id=="string"&&e.parent_tool_use_id.length>0?e.parent_tool_use_id:null;if(e.type==="assistant"){let r=e.message,o=r&&Array.isArray(r.content)?r.content:[],s=[];for(let i of o)if(Cn(i)){if(i.type==="text"&&typeof i.text=="string")s.push(ll(i.text));else if(i.type==="thinking"){let l=al(i.thinking);l&&s.push(l)}else if(i.type==="tool_use"){let l=Mh(i);typeof i.id=="string"&&t.set(i.id,l),s.push(l)}}return n?Ld(s,n):s}if(e.type==="user"){let r=e.message,o=r&&Array.isArray(r.content)?r.content:[];for(let i of o)if(Cn(i)&&i.type==="tool_result"){let l=t.get(String(i.tool_use_id));if(l){let a=Md(i.content);l.result=a,l.output=typeof i.content=="string"?i.content:a,i.is_error===!0&&(l.is_error=!0)}}let s=Dd(r&&r.content);return s?[s]:[]}if(e.type==="result"){let r=e.is_error===!1&&e.subtype==="success",o={kind:"result",success:r,text:typeof e.result=="string"?e.result:r?"DONE":""};return n?Ld([o],n):[o]}return[]}function Ld(e,t){for(let n of e)n.parent_tool_use_id=t;return e}function qh(e){let t=typeof e.command=="string"?e.command:"",n=Md(e.aggregated_output===void 0?e.output:e.aggregated_output),o=[typeof e.exit_code=="number"&&Number.isFinite(e.exit_code)?`exit ${e.exit_code}`:typeof e.status=="string"&&e.status.length>0?e.status:"",n].filter(i=>i.length>0).join(" \xB7 "),s={kind:"tool",tool:"shell",icon:Id.Bash,command:t,input:{command:t},expandable:!0};return o.length>0&&(s.result=o),typeof e.aggregated_output=="string"&&(s.output=e.aggregated_output),s}function Fh(e){if(e.type==="item.completed"&&Cn(e.item)){let t=e.item;if(t.type==="agent_message"&&typeof t.text=="string")return[ll(t.text)];if(t.type==="user_message"){let n=Dd(t.text);return n?[n]:[]}if(t.type==="reasoning"){let n=al(t.text);return n?[n]:[]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:t.type==="command_execution"?[qh(t)]:[]}if(e.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(e.type==="turn.failed"){let t=e.error;return[{kind:"error",text:t&&typeof t.message=="string"?t.message:"turn failed"}]}return e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}function jh(e){if(e.schema!=="codex-delegation-monitor-v1"||!Cn(e.event))return[];let t=e.event;if(t.type==="session.started"||t.type==="turn.started")return[];if((t.type==="item.started"||t.type==="item.completed")&&Cn(t.item)){let n=t.item;if(typeof n.id!="string"||n.id.length===0)return[];if(t.type==="item.completed"&&n.kind==="agent_message"&&typeof n.text=="string"&&n.text.trim().length>0)return[ll(n.text)];if(t.type==="item.completed"&&n.kind==="reasoning"){let l=al(n.text);return l?[l]:[]}if(n.kind!=="activity"||typeof n.activity!="string")return[];let r=Oh[n.activity];if(!r)return[];let o="\uC2DC\uC791",s="\u2026",i={kind:"tool",tool:"",icon:s,expandable:!1};if(t.type==="item.completed"){if(n.status==="completed")o="\uC644\uB8CC",s="\u2713";else if(n.status==="failed")o="\uC2E4\uD328",s="\u2717";else return[];i.result=""}return i.tool=`${r} \xB7 ${o}`,i.icon=s,[i]}return t.type==="turn.completed"&&t.status==="completed"?[{kind:"result",success:!0,text:"DONE"}]:t.type==="turn.failed"&&(t.status==="failed"||t.status==="interrupted")&&typeof t.error_code=="string"&&t.error_code.length>0?[{kind:"error",text:t.error_code}]:[]}function Bh(e){let t=e.type;return typeof t=="string"&&(t==="error"||t.startsWith("thread.")||t.startsWith("turn.")||t.startsWith("item."))}function Uh(e){let t=e;if(typeof e=="string"){let n=e.trim();if(n.length===0)return null;try{t=JSON.parse(n)}catch{return null}}return Cn(t)?t:null}function Pd(e={}){let t=e.skip_delegated===!0,n=new Map,r={progress:null};return{push(o){let s=Uh(o);if(!s)return[];if(t&&typeof s.parent_tool_use_id=="string"&&s.parent_tool_use_id.length>0)return[];if(s.type==="system"&&s.schema!=="codex-delegation-monitor-v1")return Ph(s,r);let i=s.schema==="codex-delegation-monitor-v1"?jh(s):Bh(s)?Fh(s):Nh(s,n);return i.length>0&&(r.progress=null),i}}}function cl(e){let t=[],n=Pd(),r=Array.isArray(e)?e:[];for(let o of r)for(let s of n.push(o))t.push(s);return t}var Wh=5,zh=10,Hh=/Task\s+#(\d+)/,Gh=/\bgh\s+pr\s+create\b|\bgit\s+push\b/,Kh=/\bnpm\s+(?:run\s+)?(?:test|tsc|lint|build)\b|\bvitest\b/;function Zo(e){return typeof e!="string"?"":(e.split(/\r?\n/).find(t=>t.trim().length>0)||"").trim()}function Yh(e){return typeof e!="string"||e.length===0?0:e.split(/\r?\n/).length}function Vh(e){for(let t=e.length-1;t>=0;t-=1){let n=e[t];if(n.kind==="phase"||n.kind==="gate")return n.text||null}return null}function Xh(e){let t=new Map,n=0;for(let o of e){if(o.kind!=="tool")continue;n+=1;let s=o.input||{};if(o.tool==="TaskCreate"){let a=Hh.exec(o.output||o.result||""),u=String(s.activeForm||s.subject||"").trim();if(!a||u.length===0)continue;t.set(a[1],{label:u,active:s.status==="in_progress"?n:0});continue}if(o.tool!=="TaskUpdate")continue;let i=t.get(String(s.taskId??""));if(!i)continue;let l=s.activeForm||s.subject;typeof l=="string"&&l.trim().length>0&&(i.label=l.trim()),typeof s.status=="string"&&(i.active=s.status==="in_progress"?n:0)}let r=null;for(let o of t.values())o.active>0&&(!r||o.active>r.active)&&(r=o);return r?r.label:null}function Qh(e){if(e.tool==="Bash"){let t=e.command||"";return Gh.test(t)?"~ PR/\uAC8C\uC2DC \uC911":Kh.test(t)?"~ \uAC80\uC99D \uC911":null}return e.tool==="Edit"||e.tool==="Write"||e.tool==="MultiEdit"?"~ \uAD6C\uD604 \uC911":e.tool==="Read"||e.tool==="Grep"||e.tool==="Glob"?"~ \uD0D0\uC0C9 \uC911":null}function Zh(e){let t=e.filter(o=>o.kind==="tool").slice(-zh),n=new Map;t.forEach((o,s)=>{let i=Qh(o);if(!i)return;let l=n.get(i)||{count:0,last:-1};l.count+=1,l.last=s,n.set(i,l)});let r=null;for(let[o,s]of n)(!r||s.count>r.count||s.count===r.count&&s.last>r.last)&&(r={label:o,count:s.count,last:s.last});return r?r.label:null}function Jh(e){let t=Vh(e);if(t)return{text:t,guess:!1};let n=Xh(e);if(n)return{text:n,guess:!1};let r=Zh(e);return r?{text:r,guess:!0}:null}function eb(e,t){if(typeof e!="number")return"";let n=Math.max(0,Math.floor((t-e)/1e3));return n<60?`${n}\uCD08 \uC804`:nn(e,t)}function io(e,t={}){let{transport:n,sessionLogStore:r,onClose:o}=t,s=null,i=null,l=null,a=null,u=null,d=!1,_={},h=!0,m=new Set,w=new Set,C=null,F=null,z=!1,ae=!1,X=!1,N=null,O=null;function M(){z=!1,ae=!1,X=!1,N=null,O=null}async function B(V){if(n){ae=!0,X=!1,Ie();try{let j=await Promise.resolve(n("get-attempt-prompt",{attempt_id:V,...u?{root_dir:u}:{}}));if(s!==V)return;!j||typeof j!="object"||Array.isArray(j)?X=!0:(N=j,O=V)}catch{s===V&&(X=!0)}finally{s===V&&(ae=!1,Ie())}}}function Q(){if(z=!z,z&&s&&O!==s){B(s);return}Ie()}function oe(){if(!z)return"";let V=so({loading:ae,error:X});if(V)return c`<div class="sv__prompt" data-seam="attempt-prompt">
      ...
      </div>`}if(j.kind==="error")return c`<div class="sv__error">⛔ ${j.text}</div>`;if(j.kind==="blocker")return c`<div class="sv__error">⛔ ${j.text}</div>`;if(j.kind==="tool"){let Ne=m.has(V),ct=j.tool==="Bash"?Yh(j.command):0,Je=j.tool==="Bash"?ct>1?Zo(j.command):j.command:j.path||j.command||"";return c`<div
...
`)}function ge(){if(!s)return c``;let V=D(),j=(i?[_.agent_type,_.model,_.effort]:[_.runner,_.model,_.effort]).filter(Boolean).join(" \xB7 "),Ne=_.session_id||"",ct=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${h?"ON":"OFF"}`,Je=U(),y=Je?eb(Y(),Date.now()):"",W=Je?we(V):null,Ee=Je?xe(V):null,Ce=Jh(V);return c`<div class="sv" data-attempt-id=${s}>
      <div class="sv__bar">
        <span class="sv__id"
      ...
      ${W||Ee?c`<div class="sv__now">
            ...
            ${W?c`<span class="sv__now-icon">${W.icon}</span>
                  ...
                  <span class="sv__now-detail"
                    >${W.tool==="Bash"?Zo(W.command):W.path||W.command||""}</span
                  >`:""}
...
`).trim()}}var qd=20;function Fd(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),s=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${o}:${s}`}function ib(e){return e.length>qd?`${e.slice(0,qd)}\u2026`:e}function ab(e,t,n,r){let o=`${t.lane} ${ib(t.identifier)}`;return c`<div class="detail-report">
  ...
  </details>`}function mb(e){let t=[];if(e.workflow_mode&&t.push(e.workflow_mode.display),e.impl_dispatch?.value==="main")t.push("\uBA54\uC778");else if(e.impl_dispatch?.value==="delegated"){let n=e.impl_runtime?` ${e.impl_runtime.display}`:"";t.push(`\uC704\uC784${n}`)}for(let n of["impl_model","impl_effort","impl_speed"])e[n]?.resolution!=="not_applicable"&&t.push(e[n]?.display||"\uAE30\uBCF8\uAC12 \uD655\uC778 \uBD88\uAC00");return t.join(" \xB7 ")}function gb(e){if(!e||typeof e!="object")return null;let{kind:t,actor:n,effort:r,sha:o}=e;return typeof t!="string"||typeof n!="string"||typeof o!="string"?null:{kind:t,actor:n,effort:typeof r=="string"?r:null,sha:o}}function Hd(e,t={}){let n=e&&typeof e.metadata=="object"&&e.metadata?e.metadata:{},r=e&&typeof e.workflow=="object"&&e.workflow?e.workflow:{},o=r.stages||{},s=r.route||n.route||null,i=typeof n.pr_url=="string"?n.pr_url:"",l=typeof n.exec_receipt=="string"?n.exec_receipt:"",a=gb(r.exec_receipt),u=a?Wn(a):l,d=a?`${a.kind}:${a.actor}`:l.split("@")[0],_=xs(r.planned_execution,r.exec_receipt),h=r.chips?.pr?.number,m=typeof h=="number"?`PR #${h}`:"PR",w=To(n),C=w!==null&&t.isChipOpen?.("rec")===!0,F=C?xa({rec:w},"rec"):null;return c`<section class="detail-summary" data-seam="detail-summary">
...
${l}</pre
    ...
    ${o?c`<span class="detail-session__usage" title=${o.tooltip}
          >${o.label}</span
        >`:""}
  </div>`}function Mb(e,t,n,r){let o=e.status==="running"?null:t,i=(o?Qt({providers:{[e.provider]:{subtotal:o.subtotal,breakdown:o.usage,...o.replayed?{replayed:!0}:{}}},roles:{}}):[])[0],l=e.status==="running"?Jo(e.last_event_at):o?fl(o.completed_at):"",a=(e.provider==="claude"?["Claude",e.agent_type,Rb(e.model),e.effort]:["codex",e.model,e.effort]).filter(Boolean).join(" \xB7 "),u=Ob(e,o);return c`<button
    type="button"
  ...
  >
    ...
    ${i?c`<span class="detail-session__usage" title=${i.tooltip}
          >${i.label}</span
        >`:""}
  </button>`}function Db(e,t){return e.role===t.role&&(e.model===null||t.model===void 0||e.model===t.model)&&e.session_id===t.session_id}function Pb(e,t,n){let r=[],o=new Set,s=Array.isArray(e.delegation_sessions)?e.delegation_sessions:[];for(let d of s){let _=Lb(d);!_||o.has(_.launch_id)||Zd(_.agent_type)||(o.add(_.launch_id),r.push(_))}r.sort((d,_)=>(d.started_at||0)-(_.started_at||0));let i={};for(let{role:d,provider:_}of Si){let h=t?t.roles[d]?.[_]:null;i[d]=h?[...h.legs]:[]}let l=Si.flatMap(({role:d})=>i[d]),a=new Set,u=[];for(let{role:d,provider:_}of Si){for(let h of r.filter(m=>m.role===d&&m.provider===_)){let m=l.find(w=>w.receipt_id===h.launch_id)||null;m&&!Db(h,m)||(m&&a.add(m.receipt_id),u.push(Mb(h,m,e.attempt_id,n)))}for(let h of i[d])!a.has(h.receipt_id)&&!Zd(h.agent_type)&&u.push(Ib(d,_,h))}return u}function Nb(e,t){let n=typeof e.total_cost_usd=="number"&&Number.isFinite(e.total_cost_usd)?e.total_cost_usd:null,r=[...xb,{key:"cache_creation_input_tokens",label:t==="codex"?"\uCE90\uC2DC \uC4F0\uAE30":"\uCE90\uC2DC \uC0DD\uC131"},...t==="codex"&&typeof e.reasoning_output_tokens=="number"&&Number.isFinite(e.reasoning_output_tokens)?[{key:"reasoning_output_tokens",label:"\uCD94\uB860 \uCD9C\uB825"}]:[]];return c`<div class="detail-session__usage-detail">
  ...
  </div>`}var qb={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function Jo(e){if(typeof e!="number"||!Number.isFinite(e))return"";let t=new Date(e),n=String(t.getHours()).padStart(2,"0"),r=String(t.getMinutes()).padStart(2,"0");return`${n}:${r}`}function Fb(e){if(typeof e.exec_default_preset_id!="string"||e.exec_default_preset_id.length===0)return"";let t=e.exec_values&&typeof e.exec_values=="object"?Object.entries(e.exec_values).filter(([,r])=>typeof r=="string"&&r.length>0).map(([r,o])=>`${r}=${o}`).join(" \xB7 "):"",n=typeof e.exec_default_preset_revision=="number"?` r${e.exec_default_preset_revision}`:"";return c`<div
  ...
  >
  ...
  </div>`}function tp(e,t={},n={},r=[]){let o=Array.isArray(e)?e:[],s=Array.isArray(r)?r:[],i=[...s.filter(m=>m&&m.current===!0),...s.filter(m=>m&&m.current!==!0).sort((m,w)=>w.index-m.index)],l=i.map(m=>Bb(m,t)),a=n.expanded||new Set;if(o.length===0&&i.length===0)return c`
    ...
    >
      ...
      ${m.cause}
    </div>`},h=m=>{let w=Jd(aa(m));if(Qt(w).length===0&&!Gr(m.usage))return"";let C=a.has(m.attempt_id);return c`<button
      type="button"
  ...
  `}function Ub(e){let t=so(e);if(t)return t;let n=e.data;if(!n)return"";if(n.missing)return c`<div class="detail-prompt__missing">
  ...
  `}var Wb=["open","in_progress","deferred","resolved","closed"],zb=[0,1,2,3,4];function sp(e,t){let n=t.issueStores,r=t.onClose,o=t.transport,s=t.onNavigate,i=t.queueStore,l=t.execPresetStore,a=t.sessionLogStore,u=null,d=null,_={},h="",m=!1,w=[],C=!1,F={},z={claude:null,codex:null},ae=null,X=null,N=0,O=!1,M=!1,B="",Q="",oe="",D="",Y=!1;function U(){O=!1,M=!1,B="",Q="",oe="",D="",Y=!1}function Z(){z={claude:null,codex:null},ae=null,X=null,N+=1}async function Ae(){if(!o)return null;try{let v=await Promise.resolve(o("get-workspace-accounts",{}));return v&&typeof v.state=="string"?v:null}catch{return null}}async function be(v){try{let P=await fetch(v);if(!P.ok)return null;let G=await P.json();if(!G||typeof G!="object"||!Array.isArray(G.accounts))return null;let ve=G.accounts.filter(tt=>tt!==null&&typeof tt=="object"&&!Array.isArray(tt));return{accounts:ve,active:ve.find(tt=>tt.active===!0)||null}}catch{return null}}async function ce(v){X=v;let P=++N,[G,ve,tt]=await Promise.all([be("/api/claude-usage"),be("/api/codex-usage"),Ae()]);P!==N||v!==u||(z={claude:G,codex:ve},ae=tt,it())}let q=[],we=null,xe=null,A=!1,ne="",ge=!1,pe=0,Re=new Set;function ue(){q=[],we=null,xe=null,A=!1,ne="",ge=!1,pe+=1,Re.clear()}async function Ie(v){if(!o)return;let P=++pe;try{let G=await Promise.resolve(o("get-comments",{id:v}));if(P!==pe||v!==u)return;q=Array.isArray(G)?G:[],A=!1}catch{if(P!==pe||v!==u)return;A=!0}it()}function rt(){if(!o||!u)return;let v=d&&typeof d.comment_count=="number"?d.comment_count:null;if(we!==u){we=u,xe=v,Ie(u);return}v!==null&&v!==xe&&(xe=v,Ie(u))}function st(v){Re.has(v)?Re.delete(v):Re.add(v),it()}function I(v){let P=ne.trim().length===0;ne=v,P!==(v.trim().length===0)&&it()}async function le(){let v=ne.trim();if(!o||!u||v.length===0||ge)return;let P=u;ge=!0,it();let G=!1;try{let ve=await Promise.resolve(o("add-comment",{id:P,text:v}));Array.isArray(ve)&&ve.length>0&&(G=!0,P===u&&(q=ve,A=!1,ne="",xe=ve.length))}catch{G=!1}G||he("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),P===u&&(ge=!1),it()}let se={onToggle:st,onDraftInput:I,onSubmit:le},de=t.mdViewer||null,$e=null;de||($e=document.createElement("div"),$e.className="md-viewer-root",document.body.appendChild($e));let ie=de||Ai($e,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),Fe=document.createElement("div");Fe.className="session-log-root",document.body.appendChild(Fe);let Ke=io(Fe,{transport:o?(v,P)=>Promise.resolve(o(v,P)):void 0,sessionLogStore:a}),Qe=!1,Pe=!1,V=!1,j=null,Ne=null,ct=0;function Je(v){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${v}`}function y(){Qe=!1,Pe=!1,V=!1,j=null,Ne=null,ct+=1}async function W(v){if(!o)return;let P=++ct;Pe=!0,V=!1,it();try{let G=await Promise.resolve(o("get-bead-prompt",{bead_id:v}));if(P!==ct)return;!G||typeof G!="object"||Array.isArray(G)?V=!0:(j=G,Ne=Je(v))}catch{P===ct&&(V=!0)}finally{P===ct&&(Pe=!1,it())}}let Ee=[],Ce=null,je=0;function Ve(v,P){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${v}::${P}`}function dt(){Ee=[],Ce=null,je+=1}async function wt(v,P){if(!o)return;let G=++je,ve;try{ve=await Promise.resolve(o("get-session-refs",{bead_id:v}))}catch{ve=null}G!==je||P!==Ce||(Ee=ve&&Array.isArray(ve.sessions)?ve.sessions:[],it())}function Lt(){if(!o||!u)return;let v=d&&d.metadata,P=v&&typeof v=="object"&&typeof v.session_ref=="string"?v.session_ref:null;if(P===null){dt();return}let G=Ve(u,P);Ce!==G&&(Ee=[],Ce=G,wt(u,G))}let kt=[],mt=[],Be=Er,L=null,J=0;function ye(v){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${v}`}function S(){kt=[],mt=[],Be=Er,L=null,J+=1}async function K(v,P){if(!o)return;let G=++J,ve;try{ve=await Promise.resolve(o("get-bead-timeline",{bead_id:v}))}catch{ve=null}G!==J||P!==L||(kt=ve&&Array.isArray(ve.events)?ve.events:[],mt=ve&&Array.isArray(ve.attempts)?ve.attempts:[],Be=Er,it())}function Me(){if(!o||!u)return;let v=ye(u);L!==v&&(kt=[],mt=[],Be=Er,L=v,K(u,v))}function ze(){Be+=Er,it()}function qe(){if(Qe=!Qe,Qe&&u&&Ne!==Je(u)){j=null,W(u);return}it()}function et(){let v={};for(let G of mt)G&&typeof G=="object"&&G.bead_id===u&&(v[String(G.attempt_id)]=G);let P=i?i.get():null;for(let G of P&&P.attempts?Object.values(P.attempts):[]){let ve=G;ve&&ve.bead_id===u&&(v[String(ve.attempt_id)]=ve)}return v}function Oe(){return u?Object.values(et()).sort((P,G)=>(G.started_at||0)-(P.started_at||0)).map(P=>({attempt_id:P.attempt_id,bead_id:P.bead_id,status:P.status,started_at:typeof P.started_at=="number"?P.started_at:null,runner:P.runner||null,model:P.model||null,effort:P.effort||P.observed_effort||null,speed:P.speed||null,session_id:P.session_id||null,resumed_from:P.resumed_from||null,continuation_mode:P.continuation_mode||null,dismissed_at:typeof P.dismissed_at=="number"?P.dismissed_at:null,cause:typeof P.cause=="string"?P.cause:null,cause_detail:P.cause_detail||null,exec_default_preset_id:typeof P.exec_default_preset_id=="string"?P.exec_default_preset_id:null,exec_default_preset_revision:typeof P.exec_default_preset_revision=="number"?P.exec_default_preset_revision:null,exec_values:P.exec_values&&typeof P.exec_values=="object"?P.exec_values:null,usage:P.usage||null,usage_legs:Array.isArray(P.usage_legs)?P.usage_legs:[],delegation_sessions:Array.isArray(P.delegation_sessions)?P.delegation_sessions:[]})):[]}function Ge(){return u?Gn(et(),u):null}let Ze=new Set;function bt(v){Ze.has(v)?Ze.delete(v):Ze.add(v),it()}function He(v){let P=i?i.get():null,G=P&&P.attempts?P.attempts[v]:null;Ke.open({attempt_id:v,meta:G?{runner:G.runner||void 0,model:G.model||void 0,effort:G.effort||void 0,status:G.status||void 0,session_id:G.session_id||void 0}:{}})}function xt(v,P){let G=i?i.get():null,ve=G&&G.attempts?G.attempts[v]:null,nt=(ve&&Array.isArray(ve.delegation_sessions)?ve.delegation_sessions:[]).find(gt=>gt&&typeof gt=="object"&&gt.launch_id===P);nt&&Ke.open({attempt_id:v,launch_id:P,meta:{runner:nt.provider==="claude"?"claude":"codex",role:nt.role,...typeof nt.agent_type=="string"?{agent_type:nt.agent_type}:{},model:nt.model,effort:nt.effort,session_id:nt.session_id,status:nt.status}})}async function qt(v){if(!o||!v)return;let P=await Wr();if(P===null)return;let G=()=>{let gt=i?i.get():null;return gt&&typeof gt.revision=="number"?gt.revision:0},ve=async(gt={},Xe=G())=>await o("worker-attempt-resume",{attempt_id:v,expected_revision:Xe,...P!==""?{instructions:P}:{},...gt}),tt=gt=>{gt?.queue&&i?.set&&i.set(gt.queue)},nt=await ve();if(tt(nt),nt&&nt.conflict){let gt=nt.queue&&typeof nt.queue.revision=="number"?nt.queue.revision:G();nt=await ve({},gt),tt(nt)}nt=await zn(nt,(gt,Xe)=>ve({continuation:gt,decision_token:Xe}),{onResult:tt,refresh:()=>ve()}),nt&&nt.resumed===!1&&!nt.conflict&&nt.reason&&he(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${nt.reason}`,"error",2400)}function at(v){!v||!u||Ke.open(zr(v,u,d&&d.status))}let Yt={onOpen:He,onOpenDelegation:xt,onResume:qt,onToggleUsage:bt,onOpenSessionRef:at,onCopyResumeCommand:f};function St(){let v=i?i.get():null,P={...F};for(let G of["orchestration_model","orchestration_effort","orchestration_speed"]){let ve=v&&v[G];typeof ve=="string"&&(P[G]=ve)}return P}async function It(){if(o){try{let v=await Promise.resolve(o("get-session-defaults",{}));F=v&&v.values&&typeof v.values=="object"?v.values:{}}catch{F={}}it()}}function Ut(){let v=i?i.get():null;return v&&v.runner_catalog||null}function Vt(){let v=i?i.get():null;return v&&typeof v.execution_defaults=="object"?v.execution_defaults:null}function Jt(){let v=d?.metadata&&typeof d.metadata=="object"?d.metadata:{},G=fn({pin:{...v,..._},global:St(),execution_defaults:Vt(),runner_catalog:Ut(),route:typeof v.route=="string"?v.route:null}).orchestration_model.value||"";return xn(Ut(),G)}function Wt(){let v=l?l.get():null;return!v||typeof v.revision!="number"?null:{revision:v.revision,presets:Array.isArray(v.presets)?v.presets:[]}}function Dt(v){return v?.compatible===!1}function un(v){l&&v&&typeof v.revision=="number"&&Array.isArray(v.presets)&&l.set({revision:v.revision,presets:v.presets})}async function Mt(){let v=Wt(),P=v?.presets.find(G=>G.id===h);if(!(!o||!u||!v||!P||Dt(P)||m)){m=!0,w=[],it();try{let G=await Promise.resolve(o("apply-impl-preset",tu(u,P.id,v.revision)));if(G&&G.conflict){un(G),he("\uD504\uB9AC\uC14B\uC774 \uBCC0\uACBD\uB410\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uBAA9\uB85D\uC5D0\uC11C \uB2E4\uC2DC \uC801\uC6A9\uD558\uC138\uC694.","error",4e3);return}let ve=G&&Array.isArray(G.issue)?G.issue[0]:G?.issue;if(G&&G.applied&&ve&&typeof ve=="object"){d=ve,w=Array.isArray(G.skipped_orchestration_keys)?G.skipped_orchestration_keys.filter(tt=>typeof tt=="string"):[];for(let tt of nu)delete _[tt];he(w.length>0?"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4. \uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 3\uD0A4\uB294 Bead\uC5D0 \uD540\uD560 \uC218 \uC5C6\uC5B4 \uAC74\uB108\uB6F0\uC5C8\uC2B5\uB2C8\uB2E4.":"\uC2E4\uD589 \uD504\uB9AC\uC14B\uC744 \uC801\uC6A9\uD588\uC2B5\uB2C8\uB2E4.","success",4e3);return}G&&G.error==="bd_readback_failed"?he("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):he("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}catch(G){G&&typeof G=="object"&&G.code==="bd_readback_failed"?he("\uC124\uC815\uC740 \uC804\uC1A1\uB410\uC9C0\uB9CC \uC801\uC6A9 \uC5EC\uBD80 \uD655\uC778\uC774 \uD544\uC694\uD569\uB2C8\uB2E4.","error",4e3):he("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328","error",4e3)}finally{m=!1,it()}}}let Gt=null;n&&n.subscribe&&(Gt=n.subscribe(()=>p()));let Ft=null;i&&typeof i.subscribe=="function"&&(Ft=i.subscribe(()=>{u&&it()}));let $t=null,fe=null;function T(){fe&&(fe(),fe=null)}l&&typeof l.subscribe=="function"&&($t=l.subscribe(()=>{u&&it()}));function ee(v){v.key==="Escape"&&u&&(v.preventDefault(),r())}document.addEventListener("keydown",ee);let Le=Kr(()=>it());Le.attach();function p(){if(u){if(n&&typeof n.snapshotFor=="function"){let v=n.snapshotFor("detail:"+u)||[];d=v.find(G=>G&&G.id===u)||v[0]||d}rt(),Lt(),Me(),it()}}function f(v){rn(v).then(P=>{P?he("\uBCF5\uC0AC\uB428","success",1200):he("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function k(v){v.preventDefault(),v.stopPropagation(),u&&f(u)}function R(v,P){v.preventDefault(),v.stopPropagation(),f(P)}function H(v,P,G){v.preventDefault(),v.stopPropagation(),ie.open(P,{missing_state:G})}async function re(v,P){let G=Object.hasOwn(_,v),ve=_[v];if(_[v]=P,it(),!(!o||!u))try{let tt=await Promise.resolve(o("update-exec-settings",eu(u,v,P.length===0?null:P))),nt=Array.isArray(tt)?tt[0]:tt;if(!nt||typeof nt!="object"||!nt.id)throw new Error("exec settings readback failed");d=nt,delete _[v],it()}catch(tt){throw G?_[v]=ve:delete _[v],it(),he("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error"),tt}}function _e(v){v.catch(()=>{})}async function ke(v,P){let G=d||{},ve=G.metadata&&typeof G.metadata=="object"?G.metadata:{},tt={};for(let Xe of["impl_runtime","impl_model","impl_effort"])tt[Xe]=Object.hasOwn(_,Xe)?_[Xe]:typeof ve[Xe]=="string"?ve[Xe]:"";tt[v]=P;let nt=su(tt,Ut(),Jt()),gt={};for(let Xe of["impl_runtime","impl_model","impl_effort"])gt[Xe]=_[Xe],_[Xe]=nt[Xe]||"";if(it(),!(!o||!u))return Promise.resolve(o("update-impl-target",{id:u,...nt,orchestration_runtime:Jt()})).then(Xe=>{let ut=Array.isArray(Xe)?Xe[0]:Xe;if(!ut||typeof ut!="object"||!ut.id)throw new Error("implementation target readback failed");d=ut;for(let kn of["impl_runtime","impl_model","impl_effort"])delete _[kn];it()}).catch(Xe=>{for(let ut of["impl_runtime","impl_model","impl_effort"])gt[ut]===void 0?delete _[ut]:_[ut]=gt[ut];throw it(),he("\uAD6C\uD604 target \uBCC0\uACBD \uC2E4\uD328","error"),Xe})}async function Ue(v,P,G){if(!o||!u)return!1;try{let ve=await Promise.resolve(o(v,P)),tt=Array.isArray(ve)?ve[0]:ve;return tt&&typeof tt=="object"&&tt.id?(d=tt,!0):(he(G,"error"),!1)}catch(ve){return ve&&typeof ve=="object"&&ve.code==="bd_readback_failed"?(he("\uC800\uC7A5\uB410\uC73C\uB098 \uD655\uC778 \uC2E4\uD328 \u2014 \uACE7 \uAC31\uC2E0\uB429\uB2C8\uB2E4","error"),{ok:!1,saved:!0}):(he(G,"error"),!1)}}function ft(v){setTimeout(()=>{try{let P=e.querySelector(v);P&&typeof P.focus=="function"&&P.focus()}catch{}},0)}function _t(){O=!0,B=d&&d.title||"",it(),ft('.detail-edit__input[data-edit="title"]')}function en(v){B=v.target.value}function $(){O=!1,B="",it()}function E(){Ue("edit-text",{id:u,field:"title",value:B},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(P=>{P===!0&&(O=!1,B=""),it()})}function Se(){M=!0,Q=d&&d.description||"",it(),ft('.detail-edit__textarea[data-edit="description"]')}function g(v){Q=v.target.value}function b(){M=!1,Q="",it()}function x(){Ue("edit-text",{id:u,field:"description",value:Q},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(P=>{P===!0&&(M=!1,Q=""),it()})}function te(v,P,G,ve){if(v.key==="Escape"){v.stopPropagation(),G();return}v.key==="Enter"&&(!ve||v.ctrlKey||v.metaKey)&&(v.preventDefault(),P())}function me(v){let P=v.target.value;Ue("update-status",{id:u,status:P},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>it())}function Te(v){let P=Number(v.target.value);Ue("update-priority",{id:u,priority:P},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>it())}function Ye(v){oe=v.target.value}function yt(){let v=oe.trim();v.length!==0&&Ue("label-add",{id:u,label:v},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(P=>{P===!0&&(oe=""),it()})}function jt(v){if(v.key==="Escape"){v.stopPropagation(),oe="",it();return}v.key==="Enter"&&(v.preventDefault(),yt())}function Xt(v){Ue("label-remove",{id:u,label:v},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>it())}let gn={onCopyPath:R,onOpenDoc:H};function Pn(v){return typeof v=="string"?v:v&&typeof v=="object"?String(v.id||v.to||v.issue_id||v.depends_on||""):""}function hn(v){return v&&typeof v=="object"?String(v.dependency_type||v.type||""):""}function Nn(v){switch(v){case"discovered-from":return{glyph:"\u21A9 ",relation:"\uBC1C\uACAC"};case"parent-child":return{glyph:"\u2338 ",relation:"\uC0C1\uC704"};case"related":return{glyph:"\u2194 ",relation:"\uAD00\uB828"};default:return v.length>0?{glyph:`${v} `,relation:v}:{glyph:"",relation:""}}}function wn(v,P){let G=Kt(P),ve=[];return v.length>0&&ve.push(v),G&&ve.push(G),ve.length>0?ve.join(`
`):void 0}function Kt(v){if(!v||typeof v!="object")return;let P=typeof v.status=="string"?v.status:"",G=typeof v.title=="string"?v.title:"";return P.length>0&&G.length>0?`${P} \xB7 ${G}`:void 0}function er(){return(t.getWorkspacePath&&t.getWorkspacePath()||"").trim()}function qn(){return t.depCandidates?t.depCandidates():null}async function Fn(v,P,G){let ve=er(),tt=u;if(!tt)return;if(ve.length===0){he("\uB808\uD3EC\uB97C \uC54C \uC218 \uC5C6\uC5B4 \uC758\uC874\uC744 \uBC14\uAFC0 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}let nt=await Ue(v,{a:tt,b:P,view_id:tt,root_dir:ve},G),gt=nt===!0||nt!==!1&&nt.saved===!0;gt&&t.onDepChanged&&t.onDepChanged({type:v,a:tt,b:P}),v==="dep-add"&&gt&&(D="",Y=!1),it()}function jn(v){if(!u)return;let P=globalThis.confirm;typeof P=="function"&&!P(`${v}\uAC00 ${u}\uB97C \uB9C9\uB294 \uC5F0\uACB0\uC744 \uB04A\uC744\uAE4C\uC694?`)||Fn("dep-remove",v,"\uC758\uC874 \uD574\uC81C \uC2E4\uD328")}function On(v){v.disabled||Fn("dep-add",v.bead_id,"\uC758\uC874 \uCD94\uAC00 \uC2E4\uD328")}function pr(v){D=v.target.value,Y=!0,it()}function We(){Y||(Y=!0,it())}function Pt(v,P){if(v.key==="Escape"){v.stopPropagation(),D="",Y=!1,it();return}v.key==="Enter"&&(v.preventDefault(),P.length===1&&!P[0].disabled&&On(P[0]))}function bn(v){return c`<div class="detail-dep-add">
      <input
    ...
    </div>`}function lo(v,P){let G=P.get(v.id),ve=s?c`<button
          type="button"
    ...
    >`}function rs(v){let P=Array.isArray(v.dependencies)?v.dependencies:[],G=Array.isArray(v.dependents)?v.dependents:[],ve=[];for(let Xe of P){let ut=Pn(Xe);ut.length>0&&hn(Xe)==="blocks"&&ve.push({id:ut,label:`\u26D3 ${ut}`,kind:"pred",title:wn("\uB9C9\uB294",Xe)})}for(let Xe of G){let ut=Pn(Xe);ut.length>0&&hn(Xe)==="blocks"&&ve.push({id:ut,label:`\u2192 ${ut}`,kind:"succ",title:wn("\uB9C9\uD788\uB294",Xe)})}for(let Xe of P){let ut=Pn(Xe),kn=hn(Xe);if(ut.length>0&&kn!=="blocks"){let El=Nn(kn);ve.push({id:ut,label:`${El.glyph}${ut}`,kind:"other",title:wn(El.relation,Xe)})}}let tt=qn(),nt=new Map;if(tt)for(let Xe of tt.issues)nt.has(Xe.bead_id)||nt.set(Xe.bead_id,Xe.root_dir);let gt=tt&&u?ed(Ju(u,tt),D):[];return c`
    ...
    `}let co={route:["quick_fix","spec_backed","full_plan"]};async function ss(v,P){let G=P.target.value;if(v==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&G!=="full_plan"&&!window.confirm(`full_plan \u2192 ${G||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){it();return}await Ue("update-workflow-meta",{id:u,key:v,value:G},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),it()}function De(v){let P=v.metadata||{};return c` ${((ve,tt)=>{let nt=co[ve],gt=typeof P[ve]=="string"?P[ve]:"";return c`<div class="detail-kv">
    ...
    `}function zf(v,P){return c`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${me}
        >
          ${Wb.map(G=>c`<option value=${G} ?selected=${G===v}>${G}</option>`)}
        </select>
      </div>
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Te}
        >
          ${zb.map(G=>c`<option value=${String(G)} ?selected=${G===P}>
                P${G}
              </option>`)}
        </select>
      </div>
    `}function Hf(v){return c`
      <div class="detail-title-row">
    ...
    `}function Gf(v){let P=typeof v.notes=="string"?v.notes:"";return P.trim().length===0?c``:c`
      <div class="detail-overlay__section-label">노트</div>
      <div class="detail-overlay__notes">${P}</div>
    `}function Kf(v){let P=Array.isArray(v.labels)?v.labels:[];return c`
    ...
    `}function Yf(){if(!u)return c``;let v=d||{},P=String(v.id||u),G=v.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",ve=Ge(),tt=v.status||"open",nt=typeof v.priority=="number"?Math.max(0,Math.min(4,v.priority)):"",gt=v.description||"",Xe={...v,metadata:{...v.metadata||{},..._}};return c`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${zd({metadata:Xe.metadata,workspace_values:St(),catalog:Ut(),execution_defaults:Vt(),expanded:C,presets:Wt()?.presets||[],preset_id:h,preset_busy:m,skipped_orchestration_keys:w},{onToggle:ut=>{C=ut,it()},onEdit:(ut,kn)=>{if(ut==="impl_runtime"||ut==="impl_model"||ut==="impl_effort"){_e(ke(ut,kn??""));return}_e(re(ut,kn??""))},onPresetSelect:ut=>{h=ut,w=[],it()},onPresetApply:()=>{Mt()}})}
  ...
  >
    ▤ 세션
  </button>`}function iy(e,t,n){if(!e)return"";let r=Zb(t?.summary),o=gp(t);return c`${r?c`<p class="rtile__held-summary">${r}</p>`:""}${o}
    <div class="rtile__foot">
      ...
      ${n}
    </div>`}function gl(e,t,n=null,r={}){let o=e.kind==="session",s=o&&Array.isArray(e.session_refs)&&e.session_refs.find(Ie=>Ie&&Ie.current===!0)||null,i=e.failed===!0,l=i&&e.failure||null,a=e.parked===!0&&!i,u=e.retry_wait===!0&&!i&&!a,d=a&&e.failure||null,_=a||u,h=!!e.paused,m=i||_?e.status_label||(a?"\uC138\uC158 \uB300\uAE30":u?"\uC7AC\uC2DC\uB3C4 \uB300\uAE30":e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):h?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Qb(t-e.started_at):"\u2014",w=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,C=yo(e),F=Qt(e.usage),z=Hn(e.usage),ae=e.conflict_resolution?h?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,X=e.base_exception||null,N=e.landing,O=e.attempt_id&&e.attempt_id===n,M=r.monitor||null,B=ty(M),Q=Gs(M?.cross_lane_chip),oe=M?Hs(M.dependency_chips):"",D=ry(M,t,h,o?{updated_at:e.updated_at??null,last_event_at:s&&s.locality==="local"?s.last_event_at:null}:null),Y=o&&e.workflow?.chips?.exec_receipt||null,U=Ks(e.workflow),Z=Ys(e.rec,e.chip_popover?.chip_key==="rec"),Ae=e.chip_popover?Yr(e.chip_popover.content):"",be=Y?c`<span
        class="ctl-chip ctl-chip--exec-receipt"
      ...
      >`:u?c`<span
        ...
        >${X}</span
      >`:""}${we}${xe}`,ne=o?"":to(e),ge=Ds(l?.quickfix_landing),pe=ge==="settlement"?"\uC815\uC0B0 \uC7AC\uAC1C":"\uC774\uC5B4\uD558\uAE30",Re=ge==="settlement"?"\uCC29\uC9C0 \uC815\uC0B0\uC744 \uB2E4\uC2DC \uC2E4\uD589":"\uAC19\uC740 \uC138\uC158\uC73C\uB85C \uC774\uC5B4\uC11C \uC9C4\uD589",ue=e.discard?.action&&!(i&&l?.landed===!0)?c`<button
          type="button"
  ...
  >
    <div class="rtile__hd">
      ...
      <div class="rtile__hd-actions">
        ${o?c`${typeof e.started_at=="number"?c`<span class="rtile__elapsed">${m}</span>`:""}${sy(s)}<span
    ...
    ${_?iy(a,d,ue):i?"":c`${D}${e.rollup?ws(e.rollup,{parent_id:e.bead_id,expanded:e.rollup_expanded===!0,childChips:ea}):""}
    ...
    >
    ...
    </div>`}function Ee(L,J){let ye=J?J.active:null;return pn(ye)?`\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(${L==="claude"?ye.email:ao({...ye,alias:null})})`:"\uAE30\uBCF8\uAC12 \uC0AC\uC6A9 \u2014 \uD604\uC7AC \uB85C\uADF8\uC778(\uD655\uC778 \uBD88\uAC00)"}function Ce(L,J,ye){let S=m[ye],K=Object.hasOwn(d,L)?d[L]:Zt,Me=ye==="claude"?xi:ao,ze=!!S?.accounts.some(qe=>qe.key===K);return c`<div class="settings-dialog__row">
      <span class="settings-dialog__row-label">${J}</span>
      <span class="settings-dialog__controls">
        <select
          aria-label=${J}
    ...
    </div>`}function kt(){let L=Q(),J={};for(let ye of Yn)J[ye]=Object.prototype.hasOwnProperty.call(F,ye)?F[ye]:L&&typeof L[ye]=="string"?L[ye]:null;return J}function mt(){let L=oe(),J=i.impl_runtime,ye=i.impl_model,S=Y(),K=Q(),Me=kt(),ze=So(L,C),qe=Xr(L,void 0).filter(at=>at!==mn),et=ua(L,C,Me.orchestration_model||mn).filter(at=>at!==mn),Oe=z?(S?.presets||[]).find(at=>at.id===z):null,Ge=Oe?Xc(Fe(),pn(Oe.settings)?Oe.settings:{}):null,Ze=K&&typeof K.slots=="number"?K.slots:Ii+1,bt=K&&typeof K.serial_lane_count=="number"?K.serial_lane_count:Ii,He=D()?.supported===!0,xt=je(),qt=da("workflow_mode",xo,i,D(),L);return c`
      ...
      ${a?c`<div class="settings-dialog__empty">불러오는 중…</div>`:c`
            ...
            <div class="settings-dialog__group">
              ...
              ${W("orchestration_speed","\uC18D\uB3C4",$o,le,Me)}
            </div>
            ...
            <div class="settings-dialog__group">
              ...
              ${Ve("\uC0AC\uC591 \uB9AC\uBDF0","spec","spec_review_model",Ao,"spec_review_effort")}
              ${Ve("\uACC4\uD68D \uB9AC\uBDF0","plan","plan_review_model",Os,"plan_review_effort")}
              ${Ve("\uAD6C\uD604 \uB9AC\uBDF0","impl","impl_review_model",Ao,"impl_review_effort")}
            </div>
            ...
            <div class="settings-dialog__group">
              ...
              ${W("impl_model","\uBAA8\uB378",Xr(L,J),ue,i)}
              ${W("impl_effort","effort",Qr(L,J,ye),ue,i)}
              ${W("impl_speed","\uC18D\uB3C4",$o,ue,i)}
  ...
  >
    ...
    >
      ...
      >
        ${wp()}
      </button>`}function Y(A){let ne=py(A);return ne?c`<div class="mon2-deck__chips">
      ...
      ${ne.worker?c`<span class="mon2-deck__chip" title=${ne.worker.title}
          ...
          >`:""}
    </div>`:""}function U(A){let ne=[];for(let[ge,pe]of[["queue","\uB300\uAE30"],["pr_wait","PR"],["session_active","\uC138\uC158"]]){let Re=hl(A,ge);Re>0&&ne.push(`${pe} ${Re}`)}return ne.join(" \xB7 ")}function Z(A){let ne=hl(A,"running"),ge=typeof A.slots=="number"?A.slots:1;return c`<div
    ...
    </div>`}function Ae(A){let ne=t.doneItems?t.doneItems():[],ge=t.rangeLabel?t.rangeLabel():"",pe=$p(Array.isArray(ne)?ne:[]),Re=ue=>A.reduce((Ie,rt)=>Ie+hl(rt,ue),0);return c`<div class="mon2-deck__bar">
      <span
...
`)}
  ...
  `}var Ty=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function Wp(e,t){let{transport:n,policyStore:r,labelOptions:o}=t,s=t.notify||(Z=>he(Z,"error",4e3)),i=document.createElement("dialog");i.id="settings-dialog",i.className="settings-dialog",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","\uC124\uC815"),e.appendChild(i);let l="execution",a=!1,u="",d=null;function _(){if(d)return d;let Z=i.querySelector('[data-pane="execution"]');return Z?(d=Mi(Z,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:s,onQueueAdopt:Ae=>t.queueStore?.set?.(Ae)}),d):null}function h(){return c`
    ...
    `}async function w(Z){let Ae=r.get();if(Ae)try{let be=await n("display-policy-set",{expected_revision:Ae.revision,policy:Z(Ae)});C(be),be&&be.conflict&&be.policy&&(be=await n("display-policy-set",{expected_revision:be.policy.revision,policy:Z(be.policy)}),C(be)),be&&be.conflict&&s("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{s("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function C(Z){Z&&Z.policy&&typeof Z.policy=="object"&&r.set(Z.policy)}function F(Z){w(Z)}function z(Z){let Ae=r.get();if(!Ae)return;let be=!Cy(Z,Ae);F(ce=>Ry(Z,ce,be))}function ae(){let Z=u.trim();Z.length!==0&&(u="",F(Ae=>Ae.hidden_prefixes.includes(Z)?{hidden_prefixes:Ae.hidden_prefixes}:{hidden_prefixes:[...Ae.hidden_prefixes,Z]}),O())}function X(Z){F(Ae=>({hidden_prefixes:Ae.hidden_prefixes.filter(be=>be!==Z)}))}function N(Z){let Ae=r.get();if(!Ae)return;let be=Ae.chips[Z]===!1;F(()=>({chips:{[Z]:be}}))}function O(){ot(c`
    ...
    </span>`}function O(ce,q,we){let xe=Zp(q,we),A=q.available&&(q.held||xe>bl),ne=A?`${Math.floor(xe/60)}\uBD84 \uC804 \uCE21\uC815`:"",ge=q.accounts.filter(Ie=>!Ie.active).length,pe=`usage-meter__group${A?" usage-meter__group--stale":""}`,Re=c`<span class="usage-meter__provider"
        >${ce.label}</span
      >
    ...
    </div>`}function U(){let ce=Date.now(),q=[];for(let xe of Vp){let A=s.get(xe.key);A&&q.push({provider:xe,snapshot:Fy(A,ce)})}if(q.length===0){m(),u();return}let we=q.find(xe=>xe.provider.key===n&&xe.snapshot.accounts.length>0);we||m(),ot(M(q,ce),e),e.hidden=!1,we?Z(we,ce):_()}function Z(ce,q){let we=d(),xe=e.getBoundingClientRect(),A=e.ownerDocument.documentElement.clientWidth;we.style.setProperty("--usage-meter-anchor-top",`${xe.bottom}px`),we.style.setProperty("--usage-meter-anchor-right",`${Math.max(0,A-xe.right)}px`),ot(c`<div
          class="usage-meter__scrim"
          aria-hidden="true"
          @mousedown=${ae}
        ></div>
        ${Y(ce,q)}`,we)}async function Ae(ce){try{let q=await fetch(ce.endpoint);return q.ok?qy(await q.json(),Date.now()):{kind:"error"}}catch{return{kind:"error"}}}async function be(){l+=1;let ce=l,q=await Promise.all(Vp.map(async we=>({provider:we,read:await Ae(we)})));if(!(t||ce!==l)){for(let we of q){let xe=we.provider.key;if(we.read.kind==="ok"){s.set(xe,we.read.snapshot);continue}if(we.read.kind==="empty"){s.delete(xe);continue}let A=s.get(xe);A!==void 0&&!A.held&&s.set(xe,{...A,held:!0})}U()}}return u(),be(),o=setInterval(()=>{be()},6e4),{destroy(){t=!0,o!==null&&(clearInterval(o),o=null),m(),u()}}}var jy="worker-ineligible";function Cr(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function ef(e){return Cr(e).includes(jy)}var By="worker-serial";function tf(e){return Cr(e).includes(By)}function Pi(e){let t=e?.blocked_info;return t&&typeof t=="object"?Array.isArray(t.blockers)?t.blockers.filter(r=>typeof r=="string"&&r.length>0):[]:(Array.isArray(e?.dependencies)?e.dependencies:[]).map(r=>{if(typeof r=="string")return r;if(!r||typeof r!="object")return"";let o=r.type??r.dependency_type;return o!==void 0&&o!=="blocks"?"":r.depends_on_id||r.id||""}).filter(Boolean)}var of="bdui.worker.candidate_sort",ts=Object.freeze([{id:"spec",label:"spec \uC6B0\uC120",chain:[{key:"spec",dir:"desc"},{key:"created",dir:"asc"}]},{id:"bottleneck",label:"\uBCD1\uBAA9 \uC6B0\uC120",chain:[{key:"priority",dir:"asc"},{key:"dependents",dir:"desc"},{key:"released",dir:"desc"}]},{id:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131",chain:[{key:"created",dir:"desc"},{key:"priority",dir:"asc"}]},{id:"updated",label:"\uCD5C\uC2E0 \uC218\uC815",chain:[{key:"updated",dir:"desc"}]}]),Ni=Object.freeze({preset:"spec"}),sf=3,af=Object.freeze([{key:"priority",label:"\uC6B0\uC120\uC21C\uC704"},{key:"dependents",label:"\uD6C4\uC18D \uC218"},{key:"released",label:"\uD574\uC81C \uC2DC\uAC01"},{key:"spec",label:"spec \uC720\uBB34"},{key:"created",label:"\uC0DD\uC131"},{key:"updated",label:"\uC218\uC815"}]);function nf(e){return ts.some(t=>t.id===e)}function rf(e){let t=ts.find(n=>n.id===e);return t?t.chain.map(n=>({...n})):[]}function Uy(e,t){return e.length===t.length&&e.every((n,r)=>n.key===t[r].key&&n.dir===t[r].dir)}function ns(e){return e&&"preset"in e?rf(e.preset):e&&Array.isArray(e.chain)?e.chain.map(t=>({...t})):rf("spec")}function yl(e){return e&&"preset"in e?e.preset:null}function Rr(e){if(typeof e=="string"){let s;try{s=JSON.parse(e)}catch{return nf(e)?{preset:e}:Ni}return Rr(s)}if(!e||typeof e!="object")return Ni;let t=e;if(nf(t.preset))return{preset:t.preset};let n=t.chain;if(!Array.isArray(n)||n.length===0||n.length>sf||!n.every(Yi))return Ni;let r=[];for(let s of n)r.some(i=>i.key===s.key)||r.push({key:s.key,dir:s.dir});let o=ts.find(s=>Uy(s.chain,r));return o?{preset:o.id}:{chain:r}}function lf(){try{return Rr(window.localStorage.getItem(of))}catch{return Ni}}function vl(e){try{window.localStorage.setItem(of,JSON.stringify(e))}catch{}}function cf(e,t,n){let r=e.map(a=>({...a}));if(!n)return r.slice(0,t);if(!Object.prototype.hasOwnProperty.call(ms,n))return r;let o=n;if(r.slice(0,t).some(a=>a.key===o))return r.slice(0,t);let s={key:o,dir:r[t]&&r[t].key===o?r[t].dir:ms[o]},i=r.slice(0,t),l=r.slice(t+1).filter(a=>a.key!==o);return[...i,s,...l].slice(0,sf)}function uf(e,t){return e.map((n,r)=>r===t?{key:n.key,dir:n.dir==="asc"?"desc":"asc"}:{...n})}function Wy(e){let t=new Set(e.map(l=>l.id)),n=new Map,r=new Map;for(let l of e){let a=Pi(l).filter(u=>t.has(u));n.set(l.id,a);for(let u of a){let d=r.get(u);d?d.push(l):r.set(u,[l])}}let o=new Set,s=[],i=l=>{o.add(l.id),s.push(l);for(let a of r.get(l.id)??[])!o.has(a.id)&&(n.get(a.id)??[]).every(u=>o.has(u))&&i(a)};for(;s.length<e.length;){let l=e.find(a=>!o.has(a.id)&&(n.get(a.id)??[]).every(u=>o.has(u)));i(l??e.find(a=>!o.has(a.id)))}return s}function df(e,t){let n=Array.isArray(e)?e.slice():[];return n.sort(ic(ns(t))),Wy(n)}function pf(e,t){let n=new Map;if(!e||typeof e!="object")return n;let r=e,o=[],s=new Set;for(let i of t){if(s.has(i.id))continue;s.add(i.id);let l=r[i.id];if(!l||!Array.isArray(l.scope))continue;let a=l.scope.filter(u=>typeof u=="string"&&u.length>0);if(a.length===0){n.set(i.id,{overlaps:[],scope_missing:!0});continue}n.set(i.id,{overlaps:[],scope_missing:!1}),o.push({member:i,scope:a})}for(let i=0;i<o.length;i+=1)for(let l=i+1;l<o.length;l+=1){let a=qs(o[i].scope,o[l].scope);if(a.length===0)continue;let u=o[i].member,d=o[l].member;n.get(u.id)?.overlaps.push({id:d.id,title:d.title,location_label:d.location_label,prefixes:a}),n.get(d.id)?.overlaps.push({id:u.id,title:u.title,location_label:u.location_label,prefixes:a})}return n}var ff=new Set(["sh","bash","zsh","dash","ksh"]),_f=/('(?:[^']*)'|"(?:\\.|[^"\\])*"|#.*|\$(?:\{[^}\n]*\}|[A-Za-z_][A-Za-z0-9_]*|[?#@*!$0-9-])|\b(?:if|then|else|elif|fi|for|while|until|do|done|case|esac|in|function|select|time)\b)/g;function mf(e){let t=e.split("/");return t[t.length-1]||""}function zy(e){let t=e.split(`
`,1)[0];if(!t.startsWith("#!"))return!1;let n=t.slice(2).trim().split(/\s+/).filter(Boolean);if(n.length===0)return!1;let r=mf(n[0]);if(r!=="env")return ff.has(r);let o=n.slice(1).find(s=>!s.startsWith("-")&&!s.includes("="));return o!==void 0&&ff.has(mf(o))}function Hy(e){return e.startsWith("#")?"comment":e.startsWith("'")||e.startsWith('"')?"string":e.startsWith("$")?"variable":"keyword"}function Gy(e){let t=[],n=0;_f.lastIndex=0;for(let r of e.matchAll(_f)){let o=r.index;o>n&&t.push({text:e.slice(n,o),kind:"plain"}),t.push({text:r[0],kind:Hy(r[0])}),n=o+r[0].length}return n<e.length&&t.push({text:e.slice(n),kind:"plain"}),t.length===0&&t.push({text:e,kind:"plain"}),t}function Ky(e){return{bad_request:"\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC774 \uC62C\uBC14\uB974\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.",forbidden:"\uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB294 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",lane_not_declared:"\uD604\uC7AC \uACE0\uC815 \uC120\uC5B8\uC5D0 \uD574\uB2F9 \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.",stale_declaration:"\uC800\uC7A5\uC18C \uC791\uC5C5 \uC120\uC5B8\uC774 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uD654\uBA74\uC5D0\uC11C \uB2E4\uC2DC \uC5F4\uC5B4 \uC8FC\uC138\uC694.",too_large:"\uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uB108\uBB34 \uCEE4\uC11C \uD654\uBA74\uC5D0 \uD45C\uC2DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",unsupported_content:"\uD14D\uC2A4\uD2B8 \uD615\uC2DD\uC758 \uC2A4\uD06C\uB9BD\uD2B8\uB9CC \uD45C\uC2DC\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.",unreadable:"\uACE0\uC815\uB41C \uC2A4\uD06C\uB9BD\uD2B8 \uB0B4\uC6A9\uC744 \uC77D\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}[e]||"\uC2A4\uD06C\uB9BD\uD2B8\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}function gf(e){let t=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),r=document.createElement("div");r.className="repo-ops-script-viewer-root",document.body.appendChild(r);let o=null,s="loading",i="",l="",a=0,u=null,d=!1;function _(O,M){return M?Gy(O).map(B=>B.kind==="plain"?B.text:c`<span
            class="repo-ops-script-viewer__token repo-ops-script-viewer__token--${B.kind}"
            >${B.text}</span
          >`):O}function h(){if(!o)return c``;let O=s==="ready"&&zy(i),M=s==="ready"?i.split(`
`):[];return c`<div
    ...
    ></button>`}function m(){let D=s().repo_operations;return Array.isArray(D)?D:[]}function w(){let D=a().repo_ops,Y=D&&typeof D=="object"?D.repo_id:null;return typeof Y=="string"&&Y?Y:null}function C(){return m().some(D=>D&&D.kind==="deploy"&&Yy.has(D.state))}function F(){let D=C(),Y=w()===null;return c`<button
      type="button"
    ...
    >
      <details class="worker-repo-ops__policy" data-seam="policy-lists">
        ...
        ${N(a())} ${oe()}
      </details>`}}}var wf=20,Vy=5,Xy=new Set(["failed","running","queued","retry_pending"]),yf={verify:"\uBA38\uC9C0 \uC804 \uAC80\uC99D",deploy:"\uBA38\uC9C0 \uD6C4 \uBC30\uD3EC"};function Qy(e,t,n=wf){let r=[];for(let o of Array.isArray(e)?e:[])!o||typeof o!="object"||r.push({type:"operation",id:o.operation_id,at:typeof o.finished_at=="number"?o.finished_at:typeof o.requested_at=="number"?o.requested_at:null,operation:o});for(let o of Array.isArray(t)?t:[])!o||typeof o!="object"||r.push({type:"cleanup",id:o.bead_id,at:typeof o.at=="number"?o.at:null,cleanup:o});return r.sort((o,s)=>o.at===null&&s.at===null?String(o.id||"").localeCompare(String(s.id||"")):o.at===null?1:s.at===null?-1:s.at-o.at),r.slice(0,Math.max(0,n))}function Zy(e){if(e.type==="cleanup")return!0;let t=e.operation;return Xy.has(t.state)&&!t.dismissed&&!t.superseded_by}function Jy(e,t,n={}){let r=Qy(e,t,1/0),o=n.expanded===!0?wf:Vy,s=new Set(r.slice(0,o)),i=r.filter(l=>s.has(l)||Zy(l));return{visible:i,hidden:r.length-i.length}}function vf(e){if(e.type==="cleanup")return"warn";let t=e.operation.state;return t==="succeeded"?"ok":t==="failed"?"fail":"live"}function ev(e){if(e.type==="cleanup")return"\uBA48\uCDA4";switch(e.operation.state){case"succeeded":return"\uC131\uACF5";case"failed":return"\uC2E4\uD328";case"retry_pending":return"\uC7AC\uC2DC\uB3C4 \uC911";case"running":return"\uC2E4\uD589 \uC911";default:return"\uB300\uAE30"}}function kf(e){let t=e.filter(n=>n.value);return t.length===0?"":c`<details class="worker-ev__details">
    <summary>세부</summary>
  ...
  </p>`}function tv(e,t){if(!e||typeof e!="object")return;let n=t&&t.kind==="verify"?"verify":"deploy",r=e[n],o=r&&typeof r=="object"?r.timeout_ms:void 0;return typeof o=="number"&&Number.isFinite(o)?o:void 0}function nv(e,t){let n=pp(e,t),r=fp(e);return!n&&!r?"":c`<p class="worker-ev__why">
    ${n?c`<span class="worker-ev__why-line">${n}</span>`:""}${r?c`<span class="worker-ev__why-line">${r}</span>`:""}
  </p>`}function rv(e){return e.state!=="failed"||e.superseded_by||e.dismissed?"":c`<div class="worker-ev__acts">
    <button
      type="button"
  ...
  </div>`}function ov(e,t){let n=e.operation,r=n.state==="failed",o=n.failure?n.failure.code:"";return c`<li
    class="worker-ev"
  ...
  </li>`}function sv(e){let t=e.cleanup,n=$r(t.step);return c`<li
    class="worker-ev"
  ...
  >
  ...
  </li>`}function iv(e){let t=typeof e.hidden=="number"?e.hidden:0,n=e.expanded===!0;return c`<section class="worker-repo-drawer" data-seam="repo-ops-timeline">
    ...
    ${e.events.length===0?c`<div class="worker-repo-drawer__empty">기록 없음</div>`:c`<ul class="worker-rail">
          ${e.events.map(r=>r.type==="cleanup"?sv(r):ov(r,e.repo_ops))}
        </ul>`}
  ...
  </section>`}function xf(e,t={}){let n=null;function r(){if(n===null){ot(c``,e);return}let i=Jy(n.operations,n.cleanup_failures,{expanded:n.expanded});ot(iv({events:i.visible,hidden:i.hidden,expanded:n.expanded,repo:n.repo,repo_ops:n.repo_ops}),e)}e.addEventListener("click",i=>{let l=i.target;if(l?.closest?.('[data-seam="repo-ops-close"]')){s();return}l?.closest?.('[data-seam="repo-ops-more"]')&&n&&(n.expanded=!n.expanded,r())});function o(i){n={operations:i.operations,cleanup_failures:i.cleanup_failures,repo:i.repo||"",repo_ops:i.repo_ops||null,expanded:!1},r()}function s(){n!==null&&(n=null,r(),t.onClose&&t.onClose())}return{open:o,close:s,isOpen:()=>n!==null,refresh(i){n&&(n={operations:i.operations,cleanup_failures:i.cleanup_failures,repo:i.repo||"",repo_ops:i.repo_ops||null,expanded:n.expanded},r())}}}var av="session-preferred",lv=["exclusive_machine","iterative_user_judgment","visual_verification"];function Af(e,t){if(!Cr(e).includes(av)||typeof t!="object"||t===null)return"";let n=t.session_preferred_reason;return typeof n=="string"&&lv.includes(n)?n:""}var cv="spec-after-blocker";function Sf(e,t){return Cr(e).includes(cv)&&Array.isArray(t)&&t.length>0}var uv=Ct("views:worker:adapter"),dv="tab:worker:ready",pv="tab:worker:blocked",fv="tab:worker:in-progress",_v="tab:worker:resolved",mv="tab:worker:closed",gv="\u{1F512} blocked",hv={revision:0,auto_advance:!1,auto_merge:!1,slots:oi,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]},bv=["claude_account","codex_account"],yv=[...Vr,...bv];function vv(e){let t=e&&e.parent;return(typeof t=="string"?t.length>0:!!(t&&t.id))||/\.\d+$/.test(e&&e.id||"")}function wv(e){let t=e&&typeof e=="object"?e.awaiting_user:void 0,n=typeof t=="string"?t.trim():"";return n.length>0?`${Qs}: ${n}`:Qs}function Or(e){return e&&typeof e=="object"?e:{}}function kv(e){let t={};for(let n of yv){let r=e[n];typeof r=="string"&&r.length>0&&(t[n]=r)}return t}function $v(e){let t=e.replace(/\/+$/,""),n=t.lastIndexOf("/");return n>=0?t.slice(n+1):t}function Ef(e={}){let{queueStore:t,issueStores:n,transport:r,getWorkspacePath:o,onInvalidate:s}=e,i=n?Fr(n):null,l=new Map,a={},u=null,d=0,_=null,h=!1;function m(){h||!s||s()}function w(M){return u===M?a:{}}async function C(){if(!r||h)return;let M=o?.()||"";if(u===M||_&&_.key===M&&_.generation===d)return;let B=++d;_={key:M,generation:B};let Q=null;try{Q=await Promise.resolve(r("get-session-defaults",{}))}catch(oe){if(B!==d)return;_=null,uv("get-session-defaults failed: %o",oe),m();return}B===d&&(a=Q&&typeof Q.values=="object"&&Q.values!==null?{...Q.values}:{},u=M,_=null,m())}function F(){u=null,d+=1,C()}function z(){for(let[M,B]of l)B==="failed"&&l.delete(M)}function ae(M,B){return i?i.selectBoardColumn(M,B):[]}function X(M,B,Q,oe){let D=Array.isArray(M.queue)?M.queue:[],Y=new Set([...D.map(q=>q.bead_id),...(Array.isArray(M.serial_lanes)?M.serial_lanes:[]).flatMap(q=>(Array.isArray(q?.entries)?q.entries:[]).map(we=>we.bead_id)),...(Array.isArray(M.pr_wait)?M.pr_wait:[]).map(q=>q.bead_id),...(Array.isArray(M.done)?M.done:[]).map(q=>q.bead_id)]),U=new Set(Q.map(q=>q.id)),Z=new Set,Ae=[];for(let q of[...B,...Q])Y.has(q.id)||Z.has(q.id)||vv(q)||(Z.add(q.id),Ae.push(q));let be=df(Ae,Rr(oe)),ce=Or(M.bead_scope);return be.map(q=>{let we=Nr(q),xe=we.evidence==="published",A=typeof q.workflow?.route=="string"&&q.workflow.route||(q.metadata&&typeof q.metadata.route=="string"?q.metadata.route:""),ne=A==="quick_fix",ge=!Object.hasOwn(q,"description")||typeof q.description=="string"&&q.description.trim().length>0,pe=Object.hasOwn(q,"labels")&&ef(q.labels),Re=pe||!Object.hasOwn(q,"labels")?"":Af(q.labels,q.metadata),ue=q.metadata&&typeof q.metadata=="object"?Object.hasOwn(q.metadata,"awaiting_user"):!1,Ie=!pe&&!ue&&(ne?ge:xe&&!we.conflict),rt=U.has(q.id),st=rt?Pi(q):[],I=[];rt&&st.length===0&&I.push(gv),ue&&I.push(wv(q.metadata)),ne&&!ge?I.push("missing_description"):!ne&&we.conflict?I.push("spec_id_conflict"):!ne&&we.evidence==="none"?I.push("spec \uC5C6\uC74C"):!ne&&we.evidence==="draft"&&I.push("spec \uBBF8\uBC1C\uD589(draft)");let le=ce[q.id];return{bead_id:q.id,title:q.title||q.id,route:A,spec_id:we.conflict?"":we.path,published:xe,blocked:rt,blocked_by:st,labels:Array.isArray(q.labels)?q.labels:[],created_at:q.created_at,updated_at:q.updated_at,status:q.status,workflow:q.workflow||null,exec_pins:kv(Or(q.metadata)),rec:null,...le&&Array.isArray(le.scope)?{scope:le.scope}:{},eligible:Ie,reason:I.join(" \xB7 "),worker_ineligible:pe,session_preferred:Re.length>0,session_preferred_reason:Re,spec_after_blocker:Sf(q.labels,st),release_info:q.release_info,dependents_info:q.dependents_info}})}function N(M){let[B,Q,oe,D,Y]=M,U=bs([...B,...Q,...oe,...D,...Y]),Z={},Ae=(be,ce)=>{if(!be||typeof be.id!="string"||be.id.length===0)return;let q=Z[be.id]||(Z[be.id]={});if(typeof be.priority=="number"&&!("priority"in q)&&(q.priority=be.priority),typeof be.from_id=="string"&&!("from_id"in q)&&(q.from_id=be.from_id),ce&&!("metadata"in q)){q.metadata=Or(be.metadata);let we=Or(be.workflow).route;typeof we=="string"&&we.length>0&&(q.route=we)}};for(let be of[...B,...Q,...oe])Ae(be,!0);for(let be of[...D,...Y])Ae(be,!1);for(let be of new Set([...Object.keys(Z),...U.keys()])){let ce=ys(U,be);if(ce.total>0){let q=Z[be]||(Z[be]={});q.rollup=ce}}return Z}function O(M,B,Q,oe){let D=new Set((Array.isArray(M.done)?M.done:[]).map(U=>U?.bead_id).filter(U=>typeof U=="string")),Y=[];for(let U of B){let Z=tr(U.closed_at);if(typeof U.id!="string"||D.has(U.id)||Z===null||oe!==void 0&&Z<oe||typeof U.comment_count!="number"||U.comment_count<=0)continue;let Ae=`${Q}\0${U.id}\0${String(U.updated_at)}\0${U.comment_count}`,be=l.get(Ae);if(be===void 0&&r&&(l.set(Ae,"pending"),Promise.resolve(r("get-comments",{id:U.id})).then(q=>{let we=Array.isArray(q)&&q.some(xe=>wi(typeof xe?.text=="string"?xe.text:"")?.lane==="session");l.set(Ae,we?"session":"not-session"),m()}).catch(()=>{l.set(Ae,"failed"),m()})),be!=="session")continue;let ce=tr(U.started_at);Y.push({id:U.id,title:U.title||U.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:ce!==null&&Z>=ce?Z-ce:null,work_kind:"session",done_at:Z,created_at:U.created_at,updated_at:U.updated_at})}return Y}return{read(M){if(!t)return{workspaces:[],workspaces_state:[]};let B=t.get()||hv,Q=o?.()||"",oe=M&&typeof M.done_since=="number"?M.done_since:void 0,D=ae(dv,"ready"),Y=ae(pv,"blocked"),U=ae(fv,"in_progress"),Z=ae(_v,"resolved"),Ae=ae(mv,"closed");return{workspaces:[{...B,bead_titles:{...Or(B.bead_titles),...Object.fromEntries([...D,...Y].filter(be=>be&&typeof be.id=="string").map(be=>[be.id,be.title||be.id]))},root_dir:Q,name:$v(Q),runnable:X(B,D,Y,M?M.candidate_sort:void 0),session_done:O(B,Ae,Q,oe),bead_overlay:N([D,Y,U,Z,Ae])}],workspaces_state:[{root_dir:Q,revision:B.revision,auto_advance:B.auto_advance,auto_merge:B.auto_merge,slots:typeof Or(B.workspace_info).slots=="number"?Or(B.workspace_info).slots:B.slots,runner_catalog:B.runner_catalog,execution_defaults:B.execution_defaults,session_defaults:w(Q),orchestration_model:B.orchestration_model,orchestration_effort:B.orchestration_effort,orchestration_speed:B.orchestration_speed,issue_prefix:""}]}},ensureSessionDefaults(){C()},refreshSessionDefaults:F,notifyIssuesChanged:z,destroy(){h=!0,d+=1,_=null,l.clear()}}}var qi=1,Tf=5,xv={root_dir:"",name:"",auto_advance:!1,auto_merge:!1,slots:qi,revision:0,runner_catalog:{},items:[],sublanes:{parallel:[],serial:[]},serial_lane_count:0,raw_queue_length:0,live_count:0,over_cap:!1,merge:{positions:new Map,resolutions:new Map,continuations:new Map,authorities:new Map,state:{active:null,failures:{},waiting:null},auto_excluded:[],running:!1},token_total:null,cleanup_failures:[],declared_base:null,repo_operations:[]};function cn(e){return e&&typeof e=="object"?e:{}}var Of="beads-ui.worker.candidate-filter",wl={show_blocked:!1,spec:"all"};function Av(){try{let e=window.localStorage.getItem(Of);if(!e)return{...wl};let t=JSON.parse(e);if(!t||typeof t!="object")return{...wl};let n=t.spec;return{show_blocked:t.show_blocked===!0,spec:n==="with"||n==="without"?n:"all"}}catch{return{...wl}}}function Sv(e){try{window.localStorage.setItem(Of,JSON.stringify(e))}catch{}}var Ev=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],Lf="bdui.worker.done-range";function Tv(){try{let e=window.localStorage.getItem(Lf);return e===null?"today":Ln(e)}catch{return"today"}}function Cv(e){try{window.localStorage.setItem(Lf,e)}catch{}}function Cf(e){let t=Array.isArray(e)&&e.length>0?e[0]:null;if(!t)return"";let n=typeof t.title=="string"?t.title:t.id||"";return n.length>22?`${n.slice(0,22)}\u2026`:n}function Rv(e){return e==="receipt_not_current"?"\uB9AC\uBDF0 \uD6C4\uC5D0\uB3C4 \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD558\uC9C0 \uC54A\uC74C":e==="cancelled"?"\uB9AC\uBDF0 \uC138\uC158 \uCDE8\uC18C\uB428":e.startsWith("launch_failed:")?`\uB9AC\uBDF0 \uC138\uC158 \uC2DC\uC791 \uC2E4\uD328(${e.slice(14)})`:e.startsWith("session_failed:")?`\uB9AC\uBDF0 \uC138\uC158 \uBE44\uC815\uC0C1 \uC885\uB8CC(${e.slice(15)})`:`\uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD328(${e})`}function Rf(e){if(e.startsWith("receipt_unbacked:"))return`\uC2E4\uD589 \uC601\uC218\uC99D \uC790\uB3D9 \uAC80\uC99D \uBD88\uAC00(${e.slice(17)}) \u2014 [\uBA38\uC9C0] \uD074\uB9AD\uC73C\uB85C \uC218\uB3D9 \uC9C4\uD589 \uAC00\uB2A5`;switch(e){case"not_in_pr_wait":return"PR \uB300\uAE30 \uC0C1\uD0DC \uB3D9\uAE30\uD654 \uC2E4\uD328";case"resolution_round_cap":return"\uCDA9\uB3CC \uD574\uC18C 2\uD68C \uCD08\uACFC";case"resolution_rebase_cap":return"\uD050 \uC7AC\uCDA9\uB3CC 3\uD68C \uCD08\uACFC";case"resolution_timeout":return"\uCDA9\uB3CC \uD574\uC18C \uB300\uAE30 \uC2DC\uAC04 \uCD08\uACFC";case"resolution_refused":return"\uD574\uC18C \uC138\uC158 \uB514\uC2A4\uD328\uCE58 \uAC70\uBD80";case"worktree_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uD574\uC18C \uD544\uC694";case"worktree_restore_branch_mismatch":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 \uBE0C\uB79C\uCE58 \uC774\uB984 \uBD88\uC77C\uCE58";case"worktree_restore_path_exists":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 \uACBD\uB85C \uC774\uBBF8 \uC788\uC74C";case"worktree_restore_branch_missing":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 origin\uC5D0 \uBE0C\uB79C\uCE58 \uC5C6\uC74C";case"worktree_restore_branch_diverged":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328 \u2014 \uB85C\uCEEC \uBE0C\uB79C\uCE58\uAC00 origin\uACFC \uB2E4\uB984";case"worktree_restore_failed":return"\uC6CC\uD06C\uD2B8\uB9AC \uBCF5\uC6D0 \uC2E4\uD328";case"merge_unconfirmed_timeout":return"\uBA38\uC9C0 \uD655\uC778 \uC2DC\uAC04 \uCD08\uACFC";case"pr_closed_unmerged":return"PR \uB2EB\uD798";case"merge_error":return"\uBA38\uC9C0 \uC624\uB958";case"spec_id_missing":return"\uC2A4\uD399 ID \uAE30\uB85D \uC5C6\uC74C";default:return e}}function Ov(e){if(e==="lane_occupied")return"\uC2E4\uD589 \uB808\uC778\uC5D0 \uB0A8\uC544 \uC788\uC5B4 \uBA38\uC9C0 \uB300\uC0C1\uC774 \uC544\uB2D9\uB2C8\uB2E4";let t="\uBA38\uC9C0 \uD050\uC5D0 \uB123\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 (\uC774\uBBF8 \uB300\uAE30 \uC911\uC774\uAC70\uB098 \uB300\uC0C1 \uC544\uB2D8)";return typeof e=="string"&&e.length>0?`${t}: ${e}`:t}function Lv(e){if(e==="worker_sessions_busy")return"\uD574\uC18C \uB300\uAE30 \u2014 \uC2E4\uD589 \uC2AC\uB86F \uB300\uAE30 \uC911";if(typeof e!="string"||!e.startsWith("completion_waiting:"))return null;let t=e.slice(19);if(t.length===0)return null;switch(t){case"gating":return"\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911";case"merging":return"\uBA38\uC9C0 \uC911";case"cleaning":return"\uB9C8\uBB34\uB9AC \uC911";case"paused":return"\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";case"needs_human":return"\uD655\uC778 \uD544\uC694";default:return null}}function Iv(e){if(!e||typeof e!="object")return null;switch(e.state){case"waiting":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC911",live:!0};case"yielded":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uACC4\uC18D \uC911 \xB7 \uC644\uB8CC \uD6C4 \uC6B0\uC120 \uBA38\uC9C0",live:!0};case"ready":return{badge:"\uCDA9\uB3CC \uD574\uC18C \uC644\uB8CC \xB7 \uC7AC\uAC80\uC99D \uB300\uAE30",live:!1};default:return null}}var Mv=new Set(["paused","needs_human","waiting_metadata","reviewing","retrying"]),Dv=new Set(["waiting_metadata","reviewing","retrying"]),kl=new Set(["review_receipt_missing","review_receipt_stale","review_receipt_invalid","review_receipt_undetermined"]);function Pv(e){let t=e&&typeof e=="object"?e.auto_resolution:null,n=t&&typeof t=="object"&&!Array.isArray(t)?t:null;if(!n||!e)return null;let r=typeof n.origin_reason=="string"&&n.origin_reason.length>0?`\uC6D0 \uC0AC\uC720: ${n.origin_reason}`:"";switch(e.phase){case"waiting_metadata":return{label:"\uC815\uC815 \uB300\uAE30",details:[r,"\uBA54\uD0C0\uB370\uC774\uD130 \uC815\uC815\uC774 \uAD00\uCE21\uB418\uBA74 \uC790\uB3D9 \uC7AC\uAC1C"].filter(Boolean),live:!1};case"retrying":{let o=Number.isInteger(n.attempts)?Math.max(0,Number(n.attempts)):0,s=Number.isInteger(n.attempt_cap)&&Number(n.attempt_cap)>0?Number(n.attempt_cap):0,i=typeof n.next_at=="number"?Ht(n.next_at):"",l=typeof n.last_error=="string"&&n.last_error.length>0?n.last_error:"";return{label:s>0?`\uC7AC\uC2DC\uB3C4 ${Math.min(o,s)}/${s}`:`\uC7AC\uC2DC\uB3C4 ${o}`,details:[r,i?`\uB2E4\uC74C \uC2DC\uAC01 ${i}`:"",l?`\uB9C8\uC9C0\uB9C9 \uC624\uB958: ${l}`:""].filter(Boolean),live:!0}}default:return null}}function Nv(e){if(typeof e!="string")return"";for(let t of["retry_exhausted:","auto_review_exhausted:"])if(e.startsWith(t))return e.slice(t.length);return""}function qv(e,t=null){if(!e||typeof e!="object")return null;let n="";switch(e.phase){case"gating":n="\uBA38\uC9C0 \uC870\uAC74 \uD655\uC778 \uC911";break;case"merging":n="\uBA38\uC9C0 \uC911";break;case"cleaning":n="\uB9C8\uBB34\uB9AC \uC911";break;case"waiting_metadata":case"reviewing":case"retrying":if(!t)return null;n=t.label;break;case"paused":n="\uC790\uB3D9 \uC9C4\uD589 \uC77C\uC2DC\uC815\uC9C0";break;case"needs_human":n="\uD655\uC778 \uD544\uC694";break;case"completed":return null;default:return null}let r=[n];e.head_sha&&r.push(`head ${e.head_sha}`),e.base_sha&&r.push(`base ${e.base_sha}`),(e.failure_stage||e.failure_reason)&&r.push(`${e.failure_stage||"failure"} \xB7 ${e.failure_reason||"\uC6D0\uC778 \uBBF8\uC0C1"}`);let o=Nv(e.terminal_reason);o&&r.push(`\uC6D0 \uC0AC\uC720: ${o}`);let s=e.phase==="needs_human"&&!o?Tr(e.terminal_reason):null;s&&r.push(e.failure_stage?`${e.failure_stage} \xB7 ${s}`:s);for(let i of t?t.details:[])r.push(i);return e.active_attempt_id&&r.push(`attempt ${e.active_attempt_id}`),e.evidence&&r.push(e.evidence),e.log_path&&r.push(e.log_path),{badge:n,title:r.join(`
`),alert:e.phase==="needs_human",lock_actions:!Mv.has(e.phase)}}function Fv(e){if(!e||typeof e!="object")return[];let t=e.blocking_codes;return Array.isArray(t)?t.filter(n=>typeof n=="string"&&n.length>0):[]}function jv(e){let t=e.queue_failure?`\uBA38\uC9C0 \uC2E4\uD328 \uC6D0\uBB38: ${e.queue_failure}`:e.auto_skip?`\uC790\uB3D9 \uC81C\uC678 \uC6D0\uBB38: ${e.auto_skip}`:"",n=(s,i={})=>{let l=[i.title||"",t].filter(Boolean);return{label:s,title:l.join(`
...
\uC9C1\uC804 \uB9AC\uBDF0 \uC138\uC158 \uC885\uB8CC \uC0AC\uC720: ${e.review_session.failure}`,alert:!0})}return n("\uCD5C\uC885 \uBCC0\uACBD \uB9AC\uBDF0 \uD544\uC694",{title:s,alert:!0})}return e.gate?.reason==="spec_id_missing"?n("\uC2A4\uD399 ID \uB204\uB77D",{title:"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id \uD544\uC694",alert:!0}):r.length>0?n(`\uC601\uC218\uC99D \uD655\uC778 \uD544\uC694 \xB7 ${r[0]}`,{title:`\uC131\uB9BD\uD558\uC9C0 \uC54A\uB294 \uC2E4\uD589 \uC601\uC218\uC99D \u2014 ${r.join(", ")}`,alert:!0}):e.recovery?n(e.recovery.badge,{title:e.recovery.title,alert:!0}):e.gate?.tier==="verify"&&e.gate.gate_badge==="\uAC80\uC99D \uC2E4\uD328"?n("\uAC80\uC99D \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.queue_failure?n(`\uBA38\uC9C0 \uC2E4\uD328 \u2014 ${Rf(e.queue_failure)}`,{title:e.queue_failure,alert:!0}):e.auto_skip?n(`\uC790\uB3D9 \uC81C\uC678 \u2014 ${Rf(e.auto_skip)}`,{title:e.auto_skip,alert:!0}):e.queued&&!e.queue_active?n(`\uBA38\uC9C0 \uB300\uAE30 #${e.queue_position}`):e.gate?.enabled===!0?n("\uBA38\uC9C0 \uAC00\uB2A5"):e.gate?.tier==="merged"?n("\uBA38\uC9C0\uB428"):e.gate?.tier==="closed_unmerged"?n("\uB2EB\uD798",{alert:!0}):e.activity?n("\uD655\uC778 \uC911",{live:!0}):e.gate?.tier==="undecidable"||e.gate?.reason==="mergeability_unknown"?n("\uC0C1\uD0DC \uD655\uC778 \uC2E4\uD328",{title:e.gate.reason||"",alert:!0}):e.gate?.tier==="unobserved"||e.gate?.tier==="verify"||e.gate?.gate_badge==="\uAD00\uCE21 \uB300\uAE30"?n("\uD655\uC778 \uC911"):e.gate?.gate_badge?n(e.gate.gate_badge,{title:e.gate.reason||"",alert:e.gate.enabled!==!0}):null}function Bv(e,t,n,r,o=null,s=null,i=null,l=!1,a=null,u=!0,d=null,_=null,h=null,m={},w=!1,C=!1,F={},z=null,ae={active:!1,failure:null,origin:null}){let X=!!a&&a.position>0,N=!!a?.continuation_action&&a.continuation_action.continuation===null,O=!!a&&a.active===!0,M=a&&a.failure||null,B=Lv(a?a.waiting:null),Q=n[e]||null,oe=Q&&Q.gate?Q.gate:null,D=Q&&Q.pr?Q.pr:null,Y=Iv(a?a.resolution:null),U=Pv(h),Z=qv(h,U),Ae=a&&a.authority||null,be=a&&a.review_dispatch||null,ce=a?.hold?.auto_review_wait==="slot"?"slot":null,q=!!h&&typeof h=="object"&&Dv.has(h.phase),we=X&&!O&&(!Ae||q||Ae.source==="automatic"&&!C),xe=i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":Y?Y.badge:i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC911":B,A=!!oe&&oe.base_badge==="\uCDA9\uB3CC",ne=!!oe&&oe.enabled===!0,ge=Io({bead_id:e,merge_sha:F.merge_sha,cleanup_cursor:F.cleanup_cursor,merge_progress:s&&s.merge_progress?s.merge_progress:null,cleanup_failed:r,repo_operations:F.repo_operations}),pe=ni(ge),Re=s&&!ge&&(s.queueing??null)?s.queueing:null,ue=!!r&&["repo_operations","child_sweep","branch_cleanup","parent_close"].includes(r.step)&&!!oe&&oe.tier==="merged",Ie=r&&r.step==="repo_operations"&&ge?.failed===!0&&(ge.step==="deploy"||ge.step==="verify")?ge.step:null,rt=l&&!!r&&!!oe&&oe.tier==="merged",st=we&&(ne||A||oe?.reason==="base_behind"||kl.has(oe?.reason)||ue||rt),I=kl.has(oe?.reason),le=l&&A&&u===!1,se=Vn(m,e,{external:l,merge_active:O||ge?.step==="merge",merge_queued:X,conflict_active:!!i,cleanup_active:pe,merged:!!r||oe?.tier==="merged"}),de=!!se.operation,$e=X&&!M&&!N&&!ue&&!(Z&&Z.lock_actions),ie=jv({auto_pending:$e,continuation_required:N,queueing:Re,merge_step:ge,conflict_badge:xe,conflict_live:Y?.live===!0||i==="running",auto_resolution:U,recovery:Z,cleanup_failed:r,cleanup_label:r?$r(r.step):null,base_exception:_,conflicting:A,gate:oe,receipt_check:Q&&Q.receipt_check?Q.receipt_check:null,queue_failure:M,auto_skip:d,queued:X,queue_active:O,queue_position:a?a.position:0,review_session:ae,review_dispatch:be,auto_review_wait:ce,activity:xe?null:s&&s.activity||null}),Fe=ie?.live===!0&&ie.title?c`<span title=${ie.title}>${ie.label}</span>`:ie?.label||null;return{id:e,title:l?c`${t}<span class="muted"> · 세션</span>`:t,reason:r&&ge?.active!==!0?ti(r.step):"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",worker_serial:w,...z?{dependency_chips:z}:{},external:l,pr_number:D&&typeof D.number=="number"?D.number:null,pr_url:D&&typeof D.url=="string"?D.url:"",completion_badge:ie?.live!==!0&&ie?.title?ie.label:null,completion_title:ie?.title||"",...h?.phase==="needs_human"&&typeof h.log_path=="string"&&h.log_path.length>0?{log_path:h.log_path}:{},badges:Fe?[Fe]:[],live_badge:ie?.live===!0?Fe:null,usage:o,alert:ie?.alert===!0,merge_action:oe?.tier==="merged"&&!ue&&!rt?!1:!X||N||we||I,cancel_action:X&&!N,cancel_enabled:!O&&!(Z&&Z.lock_actions),cancel_title:Z&&Z.lock_actions?`${Z.badge} \u2014 \uC911\uB2E8\uD558\uB824\uBA74 \uC0C1\uB2E8 \uC790\uB3D9 \uBA38\uC9C0 \uC911\uB2E8\uC744 \uC0AC\uC6A9\uD558\uC138\uC694`:O?"\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4":"\uBA38\uC9C0 \uD050\uC5D0\uC11C \uC774 \uD56D\uBAA9\uC744 \uBE8D\uB2C8\uB2E4 (\uB2E4\uC2DC [\uBA38\uC9C0]\uB85C \uB123\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4)",discard:se,discard_action:se.action,merge_step:ge,discard_enabled:se.enabled,discard_title:se.title,merge_enabled:!ge&&!Re&&!i&&!de&&!_&&!(Z&&Z.lock_actions)&&!le&&ae.active!==!0&&(ne||A||oe?.reason==="base_behind"||I||ue||rt||st||q&&!O),merge_label:N?"\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD":ue||rt?Ie==="deploy"?"\uBC30\uD3EC \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":Ie==="verify"?"\uAC80\uC99D \uC7AC\uC2DC\uB3C4 \uD6C4 \uC815\uB9AC":"\uC815\uB9AC \uC7AC\uAC1C":A&&!ge&&!ue?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":oe?.reason==="base_behind"?"base \uAC31\uC2E0 \uD6C4 \uBA38\uC9C0":I?"\uB9AC\uBDF0 \uD6C4 \uBA38\uC9C0":we?"\uB2E4\uC2DC \uBA38\uC9C0":void 0,merge_title:de?se.error?`\uD3D0\uAE30 \uC2E4\uD328: ${se.error} \u2014 [\uC7AC\uC2DC\uB3C4]\uD558\uAC70\uB098 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694`:`\uD3D0\uAE30 \uC9C4\uD589 \uC911 \u2014 ${se.progress||"\uC644\uB8CC\uB97C \uAE30\uB2E4\uB9AC\uC138\uC694"}`:N?"\uC2E4\uD589 provider\uAC00 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uC774\uC5B4\uAC08 \uBC29\uC2DD\uC744 \uC120\uD0DD\uD558\uC138\uC694":Re?"\uC694\uCCAD\uC744 \uBCF4\uB0B4\uB294 \uC911 \u2014 \uC11C\uBC84 \uC751\uB2F5\uC744 \uAE30\uB2E4\uB9BD\uB2C8\uB2E4":ge?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${ge.label}`:Ie?`\uBA38\uC9C0 \uC644\uB8CC \u2014 ${Ie==="deploy"?"\uBC30\uD3EC":"\uAC80\uC99D"} \uC2A4\uD06C\uB9BD\uD2B8\uAC00 \uC2E4\uD328\uD574 \uC815\uB9AC\uAC00 \uBA48\uCDC4\uC2B5\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uC800\uC7A5\uC18C \uC791\uC5C5\uBD80\uD130 \uC815\uB9AC\uB97C \uB2E4\uC2DC \uC9C4\uD589\uD569\uB2C8\uB2E4`:rt?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uC2E4\uD328\uD55C \uC815\uB9AC\uB97C \uC7AC\uAC1C\uD569\uB2C8\uB2E4":le?"\uC6CC\uD06C\uD2B8\uB9AC \uC5C6\uC74C \u2014 \uC138\uC158\uC5D0\uC11C \uC9C1\uC811 \uD574\uC18C\uD558\uC138\uC694":i==="running"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uC644\uB8CC \uD6C4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":i==="paused"?"\uCDA9\uB3CC \uD574\uC18C \uC138\uC158 \uC77C\uC2DC\uC815\uC9C0 \u2014 \uC7AC\uAC1C \uD6C4 \uC644\uB8CC\uB418\uBA74 \uBA38\uC9C0\uD558\uC138\uC694":ue?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uC2E4\uD328 \uB2E8\uACC4\uBD80\uD130 \uC7AC\uAC1C\uD569\uB2C8\uB2E4":A?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":oe?.reason==="base_behind"?"base\uB97C \uC790\uB3D9 \uAC31\uC2E0\uD55C \uB4A4 \uBA38\uC9C0\uD569\uB2C8\uB2E4":ae.active===!0?ae.origin==="auto"?"\uC790\uB3D9 \uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uB05D\uB098\uBA74 \uC601\uC218\uC99D\uC744 \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":"\uB9AC\uBDF0 \uC138\uC158 \uC2E4\uD589 \uC911 \u2014 \uB05D\uB098\uBA74 \uC601\uC218\uC99D\uC744 \uB2E4\uC2DC \uD310\uC815\uD569\uB2C8\uB2E4":oe?.reason==="review_receipt_missing"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uC5C6\uC74C \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uB9AC\uBDF0\uB9CC \uC218\uD589\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":oe?.reason==="review_receipt_stale"?"head \uC7AC\uC791\uC131\uB428(\uC601\uC218\uC99D\uC774 \uD604\uC7AC head\uC758 \uC870\uC0C1\uC774 \uC544\uB2D8) \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":oe?.reason==="review_receipt_invalid"?"\uB9AC\uBDF0 \uC601\uC218\uC99D \uAE30\uB85D\uC774 \uC131\uB9BD\uD558\uC9C0 \uC54A\uC74C \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC601\uC218\uC99D\uC774 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":oe?.reason==="review_receipt_undetermined"?"\uB9AC\uBDF0 \uC601\uC218\uC99D ancestry probe \uBBF8\uC644\uB8CC \u2014 \uBA38\uC9C0 \uAC8C\uC774\uD2B8 \uBCF4\uB958\uC785\uB2C8\uB2E4. \uD074\uB9AD\uD558\uBA74 \uAE30\uB85D\uB41C \uC138\uC158\uC744 \uC774\uC5B4 \uCD5C\uC885 head\uB97C \uB2E4\uC2DC \uB9AC\uBDF0\uC2DC\uD0A4\uACE0, \uC0C8 \uC601\uC218\uC99D\uC774 \uCD5C\uC885 head\uC5D0 \uC720\uD6A8\uD574\uC9C0\uBA74 \uD050\uAC00 \uBA38\uC9C0\uD569\uB2C8\uB2E4":oe?.reason==="spec_id_missing"?"native spec_id \uBBF8\uAE30\uB85D \u2014 bd update --spec-id\uB85C \uAE30\uB85D\uD55C \uB4A4 \uB2E4\uC2DC \uBA38\uC9C0\uD558\uC138\uC694":ne?`\uBA38\uC9C0 (${oe.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4 (\uCC28\uB840\uAC00 \uB418\uBA74 \uB2E4\uC2DC \uD655\uC778)`:oe&&oe.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${oe&&oe.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function $l(e,t={}){let{transport:n,issueStores:r,queueStore:o,sessionLogStore:s,gotoIssue:i,getWorkspacePath:l,switchWorkspace:a,openDoc:u,doneRange:d,onDoneRangeChange:_}=t,h=r?Fr(r):null,m=Av(),w=null,C=null,F=Kr(()=>ee()),z=new Map,ae=new Map,X=lf(),N=yl(X)===null,O=d?Ln(d):Tv();function M(){let g=Ir.find(b=>b.value===O);return g?g.label:"\uC624\uB298"}let B=Ti("beads-ui.worker.lane-collapsed"),Q=!1,oe=new Set,D=new Set,Y=new Set,U=new Set,Z=new Set,Ae=null,be=[],ce=Ef({queueStore:o,issueStores:r,transport:n,getWorkspacePath:l,onInvalidate:()=>ee()});function q(){ce.refreshSessionDefaults()}let we=document.createElement("div");we.className="worker-console";let xe=document.createElement("div");xe.className="worker-top";let A=document.createElement("div");A.className="worker-drawer-overlay",A.hidden=!0;let ne=document.createElement("div");ne.className="worker-drawer-overlay__backdrop";let ge=document.createElement("div");ge.className="worker-drawer-host";let pe=document.createElement("div");pe.className="worker-drawer-host",pe.hidden=!0,A.append(ne,ge,pe);let Re=document.createElement("div");Re.className="worker-lanes-host",we.append(xe,A,Re),e.appendChild(we);let ue=ar(null,null),Ie=[],rt=Ri({transport:n,console_el:we,getLanes:()=>ue,getWorkspaces:()=>Ie,getCrossLanes:()=>null,reproject:()=>({lanes:S(),raw_lanes:null}),onCorrection:()=>{},showToast:he,requestRender:()=>ee(),adoptQueue:(g,b)=>{o&&o.set(b)},onDragBegin:()=>{w=null}}),st=null,I=io(ge,{transport:n,sessionLogStore:s,onClose:()=>{st=null,A.hidden=!0,ee()}}),le=xf(pe,{onClose:()=>{pe.hidden=!0,A.hidden=!0,ee()}}),se=gf({getWorkspacePath:l||(()=>"")}),de=l&&l()||"",$e=bf({queueStore:o,transport:n,onChanged:()=>ee(),onOpenScript:(g,b)=>{se.open(g,b)}});function ie(){return o&&o.get()||{revision:0,auto_advance:!1,auto_merge:!1,slots:qi,queue:[],serial_lanes:[],serial_lane_count:0,pr_wait:[],done:[]}}function Fe(){let g=ie(),b=typeof g.serial_lane_count=="number"&&Number.isInteger(g.serial_lane_count)&&g.serial_lane_count>0?Math.min(g.serial_lane_count,5):0,x=Array.isArray(g.serial_lanes)?g.serial_lanes:[],te=[];for(let Te of x){if(te.length>=b)break;!Te||typeof Te.id!="string"||!/^s[1-5]$/.test(Te.id)||!Array.isArray(Te.entries)||te.push({id:Te.id,label:`\uC9C1\uB82C ${Te.id.slice(1)}`,count:Te.entries.length})}return te.length===0?null:[{id:"parallel",label:"\uBCD1\uB82C",count:(Array.isArray(g.queue)?g.queue:[]).length},...te]}function Ke(g){if(!w||!g.some(x=>x.id===w))return null;let b=Fe();return b?{bead_id:w,lanes:b}:null}function Qe(){return l&&l()||""}async function Pe(g,b){await rt.sendOp({type:"worker-queue-place",payload:{bead_id:g,...b==="parallel"?{}:{lane:b}},root_dir:Qe()},g)}function V(){let g=ie();return typeof g.revision=="number"?g.revision:0}function j(g){g&&g.queue&&o&&o.set(g.queue)}async function Ne(g){if(!n||!g)return;let b=await n("worker-attempt-pause",{attempt_id:g});b&&b.paused===!1&&b.reason&&he(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${b.reason}`,"error",2400)}async function ct(g,b="session"){if(!n||!g)return;let x=await Wr();if(x===null)return;let te=async(Te={})=>await n("worker-attempt-resume",{attempt_id:g,expected_revision:V(),...x!==""?{instructions:x}:{},...Te}),me=await te();j(me),me&&me.conflict&&(me=await te(),j(me)),me=await zn(me,(Te,Ye)=>te({continuation:Te,decision_token:Ye}),{onResult:j,refresh:()=>te()}),me&&me.resumed===!1&&!me.conflict&&me.reason&&he(`${b==="settlement"?"\uC815\uC0B0 \uC7AC\uAC1C":"\uC774\uC5B4\uD558\uAE30"} \uAC70\uBD80: ${me.reason}`,"error",2400)}async function Je(g,b,x=!0){if(!n)return null;let te=n,me=await te(g,{...b,expected_revision:V()});return j(me),me&&me.conflict&&x&&(me=await te(g,{...b,expected_revision:V()}),j(me)),me}async function y(g){if(!n||!g)return;let b=ie().merge_queue?.find(te=>te.bead_id===g)?.continuation_action;if(b?.mismatch&&b.continuation===null){await je(g,b.mismatch);return}oe.add(g),ee();let x;try{x=await Je("worker-merge-queue-add",{bead_id:g})}catch{he("\uBA38\uC9C0 \uD074\uB9AD\uC774 \uC11C\uBC84\uC5D0 \uC804\uB2EC\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4(\uC5F0\uACB0 \uBB38\uC81C) \u2014 \uC5F0\uACB0 \uBCF5\uAD6C \uD6C4 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",3200);return}finally{oe.delete(g),ee()}if(!(!x||x.applied)){if(x.conflict){he("\uD050\uAC00 \uBC14\uB00C\uC5B4 \uBA38\uC9C0 \uD074\uB9AD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uB20C\uB7EC\uC8FC\uC138\uC694","error",2400);return}he(Ov(x.reason),"error",2400)}}async function W(g){if(!(!n||!g||D.has(g))){D.add(g),ee();try{let b=await n("worker-cleanup-retry",{bead_id:g,expected_revision:V()});j(b),b&&!b.retried&&!b.conflict&&b.reason&&he(`\uC815\uB9AC \uC7AC\uAC1C \uAC70\uBD80: ${b.reason}`,"error",2400)}finally{D.delete(g),ee()}}}async function Ee(g,b){let x=ie().hold;if(!n||!x||typeof x.since!="number")return;let te=await n(g,{since:x.since});j(te),te&&te.ok===!1&&he(`${b}: ${te.reason==="hold_changed"?"\uD050 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694":te.reason||""}`,"error",2800)}async function Ce(g,b){if(!n||!g||!b)return;let x=await n("worker-parked-retry",{bead_id:g,attempt_id:b});j(x),x&&x.ok===!1&&he(`\uC7AC\uC2DC\uB3C4 \uAC70\uBD80: ${x.reason==="not_latest"?"\uC774 bead\uC5D0 \uB354 \uC0C8\uB85C\uC6B4 \uC2DC\uB3C4\uAC00 \uC788\uC2B5\uB2C8\uB2E4":x.reason||""}`,"error",2800)}async function je(g,b){let x=await zn({continuation_mismatch:b},(me,Te)=>Je("worker-merge-queue-add",{bead_id:g,continuation:me,decision_token:Te},!1)),te=x?.queue?.merge_queue?.find(me=>me.bead_id===g)?.continuation_action;if(x?.applied!==!0&&te?.continuation===null&&te.mismatch){await je(g,te.mismatch);return}x&&x.applied===!1&&!x.conflict&&he("\uC774\uC5B4\uD558\uAE30 \uC120\uD0DD\uC774 \uCD5C\uC2E0 \uC0C1\uD0DC\uC640 \uC77C\uCE58\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4","error",2800)}async function Ve(g){if(!n)return;let b=await Je("worker-merge-auto-toggle",{on:g});!b||b.conflict||he(g?"\uC790\uB3D9 \uBA38\uC9C0 \uCF1C\uC9D0 \u2014 \uC790\uACA9\uC774 \uC0DD\uAE30\uB294 PR\uC744 \uACC4\uC18D \uBA38\uC9C0\uD569\uB2C8\uB2E4":"\uC790\uB3D9 \uBA38\uC9C0 \uAEBC\uC9D0 \u2014 \uB300\uAE30 \uD56D\uBAA9\uC744 \uBE44\uC6E0\uC2B5\uB2C8\uB2E4",g?"success":"info",2400)}async function dt(g){if(!n||!g)return;let b=await Je("worker-merge-queue-remove",{bead_id:g});b&&!b.conflict&&!b.applied&&b.reason==="merge_active"&&he("\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 \uCDE8\uC18C\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error",2400)}async function wt(){await Je("worker-merge-queue-remove",{all:!0})}async function Lt(g,b=null,x="unmerged",te=null){if(!n||!g)return;let me=Ro(g,x);if(!(!!te||typeof globalThis.confirm!="function"||globalThis.confirm(me)))return;let Ye=await n("worker-discard",{bead_id:g,...b?{attempt_id:b}:{},...te?{operation_id:te}:{},expected_revision:V()});if(j(Ye),Ye&&Ye.conflict&&(Ye=await n("worker-discard",{bead_id:g,...b?{attempt_id:b}:{},...te?{operation_id:te}:{},expected_revision:V()}),j(Ye)),Ye&&Ye.discarded===!0){he(Ws(Ye),"success",5e3);return}if(Ye&&Ye.reason){he(`\uD3D0\uAE30 \uC2E4\uD328: ${Ye.reason}`,"error",2800);return}if(Ye&&Ye.accepted&&Ye.pending==="merged_revert"){he("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success",2400);return}if(Ye&&Ye.accepted&&!Ye.discarded){he(`\uD3D0\uAE30 \uC9C4\uD589: ${Ye.phase||"\uBC31\uC5C5 \uC911"}`,"success",2400);return}Ye&&!Ye.conflict&&he("\uD3D0\uAE30 \uAC70\uBD80: unknown","error",2800)}async function kt(g,b,x){if(!(!n||!b||!x||U.has(b))){U.add(b),ee();try{let te=await n(g,{bead_id:b,action_id:x,expected_revision:V()});j(te),te?.conflict?he("\uC774\uC804 \uC791\uC5C5 \uC0C1\uD0DC\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4. \uCD5C\uC2E0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD558\uC138\uC694.","error",2800):!te?.ok&&te?.reason&&he(`\uC774\uC804 \uC791\uC5C5 \uCC98\uB9AC \uAC70\uBD80: ${String(te.reason)}`,"error",2800)}finally{U.delete(b),ee()}}}async function mt(g,b){if(!n||!b||Y.has(b))return;Y.add(b),ee();let x;try{let te=async(me={})=>await n(g,{bead_id:b,expected_revision:V(),...me});x=await te(),j(x),x&&x.conflict&&(x=await n(g,{bead_id:b,expected_revision:V()}),j(x)),g==="worker-revise-fix"&&(x=await zn(x,(me,Te)=>te({continuation:me,decision_token:Te}),{onResult:j,refresh:()=>te()}))}finally{Y.delete(b),ee()}if(!(!x||x.conflict)){if(x.ok){he(g==="worker-revise-fix"?"\uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 \u2014 \uC218\uB9AC \uD6C4 \uAD6C\uD604\uC774 \uC7AC\uB514\uC2A4\uD328\uCE58\uB429\uB2C8\uB2E4":"\uB378\uD0C0 \uC2B9\uC778 \uC644\uB8CC \u2014 \uC601\uC218\uC99D \uAC31\uC2E0 + \uD30C\uD0B9 \uD574\uC81C","success",2800);return}he(`\uCC98\uBD84 \uAC70\uBD80: ${x.reason||""}`,"error",3e3)}}async function Be(g){if(!n)return;let b=await n("worker-automation-toggle",{on:g,expected_revision:V()});j(b),b&&b.conflict&&await n("worker-automation-toggle",{on:g,expected_revision:V()}).then(j)}async function L(g){if(!n||!g)return;let b=await n("worker-repo-operation-dismiss",{operation_id:g});j(b),b&&b.ok===!1&&he(`\uAE30\uB85D \uB2EB\uAE30 \uAC70\uBD80: ${b.reason||""}`,"error",3e3)}async function J(g){if(!n||!Number.isFinite(g))return;let b=Math.max(qi,Math.floor(g)),x=await n("worker-queue-set-slots",{slots:b,expected_revision:V()});j(x),x&&x.conflict&&await n("worker-queue-set-slots",{slots:b,expected_revision:V()}).then(j)}async function ye(g){if(!n||!Number.isInteger(g)||g<1||g>Tf)return;let b=ie(),x=(Array.isArray(b.serial_lanes)?b.serial_lanes:[]).slice(g).reduce((Te,Ye)=>Te+(Array.isArray(Ye?.entries)?Ye.entries.length:0),0),te=()=>({count:g,expected_revision:V()}),me=await n("worker-queue-set-serial-lane-count",te());j(me),me&&me.conflict&&(me=await n("worker-queue-set-serial-lane-count",te()),j(me)),me&&me.applied&&x>0&&he(`\uC9C1\uB82C \uB808\uC778 \uCD95\uC18C \u2014 ${x}\uAC1C \uD56D\uBAA9\uC774 \uBCD1\uB82C \uB300\uAE30\uB85C \uC774\uB3D9`)}function S(){let g=br(O),b=ce.read({candidate_sort:X,done_since:g});return Ie=b.workspaces,ue=ar(b.workspaces,b.workspaces_state,{done_since:g,candidate_filter:m,candidate_hidden_counts:"per_control",candidate_sort:"as_given",groups:"all"}),ue}function K(g){return g.queue_groups[0]||xv}function Me(g){let b=g.dependency_chips||null,x={...b&&b.released?{released:b.released}:{},...b&&b.dependents?{dependents:b.dependents}:{}},te=z.get(g.id),me=ae.get(g.id)||null,Te=te&&te.overlaps.length>0?te.overlaps:null,Ye=!!te&&te.scope_missing;return!me&&!Te&&!Ye&&Object.keys(x).length===0?null:{...x,...me?{predecessors:me}:{},...Te?{overlaps:Te}:{},...Ye?{scope_missing:!0}:{}}}function ze(g){return{...g,workspace_name:"",done_layout:void 0,dependency_chips:Me(g)||void 0,chip_popover:qe(g)}}function qe(g){return Xs(g,b=>F.isOpen({bead_id:g.id,chip_key:b}))}function et(){let g=ie(),b=new Map;for(let x of Object.values(cn(g.lane_states))){let te=Array.isArray(x?.corrections)?x.corrections:[];for(let me of te)me&&typeof me.bead_id=="string"&&typeof me.after=="string"&&b.set(me.bead_id,me.after)}return{admission:cn(g.admission),bead_labels:cn(g.bead_labels),correction_after:b}}function Oe(g,b){let x=ze(g),te=ku(b.admission[g.id]||null,!!g.discard||U.has(g.id)),me=b.bead_labels[g.id],Te=b.correction_after.get(g.id);return{...x,draggable:x.draggable===!0&&!te,stale_work:te,reason:te?"":x.reason,worker_serial:Array.isArray(me)&&tf(me),badges:Te?[`\u{1F517} ${Te} \uB4A4 (blocks \uC790\uB3D9)`,...x.badges||[]]:x.badges,revise_enabled:x.revise_enabled===!0&&!Y.has(g.id)}}function Ge(g){let b=et();return K(g).sublanes.parallel.map(x=>Oe(x,b))}function Ze(g){let b=et();return K(g).sublanes.serial.map(x=>{let te=x.occupants.map(me=>({id:me.id,title:me.title,draggable:!1,lane:x.id,ghost:!0,badges:[me.badge]}));return{id:x.id,index:x.index+1,raw_length:x.raw_length,ghosts:te,items:x.items.map(me=>Oe(me,b)),occupied:x.occupied_by.length>0,badge:x.occupants.length>0?x.occupants[0].badge:"\uB300\uAE30",cycle:x.cycle===!0}})}function bt(g){return g.runnable.map(b=>ze(b))}function He(g){return g.done.map(b=>ze(b))}function xt(g){let b=g.running.filter(x=>x.non_occupying!==!0).map(x=>({...x,bead_id:x.id,attempt_id:x.attempt_id||"",paused:x.run_state==="paused",failed:x.run_state==="failed",parked:x.run_state==="parked",retry_wait:x.run_state==="retry_wait",status_label:x.run_state==="failed"?x.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328":x.run_state==="parked"?"\uC138\uC158 \uB300\uAE30":x.run_state==="retry_wait"?"\uC7AC\uC2DC\uB3C4 \uB300\uAE30":void 0,can_pause:x.can_pause!==!1,workspace_name:"",dependency_chips:Me(x)||void 0,chip_popover:qe(x),rollup_expanded:Z.has(x.id),failure:x.failure?{...x.failure,open:C===x.attempt_id}:null}));return[...b.filter(x=>x.failed===!0),...b.filter(x=>x.failed!==!0&&x.parked===!0),...b.filter(x=>x.failed!==!0&&x.parked!==!0)]}function qt(g){if(Ae&&Ae.model===g)return Ae.rows;let b=ie(),x=K(g),te=cn(b.attempts),me=Object.values(te).filter(Kn),Te=new Map;for(let We of me)Te.set(We.attempt_id,We);let Ye=new Map;for(let We of me)Ye.set(We.bead_id,We);let yt=new Map;for(let We of[...g.pr_wait,...g.running,...g.queue,...g.runnable,...g.done])yt.has(We.id)||yt.set(We.id,We);let jt=We=>{let Pt=null;for(let bn of me)!bn||bn.bead_id!==We||Ia(bn,Te)||(Pt===null||(typeof bn.started_at=="number"?bn.started_at:0)>=(typeof Pt.started_at=="number"?Pt.started_at:0))&&(Pt=bn);return Pt&&typeof Pt.target_base=="string"?Pt.target_base:null},Xt=new Map;for(let We of g.running)We.run_state==="failed"||We.conflict_resolution!==!0||(We.run_state!=="paused"?Xt.set(We.id,"running"):Xt.has(We.id)||Xt.set(We.id,"paused"));let gn=cn(b.auto_merge_skips),Pn=new Set(x.merge.auto_excluded),hn=cn(b.pr_observations),Nn=cn(b.pr_activity),wn=cn(b.cleanup_failed),Kt=cn(b.discard_operations),er=cn(b.bead_workflow),qn=cn(b.bead_titles),Fn=b.merge_queue_state||{active:null,failures:{}},jn=x.merge.state.waiting,On=new Map;for(let We of Array.isArray(b.merge_queue)?b.merge_queue:[])We&&typeof We=="object"&&We.bead_id&&On.set(We.bead_id,We);let pr=(Array.isArray(b.pr_wait)?b.pr_wait:[]).map(We=>{let Pt=yt.get(We.bead_id);return{...Bv(We.bead_id,Pt?.title||qn[We.bead_id]||We.bead_id,hn,wn[We.bead_id]||null,Gn(te,We.bead_id),Nn[We.bead_id]||(oe.has(We.bead_id)?{activity:null,merge_progress:null,queueing:"merge"}:D.has(We.bead_id)?{activity:null,merge_progress:null,queueing:"cleanup"}:null),Xt.get(We.bead_id)||null,We.external===!0,{position:x.merge.positions.get(We.bead_id)||0,active:Fn.active===We.bead_id,failure:cn(Fn.failures)[We.bead_id]||null,waiting:jn&&jn.bead_id===We.bead_id?jn.reason:null,resolution:x.merge.resolutions.get(We.bead_id),continuation_action:x.merge.continuations.get(We.bead_id),authority:x.merge.authorities.get(We.bead_id)||null,hold:On.get(We.bead_id)?.hold||null,review_dispatch:On.get(We.bead_id)?.review_dispatch||null},We.wt_present!==!1,b.auto_merge===!0&&Pn.has(We.bead_id)?gn[We.bead_id]?.reason||"":null,La(x.declared_base,jt(We.bead_id)),cn(b.completion_status)[We.bead_id]||null,Kt,Ye.get(We.bead_id)?.worker_serial===!0,b.auto_merge===!0,{merge_sha:We.merge_sha,cleanup_cursor:We.cleanup_cursor,repo_operations:x.repo_operations},Pt?Me(Pt):null,bu(te,We.bead_id)),workflow:er[We.bead_id]||null,priority:Pt?.priority,from_id:Pt?.from_id,...Pt?.created_at===void 0?{}:{created_at:Pt.created_at},...Pt?.updated_at===void 0?{}:{updated_at:Pt.updated_at}}});return Ae={model:g,rows:pr},pr}function at(g){let b=K(g),x=[];for(let Te of g.running)Te.non_occupying!==!0&&x.push({id:Te.id,title:Te.title,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:Te.serial_lane_id??null});for(let Te of g.pr_wait)x.push({id:Te.id,title:Te.title,location_label:"PR \uB300\uAE30",kind:"pr_wait",lane_id:null});for(let Te of b.sublanes.serial)Te.items.forEach((Ye,yt)=>{x.push({id:Ye.id,title:Ye.title,location_label:`${Te.id} #${yt+1}`,kind:"serial",lane_id:Te.id})});b.sublanes.parallel.forEach((Te,Ye)=>{x.push({id:Te.id,title:Te.title,location_label:`#${Ye+1}`,kind:"parallel",lane_id:null})});for(let Te of g.runnable)x.push({id:Te.id,title:Te.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null,queue_placeable:Te.queue_placeable===!0});let te=ie();z=pf(te.bead_scope,x);let me=new Map;for(let Te of[...g.running,...g.runnable])Array.isArray(Te.blocked_by)&&Te.blocked_by.length>0&&me.set(Te.id,Te.blocked_by);for(let[Te,Ye]of Object.entries(cn(te.bead_blocked_by)))Array.isArray(Ye)&&me.set(Te,Ye.filter(yt=>typeof yt=="string"&&yt.length>0));ae=Ou(me,x,cn(te.blocker_workspaces))}function Yt(g){let b=g.hold&&typeof g.hold=="object"?g.hold:null;if(!b||b.kind!=="env"&&b.kind!=="systemic")return"";let x=cr(b.cause)||String(b.cause||""),te=Array.isArray(g.lineages)?g.lineages:[];if(b.kind==="env"){let Te=te.map(yt=>yt&&yt.next_at).filter(yt=>typeof yt=="number").sort((yt,jt)=>yt-jt)[0],Ye=typeof Te=="number"?` \xB7 \uB2E4\uC74C ${new Date(Te).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"})}`:"";return c`<div class="worker-hold worker-hold--env" role="status">
    ...
    >`,hn=c`<label class="worker-tgl worker-slots"
      ...
      </label> `,Nn=vu(x.repo_operations,x.cleanup_failures),wn=Yt(b);return Q?c`<div class="worker-ribbon">
          ${Te} ${Ye}
    ...
    </div>`}function Ut(){let g=N?"custom":yl(X)||"custom";return c`<select
      class="worker-sort"
      aria-label="후보 정렬"
      title="후보 정렬"
      .value=${g}
    ...
    `}function N(){let M=t.getState(),B=M.workspace?.current,Q=M.workspace?.available||[],oe=new Set(M.workspace?.hidden||[]),D=B?.path||Q[0]?.path||"";if(Q.length===0)return c``;let Y=Q.filter(U=>!oe.has(U.path)||U.path===D);if(Y.length<=1){let U=Y[0]||Q[0],Z=xl(U.path);return c`
