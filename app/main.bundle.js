...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Xs=/'/g,Qs=/"/g,ro=/^(?:script|style|textarea|title)$/i,qn=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),l=qn(1),Pt=qn(2),hu=qn(3),Xt=Symbol.for("lit-noChange"),Ze=Symbol.for("lit-nothing"),Js=new WeakMap,Kt=Zt.createTreeWalker(Zt,129);function no(e,t){if(!Fn(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Vs!==void 0?Vs.createHTML(t):t}var Bi=(e,t)=>{let r=e.length-1,n=[],s,o=t===2?"<svg>":t===3?"<math>":"",a=kr;for(let c=0;c<r;c++){let i=e[c],d,_,m=-1,h=0;for(;h<i.length&&(a.lastIndex=h,_=a.exec(i),_!==null);)h=a.lastIndex,a===kr?_[1]==="!--"?a=Ks:_[1]!==void 0?a=Zs:_[2]!==void 0?(ro.test(_[2])&&(s=RegExp("</"+_[2],"g")),a=Vt):_[3]!==void 0&&(a=Vt):a===Vt?_[0]===">"?(a=s??kr,m=-1):_[1]===void 0?m=-2:(m=a.lastIndex-_[2].length,d=_[1],a=_[3]===void 0?Vt:_[3]==='"'?Qs:Xs):a===Qs||a===Xs?a=Vt:a===Ks||a===Zs?a=kr:(a=Vt,s=void 0);let w=a===Vt&&e[c+1].startsWith("/>")?" ":"";o+=a===kr?i+Fi:m>=0?(n.push(d),i.slice(0,m)+eo+i.slice(m)+Ht+w):i+Ht+(m===-2?c:w)}return[no(e,o+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]},Sr=class e{constructor({strings:t,_$litType$:r},n){let s;this.parts=[];let o=0,a=0,c=t.length-1,i=this.parts,[d,_]=Bi(t,r);if(this.el=e.createElement(d,n),Kt.currentNode=this.el.content,r===2||r===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=Kt.nextNode())!==null&&i.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith(eo)){let h=_[a++],w=s.getAttribute(m).split(Ht),$=/([.?@])?(.*)/.exec(h);i.push({type:1,index:o,name:$[2],strings:w,ctor:$[1]==="."?On:$[1]==="?"?Mn:$[1]==="@"?Nn:lr}),s.removeAttribute(m)}else m.startsWith(Ht)&&(i.push({type:6,index:o}),s.removeAttribute(m));if(ro.test(s.tagName)){let m=s.textContent.split(Ht),h=m.length-1;if(h>0){s.textContent=Zr?Zr.emptyScript:"";for(let w=0;w<h;w++)s.append(m[w],$r()),Kt.nextNode(),i.push({type:2,index:++o});s.append(m[h],$r())}}}else if(s.nodeType===8)if(s.data===to)i.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(Ht,m+1))!==-1;)i.push({type:7,index:o}),m+=Ht.length-1}o++}}static createElement(t,r){let n=Zt.createElement("template");return n.innerHTML=t,n}};function ir(e,t,r=e,n){if(t===Xt)return t;let s=n!==void 0?r._$Co?.[n]:r._$Cl,o=xr(t)?void 0:t._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(e),s._$AT(e,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(t=ir(e,s._$AS(e,t.values),s,n)),t}var Dn=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:r},parts:n}=this._$AD,s=(t?.creationScope??Zt).importNode(r,!0);Kt.currentNode=s;let o=Kt.nextNode(),a=0,c=0,i=n[0];for(;i!==void 0;){if(a===i.index){let d;i.type===2?d=new Ar(o,o.nextSibling,this,t):i.type===1?d=new i.ctor(o,i.name,i.strings,this,t):i.type===6&&(d=new Pn(o,this,t)),this._$AV.push(d),i=n[++c]}a!==i?.index&&(o=Kt.nextNode(),a++)}return Kt.currentNode=Zt,s}p(t){let r=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,r),r+=n.strings.length-2):n._$AI(t[r])),r++}},Ar=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,r,n,s){this.type=2,this._$AH=Ze,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=ir(this,t,r),xr(t)?t===Ze||t==null||t===""?(this._$AH!==Ze&&this._$AR(),this._$AH=Ze):t!==this._$AH&&t!==Xt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):qi(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Ze&&xr(this._$AH)?this._$AA.nextSibling.data=t:this.T(Zt.createTextNode(t)),this._$AH=t}$(t){let{values:r,_$litType$:n}=t,s=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=Sr.createElement(no(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(r);else{let o=new Dn(s,this),a=o.u(this.options);o.p(r),this.T(a),this._$AH=o}}_$AC(t){let r=Js.get(t.strings);return r===void 0&&Js.set(t.strings,r=new Sr(t)),r}k(t){Fn(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,n,s=0;for(let o of t)s===r.length?r.push(n=new e(this.O($r()),this.O($r()),this,this.options)):n=r[s],n._$AI(o),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(t=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);t!==this._$AB;){let n=t.nextSibling;t.remove(),t=n}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},lr=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,n,s,o){this.type=1,this._$AH=Ze,this._$AN=void 0,this.element=t,this.name=r,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=Ze}_$AI(t,r=this,n,s){let o=this.strings,a=!1;if(o===void 0)t=ir(this,t,r,0),a=!xr(t)||t!==this._$AH&&t!==Xt,a&&(this._$AH=t);else{let c=t,i,d;for(t=o[0],i=0;i<o.length-1;i++)d=ir(this,c[n+i],r,i),d===Xt&&(d=this._$AH[i]),a||(a=!xr(d)||d!==this._$AH[i]),d===Ze?t=Ze:t!==Ze&&(t+=(d??"")+o[i+1]),this._$AH[i]=d}a&&!s&&this.j(t)}j(t){t===Ze?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},On=class extends lr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Ze?void 0:t}},Mn=class extends lr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Ze)}},Nn=class extends lr{constructor(t,r,n,s,o){super(t,r,n,s,o),this.type=5}_$AI(t,r=this){if((t=ir(this,t,r,0)??Ze)===Xt)return;let n=this._$AH,s=t===Ze&&n!==Ze||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,o=t!==Ze&&(n===Ze||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Pn=class{constructor(t,r,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){ir(this,t)}};var Ui=wr.litHtmlPolyfillSupport;Ui?.(Sr,Ar),(wr.litHtmlVersions??(wr.litHtmlVersions=[])).push("3.3.1");var De=(e,t,r)=>{let n=r?.renderBefore??t,s=n._$litPart$;if(s===void 0){let o=r?.renderBefore??null;n._$litPart$=s=new Ar(t.insertBefore($r(),o),o,void 0,r??{})}return s._$AI(e),s};var kt="today",Lt=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function Ft(e){return e==="today"||e==="7d"||e==="30d"||e==="all"}function cr(e,t=Date.now()){switch(e){case"today":{let r=new Date(t);return r.setHours(0,0,0,0),r.getTime()}case"7d":return t-7*864e5;case"30d":return t-30*864e5;case"all":default:return}}function so(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function oo(){let e=null,t=[],r=new Set;function n(){for(let s of Array.from(r))try{s()}catch{}}return{get(){return e},getWorkspacesState(){return t},set(s,o){e=Array.isArray(s)?s:null,t=Array.isArray(o)?o:[],n()},clear(){e=null,t=[],n()},subscribe(s){return r.add(s),()=>r.delete(s)}}}function ao(){let e=new Map,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{set(n,s,o=null){e.set(n,{lines:Array.isArray(s)?[...s]:[],last_event_at:typeof o=="number"?o:null}),r()},append(n,s){let o=e.get(n)||{lines:[],last_event_at:null};o.lines=[...o.lines,s],o.last_event_at=Date.now(),e.set(n,o),r()},get(n){return e.get(n)||null},clear(n){typeof n=="string"?e.delete(n):e.clear(),r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}var fo=Pi(po(),1);function He(e){return(0,fo.default)(`beads-ui:${e}`)}function St(e){if(typeof e=="number")return Number.isFinite(e)?e:0;if(typeof e=="string"){let t=Date.parse(e);return Number.isFinite(t)?t:0}return 0}function Jt(e,t){let r=St(e.created_at),n=St(t.created_at);if(r!==n)return r<n?1:-1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,c=t.id;return a<c?-1:a>c?1:0}function go(e,t){let r=St(e.created_at),n=St(t.created_at);if(r!==n)return r<n?-1:1;let s=e.priority??2,o=t.priority??2;if(s!==o)return s-o;let a=e.id,c=t.id;return a<c?-1:a>c?1:0}function ho(e,t){let r=St(e.updated_at),n=St(t.updated_at);if(r!==n)return r<n?1:-1;let s=e.id,o=t.id;return s<o?-1:s>o?1:0}function bo(e,t){let r=e.priority??2,n=t.priority??2;if(r!==n)return r-n;let s=St(e.created_at),o=St(t.created_at);if(s!==o)return s<o?1:-1;let a=e.id,c=t.id;return a<c?-1:a>c?1:0}function vo(e,t){let r=e.closed_at??0,n=t.closed_at??0;if(r!==n)return r<n?1:-1;let s=e?.id,o=t?.id;return s<o?-1:s>o?1:0}var el=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function _o(e){let t=e&&e.metadata,r=t?t.task_order:void 0;if(r==null||r==="")return Number.POSITIVE_INFINITY;let n=Number(r);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function mo(e){let t=e&&e.title;if(typeof t!="string")return Number.POSITIVE_INFINITY;let r=el.exec(t);if(!r)return Number.POSITIVE_INFINITY;let n=Number(r[1]);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function yo(e,t){let r=_o(e),n=_o(t);if(r!==n)return r<n?-1:1;let s=mo(e),o=mo(t);if(s!==o)return s<o?-1:1;let a=St(e&&e.created_at),c=St(t&&t.created_at);if(a!==c)return a<c?-1:1;let i=e&&e.id,d=t&&t.id;return i===d?0:String(i)<String(d)?-1:1}var Bn=2**20;function fr(e,t){let r=e&&e.id;return t&&typeof r=="string"&&Object.prototype.hasOwnProperty.call(t,r)&&typeof t[r]=="number"&&Number.isFinite(t[r])?t[r]:-St(e&&e.created_at)}function Jr(e){return(t,r)=>{let n=fr(t,e),s=fr(r,e);if(n!==s)return n<s?-1:1;let o=t?.id,a=r?.id;return o<a?-1:o>a?1:0}}function Un(e,t,r){let n=Array.isArray(e)?e:[],s=n.length,o=Math.max(0,Math.min(t,s-1)),a=o-1>=0?n[o-1]:null,c=o+1<s?n[o+1]:null;if(!a&&!c)return{rank:0};if(!a)return{rank:fr(c,r)-Bn};if(!c)return{rank:fr(a,r)+Bn};let i=fr(a,r),d=fr(c,r),_=(i+d)/2;return i<_&&_<d?{rank:_}:{renormalize:n.map((m,h)=>({bead_id:m.id,rank:h*Bn}))}}function zn(e,t={}){let r=He(`issue-store:${e}`),n=new Map,s=[],o=0,a=new Set,c=!1,i=t.sort||Jt;function d(){for(let h of Array.from(a))try{h()}catch{}}function _(){s=Array.from(n.values()).sort(i)}function m(h){if(c||!h||h.id!==e)return;let w=Number(h.revision)||0;if(r("apply %s rev=%d",h.type,w),!(w<=o&&h.type!=="snapshot")){if(h.type==="snapshot"){if(w<=o)return;n.clear();let $=Array.isArray(h.issues)?h.issues:[];for(let g of $)g&&typeof g.id=="string"&&g.id.length>0&&n.set(g.id,g);_(),o=w,d();return}if(h.type==="upsert"){let $=h.issue;if($&&typeof $.id=="string"&&$.id.length>0){let g=n.get($.id);if(!g)n.set($.id,$);else{let E=Number.isFinite(g.updated_at)?g.updated_at:0,j=Number.isFinite($.updated_at)?$.updated_at:0;if(E<=j){for(let Y of Object.keys(g))Y in $||delete g[Y];for(let[Y,Z]of Object.entries($))g[Y]=Z}}_()}o=w,d()}else if(h.type==="delete"){let $=String(h.issue_id||"");$&&(n.delete($),_()),o=w,d()}}}return{id:e,subscribe(h){return a.add(h),()=>{a.delete(h)}},applyPush:m,snapshot(){return s},size(){return n.size},getById(h){return n.get(h)},dispose(){c=!0,n.clear(),s=[],a.clear(),o=0}}}function en(e){let t=String(e.type||"").trim(),r={};if(e.params&&typeof e.params=="object"){let s=Object.keys(e.params).sort();for(let o of s){let a=e.params[o];r[o]=String(a)}}let n=new URLSearchParams(r).toString();return n.length>0?`${t}?${n}`:t}function ko(e){let t=He("subs"),r=new Map,n=new Map;function s(c,i){t("applyDelta %s +%d ~%d -%d",c,(i.added||[]).length,(i.updated||[]).length,(i.removed||[]).length);let d=n.get(c);if(!d||d.size===0)return;let _=Array.isArray(i.added)?i.added:[],m=Array.isArray(i.updated)?i.updated:[],h=Array.isArray(i.removed)?i.removed:[];for(let w of Array.from(d)){let $=r.get(w);if(!$)continue;let g=$.itemsById;for(let E of _)typeof E=="string"&&E.length>0&&g.set(E,!0);for(let E of m)typeof E=="string"&&E.length>0&&g.set(E,!0);for(let E of h)typeof E=="string"&&E.length>0&&g.delete(E)}}async function o(c,i){let d=en(i);if(t("subscribe %s key=%s",c,d),!r.has(c))r.set(c,{key:d,itemsById:new Map});else{let m=r.get(c);if(m&&m.key!==d){let h=n.get(m.key);h&&(h.delete(c),h.size===0&&n.delete(m.key)),r.set(c,{key:d,itemsById:new Map})}}n.has(d)||n.set(d,new Set);let _=n.get(d);_&&_.add(c);try{await e("subscribe-list",{id:c,type:i.type,params:i.params})}catch(m){let h=r.get(c)||null;if(h){let w=n.get(h.key);w&&(w.delete(c),w.size===0&&n.delete(h.key))}throw r.delete(c),m}return async()=>{t("unsubscribe %s key=%s",c,d);try{await e("unsubscribe-list",{id:c})}catch{}let m=r.get(c)||null;if(m){let h=n.get(m.key);h&&(h.delete(c),h.size===0&&n.delete(m.key))}r.delete(c)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:en,selectors:{getIds(c){let i=r.get(c);return i?Array.from(i.itemsById.keys()):[]},has(c,i){let d=r.get(c);return d?d.itemsById.has(i):!1},count(c){let i=r.get(c);return i?i.itemsById.size:0},getItemsById(c){let i=r.get(c),d={};if(!i)return d;for(let _ of i.itemsById.keys())d[_]=!0;return d}}}}function wo(){let e=He("issue-stores"),t=new Map,r=new Map,n=new Set,s=new Map;function o(){for(let i of Array.from(n))try{i()}catch{}}function a(i,d,_){let m=d?en(d):"",h=r.get(i)||"",w=t.has(i);if(e("register %s key=%s (prev=%s)",i,m,h),w&&h&&m&&h!==m){let $=t.get(i);if($)try{$.dispose()}catch{}let g=s.get(i);if(g){try{g()}catch{}s.delete(i)}let E=zn(i,_);t.set(i,E);let j=E.subscribe(()=>o());s.set(i,j)}else if(!w){let $=zn(i,_);t.set(i,$);let g=$.subscribe(()=>o());s.set(i,g)}return r.set(i,m),()=>c(i)}function c(i){e("unregister %s",i),r.delete(i);let d=t.get(i);d&&(d.dispose(),t.delete(i));let _=s.get(i);if(_){try{_()}catch{}s.delete(i)}}return{register:a,unregister:c,getStore(i){return t.get(i)||null},snapshotFor(i){let d=t.get(i);return d?d.snapshot().slice():[]},subscribe(i){return n.add(i),()=>n.delete(i)}}}function $o(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function xo(){let e=null,t=new Set;function r(){for(let n of Array.from(t))try{n()}catch{}}return{get(){return e},set(n){e=n,r()},clear(){e=null,r()},subscribe(n){return t.add(n),()=>t.delete(n)}}}function Hn(e,t){return`#/${e==="worker"||e==="monitor"?e:"board"}?issue=${encodeURIComponent(t)}`}function tl(e){let t=String(e||""),r=t.startsWith("#")?t.slice(1):t,n=r.indexOf("?"),s=n>=0?r.slice(n+1):"";if(s){let c=new URLSearchParams(s).get("issue");if(c)return decodeURIComponent(c)}let o=/^\/issue\/([^\s?#]+)/.exec(r);return o&&o[1]?decodeURIComponent(o[1]):null}function rl(e){let t=String(e||"");return/^#\/worker(\b|\/|$)/.test(t)?"worker":/^#\/monitor(\b|\/|$)/.test(t)?"monitor":"board"}function So(e){let t=He("router"),r=()=>{let n=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(n),o=s&&s[1]?decodeURIComponent(s[1]):tl(n),a=rl(n);if(t("hash change \u2192 view=%s id=%s",a,o),e.setState({selected_id:a==="worker"?null:o,view:a,worker:{selected_parent_id:a==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(n)){let i=o?`#/${a}?issue=${encodeURIComponent(o)}`:`#/${a}`;window.location.hash!==i&&(window.location.hash=i)}};return{start(){window.addEventListener("hashchange",r),r()},stop(){window.removeEventListener("hashchange",r)},gotoIssue(n){let s=e.getState?e.getState():{view:"board"},o=s.view==="worker"||s.view==="monitor"?s.view:"board",a=Hn(o,n);t("goto issue %s (view=%s)",n,o),window.location.hash!==a?window.location.hash=a:e.setState({selected_id:o==="worker"?null:n,view:o,worker:{selected_parent_id:o==="worker"?n:null}})},gotoView(n){let s=e.getState?e.getState():{selected_id:null,worker:{selected_parent_id:null}},o=n==="worker"?s.worker?.selected_parent_id:s.selected_id,a=o?Hn(n,o):`#/${n}`;t("goto view %s (id=%s)",n,o||""),window.location.hash!==a?window.location.hash=a:e.setState({view:n,selected_id:n==="worker"?null:s.selected_id})}}}var nl=Object.freeze({workspace_config:{default_workspace:null}});function Ao(e){return{workspace_config:{default_workspace:typeof e?.workspace_config?.default_workspace=="string"&&e.workspace_config.default_workspace.length>0?e.workspace_config.default_workspace:nl.workspace_config.default_workspace}}}function To(e={}){let t=He("state"),r={selected_id:e.selected_id??null,view:e.view??"board",filters:{status:e.filters?.status??"all",search:e.filters?.search??"",type:typeof e.filters?.type=="string"?e.filters?.type:""},board:{closed_filter:e.board?.closed_filter==="3"||e.board?.closed_filter==="7"||e.board?.closed_filter==="today"?e.board?.closed_filter:"today"},worker:{selected_parent_id:e.worker?.selected_parent_id??null,show_closed_children:Array.isArray(e.worker?.show_closed_children)?e.worker.show_closed_children:[]},workspace:{current:e.workspace?.current??null,available:e.workspace?.available??[],hidden:e.workspace?.hidden??[]},config:Ao(e.config)},n=new Set;function s(){for(let o of Array.from(n))try{o(r)}catch{}}return{getState(){return r},setState(o){let a={...r,...o,filters:{...r.filters,...o.filters||{}},board:{...r.board,...o.board||{}},worker:{...r.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:r.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:r.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:r.workspace.hidden},config:o.config!==void 0?Ao(o.config):r.config},c=a.workspace.current?.path!==r.workspace.current?.path||a.workspace.available.length!==r.workspace.available.length||a.workspace.hidden.length!==r.workspace.hidden.length||a.workspace.hidden.some((d,_)=>d!==r.workspace.hidden[_]),i=a.config.workspace_config.default_workspace!==r.config.workspace_config.default_workspace;a.selected_id===r.selected_id&&a.view===r.view&&a.filters.status===r.filters.status&&a.filters.search===r.filters.search&&a.filters.type===r.filters.type&&a.board.closed_filter===r.board.closed_filter&&a.worker.selected_parent_id===r.worker.selected_parent_id&&a.worker.show_closed_children.length===r.worker.show_closed_children.length&&a.worker.show_closed_children.every((d,_)=>d===r.worker.show_closed_children[_])&&!c&&!i||(r=a,t("state change %o",{selected_id:r.selected_id,view:r.view,filters:r.filters,board:r.board,worker:r.worker,workspace:r.workspace.current?.path,config:{default_workspace:r.config.workspace_config.default_workspace}}),s())},subscribe(o){return n.add(o),()=>n.delete(o)}}}function Eo(e){let t=He("activity"),r=0,n=new Map,s=1;function o(){if(!e)return;let d=r>0;e.toggleAttribute("hidden",!d),e.setAttribute("aria-busy",d?"true":"false")}function a(){r+=1,t("start count=%d",r),o()}function c(){let d=r;r=Math.max(0,r-1),d<=0?t("done called but count was already %d",d):t("done count=%d\u2192%d",d,r),o()}function i(d){return async(m,h)=>{let w=s++,$=Date.now();n.set(w,{type:m,start_ts:$}),t("request start id=%d type=%s count=%d",w,m,r+1),a();let g=!1,E=()=>{g||(g=!0,n.delete(w),c())},j=setTimeout(()=>{g||(t("request TIMEOUT id=%d type=%s elapsed=%dms",w,m,Date.now()-$),E())},3e4);try{let Y=await d(m,h),Z=Date.now()-$;return t("request done id=%d type=%s elapsed=%dms",w,m,Z),Y}catch(Y){let Z=Date.now()-$;throw t("request error id=%d type=%s elapsed=%dms err=%o",w,m,Z,Y),Y}finally{clearTimeout(j),E()}}}return o(),{wrapSend:i,start:a,done:c,getCount:()=>r,getActiveRequests:()=>{let d=Date.now();return Array.from(n.entries()).map(([_,m])=>({id:_,type:m.type,elapsed_ms:d-m.start_ts}))}}}function ne(e,t="info",r=2800){let n=document.createElement("div");n.className="toast",n.textContent=e,n.style.position="fixed",n.style.right="12px",n.style.bottom="12px",n.style.zIndex="1000",n.style.color="#fff",n.style.padding="8px 10px",n.style.borderRadius="4px",n.style.fontSize="12px",t==="success"?n.style.background="#156d36":t==="warning"?n.style.background="#a36a00":t==="error"?n.style.background="#9f2011":n.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(n),setTimeout(()=>{try{n.remove()}catch{}},r)}function tn(e=void 0,t=void 0){function r(){if(!t||typeof t.get!="function")return null;let o=t.get();return o&&o.order?o.order:{}}function n(o,a,c){let i=e&&e.snapshotFor?e.snapshotFor(o).slice():[];if(a==="closed")return i.sort(vo),i;switch(c){case"created_desc":return i.sort(Jt),i;case"created_asc":return i.sort(go),i;case"updated_desc":return i.sort(ho),i;case"priority":return i.sort(bo),i;case"manual":default:{let d=r();return d?i.sort(Jr(d)):i.sort(Jt),i}}}function s(o){let a=[];return e&&typeof e.subscribe=="function"&&a.push(e.subscribe(o)),t&&typeof t.subscribe=="function"&&a.push(t.subscribe(o)),()=>{for(let c of a)try{c()}catch{}}}return{selectBoardColumn:n,subscribe:s}}function Tr(e){if(!e)return null;if(typeof e=="number")return Number.isFinite(e)?e:null;let t=Date.parse(e);return Number.isFinite(t)?t:null}function ct(e){let t=Tr(e);if(t===null)return"";let r=new Date(t),n=s=>String(s).padStart(2,"0");return`${r.getFullYear()}-${n(r.getMonth()+1)}-${n(r.getDate())} ${n(r.getHours())}:${n(r.getMinutes())}`}function yt(e,t){let r=Tr(e);if(r===null)return"";let s=(typeof t=="number"?t:Date.now())-r;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let a=Math.floor(s/36e5);if(a<24)return`${a}\uC2DC\uAC04 \uC804`;let c=Math.floor(s/864e5);if(c<7)return`${c}\uC77C \uC804`;let i=Math.floor(c/7);if(c<30)return`${i}\uC8FC \uC804`;let d=Math.floor(c/30);return d<12?`${d}\uAC1C\uC6D4 \uC804`:`${Math.floor(c/365)}\uB144 \uC804`}function rn(e){if(!Array.isArray(e))return null;let t=null,r=-1;for(let n of e){if(!n||n.status!=="in_progress")continue;let s=Tr(n.updated_at)??0;if(t===null||s>r){t=n,r=s;continue}s===r&&String(n.id)<String(t.id)&&(t=n)}return t}function nn(e){let t=e.transport,r=e.uiOrderStore;function n(a,c){return"renormalize"in a?a.renormalize:[{bead_id:c,rank:a.rank}]}function s(a,c){let i={...a.order};for(let d of c)i[d.bead_id]=d.rank;r&&r.set({revision:a.revision,order:i})}async function o(a,c,i){if(!t||!r)return;let d=r.get()||{revision:0,order:{}},_=n(Un(c,i,d.order),a);s(d,_);let m=await t("ui-order-set",{expected_revision:d.revision,entries:_});if(m&&m.conflict){let h={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};r.set(h);let w=n(Un(c,i,h.order),a);s(h,w);let $=await t("ui-order-set",{expected_revision:h.revision,entries:w});$&&$.applied&&r.set({revision:typeof $.revision=="number"?$.revision:0,order:$.order||{}})}else m&&m.applied&&r.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:o}}function sn(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Wn(e,t){return!t||typeof e!="string"||e.length===0||sn(t.visible_labels).includes(e)?!0:sn(t.hidden_labels).includes(e)?!1:!sn(t.hidden_prefixes).some(r=>r.length>0&&e.startsWith(r))}function on(e,t){return sn(e).filter(r=>Wn(r,t))}function er(e,t){let r=e&&e.chips?e.chips[t]:void 0;return typeof r=="boolean"?r:!0}var sl={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg"},Co={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge"},ol={spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},al={review:"\u2713",skip:"\u2298"},_r={none:"\uBBF8\uB3C4\uB2EC",dim:"\uC9C4\uD589 \uC911",stale:"\uC7AC\uAC80\uD1A0 \uD544\uC694",review:"\uAC80\uD1A0 \uC644\uB8CC",skip:"\uAC80\uD1A0 \uC0DD\uB7B5",done:"\uC644\uB8CC"};function il(e,t,r){if(!(r==="in_progress"||r==="resolved"))return null;for(let s of e){let o=t[s];if(o&&o.fill==="dim"&&o.stale!==!0)return s}return null}function ll(e){let t=e&&e.fill||"none";return t==="none"?_r.none:e&&e.stale===!0?_r.stale:t==="dim"?_r.dim:e&&e.glyph==="review"?_r.review:e&&e.glyph==="skip"?_r.skip:_r.done}function cl(e,t,r){let n=sl[e]||e,s=t&&t.fill||"none",o=!!t&&t.stale===!0,a=al[t&&t.glyph||""]||"",c="bar";s==="dim"?c+=` b-${n} dim`:s==="full"&&(c+=` b-${n} full`),o&&(c+=" stale"),r&&(c+=" cur");let i=s==="none"?"lbl":`lbl l-${n} on`,d=r?`color: var(--stage-${n}-on)`:"";return l`
  ...
  `}var yl=200,kl={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","closed-col":"closed"},wl=new Set(["blocked-col","ready-col","in-progress-col","resolved-col"]),Do="beads-ui.board.sort",Oo=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function $l(){try{let e=window.localStorage.getItem(Do);if(e&&Oo.has(e))return e}catch{}return"created_desc"}function Mo(e,t){let r=He("views:board"),n=t.gotoIssue,s=t.issueStores,o=t.transport,a=t.uiOrderStore,c=t.displayPolicyStore,i=t.onClosedRangeChange,d=t.onNewIssue,_=t.closedRange||kt,m=s?tn(s,a):null,h=nn({transport:o,uiOrderStore:a}),w=[],$=[],g=[],E=[],j=[],Y=[],Z=!1,M=0,A=$l(),x=new Map,P=new Map,H=new Map,ce=new Set,J={search:"",priority:"",type:"",labels:[]},ae=!1,fe=null;function Le(I){return String(I.status||"open")==="open"}function Ye(I){let q=String(I.status||"open");return q==="open"||q==="blocked"}function Se(I){let q=J.search.trim().toLowerCase(),re=J.priority,se=J.type,ie=J.labels;return I.filter(ve=>{if(q){let u=String(ve.id||"").toLowerCase(),v=String(ve.title||"").toLowerCase();if(!u.includes(q)&&!v.includes(q))return!1}if(re!==""&&String(ve.priority)!==re||se!==""&&String(ve.issue_type||"")!==se)return!1;if(ie.length>0){let u=Array.isArray(ve.labels)?ve.labels:[];if(!ie.some(v=>u.includes(v)))return!1}return!0})}function T(){let I=new Set;for(let q of[w,$,g,E,j,Y])for(let re of q){let se=Array.isArray(re.labels)?re.labels:[];for(let ie of se)typeof ie=="string"&&ie.length>0&&I.add(ie)}return Array.from(I).sort()}function K(){return J.search.trim()!==""||J.priority!==""||J.type!==""||J.labels.length>0}function O(){try{if(m){let I=m.selectBoardColumn("tab:board:in-progress","in_progress",A),q=m.selectBoardColumn("tab:board:blocked","blocked",A).filter(Ye),re=new Set(I.map(X=>X.id)),se=m.selectBoardColumn("tab:board:ready","ready",A).filter(X=>Le(X)&&!re.has(X.id)),ie=m.selectBoardColumn("tab:board:resolved","resolved",A),ve=m.selectBoardColumn("tab:board:deferred","deferred",A),u=m.selectBoardColumn("tab:board:closed","closed").slice(0,yl),v=[...q,...se,...I,...ie,...u];W(v);let L=new Set;for(let X of v)X&&X.id&&!Gn(X)&&L.add(X.id);let Q=!K();w=Q?Er(q,L):q,$=Q?Er(se,L):se,g=Q?Er(I,L):I,E=Q?Er(ie,L):ie,j=ve,M=ve.length,Y=Q?Er(u,L):u,x=new Map;for(let X of w)x.set(X.id,"open");for(let X of $)x.set(X.id,"open");for(let X of g)x.set(X.id,"in_progress");for(let X of E)x.set(X.id,"resolved");for(let X of j)x.set(X.id,"deferred");for(let X of Y)x.set(X.id,"closed");P=new Map;for(let X of w)P.set(X.id,"blocked-col");for(let X of $)P.set(X.id,"ready-col");for(let X of g)P.set(X.id,"in-progress-col");for(let X of E)P.set(X.id,"resolved-col");for(let X of Y)P.set(X.id,"closed-col")}Ae()}catch{w=[],$=[],g=[],E=[],j=[],Y=[],H=new Map,Ae()}}function W(I){let q=new Map;for(let se of I)se&&se.id&&!q.has(se.id)&&q.set(se.id,se);let re=new Map;for(let se of q.values()){let ie=Gn(se);if(!ie)continue;let ve=re.get(ie);ve||(ve=[],re.set(ie,ve)),ve.push({id:se.id,title:se.title,status:se.status,metadata:se.metadata,created_at:se.created_at,updated_at:se.updated_at})}H=re}function de(I){let q=H.get(I)||[],re=0;for(let ie of q)(ie.status==="resolved"||ie.status==="closed")&&(re+=1);let se=rn(q);return{total:q.length,count:re,current:se,children:q}}function le(I){return!ce.has(I)}function ye(I,q){I.preventDefault(),I.stopPropagation(),ce.has(q)?ce.delete(q):ce.add(q),Ae()}function _e(I,q){I.preventDefault(),I.stopPropagation(),n(q)}function Ue(I,q){I.preventDefault(),I.stopPropagation(),n(q)}function ue(I,q){fe||n(q)}function Oe(I,q){I.preventDefault(),I.stopPropagation(),xl(q).then(re=>{re&&ne("\uBCF5\uC0AC\uB428","success",1200)})}function F(I,q){fe=q,I.dataTransfer&&(I.dataTransfer.setData("text/plain",q),I.dataTransfer.effectAllowed="move"),I.target.classList.add("board-card--dragging")}function N(I){I.target.classList.remove("board-card--dragging"),bt(),setTimeout(()=>{fe=null},0)}function pe(I){let q=String(I.target.value||"");!q||q===_||(_=q,i&&i(q),Ae())}function qe(){return c?c.get():null}let D={onCardClick:ue,onCopyId:Oe,onDragStart:F,onDragEnd:N,onClosedRangeChange:pe,rollupFor:de,isExpanded:le,onRollupToggle:ye,onChildClick:_e,onFromChipClick:Ue,get policy(){return qe()}};function G(I,q){fe||(We(),n(q))}function R(I,q){I.preventDefault(),I.stopPropagation(),We(),n(q)}let te={...D,onCardClick:G,onChildClick:R,onFromChipClick:R,get policy(){return qe()}};function ee(I){let q=I.target,re=e.querySelector(".board-filter__labels");q&&re&&re.contains(q)||$e()}function ge(I){I.key==="Escape"&&$e()}function he(){ae||(ae=!0,document.addEventListener("mousedown",ee),document.addEventListener("keydown",ge),Ae())}function $e(){ae&&(ae=!1,document.removeEventListener("mousedown",ee),document.removeEventListener("keydown",ge),Ae())}function Re(I){I.key==="Escape"&&We()}function rt(){Z||(Z=!0,document.addEventListener("keydown",Re),Ae())}function We(){Z&&(Z=!1,document.removeEventListener("keydown",Re),Ae())}let Xe={onClose:We,onOverlayClick(I){I.target===I.currentTarget&&We()}},dt={onSearchInput(I){J.search=String(I.target.value||""),O()},onPriorityChange(I){J.priority=String(I.target.value||""),O()},onTypeChange(I){J.type=String(I.target.value||""),O()},onSortChange(I){let q=String(I.target.value||"");if(!(!Oo.has(q)||q===A)){A=q;try{window.localStorage.setItem(Do,q)}catch{}O()}},onDeferredToggle(){Z?We():rt()},onLabelMenuToggle(){ae?$e():he()},onLabelToggle(I){let q=J.labels.indexOf(I);q===-1?J.labels.push(I):J.labels.splice(q,1),O()},onLabelClear(){J.labels.length!==0&&(J.labels=[],O())},onNewIssue(){d&&d()}};function ut(){return l`
      <div class="board-view">
        ${Lo(J,dt,{sort_mode:A,deferred_popup_open:Z,deferred_count:M,label_options:T(),label_menu_open:ae})}
...
Please report this to https://github.com/markedjs/marked.`,e){let n="<p>An error occurred:</p><pre>"+Ut(r.message+"",!0)+"</pre>";return t?Promise.resolve(n):n}if(t)return Promise.reject(r);throw r}}},nr=new Rc;function Me(e,t){return nr.parse(e,t)}Me.options=Me.setOptions=function(e){return nr.setOptions(e),Me.defaults=nr.defaults,aa(Me.defaults),Me};Me.getDefaults=ss;Me.defaults=sr;Me.use=function(...e){return nr.use(...e),Me.defaults=nr.defaults,aa(Me.defaults),Me};Me.walkTokens=function(e,t){return nr.walkTokens(e,t)};Me.parseInline=nr.parseInline;Me.Parser=Ct;Me.parser=Ct.parse;Me.Renderer=hn;Me.TextRenderer=ps;Me.Lexer=Et;Me.lexer=Et.lex;Me.Tokenizer=gn;Me.Hooks=Pr;Me.parse=Me;var Np=Me.options,Pp=Me.setOptions,Fp=Me.use,qp=Me.walkTokens,Bp=Me.parseInline;var Up=Ct.parse,zp=Et.lex;function Wt(e){let t=Me.parse(e),r=Zo.sanitize(t);return Jo(r)}function zt(e,t){return l`<div class="prompt-block">
    ...
    <pre class="prompt-block__body">${t}</pre>
      ...
      </div>`}if(N.kind==="error")return l`<div class="sv__error">⛔ ${N.text}</div>`;if(N.kind==="blocker")return l`<div class="sv__error">⛔ ${N.text}</div>`;if(N.kind==="tool"){let pe=i.has(F),qe=N.tool==="Bash"?Wc(N.command):0,D=N.tool==="Bash"?qe>1?kn(N.command):N.command:N.path||N.command||"";return l`<div
...
`)}function Se(){if(!o)return l``;let F=A(),N=[a.runner,a.model,a.effort].filter(Boolean).join(" \xB7 "),pe=a.session_id||"",qe=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${c?"ON":"OFF"}`,D=P(),G=D?Zc(x(),Date.now()):"",R=D?ae(F):null,te=D?fe(F):null,ee=Kc(F);return l`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
`).trim()}}var $a=20;function xa(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${r}-${n} ${s}:${o}`}function td(e){return e.length>$a?`${e.slice(0,$a)}\u2026`:e}function rd(e,t,r,n){let s=`${t.lane} ${td(t.identifier)}`;return l`<div class="detail-report">
  ...
  `}function pd(e){let t=br(e);if(t)return t;let r=e.data;if(!r)return"";if(r.missing)return l`<div class="detail-prompt__missing">
    ...
    ${typeof r.system_prompt=="string"?zt("\uC2DC\uC2A4\uD15C \uACC4\uC57D (--append-system-prompt)",r.system_prompt):""}`}var fd=["open","in_progress","deferred","resolved","closed"],_d=[0,1,2,3,4];function Ia(e,t){let r=t.issueStores,n=t.onClose,s=t.transport,o=t.onNavigate,a=t.queueStore,c=t.sessionLogStore,i=null,d=null,_={},m=!1,h=!1,w="",$="",g="";function E(){m=!1,h=!1,w="",$="",g=""}let j=[],Y=null,Z=null,M=!1,A="",x=!1,P=0,H=new Set;function ce(){j=[],Y=null,Z=null,M=!1,A="",x=!1,P+=1,H.clear()}async function J(y){if(!s)return;let U=++P;try{let B=await Promise.resolve(s("get-comments",{id:y}));if(U!==P||y!==i)return;j=Array.isArray(B)?B:[],M=!1}catch{if(U!==P||y!==i)return;M=!0}we()}function ae(){if(!s||!i)return;let y=d&&typeof d.comment_count=="number"?d.comment_count:null;if(Y!==i){Y=i,Z=y,J(i);return}y!==null&&y!==Z&&(Z=y,J(i))}function fe(y){H.has(y)?H.delete(y):H.add(y),we()}function Le(y){let U=A.trim().length===0;A=y,U!==(y.trim().length===0)&&we()}async function Ye(){let y=A.trim();if(!s||!i||y.length===0||x)return;let U=i;x=!0,we();let B=!1;try{let f=await Promise.resolve(s("add-comment",{id:U,text:y}));Array.isArray(f)&&f.length>0&&(B=!0,U===i&&(j=f,M=!1,A="",Z=f.length))}catch{B=!1}B||ne("\uB313\uAE00 \uCD94\uAC00 \uC2E4\uD328","error"),U===i&&(x=!1),we()}let Se={onToggle:fe,onDraftInput:Le,onSubmit:Ye},T=document.createElement("div");T.className="md-viewer-root",document.body.appendChild(T);let K=Ta(T,{getWorkspacePath:t.getWorkspacePath||(()=>"")}),O=document.createElement("div");O.className="session-log-root",document.body.appendChild(O);let W=wn(O,{transport:s?(y,U)=>Promise.resolve(s(y,U)):void 0,sessionLogStore:c}),de=!1,le=!1,ye=!1,_e=null,Ue=null,ue=0;function Oe(y){return`${t.getWorkspacePath&&t.getWorkspacePath()||""}::${y}`}function F(){de=!1,le=!1,ye=!1,_e=null,Ue=null,ue+=1}async function N(y){if(!s)return;let U=++ue;le=!0,ye=!1,we();try{let B=await Promise.resolve(s("get-bead-prompt",{bead_id:y}));if(U!==ue)return;!B||typeof B!="object"||Array.isArray(B)?ye=!0:(_e=B,Ue=Oe(y))}catch{U===ue&&(ye=!0)}finally{U===ue&&(le=!1,we())}}function pe(){if(de=!de,de&&i&&Ue!==Oe(i)){_e=null,N(i);return}we()}function qe(){if(!a||!i)return[];let y=a.get();return(y&&y.attempts?Object.values(y.attempts):[]).filter(B=>B&&B.bead_id===i).sort((B,f)=>(f.started_at||0)-(B.started_at||0)).map(B=>({attempt_id:B.attempt_id,bead_id:B.bead_id,status:B.status,started_at:typeof B.started_at=="number"?B.started_at:null,runner:B.runner||null,model:B.model||null,session_id:B.session_id||null,resumed_from:B.resumed_from||null,dismissed_at:typeof B.dismissed_at=="number"?B.dismissed_at:null,cause:typeof B.cause=="string"?B.cause:null,cause_detail:B.cause_detail||null,usage:B.usage||null}))}function D(){if(!a||!i)return null;let y=a.get();return Dt(y&&y.attempts||{},i)}let G=new Set;function R(y){G.has(y)?G.delete(y):G.add(y),we()}function te(y){let U=a?a.get():null,B=U&&U.attempts?U.attempts[y]:null;W.open({attempt_id:y,meta:B?{runner:B.runner||void 0,model:B.model||void 0,effort:B.effort||void 0,status:B.status||void 0,session_id:B.session_id||void 0}:{}})}async function ee(y){if(!s||!y)return;let U=()=>{let f=a?a.get():null;return f&&typeof f.revision=="number"?f.revision:0},B=await s("worker-attempt-resume",{attempt_id:y,expected_revision:U()});if(B&&B.conflict){let f=B.queue&&typeof B.queue.revision=="number"?B.queue.revision:U();B=await s("worker-attempt-resume",{attempt_id:y,expected_revision:f})}B&&B.resumed===!1&&!B.conflict&&B.reason&&ne(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${B.reason}`,"error",2400)}let ge={onOpen:te,onResume:ee,onToggleUsage:R};function he(){let y=a?a.get():null,U=y&&y.exec_defaults;return U&&typeof U=="object"?U:{}}let $e=null;r&&r.subscribe&&($e=r.subscribe(()=>We()));let Re=null;a&&typeof a.subscribe=="function"&&(Re=a.subscribe(()=>{i&&we()}));function rt(y){y.key==="Escape"&&i&&(y.preventDefault(),n())}document.addEventListener("keydown",rt);function We(){if(i){if(r&&typeof r.snapshotFor=="function"){let y=r.snapshotFor("detail:"+i)||[];d=y.find(B=>B&&B.id===i)||y[0]||d}ae(),we()}}function Xe(y){tr(y).then(U=>{U?ne("\uBCF5\uC0AC\uB428","success",1200):ne("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function dt(y){y.preventDefault(),y.stopPropagation(),i&&Xe(i)}function ut(y,U){y.preventDefault(),y.stopPropagation(),Xe(U)}function Ae(y,U){y.preventDefault(),y.stopPropagation(),K.open(U)}function it(y,U){_[y]=U,we(),!(!s||!i)&&Promise.resolve(s("update-exec-settings",{id:i,key:y,value:U})).catch(()=>{ne("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function ze(y,U,B){if(!s||!i)return!1;try{let f=await Promise.resolve(s(y,U)),b=Array.isArray(f)?f[0]:f;return b&&typeof b=="object"&&b.id?(d=b,!0):(ne(B,"error"),!1)}catch{return ne(B,"error"),!1}}function at(y){setTimeout(()=>{try{let U=e.querySelector(y);U&&typeof U.focus=="function"&&U.focus()}catch{}},0)}function pt(){m=!0,w=d&&d.title||"",we(),at('.detail-edit__input[data-edit="title"]')}function bt(y){w=y.target.value}function Be(){m=!1,w="",we()}function lt(){ze("edit-text",{id:i,field:"title",value:w},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(U=>{U&&(m=!1,w=""),we()})}function Ve(){h=!0,$=d&&d.description||"",we(),at('.detail-edit__textarea[data-edit="description"]')}function et(y){$=y.target.value}function I(){h=!1,$="",we()}function q(){ze("edit-text",{id:i,field:"description",value:$},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(U=>{U&&(h=!1,$=""),we()})}function re(y,U,B,f){if(y.key==="Escape"){y.stopPropagation(),B();return}y.key==="Enter"&&(!f||y.ctrlKey||y.metaKey)&&(y.preventDefault(),U())}function se(y){let U=y.target.value;ze("update-status",{id:i,status:U},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>we())}function ie(y){let U=Number(y.target.value);ze("update-priority",{id:i,priority:U},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>we())}function ve(y){g=y.target.value}function u(){let y=g.trim();y.length!==0&&ze("label-add",{id:i,label:y},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(U=>{U&&(g=""),we()})}function v(y){if(y.key==="Escape"){y.stopPropagation(),g="",we();return}y.key==="Enter"&&(y.preventDefault(),u())}function L(y){ze("label-remove",{id:i,label:y},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>we())}let Q={onCopyPath:ut,onOpenDoc:Ae},X={onChange:it};function me(y){return typeof y=="string"?y:y&&typeof y=="object"?String(y.id||y.to||y.issue_id||y.depends_on||""):""}function Ee(y){switch(y&&typeof y=="object"?String(y.dependency_type||y.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Ne(y){let B=(Array.isArray(y.dependencies)?y.dependencies:[]).map(f=>({id:me(f),icon:Ee(f)})).filter(f=>f.id.length>0);return l`
    ...
    `}function Ke(y){let U=y.metadata||{},B=y.workflow||{},f=B.stages||{},b=f.spec&&f.spec.stale,C=f.impl&&f.impl.stale,p=B.route_source==="derived",S=B.route||U.route||"\u2014";return l`
      <div class="detail-section-label">워크플로우</div>
      <div class="detail-kv">
        <span class="detail-kv__k">route</span>
        <span
          class="detail-kv__v${p?" detail-kv__v--derived":""}"
          title=${p?"route \uCD94\uB860\uAC12 (metadata \uBBF8\uD540)":"route"}
          >${p&&B.route?`${S} ? (\uCD94\uB860)`:S}</span
        >
      </div>
      <div class="detail-kv">
        <span class="detail-kv__k">spec_review</span>
        <span class="detail-kv__v"
          >${U.spec_review||"\uC5C6\uC74C"}${b?" \xB7 stale":""}</span
        >
      </div>
      <div class="detail-kv">
        <span class="detail-kv__k">impl_review</span>
        <span class="detail-kv__v"
          >${U.impl_review||"\uC5C6\uC74C"}${C?" \xB7 stale":""}</span
        >
      </div>
    ...
    `}let nt={route:["spec_backed","full_plan"]};async function ke(y,U){let B=U.target.value;if(y==="route"&&d&&d.metadata&&d.metadata.route==="full_plan"&&B!=="full_plan"&&!window.confirm(`full_plan \u2192 ${B||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){we();return}await ze("update-workflow-meta",{id:i,key:y,value:B},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),we()}function st(y){let U=y.metadata||{};return l` ${((f,b)=>{let C=nt[f],p=typeof U[f]=="string"?U[f]:"";return l`<div class="detail-kv">
    ...
    `}function Ge(y){let U=ct(y.created_at),B=ct(y.updated_at);return!U&&!B?l``:l`
    ...
    `}function Ce(y){let U=typeof y.notes=="string"?y.notes:"";return U.trim().length===0?l``:l`
      <div class="detail-overlay__section-label">노트</div>
      <div class="detail-overlay__notes">${U}</div>
    `}function xt(y){let U=Array.isArray(y.labels)?y.labels:[];return l`
    ...
    `}function Mt(){if(!i)return l``;let y=d||{},U=String(y.id||i),B=y.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",f=y.status||"open",b=typeof y.priority=="number"?Math.max(0,Math.min(4,y.priority)):"",C=y.description||"",p={...y,metadata:{...y.metadata||{},..._}};return l`
      <div class="detail-overlay" role="dialog" aria-modal="true">
        ...
        <div class="detail-overlay__panel">
          ...
          ${$t(B)} ${ot(f,b)}
          ${Ge(y)} ${be(C)}
          ${Sa(j,Se,{expanded:H,draft:A,sending:x,error:M})}
          ${Ce(y)} ${xt(y)} ${Ne(y)}
          ${Ke(y)} ${st(y)}
          ${ka(y,Q)}
          ${Aa(p,X,he())}
          ${Ra({expanded:de,loading:le,error:ye,data:_e},{onToggle:pe})}
          ${Ca(qe(),ge,{total:D(),expanded:G})}
        </div>
      </div>
    `}function we(){De(Mt(),e)}return{load(y){y!==i&&(_={},E(),ce(),F()),i=y,d=null,We()},clear(){i=null,d=null,_={},E(),ce(),F(),K.close(),W.close(),De(l``,e)},destroy(){$e&&($e(),$e=null),Re&&(Re(),Re=null),document.removeEventListener("keydown",rt),K.destroy(),T.parentNode&&T.parentNode.removeChild(T),W.destroy(),O.parentNode&&O.parentNode.removeChild(O),i=null,d=null,ce(),F(),De(l``,e)}}}var md=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function La(e,t){return Wn(e,t)?"shown":t.hidden_labels.includes(e)?"hidden_exact":"hidden_prefix"}function gd(e,t,r){if(!r)return{hidden_labels:t.hidden_labels.includes(e)?t.hidden_labels:[...t.hidden_labels,e],visible_labels:t.visible_labels.filter(o=>o!==e)};let n=t.hidden_labels.filter(o=>o!==e);return t.hidden_prefixes.some(o=>o.length>0&&e.startsWith(o))?{hidden_labels:n,visible_labels:t.visible_labels.includes(e)?t.visible_labels:[...t.visible_labels,e]}:{hidden_labels:n}}function Da(e,t){let{policyStore:r,transport:n,labelOptions:s}=t,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),e.appendChild(o);let a="";async function c(x){let P=r.get();if(P)try{let H=await n("display-policy-set",{expected_revision:P.revision,policy:x(P)});i(H),H&&H.conflict&&H.policy&&(H=await n("display-policy-set",{expected_revision:H.policy.revision,policy:x(H.policy)}),i(H)),H&&H.conflict&&ne("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{ne("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function i(x){x&&x.policy&&typeof x.policy=="object"&&r.set(x.policy)}function d(x){let P=r.get();if(!P)return;let H=La(x,P)!=="shown";c(ce=>gd(x,ce,H))}function _(){let x=a.trim();x.length!==0&&(a="",c(P=>P.hidden_prefixes.includes(x)?{hidden_prefixes:P.hidden_prefixes}:{hidden_prefixes:[...P.hidden_prefixes,x]}),E())}function m(x){c(P=>({hidden_prefixes:P.hidden_prefixes.filter(H=>H!==x)}))}function h(x){let P=r.get();if(!P)return;let H=P.chips[x]===!1;c(()=>({chips:{[x]:H}}))}function w(x){let P=s();return l`
      <section class="display-settings__section">
        ...
        ${P.length===0?l`<div class="display-settings__empty">라벨 없음</div>`:l`<div class="display-settings__pills">
              ${P.map(H=>{let ce=La(H,x);return l`<button
                  type="button"
    ...
    <div class="fatal-error">
      ...
      >${K}</span
    >`}function $(T){let K=T?Na(T.cmd):"",O=T?Ma(T.timeout_ms):"",W=s&&s()||"<workspace \uACBD\uB85C>";return l`<div class="exec-defaults__vd-group" data-vd="verify">
    ...
    </div>`}function g(T){let K=T?Na(T.cmd):"",O=T?Ma(T.timeout_ms):"",W=O?`timeout ${O} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",de=s&&s()||"<workspace \uACBD\uB85C>";return l`<div class="exec-defaults__vd-group" data-vd="deploy">
    ...
    </div>`}function E(T){if(!T||typeof T!="object")return"";let K=hd[String(T.outcome)];if(!K)return"";let O=T.outcome==="failed"&&T.reason?`${K.label} \xB7 ${T.reason}`:K.label,W=[ct(T.at),typeof T.bead_id=="string"?T.bead_id:"",typeof T.base_sha=="string"?T.base_sha.slice(0,7):""].filter(ye=>ye.length>0).join(" \xB7 "),de=typeof T.detail=="string"&&T.detail.length>0?bd(T.detail):"",le=typeof T.log_path=="string"&&T.log_path.length>0?T.log_path:"";return l`<div class="exec-defaults__vd-group" data-vd="last-deploy">
      ...
      ${E(T.last_deploy)}
        ...
        <div class="exec-defaults__container">
          ...
          <div class="exec-defaults__body">
            ...
            ${vd.map(K=>m(K.key,K.values(),T[K.key]||""))}
            ${ce(h())}
            ${P()}
          </div>
        </div>
  ...
  >
    ...
    ${xd(e.shipFailure)}
  </div>`}function Sd(e,t,r=null){let n=!!e.paused,s=n?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?ks(t-e.started_at):"\u2014",o=[e.runner,e.model].filter(Boolean).join(" \xB7 "),a=At(e.usage),c=e.conflict_resolution?n?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,i=e.base_exception||null,d=e.attempt_id&&e.attempt_id===r;return l`<div
  ...
  >
    ...
    <path d="M8.8 3.6 14 8l-5.2 4.4z" />`)}var zr=1,Ad=6e4,Td={auto_merge:"\uC790\uB3D9 \uBA38\uC9C0",merged:"\uBA38\uC9C0",merge:"\uBA38\uC9C0",pr_stop:"PR \uC911\uB2E8",stopped:"\uC911\uB2E8",failed:"\uC2E4\uD328"},Ed=new Set(["auto_merge","merged","merge","done"]),Ga={running:3,paused:2,failed:1};function Cd(e,t){let r=null,n=-1/0;for(let s of Object.values(e)){if(!s||s.bead_id!==t||s.status==="running")continue;let o=typeof s.finished_at=="number"?s.finished_at:typeof s.started_at=="number"?s.started_at:0;o>=n&&(n=o,r=s)}return r}function Rd(e,t){let r=Object.values(e||{}),n=new Set,s=new Map;for(let a of r)!a||typeof a.bead_id!="string"||(typeof a.resumed_from=="string"&&a.resumed_from.length>0&&n.add(a.resumed_from),s.set(a.bead_id,a.attempt_id));let o=new Map;for(let a of r){if(!a||typeof a.bead_id!="string"||a.bead_id.length===0)continue;let c=null;if(a.status==="running")c="running";else if(a.status==="paused"&&!n.has(a.attempt_id))c="paused";else if(a.status==="failed"||a.status==="orphaned"){let m=t.get(a.bead_id),h=typeof m=="number"&&m>0&&typeof a.finished_at=="number"&&m>=a.finished_at;s.get(a.bead_id)===a.attempt_id&&!h&&typeof a.dismissed_at!="number"&&(c="failed")}if(!c)continue;let i=typeof a.started_at=="number"?a.started_at:null,d=o.get(a.bead_id);if(d){let m=Ga[d.run_state],h=Ga[c];if(m>h||m===h&&(d.started_at??0)>(i??0))continue}let _=typeof a.session_id=="string"&&a.session_id.length>0;o.set(a.bead_id,{attempt_id:typeof a.attempt_id=="string"?a.attempt_id:"",run_state:c,started_at:i,last_event_at:typeof a.last_event_at=="number"?a.last_event_at:null,model:typeof a.model=="string"?a.model:null,usage:Dt(e,a.bead_id),can_pause:c==="running"&&_,can_resume:c!=="running"&&_&&!n.has(a.attempt_id)})}return o}function ja(e,t){let r=e[t];if(!r)return"";if(r.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let n=typeof r.reason=="string"?r.reason:"",s=n.indexOf(":");return s>0&&s<n.length-1?`\u26D4 ${n.slice(0,s)} (${n.slice(s+1)})`:`\u26D4 ${n}`}function Rt(e){return e&&typeof e=="object"?e:{}}function As(e,t,r){let n=Array.isArray(e)?e:[],s=Array.isArray(t)?t:[],o=r&&typeof r.done_since=="number"?r.done_since:void 0,a=new Map;for(let g of s)g&&typeof g.root_dir=="string"&&a.set(g.root_dir,g);let c=[],i=[],d=[],_=[],m=[],h=new Map;for(let g of n){if(!g||typeof g.root_dir!="string")continue;let E=g.root_dir,j=g.name||E,Y=a.get(E),Z=Y&&typeof Y.revision=="number"?Y.revision:typeof g.revision=="number"?g.revision:0,M=Rt(g.attempts),A=Rt(g.bead_titles),x=Rt(g.pr_observations),P=Rt(g.admission),H=Rt(g.revise_parked),ce=Rt(g.merge_queue_state),J=Rt(g.cleanup_failed),ae=Array.isArray(g.merge_queue)?g.merge_queue:[],fe=new Set(ae.filter(O=>O&&typeof O.bead_id=="string").map(O=>O.bead_id)),Le=Array.isArray(g.queue)?g.queue:[],Ye=Array.isArray(g.done)?g.done:[],Se=new Map;for(let O of Ye)O&&typeof O.bead_id=="string"&&typeof O.added_at=="number"&&Se.set(O.bead_id,O.added_at);let T=O=>({id:O,title:A[O]||O,root_dir:E,workspace_name:j,expected_revision:Z,draggable:!1}),K=new Set;for(let[O,W]of Rd(M,Se))K.add(O),i.push({...T(O),lane:"running",attempt_id:W.attempt_id,run_state:W.run_state,can_pause:W.can_pause,can_resume:W.can_resume,started_at:W.started_at,last_event_at:W.last_event_at,model:W.model,usage:W.usage,badges:W.run_state==="paused"?["\u23F8 \uC77C\uC2DC\uC815\uC9C0"]:W.run_state==="failed"?["\u26A0 \uC2E4\uD328"]:[],alert:W.run_state==="failed"});for(let O of Array.isArray(g.pr_wait)?g.pr_wait:[]){let W=O&&O.bead_id;if(typeof W!="string"||K.has(W))continue;K.add(W);let de=Rt(x[W]),le=Rt(de.pr),ye=de.gate?Rt(de.gate):null,_e=fe.has(W),Ue=ce.active===W,ue=O.external===!0,Oe=J[W]||null,F=!!ye&&ye.base_badge==="\uCDA9\uB3CC",N=!!Oe&&!!ye&&ye.tier==="merged",pe=ue&&!!ye&&ye.tier==="merged";d.push({...T(W),lane:"pr_wait",pr_number:typeof le.number=="number"?le.number:null,pr_url:typeof le.url=="string"?le.url:void 0,external:ue,usage:Dt(M,W),badges:Oe?["\uC815\uB9AC \uC2E4\uD328"]:[],alert:!!Oe,reason:Oe?"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644":"PR \uB300\uAE30",merge_action:!_e,merge_enabled:ye?.enabled===!0||F||N||pe,merge_label:pe?"\uC815\uB9AC":F&&!N?"\uCDA9\uB3CC \uD574\uC18C \uD6C4 \uBA38\uC9C0":void 0,merge_title:pe?"\uBA38\uC9C0\uB428 \u2014 \uD074\uB9AD\uD558\uBA74 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC\uB97C \uC218\uD589\uD569\uB2C8\uB2E4":N?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uC218\uD589\uD569\uB2C8\uB2E4":F?"\uCDA9\uB3CC \u2014 \uD050\uC5D0 \uB123\uC73C\uBA74 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6B0\uACE0 \uC644\uB8CC \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC7AC\uBA38\uC9C0\uD569\uB2C8\uB2E4":ye?.enabled===!0?`\uBA38\uC9C0 (${ye.gate_badge}) \u2014 \uD050\uC5D0 \uB123\uC5B4 \uC21C\uC11C\uB300\uB85C \uBA38\uC9C0\uD569\uB2C8\uB2E4`:`\uBA38\uC9C0 \uBD88\uAC00: ${ye?.reason||"\uAD00\uCE21 \uB300\uAE30"}`,cancel_action:_e,cancel_enabled:!Ue,discard_action:!ue&&!Oe&&!(ye&&ye.tier==="merged"),discard_enabled:!Ue&&!_e,discard_title:_e?"\uBA38\uC9C0 \uD050\uC5D0 \uC788\uC74C \u2014 \uD3D0\uAE30\uD558\uB824\uBA74 \uBA3C\uC800 [\uCDE8\uC18C]\uD558\uC138\uC694":void 0})}for(let O=0;O<Le.length;O++){let W=Le[O],de=W&&W.bead_id;if(typeof de!="string"||K.has(de))continue;K.add(de);let le=H[de],ye={...T(de),lane:"queue",reason:ja(P,de),queue_position:O+1,queue_index:O,queue_length:Le.length,badges:le?["\u23F8 REVISE \uD30C\uD0B9"]:[],alert:!!le,revise_action:!!le,revise_enabled:!!le,revise_title:le?le.notes_tail?`REVISE findings (\uC790\uC138\uD788\uB294 \uCE74\uB4DC \uD074\uB9AD \u2192 \uC774\uC288 \uC0C1\uC138):
${le.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};_.push(ye);let _e=h.get(E);_e?_e.push(ye):h.set(E,[ye])}for(let O of Array.isArray(g.runnable)?g.runnable:[]){let W=O&&O.bead_id;typeof W!="string"||K.has(W)||(K.add(W),c.push({...T(W),title:O.title||A[W]||W,lane:"runnable",draggable:!0,reason:ja(P,W),created_at:O.created_at??void 0,updated_at:O.updated_at??void 0,labels:Array.isArray(O.labels)?O.labels:[],workflow:O.route?{route:O.route,chips:{route:O.route}}:null,place_index:Le.length}))}for(let O of Ye){let W=O&&O.bead_id;if(typeof W!="string"||K.has(W)||(K.add(W),o!==void 0&&typeof O.added_at=="number"&&O.added_at<o))continue;let de=Cd(M,W);m.push({...T(W),lane:"done",done:!0,usage:Dt(M,W),done_at:typeof O.added_at=="number"?O.added_at:void 0,done_kind:de&&typeof de.done_kind=="string"?de.done_kind:null})}}i.sort((g,E)=>(E.last_event_at??0)-(g.last_event_at??0)),m.sort((g,E)=>(E.done_at??0)-(g.done_at??0));let w=s.length>0?s:n.map(g=>({root_dir:g&&g.root_dir,name:g&&g.name,auto_advance:g&&g.auto_advance,auto_merge:g&&g.auto_merge,slots:g&&g.slots,revision:g&&g.revision,exec_defaults:g&&g.exec_defaults})),$=[];for(let g of w)!g||typeof g.root_dir!="string"||$.push({root_dir:g.root_dir,name:g.name||g.root_dir,auto_advance:g.auto_advance===!0,auto_merge:g.auto_merge===!0,slots:typeof g.slots=="number"&&g.slots>=zr?g.slots:zr,revision:typeof g.revision=="number"?g.revision:0,exec_defaults:Rt(g.exec_defaults),items:h.get(g.root_dir)||[]});return{runnable:c,queue:_,queue_groups:$,running:i,pr_wait:d,done:m,automation:{total:$.length,both_on:$.filter(g=>g.auto_advance&&g.auto_merge).length}}}function Id(e,t){if(typeof e!="number"||!Number.isFinite(e))return"";let n=t-e<Ad;return l`<span
  ...
  >`}function Sn(e){return e.workspace_name?l`<span class="mon-c__repo" title=${e.root_dir||""}
    ...
    <div class="mon-c__meta">
      ...
      ${Ts(e)}${Ld(e)}
    </div>`}function Od(e){let t=e.workflow,n=(t&&t.chips||{}).route||t&&t.route,s=typeof e.reason=="string"&&e.reason.startsWith("\u26D4"),o=yt(e.updated_at);return l`${Hr(e)}
    <div class="mon-c__meta">
    ...
    ${e.revise_action?l`<div class="mon-c__tail">
        ...
        </div>`:""}`}function Nd(e){let t=!!(At(e.usage)||e.merge_action||e.cancel_action||e.discard_action);return l`${Hr(e)}
    <div class="mon-c__meta">
      ${Wr(e)}${Sn(e)}
    ...
    ${t?l`<div class="mon-c__tail">
        ...
        </div>`:""}`}function Pd(e,t){let r=e.done_kind||"",n=r?Td[r]||r:"",s=yt(e.done_at,t);return l`${Hr(e)}
    <div class="mon-c__meta">
      ${Wr(e)}${Sn(e)}
      ${n?l`<span
  ...
  </header>`}function Ka(e){let{total:t,both_on:r}=e.automation,n=t>0&&r===t,s=Lt.find(o=>o.value===e.done_range)?.label||"";return l`<div class="mon-top">
    <button
      type="button"
  ...
  </div>`}function Za(e){return`${e} \uC644\uB8CC\uB41C \uC774\uC288\uB4E4\uC774 \uC0DD\uC560 \uC804\uCCB4\uC5D0 \uC4F4 \uD1A0\uD070 \uB204\uC801 (\uC785\uB825+\uCD9C\uB825+\uCE90\uC2DC). \uC774 \uAE30\uAC04\uC5D0 \uC18C\uBAA8\uB41C \uC591\uC774 \uC544\uB2C8\uB2E4`}function Xa(e){let t={};for(let a of qt)t[a]=0;let r=!1,n=0,s=0,o=0;for(let a of Array.isArray(e)?e:[]){let c=a&&a.usage;if(c&&typeof c=="object"){let i=!1;for(let d of qt){let _=c[d];typeof _=="number"&&Number.isFinite(_)&&(t[d]+=_,r=!0,i=!0)}if(i){s+=1;let d=c.total_cost_usd;typeof d=="number"&&Number.isFinite(d)&&(n+=d,o+=1)}}}return s>0&&o===s&&(t.total_cost_usd=n),r?At(t):null}var Ja="bdui.monitor.done-range";function Fd(){try{let e=window.localStorage.getItem(Ja);return Ft(e)?e:kt}catch{return kt}}function qd(e){try{window.localStorage.setItem(Ja,e)}catch{}}var ei="tab:monitor:pipeline",Bd=1e3,Ud=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}];function Qa(e,t){let r=e.lane==="runnable"||e.lane==="queue";return l`<div
...
${Pe.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:V==="done"?Dt(u.attempts||{},oe.bead_id):null,done_at:V==="done"&&typeof oe.added_at=="number"?oe.added_at:void 0,...ke(oe.bead_id)}}),je=new Map;for(let k of u.done)k&&typeof k.bead_id=="string"&&typeof k.added_at=="number"&&je.set(k.bead_id,k.added_at);let Qe=u.attempts?Object.values(u.attempts):[],vt=new Set;for(let k of Qe)k&&typeof k.resumed_from=="string"&&k.resumed_from.length>0&&vt.add(k.resumed_from);let Nt=new Map;for(let k of Qe)Nt.set(k.bead_id,k.attempt_id);let or=new Map;for(let k of Qe)or.set(k.attempt_id,k);function Je(k){let V=new Set,oe=k;for(;oe&&!V.has(oe.attempt_id);){if(oe.conflict_resolution===!0)return!0;V.add(oe.attempt_id),oe=typeof oe.resumed_from=="string"&&oe.resumed_from.length>0&&or.get(oe.resumed_from)||null}return!1}let ar=typeof u.declared_base=="string"?u.declared_base:null;function jr(k){let V=null;for(let oe of Qe)!oe||oe.bead_id!==k||Je(oe)||(V===null||(typeof oe.started_at=="number"?oe.started_at:0)>=(typeof V.started_at=="number"?V.started_at:0))&&(V=oe);return V&&typeof V.target_base=="string"?V.target_base:null}let yr=[],It=null;for(let k of Qe){let V=k.status==="paused"&&!vt.has(k.attempt_id);if(k.status==="running"||V)yr.push({bead_id:k.bead_id,attempt_id:k.attempt_id,title:Ne.get(k.bead_id)||k.bead_id,runner:k.runner||null,model:k.model||null,effort:k.effort||null,started_at:typeof k.started_at=="number"?k.started_at:null,resumed_from:k.resumed_from||null,paused:V,conflict_resolution:Je(k),base_exception:ci(ar,k.target_base),can_pause:typeof k.session_id=="string"&&k.session_id.length>0,usage:Dt(u.attempts||{},k.bead_id),current_child:me(k.bead_id),...ke(k.bead_id)});else if(k.status==="failed"||k.status==="orphaned"){let oe=Nt.get(k.bead_id)!==k.attempt_id,Pe=je.get(k.bead_id),Kr=typeof Pe=="number"&&Pe>0&&typeof k.finished_at=="number"&&Pe>=k.finished_at;!oe&&!Kr&&typeof k.dismissed_at!="number"&&(It=k)}}let Ns=null;if(It){let k=typeof It.session_id=="string"&&It.session_id.length>0,V=vt.has(It.attempt_id),oe=It.cause_detail;Ns={repo:It.repo||"",reason:It.cause||It.status,cause_detail:oe&&typeof oe.reason=="string"?{reason:oe.reason,command:typeof oe.command=="string"?oe.command:null}:null,resume_attempt_id:It.attempt_id,resume_eligible:k&&!V,resume_reason:k?V?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let xi=new Set(yr.map(k=>k.bead_id)),En=Array.isArray(u.merge_queue)?u.merge_queue:[],Ps=new Map;En.forEach((k,V)=>{k&&typeof k.bead_id=="string"&&Ps.set(k.bead_id,V+1)});let Fs=u.merge_queue_state||{active:null,failures:{}},Si=Fs.failures||{},Ai=u.auto_merge_skips||{},qs=k=>{let V=Ai[k];if(!V)return null;let oe=$t[k],Pe=oe&&oe.pr?oe.pr.head_sha:null;return Pe&&Pe===V.head_sha?V.reason||"":null},Yr=new Map;for(let k of yr)k.conflict_resolution&&(k.paused?Yr.has(k.bead_id)||Yr.set(k.bead_id,"paused"):Yr.set(k.bead_id,"running"));let Bs=yr.filter(k=>!k.paused).length,Us=(u.workspace_info||{}).slots,zs=typeof Us=="number"?Us:typeof u.slots=="number"?u.slots:An,Ti=Bs>zs,Hs=cr(g),Ei=(Array.isArray(u.done)?u.done.slice():[]).filter(k=>Hs===void 0||typeof k.added_at!="number"||k.added_at>=Hs).sort((k,V)=>(V.added_at||0)-(k.added_at||0)),Ws=tt(Ei,"done"),Vr={};for(let k of qt)Vr[k]=0;let Gs=!1,js=0,Cn=0,Ys=0;for(let k of Ws){let V=k.usage;if(V&&typeof V=="object"){let oe=!1;for(let Pe of qt)Number.isFinite(V[Pe])&&(Vr[Pe]+=V[Pe],Gs=!0,oe=!0);oe&&(Cn+=1,Number.isFinite(V.total_cost_usd)&&(js+=V.total_cost_usd,Ys+=1))}}Cn>0&&Ys===Cn&&(Vr.total_cost_usd=js);let Ci=Gs?At(Vr):null;return{queue:u,idToTitle:Ne,candidates:z,candidate_hidden:{blocked:S.hidden_blocked,spec:S.hidden_spec},running:yr,live_count:Bs,slots:zs,over_cap:Ti,failure:Ns,waiting:tt(Mt.filter(k=>!xi.has(k.bead_id)),"queue"),pr_wait:st.map(k=>uu(k.bead_id,Ne.get(k.bead_id)||k.bead_id,$t,ot[k.bead_id]||null,Dt(u.attempts||{},k.bead_id),Ge[k.bead_id]||(Z.has(k.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Yr.get(k.bead_id)||null,k.external===!0,{position:Ps.get(k.bead_id)||0,active:Fs.active===k.bead_id,failure:Si[k.bead_id]||null},k.wt_present!==!1,u.auto_merge===!0?qs(k.bead_id):null,ci(ar,jr(k.bead_id)))).map(k=>({...k,...ke(k.id)})),merge_queue_length:En.length,merge_queue_running:En.length>0,auto_excluded:st.map(k=>k.bead_id).filter(k=>qs(k)!==null),verify_cmd_present:!!(u.workspace_info||{}).verify_cmd,declared_base:ar,done:Ws,token_total:Ci,cleanup_failures:be,ship_failure:xt}}function he(u){let v=u.waiting.length>0?u.waiting[0].id:"\u2014",L=l`<button
    ...
    >`,Ke=l`<label class="worker-tgl worker-slots"
      ...
      >
        ⚙
      </button>`,nt=qa({failure:u.failure,cleanupFailures:u.cleanup_failures,shipFailure:u.ship_failure});return Y?l`<div class="worker-ribbon">
          ${L}
    ...
    >
      ▶ 자동 머지${Q>0?` ${Q}`:""}
        ...
        ${$e(u)}
        ${Ot({id:"worker-pane-queue",lane:"queue",title:"\uB300\uAE30",items:u.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:j.queue,preview:ii(u.waiting)})}
        ${v}
        ${Ot({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:u.done,empty:`${E()} \uC644\uB8CC \uC5C6\uC74C`,controls:We(),collapsible:!0,collapsed:j.done,preview:u.token_total||ii(u.done)})}
