...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Vn=/'/g,Kn=/"/g,Jn=/^(?:script|style|textarea|title)$/i,Yr=t=>(e,...r)=>({_$litType$:t,strings:e,values:r}),d=Yr(1),zl=Yr(2),Hl=Yr(3),xt=Symbol.for("lit-noChange"),ke=Symbol.for("lit-nothing"),Zn=new WeakMap,vt=$t.createTreeWalker($t,129);function es(t,e){if(!jr(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Gn!==void 0?Gn.createHTML(e):e}var oi=(t,e)=>{let r=t.length-1,n=[],s,o=e===2?"<svg>":e===3?"<math>":"",i=Wt;for(let l=0;l<r;l++){let a=t[l],c,p,m=-1,b=0;for(;b<a.length&&(i.lastIndex=b,p=i.exec(a),p!==null);)b=i.lastIndex,i===Wt?p[1]==="!--"?i=jn:p[1]!==void 0?i=Yn:p[2]!==void 0?(Jn.test(p[2])&&(s=RegExp("</"+p[2],"g")),i=kt):p[3]!==void 0&&(i=kt):i===kt?p[0]===">"?(i=s??Wt,m=-1):p[1]===void 0?m=-2:(m=i.lastIndex-p[2].length,c=p[1],i=p[3]===void 0?kt:p[3]==='"'?Kn:Vn):i===Kn||i===Vn?i=kt:i===jn||i===Yn?i=Wt:(i=kt,s=void 0);let v=i===kt&&t[l+1].startsWith("/>")?" ":"";o+=i===Wt?a+ni:m>=0?(n.push(c),a.slice(0,m)+Xn+a.slice(m)+mt+v):a+mt+(m===-2?l:v)}return[es(t,o+(t[r]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},Vt=class t{constructor({strings:e,_$litType$:r},n){let s;this.parts=[];let o=0,i=0,l=e.length-1,a=this.parts,[c,p]=oi(e,r);if(this.el=t.createElement(c,n),vt.currentNode=this.el.content,r===2||r===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=vt.nextNode())!==null&&a.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith(Xn)){let b=p[i++],v=s.getAttribute(m).split(mt),k=/([.?@])?(.*)/.exec(b);a.push({type:1,index:o,name:k[2],strings:v,ctor:k[1]==="."?zr:k[1]==="?"?Hr:k[1]==="@"?Wr:Ot}),s.removeAttribute(m)}else m.startsWith(mt)&&(a.push({type:6,index:o}),s.removeAttribute(m));if(Jn.test(s.tagName)){let m=s.textContent.split(mt),b=m.length-1;if(b>0){s.textContent=dr?dr.emptyScript:"";for(let v=0;v<b;v++)s.append(m[v],jt()),vt.nextNode(),a.push({type:2,index:++o});s.append(m[b],jt())}}}else if(s.nodeType===8)if(s.data===Qn)a.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(mt,m+1))!==-1;)a.push({type:7,index:o}),m+=mt.length-1}o++}}static createElement(e,r){let n=$t.createElement("template");return n.innerHTML=e,n}};function Dt(t,e,r=t,n){if(e===xt)return e;let s=n!==void 0?r._$Co?.[n]:r._$Cl,o=Yt(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(t),s._$AT(t,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=s:r._$Cl=s),s!==void 0&&(e=Dt(t,s._$AS(t,e.values),s,n)),e}var Ur=class{constructor(e,r){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:r},parts:n}=this._$AD,s=(e?.creationScope??$t).importNode(r,!0);vt.currentNode=s;let o=vt.nextNode(),i=0,l=0,a=n[0];for(;a!==void 0;){if(i===a.index){let c;a.type===2?c=new Kt(o,o.nextSibling,this,e):a.type===1?c=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(c=new Gr(o,this,e)),this._$AV.push(c),a=n[++l]}i!==a?.index&&(o=vt.nextNode(),i++)}return vt.currentNode=$t,s}p(e){let r=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,r),r+=n.strings.length-2):n._$AI(e[r])),r++}},Kt=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,r,n,s){this.type=2,this._$AH=ke,this._$AN=void 0,this._$AA=e,this._$AB=r,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,r=this._$AM;return r!==void 0&&e?.nodeType===11&&(e=r.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,r=this){e=Dt(this,e,r),Yt(e)?e===ke||e==null||e===""?(this._$AH!==ke&&this._$AR(),this._$AH=ke):e!==this._$AH&&e!==xt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):si(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==ke&&Yt(this._$AH)?this._$AA.nextSibling.data=e:this.T($t.createTextNode(e)),this._$AH=e}$(e){let{values:r,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=Vt.createElement(es(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(r);else{let o=new Ur(s,this),i=o.u(this.options);o.p(r),this.T(i),this._$AH=o}}_$AC(e){let r=Zn.get(e.strings);return r===void 0&&Zn.set(e.strings,r=new Vt(e)),r}k(e){jr(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,n,s=0;for(let o of e)s===r.length?r.push(n=new t(this.O(jt()),this.O(jt()),this,this.options)):n=r[s],n._$AI(o),s++;s<r.length&&(this._$AR(n&&n._$AB.nextSibling,s),r.length=s)}_$AR(e=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ot=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,r,n,s,o){this.type=1,this._$AH=ke,this._$AN=void 0,this.element=e,this.name=r,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=ke}_$AI(e,r=this,n,s){let o=this.strings,i=!1;if(o===void 0)e=Dt(this,e,r,0),i=!Yt(e)||e!==this._$AH&&e!==xt,i&&(this._$AH=e);else{let l=e,a,c;for(e=o[0],a=0;a<o.length-1;a++)c=Dt(this,l[n+a],r,a),c===xt&&(c=this._$AH[a]),i||(i=!Yt(c)||c!==this._$AH[a]),c===ke?e=ke:e!==ke&&(e+=(c??"")+o[a+1]),this._$AH[a]=c}i&&!s&&this.j(e)}j(e){e===ke?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},zr=class extends Ot{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===ke?void 0:e}},Hr=class extends Ot{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==ke)}},Wr=class extends Ot{constructor(e,r,n,s,o){super(e,r,n,s,o),this.type=5}_$AI(e,r=this){if((e=Dt(this,e,r,0)??ke)===xt)return;let n=this._$AH,s=e===ke&&n!==ke||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,o=e!==ke&&(n===ke||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Gr=class{constructor(e,r,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Dt(this,e)}};var ii=Gt.litHtmlPolyfillSupport;ii?.(Vt,Kt),(Gt.litHtmlVersions??(Gt.litHtmlVersions=[])).push("3.3.1");var ce=(t,e,r)=>{let n=r?.renderBefore??e,s=n._$litPart$;if(s===void 0){let o=r?.renderBefore??null;n._$litPart$=s=new Kt(e.insertBefore(jt(),o),o,void 0,r??{})}return s._$AI(t),s};var ur="today",ts=[{value:"today",label:"\uC624\uB298"},{value:"7d",label:"\uCD5C\uADFC 7\uC77C"},{value:"30d",label:"\uCD5C\uADFC 30\uC77C"},{value:"all",label:"\uC804\uCCB4"}];function Vr(t){return t==="today"||t==="7d"||t==="30d"||t==="all"}function rs(t,e=Date.now()){switch(t){case"today":{let r=new Date(e);return r.setHours(0,0,0,0),r.getTime()}case"7d":return e-7*864e5;case"30d":return e-30*864e5;case"all":default:return}}function ns(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function ss(){let t=new Map,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{set(n,s){t.set(n,{lines:Array.isArray(s)?[...s]:[]}),r()},append(n,s){let o=t.get(n)||{lines:[]};o.lines=[...o.lines,s],t.set(n,o),r()},get(n){return t.get(n)||null},clear(n){typeof n=="string"?t.delete(n):t.clear(),r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}var ds=ri(cs(),1);function we(t){return(0,ds.default)(`beads-ui:${t}`)}function nt(t){if(typeof t=="number")return Number.isFinite(t)?t:0;if(typeof t=="string"){let e=Date.parse(t);return Number.isFinite(e)?e:0}return 0}function Tt(t,e){let r=nt(t.created_at),n=nt(e.created_at);if(r!==n)return r<n?1:-1;let s=t.priority??2,o=e.priority??2;if(s!==o)return s-o;let i=t.id,l=e.id;return i<l?-1:i>l?1:0}function fs(t,e){let r=nt(t.created_at),n=nt(e.created_at);if(r!==n)return r<n?-1:1;let s=t.priority??2,o=e.priority??2;if(s!==o)return s-o;let i=t.id,l=e.id;return i<l?-1:i>l?1:0}function hs(t,e){let r=nt(t.updated_at),n=nt(e.updated_at);if(r!==n)return r<n?1:-1;let s=t.id,o=e.id;return s<o?-1:s>o?1:0}function ms(t,e){let r=t.priority??2,n=e.priority??2;if(r!==n)return r-n;let s=nt(t.created_at),o=nt(e.created_at);if(s!==o)return s<o?1:-1;let i=t.id,l=e.id;return i<l?-1:i>l?1:0}function gs(t,e){let r=t.closed_at??0,n=e.closed_at??0;if(r!==n)return r<n?1:-1;let s=t?.id,o=e?.id;return s<o?-1:s>o?1:0}var yi=/^(?:[A-Za-z][A-Za-z0-9]*(?:-[A-Za-z0-9]+)+\s+)?(?:Task|Phase|T)\s*(\d+)/i;function us(t){let e=t&&t.metadata,r=e?e.task_order:void 0;if(r==null||r==="")return Number.POSITIVE_INFINITY;let n=Number(r);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function ps(t){let e=t&&t.title;if(typeof e!="string")return Number.POSITIVE_INFINITY;let r=yi.exec(e);if(!r)return Number.POSITIVE_INFINITY;let n=Number(r[1]);return Number.isFinite(n)?n:Number.POSITIVE_INFINITY}function _s(t,e){let r=us(t),n=us(e);if(r!==n)return r<n?-1:1;let s=ps(t),o=ps(e);if(s!==o)return s<o?-1:1;let i=nt(t&&t.created_at),l=nt(e&&e.created_at);if(i!==l)return i<l?-1:1;let a=t&&t.id,c=e&&e.id;return a===c?0:String(a)<String(c)?-1:1}var Kr=2**20;function Ft(t,e){let r=t&&t.id;return e&&typeof r=="string"&&Object.prototype.hasOwnProperty.call(e,r)&&typeof e[r]=="number"&&Number.isFinite(e[r])?e[r]:-nt(t&&t.created_at)}function hr(t){return(e,r)=>{let n=Ft(e,t),s=Ft(r,t);if(n!==s)return n<s?-1:1;let o=e?.id,i=r?.id;return o<i?-1:o>i?1:0}}function Zr(t,e,r){let n=Array.isArray(t)?t:[],s=n.length,o=Math.max(0,Math.min(e,s-1)),i=o-1>=0?n[o-1]:null,l=o+1<s?n[o+1]:null;if(!i&&!l)return{rank:0};if(!i)return{rank:Ft(l,r)-Kr};if(!l)return{rank:Ft(i,r)+Kr};let a=Ft(i,r),c=Ft(l,r),p=(a+c)/2;return a<p&&p<c?{rank:p}:{renormalize:n.map((m,b)=>({bead_id:m.id,rank:b*Kr}))}}function Xr(t,e={}){let r=we(`issue-store:${t}`),n=new Map,s=[],o=0,i=new Set,l=!1,a=e.sort||Tt;function c(){for(let b of Array.from(i))try{b()}catch{}}function p(){s=Array.from(n.values()).sort(a)}function m(b){if(l||!b||b.id!==t)return;let v=Number(b.revision)||0;if(r("apply %s rev=%d",b.type,v),!(v<=o&&b.type!=="snapshot")){if(b.type==="snapshot"){if(v<=o)return;n.clear();let k=Array.isArray(b.issues)?b.issues:[];for(let R of k)R&&typeof R.id=="string"&&R.id.length>0&&n.set(R.id,R);p(),o=v,c();return}if(b.type==="upsert"){let k=b.issue;if(k&&typeof k.id=="string"&&k.id.length>0){let R=n.get(k.id);if(!R)n.set(k.id,k);else{let B=Number.isFinite(R.updated_at)?R.updated_at:0,z=Number.isFinite(k.updated_at)?k.updated_at:0;if(B<=z){for(let V of Object.keys(R))V in k||delete R[V];for(let[V,H]of Object.entries(k))R[V]=H}}p()}o=v,c()}else if(b.type==="delete"){let k=String(b.issue_id||"");k&&(n.delete(k),p()),o=v,c()}}}return{id:t,subscribe(b){return i.add(b),()=>{i.delete(b)}},applyPush:m,snapshot(){return s},size(){return n.size},getById(b){return n.get(b)},dispose(){l=!0,n.clear(),s=[],i.clear(),o=0}}}function mr(t){let e=String(t.type||"").trim(),r={};if(t.params&&typeof t.params=="object"){let s=Object.keys(t.params).sort();for(let o of s){let i=t.params[o];r[o]=String(i)}}let n=new URLSearchParams(r).toString();return n.length>0?`${e}?${n}`:e}function bs(t){let e=we("subs"),r=new Map,n=new Map;function s(l,a){e("applyDelta %s +%d ~%d -%d",l,(a.added||[]).length,(a.updated||[]).length,(a.removed||[]).length);let c=n.get(l);if(!c||c.size===0)return;let p=Array.isArray(a.added)?a.added:[],m=Array.isArray(a.updated)?a.updated:[],b=Array.isArray(a.removed)?a.removed:[];for(let v of Array.from(c)){let k=r.get(v);if(!k)continue;let R=k.itemsById;for(let B of p)typeof B=="string"&&B.length>0&&R.set(B,!0);for(let B of m)typeof B=="string"&&B.length>0&&R.set(B,!0);for(let B of b)typeof B=="string"&&B.length>0&&R.delete(B)}}async function o(l,a){let c=mr(a);if(e("subscribe %s key=%s",l,c),!r.has(l))r.set(l,{key:c,itemsById:new Map});else{let m=r.get(l);if(m&&m.key!==c){let b=n.get(m.key);b&&(b.delete(l),b.size===0&&n.delete(m.key)),r.set(l,{key:c,itemsById:new Map})}}n.has(c)||n.set(c,new Set);let p=n.get(c);p&&p.add(l);try{await t("subscribe-list",{id:l,type:a.type,params:a.params})}catch(m){let b=r.get(l)||null;if(b){let v=n.get(b.key);v&&(v.delete(l),v.size===0&&n.delete(b.key))}throw r.delete(l),m}return async()=>{e("unsubscribe %s key=%s",l,c);try{await t("unsubscribe-list",{id:l})}catch{}let m=r.get(l)||null;if(m){let b=n.get(m.key);b&&(b.delete(l),b.size===0&&n.delete(m.key))}r.delete(l)}}return{subscribeList:o,_applyDelta:s,_subKeyOf:mr,selectors:{getIds(l){let a=r.get(l);return a?Array.from(a.itemsById.keys()):[]},has(l,a){let c=r.get(l);return c?c.itemsById.has(a):!1},count(l){let a=r.get(l);return a?a.itemsById.size:0},getItemsById(l){let a=r.get(l),c={};if(!a)return c;for(let p of a.itemsById.keys())c[p]=!0;return c}}}}function ys(){let t=we("issue-stores"),e=new Map,r=new Map,n=new Set,s=new Map;function o(){for(let a of Array.from(n))try{a()}catch{}}function i(a,c,p){let m=c?mr(c):"",b=r.get(a)||"",v=e.has(a);if(t("register %s key=%s (prev=%s)",a,m,b),v&&b&&m&&b!==m){let k=e.get(a);if(k)try{k.dispose()}catch{}let R=s.get(a);if(R){try{R()}catch{}s.delete(a)}let B=Xr(a,p);e.set(a,B);let z=B.subscribe(()=>o());s.set(a,z)}else if(!v){let k=Xr(a,p);e.set(a,k);let R=k.subscribe(()=>o());s.set(a,R)}return r.set(a,m),()=>l(a)}function l(a){t("unregister %s",a),r.delete(a);let c=e.get(a);c&&(c.dispose(),e.delete(a));let p=s.get(a);if(p){try{p()}catch{}s.delete(a)}}return{register:i,unregister:l,getStore(a){return e.get(a)||null},snapshotFor(a){let c=e.get(a);return c?c.snapshot().slice():[]},subscribe(a){return n.add(a),()=>n.delete(a)}}}function ws(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function ks(){let t=null,e=new Set;function r(){for(let n of Array.from(e))try{n()}catch{}}return{get(){return t},set(n){t=n,r()},clear(){t=null,r()},subscribe(n){return e.add(n),()=>e.delete(n)}}}function Qr(t,e){return`#/${t==="worker"?"worker":"board"}?issue=${encodeURIComponent(e)}`}function wi(t){let e=String(t||""),r=e.startsWith("#")?e.slice(1):e,n=r.indexOf("?"),s=n>=0?r.slice(n+1):"";if(s){let l=new URLSearchParams(s).get("issue");if(l)return decodeURIComponent(l)}let o=/^\/issue\/([^\s?#]+)/.exec(r);return o&&o[1]?decodeURIComponent(o[1]):null}function ki(t){let e=String(t||"");return/^#\/worker(\b|\/|$)/.test(e)?"worker":"board"}function vs(t){let e=we("router"),r=()=>{let n=window.location.hash||"",s=/^#\/issue\/([^\s?#]+)/.exec(n),o=s&&s[1]?decodeURIComponent(s[1]):wi(n),i=ki(n);if(e("hash change \u2192 view=%s id=%s",i,o),t.setState({selected_id:i==="worker"?null:o,view:i,worker:{selected_parent_id:i==="worker"?o:null}}),!!s||/^#\/(issues|epics)(\b|\/|\?|$)/.test(n)){let a=o?`#/${i}?issue=${encodeURIComponent(o)}`:`#/${i}`;window.location.hash!==a&&(window.location.hash=a)}};return{start(){window.addEventListener("hashchange",r),r()},stop(){window.removeEventListener("hashchange",r)},gotoIssue(n){let o=(t.getState?t.getState():{view:"board"}).view==="worker"?"worker":"board",i=Qr(o,n);e("goto issue %s (view=%s)",n,o),window.location.hash!==i?window.location.hash=i:t.setState({selected_id:o==="worker"?null:n,view:o,worker:{selected_parent_id:o==="worker"?n:null}})},gotoView(n){let s=t.getState?t.getState():{selected_id:null,worker:{selected_parent_id:null}},o=n==="worker"?s.worker?.selected_parent_id:s.selected_id,i=o?Qr(n,o):`#/${n}`;e("goto view %s (id=%s)",n,o||""),window.location.hash!==i?window.location.hash=i:t.setState({view:n,selected_id:n==="worker"?null:s.selected_id})}}}var vi=Object.freeze({workspace_config:{default_workspace:null}});function $s(t){return{workspace_config:{default_workspace:typeof t?.workspace_config?.default_workspace=="string"&&t.workspace_config.default_workspace.length>0?t.workspace_config.default_workspace:vi.workspace_config.default_workspace}}}function xs(t={}){let e=we("state"),r={selected_id:t.selected_id??null,view:t.view??"board",filters:{status:t.filters?.status??"all",search:t.filters?.search??"",type:typeof t.filters?.type=="string"?t.filters?.type:""},board:{closed_filter:t.board?.closed_filter==="3"||t.board?.closed_filter==="7"||t.board?.closed_filter==="today"?t.board?.closed_filter:"today",show_deferred_column:t.board?.show_deferred_column===!0},worker:{selected_parent_id:t.worker?.selected_parent_id??null,show_closed_children:Array.isArray(t.worker?.show_closed_children)?t.worker.show_closed_children:[]},workspace:{current:t.workspace?.current??null,available:t.workspace?.available??[],hidden:t.workspace?.hidden??[]},config:$s(t.config)},n=new Set;function s(){for(let o of Array.from(n))try{o(r)}catch{}}return{getState(){return r},setState(o){let i={...r,...o,filters:{...r.filters,...o.filters||{}},board:{...r.board,...o.board||{}},worker:{...r.worker,...o.worker||{}},workspace:{current:o.workspace?.current!==void 0?o.workspace.current:r.workspace.current,available:o.workspace?.available!==void 0?o.workspace.available:r.workspace.available,hidden:o.workspace?.hidden!==void 0?o.workspace.hidden:r.workspace.hidden},config:o.config!==void 0?$s(o.config):r.config},l=i.workspace.current?.path!==r.workspace.current?.path||i.workspace.available.length!==r.workspace.available.length||i.workspace.hidden.length!==r.workspace.hidden.length||i.workspace.hidden.some((c,p)=>c!==r.workspace.hidden[p]),a=i.config.workspace_config.default_workspace!==r.config.workspace_config.default_workspace;i.selected_id===r.selected_id&&i.view===r.view&&i.filters.status===r.filters.status&&i.filters.search===r.filters.search&&i.filters.type===r.filters.type&&i.board.closed_filter===r.board.closed_filter&&i.board.show_deferred_column===r.board.show_deferred_column&&i.worker.selected_parent_id===r.worker.selected_parent_id&&i.worker.show_closed_children.length===r.worker.show_closed_children.length&&i.worker.show_closed_children.every((c,p)=>c===r.worker.show_closed_children[p])&&!l&&!a||(r=i,e("state change %o",{selected_id:r.selected_id,view:r.view,filters:r.filters,board:r.board,worker:r.worker,workspace:r.workspace.current?.path,config:{default_workspace:r.config.workspace_config.default_workspace}}),s())},subscribe(o){return n.add(o),()=>n.delete(o)}}}function Ss(t){let e=we("activity"),r=0,n=new Map,s=1;function o(){if(!t)return;let c=r>0;t.toggleAttribute("hidden",!c),t.setAttribute("aria-busy",c?"true":"false")}function i(){r+=1,e("start count=%d",r),o()}function l(){let c=r;r=Math.max(0,r-1),c<=0?e("done called but count was already %d",c):e("done count=%d\u2192%d",c,r),o()}function a(c){return async(m,b)=>{let v=s++,k=Date.now();n.set(v,{type:m,start_ts:k}),e("request start id=%d type=%s count=%d",v,m,r+1),i();let R=!1,B=()=>{R||(R=!0,n.delete(v),l())},z=setTimeout(()=>{R||(e("request TIMEOUT id=%d type=%s elapsed=%dms",v,m,Date.now()-k),B())},3e4);try{let V=await c(m,b),H=Date.now()-k;return e("request done id=%d type=%s elapsed=%dms",v,m,H),V}catch(V){let H=Date.now()-k;throw e("request error id=%d type=%s elapsed=%dms err=%o",v,m,H,V),V}finally{clearTimeout(z),B()}}}return o(),{wrapSend:a,start:i,done:l,getCount:()=>r,getActiveRequests:()=>{let c=Date.now();return Array.from(n.entries()).map(([p,m])=>({id:p,type:m.type,elapsed_ms:c-m.start_ts}))}}}function Q(t,e="info",r=2800){let n=document.createElement("div");n.className="toast",n.textContent=t,n.style.position="fixed",n.style.right="12px",n.style.bottom="12px",n.style.zIndex="1000",n.style.color="#fff",n.style.padding="8px 10px",n.style.borderRadius="4px",n.style.fontSize="12px",e==="success"?n.style.background="#156d36":e==="warning"?n.style.background="#a36a00":e==="error"?n.style.background="#9f2011":n.style.background="rgba(0,0,0,0.85)",(document.body||document.documentElement).appendChild(n),setTimeout(()=>{try{n.remove()}catch{}},r)}function gr(t=void 0,e=void 0){function r(){if(!e||typeof e.get!="function")return null;let o=e.get();return o&&o.order?o.order:{}}function n(o,i,l){let a=t&&t.snapshotFor?t.snapshotFor(o).slice():[];if(i==="closed")return a.sort(gs),a;switch(l){case"created_desc":return a.sort(Tt),a;case"created_asc":return a.sort(fs),a;case"updated_desc":return a.sort(hs),a;case"priority":return a.sort(ms),a;case"manual":default:{let c=r();return c?a.sort(hr(c)):a.sort(Tt),a}}}function s(o){let i=[];return t&&typeof t.subscribe=="function"&&i.push(t.subscribe(o)),e&&typeof e.subscribe=="function"&&i.push(e.subscribe(o)),()=>{for(let l of i)try{l()}catch{}}}return{selectBoardColumn:n,subscribe:s}}function _r(t){let e=t.transport,r=t.uiOrderStore;function n(i,l){return"renormalize"in i?i.renormalize:[{bead_id:l,rank:i.rank}]}function s(i,l){let a={...i.order};for(let c of l)a[c.bead_id]=c.rank;r&&r.set({revision:i.revision,order:a})}async function o(i,l,a){if(!e||!r)return;let c=r.get()||{revision:0,order:{}},p=n(Zr(l,a,c.order),i);s(c,p);let m=await e("ui-order-set",{expected_revision:c.revision,entries:p});if(m&&m.conflict){let b={revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}};r.set(b);let v=n(Zr(l,a,b.order),i);s(b,v);let k=await e("ui-order-set",{expected_revision:b.revision,entries:v});k&&k.applied&&r.set({revision:typeof k.revision=="number"?k.revision:0,order:k.order||{}})}else m&&m.applied&&r.set({revision:typeof m.revision=="number"?m.revision:0,order:m.order||{}})}return{applyReorder:o}}function br(t){return Array.isArray(t)?t.filter(e=>typeof e=="string"):[]}function Jr(t,e){return!e||typeof t!="string"||t.length===0||br(e.visible_labels).includes(t)?!0:br(e.hidden_labels).includes(t)?!1:!br(e.hidden_prefixes).some(r=>r.length>0&&t.startsWith(r))}function Ts(t,e){return br(t).filter(r=>Jr(r,e))}function At(t,e){let r=t&&t.chips?t.chips[e]:void 0;return typeof r=="boolean"?r:!0}function en(t){if(!t)return null;if(typeof t=="number")return Number.isFinite(t)?t:null;let e=Date.parse(t);return Number.isFinite(e)?e:null}function gt(t){let e=en(t);if(e===null)return"";let r=new Date(e),n=s=>String(s).padStart(2,"0");return`${r.getFullYear()}-${n(r.getMonth()+1)}-${n(r.getDate())} ${n(r.getHours())}:${n(r.getMinutes())}`}function tn(t,e){let r=en(t);if(r===null)return"";let s=(typeof e=="number"?e:Date.now())-r;if(s<6e4)return"\uBC29\uAE08";let o=Math.floor(s/6e4);if(o<60)return`${o}\uBD84 \uC804`;let i=Math.floor(s/36e5);if(i<24)return`${i}\uC2DC\uAC04 \uC804`;let l=Math.floor(s/864e5);if(l<7)return`${l}\uC77C \uC804`;let a=Math.floor(l/7);if(l<30)return`${a}\uC8FC \uC804`;let c=Math.floor(l/30);return c<12?`${c}\uAC1C\uC6D4 \uC804`:`${Math.floor(l/365)}\uB144 \uC804`}var $i={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"mrg"},xi={spec:"spec",plan:"plan",impl:"impl",pr:"pr",merge:"merge"},Si={spec_backed:["spec","impl","pr","merge"],full_plan:["spec","plan","impl","pr","merge"]},Ti={reviewed:"\u2713",skip:"\u2298",stale:"\u2713"};function Ai(t,e,r){if(!(r==="in_progress"||r==="resolved"))return null;for(let s of t)if(e[s]&&e[s].state==="dim")return s;return null}function Ei(t,e,r){let n=$i[t]||t,s=e&&e.state||"empty",o=Ti[s]||"",i="bar";s==="dim"?i+=` b-${n} dim`:s==="on"||s==="reviewed"||s==="skip"?i+=` b-${n} on`:s==="stale"&&(i+=` b-${n} stale`),r&&(i+=" glow");let l=s==="empty"?"lbl":`lbl l-${n} on`,a=r?`color: var(--stage-${n}-on)`:"";return d`
  ...
  `}function Es(t,e){let r=Ci(t.priority);return d`
    ...
    >
      ...
      ${Ii(t,e)}
      ${t.workflow&&At(e.policy||null,"stepper")?yr(t.workflow,t.status):""}
      ${Oi(t,e)}
    </article>
  ...
  `}var Bi=200,qi={"ready-col":"open","in-progress-col":"in_progress","resolved-col":"resolved","deferred-col":"deferred","closed-col":"closed"},Ui=new Set(["blocked-col","ready-col","in-progress-col","resolved-col","deferred-col"]),Rs="beads-ui.board.sort",Is=new Set(["created_desc","created_asc","updated_desc","priority","manual"]);function zi(){try{let t=window.localStorage.getItem(Rs);if(t&&Is.has(t))return t}catch{}return"created_desc"}function Ls(t,e){let r=we("views:board"),n=e.gotoIssue,s=e.issueStores,o=e.transport,i=e.uiOrderStore,l=e.displayPolicyStore,a=e.onClosedRangeChange,c=e.onNewIssue,p=e.closedRange||ur,m=s?gr(s,i):null,b=_r({transport:o,uiOrderStore:i}),v=[],k=[],R=[],B=[],z=[],V=[],H=!1,N=0,S=zi(),x=new Map,$=new Map,f=new Map,M=new Set,F={search:"",priority:"",type:"",labels:[]},P=!1,q=null;function Ce(T){return String(T.status||"open")==="open"}function Ne(T){let E=String(T.status||"open");return E==="open"||E==="blocked"}function Se(T){let E=F.search.trim().toLowerCase(),j=F.priority,W=F.type,L=F.labels;return T.filter(g=>{if(E){let C=String(g.id||"").toLowerCase(),A=String(g.title||"").toLowerCase();if(!C.includes(E)&&!A.includes(E))return!1}if(j!==""&&String(g.priority)!==j||W!==""&&String(g.issue_type||"")!==W)return!1;if(L.length>0){let C=Array.isArray(g.labels)?g.labels:[];if(!L.some(A=>C.includes(A)))return!1}return!0})}function Je(){let T=new Set;for(let E of[v,k,R,B,z,V])for(let j of E){let W=Array.isArray(j.labels)?j.labels:[];for(let L of W)typeof L=="string"&&L.length>0&&T.add(L)}return Array.from(T).sort()}function ze(){return F.search.trim()!==""||F.priority!==""||F.type!==""||F.labels.length>0}function _e(){try{if(m){let T=m.selectBoardColumn("tab:board:in-progress","in_progress",S),E=m.selectBoardColumn("tab:board:blocked","blocked",S).filter(Ne),j=new Set(T.map(Y=>Y.id)),W=m.selectBoardColumn("tab:board:ready","ready",S).filter(Y=>Ce(Y)&&!j.has(Y.id)),L=m.selectBoardColumn("tab:board:resolved","resolved",S),g=m.selectBoardColumn("tab:board:deferred","deferred",S),C=H?g:[],A=m.selectBoardColumn("tab:board:closed","closed").slice(0,Bi),I=[...E,...W,...T,...L,...C,...A];$e(I);let J=new Set;for(let Y of I)Y&&Y.id&&!rn(Y)&&J.add(Y.id);let le=!ze();v=le?Bt(E,J):E,k=le?Bt(W,J):W,R=le?Bt(T,J):T,B=le?Bt(L,J):L,z=le?Bt(C,J):C,N=g.length,V=le?Bt(A,J):A,x=new Map;for(let Y of v)x.set(Y.id,"open");for(let Y of k)x.set(Y.id,"open");for(let Y of R)x.set(Y.id,"in_progress");for(let Y of B)x.set(Y.id,"resolved");for(let Y of z)x.set(Y.id,"deferred");for(let Y of V)x.set(Y.id,"closed");$=new Map;for(let Y of v)$.set(Y.id,"blocked-col");for(let Y of k)$.set(Y.id,"ready-col");for(let Y of R)$.set(Y.id,"in-progress-col");for(let Y of B)$.set(Y.id,"resolved-col");for(let Y of z)$.set(Y.id,"deferred-col");for(let Y of V)$.set(Y.id,"closed-col")}ye()}catch{v=[],k=[],R=[],B=[],z=[],V=[],f=new Map,ye()}}function $e(T){let E=new Map;for(let W of T)W&&W.id&&!E.has(W.id)&&E.set(W.id,W);let j=new Map;for(let W of E.values()){let L=rn(W);if(!L)continue;let g=j.get(L);g||(g=[],j.set(L,g)),g.push({id:W.id,title:W.title,status:W.status,metadata:W.metadata,created_at:W.created_at})}f=j}function Ve(T){let E=f.get(T)||[],j=0,W=null;for(let L of E)(L.status==="resolved"||L.status==="closed")&&(j+=1),!W&&L.status==="in_progress"&&(W=L);return{total:E.length,count:j,current:W,children:E}}function pe(T){return!M.has(T)}function at(T,E){T.preventDefault(),T.stopPropagation(),M.has(E)?M.delete(E):M.add(E),ye()}function fe(T,E){T.preventDefault(),T.stopPropagation(),n(E)}function Ke(T,E){T.preventDefault(),T.stopPropagation(),n(E)}function ie(T,E){q||n(E)}function Pe(T,E){T.preventDefault(),T.stopPropagation(),Hi(E).then(j=>{j&&Q("\uBCF5\uC0AC\uB428","success",1200)})}function et(T,E){q=E,T.dataTransfer&&(T.dataTransfer.setData("text/plain",E),T.dataTransfer.effectAllowed="move"),T.target.classList.add("board-card--dragging")}function Te(T){T.target.classList.remove("board-card--dragging"),y(),setTimeout(()=>{q=null},0)}function de(T){let E=String(T.target.value||"");!E||E===p||(p=E,a&&a(E),ye())}let be={onCardClick:ie,onCopyId:Pe,onDragStart:et,onDragEnd:Te,onClosedRangeChange:de,rollupFor:Ve,isExpanded:pe,onRollupToggle:at,onChildClick:fe,onFromChipClick:Ke,get policy(){return l?l.get():null}};function Le(T){let E=T.target,j=t.querySelector(".board-filter__labels");E&&j&&j.contains(E)||De()}function He(T){T.key==="Escape"&&De()}function Re(){P||(P=!0,document.addEventListener("mousedown",Le),document.addEventListener("keydown",He),ye())}function De(){P&&(P=!1,document.removeEventListener("mousedown",Le),document.removeEventListener("keydown",He),ye())}let Ae={onSearchInput(T){F.search=String(T.target.value||""),_e()},onPriorityChange(T){F.priority=String(T.target.value||""),_e()},onTypeChange(T){F.type=String(T.target.value||""),_e()},onSortChange(T){let E=String(T.target.value||"");if(!(!Is.has(E)||E===S)){S=E;try{window.localStorage.setItem(Rs,E)}catch{}_e()}},onDeferredToggle(){H=!H,_e()},onLabelMenuToggle(){P?De():Re()},onLabelToggle(T){let E=F.labels.indexOf(T);E===-1?F.labels.push(T):F.labels.splice(E,1),_e()},onLabelClear(){F.labels.length!==0&&(F.labels=[],_e())},onNewIssue(){c&&c()}};function We(){let T=H?"board-root board-root--deferred":"board-root";return d`
      <div class="board-view">
        ${Cs(F,Ae,{sort_mode:S,show_deferred:H,deferred_count:N,label_options:Je(),label_menu_open:P})}
        <div class=${T}>
          ${Et({title:"Blocked",id:"blocked-col",items:Se(v)},be)}
          ${Et({title:"Ready",id:"ready-col",items:Se(k)},be)}
          ${Et({title:"In progress",id:"in-progress-col",items:Se(R)},be)}
          ${Et({title:"Resolved",id:"resolved-col",items:Se(B)},be)}
          ${H?Et({title:"Deferred",id:"deferred-col",items:Se(z)},be):""}
          ${Et({title:"Closed",id:"closed-col",items:Se(V),is_closed:!0,closed_range:p},be)}
        </div>
      </div>
    `}function ye(){ce(We(),t),Ee()}function Ee(){try{let T=Array.from(t.querySelectorAll(".board-column"));for(let E of T)Array.from(E.querySelectorAll(".board-card")).forEach((W,L)=>{W.tabIndex=L===0?0:-1})}catch{}}async function Ge(T,E){if(!o){Q("\uC5F0\uACB0\uB418\uC9C0 \uC54A\uC544 \uC0C1\uD0DC\uB97C \uBCC0\uACBD\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","error");return}try{await o("update-status",{id:T,status:E}),Q("\uC0C1\uD0DC \uBCC0\uACBD\uB428","success",1500)}catch(j){r("update-status failed: %o",j),Q("\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328","error")}}function Oe(T){switch(T){case"blocked-col":return v;case"ready-col":return k;case"in-progress-col":return R;case"resolved-col":return B;case"deferred-col":return z;default:return[]}}function Ze(T,E,j){if(!o||!i)return;let W=Oe(T),L=W.find(J=>J.id===E);if(!L)return;let g=W.filter(J=>J.id!==E),C=j.closest?j.closest(".board-card"):null,A=g.length;if(C){let J=C.getAttribute("data-issue-id");if(J===E)return;let le=g.findIndex(Y=>Y.id===J);le>=0&&(A=le)}let I=g.slice();I.splice(A,0,L),b.applyReorder(E,I,A)}function y(){for(let T of Array.from(t.querySelectorAll(".board-column--drag-over")))T.classList.remove("board-column--drag-over")}let w=null;t.addEventListener("dragover",T=>{T.preventDefault(),T.dataTransfer&&(T.dataTransfer.dropEffect="move");let j=T.target.closest(".board-column");j&&j!==w&&(w&&w.classList.remove("board-column--drag-over"),j.classList.add("board-column--drag-over"),w=j)}),t.addEventListener("dragleave",T=>{let E=T.relatedTarget;(!E||!t.contains(E))&&w&&(w.classList.remove("board-column--drag-over"),w=null)}),t.addEventListener("drop",T=>{T.preventDefault(),w&&(w.classList.remove("board-column--drag-over"),w=null);let E=T.target,j=E.closest(".board-column");if(!j)return;let W=T.dataTransfer?.getData("text/plain")||"";if(!W)return;let L=j.id,g=$.get(W);if(g&&g===L){if(Ui.has(L)){if(S!=="manual"){Q("\uC218\uB3D9(\uB4DC\uB798\uADF8) \uC815\uB82C \uBAA8\uB4DC\uC5D0\uC11C\uB9CC \uC21C\uC11C\uB97C \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4","warning",2e3);return}Ze(L,W,E)}return}let C=qi[L];if(!C){Q("\uC5EC\uAE30\uB85C\uB294 \uC62E\uAE38 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4","warning",1500);return}x.get(W)!==C&&Ge(W,C)}),t.addEventListener("keydown",T=>{let E=T.target;if(!(E instanceof HTMLElement))return;let j=String(E.tagName||"").toLowerCase();if(j==="input"||j==="textarea"||j==="select"||j==="button"||j==="a"||E.isContentEditable===!0)return;let W=E.closest(".board-card");if(!W)return;let L=String(T.key||"");if(L==="Enter"||L===" "){T.preventDefault();let I=W.getAttribute("data-issue-id");I&&n(I);return}if(L!=="ArrowUp"&&L!=="ArrowDown"&&L!=="ArrowLeft"&&L!=="ArrowRight")return;T.preventDefault();let g=W.closest(".board-column");if(!g)return;let C=Array.from(g.querySelectorAll(".board-card")),A=C.indexOf(W);if(L==="ArrowDown"&&A<C.length-1){U(W,C[A+1]);return}if(L==="ArrowUp"&&A>0){U(W,C[A-1]);return}if(L==="ArrowLeft"||L==="ArrowRight"){let I=Array.from(t.querySelectorAll(".board-column")),J=I.indexOf(g),le=L==="ArrowRight"?1:-1,Y=J+le;for(;Y>=0&&Y<I.length;){let xe=I[Y].querySelector(".board-card");if(xe){U(W,xe);return}Y+=le}}});function U(T,E){try{T.tabIndex=-1,E.tabIndex=0,E.focus()}catch{}}let ee=null;m&&m.subscribe&&(ee=m.subscribe(()=>{try{_e()}catch{}}));let se=null;return l&&l.subscribe&&(se=l.subscribe(()=>{try{_e()}catch{}})),{async load(){r("load"),_e()},clear(){De(),ee&&(ee(),ee=null),se&&(se(),se=null),t.replaceChildren(),v=[],k=[],R=[],B=[],z=[],V=[],x=new Map,$=new Map}}}function rn(t){let e=t&&t.parent;return typeof e=="string"?e:e&&e.id?String(e.id):""}function Bt(t,e){return t.filter(r=>{let n=rn(r);return!(n&&e.has(n))})}async function Hi(t){try{if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")return await navigator.clipboard.writeText(String(t)),!0;let e=document.createElement("textarea");e.value=String(t),e.style.position="fixed",e.style.left="-9999px",document.body.appendChild(e),e.select();let r=!1;try{r=document.execCommand("copy")}finally{e.remove()}return r}catch{return!1}}async function qt(t){let e=String(t);if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{return await navigator.clipboard.writeText(e),!0}catch{}try{let r=document.createElement("textarea");r.value=e,r.style.position="fixed",r.style.left="-9999px",document.body.appendChild(r),r.select();let n=!1;try{n=document.execCommand("copy")}finally{r.remove()}return n}catch{return!1}}var Wi={Read:"\u{1F4D6}",Edit:"\u270E",MultiEdit:"\u270E",Write:"\u{1F4DD}",Bash:"\u26A1",Grep:"\u{1F50E}",Glob:"\u{1F50E}",Task:"\u{1F916}",WebFetch:"\u{1F310}",WebSearch:"\u{1F310}"},Gi=/^\s*([✓✗⊘])\s*(spec|impl|implementation|plan)\s*게이트\s*[—–-]\s*(\S+)\s+(APPROVE|REVISE|REJECT|BLOCK|SKIP)(?:\s*·\s*(.+))?/,ji=/^\s*#{0,3}\s*Phase\s+\d+(?:\s*\/\s*\d+)?\s*(?:[·:—–-]\s*.+)?$/;function _t(t){return!!t&&typeof t=="object"}function nn(t){return typeof t!="string"||t.length===0?[]:t.split(/\r?\n/)}function Ds(t,e){let r=nn(t),n=nn(e),s=new Map;for(let l of r)s.set(l,(s.get(l)||0)+1);let o=0;for(let l of n){let a=s.get(l)||0;a>0?s.set(l,a-1):o+=1}let i=0;for(let l of s.values())i+=l;return{added:o,removed:i}}function Yi(t){let e="";typeof t=="string"?e=t:Array.isArray(t)?e=t.map(s=>_t(s)&&typeof s.text=="string"?s.text:"").join(""):_t(t)&&typeof t.text=="string"&&(e=t.text);let n=(String(e).split(/\r?\n/).find(s=>s.trim().length>0)||"").trim();return n.length>120?`${n.slice(0,117)}\u2026`:n}function Vi(t){let e=String(t.name||""),r=t.input||{},n={kind:"tool",tool:e,icon:Wi[e]||"\u{1F527}",input:r,expandable:!0};if((e==="Read"||e==="Write")&&(n.path=String(r.file_path||r.path||"")),e==="Write"&&(n.added=nn(r.content).length),e==="Edit"){n.path=String(r.file_path||r.path||"");let{added:s,removed:o}=Ds(r.old_string,r.new_string);n.added=s,n.removed=o}if(e==="MultiEdit"){n.path=String(r.file_path||r.path||"");let s=0,o=0,i=Array.isArray(r.edits)?r.edits:[];for(let l of i){let a=Ds(_t(l)?l.old_string:"",_t(l)?l.new_string:"");s+=a.added,o+=a.removed}n.added=s,n.removed=o}return e==="Bash"&&(n.command=String(r.command||"")),(e==="Grep"||e==="Glob")&&(n.command=String(r.pattern||r.query||"")),n}function Os(t){let e=t.split(/\r?\n/).find(n=>n.trim().length>0)||"",r=Gi.exec(e);return r?{kind:"gate",gate:r[2]==="implementation"?"impl":r[2],reviewer:r[3],verdict:r[4],time:r[5]?r[5].trim():void 0,text:e.trim()}:ji.test(e)&&e.trim().length<=80?{kind:"phase",text:e.trim()}:{kind:"assistant",text:t}}function Ki(t,e){if(t.type==="assistant"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[],s=[];for(let o of n)if(_t(o)){if(o.type==="text"&&typeof o.text=="string")s.push(Os(o.text));else if(o.type==="tool_use"){let i=Vi(o);typeof o.id=="string"&&e.set(o.id,i),s.push(i)}}return s}if(t.type==="user"){let r=t.message,n=r&&Array.isArray(r.content)?r.content:[];for(let s of n)if(_t(s)&&s.type==="tool_result"){let o=e.get(String(s.tool_use_id));if(o){let i=Yi(s.content);o.result=i,o.output=typeof s.content=="string"?s.content:i}}return[]}if(t.type==="result"){let r=t.is_error===!1&&t.subtype==="success";return[{kind:"result",success:r,text:typeof t.result=="string"?t.result:r?"DONE":""}]}return[]}function Zi(t){if(t.type==="item.completed"&&_t(t.item)){let e=t.item;return e.type==="agent_message"&&typeof e.text=="string"?[Os(e.text)]:e.type==="error"?[{kind:"error",text:String(e.message||"")}]:[]}if(t.type==="turn.completed")return[{kind:"result",success:!0,text:"DONE"}];if(t.type==="turn.failed"){let e=t.error;return[{kind:"error",text:e&&typeof e.message=="string"?e.message:"turn failed"}]}return t.type==="error"?[{kind:"error",text:String(t.message||"")}]:[]}function Xi(t){let e=t.type;return typeof e=="string"&&(e==="error"||e.startsWith("thread.")||e.startsWith("turn.")||e.startsWith("item."))}function Ms(t){let e=[],r=new Map,n=Array.isArray(t)?t:[];for(let s of n){let o=s;if(typeof s=="string"){let l=s.trim();if(l.length===0)continue;try{o=JSON.parse(l)}catch{continue}}if(!_t(o))continue;let i=Xi(o)?Zi(o):Ki(o,r);for(let l of i)e.push(l)}return e}function wr(t,e={}){let{transport:r,sessionLogStore:n,onClose:s}=e,o=null,i={},l=!0,a=new Set,c=null;function p(){if(!o||!n)return[];let $=n.get(o);return Ms($?$.lines:[])}function m($,f){if(f.kind==="gate")return d`<div class="sv__gate">${f.text}</div>`;if(f.kind==="phase")return d`<div class="sv__phase">${f.text}</div>`;if(f.kind==="result")return d`<div
        class="sv__result${f.success?" sv__result--ok":" sv__result--fail"}"
      >
        ${f.success?"\u2713":"\u2717"}
        ${f.text||(f.success?"DONE":"\uC2E4\uD328")}
      </div>`;if(f.kind==="error")return d`<div class="sv__error">⛔ ${f.text}</div>`;if(f.kind==="blocker")return d`<div class="sv__error">⛔ ${f.text}</div>`;if(f.kind==="tool"){let M=a.has($),F=f.tool==="Bash"?f.command:f.path||f.command||"";return d`<div
...
`)}function v(){if(!o)return d``;let $=p(),f=[i.runner,i.model,i.effort].filter(Boolean).join(" \xB7 "),M=i.session_id||"",F=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${l?"ON":"OFF"}`;return d`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
`+r.join(`
`),R=this.blockquote(k);o[o.length-1]=R,n=n.substring(0,n.length-v.raw.length)+R.raw,s=s.substring(0,s.length-v.text.length)+R.text;break}else if(b?.type==="list"){let v=b,k=v.raw+`
`+r.join(`
`),R=this.list(k);o[o.length-1]=R,n=n.substring(0,n.length-b.raw.length)+R.raw,s=s.substring(0,s.length-v.raw.length)+R.raw,r=k.substring(o.at(-1).raw.length).split(`
...
`,t=t.substring(b.length+1),a=!0),!a){let R=this.rules.other.nextBulletRegex(k),B=this.rules.other.hrRegex(k),z=this.rules.other.fencesBeginRegex(k),V=this.rules.other.headingBeginRegex(k),H=this.rules.other.htmlBeginRegex(k);for(;t;){let N=t.split(`
`,1)[0],S;if(b=N,this.options.pedantic?(b=b.replace(this.rules.other.listReplaceNesting,"  "),S=b):S=b.replace(this.rules.other.tabCharGlobal,"    "),z.test(b)||V.test(b)||H.test(b)||R.test(b)||B.test(b))break;if(S.search(this.rules.other.nonSpaceChar)>=k||!b.trim())p+=`
`+S.slice(k);else{if(v||m.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||z.test(m)||V.test(m)||B.test(m))break;p+=`
`+b}!v&&!b.trim()&&(v=!0),c+=N+`
...
Please report this to https://github.com/markedjs/marked.`,t){let n="<p>An error occurred:</p><pre>"+ft(r.message+"",!0)+"</pre>";return e?Promise.resolve(n):n}if(e)return Promise.reject(r);throw r}}},Ct=new nl;function ae(t,e){return Ct.parse(t,e)}ae.options=ae.setOptions=function(t){return Ct.setOptions(t),ae.defaults=Ct.defaults,io(ae.defaults),ae};ae.getDefaults=vn;ae.defaults=Rt;ae.use=function(...t){return Ct.use(...t),ae.defaults=Ct.defaults,io(ae.defaults),ae};ae.walkTokens=function(t,e){return Ct.walkTokens(t,e)};ae.parseInline=Ct.parseInline;ae.Parser=it;ae.parser=it.parse;ae.Renderer=Rr;ae.TextRenderer=Rn;ae.Lexer=ot;ae.lexer=ot.lex;ae.Tokenizer=Cr;ae.Hooks=ir;ae.parse=ae;var cd=ae.options,dd=ae.setOptions,ud=ae.use,pd=ae.walkTokens,fd=ae.parseInline;var hd=it.parse,md=ot.lex;function bo(t){let e=ae.parse(t),r=Zs.sanitize(e);return Js(r)}function sl(t){return String(t||"").replace(/^docs\/(superpowers\/)?/,"")}function yo(t,e){let r=e.getWorkspacePath,n=e.fetchImpl||globalThis.fetch?.bind(globalThis),s=null,o="loading",i="",l="";function a(k){k.key==="Escape"&&s&&(k.preventDefault(),b())}document.addEventListener("keydown",a);function c(){return s?d`
    ...
    `:d``}function p(){ce(c(),t)}async function m(k){s=k,o="loading",i="",l="",p();let R=r?r():"";if(!R){o="error",l="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4",p();return}if(!n){o="error",l="fetch\uB97C \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4",p();return}let B="/api/doc?workspace="+encodeURIComponent(R)+"&path="+encodeURIComponent(k);try{let z=await n(B),V=await z.json().catch(()=>({}));if(!z.ok||!V||V.ok!==!0){o="error",l="\uBB38\uC11C\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4 ("+String(V&&V.error||z.status)+")",p();return}i=String(V.content||""),o="ready",p()}catch{o="error",l="\uBB38\uC11C \uC694\uCCAD \uC2E4\uD328",p()}}function b(){s=null,ce(d``,t)}function v(){document.removeEventListener("keydown",a),b()}return{open:m,close:b,destroy:v}}var ol={running:"\u25CF",done:"\u2713",failed:"\u2717",orphaned:"\u26A0"};function il(t){if(typeof t!="number"||!Number.isFinite(t))return"";let e=new Date(t),r=String(e.getHours()).padStart(2,"0"),n=String(e.getMinutes()).padStart(2,"0");return`${r}:${n}`}function wo(t,e={}){let r=Array.isArray(t)?t:[];if(r.length===0)return d`
  ...
  `}var al=["open","in_progress","deferred","resolved","closed"],ll=[0,1,2,3,4];function ko(t,e){let r=e.issueStores,n=e.onClose,s=e.transport,o=e.onNavigate,i=e.queueStore,l=e.sessionLogStore,a=null,c=null,p={},m=!1,b=!1,v="",k="",R="";function B(){m=!1,b=!1,v="",k="",R=""}let z=document.createElement("div");z.className="md-viewer-root",document.body.appendChild(z);let V=yo(z,{getWorkspacePath:e.getWorkspacePath||(()=>"")}),H=document.createElement("div");H.className="session-log-root",document.body.appendChild(H);let N=wr(H,{transport:s?(g,C)=>Promise.resolve(s(g,C)):void 0,sessionLogStore:l});function S(){if(!i||!a)return[];let g=i.get();return(g&&g.attempts?Object.values(g.attempts):[]).filter(A=>A&&A.bead_id===a).sort((A,I)=>(I.started_at||0)-(A.started_at||0)).map(A=>({attempt_id:A.attempt_id,bead_id:A.bead_id,status:A.status,started_at:typeof A.started_at=="number"?A.started_at:null,runner:A.runner||null,model:A.model||null,session_id:A.session_id||null,resumed_from:A.resumed_from||null,dismissed_at:typeof A.dismissed_at=="number"?A.dismissed_at:null,cause:typeof A.cause=="string"?A.cause:null,cause_detail:A.cause_detail||null}))}function x(g){let C=i?i.get():null,A=C&&C.attempts?C.attempts[g]:null;N.open({attempt_id:g,meta:A?{runner:A.runner||void 0,model:A.model||void 0,effort:A.effort||void 0,status:A.status||void 0,session_id:A.session_id||void 0}:{}})}async function $(g){if(!s||!g)return;let C=()=>{let I=i?i.get():null;return I&&typeof I.revision=="number"?I.revision:0},A=await s("worker-attempt-resume",{attempt_id:g,expected_revision:C()});if(A&&A.conflict){let I=A.queue&&typeof A.queue.revision=="number"?A.queue.revision:C();A=await s("worker-attempt-resume",{attempt_id:g,expected_revision:I})}A&&A.resumed===!1&&!A.conflict&&A.reason&&Q(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${A.reason}`,"error",2400)}let f={onOpen:x,onResume:$};function M(){let g=i?i.get():null,C=g&&g.exec_defaults;return C&&typeof C=="object"?C:{}}let F=null;r&&r.subscribe&&(F=r.subscribe(()=>Ce()));let P=null;i&&typeof i.subscribe=="function"&&(P=i.subscribe(()=>{a&&L()}));function q(g){g.key==="Escape"&&a&&(g.preventDefault(),n())}document.addEventListener("keydown",q);function Ce(){if(a){if(r&&typeof r.snapshotFor=="function"){let g=r.snapshotFor("detail:"+a)||[];c=g.find(A=>A&&A.id===a)||g[0]||c}L()}}function Ne(g){qt(g).then(C=>{C?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)})}function Se(g){g.preventDefault(),g.stopPropagation(),a&&Ne(a)}function Je(g,C){g.preventDefault(),g.stopPropagation(),Ne(C)}function ze(g,C){g.preventDefault(),g.stopPropagation(),V.open(C)}function _e(g,C){p[g]=C,L(),!(!s||!a)&&Promise.resolve(s("update-exec-settings",{id:a,key:g,value:C})).catch(()=>{Q("\uC2E4\uD589 \uC124\uC815 \uBCC0\uACBD \uC2E4\uD328","error")})}async function $e(g,C,A){if(!s||!a)return!1;try{let I=await Promise.resolve(s(g,C)),J=Array.isArray(I)?I[0]:I;return J&&typeof J=="object"&&J.id?(c=J,!0):(Q(A,"error"),!1)}catch{return Q(A,"error"),!1}}function Ve(g){setTimeout(()=>{try{let C=t.querySelector(g);C&&typeof C.focus=="function"&&C.focus()}catch{}},0)}function pe(){m=!0,v=c&&c.title||"",L(),Ve('.detail-edit__input[data-edit="title"]')}function at(g){v=g.target.value}function fe(){m=!1,v="",L()}function Ke(){$e("edit-text",{id:a,field:"title",value:v},"\uC81C\uBAA9 \uC800\uC7A5 \uC2E4\uD328").then(C=>{C&&(m=!1,v=""),L()})}function ie(){b=!0,k=c&&c.description||"",L(),Ve('.detail-edit__textarea[data-edit="description"]')}function Pe(g){k=g.target.value}function et(){b=!1,k="",L()}function Te(){$e("edit-text",{id:a,field:"description",value:k},"\uC124\uBA85 \uC800\uC7A5 \uC2E4\uD328").then(C=>{C&&(b=!1,k=""),L()})}function de(g,C,A,I){if(g.key==="Escape"){g.stopPropagation(),A();return}g.key==="Enter"&&(!I||g.ctrlKey||g.metaKey)&&(g.preventDefault(),C())}function be(g){let C=g.target.value;$e("update-status",{id:a,status:C},"\uC0C1\uD0DC \uBCC0\uACBD \uC2E4\uD328").then(()=>L())}function Le(g){let C=Number(g.target.value);$e("update-priority",{id:a,priority:C},"\uC6B0\uC120\uC21C\uC704 \uBCC0\uACBD \uC2E4\uD328").then(()=>L())}function He(g){R=g.target.value}function Re(){let g=R.trim();g.length!==0&&$e("label-add",{id:a,label:g},"\uB77C\uBCA8 \uCD94\uAC00 \uC2E4\uD328").then(C=>{C&&(R=""),L()})}function De(g){if(g.key==="Escape"){g.stopPropagation(),R="",L();return}g.key==="Enter"&&(g.preventDefault(),Re())}function Ae(g){$e("label-remove",{id:a,label:g},"\uB77C\uBCA8 \uC81C\uAC70 \uC2E4\uD328").then(()=>L())}let We={onCopyPath:Je,onOpenDoc:ze},ye={onChange:_e};function Ee(g){return typeof g=="string"?g:g&&typeof g=="object"?String(g.id||g.to||g.issue_id||g.depends_on||""):""}function Ge(g){switch(g&&typeof g=="object"?String(g.dependency_type||g.type||""):""){case"blocks":return"\u26D3";case"discovered-from":return"\u21A9";case"parent-child":return"\u2338";default:return""}}function Oe(g){let A=(Array.isArray(g.dependencies)?g.dependencies:[]).map(I=>({id:Ee(I),icon:Ge(I)})).filter(I=>I.id.length>0);return d`
    ...
    `}function Ze(g){let C=g.metadata||{},A=g.workflow||{},I=A.stages||{},J=I.spec&&I.spec.stale,le=I.impl&&I.impl.stale,Y=A.route_source==="derived",xe=A.route||C.route||"\u2014";return d`
      ...
      <div class="detail-kv">
        ...
        <span class="detail-kv__v"
          >${C.spec_review||"\uC5C6\uC74C"}${J?" \xB7 stale":""}</span
        >
      </div>
      <div class="detail-kv">
        <span class="detail-kv__k">impl_review</span>
        <span class="detail-kv__v"
          >${C.impl_review||"\uC5C6\uC74C"}${le?" \xB7 stale":""}</span
        >
      </div>
      ${C.pr_url?d`<div class="detail-kv">
            <span class="detail-kv__k">pr_url</span>
            <span class="detail-kv__v detail-kv__v--wrap">${C.pr_url}</span>
          </div>`:""}
    `}let y={route:["spec_backed","full_plan"]};async function w(g,C){let A=C.target.value;if(g==="route"&&c&&c.metadata&&c.metadata.route==="full_plan"&&A!=="full_plan"&&!window.confirm(`full_plan \u2192 ${A||"(\uBBF8\uC124\uC815)"} \uC804\uD658: \uC800\uC7A5\uB41C plan \uC2B9\uC778\uC740 \uD3EC\uAE30\uB418\uBA70, plan \uD30C\uC77C\xB7\uB9C8\uCEE4 \uC815\uB9AC\uB294 \uC138\uC158 \uACC4\uC57D\uC774 \uC218\uD589\uD569\uB2C8\uB2E4. \uACC4\uC18D\uD560\uAE4C\uC694?`)){L();return}await $e("update-workflow-meta",{id:a,key:g,value:A},"\uC6CC\uD06C\uD50C\uB85C\uC6B0 \uBA54\uD0C0 \uBCC0\uACBD \uC2E4\uD328"),L()}function U(g){let C=g.metadata||{};return d` ${((I,J)=>{let le=y[I],Y=typeof C[I]=="string"?C[I]:"";return d`<div class="detail-kv">
      ...
      </div>`})("route","(\uBBF8\uC124\uC815 \xB7 \uCD94\uB860)")} `}function ee(g){return m?d`
    ...
    `}function se(g){let C=gt(g.created_at),A=gt(g.updated_at);return!C&&!A?d``:d`
    ...
    `}function T(g,C){return d`
      ...
      <div class="detail-kv">
        ...
        <select
          ...
          @change=${Le}
        >
          ${ll.map(A=>d`<option value=${String(A)} ?selected=${A===C}>
                P${A}
              </option>`)}
        </select>
      </div>
    `}function E(g){return d`
      <div class="detail-title-row">
    ...
    `}function j(g){let C=Array.isArray(g.labels)?g.labels:[];return d`
      <div class="detail-section-label">라벨</div>
      <div class="detail-labels">
        ${C.map(A=>d`<span class="detail-label-chip"
              >${A}<button
                type="button"
    ...
    `}function W(){if(!a)return d``;let g=c||{},C=String(g.id||a),A=g.title||"(\uC81C\uBAA9 \uC5C6\uC74C)",I=g.status||"open",J=typeof g.priority=="number"?Math.max(0,Math.min(4,g.priority)):"",le=g.description||"",Y={...g,metadata:{...g.metadata||{},...p}};return d`
    ...
    `}function L(){ce(W(),t)}return{load(g){g!==a&&(p={},B()),a=g,c=null,Ce()},clear(){a=null,c=null,p={},B(),V.close(),N.close(),ce(d``,t)},destroy(){F&&(F(),F=null),P&&(P(),P=null),document.removeEventListener("keydown",q),V.destroy(),z.parentNode&&z.parentNode.removeChild(z),N.destroy(),H.parentNode&&H.parentNode.removeChild(H),a=null,c=null,ce(d``,t)}}}var cl=[["route","route \uCE69"],["fast_track","\u26A1 fast_track \uCE69"],["pr","PR \uCE69"],["from","\u21A9 from \uCE69"],["blocked","blocked \uC0AC\uC720 \uCE69"],["stepper","stepper"]];function vo(t,e){return Jr(t,e)?"shown":e.hidden_labels.includes(t)?"hidden_exact":"hidden_prefix"}function dl(t,e,r){if(!r)return{hidden_labels:e.hidden_labels.includes(t)?e.hidden_labels:[...e.hidden_labels,t],visible_labels:e.visible_labels.filter(o=>o!==t)};let n=e.hidden_labels.filter(o=>o!==t);return e.hidden_prefixes.some(o=>o.length>0&&t.startsWith(o))?{hidden_labels:n,visible_labels:e.visible_labels.includes(t)?e.visible_labels:[...e.visible_labels,t]}:{hidden_labels:n}}function $o(t,e){let{policyStore:r,transport:n,labelOptions:s}=e,o=document.createElement("dialog");o.id="display-settings-dialog",o.className="display-settings",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);let i="";async function l(x){let $=r.get();if($)try{let f=await n("display-policy-set",{expected_revision:$.revision,policy:x($)});a(f),f&&f.conflict&&f.policy&&(f=await n("display-policy-set",{expected_revision:f.policy.revision,policy:x(f.policy)}),a(f)),f&&f.conflict&&Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function a(x){x&&x.policy&&typeof x.policy=="object"&&r.set(x.policy)}function c(x){let $=r.get();if(!$)return;let f=vo(x,$)!=="shown";l(M=>dl(x,M,f))}function p(){let x=i.trim();x.length!==0&&(i="",l($=>$.hidden_prefixes.includes(x)?{hidden_prefixes:$.hidden_prefixes}:{hidden_prefixes:[...$.hidden_prefixes,x]}),B())}function m(x){l($=>({hidden_prefixes:$.hidden_prefixes.filter(f=>f!==x)}))}function b(x){let $=r.get();if(!$)return;let f=$.chips[x]===!1;l(()=>({chips:{[x]:f}}))}function v(x){let $=s();return d`
  ...
  `,t.appendChild(r);let n=r.querySelector("#new-issue-form"),s=r.querySelector("#new-title"),o=r.querySelector("#new-type"),i=r.querySelector("#new-priority"),l=r.querySelector("#new-labels"),a=r.querySelector("#new-description"),c=r.querySelector("#new-issue-error"),p=r.querySelector("#btn-cancel"),m=r.querySelector("#btn-create"),b=r.querySelector(".new-issue__close");function v(){o.replaceChildren();let S=document.createElement("option");S.value="",S.textContent="\u2014 Select \u2014",o.appendChild(S);for(let x of To){let $=document.createElement("option");$.value=x,$.textContent=Ao(x),o.appendChild($)}i.replaceChildren();for(let x=0;x<=4;x+=1){let $=document.createElement("option");$.value=String(x);let f=Eo[x]||"Medium";$.textContent=`${x} \u2013 ${f}`,i.appendChild($)}}v();function k(){try{typeof r.close=="function"?r.close():r.removeAttribute("open")}catch{r.removeAttribute("open")}}function R(S){s.disabled=S,o.disabled=S,i.disabled=S,l.disabled=S,a.disabled=S,p.disabled=S,m.disabled=S,m.textContent=S?"Creating\u2026":"Create"}function B(){c.textContent=""}function z(S){c.textContent=S}function V(){try{let S=window.localStorage.getItem("beads-ui.new.type");S?o.value=S:o.value="";let x=window.localStorage.getItem("beads-ui.new.priority");x&&/^\d$/.test(x)?i.value=x:i.value="2"}catch{o.value="",i.value="2"}}function H(){let S=o.value||"",x=i.value||"";S.length>0&&window.localStorage.setItem("beads-ui.new.type",S),x.length>0&&window.localStorage.setItem("beads-ui.new.priority",x)}async function N(){B();let S=String(s.value||"").trim();if(S.length===0){z("Title is required"),s.focus();return}let x=Number(i.value||"2");if(!(x>=0&&x<=4)){z("Priority must be 0..4"),i.focus();return}let $=String(o.value||""),f=String(a.value||""),M={title:S};$.length>0&&(M.type=$),String(x).length>0&&(M.priority=x),f.length>0&&(M.description=f),R(!0);try{await e("create-issue",M)}catch{R(!1),z("Failed to create issue");return}H(),R(!1),k()}return r.addEventListener("cancel",S=>{S.preventDefault(),k()}),b.addEventListener("click",()=>k()),p.addEventListener("click",()=>k()),r.addEventListener("keydown",S=>{S.key==="Enter"&&(S.ctrlKey||S.metaKey)&&(S.preventDefault(),N())}),n.addEventListener("submit",S=>{S.preventDefault(),N()}),{open(){n.reset(),B(),V();try{"showModal"in r&&typeof r.showModal=="function"?r.showModal():r.setAttribute("open","")}catch{r.setAttribute("open","")}setTimeout(()=>{try{s.focus()}catch{}},0)},close(){k()}}}function Ro(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"";if(t<6e4)return`${Math.round(t/1e3)}\uCD08`;let e=t/6e4;return`${Number.isInteger(e)?e:Math.round(e*10)/10}\uBD84`}function Io(t){return Array.isArray(t)?t.filter(e=>typeof e=="string").join(" "):""}var ul={deployed:{modifier:"ok",label:"\uC131\uACF5"},launched:{modifier:"launched",label:"\uBC1C\uC0AC\uB428"},failed:{modifier:"fail",label:"\uC2E4\uD328"}},pl=[{key:"orchestration_model",values:()=>sn},{key:"orchestration_effort",values:()=>on},{key:"review_model",values:()=>an},{key:"impl_model",values:()=>ln}];function Lo(t,e){let{queueStore:r,transport:n,getWorkspacePath:s}=e,o=document.createElement("dialog");o.id="worker-exec-defaults-dialog",o.className="exec-defaults",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),t.appendChild(o);function i(){return r&&r.get()||{revision:0,exec_defaults:{}}}function l(){let f=i();return typeof f.revision=="number"?f.revision:0}function a(){let f=i().exec_defaults;return f&&typeof f=="object"?f:{}}function c(f){f&&f.queue&&r&&r.set(f.queue)}async function p(f,M){if(!n)return;let F={key:f,value:M||null};try{let P=await n("worker-queue-set-exec-default",{...F,expected_revision:l()});c(P),P&&P.conflict&&(P=await n("worker-queue-set-exec-default",{...F,expected_revision:l()}),c(P)),P&&P.conflict&&Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC","error",4e3)}catch{Q("\uC804\uC5ED \uC2E4\uD589 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328","error",4e3)}}function m(f,M,F){let P=!!F&&!M.includes(F);return d`<div class="exec-defaults__row">
      ...
      >
        ...
        ${P?d`<option value=${F} ?selected=${!0}>
              ${F} (비호환)
            </option>`:""}
        ${M.map(q=>d`<option value=${q} ?selected=${F===q}>${q}</option>`)}
      </select>
      ...
      >${M}</span
    >`}function k(f){let M=f?Io(f.cmd):"",F=f?Ro(f.timeout_ms):"",P=!!f&&f.source==="detected";return d`<div class="exec-defaults__vd-group" data-vd="verify">
    ...
    </div>`}function R(f){let M=f?Io(f.cmd):"",F=f?Ro(f.timeout_ms):"",P=F?`timeout ${F} \xB7 verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589`:"verify \uD1B5\uACFC \uC2DC\uC5D0\uB9CC \uC2E4\uD589",q=s&&s()||"<workspace \uACBD\uB85C>";return d`<div class="exec-defaults__vd-group" data-vd="deploy">
    ...
    </div>`}function B(f){if(!f||typeof f!="object")return"";let M=ul[String(f.outcome)];if(!M)return"";let F=f.outcome==="failed"&&f.reason?`${M.label} \xB7 ${f.reason}`:M.label,P=[gt(f.at),typeof f.bead_id=="string"?f.bead_id:"",typeof f.base_sha=="string"?f.base_sha.slice(0,7):""].filter(q=>q.length>0).join(" \xB7 ");return d`<div class="exec-defaults__vd-group" data-vd="last-deploy">
      <div class="exec-defaults__vd-label">마지막 배포</div>
      <div class="exec-defaults__vd-line">
        ${v(M.modifier,F)}
        ${P?d`<span class="exec-defaults__vd-meta">${P}</span>`:""}
      </div>
    </div>`}function z(f){return d`<section class="exec-defaults__vd">
      ...
      ${k(f.verify_cmd)} ${R(f.deploy_cmd)}
      ${B(f.last_deploy)}
    </section>`}function V(){let f=a();ce(d`
  ...
  </div>`}function wl(t,e,r=null){let n=!!t.paused,s=n?"\uC77C\uC2DC\uC815\uC9C0":typeof t.started_at=="number"?yl(e-t.started_at):"\u2014",o=[t.runner,t.model].filter(Boolean).join(" \xB7 "),i=Dr(t.usage),l=t.attempt_id&&t.attempt_id===r;return d`<div
  ...
  >
  ...
  </div>`}var kl="tab:worker:ready",vl="tab:worker:blocked",Mr=1;function On(t){let e=t&&t.metadata;return!!(e&&typeof e=="object"&&e.spec_id)}var Po="beads-ui.worker.candidate-filter",Ln={show_blocked:!1,spec:"all"};function $l(){try{let t=window.localStorage.getItem(Po);if(!t)return{...Ln};let e=JSON.parse(t);if(!e||typeof e!="object")return{...Ln};let r=e.spec;return{show_blocked:e.show_blocked===!0,spec:r==="with"||r==="without"?r:"all"}}catch{return{...Ln}}}function xl(t){try{window.localStorage.setItem(Po,JSON.stringify(t))}catch{}}function Sl(t,e){let r=l=>e.show_blocked||!l.blocked,n=l=>e.spec==="all"||(e.spec==="with"?l.has_spec:!l.has_spec),s=[],o=0,i=0;for(let l of t){let a=r(l),c=n(l);a&&c?s.push(l):!a&&c?o+=1:a&&!c&&(i+=1)}return{visible:s,hidden_blocked:o,hidden_spec:i}}var Tl=[{value:"all",label:"\uC804\uCCB4"},{value:"with",label:"spec \uC788\uC74C"},{value:"without",label:"spec \uC5C6\uC74C"}],Fo="bdui.worker.candidate_sort",Al=[{value:"spec",label:"spec \uC6B0\uC120"},{value:"board",label:"Board \uC21C\uC11C"},{value:"created",label:"\uCD5C\uC2E0 \uC0DD\uC131\uC21C"}],Nr="spec";function El(){try{let t=window.localStorage.getItem(Fo);return t==="board"||t==="created"||t==="spec"?t:Nr}catch{return Nr}}function Cl(t){try{window.localStorage.setItem(Fo,t)}catch{}}function Rl(t,e,r){let n=Array.isArray(t)?t.slice():[];return e==="created"?n.sort(Tt):(n.sort(hr(r)),e==="board"?n:[...n.filter(On),...n.filter(s=>!On(s))])}function Il(t){let e=t&&t.parent;return(typeof e=="string"?e.length>0:!!(e&&e.id))||/\.\d+$/.test(t&&t.id||"")}function Ll(t){let r=(Array.isArray(t?.dependencies)?t.dependencies:[]).map(n=>typeof n=="string"?n:n&&n.id).filter(Boolean);return r.length>0?`\u{1F512} ${r.join(", ")}`:"\u{1F512} blocked"}var Dl=["closed_unmerged","undecidable"],Ol=[{from:"\uAD00\uCE21 \uB300\uAE30",activity:"checking",to:"\uD655\uC778\uC911"},{from:"\uB85C\uCEEC\uAC80\uC99D \uB300\uAE30",activity:"verifying",to:"\uB85C\uCEEC\uAC80\uC99D \uC2E4\uD589 \uC911"}];function Ml(t,e){for(let r of Ol)if(t===r.from&&e===r.activity)return{label:r.to,live:!0};return{label:t,live:!1}}var Dn=[{step:"merging",label:"\uBA38\uC9C0 \uC911"},{step:"base_sync",label:"base \uB3D9\uAE30\uD654"},{step:"post_merge_verify",label:"\uBA38\uC9C0 \uD6C4 \uAC80\uC99D"},{step:"deploy",label:"\uBC30\uD3EC"},{step:"child_sweep",label:"\uC790\uC2DD \uC815\uB9AC"},{step:"branch_cleanup",label:"\uBE0C\uB79C\uCE58 \uC815\uB9AC"},{step:"parent_close",label:"\uBD80\uBAA8 close"}];function Nl(t){if(typeof t!="string"||t.length===0)return null;let e=Dn.length,r=Dn.findIndex(n=>n.step===t);return r<0?{label:t,index:0,total:e,percent:0}:{label:Dn[r].label,index:r+1,total:e,percent:Math.round((r+1)/e*100)}}function Pl(t,e,r,n,s=null,o=null){let i=r[t]||null,l=i&&i.gate?i.gate:null,a=i&&i.pr?i.pr:null,c=[],p=Ml(l&&l.gate_badge||"",o&&o.activity||null);p.label&&c.push(p.label),l&&l.base_badge&&l.base_badge!==l.gate_badge&&c.push(l.base_badge),n&&c.push("\uC815\uB9AC \uC2E4\uD328");let m=!!l&&l.base_badge==="\uCDA9\uB3CC",b=!!l&&l.enabled===!0,v=Nl(o&&o.merge_progress?o.merge_progress.step:null),k=!!n&&!!l&&l.tier==="merged";return{id:t,title:e,reason:n?"\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uBBF8\uC644":"PR \uB300\uAE30",draggable:!1,done:!0,lane:"pr_wait",pr_number:a&&typeof a.number=="number"?a.number:null,pr_url:a&&typeof a.url=="string"?a.url:"",badges:c,live_badge:p.live?p.label:null,usage:s,alert:!!l&&Dl.includes(l.tier)||!!n,merge_action:!0,discard_action:!n&&!(l&&l.tier==="merged"),merge_step:v,discard_enabled:!v,merge_enabled:!v&&(b||m||k),merge_title:v?`\uBA38\uC9C0 \uC9C4\uD589 \uC911 \u2014 ${v.label}`:k?"\uBA38\uC9C0 \uC644\uB8CC \u2014 \uD074\uB9AD\uD558\uBA74 \uB0A8\uC740 \uC815\uB9AC\uB97C \uCC98\uC74C\uBD80\uD130 \uB2E4\uC2DC \uC218\uD589\uD569\uB2C8\uB2E4":m?"\uCDA9\uB3CC \u2014 \uD074\uB9AD\uD558\uBA74 \uCDA9\uB3CC \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4 (\uBA38\uC9C0\uD558\uC9C0 \uC54A\uC74C)":b?`\uBA38\uC9C0 (${l.gate_badge}) \u2014 \uD074\uB9AD \uC2DC\uC810\uC5D0 \uB2E4\uC2DC \uD655\uC778\uD569\uB2C8\uB2E4`:l&&l.tier==="merged"?"\uBA38\uC9C0\uB428 \u2014 \uBA38\uC9C0 \uD6C4 \uC815\uB9AC \uC9C4\uD589 \uC911":`\uBA38\uC9C0 \uBD88\uAC00: ${l&&l.reason||"\uAD00\uCE21 \uB300\uAE30"}`}}function Mn(t,e={}){let{transport:r,issueStores:n,queueStore:s,sessionLogStore:o,uiOrderStore:i,gotoIssue:l,getWorkspacePath:a}=e,c=n?gr(n,i):null,p=_r({transport:r,uiOrderStore:i}),m=null,b=[],v=$l(),k=El(),R=new Set,B=[],z=document.createElement("div");z.className="worker-console";let V=document.createElement("div"),H=document.createElement("div");H.className="worker-drawer-overlay",H.hidden=!0;let N=document.createElement("div");N.className="worker-drawer-overlay__backdrop";let S=document.createElement("div");S.className="worker-drawer-host",H.append(N,S);let x=document.createElement("div");x.className="worker-lanes-host",z.append(V,H,x),t.appendChild(z);let $=null,f=wr(S,{transport:r,sessionLogStore:o,onClose:()=>{$=null,H.hidden=!0,de()}}),M=Lo(z,{queueStore:s,transport:r,getWorkspacePath:a});function F(){return s&&s.get()||{revision:0,auto_advance:!1,slots:Mr,queue:[],pr_wait:[],done:[]}}function P(){let y=F();return typeof y.revision=="number"?y.revision:0}function q(y){y&&y.queue&&s&&s.set(y.queue)}async function Ce(y,w){if(!r)return;let U=await r("worker-queue-place",{bead_id:y,index:w,expected_revision:P()});q(U),U&&U.conflict&&await r("worker-queue-place",{bead_id:y,index:w,expected_revision:P()}).then(q)}async function Ne(y,w){if(!r)return;let U=await r("worker-queue-reorder",{bead_id:y,to_index:w,expected_revision:P()});q(U),U&&U.conflict&&await r("worker-queue-reorder",{bead_id:y,to_index:w,expected_revision:P()}).then(q)}async function Se(y){if(!r)return;let w=await r("worker-queue-remove",{bead_id:y,expected_revision:P()});q(w),w&&w.conflict&&await r("worker-queue-remove",{bead_id:y,expected_revision:P()}).then(q)}async function Je(y){!r||!y||await r("worker-attempt-stop",{attempt_id:y})}async function ze(y){if(!r||!y)return;let w=await r("worker-attempt-pause",{attempt_id:y});w&&w.paused===!1&&w.reason&&Q(`\uC77C\uC2DC\uC815\uC9C0 \uAC70\uBD80: ${w.reason}`,"error",2400)}async function _e(y){if(!r||!y)return;let w=await r("worker-attempt-resume",{attempt_id:y,expected_revision:P()});q(w),w&&w.conflict&&(w=await r("worker-attempt-resume",{attempt_id:y,expected_revision:P()}),q(w)),w&&w.resumed===!1&&!w.conflict&&w.reason&&Q(`\uC774\uC5B4\uD558\uAE30 \uAC70\uBD80: ${w.reason}`,"error",2400)}async function $e(y){if(!r||!y)return;let w=await r("worker-attempt-dismiss",{attempt_id:y,expected_revision:P()});q(w),w&&w.conflict&&(w=await r("worker-attempt-dismiss",{attempt_id:y,expected_revision:P()}),q(w)),w&&w.dismissed===!1&&!w.conflict&&w.reason&&Q(`\uBC30\uB108 \uB2EB\uAE30 \uAC70\uBD80: ${w.reason}`,"error",2400)}async function Ve(y){if(!r||!y)return;R.add(y),de();let w;try{w=await r("worker-pr-merge",{bead_id:y,expected_revision:P()}),q(w),w&&w.conflict&&(w=await r("worker-pr-merge",{bead_id:y,expected_revision:P()}),q(w))}finally{R.delete(y),de()}if(!(!w||w.conflict)){if(w.action==="conflict_resolution"){Q(w.ok?"\uCDA9\uB3CC \u2014 \uD574\uC18C \uC138\uC158\uC744 \uB744\uC6E0\uC2B5\uB2C8\uB2E4 (\uBA38\uC9C0\uD558\uC9C0 \uC54A\uC74C)":`\uCDA9\uB3CC \uD574\uC18C \uB514\uC2A4\uD328\uCE58 \uC2E4\uD328: ${w.reason||""}`,w.ok?"success":"error",2800);return}if(w.ok){Q("\uBA38\uC9C0 + \uC815\uB9AC \uC644\uB8CC","success",2e3);return}Q(w.cleanup_step?`\uBA38\uC9C0\uB428 \xB7 \uC815\uB9AC \uC2E4\uD328(${w.cleanup_step}): ${w.reason||""}`:`\uBA38\uC9C0 \uAC70\uBD80: ${w.reason||""}`,"error",3200)}}async function pe(y){if(!r||!y||!(typeof globalThis.confirm!="function"||globalThis.confirm(`${y}: PR\uC744 \uB2EB\uACE0 \uC6CC\uD06C\uD2B8\uB9AC/\uBE0C\uB79C\uCE58\uB97C \uD3D0\uAE30\uD569\uB2C8\uB2E4. \uB418\uB3CC\uB9B4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uB2E4\uC2DC \uC2E4\uD589\uD558\uB824\uBA74 \uD6C4\uBCF4 \uB808\uC778\uC5D0\uC11C \uB300\uAE30 \uB808\uC778\uC73C\uB85C \uC62E\uAE30\uC138\uC694. \uACC4\uC18D\uD560\uAE4C\uC694?`)))return;let U=await r("worker-pr-discard",{bead_id:y,expected_revision:P()});if(q(U),U&&U.conflict&&(U=await r("worker-pr-discard",{bead_id:y,expected_revision:P()}),q(U)),U&&U.discarded===!0){Q("\uD3D0\uAE30 \uC644\uB8CC \u2014 \uD6C4\uBCF4 \uB808\uC778\uC5D0\uC11C \uB2E4\uC2DC \uC2E4\uD589\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4","success",2400);return}U&&U.discarded===!1&&!U.conflict&&Q(`\uD3D0\uAE30 \uAC70\uBD80: ${U.reason||""}`,"error",2800)}async function at(y){if(!r)return;let w=await r("worker-queue-toggle",{on:y,expected_revision:P()});q(w),w&&w.conflict&&await r("worker-queue-toggle",{on:y,expected_revision:P()}).then(q)}async function fe(y){if(!r||!Number.isFinite(y))return;let w=Math.max(Mr,Math.floor(y)),U=await r("worker-queue-set-slots",{slots:w,expected_revision:P()});q(U),U&&U.conflict&&await r("worker-queue-set-slots",{slots:w,expected_revision:P()}).then(q)}function Ke(){let y=F(),w=c?c.selectBoardColumn(kl,"ready"):[],U=c?c.selectBoardColumn(vl,"blocked"):[],ee=new Map;for(let O of[...w,...U])ee.set(O.id,O.title||O.id);let se=y.pr_wait||[],T=y.pr_observations||{},E=y.pr_activity||{},j=y.cleanup_failed||{},W=Object.entries(j).map(([O,re])=>({bead_id:O,step:re&&re.step?re.step:"",reason:re&&re.reason?re.reason:"",detail:re&&typeof re.detail=="string"?re.detail:null,output_tail:re&&typeof re.output_tail=="string"&&re.output_tail?re.output_tail:void 0})),L=y.queue||[],g=new Set([...L.map(O=>O.bead_id),...se.map(O=>O.bead_id),...y.done.map(O=>O.bead_id)]),C=new Set(U.map(O=>O.id)),A=i?i.get()?.order||{}:{},I=new Set,J=[];for(let O of[...w,...U])g.has(O.id)||I.has(O.id)||Il(O)||(I.add(O.id),J.push(O));b=Rl(J,k,A);let le=y.admission||{},Y=O=>{let re=le[O];if(!re)return"";if(re.stale===!0)return"\u267B\uFE0F stale\u2192\uC7AC\uB9AC\uBDF0";let me=typeof re.reason=="string"?re.reason:"",Qe=me.indexOf(":");return Qe>0&&Qe<me.length-1?`\u26D4 ${me.slice(0,Qe)} (${me.slice(Qe+1)})`:`\u26D4 ${me}`},xe=b.map(O=>{let re=On(O),me=C.has(O.id),Qe=[];me&&Qe.push(Ll(O)),re||Qe.push("spec \uC5C6\uC74C");let Ht=Y(O.id);return Ht&&Qe.push(Ht),{id:O.id,title:O.title||O.id,reason:Qe.join(" \xB7 "),draggable:re,lane:"candidate",workflow:O.workflow,status:O.status,blocked:me,has_spec:re}}),lt=Sl(xe,v),ht=lt.visible,It=(O,re)=>O.map(me=>({id:me.bead_id,title:ee.get(me.bead_id)||me.bead_id,reason:re==="done"?"":Y(me.bead_id),draggable:re!=="done",done:re==="done",lane:re,usage:re==="done"?In(y.attempts||{},me.bead_id):null})),Xe=y.attempts?Object.values(y.attempts):[],ct=new Set;for(let O of Xe)O&&typeof O.resumed_from=="string"&&O.resumed_from.length>0&&ct.add(O.resumed_from);let yt=new Map;for(let O of Xe)yt.set(O.bead_id,O.attempt_id);let h=[],_=null;for(let O of Xe){let re=O.status==="paused"&&!ct.has(O.attempt_id);O.status==="running"||re?h.push({bead_id:O.bead_id,attempt_id:O.attempt_id,title:ee.get(O.bead_id)||O.bead_id,runner:O.runner||null,model:O.model||null,effort:O.effort||null,started_at:typeof O.started_at=="number"?O.started_at:null,resumed_from:O.resumed_from||null,paused:re,can_pause:typeof O.session_id=="string"&&O.session_id.length>0,usage:O.usage||null}):(O.status==="failed"||O.status==="orphaned")&&!(yt.get(O.bead_id)!==O.attempt_id)&&typeof O.dismissed_at!="number"&&(_=O)}let Z=null;if(_){let O=typeof _.session_id=="string"&&_.session_id.length>0,re=ct.has(_.attempt_id),me=_.cause_detail;Z={repo:_.repo||"",reason:_.cause||_.status,cause_detail:me&&typeof me.reason=="string"?{reason:me.reason,command:typeof me.command=="string"?me.command:null}:null,resume_attempt_id:_.attempt_id,resume_eligible:O&&!re,resume_reason:O?re?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}}let K=new Set(h.map(O=>O.bead_id)),he=h.filter(O=>!O.paused).length,wt=(y.workspace_info||{}).slots,cr=typeof wt=="number"?wt:typeof y.slots=="number"?y.slots:Mr,tt=he>cr;return{queue:y,idToTitle:ee,candidates:ht,candidate_hidden:{blocked:lt.hidden_blocked,spec:lt.hidden_spec},running:h,live_count:he,slots:cr,over_cap:tt,failure:Z,waiting:It(L.filter(O=>!K.has(O.bead_id)),"queue"),pr_wait:se.map(O=>Pl(O.bead_id,ee.get(O.bead_id)||O.bead_id,T,j[O.bead_id]||null,In(y.attempts||{},O.bead_id),E[O.bead_id]||(R.has(O.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null))),done:It(y.done,"done"),cleanup_failures:W}}function ie(y){let w=y.waiting.length>0?y.waiting[0].id:"\u2014";return d`<div class="worker-ctrl">
        <button
          type="button"
    ...
    </div>`}function de(){let y=Ke();ce(ie(y),V),ce(Te(y),x)}function be(y){let w=y.target?.closest?.('.worker-mini[draggable="true"], .worker-card[draggable="true"]');if(!w)return;let U=w.dataset.beadId||"",ee=w.dataset.lane||"";m={bead_id:U,from_lane:ee};try{y.dataTransfer?.setData("text/plain",U),y.dataTransfer&&(y.dataTransfer.effectAllowed="move")}catch{}}function Le(y){let w=y.target?.closest?.(".worker-pane");if(!w)return;let U=w.dataset.lane||"";U!=="candidate"&&U!=="queue"||(y.preventDefault(),y.dataTransfer&&(y.dataTransfer.dropEffect="move"),w.classList.add("worker-pane--drag-over"))}function He(y){y.target?.closest?.(".worker-pane")?.classList.remove("worker-pane--drag-over")}function Re(y,w){let U=b.find(E=>E.id===y);if(!U)return;let ee=b.filter(E=>E.id!==y),se=ee.length;if(w){let E=w.dataset.beadId;if(E===y)return;let j=ee.findIndex(W=>W.id===E);j>=0&&(se=j)}let T=ee.slice();T.splice(se,0,U),p.applyReorder(y,T,se)}function De(y){let w=y.target?.closest?.(".worker-pane");if(!w)return;y.preventDefault(),w.classList.remove("worker-pane--drag-over");let U=w.dataset.lane||"",ee=m?.bead_id||y.dataTransfer?.getData("text/plain")||"",se=m?.from_lane||"";if(m=null,!ee)return;let T=y.target?.closest?.(".worker-mini, .worker-card"),E=Array.from(w.querySelectorAll(".worker-mini, .worker-card")),j=E.length;if(T){let W=E.indexOf(T);W>=0&&(j=W)}if(U==="candidate"){if(se==="candidate"){Re(ee,T);return}se==="queue"&&Se(ee);return}U==="queue"&&(se==="queue"?Ne(ee,j):Ce(ee,j))}function Ae(y){v=y,xl(y),de()}function We(y){k=y==="board"||y==="created"||y==="spec"?y:Nr,Cl(k),de()}function ye(y){let w=y.target?.closest?.(".worker-filter__blocked");if(w){Ae({...v,show_blocked:w.checked});return}let U=y.target?.closest?.(".worker-sort");if(U){We(U.value||Nr);return}let ee=y.target?.closest?.(".worker-slots__input");if(!ee)return;let se=Number.parseInt(ee.value,10);if(!Number.isFinite(se)){de();return}fe(se).then(de)}function Ee(y){return y?{runner:y.runner||void 0,model:y.model||void 0,effort:y.effort||void 0,worktree:y.worktree||void 0,status:y.status||void 0,session_id:y.session_id||void 0}:{}}function Ge(y){let w=F(),U=w.attempts?w.attempts[y]:null;$=y,H.hidden=!1,f.open({attempt_id:y,meta:Ee(U)}),de()}function Oe(){if(!$)return;let y=F(),w=y.attempts?y.attempts[$]:null;if(w){f.updateMeta(Ee(w));return}f.close()}function Ze(y){let w=y.target;if(w?.closest?.("#worker-exec-defaults-dialog"))return;if(w?.closest?.(".worker-exec-defaults-btn")){M.open();return}let U=w?.closest?.(".worker-banner__resume");if(U){let L=U.dataset.attemptId;L&&_e(L);return}let ee=w?.closest?.(".worker-banner__dismiss");if(ee){let L=ee.dataset.attemptId;L&&$e(L);return}if(w?.closest?.(".worker-play")){at(!F().auto_advance);return}let se=w?.closest?.(".worker-filter__chip");if(se){let L=se.dataset.spec;(L==="all"||L==="with"||L==="without")&&Ae({...v,spec:L});return}let T=w?.closest?.(".worker-mini__merge");if(T){Ve(T.dataset.beadId||"");return}let E=w?.closest?.(".worker-mini__discard");if(E){pe(E.dataset.beadId||"");return}if(w?.closest?.(".worker-mini__pr"))return;if(w?.closest?.(".rtile__stop")){let g=w?.closest?.(".rtile")?.dataset?.attemptId;g&&Je(g);return}if(w?.closest?.(".rtile__pause")){let g=w?.closest?.(".rtile")?.dataset?.attemptId;g&&ze(g);return}if(w?.closest?.(".rtile__resume")){let g=w?.closest?.(".rtile")?.dataset?.attemptId;g&&_e(g);return}if(w?.closest?.(".rtile__info")){let g=w?.closest?.(".rtile")?.dataset?.beadId;g&&l&&l(g);return}if(w?.closest?.(".worker-drawer-overlay__backdrop")){f.close();return}if(w?.closest?.(".worker-drawer-host"))return;let j=w?.closest?.(".rtile");if(j){let L=j.dataset.attemptId;L&&Ge(L);return}let W=w?.closest?.(".worker-mini, .worker-card");if(W){let L=W.dataset.beadId;if(w?.closest?.(".worker-mini__id, .worker-card__id")){L&&qt(L).then(g=>{g?Q("\uBCF5\uC0AC\uB428","success",1200):Q("\uBCF5\uC0AC \uC2E4\uD328","error",1600)});return}L&&l&&l(L)}}return t.addEventListener("dragstart",be),t.addEventListener("dragover",Le),t.addEventListener("dragleave",He),t.addEventListener("drop",De),t.addEventListener("click",Ze),t.addEventListener("change",ye),c&&B.push(c.subscribe(de)),s&&B.push(s.subscribe(()=>{de(),Oe()})),de(),{load(){de()},destroy(){for(let y of B.splice(0))try{y()}catch{}t.removeEventListener("dragstart",be),t.removeEventListener("dragover",Le),t.removeEventListener("dragleave",He),t.removeEventListener("drop",De),t.removeEventListener("click",Ze),t.removeEventListener("change",ye);try{f.destroy()}catch{}H.hidden=!0;try{M.destroy()}catch{}ce(d``,t)}}}function Nn(t){if(!t)return"Unknown";let e=t.split("/").filter(Boolean);return e.length>0?e[e.length-1]:"Unknown"}function Bo(t,e,r,n=async()=>{},s=async()=>{}){let o=we("views:workspace-picker"),i=null,l=!1,a=!1,c=!1;async function p(x){let f=x.target.value,F=e.getState().workspace?.current?.path||"";if(f&&f!==F){o("switching workspace to %s",f),l=!0,S();try{await r(f)}catch(P){o("workspace switch failed: %o",P)}finally{l=!1,S()}}}async function m(){let x=e.getState(),$=x.workspace?.current?.path||x.workspace?.available?.[0]?.path||"";if(!(!$||a)){o("git-pulling workspace %s",$),a=!0,S();try{await n($)}catch(f){o("workspace git pull failed: %o",f)}finally{a=!1,S()}}}function b(x){let $=x.target;$&&t.contains($)||R()}function v(x){x.key==="Escape"&&R()}function k(){c||(c=!0,document.addEventListener("mousedown",b),document.addEventListener("keydown",v),S())}function R(){c&&(c=!1,document.removeEventListener("mousedown",b),document.removeEventListener("keydown",v),S())}function B(){c?R():k()}async function z(x){let $=x.target,f=$.value,M=$.checked;o("toggling visibility %s \u2192 %s",f,String(M));try{await s(f,M)}catch(F){o("workspace visibility toggle failed: %o",F)}}function V(x){return x?d`
      <button
        type="button"
    ...
    `}function N(){let x=e.getState(),$=x.workspace?.current,f=x.workspace?.available||[],M=new Set(x.workspace?.hidden||[]),F=$?.path||f[0]?.path||"";if(f.length===0)return d``;let P=f.filter(q=>!M.has(q.path)||q.path===F);if(P.length<=1){let q=P[0]||f[0],Ce=Nn(q.path);return d`
    ...
    `}function S(){ce(N(),t)}return S(),i=e.subscribe(()=>S()),{destroy(){i&&(i(),i=null),document.removeEventListener("mousedown",b),document.removeEventListener("keydown",v),ce(d``,t)}}}var qo=["update-status","edit-text","update-priority","create-issue","dep-add","dep-remove","update-assignee","update-exec-settings","update-workflow-meta","label-add","label-remove","subscribe-list","unsubscribe-list","snapshot","upsert","delete","get-comments","add-comment","delete-issue","list-workspaces","set-workspace","set-workspace-visibility","get-workspace","workspace-changed","git-pull-workspace","subscribe-worker-queue","unsubscribe-worker-queue","worker-queue-snapshot","worker-queue-place","worker-queue-reorder","worker-queue-toggle","worker-queue-set-slots","worker-queue-set-exec-default","worker-queue-remove","worker-attempt-pause","worker-attempt-stop","worker-attempt-resume","worker-attempt-dismiss","worker-pr-merge","worker-pr-discard","subscribe-ui-order","unsubscribe-ui-order","ui-order-set","ui-order-snapshot","subscribe-display-policy","unsubscribe-display-policy","display-policy-set","display-policy-snapshot","subscribe-session-log","unsubscribe-session-log","session-log-snapshot","session-log-append"];function Pn(){let t=Date.now().toString(36),e=Math.random().toString(36).slice(2,8);return`${t}-${e}`}function Uo(t,e,r=Pn()){return{id:r,type:t,payload:e}}function zo(t={}){let e=we("ws"),r={initialMs:t.backoff?.initialMs??1e3,maxMs:t.backoff?.maxMs??3e4,factor:t.backoff?.factor??2,jitterRatio:t.backoff?.jitterRatio??.2},n=()=>t.url&&t.url.length>0?t.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",s=null,o="closed",i=0,l=null,a=!0,c=new Map,p=[],m=new Map,b=new Set;function v(N){for(let S of Array.from(b))try{S(N)}catch{}}function k(){if(!a||l)return;o="reconnecting",e("ws reconnecting\u2026"),v(o);let N=Math.min(r.maxMs||0,(r.initialMs||0)*Math.pow(r.factor||1,i)),S=(r.jitterRatio||0)*N,x=Math.max(0,Math.round(N+(Math.random()*2-1)*S));e("ws retry in %d ms (attempt %d)",x,i+1),l=setTimeout(()=>{l=null,H()},x)}function R(N){try{s?.send(JSON.stringify(N))}catch(S){e("ws send failed",S)}}function B(){for(o="open",e("ws open"),v(o),i=0;p.length;){let N=p.shift();N&&R(N)}}function z(N){let S;try{S=JSON.parse(String(N.data))}catch{e("ws received non-JSON message");return}if(!S||typeof S.id!="string"||typeof S.type!="string"){e("ws received invalid envelope");return}if(c.has(S.id)){let $=c.get(S.id);c.delete(S.id),S.ok?$?.resolve(S.payload):$?.reject(S.error||new Error("ws error"));return}let x=m.get(S.type);if(x&&x.size>0)for(let $ of Array.from(x))try{$(S.payload)}catch(f){e("ws event handler error",f)}else e("ws received unhandled message type: %s",S.type)}function V(){o="closed",e("ws closed"),v(o);for(let[N,S]of c.entries())S.reject(new Error("ws disconnected")),c.delete(N);i+=1,k()}function H(){if(!a)return;let N=n();try{s=new WebSocket(N),e("ws connecting %s",N),o="connecting",v(o),s.addEventListener("open",B),s.addEventListener("message",z),s.addEventListener("error",()=>{}),s.addEventListener("close",V)}catch(S){e("ws connect failed %o",S),k()}}return H(),{send(N,S){if(!qo.includes(N))return Promise.reject(new Error(`unknown message type: ${N}`));let x=Pn(),$=Uo(N,S,x);return e("send %s id=%s",N,x),new Promise((f,M)=>{c.set(x,{resolve:f,reject:M,type:N}),s&&s.readyState===s.OPEN?R($):(e("queue %s id=%s (state=%s)",N,x,o),p.push($))})},on(N,S){m.has(N)||m.set(N,new Set);let x=m.get(N);return x?.add(S),()=>{x?.delete(S)}},onConnection(N){return b.add(N),()=>{b.delete(N)}},reconnect(){a=!0,l&&(clearTimeout(l),l=null),i=0,H()},close(){a=!1,l&&(clearTimeout(l),l=null);try{s?.close()}catch{}},getState(){return o}}}function Fl(){let t=window.__BDUI_BOOTSTRAP__;return{workspace_config:{default_workspace:typeof t?.workspace_config?.default_workspace=="string"&&t.workspace_config.default_workspace.length>0?t.workspace_config.default_workspace:null}}}async function Bl(t,e){try{let n=await(await fetch("/api/config")).json();t.setState({config:n})}catch(r){e("config refresh failed",r)}}var Fn=[["tab:board:ready","ready-issues"],["tab:board:blocked","blocked-issues"],["tab:board:in-progress","in-progress-issues"],["tab:board:resolved","resolved-issues"],["tab:board:deferred","deferred-issues"],["tab:board:closed","closed-issues"]],Ho=[["tab:worker:ready","ready-issues"],["tab:worker:blocked","blocked-issues"]],Wo="worker:queue",Go="ui:order",jo="ui:display-policy",bt="tab:board:closed",Yo="beads-ui.board.closed-range";function ql(t){let e=we("main");e("bootstrap start");let r=d`
    <section id="board-root" class="route board"></section>
    <section id="worker-root" class="route worker" hidden></section>
    <section id="detail-panel" class="route detail" hidden></section>
  `;ce(r,t);let n=document.getElementById("top-nav"),s=document.getElementById("board-root"),o=document.getElementById("worker-root"),i=document.getElementById("detail-panel");if(s&&o&&i){let f=function(h,_){let Z="Request failed",K="";if(h&&typeof h=="object"){let he=h;if(typeof he.message=="string"&&he.message.length>0&&(Z=he.message),typeof he.details=="string")K=he.details;else if(he.details&&typeof he.details=="object")try{K=JSON.stringify(he.details,null,2)}catch{K=""}}else typeof h=="string"&&h.length>0&&(Z=h);let te=_&&_.length>0?`Failed to load ${_}`:"Request failed";$.open(te,Z,K)},ie=function(h){return`${I.getState().workspace.current?.path||""}\0${h}`},Pe=function(){ze&&(ze().catch(()=>{}),ze=null),_e=null,$e=null},Te=function(h){Ve=h;let _=()=>{Ve!==h||I.getState().selected_id!==h||(Ve=null,et(h))};if(!fe){at.then(_);return}_()},He=function(){let h=rs(Le);return h===void 0?{type:"closed-issues"}:{type:"closed-issues",params:{since:h}}},Re=function(h){if(h)for(let[_,Z]of Fn){if(de.has(_)||be.has(_))continue;let K=_===bt?He():{type:Z};try{q.register(_,K)}catch(te){e("register %s store failed: %o",_,te)}be.add(_),P.subscribeList(_,K).then(te=>{de.set(_,te)}).catch(te=>{e("subscribe %s failed: %o",_,te),f(te,"board")}).finally(()=>{be.delete(_)})}else Ae()},Ae=function(){for(let[h]of Fn){let _=de.get(h);_&&(_().catch(()=>{}),de.delete(h));try{q.unregister(h)}catch(Z){e("unregister %s failed: %o",h,Z)}}},Ee=function(h){if(!h){Ge();return}for(let[_,Z]of Ho)if(!(We.has(_)||be.has(_))){try{q.register(_,{type:Z})}catch(K){e("register %s store failed: %o",_,K)}be.add(_),P.subscribeList(_,{type:Z}).then(K=>{We.set(_,K)}).catch(K=>{e("subscribe %s failed: %o",_,K),f(K,"worker")}).finally(()=>{be.delete(_)})}ye||(F("subscribe-worker-queue",{id:Wo}).catch(_=>{e("subscribe-worker-queue failed: %o",_)}),ye=()=>F("unsubscribe-worker-queue",{id:Wo}))},Ge=function(){for(let[h]of Ho){let _=We.get(h);_&&(_().catch(()=>{}),We.delete(h));try{q.unregister(h)}catch(Z){e("unregister %s failed: %o",h,Z)}}ye&&(ye().catch(()=>{}),ye=null)},Ze=function(){Oe||(F("subscribe-ui-order",{id:Go}).catch(h=>{e("subscribe-ui-order failed: %o",h)}),Oe=()=>F("unsubscribe-ui-order",{id:Go}))},y=function(){Oe&&(Oe().catch(()=>{}),Oe=null),Ne.clear()},U=function(){w||(F("subscribe-display-policy",{id:jo}).catch(h=>{e("subscribe-display-policy failed: %o",h)}),w=()=>F("unsubscribe-display-policy",{id:jo}))},ee=function(){w&&(w().catch(()=>{}),w=null),Se.clear()},L=function(h){if(!h)return"Unknown";let _=h.split("/").filter(Boolean);return _.length>0?_[_.length-1]:"Unknown"};var l=f,a=ie,c=Pe,p=Te,m=He,b=Re,v=Ae,k=Ee,R=Ge,B=Ze,z=y,V=U,H=ee,N=L;let S=document.getElementById("header-loading"),x=Ss(S),$=xo(t),M=zo(),F=x.wrapSend((h,_)=>M.send(h,_)),P=bs(F),q=ys(),Ce=ks(),Ne=ws(),Se=ns(),Je=ss();M.on("ui-order-snapshot",h=>{let _=h;if(_&&typeof _.revision=="number")try{Ne.set({revision:_.revision,order:_.order&&typeof _.order=="object"?_.order:{}})}catch{}}),M.on("display-policy-snapshot",h=>{let _=h;if(_&&_.policy&&typeof _.policy=="object")try{Se.set(_.policy)}catch{}}),M.on("session-log-snapshot",h=>{let _=h;if(_&&typeof _.attempt_id=="string")try{Je.set(_.attempt_id,Array.isArray(_.lines)?_.lines:[])}catch{}}),M.on("session-log-append",h=>{let _=h;if(_&&typeof _.attempt_id=="string")try{Je.append(_.attempt_id,_.event)}catch{}}),M.on("snapshot",h=>{let _=h,Z=_&&typeof _.id=="string"?_.id:"",K=Z?q.getStore(Z):null;if(K&&_&&_.type==="snapshot")try{K.applyPush(_)}catch{}}),M.on("upsert",h=>{let _=h,Z=_&&typeof _.id=="string"?_.id:"",K=Z?q.getStore(Z):null;if(K&&_&&_.type==="upsert")try{K.applyPush(_)}catch{}}),M.on("delete",h=>{let _=h,Z=_&&typeof _.id=="string"?_.id:"",K=Z?q.getStore(Z):null;if(K&&_&&_.type==="delete")try{K.applyPush(_)}catch{}});let ze=null,_e=null,$e=null,Ve=null,pe=()=>{},at=new Promise(h=>{pe=()=>h(void 0)}),fe=!1,Ke=!1;async function et(h){let _=ie(h);if(_===_e||_===$e)return;$e=_;let Z=`detail:${h}`,K={type:"issue-detail",params:{id:h}};try{q.register(Z,K)}catch(te){e("register detail store failed: %o",te)}try{let te=await P.subscribeList(Z,K);if(I.getState().selected_id!==h||ie(h)!==_){await te().catch(()=>{});return}ze&&await ze().catch(()=>{}),ze=te,_e=_}catch(te){e("detail subscribe failed: %o",te),f(te,"issue details")}finally{$e===_&&($e=null)}}let de=new Map,be=new Set,Le=ur;try{let h=window.localStorage.getItem(Yo);Vr(h)&&(Le=h)}catch{}async function De(h){if(!Vr(h)||h===Le)return;Le=h;try{window.localStorage.setItem(Yo,h)}catch{}let _=de.get(bt);if(!_)return;de.delete(bt),await _().catch(()=>{});let Z=He();try{q.register(bt,Z)}catch(K){e("register %s store failed: %o",bt,K)}try{let K=await P.subscribeList(bt,Z);de.set(bt,K)}catch(K){e("re-subscribe %s failed: %o",bt,K),f(K,"board")}}let We=new Map,ye=null,Oe=null,w=null;async function se(){w=null,Se.clear(),ye=null;let h=I.getState().workspace.current?.path;if(h)try{await M.send("set-workspace",{path:h})}catch(_){e("workspace restore after reconnect failed: %o",_);return}U(),Ee(I.getState().view==="worker")}async function T(){e("clearing all subscriptions for workspace switch"),Ae(),Ge(),Ce.clear(),y(),Ze(),ee(),U(),Pe();let h=I.getState();if(h.selected_id)try{q.unregister(`detail:${h.selected_id}`)}catch{}let _=I.getState();Re(_.view==="board"),Ee(_.view==="worker"),_.selected_id&&Te(_.selected_id)}async function E(h){e("requesting workspace switch to %s",h),Ke=!0;try{let _=await M.send("set-workspace",{path:h});e("workspace switch result: %o",_),_&&_.workspace&&(I.setState({workspace:{current:{path:_.workspace.root_dir,database:_.workspace.db_path}}}),window.localStorage.setItem("beads-ui.workspace",h),_.changed&&(await T(),Q("Switched to "+L(h),"success",2e3)))}catch(_){throw e("workspace switch failed: %o",_),Q("Failed to switch workspace","error",3e3),_}finally{Ke=!1}}async function j(h){e("requesting workspace git pull for %s",h);try{let _=await M.send("git-pull-workspace",{});e("workspace git pull result: %o",_);let Z=_?.status;if(Z==="up_to_date"){Q("Already up to date","success",2e3);return}if(Z==="stash_pop_conflict"){Q("Git pulled, but stash pop conflicted (check git stash list)","warning",4e3);return}Q("Git pulled "+L(h),"success",2e3)}catch(_){e("workspace git pull failed: %o",_);let Z=_?.code,K=_?.message;if(Z==="rebase_conflict"){Q("Git pull conflicts \u2014 reverted (manual resolve required)","error",4e3);return}if(Z==="rebase_conflict_abort_failed"){Q("Git pull conflicts AND rebase --abort failed \u2014 repo left mid-rebase, run 'git rebase --abort' manually","error",6e3);return}if(Z==="busy"){Q("Git pull skipped: another operation is running","warning",3e3);return}let te=K?`: ${K}`:"";throw Q(`Git pull failed${te}`,"error",3e3),_}}async function W(h,_){e("setting workspace visibility %s \u2192 %s",h,String(_));try{await M.send("set-workspace-visibility",{path:h,visible:_}),await g()}catch(Z){e("workspace visibility update failed: %o",Z),Q("Failed to update project visibility","error",3e3)}}async function g(){try{let h=await M.send("list-workspaces",{});if(e("workspaces loaded: %o",h),h&&Array.isArray(h.workspaces)){let _=h.workspaces.map(he=>({path:he.path,database:he.database,pid:he.pid,version:he.version})),Z=h.current?{path:h.current.root_dir,database:h.current.db_path}:null,K=Array.isArray(h.hidden)?h.hidden.filter(he=>typeof he=="string"):[];I.setState({workspace:{current:Z,available:_,hidden:K}});let te=window.localStorage.getItem("beads-ui.workspace");te&&(!_.some(wt=>wt.path===te)||K.includes(te)?window.localStorage.removeItem("beads-ui.workspace"):Z&&te!==Z.path&&(e("restoring saved workspace preference: %s",te),await E(te)))}}catch(h){e("failed to load workspaces: %o",h)}}M.on("workspace-changed",h=>{e("workspace-changed event: %o",h),h&&h.root_dir&&(I.setState({workspace:{current:{path:h.root_dir,database:h.db_path}}}),g(),T())});let C=!1;if(typeof M.onConnection=="function"){let h=_=>{e("ws state %s",_),_==="reconnecting"||_==="closed"?(C=!0,Q("Connection lost. Reconnecting\u2026","error",4e3)):_==="open"&&C&&(C=!1,Q("Reconnected","success",2200),Bl(I,(Z,K)=>{e(`${Z}: %o`,K)}),se())};M.onConnection(h)}let A="board";try{let h=window.localStorage.getItem("beads-ui.view");(h==="board"||h==="worker")&&(A=h)}catch(h){e("view parse error: %o",h)}let I=xs({config:Fl(),view:A});M.on("worker-queue-snapshot",h=>{let _=h;if(!_||!_.queue)return;let Z=I.getState().workspace.current?.path;if(typeof Z=="string"&&Z.length>0&&_.root_dir!==Z){e("dropping worker-queue snapshot for %s",String(_.root_dir));return}try{Ce.set(_.queue)}catch{}});let J=vs(I);J.start();let le=async(h,_)=>{try{return await F(h,_)}catch{return[]}};n&&So(n,I,J);let Y=document.getElementById("workspace-picker");Y&&Bo(Y,I,E,j,W);let xe=Co(t,(h,_)=>F(h,_));try{let h=document.getElementById("new-issue-btn");h&&h.addEventListener("click",()=>xe.open())}catch{}let lt=$o(t,{policyStore:Se,transport:(h,_)=>F(h,_),labelOptions:()=>{let h=new Set;for(let[_]of Fn)for(let Z of q.snapshotFor(_)||[]){let K=Z.labels;if(Array.isArray(K))for(let te of K)typeof te=="string"&&te.length>0&&h.add(te)}return Array.from(h).sort()}});try{let h=document.getElementById("display-settings-btn");h&&h.addEventListener("click",()=>lt.open())}catch{}let ht=Ls(s,{gotoIssue:h=>J.gotoIssue(h),issueStores:q,transport:le,uiOrderStore:Ne,displayPolicyStore:Se,closedRange:Le,onClosedRangeChange:h=>{De(h)},onNewIssue:()=>xe.open()}),It=Mn(o,{transport:le,issueStores:q,queueStore:Ce,sessionLogStore:Je,uiOrderStore:Ne,gotoIssue:h=>I.setState({selected_id:h}),getWorkspacePath:()=>I.getState().workspace.current?.path}),Xe=ko(i,{issueStores:q,transport:le,queueStore:Ce,sessionLogStore:Je,getWorkspacePath:()=>I.getState().workspace.current?.path,onNavigate:h=>{I.getState().view==="worker"?I.setState({selected_id:h}):J.gotoIssue(h)},onClose:()=>{let h=I.getState();I.setState({selected_id:null});try{J.gotoView(h.view==="worker"?"worker":"board")}catch{}}}),ct=I.getState().selected_id;ct&&(i.hidden=!1,Xe.load(ct),Te(ct)),I.subscribe(h=>{let _=h.selected_id;_?(i.hidden=!1,Xe.load(_),Ke||Te(_)):(Xe.clear(),i.hidden=!0,Pe())});let yt=h=>{s.hidden=h.view!=="board",o.hidden=h.view!=="worker",Re(h.view==="board"),Ee(h.view==="worker"),!h.selected_id&&h.view==="board"&&ht.load(),h.view==="worker"&&It.load(),window.localStorage.setItem("beads-ui.view",h.view)};I.subscribe(yt),yt(I.getState()),Ze(),U(),g().finally(()=>{fe=!0,pe()}),window.addEventListener("keydown",h=>{let _=h.ctrlKey||h.metaKey,Z=String(h.key||"").toLowerCase(),K=h.target,te=K&&K.tagName?String(K.tagName).toLowerCase():"",he=te==="input"||te==="textarea"||te==="select"||K&&typeof K.isContentEditable=="boolean"&&K.isContentEditable;_&&Z==="n"&&(he||(h.preventDefault(),xe.open()))})}}typeof window<"u"&&typeof document<"u"&&window.addEventListener("DOMContentLoaded",()=>{try{let r=window.localStorage.getItem("beads-ui.theme"),n=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,s=r==="dark"||r==="light"?r:n?"dark":"light";document.documentElement.setAttribute("data-theme",s);let o=document.getElementById("theme-switch");o&&(o.checked=s==="dark")}catch{}let t=document.getElementById("theme-switch");t&&t.addEventListener("change",()=>{let r=t.checked?"dark":"light";document.documentElement.setAttribute("data-theme",r),window.localStorage.setItem("beads-ui.theme",r)});let e=document.getElementById("app");e&&ql(e)});export{ql as bootstrap,Fl as readBootstrapConfig,Bl as refreshConfigSnapshot};
