...
`)}function de(){if(!o)return u``;let H=j(),K=(a?[p.agent_type,p.model,p.effort]:[p.runner,p.model,p.effort]).filter(Boolean).join(" \xB7 "),Pe=p.session_id||"",Ke=`\uB77C\uC774\uBE0C \uB530\uB77C\uAC00\uAE30 ${f?"ON":"OFF"}`,Ge=he(),ye=Ge?Km($e(),Date.now()):"",M=Ge?ae(H):null,X=Ge?Se(H):null,ne=Vm(H);return u`<div class="sv" data-attempt-id=${o}>
      <div class="sv__bar">
...
`).trim()}}var hu=20;function bu(e){if(e==null||e==="")return"";let t=new Date(e);if(Number.isNaN(t.getTime()))return"";let n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0"),s=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${n}-${r} ${s}:${o}`}function tg(e){return e.length>hu?`${e.slice(0,hu)}\u2026`:e}function ng(e,t,n,r){let s=`${t.lane} ${tg(t.identifier)}`;return u`<div class="detail-report">
  ...
  >
    ...
    <div class="detail-summary__gates">
      ${lg.map(f=>{let b=f.receipt&&typeof t[f.receipt]=="string"?String(t[f.receipt]):"",w=r[f.id],x=b.length>0||w?.fill==="full",N=!x&&w?.fill==="dim",B=w?.stale===!0;return u`<span
...
`)}
  ...
  >
    ...
    >${e.id}</span
  >`,x=e.lane==="done"?"":Br(e.workflow),N=ed(e.from_id),B=Vo(e.priority),Y=u`<span class="worker-mini__title">${e.title}</span>`,ee=e.pr_url&&e.pr_number?u`<a
      ...
      >`:""}${e.serial_lane_id?u`<span class="rtile__lane">${e.serial_lane_id}</span>`:""}`:""}var Zg=new Set(["codex-runner"]);function Qg(e,t,n,r=null){if(!e)return"";let s=e.last_activity||null,o=s&&typeof s.text=="string"?s.text:"",a=s&&typeof s.at=="number"?s.at:null,i=(r||!Array.isArray(e.legs)?[]:e.legs).filter(b=>b&&!(typeof b.agent_type=="string"&&Zg.has(b.agent_type))),c=i.filter(b=>b&&b.state==="live"),d=i.filter(b=>b&&b.state!=="live"),p=jr(e.dependency_chips,{lane:"running"}),f=r?on(r.updated_at,t):"";return u`${o?u`<div class="rtile__activity${n?" is-paused":""}">
        ...
        ${c.map(b=>u`<span
            ...
            >`)}${d.length>0?u`<span
              ...
              >위임 완료 ${d.length}</span
            >`:""}
      </div>`:""}${p}`}function $i(e,t,n=null,r={}){let s=e.kind==="session",o=e.failed===!0,a=!!e.paused,i=o?e.status_label||(e.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328"):a?"\uC77C\uC2DC\uC815\uC9C0":typeof e.started_at=="number"?Kg(t-e.started_at):"\u2014",c=e.exec_chips&&(e.exec_chips.orchestration||e.exec_chips.worker)?e.exec_chips:null,d=rs(e),p=zt(e.usage),f=In(e.usage),b=e.conflict_resolution?a?"\uCDA9\uB3CC \uD574\uC18C \uC77C\uC2DC\uC815\uC9C0":"\uCDA9\uB3CC \uD574\uC18C":null,w=e.base_exception||null,x=e.landing,N=e.attempt_id&&e.attempt_id===n,B=r.monitor||null,Y=Yg(B),ee=Qg(B,t,a,s?{updated_at:e.updated_at??null}:null),L=s&&e.workflow?.chips?.exec_receipt||null,I=Br(e.workflow),D=L?u`<span
        class="ctl-chip ctl-chip--exec-receipt"
  ...
  >
    <div class="rtile__hd">
      ...
      ${Vo(e.priority)}${Y}${d?u`<span class="rtile__resumed" title=${d}>↻</span>`:""}
...
`)}function Ss(e){if(typeof e!="object"||e===null)return null;let t=ur(e);if(t==="")return null;let n=(r,s)=>typeof s=="string"&&s.length>0?`${r}: ${s}`:null;return{text:t,title:Si(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uC774 attempt\uC5D0 \uAE30\uB85D\uB41C \uC2E4\uD589\uAC12",n("runner",e.runner),n(Vn.orchestration_model,e.model),n(Vn.orchestration_effort,e.effort),n(Vn.orchestration_speed,e.speed)])}}function _r(e,t){let n=Yn(e,"orchestration_model");if(n===null||n.resolution==="unavailable")return null;let r=Yn(e,"orchestration_effort"),s=Yn(e,"orchestration_speed"),o=id([wn(t,n.value??""),n.display,r!==null&&r.value!==null?r.display:null,s!==null&&s.value==="fast"?"Fast":null]);return o===""?null:{text:o,title:Si(["\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uD050 \uAE30\uBCF8\uAC12)",Zn("orchestration_model",n),Zn("orchestration_effort",r),Zn("orchestration_speed",s)])}}function Xg(e,t){return e===null||e.value===null||Ai.has(e.resolution)?null:e.value!=="inherit"?e.value:t?`inherit\u2192${t}`:"inherit"}function Jg(e){return e===null||Ai.has(e.resolution)?null:e.value==="auto"?"auto":e.display}function eh(e){return e===null?null:e.value==="auto"?"auto":Ai.has(e.resolution)?null:e.display}function Qn(e,t){if(typeof e!="object"||e===null)return null;let n=Yn(e,"impl_dispatch"),r=Yn(e,"impl_runtime"),s=Yn(e,"impl_model"),o=Yn(e,"impl_effort"),a=Yn(e,"impl_speed"),i=n!==null&&n.value==="main"?"\uBA54\uC778":id([Xg(r,t??null),Jg(s),eh(o),a!==null&&a.value==="fast"?"Fast":null]);return i===""?null:{text:i,title:Si(["\uC6CC\uCEE4(\uAD6C\uD604 \uC704\uC784) \u2014 \uD604\uC7AC \uD574\uC11D\uAC12 (\uD540 > \uC804\uC5ED kv > \uAE30\uBCF8). \uC2E4\uD589 \uC911\uC774\uBA74 \uC138\uC158\uC774 \uC2DC\uC791 \uC2DC \uACE0\uC815\uD55C \uAC12\uACFC \uB2E4\uB97C \uC218 \uC788\uC74C",Zn("impl_dispatch",n),Zn("impl_runtime",r),Zn("impl_model",s),Zn("impl_effort",o),Zn("impl_speed",a)])}}var Jt="",th=["impl_runtime","impl_model","impl_effort"],nh=5,Yo=1;function qn(e){return!!e&&typeof e=="object"&&!Array.isArray(e)}function Zo(e,t){let n=t.transport,r=typeof t.root_dir=="string"&&t.root_dir.length>0?t.root_dir:null,s=t.notify||(M=>ue(M,"error",4e3)),o={},a={},i=[],c=!1,d=null,p={},f="",b="",w=!1,x=!1,N=!1,B=null,Y=!1;function ee(){let M=t.queue?t.queue():null;return qn(M)?M:null}function L(){let M=ee();return M?M.runner_catalog:null}function I(){let M=ee();return M&&qn(M.execution_defaults)?M.execution_defaults:null}function D(){let M=t.implPresetStore?.get();return qn(M)&&Array.isArray(M.presets)?M:null}function G(){return r===null?{}:{root_dir:r}}async function S(M,X){return Y||!n?null:await n(M,X)}function U(M){M&&qn(M.queue)&&t.onQueueAdopt?.(M.queue)}async function j(M,X){let ne=ee();if(!ne||Y)return null;let V=await S(M,{...X,...G(),expected_revision:ne.revision});if(U(V),r!==null&&V&&V.conflict){let Ne=V.queue&&typeof V.queue.revision=="number"?V.queue.revision:ee()?.revision??ne.revision;V=await S(M,{...X,...G(),expected_revision:Ne}),U(V)}return V}async function $e(){c=!0,ye();try{let M=await S("get-session-defaults",{...G()});o=qn(M?.values)?{...M.values}:{},a={...o},i=Array.isArray(M?.warnings)?M.warnings:[]}catch(M){i=["kv_read_failed"],s(`\uC138\uC158 \uAE30\uBCF8\uAC12\uC744 \uC77D\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4: ${M instanceof Error?M.message:String(M)}`)}finally{c=!1,ye()}}async function he(){let M=Eu(o,a);if(Object.keys(M).length!==0){try{let X=await S("set-session-defaults",{values:M,...G()});o=qn(X?.values)?{...X.values}:{},a={...o},i=Array.isArray(X?.warnings)?X.warnings:[]}catch(X){s(`\uC138\uC158 \uAE30\uBCF8\uAC12 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}ye()}}function pe(M,X){if(th.includes(M)){Oe(M,X);return}X===Jt?delete a[M]:a[M]=X,ye(),he()}function z(){let M=Ke().orchestration_model,X=Xt({global:{orchestration_model:M??void 0},execution_defaults:I(),runner_catalog:L()}).orchestration_model.value;return X?wn(L(),X):null}function xe(M,X){typeof X=="string"&&X.length>0?a[M]=X:delete a[M]}function Oe(M,X){let ne=X===Jt?void 0:X,V=Au({impl_runtime:M==="impl_runtime"?ne:a.impl_runtime,impl_model:M==="impl_model"?ne:a.impl_model,impl_effort:M==="impl_effort"?ne:a.impl_effort},L(),z());xe("impl_runtime",V.impl_runtime),xe("impl_model",V.impl_model),xe("impl_effort",V.impl_effort),ye(),he()}async function re(){let M=ee();if(!M)return;let X={orchestration_model:M.orchestration_model??null,orchestration_effort:M.orchestration_effort??null,orchestration_speed:M.orchestration_speed??null},ne=Tu(X,{...X,...p});if(Object.keys(ne).length!==0){try{let V=await j("worker-queue-set-orchestration-defaults",{values:ne});if(V&&V.applied===!1){s("Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC");return}p={}}catch(V){s(`Worker \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}ye()}}function ae(M,X){p[M]=X===Jt?null:X,ye(),re()}function Se(M){if(d=M,!M){ye();return}let X=L(),ne=Ke(),V=ne.orchestration_model;V&&!ws(X,M).includes(V)&&(p.orchestration_model=null,V=null);let Ne=ne.orchestration_effort;Ne&&!fi(X,M,V||cn).includes(Ne)&&(p.orchestration_effort=null),ye(),re()}async function W(M){if(!(!ee()||M<Yo)){try{await j("worker-queue-set-slots",{slots:M})}catch(X){s(`slots \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}ye()}}async function J(M){if(!(!ee()||M<Yo||M>nh)){try{await j("worker-queue-set-serial-lane-count",{count:M})}catch(X){s(`\uC9C1\uB82C \uB808\uC778 \uC800\uC7A5 \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}ye()}}async function de(M,X){let ne=M==="auto_advance"?"worker-automation-toggle":M==="auto_merge"?"worker-merge-auto-toggle":"worker-auto-repair-toggle";try{await j(ne,{on:X})}catch(V){s(`\uC790\uB3D9\uD654 \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}ye()}function Ee(){let M={},X=Ke();for(let ne of Oo){let V=Nn.includes(ne)?X[ne]:a[ne];typeof V=="string"&&V.length>0&&(M[ne]=V)}return M}async function be(){let M=D();if(!M)return;let X=Ee();if(Object.keys(X).length===0){s("\uC800\uC7A5\uD560 \uC2E4\uD589 \uC124\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4 \u2014 \uBA3C\uC800 \uC2E4\uD589 \uAC12\uC744 \uC120\uD0DD\uD558\uC138\uC694");return}let ne=(M.presets||[]).find(Ne=>Ne.id===f),V=b.trim()||(ne?ne.name:"");if(!V){s("\uD504\uB9AC\uC14B \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694");return}try{let Ne=ne?await S("impl-preset-update",{expected_revision:M.revision,id:ne.id,name:V,settings:X}):await S("impl-preset-create",{expected_revision:M.revision,name:V,settings:X});if(Ne&&Ne.applied){if(b="",!ne&&Array.isArray(Ne.presets)){let Qe=Ne.presets.find(ct=>ct.name===V);f=Qe?Qe.id:f}ye()}else s("\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),ye()}catch(Ne){s(`\uD504\uB9AC\uC14B \uC800\uC7A5 \uC2E4\uD328: ${Ne instanceof Error?Ne.message:String(Ne)}`)}}async function Be(){let M=D();if(!(!M||f.length===0))try{let X=await S("impl-preset-delete",{expected_revision:M.revision,id:f});X&&X.applied?(f="",ye()):(s("\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: \uB2E4\uB978 \uACF3\uC5D0\uC11C \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4"),ye())}catch(X){s(`\uD504\uB9AC\uC14B \uC0AD\uC81C \uC2E4\uD328: ${X instanceof Error?X.message:String(X)}`)}}function we(M){o=qn(M.values)?{...M.values}:{},a={...o},i=Array.isArray(M.warnings)?M.warnings:[],qn(M.queue)&&(t.onQueueAdopt?.(M.queue),p={})}async function Ze(){let M=D(),X=ee();if(!M||!X||f.length===0)return;let ne=V=>({preset_id:f,expected_revision:M.revision,expected_queue_revision:V,...G()});try{let V=await S("apply-impl-preset-global",ne(X.revision));if(V&&V.applied&&we(V),r!==null&&V&&V.queue_applied===!1){let Ne=V.queue&&typeof V.queue.revision=="number"?V.queue.revision:ee()?.revision??X.revision;V=await S("apply-impl-preset-global",ne(Ne)),V&&V.applied&&we(V)}V&&V.applied?V.queue_applied===!1&&s("\uC624\uCF00\uC2A4\uD2B8\uB808\uC774\uC158 \uAC12\uC740 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD558\uC138\uC694"):V&&V.conflict&&s("\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: \uD504\uB9AC\uC14B\uC774 \uBC29\uAE08 \uBCC0\uACBD\uB418\uC5C8\uC2B5\uB2C8\uB2E4")}catch(V){s(`\uC2E4\uD589 \uD504\uB9AC\uC14B \uC801\uC6A9 \uC2E4\uD328: ${V instanceof Error?V.message:String(V)}`)}ye()}async function lt(){x=!0,N=!1,ye();try{let M=await S("get-worker-system-prompt",{});!M||typeof M!="object"||Array.isArray(M)?N=!0:B=M}catch{N=!0}finally{x=!1,ye()}}function R(){if(w=!w,w&&!B){lt();return}ye()}function ce(){let M=Pr({loading:x,error:N});if(M)return M;if(!B)return"";let X=Array.isArray(B.variants)?B.variants:[];return u`<div class="settings-dialog__sp-body">
    ...
    >
      ...
      ${w?ce():""}
    </section>`}function Ae(M,X,ne,V,Ne,Qe,ct){let ot=Ne[M]??Jt,ut=_i(M,ne,Ne,I(),L(),ct),ht=ut.options.find(tt=>tt.value===ot),bt=ot===Jt?ut.full_value:ht?.full_value;return u`<select
    ...
    </div>`}function Ke(){let M=ee(),X={};for(let ne of Nn)X[ne]=Object.prototype.hasOwnProperty.call(p,ne)?p[ne]:M&&typeof M[ne]=="string"?M[ne]:null;return X}function Ge(){let M=L(),X=a.impl_runtime,ne=a.impl_model,V=D(),Ne=ee(),Qe=Ke(),ct=ws(M,d),ot=Nr(M,void 0).filter(ge=>ge!==cn),ut=fi(M,d,Qe.orchestration_model||cn).filter(ge=>ge!==cn),ht=f?(V?.presets||[]).find(ge=>ge.id===f):null,bt=ht?Su(Ee(),qn(ht.settings)?ht.settings:{}):null,tt=Ne&&typeof Ne.slots=="number"?Ne.slots:Yo+1,Tt=Ne&&typeof Ne.serial_lane_count=="number"?Ne.serial_lane_count:Yo,wt=I()?.supported===!0,He=_i("workflow_mode",ys,a,I(),M);return u`
...
${ve.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":""};return Object.hasOwn(ne,oe)&&(rt.blocked_by=Array.isArray(ne[oe])?ne[oe].filter(Ye=>typeof Ye=="string"&&Ye.length>0):[]),rt};for(let h=0;h<ht.length;h++){let A=Q(ht[h],"queue",h,ht.length);if(!A)continue;b.push(A);let F=N.get(ce);F?F.push(A):N.set(ce,[A])}let ie=h=>{let A=f.find(oe=>oe.id===h&&oe.root_dir===ce);if(A)return{id:h,title:A.title,badge:"PR \uB300\uAE30 \xB7 \uC810\uC720"};let F=p.find(oe=>oe.id===h&&oe.root_dir===ce),se=F&&F.run_state==="failed"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":F&&F.run_state==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720";return{id:h,title:F?F.title:kt(h).title,badge:se}},qe=[];for(let h=0;h<Math.max(Tt,bt.length);h++){let A=`s${h+1}`,F=wt.get(A),se=F&&Array.isArray(F.entries)?F.entries:[],oe=[];for(let Je=0;Je<se.length;Je++){let rt=Q(se[Je],A,Je,se.length);rt&&(oe.push(rt),b.push(rt))}let ve=Et(tt[A]),Te=Array.isArray(ve.occupied_by)?ve.occupied_by.filter(Je=>typeof Je=="string"):[];oe.length===0&&Te.length===0&&(Tt<=1||h>=Tt)||qe.push({id:A,index:h,items:oe,raw_length:se.length,occupied_by:Te,occupants:Te.map(Je=>ie(Je)),corrections:Array.isArray(ve.corrections)?ve.corrections.length:0,cycle:ve.cycle===!0,...oe.length===0&&Te.length===0?{empty:!0}:{}})}B.set(ce,qe);let E=Array.from({length:Tt},(h,A)=>{let F=`s${A+1}`,se=wt.get(F),oe=se&&Array.isArray(se.entries)?se.entries:[],ve=Et(tt[F]);return{id:F,index:oe.length,length:oe.length,occupied_by:Array.isArray(ve.occupied_by)?ve.occupied_by.filter(Te=>typeof Te=="string"):[]}});for(let h of Array.isArray(R.runnable)?R.runnable:[]){let A=h&&h.bead_id;if(typeof A!="string"||nt.has(A))continue;nt.add(A);let F=h.workflow&&typeof h.workflow=="object"?h.workflow:null,se=F&&typeof F.route=="string"&&F.route||(typeof h.route=="string"?h.route:null),oe=Ah(Et(Ae),h.exec_pins,se);Array.isArray(h.blocked_by)&&h.blocked_by.length>0&&L.set(A,h.blocked_by.filter(ve=>typeof ve=="string"&&ve.length>0)),typeof h.title=="string"&&h.title.length>0&&G.set(A,h.title),F&&S.set(A,F),Array.isArray(h.scope)&&D.set(A,h.scope.filter(ve=>typeof ve=="string"&&ve.length>0)),d.push({...kt(A),title:h.title||H[A]||A,lane:"runnable",draggable:!0,reason:Cd(Ke,A),created_at:h.created_at??void 0,updated_at:h.updated_at??void 0,status:typeof h.status=="string"?h.status:void 0,labels:Array.isArray(h.labels)?h.labels:[],spec_id:typeof h.spec_id=="string"?h.spec_id:"",workflow:F||(se?{route:se,chips:{route:se}}:null),...oe?{exec_chips:oe}:{},blocked:h.blocked===!0,...Array.isArray(h.blocked_by)?{blocked_by:h.blocked_by.filter(ve=>typeof ve=="string"&&ve.length>0)}:{},place_index:ht.length,place_lanes:E})}for(let h of ge){let A=h&&h.bead_id;if(typeof A!="string"||nt.has(A)||(nt.add(A),o!==void 0&&typeof h.added_at=="number"&&h.added_at<o))continue;let F=$h(De,A),se=F&&typeof F.done_kind=="string"?F.done_kind:null;w.push({...kt(A),lane:"done",done:!0,done_layout:"three_line",usage:pn(De,A),work_ms:Wo(De,A),done_at:typeof h.added_at=="number"?h.added_at:void 0,done_kind:se,badges:[...se&&Td[se]?[Td[se]]:[],...Uo(De,A)]})}}let U=new Map;s.forEach((R,ce)=>{R&&typeof R.root_dir=="string"&&U.set(R.root_dir,ce)});let j=n&&n.running_sort==="repo"?"repo":"started";p.sort((R,ce)=>{let ke=R.kind==="session",Ae=ce.kind==="session";if(ke!==Ae)return ke?1:-1;if(ke&&Ae){let H=na(ce.updated_at)-na(R.updated_at);return H!==0?H:R.id.localeCompare(ce.id)}if(j==="repo"){let H=U.get(R.root_dir)??Number.MAX_SAFE_INTEGER,K=U.get(ce.root_dir)??Number.MAX_SAFE_INTEGER;if(H!==K)return H-K}let je=typeof R.started_at=="number"&&Number.isFinite(R.started_at)?R.started_at:null,De=typeof ce.started_at=="number"&&Number.isFinite(ce.started_at)?ce.started_at:null;return je!==null&&De!==null&&je!==De?je-De:je===null&&De!==null?1:je!==null&&De===null?-1:R.id.localeCompare(ce.id)}),w.sort((R,ce)=>(ce.done_at??0)-(R.done_at??0));let $e=s.length>0?s:r.map(R=>({root_dir:R&&R.root_dir,name:R&&R.name,auto_advance:R&&R.auto_advance,auto_merge:R&&R.auto_merge,slots:R&&R.slots,revision:R&&R.revision,runner_catalog:R&&R.runner_catalog})),he=new Set(d.map(R=>R.root_dir)),pe=[];for(let R of $e){if(!R||typeof R.root_dir!="string")continue;let ce=N.get(R.root_dir)||[],ke=B.get(R.root_dir)||[];!(ce.length>0||ke.some(je=>je.items.length>0||je.occupied_by.length>0))&&!he.has(R.root_dir)||pe.push({root_dir:R.root_dir,name:R.name||R.root_dir,auto_advance:R.auto_advance===!0,auto_merge:R.auto_merge===!0,slots:typeof R.slots=="number"&&R.slots>=Ed?R.slots:Ed,revision:typeof R.revision=="number"?R.revision:0,runner_catalog:Et(R.runner_catalog),items:ce,sublanes:{parallel:ce,serial:ke},serial_lane_count:Y.get(R.root_dir)||0,raw_queue_length:ee.get(R.root_dir)||0})}let z={runnable:d,runnable_hidden:{blocked:0,spec:0},runnable_sections:[],runnable_flat:i==="updated_flat",queue:b,queue_groups:pe,running:p,pr_wait:f,done:w,chains:[],parallel_rows:[],chain_lanes:[],parallel_raw_length:Object.fromEntries(ee),owner_of:{},pending_lanes_kept:[]},xe=$d(z);for(let R of x)xe.has(R.id)||xe.set(R.id,{root_dir:R.root_dir,workspace_name:R.workspace_name,lane:"done",state:"done"});let Oe=new Map;for(let[R,ce]of L)for(let ke of ce){let Ae=Oe.get(ke);Ae?Ae.includes(R)||Ae.push(R):Oe.set(ke,[R])}for(let R of[...z.queue,...z.runnable]){if(!Object.hasOwn(R,"blocked_by"))continue;let ce=xe.get(R.id);R.blockers=(R.blocked_by||[]).map(ke=>xd(ke,ce,xe,s)),R.blocker_warnings=R.blockers.filter(ke=>ke.missing_internal).map(ke=>`\u26A0 \uC120\uD589 ${ke.id}\uAC00 \uC5B4\uB290 \uB808\uC778\uC5D0\uB3C4 \uC5C6\uACE0 \uC2E4\uD589 \uC911\uB3C4 \uC544\uB2D8 \u2014 \uC218\uB3D9 \uAC1C\uC785 \uC804\uAE4C\uC9C0 \uC774 \uC790\uB9AC\uC5D0\uC11C \uC815\uC9C0`),R.blocker_warnings.length>0&&(R.alert=!0)}for(let R of[...z.queue,...z.runnable,...z.running,...z.pr_wait]){let ce=R.lane==="running"||R.lane==="pr_wait"?[]:(R.blockers||[]).map(Sh),ke=[];for(let De of Oe.get(R.id)||[]){let H=Eh(De,xe);H&&ke.push(H)}let Ae=R.lane==="running"||R.lane==="pr_wait"?[]:R.blocker_warnings||[];if(ce.length===0&&ke.length===0&&Ae.length===0)continue;let je={predecessors:ce,successors:ke,warnings:Ae};R.dependency_chips=je}Lh(z,I,D,xe,s),z.chains=Ch(L,xe,s);let re=Ad(z.queue_groups);for(let R of z.queue_groups)for(let ce of R.sublanes.serial){let ke=re.get(Sd(R.root_dir,ce.id));ke&&(ce.cross_wait_peers=ke)}let ae=Oh(z.chains,Array.isArray(n?.pending_lanes)?n.pending_lanes:[],L,xe,s,G,S);z.chain_lanes=ae.chain_lanes,z.pending_lanes_kept=ae.pending_lanes_kept;let Se=new Map;for(let R of[...z.running,...z.queue,...z.runnable])Se.has(R.id)||Se.set(R.id,R);let W=new Set;for(let R of z.chain_lanes)for(let ce of R.rows){W.add(ce.id);let ke=Se.get(ce.id);ke&&(ke.overlap_chips&&(ce.overlap_chips=ke.overlap_chips),ke.scope_state&&(ce.scope_state=ke.scope_state))}let J=[];for(let R of N.values())for(let ce of R)W.has(ce.id)||J.push(ce);J.sort((R,ce)=>{let ke=R.workspace_name.localeCompare(ce.workspace_name);return ke!==0?ke:(R.queue_index??0)-(ce.queue_index??0)}),z.parallel_rows=J;let de={};for(let[R,ce]of xe)typeof ce.root_dir=="string"&&ce.root_dir.length>0&&(de[R]=ce.root_dir);z.owner_of=de;let Ee=z.runnable.length,be=z.runnable;a.show_blocked||(be=be.filter(R=>R.blocked!==!0));let Be=be.length;a.spec==="with"?be=be.filter(R=>!!R.spec_id):a.spec==="without"&&(be=be.filter(R=>!R.spec_id)),z.runnable_hidden={blocked:Ee-Be,spec:Be-be.length};let we=(R,ce)=>{let ke=na(ce.updated_at)-na(R.updated_at);return ke!==0?ke:R.id.localeCompare(ce.id)},lt=i==="repo_spec"?(R,ce)=>{let ke=R.spec_id?0:1,Ae=ce.spec_id?0:1;return ke!==Ae?ke-Ae:we(R,ce)}:we;if(i==="updated_flat")z.runnable=be.slice().sort(we),z.runnable_sections=[];else{let R=new Map;for(let Ae of be){let je=R.get(Ae.root_dir);je?je.push(Ae):R.set(Ae.root_dir,[Ae])}let ce=[],ke=[];for(let Ae of $e){if(!Ae||typeof Ae.root_dir!="string")continue;let je=(R.get(Ae.root_dir)||[]).slice().sort(lt);R.delete(Ae.root_dir),je.length!==0&&(ce.push({root_dir:Ae.root_dir,name:Ae.name||Ae.root_dir,items:je.map(De=>({...De,workspace_name:""}))}),ke.push(...je))}for(let[Ae,je]of R){let De=je.slice().sort(lt);ce.push({root_dir:Ae,name:De[0]?.workspace_name||Ae,items:De.map(H=>({...H,workspace_name:""}))}),ke.push(...De)}z.runnable=ke,z.runnable_sections=ce}return z}var Ld="\uAC19\uC740 \uC9C1\uB82C \uB808\uC778\uC73C\uB85C";function Md(e){return typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)?e.lane:e.lane==="running"&&e.serial_lane_id?e.serial_lane_id:null}function Pd(e){return e.lane==="runnable"||e.lane==="queue"||typeof e.lane=="string"&&/^s[1-5]$/.test(e.lane)}var Fd="bdui.monitor.done-range",jd="bdui.monitor.running_sort",Bd="bdui.monitor.candidate_sort",Ud="beads-ui.monitor.candidate-filter",Wd="beads-ui.monitor.sections";function Mh(){try{let e=window.localStorage.getItem(Ud);if(!e)return{...Hr};let t=JSON.parse(e);return!t||typeof t!="object"?{...Hr}:{show_blocked:typeof t.show_blocked=="boolean"?t.show_blocked:Hr.show_blocked,spec:Mi.some(n=>n.value===t.spec)?t.spec:"all"}}catch{return{...Hr}}}function Dd(e){try{window.localStorage.setItem(Ud,JSON.stringify({show_blocked:e.show_blocked,spec:e.spec}))}catch{}}function Ph(){try{let e=window.localStorage.getItem(Bd);return Os.some(t=>t.value===e)?e:"repo_spec"}catch{return"repo_spec"}}function Dh(e){try{window.localStorage.setItem(Bd,e)}catch{}}function Nh(){try{let e=window.localStorage.getItem(Wd);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Nd(e){try{window.localStorage.setItem(Wd,JSON.stringify(e))}catch{}}function qh(){try{let e=window.localStorage.getItem(Fd);return dn(e)?e:sn}catch{return sn}}function Fh(e){try{window.localStorage.setItem(Fd,e)}catch{}}function jh(){try{return window.localStorage.getItem(jd)==="repo"?"repo":"started"}catch{return"started"}}function Bh(e){try{window.localStorage.setItem(jd,e)}catch{}}var zd="tab:monitor:pipeline",Uh=1e3,Wh=[{lane:"runnable",pane:"candidate",title:"\uC2E4\uD589\uAC00\uB2A5",empty:"\uC2E4\uD589 \uC790\uACA9\uC744 \uAC16\uCD98 \uC774\uC288 \uC5C6\uC74C"},{lane:"queue",pane:"queue",title:"\uB300\uAE30",empty:"\uD45C\uC2DC\uD560 \uB808\uD3EC \uC5C6\uC74C"},{lane:"running",pane:"running",title:"\uC2E4\uD589\uC911",empty:"\uC2E4\uD589 \uC911 \uC5C6\uC74C"},{lane:"pr_wait",pane:"pr_wait",title:"PR \uB300\uAE30",empty:"PR \uC5C6\uC74C"},{lane:"done",pane:"done",title:"\uC644\uB8CC",empty:"\uC644\uB8CC \uAE30\uB85D \uC5C6\uC74C"}],qd="\u2460\u2461\u2462\u2463\u2464\u2465\u2466\u2467\u2468\u2469\u246A\u246B\u246C\u246D\u246E\u246F\u2470\u2471\u2472\u2473";function zh(e){return e>=1&&e<=qd.length?qd[e-1]:`(${e})`}function Hd(e,t){let n=Ct("views:monitor"),r=t.gotoIssue,s=t.pipelineStore,o=t.transport,a=t.getWorkspacePath,i=t.openDoc,c=t.switchWorkspace,d=t.router,p=t.now||(()=>Date.now()),f=t.confirm||(v=>typeof globalThis.confirm!="function"||globalThis.confirm(v)),b=qh(),w=jh(),x=Mh(),N=Ph(),B=Nh(),Y=null,ee=null,L=null,I=[],D=null;function G(){let v=Wn.find(y=>y.value===b);return v?v.label:""}let S=document.createElement("div");S.className="mon",e.appendChild(S);let U=document.createElement("div");U.className="mon2-drawer",e.appendChild(U);let j=Pi(null,null),$e=new Map,he=new Map,pe=null,z=null,xe=null,Oe=Dr(U,{transport:o,sessionLogStore:t.sessionLogStore,onClose:()=>{Y=null,ge()}});async function re(v,y,k,P,Z=!0){if(!o||!k)return null;let me=await o(v,{...y,root_dir:k,expected_revision:P});if(me&&me.conflict&&Z){me.queue&&he.set(k,me.queue);let Le=me.queue&&typeof me.queue.revision=="number"?me.queue.revision:P;me=await o(v,{...y,root_dir:k,expected_revision:Le})}return me&&me.queue&&k&&he.set(k,me.queue),me}function ae(v,y){let k=he.get(v),P=s&&s.get?s.get():null,Z=(Array.isArray(P)?P:[]).find(Le=>Le?.root_dir===v);return(k||Z)?.merge_queue?.find(Le=>Le.bead_id===y)?.continuation_action}async function Se(v,y,k,P){let Z=await re(v,y,k,P),me=he.get(k)?.revision??Z?.queue?.revision??P;return Rn(Z,(Le,Xe)=>re(v,{...y,continuation:Le,decision_token:Xe},k,me,!1),{refresh:Le=>re(v,y,k,Le?.queue?.revision??he.get(k)?.revision??me,!1)})}async function W(v,y,k,P){let Z=await Rn({continuation_mismatch:P},(Le,Xe)=>re("worker-merge-queue-add",{bead_id:y,continuation:Le,decision_token:Xe},v,k,!1)),me=Z?.queue?.merge_queue?.find(Le=>Le.bead_id===y)?.continuation_action;Z?.applied!==!0&&me?.continuation===null&&me.mismatch&&await W(v,y,Z.queue.revision,me.mismatch)}async function J(v,y,k){let P=await re("worker-discard",v,y,k);if(P&&P.discarded===!0){ue(Ho(P),"success",5e3);return}if(P&&P.reason){ue(`\uD3D0\uAE30 \uC2E4\uD328: ${P.reason}`,"error");return}if(P&&P.accepted&&P.pending==="merged_revert"){ue("revert PR \uB300\uAE30 \uC0C1\uD0DC\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4","success");return}if(P&&P.accepted){ue(`\uD3D0\uAE30 \uC9C4\uD589: ${P.phase||"\uBC31\uC5C5 \uC911"}`,"success");return}P&&!P.conflict&&ue("\uD3D0\uAE30 \uAC70\uBD80: unknown","error")}async function de(v,y,k){return!o||!k?null:await o(v,{...y,root_dir:k})}async function Ee(){let v=new Map;for(let y of j.pr_wait)v.has(y.root_dir)||v.set(y.root_dir,y.expected_revision);for(let[y,k]of v)await re("worker-merge-queue-add-all",{},y,k)}function be(v){let y=B[v];return!!(y&&y.runnable===!0)}function Be(v){let y={...B[v]||{}};y.runnable=!y.runnable,B={...B,[v]:y},Nd(B),ge()}function we(v){return B[v]===!0}function Ze(v){B={...B,[v]:B[v]!==!0},Nd(B),ge()}function lt(v){let y=j.queue_groups.find(k=>k.root_dir===v);if(!y)return null;for(let k=0;k<y.serial_lane_count;k+=1){let P=`s${k+1}`,Z=y.sublanes.serial.find(me=>me.id===P);if(!Z||Z.raw_length===0&&Z.occupied_by.length===0)return P}return null}function R(v,y){let k=j.queue_groups.find(Z=>Z.root_dir===v),P=k?k.sublanes.serial.find(Z=>Z.id===y):void 0;return P?P.raw_length:0}function ce(v,y){let k=$e.get(v),P=$e.get(y);if(!k||!P)return{kind:"note",text:"\uC0C1\uB300\uC758 \uD604\uC7AC \uC704\uCE58\uB97C \uC54C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"};let Z=Md(k),me=Md(P);if(Z!==null&&Z===me&&k.root_dir===P.root_dir)return{kind:"note",text:"\uC774\uBBF8 \uAC19\uC740 \uC9C1\uB82C \uB808\uC778 \u2014 \uC21C\uC11C\uAC00 \uC788\uC2B5\uB2C8\uB2E4"};let Le=Pd(k),Xe=Pd(P);if(Le&&me!==null){let $=me;return{kind:"ops",title:`${$} \uB05D\uC5D0 ${v}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:P.root_dir,ops:[{bead_id:v,lane:$,index:R(P.root_dir,$)}]}}if(Z!==null&&Xe&&me===null){let $=Z;return{kind:"ops",title:`${$} \uB05D\uC5D0 ${y}\uB97C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:k.root_dir,ops:[{bead_id:y,lane:$,index:R(k.root_dir,$)}]}}if(Le&&Z===null&&Xe&&me===null){let $=lt(k.root_dir);return $===null?{kind:"disabled",title:"\uBE48 \uC9C1\uB82C \uB808\uC778 \uC5C6\uC74C \u2014 Worker \uD0ED\uC5D0\uC11C \uB808\uC778 \uC218 \uC870\uC808"}:{kind:"ops",title:`${$} \uB808\uC778\uC5D0 ${y} \u2192 ${v} \uC21C\uC11C\uB85C \uB123\uC2B5\uB2C8\uB2E4`,root_dir:k.root_dir,ops:[{bead_id:y,lane:$,index:0},{bead_id:v,lane:$,index:1}]}}return!Le&&!Xe?{kind:"note",text:"\uB458 \uB2E4 \uC2E4\uD589 \uC911 \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4"}:Le?{kind:"note",text:"\uC2E4\uD589 \uC911 \u2014 \uC885\uB8CC \uD6C4 \uCD9C\uBC1C\uD558\uB824\uBA74 \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694"}:{kind:"note",text:"\uC2E4\uD589 \uC911 \u2014 \uC21C\uC11C\uB97C \uB9CC\uB4E4\uB824\uBA74 \uC0C1\uB300\uB97C \uC9C1\uB82C \uB808\uC778\uC5D0 \uB450\uC138\uC694"}}function ke(v,y){let k=ce(v,y.id);return{id:y.id,title:y.title,location_label:y.location_label,prefixes:y.prefixes,action:k.kind==="note"?{kind:"note",text:k.text}:k.kind==="disabled"?{kind:"disabled",label:Ld,title:k.title}:{kind:"place",label:Ld,title:k.title}}}function Ae(v,y){if(!L||L.bead_id!==v)return null;let k=L.counterpart_id,P=k===null?y:y.filter(Z=>Z.id===k);return P.length===0?null:{rows:P.map(Z=>ke(v,Z))}}function je(v){let y=v.dependency_chips||null,k=v.overlap_chips||[],P=v.scope_state==="missing";if(!y&&k.length===0&&!P)return null;let Z=Ae(v.id,k);return{...y||{},...k.length>0?{overlaps:k}:{},...P?{scope_missing:!0}:{},...Z?{popover:Z}:{}}}function De(v){let y=je(v);return y?{...v,dependency_chips:y}:v}async function H(v,y){let k=ce(v,y);if(L=null,k.kind!=="ops"){ge();return}let P=oe(k.root_dir,k.ops[0].bead_id);for(let Z of k.ops){let me=await K(Z,k.root_dir,P);if(me===null)break;P=me}ge()}async function K(v,y,k){try{let P=await re("worker-queue-place",v,y,k,!1);if(P&&P.conflict)return ue("\uD050\uAC00 \uBC14\uB00C\uC5C8\uC2B5\uB2C8\uB2E4 \u2014 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694","error"),null;if(!P||P.applied!==!0)return ue(P&&typeof P.admission_reason=="string"?`\uD050 \uC801\uC7AC \uAC70\uBD80: ${P.admission_reason}`:"\uD050 \uC694\uCCAD\uC774 \uC801\uC6A9\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4","error"),null;let Z=P.queue?P.queue.revision:void 0;return typeof Z!="number"?(ue("\uD050 \uC751\uB2F5\uC5D0 revision\uC774 \uC5C6\uC2B5\uB2C8\uB2E4","error"),null):Z}catch(P){return ue(h(P),"error"),null}}function Pe(v){let y=be(v.root_dir);return u`<header class="mon2-sec__hd">
    ...
    >
      ${y}
    </div>`}function Ge(v){if(ee!==v.id)return null;let y=j.queue_groups.find(P=>P.root_dir===v.root_dir),k=v.place_lanes||[];return{bead_id:v.id,lanes:[{id:"parallel",label:"\uBCD1\uB82C",count:v.place_index??0},...j.chain_lanes.map((P,Z)=>({id:`lane:${Z}`,label:`\uC5F0\uACB0 ${Z+1} \uB05D\uC5D0`,count:P.rows.length})),{id:"new-lane",label:"\uC0C8 \uC5F0\uACB0 \uB808\uC778",count:0},...k.map(P=>({id:`serial:${P.id}`,label:`${y?y.name:""} \uC9C1\uB82C ${Number(P.id.slice(1))}`,count:P.length}))]}}function ye(v){return Ke(v,vi(De(v),Ge(v),{exec_chips_mode:"pinned_only",onOpenDoc:i?(y,k)=>i(k,v.root_dir):void 0}))}function M(){return j.runnable_flat?u`<div class="mon2-flat" data-drop="candidate">
  ...
  `}var Vh=[{id:"execution",label:"\uC2E4\uD589",glyph:"\u25C6"},{id:"display",label:"\uD45C\uC2DC",glyph:"\u25EB"}];function ep(e,t){let{transport:n,policyStore:r,labelOptions:s}=t,o=t.notify||(z=>ue(z,"error",4e3)),a=document.createElement("dialog");a.id="settings-dialog",a.className="settings-dialog",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("aria-label","\uC124\uC815"),e.appendChild(a);let i="execution",c=!1,d="",p=null;function f(){if(p)return p;let z=a.querySelector('[data-pane="execution"]');return z?(p=Zo(z,{root_dir:null,queue:()=>t.queueStore?.get()??null,transport:n,implPresetStore:t.implPresetStore,notify:o,onQueueAdopt:xe=>t.queueStore?.set?.(xe)}),p):null}function b(){return u`
    ...
    `}function w(){let z=r.get();return u`
      ...
      >
        ...
        ${z?u`
              ${Qd(z,s(),Y)}
              ${Xd(z,d,{onDraft:xe=>{d=xe},onAdd:ee,onRemove:L})}
              ${Jd(z,I)}
            `:u`<div class="settings-dialog__empty">
              표시 정책을 불러오는 중…
            </div>`}
      </section>
    `}async function x(z){let xe=r.get();if(xe)try{let Oe=await n("display-policy-set",{expected_revision:xe.revision,policy:z(xe)});N(Oe),Oe&&Oe.conflict&&Oe.policy&&(Oe=await n("display-policy-set",{expected_revision:Oe.policy.revision,policy:z(Oe.policy)}),N(Oe)),Oe&&Oe.conflict&&o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328: \uB2E4\uB978 \uD074\uB77C\uC774\uC5B8\uD2B8\uC640 \uCDA9\uB3CC")}catch{o("\uD45C\uC2DC \uC124\uC815 \uC800\uC7A5 \uC2E4\uD328")}}function N(z){z&&z.policy&&typeof z.policy=="object"&&r.set(z.policy)}function B(z){x(z)}function Y(z){let xe=r.get();if(!xe)return;let Oe=!Kh(z,xe);B(re=>Yh(z,re,Oe))}function ee(){let z=d.trim();z.length!==0&&(d="",B(xe=>xe.hidden_prefixes.includes(z)?{hidden_prefixes:xe.hidden_prefixes}:{hidden_prefixes:[...xe.hidden_prefixes,z]}),D())}function L(z){B(xe=>({hidden_prefixes:xe.hidden_prefixes.filter(Oe=>Oe!==z)}))}function I(z){let xe=r.get();if(!xe)return;let Oe=xe.chips[z]===!1;B(()=>({chips:{[z]:Oe}}))}function D(){Ve(u`
    ...
    >
      ...
      <span class="usage-meter__account-reset"
        >${W.length>0?`\u21BB ${W}`:""}</span
      >
    </span>`}function U(re,ae){return Xh.includes(ae)?`\uD1A0\uD070 \uB9CC\uB8CC \u2014 ${re.tool} \uC7AC\uB85C\uADF8\uC778 \uD544\uC694`:"\uC0AC\uC6A9\uB7C9 \uC5C6\uC74C"}function j(re,ae,Se){let W=ae.status==="ok",J=typeof ae.ageSeconds=="number"&&ae.ageSeconds>np,de=a.get(lp(re.key,ae.number)),Ee=r.get(re.key),be=Ee!==void 0,Be=Ee===ae.number,we=["usage-meter__account"];return ae.active&&we.push("usage-meter__account--active"),W||we.push("usage-meter__account--unavailable"),J&&we.push("usage-meter__account--stale"),u`<div class=${we.join(" ")}>
...
`):[];return u`<div
    ...
    </div>`}function w(){Ve(b(),r)}async function x(){if(o!=="ready")return;let D=await an(a);ue(D?"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC\uB428":"\uC2A4\uD06C\uB9BD\uD2B8 \uBCF5\uC0AC \uC2E4\uD328",D?"success":"error")}function N(D){D.key==="Escape"&&s&&(D.preventDefault(),L())}function B(){p||(document.addEventListener("keydown",N),p=!0)}function Y(){p&&(document.removeEventListener("keydown",N),p=!1)}async function ee(D,G=null){let S=++c;B(),s={...D},d=G||(document.activeElement instanceof HTMLElement?document.activeElement:null),o="loading",a="",i="",w(),r.querySelector(".repo-ops-script-viewer__close")?.focus();let j=t?t():"";if(!j){o="error",i="\uC6CC\uD06C\uC2A4\uD398\uC774\uC2A4\uAC00 \uC120\uD0DD\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.",w();return}if(!n){o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD \uAE30\uB2A5\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",w();return}let $e="/api/repo-ops-script?workspace="+encodeURIComponent(j)+"&lane="+encodeURIComponent(D.lane)+"&base_sha="+encodeURIComponent(D.base_sha);try{let he=await n($e),pe=await he.json().catch(()=>({}));if(S!==c)return;if((t?t():"")!==j){L();return}if(!he.ok||!pe||pe.ok!==!0){o="error",i=fb(pe&&typeof pe.error=="string"?pe.error:""),w();return}s={lane:pe.lane,base_sha:pe.base_sha,path:pe.path,base_ref:pe.base_ref},a=String(pe.content),o="ready",w()}catch{if(S!==c)return;o="error",i="\uC2A4\uD06C\uB9BD\uD2B8 \uC694\uCCAD\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.",w()}}function L(){c+=1,Y(),s=null,a="",w();let D=d;d=null,D?.isConnected&&D.focus()}function I(){L(),r.remove()}return{open:ee,close:L,destroy:I}}function yp(e){let t=e.queueStore,n=e.transport,r=e.onChanged||(()=>{}),s=e.onOpenScript;function o(){return t&&t.get()||{}}function a(){let S=o();return typeof S.revision=="number"?S.revision:0}function i(S){t&&S&&S.queue&&typeof S.queue=="object"&&t.set(S.queue)}function c(){let S=o().workspace_info;return S&&typeof S=="object"?S:{}}function d(S,U){return u`<span
...
${Dt.notes_tail}`:"notes\uC758 REVISE finding\uC744 \uC2A4\uD399\uC5D0 \uBC18\uC601\uD558\uB294 \uCC98\uBD84 \uC138\uC158\uC744 \uB744\uC6C1\uB2C8\uB2E4":"",usage:q==="done"?pn(l.attempts||{},te.bead_id):null,work_ms:q==="done"?Wo(l.attempts||{},te.bead_id):null,done_at:q==="done"&&typeof te.added_at=="number"?te.added_at:void 0,exec_chips:it?Gr(te.bead_id):null,workflow:it&&jn[te.bead_id]||null,from_id:Vr.get(te.bead_id)||void 0,priority:xn.get(te.bead_id),...tr(te.bead_id)}}),yr=l.attempts?Object.values(l.attempts).filter(Wr):[],ca=new Set;for(let m of yr)m&&typeof m.resumed_from=="string"&&m.resumed_from.length>0&&ca.add(m.resumed_from);let Qi=new Map;for(let m of yr)Qi.set(m.bead_id,m.attempt_id);let Ds=new Map;for(let m of yr)Ds.set(m.attempt_id,m);function ua(m){let q=new Set,te=m;for(;te&&!q.has(te.attempt_id);){if(te.conflict_resolution===!0)return!0;q.add(te.attempt_id),te=typeof te.resumed_from=="string"&&te.resumed_from.length>0&&Ds.get(te.resumed_from)||null}return!1}let Ns=typeof l.declared_base=="string"?l.declared_base:null;function tf(m){let q=null;for(let te of yr)!te||te.bead_id!==m||ua(te)||(q===null||(typeof te.started_at=="number"?te.started_at:0)>=(typeof q.started_at=="number"?q.started_at:0))&&(q=te);return q&&typeof q.target_base=="string"?q.target_base:null}let da=[],qs=[],nf=dp(l),Xi=m=>{let q=typeof m.session_id=="string"&&m.session_id.length>0,te=ca.has(m.attempt_id);return{eligible:q&&!te,reason:q?te?"\uC774\uBBF8 \uC774\uC5B4\uBC1B\uC740 attempt (child attempt \uC874\uC7AC) \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00":null:"session_id \uC5C6\uB294 \uAD6C attempt \u2014 \uC774\uC5B4\uD558\uAE30 \uBD88\uAC00"}},mn=null;for(let m of yr){let q=m.status==="paused"&&!ca.has(m.attempt_id);if(m.status==="running"||q)qs.push({bead_id:m.bead_id,attempt_id:m.attempt_id,title:Zt.get(m.bead_id)||m.bead_id,runner:m.runner||null,model:m.model||null,effort:m.effort||null,speed:m.speed||null,continuation_mode:m.continuation_mode||null,started_at:typeof m.started_at=="number"?m.started_at:null,resumed_from:m.resumed_from||null,paused:q,conflict_resolution:ua(m),base_exception:Ui(Ns,m.target_base),can_pause:typeof m.session_id=="string"&&m.session_id.length>0,discard:kn(Ps,m.bead_id,{attempt_id:m.attempt_id}),workflow:jn[m.bead_id]||null,priority:xn.get(m.bead_id),usage:pn(l.attempts||{},m.bead_id),rollup:gr(m.bead_id),rollup_expanded:Oe.has(m.bead_id),exec_chips:nn(m),...tr(m.bead_id)});else if((m.status==="failed"||m.status==="orphaned")&&nf(m)){let te=Xi(m);da.push({bead_id:m.bead_id,attempt_id:m.attempt_id,title:Zt.get(m.bead_id)||m.bead_id,runner:m.runner||null,model:m.model||null,effort:m.effort||null,speed:m.speed||null,continuation_mode:m.continuation_mode||null,started_at:typeof m.started_at=="number"?m.started_at:null,resumed_from:m.resumed_from||null,failed:!0,status:m.status,status_label:m.status==="orphaned"?"\uC911\uB2E8\uB428":"\uC2E4\uD328",discard:kn(Ps,m.bead_id,{attempt_id:m.attempt_id}),resume_eligible:te.eligible,resume_reason:te.reason,conflict_resolution:ua(m),base_exception:Ui(Ns,m.target_base),workflow:jn[m.bead_id]||null,priority:xn.get(m.bead_id),usage:pn(l.attempts||{},m.bead_id),rollup:gr(m.bead_id),rollup_expanded:Oe.has(m.bead_id),exec_chips:nn(m),...tr(m.bead_id)}),mn=m}}let Ji=new Set([...da,...qs].map(m=>m.bead_id));for(let m of Array.isArray(l.session_active)?l.session_active:[]){let q=m&&m.bead_id;typeof q!="string"||q.length===0||Ji.has(q)||(Ji.add(q),qs.push({bead_id:q,attempt_id:null,kind:"session",title:m.title||Zt.get(q)||q,status:"in_progress",started_at:An(m.started_at)??An(m.updated_at),updated_at:An(m.updated_at),workflow:m.workflow||null,priority:xn.get(q),runner:null,model:null,effort:null,speed:null,continuation_mode:null,resumed_from:null,paused:!1,can_pause:!1,conflict_resolution:!1,base_exception:null,discard:null,exec_chips:null,usage:null,rollup:null,rollup_expanded:!1}))}let vr=[...da,...qs].map(m=>{let q=Ds.get(m.attempt_id),te=q?.quickfix_landing;if(q?.quickfix_lane!==!0||!te||typeof te!="object")return m;let We=typeof te.reason=="string"&&te.reason.length>0?te.reason:null,it=Rs({bead_id:q.bead_id,merge_sha:te.head_sha,cleanup_cursor:te.cursor,cleanup_failed:We?{step:te.cursor,reason:We}:null,repo_operations:Array.isArray(l.repo_operations)?l.repo_operations:[]});return it?{...m,landing:it}:m}),el=null;if(mn){let m=Xi(mn),q=mn.cause_detail;el={bead_id:mn.bead_id,repo:mn.repo||"",reason:mn.cause||mn.status,cause_detail:q&&typeof q.reason=="string"?{reason:q.reason,command:typeof q.command=="string"?q.command:null}:null,resume_attempt_id:mn.attempt_id,resume_eligible:m.eligible,resume_reason:m.reason,discard:kn(Ps,mn.bead_id,{attempt_id:mn.attempt_id})}}let tl=new Set(vr.map(m=>m.bead_id)),pa=Array.isArray(l.merge_queue)?l.merge_queue:[],nl=new Map,rl=new Map,sl=new Map,ol=new Map,al=new Map;pa.forEach((m,q)=>{m&&typeof m.bead_id=="string"&&(nl.set(m.bead_id,q+1),rl.set(m.bead_id,m.resolution),sl.set(m.bead_id,m.continuation_action||null),ol.set(m.bead_id,m.head_review||null),al.set(m.bead_id,m.authority||null))});let wr=l.merge_queue_state||{active:null,failures:{}},rf=wr.failures||{},il=wr.waiting&&typeof wr.waiting.bead_id=="string"&&typeof wr.waiting.reason=="string"?wr.waiting:null,sf=l.auto_merge_skips||{},ll=m=>{let q=sf[m];if(!q)return null;let te=Yr[m],We=te&&te.pr?te.pr.head_sha:null;return We&&We===q.head_sha?q.reason||"":null},Fs=new Map;for(let m of vr)m.failed!==!0&&m.conflict_resolution&&(m.paused?Fs.has(m.bead_id)||Fs.set(m.bead_id,"paused"):Fs.set(m.bead_id,"running"));let cl=vr.filter(m=>m.kind!=="session"&&!m.paused&&m.failed!==!0).length,ul=(l.workspace_info||{}).slots,dl=typeof ul=="number"?ul:typeof l.slots=="number"?l.slots:ra,of=cl>dl,js=ir(G),af=(Array.isArray(l.done)?l.done.slice():[]).filter(m=>js===void 0||typeof m.added_at!="number"||m.added_at>=js).sort((m,q)=>(q.added_at||0)-(m.added_at||0)),Zr=la(af,"done"),lf=new Set((Array.isArray(l.done)?l.done:[]).map(m=>m?.bead_id).filter(m=>typeof m=="string")),pl=[],cf=d?.()||"";for(let m of O){let q=An(m.closed_at);if(typeof m.id!="string"||lf.has(m.id)||q===null||js!==void 0&&q<js||typeof m.comment_count!="number"||m.comment_count<=0)continue;let te=`${cf}\0${m.id}\0${String(m.updated_at)}\0${m.comment_count}`,We=S.get(te);We===void 0&&n&&(S.set(te,"pending"),Promise.resolve(n("get-comments",{id:m.id})).then(it=>{let qt=Array.isArray(it)&&it.some(Dt=>Co(typeof Dt?.text=="string"?Dt.text:"")?.lane==="session");S.set(te,qt?"session":"not-session"),ze()}).catch(()=>{S.set(te,"failed"),ze()})),We==="session"&&pl.push({id:m.id,title:m.title||m.id,reason:"",draggable:!1,done:!0,lane:"done",selectable:!1,selected:!1,worker_serial:!1,badges:["\uC138\uC158 \uC791\uC5C5"],alert:!1,usage:null,work_ms:null,done_at:q,created_at:m.created_at,updated_at:m.updated_at})}Zr.push(...pl),Zr.sort((m,q)=>(q.done_at||0)-(m.done_at||0));let Bs={};for(let m of On)Bs[m]=0;let fl=!1,_l=0,fa=0,ml=0;for(let m of Zr){let q=m.usage;if(q&&typeof q=="object"){let te=!1;for(let We of On)Number.isFinite(q[We])&&(Bs[We]+=q[We],fl=!0,te=!0);te&&(fa+=1,Number.isFinite(q.total_cost_usd)&&(_l+=q.total_cost_usd,ml+=1))}}fa>0&&ml===fa&&(Bs.total_cost_usd=_l);let gl=Zr.map(m=>m.usage).filter(m=>m&&typeof m=="object"&&m.providers),uf=gl.length>0?zt(_o(gl)):fl?In(Bs):null,hl=l.lane_states&&typeof l.lane_states=="object"&&!Array.isArray(l.lane_states)?l.lane_states:{},bl=Array.isArray(l.serial_lanes)?l.serial_lanes:[],yl=m=>{if(Un.some(We=>We.bead_id===m))return"PR \uB300\uAE30 \xB7 \uC810\uC720";let q=yr.filter(We=>We&&We.bead_id===m),te=q.length>0?q[q.length-1].status:null;return te==="failed"||te==="orphaned"?"\uC2E4\uD328 \xB7 \uC810\uC720 \uC720\uC9C0":te==="paused"?"\uC77C\uC2DC\uC815\uC9C0 \xB7 \uC810\uC720":"\uC2E4\uD589 \uC911 \xB7 \uC810\uC720"},Us=bl.filter(m=>m&&typeof m.id=="string"&&Array.isArray(m.entries)).map((m,q)=>{let te=hl[m.id]||{},We=new Map((Array.isArray(te.corrections)?te.corrections:[]).filter(At=>At&&typeof At.bead_id=="string"&&typeof At.after=="string").map(At=>[At.bead_id,At.after])),it=la(m.entries.filter(At=>!tl.has(At.bead_id)),m.id).map(At=>We.has(At.id)?{...At,badges:[`\u{1F517} ${We.get(At.id)} \uB4A4 (blocks \uC790\uB3D9)`,...At.badges]}:At),qt=Array.isArray(te.occupied_by)?te.occupied_by.filter(At=>typeof At=="string"):[],Dt=qt.map(At=>({id:At,title:Zt.get(At)||At,draggable:!1,lane:m.id,ghost:!0,badges:[yl(At)]}));return{id:m.id,index:q+1,rows:[...Dt,...it],occupied:qt.length>0,badge:qt.length>0?yl(qt[0]):"\uB300\uAE30",cycle:te.cycle===!0}}),vl=typeof l.serial_lane_count=="number"?l.serial_lane_count:Us.length,_a=la(oa.filter(m=>!tl.has(m.bead_id)),"queue"),wl=new Map,kl=new Set;for(let[m,q]of Object.entries(hl)){if(!/^s[1-5]$/.test(m))continue;let te=q&&Array.isArray(q.occupied_by)?q.occupied_by:[];for(let We of te)typeof We=="string"&&wl.set(We,m);te.length>0&&kl.add(m)}let kr=[];for(let m of vr)typeof m.bead_id=="string"&&kr.push({id:m.bead_id,title:Zt.get(m.bead_id)||m.bead_id,location_label:"\uC2E4\uD589\uC911",kind:"running",lane_id:wl.get(m.bead_id)??null});for(let m of Us)for(let q of m.rows)q.ghost!==!0&&kr.push({id:q.id,title:q.title,location_label:`${m.id} #${q.seq??""}`.trim(),kind:"serial",lane_id:m.id});_a.forEach((m,q)=>{kr.push({id:m.id,title:m.title,location_label:`#${q+1}`,kind:"parallel",lane_id:null})});for(let m of ia)kr.push({id:m.id,title:m.title,location_label:"\uD6C4\uBCF4",kind:"candidate",lane_id:null});let $l={};for(let m of bl)m&&typeof m.id=="string"&&Array.isArray(m.entries)&&($l[m.id]=m.entries.length);let ma=new Map;for(let m of kr)ma.has(m.id)||ma.set(m.id,m);I={members_by_id:ma,serial_raw_lengths:$l,serial_lane_count:vl,occupied_lanes:kl};let xl=_p(l.bead_scope,kr),ga=(m,q)=>{let te=xl.get(m.id);if(!te||te.overlaps.length===0&&!te.scope_missing)return m;let We=ve(m.id,te.overlaps);return m.dependency_chips={...m.dependency_chips||{},...te.overlaps.length>0?{overlaps:te.overlaps}:{},...te.scope_missing&&q!=="running"?{scope_missing:!0}:{},...We?{popover:We}:{}},m};for(let m of _a)ga(m,"queue");for(let m of Us)for(let q of m.rows)q.ghost!==!0&&ga(q,m.id);for(let m of ia)ga(m,"candidate");let Al=new Map;for(let m of vr){let q=typeof m.bead_id=="string"?xl.get(m.bead_id):void 0;if(!q||q.overlaps.length===0)continue;let te=ve(m.bead_id,q.overlaps);Al.set(m.bead_id,{dependency_chips:{overlaps:q.overlaps,...te?{popover:te}:{}}})}return{queue:l,idToTitle:Zt,candidates:ia,candidate_hidden:{blocked:aa.hidden_blocked,spec:aa.hidden_spec},running:vr,live_count:cl,slots:dl,over_cap:of,failure:el,waiting:_a,serial_lanes:Us,serial_lane_count:vl,running_overlays:Al,pr_wait:Un.map(m=>ry(m.bead_id,Zt.get(m.bead_id)||m.bead_id,Yr,dt[m.bead_id]||null,pn(l.attempts||{},m.bead_id),Fe[m.bead_id]||(he.has(m.bead_id)||pe.has(m.bead_id)?{activity:null,merge_progress:{step:"merging"}}:null),Fs.get(m.bead_id)||null,m.external===!0,{position:nl.get(m.bead_id)||0,active:wr.active===m.bead_id,failure:rf[m.bead_id]||null,waiting:il?.bead_id===m.bead_id?il.reason:null,resolution:rl.get(m.bead_id),continuation_action:sl.get(m.bead_id),head_review:ol.get(m.bead_id)||null,authority:al.get(m.bead_id)||null},m.wt_present!==!1,l.auto_merge===!0?ll(m.bead_id):null,Ui(Ns,tf(m.bead_id)),l.completion_status&&typeof l.completion_status=="object"&&!Array.isArray(l.completion_status)&&l.completion_status[m.bead_id]||null,l.discard_operations&&typeof l.discard_operations=="object"&&!Array.isArray(l.discard_operations)?l.discard_operations:{},Ds.get(Qi.get(m.bead_id)||"")?.worker_serial===!0,l.auto_merge===!0,{merge_sha:m.merge_sha,cleanup_cursor:m.cleanup_cursor,repo_operations:Array.isArray(l.repo_operations)?l.repo_operations:[]})).map(m=>({...m,workflow:jn[m.id]||null,priority:xn.get(m.id),...tr(m.id)})),merge_queue_length:pa.length,merge_queue_running:pa.length>0,auto_excluded:Un.map(m=>m.bead_id).filter(m=>ll(m)!==null),declared_base:Ns,done:Zr,token_total:uf,cleanup_failures:rn,repo_operations:Array.isArray(l.repo_operations)?l.repo_operations:[]}}function Ye(){let _=!!o?.get()?.job,g=!_&&o?.isPending?.()===!0,O=_?"\uBD84\uC11D \uC911":g?"\uC900\uBE44 \uC911":"";return u`<button
    ...
    >
      ▶ 자동 머지${O>0?` ${O}`:""}
        ...
        ${Rt(l)}
        ${_n({id:"worker-pane-queue",lane:"queue",title:"\uBCD1\uB82C \uB300\uAE30",items:l.waiting,empty:"\uB4DC\uB798\uADF8 \uB610\uB294 [\uB300\uAE30\uB85C \u21B4]\uB85C \uBC30\uCE58",collapsible:!0,collapsed:j.queue,preview:Rp(l.waiting)})}
        ${l.serial_lanes.map(g=>Mt(g))}
        ${_}
        ${_n({id:"worker-pane-done",lane:"done",title:"\uC644\uB8CC",items:l.done,empty:`${U()} \uC644\uB8CC \uC5C6\uC74C`,controls:jt(),collapsible:!0,collapsed:j.done,preview:Array.isArray(l.token_total)?l.token_total.map(g=>g.label).join(" \xB7 "):l.token_total||Rp(l.done)})}
    ...
    `}function I(){let G=t.getState(),S=G.workspace?.current,U=G.workspace?.available||[],j=new Set(G.workspace?.hidden||[]),$e=S?.path||U[0]?.path||"";if(U.length===0)return u``;let he=U.filter(pe=>!j.has(pe.path)||pe.path===$e);if(he.length<=1){let pe=he[0]||U[0],z=zi(pe.path);return u`
