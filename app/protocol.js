...
export const MESSAGE_TYPES = /** @type {const} */ ([
  ...
  'get-compare',
  'compare-snapshot',
  // Bench experiment channel (preset-compare §4.3·§4.7). Same shape and same
  // reason as the pair above: creating an experiment and listing the existing
  // ones are both one-shot answers, not a stream.
  'bench-run-create',
  'bench-run-list',
  'bench-runs-snapshot'
]);
