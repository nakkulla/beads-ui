...
export const MESSAGE_TYPES = /** @type {const} */ ([
  ...
  'impl-preset-update',
  'impl-preset-delete',
  // Server-global chip → preset bindings and the chip click that applies or
  // restores one (UI-wg68 §3, §4). Both ride the preset list's CAS revision.
  'impl-preset-bind',
  'chip-preset-toggle',
  'apply-impl-preset',
