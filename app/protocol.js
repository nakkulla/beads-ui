...
/**
 * @typedef {Object} MonitorPipelineSnapshotPayload
 * @property {'monitor-pipeline-snapshot'} type
 * @property {string} id
 * @property {number} seq
 * @property {Array<Record<string, unknown>>} workspaces
 * @property {Array<Record<string, unknown>>} workspaces_state
 */

/**
 * @typedef {Object} KeyedPatchPayload
 * @property {'worker-queue-patch'|'monitor-pipeline-patch'} type
 * @property {string} id
 * @property {number} seq
 * @property {Record<string, unknown>} set
 * @property {string[]} unset
 * @property {string} [root_dir] - Required for worker-queue patches.
 */
...
export const MESSAGE_TYPES = /** @type {const} */ ([
  ...
  // 큐 보류/정지의 사람 출구 (UI-5ym8 §4). 둘 다 `{since}`가 현재 hold와
  // 같을 때만 적용되고, 응답 뒤에는 `worker-queue-snapshot` fanout이 따른다.
  'worker-queue-hold-resume',
  'worker-queue-hold-retry-now',
  // `↻ 지금 프로브` (UI-o5ll §3.3): 공급자 보류의 회복 프로브를 그 러너 전체에
