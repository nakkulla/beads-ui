 ...
 * @typedef {Omit<Queue, 'completion_intents'|'merge_queue'> & { merge_queue: Array<{ bead_id: string, resolution_rounds: number, resolution?: ResolutionProjection|null, authority?: import('../../server/worker/queue-store.js').MergeAuthority|null, head_review?: import('../../server/worker/queue-store.js').HeadReview|null }>, completion_status?: Record<string, CompletionStatus>, manual_merge_continuation?: { schema_version: number, head_review_projection: boolean } }} WorkerQueueSnapshot
 */
